...
#define CLASS_2_D9F89A734FDEEA0E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x151FAA60)
#define CLASS_2_D9F89A734FDEEA0E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x151FAAA0)
#define CLASS_2_D9F89A734FDEEA0E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x151FAB20)
#define CLASS_2_D9F89A734FDEEA0E_TICK_OFFSET UNITYSDK_OFFSET(0x151FAB70)
#define CLASS_2_D9F89A734FDEEA0E__CTOR_OFFSET UNITYSDK_OFFSET(0x151FAA50)

inline static constexpr unsigned int Class_2_D9F89A734FDEEA0E_TypeDefinitionIndex = 58827;

class Class_2_D9F89A734FDEEA0E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowPuzzleHudWolfBroInBox* OFKGLJOAMLD; // 0x18
