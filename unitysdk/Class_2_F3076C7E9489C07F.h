...
#define CLASS_2_F3076C7E9489C07F_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8CE950)
#define CLASS_2_F3076C7E9489C07F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB8CE990)
#define CLASS_2_F3076C7E9489C07F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB8CE9F0)
#define CLASS_2_F3076C7E9489C07F_TICK_OFFSET UNITYSDK_OFFSET(0xB8CEA40)
#define CLASS_2_F3076C7E9489C07F__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CE940)

inline static constexpr unsigned int Class_2_F3076C7E9489C07F_TypeDefinitionIndex = 42967;

class Class_2_F3076C7E9489C07F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::PlayChallengeTargetAnimation* Field_2_0; // 0x20
