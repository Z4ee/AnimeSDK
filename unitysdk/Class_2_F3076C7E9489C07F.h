...
#define CLASS_2_F3076C7E9489C07F_DISPOSE_OFFSET UNITYSDK_OFFSET(0xACBA720)
#define CLASS_2_F3076C7E9489C07F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xACBA760)
#define CLASS_2_F3076C7E9489C07F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xACBA7C0)
#define CLASS_2_F3076C7E9489C07F_TICK_OFFSET UNITYSDK_OFFSET(0xACBA810)
#define CLASS_2_F3076C7E9489C07F__CTOR_OFFSET UNITYSDK_OFFSET(0xACBA710)

inline static constexpr unsigned int Class_2_F3076C7E9489C07F_TypeDefinitionIndex = 49619;
