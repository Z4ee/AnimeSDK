...
#define CLASS_1_5B567C8A01BAEDFE_304_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B94720)
#define CLASS_1_5B567C8A01BAEDFE_304_CLONE_OFFSET UNITYSDK_OFFSET(0x19B94590)
#define CLASS_1_5B567C8A01BAEDFE_304_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B94630)
#define CLASS_1_5B567C8A01BAEDFE_304_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B945D0)
#define CLASS_1_5B567C8A01BAEDFE_304_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B94680)
#define CLASS_1_5B567C8A01BAEDFE_304_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B94770)
#define CLASS_1_5B567C8A01BAEDFE_304_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B94740)
#define CLASS_1_5B567C8A01BAEDFE_304_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19B94510)
#define CLASS_1_5B567C8A01BAEDFE_304_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B94540)
#define CLASS_1_5B567C8A01BAEDFE_304_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B946B0)
#define CLASS_1_5B567C8A01BAEDFE_304_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B94710)
#define CLASS_1_5B567C8A01BAEDFE_304__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B947C0)
#define CLASS_1_5B567C8A01BAEDFE_304__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B94560)
#define CLASS_1_5B567C8A01BAEDFE_304__CTOR_OFFSET UNITYSDK_OFFSET(0x19B94550)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_304_TypeDefinitionIndex = 31171;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_304*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_304_TypeDefinitionIndex)->GetStaticField(0x4B5B0);
	}
