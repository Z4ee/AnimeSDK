...
#define CLASS_2_A326BDFCE24CAF6D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1891DFC0)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1891E050)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1891E000)
#define CLASS_2_A326BDFCE24CAF6D_TICK_OFFSET UNITYSDK_OFFSET(0x1891E260)
#define CLASS_2_A326BDFCE24CAF6D__CTOR_OFFSET UNITYSDK_OFFSET(0x1891DFB0)

inline static constexpr unsigned int Class_2_A326BDFCE24CAF6D_TypeDefinitionIndex = 55880;

class Class_2_A326BDFCE24CAF6D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchMainCamera* OFKGLJOAMLD; // 0x18
