...
#define CLASS_2_A326BDFCE24CAF6D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAB321C0)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAB32250)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAB32200)
#define CLASS_2_A326BDFCE24CAF6D_TICK_OFFSET UNITYSDK_OFFSET(0xAB32460)
#define CLASS_2_A326BDFCE24CAF6D__CTOR_OFFSET UNITYSDK_OFFSET(0xAB321B0)

inline static constexpr unsigned int Class_2_A326BDFCE24CAF6D_TypeDefinitionIndex = 52012;

class Class_2_A326BDFCE24CAF6D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchMainCamera* Field_2_0; // 0x18
