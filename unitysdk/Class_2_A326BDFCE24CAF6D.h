...
#define CLASS_2_A326BDFCE24CAF6D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15089BA0)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15089C30)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15089BE0)
#define CLASS_2_A326BDFCE24CAF6D_TICK_OFFSET UNITYSDK_OFFSET(0x15089E40)
#define CLASS_2_A326BDFCE24CAF6D__CTOR_OFFSET UNITYSDK_OFFSET(0x15089B90)

inline static constexpr unsigned int Class_2_A326BDFCE24CAF6D_TypeDefinitionIndex = 53168;

class Class_2_A326BDFCE24CAF6D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SwitchMainCamera* Field_2_1; // 0x20
