...
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17679280)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_RPG_GAMECORE_STRINGHASH_RPG_GAMECORE_FIXPOINT___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x176797C0)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_RPG_GAMECORE_STRINGHASH_RPG_GAMECORE_FIXPOINT___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17679710)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x17679840)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17679770)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17679720)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17679260)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x17679160)
#define CLASS_2_DFCE341CCFEBAEC2__GETALLVALUESWITHOVERRIDE_D__8___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x17679270)
...
public:
	...
	::RPG::GameCore::StringHash _key_5__3; // 0x58
