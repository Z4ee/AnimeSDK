...
#define CLASS_1_5B567C8A01BAEDFE_113_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A273C40)
#define CLASS_1_5B567C8A01BAEDFE_113_CLONE_OFFSET UNITYSDK_OFFSET(0x1A273AB0)
#define CLASS_1_5B567C8A01BAEDFE_113_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A273B50)
#define CLASS_1_5B567C8A01BAEDFE_113_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A273AF0)
#define CLASS_1_5B567C8A01BAEDFE_113_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A273BA0)
#define CLASS_1_5B567C8A01BAEDFE_113_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A273C90)
#define CLASS_1_5B567C8A01BAEDFE_113_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A273C60)
#define CLASS_1_5B567C8A01BAEDFE_113_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A273A30)
#define CLASS_1_5B567C8A01BAEDFE_113_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A273A60)
#define CLASS_1_5B567C8A01BAEDFE_113_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A273BD0)
#define CLASS_1_5B567C8A01BAEDFE_113_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A273C30)
#define CLASS_1_5B567C8A01BAEDFE_113__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A273CE0)
#define CLASS_1_5B567C8A01BAEDFE_113__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A273A80)
#define CLASS_1_5B567C8A01BAEDFE_113__CTOR_OFFSET UNITYSDK_OFFSET(0x1A273A70)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_113_TypeDefinitionIndex = 26550;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_113*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_113_TypeDefinitionIndex)->GetStaticField(0x466D0);
	}
