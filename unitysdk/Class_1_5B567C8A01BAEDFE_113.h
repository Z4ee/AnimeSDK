...
#define CLASS_1_5B567C8A01BAEDFE_113_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195D7C20)
#define CLASS_1_5B567C8A01BAEDFE_113_CLONE_OFFSET UNITYSDK_OFFSET(0x195D7A30)
#define CLASS_1_5B567C8A01BAEDFE_113_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195D7B30)
#define CLASS_1_5B567C8A01BAEDFE_113_EQUALS_OFFSET UNITYSDK_OFFSET(0x195D7AA0)
#define CLASS_1_5B567C8A01BAEDFE_113_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195D7B80)
#define CLASS_1_5B567C8A01BAEDFE_113_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195D7C70)
#define CLASS_1_5B567C8A01BAEDFE_113_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195D7C40)
#define CLASS_1_5B567C8A01BAEDFE_113_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195D7980)
#define CLASS_1_5B567C8A01BAEDFE_113_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195D79E0)
#define CLASS_1_5B567C8A01BAEDFE_113_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195D7BB0)
#define CLASS_1_5B567C8A01BAEDFE_113_WRITETO_OFFSET UNITYSDK_OFFSET(0x195D7C10)
#define CLASS_1_5B567C8A01BAEDFE_113__CCTOR_OFFSET UNITYSDK_OFFSET(0x195D7CC0)
#define CLASS_1_5B567C8A01BAEDFE_113__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195D7A00)
#define CLASS_1_5B567C8A01BAEDFE_113__CTOR_OFFSET UNITYSDK_OFFSET(0x195D79F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_113_TypeDefinitionIndex = 26774;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_113*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_113_TypeDefinitionIndex)->GetStaticField(0x54FC0);
	}
