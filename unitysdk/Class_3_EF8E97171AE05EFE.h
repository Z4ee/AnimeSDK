...
#define CLASS_3_EF8E97171AE05EFE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9840560)
#define CLASS_3_EF8E97171AE05EFE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x98405B0)
#define CLASS_3_EF8E97171AE05EFE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9840950)
#define CLASS_3_EF8E97171AE05EFE_TICK_OFFSET UNITYSDK_OFFSET(0x9840740)
#define CLASS_3_EF8E97171AE05EFE__CTOR_OFFSET UNITYSDK_OFFSET(0x9840530)
#define CLASS_3_EF8E97171AE05EFE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98409A0)
#define CLASS_3_EF8E97171AE05EFE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x98409F0)

inline static constexpr unsigned int Class_3_EF8E97171AE05EFE_TypeDefinitionIndex = 48132;
