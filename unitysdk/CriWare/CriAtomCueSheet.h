...
#define CRIWARE_CRIATOMCUESHEET_GET_ISERROR_OFFSET UNITYSDK_OFFSET(0x119F9A20)
#define CRIWARE_CRIATOMCUESHEET_GET_ISLOADING_OFFSET UNITYSDK_OFFSET(0x119F4E60)
#define CRIWARE_CRIATOMCUESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x119F7420)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomCueSheet_TypeDefinitionIndex = 30958;
