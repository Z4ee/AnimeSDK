...
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYERPARAMETER_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1FA65780)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1FA62500)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1FA62A40)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x1FA65100)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x1FA653E0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERUINT32_OFFSET UNITYSDK_OFFSET(0x1FA65270)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPLAYERPARAMETER_OFFSET UNITYSDK_OFFSET(0x1FA65700)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1FA64F90)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1FA64E30)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1FA63460)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_LIMITLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1FA65680)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1FA63190)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_RESUME_OFFSET UNITYSDK_OFFSET(0x1FA63300)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SET3DLISTENERHN_OFFSET UNITYSDK_OFFSET(0x1FA64890)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SET3DSOURCEHN_OFFSET UNITYSDK_OFFSET(0x1FA64710)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETAISACCONTROLBYID_OFFSET UNITYSDK_OFFSET(0x1FA64580)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETAISACCONTROLBYNAME_OFFSET UNITYSDK_OFFSET(0x1FA643E0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELBYNAME_OFFSET UNITYSDK_OFFSET(0x1FA63D60)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSETBYNAME_OFFSET UNITYSDK_OFFSET(0x1FA640A0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_OFFSET UNITYSDK_OFFSET(0x1FA64240)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVEL_OFFSET UNITYSDK_OFFSET(0x1FA63F00)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETCUEID_OFFSET UNITYSDK_OFFSET(0x1FA62DA0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETCUENAME_OFFSET UNITYSDK_OFFSET(0x1FA62BE0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETDSPPARAMETER_OFFSET UNITYSDK_OFFSET(0x1FA659E0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPAN3DANGLE_OFFSET UNITYSDK_OFFSET(0x1FA638D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPAN3DINTERIORDISTANCE_OFFSET UNITYSDK_OFFSET(0x1FA63A50)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPANTYPE_OFFSET UNITYSDK_OFFSET(0x1FA63BD0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPITCH_OFFSET UNITYSDK_OFFSET(0x1FA63750)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1FA64A00)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETVOLUME_OFFSET UNITYSDK_OFFSET(0x1FA635D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1FA63030)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_STOPWITHOUTRELEASETIME_OFFSET UNITYSDK_OFFSET(0x1FA65CC0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1FA65BC0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1FA64CD0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FA64B70)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE539549FD_OFFSET UNITYSDK_OFFSET(0x1FA629C0)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE579660FB_OFFSET UNITYSDK_OFFSET(0x1FA65C40)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE9B3BF0D2_OFFSET UNITYSDK_OFFSET(0x1FA62FB0)
#define CRIWARE_CRIATOMEXPLAYER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FA625D0)
#define CRIWARE_CRIATOMEXPLAYER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1FA65D40)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x1FA65010)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x1FA652F0)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERUINT32_OFFSET UNITYSDK_OFFSET(0x1FA65180)
#define CRIWARE_CRIATOMEXPLAYER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1FA64EB0)
#define CRIWARE_CRIATOMEXPLAYER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1FA64D50)
#define CRIWARE_CRIATOMEXPLAYER_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1FA62200)
#define CRIWARE_CRIATOMEXPLAYER_GET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1FA621F0)
#define CRIWARE_CRIATOMEXPLAYER_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1FA63380)
#define CRIWARE_CRIATOMEXPLAYER_LOOP_OFFSET UNITYSDK_OFFSET(0x1FA65460)
#define CRIWARE_CRIATOMEXPLAYER_ONBEATSYNCCALLBACKCHAININTERNAL_OFFSET UNITYSDK_OFFSET(0x1FA65DB0)
#define CRIWARE_CRIATOMEXPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1FA630B0)
#define CRIWARE_CRIATOMEXPLAYER_RESUME_OFFSET UNITYSDK_OFFSET(0x1FA63210)
#define CRIWARE_CRIATOMEXPLAYER_SET3DLISTENER_OFFSET UNITYSDK_OFFSET(0x1FA64790)
#define CRIWARE_CRIATOMEXPLAYER_SET3DSOURCE_OFFSET UNITYSDK_OFFSET(0x1FA64610)
#define CRIWARE_CRIATOMEXPLAYER_SETAISACCONTROL_1_OFFSET UNITYSDK_OFFSET(0x1FA64490)
#define CRIWARE_CRIATOMEXPLAYER_SETAISACCONTROL_OFFSET UNITYSDK_OFFSET(0x1FA642D0)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1FA64150)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_OFFSET UNITYSDK_OFFSET(0x1FA63F90)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVEL_1_OFFSET UNITYSDK_OFFSET(0x1FA63E10)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVEL_OFFSET UNITYSDK_OFFSET(0x1FA63C50)
#define CRIWARE_CRIATOMEXPLAYER_SETCUE_1_OFFSET UNITYSDK_OFFSET(0x1FA62C90)
#define CRIWARE_CRIATOMEXPLAYER_SETCUE_OFFSET UNITYSDK_OFFSET(0x1FA62AC0)
#define CRIWARE_CRIATOMEXPLAYER_SETDSPPARAMETER_OFFSET UNITYSDK_OFFSET(0x1FA658F0)
#define CRIWARE_CRIATOMEXPLAYER_SETDSPTIMESTRETCHRATIO_OFFSET UNITYSDK_OFFSET(0x1FA65800)
#define CRIWARE_CRIATOMEXPLAYER_SETPAN3DANGLE_OFFSET UNITYSDK_OFFSET(0x1FA637E0)
#define CRIWARE_CRIATOMEXPLAYER_SETPAN3DINTERIORDISTANCE_OFFSET UNITYSDK_OFFSET(0x1FA63960)
#define CRIWARE_CRIATOMEXPLAYER_SETPANTYPE_OFFSET UNITYSDK_OFFSET(0x1FA63AE0)
#define CRIWARE_CRIATOMEXPLAYER_SETPITCH_OFFSET UNITYSDK_OFFSET(0x1FA63660)
#define CRIWARE_CRIATOMEXPLAYER_SETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1FA64910)
#define CRIWARE_CRIATOMEXPLAYER_SETVOLUME_OFFSET UNITYSDK_OFFSET(0x1FA634E0)
#define CRIWARE_CRIATOMEXPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1FA62E30)
#define CRIWARE_CRIATOMEXPLAYER_STOPWITHOUTRELEASETIME_OFFSET UNITYSDK_OFFSET(0x1FA62870)
#define CRIWARE_CRIATOMEXPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1FA65A70)
#define CRIWARE_CRIATOMEXPLAYER_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1FA64BF0)
#define CRIWARE_CRIATOMEXPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FA64A80)
#define CRIWARE_CRIATOMEXPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FA65DE0)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FA624E0)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1FA62230)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA62210)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExPlayer_TypeDefinitionIndex = 34948;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(CriAtomExPlayer_TypeDefinitionIndex)->GetStaticField(0x84C0);
		}
		...
		static ::System::Void CRIWARE539549FD(::System::IntPtr pool)
		{
			return ((::System::Void(*)(::System::IntPtr))((::PBYTE)hIl2Cpp + CRIWARE_CRIATOMEXPLAYER_CRIWARE539549FD_OFFSET))(pool);
		}

		static ::System::Void CRIWARE9B3BF0D2(::System::IntPtr pool)
		{
			return ((::System::Void(*)(::System::IntPtr))((::PBYTE)hIl2Cpp + CRIWARE_CRIATOMEXPLAYER_CRIWARE9B3BF0D2_OFFSET))(pool);
		}

		static ::System::Void CRIWARE579660FB(::System::IntPtr pool)
		{
			return ((::System::Void(*)(::System::IntPtr))((::PBYTE)hIl2Cpp + CRIWARE_CRIATOMEXPLAYER_CRIWARE579660FB_OFFSET))(pool);
		}
		...
		static ::System::Void criAtomExPlayerParameter_RemoveParameter(::System::IntPtr player_parameter, ::System::UInt32 id)
		{
			return ((::System::Void(*)(::System::IntPtr, ::System::UInt32))((::PBYTE)hIl2Cpp + CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYERPARAMETER_REMOVEPARAMETER_OFFSET))(player_parameter, id);
		}
