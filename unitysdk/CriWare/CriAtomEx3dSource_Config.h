...
#define CRIWARE_CRIATOMEX3DSOURCE_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x38DE2E0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx3dSource_Config_TypeDefinitionIndex = 37856;
