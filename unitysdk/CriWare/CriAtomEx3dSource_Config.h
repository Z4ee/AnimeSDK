...
#define CRIWARE_CRIATOMEX3DSOURCE_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7F2F0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx3dSource_Config_TypeDefinitionIndex = 31037;
