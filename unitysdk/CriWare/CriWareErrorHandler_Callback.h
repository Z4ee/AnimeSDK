...
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146DC200)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146DC230)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x146DBD20)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x146DC190)

namespace CriWare
{
	inline static constexpr unsigned int CriWareErrorHandler_Callback_TypeDefinitionIndex = 37184;
