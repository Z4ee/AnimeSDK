...
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BE773A0)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE773D0)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BE76E50)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE77330)

namespace CriWare
{
	inline static constexpr unsigned int CriWareErrorHandler_Callback_TypeDefinitionIndex = 37988;
