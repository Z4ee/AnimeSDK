...
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1650EB40)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1650EB70)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1650E5F0)
#define CRIWARE_CRIWAREERRORHANDLER_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1650EAD0)
