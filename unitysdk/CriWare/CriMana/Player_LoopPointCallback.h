...
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C48D260)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C48D290)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C48CD60)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48CD50)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_LoopPointCallback_TypeDefinitionIndex = 32855;
