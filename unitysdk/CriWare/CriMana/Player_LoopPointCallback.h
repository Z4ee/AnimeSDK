...
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FBA4B20)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FBA4B50)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FBA4600)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBA45E0)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_LoopPointCallback_TypeDefinitionIndex = 35062;
