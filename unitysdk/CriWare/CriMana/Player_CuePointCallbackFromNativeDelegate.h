...
#define CRIWARE_CRIMANA_PLAYER_CUEPOINTCALLBACKFROMNATIVEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6CD90)
#define CRIWARE_CRIMANA_PLAYER_CUEPOINTCALLBACKFROMNATIVEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6CE40)
#define CRIWARE_CRIMANA_PLAYER_CUEPOINTCALLBACKFROMNATIVEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6CD70)
#define CRIWARE_CRIMANA_PLAYER_CUEPOINTCALLBACKFROMNATIVEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE6CD00)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_CuePointCallbackFromNativeDelegate_TypeDefinitionIndex = 38068;
