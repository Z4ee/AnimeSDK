...
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_CREATERENDERERRESOURCE_OFFSET UNITYSDK_OFFSET(0x164F46D0)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_ONDISPOSEMANAGED_OFFSET UNITYSDK_OFFSET(0x164F47A0)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_ONDISPOSEUNMANAGED_OFFSET UNITYSDK_OFFSET(0x164F47B0)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV__CTOR_OFFSET UNITYSDK_OFFSET(0x164F47C0)
