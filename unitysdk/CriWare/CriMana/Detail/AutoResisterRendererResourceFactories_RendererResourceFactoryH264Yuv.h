...
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_CREATERENDERERRESOURCE_OFFSET UNITYSDK_OFFSET(0x1C54BDF0)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_ONDISPOSEMANAGED_OFFSET UNITYSDK_OFFSET(0x1C54BE70)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_ONDISPOSEUNMANAGED_OFFSET UNITYSDK_OFFSET(0x1C54BE80)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54BE90)

namespace CriWare::CriMana::Detail
{
	inline static constexpr unsigned int AutoResisterRendererResourceFactories_RendererResourceFactoryH264Yuv_TypeDefinitionIndex = 32862;
