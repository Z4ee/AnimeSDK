...
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECALLBACKFROMNATIVEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6D110)
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECALLBACKFROMNATIVEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6D180)
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECALLBACKFROMNATIVEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6D100)
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECALLBACKFROMNATIVEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE6D090)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_SubtitleCallbackFromNativeDelegate_TypeDefinitionIndex = 38069;
