...
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C489870)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4898A0)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C489370)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C489360)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExSequencer_EventCbFunc_TypeDefinitionIndex = 32719;
