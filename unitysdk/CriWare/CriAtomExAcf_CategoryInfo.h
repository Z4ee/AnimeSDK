...
#define CRIWARE_CRIATOMEXACF_CATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x3A17F90)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAcf_CategoryInfo_TypeDefinitionIndex = 37874;
