...
#define CRIWARE_CRIATOMEXACF_CATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2BD4750)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAcf_CategoryInfo_TypeDefinitionIndex = 37074;
