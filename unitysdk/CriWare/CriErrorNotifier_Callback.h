...
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E6605C0)
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E6605F0)
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E6600C0)
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6600A0)

namespace CriWare
{
	inline static constexpr unsigned int CriErrorNotifier_Callback_TypeDefinitionIndex = 34345;
