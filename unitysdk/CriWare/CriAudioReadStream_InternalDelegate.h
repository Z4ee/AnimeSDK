...
#define CRIWARE_CRIAUDIOREADSTREAM_INTERNALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x164E7830)
#define CRIWARE_CRIAUDIOREADSTREAM_INTERNALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x164E78C0)
#define CRIWARE_CRIAUDIOREADSTREAM_INTERNALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x164E7810)
#define CRIWARE_CRIAUDIOREADSTREAM_INTERNALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x164E77A0)

namespace CriWare
{
	inline static constexpr unsigned int CriAudioReadStream_InternalDelegate_TypeDefinitionIndex = 38791;
