...
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONAPPLICATIONPAUSECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E81F7B0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONAPPLICATIONPAUSECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E81F830)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONAPPLICATIONPAUSECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E81F1C0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONAPPLICATIONPAUSECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81F1A0)

namespace CriWare
{
	inline static constexpr unsigned int CriManaMovieMaterialBase_OnApplicationPauseCallback_TypeDefinitionIndex = 34336;
