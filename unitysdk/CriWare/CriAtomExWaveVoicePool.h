...
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_CRIATOMEXVOICEPOOL_ALLOCATEWAVEVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x1B79DF90)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_CRIWAREEDDDA553_OFFSET UNITYSDK_OFFSET(0x1B79DE00)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_SETDEFAULTCONFIGFORWAVEVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x1B79DDF0)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B79E0B0)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79DF10)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExWaveVoicePool_TypeDefinitionIndex = 37925;
