...
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_CRIATOMEXVOICEPOOL_ALLOCATEWAVEVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x164DA840)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_CRIWAREEDDDA553_OFFSET UNITYSDK_OFFSET(0x164DA6B0)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_SETDEFAULTCONFIGFORWAVEVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x164DA6A0)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x164DA960)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x164DA7C0)
