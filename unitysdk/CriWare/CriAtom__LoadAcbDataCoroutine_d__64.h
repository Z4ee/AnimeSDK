...
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E519630)
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E519960)
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E5199C0)
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E519970)
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E519540)
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64__CTOR_OFFSET UNITYSDK_OFFSET(0x1E519530)
#define CRIWARE_CRIATOM__LOADACBDATACOROUTINE_D__64___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1E5195C0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtom__LoadAcbDataCoroutine_d__64_TypeDefinitionIndex = 34243;

	class CriAtom__LoadAcbDataCoroutine_d__64 : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* acbData; // 0x10
		::CriWare::CriAtom* __4__this; // 0x18
		::System::String* awbPath; // 0x20
		::CriWare::CriFsBinder* awbBinder; // 0x28
		::CriWare::CriAtomCueSheet* cueSheet; // 0x30
