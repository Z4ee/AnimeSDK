...
#define CRIWARE_CRIATOMEX_AISACINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x3A15390)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_AisacInfo_TypeDefinitionIndex = 37820;
