...
#define CRIWARE_CRIATOMEXMIC_CONFIG_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x11A14290)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExMic_Config_TypeDefinitionIndex = 31072;
