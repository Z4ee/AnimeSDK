...
#define CRIWARE_CRIATOMPLUGIN_FILEOPENCONDITION_GET_CANATTACHAWB_OFFSET UNITYSDK_OFFSET(0x2E016F0)
#define CRIWARE_CRIATOMPLUGIN_FILEOPENCONDITION_GET_CANLOADACBWITHAWB_OFFSET UNITYSDK_OFFSET(0x2E016E0)
#define CRIWARE_CRIATOMPLUGIN_FILEOPENCONDITION_GET_CANLOADACB_OFFSET UNITYSDK_OFFSET(0x2E01620)
#define CRIWARE_CRIATOMPLUGIN_FILEOPENCONDITION_GET_CANLOADACF_OFFSET UNITYSDK_OFFSET(0x2E01560)
