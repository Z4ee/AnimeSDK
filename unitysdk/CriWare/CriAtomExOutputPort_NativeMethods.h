...
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_CALCULATEWORKSIZE_OFFSET UNITYSDK_OFFSET(0x1D367110)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1D367220)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D3675F0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_ISDESTROYABLE_OFFSET UNITYSDK_OFFSET(0x1D367A10)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETASRRACKID_OFFSET UNITYSDK_OFFSET(0x1D3676F0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETMONAURALMIX_OFFSET UNITYSDK_OFFSET(0x1D367910)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETVIBRATIONCHANNELLEVEL_OFFSET UNITYSDK_OFFSET(0x1D367800)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D367AE0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExOutputPort_NativeMethods_TypeDefinitionIndex = 38755;
