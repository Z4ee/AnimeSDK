...
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_CALCULATEWORKSIZE_OFFSET UNITYSDK_OFFSET(0x164CB0B0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x164CB1C0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_DESTROY_OFFSET UNITYSDK_OFFSET(0x164CB590)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_ISDESTROYABLE_OFFSET UNITYSDK_OFFSET(0x164CB9B0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETASRRACKID_OFFSET UNITYSDK_OFFSET(0x164CB690)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETMONAURALMIX_OFFSET UNITYSDK_OFFSET(0x164CB8B0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETVIBRATIONCHANNELLEVEL_OFFSET UNITYSDK_OFFSET(0x164CB7A0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x164CBA80)
