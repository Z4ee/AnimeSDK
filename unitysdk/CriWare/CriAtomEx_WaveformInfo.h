...
#define CRIWARE_CRIATOMEX_WAVEFORMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D9D50)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_WaveformInfo_TypeDefinitionIndex = 32712;
