...
#define CRIWARE_CRIATOMEX_WAVEFORMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA7B0D0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_WaveformInfo_TypeDefinitionIndex = 34265;
