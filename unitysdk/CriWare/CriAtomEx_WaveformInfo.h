...
#define CRIWARE_CRIATOMEX_WAVEFORMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDFB0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_WaveformInfo_TypeDefinitionIndex = 31000;
