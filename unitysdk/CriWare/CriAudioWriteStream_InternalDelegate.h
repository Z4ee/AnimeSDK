...
#define CRIWARE_CRIAUDIOWRITESTREAM_INTERNALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A329B0)
#define CRIWARE_CRIAUDIOWRITESTREAM_INTERNALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A32A40)
#define CRIWARE_CRIAUDIOWRITESTREAM_INTERNALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A32610)
#define CRIWARE_CRIAUDIOWRITESTREAM_INTERNALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x11A31F30)

namespace CriWare
{
	inline static constexpr unsigned int CriAudioWriteStream_InternalDelegate_TypeDefinitionIndex = 31116;
