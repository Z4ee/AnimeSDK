...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E67CF30)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E67CF20)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1E67D010)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_SETCLIPDURATION_OFFSET UNITYSDK_OFFSET(0x1E67D000)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E67D040)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomClipBase_TypeDefinitionIndex = 34390;
