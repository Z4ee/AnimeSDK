...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_GET_ISEDITOR_OFFSET UNITYSDK_OFFSET(0x1C310380)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_GET_M_GUID_OFFSET UNITYSDK_OFFSET(0x1C310310)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1C310390)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1C310330)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C3105E0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_SET_M_GUID_OFFSET UNITYSDK_OFFSET(0x1C310320)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C311190)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomMixerBehaviour_TypeDefinitionIndex = 32838;
