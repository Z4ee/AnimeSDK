...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GETCUELENGTHSEC_OFFSET UNITYSDK_OFFSET(0x1FC02370)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_CUELENGTH_OFFSET UNITYSDK_OFFSET(0x1FC01C50)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_ISCLIPPLAYING_OFFSET UNITYSDK_OFFSET(0x1FC01C30)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_PLAYBACK_OFFSET UNITYSDK_OFFSET(0x1FC01C10)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1FC01C70)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_PLAY_OFFSET UNITYSDK_OFFSET(0x1FC01C80)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_PREVIEWPLAY_OFFSET UNITYSDK_OFFSET(0x1FC023E0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_CUELENGTH_OFFSET UNITYSDK_OFFSET(0x1FC01C60)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_ISCLIPPLAYING_OFFSET UNITYSDK_OFFSET(0x1FC01C40)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_PLAYBACK_OFFSET UNITYSDK_OFFSET(0x1FC01C20)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_STOP_OFFSET UNITYSDK_OFFSET(0x1FC02A90)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_WAITANDSTOP_OFFSET UNITYSDK_OFFSET(0x1FC029F0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC02AD0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC02AC0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__WAITANDSTOP_B__21_0_OFFSET UNITYSDK_OFFSET(0x1FC02AE0)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomBehaviour_TypeDefinitionIndex = 35039;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CriAtomBehaviour_TypeDefinitionIndex)->GetStaticField(0x84B0);
		}
		...
		::System::Void Stop(::System::Boolean noReleaseTime, ::System::Boolean flagResetOnly)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_STOP_OFFSET))(this, noReleaseTime, flagResetOnly);
		}
