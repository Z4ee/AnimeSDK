...
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_DATAID_OFFSET UNITYSDK_OFFSET(0x1E81FB70)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_MOVIEDATA_OFFSET UNITYSDK_OFFSET(0x1E81F850)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_MOVIENAME_OFFSET UNITYSDK_OFFSET(0x1E81F9B0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_MOVIEPATH_OFFSET UNITYSDK_OFFSET(0x1E81F840)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81FCF0)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaClip_TypeDefinitionIndex = 34378;
