...
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_FORCESYNCEDSTOP_OFFSET UNITYSDK_OFFSET(0x1C161510)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_GET_ISEDITMODE_OFFSET UNITYSDK_OFFSET(0x1C1601D0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERERROR_OFFSET UNITYSDK_OFFSET(0x1C161320)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERPREPARING_OFFSET UNITYSDK_OFFSET(0x1C161250)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERREADYORPLAYING_OFFSET UNITYSDK_OFFSET(0x1C1613A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERSTOPPED_OFFSET UNITYSDK_OFFSET(0x1C1612D0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_KEEPAUDIOVOLUME_OFFSET UNITYSDK_OFFSET(0x1C1601E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1C162F20)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1C162D40)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1C163100)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1C1635A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1C163730)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1C1637A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PAUSEPLAYER_OFFSET UNITYSDK_OFFSET(0x1C162A90)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PLAYMOVIE_OFFSET UNITYSDK_OFFSET(0x1C1603E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PREPAREMOVIE_OFFSET UNITYSDK_OFFSET(0x1C160940)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PROCESSFRAMEONSEEKING_OFFSET UNITYSDK_OFFSET(0x1C161470)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C161700)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_SEEKPLAYBACKENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C162CF0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_STOPMOVIE_OFFSET UNITYSDK_OFFSET(0x1C160E30)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C163830)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C163800)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaMixerBehaviour_TypeDefinitionIndex = 32828;
	...
	public:
		...
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(CriManaMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0x7ED0);
		}
