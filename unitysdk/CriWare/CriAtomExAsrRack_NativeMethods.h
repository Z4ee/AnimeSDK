...
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_GETCURRENTUSERID_PS5_OFFSET UNITYSDK_OFFSET(0x1AEFDE10)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_ISUSERIDSETTABLE_PS5_OFFSET UNITYSDK_OFFSET(0x1AEFDDD0)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETDEFAULTCONFIG_ANDROID_MACRO_OFFSET UNITYSDK_OFFSET(0x1AEFDD90)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETDEFAULTCONFIG_PS5_MACRO_OFFSET UNITYSDK_OFFSET(0x1AEFDDB0)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETUSERID_PS5_OFFSET UNITYSDK_OFFSET(0x1AEFDDF0)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF000C0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAsrRack_NativeMethods_TypeDefinitionIndex = 37759;
