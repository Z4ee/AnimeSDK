...
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_GETCURRENTUSERID_PS5_OFFSET UNITYSDK_OFFSET(0x1CB943A0)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_ISUSERIDSETTABLE_PS5_OFFSET UNITYSDK_OFFSET(0x1CB94360)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETDEFAULTCONFIG_ANDROID_MACRO_OFFSET UNITYSDK_OFFSET(0x1CB94320)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETDEFAULTCONFIG_PS5_MACRO_OFFSET UNITYSDK_OFFSET(0x1CB94340)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETUSERID_PS5_OFFSET UNITYSDK_OFFSET(0x1CB94380)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB96650)
