...
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BE6E520)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_CREATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1BE701F0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE70DA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE6E000)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_DESTROYOWNMATERIAL_OFFSET UNITYSDK_OFFSET(0x1BE6F860)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_HAVERENDEREROWNER_OFFSET UNITYSDK_OFFSET(0x1BE6FA60)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_ISMATERIALAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1BE6F7A0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_ISRENDEREROWNERISTARGET_OFFSET UNITYSDK_OFFSET(0x1BE6FA80)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1BE6F7E0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_MAXFRAMEDROP_OFFSET UNITYSDK_OFFSET(0x1BE6F770)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1BE6F7C0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_TIMERTYPE_OFFSET UNITYSDK_OFFSET(0x1BE6F8A0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1BE70E00)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BE70BA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BE708A0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BE70600)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONMATERIALAVAILABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1BE6FDA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONMATERIALUPDATED_OFFSET UNITYSDK_OFFSET(0x1BE6FDB0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONWILLRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1BE70DD0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x1BE6FBF0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1BE70040)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BE6FDC0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALSETUP_OFFSET UNITYSDK_OFFSET(0x1BE70100)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE70430)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAY_OFFSET UNITYSDK_OFFSET(0x1BE6FAA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PROCESSAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1BE70E10)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RENDERMOVIE_OFFSET UNITYSDK_OFFSET(0x1BE70D80)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RENDERTARGETMANUALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1BE70420)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RENDERTARGETMANUALSETUP_OFFSET UNITYSDK_OFFSET(0x1BE70410)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RESTARTPLAYERROUTINE_OFFSET UNITYSDK_OFFSET(0x1BE70840)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_HAVERENDEREROWNER_OFFSET UNITYSDK_OFFSET(0x1BE6FA70)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_ISMATERIALAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1BE6F7B0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_ISRENDEREROWNERISTARGET_OFFSET UNITYSDK_OFFSET(0x1BE6FA90)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1BE6F7F0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_MAXFRAMEDROP_OFFSET UNITYSDK_OFFSET(0x1BE6F780)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1BE6F7D0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_TIMERTYPE_OFFSET UNITYSDK_OFFSET(0x1BE6F8B0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_START_OFFSET UNITYSDK_OFFSET(0x1BE70CE0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_STOP_OFFSET UNITYSDK_OFFSET(0x1BE6FB40)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE6F730)

namespace CriWare
{
	inline static constexpr unsigned int CriManaMovieMaterialBase_TypeDefinitionIndex = 37974;
