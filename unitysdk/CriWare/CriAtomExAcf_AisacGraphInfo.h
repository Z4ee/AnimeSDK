...
#define CRIWARE_CRIATOMEXACF_AISACGRAPHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14F0050)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAcf_AisacGraphInfo_TypeDefinitionIndex = 31058;
