...
#define CRIWARE_CRIFS_GETMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x1B7AD2F0)
#define CRIWARE_CRIFS_GETNUMBINDS_OFFSET UNITYSDK_OFFSET(0x1B7A3F70)
#define CRIWARE_CRIFS_GETNUMOPENEDFILES_OFFSET UNITYSDK_OFFSET(0x1B7A4020)
#define CRIWARE_CRIFS_GETNUMUSEDBINDERS_OFFSET UNITYSDK_OFFSET(0x1B7ACEC0)
#define CRIWARE_CRIFS_GETNUMUSEDINSTALLERS_OFFSET UNITYSDK_OFFSET(0x1B7AD090)
#define CRIWARE_CRIFS_GETNUMUSEDLOADERS_OFFSET UNITYSDK_OFFSET(0x1B7A40D0)
#define CRIWARE_CRIFS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AD400)
