...
#define CRIWARE_CRIFS_GETMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x164E9B90)
#define CRIWARE_CRIFS_GETNUMBINDS_OFFSET UNITYSDK_OFFSET(0x164E0820)
#define CRIWARE_CRIFS_GETNUMOPENEDFILES_OFFSET UNITYSDK_OFFSET(0x164E08D0)
#define CRIWARE_CRIFS_GETNUMUSEDBINDERS_OFFSET UNITYSDK_OFFSET(0x164E9760)
#define CRIWARE_CRIFS_GETNUMUSEDINSTALLERS_OFFSET UNITYSDK_OFFSET(0x164E9930)
#define CRIWARE_CRIFS_GETNUMUSEDLOADERS_OFFSET UNITYSDK_OFFSET(0x164E0980)
#define CRIWARE_CRIFS__CTOR_OFFSET UNITYSDK_OFFSET(0x164E9CA0)
