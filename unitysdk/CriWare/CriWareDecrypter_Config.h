...
#define CRIWARE_CRIWAREDECRYPTER_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE75D90)

namespace CriWare
{
	inline static constexpr unsigned int CriWareDecrypter_Config_TypeDefinitionIndex = 37984;
