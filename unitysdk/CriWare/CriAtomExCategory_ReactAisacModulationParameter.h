...
#define CRIWARE_CRIATOMEXCATEGORY_REACTAISACMODULATIONPARAMETER_GET_ENABLEINCREMENTAISACMODULATIONKEY_OFFSET UNITYSDK_OFFSET(0x2BD5930)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExCategory_ReactAisacModulationParameter_TypeDefinitionIndex = 37037;
