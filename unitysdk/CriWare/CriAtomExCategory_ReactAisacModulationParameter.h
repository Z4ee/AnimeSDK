...
#define CRIWARE_CRIATOMEXCATEGORY_REACTAISACMODULATIONPARAMETER_GET_ENABLEDECREMENTAISACMODULATIONKEY_OFFSET UNITYSDK_OFFSET(0xC2F770)
#define CRIWARE_CRIATOMEXCATEGORY_REACTAISACMODULATIONPARAMETER_GET_ENABLEINCREMENTAISACMODULATIONKEY_OFFSET UNITYSDK_OFFSET(0x3A19460)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExCategory_ReactAisacModulationParameter_TypeDefinitionIndex = 37836;
