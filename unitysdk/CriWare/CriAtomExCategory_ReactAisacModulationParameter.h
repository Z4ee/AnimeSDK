...
#define CRIWARE_CRIATOMEXCATEGORY_REACTAISACMODULATIONPARAMETER_GET_ENABLEINCREMENTAISACMODULATIONKEY_OFFSET UNITYSDK_OFFSET(0x1625850)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExCategory_ReactAisacModulationParameter_TypeDefinitionIndex = 36737;
