...
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_UNSAFENATIVEMETHODS_CRIATOMUNITY_ISOUTPUTDEVICECONNECTED_WASAPI_OFFSET UNITYSDK_OFFSET(0x1FBC34F0)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_UNSAFENATIVEMETHODS_CRIATOMUNITY_STARTOUTPUTDEVICEOBSERVER_WASAPI_OFFSET UNITYSDK_OFFSET(0x1FBC33F0)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_UNSAFENATIVEMETHODS_CRIATOMUNITY_STOPOUTPUTDEVICEOBSERVER_WASAPI_OFFSET UNITYSDK_OFFSET(0x1FBC3470)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomOutputDeviceObserver_UnsafeNativeMethods_TypeDefinitionIndex = 34893;
