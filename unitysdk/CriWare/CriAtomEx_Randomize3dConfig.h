...
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_CLEARCALCPARAMS_OFFSET UNITYSDK_OFFSET(0x1622320)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_GETPARAMBYTYPE_OFFSET UNITYSDK_OFFSET(0x1622370)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_GET_CALCULATIONPARAMETER1_OFFSET UNITYSDK_OFFSET(0x16221D0)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_GET_CALCULATIONPARAMETER2_OFFSET UNITYSDK_OFFSET(0x1622210)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_GET_CALCULATIONPARAMETER3_OFFSET UNITYSDK_OFFSET(0x1622250)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_GET_CALCULATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1DA80)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_GET_FOLLOWSORIGINALSOURCE_OFFSET UNITYSDK_OFFSET(0x2A500)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG_SETPARAMBYTYPE_OFFSET UNITYSDK_OFFSET(0x1622380)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16222A0)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16222B0)
#define CRIWARE_CRIATOMEX_RANDOMIZE3DCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1622290)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_Randomize3dConfig_TypeDefinitionIndex = 36715;
