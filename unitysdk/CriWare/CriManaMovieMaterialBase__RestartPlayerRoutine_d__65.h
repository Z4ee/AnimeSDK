...
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__RESTARTPLAYERROUTINE_D__65_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16508A30)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__RESTARTPLAYERROUTINE_D__65_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16508D50)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__RESTARTPLAYERROUTINE_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16508DB0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__RESTARTPLAYERROUTINE_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16508D60)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__RESTARTPLAYERROUTINE_D__65_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16508A20)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__RESTARTPLAYERROUTINE_D__65__CTOR_OFFSET UNITYSDK_OFFSET(0x16508030)

namespace CriWare
{
	inline static constexpr unsigned int CriManaMovieMaterialBase__RestartPlayerRoutine_d__65_TypeDefinitionIndex = 38837;
