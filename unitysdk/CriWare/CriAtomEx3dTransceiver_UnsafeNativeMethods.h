...
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_ATTACHAISAC_OFFSET UNITYSDK_OFFSET(0x1E7F2560)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_CREATE_OFFSET UNITYSDK_OFFSET(0x1E7F1E90)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E7F1F20)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SET3DREGIONHN_OFFSET UNITYSDK_OFFSET(0x1E7F2910)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETDISTANCEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1E7F2690)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTCROSSFADEFIELD_OFFSET UNITYSDK_OFFSET(0x1E7F2430)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTORIENTATION_OFFSET UNITYSDK_OFFSET(0x1E7F2120)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x1E7F2020)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETLISTENERBASEDAZIMUTHANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1E7F2710)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETLISTENERBASEDELEVATIONANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1E7F2790)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETMAXANGLEAISACDELTA_OFFSET UNITYSDK_OFFSET(0x1E7F2600)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTCONEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1E7F2240)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTINTERIORPANFIELD_OFFSET UNITYSDK_OFFSET(0x1E7F2390)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTMINMAXATTENUATIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x1E7F22F0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTORIENTATION_OFFSET UNITYSDK_OFFSET(0x1E7F21B0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x1E7F20A0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTVOLUME_OFFSET UNITYSDK_OFFSET(0x1E7F24D0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETTRANSCEIVEROUTPUTBASEDAZIMUTHANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1E7F2810)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETTRANSCEIVEROUTPUTBASEDELEVATIONANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1E7F2890)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E7F1FA0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx3dTransceiver_UnsafeNativeMethods_TypeDefinitionIndex = 34289;
