...
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_ATTACHAISAC_OFFSET UNITYSDK_OFFSET(0x11A022D0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_CREATE_OFFSET UNITYSDK_OFFSET(0x11A01400)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_DESTROY_OFFSET UNITYSDK_OFFSET(0x11A01590)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_DETACHAISAC_OFFSET UNITYSDK_OFFSET(0x11A02410)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SET3DREGIONHN_OFFSET UNITYSDK_OFFSET(0x11A02B70)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETDISTANCEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x11A02650)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTCROSSFADEFIELD_OFFSET UNITYSDK_OFFSET(0x11A02070)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTORIENTATION_OFFSET UNITYSDK_OFFSET(0x11A01A10)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x11A017C0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETLISTENERBASEDAZIMUTHANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x11A02750)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETLISTENERBASEDELEVATIONANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x11A02850)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETMAXANGLEAISACDELTA_OFFSET UNITYSDK_OFFSET(0x11A02540)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTCONEPARAMETER_OFFSET UNITYSDK_OFFSET(0x11A01CA0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTINTERIORPANFIELD_OFFSET UNITYSDK_OFFSET(0x11A01F30)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTMINMAXATTENUATIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x11A01DF0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTORIENTATION_OFFSET UNITYSDK_OFFSET(0x11A01B50)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x11A018E0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTVOLUME_OFFSET UNITYSDK_OFFSET(0x11A021A0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETTRANSCEIVEROUTPUTBASEDAZIMUTHANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x11A02950)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETTRANSCEIVEROUTPUTBASEDELEVATIONANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x11A02A50)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x11A016A0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx3dTransceiver_UnsafeNativeMethods_TypeDefinitionIndex = 31040;
