...
#define CRIWARE_CRIATOMEXOUTPUTPORT_CALCULATEWORKSIZE_OFFSET UNITYSDK_OFFSET(0x1B78E750)
#define CRIWARE_CRIATOMEXOUTPUTPORT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B78EBC0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B78EB40)
#define CRIWARE_CRIATOMEXOUTPUTPORT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B78EA70)
#define CRIWARE_CRIATOMEXOUTPUTPORT_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B78E740)
#define CRIWARE_CRIATOMEXOUTPUTPORT_GET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B78F190)
#define CRIWARE_CRIATOMEXOUTPUTPORT_ISDESTROYABLE_OFFSET UNITYSDK_OFFSET(0x1B78F090)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SETASRRACKID_OFFSET UNITYSDK_OFFSET(0x1B78ED70)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SETMONAURALMIX_OFFSET UNITYSDK_OFFSET(0x1B78EF90)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SETVIBRATIONCHANNELLEVEL_OFFSET UNITYSDK_OFFSET(0x1B78EE70)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B78F1A0)
#define CRIWARE_CRIATOMEXOUTPUTPORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B78EA20)
#define CRIWARE_CRIATOMEXOUTPUTPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78E8C0)
