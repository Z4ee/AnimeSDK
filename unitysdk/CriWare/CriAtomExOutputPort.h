...
#define CRIWARE_CRIATOMEXOUTPUTPORT_CALCULATEWORKSIZE_OFFSET UNITYSDK_OFFSET(0x1D367050)
#define CRIWARE_CRIATOMEXOUTPUTPORT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D3674C0)
#define CRIWARE_CRIATOMEXOUTPUTPORT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D367440)
#define CRIWARE_CRIATOMEXOUTPUTPORT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D367370)
#define CRIWARE_CRIATOMEXOUTPUTPORT_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1D367040)
#define CRIWARE_CRIATOMEXOUTPUTPORT_GET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1D367A90)
#define CRIWARE_CRIATOMEXOUTPUTPORT_ISDESTROYABLE_OFFSET UNITYSDK_OFFSET(0x1D367990)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SETASRRACKID_OFFSET UNITYSDK_OFFSET(0x1D367670)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SETMONAURALMIX_OFFSET UNITYSDK_OFFSET(0x1D367890)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SETVIBRATIONCHANNELLEVEL_OFFSET UNITYSDK_OFFSET(0x1D367770)
#define CRIWARE_CRIATOMEXOUTPUTPORT_SET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1D367AA0)
#define CRIWARE_CRIATOMEXOUTPUTPORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D367320)
#define CRIWARE_CRIATOMEXOUTPUTPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3671C0)
