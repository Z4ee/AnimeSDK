...
#define CRIWARE_CRIATOMEX_AISACCONTROLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2DFC5A0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_AisacControlInfo_TypeDefinitionIndex = 38668;
