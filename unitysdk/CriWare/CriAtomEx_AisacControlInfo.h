...
#define CRIWARE_CRIATOMEX_AISACCONTROLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2BD1BE0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_AisacControlInfo_TypeDefinitionIndex = 37012;
