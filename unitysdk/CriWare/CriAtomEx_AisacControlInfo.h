...
#define CRIWARE_CRIATOMEX_AISACCONTROLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14ED4D0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_AisacControlInfo_TypeDefinitionIndex = 30992;
