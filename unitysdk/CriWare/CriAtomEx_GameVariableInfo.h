...
#define CRIWARE_CRIATOMEX_GAMEVARIABLEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x14EDD00)
#define CRIWARE_CRIATOMEX_GAMEVARIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDCF0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_GameVariableInfo_TypeDefinitionIndex = 30997;
