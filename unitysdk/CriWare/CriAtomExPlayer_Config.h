...
#define CRIWARE_CRIATOMEXPLAYER_CONFIG_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x164CDEB0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExPlayer_Config_TypeDefinitionIndex = 38761;
