...
#define CRIWARE_CRIATOMTRANSCEIVER_APPLYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x1E4A5190)
#define CRIWARE_CRIATOMTRANSCEIVER_APPLYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E4A5C80)
#define CRIWARE_CRIATOMTRANSCEIVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E4A4E90)
#define CRIWARE_CRIATOMTRANSCEIVER_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4A62D0)
#define CRIWARE_CRIATOMTRANSCEIVER_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4A62C0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTFRONT_OFFSET UNITYSDK_OFFSET(0x1E4A48F0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTPOS_OFFSET UNITYSDK_OFFSET(0x1E4A48C0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTUP_OFFSET UNITYSDK_OFFSET(0x1E4A4920)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_REGION3D_OFFSET UNITYSDK_OFFSET(0x1E4A4950)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_TRANSCEIVERHN_OFFSET UNITYSDK_OFFSET(0x1E4A48A0)
#define CRIWARE_CRIATOMTRANSCEIVER_INITIALIZEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E4A5120)
#define CRIWARE_CRIATOMTRANSCEIVER_INTERNALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1E4A50A0)
#define CRIWARE_CRIATOMTRANSCEIVER_INTERNALINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E4A5020)
#define CRIWARE_CRIATOMTRANSCEIVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E4A5010)
#define CRIWARE_CRIATOMTRANSCEIVER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E4A4FE0)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTFRONT_OFFSET UNITYSDK_OFFSET(0x1E4A4910)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTPOS_OFFSET UNITYSDK_OFFSET(0x1E4A48E0)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTUP_OFFSET UNITYSDK_OFFSET(0x1E4A4940)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_REGION3D_OFFSET UNITYSDK_OFFSET(0x1E4A4960)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_TRANSCEIVERHN_OFFSET UNITYSDK_OFFSET(0x1E4A48B0)
#define CRIWARE_CRIATOMTRANSCEIVER_START_OFFSET UNITYSDK_OFFSET(0x1E4A4EA0)
#define CRIWARE_CRIATOMTRANSCEIVER_TRYSETAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1E4A62E0)
#define CRIWARE_CRIATOMTRANSCEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4A63F0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomTransceiver_TypeDefinitionIndex = 34254;
