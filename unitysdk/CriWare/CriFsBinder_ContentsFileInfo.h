...
#define CRIWARE_CRIFSBINDER_CONTENTSFILEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14F2770)

namespace CriWare
{
	inline static constexpr unsigned int CriFsBinder_ContentsFileInfo_TypeDefinitionIndex = 31126;
