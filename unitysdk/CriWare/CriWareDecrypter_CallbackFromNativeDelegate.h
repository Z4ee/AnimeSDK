...
#define CRIWARE_CRIWAREDECRYPTER_CALLBACKFROMNATIVEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E404720)
#define CRIWARE_CRIWAREDECRYPTER_CALLBACKFROMNATIVEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E404770)
#define CRIWARE_CRIWAREDECRYPTER_CALLBACKFROMNATIVEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E404430)
#define CRIWARE_CRIWAREDECRYPTER_CALLBACKFROMNATIVEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E404410)

namespace CriWare
{
	inline static constexpr unsigned int CriWareDecrypter_CallbackFromNativeDelegate_TypeDefinitionIndex = 34341;
