...
#define CRIWARE_CRIMANACONFIG_WEBGLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x146D58B0)

namespace CriWare
{
	inline static constexpr unsigned int CriManaConfig_WebGLConfig_TypeDefinitionIndex = 37210;
