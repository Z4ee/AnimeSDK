...
#define CRIWARE_CRIMANACONFIG_WEBGLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12C1C260)

namespace CriWare
{
	inline static constexpr unsigned int CriManaConfig_WebGLConfig_TypeDefinitionIndex = 36910;
