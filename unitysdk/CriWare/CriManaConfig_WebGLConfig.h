...
#define CRIWARE_CRIMANACONFIG_WEBGLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1F860620)

namespace CriWare
{
	inline static constexpr unsigned int CriManaConfig_WebGLConfig_TypeDefinitionIndex = 35021;
