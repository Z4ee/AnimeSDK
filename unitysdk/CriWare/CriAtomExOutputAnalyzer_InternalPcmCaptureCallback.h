...
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B78E570)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B78E620)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B78E540)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78E4D0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExOutputAnalyzer_InternalPcmCaptureCallback_TypeDefinitionIndex = 37892;
