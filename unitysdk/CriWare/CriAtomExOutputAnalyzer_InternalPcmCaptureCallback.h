...
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x164CAE10)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x164CAEC0)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x164CADE0)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_INTERNALPCMCAPTURECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x164CAD70)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExOutputAnalyzer_InternalPcmCaptureCallback_TypeDefinitionIndex = 38751;
