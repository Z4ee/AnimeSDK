...
#define CRIWARE_CRIATOMEX_CUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDC10)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_CueInfo_TypeDefinitionIndex = 30999;
