...
#define CRIWARE_CRIATOMEXAUXIN_CONFIG_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x11A102C0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAuxIn_Config_TypeDefinitionIndex = 31069;
