...
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7AAE50)
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7AAEB0)
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7AADC0)
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AADD0)

namespace CriWare
{
	inline static constexpr unsigned int CriAudioReadStream_Delegate_TypeDefinitionIndex = 37933;
