...
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12C00030)
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12C00090)
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x12BFFAB0)
#define CRIWARE_CRIAUDIOREADSTREAM_DELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x12C00010)

namespace CriWare
{
	inline static constexpr unsigned int CriAudioReadStream_Delegate_TypeDefinitionIndex = 36833;
