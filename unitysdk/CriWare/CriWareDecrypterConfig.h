...
#define CRIWARE_CRIWAREDECRYPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11A53940)

namespace CriWare
{
	inline static constexpr unsigned int CriWareDecrypterConfig_TypeDefinitionIndex = 31191;
