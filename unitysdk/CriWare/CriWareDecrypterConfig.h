...
#define CRIWARE_CRIWAREDECRYPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FF180)

namespace CriWare
{
	inline static constexpr unsigned int CriWareDecrypterConfig_TypeDefinitionIndex = 32816;
