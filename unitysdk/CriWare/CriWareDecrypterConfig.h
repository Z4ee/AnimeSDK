...
#define CRIWARE_CRIWAREDECRYPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8332E0)

namespace CriWare
{
	inline static constexpr unsigned int CriWareDecrypterConfig_TypeDefinitionIndex = 34369;
