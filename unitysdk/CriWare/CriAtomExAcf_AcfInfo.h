...
#define CRIWARE_CRIATOMEXACF_ACFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x3A17EE0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAcf_AcfInfo_TypeDefinitionIndex = 37880;
