...
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D3856F0)
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D3857A0)
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3856C0)
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D385650)

namespace CriWare
{
	inline static constexpr unsigned int CriErrorNotifier_ErrorCallbackFunc_TypeDefinitionIndex = 38851;
