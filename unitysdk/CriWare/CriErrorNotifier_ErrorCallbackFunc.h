...
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A34670)
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A34720)
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A34270)
#define CRIWARE_CRIERRORNOTIFIER_ERRORCALLBACKFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x11A33780)

namespace CriWare
{
	inline static constexpr unsigned int CriErrorNotifier_ErrorCallbackFunc_TypeDefinitionIndex = 31167;
