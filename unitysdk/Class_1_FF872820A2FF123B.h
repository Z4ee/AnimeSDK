...
#define CLASS_1_FF872820A2FF123B_METHOD_1_CBBB30978BA34B92_OFFSET UNITYSDK_OFFSET(0x1AAF86C0)
#define CLASS_1_FF872820A2FF123B__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAF8770)
...
{
public:
	::Class_1_C98B12E65C7C4800* ADCPPJNMGJP; // 0x10
	...
	::Class_1_46AC29DEBE45F8A8* GNLAGMCLFFI; // 0x28
	::Class_1_C4C2ACF3D9655BEA* MJGPGGNMDDC; // 0x30
