...
#define CLASS_3_D1551504425564A4_EVALUATE_OFFSET UNITYSDK_OFFSET(0xC0D5780)
#define CLASS_3_D1551504425564A4__CTOR_OFFSET UNITYSDK_OFFSET(0xC0D5750)

inline static constexpr unsigned int Class_3_D1551504425564A4_TypeDefinitionIndex = 48089;
