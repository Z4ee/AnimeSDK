...
#define CLASS_2_8BB678B015BA5C42_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185C1A70)
#define CLASS_2_8BB678B015BA5C42_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x185C1AB0)
#define CLASS_2_8BB678B015BA5C42_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x185C1B00)
#define CLASS_2_8BB678B015BA5C42_TICK_OFFSET UNITYSDK_OFFSET(0x185C1B50)
#define CLASS_2_8BB678B015BA5C42__CTOR_OFFSET UNITYSDK_OFFSET(0x185C1A60)

inline static constexpr unsigned int Class_2_8BB678B015BA5C42_TypeDefinitionIndex = 50899;

class Class_2_8BB678B015BA5C42 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TakeMission* Field_2_1; // 0x20
