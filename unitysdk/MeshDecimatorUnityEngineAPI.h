...
#define MESHDECIMATORUNITYENGINEAPI_DECMESH2MESH_OFFSET UNITYSDK_OFFSET(0x103417B0)
#define MESHDECIMATORUNITYENGINEAPI_MESH2DECMESH_OFFSET UNITYSDK_OFFSET(0x10340DF0)
#define MESHDECIMATORUNITYENGINEAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x103425B0)

inline static constexpr unsigned int MeshDecimatorUnityEngineAPI_TypeDefinitionIndex = 85905;
