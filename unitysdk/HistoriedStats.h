...
#define HISTORIEDSTATS_ADD_OFFSET UNITYSDK_OFFSET(0x1565FD70)
#define HISTORIEDSTATS_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1565FF20)
#define HISTORIEDSTATS_GET_MEAN_OFFSET UNITYSDK_OFFSET(0x1565FF00)
#define HISTORIEDSTATS_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1565FF40)
#define HISTORIEDSTATS_RECALCIFDIRTY_OFFSET UNITYSDK_OFFSET(0x1565FE10)
#define HISTORIEDSTATS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1565FF60)
#define HISTORIEDSTATS__CTOR_OFFSET UNITYSDK_OFFSET(0x1565FD10)
#define HISTORIEDSTATS___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15660070)

inline static constexpr unsigned int HistoriedStats_TypeDefinitionIndex = 49994;

class HistoriedStats : public ::System::Object
{
public:
	::Il2CppArray<::System::Single>* m_History; // 0x10
	::System::Single m_InvLength; // 0x18
	::System::Single m_Max; // 0x1C
	::System::Single m_Min; // 0x20
	::System::Int32 m_LastIndex; // 0x24
	::System::Boolean m_Ready; // 0x28
