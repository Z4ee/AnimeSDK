...
#define CLASS_1_5B567C8A01BAEDFE_166_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9D9D70)
#define CLASS_1_5B567C8A01BAEDFE_166_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9D9B80)
#define CLASS_1_5B567C8A01BAEDFE_166_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9D9C80)
#define CLASS_1_5B567C8A01BAEDFE_166_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9D9BF0)
#define CLASS_1_5B567C8A01BAEDFE_166_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9D9CD0)
#define CLASS_1_5B567C8A01BAEDFE_166_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9D9DC0)
#define CLASS_1_5B567C8A01BAEDFE_166_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9D9D90)
#define CLASS_1_5B567C8A01BAEDFE_166_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A9D9AD0)
#define CLASS_1_5B567C8A01BAEDFE_166_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9D9B30)
#define CLASS_1_5B567C8A01BAEDFE_166_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9D9D00)
#define CLASS_1_5B567C8A01BAEDFE_166_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9D9D60)
#define CLASS_1_5B567C8A01BAEDFE_166__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9D9E10)
#define CLASS_1_5B567C8A01BAEDFE_166__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9D9B50)
#define CLASS_1_5B567C8A01BAEDFE_166__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9D9B40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_166_TypeDefinitionIndex = 28025;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_166*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_166_TypeDefinitionIndex)->GetStaticField(0x67BA0);
	}
