...
#define CLASS_1_5B567C8A01BAEDFE_166_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19A1ABA0)
#define CLASS_1_5B567C8A01BAEDFE_166_CLONE_OFFSET UNITYSDK_OFFSET(0x19A1A9B0)
#define CLASS_1_5B567C8A01BAEDFE_166_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19A1AAB0)
#define CLASS_1_5B567C8A01BAEDFE_166_EQUALS_OFFSET UNITYSDK_OFFSET(0x19A1AA20)
#define CLASS_1_5B567C8A01BAEDFE_166_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A1AB00)
#define CLASS_1_5B567C8A01BAEDFE_166_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19A1ABF0)
#define CLASS_1_5B567C8A01BAEDFE_166_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19A1ABC0)
#define CLASS_1_5B567C8A01BAEDFE_166_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19A1A900)
#define CLASS_1_5B567C8A01BAEDFE_166_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19A1A960)
#define CLASS_1_5B567C8A01BAEDFE_166_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19A1AB30)
#define CLASS_1_5B567C8A01BAEDFE_166_WRITETO_OFFSET UNITYSDK_OFFSET(0x19A1AB90)
#define CLASS_1_5B567C8A01BAEDFE_166__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A1AC40)
#define CLASS_1_5B567C8A01BAEDFE_166__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A1A980)
#define CLASS_1_5B567C8A01BAEDFE_166__CTOR_OFFSET UNITYSDK_OFFSET(0x19A1A970)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_166_TypeDefinitionIndex = 28215;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_166*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_166_TypeDefinitionIndex)->GetStaticField(0x487F0);
	}
