...
#define CLASS_2_110EA8F5CE9D8DFC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17FD7C50)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17FD7C90)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17FD7E20)
#define CLASS_2_110EA8F5CE9D8DFC_TICK_OFFSET UNITYSDK_OFFSET(0x17FD7E70)
#define CLASS_2_110EA8F5CE9D8DFC__CTOR_OFFSET UNITYSDK_OFFSET(0x17FD7C40)
...
{
public:
	::RPG::GameCore::ShowGuide* OFKGLJOAMLD; // 0x18
