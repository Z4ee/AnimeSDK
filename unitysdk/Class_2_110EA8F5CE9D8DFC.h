...
#define CLASS_2_110EA8F5CE9D8DFC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13BD6F60)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13BD6FA0)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13BD7130)
#define CLASS_2_110EA8F5CE9D8DFC_TICK_OFFSET UNITYSDK_OFFSET(0x13BD7180)
#define CLASS_2_110EA8F5CE9D8DFC__CTOR_OFFSET UNITYSDK_OFFSET(0x13BD6F50)

inline static constexpr unsigned int Class_2_110EA8F5CE9D8DFC_TypeDefinitionIndex = 54805;

class Class_2_110EA8F5CE9D8DFC : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ShowGuide* Field_2_1; // 0x20
