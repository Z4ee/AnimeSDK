...
#define CLASS_2_110EA8F5CE9D8DFC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15A75E60)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15A75EA0)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15A76030)
#define CLASS_2_110EA8F5CE9D8DFC_TICK_OFFSET UNITYSDK_OFFSET(0x15A76080)
#define CLASS_2_110EA8F5CE9D8DFC__CTOR_OFFSET UNITYSDK_OFFSET(0x15A75E50)

inline static constexpr unsigned int Class_2_110EA8F5CE9D8DFC_TypeDefinitionIndex = 58807;

class Class_2_110EA8F5CE9D8DFC : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::ShowGuide* OFKGLJOAMLD; // 0x20
