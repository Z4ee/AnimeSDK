...
#define INSTANCETEST_APPLY_OFFSET UNITYSDK_OFFSET(0x177F6AB0)
#define INSTANCETEST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x177F6A60)
#define INSTANCETEST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x177F6A50)
#define INSTANCETEST_UNAPPLY_OFFSET UNITYSDK_OFFSET(0x177F6A80)
#define INSTANCETEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x177F6AA0)
#define INSTANCETEST__CTOR_OFFSET UNITYSDK_OFFSET(0x177F6BC0)

inline static constexpr unsigned int InstanceTest_TypeDefinitionIndex = 35938;
