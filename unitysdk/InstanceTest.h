...
#define INSTANCETEST_APPLY_OFFSET UNITYSDK_OFFSET(0x18E9FD10)
#define INSTANCETEST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18E9FCC0)
#define INSTANCETEST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18E9FCB0)
#define INSTANCETEST_UNAPPLY_OFFSET UNITYSDK_OFFSET(0x18E9FCE0)
#define INSTANCETEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x18E9FD00)
#define INSTANCETEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9FE20)

inline static constexpr unsigned int InstanceTest_TypeDefinitionIndex = 35156;
