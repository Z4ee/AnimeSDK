...
#define INSTANCETEST_APPLY_OFFSET UNITYSDK_OFFSET(0x180FCEB0)
#define INSTANCETEST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x180FCE60)
#define INSTANCETEST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x180FCE50)
#define INSTANCETEST_UNAPPLY_OFFSET UNITYSDK_OFFSET(0x180FCE80)
#define INSTANCETEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x180FCEA0)
#define INSTANCETEST__CTOR_OFFSET UNITYSDK_OFFSET(0x180FCFC0)

inline static constexpr unsigned int InstanceTest_TypeDefinitionIndex = 34873;
