...
#define INSTANCETEST_APPLY_OFFSET UNITYSDK_OFFSET(0x1C6645E0)
#define INSTANCETEST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C664590)
#define INSTANCETEST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C664580)
#define INSTANCETEST_UNAPPLY_OFFSET UNITYSDK_OFFSET(0x1C6645B0)
#define INSTANCETEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C6645D0)
#define INSTANCETEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6646F0)
