...
#define EVIRONMENTSYSTEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3F580)

inline static constexpr unsigned int EvironmentSystemConfig_TypeDefinitionIndex = 45519;
