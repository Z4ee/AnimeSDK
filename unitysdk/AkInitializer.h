...
#define AKINITIALIZER_AUTOCREATEIFNOTEXIST_OFFSET UNITYSDK_OFFSET(0x1C2A02E0)
#define AKINITIALIZER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C2A0500)
#define AKINITIALIZER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C2A0E80)
#define AKINITIALIZER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1C2A0BB0)
#define AKINITIALIZER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1C2A0AB0)
#define AKINITIALIZER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1C2A0C60)
#define AKINITIALIZER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C2A0A30)
#define AKINITIALIZER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C2A09A0)
#define AKINITIALIZER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C2A0710)
#define AKINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2A0F20)

inline static constexpr unsigned int AkInitializer_TypeDefinitionIndex = 31606;
...
public:
	...
	{
		return (::AkInitializer**)Il2CppClass::FromTypeDefinitionIndex(AkInitializer_TypeDefinitionIndex)->GetStaticField(0x25910);
	}
