...
#define AKINITIALIZER_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BB6440)
#define AKINITIALIZER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18BB6430)
#define AKINITIALIZER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18BB6A30)
#define AKINITIALIZER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x18BB68F0)
#define AKINITIALIZER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x18BB67D0)
#define AKINITIALIZER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x18BB6940)
#define AKINITIALIZER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BB6740)
#define AKINITIALIZER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18BB6640)
#define AKINITIALIZER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BB6540)
#define AKINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB6B20)
...
public:
	...
	{
		return (::AkInitializer**)Il2CppClass::FromTypeDefinitionIndex(AkInitializer_TypeDefinitionIndex)->GetStaticField(0x30920);
	}
