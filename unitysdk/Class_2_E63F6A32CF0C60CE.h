...
#define CLASS_2_E63F6A32CF0C60CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15735F80)
#define CLASS_2_E63F6A32CF0C60CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15736090)
#define CLASS_2_E63F6A32CF0C60CE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x157363F0)
#define CLASS_2_E63F6A32CF0C60CE_TICK_OFFSET UNITYSDK_OFFSET(0x15735FC0)
#define CLASS_2_E63F6A32CF0C60CE__CTOR_OFFSET UNITYSDK_OFFSET(0x15735F70)

inline static constexpr unsigned int Class_2_E63F6A32CF0C60CE_TypeDefinitionIndex = 53696;

class Class_2_E63F6A32CF0C60CE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::TravelShipNavigateTo* IGHAHBNLIJA; // 0x20
	::UnityEngine::Vector3 MAJNABOELDH; // 0x28
