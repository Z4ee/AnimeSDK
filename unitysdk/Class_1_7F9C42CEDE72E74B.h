...
#define CLASS_1_7F9C42CEDE72E74B_CLEAR_OFFSET UNITYSDK_OFFSET(0xC11DA40)
#define CLASS_1_7F9C42CEDE72E74B__CTOR_OFFSET UNITYSDK_OFFSET(0xC11DA90)
...
public:
	...
	::RPG::GameCore::FixPoint AJHHCOHFIFA; // 0x28
