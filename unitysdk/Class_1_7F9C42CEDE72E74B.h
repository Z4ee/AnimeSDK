...
#define CLASS_1_7F9C42CEDE72E74B_CLEAR_OFFSET UNITYSDK_OFFSET(0x123690A0)
#define CLASS_1_7F9C42CEDE72E74B__CTOR_OFFSET UNITYSDK_OFFSET(0x123690F0)

inline static constexpr unsigned int Class_1_7F9C42CEDE72E74B_TypeDefinitionIndex = 51653;

class Class_1_7F9C42CEDE72E74B : public ::System::Object
{
public:
	::RPG::GameCore::TaskContext* Field_1_3; // 0x10
	::Class_2_F3EEA4ED0244C1A6* Field_1_4; // 0x18
	::RPG::GameCore::GameEntity* Field_1_2; // 0x20
	::RPG::GameCore::FixPoint Field_1_0; // 0x28
	::RPG::GameCore::ElationPointModifyFunction Field_1_1; // 0x30
