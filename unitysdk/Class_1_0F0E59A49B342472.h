...
#define CLASS_1_0F0E59A49B342472_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FFFC90)
#define CLASS_1_0F0E59A49B342472_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1A000E70)
#define CLASS_1_0F0E59A49B342472_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x1A000E80)
#define CLASS_1_0F0E59A49B342472_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x1A000E90)
#define CLASS_1_0F0E59A49B342472_METHOD_1_1588CC8352F055BF_OFFSET UNITYSDK_OFFSET(0x1A000490)
#define CLASS_1_0F0E59A49B342472_METHOD_1_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x19FFFE50)
#define CLASS_1_0F0E59A49B342472_METHOD_1_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0x19FFFEC0)
#define CLASS_1_0F0E59A49B342472_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1A000DB0)
#define CLASS_1_0F0E59A49B342472_METHOD_1_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x19FFFBD0)
#define CLASS_1_0F0E59A49B342472_METHOD_1_6173AF17811AED4B_OFFSET UNITYSDK_OFFSET(0x19FFF830)
#define CLASS_1_0F0E59A49B342472_METHOD_1_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0x19FFF910)
#define CLASS_1_0F0E59A49B342472_METHOD_1_6DAEAFEF809DA236_OFFSET UNITYSDK_OFFSET(0x1A000190)
#define CLASS_1_0F0E59A49B342472_METHOD_1_AAD864A9DF964170_OFFSET UNITYSDK_OFFSET(0x19FFF340)
#define CLASS_1_0F0E59A49B342472_METHOD_1_D126A9270C6BEF9E_OFFSET UNITYSDK_OFFSET(0x1A0009B0)
#define CLASS_1_0F0E59A49B342472_METHOD_1_ECDD4B6593FA2BB9_OFFSET UNITYSDK_OFFSET(0x1A000A60)
#define CLASS_1_0F0E59A49B342472_METHOD_1_EE97EFC752A55D2E_OFFSET UNITYSDK_OFFSET(0x1A000D00)
#define CLASS_1_0F0E59A49B342472_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x1A000EA0)
#define CLASS_1_0F0E59A49B342472__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A000F20)
#define CLASS_1_0F0E59A49B342472__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFF130)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0F0E59A49B342472_TypeDefinitionIndex)->GetStaticField(0x15070);
	}
	::RPG::Client::AirlineBirdWay* PLOCJFAHLPK; // 0x10
	::System::Collections::Generic::List_1<::Class_1_FD711FBD7923B1D0*>* IFCAPLOMACM; // 0x18
	::System::String* JLKFFKGABBC; // 0x20
	::RPG::Client::AirshipBirdEmitter* DHOEAAPGHFK; // 0x28
	...
	::System::Single CBPJMLPBEIG; // 0x48
