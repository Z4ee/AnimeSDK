...
#define BONEADJUST_ADJUSTBONETRANSFORMBYONEBONELAYERDATAWITH2TARGETPOSE_OFFSET UNITYSDK_OFFSET(0x15CA7E70)
#define BONEADJUST_ADJUSTBONETRANSFORMBYSCATTER2DBLEND_OFFSET UNITYSDK_OFFSET(0x13D47440)
#define BONEADJUST_ADJUSTBONETRANSFORMBYVELOCITYIMPL_OFFSET UNITYSDK_OFFSET(0x15CA9CC0)
#define BONEADJUST_ADJUSTBONETRANSFORMBYVELOCITY_OFFSET UNITYSDK_OFFSET(0x15CA9770)
#define BONEADJUST_BLEND2DCOMPUTECHILDNODEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x15CA85B0)
#define BONEADJUST_GET_ANIMDIRVEC_OFFSET UNITYSDK_OFFSET(0x13D43DE0)
#define BONEADJUST_GET_ENABLEFORWARDLEANING_OFFSET UNITYSDK_OFFSET(0x13D43E00)
#define BONEADJUST_GET_ENABLEPITCHROLLBYGROUND_OFFSET UNITYSDK_OFFSET(0x13D43E20)
#define BONEADJUST_GET_FORCEENABLEKNEESMOOTH_OFFSET UNITYSDK_OFFSET(0x13D43D80)
#define BONEADJUST_GET_IKDIRVEC_OFFSET UNITYSDK_OFFSET(0x13D43DF0)
#define BONEADJUST_GET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x13D43D60)
#define BONEADJUST_GET_OVERRIDEDDOWNSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x13D43DC0)
#define BONEADJUST_GET_OVERRIDEDUPSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x13D43DA0)
#define BONEADJUST_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x13D43E40)
#define BONEADJUST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x13D495E0)
#define BONEADJUST_LIFTBONESACCORDINGIK_OFFSET UNITYSDK_OFFSET(0x15CAA220)
#define BONEADJUST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x13D45DC0)
#define BONEADJUST_ONLATEANIMAGEIK_OFFSET UNITYSDK_OFFSET(0x13D46980)
#define BONEADJUST_PITCHROLLBYGROUND_OFFSET UNITYSDK_OFFSET(0x15CAA4B0)
#define BONEADJUST_RECORDANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x13D45550)
#define BONEADJUST_SET_ENABLEFORWARDLEANING_OFFSET UNITYSDK_OFFSET(0x13D43E10)
#define BONEADJUST_SET_ENABLEPITCHROLLBYGROUND_OFFSET UNITYSDK_OFFSET(0x13D43E30)
#define BONEADJUST_SET_FORCEENABLEKNEESMOOTH_OFFSET UNITYSDK_OFFSET(0x13D43D90)
#define BONEADJUST_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x13D43D70)
#define BONEADJUST_SET_OVERRIDEDDOWNSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x13D43DD0)
#define BONEADJUST_SET_OVERRIDEDUPSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x13D43DB0)
#define BONEADJUST_SMOOTHKNEE_OFFSET UNITYSDK_OFFSET(0x13D469F0)
#define BONEADJUST_START_OFFSET UNITYSDK_OFFSET(0x13D45500)
#define BONEADJUST_TRYRAYCASTGROUND_OFFSET UNITYSDK_OFFSET(0x15CAAD30)
#define BONEADJUST_UPDATE_OFFSET UNITYSDK_OFFSET(0x13D45CA0)
#define BONEADJUST__CCTOR_OFFSET UNITYSDK_OFFSET(0x15CAB5B0)
#define BONEADJUST__CTOR_OFFSET UNITYSDK_OFFSET(0x15CAB350)

inline static constexpr unsigned int BoneAdjust_TypeDefinitionIndex = 85473;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(BoneAdjust_TypeDefinitionIndex)->GetStaticField(0x36280);
	}
