...
#define BONEADJUST_ADJUSTBONETRANSFORMBYONEBONELAYERDATAWITH2TARGETPOSE_OFFSET UNITYSDK_OFFSET(0x11669F30)
#define BONEADJUST_ADJUSTBONETRANSFORMBYSCATTER2DBLEND_OFFSET UNITYSDK_OFFSET(0x11666840)
#define BONEADJUST_ADJUSTBONETRANSFORMBYVELOCITYIMPL_OFFSET UNITYSDK_OFFSET(0x1166B830)
#define BONEADJUST_ADJUSTBONETRANSFORMBYVELOCITY_OFFSET UNITYSDK_OFFSET(0x116689E0)
#define BONEADJUST_BLEND2DCOMPUTECHILDNODEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1166A670)
#define BONEADJUST_GET_ANIMDIRVEC_OFFSET UNITYSDK_OFFSET(0x116631E0)
#define BONEADJUST_GET_ENABLEFORWARDLEANING_OFFSET UNITYSDK_OFFSET(0x11663200)
#define BONEADJUST_GET_ENABLEPITCHROLLBYGROUND_OFFSET UNITYSDK_OFFSET(0x11663220)
#define BONEADJUST_GET_FORCEENABLEKNEESMOOTH_OFFSET UNITYSDK_OFFSET(0x11663180)
#define BONEADJUST_GET_IKDIRVEC_OFFSET UNITYSDK_OFFSET(0x116631F0)
#define BONEADJUST_GET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x11663160)
#define BONEADJUST_GET_OVERRIDEDDOWNSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x116631C0)
#define BONEADJUST_GET_OVERRIDEDUPSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x116631A0)
#define BONEADJUST_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x11663240)
#define BONEADJUST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11668F30)
#define BONEADJUST_LIFTBONESACCORDINGIK_OFFSET UNITYSDK_OFFSET(0x11668F90)
#define BONEADJUST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x116651C0)
#define BONEADJUST_ONLATEANIMAGEIK_OFFSET UNITYSDK_OFFSET(0x11665D80)
#define BONEADJUST_PITCHROLLBYGROUND_OFFSET UNITYSDK_OFFSET(0x11669220)
#define BONEADJUST_RECORDANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x11664950)
#define BONEADJUST_SET_ENABLEFORWARDLEANING_OFFSET UNITYSDK_OFFSET(0x11663210)
#define BONEADJUST_SET_ENABLEPITCHROLLBYGROUND_OFFSET UNITYSDK_OFFSET(0x11663230)
#define BONEADJUST_SET_FORCEENABLEKNEESMOOTH_OFFSET UNITYSDK_OFFSET(0x11663190)
#define BONEADJUST_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x11663170)
#define BONEADJUST_SET_OVERRIDEDDOWNSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x116631D0)
#define BONEADJUST_SET_OVERRIDEDUPSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x116631B0)
#define BONEADJUST_SMOOTHKNEE_OFFSET UNITYSDK_OFFSET(0x11665DF0)
#define BONEADJUST_START_OFFSET UNITYSDK_OFFSET(0x11664900)
#define BONEADJUST_UPDATE_OFFSET UNITYSDK_OFFSET(0x116650A0)
#define BONEADJUST__CTOR_OFFSET UNITYSDK_OFFSET(0x1166BD90)

inline static constexpr unsigned int BoneAdjust_TypeDefinitionIndex = 72033;
...
public:
	...
	::System::Boolean _EnablePitchRollByGround_k__BackingField; // 0x190
	::System::Single prevHeightDiff; // 0x194
