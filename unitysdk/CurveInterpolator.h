...
#define CURVEINTERPOLATOR_CATMULL3_OFFSET UNITYSDK_OFFSET(0x1821C3D0)
#define CURVEINTERPOLATOR_CATMULLN_OFFSET UNITYSDK_OFFSET(0x1821C6D0)
#define CURVEINTERPOLATOR_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x1821C880)
#define CURVEINTERPOLATOR_EVALUATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1821BFB0)
#define CURVEINTERPOLATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1821BF10)
#define CURVEINTERPOLATOR_LERP2_OFFSET UNITYSDK_OFFSET(0x1821C2A0)
#define CURVEINTERPOLATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1821BEA0)

inline static constexpr unsigned int CurveInterpolator_TypeDefinitionIndex = 64280;
