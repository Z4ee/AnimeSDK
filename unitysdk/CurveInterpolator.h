...
#define CURVEINTERPOLATOR_CATMULL3_OFFSET UNITYSDK_OFFSET(0x14512870)
#define CURVEINTERPOLATOR_CATMULLN_OFFSET UNITYSDK_OFFSET(0x14512B70)
#define CURVEINTERPOLATOR_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x14512D20)
#define CURVEINTERPOLATOR_EVALUATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x14512450)
#define CURVEINTERPOLATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x145123B0)
#define CURVEINTERPOLATOR_LERP2_OFFSET UNITYSDK_OFFSET(0x14512740)
#define CURVEINTERPOLATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x14512340)

inline static constexpr unsigned int CurveInterpolator_TypeDefinitionIndex = 56056;
