...
#define CLASS_2_AC40BF112363AD76_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F8A480)
#define CLASS_2_AC40BF112363AD76_METHOD_2_1C59EE3D21C209B4_OFFSET UNITYSDK_OFFSET(0x17F8A6F0)
#define CLASS_2_AC40BF112363AD76_METHOD_2_CF293F7C02C74631_OFFSET UNITYSDK_OFFSET(0x17F8A870)
#define CLASS_2_AC40BF112363AD76_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17F8A4C0)
#define CLASS_2_AC40BF112363AD76_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17F8A7C0)
#define CLASS_2_AC40BF112363AD76_TICK_OFFSET UNITYSDK_OFFSET(0x17F8A810)
#define CLASS_2_AC40BF112363AD76__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8A470)
#define CLASS_2_AC40BF112363AD76___GETACTIONBAREFFECTTEXTPARAMS_B__6_0_OFFSET UNITYSDK_OFFSET(0x17F8A9B0)
#define CLASS_2_AC40BF112363AD76___GETACTIONBARSINGLEACTIONEFFECTPARAMS_B__5_0_OFFSET UNITYSDK_OFFSET(0x17F8A940)
...
{
public:
	::RPG::GameCore::ShowActionBarEffect* OFKGLJOAMLD; // 0x18
