...
class Class_1_6C2797E3349B53EE_1;
...
#define CLASS_2_850C234AA2B8A0A3_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCD31790)
#define CLASS_2_850C234AA2B8A0A3_GET_DISPOSED_OFFSET UNITYSDK_OFFSET(0xCD393D0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_029F0C6DBB8AC745_OFFSET UNITYSDK_OFFSET(0xCD39180)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_06608D365EA50724_OFFSET UNITYSDK_OFFSET(0xCD37AB0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_1792F44D8A28BBA5_OFFSET UNITYSDK_OFFSET(0xCD37790)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_199CB10F8BF6CEF4_OFFSET UNITYSDK_OFFSET(0xCD359B0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_20D2EE25D15C1A41_OFFSET UNITYSDK_OFFSET(0xCD37640)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_29EF15CD94593AAE_OFFSET UNITYSDK_OFFSET(0xCD33D70)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_416B804F4ABC78EC_OFFSET UNITYSDK_OFFSET(0xCD343D0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_4F4AFFC911B3D4AA_OFFSET UNITYSDK_OFFSET(0xCD34990)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_51BE7F0CD6759F40_OFFSET UNITYSDK_OFFSET(0xCD34550)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_53BD888AED7AAE33_OFFSET UNITYSDK_OFFSET(0xCD33110)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_70D6A5484CC294F3_OFFSET UNITYSDK_OFFSET(0xCD318E0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_79335F97BF9F9923_OFFSET UNITYSDK_OFFSET(0xCD37FD0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_7EE311423AAF2EBA_OFFSET UNITYSDK_OFFSET(0xCD38FE0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_87B3FEE9DCD52DFC_OFFSET UNITYSDK_OFFSET(0xCD35390)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_A08592C92206725D_OFFSET UNITYSDK_OFFSET(0xCD32F90)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_B6066EDABA9658FF_1_OFFSET UNITYSDK_OFFSET(0xCD347C0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_B6066EDABA9658FF_OFFSET UNITYSDK_OFFSET(0xCD345F0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_BFFE0D476A0214C1_OFFSET UNITYSDK_OFFSET(0xCD31AD0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_C2DEBF51B6B0C21F_OFFSET UNITYSDK_OFFSET(0xCD34BD0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_C693EE9B34491FF7_OFFSET UNITYSDK_OFFSET(0xCD37910)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_D0AE1786157F8347_OFFSET UNITYSDK_OFFSET(0xCD33E00)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_E61B723F9C6B7CFD_OFFSET UNITYSDK_OFFSET(0xCD34FE0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_F12E7C59B11C586B_OFFSET UNITYSDK_OFFSET(0xCD36060)
#define CLASS_2_850C234AA2B8A0A3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xCD31BB0)
#define CLASS_2_850C234AA2B8A0A3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xCD34320)
#define CLASS_2_850C234AA2B8A0A3_SET_DISPOSED_OFFSET UNITYSDK_OFFSET(0xCD393E0)
#define CLASS_2_850C234AA2B8A0A3_TICK_OFFSET UNITYSDK_OFFSET(0xCD34370)
#define CLASS_2_850C234AA2B8A0A3__CTOR_OFFSET UNITYSDK_OFFSET(0xCD316E0)

inline static constexpr unsigned int Class_2_850C234AA2B8A0A3_TypeDefinitionIndex = 50714;

class Class_2_850C234AA2B8A0A3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_2; // 0x18
	::Class_1_827373C1CEDFE355* Field_2_3; // 0x20
	::RPG::GameCore::DamageByAttackProperty* Field_2_1; // 0x28
	::System::Collections::Generic::List_1<::Class_1_C1EF032BF58D5C23*>* Field_2_5; // 0x30
	...
	::Class_1_C1EF032BF58D5C23* Method_2_70D6A5484CC294F3()
	{
		return ((::Class_1_C1EF032BF58D5C23*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_70D6A5484CC294F3_OFFSET))(this);
	}

	::System::Void Method_2_BFFE0D476A0214C1(::Class_1_C1EF032BF58D5C23* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_C1EF032BF58D5C23*))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_BFFE0D476A0214C1_OFFSET))(this, a1);
	}
	...
	::System::Boolean Method_2_53BD888AED7AAE33(::Class_1_6C2797E3349B53EE_1* a1)
	{
		return ((::System::Boolean(*)(::PVOID, ::Class_1_6C2797E3349B53EE_1*))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_53BD888AED7AAE33_OFFSET))(this, a1);
	}
	...
	static ::System::Boolean Method_2_F12E7C59B11C586B(::RPG::GameCore::TaskContext* a1, ::RPG::GameCore::DamageByAttackProperty* a2, ::Class_1_256D9F63CEA2C6FD* a3, ::RPG::GameCore::TurnBasedAbilityComponent* a4, ::RPG::GameCore::TurnBasedAbilityComponent* a5, ::RPG::GameCore::GameEntity* a6, ::RPG::GameCore::GameEntity* a7, ::RPG::GameCore::GameEntity* a8, ::System::Boolean a9, ::Class_3_E21F6DE9B7FA4D05* a10)
	{
		return ((::System::Boolean(*)(::RPG::GameCore::TaskContext*, ::RPG::GameCore::DamageByAttackProperty*, ::Class_1_256D9F63CEA2C6FD*, ::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::GameEntity*, ::System::Boolean, ::Class_3_E21F6DE9B7FA4D05*))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_F12E7C59B11C586B_OFFSET))(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
	}

	static ::System::Void Method_2_20D2EE25D15C1A41(::RPG::GameCore::TaskContext* a1, ::RPG::GameCore::GameEntity* a2, ::RPG::GameCore::GameEntity* a3, ::RPG::GameCore::AttackData* a4, ::Class_1_256D9F63CEA2C6FD* a5, ::Struct_2_E03B78B927A9E70C_1 a6)
	{
		return ((::System::Void(*)(::RPG::GameCore::TaskContext*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::AttackData*, ::Class_1_256D9F63CEA2C6FD*, ::Struct_2_E03B78B927A9E70C_1))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_20D2EE25D15C1A41_OFFSET))(a1, a2, a3, a4, a5, a6);
	}
	...
	static ::System::Void Method_2_199CB10F8BF6CEF4(::RPG::GameCore::TurnBasedAbilityComponent* a1, ::RPG::GameCore::GameEntity* a2, ::Class_1_256D9F63CEA2C6FD* a3, ::Class_3_E21F6DE9B7FA4D05* a4)
	{
		return ((::System::Void(*)(::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::GameEntity*, ::Class_1_256D9F63CEA2C6FD*, ::Class_3_E21F6DE9B7FA4D05*))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_199CB10F8BF6CEF4_OFFSET))(a1, a2, a3, a4);
	}
	...
	::System::Void Method_2_A08592C92206725D(::RPG::GameCore::TurnBasedAbilityComponent* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::TurnBasedAbilityComponent*))((::PBYTE)hIl2Cpp + CLASS_2_850C234AA2B8A0A3_METHOD_2_A08592C92206725D_OFFSET))(this, a1);
	}
