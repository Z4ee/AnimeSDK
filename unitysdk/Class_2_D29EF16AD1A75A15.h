...
#define CLASS_2_D29EF16AD1A75A15_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A084220)
#define CLASS_2_D29EF16AD1A75A15_METHOD_2_6A535332060949F6_OFFSET UNITYSDK_OFFSET(0x1A084260)
#define CLASS_2_D29EF16AD1A75A15_METHOD_2_BEFE21FC0773CE57_OFFSET UNITYSDK_OFFSET(0x1A0848B0)
#define CLASS_2_D29EF16AD1A75A15_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A084400)
#define CLASS_2_D29EF16AD1A75A15_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A084B90)
#define CLASS_2_D29EF16AD1A75A15_TICK_OFFSET UNITYSDK_OFFSET(0x1A084BE0)
#define CLASS_2_D29EF16AD1A75A15__CTOR_OFFSET UNITYSDK_OFFSET(0x1A084210)

inline static constexpr unsigned int Class_2_D29EF16AD1A75A15_TypeDefinitionIndex = 53519;

class Class_2_D29EF16AD1A75A15 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShiftLocalPlayerByAnchor* OFKGLJOAMLD; // 0x18
