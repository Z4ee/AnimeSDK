...
#define CLASS_2_D29EF16AD1A75A15_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96765E0)
#define CLASS_2_D29EF16AD1A75A15_METHOD_2_6A535332060949F6_OFFSET UNITYSDK_OFFSET(0x9676620)
#define CLASS_2_D29EF16AD1A75A15_METHOD_2_BEFE21FC0773CE57_OFFSET UNITYSDK_OFFSET(0x9676C30)
#define CLASS_2_D29EF16AD1A75A15_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x96767F0)
#define CLASS_2_D29EF16AD1A75A15_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9676F10)
#define CLASS_2_D29EF16AD1A75A15_TICK_OFFSET UNITYSDK_OFFSET(0x9676F60)
#define CLASS_2_D29EF16AD1A75A15__CTOR_OFFSET UNITYSDK_OFFSET(0x96765D0)

inline static constexpr unsigned int Class_2_D29EF16AD1A75A15_TypeDefinitionIndex = 49115;

class Class_2_D29EF16AD1A75A15 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShiftLocalPlayerByAnchor* Field_2_0; // 0x18
