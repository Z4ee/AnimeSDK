...
#define CLASS_1_D8203AFB32E9259C_DISPATCHPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0xCA6ED00)
#define CLASS_1_D8203AFB32E9259C_GET_DESCTABLE_OFFSET UNITYSDK_OFFSET(0xCA6F510)
#define CLASS_1_D8203AFB32E9259C_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCA6F4E0)
#define CLASS_1_D8203AFB32E9259C_GET_PROPERTYTABLE_OFFSET UNITYSDK_OFFSET(0xCA6F500)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_025C809DC116AF4A_OFFSET UNITYSDK_OFFSET(0xCA70790)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_04412667112B3991_OFFSET UNITYSDK_OFFSET(0xCA72B40)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_0AC4757773CE644B_OFFSET UNITYSDK_OFFSET(0xCA722E0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCA72CE0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_5285E499CCD89702_OFFSET UNITYSDK_OFFSET(0xCA72D40)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_5546C71AF7082535_OFFSET UNITYSDK_OFFSET(0xCA6EB70)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_56B9555826E06CEF_OFFSET UNITYSDK_OFFSET(0xCA6FCA0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_5939263D2FF2ED03_OFFSET UNITYSDK_OFFSET(0xCA6EA10)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_59399DAE4B1E150D_OFFSET UNITYSDK_OFFSET(0xCA71150)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_7468C2333FD0284B_OFFSET UNITYSDK_OFFSET(0xCA72130)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_74EB3559221F6DCB_OFFSET UNITYSDK_OFFSET(0xCA71680)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_7AB417CD73CB3735_OFFSET UNITYSDK_OFFSET(0xCA72AE0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_7F687CA13EE0372F_OFFSET UNITYSDK_OFFSET(0xCA6E8B0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_84EAB34EABC7F508_OFFSET UNITYSDK_OFFSET(0xCA71210)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_86D2CA735F7A7EB3_OFFSET UNITYSDK_OFFSET(0xCA6E770)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_89C03AF435ED2C78_OFFSET UNITYSDK_OFFSET(0xCA6F910)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_8EDB7FE5AA37C50F_OFFSET UNITYSDK_OFFSET(0xCA72D30)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_A4E0A8C1DDA0F425_OFFSET UNITYSDK_OFFSET(0xCA70A10)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0xCA6ED50)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_B3EFF5DBF1A65C79_OFFSET UNITYSDK_OFFSET(0xCA71350)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_B68BB63C6CEE57D3_OFFSET UNITYSDK_OFFSET(0xCA72C60)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xCA6FAA0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_D41059BB825399DF_OFFSET UNITYSDK_OFFSET(0xCA6FD60)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_D47D06B2A9235FEB_OFFSET UNITYSDK_OFFSET(0xCA70970)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_D6D04DC49729A6DD_OFFSET UNITYSDK_OFFSET(0xCA6E410)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_DE0F12B756C00FC9_OFFSET UNITYSDK_OFFSET(0xCA6F570)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_E1F3EADF46C38068_OFFSET UNITYSDK_OFFSET(0xCA6E390)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_E9A0EBE21D21BA0B_OFFSET UNITYSDK_OFFSET(0xCA71FE0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_EDBE0DAF47EEEEED_OFFSET UNITYSDK_OFFSET(0xCA70900)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0xCA70140)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xCA71EB0)
#define CLASS_1_D8203AFB32E9259C_METHOD_1_F661BF3915CFFD3D_OFFSET UNITYSDK_OFFSET(0xCA72CD0)
#define CLASS_1_D8203AFB32E9259C_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCA72280)
#define CLASS_1_D8203AFB32E9259C__CCTOR_OFFSET UNITYSDK_OFFSET(0xCA6DF70)
#define CLASS_1_D8203AFB32E9259C__CTOR_OFFSET UNITYSDK_OFFSET(0xCA72DC0)
...
public:
	...
	{
		return (::Class_1_AEC4D667AA9BE4FB**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D8203AFB32E9259C_TypeDefinitionIndex)->GetStaticField(0x592F0);
	}
	static ::RPG::GameCore::RtSkillTargetInfo** StaticGet_NIANAMPHOJJ()
	{
		return (::RPG::GameCore::RtSkillTargetInfo**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D8203AFB32E9259C_TypeDefinitionIndex)->GetStaticField(0x592F8);
	}
	::Il2CppArray<::System::String*>* JCJODLLDMLK; // 0x10
	::RPG::GameCore::GameEntity* DJEDKEGDJGE; // 0x18
	::System::String* OENAMINOLLF; // 0x20
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* ILIPCNCIPBB; // 0x28
	::RPG::GameCore::RtSkillConfig* EABKOHGCHFP; // 0x30
	::Class_0_16E4307DCC419505_522* IMFHKMBAOKN; // 0x38
	::Class_1_5F51D4049EA87B7B* CJEBNGMMHII; // 0x40
	::Class_1_5F51D4049EA87B7B* DJHOAONPLLH; // 0x48
	::RPG::GameCore::GameEntity* CNONKDPOJLC; // 0x50
	::Il2CppArray<::Class_1_11F507CAFD9CD2DF*>* KGLOIHNOFCM; // 0x58
	::Class_2_0299C3274218DF36* HKAGAPCAJDE; // 0x60
	::Class_2_99871FCF90B6E8A6* PHEKPAADNKB; // 0x68
	::System::Action_1<::Class_2_F3B643C4D5BD11F2*>* EDCMBLLIICC; // 0x70
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* KGKEPIJIABL; // 0x78
	::Class_2_F3B643C4D5BD11F2* CIFJFKPIJMN; // 0x80
	::RPG::GameCore::SkillEffect KOMCEJDJIIL; // 0x88
	::RPG::GameCore::AttackType HIFKEKCELFB; // 0x8C
	::RPG::GameCore::FixPoint PMFOPBEEDBI; // 0x90
	::System::Int32 KBAPBCNJHDB; // 0x98
	::RPG::GameCore::RtSkillState DLNIGFGLPLJ; // 0x9C
