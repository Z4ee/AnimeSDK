...
#define CLASS_4_B99AA5AE371451AA_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x180705F0)
#define CLASS_4_B99AA5AE371451AA_METHOD_4_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x18070880)
#define CLASS_4_B99AA5AE371451AA_METHOD_4_528BD4865C714C5C_OFFSET UNITYSDK_OFFSET(0x18070890)
#define CLASS_4_B99AA5AE371451AA_METHOD_4_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x18070A90)
#define CLASS_4_B99AA5AE371451AA_METHOD_4_9F34110CB06313DC_OFFSET UNITYSDK_OFFSET(0x18070940)
#define CLASS_4_B99AA5AE371451AA_METHOD_4_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x180708B0)
#define CLASS_4_B99AA5AE371451AA_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x180706C0)
#define CLASS_4_B99AA5AE371451AA__CCTOR_OFFSET UNITYSDK_OFFSET(0x18070640)
#define CLASS_4_B99AA5AE371451AA__CTOR_OFFSET UNITYSDK_OFFSET(0x180707B0)

inline static constexpr unsigned int Class_4_B99AA5AE371451AA_TypeDefinitionIndex = 66933;

class Class_4_B99AA5AE371451AA : public ::Class_3_95932C222EBC5BA5
{
public:
	// static const ::System::Int32 Field_4_0 = 0x227; // 0x0
	// static const ::System::String* Field_4_1; // 0x0
	::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::RenderDataHandle>* Field_4_4; // 0x50
	::Class_1_EDF7E2913A3DD535* Field_4_3; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* Field_4_5; // 0x60
	::System::Int64 Field_4_2; // 0x68
