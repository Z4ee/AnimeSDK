...
#define SRF_UI_STYLE_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1E6BA410)
#define SRF_UI_STYLE_COPY_OFFSET UNITYSDK_OFFSET(0x1E6BA350)
#define SRF_UI_STYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6BA3F0)
