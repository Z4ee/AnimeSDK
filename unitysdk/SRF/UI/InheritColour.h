...
#define SRF_UI_INHERITCOLOUR_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x184700B0)
#define SRF_UI_INHERITCOLOUR_REFRESH_OFFSET UNITYSDK_OFFSET(0x18470140)
#define SRF_UI_INHERITCOLOUR_START_OFFSET UNITYSDK_OFFSET(0x184702E0)
#define SRF_UI_INHERITCOLOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x184702D0)
#define SRF_UI_INHERITCOLOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x184702F0)

namespace SRF::UI
{
	inline static constexpr unsigned int InheritColour_TypeDefinitionIndex = 27668;
