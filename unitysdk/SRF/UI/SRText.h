...
#define SRF_UI_SRTEXT_ADD_LAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x1E6B2DF0)
#define SRF_UI_SRTEXT_REMOVE_LAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x1E6B30A0)
#define SRF_UI_SRTEXT_SETLAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x1E6B9F10)
#define SRF_UI_SRTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6B9F50)
