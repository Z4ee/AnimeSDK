...
#define SRF_UI_RESPONSIVEBASE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x1CEDC490)
#define SRF_UI_RESPONSIVEBASE_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1CEDC390)
#define SRF_UI_RESPONSIVEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CEDC3E0)
#define SRF_UI_RESPONSIVEBASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1CEDC3F0)
#define SRF_UI_RESPONSIVEBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CEDC400)
#define SRF_UI_RESPONSIVEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDC510)

namespace SRF::UI
{
	inline static constexpr unsigned int ResponsiveBase_TypeDefinitionIndex = 33947;
