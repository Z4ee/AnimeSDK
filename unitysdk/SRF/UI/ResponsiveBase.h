...
#define SRF_UI_RESPONSIVEBASE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x18473DA0)
#define SRF_UI_RESPONSIVEBASE_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18473D00)
#define SRF_UI_RESPONSIVEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18473D50)
#define SRF_UI_RESPONSIVEBASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x18473D60)
#define SRF_UI_RESPONSIVEBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x18473D70)
#define SRF_UI_RESPONSIVEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18473DB0)

namespace SRF::UI
{
	inline static constexpr unsigned int ResponsiveBase_TypeDefinitionIndex = 27670;
