...
#define SRF_UI_COPYPREFERREDSIZE_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AD20B10)
#define SRF_UI_COPYPREFERREDSIZE_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AD20AA0)
#define SRF_UI_COPYPREFERREDSIZE_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1AD20A30)
#define SRF_UI_COPYPREFERREDSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD20B20)

namespace SRF::UI
{
	inline static constexpr unsigned int CopyPreferredSize_TypeDefinitionIndex = 33570;
