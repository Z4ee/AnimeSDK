...
#define SRF_UI_SRSPINNER_SPINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDDB30)

namespace SRF::UI
{
	inline static constexpr unsigned int SRSpinner_SpinEvent_TypeDefinitionIndex = 33958;
