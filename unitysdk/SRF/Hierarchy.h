...
#define SRF_HIERARCHY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CECD6C0)
#define SRF_HIERARCHY_GET_OFFSET UNITYSDK_OFFSET(0x1CECD6F0)
#define SRF_HIERARCHY_RUNTIMEINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CECDA00)
#define SRF_HIERARCHY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CECDAA0)
#define SRF_HIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECDA90)
...
namespace SRF
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Hierarchy_TypeDefinitionIndex)->GetStaticField(0x438C0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Transform*>** StaticGet_Cache()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(Hierarchy_TypeDefinitionIndex)->GetStaticField(0x438C8);
		}
