...
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CECD680)
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CECD6B0)
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CECCEF0)
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECD610)

namespace SRF::Helpers
{
	inline static constexpr unsigned int PropertyValueChangedHandler_TypeDefinitionIndex = 33990;
