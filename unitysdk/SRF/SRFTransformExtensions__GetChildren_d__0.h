...
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19EA62D0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_TRANSFORM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19EA63C0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_TRANSFORM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19EA6350)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19EA6440)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19EA63B0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19EA6360)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19EA62C0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA5C80)

namespace SRF
{
	inline static constexpr unsigned int SRFTransformExtensions__GetChildren_d__0_TypeDefinitionIndex = 33284;
