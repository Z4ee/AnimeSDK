...
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E6AE240)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_TRANSFORM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E6AE330)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_TRANSFORM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E6AE2C0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E6AE3B0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E6AE320)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E6AE2D0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E6AE230)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6ADAB0)
...
namespace SRF
{
	...
	{
	public:
		::UnityEngine::Transform* __3__t; // 0x10
