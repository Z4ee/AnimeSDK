...
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CED1A10)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_TRANSFORM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CED1B00)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_TRANSFORM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CED1A90)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CED1B80)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CED1AF0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CED1AA0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CED1A00)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED1280)

namespace SRF
{
	inline static constexpr unsigned int SRFTransformExtensions__GetChildren_d__0_TypeDefinitionIndex = 33937;
