...
#define SRF_COROUTINES__WAITFORSECONDSREALTIME_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E6A89B0)
#define SRF_COROUTINES__WAITFORSECONDSREALTIME_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E6A8A30)
#define SRF_COROUTINES__WAITFORSECONDSREALTIME_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E6A8A90)
#define SRF_COROUTINES__WAITFORSECONDSREALTIME_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E6A8A40)
#define SRF_COROUTINES__WAITFORSECONDSREALTIME_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E6A89A0)
#define SRF_COROUTINES__WAITFORSECONDSREALTIME_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6A8990)
