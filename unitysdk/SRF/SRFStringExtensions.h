...
#define SRF_SRFSTRINGEXTENSIONS_FMT_OFFSET UNITYSDK_OFFSET(0x1CECC010)

namespace SRF
{
	inline static constexpr unsigned int SRFStringExtensions_TypeDefinitionIndex = 33935;
