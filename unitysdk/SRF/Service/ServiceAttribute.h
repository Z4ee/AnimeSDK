...
#define SRF_SERVICE_SERVICEATTRIBUTE_GET_SERVICETYPE_OFFSET UNITYSDK_OFFSET(0x1CED5EE0)
#define SRF_SERVICE_SERVICEATTRIBUTE_SET_SERVICETYPE_OFFSET UNITYSDK_OFFSET(0x1CED5EF0)
#define SRF_SERVICE_SERVICEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED5ED0)

namespace SRF::Service
{
	inline static constexpr unsigned int ServiceAttribute_TypeDefinitionIndex = 33971;
