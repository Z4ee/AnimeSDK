...
#define SRF_SERVICE_SERVICEATTRIBUTE_GET_SERVICETYPE_OFFSET UNITYSDK_OFFSET(0x1EC41F10)
#define SRF_SERVICE_SERVICEATTRIBUTE_SET_SERVICETYPE_OFFSET UNITYSDK_OFFSET(0x1EC41F20)
#define SRF_SERVICE_SERVICEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC41F00)

namespace SRF::Service
{
	inline static constexpr unsigned int ServiceAttribute_TypeDefinitionIndex = 34738;
