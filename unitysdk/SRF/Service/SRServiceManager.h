...
#define SRF_SERVICE_SRSERVICEMANAGER_AUTOCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x1E6AFE20)
#define SRF_SERVICE_SRSERVICEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E6B04A0)
#define SRF_SERVICE_SRSERVICEMANAGER_DEFAULTSERVICECONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1E6B0A60)
#define SRF_SERVICE_SRSERVICEMANAGER_GETSERVICEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E6AFA00)
#define SRF_SERVICE_SRSERVICEMANAGER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1E6AF680)
#define SRF_SERVICE_SRSERVICEMANAGER_GETSTATICMETHODS_OFFSET UNITYSDK_OFFSET(0x1E6B1FF0)
#define SRF_SERVICE_SRSERVICEMANAGER_GET_ISLOADING_OFFSET UNITYSDK_OFFSET(0x1E6AF9D0)
#define SRF_SERVICE_SRSERVICEMANAGER_HASSERVICE_OFFSET UNITYSDK_OFFSET(0x1E6AFFB0)
#define SRF_SERVICE_SRSERVICEMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1E6B0CD0)
#define SRF_SERVICE_SRSERVICEMANAGER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1E6B0160)
#define SRF_SERVICE_SRSERVICEMANAGER_SCANTYPEFORCONSTRUCTORS_OFFSET UNITYSDK_OFFSET(0x1E6B0D70)
#define SRF_SERVICE_SRSERVICEMANAGER_SCANTYPEFORSELECTORS_OFFSET UNITYSDK_OFFSET(0x1E6B16B0)
#define SRF_SERVICE_SRSERVICEMANAGER_SCANTYPE_OFFSET UNITYSDK_OFFSET(0x1E6B0960)
#define SRF_SERVICE_SRSERVICEMANAGER_UNREGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1E6AFC00)
#define SRF_SERVICE_SRSERVICEMANAGER_UPDATESTUBS_OFFSET UNITYSDK_OFFSET(0x1E6B0560)
#define SRF_SERVICE_SRSERVICEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E6B20D0)
#define SRF_SERVICE_SRSERVICEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6B20A0)
...
namespace SRF::Service
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Reflection::Assembly*>**)Il2CppClass::FromTypeDefinitionIndex(SRServiceManager_TypeDefinitionIndex)->GetStaticField(0x5F230);
		}
		static ::System::Int32* StaticGet_LoadingCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SRServiceManager_TypeDefinitionIndex)->GetStaticField(0x13680);
		}
		static ::System::Boolean* StaticGet__hasQuit()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SRServiceManager_TypeDefinitionIndex)->GetStaticField(0x13684);
		}
