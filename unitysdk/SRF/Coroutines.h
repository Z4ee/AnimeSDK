...
#define SRF_COROUTINES_WAITFORSECONDSREALTIME_OFFSET UNITYSDK_OFFSET(0x1CECC120)

namespace SRF
{
	inline static constexpr unsigned int Coroutines_TypeDefinitionIndex = 33930;
