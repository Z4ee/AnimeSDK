...
#define SRF_JSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CECE610)
#define SRF_JSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1CECE570)
#define SRF_JSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x1CECDEB0)
#define SRF_JSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1CECE2A0)
#define SRF_JSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x1CECDF10)
#define SRF_JSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1CECDE50)
#define SRF_JSON_PARSER_ISWORDBREAK_OFFSET UNITYSDK_OFFSET(0x1CECE240)
#define SRF_JSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1CECEF00)
#define SRF_JSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x1CECF000)
#define SRF_JSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1CECF0A0)
#define SRF_JSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CECE660)
#define SRF_JSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1CECE810)
#define SRF_JSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1CECE640)
#define SRF_JSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1CECDB90)
#define SRF_JSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECDDD0)

namespace SRF
{
	inline static constexpr unsigned int Json_Parser_TypeDefinitionIndex = 33920;
