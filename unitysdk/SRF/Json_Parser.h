...
#define SRF_JSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E6AAE40)
#define SRF_JSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1E6AADA0)
#define SRF_JSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x1E6AA6E0)
#define SRF_JSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1E6AAAD0)
#define SRF_JSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x1E6AA740)
#define SRF_JSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1E6AA680)
#define SRF_JSON_PARSER_ISWORDBREAK_OFFSET UNITYSDK_OFFSET(0x1E6AAA70)
#define SRF_JSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1E6AB730)
#define SRF_JSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x1E6AB830)
#define SRF_JSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1E6AB8D0)
#define SRF_JSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E6AAE90)
#define SRF_JSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1E6AB040)
#define SRF_JSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1E6AAE70)
#define SRF_JSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1E6AA3C0)
#define SRF_JSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6AA600)
