...
#define CLASS_1_35769E9BC1F47769_CLASS_1_18FFD9DAACAA85F6_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x145A76F0)
#define CLASS_1_35769E9BC1F47769_CLASS_1_18FFD9DAACAA85F6_METHOD_1_7857B385C2B6C0EB_OFFSET UNITYSDK_OFFSET(0x145A7660)
#define CLASS_1_35769E9BC1F47769_CLASS_1_18FFD9DAACAA85F6__CTOR_OFFSET UNITYSDK_OFFSET(0x145A7770)
...
{
public:
	::Class_1_35769E9BC1F47769_Class_1_EA09F20FCF92DD72* MiddleRoles; // 0x10
	::System::String* Title; // 0x18
	::Il2CppArray<::System::UInt32>* BasicEquips; // 0x20
	::Il2CppArray<::System::UInt32>* SecondaryAugments; // 0x28
	::Class_1_35769E9BC1F47769_Class_1_6AED069C3F7FADB9* FinalRoles; // 0x30
	...
	::Class_1_35769E9BC1F47769_Class_1_EA09F20FCF92DD72* EarlyRoles; // 0x60
	::Il2CppArray<::System::UInt32>* CoreEquips; // 0x68
	::Il2CppArray<::System::String*>* Tags; // 0x70
	::System::String* Lang; // 0x78
	::System::UInt32 LikeCountForSort; // 0x80
	::System::UInt32 SubSeasonID; // 0x84
	::System::Boolean IsLike; // 0x88
	::System::Boolean IsSupportHard; // 0x89
	::System::Boolean IsFavour; // 0x8A
	::System::UInt32 RecentUseCnt; // 0x8C
	::System::UInt32 SeasonID; // 0x90
	::System::UInt32 GameVersion; // 0x94
	::System::UInt32 RecentFavourCnt; // 0x98
	::System::UInt32 FavourCnt; // 0x9C
	::System::UInt32 TimeStamp; // 0xA0
	::System::Int32 level; // 0xA4
	::System::UInt32 RecentLikeCnt; // 0xA8
	::RPG::Client::MongoObjectId Field_1_27; // 0xAC
