...
#define STRUCT_2_BF3A4206DCB16EB5_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x1330C9D0)
#define STRUCT_2_BF3A4206DCB16EB5_METHOD_2_704CAEDCD95E9E98_OFFSET UNITYSDK_OFFSET(0x1330CA40)
#define STRUCT_2_BF3A4206DCB16EB5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1330C9B0)

inline static constexpr unsigned int Struct_2_BF3A4206DCB16EB5_TypeDefinitionIndex = 42110;

struct alignas(4) Struct_2_BF3A4206DCB16EB5
{
	static ::Struct_2_BF3A4206DCB16EB5* StaticGet_Field_2_0()
	{
		return (::Struct_2_BF3A4206DCB16EB5*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_BF3A4206DCB16EB5_TypeDefinitionIndex)->GetStaticField(0xA550);
	}
