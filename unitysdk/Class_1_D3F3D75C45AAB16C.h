...
#define CLASS_1_D3F3D75C45AAB16C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195F2100)
#define CLASS_1_D3F3D75C45AAB16C_CLONE_OFFSET UNITYSDK_OFFSET(0x195F1D70)
#define CLASS_1_D3F3D75C45AAB16C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195F1F30)
#define CLASS_1_D3F3D75C45AAB16C_EQUALS_OFFSET UNITYSDK_OFFSET(0x195F1E50)
#define CLASS_1_D3F3D75C45AAB16C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195F1FE0)
#define CLASS_1_D3F3D75C45AAB16C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195F21F0)
#define CLASS_1_D3F3D75C45AAB16C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195F2160)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x195F1E30)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195F1C80)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x195F1E40)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x195F1E20)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x195F1E10)
#define CLASS_1_D3F3D75C45AAB16C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195F1CE0)
#define CLASS_1_D3F3D75C45AAB16C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195F2020)
#define CLASS_1_D3F3D75C45AAB16C_WRITETO_OFFSET UNITYSDK_OFFSET(0x195F2080)
#define CLASS_1_D3F3D75C45AAB16C__CCTOR_OFFSET UNITYSDK_OFFSET(0x195F22B0)
#define CLASS_1_D3F3D75C45AAB16C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195F1D00)
#define CLASS_1_D3F3D75C45AAB16C__CTOR_OFFSET UNITYSDK_OFFSET(0x195F1CF0)

inline static constexpr unsigned int Class_1_D3F3D75C45AAB16C_TypeDefinitionIndex = 28405;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_D3F3D75C45AAB16C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D3F3D75C45AAB16C_TypeDefinitionIndex)->GetStaticField(0x57380);
	}
