...
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_0D03A3384AD603EF_OFFSET UNITYSDK_OFFSET(0xF522840)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_1289C76924B12EAF_OFFSET UNITYSDK_OFFSET(0xF523FF0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_17FA0422991FF5E1_OFFSET UNITYSDK_OFFSET(0xF51FC40)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_19A243F71AC9569D_OFFSET UNITYSDK_OFFSET(0xF523F30)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_289E069BEBB00D08_OFFSET UNITYSDK_OFFSET(0xF520160)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_2C38C45A06C4F43E_OFFSET UNITYSDK_OFFSET(0xF5200A0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_2E806A43A7F1E286_OFFSET UNITYSDK_OFFSET(0xF520F80)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_3368A955600D49B7_OFFSET UNITYSDK_OFFSET(0xF523BB0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_49B12F8094E117D0_OFFSET UNITYSDK_OFFSET(0xF521BB0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_4B76CED1EE263E14_OFFSET UNITYSDK_OFFSET(0xF5220A0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_4C2A407444543FB7_OFFSET UNITYSDK_OFFSET(0xF5243C0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_4C9F348918F0BA3D_OFFSET UNITYSDK_OFFSET(0xF523AD0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_4E462256C54788ED_OFFSET UNITYSDK_OFFSET(0xF523640)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_59190FAA997CC23F_OFFSET UNITYSDK_OFFSET(0xF521C60)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_663635FC436CF63C_OFFSET UNITYSDK_OFFSET(0xF5205E0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_7CF8E015B7C82EAA_OFFSET UNITYSDK_OFFSET(0xF521750)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_871FC9C75EE72A2C_OFFSET UNITYSDK_OFFSET(0xF5222E0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_906E868759828A7F_OFFSET UNITYSDK_OFFSET(0xF5229D0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_970D9BBAEECEBF3E_OFFSET UNITYSDK_OFFSET(0xF522150)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_A3547BABB06EC35A_OFFSET UNITYSDK_OFFSET(0xF520990)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_A4B43BB6DF03405F_OFFSET UNITYSDK_OFFSET(0xF521300)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_A933534E99843834_OFFSET UNITYSDK_OFFSET(0xF523250)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0xF51FAA0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_B11E5E2802BCC01F_OFFSET UNITYSDK_OFFSET(0xF522B00)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_BD639774086BCC66_OFFSET UNITYSDK_OFFSET(0xF521FF0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_C1D1279A0E6E9CBF_OFFSET UNITYSDK_OFFSET(0xF5227B0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_C495FC84AA2302E0_OFFSET UNITYSDK_OFFSET(0xF524460)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xF5243B0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_D3E836A1A3C7BA75_OFFSET UNITYSDK_OFFSET(0xF5221E0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_D4B3608B292F0A4E_OFFSET UNITYSDK_OFFSET(0xF521F50)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_E2B18B851C7D7E4F_OFFSET UNITYSDK_OFFSET(0xF5223C0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_E3FAE0F50618D019_OFFSET UNITYSDK_OFFSET(0xF521690)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_E756FFE5B3ACE41A_OFFSET UNITYSDK_OFFSET(0xF5231A0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xF51FA80)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xF523FE0)
#define CLASS_1_1E8D2BC1EF83C1D7_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xF51FA70)
#define CLASS_1_1E8D2BC1EF83C1D7__CTOR_OFFSET UNITYSDK_OFFSET(0xF51FA90)

inline static constexpr unsigned int Class_1_1E8D2BC1EF83C1D7_TypeDefinitionIndex = 52289;
