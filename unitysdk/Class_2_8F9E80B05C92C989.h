...
#define CLASS_2_8F9E80B05C92C989_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1670B7E0)
#define CLASS_2_8F9E80B05C92C989_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1670B840)
#define CLASS_2_8F9E80B05C92C989__CTOR_OFFSET UNITYSDK_OFFSET(0x1670B7A0)

inline static constexpr unsigned int Class_2_8F9E80B05C92C989_TypeDefinitionIndex = 59274;
