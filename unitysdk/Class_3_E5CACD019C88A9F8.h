...
#define CLASS_3_E5CACD019C88A9F8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8E12B50)
#define CLASS_3_E5CACD019C88A9F8_METHOD_3_15E74EE53C013940_OFFSET UNITYSDK_OFFSET(0x8E12BF0)
#define CLASS_3_E5CACD019C88A9F8_METHOD_3_ACDFEAC427456543_OFFSET UNITYSDK_OFFSET(0x8E12E20)
#define CLASS_3_E5CACD019C88A9F8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8E12B90)
#define CLASS_3_E5CACD019C88A9F8__CTOR_OFFSET UNITYSDK_OFFSET(0x8E12A80)
#define CLASS_3_E5CACD019C88A9F8___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8E12F20)

inline static constexpr unsigned int Class_3_E5CACD019C88A9F8_TypeDefinitionIndex = 44528;
...
public:
	...
	::Class_1_945ACFB1FEBC7A2C_19* Method_3_15E74EE53C013940()
	{
		return ((::Class_1_945ACFB1FEBC7A2C_19*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_E5CACD019C88A9F8_METHOD_3_15E74EE53C013940_OFFSET))(this);
	}
