...
#define CLASS_1_A4905737247C8515_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0x160A5D80)
#define CLASS_1_A4905737247C8515_INIT_OFFSET UNITYSDK_OFFSET(0x160A5DC0)
#define CLASS_1_A4905737247C8515_METHOD_1_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0x160A62A0)
#define CLASS_1_A4905737247C8515_REFRESH_OFFSET UNITYSDK_OFFSET(0x160A5E60)
#define CLASS_1_A4905737247C8515_RESET_OFFSET UNITYSDK_OFFSET(0x160A61F0)
#define CLASS_1_A4905737247C8515__CTOR_OFFSET UNITYSDK_OFFSET(0x160A6600)

inline static constexpr unsigned int Class_1_A4905737247C8515_TypeDefinitionIndex = 66470;
