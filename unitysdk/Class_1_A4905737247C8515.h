...
#define CLASS_1_A4905737247C8515_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0xD2701C0)
#define CLASS_1_A4905737247C8515_INIT_OFFSET UNITYSDK_OFFSET(0xD270200)
#define CLASS_1_A4905737247C8515_METHOD_1_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xD2706E0)
#define CLASS_1_A4905737247C8515_REFRESH_OFFSET UNITYSDK_OFFSET(0xD2702A0)
#define CLASS_1_A4905737247C8515_RESET_OFFSET UNITYSDK_OFFSET(0xD270630)
#define CLASS_1_A4905737247C8515__CTOR_OFFSET UNITYSDK_OFFSET(0xD270A40)
...
{
public:
	::RPG::Client::CameraFightStateLightTeamDollyConfig* MAFIONBKPIE; // 0x10
