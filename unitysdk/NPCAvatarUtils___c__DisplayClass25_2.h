...
{
public:
	::NPCAvatarUtils___c__DisplayClass25_0* CS___8__locals2; // 0x10
	::System::Int32 i; // 0x18

	::System::Void _ctor()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + NPCAVATARUTILS___C__DISPLAYCLASS25_2__CTOR_OFFSET))(this);
	}

	::System::Boolean _IsLODResValid_b__1(::NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets* data)
	{
		return ((::System::Boolean(*)(::PVOID, ::NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets*))((::PBYTE)hIl2Cpp + NPCAVATARUTILS___C__DISPLAYCLASS25_2__ISLODRESVALID_B__1_OFFSET))(this, data);
	}
};
