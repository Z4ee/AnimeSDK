...
#define CLASS_1_7EBCC81DBF7C3C00_METHOD_1_49DFA39A30A44449_OFFSET UNITYSDK_OFFSET(0x140BAD10)
#define CLASS_1_7EBCC81DBF7C3C00_METHOD_1_502A81344CAEE4A4_OFFSET UNITYSDK_OFFSET(0x140BAC20)
#define CLASS_1_7EBCC81DBF7C3C00__CCTOR_OFFSET UNITYSDK_OFFSET(0x140BAC10)
#define CLASS_1_7EBCC81DBF7C3C00__CTOR_OFFSET UNITYSDK_OFFSET(0x140BAC00)

inline static constexpr unsigned int Class_1_7EBCC81DBF7C3C00_TypeDefinitionIndex = 76952;
...
public:
	...
	{
		return (::MoleMole::Config::AvatarScriptAndAnimOverrideConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7EBCC81DBF7C3C00_TypeDefinitionIndex)->GetStaticField(0x36690);
	}
