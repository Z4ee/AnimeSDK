...
#define CLASS_1_7EBCC81DBF7C3C00_METHOD_1_49DFA39A30A44449_OFFSET UNITYSDK_OFFSET(0x11C08FA0)
#define CLASS_1_7EBCC81DBF7C3C00_METHOD_1_502A81344CAEE4A4_OFFSET UNITYSDK_OFFSET(0x11C08EB0)
#define CLASS_1_7EBCC81DBF7C3C00__CCTOR_OFFSET UNITYSDK_OFFSET(0x11C08EA0)
#define CLASS_1_7EBCC81DBF7C3C00__CTOR_OFFSET UNITYSDK_OFFSET(0x11C08E90)

inline static constexpr unsigned int Class_1_7EBCC81DBF7C3C00_TypeDefinitionIndex = 49371;
...
public:
	...
	{
		return (::MoleMole::Config::AvatarScriptAndAnimOverrideConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7EBCC81DBF7C3C00_TypeDefinitionIndex)->GetStaticField(0x322F0);
	}
