...
#define CLASS_1_5B567C8A01BAEDFE_63_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A623290)
#define CLASS_1_5B567C8A01BAEDFE_63_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6230A0)
#define CLASS_1_5B567C8A01BAEDFE_63_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6231A0)
#define CLASS_1_5B567C8A01BAEDFE_63_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A623110)
#define CLASS_1_5B567C8A01BAEDFE_63_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6231F0)
#define CLASS_1_5B567C8A01BAEDFE_63_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6232E0)
#define CLASS_1_5B567C8A01BAEDFE_63_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6232B0)
#define CLASS_1_5B567C8A01BAEDFE_63_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A622FF0)
#define CLASS_1_5B567C8A01BAEDFE_63_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A623050)
#define CLASS_1_5B567C8A01BAEDFE_63_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A623220)
#define CLASS_1_5B567C8A01BAEDFE_63_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A623280)
#define CLASS_1_5B567C8A01BAEDFE_63__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A623330)
#define CLASS_1_5B567C8A01BAEDFE_63__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A623070)
#define CLASS_1_5B567C8A01BAEDFE_63__CTOR_OFFSET UNITYSDK_OFFSET(0x1A623060)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_63_TypeDefinitionIndex = 25484;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_63*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_63_TypeDefinitionIndex)->GetStaticField(0x25140);
	}
