...
#define CLASS_1_E555DFFCA4EEA2C0_METHOD_1_505594EF44B87658_OFFSET UNITYSDK_OFFSET(0xE0237B0)
#define CLASS_1_E555DFFCA4EEA2C0_METHOD_1_F005C1349A09D61B_OFFSET UNITYSDK_OFFSET(0xE023EB0)
#define CLASS_1_E555DFFCA4EEA2C0__CTOR_OFFSET UNITYSDK_OFFSET(0xE023780)
...
{
public:
	::RPG::GameCore::AvatarPropertyType KNBEPFPCEBB; // 0x10
	::RPG::GameCore::AvatarPropertyType GGKLKCAMNJK; // 0x14
	::RPG::GameCore::AvatarPropertyType GBPCKJBAAAA; // 0x18
	::RPG::GameCore::AvatarPropertyType DJIPGJLJLDP; // 0x1C
	::RPG::GameCore::AvatarPropertyType BFPOCEDAOMA; // 0x20
	::RPG::GameCore::AvatarPropertyType GBKKAELNFAO; // 0x24
	::RPG::GameCore::AvatarPropertyType ANPAHODBCOB; // 0x28
