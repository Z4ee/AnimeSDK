...
#define UITOWORLDRTOUTPUT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AA2C900)
#define UITOWORLDRTOUTPUT_SETRENDERTEXTURERAWIMAGE_OFFSET UNITYSDK_OFFSET(0x1AA2C5E0)
#define UITOWORLDRTOUTPUT_SETRENDERTEXUTRE_OFFSET UNITYSDK_OFFSET(0x1AA2C310)
#define UITOWORLDRTOUTPUT_SETUI_OFFSET UNITYSDK_OFFSET(0x1AA2C890)
#define UITOWORLDRTOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2C950)

inline static constexpr unsigned int UIToWorldRTOutput_TypeDefinitionIndex = 46097;
