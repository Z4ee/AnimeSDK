...
#define CLASS_1_12A87790910921BB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17E019E0)
#define CLASS_1_12A87790910921BB_METHOD_1_1655B698CBDB2306_OFFSET UNITYSDK_OFFSET(0x17E02620)
#define CLASS_1_12A87790910921BB_METHOD_1_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x17E020A0)
#define CLASS_1_12A87790910921BB_METHOD_1_2BBC367F6C8B0002_OFFSET UNITYSDK_OFFSET(0x17E033C0)
#define CLASS_1_12A87790910921BB_METHOD_1_A21BBA85D4EF7B41_OFFSET UNITYSDK_OFFSET(0x17E02900)
#define CLASS_1_12A87790910921BB_METHOD_1_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x17E01B40)
#define CLASS_1_12A87790910921BB_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x17E025E0)
#define CLASS_1_12A87790910921BB__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E04360)
#define CLASS_1_12A87790910921BB__CTOR_OFFSET UNITYSDK_OFFSET(0x17E019A0)

inline static constexpr unsigned int Class_1_12A87790910921BB_TypeDefinitionIndex = 76801;

class Class_1_12A87790910921BB : public ::System::Object
{
public:
	static ::System::Single* StaticGet_GAPFHIBIGBD()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_12A87790910921BB_TypeDefinitionIndex)->GetStaticField(0x11E70);
	}
	::Class_1_D272AF60A040331E* EEOKAMAGEKP; // 0x10
	::Class_3_F4528A5C0F861AF2* PDENFEFCAGN; // 0x18
	::Class_2_80F8710F847F1248* EEFMDEHLLFI; // 0x20
	::UnityEngine::Vector3 ODJNEAOMGIL; // 0x28
	::UnityEngine::Vector2 MNOKAIAOCPH; // 0x34
	::UnityEngine::Ray PNGHABAEDBC; // 0x3C
	::System::Single PJJLEJDPNHI; // 0x54
