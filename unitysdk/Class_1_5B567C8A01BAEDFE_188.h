...
#define CLASS_1_5B567C8A01BAEDFE_188_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5AC8B0)
#define CLASS_1_5B567C8A01BAEDFE_188_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5AC720)
#define CLASS_1_5B567C8A01BAEDFE_188_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5AC7C0)
#define CLASS_1_5B567C8A01BAEDFE_188_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5AC760)
#define CLASS_1_5B567C8A01BAEDFE_188_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5AC810)
#define CLASS_1_5B567C8A01BAEDFE_188_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5AC900)
#define CLASS_1_5B567C8A01BAEDFE_188_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5AC8D0)
#define CLASS_1_5B567C8A01BAEDFE_188_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A5AC6A0)
#define CLASS_1_5B567C8A01BAEDFE_188_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5AC6D0)
#define CLASS_1_5B567C8A01BAEDFE_188_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5AC840)
#define CLASS_1_5B567C8A01BAEDFE_188_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5AC8A0)
#define CLASS_1_5B567C8A01BAEDFE_188__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5AC950)
#define CLASS_1_5B567C8A01BAEDFE_188__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5AC6F0)
#define CLASS_1_5B567C8A01BAEDFE_188__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5AC6E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_188_TypeDefinitionIndex = 28602;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_188*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_188_TypeDefinitionIndex)->GetStaticField(0x169F0);
	}
