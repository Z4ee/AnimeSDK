...
#define CLASS_2_F17E575C6223E32C_GENSTATISTICS_OFFSET UNITYSDK_OFFSET(0x16771830)
#define CLASS_2_F17E575C6223E32C_GET_ACTIVITYSUBMODETYPE_OFFSET UNITYSDK_OFFSET(0x16771820)
#define CLASS_2_F17E575C6223E32C_METHOD_2_48BA2F5A2F5F8B43_OFFSET UNITYSDK_OFFSET(0x16771B10)
#define CLASS_2_F17E575C6223E32C_METHOD_2_4ED9AC70395CC495_OFFSET UNITYSDK_OFFSET(0x16771C80)
#define CLASS_2_F17E575C6223E32C__CTOR_OFFSET UNITYSDK_OFFSET(0x16771D10)

inline static constexpr unsigned int Class_2_F17E575C6223E32C_TypeDefinitionIndex = 56200;

class Class_2_F17E575C6223E32C : public ::Class_1_D90D29A0DA06B4F8
{
public:
	::RPG::GameCore::FixPoint BLECGLCDDCE; // 0x38
	::RPG::GameCore::FixPoint CMANCKIBBHP; // 0x40
