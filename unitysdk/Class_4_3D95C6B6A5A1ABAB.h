...
#define CLASS_4_3D95C6B6A5A1ABAB_METHOD_4_052FAABF5BB8BE83_OFFSET UNITYSDK_OFFSET(0x194A2CB0)
#define CLASS_4_3D95C6B6A5A1ABAB_METHOD_4_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x194A32B0)
#define CLASS_4_3D95C6B6A5A1ABAB_METHOD_4_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x194A2BD0)
#define CLASS_4_3D95C6B6A5A1ABAB__CTOR_OFFSET UNITYSDK_OFFSET(0x194A31C0)

inline static constexpr unsigned int Class_4_3D95C6B6A5A1ABAB_TypeDefinitionIndex = 51748;

class Class_4_3D95C6B6A5A1ABAB : public ::Class_3_F3948D237059FA7A
{
public:
	::System::Action_1<::System::EventArgs*>* Field_4_0; // 0x28
