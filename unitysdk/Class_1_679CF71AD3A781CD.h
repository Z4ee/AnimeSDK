...
#define CLASS_1_679CF71AD3A781CD_GET_EQUIP_OFFSET UNITYSDK_OFFSET(0x18384DE0)
#define CLASS_1_679CF71AD3A781CD_GET_SLOTID_OFFSET UNITYSDK_OFFSET(0x18384E00)
#define CLASS_1_679CF71AD3A781CD_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x18384DD0)
#define CLASS_1_679CF71AD3A781CD_METHOD_1_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x18384E90)
#define CLASS_1_679CF71AD3A781CD_METHOD_1_8119DCA79885035D_OFFSET UNITYSDK_OFFSET(0x18384E40)
#define CLASS_1_679CF71AD3A781CD_SET_EQUIP_OFFSET UNITYSDK_OFFSET(0x18384DF0)
#define CLASS_1_679CF71AD3A781CD__CTOR_OFFSET UNITYSDK_OFFSET(0x18384E10)

inline static constexpr unsigned int Class_1_679CF71AD3A781CD_TypeDefinitionIndex = 74922;

class Class_1_679CF71AD3A781CD : public ::System::Object
{
public:
	::RPG::Client::ActivityIdleLive::IdleLiveEquipmentData* _Equip_k__BackingField; // 0x10
	::System::String* NDKFOEHAIED; // 0x18
	::System::UInt32 _SlotId_k__BackingField; // 0x20
	::System::UInt32 IPONDHMHDBI; // 0x24
