...
#define RANDOMINSTANCING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A684060)
#define RANDOMINSTANCING_HASH2_OFFSET UNITYSDK_OFFSET(0x1A684CF0)
#define RANDOMINSTANCING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A684460)
#define RANDOMINSTANCING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A6841C0)
#define RANDOMINSTANCING_RANDOM_OFFSET UNITYSDK_OFFSET(0x1A684D40)
#define RANDOMINSTANCING_UPDATEINSTANCES_OFFSET UNITYSDK_OFFSET(0x1A684210)
#define RANDOMINSTANCING_UPDATETILEINSTANCES_OFFSET UNITYSDK_OFFSET(0x1A684740)
#define RANDOMINSTANCING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6846F0)
#define RANDOMINSTANCING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A684DE0)

inline static constexpr unsigned int RandomInstancing_TypeDefinitionIndex = 71439;
