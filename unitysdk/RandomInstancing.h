...
#define RANDOMINSTANCING_AWAKE_OFFSET UNITYSDK_OFFSET(0x18AE4F80)
#define RANDOMINSTANCING_HASH2_OFFSET UNITYSDK_OFFSET(0x18AE5C10)
#define RANDOMINSTANCING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18AE5380)
#define RANDOMINSTANCING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18AE50E0)
#define RANDOMINSTANCING_RANDOM_OFFSET UNITYSDK_OFFSET(0x18AE5C60)
#define RANDOMINSTANCING_UPDATEINSTANCES_OFFSET UNITYSDK_OFFSET(0x18AE5130)
#define RANDOMINSTANCING_UPDATETILEINSTANCES_OFFSET UNITYSDK_OFFSET(0x18AE5660)
#define RANDOMINSTANCING_UPDATE_OFFSET UNITYSDK_OFFSET(0x18AE5610)
#define RANDOMINSTANCING__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE5D00)

inline static constexpr unsigned int RandomInstancing_TypeDefinitionIndex = 50003;
