...
#define CLASS_1_F138DBFC3396EA15_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EBCF480)
#define CLASS_1_F138DBFC3396EA15_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1EBCEDB0)
#define CLASS_1_F138DBFC3396EA15_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EBCF000)
#define CLASS_1_F138DBFC3396EA15_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EBCEF40)
#define CLASS_1_F138DBFC3396EA15_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EBCF0B0)
#define CLASS_1_F138DBFC3396EA15_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EBCF770)
#define CLASS_1_F138DBFC3396EA15_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EBCF6F0)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1EBCEF20)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1EBCEF00)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_050E70FEDB783306_1_OFFSET UNITYSDK_OFFSET(0x1EBCEEB0)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1EBCEE50)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_126AB3935214AA22_1_OFFSET UNITYSDK_OFFSET(0x1EBCEEA0)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1EBCEE40)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1EBCEE30)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EBCECF0)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1EBCEF30)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1EBCEF10)
#define CLASS_1_F138DBFC3396EA15_1_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1EBCEE20)
#define CLASS_1_F138DBFC3396EA15_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EBCED20)
#define CLASS_1_F138DBFC3396EA15_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EBCF210)
#define CLASS_1_F138DBFC3396EA15_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EBCF270)
#define CLASS_1_F138DBFC3396EA15_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBCF890)
#define CLASS_1_F138DBFC3396EA15_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EBCED50)
#define CLASS_1_F138DBFC3396EA15_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBCED30)

inline static constexpr unsigned int Class_1_F138DBFC3396EA15_1_TypeDefinitionIndex = 30684;

class Class_1_F138DBFC3396EA15_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F138DBFC3396EA15_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F138DBFC3396EA15_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F138DBFC3396EA15_1_TypeDefinitionIndex)->GetStaticField(0x407D0);
	}
	// static const ::System::Int32 GJPAOFHOPOJ = 0xF; // 0x0
	// static const ::System::Int32 JCPEEKKJIPM = 0xB; // 0x0
	// static const ::System::Int32 HAHLAGNDDNG = 0x1; // 0x0
	// static const ::System::Int32 HEELLIHJDCJ = 0x2; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0x4; // 0x0
	::System::String* MNJKFIJEGNH; // 0x10
	::System::String* BCBNAACIMJI; // 0x18
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x20
	::System::UInt32 GJPFCNBFMAB; // 0x28
	::System::UInt32 NAEACGPKNNH; // 0x2C
	::System::UInt64 GCNANINCJLD; // 0x30
