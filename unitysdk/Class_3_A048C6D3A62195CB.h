...
#define CLASS_3_A048C6D3A62195CB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x189B03C0)
#define CLASS_3_A048C6D3A62195CB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x189B0480)
#define CLASS_3_A048C6D3A62195CB__CTOR_OFFSET UNITYSDK_OFFSET(0x189B03A0)

inline static constexpr unsigned int Class_3_A048C6D3A62195CB_TypeDefinitionIndex = 34782;
