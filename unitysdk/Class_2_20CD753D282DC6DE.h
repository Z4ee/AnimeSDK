...
#define CLASS_2_20CD753D282DC6DE_METHOD_2_205C242D36381FFB_OFFSET UNITYSDK_OFFSET(0x1870A380)
#define CLASS_2_20CD753D282DC6DE_METHOD_2_37CF7377CBA6E635_OFFSET UNITYSDK_OFFSET(0x1870A1B0)
#define CLASS_2_20CD753D282DC6DE_METHOD_2_50306739355B64EB_OFFSET UNITYSDK_OFFSET(0x1870A140)
#define CLASS_2_20CD753D282DC6DE_METHOD_2_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x1870C900)
#define CLASS_2_20CD753D282DC6DE_METHOD_2_B76CD5CB3E297DF3_OFFSET UNITYSDK_OFFSET(0x1870B3E0)
#define CLASS_2_20CD753D282DC6DE_METHOD_2_FB0DF283AE5D325A_OFFSET UNITYSDK_OFFSET(0x18709CA0)
#define CLASS_2_20CD753D282DC6DE__CTOR_OFFSET UNITYSDK_OFFSET(0x1870CF10)
...
public:
	...
	::System::Single HMNKOANNINJ; // 0x20
	::System::Single DEIMGIGLHLK; // 0x24
	::System::Single LKBKDNAMNEG; // 0x28
	::System::Single EEPGKELFPFL; // 0x2C
	::UnityEngine::Vector4 HDNFNONGHCP; // 0x30
	::UnityEngine::Vector3 DCPMGDCGHFK; // 0x40
	::UnityEngine::Vector3 PDKDKJIEHPC; // 0x4C
	::System::Single GHABAAOGBNO; // 0x58
	::UnityEngine::Vector3 JBIJNCJEFIB; // 0x5C
	::System::Single GHCBGHCGBBJ; // 0x68
	::UnityEngine::Vector3 OEJLOADFCGB; // 0x6C
	::UnityEngine::Vector3 NILAGOHELML; // 0x78
	::UnityEngine::Vector3 ICNBBLAOJGH; // 0x84
