...
#define CLASS_2_1B3696AECFCB7A2D_COMPARE_OFFSET UNITYSDK_OFFSET(0xB067440)
#define CLASS_2_1B3696AECFCB7A2D_METHOD_2_6FC5C78E9F4F8777_OFFSET UNITYSDK_OFFSET(0xB066FA0)
#define CLASS_2_1B3696AECFCB7A2D_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xB067190)
#define CLASS_2_1B3696AECFCB7A2D__CTOR_OFFSET UNITYSDK_OFFSET(0xB066E00)

inline static constexpr unsigned int Class_2_1B3696AECFCB7A2D_TypeDefinitionIndex = 55288;

class Class_2_1B3696AECFCB7A2D : public ::RPG::GameCore::TargetSeqOperationImpl_1<::RPG::GameCore::TargetSortSequence*>
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_571*>* Field_2_0; // 0x18
	...
	::System::Void Method_2_6FC5C78E9F4F8777(::RPG::GameCore::TaskContext* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::TaskContext*))((::PBYTE)hIl2Cpp + CLASS_2_1B3696AECFCB7A2D_METHOD_2_6FC5C78E9F4F8777_OFFSET))(this, a1);
	}
