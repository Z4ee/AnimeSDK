...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_GET_ISPLAYINGFADEIN_OFFSET UNITYSDK_OFFSET(0xE876190)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_GET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0xE876170)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_GET__FADEINCONFIG_OFFSET UNITYSDK_OFFSET(0xE8761B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_PLAYFADEINANIMATIONINNER_OFFSET UNITYSDK_OFFSET(0xE876280)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xE8761D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_SETFADEINANIMATIONTOFIRSTFRAMEINNER_OFFSET UNITYSDK_OFFSET(0xE876350)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_SETFADEINANIMATIONTOFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xE876300)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_SET_ISPLAYINGFADEIN_OFFSET UNITYSDK_OFFSET(0xE8761A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_SET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0xE876180)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0xE8763D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE__CTOR_OFFSET UNITYSDK_OFFSET(0xE875FB0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginScrollViewFade_TypeDefinitionIndex = 54049;
