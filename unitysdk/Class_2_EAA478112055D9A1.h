...
#define CLASS_2_EAA478112055D9A1_GET_GRAPHNAME_OFFSET UNITYSDK_OFFSET(0xC384B20)
#define CLASS_2_EAA478112055D9A1_GET_INFO_OFFSET UNITYSDK_OFFSET(0xC383260)
#define CLASS_2_EAA478112055D9A1_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xC3831F0)
#define CLASS_2_EAA478112055D9A1_GET_MODE_OFFSET UNITYSDK_OFFSET(0xC383250)
#define CLASS_2_EAA478112055D9A1_METHOD_2_0D7B5DCCDE94E1A3_OFFSET UNITYSDK_OFFSET(0xC384740)
#define CLASS_2_EAA478112055D9A1_METHOD_2_1B4418493CBE7E89_OFFSET UNITYSDK_OFFSET(0xC383B20)
#define CLASS_2_EAA478112055D9A1_METHOD_2_1BB9C827421A05BD_OFFSET UNITYSDK_OFFSET(0xC384A10)
#define CLASS_2_EAA478112055D9A1_METHOD_2_4679E7840A7526E1_OFFSET UNITYSDK_OFFSET(0xC384400)
#define CLASS_2_EAA478112055D9A1_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xC3833E0)
#define CLASS_2_EAA478112055D9A1_METHOD_2_61FD66D870E9DE3E_OFFSET UNITYSDK_OFFSET(0xC384560)
#define CLASS_2_EAA478112055D9A1_METHOD_2_777C630B90A28EF1_OFFSET UNITYSDK_OFFSET(0xC383E30)
#define CLASS_2_EAA478112055D9A1_METHOD_2_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0xC384250)
#define CLASS_2_EAA478112055D9A1_METHOD_2_84816770B063DB77_1_OFFSET UNITYSDK_OFFSET(0xC3834A0)
#define CLASS_2_EAA478112055D9A1_METHOD_2_84816770B063DB77_OFFSET UNITYSDK_OFFSET(0xC383320)
#define CLASS_2_EAA478112055D9A1_METHOD_2_9F93A4AC46D6E7E9_OFFSET UNITYSDK_OFFSET(0xC383690)
#define CLASS_2_EAA478112055D9A1_METHOD_2_A57FA722AB2A8938_OFFSET UNITYSDK_OFFSET(0xC384300)
#define CLASS_2_EAA478112055D9A1_METHOD_2_B1971FCD21F5B2F8_OFFSET UNITYSDK_OFFSET(0xC383720)
#define CLASS_2_EAA478112055D9A1_METHOD_2_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xC3842B0)
#define CLASS_2_EAA478112055D9A1_METHOD_2_C3B7C579BBD45F06_OFFSET UNITYSDK_OFFSET(0xC383560)
#define CLASS_2_EAA478112055D9A1_METHOD_2_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0xC383840)
#define CLASS_2_EAA478112055D9A1_METHOD_2_E4960DD9B8574C3F_OFFSET UNITYSDK_OFFSET(0xC3847B0)
#define CLASS_2_EAA478112055D9A1_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC384B40)
#define CLASS_2_EAA478112055D9A1_SET_GRAPHNAME_OFFSET UNITYSDK_OFFSET(0xC384B30)
#define CLASS_2_EAA478112055D9A1__CTOR_OFFSET UNITYSDK_OFFSET(0xC383060)
...
{
public:
	::RPG::GameCore::FreeStyleTriggerNodeInfo* BECOOHALAFM; // 0x28
	::Class_2_15C1107F59D2E68D* OPFHJALFFIC; // 0x30
	::System::Collections::Generic::HashSet_1<::System::String*>* HGHJGOBMHGK; // 0x38
	::System::Random* OLEEIPHBJKB; // 0x40
	::RPG::GameCore::FreeStyleTriggerGraphInfo* GKKJCLNMALH; // 0x48
