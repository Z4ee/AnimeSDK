...
#define CLASS_2_3B96DF6E0C8F09CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1168FF10)
#define CLASS_2_3B96DF6E0C8F09CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1168FF50)
#define CLASS_2_3B96DF6E0C8F09CE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11690140)
#define CLASS_2_3B96DF6E0C8F09CE_TICK_OFFSET UNITYSDK_OFFSET(0x11690190)
#define CLASS_2_3B96DF6E0C8F09CE__CTOR_OFFSET UNITYSDK_OFFSET(0x1168FF00)

inline static constexpr unsigned int Class_2_3B96DF6E0C8F09CE_TypeDefinitionIndex = 44330;

class Class_2_3B96DF6E0C8F09CE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetCameraRootFollow* Field_2_0; // 0x20
