...
#define CLASS_2_D8FA915B7E1BF7BE_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x15859E20)
#define CLASS_2_D8FA915B7E1BF7BE_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1585A060)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_165178681EB5F017_OFFSET UNITYSDK_OFFSET(0x15859480)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_2A66D148A153D793_OFFSET UNITYSDK_OFFSET(0x158592F0)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x15859210)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_395530CA50BA8FE8_OFFSET UNITYSDK_OFFSET(0x158590F0)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_42C5BADE1C9EFC80_1_OFFSET UNITYSDK_OFFSET(0x15859BF0)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_42C5BADE1C9EFC80_OFFSET UNITYSDK_OFFSET(0x15859B30)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_65F4D176AD70D378_1_OFFSET UNITYSDK_OFFSET(0x15859870)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_65F4D176AD70D378_OFFSET UNITYSDK_OFFSET(0x15859690)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0x15859530)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_A3FAE12D7B6ACD62_2_OFFSET UNITYSDK_OFFSET(0x15859CB0)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x158595E0)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_CC15D6CD4D3CC816_OFFSET UNITYSDK_OFFSET(0x15859A50)
#define CLASS_2_D8FA915B7E1BF7BE_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x15859D60)
#define CLASS_2_D8FA915B7E1BF7BE__CTOR_OFFSET UNITYSDK_OFFSET(0x1585A260)
#define CLASS_2_D8FA915B7E1BF7BE__ONBIND_OFFSET UNITYSDK_OFFSET(0x15858E60)

inline static constexpr unsigned int Class_2_D8FA915B7E1BF7BE_TypeDefinitionIndex = 72174;

class Class_2_D8FA915B7E1BF7BE : public ::Class_1_34917908B7833130
{
public:
	::RPG::GameCore::BattleGridFightAvatarData* OAEOLANBFMB; // 0x60
	::Il2CppArray<::RPG::GameCore::GridFightChargeType>* DHMAHKNDMNL; // 0x68
	::UnityEngine::Transform* FNMJFBCDOHG; // 0x70
	::UnityEngine::Transform* FPDKGPNCACA; // 0x78
	::UnityEngine::Transform* EKCFKCLNPPM; // 0x80
	::UnityEngine::Transform* FBPEIJECHHJ; // 0x88
	::UnityEngine::Transform* MOBOBJJCDDK; // 0x90
	::RPG::GameCore::GameEntity* JDOAGFALGGA; // 0x98
