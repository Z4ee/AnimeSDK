...
#define STATESPREADCONTROL_METHOD_4_C06AC8811E797798_OFFSET UNITYSDK_OFFSET(0x197F3300)
#define STATESPREADCONTROL_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x197F3140)
#define STATESPREADCONTROL_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x197F3250)
#define STATESPREADCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x197F3420)

inline static constexpr unsigned int StateSpreadControl_TypeDefinitionIndex = 48085;
