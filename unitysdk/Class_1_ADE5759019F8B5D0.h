...
#define CLASS_1_ADE5759019F8B5D0_EXECUTE_OFFSET UNITYSDK_OFFSET(0x172C1510)
#define CLASS_1_ADE5759019F8B5D0_METHOD_1_0505AA4D2BAFAE8A_OFFSET UNITYSDK_OFFSET(0x172C1B40)
#define CLASS_1_ADE5759019F8B5D0__CTOR_OFFSET UNITYSDK_OFFSET(0x172C1D00)

inline static constexpr unsigned int Class_1_ADE5759019F8B5D0_TypeDefinitionIndex = 76870;
