...
#define CLASS_1_ADE5759019F8B5D0_EXECUTE_OFFSET UNITYSDK_OFFSET(0x156F6610)
#define CLASS_1_ADE5759019F8B5D0_METHOD_1_0505AA4D2BAFAE8A_OFFSET UNITYSDK_OFFSET(0x156F6C40)
#define CLASS_1_ADE5759019F8B5D0__CTOR_OFFSET UNITYSDK_OFFSET(0x156F6E00)

inline static constexpr unsigned int Class_1_ADE5759019F8B5D0_TypeDefinitionIndex = 76871;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_255*, ::System::Collections::Generic::List_1<::Entitas::IEntity*>*, ::RPG::GameCore::BaseLittleGameAbilityEffectConfig*))((::PBYTE)hIl2Cpp + CLASS_1_ADE5759019F8B5D0_EXECUTE_OFFSET))(this, a1, a2, a3);
	}
