...
#define CLASS_1_5B567C8A01BAEDFE_374_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C25140)
#define CLASS_1_5B567C8A01BAEDFE_374_CLONE_OFFSET UNITYSDK_OFFSET(0x19C24FB0)
#define CLASS_1_5B567C8A01BAEDFE_374_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C25050)
#define CLASS_1_5B567C8A01BAEDFE_374_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C24FF0)
#define CLASS_1_5B567C8A01BAEDFE_374_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C250A0)
#define CLASS_1_5B567C8A01BAEDFE_374_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C25190)
#define CLASS_1_5B567C8A01BAEDFE_374_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C25160)
#define CLASS_1_5B567C8A01BAEDFE_374_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C24F30)
#define CLASS_1_5B567C8A01BAEDFE_374_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C24F60)
#define CLASS_1_5B567C8A01BAEDFE_374_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C250D0)
#define CLASS_1_5B567C8A01BAEDFE_374_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C25130)
#define CLASS_1_5B567C8A01BAEDFE_374__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C251E0)
#define CLASS_1_5B567C8A01BAEDFE_374__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C24F80)
#define CLASS_1_5B567C8A01BAEDFE_374__CTOR_OFFSET UNITYSDK_OFFSET(0x19C24F70)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_374_TypeDefinitionIndex = 33096;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_374*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_374_TypeDefinitionIndex)->GetStaticField(0x2E930);
	}
