...
#define CLASS_3_0F7DD8D4BFAC6EE2_METHOD_3_6DC60149A270E0D4_OFFSET UNITYSDK_OFFSET(0x17ABB4B0)
#define CLASS_3_0F7DD8D4BFAC6EE2__CTOR_OFFSET UNITYSDK_OFFSET(0x17ABB4A0)

inline static constexpr unsigned int Class_3_0F7DD8D4BFAC6EE2_TypeDefinitionIndex = 67100;

class Class_3_0F7DD8D4BFAC6EE2 : public ::Class_2_B9D6628E5930AA50
{
public:
	::Class_1_0A99AF1699F7F17E_29* LEEMNOCGBOJ; // 0x28

	::System::Void _ctor(::Enum_3_63BCB6C405BA8A1D_3 a1, ::RPG::Client::RogueTournPersonaStyleInfo* a2, ::Class_1_0A99AF1699F7F17E_29* a3)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_63BCB6C405BA8A1D_3, ::RPG::Client::RogueTournPersonaStyleInfo*, ::Class_1_0A99AF1699F7F17E_29*))((::PBYTE)hIl2Cpp + CLASS_3_0F7DD8D4BFAC6EE2__CTOR_OFFSET))(this, a1, a2, a3);
	}
