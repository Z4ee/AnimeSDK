...
#define LEGACYGPUPARTICLESYSTEM_ADDATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1E548060)
#define LEGACYGPUPARTICLESYSTEM_ADDBURST_OFFSET UNITYSDK_OFFSET(0x1E546D40)
#define LEGACYGPUPARTICLESYSTEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E53A9C0)
#define LEGACYGPUPARTICLESYSTEM_BAKEBEZIERCURVE_OFFSET UNITYSDK_OFFSET(0x1E53D270)
#define LEGACYGPUPARTICLESYSTEM_CALCULATEROTATEEXTENTS_OFFSET UNITYSDK_OFFSET(0x1E5428B0)
#define LEGACYGPUPARTICLESYSTEM_CLEARPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x1E53A3B0)
#define LEGACYGPUPARTICLESYSTEM_EMITNUMPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E544F80)
#define LEGACYGPUPARTICLESYSTEM_EMIT_OFFSET UNITYSDK_OFFSET(0x1E544F70)
#define LEGACYGPUPARTICLESYSTEM_FORCERECREATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E5468E0)
#define LEGACYGPUPARTICLESYSTEM_GETWSBOUNDS_OFFSET UNITYSDK_OFFSET(0x1E54B1B0)
#define LEGACYGPUPARTICLESYSTEM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E53E1F0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x1E53E970)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_0C88AB06D46E777A_1_OFFSET UNITYSDK_OFFSET(0x1E54ADA0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_0C88AB06D46E777A_2_OFFSET UNITYSDK_OFFSET(0x1E54AF60)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x1E54ABF0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_637DBA7901C3991A_OFFSET UNITYSDK_OFFSET(0x1E539D90)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_64F3965CE4C4DB47_OFFSET UNITYSDK_OFFSET(0x1E53EA20)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_659B881A8763C779_OFFSET UNITYSDK_OFFSET(0x1E53E7E0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_672D56D99D734395_OFFSET UNITYSDK_OFFSET(0x1E53B090)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x1E53EBA0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1E53B5D0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0x1E53F030)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_8C6E66D260CC37AD_OFFSET UNITYSDK_OFFSET(0x1E53B790)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x1E541600)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_A9DAF3FE2888211B_1_OFFSET UNITYSDK_OFFSET(0x1E53B910)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0x1E53B9F0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_AC7828729159F6C6_OFFSET UNITYSDK_OFFSET(0x1E53A7A0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_B917C58B4E14AC1B_OFFSET UNITYSDK_OFFSET(0x1E539680)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0x1E53EC80)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_C1275094A3E8D145_OFFSET UNITYSDK_OFFSET(0x1E53E3A0)
#define LEGACYGPUPARTICLESYSTEM_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0x1E53E710)
#define LEGACYGPUPARTICLESYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E53B000)
#define LEGACYGPUPARTICLESYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E53A320)
#define LEGACYGPUPARTICLESYSTEM_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1E54B810)
#define LEGACYGPUPARTICLESYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E539190)
#define LEGACYGPUPARTICLESYSTEM_PAUSE_OFFSET UNITYSDK_OFFSET(0x1E53ED30)
#define LEGACYGPUPARTICLESYSTEM_PLAY_OFFSET UNITYSDK_OFFSET(0x1E53A280)
#define LEGACYGPUPARTICLESYSTEM_PREPAREPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x1E539430)
#define LEGACYGPUPARTICLESYSTEM_PREPARESKINNEDMESH_OFFSET UNITYSDK_OFFSET(0x1E53C9E0)
#define LEGACYGPUPARTICLESYSTEM_REMOVEATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1E547FC0)
#define LEGACYGPUPARTICLESYSTEM_REMOVELASTATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1E5482B0)
#define LEGACYGPUPARTICLESYSTEM_REMOVELASTBURST_OFFSET UNITYSDK_OFFSET(0x1E546E20)
#define LEGACYGPUPARTICLESYSTEM_RENDERSKINNEDMESHEMITTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1E5418D0)
#define LEGACYGPUPARTICLESYSTEM_RESEED_OFFSET UNITYSDK_OFFSET(0x1E53ACF0)
#define LEGACYGPUPARTICLESYSTEM_RESETSEED_OFFSET UNITYSDK_OFFSET(0x1E546910)
#define LEGACYGPUPARTICLESYSTEM_RESTART_OFFSET UNITYSDK_OFFSET(0x1E53EFC0)
#define LEGACYGPUPARTICLESYSTEM_SETATTRACTORKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E548150)
#define LEGACYGPUPARTICLESYSTEM_SETBLENDMODE_OFFSET UNITYSDK_OFFSET(0x1E549070)
#define LEGACYGPUPARTICLESYSTEM_SETCIRCULARFORCE_OFFSET UNITYSDK_OFFSET(0x1E53BD20)
#define LEGACYGPUPARTICLESYSTEM_SETCOLLISIONTYPE_OFFSET UNITYSDK_OFFSET(0x1E548AA0)
#define LEGACYGPUPARTICLESYSTEM_SETCURVEPOINTDATA_OFFSET UNITYSDK_OFFSET(0x1E54B490)
#define LEGACYGPUPARTICLESYSTEM_SETEMISSIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E54A130)
#define LEGACYGPUPARTICLESYSTEM_SETEMISSIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E549FE0)
#define LEGACYGPUPARTICLESYSTEM_SETEMITFROMBASE_OFFSET UNITYSDK_OFFSET(0x1E54A680)
#define LEGACYGPUPARTICLESYSTEM_SETEMITFROMSHELL_OFFSET UNITYSDK_OFFSET(0x1E54A570)
#define LEGACYGPUPARTICLESYSTEM_SETEMITTERSHAPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E53D840)
#define LEGACYGPUPARTICLESYSTEM_SETLAYER_OFFSET UNITYSDK_OFFSET(0x1E54B120)
#define LEGACYGPUPARTICLESYSTEM_SETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x1E53BAD0)
#define LEGACYGPUPARTICLESYSTEM_SETLIMITVELOCITY_OFFSET UNITYSDK_OFFSET(0x1E547C40)
#define LEGACYGPUPARTICLESYSTEM_SETMAINTEXTUREKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E549540)
#define LEGACYGPUPARTICLESYSTEM_SETMAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E53B5E0)
#define LEGACYGPUPARTICLESYSTEM_SETMESHTARGETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E54A1B0)
#define LEGACYGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E549C60)
#define LEGACYGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E549B10)
#define LEGACYGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSVALUE_OFFSET UNITYSDK_OFFSET(0x1E549A50)
#define LEGACYGPUPARTICLESYSTEM_SETNORMALKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E549F60)
#define LEGACYGPUPARTICLESYSTEM_SETNORMALMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E549E10)
#define LEGACYGPUPARTICLESYSTEM_SETPARTICLETYPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E53D8E0)
#define LEGACYGPUPARTICLESYSTEM_SETPARTICLETYPEVECTOR_OFFSET UNITYSDK_OFFSET(0x1E545830)
#define LEGACYGPUPARTICLESYSTEM_SETRANDOMINDEXKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E5497D0)
#define LEGACYGPUPARTICLESYSTEM_SETREFRACTIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E549CE0)
#define LEGACYGPUPARTICLESYSTEM_SETRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x1E53A250)
#define LEGACYGPUPARTICLESYSTEM_SETROTATIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E546EA0)
#define LEGACYGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E547960)
#define LEGACYGPUPARTICLESYSTEM_SETSIMULATIONSPACE_OFFSET UNITYSDK_OFFSET(0x1E53DB50)
#define LEGACYGPUPARTICLESYSTEM_SETSIZEOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E5472B0)
#define LEGACYGPUPARTICLESYSTEM_SETTEXTURESHEETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E5495C0)
#define LEGACYGPUPARTICLESYSTEM_SETTURBULENCEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1E53BB70)
#define LEGACYGPUPARTICLESYSTEM_SETUPSKINNEDMESHEMITTERCAMERA_OFFSET UNITYSDK_OFFSET(0x1E54A790)
#define LEGACYGPUPARTICLESYSTEM_SETWAVEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1E53E080)
#define LEGACYGPUPARTICLESYSTEM_SETZBUFFER_OFFSET UNITYSDK_OFFSET(0x1E548FD0)
#define LEGACYGPUPARTICLESYSTEM_STOP_OFFSET UNITYSDK_OFFSET(0x1E53A370)
#define LEGACYGPUPARTICLESYSTEM_UPDATEAIRRESISTANCE_OFFSET UNITYSDK_OFFSET(0x1E541490)
#define LEGACYGPUPARTICLESYSTEM_UPDATEAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1E540F70)
#define LEGACYGPUPARTICLESYSTEM_UPDATEASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1E541800)
#define LEGACYGPUPARTICLESYSTEM_UPDATECIRCULARFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E5415C0)
#define LEGACYGPUPARTICLESYSTEM_UPDATECOLLISIONCAMERA_OFFSET UNITYSDK_OFFSET(0x1E548C20)
#define LEGACYGPUPARTICLESYSTEM_UPDATECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x1E540E80)
#define LEGACYGPUPARTICLESYSTEM_UPDATECOLOROVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E53BDC0)
#define LEGACYGPUPARTICLESYSTEM_UPDATECUSTOMDATASTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E545710)
#define LEGACYGPUPARTICLESYSTEM_UPDATECUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x1E540730)
#define LEGACYGPUPARTICLESYSTEM_UPDATEDEPTHCOLLISIONVALUES_OFFSET UNITYSDK_OFFSET(0x1E548C90)
#define LEGACYGPUPARTICLESYSTEM_UPDATEEMITTERMATRIX_OFFSET UNITYSDK_OFFSET(0x1E5400E0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEEMITTERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E53BF00)
#define LEGACYGPUPARTICLESYSTEM_UPDATEEMITTER_OFFSET UNITYSDK_OFFSET(0x1E53FF00)
#define LEGACYGPUPARTICLESYSTEM_UPDATEFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E541890)
#define LEGACYGPUPARTICLESYSTEM_UPDATEFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1E541210)
#define LEGACYGPUPARTICLESYSTEM_UPDATEGRAVITY_OFFSET UNITYSDK_OFFSET(0x1E540670)
#define LEGACYGPUPARTICLESYSTEM_UPDATEINDEXOFREFRACTION_OFFSET UNITYSDK_OFFSET(0x1E549D80)
#define LEGACYGPUPARTICLESYSTEM_UPDATEMAXVELOCITYOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E5417C0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEMESHTARGETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E548910)
#define LEGACYGPUPARTICLESYSTEM_UPDATEMESHTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E548330)
#define LEGACYGPUPARTICLESYSTEM_UPDATEMOTIONVECTORSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1E5499C0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEMOTIONVECTORTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E549910)
#define LEGACYGPUPARTICLESYSTEM_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1E5413A0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEPARTICLETYPEKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1E548DE0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1E548F20)
#define LEGACYGPUPARTICLESYSTEM_UPDATEROTATIONOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E547420)
#define LEGACYGPUPARTICLESYSTEM_UPDATESIZEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E540800)
#define LEGACYGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERPOSITIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x1E54AA30)
#define LEGACYGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERTEXTURES_OFFSET UNITYSDK_OFFSET(0x1E543320)
#define LEGACYGPUPARTICLESYSTEM_UPDATESTARTSIZEANDROTATION_OFFSET UNITYSDK_OFFSET(0x1E5403C0)
#define LEGACYGPUPARTICLESYSTEM_UPDATESTARTSIZE_OFFSET UNITYSDK_OFFSET(0x1E545690)
#define LEGACYGPUPARTICLESYSTEM_UPDATESTARTSPEEDANDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1E540380)
#define LEGACYGPUPARTICLESYSTEM_UPDATESTRETCHMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1E54A300)
#define LEGACYGPUPARTICLESYSTEM_UPDATETEXTURESHEETDIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1E549850)
#define LEGACYGPUPARTICLESYSTEM_UPDATETIGHTNESS_OFFSET UNITYSDK_OFFSET(0x1E5412F0)
#define LEGACYGPUPARTICLESYSTEM_UPDATETRAILVALUES_OFFSET UNITYSDK_OFFSET(0x1E54A3E0)
#define LEGACYGPUPARTICLESYSTEM_UPDATETURBULENCETEXTURE_OFFSET UNITYSDK_OFFSET(0x1E53BC80)
#define LEGACYGPUPARTICLESYSTEM_UPDATEVECTORFIELDFILE_OFFSET UNITYSDK_OFFSET(0x1E547F90)
#define LEGACYGPUPARTICLESYSTEM_UPDATEVECTORFIELDMATRIX_OFFSET UNITYSDK_OFFSET(0x1E53D6D0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEVECTORFIELD_OFFSET UNITYSDK_OFFSET(0x1E53D630)
#define LEGACYGPUPARTICLESYSTEM_UPDATEWAVESIM_OFFSET UNITYSDK_OFFSET(0x1E5461F0)
#define LEGACYGPUPARTICLESYSTEM_UPDATEWORLDSPACEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1E53E430)
#define LEGACYGPUPARTICLESYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E54DEA0)
#define LEGACYGPUPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E54BAA0)

inline static constexpr unsigned int LegacyGPUParticleSystem_TypeDefinitionIndex = 42302;
...
public:
	...
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51540);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPSpawner()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51548);
	}
	static ::System::Collections::Generic::List_1<::LegacyGPUParticleSystem*>** StaticGet_instanceList()
	{
		return (::System::Collections::Generic::List_1<::LegacyGPUParticleSystem*>**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51550);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPVelocity()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51558);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPResetPosBuffer()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51560);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPMeta()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51568);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPResetMetaBuffer()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51570);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPPosition()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51578);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPSkinMeshPos()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51580);
	}
	static ::UnityEngine::Shader** StaticGet_gpuPSkinMeshPosPoint()
	{
		return (::UnityEngine::Shader**)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x51588);
	}
	static ::System::Int32* StaticGet_LEGLDGNPIHD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11060);
	}
	static ::System::Single* StaticGet_maxNormalRatio()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11064);
	}
	static ::System::Int32* StaticGet_ELJIDCEFKHG()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11068);
	}
	static ::System::Int32* StaticGet_BJGJKPDHECD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x1106C);
	}
	static ::System::Int32* StaticGet_NEHBPFLCLLJ()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11070);
	}
	static ::System::Int32* StaticGet_NEEEEEOHMNK()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11074);
	}
	static ::System::Int32* StaticGet_EDILKGAGMNK()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11078);
	}
	static ::System::Int32* StaticGet_DLLPGIFLGCI()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x1107C);
	}
	static ::System::Int32* StaticGet_NEHGAPHJMPA()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11080);
	}
	static ::System::Int32* StaticGet_AMEHEHGGMFG()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11084);
	}
	static ::System::Int32* StaticGet_COGBJEFFFLG()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11088);
	}
	static ::System::Int32* StaticGet_HCGLJPAMNKE()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x1108C);
	}
	static ::System::Int32* StaticGet_JNMACHIHELO()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11090);
	}
	static ::System::Int32* StaticGet_CBHCPCONCEM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11094);
	}
	static ::System::Int32* StaticGet_FLPLGEMIMCJ()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11098);
	}
	static ::System::Int32* StaticGet_JHPIBNMJFCM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x1109C);
	}
	static ::System::Int32* StaticGet_FPGFIKCAMFK()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110A0);
	}
	static ::System::Int32* StaticGet_FBIHKOOCJJP()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110A4);
	}
	static ::System::Int32* StaticGet_NJPDPGLKDMI()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110A8);
	}
	static ::System::Int32* StaticGet_DHILAHPKMAB()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110AC);
	}
	static ::System::Int32* StaticGet_LKAKDPACGLA()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110B0);
	}
	static ::System::Int32* StaticGet_EFBLGFOJJEM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110B4);
	}
	static ::System::Int32* StaticGet_LMOCGOEAJFI()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110B8);
	}
	static ::System::Int32* StaticGet_ILAIPCEJOCN()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110BC);
	}
	static ::System::Int32* StaticGet_JKMGENMIKIN()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110C0);
	}
	static ::System::Int32* StaticGet_JJKOBAOBGKM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110C4);
	}
	static ::System::Int32* StaticGet_FJLGLEIFKDC()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110C8);
	}
	static ::System::Int32* StaticGet_DOPMEHHOLLC()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110CC);
	}
	static ::System::Int32* StaticGet_DFOJCFCJFPL()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110D0);
	}
	static ::System::Int32* StaticGet_AKGCOGEBHLH()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110D4);
	}
	static ::System::Int32* StaticGet_IBDGJOOBALL()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110D8);
	}
	static ::System::Int32* StaticGet_IOCEDHMAPIG()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110DC);
	}
	static ::System::Int32* StaticGet_DBLJMLMIIIL()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110E0);
	}
	static ::System::UInt32* StaticGet_instanceNum()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110E4);
	}
	static ::System::Int32* StaticGet_NLENMAKOOCL()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110E8);
	}
	static ::System::Int32* StaticGet_CFJCNLHGFJM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110EC);
	}
	static ::System::Int32* StaticGet_HAJJJLIAHED()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110F0);
	}
	static ::System::Int32* StaticGet_CIOBMHEJFLC()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110F4);
	}
	static ::System::Int32* StaticGet_BIGCONIFBJB()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110F8);
	}
	static ::System::Int32* StaticGet_ONGBGAPKAFD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x110FC);
	}
	static ::System::Int32* StaticGet_AEIJAIMCBHK()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11100);
	}
	static ::System::Int32* StaticGet_AFDCOJHACNJ()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11104);
	}
	static ::System::Int32* StaticGet_OHMCGCGPPKN()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LegacyGPUParticleSystem_TypeDefinitionIndex)->GetStaticField(0x11108);
	}
	// static const ::System::String* JGCHDKLBMKM; // 0x0
	...
	::UnityEngine::GameObject* HJIDMHNDDKC; // 0x60
	...
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* LAGOJCLIDDA; // 0x100
	...
	::System::Collections::Generic::List_1<::RefGPUParticleSystemBurst*>* PEKKIFDLFHC; // 0x130
	::System::Collections::Generic::List_1<::RefGPUParticleSystemBurst*>* bursts; // 0x138
	::System::Single progress; // 0x140
	::System::Single DGNCAICELJM; // 0x144
	...
	::UnityEngine::Texture2D* IDCMLHDNFFH; // 0x160
	...
	::System::Single PNOMONOCJPE; // 0x218
	::System::Single JNENLJGGFOA; // 0x21C
	::System::Int32 NBPMDGAFFKO; // 0x220
	::System::Single customTime; // 0x224
	::System::Single absCustomTime; // 0x228
	::System::Single KNOFOKJDAHJ; // 0x22C
	::System::Single LBLBBAGHOKA; // 0x230
	::System::Single JJGBLKNIHFD; // 0x234
	::UnityEngine::GameObject* LOCNDMHEJKH; // 0x238
	::UnityEngine::Bounds LANPMLIFOAH; // 0x240
	::Il2CppArray<::UnityEngine::GameObject*>* FGONMEEJKIL; // 0x258
	::Il2CppArray<::UnityEngine::MeshFilter*>* PDELHIBPCAM; // 0x260
	::Il2CppArray<::UnityEngine::MeshRenderer*>* KACCJFICDHI; // 0x268
	...
	::UnityEngine::Texture2D* HNNDAHKCDCI; // 0x450
	::UnityEngine::SkinnedMeshRenderer* CKIACKMJEEM; // 0x458
	...
	::UnityEngine::Material* JCMHLENNCGM; // 0x478
	::UnityEngine::RenderTexture* PBFMIDEKODA; // 0x480
	::UnityEngine::RenderTexture* LENADLJJNAG; // 0x488
	::UnityEngine::RenderTexture* MLMPCNCAHIJ; // 0x490
	::UnityEngine::RenderTexture* NLHPDFKMOLD; // 0x498
	...
	::UnityEngine::Vector3 AKIBNHPMLHF; // 0x50C
	::System::Boolean ForcesTab; // 0x518
	::System::Boolean timeOffset; // 0x519
	::System::Boolean NOMCHBCOGEB; // 0x51A
