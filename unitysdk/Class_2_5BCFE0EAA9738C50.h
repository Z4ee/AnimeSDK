...
#define CLASS_2_5BCFE0EAA9738C50_METHOD_2_65367CC4DD011F4E_OFFSET UNITYSDK_OFFSET(0x18EAC8C0)
#define CLASS_2_5BCFE0EAA9738C50_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x18EACA20)
#define CLASS_2_5BCFE0EAA9738C50_METHOD_2_E9A21D244C9D6B36_OFFSET UNITYSDK_OFFSET(0x18EAC780)
#define CLASS_2_5BCFE0EAA9738C50__CTOR_OFFSET UNITYSDK_OFFSET(0x18EACA10)

inline static constexpr unsigned int Class_2_5BCFE0EAA9738C50_TypeDefinitionIndex = 42793;
...
public:
	...
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_2_4; // 0x20
	::MoleMole::MonoGameSceneObjectMap* Field_2_2; // 0x28
	::UnityEngine::Camera* Field_2_0; // 0x30
	::UnityEngine::Rendering::Volume* Field_2_5; // 0x38
