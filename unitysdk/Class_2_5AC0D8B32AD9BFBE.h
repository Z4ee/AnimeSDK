...
#define CLASS_2_5AC0D8B32AD9BFBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16E90A90)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_024876544C3FD21D_OFFSET UNITYSDK_OFFSET(0x16E91B60)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_05385E043E28B03E_OFFSET UNITYSDK_OFFSET(0x16E92C10)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_1086E351241EDD3B_1_OFFSET UNITYSDK_OFFSET(0x16E92180)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_1086E351241EDD3B_2_OFFSET UNITYSDK_OFFSET(0x16E921D0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_1086E351241EDD3B_3_OFFSET UNITYSDK_OFFSET(0x16E92230)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_1086E351241EDD3B_OFFSET UNITYSDK_OFFSET(0x16E92130)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x16E90770)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_336976A186FC8B44_OFFSET UNITYSDK_OFFSET(0x16E91E00)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_347F18FA30CEE25E_OFFSET UNITYSDK_OFFSET(0x16E90C40)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_41AA181104E03F2C_OFFSET UNITYSDK_OFFSET(0x16E908D0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_4450635DBE779CA8_OFFSET UNITYSDK_OFFSET(0x16E92760)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x16E90DE0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_6F041C96885D24EC_OFFSET UNITYSDK_OFFSET(0x16E91F80)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_70437D85C11C5222_OFFSET UNITYSDK_OFFSET(0x16E909A0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7352AE24442C691D_OFFSET UNITYSDK_OFFSET(0x16E92430)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7E3858055FECC425_OFFSET UNITYSDK_OFFSET(0x16E91C30)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x16E907D0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_947D2B8B7863EE1B_OFFSET UNITYSDK_OFFSET(0x16E90860)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_992B88E0E0E3EDAE_OFFSET UNITYSDK_OFFSET(0x16E92280)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x16E91EC0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_A0BCF6B0C0D36E41_OFFSET UNITYSDK_OFFSET(0x16E917B0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_A1E867892BDB62CB_1_OFFSET UNITYSDK_OFFSET(0x16E91BC0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_A1E867892BDB62CB_OFFSET UNITYSDK_OFFSET(0x16E91740)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_B1E62D978A54E884_OFFSET UNITYSDK_OFFSET(0x16E91180)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_E7046C181E996411_OFFSET UNITYSDK_OFFSET(0x16E91930)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0x16E91E60)
#define CLASS_2_5AC0D8B32AD9BFBE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E92CF0)
...
public:
	...
	::RPG::GameCore::MapRotationCameraConfig* GGBGBANPMFG; // 0x10
	::RPG::Client::AdventurePhase* DEIEJIOELMO; // 0x18
	::Class_1_64D890C466F37235* KGCNPIEDOCA; // 0x20
	::RPG::GameCore::PlayerEnergyConfig* LDNOGBHGKOH; // 0x28
	::RPG::Client::MapRotationInfo* OCDIENNPEDA; // 0x30
	::Class_2_2B9847232031B19F* BAMECAHHEKC; // 0x38
	::System::Boolean IPMKNCEPIGC; // 0x40
	::System::Boolean OLILHCANLJD; // 0x41
	::System::Boolean BOGHIMFCFMK; // 0x42
