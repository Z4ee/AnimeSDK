...
#define CLASS_1_5C85280C68EBF115__CTOR_OFFSET UNITYSDK_OFFSET(0x18F71970)
...
public:
	...
	::UnityEngine::Animation* FOPCFKFAGPM; // 0x18
	::System::String* CNJCEOEHOIP; // 0x20
	::System::String* CONJJBPOJEE; // 0x28
