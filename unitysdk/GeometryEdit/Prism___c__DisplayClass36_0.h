...
#define GEOMETRYEDIT_PRISM___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x10A4AEA0)
#define GEOMETRYEDIT_PRISM___C__DISPLAYCLASS36_0__RESETPIVOT_B__0_OFFSET UNITYSDK_OFFSET(0x10A4AF30)

namespace GeometryEdit
{
	inline static constexpr unsigned int Prism___c__DisplayClass36_0_TypeDefinitionIndex = 39876;
