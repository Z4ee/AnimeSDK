...
#define CLASS_2_DA77DBC670DD4C3C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF37D590)
#define CLASS_2_DA77DBC670DD4C3C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF37D5D0)
#define CLASS_2_DA77DBC670DD4C3C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xF37D7C0)
#define CLASS_2_DA77DBC670DD4C3C_TICK_OFFSET UNITYSDK_OFFSET(0xF37D810)
#define CLASS_2_DA77DBC670DD4C3C__CTOR_OFFSET UNITYSDK_OFFSET(0xF37D580)

inline static constexpr unsigned int Class_2_DA77DBC670DD4C3C_TypeDefinitionIndex = 46734;

class Class_2_DA77DBC670DD4C3C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::BeginUseSharedSummonUnit* Field_2_1; // 0x18
