...
#define CLASS_2_DA77DBC670DD4C3C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188C6990)
#define CLASS_2_DA77DBC670DD4C3C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188C69D0)
#define CLASS_2_DA77DBC670DD4C3C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188C6C40)
#define CLASS_2_DA77DBC670DD4C3C_TICK_OFFSET UNITYSDK_OFFSET(0x188C6C90)
#define CLASS_2_DA77DBC670DD4C3C__CTOR_OFFSET UNITYSDK_OFFSET(0x188C6980)

inline static constexpr unsigned int Class_2_DA77DBC670DD4C3C_TypeDefinitionIndex = 58110;

class Class_2_DA77DBC670DD4C3C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::BeginUseSharedSummonUnit* OFKGLJOAMLD; // 0x20
