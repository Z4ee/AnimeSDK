...
#define STAGEHARMONYTRANSFORMDEMODULATOR_METHOD_3_4BF7DA9CA52F7891_OFFSET UNITYSDK_OFFSET(0x197F0C50)
#define STAGEHARMONYTRANSFORMDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0x197F0F70)
#define STAGEHARMONYTRANSFORMDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x197F0FC0)

inline static constexpr unsigned int StageHarmonyTransformDemodulator_TypeDefinitionIndex = 47990;
