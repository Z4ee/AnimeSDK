...
#define PERFTEYVAT_NETWORKCLIENTPROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB8FB80)

namespace PerfTeyvat
{
	inline static constexpr unsigned int NetworkClientProfiler_TypeDefinitionIndex = 54159;
