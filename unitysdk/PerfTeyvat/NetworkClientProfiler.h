...
#define PERFTEYVAT_NETWORKCLIENTPROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB251A0)

namespace PerfTeyvat
{
	inline static constexpr unsigned int NetworkClientProfiler_TypeDefinitionIndex = 48064;
