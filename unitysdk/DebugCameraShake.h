...
#define DEBUGCAMERASHAKE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x106520B0)
#define DEBUGCAMERASHAKE_METHOD_5_DA9EBD5F5A0C0204_OFFSET UNITYSDK_OFFSET(0x10651E10)
#define DEBUGCAMERASHAKE_START_OFFSET UNITYSDK_OFFSET(0x10651AF0)
#define DEBUGCAMERASHAKE_UPDATE_OFFSET UNITYSDK_OFFSET(0x10651C90)
#define DEBUGCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x10652130)

inline static constexpr unsigned int DebugCameraShake_TypeDefinitionIndex = 44582;
