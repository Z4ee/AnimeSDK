...
#define DEBUGCAMERASHAKE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC7217F0)
#define DEBUGCAMERASHAKE_METHOD_5_DA9EBD5F5A0C0204_OFFSET UNITYSDK_OFFSET(0xC721550)
#define DEBUGCAMERASHAKE_START_OFFSET UNITYSDK_OFFSET(0xC721230)
#define DEBUGCAMERASHAKE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC7213D0)
#define DEBUGCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xC721870)

inline static constexpr unsigned int DebugCameraShake_TypeDefinitionIndex = 44036;
