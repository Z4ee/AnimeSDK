...
#define CLASS_2_A1C9DC0EF54540E3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F029B0)
#define CLASS_2_A1C9DC0EF54540E3_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x18F02A00)
#define CLASS_2_A1C9DC0EF54540E3_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x18F02FB0)
#define CLASS_2_A1C9DC0EF54540E3_ONSKIP_OFFSET UNITYSDK_OFFSET(0x18F02F60)
#define CLASS_2_A1C9DC0EF54540E3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18F02A10)
#define CLASS_2_A1C9DC0EF54540E3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18F02B50)
#define CLASS_2_A1C9DC0EF54540E3_TICK_OFFSET UNITYSDK_OFFSET(0x18F02C40)
#define CLASS_2_A1C9DC0EF54540E3__CTOR_OFFSET UNITYSDK_OFFSET(0x18F02970)

inline static constexpr unsigned int Class_2_A1C9DC0EF54540E3_TypeDefinitionIndex = 56291;

class Class_2_A1C9DC0EF54540E3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::WaitSecond* Field_2_1; // 0x20
	::RPG::GameCore::LevelWaitSecond* Field_2_2; // 0x28
