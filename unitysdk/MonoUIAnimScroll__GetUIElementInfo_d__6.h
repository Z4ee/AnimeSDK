...
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x112F1F60)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x112F2A20)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x112F2A80)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x112F2A30)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x112F1F50)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x112F1F40)

inline static constexpr unsigned int MonoUIAnimScroll__GetUIElementInfo_d__6_TypeDefinitionIndex = 84705;
