...
#define CLASS_2_646CCD18043C3F6C_METHOD_2_6C42F1687E010F47_OFFSET UNITYSDK_OFFSET(0x1B45CD70)
#define CLASS_2_646CCD18043C3F6C_METHOD_2_846FB62C6EE72A8A_OFFSET UNITYSDK_OFFSET(0x1B45D4C0)
#define CLASS_2_646CCD18043C3F6C_METHOD_2_8C4710AA642393E6_OFFSET UNITYSDK_OFFSET(0x1B45D7B0)
#define CLASS_2_646CCD18043C3F6C_METHOD_2_B4BFAA75B7B94C85_OFFSET UNITYSDK_OFFSET(0x1B45D340)
#define CLASS_2_646CCD18043C3F6C_METHOD_2_FC279EE69113F51F_OFFSET UNITYSDK_OFFSET(0x1B45D660)
#define CLASS_2_646CCD18043C3F6C_UPDATEADDROLE_OFFSET UNITYSDK_OFFSET(0x1B45CD20)
#define CLASS_2_646CCD18043C3F6C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B45CB70)

inline static constexpr unsigned int Class_2_646CCD18043C3F6C_TypeDefinitionIndex = 65258;

class Class_2_646CCD18043C3F6C : public ::Class_1_41E07A9DDAB7FC78
{
public:
	::System::Collections::Generic::List_1<::Class_2_646CCD18043C3F6C_Class_3_6340F8F348E84260*>* DPLHNANNBAJ; // 0x10
	::System::UInt32 JPGGPEDKFKE; // 0x18
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_190BB2A3D431BCD2_1*))((::PBYTE)hIl2Cpp + CLASS_2_646CCD18043C3F6C_UPDATEADDROLE_OFFSET))(this, a1);
	}

	::System::Void Method_2_6C42F1687E010F47(::Class_1_190BB2A3D431BCD2_1* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_190BB2A3D431BCD2_1*))((::PBYTE)hIl2Cpp + CLASS_2_646CCD18043C3F6C_METHOD_2_6C42F1687E010F47_OFFSET))(this, a1);
	}
