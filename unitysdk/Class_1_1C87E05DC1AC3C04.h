...
#define CLASS_1_1C87E05DC1AC3C04_GET_CONTENTTEXTID_OFFSET UNITYSDK_OFFSET(0x17A8D600)
#define CLASS_1_1C87E05DC1AC3C04_GET_POSITIONINFO_OFFSET UNITYSDK_OFFSET(0x17A8D5E0)
#define CLASS_1_1C87E05DC1AC3C04_SET_CONTENTTEXTID_OFFSET UNITYSDK_OFFSET(0x17A8D610)
#define CLASS_1_1C87E05DC1AC3C04_SET_POSITIONINFO_OFFSET UNITYSDK_OFFSET(0x17A8D5F0)
#define CLASS_1_1C87E05DC1AC3C04__CTOR_OFFSET UNITYSDK_OFFSET(0x17A8D620)

inline static constexpr unsigned int Class_1_1C87E05DC1AC3C04_TypeDefinitionIndex = 60211;
