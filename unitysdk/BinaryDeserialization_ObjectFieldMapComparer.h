...
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C059710)
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0597C0)
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C059970)

inline static constexpr unsigned int BinaryDeserialization_ObjectFieldMapComparer_TypeDefinitionIndex = 31659;
