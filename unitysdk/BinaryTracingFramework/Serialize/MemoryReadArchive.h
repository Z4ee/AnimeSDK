...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1BF04D70)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1BEFFC60)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_RESET_OFFSET UNITYSDK_OFFSET(0x1BF04DA0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF04BE0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int MemoryReadArchive_TypeDefinitionIndex = 32428;
