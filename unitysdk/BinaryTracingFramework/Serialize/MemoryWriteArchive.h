...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1BF04E10)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1BEFFC00)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1BEFFC30)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1BF04ED0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_RESET_OFFSET UNITYSDK_OFFSET(0x1BF033C0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1BF03430)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1BF03460)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1BF034D0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1BF03490)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1BF04E40)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1BF04E70)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1BF04EA0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BF00C70)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF02E90)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF02F90)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int MemoryWriteArchive_TypeDefinitionIndex = 32426;
	...
	public:
		...
		::System::IO::MemoryStream* _stream; // 0x18
		::System::IO::BinaryWriter* _writer; // 0x20
