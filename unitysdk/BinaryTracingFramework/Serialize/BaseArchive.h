...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE_GET_ARISLOADING_OFFSET UNITYSDK_OFFSET(0x1F653D70)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE_SET_ARISLOADING_OFFSET UNITYSDK_OFFSET(0x1F653D80)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F653D90)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int BaseArchive_TypeDefinitionIndex = 34608;
