...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE_GET_ARISLOADING_OFFSET UNITYSDK_OFFSET(0x1BF047D0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE_SET_ARISLOADING_OFFSET UNITYSDK_OFFSET(0x1BF047E0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF047F0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int BaseArchive_TypeDefinitionIndex = 32421;
