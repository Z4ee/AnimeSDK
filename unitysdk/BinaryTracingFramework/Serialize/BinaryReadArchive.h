...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1E22FEB0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1E22B320)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1E22B3A0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1E22B360)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1E22B3E0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1E22FF00)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1E22FF40)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1E22FF80)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E22FEC0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SETUP_OFFSET UNITYSDK_OFFSET(0x1E22FDE0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22FDD0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int BinaryReadArchive_TypeDefinitionIndex = 33978;
