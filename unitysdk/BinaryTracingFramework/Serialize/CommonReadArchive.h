...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1F654130)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1F654060)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F653F90)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int CommonReadArchive_TypeDefinitionIndex = 34616;
