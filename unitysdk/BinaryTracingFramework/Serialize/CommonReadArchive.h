...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1BF04B90)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1BF04AC0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF049F0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int CommonReadArchive_TypeDefinitionIndex = 32429;
