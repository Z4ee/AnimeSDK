...
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_11CACFD5BFA626A2_OFFSET UNITYSDK_OFFSET(0x17E18530)
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x17E17DB0)
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0x17E17D20)
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_5C0F92F807DE3F58_OFFSET UNITYSDK_OFFSET(0x17E17F60)
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_B6B6DFCC21EB9868_OFFSET UNITYSDK_OFFSET(0x17E17E50)
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x17E17E00)
#define CLASS_1_CFF7FC5CD9C1D292_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17E17CD0)
#define CLASS_1_CFF7FC5CD9C1D292__CTOR_OFFSET UNITYSDK_OFFSET(0x17E179F0)

inline static constexpr unsigned int Class_1_CFF7FC5CD9C1D292_TypeDefinitionIndex = 75173;

class Class_1_CFF7FC5CD9C1D292 : public ::System::Object
{
public:
	::Class_1_B7039134DC553D20_Class_1_411CE7DBE5F749E8* LPMGGBGJJCE; // 0x10
	::RPG::Client::ActivityHipplen::ActivityHipplenGameInstance* MFFELPGKEMH; // 0x18
	::System::Single NPINECOCALC; // 0x20
	::System::UInt32 HEKMDEJINNJ; // 0x24
	::System::UInt32 DCJIHBBCKBF; // 0x28
	::System::UInt32 IKGIHJHAKLD; // 0x2C
	::System::UInt32 ENBPBGBKCHG; // 0x30
