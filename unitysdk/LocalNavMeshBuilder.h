...
#define LOCALNAVMESHBUILDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12C10AB0)
#define LOCALNAVMESHBUILDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12C106B0)
#define LOCALNAVMESHBUILDER_QUANTIZEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x12C10B00)
#define LOCALNAVMESHBUILDER_QUANTIZE_OFFSET UNITYSDK_OFFSET(0x12C10E50)
#define LOCALNAVMESHBUILDER_START_OFFSET UNITYSDK_OFFSET(0x12C10630)
#define LOCALNAVMESHBUILDER_UPDATENAVMESH_OFFSET UNITYSDK_OFFSET(0x12C108A0)
#define LOCALNAVMESHBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C10F60)

inline static constexpr unsigned int LocalNavMeshBuilder_TypeDefinitionIndex = 76663;
