...
#define CLASS_2_0A053ACAB3C04AA4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11950940)
#define CLASS_2_0A053ACAB3C04AA4_METHOD_2_4AD3C45D81B35B70_OFFSET UNITYSDK_OFFSET(0x11952110)
#define CLASS_2_0A053ACAB3C04AA4_METHOD_2_71436269021F921C_OFFSET UNITYSDK_OFFSET(0x11952020)
#define CLASS_2_0A053ACAB3C04AA4_METHOD_2_CD0979951400C3FD_OFFSET UNITYSDK_OFFSET(0x119520B0)
#define CLASS_2_0A053ACAB3C04AA4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11950980)
#define CLASS_2_0A053ACAB3C04AA4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11952170)
#define CLASS_2_0A053ACAB3C04AA4_TICK_OFFSET UNITYSDK_OFFSET(0x119521C0)
#define CLASS_2_0A053ACAB3C04AA4__CTOR_OFFSET UNITYSDK_OFFSET(0x11950930)

inline static constexpr unsigned int Class_2_0A053ACAB3C04AA4_TypeDefinitionIndex = 51204;

class Class_2_0A053ACAB3C04AA4 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetMonsterEnergyBarState* Field_2_0; // 0x20
