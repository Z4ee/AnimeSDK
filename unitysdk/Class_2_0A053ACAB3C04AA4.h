...
#define CLASS_2_0A053ACAB3C04AA4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1CAC50)
#define CLASS_2_0A053ACAB3C04AA4_METHOD_2_4AD3C45D81B35B70_OFFSET UNITYSDK_OFFSET(0xC1CC310)
#define CLASS_2_0A053ACAB3C04AA4_METHOD_2_71436269021F921C_OFFSET UNITYSDK_OFFSET(0xC1CC220)
#define CLASS_2_0A053ACAB3C04AA4_METHOD_2_CD0979951400C3FD_OFFSET UNITYSDK_OFFSET(0xC1CC2B0)
#define CLASS_2_0A053ACAB3C04AA4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC1CAC90)
#define CLASS_2_0A053ACAB3C04AA4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC1CC370)
#define CLASS_2_0A053ACAB3C04AA4_TICK_OFFSET UNITYSDK_OFFSET(0xC1CC3C0)
#define CLASS_2_0A053ACAB3C04AA4__CTOR_OFFSET UNITYSDK_OFFSET(0xC1CAC40)

inline static constexpr unsigned int Class_2_0A053ACAB3C04AA4_TypeDefinitionIndex = 51875;
