...
#define CLASS_2_CE1B1B80A3029ACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB506450)
#define CLASS_2_CE1B1B80A3029ACE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB505FA0)
#define CLASS_2_CE1B1B80A3029ACE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB5063A0)
#define CLASS_2_CE1B1B80A3029ACE_TICK_OFFSET UNITYSDK_OFFSET(0xB5063F0)
#define CLASS_2_CE1B1B80A3029ACE__CTOR_OFFSET UNITYSDK_OFFSET(0xB505F90)

inline static constexpr unsigned int Class_2_CE1B1B80A3029ACE_TypeDefinitionIndex = 52668;

class Class_2_CE1B1B80A3029ACE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetMainLightOffset* Field_2_0; // 0x18
