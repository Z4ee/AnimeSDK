...
#define CLASS_2_CE1B1B80A3029ACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E3C4C0)
#define CLASS_2_CE1B1B80A3029ACE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15E3BF10)
#define CLASS_2_CE1B1B80A3029ACE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15E3C410)
#define CLASS_2_CE1B1B80A3029ACE_TICK_OFFSET UNITYSDK_OFFSET(0x15E3C460)
#define CLASS_2_CE1B1B80A3029ACE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E3BF00)
...
{
public:
	::RPG::GameCore::SetMainLightOffset* OFKGLJOAMLD; // 0x18
