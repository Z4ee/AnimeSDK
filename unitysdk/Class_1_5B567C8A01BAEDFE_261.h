...
#define CLASS_1_5B567C8A01BAEDFE_261_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DE87230)
#define CLASS_1_5B567C8A01BAEDFE_261_CLONE_OFFSET UNITYSDK_OFFSET(0x1DE86F20)
#define CLASS_1_5B567C8A01BAEDFE_261_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DE87030)
#define CLASS_1_5B567C8A01BAEDFE_261_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DE86F60)
#define CLASS_1_5B567C8A01BAEDFE_261_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DE87190)
#define CLASS_1_5B567C8A01BAEDFE_261_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DE87280)
#define CLASS_1_5B567C8A01BAEDFE_261_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DE87250)
#define CLASS_1_5B567C8A01BAEDFE_261_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DE86EA0)
#define CLASS_1_5B567C8A01BAEDFE_261_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DE86ED0)
#define CLASS_1_5B567C8A01BAEDFE_261_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DE871C0)
#define CLASS_1_5B567C8A01BAEDFE_261_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DE87220)
#define CLASS_1_5B567C8A01BAEDFE_261__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE872D0)
#define CLASS_1_5B567C8A01BAEDFE_261__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE86EF0)
#define CLASS_1_5B567C8A01BAEDFE_261__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE86EE0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_261_TypeDefinitionIndex = 31486;

class Class_1_5B567C8A01BAEDFE_261 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_261*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_261*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_261_TypeDefinitionIndex)->GetStaticField(0x54C90);
	}
