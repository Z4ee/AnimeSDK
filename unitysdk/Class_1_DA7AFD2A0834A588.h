...
#define CLASS_1_DA7AFD2A0834A588_CLEAR_OFFSET UNITYSDK_OFFSET(0x143F0CC0)
#define CLASS_1_DA7AFD2A0834A588__CTOR_OFFSET UNITYSDK_OFFSET(0x143F0D20)
...
public:
	...
	::System::Action_2<::RPG::GameCore::GameEntity*, ::RPG::GameCore::GameEntity*>* Field_1_2; // 0x20
	::RPG::GameCore::RedirectSkillTargetAffectTeam Field_1_3; // 0x28
