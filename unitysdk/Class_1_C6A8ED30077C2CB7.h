...
#define CLASS_1_C6A8ED30077C2CB7_METHOD_1_16E0583AE1690754_OFFSET UNITYSDK_OFFSET(0x17A0DEA0)
#define CLASS_1_C6A8ED30077C2CB7_METHOD_1_A5AE030BBDCA17EA_OFFSET UNITYSDK_OFFSET(0x17A0DE50)
#define CLASS_1_C6A8ED30077C2CB7_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17A0DFF0)
#define CLASS_1_C6A8ED30077C2CB7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17A0DE40)
#define CLASS_1_C6A8ED30077C2CB7__CTOR_OFFSET UNITYSDK_OFFSET(0x17A0DDE0)

inline static constexpr unsigned int Class_1_C6A8ED30077C2CB7_TypeDefinitionIndex = 56704;

class Class_1_C6A8ED30077C2CB7 : public ::System::Object
{
public:
	::RPG::GameCore::TargetEvaluator* MOINFBGHNFO; // 0x10
