...
#define MB3_DISABLEHIDDENANIMATIONS_ONBECAMEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x1E750910)
#define MB3_DISABLEHIDDENANIMATIONS_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1E750750)
#define MB3_DISABLEHIDDENANIMATIONS_START_OFFSET UNITYSDK_OFFSET(0x1E750540)
#define MB3_DISABLEHIDDENANIMATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E750AD0)

inline static constexpr unsigned int MB3_DisableHiddenAnimations_TypeDefinitionIndex = 94471;
