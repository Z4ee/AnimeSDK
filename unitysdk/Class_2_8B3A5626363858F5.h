...
#define CLASS_2_8B3A5626363858F5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1585A860)
#define CLASS_2_8B3A5626363858F5_METHOD_2_34D5F4DBE622AF88_OFFSET UNITYSDK_OFFSET(0x1585AD60)
#define CLASS_2_8B3A5626363858F5_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x1585ADC0)
#define CLASS_2_8B3A5626363858F5_METHOD_2_FC21FC07A06ACCCD_OFFSET UNITYSDK_OFFSET(0x1585B020)
#define CLASS_2_8B3A5626363858F5_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0x1585B180)
#define CLASS_2_8B3A5626363858F5_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x1585B130)
#define CLASS_2_8B3A5626363858F5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1585AA10)
#define CLASS_2_8B3A5626363858F5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1585B0E0)
#define CLASS_2_8B3A5626363858F5_TICK_OFFSET UNITYSDK_OFFSET(0x1585A9B0)
#define CLASS_2_8B3A5626363858F5__CTOR_OFFSET UNITYSDK_OFFSET(0x1585A840)
#define CLASS_2_8B3A5626363858F5___SETTEXTURE_B__6_0_OFFSET UNITYSDK_OFFSET(0x1585B1D0)
#define CLASS_2_8B3A5626363858F5___SETTEXTURE_B__6_1_OFFSET UNITYSDK_OFFSET(0x1585B2E0)
...
public:
	...
	::RPG::GameCore::PropComponent* BCCLENOIOBD; // 0x20
	...
	::System::UInt32 LDKFBCDPHJD; // 0x3C
	::System::Boolean MJGDFAHFDDF; // 0x40
