...
#define WAVESIMPANEL_CALCULATERENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xAC73100)
#define WAVESIMPANEL_CALCULATESIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xAC73090)
#define WAVESIMPANEL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xAC72E90)
#define WAVESIMPANEL_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC73170)
#define WAVESIMPANEL_GET_ACTIVEPRIORITY_OFFSET UNITYSDK_OFFSET(0xAC72F90)
#define WAVESIMPANEL_GET_ADVECDISTDAMPING_OFFSET UNITYSDK_OFFSET(0xAC72F20)
#define WAVESIMPANEL_GET_DAMPING_OFFSET UNITYSDK_OFFSET(0xAC72F10)
#define WAVESIMPANEL_GET_FADINGRATE_OFFSET UNITYSDK_OFFSET(0xAC72F80)
#define WAVESIMPANEL_GET_GENERATED_OFFSET UNITYSDK_OFFSET(0xAC72FD0)
#define WAVESIMPANEL_GET_PARTICLEADEVINTENSITY_OFFSET UNITYSDK_OFFSET(0xAC72F30)
#define WAVESIMPANEL_GET_PARTICLEDAMPING_OFFSET UNITYSDK_OFFSET(0xAC72F50)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYINTENSITY_OFFSET UNITYSDK_OFFSET(0xAC72F40)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYOFFSET_OFFSET UNITYSDK_OFFSET(0xAC72F60)
#define WAVESIMPANEL_GET_RENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xAC72FC0)
#define WAVESIMPANEL_GET_SIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xAC72FB0)
#define WAVESIMPANEL_GET_STATICBOUNDARYTEXTURE_OFFSET UNITYSDK_OFFSET(0xAC72FA0)
#define WAVESIMPANEL_GET_USEBLENDINGASRENDER_OFFSET UNITYSDK_OFFSET(0xAC72F70)
#define WAVESIMPANEL_RESETSIMSIZE_OFFSET UNITYSDK_OFFSET(0xAC72FE0)
#define WAVESIMPANEL_SPAWNED_OFFSET UNITYSDK_OFFSET(0xAC72E50)
#define WAVESIMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC731C0)
#define WAVESIMPANEL___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC73270)

inline static constexpr unsigned int WaveSimPanel_TypeDefinitionIndex = 38361;
...
public:
	...
	{
		return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + WAVESIMPANEL___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET))(this);
	}
};
