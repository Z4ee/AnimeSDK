...
#define WAVESIMPANEL_CALCULATERENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xE9A2640)
#define WAVESIMPANEL_CALCULATESIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xE9A25D0)
#define WAVESIMPANEL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xE9A23D0)
#define WAVESIMPANEL_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xE9A26B0)
#define WAVESIMPANEL_GET_ACTIVEPRIORITY_OFFSET UNITYSDK_OFFSET(0xE9A24D0)
#define WAVESIMPANEL_GET_ADVECDISTDAMPING_OFFSET UNITYSDK_OFFSET(0xE9A2460)
#define WAVESIMPANEL_GET_DAMPING_OFFSET UNITYSDK_OFFSET(0xE9A2450)
#define WAVESIMPANEL_GET_FADINGRATE_OFFSET UNITYSDK_OFFSET(0xE9A24C0)
#define WAVESIMPANEL_GET_GENERATED_OFFSET UNITYSDK_OFFSET(0xE9A2510)
#define WAVESIMPANEL_GET_PARTICLEADEVINTENSITY_OFFSET UNITYSDK_OFFSET(0xE9A2470)
#define WAVESIMPANEL_GET_PARTICLEDAMPING_OFFSET UNITYSDK_OFFSET(0xE9A2490)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYINTENSITY_OFFSET UNITYSDK_OFFSET(0xE9A2480)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYOFFSET_OFFSET UNITYSDK_OFFSET(0xE9A24A0)
#define WAVESIMPANEL_GET_RENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xE9A2500)
#define WAVESIMPANEL_GET_SIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xE9A24F0)
#define WAVESIMPANEL_GET_STATICBOUNDARYTEXTURE_OFFSET UNITYSDK_OFFSET(0xE9A24E0)
#define WAVESIMPANEL_GET_USEBLENDINGASRENDER_OFFSET UNITYSDK_OFFSET(0xE9A24B0)
#define WAVESIMPANEL_RESETSIMSIZE_OFFSET UNITYSDK_OFFSET(0xE9A2520)
#define WAVESIMPANEL_SPAWNED_OFFSET UNITYSDK_OFFSET(0xE9A2390)
#define WAVESIMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xE9A2700)
