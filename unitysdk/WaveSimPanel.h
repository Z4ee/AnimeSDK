...
#define WAVESIMPANEL_CALCULATERENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xB9B2380)
#define WAVESIMPANEL_CALCULATESIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xB9B2310)
#define WAVESIMPANEL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB9B2110)
#define WAVESIMPANEL_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB9B23F0)
#define WAVESIMPANEL_GET_ACTIVEPRIORITY_OFFSET UNITYSDK_OFFSET(0xB9B2210)
#define WAVESIMPANEL_GET_ADVECDISTDAMPING_OFFSET UNITYSDK_OFFSET(0xB9B21A0)
#define WAVESIMPANEL_GET_DAMPING_OFFSET UNITYSDK_OFFSET(0xB9B2190)
#define WAVESIMPANEL_GET_FADINGRATE_OFFSET UNITYSDK_OFFSET(0xB9B2200)
#define WAVESIMPANEL_GET_GENERATED_OFFSET UNITYSDK_OFFSET(0xB9B2250)
#define WAVESIMPANEL_GET_PARTICLEADEVINTENSITY_OFFSET UNITYSDK_OFFSET(0xB9B21B0)
#define WAVESIMPANEL_GET_PARTICLEDAMPING_OFFSET UNITYSDK_OFFSET(0xB9B21D0)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYINTENSITY_OFFSET UNITYSDK_OFFSET(0xB9B21C0)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYOFFSET_OFFSET UNITYSDK_OFFSET(0xB9B21E0)
#define WAVESIMPANEL_GET_RENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xB9B2240)
#define WAVESIMPANEL_GET_SIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xB9B2230)
#define WAVESIMPANEL_GET_STATICBOUNDARYTEXTURE_OFFSET UNITYSDK_OFFSET(0xB9B2220)
#define WAVESIMPANEL_GET_USEBLENDINGASRENDER_OFFSET UNITYSDK_OFFSET(0xB9B21F0)
#define WAVESIMPANEL_RESETSIMSIZE_OFFSET UNITYSDK_OFFSET(0xB9B2260)
#define WAVESIMPANEL_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB9B20D0)
#define WAVESIMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB9B2440)
#define WAVESIMPANEL___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB9B24F0)

inline static constexpr unsigned int WaveSimPanel_TypeDefinitionIndex = 44245;
