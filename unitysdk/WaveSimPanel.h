...
#define WAVESIMPANEL_CALCULATERENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xD0F9E60)
#define WAVESIMPANEL_CALCULATESIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xD0F9DF0)
#define WAVESIMPANEL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD0F9BF0)
#define WAVESIMPANEL_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xD0F9ED0)
#define WAVESIMPANEL_GET_ACTIVEPRIORITY_OFFSET UNITYSDK_OFFSET(0xD0F9CF0)
#define WAVESIMPANEL_GET_ADVECDISTDAMPING_OFFSET UNITYSDK_OFFSET(0xD0F9C80)
#define WAVESIMPANEL_GET_DAMPING_OFFSET UNITYSDK_OFFSET(0xD0F9C70)
#define WAVESIMPANEL_GET_FADINGRATE_OFFSET UNITYSDK_OFFSET(0xD0F9CE0)
#define WAVESIMPANEL_GET_GENERATED_OFFSET UNITYSDK_OFFSET(0xD0F9D30)
#define WAVESIMPANEL_GET_PARTICLEADEVINTENSITY_OFFSET UNITYSDK_OFFSET(0xD0F9C90)
#define WAVESIMPANEL_GET_PARTICLEDAMPING_OFFSET UNITYSDK_OFFSET(0xD0F9CB0)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYINTENSITY_OFFSET UNITYSDK_OFFSET(0xD0F9CA0)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYOFFSET_OFFSET UNITYSDK_OFFSET(0xD0F9CC0)
#define WAVESIMPANEL_GET_RENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xD0F9D20)
#define WAVESIMPANEL_GET_SIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xD0F9D10)
#define WAVESIMPANEL_GET_STATICBOUNDARYTEXTURE_OFFSET UNITYSDK_OFFSET(0xD0F9D00)
#define WAVESIMPANEL_GET_USEBLENDINGASRENDER_OFFSET UNITYSDK_OFFSET(0xD0F9CD0)
#define WAVESIMPANEL_RESETSIMSIZE_OFFSET UNITYSDK_OFFSET(0xD0F9D40)
#define WAVESIMPANEL_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD0F9BB0)
#define WAVESIMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F9F20)
#define WAVESIMPANEL___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xD0F9FD0)

inline static constexpr unsigned int WaveSimPanel_TypeDefinitionIndex = 44791;
