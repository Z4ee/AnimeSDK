...
#define WAVESIMPANEL_CALCULATERENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0x1050A2B0)
#define WAVESIMPANEL_CALCULATESIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x1050A240)
#define WAVESIMPANEL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1050A040)
#define WAVESIMPANEL_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x1050A320)
#define WAVESIMPANEL_GET_ACTIVEPRIORITY_OFFSET UNITYSDK_OFFSET(0x1050A140)
#define WAVESIMPANEL_GET_ADVECDISTDAMPING_OFFSET UNITYSDK_OFFSET(0x1050A0D0)
#define WAVESIMPANEL_GET_DAMPING_OFFSET UNITYSDK_OFFSET(0x1050A0C0)
#define WAVESIMPANEL_GET_FADINGRATE_OFFSET UNITYSDK_OFFSET(0x1050A130)
#define WAVESIMPANEL_GET_GENERATED_OFFSET UNITYSDK_OFFSET(0x1050A180)
#define WAVESIMPANEL_GET_PARTICLEADEVINTENSITY_OFFSET UNITYSDK_OFFSET(0x1050A0E0)
#define WAVESIMPANEL_GET_PARTICLEDAMPING_OFFSET UNITYSDK_OFFSET(0x1050A100)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYINTENSITY_OFFSET UNITYSDK_OFFSET(0x1050A0F0)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYOFFSET_OFFSET UNITYSDK_OFFSET(0x1050A110)
#define WAVESIMPANEL_GET_RENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0x1050A170)
#define WAVESIMPANEL_GET_SIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x1050A160)
#define WAVESIMPANEL_GET_STATICBOUNDARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1050A150)
#define WAVESIMPANEL_GET_USEBLENDINGASRENDER_OFFSET UNITYSDK_OFFSET(0x1050A120)
#define WAVESIMPANEL_RESETSIMSIZE_OFFSET UNITYSDK_OFFSET(0x1050A190)
#define WAVESIMPANEL_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1050A000)
#define WAVESIMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1050A370)

inline static constexpr unsigned int WaveSimPanel_TypeDefinitionIndex = 47959;
