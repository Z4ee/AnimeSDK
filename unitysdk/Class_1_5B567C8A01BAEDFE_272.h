...
#define CLASS_1_5B567C8A01BAEDFE_272_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A879100)
#define CLASS_1_5B567C8A01BAEDFE_272_CLONE_OFFSET UNITYSDK_OFFSET(0x1A878F70)
#define CLASS_1_5B567C8A01BAEDFE_272_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A879010)
#define CLASS_1_5B567C8A01BAEDFE_272_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A878FB0)
#define CLASS_1_5B567C8A01BAEDFE_272_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A879060)
#define CLASS_1_5B567C8A01BAEDFE_272_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A879150)
#define CLASS_1_5B567C8A01BAEDFE_272_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A879120)
#define CLASS_1_5B567C8A01BAEDFE_272_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A878EF0)
#define CLASS_1_5B567C8A01BAEDFE_272_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A878F20)
#define CLASS_1_5B567C8A01BAEDFE_272_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A879090)
#define CLASS_1_5B567C8A01BAEDFE_272_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8790F0)
#define CLASS_1_5B567C8A01BAEDFE_272__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8791A0)
#define CLASS_1_5B567C8A01BAEDFE_272__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A878F40)
#define CLASS_1_5B567C8A01BAEDFE_272__CTOR_OFFSET UNITYSDK_OFFSET(0x1A878F30)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_272_TypeDefinitionIndex = 30502;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_272*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_272_TypeDefinitionIndex)->GetStaticField(0x55330);
	}
