...
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xBAC1E60)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_166FCE95AF172ABC_OFFSET UNITYSDK_OFFSET(0xBAC18F0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_23EFCEB999C1D825_OFFSET UNITYSDK_OFFSET(0xBAC35C0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xBAC2120)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xBAC20C0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBAC2060)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xBAC1A40)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_5903A6947D49E37C_OFFSET UNITYSDK_OFFSET(0xBAC2630)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0xBAC1F10)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_9999F3E4D60BFCCC_OFFSET UNITYSDK_OFFSET(0xBAC2FC0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_99C2D4DED85BBB24_OFFSET UNITYSDK_OFFSET(0xBAC2200)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_C31D75E0B090D0CD_OFFSET UNITYSDK_OFFSET(0xBAC25C0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBAC3170)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xBAC2170)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xBAC31E0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_DBDE806671808CE7_OFFSET UNITYSDK_OFFSET(0xBAC2540)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_E8F71BC8471C5469_OFFSET UNITYSDK_OFFSET(0xBAC19E0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_EF17FAB3022DE07B_1_OFFSET UNITYSDK_OFFSET(0xBAC2B70)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_EF17FAB3022DE07B_OFFSET UNITYSDK_OFFSET(0xBAC2720)
#define CLASS_1_7AAE8FA406499FBF__CTOR_OFFSET UNITYSDK_OFFSET(0xBAC1900)

inline static constexpr unsigned int Class_1_7AAE8FA406499FBF_TypeDefinitionIndex = 73462;

class Class_1_7AAE8FA406499FBF : public ::System::Object
{
public:
	::UnityEngine::AnimationClip* PODEAFMGIOB; // 0x10
	::Class_1_C3442CFB67797449* HBJBEIIAJKH; // 0x18
	::UnityEngine::AnimationClip* NAPHBNMNCFK; // 0x20
	::Class_1_C3442CFB67797449* DGKICCGPAAH; // 0x28
	::UnityEngine::Animator* NAHOHKAHBPK; // 0x30
	::Class_1_C3442CFB67797449* EECCMELJCHP; // 0x38
	::Class_1_C3442CFB67797449* ICDLCLIFELJ; // 0x40
	::UnityEngine::AnimationClip* JPLCHLKHKFB; // 0x48
	::UnityEngine::AnimationClip* BDNGEELCHFG; // 0x50
	::System::String* EGGEKICGAMP; // 0x58
	::UnityEngine::AnimationClip* DBJEDIFALGG; // 0x60
	::Class_1_C3442CFB67797449* DCFODACFGAL; // 0x68
	::RPG::Client::MonoEmoPlayableGraph* IKJNGHGBJMF; // 0x70
	::UnityEngine::Animations::AnimationPlayableOutput LELHBCNLOHP; // 0x78
	::UnityEngine::Animations::AnimationLayerMixerPlayable MJEJPBFPDPN; // 0x88
	::System::Single CPHBOGKIJAL; // 0x98
	::System::Single JDNDJHDHIAI; // 0x9C
	::System::Int32 BOFHAPACNHF; // 0xA0
	::System::Single JCABJKJNPFN; // 0xA4
	::UnityEngine::Animations::AnimationPlayableOutput LOCFECAKLPJ; // 0xA8
	::UnityEngine::Playables::PlayableGraph DHGFBIIDMFB; // 0xB8
	::System::Single MBFCJCGLMDE; // 0xC8
	::System::Single NHDBJHJAKCD; // 0xCC
	::UnityEngine::Animations::AnimationPlayableOutput PABCPEECPIA; // 0xD0
