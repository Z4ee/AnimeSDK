...
#define STRUCT_2_7A7B8DBB8BCC7E0F_METHOD_2_4F3661D3B38CBEAF_OFFSET UNITYSDK_OFFSET(0x9FF7C0)

inline static constexpr unsigned int Struct_2_7A7B8DBB8BCC7E0F_TypeDefinitionIndex = 91628;

struct alignas(4) Struct_2_7A7B8DBB8BCC7E0F
{
	::System::UInt32 Field_2_1; // 0x10
	::Enum_3_CC342C5CC837CDC0 Field_2_0; // 0x14
