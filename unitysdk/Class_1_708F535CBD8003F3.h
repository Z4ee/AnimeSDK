...
#define CLASS_1_708F535CBD8003F3_METHOD_1_078DF7FA97C8BB47_OFFSET UNITYSDK_OFFSET(0x121EE650)
#define CLASS_1_708F535CBD8003F3_METHOD_1_099C229CF1BB9083_OFFSET UNITYSDK_OFFSET(0x121EF0C0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_126AB3935214AA22_1_OFFSET UNITYSDK_OFFSET(0x121ECFD0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_126AB3935214AA22_2_OFFSET UNITYSDK_OFFSET(0x121ECFE0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x121ECFC0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_3559476C7C86165D_OFFSET UNITYSDK_OFFSET(0x121EF060)
#define CLASS_1_708F535CBD8003F3_METHOD_1_3BE5DBAE268F9022_OFFSET UNITYSDK_OFFSET(0x121ED9C0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_490B5123E6F6015E_OFFSET UNITYSDK_OFFSET(0x121ECFF0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_5B3FA9FDD7D2BA8C_1_OFFSET UNITYSDK_OFFSET(0x121EEA60)
#define CLASS_1_708F535CBD8003F3_METHOD_1_5B3FA9FDD7D2BA8C_OFFSET UNITYSDK_OFFSET(0x121EED60)
#define CLASS_1_708F535CBD8003F3_METHOD_1_68B0016CFD71207A_OFFSET UNITYSDK_OFFSET(0x121ED070)
#define CLASS_1_708F535CBD8003F3_METHOD_1_9F89A193911611E4_OFFSET UNITYSDK_OFFSET(0x121EDA70)
#define CLASS_1_708F535CBD8003F3_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x121ED8B0)
#define CLASS_1_708F535CBD8003F3_METHOD_1_C081D0F1BA12AC56_OFFSET UNITYSDK_OFFSET(0x121ED730)
#define CLASS_1_708F535CBD8003F3_METHOD_1_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x121ED020)
#define CLASS_1_708F535CBD8003F3__CTOR_OFFSET UNITYSDK_OFFSET(0x121ED000)
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_708F535CBD8003F3_TypeDefinitionIndex)->GetStaticField(0x10FA0);
	}
	::System::String* FFHJENBPOAI; // 0x10
	::System::Collections::Generic::List_1<::System::Int32>* IAGNMEHODJI; // 0x18
	::System::String* DIEGNJFBPHN; // 0x20
	::System::String* DJNKMHHLKHM; // 0x28
	::System::String* BLJCKFHOOIA; // 0x30
	::System::Collections::Generic::List_1<::System::Int32>* MOIDMEBPDKE; // 0x38
	::System::String* NCMBPNCPEHB; // 0x40
	::RPG::CustomRP::CustomLightQualityFilter DDEGBOBCNFA; // 0x48
	::System::Single IAJFEFLCEDB; // 0x4C
	::System::Int32 IJNDNFMBNGC; // 0x50
	::RPG::Client::OpenWorld::StreamingLightEnum OCMJCFLLJAB; // 0x54
	::EnviromentSystem::BlockEnvDataStmState KOEKPKHCLCM; // 0x58
	::System::Int32 CGDPPGNJFGC; // 0x5C
	::RPG::CustomRP::CustomLightQualityFilter AJMAPJOPFFP; // 0x60
