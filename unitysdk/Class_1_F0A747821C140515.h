...
#define CLASS_1_F0A747821C140515_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x102059F0)
#define CLASS_1_F0A747821C140515_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x10205940)
#define CLASS_1_F0A747821C140515__CCTOR_OFFSET UNITYSDK_OFFSET(0x10205AE0)
#define CLASS_1_F0A747821C140515__CTOR_OFFSET UNITYSDK_OFFSET(0x10205AD0)

inline static constexpr unsigned int Class_1_F0A747821C140515_TypeDefinitionIndex = 55777;
...
public:
	...
	{
		return (::Class_1_F0A747821C140515**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F0A747821C140515_TypeDefinitionIndex)->GetStaticField(0x3BF60);
	}
