...
#define CLASS_2_E451969B10231E68_METHOD_2_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x1C2A75A0)
#define CLASS_2_E451969B10231E68_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1C2A7820)
#define CLASS_2_E451969B10231E68_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1C2A77E0)
#define CLASS_2_E451969B10231E68_METHOD_2_D9B69CBFF2C3295F_OFFSET UNITYSDK_OFFSET(0x1C2A7960)
#define CLASS_2_E451969B10231E68__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2A74D0)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* NKKOKKFGNHC; // 0x18
	::RPG::GameCore::LittleGameEntityConfig* LOAGALADJPN; // 0x20
	::RPG::GameCore::LittleGameEntityConfig* EBEHGIPOOEI; // 0x28
	::RPG::GameCore::LittleGameEntityConfig* PBFLDBBIGNB; // 0x30
	::RPG::GameCore::LittleGameEntityConfig* PMBJAHLGBEG; // 0x38
	::RPG::GameCore::LittleGameLevelConfig* CLKEPOJFDPD; // 0x40
	::RPG::GameCore::LittleGameConstConfig* OEBCGADNGII; // 0x48
