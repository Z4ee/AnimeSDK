...
#define CLASS_2_8042A17D16AFC306_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x134FE7E0)
#define CLASS_2_8042A17D16AFC306_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x134FE790)
#define CLASS_2_8042A17D16AFC306_METHOD_2_4621DE889D0D5507_OFFSET UNITYSDK_OFFSET(0x134FE6D0)
#define CLASS_2_8042A17D16AFC306__CTOR_OFFSET UNITYSDK_OFFSET(0x134FE830)
...
{
public:
	::RPG::GameCore::GameEntity* DOCLLEDKMNK; // 0x18
	::RPG::GameCore::TaskContext* GPKCGOLOJKC; // 0x20
	::Class_1_43BD383C98B4C0C5_128* MGOHJJNKGNJ; // 0x28
	::RPG::GameCore::GameEntity* CFOAICLAMHO; // 0x30
	::Class_3_AD202E4D78C8CB31* MCDGBGOBFJN; // 0x38
