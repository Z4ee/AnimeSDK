...
#define CLASS_1_5B567C8A01BAEDFE_85_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1951ADC0)
#define CLASS_1_5B567C8A01BAEDFE_85_CLONE_OFFSET UNITYSDK_OFFSET(0x1951ABD0)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1951ACD0)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_OFFSET UNITYSDK_OFFSET(0x1951AC40)
#define CLASS_1_5B567C8A01BAEDFE_85_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1951AD20)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1951AE10)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1951ADE0)
#define CLASS_1_5B567C8A01BAEDFE_85_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1951AB20)
#define CLASS_1_5B567C8A01BAEDFE_85_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1951AB80)
#define CLASS_1_5B567C8A01BAEDFE_85_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1951AD50)
#define CLASS_1_5B567C8A01BAEDFE_85_WRITETO_OFFSET UNITYSDK_OFFSET(0x1951ADB0)
#define CLASS_1_5B567C8A01BAEDFE_85__CCTOR_OFFSET UNITYSDK_OFFSET(0x1951AE60)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1951ABA0)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_OFFSET UNITYSDK_OFFSET(0x1951AB90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_85_TypeDefinitionIndex = 26095;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_85*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_85_TypeDefinitionIndex)->GetStaticField(0x456A0);
	}
