...
#define CLASS_1_5B567C8A01BAEDFE_85_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DDB3B60)
#define CLASS_1_5B567C8A01BAEDFE_85_CLONE_OFFSET UNITYSDK_OFFSET(0x1DDB3850)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DDB3960)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DDB3890)
#define CLASS_1_5B567C8A01BAEDFE_85_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DDB3AC0)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DDB3BB0)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DDB3B80)
#define CLASS_1_5B567C8A01BAEDFE_85_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DDB37D0)
#define CLASS_1_5B567C8A01BAEDFE_85_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DDB3800)
#define CLASS_1_5B567C8A01BAEDFE_85_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DDB3AF0)
#define CLASS_1_5B567C8A01BAEDFE_85_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DDB3B50)
#define CLASS_1_5B567C8A01BAEDFE_85__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DDB3C00)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DDB3820)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDB3810)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_85_TypeDefinitionIndex = 27161;

class Class_1_5B567C8A01BAEDFE_85 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_85*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_85*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_85_TypeDefinitionIndex)->GetStaticField(0x1BF90);
	}
