...
#define CLASS_1_5B567C8A01BAEDFE_85_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EBA6AE0)
#define CLASS_1_5B567C8A01BAEDFE_85_CLONE_OFFSET UNITYSDK_OFFSET(0x1EBA67D0)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EBA68E0)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EBA6810)
#define CLASS_1_5B567C8A01BAEDFE_85_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EBA6A40)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EBA6B30)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EBA6B00)
#define CLASS_1_5B567C8A01BAEDFE_85_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EBA6750)
#define CLASS_1_5B567C8A01BAEDFE_85_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EBA6780)
#define CLASS_1_5B567C8A01BAEDFE_85_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EBA6A70)
#define CLASS_1_5B567C8A01BAEDFE_85_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EBA6AD0)
#define CLASS_1_5B567C8A01BAEDFE_85__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBA6B80)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EBA67A0)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBA6790)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_85*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_85_TypeDefinitionIndex)->GetStaticField(0x1B3A0);
	}
