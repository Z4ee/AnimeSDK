...
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AF8D900)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF8E040)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF8E0A0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AF8E050)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF8D8F0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF8D8E0)

inline static constexpr unsigned int MB3_TextureBaker___CreateAtlasesCoroutineAtlases_d__109_TypeDefinitionIndex = 84980;
