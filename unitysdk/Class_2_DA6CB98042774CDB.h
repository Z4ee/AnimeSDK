...
#define CLASS_2_DA6CB98042774CDB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F60E30)
#define CLASS_2_DA6CB98042774CDB_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x18F60D30)
#define CLASS_2_DA6CB98042774CDB_ONSKIP_OFFSET UNITYSDK_OFFSET(0x18F60D40)
#define CLASS_2_DA6CB98042774CDB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18F60F50)
#define CLASS_2_DA6CB98042774CDB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18F61070)
#define CLASS_2_DA6CB98042774CDB_TICK_OFFSET UNITYSDK_OFFSET(0x18F60E70)
#define CLASS_2_DA6CB98042774CDB__CTOR_OFFSET UNITYSDK_OFFSET(0x18F60D20)

inline static constexpr unsigned int Class_2_DA6CB98042774CDB_TypeDefinitionIndex = 52967;

class Class_2_DA6CB98042774CDB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::ClockParkStorySwitchBackground* IGHAHBNLIJA; // 0x20
