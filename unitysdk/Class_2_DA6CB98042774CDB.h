...
#define CLASS_2_DA6CB98042774CDB_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE024DE0)
#define CLASS_2_DA6CB98042774CDB_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xE024CA0)
#define CLASS_2_DA6CB98042774CDB_ONSKIP_OFFSET UNITYSDK_OFFSET(0xE024CB0)
#define CLASS_2_DA6CB98042774CDB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE024F40)
#define CLASS_2_DA6CB98042774CDB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE0250A0)
#define CLASS_2_DA6CB98042774CDB_TICK_OFFSET UNITYSDK_OFFSET(0xE024E20)
#define CLASS_2_DA6CB98042774CDB__CTOR_OFFSET UNITYSDK_OFFSET(0xE024C90)

inline static constexpr unsigned int Class_2_DA6CB98042774CDB_TypeDefinitionIndex = 48624;
