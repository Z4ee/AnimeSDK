...
#define RBDDESTRUCTION_RBDMANAGER_ASSETSCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC67A10)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDManager_AssetsCollider_TypeDefinitionIndex = 27067;
