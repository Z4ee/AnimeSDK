...
#define RBDDESTRUCTION_RBDMANAGER_ADD_ONDESTROYEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1927A030)
#define RBDDESTRUCTION_RBDMANAGER_ADD_ONGROUNDEDEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x19279ED0)
#define RBDDESTRUCTION_RBDMANAGER_ADD_ONHITEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x19279D70)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETDESTROYEVENTS_OFFSET UNITYSDK_OFFSET(0x1927AA10)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETEVENTS_OFFSET UNITYSDK_OFFSET(0x1927A7E0)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETGROUNDEVENTS_OFFSET UNITYSDK_OFFSET(0x1927A940)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETHITEVENTS_OFFSET UNITYSDK_OFFSET(0x1927A870)
#define RBDDESTRUCTION_RBDMANAGER_BREAKALLBUILDINGS_OFFSET UNITYSDK_OFFSET(0x1927DC30)
#define RBDDESTRUCTION_RBDMANAGER_BREAKBUILDINGSAFTERDELAY_OFFSET UNITYSDK_OFFSET(0x1927E350)
#define RBDDESTRUCTION_RBDMANAGER_BUILDINGINFOINIT_OFFSET UNITYSDK_OFFSET(0x1927C4F0)
#define RBDDESTRUCTION_RBDMANAGER_CLEARBUFFER_OFFSET UNITYSDK_OFFSET(0x1927E430)
#define RBDDESTRUCTION_RBDMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1927C3F0)
#define RBDDESTRUCTION_RBDMANAGER_DISPOSEBUFFER_OFFSET UNITYSDK_OFFSET(0x1927A780)
#define RBDDESTRUCTION_RBDMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19279D50)
#define RBDDESTRUCTION_RBDMANAGER_HITBUILDING_1_OFFSET UNITYSDK_OFFSET(0x1927CC30)
#define RBDDESTRUCTION_RBDMANAGER_HITBUILDING_OFFSET UNITYSDK_OFFSET(0x1927CA80)
#define RBDDESTRUCTION_RBDMANAGER_INITEVENTSBUFFER_OFFSET UNITYSDK_OFFSET(0x1927A190)
#define RBDDESTRUCTION_RBDMANAGER_INITMATERIALBUFFERS_OFFSET UNITYSDK_OFFSET(0x1927C6D0)
#define RBDDESTRUCTION_RBDMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x1927B0A0)
#define RBDDESTRUCTION_RBDMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1927E3E0)
#define RBDDESTRUCTION_RBDMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1927C920)
#define RBDDESTRUCTION_RBDMANAGER_PROCESSDESTROYEVENTS_OFFSET UNITYSDK_OFFSET(0x1927AD00)
#define RBDDESTRUCTION_RBDMANAGER_PROCESSGROUNDEVENTS_OFFSET UNITYSDK_OFFSET(0x1927AAE0)
#define RBDDESTRUCTION_RBDMANAGER_PROCESSHITEVENTS_OFFSET UNITYSDK_OFFSET(0x1927ABF0)
#define RBDDESTRUCTION_RBDMANAGER_RELEASEEVENTSBUFFER_OFFSET UNITYSDK_OFFSET(0x1927A500)
#define RBDDESTRUCTION_RBDMANAGER_REMOVE_ONDESTROYEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1927A0E0)
#define RBDDESTRUCTION_RBDMANAGER_REMOVE_ONGROUNDEDEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x19279F80)
#define RBDDESTRUCTION_RBDMANAGER_REMOVE_ONHITEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x19279E20)
#define RBDDESTRUCTION_RBDMANAGER_SETUPKERNEL_OFFSET UNITYSDK_OFFSET(0x1927C570)
#define RBDDESTRUCTION_RBDMANAGER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19279D60)
#define RBDDESTRUCTION_RBDMANAGER_SPAWNDESTROYBATCH_OFFSET UNITYSDK_OFFSET(0x1927AF50)
#define RBDDESTRUCTION_RBDMANAGER_SPAWNGROUNDEDBATCH_OFFSET UNITYSDK_OFFSET(0x1927AEB0)
#define RBDDESTRUCTION_RBDMANAGER_SPAWNHITBATCH_OFFSET UNITYSDK_OFFSET(0x1927AE10)
#define RBDDESTRUCTION_RBDMANAGER_UPDATEFRAGMENTPHYSICS_1_OFFSET UNITYSDK_OFFSET(0x1927D660)
#define RBDDESTRUCTION_RBDMANAGER_UPDATEFRAGMENTPHYSICS_OFFSET UNITYSDK_OFFSET(0x1927C9D0)
#define RBDDESTRUCTION_RBDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1927C970)
#define RBDDESTRUCTION_RBDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1927E510)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDManager_TypeDefinitionIndex = 29706;
	...
	public:
		...
		{
			return (::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_GroundedEvent>*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x233B0);
		}
		static ::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_DestroyEvent>*, ::System::Int32>** StaticGet_OnDestroyEventsBatch()
		{
			return (::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_DestroyEvent>*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x233B8);
		}
		static ::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_HitEvent>*, ::System::Int32>** StaticGet_OnHitEventsBatch()
		{
			return (::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_HitEvent>*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x233C0);
		}
		static ::RBDDestruction::RBDManager** StaticGet__instance_k__BackingField()
		{
			return (::RBDDestruction::RBDManager**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x233C8);
		}
