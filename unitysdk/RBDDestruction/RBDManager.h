...
#define RBDDESTRUCTION_RBDMANAGER_ADD_ONDESTROYEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1B171BD0)
#define RBDDESTRUCTION_RBDMANAGER_ADD_ONGROUNDEDEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1B171A70)
#define RBDDESTRUCTION_RBDMANAGER_ADD_ONHITEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1B171910)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETDESTROYEVENTS_OFFSET UNITYSDK_OFFSET(0x1B1725B0)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETEVENTS_OFFSET UNITYSDK_OFFSET(0x1B172380)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETGROUNDEVENTS_OFFSET UNITYSDK_OFFSET(0x1B1724E0)
#define RBDDESTRUCTION_RBDMANAGER_BINDANDRESETHITEVENTS_OFFSET UNITYSDK_OFFSET(0x1B172410)
#define RBDDESTRUCTION_RBDMANAGER_BREAKALLBUILDINGS_OFFSET UNITYSDK_OFFSET(0x1B1757D0)
#define RBDDESTRUCTION_RBDMANAGER_BREAKBUILDINGSAFTERDELAY_OFFSET UNITYSDK_OFFSET(0x1B175EF0)
#define RBDDESTRUCTION_RBDMANAGER_BUILDINGINFOINIT_OFFSET UNITYSDK_OFFSET(0x1B174090)
#define RBDDESTRUCTION_RBDMANAGER_CLEARBUFFER_OFFSET UNITYSDK_OFFSET(0x1B175FD0)
#define RBDDESTRUCTION_RBDMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B173F90)
#define RBDDESTRUCTION_RBDMANAGER_DISPOSEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B172320)
#define RBDDESTRUCTION_RBDMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B1718F0)
#define RBDDESTRUCTION_RBDMANAGER_HITBUILDING_1_OFFSET UNITYSDK_OFFSET(0x1B1747D0)
#define RBDDESTRUCTION_RBDMANAGER_HITBUILDING_OFFSET UNITYSDK_OFFSET(0x1B174620)
#define RBDDESTRUCTION_RBDMANAGER_INITEVENTSBUFFER_OFFSET UNITYSDK_OFFSET(0x1B171D30)
#define RBDDESTRUCTION_RBDMANAGER_INITMATERIALBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B174270)
#define RBDDESTRUCTION_RBDMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x1B172C40)
#define RBDDESTRUCTION_RBDMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B175F80)
#define RBDDESTRUCTION_RBDMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1744C0)
#define RBDDESTRUCTION_RBDMANAGER_PROCESSDESTROYEVENTS_OFFSET UNITYSDK_OFFSET(0x1B1728A0)
#define RBDDESTRUCTION_RBDMANAGER_PROCESSGROUNDEVENTS_OFFSET UNITYSDK_OFFSET(0x1B172680)
#define RBDDESTRUCTION_RBDMANAGER_PROCESSHITEVENTS_OFFSET UNITYSDK_OFFSET(0x1B172790)
#define RBDDESTRUCTION_RBDMANAGER_RELEASEEVENTSBUFFER_OFFSET UNITYSDK_OFFSET(0x1B1720A0)
#define RBDDESTRUCTION_RBDMANAGER_REMOVE_ONDESTROYEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1B171C80)
#define RBDDESTRUCTION_RBDMANAGER_REMOVE_ONGROUNDEDEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1B171B20)
#define RBDDESTRUCTION_RBDMANAGER_REMOVE_ONHITEVENTSBATCH_OFFSET UNITYSDK_OFFSET(0x1B1719C0)
#define RBDDESTRUCTION_RBDMANAGER_SETUPKERNEL_OFFSET UNITYSDK_OFFSET(0x1B174110)
#define RBDDESTRUCTION_RBDMANAGER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B171900)
#define RBDDESTRUCTION_RBDMANAGER_SPAWNDESTROYBATCH_OFFSET UNITYSDK_OFFSET(0x1B172AF0)
#define RBDDESTRUCTION_RBDMANAGER_SPAWNGROUNDEDBATCH_OFFSET UNITYSDK_OFFSET(0x1B172A50)
#define RBDDESTRUCTION_RBDMANAGER_SPAWNHITBATCH_OFFSET UNITYSDK_OFFSET(0x1B1729B0)
#define RBDDESTRUCTION_RBDMANAGER_UPDATEFRAGMENTPHYSICS_1_OFFSET UNITYSDK_OFFSET(0x1B175200)
#define RBDDESTRUCTION_RBDMANAGER_UPDATEFRAGMENTPHYSICS_OFFSET UNITYSDK_OFFSET(0x1B174570)
#define RBDDESTRUCTION_RBDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B174510)
#define RBDDESTRUCTION_RBDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1760B0)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDManager_TypeDefinitionIndex = 27124;
	...
	public:
		...
		{
			return (::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_GroundedEvent>*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x20AE0);
		}
		static ::RBDDestruction::RBDManager** StaticGet__instance_k__BackingField()
		{
			return (::RBDDestruction::RBDManager**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x20AE8);
		}
		static ::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_HitEvent>*, ::System::Int32>** StaticGet_OnHitEventsBatch()
		{
			return (::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_HitEvent>*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x20AF0);
		}
		static ::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_DestroyEvent>*, ::System::Int32>** StaticGet_OnDestroyEventsBatch()
		{
			return (::System::Action_2<::Il2CppArray<::RBDDestruction::RBDManager_DestroyEvent>*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RBDManager_TypeDefinitionIndex)->GetStaticField(0x20AF8);
		}
