...
#define RBDDESTRUCTION_RBDVOLUMEGROUPMANAGER_VOLUMEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xF7EBAC0)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDVolumeGroupManager_VolumeGroup_TypeDefinitionIndex = 29725;
