...
#define RBDDESTRUCTION_RBDMANAGER_ASSETSMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDF4C20)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDManager_AssetsMatrix_TypeDefinitionIndex = 27066;
