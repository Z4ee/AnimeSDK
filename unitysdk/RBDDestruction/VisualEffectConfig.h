...
#define RBDDESTRUCTION_VISUALEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B83F90)

namespace RBDDestruction
{
	inline static constexpr unsigned int VisualEffectConfig_TypeDefinitionIndex = 29703;
