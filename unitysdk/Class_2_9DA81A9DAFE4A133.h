...
#define CLASS_2_9DA81A9DAFE4A133_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C774F0)
#define CLASS_2_9DA81A9DAFE4A133_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C77530)
#define CLASS_2_9DA81A9DAFE4A133_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C77B40)
#define CLASS_2_9DA81A9DAFE4A133_TICK_OFFSET UNITYSDK_OFFSET(0x10C77B90)
#define CLASS_2_9DA81A9DAFE4A133__CTOR_OFFSET UNITYSDK_OFFSET(0x10C77420)

inline static constexpr unsigned int Class_2_9DA81A9DAFE4A133_TypeDefinitionIndex = 51657;

class Class_2_9DA81A9DAFE4A133 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RemoveDynamicEntityParam* Field_2_0; // 0x18
