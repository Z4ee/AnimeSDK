...
#define CLASS_1_355A2207C3B7A99D_68_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3A0FD0)
#define CLASS_1_355A2207C3B7A99D_68_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3A0C60)
#define CLASS_1_355A2207C3B7A99D_68_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3A0DF0)
#define CLASS_1_355A2207C3B7A99D_68_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3A0D40)
#define CLASS_1_355A2207C3B7A99D_68_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3A0E90)
#define CLASS_1_355A2207C3B7A99D_68_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3A1120)
#define CLASS_1_355A2207C3B7A99D_68_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3A1030)
#define CLASS_1_355A2207C3B7A99D_68_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A3A0D20)
#define CLASS_1_355A2207C3B7A99D_68_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3A0B60)
#define CLASS_1_355A2207C3B7A99D_68_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A3A0D30)
#define CLASS_1_355A2207C3B7A99D_68_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3A0B90)
#define CLASS_1_355A2207C3B7A99D_68_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3A0F10)
#define CLASS_1_355A2207C3B7A99D_68_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3A0F70)
#define CLASS_1_355A2207C3B7A99D_68__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3A12B0)
#define CLASS_1_355A2207C3B7A99D_68__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3A0BB0)
#define CLASS_1_355A2207C3B7A99D_68__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A0BA0)

inline static constexpr unsigned int Class_1_355A2207C3B7A99D_68_TypeDefinitionIndex = 30395;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_355A2207C3B7A99D_68*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_355A2207C3B7A99D_68_TypeDefinitionIndex)->GetStaticField(0x5C4C0);
	}
	...
	{
		return ((::Class_1_C2CA2C8C31F52936_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_68_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_C2CA2C8C31F52936_1* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_C2CA2C8C31F52936_1*))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_68_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
