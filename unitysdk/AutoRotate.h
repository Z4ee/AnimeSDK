...
#define AUTOROTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x14E176E0)
#define AUTOROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x14E178F0)

inline static constexpr unsigned int AutoRotate_TypeDefinitionIndex = 78198;
