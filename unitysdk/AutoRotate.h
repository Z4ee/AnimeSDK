...
#define AUTOROTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1491FA00)
#define AUTOROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1491FC10)

inline static constexpr unsigned int AutoRotate_TypeDefinitionIndex = 78575;
