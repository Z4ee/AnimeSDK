...
#define CLASS_1_CB599396E59DD4D3_METHOD_1_BA928C31B09C0D39_OFFSET UNITYSDK_OFFSET(0x1A3F6800)
#define CLASS_1_CB599396E59DD4D3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F6BC0)
...
{
public:
	::Il2CppArray<::System::UInt32>* JDKLJBMHHKO; // 0x10
	::System::String* AJJOOHJFNMC; // 0x18
	::Il2CppArray<::System::UInt32>* EBDLFNOELLO; // 0x20
	::Il2CppArray<::System::UInt32>* PPNLEBDNKNI; // 0x28
	::Il2CppArray<::System::UInt32>* PEOFHNELHLJ; // 0x30
	::System::String* IOCHHAPIOJA; // 0x38
	::RPG::Client::TextID MMOFKKMMKLK; // 0x40
	::System::UInt32 BFDOFFNMCPO; // 0x50
	::RPG::GameCore::TeamTowersStageType GMPGDEINODK; // 0x54
