...
#define CLASS_1_5B567C8A01BAEDFE_369_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19CC5A40)
#define CLASS_1_5B567C8A01BAEDFE_369_CLONE_OFFSET UNITYSDK_OFFSET(0x19CC58B0)
#define CLASS_1_5B567C8A01BAEDFE_369_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19CC5950)
#define CLASS_1_5B567C8A01BAEDFE_369_EQUALS_OFFSET UNITYSDK_OFFSET(0x19CC58F0)
#define CLASS_1_5B567C8A01BAEDFE_369_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19CC59A0)
#define CLASS_1_5B567C8A01BAEDFE_369_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19CC5A90)
#define CLASS_1_5B567C8A01BAEDFE_369_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19CC5A60)
#define CLASS_1_5B567C8A01BAEDFE_369_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19CC5830)
#define CLASS_1_5B567C8A01BAEDFE_369_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19CC5860)
#define CLASS_1_5B567C8A01BAEDFE_369_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19CC59D0)
#define CLASS_1_5B567C8A01BAEDFE_369_WRITETO_OFFSET UNITYSDK_OFFSET(0x19CC5A30)
#define CLASS_1_5B567C8A01BAEDFE_369__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CC5AE0)
#define CLASS_1_5B567C8A01BAEDFE_369__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19CC5880)
#define CLASS_1_5B567C8A01BAEDFE_369__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC5870)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_369_TypeDefinitionIndex = 32826;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_369*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_369_TypeDefinitionIndex)->GetStaticField(0x65CB0);
	}
