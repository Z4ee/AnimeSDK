...
#define BEEBYTE_OBFUSCATOR_RENAMEATTRIBUTE_GETTARGET_OFFSET UNITYSDK_OFFSET(0x1BD98D10)
#define BEEBYTE_OBFUSCATOR_RENAMEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD98D00)
#define BEEBYTE_OBFUSCATOR_RENAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD98CF0)

namespace Beebyte::Obfuscator
{
	inline static constexpr unsigned int RenameAttribute_TypeDefinitionIndex = 45260;
