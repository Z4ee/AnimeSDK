...
#define PSFOLLOWOWNERSHAPE_ATTACHTOOWNERMODELRENDERSHAPE_OFFSET UNITYSDK_OFFSET(0x1A154A90)
#define PSFOLLOWOWNERSHAPE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A1549F0)
#define PSFOLLOWOWNERSHAPE_REFRESHOWNERRENDERSHAPE_OFFSET UNITYSDK_OFFSET(0x1A154820)
#define PSFOLLOWOWNERSHAPE_RESET_OFFSET UNITYSDK_OFFSET(0x1A154A40)
#define PSFOLLOWOWNERSHAPE_START_OFFSET UNITYSDK_OFFSET(0x1A1547D0)
#define PSFOLLOWOWNERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A154C20)

inline static constexpr unsigned int PSFollowOwnerShape_TypeDefinitionIndex = 72100;
