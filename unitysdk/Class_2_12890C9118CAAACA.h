...
#define CLASS_2_12890C9118CAAACA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E27A50)
#define CLASS_2_12890C9118CAAACA_METHOD_2_4D72DCC0B92993D6_OFFSET UNITYSDK_OFFSET(0x18E28D50)
#define CLASS_2_12890C9118CAAACA_METHOD_2_8377BC0DCBA8CDB6_OFFSET UNITYSDK_OFFSET(0x18E28D60)
#define CLASS_2_12890C9118CAAACA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18E27C30)
#define CLASS_2_12890C9118CAAACA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18E287F0)
#define CLASS_2_12890C9118CAAACA_TICK_OFFSET UNITYSDK_OFFSET(0x18E28840)
#define CLASS_2_12890C9118CAAACA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E278F0)
...
{
public:
	::RPG::GameCore::SortTargets* OFKGLJOAMLD; // 0x18
	::Class_1_5F51D4049EA87B7B* LLHKOFLJFCH; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::Class_3_07C3C4D2990C49EE* FNLJDEPHGFK; // 0x30
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* BLOMOEJJCIK; // 0x38
	::System::Collections::Generic::List_1<::Class_3_07C3C4D2990C49EE*>* FBAGEMHGIIB; // 0x40
