...
#define CLASS_3_C595530C21E9D2C1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18E30FF0)
#define CLASS_3_C595530C21E9D2C1__CTOR_OFFSET UNITYSDK_OFFSET(0x18E30FC0)

inline static constexpr unsigned int Class_3_C595530C21E9D2C1_TypeDefinitionIndex = 55375;
