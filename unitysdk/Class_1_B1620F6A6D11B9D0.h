...
#define CLASS_1_B1620F6A6D11B9D0_GET_DESC_OFFSET UNITYSDK_OFFSET(0x18BDA1E0)
#define CLASS_1_B1620F6A6D11B9D0_GET_FULLDESC_OFFSET UNITYSDK_OFFSET(0x18BDA240)
#define CLASS_1_B1620F6A6D11B9D0_GET_ID_OFFSET UNITYSDK_OFFSET(0x18BDA1A0)
#define CLASS_1_B1620F6A6D11B9D0_GET_MIDDLEDESC_OFFSET UNITYSDK_OFFSET(0x18BDA220)
#define CLASS_1_B1620F6A6D11B9D0_GET_OWNERSNAME_OFFSET UNITYSDK_OFFSET(0x18BDA200)
#define CLASS_1_B1620F6A6D11B9D0_GET_SERVANTCARDOWNERTYPE_OFFSET UNITYSDK_OFFSET(0x18BDA1C0)
#define CLASS_1_B1620F6A6D11B9D0_METHOD_1_A85A5A4F484E8E77_OFFSET UNITYSDK_OFFSET(0x18BDA260)
#define CLASS_1_B1620F6A6D11B9D0_SET_DESC_OFFSET UNITYSDK_OFFSET(0x18BDA1F0)
#define CLASS_1_B1620F6A6D11B9D0_SET_FULLDESC_OFFSET UNITYSDK_OFFSET(0x18BDA250)
#define CLASS_1_B1620F6A6D11B9D0_SET_ID_OFFSET UNITYSDK_OFFSET(0x18BDA1B0)
#define CLASS_1_B1620F6A6D11B9D0_SET_MIDDLEDESC_OFFSET UNITYSDK_OFFSET(0x18BDA230)
#define CLASS_1_B1620F6A6D11B9D0_SET_OWNERSNAME_OFFSET UNITYSDK_OFFSET(0x18BDA210)
#define CLASS_1_B1620F6A6D11B9D0_SET_SERVANTCARDOWNERTYPE_OFFSET UNITYSDK_OFFSET(0x18BDA1D0)
#define CLASS_1_B1620F6A6D11B9D0__CTOR_OFFSET UNITYSDK_OFFSET(0x18BDA350)

inline static constexpr unsigned int Class_1_B1620F6A6D11B9D0_TypeDefinitionIndex = 79812;

class Class_1_B1620F6A6D11B9D0 : public ::System::Object
{
public:
	::System::String* _FullDesc_k__BackingField; // 0x10
	::RPG::Client::TextID _OwnersName_k__BackingField; // 0x18
	::RPG::Client::TextID _MiddleDesc_k__BackingField; // 0x28
	::RPG::Client::TextID _Desc_k__BackingField; // 0x38
	::RPG::GameCore::FateRinHouguOwnerType _ServantCardOwnerType_k__BackingField; // 0x48
