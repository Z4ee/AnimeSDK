...
#define CLASS_2_0161C2FC7AFF3FAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15EF1240)
#define CLASS_2_0161C2FC7AFF3FAA_METHOD_2_319CB30159DF6F08_OFFSET UNITYSDK_OFFSET(0x15EF18C0)
#define CLASS_2_0161C2FC7AFF3FAA_METHOD_2_D3A565A802E80D24_OFFSET UNITYSDK_OFFSET(0x15EF1B10)
#define CLASS_2_0161C2FC7AFF3FAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15EF1290)
#define CLASS_2_0161C2FC7AFF3FAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15EF1F10)
#define CLASS_2_0161C2FC7AFF3FAA_TICK_OFFSET UNITYSDK_OFFSET(0x15EF1FA0)
#define CLASS_2_0161C2FC7AFF3FAA__CTOR_OFFSET UNITYSDK_OFFSET(0x15EF11A0)

inline static constexpr unsigned int Class_2_0161C2FC7AFF3FAA_TypeDefinitionIndex = 52729;

class Class_2_0161C2FC7AFF3FAA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_2_24A88014580ADDB3* Field_2_0; // 0x18
	::Struct_2_CC45B4503679E14E_57 Field_2_1; // 0x20
	::RPG::GameCore::TaskContext* Field_2_2; // 0x30
	::Class_2_2461A19B320A03F9* Field_2_3; // 0x38
	::RPG::GameCore::MoveToTargetList* Field_2_4; // 0x40
