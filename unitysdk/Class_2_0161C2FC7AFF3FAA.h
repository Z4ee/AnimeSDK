...
#define CLASS_2_0161C2FC7AFF3FAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1092C7C0)
#define CLASS_2_0161C2FC7AFF3FAA_METHOD_2_319CB30159DF6F08_OFFSET UNITYSDK_OFFSET(0x1092CC90)
#define CLASS_2_0161C2FC7AFF3FAA_METHOD_2_C3B07CFF6BC616BE_OFFSET UNITYSDK_OFFSET(0x1092CEC0)
#define CLASS_2_0161C2FC7AFF3FAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1092C810)
#define CLASS_2_0161C2FC7AFF3FAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1092D1E0)
#define CLASS_2_0161C2FC7AFF3FAA_TICK_OFFSET UNITYSDK_OFFSET(0x1092D270)
#define CLASS_2_0161C2FC7AFF3FAA__CTOR_OFFSET UNITYSDK_OFFSET(0x1092C720)

inline static constexpr unsigned int Class_2_0161C2FC7AFF3FAA_TypeDefinitionIndex = 44208;

class Class_2_0161C2FC7AFF3FAA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Struct_2_CC45B4503679E14E Field_2_8; // 0x18
	::Class_2_81F92B0B04671207* Field_2_4; // 0x28
	::RPG::GameCore::TaskContext* Field_2_1; // 0x30
	::Class_2_1DBE0E1023AFDBC5* Field_2_2; // 0x38
	::UnityEngine::Animator* Field_2_3; // 0x40
	::RPG::GameCore::MoveToTargetList* Field_2_0; // 0x48
