...
#define CLASS_1_F6B785197712430F_METHOD_1_0947F577F1E5AE4F_OFFSET UNITYSDK_OFFSET(0x14914FC0)
#define CLASS_1_F6B785197712430F_METHOD_1_8E2C129DE4FC3609_OFFSET UNITYSDK_OFFSET(0x149150B0)
#define CLASS_1_F6B785197712430F_METHOD_1_9C25CF5A7B0B9AEF_OFFSET UNITYSDK_OFFSET(0x14915270)
#define CLASS_1_F6B785197712430F_METHOD_1_B77EEDF8ECF69212_OFFSET UNITYSDK_OFFSET(0x14915480)
#define CLASS_1_F6B785197712430F_METHOD_1_C22B31761DC46521_OFFSET UNITYSDK_OFFSET(0x14914FB0)

inline static constexpr unsigned int Class_1_F6B785197712430F_TypeDefinitionIndex = 52721;
...
public:
	...
	{
		return (::MoleMole::Config::ConfigTeleportSelections**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F6B785197712430F_TypeDefinitionIndex)->GetStaticField(0x382C0);
	}
