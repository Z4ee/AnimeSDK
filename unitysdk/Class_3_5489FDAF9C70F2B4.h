...
#define CLASS_3_5489FDAF9C70F2B4_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19FE3E50)
#define CLASS_3_5489FDAF9C70F2B4__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE3E20)

inline static constexpr unsigned int Class_3_5489FDAF9C70F2B4_TypeDefinitionIndex = 54888;
