...
#define CLASS_1_24C7DBE81C8DCCB7_METHOD_1_18A7BF8B592973BC_OFFSET UNITYSDK_OFFSET(0x18F9E7C0)
#define CLASS_1_24C7DBE81C8DCCB7_METHOD_1_A467DFE7862A0D44_OFFSET UNITYSDK_OFFSET(0x18F9E2B0)
#define CLASS_1_24C7DBE81C8DCCB7_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x18F9E220)
#define CLASS_1_24C7DBE81C8DCCB7_METHOD_1_C7E8C9D37CBB3C94_OFFSET UNITYSDK_OFFSET(0x18F9E9C0)
#define CLASS_1_24C7DBE81C8DCCB7_METHOD_1_C95C72C01AAA34B5_OFFSET UNITYSDK_OFFSET(0x18F9E050)
#define CLASS_1_24C7DBE81C8DCCB7_METHOD_1_F3056E6B09294016_OFFSET UNITYSDK_OFFSET(0x18F9E340)
#define CLASS_1_24C7DBE81C8DCCB7_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0x18F9D8D0)
#define CLASS_1_24C7DBE81C8DCCB7_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0x18F9DD00)
#define CLASS_1_24C7DBE81C8DCCB7__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F9EC30)
#define CLASS_1_24C7DBE81C8DCCB7__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9EAF0)

inline static constexpr unsigned int Class_1_24C7DBE81C8DCCB7_TypeDefinitionIndex = 73152;

class Class_1_24C7DBE81C8DCCB7 : public ::System::Object
{
public:
	static ::System::Boolean* StaticGet_MOKNCFJICIC()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_24C7DBE81C8DCCB7_TypeDefinitionIndex)->GetStaticField(0x9E60);
	}
	::RPG::GameCore::GameWorld* IMMBMILPPFB; // 0x10
	::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>* EAJCPNKLDID; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::Class_1_E8972CDB20ABFBE4*>* KNLPBDKAGLP; // 0x20
