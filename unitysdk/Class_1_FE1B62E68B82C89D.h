...
#define CLASS_1_FE1B62E68B82C89D_CLEAR_OFFSET UNITYSDK_OFFSET(0xDAAD710)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_0B9393FF4819E623_OFFSET UNITYSDK_OFFSET(0xDAAE540)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_340B09B8101954D0_OFFSET UNITYSDK_OFFSET(0xDAAE960)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_66456C92217FE904_OFFSET UNITYSDK_OFFSET(0xDAAD910)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_7BD404790CD546FB_OFFSET UNITYSDK_OFFSET(0xDAAE120)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_7EABD45AC410AEDE_OFFSET UNITYSDK_OFFSET(0xDAAE5F0)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_887076C3AE781BC5_OFFSET UNITYSDK_OFFSET(0xDAAD780)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_A39BC28B44D93F59_OFFSET UNITYSDK_OFFSET(0xDAADBE0)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0xDAAD3C0)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_C415407BB0EB376A_OFFSET UNITYSDK_OFFSET(0xDAAD2D0)
#define CLASS_1_FE1B62E68B82C89D_METHOD_1_FB5698F55343DDF5_OFFSET UNITYSDK_OFFSET(0xDAAD580)
#define CLASS_1_FE1B62E68B82C89D__CTOR_OFFSET UNITYSDK_OFFSET(0xDAAECB0)
...
{
public:
	::System::Collections::Generic::List_1<::System::Single>* HJBHGBIFCLN; // 0x10
	::Class_1_C58549E83E2A95B6* PBOBGOFNGMH; // 0x18
	::UnityEngine::Vector3 CGHEFMPCGGJ; // 0x20
	::System::Int32 FCHELGCIIOB; // 0x2C
	::System::Single PIFPMOFLAAJ; // 0x30
	::System::Single LOBALJEAOPJ; // 0x34
