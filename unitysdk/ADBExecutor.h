...
#define ADBEXECUTOR_CONNECTDEVICE_OFFSET UNITYSDK_OFFSET(0x1F225560)
#define ADBEXECUTOR_GETFIRSTCONNECTEDANDROIDDEVICE_OFFSET UNITYSDK_OFFSET(0x1F224DB0)
#define ADBEXECUTOR_ISFORWARDING_OFFSET UNITYSDK_OFFSET(0x1F224DA0)
#define ADBEXECUTOR_LOADADBPATH_OFFSET UNITYSDK_OFFSET(0x1F224CA0)
#define ADBEXECUTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F224A80)

inline static constexpr unsigned int ADBExecutor_TypeDefinitionIndex = 38736;
