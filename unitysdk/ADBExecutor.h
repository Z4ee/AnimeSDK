...
#define ADBEXECUTOR_CONNECTDEVICE_OFFSET UNITYSDK_OFFSET(0x1DE11D70)
#define ADBEXECUTOR_GETFIRSTCONNECTEDANDROIDDEVICE_OFFSET UNITYSDK_OFFSET(0x1DE115C0)
#define ADBEXECUTOR_ISFORWARDING_OFFSET UNITYSDK_OFFSET(0x1DE115B0)
#define ADBEXECUTOR_LOADADBPATH_OFFSET UNITYSDK_OFFSET(0x1DE114B0)
#define ADBEXECUTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE11290)

inline static constexpr unsigned int ADBExecutor_TypeDefinitionIndex = 38075;
