...
#define CLASS_1_BBDB4FC982910AAE_GET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x16AD7B20)
#define CLASS_1_BBDB4FC982910AAE_GET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x16AD7B10)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_00DB1B1197C37C43_OFFSET UNITYSDK_OFFSET(0x16AD7440)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x16AD7840)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_0FFCA426B159D768_OFFSET UNITYSDK_OFFSET(0x16AD7350)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_1F1C98D6DF492EBF_OFFSET UNITYSDK_OFFSET(0x16AD7640)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_41EF9FDF8B1D6495_OFFSET UNITYSDK_OFFSET(0x16AD7140)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_B5E70EA91188B770_OFFSET UNITYSDK_OFFSET(0x16AD74F0)
#define CLASS_1_BBDB4FC982910AAE_SET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x16AD7B30)
#define CLASS_1_BBDB4FC982910AAE__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD7090)

inline static constexpr unsigned int Class_1_BBDB4FC982910AAE_TypeDefinitionIndex = 72633;

class Class_1_BBDB4FC982910AAE : public ::System::Object
{
public:
	::Entitas::IContext* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_F878001C4B922748*>* Field_1_1; // 0x18
	::Class_0_16E4307DCC419505_39* _GameInstance_k__BackingField; // 0x20
	::Class_3_9F40BD36E5F30CAE* _InstanceClient_k__BackingField; // 0x28
