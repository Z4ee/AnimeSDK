...
#define CLASS_1_BBDB4FC982910AAE_GET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0xE8B3380)
#define CLASS_1_BBDB4FC982910AAE_GET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0xE8B3370)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_00DB1B1197C37C43_OFFSET UNITYSDK_OFFSET(0xE8B2CA0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0xE8B30A0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_0FFCA426B159D768_OFFSET UNITYSDK_OFFSET(0xE8B2BB0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_1F1C98D6DF492EBF_OFFSET UNITYSDK_OFFSET(0xE8B2EA0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_41EF9FDF8B1D6495_OFFSET UNITYSDK_OFFSET(0xE8B29A0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_B5E70EA91188B770_OFFSET UNITYSDK_OFFSET(0xE8B2D50)
#define CLASS_1_BBDB4FC982910AAE_SET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0xE8B3390)
#define CLASS_1_BBDB4FC982910AAE__CTOR_OFFSET UNITYSDK_OFFSET(0xE8B28F0)

inline static constexpr unsigned int Class_1_BBDB4FC982910AAE_TypeDefinitionIndex = 76070;
...
public:
	...
	::Class_0_16E4307DCC419505_39* _GameInstance_k__BackingField; // 0x18
	::Entitas::IContext* EEFMDEHLLFI; // 0x20
