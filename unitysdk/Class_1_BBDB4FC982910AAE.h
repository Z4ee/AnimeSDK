...
#define CLASS_1_BBDB4FC982910AAE_GET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x8C256D0)
#define CLASS_1_BBDB4FC982910AAE_GET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x8C256C0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_18CE1970D42ACC70_OFFSET UNITYSDK_OFFSET(0x8C25330)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_5DBE0D8848C75126_OFFSET UNITYSDK_OFFSET(0x8C25100)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_8B933DECC394D41D_OFFSET UNITYSDK_OFFSET(0x8C254D0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_971DAF87368385CC_OFFSET UNITYSDK_OFFSET(0x8C24EC0)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_A913AABBB5B75EFA_OFFSET UNITYSDK_OFFSET(0x8C24470)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_B5E70EA91188B770_OFFSET UNITYSDK_OFFSET(0x8C25230)
#define CLASS_1_BBDB4FC982910AAE_SET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x8C256E0)
#define CLASS_1_BBDB4FC982910AAE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C24E10)

inline static constexpr unsigned int Class_1_BBDB4FC982910AAE_TypeDefinitionIndex = 62305;

class Class_1_BBDB4FC982910AAE : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_31* _GameInstance_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_F878001C4B922748*>* Field_1_2; // 0x18
	::Class_3_C66DEDBB208C643C* _InstanceClient_k__BackingField; // 0x20
	::Entitas::IContext* Field_1_3; // 0x28
