...
#define CLASS_2_AF0CF8D32079A59D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF1A9B0)
#define CLASS_2_AF0CF8D32079A59D_METHOD_2_FCEF005F844F513C_OFFSET UNITYSDK_OFFSET(0x1AF1ABE0)
#define CLASS_2_AF0CF8D32079A59D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1AF1AAD0)
#define CLASS_2_AF0CF8D32079A59D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1AF1A960)
#define CLASS_2_AF0CF8D32079A59D_TICK_OFFSET UNITYSDK_OFFSET(0x1AF1A8C0)
#define CLASS_2_AF0CF8D32079A59D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF1A840)

inline static constexpr unsigned int Class_2_AF0CF8D32079A59D_TypeDefinitionIndex = 58632;

class Class_2_AF0CF8D32079A59D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_97C496F5D89C4BC2* JKJPFJALGKO; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_3_07C3C4D2990C49EE* HIBJGHDJLJO; // 0x28
