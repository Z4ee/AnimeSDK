...
#define CLASS_1_3EEDB4263A2F6FE3__CTOR_OFFSET UNITYSDK_OFFSET(0xE024340)

inline static constexpr unsigned int Class_1_3EEDB4263A2F6FE3_TypeDefinitionIndex = 80664;
...
public:
	...
	::RPG::GameCore::B51RacingPartType OAPONHEHCOJ; // 0x20
	::System::UInt32 CMNOEFFFNPE; // 0x24
	::RPG::Client::B51Racing::B51RacingDIYDecoItemType LINLNNHIBAK; // 0x28
	::System::Boolean AALCCPJCBME; // 0x2C
	::System::Boolean HELJNHNDCJP; // 0x2D
