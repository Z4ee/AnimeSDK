...
#define MONOUPDATEMODEBASE_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x116CED90)
#define MONOUPDATEMODEBASE_GET__ACCURACYCOUNT_OFFSET UNITYSDK_OFFSET(0x116CED00)
#define MONOUPDATEMODEBASE_TRYCALCULATESTEPTIME_OFFSET UNITYSDK_OFFSET(0x116CED10)
#define MONOUPDATEMODEBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x116CEF00)
#define MONOUPDATEMODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x116CEF50)

inline static constexpr unsigned int MonoUpdateModeBase_TypeDefinitionIndex = 39843;
