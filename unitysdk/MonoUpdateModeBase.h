...
#define MONOUPDATEMODEBASE_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0xF722760)
#define MONOUPDATEMODEBASE_GET__ACCURACYCOUNT_OFFSET UNITYSDK_OFFSET(0xF7226D0)
#define MONOUPDATEMODEBASE_TRYCALCULATESTEPTIME_OFFSET UNITYSDK_OFFSET(0xF7226E0)
#define MONOUPDATEMODEBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xF7228F0)
#define MONOUPDATEMODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xF722940)

inline static constexpr unsigned int MonoUpdateModeBase_TypeDefinitionIndex = 76412;
