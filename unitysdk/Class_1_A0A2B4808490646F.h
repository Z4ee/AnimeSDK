...
#define CLASS_1_A0A2B4808490646F_CLEAR_OFFSET UNITYSDK_OFFSET(0x10497F70)
#define CLASS_1_A0A2B4808490646F_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x10498070)
#define CLASS_1_A0A2B4808490646F_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x10498090)
#define CLASS_1_A0A2B4808490646F_METHOD_1_A538D7DBA7BF5017_OFFSET UNITYSDK_OFFSET(0x10497FC0)
#define CLASS_1_A0A2B4808490646F_METHOD_1_F3B68CBB8AE22AB6_OFFSET UNITYSDK_OFFSET(0x10497EF0)
#define CLASS_1_A0A2B4808490646F_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x10498080)
#define CLASS_1_A0A2B4808490646F_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x104980A0)
#define CLASS_1_A0A2B4808490646F__CTOR_OFFSET UNITYSDK_OFFSET(0x104980B0)

inline static constexpr unsigned int Class_1_A0A2B4808490646F_TypeDefinitionIndex = 45776;
