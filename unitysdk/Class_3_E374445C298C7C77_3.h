...
#define CLASS_3_E374445C298C7C77_3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1937C4B0)
#define CLASS_3_E374445C298C7C77_3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1937C540)
#define CLASS_3_E374445C298C7C77_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1937C480)

inline static constexpr unsigned int Class_3_E374445C298C7C77_3_TypeDefinitionIndex = 51178;
