...
#define CLASS_2_4B12DF909ABFF25F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17AAFA90)
#define CLASS_2_4B12DF909ABFF25F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17AAFAD0)
#define CLASS_2_4B12DF909ABFF25F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17AAFB30)
#define CLASS_2_4B12DF909ABFF25F_TICK_OFFSET UNITYSDK_OFFSET(0x17AAFB80)
#define CLASS_2_4B12DF909ABFF25F__CTOR_OFFSET UNITYSDK_OFFSET(0x17AAFA80)

inline static constexpr unsigned int Class_2_4B12DF909ABFF25F_TypeDefinitionIndex = 53909;

class Class_2_4B12DF909ABFF25F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ShowBattleEventTips* Field_2_1; // 0x20
