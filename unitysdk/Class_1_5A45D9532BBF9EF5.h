...
#define CLASS_1_5A45D9532BBF9EF5_GET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x158611E0)
#define CLASS_1_5A45D9532BBF9EF5_GET_ISDRAGGINGUIITEM_OFFSET UNITYSDK_OFFSET(0x15861200)
#define CLASS_1_5A45D9532BBF9EF5_GET_ISEXPANDSELECT_OFFSET UNITYSDK_OFFSET(0x15861220)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_04AF66402B9859B9_OFFSET UNITYSDK_OFFSET(0x15860980)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_050D955490C4C3D0_OFFSET UNITYSDK_OFFSET(0x1585F8A0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_078D85152011B919_1_OFFSET UNITYSDK_OFFSET(0x15860F10)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x15860E10)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_16F329E8131CBCB7_OFFSET UNITYSDK_OFFSET(0x15860460)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0x1585FDE0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_2C1C2A8E63DB0F10_OFFSET UNITYSDK_OFFSET(0x15860A30)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_2C9894E935536006_OFFSET UNITYSDK_OFFSET(0x15860380)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_3BEE013982122797_OFFSET UNITYSDK_OFFSET(0x158602A0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_3E7178C5ECF017DB_1_OFFSET UNITYSDK_OFFSET(0x15860580)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x15860530)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x158609D0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_46206B56BD30B28B_OFFSET UNITYSDK_OFFSET(0x15861110)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_4C27DE82B2DFE27A_OFFSET UNITYSDK_OFFSET(0x15860300)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x1585F7E0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_6173AF17811AED4B_OFFSET UNITYSDK_OFFSET(0x15861150)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_6FE6E0587E8D1F5C_OFFSET UNITYSDK_OFFSET(0x1585F590)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_8849372481724D9B_OFFSET UNITYSDK_OFFSET(0x158603F0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_97428D6179B1CFD2_OFFSET UNITYSDK_OFFSET(0x15860C50)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_A1D8C338F14D1B57_OFFSET UNITYSDK_OFFSET(0x15860920)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_BCD83C07168CC893_OFFSET UNITYSDK_OFFSET(0x1585B4A0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_C8242D0340185D87_OFFSET UNITYSDK_OFFSET(0x15860000)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_CF2323683121E2E8_OFFSET UNITYSDK_OFFSET(0x1585B200)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0x158605D0)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_E14A7FCF78650419_OFFSET UNITYSDK_OFFSET(0x1585FC90)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_E4DDC118595D11DF_OFFSET UNITYSDK_OFFSET(0x1585FD70)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x1585FC30)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_F4D6A15EBC6DEA3E_OFFSET UNITYSDK_OFFSET(0x1585B310)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_F7214300AC6F4344_1_OFFSET UNITYSDK_OFFSET(0x15861090)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_F7214300AC6F4344_OFFSET UNITYSDK_OFFSET(0x15861010)
#define CLASS_1_5A45D9532BBF9EF5_METHOD_1_F944CC0CE8B3E57A_OFFSET UNITYSDK_OFFSET(0x1585FB70)
#define CLASS_1_5A45D9532BBF9EF5_SET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x158611F0)
#define CLASS_1_5A45D9532BBF9EF5_SET_ISDRAGGINGUIITEM_OFFSET UNITYSDK_OFFSET(0x15861210)
#define CLASS_1_5A45D9532BBF9EF5_SET_ISEXPANDSELECT_OFFSET UNITYSDK_OFFSET(0x15861230)
#define CLASS_1_5A45D9532BBF9EF5__CTOR_OFFSET UNITYSDK_OFFSET(0x1585F4E0)

inline static constexpr unsigned int Class_1_5A45D9532BBF9EF5_TypeDefinitionIndex = 77298;

class Class_1_5A45D9532BBF9EF5 : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::ChenLingFes::ChenLingFesJoyStickState, ::Class_1_61D78C3DEA410E5A*>* FMKOCCEPMBG; // 0x10
	::System::Action_3<::RPG::Client::VirtualCursorSimulateTouchActionWrapper*, ::UnityEngine::GameObject*, ::UnityEngine::EventSystems::PointerEventData*>* CLFCPEOPCFK; // 0x18
	::RPG::Common::StateMachine_1<::Class_1_5A45D9532BBF9EF5*>* CBIGPGKJAEI; // 0x20
	::System::Action_3<::RPG::Client::VirtualCursorSimulateTouchActionWrapper*, ::UnityEngine::GameObject*, ::UnityEngine::EventSystems::PointerEventData*>* AFNLFDEBMKC; // 0x28
	::Class_3_97041AE90E3B2214* PDENFEFCAGN; // 0x30
	::RPG::Client::VirtualCursorSimulateTouchActionWrapper* JMLBHJIEFNF; // 0x38
	::System::Action* OMAICAFCLKK; // 0x40
	::RPG::Client::LittleGame::ChenLingFes::ChenLingFesJoyStickState _CurJoyStickState_k__BackingField; // 0x48
	::System::Nullable_1<::UnityEngine::Vector3> HOLDJMMAFFN; // 0x4C
	::System::Boolean _IsExpandSelect_k__BackingField; // 0x5C
	::System::Boolean _IsDraggingUIItem_k__BackingField; // 0x5D
