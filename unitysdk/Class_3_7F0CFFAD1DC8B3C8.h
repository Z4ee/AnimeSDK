...
#define CLASS_3_7F0CFFAD1DC8B3C8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x165C3E80)
#define CLASS_3_7F0CFFAD1DC8B3C8_METHOD_3_0397616FAD7FE5AD_OFFSET UNITYSDK_OFFSET(0x165C3F20)
#define CLASS_3_7F0CFFAD1DC8B3C8_METHOD_3_2638719AE9FDAF90_OFFSET UNITYSDK_OFFSET(0x165C4160)
#define CLASS_3_7F0CFFAD1DC8B3C8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x165C3EC0)
#define CLASS_3_7F0CFFAD1DC8B3C8__CTOR_OFFSET UNITYSDK_OFFSET(0x165C3DA0)

inline static constexpr unsigned int Class_3_7F0CFFAD1DC8B3C8_TypeDefinitionIndex = 55789;

class Class_3_7F0CFFAD1DC8B3C8 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::SetWeatherUI*>
{
public:
	::System::Collections::Generic::List_1<::Class_1_424581DF7DB1F4F0_Struct_2_74774458D8863C06>* DEKGAJLHDGE; // 0x28
