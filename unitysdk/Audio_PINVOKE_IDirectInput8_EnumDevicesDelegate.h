...
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18171660)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18171750)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18171280)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18171260)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_EnumDevicesDelegate_TypeDefinitionIndex = 80178;
