...
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12389D50)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12389E40)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x12389930)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x12389910)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_EnumDevicesDelegate_TypeDefinitionIndex = 86137;
