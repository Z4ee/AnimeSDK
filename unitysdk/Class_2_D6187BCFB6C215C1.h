...
#define CLASS_2_D6187BCFB6C215C1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11AA0250)
#define CLASS_2_D6187BCFB6C215C1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11AA0290)
#define CLASS_2_D6187BCFB6C215C1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11AA0380)
#define CLASS_2_D6187BCFB6C215C1_TICK_OFFSET UNITYSDK_OFFSET(0x11AA03D0)
#define CLASS_2_D6187BCFB6C215C1__CTOR_OFFSET UNITYSDK_OFFSET(0x11AA0240)

inline static constexpr unsigned int Class_2_D6187BCFB6C215C1_TypeDefinitionIndex = 51401;

class Class_2_D6187BCFB6C215C1 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TriggerModifierPhase1Perform* Field_2_0; // 0x18
