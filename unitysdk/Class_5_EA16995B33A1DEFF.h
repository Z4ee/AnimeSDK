...
#define CLASS_5_EA16995B33A1DEFF_CLONE_OFFSET UNITYSDK_OFFSET(0x15605A00)
#define CLASS_5_EA16995B33A1DEFF_METHOD_5_76C20C1C1323A406_OFFSET UNITYSDK_OFFSET(0x156057E0)
#define CLASS_5_EA16995B33A1DEFF_METHOD_5_A121432BC80DD093_OFFSET UNITYSDK_OFFSET(0x15605590)
#define CLASS_5_EA16995B33A1DEFF_METHOD_5_C34A0F1A8A1B4952_OFFSET UNITYSDK_OFFSET(0x15605640)
#define CLASS_5_EA16995B33A1DEFF_REVERSE_OFFSET UNITYSDK_OFFSET(0x15605A70)
#define CLASS_5_EA16995B33A1DEFF_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x156058A0)
#define CLASS_5_EA16995B33A1DEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x156057C0)

inline static constexpr unsigned int Class_5_EA16995B33A1DEFF_TypeDefinitionIndex = 73414;

class Class_5_EA16995B33A1DEFF : public ::Class_4_B0C50D0F8BAB7BA3
{
public:
	::UnityEngine::Vector3 ICABBADGANM; // 0x60
