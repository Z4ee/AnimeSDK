...
inline static constexpr unsigned int Struct_2_332332163EA0DDE7_TypeDefinitionIndex = 46173;

struct alignas(8) Struct_2_332332163EA0DDE7
{
	::System::String* Field_2_1; // 0x10
	::MoleMole::Cameras::SideScrollingCameraRuntimeParam* Field_2_0; // 0x18
	::System::String* Field_2_7; // 0x20
	::MoleMole::Cameras::OverrideConfigSideScrollingCamera* Field_2_6; // 0x28
};
