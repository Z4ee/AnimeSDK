...
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_4CBC45500E752367_OFFSET UNITYSDK_OFFSET(0x10B43DC0)
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_68592A05AD6EBA8C_OFFSET UNITYSDK_OFFSET(0x10B437F0)
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_75E6FE343010D16A_OFFSET UNITYSDK_OFFSET(0x10B43B70)
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_7F9EF124841C01AC_OFFSET UNITYSDK_OFFSET(0x10B432B0)
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_9A406B5B2D9F3AA9_OFFSET UNITYSDK_OFFSET(0x10B43070)
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_C49F91F3E8AB7F17_OFFSET UNITYSDK_OFFSET(0x10B43440)
#define CLASS_4_1A39C6C15EFBB423_METHOD_4_EE348374C0008F3B_OFFSET UNITYSDK_OFFSET(0x10B43960)
#define CLASS_4_1A39C6C15EFBB423__CTOR_OFFSET UNITYSDK_OFFSET(0x10B431D0)

inline static constexpr unsigned int Class_4_1A39C6C15EFBB423_TypeDefinitionIndex = 69079;

class Class_4_1A39C6C15EFBB423 : public ::Class_3_B3B7AD2B34783116
{
public:
	::Class_1_37BCC354BD0C729A* Field_4_0; // 0x10
	...
	::System::Void Method_4_C49F91F3E8AB7F17(::MoleMole::HollowChessboard::HollowChessboardUID a1, ::MoleMole::HollowChessboard::HollowEntity* a2, ::Class_4_8637C178AE75321B* a3)
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::HollowChessboard::HollowChessboardUID, ::MoleMole::HollowChessboard::HollowEntity*, ::Class_4_8637C178AE75321B*))((::PBYTE)hIl2Cpp + CLASS_4_1A39C6C15EFBB423_METHOD_4_C49F91F3E8AB7F17_OFFSET))(this, a1, a2, a3);
	}
