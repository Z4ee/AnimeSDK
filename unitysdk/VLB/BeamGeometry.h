...
#define VLB_BEAMGEOMETRY_GET_CONEMESH_OFFSET UNITYSDK_OFFSET(0xD0F25C0)
#define VLB_BEAMGEOMETRY_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0xD0F25A0)
#define VLB_BEAMGEOMETRY_GET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0xD0F2580)
#define VLB_BEAMGEOMETRY_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0xD0F2620)
#define VLB_BEAMGEOMETRY_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0xD0F2670)
#define VLB_BEAMGEOMETRY_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xD0F25E0)
#define VLB_BEAMGEOMETRY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD0F2D10)
#define VLB_BEAMGEOMETRY_METHOD_5_0839ABB041C2D671_OFFSET UNITYSDK_OFFSET(0xD0F5660)
#define VLB_BEAMGEOMETRY_METHOD_5_318C71A4BA509D02_OFFSET UNITYSDK_OFFSET(0xD0F4FA0)
#define VLB_BEAMGEOMETRY_METHOD_5_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xD0F5250)
#define VLB_BEAMGEOMETRY_METHOD_5_3F6DD32D583A9FCF_OFFSET UNITYSDK_OFFSET(0xD0F4E40)
#define VLB_BEAMGEOMETRY_METHOD_5_4912599A9CBB011C_OFFSET UNITYSDK_OFFSET(0xD0F5180)
#define VLB_BEAMGEOMETRY_METHOD_5_7BCD4E2F1093FC06_OFFSET UNITYSDK_OFFSET(0xD0F5650)
#define VLB_BEAMGEOMETRY_METHOD_5_7C1FB31481CF83B2_OFFSET UNITYSDK_OFFSET(0xD0F5040)
#define VLB_BEAMGEOMETRY_METHOD_5_8BA81D51FB5D5B30_OFFSET UNITYSDK_OFFSET(0xD0F30A0)
#define VLB_BEAMGEOMETRY_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD0F4D40)
#define VLB_BEAMGEOMETRY_METHOD_5_CCED8C9A4E131333_OFFSET UNITYSDK_OFFSET(0xD0F27D0)
#define VLB_BEAMGEOMETRY_METHOD_5_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0xD0F4F10)
#define VLB_BEAMGEOMETRY_METHOD_5_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0xD0F2730)
#define VLB_BEAMGEOMETRY_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD0F4EE0)
#define VLB_BEAMGEOMETRY_METHOD_5_F760BA633AF61E98_OFFSET UNITYSDK_OFFSET(0xD0F50E0)
#define VLB_BEAMGEOMETRY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD0F2700)
#define VLB_BEAMGEOMETRY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD0F2B40)
#define VLB_BEAMGEOMETRY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD0F2970)
#define VLB_BEAMGEOMETRY_ONWILLRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0xD0F5CE0)
#define VLB_BEAMGEOMETRY_REGENERATEMESH_OFFSET UNITYSDK_OFFSET(0xD0F3350)
#define VLB_BEAMGEOMETRY_SETCLIPPINGPLANEOFF_OFFSET UNITYSDK_OFFSET(0xD0F5610)
#define VLB_BEAMGEOMETRY_SETCLIPPINGPLANE_OFFSET UNITYSDK_OFFSET(0xD0F55C0)
#define VLB_BEAMGEOMETRY_SET_CONEMESH_OFFSET UNITYSDK_OFFSET(0xD0F25D0)
#define VLB_BEAMGEOMETRY_SET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0xD0F25B0)
#define VLB_BEAMGEOMETRY_SET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0xD0F2590)
#define VLB_BEAMGEOMETRY_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0xD0F2640)
#define VLB_BEAMGEOMETRY_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0xD0F2690)
#define VLB_BEAMGEOMETRY_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xD0F2600)
#define VLB_BEAMGEOMETRY_START_OFFSET UNITYSDK_OFFSET(0xD0F26C0)
#define VLB_BEAMGEOMETRY_SYNCMATERIAL_OFFSET UNITYSDK_OFFSET(0xD0F4F60)
#define VLB_BEAMGEOMETRY_UPDATEMATERIALANDBOUNDS_OFFSET UNITYSDK_OFFSET(0xD0F3610)
#define VLB_BEAMGEOMETRY_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xD0F5310)
#define VLB_BEAMGEOMETRY__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F5FF0)
