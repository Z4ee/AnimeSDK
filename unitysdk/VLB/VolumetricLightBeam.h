...
#define VLB_VOLUMETRICLIGHTBEAM_ASSIGNPROPERTIESFROMSPOTLIGHT_OFFSET UNITYSDK_OFFSET(0x1053AE70)
#define VLB_VOLUMETRICLIGHTBEAM_CLAMPPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1053AF30)
#define VLB_VOLUMETRICLIGHTBEAM_DESTROYBEAM_OFFSET UNITYSDK_OFFSET(0x1053ADC0)
#define VLB_VOLUMETRICLIGHTBEAM_DOPLAYTIMEUPDATE_OFFSET UNITYSDK_OFFSET(0x1053AA20)
#define VLB_VOLUMETRICLIGHTBEAM_GENERATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x10539C70)
#define VLB_VOLUMETRICLIGHTBEAM_GENERATE_OFFSET UNITYSDK_OFFSET(0x10539BF0)
#define VLB_VOLUMETRICLIGHTBEAM_GETINSIDEBEAMFACTORFROMOBJECTSPACEPOS_OFFSET UNITYSDK_OFFSET(0x105388E0)
#define VLB_VOLUMETRICLIGHTBEAM_GETINSIDEBEAMFACTOR_OFFSET UNITYSDK_OFFSET(0x10539B70)
#define VLB_VOLUMETRICLIGHTBEAM_GET_ATTENUATIONLERPLINEARQUAD_OFFSET UNITYSDK_OFFSET(0x105380D0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_BLENDINGMODEASINT_OFFSET UNITYSDK_OFFSET(0x10539610)
#define VLB_VOLUMETRICLIGHTBEAM_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x10539310)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONEANGLE_OFFSET UNITYSDK_OFFSET(0x10537FE0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONEAPEXOFFSETZ_OFFSET UNITYSDK_OFFSET(0x10538040)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONERADIUSEND_OFFSET UNITYSDK_OFFSET(0x10537940)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONEVOLUME_OFFSET UNITYSDK_OFFSET(0x10538FA0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_GEOMSEGMENTS_OFFSET UNITYSDK_OFFSET(0x10539070)
#define VLB_VOLUMETRICLIGHTBEAM_GET_GEOMSIDES_OFFSET UNITYSDK_OFFSET(0x10539020)
#define VLB_VOLUMETRICLIGHTBEAM_GET_HASGEOMETRY_OFFSET UNITYSDK_OFFSET(0x105392F0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_ISCURRENTLYTRACKINGCHANGES_OFFSET UNITYSDK_OFFSET(0x105392E0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_LIGHTSPOTATTACHED_OFFSET UNITYSDK_OFFSET(0x10539AB0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_MESHSTATS_OFFSET UNITYSDK_OFFSET(0x10539890)
#define VLB_VOLUMETRICLIGHTBEAM_GET_MESHTRIANGLESCOUNT_OFFSET UNITYSDK_OFFSET(0x10539A50)
#define VLB_VOLUMETRICLIGHTBEAM_GET_MESHVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0x10539A20)
#define VLB_VOLUMETRICLIGHTBEAM_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x105390C0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x10539110)
#define VLB_VOLUMETRICLIGHTBEAM_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x10539180)
#define VLB_VOLUMETRICLIGHTBEAM_GET_TRACKCHANGESDURINGPLAYTIME_OFFSET UNITYSDK_OFFSET(0x105391D0)
#define VLB_VOLUMETRICLIGHTBEAM_GET__INTERNAL_INSTANCEDMATERIALGROUPID_OFFSET UNITYSDK_OFFSET(0x10539760)
#define VLB_VOLUMETRICLIGHTBEAM_HANDLEBACKWARDCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0x10539E40)
#define VLB_VOLUMETRICLIGHTBEAM_ISCOLLIDERHIDDENBYDYNAMICOCCLUDER_OFFSET UNITYSDK_OFFSET(0x105394B0)
#define VLB_VOLUMETRICLIGHTBEAM_ISNEEDTICK_OFFSET UNITYSDK_OFFSET(0x1053AAD0)
#define VLB_VOLUMETRICLIGHTBEAM_SETCLIPPINGPLANEOFF_OFFSET UNITYSDK_OFFSET(0x10539450)
#define VLB_VOLUMETRICLIGHTBEAM_SETCLIPPINGPLANE_OFFSET UNITYSDK_OFFSET(0x105393E0)
#define VLB_VOLUMETRICLIGHTBEAM_SETTSC_OFFSET UNITYSDK_OFFSET(0x10539780)
#define VLB_VOLUMETRICLIGHTBEAM_SET_GEOMSEGMENTS_OFFSET UNITYSDK_OFFSET(0x105390B0)
#define VLB_VOLUMETRICLIGHTBEAM_SET_GEOMSIDES_OFFSET UNITYSDK_OFFSET(0x10539060)
#define VLB_VOLUMETRICLIGHTBEAM_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x105390D0)
#define VLB_VOLUMETRICLIGHTBEAM_SET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x10539120)
#define VLB_VOLUMETRICLIGHTBEAM_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x10539190)
#define VLB_VOLUMETRICLIGHTBEAM_SET_TRACKCHANGESDURINGPLAYTIME_OFFSET UNITYSDK_OFFSET(0x105391E0)
#define VLB_VOLUMETRICLIGHTBEAM_SET__INTERNAL_INSTANCEDMATERIALGROUPID_OFFSET UNITYSDK_OFFSET(0x10539770)
#define VLB_VOLUMETRICLIGHTBEAM_STARTPLAYTIMEUPDATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x105391F0)
#define VLB_VOLUMETRICLIGHTBEAM_SYNCMATERIAL_OFFSET UNITYSDK_OFFSET(0x1053AAE0)
#define VLB_VOLUMETRICLIGHTBEAM_UPDATEAFTERMANUALPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x10539F70)
#define VLB_VOLUMETRICLIGHTBEAM_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1053AF10)
#define VLB_VOLUMETRICLIGHTBEAM_VALIDATEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x10539ED0)
#define VLB_VOLUMETRICLIGHTBEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1053B0F0)
#define VLB_VOLUMETRICLIGHTBEAM__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1053ADB0)
#define VLB_VOLUMETRICLIGHTBEAM__ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1053AC70)
#define VLB_VOLUMETRICLIGHTBEAM__ONENABLE_OFFSET UNITYSDK_OFFSET(0x1053AB30)
#define VLB_VOLUMETRICLIGHTBEAM__START_OFFSET UNITYSDK_OFFSET(0x1053A030)
#define VLB_VOLUMETRICLIGHTBEAM__UPDATE_OFFSET UNITYSDK_OFFSET(0x1053A520)

namespace VLB
{
	inline static constexpr unsigned int VolumetricLightBeam_TypeDefinitionIndex = 47177;
