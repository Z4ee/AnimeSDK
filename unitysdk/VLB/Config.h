...
#define VLB_CONFIG_GET_ACTUALRENDERINGMODE_OFFSET UNITYSDK_OFFSET(0xD0F3090)
#define VLB_CONFIG_GET_BEAMSHADER_OFFSET UNITYSDK_OFFSET(0xD0F6080)
#define VLB_CONFIG_GET_GLOBALNOISEPARAM_OFFSET UNITYSDK_OFFSET(0xD0F6090)
#define VLB_CONFIG_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD0F3080)
#define VLB_CONFIG_GET_USESINGLEPASSSHADER_OFFSET UNITYSDK_OFFSET(0xD0F3600)
#define VLB_CONFIG_METHOD_3_C302CE84D96D179E_OFFSET UNITYSDK_OFFSET(0xD0F60A0)
#define VLB_CONFIG_METHOD_3_F97007FB78F3F2C9_OFFSET UNITYSDK_OFFSET(0xD0F6290)
#define VLB_CONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD0F6210)
#define VLB_CONFIG_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD0F6300)
#define VLB_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F6310)

namespace VLB
{
	inline static constexpr unsigned int Config_TypeDefinitionIndex = 46180;
	...
	public:
		...
		{
			return (::VLB::Config**)Il2CppClass::FromTypeDefinitionIndex(Config_TypeDefinitionIndex)->GetStaticField(0x136E0);
		}
