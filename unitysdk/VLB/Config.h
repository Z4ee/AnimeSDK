...
#define VLB_CONFIG_GET_ACTUALRENDERINGMODE_OFFSET UNITYSDK_OFFSET(0xAC34610)
#define VLB_CONFIG_GET_BEAMSHADER_OFFSET UNITYSDK_OFFSET(0xAC375C0)
#define VLB_CONFIG_GET_GLOBALNOISEPARAM_OFFSET UNITYSDK_OFFSET(0xAC375D0)
#define VLB_CONFIG_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAC34600)
#define VLB_CONFIG_GET_USESINGLEPASSSHADER_OFFSET UNITYSDK_OFFSET(0xAC34BE0)
#define VLB_CONFIG_METHOD_3_C302CE84D96D179E_OFFSET UNITYSDK_OFFSET(0xAC375E0)
#define VLB_CONFIG_METHOD_3_F97007FB78F3F2C9_OFFSET UNITYSDK_OFFSET(0xAC377D0)
#define VLB_CONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAC37750)
#define VLB_CONFIG_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAC37850)
#define VLB_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAC37860)

namespace VLB
{
	inline static constexpr unsigned int Config_TypeDefinitionIndex = 39688;
	...
	public:
		...
		{
			return (::VLB::Config**)Il2CppClass::FromTypeDefinitionIndex(Config_TypeDefinitionIndex)->GetStaticField(0x5C70);
		}
