...
#define VLB_CONFIG_GET_ACTUALRENDERINGMODE_OFFSET UNITYSDK_OFFSET(0xB9AB3B0)
#define VLB_CONFIG_GET_BEAMSHADER_OFFSET UNITYSDK_OFFSET(0xB9AE490)
#define VLB_CONFIG_GET_GLOBALNOISEPARAM_OFFSET UNITYSDK_OFFSET(0xB9AE4A0)
#define VLB_CONFIG_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB9AB3A0)
#define VLB_CONFIG_GET_USESINGLEPASSSHADER_OFFSET UNITYSDK_OFFSET(0xB9AB980)
#define VLB_CONFIG_METHOD_3_C302CE84D96D179E_OFFSET UNITYSDK_OFFSET(0xB9AE4B0)
#define VLB_CONFIG_METHOD_3_F97007FB78F3F2C9_OFFSET UNITYSDK_OFFSET(0xB9AE6A0)
#define VLB_CONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB9AE620)
#define VLB_CONFIG_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB9AE720)
#define VLB_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AE730)

namespace VLB
{
	inline static constexpr unsigned int Config_TypeDefinitionIndex = 45597;
	...
	public:
		...
		{
			return (::VLB::Config**)Il2CppClass::FromTypeDefinitionIndex(Config_TypeDefinitionIndex)->GetStaticField(0x6C90);
		}
