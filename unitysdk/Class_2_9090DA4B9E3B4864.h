...
#define CLASS_2_9090DA4B9E3B4864_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17DF48D0)
#define CLASS_2_9090DA4B9E3B4864_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17DF4910)
#define CLASS_2_9090DA4B9E3B4864_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17DF4970)
#define CLASS_2_9090DA4B9E3B4864_TICK_OFFSET UNITYSDK_OFFSET(0x17DF49C0)
#define CLASS_2_9090DA4B9E3B4864__CTOR_OFFSET UNITYSDK_OFFSET(0x17DF48C0)

inline static constexpr unsigned int Class_2_9090DA4B9E3B4864_TypeDefinitionIndex = 56603;

class Class_2_9090DA4B9E3B4864 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::SetShenJunActionBar* OFKGLJOAMLD; // 0x20
