...
#define CLASS_2_9090DA4B9E3B4864_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEDA8BE0)
#define CLASS_2_9090DA4B9E3B4864_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xEDA8C20)
#define CLASS_2_9090DA4B9E3B4864_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xEDA8C80)
#define CLASS_2_9090DA4B9E3B4864_TICK_OFFSET UNITYSDK_OFFSET(0xEDA8CD0)
#define CLASS_2_9090DA4B9E3B4864__CTOR_OFFSET UNITYSDK_OFFSET(0xEDA8BD0)
...
{
public:
	::RPG::GameCore::SetShenJunActionBar* OFKGLJOAMLD; // 0x18
