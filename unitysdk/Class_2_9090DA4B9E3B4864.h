...
#define CLASS_2_9090DA4B9E3B4864_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8860FF0)
#define CLASS_2_9090DA4B9E3B4864_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8861030)
#define CLASS_2_9090DA4B9E3B4864_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8861090)
#define CLASS_2_9090DA4B9E3B4864_TICK_OFFSET UNITYSDK_OFFSET(0x88610E0)
#define CLASS_2_9090DA4B9E3B4864__CTOR_OFFSET UNITYSDK_OFFSET(0x8860FE0)

inline static constexpr unsigned int Class_2_9090DA4B9E3B4864_TypeDefinitionIndex = 45356;

class Class_2_9090DA4B9E3B4864 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetShenJunActionBar* Field_2_0; // 0x20
