...
#define NPCEMOTIONCLIPCONFIG_GETCLIPASSET_OFFSET UNITYSDK_OFFSET(0x102C9090)
#define NPCEMOTIONCLIPCONFIG_GET_FACIALMASK_OFFSET UNITYSDK_OFFSET(0x102C8EE0)
#define NPCEMOTIONCLIPCONFIG_UNLOADASSETS_OFFSET UNITYSDK_OFFSET(0x102C9210)
#define NPCEMOTIONCLIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x102C94A0)

inline static constexpr unsigned int NPCEmotionClipConfig_TypeDefinitionIndex = 52327;
