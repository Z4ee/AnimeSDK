...
#define CLASS_2_346879A217A503EE_METHOD_2_1086E351241EDD3B_1_OFFSET UNITYSDK_OFFSET(0x169AC9A0)
#define CLASS_2_346879A217A503EE_METHOD_2_1086E351241EDD3B_OFFSET UNITYSDK_OFFSET(0x169AC930)
#define CLASS_2_346879A217A503EE_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x169ACC20)
#define CLASS_2_346879A217A503EE_METHOD_2_5CC589A90C8895C1_OFFSET UNITYSDK_OFFSET(0x169ACB00)
#define CLASS_2_346879A217A503EE_METHOD_2_67092B198ADCB2A8_OFFSET UNITYSDK_OFFSET(0x169ACA10)
#define CLASS_2_346879A217A503EE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x169ACF40)
#define CLASS_2_346879A217A503EE_METHOD_2_D4499A0147676A9C_OFFSET UNITYSDK_OFFSET(0x169AC890)
#define CLASS_2_346879A217A503EE_METHOD_2_DEDD31AF6F4E4818_OFFSET UNITYSDK_OFFSET(0x169AC180)
#define CLASS_2_346879A217A503EE_METHOD_2_F0F6A8A07770D2DE_OFFSET UNITYSDK_OFFSET(0x169AC760)
#define CLASS_2_346879A217A503EE__ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0x169AC700)
#define CLASS_2_346879A217A503EE__CTOR_OFFSET UNITYSDK_OFFSET(0x169ABC00)
#define CLASS_2_346879A217A503EE__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x169ABD30)
#define CLASS_2_346879A217A503EE__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x169AC270)
#define CLASS_2_346879A217A503EE__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0x169AC230)
#define CLASS_2_346879A217A503EE___SETUPVIEW_B__3_0_OFFSET UNITYSDK_OFFSET(0x169ACF90)
#define CLASS_2_346879A217A503EE___SETUPVIEW_B__3_1_OFFSET UNITYSDK_OFFSET(0x169AD170)

inline static constexpr unsigned int Class_2_346879A217A503EE_TypeDefinitionIndex = 72844;

class Class_2_346879A217A503EE : public ::RPG::Client::UIController
{
public:
	// static const ::System::Int64 APHOECLDJKJ = 0x40000000; // 0x0
	::System::Action_1<::System::Boolean>* MCLELAFIEBJ; // 0x188
	::System::Collections::Generic::HashSet_1<::System::UInt32>* HMLIPMFHDGK; // 0x190
	::System::Int64 LDPEGLBLALO; // 0x198
	::System::Boolean KLCFJOLMICI; // 0x1A0
	::System::Boolean DFIAMJNMEAP; // 0x1A1
	::System::Boolean MNJOPAEEGLD; // 0x1A2
	::System::Int64 ILBLJFLGAJD; // 0x1A8
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_346879A217A503EE_METHOD_2_D4499A0147676A9C_OFFSET))(this);
	}
