...
#define CLASS_2_120628742D11F9B9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x158C70C0)
#define CLASS_2_120628742D11F9B9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x158C71A0)
#define CLASS_2_120628742D11F9B9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x158C7400)
#define CLASS_2_120628742D11F9B9_TICK_OFFSET UNITYSDK_OFFSET(0x158C7450)
#define CLASS_2_120628742D11F9B9__CTOR_OFFSET UNITYSDK_OFFSET(0x158C6FB0)

inline static constexpr unsigned int Class_2_120628742D11F9B9_TypeDefinitionIndex = 55180;

class Class_2_120628742D11F9B9 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::ConditionLoopExecuteTaskList* OFKGLJOAMLD; // 0x20
	::Class_1_5F51D4049EA87B7B* LLHKOFLJFCH; // 0x28
	::Class_3_07C3C4D2990C49EE* NDOFCGDDHHD; // 0x30
