...
#define CLASS_1_59B98C410EFDD281_CLEAR_OFFSET UNITYSDK_OFFSET(0x11EFC550)
#define CLASS_1_59B98C410EFDD281_METHOD_1_1C5751DE38D528FC_OFFSET UNITYSDK_OFFSET(0x11EFC730)
#define CLASS_1_59B98C410EFDD281_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x11EFC640)
#define CLASS_1_59B98C410EFDD281_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x11EFC5F0)
#define CLASS_1_59B98C410EFDD281_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x11EFC5A0)
#define CLASS_1_59B98C410EFDD281_METHOD_1_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x11EFC690)
#define CLASS_1_59B98C410EFDD281_METHOD_1_F470081F1838BD2B_OFFSET UNITYSDK_OFFSET(0x11EFC4E0)
#define CLASS_1_59B98C410EFDD281__CTOR_OFFSET UNITYSDK_OFFSET(0x11EFC4D0)

inline static constexpr unsigned int Class_1_59B98C410EFDD281_TypeDefinitionIndex = 76487;

class Class_1_59B98C410EFDD281 : public ::System::Object
{
public:
	::Class_3_1E4F9B0ED3BF21DE* PDENFEFCAGN; // 0x10
	::UnityEngine::Rigidbody* LLBAAKBKFLC; // 0x18
	::Class_2_B9E8C2EEAA5C96EC* GGKGFABFGFE; // 0x20
	::UnityEngine::Vector3 DEIIMEECCKK; // 0x28
