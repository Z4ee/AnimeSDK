...
#define CLASS_1_3CB66EAA8C4DE7F9_GET_AIINFOS_OFFSET UNITYSDK_OFFSET(0x15246A00)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_BALLID_OFFSET UNITYSDK_OFFSET(0x15246960)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0x15246A10)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_DISTANCETOFINISH_OFFSET UNITYSDK_OFFSET(0x15246A70)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_ELAPSEDMS_OFFSET UNITYSDK_OFFSET(0x15246980)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x15246940)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_LEVELSTTS_OFFSET UNITYSDK_OFFSET(0x152469E0)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_PARKOURRANKS_OFFSET UNITYSDK_OFFSET(0x152469F0)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_RANK_OFFSET UNITYSDK_OFFSET(0x152469A0)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_REASON_OFFSET UNITYSDK_OFFSET(0x152469C0)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_RESTARTCOUNT_OFFSET UNITYSDK_OFFSET(0x15246A30)
#define CLASS_1_3CB66EAA8C4DE7F9_GET_TOTALTIME_OFFSET UNITYSDK_OFFSET(0x15246A50)
#define CLASS_1_3CB66EAA8C4DE7F9_METHOD_1_0621C6FE5BBF3A21_OFFSET UNITYSDK_OFFSET(0x15246B80)
#define CLASS_1_3CB66EAA8C4DE7F9_METHOD_1_BE18C04CD91E0748_OFFSET UNITYSDK_OFFSET(0x15246F00)
#define CLASS_1_3CB66EAA8C4DE7F9_METHOD_1_D0F318F102254C6B_OFFSET UNITYSDK_OFFSET(0x15246DE0)
#define CLASS_1_3CB66EAA8C4DE7F9_METHOD_1_FC1FC8435418E416_OFFSET UNITYSDK_OFFSET(0x15246CA0)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_BALLID_OFFSET UNITYSDK_OFFSET(0x15246970)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_DETAIL_OFFSET UNITYSDK_OFFSET(0x15246A20)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_DISTANCETOFINISH_OFFSET UNITYSDK_OFFSET(0x15246A80)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_ELAPSEDMS_OFFSET UNITYSDK_OFFSET(0x15246990)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x15246950)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_RANK_OFFSET UNITYSDK_OFFSET(0x152469B0)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_REASON_OFFSET UNITYSDK_OFFSET(0x152469D0)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_RESTARTCOUNT_OFFSET UNITYSDK_OFFSET(0x15246A40)
#define CLASS_1_3CB66EAA8C4DE7F9_SET_TOTALTIME_OFFSET UNITYSDK_OFFSET(0x15246A60)
#define CLASS_1_3CB66EAA8C4DE7F9__CTOR_OFFSET UNITYSDK_OFFSET(0x15246A90)

inline static constexpr unsigned int Class_1_3CB66EAA8C4DE7F9_TypeDefinitionIndex = 59104;

class Class_1_3CB66EAA8C4DE7F9 : public ::System::Object
{
public:
	::Class_1_F3CA30716D4FAF92_15* _Detail_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_764*>* _AiInfos_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::Class_1_1CBA230307F9C289_67*>* _LevelStts_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::RPG::Client::ParkourRank*>* _ParkourRanks_k__BackingField; // 0x28
	::System::UInt32 _RestartCount_k__BackingField; // 0x30
	::System::UInt32 _TotalTime_k__BackingField; // 0x34
	::System::UInt32 _LevelID_k__BackingField; // 0x38
	::Enum_3_0A3761FE34514D6C_51 _Reason_k__BackingField; // 0x3C
	...
	::System::Collections::Generic::List_1<::Class_1_1CBA230307F9C289_67*>* get_LevelStts()
	{
		return ((::System::Collections::Generic::List_1<::Class_1_1CBA230307F9C289_67*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_3CB66EAA8C4DE7F9_GET_LEVELSTTS_OFFSET))(this);
	}
	...
	::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_764*>* get_AiInfos()
	{
		return ((::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_764*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_3CB66EAA8C4DE7F9_GET_AIINFOS_OFFSET))(this);
	}
