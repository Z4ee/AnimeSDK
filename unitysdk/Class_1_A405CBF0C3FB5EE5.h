...
#define CLASS_1_A405CBF0C3FB5EE5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C7B4900)
#define CLASS_1_A405CBF0C3FB5EE5_CLONE_OFFSET UNITYSDK_OFFSET(0x1C7B42D0)
#define CLASS_1_A405CBF0C3FB5EE5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C7B4470)
#define CLASS_1_A405CBF0C3FB5EE5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C7B4350)
#define CLASS_1_A405CBF0C3FB5EE5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C7B4620)
#define CLASS_1_A405CBF0C3FB5EE5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7B4AD0)
#define CLASS_1_A405CBF0C3FB5EE5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C7B4A20)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C7B4310)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C7B4300)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C7B4180)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1C7B4340)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1C7B4330)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C7B4320)
#define CLASS_1_A405CBF0C3FB5EE5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7B41B0)
#define CLASS_1_A405CBF0C3FB5EE5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C7B4770)
#define CLASS_1_A405CBF0C3FB5EE5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C7B47D0)
#define CLASS_1_A405CBF0C3FB5EE5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C7B4BF0)
#define CLASS_1_A405CBF0C3FB5EE5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7B4210)
#define CLASS_1_A405CBF0C3FB5EE5__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7B41C0)

inline static constexpr unsigned int Class_1_A405CBF0C3FB5EE5_TypeDefinitionIndex = 25453;

class Class_1_A405CBF0C3FB5EE5 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_A405CBF0C3FB5EE5*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A405CBF0C3FB5EE5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A405CBF0C3FB5EE5_TypeDefinitionIndex)->GetStaticField(0x63840);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A405CBF0C3FB5EE5_TypeDefinitionIndex)->GetStaticField(0x63848);
	}
