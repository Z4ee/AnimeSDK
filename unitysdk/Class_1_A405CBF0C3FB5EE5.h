...
#define CLASS_1_A405CBF0C3FB5EE5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E33CA70)
#define CLASS_1_A405CBF0C3FB5EE5_CLONE_OFFSET UNITYSDK_OFFSET(0x1E33C420)
#define CLASS_1_A405CBF0C3FB5EE5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E33C5C0)
#define CLASS_1_A405CBF0C3FB5EE5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E33C4A0)
#define CLASS_1_A405CBF0C3FB5EE5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E33C770)
#define CLASS_1_A405CBF0C3FB5EE5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E33CC40)
#define CLASS_1_A405CBF0C3FB5EE5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E33CB90)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E33C450)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1E33C490)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E33C2C0)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1E33C480)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1E33C470)
#define CLASS_1_A405CBF0C3FB5EE5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E33C460)
#define CLASS_1_A405CBF0C3FB5EE5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E33C2F0)
#define CLASS_1_A405CBF0C3FB5EE5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E33C8E0)
#define CLASS_1_A405CBF0C3FB5EE5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E33C940)
#define CLASS_1_A405CBF0C3FB5EE5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E33CD60)
#define CLASS_1_A405CBF0C3FB5EE5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E33C350)
#define CLASS_1_A405CBF0C3FB5EE5__CTOR_OFFSET UNITYSDK_OFFSET(0x1E33C300)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A405CBF0C3FB5EE5_TypeDefinitionIndex)->GetStaticField(0x52910);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_A405CBF0C3FB5EE5*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A405CBF0C3FB5EE5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A405CBF0C3FB5EE5_TypeDefinitionIndex)->GetStaticField(0x52918);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* EDKFHJOFFPM; // 0x20
