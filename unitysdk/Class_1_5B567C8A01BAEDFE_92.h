...
#define CLASS_1_5B567C8A01BAEDFE_92_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D808370)
#define CLASS_1_5B567C8A01BAEDFE_92_CLONE_OFFSET UNITYSDK_OFFSET(0x1E526EE0)
#define CLASS_1_5B567C8A01BAEDFE_92_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E526FF0)
#define CLASS_1_5B567C8A01BAEDFE_92_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E526F20)
#define CLASS_1_5B567C8A01BAEDFE_92_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E527150)
#define CLASS_1_5B567C8A01BAEDFE_92_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D8083C0)
#define CLASS_1_5B567C8A01BAEDFE_92_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D808390)
#define CLASS_1_5B567C8A01BAEDFE_92_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E526E60)
#define CLASS_1_5B567C8A01BAEDFE_92_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E526E90)
#define CLASS_1_5B567C8A01BAEDFE_92_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E527180)
#define CLASS_1_5B567C8A01BAEDFE_92_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D808360)
#define CLASS_1_5B567C8A01BAEDFE_92__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D808410)
#define CLASS_1_5B567C8A01BAEDFE_92__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E526EB0)
#define CLASS_1_5B567C8A01BAEDFE_92__CTOR_OFFSET UNITYSDK_OFFSET(0x1E526EA0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_92_TypeDefinitionIndex = 27344;

class Class_1_5B567C8A01BAEDFE_92 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_92*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_92*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_92_TypeDefinitionIndex)->GetStaticField(0x28720);
	}
