...
#define CLASS_2_6C642AC912FD8C0A_ONADD_OFFSET UNITYSDK_OFFSET(0x16353400)
#define CLASS_2_6C642AC912FD8C0A_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x16353970)
#define CLASS_2_6C642AC912FD8C0A_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x16353460)
#define CLASS_2_6C642AC912FD8C0A__CTOR_OFFSET UNITYSDK_OFFSET(0x163539C0)

inline static constexpr unsigned int Class_2_6C642AC912FD8C0A_TypeDefinitionIndex = 75157;
