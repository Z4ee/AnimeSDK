...
#define CLASS_2_6C642AC912FD8C0A_ONADD_OFFSET UNITYSDK_OFFSET(0x172A94E0)
#define CLASS_2_6C642AC912FD8C0A_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x172A9A50)
#define CLASS_2_6C642AC912FD8C0A_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x172A9540)
#define CLASS_2_6C642AC912FD8C0A__CTOR_OFFSET UNITYSDK_OFFSET(0x172A9AA0)

inline static constexpr unsigned int Class_2_6C642AC912FD8C0A_TypeDefinitionIndex = 78654;
