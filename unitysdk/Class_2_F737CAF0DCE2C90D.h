...
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x14B80040)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_25A6D6D1C622BFDB_OFFSET UNITYSDK_OFFSET(0x14B7F400)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x14B7FC30)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x14B7FFA0)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_A678846DF98684D3_OFFSET UNITYSDK_OFFSET(0x14B7F010)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_FE1A1A30B3CE9C46_OFFSET UNITYSDK_OFFSET(0x14B7FEB0)
#define CLASS_2_F737CAF0DCE2C90D__CTOR_OFFSET UNITYSDK_OFFSET(0x14B7EF60)

inline static constexpr unsigned int Class_2_F737CAF0DCE2C90D_TypeDefinitionIndex = 52258;

class Class_2_F737CAF0DCE2C90D : public ::Class_1_1835888C1E19F013
{
public:
	::RPG::GameCore::BezierProjectileData* Field_2_0; // 0x48
	::System::Collections::Generic::List_1<::UnityEngine::Vector3>* Field_2_1; // 0x50
