...
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x10648680)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x106484B0)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_25A6D6D1C622BFDB_OFFSET UNITYSDK_OFFSET(0x10647870)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10648620)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x106480A0)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_7DFB4B9C80198D98_OFFSET UNITYSDK_OFFSET(0x106485F0)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x10648410)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_A678846DF98684D3_OFFSET UNITYSDK_OFFSET(0x10647480)
#define CLASS_2_F737CAF0DCE2C90D_METHOD_2_FE1A1A30B3CE9C46_OFFSET UNITYSDK_OFFSET(0x10648320)
#define CLASS_2_F737CAF0DCE2C90D__CTOR_OFFSET UNITYSDK_OFFSET(0x106473D0)

inline static constexpr unsigned int Class_2_F737CAF0DCE2C90D_TypeDefinitionIndex = 51167;

class Class_2_F737CAF0DCE2C90D : public ::Class_1_1835888C1E19F013
{
public:
	::System::Collections::Generic::List_1<::UnityEngine::Vector3>* Field_2_0; // 0x48
	::RPG::GameCore::BezierProjectileData* Field_2_1; // 0x50
