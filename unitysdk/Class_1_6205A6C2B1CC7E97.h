...
#define CLASS_1_6205A6C2B1CC7E97_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x13794740)
#define CLASS_1_6205A6C2B1CC7E97_FROMFLX_OFFSET UNITYSDK_OFFSET(0x13794AC0)
#define CLASS_1_6205A6C2B1CC7E97_METHOD_1_00531776927FE5B6_OFFSET UNITYSDK_OFFSET(0x13794B40)
#define CLASS_1_6205A6C2B1CC7E97_METHOD_1_1DFF921950D5D3D5_OFFSET UNITYSDK_OFFSET(0x137947A0)
#define CLASS_1_6205A6C2B1CC7E97__CTOR_OFFSET UNITYSDK_OFFSET(0x13795150)

inline static constexpr unsigned int Class_1_6205A6C2B1CC7E97_TypeDefinitionIndex = 46658;

class Class_1_6205A6C2B1CC7E97 : public ::System::Object
{
public:
	::Class_1_077219EE5F3510E3* Field_1_6; // 0x10
	::System::Collections::Generic::List_1<::Class_1_BD2E5F64784FE078*>* Field_1_0; // 0x18
	::System::Collections::Generic::List_1<::Class_1_BD2E5F64784FE078*>* Field_1_7; // 0x20
	::MoleMole::Config::AidAttackType Field_1_5; // 0x28
