...
#define CLASS_2_AFBB6BD2FF5DAA7F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x164097D0)
#define CLASS_2_AFBB6BD2FF5DAA7F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16409810)
#define CLASS_2_AFBB6BD2FF5DAA7F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x164098E0)
#define CLASS_2_AFBB6BD2FF5DAA7F_TICK_OFFSET UNITYSDK_OFFSET(0x16409930)
#define CLASS_2_AFBB6BD2FF5DAA7F__CTOR_OFFSET UNITYSDK_OFFSET(0x164097C0)

inline static constexpr unsigned int Class_2_AFBB6BD2FF5DAA7F_TypeDefinitionIndex = 58843;

class Class_2_AFBB6BD2FF5DAA7F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowSwipeGuide* OFKGLJOAMLD; // 0x18
