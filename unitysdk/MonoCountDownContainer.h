...
#define MONOCOUNTDOWNCONTAINER_AWAKE_OFFSET UNITYSDK_OFFSET(0x112EC640)
#define MONOCOUNTDOWNCONTAINER_CLOSETIMER_OFFSET UNITYSDK_OFFSET(0x112ECD00)
#define MONOCOUNTDOWNCONTAINER_FORMATTIME_OFFSET UNITYSDK_OFFSET(0x112EC980)
#define MONOCOUNTDOWNCONTAINER_OPENTIMER_OFFSET UNITYSDK_OFFSET(0x112ECB40)
#define MONOCOUNTDOWNCONTAINER_PAUSE_OFFSET UNITYSDK_OFFSET(0x112ECDB0)
#define MONOCOUNTDOWNCONTAINER_TICKTIMER_OFFSET UNITYSDK_OFFSET(0x112EC6F0)
#define MONOCOUNTDOWNCONTAINER_UPDATE_OFFSET UNITYSDK_OFFSET(0x112EC690)
#define MONOCOUNTDOWNCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x112ECE00)

inline static constexpr unsigned int MonoCountDownContainer_TypeDefinitionIndex = 81020;
