...
#define MONOCOUNTDOWNCONTAINER_AWAKE_OFFSET UNITYSDK_OFFSET(0x108A7180)
#define MONOCOUNTDOWNCONTAINER_CLOSETIMER_OFFSET UNITYSDK_OFFSET(0x108A7840)
#define MONOCOUNTDOWNCONTAINER_FORMATTIME_OFFSET UNITYSDK_OFFSET(0x108A74C0)
#define MONOCOUNTDOWNCONTAINER_OPENTIMER_OFFSET UNITYSDK_OFFSET(0x108A7680)
#define MONOCOUNTDOWNCONTAINER_PAUSE_OFFSET UNITYSDK_OFFSET(0x108A78F0)
#define MONOCOUNTDOWNCONTAINER_TICKTIMER_OFFSET UNITYSDK_OFFSET(0x108A7230)
#define MONOCOUNTDOWNCONTAINER_UPDATE_OFFSET UNITYSDK_OFFSET(0x108A71D0)
#define MONOCOUNTDOWNCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x108A7940)

inline static constexpr unsigned int MonoCountDownContainer_TypeDefinitionIndex = 64145;
