...
#define CLASS_1_B4A74ED2BE491B9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE2E0EC0)
#define CLASS_1_B4A74ED2BE491B9A_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xE2E02B0)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0xE2E1640)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xE2E25A0)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_2505E255AC8ECF2D_OFFSET UNITYSDK_OFFSET(0xE2E2160)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_3701C92AC1E55974_OFFSET UNITYSDK_OFFSET(0xE2E2470)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_8A3E5DFD7F12342E_OFFSET UNITYSDK_OFFSET(0xE2E23C0)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_97AC5E0734B0603A_OFFSET UNITYSDK_OFFSET(0xE2E16F0)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0xE2E2890)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_C9BE5751944732FF_OFFSET UNITYSDK_OFFSET(0xE2E26D0)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE2E09D0)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_E2412894BC3CB7C9_OFFSET UNITYSDK_OFFSET(0xE2E1010)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xE2E0710)
#define CLASS_1_B4A74ED2BE491B9A_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xE2E0850)
#define CLASS_1_B4A74ED2BE491B9A_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xE2E02C0)
#define CLASS_1_B4A74ED2BE491B9A__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE2E0A20)
#define CLASS_1_B4A74ED2BE491B9A__CTOR_OFFSET UNITYSDK_OFFSET(0xE2E02D0)
...
public:
	...
	{
		return (::Class_1_B4A74ED2BE491B9A**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B4A74ED2BE491B9A_TypeDefinitionIndex)->GetStaticField(0x65C80);
	}
	::RPG::GameCore::GameEntity* KDAJNFLENID; // 0x10
	::RPG::GameCore::GameEntity* OGLMLEFKHKN; // 0x18
	::Class_1_73FF716382F12A48* BEFPLOOEKCO; // 0x20
	::Class_1_538C7B5C2BA54916* LGLECMDANCO; // 0x28
	::Class_1_2FF2F7FAA870CDF1* GNIKBIOOJGH; // 0x30
	::System::Collections::Generic::Queue_1<::Class_1_B4A74ED2BE491B9A_Struct_2_0A1006A3711077C2>* OKNIOMJENPK; // 0x38
	::RPG::GameCore::GameEntity* NNPJKEFNOMG; // 0x40
	::RPG::Client::MonoEffectManager* KMLMEHCDDMA; // 0x48
	::Class_1_73FF716382F12A48* GMNFMEGKFCK; // 0x50
	::Class_1_8676A5D6BF139078* NNFBICAOPPE; // 0x58
	::RPG::Client::MonoInflatableFighter* KGPGMDIPFJN; // 0x60
	::RPG::Client::MonoInflatableFighter* BFGIAGJLMJF; // 0x68
	::Class_1_8676A5D6BF139078* DAELNGNNOBK; // 0x70
	::RPG::Client::InflatableFighterPuzzleBoard* CCAHGFIABKE; // 0x78
	::RPG::GameCore::GameEntity* IFIADNDCPHH; // 0x80
	::System::Boolean NJPHNILEEFH; // 0x88
	::System::Boolean AGELLGAPADG; // 0x89
	::System::Single COCJDAKNIAP; // 0x8C
	::System::Int32 OPKPFOJKAIK; // 0x90
	::System::Int32 HEIKIDKDCJK; // 0x94
	::RPG::GameCore::StringHash BBAFILGFPJK; // 0x98
	::System::Boolean PCHMPNFGDKF; // 0x9C
	::System::Boolean FPEONIGKCJP; // 0x9D
	::System::Boolean AOBOGIFBNEJ; // 0x9E
