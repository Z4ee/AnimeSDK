...
#define CLASS_1_25BE2AF5F074F391_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16FBCA70)
#define CLASS_1_25BE2AF5F074F391_ENTER_OFFSET UNITYSDK_OFFSET(0x16FBCAC0)
#define CLASS_1_25BE2AF5F074F391_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x16FBD130)
#define CLASS_1_25BE2AF5F074F391_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16FBD040)
#define CLASS_1_25BE2AF5F074F391_LEAVE_OFFSET UNITYSDK_OFFSET(0x16FBD0A0)
#define CLASS_1_25BE2AF5F074F391_METHOD_1_0608E01D4DD006F1_OFFSET UNITYSDK_OFFSET(0x16FBD290)
#define CLASS_1_25BE2AF5F074F391_METHOD_1_5E9FCCDB6178A9A4_OFFSET UNITYSDK_OFFSET(0x16FBCCC0)
#define CLASS_1_25BE2AF5F074F391_METHOD_1_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x16FBD180)
#define CLASS_1_25BE2AF5F074F391_TICK_OFFSET UNITYSDK_OFFSET(0x16FBCFE0)
#define CLASS_1_25BE2AF5F074F391__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBCA60)
#define CLASS_1_25BE2AF5F074F391__ENTER_B__2_0_OFFSET UNITYSDK_OFFSET(0x16FBD320)
...
public:
	...
	{
		return (::Class_1_DD365D3DF2F2F979**)Il2CppClass::FromTypeDefinitionIndex(Class_1_25BE2AF5F074F391_TypeDefinitionIndex)->GetStaticField(0x65430);
	}
	::System::String* AHFIKOKEIFC; // 0x10
	::System::String* AGDCPDBNPNP; // 0x18
	::Class_1_DD365D3DF2F2F979* MOFHGHGKAFP; // 0x20
	::RPG::Client::EnvironmentSystem* NLKKPKJEAOO; // 0x28
	::RPG::GameCore::BattleLineupData* LMAGEICFOMF; // 0x30
	::Class_1_118030333D39EAFB* GLBKFKJJPGO; // 0x38
	::System::UInt32 DGNCONDBJGE; // 0x40
	::System::Boolean KGIAHODIGOE; // 0x44
	::System::UInt32 DLHOKIMOHFG; // 0x48
	::System::UInt32 GAPNANDKMHM; // 0x4C
