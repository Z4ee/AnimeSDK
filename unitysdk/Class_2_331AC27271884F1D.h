...
#define CLASS_2_331AC27271884F1D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1679AC90)
#define CLASS_2_331AC27271884F1D_METHOD_2_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0x1679AF90)
#define CLASS_2_331AC27271884F1D_METHOD_2_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x1679B300)
#define CLASS_2_331AC27271884F1D_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1679B360)
#define CLASS_2_331AC27271884F1D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1679ACF0)
#define CLASS_2_331AC27271884F1D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1679B0F0)
#define CLASS_2_331AC27271884F1D_TICK_OFFSET UNITYSDK_OFFSET(0x1679B240)
#define CLASS_2_331AC27271884F1D__CTOR_OFFSET UNITYSDK_OFFSET(0x1679A630)
...
{
public:
	::RPG::GameCore::AdventureCharacterController* EEMOFHKBEBO; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_2_A0580152EB393340* CHKJEKFMODH; // 0x28
	::Class_2_469A56953483CA0D* DOGOBMEFBAG; // 0x30
	::Class_2_3F4D673D3F90D12C* FAOEOJJKLLB; // 0x38
	::RPG::GameCore::AdvNPCGoback* IGHAHBNLIJA; // 0x40
	::Class_1_F3391C70DC37088D* KLPHHEJAPDF; // 0x48
	::RPG::GameCore::NPCComponent* OLMFOBHMCKN; // 0x50
	::Class_1_F3391C70DC37088D* ENOJCFIDHLJ; // 0x58
