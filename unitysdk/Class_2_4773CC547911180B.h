...
#define CLASS_2_4773CC547911180B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x184E30A0)
#define CLASS_2_4773CC547911180B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x184E30E0)
#define CLASS_2_4773CC547911180B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x184E3160)
#define CLASS_2_4773CC547911180B_TICK_OFFSET UNITYSDK_OFFSET(0x184E31B0)
#define CLASS_2_4773CC547911180B__CTOR_OFFSET UNITYSDK_OFFSET(0x184E3090)

inline static constexpr unsigned int Class_2_4773CC547911180B_TypeDefinitionIndex = 53708;

class Class_2_4773CC547911180B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::TriggerMazeMiniMapUI* OFKGLJOAMLD; // 0x20
