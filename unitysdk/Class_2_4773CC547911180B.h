...
#define CLASS_2_4773CC547911180B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1425A600)
#define CLASS_2_4773CC547911180B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1425A640)
#define CLASS_2_4773CC547911180B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1425A6C0)
#define CLASS_2_4773CC547911180B_TICK_OFFSET UNITYSDK_OFFSET(0x1425A710)
#define CLASS_2_4773CC547911180B__CTOR_OFFSET UNITYSDK_OFFSET(0x1425A5F0)

inline static constexpr unsigned int Class_2_4773CC547911180B_TypeDefinitionIndex = 51024;

class Class_2_4773CC547911180B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TriggerMazeMiniMapUI* Field_2_1; // 0x20
