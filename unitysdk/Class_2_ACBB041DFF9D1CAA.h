...
#define CLASS_2_ACBB041DFF9D1CAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA3D98D0)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA3D9910)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA3D9970)
#define CLASS_2_ACBB041DFF9D1CAA_TICK_OFFSET UNITYSDK_OFFSET(0xA3D99C0)
#define CLASS_2_ACBB041DFF9D1CAA__CTOR_OFFSET UNITYSDK_OFFSET(0xA3D98C0)

inline static constexpr unsigned int Class_2_ACBB041DFF9D1CAA_TypeDefinitionIndex = 54877;
