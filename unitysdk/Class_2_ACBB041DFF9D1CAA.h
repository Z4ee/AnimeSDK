...
#define CLASS_2_ACBB041DFF9D1CAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10375360)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x103753A0)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10375400)
#define CLASS_2_ACBB041DFF9D1CAA_TICK_OFFSET UNITYSDK_OFFSET(0x10375450)
#define CLASS_2_ACBB041DFF9D1CAA__CTOR_OFFSET UNITYSDK_OFFSET(0x10375350)

inline static constexpr unsigned int Class_2_ACBB041DFF9D1CAA_TypeDefinitionIndex = 47416;

class Class_2_ACBB041DFF9D1CAA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StopRandomMissionTalk* Field_2_0; // 0x18
