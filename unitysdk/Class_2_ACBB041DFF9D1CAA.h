...
#define CLASS_2_ACBB041DFF9D1CAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17ED0F90)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17ED0FD0)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17ED1030)
#define CLASS_2_ACBB041DFF9D1CAA_TICK_OFFSET UNITYSDK_OFFSET(0x17ED1080)
#define CLASS_2_ACBB041DFF9D1CAA__CTOR_OFFSET UNITYSDK_OFFSET(0x17ED0F80)

inline static constexpr unsigned int Class_2_ACBB041DFF9D1CAA_TypeDefinitionIndex = 58883;

class Class_2_ACBB041DFF9D1CAA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StopRandomMissionTalk* OFKGLJOAMLD; // 0x18
