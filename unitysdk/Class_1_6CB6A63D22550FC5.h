...
#define CLASS_1_6CB6A63D22550FC5__CTOR_OFFSET UNITYSDK_OFFSET(0xFA7C990)
...
{
public:
	::UnityEngine::Vector2 COIHCPBGBPA; // 0x10
	::UnityEngine::Vector2 ECKAIJLHEEM; // 0x18
	::System::Single NIDAPHBEMDE; // 0x20
