...
#define CLASS_3_199C887C8B7CFA71_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x136A3690)
#define CLASS_3_199C887C8B7CFA71__CTOR_OFFSET UNITYSDK_OFFSET(0x136A3660)

inline static constexpr unsigned int Class_3_199C887C8B7CFA71_TypeDefinitionIndex = 51273;
