...
#define CLASS_1_5B567C8A01BAEDFE_181_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2BB7C0)
#define CLASS_1_5B567C8A01BAEDFE_181_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2BB630)
#define CLASS_1_5B567C8A01BAEDFE_181_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2BB6D0)
#define CLASS_1_5B567C8A01BAEDFE_181_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2BB670)
#define CLASS_1_5B567C8A01BAEDFE_181_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2BB720)
#define CLASS_1_5B567C8A01BAEDFE_181_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2BB810)
#define CLASS_1_5B567C8A01BAEDFE_181_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2BB7E0)
#define CLASS_1_5B567C8A01BAEDFE_181_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A2BB5B0)
#define CLASS_1_5B567C8A01BAEDFE_181_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2BB5E0)
#define CLASS_1_5B567C8A01BAEDFE_181_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2BB750)
#define CLASS_1_5B567C8A01BAEDFE_181_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2BB7B0)
#define CLASS_1_5B567C8A01BAEDFE_181__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2BB860)
#define CLASS_1_5B567C8A01BAEDFE_181__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2BB600)
#define CLASS_1_5B567C8A01BAEDFE_181__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2BB5F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_181_TypeDefinitionIndex = 28467;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_181*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_181_TypeDefinitionIndex)->GetStaticField(0x4C1E0);
	}
