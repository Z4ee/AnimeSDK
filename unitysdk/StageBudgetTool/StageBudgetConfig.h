...
#define STAGEBUDGETTOOL_STAGEBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD094D70)

namespace StageBudgetTool
{
	inline static constexpr unsigned int StageBudgetConfig_TypeDefinitionIndex = 45043;
