...
#define STAGEBUDGETTOOL_PRISM_METHOD_1_4C02A9C832395D7A_OFFSET UNITYSDK_OFFSET(0x197E4FA0)
#define STAGEBUDGETTOOL_PRISM_METHOD_1_57B996E880F6A8CA_OFFSET UNITYSDK_OFFSET(0x197E4E30)
#define STAGEBUDGETTOOL_PRISM_METHOD_1_E6E9E20688D7143D_OFFSET UNITYSDK_OFFSET(0x197E4E00)
#define STAGEBUDGETTOOL_PRISM__CTOR_OFFSET UNITYSDK_OFFSET(0x197E5510)

namespace StageBudgetTool
{
	inline static constexpr unsigned int Prism_TypeDefinitionIndex = 48176;
