...
#define STAGEBUDGETTOOL_PRISM_METHOD_1_5E3A735B29A1B5B0_OFFSET UNITYSDK_OFFSET(0xABD9910)
#define STAGEBUDGETTOOL_PRISM_METHOD_1_E6E9E20688D7143D_OFFSET UNITYSDK_OFFSET(0xABD97A0)
#define STAGEBUDGETTOOL_PRISM_METHOD_1_FF2FC2568C8F242F_OFFSET UNITYSDK_OFFSET(0xABD97D0)
#define STAGEBUDGETTOOL_PRISM__CTOR_OFFSET UNITYSDK_OFFSET(0xABD9C20)

namespace StageBudgetTool
{
	inline static constexpr unsigned int Prism_TypeDefinitionIndex = 38597;
