...
#define CLASS_2_A567B4CAFC5B73B1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x163D7570)
#define CLASS_2_A567B4CAFC5B73B1_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x163D7780)
#define CLASS_2_A567B4CAFC5B73B1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x163D75B0)
#define CLASS_2_A567B4CAFC5B73B1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x163D7600)
#define CLASS_2_A567B4CAFC5B73B1_TICK_OFFSET UNITYSDK_OFFSET(0x163D7650)
#define CLASS_2_A567B4CAFC5B73B1__CTOR_OFFSET UNITYSDK_OFFSET(0x163D7560)
...
public:
	...
	::RPG::Client::RoadRashGameModifier_TimedState* OFKGLJOAMLD; // 0x20
