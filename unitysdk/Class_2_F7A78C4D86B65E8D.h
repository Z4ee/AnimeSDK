...
#define CLASS_2_F7A78C4D86B65E8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x109FB010)
#define CLASS_2_F7A78C4D86B65E8D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x109FB990)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_5D99099B99F1668A_OFFSET UNITYSDK_OFFSET(0x109FB600)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_688BE5E8E681071A_OFFSET UNITYSDK_OFFSET(0x109FB070)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_A7DA7E520D3F52A3_OFFSET UNITYSDK_OFFSET(0x109FB530)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x109FBA10)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_DF4A3B8481FEB8BF_OFFSET UNITYSDK_OFFSET(0x109FB100)
#define CLASS_2_F7A78C4D86B65E8D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x109FB9A0)
#define CLASS_2_F7A78C4D86B65E8D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x109FB180)
#define CLASS_2_F7A78C4D86B65E8D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x109FB8C0)
#define CLASS_2_F7A78C4D86B65E8D_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x109FB0B0)
#define CLASS_2_F7A78C4D86B65E8D_TICK_OFFSET UNITYSDK_OFFSET(0x109FB930)
#define CLASS_2_F7A78C4D86B65E8D__CTOR_OFFSET UNITYSDK_OFFSET(0x109FAFF0)

inline static constexpr unsigned int Class_2_F7A78C4D86B65E8D_TypeDefinitionIndex = 43286;

class Class_2_F7A78C4D86B65E8D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::AdventurePhase* Field_2_4; // 0x18
	::RPG::Client::PerformanceManager* Field_2_5; // 0x20
	::Class_3_5775A4FEC79026BC* Field_2_3; // 0x28
	::RPG::GameCore::TriggerPerformance* Field_2_0; // 0x30
	::RPG::GameCore::TaskContext* Field_2_1; // 0x38
	::Class_1_5F51D4049EA87B7B* Field_2_2; // 0x40
