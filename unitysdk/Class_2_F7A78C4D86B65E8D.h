...
#define CLASS_2_F7A78C4D86B65E8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19351DC0)
#define CLASS_2_F7A78C4D86B65E8D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x193528B0)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_688BE5E8E681071A_OFFSET UNITYSDK_OFFSET(0x19351E20)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19352930)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_CCD768A4B5AD3AFC_OFFSET UNITYSDK_OFFSET(0x19351EB0)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_D77E6A6E25781A33_OFFSET UNITYSDK_OFFSET(0x19352390)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_E598ADFD47E46991_OFFSET UNITYSDK_OFFSET(0x19352460)
#define CLASS_2_F7A78C4D86B65E8D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x193528C0)
#define CLASS_2_F7A78C4D86B65E8D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19351F30)
#define CLASS_2_F7A78C4D86B65E8D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x193527E0)
#define CLASS_2_F7A78C4D86B65E8D_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x19351E60)
#define CLASS_2_F7A78C4D86B65E8D_TICK_OFFSET UNITYSDK_OFFSET(0x19352850)
#define CLASS_2_F7A78C4D86B65E8D__CTOR_OFFSET UNITYSDK_OFFSET(0x19351DA0)

inline static constexpr unsigned int Class_2_F7A78C4D86B65E8D_TypeDefinitionIndex = 51026;

class Class_2_F7A78C4D86B65E8D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_07C3C4D2990C49EE* Field_2_0; // 0x18
	::RPG::Client::PerformanceManager* Field_2_1; // 0x20
	::Class_1_5F51D4049EA87B7B* Field_2_2; // 0x28
	::RPG::GameCore::TaskContext* Field_2_3; // 0x30
	::RPG::GameCore::TriggerPerformance* Field_2_4; // 0x38
	::RPG::Client::AdventurePhase* Field_2_5; // 0x40
	...
	::System::Void Method_2_E598ADFD47E46991(::Struct_2_FEFADCB82FEB841E_3 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Struct_2_FEFADCB82FEB841E_3))((::PBYTE)hIl2Cpp + CLASS_2_F7A78C4D86B65E8D_METHOD_2_E598ADFD47E46991_OFFSET))(this, a1);
	}
