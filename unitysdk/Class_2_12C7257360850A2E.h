...
#define CLASS_2_12C7257360850A2E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x893C260)
#define CLASS_2_12C7257360850A2E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x893C2A0)
#define CLASS_2_12C7257360850A2E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x893C600)
#define CLASS_2_12C7257360850A2E_TICK_OFFSET UNITYSDK_OFFSET(0x893C650)
#define CLASS_2_12C7257360850A2E__CTOR_OFFSET UNITYSDK_OFFSET(0x893C250)

inline static constexpr unsigned int Class_2_12C7257360850A2E_TypeDefinitionIndex = 46923;

class Class_2_12C7257360850A2E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::HideLevelStage* Field_2_0; // 0x20
