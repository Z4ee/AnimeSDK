...
#define CLASS_1_68A7E1D93E15255C_GET_BGPATH_OFFSET UNITYSDK_OFFSET(0x118B6D60)
#define CLASS_1_68A7E1D93E15255C_GET_DESC_OFFSET UNITYSDK_OFFSET(0x118B6DC0)
#define CLASS_1_68A7E1D93E15255C_GET_EQUIPMENT3DTGAPATH_OFFSET UNITYSDK_OFFSET(0x118B6D20)
#define CLASS_1_68A7E1D93E15255C_GET_EQUIPMENTLIGHTMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x118B6D00)
#define CLASS_1_68A7E1D93E15255C_GET_FIRSTWORDTEXT_OFFSET UNITYSDK_OFFSET(0x118B6DE0)
#define CLASS_1_68A7E1D93E15255C_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6CA0)
#define CLASS_1_68A7E1D93E15255C_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x118B6C90)
#define CLASS_1_68A7E1D93E15255C_GET_LIGHTCONECARDBACKIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x118B6D80)
#define CLASS_1_68A7E1D93E15255C_GET_MIDDLEICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6CC0)
#define CLASS_1_68A7E1D93E15255C_GET_NAME_OFFSET UNITYSDK_OFFSET(0x118B6DA0)
#define CLASS_1_68A7E1D93E15255C_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6CE0)
#define CLASS_1_68A7E1D93E15255C_GET_TALKICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6D40)
#define CLASS_1_68A7E1D93E15255C_SET_BGPATH_OFFSET UNITYSDK_OFFSET(0x118B6D70)
#define CLASS_1_68A7E1D93E15255C_SET_DESC_OFFSET UNITYSDK_OFFSET(0x118B6DD0)
#define CLASS_1_68A7E1D93E15255C_SET_EQUIPMENT3DTGAPATH_OFFSET UNITYSDK_OFFSET(0x118B6D30)
#define CLASS_1_68A7E1D93E15255C_SET_EQUIPMENTLIGHTMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x118B6D10)
#define CLASS_1_68A7E1D93E15255C_SET_FIRSTWORDTEXT_OFFSET UNITYSDK_OFFSET(0x118B6DF0)
#define CLASS_1_68A7E1D93E15255C_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6CB0)
#define CLASS_1_68A7E1D93E15255C_SET_LIGHTCONECARDBACKIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x118B6D90)
#define CLASS_1_68A7E1D93E15255C_SET_MIDDLEICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6CD0)
#define CLASS_1_68A7E1D93E15255C_SET_NAME_OFFSET UNITYSDK_OFFSET(0x118B6DB0)
#define CLASS_1_68A7E1D93E15255C_SET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6CF0)
#define CLASS_1_68A7E1D93E15255C_SET_TALKICONPATH_OFFSET UNITYSDK_OFFSET(0x118B6D50)
#define CLASS_1_68A7E1D93E15255C__CTOR_OFFSET UNITYSDK_OFFSET(0x118B6E00)

inline static constexpr unsigned int Class_1_68A7E1D93E15255C_TypeDefinitionIndex = 47970;

class Class_1_68A7E1D93E15255C : public ::System::Object
{
public:
	::System::String* _TalkIconPath_k__BackingField; // 0x10
	::System::String* _LightConeCardBackImagePath_k__BackingField; // 0x18
	::System::String* _MiddleIconPath_k__BackingField; // 0x20
	::System::String* _EquipmentLightMaterialPath_k__BackingField; // 0x28
	...
	::System::String* _Equipment3DTgaPath_k__BackingField; // 0x48
	::System::String* _BgPath_k__BackingField; // 0x50
	::RPG::Client::TextID _Desc_k__BackingField; // 0x58
	::RPG::Client::TextID _Name_k__BackingField; // 0x68
	::Struct_2_019938BC9C50B169_6 _Identifier_k__BackingField; // 0x78
