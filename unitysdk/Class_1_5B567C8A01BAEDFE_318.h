...
#define CLASS_1_5B567C8A01BAEDFE_318_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AA3A510)
#define CLASS_1_5B567C8A01BAEDFE_318_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA3A380)
#define CLASS_1_5B567C8A01BAEDFE_318_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AA3A420)
#define CLASS_1_5B567C8A01BAEDFE_318_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AA3A3C0)
#define CLASS_1_5B567C8A01BAEDFE_318_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AA3A470)
#define CLASS_1_5B567C8A01BAEDFE_318_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AA3A560)
#define CLASS_1_5B567C8A01BAEDFE_318_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AA3A530)
#define CLASS_1_5B567C8A01BAEDFE_318_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AA3A300)
#define CLASS_1_5B567C8A01BAEDFE_318_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AA3A330)
#define CLASS_1_5B567C8A01BAEDFE_318_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AA3A4A0)
#define CLASS_1_5B567C8A01BAEDFE_318_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AA3A500)
#define CLASS_1_5B567C8A01BAEDFE_318__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA3A5B0)
#define CLASS_1_5B567C8A01BAEDFE_318__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA3A350)
#define CLASS_1_5B567C8A01BAEDFE_318__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3A340)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_318_TypeDefinitionIndex = 31290;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_318*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_318_TypeDefinitionIndex)->GetStaticField(0x6080);
	}
