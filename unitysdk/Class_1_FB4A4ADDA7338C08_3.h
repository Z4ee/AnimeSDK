...
#define CLASS_1_FB4A4ADDA7338C08_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19776F60)
#define CLASS_1_FB4A4ADDA7338C08_3_CLONE_OFFSET UNITYSDK_OFFSET(0x19776B50)
#define CLASS_1_FB4A4ADDA7338C08_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19776C80)
#define CLASS_1_FB4A4ADDA7338C08_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x19776BD0)
#define CLASS_1_FB4A4ADDA7338C08_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19776D20)
#define CLASS_1_FB4A4ADDA7338C08_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x197770B0)
#define CLASS_1_FB4A4ADDA7338C08_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19777050)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19776B80)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19776BA0)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19776A30)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19776B90)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19776BC0)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19776BB0)
#define CLASS_1_FB4A4ADDA7338C08_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19776A60)
#define CLASS_1_FB4A4ADDA7338C08_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19776E30)
#define CLASS_1_FB4A4ADDA7338C08_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x19776E90)
#define CLASS_1_FB4A4ADDA7338C08_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x19777180)
#define CLASS_1_FB4A4ADDA7338C08_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19776AC0)
#define CLASS_1_FB4A4ADDA7338C08_3__CTOR_OFFSET UNITYSDK_OFFSET(0x19776A70)

inline static constexpr unsigned int Class_1_FB4A4ADDA7338C08_3_TypeDefinitionIndex = 29566;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB4A4ADDA7338C08_3_TypeDefinitionIndex)->GetStaticField(0x5C8F0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_FB4A4ADDA7338C08_3*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_FB4A4ADDA7338C08_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB4A4ADDA7338C08_3_TypeDefinitionIndex)->GetStaticField(0x5C8F8);
	}
