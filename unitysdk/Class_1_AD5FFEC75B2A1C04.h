...
#define CLASS_1_AD5FFEC75B2A1C04_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x160070B0)
#define CLASS_1_AD5FFEC75B2A1C04_FROMFLX_OFFSET UNITYSDK_OFFSET(0x16006CC0)
#define CLASS_1_AD5FFEC75B2A1C04_METHOD_1_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x16007110)
#define CLASS_1_AD5FFEC75B2A1C04_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x16006D40)
#define CLASS_1_AD5FFEC75B2A1C04__CTOR_OFFSET UNITYSDK_OFFSET(0x16007470)

inline static constexpr unsigned int Class_1_AD5FFEC75B2A1C04_TypeDefinitionIndex = 83874;
