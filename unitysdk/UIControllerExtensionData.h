...
#define UICONTROLLEREXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0x18D4F060)
#define UICONTROLLEREXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0x18D4F230)
#define UICONTROLLEREXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0x18D4EF70)
#define UICONTROLLEREXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0x18D4EE80)
#define UICONTROLLEREXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0x18D4F150)
#define UICONTROLLEREXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18D4F360)

inline static constexpr unsigned int UIControllerExtensionData_TypeDefinitionIndex = 46996;
