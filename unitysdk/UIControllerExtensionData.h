...
#define UICONTROLLEREXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0x1CC193E0)
#define UICONTROLLEREXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0x1CC195B0)
#define UICONTROLLEREXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0x1CC192F0)
#define UICONTROLLEREXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0x1CC19200)
#define UICONTROLLEREXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0x1CC194D0)
#define UICONTROLLEREXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC196E0)

inline static constexpr unsigned int UIControllerExtensionData_TypeDefinitionIndex = 50028;
