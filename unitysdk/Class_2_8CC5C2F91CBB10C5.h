...
#define CLASS_2_8CC5C2F91CBB10C5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87A3410)
#define CLASS_2_8CC5C2F91CBB10C5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x87A3450)
#define CLASS_2_8CC5C2F91CBB10C5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x87A35A0)
#define CLASS_2_8CC5C2F91CBB10C5_TICK_OFFSET UNITYSDK_OFFSET(0x87A35F0)
#define CLASS_2_8CC5C2F91CBB10C5__CTOR_OFFSET UNITYSDK_OFFSET(0x87A3400)

inline static constexpr unsigned int Class_2_8CC5C2F91CBB10C5_TypeDefinitionIndex = 44320;

class Class_2_8CC5C2F91CBB10C5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetBattleEventUltraSkillCutin* Field_2_0; // 0x18
