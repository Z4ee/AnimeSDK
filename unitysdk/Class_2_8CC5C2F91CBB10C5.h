...
#define CLASS_2_8CC5C2F91CBB10C5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11DE8B00)
#define CLASS_2_8CC5C2F91CBB10C5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11DE8B40)
#define CLASS_2_8CC5C2F91CBB10C5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11DE8C90)
#define CLASS_2_8CC5C2F91CBB10C5_TICK_OFFSET UNITYSDK_OFFSET(0x11DE8CE0)
#define CLASS_2_8CC5C2F91CBB10C5__CTOR_OFFSET UNITYSDK_OFFSET(0x11DE8AF0)

inline static constexpr unsigned int Class_2_8CC5C2F91CBB10C5_TypeDefinitionIndex = 51036;

class Class_2_8CC5C2F91CBB10C5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetBattleEventUltraSkillCutin* Field_2_0; // 0x20
