...
#define CLASS_1_7C8A615C8E907635_METHOD_1_457717A0CF438A7C_OFFSET UNITYSDK_OFFSET(0x186D0360)
#define CLASS_1_7C8A615C8E907635_METHOD_1_6A6A065F9530B8FD_OFFSET UNITYSDK_OFFSET(0x186D03B0)
#define CLASS_1_7C8A615C8E907635_METHOD_1_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x186D0420)
#define CLASS_1_7C8A615C8E907635_METHOD_1_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0x186D0580)
#define CLASS_1_7C8A615C8E907635__CTOR_OFFSET UNITYSDK_OFFSET(0x186D07F0)
...
{
public:
	::Class_2_BF47C01E9CFEA39C* DFBAMMDBOIA; // 0x10
	::Il2CppArray<::System::Threading::Thread*>* MJHIBOMBAJE; // 0x18
	::Class_1_FF115791B3A1D76D* JLDAANDIJCN; // 0x20
	::RPG::Client::MLinkedLockFreeQueue_1<::System::Action*>* PAINLBMDCJO; // 0x28
