...
#define CLASS_1_7C8A615C8E907635_METHOD_1_457717A0CF438A7C_OFFSET UNITYSDK_OFFSET(0x16C77030)
#define CLASS_1_7C8A615C8E907635_METHOD_1_6A6A065F9530B8FD_OFFSET UNITYSDK_OFFSET(0x16C77080)
#define CLASS_1_7C8A615C8E907635_METHOD_1_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x16C770F0)
#define CLASS_1_7C8A615C8E907635_METHOD_1_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0x16C77250)
#define CLASS_1_7C8A615C8E907635__CTOR_OFFSET UNITYSDK_OFFSET(0x16C774C0)

inline static constexpr unsigned int Class_1_7C8A615C8E907635_TypeDefinitionIndex = 56927;

class Class_1_7C8A615C8E907635 : public ::System::Object
{
public:
	::Class_2_BF47C01E9CFEA39C* Field_1_0; // 0x10
	::RPG::Client::MLinkedLockFreeQueue_1<::System::Action*>* Field_1_1; // 0x18
	::Il2CppArray<::System::Threading::Thread*>* Field_1_2; // 0x20
	::Class_1_FF115791B3A1D76D* Field_1_3; // 0x28
