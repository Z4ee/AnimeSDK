...
#define CLASS_1_5B567C8A01BAEDFE_54_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A01DC50)
#define CLASS_1_5B567C8A01BAEDFE_54_CLONE_OFFSET UNITYSDK_OFFSET(0x1A01DAC0)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A01DB60)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A01DB00)
#define CLASS_1_5B567C8A01BAEDFE_54_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A01DBB0)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A01DCA0)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A01DC70)
#define CLASS_1_5B567C8A01BAEDFE_54_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A01DA40)
#define CLASS_1_5B567C8A01BAEDFE_54_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A01DA70)
#define CLASS_1_5B567C8A01BAEDFE_54_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A01DBE0)
#define CLASS_1_5B567C8A01BAEDFE_54_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A01DC40)
#define CLASS_1_5B567C8A01BAEDFE_54__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A01DCF0)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A01DA90)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_OFFSET UNITYSDK_OFFSET(0x1A01DA80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_54_TypeDefinitionIndex = 25365;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_54*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_54_TypeDefinitionIndex)->GetStaticField(0x2ABA0);
	}
