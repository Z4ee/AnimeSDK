...
#define CLASS_1_5B567C8A01BAEDFE_54_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B8BF60)
#define CLASS_1_5B567C8A01BAEDFE_54_CLONE_OFFSET UNITYSDK_OFFSET(0x19B8BDD0)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B8BE70)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B8BE10)
#define CLASS_1_5B567C8A01BAEDFE_54_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B8BEC0)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B8BFB0)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B8BF80)
#define CLASS_1_5B567C8A01BAEDFE_54_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19B8BD50)
#define CLASS_1_5B567C8A01BAEDFE_54_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B8BD80)
#define CLASS_1_5B567C8A01BAEDFE_54_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B8BEF0)
#define CLASS_1_5B567C8A01BAEDFE_54_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B8BF50)
#define CLASS_1_5B567C8A01BAEDFE_54__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B8C000)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B8BDA0)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8BD90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_54_TypeDefinitionIndex = 25517;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_54*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_54_TypeDefinitionIndex)->GetStaticField(0x4A6E0);
	}
