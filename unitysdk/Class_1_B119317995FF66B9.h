...
#define CLASS_1_B119317995FF66B9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7C8400)
#define CLASS_1_B119317995FF66B9_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7C7FE0)
#define CLASS_1_B119317995FF66B9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7C8130)
#define CLASS_1_B119317995FF66B9_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7C8040)
#define CLASS_1_B119317995FF66B9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7C81E0)
#define CLASS_1_B119317995FF66B9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7C85D0)
#define CLASS_1_B119317995FF66B9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7C8530)
#define CLASS_1_B119317995FF66B9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A7C8020)
#define CLASS_1_B119317995FF66B9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7C7E90)
#define CLASS_1_B119317995FF66B9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A7C8030)
#define CLASS_1_B119317995FF66B9_METHOD_1_AD515D31D5C81878_OFFSET UNITYSDK_OFFSET(0x1A7C8010)
#define CLASS_1_B119317995FF66B9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7C7EC0)
#define CLASS_1_B119317995FF66B9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7C82D0)
#define CLASS_1_B119317995FF66B9_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7C8330)
#define CLASS_1_B119317995FF66B9__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7C87A0)
#define CLASS_1_B119317995FF66B9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7C7F20)
#define CLASS_1_B119317995FF66B9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C7ED0)

inline static constexpr unsigned int Class_1_B119317995FF66B9_TypeDefinitionIndex = 27265;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B119317995FF66B9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B119317995FF66B9_TypeDefinitionIndex)->GetStaticField(0x4B2A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::PlayerAssistInfo*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PlayerAssistInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B119317995FF66B9_TypeDefinitionIndex)->GetStaticField(0x4B2A8);
	}
