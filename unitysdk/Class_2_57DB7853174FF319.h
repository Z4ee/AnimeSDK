...
#define CLASS_2_57DB7853174FF319_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C37BD0)
#define CLASS_2_57DB7853174FF319_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10C38190)
#define CLASS_2_57DB7853174FF319_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x10C38110)
#define CLASS_2_57DB7853174FF319_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C37C10)
#define CLASS_2_57DB7853174FF319_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C38060)
#define CLASS_2_57DB7853174FF319_TICK_OFFSET UNITYSDK_OFFSET(0x10C380B0)
#define CLASS_2_57DB7853174FF319__CTOR_OFFSET UNITYSDK_OFFSET(0x10C37BC0)

inline static constexpr unsigned int Class_2_57DB7853174FF319_TypeDefinitionIndex = 47363;

class Class_2_57DB7853174FF319 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowReading* Field_2_0; // 0x18
