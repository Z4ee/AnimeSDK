...
#define CLASS_1_5B567C8A01BAEDFE_102_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A723530)
#define CLASS_1_5B567C8A01BAEDFE_102_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7233A0)
#define CLASS_1_5B567C8A01BAEDFE_102_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A723440)
#define CLASS_1_5B567C8A01BAEDFE_102_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7233E0)
#define CLASS_1_5B567C8A01BAEDFE_102_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A723490)
#define CLASS_1_5B567C8A01BAEDFE_102_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A723580)
#define CLASS_1_5B567C8A01BAEDFE_102_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A723550)
#define CLASS_1_5B567C8A01BAEDFE_102_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A723320)
#define CLASS_1_5B567C8A01BAEDFE_102_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A723350)
#define CLASS_1_5B567C8A01BAEDFE_102_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7234C0)
#define CLASS_1_5B567C8A01BAEDFE_102_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A723520)
#define CLASS_1_5B567C8A01BAEDFE_102__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7235D0)
#define CLASS_1_5B567C8A01BAEDFE_102__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A723370)
#define CLASS_1_5B567C8A01BAEDFE_102__CTOR_OFFSET UNITYSDK_OFFSET(0x1A723360)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_102_TypeDefinitionIndex = 26291;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_102*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_102_TypeDefinitionIndex)->GetStaticField(0x3D290);
	}
