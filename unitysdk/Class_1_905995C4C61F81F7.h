...
#define CLASS_1_905995C4C61F81F7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E3C9E10)
#define CLASS_1_905995C4C61F81F7_CLONE_OFFSET UNITYSDK_OFFSET(0x1E3C97E0)
#define CLASS_1_905995C4C61F81F7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E3C9A50)
#define CLASS_1_905995C4C61F81F7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E3C98C0)
#define CLASS_1_905995C4C61F81F7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3C9BE0)
#define CLASS_1_905995C4C61F81F7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E3C9FF0)
#define CLASS_1_905995C4C61F81F7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E3C9F50)
#define CLASS_1_905995C4C61F81F7_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E3C9880)
#define CLASS_1_905995C4C61F81F7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E3C9860)
#define CLASS_1_905995C4C61F81F7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E3C9720)
#define CLASS_1_905995C4C61F81F7_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1E3C98B0)
#define CLASS_1_905995C4C61F81F7_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1E3C98A0)
#define CLASS_1_905995C4C61F81F7_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E3C9890)
#define CLASS_1_905995C4C61F81F7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E3C9870)
#define CLASS_1_905995C4C61F81F7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E3C9750)
#define CLASS_1_905995C4C61F81F7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3C9C70)
#define CLASS_1_905995C4C61F81F7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E3C9CD0)
#define CLASS_1_905995C4C61F81F7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3CA1D0)
#define CLASS_1_905995C4C61F81F7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3C9770)
#define CLASS_1_905995C4C61F81F7__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C9760)

inline static constexpr unsigned int Class_1_905995C4C61F81F7_TypeDefinitionIndex = 25592;

class Class_1_905995C4C61F81F7 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_905995C4C61F81F7*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_905995C4C61F81F7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_905995C4C61F81F7_TypeDefinitionIndex)->GetStaticField(0x5F2F0);
	}
