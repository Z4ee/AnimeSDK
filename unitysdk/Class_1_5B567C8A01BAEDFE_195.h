...
#define CLASS_1_5B567C8A01BAEDFE_195_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5B23A0)
#define CLASS_1_5B567C8A01BAEDFE_195_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5B2090)
#define CLASS_1_5B567C8A01BAEDFE_195_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5B21A0)
#define CLASS_1_5B567C8A01BAEDFE_195_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5B20D0)
#define CLASS_1_5B567C8A01BAEDFE_195_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5B2300)
#define CLASS_1_5B567C8A01BAEDFE_195_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5B23F0)
#define CLASS_1_5B567C8A01BAEDFE_195_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5B23C0)
#define CLASS_1_5B567C8A01BAEDFE_195_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C5B2010)
#define CLASS_1_5B567C8A01BAEDFE_195_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5B2040)
#define CLASS_1_5B567C8A01BAEDFE_195_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5B2330)
#define CLASS_1_5B567C8A01BAEDFE_195_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5B2390)
#define CLASS_1_5B567C8A01BAEDFE_195__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5B2440)
#define CLASS_1_5B567C8A01BAEDFE_195__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5B2060)
#define CLASS_1_5B567C8A01BAEDFE_195__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5B2050)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_195_TypeDefinitionIndex = 29342;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_195*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_195_TypeDefinitionIndex)->GetStaticField(0x474A0);
	}
