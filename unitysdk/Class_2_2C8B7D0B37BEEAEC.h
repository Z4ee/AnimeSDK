...
#define CLASS_2_2C8B7D0B37BEEAEC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x180095B0)
#define CLASS_2_2C8B7D0B37BEEAEC_METHOD_2_900854D6DD23E296_OFFSET UNITYSDK_OFFSET(0x180091B0)
#define CLASS_2_2C8B7D0B37BEEAEC_METHOD_2_F6FC78BA493D9C05_OFFSET UNITYSDK_OFFSET(0x18009120)
#define CLASS_2_2C8B7D0B37BEEAEC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18008F90)
#define CLASS_2_2C8B7D0B37BEEAEC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18009310)
#define CLASS_2_2C8B7D0B37BEEAEC_TICK_OFFSET UNITYSDK_OFFSET(0x180093F0)
#define CLASS_2_2C8B7D0B37BEEAEC__CTOR_OFFSET UNITYSDK_OFFSET(0x18008E40)
...
{
public:
	::RPG::Client::LimaoNews::LimaoNewsPlanService* IAHMPKBCKBF; // 0x18
	::Class_3_07C3C4D2990C49EE* EBAIBMDGJNK; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::Class_3_07C3C4D2990C49EE* JPMOKOKJEJC; // 0x30
	::Class_3_45376C2A41320C07* OFKGLJOAMLD; // 0x38
	::Class_3_07C3C4D2990C49EE* CDINLNAOFJO; // 0x40
