...
#define CLASS_1_C7174592C54B104B_EXECUTE_OFFSET UNITYSDK_OFFSET(0xE5AE840)
#define CLASS_1_C7174592C54B104B_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xE5AE5C0)
#define CLASS_1_C7174592C54B104B_METHOD_1_03F3E8B89AA38AF9_OFFSET UNITYSDK_OFFSET(0xE5AEED0)
#define CLASS_1_C7174592C54B104B_METHOD_1_13CC54082E9757C7_OFFSET UNITYSDK_OFFSET(0xE5AED40)
#define CLASS_1_C7174592C54B104B_METHOD_1_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0xE5AF650)
#define CLASS_1_C7174592C54B104B_METHOD_1_5D09DFA26924F01B_OFFSET UNITYSDK_OFFSET(0xE5AF2C0)
#define CLASS_1_C7174592C54B104B_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xE5AF1E0)
#define CLASS_1_C7174592C54B104B_METHOD_1_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xE5AF450)
#define CLASS_1_C7174592C54B104B_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE5AF180)
#define CLASS_1_C7174592C54B104B_METHOD_1_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xE5AFA40)
#define CLASS_1_C7174592C54B104B_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xE5AE610)
#define CLASS_1_C7174592C54B104B_METHOD_1_FD81768D38A00E7C_OFFSET UNITYSDK_OFFSET(0xE5AF4B0)
#define CLASS_1_C7174592C54B104B__CTOR_OFFSET UNITYSDK_OFFSET(0xE5AE530)

inline static constexpr unsigned int Class_1_C7174592C54B104B_TypeDefinitionIndex = 75392;
...
public:
	...
	::Class_2_F3C4BC00835CFDCA* HINDODOFCLK; // 0x10
	::RPG::Client::UIController* LHKMEAFLNBB; // 0x18
	::Class_2_FD51057495DB654F* NFFDOEANJMA; // 0x20
	::Class_1_D33B7D6901AE39E9* FKINCGODJEP; // 0x28
	::System::Single LLNIGIGFCEA; // 0x30
	::System::Boolean BDKNPNKNJIO; // 0x34
