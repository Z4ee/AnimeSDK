...
#define MB3_MESHBAKERCOMMON_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1BE07F60)
#define MB3_MESHBAKERCOMMON_APPLY_OFFSET UNITYSDK_OFFSET(0x1BE07BC0)
#define MB3_MESHBAKERCOMMON_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1BE07600)
#define MB3_MESHBAKERCOMMON_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1BE07580)
#define MB3_MESHBAKERCOMMON_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1BE083A0)
#define MB3_MESHBAKERCOMMON_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1BE07700)
#define MB3_MESHBAKERCOMMON_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1BE07680)
#define MB3_MESHBAKERCOMMON_ENABLEDISABLESOURCEOBJECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x1BE06F90)
#define MB3_MESHBAKERCOMMON_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1BE07740)
#define MB3_MESHBAKERCOMMON_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1BE063A0)
#define MB3_MESHBAKERCOMMON_GETTEXTUREBAKER_OFFSET UNITYSDK_OFFSET(0x1BE07770)
#define MB3_MESHBAKERCOMMON_GET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1BE06140)
#define MB3_MESHBAKERCOMMON_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1BE06330)
#define MB3_MESHBAKERCOMMON_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1BE06130)
#define MB3_MESHBAKERCOMMON_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1BE06980)
#define MB3_MESHBAKERCOMMON_SET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1BE06260)
#define MB3_MESHBAKERCOMMON_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1BE06360)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1BE08570)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_2_OFFSET UNITYSDK_OFFSET(0x1BE08700)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_3_OFFSET UNITYSDK_OFFSET(0x1BE088C0)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1BE083E0)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1BE08B20)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BE08B70)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BE08AD0)
#define MB3_MESHBAKERCOMMON_UPGRADETOCURRENTVERSIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1BE06210)
#define MB3_MESHBAKERCOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE08EE0)
#define MB3_MESHBAKERCOMMON__VALIDATEFORUPDATESKINNEDMESHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BE08BC0)

inline static constexpr unsigned int MB3_MeshBakerCommon_TypeDefinitionIndex = 84966;
