...
#define DYNAMICBONECOLLIDER_COLLIDE_OFFSET UNITYSDK_OFFSET(0x1F5E9210)
#define DYNAMICBONECOLLIDER_DRAWWIRECAPSULE_OFFSET UNITYSDK_OFFSET(0x1F5E9D10)
#define DYNAMICBONECOLLIDER_INSIDECAPSULE_OFFSET UNITYSDK_OFFSET(0x1F5E9AD0)
#define DYNAMICBONECOLLIDER_INSIDESPHERE_OFFSET UNITYSDK_OFFSET(0x1F5E97D0)
#define DYNAMICBONECOLLIDER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F5E9200)
#define DYNAMICBONECOLLIDER_OUTSIDECAPSULE_OFFSET UNITYSDK_OFFSET(0x1F5E9870)
#define DYNAMICBONECOLLIDER_OUTSIDESPHERE_OFFSET UNITYSDK_OFFSET(0x1F5E9720)
#define DYNAMICBONECOLLIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F5EA330)
#define DYNAMICBONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5EA240)

inline static constexpr unsigned int DynamicBoneCollider_TypeDefinitionIndex = 35283;
...
public:
	...
	{
		return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(DynamicBoneCollider_TypeDefinitionIndex)->GetStaticField(0x29460);
	}
