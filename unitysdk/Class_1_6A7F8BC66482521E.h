...
#define CLASS_1_6A7F8BC66482521E_GETSKILLROWDATABYID_OFFSET UNITYSDK_OFFSET(0xBBFA8C0)
#define CLASS_1_6A7F8BC66482521E_GETSKILLROWDATABYNAME_OFFSET UNITYSDK_OFFSET(0xBBFA870)
#define CLASS_1_6A7F8BC66482521E_GETSKILLROWDATA_OFFSET UNITYSDK_OFFSET(0xBBFA820)
#define CLASS_1_6A7F8BC66482521E_GET_ACTIONICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA6A0)
#define CLASS_1_6A7F8BC66482521E_GET_AIPATH_OFFSET UNITYSDK_OFFSET(0xBBFA500)
#define CLASS_1_6A7F8BC66482521E_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA710)
#define CLASS_1_6A7F8BC66482521E_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xBBFA620)
#define CLASS_1_6A7F8BC66482521E_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xBBFA4C0)
#define CLASS_1_6A7F8BC66482521E_GET_DAMAGETYPERESISTANCE_OFFSET UNITYSDK_OFFSET(0xBBFA5C0)
#define CLASS_1_6A7F8BC66482521E_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xBBFA5A0)
#define CLASS_1_6A7F8BC66482521E_GET_HAVEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0xBBFA600)
#define CLASS_1_6A7F8BC66482521E_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA680)
#define CLASS_1_6A7F8BC66482521E_GET_INTRODUCTION_OFFSET UNITYSDK_OFFSET(0xBBFA640)
#define CLASS_1_6A7F8BC66482521E_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA4E0)
#define CLASS_1_6A7F8BC66482521E_GET_JSON_OFFSET UNITYSDK_OFFSET(0xBBFA4A0)
#define CLASS_1_6A7F8BC66482521E_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xBBFA540)
#define CLASS_1_6A7F8BC66482521E_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xBBFA660)
#define CLASS_1_6A7F8BC66482521E_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0xBBFA580)
#define CLASS_1_6A7F8BC66482521E_GET_OVERRIDEAIPATHS_OFFSET UNITYSDK_OFFSET(0xBBFA520)
#define CLASS_1_6A7F8BC66482521E_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA700)
#define CLASS_1_6A7F8BC66482521E_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBBFA480)
#define CLASS_1_6A7F8BC66482521E_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA6C0)
#define CLASS_1_6A7F8BC66482521E_GET_SKILLROWDATAS_OFFSET UNITYSDK_OFFSET(0xBBFA560)
#define CLASS_1_6A7F8BC66482521E_GET_SOMATOTYPE_OFFSET UNITYSDK_OFFSET(0xBBFA720)
#define CLASS_1_6A7F8BC66482521E_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xBBFA5E0)
#define CLASS_1_6A7F8BC66482521E_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA6E0)
#define CLASS_1_6A7F8BC66482521E_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xBBFA7C0)
#define CLASS_1_6A7F8BC66482521E_OVERRIDEDISPLAY_OFFSET UNITYSDK_OFFSET(0xBBFA740)
#define CLASS_1_6A7F8BC66482521E_SET_ACTIONICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA6B0)
#define CLASS_1_6A7F8BC66482521E_SET_AIPATH_OFFSET UNITYSDK_OFFSET(0xBBFA510)
#define CLASS_1_6A7F8BC66482521E_SET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xBBFA630)
#define CLASS_1_6A7F8BC66482521E_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xBBFA4D0)
#define CLASS_1_6A7F8BC66482521E_SET_DAMAGETYPERESISTANCE_OFFSET UNITYSDK_OFFSET(0xBBFA5D0)
#define CLASS_1_6A7F8BC66482521E_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xBBFA5B0)
#define CLASS_1_6A7F8BC66482521E_SET_HAVEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0xBBFA610)
#define CLASS_1_6A7F8BC66482521E_SET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA690)
#define CLASS_1_6A7F8BC66482521E_SET_INTRODUCTION_OFFSET UNITYSDK_OFFSET(0xBBFA650)
#define CLASS_1_6A7F8BC66482521E_SET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA4F0)
#define CLASS_1_6A7F8BC66482521E_SET_JSON_OFFSET UNITYSDK_OFFSET(0xBBFA4B0)
#define CLASS_1_6A7F8BC66482521E_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xBBFA550)
#define CLASS_1_6A7F8BC66482521E_SET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xBBFA670)
#define CLASS_1_6A7F8BC66482521E_SET_NATUREID_OFFSET UNITYSDK_OFFSET(0xBBFA590)
#define CLASS_1_6A7F8BC66482521E_SET_OVERRIDEAIPATHS_OFFSET UNITYSDK_OFFSET(0xBBFA530)
#define CLASS_1_6A7F8BC66482521E_SET_ROW_OFFSET UNITYSDK_OFFSET(0xBBFA490)
#define CLASS_1_6A7F8BC66482521E_SET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA6D0)
#define CLASS_1_6A7F8BC66482521E_SET_SKILLROWDATAS_OFFSET UNITYSDK_OFFSET(0xBBFA570)
#define CLASS_1_6A7F8BC66482521E_SET_SOMATOTYPE_OFFSET UNITYSDK_OFFSET(0xBBFA730)
#define CLASS_1_6A7F8BC66482521E_SET_SPNEED_OFFSET UNITYSDK_OFFSET(0xBBFA5F0)
#define CLASS_1_6A7F8BC66482521E_SET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBBFA6F0)
#define CLASS_1_6A7F8BC66482521E__CTOR_OFFSET UNITYSDK_OFFSET(0xBBFA400)

inline static constexpr unsigned int Class_1_6A7F8BC66482521E_TypeDefinitionIndex = 57093;

class Class_1_6A7F8BC66482521E : public ::System::Object
{
public:
	::RPG::GameCore::CharacterConfig* _Json_k__BackingField; // 0x10
	...
	::Il2CppArray<::System::String*>* _OverrideAIPaths_k__BackingField; // 0x30
	::System::String* _AIPath_k__BackingField; // 0x38
	::System::Object* _Row_k__BackingField; // 0x40
	::System::Collections::Generic::List_1<::RPG::GameCore::ICharacterSkillRowData*>* _SkillRowDatas_k__BackingField; // 0x48
	::System::String* _JsonPath_k__BackingField; // 0x50
	::Il2CppArray<::RPG::GameCore::ElementResistanceConfig*>* _DamageTypeResistance_k__BackingField; // 0x58
	::System::String* _SideAvatarHeadIconPath_k__BackingField; // 0x60
	::System::String* _WaitingAvatarHeadIconPath_k__BackingField; // 0x68
	::System::UInt32 _NatureID_k__BackingField; // 0x70
	...
	::System::UInt32 _ConfigID_k__BackingField; // 0x80
	::System::Boolean _HaveActionDelay_k__BackingField; // 0x84
	::RPG::Client::TextID _Introduction_k__BackingField; // 0x88
