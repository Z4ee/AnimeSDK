...
#define CLASS_2_258337476290CA91_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7F4B50)
#define CLASS_2_258337476290CA91_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A7F4930)
#define CLASS_2_258337476290CA91_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A7F4B00)
#define CLASS_2_258337476290CA91_TICK_OFFSET UNITYSDK_OFFSET(0x1A7F4CC0)
#define CLASS_2_258337476290CA91__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F4830)
...
{
public:
	::RPG::GameCore::MonopolyCheckShouldSettle* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_3_07C3C4D2990C49EE* IJBFOGOBMLE; // 0x28
	::Class_3_07C3C4D2990C49EE* APPJBNPGGMI; // 0x30
