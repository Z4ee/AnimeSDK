...
#define CLASS_3_9C05D2473BED75E6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17AA4A00)
#define CLASS_3_9C05D2473BED75E6_METHOD_3_F6BF6CD921145C05_OFFSET UNITYSDK_OFFSET(0x17AA48F0)
#define CLASS_3_9C05D2473BED75E6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17AA3AD0)
#define CLASS_3_9C05D2473BED75E6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17AA49B0)
#define CLASS_3_9C05D2473BED75E6_TICK_OFFSET UNITYSDK_OFFSET(0x17AA4A40)
#define CLASS_3_9C05D2473BED75E6__CTOR_OFFSET UNITYSDK_OFFSET(0x17AA3AB0)
...
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x78
	::RPG::GameCore::ActiveMarbleVirtualCamera* IGHAHBNLIJA; // 0x80
