...
#define CLASS_2_231AB9D7CB560FEC_METHOD_2_4D6789FBC58A056F_OFFSET UNITYSDK_OFFSET(0x1C8C4B90)
#define CLASS_2_231AB9D7CB560FEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8C4ED0)
...
{
public:
	::Il2CppArray<::RPG::GameCore::JsonEnum*>* DCLGGMAEMAO; // 0x10
	::RPG::GameCore::DynamicFloat* EPFPKBLIIOI; // 0x18
	::RPG::GameCore::DynamicFloat* HCDEOKNIGKG; // 0x20
	::RPG::GameCore::RtSummonCharacterExtraDataBase* PDLNGNHJJEI; // 0x28
	::RPG::GameCore::DynamicFloat* JIDLKIHJLFL; // 0x30
	::RPG::GameCore::TargetEvaluator* PPKKOLKCKOI; // 0x38
