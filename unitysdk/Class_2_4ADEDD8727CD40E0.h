...
#define CLASS_2_4ADEDD8727CD40E0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178BD300)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x178BF160)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_1D9665FEAF2CECC3_OFFSET UNITYSDK_OFFSET(0x178BE940)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_2045BA2947DBDBCE_OFFSET UNITYSDK_OFFSET(0x178BEE80)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_2B82A6C640A9C940_OFFSET UNITYSDK_OFFSET(0x178BFF00)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x178BE070)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_8C1C9660B1FCE875_OFFSET UNITYSDK_OFFSET(0x178BF5F0)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x178BDD00)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_9DC685F3E3A2FC2F_OFFSET UNITYSDK_OFFSET(0x178BD650)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_A07EA6C551ECC2CC_OFFSET UNITYSDK_OFFSET(0x178BFC70)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x178BF490)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_DB423A05B471042F_OFFSET UNITYSDK_OFFSET(0x178BF9D0)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_DF2A78D8DB25ED05_1_OFFSET UNITYSDK_OFFSET(0x178BF0A0)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x178BEE30)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_E0F3A7E0D78CF15F_OFFSET UNITYSDK_OFFSET(0x178BE110)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_E49FC3D0AC1CB0F6_OFFSET UNITYSDK_OFFSET(0x178BF5A0)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_F5447CD65612575D_1_OFFSET UNITYSDK_OFFSET(0x178BF960)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x178BF0F0)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_F944CC0CE8B3E57A_OFFSET UNITYSDK_OFFSET(0x178BDFB0)
#define CLASS_2_4ADEDD8727CD40E0_METHOD_2_FADBDF6B666E37DE_OFFSET UNITYSDK_OFFSET(0x178BDDE0)
#define CLASS_2_4ADEDD8727CD40E0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x178BD470)
#define CLASS_2_4ADEDD8727CD40E0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x178BD3A0)
#define CLASS_2_4ADEDD8727CD40E0_TICK_OFFSET UNITYSDK_OFFSET(0x178BD400)
#define CLASS_2_4ADEDD8727CD40E0__CTOR_OFFSET UNITYSDK_OFFSET(0x178BD1A0)
...
{
public:
	::RPG::GameCore::LevelGraphConfig* INCIKECJNHK; // 0x18
	::RPG::GameCore::StartSummonUnitGameplay* OFKGLJOAMLD; // 0x20
	::Class_2_E3332B678B8C5C07* KFEEIIIHPJM; // 0x28
	::RPG::GameCore::SummonUnitGameplayConfig* IOFNMCBADNM; // 0x30
	::Class_1_DB9575801298F699* EPGIOAEIACN; // 0x38
	::Class_1_72FF3C03F0F06A80* AFNDGMJDPIC; // 0x40
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x48
	::System::Boolean HFAPCECJFPM; // 0x50
	::System::UInt32 ACOIPMDKLPJ; // 0x54
