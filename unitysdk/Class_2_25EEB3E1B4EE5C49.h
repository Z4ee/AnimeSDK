...
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x180A63C0)
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0x180A67F0)
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_2C42E9E5ED099427_OFFSET UNITYSDK_OFFSET(0x180A6420)
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x180A6500)
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_8FAD57395F26ACC4_1_OFFSET UNITYSDK_OFFSET(0x180A6740)
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x180A6680)
#define CLASS_2_25EEB3E1B4EE5C49_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x180A62C0)
#define CLASS_2_25EEB3E1B4EE5C49_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x180A61E0)
#define CLASS_2_25EEB3E1B4EE5C49_ONRETURN_OFFSET UNITYSDK_OFFSET(0x180A6230)
#define CLASS_2_25EEB3E1B4EE5C49__CTOR_OFFSET UNITYSDK_OFFSET(0x180A6850)
#define CLASS_2_25EEB3E1B4EE5C49__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x180A6330)

inline static constexpr unsigned int Class_2_25EEB3E1B4EE5C49_TypeDefinitionIndex = 71767;

class Class_2_25EEB3E1B4EE5C49 : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* EDFBNBONLCF; // 0x0
	// static const ::System::String* KPDLCOGBBCJ; // 0x0
	::UnityEngine::Animation* KCOAILOHDND; // 0x60
	::UnityEngine::RectTransform* DHLNPCEAAML; // 0x68
