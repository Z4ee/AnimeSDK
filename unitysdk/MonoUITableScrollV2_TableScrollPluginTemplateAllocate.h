...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_ALLOCATESCROLLITEM_OFFSET UNITYSDK_OFFSET(0x1345F6F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_CREATESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x1345FCC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_FLUSHALLTEMPRECYCLEITEMTORECYCLE_OFFSET UNITYSDK_OFFSET(0x1345FB70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_POPTEMPRECYCLESCOPE_OFFSET UNITYSDK_OFFSET(0x1345FC50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_PUSHTEMPRECYCLESCOPE_OFFSET UNITYSDK_OFFSET(0x1345FBF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_RECYCLEALLSCROLLITEMS_OFFSET UNITYSDK_OFFSET(0x1345F1A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE_RECYCLESCROLLITEM_OFFSET UNITYSDK_OFFSET(0x1345F380)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE__ALLOCATESCROLLITEM_OFFSET UNITYSDK_OFFSET(0x1345F740)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINTEMPLATEALLOCATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1345F190)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginTemplateAllocate_TypeDefinitionIndex = 54141;
