...
#define CLASS_1_3A9E54A224DC962B_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DFC25A0)
#define CLASS_1_3A9E54A224DC962B_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1DFC2000)
#define CLASS_1_3A9E54A224DC962B_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DFC2240)
#define CLASS_1_3A9E54A224DC962B_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DFC20C0)
#define CLASS_1_3A9E54A224DC962B_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DFC23C0)
#define CLASS_1_3A9E54A224DC962B_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DFC2700)
#define CLASS_1_3A9E54A224DC962B_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DFC2670)
#define CLASS_1_3A9E54A224DC962B_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DFC20A0)
#define CLASS_1_3A9E54A224DC962B_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DFC1F40)
#define CLASS_1_3A9E54A224DC962B_3_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1DFC2090)
#define CLASS_1_3A9E54A224DC962B_3_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1DFC2080)
#define CLASS_1_3A9E54A224DC962B_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DFC20B0)
#define CLASS_1_3A9E54A224DC962B_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DFC1F70)
#define CLASS_1_3A9E54A224DC962B_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DFC2460)
#define CLASS_1_3A9E54A224DC962B_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DFC24C0)
#define CLASS_1_3A9E54A224DC962B_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DFC28C0)
#define CLASS_1_3A9E54A224DC962B_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFC1F90)
#define CLASS_1_3A9E54A224DC962B_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFC1F80)

inline static constexpr unsigned int Class_1_3A9E54A224DC962B_3_TypeDefinitionIndex = 30370;

class Class_1_3A9E54A224DC962B_3 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_3A9E54A224DC962B_3*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_3A9E54A224DC962B_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3A9E54A224DC962B_3_TypeDefinitionIndex)->GetStaticField(0x55B20);
	}
	// static const ::System::Int32 EBMIJAAKMMH = 0x6; // 0x0
	// static const ::System::Int32 PGLBLGGFDJF = 0x8; // 0x0
