...
#define CLASS_3_4FEC308312B5461F_METHOD_3_797574F762C9D389_OFFSET UNITYSDK_OFFSET(0x1DC7D5C0)
#define CLASS_3_4FEC308312B5461F_METHOD_3_FCE92D332F1E367F_OFFSET UNITYSDK_OFFSET(0x1DC7D550)
#define CLASS_3_4FEC308312B5461F__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC7D5A0)
...
public:
	...
	::RPG::GameCore::NewProjectileConfig* FJFCBBOCICK; // 0x20
	::RPG::GameCore::ProjectileData* PJCICCBNBEI; // 0x28
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* BKNDLCGHANK; // 0x30
	::RPG::GameCore::PredicateConfig* FHAAHMEJMCI; // 0x38
	::System::Int32 MGKPADCJGIM; // 0x40
	::RPG::GameCore::AliveStateMask MJKLBHBEDJH; // 0x44
	::System::Boolean JGJPOFCDKFM; // 0x46
	::System::Boolean FKJPBMMCHFL; // 0x47
	::System::Int32 LNNLLMKBAGL; // 0x48
