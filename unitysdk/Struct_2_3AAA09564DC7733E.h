...
#define STRUCT_2_3AAA09564DC7733E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x880E30)
#define STRUCT_2_3AAA09564DC7733E_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x880F60)
#define STRUCT_2_3AAA09564DC7733E_EQUALS_OFFSET UNITYSDK_OFFSET(0x880DB0)
#define STRUCT_2_3AAA09564DC7733E_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x880FB0)
#define STRUCT_2_3AAA09564DC7733E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x880F10)
#define STRUCT_2_3AAA09564DC7733E_METHOD_2_57A8E11FECF10345_1_OFFSET UNITYSDK_OFFSET(0x186ED3D0)
#define STRUCT_2_3AAA09564DC7733E_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x186ED240)
#define STRUCT_2_3AAA09564DC7733E_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x880FE0)
#define STRUCT_2_3AAA09564DC7733E_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x881050)
#define STRUCT_2_3AAA09564DC7733E__CCTOR_OFFSET UNITYSDK_OFFSET(0x186ED350)

inline static constexpr unsigned int Struct_2_3AAA09564DC7733E_TypeDefinitionIndex = 40507;

struct alignas(8) Struct_2_3AAA09564DC7733E
{
	static ::Struct_2_3AAA09564DC7733E* StaticGet_Field_2_1()
	{
		return (::Struct_2_3AAA09564DC7733E*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_3AAA09564DC7733E_TypeDefinitionIndex)->GetStaticField(0x515B0);
	}
	::System::String* Field_2_0; // 0x10
	::System::UInt64 Field_2_7; // 0x18
	::MoleMole::Config::ScreenEffectType Field_2_6; // 0x20
	::Enum_3_94EF767DB88BCE69 Field_2_5; // 0x24
	::Class_1_43BD383C98B4C0C5_28* Field_2_4; // 0x28
