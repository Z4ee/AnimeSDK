...
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7D6730)
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E7D6740)
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E7D6760)
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7D6720)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeSpanDrawerSettingsAttribute_TypeDefinitionIndex = 91395;
