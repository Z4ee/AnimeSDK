...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C49BD50)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C49BE00)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C49B9C0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49B9B0)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_WithUnitValueDelegate_TypeDefinitionIndex = 85825;
