...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7D93B0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7D9460)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7D9020)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7D9000)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_WithUnitValueDelegate_TypeDefinitionIndex = 91399;
