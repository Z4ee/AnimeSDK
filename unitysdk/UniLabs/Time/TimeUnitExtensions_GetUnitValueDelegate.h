...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7D8F40)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7D8FD0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7D8BF0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7D8BD0)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_GetUnitValueDelegate_TypeDefinitionIndex = 91400;
