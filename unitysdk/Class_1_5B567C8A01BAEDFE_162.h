...
#define CLASS_1_5B567C8A01BAEDFE_162_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C7D6860)
#define CLASS_1_5B567C8A01BAEDFE_162_CLONE_OFFSET UNITYSDK_OFFSET(0x1C7D6550)
#define CLASS_1_5B567C8A01BAEDFE_162_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C7D6660)
#define CLASS_1_5B567C8A01BAEDFE_162_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C7D6590)
#define CLASS_1_5B567C8A01BAEDFE_162_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C7D67C0)
#define CLASS_1_5B567C8A01BAEDFE_162_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7D68B0)
#define CLASS_1_5B567C8A01BAEDFE_162_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C7D6880)
#define CLASS_1_5B567C8A01BAEDFE_162_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C7D64D0)
#define CLASS_1_5B567C8A01BAEDFE_162_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7D6500)
#define CLASS_1_5B567C8A01BAEDFE_162_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C7D67F0)
#define CLASS_1_5B567C8A01BAEDFE_162_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C7D6850)
#define CLASS_1_5B567C8A01BAEDFE_162__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C7D6900)
#define CLASS_1_5B567C8A01BAEDFE_162__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7D6520)
#define CLASS_1_5B567C8A01BAEDFE_162__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7D6510)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_162_TypeDefinitionIndex = 28508;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_162*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_162_TypeDefinitionIndex)->GetStaticField(0x29FB0);
	}
