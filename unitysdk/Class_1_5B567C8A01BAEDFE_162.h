...
#define CLASS_1_5B567C8A01BAEDFE_162_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9BD0C0)
#define CLASS_1_5B567C8A01BAEDFE_162_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9BCED0)
#define CLASS_1_5B567C8A01BAEDFE_162_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9BCFD0)
#define CLASS_1_5B567C8A01BAEDFE_162_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9BCF40)
#define CLASS_1_5B567C8A01BAEDFE_162_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9BD020)
#define CLASS_1_5B567C8A01BAEDFE_162_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9BD110)
#define CLASS_1_5B567C8A01BAEDFE_162_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9BD0E0)
#define CLASS_1_5B567C8A01BAEDFE_162_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A9BCE20)
#define CLASS_1_5B567C8A01BAEDFE_162_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9BCE80)
#define CLASS_1_5B567C8A01BAEDFE_162_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9BD050)
#define CLASS_1_5B567C8A01BAEDFE_162_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9BD0B0)
#define CLASS_1_5B567C8A01BAEDFE_162__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9BD160)
#define CLASS_1_5B567C8A01BAEDFE_162__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9BCEA0)
#define CLASS_1_5B567C8A01BAEDFE_162__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9BCE90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_162_TypeDefinitionIndex = 27926;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_162*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_162_TypeDefinitionIndex)->GetStaticField(0x67390);
	}
