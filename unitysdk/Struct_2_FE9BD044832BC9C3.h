...
#define STRUCT_2_FE9BD044832BC9C3__CTOR_OFFSET UNITYSDK_OFFSET(0x39A9C20)

inline static constexpr unsigned int Struct_2_FE9BD044832BC9C3_TypeDefinitionIndex = 73936;

struct alignas(8) Struct_2_FE9BD044832BC9C3
{
	// static const ::System::Int32 FCMMMANGEEI = 0xC; // 0x0
	::System::Int32 NOIEMNLMACN; // 0x10
	::Struct_2_E4446863CEE2BD81 OGKKJKFNCFL; // 0x18
