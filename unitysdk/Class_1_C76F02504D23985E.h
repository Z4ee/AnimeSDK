...
#define CLASS_1_C76F02504D23985E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D8211B0)
#define CLASS_1_C76F02504D23985E_CLONE_OFFSET UNITYSDK_OFFSET(0x1D820C50)
#define CLASS_1_C76F02504D23985E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D820E30)
#define CLASS_1_C76F02504D23985E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D820CD0)
#define CLASS_1_C76F02504D23985E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D820F60)
#define CLASS_1_C76F02504D23985E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D821430)
#define CLASS_1_C76F02504D23985E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D821380)
#define CLASS_1_C76F02504D23985E_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1D820CB0)
#define CLASS_1_C76F02504D23985E_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1D820C90)
#define CLASS_1_C76F02504D23985E_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D820B00)
#define CLASS_1_C76F02504D23985E_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1D820CA0)
#define CLASS_1_C76F02504D23985E_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1D820CC0)
#define CLASS_1_C76F02504D23985E_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1D820C80)
#define CLASS_1_C76F02504D23985E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D820B30)
#define CLASS_1_C76F02504D23985E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D820FD0)
#define CLASS_1_C76F02504D23985E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D821030)
#define CLASS_1_C76F02504D23985E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D821620)
#define CLASS_1_C76F02504D23985E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D820B90)
#define CLASS_1_C76F02504D23985E__CTOR_OFFSET UNITYSDK_OFFSET(0x1D820B40)

inline static constexpr unsigned int Class_1_C76F02504D23985E_TypeDefinitionIndex = 25760;

class Class_1_C76F02504D23985E : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_8654F1DF226F6DE3_4*>** StaticGet_NPHBBNDFMJP()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_8654F1DF226F6DE3_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C76F02504D23985E_TypeDefinitionIndex)->GetStaticField(0x2C4A0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_C76F02504D23985E*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C76F02504D23985E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C76F02504D23985E_TypeDefinitionIndex)->GetStaticField(0x2C4A8);
	}
	// static const ::System::Int32 COICJNBDJFC = 0xA; // 0x0
	// static const ::System::Int32 DNFFJDPPHNL = 0xC; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0x7; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_8654F1DF226F6DE3_4*>* BGOOOPAMDJG; // 0x18
