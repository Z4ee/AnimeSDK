...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESIMPL_OFFSET UNITYSDK_OFFSET(0x171F02F0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICES_OFFSET UNITYSDK_OFFSET(0x171F0250)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GETDEVICESGUIDPRODUCT_OFFSET UNITYSDK_OFFSET(0x171F0170)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x171F0310)
#define AUDIO_PINVOKE_IDIRECTINPUT8__CTOR_OFFSET UNITYSDK_OFFSET(0x171F0100)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_TypeDefinitionIndex = 80176;
...
public:
	...
	::System::IntPtr _callbackPtr; // 0x18
	::System::Guid resultGuidProduct; // 0x20
	::System::IntPtr _nativePtr; // 0x30
