...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESIMPL_OFFSET UNITYSDK_OFFSET(0x160612A0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICES_OFFSET UNITYSDK_OFFSET(0x16061200)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GETDEVICESGUIDPRODUCT_OFFSET UNITYSDK_OFFSET(0x16061120)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x160612C0)
#define AUDIO_PINVOKE_IDIRECTINPUT8__CTOR_OFFSET UNITYSDK_OFFSET(0x160610B0)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_TypeDefinitionIndex = 86136;
...
public:
	...
	::System::IntPtr _nativePtr; // 0x18
	::System::IntPtr _callbackPtr; // 0x20
	::System::Guid resultGuidProduct; // 0x28
