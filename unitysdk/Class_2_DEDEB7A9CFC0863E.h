...
#define CLASS_2_DEDEB7A9CFC0863E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x117B05C0)
#define CLASS_2_DEDEB7A9CFC0863E_GET__COMMONCONFIG_OFFSET UNITYSDK_OFFSET(0x117B0CA0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_086AF5E1F81FD4BC_OFFSET UNITYSDK_OFFSET(0x117AFEF0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_0FF711E1520484B8_OFFSET UNITYSDK_OFFSET(0x117B0090)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x117AF3E0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_4E4517540F7A2678_OFFSET UNITYSDK_OFFSET(0x117AFE20)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_66B58BEE3C528647_OFFSET UNITYSDK_OFFSET(0x117AF6D0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x117AFC30)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_812B27EF664F59CD_OFFSET UNITYSDK_OFFSET(0x117B0C00)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_94CBD0C21A609187_OFFSET UNITYSDK_OFFSET(0x117B0B40)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_99053D1AE5A59190_OFFSET UNITYSDK_OFFSET(0x117B0240)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_A4A798E0E81B27AE_OFFSET UNITYSDK_OFFSET(0x117AF200)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0x117AF440)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_CFB4683D7465D57F_OFFSET UNITYSDK_OFFSET(0x117B0750)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x117AFA80)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x117B0C90)
#define CLASS_2_DEDEB7A9CFC0863E_SET__COMMONCONFIG_OFFSET UNITYSDK_OFFSET(0x117B0CB0)
#define CLASS_2_DEDEB7A9CFC0863E_TICK_OFFSET UNITYSDK_OFFSET(0x117B06D0)
#define CLASS_2_DEDEB7A9CFC0863E__CTOR_OFFSET UNITYSDK_OFFSET(0x117AF150)
#define CLASS_2_DEDEB7A9CFC0863E___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x117B0CC0)

inline static constexpr unsigned int Class_2_DEDEB7A9CFC0863E_TypeDefinitionIndex = 60077;

class Class_2_DEDEB7A9CFC0863E : public ::RPG::GameCore::GameComponentBase
{
public:
	// static const ::System::UInt32 Field_2_8 = 0x3DB4E2; // 0x0
	::RPG::Client::EraFlipperManager* Field_2_7; // 0x18
