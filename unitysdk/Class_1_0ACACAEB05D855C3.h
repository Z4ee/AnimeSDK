...
#define CLASS_1_0ACACAEB05D855C3_GETVALUE_OFFSET UNITYSDK_OFFSET(0x139F5FB0)
#define CLASS_1_0ACACAEB05D855C3_METHOD_1_6F63188617A9C728_OFFSET UNITYSDK_OFFSET(0x139F6040)
#define CLASS_1_0ACACAEB05D855C3__CTOR_OFFSET UNITYSDK_OFFSET(0x139F6100)

inline static constexpr unsigned int Class_1_0ACACAEB05D855C3_TypeDefinitionIndex = 71919;
...
public:
	...
	{
		return ((::RPG::GameCore::FixPoint(*)(::PVOID, ::Class_0_16E4307DCC419505_260*, ::Entitas::IEntity*, ::RPG::GameCore::BaseLittleGameAbilityValueGetterConfig*))((::PBYTE)hIl2Cpp + CLASS_1_0ACACAEB05D855C3_GETVALUE_OFFSET))(this, a1, a2, a3);
	}
