...
#define CLASS_1_23C1B7E6B450FFB8_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E1931C0)
#define CLASS_1_23C1B7E6B450FFB8_4_CLONE_OFFSET UNITYSDK_OFFSET(0x1E192BA0)
#define CLASS_1_23C1B7E6B450FFB8_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E192CE0)
#define CLASS_1_23C1B7E6B450FFB8_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E192C80)
#define CLASS_1_23C1B7E6B450FFB8_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E192EE0)
#define CLASS_1_23C1B7E6B450FFB8_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E193350)
#define CLASS_1_23C1B7E6B450FFB8_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E1932F0)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E192C60)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E192C20)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E192AE0)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E192C70)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E192C30)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1E192C50)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1E192C40)
#define CLASS_1_23C1B7E6B450FFB8_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E192B40)
#define CLASS_1_23C1B7E6B450FFB8_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E193000)
#define CLASS_1_23C1B7E6B450FFB8_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E193060)
#define CLASS_1_23C1B7E6B450FFB8_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E193560)
#define CLASS_1_23C1B7E6B450FFB8_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E192B60)
#define CLASS_1_23C1B7E6B450FFB8_4__CTOR_OFFSET UNITYSDK_OFFSET(0x1E192B50)

inline static constexpr unsigned int Class_1_23C1B7E6B450FFB8_4_TypeDefinitionIndex = 25316;

class Class_1_23C1B7E6B450FFB8_4 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_4*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_23C1B7E6B450FFB8_4_TypeDefinitionIndex)->GetStaticField(0x52790);
	}
	// static const ::System::Int32 KOEOEHIMOEI = 0x1; // 0x0
	// static const ::System::Int32 IBJNBJNDPIK = 0x2; // 0x0
	// static const ::System::Int32 DCLDKJHAEOJ = 0x3; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt32 LJDBCGPFFDH; // 0x18
	::System::UInt32 DAOHIMDOFME; // 0x1C
