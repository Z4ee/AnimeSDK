...
#define STRUCT_2_DEFBC4F1D068893B_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_1EF0BB4FC8495162_OFFSET UNITYSDK_OFFSET(0x825FA0)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_3FA063706A9B5149_OFFSET UNITYSDK_OFFSET(0x826160)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_B979C738815D22CC_OFFSET UNITYSDK_OFFSET(0x825F90)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_D180C1C39675A7FD_OFFSET UNITYSDK_OFFSET(0x8260B0)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_FE46CFDD5AFA32C9_OFFSET UNITYSDK_OFFSET(0x826100)
#define STRUCT_2_DEFBC4F1D068893B__CTOR_OFFSET UNITYSDK_OFFSET(0x825F40)

inline static constexpr unsigned int Struct_2_DEFBC4F1D068893B_TypeDefinitionIndex = 44306;

struct alignas(8) Struct_2_DEFBC4F1D068893B
{
	::System::Int32 Field_2_0; // 0x10
	::Class_2_208CC9941471731A_997* Field_2_1; // 0x18
