...
#define STRUCT_2_DEFBC4F1D068893B_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_1EF0BB4FC8495162_OFFSET UNITYSDK_OFFSET(0x7B9E10)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_37C94BEC75E6B529_OFFSET UNITYSDK_OFFSET(0x7BA000)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_3FA063706A9B5149_OFFSET UNITYSDK_OFFSET(0x7B9F80)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_D180C1C39675A7FD_OFFSET UNITYSDK_OFFSET(0x7BA010)
#define STRUCT_2_DEFBC4F1D068893B_METHOD_2_FE46CFDD5AFA32C9_OFFSET UNITYSDK_OFFSET(0x7B9F20)
#define STRUCT_2_DEFBC4F1D068893B__CTOR_OFFSET UNITYSDK_OFFSET(0x7B9DC0)

inline static constexpr unsigned int Struct_2_DEFBC4F1D068893B_TypeDefinitionIndex = 73376;

struct alignas(8) Struct_2_DEFBC4F1D068893B
{
	::System::Int32 Field_2_1; // 0x10
	::Class_2_208CC9941471731A_359* Field_2_0; // 0x18
	...
	*/
	...
	{
		return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_DEFBC4F1D068893B_METHOD_2_37C94BEC75E6B529_OFFSET))(this);
	}
