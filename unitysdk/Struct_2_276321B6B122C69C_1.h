...
#define STRUCT_2_276321B6B122C69C_1_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7DFB0)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7DE80)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x147FF0)
#define STRUCT_2_276321B6B122C69C_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7DD60)
#define STRUCT_2_276321B6B122C69C_1_GET_ID_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define STRUCT_2_276321B6B122C69C_1_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1E110)
#define STRUCT_2_276321B6B122C69C_1_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCEBFA00)
#define STRUCT_2_276321B6B122C69C_1_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCEBF8E0)
#define STRUCT_2_276321B6B122C69C_1_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x147FD0)
#define STRUCT_2_276321B6B122C69C_1_SET_ID_OFFSET UNITYSDK_OFFSET(0x2C4C0)
#define STRUCT_2_276321B6B122C69C_1_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x21F0)
#define STRUCT_2_276321B6B122C69C_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x147FC0)
#define STRUCT_2_276321B6B122C69C_1__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBE0)

inline static constexpr unsigned int Struct_2_276321B6B122C69C_1_TypeDefinitionIndex = 48560;
