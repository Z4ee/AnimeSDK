...
#define STRUCT_2_276321B6B122C69C_1_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x38E4A80)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3948FA0)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x3948F70)
#define STRUCT_2_276321B6B122C69C_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3948F60)
#define STRUCT_2_276321B6B122C69C_1_GET_ID_OFFSET UNITYSDK_OFFSET(0x167710)
#define STRUCT_2_276321B6B122C69C_1_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define STRUCT_2_276321B6B122C69C_1_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x16D8AB00)
#define STRUCT_2_276321B6B122C69C_1_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x16D8AAE0)
#define STRUCT_2_276321B6B122C69C_1_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x3948F40)
#define STRUCT_2_276321B6B122C69C_1_SET_ID_OFFSET UNITYSDK_OFFSET(0x167520)
#define STRUCT_2_276321B6B122C69C_1_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA4B350)
#define STRUCT_2_276321B6B122C69C_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3948F30)
#define STRUCT_2_276321B6B122C69C_1__CTOR_OFFSET UNITYSDK_OFFSET(0x6E5720)

inline static constexpr unsigned int Struct_2_276321B6B122C69C_1_TypeDefinitionIndex = 49573;
