...
#define CLASS_2_8B1646B01C41AFE5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B245D0)
#define CLASS_2_8B1646B01C41AFE5_METHOD_2_C2422E9C86913F34_OFFSET UNITYSDK_OFFSET(0x14B246D0)
#define CLASS_2_8B1646B01C41AFE5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14B24610)
#define CLASS_2_8B1646B01C41AFE5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14B24760)
#define CLASS_2_8B1646B01C41AFE5_TICK_OFFSET UNITYSDK_OFFSET(0x14B247B0)
#define CLASS_2_8B1646B01C41AFE5__CTOR_OFFSET UNITYSDK_OFFSET(0x14B245C0)

inline static constexpr unsigned int Class_2_8B1646B01C41AFE5_TypeDefinitionIndex = 51922;

class Class_2_8B1646B01C41AFE5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifyAIVariableInt* Field_2_0; // 0x18
