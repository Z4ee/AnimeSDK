...
#define CLASS_2_8B1646B01C41AFE5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xECB8B80)
#define CLASS_2_8B1646B01C41AFE5_METHOD_2_C2422E9C86913F34_OFFSET UNITYSDK_OFFSET(0xECB8C70)
#define CLASS_2_8B1646B01C41AFE5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xECB8BC0)
#define CLASS_2_8B1646B01C41AFE5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xECB8D00)
#define CLASS_2_8B1646B01C41AFE5_TICK_OFFSET UNITYSDK_OFFSET(0xECB8D50)
#define CLASS_2_8B1646B01C41AFE5__CTOR_OFFSET UNITYSDK_OFFSET(0xECB8B70)

inline static constexpr unsigned int Class_2_8B1646B01C41AFE5_TypeDefinitionIndex = 50170;

class Class_2_8B1646B01C41AFE5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifyAIVariableInt* Field_2_1; // 0x18
