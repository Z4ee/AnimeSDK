...
#define CLASS_2_FCA621F56128C675_CLEAR_OFFSET UNITYSDK_OFFSET(0xC50A5F0)
#define CLASS_2_FCA621F56128C675_CREATEAVATARDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0xC50A670)
#define CLASS_2_FCA621F56128C675_CREATEEQUIPCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC50A780)
#define CLASS_2_FCA621F56128C675_CREATEEQUIPITEMS_OFFSET UNITYSDK_OFFSET(0xC50AA10)
#define CLASS_2_FCA621F56128C675_CREATEPROPERTYPROVIDER_OFFSET UNITYSDK_OFFSET(0xC50A6F0)
#define CLASS_2_FCA621F56128C675_CREATETRAITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC50A880)
#define CLASS_2_FCA621F56128C675_CREATETRAITS_OFFSET UNITYSDK_OFFSET(0xC50AAA0)
#define CLASS_2_FCA621F56128C675_CREATEVALUECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC50A910)
#define CLASS_2_FCA621F56128C675_CREATEVALUEMAP_OFFSET UNITYSDK_OFFSET(0xC50AB30)
#define CLASS_2_FCA621F56128C675_METHOD_2_88BBB895DF6C5669_OFFSET UNITYSDK_OFFSET(0xC50A3E0)
#define CLASS_2_FCA621F56128C675_METHOD_2_E5A5EFB9783AE9D3_OFFSET UNITYSDK_OFFSET(0xC50A5A0)
#define CLASS_2_FCA621F56128C675__CTOR_OFFSET UNITYSDK_OFFSET(0xC50ABE0)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xC50ABF0)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEAVATARDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0xC50AC60)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEEQUIPCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC50AC70)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATETRAITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC50AC80)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEVALUECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC50AC90)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEVALUEMAP_OFFSET UNITYSDK_OFFSET(0xC50ACA0)

inline static constexpr unsigned int Class_2_FCA621F56128C675_TypeDefinitionIndex = 52867;

class Class_2_FCA621F56128C675 : public ::RPG::Client::GridFightRole_GridFightRoleBuilder
{
public:
	::RPG::Client::GridFightBattleGameContext* Field_2_1; // 0x28
	::RPG::GameCore::BattleGridFightAvatarData* Field_2_0; // 0x30
	...
	::Class_0_16E4307DCC419505_642* CreateAvatarDataProvider(::RPG::Client::GridFightRole* a1)
	{
		return ((::Class_0_16E4307DCC419505_642*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_FCA621F56128C675_CREATEAVATARDATAPROVIDER_OFFSET))(this, a1);
	}

	::Class_0_16E4307DCC419505_641* CreatePropertyProvider(::RPG::Client::GridFightRole* a1)
	{
		return ((::Class_0_16E4307DCC419505_641*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_FCA621F56128C675_CREATEPROPERTYPROVIDER_OFFSET))(this, a1);
	}
	...
	::Class_0_16E4307DCC419505_642* __iFixBaseProxy_CreateAvatarDataProvider(::RPG::Client::GridFightRole* P0)
	{
		return ((::Class_0_16E4307DCC419505_642*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEAVATARDATAPROVIDER_OFFSET))(this, P0);
	}
