...
#define NAPRENDERENTITY_ADDINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x1C98DF90)
#define NAPRENDERENTITY_ADDRENDERER_OFFSET UNITYSDK_OFFSET(0x1C98CE40)
#define NAPRENDERENTITY_APPLYSHADOWPROXYDITHERALPHAIFDIRTY_OFFSET UNITYSDK_OFFSET(0x1C98DCA0)
#define NAPRENDERENTITY_ATTACHNATIVERENDERERHANDLES_OFFSET UNITYSDK_OFFSET(0x1C97BE80)
#define NAPRENDERENTITY_BATCHEDVISIBLECHECK_OFFSET UNITYSDK_OFFSET(0x1C97FCD0)
#define NAPRENDERENTITY_BUILDINDICATEDNAPLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1C98E480)
#define NAPRENDERENTITY_CREATEMATCAPTEXTUREARRAYLEGACY_OFFSET UNITYSDK_OFFSET(0x1C987400)
#define NAPRENDERENTITY_CREATEMATCAPTEXTUREARRAYSIMPLIFY_OFFSET UNITYSDK_OFFSET(0x1C985930)
#define NAPRENDERENTITY_FINDNAPMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C98EF30)
#define NAPRENDERENTITY_GETLODPARTID_OFFSET UNITYSDK_OFFSET(0x1C98D4D0)
#define NAPRENDERENTITY_GETPEROBJECTSHADOWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1C97EF80)
#define NAPRENDERENTITY_GETPEROBJECTSHADOWRENDERER_OFFSET UNITYSDK_OFFSET(0x1C97EFC0)
#define NAPRENDERENTITY_GETRENDERERAT_OFFSET UNITYSDK_OFFSET(0x1C98ACC0)
#define NAPRENDERENTITY_GETRENDERERCOUNT_OFFSET UNITYSDK_OFFSET(0x1C98AC60)
#define NAPRENDERENTITY_GET_BAKEDOBJECTSPACECULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x1C97DC20)
#define NAPRENDERENTITY_GET_CACHEBOUNDSWHENSTAYS_OFFSET UNITYSDK_OFFSET(0x1C97DAC0)
#define NAPRENDERENTITY_GET_CACHEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C97DB20)
#define NAPRENDERENTITY_GET_CACHEDLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C97DB60)
#define NAPRENDERENTITY_GET_CLIPVERTICESUNDERCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1C97D030)
#define NAPRENDERENTITY_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1C97DAB0)
#define NAPRENDERENTITY_GET_CUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x1C97D690)
#define NAPRENDERENTITY_GET_CUSTOMLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C97E680)
#define NAPRENDERENTITY_GET_DISABLESPHERECULLING_OFFSET UNITYSDK_OFFSET(0x1C97D0E0)
#define NAPRENDERENTITY_GET_DISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x1C97DD60)
#define NAPRENDERENTITY_GET_DONTOPTIMIZESHADOWPROXYBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C97F780)
#define NAPRENDERENTITY_GET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x1C97D2E0)
#define NAPRENDERENTITY_GET_FIXEDAVATARLOD3SHADOW_OFFSET UNITYSDK_OFFSET(0x1C97F770)
#define NAPRENDERENTITY_GET_FIXRED_OFFSET UNITYSDK_OFFSET(0x1C97D6B0)
#define NAPRENDERENTITY_GET_FIXSHADOWCOVERAGEOUTOFFRUSTUM_OFFSET UNITYSDK_OFFSET(0x1C97D760)
#define NAPRENDERENTITY_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C97CD10)
#define NAPRENDERENTITY_GET_FORCEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1C97DA90)
#define NAPRENDERENTITY_GET_HASCHARACTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C97CBB0)
#define NAPRENDERENTITY_GET_HASREGULARRENDERER_OFFSET UNITYSDK_OFFSET(0x1C97C840)
#define NAPRENDERENTITY_GET_HASVALIDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C97CC60)
#define NAPRENDERENTITY_GET_HEADBONEFORWARD_OFFSET UNITYSDK_OFFSET(0x1C97D1D0)
#define NAPRENDERENTITY_GET_HEADBONEPOSITION_OFFSET UNITYSDK_OFFSET(0x1C97D1B0)
#define NAPRENDERENTITY_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C97C230)
#define NAPRENDERENTITY_GET_ISAVATARPARTICLEDIRTY_OFFSET UNITYSDK_OFFSET(0x1C97F610)
#define NAPRENDERENTITY_GET_ISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C97C8F0)
#define NAPRENDERENTITY_GET_ISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x1C97CD30)
#define NAPRENDERENTITY_GET_ISFIRSTTIMECALCULATERADIAN_OFFSET UNITYSDK_OFFSET(0x1C97F6C0)
#define NAPRENDERENTITY_GET_ISGPUCROWD_OFFSET UNITYSDK_OFFSET(0x1C97CBA0)
#define NAPRENDERENTITY_GET_ISNAPCBBOUND_OFFSET UNITYSDK_OFFSET(0x1C97CF70)
#define NAPRENDERENTITY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C97F420)
#define NAPRENDERENTITY_GET_ISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1C97C4E0)
#define NAPRENDERENTITY_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C97C790)
#define NAPRENDERENTITY_GET_LASTFRAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x1C97DAE0)
#define NAPRENDERENTITY_GET_LIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C97DC40)
#define NAPRENDERENTITY_GET_LODGROUPS_OFFSET UNITYSDK_OFFSET(0x1C97D1F0)
#define NAPRENDERENTITY_GET_MAINLIGHTPARAMSOVERRIDEN_OFFSET UNITYSDK_OFFSET(0x1C97D210)
#define NAPRENDERENTITY_GET_MIDDLEPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1C97D190)
#define NAPRENDERENTITY_GET_NAPCBUFFER_OFFSET UNITYSDK_OFFSET(0x1C97D020)
#define NAPRENDERENTITY_GET_OFFSETFORRENDERING_OFFSET UNITYSDK_OFFSET(0x1C97DD40)
#define NAPRENDERENTITY_GET_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x1C97BB30)
#define NAPRENDERENTITY_GET_OVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1C97D2C0)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWALPHA_OFFSET UNITYSDK_OFFSET(0x1C97DBC0)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWCULLRESULT_OFFSET UNITYSDK_OFFSET(0x1C97DBA0)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWFADETARGET_OFFSET UNITYSDK_OFFSET(0x1C97DBE0)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWRESOLVEALPHA_OFFSET UNITYSDK_OFFSET(0x1C97DD80)
#define NAPRENDERENTITY_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1C97BB70)
#define NAPRENDERENTITY_GET_RAYCASTFORCULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x1C97DAA0)
#define NAPRENDERENTITY_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x1C97BB50)
#define NAPRENDERENTITY_GET_SHADERUNIFORMPEROBJECTSHADOWDATA_OFFSET UNITYSDK_OFFSET(0x1C97F040)
#define NAPRENDERENTITY_GET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C97BFE0)
#define NAPRENDERENTITY_GET_USEBAKEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C97DC00)
#define NAPRENDERENTITY_GET_USECUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x1C97D5E0)
#define NAPRENDERENTITY_GET_USECUSTOMLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C97E500)
#define NAPRENDERENTITY_GET_USEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1C97D810)
#define NAPRENDERENTITY_GET_XAXIS_OFFSET UNITYSDK_OFFSET(0x1C97DC80)
#define NAPRENDERENTITY_GET_YAXIS_OFFSET UNITYSDK_OFFSET(0x1C97DCC0)
#define NAPRENDERENTITY_GET_ZAXIS_OFFSET UNITYSDK_OFFSET(0x1C97DD00)
#define NAPRENDERENTITY_GET_ZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x1C97C000)
#define NAPRENDERENTITY_HASFLAG_OFFSET UNITYSDK_OFFSET(0x1C9825A0)
#define NAPRENDERENTITY_ISRENDERERCHANGED_OFFSET UNITYSDK_OFFSET(0x1C98CC10)
#define NAPRENDERENTITY_LEGACYVISIBLECHECK_OFFSET UNITYSDK_OFFSET(0x1C97FDA0)
#define NAPRENDERENTITY_MATCAPTEXTURECHECKRESULT_OFFSET UNITYSDK_OFFSET(0x1C98A710)
#define NAPRENDERENTITY_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x1C98AD40)
#define NAPRENDERENTITY_OVERRIDEMAINLIGHTPARAMS_OFFSET UNITYSDK_OFFSET(0x1C98EAA0)
#define NAPRENDERENTITY_PUSHBONETRANSFORMSTONATIVE_OFFSET UNITYSDK_OFFSET(0x1C9823F0)
#define NAPRENDERENTITY_REFRESHMATCAPDATA_OFFSET UNITYSDK_OFFSET(0x1C98D2E0)
#define NAPRENDERENTITY_REFRESHMATCAPVECTORARRAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C98F570)
#define NAPRENDERENTITY_REFRESHSTATEPERFRAME_OFFSET UNITYSDK_OFFSET(0x1C97FF10)
#define NAPRENDERENTITY_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C98BA80)
#define NAPRENDERENTITY_RELEASEMATCAPTEXTUREARRAY_OFFSET UNITYSDK_OFFSET(0x1C98A4D0)
#define NAPRENDERENTITY_RELEASETEXTUREARRAYLIST_OFFSET UNITYSDK_OFFSET(0x1C98A290)
#define NAPRENDERENTITY_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C98AE40)
#define NAPRENDERENTITY_REMOVEINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x1C98E8D0)
#define NAPRENDERENTITY_REMOVERENDERER_OFFSET UNITYSDK_OFFSET(0x1C98D090)
#define NAPRENDERENTITY_RESET_OFFSET UNITYSDK_OFFSET(0x1C98AEB0)
#define NAPRENDERENTITY_REVERTOVERRIDENMAINLIGHTPARAMS_OFFSET UNITYSDK_OFFSET(0x1C98ED00)
#define NAPRENDERENTITY_SETFLAG_OFFSET UNITYSDK_OFFSET(0x1C9825F0)
#define NAPRENDERENTITY_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x1C98DE00)
#define NAPRENDERENTITY_SETSHADOWDATABLOCK_OFFSET UNITYSDK_OFFSET(0x1C97E0B0)
#define NAPRENDERENTITY_SETSHADOWLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1C97E8C0)
#define NAPRENDERENTITY_SETSHADOWPROXYDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x1C98D850)
#define NAPRENDERENTITY_SETTRANSFORMGETTERS_OFFSET UNITYSDK_OFFSET(0x1C98D470)
#define NAPRENDERENTITY_SETUP_OFFSET UNITYSDK_OFFSET(0x1C982840)
#define NAPRENDERENTITY_SET_BAKEDOBJECTSPACECULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x1C97DC30)
#define NAPRENDERENTITY_SET_CACHEBOUNDSWHENSTAYS_OFFSET UNITYSDK_OFFSET(0x1C97DAD0)
#define NAPRENDERENTITY_SET_CACHEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C97DB40)
#define NAPRENDERENTITY_SET_CACHEDLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C97DB80)
#define NAPRENDERENTITY_SET_CLIPVERTICESUNDERCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1C97D080)
#define NAPRENDERENTITY_SET_CUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x1C97D6A0)
#define NAPRENDERENTITY_SET_DISABLESPHERECULLING_OFFSET UNITYSDK_OFFSET(0x1C97D130)
#define NAPRENDERENTITY_SET_DISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x1C97DD70)
#define NAPRENDERENTITY_SET_DONTOPTIMIZESHADOWPROXYBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C97F790)
#define NAPRENDERENTITY_SET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x1C97D350)
#define NAPRENDERENTITY_SET_FIXRED_OFFSET UNITYSDK_OFFSET(0x1C97D700)
#define NAPRENDERENTITY_SET_FIXSHADOWCOVERAGEOUTOFFRUSTUM_OFFSET UNITYSDK_OFFSET(0x1C97D7B0)
#define NAPRENDERENTITY_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C97CD20)
#define NAPRENDERENTITY_SET_HASCHARACTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C97CC00)
#define NAPRENDERENTITY_SET_HASREGULARRENDERER_OFFSET UNITYSDK_OFFSET(0x1C97C890)
#define NAPRENDERENTITY_SET_HASVALIDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C97CCB0)
#define NAPRENDERENTITY_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C97C480)
#define NAPRENDERENTITY_SET_ISAVATARPARTICLEDIRTY_OFFSET UNITYSDK_OFFSET(0x1C97F660)
#define NAPRENDERENTITY_SET_ISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C97CB40)
#define NAPRENDERENTITY_SET_ISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x1C97CD40)
#define NAPRENDERENTITY_SET_ISFIRSTTIMECALCULATERADIAN_OFFSET UNITYSDK_OFFSET(0x1C97F710)
#define NAPRENDERENTITY_SET_ISNAPCBBOUND_OFFSET UNITYSDK_OFFSET(0x1C97CFC0)
#define NAPRENDERENTITY_SET_ISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1C97C730)
#define NAPRENDERENTITY_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C97C7E0)
#define NAPRENDERENTITY_SET_LASTFRAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x1C97DB00)
#define NAPRENDERENTITY_SET_LIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C97DC60)
#define NAPRENDERENTITY_SET_LODGROUPS_OFFSET UNITYSDK_OFFSET(0x1C97D200)
#define NAPRENDERENTITY_SET_MAINLIGHTPARAMSOVERRIDEN_OFFSET UNITYSDK_OFFSET(0x1C97D260)
#define NAPRENDERENTITY_SET_OFFSETFORRENDERING_OFFSET UNITYSDK_OFFSET(0x1C97DD50)
#define NAPRENDERENTITY_SET_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x1C97BB40)
#define NAPRENDERENTITY_SET_OVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1C97D2D0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWALPHA_OFFSET UNITYSDK_OFFSET(0x1C97DBD0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWCULLRESULT_OFFSET UNITYSDK_OFFSET(0x1C97DBB0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWFADETARGET_OFFSET UNITYSDK_OFFSET(0x1C97DBF0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWRESOLVEALPHA_OFFSET UNITYSDK_OFFSET(0x1C97DF10)
#define NAPRENDERENTITY_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1C97BB80)
#define NAPRENDERENTITY_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x1C97BB60)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWDATA_OFFSET UNITYSDK_OFFSET(0x1C97F0B0)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWRESOLVEST_OFFSET UNITYSDK_OFFSET(0x1C97F3B0)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWUVMATRIX_OFFSET UNITYSDK_OFFSET(0x1C97F1E0)
#define NAPRENDERENTITY_SET_SHADERUNIFORMRECEIVESHADOW_OFFSET UNITYSDK_OFFSET(0x1C97F120)
#define NAPRENDERENTITY_SET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C97BFF0)
#define NAPRENDERENTITY_SET_USEBAKEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C97DC10)
#define NAPRENDERENTITY_SET_USECUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x1C97D630)
#define NAPRENDERENTITY_SET_USEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1C97D860)
#define NAPRENDERENTITY_SET_XAXIS_OFFSET UNITYSDK_OFFSET(0x1C97DCA0)
#define NAPRENDERENTITY_SET_YAXIS_OFFSET UNITYSDK_OFFSET(0x1C97DCE0)
#define NAPRENDERENTITY_SET_ZAXIS_OFFSET UNITYSDK_OFFSET(0x1C97DD20)
#define NAPRENDERENTITY_SET_ZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x1C97C220)
#define NAPRENDERENTITY_UPDATEBONETRANSFORMSFORFRAME_OFFSET UNITYSDK_OFFSET(0x1C980F50)
#define NAPRENDERENTITY_UPDATEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1C97F7A0)
#define NAPRENDERENTITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C98F830)
#define NAPRENDERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C97EB20)

inline static constexpr unsigned int NapRenderEntity_TypeDefinitionIndex = 27220;
...
public:
	...
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23060);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CountMaterials()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23068);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CopyTexture()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23070);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitPropertyMode()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23078);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectMapCapInfo()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23080);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CalculateCameraVisibility()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23088);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTexture()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23090);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Part2()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23098);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_UpdateRamp()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230A0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_UpdateDistanceToCamera()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230A8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectBounds()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230B0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_SetShadowProxyAlphas()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230B8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_ApplyMaterialProperties()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230C0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Release()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230C8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Setup()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230D0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsFromJob()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230D8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_RefreshStatePerFrame()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230E0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_LayerAndFrustumCulling()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230E8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitLodGroup1()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230F0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CharacterGI()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x230F8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_SetFlags()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23100);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectRenderingLayer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23108);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CalculateCullingSphere()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23110);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitMaterialParticleArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23118);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectFaceRendererNotSkinned()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23120);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CheckMaterialValid()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23128);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsCommon()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23130);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitNapRenderer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23138);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CheckMatCapEnabled()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23140);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CreateMatCapTextureArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23148);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransforms()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23150);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsFromFunc()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23158);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetHeadBoneTransform()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23160);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitMatCapIDArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23168);
	}
	static ::System::Collections::Generic::List_1<::NapRenderEntity_MatCapInfo>** StaticGet_matCapInfos()
	{
		return (::System::Collections::Generic::List_1<::NapRenderEntity_MatCapInfo>**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23170);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitLodGroup2()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23178);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CreateTextureArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23180);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectLayer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23188);
	}
	...
	::System::Boolean disableLightBlendShadowTemporalFade; // 0x178
	::PerObjectShadowContext context; // 0x17C
	::System::Boolean _CacheBoundsWhenStays_k__BackingField; // 0x1C8
	::UnityEngine::Vector3 _LastFramePosition_k__BackingField; // 0x1CC
	::UnityEngine::Bounds _CachedBounds_k__BackingField; // 0x1D8
	::UnityEngine::Vector3 _CachedLightDirection_k__BackingField; // 0x1F0
	::PerObjectShadowCullResult _PerObjectShadowCullResult_k__BackingField; // 0x1FC
	::System::Single _PerObjectShadowAlpha_k__BackingField; // 0x200
	::System::Int32 _PerObjectShadowFadeTarget_k__BackingField; // 0x204
	::System::Boolean _UseBakedBounds_k__BackingField; // 0x208
	::UnityEngine::Vector4 _BakedObjectSpaceCullingSphere_k__BackingField; // 0x20C
	::UnityEngine::Vector3 _LightDirection_k__BackingField; // 0x21C
	::UnityEngine::Vector3 _xAxis_k__BackingField; // 0x228
	::UnityEngine::Vector3 _yAxis_k__BackingField; // 0x234
	::UnityEngine::Vector3 _zAxis_k__BackingField; // 0x240
	::UnityEngine::Vector4 _OffsetForRendering_k__BackingField; // 0x24C
	::UnityEngine::Vector3 m_CachedCustomLightDirection; // 0x25C
	::UnityEngine::Vector3 m_CachedXAxis; // 0x268
	::UnityEngine::Vector3 m_CachedYAxis; // 0x274
	::UnityEngine::Vector3 m_CachedZAxis; // 0x280
	::System::Single _DistanceToCamera_k__BackingField; // 0x28C
	::System::Boolean isActuallyDistanceCulled; // 0x290
	::System::Int32 EntityID; // 0x294
	...
	::System::Boolean fixedAvatarLod3Shadow; // 0x2E9
	::System::Boolean _DontOptimizeShadowProxyBounds_k__BackingField; // 0x2EA
	...
	{
		return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + NAPRENDERENTITY_GET_FIXEDAVATARLOD3SHADOW_OFFSET))(this);
	}
