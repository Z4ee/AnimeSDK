...
#define CLASS_3_5C01DB3813C27EF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1788EAD0)
#define CLASS_3_5C01DB3813C27EF2__CTOR_OFFSET UNITYSDK_OFFSET(0x1788E830)
#define CLASS_3_5C01DB3813C27EF2__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x1788EB30)
#define CLASS_3_5C01DB3813C27EF2__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1788EBB0)
#define CLASS_3_5C01DB3813C27EF2__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1788ED40)
