...
#define CLASS_2_D32AFEEE164C6B3D_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x122ECCA0)
#define CLASS_2_D32AFEEE164C6B3D_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x122ECBF0)
#define CLASS_2_D32AFEEE164C6B3D__CTOR_OFFSET UNITYSDK_OFFSET(0x122ECC00)

inline static constexpr unsigned int Class_2_D32AFEEE164C6B3D_TypeDefinitionIndex = 44904;
