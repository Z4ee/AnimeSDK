...
#define CLASS_2_D32AFEEE164C6B3D_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x134544C0)
#define CLASS_2_D32AFEEE164C6B3D_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x13454410)
#define CLASS_2_D32AFEEE164C6B3D__CTOR_OFFSET UNITYSDK_OFFSET(0x13454420)

inline static constexpr unsigned int Class_2_D32AFEEE164C6B3D_TypeDefinitionIndex = 72848;
