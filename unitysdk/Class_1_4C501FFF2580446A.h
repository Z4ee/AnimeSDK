...
#define CLASS_1_4C501FFF2580446A_METHOD_1_0EB17942EB1D8738_OFFSET UNITYSDK_OFFSET(0x17AB8CC0)
#define CLASS_1_4C501FFF2580446A_METHOD_1_272D8737716D5C99_1_OFFSET UNITYSDK_OFFSET(0x17AB8C70)
#define CLASS_1_4C501FFF2580446A_METHOD_1_272D8737716D5C99_2_OFFSET UNITYSDK_OFFSET(0x17AB8E60)
#define CLASS_1_4C501FFF2580446A_METHOD_1_272D8737716D5C99_OFFSET UNITYSDK_OFFSET(0x17AB9D70)
#define CLASS_1_4C501FFF2580446A_METHOD_1_3167F8AC2BACD9E1_OFFSET UNITYSDK_OFFSET(0x17AB8BA0)
#define CLASS_1_4C501FFF2580446A_METHOD_1_3CF43707BF2E9BBA_OFFSET UNITYSDK_OFFSET(0x17AB9060)
#define CLASS_1_4C501FFF2580446A_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17AB92C0)
#define CLASS_1_4C501FFF2580446A_METHOD_1_43BE3EFC78731B2A_OFFSET UNITYSDK_OFFSET(0x17AB9C90)
#define CLASS_1_4C501FFF2580446A_METHOD_1_4BCD51618C77AD95_OFFSET UNITYSDK_OFFSET(0x17AB9C00)
#define CLASS_1_4C501FFF2580446A_METHOD_1_5CEC4607322705E5_OFFSET UNITYSDK_OFFSET(0x17AB9D20)
#define CLASS_1_4C501FFF2580446A_METHOD_1_ACB515D94CF05080_OFFSET UNITYSDK_OFFSET(0x17AB9320)
#define CLASS_1_4C501FFF2580446A_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x17AB9230)
#define CLASS_1_4C501FFF2580446A_METHOD_1_B677D18EEB4764D3_OFFSET UNITYSDK_OFFSET(0x17AB8D70)
#define CLASS_1_4C501FFF2580446A_METHOD_1_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x17AB91C0)
#define CLASS_1_4C501FFF2580446A_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17AB9170)
#define CLASS_1_4C501FFF2580446A_METHOD_1_F8DF29599F19AAC4_OFFSET UNITYSDK_OFFSET(0x17AB8EB0)
#define CLASS_1_4C501FFF2580446A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17AB8AA0)
#define CLASS_1_4C501FFF2580446A__CTOR_OFFSET UNITYSDK_OFFSET(0x17AB89C0)

inline static constexpr unsigned int Class_1_4C501FFF2580446A_TypeDefinitionIndex = 57962;

class Class_1_4C501FFF2580446A : public ::System::Object
{
public:
	::System::Collections::Generic::LinkedList_1<::RPG::GameCore::GameEntity*>* JBIPKAENAMO; // 0x10
	::System::Collections::Generic::HashSet_1<::System::Collections::Generic::LinkedListNode_1<::RPG::GameCore::GameEntity*>*>* GIPEEJCLACO; // 0x18
	::System::Collections::Generic::LinkedList_1<::RPG::GameCore::GameEntity*>* GLFCGDLDLCO; // 0x20
	::System::Collections::Generic::LinkedListNode_1<::RPG::GameCore::GameEntity*>* LMCCPIDGDBC; // 0x28
	::System::UInt32 OLEIDKBKEOE; // 0x30
	::System::UInt32 BDKNDKADDOD; // 0x34
	::System::UInt32 EKACELHACDK; // 0x38
	::System::Boolean JFECBEOOFCH; // 0x3C
