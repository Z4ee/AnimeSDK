...
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRFLOAT_OFFSET UNITYSDK_OFFSET(0x10C1ADF0)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRINT_OFFSET UNITYSDK_OFFSET(0x10C1AE00)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWSTATTYPE_OFFSET UNITYSDK_OFFSET(0x10C1ADA0)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10C1AE50)

inline static constexpr unsigned int HipplenBuilderBuffAsset_BuffElementConfig_TypeDefinitionIndex = 38135;
