...
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRFLOAT_OFFSET UNITYSDK_OFFSET(0x11DFD5F0)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRINT_OFFSET UNITYSDK_OFFSET(0x11DFD600)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWSTATTYPE_OFFSET UNITYSDK_OFFSET(0x11DFD5A0)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11DFD650)

inline static constexpr unsigned int HipplenBuilderBuffAsset_BuffElementConfig_TypeDefinitionIndex = 44019;
