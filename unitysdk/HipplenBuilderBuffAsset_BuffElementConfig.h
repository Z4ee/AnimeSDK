...
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRFLOAT_OFFSET UNITYSDK_OFFSET(0x17A5BF30)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRINT_OFFSET UNITYSDK_OFFSET(0x17A5BF80)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWSTATTYPE_OFFSET UNITYSDK_OFFSET(0x17A5BEE0)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17A5BFD0)

inline static constexpr unsigned int HipplenBuilderBuffAsset_BuffElementConfig_TypeDefinitionIndex = 45437;
