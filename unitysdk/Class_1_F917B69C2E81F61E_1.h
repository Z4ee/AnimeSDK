...
#define CLASS_1_F917B69C2E81F61E_1_GET_BATTLEEVENTSPECIALMARKSTATE_OFFSET UNITYSDK_OFFSET(0x1875D910)
#define CLASS_1_F917B69C2E81F61E_1_GET_ID_OFFSET UNITYSDK_OFFSET(0x1875D8D0)
#define CLASS_1_F917B69C2E81F61E_1_GET_SPECIALMARKSTATE_OFFSET UNITYSDK_OFFSET(0x1875D8F0)
#define CLASS_1_F917B69C2E81F61E_1_SET_BATTLEEVENTSPECIALMARKSTATE_OFFSET UNITYSDK_OFFSET(0x1875D920)
#define CLASS_1_F917B69C2E81F61E_1_SET_ID_OFFSET UNITYSDK_OFFSET(0x1875D8E0)
#define CLASS_1_F917B69C2E81F61E_1_SET_SPECIALMARKSTATE_OFFSET UNITYSDK_OFFSET(0x1875D900)
#define CLASS_1_F917B69C2E81F61E_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1875D930)

inline static constexpr unsigned int Class_1_F917B69C2E81F61E_1_TypeDefinitionIndex = 76051;

class Class_1_F917B69C2E81F61E_1 : public ::System::Object
{
public:
	::Class_1_FA3DCD5934CBE599* _SpecialMarkState_k__BackingField; // 0x10
	::Class_1_FA3DCD5934CBE599* _BattleEventSpecialMarkState_k__BackingField; // 0x18
