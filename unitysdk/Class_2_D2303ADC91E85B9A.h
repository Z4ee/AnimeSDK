...
#define CLASS_2_D2303ADC91E85B9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B1B110)
#define CLASS_2_D2303ADC91E85B9A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18B1B150)
#define CLASS_2_D2303ADC91E85B9A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18B1B4E0)
#define CLASS_2_D2303ADC91E85B9A_TICK_OFFSET UNITYSDK_OFFSET(0x18B1B530)
#define CLASS_2_D2303ADC91E85B9A__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1B100)

inline static constexpr unsigned int Class_2_D2303ADC91E85B9A_TypeDefinitionIndex = 53881;

class Class_2_D2303ADC91E85B9A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SetMonsterStanceVulnerable* Field_2_1; // 0x20
