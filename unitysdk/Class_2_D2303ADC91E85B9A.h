...
#define CLASS_2_D2303ADC91E85B9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x160D1470)
#define CLASS_2_D2303ADC91E85B9A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x160D14B0)
#define CLASS_2_D2303ADC91E85B9A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x160D1840)
#define CLASS_2_D2303ADC91E85B9A_TICK_OFFSET UNITYSDK_OFFSET(0x160D1890)
#define CLASS_2_D2303ADC91E85B9A__CTOR_OFFSET UNITYSDK_OFFSET(0x160D1460)

inline static constexpr unsigned int Class_2_D2303ADC91E85B9A_TypeDefinitionIndex = 56601;

class Class_2_D2303ADC91E85B9A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetMonsterStanceVulnerable* OFKGLJOAMLD; // 0x18
