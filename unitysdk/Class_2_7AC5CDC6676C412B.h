...
#define CLASS_2_7AC5CDC6676C412B_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB897970)
#define CLASS_2_7AC5CDC6676C412B_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB897EE0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB897260)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_2377E17936196E10_OFFSET UNITYSDK_OFFSET(0xB895E60)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0xB895830)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xB290BC0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xB8986A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB8985D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_62D8D456C60B1D9D_OFFSET UNITYSDK_OFFSET(0xB895EF0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67AEFE17318883D4_OFFSET UNITYSDK_OFFSET(0xB2911D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xB896340)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_87A84693C939DE46_OFFSET UNITYSDK_OFFSET(0xB896430)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_88BEF7B7499FDBAA_OFFSET UNITYSDK_OFFSET(0xB8953A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_99C9EEE541D93457_OFFSET UNITYSDK_OFFSET(0xB895200)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xB897510)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xB897620)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0xB897730)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0xB897910)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xB8972C0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xB896390)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B2D0C393C5A33FA5_OFFSET UNITYSDK_OFFSET(0xB895300)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0xB8962D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_1_OFFSET UNITYSDK_OFFSET(0xB897840)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0xB8973B0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C3FA16B393076D2B_OFFSET UNITYSDK_OFFSET(0xB895DD0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0xB896D00)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CF8551534BA217CC_OFFSET UNITYSDK_OFFSET(0xB290E20)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DAFD4F26397DCF6C_OFFSET UNITYSDK_OFFSET(0xB8957A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DD152A1A30757DCD_OFFSET UNITYSDK_OFFSET(0xB290DB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DFB53B789DEB4FB5_OFFSET UNITYSDK_OFFSET(0xB291240)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F49AADE07313BF76_OFFSET UNITYSDK_OFFSET(0xB897190)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0xB290D50)
#define CLASS_2_7AC5CDC6676C412B__CTOR_OFFSET UNITYSDK_OFFSET(0xB898420)
#define CLASS_2_7AC5CDC6676C412B__ONBIND_OFFSET UNITYSDK_OFFSET(0xB290A90)
#define CLASS_2_7AC5CDC6676C412B__ONTICK_OFFSET UNITYSDK_OFFSET(0xB290CE0)
#define CLASS_2_7AC5CDC6676C412B__PLAYFADE_B__8_0_OFFSET UNITYSDK_OFFSET(0xB898530)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB898700)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB898760)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xB898570)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0xB898630)

inline static constexpr unsigned int Class_2_7AC5CDC6676C412B_TypeDefinitionIndex = 58694;
...
public:
	...
	::Class_1_23F67DD15593C8D6* Field_2_6; // 0x60
	...
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::GameEntity*>* Field_2_3; // 0x88
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_842*>* Field_2_2; // 0x90
