...
#define CLASS_2_0007C788FCAA0AB9_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C623420)
#define CLASS_2_0007C788FCAA0AB9__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6234A0)
...
{
public:
	::UnityEngine::Vector3 EBDGPICAGAC; // 0x338
	::System::Boolean AOEBHLBJIOP; // 0x344
	::System::Single KIPAGNCANAJ; // 0x348
