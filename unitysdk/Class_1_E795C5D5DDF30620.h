...
#define CLASS_1_E795C5D5DDF30620_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x14DFFD40)
#define CLASS_1_E795C5D5DDF30620_FROMFLX_OFFSET UNITYSDK_OFFSET(0x14E003B0)
#define CLASS_1_E795C5D5DDF30620_METHOD_1_0578713EDB32B89E_OFFSET UNITYSDK_OFFSET(0x14E00430)
#define CLASS_1_E795C5D5DDF30620_METHOD_1_6A03C0134352525C_OFFSET UNITYSDK_OFFSET(0x14DFFDA0)
#define CLASS_1_E795C5D5DDF30620__CTOR_OFFSET UNITYSDK_OFFSET(0x14E01A80)

inline static constexpr unsigned int Class_1_E795C5D5DDF30620_TypeDefinitionIndex = 40845;
...
public:
	...
	::MoleMole::Config::DynamicInt* Field_1_7; // 0x30
	::MoleMole::Config::DynamicFloat* Field_1_8; // 0x38
	::MoleMole::Config::DynamicFloat* Field_1_10; // 0x40
	::MoleMole::Config::DynamicFloat* Field_1_4; // 0x48
	::MoleMole::Config::DynamicFloat* Field_1_9; // 0x50
	::MoleMole::Config::DynamicFloat* Field_1_5; // 0x58
	::MoleMole::Config::DynamicFloat* Field_1_11; // 0x60
	::UnityEngine::Vector3 Field_1_14; // 0x68
	::UnityEngine::Vector3 Field_1_15; // 0x74
	::Enum_3_F40B865AC61AB8D7 Field_1_2; // 0x80
