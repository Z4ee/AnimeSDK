...
#define CLASS_3_EED208C55D4DEECC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11121C20)
#define CLASS_3_EED208C55D4DEECC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11121C60)
#define CLASS_3_EED208C55D4DEECC__CTOR_OFFSET UNITYSDK_OFFSET(0x11121BF0)
#define CLASS_3_EED208C55D4DEECC___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11121EA0)

inline static constexpr unsigned int Class_3_EED208C55D4DEECC_TypeDefinitionIndex = 47272;
