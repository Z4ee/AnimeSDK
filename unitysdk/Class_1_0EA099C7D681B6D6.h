...
#define CLASS_1_0EA099C7D681B6D6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BA99180)
#define CLASS_1_0EA099C7D681B6D6_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1BA99340)
#define CLASS_1_0EA099C7D681B6D6_METHOD_1_1B9A06AC7EA63500_OFFSET UNITYSDK_OFFSET(0x1BA991C0)
#define CLASS_1_0EA099C7D681B6D6__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA99160)

inline static constexpr unsigned int Class_1_0EA099C7D681B6D6_TypeDefinitionIndex = 41153;

class Class_1_0EA099C7D681B6D6 : public ::System::Object
{
public:
	::Class_2_037EA204E69EBC75* KAKEIDJDNHJ; // 0x10
	::UnityEngine::Vector3 JLALCNPLAPK; // 0x18
