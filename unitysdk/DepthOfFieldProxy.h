...
#define DEPTHOFFIELDPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x12244EC0)
#define DEPTHOFFIELDPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x12245290)
#define DEPTHOFFIELDPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x12245570)
#define DEPTHOFFIELDPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x12245520)
#define DEPTHOFFIELDPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x12245A30)

inline static constexpr unsigned int DepthOfFieldProxy_TypeDefinitionIndex = 70941;
