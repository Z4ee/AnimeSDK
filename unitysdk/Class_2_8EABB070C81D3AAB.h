...
#define CLASS_2_8EABB070C81D3AAB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14C738C0)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_0AB236E3B5B91774_OFFSET UNITYSDK_OFFSET(0x14C73DE0)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_0F6CD6FCE9685131_1_OFFSET UNITYSDK_OFFSET(0x14C75810)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_0F6CD6FCE9685131_OFFSET UNITYSDK_OFFSET(0x14C75C50)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x14C75E70)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_24CC767C63894B07_OFFSET UNITYSDK_OFFSET(0x14C75A30)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_3C37862761792B91_OFFSET UNITYSDK_OFFSET(0x14C769C0)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0x14C74940)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_5F562E77E2FF7144_OFFSET UNITYSDK_OFFSET(0x14C753E0)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0x14C739E0)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_8C1368A1D9B7F039_OFFSET UNITYSDK_OFFSET(0x14C76580)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_94B4A610E9A9ECF3_OFFSET UNITYSDK_OFFSET(0x14C75650)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_AF17EFF0227C3930_OFFSET UNITYSDK_OFFSET(0x14C76760)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_B85DEA4F5EB0F12F_OFFSET UNITYSDK_OFFSET(0x14C75250)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_E5FB76C2AFA3092D_OFFSET UNITYSDK_OFFSET(0x14C73CE0)
#define CLASS_2_8EABB070C81D3AAB_METHOD_2_FF7D42127627E96E_OFFSET UNITYSDK_OFFSET(0x14C762F0)
#define CLASS_2_8EABB070C81D3AAB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14C73A30)
#define CLASS_2_8EABB070C81D3AAB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14C74570)
#define CLASS_2_8EABB070C81D3AAB_TICK_OFFSET UNITYSDK_OFFSET(0x14C74610)
#define CLASS_2_8EABB070C81D3AAB__CTOR_OFFSET UNITYSDK_OFFSET(0x14C738B0)
...
{
public:
	::RPG::GameCore::ShowGuideHintWithText* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_1_F3391C70DC37088D* NNFJKIPMAAI; // 0x28
	::Class_0_16E4307DCC419505_638* EIFGEIFAGNM; // 0x30
	::Class_1_BAD2D343EF0045A3* EMCDEOIEFEA; // 0x38
	::Class_1_B407606E338E5818* GNEFMGHCILF; // 0x40
	::System::Collections::Generic::IList_1<::System::String*>* EGINIHPMDGE; // 0x48
