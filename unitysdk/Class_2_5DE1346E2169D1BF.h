...
#define CLASS_2_5DE1346E2169D1BF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B51D00)
#define CLASS_2_5DE1346E2169D1BF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19B51D50)
#define CLASS_2_5DE1346E2169D1BF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19B51FE0)
#define CLASS_2_5DE1346E2169D1BF_TICK_OFFSET UNITYSDK_OFFSET(0x19B52030)
#define CLASS_2_5DE1346E2169D1BF__CTOR_OFFSET UNITYSDK_OFFSET(0x19B51CF0)

inline static constexpr unsigned int Class_2_5DE1346E2169D1BF_TypeDefinitionIndex = 58527;

class Class_2_5DE1346E2169D1BF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ReleaseCacheUI* OFKGLJOAMLD; // 0x18
