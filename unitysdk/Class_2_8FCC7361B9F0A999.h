...
#define CLASS_2_8FCC7361B9F0A999_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x15989D70)
#define CLASS_2_8FCC7361B9F0A999_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x15989F30)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_2CD6D17D088D5DB9_OFFSET UNITYSDK_OFFSET(0x15988860)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_3ADBDAC4E19C46FF_OFFSET UNITYSDK_OFFSET(0x159890B0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0x15988780)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_4E42C1D03BBB9919_OFFSET UNITYSDK_OFFSET(0x15988D30)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x159892C0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_7D21D8548943D577_OFFSET UNITYSDK_OFFSET(0x15988600)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_8AAA870BDF6CE134_OFFSET UNITYSDK_OFFSET(0x159894E0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x159884F0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_936E7DFACB32E87B_OFFSET UNITYSDK_OFFSET(0x15988A20)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15988CC0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_98CD8BF64F5D1A46_OFFSET UNITYSDK_OFFSET(0x15988EA0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x15988960)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_A0CFDB5F5B1DB2D6_OFFSET UNITYSDK_OFFSET(0x159891A0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x159893C0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0x15989C30)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_BB9510FC835F0664_OFFSET UNITYSDK_OFFSET(0x15989680)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_D7411E5DB745D614_OFFSET UNITYSDK_OFFSET(0x15989810)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_E0C22160558909B0_OFFSET UNITYSDK_OFFSET(0x15989020)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_E8AE7970E4E0CA8B_OFFSET UNITYSDK_OFFSET(0x15989760)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_EDA494CF8BB29EBF_OFFSET UNITYSDK_OFFSET(0x159898E0)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0x15988720)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x15989A10)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x15989B70)
#define CLASS_2_8FCC7361B9F0A999_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x15989950)
#define CLASS_2_8FCC7361B9F0A999_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x15988560)
#define CLASS_2_8FCC7361B9F0A999_ONRETURN_OFFSET UNITYSDK_OFFSET(0x15988690)
#define CLASS_2_8FCC7361B9F0A999__CCTOR_OFFSET UNITYSDK_OFFSET(0x1598A110)
#define CLASS_2_8FCC7361B9F0A999__CTOR_OFFSET UNITYSDK_OFFSET(0x1598A0D0)
#define CLASS_2_8FCC7361B9F0A999__ONBIND_OFFSET UNITYSDK_OFFSET(0x159881F0)
#define CLASS_2_8FCC7361B9F0A999___ONBIND_B__0_0_OFFSET UNITYSDK_OFFSET(0x1598A180)

inline static constexpr unsigned int Class_2_8FCC7361B9F0A999_TypeDefinitionIndex = 71363;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_8FCC7361B9F0A999_TypeDefinitionIndex)->GetStaticField(0x11D90);
	}
	static ::System::Int32* StaticGet_FFEPLIHOFLA()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_8FCC7361B9F0A999_TypeDefinitionIndex)->GetStaticField(0x11D94);
	}
	...
	::RPG::Client::LocalizedText* AACBDGMIDEN; // 0x78
	::UnityEngine::UI::Image* PPJDHFKIMNH; // 0x80
	::UnityEngine::ParticleSystem* EGBLBGBNJHM; // 0x88
	::UnityEngine::Animator* CFNGLMDMENE; // 0x90
	::UnityEngine::UI::Image* BOCHOANELAE; // 0x98
	::RPG::Client::LocalizedText* FLEDFEBIHEN; // 0xA0
	::UnityEngine::UI::Image* EAKFBADKHII; // 0xA8
	::Class_2_7B1C7CBB7B4FF79A* JMFMANFANAH; // 0xB0
	::UnityEngine::Transform* ECLMJGKIMJO; // 0xB8
	...
	::System::Int32 CIDELCPIDHH; // 0xD8
	::System::Int32 BFLNNOEKIGE; // 0xDC
	::System::Boolean CDFHJPKKEEE; // 0xE0
	::System::Boolean EPCCCGMNGLO; // 0xE1
	::Class_2_8FCC7361B9F0A999_CounterType IIAFMBKHOHL; // 0xE4
	::RPG::GameCore::EnergyBarState LODNGAGNLCB; // 0xE8
