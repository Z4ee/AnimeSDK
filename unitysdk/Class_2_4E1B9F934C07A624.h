...
#define CLASS_2_4E1B9F934C07A624_GET_HITADDITIVELAYERINDEX_OFFSET UNITYSDK_OFFSET(0x15A4ABE0)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_5127424BDC5529D7_OFFSET UNITYSDK_OFFSET(0x15A4A960)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0x15A49B50)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0x15A4A7F0)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_B45DC2E8B8DF29CA_OFFSET UNITYSDK_OFFSET(0x15A49F80)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_BAD16C0582DF65F4_OFFSET UNITYSDK_OFFSET(0x15A4A050)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15A4A920)
#define CLASS_2_4E1B9F934C07A624_METHOD_2_EBAB6A35C21A2A5B_OFFSET UNITYSDK_OFFSET(0x15A49D30)
#define CLASS_2_4E1B9F934C07A624_ONANIMATORCHANGE_OFFSET UNITYSDK_OFFSET(0x15A4AB10)
#define CLASS_2_4E1B9F934C07A624_ONFLAGSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x15A4A9C0)
#define CLASS_2_4E1B9F934C07A624_SET_HITADDITIVELAYERINDEX_OFFSET UNITYSDK_OFFSET(0x15A4ABF0)
#define CLASS_2_4E1B9F934C07A624__CCTOR_OFFSET UNITYSDK_OFFSET(0x15A4AC10)
#define CLASS_2_4E1B9F934C07A624__CTOR_OFFSET UNITYSDK_OFFSET(0x15A4AC00)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_4E1B9F934C07A624_TypeDefinitionIndex)->GetStaticField(0x12CF0);
	}
	static ::System::Int32* StaticGet_COJOCBCIPAN()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_4E1B9F934C07A624_TypeDefinitionIndex)->GetStaticField(0x12CF4);
	}
	::System::Int32 DCDBAJGEEHO; // 0x18
	::RPG::GameCore::FixPoint HCMKIPKCKOL; // 0x20
	::System::Int32 _HitAdditiveLayerIndex_k__BackingField; // 0x28
	::System::Boolean PDEGILGLFKI; // 0x2C
	::System::Boolean GDOMAIIIKDG; // 0x2D
	::System::Boolean EDPCLJALHGL; // 0x2E
	::System::Boolean DGDJGLFNJID; // 0x2F
