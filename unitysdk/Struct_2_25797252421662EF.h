...
inline static constexpr unsigned int Struct_2_25797252421662EF_TypeDefinitionIndex = 56027;
...
struct alignas(8) Struct_2_25797252421662EF
{
	...
	::System::Collections::Generic::List_1<::MoleMole::Config::RenderMaterial*>* Field_2_7; // 0x28
	::System::Boolean Field_2_6; // 0x30
	::MoleMole::Battle::MaterialPropertyModifierExtraParams Field_2_5; // 0x38
};
