...
#define STATEMOVEUP_METHOD_4_D00EFFFA316CD3C0_OFFSET UNITYSDK_OFFSET(0xB955F60)
#define STATEMOVEUP_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xB955B20)
#define STATEMOVEUP_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB955BD0)
#define STATEMOVEUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB956030)
#define STATEMOVEUP___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xB956040)
#define STATEMOVEUP___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB956050)

inline static constexpr unsigned int StateMoveUp_TypeDefinitionIndex = 44066;
