...
#define STRUCT_2_A3B5141C858708A0_GET_BYTEBUFFER_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define STRUCT_2_A3B5141C858708A0_METHOD_2_4CDE2E1382E8C4EB_OFFSET UNITYSDK_OFFSET(0x1A6A7610)
#define STRUCT_2_A3B5141C858708A0_METHOD_2_574A0EFDE858A687_OFFSET UNITYSDK_OFFSET(0x77D950)
#define STRUCT_2_A3B5141C858708A0_METHOD_2_6C957C84B1F40239_OFFSET UNITYSDK_OFFSET(0x77D9B0)
#define STRUCT_2_A3B5141C858708A0_METHOD_2_8F54C68DC21A03C7_OFFSET UNITYSDK_OFFSET(0x1A6A76B0)
#define STRUCT_2_A3B5141C858708A0_METHOD_2_E243B4F73EA9A980_OFFSET UNITYSDK_OFFSET(0x8B9E20)
#define STRUCT_2_A3B5141C858708A0_METHOD_2_E687B8530C04E50A_OFFSET UNITYSDK_OFFSET(0x8B9DE0)
#define STRUCT_2_A3B5141C858708A0___INIT_OFFSET UNITYSDK_OFFSET(0x8B9DC0)

inline static constexpr unsigned int Struct_2_A3B5141C858708A0_TypeDefinitionIndex = 8946;
...
struct alignas(8) Struct_2_A3B5141C858708A0
{
	...
	{
		return ((::System::Nullable_1<::Struct_2_58DF5669875F2C66_6>(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + STRUCT_2_A3B5141C858708A0_METHOD_2_6C957C84B1F40239_OFFSET))(this, a1);
	}
	*/
