...
#define CLASS_1_5B567C8A01BAEDFE_282_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A794310)
#define CLASS_1_5B567C8A01BAEDFE_282_CLONE_OFFSET UNITYSDK_OFFSET(0x1A794120)
#define CLASS_1_5B567C8A01BAEDFE_282_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A794220)
#define CLASS_1_5B567C8A01BAEDFE_282_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A794190)
#define CLASS_1_5B567C8A01BAEDFE_282_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A794270)
#define CLASS_1_5B567C8A01BAEDFE_282_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A794360)
#define CLASS_1_5B567C8A01BAEDFE_282_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A794330)
#define CLASS_1_5B567C8A01BAEDFE_282_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A794070)
#define CLASS_1_5B567C8A01BAEDFE_282_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7940D0)
#define CLASS_1_5B567C8A01BAEDFE_282_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7942A0)
#define CLASS_1_5B567C8A01BAEDFE_282_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A794300)
#define CLASS_1_5B567C8A01BAEDFE_282__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7943B0)
#define CLASS_1_5B567C8A01BAEDFE_282__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7940F0)
#define CLASS_1_5B567C8A01BAEDFE_282__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7940E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_282_TypeDefinitionIndex = 30877;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_282*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_282_TypeDefinitionIndex)->GetStaticField(0x47FA0);
	}
