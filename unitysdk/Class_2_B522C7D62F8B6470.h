...
#define CLASS_2_B522C7D62F8B6470_METHOD_2_39CEC1620A646170_OFFSET UNITYSDK_OFFSET(0xBB4F340)
#define CLASS_2_B522C7D62F8B6470_METHOD_2_6BCEDD4814D8A8D9_OFFSET UNITYSDK_OFFSET(0xBB4EBE0)
#define CLASS_2_B522C7D62F8B6470_METHOD_2_B6E5FAEA04542937_OFFSET UNITYSDK_OFFSET(0xBB4EDA0)
#define CLASS_2_B522C7D62F8B6470_METHOD_2_E282AD45A2AD9E9A_OFFSET UNITYSDK_OFFSET(0xBB4ED00)
#define CLASS_2_B522C7D62F8B6470_METHOD_2_FFD4497C3B25EFD1_OFFSET UNITYSDK_OFFSET(0xBB4F5A0)
#define CLASS_2_B522C7D62F8B6470__CTOR_OFFSET UNITYSDK_OFFSET(0xBB4F630)
#define CLASS_2_B522C7D62F8B6470__ONBIND_OFFSET UNITYSDK_OFFSET(0xBB4EC70)

inline static constexpr unsigned int Class_2_B522C7D62F8B6470_TypeDefinitionIndex = 71616;

class Class_2_B522C7D62F8B6470 : public ::Class_1_34917908B7833130
{
public:
	::Class_2_C7DFD1DD059BE185* CNMNFOIDLBL; // 0x60
	::UnityEngine::Transform* OHJCABBKJHA; // 0x68
