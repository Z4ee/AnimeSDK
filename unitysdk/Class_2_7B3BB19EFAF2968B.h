...
#define CLASS_2_7B3BB19EFAF2968B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15475480)
#define CLASS_2_7B3BB19EFAF2968B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15475530)
#define CLASS_2_7B3BB19EFAF2968B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x154754F0)
#define CLASS_2_7B3BB19EFAF2968B_TICK_OFFSET UNITYSDK_OFFSET(0x15475980)
#define CLASS_2_7B3BB19EFAF2968B__CTOR_OFFSET UNITYSDK_OFFSET(0x15475470)
...
public:
	...
	::Class_2_71327659F4088CD0* KCAPNKMBOBO; // 0x20
	::RPG::GameCore::GameEntity* ILAJEHHAPBD; // 0x28
	::RPG::GameCore::AdvChaseBailu* OFKGLJOAMLD; // 0x30
