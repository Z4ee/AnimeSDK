...
#define CLASS_2_A586D0C837F5D16D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16F88C20)
#define CLASS_2_A586D0C837F5D16D_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x16F88C00)
#define CLASS_2_A586D0C837F5D16D_METHOD_2_20B34875EFF4EB0F_OFFSET UNITYSDK_OFFSET(0x16F88A70)
#define CLASS_2_A586D0C837F5D16D_METHOD_2_20B88645258E9357_OFFSET UNITYSDK_OFFSET(0x16F88AE0)
#define CLASS_2_A586D0C837F5D16D_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x16F88B50)
#define CLASS_2_A586D0C837F5D16D_METHOD_2_B5D7508463F26E87_OFFSET UNITYSDK_OFFSET(0x160B3E20)
#define CLASS_2_A586D0C837F5D16D_METHOD_2_D578E705DC1B8121_OFFSET UNITYSDK_OFFSET(0x16F88BB0)
#define CLASS_2_A586D0C837F5D16D__CTOR_OFFSET UNITYSDK_OFFSET(0x16F88C70)

inline static constexpr unsigned int Class_2_A586D0C837F5D16D_TypeDefinitionIndex = 54966;

class Class_2_A586D0C837F5D16D : public ::RPG::GameCore::GameComponentBase
{
public:
	::RPG::AvatarSystem::IAvatar* Field_2_0; // 0x18
	::RPG::GameCore::AdventureCharacterConfig* Field_2_1; // 0x20
