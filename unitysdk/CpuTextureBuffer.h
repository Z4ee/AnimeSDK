...
#define CPUTEXTUREBUFFER_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0xE01BED0)
#define CPUTEXTUREBUFFER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xE01BEC0)
#define CPUTEXTUREBUFFER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xE01BEB0)
#define CPUTEXTUREBUFFER_METHOD_3_053D00406C3D70A8_OFFSET UNITYSDK_OFFSET(0xE01BF90)
#define CPUTEXTUREBUFFER_METHOD_3_5DE9667DA47C9DE0_OFFSET UNITYSDK_OFFSET(0xE01C120)
#define CPUTEXTUREBUFFER_METHOD_3_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0xE01C320)
#define CPUTEXTUREBUFFER_METHOD_3_9FE4AB7E2BDAE9CB_OFFSET UNITYSDK_OFFSET(0xE01BF20)
#define CPUTEXTUREBUFFER_METHOD_3_BA7EA81739AE87D6_OFFSET UNITYSDK_OFFSET(0xE01C3A0)
#define CPUTEXTUREBUFFER_METHOD_3_E88B5CB549D7264A_OFFSET UNITYSDK_OFFSET(0xE01C1F0)
#define CPUTEXTUREBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0xE01C660)
