...
#define CLASS_3_66B7AEE5B2F59FF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF3F670)
#define CLASS_3_66B7AEE5B2F59FF2_METHOD_3_35F1558C0CF0108B_OFFSET UNITYSDK_OFFSET(0x1AF3F570)
#define CLASS_3_66B7AEE5B2F59FF2_METHOD_3_A4869E754AD7F239_OFFSET UNITYSDK_OFFSET(0x1AF3EE90)
#define CLASS_3_66B7AEE5B2F59FF2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1AF3EC70)
#define CLASS_3_66B7AEE5B2F59FF2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF3EC40)

inline static constexpr unsigned int Class_3_66B7AEE5B2F59FF2_TypeDefinitionIndex = 52727;

class Class_3_66B7AEE5B2F59FF2 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::AdvNpcMonsterSetupTrigger*>
{
public:
	::Class_2_B97395A7A10E835D* GALAHGAJODG; // 0x28
	::RPG::GameCore::GameEntity* KCKEHDGBGGG; // 0x30
	::RPG::GameCore::ColliderTriggerComponent* IKPIABIPNEK; // 0x38
