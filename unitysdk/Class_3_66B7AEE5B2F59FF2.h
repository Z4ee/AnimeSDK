...
#define CLASS_3_66B7AEE5B2F59FF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB75D210)
#define CLASS_3_66B7AEE5B2F59FF2_METHOD_3_35F1558C0CF0108B_OFFSET UNITYSDK_OFFSET(0xB75D110)
#define CLASS_3_66B7AEE5B2F59FF2_METHOD_3_A4869E754AD7F239_OFFSET UNITYSDK_OFFSET(0xB75CA30)
#define CLASS_3_66B7AEE5B2F59FF2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB75C810)
#define CLASS_3_66B7AEE5B2F59FF2__CTOR_OFFSET UNITYSDK_OFFSET(0xB75C7E0)
...
{
public:
	::RPG::GameCore::ColliderTriggerComponent* IKPIABIPNEK; // 0x28
	::RPG::GameCore::GameEntity* KCKEHDGBGGG; // 0x30
	::Class_2_B97395A7A10E835D* GALAHGAJODG; // 0x38
