...
#define CLASS_2_174D59A39557C6B7_CLASS_1_949AA8CED6F3A04D__CTOR_OFFSET UNITYSDK_OFFSET(0xBBF54D0)
...
{
public:
	::RPG::GameCore::SetComponentAssetAnimStateConfig* EABKOHGCHFP; // 0x10
