...
#define ETHEREYESOUTLINERENDERER_CLEANRENDERERS_OFFSET UNITYSDK_OFFSET(0x17852E40)
#define ETHEREYESOUTLINERENDERER_CLOSEOUTLINE_OFFSET UNITYSDK_OFFSET(0x17852DE0)
#define ETHEREYESOUTLINERENDERER_ENTERSELECTED_OFFSET UNITYSDK_OFFSET(0x17853010)
#define ETHEREYESOUTLINERENDERER_EXITSELECTED_OFFSET UNITYSDK_OFFSET(0x17853050)
#define ETHEREYESOUTLINERENDERER_FETCHCONFIG_OFFSET UNITYSDK_OFFSET(0x17852B10)
#define ETHEREYESOUTLINERENDERER_GETOUTLINERENDERTYPE_OFFSET UNITYSDK_OFFSET(0x17853960)
#define ETHEREYESOUTLINERENDERER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x17852010)
#define ETHEREYESOUTLINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17853890)
#define ETHEREYESOUTLINERENDERER_OPENOUTLINE_OFFSET UNITYSDK_OFFSET(0x17852CC0)
#define ETHEREYESOUTLINERENDERER_TESTCLOSEOUTLINE_OFFSET UNITYSDK_OFFSET(0x17853810)
#define ETHEREYESOUTLINERENDERER_TESTOPENOUTLINE_OFFSET UNITYSDK_OFFSET(0x17853530)
#define ETHEREYESOUTLINERENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17853090)
#define ETHEREYESOUTLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x178539B0)

inline static constexpr unsigned int EtherEyesOutlineRenderer_TypeDefinitionIndex = 52290;
...
public:
	...
	::Class_1_8289F2785D9AA990* fadeTimer; // 0x58
