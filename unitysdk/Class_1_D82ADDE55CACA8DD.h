...
#define CLASS_1_D82ADDE55CACA8DD_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x10C70E60)
#define CLASS_1_D82ADDE55CACA8DD_GET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x10C70E80)
#define CLASS_1_D82ADDE55CACA8DD_GET_ISSHELFUNLOCK_OFFSET UNITYSDK_OFFSET(0x10C70EA0)
#define CLASS_1_D82ADDE55CACA8DD_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x10C70E40)
#define CLASS_1_D82ADDE55CACA8DD_GET_LOCALISVISIBLE_OFFSET UNITYSDK_OFFSET(0x10C70EE0)
#define CLASS_1_D82ADDE55CACA8DD_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0x10C70EC0)
#define CLASS_1_D82ADDE55CACA8DD_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x10C70E70)
#define CLASS_1_D82ADDE55CACA8DD_SET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x10C70E90)
#define CLASS_1_D82ADDE55CACA8DD_SET_ISSHELFUNLOCK_OFFSET UNITYSDK_OFFSET(0x10C70EB0)
#define CLASS_1_D82ADDE55CACA8DD_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x10C70E50)
#define CLASS_1_D82ADDE55CACA8DD_SET_LOCALISVISIBLE_OFFSET UNITYSDK_OFFSET(0x10C70EF0)
#define CLASS_1_D82ADDE55CACA8DD_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0x10C70ED0)
#define CLASS_1_D82ADDE55CACA8DD__CTOR_OFFSET UNITYSDK_OFFSET(0x10C70F00)

inline static constexpr unsigned int Class_1_D82ADDE55CACA8DD_TypeDefinitionIndex = 74298;

class Class_1_D82ADDE55CACA8DD : public ::System::Object
{
public:
	::Proto::ItemList* _Rewards_k__BackingField; // 0x10
	::System::Boolean _LocalIsVisible_k__BackingField; // 0x18
	::System::Boolean _IsShelfUnlock_k__BackingField; // 0x19
	::System::Boolean _CanInteract_k__BackingField; // 0x1A
	::System::Boolean _IsVisible_k__BackingField; // 0x1B
