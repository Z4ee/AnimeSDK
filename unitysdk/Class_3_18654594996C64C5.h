...
#define CLASS_3_18654594996C64C5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x114D6990)
#define CLASS_3_18654594996C64C5__CTOR_OFFSET UNITYSDK_OFFSET(0x114D6960)

inline static constexpr unsigned int Class_3_18654594996C64C5_TypeDefinitionIndex = 42857;
