...
#define STRUCT_2_9631509AB5AD4C70_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9C9EB0)
#define STRUCT_2_9631509AB5AD4C70_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C9DE0)
#define STRUCT_2_9631509AB5AD4C70_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9C9EC0)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x9C9FD0)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x9CA0B0)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x9CA050)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_BE560DD3F683CA66_OFFSET UNITYSDK_OFFSET(0x1CF83990)
#define STRUCT_2_9631509AB5AD4C70_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x4120B0)
#define STRUCT_2_9631509AB5AD4C70_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9C9DD0)
#define STRUCT_2_9631509AB5AD4C70__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CF83D10)
#define STRUCT_2_9631509AB5AD4C70__CTOR_OFFSET UNITYSDK_OFFSET(0x9C9DC0)

inline static constexpr unsigned int Struct_2_9631509AB5AD4C70_TypeDefinitionIndex = 33940;

struct alignas(8) Struct_2_9631509AB5AD4C70
{
	static ::Struct_2_9631509AB5AD4C70* StaticGet_Field_2_3()
	{
		return (::Struct_2_9631509AB5AD4C70*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_9631509AB5AD4C70_TypeDefinitionIndex)->GetStaticField(0x27610);
	}
	static ::Struct_2_9631509AB5AD4C70* StaticGet_Field_2_2()
	{
		return (::Struct_2_9631509AB5AD4C70*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_9631509AB5AD4C70_TypeDefinitionIndex)->GetStaticField(0x27620);
	}
