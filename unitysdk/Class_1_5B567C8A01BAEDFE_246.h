...
#define CLASS_1_5B567C8A01BAEDFE_246_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CCABCD0)
#define CLASS_1_5B567C8A01BAEDFE_246_CLONE_OFFSET UNITYSDK_OFFSET(0x1CCAB970)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CCABAD0)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CCAB9E0)
#define CLASS_1_5B567C8A01BAEDFE_246_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CCABC30)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CCABD20)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CCABCF0)
#define CLASS_1_5B567C8A01BAEDFE_246_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1CCAB8C0)
#define CLASS_1_5B567C8A01BAEDFE_246_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CCAB920)
#define CLASS_1_5B567C8A01BAEDFE_246_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CCABC60)
#define CLASS_1_5B567C8A01BAEDFE_246_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CCABCC0)
#define CLASS_1_5B567C8A01BAEDFE_246__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CCABD70)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CCAB940)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCAB930)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex = 30457;

class Class_1_5B567C8A01BAEDFE_246 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_246*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_246*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex)->GetStaticField(0x671B0);
	}
