...
#define CLASS_1_5B567C8A01BAEDFE_246_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A40CC00)
#define CLASS_1_5B567C8A01BAEDFE_246_CLONE_OFFSET UNITYSDK_OFFSET(0x1A40CA10)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A40CB10)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A40CA80)
#define CLASS_1_5B567C8A01BAEDFE_246_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A40CB60)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A40CC50)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A40CC20)
#define CLASS_1_5B567C8A01BAEDFE_246_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A40C960)
#define CLASS_1_5B567C8A01BAEDFE_246_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A40C9C0)
#define CLASS_1_5B567C8A01BAEDFE_246_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A40CB90)
#define CLASS_1_5B567C8A01BAEDFE_246_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A40CBF0)
#define CLASS_1_5B567C8A01BAEDFE_246__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A40CCA0)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A40C9E0)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_OFFSET UNITYSDK_OFFSET(0x1A40C9D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex = 30031;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_246*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex)->GetStaticField(0x63910);
	}
