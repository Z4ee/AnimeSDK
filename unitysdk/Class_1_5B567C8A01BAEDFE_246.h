...
#define CLASS_1_5B567C8A01BAEDFE_246_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19801F50)
#define CLASS_1_5B567C8A01BAEDFE_246_CLONE_OFFSET UNITYSDK_OFFSET(0x19801D60)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19801E60)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_OFFSET UNITYSDK_OFFSET(0x19801DD0)
#define CLASS_1_5B567C8A01BAEDFE_246_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19801EB0)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19801FA0)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19801F70)
#define CLASS_1_5B567C8A01BAEDFE_246_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19801CB0)
#define CLASS_1_5B567C8A01BAEDFE_246_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19801D10)
#define CLASS_1_5B567C8A01BAEDFE_246_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19801EE0)
#define CLASS_1_5B567C8A01BAEDFE_246_WRITETO_OFFSET UNITYSDK_OFFSET(0x19801F40)
#define CLASS_1_5B567C8A01BAEDFE_246__CCTOR_OFFSET UNITYSDK_OFFSET(0x19801FF0)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19801D30)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_OFFSET UNITYSDK_OFFSET(0x19801D20)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex = 30149;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_246*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex)->GetStaticField(0x65040);
	}
