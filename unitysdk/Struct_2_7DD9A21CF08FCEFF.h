...
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_05845255F81DB107_OFFSET UNITYSDK_OFFSET(0x3B96370)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_2C034707CFF4EE92_OFFSET UNITYSDK_OFFSET(0x3B964F0)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_30735BFB07D87821_OFFSET UNITYSDK_OFFSET(0x3B96420)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_43D99DDD80B1E30C_OFFSET UNITYSDK_OFFSET(0x3B960C0)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_501C4FA5421B00BE_OFFSET UNITYSDK_OFFSET(0x3B964C0)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_6DD874399D7FD8ED_OFFSET UNITYSDK_OFFSET(0x3B96520)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_71D7FBD389114852_OFFSET UNITYSDK_OFFSET(0x3B96540)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_7D21D8548943D577_OFFSET UNITYSDK_OFFSET(0x3B96530)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_8040BAF29B6E8032_OFFSET UNITYSDK_OFFSET(0x3B960B0)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_82ECC72D992D12DD_OFFSET UNITYSDK_OFFSET(0x1D765960)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_8472716CEE94D849_OFFSET UNITYSDK_OFFSET(0x3B964E0)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_9772880FD3E17AB8_OFFSET UNITYSDK_OFFSET(0x3B96380)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_AC5564BB90FB4411_OFFSET UNITYSDK_OFFSET(0x3B96340)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_DFAD0398FA59DB56_OFFSET UNITYSDK_OFFSET(0x3B96250)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_E0D0A525BBFE5C6D_OFFSET UNITYSDK_OFFSET(0x3B964B0)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_E27FC1DE9BCBC5A2_OFFSET UNITYSDK_OFFSET(0x3B96290)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_F7D4B0D32C65DE6B_OFFSET UNITYSDK_OFFSET(0x3B96390)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_F84946FD738E3A9C_OFFSET UNITYSDK_OFFSET(0x1D765E10)
#define STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_FA1861945A7D62AB_OFFSET UNITYSDK_OFFSET(0x3B96280)
#define STRUCT_2_7DD9A21CF08FCEFF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B96070)
#define STRUCT_2_7DD9A21CF08FCEFF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B96000)
#define STRUCT_2_7DD9A21CF08FCEFF__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3B96010)
#define STRUCT_2_7DD9A21CF08FCEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x3B95FF0)

inline static constexpr unsigned int Struct_2_7DD9A21CF08FCEFF_TypeDefinitionIndex = 6309;

struct alignas(8) Struct_2_7DD9A21CF08FCEFF
{
	// static const ::System::Int32 IKJLEKPEHBB = 0xB; // 0x0
	// static const ::System::Int32 MDPBLFCNANB = 0x100; // 0x0
	::System::IFormatProvider* NAMGCGIEMOE; // 0x10
	::Il2CppArray<::System::Char>* EDEHAPAGECA; // 0x18
	::System::Span_1<::System::Char> NKKOAPEIOKA; // 0x20
	::System::Int32 LOLFABAKIJA; // 0x38
	::System::Boolean JOFPBDAJDIE; // 0x3C
	...
	*/
	...
	::System::Void Method_2_9772880FD3E17AB8(::System::String* a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + STRUCT_2_7DD9A21CF08FCEFF_METHOD_2_9772880FD3E17AB8_OFFSET))(this, a1);
	}
