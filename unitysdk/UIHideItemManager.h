...
#define UIHIDEITEMMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x150A5CB0)
#define UIHIDEITEMMANAGER_HANDLESETUPUIANIMLENGTHMAX_OFFSET UNITYSDK_OFFSET(0x150A6BF0)
#define UIHIDEITEMMANAGER_HANDLESETUPUIFINISHCB_OFFSET UNITYSDK_OFFSET(0x150A6C90)
#define UIHIDEITEMMANAGER_INTERRUPTSETUPUIBYTYPE_OFFSET UNITYSDK_OFFSET(0x150A8740)
#define UIHIDEITEMMANAGER_INTERRUPTSETUPUI_OFFSET UNITYSDK_OFFSET(0x150A8390)
#define UIHIDEITEMMANAGER_ISITEMSHOW_OFFSET UNITYSDK_OFFSET(0x150A8B30)
#define UIHIDEITEMMANAGER_POP_OFFSET UNITYSDK_OFFSET(0x150A61A0)
#define UIHIDEITEMMANAGER_PUSH_OFFSET UNITYSDK_OFFSET(0x150A5E40)
#define UIHIDEITEMMANAGER_RESETHIDEITEMS_OFFSET UNITYSDK_OFFSET(0x150A8C60)
#define UIHIDEITEMMANAGER_SETUPUIBYACTION_OFFSET UNITYSDK_OFFSET(0x150A74B0)
#define UIHIDEITEMMANAGER_SETUPUIBYZONE_OFFSET UNITYSDK_OFFSET(0x150A8290)
#define UIHIDEITEMMANAGER_SETUPUI_1_OFFSET UNITYSDK_OFFSET(0x150A6D60)
#define UIHIDEITEMMANAGER_SETUPUI_2_OFFSET UNITYSDK_OFFSET(0x150A7550)
#define UIHIDEITEMMANAGER_SETUPUI_OFFSET UNITYSDK_OFFSET(0x150A63D0)
#define UIHIDEITEMMANAGER_TRYGETHIDEITEM_OFFSET UNITYSDK_OFFSET(0x150A90A0)
#define UIHIDEITEMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x150A5DB0)

inline static constexpr unsigned int UIHideItemManager_TypeDefinitionIndex = 58170;
...
public:
	...
	{
		return (::UIHideItemManager**)Il2CppClass::FromTypeDefinitionIndex(UIHideItemManager_TypeDefinitionIndex)->GetStaticField(0x3F7C0);
	}
