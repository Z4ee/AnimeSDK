...
#define STRUCT_2_2D47C7A2C6B7C7A0_EQUALS_OFFSET UNITYSDK_OFFSET(0x7BDEC0)
#define STRUCT_2_2D47C7A2C6B7C7A0_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7BDF20)

inline static constexpr unsigned int Struct_2_2D47C7A2C6B7C7A0_TypeDefinitionIndex = 90208;
