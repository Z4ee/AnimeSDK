...
#define STRUCT_2_2D47C7A2C6B7C7A0_EQUALS_OFFSET UNITYSDK_OFFSET(0x7C6FC0)
#define STRUCT_2_2D47C7A2C6B7C7A0_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7C7020)

inline static constexpr unsigned int Struct_2_2D47C7A2C6B7C7A0_TypeDefinitionIndex = 63712;
