...
#define CLASS_3_3CF102DF6BA04E78_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC5035B0)
#define CLASS_3_3CF102DF6BA04E78_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xC5037B0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_043AEF5D7DD905FE_OFFSET UNITYSDK_OFFSET(0xC5014B0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0xC5029C0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_38B862BB2192EC08_OFFSET UNITYSDK_OFFSET(0xC503470)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_427D56D899C161B9_OFFSET UNITYSDK_OFFSET(0xC501200)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0xC501C40)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_630A3B9C63A23882_OFFSET UNITYSDK_OFFSET(0xC502B50)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xC501120)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC502AC0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_AC1BFDB3D2FC0C79_OFFSET UNITYSDK_OFFSET(0xC5013C0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_AC93EA9EB530001C_1_OFFSET UNITYSDK_OFFSET(0xC5033E0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_AC93EA9EB530001C_OFFSET UNITYSDK_OFFSET(0xC503240)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_B00A1D822E6F5C31_OFFSET UNITYSDK_OFFSET(0xC501640)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xC502710)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xC5034C0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_C4E2F930A41E34C0_OFFSET UNITYSDK_OFFSET(0xC5032D0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_CBA096B6B8D30164_OFFSET UNITYSDK_OFFSET(0xC502ED0)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xC502650)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_F5B4708E7805566C_1_OFFSET UNITYSDK_OFFSET(0xC502A50)
#define CLASS_3_3CF102DF6BA04E78_METHOD_3_F5B4708E7805566C_OFFSET UNITYSDK_OFFSET(0xC5026A0)
#define CLASS_3_3CF102DF6BA04E78_ONRETURN_OFFSET UNITYSDK_OFFSET(0xC501010)
#define CLASS_3_3CF102DF6BA04E78__CTOR_OFFSET UNITYSDK_OFFSET(0xC5039B0)
#define CLASS_3_3CF102DF6BA04E78__ONBIND_OFFSET UNITYSDK_OFFSET(0xC500D40)

inline static constexpr unsigned int Class_3_3CF102DF6BA04E78_TypeDefinitionIndex = 71861;
...
public:
	...
	// static const ::RPG::GameCore::ModifierBehaviorFlag FKJAGNNBGAN; // 0x0
	// static const ::System::String* FBNOEMDNIBN; // 0x0
	// static const ::System::String* IBAOBHODAKN; // 0x0
	// static const ::System::String* LLLKIDGGMKJ; // 0x0
	::Class_1_274386B6ECA5E606* LCAFDOLIHIH; // 0xB8
	::UnityEngine::UI::Image* IHDDCCAIDIB; // 0xC0
	::UnityEngine::Transform* CEGHCGEHNGI; // 0xC8
	::UnityEngine::UI::Image* AJKPFICIIIP; // 0xD0
	::UnityEngine::Transform* MEBAOIBNLHL; // 0xD8
	::UnityEngine::UI::SmoothMask* DOEGJDFFCNI; // 0xE0
	::UnityEngine::UI::Image* IFPFGDMAJCF; // 0xE8
	::UnityEngine::ParticleSystem* DHENGDCFOHA; // 0xF0
	::UnityEngine::UI::Image* PMJFBCCOBJF; // 0xF8
	::RPG::Client::SPProgress* NAAODEIIMCI; // 0x100
	::UnityEngine::UI::Image* HFJBNHOHJHM; // 0x108
	::UnityEngine::Animation* LIFEJLAJJKO; // 0x110
	::UnityEngine::UI::Image* MAOLDDGOHKO; // 0x118
	::System::Boolean KHCEJBHMIDF; // 0x120
