...
#define CLASS_1_D1B623B440377B6F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DCCFF10)
#define CLASS_1_D1B623B440377B6F_CLONE_OFFSET UNITYSDK_OFFSET(0x1DCCFA00)
#define CLASS_1_D1B623B440377B6F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DCCFC10)
#define CLASS_1_D1B623B440377B6F_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DCCFA80)
#define CLASS_1_D1B623B440377B6F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DCCFD30)
#define CLASS_1_D1B623B440377B6F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DCD00C0)
#define CLASS_1_D1B623B440377B6F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DCD0040)
#define CLASS_1_D1B623B440377B6F_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DCCFA60)
#define CLASS_1_D1B623B440377B6F_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DCCF880)
#define CLASS_1_D1B623B440377B6F_METHOD_1_47587B9526E5B08E_OFFSET UNITYSDK_OFFSET(0x1DCCFA50)
#define CLASS_1_D1B623B440377B6F_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DCCFA70)
#define CLASS_1_D1B623B440377B6F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DCCF8E0)
#define CLASS_1_D1B623B440377B6F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DCCFDA0)
#define CLASS_1_D1B623B440377B6F_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DCCFE00)
#define CLASS_1_D1B623B440377B6F__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DCD0290)
#define CLASS_1_D1B623B440377B6F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DCCF940)
#define CLASS_1_D1B623B440377B6F__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCCF8F0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D1B623B440377B6F_TypeDefinitionIndex)->GetStaticField(0x31F0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_D1B623B440377B6F*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_D1B623B440377B6F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D1B623B440377B6F_TypeDefinitionIndex)->GetStaticField(0x31F8);
	}
