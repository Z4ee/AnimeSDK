...
#define CLASS_2_0BBF70F823B9A54E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF47BD0)
#define CLASS_2_0BBF70F823B9A54E_METHOD_2_E088C14C065FBD97_OFFSET UNITYSDK_OFFSET(0x1AF483B0)
#define CLASS_2_0BBF70F823B9A54E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1AF47C10)
#define CLASS_2_0BBF70F823B9A54E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1AF48440)
#define CLASS_2_0BBF70F823B9A54E_TICK_OFFSET UNITYSDK_OFFSET(0x1AF48490)
#define CLASS_2_0BBF70F823B9A54E__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF47BC0)

inline static constexpr unsigned int Class_2_0BBF70F823B9A54E_TypeDefinitionIndex = 55982;

class Class_2_0BBF70F823B9A54E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::UpdateMonsterFootIKMode* OFKGLJOAMLD; // 0x20
