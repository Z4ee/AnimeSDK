...
#define CLASS_2_0BBF70F823B9A54E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11E24700)
#define CLASS_2_0BBF70F823B9A54E_METHOD_2_E088C14C065FBD97_OFFSET UNITYSDK_OFFSET(0x11E24DA0)
#define CLASS_2_0BBF70F823B9A54E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11E24740)
#define CLASS_2_0BBF70F823B9A54E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11E24E30)
#define CLASS_2_0BBF70F823B9A54E_TICK_OFFSET UNITYSDK_OFFSET(0x11E24E80)
#define CLASS_2_0BBF70F823B9A54E__CTOR_OFFSET UNITYSDK_OFFSET(0x11E246F0)

inline static constexpr unsigned int Class_2_0BBF70F823B9A54E_TypeDefinitionIndex = 51443;

class Class_2_0BBF70F823B9A54E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::UpdateMonsterFootIKMode* Field_2_0; // 0x18
