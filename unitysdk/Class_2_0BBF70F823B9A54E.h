...
#define CLASS_2_0BBF70F823B9A54E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18AF7340)
#define CLASS_2_0BBF70F823B9A54E_METHOD_2_E088C14C065FBD97_OFFSET UNITYSDK_OFFSET(0x18AF7B30)
#define CLASS_2_0BBF70F823B9A54E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18AF7380)
#define CLASS_2_0BBF70F823B9A54E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18AF7BC0)
#define CLASS_2_0BBF70F823B9A54E_TICK_OFFSET UNITYSDK_OFFSET(0x18AF7C10)
#define CLASS_2_0BBF70F823B9A54E__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF7330)

inline static constexpr unsigned int Class_2_0BBF70F823B9A54E_TypeDefinitionIndex = 53268;

class Class_2_0BBF70F823B9A54E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::UpdateMonsterFootIKMode* Field_2_1; // 0x20
