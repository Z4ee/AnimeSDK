...
#define CLASS_2_0BBF70F823B9A54E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA4B5BF0)
#define CLASS_2_0BBF70F823B9A54E_METHOD_2_E088C14C065FBD97_OFFSET UNITYSDK_OFFSET(0xA4B6250)
#define CLASS_2_0BBF70F823B9A54E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA4B5C30)
#define CLASS_2_0BBF70F823B9A54E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA4B62E0)
#define CLASS_2_0BBF70F823B9A54E_TICK_OFFSET UNITYSDK_OFFSET(0xA4B6330)
#define CLASS_2_0BBF70F823B9A54E__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B5BE0)

inline static constexpr unsigned int Class_2_0BBF70F823B9A54E_TypeDefinitionIndex = 52111;
