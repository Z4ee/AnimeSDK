...
#define CLASS_2_ACF6D468822B8D7F_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB4A5DA0)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_77E4508564C6D7D6_OFFSET UNITYSDK_OFFSET(0xB4A6610)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_9E5E9518D01FCB25_OFFSET UNITYSDK_OFFSET(0xB4A6810)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_DD724269AA49742B_1_OFFSET UNITYSDK_OFFSET(0xB4A6320)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_DD724269AA49742B_OFFSET UNITYSDK_OFFSET(0xB4A60D0)
#define CLASS_2_ACF6D468822B8D7F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB4A59E0)
#define CLASS_2_ACF6D468822B8D7F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB4A5BF0)
#define CLASS_2_ACF6D468822B8D7F_TICK_OFFSET UNITYSDK_OFFSET(0xB4A6B10)
#define CLASS_2_ACF6D468822B8D7F__CTOR_OFFSET UNITYSDK_OFFSET(0xB4A57A0)
...
{
public:
	::Class_3_07C3C4D2990C49EE* NLGPHOKCGAC; // 0x18
	::Class_3_07C3C4D2990C49EE* NDAOBOMHGDA; // 0x20
	::Class_3_07C3C4D2990C49EE* MGFEGFCANBP; // 0x28
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x30
	::RPG::GameCore::DronesPuzzleEventListener* IGHAHBNLIJA; // 0x38
	::Class_3_07C3C4D2990C49EE* BCAHIEKECBN; // 0x40
	::Class_3_07C3C4D2990C49EE* BKCCIMBLMHN; // 0x48
	::System::Boolean NPNCKMIKGAK; // 0x50
	::System::Boolean APMJOKCHJID; // 0x51
	::System::Boolean IPLEKIHBLHE; // 0x52
	::System::Boolean JGLBOEPDEOB; // 0x53
