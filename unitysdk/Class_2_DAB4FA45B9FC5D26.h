...
#define CLASS_2_DAB4FA45B9FC5D26_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1391E120)
#define CLASS_2_DAB4FA45B9FC5D26_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1391E270)
#define CLASS_2_DAB4FA45B9FC5D26_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1391E2E0)
#define CLASS_2_DAB4FA45B9FC5D26_TICK_OFFSET UNITYSDK_OFFSET(0x1391E190)
#define CLASS_2_DAB4FA45B9FC5D26__CTOR_OFFSET UNITYSDK_OFFSET(0x1391E090)

inline static constexpr unsigned int Class_2_DAB4FA45B9FC5D26_TypeDefinitionIndex = 49046;

class Class_2_DAB4FA45B9FC5D26 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_5F51D4049EA87B7B* Field_2_0; // 0x18
	::RPG::GameCore::AdvNpcTrackedSearch* Field_2_1; // 0x20
