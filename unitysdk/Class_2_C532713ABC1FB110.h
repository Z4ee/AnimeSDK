...
#define CLASS_2_C532713ABC1FB110_DISPOSE_OFFSET UNITYSDK_OFFSET(0x176C5320)
#define CLASS_2_C532713ABC1FB110_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x176C5370)
#define CLASS_2_C532713ABC1FB110_ONSKIP_OFFSET UNITYSDK_OFFSET(0x176C6050)
#define CLASS_2_C532713ABC1FB110_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x176C5380)
#define CLASS_2_C532713ABC1FB110_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x176C5B30)
#define CLASS_2_C532713ABC1FB110_TICK_OFFSET UNITYSDK_OFFSET(0x176C5B80)
#define CLASS_2_C532713ABC1FB110__CTOR_OFFSET UNITYSDK_OFFSET(0x176C5300)
...
public:
	...
	::RPG::GameCore::WaitParallelTimeStamp* OFKGLJOAMLD; // 0x28
