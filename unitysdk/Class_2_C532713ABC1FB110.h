...
#define CLASS_2_C532713ABC1FB110_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD3A0AF0)
#define CLASS_2_C532713ABC1FB110_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xD3A0B40)
#define CLASS_2_C532713ABC1FB110_ONSKIP_OFFSET UNITYSDK_OFFSET(0xD3A1360)
#define CLASS_2_C532713ABC1FB110_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD3A0B50)
#define CLASS_2_C532713ABC1FB110_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD3A0FE0)
#define CLASS_2_C532713ABC1FB110_TICK_OFFSET UNITYSDK_OFFSET(0xD3A1030)
#define CLASS_2_C532713ABC1FB110__CTOR_OFFSET UNITYSDK_OFFSET(0xD3A0AD0)

inline static constexpr unsigned int Class_2_C532713ABC1FB110_TypeDefinitionIndex = 54313;

class Class_2_C532713ABC1FB110 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::Class_0_16E4307DCC419505_484* Field_2_3; // 0x20
	::RPG::GameCore::WaitParallelTimeStamp* Field_2_0; // 0x28
