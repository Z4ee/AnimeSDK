...
#define CLASS_2_C532713ABC1FB110_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8980F80)
#define CLASS_2_C532713ABC1FB110_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x8980FD0)
#define CLASS_2_C532713ABC1FB110_ONSKIP_OFFSET UNITYSDK_OFFSET(0x89817F0)
#define CLASS_2_C532713ABC1FB110_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8980FE0)
#define CLASS_2_C532713ABC1FB110_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8981470)
#define CLASS_2_C532713ABC1FB110_TICK_OFFSET UNITYSDK_OFFSET(0x89814C0)
#define CLASS_2_C532713ABC1FB110__CTOR_OFFSET UNITYSDK_OFFSET(0x8980F60)

inline static constexpr unsigned int Class_2_C532713ABC1FB110_TypeDefinitionIndex = 47575;

class Class_2_C532713ABC1FB110 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::WaitParallelTimeStamp* Field_2_0; // 0x20
	::Class_0_16E4307DCC419505_401* Field_2_3; // 0x28
