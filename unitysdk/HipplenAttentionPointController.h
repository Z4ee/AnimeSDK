...
#define HIPPLENATTENTIONPOINTCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x10C1A590)
#define HIPPLENATTENTIONPOINTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10C1AD00)

inline static constexpr unsigned int HipplenAttentionPointController_TypeDefinitionIndex = 38107;
