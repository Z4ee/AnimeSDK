...
#define CLASS_3_D8CD91A9FE5659F7_METHOD_3_E024E0080A08A9C9_OFFSET UNITYSDK_OFFSET(0x1DADAD20)
#define CLASS_3_D8CD91A9FE5659F7_METHOD_3_FCE92D332F1E367F_OFFSET UNITYSDK_OFFSET(0x1DADAC10)
#define CLASS_3_D8CD91A9FE5659F7__CTOR_OFFSET UNITYSDK_OFFSET(0x1DADACB0)
...
{
public:
	::RPG::GameCore::TargetEvaluator* NFMKOFNEKLA; // 0x18
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x20
	::RPG::GameCore::DamageDisplayData* AIMHHKODFJN; // 0x28
	::RPG::GameCore::DynamicFloat* MIAFMBHCMOG; // 0x30
	::System::String* FDFONLOKOHJ; // 0x38
	::RPG::GameCore::DynamicFloat* PIBDDOGGDKL; // 0x40
	...
	::RPG::GameCore::AttackType HIFKEKCELFB; // 0x58
	::RPG::GameCore::DynamicValueContextScope AMEKHLANFKP; // 0x5C
	::RPG::GameCore::AttackDamageType PAIECOBACKB; // 0x60
