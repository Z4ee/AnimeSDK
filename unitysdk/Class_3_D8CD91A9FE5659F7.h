...
#define CLASS_3_D8CD91A9FE5659F7_METHOD_3_E024E0080A08A9C9_OFFSET UNITYSDK_OFFSET(0x182018F0)
#define CLASS_3_D8CD91A9FE5659F7_METHOD_3_FCE92D332F1E367F_OFFSET UNITYSDK_OFFSET(0x182017B0)
#define CLASS_3_D8CD91A9FE5659F7__CTOR_OFFSET UNITYSDK_OFFSET(0x18201860)

inline static constexpr unsigned int Class_3_D8CD91A9FE5659F7_TypeDefinitionIndex = 23162;

class Class_3_D8CD91A9FE5659F7 : public ::RPG::GameCore::TaskConfig
{
public:
	::System::String* Field_3_7; // 0x18
	::RPG::GameCore::DynamicFloat* Field_3_6; // 0x20
	::RPG::GameCore::DynamicFloat* Field_3_4; // 0x28
	::RPG::GameCore::TargetEvaluator* Field_3_0; // 0x30
	::RPG::GameCore::DamageDisplayData* Field_3_9; // 0x38
	::RPG::GameCore::DynamicFloat* Field_3_5; // 0x40
	::RPG::GameCore::TargetEvaluator* Field_3_10; // 0x48
	::System::Boolean Field_3_11; // 0x50
	::System::Boolean Field_3_12; // 0x51
	::RPG::GameCore::TargetRatioType Field_3_3; // 0x54
	::RPG::GameCore::AttackDamageType Field_3_2; // 0x58
	::RPG::GameCore::AttackType Field_3_1; // 0x5C
	::RPG::GameCore::DynamicValueContextScope Field_3_8; // 0x60
