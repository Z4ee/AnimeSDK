...
#define STRUCT_2_A9A03775CD77F6D6_EQUALS_OFFSET UNITYSDK_OFFSET(0x7BFC90)

inline static constexpr unsigned int Struct_2_A9A03775CD77F6D6_TypeDefinitionIndex = 62698;

struct alignas(8) Struct_2_A9A03775CD77F6D6
{
	::System::Int32 Field_2_0; // 0x10
	::UnityEngine::Bounds Field_2_1; // 0x14
	::System::Collections::Generic::List_1<::UnityEngine::Bounds>* Field_2_2; // 0x30
