...
#define MB3_BATCHPREFABBAKER_CREATESOURCEANDRESULTPREFABINSTANCES_OFFSET UNITYSDK_OFFSET(0x1FBF7AC0)
#define MB3_BATCHPREFABBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBF7B30)

inline static constexpr unsigned int MB3_BatchPrefabBaker_TypeDefinitionIndex = 94468;
