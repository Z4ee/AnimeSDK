...
#define CLASS_1_9B635DC3F867E2EE_CLEAR_OFFSET UNITYSDK_OFFSET(0x15DF9020)
#define CLASS_1_9B635DC3F867E2EE__CTOR_OFFSET UNITYSDK_OFFSET(0x15DF9070)
...
public:
	...
	::RPG::GameCore::TeamTypeMask OBMPNGFPNMG; // 0x18
	::System::Int32 NALMBOOCCIN; // 0x1C
	::RPG::GameCore::RtStackSkillTargetRedirectPhase IFDLJDHLPJM; // 0x20
	::RPG::GameCore::EntityTypeMask PCBEIEAONIF; // 0x28
