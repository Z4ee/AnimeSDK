...
#define CLASS_1_4C3D712C4A57A9B3_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17DA4E50)
#define CLASS_1_4C3D712C4A57A9B3_TICK_OFFSET UNITYSDK_OFFSET(0x17DA4F00)
#define CLASS_1_4C3D712C4A57A9B3__CTOR_OFFSET UNITYSDK_OFFSET(0x17DA4E40)

inline static constexpr unsigned int Class_1_4C3D712C4A57A9B3_TypeDefinitionIndex = 74392;
