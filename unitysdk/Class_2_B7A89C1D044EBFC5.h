...
#define CLASS_2_B7A89C1D044EBFC5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15F219C0)
#define CLASS_2_B7A89C1D044EBFC5_METHOD_2_87A2427A13E31018_OFFSET UNITYSDK_OFFSET(0x15F21A30)
#define CLASS_2_B7A89C1D044EBFC5_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0x15F21930)
#define CLASS_2_B7A89C1D044EBFC5__CTOR_OFFSET UNITYSDK_OFFSET(0x15F21A20)

inline static constexpr unsigned int Class_2_B7A89C1D044EBFC5_TypeDefinitionIndex = 84749;

class Class_2_B7A89C1D044EBFC5 : public ::Class_1_43BD383C98B4C0C5_84
{
public:
