...
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_0CE847FF527A969C_OFFSET UNITYSDK_OFFSET(0xC4507A0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_16DC12B9AA0610D8_OFFSET UNITYSDK_OFFSET(0xC4516F0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_55357EED91DD300A_OFFSET UNITYSDK_OFFSET(0xC451670)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_594B16EC13924620_OFFSET UNITYSDK_OFFSET(0xC451570)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_5A4F244FA80C999D_OFFSET UNITYSDK_OFFSET(0xC44F7C0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7B23922E4C775970_OFFSET UNITYSDK_OFFSET(0xC450DB0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7B79FC85A5EDBF4B_OFFSET UNITYSDK_OFFSET(0xC451CA0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7C350CDAB199DC24_OFFSET UNITYSDK_OFFSET(0xC4514A0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_A13A778D4D3E962F_OFFSET UNITYSDK_OFFSET(0xC4513E0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_A42DC4450468C0E0_OFFSET UNITYSDK_OFFSET(0xC450F00)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_B7E646E7463E1B89_OFFSET UNITYSDK_OFFSET(0xC44F1B0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_C76FBF5BDDCD86A3_OFFSET UNITYSDK_OFFSET(0xC451260)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_D0E12D959862FC72_OFFSET UNITYSDK_OFFSET(0xC450B40)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_DC4F7BE1519B0B0B_OFFSET UNITYSDK_OFFSET(0xC450C00)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_FEA73477BA929C29_OFFSET UNITYSDK_OFFSET(0xC44F9E0)
#define CLASS_2_B078978DCA0CA7A4__CCTOR_OFFSET UNITYSDK_OFFSET(0xC451D20)
#define CLASS_2_B078978DCA0CA7A4__CTOR_OFFSET UNITYSDK_OFFSET(0xC44F110)

inline static constexpr unsigned int Class_2_B078978DCA0CA7A4_TypeDefinitionIndex = 54593;

class Class_2_B078978DCA0CA7A4 : public ::Class_1_F9FBCC956DFCF137_5
{
public:
	static ::System::String** StaticGet_KOIJGPMOOIF()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4_TypeDefinitionIndex)->GetStaticField(0x5D4E0);
	}
	static ::System::String** StaticGet_EGEDJFGFDIN()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4_TypeDefinitionIndex)->GetStaticField(0x5D4E8);
	}
	::RPG::GameCore::ComplexSkillAIAxis* IGHAHBNLIJA; // 0x18
	::Class_1_73D621BDD90E61A7* EMOAGCAHICO; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_2_B078978DCA0CA7A4_Class_1_9D2500B7447E67F1*>* JNJHHADPJKL; // 0x28
	...
	::System::ValueTuple_2<::System::Boolean, ::RPG::GameCore::FixPoint> Method_2_16DC12B9AA0610D8(::Class_1_AC66714FF5876767* a1, ::Class_1_73D621BDD90E61A7* a2, ::RPG::GameCore::SkillData* a3)
	{
		return ((::System::ValueTuple_2<::System::Boolean, ::RPG::GameCore::FixPoint>(*)(::PVOID, ::Class_1_AC66714FF5876767*, ::Class_1_73D621BDD90E61A7*, ::RPG::GameCore::SkillData*))((::PBYTE)hIl2Cpp + CLASS_2_B078978DCA0CA7A4_METHOD_2_16DC12B9AA0610D8_OFFSET))(this, a1, a2, a3);
	}
