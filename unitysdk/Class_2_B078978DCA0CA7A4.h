...
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_0CE847FF527A969C_OFFSET UNITYSDK_OFFSET(0x1709DBE0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_40A3233404DDB201_OFFSET UNITYSDK_OFFSET(0x1709EB20)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_55357EED91DD300A_OFFSET UNITYSDK_OFFSET(0x1709EAA0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_594B16EC13924620_OFFSET UNITYSDK_OFFSET(0x1709E9A0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_5A4F244FA80C999D_OFFSET UNITYSDK_OFFSET(0x1709CC00)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7B23922E4C775970_OFFSET UNITYSDK_OFFSET(0x1709E1E0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7B79FC85A5EDBF4B_OFFSET UNITYSDK_OFFSET(0x1709F0D0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7C350CDAB199DC24_OFFSET UNITYSDK_OFFSET(0x1709E8D0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_A13A778D4D3E962F_OFFSET UNITYSDK_OFFSET(0x1709E810)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_A42DC4450468C0E0_OFFSET UNITYSDK_OFFSET(0x1709E330)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_B7E646E7463E1B89_OFFSET UNITYSDK_OFFSET(0x1709C5F0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_C76FBF5BDDCD86A3_OFFSET UNITYSDK_OFFSET(0x1709E690)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_D0E12D959862FC72_OFFSET UNITYSDK_OFFSET(0x1709DF70)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_DC4F7BE1519B0B0B_OFFSET UNITYSDK_OFFSET(0x1709E030)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_FEA73477BA929C29_OFFSET UNITYSDK_OFFSET(0x1709CE20)
#define CLASS_2_B078978DCA0CA7A4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1709F150)
#define CLASS_2_B078978DCA0CA7A4__CTOR_OFFSET UNITYSDK_OFFSET(0x1709C550)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4_TypeDefinitionIndex)->GetStaticField(0x5F170);
	}
	static ::System::String** StaticGet_EGEDJFGFDIN()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4_TypeDefinitionIndex)->GetStaticField(0x5F178);
	}
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_2_B078978DCA0CA7A4_Class_1_9D2500B7447E67F1*>* JNJHHADPJKL; // 0x18
	::RPG::GameCore::ComplexSkillAIAxis* IGHAHBNLIJA; // 0x20
	::Class_1_73D621BDD90E61A7* EMOAGCAHICO; // 0x28
