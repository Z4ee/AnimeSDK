...
#define CLASS_2_4B21C8B4C6451B1A_GET_REFERENCESTATE_OFFSET UNITYSDK_OFFSET(0x9822FE0)
#define CLASS_2_4B21C8B4C6451B1A_METHOD_2_457717A0CF438A7C_OFFSET UNITYSDK_OFFSET(0x98230B0)
#define CLASS_2_4B21C8B4C6451B1A_ONALLOC_OFFSET UNITYSDK_OFFSET(0x9823000)
#define CLASS_2_4B21C8B4C6451B1A_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x9823060)
#define CLASS_2_4B21C8B4C6451B1A_SET_REFERENCESTATE_OFFSET UNITYSDK_OFFSET(0x9822FF0)
#define CLASS_2_4B21C8B4C6451B1A__CTOR_OFFSET UNITYSDK_OFFSET(0x9823100)

inline static constexpr unsigned int Class_2_4B21C8B4C6451B1A_TypeDefinitionIndex = 54593;
