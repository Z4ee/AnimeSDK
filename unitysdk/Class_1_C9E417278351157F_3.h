...
#define CLASS_1_C9E417278351157F_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DF926F0)
#define CLASS_1_C9E417278351157F_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1DF92330)
#define CLASS_1_C9E417278351157F_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DF924A0)
#define CLASS_1_C9E417278351157F_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DF923C0)
#define CLASS_1_C9E417278351157F_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DF92570)
#define CLASS_1_C9E417278351157F_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DF92890)
#define CLASS_1_C9E417278351157F_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DF92850)
#define CLASS_1_C9E417278351157F_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DF923A0)
#define CLASS_1_C9E417278351157F_3_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1DF92390)
#define CLASS_1_C9E417278351157F_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DF922A0)
#define CLASS_1_C9E417278351157F_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DF923B0)
#define CLASS_1_C9E417278351157F_3_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1DF92380)
#define CLASS_1_C9E417278351157F_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DF922D0)
#define CLASS_1_C9E417278351157F_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DF925B0)
#define CLASS_1_C9E417278351157F_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DF92610)
#define CLASS_1_C9E417278351157F_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF92A10)
#define CLASS_1_C9E417278351157F_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF922F0)
#define CLASS_1_C9E417278351157F_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF922E0)

inline static constexpr unsigned int Class_1_C9E417278351157F_3_TypeDefinitionIndex = 26503;

class Class_1_C9E417278351157F_3 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_C9E417278351157F_3*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C9E417278351157F_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9E417278351157F_3_TypeDefinitionIndex)->GetStaticField(0x499B0);
	}
	// static const ::System::Int32 FFLAONFANIJ = 0xC; // 0x0
	// static const ::System::Int32 BBPEIEAMMLA = 0xF; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt32 GIBEGMIBKIM; // 0x18
	::System::Int64 IDODKKGNCHM; // 0x20
