...
#define CLASS_2_A039196385F1D3A2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11B8A8C0)
#define CLASS_2_A039196385F1D3A2_METHOD_2_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x11B8AD00)
#define CLASS_2_A039196385F1D3A2_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x11B8AC20)
#define CLASS_2_A039196385F1D3A2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11B8AA20)
#define CLASS_2_A039196385F1D3A2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11B8ADE0)
#define CLASS_2_A039196385F1D3A2_TICK_OFFSET UNITYSDK_OFFSET(0x11B8AEC0)
#define CLASS_2_A039196385F1D3A2__CTOR_OFFSET UNITYSDK_OFFSET(0x11B8A7D0)
...
public:
	...
	::RPG::GameCore::CheckIsMagicRogueAutoDressOpen* OFKGLJOAMLD; // 0x30
