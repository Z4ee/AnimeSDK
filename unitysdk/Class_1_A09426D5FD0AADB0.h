...
#define CLASS_1_A09426D5FD0AADB0_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC7CEEC0)
#define CLASS_1_A09426D5FD0AADB0_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC7CEE80)
#define CLASS_1_A09426D5FD0AADB0_TEARDOWN_OFFSET UNITYSDK_OFFSET(0xC7CF4F0)
#define CLASS_1_A09426D5FD0AADB0__CTOR_OFFSET UNITYSDK_OFFSET(0xC7CECC0)

inline static constexpr unsigned int Class_1_A09426D5FD0AADB0_TypeDefinitionIndex = 77306;

class Class_1_A09426D5FD0AADB0 : public ::System::Object
{
public:
	::Class_3_97041AE90E3B2214* PDENFEFCAGN; // 0x10
	::Class_1_EBA8C9C89C53F81F_1* FBHBOJMPCIM; // 0x18
	::Entitas::IGroup_1<::Class_2_5436AF4270279182*>* MGPDGDNOGJA; // 0x20
