...
#define CLASS_1_A09426D5FD0AADB0_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15E2E6B0)
#define CLASS_1_A09426D5FD0AADB0_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x15E2E670)
#define CLASS_1_A09426D5FD0AADB0_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x15E2ECE0)
#define CLASS_1_A09426D5FD0AADB0__CTOR_OFFSET UNITYSDK_OFFSET(0x15E2E4B0)

inline static constexpr unsigned int Class_1_A09426D5FD0AADB0_TypeDefinitionIndex = 77305;

class Class_1_A09426D5FD0AADB0 : public ::System::Object
{
public:
	::Class_1_EBA8C9C89C53F81F_1* FBHBOJMPCIM; // 0x10
	::Entitas::IGroup_1<::Class_2_5436AF4270279182*>* MGPDGDNOGJA; // 0x18
