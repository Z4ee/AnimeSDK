...
#define CLASS_2_DA985DC97C4A51A6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF392510)
#define CLASS_2_DA985DC97C4A51A6_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xF392550)
#define CLASS_2_DA985DC97C4A51A6_ONSKIP_OFFSET UNITYSDK_OFFSET(0xF392690)
#define CLASS_2_DA985DC97C4A51A6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF392560)
#define CLASS_2_DA985DC97C4A51A6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xF3925C0)
#define CLASS_2_DA985DC97C4A51A6_TICK_OFFSET UNITYSDK_OFFSET(0xF392610)
#define CLASS_2_DA985DC97C4A51A6__CTOR_OFFSET UNITYSDK_OFFSET(0xF392500)

inline static constexpr unsigned int Class_2_DA985DC97C4A51A6_TypeDefinitionIndex = 47558;
