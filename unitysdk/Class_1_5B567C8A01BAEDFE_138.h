...
#define CLASS_1_5B567C8A01BAEDFE_138_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1E5350)
#define CLASS_1_5B567C8A01BAEDFE_138_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1E51C0)
#define CLASS_1_5B567C8A01BAEDFE_138_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1E5260)
#define CLASS_1_5B567C8A01BAEDFE_138_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1E5200)
#define CLASS_1_5B567C8A01BAEDFE_138_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1E52B0)
#define CLASS_1_5B567C8A01BAEDFE_138_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1E53A0)
#define CLASS_1_5B567C8A01BAEDFE_138_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1E5370)
#define CLASS_1_5B567C8A01BAEDFE_138_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1E5140)
#define CLASS_1_5B567C8A01BAEDFE_138_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1E5170)
#define CLASS_1_5B567C8A01BAEDFE_138_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1E52E0)
#define CLASS_1_5B567C8A01BAEDFE_138_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1E5340)
#define CLASS_1_5B567C8A01BAEDFE_138__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E53F0)
#define CLASS_1_5B567C8A01BAEDFE_138__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1E5190)
#define CLASS_1_5B567C8A01BAEDFE_138__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E5180)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_138_TypeDefinitionIndex = 27291;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_138*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_138_TypeDefinitionIndex)->GetStaticField(0x37BE0);
	}
