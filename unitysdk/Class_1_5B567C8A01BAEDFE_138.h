...
#define CLASS_1_5B567C8A01BAEDFE_138_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1948AB10)
#define CLASS_1_5B567C8A01BAEDFE_138_CLONE_OFFSET UNITYSDK_OFFSET(0x1948A920)
#define CLASS_1_5B567C8A01BAEDFE_138_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1948AA20)
#define CLASS_1_5B567C8A01BAEDFE_138_EQUALS_OFFSET UNITYSDK_OFFSET(0x1948A990)
#define CLASS_1_5B567C8A01BAEDFE_138_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1948AA70)
#define CLASS_1_5B567C8A01BAEDFE_138_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1948AB60)
#define CLASS_1_5B567C8A01BAEDFE_138_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1948AB30)
#define CLASS_1_5B567C8A01BAEDFE_138_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1948A870)
#define CLASS_1_5B567C8A01BAEDFE_138_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1948A8D0)
#define CLASS_1_5B567C8A01BAEDFE_138_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1948AAA0)
#define CLASS_1_5B567C8A01BAEDFE_138_WRITETO_OFFSET UNITYSDK_OFFSET(0x1948AB00)
#define CLASS_1_5B567C8A01BAEDFE_138__CCTOR_OFFSET UNITYSDK_OFFSET(0x1948ABB0)
#define CLASS_1_5B567C8A01BAEDFE_138__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1948A8F0)
#define CLASS_1_5B567C8A01BAEDFE_138__CTOR_OFFSET UNITYSDK_OFFSET(0x1948A8E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_138_TypeDefinitionIndex = 27580;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_138*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_138_TypeDefinitionIndex)->GetStaticField(0x4CFD0);
	}
