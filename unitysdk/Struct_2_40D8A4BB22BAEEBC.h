...
#define STRUCT_2_40D8A4BB22BAEEBC_METHOD_2_961F4A46B813CAC8_OFFSET UNITYSDK_OFFSET(0x80E860)
#define STRUCT_2_40D8A4BB22BAEEBC__CTOR_OFFSET UNITYSDK_OFFSET(0x80E7D0)

inline static constexpr unsigned int Struct_2_40D8A4BB22BAEEBC_TypeDefinitionIndex = 81651;

struct alignas(8) Struct_2_40D8A4BB22BAEEBC
{
	::MoleMole::HollowChessboard::MatPropertyData* Field_2_2; // 0x10
