...
public:
	...
	{
		return (::RPG::Client::OnAssetOperationDelegate**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4938BD5B14CEBAD5___O_TypeDefinitionIndex)->GetStaticField(0x15A00);
	}
};
