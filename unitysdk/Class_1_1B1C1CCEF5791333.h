...
#define CLASS_1_1B1C1CCEF5791333_GET_CANFOCUS_OFFSET UNITYSDK_OFFSET(0x19C9A3B0)
#define CLASS_1_1B1C1CCEF5791333_GET_LABEL_OFFSET UNITYSDK_OFFSET(0x19C9A3A0)
#define CLASS_1_1B1C1CCEF5791333__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9A3C0)

inline static constexpr unsigned int Class_1_1B1C1CCEF5791333_TypeDefinitionIndex = 73370;
