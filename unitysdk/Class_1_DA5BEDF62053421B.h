...
#define CLASS_1_DA5BEDF62053421B_METHOD_1_14EDC9421BD42937_OFFSET UNITYSDK_OFFSET(0x1928F470)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_2BCCBFF50C5269AF_OFFSET UNITYSDK_OFFSET(0x1928F360)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1928F240)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_3E8B5E51DDF99D33_OFFSET UNITYSDK_OFFSET(0x1928F3C0)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_4D70E3D849E4E16D_OFFSET UNITYSDK_OFFSET(0x1928F570)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_66783CE1164CF60E_OFFSET UNITYSDK_OFFSET(0x1928F140)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_8EB301F084025F77_OFFSET UNITYSDK_OFFSET(0x1928F2D0)
#define CLASS_1_DA5BEDF62053421B_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1928F1D0)
#define CLASS_1_DA5BEDF62053421B__CTOR_OFFSET UNITYSDK_OFFSET(0x1928FAE0)
...
public:
	...
	::RPG::Client::EnvironmentSystemV1* OCFNGNEFLDI; // 0x18
	::EnviromentSystem::EnviromentProfile* HPOBPDGDONL; // 0x20
	::System::Action* FEBMANBKLPP; // 0x28
	::EnviromentSystem::EnviromentProfile* JDIIAGNIJBA; // 0x30
	::System::Boolean ALMEAKBOGKH; // 0x38
	::System::Int32 FNGCCGFFMOH; // 0x3C
	::RPG::GameCore::EnviromentControlPriority MNMMMFDIHOB; // 0x40
