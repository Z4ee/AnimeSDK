...
#define LIGHTPERFORMANCETESTUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47BE20)

inline static constexpr unsigned int LightPerformanceTestUnit_TypeDefinitionIndex = 47778;
