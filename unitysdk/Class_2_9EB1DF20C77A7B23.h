...
#define CLASS_2_9EB1DF20C77A7B23_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16051610)
#define CLASS_2_9EB1DF20C77A7B23_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16051650)
#define CLASS_2_9EB1DF20C77A7B23_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16051890)
#define CLASS_2_9EB1DF20C77A7B23_TICK_OFFSET UNITYSDK_OFFSET(0x160518E0)
#define CLASS_2_9EB1DF20C77A7B23__CTOR_OFFSET UNITYSDK_OFFSET(0x16051600)

inline static constexpr unsigned int Class_2_9EB1DF20C77A7B23_TypeDefinitionIndex = 50855;

class Class_2_9EB1DF20C77A7B23 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowOfferingClockieUpgradeHint* Field_2_0; // 0x18
