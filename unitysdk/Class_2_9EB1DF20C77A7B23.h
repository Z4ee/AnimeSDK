...
#define CLASS_2_9EB1DF20C77A7B23_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13813B50)
#define CLASS_2_9EB1DF20C77A7B23_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13813B90)
#define CLASS_2_9EB1DF20C77A7B23_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13813DD0)
#define CLASS_2_9EB1DF20C77A7B23_TICK_OFFSET UNITYSDK_OFFSET(0x13813E20)
#define CLASS_2_9EB1DF20C77A7B23__CTOR_OFFSET UNITYSDK_OFFSET(0x13813B40)

inline static constexpr unsigned int Class_2_9EB1DF20C77A7B23_TypeDefinitionIndex = 49800;

class Class_2_9EB1DF20C77A7B23 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ShowOfferingClockieUpgradeHint* Field_2_1; // 0x20
