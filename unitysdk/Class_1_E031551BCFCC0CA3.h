...
#define CLASS_1_E031551BCFCC0CA3__CTOR_OFFSET UNITYSDK_OFFSET(0x15508B80)
...
{
public:
	::RPGTools::Timeline::HeightLimitedTarget MCLLALGABAB; // 0x10
	::System::Single HBAMPJPOOLM; // 0x14
