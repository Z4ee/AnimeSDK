...
#define CLASS_3_2D3AF613CA4710C6_METHOD_3_FB1642A74D67A3A6_OFFSET UNITYSDK_OFFSET(0x14690930)
#define CLASS_3_2D3AF613CA4710C6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14690540)
#define CLASS_3_2D3AF613CA4710C6__CCTOR_OFFSET UNITYSDK_OFFSET(0x14690420)
#define CLASS_3_2D3AF613CA4710C6__CTOR_OFFSET UNITYSDK_OFFSET(0x14690510)

inline static constexpr unsigned int Class_3_2D3AF613CA4710C6_TypeDefinitionIndex = 52834;
...
public:
	...
	{
		return (::RPG::FuncBinder_4<::RPG::GameCore::GameEntity*, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_2D3AF613CA4710C6_TypeDefinitionIndex)->GetStaticField(0x6C030);
	}
