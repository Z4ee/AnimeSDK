...
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16BB6B10)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_GRIDFIGHTTRAIT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16BB7480)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_GRIDFIGHTTRAIT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16BB7410)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16BB7500)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16BB7470)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16BB7420)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16BB69D0)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB68F0)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x16BB6A10)

inline static constexpr unsigned int Class_2_FCA621F56128C675__CreateTraits_d__9_TypeDefinitionIndex = 62191;
...
public:
	...
	::Class_2_FCA621F56128C675* __4__this; // 0x20
	::System::Collections::Generic::IEnumerator_1<::RPG::Client::GridFightUnlockTraitMember*>* __7__wrap3; // 0x28
	::RPG::Client::GridFightRole* role; // 0x30
	::RPG::Client::GridFightTrait* __2__current; // 0x38
