...
#define CLASS_1_0F1C0A22A54565B8_METHOD_1_0004EB5BFAE95784_OFFSET UNITYSDK_OFFSET(0x1659DD90)
#define CLASS_1_0F1C0A22A54565B8_METHOD_1_0947F577F1E5AE4F_OFFSET UNITYSDK_OFFSET(0x1659DFB0)
#define CLASS_1_0F1C0A22A54565B8_METHOD_1_691734491BCED0DD_OFFSET UNITYSDK_OFFSET(0x1659DC40)
#define CLASS_1_0F1C0A22A54565B8_METHOD_1_8E2C129DE4FC3609_OFFSET UNITYSDK_OFFSET(0x1659DDF0)
#define CLASS_1_0F1C0A22A54565B8_METHOD_1_A7A48E71437C1EF5_OFFSET UNITYSDK_OFFSET(0x1659DD70)
#define CLASS_1_0F1C0A22A54565B8_METHOD_1_FEE2FA448C7D6C8E_OFFSET UNITYSDK_OFFSET(0x1659DD80)

inline static constexpr unsigned int Class_1_0F1C0A22A54565B8_TypeDefinitionIndex = 51732;
...
public:
	...
	{
		return (::MoleMole::Config::EffectPatternInfoConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0F1C0A22A54565B8_TypeDefinitionIndex)->GetStaticField(0x385B0);
	}
