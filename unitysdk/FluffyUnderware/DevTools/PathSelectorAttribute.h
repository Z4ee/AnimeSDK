...
#define FLUFFYUNDERWARE_DEVTOOLS_PATHSELECTORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69D1B0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PathSelectorAttribute_TypeDefinitionIndex = 28367;
