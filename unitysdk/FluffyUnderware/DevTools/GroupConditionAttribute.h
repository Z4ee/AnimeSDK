...
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA55D70)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EA55D80)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EA55D90)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA55D60)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int GroupConditionAttribute_TypeDefinitionIndex = 28934;
