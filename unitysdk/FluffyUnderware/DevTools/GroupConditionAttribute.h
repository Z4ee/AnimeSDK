...
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2D4810)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B2D4820)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B2D4830)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D4800)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int GroupConditionAttribute_TypeDefinitionIndex = 25836;
