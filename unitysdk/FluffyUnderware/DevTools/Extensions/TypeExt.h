...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_FIELDBYNAME_OFFSET UNITYSDK_OFFSET(0x1D691DD0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_FINDIENUMERABLE_OFFSET UNITYSDK_OFFSET(0x1D69B7B0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1D6938F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D6948D0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETENUMERABLETYPE_OFFSET UNITYSDK_OFFSET(0x1D694B00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETFIELDINCLUDINGBASECLASSES_OFFSET UNITYSDK_OFFSET(0x1D69B390)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETLOADEDASSEMBLIES_OFFSET UNITYSDK_OFFSET(0x1D69B090)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETLOADEDTYPES_OFFSET UNITYSDK_OFFSET(0x1D690B00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETMETHODINCLUDINGBASECLASSES_OFFSET UNITYSDK_OFFSET(0x1D69B180)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETPROPERTYINCLUDINGBASECLASSES_OFFSET UNITYSDK_OFFSET(0x1D69B4B0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_ISARRAYORLIST_OFFSET UNITYSDK_OFFSET(0x1D69B730)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_ISFRAMEWORKTYPE_OFFSET UNITYSDK_OFFSET(0x1D69B680)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_MATCHES_OFFSET UNITYSDK_OFFSET(0x1D69BBC0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_METHODBYNAME_OFFSET UNITYSDK_OFFSET(0x1D6902D0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_PROPERTYBYNAME_OFFSET UNITYSDK_OFFSET(0x1D691E10)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int TypeExt_TypeDefinitionIndex = 28412;
