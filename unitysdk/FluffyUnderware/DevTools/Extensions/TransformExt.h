...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_DELETECHILDREN_OFFSET UNITYSDK_OFFSET(0x1D69AE80)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_DESTROYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1D69AF80)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_UNDOABLESETPARENT_OFFSET UNITYSDK_OFFSET(0x1D69AE60)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int TransformExt_TypeDefinitionIndex = 28396;
