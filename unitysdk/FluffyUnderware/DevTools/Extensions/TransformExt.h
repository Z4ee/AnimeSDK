...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_DELETECHILDREN_OFFSET UNITYSDK_OFFSET(0x1B2D2B40)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_DESTROYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B2D2C40)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_UNDOABLESETPARENT_OFFSET UNITYSDK_OFFSET(0x1B2D2B20)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int TransformExt_TypeDefinitionIndex = 25902;
