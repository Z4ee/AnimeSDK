...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_FLOATEXT_ISBETWEEN0AND1_OFFSET UNITYSDK_OFFSET(0x1EA52630)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_FLOATEXT_ISBETWEEN_OFFSET UNITYSDK_OFFSET(0x1EA52650)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_FLOATEXT_REPEAT_OFFSET UNITYSDK_OFFSET(0x1EA52670)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int FloatExt_TypeDefinitionIndex = 29003;
