...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_ADDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B2D08C0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B2D09B0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B2D0600)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int ComponentExt_TypeDefinitionIndex = 25910;
