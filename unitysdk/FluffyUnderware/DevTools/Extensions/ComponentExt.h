...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_ADDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D698C00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D698CF0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1D698940)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int ComponentExt_TypeDefinitionIndex = 28404;
