...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_ANGLESIGNED_OFFSET UNITYSDK_OFFSET(0x1B2D39E0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_LEFTNORMAL_OFFSET UNITYSDK_OFFSET(0x1B2D3B10)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_RIGHTNORMAL_OFFSET UNITYSDK_OFFSET(0x1B2D3B30)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_ROTATE_OFFSET UNITYSDK_OFFSET(0x1B2D3B40)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_SNAP_OFFSET UNITYSDK_OFFSET(0x1B2D3960)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1B2D3BE0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int Vector2Ext_TypeDefinitionIndex = 25906;
