...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1D69A8E0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_INCLUDE_OFFSET UNITYSDK_OFFSET(0x1D69A9D0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SCALEBY_1_OFFSET UNITYSDK_OFFSET(0x1D69A940)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SCALEBY_OFFSET UNITYSDK_OFFSET(0x1D69A910)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETBETWEEN_OFFSET UNITYSDK_OFFSET(0x1D69A850)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1D69A8C0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1D69A8A0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1D69A8F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SET_OFFSET UNITYSDK_OFFSET(0x1D69A820)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SHIFTBY_1_OFFSET UNITYSDK_OFFSET(0x1D69A9B0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SHIFTBY_OFFSET UNITYSDK_OFFSET(0x1D69A980)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int RectExt_TypeDefinitionIndex = 28407;
