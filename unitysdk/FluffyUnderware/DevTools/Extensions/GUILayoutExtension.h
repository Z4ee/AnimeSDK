...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_AREA_1_OFFSET UNITYSDK_OFFSET(0x1D699570)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_AREA_OFFSET UNITYSDK_OFFSET(0x1D6994D0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_HORIZONTAL_1_OFFSET UNITYSDK_OFFSET(0x1D6996C0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1D699630)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1D699770)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GUILayoutExtension_TypeDefinitionIndex = 28414;
