...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_AREA_1_OFFSET UNITYSDK_OFFSET(0x1B2D1230)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_AREA_OFFSET UNITYSDK_OFFSET(0x1B2D1190)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_HORIZONTAL_1_OFFSET UNITYSDK_OFFSET(0x1B2D1380)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B2D12F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1B2D1430)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GUILayoutExtension_TypeDefinitionIndex = 25920;
