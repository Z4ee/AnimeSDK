...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_OBJECTEXT_DESTROY_1_OFFSET UNITYSDK_OFFSET(0x1D6981F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_OBJECTEXT_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D69A6F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_OBJECTEXT_TODUMPSTRING_OFFSET UNITYSDK_OFFSET(0x1D69A710)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int ObjectExt_TypeDefinitionIndex = 28398;
