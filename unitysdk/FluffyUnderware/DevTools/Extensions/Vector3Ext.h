...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_ANGLESIGNED_OFFSET UNITYSDK_OFFSET(0x1B2D3BF0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1B2D3DF0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_NOTAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1B2D3F00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_ROTATEAROUND_OFFSET UNITYSDK_OFFSET(0x1B2D3C80)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_TOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1B2D3DE0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int Vector3Ext_TypeDefinitionIndex = 25907;
