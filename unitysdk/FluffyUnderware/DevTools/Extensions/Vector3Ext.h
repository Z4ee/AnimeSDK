...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_ANGLESIGNED_OFFSET UNITYSDK_OFFSET(0x1D69BF30)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1D69C130)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_NOTAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1D69C240)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_ROTATEAROUND_OFFSET UNITYSDK_OFFSET(0x1D69BFC0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_TOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1D69C120)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int Vector3Ext_TypeDefinitionIndex = 28401;
