...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B2D14C0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B2D0730)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_UNDOABLECREATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B2D1700)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GameObjectExt_TypeDefinitionIndex = 25909;
