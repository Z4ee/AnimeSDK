...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D699800)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1D698A70)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_UNDOABLECREATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D699A40)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GameObjectExt_TypeDefinitionIndex = 28403;
