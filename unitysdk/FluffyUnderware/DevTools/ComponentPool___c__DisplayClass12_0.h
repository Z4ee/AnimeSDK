...
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D690AF0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL___C__DISPLAYCLASS12_0__ONAFTERDESERIALIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1D691120)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ComponentPool___c__DisplayClass12_0_TypeDefinitionIndex = 28385;
