...
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_CREATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B2D68E0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GETITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B2D6E10)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B2D6690)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1B2D66B0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B2D5EA0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B2D66D0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B2D66A0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1B2D66C0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D6E20)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PrefabPool_TypeDefinitionIndex = 25898;
