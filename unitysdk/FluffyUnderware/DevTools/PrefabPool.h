...
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_CREATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1EA57F30)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GETITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1EA58460)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1EA57CE0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1EA57D00)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EA574F0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EA57D20)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1EA57CF0)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1EA57D10)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA58470)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PrefabPool_TypeDefinitionIndex = 28996;
