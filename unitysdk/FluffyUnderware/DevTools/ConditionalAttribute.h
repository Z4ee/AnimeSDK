...
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_CONDITIONMET_OFFSET UNITYSDK_OFFSET(0x1EA4A930)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1EA4AA10)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA4A3B0)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EA4A590)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EA4A820)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA4A280)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ConditionalAttribute_TypeDefinitionIndex = 28920;
