...
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_CONDITIONMET_OFFSET UNITYSDK_OFFSET(0x1D691830)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1D691920)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D6912B0)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D691490)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D691720)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D691180)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ConditionalAttribute_TypeDefinitionIndex = 28316;
