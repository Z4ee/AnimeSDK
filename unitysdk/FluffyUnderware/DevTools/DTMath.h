...
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_1_OFFSET UNITYSDK_OFFSET(0x1B2CA540)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_2_OFFSET UNITYSDK_OFFSET(0x1B2CA560)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_3_OFFSET UNITYSDK_OFFSET(0x1B2CA5B0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_OFFSET UNITYSDK_OFFSET(0x1B2CA510)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LEFTTAN_OFFSET UNITYSDK_OFFSET(0x1B2CA420)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1B2CAE30)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1B2CAF20)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINEPOINTDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1B2CA960)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_MAPVALUE_OFFSET UNITYSDK_OFFSET(0x1B2CA630)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_PARALLELTRANSPORTFRAME_OFFSET UNITYSDK_OFFSET(0x1B2CA180)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_POINTINSIDETRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B2CB040)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RAYLINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1B2CAA40)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_REPEAT_OFFSET UNITYSDK_OFFSET(0x1B2CA4C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RIGHTTAN_OFFSET UNITYSDK_OFFSET(0x1B2CA470)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SHORTESTINTERSECTIONLINE_OFFSET UNITYSDK_OFFSET(0x1B2CAB60)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_1_OFFSET UNITYSDK_OFFSET(0x1B2CA6F0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_2_OFFSET UNITYSDK_OFFSET(0x1B2CA7F0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_OFFSET UNITYSDK_OFFSET(0x1B2CA650)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTMath_TypeDefinitionIndex = 25844;
