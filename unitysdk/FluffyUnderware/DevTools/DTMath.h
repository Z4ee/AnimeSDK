...
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_1_OFFSET UNITYSDK_OFFSET(0x1EA4B9A0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_2_OFFSET UNITYSDK_OFFSET(0x1EA4B9C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_3_OFFSET UNITYSDK_OFFSET(0x1EA4BA10)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_OFFSET UNITYSDK_OFFSET(0x1EA4B970)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LEFTTAN_OFFSET UNITYSDK_OFFSET(0x1EA4B880)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1EA4C290)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1EA4C380)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINEPOINTDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1EA4BDB0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_MAPVALUE_OFFSET UNITYSDK_OFFSET(0x1EA4BA80)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_PARALLELTRANSPORTFRAME_OFFSET UNITYSDK_OFFSET(0x1EA4B5D0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_POINTINSIDETRIANGLE_OFFSET UNITYSDK_OFFSET(0x1EA4C4A0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RAYLINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1EA4BE90)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_REPEAT_OFFSET UNITYSDK_OFFSET(0x1EA4B920)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RIGHTTAN_OFFSET UNITYSDK_OFFSET(0x1EA4B8D0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SHORTESTINTERSECTIONLINE_OFFSET UNITYSDK_OFFSET(0x1EA4BFB0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_1_OFFSET UNITYSDK_OFFSET(0x1EA4BB40)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_2_OFFSET UNITYSDK_OFFSET(0x1EA4BC40)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_OFFSET UNITYSDK_OFFSET(0x1EA4BAA0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTMath_TypeDefinitionIndex = 28942;
