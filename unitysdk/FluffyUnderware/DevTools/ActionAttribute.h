...
#define FLUFFYUNDERWARE_DEVTOOLS_ACTIONATTRIBUTE_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1EA49090)
#define FLUFFYUNDERWARE_DEVTOOLS_ACTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA49050)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ActionAttribute_TypeDefinitionIndex = 28917;
