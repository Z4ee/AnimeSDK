...
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_CLAMP_OFFSET UNITYSDK_OFFSET(0xA53B90)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA53D60)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_EQUALS_OFFSET UNITYSDK_OFFSET(0xA53D40)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA0E580)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_HIGH_OFFSET UNITYSDK_OFFSET(0xA53C30)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LENGTHPOSITIVE_OFFSET UNITYSDK_OFFSET(0xA53C90)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xA53C80)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LOW_OFFSET UNITYSDK_OFFSET(0xA53C00)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_POSITIVE_OFFSET UNITYSDK_OFFSET(0xA53BF0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_RANDOM_OFFSET UNITYSDK_OFFSET(0xA53C60)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_ZEROONE_OFFSET UNITYSDK_OFFSET(0x1EA55E50)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0xA53B70)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1EA560B0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1EA56150)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1EA56180)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1EA561A0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1EA56130)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1EA56110)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1EA560D0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1EA560F0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_SET_HIGH_OFFSET UNITYSDK_OFFSET(0xA53C40)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_SET_LOW_OFFSET UNITYSDK_OFFSET(0xA53C10)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA53CA0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA53B60)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xA53B50)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int IntRegion_TypeDefinitionIndex = 28951;
