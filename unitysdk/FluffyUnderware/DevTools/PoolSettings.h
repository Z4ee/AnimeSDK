...
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_AUTOCREATE_OFFSET UNITYSDK_OFFSET(0x1B2D64C0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_AUTOENABLEDISABLE_OFFSET UNITYSDK_OFFSET(0x1B2D64E0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_COUNTADJUSTMENTINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B2D6540)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_INITIALIZECOUNTCONSTRAINED_OFFSET UNITYSDK_OFFSET(0x1B2D64A0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_MAXIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2D6520)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_MINIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2D6500)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_MINITEMS_OFFSET UNITYSDK_OFFSET(0x1B2D6580)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_PREWARM_OFFSET UNITYSDK_OFFSET(0x1B2D6560)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1B2D65C0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B2D65A0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B2D6610)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1B2D65E0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_AUTOCREATE_OFFSET UNITYSDK_OFFSET(0x1B2D64D0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_AUTOENABLEDISABLE_OFFSET UNITYSDK_OFFSET(0x1B2D64F0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_COUNTADJUSTMENTINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B2D6550)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_INITIALIZECOUNTCONSTRAINED_OFFSET UNITYSDK_OFFSET(0x1B2D64B0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_MAXIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2D6530)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_MINIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2D6510)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_MINITEMS_OFFSET UNITYSDK_OFFSET(0x1B2D6590)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_PREWARM_OFFSET UNITYSDK_OFFSET(0x1B2D6570)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1B2D65D0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B2D65B0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1B2D4F50)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2D5E40)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D6470)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PoolSettings_TypeDefinitionIndex = 25856;
