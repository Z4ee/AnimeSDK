...
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_CREATEPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1B2D5BA0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_DELETEPOOLS_OFFSET UNITYSDK_OFFSET(0x1B2D60C0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_DELETEPOOL_OFFSET UNITYSDK_OFFSET(0x1B2D6140)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_FINDPOOLS_OFFSET UNITYSDK_OFFSET(0x1B2D5F20)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1B2D5A60)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GETUNIQUEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B2D5980)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_AUTOCREATEPOOLS_OFFSET UNITYSDK_OFFSET(0x1B2D4EE0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B2D4FA0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B2D4F00)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B2D4F80)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B2D5230)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B2D5030)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B2D4FE0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1B2D5020)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_AUTOCREATEPOOLS_OFFSET UNITYSDK_OFFSET(0x1B2D4EF0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B2D4F10)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B2D4F90)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B2D5040)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D62C0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PoolManager_TypeDefinitionIndex = 25897;
