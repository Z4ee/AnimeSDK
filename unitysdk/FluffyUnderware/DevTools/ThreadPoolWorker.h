...
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA591C0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_DONEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1EA58FC0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_HANDLEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1EA590D0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_1_OFFSET UNITYSDK_OFFSET(0x1EA58B00)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_2_OFFSET UNITYSDK_OFFSET(0x1EA58BD0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_3_OFFSET UNITYSDK_OFFSET(0x1EA58A90)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_4_OFFSET UNITYSDK_OFFSET(0x1EA58B10)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1EA58A20)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x1EA58CF0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_1_OFFSET UNITYSDK_OFFSET(0x1EA58F70)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_2_OFFSET UNITYSDK_OFFSET(0x1EA58DA0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_OFFSET UNITYSDK_OFFSET(0x1EA58D90)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA591F0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ThreadPoolWorker_TypeDefinitionIndex = 28982;
