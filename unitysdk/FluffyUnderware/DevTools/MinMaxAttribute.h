...
#define FLUFFYUNDERWARE_DEVTOOLS_MINMAXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69D0C0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int MinMaxAttribute_TypeDefinitionIndex = 28364;
