...
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA555F0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EA55600)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EA55610)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA555B0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FieldConditionAttribute_TypeDefinitionIndex = 28933;
