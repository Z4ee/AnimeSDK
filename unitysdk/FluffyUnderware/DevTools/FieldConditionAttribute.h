...
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2D4090)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B2D40A0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B2D40B0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D4050)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FieldConditionAttribute_TypeDefinitionIndex = 25835;
