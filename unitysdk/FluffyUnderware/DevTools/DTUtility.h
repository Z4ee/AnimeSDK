...
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1EA511C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1EA50AB0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHANDLESIZE_1_OFFSET UNITYSDK_OFFSET(0x1EA50F70)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHANDLESIZE_OFFSET UNITYSDK_OFFSET(0x1EA50AD0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHELPURL_1_OFFSET UNITYSDK_OFFSET(0x1EA510F0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHELPURL_OFFSET UNITYSDK_OFFSET(0x1EA510C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GET_ISEDITORSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1EA50AC0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GET_ISINEDITMODE_OFFSET UNITYSDK_OFFSET(0x1EA51310)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_RANDOMSIGN_OFFSET UNITYSDK_OFFSET(0x1EA51090)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTUtility_TypeDefinitionIndex = 28939;
