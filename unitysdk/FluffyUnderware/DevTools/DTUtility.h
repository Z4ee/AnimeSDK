...
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1D697FB0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D6978B0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHANDLESIZE_1_OFFSET UNITYSDK_OFFSET(0x1D697D70)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHANDLESIZE_OFFSET UNITYSDK_OFFSET(0x1D6978D0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHELPURL_1_OFFSET UNITYSDK_OFFSET(0x1D697EE0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHELPURL_OFFSET UNITYSDK_OFFSET(0x1D697EB0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GET_ISEDITORSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1D6978C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GET_ISINEDITMODE_OFFSET UNITYSDK_OFFSET(0x1D698100)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_RANDOMSIGN_OFFSET UNITYSDK_OFFSET(0x1D697E90)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTUtility_TypeDefinitionIndex = 28335;
