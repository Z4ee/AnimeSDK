...
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ADD_OFFSET UNITYSDK_OFFSET(0x1F493E10)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_GETSLOT_OFFSET UNITYSDK_OFFSET(0x1F493BD0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F493860)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1F4938A0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONSPLINEREFRESH_OFFSET UNITYSDK_OFFSET(0x1F493A60)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F493620)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_REMOVE_OFFSET UNITYSDK_OFFSET(0x1F494030)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_SANITIZE_OFFSET UNITYSDK_OFFSET(0x1F493630)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4941A0)

namespace FluffyUnderware::Curvy::Components
{
	inline static constexpr unsigned int CurvyGLRenderer_TypeDefinitionIndex = 39603;
