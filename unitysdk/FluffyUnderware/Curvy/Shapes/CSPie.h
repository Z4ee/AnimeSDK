...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1DB19610)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_CPPOSITION_OFFSET UNITYSDK_OFFSET(0x1DB19550)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_EAT_OFFSET UNITYSDK_OFFSET(0x1DB19530)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1DB194F0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_MAXEMPTY_OFFSET UNITYSDK_OFFSET(0x1DB19520)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1DB194B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_EAT_OFFSET UNITYSDK_OFFSET(0x1DB19540)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1DB19500)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1DB194C0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB1B190)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSPie_TypeDefinitionIndex = 38973;
