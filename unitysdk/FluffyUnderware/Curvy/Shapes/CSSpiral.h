...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1DB59EF0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1DB59E50)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DB59E20)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1DB59EB0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1DB59E80)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_Z_OFFSET UNITYSDK_OFFSET(0x1DB59ED0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1DB59E60)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DB59E30)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1DB59EC0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1DB59E90)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_Z_OFFSET UNITYSDK_OFFSET(0x1DB59EE0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB5A190)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSSpiral_TypeDefinitionIndex = 38789;
