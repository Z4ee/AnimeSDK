...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1B7CFB40)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1B7CFAA0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B7CFA70)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1B7CFB00)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B7CFAD0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_Z_OFFSET UNITYSDK_OFFSET(0x1B7CFB20)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1B7CFAB0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B7CFA80)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1B7CFB10)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B7CFAE0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_Z_OFFSET UNITYSDK_OFFSET(0x1B7CFB30)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7CFDE0)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSSpiral_TypeDefinitionIndex = 37245;
