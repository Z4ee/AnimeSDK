...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1C31F1D0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C31F170)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1C31F1A0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C31F180)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1C31F1B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C31F470)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSCircle_TypeDefinitionIndex = 37240;
