...
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1EFB88B0)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0x1EFB8350)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1EFB8020)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EFB8CE0)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EFB8B70)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_ONSPLINECOORDINATESCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFB8700)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_ONSPLINEREFRESH_OFFSET UNITYSDK_OFFSET(0x1EFB85B0)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EFB8E20)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_PROCESSEVENT_OFFSET UNITYSDK_OFFSET(0x1EFB8660)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1EFB8030)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_START_OFFSET UNITYSDK_OFFSET(0x1EFB8E60)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_UNBINDEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1EFB87A0)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR_UNBINDEVENTS_OFFSET UNITYSDK_OFFSET(0x1EFB8210)
#define FLUFFYUNDERWARE_CURVY_SPLINEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB8E70)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int SplineProcessor_TypeDefinitionIndex = 39614;
