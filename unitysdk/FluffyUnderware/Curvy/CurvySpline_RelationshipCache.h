...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_ENSUREISVALID_OFFSET UNITYSDK_OFFSET(0x1BB1E7D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_GET_FIRSTSEGMENT_OFFSET UNITYSDK_OFFSET(0x1BB1E800)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_GET_FIRSTVISIBLECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1BB1E7B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BB1E840)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_GET_LASTSEGMENT_OFFSET UNITYSDK_OFFSET(0x1BB1E820)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_GET_LASTVISIBLECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1BB1E7E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_INVALIDATE_OFFSET UNITYSDK_OFFSET(0x1BB1E890)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_REBUILDANDFIXNONCOHERENTCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1BB1E950)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BB1E850)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_RELATIONSHIPCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1E860)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_RelationshipCache_TypeDefinitionIndex = 37220;

	class CurvySpline_RelationshipCache : public ::System::Object
	{
	public:
		::FluffyUnderware::Curvy::CurvySplineSegment* firstVisibleControlPoint; // 0x10
