...
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1E673C70)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E673C30)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_PROCESS_OFFSET UNITYSDK_OFFSET(0x1E6737B0)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E673C20)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E673C80)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int NearestSplinePoint_TypeDefinitionIndex = 39010;
