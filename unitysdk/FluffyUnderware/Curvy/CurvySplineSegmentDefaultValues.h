...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENTDEFAULTVALUES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E88B640)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegmentDefaultValues_TypeDefinitionIndex = 38804;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(CurvySplineSegmentDefaultValues_TypeDefinitionIndex)->GetStaticField(0x92F0);
		}
		static ::UnityEngine::Vector3* StaticGet_HandleOut()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(CurvySplineSegmentDefaultValues_TypeDefinitionIndex)->GetStaticField(0x92FC);
		}
