...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTODYNAMIC_OFFSET UNITYSDK_OFFSET(0x1BC16340)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTONONE_OFFSET UNITYSDK_OFFSET(0x1BC15FA0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTOSTATIC_OFFSET UNITYSDK_OFFSET(0x1BC160B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOINTTANGENTANDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1BC167E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1BC15230)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBSPLINE_OFFSET UNITYSDK_OFFSET(0x1BC15810)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1BC14360)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1BC13F50)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOPOINT_OFFSET UNITYSDK_OFFSET(0x1BC13E00)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOTCB_OFFSET UNITYSDK_OFFSET(0x1BC149C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTPRECISETANGENTS_OFFSET UNITYSDK_OFFSET(0x1BC175B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTTANGENTSANDDISTANCES_OFFSET UNITYSDK_OFFSET(0x1BC16FB0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1BC17C20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1BC181B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1BC18980)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOTCB_OFFSET UNITYSDK_OFFSET(0x1BC184F0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_ApproximationsSetter_TypeDefinitionIndex = 37230;
