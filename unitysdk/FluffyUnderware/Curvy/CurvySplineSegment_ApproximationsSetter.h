...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTODYNAMIC_OFFSET UNITYSDK_OFFSET(0x1DF509A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTONONE_OFFSET UNITYSDK_OFFSET(0x1DF50600)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTOSTATIC_OFFSET UNITYSDK_OFFSET(0x1DF50710)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOINTTANGENTANDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1DF50E40)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1DF4F890)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBSPLINE_OFFSET UNITYSDK_OFFSET(0x1DF4FE70)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1DF4E9C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1DF4E5B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOPOINT_OFFSET UNITYSDK_OFFSET(0x1DF4E460)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOTCB_OFFSET UNITYSDK_OFFSET(0x1DF4F020)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTPRECISETANGENTS_OFFSET UNITYSDK_OFFSET(0x1DF51C10)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTTANGENTSANDDISTANCES_OFFSET UNITYSDK_OFFSET(0x1DF51610)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1DF52280)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1DF52810)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1DF52FE0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOTCB_OFFSET UNITYSDK_OFFSET(0x1DF52B50)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_ApproximationsSetter_TypeDefinitionIndex = 39027;
