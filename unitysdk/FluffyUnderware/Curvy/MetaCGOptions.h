...
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B737470)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_CANHAVEUVEDGEORHADRDEDGE_OFFSET UNITYSDK_OFFSET(0x1B736D70)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_ENSUREUVEDGEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B737490)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GETDEFINEDFIRSTU_OFFSET UNITYSDK_OFFSET(0x1B737730)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GETDEFINEDSECONDU_OFFSET UNITYSDK_OFFSET(0x1B737770)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_CORRECTEDHARDEDGE_OFFSET UNITYSDK_OFFSET(0x1B736D40)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_CORRECTEDUVEDGE_OFFSET UNITYSDK_OFFSET(0x1B736EE0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_EXPLICITU_OFFSET UNITYSDK_OFFSET(0x1B736F10)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_FIRSTU_OFFSET UNITYSDK_OFFSET(0x1B736F40)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_HARDEDGE_OFFSET UNITYSDK_OFFSET(0x1B736D10)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_HASDIFFERENTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B736FE0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_MATERIALID_OFFSET UNITYSDK_OFFSET(0x1B736CE0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_MAXSTEPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B736FA0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_SECONDU_OFFSET UNITYSDK_OFFSET(0x1B736F70)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_SHOWEXPLICITU_OFFSET UNITYSDK_OFFSET(0x1B737260)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_SHOWFIRSTU_OFFSET UNITYSDK_OFFSET(0x1B7373E0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_SHOWSECONDU_OFFSET UNITYSDK_OFFSET(0x1B7373B0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_SHOWUVEDGEORHARDEDGE_OFFSET UNITYSDK_OFFSET(0x1B737120)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_GET_UVEDGE_OFFSET UNITYSDK_OFFSET(0x1B736EB0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B737430)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B737420)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_RESETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B737640)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_RESET_OFFSET UNITYSDK_OFFSET(0x1B737610)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_EXPLICITU_OFFSET UNITYSDK_OFFSET(0x1B736F20)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_FIRSTU_OFFSET UNITYSDK_OFFSET(0x1B736F50)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_HARDEDGE_OFFSET UNITYSDK_OFFSET(0x1B736D20)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_MATERIALID_OFFSET UNITYSDK_OFFSET(0x1B736CF0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_MAXSTEPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B736FB0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_SECONDU_OFFSET UNITYSDK_OFFSET(0x1B736F80)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS_SET_UVEDGE_OFFSET UNITYSDK_OFFSET(0x1B736EC0)
#define FLUFFYUNDERWARE_CURVY_METACGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7377D0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int MetaCGOptions_TypeDefinitionIndex = 37174;
