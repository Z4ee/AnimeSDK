...
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ADDCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3B4910)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_AUTOSETFOLLOWUP_OFFSET UNITYSDK_OFFSET(0x1E3B4BF0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1E3B44A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x1E3B5580)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3B4280)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3B42E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_CONTROLPOINTSLIST_OFFSET UNITYSDK_OFFSET(0x1E3B4000)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E3B4060)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E3B4080)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3B42A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E3B58E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E3B57D0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E3B4320)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E3B41C0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E3B40E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONSCENELOADED_OFFSET UNITYSDK_OFFSET(0x1E3B5AB0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_OTHERCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3B55A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_REMOVECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1E3B5310)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_REMOVENULLCPS_OFFSET UNITYSDK_OFFSET(0x1E3B57E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1E3B5D10)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_SETSYNCHRONISATIONPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1E3B56B0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_SETSYNCHRONIZATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1E3B51A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E3B4240)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3B3D90)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyConnection_TypeDefinitionIndex = 38797;
