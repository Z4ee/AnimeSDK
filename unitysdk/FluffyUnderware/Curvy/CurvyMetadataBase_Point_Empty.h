...
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_EMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1CB3B0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyMetadataBase_Point_Empty_TypeDefinitionIndex = 38995;
