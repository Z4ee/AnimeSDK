...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1DC88640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1DC889D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1DC885D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC88630)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceLoader_TypeDefinitionIndex = 38860;
