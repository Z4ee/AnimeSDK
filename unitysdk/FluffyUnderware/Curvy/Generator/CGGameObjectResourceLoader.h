...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1EFADB20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1EFADEB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1EFADAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFADB10)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceLoader_TypeDefinitionIndex = 39547;
