...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_CHECKDATATYPES_OFFSET UNITYSDK_OFFSET(0x1E6736B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1E673630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_GET_DATATYPES_OFFSET UNITYSDK_OFFSET(0x1E6734D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1E670990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1E673590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E6735E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E6735F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6735A0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SlotInfo_TypeDefinitionIndex = 38942;
