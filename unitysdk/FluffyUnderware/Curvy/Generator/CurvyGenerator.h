...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ADDMODULE_1_OFFSET UNITYSDK_OFFSET(0x1F40B5F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ADDMODULE_OFFSET UNITYSDK_OFFSET(0x1F40B4B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ARRANGEMODULES_OFFSET UNITYSDK_OFFSET(0x1F40BD50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1F40CF70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CORRECTDUPLICATEMODULEIDS_OFFSET UNITYSDK_OFFSET(0x1F40DBD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1F40B290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEALLOUTPUTMANAGEDRESOURCESFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1F40F4A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1F40ECD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETELINK_OFFSET UNITYSDK_OFFSET(0x1F40D1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEMODULE_OFFSET UNITYSDK_OFFSET(0x1F40D080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEOUTPUTSLOT_1_OFFSET UNITYSDK_OFFSET(0x1F40D960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1F40D810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULES_1_OFFSET UNITYSDK_OFFSET(0x1F40D6B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULES_OFFSET UNITYSDK_OFFSET(0x1F40D6A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1F40B9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1F40BB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_1_OFFSET UNITYSDK_OFFSET(0x1F40D4E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_2_OFFSET UNITYSDK_OFFSET(0x1F40D800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_3_OFFSET UNITYSDK_OFFSET(0x1F40A350)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_OFFSET UNITYSDK_OFFSET(0x1F40D7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETUNIQUEMODULENAMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F40EF00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_AUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1F40A750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_DESTROYING_OFFSET UNITYSDK_OFFSET(0x1F40A970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_HASMODULESWITHSAMEID_OFFSET UNITYSDK_OFFSET(0x1F40F2E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1F40A960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_MODULESBYID_OFFSET UNITYSDK_OFFSET(0x1F40A990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_M_LASTMODULEID_OFFSET UNITYSDK_OFFSET(0x1F40A5D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1F40A940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_POOLMANAGER_OFFSET UNITYSDK_OFFSET(0x1F40A7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_REFRESHDELAYEDITOR_OFFSET UNITYSDK_OFFSET(0x1F40A790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1F40A770)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_SHOWDEBUG_OFFSET UNITYSDK_OFFSET(0x1F40A5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_HASCIRCULARREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F40F280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1F40AEA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ISMODULENAMEUNIQUE_OFFSET UNITYSDK_OFFSET(0x1F40EE10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F40ADB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F40ADA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F40ABD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1F40EC70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0x1F40E850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REMOVEMODULE_OFFSET UNITYSDK_OFFSET(0x1F40BCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REORDERENDPOINTRECURSIVEINPUTS_OFFSET UNITYSDK_OFFSET(0x1F40CAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REORDERMODULES_OFFSET UNITYSDK_OFFSET(0x1F40BFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_RESETALLMODULELINKS_OFFSET UNITYSDK_OFFSET(0x1F40E750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1F40EEC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SAVEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1F40F4B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SETMODULESFROMCHILDREN_OFFSET UNITYSDK_OFFSET(0x1F40DAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_AUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1F40A760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_DESTROYING_OFFSET UNITYSDK_OFFSET(0x1F40A980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_MODULESBYID_OFFSET UNITYSDK_OFFSET(0x1F40AB80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_M_LASTMODULEID_OFFSET UNITYSDK_OFFSET(0x1F40A700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1F40A950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_REFRESHDELAYEDITOR_OFFSET UNITYSDK_OFFSET(0x1F40A7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1F40A780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_SHOWDEBUG_OFFSET UNITYSDK_OFFSET(0x1F40A5C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SORTMODULESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F40F260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TRYAUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1F40B1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_UPDATEMODULESRECURSIVEINPUTS_OFFSET UNITYSDK_OFFSET(0x1F40C740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F40ADC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F40F880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR__SETMODULESFROMCHILDREN_B__89_0_OFFSET UNITYSDK_OFFSET(0x1F40FA40)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_TypeDefinitionIndex = 39650;
