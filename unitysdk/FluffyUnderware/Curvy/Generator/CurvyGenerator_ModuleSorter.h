...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_ENSUREISSORTED_OFFSET UNITYSDK_OFFSET(0x1F5F1980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_ENSURELINKEDSLOTSBUILD_OFFSET UNITYSDK_OFFSET(0x1F5F2C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_GET_SORTINGNEEDED_OFFSET UNITYSDK_OFFSET(0x1F5F1900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_HASCIRCULARREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F5F1920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_SET_SORTINGNEEDED_OFFSET UNITYSDK_OFFSET(0x1F5F1910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_SORT_OFFSET UNITYSDK_OFFSET(0x1F5F19A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5F2F60)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_ModuleSorter_TypeDefinitionIndex = 39655;
