...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1DE90F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1DE91090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1DE90EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE90F50)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGShapeResourceLoader_TypeDefinitionIndex = 38836;
