...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1BB1F3A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1BB1F4D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1BB1F330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1F390)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGShapeResourceLoader_TypeDefinitionIndex = 37339;
