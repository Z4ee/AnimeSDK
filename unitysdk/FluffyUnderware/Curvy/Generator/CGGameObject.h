...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1F7A72B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1F7A7780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F7A73E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F7A7630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F7A7450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1F7A7690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7A73C0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObject_TypeDefinitionIndex = 39515;

	class CGGameObject : public ::FluffyUnderware::Curvy::Generator::CGBounds
	{
	public:
		::UnityEngine::GameObject* Object; // 0x40
		::UnityEngine::Vector3 Rotate; // 0x48
		::UnityEngine::Vector3 Translate; // 0x54
