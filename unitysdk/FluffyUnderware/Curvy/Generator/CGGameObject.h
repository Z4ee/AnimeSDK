...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1C0BAEC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C0BB390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0BAFF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C0BB240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C0BB060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C0BB2A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0BAFD0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObject_TypeDefinitionIndex = 37304;
