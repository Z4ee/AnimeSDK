...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ARESLOTSCOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1F497600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1F4974A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_SLOTNAME_OFFSET UNITYSDK_OFFSET(0x1F4974B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_TARGETMODULEID_OFFSET UNITYSDK_OFFSET(0x1F4974C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_TARGETSLOTNAME_OFFSET UNITYSDK_OFFSET(0x1F4974D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISBETWEEN_OFFSET UNITYSDK_OFFSET(0x1F497A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISFROM_OFFSET UNITYSDK_OFFSET(0x1F497950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISSAME_1_OFFSET UNITYSDK_OFFSET(0x1F4976F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISSAME_OFFSET UNITYSDK_OFFSET(0x1F497660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISTO_OFFSET UNITYSDK_OFFSET(0x1F497890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISUSING_OFFSET UNITYSDK_OFFSET(0x1F497A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1F497D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_SETMODULEIDIINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F497D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F497D90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F497500)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4974E0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleLink_TypeDefinitionIndex = 39508;
