...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTPARAMETER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1EEBD930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEBD940)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestParameter_TypeDefinitionIndex = 39662;
