...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_COPY_OFFSET UNITYSDK_OFFSET(0x1BB1F290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1BB1F050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1BB1F110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BB1F270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_SET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1BB1F0F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BB1F1B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BB1F1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1F1A0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGBounds_TypeDefinitionIndex = 37290;
