...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_ADD_OFFSET UNITYSDK_OFFSET(0x1B7C94E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B7C91E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B7C8D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_OFFSET UNITYSDK_OFFSET(0x1B7C9360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_TRIANGLESLIST_OFFSET UNITYSDK_OFFSET(0x1B7C8AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_TRIANGLES_OFFSET UNITYSDK_OFFSET(0x1B7C8BC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_SET_TRIANGLESLIST_OFFSET UNITYSDK_OFFSET(0x1B7C8AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_SET_TRIANGLES_OFFSET UNITYSDK_OFFSET(0x1B7C8CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_SHIFTINDICES_OFFSET UNITYSDK_OFFSET(0x1B7C9490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B7C8EC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B7C8F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B7C8F50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B7C9080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C8D90)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVSubMesh_TypeDefinitionIndex = 37346;
