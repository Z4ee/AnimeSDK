...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INFORMATIONPROVIDER_GETINFORMATION_OFFSET UNITYSDK_OFFSET(0x1DC8E1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INFORMATIONPROVIDER_GET_INFORMATION_OFFSET UNITYSDK_OFFSET(0x1DC89280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INFORMATIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC8BD90)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_InformationProvider_TypeDefinitionIndex = 38903;
