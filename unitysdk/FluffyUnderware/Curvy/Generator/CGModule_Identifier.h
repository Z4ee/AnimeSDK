...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_GET_ID_OFFSET UNITYSDK_OFFSET(0x1E5645E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_GET_STRINGID_OFFSET UNITYSDK_OFFSET(0x1E564630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_RESET_OFFSET UNITYSDK_OFFSET(0x1E564690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_SET_ID_OFFSET UNITYSDK_OFFSET(0x1E564600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E564680)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_Identifier_TypeDefinitionIndex = 39714;
