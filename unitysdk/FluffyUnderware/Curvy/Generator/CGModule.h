...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ADDMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1DC8CAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DC8A0A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_CHECKONSTATECHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DC8D3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1DC8C850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DECREMENTCHILDS_OFFSET UNITYSDK_OFFSET(0x1DC8D780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1DC8B880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1DC8CE40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1DC8B030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETE_OFFSET UNITYSDK_OFFSET(0x1DC8CFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x1DC8D1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1DC8CD60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINFO_OFFSET UNITYSDK_OFFSET(0x1DC892B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1DC8C7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINK_OFFSET UNITYSDK_OFFSET(0x1DC8C6D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1DC89650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1DC8CFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINKS_OFFSET UNITYSDK_OFFSET(0x1DC8C620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINK_OFFSET UNITYSDK_OFFSET(0x1DC8C510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1DC8A830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1DC8C5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINK_OFFSET UNITYSDK_OFFSET(0x1DC8C400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1DC89840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1DC8CFF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1DC8D020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETRESOURCEMANAGERS_OFFSET UNITYSDK_OFFSET(0x1DC8BDA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1DC89CE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1DC89FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1DC89DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_GENERATOR_OFFSET UNITYSDK_OFFSET(0x1DC886F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1DC89240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1DC8A060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUT_OFFSET UNITYSDK_OFFSET(0x1DC89800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1DC89DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1DC89E90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1DC89AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1DC899F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1DC89A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1DC8A080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1DC89820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1DC89DA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1DC89D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1DC89EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZESORT_OFFSET UNITYSDK_OFFSET(0x1DC8D580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1DC8A1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ISMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1DC8CBD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONBEFOREREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1DC89A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DC8A3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DC8A0B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1DC89A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1DC8B890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1DC8B8F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1DC8B1A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1DC8B820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REINITIALIZELINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1DC89630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REMOVEREQUESTPARAMETER_OFFSET UNITYSDK_OFFSET(0x1DC8B900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMEMANAGEDRESOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DC89380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMERESOURCE_OFFSET UNITYSDK_OFFSET(0x1DC89610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1DC8D410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1DC8B250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETMODULENAME_OFFSET UNITYSDK_OFFSET(0x1DC8BF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETUNIQUEIDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DC890D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1DC89CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1DC8A010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1DC89D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1DC89B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1DC89A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1DC89A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1DC89DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1DC89D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1DC89ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_TRYDELETECHILDRENFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1DC8D1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DC8B240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_USESRANDOM_OFFSET UNITYSDK_OFFSET(0x1DC8D500)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC8DF70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC8B980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__RESET_B__80_0_OFFSET UNITYSDK_OFFSET(0x1DC8E100)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_TypeDefinitionIndex = 38898;
