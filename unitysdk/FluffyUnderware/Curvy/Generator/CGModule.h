...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ADDMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1EFB1F90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1EFAF580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_CHECKONSTATECHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EFB28C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1EFB1D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DECREMENTCHILDS_OFFSET UNITYSDK_OFFSET(0x1EFB2C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1EFB0D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1EFB2330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1EFB0510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETE_OFFSET UNITYSDK_OFFSET(0x1EFB2490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x1EFB26C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1EFB2250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINFO_OFFSET UNITYSDK_OFFSET(0x1EFAE790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1EFB1CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINK_OFFSET UNITYSDK_OFFSET(0x1EFB1BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1EFAEB30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1EFB24C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINKS_OFFSET UNITYSDK_OFFSET(0x1EFB1B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINK_OFFSET UNITYSDK_OFFSET(0x1EFB19F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1EFAFD10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1EFB1A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINK_OFFSET UNITYSDK_OFFSET(0x1EFB18E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1EFAED20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1EFB24E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1EFB2510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETRESOURCEMANAGERS_OFFSET UNITYSDK_OFFSET(0x1EFB1280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1EFAF1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1EFAF480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1EFAF2A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_GENERATOR_OFFSET UNITYSDK_OFFSET(0x1EFADBD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EFAE720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1EFAF540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUT_OFFSET UNITYSDK_OFFSET(0x1EFAECE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1EFAF2C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1EFAF370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1EFAEFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1EFAEED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1EFAEEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1EFAF560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1EFAED00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1EFAF280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1EFAF240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1EFAF380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZESORT_OFFSET UNITYSDK_OFFSET(0x1EFB2A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EFAF6D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ISMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1EFB20C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONBEFOREREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1EFAEF10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EFAF8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EFAF590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1EFAEF70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1EFB0D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1EFB0DD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EFB0680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1EFB0D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REINITIALIZELINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1EFAEB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REMOVEREQUESTPARAMETER_OFFSET UNITYSDK_OFFSET(0x1EFB0DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMEMANAGEDRESOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EFAE860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMERESOURCE_OFFSET UNITYSDK_OFFSET(0x1EFAEAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1EFB2900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1EFB0730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETMODULENAME_OFFSET UNITYSDK_OFFSET(0x1EFB1470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETUNIQUEIDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EFAE5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1EFAF1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1EFAF4F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1EFAF220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1EFAF030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1EFAEEE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1EFAEF00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1EFAF290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1EFAF250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1EFAF3B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_TRYDELETECHILDRENFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1EFB26B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1EFB0720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_USESRANDOM_OFFSET UNITYSDK_OFFSET(0x1EFB29F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EFB33F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB0E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__RESET_B__80_0_OFFSET UNITYSDK_OFFSET(0x1EFB3580)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_TypeDefinitionIndex = 39708;
