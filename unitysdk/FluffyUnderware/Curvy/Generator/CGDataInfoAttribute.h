...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F7A7260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F7A7280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7A7250)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataInfoAttribute_TypeDefinitionIndex = 39697;
