...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1C319CD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GETLENGTHS_OFFSET UNITYSDK_OFFSET(0x1C319AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_ENDVERTEX_OFFSET UNITYSDK_OFFSET(0x1C3199B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_STARTVERTEX_OFFSET UNITYSDK_OFFSET(0x1C319980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1C3197F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1C3199F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C319AA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C319A30)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsMaterialGroup_TypeDefinitionIndex = 37374;
