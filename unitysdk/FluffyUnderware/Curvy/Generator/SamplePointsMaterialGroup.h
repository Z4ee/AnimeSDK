...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1FA52F10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GETLENGTHS_OFFSET UNITYSDK_OFFSET(0x1FA52D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_ENDVERTEX_OFFSET UNITYSDK_OFFSET(0x1FA52C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_STARTVERTEX_OFFSET UNITYSDK_OFFSET(0x1FA52C10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1FA52B40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1FA52C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FA52D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA52CC0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsMaterialGroup_TypeDefinitionIndex = 39483;
