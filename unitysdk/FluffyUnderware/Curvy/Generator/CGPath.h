...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_COPY_OFFSET UNITYSDK_OFFSET(0x1E670FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E670F10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1E6709B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1E670AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1E6715C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_1_OFFSET UNITYSDK_OFFSET(0x1E671420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1E671130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1E6709C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1E670C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E670DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E670C90)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGPath_TypeDefinitionIndex = 38809;
