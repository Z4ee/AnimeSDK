...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_COPY_OFFSET UNITYSDK_OFFSET(0x1FA5F4C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FA5F3E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1FA5EE80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1FA5EFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1FA5FA80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_1_OFFSET UNITYSDK_OFFSET(0x1FA5F8F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1FA5F600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1FA5EE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1FA5F0D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FA5F280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA5F160)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGPath_TypeDefinitionIndex = 39449;
