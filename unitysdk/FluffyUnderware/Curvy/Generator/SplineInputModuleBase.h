...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1F49CC40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CALCULATEEXTENDEDUV_OFFSET UNITYSDK_OFFSET(0x1F49DDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CLEARRANGE_OFFSET UNITYSDK_OFFSET(0x1F499860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FILLDATA_OFFSET UNITYSDK_OFFSET(0x1F49D130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDNEXTREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1F49E9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDPREVIOUSREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1F49E790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FORCEREFRESH_OFFSET UNITYSDK_OFFSET(0x1F49A000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETPATHCLOSED_OFFSET UNITYSDK_OFFSET(0x1F499540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETSPLINEDATA_OFFSET UNITYSDK_OFFSET(0x1F49A290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1F499030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1F499130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1F499260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1F4993D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1F4983F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1F4983A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1F4990E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_MOVEBYANGLEEXT_OFFSET UNITYSDK_OFFSET(0x1F49D890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F4998B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F499870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONINPUTSPLINECOORDINATESCHANGED_OFFSET UNITYSDK_OFFSET(0x1F49A160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1F49EB80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1F49A020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEREFRESHED_OFFSET UNITYSDK_OFFSET(0x1F499EC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F499B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_PROCESSCONTROLPOINTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1F49CE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1F499BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SETRANGE_OFFSET UNITYSDK_OFFSET(0x1F499760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1F499040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1F498400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1F4983B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1F4990F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_VALIDATESTARTANDENDCPS_OFFSET UNITYSDK_OFFSET(0x1F4984A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F49EE70)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SplineInputModuleBase_TypeDefinitionIndex = 39553;
