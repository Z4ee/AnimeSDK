...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1BE40440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CALCULATEEXTENDEDUV_OFFSET UNITYSDK_OFFSET(0x1BE415A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CLEARRANGE_OFFSET UNITYSDK_OFFSET(0x1BE3CFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FILLDATA_OFFSET UNITYSDK_OFFSET(0x1BE40910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDNEXTREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BE421B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDPREVIOUSREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BE41F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FORCEREFRESH_OFFSET UNITYSDK_OFFSET(0x1BE3D760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETPATHCLOSED_OFFSET UNITYSDK_OFFSET(0x1BE3CCA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETSPLINEDATA_OFFSET UNITYSDK_OFFSET(0x1BE3D9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1BE3C790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1BE3C890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1BE3C9C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1BE3CB30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1BE3BB60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1BE3BB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1BE3C840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_MOVEBYANGLEEXT_OFFSET UNITYSDK_OFFSET(0x1BE41080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BE3D010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BE3CFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONINPUTSPLINECOORDINATESCHANGED_OFFSET UNITYSDK_OFFSET(0x1BE3D8C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1BE42370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1BE3D780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEREFRESHED_OFFSET UNITYSDK_OFFSET(0x1BE3D620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1BE3D2C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_PROCESSCONTROLPOINTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BE40680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1BE3D300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SETRANGE_OFFSET UNITYSDK_OFFSET(0x1BE3CEC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1BE3C7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1BE3BB70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1BE3BB20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1BE3C850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_VALIDATESTARTANDENDCPS_OFFSET UNITYSDK_OFFSET(0x1BE3BC10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE42650)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SplineInputModuleBase_TypeDefinitionIndex = 37380;
