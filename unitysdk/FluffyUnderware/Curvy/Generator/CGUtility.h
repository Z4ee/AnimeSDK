...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_CALCULATEUV2_1_OFFSET UNITYSDK_OFFSET(0x1DF54010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_CALCULATEUV2_OFFSET UNITYSDK_OFFSET(0x1DF53FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_GETCONTROLPOINTSWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x1DF54140)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGUtility_TypeDefinitionIndex = 38983;
