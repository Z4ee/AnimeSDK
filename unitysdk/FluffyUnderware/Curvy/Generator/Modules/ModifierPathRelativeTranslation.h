...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1F5F7E70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_LATERALTRANSLATION_OFFSET UNITYSDK_OFFSET(0x1F5F7E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_MULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1F5F7EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1F5F7F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F5F8640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1F5F8080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F5F8760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_RESET_OFFSET UNITYSDK_OFFSET(0x1F5F8680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1F5F7E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_LATERALTRANSLATION_OFFSET UNITYSDK_OFFSET(0x1F5F7E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_MULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1F5F7EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_TRANSLATEPOINT_OFFSET UNITYSDK_OFFSET(0x1F5F82F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5F87C0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierPathRelativeTranslation_TypeDefinitionIndex = 39607;
