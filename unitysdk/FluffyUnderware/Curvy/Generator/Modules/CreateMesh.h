...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B7306C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CREATEMESHES_OFFSET UNITYSDK_OFFSET(0x1B732090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CREATESPOTMESHES_OFFSET UNITYSDK_OFFSET(0x1B7313F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1B7302A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GETNEWMESH_OFFSET UNITYSDK_OFFSET(0x1B732E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDNORMALS_OFFSET UNITYSDK_OFFSET(0x1B72F1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1B72F210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDUV2_OFFSET UNITYSDK_OFFSET(0x1B72F260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ANCHOROVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B72F5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_AUTOUPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1B72F6B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANGROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1B72F900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANMODIFYSTATICFLAG_OFFSET UNITYSDK_OFFSET(0x1B72F920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANUPDATE_OFFSET UNITYSDK_OFFSET(0x1B72F930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1B72F420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1B72F660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COMBINE_OFFSET UNITYSDK_OFFSET(0x1B72EFB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CONVEX_OFFSET UNITYSDK_OFFSET(0x1B72F700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COOKINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x1B72F7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ENABLEISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B72F960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_GROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1B72F0D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_INCLUDENORMALS_OFFSET UNITYSDK_OFFSET(0x1B72F120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_INCLUDETANGENTS_OFFSET UNITYSDK_OFFSET(0x1B72F170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B72F750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x1B72F2B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1B72F510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1B72F380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B72F7F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1B72F8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1B72F8A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1B72F470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_REFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1B72F560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_RENDERERENABLED_OFFSET UNITYSDK_OFFSET(0x1B72F3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1B72F310)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_UNWRAPUV2_OFFSET UNITYSDK_OFFSET(0x1B72F000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1B72F4C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B72F8E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B7328D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B7328C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B72F9A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B7306D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1B733E70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1B72F9D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVERESOURCETOSCENE_OFFSET UNITYSDK_OFFSET(0x1B733F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVETOASSET_OFFSET UNITYSDK_OFFSET(0x1B733E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVETOSCENEANDASSET_OFFSET UNITYSDK_OFFSET(0x1B733ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDNORMALS_OFFSET UNITYSDK_OFFSET(0x1B72F1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1B72F220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDUV2_OFFSET UNITYSDK_OFFSET(0x1B72F270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ANCHOROVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B72F5C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_AUTOUPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1B72F6C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1B72F430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1B72F670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COMBINE_OFFSET UNITYSDK_OFFSET(0x1B72EFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_CONVEX_OFFSET UNITYSDK_OFFSET(0x1B72F710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COOKINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x1B72F7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_GROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1B72F0E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_INCLUDENORMALS_OFFSET UNITYSDK_OFFSET(0x1B72F130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_INCLUDETANGENTS_OFFSET UNITYSDK_OFFSET(0x1B72F180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B72F760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_LAYER_OFFSET UNITYSDK_OFFSET(0x1B72F2C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1B72F520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1B72F390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B72F800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1B72F480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_REFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1B72F570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_RENDERERENABLED_OFFSET UNITYSDK_OFFSET(0x1B72F3E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_TAG_OFFSET UNITYSDK_OFFSET(0x1B72F320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_UNWRAPUV2_OFFSET UNITYSDK_OFFSET(0x1B72F010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1B72F4D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B72F8F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1B730F50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_UPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1B7321B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_VALIDATEMESH_OFFSET UNITYSDK_OFFSET(0x1B733A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_WRITEVMESHTOMESH_OFFSET UNITYSDK_OFFSET(0x1B732990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7300B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreateMesh_TypeDefinitionIndex = 37404;
