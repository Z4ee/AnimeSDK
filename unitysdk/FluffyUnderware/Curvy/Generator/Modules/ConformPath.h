...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_1_OFFSET UNITYSDK_OFFSET(0x1FA606C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_OFFSET UNITYSDK_OFFSET(0x1FA60660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1FA5FFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1FA60140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1FA60050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1FA600A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1FA60320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_WARP_OFFSET UNITYSDK_OFFSET(0x1FA600F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1FA60190)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1FA60470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1FA601C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1FA5FFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1FA60150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1FA60060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1FA600B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_WARP_OFFSET UNITYSDK_OFFSET(0x1FA60100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA60BA0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ConformPath_TypeDefinitionIndex = 39700;
