...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_1_OFFSET UNITYSDK_OFFSET(0x1C363E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_OFFSET UNITYSDK_OFFSET(0x1C363E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1C363760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1C363900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C363810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C363860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1C363AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_WARP_OFFSET UNITYSDK_OFFSET(0x1C3638B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C363950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1C363C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1C363980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1C363780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1C363910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C363820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C363870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_WARP_OFFSET UNITYSDK_OFFSET(0x1C3638C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C364360)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ConformPath_TypeDefinitionIndex = 37401;
