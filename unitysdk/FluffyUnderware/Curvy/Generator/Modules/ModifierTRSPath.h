...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1E02B110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1E02B260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E02B4C0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSPath_TypeDefinitionIndex = 38939;
