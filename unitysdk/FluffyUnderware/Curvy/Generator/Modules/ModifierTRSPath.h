...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1BCDFA00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1BCDFB50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCDFDB0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSPath_TypeDefinitionIndex = 37431;
