...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_GET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1EECC520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EECC570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1EECC5F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1EECC5A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_SET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1EECC530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EECC6F0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSpots_TypeDefinitionIndex = 39610;
