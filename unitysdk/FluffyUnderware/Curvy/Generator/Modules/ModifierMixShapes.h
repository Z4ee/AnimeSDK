...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1B928470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B9284E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_INTERPOLATESHAPE_OFFSET UNITYSDK_OFFSET(0x1B928C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_MIXSHAPES_OFFSET UNITYSDK_OFFSET(0x1B928BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B9287C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1B928980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1B928930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1B928480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B929E00)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixShapes_TypeDefinitionIndex = 37426;
