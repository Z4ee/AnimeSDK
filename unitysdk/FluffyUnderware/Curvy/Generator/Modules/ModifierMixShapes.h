...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1EFB59B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1EFB5A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_INTERPOLATESHAPE_OFFSET UNITYSDK_OFFSET(0x1EFB61A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_MIXSHAPES_OFFSET UNITYSDK_OFFSET(0x1EFB6100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EFB5D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1EFB5ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1EFB5E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1EFB59C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB7340)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixShapes_TypeDefinitionIndex = 39682;
