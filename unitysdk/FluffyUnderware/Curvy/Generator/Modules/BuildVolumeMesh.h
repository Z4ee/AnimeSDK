...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B2300F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B2300C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_BUILD_OFFSET UNITYSDK_OFFSET(0x1B231480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV2_OFFSET UNITYSDK_OFFSET(0x1B2329E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV_OFFSET UNITYSDK_OFFSET(0x1B2326A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEPATCHTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1B232B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIALIDGROUPS_OFFSET UNITYSDK_OFFSET(0x1B230E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B232200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1B22FE40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1B22FDF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_ISSPLITUV2TOGGLABLE_OFFSET UNITYSDK_OFFSET(0x1B232C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2300A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B230090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTTINGS_OFFSET UNITYSDK_OFFSET(0x1B230080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1B22FF30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x1B22FFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x1B230030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLIT_OFFSET UNITYSDK_OFFSET(0x1B22FF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x1B22FE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1B22FEE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_PREPARESUBMESHES_OFFSET UNITYSDK_OFFSET(0x1B2322A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B230960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REMOVEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B231E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1B2301C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B231FE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1B22FE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1B22FE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1B22FF40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x1B22FFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x1B230040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLIT_OFFSET UNITYSDK_OFFSET(0x1B22FF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x1B22FEA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1B22FEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_VALIDATEMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1B231F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B232C90)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeMesh_TypeDefinitionIndex = 37394;
