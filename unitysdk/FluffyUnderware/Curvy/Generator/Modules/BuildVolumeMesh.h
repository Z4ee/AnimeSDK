...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E9B4E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E9B4E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_BUILD_OFFSET UNITYSDK_OFFSET(0x1E9B6240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV2_OFFSET UNITYSDK_OFFSET(0x1E9B7780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV_OFFSET UNITYSDK_OFFSET(0x1E9B73B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEPATCHTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1E9B78D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIALIDGROUPS_OFFSET UNITYSDK_OFFSET(0x1E9B5C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E9B6F80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1E9B4BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1E9B4B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_ISSPLITUV2TOGGLABLE_OFFSET UNITYSDK_OFFSET(0x1E9B7A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1E9B4E00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1E9B4DF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTTINGS_OFFSET UNITYSDK_OFFSET(0x1E9B4DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1E9B4C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x1E9B4D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x1E9B4D90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLIT_OFFSET UNITYSDK_OFFSET(0x1E9B4CE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x1E9B4BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1E9B4C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_PREPARESUBMESHES_OFFSET UNITYSDK_OFFSET(0x1E9B7020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E9B5710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REMOVEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E9B6B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1E9B4F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E9B6D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1E9B4BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1E9B4B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1E9B4CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x1E9B4D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x1E9B4DA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLIT_OFFSET UNITYSDK_OFFSET(0x1E9B4CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x1E9B4C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1E9B4C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_VALIDATEMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1E9B6CE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9B7A20)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeMesh_TypeDefinitionIndex = 39617;
