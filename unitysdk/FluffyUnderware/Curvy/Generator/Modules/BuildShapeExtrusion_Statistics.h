...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9B2BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_EQUALS_OFFSET UNITYSDK_OFFSET(0x919370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x94B630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_GET_CROSSSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x3A4E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_GET_MATERIALGROUPSCOUNT_OFFSET UNITYSDK_OFFSET(0x2F0420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_GET_PATHSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BCDEC50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BCDEC70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_SET_CROSSSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x5B6810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_SET_MATERIALGROUPSCOUNT_OFFSET UNITYSDK_OFFSET(0x50A4B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_SET_OFFSET UNITYSDK_OFFSET(0x3EABD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDSHAPEEXTRUSION_STATISTICS_SET_PATHSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x2E85F0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildShapeExtrusion_Statistics_TypeDefinitionIndex = 37390;
