...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_GET_TRANSFORMSPOTS_OFFSET UNITYSDK_OFFSET(0x1BE920F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BE92170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BE92140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1BE92420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1BE926E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1BE92180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_SET_TRANSFORMSPOTS_OFFSET UNITYSDK_OFFSET(0x1BE92100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BE921D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE92760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS__REFRESH_B__9_1_OFFSET UNITYSDK_OFFSET(0x1BE928A0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputTransformSpots_TypeDefinitionIndex = 37422;
