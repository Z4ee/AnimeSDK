...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1EECC9D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1EECC780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1EECCA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1EECCA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_SET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1EECC9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1EECCFB0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierVariableMixShapes_TypeDefinitionIndex = 39526;
