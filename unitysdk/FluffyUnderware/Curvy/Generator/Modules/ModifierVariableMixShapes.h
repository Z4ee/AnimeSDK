...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1B736640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B7363F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1B7366D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1B736690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_SET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1B736650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B736C20)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierVariableMixShapes_TypeDefinitionIndex = 37433;
