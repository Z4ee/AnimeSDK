...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_COMBINEMESHFILTERS_OFFSET UNITYSDK_OFFSET(0x1E658E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1E657D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1E657CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E657DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1E657D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1E657D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1E657CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E659BD0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int GameObjectToMesh_TypeDefinitionIndex = 39054;
