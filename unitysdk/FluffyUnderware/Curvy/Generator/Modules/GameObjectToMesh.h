...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_COMBINEMESHFILTERS_OFFSET UNITYSDK_OFFSET(0x1FA51CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1FA50B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1FA50B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1FA50C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1FA50BC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1FA50B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1FA50B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA52AC0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int GameObjectToMesh_TypeDefinitionIndex = 39628;
