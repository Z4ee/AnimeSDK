...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1BB29BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1BB29850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1BB29910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1BB29920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1BB29AA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_SET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1BB29C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1BB29860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB29C10)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSplinePath_TypeDefinitionIndex = 37419;
