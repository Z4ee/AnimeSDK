...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1F5F6A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1F5F6A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1F5F6E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F5F6A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1F5F6BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1F5F6B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1F5F6EB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5F7220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__WARNABOUTINVALIDINPUTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x1F5F73A0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputMesh_TypeDefinitionIndex = 39646;
