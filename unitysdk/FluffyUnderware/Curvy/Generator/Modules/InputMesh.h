...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1E1D0720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1E1D0730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1E1D0B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E1D0740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E1D0890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1E1D0840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1E1D0BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1D0F00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__WARNABOUTINVALIDINPUTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x1E1D1080)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputMesh_TypeDefinitionIndex = 38840;
