...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYMATRIX_OFFSET UNITYSDK_OFFSET(0x1B72E680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV2_OFFSET UNITYSDK_OFFSET(0x1B72ED90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV_OFFSET UNITYSDK_OFFSET(0x1B72E9F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B72BCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_FLIPTRIS_OFFSET UNITYSDK_OFFSET(0x1B72E950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1B72E180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1B72BBC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1B72BB70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B72BC10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B72BC20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1B72B9C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1B72B970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1B72BA10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1B72BA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B72BB60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B72BAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_MAKE2DSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B72DF20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B72C300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_RESET_OFFSET UNITYSDK_OFFSET(0x1B72C020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1B72BBD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1B72BB80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B72BC30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1B72B9D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1B72B980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1B72BA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1B72BA70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B72BAC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72EEA0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeCaps_TypeDefinitionIndex = 37392;
