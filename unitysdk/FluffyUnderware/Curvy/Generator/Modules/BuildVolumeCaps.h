...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYMATRIX_OFFSET UNITYSDK_OFFSET(0x1DB102F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV2_OFFSET UNITYSDK_OFFSET(0x1DB10A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV_OFFSET UNITYSDK_OFFSET(0x1DB10660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DB0D930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_FLIPTRIS_OFFSET UNITYSDK_OFFSET(0x1DB105C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1DB0FDF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1DB0D820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1DB0D7D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1DB0D870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DB0D880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1DB0D620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1DB0D5D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1DB0D670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1DB0D6C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1DB0D7C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DB0D710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_MAKE2DSEGMENT_OFFSET UNITYSDK_OFFSET(0x1DB0FB90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1DB0DF60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_RESET_OFFSET UNITYSDK_OFFSET(0x1DB0DC80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1DB0D830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1DB0D7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DB0D890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1DB0D630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1DB0D5E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1DB0D680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1DB0D6D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DB0D720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB10B10)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeCaps_TypeDefinitionIndex = 38971;
