...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETADVANCEDSCALE_OFFSET UNITYSDK_OFFSET(0x1DB59C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETRELATIVEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1DB59BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_1_OFFSET UNITYSDK_OFFSET(0x1DB59A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_2_OFFSET UNITYSDK_OFFSET(0x1DB598D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_OFFSET UNITYSDK_OFFSET(0x1DB59870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSIMPLESCALE_OFFSET UNITYSDK_OFFSET(0x1DB59D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1DB59420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1DB595B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1DB59650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1DB59510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DB59470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1DB594C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1DB59560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1DB59600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1DB596A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1DB59430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1DB595C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1DB59660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1DB59520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DB59480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1DB594D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1DB59570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1DB59610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB59D60)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ScalingModule_TypeDefinitionIndex = 38837;
