...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETADVANCEDSCALE_OFFSET UNITYSDK_OFFSET(0x1B7CF8D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETRELATIVEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B7CF830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_1_OFFSET UNITYSDK_OFFSET(0x1B7CF680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_2_OFFSET UNITYSDK_OFFSET(0x1B7CF520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_OFFSET UNITYSDK_OFFSET(0x1B7CF4C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSIMPLESCALE_OFFSET UNITYSDK_OFFSET(0x1B7CF990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1B7CF070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1B7CF200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1B7CF2A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B7CF160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B7CF0C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1B7CF110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1B7CF1B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1B7CF250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1B7CF2F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1B7CF080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1B7CF210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1B7CF2B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B7CF170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B7CF0D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1B7CF120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1B7CF1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1B7CF260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7CF9B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ScalingModule_TypeDefinitionIndex = 37385;
