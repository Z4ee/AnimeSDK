...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E0D7630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E0D74D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E0D7690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_BOUNDSGROUP_OFFSET UNITYSDK_OFFSET(0x1E0D7430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_GROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1E0D7450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_ITEMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1E0D7460)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_ITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1E0D7440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1E0D7480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1E0D7470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D7490)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_EndGroupData_TypeDefinitionIndex = 38813;
	...
	public:
		...
		::System::Single _GroupDepth_k__BackingField; // 0x38
