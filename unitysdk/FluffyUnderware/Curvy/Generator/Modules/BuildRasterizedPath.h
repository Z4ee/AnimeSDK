...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_ANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B926530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_CLAMPPATH_OFFSET UNITYSDK_OFFSET(0x1B9263A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_FROM_OFFSET UNITYSDK_OFFSET(0x1B926250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B9263C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1B9264E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B926650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1B9265A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1B926880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_RESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B926480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_TO_OFFSET UNITYSDK_OFFSET(0x1B9262E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_USEBUGGEDRANGE_OFFSET UNITYSDK_OFFSET(0x1B926830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B926960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B926BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1B926AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_ANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B926540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_FROM_OFFSET UNITYSDK_OFFSET(0x1B926260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B926400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1B9264F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_RESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B926490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_TO_OFFSET UNITYSDK_OFFSET(0x1B9262F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_USEBUGGEDRANGE_OFFSET UNITYSDK_OFFSET(0x1B926840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B926EF0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildRasterizedPath_TypeDefinitionIndex = 37386;
