...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1C0BC5E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1C0BC730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0BC850)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSShape_TypeDefinitionIndex = 37432;
