...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1E3B9440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1E3B9590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3B96B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSShape_TypeDefinitionIndex = 38924;
