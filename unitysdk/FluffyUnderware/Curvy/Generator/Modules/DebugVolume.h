...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C31DF30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME_RESET_OFFSET UNITYSDK_OFFSET(0x1C31DF60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C31DFD0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DebugVolume_TypeDefinitionIndex = 37410;
