...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E9B80B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1E9B7D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_APPLYLAYERONCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E9B7B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_GAMEOBJECTCOUNT_OFFSET UNITYSDK_OFFSET(0x1E9B7C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E9B7C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x1E9B7B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1E9B7BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E9B7CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E9B80C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1E9B9030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x1E9B7C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SAVERESOURCETOSCENE_OFFSET UNITYSDK_OFFSET(0x1E9B8F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_APPLYLAYERONCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E9B7B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_LAYER_OFFSET UNITYSDK_OFFSET(0x1E9B7B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1E9B7BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9B90B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreateGameObject_TypeDefinitionIndex = 39460;
