...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B233350)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1B232FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_APPLYLAYERONCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B232E00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_GAMEOBJECTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B232EB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B232EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x1B232DA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1B232E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B232F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B233360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1B2342E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x1B232EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SAVERESOURCETOSCENE_OFFSET UNITYSDK_OFFSET(0x1B2341F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_APPLYLAYERONCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B232E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_LAYER_OFFSET UNITYSDK_OFFSET(0x1B232DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1B232E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B234360)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreateGameObject_TypeDefinitionIndex = 37402;
