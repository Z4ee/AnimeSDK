...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_1_OFFSET UNITYSDK_OFFSET(0x1DB577F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_OFFSET UNITYSDK_OFFSET(0x1DB56EC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUP_OFFSET UNITYSDK_OFFSET(0x1DB547A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DB548E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1DB575A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1DB57210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETREGIONNEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1DB57550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETSPOT_OFFSET UNITYSDK_OFFSET(0x1DB57DA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS630_OFFSET UNITYSDK_OFFSET(0x1DB58640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS_OFFSET UNITYSDK_OFFSET(0x1DB58C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSINDICES_OFFSET UNITYSDK_OFFSET(0x1DB54250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1DB54130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DB54340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1DB53E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1DB53ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1DB53F90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FITEND_OFFSET UNITYSDK_OFFSET(0x1DB540C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPCOUNT_OFFSET UNITYSDK_OFFSET(0x1DB54110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1DB53F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1DB54010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1DB54040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1DB54360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1DB53C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1DB543D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1DB53F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SHOWFITEND_OFFSET UNITYSDK_OFFSET(0x1DB590A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1DB53D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1DB53DD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1DB53D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ISINPUTAVOLUME_OFFSET UNITYSDK_OFFSET(0x1DB54350)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DB59170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DB59160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DB54460)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1DB54870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_PREPARE_OFFSET UNITYSDK_OFFSET(0x1DB56A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1DB549D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REMOVEGROUP_OFFSET UNITYSDK_OFFSET(0x1DB57D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1DB590D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1DB54490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1DB53E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1DB53EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1DB53FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FITEND_OFFSET UNITYSDK_OFFSET(0x1DB540D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1DB53F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1DB54050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x1DB53C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1DB53F50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1DB53D90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1DB53DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1DB53D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB53AB0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_TypeDefinitionIndex = 38810;
