...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_1_OFFSET UNITYSDK_OFFSET(0x1B7CD440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_OFFSET UNITYSDK_OFFSET(0x1B7CCB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUP_OFFSET UNITYSDK_OFFSET(0x1B7CA3E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B7CA520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1B7CD1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1B7CCE60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETREGIONNEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1B7CD1A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETSPOT_OFFSET UNITYSDK_OFFSET(0x1B7CD9F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS630_OFFSET UNITYSDK_OFFSET(0x1B7CE290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS_OFFSET UNITYSDK_OFFSET(0x1B7CE8A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSINDICES_OFFSET UNITYSDK_OFFSET(0x1B7C9E90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1B7C9D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B7C9F80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1B7C9A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1B7C9B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1B7C9BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FITEND_OFFSET UNITYSDK_OFFSET(0x1B7C9D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPCOUNT_OFFSET UNITYSDK_OFFSET(0x1B7C9D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1B7C9B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1B7C9C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1B7C9C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1B7C9FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1B7C9890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1B7CA010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1B7C9B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SHOWFITEND_OFFSET UNITYSDK_OFFSET(0x1B7CECF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B7C99C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1B7C9A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1B7C9970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ISINPUTAVOLUME_OFFSET UNITYSDK_OFFSET(0x1B7C9F90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B7CEDC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B7CEDB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B7CA0A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1B7CA4B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_PREPARE_OFFSET UNITYSDK_OFFSET(0x1B7CC650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B7CA610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REMOVEGROUP_OFFSET UNITYSDK_OFFSET(0x1B7CD980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1B7CED20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1B7CA0D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1B7C9A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1B7C9B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1B7C9BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FITEND_OFFSET UNITYSDK_OFFSET(0x1B7C9D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1B7C9B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1B7C9C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x1B7C98B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1B7C9B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B7C99D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1B7C9A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1B7C9980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C96F0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_TypeDefinitionIndex = 37395;
