...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_1_OFFSET UNITYSDK_OFFSET(0x1EECB3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_OFFSET UNITYSDK_OFFSET(0x1EECBE10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GETSPOTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1EECBFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1EECA580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ISCURVEEVALUATIONNEEDED_OFFSET UNITYSDK_OFFSET(0x1EECBF20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EECA610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1EECA650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1EECA5D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_SET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1EECA590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1EECAF40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1EECC090)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DeformMesh_TypeDefinitionIndex = 39611;
