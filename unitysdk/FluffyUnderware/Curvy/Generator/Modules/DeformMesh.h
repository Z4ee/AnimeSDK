...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_1_OFFSET UNITYSDK_OFFSET(0x1DB16D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_OFFSET UNITYSDK_OFFSET(0x1DB17700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GETSPOTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1DB178C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1DB15E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ISCURVEEVALUATIONNEEDED_OFFSET UNITYSDK_OFFSET(0x1DB17820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DB15EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1DB15F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1DB15EB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_SET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1DB15E70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1DB16860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB17990)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DeformMesh_TypeDefinitionIndex = 38829;
