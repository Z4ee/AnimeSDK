...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1EFB44C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1EFB4B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x1EFB4660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB5330)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreatePathLineRenderer_TypeDefinitionIndex = 39468;
