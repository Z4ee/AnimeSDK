...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA9EAE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xA9EA30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GETBOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1F344670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA9EAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_INPUTISAVOLUME_OFFSET UNITYSDK_OFFSET(0x3D1BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_SPOTSCOUNT_OFFSET UNITYSDK_OFFSET(0x325570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1F344860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1F344910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA9EA10)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_EditorData_TypeDefinitionIndex = 39598;
