...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_FREEFORM_OFFSET UNITYSDK_OFFSET(0x1C364790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1C3650A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1C3643F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1C364780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1C364DF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1C364610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_REMOVEMANAGEDSHAPE_OFFSET UNITYSDK_OFFSET(0x1C364F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_FREEFORM_OFFSET UNITYSDK_OFFSET(0x1C364A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1C3650B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1C364400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3650C0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSplineShape_TypeDefinitionIndex = 37420;
