...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_FREEFORM_OFFSET UNITYSDK_OFFSET(0x1FA60FD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1FA618E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1FA60C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1FA60FC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1FA61630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1FA60E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_REMOVEMANAGEDSHAPE_OFFSET UNITYSDK_OFFSET(0x1FA61780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_FREEFORM_OFFSET UNITYSDK_OFFSET(0x1FA61260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1FA618F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1FA60C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA61900)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSplineShape_TypeDefinitionIndex = 39637;
