...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E569660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1E569670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1E569990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E5696D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x1E569680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1E5699E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E569BA0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputGameObject_TypeDefinitionIndex = 39565;
