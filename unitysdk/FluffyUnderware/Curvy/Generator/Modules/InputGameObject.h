...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1D22B0A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1D22B0B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1D22B3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x1D22B110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x1D22B0C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1D22B420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22B5E0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputGameObject_TypeDefinitionIndex = 39006;
