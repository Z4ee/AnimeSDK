...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1E02A3A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1E02A410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_MIXPATH_OFFSET UNITYSDK_OFFSET(0x1E02A8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E02A660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1E02A6F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_RESET_OFFSET UNITYSDK_OFFSET(0x1E02A6A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1E02A3B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E02B080)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixPaths_TypeDefinitionIndex = 38888;
