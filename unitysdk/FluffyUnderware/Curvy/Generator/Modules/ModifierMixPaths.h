...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1BCDEC90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1BCDED00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_MIXPATH_OFFSET UNITYSDK_OFFSET(0x1BCDF1A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BCDEF50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1BCDEFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_RESET_OFFSET UNITYSDK_OFFSET(0x1BCDEF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1BCDECA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCDF970)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixPaths_TypeDefinitionIndex = 37425;
