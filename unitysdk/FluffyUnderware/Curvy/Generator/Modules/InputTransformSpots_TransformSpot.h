...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x955770)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x955720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x955800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x28B580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B2346F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B234740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT__CTOR_OFFSET UNITYSDK_OFFSET(0x3A4A20)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputTransformSpots_TransformSpot_TypeDefinitionIndex = 37423;
