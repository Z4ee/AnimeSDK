...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xAA3D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_EQUALS_OFFSET UNITYSDK_OFFSET(0x6340C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA1C320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GET_END_OFFSET UNITYSDK_OFFSET(0x8880B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0xAA3D20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1F411220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1F411230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_SET_END_OFFSET UNITYSDK_OFFSET(0xAA3D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAA3D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x8536B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsPatch_TypeDefinitionIndex = 39544;
