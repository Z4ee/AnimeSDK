...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA52A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_EQUALS_OFFSET UNITYSDK_OFFSET(0x412140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9D09B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GET_END_OFFSET UNITYSDK_OFFSET(0xA2AE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0xA52A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E02B980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E02B990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_SET_END_OFFSET UNITYSDK_OFFSET(0xA52A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA52A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x623A10)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsPatch_TypeDefinitionIndex = 38824;
