...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB52CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DB526B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1DB524F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1DB523E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x1DB52620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_SET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1DB523F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB527E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB52860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DB52870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DB529B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DB52BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB526C0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGSpots_TypeDefinitionIndex = 39013;
