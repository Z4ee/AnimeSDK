...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGWEIGHTEDITEM_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1B03EF70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGWEIGHTEDITEM_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1B03EF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGWEIGHTEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03EFB0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGWeightedItem_TypeDefinitionIndex = 37348;
