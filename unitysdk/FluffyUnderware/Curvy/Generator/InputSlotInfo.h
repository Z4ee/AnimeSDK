...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO_ISVALIDFROM_OFFSET UNITYSDK_OFFSET(0x1C317810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3177A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C3177B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C3177F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C317760)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int InputSlotInfo_TypeDefinitionIndex = 37369;
