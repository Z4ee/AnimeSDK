...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x955660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x955630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9556D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_ENDINDEX_OFFSET UNITYSDK_OFFSET(0x3A4E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_ISHARDEDGE_OFFSET UNITYSDK_OFFSET(0x3AB220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B22F920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B22F950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9556F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x6D6F50)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int DuplicateSamplePoint_TypeDefinitionIndex = 37362;
