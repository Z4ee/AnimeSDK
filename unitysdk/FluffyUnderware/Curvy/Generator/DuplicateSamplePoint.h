...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9F89A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9F8970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9F8A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_ENDINDEX_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_ISHARDEDGE_OFFSET UNITYSDK_OFFSET(0x3E5670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D616F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D616F50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9F8A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x702840)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int DuplicateSamplePoint_TypeDefinitionIndex = 39056;
