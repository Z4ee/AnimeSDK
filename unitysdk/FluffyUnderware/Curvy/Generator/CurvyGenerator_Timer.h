...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_GET_NOW_OFFSET UNITYSDK_OFFSET(0x1E530400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_RESET_OFFSET UNITYSDK_OFFSET(0x1E5304F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E530460)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_VALIDATETIMES_OFFSET UNITYSDK_OFFSET(0x1E530420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E530500)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_Timer_TypeDefinitionIndex = 38916;
