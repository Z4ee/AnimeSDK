...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_AREINPUTANDOUTPUTSLOTSCOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EE602C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_CANLINKTO_OFFSET UNITYSDK_OFFSET(0x1EE5FFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_GET_INPUTINFO_OFFSET UNITYSDK_OFFSET(0x1EE5E8C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_GET_ISONREQUEST_OFFSET UNITYSDK_OFFSET(0x1EE5E920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_LINKTO_OFFSET UNITYSDK_OFFSET(0x1EE5EE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_LOADLINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1EE5E9F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_SOURCESLOT_OFFSET UNITYSDK_OFFSET(0x1EE5FCB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_UNLINKFROM_OFFSET UNITYSDK_OFFSET(0x1EE5F760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE60340)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleInputSlot_TypeDefinitionIndex = 39685;
