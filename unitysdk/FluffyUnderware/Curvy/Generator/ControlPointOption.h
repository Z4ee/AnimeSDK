...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA74220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_OFFSET UNITYSDK_OFFSET(0xA741F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA742A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E671A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E671AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA74180)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int ControlPointOption_TypeDefinitionIndex = 39036;
