...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9D4840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x9D4810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9D48C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C363700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C363730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D47A0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int ControlPointOption_TypeDefinitionIndex = 37350;
