...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_CONVERTOBSOLETEDATA_OFFSET UNITYSDK_OFFSET(0x1BCD8CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_FILLITEMBAG_OFFSET UNITYSDK_OFFSET(0x1BCD88D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1BCD8300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1BCD85D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_IGNOREMODULECROSSBASE_OFFSET UNITYSDK_OFFSET(0x1BCD8330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCD8630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1BCD85C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_KEEPTOGETHER_OFFSET UNITYSDK_OFFSET(0x1BCD8230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1BCD8650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BCD8210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_POSITIONRANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BCD8C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_RANDOMIZEITEMS_OFFSET UNITYSDK_OFFSET(0x1BCD82B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_RELATIVETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1BCD8510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BCD8BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_REPEATINGITEMS_OFFSET UNITYSDK_OFFSET(0x1BCD82D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1BCD8350)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONX_OFFSET UNITYSDK_OFFSET(0x1BCD8370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONY_OFFSET UNITYSDK_OFFSET(0x1BCD83B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1BCD83F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1BCD8450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1BCD8490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEZ_OFFSET UNITYSDK_OFFSET(0x1BCD84D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1BCD8280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1BCD8250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONX_OFFSET UNITYSDK_OFFSET(0x1BCD8530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONY_OFFSET UNITYSDK_OFFSET(0x1BCD8560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONZ_OFFSET UNITYSDK_OFFSET(0x1BCD8590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_UNIFORMSCALING_OFFSET UNITYSDK_OFFSET(0x1BCD8430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1BCD8320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1BCD85E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_IGNOREMODULECROSSBASE_OFFSET UNITYSDK_OFFSET(0x1BCD8340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_KEEPTOGETHER_OFFSET UNITYSDK_OFFSET(0x1BCD8240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1BCD8660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1BCD8220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_RANDOMIZEITEMS_OFFSET UNITYSDK_OFFSET(0x1BCD82C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_RELATIVETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1BCD8520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_REPEATINGITEMS_OFFSET UNITYSDK_OFFSET(0x1BCD82F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1BCD8360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONX_OFFSET UNITYSDK_OFFSET(0x1BCD8390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONY_OFFSET UNITYSDK_OFFSET(0x1BCD83D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1BCD8410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1BCD8470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1BCD84B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEZ_OFFSET UNITYSDK_OFFSET(0x1BCD84F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1BCD82A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1BCD8270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONX_OFFSET UNITYSDK_OFFSET(0x1BCD8550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONY_OFFSET UNITYSDK_OFFSET(0x1BCD8580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONZ_OFFSET UNITYSDK_OFFSET(0x1BCD85B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_UNIFORMSCALING_OFFSET UNITYSDK_OFFSET(0x1BCD8440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD86B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGBoundsGroup_TypeDefinitionIndex = 37291;
