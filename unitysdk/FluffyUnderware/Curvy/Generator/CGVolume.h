...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CALCSEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1F28BEB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CROSSDISTANCETOF_OFFSET UNITYSDK_OFFSET(0x1F28C000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CROSSFTODISTANCE_OFFSET UNITYSDK_OFFSET(0x1F28BFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F28A3F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETCROSSFINDEX_OFFSET UNITYSDK_OFFSET(0x1F28C050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETCROSSLENGTH_OFFSET UNITYSDK_OFFSET(0x1F28B990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x1F28C040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTINDICES_OFFSET UNITYSDK_OFFSET(0x1F28BDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTVERTICES_OFFSET UNITYSDK_OFFSET(0x1F28C170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETVERTEXINDEX_1_OFFSET UNITYSDK_OFFSET(0x1F28B0E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x1F28C0E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSCUSTOMVALUES_OFFSET UNITYSDK_OFFSET(0x1F288AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSF_OFFSET UNITYSDK_OFFSET(0x1F2890B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSMAP_OFFSET UNITYSDK_OFFSET(0x1F289270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSRELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1F2889D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSSIZE_OFFSET UNITYSDK_OFFSET(0x1F283BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_OFFSET UNITYSDK_OFFSET(0x1F28A8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_SCALES_OFFSET UNITYSDK_OFFSET(0x1F288C10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_SEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1F289430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1F2894A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXNORMALS_OFFSET UNITYSDK_OFFSET(0x1F2888B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXNORMAL_OFFSET UNITYSDK_OFFSET(0x1F288EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1F288D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1F288790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1F28B4A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F28B1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEUP_OFFSET UNITYSDK_OFFSET(0x1F28B700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUME_OFFSET UNITYSDK_OFFSET(0x1F28AD30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSCUSTOMVALUES_OFFSET UNITYSDK_OFFSET(0x1F288B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSF_OFFSET UNITYSDK_OFFSET(0x1F2891E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSMAP_OFFSET UNITYSDK_OFFSET(0x1F2893A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSRELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1F2889E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_SCALES_OFFSET UNITYSDK_OFFSET(0x1F288C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_SEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1F289490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEXNORMALS_OFFSET UNITYSDK_OFFSET(0x1F2888C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEXNORMAL_OFFSET UNITYSDK_OFFSET(0x1F289020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1F288E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1F2887A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F2894C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F2899A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F289E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2894B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVolume_TypeDefinitionIndex = 39616;
	...
	public:
		...
		::FluffyUnderware::Curvy::Generator::SamplePointsMaterialGroupCollection* CrossMaterialGroups; // 0xC0
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector3> vertexNormals; // 0xC8
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector2> scales; // 0xD8
		...
		::System::Boolean CrossSeamless; // 0x10C
		::System::Boolean CrossClosed; // 0x10D
