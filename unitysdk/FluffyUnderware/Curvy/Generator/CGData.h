...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C17C050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C17BFB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C17C100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_GETGENERICFINDEX_OFFSET UNITYSDK_OFFSET(0x1C17C190)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C17C170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C17C180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C17C230)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGData_TypeDefinitionIndex = 37296;
