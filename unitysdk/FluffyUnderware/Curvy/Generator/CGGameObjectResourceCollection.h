...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E0D5F10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1E0D5F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D5FE0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceCollection_TypeDefinitionIndex = 38969;
