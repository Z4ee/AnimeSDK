...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E1CB470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1E1CB490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1CB540)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceCollection_TypeDefinitionIndex = 38856;
