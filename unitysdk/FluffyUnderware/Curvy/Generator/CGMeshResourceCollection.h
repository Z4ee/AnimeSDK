...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1F5F17B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1F5F17D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5F1880)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceCollection_TypeDefinitionIndex = 39687;
