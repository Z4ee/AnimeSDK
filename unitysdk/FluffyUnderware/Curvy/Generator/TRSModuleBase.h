...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_APPLYTRSONSHAPE_OFFSET UNITYSDK_OFFSET(0x1D22BE80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1D22BD60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1D22BC00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1D22BCB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1D22BB50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D22C3A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1D22C3E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1D22BC20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1D22BCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1D22BB70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22C590)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int TRSModuleBase_TypeDefinitionIndex = 38923;
