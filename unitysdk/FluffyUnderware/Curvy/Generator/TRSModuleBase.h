...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_APPLYTRSONSHAPE_OFFSET UNITYSDK_OFFSET(0x1E56A3B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1E56A290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1E56A130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1E56A1E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1E56A080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E56A8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1E56A8F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1E56A150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1E56A200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1E56A0A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E56AA50)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int TRSModuleBase_TypeDefinitionIndex = 39514;
