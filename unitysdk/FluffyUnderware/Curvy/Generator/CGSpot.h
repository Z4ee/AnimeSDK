...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xAC4CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_EQUALS_OFFSET UNITYSDK_OFFSET(0xAC4B40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xAC4D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x325570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0xAC4940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x41FCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x41E4B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_SCALE_OFFSET UNITYSDK_OFFSET(0xA7CF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1FA506C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1FA50870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x826A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x56EA80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_SCALE_OFFSET UNITYSDK_OFFSET(0xAC4930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_TOTRANSFORM_OFFSET UNITYSDK_OFFSET(0xAC4AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC4A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC49E0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGSpot_TypeDefinitionIndex = 39518;
