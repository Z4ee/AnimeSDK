...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DF53C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DF53E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_PATHF_OFFSET UNITYSDK_OFFSET(0x1DF53700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1DF536E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_PATHF_OFFSET UNITYSDK_OFFSET(0x1DF53830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1DF536F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DF53F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF53A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF538B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestShapeRasterization_TypeDefinitionIndex = 39034;
