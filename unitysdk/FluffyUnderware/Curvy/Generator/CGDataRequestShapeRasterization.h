...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1F343090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1F343260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_PATHF_OFFSET UNITYSDK_OFFSET(0x1F342B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1F342AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_PATHF_OFFSET UNITYSDK_OFFSET(0x1F342C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1F342B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F343330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F342EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F342CC0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestShapeRasterization_TypeDefinitionIndex = 39462;
