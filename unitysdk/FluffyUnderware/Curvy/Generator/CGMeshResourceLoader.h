...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1C316670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C316700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1C316600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C316660)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceLoader_TypeDefinitionIndex = 37314;
