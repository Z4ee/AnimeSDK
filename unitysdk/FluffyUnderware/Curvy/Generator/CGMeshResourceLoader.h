...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1E656AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E656B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1E656A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E656AC0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceLoader_TypeDefinitionIndex = 38963;
