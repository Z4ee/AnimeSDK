...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1E9A2B20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_GETCONTROLPOINTNAMES_OFFSET UNITYSDK_OFFSET(0x1E9A2CC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_GETCONTROLPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1E9A2B30)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_MAKECONTROLPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1E9A2C60)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1E9A2990)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_RENAMECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1E9A2A00)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_REQUESTRENAME_OFFSET UNITYSDK_OFFSET(0x1E9A2980)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E9A2E40)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9A2970)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_ControlPointNamer_TypeDefinitionIndex = 39667;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CurvySpline_ControlPointNamer_TypeDefinitionIndex)->GetStaticField(0x2AC20);
		}
