...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1B21DD80)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_GETCONTROLPOINTNAMES_OFFSET UNITYSDK_OFFSET(0x1B21DF20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_GETCONTROLPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1B21DD90)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_MAKECONTROLPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1B21DEC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1B21DBF0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_RENAMECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1B21DC60)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_REQUESTRENAME_OFFSET UNITYSDK_OFFSET(0x1B21DBE0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B21E0A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21DBD0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_ControlPointNamer_TypeDefinitionIndex = 37223;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CurvySpline_ControlPointNamer_TypeDefinitionIndex)->GetStaticField(0x276D0);
		}
