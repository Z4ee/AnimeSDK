...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT_WRITEINTOCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1B0408F0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0405A0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B040520)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SerializedCurvySplineSegment_TypeDefinitionIndex = 37263;
