...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE_WRITEINTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1BE42CF0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE42750)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE426B0)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SerializedCurvySpline_TypeDefinitionIndex = 37262;
