...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_DRAWNODE_OFFSET UNITYSDK_OFFSET(0x1E452380)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1E451F30)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1E451DE0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1E452330)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineSvgConverter_TypeDefinitionIndex = 38816;
