...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_DRAWNODE_OFFSET UNITYSDK_OFFSET(0x1F86DD80)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1F86D930)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1F86D7E0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1F86DD30)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineSvgConverter_TypeDefinitionIndex = 39605;
