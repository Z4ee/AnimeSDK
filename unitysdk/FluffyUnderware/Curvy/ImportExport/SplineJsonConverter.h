...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1C0BCDC0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1C0BCC50)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1C0BD200)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINESTOJSON_OFFSET UNITYSDK_OFFSET(0x1C0BCAA0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINETOJSON_OFFSET UNITYSDK_OFFSET(0x1C0BCB80)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineJsonConverter_TypeDefinitionIndex = 37264;
