...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1F7A9190)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1F7A9020)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1F7A95E0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINESTOJSON_OFFSET UNITYSDK_OFFSET(0x1F7A8E70)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINETOJSON_OFFSET UNITYSDK_OFFSET(0x1F7A8F50)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineJsonConverter_TypeDefinitionIndex = 39695;
