...
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEBCD10)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyShapeInfo_TypeDefinitionIndex = 39480;
