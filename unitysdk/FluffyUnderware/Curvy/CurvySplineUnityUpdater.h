...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_APPLYHIDEFLAGS_OFFSET UNITYSDK_OFFSET(0x1D225130)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D225120)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_DETACH_OFFSET UNITYSDK_OFFSET(0x1D220880)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_GET_HASTRACKEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1D2209E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D2206F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D2254D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D2253B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1D2258C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D2258A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D2255F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D225150)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_REMOVEDESTROYEDREFERENCES_OFFSET UNITYSDK_OFFSET(0x1D225160)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_RESET_OFFSET UNITYSDK_OFFSET(0x1D225140)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_SHOULDRUNFORSTAGE_OFFSET UNITYSDK_OFFSET(0x1D2258E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER_TICK_OFFSET UNITYSDK_OFFSET(0x1D225610)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEUNITYUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D225920)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineUnityUpdater_TypeDefinitionIndex = 39050;
