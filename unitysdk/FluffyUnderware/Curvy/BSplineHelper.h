...
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORCLAMPED_OFFSET UNITYSDK_OFFSET(0x1F4065F0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1F406800)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEN_OFFSET UNITYSDK_OFFSET(0x1F406960)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEUANDK_OFFSET UNITYSDK_OFFSET(0x1F406970)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int BSplineHelper_TypeDefinitionIndex = 39577;
