...
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORCLAMPED_OFFSET UNITYSDK_OFFSET(0x1BCD56B0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1BCD58C0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEN_OFFSET UNITYSDK_OFFSET(0x1BCD5A30)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEUANDK_OFFSET UNITYSDK_OFFSET(0x1BCD5A40)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int BSplineHelper_TypeDefinitionIndex = 37175;
