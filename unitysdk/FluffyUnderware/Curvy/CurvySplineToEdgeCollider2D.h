...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINETOEDGECOLLIDER2D_GET_EDGECOLLIDER_OFFSET UNITYSDK_OFFSET(0x1E0D4860)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINETOEDGECOLLIDER2D_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E0D49F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINETOEDGECOLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D5180)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineToEdgeCollider2D_TypeDefinitionIndex = 38909;
