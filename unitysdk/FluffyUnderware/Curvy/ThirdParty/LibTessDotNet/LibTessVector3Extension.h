...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LIBTESSVECTOR3EXTENSION_CONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1DC370E0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LIBTESSVECTOR3EXTENSION_VEC3_OFFSET UNITYSDK_OFFSET(0x1DC370C0)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int LibTessVector3Extension_TypeDefinitionIndex = 28442;
