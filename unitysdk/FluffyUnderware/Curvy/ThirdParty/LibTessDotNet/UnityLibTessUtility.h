...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_CONTOURVERTICESTOPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B8B32A0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_FROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1B8B3200)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETFROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1B8B33F0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETTOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1B8B3490)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_1_OFFSET UNITYSDK_OFFSET(0x1B8B30E0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1B8B2FE0)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int UnityLibTessUtility_TypeDefinitionIndex = 25950;
