...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_CONTOURVERTICESTOPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1DC3E4E0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_FROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1DC3E440)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETFROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1DC3E630)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETTOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1DC3E6D0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_1_OFFSET UNITYSDK_OFFSET(0x1DC3E320)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1DC3E220)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int UnityLibTessUtility_TypeDefinitionIndex = 28444;
