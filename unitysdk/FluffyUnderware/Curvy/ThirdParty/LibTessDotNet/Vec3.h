...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_DOT_OFFSET UNITYSDK_OFFSET(0x1DC3C740)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA391B0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_LONGAXIS_OFFSET UNITYSDK_OFFSET(0x1DC3BE10)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_NEG_OFFSET UNITYSDK_OFFSET(0x1DC3C060)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1DC3E770)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xA39230)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_SUB_OFFSET UNITYSDK_OFFSET(0x1DC3BDF0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA392C0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC3E8B0)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int Vec3_TypeDefinitionIndex = 28422;

	struct alignas(4) Vec3
	{
		static ::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::Vec3* StaticGet_Zero()
		{
			return (::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::Vec3*)Il2CppClass::FromTypeDefinitionIndex(Vec3_TypeDefinitionIndex)->GetStaticField(0x78F0);
		}
