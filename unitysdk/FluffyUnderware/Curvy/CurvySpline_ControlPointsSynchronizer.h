...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_ASSERTISNOTPROCESSING_OFFSET UNITYSDK_OFFSET(0x1C3165F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1C316380)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_DEBUGLOG_OFFSET UNITYSDK_OFFSET(0x1C316520)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_GET_CURRENTREQUEST_OFFSET UNITYSDK_OFFSET(0x1C315FD0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_LOGIGNOREDREQUEST_OFFSET UNITYSDK_OFFSET(0x1C316580)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1C316040)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_REQUESTHIERARCHYTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1C316020)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_REQUESTSPLINETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1C316000)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SET_CURRENTREQUEST_OFFSET UNITYSDK_OFFSET(0x1C315FE0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SYNCHRONIZEHIERARCHYTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1C316120)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SYNCHRONIZESPLINETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1C316390)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C315FF0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_ControlPointsSynchronizer_TypeDefinitionIndex = 37214;
