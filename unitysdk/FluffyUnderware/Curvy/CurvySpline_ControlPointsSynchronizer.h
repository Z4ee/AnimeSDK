...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_ASSERTISNOTPROCESSING_OFFSET UNITYSDK_OFFSET(0x1E656A50)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1E6567E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_DEBUGLOG_OFFSET UNITYSDK_OFFSET(0x1E656980)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_GET_CURRENTREQUEST_OFFSET UNITYSDK_OFFSET(0x1E656430)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_LOGIGNOREDREQUEST_OFFSET UNITYSDK_OFFSET(0x1E6569E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1E6564A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_REQUESTHIERARCHYTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1E656480)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_REQUESTSPLINETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1E656460)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SET_CURRENTREQUEST_OFFSET UNITYSDK_OFFSET(0x1E656440)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SYNCHRONIZEHIERARCHYTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1E656580)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SYNCHRONIZESPLINETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1E6567F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E656450)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_ControlPointsSynchronizer_TypeDefinitionIndex = 38848;
