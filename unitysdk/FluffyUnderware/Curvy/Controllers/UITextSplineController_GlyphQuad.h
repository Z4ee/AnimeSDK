...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_CALCRECT_OFFSET UNITYSDK_OFFSET(0x1C0B6270)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1C0B5F80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_LOADTRIS_OFFSET UNITYSDK_OFFSET(0x1C0B62F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_LOAD_OFFSET UNITYSDK_OFFSET(0x1C0B5FB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_ROTATE_OFFSET UNITYSDK_OFFSET(0x1C0B69D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1C0B6890)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_SAVE_OFFSET UNITYSDK_OFFSET(0x1C0B65B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1C0B68C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0B6F10)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int UITextSplineController_GlyphQuad_TypeDefinitionIndex = 37287;
