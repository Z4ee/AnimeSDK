...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ADD_ONMANUALMODEDISABLED_OFFSET UNITYSDK_OFFSET(0x1EE58240)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ADD_ONMANUALMODEENABLED_OFFSET UNITYSDK_OFFSET(0x1EE58120)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_APPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1EE5BAF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_APPLYOFFSET_OFFSET UNITYSDK_OFFSET(0x1EE5A790)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ATTACHTOUNITYUPDATER_OFFSET UNITYSDK_OFFSET(0x1EE5C560)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0x1EE5AB00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_COMPUTEOFFSETCOMPENSATEDSPEED_OFFSET UNITYSDK_OFFSET(0x1EE59630)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_COMPUTETARGETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1EE59C40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_CONFIGUREUPDATEMODEHANDLERS_OFFSET UNITYSDK_OFFSET(0x1EE58F00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_DEINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EE5AAE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_DETACHFROMUNITYUPDATER_OFFSET UNITYSDK_OFFSET(0x1EE5C2C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETCLAMPEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE58860)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETMAXPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE5C900)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETORIENTATIONNONEUPANDFORWARD_OFFSET UNITYSDK_OFFSET(0x1EE5A290)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1EE5AB70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ABSOLUTEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE58A10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ALLOWTICKLOD_OFFSET UNITYSDK_OFFSET(0x1EE58470)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ARECONSTRAINTSCONFLICTING_OFFSET UNITYSDK_OFFSET(0x1EE5CEA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_CLAMPING_OFFSET UNITYSDK_OFFSET(0x1EE58510)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_DAMPER_OFFSET UNITYSDK_OFFSET(0x1EE58DF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_DIRECTIONDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1EE585F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_DIRECTIONDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EE58050)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_IGNOREDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EE58630)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1EE5C2A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDED2DRIGIDBODYMISSING_OFFSET UNITYSDK_OFFSET(0x1EE5CAD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDED2DRIGIDBODYNOTKINEMATIC_OFFSET UNITYSDK_OFFSET(0x1EE5CD50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDEDRIGIDBODYMISSING_OFFSET UNITYSDK_OFFSET(0x1EE5C9A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDEDRIGIDBODYNOTKINEMATIC_OFFSET UNITYSDK_OFFSET(0x1EE5CC00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_LOCKROTATION_OFFSET UNITYSDK_OFFSET(0x1EE58570)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MAXPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE5C860)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MOTIONCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1EE58530)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EE58D90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MOVEMODE_OFFSET UNITYSDK_OFFSET(0x1EE584D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1EE58650)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_OFFSETCOMPENSATION_OFFSET UNITYSDK_OFFSET(0x1EE58690)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_OFFSETRADIUS_OFFSET UNITYSDK_OFFSET(0x1EE58670)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1EE58110)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1EE585D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ORIENTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1EE58550)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_PLAYAUTOMATICALLY_OFFSET UNITYSDK_OFFSET(0x1EE584F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_PLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EE58DB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_POSITIONMODE_OFFSET UNITYSDK_OFFSET(0x1EE584B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1EE58C80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_RELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE586E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_RIGIDBODY2D_OFFSET UNITYSDK_OFFSET(0x1EE591C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1EE59110)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SHOULDDISABLEPOSITIONSLIDER_OFFSET UNITYSDK_OFFSET(0x1EE58DC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SHOWOFFSETSECTION_OFFSET UNITYSDK_OFFSET(0x1EE5B8A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SHOWORIENTATIONSECTION_OFFSET UNITYSDK_OFFSET(0x1EE5B890)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1EE586B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TARGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EE58490)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TIMESINCELASTUPDATEPUBLIC_OFFSET UNITYSDK_OFFSET(0x1EE5C850)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TIMESINCELASTUPDATE_OFFSET UNITYSDK_OFFSET(0x1EE5C840)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EE59100)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_UPDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1EE58610)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_UPDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EE580B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_UPDATEIN_OFFSET UNITYSDK_OFFSET(0x1EE58360)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_USEOFFSET_OFFSET UNITYSDK_OFFSET(0x1EE59620)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_INITIALIZEDAPPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1EE59270)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EE5A970)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EE5D110)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EE5D100)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EE58F90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EE58E00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EE59020)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1EE5BA50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x1EE5AAB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1EE5BA70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_REMOVE_ONMANUALMODEDISABLED_OFFSET UNITYSDK_OFFSET(0x1EE582D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_REMOVE_ONMANUALMODEENABLED_OFFSET UNITYSDK_OFFSET(0x1EE581B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_RESETPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EE5AB60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_RESTOREPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EE5AB40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SAVEPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EE5AB20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SETFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1EE5BE20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1EE5B160)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SETUPDATEMETHOD_OFFSET UNITYSDK_OFFSET(0x1EE58380)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ABSOLUTEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE58B90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ALLOWTICKLOD_OFFSET UNITYSDK_OFFSET(0x1EE58480)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_CLAMPING_OFFSET UNITYSDK_OFFSET(0x1EE58520)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_DIRECTIONDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1EE58600)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_DIRECTIONDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EE58080)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_IGNOREDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EE58640)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1EE5C2B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_LOCKROTATION_OFFSET UNITYSDK_OFFSET(0x1EE58580)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_MOTIONCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1EE58540)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EE58DA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_MOVEMODE_OFFSET UNITYSDK_OFFSET(0x1EE584E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1EE58660)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_OFFSETCOMPENSATION_OFFSET UNITYSDK_OFFSET(0x1EE586A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_OFFSETRADIUS_OFFSET UNITYSDK_OFFSET(0x1EE58680)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1EE585E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ORIENTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1EE58560)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_PLAYAUTOMATICALLY_OFFSET UNITYSDK_OFFSET(0x1EE58500)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_POSITIONMODE_OFFSET UNITYSDK_OFFSET(0x1EE584C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1EE58D00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_RELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE58930)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1EE586C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_TARGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EE584A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_UPDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1EE58620)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_UPDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EE580E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_UPDATEIN_OFFSET UNITYSDK_OFFSET(0x1EE58370)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1EE58F40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0x1EE5BA20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_TELEPORTBY_OFFSET UNITYSDK_OFFSET(0x1EE5BCA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_TELEPORTTO_OFFSET UNITYSDK_OFFSET(0x1EE5BB80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_UNBINDEVENTS_OFFSET UNITYSDK_OFFSET(0x1EE5AB10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_USERAFTERINIT_OFFSET UNITYSDK_OFFSET(0x1EE5B870)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_USERAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1EE5B880)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE5B8B0)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvyController_TypeDefinitionIndex = 39560;
	...
	public:
		...
		{
			return (::System::Action_1<::FluffyUnderware::Curvy::Controllers::CurvyController*>**)Il2CppClass::FromTypeDefinitionIndex(CurvyController_TypeDefinitionIndex)->GetStaticField(0x2AD30);
		}
		static ::System::Action_1<::FluffyUnderware::Curvy::Controllers::CurvyController*>** StaticGet_OnManualModeEnabled()
		{
			return (::System::Action_1<::FluffyUnderware::Curvy::Controllers::CurvyController*>**)Il2CppClass::FromTypeDefinitionIndex(CurvyController_TypeDefinitionIndex)->GetStaticField(0x2AD38);
		}
