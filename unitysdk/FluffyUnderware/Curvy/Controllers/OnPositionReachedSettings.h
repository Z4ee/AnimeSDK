...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_CLONE_OFFSET UNITYSDK_OFFSET(0x1E3B2CC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_INITIALIZEFIELDSWITHDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1E3B2C00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E3B2C60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E3B2C50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3B2AF0)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int OnPositionReachedSettings_TypeDefinitionIndex = 38947;
