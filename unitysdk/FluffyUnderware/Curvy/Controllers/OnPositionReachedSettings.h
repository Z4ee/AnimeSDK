...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_CLONE_OFFSET UNITYSDK_OFFSET(0x1F7A2000)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_INITIALIZEFIELDSWITHDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1F7A1F40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F7A1FA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F7A1F90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7A1E30)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int OnPositionReachedSettings_TypeDefinitionIndex = 39569;
