...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1DC83BF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCESWITCHING_OFFSET UNITYSDK_OFFSET(0x1DC85B20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1DC84420)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_CANCELCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1DC83790)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTEPOSITIONANDROTATIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1DC86770)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTETARGETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1DC861F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_EVENTAWAREMOVE_OFFSET UNITYSDK_OFFSET(0x1DC84530)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_FINISHCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1DC83720)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETANGLEBETWEENCONNECTEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1DC837C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETCONTROLPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1DC86CA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1DC83E80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DC83CD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DC842E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETPOSTCONNECTIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x1DC83A40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETSWITCHINGPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1DC86500)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1DC84130)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1DC83010)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1DC82FD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1DC82FF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_DIRECTIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1DC82C40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1DC83500)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1DC83140)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1DC830F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1DC83070)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1DC830B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1DC830D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1DC83090)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1DC831C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1DC83030)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1DC83050)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SHOWRANDOMCONNECTIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1DC885C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1DC82F90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHDURATION_OFFSET UNITYSDK_OFFSET(0x1DC82BE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHPROGRESS_OFFSET UNITYSDK_OFFSET(0x1DC83160)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1DC82BC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1DC82C00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_TFONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1DC82C20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1DC82FB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEFOLLOWUPCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1DC876E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENTS_OFFSET UNITYSDK_OFFSET(0x1DC86D60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENT_OFFSET UNITYSDK_OFFSET(0x1DC87C00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLERANDOMCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1DC87990)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEREACHINGNEWCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1DC87360)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HEADINGTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1DC88410)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INITIALIZEDAPPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1DC86030)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1DC88050)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1DC88180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLEGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1DC86890)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1DC86AA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1DC831E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1DC83B30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1DC86700)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1DC83B10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESTOREPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1DC83AD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SAVEPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1DC83A90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1DC83020)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1DC82FE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1DC83000)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1DC83080)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1DC830C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1DC830E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1DC830A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1DC831D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1DC83040)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1DC83060)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1DC82FA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1DC82FC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCEONSPLINE_OFFSET UNITYSDK_OFFSET(0x1DC85D40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1DC85CE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1DC83550)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC82C60)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_TypeDefinitionIndex = 38868;
	...
	public:
		...
		::FluffyUnderware::Curvy::CurvySpline* m_Spline; // 0xB0
		::System::Boolean m_UseCache; // 0xB8
		::FluffyUnderware::Curvy::Controllers::SplineControllerConnectionBehavior connectionBehavior; // 0xBC
		::System::Boolean allowDirectionChange; // 0xC0
		::System::Boolean rejectCurrentSpline; // 0xC1
		::System::Boolean rejectTooDivergentSplines; // 0xC2
		::System::Single maxAllowedDivergenceAngle; // 0xC4
		::FluffyUnderware::Curvy::Controllers::ConnectedControlPointsSelector* connectionCustomSelector; // 0xC8
		::System::Collections::Generic::List_1<::FluffyUnderware::Curvy::Controllers::OnPositionReachedSettings*>* onPositionReachedList; // 0xD0
		::FluffyUnderware::Curvy::Controllers::CurvySplineMoveEvent* m_OnControlPointReached; // 0xD8
		::FluffyUnderware::Curvy::Controllers::CurvySplineMoveEvent* m_OnEndReached; // 0xE0
		::FluffyUnderware::Curvy::Controllers::CurvySplineMoveEvent* m_OnSwitch; // 0xE8
		::FluffyUnderware::Curvy::Controllers::SplineController_SplineSwitcher* Switcher; // 0xF0
		::FluffyUnderware::Curvy::CurvySpline* prePlaySpline; // 0xF8
		::FluffyUnderware::Curvy::Controllers::CurvySplineMoveEventArgs* preAllocatedEventArgs; // 0x100
