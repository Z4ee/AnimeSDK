...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1EFA7910)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCESWITCHING_OFFSET UNITYSDK_OFFSET(0x1EFA97C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1EFA8100)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_CANCELCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1EFA74B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTEPOSITIONANDROTATIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1EFAA450)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTETARGETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1EFA9EB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_EVENTAWAREMOVE_OFFSET UNITYSDK_OFFSET(0x1EFA8210)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_FINISHCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1EFA7430)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETANGLEBETWEENCONNECTEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1EFA74E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETCONTROLPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1EFAA970)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1EFA7B70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EFA79F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1EFA7FC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETPOSTCONNECTIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EFA7760)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETSWITCHINGPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1EFAA1D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1EFA7E10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EFA6D20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1EFA6CE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1EFA6D00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_DIRECTIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1EFA6950)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1EFA7210)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1EFA6E50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1EFA6E00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1EFA6D80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1EFA6DC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1EFA6DE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1EFA6DA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1EFA6ED0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1EFA6D40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1EFA6D60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SHOWRANDOMCONNECTIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1EFAC2C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1EFA6CA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHDURATION_OFFSET UNITYSDK_OFFSET(0x1EFA68F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHPROGRESS_OFFSET UNITYSDK_OFFSET(0x1EFA6E70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1EFA68D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1EFA6910)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_TFONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1EFA6930)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1EFA6CC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEFOLLOWUPCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1EFAB3D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENTS_OFFSET UNITYSDK_OFFSET(0x1EFAAA30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENT_OFFSET UNITYSDK_OFFSET(0x1EFAB900)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLERANDOMCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1EFAB680)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEREACHINGNEWCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1EFAB040)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HEADINGTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1EFAC110)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INITIALIZEDAPPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1EFA9CE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1EFABD60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1EFABE90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLEGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1EFAA560)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1EFAA770)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EFA6EF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1EFA7850)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1EFAA3D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EFA7830)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESTOREPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EFA77F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SAVEPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1EFA77B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EFA6D30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1EFA6CF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1EFA6D10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1EFA6D90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1EFA6DD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1EFA6DF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1EFA6DB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1EFA6EE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1EFA6D50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1EFA6D70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1EFA6CB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1EFA6CD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCEONSPLINE_OFFSET UNITYSDK_OFFSET(0x1EFA99F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1EFA9990)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1EFA7260)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA6970)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_TypeDefinitionIndex = 39724;
