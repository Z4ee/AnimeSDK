...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1F33A150)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1F339FC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1F339F60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1F339FE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1F33A000)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1F339F80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1F339F40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_TF_OFFSET UNITYSDK_OFFSET(0x1F339FA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1F339FD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x1F339F70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1F339FF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1F339F90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1F339F50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_TF_OFFSET UNITYSDK_OFFSET(0x1F339FB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_START_OFFSET UNITYSDK_OFFSET(0x1F33A050)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_STOP_OFFSET UNITYSDK_OFFSET(0x1F33A1B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F33A1C0)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_SplineSwitcher_TypeDefinitionIndex = 39725;

	class SplineController_SplineSwitcher : public ::System::Object
	{
	public:
		::FluffyUnderware::Curvy::CurvySpline* _Spline_k__BackingField; // 0x10
		::FluffyUnderware::Curvy::Controllers::MovementDirection _Direction_k__BackingField; // 0x18
		::System::Single _Tf_k__BackingField; // 0x1C
		::System::Boolean _IsSwitching_k__BackingField; // 0x20
		::System::Single _Duration_k__BackingField; // 0x24
		::System::Single _StartTime_k__BackingField; // 0x28
