...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1BB1CB50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1BB1CBB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1BB1CB90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BB1CBD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x1BB1CB10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1BB1CB30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1BB1CB70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1BB1CB60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_DELTA_OFFSET UNITYSDK_OFFSET(0x1BB1CBC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1BB1CCA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1BB1CBA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BB1CBE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x1BB1CB20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1BB1CB40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1BB1CB80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1CBF0)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvySplineMoveEventArgs_TypeDefinitionIndex = 37274;
	...
	public:
		...
		::System::Boolean _WorldUnits_k__BackingField; // 0x38
		::System::Single _Delta_k__BackingField; // 0x3C
