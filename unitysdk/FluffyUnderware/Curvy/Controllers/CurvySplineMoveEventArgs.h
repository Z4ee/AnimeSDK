...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1F27F770)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1F27F7D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1F27F7B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F27F7F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x1F27F730)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1F27F750)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1F27F790)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1F27F780)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_DELTA_OFFSET UNITYSDK_OFFSET(0x1F27F7E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F27F8C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1F27F7C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F27F800)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x1F27F740)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1F27F760)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1F27F7A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F27F810)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvySplineMoveEventArgs_TypeDefinitionIndex = 39609;

	class CurvySplineMoveEventArgs : public ::System::ComponentModel::CancelEventArgs
	{
	public:
		::FluffyUnderware::Curvy::CurvySpline* _Spline_k__BackingField; // 0x18
		::FluffyUnderware::Curvy::Controllers::SplineController* _Sender_k__BackingField; // 0x20
		::FluffyUnderware::Curvy::CurvySplineSegment* _ControlPoint_k__BackingField; // 0x28
		::System::Single _Position_k__BackingField; // 0x30
		::FluffyUnderware::Curvy::Controllers::MovementDirection _MovementDirection_k__BackingField; // 0x34
		::System::Single _Delta_k__BackingField; // 0x38
		::System::Boolean _WorldUnits_k__BackingField; // 0x3C
