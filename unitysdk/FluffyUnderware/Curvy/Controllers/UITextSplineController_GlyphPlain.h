...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_CALCRECT_OFFSET UNITYSDK_OFFSET(0x1DE8EB20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1DE8E890)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_LOAD_OFFSET UNITYSDK_OFFSET(0x1DE8E8C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_ROTATE_OFFSET UNITYSDK_OFFSET(0x1DE8EE60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_SAVE_OFFSET UNITYSDK_OFFSET(0x1DE8EB90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1DE8ED70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE8F390)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int UITextSplineController_GlyphPlain_TypeDefinitionIndex = 38931;
