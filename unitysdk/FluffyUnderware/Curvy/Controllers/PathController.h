...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1D604460)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1D604C70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1D604750)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D6045E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1D604B00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1D604990)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1D604280)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D604120)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATHDATA_OFFSET UNITYSDK_OFFSET(0x1D604090)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1D604070)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1D6042D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SET_PATH_OFFSET UNITYSDK_OFFSET(0x1D604080)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1D604CE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D604FD0)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int PathController_TypeDefinitionIndex = 38822;
