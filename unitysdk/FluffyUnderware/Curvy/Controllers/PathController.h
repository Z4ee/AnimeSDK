...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1B21CE90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1B21D6A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1B21D180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B21D010)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B21D530)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1B21D3C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1B21CCB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B21CB50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATHDATA_OFFSET UNITYSDK_OFFSET(0x1B21CAC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1B21CAA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1B21CD00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SET_PATH_OFFSET UNITYSDK_OFFSET(0x1B21CAB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1B21D710)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21DA00)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int PathController_TypeDefinitionIndex = 37279;

	class PathController : public ::FluffyUnderware::Curvy::Controllers::CurvyController
	{
	public:
		::FluffyUnderware::Curvy::Generator::CGDataReference* m_Path; // 0xA8
