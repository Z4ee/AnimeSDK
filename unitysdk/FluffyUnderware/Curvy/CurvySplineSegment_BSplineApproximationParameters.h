...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x955580)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0x9554A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x955590)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x381840)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_DEGREE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ENDTF_OFFSET UNITYSDK_OFFSET(0x43E9B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ISCLAMPED_OFFSET UNITYSDK_OFFSET(0x3A4A80)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x955480)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_SEGMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x319030)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_STARTTF_OFFSET UNITYSDK_OFFSET(0x3AB430)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B22DAE0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B22DBC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x955490)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_BSplineApproximationParameters_TypeDefinitionIndex = 37231;
