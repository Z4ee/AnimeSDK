...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA46D00)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA46C20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA46D10)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x3C9DA0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_DEGREE_OFFSET UNITYSDK_OFFSET(0x325570)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ENDTF_OFFSET UNITYSDK_OFFSET(0x478130)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ISCLAMPED_OFFSET UNITYSDK_OFFSET(0x3D1BF0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0xA46C00)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_SEGMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x352810)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_STARTTF_OFFSET UNITYSDK_OFFSET(0x3D1D70)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E9B2840)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E9B2920)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0xA46C10)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_BSplineApproximationParameters_TypeDefinitionIndex = 39634;
