...
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1F92EF40)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GETUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1F92E4E0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1F92E9C0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GET_INSPECTORDEBUG_OFFSET UNITYSDK_OFFSET(0x1F92E4F0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GET_SEGMENT_OFFSET UNITYSDK_OFFSET(0x1F92E4D0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1F92E4C0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GET_TANGENT_OFFSET UNITYSDK_OFFSET(0x1F92ECF0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_GET_TF_OFFSET UNITYSDK_OFFSET(0x1F92E500)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_NOTIFYMODIFICATION_OFFSET UNITYSDK_OFFSET(0x1F92F360)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F92F1A0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_ONSPLINEREFRESH_OFFSET UNITYSDK_OFFSET(0x1F92F4A0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F92F4B0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyMetadataBase_Point_TypeDefinitionIndex = 39523;
	...
	public:
		...
		::System::Void OnSplineRefresh(::FluffyUnderware::Curvy::CurvySplineEventArgs* arg0)
		{
			return ((::System::Void(*)(::PVOID, ::FluffyUnderware::Curvy::CurvySplineEventArgs*))((::PBYTE)hIl2Cpp + FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_POINT_ONSPLINEREFRESH_OFFSET))(this, arg0);
		}
	};
}
