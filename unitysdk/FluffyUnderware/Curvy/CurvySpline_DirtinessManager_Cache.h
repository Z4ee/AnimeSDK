...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_DIRTINESSMANAGER_CACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9A2E60)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_DirtinessManager_Cache_TypeDefinitionIndex = 39672;

	class CurvySpline_DirtinessManager_Cache : public ::System::Object
	{
	public:
		::System::Collections::Generic::HashSet_1<::FluffyUnderware::Curvy::CurvySpline*>* SplineSet; // 0x10
		::System::Collections::Generic::List_1<::FluffyUnderware::Curvy::CurvySplineSegment*>* SegmentList; // 0x18
