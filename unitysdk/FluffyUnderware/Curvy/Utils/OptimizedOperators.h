...
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_ADDITION_OFFSET UNITYSDK_OFFSET(0x1F3425F0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_DIVISION_OFFSET UNITYSDK_OFFSET(0x1F344AD0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1F33DEF0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1F344AA0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x1F344B10)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_3_OFFSET UNITYSDK_OFFSET(0x1F344B30)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_4_OFFSET UNITYSDK_OFFSET(0x1F344B50)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1F344A70)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1F342560)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1F340A70)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1F344A40)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int OptimizedOperators_TypeDefinitionIndex = 39469;
