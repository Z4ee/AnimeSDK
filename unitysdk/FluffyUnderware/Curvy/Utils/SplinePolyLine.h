...
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETPOLYGON_OFFSET UNITYSDK_OFFSET(0x1C17DCF0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETVERTEXLIST_OFFSET UNITYSDK_OFFSET(0x1C17DAB0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x1C17D8E0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1C17D790)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C17D770)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C17D750)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C17D740)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int SplinePolyLine_TypeDefinitionIndex = 37257;
