...
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1D61CE50)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_1_OFFSET UNITYSDK_OFFSET(0x1D61C9B0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_2_OFFSET UNITYSDK_OFFSET(0x1D61CB50)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_3_OFFSET UNITYSDK_OFFSET(0x1D61CC90)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1D61C890)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_1_OFFSET UNITYSDK_OFFSET(0x1D61C5D0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_OFFSET UNITYSDK_OFFSET(0x1D61C4B0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPVALUE_OFFSET UNITYSDK_OFFSET(0x1D61C710)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D617B30)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETNEARESTPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1D60FDD0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_1_OFFSET UNITYSDK_OFFSET(0x1D610180)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_OFFSET UNITYSDK_OFFSET(0x1D61CEC0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_SPLINETOMESH_OFFSET UNITYSDK_OFFSET(0x1D61CEE0)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int CurvyUtility_TypeDefinitionIndex = 39052;
