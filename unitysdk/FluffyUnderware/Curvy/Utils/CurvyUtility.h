...
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1E9BA5F0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_1_OFFSET UNITYSDK_OFFSET(0x1E9BA170)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_2_OFFSET UNITYSDK_OFFSET(0x1E9BA300)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_3_OFFSET UNITYSDK_OFFSET(0x1E9BA440)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1E9BA050)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_1_OFFSET UNITYSDK_OFFSET(0x1E9B9D80)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_OFFSET UNITYSDK_OFFSET(0x1E9B9C60)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPVALUE_OFFSET UNITYSDK_OFFSET(0x1E9B9EC0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E9B52E0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETNEARESTPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1E9AD500)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_1_OFFSET UNITYSDK_OFFSET(0x1E9AD8C0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_OFFSET UNITYSDK_OFFSET(0x1E9BA660)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_SPLINETOMESH_OFFSET UNITYSDK_OFFSET(0x1E9BA680)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int CurvyUtility_TypeDefinitionIndex = 39478;
