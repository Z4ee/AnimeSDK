...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_APPLYPARALLELTRANSPORT_OFFSET UNITYSDK_OFFSET(0x1DB4ECD0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_APPLYSWIRLANDSMOOTHING_OFFSET UNITYSDK_OFFSET(0x1DB4EEA0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GETACCUMULATEDSWIRLANGLES_OFFSET UNITYSDK_OFFSET(0x1DB4F580)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GETORIENTATIONGAP_OFFSET UNITYSDK_OFFSET(0x1DB4F390)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1DB4E9F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_SETUPORIENTATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1DB4EAB0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_UPDATEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DB4ECB0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB4EA00)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_OrientationGroup_TypeDefinitionIndex = 38847;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* accumulatedCacheSizes; // 0x20
