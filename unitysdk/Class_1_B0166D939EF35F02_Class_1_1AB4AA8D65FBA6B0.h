...
#define CLASS_1_B0166D939EF35F02_CLASS_1_1AB4AA8D65FBA6B0__CTOR_OFFSET UNITYSDK_OFFSET(0x16343260)
...
public:
	...
	::Class_1_1C30CE192ABE4C54* CIJDNELBFIG; // 0x18
	::RPG::GameCore::TaskContext* BKIFMPHBIAK; // 0x20
	::RPG::GameCore::TaskConfig* EABKOHGCHFP; // 0x28
	::Class_1_93EC936D6B573DA2* BGOBPFANEHD; // 0x30
