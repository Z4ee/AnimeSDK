...
#define CLASS_1_A6B4D5686BDF6BEB_GET_CANDIDATEPOOLIDS_OFFSET UNITYSDK_OFFSET(0x17A2C410)
#define CLASS_1_A6B4D5686BDF6BEB_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x17A2C400)
#define CLASS_1_A6B4D5686BDF6BEB_METHOD_1_2AB34FE959A47862_OFFSET UNITYSDK_OFFSET(0x17A2C420)
#define CLASS_1_A6B4D5686BDF6BEB__CTOR_OFFSET UNITYSDK_OFFSET(0x17A2C660)

inline static constexpr unsigned int Class_1_A6B4D5686BDF6BEB_TypeDefinitionIndex = 65078;
