...
#define CLASS_2_9500E690955A5FE1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x180C1010)
#define CLASS_2_9500E690955A5FE1_METHOD_2_FC0CFB0AEEB99E45_OFFSET UNITYSDK_OFFSET(0x180C17A0)
#define CLASS_2_9500E690955A5FE1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x180C11D0)
#define CLASS_2_9500E690955A5FE1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x180C10D0)
#define CLASS_2_9500E690955A5FE1_TICK_OFFSET UNITYSDK_OFFSET(0x180C1170)
#define CLASS_2_9500E690955A5FE1__CTOR_OFFSET UNITYSDK_OFFSET(0x180C1000)
...
public:
	...
	::RPG::GameCore::RequestGroupStateChange* OFKGLJOAMLD; // 0x20
	::System::UInt32 PEEFHNHDBMF; // 0x28
	::System::UInt32 DEMEIKDPBAL; // 0x2C
	::System::UInt64 FDIBNPCCJAE; // 0x30
	::System::UInt32 AJJFAODDKFB; // 0x38
	::System::UInt32 ACHIDNBOBLA; // 0x3C
