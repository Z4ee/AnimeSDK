...
#define MIHOYOSDKJSON_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E0077F0)
#define MIHOYOSDKJSON_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E007430)
#define MIHOYOSDKJSON_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E007A20)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1E007510)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x1E007530)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x1E007420)
#define MIHOYOSDKJSON_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1E007410)
#define MIHOYOSDKJSON_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E007450)
#define MIHOYOSDKJSON_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0x1E0076E0)
#define MIHOYOSDKJSON_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1E007520)
#define MIHOYOSDKJSON_JSONNUMBER_SET_ASLONG_OFFSET UNITYSDK_OFFSET(0x1E007540)
#define MIHOYOSDKJSON_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E007490)
#define MIHOYOSDKJSON_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1E007680)
#define MIHOYOSDKJSON_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E0075C0)
#define MIHOYOSDKJSON_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E007550)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNumber_TypeDefinitionIndex = 37104;
