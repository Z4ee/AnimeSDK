...
#define MIHOYOSDKJSON_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AE40140)
#define MIHOYOSDKJSON_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE3FF70)
#define MIHOYOSDKJSON_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AE402F0)
#define MIHOYOSDKJSON_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1AE3FF60)
#define MIHOYOSDKJSON_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1AE3FF50)
#define MIHOYOSDKJSON_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AE3FF90)
#define MIHOYOSDKJSON_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AE3FFA0)
#define MIHOYOSDKJSON_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1AE40010)
#define MIHOYOSDKJSON_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3FFB0)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONString_TypeDefinitionIndex = 34881;
