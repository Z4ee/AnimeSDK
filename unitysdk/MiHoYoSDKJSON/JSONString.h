...
#define MIHOYOSDKJSON_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x85B2B20)
#define MIHOYOSDKJSON_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x85B2A70)
#define MIHOYOSDKJSON_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x85B2C90)
#define MIHOYOSDKJSON_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x85B2A60)
#define MIHOYOSDKJSON_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x85B2A50)
#define MIHOYOSDKJSON_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x85B2A90)
#define MIHOYOSDKJSON_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x85B2AA0)
#define MIHOYOSDKJSON_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x85B2AB0)
#define MIHOYOSDKJSON_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x85AE420)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONString_TypeDefinitionIndex = 36836;
