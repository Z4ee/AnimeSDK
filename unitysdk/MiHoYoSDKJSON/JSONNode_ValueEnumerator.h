...
#define MIHOYOSDKJSON_JSONNODE_VALUEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x29FB0)
...
{
	inline static constexpr unsigned int JSONNode_ValueEnumerator_TypeDefinitionIndex = 42652;
