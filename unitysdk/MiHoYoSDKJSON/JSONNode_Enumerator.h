...
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2CD90)
...
{
	inline static constexpr unsigned int JSONNode_Enumerator_TypeDefinitionIndex = 43453;
