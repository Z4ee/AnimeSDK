...
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8B5AC0)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x5B28F0)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8B5B10)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x81C9D0)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x81C980)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNode_Enumerator_TypeDefinitionIndex = 34869;
