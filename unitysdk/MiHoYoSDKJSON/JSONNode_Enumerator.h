...
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x3A33950)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC2F770)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A339A0)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x397B570)
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x397B520)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNode_Enumerator_TypeDefinitionIndex = 44314;
