...
#define MIHOYOSDKJSON_JSONNODE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x29FB0)
...
{
	inline static constexpr unsigned int JSONNode_Enumerator_TypeDefinitionIndex = 42650;
