...
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x85B0540)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MIHOYOSDKJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x85B0BB0)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MIHOYOSDKJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x85B0B40)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x85B0C30)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x85B0BA0)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x85B0B50)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85B0210)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x85AEB70)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x85B0490)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x85B03E0)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNode__get_DeepChildren_d__43_TypeDefinitionIndex = 36830;

	class JSONNode__get_DeepChildren_d__43 : public ::System::Object
	{
	public:
		::MiHoYoSDKJSON::JSONNode* __4__this; // 0x10
		::System::Collections::Generic::IEnumerator_1<::MiHoYoSDKJSON::JSONNode*>* __7__wrap2; // 0x18
		::MiHoYoSDKJSON::JSONNode* __2__current; // 0x20
