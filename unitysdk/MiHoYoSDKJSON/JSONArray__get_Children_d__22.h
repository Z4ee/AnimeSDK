...
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CD54770)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MIHOYOSDKJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CD54970)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MIHOYOSDKJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD54900)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CD549F0)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD54960)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CD54910)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD54750)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD540D0)
#define MIHOYOSDKJSON_JSONARRAY__GET_CHILDREN_D__22___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1CD54760)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONArray__get_Children_d__22_TypeDefinitionIndex = 46504;

	class JSONArray__get_Children_d__22 : public ::System::Object
	{
	public:
		::MiHoYoSDKJSON::JSONArray* __4__this; // 0x10
		::MiHoYoSDKJSON::JSONNode* __2__current; // 0x18
		::System::Collections::Generic::List_1_Enumerator<::MiHoYoSDKJSON::JSONNode*> __7__wrap1; // 0x20
