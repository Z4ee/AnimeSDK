...
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA233400)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA233420)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA233230)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA233330)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA233470)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA2335A0)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA233290)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA230EB0)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNode_LinqEnumerator_TypeDefinitionIndex = 43457;
