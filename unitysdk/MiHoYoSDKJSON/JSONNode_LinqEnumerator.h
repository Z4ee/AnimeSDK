...
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD58E20)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CD58E40)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD58C50)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CD58D50)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CD58E90)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CD58FA0)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD58CB0)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD56260)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNode_LinqEnumerator_TypeDefinitionIndex = 46500;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::MiHoYoSDKJSON::JSONNode*))((::PBYTE)hIl2Cpp + MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR__CTOR_OFFSET))(this, a1);
		}
