...
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_0E5EBD4812417522_OFFSET UNITYSDK_OFFSET(0x1CAD5380)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_0FAEE31385A1724C_OFFSET UNITYSDK_OFFSET(0x1CAD54C0)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_101639FD7468FD9D_OFFSET UNITYSDK_OFFSET(0x1CAD5030)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_18712DB3B1B723E8_OFFSET UNITYSDK_OFFSET(0x1CAD5530)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_5E40381A9D0A7403_OFFSET UNITYSDK_OFFSET(0x1CAD52C0)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_745CB1E678C03D3A_OFFSET UNITYSDK_OFFSET(0x1CAD50F0)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_8EB7B3E3BA847A23_OFFSET UNITYSDK_OFFSET(0x1CAD5360)
#define CLASS_1_232C1F3EBC1590A7_METHOD_1_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0x1CAD5770)
#define CLASS_1_232C1F3EBC1590A7__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD5670)

inline static constexpr unsigned int Class_1_232C1F3EBC1590A7_TypeDefinitionIndex = 10348;

class Class_1_232C1F3EBC1590A7 : public ::System::Object
{
public:
	static ::Class_1_232C1F3EBC1590A7** StaticGet_EMLNOINPICJ()
	{
		return (::Class_1_232C1F3EBC1590A7**)Il2CppClass::FromTypeDefinitionIndex(Class_1_232C1F3EBC1590A7_TypeDefinitionIndex)->GetStaticField(0x47A30);
	}
	::System::Collections::Generic::List_1<::System::Byte>* NLJFNCBAGJB; // 0x10
	::System::Collections::Generic::List_1<::System::Int32>* NMBCAEAPIPN; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::FixPoint>* GKGAKIADDCD; // 0x20
