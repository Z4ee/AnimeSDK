...
#define CLASS_2_DADF6E2264D3431E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17DDABF0)
#define CLASS_2_DADF6E2264D3431E_METHOD_2_71436269021F921C_OFFSET UNITYSDK_OFFSET(0x17DDB020)
#define CLASS_2_DADF6E2264D3431E_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x17DDAD20)
#define CLASS_2_DADF6E2264D3431E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17DDAC30)
#define CLASS_2_DADF6E2264D3431E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17DDAF70)
#define CLASS_2_DADF6E2264D3431E_TICK_OFFSET UNITYSDK_OFFSET(0x17DDAFC0)
#define CLASS_2_DADF6E2264D3431E__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDABE0)

inline static constexpr unsigned int Class_2_DADF6E2264D3431E_TypeDefinitionIndex = 55783;

class Class_2_DADF6E2264D3431E : public ::Class_1_5F51D4049EA87B7B
{
public:
	// static const ::System::String* NEHPDHONFOB; // 0x0
	::RPG::GameCore::SetVersusBar* OFKGLJOAMLD; // 0x18
