...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLHANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x18973940)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x18973920)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLHANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x18973900)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x18973A60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_EXISTING_OFFSET UNITYSDK_OFFSET(0x18973A80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_HANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x18973840)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_HANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x18973820)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_HIDEHANDLES_OFFSET UNITYSDK_OFFSET(0x189735A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LABELCOLORSELECTED_OFFSET UNITYSDK_OFFSET(0x189739E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LABELCOLOR_OFFSET UNITYSDK_OFFSET(0x189739C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LABELCONTROLCOLOR_OFFSET UNITYSDK_OFFSET(0x18973AC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LINECOLOR_OFFSET UNITYSDK_OFFSET(0x189738C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_NEWPOINTDISTANCE_OFFSET UNITYSDK_OFFSET(0x189735C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_RESTRICTGIZMOZSETTINGS_OFFSET UNITYSDK_OFFSET(0x189736A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_RESTRICTGIZMOZ_OFFSET UNITYSDK_OFFSET(0x18973680)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x18973860)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCONTROLHANDLES_OFFSET UNITYSDK_OFFSET(0x189738E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCONTROLLABELS_OFFSET UNITYSDK_OFFSET(0x18973AA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x189739A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCURVEMODE_OFFSET UNITYSDK_OFFSET(0x18973720)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCURVEOPTION_OFFSET UNITYSDK_OFFSET(0x18973740)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCURVE_OFFSET UNITYSDK_OFFSET(0x18973660)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWHANDLES_OFFSET UNITYSDK_OFFSET(0x18973760)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWLABELS_OFFSET UNITYSDK_OFFSET(0x18973960)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x18973620)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x189735E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTMENU_OFFSET UNITYSDK_OFFSET(0x18973640)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x18973600)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOSITIONS_OFFSET UNITYSDK_OFFSET(0x18973980)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWSPHERES_OFFSET UNITYSDK_OFFSET(0x18973A00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWTANGENTS_OFFSET UNITYSDK_OFFSET(0x18973780)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWTRANSFORMFIELD_OFFSET UNITYSDK_OFFSET(0x18973AE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SPHERECOLOR_OFFSET UNITYSDK_OFFSET(0x18973A40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x18973A20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_TANGENTSCOLOR_OFFSET UNITYSDK_OFFSET(0x189737C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_TANGENTSPERSECTION_OFFSET UNITYSDK_OFFSET(0x189737E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_TANGENTSSIZE_OFFSET UNITYSDK_OFFSET(0x189737A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_VRAY_OFFSET UNITYSDK_OFFSET(0x189738A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLHANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x18973950)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x18973930)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLHANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x18973910)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x18973A70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_EXISTING_OFFSET UNITYSDK_OFFSET(0x18973A90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_HANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x18973850)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_HANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x18973830)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_HIDEHANDLES_OFFSET UNITYSDK_OFFSET(0x189735B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LABELCOLORSELECTED_OFFSET UNITYSDK_OFFSET(0x189739F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LABELCOLOR_OFFSET UNITYSDK_OFFSET(0x189739D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LABELCONTROLCOLOR_OFFSET UNITYSDK_OFFSET(0x18973AD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LINECOLOR_OFFSET UNITYSDK_OFFSET(0x189738D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_NEWPOINTDISTANCE_OFFSET UNITYSDK_OFFSET(0x189735D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_RESTRICTGIZMOZ_OFFSET UNITYSDK_OFFSET(0x18973690)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x18973880)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCONTROLHANDLES_OFFSET UNITYSDK_OFFSET(0x189738F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCONTROLLABELS_OFFSET UNITYSDK_OFFSET(0x18973AB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x189739B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCURVEMODE_OFFSET UNITYSDK_OFFSET(0x18973730)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCURVEOPTION_OFFSET UNITYSDK_OFFSET(0x18973750)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCURVE_OFFSET UNITYSDK_OFFSET(0x18973670)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWHANDLES_OFFSET UNITYSDK_OFFSET(0x18973770)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWLABELS_OFFSET UNITYSDK_OFFSET(0x18973970)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x18973630)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x189735F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTMENU_OFFSET UNITYSDK_OFFSET(0x18973650)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x18973610)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOSITIONS_OFFSET UNITYSDK_OFFSET(0x18973990)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWSPHERES_OFFSET UNITYSDK_OFFSET(0x18973A10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWTANGENTS_OFFSET UNITYSDK_OFFSET(0x18973790)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWTRANSFORMFIELD_OFFSET UNITYSDK_OFFSET(0x18973AF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SPHERECOLOR_OFFSET UNITYSDK_OFFSET(0x18973A50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x18973A30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_TANGENTSCOLOR_OFFSET UNITYSDK_OFFSET(0x189737D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_TANGENTSPERSECTION_OFFSET UNITYSDK_OFFSET(0x18973800)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_TANGENTSSIZE_OFFSET UNITYSDK_OFFSET(0x189737B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_VRAY_OFFSET UNITYSDK_OFFSET(0x189738B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18973B00)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurveSettings_TypeDefinitionIndex = 34106;
