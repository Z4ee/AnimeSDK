...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_CALCULATESPLITSECTION_OFFSET UNITYSDK_OFFSET(0x16582450)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_INIT_OFFSET UNITYSDK_OFFSET(0x16581A20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_ISUSEDISTANCETOADJUSTTANGENTS_OFFSET UNITYSDK_OFFSET(0x16582440)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_RECURSIVECUBICSPLIT_OFFSET UNITYSDK_OFFSET(0x16582FE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_RECURSIVEQUADRATICSPLIT_OFFSET UNITYSDK_OFFSET(0x16583780)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_RESET_OFFSET UNITYSDK_OFFSET(0x16581D20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16583D80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEADAPTIVEMATH__CTOR_OFFSET UNITYSDK_OFFSET(0x16564130)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurveAdaptiveMath_TypeDefinitionIndex = 28171;
