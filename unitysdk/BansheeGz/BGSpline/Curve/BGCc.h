...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ADDEDINEDITOR_OFFSET UNITYSDK_OFFSET(0x17B9CF60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ADD_CHANGEDPARAMS_OFFSET UNITYSDK_OFFSET(0x17B8ECE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CHECKREQUIRED_OFFSET UNITYSDK_OFFSET(0x17B9D150)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CHOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0x17B8A7E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CONTEXTMENUITEMS_OFFSET UNITYSDK_OFFSET(0x17B9D370)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CONTEXTMENUVALIDATE_OFFSET UNITYSDK_OFFSET(0x17B9D380)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_FIRECHANGEDPARAMS_OFFSET UNITYSDK_OFFSET(0x17B84F90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17B9CD10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETHELPURL_OFFSET UNITYSDK_OFFSET(0x17B9CE20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETPARENTCLASS_1_OFFSET UNITYSDK_OFFSET(0x17B9CF90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETPARENTCLASS_OFFSET UNITYSDK_OFFSET(0x17B9CF70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETPARENT_OFFSET UNITYSDK_OFFSET(0x17B9CB10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_CCNAME_OFFSET UNITYSDK_OFFSET(0x17B9CBB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x17B858A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17B9CCD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x17B9CA90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_HELPURL_OFFSET UNITYSDK_OFFSET(0x17B9CDF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_HIDDEN_OFFSET UNITYSDK_OFFSET(0x17B9CAB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_HIDEHANDLESININSPECTOR_OFFSET UNITYSDK_OFFSET(0x17B9CAF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_INFO_OFFSET UNITYSDK_OFFSET(0x17B9CA70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_SHOWHANDLES_OFFSET UNITYSDK_OFFSET(0x17B9CAA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_SUPPORTHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x17B9CAE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x17B9CAD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x17B9CA80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_HASERROR_OFFSET UNITYSDK_OFFSET(0x17B9CF00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_HASWARNING_OFFSET UNITYSDK_OFFSET(0x17B9CF30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ISSINGLE_OFFSET UNITYSDK_OFFSET(0x17B9D260)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B9CEF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_REMOVE_CHANGEDPARAMS_OFFSET UNITYSDK_OFFSET(0x17B8DD90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SETPARENT_OFFSET UNITYSDK_OFFSET(0x17B9CB00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SET_CCNAME_OFFSET UNITYSDK_OFFSET(0x17B9CC20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SET_HIDDEN_OFFSET UNITYSDK_OFFSET(0x17B9CAC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SHOWERROR_OFFSET UNITYSDK_OFFSET(0x17B9D430)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_START_OFFSET UNITYSDK_OFFSET(0x17B9CEE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_TRANSACTION_OFFSET UNITYSDK_OFFSET(0x17B9D2D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_WHYDISABLED_OFFSET UNITYSDK_OFFSET(0x17B9D4B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC__CTOR_OFFSET UNITYSDK_OFFSET(0x17B90080)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCc_TypeDefinitionIndex = 33782;
