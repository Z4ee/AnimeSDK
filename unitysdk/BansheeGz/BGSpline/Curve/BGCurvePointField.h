...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_CHECKNAME_OFFSET UNITYSDK_OFFSET(0x183B3150)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x183C82E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_EQUALS_OFFSET UNITYSDK_OFFSET(0x183C81E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x183C8470)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x183C81D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_GET_FIELDNAME_OFFSET UNITYSDK_OFFSET(0x183C7ED0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x183C81C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_INIT_OFFSET UNITYSDK_OFFSET(0x183B3370)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_SET_FIELDNAME_OFFSET UNITYSDK_OFFSET(0x183C7EE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x183C8510)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x183C8520)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurvePointField_TypeDefinitionIndex = 35333;
