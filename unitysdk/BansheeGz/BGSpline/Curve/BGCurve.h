...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELDS_OFFSET UNITYSDK_OFFSET(0x16900340)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x168FA970)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x168FA960)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_1_OFFSET UNITYSDK_OFFSET(0x168F7170)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_2_OFFSET UNITYSDK_OFFSET(0x168F69A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_OFFSET UNITYSDK_OFFSET(0x168F6960)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_1_OFFSET UNITYSDK_OFFSET(0x168F6950)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_2_OFFSET UNITYSDK_OFFSET(0x168F64C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x168F6490)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADD_BEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x168F3210)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADD_CHANGED_OFFSET UNITYSDK_OFFSET(0x168E0B90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_1_OFFSET UNITYSDK_OFFSET(0x168FBF20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_2_OFFSET UNITYSDK_OFFSET(0x168FC530)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_OFFSET UNITYSDK_OFFSET(0x168F4A00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_1_OFFSET UNITYSDK_OFFSET(0x168FC5B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_2_OFFSET UNITYSDK_OFFSET(0x168FC7E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_OFFSET UNITYSDK_OFFSET(0x168F4DE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CACHEPOINTSWITHTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x168F8880)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CLEAR_OFFSET UNITYSDK_OFFSET(0x168F6070)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTGOTOINLINE_OFFSET UNITYSDK_OFFSET(0x169005E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTINLINETOGO_OFFSET UNITYSDK_OFFSET(0x16900420)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTPOINTS_OFFSET UNITYSDK_OFFSET(0x168F3920)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERT_OFFSET UNITYSDK_OFFSET(0x168FE330)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x168F5FD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x168F5F40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMWORLDPOSITION_1_OFFSET UNITYSDK_OFFSET(0x168F5DE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x168F5CD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETEFIELD_1_OFFSET UNITYSDK_OFFSET(0x168FAD60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETEFIELD_OFFSET UNITYSDK_OFFSET(0x168FAD50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_1_OFFSET UNITYSDK_OFFSET(0x168F7440)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_2_OFFSET UNITYSDK_OFFSET(0x168F7450)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_3_OFFSET UNITYSDK_OFFSET(0x168F71B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_4_OFFSET UNITYSDK_OFFSET(0x168F7460)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_OFFSET UNITYSDK_OFFSET(0x168F7190)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DESTROYIT_OFFSET UNITYSDK_OFFSET(0x168F6370)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIREBEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x168F34E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIRECHANGE_OFFSET UNITYSDK_OFFSET(0x168F3640)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIREFINALEVENT_OFFSET UNITYSDK_OFFSET(0x168FD6C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FOREACH_OFFSET UNITYSDK_OFFSET(0x168FDF60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GETFIELDSVALUES_OFFSET UNITYSDK_OFFSET(0x168FA400)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GETFIELD_OFFSET UNITYSDK_OFFSET(0x168FB2E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_CHANGELIST_OFFSET UNITYSDK_OFFSET(0x168F5C60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x168F3340)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_EVENTMODE_OFFSET UNITYSDK_OFFSET(0x168F5C20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FIELDSCOUNT_OFFSET UNITYSDK_OFFSET(0x168F3320)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FIELDS_OFFSET UNITYSDK_OFFSET(0x168F3310)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FORCECHANGEDEVENTMODE_OFFSET UNITYSDK_OFFSET(0x168F59E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_IMMEDIATECHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x168F5C40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x168D89D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_MODE2DON_OFFSET UNITYSDK_OFFSET(0x168E8E20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_MODE2D_OFFSET UNITYSDK_OFFSET(0x168F49E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTSCOUNT_OFFSET UNITYSDK_OFFSET(0x168D7640)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTSMODE_OFFSET UNITYSDK_OFFSET(0x168F38F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x168E37B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x168F3200)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPAXIS_OFFSET UNITYSDK_OFFSET(0x168F4EC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPDISTANCE_OFFSET UNITYSDK_OFFSET(0x168F5090)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPLAYERMASK_OFFSET UNITYSDK_OFFSET(0x168F5650)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPMONITORING_OFFSET UNITYSDK_OFFSET(0x168F5820)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTOBACKFACES_OFFSET UNITYSDK_OFFSET(0x168F5480)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x168F52B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTYPE_OFFSET UNITYSDK_OFFSET(0x168F4C10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SUPRESSEVENTS_OFFSET UNITYSDK_OFFSET(0x168F5BC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_TRACECHANGES_OFFSET UNITYSDK_OFFSET(0x168F5BA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_TRANSACTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x168FD570)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_USEEVENTSARGS_OFFSET UNITYSDK_OFFSET(0x168F5C00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_HASFIELD_OFFSET UNITYSDK_OFFSET(0x168FB3C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOFFIELDVALUE_OFFSET UNITYSDK_OFFSET(0x168FB4A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x168FB210)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOF_OFFSET UNITYSDK_OFFSET(0x168F6380)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ISGOMODE_OFFSET UNITYSDK_OFFSET(0x168F8680)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x168FDD60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATETRANSFORMFORPOINTADDED_OFFSET UNITYSDK_OFFSET(0x168FE160)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATETRANSFORMFORPOINTREMOVED_OFFSET UNITYSDK_OFFSET(0x168FE290)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATEUPDATEFIELDSVALUESINDEXES_OFFSET UNITYSDK_OFFSET(0x168FB570)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REMOVE_BEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x168F3290)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REMOVE_CHANGED_OFFSET UNITYSDK_OFFSET(0x168E2140)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REVERSE_OFFSET UNITYSDK_OFFSET(0x168F8B30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SETFIELDSVALUES_OFFSET UNITYSDK_OFFSET(0x168FA560)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SETPOINTSNAMES_OFFSET UNITYSDK_OFFSET(0x168F8690)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x168F3350)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_EVENTMODE_OFFSET UNITYSDK_OFFSET(0x168F5C30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_FORCECHANGEDEVENTMODE_OFFSET UNITYSDK_OFFSET(0x168F59F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_IMMEDIATECHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x168F5C50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x168FA6D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_MODE2D_OFFSET UNITYSDK_OFFSET(0x168F49F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_POINTSMODE_OFFSET UNITYSDK_OFFSET(0x168F3900)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPAXIS_OFFSET UNITYSDK_OFFSET(0x168F4ED0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPDISTANCE_OFFSET UNITYSDK_OFFSET(0x168F50A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPLAYERMASK_OFFSET UNITYSDK_OFFSET(0x168F5660)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPMONITORING_OFFSET UNITYSDK_OFFSET(0x168F5830)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTOBACKFACES_OFFSET UNITYSDK_OFFSET(0x168F5490)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x168F52C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTYPE_OFFSET UNITYSDK_OFFSET(0x168F4C20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SUPRESSEVENTS_OFFSET UNITYSDK_OFFSET(0x168F5BD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_TRACECHANGES_OFFSET UNITYSDK_OFFSET(0x168F5BB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_USEEVENTSARGS_OFFSET UNITYSDK_OFFSET(0x168F5C10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SNAPIT_OFFSET UNITYSDK_OFFSET(0x168FD2E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_START_OFFSET UNITYSDK_OFFSET(0x168FD640)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SWAP_OFFSET UNITYSDK_OFFSET(0x168F8040)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOLOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x168FDE80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOLOCAL_OFFSET UNITYSDK_OFFSET(0x168FDDA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x168FE0B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOWORLDDIRECTION_OFFSET UNITYSDK_OFFSET(0x168FDEF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOWORLD_OFFSET UNITYSDK_OFFSET(0x168FDE10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TRANSACTION_OFFSET UNITYSDK_OFFSET(0x168FBBA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_UPDATE_OFFSET UNITYSDK_OFFSET(0x168FD650)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__APPLY2D_B__169_0_OFFSET UNITYSDK_OFFSET(0x16902BF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x16902B20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16902A90)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurve_TypeDefinitionIndex = 34439;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4B770);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet_pointsIndexesList()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4B778);
		}
		static ::Il2CppArray<::BansheeGz::BGSpline::Curve::BGCurvePointI*>** StaticGet_pointArray()
		{
			return (::Il2CppArray<::BansheeGz::BGSpline::Curve::BGCurvePointI*>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4B780);
		}
		static ::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Curve::BGCurvePointI*>** StaticGet_pointsList()
		{
			return (::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Curve::BGCurvePointI*>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4B788);
		}
