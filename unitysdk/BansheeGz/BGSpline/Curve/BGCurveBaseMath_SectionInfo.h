...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_CALCBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x17B9A8D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_FINDPOINTINDEXBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x17BB58B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x17B875A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x17B9A040)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_GET_POINTSCOUNT_OFFSET UNITYSDK_OFFSET(0x17B9A070)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x17BB57E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_RESET_OFFSET UNITYSDK_OFFSET(0x17BACA20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x17BB5860)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17BB57F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_SECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17BB2C50)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurveBaseMath_SectionInfo_TypeDefinitionIndex = 33801;
	...
	public:
		...
		::UnityEngine::Vector3 OriginalTo; // 0x18
		::UnityEngine::Vector3 OriginalToControl; // 0x24
		::System::Single DistanceFromStartToOrigin; // 0x30
		::BansheeGz::BGSpline::Curve::BGCurvePoint_ControlTypeEnum OriginalFromControlType; // 0x34
		::UnityEngine::Vector3 OriginalFromControl; // 0x38
		::UnityEngine::Vector3 OriginalFirstPointTangent; // 0x44
		::UnityEngine::Vector3 OriginalLastPointTangent; // 0x50
		::BansheeGz::BGSpline::Curve::BGCurvePoint_ControlTypeEnum OriginalToControlType; // 0x5C
