...
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D2FDE80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1D2FDF20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1D2FDFB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISSUBCLASSOF_OFFSET UNITYSDK_OFFSET(0x1D2FDFD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1D2FE070)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGReflectionAdapter_TypeDefinitionIndex = 34483;
