...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_ADD_UPDATE_OFFSET UNITYSDK_OFFSET(0x1895E9F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18965A20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_EQUALS_OFFSET UNITYSDK_OFFSET(0x189659E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_FIREUPDATE_OFFSET UNITYSDK_OFFSET(0x1893E100)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18965AC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_REMOVE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1895E990)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1893CC50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189659D0)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurveBaseMath_Config_TypeDefinitionIndex = 34082;
	...
	public:
		...
		::System::Boolean UsePointPositionsToCalcTangents; // 0x28
		::System::Boolean OptimizeStraightLines; // 0x29
