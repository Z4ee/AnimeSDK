...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_ADD_UPDATE_OFFSET UNITYSDK_OFFSET(0x16905BE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1690D900)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_EQUALS_OFFSET UNITYSDK_OFFSET(0x1690D8C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_FIREUPDATE_OFFSET UNITYSDK_OFFSET(0x168E3920)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1690D9A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG_REMOVE_UPDATE_OFFSET UNITYSDK_OFFSET(0x16905B80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG__CTOR_1_OFFSET UNITYSDK_OFFSET(0x168E2210)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEBASEMATH_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1690D8B0)
