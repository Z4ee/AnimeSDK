...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ITERATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16581990)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ITERATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16581A10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ITERATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1657CD10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ITERATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16581970)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurve_IterationCallback_TypeDefinitionIndex = 28169;
