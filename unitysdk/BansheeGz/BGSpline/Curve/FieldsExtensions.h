...
#define BANSHEEGZ_BGSPLINE_CURVE_FIELDSEXTENSIONS_VAL_OFFSET UNITYSDK_OFFSET(0x18974360)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int FieldsExtensions_TypeDefinitionIndex = 34086;
