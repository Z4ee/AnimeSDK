...
#define BANSHEEGZ_BGSPLINE_CURVE_FIELDSEXTENSIONS_VAL_OFFSET UNITYSDK_OFFSET(0x1C01C1A0)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int FieldsExtensions_TypeDefinitionIndex = 35317;
