...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_COMPLY_OFFSET UNITYSDK_OFFSET(0x1BFFA9F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1BFFAAF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BFFAC30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFFABB0)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int BGCurve_FieldsTree_TypeDefinitionIndex = 35307;
