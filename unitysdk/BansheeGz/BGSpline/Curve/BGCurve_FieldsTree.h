...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_COMPLY_OFFSET UNITYSDK_OFFSET(0x183AC990)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_GETINDEX_OFFSET UNITYSDK_OFFSET(0x183ACA90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_UPDATE_OFFSET UNITYSDK_OFFSET(0x183ACBD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x183ACB50)
