...
#define BANSHEEGZ_BGSPLINE_CURVE_FIELDEXTENSIONS_IN_OFFSET UNITYSDK_OFFSET(0x18974340)
#define BANSHEEGZ_BGSPLINE_CURVE_FIELDEXTENSIONS_VAL_OFFSET UNITYSDK_OFFSET(0x18974350)

namespace BansheeGz::BGSpline::Curve
{
	inline static constexpr unsigned int FieldExtensions_TypeDefinitionIndex = 34085;
