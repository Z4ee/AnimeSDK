...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x16569950)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x16569AB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_FLIP_OFFSET UNITYSDK_OFFSET(0x16569910)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x16569B80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x16569DB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x165698A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x16569980)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_USELOCAL_OFFSET UNITYSDK_OFFSET(0x16569AA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1656A450)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1656A3E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x16569960)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_FLIP_OFFSET UNITYSDK_OFFSET(0x16569920)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x165698B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x16569990)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_START_OFFSET UNITYSDK_OFFSET(0x16569E40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UIUPDATER_OFFSET UNITYSDK_OFFSET(0x16569A50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1656AFB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x16569F90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1656AFF0)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcTriangulate2D_TypeDefinitionIndex = 28228;
