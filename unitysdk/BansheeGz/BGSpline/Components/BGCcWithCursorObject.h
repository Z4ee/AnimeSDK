...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x18938800)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT_GET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x18948410)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT_SET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x18948420)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18939ED0)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcWithCursorObject_TypeDefinitionIndex = 34143;
