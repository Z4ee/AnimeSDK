...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1BFE5680)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_LINEWIDTH_OFFSET UNITYSDK_OFFSET(0x1BFE5500)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x1BFE58A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_PROFILEMODE_OFFSET UNITYSDK_OFFSET(0x1BFE54A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_PROFILESPLINE_OFFSET UNITYSDK_OFFSET(0x1BFE5590)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_SWAPNORMALS_OFFSET UNITYSDK_OFFSET(0x1BFE5620)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_SWAPUV_OFFSET UNITYSDK_OFFSET(0x1BFE55F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_UCOORDINATEEND_OFFSET UNITYSDK_OFFSET(0x1BFE5560)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_UCOORDINATESTART_OFFSET UNITYSDK_OFFSET(0x1BFE5530)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_VCOORDINATESCALE_OFFSET UNITYSDK_OFFSET(0x1BFE5650)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_LINEWIDTH_OFFSET UNITYSDK_OFFSET(0x1BFE5510)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_PROFILEMODE_OFFSET UNITYSDK_OFFSET(0x1BFE54B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_PROFILESPLINE_OFFSET UNITYSDK_OFFSET(0x1BFE55A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_SWAPNORMALS_OFFSET UNITYSDK_OFFSET(0x1BFE5630)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_SWAPUV_OFFSET UNITYSDK_OFFSET(0x1BFE5600)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_UCOORDINATEEND_OFFSET UNITYSDK_OFFSET(0x1BFE5570)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_UCOORDINATESTART_OFFSET UNITYSDK_OFFSET(0x1BFE5540)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_VCOORDINATESCALE_OFFSET UNITYSDK_OFFSET(0x1BFE5660)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_START_OFFSET UNITYSDK_OFFSET(0x1BFE5930)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1BFE7960)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x1BFE59F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFE7BB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE79A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D__GET_ERROR_B__34_0_OFFSET UNITYSDK_OFFSET(0x1BFE7C50)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Components::BGCcSweep2D_PositionWithU>**)Il2CppClass::FromTypeDefinitionIndex(BGCcSweep2D_TypeDefinitionIndex)->GetStaticField(0x63840);
		}
