...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERMATH_COMPLY_OFFSET UNITYSDK_OFFSET(0x1BFEEEE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERMATH_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x1BFEEEF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERMATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFED780)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGPolylineSplitter_PositionsProviderMath_TypeDefinitionIndex = 35382;
