...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1838DD10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS_GET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0x1838DE20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS_SET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0x1838DE30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1838DE60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1838DE40)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcCursorChangeLinear_PointReachedArgs_TypeDefinitionIndex = 35349;
	...
	public:
		...
		{
			return (::BansheeGz::BGSpline::Components::BGCcCursorChangeLinear_PointReachedArgs**)Il2CppClass::FromTypeDefinitionIndex(BGCcCursorChangeLinear_PointReachedArgs_TypeDefinitionIndex)->GetStaticField(0x53F70);
		}
