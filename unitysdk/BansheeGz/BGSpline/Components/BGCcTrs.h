...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_FILLINTERPOLATIONINFO_OFFSET UNITYSDK_OFFSET(0x1BFEB100)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1BFEA920)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GETCURRENTSESSIONMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x1BFEC290)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GETPREDICTSTEPDISTANCEDELTA_OFFSET UNITYSDK_OFFSET(0x1BFEA960)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_CURSORCHANGEMODE_OFFSET UNITYSDK_OFFSET(0x1BFE9C90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1BFE9A20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x1BFE9F80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_MOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFE9DE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x1BFE9D50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1BFE9E70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_OVERFLOWCONTROL_OFFSET UNITYSDK_OFFSET(0x1BFE9C30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ROTATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFE9E10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x1BFE9FE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1BFE9F20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x1BFEA040)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SCALEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFE9E40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x1BFE9FB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SPEEDFIELD_OFFSET UNITYSDK_OFFSET(0x1BFE9CF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SPEEDISREVERSED_OFFSET UNITYSDK_OFFSET(0x1BFE9A00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1BFE9CD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_UPVECTOR_OFFSET UNITYSDK_OFFSET(0x1BFE9EC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_USEFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1BFE9DB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_LERPBOOLEN_OFFSET UNITYSDK_OFFSET(0x1BFEC060)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_LERPQUATERNION_OFFSET UNITYSDK_OFFSET(0x1BFEBB20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_LERPVECTOR3_OFFSET UNITYSDK_OFFSET(0x1BFEBDC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1BFEA950)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1BFEC400)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SETMANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1BFEA940)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_CURSORCHANGEMODE_OFFSET UNITYSDK_OFFSET(0x1BFE9CA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x1BFE9F90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_MOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFE9DF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x1BFE9D60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1BFE9E90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_OVERFLOWCONTROL_OFFSET UNITYSDK_OFFSET(0x1BFE9C40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_ROTATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFE9E20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x1BFE9FF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1BFE9F30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x1BFEA050)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SCALEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFE9E50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x1BFE9FC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SPEEDFIELD_OFFSET UNITYSDK_OFFSET(0x1BFE9D00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SPEEDISREVERSED_OFFSET UNITYSDK_OFFSET(0x1BFE9A10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1BFE9CE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_UPVECTOR_OFFSET UNITYSDK_OFFSET(0x1BFE9ED0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_USEFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1BFE9DC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_STEP_OFFSET UNITYSDK_OFFSET(0x1BFEA0C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_TRS_OFFSET UNITYSDK_OFFSET(0x1BFEB4E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BFEA0A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFEC440)
