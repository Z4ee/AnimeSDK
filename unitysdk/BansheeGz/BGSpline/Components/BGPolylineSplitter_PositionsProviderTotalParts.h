...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_BUILD_OFFSET UNITYSDK_OFFSET(0x1BFEF380)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_COMPLY_OFFSET UNITYSDK_OFFSET(0x1BFEF370)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x1BFF0230)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_INIT_OFFSET UNITYSDK_OFFSET(0x1BFED730)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFED720)
