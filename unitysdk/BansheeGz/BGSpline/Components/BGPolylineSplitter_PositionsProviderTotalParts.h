...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_BUILD_OFFSET UNITYSDK_OFFSET(0x168F0270)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_COMPLY_OFFSET UNITYSDK_OFFSET(0x168F0260)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x168F1120)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_INIT_OFFSET UNITYSDK_OFFSET(0x168EE620)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0x168EE610)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGPolylineSplitter_PositionsProviderTotalParts_TypeDefinitionIndex = 34519;
	...
	{
	public:
		::System::Int32 partsPerSectionFloor; // 0x28
		::System::Int32 reminderForCurved; // 0x2C
		::System::Int32 parts; // 0x30
