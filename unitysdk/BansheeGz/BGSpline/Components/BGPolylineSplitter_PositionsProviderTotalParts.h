...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_BUILD_OFFSET UNITYSDK_OFFSET(0x165702A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_COMPLY_OFFSET UNITYSDK_OFFSET(0x16570290)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x16570CA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_INIT_OFFSET UNITYSDK_OFFSET(0x1656EC30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1656EC20)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGPolylineSplitter_PositionsProviderTotalParts_TypeDefinitionIndex = 28242;
