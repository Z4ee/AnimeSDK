...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_POLYLINEPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3939FF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_POLYLINEPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3939FB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_POLYLINEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x3939F70)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcSplitterPolyline_PolylinePoint_TypeDefinitionIndex = 34501;
