...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_POLYLINEPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B73CA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_POLYLINEPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B73C60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_POLYLINEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x3B73C20)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcSplitterPolyline_PolylinePoint_TypeDefinitionIndex = 35362;
