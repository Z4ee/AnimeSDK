...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION_COMPLY_OFFSET UNITYSDK_OFFSET(0x183A12E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x183A12F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0x1839F700)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1839F6F0)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGPolylineSplitter_PositionsProviderPartsPerSection_TypeDefinitionIndex = 35381;
