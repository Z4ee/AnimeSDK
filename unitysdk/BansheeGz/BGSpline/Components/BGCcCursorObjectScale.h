...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_ADD_OBJECTSCALED_OFFSET UNITYSDK_OFFSET(0x17B8C020)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x17B8C1A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_GET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x17B8C0E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_REMOVE_OBJECTSCALED_OFFSET UNITYSDK_OFFSET(0x17B8C080)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_SET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x17B8C0F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B8C260)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B8C890)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE__GET_ERROR_B__8_0_OFFSET UNITYSDK_OFFSET(0x17B8C8A0)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcCursorObjectScale_TypeDefinitionIndex = 33839;
