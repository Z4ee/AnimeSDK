...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_ADD_OBJECTSCALED_OFFSET UNITYSDK_OFFSET(0x168DEE60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x168DEF80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_GET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x168DEF20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_REMOVE_OBJECTSCALED_OFFSET UNITYSDK_OFFSET(0x168DEEC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_SET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x168DEF30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0x168DF020)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x168DF750)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE__GET_ERROR_B__8_0_OFFSET UNITYSDK_OFFSET(0x168DF760)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcCursorObjectScale_TypeDefinitionIndex = 34492;
