...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADDFIRSTPOINTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1839FFF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADDLASTPOINTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x183A0080)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADD_1_OFFSET UNITYSDK_OFFSET(0x183A02E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADD_OFFSET UNITYSDK_OFFSET(0x183A0550)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1839F830)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_FILLIN_OFFSET UNITYSDK_OFFSET(0x183A07B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_GET_DISTANCEMAX_OFFSET UNITYSDK_OFFSET(0x1839F820)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_GET_DISTANCEMIN_OFFSET UNITYSDK_OFFSET(0x1839F810)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_INIT_OFFSET UNITYSDK_OFFSET(0x1839F730)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_SET_DISTANCEMAX_OFFSET UNITYSDK_OFFSET(0x1839F800)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_SET_DISTANCEMIN_OFFSET UNITYSDK_OFFSET(0x1839F7F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x183A0E70)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		::System::Boolean calculatingTangents; // 0x19
		::System::Boolean LastPointAdded; // 0x1A
		::System::Boolean DistanceMinConstrained; // 0x1B
