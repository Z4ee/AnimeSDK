...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPPU_GET_X_OFFSET UNITYSDK_OFFSET(0x19050)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPPU_GET_Y_OFFSET UNITYSDK_OFFSET(0x784260)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPPU_SET_X_OFFSET UNITYSDK_OFFSET(0x18EB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPPU_SET_Y_OFFSET UNITYSDK_OFFSET(0xB596A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPPU__CTOR_OFFSET UNITYSDK_OFFSET(0x6B4C20)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGPpu_TypeDefinitionIndex = 35383;
