...
#define CLASS_3_374B4A87C3BAEF86_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105C7240)
#define CLASS_3_374B4A87C3BAEF86__CTOR_OFFSET UNITYSDK_OFFSET(0x105C7210)

inline static constexpr unsigned int Class_3_374B4A87C3BAEF86_TypeDefinitionIndex = 42665;
