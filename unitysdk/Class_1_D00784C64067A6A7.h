...
#define CLASS_1_D00784C64067A6A7_METHOD_1_2B85C1969225764F_OFFSET UNITYSDK_OFFSET(0x18377BA0)
#define CLASS_1_D00784C64067A6A7_METHOD_1_2C2C08A7E3721C7A_OFFSET UNITYSDK_OFFSET(0x18376C80)
#define CLASS_1_D00784C64067A6A7_METHOD_1_3E617B145B43F036_OFFSET UNITYSDK_OFFSET(0x18377140)
#define CLASS_1_D00784C64067A6A7_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x18377F30)
#define CLASS_1_D00784C64067A6A7_METHOD_1_5B944DF9FC8FD32D_OFFSET UNITYSDK_OFFSET(0x18376BF0)
#define CLASS_1_D00784C64067A6A7_METHOD_1_8F490265D0A1B8F6_OFFSET UNITYSDK_OFFSET(0x18378020)
#define CLASS_1_D00784C64067A6A7_METHOD_1_EFDDE755A4CD13DC_OFFSET UNITYSDK_OFFSET(0x18377920)
#define CLASS_1_D00784C64067A6A7_METHOD_1_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x183781B0)
#define CLASS_1_D00784C64067A6A7__CTOR_OFFSET UNITYSDK_OFFSET(0x183767B0)
...
{
public:
	::RPG::Client::FallingObjectTemplate* OBPFHANLBIG; // 0x10
	::UnityEngine::GameObject* PLAJENPLCNM; // 0x18
	::System::Collections::Generic::List_1<::Class_1_929E979D9ED7139E*>* BHJBFKOHLII; // 0x20
	::RPG::Client::StageLiteInstanceItemRendererMonoPlugin* EFJIMACIJAP; // 0x28
	::System::Single FPDLMIIEGEB; // 0x30
	::UnityEngine::Vector3 GCJMFBKLGHI; // 0x34
	::UnityEngine::Vector3 FLNOBMJMDNG; // 0x40
	::UnityEngine::Vector3 BBFOLEOPPPL; // 0x4C
	::UnityEngine::Vector3 IEELGIPAPFK; // 0x58
