...
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_01746650EFB5C402_OFFSET UNITYSDK_OFFSET(0x1408C750)
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_0F26F6C53D5E7BC4_OFFSET UNITYSDK_OFFSET(0x1408C690)
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x1408C470)
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_9345D465C2ECE776_OFFSET UNITYSDK_OFFSET(0x1408C0A0)
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_970F83AA36AAD910_OFFSET UNITYSDK_OFFSET(0x1408C630)
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_EC349FF01F2F8C82_OFFSET UNITYSDK_OFFSET(0x1408C6F0)
#define CLASS_1_B5199E29CF4E68F9_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x1408C150)
#define CLASS_1_B5199E29CF4E68F9__CTOR_OFFSET UNITYSDK_OFFSET(0x1408BE60)

inline static constexpr unsigned int Class_1_B5199E29CF4E68F9_TypeDefinitionIndex = 61843;

class Class_1_B5199E29CF4E68F9 : public ::System::Object
{
public:
	::System::Collections::Generic::HashSet_1<::MoleMole::HollowChessboard::HollowCell>* Field_1_7; // 0x10
	::Class_1_889CA1053E4BF344* Field_1_2; // 0x18
	::System::Collections::Generic::HashSet_1<::MoleMole::HollowChessboard::HollowCell>* Field_1_5; // 0x20
	::Class_1_165FBB84936002B9* Field_1_1; // 0x28
	::Class_1_0D2F62EE0080B2A1* Field_1_10; // 0x30
	::Class_1_3F98947A20FC799A* Field_1_6; // 0x38
	::Class_1_849BDF188AEF4F8D* Field_1_0; // 0x40
	::System::Collections::Generic::HashSet_1<::MoleMole::HollowChessboard::HollowCell>* Field_1_4; // 0x48
