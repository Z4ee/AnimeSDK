...
#define REPLAYCHECKPOINTELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C92A4D0)
#define REPLAYCHECKPOINTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C92A6C0)
#define REPLAYCHECKPOINTELEMENT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C92A700)

inline static constexpr unsigned int ReplayCheckpointElement_TypeDefinitionIndex = 34508;
