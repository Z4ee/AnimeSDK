...
#define REPLAYCHECKPOINTELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A641670)
#define REPLAYCHECKPOINTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A622220)
#define REPLAYCHECKPOINTELEMENT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A641820)

inline static constexpr unsigned int ReplayCheckpointElement_TypeDefinitionIndex = 32943;
