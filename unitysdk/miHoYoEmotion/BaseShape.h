...
#define MIHOYOEMOTION_BASESHAPE_GETELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1D0259D0)
#define MIHOYOEMOTION_BASESHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D025A60)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseShape_TypeDefinitionIndex = 39981;
