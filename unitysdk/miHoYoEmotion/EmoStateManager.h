...
#define MIHOYOEMOTION_EMOSTATEMANAGER_CALLSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x1978D2F0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x1978D5F0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x1978D040)
#define MIHOYOEMOTION_EMOSTATEMANAGER_INSTATE_OFFSET UNITYSDK_OFFSET(0x1978D1F0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x1978D3F0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1978CF50)
#define MIHOYOEMOTION_EMOSTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1978C370)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoStateManager_TypeDefinitionIndex = 37727;

	class EmoStateManager : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::miHoYoEmotion::EmoTrack_EmoVoidHandler*>* _stateClearHandlerDic; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>* _stateDic; // 0x18
