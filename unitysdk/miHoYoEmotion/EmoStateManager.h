...
#define MIHOYOEMOTION_EMOSTATEMANAGER_CALLSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x1BAF9900)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x1BAF9BF0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x1BAF9650)
#define MIHOYOEMOTION_EMOSTATEMANAGER_INSTATE_OFFSET UNITYSDK_OFFSET(0x1BAF9800)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x1BAF9A00)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1BAF9560)
#define MIHOYOEMOTION_EMOSTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF8A00)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoStateManager_TypeDefinitionIndex = 39392;
