...
#define MIHOYOEMOTION_BONESHAPE_SETNEUTRAL_OFFSET UNITYSDK_OFFSET(0x1BAE2F50)
#define MIHOYOEMOTION_BONESHAPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BAE32A0)
#define MIHOYOEMOTION_BONESHAPE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BAE3340)
#define MIHOYOEMOTION_BONESHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE3240)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BoneShape_TypeDefinitionIndex = 39379;
