...
#define MIHOYOEMOTION_FRAMEEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x1BB04370)
#define MIHOYOEMOTION_FRAMEEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB04650)
#define MIHOYOEMOTION_FRAMEEMOANIMATION___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x1BB046D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoAnimation_TypeDefinitionIndex = 39375;
