...
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D04EB30)
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1D04EB20)
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D04EB90)
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04EC30)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int PhonemeShapeListWrapper_TypeDefinitionIndex = 40017;
