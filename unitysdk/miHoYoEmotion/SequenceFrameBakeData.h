...
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_GET_EMOTIONBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FE80)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_GET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FDC0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_SET_EMOTIONBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FE90)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_SET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FDD0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1979FF40)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA___BASE_SET_EMOTIONBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FFA0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA___BASE_SET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FFB0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceFrameBakeData_TypeDefinitionIndex = 37757;
