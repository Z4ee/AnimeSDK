...
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA_GET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FBE0)
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA_SET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FBF0)
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1979FCA0)
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA___BASE_SET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x1979FD00)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceClipBakeData_TypeDefinitionIndex = 37754;
