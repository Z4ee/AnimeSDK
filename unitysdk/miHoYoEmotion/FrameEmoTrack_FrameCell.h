...
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_ADDELEMENT_OFFSET UNITYSDK_OFFSET(0x92F020)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x92EEF0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_APPLY_OFFSET UNITYSDK_OFFSET(0x92F040)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_CLEARCELL_OFFSET UNITYSDK_OFFSET(0x92EFD0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GETELEMENTCELL_OFFSET UNITYSDK_OFFSET(0x92EFB0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GETINDEX_OFFSET UNITYSDK_OFFSET(0x92EF00)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GET_ELEMENTCELLS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GET_ELEMENTCNT_OFFSET UNITYSDK_OFFSET(0x92EF10)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_SETELEMENTCELL_OFFSET UNITYSDK_OFFSET(0x92EFE0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x92F030)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoTrack_FrameCell_TypeDefinitionIndex = 39334;
