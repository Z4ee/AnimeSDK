...
#define MIHOYOEMOTION_FREEEMOTIONMARKER_ADDORSETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1D04C0F0)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_CREATENOTFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1D04BF60)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_CREATE_OFFSET UNITYSDK_OFFSET(0x1D04BE40)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1D04C050)
#define MIHOYOEMOTION_FREEEMOTIONMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D041810)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FreeEmotionMarker_TypeDefinitionIndex = 40029;
