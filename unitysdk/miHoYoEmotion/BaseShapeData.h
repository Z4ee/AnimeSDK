...
#define MIHOYOEMOTION_BASESHAPEDATA_ADDSHAPEELEMENT_OFFSET UNITYSDK_OFFSET(0x1BAE2770)
#define MIHOYOEMOTION_BASESHAPEDATA_INITELEMENTDIC_OFFSET UNITYSDK_OFFSET(0x1BAE26A0)
#define MIHOYOEMOTION_BASESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1BAE2840)
#define MIHOYOEMOTION_BASESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE28F0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseShapeData_TypeDefinitionIndex = 39368;
