...
#define MIHOYOEMOTION_BASESHAPEDATA_ADDSHAPEELEMENT_OFFSET UNITYSDK_OFFSET(0x19776880)
#define MIHOYOEMOTION_BASESHAPEDATA_INITELEMENTDIC_OFFSET UNITYSDK_OFFSET(0x197767B0)
#define MIHOYOEMOTION_BASESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x19776950)
#define MIHOYOEMOTION_BASESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19776A00)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseShapeData_TypeDefinitionIndex = 37730;
