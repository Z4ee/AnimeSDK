...
#define MIHOYOEMOTION_BASEEMOANIMATION_ADDTRACK_OFFSET UNITYSDK_OFFSET(0x19774E40)
#define MIHOYOEMOTION_BASEEMOANIMATION_APPENDSHAPE_OFFSET UNITYSDK_OFFSET(0x19775A60)
#define MIHOYOEMOTION_BASEEMOANIMATION_APPLY_OFFSET UNITYSDK_OFFSET(0x197751B0)
#define MIHOYOEMOTION_BASEEMOANIMATION_CALLALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x19775760)
#define MIHOYOEMOTION_BASEEMOANIMATION_CALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x197756F0)
#define MIHOYOEMOTION_BASEEMOANIMATION_CLEARSHAPEONLY_OFFSET UNITYSDK_OFFSET(0x19775B60)
#define MIHOYOEMOTION_BASEEMOANIMATION_CLEARSHAPE_OFFSET UNITYSDK_OFFSET(0x19775AF0)
#define MIHOYOEMOTION_BASEEMOANIMATION_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x19775940)
#define MIHOYOEMOTION_BASEEMOANIMATION_GETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x197757F0)
#define MIHOYOEMOTION_BASEEMOANIMATION_GETTRACK_OFFSET UNITYSDK_OFFSET(0x19774F50)
#define MIHOYOEMOTION_BASEEMOANIMATION_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x19774E30)
#define MIHOYOEMOTION_BASEEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x19774FF0)
#define MIHOYOEMOTION_BASEEMOANIMATION_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x19775FB0)
#define MIHOYOEMOTION_BASEEMOANIMATION_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x19776310)
#define MIHOYOEMOTION_BASEEMOANIMATION_ISTRACKPLAYING_OFFSET UNITYSDK_OFFSET(0x19775BD0)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYATTIME_OFFSET UNITYSDK_OFFSET(0x19776040)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYBAKEDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x19775C40)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYDEFAULT_OFFSET UNITYSDK_OFFSET(0x197759D0)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYTRACKATTIME_OFFSET UNITYSDK_OFFSET(0x197761E0)
#define MIHOYOEMOTION_BASEEMOANIMATION_REFRESHSTOPSHAPEVALUES_OFFSET UNITYSDK_OFFSET(0x19775300)
#define MIHOYOEMOTION_BASEEMOANIMATION_REGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x197755F0)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x197758C0)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETEMOTIONSTOPPED_OFFSET UNITYSDK_OFFSET(0x19775F10)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETFACIALKEY_OFFSET UNITYSDK_OFFSET(0x19775DB0)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETPOSEKEY_OFFSET UNITYSDK_OFFSET(0x19775D40)
#define MIHOYOEMOTION_BASEEMOANIMATION_STOPSEQUENCE_OFFSET UNITYSDK_OFFSET(0x19776280)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEEYECTRL_OFFSET UNITYSDK_OFFSET(0x19775E20)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEPAUSEBLINK_OFFSET UNITYSDK_OFFSET(0x19775EA0)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x19775CD0)
#define MIHOYOEMOTION_BASEEMOANIMATION_UNREGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x19775670)
#define MIHOYOEMOTION_BASEEMOANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x19775040)
#define MIHOYOEMOTION_BASEEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x197763A0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseEmoAnimation_TypeDefinitionIndex = 37689;
