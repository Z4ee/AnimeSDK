...
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAFE3B0)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAFE3E0)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAFCE90)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFE390)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_PhoFinishDelegate_TypeDefinitionIndex = 39397;
