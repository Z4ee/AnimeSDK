...
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D041250)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D041280)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D03FCF0)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D041230)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_PhoFinishDelegate_TypeDefinitionIndex = 40014;
