...
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D0414F0)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D041520)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D03C890)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D040A90)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoTrack_EmoVoidHandler_TypeDefinitionIndex = 39990;
