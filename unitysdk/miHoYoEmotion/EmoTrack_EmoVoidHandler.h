...
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19791B70)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19791BA0)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1978D7F0)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19791140)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoTrack_EmoVoidHandler_TypeDefinitionIndex = 37696;
