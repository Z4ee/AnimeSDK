...
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA_GET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x197A0ED0)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA_SET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x197A0EE0)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x197A0F90)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA___BASE_SET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x197A0FF0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SubSequenceClipBakeData_TypeDefinitionIndex = 37779;
