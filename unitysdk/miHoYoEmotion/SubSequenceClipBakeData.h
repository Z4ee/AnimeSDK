...
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA_GET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x1D0507B0)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA_SET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x1D0507C0)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D050870)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA___BASE_SET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x1D0508D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SubSequenceClipBakeData_TypeDefinitionIndex = 40015;
