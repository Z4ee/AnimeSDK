...
#define MIHOYOEMOTION_FRAMESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1D04AB00)
#define MIHOYOEMOTION_FRAMESHAPEDATA_UPDATETYPEELEMENT_OFFSET UNITYSDK_OFFSET(0x1D04AC00)
#define MIHOYOEMOTION_FRAMESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04ACA0)
#define MIHOYOEMOTION_FRAMESHAPEDATA___BASE_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1D04AD10)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameShapeData_TypeDefinitionIndex = 39987;
