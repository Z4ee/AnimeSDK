...
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x19798000)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x19797CD0)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19797B70)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x19798D00)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x19799700)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoBlinkTrack_TypeDefinitionIndex = 37700;
