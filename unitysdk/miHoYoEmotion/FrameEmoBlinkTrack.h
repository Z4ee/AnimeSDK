...
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x1BB04A80)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x1BB04770)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB04600)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x1BB05780)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x1BB06180)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoBlinkTrack_TypeDefinitionIndex = 39372;
