...
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x1D033DA0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1D03AE10)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GET_INDEXRES2INDEXRUNTIMEDIC_OFFSET UNITYSDK_OFFSET(0x1D03ACF0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_PUTCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x1D03AB10)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_UPDATERUNTIMEINDEX_OFFSET UNITYSDK_OFFSET(0x1D03A2A0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D03AEB0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeManager_CurveBindingGrp_TypeDefinitionIndex = 40048;
