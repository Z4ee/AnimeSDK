...
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x1BAF0CC0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1BAF8410)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GET_INDEXRES2INDEXRUNTIMEDIC_OFFSET UNITYSDK_OFFSET(0x1BAF82F0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_PUTCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x1BAF8110)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_UPDATERUNTIMEINDEX_OFFSET UNITYSDK_OFFSET(0x1BAF7870)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF84B0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeManager_CurveBindingGrp_TypeDefinitionIndex = 39355;
