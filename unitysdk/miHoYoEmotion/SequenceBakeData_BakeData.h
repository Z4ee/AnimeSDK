...
#define MIHOYOEMOTION_SEQUENCEBAKEDATA_BAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFEBDD0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceBakeData_BakeData_TypeDefinitionIndex = 44828;
