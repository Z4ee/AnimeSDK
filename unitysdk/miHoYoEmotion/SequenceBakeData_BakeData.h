...
#define MIHOYOEMOTION_SEQUENCEBAKEDATA_BAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19282F70)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceBakeData_BakeData_TypeDefinitionIndex = 42646;
