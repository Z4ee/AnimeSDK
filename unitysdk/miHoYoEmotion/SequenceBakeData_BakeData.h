...
#define MIHOYOEMOTION_SEQUENCEBAKEDATA_BAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8E53230)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceBakeData_BakeData_TypeDefinitionIndex = 40967;
