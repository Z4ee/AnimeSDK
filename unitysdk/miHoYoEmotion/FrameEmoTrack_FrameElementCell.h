...
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_ADDFRAME_OFFSET UNITYSDK_OFFSET(0x8847C0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_APPLY_OFFSET UNITYSDK_OFFSET(0x8848C0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_CLEARFRAME_OFFSET UNITYSDK_OFFSET(0x8846E0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x8847D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoTrack_FrameElementCell_TypeDefinitionIndex = 37698;
