...
#define MIHOYOEMOTION_BLENDSHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x980020)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BlendShapeData_TypeDefinitionIndex = 40001;
