...
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x980960)
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x9808E0)
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x980920)
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x9808D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeKey_MouseShapeAnimationJob_TypeDefinitionIndex = 40075;
