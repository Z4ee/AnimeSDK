...
#define MIHOYOEMOTION_CLIPSHAPEELEMENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x19785B30)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x19785BA0)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19785C10)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT___BASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x19785C30)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT___BASE_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x19785C50)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeElement_TypeDefinitionIndex = 37766;
