...
#define MIHOYOEMOTION_CLIPSHAPEELEMENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1BAF1AE0)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x1BAF1B50)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF1BC0)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT___BASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1BAF1BE0)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT___BASE_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x1BAF1C00)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeElement_TypeDefinitionIndex = 39373;
