...
#define MIHOYOEMOTION_EYECTRLMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19282AF0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrlMarker_TypeDefinitionIndex = 42644;
