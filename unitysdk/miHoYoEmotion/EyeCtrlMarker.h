...
#define MIHOYOEMOTION_EYECTRLMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFEB950)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrlMarker_TypeDefinitionIndex = 44826;
