...
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_APPLY_OFFSET UNITYSDK_OFFSET(0x1BB06FA0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_GETBINDINGBYKEY_OFFSET UNITYSDK_OFFSET(0x1BB07020)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_RESETFRAME_OFFSET UNITYSDK_OFFSET(0x1BB067C0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_UPDATEFRAME_OFFSET UNITYSDK_OFFSET(0x1BB06D30)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0CC10)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceFrameBakeData_FrameBinding_TypeDefinitionIndex = 39325;
