...
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_APPLY_OFFSET UNITYSDK_OFFSET(0x1979A540)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_GETBINDINGBYKEY_OFFSET UNITYSDK_OFFSET(0x1979A5C0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_RESETFRAME_OFFSET UNITYSDK_OFFSET(0x19799D60)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_UPDATEFRAME_OFFSET UNITYSDK_OFFSET(0x1979A2D0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1979FFD0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceFrameBakeData_FrameBinding_TypeDefinitionIndex = 37760;
