...
#define MIHOYOEMOTION_SHAPE_HASBONE_OFFSET UNITYSDK_OFFSET(0x861FB60)
#define MIHOYOEMOTION_SHAPE_INDEXOFBONE_OFFSET UNITYSDK_OFFSET(0x861FC40)
#define MIHOYOEMOTION_SHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x861F860)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int Shape_TypeDefinitionIndex = 35143;
