...
#define MIHOYOEMOTION_EMOTIONGROUPEDPHONEMES__CTOR_OFFSET UNITYSDK_OFFSET(0x19791BB0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmotionGroupedPhonemes_TypeDefinitionIndex = 37751;
