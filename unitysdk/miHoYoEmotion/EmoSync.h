...
#define MIHOYOEMOTION_EMOSYNC_ADD_ONPHOFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x1978DAB0)
#define MIHOYOEMOTION_EMOSYNC_CLEAREMOTION_OFFSET UNITYSDK_OFFSET(0x197901D0)
#define MIHOYOEMOTION_EMOSYNC_CLEARSEQUENCE_OFFSET UNITYSDK_OFFSET(0x19790140)
#define MIHOYOEMOTION_EMOSYNC_EMOFINISH_OFFSET UNITYSDK_OFFSET(0x197902A0)
#define MIHOYOEMOTION_EMOSYNC_ENDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x1978FDE0)
#define MIHOYOEMOTION_EMOSYNC_GETEMOTION_OFFSET UNITYSDK_OFFSET(0x1978E130)
#define MIHOYOEMOTION_EMOSYNC_GETPHONEME_OFFSET UNITYSDK_OFFSET(0x1978E040)
#define MIHOYOEMOTION_EMOSYNC_GET_SETDATA_OFFSET UNITYSDK_OFFSET(0x1978DA90)
#define MIHOYOEMOTION_EMOSYNC_INTERRUPTSEQUENCE_OFFSET UNITYSDK_OFFSET(0x1978FEC0)
#define MIHOYOEMOTION_EMOSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x197912D0)
#define MIHOYOEMOTION_EMOSYNC_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x19791250)
#define MIHOYOEMOTION_EMOSYNC_PERFORMCACHE_OFFSET UNITYSDK_OFFSET(0x197908D0)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISH_OFFSET UNITYSDK_OFFSET(0x19790330)
#define MIHOYOEMOTION_EMOSYNC_PLAYATTIME_OFFSET UNITYSDK_OFFSET(0x1978FC10)
#define MIHOYOEMOTION_EMOSYNC_PLAYSEQUENCE_OFFSET UNITYSDK_OFFSET(0x1978F600)
#define MIHOYOEMOTION_EMOSYNC_REMOVE_ONPHOFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x1978DB30)
#define MIHOYOEMOTION_EMOSYNC_RESETEMOTION_OFFSET UNITYSDK_OFFSET(0x1978EF20)
#define MIHOYOEMOTION_EMOSYNC_RESETPHONEME_OFFSET UNITYSDK_OFFSET(0x1978E220)
#define MIHOYOEMOTION_EMOSYNC_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x1978FFA0)
#define MIHOYOEMOTION_EMOSYNC_SETDEFAULTEMOTION_OFFSET UNITYSDK_OFFSET(0x19791150)
#define MIHOYOEMOTION_EMOSYNC_SETDEFAULTPHONEME_OFFSET UNITYSDK_OFFSET(0x197911E0)
#define MIHOYOEMOTION_EMOSYNC_SETEMOTION_OFFSET UNITYSDK_OFFSET(0x1978F070)
#define MIHOYOEMOTION_EMOSYNC_SETPHONEMEANDEMOTION_OFFSET UNITYSDK_OFFSET(0x1978E7A0)
#define MIHOYOEMOTION_EMOSYNC_SETPHONEME_OFFSET UNITYSDK_OFFSET(0x1978E370)
#define MIHOYOEMOTION_EMOSYNC_SETPOSEFACIALKEY_OFFSET UNITYSDK_OFFSET(0x1978F400)
#define MIHOYOEMOTION_EMOSYNC_SET_SETDATA_OFFSET UNITYSDK_OFFSET(0x1978DAA0)
#define MIHOYOEMOTION_EMOSYNC_START_OFFSET UNITYSDK_OFFSET(0x19790C60)
#define MIHOYOEMOTION_EMOSYNC_TOGGLE_OFFSET UNITYSDK_OFFSET(0x1978FB30)
#define MIHOYOEMOTION_EMOSYNC_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x1978DFF0)
#define MIHOYOEMOTION_EMOSYNC_UPDATEEMOTIONCACHE_OFFSET UNITYSDK_OFFSET(0x1978DDD0)
#define MIHOYOEMOTION_EMOSYNC_UPDATEPHONEMECACHE_OFFSET UNITYSDK_OFFSET(0x1978DBB0)
#define MIHOYOEMOTION_EMOSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19791470)
#define MIHOYOEMOTION_EMOSYNC___BASE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x197916C0)
#define MIHOYOEMOTION_EMOSYNC___BASE_START_OFFSET UNITYSDK_OFFSET(0x19791750)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_TypeDefinitionIndex = 37713;
