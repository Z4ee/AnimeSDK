...
#define MIHOYOEMOTION_EMOTIONMARKER_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1BAFE750)
#define MIHOYOEMOTION_EMOTIONMARKER_ISFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1BAFE6D0)
#define MIHOYOEMOTION_EMOTIONMARKER_SETTOOTHERMARKER_OFFSET UNITYSDK_OFFSET(0x1BAFEA20)
#define MIHOYOEMOTION_EMOTIONMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFEA10)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmotionMarker_TypeDefinitionIndex = 39347;
