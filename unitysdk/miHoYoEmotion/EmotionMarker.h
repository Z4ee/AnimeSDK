...
#define MIHOYOEMOTION_EMOTIONMARKER_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1D0415F0)
#define MIHOYOEMOTION_EMOTIONMARKER_ISFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1D041570)
#define MIHOYOEMOTION_EMOTIONMARKER_SETTOOTHERMARKER_OFFSET UNITYSDK_OFFSET(0x1D0418C0)
#define MIHOYOEMOTION_EMOTIONMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0418B0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmotionMarker_TypeDefinitionIndex = 40052;
