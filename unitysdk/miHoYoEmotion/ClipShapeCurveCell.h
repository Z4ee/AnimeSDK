...
#define MIHOYOEMOTION_CLIPSHAPECURVECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0344D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeCurveCell_TypeDefinitionIndex = 40067;
