...
#define MIHOYOEMOTION_RDPHONEMEMARKER_CLONETOFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1D04F270)
#define MIHOYOEMOTION_RDPHONEMEMARKER_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1D04ED30)
#define MIHOYOEMOTION_RDPHONEMEMARKER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1D04F470)
#define MIHOYOEMOTION_RDPHONEMEMARKER_ISFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1D04ECB0)
#define MIHOYOEMOTION_RDPHONEMEMARKER_SETTOOTHERMARKER_OFFSET UNITYSDK_OFFSET(0x1D04C4E0)
#define MIHOYOEMOTION_RDPHONEMEMARKER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D04C3C0)
#define MIHOYOEMOTION_RDPHONEMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04C4D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int RDPhonemeMarker_TypeDefinitionIndex = 40038;
