...
#define MIHOYOEMOTION_FRAMESHAPEELEMENT_GET_BLINKDURATION_OFFSET UNITYSDK_OFFSET(0x1BB08050)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1BB07F70)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x1BB07FE0)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB080C0)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT___BASE_GET_BLINKDURATION_OFFSET UNITYSDK_OFFSET(0x1BB08110)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT___BASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1BB08130)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT___BASE_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x1BB08140)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameShapeElement_TypeDefinitionIndex = 39343;
