...
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_ADDORSETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1979CCC0)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_CREATENOTFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1979CA90)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1979CC00)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1979C8E0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FreeRDPhonemeMarker_TypeDefinitionIndex = 37745;
