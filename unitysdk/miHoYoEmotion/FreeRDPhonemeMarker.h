...
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_ADDORSETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1BB09670)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_CREATENOTFREEMARKER_OFFSET UNITYSDK_OFFSET(0x1BB09440)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1BB095B0)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB09290)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FreeRDPhonemeMarker_TypeDefinitionIndex = 39339;
