...
#define MIHOYOEMOTION_CLIPEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x1D026720)
#define MIHOYOEMOTION_CLIPEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D026C10)
#define MIHOYOEMOTION_CLIPEMOANIMATION___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x1D026C90)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipEmoAnimation_TypeDefinitionIndex = 40006;
