...
#define MIHOYOEMOTION_CLIPSHAPE_GETELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19785270)
#define MIHOYOEMOTION_CLIPSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19785300)
#define MIHOYOEMOTION_CLIPSHAPE___BASE_GETELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19785380)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShape_TypeDefinitionIndex = 37765;
