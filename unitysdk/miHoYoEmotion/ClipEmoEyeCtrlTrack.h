...
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK_ADDEYECTRLLIST_OFFSET UNITYSDK_OFFSET(0x1BAE3CE0)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK_APPLY_OFFSET UNITYSDK_OFFSET(0x1BAE42D0)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK_INIT_OFFSET UNITYSDK_OFFSET(0x1BAE3990)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BAE3F20)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BAE4740)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE4550)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK___BASE_APPLY_OFFSET UNITYSDK_OFFSET(0x1BAE4780)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x1BAE4850)
#define MIHOYOEMOTION_CLIPEMOEYECTRLTRACK___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BAE48F0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipEmoEyeCtrlTrack_TypeDefinitionIndex = 39398;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ClipEmoEyeCtrlTrack_TypeDefinitionIndex)->GetStaticField(0x98B0);
		}
		::miHoYoEmotion::ClipShapeManager* _clipManager; // 0x58
		::miHoYoEmotion::EyeKey* _eyeKey; // 0x60
		::miHoYoEmotion::SequenceClipBakeData_EyeCtrlData* _lastData; // 0x68
		::UnityEngine::GameObject* _eyeStar; // 0x70
		::miHoYoEmotion::SequenceClipBakeData_EyeCtrlData* _currData; // 0x78
		::System::Collections::Generic::List_1<::miHoYoEmotion::SequenceClipBakeData_EyeCtrlData*>* _currList; // 0x80
