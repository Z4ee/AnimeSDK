...
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_AREPOINTSCOLINEAR_OFFSET UNITYSDK_OFFSET(0x1D023AE0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_CHECKTANGENTCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x1D023CB0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1D0240C0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTIONWITHCOLINEARITY_OFFSET UNITYSDK_OFFSET(0x1D0236B0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTION_OFFSET UNITYSDK_OFFSET(0x1D023E20)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int AnimationCurveExtension_TypeDefinitionIndex = 40066;
