...
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_AREPOINTSCOLINEAR_OFFSET UNITYSDK_OFFSET(0x197745B0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_CHECKTANGENTCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x197749A0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_GETDURATION_OFFSET UNITYSDK_OFFSET(0x19774DA0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTIONWITHCOLINEARITY_OFFSET UNITYSDK_OFFSET(0x19774180)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTION_OFFSET UNITYSDK_OFFSET(0x19774B10)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int AnimationCurveExtension_TypeDefinitionIndex = 37729;
