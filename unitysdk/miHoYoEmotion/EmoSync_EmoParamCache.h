...
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BAFCC80)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1BAFE2B0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1BAFE2D0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETEMOTIONCACHE_OFFSET UNITYSDK_OFFSET(0x1BAFB470)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETPHONEMECACHE_OFFSET UNITYSDK_OFFSET(0x1BAFACF0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETSEQDATACACHE_OFFSET UNITYSDK_OFFSET(0x1BAFE310)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1BAFE2C0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFDBF0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_EmoParamCache_TypeDefinitionIndex = 39396;

	class EmoSync_EmoParamCache : public ::System::Object
	{
	public:
		::System::String* emotionName; // 0x10
		::miHoYoEmotion::SequenceBakeData* seqData; // 0x18
		::System::String* phonemeName; // 0x20
