...
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_1_OFFSET UNITYSDK_OFFSET(0x1BB01010)
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_OFFSET UNITYSDK_OFFSET(0x1BB01230)
#define MIHOYOEMOTION_EYECTRL_BLINKFINISH_OFFSET UNITYSDK_OFFSET(0x1BB00750)
#define MIHOYOEMOTION_EYECTRL_BLINK_OFFSET UNITYSDK_OFFSET(0x1BB00440)
#define MIHOYOEMOTION_EYECTRL_CHECKMINANGLE_OFFSET UNITYSDK_OFFSET(0x1BB01450)
#define MIHOYOEMOTION_EYECTRL_CLEARLOOKAT_OFFSET UNITYSDK_OFFSET(0x1BB00880)
#define MIHOYOEMOTION_EYECTRL_FORCEUPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x1BB00800)
#define MIHOYOEMOTION_EYECTRL_GET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x1BAFEB10)
#define MIHOYOEMOTION_EYECTRL_GET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x1BAFEBC0)
#define MIHOYOEMOTION_EYECTRL_INITEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x1BAFF260)
#define MIHOYOEMOTION_EYECTRL_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x1BB006A0)
#define MIHOYOEMOTION_EYECTRL_LATETICK_OFFSET UNITYSDK_OFFSET(0x1BAFF830)
#define MIHOYOEMOTION_EYECTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BAFF720)
#define MIHOYOEMOTION_EYECTRL_SET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x1BAFEB20)
#define MIHOYOEMOTION_EYECTRL_SET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x1BAFEBD0)
#define MIHOYOEMOTION_EYECTRL_START_OFFSET UNITYSDK_OFFSET(0x1BAFEC70)
#define MIHOYOEMOTION_EYECTRL_TOGGLEBLINK_OFFSET UNITYSDK_OFFSET(0x1BB00610)
#define MIHOYOEMOTION_EYECTRL_UPDATEBLINK_OFFSET UNITYSDK_OFFSET(0x1BAFF920)
#define MIHOYOEMOTION_EYECTRL_UPDATEEYETARGET_OFFSET UNITYSDK_OFFSET(0x1BB008D0)
#define MIHOYOEMOTION_EYECTRL_UPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x1BAFFA80)
#define MIHOYOEMOTION_EYECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB016D0)
#define MIHOYOEMOTION_EYECTRL___BASE_LATETICK_OFFSET UNITYSDK_OFFSET(0x1BB01760)
#define MIHOYOEMOTION_EYECTRL___BASE_START_OFFSET UNITYSDK_OFFSET(0x1BB01800)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrl_TypeDefinitionIndex = 39404;
