...
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_1_OFFSET UNITYSDK_OFFSET(0x19794520)
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_OFFSET UNITYSDK_OFFSET(0x19794740)
#define MIHOYOEMOTION_EYECTRL_BLINKFINISH_OFFSET UNITYSDK_OFFSET(0x19793C60)
#define MIHOYOEMOTION_EYECTRL_BLINK_OFFSET UNITYSDK_OFFSET(0x19793950)
#define MIHOYOEMOTION_EYECTRL_CHECKMINANGLE_OFFSET UNITYSDK_OFFSET(0x19794960)
#define MIHOYOEMOTION_EYECTRL_CLEARLOOKAT_OFFSET UNITYSDK_OFFSET(0x19793D90)
#define MIHOYOEMOTION_EYECTRL_FORCEUPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x19793D10)
#define MIHOYOEMOTION_EYECTRL_GET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x19792030)
#define MIHOYOEMOTION_EYECTRL_GET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x197920E0)
#define MIHOYOEMOTION_EYECTRL_INITEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x19792770)
#define MIHOYOEMOTION_EYECTRL_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x19793BB0)
#define MIHOYOEMOTION_EYECTRL_LATETICK_OFFSET UNITYSDK_OFFSET(0x19792D40)
#define MIHOYOEMOTION_EYECTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19792C30)
#define MIHOYOEMOTION_EYECTRL_SET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x19792040)
#define MIHOYOEMOTION_EYECTRL_SET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x197920F0)
#define MIHOYOEMOTION_EYECTRL_START_OFFSET UNITYSDK_OFFSET(0x19792190)
#define MIHOYOEMOTION_EYECTRL_TOGGLEBLINK_OFFSET UNITYSDK_OFFSET(0x19793B20)
#define MIHOYOEMOTION_EYECTRL_UPDATEBLINK_OFFSET UNITYSDK_OFFSET(0x19792E30)
#define MIHOYOEMOTION_EYECTRL_UPDATEEYETARGET_OFFSET UNITYSDK_OFFSET(0x19793DE0)
#define MIHOYOEMOTION_EYECTRL_UPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x19792F90)
#define MIHOYOEMOTION_EYECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x19794BE0)
#define MIHOYOEMOTION_EYECTRL___BASE_LATETICK_OFFSET UNITYSDK_OFFSET(0x19794C70)
#define MIHOYOEMOTION_EYECTRL___BASE_START_OFFSET UNITYSDK_OFFSET(0x19794D10)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrl_TypeDefinitionIndex = 37716;
