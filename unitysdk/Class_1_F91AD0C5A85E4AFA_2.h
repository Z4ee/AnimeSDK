...
#define CLASS_1_F91AD0C5A85E4AFA_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DE4BE20)
#define CLASS_1_F91AD0C5A85E4AFA_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1DE4B8E0)
#define CLASS_1_F91AD0C5A85E4AFA_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DE4BB00)
#define CLASS_1_F91AD0C5A85E4AFA_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DE4B9D0)
#define CLASS_1_F91AD0C5A85E4AFA_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DE4BC00)
#define CLASS_1_F91AD0C5A85E4AFA_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DE4BF50)
#define CLASS_1_F91AD0C5A85E4AFA_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DE4BF00)
#define CLASS_1_F91AD0C5A85E4AFA_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DE4B9B0)
#define CLASS_1_F91AD0C5A85E4AFA_2_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1DE4B960)
#define CLASS_1_F91AD0C5A85E4AFA_2_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1DE4B950)
#define CLASS_1_F91AD0C5A85E4AFA_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DE4B820)
#define CLASS_1_F91AD0C5A85E4AFA_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DE4B9C0)
#define CLASS_1_F91AD0C5A85E4AFA_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DE4B880)
#define CLASS_1_F91AD0C5A85E4AFA_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DE4BCD0)
#define CLASS_1_F91AD0C5A85E4AFA_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DE4BD30)
#define CLASS_1_F91AD0C5A85E4AFA_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE4C100)
#define CLASS_1_F91AD0C5A85E4AFA_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE4B8A0)
#define CLASS_1_F91AD0C5A85E4AFA_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE4B890)

inline static constexpr unsigned int Class_1_F91AD0C5A85E4AFA_2_TypeDefinitionIndex = 24921;

class Class_1_F91AD0C5A85E4AFA_2 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_2*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F91AD0C5A85E4AFA_2_TypeDefinitionIndex)->GetStaticField(0x2DDE0);
	}
	// static const ::System::Int32 DBKOHLFBPNI = 0x1; // 0x0
	// static const ::System::Int32 ENGJNFFIMIJ = 0x2; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::String* JDOJAMHCAJD; // 0x18
	::System::UInt32 MIENDINJKKL; // 0x20
