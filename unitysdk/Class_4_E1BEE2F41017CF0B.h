...
#define CLASS_4_E1BEE2F41017CF0B_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xCA51F70)
#define CLASS_4_E1BEE2F41017CF0B_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xCA52060)
#define CLASS_4_E1BEE2F41017CF0B_METHOD_4_A0CFDB5F5B1DB2D6_OFFSET UNITYSDK_OFFSET(0xCA51B90)
#define CLASS_4_E1BEE2F41017CF0B_METHOD_4_B35E7E320C6E607B_OFFSET UNITYSDK_OFFSET(0xCA51CF0)
#define CLASS_4_E1BEE2F41017CF0B_METHOD_4_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xCA51E80)
#define CLASS_4_E1BEE2F41017CF0B_METHOD_4_D5F28AFD29B39D22_OFFSET UNITYSDK_OFFSET(0xCA51D80)
#define CLASS_4_E1BEE2F41017CF0B__CTOR_OFFSET UNITYSDK_OFFSET(0xCA52130)
#define CLASS_4_E1BEE2F41017CF0B__ONBIND_OFFSET UNITYSDK_OFFSET(0xCA51A60)

inline static constexpr unsigned int Class_4_E1BEE2F41017CF0B_TypeDefinitionIndex = 71217;

class Class_4_E1BEE2F41017CF0B : public ::Class_3_038FF51960FDFF64
{
public:
	::System::String* CHAMNLJOFII; // 0x138
	::Class_1_A767C3DCD789E4BF* EKDLLLIPKEE; // 0x140
	::UnityEngine::UI::Image* KEFCOKPMPDO; // 0x148
	::UnityEngine::UI::Image* IGPGEAPACDK; // 0x150
