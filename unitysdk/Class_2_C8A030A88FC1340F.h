...
#define CLASS_2_C8A030A88FC1340F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16190B20)
#define CLASS_2_C8A030A88FC1340F_METHOD_2_0986B6F765C6D4BF_OFFSET UNITYSDK_OFFSET(0x16190E50)
#define CLASS_2_C8A030A88FC1340F_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16190A70)
#define CLASS_2_C8A030A88FC1340F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16190850)
#define CLASS_2_C8A030A88FC1340F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16190A20)
#define CLASS_2_C8A030A88FC1340F_TICK_OFFSET UNITYSDK_OFFSET(0x16190C00)
#define CLASS_2_C8A030A88FC1340F__CTOR_OFFSET UNITYSDK_OFFSET(0x16190830)

inline static constexpr unsigned int Class_2_C8A030A88FC1340F_TypeDefinitionIndex = 55788;

class Class_2_C8A030A88FC1340F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_5F51D4049EA87B7B* Field_2_0; // 0x18
	::RPG::GameCore::QuestProgressChangeListener* Field_2_1; // 0x20
