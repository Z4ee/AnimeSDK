...
#define CLASS_1_115E551636659526_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19901410)
#define CLASS_1_115E551636659526_GET_CURRENTSESSIONRECORD_OFFSET UNITYSDK_OFFSET(0x19900A60)
#define CLASS_1_115E551636659526_GET_REWARDITEMS_OFFSET UNITYSDK_OFFSET(0x19900AD0)
#define CLASS_1_115E551636659526_GET_SHOWREWARDDETAILCOMMAND_OFFSET UNITYSDK_OFFSET(0x19900D70)
#define CLASS_1_115E551636659526_GET_STAGES_OFFSET UNITYSDK_OFFSET(0x19900540)
#define CLASS_1_115E551636659526_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0x19900910)
#define CLASS_1_115E551636659526_METHOD_1_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x19900820)
#define CLASS_1_115E551636659526_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x19900A70)
#define CLASS_1_115E551636659526_METHOD_1_1E5BC75FD81F8703_OFFSET UNITYSDK_OFFSET(0x19900610)
#define CLASS_1_115E551636659526_METHOD_1_2975D910FEF48882_OFFSET UNITYSDK_OFFSET(0x199009B0)
#define CLASS_1_115E551636659526_METHOD_1_742A114BB44F2EFA_OFFSET UNITYSDK_OFFSET(0x19900450)
#define CLASS_1_115E551636659526_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x19900550)
#define CLASS_1_115E551636659526_METHOD_1_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x19900350)
#define CLASS_1_115E551636659526_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x19900920)
#define CLASS_1_115E551636659526_METHOD_1_AD331C687D23A379_OFFSET UNITYSDK_OFFSET(0x19900D20)
#define CLASS_1_115E551636659526_METHOD_1_B213056103887067_1_OFFSET UNITYSDK_OFFSET(0x19900BA0)
#define CLASS_1_115E551636659526_METHOD_1_B213056103887067_2_OFFSET UNITYSDK_OFFSET(0x19900C60)
#define CLASS_1_115E551636659526_METHOD_1_B213056103887067_OFFSET UNITYSDK_OFFSET(0x19900AE0)
#define CLASS_1_115E551636659526_METHOD_1_B64C60973842FE45_OFFSET UNITYSDK_OFFSET(0x199004A0)
#define CLASS_1_115E551636659526_METHOD_1_BD83D9A311EA4A81_OFFSET UNITYSDK_OFFSET(0x199003A0)
#define CLASS_1_115E551636659526_METHOD_1_C073386EB70C90B2_OFFSET UNITYSDK_OFFSET(0x199005A0)
#define CLASS_1_115E551636659526__CTOR_OFFSET UNITYSDK_OFFSET(0x19900D80)
#define CLASS_1_115E551636659526__GET_CONTINUECOMMAND_B__46_0_OFFSET UNITYSDK_OFFSET(0x19901980)
#define CLASS_1_115E551636659526__GET_CONTINUECOMMAND_B__46_1_OFFSET UNITYSDK_OFFSET(0x19901C60)
#define CLASS_1_115E551636659526__GET_EXITCOMMAND_B__40_0_OFFSET UNITYSDK_OFFSET(0x19901940)
#define CLASS_1_115E551636659526__GET_RESTARTCOMMAND_B__43_0_OFFSET UNITYSDK_OFFSET(0x19901960)

inline static constexpr unsigned int Class_1_115E551636659526_TypeDefinitionIndex = 80282;

class Class_1_115E551636659526 : public ::System::Object
{
public:
	::RPG::Client::ChallengeData* HBPBNOCLCPA; // 0x10
	::Class_0_16E4307DCC419505_318* _ShowRewardDetailCommand_k__BackingField; // 0x18
	::RPG::Client::Challenge::Tierce::ChallengeTierceRecordBase* _CurrentSessionRecord_k__BackingField; // 0x20
	::Sofa::Core::SimpleCommand* LCGBLFOHNFA; // 0x28
	::Class_1_5EBDCA5E10FB9D5A* PFJGDJPMAMM; // 0x30
	::Sofa::Core::SimpleCommand* KNOPHJEEPGJ; // 0x38
	::System::Collections::Generic::IReadOnlyList_1<::Class_1_FD21020B0878C0A0*>* _RewardItems_k__BackingField; // 0x40
	::Sofa::Core::SimpleCommand* APHMKBFPPPD; // 0x48
	::Class_1_19DB14C0C5CFE108* KOADDJDNCKO; // 0x50
	::System::Collections::Generic::IReadOnlyList_1<::Class_1_37CFE50712AC363B*>* _Stages_k__BackingField; // 0x58
