...
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12975430)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12975680)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x129756E0)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12975690)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12975420)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x12975410)

inline static constexpr unsigned int CustomSkin_PhoneLogin__CountDown_d__42_TypeDefinitionIndex = 41943;
