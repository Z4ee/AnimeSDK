...
#define GAUSSIANBLURVOLUMETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x154EA880)
#define GAUSSIANBLURVOLUMETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x154EB2C0)
#define GAUSSIANBLURVOLUMETIMELINETRACK___BASE_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x154EB320)

inline static constexpr unsigned int GaussianBlurVolumeTimelineTrack_TypeDefinitionIndex = 66522;
