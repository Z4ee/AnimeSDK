...
#define CLASS_1_0AD6129525BF5F86_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CB34F0)
#define CLASS_1_0AD6129525BF5F86_GET_DATABEHAVIORTYPE_OFFSET UNITYSDK_OFFSET(0x19CB5240)
#define CLASS_1_0AD6129525BF5F86_GET_DATAREF_OFFSET UNITYSDK_OFFSET(0x19CB5220)
#define CLASS_1_0AD6129525BF5F86_GET_ENSURECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x19CB52E0)
#define CLASS_1_0AD6129525BF5F86_GET_ID_OFFSET UNITYSDK_OFFSET(0x19CB5380)
#define CLASS_1_0AD6129525BF5F86_GET_ISHIT_OFFSET UNITYSDK_OFFSET(0x19CB5260)
#define CLASS_1_0AD6129525BF5F86_GET_ONPROJECTILEHIT_OFFSET UNITYSDK_OFFSET(0x19CB5280)
#define CLASS_1_0AD6129525BF5F86_GET_ONPROJECTILELIFETIMEFINISH_OFFSET UNITYSDK_OFFSET(0x19CB52A0)
#define CLASS_1_0AD6129525BF5F86_GET_OWNERABILITYREF_OFFSET UNITYSDK_OFFSET(0x19CB5200)
#define CLASS_1_0AD6129525BF5F86_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x19CB51E0)
#define CLASS_1_0AD6129525BF5F86_GET_PREVIOUSPROJECTILE_OFFSET UNITYSDK_OFFSET(0x19CB5300)
#define CLASS_1_0AD6129525BF5F86_GET_SKILLCONTEXT_OFFSET UNITYSDK_OFFSET(0x19CB52C0)
#define CLASS_1_0AD6129525BF5F86_GET_STATE_OFFSET UNITYSDK_OFFSET(0x19CB5180)
#define CLASS_1_0AD6129525BF5F86_GET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0x19CB51A0)
#define CLASS_1_0AD6129525BF5F86_GET_TARGETPOSENTITY_OFFSET UNITYSDK_OFFSET(0x19CB51C0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_0094A08E076C3CCD_OFFSET UNITYSDK_OFFSET(0x19CB6F40)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_0986B6F765C6D4BF_OFFSET UNITYSDK_OFFSET(0x19CB6AF0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_0A26BD5C1AA86FC1_OFFSET UNITYSDK_OFFSET(0x19CB4300)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_1AD51778485AD495_OFFSET UNITYSDK_OFFSET(0x19CB50C0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x19CB5320)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_218F2836DA51D562_OFFSET UNITYSDK_OFFSET(0x19CB5030)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_21F6EDFB46EAF49A_OFFSET UNITYSDK_OFFSET(0x19CB2CA0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x19CB6EB0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19CB5070)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x19CB6760)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0x19CB39F0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x19CB37E0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_79E872D90798D236_OFFSET UNITYSDK_OFFSET(0x19CB3850)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_82D02CA55C2C5E94_OFFSET UNITYSDK_OFFSET(0x19CB3D80)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x19CB3960)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x19CB3C70)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_8AB82AB9C7395DBE_OFFSET UNITYSDK_OFFSET(0x19CB3EB0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x19CB2BB0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A1F9BFB7EBB25DAC_OFFSET UNITYSDK_OFFSET(0x19CB6870)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x19CB3B70)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0x19CB3660)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19CB3FC0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_CE1B8140CA2F0094_OFFSET UNITYSDK_OFFSET(0x19CA1D40)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_DFEE291D2E3825AE_OFFSET UNITYSDK_OFFSET(0x19CB53A0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_E3AC81DD7CD64AC9_OFFSET UNITYSDK_OFFSET(0x19CB4000)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_E7B909E841DA8734_OFFSET UNITYSDK_OFFSET(0x19CB5D60)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_F3BF7103107A47CD_OFFSET UNITYSDK_OFFSET(0x19CB6BA0)
#define CLASS_1_0AD6129525BF5F86_SET_DATABEHAVIORTYPE_OFFSET UNITYSDK_OFFSET(0x19CB5250)
#define CLASS_1_0AD6129525BF5F86_SET_DATAREF_OFFSET UNITYSDK_OFFSET(0x19CB5230)
#define CLASS_1_0AD6129525BF5F86_SET_ENSURECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x19CB52F0)
#define CLASS_1_0AD6129525BF5F86_SET_ID_OFFSET UNITYSDK_OFFSET(0x19CB5390)
#define CLASS_1_0AD6129525BF5F86_SET_ISHIT_OFFSET UNITYSDK_OFFSET(0x19CB5270)
#define CLASS_1_0AD6129525BF5F86_SET_ONPROJECTILEHIT_OFFSET UNITYSDK_OFFSET(0x19CB5290)
#define CLASS_1_0AD6129525BF5F86_SET_ONPROJECTILELIFETIMEFINISH_OFFSET UNITYSDK_OFFSET(0x19CB52B0)
#define CLASS_1_0AD6129525BF5F86_SET_OWNERABILITYREF_OFFSET UNITYSDK_OFFSET(0x19CB5210)
#define CLASS_1_0AD6129525BF5F86_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x19CB51F0)
#define CLASS_1_0AD6129525BF5F86_SET_PREVIOUSPROJECTILE_OFFSET UNITYSDK_OFFSET(0x19CB5310)
#define CLASS_1_0AD6129525BF5F86_SET_SKILLCONTEXT_OFFSET UNITYSDK_OFFSET(0x19CB52D0)
#define CLASS_1_0AD6129525BF5F86_SET_STATE_OFFSET UNITYSDK_OFFSET(0x19CB5190)
#define CLASS_1_0AD6129525BF5F86_SET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0x19CB51B0)
#define CLASS_1_0AD6129525BF5F86_SET_TARGETPOSENTITY_OFFSET UNITYSDK_OFFSET(0x19CB51D0)
#define CLASS_1_0AD6129525BF5F86__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CB7140)
#define CLASS_1_0AD6129525BF5F86__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB2E10)
#define CLASS_1_0AD6129525BF5F86___CTOR_B__4_0_OFFSET UNITYSDK_OFFSET(0x19CB7200)
...
public:
	...
	{
		return (::RPG::GameCore::ColliderConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x62F90);
	}
	static ::System::String** StaticGet_LBGAAPBDIDI()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x62F98);
	}
	static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_IKADOAGOFEM()
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x62FA0);
	}
	static ::RPG::GameCore::ProjectileTemplateConfig** StaticGet_BGGJAPNALIN()
	{
		return (::RPG::GameCore::ProjectileTemplateConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x62FA8);
	}
	static ::System::Int32* StaticGet_BNGOLNHFADJ()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x14510);
	}
	static ::System::Int32* StaticGet_LIPDNJHCKGC()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x14514);
	}
	::Class_1_A2D8E5AB4B623162* _OwnerAbilityRef_k__BackingField; // 0x10
	::System::String* MGHMMOLGFKL; // 0x18
	::Class_3_98C806684F7CC372_15* _OnProjectileLifetimeFinish_k__BackingField; // 0x20
	::UnityEngine::Transform* MJMHMMFKBCC; // 0x28
	::System::String* LBGEHJJFKCL; // 0x30
	::UnityEngine::GameObject* FCKCHPNEEKB; // 0x38
	::RPG::Client::MonoProjectileEffect* LLEDDKCJBBM; // 0x40
	::Class_1_2B8E0B4950FE44E7* _SkillContext_k__BackingField; // 0x48
	::Class_1_0AD6129525BF5F86* _PreviousProjectile_k__BackingField; // 0x50
	::RPG::GameCore::GameEntity* _TargetPosEntity_k__BackingField; // 0x58
	::Class_3_98C806684F7CC372_14* _OnProjectileHit_k__BackingField; // 0x60
	::RPG::GameCore::NewProjectileConfig* _DataRef_k__BackingField; // 0x68
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* CJDIGEBAGBO; // 0x70
	::UnityEngine::Rigidbody* NCLFBGFOJKC; // 0x78
	::UnityEngine::Animator* OELNPDNHMPG; // 0x80
	::Class_1_1835888C1E19F013* LKNBIAHBIFP; // 0x88
	::RPG::GameCore::GameEntity* _OwnerEntity_k__BackingField; // 0x90
	::RPG::GameCore::GameEntity* _TargetEntity_k__BackingField; // 0x98
	::System::Single INIEIBBFCIM; // 0xA0
	::UnityEngine::Vector3 MHHGMIHOCMJ; // 0xA4
	::System::Single FPHNBMKFDDN; // 0xB0
	::System::Boolean _IsHit_k__BackingField; // 0xB4
	::System::Boolean NIPHGONDDHC; // 0xB5
	::System::Boolean FHHPOKGHNBG; // 0xB6
	::System::Boolean _EnsureCallbackOrder_k__BackingField; // 0xB7
	::UnityEngine::Vector3 HFCLFJMMFJK; // 0xB8
	::UnityEngine::Vector3 DBGPPLMHKHJ; // 0xC4
	::UnityEngine::Vector3 DLKMKNFJLIK; // 0xD0
	::RPG::GameCore::ProjectileMoveBehavior _DataBehaviorType_k__BackingField; // 0xDC
	::UnityEngine::Vector3 AKOIKFDLNID; // 0xE0
	::System::Single DNPEHPPLEOA; // 0xEC
	::Struct_2_1C6CD3A917B08105 NNGCDEHEDJE; // 0xF0
	::UnityEngine::Vector3 KONBAMDOGDH; // 0xF8
	::System::Int32 _ID_k__BackingField; // 0x104
	::UnityEngine::Vector3 PGJJCGGBCKK; // 0x108
	::UnityEngine::Vector3 IFIEBIEIKIE; // 0x114
	::UnityEngine::Vector3 CNCEDLKOHFL; // 0x120
	::UnityEngine::Vector3 EGHDMDEJICM; // 0x12C
	::RPG::GameCore::ProjectileState _State_k__BackingField; // 0x138
	::System::Int32 BILLIIBBKPE; // 0x13C
	::UnityEngine::Vector3 HFOMPEEAPCG; // 0x140
