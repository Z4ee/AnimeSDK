...
#define CLASS_2_E59C28A7BDCC5D07_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18099300)
#define CLASS_2_E59C28A7BDCC5D07_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1809A430)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x180998B0)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x18099350)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_E6F2B746784C0C83_OFFSET UNITYSDK_OFFSET(0x18099D80)
#define CLASS_2_E59C28A7BDCC5D07_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1809A3D0)
#define CLASS_2_E59C28A7BDCC5D07_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1809A220)
#define CLASS_2_E59C28A7BDCC5D07_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x180999A0)
#define CLASS_2_E59C28A7BDCC5D07_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18099DE0)
#define CLASS_2_E59C28A7BDCC5D07_TICK_OFFSET UNITYSDK_OFFSET(0x18099E30)
#define CLASS_2_E59C28A7BDCC5D07__CTOR_OFFSET UNITYSDK_OFFSET(0x180992E0)
...
public:
	...
	::RPG::GameCore::TransformComponent* JDPKGCFJHJF; // 0x20
	::RPG::Client::CameraDataAndFlags* OMKPPIGCFDN; // 0x28
	::RPG::GameCore::AdventureCharacterController* OHMHKPLKPJI; // 0x30
	::RPG::GameCore::GameEntity* ACJGKBDLCMF; // 0x38
	::RPG::GameCore::AdvEnablePropDialogMode* OFKGLJOAMLD; // 0x40
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x48
	::System::Single AKAHKABBNAF; // 0x50
	::System::Single MLIKCLDNOCI; // 0x54
	::UnityEngine::Vector3 KIPJGEFAHPF; // 0x58
	::System::Boolean FPGKLEODJJN; // 0x64
	::System::Nullable_1<::UnityEngine::Vector3> EPBKDBCMBDN; // 0x68
