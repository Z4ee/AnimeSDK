...
#define SPINESKELETONFLIPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C36A8B0)

inline static constexpr unsigned int SpineSkeletonFlipBehaviour_TypeDefinitionIndex = 85884;
