...
#define CLASS_2_7E5D0F1AAC191692_DISPOSE_OFFSET UNITYSDK_OFFSET(0x192803A0)
#define CLASS_2_7E5D0F1AAC191692_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x192803E0)
#define CLASS_2_7E5D0F1AAC191692_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19280530)
#define CLASS_2_7E5D0F1AAC191692_TICK_OFFSET UNITYSDK_OFFSET(0x19280580)
#define CLASS_2_7E5D0F1AAC191692__CTOR_OFFSET UNITYSDK_OFFSET(0x19280390)

inline static constexpr unsigned int Class_2_7E5D0F1AAC191692_TypeDefinitionIndex = 55453;

class Class_2_7E5D0F1AAC191692 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::OwnerEntityRemoveAbility* OFKGLJOAMLD; // 0x18
