...
#define CLASS_2_BE5E024943FBFDC5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15B770B0)
#define CLASS_2_BE5E024943FBFDC5_GET_FOLLOWSOURCE_OFFSET UNITYSDK_OFFSET(0x15B785F0)
#define CLASS_2_BE5E024943FBFDC5_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15B77630)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_0DA2366A4A7DBAA7_OFFSET UNITYSDK_OFFSET(0x15B774E0)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_0DC71D7A58FDD8E3_OFFSET UNITYSDK_OFFSET(0x15B782B0)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_1E8636B0C75F4A00_OFFSET UNITYSDK_OFFSET(0x15B78250)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x15B77690)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_821BBDC04720A2EB_OFFSET UNITYSDK_OFFSET(0x15B77D50)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_972179ACA713A4B1_OFFSET UNITYSDK_OFFSET(0x15B77410)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x15B771D0)
#define CLASS_2_BE5E024943FBFDC5_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x15B76F90)
#define CLASS_2_BE5E024943FBFDC5_SET_FOLLOWSOURCE_OFFSET UNITYSDK_OFFSET(0x15B78600)
#define CLASS_2_BE5E024943FBFDC5__CCTOR_OFFSET UNITYSDK_OFFSET(0x15B786D0)
#define CLASS_2_BE5E024943FBFDC5__CTOR_OFFSET UNITYSDK_OFFSET(0x15B78610)
...
public:
	...
	{
		return (::Il2CppArray<::RPG::Client::MonoEffectHideReason>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BE5E024943FBFDC5_TypeDefinitionIndex)->GetStaticField(0x648D0);
	}
	::System::Collections::Generic::Dictionary_2<::RPG::Client::TriggerEffectParamsRef, ::RPG::Client::TriggerEffectParamsRef>* FJFBAGIAAKK; // 0x18
	::RPG::GameCore::GameEntity* _FollowSource_k__BackingField; // 0x20
