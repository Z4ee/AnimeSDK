...
#define CLASS_1_126415C60CEDDA17_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DAC8A70)
#define CLASS_1_126415C60CEDDA17_CLONE_OFFSET UNITYSDK_OFFSET(0x1DAC85A0)
#define CLASS_1_126415C60CEDDA17_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DAC8720)
#define CLASS_1_126415C60CEDDA17_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DAC8680)
#define CLASS_1_126415C60CEDDA17_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DAC8820)
#define CLASS_1_126415C60CEDDA17_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DAC8BC0)
#define CLASS_1_126415C60CEDDA17_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DAC8B70)
#define CLASS_1_126415C60CEDDA17_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1DAC8670)
#define CLASS_1_126415C60CEDDA17_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DAC84E0)
#define CLASS_1_126415C60CEDDA17_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x1DAC8650)
#define CLASS_1_126415C60CEDDA17_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1DAC8630)
#define CLASS_1_126415C60CEDDA17_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1DAC8660)
#define CLASS_1_126415C60CEDDA17_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1DAC8640)
#define CLASS_1_126415C60CEDDA17_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1DAC8620)
#define CLASS_1_126415C60CEDDA17_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DAC8540)
#define CLASS_1_126415C60CEDDA17_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DAC8870)
#define CLASS_1_126415C60CEDDA17_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DAC88D0)
#define CLASS_1_126415C60CEDDA17__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAC8D60)
#define CLASS_1_126415C60CEDDA17__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAC8560)
#define CLASS_1_126415C60CEDDA17__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAC8550)

inline static constexpr unsigned int Class_1_126415C60CEDDA17_TypeDefinitionIndex = 30426;

class Class_1_126415C60CEDDA17 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_126415C60CEDDA17*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_126415C60CEDDA17*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_126415C60CEDDA17_TypeDefinitionIndex)->GetStaticField(0x1A590);
	}
	// static const ::System::Int32 DIJCEHJPFAC = 0xC; // 0x0
	// static const ::System::Int32 HOLLCCLAJAB = 0xF; // 0x0
	// static const ::System::Int32 EPBPHGNEEKM = 0x6; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt64 KIPJPMDOMPF; // 0x18
	::System::Boolean DHAHNCEMJJE; // 0x20
	::System::Boolean FMOMGAKACID; // 0x21
