...
#define CLASS_2_6626A1BAF6E6C42E_GET_ADDINGCONCRETE_OFFSET UNITYSDK_OFFSET(0x1AC41320)
#define CLASS_2_6626A1BAF6E6C42E_GET_CONFLICTGUID_OFFSET UNITYSDK_OFFSET(0x1AC41310)
#define CLASS_2_6626A1BAF6E6C42E_GET_EXISTINGCONCRETE_OFFSET UNITYSDK_OFFSET(0x1AC41330)
#define CLASS_2_6626A1BAF6E6C42E__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3FF80)

inline static constexpr unsigned int Class_2_6626A1BAF6E6C42E_TypeDefinitionIndex = 40684;

class Class_2_6626A1BAF6E6C42E : public ::System::Exception
{
public:
	::Class_1_60B5E5A0CB5606E4* _ExistingConcrete_k__BackingField; // 0x88
	::Class_1_60B5E5A0CB5606E4* _AddingConcrete_k__BackingField; // 0x90
