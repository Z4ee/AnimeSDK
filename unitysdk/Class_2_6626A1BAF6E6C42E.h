...
#define CLASS_2_6626A1BAF6E6C42E_GET_ADDINGCONCRETE_OFFSET UNITYSDK_OFFSET(0x18387C70)
#define CLASS_2_6626A1BAF6E6C42E_GET_CONFLICTGUID_OFFSET UNITYSDK_OFFSET(0x18387C60)
#define CLASS_2_6626A1BAF6E6C42E_GET_EXISTINGCONCRETE_OFFSET UNITYSDK_OFFSET(0x18387C80)
#define CLASS_2_6626A1BAF6E6C42E__CTOR_OFFSET UNITYSDK_OFFSET(0x18381FD0)

inline static constexpr unsigned int Class_2_6626A1BAF6E6C42E_TypeDefinitionIndex = 34033;
