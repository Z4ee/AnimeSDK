...
#define CLASS_1_5B567C8A01BAEDFE_323_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9EE920)
#define CLASS_1_5B567C8A01BAEDFE_323_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9EE790)
#define CLASS_1_5B567C8A01BAEDFE_323_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9EE830)
#define CLASS_1_5B567C8A01BAEDFE_323_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9EE7D0)
#define CLASS_1_5B567C8A01BAEDFE_323_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9EE880)
#define CLASS_1_5B567C8A01BAEDFE_323_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9EE970)
#define CLASS_1_5B567C8A01BAEDFE_323_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9EE940)
#define CLASS_1_5B567C8A01BAEDFE_323_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A9EE710)
#define CLASS_1_5B567C8A01BAEDFE_323_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9EE740)
#define CLASS_1_5B567C8A01BAEDFE_323_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9EE8B0)
#define CLASS_1_5B567C8A01BAEDFE_323_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9EE910)
#define CLASS_1_5B567C8A01BAEDFE_323__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9EE9C0)
#define CLASS_1_5B567C8A01BAEDFE_323__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9EE760)
#define CLASS_1_5B567C8A01BAEDFE_323__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EE750)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_323*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_323_TypeDefinitionIndex)->GetStaticField(0x68090);
	}
