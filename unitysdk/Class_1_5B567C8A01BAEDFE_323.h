...
#define CLASS_1_5B567C8A01BAEDFE_323_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195EAE10)
#define CLASS_1_5B567C8A01BAEDFE_323_CLONE_OFFSET UNITYSDK_OFFSET(0x195EAC20)
#define CLASS_1_5B567C8A01BAEDFE_323_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195EAD20)
#define CLASS_1_5B567C8A01BAEDFE_323_EQUALS_OFFSET UNITYSDK_OFFSET(0x195EAC90)
#define CLASS_1_5B567C8A01BAEDFE_323_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195EAD70)
#define CLASS_1_5B567C8A01BAEDFE_323_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195EAE60)
#define CLASS_1_5B567C8A01BAEDFE_323_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195EAE30)
#define CLASS_1_5B567C8A01BAEDFE_323_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195EAB70)
#define CLASS_1_5B567C8A01BAEDFE_323_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195EABD0)
#define CLASS_1_5B567C8A01BAEDFE_323_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195EADA0)
#define CLASS_1_5B567C8A01BAEDFE_323_WRITETO_OFFSET UNITYSDK_OFFSET(0x195EAE00)
#define CLASS_1_5B567C8A01BAEDFE_323__CCTOR_OFFSET UNITYSDK_OFFSET(0x195EAEB0)
#define CLASS_1_5B567C8A01BAEDFE_323__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195EABF0)
#define CLASS_1_5B567C8A01BAEDFE_323__CTOR_OFFSET UNITYSDK_OFFSET(0x195EABE0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_323_TypeDefinitionIndex = 31766;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_323*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_323_TypeDefinitionIndex)->GetStaticField(0x563F0);
	}
	...
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_323*>* Method_1_33819E510657F52F()
	{
		return ((::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_323*>*(*)())((::PBYTE)hIl2Cpp + CLASS_1_5B567C8A01BAEDFE_323_METHOD_1_33819E510657F52F_OFFSET))();
	}
