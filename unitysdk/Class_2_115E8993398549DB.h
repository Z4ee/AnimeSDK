...
#define CLASS_2_115E8993398549DB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18017500)
#define CLASS_2_115E8993398549DB_DOONENTER_OFFSET UNITYSDK_OFFSET(0x180176A0)
#define CLASS_2_115E8993398549DB_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x18017C50)
#define CLASS_2_115E8993398549DB_GET_BLOCKDIALOGUEINRANGE_OFFSET UNITYSDK_OFFSET(0x18018040)
#define CLASS_2_115E8993398549DB_GET_DISABLEAFTERTRIGGERED_OFFSET UNITYSDK_OFFSET(0x18018020)
#define CLASS_2_115E8993398549DB_GET_ENSUREIMMEDIATETASK_OFFSET UNITYSDK_OFFSET(0x18018060)
#define CLASS_2_115E8993398549DB_METHOD_2_74505E341CB9A5FE_OFFSET UNITYSDK_OFFSET(0x18018080)
#define CLASS_2_115E8993398549DB_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18017650)
#define CLASS_2_115E8993398549DB_ONTRIGGEREDLOGICFINISH_OFFSET UNITYSDK_OFFSET(0x18017550)
#define CLASS_2_115E8993398549DB_SET_BLOCKDIALOGUEINRANGE_OFFSET UNITYSDK_OFFSET(0x18018050)
#define CLASS_2_115E8993398549DB_SET_DISABLEAFTERTRIGGERED_OFFSET UNITYSDK_OFFSET(0x18018030)
#define CLASS_2_115E8993398549DB_SET_ENSUREIMMEDIATETASK_OFFSET UNITYSDK_OFFSET(0x18018070)
#define CLASS_2_115E8993398549DB__CCTOR_OFFSET UNITYSDK_OFFSET(0x180181D0)
#define CLASS_2_115E8993398549DB__CTOR_OFFSET UNITYSDK_OFFSET(0x180174A0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_115E8993398549DB_TypeDefinitionIndex)->GetStaticField(0x5FF40);
	}
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* HAEDBJEGEJB; // 0x98
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* IGAJPJJKPDF; // 0xA0
	::RPG::GameCore::TaskContext* OELBMKNMMGO; // 0xA8
	::System::Boolean _EnsureImmediateTask_k__BackingField; // 0xB0
	::System::Boolean IKOKPIGDJEO; // 0xB1
