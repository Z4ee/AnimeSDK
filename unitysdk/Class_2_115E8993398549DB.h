...
#define CLASS_2_115E8993398549DB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13C4A6A0)
#define CLASS_2_115E8993398549DB_DOONENTER_OFFSET UNITYSDK_OFFSET(0x13C4A840)
#define CLASS_2_115E8993398549DB_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x13C4AC50)
#define CLASS_2_115E8993398549DB_GET_BLOCKDIALOGUEINRANGE_OFFSET UNITYSDK_OFFSET(0x13C4AF70)
#define CLASS_2_115E8993398549DB_GET_DISABLEAFTERTRIGGERED_OFFSET UNITYSDK_OFFSET(0x13C4AF50)
#define CLASS_2_115E8993398549DB_GET_ENSUREIMMEDIATETASK_OFFSET UNITYSDK_OFFSET(0x13C4AF90)
#define CLASS_2_115E8993398549DB_METHOD_2_227DBAAD8A7BA789_OFFSET UNITYSDK_OFFSET(0x13C4AFB0)
#define CLASS_2_115E8993398549DB_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13C4A7F0)
#define CLASS_2_115E8993398549DB_ONTRIGGEREDLOGICFINISH_OFFSET UNITYSDK_OFFSET(0x13C4A6F0)
#define CLASS_2_115E8993398549DB_SET_BLOCKDIALOGUEINRANGE_OFFSET UNITYSDK_OFFSET(0x13C4AF80)
#define CLASS_2_115E8993398549DB_SET_DISABLEAFTERTRIGGERED_OFFSET UNITYSDK_OFFSET(0x13C4AF60)
#define CLASS_2_115E8993398549DB_SET_ENSUREIMMEDIATETASK_OFFSET UNITYSDK_OFFSET(0x13C4AFA0)
#define CLASS_2_115E8993398549DB__CCTOR_OFFSET UNITYSDK_OFFSET(0x13C4B0B0)
#define CLASS_2_115E8993398549DB__CTOR_OFFSET UNITYSDK_OFFSET(0x13C4A640)
#define CLASS_2_115E8993398549DB___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13C4B0D0)
#define CLASS_2_115E8993398549DB___IFIXBASEPROXY_DOONENTER_OFFSET UNITYSDK_OFFSET(0x13C4B0F0)
#define CLASS_2_115E8993398549DB___IFIXBASEPROXY_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x13C4B100)
#define CLASS_2_115E8993398549DB___IFIXBASEPROXY_ONTRIGGEREDLOGICFINISH_OFFSET UNITYSDK_OFFSET(0x13C4B0E0)

inline static constexpr unsigned int Class_2_115E8993398549DB_TypeDefinitionIndex = 53718;

class Class_2_115E8993398549DB : public ::Class_1_A696AB4980B3D7B5
{
public:
	static ::System::String** StaticGet_Field_2_0()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_115E8993398549DB_TypeDefinitionIndex)->GetStaticField(0x65270);
	}
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* Field_2_1; // 0x98
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* Field_2_2; // 0xA0
	::RPG::GameCore::TaskContext* Field_2_3; // 0xA8
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + CLASS_2_115E8993398549DB___IFIXBASEPROXY_DOONENTER_OFFSET))(this, a1);
	}

	::System::Void __iFixBaseProxy_DoOnExit(::RPG::GameCore::GameEntity* a1, ::RPG::GameCore::TriggerExitReason a2)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TriggerExitReason))((::PBYTE)hIl2Cpp + CLASS_2_115E8993398549DB___IFIXBASEPROXY_DOONEXIT_OFFSET))(this, a1, a2);
	}
};
