...
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_002A3C2EF46C74CF_OFFSET UNITYSDK_OFFSET(0xEA5FA50)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_04B1E591CC9E8ECC_OFFSET UNITYSDK_OFFSET(0xEA5EFD0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_04DC58A6E3312864_OFFSET UNITYSDK_OFFSET(0xEA5DD40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_0841DD481C9E7631_OFFSET UNITYSDK_OFFSET(0xEA5C6B0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_0CC78D4556EB7518_OFFSET UNITYSDK_OFFSET(0xEA5CF00)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_0ECCCB67C31BD45B_OFFSET UNITYSDK_OFFSET(0xEA5EB00)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_17999C18C76E1A82_OFFSET UNITYSDK_OFFSET(0xEA5E780)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0xEA5DEA0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_25AD43CEABA83428_OFFSET UNITYSDK_OFFSET(0xEA5DBD0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_25EC27153ED46963_OFFSET UNITYSDK_OFFSET(0xEA5DA70)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_3A43654647DF6A74_OFFSET UNITYSDK_OFFSET(0xEA5CE70)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_3AF977ABBC8283D6_OFFSET UNITYSDK_OFFSET(0xEA5DE40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_4147D731A50593B6_1_OFFSET UNITYSDK_OFFSET(0xEA5F230)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_4147D731A50593B6_2_OFFSET UNITYSDK_OFFSET(0xEA5F7E0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_4147D731A50593B6_OFFSET UNITYSDK_OFFSET(0xEA5E4A0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_421ECE05A9FEB34D_OFFSET UNITYSDK_OFFSET(0xEA5C620)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_575495378A53B008_OFFSET UNITYSDK_OFFSET(0xEA5F090)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_57D6190C61FC7003_OFFSET UNITYSDK_OFFSET(0xEA5C200)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_5EF9DDA5070B0261_OFFSET UNITYSDK_OFFSET(0xEA5C470)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_656CD7CD7E175989_OFFSET UNITYSDK_OFFSET(0xEA5CFE0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_70459B7C790C82DB_OFFSET UNITYSDK_OFFSET(0xEA5F3F0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0xEA5E6B0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_9818E41BDCF3063A_OFFSET UNITYSDK_OFFSET(0xEA5CC40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_991C84568C655F51_OFFSET UNITYSDK_OFFSET(0xEA5DDD0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_9FAA2C729153F143_OFFSET UNITYSDK_OFFSET(0xEA5C030)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0xEA5C020)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_AA8656BCDBBD4870_OFFSET UNITYSDK_OFFSET(0xEA5F750)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_B7F8E960CB973ADC_OFFSET UNITYSDK_OFFSET(0xEA5C890)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_B88EEC44BCFAF6F9_OFFSET UNITYSDK_OFFSET(0xEA5E160)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_CF242B0F311AA6EB_OFFSET UNITYSDK_OFFSET(0xEA5DEB0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_CF6EEB0206D60DE3_OFFSET UNITYSDK_OFFSET(0xEA5F680)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_DA624ED5E7AFDE43_1_OFFSET UNITYSDK_OFFSET(0xEA5F9A0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_DA624ED5E7AFDE43_OFFSET UNITYSDK_OFFSET(0xEA5CE10)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_EDBFE3C4D4F7A857_OFFSET UNITYSDK_OFFSET(0xEA5F530)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_F343EB366B5A896D_OFFSET UNITYSDK_OFFSET(0xEA5F5E0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_F7A2740694EB100F_OFFSET UNITYSDK_OFFSET(0xEA5E010)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_FFFEA3B2FB2730AD_OFFSET UNITYSDK_OFFSET(0xEA5E660)
#define CLASS_2_D39C2FCEF4D4B922__CTOR_OFFSET UNITYSDK_OFFSET(0xEA5D6A0)

inline static constexpr unsigned int Class_2_D39C2FCEF4D4B922_TypeDefinitionIndex = 43286;

class Class_2_D39C2FCEF4D4B922 : public ::Class_1_2A3859B4230FECE9
{
public:
	::MoleMole::CameraDelayDatas* Field_2_9; // 0x38
	::MoleMole::CameraDelayDatas* Field_2_7; // 0x40
	::MoleMole::Cameras::CameraDelayMoveDataBlendDefinition Field_2_2; // 0x48
	::Class_1_9DAA93B261093A09* Field_2_12; // 0x60
	::MoleMole::CameraDelayDatas* Field_2_8; // 0x68
	::MoleMole::Cameras::NapVirtual3DActionCamera_1* Field_2_0; // 0x70
	::Cinemachine::CameraState Field_2_11; // 0x78
	::Class_1_A422B5C99AB5650D* Field_2_3; // 0x160
	::MoleMole::CameraDelayDatas* Field_2_10; // 0x168
	::Class_1_9DAA93B261093A09* Field_2_1; // 0x170
	::System::Collections::Generic::List_1<::Class_1_4E9B72F06BA2FBA2*>* Field_2_4; // 0x178
	::MoleMole::CameraDelayDatas* Field_2_6; // 0x180
