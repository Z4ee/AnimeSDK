...
#define CLASS_1_5E9C16BFAA602EE3_METHOD_1_E8485B126CCCF227_OFFSET UNITYSDK_OFFSET(0x1892EA10)
#define CLASS_1_5E9C16BFAA602EE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1892EB40)
...
public:
	...
	::RPG::Client::TextID ENNKPIBOJLE; // 0x20
