...
#define INTERACTPROXY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x161BF780)
#define INTERACTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x161BF760)

inline static constexpr unsigned int InteractProxy_TypeDefinitionIndex = 47953;
