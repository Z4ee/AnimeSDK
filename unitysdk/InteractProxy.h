...
#define INTERACTPROXY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x14240680)
#define INTERACTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x14240660)

inline static constexpr unsigned int InteractProxy_TypeDefinitionIndex = 44785;
