...
#define CLASS_2_2CF600F518D344A2_ACTIVEENVIRONMENT_OFFSET UNITYSDK_OFFSET(0xE2ED0D0)
#define CLASS_2_2CF600F518D344A2_ADDENTITYSTREAMING_OFFSET UNITYSDK_OFFSET(0xE2EE260)
#define CLASS_2_2CF600F518D344A2_ADDMONOEFFECTSTREAMING_OFFSET UNITYSDK_OFFSET(0xE2EE030)
#define CLASS_2_2CF600F518D344A2_ADDSTREAMINGSOURCE_1_OFFSET UNITYSDK_OFFSET(0xE2F0D10)
#define CLASS_2_2CF600F518D344A2_ADDSTREAMINGSOURCE_OFFSET UNITYSDK_OFFSET(0xE2F0AE0)
#define CLASS_2_2CF600F518D344A2_CLEARADDITIONCENTERS_OFFSET UNITYSDK_OFFSET(0xE2F1030)
#define CLASS_2_2CF600F518D344A2_CLEARSHAREDALIASTASKVISIBLESTATE_OFFSET UNITYSDK_OFFSET(0xE2ED9A0)
#define CLASS_2_2CF600F518D344A2_CLEARSIDEEFFECT_OFFSET UNITYSDK_OFFSET(0xE2ECC70)
#define CLASS_2_2CF600F518D344A2_COLLECTBLOCKSBYTAG_1_OFFSET UNITYSDK_OFFSET(0xE2ECAF0)
#define CLASS_2_2CF600F518D344A2_COLLECTBLOCKSBYTAG_OFFSET UNITYSDK_OFFSET(0xE2EC810)
#define CLASS_2_2CF600F518D344A2_COLLECTSTREAMINGBLOCKBYNAMESET_OFFSET UNITYSDK_OFFSET(0xE2EC8E0)
#define CLASS_2_2CF600F518D344A2_DEBUGREPORTWHYNOTBATTLEAREALOADFINISH_OFFSET UNITYSDK_OFFSET(0xE2EB9D0)
#define CLASS_2_2CF600F518D344A2_DEBUGSETAREADELTAPOSITION_OFFSET UNITYSDK_OFFSET(0xE2F0230)
#define CLASS_2_2CF600F518D344A2_DESTROY_OFFSET UNITYSDK_OFFSET(0xE2ECF00)
#define CLASS_2_2CF600F518D344A2_ENABLEDYNAMICBLOCKENVPROFILEDATA_OFFSET UNITYSDK_OFFSET(0xE2EF800)
#define CLASS_2_2CF600F518D344A2_ENABLESTREAMINGDEBUGSCRIPT_OFFSET UNITYSDK_OFFSET(0xE2EF310)
#define CLASS_2_2CF600F518D344A2_ENDOFTICK_OFFSET UNITYSDK_OFFSET(0xE2EB610)
#define CLASS_2_2CF600F518D344A2_FORCEACTIVEBLOCKSENTITY_OFFSET UNITYSDK_OFFSET(0xE2EBDF0)
#define CLASS_2_2CF600F518D344A2_FORCEMONOEFFECTSTREAMINGUPDATE_OFFSET UNITYSDK_OFFSET(0xE2EE1A0)
#define CLASS_2_2CF600F518D344A2_FOREACHSTREAMINGBLOCKS_OFFSET UNITYSDK_OFFSET(0xE2ECA00)
#define CLASS_2_2CF600F518D344A2_GETALIASINSTANCEANDMARK_OFFSET UNITYSDK_OFFSET(0xE2ED2D0)
#define CLASS_2_2CF600F518D344A2_GETALIASITEMDATA_OFFSET UNITYSDK_OFFSET(0xE2ED6B0)
#define CLASS_2_2CF600F518D344A2_GETALIASITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xE2EDBA0)
#define CLASS_2_2CF600F518D344A2_GETALIASSTREAMINGINSTANCEANDMARK_OFFSET UNITYSDK_OFFSET(0xE2ED4D0)
#define CLASS_2_2CF600F518D344A2_GETPERSISTENTINSTOBJ_OFFSET UNITYSDK_OFFSET(0xE2EDAA0)
#define CLASS_2_2CF600F518D344A2_GETPERSISTENTTAGROOT_OFFSET UNITYSDK_OFFSET(0xE2EC720)
#define CLASS_2_2CF600F518D344A2_GETRANGEENTITY_OFFSET UNITYSDK_OFFSET(0xE2F0370)
#define CLASS_2_2CF600F518D344A2_GETSHAREDALIASITEMDATALIST_OFFSET UNITYSDK_OFFSET(0xE2ED780)
#define CLASS_2_2CF600F518D344A2_GETTRANSFORMTOOL_OFFSET UNITYSDK_OFFSET(0xE2EEE70)
#define CLASS_2_2CF600F518D344A2_GET_OPENWORLD_OFFSET UNITYSDK_OFFSET(0xE2EF780)
#define CLASS_2_2CF600F518D344A2_INACTIVEENVIROMENT_OFFSET UNITYSDK_OFFSET(0xE2ED1C0)
#define CLASS_2_2CF600F518D344A2_INITBATTLEAREA_OFFSET UNITYSDK_OFFSET(0xE2EAF70)
#define CLASS_2_2CF600F518D344A2_INITOPENWORLD_OFFSET UNITYSDK_OFFSET(0xE2EAA50)
#define CLASS_2_2CF600F518D344A2_INITREGIONMANAGER_OFFSET UNITYSDK_OFFSET(0xE2EAD90)
#define CLASS_2_2CF600F518D344A2_INVOKEUNITYGOLOGICRESETWITHTAMONO_OFFSET UNITYSDK_OFFSET(0xE2ECD00)
#define CLASS_2_2CF600F518D344A2_ISBATTLEAREALOADFINISH_OFFSET UNITYSDK_OFFSET(0xE2EB920)
#define CLASS_2_2CF600F518D344A2_ISSTREAMINGLOADFINISH_OFFSET UNITYSDK_OFFSET(0xE2EB840)
#define CLASS_2_2CF600F518D344A2_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE2EB570)
#define CLASS_2_2CF600F518D344A2_LOADAREA_OFFSET UNITYSDK_OFFSET(0xE2F0130)
#define CLASS_2_2CF600F518D344A2_LOADBATTLEAREABLOCK_OFFSET UNITYSDK_OFFSET(0xE2ECBC0)
#define CLASS_2_2CF600F518D344A2_LOAD_OFFSET UNITYSDK_OFFSET(0xE2EA260)
#define CLASS_2_2CF600F518D344A2_LOCKMAINSTREAMINGSOURCE_OFFSET UNITYSDK_OFFSET(0xE2F10F0)
#define CLASS_2_2CF600F518D344A2_METHOD_2_111E3F406ABDDAA7_OFFSET UNITYSDK_OFFSET(0xE2EA820)
#define CLASS_2_2CF600F518D344A2_METHOD_2_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xE2EF540)
#define CLASS_2_2CF600F518D344A2_METHOD_2_7854AA0B7A17DA18_OFFSET UNITYSDK_OFFSET(0xE59BF20)
#define CLASS_2_2CF600F518D344A2_METHOD_2_C7CCAF1C279004F7_1_OFFSET UNITYSDK_OFFSET(0xE2EF030)
#define CLASS_2_2CF600F518D344A2_METHOD_2_C7CCAF1C279004F7_OFFSET UNITYSDK_OFFSET(0xE2EDE40)
#define CLASS_2_2CF600F518D344A2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE2EF350)
#define CLASS_2_2CF600F518D344A2_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xE59C350)
#define CLASS_2_2CF600F518D344A2_METHOD_2_F1BE9F8DD9A4BA42_OFFSET UNITYSDK_OFFSET(0xE59C300)
#define CLASS_2_2CF600F518D344A2_METHOD_2_FE72BF2F281C4FA8_1_OFFSET UNITYSDK_OFFSET(0xE2EC1E0)
#define CLASS_2_2CF600F518D344A2_METHOD_2_FE72BF2F281C4FA8_2_OFFSET UNITYSDK_OFFSET(0xE2EC480)
#define CLASS_2_2CF600F518D344A2_METHOD_2_FE72BF2F281C4FA8_OFFSET UNITYSDK_OFFSET(0xE2EBF70)
#define CLASS_2_2CF600F518D344A2_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0xE2EB000)
#define CLASS_2_2CF600F518D344A2_ONMONOEFFECTPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0xE2EEBB0)
#define CLASS_2_2CF600F518D344A2_PREINITOPENWORLD_OFFSET UNITYSDK_OFFSET(0xE2EA870)
#define CLASS_2_2CF600F518D344A2_REMOVEADDITIONCENTER_OFFSET UNITYSDK_OFFSET(0xE2F0F60)
#define CLASS_2_2CF600F518D344A2_REMOVEBLOCK_OFFSET UNITYSDK_OFFSET(0xE2F1230)
#define CLASS_2_2CF600F518D344A2_REMOVEENTITYSTREAMING_OFFSET UNITYSDK_OFFSET(0xE2EE330)
#define CLASS_2_2CF600F518D344A2_REMOVEMONOEFFECTSTREAMING_OFFSET UNITYSDK_OFFSET(0xE2EE110)
#define CLASS_2_2CF600F518D344A2_RUNTIMEADDRENDERSTUB_1_OFFSET UNITYSDK_OFFSET(0xE2F0800)
#define CLASS_2_2CF600F518D344A2_RUNTIMEADDRENDERSTUB_OFFSET UNITYSDK_OFFSET(0xE2F0570)
#define CLASS_2_2CF600F518D344A2_RUNTIMEADDSTREAMINGITEM_1_OFFSET UNITYSDK_OFFSET(0xE2EE5B0)
#define CLASS_2_2CF600F518D344A2_RUNTIMEADDSTREAMINGITEM_2_OFFSET UNITYSDK_OFFSET(0xE2EE760)
#define CLASS_2_2CF600F518D344A2_RUNTIMEADDSTREAMINGITEM_OFFSET UNITYSDK_OFFSET(0xE2EE3F0)
#define CLASS_2_2CF600F518D344A2_RUNTIMEDYNAMICLOADOPTIONALBLOCK_OFFSET UNITYSDK_OFFSET(0xE2EF390)
#define CLASS_2_2CF600F518D344A2_RUNTIMEDYNAMICREMOVEBLOCK_OFFSET UNITYSDK_OFFSET(0xE2EF460)
#define CLASS_2_2CF600F518D344A2_RUNTIMELOADOPTIONALBLOCKSCONFIG_OFFSET UNITYSDK_OFFSET(0xE2EFF90)
#define CLASS_2_2CF600F518D344A2_RUNTIMEREMOVERENDERSTUB_OFFSET UNITYSDK_OFFSET(0xE2F0700)
#define CLASS_2_2CF600F518D344A2_RUNTIMEREMOVESTREAMINGITEM_OFFSET UNITYSDK_OFFSET(0xE2EE930)
#define CLASS_2_2CF600F518D344A2_RUNTIMESETSTREAMINGENABLE_OFFSET UNITYSDK_OFFSET(0xE2EF220)
#define CLASS_2_2CF600F518D344A2_RUNTIMESETSTREAMINGITEMVISIBLE_OFFSET UNITYSDK_OFFSET(0xE2EE9C0)
#define CLASS_2_2CF600F518D344A2_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xE2EFA80)
#define CLASS_2_2CF600F518D344A2_SETADDITIONCENTER_OFFSET UNITYSDK_OFFSET(0xE2F09E0)
#define CLASS_2_2CF600F518D344A2_SETALLBLOCKVISIBLE_OFFSET UNITYSDK_OFFSET(0xE2EFEC0)
#define CLASS_2_2CF600F518D344A2_SETBLOCKFOCUSWITHNAMES_OFFSET UNITYSDK_OFFSET(0xE2F04A0)
#define CLASS_2_2CF600F518D344A2_SETBLOCKFORCEHIDEEXCEPTNAMES_OFFSET UNITYSDK_OFFSET(0xE2EBD20)
#define CLASS_2_2CF600F518D344A2_SETBLOCKFORCEHIDEEXCEPTTAGNAME_OFFSET UNITYSDK_OFFSET(0xE2EBC20)
#define CLASS_2_2CF600F518D344A2_SETBLOCKFORCEHLODWITHTAGS_OFFSET UNITYSDK_OFFSET(0xE2EBB50)
#define CLASS_2_2CF600F518D344A2_SETBLOCKVISIBLEBYALIAS_OFFSET UNITYSDK_OFFSET(0xE2EFDE0)
#define CLASS_2_2CF600F518D344A2_SETBLOCKVISIBLEBYALLHOYOTAGS_OFFSET UNITYSDK_OFFSET(0xE2EFD00)
#define CLASS_2_2CF600F518D344A2_SETBLOCKVISIBLEBYHOYOTAG_OFFSET UNITYSDK_OFFSET(0xE2EFC20)
#define CLASS_2_2CF600F518D344A2_SETBLOCKVISIBLEBYTAG_OFFSET UNITYSDK_OFFSET(0xE2EFB40)
#define CLASS_2_2CF600F518D344A2_SETFORCESTREAMING_OFFSET UNITYSDK_OFFSET(0xE2EEC70)
#define CLASS_2_2CF600F518D344A2_SETMAPDEF_OFFSET UNITYSDK_OFFSET(0xE2EA620)
#define CLASS_2_2CF600F518D344A2_SETSHAREDALIASTASKVISIBLESTATE_OFFSET UNITYSDK_OFFSET(0xE2ED8A0)
#define CLASS_2_2CF600F518D344A2_SETUNLOADENABLE_OFFSET UNITYSDK_OFFSET(0xE2EDD80)
#define CLASS_2_2CF600F518D344A2_SHOWALLBLOCKS_OFFSET UNITYSDK_OFFSET(0xE2EC640)
#define CLASS_2_2CF600F518D344A2_SHOWAREAONLY_OFFSET UNITYSDK_OFFSET(0xE2F0070)
#define CLASS_2_2CF600F518D344A2_SYNCPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0xE2EF8C0)
#define CLASS_2_2CF600F518D344A2_TRYREGISTERRENDERSTUBREBUILDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE2EDCA0)
#define CLASS_2_2CF600F518D344A2_UNLOADALLRESOURCE_OFFSET UNITYSDK_OFFSET(0xE2EC130)
#define CLASS_2_2CF600F518D344A2_UNLOADBATTLEAREABLOCK_OFFSET UNITYSDK_OFFSET(0xE2EBAA0)
#define CLASS_2_2CF600F518D344A2_UNLOADPERSISTENTRESOURCE_OFFSET UNITYSDK_OFFSET(0xE2EC3A0)
#define CLASS_2_2CF600F518D344A2_UNLOADSTREAMINGRESOURCE_OFFSET UNITYSDK_OFFSET(0xE2EBEC0)
#define CLASS_2_2CF600F518D344A2_UNLOCKMAINSTREAMINGSOURCE_OFFSET UNITYSDK_OFFSET(0xE2F11A0)
#define CLASS_2_2CF600F518D344A2_UNMARKALIASINSTANCE_OFFSET UNITYSDK_OFFSET(0xE2ED3F0)
#define CLASS_2_2CF600F518D344A2_UNMARKALIASSTREAMINGINSTANCE_OFFSET UNITYSDK_OFFSET(0xE2ED5D0)
#define CLASS_2_2CF600F518D344A2_UPDATEITEMLODTEMPLATE_OFFSET UNITYSDK_OFFSET(0xE2EEAD0)
#define CLASS_2_2CF600F518D344A2_UPDATESTREAMINGLOADFINISH_OFFSET UNITYSDK_OFFSET(0xE2EB3E0)
#define CLASS_2_2CF600F518D344A2_UPDATE_OFFSET UNITYSDK_OFFSET(0xE2EB200)
#define CLASS_2_2CF600F518D344A2_VISIBLEPCONLYBLOCK_OFFSET UNITYSDK_OFFSET(0xE2EEF50)
#define CLASS_2_2CF600F518D344A2__CTOR_OFFSET UNITYSDK_OFFSET(0xE59C3C0)
#define CLASS_2_2CF600F518D344A2__UPDATEAFTEROPENWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xE59C360)
...
{
public:
	::RPG::GameCore::StageConfig* PPAODDKLMMC; // 0xC0
	::RPG::Client::Stage* HPODNCAICPG; // 0xC8
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::Client::Stage*>* CFOLJKEEKGL; // 0xD0
