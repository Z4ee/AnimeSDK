...
#define CLASS_2_1876638A8093ADEC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B03B00)
#define CLASS_2_1876638A8093ADEC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17B03B40)
#define CLASS_2_1876638A8093ADEC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17B03BC0)
#define CLASS_2_1876638A8093ADEC_TICK_OFFSET UNITYSDK_OFFSET(0x17B03C10)
#define CLASS_2_1876638A8093ADEC__CTOR_OFFSET UNITYSDK_OFFSET(0x17B03AF0)
...
{
public:
	::RPG::GameCore::LockToast* OFKGLJOAMLD; // 0x18
