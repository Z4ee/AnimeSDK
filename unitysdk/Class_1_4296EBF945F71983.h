...
#define CLASS_1_4296EBF945F71983_METHOD_1_04951D6B02953962_OFFSET UNITYSDK_OFFSET(0x1A8C3680)
#define CLASS_1_4296EBF945F71983_METHOD_1_414C8F92528E4746_1_OFFSET UNITYSDK_OFFSET(0x1A8C32C0)
#define CLASS_1_4296EBF945F71983_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x1A8C30A0)
#define CLASS_1_4296EBF945F71983_METHOD_1_56E8ED155DF34A44_OFFSET UNITYSDK_OFFSET(0x1A8C2F60)
#define CLASS_1_4296EBF945F71983_METHOD_1_6632971549249DA6_OFFSET UNITYSDK_OFFSET(0x1A8C2D70)
#define CLASS_1_4296EBF945F71983_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x1A8C2F10)
#define CLASS_1_4296EBF945F71983_METHOD_1_A799B17DDBC2AB8A_OFFSET UNITYSDK_OFFSET(0x1A8C3710)
#define CLASS_1_4296EBF945F71983_METHOD_1_AABDDF32B6E8582A_OFFSET UNITYSDK_OFFSET(0x1A8C3570)
#define CLASS_1_4296EBF945F71983_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1A8C34E0)
#define CLASS_1_4296EBF945F71983_METHOD_1_D8E6DC0B27699F85_OFFSET UNITYSDK_OFFSET(0x1A8C3B90)
#define CLASS_1_4296EBF945F71983__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8C3D80)
#define CLASS_1_4296EBF945F71983__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C2EC0)

inline static constexpr unsigned int Class_1_4296EBF945F71983_TypeDefinitionIndex = 73462;

class Class_1_4296EBF945F71983 : public ::System::Object
{
public:
	static ::Class_1_4296EBF945F71983** StaticGet_EMLNOINPICJ()
	{
		return (::Class_1_4296EBF945F71983**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4296EBF945F71983_TypeDefinitionIndex)->GetStaticField(0x5E9D0);
	}
	static ::System::Int32* StaticGet_MMNNADCNGLC()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4296EBF945F71983_TypeDefinitionIndex)->GetStaticField(0x131E0);
	}
	::System::Collections::Generic::List_1<::RPG::Client::DynamicFloatingObject::DynamicFloatingObject*>* AHIPHBAEDPM; // 0x10
	::WaveSimPanel* OELCBNCFOEA; // 0x18
	::RPG::Client::DynamicFloatingObject::WaterSimOverrideParam* MDGBEEMINOA; // 0x20
	::System::Boolean KKCFCJFAAKA; // 0x28
