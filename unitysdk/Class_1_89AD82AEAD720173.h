...
#define CLASS_1_89AD82AEAD720173_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BA9B5C0)
#define CLASS_1_89AD82AEAD720173_ONALLOC_OFFSET UNITYSDK_OFFSET(0x1BA9B6C0)
#define CLASS_1_89AD82AEAD720173_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1BA9B730)
#define CLASS_1_89AD82AEAD720173__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA9B770)
...
{
public:
	::Class_1_69C7B9DFD5B449A1* CEEGJCAJAHB; // 0x10
	::Struct_2_CFA12135DA0D972E ANCGCNIEAAC; // 0x18
	::Class_1_69C7B9DFD5B449A1* CDJBDBKGDIL; // 0x28
	::Class_1_F35D4DA7881CD768* DHHKBENPHMH; // 0x30
