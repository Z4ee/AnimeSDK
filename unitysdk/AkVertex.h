...
#define AKVERTEX_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C1527D0)
#define AKVERTEX_CLONE_OFFSET UNITYSDK_OFFSET(0x1C1527F0)
#define AKVERTEX_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1C1527E0)
#define AKVERTEX_GET_X_OFFSET UNITYSDK_OFFSET(0x1C152720)
#define AKVERTEX_GET_Y_OFFSET UNITYSDK_OFFSET(0x1C152740)
#define AKVERTEX_GET_Z_OFFSET UNITYSDK_OFFSET(0x1C152760)
#define AKVERTEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C152770)
#define AKVERTEX_SET_X_OFFSET UNITYSDK_OFFSET(0x1C152710)
#define AKVERTEX_SET_Y_OFFSET UNITYSDK_OFFSET(0x1C152730)
#define AKVERTEX_SET_Z_OFFSET UNITYSDK_OFFSET(0x1C152750)
#define AKVERTEX_ZERO_OFFSET UNITYSDK_OFFSET(0x1C152700)
#define AKVERTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C1527C0)
#define AKVERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1527A0)

inline static constexpr unsigned int AkVertex_TypeDefinitionIndex = 31528;
