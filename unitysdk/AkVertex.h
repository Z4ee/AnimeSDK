...
#define AKVERTEX_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B6E72B0)
#define AKVERTEX_CLONE_OFFSET UNITYSDK_OFFSET(0x1B6E7340)
#define AKVERTEX_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1B6E7300)
#define AKVERTEX_GET_X_OFFSET UNITYSDK_OFFSET(0x1B6E7060)
#define AKVERTEX_GET_Y_OFFSET UNITYSDK_OFFSET(0x1B6E7110)
#define AKVERTEX_GET_Z_OFFSET UNITYSDK_OFFSET(0x1B6E71C0)
#define AKVERTEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B6E7210)
#define AKVERTEX_SET_X_OFFSET UNITYSDK_OFFSET(0x1B6E7000)
#define AKVERTEX_SET_Y_OFFSET UNITYSDK_OFFSET(0x1B6E70B0)
#define AKVERTEX_SET_Z_OFFSET UNITYSDK_OFFSET(0x1B6E7160)
#define AKVERTEX_ZERO_OFFSET UNITYSDK_OFFSET(0x1B6E6FB0)
#define AKVERTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6E72A0)
#define AKVERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E7280)
