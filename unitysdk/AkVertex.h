...
#define AKVERTEX_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D2D87D0)
#define AKVERTEX_CLONE_OFFSET UNITYSDK_OFFSET(0x1D2D8860)
#define AKVERTEX_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1D2D8820)
#define AKVERTEX_GET_X_OFFSET UNITYSDK_OFFSET(0x1D2D8580)
#define AKVERTEX_GET_Y_OFFSET UNITYSDK_OFFSET(0x1D2D8630)
#define AKVERTEX_GET_Z_OFFSET UNITYSDK_OFFSET(0x1D2D86E0)
#define AKVERTEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D2D8730)
#define AKVERTEX_SET_X_OFFSET UNITYSDK_OFFSET(0x1D2D8520)
#define AKVERTEX_SET_Y_OFFSET UNITYSDK_OFFSET(0x1D2D85D0)
#define AKVERTEX_SET_Z_OFFSET UNITYSDK_OFFSET(0x1D2D8680)
#define AKVERTEX_ZERO_OFFSET UNITYSDK_OFFSET(0x1D2D84D0)
#define AKVERTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D2D87C0)
#define AKVERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D87A0)
