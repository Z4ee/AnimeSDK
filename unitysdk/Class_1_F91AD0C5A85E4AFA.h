...
#define CLASS_1_F91AD0C5A85E4AFA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4A65A0)
#define CLASS_1_F91AD0C5A85E4AFA_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4A5EB0)
#define CLASS_1_F91AD0C5A85E4AFA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4A60F0)
#define CLASS_1_F91AD0C5A85E4AFA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4A6030)
#define CLASS_1_F91AD0C5A85E4AFA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4A62C0)
#define CLASS_1_F91AD0C5A85E4AFA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4A68D0)
#define CLASS_1_F91AD0C5A85E4AFA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4A6730)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E4A5FF0)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E4A5FD0)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1E4A5F80)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1E4A5F70)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1E4A6010)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E4A5D90)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E4A6000)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E4A5FE0)
#define CLASS_1_F91AD0C5A85E4AFA_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1E4A6020)
#define CLASS_1_F91AD0C5A85E4AFA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4A5DF0)
#define CLASS_1_F91AD0C5A85E4AFA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4A6390)
#define CLASS_1_F91AD0C5A85E4AFA_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4A63F0)
#define CLASS_1_F91AD0C5A85E4AFA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4A6A70)
#define CLASS_1_F91AD0C5A85E4AFA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4A5E10)
#define CLASS_1_F91AD0C5A85E4AFA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4A5E00)

inline static constexpr unsigned int Class_1_F91AD0C5A85E4AFA_TypeDefinitionIndex = 24795;

class Class_1_F91AD0C5A85E4AFA : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F91AD0C5A85E4AFA_TypeDefinitionIndex)->GetStaticField(0x42980);
	}
	...
	// static const ::System::Int32 DLFLLLJJOKD = 0x4; // 0x0
	::System::String* DEJFOEHNFJA; // 0x10
	::Class_1_45BB92167AED63A0* LLNBEBKIOLH; // 0x18
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x20
	::System::UInt32 AAGAKAIKGCM; // 0x28
	::System::UInt32 AJPNGCJCMEB; // 0x2C
