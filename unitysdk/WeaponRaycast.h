...
#define WEAPONRAYCAST_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x19A9AC90)
#define WEAPONRAYCAST_GETBIPROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x19A99B00)
#define WEAPONRAYCAST_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19A9A4A0)
#define WEAPONRAYCAST_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x19A99E90)
#define WEAPONRAYCAST_GETSTAGEGROUNDPOSHIT_OFFSET UNITYSDK_OFFSET(0x19A9A080)
#define WEAPONRAYCAST_GET_BLENDVALUE_OFFSET UNITYSDK_OFFSET(0x19A9A950)
#define WEAPONRAYCAST_GET_CALCPROCESSTIME_OFFSET UNITYSDK_OFFSET(0x19A9A840)
#define WEAPONRAYCAST_GET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x19A99AC0)
#define WEAPONRAYCAST_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x19A99AE0)
#define WEAPONRAYCAST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19A9B350)
#define WEAPONRAYCAST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x19A9B260)
#define WEAPONRAYCAST_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x19A99CE0)
#define WEAPONRAYCAST_SET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x19A99AD0)
#define WEAPONRAYCAST_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x19A99AF0)
#define WEAPONRAYCAST_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x19A9A7B0)
#define WEAPONRAYCAST_START_OFFSET UNITYSDK_OFFSET(0x19A99CF0)
#define WEAPONRAYCAST_TRIGGERRAYCASTCLOSE_OFFSET UNITYSDK_OFFSET(0x19A9AB80)
#define WEAPONRAYCAST_TRIGGERRAYCASTOPEN_OFFSET UNITYSDK_OFFSET(0x19A9AA80)
#define WEAPONRAYCAST_UPDATESETTIME_OFFSET UNITYSDK_OFFSET(0x19A9A8E0)
#define WEAPONRAYCAST__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A9B870)
#define WEAPONRAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x19A9B790)

inline static constexpr unsigned int WeaponRaycast_TypeDefinitionIndex = 46542;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x3D670);
	}
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_rayCastHitResults()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x3D678);
	}
