...
#define WEAPONRAYCAST_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x1C6BD690)
#define WEAPONRAYCAST_GETBIPROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x1C6BC500)
#define WEAPONRAYCAST_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C6BCEA0)
#define WEAPONRAYCAST_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x1C6BC890)
#define WEAPONRAYCAST_GETSTAGEGROUNDPOSHIT_OFFSET UNITYSDK_OFFSET(0x1C6BCA80)
#define WEAPONRAYCAST_GET_BLENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C6BD350)
#define WEAPONRAYCAST_GET_CALCPROCESSTIME_OFFSET UNITYSDK_OFFSET(0x1C6BD240)
#define WEAPONRAYCAST_GET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x1C6BC4C0)
#define WEAPONRAYCAST_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x1C6BC4E0)
#define WEAPONRAYCAST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C6BDD50)
#define WEAPONRAYCAST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1C6BDC60)
#define WEAPONRAYCAST_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x1C6BC6E0)
#define WEAPONRAYCAST_SET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x1C6BC4D0)
#define WEAPONRAYCAST_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x1C6BC4F0)
#define WEAPONRAYCAST_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x1C6BD1B0)
#define WEAPONRAYCAST_START_OFFSET UNITYSDK_OFFSET(0x1C6BC6F0)
#define WEAPONRAYCAST_TRIGGERRAYCASTCLOSE_OFFSET UNITYSDK_OFFSET(0x1C6BD580)
#define WEAPONRAYCAST_TRIGGERRAYCASTOPEN_OFFSET UNITYSDK_OFFSET(0x1C6BD480)
#define WEAPONRAYCAST_UPDATESETTIME_OFFSET UNITYSDK_OFFSET(0x1C6BD2E0)
#define WEAPONRAYCAST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6BE270)
#define WEAPONRAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6BE190)

inline static constexpr unsigned int WeaponRaycast_TypeDefinitionIndex = 50747;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x3FBC0);
	}
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_rayCastHitResults()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x3FBC8);
	}
