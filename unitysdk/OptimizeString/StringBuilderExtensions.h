...
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_1_OFFSET UNITYSDK_OFFSET(0x1E871630)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_2_OFFSET UNITYSDK_OFFSET(0x1E871740)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_3_OFFSET UNITYSDK_OFFSET(0x1E871530)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_4_OFFSET UNITYSDK_OFFSET(0x1E871880)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_5_OFFSET UNITYSDK_OFFSET(0x1E871A10)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_6_OFFSET UNITYSDK_OFFSET(0x1E871B10)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_7_OFFSET UNITYSDK_OFFSET(0x1E871DD0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_8_OFFSET UNITYSDK_OFFSET(0x1E8720A0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_OFFSET UNITYSDK_OFFSET(0x1E871420)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_EMPTY_OFFSET UNITYSDK_OFFSET(0x1E872BA0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E872BD0)

namespace OptimizeString
{
	inline static constexpr unsigned int StringBuilderExtensions_TypeDefinitionIndex = 7252;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringBuilderExtensions_TypeDefinitionIndex)->GetStaticField(0x60E0);
		}
		static ::System::Char* StaticGet_ms_default_pad_char()
		{
			return (::System::Char*)Il2CppClass::FromTypeDefinitionIndex(StringBuilderExtensions_TypeDefinitionIndex)->GetStaticField(0x32B0);
		}
		static ::System::UInt32* StaticGet_ms_default_decimal_places()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(StringBuilderExtensions_TypeDefinitionIndex)->GetStaticField(0x32B4);
		}
