...
#define OPTIMIZESTRING_STRINGBUILDERNOGC_COPYTOCACHESTRING_OFFSET UNITYSDK_OFFSET(0x1FC49CD0)
#define OPTIMIZESTRING_STRINGBUILDERNOGC_INITPOOL_OFFSET UNITYSDK_OFFSET(0x1FC498A0)
#define OPTIMIZESTRING_STRINGBUILDERNOGC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1FC4A070)
#define OPTIMIZESTRING_STRINGBUILDERNOGC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC496D0)
#define OPTIMIZESTRING_STRINGBUILDERNOGC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FC49BA0)
#define OPTIMIZESTRING_STRINGBUILDERNOGC__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC49A70)

namespace OptimizeString
{
	inline static constexpr unsigned int StringBuilderNoGC_TypeDefinitionIndex = 7257;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(StringBuilderNoGC_TypeDefinitionIndex)->GetStaticField(0x6100);
		}
		static ::System::Collections::Generic::Stack_1<::OptimizeString::StringBuilderNoGC*>** StaticGet_s_pool()
		{
			return (::System::Collections::Generic::Stack_1<::OptimizeString::StringBuilderNoGC*>**)Il2CppClass::FromTypeDefinitionIndex(StringBuilderNoGC_TypeDefinitionIndex)->GetStaticField(0x6108);
		}
		static ::System::Boolean* StaticGet_s_UseShortCache()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(StringBuilderNoGC_TypeDefinitionIndex)->GetStaticField(0x32D0);
		}
		::System::Text::StringBuilder* m_stringBuilder; // 0x10
		::System::String* m_cacheString; // 0x18
		::System::String* m_immutableString; // 0x20
		::System::String* forToString; // 0x28
		::System::Int32 m_capacity; // 0x30
		::System::Boolean m_isDirty; // 0x34
