...
#define CLASS_2_503F42E3C830DCDF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x106274A0)
#define CLASS_2_503F42E3C830DCDF_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x10627570)
#define CLASS_2_503F42E3C830DCDF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x106273A0)
#define CLASS_2_503F42E3C830DCDF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10627450)
#define CLASS_2_503F42E3C830DCDF_TICK_OFFSET UNITYSDK_OFFSET(0x10627660)
#define CLASS_2_503F42E3C830DCDF__CTOR_OFFSET UNITYSDK_OFFSET(0x10627310)

inline static constexpr unsigned int Class_2_503F42E3C830DCDF_TypeDefinitionIndex = 43311;

class Class_2_503F42E3C830DCDF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_5775A4FEC79026BC* Field_2_2; // 0x18
	::RPG::GameCore::WaitMusicRhythmSongChangeEvent* Field_2_1; // 0x20
