...
#define HORIZONTALFLOWLAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x10512DB0)
#define HORIZONTALFLOWLAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x10513A10)
#define HORIZONTALFLOWLAYOUTGROUP_CALCULATEROWVERTICALOFFSET_OFFSET UNITYSDK_OFFSET(0x10513A90)
#define HORIZONTALFLOWLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x134D2BE0)
#define HORIZONTALFLOWLAYOUTGROUP_GETGREATESTMINCOLWIDTH_OFFSET UNITYSDK_OFFSET(0x134D2AA0)
#define HORIZONTALFLOWLAYOUTGROUP_GETGREATESTMINIMUMCHILDWIDTH_OFFSET UNITYSDK_OFFSET(0x134D29E0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CHILDFORCEEXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x10512A90)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CHILDFORCEEXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x10512B70)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CONSTRAINTCOUNT_OFFSET UNITYSDK_OFFSET(0x105129B0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CONSTRAINT_OFFSET UNITYSDK_OFFSET(0x10512920)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISCENTERALIGN_OFFSET UNITYSDK_OFFSET(0x10512C50)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISLOWERALIGN_OFFSET UNITYSDK_OFFSET(0x10512D60)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISMIDDLEALIGN_OFFSET UNITYSDK_OFFSET(0x10512D10)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISRIGHTALIGN_OFFSET UNITYSDK_OFFSET(0x10512CB0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_SPACING_OFFSET UNITYSDK_OFFSET(0x10512860)
#define HORIZONTALFLOWLAYOUTGROUP_LAYOUTROW_OFFSET UNITYSDK_OFFSET(0x10513BB0)
#define HORIZONTALFLOWLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x10512EF0)
#define HORIZONTALFLOWLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x10513990)
#define HORIZONTALFLOWLAYOUTGROUP_SETLAYOUT_OFFSET UNITYSDK_OFFSET(0x10512F70)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CHILDFORCEEXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x10512AA0)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CHILDFORCEEXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x10512B80)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CONSTRAINTCOUNT_OFFSET UNITYSDK_OFFSET(0x105129C0)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CONSTRAINT_OFFSET UNITYSDK_OFFSET(0x10512930)
#define HORIZONTALFLOWLAYOUTGROUP_SET_SPACING_OFFSET UNITYSDK_OFFSET(0x10512870)
#define HORIZONTALFLOWLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x134D2C20)
#define HORIZONTALFLOWLAYOUTGROUP___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x134D2CC0)
#define HORIZONTALFLOWLAYOUTGROUP___BASE_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x134D2CD0)

inline static constexpr unsigned int HorizontalFlowLayoutGroup_TypeDefinitionIndex = 38840;
