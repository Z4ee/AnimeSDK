...
#define MATERIALPROPERTYBLOCKDEBUGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1033F6F0)
#define MATERIALPROPERTYBLOCKDEBUGGER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1033F0A0)
#define MATERIALPROPERTYBLOCKDEBUGGER_RELEASECONTENTS_OFFSET UNITYSDK_OFFSET(0x1033F530)
#define MATERIALPROPERTYBLOCKDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1033F740)

inline static constexpr unsigned int MaterialPropertyBlockDebugger_TypeDefinitionIndex = 85953;
