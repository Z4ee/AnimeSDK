...
#define MATERIALPROPERTYBLOCKDEBUGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11A649E0)
#define MATERIALPROPERTYBLOCKDEBUGGER_REFRESH_OFFSET UNITYSDK_OFFSET(0x11A64390)
#define MATERIALPROPERTYBLOCKDEBUGGER_RELEASECONTENTS_OFFSET UNITYSDK_OFFSET(0x11A64820)
#define MATERIALPROPERTYBLOCKDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A64A30)

inline static constexpr unsigned int MaterialPropertyBlockDebugger_TypeDefinitionIndex = 91482;
