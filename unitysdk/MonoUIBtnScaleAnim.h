...
#define MONOUIBTNSCALEANIM_AWAKE_OFFSET UNITYSDK_OFFSET(0xC93B470)
#define MONOUIBTNSCALEANIM_GETFIXSCALE_OFFSET UNITYSDK_OFFSET(0xC93C000)
#define MONOUIBTNSCALEANIM_INIT_OFFSET UNITYSDK_OFFSET(0xC93C890)
#define MONOUIBTNSCALEANIM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC93CA20)
#define MONOUIBTNSCALEANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC93C7E0)
#define MONOUIBTNSCALEANIM_RELOADCONFIG_OFFSET UNITYSDK_OFFSET(0xC93B5C0)
#define MONOUIBTNSCALEANIM_RESETSTATE_OFFSET UNITYSDK_OFFSET(0xC93C1C0)
#define MONOUIBTNSCALEANIM_STARTANIM_OFFSET UNITYSDK_OFFSET(0xC93C060)
#define MONOUIBTNSCALEANIM_STOPANIM_OFFSET UNITYSDK_OFFSET(0xC93C7A0)
#define MONOUIBTNSCALEANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0xC93C840)
#define MONOUIBTNSCALEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xC93CA80)
#define MONOUIBTNSCALEANIM__STARTANIM_OFFSET UNITYSDK_OFFSET(0xC93C210)
#define MONOUIBTNSCALEANIM___STARTANIM_B__40_0_OFFSET UNITYSDK_OFFSET(0xC93CB10)
#define MONOUIBTNSCALEANIM___STARTANIM_B__40_1_OFFSET UNITYSDK_OFFSET(0xC93CDB0)

inline static constexpr unsigned int MonoUIBtnScaleAnim_TypeDefinitionIndex = 45671;
