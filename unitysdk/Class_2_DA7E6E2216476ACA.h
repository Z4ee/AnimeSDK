...
#define CLASS_2_DA7E6E2216476ACA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16FC3710)
#define CLASS_2_DA7E6E2216476ACA_METHOD_2_B82DC6B34437802C_OFFSET UNITYSDK_OFFSET(0x16FC3440)
#define CLASS_2_DA7E6E2216476ACA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16FC3390)
#define CLASS_2_DA7E6E2216476ACA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16FC3660)
#define CLASS_2_DA7E6E2216476ACA_TICK_OFFSET UNITYSDK_OFFSET(0x16FC36B0)
#define CLASS_2_DA7E6E2216476ACA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC3380)

inline static constexpr unsigned int Class_2_DA7E6E2216476ACA_TypeDefinitionIndex = 55540;

class Class_2_DA7E6E2216476ACA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::EnterGameFlowImmediately* Field_2_1; // 0x20
