...
#define ZXING_QRCODE_INTERNAL_ENCODER_APPEND8BITBYTES_OFFSET UNITYSDK_OFFSET(0x16D760B0)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDALPHANUMERICBYTES_OFFSET UNITYSDK_OFFSET(0x16D75E20)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDBYTES_OFFSET UNITYSDK_OFFSET(0x16D73BC0)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDECI_OFFSET UNITYSDK_OFFSET(0x16D73AD0)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDKANJIBYTES_OFFSET UNITYSDK_OFFSET(0x16D762D0)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDLENGTHINFO_OFFSET UNITYSDK_OFFSET(0x16D74150)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDMODEINFO_OFFSET UNITYSDK_OFFSET(0x16D73B90)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDNUMERICBYTES_OFFSET UNITYSDK_OFFSET(0x16D75C30)
#define ZXING_QRCODE_INTERNAL_ENCODER_CALCULATEBITSNEEDED_OFFSET UNITYSDK_OFFSET(0x16D73EB0)
#define ZXING_QRCODE_INTERNAL_ENCODER_CALCULATEMASKPENALTY_OFFSET UNITYSDK_OFFSET(0x16D71F20)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEMASKPATTERN_OFFSET UNITYSDK_OFFSET(0x16D75270)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEMODE_OFFSET UNITYSDK_OFFSET(0x16D738B0)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEVERSION_OFFSET UNITYSDK_OFFSET(0x16D754F0)
#define ZXING_QRCODE_INTERNAL_ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x16D72900)
#define ZXING_QRCODE_INTERNAL_ENCODER_GENERATEECBYTES_OFFSET UNITYSDK_OFFSET(0x16D75AA0)
#define ZXING_QRCODE_INTERNAL_ENCODER_GETALPHANUMERICCODE_OFFSET UNITYSDK_OFFSET(0x16D75660)
#define ZXING_QRCODE_INTERNAL_ENCODER_GETNUMDATABYTESANDNUMECBYTESFORBLOCKID_OFFSET UNITYSDK_OFFSET(0x16D75920)
#define ZXING_QRCODE_INTERNAL_ENCODER_INTERLEAVEWITHECBYTES_OFFSET UNITYSDK_OFFSET(0x16D745A0)
#define ZXING_QRCODE_INTERNAL_ENCODER_ISONLYDOUBLEBYTEKANJI_OFFSET UNITYSDK_OFFSET(0x16D75730)
#define ZXING_QRCODE_INTERNAL_ENCODER_RECOMMENDVERSION_OFFSET UNITYSDK_OFFSET(0x16D73FB0)
#define ZXING_QRCODE_INTERNAL_ENCODER_TERMINATEBITS_OFFSET UNITYSDK_OFFSET(0x16D742E0)
#define ZXING_QRCODE_INTERNAL_ENCODER_WILLFIT_OFFSET UNITYSDK_OFFSET(0x16D73EF0)
#define ZXING_QRCODE_INTERNAL_ENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16D76620)
...
namespace ZXing::QrCode::Internal
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x32890);
		}
		static ::System::String** StaticGet_DEFAULT_BYTE_MODE_ENCODING()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x32898);
		}
