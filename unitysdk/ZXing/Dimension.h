...
#define ZXING_DIMENSION_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x16D55B20)
#define ZXING_DIMENSION_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x16D55B10)

namespace ZXing
{
	inline static constexpr unsigned int Dimension_TypeDefinitionIndex = 7000;
