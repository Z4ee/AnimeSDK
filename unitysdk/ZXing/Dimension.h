...
#define ZXING_DIMENSION_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x18D122B0)
#define ZXING_DIMENSION_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x18D122A0)

namespace ZXing
{
	inline static constexpr unsigned int Dimension_TypeDefinitionIndex = 6065;
