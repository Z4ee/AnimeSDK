...
#define ZXING_AZTEC_INTERNAL_ENCODER_BITSTOWORDS_OFFSET UNITYSDK_OFFSET(0x18CFC3E0)
#define ZXING_AZTEC_INTERNAL_ENCODER_DRAWBULLSEYE_OFFSET UNITYSDK_OFFSET(0x18CFBE30)
#define ZXING_AZTEC_INTERNAL_ENCODER_DRAWMODEMESSAGE_OFFSET UNITYSDK_OFFSET(0x18CFB8E0)
#define ZXING_AZTEC_INTERNAL_ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x18CF8F30)
#define ZXING_AZTEC_INTERNAL_ENCODER_GENERATECHECKWORDS_OFFSET UNITYSDK_OFFSET(0x18CFB4D0)
#define ZXING_AZTEC_INTERNAL_ENCODER_GENERATEMODEMESSAGE_OFFSET UNITYSDK_OFFSET(0x18CFB680)
#define ZXING_AZTEC_INTERNAL_ENCODER_GETGF_OFFSET UNITYSDK_OFFSET(0x18CFC150)
#define ZXING_AZTEC_INTERNAL_ENCODER_STUFFBITS_OFFSET UNITYSDK_OFFSET(0x18CFB310)
#define ZXING_AZTEC_INTERNAL_ENCODER_TOTALBITSINLAYER_OFFSET UNITYSDK_OFFSET(0x18CFB2F0)
#define ZXING_AZTEC_INTERNAL_ENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18CFC810)

namespace ZXing::Aztec::Internal
{
	inline static constexpr unsigned int Encoder_TypeDefinitionIndex = 6045;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x8470);
		}
