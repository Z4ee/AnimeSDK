...
#define ZXING_DATAMATRIX_ENCODER_TEXTENCODER_ENCODECHAR_OFFSET UNITYSDK_OFFSET(0x1BE80A80)
#define ZXING_DATAMATRIX_ENCODER_TEXTENCODER_GET_ENCODINGMODE_OFFSET UNITYSDK_OFFSET(0x1BE80A70)
#define ZXING_DATAMATRIX_ENCODER_TEXTENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE7ED40)

namespace ZXing::Datamatrix::Encoder
{
	inline static constexpr unsigned int TextEncoder_TypeDefinitionIndex = 19512;
