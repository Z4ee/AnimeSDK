...
#define ZXING_COMMON_ECI_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BE71030)
#define ZXING_COMMON_ECI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE70EF0)

namespace ZXing::Common
{
	inline static constexpr unsigned int ECI_TypeDefinitionIndex = 19444;
