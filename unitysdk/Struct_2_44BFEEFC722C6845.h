...
#define STRUCT_2_44BFEEFC722C6845_METHOD_2_3D6EDFDF43C4B010_OFFSET UNITYSDK_OFFSET(0x78C500)
#define STRUCT_2_44BFEEFC722C6845_METHOD_2_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x78C5C0)
#define STRUCT_2_44BFEEFC722C6845_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x36D9B0)
#define STRUCT_2_44BFEEFC722C6845_METHOD_2_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x78C510)
#define STRUCT_2_44BFEEFC722C6845__CTOR_OFFSET UNITYSDK_OFFSET(0x78C4F0)

inline static constexpr unsigned int Struct_2_44BFEEFC722C6845_TypeDefinitionIndex = 88041;

struct alignas(4) Struct_2_44BFEEFC722C6845
{
	::Foundation::Unreal::Interval_1<::System::Single> Field_2_1; // 0x10
	::Enum_3_2ACAE3B8E89364F1 Field_2_0; // 0x20
	::Foundation::FixedArray2_1<::System::Single> Field_2_7; // 0x24
