...
#define AUISTATETAGLOADER_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x12111540)
#define AUISTATETAGLOADER_ISFALSE_OFFSET UNITYSDK_OFFSET(0x12110AA0)
#define AUISTATETAGLOADER_ISTRUE_OFFSET UNITYSDK_OFFSET(0x12111140)
#define AUISTATETAGLOADER_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x12111070)
#define AUISTATETAGLOADER_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x12111550)
#define AUISTATETAGLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x12111560)

inline static constexpr unsigned int AUiStateTagLoader_TypeDefinitionIndex = 44323;
