...
#define CLASS_2_EA329A6A72E70DEE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E59260)
#define CLASS_2_EA329A6A72E70DEE_METHOD_2_92BE766FE7637517_OFFSET UNITYSDK_OFFSET(0x18E59590)
#define CLASS_2_EA329A6A72E70DEE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18E593C0)
#define CLASS_2_EA329A6A72E70DEE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18E592B0)
#define CLASS_2_EA329A6A72E70DEE_TICK_OFFSET UNITYSDK_OFFSET(0x18E59360)
#define CLASS_2_EA329A6A72E70DEE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E59250)

inline static constexpr unsigned int Class_2_EA329A6A72E70DEE_TypeDefinitionIndex = 53289;

class Class_2_EA329A6A72E70DEE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::RequestChangeMatchThreeV2BirdLocation* OFKGLJOAMLD; // 0x18
