...
#define CLASS_2_FE1C55B9A3D608B7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15FF5830)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_0C26ECD726C672E7_OFFSET UNITYSDK_OFFSET(0x15FF7AC0)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x15FF8610)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x15FF7010)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_342BE5A5703789D7_OFFSET UNITYSDK_OFFSET(0x15FF78E0)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_3A45CD235E3551A6_OFFSET UNITYSDK_OFFSET(0x15FF7D30)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_3E17DE187D6B8091_OFFSET UNITYSDK_OFFSET(0x15FF8910)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_3F22D21CFB54FC1E_OFFSET UNITYSDK_OFFSET(0x15FF7A70)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_4EBCEEADE9A1AAE6_OFFSET UNITYSDK_OFFSET(0x15FF8540)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_5110E061C0DF5692_OFFSET UNITYSDK_OFFSET(0x15FF5920)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_59F5F5E6AFB9C8E7_OFFSET UNITYSDK_OFFSET(0x15FF7710)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_79C0322DC08C55D6_OFFSET UNITYSDK_OFFSET(0x15FF6F90)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_95A04E8059088754_OFFSET UNITYSDK_OFFSET(0x15FF83D0)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0x15FF5BB0)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_A6143A14F11DAA03_OFFSET UNITYSDK_OFFSET(0x15FF8970)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_ACA133530085D272_OFFSET UNITYSDK_OFFSET(0x15FF7E70)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_ADF4AD3331B4D7AD_1_OFFSET UNITYSDK_OFFSET(0x15FF8820)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_ADF4AD3331B4D7AD_2_OFFSET UNITYSDK_OFFSET(0x15FF8870)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x15FF87D0)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_BCEDF88FD731AB55_OFFSET UNITYSDK_OFFSET(0x15FF8360)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_D20BF56E36607D54_OFFSET UNITYSDK_OFFSET(0x15FF88C0)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_DDE5DAED7274FB5D_OFFSET UNITYSDK_OFFSET(0x15FF7680)
#define CLASS_2_FE1C55B9A3D608B7_METHOD_2_E4E99C7BB6A2A951_OFFSET UNITYSDK_OFFSET(0x15FF7F90)
#define CLASS_2_FE1C55B9A3D608B7__CTOR_OFFSET UNITYSDK_OFFSET(0x15FF8A30)
...
public:
	...
	::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>* MONOAGGOGCL; // 0x20
	::RPG::Client::AdventurePhase* DEIEJIOELMO; // 0x28
	::Class_1_64D890C466F37235* KGCNPIEDOCA; // 0x30
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::System::String*>* DMIJDAKHLOI; // 0x38
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::System::ValueTuple_3<::System::UInt32, ::System::String*, ::System::String*>>* DLJEDFLGCNL; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::UInt32, ::System::UInt32>, ::System::ValueTuple_2<::System::String*, ::System::String*>>* KIFCEDBCHBN; // 0x48
