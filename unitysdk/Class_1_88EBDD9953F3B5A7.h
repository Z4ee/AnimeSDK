...
#define CLASS_1_88EBDD9953F3B5A7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D8A00B0)
#define CLASS_1_88EBDD9953F3B5A7_CLONE_OFFSET UNITYSDK_OFFSET(0x1D89FAA0)
#define CLASS_1_88EBDD9953F3B5A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D89FD30)
#define CLASS_1_88EBDD9953F3B5A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D89FBA0)
#define CLASS_1_88EBDD9953F3B5A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D89FEC0)
#define CLASS_1_88EBDD9953F3B5A7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D8A02F0)
#define CLASS_1_88EBDD9953F3B5A7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D8A0250)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1D89FB40)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1D89FB60)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1D89FB90)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D89F9C0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1D89FB50)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1D89FB80)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1D89FB70)
#define CLASS_1_88EBDD9953F3B5A7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D89F9F0)
#define CLASS_1_88EBDD9953F3B5A7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D89FF10)
#define CLASS_1_88EBDD9953F3B5A7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D89FF70)
#define CLASS_1_88EBDD9953F3B5A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8A04C0)
#define CLASS_1_88EBDD9953F3B5A7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D89FA10)
#define CLASS_1_88EBDD9953F3B5A7__CTOR_OFFSET UNITYSDK_OFFSET(0x1D89FA00)

inline static constexpr unsigned int Class_1_88EBDD9953F3B5A7_TypeDefinitionIndex = 34006;

class Class_1_88EBDD9953F3B5A7 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_88EBDD9953F3B5A7*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_88EBDD9953F3B5A7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_88EBDD9953F3B5A7_TypeDefinitionIndex)->GetStaticField(0x42AD0);
	}
	// static const ::System::Int32 PLDKENJLKME = 0x9; // 0x0
	// static const ::System::Int32 KIEJLJIMANA = 0x2; // 0x0
	// static const ::System::Int32 FIEMKPOELCD = 0xC; // 0x0
