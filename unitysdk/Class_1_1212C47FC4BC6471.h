...
#define CLASS_1_1212C47FC4BC6471_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195B2430)
#define CLASS_1_1212C47FC4BC6471_CLONE_OFFSET UNITYSDK_OFFSET(0x195B1EF0)
#define CLASS_1_1212C47FC4BC6471_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195B2090)
#define CLASS_1_1212C47FC4BC6471_EQUALS_OFFSET UNITYSDK_OFFSET(0x195B1FD0)
#define CLASS_1_1212C47FC4BC6471_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195B2150)
#define CLASS_1_1212C47FC4BC6471_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195B27B0)
#define CLASS_1_1212C47FC4BC6471_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195B2730)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x195B1F40)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x195B1F60)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x195B1F80)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x195B1F20)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x195B1FB0)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x195B1FC0)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x195B1DC0)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x195B1F50)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x195B1F70)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x195B1F90)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x195B1F30)
#define CLASS_1_1212C47FC4BC6471_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x195B1FA0)
#define CLASS_1_1212C47FC4BC6471_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195B1DF0)
#define CLASS_1_1212C47FC4BC6471_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195B2270)
#define CLASS_1_1212C47FC4BC6471_WRITETO_OFFSET UNITYSDK_OFFSET(0x195B22D0)
#define CLASS_1_1212C47FC4BC6471__CCTOR_OFFSET UNITYSDK_OFFSET(0x195B28D0)
#define CLASS_1_1212C47FC4BC6471__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195B1E50)
#define CLASS_1_1212C47FC4BC6471__CTOR_OFFSET UNITYSDK_OFFSET(0x195B1E00)

inline static constexpr unsigned int Class_1_1212C47FC4BC6471_TypeDefinitionIndex = 29606;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1212C47FC4BC6471_TypeDefinitionIndex)->GetStaticField(0x4DED0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_1212C47FC4BC6471*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_1212C47FC4BC6471*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1212C47FC4BC6471_TypeDefinitionIndex)->GetStaticField(0x4DED8);
	}
	...
	::Enum_3_0A3761FE34514D6C_48 Field_1_11; // 0x30
