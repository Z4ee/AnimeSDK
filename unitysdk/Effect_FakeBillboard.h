...
#define EFFECT_FAKEBILLBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF2F4BA0)
#define EFFECT_FAKEBILLBOARD_RESET_OFFSET UNITYSDK_OFFSET(0xF2F4800)
#define EFFECT_FAKEBILLBOARD_START_OFFSET UNITYSDK_OFFSET(0xF2F4BF0)
#define EFFECT_FAKEBILLBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xF2F4C40)
#define EFFECT_FAKEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xF2F5200)

inline static constexpr unsigned int Effect_FakeBillboard_TypeDefinitionIndex = 44200;
