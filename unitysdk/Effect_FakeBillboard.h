...
#define EFFECT_FAKEBILLBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1357B830)
#define EFFECT_FAKEBILLBOARD_RESET_OFFSET UNITYSDK_OFFSET(0x1357B480)
#define EFFECT_FAKEBILLBOARD_START_OFFSET UNITYSDK_OFFSET(0x1357B880)
#define EFFECT_FAKEBILLBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x1357B8D0)
#define EFFECT_FAKEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1357BE70)

inline static constexpr unsigned int Effect_FakeBillboard_TypeDefinitionIndex = 44746;
