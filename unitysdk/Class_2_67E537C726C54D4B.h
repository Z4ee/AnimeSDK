...
#define CLASS_2_67E537C726C54D4B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x129886C0)
#define CLASS_2_67E537C726C54D4B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x129885D0)
#define CLASS_2_67E537C726C54D4B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12988670)
#define CLASS_2_67E537C726C54D4B_TICK_OFFSET UNITYSDK_OFFSET(0x12988700)
#define CLASS_2_67E537C726C54D4B__CTOR_OFFSET UNITYSDK_OFFSET(0x129885C0)

inline static constexpr unsigned int Class_2_67E537C726C54D4B_TypeDefinitionIndex = 53697;

class Class_2_67E537C726C54D4B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyShowSwitchTransition* Field_2_1; // 0x18
