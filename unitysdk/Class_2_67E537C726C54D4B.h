...
#define CLASS_2_67E537C726C54D4B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x152136A0)
#define CLASS_2_67E537C726C54D4B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x152135B0)
#define CLASS_2_67E537C726C54D4B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15213650)
#define CLASS_2_67E537C726C54D4B_TICK_OFFSET UNITYSDK_OFFSET(0x152136E0)
#define CLASS_2_67E537C726C54D4B__CTOR_OFFSET UNITYSDK_OFFSET(0x152135A0)
...
{
public:
	::RPG::GameCore::MonopolyShowSwitchTransition* OFKGLJOAMLD; // 0x18
