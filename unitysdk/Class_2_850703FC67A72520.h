...
#define CLASS_2_850703FC67A72520_DISPOSE_OFFSET UNITYSDK_OFFSET(0x156A8700)
#define CLASS_2_850703FC67A72520_METHOD_2_B386444429A36A77_OFFSET UNITYSDK_OFFSET(0x156A8EF0)
#define CLASS_2_850703FC67A72520_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x156A89A0)
#define CLASS_2_850703FC67A72520_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x156A8D60)
#define CLASS_2_850703FC67A72520_TICK_OFFSET UNITYSDK_OFFSET(0x156A8E90)
#define CLASS_2_850703FC67A72520__CTOR_OFFSET UNITYSDK_OFFSET(0x156A8590)
...
public:
	...
	::Class_3_07C3C4D2990C49EE* OMODOLBKBNA; // 0x18
	::RPG::GameCore::ShowDeleteMissionDialog* OFKGLJOAMLD; // 0x20
	::Class_3_07C3C4D2990C49EE* HBLGHOCOHAL; // 0x28
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x30
	::Class_3_07C3C4D2990C49EE* JBCCBPBBAIJ; // 0x38
