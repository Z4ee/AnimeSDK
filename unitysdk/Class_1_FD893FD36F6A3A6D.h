...
#define CLASS_1_FD893FD36F6A3A6D_GET_COLLIDERA_OFFSET UNITYSDK_OFFSET(0x18D3E4C0)
#define CLASS_1_FD893FD36F6A3A6D_GET_COLLIDERB_OFFSET UNITYSDK_OFFSET(0x18D3E4E0)
#define CLASS_1_FD893FD36F6A3A6D_SET_COLLIDERA_OFFSET UNITYSDK_OFFSET(0x18D3E4D0)
#define CLASS_1_FD893FD36F6A3A6D_SET_COLLIDERB_OFFSET UNITYSDK_OFFSET(0x18D3E4F0)
#define CLASS_1_FD893FD36F6A3A6D__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3E500)

inline static constexpr unsigned int Class_1_FD893FD36F6A3A6D_TypeDefinitionIndex = 35005;

class Class_1_FD893FD36F6A3A6D : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_30* _ColliderA_k__BackingField; // 0x10
	::Class_0_16E4307DCC419505_30* _ColliderB_k__BackingField; // 0x18
