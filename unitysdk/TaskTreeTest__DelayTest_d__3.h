...
#define TASKTREETEST__DELAYTEST_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xF2A7B00)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF2A7C10)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF2A7C70)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xF2A7C20)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF2A7AF0)
#define TASKTREETEST__DELAYTEST_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0xF2A7AE0)

inline static constexpr unsigned int TaskTreeTest__DelayTest_d__3_TypeDefinitionIndex = 65430;
