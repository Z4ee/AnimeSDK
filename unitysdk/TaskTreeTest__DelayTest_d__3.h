...
#define TASKTREETEST__DELAYTEST_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A515EF0)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A516000)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A516060)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A516010)
#define TASKTREETEST__DELAYTEST_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A515EE0)
#define TASKTREETEST__DELAYTEST_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A515ED0)

inline static constexpr unsigned int TaskTreeTest__DelayTest_d__3_TypeDefinitionIndex = 76081;
