...
#define STAGEHARMONYFLOATDEMODULATOR_METHOD_3_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x197EB810)
#define STAGEHARMONYFLOATDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0x197EB8A0)
#define STAGEHARMONYFLOATDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x197EA1D0)

inline static constexpr unsigned int StageHarmonyFloatDemodulator_TypeDefinitionIndex = 47987;
