...
#define CLASS_1_5B567C8A01BAEDFE_253_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DE91C90)
#define CLASS_1_5B567C8A01BAEDFE_253_CLONE_OFFSET UNITYSDK_OFFSET(0x1DE91980)
#define CLASS_1_5B567C8A01BAEDFE_253_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DE91A90)
#define CLASS_1_5B567C8A01BAEDFE_253_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DE919C0)
#define CLASS_1_5B567C8A01BAEDFE_253_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DE91BF0)
#define CLASS_1_5B567C8A01BAEDFE_253_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DE91CE0)
#define CLASS_1_5B567C8A01BAEDFE_253_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DE91CB0)
#define CLASS_1_5B567C8A01BAEDFE_253_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DE91900)
#define CLASS_1_5B567C8A01BAEDFE_253_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DE91930)
#define CLASS_1_5B567C8A01BAEDFE_253_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DE91C20)
#define CLASS_1_5B567C8A01BAEDFE_253_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DE91C80)
#define CLASS_1_5B567C8A01BAEDFE_253__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE91D30)
#define CLASS_1_5B567C8A01BAEDFE_253__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE91950)
#define CLASS_1_5B567C8A01BAEDFE_253__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE91940)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_253_TypeDefinitionIndex = 31336;

class Class_1_5B567C8A01BAEDFE_253 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_253*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_253*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_253_TypeDefinitionIndex)->GetStaticField(0x36560);
	}
