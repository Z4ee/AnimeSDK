...
#define CLASS_2_AB77020A6EAD0CE6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11DC2DE0)
#define CLASS_2_AB77020A6EAD0CE6_METHOD_2_B00A1D822E6F5C31_OFFSET UNITYSDK_OFFSET(0x11DC3960)
#define CLASS_2_AB77020A6EAD0CE6_METHOD_2_B06F516E4459C742_OFFSET UNITYSDK_OFFSET(0x11DC2E30)
#define CLASS_2_AB77020A6EAD0CE6_METHOD_2_B2075E9BC242D024_OFFSET UNITYSDK_OFFSET(0x11DC3290)
#define CLASS_2_AB77020A6EAD0CE6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11DC3020)
#define CLASS_2_AB77020A6EAD0CE6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11DC38B0)
#define CLASS_2_AB77020A6EAD0CE6_TICK_OFFSET UNITYSDK_OFFSET(0x11DC3900)
#define CLASS_2_AB77020A6EAD0CE6__CTOR_OFFSET UNITYSDK_OFFSET(0x11DB9060)

inline static constexpr unsigned int Class_2_AB77020A6EAD0CE6_TypeDefinitionIndex = 48289;

class Class_2_AB77020A6EAD0CE6 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::MarbleWaitBattleInput* Field_2_0; // 0x20
