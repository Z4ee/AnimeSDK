...
#define CLASS_1_5B567C8A01BAEDFE_336_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C69AC40)
#define CLASS_1_5B567C8A01BAEDFE_336_CLONE_OFFSET UNITYSDK_OFFSET(0x1C69A8E0)
#define CLASS_1_5B567C8A01BAEDFE_336_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C69AA40)
#define CLASS_1_5B567C8A01BAEDFE_336_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C69A950)
#define CLASS_1_5B567C8A01BAEDFE_336_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C69ABA0)
#define CLASS_1_5B567C8A01BAEDFE_336_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C69AC90)
#define CLASS_1_5B567C8A01BAEDFE_336_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C69AC60)
#define CLASS_1_5B567C8A01BAEDFE_336_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C69A830)
#define CLASS_1_5B567C8A01BAEDFE_336_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C69A890)
#define CLASS_1_5B567C8A01BAEDFE_336_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C69ABD0)
#define CLASS_1_5B567C8A01BAEDFE_336_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C69AC30)
#define CLASS_1_5B567C8A01BAEDFE_336__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C69ACE0)
#define CLASS_1_5B567C8A01BAEDFE_336__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C69A8B0)
#define CLASS_1_5B567C8A01BAEDFE_336__CTOR_OFFSET UNITYSDK_OFFSET(0x1C69A8A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_336_TypeDefinitionIndex = 32943;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_336*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_336_TypeDefinitionIndex)->GetStaticField(0x30C40);
	}
