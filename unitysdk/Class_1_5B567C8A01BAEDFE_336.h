...
#define CLASS_1_5B567C8A01BAEDFE_336_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19BDEA60)
#define CLASS_1_5B567C8A01BAEDFE_336_CLONE_OFFSET UNITYSDK_OFFSET(0x19BDE870)
#define CLASS_1_5B567C8A01BAEDFE_336_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19BDE970)
#define CLASS_1_5B567C8A01BAEDFE_336_EQUALS_OFFSET UNITYSDK_OFFSET(0x19BDE8E0)
#define CLASS_1_5B567C8A01BAEDFE_336_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19BDE9C0)
#define CLASS_1_5B567C8A01BAEDFE_336_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19BDEAB0)
#define CLASS_1_5B567C8A01BAEDFE_336_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19BDEA80)
#define CLASS_1_5B567C8A01BAEDFE_336_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19BDE7C0)
#define CLASS_1_5B567C8A01BAEDFE_336_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19BDE820)
#define CLASS_1_5B567C8A01BAEDFE_336_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BDE9F0)
#define CLASS_1_5B567C8A01BAEDFE_336_WRITETO_OFFSET UNITYSDK_OFFSET(0x19BDEA50)
#define CLASS_1_5B567C8A01BAEDFE_336__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BDEB00)
#define CLASS_1_5B567C8A01BAEDFE_336__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BDE840)
#define CLASS_1_5B567C8A01BAEDFE_336__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDE830)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_336_TypeDefinitionIndex = 32107;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_336*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_336_TypeDefinitionIndex)->GetStaticField(0x52E00);
	}
