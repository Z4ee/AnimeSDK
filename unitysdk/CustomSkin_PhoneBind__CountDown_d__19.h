...
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12D8A130)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12D8A290)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12D8A2F0)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12D8A2A0)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12D8A120)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x12D8A110)

inline static constexpr unsigned int CustomSkin_PhoneBind__CountDown_d__19_TypeDefinitionIndex = 53578;
