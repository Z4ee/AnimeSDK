...
#define CLASS_1_3DB71A4B8D828D1B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B32C50)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_064BC9871C6026C0_OFFSET UNITYSDK_OFFSET(0x18B35D50)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_132A2FBBBB8FD3A3_1_OFFSET UNITYSDK_OFFSET(0x18B364E0)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_132A2FBBBB8FD3A3_OFFSET UNITYSDK_OFFSET(0x18B34B50)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_30C2A714A5E816AB_OFFSET UNITYSDK_OFFSET(0x18B32D20)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_438FFC8DA5059CF3_OFFSET UNITYSDK_OFFSET(0x18B36980)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_4CD2BDB36AC8F127_OFFSET UNITYSDK_OFFSET(0x18B33600)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_65350E5368E0F060_OFFSET UNITYSDK_OFFSET(0x18B366E0)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_73A12C1FFADBD599_OFFSET UNITYSDK_OFFSET(0x18B32CA0)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_749D4B1DE36F3C32_OFFSET UNITYSDK_OFFSET(0x18B35940)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_7CBBD4843E0175E9_OFFSET UNITYSDK_OFFSET(0x18B34D50)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_854A0A1166AA067A_OFFSET UNITYSDK_OFFSET(0x18B34110)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_CD210EEA0CFC3079_OFFSET UNITYSDK_OFFSET(0x18B35C50)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_D04C0E623C5FB3BE_OFFSET UNITYSDK_OFFSET(0x18B35EC0)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_DD117A6748B623C3_OFFSET UNITYSDK_OFFSET(0x18B33780)
#define CLASS_1_3DB71A4B8D828D1B_METHOD_1_DF82F5E0575C4F9E_OFFSET UNITYSDK_OFFSET(0x18B357E0)
#define CLASS_1_3DB71A4B8D828D1B__CTOR_OFFSET UNITYSDK_OFFSET(0x18B32C40)

inline static constexpr unsigned int Class_1_3DB71A4B8D828D1B_TypeDefinitionIndex = 34963;

class Class_1_3DB71A4B8D828D1B : public ::System::Object
{
public:
	::Class_2_F3C45F1FC7349B6E* Field_1_0; // 0x10
	::Class_2_FBC1E64DC5B2C441* Field_1_1; // 0x18
	::Class_2_3616FDE8A71D0590_2* Field_1_2; // 0x20

	::System::Void _ctor(::Class_2_FBC1E64DC5B2C441* a1, ::Class_2_F3C45F1FC7349B6E* a2, ::Class_2_3616FDE8A71D0590_2* a3)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_FBC1E64DC5B2C441*, ::Class_2_F3C45F1FC7349B6E*, ::Class_2_3616FDE8A71D0590_2*))((::PBYTE)hIl2Cpp + CLASS_1_3DB71A4B8D828D1B__CTOR_OFFSET))(this, a1, a2, a3);
	}
