...
#define CLASS_2_F8C893847DC1857A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15579620)
#define CLASS_2_F8C893847DC1857A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15579660)
#define CLASS_2_F8C893847DC1857A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15579710)
#define CLASS_2_F8C893847DC1857A_TICK_OFFSET UNITYSDK_OFFSET(0x15579750)
#define CLASS_2_F8C893847DC1857A__CTOR_OFFSET UNITYSDK_OFFSET(0x15579610)

inline static constexpr unsigned int Class_2_F8C893847DC1857A_TypeDefinitionIndex = 56094;

class Class_2_F8C893847DC1857A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::StartChimeraWorkRound* Field_2_1; // 0x20
