...
#define CLASS_2_FAF1235429627B3D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8766C80)
#define CLASS_2_FAF1235429627B3D_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x8766E20)
#define CLASS_2_FAF1235429627B3D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8766D10)
#define CLASS_2_FAF1235429627B3D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8766D70)
#define CLASS_2_FAF1235429627B3D_TICK_OFFSET UNITYSDK_OFFSET(0x8766DC0)
#define CLASS_2_FAF1235429627B3D__CTOR_OFFSET UNITYSDK_OFFSET(0x8766C00)

inline static constexpr unsigned int Class_2_FAF1235429627B3D_TypeDefinitionIndex = 47578;
