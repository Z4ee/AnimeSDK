...
#define TAPTAP_SDK_MINIJSON_JSON_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x187807D0)
#define TAPTAP_SDK_MINIJSON_JSON_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x18781F30)

namespace TapTap::Sdk::MiniJSON
{
	inline static constexpr unsigned int Json_TypeDefinitionIndex = 6433;
