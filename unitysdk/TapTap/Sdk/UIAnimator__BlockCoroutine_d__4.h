...
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B027F80)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B027FF0)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B028050)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B028000)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B027F70)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B027F30)
