...
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB614C0)
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB614F0)
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB60FB0)
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB614B0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int LoginManager_OnLoginResult_TypeDefinitionIndex = 9481;
