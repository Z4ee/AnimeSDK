...
#define TAPTAP_SDK_UIANIMATOR___C__DISPLAYCLASS3_0__BLOCKFORSECOND_B__0_OFFSET UNITYSDK_OFFSET(0x1A1C3B80)
#define TAPTAP_SDK_UIANIMATOR___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C3830)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int UIAnimator___c__DisplayClass3_0_TypeDefinitionIndex = 6456;
