...
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYEXIT_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18780B60)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYEXIT_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18780CC0)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYEXIT_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18780D20)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYEXIT_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18780CD0)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYEXIT_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18780B50)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYEXIT_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x187808F0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int ContainerWindow__PlayExit_d__2_TypeDefinitionIndex = 6411;
