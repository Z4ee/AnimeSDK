...
#define TAPTAP_SDK_UTILS_NET__POST_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1878DA90)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1878E3C0)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1878E420)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1878E3D0)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1878DA80)
#define TAPTAP_SDK_UTILS_NET__POST_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1878C560)
