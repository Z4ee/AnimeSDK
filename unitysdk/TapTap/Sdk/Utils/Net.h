...
#define TAPTAP_SDK_UTILS_NET_DICTTOQUERYSTRING_OFFSET UNITYSDK_OFFSET(0x1878C960)
#define TAPTAP_SDK_UTILS_NET_GETASYNC_OFFSET UNITYSDK_OFFSET(0x18785F70)
#define TAPTAP_SDK_UTILS_NET_GETRESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1878C570)
#define TAPTAP_SDK_UTILS_NET_GET_OFFSET UNITYSDK_OFFSET(0x1878C4E0)
#define TAPTAP_SDK_UTILS_NET_PARSERESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1878C760)
#define TAPTAP_SDK_UTILS_NET_PARSEURL_OFFSET UNITYSDK_OFFSET(0x1878CD60)
#define TAPTAP_SDK_UTILS_NET_POSTASYNC_OFFSET UNITYSDK_OFFSET(0x18786060)
#define TAPTAP_SDK_UTILS_NET_POST_OFFSET UNITYSDK_OFFSET(0x1878C470)
#define TAPTAP_SDK_UTILS_NET__CTOR_OFFSET UNITYSDK_OFFSET(0x1878D2A0)

namespace TapTap::Sdk::Utils
{
	inline static constexpr unsigned int Net_TypeDefinitionIndex = 6437;
