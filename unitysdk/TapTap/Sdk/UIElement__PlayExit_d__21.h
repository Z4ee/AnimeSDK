...
#define TAPTAP_SDK_UIELEMENT__PLAYEXIT_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D1DEBA0)
#define TAPTAP_SDK_UIELEMENT__PLAYEXIT_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D1DF100)
#define TAPTAP_SDK_UIELEMENT__PLAYEXIT_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D1DF160)
#define TAPTAP_SDK_UIELEMENT__PLAYEXIT_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D1DF110)
#define TAPTAP_SDK_UIELEMENT__PLAYEXIT_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D1DEB90)
#define TAPTAP_SDK_UIELEMENT__PLAYEXIT_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DE530)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int UIElement__PlayExit_d__21_TypeDefinitionIndex = 7073;

	class UIElement__PlayExit_d__21 : public ::System::Object
	{
	public:
		::TapTap::Sdk::UIElement* __4__this; // 0x10
		::System::Object* __2__current; // 0x18
		::UnityEngine::RectTransform* _rectTransform_5__5; // 0x20
		::UnityEngine::CanvasGroup* _canvasGroup_5__4; // 0x28
