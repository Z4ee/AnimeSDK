...
#define TAPTAP_SDK_UIANIMATOR_ACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18789CA0)
#define TAPTAP_SDK_UIANIMATOR_ACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18789CD0)
#define TAPTAP_SDK_UIANIMATOR_ACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x187898E0)
#define TAPTAP_SDK_UIANIMATOR_ACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18789860)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int UIAnimator_Action_TypeDefinitionIndex = 6422;
