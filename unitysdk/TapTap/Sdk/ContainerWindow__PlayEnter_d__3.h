...
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BB5FFA0)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BB600F0)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BB60150)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BB60100)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BB5FF90)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB5FEC0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int ContainerWindow__PlayEnter_d__3_TypeDefinitionIndex = 9464;
