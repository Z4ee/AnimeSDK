...
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D1DD190)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D1DDA20)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D1DDA80)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D1DDA30)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D1DD180)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DA5F0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int QRCodeWindow__AutoCheck_d__38_TypeDefinitionIndex = 7064;
