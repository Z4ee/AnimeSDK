...
#define CLASS_1_C84A84118567060F_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBCD4A20)
#define CLASS_1_C84A84118567060F_GET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0xBCD4620)
#define CLASS_1_C84A84118567060F_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0xBCD4630)
#define CLASS_1_C84A84118567060F_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0xBCD4640)
#define CLASS_1_C84A84118567060F_METHOD_1_0AED1827146A0936_OFFSET UNITYSDK_OFFSET(0xBCD4F40)
#define CLASS_1_C84A84118567060F_METHOD_1_283129C30296ABB9_OFFSET UNITYSDK_OFFSET(0xBCD4B70)
#define CLASS_1_C84A84118567060F_METHOD_1_3D42765ED80D6DAA_OFFSET UNITYSDK_OFFSET(0xBCD4E20)
#define CLASS_1_C84A84118567060F_METHOD_1_59EB6225A2B14619_OFFSET UNITYSDK_OFFSET(0xBCD5320)
#define CLASS_1_C84A84118567060F_METHOD_1_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xBCD45A0)
#define CLASS_1_C84A84118567060F_METHOD_1_7FD7D34994C88765_OFFSET UNITYSDK_OFFSET(0xBCD47A0)
#define CLASS_1_C84A84118567060F_METHOD_1_85D7F5EB6E87657A_OFFSET UNITYSDK_OFFSET(0xBCD5150)
#define CLASS_1_C84A84118567060F_METHOD_1_88CDD56924254E8F_OFFSET UNITYSDK_OFFSET(0xBCD5450)
#define CLASS_1_C84A84118567060F_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xBCD5A60)
#define CLASS_1_C84A84118567060F_METHOD_1_BD2B5FECFD1C7933_OFFSET UNITYSDK_OFFSET(0xBCD4FE0)
#define CLASS_1_C84A84118567060F_METHOD_1_DE2BC44ACB86CE8C_1_OFFSET UNITYSDK_OFFSET(0xBCD4D50)
#define CLASS_1_C84A84118567060F_METHOD_1_DE2BC44ACB86CE8C_OFFSET UNITYSDK_OFFSET(0xBCD4C80)
#define CLASS_1_C84A84118567060F__CCTOR_OFFSET UNITYSDK_OFFSET(0xBCD5B00)
#define CLASS_1_C84A84118567060F__CTOR_OFFSET UNITYSDK_OFFSET(0xBCD4650)
...
public:
	...
	{
		return (::System::Collections::Generic::Queue_1<::Struct_2_A143022D1701BC76>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C84A84118567060F_TypeDefinitionIndex)->GetStaticField(0x615A0);
	}
	::UnityEngine::Transform* AACNFLDFDOH; // 0x10
	::RPGTools::Octree::Generation::OctreeData* FJCAKOIDONG; // 0x18
	::Class_1_39EE7F862E4AD59A* DEIHMFHLHHD; // 0x20
	::Class_1_F59FDA09B2302BBD* COANEIDOBOG; // 0x28
	::Struct_2_A143022D1701BC76 DHIPFJBEJPI; // 0x30
	::Unity::Collections::NativeArray_1<::Struct_2_37209C6CE609B59C> EJAAFBHDIFE; // 0x40
	::System::Int32 _MaxDepth_k__BackingField; // 0x50
	::System::Single _MaxSize_k__BackingField; // 0x54
	::System::Single _MinSize_k__BackingField; // 0x58
