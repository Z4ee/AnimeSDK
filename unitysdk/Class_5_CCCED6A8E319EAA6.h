...
#define CLASS_5_CCCED6A8E319EAA6_METHOD_5_0BDCE45D5AFF4247_OFFSET UNITYSDK_OFFSET(0x1208D3F0)
#define CLASS_5_CCCED6A8E319EAA6_METHOD_5_1C82B0464A6F73F2_OFFSET UNITYSDK_OFFSET(0x1208D920)
#define CLASS_5_CCCED6A8E319EAA6_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x1208D460)
#define CLASS_5_CCCED6A8E319EAA6_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1208DB30)
#define CLASS_5_CCCED6A8E319EAA6__CTOR_OFFSET UNITYSDK_OFFSET(0x1208DAD0)

inline static constexpr unsigned int Class_5_CCCED6A8E319EAA6_TypeDefinitionIndex = 78094;

class Class_5_CCCED6A8E319EAA6 : public ::Class_4_86126C0ABC4F0231<::MoleMole::Config::ConfigPlayInnerWorldDiffusionAnimation*>
{
public:
	::Class_3_6FA4D205CC40A95D* Field_5_1; // 0x40
	::MoleMole::Config::ConfigPlayInnerWorldDiffusionAnimation* Field_5_0; // 0x48
