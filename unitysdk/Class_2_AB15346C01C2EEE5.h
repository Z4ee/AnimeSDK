...
#define CLASS_2_AB15346C01C2EEE5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BB9E70)
#define CLASS_2_AB15346C01C2EEE5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15BB9FA0)
#define CLASS_2_AB15346C01C2EEE5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15BB9EF0)
#define CLASS_2_AB15346C01C2EEE5_TICK_OFFSET UNITYSDK_OFFSET(0x15BB9F40)
#define CLASS_2_AB15346C01C2EEE5__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB9D80)
...
{
public:
	::RPG::GameCore::StopSummonUnitGameplay* OFKGLJOAMLD; // 0x18
