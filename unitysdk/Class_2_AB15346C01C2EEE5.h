...
#define CLASS_2_AB15346C01C2EEE5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13D2BBD0)
#define CLASS_2_AB15346C01C2EEE5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13D2BD00)
#define CLASS_2_AB15346C01C2EEE5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13D2BC50)
#define CLASS_2_AB15346C01C2EEE5_TICK_OFFSET UNITYSDK_OFFSET(0x13D2BCA0)
#define CLASS_2_AB15346C01C2EEE5__CTOR_OFFSET UNITYSDK_OFFSET(0x13D2BAE0)

inline static constexpr unsigned int Class_2_AB15346C01C2EEE5_TypeDefinitionIndex = 54879;
...
public:
	...
	::RPG::GameCore::StopSummonUnitGameplay* Field_2_2; // 0x28
