...
#define CLASS_1_6DB7D93AF835945E_CLEAR_OFFSET UNITYSDK_OFFSET(0x15460C40)
#define CLASS_1_6DB7D93AF835945E__CTOR_OFFSET UNITYSDK_OFFSET(0x15460C90)
...
public:
	...
	::System::Boolean GECBBOEPHFC; // 0x18
	::RPG::GameCore::PhysicsRigidBodyType GMPGDEINODK; // 0x1C
