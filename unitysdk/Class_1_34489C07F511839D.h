...
#define CLASS_1_34489C07F511839D_GET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x16BAA520)
#define CLASS_1_34489C07F511839D_GET_AICONFIGPATH_OFFSET UNITYSDK_OFFSET(0x16BAA660)
#define CLASS_1_34489C07F511839D_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x16BAA4A0)
#define CLASS_1_34489C07F511839D_GET_DEFAULTUNLOCKTRACENODEPROFILES_OFFSET UNITYSDK_OFFSET(0x16BAA720)
#define CLASS_1_34489C07F511839D_GET_EIDOLONIDS_OFFSET UNITYSDK_OFFSET(0x16BAA620)
#define CLASS_1_34489C07F511839D_GET_ENGLISHNAME_OFFSET UNITYSDK_OFFSET(0x16BAA4E0)
#define CLASS_1_34489C07F511839D_GET_EXPGROUP_OFFSET UNITYSDK_OFFSET(0x16BAA5C0)
#define CLASS_1_34489C07F511839D_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x16BAA470)
#define CLASS_1_34489C07F511839D_GET_JSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x16BAA560)
#define CLASS_1_34489C07F511839D_GET_MAXEIDOLONLEVEL_OFFSET UNITYSDK_OFFSET(0x16BAA600)
#define CLASS_1_34489C07F511839D_GET_MAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x16BAA5E0)
#define CLASS_1_34489C07F511839D_GET_MAXSP_OFFSET UNITYSDK_OFFSET(0x16BAA5A0)
#define CLASS_1_34489C07F511839D_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16BAA4C0)
#define CLASS_1_34489C07F511839D_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0x16BAA580)
#define CLASS_1_34489C07F511839D_GET_PATH_OFFSET UNITYSDK_OFFSET(0x16BAA480)
#define CLASS_1_34489C07F511839D_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x16BAA540)
#define CLASS_1_34489C07F511839D_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x16BAA640)
#define CLASS_1_34489C07F511839D_GET_SPECIALULTRASKILLENERGYLACKTIPS_OFFSET UNITYSDK_OFFSET(0x16BAA6E0)
#define CLASS_1_34489C07F511839D_GET_SPECIALULTRASKILLRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x16BAA6C0)
#define CLASS_1_34489C07F511839D_GET_TRACEANCHORTYPES_OFFSET UNITYSDK_OFFSET(0x16BAA700)
#define CLASS_1_34489C07F511839D_GET_TRACETREEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x16BAA680)
#define CLASS_1_34489C07F511839D_GET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x16BAA6A0)
#define CLASS_1_34489C07F511839D_GET_VOTAG_OFFSET UNITYSDK_OFFSET(0x16BAA500)
#define CLASS_1_34489C07F511839D_SET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x16BAA530)
#define CLASS_1_34489C07F511839D_SET_AICONFIGPATH_OFFSET UNITYSDK_OFFSET(0x16BAA670)
#define CLASS_1_34489C07F511839D_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x16BAA4B0)
#define CLASS_1_34489C07F511839D_SET_DEFAULTUNLOCKTRACENODEPROFILES_OFFSET UNITYSDK_OFFSET(0x16BAA730)
#define CLASS_1_34489C07F511839D_SET_EIDOLONIDS_OFFSET UNITYSDK_OFFSET(0x16BAA630)
#define CLASS_1_34489C07F511839D_SET_ENGLISHNAME_OFFSET UNITYSDK_OFFSET(0x16BAA4F0)
#define CLASS_1_34489C07F511839D_SET_EXPGROUP_OFFSET UNITYSDK_OFFSET(0x16BAA5D0)
#define CLASS_1_34489C07F511839D_SET_JSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x16BAA570)
#define CLASS_1_34489C07F511839D_SET_MAXEIDOLONLEVEL_OFFSET UNITYSDK_OFFSET(0x16BAA610)
#define CLASS_1_34489C07F511839D_SET_MAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x16BAA5F0)
#define CLASS_1_34489C07F511839D_SET_MAXSP_OFFSET UNITYSDK_OFFSET(0x16BAA5B0)
#define CLASS_1_34489C07F511839D_SET_NAME_OFFSET UNITYSDK_OFFSET(0x16BAA4D0)
#define CLASS_1_34489C07F511839D_SET_NATUREID_OFFSET UNITYSDK_OFFSET(0x16BAA590)
#define CLASS_1_34489C07F511839D_SET_PATH_OFFSET UNITYSDK_OFFSET(0x16BAA490)
#define CLASS_1_34489C07F511839D_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x16BAA550)
#define CLASS_1_34489C07F511839D_SET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x16BAA650)
#define CLASS_1_34489C07F511839D_SET_SPECIALULTRASKILLENERGYLACKTIPS_OFFSET UNITYSDK_OFFSET(0x16BAA6F0)
#define CLASS_1_34489C07F511839D_SET_SPECIALULTRASKILLRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x16BAA6D0)
#define CLASS_1_34489C07F511839D_SET_TRACEANCHORTYPES_OFFSET UNITYSDK_OFFSET(0x16BAA710)
#define CLASS_1_34489C07F511839D_SET_TRACETREEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x16BAA690)
#define CLASS_1_34489C07F511839D_SET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x16BAA6B0)
#define CLASS_1_34489C07F511839D_SET_VOTAG_OFFSET UNITYSDK_OFFSET(0x16BAA510)
#define CLASS_1_34489C07F511839D__CTOR_OFFSET UNITYSDK_OFFSET(0x16BAA740)

inline static constexpr unsigned int Class_1_34489C07F511839D_TypeDefinitionIndex = 49605;

class Class_1_34489C07F511839D : public ::System::Object
{
public:
	::System::String* _SpecialUltraSkillResourcePath_k__BackingField; // 0x10
	::System::Collections::Generic::IReadOnlyList_1<::RPG::GameCore::AvatarSkillTreeAnchorType>* _TraceAnchorTypes_k__BackingField; // 0x18
	::System::String* _AIConfigPath_k__BackingField; // 0x20
	::Class_1_35B5591E4067D7D2* _Path_k__BackingField; // 0x28
	::System::String* _JsonConfigPath_k__BackingField; // 0x30
	::System::String* _TraceTreePrefabPath_k__BackingField; // 0x38
	::System::String* _VOTag_k__BackingField; // 0x40
	::System::Collections::Generic::IReadOnlyDictionary_2<::RPG::GameCore::AvatarSkillTreeAnchorType, ::Struct_2_BAC064D277DD99F1>* _DefaultUnlockTraceNodeProfiles_k__BackingField; // 0x48
	::Class_1_A3A2B28DB41BA84A_1* _DamageType_k__BackingField; // 0x50
	::Il2CppArray<::System::UInt32>* _SkillIDs_k__BackingField; // 0x58
	::Il2CppArray<::System::UInt32>* _EidolonIDs_k__BackingField; // 0x60
	::RPG::Client::TextID _Name_k__BackingField; // 0x68
	::RPG::GameCore::FixPoint _MaxSP_k__BackingField; // 0x78
	::System::UInt32 _MaxEidolonLevel_k__BackingField; // 0x80
	::RPG::GameCore::CombatPowerAvatarRarityType _Rarity_k__BackingField; // 0x84
	::RPG::Client::TextID _SpecialUltraSkillEnergyLackTips_k__BackingField; // 0x88
	::System::UInt32 _AdventurePlayerID_k__BackingField; // 0x98
	::RPG::GameCore::AvatarSpecialUltraType _UltraSkillType_k__BackingField; // 0x9C
	::Struct_2_BC950E36747FB4C9 _Identifier_k__BackingField; // 0xA0
	::System::UInt32 _NatureID_k__BackingField; // 0xA8
	::RPG::Client::TextID _EnglishName_k__BackingField; // 0xB0
	::System::UInt32 _MaxPromotionLevel_k__BackingField; // 0xC0
	::System::UInt32 _ExpGroup_k__BackingField; // 0xC4
