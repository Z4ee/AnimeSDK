...
#define LYRAGIPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19F10E30)
#define LYRAGIPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19F110B0)
#define LYRAGIPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19F11120)
#define LYRAGIPASS_UPDATEBAKEDCLIPMAP_OFFSET UNITYSDK_OFFSET(0x19F10E80)
#define LYRAGIPASS_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x19F10F80)
#define LYRAGIPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F10DA0)
#define LYRAGIPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19F11170)
#define LYRAGIPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19F11180)

inline static constexpr unsigned int LyraGIPass_TypeDefinitionIndex = 29612;
