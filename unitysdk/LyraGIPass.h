...
#define LYRAGIPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1C12C5F0)
#define LYRAGIPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C12C870)
#define LYRAGIPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1C12C8E0)
#define LYRAGIPASS_UPDATEBAKEDCLIPMAP_OFFSET UNITYSDK_OFFSET(0x1C12C640)
#define LYRAGIPASS_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1C12C740)
#define LYRAGIPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12C560)
#define LYRAGIPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1C12C930)
#define LYRAGIPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1C12C940)

inline static constexpr unsigned int LyraGIPass_TypeDefinitionIndex = 27242;
