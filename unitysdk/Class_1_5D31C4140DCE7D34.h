...
#define CLASS_1_5D31C4140DCE7D34_METHOD_1_13A4856CD0BBDB3F_OFFSET UNITYSDK_OFFSET(0x1D2F5E30)
#define CLASS_1_5D31C4140DCE7D34__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2F6070)
...
public:
	...
	::RPG::GameCore::SkillDamageRange HJNEHAAIIGI; // 0x18
	::RPG::GameCore::AttackDamageType PAIECOBACKB; // 0x1C
