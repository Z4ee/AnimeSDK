...
#define CARFLOWINTERSECTIONRULEGROUP_METHOD_1_2F8759FF1B07A918_OFFSET UNITYSDK_OFFSET(0x18472D40)
#define CARFLOWINTERSECTIONRULEGROUP_METHOD_1_C6BD7598FB8E5123_OFFSET UNITYSDK_OFFSET(0x18473190)
#define CARFLOWINTERSECTIONRULEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18473220)

inline static constexpr unsigned int CarFlowIntersectionRuleGroup_TypeDefinitionIndex = 45291;
