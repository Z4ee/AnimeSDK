...
#define CLASS_2_E5F4D5325711214C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB7C26E0)
#define CLASS_2_E5F4D5325711214C_METHOD_2_279CBFD53B59C3B1_OFFSET UNITYSDK_OFFSET(0xB7C2AE0)
#define CLASS_2_E5F4D5325711214C_METHOD_2_D24EF79E293914CD_OFFSET UNITYSDK_OFFSET(0xB7C2A10)
#define CLASS_2_E5F4D5325711214C_METHOD_2_E1595FBBE66ADF57_OFFSET UNITYSDK_OFFSET(0xB7C2DD0)
#define CLASS_2_E5F4D5325711214C_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB7C26A0)
#define CLASS_2_E5F4D5325711214C_UPDATE_OFFSET UNITYSDK_OFFSET(0xB7C2720)
#define CLASS_2_E5F4D5325711214C__CTOR_OFFSET UNITYSDK_OFFSET(0xB7C28E0)

inline static constexpr unsigned int Class_2_E5F4D5325711214C_TypeDefinitionIndex = 62127;

class Class_2_E5F4D5325711214C : public ::Foundation::SingletonDisposable_1<::Class_2_E5F4D5325711214C*>
{
public:
	::System::Collections::Generic::Stack_1<::Class_1_5B8C638EC79D460D*>* Field_2_1; // 0x10
	::System::Collections::Generic::List_1<::Class_1_5B8C638EC79D460D*>* Field_2_3; // 0x18
	::System::Collections::Generic::Stack_1<::Class_1_5B8C638EC79D460D*>* Field_2_2; // 0x20
