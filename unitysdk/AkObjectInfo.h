...
#define AKOBJECTINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x1EEE19F0)
#define AKOBJECTINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x1EEE1B50)
#define AKOBJECTINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1EEE13C0)
#define AKOBJECTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EEE11D0)
#define AKOBJECTINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EEE12F0)
#define AKOBJECTINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1EEE1120)
#define AKOBJECTINFO_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1EEE1AA0)
#define AKOBJECTINFO_GET_IDEPTH_OFFSET UNITYSDK_OFFSET(0x1EEE1940)
#define AKOBJECTINFO_GET_OBJID_OFFSET UNITYSDK_OFFSET(0x1EEE1660)
#define AKOBJECTINFO_GET_PARENTID_OFFSET UNITYSDK_OFFSET(0x1EEE17D0)
#define AKOBJECTINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1EEE1170)
#define AKOBJECTINFO_SET_IDEPTH_OFFSET UNITYSDK_OFFSET(0x1EEE1880)
#define AKOBJECTINFO_SET_OBJID_OFFSET UNITYSDK_OFFSET(0x1EEE15A0)
#define AKOBJECTINFO_SET_PARENTID_OFFSET UNITYSDK_OFFSET(0x1EEE1710)
#define AKOBJECTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EEE1C70)
#define AKOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEE1110)
