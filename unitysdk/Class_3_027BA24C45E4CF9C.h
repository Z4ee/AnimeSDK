...
#define CLASS_3_027BA24C45E4CF9C_METHOD_3_2180D7FF19869697_OFFSET UNITYSDK_OFFSET(0x15AC70D0)
#define CLASS_3_027BA24C45E4CF9C_METHOD_3_7F66F1B8686DFE4C_OFFSET UNITYSDK_OFFSET(0x15AC6EF0)
#define CLASS_3_027BA24C45E4CF9C_METHOD_3_C1796D25ED645C75_OFFSET UNITYSDK_OFFSET(0x15AC6FB0)
#define CLASS_3_027BA24C45E4CF9C_METHOD_3_F385090BF8DD2EE6_OFFSET UNITYSDK_OFFSET(0x15AC7320)
#define CLASS_3_027BA24C45E4CF9C_METHOD_3_F48B6E9D83D3B226_OFFSET UNITYSDK_OFFSET(0x15AC7380)
#define CLASS_3_027BA24C45E4CF9C__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC7390)

inline static constexpr unsigned int Class_3_027BA24C45E4CF9C_TypeDefinitionIndex = 76319;

class Class_3_027BA24C45E4CF9C : public ::Class_2_32B3FE2FD3EEDB80
{
public:
	::RPG::Client::LittleGame::Move::MoveState ACHIDNBOBLA; // 0xA8
	...
	::System::Void Method_3_7F66F1B8686DFE4C(::Class_1_63D18ECF87218619_1* a1, ::RPG::Client::LittleGame::Move::MoveState a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_63D18ECF87218619_1*, ::RPG::Client::LittleGame::Move::MoveState))((::PBYTE)hIl2Cpp + CLASS_3_027BA24C45E4CF9C_METHOD_3_7F66F1B8686DFE4C_OFFSET))(this, a1, a2);
	}
