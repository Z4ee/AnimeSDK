...
#define CLASS_1_5B567C8A01BAEDFE_152_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED72390)
#define CLASS_1_5B567C8A01BAEDFE_152_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED72030)
#define CLASS_1_5B567C8A01BAEDFE_152_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED72190)
#define CLASS_1_5B567C8A01BAEDFE_152_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED720A0)
#define CLASS_1_5B567C8A01BAEDFE_152_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED722F0)
#define CLASS_1_5B567C8A01BAEDFE_152_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED723E0)
#define CLASS_1_5B567C8A01BAEDFE_152_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED723B0)
#define CLASS_1_5B567C8A01BAEDFE_152_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1ED71F80)
#define CLASS_1_5B567C8A01BAEDFE_152_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED71FE0)
#define CLASS_1_5B567C8A01BAEDFE_152_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED72320)
#define CLASS_1_5B567C8A01BAEDFE_152_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED72380)
#define CLASS_1_5B567C8A01BAEDFE_152__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED72430)
#define CLASS_1_5B567C8A01BAEDFE_152__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED72000)
#define CLASS_1_5B567C8A01BAEDFE_152__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED71FF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_152_TypeDefinitionIndex = 28990;

class Class_1_5B567C8A01BAEDFE_152 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_152*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_152*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_152_TypeDefinitionIndex)->GetStaticField(0x3BB80);
	}
