...
#define CLASS_1_92CC78806F9A5519_METHOD_1_0F3B83E8B242C33B_OFFSET UNITYSDK_OFFSET(0x153F9730)
#define CLASS_1_92CC78806F9A5519_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x153F9670)
#define CLASS_1_92CC78806F9A5519_METHOD_1_AB87AA9F40D3796C_OFFSET UNITYSDK_OFFSET(0x153F9CD0)
#define CLASS_1_92CC78806F9A5519_METHOD_1_B85C288F4D6EB0E9_OFFSET UNITYSDK_OFFSET(0x153F9A30)
#define CLASS_1_92CC78806F9A5519_METHOD_1_ED0FF1ACB789218B_OFFSET UNITYSDK_OFFSET(0x153F9F50)
#define CLASS_1_92CC78806F9A5519__CCTOR_OFFSET UNITYSDK_OFFSET(0x153FA150)
...
public:
	...
	{
		return (::RPG::GameCore::CharacterLodConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_92CC78806F9A5519_TypeDefinitionIndex)->GetStaticField(0x52BB0);
	}
	static ::RPG::GameCore::EntityRuntimeReplaceArtPrefabConfig** StaticGet_PJMJBNAGAAP()
	{
		return (::RPG::GameCore::EntityRuntimeReplaceArtPrefabConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_92CC78806F9A5519_TypeDefinitionIndex)->GetStaticField(0x52BB8);
	}
	static ::System::Int32* StaticGet_GGKBDIMDCEL()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_92CC78806F9A5519_TypeDefinitionIndex)->GetStaticField(0x11560);
	}
