...
#define CLASS_1_5A3FB8ABB36FB7D1_GET_LEVELINDEX_OFFSET UNITYSDK_OFFSET(0x1525BDB0)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0x1525CF80)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_4D38FB50FCAD9609_OFFSET UNITYSDK_OFFSET(0x1525BD60)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x1525C160)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x1525C8A0)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_933F0E4BCE605077_OFFSET UNITYSDK_OFFSET(0x1525CC50)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1525CEE0)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_B5564E458E796F84_OFFSET UNITYSDK_OFFSET(0x1525BDC0)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_C8AAFD33C151DEE2_OFFSET UNITYSDK_OFFSET(0x1525C9E0)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1525C940)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_E16846F6D6EF4D1B_OFFSET UNITYSDK_OFFSET(0x1525C100)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_EF01F533E14F85F2_OFFSET UNITYSDK_OFFSET(0x1525CD20)
#define CLASS_1_5A3FB8ABB36FB7D1_METHOD_1_F4721F570F07072B_OFFSET UNITYSDK_OFFSET(0x1525C980)
#define CLASS_1_5A3FB8ABB36FB7D1__CTOR_OFFSET UNITYSDK_OFFSET(0x1525BFE0)
...
public:
	...
	::System::Collections::Generic::List_1<::System::UInt32>* BMPNHAJFKMH; // 0x18
	::System::Collections::Generic::IReadOnlyList_1<::Class_1_811C21B122C8082C*>* FBJPIMMIOIL; // 0x20
	::Class_0_16E4307DCC419505_836* DJEBMFEGCHN; // 0x28
	::System::Int32 MDEJNNFFOEH; // 0x30
	::System::Boolean LGCCKKDEONM; // 0x34
	::System::UInt32 HKAHFHHICEN; // 0x38
	::System::UInt32 _LevelIndex_k__BackingField; // 0x3C
