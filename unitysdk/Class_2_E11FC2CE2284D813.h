...
#define CLASS_2_E11FC2CE2284D813_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188C0850)
#define CLASS_2_E11FC2CE2284D813_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188C0890)
#define CLASS_2_E11FC2CE2284D813_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188C0EB0)
#define CLASS_2_E11FC2CE2284D813_TICK_OFFSET UNITYSDK_OFFSET(0x188C0F00)
#define CLASS_2_E11FC2CE2284D813__CTOR_OFFSET UNITYSDK_OFFSET(0x188C0840)

inline static constexpr unsigned int Class_2_E11FC2CE2284D813_TypeDefinitionIndex = 55401;

class Class_2_E11FC2CE2284D813 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifyEntityBoostPoint* OFKGLJOAMLD; // 0x18
