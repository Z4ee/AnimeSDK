...
#define CLASS_3_003CF77BF1B9FCF6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1185FC80)
#define CLASS_3_003CF77BF1B9FCF6_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11860110)
#define CLASS_3_003CF77BF1B9FCF6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1185FD10)
#define CLASS_3_003CF77BF1B9FCF6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11860070)
#define CLASS_3_003CF77BF1B9FCF6__CTOR_OFFSET UNITYSDK_OFFSET(0x1185FBC0)
#define CLASS_3_003CF77BF1B9FCF6___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11860160)

inline static constexpr unsigned int Class_3_003CF77BF1B9FCF6_TypeDefinitionIndex = 42145;

class Class_3_003CF77BF1B9FCF6 : public ::RPG::GameCore::SO_Task_1<::RPG::GameCore::SO_PlayInteractOnPoint*>
{
public:
	::Class_2_6A3F10CE86B200DD_Class_1_DF76A6160DA1EDC0* Field_3_1; // 0x40
	::Class_2_6A3F10CE86B200DD* Field_3_0; // 0x48
