...
#define CLASS_1_D311B9D517905070_METHOD_1_1F29F81CADD13A09_OFFSET UNITYSDK_OFFSET(0x1B2EF540)
#define CLASS_1_D311B9D517905070__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EF9E0)

inline static constexpr unsigned int Class_1_D311B9D517905070_TypeDefinitionIndex = 10847;
...
public:
	...
	::Il2CppArray<::RPG::GameCore::DiceCombatDiceFunctionTag>* Field_1_3; // 0x28
	::RPG::Client::TextID Field_1_4; // 0x30
	::RPG::GameCore::DiceCombatDiceRare Field_1_5; // 0x40
	::RPG::GameCore::DiceCombatDiceType Field_1_6; // 0x44
	::RPG::GameCore::DiceCombatDiceValidTurnType Field_1_7; // 0x48
