...
#define CLASS_2_4DB1DA6CE54D1DB3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17A0C9B0)
#define CLASS_2_4DB1DA6CE54D1DB3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17A0C9F0)
#define CLASS_2_4DB1DA6CE54D1DB3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17A0CA70)
#define CLASS_2_4DB1DA6CE54D1DB3_TICK_OFFSET UNITYSDK_OFFSET(0x17A0CAC0)
#define CLASS_2_4DB1DA6CE54D1DB3__CTOR_OFFSET UNITYSDK_OFFSET(0x17A0C9A0)

inline static constexpr unsigned int Class_2_4DB1DA6CE54D1DB3_TypeDefinitionIndex = 58158;

class Class_2_4DB1DA6CE54D1DB3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterNavigateFollow* OFKGLJOAMLD; // 0x18
