...
#define CLASS_2_DA76A9A749C6373D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17BAA6F0)
#define CLASS_2_DA76A9A749C6373D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17BAA730)
#define CLASS_2_DA76A9A749C6373D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17BAA7B0)
#define CLASS_2_DA76A9A749C6373D_TICK_OFFSET UNITYSDK_OFFSET(0x17BAA800)
#define CLASS_2_DA76A9A749C6373D__CTOR_OFFSET UNITYSDK_OFFSET(0x17BAA6E0)
...
public:
	...
	::RPG::GameCore::ShowAdventureLevelPage* OFKGLJOAMLD; // 0x20
