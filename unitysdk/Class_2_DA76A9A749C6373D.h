...
#define CLASS_2_DA76A9A749C6373D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11982A90)
#define CLASS_2_DA76A9A749C6373D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11982AD0)
#define CLASS_2_DA76A9A749C6373D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11982B50)
#define CLASS_2_DA76A9A749C6373D_TICK_OFFSET UNITYSDK_OFFSET(0x11982BA0)
#define CLASS_2_DA76A9A749C6373D__CTOR_OFFSET UNITYSDK_OFFSET(0x11982A80)

inline static constexpr unsigned int Class_2_DA76A9A749C6373D_TypeDefinitionIndex = 54024;

class Class_2_DA76A9A749C6373D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowAdventureLevelPage* Field_2_0; // 0x18
