...
#define SCEPADTRIGGEREFFECTVIBRATIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x65B810)

inline static constexpr unsigned int ScePadTriggerEffectVibrationParam_TypeDefinitionIndex = 50496;
