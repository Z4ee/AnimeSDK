...
#define CLASS_1_E5C370BBC5B5E897_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E8341B0)
#define CLASS_1_E5C370BBC5B5E897_CLONE_OFFSET UNITYSDK_OFFSET(0x1E833C60)
#define CLASS_1_E5C370BBC5B5E897_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E833D10)
#define CLASS_1_E5C370BBC5B5E897_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E833CE0)
#define CLASS_1_E5C370BBC5B5E897_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E833EF0)
#define CLASS_1_E5C370BBC5B5E897_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E834420)
#define CLASS_1_E5C370BBC5B5E897_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E834320)
#define CLASS_1_E5C370BBC5B5E897_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E833CC0)
#define CLASS_1_E5C370BBC5B5E897_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E833AD0)
#define CLASS_1_E5C370BBC5B5E897_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1E833CA0)
#define CLASS_1_E5C370BBC5B5E897_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1E833C90)
#define CLASS_1_E5C370BBC5B5E897_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1E833CB0)
#define CLASS_1_E5C370BBC5B5E897_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E833CD0)
#define CLASS_1_E5C370BBC5B5E897_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E833B00)
#define CLASS_1_E5C370BBC5B5E897_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E833FE0)
#define CLASS_1_E5C370BBC5B5E897_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E834040)
#define CLASS_1_E5C370BBC5B5E897__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E834660)
#define CLASS_1_E5C370BBC5B5E897__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E833B60)
#define CLASS_1_E5C370BBC5B5E897__CTOR_OFFSET UNITYSDK_OFFSET(0x1E833B10)

inline static constexpr unsigned int Class_1_E5C370BBC5B5E897_TypeDefinitionIndex = 26163;

class Class_1_E5C370BBC5B5E897 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_6583CA3BD82958EC*>** StaticGet_FCNMONMFJEF()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_6583CA3BD82958EC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5C370BBC5B5E897_TypeDefinitionIndex)->GetStaticField(0x31560);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_E5C370BBC5B5E897*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E5C370BBC5B5E897*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5C370BBC5B5E897_TypeDefinitionIndex)->GetStaticField(0x31568);
	}
	// static const ::System::Int32 FHCOJGPKBHG = 0xC; // 0x0
	// static const ::System::Int32 GEJEJNNMGGP = 0x7; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0xD; // 0x0
	::Proto::ItemList* PJGCAOPPIFO; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_6583CA3BD82958EC*>* AFNHANNCAMC; // 0x18
