...
#define SCENEWATERPROXY_BARYCENTRIC_COORDS_OFFSET UNITYSDK_OFFSET(0x1F96DAC0)
#define SCENEWATERPROXY_GETBOUNDINWS_1_OFFSET UNITYSDK_OFFSET(0x1F96EDF0)
#define SCENEWATERPROXY_GETBOUNDINWS_OFFSET UNITYSDK_OFFSET(0x1F96ED40)
#define SCENEWATERPROXY_GETMINMAXV2_OFFSET UNITYSDK_OFFSET(0x1F96DFD0)
#define SCENEWATERPROXY_GETMINMAX_OFFSET UNITYSDK_OFFSET(0x1F96DF50)
#define SCENEWATERPROXY_INTERPOLATE_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1F96DC50)
#define SCENEWATERPROXY_ISPOINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1F96D760)
#define SCENEWATERPROXY_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1F96E030)
#define SCENEWATERPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F96C7D0)
#define SCENEWATERPROXY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F96EAC0)
#define SCENEWATERPROXY_SETWAVECENTERPOS_OFFSET UNITYSDK_OFFSET(0x1F96CB30)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1F96DD10)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_UP_DOWN_OFFSET UNITYSDK_OFFSET(0x1F96D8A0)
#define SCENEWATERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F96F4E0)

inline static constexpr unsigned int SceneWaterProxy_TypeDefinitionIndex = 38710;
