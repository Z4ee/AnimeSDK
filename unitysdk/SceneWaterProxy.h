...
#define SCENEWATERPROXY_BARYCENTRIC_COORDS_OFFSET UNITYSDK_OFFSET(0x1C230700)
#define SCENEWATERPROXY_GETBOUNDINWS_1_OFFSET UNITYSDK_OFFSET(0x1C231A70)
#define SCENEWATERPROXY_GETBOUNDINWS_OFFSET UNITYSDK_OFFSET(0x1C2319C0)
#define SCENEWATERPROXY_GETMINMAXV2_OFFSET UNITYSDK_OFFSET(0x1C230C00)
#define SCENEWATERPROXY_GETMINMAX_OFFSET UNITYSDK_OFFSET(0x1C230B80)
#define SCENEWATERPROXY_INTERPOLATE_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C230890)
#define SCENEWATERPROXY_ISPOINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1C2303A0)
#define SCENEWATERPROXY_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1C230C60)
#define SCENEWATERPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C22F400)
#define SCENEWATERPROXY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C231710)
#define SCENEWATERPROXY_SETWAVECENTERPOS_OFFSET UNITYSDK_OFFSET(0x1C22F750)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1C230980)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_UP_DOWN_OFFSET UNITYSDK_OFFSET(0x1C2304E0)
#define SCENEWATERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C232140)

inline static constexpr unsigned int SceneWaterProxy_TypeDefinitionIndex = 36441;
