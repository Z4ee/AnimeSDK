...
#define CLASS_1_5B567C8A01BAEDFE_27_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A86C050)
#define CLASS_1_5B567C8A01BAEDFE_27_CLONE_OFFSET UNITYSDK_OFFSET(0x1A86BEC0)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A86BF60)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A86BF00)
#define CLASS_1_5B567C8A01BAEDFE_27_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A86BFB0)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A86C0A0)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A86C070)
#define CLASS_1_5B567C8A01BAEDFE_27_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A86BE40)
#define CLASS_1_5B567C8A01BAEDFE_27_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A86BE70)
#define CLASS_1_5B567C8A01BAEDFE_27_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A86BFE0)
#define CLASS_1_5B567C8A01BAEDFE_27_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A86C040)
#define CLASS_1_5B567C8A01BAEDFE_27__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A86C0F0)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A86BE90)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_OFFSET UNITYSDK_OFFSET(0x1A86BE80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex = 24952;

class Class_1_5B567C8A01BAEDFE_27 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_27*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_27*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex)->GetStaticField(0x53CC0);
	}
