...
#define CLASS_1_5B567C8A01BAEDFE_27_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1958A990)
#define CLASS_1_5B567C8A01BAEDFE_27_CLONE_OFFSET UNITYSDK_OFFSET(0x1958A800)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1958A8A0)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_OFFSET UNITYSDK_OFFSET(0x1958A840)
#define CLASS_1_5B567C8A01BAEDFE_27_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1958A8F0)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1958A9E0)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1958A9B0)
#define CLASS_1_5B567C8A01BAEDFE_27_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1958A780)
#define CLASS_1_5B567C8A01BAEDFE_27_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1958A7B0)
#define CLASS_1_5B567C8A01BAEDFE_27_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1958A920)
#define CLASS_1_5B567C8A01BAEDFE_27_WRITETO_OFFSET UNITYSDK_OFFSET(0x1958A980)
#define CLASS_1_5B567C8A01BAEDFE_27__CCTOR_OFFSET UNITYSDK_OFFSET(0x1958AA30)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1958A7D0)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_OFFSET UNITYSDK_OFFSET(0x1958A7C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex = 25089;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_27*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex)->GetStaticField(0x4E270);
	}
