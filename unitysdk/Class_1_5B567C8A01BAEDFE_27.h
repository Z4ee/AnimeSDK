...
#define CLASS_1_5B567C8A01BAEDFE_27_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CC9A9D0)
#define CLASS_1_5B567C8A01BAEDFE_27_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC9A6C0)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CC9A7D0)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC9A700)
#define CLASS_1_5B567C8A01BAEDFE_27_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC9A930)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CC9AA20)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CC9A9F0)
#define CLASS_1_5B567C8A01BAEDFE_27_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CC9A640)
#define CLASS_1_5B567C8A01BAEDFE_27_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CC9A670)
#define CLASS_1_5B567C8A01BAEDFE_27_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC9A960)
#define CLASS_1_5B567C8A01BAEDFE_27_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CC9A9C0)
#define CLASS_1_5B567C8A01BAEDFE_27__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC9AA70)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC9A690)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC9A680)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex = 25449;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_27*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex)->GetStaticField(0x5E760);
	}
