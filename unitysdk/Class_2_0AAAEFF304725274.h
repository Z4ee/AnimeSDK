...
#define CLASS_2_0AAAEFF304725274_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11607DB0)
#define CLASS_2_0AAAEFF304725274_METHOD_2_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0x116083A0)
#define CLASS_2_0AAAEFF304725274_METHOD_2_77577333B4681208_OFFSET UNITYSDK_OFFSET(0x11608C20)
#define CLASS_2_0AAAEFF304725274_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x116082C0)
#define CLASS_2_0AAAEFF304725274_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11607F10)
#define CLASS_2_0AAAEFF304725274_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11608CE0)
#define CLASS_2_0AAAEFF304725274_TICK_OFFSET UNITYSDK_OFFSET(0x116087E0)
#define CLASS_2_0AAAEFF304725274__CTOR_OFFSET UNITYSDK_OFFSET(0x11607840)
...
{
public:
	::Class_1_5F51D4049EA87B7B* FKGNOLNADND; // 0x18
	::RPG::GameCore::AdventureCharacterController* EEMOFHKBEBO; // 0x20
	::Class_2_469A56953483CA0D* JABCHFIIFIC; // 0x28
	::Class_2_A0580152EB393340* EIJAMKAKADD; // 0x30
	::RPG::GameCore::NPCComponent* ACMDKOBBDNJ; // 0x38
	::RPG::GameCore::AdvNPCGuarding* IGHAHBNLIJA; // 0x40
	::Class_1_5F51D4049EA87B7B* NALKHCPNHHK; // 0x48
	::RPG::GameCore::TransformComponent* LMCMCFHLJEJ; // 0x50
	::Class_1_5F51D4049EA87B7B* BFADBJGMBAH; // 0x58
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x60
	::Class_1_5F51D4049EA87B7B* HLBNHHGIKFJ; // 0x68
	::RPG::GameCore::TransformComponent* DPPIHOCPIFH; // 0x70
	::Class_2_F67FF7EB526BF85C* LKNDEOKIEAK; // 0x78
