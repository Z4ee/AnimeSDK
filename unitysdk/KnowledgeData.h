...
#define KNOWLEDGEDATA_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x15C66690)
#define KNOWLEDGEDATA_GETCURPROGRESS_OFFSET UNITYSDK_OFFSET(0x15C66760)
#define KNOWLEDGEDATA_GETMAXPROGRESS_OFFSET UNITYSDK_OFFSET(0x15C668B0)
#define KNOWLEDGEDATA_GETREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x15C66910)
#define KNOWLEDGEDATA_GETREWARDS_OFFSET UNITYSDK_OFFSET(0x15C66850)
#define KNOWLEDGEDATA_GET_QUESTCONFIG_OFFSET UNITYSDK_OFFSET(0x15C66630)
#define KNOWLEDGEDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x15C66610)
#define KNOWLEDGEDATA_GET_SERVERINFO_OFFSET UNITYSDK_OFFSET(0x15C662D0)
#define KNOWLEDGEDATA_ISRED_OFFSET UNITYSDK_OFFSET(0x15C66990)
#define KNOWLEDGEDATA_SET_QUESTID_OFFSET UNITYSDK_OFFSET(0x15C66620)
#define KNOWLEDGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15C66640)

inline static constexpr unsigned int KnowledgeData_TypeDefinitionIndex = 53122;
...
public:
	...
	::Enum_3_4608E37A1B3D374A_18 GetRewardState()
	{
		return ((::Enum_3_4608E37A1B3D374A_18(*)(::PVOID))((::PBYTE)hIl2Cpp + KNOWLEDGEDATA_GETREWARDSTATE_OFFSET))(this);
	}
