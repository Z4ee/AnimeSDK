...
#define CLASS_2_F8F77B7A82F0D634_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEA7E420)
#define CLASS_2_F8F77B7A82F0D634_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xEA7E490)
#define CLASS_2_F8F77B7A82F0D634_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xEA7E620)
#define CLASS_2_F8F77B7A82F0D634_TICK_OFFSET UNITYSDK_OFFSET(0xEA7E670)
#define CLASS_2_F8F77B7A82F0D634__CTOR_OFFSET UNITYSDK_OFFSET(0xEA7E360)

inline static constexpr unsigned int Class_2_F8F77B7A82F0D634_TypeDefinitionIndex = 44566;

class Class_2_F8F77B7A82F0D634 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_5F51D4049EA87B7B* Field_2_2; // 0x18
	::RPG::GameCore::StackCustomUnselectable* Field_2_0; // 0x20
