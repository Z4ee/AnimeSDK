...
#define CLASS_2_F8F77B7A82F0D634_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1177F3E0)
#define CLASS_2_F8F77B7A82F0D634_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1177F450)
#define CLASS_2_F8F77B7A82F0D634_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1177F5F0)
#define CLASS_2_F8F77B7A82F0D634_TICK_OFFSET UNITYSDK_OFFSET(0x1177F640)
#define CLASS_2_F8F77B7A82F0D634__CTOR_OFFSET UNITYSDK_OFFSET(0x1177F320)

inline static constexpr unsigned int Class_2_F8F77B7A82F0D634_TypeDefinitionIndex = 51300;

class Class_2_F8F77B7A82F0D634 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StackCustomUnselectable* Field_2_0; // 0x18
