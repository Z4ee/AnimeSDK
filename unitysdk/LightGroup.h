...
#define LIGHTGROUP_GETLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x128F3EC0)
#define LIGHTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x128F3FA0)

inline static constexpr unsigned int LightGroup_TypeDefinitionIndex = 54270;
