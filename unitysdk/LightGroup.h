...
#define LIGHTGROUP_GETLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x1902AAE0)
#define LIGHTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1902ABC0)

inline static constexpr unsigned int LightGroup_TypeDefinitionIndex = 46945;
