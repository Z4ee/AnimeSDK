...
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2_SETCURVE_OFFSET UNITYSDK_OFFSET(0xD571BD0)
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0xD571C90)
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2___BASE_SETCURVE_OFFSET UNITYSDK_OFFSET(0xD571CA0)

inline static constexpr unsigned int MonoSpecialDamageTextBakeAnimationToolV2_TypeDefinitionIndex = 49631;
