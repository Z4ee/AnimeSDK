...
#define CLASS_2_631094C36C844CC2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1671D790)
#define CLASS_2_631094C36C844CC2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1671DB20)
#define CLASS_2_631094C36C844CC2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1671D830)
#define CLASS_2_631094C36C844CC2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1671DAD0)
#define CLASS_2_631094C36C844CC2_TICK_OFFSET UNITYSDK_OFFSET(0x1671D7D0)
#define CLASS_2_631094C36C844CC2__CTOR_OFFSET UNITYSDK_OFFSET(0x1671D780)

inline static constexpr unsigned int Class_2_631094C36C844CC2_TypeDefinitionIndex = 50879;

class Class_2_631094C36C844CC2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchHandCancelLift* Field_2_0; // 0x18
