...
#define CLASS_2_631094C36C844CC2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8891C40)
#define CLASS_2_631094C36C844CC2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8891EE0)
#define CLASS_2_631094C36C844CC2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8891CE0)
#define CLASS_2_631094C36C844CC2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8891E90)
#define CLASS_2_631094C36C844CC2_TICK_OFFSET UNITYSDK_OFFSET(0x8891C80)
#define CLASS_2_631094C36C844CC2__CTOR_OFFSET UNITYSDK_OFFSET(0x8891C30)

inline static constexpr unsigned int Class_2_631094C36C844CC2_TypeDefinitionIndex = 43162;
