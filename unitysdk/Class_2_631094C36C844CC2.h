...
#define CLASS_2_631094C36C844CC2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A3A310)
#define CLASS_2_631094C36C844CC2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9A3A5B0)
#define CLASS_2_631094C36C844CC2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9A3A3B0)
#define CLASS_2_631094C36C844CC2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9A3A560)
#define CLASS_2_631094C36C844CC2_TICK_OFFSET UNITYSDK_OFFSET(0x9A3A350)
#define CLASS_2_631094C36C844CC2__CTOR_OFFSET UNITYSDK_OFFSET(0x9A3A300)

inline static constexpr unsigned int Class_2_631094C36C844CC2_TypeDefinitionIndex = 49157;
