...
#define CONFIGENTITYJOYSTICKORDER_CHECKMATCH_OFFSET UNITYSDK_OFFSET(0x12D89990)
#define CONFIGENTITYJOYSTICKORDER_HANDLETARGETANGLE_OFFSET UNITYSDK_OFFSET(0x12D89CE0)
#define CONFIGENTITYJOYSTICKORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x12D89D60)

inline static constexpr unsigned int ConfigEntityJoystickOrder_TypeDefinitionIndex = 53793;
...
public:
	...
	::System::Single AngleErrorRange; // 0x24
