...
#define AKBANK_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C3CDCD0)
#define AKBANK_GET_BANKNAME_OFFSET UNITYSDK_OFFSET(0x1C3CDEB0)
#define AKBANK_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1C3CDF10)
#define AKBANK_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1C3CDDE0)
#define AKBANK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C3CDE30)
#define AKBANK_START_OFFSET UNITYSDK_OFFSET(0x1C3CDD40)
#define AKBANK_UNLOADBANK_OFFSET UNITYSDK_OFFSET(0x1C3CDDC0)
#define AKBANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3CE110)

inline static constexpr unsigned int AkBank_TypeDefinitionIndex = 31585;
