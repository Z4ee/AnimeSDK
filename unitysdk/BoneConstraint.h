...
#define BONECONSTRAINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8FCCD10)
#define BONECONSTRAINT_METHOD_5_20042D29B43BCB70_OFFSET UNITYSDK_OFFSET(0x8FCCD80)
#define BONECONSTRAINT_METHOD_5_412F2CEBDE691C81_OFFSET UNITYSDK_OFFSET(0x8FCDC70)
#define BONECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FCDCE0)

inline static constexpr unsigned int BoneConstraint_TypeDefinitionIndex = 38305;
