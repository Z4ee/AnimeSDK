...
#define LEGACYGPUPARTICLEKEYUTILITY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABC0F00)
#define LEGACYGPUPARTICLEKEYUTILITY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABC0BE0)
#define LEGACYGPUPARTICLEKEYUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC12A0)

inline static constexpr unsigned int LegacyGPUParticleKeyUtility_TypeDefinitionIndex = 40526;
