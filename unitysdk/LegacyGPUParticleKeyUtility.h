...
#define LEGACYGPUPARTICLEKEYUTILITY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19D435D0)
#define LEGACYGPUPARTICLEKEYUTILITY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19D432B0)
#define LEGACYGPUPARTICLEKEYUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D43970)

inline static constexpr unsigned int LegacyGPUParticleKeyUtility_TypeDefinitionIndex = 39703;
