...
#define LEGACYGPUPARTICLEKEYUTILITY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x182EF020)
#define LEGACYGPUPARTICLEKEYUTILITY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182EED00)
#define LEGACYGPUPARTICLEKEYUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x182EF3C0)

inline static constexpr unsigned int LegacyGPUParticleKeyUtility_TypeDefinitionIndex = 33902;
