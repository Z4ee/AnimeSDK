...
#define CLASS_1_5B567C8A01BAEDFE_44_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A135610)
#define CLASS_1_5B567C8A01BAEDFE_44_CLONE_OFFSET UNITYSDK_OFFSET(0x1A135420)
#define CLASS_1_5B567C8A01BAEDFE_44_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A135520)
#define CLASS_1_5B567C8A01BAEDFE_44_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A135490)
#define CLASS_1_5B567C8A01BAEDFE_44_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A135570)
#define CLASS_1_5B567C8A01BAEDFE_44_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A135660)
#define CLASS_1_5B567C8A01BAEDFE_44_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A135630)
#define CLASS_1_5B567C8A01BAEDFE_44_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A135370)
#define CLASS_1_5B567C8A01BAEDFE_44_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1353D0)
#define CLASS_1_5B567C8A01BAEDFE_44_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1355A0)
#define CLASS_1_5B567C8A01BAEDFE_44_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A135600)
#define CLASS_1_5B567C8A01BAEDFE_44__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1356B0)
#define CLASS_1_5B567C8A01BAEDFE_44__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1353F0)
#define CLASS_1_5B567C8A01BAEDFE_44__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1353E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_44_TypeDefinitionIndex = 25217;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_44*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_44_TypeDefinitionIndex)->GetStaticField(0x28940);
	}
