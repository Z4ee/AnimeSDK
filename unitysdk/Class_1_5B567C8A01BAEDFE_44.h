...
#define CLASS_1_5B567C8A01BAEDFE_44_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C13C220)
#define CLASS_1_5B567C8A01BAEDFE_44_CLONE_OFFSET UNITYSDK_OFFSET(0x1C13BEC0)
#define CLASS_1_5B567C8A01BAEDFE_44_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C13C020)
#define CLASS_1_5B567C8A01BAEDFE_44_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C13BF30)
#define CLASS_1_5B567C8A01BAEDFE_44_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C13C180)
#define CLASS_1_5B567C8A01BAEDFE_44_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C13C270)
#define CLASS_1_5B567C8A01BAEDFE_44_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C13C240)
#define CLASS_1_5B567C8A01BAEDFE_44_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C13BE10)
#define CLASS_1_5B567C8A01BAEDFE_44_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C13BE70)
#define CLASS_1_5B567C8A01BAEDFE_44_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C13C1B0)
#define CLASS_1_5B567C8A01BAEDFE_44_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C13C210)
#define CLASS_1_5B567C8A01BAEDFE_44__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C13C2C0)
#define CLASS_1_5B567C8A01BAEDFE_44__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C13BE90)
#define CLASS_1_5B567C8A01BAEDFE_44__CTOR_OFFSET UNITYSDK_OFFSET(0x1C13BE80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_44_TypeDefinitionIndex = 25748;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_44*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_44_TypeDefinitionIndex)->GetStaticField(0x5A320);
	}
