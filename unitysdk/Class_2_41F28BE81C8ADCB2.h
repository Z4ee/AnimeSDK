...
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_0986E23AB72F8F9A_OFFSET UNITYSDK_OFFSET(0x155933C0)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_0E6B796A28CF5EAE_OFFSET UNITYSDK_OFFSET(0x15591100)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_1421F30E46CEF39B_OFFSET UNITYSDK_OFFSET(0x15592700)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15592C30)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_443A8FD387045C5D_OFFSET UNITYSDK_OFFSET(0x15591630)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_5E0DBF36D6013B7C_OFFSET UNITYSDK_OFFSET(0x15592C90)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_6D006271A1FDA1A1_OFFSET UNITYSDK_OFFSET(0x15592330)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_70A027EA0E44D24A_OFFSET UNITYSDK_OFFSET(0x155931E0)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x15591A20)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_953E49F323D92B59_OFFSET UNITYSDK_OFFSET(0x155911D0)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_9BABBA0F2D002B8D_OFFSET UNITYSDK_OFFSET(0x15590D60)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_C27BE94DA25FDCAB_OFFSET UNITYSDK_OFFSET(0x15592220)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_C56DC3B2E26040B8_OFFSET UNITYSDK_OFFSET(0x155918B0)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x15592F70)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_CD560E5BE4BF42A4_OFFSET UNITYSDK_OFFSET(0x155932D0)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_D6F475CD34D5DF6B_OFFSET UNITYSDK_OFFSET(0x15591C20)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_D8FD81FB74270BB0_OFFSET UNITYSDK_OFFSET(0x15591270)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_DD1787485F11E4CB_OFFSET UNITYSDK_OFFSET(0x15591440)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_E55CBA084335CA18_OFFSET UNITYSDK_OFFSET(0x15592280)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0x15592FC0)
#define CLASS_2_41F28BE81C8ADCB2_METHOD_2_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x15593540)
#define CLASS_2_41F28BE81C8ADCB2__CCTOR_OFFSET UNITYSDK_OFFSET(0x155936F0)
#define CLASS_2_41F28BE81C8ADCB2__CTOR_OFFSET UNITYSDK_OFFSET(0x155936E0)

inline static constexpr unsigned int Class_2_41F28BE81C8ADCB2_TypeDefinitionIndex = 78652;

class Class_2_41F28BE81C8ADCB2 : public ::Class_1_D22BBD5AAECFE505
{
public:
	static ::System::Int32* StaticGet_JLOOPJJPBLI()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_41F28BE81C8ADCB2_TypeDefinitionIndex)->GetStaticField(0x41D0);
	}
	// static const ::System::Single OLEIDKBKEOE; // 0x0
	::Class_0_16E4307DCC419505_37* EKKFNDCBGHE; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* EBENFPDMCEI; // 0x20
	::Il2CppArray<::FiveDimRenderingItem*>* HCMPGFIMIFH; // 0x28
	::FiveDimRenderingPanelRuntime* JHBKPBHIJPM; // 0x30
	::System::Collections::Generic::List_1<::FiveDimRenderingItem*>* EPJNGDLFCMF; // 0x38
	::RPG::GameCore::FDRIStateMaskEnum LLBADFLDEIA; // 0x40
	::System::Boolean ENNIAANJOFD; // 0x44
	::RPG::Client::LittleGameShare::TeamTowersCore::TeamTowersBrickSpecialViewType OHMCFMNMCEJ; // 0x45
	::System::Boolean BPBMPCPDPNJ; // 0x46
	::System::Single PCOMMLHHNOA; // 0x48
	...
	::System::Void Method_2_9BABBA0F2D002B8D(::Class_0_16E4307DCC419505_37* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_37*))((::PBYTE)hIl2Cpp + CLASS_2_41F28BE81C8ADCB2_METHOD_2_9BABBA0F2D002B8D_OFFSET))(this, a1);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_41F28BE81C8ADCB2_METHOD_2_CCD88C0D86A5A786_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_41F28BE81C8ADCB2_METHOD_2_F0D9B6AAFF504D87_OFFSET))(this);
	}
	...
	::System::Void Method_2_DD1787485F11E4CB(::System::Boolean a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_2_41F28BE81C8ADCB2_METHOD_2_DD1787485F11E4CB_OFFSET))(this, a1);
	}
};
