...
#define MONOEXECUTEBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0xEBDD210)
#define MONOEXECUTEBUTTON_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xEBDD0A0)
#define MONOEXECUTEBUTTON_ONLOCKCORECHANGE_OFFSET UNITYSDK_OFFSET(0xEBDCD10)
#define MONOEXECUTEBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xEBDD190)
#define MONOEXECUTEBUTTON_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0xEBDCC90)
#define MONOEXECUTEBUTTON_UPDATEFORKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0xEBDD0E0)
#define MONOEXECUTEBUTTON_UPDATEKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0xEBDCFD0)
#define MONOEXECUTEBUTTON_UPDATE_OFFSET UNITYSDK_OFFSET(0xEBDD270)
#define MONOEXECUTEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0xEBDD2C0)

inline static constexpr unsigned int MonoExecuteButton_TypeDefinitionIndex = 42311;
