...
#define MONOEXECUTEBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x112ED820)
#define MONOEXECUTEBUTTON_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x112ED6B0)
#define MONOEXECUTEBUTTON_ONLOCKCORECHANGE_OFFSET UNITYSDK_OFFSET(0x112ED320)
#define MONOEXECUTEBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x112ED7A0)
#define MONOEXECUTEBUTTON_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x112ED2A0)
#define MONOEXECUTEBUTTON_UPDATEFORKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0x112ED6F0)
#define MONOEXECUTEBUTTON_UPDATEKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0x112ED5E0)
#define MONOEXECUTEBUTTON_UPDATE_OFFSET UNITYSDK_OFFSET(0x112ED880)
#define MONOEXECUTEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x112ED8D0)

inline static constexpr unsigned int MonoExecuteButton_TypeDefinitionIndex = 78998;
