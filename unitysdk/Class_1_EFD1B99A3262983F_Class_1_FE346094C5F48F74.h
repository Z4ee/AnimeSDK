...
#define CLASS_1_EFD1B99A3262983F_CLASS_1_FE346094C5F48F74_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x125C7470)
#define CLASS_1_EFD1B99A3262983F_CLASS_1_FE346094C5F48F74_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x125C7900)
#define CLASS_1_EFD1B99A3262983F_CLASS_1_FE346094C5F48F74_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x125C7960)
#define CLASS_1_EFD1B99A3262983F_CLASS_1_FE346094C5F48F74_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x125C7910)
#define CLASS_1_EFD1B99A3262983F_CLASS_1_FE346094C5F48F74_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x125C7460)
#define CLASS_1_EFD1B99A3262983F_CLASS_1_FE346094C5F48F74__CTOR_OFFSET UNITYSDK_OFFSET(0x125C7450)

inline static constexpr unsigned int Class_1_EFD1B99A3262983F_Class_1_FE346094C5F48F74_TypeDefinitionIndex = 72182;

class Class_1_EFD1B99A3262983F_Class_1_FE346094C5F48F74 : public ::System::Object
{
public:
	::System::Diagnostics::Stopwatch* Field_1_7; // 0x10
	::UnityEngine::Networking::UnityWebRequestAsyncOperation* Field_1_6; // 0x18
	::Struct_2_32770405D1E18A2A Field_1_3; // 0x20
	::UnityEngine::Networking::UnityWebRequest* Field_1_5; // 0x38
	::MoleMole::ServerListInfo* Field_1_2; // 0x40
