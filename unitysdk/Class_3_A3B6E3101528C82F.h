...
#define CLASS_3_A3B6E3101528C82F_METHOD_3_61929A3103595552_OFFSET UNITYSDK_OFFSET(0x10505C40)
#define CLASS_3_A3B6E3101528C82F_METHOD_3_D0B0E8495E8A13B8_OFFSET UNITYSDK_OFFSET(0x105057B0)
#define CLASS_3_A3B6E3101528C82F_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x10505840)
#define CLASS_3_A3B6E3101528C82F_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x105058D0)
#define CLASS_3_A3B6E3101528C82F__CTOR_OFFSET UNITYSDK_OFFSET(0x10505C90)
#define CLASS_3_A3B6E3101528C82F___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x10505CA0)
#define CLASS_3_A3B6E3101528C82F___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x10505D00)

inline static constexpr unsigned int Class_3_A3B6E3101528C82F_TypeDefinitionIndex = 53479;
...
public:
	...
	::RPG::Client::LittleGame::Match3::OpponentRole Field_3_3; // 0x3C
