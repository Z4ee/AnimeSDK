...
#define CLASS_2_3C52CBA38EA0D0A3_CLEAR_OFFSET UNITYSDK_OFFSET(0x11628B00)
#define CLASS_2_3C52CBA38EA0D0A3_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x11628BC0)
#define CLASS_2_3C52CBA38EA0D0A3_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x11628B70)
#define CLASS_2_3C52CBA38EA0D0A3_METHOD_2_B7A27F8F43AB5662_OFFSET UNITYSDK_OFFSET(0x11628A90)
#define CLASS_2_3C52CBA38EA0D0A3__CTOR_OFFSET UNITYSDK_OFFSET(0x11628C10)

inline static constexpr unsigned int Class_2_3C52CBA38EA0D0A3_TypeDefinitionIndex = 56807;

class Class_2_3C52CBA38EA0D0A3 : public ::Class_1_BF7A075734D15E98
{
public:
	::RPG::GameCore::GameEntity* GIHMOMMHCKC; // 0x18
	::RPG::GameCore::GameEntity* MFIEDDGBIPH; // 0x20
	::RPG::GameCore::STSpecialEventType LHNFFCMKLCE; // 0x28
