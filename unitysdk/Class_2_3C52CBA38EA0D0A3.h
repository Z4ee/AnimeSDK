...
#define CLASS_2_3C52CBA38EA0D0A3_CLEAR_OFFSET UNITYSDK_OFFSET(0x963D910)
#define CLASS_2_3C52CBA38EA0D0A3_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x963D9D0)
#define CLASS_2_3C52CBA38EA0D0A3_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x963D980)
#define CLASS_2_3C52CBA38EA0D0A3_METHOD_2_B7A27F8F43AB5662_OFFSET UNITYSDK_OFFSET(0x963BDB0)
#define CLASS_2_3C52CBA38EA0D0A3__CTOR_OFFSET UNITYSDK_OFFSET(0x963DA20)
#define CLASS_2_3C52CBA38EA0D0A3___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x963DA30)

inline static constexpr unsigned int Class_2_3C52CBA38EA0D0A3_TypeDefinitionIndex = 52177;
