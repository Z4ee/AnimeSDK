...
#define CLASS_1_5B567C8A01BAEDFE_312_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EDB8930)
#define CLASS_1_5B567C8A01BAEDFE_312_CLONE_OFFSET UNITYSDK_OFFSET(0x1EDB8620)
#define CLASS_1_5B567C8A01BAEDFE_312_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EDB8730)
#define CLASS_1_5B567C8A01BAEDFE_312_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EDB8660)
#define CLASS_1_5B567C8A01BAEDFE_312_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EDB8890)
#define CLASS_1_5B567C8A01BAEDFE_312_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EDB8980)
#define CLASS_1_5B567C8A01BAEDFE_312_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EDB8950)
#define CLASS_1_5B567C8A01BAEDFE_312_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EDB85A0)
#define CLASS_1_5B567C8A01BAEDFE_312_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EDB85D0)
#define CLASS_1_5B567C8A01BAEDFE_312_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EDB88C0)
#define CLASS_1_5B567C8A01BAEDFE_312_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EDB8920)
#define CLASS_1_5B567C8A01BAEDFE_312__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EDB89D0)
#define CLASS_1_5B567C8A01BAEDFE_312__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EDB85F0)
#define CLASS_1_5B567C8A01BAEDFE_312__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDB85E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_312_TypeDefinitionIndex = 32931;

class Class_1_5B567C8A01BAEDFE_312 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_312*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_312*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_312_TypeDefinitionIndex)->GetStaticField(0x518C0);
	}
