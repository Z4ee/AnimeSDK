...
#define CLASS_1_5B567C8A01BAEDFE_192_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6A2720)
#define CLASS_1_5B567C8A01BAEDFE_192_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6A2410)
#define CLASS_1_5B567C8A01BAEDFE_192_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6A2520)
#define CLASS_1_5B567C8A01BAEDFE_192_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6A2450)
#define CLASS_1_5B567C8A01BAEDFE_192_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6A2680)
#define CLASS_1_5B567C8A01BAEDFE_192_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6A2770)
#define CLASS_1_5B567C8A01BAEDFE_192_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6A2740)
#define CLASS_1_5B567C8A01BAEDFE_192_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C6A2390)
#define CLASS_1_5B567C8A01BAEDFE_192_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6A23C0)
#define CLASS_1_5B567C8A01BAEDFE_192_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6A26B0)
#define CLASS_1_5B567C8A01BAEDFE_192_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6A2710)
#define CLASS_1_5B567C8A01BAEDFE_192__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6A27C0)
#define CLASS_1_5B567C8A01BAEDFE_192__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6A23E0)
#define CLASS_1_5B567C8A01BAEDFE_192__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6A23D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_192_TypeDefinitionIndex = 29317;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_192*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_192_TypeDefinitionIndex)->GetStaticField(0x31100);
	}
