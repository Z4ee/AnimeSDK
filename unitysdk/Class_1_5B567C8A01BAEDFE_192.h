...
#define CLASS_1_5B567C8A01BAEDFE_192_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A101000)
#define CLASS_1_5B567C8A01BAEDFE_192_CLONE_OFFSET UNITYSDK_OFFSET(0x1A100E70)
#define CLASS_1_5B567C8A01BAEDFE_192_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A100F10)
#define CLASS_1_5B567C8A01BAEDFE_192_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A100EB0)
#define CLASS_1_5B567C8A01BAEDFE_192_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A100F60)
#define CLASS_1_5B567C8A01BAEDFE_192_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A101050)
#define CLASS_1_5B567C8A01BAEDFE_192_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A101020)
#define CLASS_1_5B567C8A01BAEDFE_192_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A100DF0)
#define CLASS_1_5B567C8A01BAEDFE_192_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A100E20)
#define CLASS_1_5B567C8A01BAEDFE_192_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A100F90)
#define CLASS_1_5B567C8A01BAEDFE_192_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A100FF0)
#define CLASS_1_5B567C8A01BAEDFE_192__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1010A0)
#define CLASS_1_5B567C8A01BAEDFE_192__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A100E40)
#define CLASS_1_5B567C8A01BAEDFE_192__CTOR_OFFSET UNITYSDK_OFFSET(0x1A100E30)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_192_TypeDefinitionIndex = 28672;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_192*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_192_TypeDefinitionIndex)->GetStaticField(0x27190);
	}
