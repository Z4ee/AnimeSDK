...
#define CLASS_2_C91A3154842340B5_METHOD_2_57FC422C238CCA4F_OFFSET UNITYSDK_OFFSET(0x1285ED10)
#define CLASS_2_C91A3154842340B5_METHOD_2_60543752498FF59A_OFFSET UNITYSDK_OFFSET(0x1285E550)
#define CLASS_2_C91A3154842340B5_METHOD_2_64B6514CFF8F8D76_OFFSET UNITYSDK_OFFSET(0x1285EA90)
#define CLASS_2_C91A3154842340B5__CTOR_OFFSET UNITYSDK_OFFSET(0x1285E4F0)
#define CLASS_2_C91A3154842340B5__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x1285EAC0)
#define CLASS_2_C91A3154842340B5__ONTICK_OFFSET UNITYSDK_OFFSET(0x1285ECB0)
#define CLASS_2_C91A3154842340B5__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1285EB80)
#define CLASS_2_C91A3154842340B5___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x1285EFF0)
#define CLASS_2_C91A3154842340B5___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x1285F0B0)
#define CLASS_2_C91A3154842340B5___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1285F050)

inline static constexpr unsigned int Class_2_C91A3154842340B5_TypeDefinitionIndex = 66787;

class Class_2_C91A3154842340B5 : public ::RPG::Client::UIController
{
public:
	::System::Single Field_2_1; // 0x180
	::System::Single Field_2_0; // 0x184
	::System::UInt32 Field_2_3; // 0x188
	::System::Boolean Field_2_2; // 0x18C
