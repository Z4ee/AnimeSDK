...
#define CLASS_1_EB1F0EB26D816EA6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16BBFF00)
#define CLASS_1_EB1F0EB26D816EA6_EQUALS_OFFSET UNITYSDK_OFFSET(0x16BC0220)
#define CLASS_1_EB1F0EB26D816EA6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16BC0230)
#define CLASS_1_EB1F0EB26D816EA6_METHOD_1_2D4D274B6A22239A_OFFSET UNITYSDK_OFFSET(0x16BBFFB0)
#define CLASS_1_EB1F0EB26D816EA6_METHOD_1_356E07C40C3C3D55_OFFSET UNITYSDK_OFFSET(0x16BC01F0)
#define CLASS_1_EB1F0EB26D816EA6_METHOD_1_3604BFE2C5097A63_OFFSET UNITYSDK_OFFSET(0x16BBFDD0)
#define CLASS_1_EB1F0EB26D816EA6_METHOD_1_9D84870F000A08DB_OFFSET UNITYSDK_OFFSET(0x16BC02D0)
#define CLASS_1_EB1F0EB26D816EA6_METHOD_1_F8612122A239F8A2_OFFSET UNITYSDK_OFFSET(0x16BC04C0)
#define CLASS_1_EB1F0EB26D816EA6_METHOD_1_FB1818E2C869DF9D_OFFSET UNITYSDK_OFFSET(0x16BC0370)
#define CLASS_1_EB1F0EB26D816EA6__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBFCC0)

inline static constexpr unsigned int Class_1_EB1F0EB26D816EA6_TypeDefinitionIndex = 6551;

class Class_1_EB1F0EB26D816EA6 : public ::System::Object
{
public:
	// static const ::System::Int32 KPHPMPLNHJC = 0x5; // 0x0
	::Class_1_E6FAF468E72DD000* KBDCLCIEDLP; // 0x10
	::System::Int32 FOLGGBCDKAL; // 0x18
	::System::Single PCKJPAIKCEK; // 0x1C
