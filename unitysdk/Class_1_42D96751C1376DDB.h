...
#define CLASS_1_42D96751C1376DDB_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x17201520)
#define CLASS_1_42D96751C1376DDB_GET_MODIFIERCONFIGUIPRIORITY_OFFSET UNITYSDK_OFFSET(0x17201560)
#define CLASS_1_42D96751C1376DDB_GET_MODIFIERHINTLIST_OFFSET UNITYSDK_OFFSET(0x172018A0)
#define CLASS_1_42D96751C1376DDB_GET_MODIFIERINSTANCEUIINDEX_OFFSET UNITYSDK_OFFSET(0x17201580)
#define CLASS_1_42D96751C1376DDB_GET_NAME_OFFSET UNITYSDK_OFFSET(0x172011E0)
#define CLASS_1_42D96751C1376DDB_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x17201540)
#define CLASS_1_42D96751C1376DDB_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x17201770)
#define CLASS_1_42D96751C1376DDB_METHOD_1_2518DCDAD14A2D19_OFFSET UNITYSDK_OFFSET(0x172010D0)
#define CLASS_1_42D96751C1376DDB_METHOD_1_42DF9B5D9091F120_OFFSET UNITYSDK_OFFSET(0x17201200)
#define CLASS_1_42D96751C1376DDB_METHOD_1_46A7A28543076C41_OFFSET UNITYSDK_OFFSET(0x17201420)
#define CLASS_1_42D96751C1376DDB_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x172016C0)
#define CLASS_1_42D96751C1376DDB_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x17201600)
#define CLASS_1_42D96751C1376DDB_METHOD_1_95780ED94B90ED36_2_OFFSET UNITYSDK_OFFSET(0x17201660)
#define CLASS_1_42D96751C1376DDB_METHOD_1_95780ED94B90ED36_3_OFFSET UNITYSDK_OFFSET(0x172017E0)
#define CLASS_1_42D96751C1376DDB_METHOD_1_95780ED94B90ED36_4_OFFSET UNITYSDK_OFFSET(0x17201840)
#define CLASS_1_42D96751C1376DDB_METHOD_1_95780ED94B90ED36_5_OFFSET UNITYSDK_OFFSET(0x172018C0)
#define CLASS_1_42D96751C1376DDB_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x172015A0)
#define CLASS_1_42D96751C1376DDB_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x17201530)
#define CLASS_1_42D96751C1376DDB_SET_MODIFIERCONFIGUIPRIORITY_OFFSET UNITYSDK_OFFSET(0x17201570)
#define CLASS_1_42D96751C1376DDB_SET_MODIFIERHINTLIST_OFFSET UNITYSDK_OFFSET(0x172018B0)
#define CLASS_1_42D96751C1376DDB_SET_MODIFIERINSTANCEUIINDEX_OFFSET UNITYSDK_OFFSET(0x17201590)
#define CLASS_1_42D96751C1376DDB_SET_NAME_OFFSET UNITYSDK_OFFSET(0x172011F0)
#define CLASS_1_42D96751C1376DDB_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x17201550)
#define CLASS_1_42D96751C1376DDB__CTOR_OFFSET UNITYSDK_OFFSET(0x17200FD0)

inline static constexpr unsigned int Class_1_42D96751C1376DDB_TypeDefinitionIndex = 75868;

class Class_1_42D96751C1376DDB : public ::System::Object
{
public:
	// static const ::System::String* Field_1_0; // 0x0
	::System::Collections::Generic::List_1<::Class_1_D126770E0092C973*>* _ModifierHintList_k__BackingField; // 0x10
	::System::WeakReference_1<::RPG::GameCore::TurnBasedModifierInstance*>* Field_1_2; // 0x18
	::System::String* _IconPath_k__BackingField; // 0x20
	::System::Int32 _ModifierConfigUIPriority_k__BackingField; // 0x28
	::System::Int32 _ModifierInstanceUIIndex_k__BackingField; // 0x2C
	::RPG::GameCore::EnumStatusType _Type_k__BackingField; // 0x30
