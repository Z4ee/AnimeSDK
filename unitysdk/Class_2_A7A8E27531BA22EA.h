...
#define CLASS_2_A7A8E27531BA22EA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x108C3200)
#define CLASS_2_A7A8E27531BA22EA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x108C32A0)
#define CLASS_2_A7A8E27531BA22EA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x108C3310)
#define CLASS_2_A7A8E27531BA22EA_TICK_OFFSET UNITYSDK_OFFSET(0x108C3240)
#define CLASS_2_A7A8E27531BA22EA__CTOR_OFFSET UNITYSDK_OFFSET(0x108C31F0)

inline static constexpr unsigned int Class_2_A7A8E27531BA22EA_TypeDefinitionIndex = 47313;
