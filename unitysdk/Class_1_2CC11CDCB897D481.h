...
#define CLASS_1_2CC11CDCB897D481_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E140430)
#define CLASS_1_2CC11CDCB897D481_CLONE_OFFSET UNITYSDK_OFFSET(0x1E140000)
#define CLASS_1_2CC11CDCB897D481_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E140150)
#define CLASS_1_2CC11CDCB897D481_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E1400D0)
#define CLASS_1_2CC11CDCB897D481_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E140250)
#define CLASS_1_2CC11CDCB897D481_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E140600)
#define CLASS_1_2CC11CDCB897D481_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E1405A0)
#define CLASS_1_2CC11CDCB897D481_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E1400B0)
#define CLASS_1_2CC11CDCB897D481_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E140090)
#define CLASS_1_2CC11CDCB897D481_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E13FF20)
#define CLASS_1_2CC11CDCB897D481_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E1400C0)
#define CLASS_1_2CC11CDCB897D481_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E1400A0)
#define CLASS_1_2CC11CDCB897D481_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1E140080)
#define CLASS_1_2CC11CDCB897D481_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E13FF50)
#define CLASS_1_2CC11CDCB897D481_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E1402A0)
#define CLASS_1_2CC11CDCB897D481_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E140300)
#define CLASS_1_2CC11CDCB897D481__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1407D0)
#define CLASS_1_2CC11CDCB897D481__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E13FF90)
#define CLASS_1_2CC11CDCB897D481__CTOR_OFFSET UNITYSDK_OFFSET(0x1E13FF60)

inline static constexpr unsigned int Class_1_2CC11CDCB897D481_TypeDefinitionIndex = 26945;

class Class_1_2CC11CDCB897D481 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_2CC11CDCB897D481*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_2CC11CDCB897D481*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2CC11CDCB897D481_TypeDefinitionIndex)->GetStaticField(0x42970);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>** StaticGet_HADDOONBKGL()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2CC11CDCB897D481_TypeDefinitionIndex)->GetStaticField(0x42978);
	}
	// static const ::System::Int32 BGPFFMJBGEL = 0xD; // 0x0
	// static const ::System::Int32 CNFKMGEHCPF = 0xF; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0x4; // 0x0
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::UInt32>* GNIPELHMPKO; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::UInt32 IGIDCGFPCEJ; // 0x20
