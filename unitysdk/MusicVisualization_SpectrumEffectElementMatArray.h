...
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATARRAY_METHOD_2_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x186F71A0)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATARRAY_METHOD_2_729C27EDE8757DF6_OFFSET UNITYSDK_OFFSET(0x186F75B0)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATARRAY_METHOD_2_8A0C05ECADC6319B_OFFSET UNITYSDK_OFFSET(0x186F7000)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATARRAY_METHOD_2_AA4D8C4B5C05111B_OFFSET UNITYSDK_OFFSET(0x186F7230)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x186F77F0)

inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementMatArray_TypeDefinitionIndex = 45682;
