...
#include "unitysdk/Class_4_0DF44C6A92A6D32F_1_Struct_2_52AD02145F5FCE36_31.h"
...
#define CLASS_4_0DF44C6A92A6D32F_1_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17F1FE90)
#define CLASS_4_0DF44C6A92A6D32F_1_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x17F1FEB0)
#define CLASS_4_0DF44C6A92A6D32F_1_METHOD_4_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x17F1EAD0)
#define CLASS_4_0DF44C6A92A6D32F_1_METHOD_4_C56684D46320D793_OFFSET UNITYSDK_OFFSET(0x17F1ECA0)
#define CLASS_4_0DF44C6A92A6D32F_1_METHOD_4_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x17F1FEA0)
#define CLASS_4_0DF44C6A92A6D32F_1_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x17F1EBC0)
#define CLASS_4_0DF44C6A92A6D32F_1_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x17F1F6A0)
#define CLASS_4_0DF44C6A92A6D32F_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17F1FE70)

inline static constexpr unsigned int Class_4_0DF44C6A92A6D32F_1_TypeDefinitionIndex = 70679;

class Class_4_0DF44C6A92A6D32F_1 : public ::Class_3_9C33AF57B038AFD8<::UnityEngine::Rendering::Universal::PartialBlur*, ::MoleMole::Timeline::PartialBlurBehaviour*>
{
public:
	::System::Boolean Field_4_5; // 0x38
	::System::Boolean Field_4_7; // 0x39
	::System::Boolean Field_4_10; // 0x3A
	::System::Boolean Field_4_9; // 0x3B
	::System::Single Field_4_4; // 0x3C
	::Class_4_0DF44C6A92A6D32F_1_Struct_2_52AD02145F5FCE36_31 Field_4_0; // 0x40
	::System::Single Field_4_6; // 0x68
	::System::Boolean Field_4_11; // 0x6C
	::System::Boolean Field_4_3; // 0x6D
	::System::Boolean Field_4_12; // 0x6E
	::System::Boolean Field_4_1; // 0x6F
	::System::Int32 Field_4_8; // 0x70
	::System::Int32 Field_4_2; // 0x74
