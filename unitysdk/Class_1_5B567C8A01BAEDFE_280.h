...
#define CLASS_1_5B567C8A01BAEDFE_280_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1994C550)
#define CLASS_1_5B567C8A01BAEDFE_280_CLONE_OFFSET UNITYSDK_OFFSET(0x1994C3C0)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1994C460)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_OFFSET UNITYSDK_OFFSET(0x1994C400)
#define CLASS_1_5B567C8A01BAEDFE_280_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1994C4B0)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1994C5A0)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1994C570)
#define CLASS_1_5B567C8A01BAEDFE_280_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1994C340)
#define CLASS_1_5B567C8A01BAEDFE_280_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1994C370)
#define CLASS_1_5B567C8A01BAEDFE_280_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1994C4E0)
#define CLASS_1_5B567C8A01BAEDFE_280_WRITETO_OFFSET UNITYSDK_OFFSET(0x1994C540)
#define CLASS_1_5B567C8A01BAEDFE_280__CCTOR_OFFSET UNITYSDK_OFFSET(0x1994C5F0)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1994C390)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_OFFSET UNITYSDK_OFFSET(0x1994C380)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_280_TypeDefinitionIndex = 30880;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_280*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_280_TypeDefinitionIndex)->GetStaticField(0x5F3A0);
	}
