...
#define CLASS_1_5B567C8A01BAEDFE_280_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C860C60)
#define CLASS_1_5B567C8A01BAEDFE_280_CLONE_OFFSET UNITYSDK_OFFSET(0x1C860950)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C860A60)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C860990)
#define CLASS_1_5B567C8A01BAEDFE_280_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C860BC0)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C860CB0)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C860C80)
#define CLASS_1_5B567C8A01BAEDFE_280_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C8608D0)
#define CLASS_1_5B567C8A01BAEDFE_280_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C860900)
#define CLASS_1_5B567C8A01BAEDFE_280_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C860BF0)
#define CLASS_1_5B567C8A01BAEDFE_280_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C860C50)
#define CLASS_1_5B567C8A01BAEDFE_280__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C860D00)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C860920)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_OFFSET UNITYSDK_OFFSET(0x1C860910)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_280_TypeDefinitionIndex = 31303;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_280*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_280_TypeDefinitionIndex)->GetStaticField(0x18570);
	}
