...
#define CLASS_1_E59740C01A594634_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C2FBD50)
#define CLASS_1_E59740C01A594634_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2FB900)
#define CLASS_1_E59740C01A594634_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C2FBAB0)
#define CLASS_1_E59740C01A594634_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C2FB980)
#define CLASS_1_E59740C01A594634_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C2FBBA0)
#define CLASS_1_E59740C01A594634_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C2FBEB0)
#define CLASS_1_E59740C01A594634_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C2FBE60)
#define CLASS_1_E59740C01A594634_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C2FB950)
#define CLASS_1_E59740C01A594634_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C2FB7B0)
#define CLASS_1_E59740C01A594634_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C2FB960)
#define CLASS_1_E59740C01A594634_METHOD_1_F64A1871C5AC5ACE_OFFSET UNITYSDK_OFFSET(0x1C2FB970)
#define CLASS_1_E59740C01A594634_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C2FB810)
#define CLASS_1_E59740C01A594634_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C2FBBF0)
#define CLASS_1_E59740C01A594634_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C2FBC50)
#define CLASS_1_E59740C01A594634__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2FC080)
#define CLASS_1_E59740C01A594634__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2FB870)
#define CLASS_1_E59740C01A594634__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2FB820)

inline static constexpr unsigned int Class_1_E59740C01A594634_TypeDefinitionIndex = 24723;
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E59740C01A594634_TypeDefinitionIndex)->GetStaticField(0x18440);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_E59740C01A594634*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E59740C01A594634*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E59740C01A594634_TypeDefinitionIndex)->GetStaticField(0x18448);
	}
	// static const ::System::Int32 Field_1_2 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x2; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_4; // 0x10
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::Double>* Field_1_5; // 0x18
