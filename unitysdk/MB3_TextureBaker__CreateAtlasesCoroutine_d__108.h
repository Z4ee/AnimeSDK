...
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_D__108_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F560A20)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_D__108_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F560DF0)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_D__108_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F560E50)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_D__108_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F560E00)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_D__108_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F560A10)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_D__108__CTOR_OFFSET UNITYSDK_OFFSET(0x1F560A00)

inline static constexpr unsigned int MB3_TextureBaker__CreateAtlasesCoroutine_d__108_TypeDefinitionIndex = 94486;
