...
#define STRUCT_2_4385444B69C9D5A6_GETCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x3B72AD0)
#define STRUCT_2_4385444B69C9D5A6_GETDOWNLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x3B72B80)
#define STRUCT_2_4385444B69C9D5A6_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x3B72A80)
#define STRUCT_2_4385444B69C9D5A6_GETLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x3B72C10)
#define STRUCT_2_4385444B69C9D5A6_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x6E30)
#define STRUCT_2_4385444B69C9D5A6_ISNEEDWRITECONTENTHASHFILE_OFFSET UNITYSDK_OFFSET(0x3B72C20)
#define STRUCT_2_4385444B69C9D5A6_ISPATCH_OFFSET UNITYSDK_OFFSET(0x3B729B0)
#define STRUCT_2_4385444B69C9D5A6_ISTMPFILENAMEADDFILEHASH_OFFSET UNITYSDK_OFFSET(0x3B72A30)
#define STRUCT_2_4385444B69C9D5A6_METHOD_2_ECA28171EB4172FF_OFFSET UNITYSDK_OFFSET(0x3B72B30)
#define STRUCT_2_4385444B69C9D5A6_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x2AA0)
#define STRUCT_2_4385444B69C9D5A6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B72C70)
