...
#define PARADOXNOTION_SERVICES_LOGGER_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1D1EF730)
#define PARADOXNOTION_SERVICES_LOGGER_FORWARDTOUNITY_OFFSET UNITYSDK_OFFSET(0x1D1EFF00)
#define PARADOXNOTION_SERVICES_LOGGER_INTERNAL_LOG_OFFSET UNITYSDK_OFFSET(0x1D1EF8C0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1D1DF200)
#define PARADOXNOTION_SERVICES_LOGGER_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1D1DB600)
#define PARADOXNOTION_SERVICES_LOGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1D1EFDF0)
#define PARADOXNOTION_SERVICES_LOGGER_LOG_OFFSET UNITYSDK_OFFSET(0x1D1EF850)
#define PARADOXNOTION_SERVICES_LOGGER_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1D1EF7C0)
#define PARADOXNOTION_SERVICES_LOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D1F0160)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Logger_TypeDefinitionIndex = 30654;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::ParadoxNotion::Services::Logger_LogHandler*>**)Il2CppClass::FromTypeDefinitionIndex(Logger_TypeDefinitionIndex)->GetStaticField(0x249F0);
		}
