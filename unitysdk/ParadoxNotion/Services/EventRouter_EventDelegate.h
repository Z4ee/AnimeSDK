...
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B427A20)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B427A90)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4275C0)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4275B0)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int EventRouter_EventDelegate_TypeDefinitionIndex = 27039;
