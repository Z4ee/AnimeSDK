...
#define PARADOXNOTION_SERVICES_THREADER__THREADMONITOR_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DB9F8C0)
#define PARADOXNOTION_SERVICES_THREADER__THREADMONITOR_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DB9FA10)
#define PARADOXNOTION_SERVICES_THREADER__THREADMONITOR_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DB9FA70)
#define PARADOXNOTION_SERVICES_THREADER__THREADMONITOR_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DB9FA20)
#define PARADOXNOTION_SERVICES_THREADER__THREADMONITOR_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB9F8B0)
#define PARADOXNOTION_SERVICES_THREADER__THREADMONITOR_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9F8A0)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Threader__ThreadMonitor_d__16_TypeDefinitionIndex = 30828;
