...
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC50700)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC50740)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC50180)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC50160)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int EventRouter_CustomEventDelegate_TypeDefinitionIndex = 29142;
