...
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A861BA0)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A861BE0)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A861620)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A861610)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int EventRouter_CustomEventDelegate_TypeDefinitionIndex = 27040;
