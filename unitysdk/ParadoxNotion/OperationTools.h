...
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_1_OFFSET UNITYSDK_OFFSET(0x1D06FD60)
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_OFFSET UNITYSDK_OFFSET(0x1D06EBC0)
#define PARADOXNOTION_OPERATIONTOOLS_GETCOMPARESTRING_OFFSET UNITYSDK_OFFSET(0x1D06E5C0)
#define PARADOXNOTION_OPERATIONTOOLS_GETOPERATIONSTRING_OFFSET UNITYSDK_OFFSET(0x1D06DF30)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_1_OFFSET UNITYSDK_OFFSET(0x1D06E040)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_2_OFFSET UNITYSDK_OFFSET(0x1D070990)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_OFFSET UNITYSDK_OFFSET(0x1D070940)

namespace ParadoxNotion
{
	inline static constexpr unsigned int OperationTools_TypeDefinitionIndex = 29715;
