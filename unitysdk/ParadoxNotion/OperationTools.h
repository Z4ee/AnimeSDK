...
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_1_OFFSET UNITYSDK_OFFSET(0x19860390)
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_OFFSET UNITYSDK_OFFSET(0x1985F1B0)
#define PARADOXNOTION_OPERATIONTOOLS_GETCOMPARESTRING_OFFSET UNITYSDK_OFFSET(0x1985EB80)
#define PARADOXNOTION_OPERATIONTOOLS_GETOPERATIONSTRING_OFFSET UNITYSDK_OFFSET(0x1985E4D0)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_1_OFFSET UNITYSDK_OFFSET(0x1985E5F0)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_2_OFFSET UNITYSDK_OFFSET(0x19860FE0)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_OFFSET UNITYSDK_OFFSET(0x19860F80)

namespace ParadoxNotion
{
	inline static constexpr unsigned int OperationTools_TypeDefinitionIndex = 27573;
