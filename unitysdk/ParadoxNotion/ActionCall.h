...
#define PARADOXNOTION_ACTIONCALL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC4DBA0)
#define PARADOXNOTION_ACTIONCALL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC4DBD0)
#define PARADOXNOTION_ACTIONCALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC48710)
#define PARADOXNOTION_ACTIONCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4DB80)

namespace ParadoxNotion
{
	inline static constexpr unsigned int ActionCall_TypeDefinitionIndex = 30065;
