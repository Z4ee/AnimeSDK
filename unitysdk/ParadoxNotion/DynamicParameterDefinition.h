...
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_ID_OFFSET UNITYSDK_OFFSET(0x1E533C30)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E544CB0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E544CD0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_ID_OFFSET UNITYSDK_OFFSET(0x1E544CA0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1E544CC0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E544CE0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E544C30)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E544C00)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E544D00)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E544CF0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int DynamicParameterDefinition_TypeDefinitionIndex = 30129;
