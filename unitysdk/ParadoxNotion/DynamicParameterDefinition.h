...
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_ID_OFFSET UNITYSDK_OFFSET(0x1D1D7DA0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D1E8F40)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D1E8F60)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_ID_OFFSET UNITYSDK_OFFSET(0x1D1E8F30)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1D1E8F50)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D1E8F70)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D1E8EC0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D1E8E90)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1E8F90)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E8F80)

namespace ParadoxNotion
{
	inline static constexpr unsigned int DynamicParameterDefinition_TypeDefinitionIndex = 29933;
