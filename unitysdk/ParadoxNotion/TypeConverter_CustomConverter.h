...
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADC5160)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADC51A0)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADC4B90)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADC5150)

namespace ParadoxNotion
{
	inline static constexpr unsigned int TypeConverter_CustomConverter_TypeDefinitionIndex = 27215;
