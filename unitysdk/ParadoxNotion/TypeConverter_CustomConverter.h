...
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E54D7C0)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E54D800)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E54D1F0)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E54D7A0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int TypeConverter_CustomConverter_TypeDefinitionIndex = 30562;
