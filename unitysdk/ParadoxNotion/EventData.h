...
#define PARADOXNOTION_EVENTDATA_GET_RECEIVER_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define PARADOXNOTION_EVENTDATA_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x28B580)
#define PARADOXNOTION_EVENTDATA_GET_VALUEBOXED_OFFSET UNITYSDK_OFFSET(0x381840)
#define PARADOXNOTION_EVENTDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x381840)
#define PARADOXNOTION_EVENTDATA_SET_RECEIVER_OFFSET UNITYSDK_OFFSET(0x2E5940)
#define PARADOXNOTION_EVENTDATA_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x381830)
#define PARADOXNOTION_EVENTDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x381850)
#define PARADOXNOTION_EVENTDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9646B0)
#define PARADOXNOTION_EVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9646A0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int EventData_TypeDefinitionIndex = 27653;
