...
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1A85F160)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_FINDREFERENCEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A85F280)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GETROOT_OFFSET UNITYSDK_OFFSET(0x1A85F270)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1A85F140)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A85F130)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_REFERENCE_OFFSET UNITYSDK_OFFSET(0x1A85F120)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_REMOVECHILD_OFFSET UNITYSDK_OFFSET(0x1A85F210)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A85F150)

namespace ParadoxNotion
{
	inline static constexpr unsigned int HierarchyTree_Element_TypeDefinitionIndex = 27207;

	class HierarchyTree_Element : public ::System::Object
	{
	public:
		::System::Object* _reference; // 0x10
		::System::Collections::Generic::List_1<::ParadoxNotion::HierarchyTree_Element*>* _children; // 0x18
