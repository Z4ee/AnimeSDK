...
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1B4BBE80)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B4BC3D0)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x1B4BBF10)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x1B4BBF20)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4BC120)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4BBF30)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BC3E0)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int fsUnityObjectConverter_TypeDefinitionIndex = 26879;
