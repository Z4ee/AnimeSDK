...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKKEY_1_OFFSET UNITYSDK_OFFSET(0x19863920)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKKEY_OFFSET UNITYSDK_OFFSET(0x19863000)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKTYPE_OFFSET UNITYSDK_OFFSET(0x19862AC0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x198636A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_FAILEXPECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x19863090)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x19863800)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x198638F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19863DB0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsBaseConverter_TypeDefinitionIndex = 27078;
