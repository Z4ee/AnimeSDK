...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1B4AA0A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4AA130)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONAFTERSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4AA100)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFOREDESERIALIZEAFTERINSTANCECREATION_OFFSET UNITYSDK_OFFSET(0x1B4AA120)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFOREDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4AA110)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4AA0F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AA140)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsObjectProcessor_TypeDefinitionIndex = 26527;
