...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1EB8CCE0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EB8CD70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONAFTERSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EB8CD40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFOREDESERIALIZEAFTERINSTANCECREATION_OFFSET UNITYSDK_OFFSET(0x1EB8CD60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFOREDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EB8CD50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EB8CD30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB8CD80)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsObjectProcessor_TypeDefinitionIndex = 30149;
