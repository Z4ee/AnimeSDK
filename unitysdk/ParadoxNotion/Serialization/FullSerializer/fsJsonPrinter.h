...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_BUILDCOMPRESSEDSTRING_OFFSET UNITYSDK_OFFSET(0x1A2ACC30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_BUILDPRETTYSTRING_OFFSET UNITYSDK_OFFSET(0x1A2AD2B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_COMPRESSEDJSON_1_OFFSET UNITYSDK_OFFSET(0x1A2ADBB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_COMPRESSEDJSON_OFFSET UNITYSDK_OFFSET(0x1A2ADD10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_CONVERTDOUBLETOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2AD1A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_ESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x1A2AC720)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_INSERTSPACING_OFFSET UNITYSDK_OFFSET(0x1A2AC6C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_PRETTYJSON_1_OFFSET UNITYSDK_OFFSET(0x1A2ADA60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_PRETTYJSON_OFFSET UNITYSDK_OFFSET(0x1A2ADD00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_TOJSON_OFFSET UNITYSDK_OFFSET(0x1A2ADA50)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsJsonPrinter_TypeDefinitionIndex = 26883;
