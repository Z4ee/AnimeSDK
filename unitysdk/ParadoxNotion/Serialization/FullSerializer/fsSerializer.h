...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADDCONVERTER_OFFSET UNITYSDK_OFFSET(0x1ADBF7A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADD_ONAFTEROBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1ADBF070)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADD_ONBEFOREOBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1ADBEF70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ENSUREDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1ADBE200)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1ADBFE00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GETPROCESSORS_OFFSET UNITYSDK_OFFSET(0x1ADBFA60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GET_IGNORESERIALIZECYCLEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1ADBEF50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GET_REFERENCESDATABASE_OFFSET UNITYSDK_OFFSET(0x1ADBEF30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INTERNAL_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADC1430)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INTERNAL_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADC0690)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBED70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONAFTERSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBEB80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFOREDESERIALIZEAFTERINSTANCECREATION_OFFSET UNITYSDK_OFFSET(0x1ADBECD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFOREDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBEC30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBE9B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISOBJECTDEFINITION_OFFSET UNITYSDK_OFFSET(0x1ADBE4F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1ADBE3C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISRESERVEDKEYWORD_OFFSET UNITYSDK_OFFSET(0x1ADBDE10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISTYPESPECIFIED_OFFSET UNITYSDK_OFFSET(0x1ADBE750)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISVERSIONED_OFFSET UNITYSDK_OFFSET(0x1ADBE620)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISWRAPPEDDATA_OFFSET UNITYSDK_OFFSET(0x1ADBE880)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_PURGETEMPORARYDATA_OFFSET UNITYSDK_OFFSET(0x1ADBF9E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVEMETADATA_OFFSET UNITYSDK_OFFSET(0x1ADBDF40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVE_ONAFTEROBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1ADBF0F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVE_ONBEFOREOBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1ADBEFF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_SET_IGNORESERIALIZECYCLEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1ADBEF60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_SET_REFERENCESDATABASE_OFFSET UNITYSDK_OFFSET(0x1ADBEF40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZEMIGRATION_OFFSET UNITYSDK_OFFSET(0x1ADC2710)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZEVERSIONING_OFFSET UNITYSDK_OFFSET(0x1ADC24A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1ADC10E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBDBD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYPOP_OFFSET UNITYSDK_OFFSET(0x1ADC1030)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYPUSH_OFFSET UNITYSDK_OFFSET(0x1ADC0E50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZEVERSIONING_OFFSET UNITYSDK_OFFSET(0x1ADC0C20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1ADC02B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBD2B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBF170)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializer_TypeDefinitionIndex = 27606;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsObjectProcessor*>*>* _cachedProcessors; // 0x10
		::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsObjectProcessor*>* _processors; // 0x18
		::System::Action_1<::System::Object*>* onBeforeObjectSerialized; // 0x20
		...
		::System::Collections::Generic::List_1<::UnityEngine::Object*>* _ReferencesDatabase_k__BackingField; // 0x38
		::System::Collections::Generic::Stack_1<::ParadoxNotion::Serialization::FullSerializer::ISerializationCollector*>* _collectors; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsBaseConverter*>* _cachedConverters; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsBaseConverter*>* _cachedOverrideConverterInstances; // 0x50
		::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsConverter*>* _availableConverters; // 0x58
		::ParadoxNotion::Serialization::FullSerializer::fsCyclicReferenceManager* _references; // 0x60
		::System::Action_2<::System::Object*, ::ParadoxNotion::Serialization::FullSerializer::fsData*>* onAfterObjectSerialized; // 0x68
