...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1BCCF040)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BCCF0B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BCCFDD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BCCF190)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD15F0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsDictionaryConverter_TypeDefinitionIndex = 30888;
