...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSLISTCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1ADBCB40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSLISTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ADBCBB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSLISTCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBD2F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSLISTCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBCC90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBDC10)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsListConverter_TypeDefinitionIndex = 26818;
