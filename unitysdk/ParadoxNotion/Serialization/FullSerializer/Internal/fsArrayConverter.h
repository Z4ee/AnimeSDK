...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1EAA0110)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1EAA0970)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x1EAA0140)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x1EAA0150)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EAA0660)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EAA0160)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSARRAYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAA0C90)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsArrayConverter_TypeDefinitionIndex = 30285;
