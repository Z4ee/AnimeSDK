...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1E7BBA60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E7BC160)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E7BBAB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7BBF50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7BBDA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7BBA40)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsForwardConverter_TypeDefinitionIndex = 29993;
