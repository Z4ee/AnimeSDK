...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1E6E0550)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E6E05A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x1E6E0580)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x1E6E0590)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E6E0BF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E6E05F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E12B0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsEnumConverter_TypeDefinitionIndex = 30786;
