...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSREFLECTEDCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1DAF8C00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSREFLECTEDCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1DAF9710)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSREFLECTEDCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DAF9250)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSREFLECTEDCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DAF8C80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSREFLECTEDCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF97F0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsReflectedConverter_TypeDefinitionIndex = 31506;
