...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ADDREFERENCEWITHID_OFFSET UNITYSDK_OFFSET(0x1AFD71A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AFD6E40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ENTER_OFFSET UNITYSDK_OFFSET(0x1AFD6F30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_EXIT_OFFSET UNITYSDK_OFFSET(0x1AFD6F40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_GETREFERENCEID_OFFSET UNITYSDK_OFFSET(0x1AFD7230)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_GETREFERENCEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AFD70A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ISREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AFD7360)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_MARKSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1AFD73E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD6CE0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsCyclicReferenceManager_TypeDefinitionIndex = 28078;
	...
	public:
		...
		::System::Int32 _idStart; // 0x24
		::System::Int32 _depth; // 0x28
