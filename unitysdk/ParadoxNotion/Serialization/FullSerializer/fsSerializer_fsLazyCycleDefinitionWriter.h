...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B0BD620)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_WRITEDEFINITION_OFFSET UNITYSDK_OFFSET(0x1B0BD220)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_WRITEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0BD3C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BD6F0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializer_fsLazyCycleDefinitionWriter_TypeDefinitionIndex = 27607;
