...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_CANSERIALIZEFIELD_OFFSET UNITYSDK_OFFSET(0x1EAA1730)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_COLLECTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EAA1320)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1EAA0C10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_FLUSHMEM_OFFSET UNITYSDK_OFFSET(0x1EAA0E00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GETDEFAULTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1EAA1BE0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GETGENERATOR_OFFSET UNITYSDK_OFFSET(0x1EAA0FA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_DESERIALIZEOVERWRITEREQUEST_OFFSET UNITYSDK_OFFSET(0x1EAA0F80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_OFFSET UNITYSDK_OFFSET(0x1EAA0A50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EAA0F60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1EAA0F40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_HASDEFAULTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1EAA1B50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_DESERIALIZEOVERWRITEREQUEST_OFFSET UNITYSDK_OFFSET(0x1EAA0F90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EAA0F70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1EAA0F50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EAA1DF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAA0CA0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaType_TypeDefinitionIndex = 30092;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsMetaType*>**)Il2CppClass::FromTypeDefinitionIndex(fsMetaType_TypeDefinitionIndex)->GetStaticField(0x263B0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>** StaticGet__defaultInstances()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(fsMetaType_TypeDefinitionIndex)->GetStaticField(0x263B8);
		}
		::System::Type* _reflectedType_k__BackingField; // 0x10
		::ParadoxNotion::Serialization::FullSerializer::fsMetaType_ObjectGenerator* generator; // 0x18
