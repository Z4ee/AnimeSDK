...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_CANSERIALIZEFIELD_OFFSET UNITYSDK_OFFSET(0x1B332D90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_COLLECTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B332970)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B332260)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_FLUSHMEM_OFFSET UNITYSDK_OFFSET(0x1B332450)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GETDEFAULTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B333230)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GETGENERATOR_OFFSET UNITYSDK_OFFSET(0x1B3325F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_DESERIALIZEOVERWRITEREQUEST_OFFSET UNITYSDK_OFFSET(0x1B3325D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_OFFSET UNITYSDK_OFFSET(0x1B3320A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B3325B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B332590)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_HASDEFAULTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1B3331A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_DESERIALIZEOVERWRITEREQUEST_OFFSET UNITYSDK_OFFSET(0x1B3325E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B3325C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B3325A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B333450)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3322F0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaType_TypeDefinitionIndex = 28152;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(fsMetaType_TypeDefinitionIndex)->GetStaticField(0x20EF0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsMetaType*>**)Il2CppClass::FromTypeDefinitionIndex(fsMetaType_TypeDefinitionIndex)->GetStaticField(0x20EF8);
		}
		::Il2CppArray<::ParadoxNotion::Serialization::FullSerializer::fsMetaProperty*>* _Properties_k__BackingField; // 0x10
		::System::Type* _reflectedType_k__BackingField; // 0x18
		::ParadoxNotion::Serialization::FullSerializer::fsMetaType_ObjectGenerator* generator; // 0x20
