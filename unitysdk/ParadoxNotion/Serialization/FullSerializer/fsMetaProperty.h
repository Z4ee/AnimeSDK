...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_ASREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D35DCA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_AUTOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D35DC80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1D35DBA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1D35DBC0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1D35DC10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_READONLY_OFFSET UNITYSDK_OFFSET(0x1D35DC40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_STORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1D35DBE0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_WRITEONLY_OFFSET UNITYSDK_OFFSET(0x1D35DC60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_READ_OFFSET UNITYSDK_OFFSET(0x1D35DE70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_ASREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D35DCB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_AUTOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D35DC90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_FIELD_OFFSET UNITYSDK_OFFSET(0x1D35DBB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1D35DBD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x1D35DC50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_WRITEONLY_OFFSET UNITYSDK_OFFSET(0x1D35DC70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_WRITE_OFFSET UNITYSDK_OFFSET(0x1D35DEA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D35DCC0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaProperty_TypeDefinitionIndex = 30495;
	...
	public:
		...
		::System::Boolean _WriteOnly_k__BackingField; // 0x20
