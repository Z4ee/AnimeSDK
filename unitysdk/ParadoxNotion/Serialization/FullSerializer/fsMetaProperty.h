...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_ASREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AF378D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_AUTOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AF378B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1AF377D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1AF377F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AF37840)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_READONLY_OFFSET UNITYSDK_OFFSET(0x1AF37870)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_STORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1AF37810)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_WRITEONLY_OFFSET UNITYSDK_OFFSET(0x1AF37890)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_READ_OFFSET UNITYSDK_OFFSET(0x1AF37AA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_ASREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AF378E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_AUTOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AF378C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_FIELD_OFFSET UNITYSDK_OFFSET(0x1AF377E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1AF37800)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x1AF37880)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_WRITEONLY_OFFSET UNITYSDK_OFFSET(0x1AF378A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_WRITE_OFFSET UNITYSDK_OFFSET(0x1AF37AD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF378F0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaProperty_TypeDefinitionIndex = 27437;
	...
	public:
		...
		::System::Boolean _AsReference_k__BackingField; // 0x22
		::System::Boolean _WriteOnly_k__BackingField; // 0x23
