...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR_SYSTEM_COLLECTIONS_GENERIC_IEQUALITYCOMPARER_SYSTEM_OBJECT__EQUALS_OFFSET UNITYSDK_OFFSET(0x1E7BCA60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR_SYSTEM_COLLECTIONS_GENERIC_IEQUALITYCOMPARER_SYSTEM_OBJECT__GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E7BCA70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7BCA90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7BCA80)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsCyclicReferenceManager_ObjectReferenceEqualityComparator_TypeDefinitionIndex = 30380;
	...
	public:
		...
		{
			return (::System::Collections::Generic::IEqualityComparer_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(fsCyclicReferenceManager_ObjectReferenceEqualityComparator_TypeDefinitionIndex)->GetStaticField(0x25E40);
		}
