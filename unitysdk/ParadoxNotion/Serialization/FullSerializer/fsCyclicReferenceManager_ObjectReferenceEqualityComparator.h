...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR_SYSTEM_COLLECTIONS_GENERIC_IEQUALITYCOMPARER_SYSTEM_OBJECT__EQUALS_OFFSET UNITYSDK_OFFSET(0x1D417490)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR_SYSTEM_COLLECTIONS_GENERIC_IEQUALITYCOMPARER_SYSTEM_OBJECT__GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D4174A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4174C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4174B0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsCyclicReferenceManager_ObjectReferenceEqualityComparator_TypeDefinitionIndex = 29531;
	...
	public:
		...
		{
			return (::System::Collections::Generic::IEqualityComparer_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(fsCyclicReferenceManager_ObjectReferenceEqualityComparator_TypeDefinitionIndex)->GetStaticField(0x24550);
		}
