...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION_GET_RAWEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B4BBDA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION_SET_RAWEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B4BBDB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BBDC0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int ResolvedException_TypeDefinitionIndex = 27613;
