...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_BECOMEDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1EB7ACA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x1EB7ADE0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_CREATEDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1EB7A9E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_CREATELIST_1_OFFSET UNITYSDK_OFFSET(0x1EB7AC40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_CREATELIST_OFFSET UNITYSDK_OFFSET(0x1EB7ABB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EB7B160)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EB7B100)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EB7B880)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1EB7B020)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ASDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1EB7B070)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1EB7B000)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x1EB7B010)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ASLIST_OFFSET UNITYSDK_OFFSET(0x1EB7B0B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1EB7B030)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISBOOL_OFFSET UNITYSDK_OFFSET(0x1EB7AEB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1EB7AF20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x1EB7AE40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISINT64_OFFSET UNITYSDK_OFFSET(0x1EB7AE60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISLIST_OFFSET UNITYSDK_OFFSET(0x1EB7AF90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1EB7AE30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1EB7AF00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EB7A7A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1EB7B6E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1EB7B780)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EB7B0F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EB7B8C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EB7A8E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EB7A930)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EB7A960)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1EB7A9B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1EB7A9C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1EB7A9D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB7A8D0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsData_TypeDefinitionIndex = 30252;
	...
	public:
		...
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsData**)Il2CppClass::FromTypeDefinitionIndex(fsData_TypeDefinitionIndex)->GetStaticField(0x25A20);
		}
		static ::ParadoxNotion::Serialization::FullSerializer::fsData** StaticGet_True()
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsData**)Il2CppClass::FromTypeDefinitionIndex(fsData_TypeDefinitionIndex)->GetStaticField(0x25A28);
		}
		static ::ParadoxNotion::Serialization::FullSerializer::fsData** StaticGet_False()
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsData**)Il2CppClass::FromTypeDefinitionIndex(fsData_TypeDefinitionIndex)->GetStaticField(0x25A30);
		}
