...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZEASATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D82D190)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZEASATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D82D180)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializeAsAttribute_TypeDefinitionIndex = 30136;
