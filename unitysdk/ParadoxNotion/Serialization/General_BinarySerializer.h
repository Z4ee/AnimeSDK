...
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_ATTACHEXTRAFORMATTER_OFFSET UNITYSDK_OFFSET(0x1E7BD4C0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_ATTACHEXTRARESOLVER_OFFSET UNITYSDK_OFFSET(0x1E7BD640)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_ENLARGEBUFF_OFFSET UNITYSDK_OFFSET(0x1E7BD7C0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1E7BD310)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_INIT_OFFSET UNITYSDK_OFFSET(0x1E7BCBD0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_MARKUNINIT_OFFSET UNITYSDK_OFFSET(0x1E7BCAD0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_RESET_OFFSET UNITYSDK_OFFSET(0x1E7BD390)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7BD8D0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER__GETDEFAULTFORMATTERS_OFFSET UNITYSDK_OFFSET(0x1E7BD290)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER__GETDEFAULTRESOLVERS_OFFSET UNITYSDK_OFFSET(0x1E7BD0A0)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int General_BinarySerializer_TypeDefinitionIndex = 29927;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::ParadoxNotion::Serialization::GeneralUsage, ::ParadoxNotion::Serialization::General_BinarySerializer_UsageContext*>**)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x25E50);
		}
