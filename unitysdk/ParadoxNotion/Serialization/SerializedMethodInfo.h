...
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_ASMEMBERINFO_OFFSET UNITYSDK_OFFSET(0x1A8614C0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1A846BD0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1A8614D0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x1A860750)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GET_T_GENERICARGUMENTSINFO_OFFSET UNITYSDK_OFFSET(0x1A860790)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GET_T_PARAMSINFO_OFFSET UNITYSDK_OFFSET(0x1A860770)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_HASCHANGED_OFFSET UNITYSDK_OFFSET(0x1A8614E0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A846670)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_SET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x1A860760)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_SET_T_GENERICARGUMENTSINFO_OFFSET UNITYSDK_OFFSET(0x1A8607A0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_SET_T_PARAMSINFO_OFFSET UNITYSDK_OFFSET(0x1A860780)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8614F0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A860C10)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A8607B0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A846EC0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8614B0)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int SerializedMethodInfo_TypeDefinitionIndex = 28195;
