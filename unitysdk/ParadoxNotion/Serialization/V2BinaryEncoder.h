...
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_COLLECTTABLES_OFFSET UNITYSDK_OFFSET(0x1AFD89B0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1AFD7F90)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_HASHSTRING_OFFSET UNITYSDK_OFFSET(0x1AFD8EF0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_WRITE7BITINT_OFFSET UNITYSDK_OFFSET(0x1AFD93B0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_WRITENODE_OFFSET UNITYSDK_OFFSET(0x1AFD8320)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1AFD91A0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFD9430)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int V2BinaryEncoder_TypeDefinitionIndex = 28120;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(V2BinaryEncoder_TypeDefinitionIndex)->GetStaticField(0x20A20);
		}
