...
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_COLLECTTABLES_OFFSET UNITYSDK_OFFSET(0x1D418DC0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1D4183A0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_HASHSTRING_OFFSET UNITYSDK_OFFSET(0x1D419300)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_WRITE7BITINT_OFFSET UNITYSDK_OFFSET(0x1D4197C0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_WRITENODE_OFFSET UNITYSDK_OFFSET(0x1D418730)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1D4195B0)
#define PARADOXNOTION_SERIALIZATION_V2BINARYENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D419840)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int V2BinaryEncoder_TypeDefinitionIndex = 30817;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(V2BinaryEncoder_TypeDefinitionIndex)->GetStaticField(0x24570);
		}
