...
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_CLONE_OFFSET UNITYSDK_OFFSET(0x1A217BE0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_COPYSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A217D30)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A217500)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_FLUSHMEM_OFFSET UNITYSDK_OFFSET(0x1A217310)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_INTERNAL_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A217570)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_PRETTIFYJSON_OFFSET UNITYSDK_OFFSET(0x1A218090)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZEANDEXECUTENOCYCLES_1_OFFSET UNITYSDK_OFFSET(0x1A209400)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZEANDEXECUTENOCYCLES_OFFSET UNITYSDK_OFFSET(0x1A209A20)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A204410)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SHOWDATA_OFFSET UNITYSDK_OFFSET(0x1A217EA0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_TRYDESERIALIZEOVERWRITE_OFFSET UNITYSDK_OFFSET(0x1A217B60)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A217250)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER___FLUSHDATACACHE_OFFSET UNITYSDK_OFFSET(0x1A217410)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int JSONSerializer_TypeDefinitionIndex = 26855;
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1FF00);
		}
		static ::ParadoxNotion::Serialization::FullSerializer::fsSerializer** StaticGet_serializer()
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsSerializer**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1FF08);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::ParadoxNotion::Serialization::FullSerializer::fsData*>**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1FF10);
		}
