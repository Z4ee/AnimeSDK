...
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8614A0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO___C__DISPLAYCLASS15_0__UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1A861500)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO___C__DISPLAYCLASS15_0__UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1A8615B0)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int SerializedMethodInfo___c__DisplayClass15_0_TypeDefinitionIndex = 28196;
