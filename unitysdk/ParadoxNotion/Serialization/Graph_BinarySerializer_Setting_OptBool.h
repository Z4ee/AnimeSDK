...
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0BD860)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B0BD840)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0BD870)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BD7A0)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int Graph_BinarySerializer_Setting_OptBool_TypeDefinitionIndex = 26763;
