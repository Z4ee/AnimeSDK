...
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E8C8A40)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E8C8A20)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E8C8A50)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8C8980)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int Graph_BinarySerializer_Setting_OptBool_TypeDefinitionIndex = 30931;
