...
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_ASMEMBERINFO_OFFSET UNITYSDK_OFFSET(0x1EB8D3D0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1EB8D400)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_GETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1EB8D3E0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_GET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x1EB8CD90)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_GET_TPARAMSINFO_OFFSET UNITYSDK_OFFSET(0x1EB8CDB0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_HASCHANGED_OFFSET UNITYSDK_OFFSET(0x1EB8D3F0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1EB8D4D0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_SET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x1EB8CDA0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_SET_TPARAMSINFO_OFFSET UNITYSDK_OFFSET(0x1EB8CDC0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EB8D4C0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EB8CFE0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EB8CDD0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EB8D3C0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDCONSTRUCTORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB8D3B0)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int SerializedConstructorInfo_TypeDefinitionIndex = 30984;
