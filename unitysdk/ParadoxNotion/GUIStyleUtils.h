...
#define PARADOXNOTION_GUISTYLEUTILS_BORDER_OFFSET UNITYSDK_OFFSET(0x1E236FC0)
#define PARADOXNOTION_GUISTYLEUTILS_MARGIN_OFFSET UNITYSDK_OFFSET(0x1E236E60)
#define PARADOXNOTION_GUISTYLEUTILS_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x1E237070)
#define PARADOXNOTION_GUISTYLEUTILS_PADDING_OFFSET UNITYSDK_OFFSET(0x1E236F10)
#define PARADOXNOTION_GUISTYLEUTILS_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1E237150)
#define PARADOXNOTION_GUISTYLEUTILS_TEXTALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E237120)

namespace ParadoxNotion
{
	inline static constexpr unsigned int GUIStyleUtils_TypeDefinitionIndex = 31018;
