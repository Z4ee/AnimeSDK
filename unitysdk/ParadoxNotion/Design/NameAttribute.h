...
#define PARADOXNOTION_DESIGN_NAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC64750)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int NameAttribute_TypeDefinitionIndex = 29278;
