...
#define PARADOXNOTION_DESIGN_COLORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A215440)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int ColorAttribute_TypeDefinitionIndex = 27935;
