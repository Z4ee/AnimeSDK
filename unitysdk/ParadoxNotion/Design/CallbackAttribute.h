...
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1D53F2E0)
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1D53F2F0)
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53F300)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int CallbackAttribute_TypeDefinitionIndex = 29149;
