...
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1E236E00)
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1E236E10)
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E236E20)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int CallbackAttribute_TypeDefinitionIndex = 30684;
