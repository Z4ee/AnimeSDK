...
#define PARADOXNOTION_DESIGN_NODEHIDEIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E8E20)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int NodeHideIfAttribute_TypeDefinitionIndex = 30565;
