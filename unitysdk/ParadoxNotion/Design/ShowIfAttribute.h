...
#define PARADOXNOTION_DESIGN_SHOWIFATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1ADBC560)
#define PARADOXNOTION_DESIGN_SHOWIFATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1ADBC570)
#define PARADOXNOTION_DESIGN_SHOWIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBC580)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int ShowIfAttribute_TypeDefinitionIndex = 27150;
