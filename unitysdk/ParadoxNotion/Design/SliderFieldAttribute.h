...
#define PARADOXNOTION_DESIGN_SLIDERFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0BD200)
#define PARADOXNOTION_DESIGN_SLIDERFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BD1F0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int SliderFieldAttribute_TypeDefinitionIndex = 27594;
