...
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1E544BA0)
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1E544BB0)
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E544BC0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int RequiredFieldAttribute_TypeDefinitionIndex = 31465;
