...
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1ADBC530)
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1ADBC540)
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBC550)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int RequiredFieldAttribute_TypeDefinitionIndex = 27096;
