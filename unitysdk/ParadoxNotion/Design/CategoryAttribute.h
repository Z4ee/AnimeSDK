...
#define PARADOXNOTION_DESIGN_CATEGORYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E8E00)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int CategoryAttribute_TypeDefinitionIndex = 30505;
