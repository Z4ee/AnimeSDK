...
#define PARADOXNOTION_DESIGN_DIMIFDEFAULTATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1CC4DBE0)
#define PARADOXNOTION_DESIGN_DIMIFDEFAULTATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1CC4DBF0)
#define PARADOXNOTION_DESIGN_DIMIFDEFAULTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4DC00)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int DimIfDefaultAttribute_TypeDefinitionIndex = 29786;
