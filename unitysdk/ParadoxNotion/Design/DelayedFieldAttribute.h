...
#define PARADOXNOTION_DESIGN_DELAYEDFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E544B80)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int DelayedFieldAttribute_TypeDefinitionIndex = 29878;
