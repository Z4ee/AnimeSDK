...
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKDIRTY_OFFSET UNITYSDK_OFFSET(0x1BCCEE80)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKUNDO_OFFSET UNITYSDK_OFFSET(0x1BCCEE20)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GETLASTOPERATIONNAMEOR_OFFSET UNITYSDK_OFFSET(0x1BCCEE00)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x1BCCED70)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1BCCEDE0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1BCCEDA0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1BCCEDC0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_OFFSET UNITYSDK_OFFSET(0x1BCCED90)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1BCCEDB0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x1BCCED80)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int UndoUtility_TypeDefinitionIndex = 29882;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UndoUtility_TypeDefinitionIndex)->GetStaticField(0x24200);
		}
