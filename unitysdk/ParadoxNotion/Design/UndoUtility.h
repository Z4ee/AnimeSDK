...
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKDIRTY_OFFSET UNITYSDK_OFFSET(0x1D0708E0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKUNDO_OFFSET UNITYSDK_OFFSET(0x1D070880)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GETLASTOPERATIONNAMEOR_OFFSET UNITYSDK_OFFSET(0x1D070860)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x1D0707D0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1D070840)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1D070800)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1D070820)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_OFFSET UNITYSDK_OFFSET(0x1D0707F0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1D070810)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x1D0707E0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int UndoUtility_TypeDefinitionIndex = 31085;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UndoUtility_TypeDefinitionIndex)->GetStaticField(0x25B20);
		}
