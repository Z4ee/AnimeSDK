...
#define PARADOXNOTION_DESIGN_ICONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB3BB80)
#define PARADOXNOTION_DESIGN_ICONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3BB70)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int IconAttribute_TypeDefinitionIndex = 29978;
