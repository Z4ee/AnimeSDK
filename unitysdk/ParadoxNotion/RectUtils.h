...
#define PARADOXNOTION_RECTUTILS_ENCAPSULATES_OFFSET UNITYSDK_OFFSET(0x1DB9F520)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_1_OFFSET UNITYSDK_OFFSET(0x1DB9F590)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_2_OFFSET UNITYSDK_OFFSET(0x1DB9F5C0)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_OFFSET UNITYSDK_OFFSET(0x1DB9F560)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_1_OFFSET UNITYSDK_OFFSET(0x1DB9F440)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_OFFSET UNITYSDK_OFFSET(0x1DB9F360)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_1_OFFSET UNITYSDK_OFFSET(0x1DB9F720)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x1DB9F600)

namespace ParadoxNotion
{
	inline static constexpr unsigned int RectUtils_TypeDefinitionIndex = 30500;
