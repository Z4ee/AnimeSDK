...
#define PARADOXNOTION_RECTUTILS_ENCAPSULATES_OFFSET UNITYSDK_OFFSET(0x1EF955D0)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_1_OFFSET UNITYSDK_OFFSET(0x1EF95640)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_2_OFFSET UNITYSDK_OFFSET(0x1EF95670)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_OFFSET UNITYSDK_OFFSET(0x1EF95610)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_1_OFFSET UNITYSDK_OFFSET(0x1EF95510)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_OFFSET UNITYSDK_OFFSET(0x1EF95490)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_1_OFFSET UNITYSDK_OFFSET(0x1EF957D0)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x1EF956B0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int RectUtils_TypeDefinitionIndex = 30594;
