...
#define PARADOXNOTION_ANIMATION_EASING_BACKINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF7710)
#define PARADOXNOTION_ANIMATION_EASING_BACKIN_OFFSET UNITYSDK_OFFSET(0x1DAF7510)
#define PARADOXNOTION_ANIMATION_EASING_BACKOUT_OFFSET UNITYSDK_OFFSET(0x1DAF7600)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF72A0)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEIN_OFFSET UNITYSDK_OFFSET(0x1DAF6F50)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEOUT_OFFSET UNITYSDK_OFFSET(0x1DAF7130)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF6910)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARIN_OFFSET UNITYSDK_OFFSET(0x1DAF66F0)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULAROUT_OFFSET UNITYSDK_OFFSET(0x1DAF6800)
#define PARADOXNOTION_ANIMATION_EASING_CUBICINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF5E60)
#define PARADOXNOTION_ANIMATION_EASING_CUBICIN_OFFSET UNITYSDK_OFFSET(0x1DAF5C80)
#define PARADOXNOTION_ANIMATION_EASING_CUBICOUT_OFFSET UNITYSDK_OFFSET(0x1DAF5D60)
#define PARADOXNOTION_ANIMATION_EASING_DIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1DAF5290)
#define PARADOXNOTION_ANIMATION_EASING_EASE_1_OFFSET UNITYSDK_OFFSET(0x1DAF4EB0)
#define PARADOXNOTION_ANIMATION_EASING_EASE_2_OFFSET UNITYSDK_OFFSET(0x1DAF5020)
#define PARADOXNOTION_ANIMATION_EASING_EASE_3_OFFSET UNITYSDK_OFFSET(0x1DAF5170)
#define PARADOXNOTION_ANIMATION_EASING_EASE_OFFSET UNITYSDK_OFFSET(0x1DAF3FF0)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF6D70)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICIN_OFFSET UNITYSDK_OFFSET(0x1DAF6A70)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICOUT_OFFSET UNITYSDK_OFFSET(0x1DAF6BF0)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF6550)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALIN_OFFSET UNITYSDK_OFFSET(0x1DAF62E0)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALOUT_OFFSET UNITYSDK_OFFSET(0x1DAF6400)
#define PARADOXNOTION_ANIMATION_EASING_FUNCTION_OFFSET UNITYSDK_OFFSET(0x1DAF40C0)
#define PARADOXNOTION_ANIMATION_EASING_LINEAR_OFFSET UNITYSDK_OFFSET(0x1DAF52C0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF54A0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICIN_OFFSET UNITYSDK_OFFSET(0x1DAF52F0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICOUT_OFFSET UNITYSDK_OFFSET(0x1DAF53C0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF57D0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICIN_OFFSET UNITYSDK_OFFSET(0x1DAF55E0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICOUT_OFFSET UNITYSDK_OFFSET(0x1DAF56C0)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF5B20)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICIN_OFFSET UNITYSDK_OFFSET(0x1DAF5920)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICOUT_OFFSET UNITYSDK_OFFSET(0x1DAF5A10)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALINOUT_OFFSET UNITYSDK_OFFSET(0x1DAF61C0)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALIN_OFFSET UNITYSDK_OFFSET(0x1DAF5FA0)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALOUT_OFFSET UNITYSDK_OFFSET(0x1DAF60C0)
#define PARADOXNOTION_ANIMATION_EASING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAF7870)

namespace ParadoxNotion::Animation
{
	inline static constexpr unsigned int Easing_TypeDefinitionIndex = 30584;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Func_4<::System::Single, ::System::Single, ::System::Single, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(Easing_TypeDefinitionIndex)->GetStaticField(0x25400);
		}
