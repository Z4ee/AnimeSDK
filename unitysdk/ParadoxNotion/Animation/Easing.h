...
#define PARADOXNOTION_ANIMATION_EASING_BACKINOUT_OFFSET UNITYSDK_OFFSET(0x1C640020)
#define PARADOXNOTION_ANIMATION_EASING_BACKIN_OFFSET UNITYSDK_OFFSET(0x1C63FE20)
#define PARADOXNOTION_ANIMATION_EASING_BACKOUT_OFFSET UNITYSDK_OFFSET(0x1C63FF10)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEINOUT_OFFSET UNITYSDK_OFFSET(0x1C63FBC0)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEIN_OFFSET UNITYSDK_OFFSET(0x1C63F850)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEOUT_OFFSET UNITYSDK_OFFSET(0x1C63FA60)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARINOUT_OFFSET UNITYSDK_OFFSET(0x1C63F240)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARIN_OFFSET UNITYSDK_OFFSET(0x1C63F030)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULAROUT_OFFSET UNITYSDK_OFFSET(0x1C63F140)
#define PARADOXNOTION_ANIMATION_EASING_CUBICINOUT_OFFSET UNITYSDK_OFFSET(0x1C63E830)
#define PARADOXNOTION_ANIMATION_EASING_CUBICIN_OFFSET UNITYSDK_OFFSET(0x1C63E650)
#define PARADOXNOTION_ANIMATION_EASING_CUBICOUT_OFFSET UNITYSDK_OFFSET(0x1C63E730)
#define PARADOXNOTION_ANIMATION_EASING_DIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1C63DCE0)
#define PARADOXNOTION_ANIMATION_EASING_EASE_1_OFFSET UNITYSDK_OFFSET(0x1C63D900)
#define PARADOXNOTION_ANIMATION_EASING_EASE_2_OFFSET UNITYSDK_OFFSET(0x1C63DA70)
#define PARADOXNOTION_ANIMATION_EASING_EASE_3_OFFSET UNITYSDK_OFFSET(0x1C63DBC0)
#define PARADOXNOTION_ANIMATION_EASING_EASE_OFFSET UNITYSDK_OFFSET(0x1C63C9C0)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICINOUT_OFFSET UNITYSDK_OFFSET(0x1C63F680)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICIN_OFFSET UNITYSDK_OFFSET(0x1C63F380)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICOUT_OFFSET UNITYSDK_OFFSET(0x1C63F500)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALINOUT_OFFSET UNITYSDK_OFFSET(0x1C63EEB0)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALIN_OFFSET UNITYSDK_OFFSET(0x1C63EC50)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALOUT_OFFSET UNITYSDK_OFFSET(0x1C63ED70)
#define PARADOXNOTION_ANIMATION_EASING_FUNCTION_OFFSET UNITYSDK_OFFSET(0x1C63CA90)
#define PARADOXNOTION_ANIMATION_EASING_LINEAR_OFFSET UNITYSDK_OFFSET(0x1C63DD10)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICINOUT_OFFSET UNITYSDK_OFFSET(0x1C63DEF0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICIN_OFFSET UNITYSDK_OFFSET(0x1C63DD40)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICOUT_OFFSET UNITYSDK_OFFSET(0x1C63DE10)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICINOUT_OFFSET UNITYSDK_OFFSET(0x1C63E200)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICIN_OFFSET UNITYSDK_OFFSET(0x1C63E020)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICOUT_OFFSET UNITYSDK_OFFSET(0x1C63E100)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICINOUT_OFFSET UNITYSDK_OFFSET(0x1C63E510)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICIN_OFFSET UNITYSDK_OFFSET(0x1C63E330)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICOUT_OFFSET UNITYSDK_OFFSET(0x1C63E410)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALINOUT_OFFSET UNITYSDK_OFFSET(0x1C63EB50)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALIN_OFFSET UNITYSDK_OFFSET(0x1C63E960)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALOUT_OFFSET UNITYSDK_OFFSET(0x1C63EA60)
#define PARADOXNOTION_ANIMATION_EASING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C640170)

namespace ParadoxNotion::Animation
{
	inline static constexpr unsigned int Easing_TypeDefinitionIndex = 30003;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Func_4<::System::Single, ::System::Single, ::System::Single, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(Easing_TypeDefinitionIndex)->GetStaticField(0x23BC0);
		}
