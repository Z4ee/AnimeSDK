...
#define PARADOXNOTION_CURVEUTILS_GETPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1BC63D50)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_1_OFFSET UNITYSDK_OFFSET(0x1BC63ED0)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1BC63EA0)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_1_OFFSET UNITYSDK_OFFSET(0x1BC64500)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_OFFSET UNITYSDK_OFFSET(0x1BC642C0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int CurveUtils_TypeDefinitionIndex = 29955;
