...
#define PARADOXNOTION_CURVEUTILS_GETPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1DB3B210)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_1_OFFSET UNITYSDK_OFFSET(0x1DB3B380)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1DB3B350)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_1_OFFSET UNITYSDK_OFFSET(0x1DB3B960)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_OFFSET UNITYSDK_OFFSET(0x1DB3B720)

namespace ParadoxNotion
{
	inline static constexpr unsigned int CurveUtils_TypeDefinitionIndex = 31140;
