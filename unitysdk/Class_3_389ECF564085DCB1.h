...
#define CLASS_3_389ECF564085DCB1_METHOD_3_9E3D0C5F7C38F16C_OFFSET UNITYSDK_OFFSET(0x17929A50)
#define CLASS_3_389ECF564085DCB1_METHOD_3_C17C5E1EBAECCBCD_OFFSET UNITYSDK_OFFSET(0x17929AD0)
#define CLASS_3_389ECF564085DCB1__CTOR_OFFSET UNITYSDK_OFFSET(0x17929AA0)

inline static constexpr unsigned int Class_3_389ECF564085DCB1_TypeDefinitionIndex = 19651;

class Class_3_389ECF564085DCB1 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicString* Field_3_0; // 0x18
	::RPG::GameCore::LittleGameFireEffectParams* Field_3_1; // 0x20
