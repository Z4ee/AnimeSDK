...
#define CLASS_1_6DD95D095DCED890_METHOD_1_4B08A5EF9CAB1270_OFFSET UNITYSDK_OFFSET(0xBB902D0)
#define CLASS_1_6DD95D095DCED890_METHOD_1_77BD1225DE9DEEB8_OFFSET UNITYSDK_OFFSET(0xBB8FEB0)
#define CLASS_1_6DD95D095DCED890_METHOD_1_B4EA5393BA544425_OFFSET UNITYSDK_OFFSET(0xBB901F0)
#define CLASS_1_6DD95D095DCED890_METHOD_1_D7411E5DB745D614_OFFSET UNITYSDK_OFFSET(0xBB90070)
#define CLASS_1_6DD95D095DCED890_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0xBB8FDB0)
#define CLASS_1_6DD95D095DCED890_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0xBB8FE60)
#define CLASS_1_6DD95D095DCED890__CTOR_OFFSET UNITYSDK_OFFSET(0xBB90320)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::Class_1_1C06630EAC3CFF7F*>* HAGAFPFAONA; // 0x10
	::RPG::GameCore::GameWorld* IMMBMILPPFB; // 0x18
	::System::Action_1<::RPG::GameCore::GameEntity*>* DGAAGLAGFID; // 0x20
