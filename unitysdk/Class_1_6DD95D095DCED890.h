...
#define CLASS_1_6DD95D095DCED890_METHOD_1_4B08A5EF9CAB1270_OFFSET UNITYSDK_OFFSET(0x1A7D1330)
#define CLASS_1_6DD95D095DCED890_METHOD_1_77BD1225DE9DEEB8_OFFSET UNITYSDK_OFFSET(0x1A7D0F10)
#define CLASS_1_6DD95D095DCED890_METHOD_1_B4EA5393BA544425_OFFSET UNITYSDK_OFFSET(0x1A7D1250)
#define CLASS_1_6DD95D095DCED890_METHOD_1_D7411E5DB745D614_OFFSET UNITYSDK_OFFSET(0x1A7D10D0)
#define CLASS_1_6DD95D095DCED890_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0x1A7D0E10)
#define CLASS_1_6DD95D095DCED890_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0x1A7D0EC0)
#define CLASS_1_6DD95D095DCED890__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D1380)

inline static constexpr unsigned int Class_1_6DD95D095DCED890_TypeDefinitionIndex = 57970;

class Class_1_6DD95D095DCED890 : public ::System::Object
{
public:
	::System::Action_1<::RPG::GameCore::GameEntity*>* DGAAGLAGFID; // 0x10
	::RPG::GameCore::GameWorld* IMMBMILPPFB; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::Class_1_1C06630EAC3CFF7F*>* HAGAFPFAONA; // 0x20
