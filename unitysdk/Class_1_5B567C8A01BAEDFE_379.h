...
#define CLASS_1_5B567C8A01BAEDFE_379_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A87C910)
#define CLASS_1_5B567C8A01BAEDFE_379_CLONE_OFFSET UNITYSDK_OFFSET(0x1A87C720)
#define CLASS_1_5B567C8A01BAEDFE_379_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A87C820)
#define CLASS_1_5B567C8A01BAEDFE_379_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A87C790)
#define CLASS_1_5B567C8A01BAEDFE_379_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A87C870)
#define CLASS_1_5B567C8A01BAEDFE_379_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A87C960)
#define CLASS_1_5B567C8A01BAEDFE_379_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A87C930)
#define CLASS_1_5B567C8A01BAEDFE_379_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A87C670)
#define CLASS_1_5B567C8A01BAEDFE_379_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A87C6D0)
#define CLASS_1_5B567C8A01BAEDFE_379_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A87C8A0)
#define CLASS_1_5B567C8A01BAEDFE_379_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A87C900)
#define CLASS_1_5B567C8A01BAEDFE_379__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A87C9B0)
#define CLASS_1_5B567C8A01BAEDFE_379__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A87C6F0)
#define CLASS_1_5B567C8A01BAEDFE_379__CTOR_OFFSET UNITYSDK_OFFSET(0x1A87C6E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_379*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_379_TypeDefinitionIndex)->GetStaticField(0x55740);
	}
