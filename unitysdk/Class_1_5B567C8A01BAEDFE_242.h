...
#define CLASS_1_5B567C8A01BAEDFE_242_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195C41D0)
#define CLASS_1_5B567C8A01BAEDFE_242_CLONE_OFFSET UNITYSDK_OFFSET(0x195C4040)
#define CLASS_1_5B567C8A01BAEDFE_242_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195C40E0)
#define CLASS_1_5B567C8A01BAEDFE_242_EQUALS_OFFSET UNITYSDK_OFFSET(0x195C4080)
#define CLASS_1_5B567C8A01BAEDFE_242_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195C4130)
#define CLASS_1_5B567C8A01BAEDFE_242_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195C4220)
#define CLASS_1_5B567C8A01BAEDFE_242_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195C41F0)
#define CLASS_1_5B567C8A01BAEDFE_242_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x195C3FC0)
#define CLASS_1_5B567C8A01BAEDFE_242_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195C3FF0)
#define CLASS_1_5B567C8A01BAEDFE_242_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195C4160)
#define CLASS_1_5B567C8A01BAEDFE_242_WRITETO_OFFSET UNITYSDK_OFFSET(0x195C41C0)
#define CLASS_1_5B567C8A01BAEDFE_242__CCTOR_OFFSET UNITYSDK_OFFSET(0x195C4270)
#define CLASS_1_5B567C8A01BAEDFE_242__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C4010)
#define CLASS_1_5B567C8A01BAEDFE_242__CTOR_OFFSET UNITYSDK_OFFSET(0x195C4000)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_242_TypeDefinitionIndex = 30064;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_242*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_242_TypeDefinitionIndex)->GetStaticField(0x53680);
	}
