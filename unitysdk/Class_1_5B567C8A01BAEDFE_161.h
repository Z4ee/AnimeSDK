...
#define CLASS_1_5B567C8A01BAEDFE_161_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C91620)
#define CLASS_1_5B567C8A01BAEDFE_161_CLONE_OFFSET UNITYSDK_OFFSET(0x19C91490)
#define CLASS_1_5B567C8A01BAEDFE_161_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C91530)
#define CLASS_1_5B567C8A01BAEDFE_161_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C914D0)
#define CLASS_1_5B567C8A01BAEDFE_161_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C91580)
#define CLASS_1_5B567C8A01BAEDFE_161_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C91670)
#define CLASS_1_5B567C8A01BAEDFE_161_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C91640)
#define CLASS_1_5B567C8A01BAEDFE_161_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C91410)
#define CLASS_1_5B567C8A01BAEDFE_161_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C91440)
#define CLASS_1_5B567C8A01BAEDFE_161_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C915B0)
#define CLASS_1_5B567C8A01BAEDFE_161_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C91610)
#define CLASS_1_5B567C8A01BAEDFE_161__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C916C0)
#define CLASS_1_5B567C8A01BAEDFE_161__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C91460)
#define CLASS_1_5B567C8A01BAEDFE_161__CTOR_OFFSET UNITYSDK_OFFSET(0x19C91450)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_161_TypeDefinitionIndex = 28092;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_161*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_161_TypeDefinitionIndex)->GetStaticField(0x63080);
	}
