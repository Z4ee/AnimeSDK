...
#define CLASS_2_1A9D9F009A5DA850_DISPOSE_OFFSET UNITYSDK_OFFSET(0x171E1420)
#define CLASS_2_1A9D9F009A5DA850_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x171E1460)
#define CLASS_2_1A9D9F009A5DA850_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x171E14E0)
#define CLASS_2_1A9D9F009A5DA850_TICK_OFFSET UNITYSDK_OFFSET(0x171E1520)
#define CLASS_2_1A9D9F009A5DA850__CTOR_OFFSET UNITYSDK_OFFSET(0x171E1410)

inline static constexpr unsigned int Class_2_1A9D9F009A5DA850_TypeDefinitionIndex = 55630;

class Class_2_1A9D9F009A5DA850 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::MatchThreeV2ChangePropContainerVisible* Field_2_0; // 0x18
