...
#define CLASS_1_BADE65034284623D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159C3500)
#define CLASS_1_BADE65034284623D_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x159C37A0)
#define CLASS_1_BADE65034284623D_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x159C37C0)
#define CLASS_1_BADE65034284623D_METHOD_1_48D844B20A8C3D3D_OFFSET UNITYSDK_OFFSET(0x159C34A0)
#define CLASS_1_BADE65034284623D_METHOD_1_9CDBE8C36BC3E9A2_OFFSET UNITYSDK_OFFSET(0x159C36F0)
#define CLASS_1_BADE65034284623D_METHOD_1_ABA9FEAB38395BC4_OFFSET UNITYSDK_OFFSET(0x159C3550)
#define CLASS_1_BADE65034284623D_SET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x159C37B0)
#define CLASS_1_BADE65034284623D_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x159C37D0)
#define CLASS_1_BADE65034284623D__CTOR_OFFSET UNITYSDK_OFFSET(0x159C37E0)
