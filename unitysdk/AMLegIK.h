...
#define AMLEGIK_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x12EE9970)
#define AMLEGIK_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x12EF2B50)
#define AMLEGIK_CALCULATEPELVISTARGETADCANCE_OFFSET UNITYSDK_OFFSET(0x12EF3C50)
#define AMLEGIK_CALCULATEPELVISTARGETLEGACY_OFFSET UNITYSDK_OFFSET(0x12EF3920)
#define AMLEGIK_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x12EF4010)
#define AMLEGIK_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x12EEA6C0)
#define AMLEGIK_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x12EEC030)
#define AMLEGIK_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x12EE9910)
#define AMLEGIK_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x12EF1A80)
#define AMLEGIK_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x12EF32D0)
#define AMLEGIK_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12EED930)
#define AMLEGIK_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x12EED780)
#define AMLEGIK_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x12EE7F40)
#define AMLEGIK_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8150)
#define AMLEGIK_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE80F0)
#define AMLEGIK_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8090)
#define AMLEGIK_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8070)
#define AMLEGIK_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x12EE7D80)
#define AMLEGIK_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE80B0)
#define AMLEGIK_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8050)
#define AMLEGIK_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8170)
#define AMLEGIK_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE80D0)
#define AMLEGIK_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8190)
#define AMLEGIK_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8130)
#define AMLEGIK_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8110)
#define AMLEGIK_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x12EE81D0)
#define AMLEGIK_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x12EE81B0)
#define AMLEGIK_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x12EE7BC0)
#define AMLEGIK_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x12EE7BA0)
#define AMLEGIK_GET_REALPREDICTRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0x12EE7AA0)
#define AMLEGIK_GET_REALRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0x12EE79A0)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x12EECFF0)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTA_OFFSET UNITYSDK_OFFSET(0x12EECE50)
#define AMLEGIK_HITGROUNDIMPL_OFFSET UNITYSDK_OFFSET(0x12EEECD0)
#define AMLEGIK_HITGROUNDSIMPLEIMPL_OFFSET UNITYSDK_OFFSET(0x12EEDC40)
#define AMLEGIK_HITGROUND_OFFSET UNITYSDK_OFFSET(0x12EEBA20)
#define AMLEGIK_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x12EE9400)
#define AMLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x12EE81F0)
#define AMLEGIK_INITSCENEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x12EE9770)
#define AMLEGIK_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x12EED280)
#define AMLEGIK_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x12EEBC70)
#define AMLEGIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12EF5DF0)
#define AMLEGIK_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x12EEC1E0)
#define AMLEGIK_MAXHIPSDELTA_OFFSET UNITYSDK_OFFSET(0x12EF3840)
#define AMLEGIK_MINHIPSDELTA_OFFSET UNITYSDK_OFFSET(0x12EF3760)
#define AMLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x12EF5790)
#define AMLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12EF5110)
#define AMLEGIK_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x12EF4CC0)
#define AMLEGIK_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x12EF0710)
#define AMLEGIK_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x12EEBBF0)
#define AMLEGIK_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x12EEAF60)
#define AMLEGIK_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x12EF0A50)
#define AMLEGIK_PREPARE_OFFSET UNITYSDK_OFFSET(0x12EE9B30)
#define AMLEGIK_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x12EECA60)
#define AMLEGIK_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x12EEBF30)
#define AMLEGIK_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x12EE7FE0)
#define AMLEGIK_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x12EF30A0)
#define AMLEGIK_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x12EE7E10)
#define AMLEGIK_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x12EE7C00)
#define AMLEGIK_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8160)
#define AMLEGIK_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8100)
#define AMLEGIK_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE80A0)
#define AMLEGIK_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8080)
#define AMLEGIK_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE80C0)
#define AMLEGIK_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8060)
#define AMLEGIK_SET_ENABLEPELVISIKROT_OFFSET UNITYSDK_OFFSET(0x12EE7DE0)
#define AMLEGIK_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8180)
#define AMLEGIK_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE80E0)
#define AMLEGIK_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE81A0)
#define AMLEGIK_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8140)
#define AMLEGIK_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x12EE8120)
#define AMLEGIK_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x12EE81E0)
#define AMLEGIK_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x12EE81C0)
#define AMLEGIK_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x12EE7BE0)
#define AMLEGIK_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x12EE7BB0)
#define AMLEGIK_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x12EE7C10)
#define AMLEGIK_SET_PELVISCASTDIST_OFFSET UNITYSDK_OFFSET(0x12EE7E00)
#define AMLEGIK_SET_PELVISIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x12EE7DF0)
#define AMLEGIK_START_OFFSET UNITYSDK_OFFSET(0x12EF4F40)
#define AMLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x12EF52E0)
#define AMLEGIK__CCTOR_OFFSET UNITYSDK_OFFSET(0x12EF5FA0)
#define AMLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x12EF5E50)

inline static constexpr unsigned int AMLegIK_TypeDefinitionIndex = 60609;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0x334A0);
	}
	static ::System::Single* StaticGet_RayCastHeightOnMovingPlatform()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0xCA80);
	}
