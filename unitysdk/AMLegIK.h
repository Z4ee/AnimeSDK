...
#define AMLEGIK_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x171CF9C0)
#define AMLEGIK_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x171D8A00)
#define AMLEGIK_CALCULATEPELVISTARGETADCANCE_OFFSET UNITYSDK_OFFSET(0x171D9AF0)
#define AMLEGIK_CALCULATEPELVISTARGETLEGACY_OFFSET UNITYSDK_OFFSET(0x171D97B0)
#define AMLEGIK_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x171D9EE0)
#define AMLEGIK_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x171D0650)
#define AMLEGIK_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x171D1FB0)
#define AMLEGIK_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x171CF960)
#define AMLEGIK_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x171D7910)
#define AMLEGIK_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x171D9160)
#define AMLEGIK_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x171D3830)
#define AMLEGIK_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x171D3680)
#define AMLEGIK_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x171CDEF0)
#define AMLEGIK_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE120)
#define AMLEGIK_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE0C0)
#define AMLEGIK_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE060)
#define AMLEGIK_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE040)
#define AMLEGIK_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x171CDD30)
#define AMLEGIK_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE080)
#define AMLEGIK_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE020)
#define AMLEGIK_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE140)
#define AMLEGIK_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE0A0)
#define AMLEGIK_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE160)
#define AMLEGIK_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE100)
#define AMLEGIK_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE0E0)
#define AMLEGIK_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x171CE1A0)
#define AMLEGIK_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x171CE180)
#define AMLEGIK_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x171CDB90)
#define AMLEGIK_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x171CDB70)
#define AMLEGIK_GET_REALPREDICTRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0x171CDA70)
#define AMLEGIK_GET_REALRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0x171CD970)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x171D2F40)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTA_OFFSET UNITYSDK_OFFSET(0x171D2DB0)
#define AMLEGIK_HITGROUNDIMPL_OFFSET UNITYSDK_OFFSET(0x171D4BA0)
#define AMLEGIK_HITGROUNDSIMPLEIMPL_OFFSET UNITYSDK_OFFSET(0x171D3B40)
#define AMLEGIK_HITGROUND_OFFSET UNITYSDK_OFFSET(0x171D19A0)
#define AMLEGIK_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x171CF3E0)
#define AMLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x171CE1C0)
#define AMLEGIK_INITSCENEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x171CF760)
#define AMLEGIK_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x171D31A0)
#define AMLEGIK_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x171D1BF0)
#define AMLEGIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x171DBCB0)
#define AMLEGIK_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x171D2160)
#define AMLEGIK_MAXHIPSDELTA_OFFSET UNITYSDK_OFFSET(0x171D96D0)
#define AMLEGIK_MINHIPSDELTA_OFFSET UNITYSDK_OFFSET(0x171D95F0)
#define AMLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x171DB640)
#define AMLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x171DAFB0)
#define AMLEGIK_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x171DAB60)
#define AMLEGIK_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x171D65E0)
#define AMLEGIK_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x171D1B70)
#define AMLEGIK_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x171D0EE0)
#define AMLEGIK_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x171D6920)
#define AMLEGIK_PREPARE_OFFSET UNITYSDK_OFFSET(0x171CFB80)
#define AMLEGIK_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x171D29C0)
#define AMLEGIK_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x171D1EB0)
#define AMLEGIK_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x171CDFB0)
#define AMLEGIK_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x171D8F30)
#define AMLEGIK_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x171CDDC0)
#define AMLEGIK_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x171CDBD0)
#define AMLEGIK_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE130)
#define AMLEGIK_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE0D0)
#define AMLEGIK_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE070)
#define AMLEGIK_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE050)
#define AMLEGIK_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE090)
#define AMLEGIK_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE030)
#define AMLEGIK_SET_ENABLEPELVISIKROT_OFFSET UNITYSDK_OFFSET(0x171CDD90)
#define AMLEGIK_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE150)
#define AMLEGIK_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE0B0)
#define AMLEGIK_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE170)
#define AMLEGIK_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE110)
#define AMLEGIK_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x171CE0F0)
#define AMLEGIK_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x171CE1B0)
#define AMLEGIK_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x171CE190)
#define AMLEGIK_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x171CDBB0)
#define AMLEGIK_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x171CDB80)
#define AMLEGIK_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x171CDBE0)
#define AMLEGIK_SET_PELVISCASTDIST_OFFSET UNITYSDK_OFFSET(0x171CDDB0)
#define AMLEGIK_SET_PELVISIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x171CDDA0)
#define AMLEGIK_START_OFFSET UNITYSDK_OFFSET(0x171DADE0)
#define AMLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x171DB180)
#define AMLEGIK__CCTOR_OFFSET UNITYSDK_OFFSET(0x171DBE60)
#define AMLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x171DBD10)

inline static constexpr unsigned int AMLegIK_TypeDefinitionIndex = 72585;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0x383E0);
	}
	static ::System::Single* StaticGet_RayCastHeightOnMovingPlatform()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0xD5E0);
	}
