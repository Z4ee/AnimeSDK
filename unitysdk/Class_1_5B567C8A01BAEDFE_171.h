...
#define CLASS_1_5B567C8A01BAEDFE_171_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C48DFE0)
#define CLASS_1_5B567C8A01BAEDFE_171_CLONE_OFFSET UNITYSDK_OFFSET(0x1C48DC80)
#define CLASS_1_5B567C8A01BAEDFE_171_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C48DDE0)
#define CLASS_1_5B567C8A01BAEDFE_171_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C48DCF0)
#define CLASS_1_5B567C8A01BAEDFE_171_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C48DF40)
#define CLASS_1_5B567C8A01BAEDFE_171_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C48E030)
#define CLASS_1_5B567C8A01BAEDFE_171_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C48E000)
#define CLASS_1_5B567C8A01BAEDFE_171_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C48DBD0)
#define CLASS_1_5B567C8A01BAEDFE_171_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C48DC30)
#define CLASS_1_5B567C8A01BAEDFE_171_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C48DF70)
#define CLASS_1_5B567C8A01BAEDFE_171_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C48DFD0)
#define CLASS_1_5B567C8A01BAEDFE_171__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C48E080)
#define CLASS_1_5B567C8A01BAEDFE_171__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C48DC50)
#define CLASS_1_5B567C8A01BAEDFE_171__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48DC40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_171_TypeDefinitionIndex = 28744;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_171*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_171_TypeDefinitionIndex)->GetStaticField(0x46CF0);
	}
