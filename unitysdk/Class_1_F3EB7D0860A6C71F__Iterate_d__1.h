...
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9582090)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_ACTIVITYBENEFITV2CONFIGDATA__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9582270)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_ACTIVITYBENEFITV2CONFIGDATA__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9582200)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x95822D0)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9582260)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9582210)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9582060)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x9581E60)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x9582080)

inline static constexpr unsigned int Class_1_F3EB7D0860A6C71F__Iterate_d__1_TypeDefinitionIndex = 56626;

class Class_1_F3EB7D0860A6C71F__Iterate_d__1 : public ::System::Object
{
public:
	::Class_1_CC0F8AEEF044EF7C* __2__current; // 0x10
	::RPG::GameCore::FixEnumerator_2<::RPG::GameCore::CommonIndexKey, ::Class_1_8941747EC3470DB6*> _iter_5__2; // 0x18
	::Class_1_F3EB7D0860A6C71F* __4__this; // 0x58
