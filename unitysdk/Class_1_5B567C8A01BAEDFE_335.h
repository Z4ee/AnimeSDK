...
#define CLASS_1_5B567C8A01BAEDFE_335_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED9C6B0)
#define CLASS_1_5B567C8A01BAEDFE_335_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED9C3A0)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED9C4B0)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED9C3E0)
#define CLASS_1_5B567C8A01BAEDFE_335_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED9C610)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED9C700)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED9C6D0)
#define CLASS_1_5B567C8A01BAEDFE_335_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ED9C320)
#define CLASS_1_5B567C8A01BAEDFE_335_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED9C350)
#define CLASS_1_5B567C8A01BAEDFE_335_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED9C640)
#define CLASS_1_5B567C8A01BAEDFE_335_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED9C6A0)
#define CLASS_1_5B567C8A01BAEDFE_335__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED9C750)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED9C370)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED9C360)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_335_TypeDefinitionIndex = 33540;

class Class_1_5B567C8A01BAEDFE_335 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_335*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_335*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_335_TypeDefinitionIndex)->GetStaticField(0x62620);
	}
