...
#define CLASS_1_5B567C8A01BAEDFE_335_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AB1A610)
#define CLASS_1_5B567C8A01BAEDFE_335_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB1A420)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AB1A520)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB1A490)
#define CLASS_1_5B567C8A01BAEDFE_335_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB1A570)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AB1A660)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AB1A630)
#define CLASS_1_5B567C8A01BAEDFE_335_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1AB1A370)
#define CLASS_1_5B567C8A01BAEDFE_335_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AB1A3D0)
#define CLASS_1_5B567C8A01BAEDFE_335_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB1A5A0)
#define CLASS_1_5B567C8A01BAEDFE_335_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AB1A600)
#define CLASS_1_5B567C8A01BAEDFE_335__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB1A6B0)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB1A3F0)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB1A3E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_335_TypeDefinitionIndex = 31871;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_335*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_335_TypeDefinitionIndex)->GetStaticField(0x169C0);
	}
