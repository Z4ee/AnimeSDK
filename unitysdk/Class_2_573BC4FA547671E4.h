...
#define CLASS_2_573BC4FA547671E4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0A5640)
#define CLASS_2_573BC4FA547671E4_METHOD_2_7892395233F7417A_OFFSET UNITYSDK_OFFSET(0xC0A5EB0)
#define CLASS_2_573BC4FA547671E4_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xC0A56F0)
#define CLASS_2_573BC4FA547671E4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC0A5780)
#define CLASS_2_573BC4FA547671E4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC0A5F70)
#define CLASS_2_573BC4FA547671E4_TICK_OFFSET UNITYSDK_OFFSET(0xC0A6020)
#define CLASS_2_573BC4FA547671E4__CTOR_OFFSET UNITYSDK_OFFSET(0xC0A5630)
...
{
public:
	::RPG::GameCore::TargetAlias* KLBJAHFMKHD; // 0x18
	::Class_3_07C3C4D2990C49EE* HFOFIODMFGB; // 0x20
	::RPG::GameCore::TriggerEntityColliderCameraConfig* OFKGLJOAMLD; // 0x28
