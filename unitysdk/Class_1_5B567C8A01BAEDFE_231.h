...
#define CLASS_1_5B567C8A01BAEDFE_231_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A851C20)
#define CLASS_1_5B567C8A01BAEDFE_231_CLONE_OFFSET UNITYSDK_OFFSET(0x1A851A90)
#define CLASS_1_5B567C8A01BAEDFE_231_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A851B30)
#define CLASS_1_5B567C8A01BAEDFE_231_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A851AD0)
#define CLASS_1_5B567C8A01BAEDFE_231_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A851B80)
#define CLASS_1_5B567C8A01BAEDFE_231_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A851C70)
#define CLASS_1_5B567C8A01BAEDFE_231_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A851C40)
#define CLASS_1_5B567C8A01BAEDFE_231_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A851A10)
#define CLASS_1_5B567C8A01BAEDFE_231_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A851A40)
#define CLASS_1_5B567C8A01BAEDFE_231_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A851BB0)
#define CLASS_1_5B567C8A01BAEDFE_231_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A851C10)
#define CLASS_1_5B567C8A01BAEDFE_231__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A851CC0)
#define CLASS_1_5B567C8A01BAEDFE_231__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A851A60)
#define CLASS_1_5B567C8A01BAEDFE_231__CTOR_OFFSET UNITYSDK_OFFSET(0x1A851A50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_231_TypeDefinitionIndex = 29579;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_231*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_231_TypeDefinitionIndex)->GetStaticField(0x517F0);
	}
