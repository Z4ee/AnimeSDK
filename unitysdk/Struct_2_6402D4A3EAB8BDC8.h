...
#define STRUCT_2_6402D4A3EAB8BDC8_METHOD_2_0D3CEA11284B35A1_1_OFFSET UNITYSDK_OFFSET(0xF5C3FE0)
#define STRUCT_2_6402D4A3EAB8BDC8_METHOD_2_0D3CEA11284B35A1_OFFSET UNITYSDK_OFFSET(0xF5AF2D0)
#define STRUCT_2_6402D4A3EAB8BDC8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x5EE400)
#define STRUCT_2_6402D4A3EAB8BDC8__CCTOR_OFFSET UNITYSDK_OFFSET(0xF5C3FC0)
#define STRUCT_2_6402D4A3EAB8BDC8__CTOR_OFFSET UNITYSDK_OFFSET(0x2B66C0)

inline static constexpr unsigned int Struct_2_6402D4A3EAB8BDC8_TypeDefinitionIndex = 57551;

struct alignas(4) Struct_2_6402D4A3EAB8BDC8
{
	static ::Struct_2_6402D4A3EAB8BDC8* StaticGet_Field_2_1()
	{
		return (::Struct_2_6402D4A3EAB8BDC8*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6402D4A3EAB8BDC8_TypeDefinitionIndex)->GetStaticField(0xAC50);
	}
