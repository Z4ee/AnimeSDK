...
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_CREATEHANDLEINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55AD80)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_CREATEHANDLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C55AD10)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9EB800)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_GETHANDLE_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_GET_NULL_OFFSET UNITYSDK_OFFSET(0x1C55A940)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C55AB20)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_SETPROCESSINPUTSINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55AD90)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_SETPROCESSINPUTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C55ACA0)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE_SETPROCESSINPUTS_OFFSET UNITYSDK_OFFSET(0x9EB8B0)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C55ADA0)
#define UNITYENGINE_ANIMATIONS_ANIMATIONSCRIPTPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB680)

namespace UnityEngine::Animations
{
	inline static constexpr unsigned int AnimationScriptPlayable_TypeDefinitionIndex = 6601;

	struct alignas(8) AnimationScriptPlayable
	{
		static ::UnityEngine::Animations::AnimationScriptPlayable* StaticGet_m_NullPlayable()
		{
			return (::UnityEngine::Animations::AnimationScriptPlayable*)Il2CppClass::FromTypeDefinitionIndex(AnimationScriptPlayable_TypeDefinitionIndex)->GetStaticField(0x3100);
		}
