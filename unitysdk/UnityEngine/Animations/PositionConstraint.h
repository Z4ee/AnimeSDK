...
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_ADDSOURCE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54AD40)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_ADDSOURCE_OFFSET UNITYSDK_OFFSET(0x1C54AD30)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCECOUNTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54AC80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCEINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54AF20)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54AEE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCES_OFFSET UNITYSDK_OFFSET(0x1C54AC90)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x1C54AE90)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_CONSTRAINTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C54AC30)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_LOCKED_OFFSET UNITYSDK_OFFSET(0x1C54AC50)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_SOURCECOUNT_OFFSET UNITYSDK_OFFSET(0x1C54AC70)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONATREST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54AB60)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONATREST_OFFSET UNITYSDK_OFFSET(0x1C54AB10)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1C54AC10)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54ABE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1C54AB90)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1C54AAF0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1C54AAE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_REMOVESOURCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54AE80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_REMOVESOURCE_OFFSET UNITYSDK_OFFSET(0x1C54AD50)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCEINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54AF80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54AF70)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54AD20)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCES_OFFSET UNITYSDK_OFFSET(0x1C54ACA0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCE_OFFSET UNITYSDK_OFFSET(0x1C54AF30)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_CONSTRAINTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C54AC40)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_LOCKED_OFFSET UNITYSDK_OFFSET(0x1C54AC60)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONATREST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54AB80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONATREST_OFFSET UNITYSDK_OFFSET(0x1C54AB70)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1C54AC20)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54AC00)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1C54ABF0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1C54AB00)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_VALIDATESOURCEINDEX_OFFSET UNITYSDK_OFFSET(0x1C54AD80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54AA80)

namespace UnityEngine::Animations
{
	inline static constexpr unsigned int PositionConstraint_TypeDefinitionIndex = 6613;
