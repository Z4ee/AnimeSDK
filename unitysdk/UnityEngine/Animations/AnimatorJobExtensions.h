...
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSCENEPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1C527B00)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C527AD0)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSCENETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C527A90)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSTREAMPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1C527A30)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSTREAMPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C5279E0)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSTREAMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C527980)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C527B40)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSCENETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C527AC0)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSTREAMPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C527A80)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSTREAMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C5279D0)

namespace UnityEngine::Animations
{
	inline static constexpr unsigned int AnimatorJobExtensions_TypeDefinitionIndex = 6608;
