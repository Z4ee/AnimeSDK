...
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DC0AC90)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_CHANGEEVENTMODULE_OFFSET UNITYSDK_OFFSET(0x1DC0B5B0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_EARLYUPDATE_OFFSET UNITYSDK_OFFSET(0x1DC0AF30)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_ALREADYSELECTING_OFFSET UNITYSDK_OFFSET(0x1DC07960)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_BASEEVENTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1DC07BA0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENTINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x1DC07490)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENTPOINTERCACHE_OFFSET UNITYSDK_OFFSET(0x1DC07440)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DC074C0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DC07140)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_ENABLEFASTRAYCAST_OFFSET UNITYSDK_OFFSET(0x1DC06F60)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_FIRSTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DC074A0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x1DC074E0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_LASTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DC074D0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_PIXELDRAGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1DC07470)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_SENDNAVIGATIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1DC07450)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_SHAREDRAYCASTCOMPARER_OFFSET UNITYSDK_OFFSET(0x1DC08830)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_SHAREDRAYCASTGRAPHICCOMPARER_OFFSET UNITYSDK_OFFSET(0x1DC09060)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ISPOINTEROVERGAMEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1DC09EB0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ISPOINTEROVERGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DC09E60)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1DC0AC40)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DC0ADE0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1DC0A140)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DC0A040)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTALL_OFFSET UNITYSDK_OFFSET(0x1DC090C0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTCOMPARER_OFFSET UNITYSDK_OFFSET(0x1DC07CF0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTGRAPHICCOMPARER_OFFSET UNITYSDK_OFFSET(0x1DC08890)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1DC09430)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SETSELECTEDGAMEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1DC07C30)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SETSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DC07970)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DC07230)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_ENABLEFASTRAYCAST_OFFSET UNITYSDK_OFFSET(0x1DC07010)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_FIRSTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DC074B0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_PIXELDRAGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1DC07480)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_SENDNAVIGATIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1DC07460)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_TICKMODULES_OFFSET UNITYSDK_OFFSET(0x1DC0A340)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_TICKRAYCASTTARGETS_OFFSET UNITYSDK_OFFSET(0x1DC0A530)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DC0B860)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_UPDATEIMPL_OFFSET UNITYSDK_OFFSET(0x1DC0B070)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_UPDATEMODULES_OFFSET UNITYSDK_OFFSET(0x1DC07630)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DC0AFD0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC0BBB0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC074F0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DC0BCC0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DC0BD50)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1DC0BDE0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DC0BE70)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DC0BF00)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int EventSystem_TypeDefinitionIndex = 19038;
	...
	public:
		...
		{
			return (::System::Comparison_1<::UnityEngine::EventSystems::RaycastResult>**)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x8870);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::EventSystem*>** StaticGet_m_EventSystems()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::EventSystems::EventSystem*>**)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x8878);
		}
		static ::System::Comparison_1<::UnityEngine::UI::Graphic*>** StaticGet_s_RaycastGraphicComparer()
		{
			return (::System::Comparison_1<::UnityEngine::UI::Graphic*>**)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x8880);
		}
		static ::System::Boolean* StaticGet_EnableUpdateBeforePhysics()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x43D0);
		}
		static ::System::Boolean* StaticGet_EnableDebugPrintMovingUI()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x43D1);
		}
		static ::System::Boolean* StaticGet_TemporaryDisableFastRaycast()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x43D2);
		}
		static ::System::Boolean* StaticGet_s_EnableFastRaycast()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x43D3);
		}
