...
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B843E70)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_CHANGEEVENTMODULE_OFFSET UNITYSDK_OFFSET(0x1B844790)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_EARLYUPDATE_OFFSET UNITYSDK_OFFSET(0x1B844110)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_ALREADYSELECTING_OFFSET UNITYSDK_OFFSET(0x1B840B40)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_BASEEVENTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1B840D80)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENTINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x1B840670)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENTPOINTERCACHE_OFFSET UNITYSDK_OFFSET(0x1B840620)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B8406A0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B840320)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_ENABLEFASTRAYCAST_OFFSET UNITYSDK_OFFSET(0x1B840140)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_FIRSTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B840680)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x1B8406C0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_LASTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B8406B0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_PIXELDRAGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B840650)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_SENDNAVIGATIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1B840630)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_SHAREDRAYCASTCOMPARER_OFFSET UNITYSDK_OFFSET(0x1B841A10)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_GET_SHAREDRAYCASTGRAPHICCOMPARER_OFFSET UNITYSDK_OFFSET(0x1B842240)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ISPOINTEROVERGAMEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B843090)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ISPOINTEROVERGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B843040)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1B843E20)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B843FC0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B843320)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B843220)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTALL_OFFSET UNITYSDK_OFFSET(0x1B8422A0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTCOMPARER_OFFSET UNITYSDK_OFFSET(0x1B840ED0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTGRAPHICCOMPARER_OFFSET UNITYSDK_OFFSET(0x1B841A70)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1B842610)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SETSELECTEDGAMEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B840E10)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SETSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B840B50)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B840410)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_ENABLEFASTRAYCAST_OFFSET UNITYSDK_OFFSET(0x1B8401F0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_FIRSTSELECTEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B840690)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_PIXELDRAGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B840660)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_SET_SENDNAVIGATIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1B840640)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_TICKMODULES_OFFSET UNITYSDK_OFFSET(0x1B843520)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_TICKRAYCASTTARGETS_OFFSET UNITYSDK_OFFSET(0x1B843710)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B844A40)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_UPDATEIMPL_OFFSET UNITYSDK_OFFSET(0x1B844250)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_UPDATEMODULES_OFFSET UNITYSDK_OFFSET(0x1B840810)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B8441B0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B844D90)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8406D0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B844E90)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B844F20)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B844FB0)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B845040)
#define UNITYENGINE_EVENTSYSTEMS_EVENTSYSTEM___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B8450D0)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int EventSystem_TypeDefinitionIndex = 8529;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x3B50);
		}
		static ::System::Boolean* StaticGet_EnableUpdateBeforePhysics()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x3B51);
		}
		static ::System::Boolean* StaticGet_EnableDebugPrintMovingUI()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x3B52);
		}
		static ::System::Boolean* StaticGet_TemporaryDisableFastRaycast()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EventSystem_TypeDefinitionIndex)->GetStaticField(0x3B53);
		}
