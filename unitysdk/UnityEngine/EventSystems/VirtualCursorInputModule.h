...
#define UNITYENGINE_EVENTSYSTEMS_VIRTUALCURSORINPUTMODULE_ONGUI_OFFSET UNITYSDK_OFFSET(0xB9A6AF0)
#define UNITYENGINE_EVENTSYSTEMS_VIRTUALCURSORINPUTMODULE_PROCESS_OFFSET UNITYSDK_OFFSET(0xB9A64C0)
#define UNITYENGINE_EVENTSYSTEMS_VIRTUALCURSORINPUTMODULE_START_OFFSET UNITYSDK_OFFSET(0xB9A6390)
#define UNITYENGINE_EVENTSYSTEMS_VIRTUALCURSORINPUTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A6DE0)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int VirtualCursorInputModule_TypeDefinitionIndex = 44499;
