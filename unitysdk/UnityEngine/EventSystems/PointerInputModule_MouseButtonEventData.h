...
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA_PRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1B37CEB0)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA_RELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1B37CEC0)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37CED0)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int PointerInputModule_MouseButtonEventData_TypeDefinitionIndex = 6099;
