...
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA_PRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1C1545C0)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA_RELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1C154610)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C154660)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int PointerInputModule_MouseButtonEventData_TypeDefinitionIndex = 8542;
