...
#define UNITYENGINE_SCRIPTING_SCRIPTINGSTRINGHELPER_MODIFYSTRINGBYNATIVESTRING_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DCDA310)
#define UNITYENGINE_SCRIPTING_SCRIPTINGSTRINGHELPER_MODIFYSTRINGBYNATIVESTRING_OFFSET UNITYSDK_OFFSET(0x1DCDA2F0)
#define UNITYENGINE_SCRIPTING_SCRIPTINGSTRINGHELPER_MODIFYSTRING_OFFSET UNITYSDK_OFFSET(0x1DCDA280)
