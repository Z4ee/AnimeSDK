...
#define UNITYENGINE_TEXTASSET_CASTTOSCRIPTINGSTRING_OFFSET UNITYSDK_OFFSET(0x1E9562F0)
#define UNITYENGINE_TEXTASSET_GETRAWDATABYTELENGTH_OFFSET UNITYSDK_OFFSET(0x1E9562E0)
#define UNITYENGINE_TEXTASSET_GETRAWDATAPTR_OFFSET UNITYSDK_OFFSET(0x1E9562D0)
#define UNITYENGINE_TEXTASSET_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x1E956140)
#define UNITYENGINE_TEXTASSET_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1E949840)
#define UNITYENGINE_TEXTASSET_INTERNAL_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E9562C0)
#define UNITYENGINE_TEXTASSET_SETBYTES_OFFSET UNITYSDK_OFFSET(0x1E956150)
#define UNITYENGINE_TEXTASSET_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1E956130)
#define UNITYENGINE_TEXTASSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E956160)
#define UNITYENGINE_TEXTASSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E956250)
#define UNITYENGINE_TEXTASSET__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E9561D0)
#define UNITYENGINE_TEXTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E956170)

namespace UnityEngine
{
	inline static constexpr unsigned int TextAsset_TypeDefinitionIndex = 5363;
