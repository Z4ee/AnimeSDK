...
#define UNITYENGINE_TEXTASSET_CASTTOSCRIPTINGSTRING_OFFSET UNITYSDK_OFFSET(0x1B18F250)
#define UNITYENGINE_TEXTASSET_GETRAWDATABYTELENGTH_OFFSET UNITYSDK_OFFSET(0x1B18F240)
#define UNITYENGINE_TEXTASSET_GETRAWDATAPTR_OFFSET UNITYSDK_OFFSET(0x1B18F230)
#define UNITYENGINE_TEXTASSET_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x1B18F0A0)
#define UNITYENGINE_TEXTASSET_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1B182450)
#define UNITYENGINE_TEXTASSET_INTERNAL_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B18F220)
#define UNITYENGINE_TEXTASSET_SETBYTES_OFFSET UNITYSDK_OFFSET(0x1B18F0B0)
#define UNITYENGINE_TEXTASSET_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1B18F090)
#define UNITYENGINE_TEXTASSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B18F0C0)
#define UNITYENGINE_TEXTASSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B18F1B0)
#define UNITYENGINE_TEXTASSET__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B18F130)
#define UNITYENGINE_TEXTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18F0D0)
