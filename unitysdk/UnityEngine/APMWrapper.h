...
#define UNITYENGINE_APMWRAPPER_GAMELOGREPORT_OFFSET UNITYSDK_OFFSET(0x1C560CF0)
#define UNITYENGINE_APMWRAPPER_INIT_OFFSET UNITYSDK_OFFSET(0x1C560CB0)
#define UNITYENGINE_APMWRAPPER_SETAPPINFO_OFFSET UNITYSDK_OFFSET(0x1C560D00)
#define UNITYENGINE_APMWRAPPER_SETCONFIG_OFFSET UNITYSDK_OFFSET(0x1C560CC0)
#define UNITYENGINE_APMWRAPPER_SETCUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x1C560CE0)
#define UNITYENGINE_APMWRAPPER_SETUSERID_OFFSET UNITYSDK_OFFSET(0x1C560D10)
#define UNITYENGINE_APMWRAPPER_SETWORKPATH_OFFSET UNITYSDK_OFFSET(0x1C560CD0)
#define UNITYENGINE_APMWRAPPER_START_OFFSET UNITYSDK_OFFSET(0x1C560D20)

namespace UnityEngine
{
	inline static constexpr unsigned int APMWrapper_TypeDefinitionIndex = 37669;
