...
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D0F8AB0)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D0F8AE0)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D0F8700)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F8A90)

namespace UnityEngine
{
	inline static constexpr unsigned int GUISkin_SkinChangedDelegate_TypeDefinitionIndex = 6416;
