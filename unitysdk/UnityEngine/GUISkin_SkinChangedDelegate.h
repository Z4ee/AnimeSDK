...
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AED0E20)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AED0E50)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AED0C50)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AED0DB0)

namespace UnityEngine
{
	inline static constexpr unsigned int GUISkin_SkinChangedDelegate_TypeDefinitionIndex = 5228;
