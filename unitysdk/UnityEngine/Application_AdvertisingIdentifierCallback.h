...
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ED09BE0)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ED09C50)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ED07800)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED09B60)
