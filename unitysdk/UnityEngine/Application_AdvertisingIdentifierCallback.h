...
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E1E5B50)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E1E5BC0)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E1E3770)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1E5AD0)

namespace UnityEngine
{
	inline static constexpr unsigned int Application_AdvertisingIdentifierCallback_TypeDefinitionIndex = 4027;
