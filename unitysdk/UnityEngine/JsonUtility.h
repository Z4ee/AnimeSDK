...
#define UNITYENGINE_JSONUTILITY_FROMJSONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D303A20)
#define UNITYENGINE_JSONUTILITY_FROMJSONOVERWRITE_OFFSET UNITYSDK_OFFSET(0x1D303D10)
#define UNITYENGINE_JSONUTILITY_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1D303B20)
#define UNITYENGINE_JSONUTILITY_TOJSONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D303A10)
#define UNITYENGINE_JSONUTILITY_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1D303A40)
#define UNITYENGINE_JSONUTILITY_TOJSON_OFFSET UNITYSDK_OFFSET(0x1D303A30)

namespace UnityEngine
{
	inline static constexpr unsigned int JsonUtility_TypeDefinitionIndex = 5714;
