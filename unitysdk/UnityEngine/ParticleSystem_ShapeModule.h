...
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB400)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xA44C60)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_MESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB4E0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0xA44CD0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_RADIUS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB480)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0xA44CA0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SHAPETYPE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB440)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SHAPETYPE_OFFSET UNITYSDK_OFFSET(0xA44C80)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SKINNEDMESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB520)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0xA44CF0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB420)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0xA44C70)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB500)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0xA44CE0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB4C0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESH_OFFSET UNITYSDK_OFFSET(0xA44CC0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_RADIUS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB4A0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0xA44CB0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB560)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SCALE_OFFSET UNITYSDK_OFFSET(0xA44D10)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SHAPETYPE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB460)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SHAPETYPE_OFFSET UNITYSDK_OFFSET(0xA44C90)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SKINNEDMESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DDFB540)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0xA44D00)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x2B6D10)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleSystem_ShapeModule_TypeDefinitionIndex = 18762;
