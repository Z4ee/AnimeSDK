...
#define UNITYENGINE_DEFAULTEXECUTIONORDER_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x1E3150F0)
#define UNITYENGINE_DEFAULTEXECUTIONORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3150E0)

namespace UnityEngine
{
	inline static constexpr unsigned int DefaultExecutionOrder_TypeDefinitionIndex = 5331;
