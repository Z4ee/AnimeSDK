...
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1FC525B0)
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST_SYNC_OFFSET UNITYSDK_OFFSET(0x1FC525C0)
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC525D0)

namespace UnityEngine
{
	inline static constexpr unsigned int AssetBundleInstanceRequest_TypeDefinitionIndex = 7673;
