...
#define UNITYENGINE_COLLISION_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1ED9D4C0)
#define UNITYENGINE_COLLISION_GETCONTACTS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1ED9CFA0)
#define UNITYENGINE_COLLISION_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1ED9D430)
#define UNITYENGINE_COLLISION_GETCONTACT_OFFSET UNITYSDK_OFFSET(0x1ED9D320)
#define UNITYENGINE_COLLISION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ED9D560)
#define UNITYENGINE_COLLISION_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1ED9CFF0)
#define UNITYENGINE_COLLISION_GET_CONTACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1ED9D2A0)
#define UNITYENGINE_COLLISION_GET_CONTACTS_OFFSET UNITYSDK_OFFSET(0x1ED9D2B0)
#define UNITYENGINE_COLLISION_GET_FRICTIONFORCESUM_OFFSET UNITYSDK_OFFSET(0x1ED9D620)
#define UNITYENGINE_COLLISION_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ED9D150)
#define UNITYENGINE_COLLISION_GET_IMPACTFORCESUM_OFFSET UNITYSDK_OFFSET(0x1ED9D600)
#define UNITYENGINE_COLLISION_GET_IMPULSE_OFFSET UNITYSDK_OFFSET(0x1ED9D5E0)
#define UNITYENGINE_COLLISION_GET_OTHER_OFFSET UNITYSDK_OFFSET(0x1ED9D640)
#define UNITYENGINE_COLLISION_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1ED9CFC0)
#define UNITYENGINE_COLLISION_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1ED9CFE0)
#define UNITYENGINE_COLLISION_GET_SELFCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1ED9CFB0)
#define UNITYENGINE_COLLISION_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ED9D000)
#define UNITYENGINE_COLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED9D780)

namespace UnityEngine
{
	inline static constexpr unsigned int Collision_TypeDefinitionIndex = 7777;
