...
#define UNITYENGINE_PHYSICSSCENE2D_CIRCLECAST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C51B0)
#define UNITYENGINE_PHYSICSSCENE2D_CIRCLECAST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C5120)
#define UNITYENGINE_PHYSICSSCENE2D_CIRCLECAST_OFFSET UNITYSDK_OFFSET(0xAA2430)
#define UNITYENGINE_PHYSICSSCENE2D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x826600)
#define UNITYENGINE_PHYSICSSCENE2D_EQUALS_OFFSET UNITYSDK_OFFSET(0xAA1F00)
#define UNITYENGINE_PHYSICSSCENE2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNITYENGINE_PHYSICSSCENE2D_GETRAYINTERSECTIONARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C5280)
#define UNITYENGINE_PHYSICSSCENE2D_GETRAYINTERSECTIONARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C5250)
#define UNITYENGINE_PHYSICSSCENE2D_GETRAYINTERSECTION_1_OFFSET UNITYSDK_OFFSET(0xAA25B0)
#define UNITYENGINE_PHYSICSSCENE2D_GETRAYINTERSECTION_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C5240)
#define UNITYENGINE_PHYSICSSCENE2D_GETRAYINTERSECTION_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C51C0)
#define UNITYENGINE_PHYSICSSCENE2D_GETRAYINTERSECTION_OFFSET UNITYSDK_OFFSET(0xAA24F0)
#define UNITYENGINE_PHYSICSSCENE2D_LINECAST_1_OFFSET UNITYSDK_OFFSET(0xAA20A0)
#define UNITYENGINE_PHYSICSSCENE2D_LINECAST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C4FD0)
#define UNITYENGINE_PHYSICSSCENE2D_LINECAST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C4F50)
#define UNITYENGINE_PHYSICSSCENE2D_LINECAST_OFFSET UNITYSDK_OFFSET(0xAA1F60)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPCOLLIDERARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C52E0)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPCOLLIDERARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C52D0)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPCOLLIDERLIST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C5300)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPCOLLIDERLIST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C52F0)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPCOLLIDER_1_OFFSET UNITYSDK_OFFSET(0x1F3BEC10)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1F3BEBB0)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPPOINT_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C52C0)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPPOINT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C5290)
#define UNITYENGINE_PHYSICSSCENE2D_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0xAA2620)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCASTARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C50C0)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCASTARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C5080)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCASTLIST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C5110)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCASTLIST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C50D0)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0xAA22A0)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCAST_2_OFFSET UNITYSDK_OFFSET(0xAA2350)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCAST_3_OFFSET UNITYSDK_OFFSET(0xAA23C0)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCAST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C5070)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCAST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C4FE0)
#define UNITYENGINE_PHYSICSSCENE2D_RAYCAST_OFFSET UNITYSDK_OFFSET(0xAA2140)
#define UNITYENGINE_PHYSICSSCENE2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAA1EF0)

namespace UnityEngine
{
	inline static constexpr unsigned int PhysicsScene2D_TypeDefinitionIndex = 18777;
