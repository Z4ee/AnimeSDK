...
#define UNITYENGINE_CUBEMAP_APPLYIMPL_OFFSET UNITYSDK_OFFSET(0x1AAD38B0)
#define UNITYENGINE_CUBEMAP_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1AAD4240)
#define UNITYENGINE_CUBEMAP_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1AAD42C0)
#define UNITYENGINE_CUBEMAP_APPLY_OFFSET UNITYSDK_OFFSET(0x1AAD41C0)
#define UNITYENGINE_CUBEMAP_CLEARREQUESTEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAD3A70)
#define UNITYENGINE_CUBEMAP_CREATEEXTERNALTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AAD3FD0)
#define UNITYENGINE_CUBEMAP_GETPIXELIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AAD3950)
#define UNITYENGINE_CUBEMAP_GETPIXELIMPL_OFFSET UNITYSDK_OFFSET(0x1AAD3900)
#define UNITYENGINE_CUBEMAP_GETPIXELS_1_OFFSET UNITYSDK_OFFSET(0x1AAD3990)
#define UNITYENGINE_CUBEMAP_GETPIXELS_OFFSET UNITYSDK_OFFSET(0x1AAD3980)
#define UNITYENGINE_CUBEMAP_GETPIXEL_OFFSET UNITYSDK_OFFSET(0x1AAD4120)
#define UNITYENGINE_CUBEMAP_GET_DESIREDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAD3A40)
#define UNITYENGINE_CUBEMAP_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1AAD37F0)
#define UNITYENGINE_CUBEMAP_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1AAD38D0)
#define UNITYENGINE_CUBEMAP_GET_LOADALLMIPS_OFFSET UNITYSDK_OFFSET(0x1AAD3A20)
#define UNITYENGINE_CUBEMAP_GET_LOADEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAD3A60)
#define UNITYENGINE_CUBEMAP_GET_LOADINGMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAD3A50)
#define UNITYENGINE_CUBEMAP_GET_REQUESTEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAD3A00)
#define UNITYENGINE_CUBEMAP_GET_STREAMINGMIPMAPSPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AAD39F0)
#define UNITYENGINE_CUBEMAP_GET_STREAMINGMIPMAPS_OFFSET UNITYSDK_OFFSET(0x1AAD39E0)
#define UNITYENGINE_CUBEMAP_INTERNAL_CREATEIMPL_OFFSET UNITYSDK_OFFSET(0x1AAD3800)
#define UNITYENGINE_CUBEMAP_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAD3810)
#define UNITYENGINE_CUBEMAP_ISREQUESTEDMIPMAPLEVELLOADED_OFFSET UNITYSDK_OFFSET(0x1AAD3A80)
#define UNITYENGINE_CUBEMAP_SETPIXELDATAIMPLARRAY_OFFSET UNITYSDK_OFFSET(0x1AAD39B0)
#define UNITYENGINE_CUBEMAP_SETPIXELDATAIMPL_OFFSET UNITYSDK_OFFSET(0x1AAD39C0)
#define UNITYENGINE_CUBEMAP_SETPIXELIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AAD38F0)
#define UNITYENGINE_CUBEMAP_SETPIXELIMPL_OFFSET UNITYSDK_OFFSET(0x1AAD38E0)
#define UNITYENGINE_CUBEMAP_SETPIXELS_1_OFFSET UNITYSDK_OFFSET(0x1AAD39D0)
#define UNITYENGINE_CUBEMAP_SETPIXELS_OFFSET UNITYSDK_OFFSET(0x1AAD39A0)
#define UNITYENGINE_CUBEMAP_SETPIXEL_OFFSET UNITYSDK_OFFSET(0x1AAD4080)
#define UNITYENGINE_CUBEMAP_SET_LOADALLMIPS_OFFSET UNITYSDK_OFFSET(0x1AAD3A30)
#define UNITYENGINE_CUBEMAP_SET_REQUESTEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAD3A10)
#define UNITYENGINE_CUBEMAP_SMOOTHEDGES_1_OFFSET UNITYSDK_OFFSET(0x1AAD3970)
#define UNITYENGINE_CUBEMAP_SMOOTHEDGES_OFFSET UNITYSDK_OFFSET(0x1AAD3960)
#define UNITYENGINE_CUBEMAP_UPDATEEXTERNALTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AAD38C0)
#define UNITYENGINE_CUBEMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAD3AC0)
#define UNITYENGINE_CUBEMAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AAD3C50)
#define UNITYENGINE_CUBEMAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AAD3E00)
#define UNITYENGINE_CUBEMAP__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AAD3C70)
#define UNITYENGINE_CUBEMAP__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AAD3F60)
#define UNITYENGINE_CUBEMAP__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1AAD3F90)
#define UNITYENGINE_CUBEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD3A90)
