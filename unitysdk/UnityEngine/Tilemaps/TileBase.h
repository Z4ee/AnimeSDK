...
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEANIMATIONDATANOREF_OFFSET UNITYSDK_OFFSET(0x1E881730)
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x1E881720)
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEDATANOREF_OFFSET UNITYSDK_OFFSET(0x1E881650)
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEDATA_OFFSET UNITYSDK_OFFSET(0x1E881640)
#define UNITYENGINE_TILEMAPS_TILEBASE_REFRESHTILE_OFFSET UNITYSDK_OFFSET(0x1E881600)
#define UNITYENGINE_TILEMAPS_TILEBASE_STARTUP_OFFSET UNITYSDK_OFFSET(0x1E881790)
#define UNITYENGINE_TILEMAPS_TILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8815A0)

namespace UnityEngine::Tilemaps
{
	inline static constexpr unsigned int TileBase_TypeDefinitionIndex = 89791;
