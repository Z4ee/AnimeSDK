...
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_GETEXECUTECMDPTR_OFFSET UNITYSDK_OFFSET(0x1D2E72D0)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_GETINITCMDPTR_OFFSET UNITYSDK_OFFSET(0x1D2E7290)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_GET_EXECUTEDATA_OFFSET UNITYSDK_OFFSET(0x1D2E70C0)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_GET_FEATURESLOT_OFFSET UNITYSDK_OFFSET(0x1D2E70E0)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_GET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1D2E70A0)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_INIT_OFFSET UNITYSDK_OFFSET(0x1D2E7200)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0x1D2E7240)
#define UNITYENGINE_NVIDIA_DLSSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2E7100)

namespace UnityEngine::NVIDIA
{
	inline static constexpr unsigned int DLSSContext_TypeDefinitionIndex = 5013;
