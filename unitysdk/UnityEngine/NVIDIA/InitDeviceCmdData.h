...
#define UNITYENGINE_NVIDIA_INITDEVICECMDDATA_SET_APPDIR_OFFSET UNITYSDK_OFFSET(0xB7C0)
#define UNITYENGINE_NVIDIA_INITDEVICECMDDATA_SET_ENGINEVERSION_OFFSET UNITYSDK_OFFSET(0x95B0)
#define UNITYENGINE_NVIDIA_INITDEVICECMDDATA_SET_PROJECTID_OFFSET UNITYSDK_OFFSET(0xC630)

namespace UnityEngine::NVIDIA
{
	inline static constexpr unsigned int InitDeviceCmdData_TypeDefinitionIndex = 4999;
