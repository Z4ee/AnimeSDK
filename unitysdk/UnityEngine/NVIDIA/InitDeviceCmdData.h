...
#define UNITYENGINE_NVIDIA_INITDEVICECMDDATA_SET_APPDIR_OFFSET UNITYSDK_OFFSET(0xA4B360)
#define UNITYENGINE_NVIDIA_INITDEVICECMDDATA_SET_ENGINEVERSION_OFFSET UNITYSDK_OFFSET(0x7BE220)
#define UNITYENGINE_NVIDIA_INITDEVICECMDDATA_SET_PROJECTID_OFFSET UNITYSDK_OFFSET(0x164FF0)

namespace UnityEngine::NVIDIA
{
	inline static constexpr unsigned int InitDeviceCmdData_TypeDefinitionIndex = 5004;
