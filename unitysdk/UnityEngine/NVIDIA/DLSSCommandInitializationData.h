...
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_GET_OUTPUTRTHEIGHT_OFFSET UNITYSDK_OFFSET(0x15A8520)
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_GET_OUTPUTRTWIDTH_OFFSET UNITYSDK_OFFSET(0xD240)
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_GET_QUALITY_OFFSET UNITYSDK_OFFSET(0x68F0)
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SETFLAG_OFFSET UNITYSDK_OFFSET(0x22F0840)
...
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SET_INPUTRTWIDTH_OFFSET UNITYSDK_OFFSET(0x299E0)
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SET_OUTPUTRTHEIGHT_OFFSET UNITYSDK_OFFSET(0x22D8250)
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SET_OUTPUTRTWIDTH_OFFSET UNITYSDK_OFFSET(0xD250)
