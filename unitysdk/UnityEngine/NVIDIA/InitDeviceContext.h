...
#define UNITYENGINE_NVIDIA_INITDEVICECONTEXT_GETINITCMDPTR_OFFSET UNITYSDK_OFFSET(0x18A8D8E0)
#define UNITYENGINE_NVIDIA_INITDEVICECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8D490)

namespace UnityEngine::NVIDIA
{
	inline static constexpr unsigned int InitDeviceContext_TypeDefinitionIndex = 5171;
