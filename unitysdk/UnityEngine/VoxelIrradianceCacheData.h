...
#define UNITYENGINE_VOXELIRRADIANCECACHEDATA_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1ED78A70)
#define UNITYENGINE_VOXELIRRADIANCECACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED78A60)
