...
#define UNITYENGINE_LIGHTMAPSETTINGS_CHECKLIGHTMAPSANDAREADIRECT_OFFSET UNITYSDK_OFFSET(0x1D41B430)
#define UNITYENGINE_LIGHTMAPSETTINGS_GETKODAMAASSETPATH_OFFSET UNITYSDK_OFFSET(0x1D41B410)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_ENABLEKODAMALIGHTINGV2_OFFSET UNITYSDK_OFFSET(0x1D41B460)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_KODAMABINDATA_OFFSET UNITYSDK_OFFSET(0x1D41B3B0)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_LIGHTMAPS_OFFSET UNITYSDK_OFFSET(0x1D41B370)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_LIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1D41B390)
#define UNITYENGINE_LIGHTMAPSETTINGS_ISKODAMALIGHTINGV2_OFFSET UNITYSDK_OFFSET(0x1D41B450)
#define UNITYENGINE_LIGHTMAPSETTINGS_ISUSINGLIGHTSKYOC_OFFSET UNITYSDK_OFFSET(0x1D41B440)
#define UNITYENGINE_LIGHTMAPSETTINGS_LIGHTMAPAREADIRTEXTUREBYINDEX_OFFSET UNITYSDK_OFFSET(0x1D41B3F0)
#define UNITYENGINE_LIGHTMAPSETTINGS_LIGHTMAPLIGHTCOLORTEXTUREBYINDEX_OFFSET UNITYSDK_OFFSET(0x1D41B3E0)
#define UNITYENGINE_LIGHTMAPSETTINGS_LIGHTMAPSLENGTH_OFFSET UNITYSDK_OFFSET(0x1D41B3D0)
#define UNITYENGINE_LIGHTMAPSETTINGS_SETCURRENTKODAMARENDER_OFFSET UNITYSDK_OFFSET(0x1D41B400)
#define UNITYENGINE_LIGHTMAPSETTINGS_SETKODAMARENDER_OFFSET UNITYSDK_OFFSET(0x1D41B420)
#define UNITYENGINE_LIGHTMAPSETTINGS_SET_KODAMABINDATA_OFFSET UNITYSDK_OFFSET(0x1D41B3C0)
#define UNITYENGINE_LIGHTMAPSETTINGS_SET_LIGHTMAPS_OFFSET UNITYSDK_OFFSET(0x1D41B380)
#define UNITYENGINE_LIGHTMAPSETTINGS_SET_LIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1D41B3A0)
#define UNITYENGINE_LIGHTMAPSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41B320)
