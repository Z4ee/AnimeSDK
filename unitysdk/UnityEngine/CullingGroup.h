...
#define UNITYENGINE_CULLINGGROUP_DISPOSEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F344F10)
#define UNITYENGINE_CULLINGGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F344F20)
#define UNITYENGINE_CULLINGGROUP_FINALIZERFAILURE_OFFSET UNITYSDK_OFFSET(0x1F344F00)
#define UNITYENGINE_CULLINGGROUP_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1F344E90)
#define UNITYENGINE_CULLINGGROUP_GET_TARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x1F344F40)
#define UNITYENGINE_CULLINGGROUP_INIT_OFFSET UNITYSDK_OFFSET(0x1F344E80)
#define UNITYENGINE_CULLINGGROUP_QUERYINDICES_1_OFFSET UNITYSDK_OFFSET(0x1F344FB0)
#define UNITYENGINE_CULLINGGROUP_QUERYINDICES_OFFSET UNITYSDK_OFFSET(0x1F344F80)
#define UNITYENGINE_CULLINGGROUP_SENDEVENTS_OFFSET UNITYSDK_OFFSET(0x1F345020)
#define UNITYENGINE_CULLINGGROUP_SETBOUNDINGDISTANCES_OFFSET UNITYSDK_OFFSET(0x1F344FC0)
#define UNITYENGINE_CULLINGGROUP_SETBOUNDINGSPHERECOUNT_OFFSET UNITYSDK_OFFSET(0x1F344F70)
#define UNITYENGINE_CULLINGGROUP_SETBOUNDINGSPHERES_OFFSET UNITYSDK_OFFSET(0x1F344F60)
#define UNITYENGINE_CULLINGGROUP_SETDISTANCEREFERENCEPOINT_INTERNALVECTOR3_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F344FE0)
#define UNITYENGINE_CULLINGGROUP_SETDISTANCEREFERENCEPOINT_INTERNALVECTOR3_OFFSET UNITYSDK_OFFSET(0x1F344FD0)
#define UNITYENGINE_CULLINGGROUP_SETDISTANCEREFERENCEPOINT_OFFSET UNITYSDK_OFFSET(0x1F344FF0)
#define UNITYENGINE_CULLINGGROUP_SET_TARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x1F344F50)
#define UNITYENGINE_CULLINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F344E60)
