...
#define UNITYENGINE_GUILAYOUTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CACD360)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayoutOption_TypeDefinitionIndex = 5167;
