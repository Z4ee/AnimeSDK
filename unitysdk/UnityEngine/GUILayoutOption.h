...
#define UNITYENGINE_GUILAYOUTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC6A90)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayoutOption_TypeDefinitionIndex = 5222;
