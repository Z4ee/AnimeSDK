...
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1CE456B0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CE45820)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1CE457F0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_GET_STREAMPLAYER_OFFSET UNITYSDK_OFFSET(0x1CE45690)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_SET_STREAMPLAYER_OFFSET UNITYSDK_OFFSET(0x1CE456A0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1CE45680)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE458B0)

namespace UnityEngine::Formats::Alembic::Timeline
{
	inline static constexpr unsigned int AlembicShotAsset_TypeDefinitionIndex = 44613;
