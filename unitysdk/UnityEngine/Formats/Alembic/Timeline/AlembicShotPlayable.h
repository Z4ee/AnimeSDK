...
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTPLAYABLE_GET_STREAMPLAYER_OFFSET UNITYSDK_OFFSET(0x1B19DED0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTPLAYABLE_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B19DEF0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTPLAYABLE_SET_STREAMPLAYER_OFFSET UNITYSDK_OFFSET(0x1B19DEE0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19E020)

namespace UnityEngine::Formats::Alembic::Timeline
{
	inline static constexpr unsigned int AlembicShotPlayable_TypeDefinitionIndex = 42432;
