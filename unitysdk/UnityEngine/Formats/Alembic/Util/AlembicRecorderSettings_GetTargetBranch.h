...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GETTARGETBRANCH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B1A4C20)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GETTARGETBRANCH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B1A4C50)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GETTARGETBRANCH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B1A4A20)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GETTARGETBRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A4BB0)

namespace UnityEngine::Formats::Alembic::Util
{
	inline static constexpr unsigned int AlembicRecorderSettings_GetTargetBranch_TypeDefinitionIndex = 42437;
