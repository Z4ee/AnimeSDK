...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_BEGINRECORDING_OFFSET UNITYSDK_OFFSET(0x1B182BD0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CONSTRUCTTREE_OFFSET UNITYSDK_OFFSET(0x1B19E500)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B184110)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_ENDRECORDING_OFFSET UNITYSDK_OFFSET(0x1B183490)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETCURRENTTIMESAMPLINGINDEX_OFFSET UNITYSDK_OFFSET(0x1B19E450)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETTARGETS_OFFSET UNITYSDK_OFFSET(0x1B19E220)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1B19E200)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_RECORDING_OFFSET UNITYSDK_OFFSET(0x1B19E1F0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B19E110)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1B19E130)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_PROCESSRECORDING_OFFSET UNITYSDK_OFFSET(0x1B183640)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCAPTURERTABLE_OFFSET UNITYSDK_OFFSET(0x1B19E710)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCOMPONENTCAPTURER_OFFSET UNITYSDK_OFFSET(0x1B19EED0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1B19E210)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B19E120)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1B19E190)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_UPDATECAPTURENODES_OFFSET UNITYSDK_OFFSET(0x1B19F5C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1841F0)

namespace UnityEngine::Formats::Alembic::Util
{
	inline static constexpr unsigned int AlembicRecorder_TypeDefinitionIndex = 42440;
