...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_BEGINRECORDING_OFFSET UNITYSDK_OFFSET(0x1EA9C790)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CONSTRUCTTREE_OFFSET UNITYSDK_OFFSET(0x1EAB80D0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA9DCD0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_ENDRECORDING_OFFSET UNITYSDK_OFFSET(0x1EA9D050)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETCURRENTTIMESAMPLINGINDEX_OFFSET UNITYSDK_OFFSET(0x1EAB8020)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETTARGETS_OFFSET UNITYSDK_OFFSET(0x1EAB7DF0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1EAB7DD0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_RECORDING_OFFSET UNITYSDK_OFFSET(0x1EAB7DC0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1EAB7CE0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1EAB7D00)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_PROCESSRECORDING_OFFSET UNITYSDK_OFFSET(0x1EA9D200)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCAPTURERTABLE_OFFSET UNITYSDK_OFFSET(0x1EAB82E0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCOMPONENTCAPTURER_OFFSET UNITYSDK_OFFSET(0x1EAB8AB0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1EAB7DE0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1EAB7CF0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1EAB7D60)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_UPDATECAPTURENODES_OFFSET UNITYSDK_OFFSET(0x1EAB91A0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA9DDB0)

namespace UnityEngine::Formats::Alembic::Util
{
	inline static constexpr unsigned int AlembicRecorder_TypeDefinitionIndex = 44622;
