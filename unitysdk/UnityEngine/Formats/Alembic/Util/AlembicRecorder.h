...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_BEGINRECORDING_OFFSET UNITYSDK_OFFSET(0x1CE2A5E0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CONSTRUCTTREE_OFFSET UNITYSDK_OFFSET(0x1CE45EF0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CE2BB20)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_ENDRECORDING_OFFSET UNITYSDK_OFFSET(0x1CE2AEA0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETCURRENTTIMESAMPLINGINDEX_OFFSET UNITYSDK_OFFSET(0x1CE45E40)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETTARGETS_OFFSET UNITYSDK_OFFSET(0x1CE45C10)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1CE45BF0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_RECORDING_OFFSET UNITYSDK_OFFSET(0x1CE45BE0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1CE45B00)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1CE45B20)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_PROCESSRECORDING_OFFSET UNITYSDK_OFFSET(0x1CE2B050)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCAPTURERTABLE_OFFSET UNITYSDK_OFFSET(0x1CE46100)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCOMPONENTCAPTURER_OFFSET UNITYSDK_OFFSET(0x1CE468D0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1CE45C00)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1CE45B10)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1CE45B80)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_UPDATECAPTURENODES_OFFSET UNITYSDK_OFFSET(0x1CE46FC0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE2BC00)
