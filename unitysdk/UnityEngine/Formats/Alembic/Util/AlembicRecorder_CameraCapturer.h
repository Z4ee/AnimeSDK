...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER_CAPTURE_1_OFFSET UNITYSDK_OFFSET(0x1B19FE80)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER_CAPTURE_OFFSET UNITYSDK_OFFSET(0x1B19FDC0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER_SETUP_OFFSET UNITYSDK_OFFSET(0x1B19FC50)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19FFC0)

namespace UnityEngine::Formats::Alembic::Util
{
	inline static constexpr unsigned int AlembicRecorder_CameraCapturer_TypeDefinitionIndex = 42450;
