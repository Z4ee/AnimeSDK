...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CAPTURE_B__0_OFFSET UNITYSDK_OFFSET(0x1CE49A10)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CAPTURE_B__1_OFFSET UNITYSDK_OFFSET(0x1CE49A50)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CAPTURE_B__2_OFFSET UNITYSDK_OFFSET(0x1CE49A90)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE49720)
