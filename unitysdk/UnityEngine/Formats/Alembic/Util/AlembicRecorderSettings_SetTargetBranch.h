...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D3045C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D3045F0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3045B0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D304540)

namespace UnityEngine::Formats::Alembic::Util
{
	inline static constexpr unsigned int AlembicRecorderSettings_SetTargetBranch_TypeDefinitionIndex = 42436;
