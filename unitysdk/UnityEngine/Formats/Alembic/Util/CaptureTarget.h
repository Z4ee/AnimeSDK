...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_CAPTURETARGET_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1F012FE0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_CAPTURETARGET_SET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1F012FF0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_CAPTURETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F013000)
