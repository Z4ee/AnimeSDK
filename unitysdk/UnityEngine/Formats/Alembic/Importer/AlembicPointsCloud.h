...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_BOUNDSCENTER_OFFSET UNITYSDK_OFFSET(0x1B037090)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_BOUNDSEXTENTS_OFFSET UNITYSDK_OFFSET(0x1B0370C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_IDSLIST_OFFSET UNITYSDK_OFFSET(0x1B037020)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_IDS_OFFSET UNITYSDK_OFFSET(0x1B037070)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_POINTSLIST_OFFSET UNITYSDK_OFFSET(0x1B037000)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x1B037030)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_VELOCITIESLIST_OFFSET UNITYSDK_OFFSET(0x1B037010)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0x1B037050)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B037180)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_RESET_OFFSET UNITYSDK_OFFSET(0x1B0370F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_SET_BOUNDSCENTER_OFFSET UNITYSDK_OFFSET(0x1B0370B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_SET_BOUNDSEXTENTS_OFFSET UNITYSDK_OFFSET(0x1B0370E0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B037320)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicPointsCloud_TypeDefinitionIndex = 41701;
