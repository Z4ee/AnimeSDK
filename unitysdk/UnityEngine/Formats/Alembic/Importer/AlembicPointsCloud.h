...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_BOUNDSCENTER_OFFSET UNITYSDK_OFFSET(0x1EAA7100)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_BOUNDSEXTENTS_OFFSET UNITYSDK_OFFSET(0x1EAA7130)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_IDSLIST_OFFSET UNITYSDK_OFFSET(0x1EAA7090)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_IDS_OFFSET UNITYSDK_OFFSET(0x1EAA70E0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_POINTSLIST_OFFSET UNITYSDK_OFFSET(0x1EAA7070)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x1EAA70A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_VELOCITIESLIST_OFFSET UNITYSDK_OFFSET(0x1EAA7080)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0x1EAA70C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EAA71F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_RESET_OFFSET UNITYSDK_OFFSET(0x1EAA7160)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_SET_BOUNDSCENTER_OFFSET UNITYSDK_OFFSET(0x1EAA7120)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_SET_BOUNDSEXTENTS_OFFSET UNITYSDK_OFFSET(0x1EAA7150)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAA7240)
