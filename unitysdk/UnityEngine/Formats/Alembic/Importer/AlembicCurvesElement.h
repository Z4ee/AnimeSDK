...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_ABCSETUP_OFFSET UNITYSDK_OFFSET(0x1B1851D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_ABCSYNCDATABEGIN_OFFSET UNITYSDK_OFFSET(0x1B1852F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_ABCSYNCDATAEND_OFFSET UNITYSDK_OFFSET(0x1B185A60)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_GET_ABCSCHEMA_OFFSET UNITYSDK_OFFSET(0x1B185180)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_GET_CREATERENDERINGCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B185160)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B185190)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT_SET_CREATERENDERINGCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B185170)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B185E60)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicCurvesElement_TypeDefinitionIndex = 42531;
