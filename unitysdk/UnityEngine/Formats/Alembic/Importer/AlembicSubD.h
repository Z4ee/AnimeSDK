...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSUBD_ABCSETUP_OFFSET UNITYSDK_OFFSET(0x1B040590)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSUBD_GET_ABCSCHEMA_OFFSET UNITYSDK_OFFSET(0x1B040580)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSUBD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B040720)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicSubD_TypeDefinitionIndex = 41692;
