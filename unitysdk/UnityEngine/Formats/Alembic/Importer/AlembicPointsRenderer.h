...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSHMOTIONVECTOR_OFFSET UNITYSDK_OFFSET(0x1A1D3FD0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A1D2FC0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1A1D2E30)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1A1D2E50)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A1D2FA0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1D4E80)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1D5190)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A1D4E70)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1A1D5010)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A1D4C20)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1A1D2E40)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1A1D2F10)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A1D2FB0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_START_OFFSET UNITYSDK_OFFSET(0x1A1D5020)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D5400)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicPointsRenderer_TypeDefinitionIndex = 40877;
