...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSHMOTIONVECTOR_OFFSET UNITYSDK_OFFSET(0x1B18E850)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B18D840)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1B18D710)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1B18D730)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B18D820)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B18F820)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B18FB20)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B18F810)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1B18F9B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B18F450)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1B18D720)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1B18D7F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B18D830)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_START_OFFSET UNITYSDK_OFFSET(0x1B18F9C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18FEE0)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicPointsRenderer_TypeDefinitionIndex = 42563;
