...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSHMOTIONVECTOR_OFFSET UNITYSDK_OFFSET(0x1CE36230)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1CE35220)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1CE350F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1CE35110)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CE35200)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1CE37200)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CE37500)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CE371F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1CE37390)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CE36E30)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1CE35100)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1CE351D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CE35210)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_START_OFFSET UNITYSDK_OFFSET(0x1CE373A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE378C0)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicPointsRenderer_TypeDefinitionIndex = 44745;
