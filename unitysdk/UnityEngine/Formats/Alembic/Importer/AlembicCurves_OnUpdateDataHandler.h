...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B185120)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B185150)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B184EF0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B185030)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicCurves_OnUpdateDataHandler_TypeDefinitionIndex = 42556;
