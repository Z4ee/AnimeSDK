...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187911C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187911F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18790B20)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187911A0)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicCurves_OnUpdateDataHandler_TypeDefinitionIndex = 35042;
