...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCUSTOMDATA_GET_FACESETNAMES_OFFSET UNITYSDK_OFFSET(0x18793A40)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCUSTOMDATA_SETFACESETNAMES_OFFSET UNITYSDK_OFFSET(0x18793A50)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18793B40)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicCustomData_TypeDefinitionIndex = 35046;
