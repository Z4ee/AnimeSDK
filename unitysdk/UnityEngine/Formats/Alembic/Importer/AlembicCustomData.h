...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCUSTOMDATA_GET_FACESETNAMES_OFFSET UNITYSDK_OFFSET(0x1CE2F940)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCUSTOMDATA_SETFACESETNAMES_OFFSET UNITYSDK_OFFSET(0x1CE2F950)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE2FA50)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicCustomData_TypeDefinitionIndex = 44742;
