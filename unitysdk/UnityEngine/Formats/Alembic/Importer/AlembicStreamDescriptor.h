...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_CLONE_OFFSET UNITYSDK_OFFSET(0x1B03E210)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_GET_MEDIADURATION_OFFSET UNITYSDK_OFFSET(0x1B03E200)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_GET_MEDIAENDTIME_OFFSET UNITYSDK_OFFSET(0x1B03E1E0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_GET_MEDIASTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B03E1C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_GET_PATHTOABC_OFFSET UNITYSDK_OFFSET(0x1B03E170)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B03E1A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_SET_MEDIAENDTIME_OFFSET UNITYSDK_OFFSET(0x1B03E1F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_SET_MEDIASTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B03E1D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_SET_PATHTOABC_OFFSET UNITYSDK_OFFSET(0x1B03E190)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B03E1B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICSTREAMDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03E250)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicStreamDescriptor_TypeDefinitionIndex = 41688;
