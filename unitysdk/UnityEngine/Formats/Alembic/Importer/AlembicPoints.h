...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS_ABCPREPARESAMPLE_OFFSET UNITYSDK_OFFSET(0x1A1D1C10)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS_ABCSETUP_OFFSET UNITYSDK_OFFSET(0x1A1D1AF0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS_ABCSYNCDATABEGIN_OFFSET UNITYSDK_OFFSET(0x1A1D1F60)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS_ABCSYNCDATAEND_OFFSET UNITYSDK_OFFSET(0x1A1D26C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS_GET_ABCSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A1D1A90)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1A1D1AA0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D2A90)
