...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x2106A20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x21069A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x187A81D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1879ED00)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiPolyMesh_TypeDefinitionIndex = 34994;
