...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3BBB060)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x3BBAFE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE45290)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESH_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE3BA80)
