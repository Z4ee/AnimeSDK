...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x187A8230)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_2_OFFSET UNITYSDK_OFFSET(0x187A8240)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_3_OFFSET UNITYSDK_OFFSET(0x187A8250)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x187A8220)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x187A8210)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiSample_TypeDefinitionIndex = 34998;
