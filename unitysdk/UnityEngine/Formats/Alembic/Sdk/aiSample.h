...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE452F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1CE45300)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1CE45310)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE452E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE452D0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiSample_TypeDefinitionIndex = 44694;
