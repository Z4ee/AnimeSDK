...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3A22B40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x3A22AC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B19D990)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B1940B0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiSubD_TypeDefinitionIndex = 42509;
