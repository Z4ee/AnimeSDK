...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3BBB500)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x3BBB480)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE45380)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE3BA90)
