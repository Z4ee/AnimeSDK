...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x2106EC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x2106E40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x187A82C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISUBD_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1879ED10)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiSubD_TypeDefinitionIndex = 34995;
