...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTNORMALS_OFFSET UNITYSDK_OFFSET(0x2467210)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTPOINTS_OFFSET UNITYSDK_OFFSET(0x3A21C20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTRGBA_OFFSET UNITYSDK_OFFSET(0x3938570)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTRGB_OFFSET UNITYSDK_OFFSET(0x3A21CC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTTANGENTS_OFFSET UNITYSDK_OFFSET(0x3A21C60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTUV0_OFFSET UNITYSDK_OFFSET(0x3A21C80)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTUV1_OFFSET UNITYSDK_OFFSET(0x3A21CA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A21C40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASCOUNTS_OFFSET UNITYSDK_OFFSET(0x38F15A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASINDSICES_OFFSET UNITYSDK_OFFSET(0x39CE7F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x38C8870)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASPOINTS_OFFSET UNITYSDK_OFFSET(0x3A1A1E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASRGBA_OFFSET UNITYSDK_OFFSET(0x3948EC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASRGB_OFFSET UNITYSDK_OFFSET(0x394C130)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x39D39A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASUV0_OFFSET UNITYSDK_OFFSET(0x39D6A40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASUV1_OFFSET UNITYSDK_OFFSET(0x39D6A30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A21BC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_TOPOLOGYVARIANCE_OFFSET UNITYSDK_OFFSET(0x167710)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTNORMALS_OFFSET UNITYSDK_OFFSET(0x7BE230)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTPOINTS_OFFSET UNITYSDK_OFFSET(0x3A21C30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTRGBA_OFFSET UNITYSDK_OFFSET(0x3938580)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTRGB_OFFSET UNITYSDK_OFFSET(0x3A21CD0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTTANGENTS_OFFSET UNITYSDK_OFFSET(0x3A21C70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTUV0_OFFSET UNITYSDK_OFFSET(0x3A21C90)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTUV1_OFFSET UNITYSDK_OFFSET(0x3A21CB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A21C50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASCOUNTS_OFFSET UNITYSDK_OFFSET(0x38F15B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASINDSICES_OFFSET UNITYSDK_OFFSET(0x3A21BA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x3A21BE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASPOINTS_OFFSET UNITYSDK_OFFSET(0x3A21BB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASRGBA_OFFSET UNITYSDK_OFFSET(0x394C120)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASRGB_OFFSET UNITYSDK_OFFSET(0x394C140)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x3A21BF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASUV0_OFFSET UNITYSDK_OFFSET(0x3A21C00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASUV1_OFFSET UNITYSDK_OFFSET(0x3A21C10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A21BD0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_TOPOLOGYVARIANCE_OFFSET UNITYSDK_OFFSET(0x167520)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiMeshSummary_TypeDefinitionIndex = 42487;

	struct alignas(4) aiMeshSummary
	{
		::UnityEngine::Formats::Alembic::Sdk::aiTopologyVariance _topologyVariance_k__BackingField; // 0x10
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasCounts_k__BackingField; // 0x14
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasIndsices_k__BackingField; // 0x15
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasPoints_k__BackingField; // 0x16
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasVelocities_k__BackingField; // 0x17
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasNormals_k__BackingField; // 0x18
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasTangents_k__BackingField; // 0x19
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasUV0_k__BackingField; // 0x1A
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasUV1_k__BackingField; // 0x1B
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasRgba_k__BackingField; // 0x1C
		::UnityEngine::Formats::Alembic::Sdk::Bool _hasRgb_k__BackingField; // 0x1D
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantPoints_k__BackingField; // 0x1E
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantVelocities_k__BackingField; // 0x1F
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantNormals_k__BackingField; // 0x20
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantTangents_k__BackingField; // 0x21
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantUV0_k__BackingField; // 0x22
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantUV1_k__BackingField; // 0x23
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantRgba_k__BackingField; // 0x24
		::UnityEngine::Formats::Alembic::Sdk::Bool _constantRgb_k__BackingField; // 0x25

		::UnityEngine::Formats::Alembic::Sdk::aiTopologyVariance get_topologyVariance()
		{
