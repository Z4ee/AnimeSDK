...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICAMERA_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x22D82D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICAMERA_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A1E1670)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICAMERA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A1D8BD0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiCamera_TypeDefinitionIndex = 40821;
