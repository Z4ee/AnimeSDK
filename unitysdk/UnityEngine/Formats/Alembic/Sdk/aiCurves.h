...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3874360)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x38741C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B045F30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B03D470)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_SET_SORTBASEPOSITION_OFFSET UNITYSDK_OFFSET(0x38742C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_SET_SORT_OFFSET UNITYSDK_OFFSET(0x3874240)
