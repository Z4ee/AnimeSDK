...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_GET_REQUESTEDINDEX_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_GET_REQUESTEDTIMEINDEXTYPE_OFFSET UNITYSDK_OFFSET(0x6E30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_GET_REQUESTEDTIME_OFFSET UNITYSDK_OFFSET(0x2E267C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_SET_REQUESTEDINDEX_OFFSET UNITYSDK_OFFSET(0xC610)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_SET_REQUESTEDTIMEINDEXTYPE_OFFSET UNITYSDK_OFFSET(0x2AA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_SET_REQUESTEDTIME_OFFSET UNITYSDK_OFFSET(0x3BACF80)
