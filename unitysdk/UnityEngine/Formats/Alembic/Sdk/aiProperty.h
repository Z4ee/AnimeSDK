...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B19D8D0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiProperty_TypeDefinitionIndex = 42518;
