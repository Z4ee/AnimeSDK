...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x6EE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_SPLITCOUNT_OFFSET UNITYSDK_OFFSET(0x1E110)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_TOPOLOGYCHANGED_OFFSET UNITYSDK_OFFSET(0x2BBAA60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x140A50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x2D770)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x2A90)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_SPLITCOUNT_OFFSET UNITYSDK_OFFSET(0x21F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0xDAE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_TOPOLOGYCHANGED_OFFSET UNITYSDK_OFFSET(0x2BBAA70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x140A60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x13CFF0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiMeshSampleSummary_TypeDefinitionIndex = 41628;
