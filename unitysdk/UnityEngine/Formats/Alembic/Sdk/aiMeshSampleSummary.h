...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x691EF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_SPLITCOUNT_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_TOPOLOGYCHANGED_OFFSET UNITYSDK_OFFSET(0x3938570)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x7A7E30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x167D30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x38C6D30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_SPLITCOUNT_OFFSET UNITYSDK_OFFSET(0xA4B350)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x38C2BD0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_TOPOLOGYCHANGED_OFFSET UNITYSDK_OFFSET(0x3938580)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x39EC370)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSAMPLESUMMARY_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x167B90)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiMeshSampleSummary_TypeDefinitionIndex = 42488;
