...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x38756B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B046AB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B03D420)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiXform_TypeDefinitionIndex = 41646;
