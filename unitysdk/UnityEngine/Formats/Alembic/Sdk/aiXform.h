...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x3BAD300)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1EAB7770)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1EAADC40)
