...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x22D9C00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A1E23B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A1D8BC0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiXform_TypeDefinitionIndex = 40820;
