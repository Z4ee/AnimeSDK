...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOLYMESHDATA_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x6E30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOLYMESHDATA_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x6020)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOLYMESHDATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x2FC10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOLYMESHDATA_SET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x2AA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOLYMESHDATA_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x9500)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOLYMESHDATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x14E860)
