...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_FILLDATA_OFFSET UNITYSDK_OFFSET(0x3BBA4B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3BBA430)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE44B50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE44B40)
