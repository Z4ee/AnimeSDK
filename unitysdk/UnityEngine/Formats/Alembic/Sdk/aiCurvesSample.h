...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_FILLDATA_OFFSET UNITYSDK_OFFSET(0x3A21AE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3A21A60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B19D160)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B19D150)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiCurvesSample_TypeDefinitionIndex = 42517;
