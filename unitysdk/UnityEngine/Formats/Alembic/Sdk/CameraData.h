...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_FARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x3A01F10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_FOCALLENGTH_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_LENSSHIFT_OFFSET UNITYSDK_OFFSET(0x676BA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0xA4B370)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_SENSORSIZE_OFFSET UNITYSDK_OFFSET(0x676DC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x167D30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_FARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x3A20460)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_FOCALLENGTH_OFFSET UNITYSDK_OFFSET(0x38DAE60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_LENSSHIFT_OFFSET UNITYSDK_OFFSET(0xA4B360)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0xA4B380)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_SENSORSIZE_OFFSET UNITYSDK_OFFSET(0x7BE220)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x167B90)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int CameraData_TypeDefinitionIndex = 42520;
