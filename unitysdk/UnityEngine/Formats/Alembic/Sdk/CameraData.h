...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_FARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x3B7C5F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_FOCALLENGTH_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_LENSSHIFT_OFFSET UNITYSDK_OFFSET(0x14420)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x3B7C5E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_SENSORSIZE_OFFSET UNITYSDK_OFFSET(0x6020)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x2FC10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_FARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x3BAAAA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_FOCALLENGTH_OFFSET UNITYSDK_OFFSET(0xD4E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_LENSSHIFT_OFFSET UNITYSDK_OFFSET(0xB7B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x777B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_SENSORSIZE_OFFSET UNITYSDK_OFFSET(0x9500)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_CAMERADATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x14E860)
