...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_GET_ISDATAUPDATED_OFFSET UNITYSDK_OFFSET(0x3BBB310)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE2C030)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_EXPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1CE304B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_EXPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1CE3F180)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_EXPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1CE33EF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_EXPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1CE2CC40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE3F530)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE3B6A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISCHEMA_UPDATESAMPLE_OFFSET UNITYSDK_OFFSET(0x3BBB400)
