...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x12370)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_INDEXES_OFFSET UNITYSDK_OFFSET(0x161E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0x784470)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x379F970)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_INDEXES_OFFSET UNITYSDK_OFFSET(0x16050)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0x3B8DEC0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aeSubmeshData_TypeDefinitionIndex = 44647;
