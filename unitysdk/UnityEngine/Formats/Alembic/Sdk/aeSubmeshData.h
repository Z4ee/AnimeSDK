...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0xDAB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_INDEXES_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0x8A3A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0xDAC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_INDEXES_OFFSET UNITYSDK_OFFSET(0xC610)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0x154E60)
