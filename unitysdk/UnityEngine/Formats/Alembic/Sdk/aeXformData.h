...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_INHERITS_OFFSET UNITYSDK_OFFSET(0x3BB9DF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x900A90)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x3BB9DC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x3A30270)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x182E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_INHERITS_OFFSET UNITYSDK_OFFSET(0x3BB9E00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x3B8AA30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x3BB9DE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x3BB9DB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x18100)
