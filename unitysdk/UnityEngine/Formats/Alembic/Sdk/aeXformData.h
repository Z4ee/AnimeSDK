...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_INHERITS_OFFSET UNITYSDK_OFFSET(0x21056F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1515D70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x21056C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x7F9E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x29C50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_INHERITS_OFFSET UNITYSDK_OFFSET(0x2105700)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x21056B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x21056E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x21056A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEXFORMDATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x791D0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aeXformData_TypeDefinitionIndex = 34949;
