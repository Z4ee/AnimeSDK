...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D290)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_IDS_OFFSET UNITYSDK_OFFSET(0x2CFE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x6020)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0x14420)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x2FC10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_COUNT_OFFSET UNITYSDK_OFFSET(0xB430)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_IDS_OFFSET UNITYSDK_OFFSET(0x2CFF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x9500)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0xB7B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x14E860)
