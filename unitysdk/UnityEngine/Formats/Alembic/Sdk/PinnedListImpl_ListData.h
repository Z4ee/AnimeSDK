...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_PINNEDLISTIMPL_LISTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E0310)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int PinnedListImpl_ListData_TypeDefinitionIndex = 40838;
