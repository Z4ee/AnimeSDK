...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_GET_INHERITS_OFFSET UNITYSDK_OFFSET(0x3A21420)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x691E00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x3A213F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x38F4340)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x167D30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_SET_INHERITS_OFFSET UNITYSDK_OFFSET(0x3A21430)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x39E7A80)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x3A21410)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x3A213E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIXFORMDATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x167B90)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiXformData_TypeDefinitionIndex = 42493;
