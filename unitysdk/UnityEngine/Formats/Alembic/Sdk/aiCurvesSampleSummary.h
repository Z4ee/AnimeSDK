...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_GET_NUMVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_GET_POSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x167710)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_SET_NUMVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0xA4B350)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_SET_POSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x167520)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiCurvesSampleSummary_TypeDefinitionIndex = 42498;
