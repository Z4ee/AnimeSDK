...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_GET_NUMVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0x1E120)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_GET_POSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x5F00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_SET_NUMVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0x2200)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_SET_POSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2E950)
