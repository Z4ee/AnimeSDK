...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_SUBMESHOFFSET_OFFSET UNITYSDK_OFFSET(0x1DA90)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0xD250)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_VERTEXOFFSET_OFFSET UNITYSDK_OFFSET(0x793A0)
...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x29130)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_SUBMESHOFFSET_OFFSET UNITYSDK_OFFSET(0x1D50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0xD260)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_VERTEXOFFSET_OFFSET UNITYSDK_OFFSET(0x2105690)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiMeshSplitSummary_TypeDefinitionIndex = 34975;
