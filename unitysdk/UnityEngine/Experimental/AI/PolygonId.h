...
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xAB1760)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_EQUALS_OFFSET UNITYSDK_OFFSET(0x3CB9B0)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x909910)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_ISNULL_OFFSET UNITYSDK_OFFSET(0x3CCD40)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1F74E3C0)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int PolygonId_TypeDefinitionIndex = 28015;
