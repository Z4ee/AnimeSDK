...
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9BF930)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_EQUALS_OFFSET UNITYSDK_OFFSET(0x396BC0)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x815700)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_ISNULL_OFFSET UNITYSDK_OFFSET(0x396A90)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C02CCA0)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int PolygonId_TypeDefinitionIndex = 24820;
