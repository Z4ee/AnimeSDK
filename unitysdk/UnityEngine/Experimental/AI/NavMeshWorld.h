...
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHWORLD_ADDDEPENDENCYINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74E380)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHWORLD_ADDDEPENDENCYINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74E370)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHWORLD_ADDDEPENDENCY_OFFSET UNITYSDK_OFFSET(0xAB1730)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHWORLD_GETDEFAULTWORLD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74E360)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHWORLD_GETDEFAULTWORLD_OFFSET UNITYSDK_OFFSET(0x1F74E330)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int NavMeshWorld_TypeDefinitionIndex = 28019;
