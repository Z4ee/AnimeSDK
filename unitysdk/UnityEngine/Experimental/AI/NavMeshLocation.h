...
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION_GET_POLYGON_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x3E3F90)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0xA60900)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int NavMeshLocation_TypeDefinitionIndex = 27414;
