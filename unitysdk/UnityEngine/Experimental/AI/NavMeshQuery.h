...
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_BEGINFINDPATH_1_OFFSET UNITYSDK_OFFSET(0x1C02C660)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_BEGINFINDPATH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02C6E0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_BEGINFINDPATH_OFFSET UNITYSDK_OFFSET(0x9BF5A0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_CREATELOCATION_OFFSET UNITYSDK_OFFSET(0x9BF690)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_CREATE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02C5F0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_CREATE_OFFSET UNITYSDK_OFFSET(0x1C02C5A0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C02C5E0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BF580)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ENDFINDPATH_1_OFFSET UNITYSDK_OFFSET(0x1C02C6A0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ENDFINDPATH_OFFSET UNITYSDK_OFFSET(0x9BF610)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETCLOSESTPOINTONPOLY_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02C7A0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETCLOSESTPOINTONPOLY_OFFSET UNITYSDK_OFFSET(0x1C02C780)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPATHRESULT_1_OFFSET UNITYSDK_OFFSET(0x1C02C6D0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPATHRESULT_OFFSET UNITYSDK_OFFSET(0x9BF620)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPOLYGONTYPE_1_OFFSET UNITYSDK_OFFSET(0x9BF8E0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPOLYGONTYPE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02CBE0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPOLYGONTYPE_OFFSET UNITYSDK_OFFSET(0x1C02CBC0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPORTALPOINTS_1_OFFSET UNITYSDK_OFFSET(0x9BF7C0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPORTALPOINTS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02C990)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPORTALPOINTS_OFFSET UNITYSDK_OFFSET(0x1C02C960)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALIDPOLYGON_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02C710)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALIDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1C02C6F0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALIDPTR_OFFSET UNITYSDK_OFFSET(0x1C02C720)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x9BF670)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALID_OFFSET UNITYSDK_OFFSET(0x9BF640)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_MAPLOCATION_1_OFFSET UNITYSDK_OFFSET(0x9BF730)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_MAPLOCATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02C8C0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_MAPLOCATION_OFFSET UNITYSDK_OFFSET(0x1C02C850)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONLOCALTOWORLDMATRIX_1_OFFSET UNITYSDK_OFFSET(0x9BF800)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONLOCALTOWORLDMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02CA50)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONLOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x1C02C9E0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONWORLDTOLOCALMATRIX_1_OFFSET UNITYSDK_OFFSET(0x9BF870)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONWORLDTOLOCALMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C02CB40)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONWORLDTOLOCALMATRIX_OFFSET UNITYSDK_OFFSET(0x1C02CAD0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_UPDATEFINDPATH_1_OFFSET UNITYSDK_OFFSET(0x1C02C680)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_UPDATEFINDPATH_OFFSET UNITYSDK_OFFSET(0x9BF600)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x9BF550)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int NavMeshQuery_TypeDefinitionIndex = 24825;
