...
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AEB80)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AEC00)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AE5F0)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5AEB60)

namespace UnityEngine::Experimental::Audio
{
	inline static constexpr unsigned int AudioSampleProvider_SampleFramesHandler_TypeDefinitionIndex = 18369;
