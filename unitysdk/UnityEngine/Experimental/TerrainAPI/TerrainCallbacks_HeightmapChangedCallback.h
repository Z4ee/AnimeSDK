...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_HEIGHTMAPCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FABFE80)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_HEIGHTMAPCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FABFF20)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_HEIGHTMAPCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FABEE10)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_HEIGHTMAPCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FABFE60)

namespace UnityEngine::Experimental::TerrainAPI
{
	inline static constexpr unsigned int TerrainCallbacks_HeightmapChangedCallback_TypeDefinitionIndex = 33115;
