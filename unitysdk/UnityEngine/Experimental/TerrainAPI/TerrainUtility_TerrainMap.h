...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_ADDTERRAININTERNAL_OFFSET UNITYSDK_OFFSET(0x1FAC2570)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_CREATEFROMPLACEMENT_1_OFFSET UNITYSDK_OFFSET(0x1FAC12F0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_CREATEFROMPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1FAC0550)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_GETTERRAIN_OFFSET UNITYSDK_OFFSET(0x1FAC1140)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TRYTOADDTERRAIN_OFFSET UNITYSDK_OFFSET(0x1FAC20E0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_VALIDATETERRAIN_OFFSET UNITYSDK_OFFSET(0x1FAC2730)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1FAC2420)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAC1B20)

namespace UnityEngine::Experimental::TerrainAPI
{
	inline static constexpr unsigned int TerrainUtility_TerrainMap_TypeDefinitionIndex = 33118;
