...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_ADDTERRAININTERNAL_OFFSET UNITYSDK_OFFSET(0x1C39E950)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_CREATEFROMPLACEMENT_1_OFFSET UNITYSDK_OFFSET(0x1C39D6A0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_CREATEFROMPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1C39C8E0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_GETTERRAIN_OFFSET UNITYSDK_OFFSET(0x1C39D4F0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TRYTOADDTERRAIN_OFFSET UNITYSDK_OFFSET(0x1C39E4B0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_VALIDATETERRAIN_OFFSET UNITYSDK_OFFSET(0x1C39EB00)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1C39E800)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C39DED0)

namespace UnityEngine::Experimental::TerrainAPI
{
	inline static constexpr unsigned int TerrainUtility_TerrainMap_TypeDefinitionIndex = 30932;
