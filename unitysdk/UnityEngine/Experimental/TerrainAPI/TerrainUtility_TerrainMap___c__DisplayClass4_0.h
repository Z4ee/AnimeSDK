...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP___C__DISPLAYCLASS4_0__CREATEFROMPLACEMENT_B__0_OFFSET UNITYSDK_OFFSET(0x1FAC36E0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAC1280)

namespace UnityEngine::Experimental::TerrainAPI
{
	inline static constexpr unsigned int TerrainUtility_TerrainMap___c__DisplayClass4_0_TypeDefinitionIndex = 33122;
