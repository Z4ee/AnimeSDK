...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3C0660)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B3C06E0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B3BFF80)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3BFF70)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int Lightmapping_RequestLightsDelegate_TypeDefinitionIndex = 6294;
