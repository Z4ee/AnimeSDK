...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EA68DC0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EA68E40)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EA68690)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA68670)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int Lightmapping_RequestLightsDelegate_TypeDefinitionIndex = 6324;
