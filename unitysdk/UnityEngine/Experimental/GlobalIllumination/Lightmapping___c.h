...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC1C5C0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC1C600)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C___CCTOR_B__7_0_OFFSET UNITYSDK_OFFSET(0x1BC1C610)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int Lightmapping___c_TypeDefinitionIndex = 6295;
	...
	public:
		...
		{
			return (::UnityEngine::Experimental::GlobalIllumination::Lightmapping___c**)Il2CppClass::FromTypeDefinitionIndex(Lightmapping___c_TypeDefinitionIndex)->GetStaticField(0x5330);
		}
