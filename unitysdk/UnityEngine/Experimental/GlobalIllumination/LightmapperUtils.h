...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACTINDIRECT_OFFSET UNITYSDK_OFFSET(0x1CF305E0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACTINNERCONE_OFFSET UNITYSDK_OFFSET(0x1CF30760)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_1_OFFSET UNITYSDK_OFFSET(0x1CF30B80)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_2_OFFSET UNITYSDK_OFFSET(0x1CF30E80)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_3_OFFSET UNITYSDK_OFFSET(0x1CF31210)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_4_OFFSET UNITYSDK_OFFSET(0x1CF31550)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_OFFSET UNITYSDK_OFFSET(0x1CF307B0)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int LightmapperUtils_TypeDefinitionIndex = 6318;
