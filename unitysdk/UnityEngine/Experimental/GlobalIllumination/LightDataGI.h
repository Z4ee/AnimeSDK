...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INITNOBAKE_OFFSET UNITYSDK_OFFSET(0xA065B0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_1_OFFSET UNITYSDK_OFFSET(0xA06400)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_2_OFFSET UNITYSDK_OFFSET(0xA06470)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_3_OFFSET UNITYSDK_OFFSET(0xA064E0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_4_OFFSET UNITYSDK_OFFSET(0xA06540)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_OFFSET UNITYSDK_OFFSET(0xA06330)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int LightDataGI_TypeDefinitionIndex = 6317;
