...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_ADDEDGEVERTEX_OFFSET UNITYSDK_OFFSET(0x19687680)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_CHECK_OFFSET UNITYSDK_OFFSET(0x19687FC0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_CONNECT_OFFSET UNITYSDK_OFFSET(0x196878F0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_DELETE_OFFSET UNITYSDK_OFFSET(0x19687500)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_MAKEEDGE_OFFSET UNITYSDK_OFFSET(0x19687360)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_MERGECONVEXFACES_OFFSET UNITYSDK_OFFSET(0x19687BE0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_ONFREE_OFFSET UNITYSDK_OFFSET(0x19687210)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_RESET_OFFSET UNITYSDK_OFFSET(0x196871C0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_SPLICE_OFFSET UNITYSDK_OFFSET(0x196873E0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_SPLITEDGE_OFFSET UNITYSDK_OFFSET(0x19687730)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_ZAPFACE_OFFSET UNITYSDK_OFFSET(0x19687A20)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x19687080)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH___BASE_ONFREE_OFFSET UNITYSDK_OFFSET(0x196880C0)

namespace UnityEngine::Experimental::Rendering::Universal::LibTessDotNet
{
	inline static constexpr unsigned int Mesh_TypeDefinitionIndex = 29739;
	...
	{
	public:
		::UnityEngine::Experimental::Rendering::Universal::LibTessDotNet::MeshUtils_Edge* _eHeadSym; // 0x10
		::UnityEngine::Experimental::Rendering::Universal::LibTessDotNet::MeshUtils_Edge* _eHead; // 0x18
