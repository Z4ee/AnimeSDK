...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_COMBINECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18FE40C0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_COMBINECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18FE4150)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_COMBINECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18FE3C20)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_COMBINECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE3C10)

namespace UnityEngine::Experimental::Rendering::Universal::LibTessDotNet
{
	inline static constexpr unsigned int CombineCallback_TypeDefinitionIndex = 29759;
