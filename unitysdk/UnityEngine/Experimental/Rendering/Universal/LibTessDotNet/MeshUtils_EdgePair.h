...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESHUTILS_EDGEPAIR_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1777A0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESHUTILS_EDGEPAIR_RESET_OFFSET UNITYSDK_OFFSET(0x8C4A90)

namespace UnityEngine::Experimental::Rendering::Universal::LibTessDotNet
{
	inline static constexpr unsigned int MeshUtils_EdgePair_TypeDefinitionIndex = 26668;
