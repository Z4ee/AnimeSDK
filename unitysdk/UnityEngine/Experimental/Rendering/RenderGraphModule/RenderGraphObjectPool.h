...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHOBJECTPOOL_GETTEMPMATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1CCFD040)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHOBJECTPOOL_RELEASEALLTEMPALLOC_OFFSET UNITYSDK_OFFSET(0x1CCFA3E0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHOBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCF6770)
