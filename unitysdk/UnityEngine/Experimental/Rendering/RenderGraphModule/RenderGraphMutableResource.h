...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DA80)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0xD240)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_ISVALID_OFFSET UNITYSDK_OFFSET(0xDFD90)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A2F9390)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x299E0)
...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0xD250)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x22DBD40)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x22C9240)

namespace UnityEngine::Experimental::Rendering::RenderGraphModule
{
	inline static constexpr unsigned int RenderGraphMutableResource_TypeDefinitionIndex = 33373;
