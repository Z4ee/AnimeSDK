...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x167710)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_ISVALID_OFFSET UNITYSDK_OFFSET(0x3A1B790)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B0CE2A0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x167520)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xA4B350)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x38C2BD0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A1B780)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x38DA730)

namespace UnityEngine::Experimental::Rendering::RenderGraphModule
{
	inline static constexpr unsigned int RenderGraphMutableResource_TypeDefinitionIndex = 34026;
