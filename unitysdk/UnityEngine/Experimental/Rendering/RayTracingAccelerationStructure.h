...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_CREATE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CF31A10)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_CREATE_OFFSET UNITYSDK_OFFSET(0x1CF319C0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_DESTROY_OFFSET UNITYSDK_OFFSET(0x1CF31980)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1CF318A0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CF318D0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1CF31890)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CF319D0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF31990)

namespace UnityEngine::Experimental::Rendering
{
	inline static constexpr unsigned int RayTracingAccelerationStructure_TypeDefinitionIndex = 6345;
