...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SCRIPTABLERUNTIMEREFLECTIONSYSTEMWRAPPER_GET_IMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D11C0C0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SCRIPTABLERUNTIMEREFLECTIONSYSTEMWRAPPER_INTERNAL_SCRIPTABLERUNTIMEREFLECTIONSYSTEMWRAPPER_TICKREALTIMEPROBES_OFFSET UNITYSDK_OFFSET(0x1D11C0E0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SCRIPTABLERUNTIMEREFLECTIONSYSTEMWRAPPER_SET_IMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D11C0D0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SCRIPTABLERUNTIMEREFLECTIONSYSTEMWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11C110)

namespace UnityEngine::Experimental::Rendering
{
	inline static constexpr unsigned int ScriptableRuntimeReflectionSystemWrapper_TypeDefinitionIndex = 6329;
