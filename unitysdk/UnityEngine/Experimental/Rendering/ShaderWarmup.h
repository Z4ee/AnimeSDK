...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_BEGINPSOWARMUPQUALITYSET_OFFSET UNITYSDK_OFFSET(0x1B294CD0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_BEGINPSOWARMUP_OFFSET UNITYSDK_OFFSET(0x1B294CB0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_ENDPSOWARMUPQUALITYSET_OFFSET UNITYSDK_OFFSET(0x1B294CE0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_ENDPSOWARMUP_OFFSET UNITYSDK_OFFSET(0x1B294CC0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_GETPSOCACHEFILESIZE_OFFSET UNITYSDK_OFFSET(0x1B294D00)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_PSOWARMUPASYNCSAVERUNNING_OFFSET UNITYSDK_OFFSET(0x1B294CF0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPPSO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B294CA0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPPSO_OFFSET UNITYSDK_OFFSET(0x1B294C90)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPSHADERPASS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B294C80)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPSHADERPASS_OFFSET UNITYSDK_OFFSET(0x1B294C60)
