...
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_1_OFFSET UNITYSDK_OFFSET(0x1FC524E0)
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_OFFSET UNITYSDK_OFFSET(0x1FC52440)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52410)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1FC52390)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52380)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52420)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x1FC52430)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETWITHSUBASSETS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52560)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_1_OFFSET UNITYSDK_OFFSET(0x1FC52300)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC522F0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1FC52200)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52160)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x1FC52170)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52190)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1FC521D0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC52180)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1FC521B0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FC521E0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_OFFSET UNITYSDK_OFFSET(0x1FC521F0)
#define UNITYENGINE_ASSETBUNDLE_RESOURCEPATHHASH_OFFSET UNITYSDK_OFFSET(0x1FC521A0)
#define UNITYENGINE_ASSETBUNDLE_SET_ENABLEBLKOPENFILECACHE_OFFSET UNITYSDK_OFFSET(0x1FC52580)
#define UNITYENGINE_ASSETBUNDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1FC52570)
#define UNITYENGINE_ASSETBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC52110)

namespace UnityEngine
{
	inline static constexpr unsigned int AssetBundle_TypeDefinitionIndex = 7671;
