...
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_1_OFFSET UNITYSDK_OFFSET(0x1E875FA0)
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_OFFSET UNITYSDK_OFFSET(0x1E875F00)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875ED0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1E875E50)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875E40)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875EE0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x1E875EF0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETWITHSUBASSETS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E876020)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_1_OFFSET UNITYSDK_OFFSET(0x1E875DC0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875DB0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1E875CC0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875C20)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x1E875C30)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875C50)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1E875C90)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875C40)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1E875C70)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1E875CA0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_OFFSET UNITYSDK_OFFSET(0x1E875CB0)
#define UNITYENGINE_ASSETBUNDLE_RESOURCEPATHHASH_OFFSET UNITYSDK_OFFSET(0x1E875C60)
#define UNITYENGINE_ASSETBUNDLE_SET_ENABLEBLKOPENFILECACHE_OFFSET UNITYSDK_OFFSET(0x1E876040)
#define UNITYENGINE_ASSETBUNDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1E876030)
#define UNITYENGINE_ASSETBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E875BD0)

namespace UnityEngine
{
	inline static constexpr unsigned int AssetBundle_TypeDefinitionIndex = 7667;
