...
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDCONTAINSNAME_1_OFFSET UNITYSDK_OFFSET(0x19A92B90)
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDCONTAINSNAME_OFFSET UNITYSDK_OFFSET(0x19A92680)
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDWITHNAME_1_OFFSET UNITYSDK_OFFSET(0x19A92170)
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDWITHNAME_OFFSET UNITYSDK_OFFSET(0x19A91C60)
#define UNITYENGINE_COMPONENTEXTENSIONS_POSTORDERTRAVERSETRANSFORMEARLYRETURN_OFFSET UNITYSDK_OFFSET(0x19A93400)
#define UNITYENGINE_COMPONENTEXTENSIONS_POSTORDERTRAVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x19A930B0)
#define UNITYENGINE_COMPONENTEXTENSIONS_PREORDERTRAVERSETRANSFORMEARLYRETURN_OFFSET UNITYSDK_OFFSET(0x19A93B30)
#define UNITYENGINE_COMPONENTEXTENSIONS_PREORDERTRAVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x19A937E0)
#define UNITYENGINE_COMPONENTEXTENSIONS_SAFEFIND_OFFSET UNITYSDK_OFFSET(0x19A91990)

namespace UnityEngine
{
	inline static constexpr unsigned int ComponentExtensions_TypeDefinitionIndex = 72378;
