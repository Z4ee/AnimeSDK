...
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0520)
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B05B0)
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B02E0)
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B04A0)

namespace UnityEngine
{
	inline static constexpr unsigned int TextGenerator_AfterWordWrapDel_TypeDefinitionIndex = 5028;
