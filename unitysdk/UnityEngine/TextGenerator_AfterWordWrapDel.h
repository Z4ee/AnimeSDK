...
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB7DB0)
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB7E40)
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB7B70)
#define UNITYENGINE_TEXTGENERATOR_AFTERWORDWRAPDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB7D30)
