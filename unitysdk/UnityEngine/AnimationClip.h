...
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F856210)
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENT_OFFSET UNITYSDK_OFFSET(0x1F856190)
#define UNITYENGINE_ANIMATIONCLIP_CLEARCURVES_OFFSET UNITYSDK_OFFSET(0x1F856040)
#define UNITYENGINE_ANIMATIONCLIP_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1F856030)
#define UNITYENGINE_ANIMATIONCLIP_GETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1F856300)
#define UNITYENGINE_ANIMATIONCLIP_GETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F856290)
#define UNITYENGINE_ANIMATIONCLIP_GETRUNTIMETOTALACLDATABASEBYTES_OFFSET UNITYSDK_OFFSET(0x1F856180)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINCLIPINFOS_OFFSET UNITYSDK_OFFSET(0x1F856170)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINDATABASEINEDITOR_OFFSET UNITYSDK_OFFSET(0x1F8562E0)
#define UNITYENGINE_ANIMATIONCLIP_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1F856110)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1F856320)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1F856340)
#define UNITYENGINE_ANIMATIONCLIP_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1F856220)
#define UNITYENGINE_ANIMATIONCLIP_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1F855FF0)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASGENERICROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F856120)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1F856140)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONFLOATCURVES_OFFSET UNITYSDK_OFFSET(0x1F856130)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTCURVES_OFFSET UNITYSDK_OFFSET(0x1F856150)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x1F856160)
#define UNITYENGINE_ANIMATIONCLIP_GET_HUMANMOTION_OFFSET UNITYSDK_OFFSET(0x1F856100)
#define UNITYENGINE_ANIMATIONCLIP_GET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1F8560E0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1F855FB0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F8560B0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1F856060)
#define UNITYENGINE_ANIMATIONCLIP_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1F855FD0)
#define UNITYENGINE_ANIMATIONCLIP_GET_STOPTIME_OFFSET UNITYSDK_OFFSET(0x1F855FE0)
#define UNITYENGINE_ANIMATIONCLIP_GET_TOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1F855FC0)
#define UNITYENGINE_ANIMATIONCLIP_GET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1F855F90)
#define UNITYENGINE_ANIMATIONCLIP_INTERNAL_CREATEANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1F855F40)
#define UNITYENGINE_ANIMATIONCLIP_PRINTANIMATIONCLIPINLRU_OFFSET UNITYSDK_OFFSET(0x1F856310)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1F855FA0)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1F855F50)
#define UNITYENGINE_ANIMATIONCLIP_SETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1F8562F0)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVEFORTRANSFORMBATCHED_OFFSET UNITYSDK_OFFSET(0x1F856020)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVE_OFFSET UNITYSDK_OFFSET(0x1F856010)
#define UNITYENGINE_ANIMATIONCLIP_SETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F8562B0)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1F856330)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1F856350)
#define UNITYENGINE_ANIMATIONCLIP_SET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1F8562A0)
#define UNITYENGINE_ANIMATIONCLIP_SET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1F856000)
#define UNITYENGINE_ANIMATIONCLIP_SET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1F8560F0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F8560D0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1F8560C0)
#define UNITYENGINE_ANIMATIONCLIP_SET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1F856050)
#define UNITYENGINE_ANIMATIONCLIP_STREAMINACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1F8562C0)
#define UNITYENGINE_ANIMATIONCLIP_STREAMOUTACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1F8562D0)
#define UNITYENGINE_ANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F855EE0)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimationClip_TypeDefinitionIndex = 6615;
