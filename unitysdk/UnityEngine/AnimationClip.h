...
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E4F6D30)
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENT_OFFSET UNITYSDK_OFFSET(0x1E4F6CB0)
#define UNITYENGINE_ANIMATIONCLIP_CLEARCURVES_OFFSET UNITYSDK_OFFSET(0x1E4F6B60)
#define UNITYENGINE_ANIMATIONCLIP_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1E4F6B50)
#define UNITYENGINE_ANIMATIONCLIP_GETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1E4F6E20)
#define UNITYENGINE_ANIMATIONCLIP_GETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E4F6DB0)
#define UNITYENGINE_ANIMATIONCLIP_GETRUNTIMETOTALACLDATABASEBYTES_OFFSET UNITYSDK_OFFSET(0x1E4F6CA0)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINCLIPINFOS_OFFSET UNITYSDK_OFFSET(0x1E4F6C90)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINDATABASEINEDITOR_OFFSET UNITYSDK_OFFSET(0x1E4F6E00)
#define UNITYENGINE_ANIMATIONCLIP_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1E4F6C30)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1E4F6E40)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1E4F6E60)
#define UNITYENGINE_ANIMATIONCLIP_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1E4F6D40)
#define UNITYENGINE_ANIMATIONCLIP_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1E4F6B10)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASGENERICROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E4F6C40)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1E4F6C60)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONFLOATCURVES_OFFSET UNITYSDK_OFFSET(0x1E4F6C50)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTCURVES_OFFSET UNITYSDK_OFFSET(0x1E4F6C70)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x1E4F6C80)
#define UNITYENGINE_ANIMATIONCLIP_GET_HUMANMOTION_OFFSET UNITYSDK_OFFSET(0x1E4F6C20)
#define UNITYENGINE_ANIMATIONCLIP_GET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1E4F6C00)
#define UNITYENGINE_ANIMATIONCLIP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E4F6AD0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E4F6BD0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1E4F6B80)
#define UNITYENGINE_ANIMATIONCLIP_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1E4F6AF0)
#define UNITYENGINE_ANIMATIONCLIP_GET_STOPTIME_OFFSET UNITYSDK_OFFSET(0x1E4F6B00)
#define UNITYENGINE_ANIMATIONCLIP_GET_TOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1E4F6AE0)
#define UNITYENGINE_ANIMATIONCLIP_GET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1E4F6AB0)
#define UNITYENGINE_ANIMATIONCLIP_INTERNAL_CREATEANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1E4F6A60)
#define UNITYENGINE_ANIMATIONCLIP_PRINTANIMATIONCLIPINLRU_OFFSET UNITYSDK_OFFSET(0x1E4F6E30)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1E4F6AC0)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1E4F6A70)
#define UNITYENGINE_ANIMATIONCLIP_SETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1E4F6E10)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVEFORTRANSFORMBATCHED_OFFSET UNITYSDK_OFFSET(0x1E4F6B40)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVE_OFFSET UNITYSDK_OFFSET(0x1E4F6B30)
#define UNITYENGINE_ANIMATIONCLIP_SETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E4F6DD0)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1E4F6E50)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1E4F6E70)
#define UNITYENGINE_ANIMATIONCLIP_SET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1E4F6DC0)
#define UNITYENGINE_ANIMATIONCLIP_SET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1E4F6B20)
#define UNITYENGINE_ANIMATIONCLIP_SET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1E4F6C10)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E4F6BF0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1E4F6BE0)
#define UNITYENGINE_ANIMATIONCLIP_SET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1E4F6B70)
#define UNITYENGINE_ANIMATIONCLIP_STREAMINACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1E4F6DE0)
#define UNITYENGINE_ANIMATIONCLIP_STREAMOUTACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1E4F6DF0)
#define UNITYENGINE_ANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4F6A00)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimationClip_TypeDefinitionIndex = 6609;
