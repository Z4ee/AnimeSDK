...
#define UNITYENGINE_AVATAR_GETAXISLENGTH_OFFSET UNITYSDK_OFFSET(0x1C544970)
#define UNITYENGINE_AVATAR_GETBONEPATHS_OFFSET UNITYSDK_OFFSET(0x1C544A40)
#define UNITYENGINE_AVATAR_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1C5449B0)
#define UNITYENGINE_AVATAR_GETSKELETONPOSITION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C544AA0)
#define UNITYENGINE_AVATAR_GETSKELETONPOSITION_OFFSET UNITYSDK_OFFSET(0x1C544A50)
#define UNITYENGINE_AVATAR_GET_ISHUMAN_OFFSET UNITYSDK_OFFSET(0x1C544960)
#define UNITYENGINE_AVATAR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C544950)
#define UNITYENGINE_AVATAR_INTERNAL_GETAXISLENGTH_OFFSET UNITYSDK_OFFSET(0x1C5449A0)
#define UNITYENGINE_AVATAR_INTERNAL_GETPOSTROTATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C544A30)
#define UNITYENGINE_AVATAR_INTERNAL_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1C5449F0)
#define UNITYENGINE_AVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C544900)

namespace UnityEngine
{
	inline static constexpr unsigned int Avatar_TypeDefinitionIndex = 6553;
