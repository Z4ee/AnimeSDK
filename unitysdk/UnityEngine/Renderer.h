...
#define UNITYENGINE_RENDERER_COPYMATERIALARRAY_OFFSET UNITYSDK_OFFSET(0x1B3CB160)
#define UNITYENGINE_RENDERER_COPYSHAREDMATERIALARRAY_OFFSET UNITYSDK_OFFSET(0x1B3CB170)
#define UNITYENGINE_RENDERER_GETCLOSESTREFLECTIONPROBESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B3CB260)
#define UNITYENGINE_RENDERER_GETCLOSESTREFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1B3CBD70)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYCOLORIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB930)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYCOLORIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB8F0)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYCOLOR_OFFSET UNITYSDK_OFFSET(0x1B3CBA20)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYFLOATIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB870)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B3CB970)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYVECTORIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB8E0)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYVECTORIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB8A0)
#define UNITYENGINE_RENDERER_GETCUSTOMPROPERTYVECTOR_OFFSET UNITYSDK_OFFSET(0x1B3CB9E0)
#define UNITYENGINE_RENDERER_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB660)
#define UNITYENGINE_RENDERER_GETLIGHTMAPST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB6C0)
#define UNITYENGINE_RENDERER_GETLIGHTMAPST_OFFSET UNITYSDK_OFFSET(0x1B3CB680)
#define UNITYENGINE_RENDERER_GETMATERIALARRAY_OFFSET UNITYSDK_OFFSET(0x1B3CB150)
#define UNITYENGINE_RENDERER_GETMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1B3CB840)
#define UNITYENGINE_RENDERER_GETMATERIALSVERSION_OFFSET UNITYSDK_OFFSET(0x1B3CB140)
#define UNITYENGINE_RENDERER_GETMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B3CBB10)
#define UNITYENGINE_RENDERER_GETMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB100)
#define UNITYENGINE_RENDERER_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CB0E0)
#define UNITYENGINE_RENDERER_GETNAPCB_OFFSET UNITYSDK_OFFSET(0x1B3CB250)
#define UNITYENGINE_RENDERER_GETNEWCUSTOMPROPERTYSETMODE_OFFSET UNITYSDK_OFFSET(0x1B3CBDC0)
#define UNITYENGINE_RENDERER_GETPROPERTYBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1B3CB230)
#define UNITYENGINE_RENDERER_GETPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1B3CB220)
#define UNITYENGINE_RENDERER_GETREFRESHWHENENABLED_OFFSET UNITYSDK_OFFSET(0x1B3CB6F0)
#define UNITYENGINE_RENDERER_GETSHAREDMATERIALARRAY_OFFSET UNITYSDK_OFFSET(0x1B3CB850)
#define UNITYENGINE_RENDERER_GETSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B3CBC40)
#define UNITYENGINE_RENDERER_GETSHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CB0F0)
#define UNITYENGINE_RENDERER_GET_ALLOWOCCLUSIONWHENDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B3CB4B0)
#define UNITYENGINE_RENDERER_GET_BOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB050)
#define UNITYENGINE_RENDERER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1B3CB000)
#define UNITYENGINE_RENDERER_GET_BREFRESHWHENENABLED_OFFSET UNITYSDK_OFFSET(0x1B3CB710)
#define UNITYENGINE_RENDERER_GET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1B3CAEE0)
#define UNITYENGINE_RENDERER_GET_CULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B3CB450)
#define UNITYENGINE_RENDERER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B3CB270)
#define UNITYENGINE_RENDERER_GET_FORCERENDERINGOFF_OFFSET UNITYSDK_OFFSET(0x1B3CB2F0)
#define UNITYENGINE_RENDERER_GET_HIGHSHADINGRATE_OFFSET UNITYSDK_OFFSET(0x1B3CB2D0)
#define UNITYENGINE_RENDERER_GET_ISPARTOFSTATICBATCH_OFFSET UNITYSDK_OFFSET(0x1B3CB510)
#define UNITYENGINE_RENDERER_GET_ISVISIBLEINCURRENTCAMERA_OFFSET UNITYSDK_OFFSET(0x1B3CB2A0)
#define UNITYENGINE_RENDERER_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B3CB290)
#define UNITYENGINE_RENDERER_GET_LIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB730)
#define UNITYENGINE_RENDERER_GET_LIGHTMAPSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3CB770)
#define UNITYENGINE_RENDERER_GET_LIGHTPROBEPROXYVOLUMEOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B3CB600)
#define UNITYENGINE_RENDERER_GET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1B3CAFC0)
#define UNITYENGINE_RENDERER_GET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB0B0)
#define UNITYENGINE_RENDERER_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B3CB060)
#define UNITYENGINE_RENDERER_GET_LOCALTOWORLDMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB5F0)
#define UNITYENGINE_RENDERER_GET_LOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x1B3CB590)
#define UNITYENGINE_RENDERER_GET_MATERIALSVERSION_OFFSET UNITYSDK_OFFSET(0x1B3CBB00)
#define UNITYENGINE_RENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1B3CBA80)
#define UNITYENGINE_RENDERER_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CBAA0)
#define UNITYENGINE_RENDERER_GET_MOTIONVECTORGENERATIONMODE_OFFSET UNITYSDK_OFFSET(0x1B3CAF60)
#define UNITYENGINE_RENDERER_GET_MOTIONVECTORS_OFFSET UNITYSDK_OFFSET(0x1B3CAF40)
#define UNITYENGINE_RENDERER_GET_NAPDRAWSET_OFFSET UNITYSDK_OFFSET(0x1B3CB640)
#define UNITYENGINE_RENDERER_GET_NEEDHIZCULLING_OFFSET UNITYSDK_OFFSET(0x1B3CBD90)
#define UNITYENGINE_RENDERER_GET_PROBEANCHOR_OFFSET UNITYSDK_OFFSET(0x1B3CB620)
#define UNITYENGINE_RENDERER_GET_RAYTRACINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1B3CB350)
#define UNITYENGINE_RENDERER_GET_RAYTRACINGMODE_OFFSET UNITYSDK_OFFSET(0x1B3CB390)
#define UNITYENGINE_RENDERER_GET_REALTIMELIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB750)
#define UNITYENGINE_RENDERER_GET_REALTIMELIGHTMAPSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3CB7D0)
#define UNITYENGINE_RENDERER_GET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1B3CB2B0)
#define UNITYENGINE_RENDERER_GET_REFLECTIONPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1B3CB310)
#define UNITYENGINE_RENDERER_GET_RENDERERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3CB370)
#define UNITYENGINE_RENDERER_GET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1B3CB330)
#define UNITYENGINE_RENDERER_GET_SHADOWCASTERCULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B3CB470)
#define UNITYENGINE_RENDERER_GET_SHADOWCASTINGMODE_OFFSET UNITYSDK_OFFSET(0x1B3CAF00)
#define UNITYENGINE_RENDERER_GET_SHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B3CBAE0)
#define UNITYENGINE_RENDERER_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CBAC0)
#define UNITYENGINE_RENDERER_GET_SORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x1B3CB410)
#define UNITYENGINE_RENDERER_GET_SORTINGGROUPORDER_OFFSET UNITYSDK_OFFSET(0x1B3CB430)
#define UNITYENGINE_RENDERER_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x1B3CB3D0)
#define UNITYENGINE_RENDERER_GET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x1B3CB3B0)
#define UNITYENGINE_RENDERER_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x1B3CB3F0)
#define UNITYENGINE_RENDERER_GET_STATICBATCHINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB4F0)
#define UNITYENGINE_RENDERER_GET_STATICBATCHROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3CB4D0)
#define UNITYENGINE_RENDERER_GET_SUPPORTSRAYTRACING_OFFSET UNITYSDK_OFFSET(0x1B3CBD80)
#define UNITYENGINE_RENDERER_GET_TEXTURESTREAMINGCALCSCALE_OFFSET UNITYSDK_OFFSET(0x1B3CB490)
#define UNITYENGINE_RENDERER_GET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1B3CAFA0)
#define UNITYENGINE_RENDERER_GET_WORLDTOLOCALMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB580)
#define UNITYENGINE_RENDERER_GET_WORLDTOLOCALMATRIX_OFFSET UNITYSDK_OFFSET(0x1B3CB520)
#define UNITYENGINE_RENDERER_HASPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1B3CB1D0)
#define UNITYENGINE_RENDERER_INTERNAL_GETNAPCB_OFFSET UNITYSDK_OFFSET(0x1B3CB1F0)
#define UNITYENGINE_RENDERER_INTERNAL_GETPROPERTYBLOCKMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB1C0)
#define UNITYENGINE_RENDERER_INTERNAL_GETPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1B3CB1A0)
#define UNITYENGINE_RENDERER_INTERNAL_SETNAPCB_OFFSET UNITYSDK_OFFSET(0x1B3CB1E0)
#define UNITYENGINE_RENDERER_INTERNAL_SETPROPERTYBLOCKMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB1B0)
#define UNITYENGINE_RENDERER_INTERNAL_SETPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1B3CB190)
#define UNITYENGINE_RENDERER_PUSHMATERIALASLASTNEWINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB130)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYCOLOR_OFFSET UNITYSDK_OFFSET(0x1B3CB980)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYFLOATIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB860)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B3CB960)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYISINSTAINCINGIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB950)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYISINSTAINCING_OFFSET UNITYSDK_OFFSET(0x1B3CBA70)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYVECTORARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB940)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1B3CBA60)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYVECTORIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB890)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYVECTORIMPL_OFFSET UNITYSDK_OFFSET(0x1B3CB880)
#define UNITYENGINE_RENDERER_SETCUSTOMPROPERTYVECTOR_OFFSET UNITYSDK_OFFSET(0x1B3CB9B0)
#define UNITYENGINE_RENDERER_SETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB670)
#define UNITYENGINE_RENDERER_SETLIGHTMAPST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB6E0)
#define UNITYENGINE_RENDERER_SETLIGHTMAPST_OFFSET UNITYSDK_OFFSET(0x1B3CB6D0)
#define UNITYENGINE_RENDERER_SETMATERIALARRAY_OFFSET UNITYSDK_OFFSET(0x1B3CB180)
#define UNITYENGINE_RENDERER_SETMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB120)
#define UNITYENGINE_RENDERER_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CB110)
#define UNITYENGINE_RENDERER_SETNAPCB_OFFSET UNITYSDK_OFFSET(0x1B3CB240)
#define UNITYENGINE_RENDERER_SETNEWCUSTOMPROPERTYSETMODE_OFFSET UNITYSDK_OFFSET(0x1B3CBDB0)
#define UNITYENGINE_RENDERER_SETPROPERTYBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1B3CB210)
#define UNITYENGINE_RENDERER_SETPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1B3CB200)
#define UNITYENGINE_RENDERER_SETREFRESHWHENENABLED_OFFSET UNITYSDK_OFFSET(0x1B3CB700)
#define UNITYENGINE_RENDERER_SETSTATICBATCHINFO_OFFSET UNITYSDK_OFFSET(0x1B3CB500)
#define UNITYENGINE_RENDERER_SETSTATICLIGHTMAPST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3CB0D0)
#define UNITYENGINE_RENDERER_SETSTATICLIGHTMAPST_OFFSET UNITYSDK_OFFSET(0x1B3CB0C0)
#define UNITYENGINE_RENDERER_SET_ALLOWOCCLUSIONWHENDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B3CB4C0)
#define UNITYENGINE_RENDERER_SET_BREFRESHWHENENABLED_OFFSET UNITYSDK_OFFSET(0x1B3CB720)
#define UNITYENGINE_RENDERER_SET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1B3CAF10)
#define UNITYENGINE_RENDERER_SET_CULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B3CB460)
#define UNITYENGINE_RENDERER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B3CB280)
#define UNITYENGINE_RENDERER_SET_FORCERENDERINGOFF_OFFSET UNITYSDK_OFFSET(0x1B3CB300)
#define UNITYENGINE_RENDERER_SET_HIGHSHADINGRATE_OFFSET UNITYSDK_OFFSET(0x1B3CB2E0)
#define UNITYENGINE_RENDERER_SET_LIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB740)
#define UNITYENGINE_RENDERER_SET_LIGHTMAPSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3CB7B0)
#define UNITYENGINE_RENDERER_SET_LIGHTPROBEPROXYVOLUMEOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B3CB610)
#define UNITYENGINE_RENDERER_SET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1B3CAFF0)
#define UNITYENGINE_RENDERER_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1B3CBA90)
#define UNITYENGINE_RENDERER_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CBAB0)
#define UNITYENGINE_RENDERER_SET_MOTIONVECTORGENERATIONMODE_OFFSET UNITYSDK_OFFSET(0x1B3CAF90)
#define UNITYENGINE_RENDERER_SET_MOTIONVECTORS_OFFSET UNITYSDK_OFFSET(0x1B3CAF70)
#define UNITYENGINE_RENDERER_SET_NAPDRAWSET_OFFSET UNITYSDK_OFFSET(0x1B3CB650)
#define UNITYENGINE_RENDERER_SET_NEEDHIZCULLING_OFFSET UNITYSDK_OFFSET(0x1B3CBDA0)
#define UNITYENGINE_RENDERER_SET_PROBEANCHOR_OFFSET UNITYSDK_OFFSET(0x1B3CB630)
#define UNITYENGINE_RENDERER_SET_RAYTRACINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1B3CB360)
#define UNITYENGINE_RENDERER_SET_RAYTRACINGMODE_OFFSET UNITYSDK_OFFSET(0x1B3CB3A0)
#define UNITYENGINE_RENDERER_SET_REALTIMELIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B3CB760)
#define UNITYENGINE_RENDERER_SET_REALTIMELIGHTMAPSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3CB810)
#define UNITYENGINE_RENDERER_SET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1B3CB2C0)
#define UNITYENGINE_RENDERER_SET_REFLECTIONPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1B3CB320)
#define UNITYENGINE_RENDERER_SET_RENDERERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3CB380)
#define UNITYENGINE_RENDERER_SET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1B3CB340)
#define UNITYENGINE_RENDERER_SET_SHADOWCASTERCULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B3CB480)
#define UNITYENGINE_RENDERER_SET_SHADOWCASTINGMODE_OFFSET UNITYSDK_OFFSET(0x1B3CAF30)
#define UNITYENGINE_RENDERER_SET_SHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B3CBAF0)
#define UNITYENGINE_RENDERER_SET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3CBAD0)
#define UNITYENGINE_RENDERER_SET_SORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x1B3CB420)
#define UNITYENGINE_RENDERER_SET_SORTINGGROUPORDER_OFFSET UNITYSDK_OFFSET(0x1B3CB440)
#define UNITYENGINE_RENDERER_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x1B3CB3E0)
#define UNITYENGINE_RENDERER_SET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x1B3CB3C0)
#define UNITYENGINE_RENDERER_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x1B3CB400)
#define UNITYENGINE_RENDERER_SET_STATICBATCHROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3CB4E0)
#define UNITYENGINE_RENDERER_SET_TEXTURESTREAMINGCALCSCALE_OFFSET UNITYSDK_OFFSET(0x1B3CB4A0)
#define UNITYENGINE_RENDERER_SET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1B3CAFD0)
#define UNITYENGINE_RENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3CBDD0)
