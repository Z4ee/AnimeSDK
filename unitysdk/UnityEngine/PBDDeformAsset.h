...
#define UNITYENGINE_PBDDEFORMASSET_CALCULATEROTATIONDATA_OFFSET UNITYSDK_OFFSET(0x1FBC94A0)
#define UNITYENGINE_PBDDEFORMASSET_CREATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1FBC9350)
#define UNITYENGINE_PBDDEFORMASSET_GENERATERIGIDBODYLINKDATA_OFFSET UNITYSDK_OFFSET(0x1FBC9440)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESKELETONPARTICLESKINDATA_OFFSET UNITYSDK_OFFSET(0x1FBC9470)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1FBC9460)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESOFTBODYSKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1FBC93F0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATEUNIFORMPARTICLES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1FBC9540)
#define UNITYENGINE_PBDDEFORMASSET_GENERATEUNIFORMPARTICLES_OFFSET UNITYSDK_OFFSET(0x1FBC94B0)
#define UNITYENGINE_PBDDEFORMASSET_GETBONETARGETMESHES_OFFSET UNITYSDK_OFFSET(0x1FBC9480)
#define UNITYENGINE_PBDDEFORMASSET_GETTETRATARGETMESHES_OFFSET UNITYSDK_OFFSET(0x1FBC9410)
#define UNITYENGINE_PBDDEFORMASSET_GETVERTEXTETRACOUNT_OFFSET UNITYSDK_OFFSET(0x1FBC9400)
#define UNITYENGINE_PBDDEFORMASSET_GET_DISTANCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC9250)
#define UNITYENGINE_PBDDEFORMASSET_GET_FIXCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC9270)
#define UNITYENGINE_PBDDEFORMASSET_GET_JOINTCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC92B0)
#define UNITYENGINE_PBDDEFORMASSET_GET_LINKEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1FBC92D0)
#define UNITYENGINE_PBDDEFORMASSET_GET_PARTICLES_OFFSET UNITYSDK_OFFSET(0x1FBC9230)
#define UNITYENGINE_PBDDEFORMASSET_GET_VOLUMECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC9290)
#define UNITYENGINE_PBDDEFORMASSET_IMPORTFROMJSON_INJECTED_OFFSET UNITYSDK_OFFSET(0x1FBC93E0)
#define UNITYENGINE_PBDDEFORMASSET_IMPORTFROMJSON_OFFSET UNITYSDK_OFFSET(0x1FBC93D0)
#define UNITYENGINE_PBDDEFORMASSET_NEEDUPDATERIGIDBODYLINKDATA_OFFSET UNITYSDK_OFFSET(0x1FBC9450)
#define UNITYENGINE_PBDDEFORMASSET_NEEDUPDATETETRASKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1FBC9430)
#define UNITYENGINE_PBDDEFORMASSET_REMOVEBONETARGETMESH_OFFSET UNITYSDK_OFFSET(0x1FBC9490)
#define UNITYENGINE_PBDDEFORMASSET_REMOVETETRATARGETMESH_OFFSET UNITYSDK_OFFSET(0x1FBC9420)
#define UNITYENGINE_PBDDEFORMASSET_SET_DISTANCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC9260)
#define UNITYENGINE_PBDDEFORMASSET_SET_FIXCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC9280)
#define UNITYENGINE_PBDDEFORMASSET_SET_JOINTCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC92C0)
#define UNITYENGINE_PBDDEFORMASSET_SET_LINKEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1FBC92E0)
#define UNITYENGINE_PBDDEFORMASSET_SET_PARTICLES_OFFSET UNITYSDK_OFFSET(0x1FBC9240)
#define UNITYENGINE_PBDDEFORMASSET_SET_VOLUMECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1FBC92A0)
#define UNITYENGINE_PBDDEFORMASSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBC9360)
#define UNITYENGINE_PBDDEFORMASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC92F0)

namespace UnityEngine
{
	inline static constexpr unsigned int PBDDeformAsset_TypeDefinitionIndex = 19158;
