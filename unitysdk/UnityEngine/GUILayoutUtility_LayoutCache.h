...
#define UNITYENGINE_GUILAYOUTUTILITY_LAYOUTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD2120)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayoutUtility_LayoutCache_TypeDefinitionIndex = 5170;
