...
#define UNITYENGINE_GUILAYOUTUTILITY_LAYOUTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E42BE30)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayoutUtility_LayoutCache_TypeDefinitionIndex = 6417;
