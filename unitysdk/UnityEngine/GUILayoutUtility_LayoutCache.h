...
#define UNITYENGINE_GUILAYOUTUTILITY_LAYOUTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A79460)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayoutUtility_LayoutCache_TypeDefinitionIndex = 5117;
