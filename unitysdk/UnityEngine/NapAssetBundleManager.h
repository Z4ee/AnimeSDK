...
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_CLEARALLNAPBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1C545110)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_CLEARNAPBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1C545120)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETALLLOADEDBLOCKPATHS_OFFSET UNITYSDK_OFFSET(0x1C545190)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETALLLOADEDBUNDLEHASHES_OFFSET UNITYSDK_OFFSET(0x1C5451A0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOADEDBUNDLE_OFFSET UNITYSDK_OFFSET(0x1C545140)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOGGINGCOSTTIME_OFFSET UNITYSDK_OFFSET(0x1C545200)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOGGINGSUPPORT_OFFSET UNITYSDK_OFFSET(0x1C5451E0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_ISASSETLOADDONE_OFFSET UNITYSDK_OFFSET(0x1C545160)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1C545150)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1C545130)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETENABLEDELAYUNLOAD_OFFSET UNITYSDK_OFFSET(0x1C5451C0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETLOGGINGCOSTTIME_OFFSET UNITYSDK_OFFSET(0x1C5451F0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETLOGGINGSUPPORT_OFFSET UNITYSDK_OFFSET(0x1C5451D0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETNAPASSETBUNDLEINDEXASSET_OFFSET UNITYSDK_OFFSET(0x1C545100)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1C545180)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x1C545170)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C5451B0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C545210)

namespace UnityEngine
{
	inline static constexpr unsigned int NapAssetBundleManager_TypeDefinitionIndex = 7604;
