...
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_CLEARALLNAPBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1E876220)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_CLEARNAPBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1E876230)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETALLLOADEDBLOCKPATHS_OFFSET UNITYSDK_OFFSET(0x1E8762A0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETALLLOADEDBUNDLEHASHES_OFFSET UNITYSDK_OFFSET(0x1E8762B0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOADEDBUNDLE_OFFSET UNITYSDK_OFFSET(0x1E876250)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOGGINGCOSTTIME_OFFSET UNITYSDK_OFFSET(0x1E876310)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOGGINGSUPPORT_OFFSET UNITYSDK_OFFSET(0x1E8762F0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_ISASSETLOADDONE_OFFSET UNITYSDK_OFFSET(0x1E876270)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1E876260)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1E876240)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETENABLEDELAYUNLOAD_OFFSET UNITYSDK_OFFSET(0x1E8762D0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETLOGGINGCOSTTIME_OFFSET UNITYSDK_OFFSET(0x1E876300)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETLOGGINGSUPPORT_OFFSET UNITYSDK_OFFSET(0x1E8762E0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETNAPASSETBUNDLEINDEXASSET_OFFSET UNITYSDK_OFFSET(0x1E876210)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1E876290)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x1E876280)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E8762C0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E876320)

namespace UnityEngine
{
	inline static constexpr unsigned int NapAssetBundleManager_TypeDefinitionIndex = 7680;
