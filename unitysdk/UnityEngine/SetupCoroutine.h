...
#define UNITYENGINE_SETUPCOROUTINE_INVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1D4FF180)
#define UNITYENGINE_SETUPCOROUTINE_INVOKEMOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D4FF070)
#define UNITYENGINE_SETUPCOROUTINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FF2C0)
