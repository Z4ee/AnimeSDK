...
#define UNITYENGINE_MINIMALCRPVERSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D119D20)

namespace UnityEngine
{
	inline static constexpr unsigned int MinimalCrpVersionAttribute_TypeDefinitionIndex = 4301;
