...
#define UNITYENGINE_WHEELCOLLIDER_GETWORLDPOSE_OFFSET UNITYSDK_OFFSET(0x1FC705D0)
#define UNITYENGINE_WHEELCOLLIDER_SET_MOTORTORQUE_OFFSET UNITYSDK_OFFSET(0x1FC705B0)
#define UNITYENGINE_WHEELCOLLIDER_SET_STEERANGLE_OFFSET UNITYSDK_OFFSET(0x1FC705C0)
#define UNITYENGINE_WHEELCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC705E0)

namespace UnityEngine
{
	inline static constexpr unsigned int WheelCollider_TypeDefinitionIndex = 33143;
