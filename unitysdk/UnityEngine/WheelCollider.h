...
#define UNITYENGINE_WHEELCOLLIDER_GETWORLDPOSE_OFFSET UNITYSDK_OFFSET(0x1E891380)
#define UNITYENGINE_WHEELCOLLIDER_SET_MOTORTORQUE_OFFSET UNITYSDK_OFFSET(0x1E891360)
#define UNITYENGINE_WHEELCOLLIDER_SET_STEERANGLE_OFFSET UNITYSDK_OFFSET(0x1E891370)
#define UNITYENGINE_WHEELCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E891390)

namespace UnityEngine
{
	inline static constexpr unsigned int WheelCollider_TypeDefinitionIndex = 32508;
