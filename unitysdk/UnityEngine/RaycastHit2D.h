...
#define UNITYENGINE_RAYCASTHIT2D_COMPARETO_OFFSET UNITYSDK_OFFSET(0xAA27B0)
#define UNITYENGINE_RAYCASTHIT2D_GET_CENTROID_OFFSET UNITYSDK_OFFSET(0x259D70)
#define UNITYENGINE_RAYCASTHIT2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0xAA26F0)
#define UNITYENGINE_RAYCASTHIT2D_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x61E820)
#define UNITYENGINE_RAYCASTHIT2D_GET_FRACTION_OFFSET UNITYSDK_OFFSET(0xA3F7B0)
#define UNITYENGINE_RAYCASTHIT2D_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x3C9DA0)
#define UNITYENGINE_RAYCASTHIT2D_GET_POINT_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define UNITYENGINE_RAYCASTHIT2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0xAA2790)
#define UNITYENGINE_RAYCASTHIT2D_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xAA27A0)
#define UNITYENGINE_RAYCASTHIT2D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1F3C5C90)
#define UNITYENGINE_RAYCASTHIT2D_SET_CENTROID_OFFSET UNITYSDK_OFFSET(0x324D50)
#define UNITYENGINE_RAYCASTHIT2D_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x7F9500)
#define UNITYENGINE_RAYCASTHIT2D_SET_FRACTION_OFFSET UNITYSDK_OFFSET(0xA7E7A0)
#define UNITYENGINE_RAYCASTHIT2D_SET_NORMAL_OFFSET UNITYSDK_OFFSET(0x3C9DB0)
#define UNITYENGINE_RAYCASTHIT2D_SET_POINT_OFFSET UNITYSDK_OFFSET(0x462A80)

namespace UnityEngine
{
	inline static constexpr unsigned int RaycastHit2D_TypeDefinitionIndex = 18791;
