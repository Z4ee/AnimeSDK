...
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_OFFSET UNITYSDK_OFFSET(0x1D0EC340)
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_VECTOR2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC2E0)
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_VECTOR2_OFFSET UNITYSDK_OFFSET(0x1D0EC2B0)
#define UNITYENGINE_GUICLIP_GETMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC2F0)
#define UNITYENGINE_GUICLIP_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1D0E46E0)
#define UNITYENGINE_GUICLIP_GET_TOPMOSTRECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC250)
#define UNITYENGINE_GUICLIP_GET_TOPMOSTRECT_OFFSET UNITYSDK_OFFSET(0x1D0EC220)
#define UNITYENGINE_GUICLIP_GET_VISIBLERECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC210)
#define UNITYENGINE_GUICLIP_GET_VISIBLERECT_OFFSET UNITYSDK_OFFSET(0x1D0E79A0)
#define UNITYENGINE_GUICLIP_INTERNAL_GETCOUNT_OFFSET UNITYSDK_OFFSET(0x1D0EC2A0)
#define UNITYENGINE_GUICLIP_INTERNAL_POPPARENTCLIP_OFFSET UNITYSDK_OFFSET(0x1D0EC330)
#define UNITYENGINE_GUICLIP_INTERNAL_POP_OFFSET UNITYSDK_OFFSET(0x1D0E9470)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSHPARENTCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC320)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSHPARENTCLIP_OFFSET UNITYSDK_OFFSET(0x1D0EC310)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC290)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSH_OFFSET UNITYSDK_OFFSET(0x1D0EC260)
#define UNITYENGINE_GUICLIP_POP_OFFSET UNITYSDK_OFFSET(0x1D0EAC70)
#define UNITYENGINE_GUICLIP_PUSH_OFFSET UNITYSDK_OFFSET(0x1D0E93C0)
#define UNITYENGINE_GUICLIP_SETMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0EC300)
#define UNITYENGINE_GUICLIP_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x1D0E4780)
#define UNITYENGINE_GUICLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0EC370)

namespace UnityEngine
{
	inline static constexpr unsigned int GUIClip_TypeDefinitionIndex = 6402;
