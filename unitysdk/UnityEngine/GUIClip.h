...
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_OFFSET UNITYSDK_OFFSET(0x1ACE9690)
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_VECTOR2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE9630)
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_VECTOR2_OFFSET UNITYSDK_OFFSET(0x1ACE9600)
#define UNITYENGINE_GUICLIP_GETMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE9640)
#define UNITYENGINE_GUICLIP_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1ACE1A30)
#define UNITYENGINE_GUICLIP_GET_TOPMOSTRECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE95A0)
#define UNITYENGINE_GUICLIP_GET_TOPMOSTRECT_OFFSET UNITYSDK_OFFSET(0x1ACE9570)
#define UNITYENGINE_GUICLIP_GET_VISIBLERECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE9560)
#define UNITYENGINE_GUICLIP_GET_VISIBLERECT_OFFSET UNITYSDK_OFFSET(0x1ACE4CF0)
#define UNITYENGINE_GUICLIP_INTERNAL_GETCOUNT_OFFSET UNITYSDK_OFFSET(0x1ACE95F0)
#define UNITYENGINE_GUICLIP_INTERNAL_POPPARENTCLIP_OFFSET UNITYSDK_OFFSET(0x1ACE9680)
#define UNITYENGINE_GUICLIP_INTERNAL_POP_OFFSET UNITYSDK_OFFSET(0x1ACE67C0)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSHPARENTCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE9670)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSHPARENTCLIP_OFFSET UNITYSDK_OFFSET(0x1ACE9660)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE95E0)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSH_OFFSET UNITYSDK_OFFSET(0x1ACE95B0)
#define UNITYENGINE_GUICLIP_POP_OFFSET UNITYSDK_OFFSET(0x1ACE7FC0)
#define UNITYENGINE_GUICLIP_PUSH_OFFSET UNITYSDK_OFFSET(0x1ACE6710)
#define UNITYENGINE_GUICLIP_SETMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACE9650)
#define UNITYENGINE_GUICLIP_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x1ACE1AD0)
#define UNITYENGINE_GUICLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE96C0)

namespace UnityEngine
{
	inline static constexpr unsigned int GUIClip_TypeDefinitionIndex = 6357;
