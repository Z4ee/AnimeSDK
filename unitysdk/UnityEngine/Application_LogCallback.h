...
#define UNITYENGINE_APPLICATION_LOGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EB5C7D0)
#define UNITYENGINE_APPLICATION_LOGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EB5C860)
#define UNITYENGINE_APPLICATION_LOGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB5C210)
#define UNITYENGINE_APPLICATION_LOGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5C1F0)

namespace UnityEngine
{
	inline static constexpr unsigned int Application_LogCallback_TypeDefinitionIndex = 5131;
