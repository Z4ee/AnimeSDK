...
#define UNITYENGINE_ANIMATOR_GRAPHEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1B5D30)
#define UNITYENGINE_ANIMATOR_GRAPHEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1B5DE0)
#define UNITYENGINE_ANIMATOR_GRAPHEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1B57B0)
#define UNITYENGINE_ANIMATOR_GRAPHEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B5CC0)

namespace UnityEngine
{
	inline static constexpr unsigned int Animator_GraphEventDelegate_TypeDefinitionIndex = 5143;
