...
#define UNITYENGINE_RIGIDBODYEXTENSIONS_HANDLECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1AC77FC0)

namespace UnityEngine
{
	inline static constexpr unsigned int RigidbodyExtensions_TypeDefinitionIndex = 81135;
