...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSETHREADED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D67D290)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D67D200)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D67D150)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D67D210)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONCREATEDVIDEOCAPTURERESOURCEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1D67CD10)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONSTARTEDRECORDINGVIDEOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x1D67CF70)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONSTOPPEDRECORDINGVIDEOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x1D67D060)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONVIDEOMODESTARTEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1D67CD90)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONVIDEOMODESTOPPEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1D67CE80)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_MAKECAPTURERESULT_OFFSET UNITYSDK_OFFSET(0x1D67CCA0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D67D2A0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D67CD80)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_TypeDefinitionIndex = 5472;
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(VideoCapture_TypeDefinitionIndex)->GetStaticField(0x2EF0);
		}
