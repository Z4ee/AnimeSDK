...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF5D760)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF5D7D0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF5D3B0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5D390)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnStoppedRecordingVideoCallback_TypeDefinitionIndex = 5479;
