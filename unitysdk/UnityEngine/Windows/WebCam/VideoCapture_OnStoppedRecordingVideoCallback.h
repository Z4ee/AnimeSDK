...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F34C9A0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F34CA10)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F34C5D0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTOPPEDRECORDINGVIDEOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F34C5B0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnStoppedRecordingVideoCallback_TypeDefinitionIndex = 5482;
