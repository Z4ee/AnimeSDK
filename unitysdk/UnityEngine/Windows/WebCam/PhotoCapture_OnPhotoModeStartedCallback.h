...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7A9B0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7AA20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7A5F0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7A5E0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnPhotoModeStartedCallback_TypeDefinitionIndex = 5466;
