...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E60EF10)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E60EF80)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E60EB40)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E60EB20)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnPhotoModeStartedCallback_TypeDefinitionIndex = 5470;
