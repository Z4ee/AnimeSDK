...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AB910)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AB980)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AB560)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AB540)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnPhotoModeStartedCallback_TypeDefinitionIndex = 5467;
