...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTOPPEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EA92670)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTOPPEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EA926E0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTOPPEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EA922A0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTOPPEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA92280)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnPhotoModeStoppedCallback_TypeDefinitionIndex = 5471;
