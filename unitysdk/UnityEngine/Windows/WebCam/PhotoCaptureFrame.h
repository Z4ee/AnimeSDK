...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B2F7FF0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B2F80E0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2F80F0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B2F8280)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETCAPTUREPIXELFORMAT_OFFSET UNITYSDK_OFFSET(0x1B2F7EF0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETDATALENGTH_OFFSET UNITYSDK_OFFSET(0x1B2F7ED0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETHASLOCATIONDATA_OFFSET UNITYSDK_OFFSET(0x1B2F7EE0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GET_DATALENGTH_OFFSET UNITYSDK_OFFSET(0x1B2F7E90)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_DATALENGTH_OFFSET UNITYSDK_OFFSET(0x1B2F7EA0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_HASLOCATIONDATA_OFFSET UNITYSDK_OFFSET(0x1B2F7EB0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_PIXELFORMAT_OFFSET UNITYSDK_OFFSET(0x1B2F7EC0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F7F00)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCaptureFrame_TypeDefinitionIndex = 5470;
