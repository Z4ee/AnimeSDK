...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1D6AE050)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D6AE140)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D6AE150)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D6AE2E0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETCAPTUREPIXELFORMAT_OFFSET UNITYSDK_OFFSET(0x1D6ADF50)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETDATALENGTH_OFFSET UNITYSDK_OFFSET(0x1D6ADF30)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETHASLOCATIONDATA_OFFSET UNITYSDK_OFFSET(0x1D6ADF40)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GET_DATALENGTH_OFFSET UNITYSDK_OFFSET(0x1D6ADEF0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_DATALENGTH_OFFSET UNITYSDK_OFFSET(0x1D6ADF00)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_HASLOCATIONDATA_OFFSET UNITYSDK_OFFSET(0x1D6ADF10)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_PIXELFORMAT_OFFSET UNITYSDK_OFFSET(0x1D6ADF20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6ADF60)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCaptureFrame_TypeDefinitionIndex = 5471;
