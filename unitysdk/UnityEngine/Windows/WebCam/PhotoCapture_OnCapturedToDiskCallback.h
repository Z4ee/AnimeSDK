...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0CA260)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0CA2D0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0C9EA0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C9E90)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCapturedToDiskCallback_TypeDefinitionIndex = 5468;
