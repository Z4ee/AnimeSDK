...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E8B44C0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E8B4530)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8B40F0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8B40D0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCapturedToDiskCallback_TypeDefinitionIndex = 5472;
