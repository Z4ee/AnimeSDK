...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F34C530)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F34C5A0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F34C160)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F34C140)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnStartedRecordingVideoCallback_TypeDefinitionIndex = 5481;
