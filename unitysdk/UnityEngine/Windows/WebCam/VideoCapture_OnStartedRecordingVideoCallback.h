...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BC22C00)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BC22C70)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BC22840)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONSTARTEDRECORDINGVIDEOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC22830)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnStartedRecordingVideoCallback_TypeDefinitionIndex = 5477;
