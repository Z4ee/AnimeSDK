...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_DISPOSETHREADED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B749030)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B748FA0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B748EF0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B748FB0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONCAPTUREDPHOTOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B748CC0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONCAPTUREDPHOTOTOMEMORYDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B748DB0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONCREATEDRESOURCEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B748A60)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONPHOTOMODESTARTEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B748AE0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONPHOTOMODESTOPPEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B748BD0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_MAKECAPTURERESULT_OFFSET UNITYSDK_OFFSET(0x1B7489F0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B749040)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B748AD0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_TypeDefinitionIndex = 5462;
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(PhotoCapture_TypeDefinitionIndex)->GetStaticField(0x2EC0);
		}
