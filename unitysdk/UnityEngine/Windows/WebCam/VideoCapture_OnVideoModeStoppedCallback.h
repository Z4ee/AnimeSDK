...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFBFA00)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFBFA70)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFBF640)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFBF630)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnVideoModeStoppedCallback_TypeDefinitionIndex = 5476;
