...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D435F00)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D435F70)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D435B50)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D435B30)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnVideoModeStoppedCallback_TypeDefinitionIndex = 5477;
