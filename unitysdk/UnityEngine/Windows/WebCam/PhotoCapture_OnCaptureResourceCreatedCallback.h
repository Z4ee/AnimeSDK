...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3A6B80)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B3A6BB0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B3A6680)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A6670)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCaptureResourceCreatedCallback_TypeDefinitionIndex = 5465;
