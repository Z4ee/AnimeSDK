...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE7950)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE79D0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE7520)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE7500)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCapturedToMemoryCallback_TypeDefinitionIndex = 5473;
