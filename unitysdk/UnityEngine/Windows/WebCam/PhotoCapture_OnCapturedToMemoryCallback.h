...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B663180)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B663200)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B662D70)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B662D60)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCapturedToMemoryCallback_TypeDefinitionIndex = 5469;
