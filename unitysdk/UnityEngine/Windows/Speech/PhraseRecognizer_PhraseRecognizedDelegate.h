...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B18F920)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B18F990)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B18F460)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18F450)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int PhraseRecognizer_PhraseRecognizedDelegate_TypeDefinitionIndex = 5449;
