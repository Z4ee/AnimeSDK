...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EED7350)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EED73C0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EED72A0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EED72E0)
