...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2E9900)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2E9970)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B2E9850)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E9890)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_DictationCompletedDelegate_TypeDefinitionIndex = 4421;
