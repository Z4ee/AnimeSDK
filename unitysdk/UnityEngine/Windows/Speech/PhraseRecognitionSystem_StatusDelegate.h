...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_STATUSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D22D030)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_STATUSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D22D0A0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_STATUSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D22CEC0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_STATUSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22CFC0)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int PhraseRecognitionSystem_StatusDelegate_TypeDefinitionIndex = 4420;
