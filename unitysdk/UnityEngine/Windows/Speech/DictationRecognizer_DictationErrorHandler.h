...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D22CC20)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D22CC80)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D22CAA0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22CBA0)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_DictationErrorHandler_TypeDefinitionIndex = 4427;
