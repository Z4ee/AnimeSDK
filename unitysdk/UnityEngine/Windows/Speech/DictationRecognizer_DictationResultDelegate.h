...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ED78F50)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ED78FD0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ED78BD0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED78ED0)
