...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_DESTROYTHREADED_OFFSET UNITYSDK_OFFSET(0x1EA1F9E0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1EA1F9D0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA1FB00)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EA1FA00)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_INVOKEPHRASERECOGNIZEDEVENT_OFFSET UNITYSDK_OFFSET(0x1EA1FBB0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_MARSHALSEMANTICMEANING_OFFSET UNITYSDK_OFFSET(0x1EA1FC20)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA1F9F0)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int PhraseRecognizer_TypeDefinitionIndex = 5452;
