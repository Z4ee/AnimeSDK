...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONHYPOTHESISDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A62B50)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONHYPOTHESISDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A62B80)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONHYPOTHESISDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A616D0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONHYPOTHESISDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A62B30)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_DictationHypothesisDelegate_TypeDefinitionIndex = 4243;
