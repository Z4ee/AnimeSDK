...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD5CA90)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD5CB00)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD5C770)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD5CA80)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int PhraseRecognitionSystem_ErrorDelegate_TypeDefinitionIndex = 5446;
