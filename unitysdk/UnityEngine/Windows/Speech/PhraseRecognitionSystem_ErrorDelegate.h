...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D13C150)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D13C1C0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D13BE20)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNITIONSYSTEM_ERRORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13C130)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int PhraseRecognitionSystem_ErrorDelegate_TypeDefinitionIndex = 5447;
