...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_CREATE_OFFSET UNITYSDK_OFFSET(0x1E7D9FA0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DESTROYTHREADED_OFFSET UNITYSDK_OFFSET(0x1E7D9FC0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E7D9FB0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKECOMPLETEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E7DA770)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKEERROREVENT_OFFSET UNITYSDK_OFFSET(0x1E7DA780)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKEHYPOTHESISGENERATEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E7DA1D0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKERESULTGENERATEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E7DA1E0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E7DA120)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E7DA020)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7DA000)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7D9FD0)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_TypeDefinitionIndex = 5454;
