...
#define UNITYENGINE_NAPANIMATOR_ADDANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1C54F8D0)
#define UNITYENGINE_NAPANIMATOR_BATCHSAMPLECURVETHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1C54F950)
#define UNITYENGINE_NAPANIMATOR_BATCHSAMPLENAPANIMATIONTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1C54F940)
#define UNITYENGINE_NAPANIMATOR_GETBONEPARENTINDICES_1_OFFSET UNITYSDK_OFFSET(0x1C54F910)
#define UNITYENGINE_NAPANIMATOR_GETBONEPARENTINDICES_OFFSET UNITYSDK_OFFSET(0x1C54F8F0)
#define UNITYENGINE_NAPANIMATOR_GETBONESNUM_OFFSET UNITYSDK_OFFSET(0x1C54F8E0)
#define UNITYENGINE_NAPANIMATOR_GETGENERICCURVEIDS_OFFSET UNITYSDK_OFFSET(0x1C54F930)
#define UNITYENGINE_NAPANIMATOR_GETGENERICCURVENUM_OFFSET UNITYSDK_OFFSET(0x1C54F920)
#define UNITYENGINE_NAPANIMATOR_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1C54F8B0)
#define UNITYENGINE_NAPANIMATOR_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1C54F8C0)
#define UNITYENGINE_NAPANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54F960)

namespace UnityEngine
{
	inline static constexpr unsigned int NapAnimator_TypeDefinitionIndex = 6566;
