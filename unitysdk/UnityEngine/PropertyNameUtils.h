...
#define UNITYENGINE_PROPERTYNAMEUTILS_PROPERTYNAMEFROMSTRING_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E60AE90)
#define UNITYENGINE_PROPERTYNAMEUTILS_PROPERTYNAMEFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1E60AE70)
#define UNITYENGINE_PROPERTYNAMEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E60AEA0)
