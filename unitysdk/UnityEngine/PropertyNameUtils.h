...
#define UNITYENGINE_PROPERTYNAMEUTILS_PROPERTYNAMEFROMSTRING_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE76970)
#define UNITYENGINE_PROPERTYNAMEUTILS_PROPERTYNAMEFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1AE76950)
#define UNITYENGINE_PROPERTYNAMEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE76980)
