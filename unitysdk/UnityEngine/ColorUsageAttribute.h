...
#define UNITYENGINE_COLORUSAGEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2830C0)
#define UNITYENGINE_COLORUSAGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B283090)

namespace UnityEngine
{
	inline static constexpr unsigned int ColorUsageAttribute_TypeDefinitionIndex = 4228;
	...
	public:
		...
		::System::Single maxBrightness; // 0x18
		::System::Boolean hdr; // 0x1C
		::System::Boolean showAlpha; // 0x1D
