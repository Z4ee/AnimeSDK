...
#define UNITYENGINE_SCRIPTINGUTILITY_ISMANAGEDCODEWORKING_OFFSET UNITYSDK_OFFSET(0x1EA66A40)
#define UNITYENGINE_SCRIPTINGUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA66A50)
