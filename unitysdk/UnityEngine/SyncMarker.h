...
#define UNITYENGINE_SYNCMARKER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3BB50E0)
#define UNITYENGINE_SYNCMARKER_EQUALS_OFFSET UNITYSDK_OFFSET(0x2E960)
#define UNITYENGINE_SYNCMARKER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5F00)
