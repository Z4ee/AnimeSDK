...
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_ASPECT_OFFSET UNITYSDK_OFFSET(0xCC80)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_MODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_SET_ASPECT_OFFSET UNITYSDK_OFFSET(0xCC90)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_SET_MODE_OFFSET UNITYSDK_OFFSET(0x29130)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x7F5F0)

namespace UnityEngine
{
	inline static constexpr unsigned int Camera_GateFitParameters_TypeDefinitionIndex = 3853;
