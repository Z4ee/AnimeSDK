...
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_ASPECT_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_MODE_OFFSET UNITYSDK_OFFSET(0x167710)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_SET_ASPECT_OFFSET UNITYSDK_OFFSET(0x38DAE60)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_SET_MODE_OFFSET UNITYSDK_OFFSET(0x167520)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x3926EC0)

namespace UnityEngine
{
	inline static constexpr unsigned int Camera_GateFitParameters_TypeDefinitionIndex = 4034;
