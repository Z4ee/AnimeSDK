...
#define UNITYENGINE_PING_DESTROYPING_OFFSET UNITYSDK_OFFSET(0x1AFBD0D0)
#define UNITYENGINE_PING_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AFBD050)
#define UNITYENGINE_PING_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1AFBD110)
#define UNITYENGINE_PING_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1AFBD140)
#define UNITYENGINE_PING_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1AFBD040)
#define UNITYENGINE_PING_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AFBD100)
#define UNITYENGINE_PING_INTERNAL_ISDONE_OFFSET UNITYSDK_OFFSET(0x1AFBD130)
#define UNITYENGINE_PING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFBD020)
