...
#define UNITYENGINE_LIGHTMAPDATA_SET_AREADIRECT_OFFSET UNITYSDK_OFFSET(0x1DA21410)
#define UNITYENGINE_LIGHTMAPDATA_SET_LIGHTMAPCOLOR_OFFSET UNITYSDK_OFFSET(0x1DA21400)
#define UNITYENGINE_LIGHTMAPDATA_SET_LIGHTSKYOC_OFFSET UNITYSDK_OFFSET(0x1DA21420)
#define UNITYENGINE_LIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA21430)
