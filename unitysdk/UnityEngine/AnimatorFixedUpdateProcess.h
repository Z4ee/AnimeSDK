...
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_CREATE_OFFSET UNITYSDK_OFFSET(0x1C550B70)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C550BA0)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C550B80)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_INVOKEONANIMATORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C550BB0)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C550B40)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimatorFixedUpdateProcess_TypeDefinitionIndex = 6546;
