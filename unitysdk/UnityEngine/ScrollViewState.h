...
#define UNITYENGINE_SCROLLVIEWSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD9820)

namespace UnityEngine
{
	inline static constexpr unsigned int ScrollViewState_TypeDefinitionIndex = 5188;
