...
#define UNITYENGINE_SCROLLVIEWSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E432B60)

namespace UnityEngine
{
	inline static constexpr unsigned int ScrollViewState_TypeDefinitionIndex = 6434;
