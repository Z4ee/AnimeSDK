...
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_GET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D41B4A0)
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_GET_OFFSET UNITYSDK_OFFSET(0x1D41B470)
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_SET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D41B4C0)
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_SET_OFFSET UNITYSDK_OFFSET(0x1D41B4B0)
