...
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY_GET_FLOATVALUE_OFFSET UNITYSDK_OFFSET(0x38803E0)
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B286570)
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x38803A0)

namespace UnityEngine
{
	inline static constexpr unsigned int ConsoleVariableFloatProperty_TypeDefinitionIndex = 4044;
