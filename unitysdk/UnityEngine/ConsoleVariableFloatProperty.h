...
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY_GET_FLOATVALUE_OFFSET UNITYSDK_OFFSET(0x3C23130)
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1DECB9D0)
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x3C230F0)
