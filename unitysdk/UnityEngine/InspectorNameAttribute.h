...
#define UNITYENGINE_INSPECTORNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A11BE0)

namespace UnityEngine
{
	inline static constexpr unsigned int InspectorNameAttribute_TypeDefinitionIndex = 4045;
