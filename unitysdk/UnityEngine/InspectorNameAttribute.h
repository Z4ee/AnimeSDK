...
#define UNITYENGINE_INSPECTORNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A44B6E0)

namespace UnityEngine
{
	inline static constexpr unsigned int InspectorNameAttribute_TypeDefinitionIndex = 4047;
