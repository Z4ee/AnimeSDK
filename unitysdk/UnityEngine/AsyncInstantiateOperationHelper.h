...
#define UNITYENGINE_ASYNCINSTANTIATEOPERATIONHELPER_SETASYNCINSTANTIATEOPERATIONRESULT_OFFSET UNITYSDK_OFFSET(0x1D6A14E0)
#define UNITYENGINE_ASYNCINSTANTIATEOPERATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A1500)
