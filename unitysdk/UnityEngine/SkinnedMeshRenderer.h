...
#define UNITYENGINE_SKINNEDMESHRENDERER_ALIGNLODMESH_OFFSET UNITYSDK_OFFSET(0x1B747AE0)
#define UNITYENGINE_SKINNEDMESHRENDERER_BAKEMESH_OFFSET UNITYSDK_OFFSET(0x1B747910)
#define UNITYENGINE_SKINNEDMESHRENDERER_CLEARCACHEDMESHDATA_OFFSET UNITYSDK_OFFSET(0x1B747B10)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_1_OFFSET UNITYSDK_OFFSET(0x1B747BD0)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_2_OFFSET UNITYSDK_OFFSET(0x1B747C60)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_3_OFFSET UNITYSDK_OFFSET(0x1B747BC0)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B747D30)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1B747B30)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETBLENDSHAPEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B7478F0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETCACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1B747AF0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETISLOOPSUBDIVISIONALLOWED_OFFSET UNITYSDK_OFFSET(0x1B7479B0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOCALAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B747970)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOCALAABB_OFFSET UNITYSDK_OFFSET(0x1B747920)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOOPSUBDIVSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B747A40)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOOPSUBDIVSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B7479E0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1B747880)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_ENABLECOMPACTCOMPUTESKINNINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B747800)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_FORCEMATRIXRECALCULATIONPERRENDER_OFFSET UNITYSDK_OFFSET(0x1B747820)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B747A50)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_QUALITY_OFFSET UNITYSDK_OFFSET(0x1B7477C0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1B747860)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_SHAREDMESH_OFFSET UNITYSDK_OFFSET(0x1B7478A0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_SKINNEDMOTIONVECTORS_OFFSET UNITYSDK_OFFSET(0x1B7478C0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1B747840)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_UPDATEWHENOFFSCREEN_OFFSET UNITYSDK_OFFSET(0x1B7477E0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GLOBALOVERRIDEENABLECOMPACTCOMPUTESKINNINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B747AD0)
#define UNITYENGINE_SKINNEDMESHRENDERER_RELEASEALLCACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1B747B20)
#define UNITYENGINE_SKINNEDMESHRENDERER_RELEASECACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1B747B00)
#define UNITYENGINE_SKINNEDMESHRENDERER_RESETMOTIONVECTORSTATE_OFFSET UNITYSDK_OFFSET(0x1B7478E0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETBLENDSHAPEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B747900)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETISLOOPSUBDIVISIONALLOWED_OFFSET UNITYSDK_OFFSET(0x1B7479A0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOCALAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B747990)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOCALAABB_OFFSET UNITYSDK_OFFSET(0x1B747980)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOOPSUBDIVSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7479D0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOOPSUBDIVSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B7479C0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_BONES_OFFSET UNITYSDK_OFFSET(0x1B747890)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_ENABLECOMPACTCOMPUTESKINNINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B747810)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_FORCEMATRIXRECALCULATIONPERRENDER_OFFSET UNITYSDK_OFFSET(0x1B747830)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B747AA0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_QUALITY_OFFSET UNITYSDK_OFFSET(0x1B7477D0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1B747870)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_SHAREDMESH_OFFSET UNITYSDK_OFFSET(0x1B7478B0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_SKINNEDMOTIONVECTORS_OFFSET UNITYSDK_OFFSET(0x1B7478D0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1B747850)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_UPDATEWHENOFFSCREEN_OFFSET UNITYSDK_OFFSET(0x1B7477F0)
#define UNITYENGINE_SKINNEDMESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B747D40)
