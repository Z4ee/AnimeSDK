...
#define UNITYENGINE_MIHOYO_ENGINEVERSION_GET_P4BRANCH_OFFSET UNITYSDK_OFFSET(0x1A4C7140)
#define UNITYENGINE_MIHOYO_ENGINEVERSION_GET_P4COMMIT_OFFSET UNITYSDK_OFFSET(0x1A4C7130)
#define UNITYENGINE_MIHOYO_ENGINEVERSION_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A4C7150)

namespace UnityEngine::miHoYo
{
	inline static constexpr unsigned int EngineVersion_TypeDefinitionIndex = 6028;
