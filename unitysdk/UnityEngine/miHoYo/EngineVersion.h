...
#define UNITYENGINE_MIHOYO_ENGINEVERSION_GET_P4BRANCH_OFFSET UNITYSDK_OFFSET(0x1D306A30)
#define UNITYENGINE_MIHOYO_ENGINEVERSION_GET_P4COMMIT_OFFSET UNITYSDK_OFFSET(0x1D306A20)
#define UNITYENGINE_MIHOYO_ENGINEVERSION_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1D306A40)

namespace UnityEngine::miHoYo
{
	inline static constexpr unsigned int EngineVersion_TypeDefinitionIndex = 6310;
