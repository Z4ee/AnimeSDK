...
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FA38700)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FA38730)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FA38470)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA38450)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimatorOverrideController_OnOverrideControllerDirtyCallback_TypeDefinitionIndex = 6639;
