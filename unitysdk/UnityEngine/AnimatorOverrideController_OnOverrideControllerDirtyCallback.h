...
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ECF7C80)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ECF7CB0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ECF7C00)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECF7C10)
