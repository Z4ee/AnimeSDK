...
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC4E0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x22F1200)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETMODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC380)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETMODE_OFFSET UNITYSDK_OFFSET(0x22F1110)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTORCOMPONENTCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC3C0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTORCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x22F1130)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC440)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x22F1170)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC320)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x22F10E0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC460)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x22F11C0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETMODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC360)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETMODE_OFFSET UNITYSDK_OFFSET(0x22F1100)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTORCOMPONENTCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC3A0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTORCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x22F1120)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC3E0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x22F1140)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A4CC340)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x22F10F0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xBDC0)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleSystem_CustomDataModule_TypeDefinitionIndex = 5475;
