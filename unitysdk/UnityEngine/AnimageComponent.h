...
#define UNITYENGINE_ANIMAGECOMPONENT_GETANIMATOROUTPUTBONELOCALX_OFFSET UNITYSDK_OFFSET(0x1C55D8C0)
#define UNITYENGINE_ANIMAGECOMPONENT_GETANIMATOROUTPUTBONEX_OFFSET UNITYSDK_OFFSET(0x1C55D8B0)
#define UNITYENGINE_ANIMAGECOMPONENT_GETBONEREFX_OFFSET UNITYSDK_OFFSET(0x1C55D890)
#define UNITYENGINE_ANIMAGECOMPONENT_GETLASTFRAMEINPUTBONEX_OFFSET UNITYSDK_OFFSET(0x1C55D8A0)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGLINE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D8E0)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGLINE_OFFSET UNITYSDK_OFFSET(0x1C55D8D0)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGSPHERE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D900)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGSPHERE_OFFSET UNITYSDK_OFFSET(0x1C55D8F0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMFLOAT_OFFSET UNITYSDK_OFFSET(0x1C55D7C0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMINT_OFFSET UNITYSDK_OFFSET(0x1C55D7D0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUATWITHSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D880)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUATWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1C55D870)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUAT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D860)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUAT_OFFSET UNITYSDK_OFFSET(0x1C55D850)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D800)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR2_OFFSET UNITYSDK_OFFSET(0x1C55D7E0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR3_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D820)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR3_OFFSET UNITYSDK_OFFSET(0x1C55D810)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR4_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C55D840)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR4_OFFSET UNITYSDK_OFFSET(0x1C55D830)
#define UNITYENGINE_ANIMAGECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C55D910)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimageComponent_TypeDefinitionIndex = 37658;
