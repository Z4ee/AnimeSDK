...
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE_RELEASE_OFFSET UNITYSDK_OFFSET(0x189025F0)
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE_REQUIRE_OFFSET UNITYSDK_OFFSET(0x18902190)
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18901D20)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VolumeProxy_ComponentState_TypeDefinitionIndex = 27951;
