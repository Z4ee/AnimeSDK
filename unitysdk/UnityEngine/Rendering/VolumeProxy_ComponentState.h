...
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EC1C9D0)
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE_REQUIRE_OFFSET UNITYSDK_OFFSET(0x1EC1C380)
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC1BF30)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VolumeProxy_ComponentState_TypeDefinitionIndex = 34995;
