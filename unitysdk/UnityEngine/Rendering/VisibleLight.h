...
#define UNITYENGINE_RENDERING_VISIBLELIGHT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x922BF0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_EQUALS_OFFSET UNITYSDK_OFFSET(0x922B80)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x922CB0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_FINALCOLOR_OFFSET UNITYSDK_OFFSET(0x3A4D80)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_LIGHTTYPE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_LIGHT_OFFSET UNITYSDK_OFFSET(0x922AA0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_LOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x922B30)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x922B60)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_SPOTANGLE_OFFSET UNITYSDK_OFFSET(0x744BA0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x922B70)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VisibleLight_TypeDefinitionIndex = 6244;
