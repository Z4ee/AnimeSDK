...
#define UNITYENGINE_RENDERING_CRPACTOR_ADDACTOR_OFFSET UNITYSDK_OFFSET(0x1CE001F0)
#define UNITYENGINE_RENDERING_CRPACTOR_ADDFLAG_OFFSET UNITYSDK_OFFSET(0x1CE00250)
#define UNITYENGINE_RENDERING_CRPACTOR_ATTACHRENDERS_OFFSET UNITYSDK_OFFSET(0x1CE00230)
#define UNITYENGINE_RENDERING_CRPACTOR_QUERYACTOR_OFFSET UNITYSDK_OFFSET(0x1CE002A0)
#define UNITYENGINE_RENDERING_CRPACTOR_REFRESHACTORRENDER_OFFSET UNITYSDK_OFFSET(0x1CE00220)
#define UNITYENGINE_RENDERING_CRPACTOR_REFRESHACTOR_OFFSET UNITYSDK_OFFSET(0x1CE00210)
#define UNITYENGINE_RENDERING_CRPACTOR_REMOVEACTOR_OFFSET UNITYSDK_OFFSET(0x1CE00200)
#define UNITYENGINE_RENDERING_CRPACTOR_REMOVEFLAG_OFFSET UNITYSDK_OFFSET(0x1CE00260)
#define UNITYENGINE_RENDERING_CRPACTOR_SETABOVEOFFSET_OFFSET UNITYSDK_OFFSET(0x1CE00240)
#define UNITYENGINE_RENDERING_CRPACTOR_SETOBJLOCALLIGHT_OFFSET UNITYSDK_OFFSET(0x1CE00290)
#define UNITYENGINE_RENDERING_CRPACTOR_SETOVERRIDECACHEPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CE00280)
#define UNITYENGINE_RENDERING_CRPACTOR_SETOVERRIDECACHEPOS_OFFSET UNITYSDK_OFFSET(0x1CE00270)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CRPActor_TypeDefinitionIndex = 4853;
