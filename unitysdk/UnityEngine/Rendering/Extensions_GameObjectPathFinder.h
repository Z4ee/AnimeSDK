...
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDGAMEOBJECTBYPATH_OFFSET UNITYSDK_OFFSET(0x1C5AEE70)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINCHILDREN_OFFSET UNITYSDK_OFFSET(0x1C5AF720)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINROOTS_OFFSET UNITYSDK_OFFSET(0x1C5AF620)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1C5AEA50)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Extensions_GameObjectPathFinder_TypeDefinitionIndex = 26989;
