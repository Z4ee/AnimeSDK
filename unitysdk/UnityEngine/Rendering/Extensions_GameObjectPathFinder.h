...
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDGAMEOBJECTBYPATH_OFFSET UNITYSDK_OFFSET(0x19280140)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINCHILDREN_OFFSET UNITYSDK_OFFSET(0x19280A00)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINROOTS_OFFSET UNITYSDK_OFFSET(0x19280900)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1927FD20)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Extensions_GameObjectPathFinder_TypeDefinitionIndex = 29780;
