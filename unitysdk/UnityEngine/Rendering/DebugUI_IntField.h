...
#define UNITYENGINE_RENDERING_DEBUGUI_INTFIELD_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1CA78790)
#define UNITYENGINE_RENDERING_DEBUGUI_INTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA78830)
#define UNITYENGINE_RENDERING_DEBUGUI_INTFIELD___BASE_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1CA78840)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_IntField_TypeDefinitionIndex = 18689;
