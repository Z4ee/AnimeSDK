...
#define UNITYENGINE_RENDERING_LAYERMASKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F3460)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int LayerMaskParameter_TypeDefinitionIndex = 34188;
