...
#define UNITYENGINE_RENDERING_BASICQUEUE_HASDATA_OFFSET UNITYSDK_OFFSET(0x2FB60)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BasicQueue_TypeDefinitionIndex = 33696;
