...
#define UNITYENGINE_RENDERING_BASICQUEUE_HASDATA_OFFSET UNITYSDK_OFFSET(0x7C5460)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BasicQueue_TypeDefinitionIndex = 34067;
