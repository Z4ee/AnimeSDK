...
#define UNITYENGINE_RENDERING_REFLECTIONINFO_CLEARREFLECITONINFO_OFFSET UNITYSDK_OFFSET(0x18A45E60)
#define UNITYENGINE_RENDERING_REFLECTIONINFO_SETREFLECITONINFO_OFFSET UNITYSDK_OFFSET(0x18A45E70)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ReflectionInfo_TypeDefinitionIndex = 4610;
