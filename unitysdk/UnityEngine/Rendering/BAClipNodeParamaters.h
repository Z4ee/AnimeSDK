...
#define UNITYENGINE_RENDERING_BACLIPNODEPARAMATERS_SETCLIPMASK_OFFSET UNITYSDK_OFFSET(0x1ED52A20)
#define UNITYENGINE_RENDERING_BACLIPNODEPARAMATERS_SETCLIPWITHMASK_OFFSET UNITYSDK_OFFSET(0x1ED52A10)
#define UNITYENGINE_RENDERING_BACLIPNODEPARAMATERS_SETCLIP_OFFSET UNITYSDK_OFFSET(0x1ED52A00)
