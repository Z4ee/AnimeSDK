...
#define UNITYENGINE_RENDERING_BACLIPNODEPARAMATERS_SETCLIPMASK_OFFSET UNITYSDK_OFFSET(0x1CDFEF50)
#define UNITYENGINE_RENDERING_BACLIPNODEPARAMATERS_SETCLIPWITHMASK_OFFSET UNITYSDK_OFFSET(0x1CDFEF40)
#define UNITYENGINE_RENDERING_BACLIPNODEPARAMATERS_SETCLIP_OFFSET UNITYSDK_OFFSET(0x1CDFEF30)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BAClipNodeParamaters_TypeDefinitionIndex = 4780;
