...
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x18902D60)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_EYETEXTUREDESC_OFFSET UNITYSDK_OFFSET(0x18902DF0)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_EYETEXTUREHEIGHT_OFFSET UNITYSDK_OFFSET(0x18902EB0)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_EYETEXTURERESOLUTIONSCALE_OFFSET UNITYSDK_OFFSET(0x18902D30)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_EYETEXTUREWIDTH_OFFSET UNITYSDK_OFFSET(0x18902EA0)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_ISDEVICEACTIVE_OFFSET UNITYSDK_OFFSET(0x18902D70)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_LOADEDDEVICENAME_OFFSET UNITYSDK_OFFSET(0x18902D80)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_RENDERVIEWPORTSCALE_OFFSET UNITYSDK_OFFSET(0x18902D50)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_STEREORENDERINGMODE_OFFSET UNITYSDK_OFFSET(0x18902DE0)
#define UNITYENGINE_RENDERING_XRGRAPHICS_GET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x18902DC0)
#define UNITYENGINE_RENDERING_XRGRAPHICS_SET_EYETEXTURERESOLUTIONSCALE_OFFSET UNITYSDK_OFFSET(0x18902D40)
#define UNITYENGINE_RENDERING_XRGRAPHICS__CTOR_OFFSET UNITYSDK_OFFSET(0x18902EC0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int XRGraphics_TypeDefinitionIndex = 27799;
