...
#define UNITYENGINE_RENDERING_AMBIENTVOLUMNEDATA_ADDAMBIENTVOLUMNE_OFFSET UNITYSDK_OFFSET(0x1EAC5180)
#define UNITYENGINE_RENDERING_AMBIENTVOLUMNEDATA_REMOVEAMBIENTVOLUMNE_OFFSET UNITYSDK_OFFSET(0x1EAC5190)
#define UNITYENGINE_RENDERING_AMBIENTVOLUMNEDATA_SETGLOBALAMBIENTDIRTY_OFFSET UNITYSDK_OFFSET(0x1EAC51A0)
