...
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F3E80)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F3E90)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F3EB0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpClampedIntParameter_TypeDefinitionIndex = 34196;
