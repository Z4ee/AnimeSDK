...
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBFD410)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBFD420)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBFD440)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpClampedIntParameter_TypeDefinitionIndex = 34963;
