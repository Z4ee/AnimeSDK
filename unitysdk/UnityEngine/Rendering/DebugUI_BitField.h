...
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD_GET_ENUMNAMES_OFFSET UNITYSDK_OFFSET(0x1B4AA720)
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD_GET_ENUMTYPE_OFFSET UNITYSDK_OFFSET(0x1B4AAC50)
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD_GET_ENUMVALUES_OFFSET UNITYSDK_OFFSET(0x1B4AA740)
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD_SET_ENUMNAMES_OFFSET UNITYSDK_OFFSET(0x1B4AA730)
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD_SET_ENUMTYPE_OFFSET UNITYSDK_OFFSET(0x1B4AA760)
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD_SET_ENUMVALUES_OFFSET UNITYSDK_OFFSET(0x1B4AA750)
#define UNITYENGINE_RENDERING_DEBUGUI_BITFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AAC60)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_BitField_TypeDefinitionIndex = 18289;

	class DebugUI_BitField : public ::UnityEngine::Rendering::DebugUI_Field_1<::System::Enum*>
	{
	public:
		::Il2CppArray<::System::Int32>* _enumValues_k__BackingField; // 0x50
		::Il2CppArray<::UnityEngine::GUIContent*>* _enumNames_k__BackingField; // 0x58
		::System::Type* m_EnumType; // 0x60
