...
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_ADDGRAPHBONEMASK_OFFSET UNITYSDK_OFFSET(0x1EAC5750)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_ADDGRAPHCLIP_OFFSET UNITYSDK_OFFSET(0x1EAC5720)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_GETGRAPHCLIPCOUNT_OFFSET UNITYSDK_OFFSET(0x1EAC5740)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_RESETGRAPH_OFFSET UNITYSDK_OFFSET(0x1EAC5760)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_SETCLIPFADEIN_OFFSET UNITYSDK_OFFSET(0x1EAC5730)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BAGraphInstance_TypeDefinitionIndex = 4799;
