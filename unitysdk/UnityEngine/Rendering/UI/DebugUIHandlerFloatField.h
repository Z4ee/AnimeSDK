...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B1897D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x1B189860)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1B189660)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x1B189750)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1B189580)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x1B189440)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD_UPDATEVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1B1894C0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFLOATFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1898E0)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerFloatField_TypeDefinitionIndex = 33877;
