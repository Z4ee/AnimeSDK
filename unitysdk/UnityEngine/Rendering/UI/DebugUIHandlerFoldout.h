...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_NEXT_OFFSET UNITYSDK_OFFSET(0x1EC0D620)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_ONACTION_OFFSET UNITYSDK_OFFSET(0x1EC0D5E0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x1EC0D5A0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1EC0D480)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x1EC0D560)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1EC0D230)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x1EC0CBE0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1EC0D1F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERFOLDOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC0D770)
