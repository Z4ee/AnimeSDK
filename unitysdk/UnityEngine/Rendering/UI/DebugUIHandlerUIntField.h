...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1EC11010)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x1EC110A0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1EC10DF0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x1EC10FA0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1EC10C40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x1EC10A50)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD_UPDATEVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1EC10B30)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERUINTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC11120)
