...
namespace UnityEngine::Rendering::UI
{
	...
	public:
		...
		::System::Boolean _IsDirectChild_b__0(::UnityEngine::Rendering::UI::DebugUIHandlerWidget* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*))((::PBYTE)hIl2Cpp + UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCONTAINER___C__DISPLAYCLASS3_0__ISDIRECTCHILD_B__0_OFFSET))(this, x);
		}
	};
}
