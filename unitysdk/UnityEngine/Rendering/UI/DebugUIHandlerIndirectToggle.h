...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_INIT_OFFSET UNITYSDK_OFFSET(0x1A329160)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_ONACTION_OFFSET UNITYSDK_OFFSET(0x1A330B30)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1A330A40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1A330960)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_UPDATEVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1A329560)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A330BC0)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerIndirectToggle_TypeDefinitionIndex = 33600;
