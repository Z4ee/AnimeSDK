...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ACTIVATEPANEL_OFFSET UNITYSDK_OFFSET(0x1C07F420)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ACTIVATESELECTION_OFFSET UNITYSDK_OFFSET(0x1C080060)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_CHANGESELECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x1C07FE80)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_CHANGESELECTION_OFFSET UNITYSDK_OFFSET(0x1C07FAA0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_GETWIDGETFROMPATH_OFFSET UNITYSDK_OFFSET(0x1C07F7E0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_HANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x1C07D690)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C07CFA0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_REBUILD_OFFSET UNITYSDK_OFFSET(0x1C07E080)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_RESETALLHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1C07D230)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_SELECTNEXTITEM_OFFSET UNITYSDK_OFFSET(0x1C07FD20)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_SELECTPREVIOUSITEM_OFFSET UNITYSDK_OFFSET(0x1C07FDD0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_TRAVERSE_OFFSET UNITYSDK_OFFSET(0x1C07EB90)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C07D140)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS__ACTIVATEPANEL_B__14_1_OFFSET UNITYSDK_OFFSET(0x1C080110)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C080100)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerCanvas_TypeDefinitionIndex = 34239;
