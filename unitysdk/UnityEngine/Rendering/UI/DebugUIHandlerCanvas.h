...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ACTIVATEPANEL_OFFSET UNITYSDK_OFFSET(0x1DE2B580)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ACTIVATESELECTION_OFFSET UNITYSDK_OFFSET(0x1DE2C1D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_CHANGESELECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x1DE2BFF0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_CHANGESELECTION_OFFSET UNITYSDK_OFFSET(0x1DE2BC00)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_GETWIDGETFROMPATH_OFFSET UNITYSDK_OFFSET(0x1DE2B940)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_HANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x1DE297C0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DE290D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_REBUILD_OFFSET UNITYSDK_OFFSET(0x1DE2A1E0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_RESETALLHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1DE29360)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_SELECTNEXTITEM_OFFSET UNITYSDK_OFFSET(0x1DE2BE90)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_SELECTPREVIOUSITEM_OFFSET UNITYSDK_OFFSET(0x1DE2BF40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_TRAVERSE_OFFSET UNITYSDK_OFFSET(0x1DE2ACF0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DE29270)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS__ACTIVATEPANEL_B__14_1_OFFSET UNITYSDK_OFFSET(0x1DE2C280)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE2C270)
