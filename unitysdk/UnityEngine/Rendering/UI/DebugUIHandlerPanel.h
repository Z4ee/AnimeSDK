...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL_GETFIRSTITEM_OFFSET UNITYSDK_OFFSET(0x1DE2BB00)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL_GETPANEL_OFFSET UNITYSDK_OFFSET(0x1DE31BD0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL_GETYPOSINSCROLL_OFFSET UNITYSDK_OFFSET(0x1DE31BE0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DE319D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL_SCROLLTO_OFFSET UNITYSDK_OFFSET(0x1DE29DE0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL_SETPANEL_OFFSET UNITYSDK_OFFSET(0x1DE2AC00)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE31DB0)
