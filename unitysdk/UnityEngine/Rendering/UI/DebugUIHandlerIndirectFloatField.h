...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x188F6B80)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_INIT_OFFSET UNITYSDK_OFFSET(0x188F3540)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x188F6C40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x188F6A80)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x188F6B70)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x188F69A0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_UPDATEVALUELABEL_OFFSET UNITYSDK_OFFSET(0x188F68C0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x188F6C50)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerIndirectFloatField_TypeDefinitionIndex = 27975;
