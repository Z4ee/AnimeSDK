...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_NEXT_OFFSET UNITYSDK_OFFSET(0x188FB590)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONACTION_OFFSET UNITYSDK_OFFSET(0x188FB560)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x188FB530)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x188FB480)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x188FB500)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x188FB1D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_SETUPSETTINGS_OFFSET UNITYSDK_OFFSET(0x188FB040)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_SETVALUE_OFFSET UNITYSDK_OFFSET(0x188FB110)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x188FACD0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x188FB6F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETUPSETTINGS_B__10_0_OFFSET UNITYSDK_OFFSET(0x188FBA50)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETUPSETTINGS_B__10_1_OFFSET UNITYSDK_OFFSET(0x188FBA70)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETUPSETTINGS_B__10_2_OFFSET UNITYSDK_OFFSET(0x188FBA90)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_0_OFFSET UNITYSDK_OFFSET(0x188FB710)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_1_OFFSET UNITYSDK_OFFSET(0x188FB750)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_2_OFFSET UNITYSDK_OFFSET(0x188FB7E0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_3_OFFSET UNITYSDK_OFFSET(0x188FB820)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_4_OFFSET UNITYSDK_OFFSET(0x188FB8B0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_5_OFFSET UNITYSDK_OFFSET(0x188FB8F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_6_OFFSET UNITYSDK_OFFSET(0x188FB980)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_7_OFFSET UNITYSDK_OFFSET(0x188FB9C0)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerVector4_TypeDefinitionIndex = 27989;
