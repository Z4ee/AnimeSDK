...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPERSISTENTCANVAS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C0860F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPERSISTENTCANVAS_TOGGLE_OFFSET UNITYSDK_OFFSET(0x1C085C20)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERPERSISTENTCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C086270)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerPersistentCanvas_TypeDefinitionIndex = 34256;
