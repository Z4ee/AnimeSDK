...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP_NEXT_OFFSET UNITYSDK_OFFSET(0x188F6340)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x188F6120)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x188F5FF0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x188F6480)

namespace UnityEngine::Rendering::UI
{
	inline static constexpr unsigned int DebugUIHandlerGroup_TypeDefinitionIndex = 27973;
