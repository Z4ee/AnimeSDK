...
#define UNITYENGINE_RENDERING_LENSFLAREDATASRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB104C0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int LensFlareDataSRP_TypeDefinitionIndex = 27538;
