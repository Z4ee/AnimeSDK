...
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETDATARAW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ED529C0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETDATARAW_OFFSET UNITYSDK_OFFSET(0x3BBD530)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ED52980)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x3BBD500)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERDATASIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ED52990)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERDATASIZE_OFFSET UNITYSDK_OFFSET(0x3BBD510)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_DONE_OFFSET UNITYSDK_OFFSET(0x3BBD4E0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_HASERROR_OFFSET UNITYSDK_OFFSET(0x3BBD4F0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x3BBD500)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_LAYERDATASIZE_OFFSET UNITYSDK_OFFSET(0x3BBD510)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_HASERROR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ED52970)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_HASERROR_OFFSET UNITYSDK_OFFSET(0x3BBD4F0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_ISDONE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ED52960)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_ISDONE_OFFSET UNITYSDK_OFFSET(0x3BBD4E0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_SETSCRIPTINGCALLBACK_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ED529A0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_SETSCRIPTINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x3BBD520)
