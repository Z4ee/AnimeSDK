...
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASDEBUGFLAG_OFFSET UNITYSDK_OFFSET(0x1D141630)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_1_OFFSET UNITYSDK_OFFSET(0x1D141610)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_2_OFFSET UNITYSDK_OFFSET(0x1D141620)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_3_OFFSET UNITYSDK_OFFSET(0x1D141670)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_4_OFFSET UNITYSDK_OFFSET(0x1D1416A0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_5_OFFSET UNITYSDK_OFFSET(0x1D1416D0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_6_OFFSET UNITYSDK_OFFSET(0x1D141710)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_7_OFFSET UNITYSDK_OFFSET(0x1D141750)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_HASFLAG_OFFSET UNITYSDK_OFFSET(0x1D1415B0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_1_OFFSET UNITYSDK_OFFSET(0x1D1415C0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_2_OFFSET UNITYSDK_OFFSET(0x1D1415E0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_3_OFFSET UNITYSDK_OFFSET(0x1D141640)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_4_OFFSET UNITYSDK_OFFSET(0x1D141680)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_5_OFFSET UNITYSDK_OFFSET(0x1D1416B0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_6_OFFSET UNITYSDK_OFFSET(0x1D1416E0)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_7_OFFSET UNITYSDK_OFFSET(0x1D141720)
#define UNITYENGINE_RENDERING_CRPFLAGHELPER_SETFLAG_OFFSET UNITYSDK_OFFSET(0x1D141590)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CRPFlagHelper_TypeDefinitionIndex = 35980;
