...
#define UNITYENGINE_RENDERING_RASTERSTATE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A73050)
#define UNITYENGINE_RENDERING_RASTERSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A72FF0)
#define UNITYENGINE_RENDERING_RASTERSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A73100)
#define UNITYENGINE_RENDERING_RASTERSTATE_GET_CONSERVATIVE_OFFSET UNITYSDK_OFFSET(0x3A72FE0)
#define UNITYENGINE_RENDERING_RASTERSTATE_GET_CULLINGMODE_OFFSET UNITYSDK_OFFSET(0x167710)
#define UNITYENGINE_RENDERING_RASTERSTATE_GET_DEPTHCLIP_OFFSET UNITYSDK_OFFSET(0x3A72FD0)
#define UNITYENGINE_RENDERING_RASTERSTATE_GET_OFFSETFACTOR_OFFSET UNITYSDK_OFFSET(0xA4BEB0)
#define UNITYENGINE_RENDERING_RASTERSTATE_GET_OFFSETUNITS_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define UNITYENGINE_RENDERING_RASTERSTATE_SET_CONSERVATIVE_OFFSET UNITYSDK_OFFSET(0x394C140)
#define UNITYENGINE_RENDERING_RASTERSTATE_SET_CULLINGMODE_OFFSET UNITYSDK_OFFSET(0x167520)
#define UNITYENGINE_RENDERING_RASTERSTATE_SET_DEPTHCLIP_OFFSET UNITYSDK_OFFSET(0x394C120)
#define UNITYENGINE_RENDERING_RASTERSTATE_SET_OFFSETFACTOR_OFFSET UNITYSDK_OFFSET(0x38DAF30)
#define UNITYENGINE_RENDERING_RASTERSTATE_SET_OFFSETUNITS_OFFSET UNITYSDK_OFFSET(0xA4B350)
#define UNITYENGINE_RENDERING_RASTERSTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFA8A50)
#define UNITYENGINE_RENDERING_RASTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x3A72FA0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RasterState_TypeDefinitionIndex = 4745;

	struct alignas(4) RasterState
	{
		static ::UnityEngine::Rendering::RasterState* StaticGet_defaultValue()
		{
			return (::UnityEngine::Rendering::RasterState*)Il2CppClass::FromTypeDefinitionIndex(RasterState_TypeDefinitionIndex)->GetStaticField(0x9AF0);
		}
