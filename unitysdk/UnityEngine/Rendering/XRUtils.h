...
#define UNITYENGINE_RENDERING_XRUTILS_DRAWOCCLUSIONMESH_OFFSET UNITYSDK_OFFSET(0x1C093A80)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int XRUtils_TypeDefinitionIndex = 34177;
