...
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x94F210)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1B0C7F00)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x94F200)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1B0C7EF0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x94F280)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_OFFSET UNITYSDK_OFFSET(0x94F220)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F06A0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_1_OFFSET UNITYSDK_OFFSET(0x1B0C7F40)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1B0C7F20)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_1_OFFSET UNITYSDK_OFFSET(0x1B0C7F30)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B0C7F10)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_1_OFFSET UNITYSDK_OFFSET(0x94F1F0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B0C7EE0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHEDYNAMICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x94F190)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESHADOWEDLIGHTS_OFFSET UNITYSDK_OFFSET(0x94F1C0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESTATICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x94F160)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_VISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0x94F130)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CullingResults_TypeDefinitionIndex = 6211;
