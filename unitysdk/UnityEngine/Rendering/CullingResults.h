...
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x9F1940)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1D4FDDB0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x9F1930)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1D4FDDA0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9F19B0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_OFFSET UNITYSDK_OFFSET(0x9F1950)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2C1CA0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_1_OFFSET UNITYSDK_OFFSET(0x1D4FDDF0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1D4FDDD0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_1_OFFSET UNITYSDK_OFFSET(0x1D4FDDE0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_OFFSET UNITYSDK_OFFSET(0x1D4FDDC0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_1_OFFSET UNITYSDK_OFFSET(0x9F1920)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_OFFSET UNITYSDK_OFFSET(0x1D4FDD90)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHEDYNAMICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x9F18C0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESHADOWEDLIGHTS_OFFSET UNITYSDK_OFFSET(0x9F18F0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESTATICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x9F1890)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_VISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0x9F1860)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CullingResults_TypeDefinitionIndex = 6237;
