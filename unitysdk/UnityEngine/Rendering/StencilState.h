...
#define UNITYENGINE_RENDERING_STENCILSTATE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA64B60)
#define UNITYENGINE_RENDERING_STENCILSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA64AF0)
#define UNITYENGINE_RENDERING_STENCILSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA64B70)
#define UNITYENGINE_RENDERING_STENCILSTATE_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1EBEBDF0)
#define UNITYENGINE_RENDERING_STENCILSTATE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x36DBB0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SETCOMPAREFUNCTION_OFFSET UNITYSDK_OFFSET(0xA64A70)
#define UNITYENGINE_RENDERING_STENCILSTATE_SETFAILOPERATION_OFFSET UNITYSDK_OFFSET(0xA64A90)
#define UNITYENGINE_RENDERING_STENCILSTATE_SETPASSOPERATION_OFFSET UNITYSDK_OFFSET(0xA64A80)
#define UNITYENGINE_RENDERING_STENCILSTATE_SETZFAILOPERATION_OFFSET UNITYSDK_OFFSET(0xA64AA0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_COMPAREFUNCTIONBACK_OFFSET UNITYSDK_OFFSET(0x622AD0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_COMPAREFUNCTIONFRONT_OFFSET UNITYSDK_OFFSET(0x3D1C00)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x324490)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_FAILOPERATIONBACK_OFFSET UNITYSDK_OFFSET(0xA64AD0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_FAILOPERATIONFRONT_OFFSET UNITYSDK_OFFSET(0xA12A60)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_PASSOPERATIONBACK_OFFSET UNITYSDK_OFFSET(0xA379E0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_PASSOPERATIONFRONT_OFFSET UNITYSDK_OFFSET(0xA64AB0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_ZFAILOPERATIONBACK_OFFSET UNITYSDK_OFFSET(0xA64AE0)
#define UNITYENGINE_RENDERING_STENCILSTATE_SET_ZFAILOPERATIONFRONT_OFFSET UNITYSDK_OFFSET(0xA64AC0)
#define UNITYENGINE_RENDERING_STENCILSTATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA64A00)
#define UNITYENGINE_RENDERING_STENCILSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA649B0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int StencilState_TypeDefinitionIndex = 6270;
