...
#define UNITYENGINE_RENDERING_BATCHANIMEVENTOBJCB_EXECUTEEVENTFUN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CDFF350)
#define UNITYENGINE_RENDERING_BATCHANIMEVENTOBJCB_EXECUTEEVENTFUN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CDFF3D0)
#define UNITYENGINE_RENDERING_BATCHANIMEVENTOBJCB_EXECUTEEVENTFUN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CDFF340)
#define UNITYENGINE_RENDERING_BATCHANIMEVENTOBJCB_EXECUTEEVENTFUN__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDFF2C0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BatchAnimEventObjCB_ExecuteEventFun_TypeDefinitionIndex = 4775;
