...
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PAUSE_OFFSET UNITYSDK_OFFSET(0x1CDFEF20)
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PLAYALL_OFFSET UNITYSDK_OFFSET(0x1CDFEF10)
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PLAY_OFFSET UNITYSDK_OFFSET(0x1CDFEF00)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BABlendNodeParamaters_TypeDefinitionIndex = 4781;
