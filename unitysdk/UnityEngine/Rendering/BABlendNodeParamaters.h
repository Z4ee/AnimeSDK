...
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PAUSE_OFFSET UNITYSDK_OFFSET(0x18A3AC40)
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PLAYALL_OFFSET UNITYSDK_OFFSET(0x18A3AC30)
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PLAY_OFFSET UNITYSDK_OFFSET(0x18A3AC20)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BABlendNodeParamaters_TypeDefinitionIndex = 4600;
