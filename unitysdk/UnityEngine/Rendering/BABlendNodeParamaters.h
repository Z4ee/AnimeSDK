...
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PAUSE_OFFSET UNITYSDK_OFFSET(0x1EAC5610)
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PLAYALL_OFFSET UNITYSDK_OFFSET(0x1EAC5600)
#define UNITYENGINE_RENDERING_BABLENDNODEPARAMATERS_PLAY_OFFSET UNITYSDK_OFFSET(0x1EAC55F0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BABlendNodeParamaters_TypeDefinitionIndex = 4791;
