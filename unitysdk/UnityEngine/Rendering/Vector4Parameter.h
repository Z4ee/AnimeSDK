...
#define UNITYENGINE_RENDERING_VECTOR4PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1A335C90)
#define UNITYENGINE_RENDERING_VECTOR4PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A335C50)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Vector4Parameter_TypeDefinitionIndex = 33560;
