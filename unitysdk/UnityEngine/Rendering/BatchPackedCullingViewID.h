...
#define UNITYENGINE_RENDERING_BATCHPACKEDCULLINGVIEWID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA35B80)
#define UNITYENGINE_RENDERING_BATCHPACKEDCULLINGVIEWID_EQUALS_OFFSET UNITYSDK_OFFSET(0x3CB9B0)
#define UNITYENGINE_RENDERING_BATCHPACKEDCULLINGVIEWID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x909910)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BatchPackedCullingViewID_TypeDefinitionIndex = 6217;
