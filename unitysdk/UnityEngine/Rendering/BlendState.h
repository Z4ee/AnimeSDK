...
#define UNITYENGINE_RENDERING_BLENDSTATE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x988E40)
#define UNITYENGINE_RENDERING_BLENDSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0x988DF0)
#define UNITYENGINE_RENDERING_BLENDSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x988ED0)
#define UNITYENGINE_RENDERING_BLENDSTATE_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1B7470E0)
#define UNITYENGINE_RENDERING_BLENDSTATE_SET_BLENDSTATE0_OFFSET UNITYSDK_OFFSET(0x2E5940)
#define UNITYENGINE_RENDERING_BLENDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x988DC0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BlendState_TypeDefinitionIndex = 6200;
