...
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CD1F7F0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CD1F800)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD1F820)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpClampedFloatParameter_TypeDefinitionIndex = 34971;
