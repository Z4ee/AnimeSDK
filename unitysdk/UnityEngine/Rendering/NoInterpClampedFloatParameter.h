...
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A321CA0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A321CB0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A321CD0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpClampedFloatParameter_TypeDefinitionIndex = 33551;
