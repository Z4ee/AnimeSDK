...
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F3CE0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F3CF0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F3D10)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpClampedFloatParameter_TypeDefinitionIndex = 34204;
