...
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_BEGINPROFILE_1_OFFSET UNITYSDK_OFFSET(0x1B0F5B30)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_BEGINPROFILE_OFFSET UNITYSDK_OFFSET(0x1B0F5B20)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x667A60)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_ENDPROFILE_OFFSET UNITYSDK_OFFSET(0x1B0F5B40)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x667A60)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x667A60)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ProfilingScope_TypeDefinitionIndex = 34119;
