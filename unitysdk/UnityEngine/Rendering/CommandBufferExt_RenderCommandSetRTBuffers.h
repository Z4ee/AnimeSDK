...
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RENDERCOMMANDSETRTBUFFERS_INIT_OFFSET UNITYSDK_OFFSET(0x3A1DB50)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RENDERCOMMANDSETRTBUFFERS_RESET_OFFSET UNITYSDK_OFFSET(0x3A1DBE0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RENDERCOMMANDSETRTBUFFERS_SERIALIZESTORELOAD_OFFSET UNITYSDK_OFFSET(0x3A1DC00)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RENDERCOMMANDSETRTBUFFERS_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x3A1DBF0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RENDERCOMMANDSETRTBUFFERS_SET_OFFSET UNITYSDK_OFFSET(0x667A60)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CommandBufferExt_RenderCommandSetRTBuffers_TypeDefinitionIndex = 34125;
