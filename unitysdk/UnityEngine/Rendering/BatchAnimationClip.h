...
#define UNITYENGINE_RENDERING_BATCHANIMATIONCLIP_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1CDFF580)
#define UNITYENGINE_RENDERING_BATCHANIMATIONCLIP_SETANIMCACHE_OFFSET UNITYSDK_OFFSET(0x1CDFF590)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BatchAnimationClip_TypeDefinitionIndex = 4776;
