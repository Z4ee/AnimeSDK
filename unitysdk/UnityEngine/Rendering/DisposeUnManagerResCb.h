...
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F05E0)
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F0610)
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F05D0)
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F0560)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DisposeUnManagerResCb_TypeDefinitionIndex = 34127;
