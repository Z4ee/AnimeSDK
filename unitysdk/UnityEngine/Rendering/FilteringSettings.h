...
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA5D3D0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA5D390)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA5D450)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x330F60)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_EXCLUDEMOTIONVECTOROBJECTS_OFFSET UNITYSDK_OFFSET(0xA5D380)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x3C9D90)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_NAPDRAWSET_OFFSET UNITYSDK_OFFSET(0x7C7B60)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x599190)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_RENDERQUEUERANGE_OFFSET UNITYSDK_OFFSET(0x324D50)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xA5D2D0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int FilteringSettings_TypeDefinitionIndex = 6247;
