...
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA0E480)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA0E440)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA0E500)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_EXCLUDEMOTIONVECTOROBJECTS_OFFSET UNITYSDK_OFFSET(0xA0E430)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_NAPDRAWSET_OFFSET UNITYSDK_OFFSET(0x48E360)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x52CD90)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_RENDERQUEUERANGE_OFFSET UNITYSDK_OFFSET(0x2B6D10)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xA0E380)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int FilteringSettings_TypeDefinitionIndex = 6243;
