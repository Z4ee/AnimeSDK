...
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAASPECTRATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B7D0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAASPECTRATIO_OFFSET UNITYSDK_OFFSET(0xA5CB80)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B790)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFAR_OFFSET UNITYSDK_OFFSET(0xA5CB60)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFOV_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B7B0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFOV_OFFSET UNITYSDK_OFFSET(0xA5CB70)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFWD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B750)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFWD_OFFSET UNITYSDK_OFFSET(0xA5CB20)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAMOTIONINCLUDED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B830)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAMOTIONINCLUDED_OFFSET UNITYSDK_OFFSET(0xA5CBB0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERANEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B770)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERANEAR_OFFSET UNITYSDK_OFFSET(0xA5CB50)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B6F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAPOS_OFFSET UNITYSDK_OFFSET(0xA5CA90)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERARIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B730)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERARIGHT_OFFSET UNITYSDK_OFFSET(0xA5CAF0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B710)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAUP_OFFSET UNITYSDK_OFFSET(0xA5CAC0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAVIEWTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B610)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAVIEWTOCLIP_OFFSET UNITYSDK_OFFSET(0xA5C950)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOCAMERAVIEW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B630)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0xA5C990)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOPREVCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B650)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOPREVCLIP_OFFSET UNITYSDK_OFFSET(0xA5C9D0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DELTATIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B7F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DELTATIME_OFFSET UNITYSDK_OFFSET(0xA5CB90)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DEPTHINVERTED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B810)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DEPTHINVERTED_OFFSET UNITYSDK_OFFSET(0xA5CBA0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_JITTEROFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B6A0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_JITTEROFFSET_OFFSET UNITYSDK_OFFSET(0xA5CA50)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MOTIONVECTORSDILATED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B870)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MOTIONVECTORSDILATED_OFFSET UNITYSDK_OFFSET(0xA5CBD0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MVECSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B6D0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MVECSCALE_OFFSET UNITYSDK_OFFSET(0xA5CA70)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_PREVCLIPTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B670)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_PREVCLIPTOCLIP_OFFSET UNITYSDK_OFFSET(0xA5CA10)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_RESET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5B850)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_RESET_OFFSET UNITYSDK_OFFSET(0xA5CBC0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int FSRConstants_TypeDefinitionIndex = 6151;
