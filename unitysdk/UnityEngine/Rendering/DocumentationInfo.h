...
#define UNITYENGINE_RENDERING_DOCUMENTATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x191F6C40)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DocumentationInfo_TypeDefinitionIndex = 9574;
