...
#define UNITYENGINE_RENDERING_LOOKDEV_STAGERUNTIMEINTERFACE_ADDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x188E7C10)
#define UNITYENGINE_RENDERING_LOOKDEV_STAGERUNTIMEINTERFACE_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x188E7C30)
#define UNITYENGINE_RENDERING_LOOKDEV_STAGERUNTIMEINTERFACE_GET_SUNLIGHT_OFFSET UNITYSDK_OFFSET(0x188E7C50)
#define UNITYENGINE_RENDERING_LOOKDEV_STAGERUNTIMEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x188E7C00)

namespace UnityEngine::Rendering::LookDev
{
	inline static constexpr unsigned int StageRuntimeInterface_TypeDefinitionIndex = 27958;

	class StageRuntimeInterface : public ::System::Object
	{
	public:
		::System::Func_1<::UnityEngine::Camera*>* m_GetCamera; // 0x10
		::System::Object* SRPData; // 0x18
		::System::Func_2<::System::Boolean, ::UnityEngine::GameObject*>* m_AddGameObject; // 0x20
		::System::Func_1<::UnityEngine::Light*>* m_GetSunLight; // 0x28
