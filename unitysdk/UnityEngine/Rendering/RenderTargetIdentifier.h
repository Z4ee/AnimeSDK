...
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA0DC60)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0xA0DC20)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA0DC00)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_GETNAMEID_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D7B76F0)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D7B38B0)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1D7B7370)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D7B2810)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D7B7730)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA0DBF0)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA0DB20)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA0DB50)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER__CTOR_3_OFFSET UNITYSDK_OFFSET(0xA0DB80)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER__CTOR_4_OFFSET UNITYSDK_OFFSET(0xA0DBB0)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER__CTOR_5_OFFSET UNITYSDK_OFFSET(0xA0DBC0)
#define UNITYENGINE_RENDERING_RENDERTARGETIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xA0DAF0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RenderTargetIdentifier_TypeDefinitionIndex = 6181;
