...
#define UNITYENGINE_RENDERING_DEBUGACTIONDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B16F030)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugActionDesc_TypeDefinitionIndex = 33711;
