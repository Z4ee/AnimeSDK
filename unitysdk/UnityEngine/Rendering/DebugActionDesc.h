...
#define UNITYENGINE_RENDERING_DEBUGACTIONDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A313C00)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugActionDesc_TypeDefinitionIndex = 33429;
