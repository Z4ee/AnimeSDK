...
#define UNITYENGINE_RENDERING_SCALEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C079510)
#define UNITYENGINE_RENDERING_SCALEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C079560)
#define UNITYENGINE_RENDERING_SCALEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0762B0)
#define UNITYENGINE_RENDERING_SCALEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0794A0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ScaleFunc_TypeDefinitionIndex = 34146;
