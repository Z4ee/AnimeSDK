...
#define UNITYENGINE_RENDERING_DOCUMENTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F0620)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Documentation_TypeDefinitionIndex = 34121;
