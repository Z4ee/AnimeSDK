...
#define UNITYENGINE_RENDERING_DOCUMENTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AEA50)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Documentation_TypeDefinitionIndex = 18305;
