...
#define UNITYENGINE_RENDERING_DOCUMENTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31E410)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Documentation_TypeDefinitionIndex = 33468;
