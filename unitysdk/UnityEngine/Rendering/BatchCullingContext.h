...
#define UNITYENGINE_RENDERING_BATCHCULLINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x3ACCD20)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BatchCullingContext_TypeDefinitionIndex = 4721;
