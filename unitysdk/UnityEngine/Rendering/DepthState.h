...
#define UNITYENGINE_RENDERING_DEPTHSTATE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x969220)
#define UNITYENGINE_RENDERING_DEPTHSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0x969200)
#define UNITYENGINE_RENDERING_DEPTHSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x969280)
#define UNITYENGINE_RENDERING_DEPTHSTATE_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1B3CCCD0)
#define UNITYENGINE_RENDERING_DEPTHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x3E0930)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DepthState_TypeDefinitionIndex = 6213;
