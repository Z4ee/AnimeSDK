...
#define UNITYENGINE_RENDERING_DEBUGUI_UINTFIELD_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1EBF8EE0)
#define UNITYENGINE_RENDERING_DEBUGUI_UINTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBF8F30)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_UIntField_TypeDefinitionIndex = 34863;
