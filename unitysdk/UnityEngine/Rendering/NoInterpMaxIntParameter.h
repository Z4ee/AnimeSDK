...
#define UNITYENGINE_RENDERING_NOINTERPMAXINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F49F0)
#define UNITYENGINE_RENDERING_NOINTERPMAXINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F4A00)
#define UNITYENGINE_RENDERING_NOINTERPMAXINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F4A10)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpMaxIntParameter_TypeDefinitionIndex = 34194;
