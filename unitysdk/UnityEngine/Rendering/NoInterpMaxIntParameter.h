...
#define UNITYENGINE_RENDERING_NOINTERPMAXINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B17C960)
#define UNITYENGINE_RENDERING_NOINTERPMAXINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B17C970)
#define UNITYENGINE_RENDERING_NOINTERPMAXINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17C980)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpMaxIntParameter_TypeDefinitionIndex = 33823;
