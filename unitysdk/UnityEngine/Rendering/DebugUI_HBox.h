...
#define UNITYENGINE_RENDERING_DEBUGUI_HBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1785C0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_HBox_TypeDefinitionIndex = 33719;
