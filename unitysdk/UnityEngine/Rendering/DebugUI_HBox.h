...
#define UNITYENGINE_RENDERING_DEBUGUI_HBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x188E32B0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_HBox_TypeDefinitionIndex = 27813;
