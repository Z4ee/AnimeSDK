...
#define UNITYENGINE_RENDERING_DEBUGUI_VECTOR4FIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B178B10)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_Vector4Field_TypeDefinitionIndex = 33735;
