...
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ADDBATCH_OFFSET UNITYSDK_OFFSET(0x1D4FB2E0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ADDDRAWCOMMANDBATCH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB2D0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ADDDRAWCOMMANDBATCH_OFFSET UNITYSDK_OFFSET(0x1D4FB280)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_CLEARSTATICCULLINGDATA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D4FB3C0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_CLEARSTATICCULLINGDATA_OFFSET UNITYSDK_OFFSET(0x1D4FB410)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0x1D4FB240)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D4FB270)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D4FB250)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_INVOKEONPERFORMCULLING_OFFSET UNITYSDK_OFFSET(0x1D4FB470)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_REGISTERMATERIAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB350)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_REGISTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D4FB330)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_REGISTERMESH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB380)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_REGISTERMESH_OFFSET UNITYSDK_OFFSET(0x1D4FB360)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_SETGLOBALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB3A0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_SETGLOBALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1D4FB390)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_SETLODINSTANCEDATA_1_OFFSET UNITYSDK_OFFSET(0x1D4FB430)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_SETLODINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x1D4FB420)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_SETSTATICCULLINGDATA_1_OFFSET UNITYSDK_OFFSET(0x1D4FB3D0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_SETSTATICCULLINGDATA_OFFSET UNITYSDK_OFFSET(0x1D4FB3B0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FB210)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BatchRendererGroup_TypeDefinitionIndex = 6223;
