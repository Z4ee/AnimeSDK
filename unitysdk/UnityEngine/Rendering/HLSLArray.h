...
#define UNITYENGINE_RENDERING_HLSLARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBFBB70)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int HLSLArray_TypeDefinitionIndex = 34907;
