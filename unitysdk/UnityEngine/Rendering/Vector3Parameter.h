...
#define UNITYENGINE_RENDERING_VECTOR3PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1EC147C0)
#define UNITYENGINE_RENDERING_VECTOR3PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC14660)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Vector3Parameter_TypeDefinitionIndex = 34978;
