...
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDAMBIENTLIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4DD660)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDAMBIENTLIGHT_OFFSET UNITYSDK_OFFSET(0x96F460)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDDIRECTIONALLIGHTINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4DD6C0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDDIRECTIONALLIGHTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B4DD6B0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDDIRECTIONALLIGHT_OFFSET UNITYSDK_OFFSET(0x96F490)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96F5B0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_EQUALS_OFFSET UNITYSDK_OFFSET(0x96F500)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96F4F0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x96F4E0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B4DE030)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B4DDDD0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B4DDFC0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int SphericalHarmonicsL2_TypeDefinitionIndex = 6193;
