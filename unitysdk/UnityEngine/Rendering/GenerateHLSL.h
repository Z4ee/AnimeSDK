...
#define UNITYENGINE_RENDERING_GENERATEHLSL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA7A7C0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int GenerateHLSL_TypeDefinitionIndex = 18715;

	class GenerateHLSL : public ::System::Attribute
	{
	public:
		::System::Boolean needParamDebug; // 0x10
		::System::Int32 paramDefinesStart; // 0x14
		::UnityEngine::Rendering::PackingRules packingRules; // 0x18
		::System::Boolean containsPackedFields; // 0x1C
		::System::Boolean needAccessors; // 0x1D
		::System::Boolean omitStructDeclaration; // 0x1E
		::System::Boolean needSetters; // 0x1F
