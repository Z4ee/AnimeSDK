...
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0xA07ED0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0xA07E80)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA07F60)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0xA07EF0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA08020)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int AttachmentDescriptor_TypeDefinitionIndex = 6225;
