...
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x967AF0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x967AA0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x967B80)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x967B10)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x967C40)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int AttachmentDescriptor_TypeDefinitionIndex = 6199;
