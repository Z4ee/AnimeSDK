...
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_ALLOWENLIGHTENSUPPORTFORUPGRADEDPROJECT_OFFSET UNITYSDK_OFFSET(0x1B3CCE30)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_CURRENTRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B3CCE60)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_DEFAULTRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B3CCF60)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_INTERNAL_CURRENTRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B3CCE50)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_INTERNAL_DEFAULTRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B3CD000)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_LIGHTSUSELINEARINTENSITY_OFFSET UNITYSDK_OFFSET(0x1B3CCDE0)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_RENDERPIPELINEASSET_OFFSET UNITYSDK_OFFSET(0x1B3CCEE0)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_GET_USESCRIPTABLERENDERPIPELINEBATCHING_OFFSET UNITYSDK_OFFSET(0x1B3CCE10)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_HASSHADERDEFINE_OFFSET UNITYSDK_OFFSET(0x1B3CCE40)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_SET_DEFAULTRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B3CCFF0)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_SET_INTERNAL_DEFAULTRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B3CD010)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_SET_LIGHTSUSECOLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1B3CCE00)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_SET_LIGHTSUSELINEARINTENSITY_OFFSET UNITYSDK_OFFSET(0x1B3CCDF0)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_SET_RENDERPIPELINEASSET_OFFSET UNITYSDK_OFFSET(0x1B3CCFE0)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS_SET_USESCRIPTABLERENDERPIPELINEBATCHING_OFFSET UNITYSDK_OFFSET(0x1B3CCE20)
#define UNITYENGINE_RENDERING_GRAPHICSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3CCD90)
