...
#define UNITYENGINE_RENDERING_HALTONSEQUENCE_GET_OFFSET UNITYSDK_OFFSET(0x1B0F3400)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int HaltonSequence_TypeDefinitionIndex = 34168;
