...
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_ADDUSINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1AECC890)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1AECCF70)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_CLEARNOTUSING_OFFSET UNITYSDK_OFFSET(0x1AECCAA0)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_GET_OFFSET UNITYSDK_OFFSET(0x1AECC4F0)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_REDUCEUSINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1AECC9D0)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AECC940)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AECD210)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECC310)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int MaterialCacheBase_TypeDefinitionIndex = 27118;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ObjectPool_1<::UnityEngine::Rendering::MaterialCacheBase_CacheEntry*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialCacheBase_TypeDefinitionIndex)->GetStaticField(0x22410);
		}
