...
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9867E0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0x986710)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9867F0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_DRAWLAYERMASK_OFFSET UNITYSDK_OFFSET(0x9866A0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_SPLITDATA_OFFSET UNITYSDK_OFFSET(0x986690)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9866B0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowDrawingSettings_TypeDefinitionIndex = 6232;
