...
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA298F0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA29820)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA29900)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_DRAWLAYERMASK_OFFSET UNITYSDK_OFFSET(0xA297B0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_SPLITDATA_OFFSET UNITYSDK_OFFSET(0xA297A0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xA297C0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowDrawingSettings_TypeDefinitionIndex = 6258;
