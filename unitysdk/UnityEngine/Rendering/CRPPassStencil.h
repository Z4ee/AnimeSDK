...
#define UNITYENGINE_RENDERING_CRPPASSSTENCIL_SETPASSSTENCIL_OFFSET UNITYSDK_OFFSET(0x1ED53DB0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CRPPassStencil_TypeDefinitionIndex = 4863;
