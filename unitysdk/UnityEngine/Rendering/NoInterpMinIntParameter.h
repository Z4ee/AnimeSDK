...
#define UNITYENGINE_RENDERING_NOINTERPMININTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBFE270)
#define UNITYENGINE_RENDERING_NOINTERPMININTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBFE280)
#define UNITYENGINE_RENDERING_NOINTERPMININTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBFE290)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpMinIntParameter_TypeDefinitionIndex = 34959;
