...
#define UNITYENGINE_RENDERING_NOINTERPMININTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CD207F0)
#define UNITYENGINE_RENDERING_NOINTERPMININTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CD20800)
#define UNITYENGINE_RENDERING_NOINTERPMININTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD20810)
