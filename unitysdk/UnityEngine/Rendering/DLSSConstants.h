...
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAASPECTRATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6F80)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAASPECTRATIO_OFFSET UNITYSDK_OFFSET(0xA0D800)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6F40)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFAR_OFFSET UNITYSDK_OFFSET(0xA0D7E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFOV_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6F60)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFOV_OFFSET UNITYSDK_OFFSET(0xA0D7F0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFWD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6F00)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFWD_OFFSET UNITYSDK_OFFSET(0xA0D7A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAMOTIONINCLUDED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6FC0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAMOTIONINCLUDED_OFFSET UNITYSDK_OFFSET(0xA0D820)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERANEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6F20)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERANEAR_OFFSET UNITYSDK_OFFSET(0xA0D7D0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6EA0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAPOS_OFFSET UNITYSDK_OFFSET(0xA0D710)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERARIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6EE0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERARIGHT_OFFSET UNITYSDK_OFFSET(0xA0D770)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6EC0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAUP_OFFSET UNITYSDK_OFFSET(0xA0D740)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAVIEWTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6DC0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAVIEWTOCLIP_OFFSET UNITYSDK_OFFSET(0xA0D5D0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOCAMERAVIEW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6DE0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0xA0D610)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOPREVCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6E00)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOPREVCLIP_OFFSET UNITYSDK_OFFSET(0xA0D650)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_DEPTHINVERTED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6FA0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_DEPTHINVERTED_OFFSET UNITYSDK_OFFSET(0xA0D810)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_JITTEROFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6E50)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_JITTEROFFSET_OFFSET UNITYSDK_OFFSET(0xA0D6D0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MINRELATIVELINEARDEPTHOBJECTSEPARATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B7020)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MINRELATIVELINEARDEPTHOBJECTSEPARATION_OFFSET UNITYSDK_OFFSET(0xA0D850)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MOTIONVECTORSDILATED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B7000)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MOTIONVECTORSDILATED_OFFSET UNITYSDK_OFFSET(0xA0D840)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MVECSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6E80)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MVECSCALE_OFFSET UNITYSDK_OFFSET(0xA0D6F0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_PREVCLIPTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6E20)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_PREVCLIPTOCLIP_OFFSET UNITYSDK_OFFSET(0xA0D690)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_RESET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7B6FE0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_RESET_OFFSET UNITYSDK_OFFSET(0xA0D830)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DLSSConstants_TypeDefinitionIndex = 6142;
