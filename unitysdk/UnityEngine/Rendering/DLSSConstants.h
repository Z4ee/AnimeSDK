...
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAASPECTRATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499640)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x96DEA0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499600)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFAR_OFFSET UNITYSDK_OFFSET(0x96DE80)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFOV_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499620)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFOV_OFFSET UNITYSDK_OFFSET(0x96DE90)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFWD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4995C0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFWD_OFFSET UNITYSDK_OFFSET(0x96DE40)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAMOTIONINCLUDED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499680)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAMOTIONINCLUDED_OFFSET UNITYSDK_OFFSET(0x96DEC0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERANEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4995E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERANEAR_OFFSET UNITYSDK_OFFSET(0x96DE70)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499560)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAPOS_OFFSET UNITYSDK_OFFSET(0x96DDB0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERARIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4995A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERARIGHT_OFFSET UNITYSDK_OFFSET(0x96DE10)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499580)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAUP_OFFSET UNITYSDK_OFFSET(0x96DDE0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAVIEWTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499480)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAVIEWTOCLIP_OFFSET UNITYSDK_OFFSET(0x96DC70)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOCAMERAVIEW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4994A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x96DCB0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOPREVCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4994C0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOPREVCLIP_OFFSET UNITYSDK_OFFSET(0x96DCF0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_DEPTHINVERTED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499660)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_DEPTHINVERTED_OFFSET UNITYSDK_OFFSET(0x96DEB0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_JITTEROFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499510)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_JITTEROFFSET_OFFSET UNITYSDK_OFFSET(0x96DD70)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MINRELATIVELINEARDEPTHOBJECTSEPARATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4996E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MINRELATIVELINEARDEPTHOBJECTSEPARATION_OFFSET UNITYSDK_OFFSET(0x96DEF0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MOTIONVECTORSDILATED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4996C0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MOTIONVECTORSDILATED_OFFSET UNITYSDK_OFFSET(0x96DEE0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MVECSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B499540)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MVECSCALE_OFFSET UNITYSDK_OFFSET(0x96DD90)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_PREVCLIPTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4994E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_PREVCLIPTOCLIP_OFFSET UNITYSDK_OFFSET(0x96DD30)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_RESET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4996A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_RESET_OFFSET UNITYSDK_OFFSET(0x96DED0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DLSSConstants_TypeDefinitionIndex = 6131;
