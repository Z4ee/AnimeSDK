...
#define UNITYENGINE_RENDERING_SPATIALHASHUTILS_CALCULATEOFFSETTEXTUREDATA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1BFABD20)
#define UNITYENGINE_RENDERING_SPATIALHASHUTILS_CALCULATEOFFSETTEXTUREDATA_OFFSET UNITYSDK_OFFSET(0x1BFABD10)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int SpatialHashUtils_TypeDefinitionIndex = 4803;
