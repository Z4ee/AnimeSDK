...
#define UNITYENGINE_RENDERING_SPATIALHASHUTILS_CALCULATEOFFSETTEXTUREDATA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B2D1910)
#define UNITYENGINE_RENDERING_SPATIALHASHUTILS_CALCULATEOFFSETTEXTUREDATA_OFFSET UNITYSDK_OFFSET(0x1B2D1900)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int SpatialHashUtils_TypeDefinitionIndex = 4798;
