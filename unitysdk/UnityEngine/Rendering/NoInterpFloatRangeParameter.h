...
#define UNITYENGINE_RENDERING_NOINTERPFLOATRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A321EE0)
#define UNITYENGINE_RENDERING_NOINTERPFLOATRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A321EF0)
#define UNITYENGINE_RENDERING_NOINTERPFLOATRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A321F20)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpFloatRangeParameter_TypeDefinitionIndex = 33553;
