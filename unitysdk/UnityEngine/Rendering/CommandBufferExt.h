...
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x1B0DD2A0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1B0DCE30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B0DAED0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_COPYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B0DCEA0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DISABLESHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x1B0DD280)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0DAAE0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x1B0DCF80)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DRAWRENDERERS_OFFSET UNITYSDK_OFFSET(0x1B0DD1F0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_ENABLESHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x1B0DD260)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x1B0DD2C0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0DAF60)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B0DAAC0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GETRAWBUFFER_OFFSET UNITYSDK_OFFSET(0x1B0DB010)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GETTEMPORARYRT_1_OFFSET UNITYSDK_OFFSET(0x1B0DBF80)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GETTEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x1B0DBB80)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_CMDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B0DD2F0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_ISSYSTEMCMDVALID_OFFSET UNITYSDK_OFFSET(0x1B0DAF30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B0DD300)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_USECUSTOMCMD_OFFSET UNITYSDK_OFFSET(0x1B0DD340)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_PREPAREDRAWRENDERERS_OFFSET UNITYSDK_OFFSET(0x1B0DD070)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B0DAEC0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x1B0DB2C0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x1B0DB030)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x1B0DB420)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1B0DB9D0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B0DB8E0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1B0DB880)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x1B0DB160)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1B0DC400)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1B0DC420)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_3_OFFSET UNITYSDK_OFFSET(0x1B0DC430)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_4_OFFSET UNITYSDK_OFFSET(0x1B0DC970)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1B0DC100)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SET_CMDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B0DD2E0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SET_USECUSTOMCMD_OFFSET UNITYSDK_OFFSET(0x1B0DD360)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__ADDSETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1B0DCBD0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DA870)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__DEPTHBUFFERFORMATFROMBITS_OFFSET UNITYSDK_OFFSET(0x1B0DBE40)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__GETTEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x1B0DBE80)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__GETTEXTYPE_OFFSET UNITYSDK_OFFSET(0x1B0DD3C0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__PUTRT_1_OFFSET UNITYSDK_OFFSET(0x1B0DD370)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__PUTRT_OFFSET UNITYSDK_OFFSET(0x1B0DBB30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__SETORCLEARFLAGS_OFFSET UNITYSDK_OFFSET(0x1B0DBE60)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1B0DC130)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CommandBufferExt_TypeDefinitionIndex = 34123;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::CommandBufferExt_RenderCommandSetRTBuffers*)Il2CppClass::FromTypeDefinitionIndex(CommandBufferExt_TypeDefinitionIndex)->GetStaticField(0x459A0);
		}
		static ::UnityEngine::Rendering::CommandBufferExt_RenderTextureDesc* StaticGet__TmpRTDesc()
		{
			return (::UnityEngine::Rendering::CommandBufferExt_RenderTextureDesc*)Il2CppClass::FromTypeDefinitionIndex(CommandBufferExt_TypeDefinitionIndex)->GetStaticField(0xC480);
		}
