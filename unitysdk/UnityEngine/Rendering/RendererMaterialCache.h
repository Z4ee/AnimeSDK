...
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEANCACHEREGULARLY_OFFSET UNITYSDK_OFFSET(0x1A692C30)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1A692E30)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x1A692CB0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERSHAREDMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x1A692D10)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_ENABLECACHE_OFFSET UNITYSDK_OFFSET(0x1A692900)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A692960)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASEMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x1A692D70)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASESHAREDMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x1A692DD0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A692EA0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A692A50)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RendererMaterialCache_TypeDefinitionIndex = 29789;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::RendererMaterialCache**)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x23B30);
		}
		static ::System::Boolean* StaticGet_enableCacheConfig()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x6540);
		}
