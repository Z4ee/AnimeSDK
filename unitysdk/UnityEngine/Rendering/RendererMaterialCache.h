...
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEANCACHEREGULARLY_OFFSET UNITYSDK_OFFSET(0x1B86C9C0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1B86CBC0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x1B86CA40)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERSHAREDMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x1B86CAA0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_ENABLECACHE_OFFSET UNITYSDK_OFFSET(0x1B86C690)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B86C6F0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASEMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x1B86CB00)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASESHAREDMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x1B86CB60)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B86CC30)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B86C7E0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RendererMaterialCache_TypeDefinitionIndex = 26189;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::RendererMaterialCache**)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x21320);
		}
		static ::System::Boolean* StaticGet_enableCacheConfig()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x6090);
		}
		// static const ::System::Int32 CACHE_MAX_SIZE = 0x400; // 0x0
		// static const ::System::Single CLEAN_CACHE_TIME; // 0x0
		::UnityEngine::Rendering::MaterialCache* m_materialCache; // 0x10
		::UnityEngine::Rendering::SharedMaterialCache* m_sharedMaterialCache; // 0x18
