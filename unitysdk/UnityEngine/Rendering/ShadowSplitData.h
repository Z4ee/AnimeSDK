...
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9EEA30)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x9EE9F0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GETCULLINGPLANE_OFFSET UNITYSDK_OFFSET(0x9EE9D0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9EEAB0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GET_CULLINGPLANECOUNT_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_SET_SHADOWCASCADEBLENDCULLINGFACTOR_OFFSET UNITYSDK_OFFSET(0x9EE9C0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D434DD0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowSplitData_TypeDefinitionIndex = 6259;

	struct alignas(4) ShadowSplitData
	{
		static ::System::Int32* StaticGet_maximumCullingPlaneCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ShadowSplitData_TypeDefinitionIndex)->GetStaticField(0x2BF0);
		}
