...
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA64750)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA64710)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETCULLINGPLANE_OFFSET UNITYSDK_OFFSET(0xA646F0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA647D0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETLAYERCULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0xA646E0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_CULLINGOPTIONS_OFFSET UNITYSDK_OFFSET(0xA646C0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_CULLINGPLANECOUNT_OFFSET UNITYSDK_OFFSET(0xA64680)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_MAXIMUMVISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0xA64660)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SETLOCALSHADOWCACHESETTING_OFFSET UNITYSDK_OFFSET(0xA645E0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SETSCREENRATIOCULLINGPARAMS_OFFSET UNITYSDK_OFFSET(0xA646A0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0xA64690)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_CULLINGOPTIONS_OFFSET UNITYSDK_OFFSET(0xA646D0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_MAXIMUMVISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0xA64670)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_SHADOWDISTANCE_OFFSET UNITYSDK_OFFSET(0xA646B0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBEB360)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ScriptableCullingParameters_TypeDefinitionIndex = 6237;

	struct alignas(8) ScriptableCullingParameters
	{
		static ::System::Int32* StaticGet_layerCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScriptableCullingParameters_TypeDefinitionIndex)->GetStaticField(0x2CD0);
		}
		static ::System::Int32* StaticGet_maximumCullingPlaneCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScriptableCullingParameters_TypeDefinitionIndex)->GetStaticField(0x2CD4);
		}
		...
		::System::Void SetScreenRatioCullingParams(::System::Int32 layerIndex, ::System::Single Ratio)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Single))((::PBYTE)hIl2Cpp + UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SETSCREENRATIOCULLINGPARAMS_OFFSET))(this, layerIndex, Ratio);
		}
