...
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA10C00)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA10BC0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETCULLINGPLANE_OFFSET UNITYSDK_OFFSET(0xA10BA0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA10C80)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETLAYERCULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0xA10B90)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_CULLINGOPTIONS_OFFSET UNITYSDK_OFFSET(0xA10B70)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_CULLINGPLANECOUNT_OFFSET UNITYSDK_OFFSET(0xA10B30)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_MAXIMUMVISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0xA10B10)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SETLOCALSHADOWCACHESETTING_OFFSET UNITYSDK_OFFSET(0xA10A90)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SETSCREENRATIOCULLINGPARAMS_OFFSET UNITYSDK_OFFSET(0xA10B50)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0xA10B40)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_CULLINGOPTIONS_OFFSET UNITYSDK_OFFSET(0xA10B80)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_MAXIMUMVISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0xA10B20)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_SHADOWDISTANCE_OFFSET UNITYSDK_OFFSET(0xA10B60)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D857040)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ScriptableCullingParameters_TypeDefinitionIndex = 6233;

	struct alignas(8) ScriptableCullingParameters
	{
		static ::System::Int32* StaticGet_layerCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScriptableCullingParameters_TypeDefinitionIndex)->GetStaticField(0x2CC0);
		}
		static ::System::Int32* StaticGet_maximumCullingPlaneCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScriptableCullingParameters_TypeDefinitionIndex)->GetStaticField(0x2CC4);
		}
