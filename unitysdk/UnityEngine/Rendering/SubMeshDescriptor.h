...
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_BASEVERTEX_OFFSET UNITYSDK_OFFSET(0x2EF9F0)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x2E44E0)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_FIRSTVERTEX_OFFSET UNITYSDK_OFFSET(0x2EF960)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_INDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x367EB0)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_INDEXSTART_OFFSET UNITYSDK_OFFSET(0x367F30)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0x319030)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x3ABCC0)
#define UNITYENGINE_RENDERING_SUBMESHDESCRIPTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x922A90)
