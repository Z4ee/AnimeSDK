...
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_ALLOCAUTOSIZEDRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A324C90)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x1A324990)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x1A325440)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_ALLOC_3_OFFSET UNITYSDK_OFFSET(0x1A3255B0)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_ALLOC_4_OFFSET UNITYSDK_OFFSET(0x1A3256C0)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_ALLOC_OFFSET UNITYSDK_OFFSET(0x1A324350)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_DEMANDRESIZE_OFFSET UNITYSDK_OFFSET(0x1A324120)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A323570)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A323560)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_DUMPRTINFO_OFFSET UNITYSDK_OFFSET(0x1A325770)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_GETMAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A324340)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_GETMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1A324330)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A3233B0)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A323850)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A323940)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A322ED0)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_RESIZE_OFFSET UNITYSDK_OFFSET(0x1A323BC0)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1A323F30)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_SETREFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1A323950)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM_SWITCHRESIZEMODE_OFFSET UNITYSDK_OFFSET(0x1A324000)
#define UNITYENGINE_RENDERING_RTHANDLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3233D0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RTHandleSystem_TypeDefinitionIndex = 33495;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Rendering::RTHandle*>* m_AutoSizedRTsArray; // 0x18
		...
		::UnityEngine::Rendering::MSAASamples m_ScaledRTCurrentMSAASamples; // 0x30
