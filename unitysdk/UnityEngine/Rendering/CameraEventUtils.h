...
#define UNITYENGINE_RENDERING_CAMERAEVENTUTILS_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B2C5730)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CameraEventUtils_TypeDefinitionIndex = 4683;
