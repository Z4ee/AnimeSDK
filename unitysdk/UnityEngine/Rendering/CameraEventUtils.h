...
#define UNITYENGINE_RENDERING_CAMERAEVENTUTILS_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BFA2610)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CameraEventUtils_TypeDefinitionIndex = 4688;
