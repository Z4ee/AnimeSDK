...
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x94F7D0)
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_EQUALS_OFFSET UNITYSDK_OFFSET(0x94F790)
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x94F850)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VisibleReflectionProbe_TypeDefinitionIndex = 6246;
