...
#define UNITYENGINE_RENDERING_PACKINGATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CA7ACF0)
#define UNITYENGINE_RENDERING_PACKINGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA7AC10)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int PackingAttribute_TypeDefinitionIndex = 18718;
	...
	public:
		...
		::System::Int32 offsetInSource; // 0x20
		::System::Int32 sizeInBits; // 0x24
		::System::Boolean isDirection; // 0x28
		::System::Boolean sRGBDisplay; // 0x29
		::UnityEngine::Rendering::FieldPacking packingScheme; // 0x2C
