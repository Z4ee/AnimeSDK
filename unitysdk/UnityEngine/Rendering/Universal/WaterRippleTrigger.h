...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_GETCUSTOMRIPPLEDATA_OFFSET UNITYSDK_OFFSET(0xF804310)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xF804290)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF8041A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xF804580)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterRippleTrigger_TypeDefinitionIndex = 29943;
