...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_GETCUSTOMRIPPLEDATA_OFFSET UNITYSDK_OFFSET(0x1E59EE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E59EDC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E59ECD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E59F0B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterRippleTrigger_TypeDefinitionIndex = 26492;
