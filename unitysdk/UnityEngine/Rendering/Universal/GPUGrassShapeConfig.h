...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_CLEARINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D3D40B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GETCURRENTMESH_OFFSET UNITYSDK_OFFSET(0x1D3D43B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALFORLOD1_OFFSET UNITYSDK_OFFSET(0x1D3D3D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALFORLOD2_OFFSET UNITYSDK_OFFSET(0x1D3D3F20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALWITHDITHERON_OFFSET UNITYSDK_OFFSET(0x1D3D3BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_INITLOD_OFFSET UNITYSDK_OFFSET(0x1D3D4150)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3D4420)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassShapeConfig_TypeDefinitionIndex = 26513;
