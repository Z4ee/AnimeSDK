...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_CLEARINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E790E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GETCURRENTMESH_OFFSET UNITYSDK_OFFSET(0x1E791150)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALFORLOD1_OFFSET UNITYSDK_OFFSET(0x1E790B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALFORLOD2_OFFSET UNITYSDK_OFFSET(0x1E790CB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALWITHDITHERON_OFFSET UNITYSDK_OFFSET(0x1E790950)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_INITLOD_OFFSET UNITYSDK_OFFSET(0x1E790EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7911C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassShapeConfig_TypeDefinitionIndex = 26905;
