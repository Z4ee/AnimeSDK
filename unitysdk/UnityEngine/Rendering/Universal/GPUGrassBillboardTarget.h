...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_AREMATERIALARRAYSEQUAL_OFFSET UNITYSDK_OFFSET(0x1D6E0810)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_BUILDBILLBOARDBINDINGKEY_OFFSET UNITYSDK_OFFSET(0x1D6E12F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_BUILDLEGACYBILLBOARDBINDINGKEY_OFFSET UNITYSDK_OFFSET(0x1D6E10F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_BUILDTRANSFORMPATHSEGMENT_OFFSET UNITYSDK_OFFSET(0x1D6E1800)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_BUILDTRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1D6E1570)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_BUILDTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1D6E1520)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_CACHEORIGINALSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1D6E0740)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_ENSUREDEFAULTBILLBOARDMESH_OFFSET UNITYSDK_OFFSET(0x1D6E0E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_GETBILLBOARDBINDINGKEY_OFFSET UNITYSDK_OFFSET(0x1D6E0F50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_GETLEGACYBINDINGKEYFORPROXY_OFFSET UNITYSDK_OFFSET(0x1D6E10A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_GETRUNTIMEBINDINGKEYFORPROXY_OFFSET UNITYSDK_OFFSET(0x1D6E1020)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_GET_LODGROUPCREATEDBYMERGEDMESHBAKER_OFFSET UNITYSDK_OFFSET(0x1D6E0390)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_GET_ORIGINALSHAREDMATERIALSCACHESTATUS_OFFSET UNITYSDK_OFFSET(0x1D6E03F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D6E0FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D6E0E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_RESET_OFFSET UNITYSDK_OFFSET(0x1D6E0B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_RESTORESAVEDORIGINALSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1D6E08F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_SETLODGROUPCREATEDBYMERGEDMESHBAKER_OFFSET UNITYSDK_OFFSET(0x1D6E03A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET_TRYGETSAVEDORIGINALSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1D6E0680)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E1A90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassBillboardTarget_TypeDefinitionIndex = 27888;
