...
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E24C7F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1E24C790)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E24C800)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E24C610)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E24C570)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FXColorCorrection_GradientParameter_TypeDefinitionIndex = 27320;
