...
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AB90780)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1AB90720)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AB90790)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB905A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB90500)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FXColorCorrection_GradientParameter_TypeDefinitionIndex = 29868;
