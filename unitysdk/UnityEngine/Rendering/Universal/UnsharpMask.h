...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNSHARPMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF12A90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UnsharpMask_TypeDefinitionIndex = 27208;
