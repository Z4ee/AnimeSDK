...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E79ED30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1E79ECB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E79ED40)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79ED50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_Texture2DParameter_TypeDefinitionIndex = 27625;
