...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B089850)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B0897D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B089860)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B089870)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_Texture2DParameter_TypeDefinitionIndex = 30041;
