...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_BILATERALUPSAMPLE_OFFSET UNITYSDK_OFFSET(0x1AF6A470)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_BLURSHARPNESS_OFFSET UNITYSDK_OFFSET(0x1AF6A3D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DEBUGMODE_OFFSET UNITYSDK_OFFSET(0x1AF6A4D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DENOISERRADIUS_OFFSET UNITYSDK_OFFSET(0x1AF6A430)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DENOISE_OFFSET UNITYSDK_OFFSET(0x1AF6A410)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DIRECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF6A4B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DIRECTLIGHTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1AF6A330)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_FULLRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1AF6A370)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_GHOSTINGREDUCTION_OFFSET UNITYSDK_OFFSET(0x1AF6A3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_INTENSITY_OFFSET UNITYSDK_OFFSET(0x1AF6A310)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_MAXIMUMRADIUSINPIXELS_OFFSET UNITYSDK_OFFSET(0x1AF6A490)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1AF6A350)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_SAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1AF6A3F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_STEPCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF6A450)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_TEMPORALACCUMULATION_OFFSET UNITYSDK_OFFSET(0x1AF6A390)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1AF6A4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6A560)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenSpaceAmbientOcclusion_TypeDefinitionIndex = 26389;
