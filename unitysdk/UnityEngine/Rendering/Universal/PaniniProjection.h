...
#define UNITYENGINE_RENDERING_UNIVERSAL_PANINIPROJECTION_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B36E470)
#define UNITYENGINE_RENDERING_UNIVERSAL_PANINIPROJECTION_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B36E4D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_PANINIPROJECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B36E510)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PaniniProjection_TypeDefinitionIndex = 30150;
