...
#define UNITYENGINE_RENDERING_UNIVERSAL_TONEMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E265910)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int Tonemapping_TypeDefinitionIndex = 27874;
