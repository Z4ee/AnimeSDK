...
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0xF7FAFF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3DFLOAT_OFFSET UNITYSDK_OFFSET(0xF7FB640)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3D_OFFSET UNITYSDK_OFFSET(0xF7FB250)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0xF7FBBA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0xF7FBA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_GET_CLEARCS_OFFSET UNITYSDK_OFFSET(0xF7FAFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_SET_CLEARCS_OFFSET UNITYSDK_OFFSET(0xF7FAFE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LyraUtils_TypeDefinitionIndex = 30037;
	...
	public:
		...
		{
			return (::UnityEngine::ComputeShader**)Il2CppClass::FromTypeDefinitionIndex(LyraUtils_TypeDefinitionIndex)->GetStaticField(0x24B20);
		}
