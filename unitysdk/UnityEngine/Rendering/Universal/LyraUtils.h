...
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x110A4210)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3DFLOAT_OFFSET UNITYSDK_OFFSET(0x110A4870)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3D_OFFSET UNITYSDK_OFFSET(0x110A4470)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x110A4DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x110A4CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_GET_CLEARCS_OFFSET UNITYSDK_OFFSET(0x110A41F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_SET_CLEARCS_OFFSET UNITYSDK_OFFSET(0x110A4200)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LyraUtils_TypeDefinitionIndex = 27857;
	...
	public:
		...
		{
			return (::UnityEngine::ComputeShader**)Il2CppClass::FromTypeDefinitionIndex(LyraUtils_TypeDefinitionIndex)->GetStaticField(0x23B30);
		}
