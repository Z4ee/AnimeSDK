...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_ACCUMULATEBOUNDARYINSETDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AEEAFF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_ADDEDGEUSECOUNT_OFFSET UNITYSDK_OFFSET(0x1AEEAEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_APPLYSCATTEROFFSETS_OFFSET UNITYSDK_OFFSET(0x1AEEB380)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_BUILDCOMBINEDMESHFROMINSTANCES_OFFSET UNITYSDK_OFFSET(0x1AEE8DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_CALCULATEMESHSURFACEAREA_OFFSET UNITYSDK_OFFSET(0x1AEEB590)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_COMPUTESTABLETARGETBAKESEED_OFFSET UNITYSDK_OFFSET(0x1AEE9160)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_GETSTABLESTRINGHASH_OFFSET UNITYSDK_OFFSET(0x1AEE9470)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_GETUNDIRECTEDEDGEKEY_OFFSET UNITYSDK_OFFSET(0x1AEEB920)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_HALTON_OFFSET UNITYSDK_OFFSET(0x1AEEB2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_ISBOUNDARYEDGE_OFFSET UNITYSDK_OFFSET(0x1AEEB980)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_TRYBUILDTARGETSCATTERMESH_OFFSET UNITYSDK_OFFSET(0x1AEE81F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY_TRYSAMPLEPOINTSONMESHSURFACE_OFFSET UNITYSDK_OFFSET(0x1AEE9620)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassBillboardSamplingUtility_TypeDefinitionIndex = 26493;
