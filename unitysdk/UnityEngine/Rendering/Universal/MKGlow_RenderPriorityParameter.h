...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RENDERPRIORITYPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B899A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RENDERPRIORITYPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B899A00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RENDERPRIORITYPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B899A90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RENDERPRIORITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B899AA0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_RenderPriorityParameter_TypeDefinitionIndex = 27105;
