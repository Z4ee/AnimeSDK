...
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSDATA_TEXTURERESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDFF2A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PostProcessData_TextureResources_TypeDefinitionIndex = 27296;
