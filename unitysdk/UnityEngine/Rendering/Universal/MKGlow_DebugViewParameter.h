...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_DEBUGVIEWPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CCA68F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_DEBUGVIEWPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1CCA6870)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_DEBUGVIEWPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CCA6900)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_DEBUGVIEWPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCA6910)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_DebugViewParameter_TypeDefinitionIndex = 27634;
