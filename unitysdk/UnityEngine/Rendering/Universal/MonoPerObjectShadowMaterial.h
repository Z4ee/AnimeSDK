...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_CACHEDSHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CEFD740)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CEFDA50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1CEFD720)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_INIT_OFFSET UNITYSDK_OFFSET(0x1CEFDC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x1CEFDF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_SET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1CEFD730)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEFDF80)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoPerObjectShadowMaterial_TypeDefinitionIndex = 27498;
