...
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_GETINDEXINCACHEARRAY_OFFSET UNITYSDK_OFFSET(0x1AF4EA70)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_GET_BLENDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AF4E6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_GET_CUBEMAPARRAYIMPORTANCE_OFFSET UNITYSDK_OFFSET(0x1AF4E9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_GET_CUBEMAPARRAY_OFFSET UNITYSDK_OFFSET(0x1AF4E010)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_GET_INDEXINARRAY_OFFSET UNITYSDK_OFFSET(0x1AF4E8F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AF4F210)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF4F060)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF4EBE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_REGISTERTOENGINE_OFFSET UNITYSDK_OFFSET(0x1AF4E070)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_SETOLDINDEX_OFFSET UNITYSDK_OFFSET(0x1AF4E760)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_SET_BLENDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AF4E700)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_SET_CUBEMAPARRAYIMPORTANCE_OFFSET UNITYSDK_OFFSET(0x1AF4E9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_SET_CUBEMAPARRAY_OFFSET UNITYSDK_OFFSET(0x1AF4E020)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE_SET_INDEXINARRAY_OFFSET UNITYSDK_OFFSET(0x1AF4E940)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4F2B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DeferredReflectionProbe_TypeDefinitionIndex = 26618;
