...
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORADJUSTMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F6060)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ColorAdjustments_TypeDefinitionIndex = 30110;
	...
	public:
		...
		{
			return (::UnityEngine::Texture2D**)Il2CppClass::FromTypeDefinitionIndex(ColorAdjustments_TypeDefinitionIndex)->GetStaticField(0x4ACD0);
		}
