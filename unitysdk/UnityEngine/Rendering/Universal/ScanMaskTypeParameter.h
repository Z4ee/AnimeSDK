...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCANMASKTYPEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6FAC60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScanMaskTypeParameter_TypeDefinitionIndex = 26807;
