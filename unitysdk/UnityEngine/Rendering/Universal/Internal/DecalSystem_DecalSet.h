...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ADDDECAL_OFFSET UNITYSDK_OFFSET(0x1C43AF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ASSIGNCURRENTBATCHES_OFFSET UNITYSDK_OFFSET(0x1C43C280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_BEGINCULL_OFFSET UNITYSDK_OFFSET(0x1C43BCD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_CREATEDRAWDATA_OFFSET UNITYSDK_OFFSET(0x1C43C5B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ENDCULL_OFFSET UNITYSDK_OFFSET(0x1C43CF50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GETDECALPROJECTBOUNDINGSPHERE_OFFSET UNITYSDK_OFFSET(0x1C43A3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C43D750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x1C43D810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GET_KEYMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C43D740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_INITIALIZEMATERIALVALUES_OFFSET UNITYSDK_OFFSET(0x1C439FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ISDRAWN_OFFSET UNITYSDK_OFFSET(0x1C43C440)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_MOVECACHEDDATA_OFFSET UNITYSDK_OFFSET(0x1C43B770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_NEEDRENDERDECAL_OFFSET UNITYSDK_OFFSET(0x1C43D100)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_QUERYCULLRESULTS_OFFSET UNITYSDK_OFFSET(0x1C43C030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_REFRESHDRAWORDER_OFFSET UNITYSDK_OFFSET(0x1C43D760)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_REMOVEDECAL_OFFSET UNITYSDK_OFFSET(0x1C43BC00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_RENDERDECAL_OFFSET UNITYSDK_OFFSET(0x1C43D280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_SETCULLRESULT_OFFSET UNITYSDK_OFFSET(0x1C43D820)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_UPDATECACHEDDATA_OFFSET UNITYSDK_OFFSET(0x1C43A760)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C43D990)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43A100)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_DecalSet_TypeDefinitionIndex = 26362;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalSystem_DecalSet_TypeDefinitionIndex)->GetStaticField(0x72E0);
		}
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::Matrix4x4>*>* m_DecalToWorld; // 0x10
		::UnityEngine::MaterialPropertyBlock* m_PropertyBlock; // 0x18
		::UnityEngine::Rendering::Universal::Internal::DecalSystem_TextureScaleBias* m_Mask; // 0x20
		::Il2CppArray<::UnityEngine::Vector2>* m_CachedDrawDistances; // 0x28
		::UnityEngine::Rendering::Universal::Internal::DecalSystem_TextureScaleBias* m_Normal; // 0x30
		::Il2CppArray<::System::Single>* m_CachedEmissionIntensity; // 0x38
		::Il2CppArray<::UnityEngine::Matrix4x4>* m_CachedDecalToWorld; // 0x40
		::Il2CppArray<::System::Int32>* m_CachedLayerMask; // 0x48
		::Il2CppArray<::System::Int32>* m_ResultIndices; // 0x50
		::Il2CppArray<::UnityEngine::Vector4>* m_CachedUVScaleBias; // 0x58
		::UnityEngine::Material* m_Material; // 0x60
		::UnityEngine::Rendering::Universal::Internal::DecalSystem_TextureScaleBias* m_Diffuse; // 0x68
		::Il2CppArray<::UnityEngine::Matrix4x4>* m_CachedNormalToWorld; // 0x70
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::Vector4>*>* m_ExtraParams; // 0x78
		::Il2CppArray<::System::Boolean>* m_CachedAnimationToggle; // 0x80
		::Il2CppArray<::UnityEngine::BoundingSphere>* m_BoundingSpheres; // 0x88
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::Matrix4x4>*>* m_NormalToWorld; // 0x90
		::Il2CppArray<::UnityEngine::Rendering::Universal::Internal::DecalSystem_DecalHandle*>* m_Handles; // 0x98
		::Il2CppArray<::UnityEngine::Vector4>* m_CachedExtraParams; // 0xA0
		::System::Int32 m_InstanceCount; // 0xA8
		::UnityEngine::Vector2Int MinMaxSiblingIndex; // 0xAC
		::System::Int32 m_DecalsCount; // 0xB4
		::System::Int32 m_NumResults; // 0xB8
		::System::Int32 _DrawOrder; // 0xBC
