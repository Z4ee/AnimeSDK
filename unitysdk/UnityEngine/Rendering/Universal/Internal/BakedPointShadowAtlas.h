...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWATLAS_GETSLICEINDEXFORCUBEMAPFACE_OFFSET UNITYSDK_OFFSET(0x1B17C270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWATLAS_GETTEMPTEXTUREWITHINDEX_OFFSET UNITYSDK_OFFSET(0x1B17BF70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWATLAS_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B17C0B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWATLAS_SETTEMPTEXTUREWITHINDEX_OFFSET UNITYSDK_OFFSET(0x1B17C010)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17C2F0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int BakedPointShadowAtlas_TypeDefinitionIndex = 26774;
