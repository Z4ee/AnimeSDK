...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_OFFPREVIEWCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B7F3E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_OFFPREVIEW_OFFSET UNITYSDK_OFFSET(0x1B7F3D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B7F3C40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B7F3B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_PREVIEWBAKE_OFFSET UNITYSDK_OFFSET(0x1B7F3CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_PREVIEWCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B7F3DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F3EC0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CombinedDecalProjector_TypeDefinitionIndex = 26209;
