...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x110A3580)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x110A34A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x110A3770)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int SceneMovableObjectHolder_TypeDefinitionIndex = 27852;
