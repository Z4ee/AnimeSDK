...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xF7A3BC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF7A3AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0xF7A3DB0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int SceneMovableObjectHolder_TypeDefinitionIndex = 26922;
