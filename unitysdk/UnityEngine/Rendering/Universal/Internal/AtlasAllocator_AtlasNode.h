...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ATLASNODE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1C431A90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ATLASNODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C431D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ATLASNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4319F0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int AtlasAllocator_AtlasNode_TypeDefinitionIndex = 27899;
