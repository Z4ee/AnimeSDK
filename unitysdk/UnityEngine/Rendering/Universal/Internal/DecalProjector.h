...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ADD_ONMATERIALCHANGE_OFFSET UNITYSDK_OFFSET(0x1C149450)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1C149410)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C1496A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETDECALUVANIMATION_OFFSET UNITYSDK_OFFSET(0x1C146E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETDECALUVOFFSET_OFFSET UNITYSDK_OFFSET(0x1C146930)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETDECALUVSCALEANDBIAS_OFFSET UNITYSDK_OFFSET(0x1C146E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETMATCHINDEX_OFFSET UNITYSDK_OFFSET(0x1C149C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DECALOFFSET_OFFSET UNITYSDK_OFFSET(0x1C147120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DECALSIZE_OFFSET UNITYSDK_OFFSET(0x1C1470A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DRAWDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C1460C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x1C145AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_EMISSIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C146270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_FADEFACTOR_OFFSET UNITYSDK_OFFSET(0x1C146BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1C147220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1C146000)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_MIRRORTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C146060)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x1C146CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_NORMALBLENDINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C146200)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C146590)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C147040)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_ROTATESPEED_OFFSET UNITYSDK_OFFSET(0x1C146790)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1C146F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C1466C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_S_WATERPROXYPREVIEW_OFFSET UNITYSDK_OFFSET(0x1C1459C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_UVBIAS_OFFSET UNITYSDK_OFFSET(0x1C1461A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_UVSCALEBIAS_OFFSET UNITYSDK_OFFSET(0x1C1471B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_UVSCALE_OFFSET UNITYSDK_OFFSET(0x1C146140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_HASANIMATION_OFFSET UNITYSDK_OFFSET(0x1C149250)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_INTERSECTTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1C14A2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C149550)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_NEEDBAKEDECALMESH_OFFSET UNITYSDK_OFFSET(0x1C145A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_NEEDWATERPOOLBAKE_OFFSET UNITYSDK_OFFSET(0x1C145A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C148E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C1490A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C147240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x1C145B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C146660)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_PREPAREFORQUADMESHDECAL_OFFSET UNITYSDK_OFFSET(0x1C147BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_REFRESHDECALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C149740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_REFRESHMESHDECALVALUE_OFFSET UNITYSDK_OFFSET(0x1C148120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_REMOVE_ONMATERIALCHANGE_OFFSET UNITYSDK_OFFSET(0x1C1494D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SETPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1C1469B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C146380)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_DRAWDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C1460D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x1C145AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_EMISSIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C146280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_FADEFACTOR_OFFSET UNITYSDK_OFFSET(0x1C146BC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1C147230)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1C146010)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_MIRRORTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C146070)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x1C146CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_NORMALBLENDINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C146210)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C1465B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_ROTATESPEED_OFFSET UNITYSDK_OFFSET(0x1C1467A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C1466E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_UVBIAS_OFFSET UNITYSDK_OFFSET(0x1C1461B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_UVSCALE_OFFSET UNITYSDK_OFFSET(0x1C146150)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_TESTTRIANGLEHIT_OFFSET UNITYSDK_OFFSET(0x1C149D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C14A790)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C14A6A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalProjector_TypeDefinitionIndex = 27274;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x22300);
		}
		static ::System::Int32* StaticGet__QuadMeshNormalToWorldMatrix()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7420);
		}
		static ::UnityEngine::Quaternion* StaticGet_k_MinusYtoZRotation()
		{
			return (::UnityEngine::Quaternion*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7424);
		}
		static ::System::Int32* StaticGet__QuadMeshUVScaleBias()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7434);
		}
		static ::System::Int32* StaticGet__QuadMeshSizeScale()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7438);
		}
