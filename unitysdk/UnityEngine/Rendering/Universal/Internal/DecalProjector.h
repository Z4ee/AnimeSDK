...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ADD_ONMATERIALCHANGE_OFFSET UNITYSDK_OFFSET(0x19F2D890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x19F2D850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x19F2DAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETDECALUVANIMATION_OFFSET UNITYSDK_OFFSET(0x19F2B430)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETDECALUVOFFSET_OFFSET UNITYSDK_OFFSET(0x19F2AF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETDECALUVSCALEANDBIAS_OFFSET UNITYSDK_OFFSET(0x19F2B480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GETMATCHINDEX_OFFSET UNITYSDK_OFFSET(0x19F2E040)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DECALOFFSET_OFFSET UNITYSDK_OFFSET(0x19F2B720)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DECALSIZE_OFFSET UNITYSDK_OFFSET(0x19F2B6A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DRAWDISTANCE_OFFSET UNITYSDK_OFFSET(0x19F2A6C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x19F2A0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_EMISSIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x19F2A870)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_FADEFACTOR_OFFSET UNITYSDK_OFFSET(0x19F2B1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x19F2B820)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x19F2A600)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_MIRRORTEXTURE_OFFSET UNITYSDK_OFFSET(0x19F2A660)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x19F2B2E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_NORMALBLENDINTENSITY_OFFSET UNITYSDK_OFFSET(0x19F2A800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x19F2AB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x19F2B640)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_ROTATESPEED_OFFSET UNITYSDK_OFFSET(0x19F2AD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x19F2B500)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19F2ACC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_S_WATERPROXYPREVIEW_OFFSET UNITYSDK_OFFSET(0x19F29FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_UVBIAS_OFFSET UNITYSDK_OFFSET(0x19F2A7A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_UVSCALEBIAS_OFFSET UNITYSDK_OFFSET(0x19F2B7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_GET_UVSCALE_OFFSET UNITYSDK_OFFSET(0x19F2A740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_HASANIMATION_OFFSET UNITYSDK_OFFSET(0x19F2D690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_INTERSECTTRIANGLE_OFFSET UNITYSDK_OFFSET(0x19F2E730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ISVALID_OFFSET UNITYSDK_OFFSET(0x19F2D990)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_NEEDBAKEDECALMESH_OFFSET UNITYSDK_OFFSET(0x19F2A080)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_NEEDWATERPOOLBAKE_OFFSET UNITYSDK_OFFSET(0x19F2A020)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19F2D390)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19F2D5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F2B840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x19F2A140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19F2AC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_PREPAREFORQUADMESHDECAL_OFFSET UNITYSDK_OFFSET(0x19F2C0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_REFRESHDECALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19F2DB80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_REFRESHMESHDECALVALUE_OFFSET UNITYSDK_OFFSET(0x19F2C650)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_REMOVE_ONMATERIALCHANGE_OFFSET UNITYSDK_OFFSET(0x19F2D910)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SETPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x19F2AFB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SETPROPERTY_OFFSET UNITYSDK_OFFSET(0x19F2A980)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_DRAWDISTANCE_OFFSET UNITYSDK_OFFSET(0x19F2A6D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x19F2A0F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_EMISSIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x19F2A880)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_FADEFACTOR_OFFSET UNITYSDK_OFFSET(0x19F2B1C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x19F2B830)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x19F2A610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_MIRRORTEXTURE_OFFSET UNITYSDK_OFFSET(0x19F2A670)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x19F2B2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_NORMALBLENDINTENSITY_OFFSET UNITYSDK_OFFSET(0x19F2A810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x19F2ABB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_ROTATESPEED_OFFSET UNITYSDK_OFFSET(0x19F2ADA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x19F2ACE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_UVBIAS_OFFSET UNITYSDK_OFFSET(0x19F2A7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SET_UVSCALE_OFFSET UNITYSDK_OFFSET(0x19F2A750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_TESTTRIANGLEHIT_OFFSET UNITYSDK_OFFSET(0x19F2E140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F2EBD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F2EAE0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalProjector_TypeDefinitionIndex = 30340;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x24A50);
		}
		static ::System::Int32* StaticGet__QuadMeshSizeScale()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7680);
		}
		static ::UnityEngine::Quaternion* StaticGet_k_MinusYtoZRotation()
		{
			return (::UnityEngine::Quaternion*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7684);
		}
		static ::System::Int32* StaticGet__QuadMeshNormalToWorldMatrix()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7694);
		}
		static ::System::Int32* StaticGet__QuadMeshUVScaleBias()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_TypeDefinitionIndex)->GetStaticField(0x7698);
		}
