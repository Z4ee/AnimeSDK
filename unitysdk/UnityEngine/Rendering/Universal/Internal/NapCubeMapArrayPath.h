...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPCUBEMAPARRAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B893BD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapCubeMapArrayPath_TypeDefinitionIndex = 26904;
