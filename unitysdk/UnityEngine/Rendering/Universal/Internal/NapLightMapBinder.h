...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D3DFD40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D3DF950)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_SETLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x1D3DF5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D3E0080)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E0030)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapBinder_TypeDefinitionIndex = 26852;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapLightMapBinder_TypeDefinitionIndex)->GetStaticField(0x6050);
		}
