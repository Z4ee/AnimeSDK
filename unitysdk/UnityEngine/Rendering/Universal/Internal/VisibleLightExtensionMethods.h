...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x192A2690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x192A2580)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETRIGHT_OFFSET UNITYSDK_OFFSET(0x192A28B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETUP_OFFSET UNITYSDK_OFFSET(0x192A27A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int VisibleLightExtensionMethods_TypeDefinitionIndex = 30374;
