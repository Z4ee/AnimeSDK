...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDUPDATEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1BC5B9C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDUPDATEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1BC5B770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDUPDATEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC5BA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDUPDATEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC5B620)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int GpuBoidUpdatePass_TypeDefinitionIndex = 27225;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GpuBoidUpdatePass_TypeDefinitionIndex)->GetStaticField(0x50B0);
		}
