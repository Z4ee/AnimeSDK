...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATREFLECTIONPASSLODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43D9D0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int MatReflectionPassLodData_TypeDefinitionIndex = 26736;
