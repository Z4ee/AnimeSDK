...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_SINGLETRIANGLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A5FD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalProjector_SingleTriangleData_TypeDefinitionIndex = 27667;
