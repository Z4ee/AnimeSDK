...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_CLEARMATRIXLIST_OFFSET UNITYSDK_OFFSET(0x1BC24AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_DESTROY_OFFSET UNITYSDK_OFFSET(0x1BC24A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_DRAWMACH25SCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1BC24FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_DRAWMACH25SCENE_OFFSET UNITYSDK_OFFSET(0x1BC24D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1BC24850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_INIT_OFFSET UNITYSDK_OFFSET(0x1BC248D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_REVERSEMATRIXLIST_OFFSET UNITYSDK_OFFSET(0x1BC24BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC248C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int Mach25ObjectInstancing_TypeDefinitionIndex = 26321;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::Mach25ObjectInstancing**)Il2CppClass::FromTypeDefinitionIndex(Mach25ObjectInstancing_TypeDefinitionIndex)->GetStaticField(0x21A30);
		}
		::UnityEngine::Rendering::Universal::Internal::Mach25ObjectInstancing_Mach25SceneObjInfo* pillarInfo; // 0x10
		...
		::UnityEngine::Rendering::Universal::Internal::Mach25ObjectInstancing_Mach25SceneObjInfo* tileInfo; // 0x28
