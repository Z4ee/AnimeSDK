...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTFLICKFREQUENCY_OFFSET UNITYSDK_OFFSET(0x6C8E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTINTENSITY_OFFSET UNITYSDK_OFFSET(0x926F20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTUREOVERLAY_OFFSET UNITYSDK_OFFSET(0x40C750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTUREOVERLAY_ST_OFFSET UNITYSDK_OFFSET(0x926F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x2AB510)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURE_ST_OFFSET UNITYSDK_OFFSET(0x3E4320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_ISDIRTTEXTUREVALID_OFFSET UNITYSDK_OFFSET(0x926F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x926F50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x926F40)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_LensDirtParams_TypeDefinitionIndex = 26700;
