...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_GETLAYERMASKFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x1ABA1730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_GET_RENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1ABA17B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ABA1880)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1ABA1900)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABA1800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_REGISTERPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x1ABA14D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_UNREGISTERPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x1ABA1600)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABA1E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA1DD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostLight_TypeDefinitionIndex = 30356;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::PostLight*>**)Il2CppClass::FromTypeDefinitionIndex(PostLight_TypeDefinitionIndex)->GetStaticField(0x24060);
		}
