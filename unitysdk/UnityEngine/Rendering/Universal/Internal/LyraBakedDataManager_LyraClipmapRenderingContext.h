...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C99F410)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_GETCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C99F5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_INITED_OFFSET UNITYSDK_OFFSET(0x1C99F560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_REALLOCATERESOURCESIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1C99FB50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASEALLOCATEDCOMPUTEBUFFERS_OFFSET UNITYSDK_OFFSET(0x1C99F880)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASERT_OFFSET UNITYSDK_OFFSET(0x1C9A0320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C99F480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1C99FAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RESETALLOCATEDCOMPUTEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1C99F5A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C99F170)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_LyraClipmapRenderingContext_TypeDefinitionIndex = 26912;

	class LyraBakedDataManager_LyraClipmapRenderingContext : public ::System::Object
	{
	public:
		::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>* m_ChangedSectorCoord; // 0x10
		::UnityEngine::RenderTexture* m_EmissionClipmapTexture; // 0x18
		::Il2CppArray<::UnityEngine::Vector4>* m_CenterAndExtent; // 0x20
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::ComputeBuffer*>*>* m_AllocatedBuffers; // 0x28
		::UnityEngine::RenderTexture* m_ClipmapTexture; // 0x30
		::UnityEngine::RenderTexture* m_CompressedClipmapTexture; // 0x38
		::Il2CppArray<::UnityEngine::Vector4>* m_WorldToUVAddAndMul; // 0x40
		::UnityEngine::Texture2D* m_AlbedoLutTex; // 0x48
		::Il2CppArray<::UnityEngine::Vector3Int>* m_FullUpdateOriginInPages; // 0x50
		::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_SceneVoxelVisualizer* m_Visualizer; // 0x58
		::Il2CppArray<::UnityEngine::Vector3Int>* m_LastPartialUpdateOriginInPages; // 0x60
		::System::Int32 m_DirtyClipmapToRefresh; // 0x68
		::System::UInt32 m_ComputeBufferSize; // 0x6C
		::System::Int32 m_NumPropagatedSteps; // 0x70
		::System::Boolean m_Inited; // 0x74
		::System::Boolean m_IsForDistanceField; // 0x75
		::System::Boolean m_Enabled; // 0x76
