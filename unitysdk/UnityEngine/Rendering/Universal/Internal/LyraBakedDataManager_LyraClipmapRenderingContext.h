...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BC23730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_GETCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x1BC23910)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_INITED_OFFSET UNITYSDK_OFFSET(0x1BC23880)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_REALLOCATERESOURCESIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1BC23E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASEALLOCATEDCOMPUTEBUFFERS_OFFSET UNITYSDK_OFFSET(0x1BC23B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASERT_OFFSET UNITYSDK_OFFSET(0x1BC24620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1BC237A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1BC23DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RESETALLOCATEDCOMPUTEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1BC238C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC23490)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_LyraClipmapRenderingContext_TypeDefinitionIndex = 27328;

	class LyraBakedDataManager_LyraClipmapRenderingContext : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::ComputeBuffer*>*>* m_AllocatedBuffers; // 0x10
		::UnityEngine::Texture2D* m_AlbedoLutTex; // 0x18
		::UnityEngine::RenderTexture* m_ClipmapTexture; // 0x20
		::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_SceneVoxelVisualizer* m_Visualizer; // 0x28
		::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>* m_ChangedSectorCoord; // 0x30
		::Il2CppArray<::UnityEngine::Vector3Int>* m_FullUpdateOriginInPages; // 0x38
		::UnityEngine::RenderTexture* m_EmissionClipmapTexture; // 0x40
		::Il2CppArray<::UnityEngine::Vector4>* m_WorldToUVAddAndMul; // 0x48
		::Il2CppArray<::UnityEngine::Vector3Int>* m_LastPartialUpdateOriginInPages; // 0x50
		::UnityEngine::RenderTexture* m_CompressedClipmapTexture; // 0x58
		::Il2CppArray<::UnityEngine::Vector4>* m_CenterAndExtent; // 0x60
		::System::Boolean m_Enabled; // 0x68
		::System::Boolean m_IsForDistanceField; // 0x69
		::System::Boolean m_Inited; // 0x6A
