...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_CLEARINIDIRECTARGS_OFFSET UNITYSDK_OFFSET(0x19289740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x192895A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_INITIFNEEDED_OFFSET UNITYSDK_OFFSET(0x192895B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETBUFFERPARAMS_OFFSET UNITYSDK_OFFSET(0x19289890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETCOORDTOWORLDPOSOFFSETANDSCALE_OFFSET UNITYSDK_OFFSET(0x19289A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x19289B00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x19289550)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex = 30456;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderTargetHandle*)Il2CppClass::FromTypeDefinitionIndex(LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex)->GetStaticField(0x5B80);
		}
