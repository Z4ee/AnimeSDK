...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_CLEARINIDIRECTARGS_OFFSET UNITYSDK_OFFSET(0x1C5B9080)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C5B8EE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_INITIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1C5B8EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETBUFFERPARAMS_OFFSET UNITYSDK_OFFSET(0x1C5B91D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETCOORDTOWORLDPOSOFFSETANDSCALE_OFFSET UNITYSDK_OFFSET(0x1C5B93D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1C5B9450)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5B8E90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex = 26926;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderTargetHandle*)Il2CppClass::FromTypeDefinitionIndex(LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex)->GetStaticField(0x54C0);
		}
		::UnityEngine::ComputeBuffer* m_VisualizationIndirectDrawBuffer; // 0x10
		::UnityEngine::ComputeBuffer* m_VisualizationCubeInfoBuffer; // 0x18
		::Il2CppArray<::UnityEngine::Vector4>* m_SceneVoxelCoordToWorldPosOffsetAndScale; // 0x20
