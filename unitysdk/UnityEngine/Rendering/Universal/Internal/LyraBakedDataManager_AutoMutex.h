...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_AUTOMUTEX_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BE220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_AUTOMUTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x8BE1E0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_AutoMutex_TypeDefinitionIndex = 27330;
