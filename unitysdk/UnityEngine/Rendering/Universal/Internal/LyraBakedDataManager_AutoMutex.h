...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_AUTOMUTEX_DISPOSE_OFFSET UNITYSDK_OFFSET(0x81F9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_AUTOMUTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x81F970)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_AutoMutex_TypeDefinitionIndex = 30469;
