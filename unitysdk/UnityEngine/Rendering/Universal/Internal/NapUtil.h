...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASFLOAT_OFFSET UNITYSDK_OFFSET(0x1B07F030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASUINT_OFFSET UNITYSDK_OFFSET(0x1B07F070)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BATCHNULLCHECK_OFFSET UNITYSDK_OFFSET(0x1B07E920)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BLITQUAD_OFFSET UNITYSDK_OFFSET(0x1B07E100)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTELINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x1B07DFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTEPIXELCOORDTOWORLDSPACEVIEWDIRECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1B07E480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_DIVROUNDUP_OFFSET UNITYSDK_OFFSET(0x1B07DEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEBYTETOFLOAT_OFFSET UNITYSDK_OFFSET(0x1B07EF40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEFLOATARRAYTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1B07E9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_EXTRACTBYTEFROMFLOAT_OFFSET UNITYSDK_OFFSET(0x1B07EFC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETBLITMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B07E2D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETSCALEANDBIASFORLINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x1B07DF50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GET_MAXUINTASFLOAT_OFFSET UNITYSDK_OFFSET(0x1B07DF40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_PROJECTIONMATRIXASPECT_OFFSET UNITYSDK_OFFSET(0x1B07E430)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07F0C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__ENCODEFLOATARRAYTOVECTOR4_G__ENCODEFLOATTOUINT8_14_0_OFFSET UNITYSDK_OFFSET(0x1B07EEA0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapUtil_TypeDefinitionIndex = 27362;
	...
	public:
		...
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(NapUtil_TypeDefinitionIndex)->GetStaticField(0x21C40);
		}
