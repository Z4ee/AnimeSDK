...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASFLOAT_OFFSET UNITYSDK_OFFSET(0x1C4DF2B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASUINT_OFFSET UNITYSDK_OFFSET(0x1C4DF2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BATCHNULLCHECK_OFFSET UNITYSDK_OFFSET(0x1C4DEA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BLITQUAD_OFFSET UNITYSDK_OFFSET(0x1C4DE1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTELINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x1C4DE0D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTEPIXELCOORDTOWORLDSPACEVIEWDIRECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1C4DE560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_DIVROUNDUP_OFFSET UNITYSDK_OFFSET(0x1C4DDFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEBYTETOFLOAT_OFFSET UNITYSDK_OFFSET(0x1C4DF1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEFLOATARRAYTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1C4DEAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_EXTRACTBYTEFROMFLOAT_OFFSET UNITYSDK_OFFSET(0x1C4DF240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETBLITMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C4DE3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETSCALEANDBIASFORLINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x1C4DE040)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GET_MAXUINTASFLOAT_OFFSET UNITYSDK_OFFSET(0x1C4DE030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_PROJECTIONMATRIXASPECT_OFFSET UNITYSDK_OFFSET(0x1C4DE510)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DF340)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__ENCODEFLOATARRAYTOVECTOR4_G__ENCODEFLOATTOUINT8_14_0_OFFSET UNITYSDK_OFFSET(0x1C4DF0C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapUtil_TypeDefinitionIndex = 27107;
	...
	public:
		...
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(NapUtil_TypeDefinitionIndex)->GetStaticField(0x233E0);
		}
