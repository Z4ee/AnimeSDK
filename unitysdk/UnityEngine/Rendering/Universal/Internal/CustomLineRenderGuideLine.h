...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_GENERATE_OFFSET UNITYSDK_OFFSET(0x1B17C4B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B17ED80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B17EF80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B17C460)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_TRYFINDINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1B17EE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17F9F0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CustomLineRenderGuideLine_TypeDefinitionIndex = 26279;
