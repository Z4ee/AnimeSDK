...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_GENERATE_OFFSET UNITYSDK_OFFSET(0x19284120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x192869F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x19286BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x192840D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_TRYFINDINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19286AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19287660)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CustomLineRenderGuideLine_TypeDefinitionIndex = 30546;
