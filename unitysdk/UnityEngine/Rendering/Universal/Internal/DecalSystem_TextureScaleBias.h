...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1C99EAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C99EC50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C99ECB0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_TextureScaleBias_TypeDefinitionIndex = 26880;
