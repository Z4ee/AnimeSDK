...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_AFMESETFRAMEINFO_OFFSET UNITYSDK_OFFSET(0x1D6E59A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6E5A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_MFRCSETINPUTTEXTURES_OFFSET UNITYSDK_OFFSET(0x1D6E5A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E5860)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FrameEstimateInfoPass_Managed_TypeDefinitionIndex = 27582;
