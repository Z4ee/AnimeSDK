...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_AFMESETFRAMEINFO_OFFSET UNITYSDK_OFFSET(0x1C406770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C406850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_MFRCSETINPUTTEXTURES_OFFSET UNITYSDK_OFFSET(0x1C4067E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C406630)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FrameEstimateInfoPass_Managed_TypeDefinitionIndex = 27074;
