...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C99E9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1C99EA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C99EA80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_FSR3PersistentData_TypeDefinitionIndex = 26713;
