...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_TRIANGLE_NEWQUAD_OFFSET UNITYSDK_OFFSET(0x1B7F42E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_TRIANGLE_NEWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B7F3F70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_TRIANGLE_SLICE_OFFSET UNITYSDK_OFFSET(0x1B7F4740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALPROJECTOR_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F3F10)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalProjector_Triangle_TypeDefinitionIndex = 27277;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(DecalProjector_Triangle_TypeDefinitionIndex)->GetStaticField(0x12FF0);
		}
