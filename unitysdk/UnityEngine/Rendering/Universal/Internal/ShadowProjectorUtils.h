...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETBOUNDSBACKCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1968E480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETCORNERSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1968CE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_1_OFFSET UNITYSDK_OFFSET(0x1968D1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_OFFSET UNITYSDK_OFFSET(0x1968D050)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETOBJECTBOUNDSINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x1968CAD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETSHADOWVIEWTOCLIPMATRIX_OFFSET UNITYSDK_OFFSET(0x1968E530)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETWORLDTOSHADOWVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x1968E160)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMAX_OFFSET UNITYSDK_OFFSET(0x1968E0F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMIN_OFFSET UNITYSDK_OFFSET(0x1968E080)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_BEFORECULLING_OFFSET UNITYSDK_OFFSET(0x1968EB30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_PREPARERESOLVEDATA_OFFSET UNITYSDK_OFFSET(0x1968E670)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_RETRIEVESCENEDATA_OFFSET UNITYSDK_OFFSET(0x1968EA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1968F150)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1968F140)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ShadowProjectorUtils_TypeDefinitionIndex = 30368;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x24820);
		}
		static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet_globalTempCubeCorners()
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x24828);
		}
