...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETBOUNDSBACKCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1B7F9AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETCORNERSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B7F84B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_1_OFFSET UNITYSDK_OFFSET(0x1B7F8810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_OFFSET UNITYSDK_OFFSET(0x1B7F8680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETOBJECTBOUNDSINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x1B7F8090)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETSHADOWVIEWTOCLIPMATRIX_OFFSET UNITYSDK_OFFSET(0x1B7F9B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETWORLDTOSHADOWVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x1B7F9790)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMAX_OFFSET UNITYSDK_OFFSET(0x1B7F9720)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMIN_OFFSET UNITYSDK_OFFSET(0x1B7F96B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_BEFORECULLING_OFFSET UNITYSDK_OFFSET(0x1B7FA160)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_PREPARERESOLVEDATA_OFFSET UNITYSDK_OFFSET(0x1B7F9CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_RETRIEVESCENEDATA_OFFSET UNITYSDK_OFFSET(0x1B7FA0B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7FA780)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7FA770)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ShadowProjectorUtils_TypeDefinitionIndex = 26660;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x220C0);
		}
		static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet_globalTempCubeCorners()
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x220C8);
		}
