...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CC9F720)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1CC9FA00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CC9F910)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CC9F5A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC9FAC0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_TypeDefinitionIndex = 26878;
