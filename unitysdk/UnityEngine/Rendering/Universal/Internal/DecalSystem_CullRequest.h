...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B892470)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B892750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B892660)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B8922F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B892810)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_TypeDefinitionIndex = 26366;
