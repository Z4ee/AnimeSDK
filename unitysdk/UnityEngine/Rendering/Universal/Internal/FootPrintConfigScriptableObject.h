...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_CONVERTMATCHNAMETOLOWCASE_OFFSET UNITYSDK_OFFSET(0x1B7F4D30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B7F4F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F5100)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintConfigScriptableObject_TypeDefinitionIndex = 26373;
