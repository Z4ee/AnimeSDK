...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_CONVERTMATCHNAMETOLOWCASE_OFFSET UNITYSDK_OFFSET(0x1CB119B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CB11C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB11D80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintConfigScriptableObject_TypeDefinitionIndex = 27005;
