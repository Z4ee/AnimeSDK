...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAFTERDEFERREDSHADING_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B181280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAFTERDEFERREDSHADING_SETUP_OFFSET UNITYSDK_OFFSET(0x1B181220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAFTERDEFERREDSHADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B181190)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraAfterDeferredShading_TypeDefinitionIndex = 26923;
