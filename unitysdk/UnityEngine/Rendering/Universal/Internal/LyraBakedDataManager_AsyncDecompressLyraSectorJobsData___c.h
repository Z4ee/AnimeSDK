...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_ASYNCDECOMPRESSLYRASECTORJOBSDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4DD6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_ASYNCDECOMPRESSLYRASECTORJOBSDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DD730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_ASYNCDECOMPRESSLYRASECTORJOBSDATA___C__DECOMPRESSASYNC_B__1_0_OFFSET UNITYSDK_OFFSET(0x1C4DD740)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_AsyncDecompressLyraSectorJobsData___c_TypeDefinitionIndex = 26920;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_AsyncDecompressLyraSectorJobsData___c**)Il2CppClass::FromTypeDefinitionIndex(LyraBakedDataManager_AsyncDecompressLyraSectorJobsData___c_TypeDefinitionIndex)->GetStaticField(0x217B0);
		}
		...
		{
			return (::System::Func_2<::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_AsyncDecompressLyraSectorJobsData*, ::System::Threading::Tasks::Task*>**)Il2CppClass::FromTypeDefinitionIndex(LyraBakedDataManager_AsyncDecompressLyraSectorJobsData___c_TypeDefinitionIndex)->GetStaticField(0x217B8);
		}
