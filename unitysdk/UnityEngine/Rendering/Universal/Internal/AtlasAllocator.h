...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x190AAC40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_RESET_OFFSET UNITYSDK_OFFSET(0x190AAF60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x190AABC0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int AtlasAllocator_TypeDefinitionIndex = 30548;
