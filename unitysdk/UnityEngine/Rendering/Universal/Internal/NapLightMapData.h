...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_GETLOADEDSCENE_OFFSET UNITYSDK_OFFSET(0x1BDBF3E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BDBF530)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BDBF4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BDBF1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_REGISTERDYNAMICLOADEDTEXTURE_OFFSET UNITYSDK_OFFSET(0x1BDBF0A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDBF570)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapData_TypeDefinitionIndex = 26864;
