...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_BAKEBOXDATA_OFFSET UNITYSDK_OFFSET(0x1AEFA200)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETNPCFOOTSIZE_OFFSET UNITYSDK_OFFSET(0x1AEFB700)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETPRESETSPAWNERWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AEFAD80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETPRESETWHEELSPAWNERWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AEFAA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GET_DYNAMICRADIUS_OFFSET UNITYSDK_OFFSET(0x1AEFC4A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_INSIDEVOLUME_OFFSET UNITYSDK_OFFSET(0x1AEFA660)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AEFBDD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1AEFCC50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AEFBEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_REFRESHPROJECTIONMATRIXANDFOOTPRINTRT_ST_OFFSET UNITYSDK_OFFSET(0x1AEFC4B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_REMOVESUBVOLUME_OFFSET UNITYSDK_OFFSET(0x1AEFA9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_SAVECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x1AEFA2D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AEFB9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFD1C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintGroundProxy_TypeDefinitionIndex = 27259;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::FootPrintGroundProxy**)Il2CppClass::FromTypeDefinitionIndex(FootPrintGroundProxy_TypeDefinitionIndex)->GetStaticField(0x20360);
		}
