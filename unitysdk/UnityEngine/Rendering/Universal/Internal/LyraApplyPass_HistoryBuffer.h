...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAPPLYPASS_HISTORYBUFFER_PINGPONG_OFFSET UNITYSDK_OFFSET(0x1E666B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAPPLYPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1E666520)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAPPLYPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1E666BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAPPLYPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6675B0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraApplyPass_HistoryBuffer_TypeDefinitionIndex = 26953;
