...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19B91360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19B916F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19B91BC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x19B912E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B91CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B910C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19B91D10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_REACTIVEMASKPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19B91D20)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ReactiveMaskPass_TypeDefinitionIndex = 30537;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ReactiveMaskPass_TypeDefinitionIndex)->GetStaticField(0x69F0);
		}
