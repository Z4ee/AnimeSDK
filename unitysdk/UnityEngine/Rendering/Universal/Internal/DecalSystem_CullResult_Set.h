...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B07BB50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B07BAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B07BA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_GET_NUMRESULTS_OFFSET UNITYSDK_OFFSET(0x1B07B9F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_GET_RESULTINDICES_OFFSET UNITYSDK_OFFSET(0x1B07BA00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_QUERYINDICES_OFFSET UNITYSDK_OFFSET(0x1B07BBA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07BC40)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullResult_Set_TypeDefinitionIndex = 26364;
