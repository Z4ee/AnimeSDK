...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1910EC20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1910EB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1910EAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_GET_NUMRESULTS_OFFSET UNITYSDK_OFFSET(0x1910EAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_GET_RESULTINDICES_OFFSET UNITYSDK_OFFSET(0x1910EAD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_QUERYINDICES_OFFSET UNITYSDK_OFFSET(0x1910EC70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET__CTOR_OFFSET UNITYSDK_OFFSET(0x1910ED10)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullResult_Set_TypeDefinitionIndex = 30348;
