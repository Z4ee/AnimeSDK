...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUGRASSUPDATEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1BC23120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUGRASSUPDATEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC22FE0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int GPUGrassUpdatePass_TypeDefinitionIndex = 26673;
