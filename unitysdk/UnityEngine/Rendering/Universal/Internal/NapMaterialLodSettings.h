...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C408470)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C407FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C407840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONRENDERERCHANGEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1C408D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1C408A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1C408B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C409B00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C409A20)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapMaterialLodSettings_TypeDefinitionIndex = 26697;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterialLodSettings_TypeDefinitionIndex)->GetStaticField(0x21FE0);
		}
