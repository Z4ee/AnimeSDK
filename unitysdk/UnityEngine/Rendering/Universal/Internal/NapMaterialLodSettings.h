...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D6E7680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D6E71C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D6E6A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONRENDERERCHANGEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1D6E7FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1D6E7C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1D6E7D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6E8D40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E8C60)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapMaterialLodSettings_TypeDefinitionIndex = 27261;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterialLodSettings_TypeDefinitionIndex)->GetStaticField(0x23780);
		}
