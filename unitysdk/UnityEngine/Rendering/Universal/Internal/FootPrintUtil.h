...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GENERATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x1C5B7240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETCHILD_OFFSET UNITYSDK_OFFSET(0x1C5B6BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETFOOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C5B6F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETORTHOPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1C5B7030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETWHEELTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C5B6FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GET_S_FOOTPRINTQUADMESH_OFFSET UNITYSDK_OFFSET(0x1C5B7680)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintUtil_TypeDefinitionIndex = 27202;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(FootPrintUtil_TypeDefinitionIndex)->GetStaticField(0x21D70);
		}
