...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETACTIVESCENELIGHTFOLDER_OFFSET UNITYSDK_OFFSET(0xF7A3E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETSCENEFOLDER_OFFSET UNITYSDK_OFFSET(0xF7A3E00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETTARGETSCENELIGHTFOLDER_OFFSET UNITYSDK_OFFSET(0xF7A40B0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int URPFileUtil_TypeDefinitionIndex = 26354;
