...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA_ADDASSET_OFFSET UNITYSDK_OFFSET(0x1AF002D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA_REMOVEASSETIMPL_OFFSET UNITYSDK_OFFSET(0x1AF0A9E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA_REMOVEASSET_OFFSET UNITYSDK_OFFSET(0x1AF00870)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFD9C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_LyraClipmapManagerData_TypeDefinitionIndex = 27316;

	class LyraBakedDataManager_LyraClipmapManagerData : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::LyraSector::LyraSectorRenderingData*>* m_SectorGpuData; // 0x10
		::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>* m_ChangedAssetsCoords; // 0x18
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraPackedAsset*, ::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>*>* m_LoadedSectorAssetsCoords; // 0x20
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::LyraSector::LyraSparseTreeBakedData*>* m_DecompressedSectors; // 0x28
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_AsyncDecompressLyraSectorSingleJobData*>* m_DecompressingSectorJobs; // 0x30
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::LyraSector::LyraPackedAsset*>* m_LoadedPackedAssets; // 0x38
		::System::Threading::Mutex* m_SectorMutex; // 0x40
		::UnityEngine::Texture2D* m_AlbedoLutTex; // 0x48
		::System::Int32 m_LoadedAssetSize; // 0x50
		::System::Boolean m_IsForDistanceField; // 0x54
