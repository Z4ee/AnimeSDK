...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA_ADDASSET_OFFSET UNITYSDK_OFFSET(0x1C4453D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA_REMOVEASSETIMPL_OFFSET UNITYSDK_OFFSET(0x1C44F750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA_REMOVEASSET_OFFSET UNITYSDK_OFFSET(0x1C445960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPMANAGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C442AD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_LyraClipmapManagerData_TypeDefinitionIndex = 26915;

	class LyraBakedDataManager_LyraClipmapManagerData : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraPackedAsset*, ::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>*>* m_LoadedSectorAssetsCoords; // 0x10
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::LyraSector::LyraPackedAsset*>* m_LoadedPackedAssets; // 0x18
		::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::LyraSector::LyraSectorRenderingData*>* m_SectorGpuData; // 0x20
		...
		::UnityEngine::Texture2D* m_AlbedoLutTex; // 0x38
