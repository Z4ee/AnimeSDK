...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTAO_OFFSET UNITYSDK_OFFSET(0x1C9A1F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x1C9A1BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9A2310)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int RuntimePostLightManager_TypeDefinitionIndex = 27512;
