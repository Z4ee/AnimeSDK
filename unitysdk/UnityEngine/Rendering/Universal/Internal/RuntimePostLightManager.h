...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTAO_OFFSET UNITYSDK_OFFSET(0x1BC262A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x1BC25F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC26620)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int RuntimePostLightManager_TypeDefinitionIndex = 26287;
