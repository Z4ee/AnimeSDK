...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_CALCULATECENTER_OFFSET UNITYSDK_OFFSET(0x97B080)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_CALCULATEEXTENT_OFFSET UNITYSDK_OFFSET(0x97B120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x97B1C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_EXPAND_1_OFFSET UNITYSDK_OFFSET(0x97B260)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_EXPAND_OFFSET UNITYSDK_OFFSET(0x97B250)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_INIT_OFFSET UNITYSDK_OFFSET(0x97B010)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_INTERSECT_OFFSET UNITYSDK_OFFSET(0x97B300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_ISVALID_OFFSET UNITYSDK_OFFSET(0x97B2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_OVERLAP_OFFSET UNITYSDK_OFFSET(0x97B390)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x97AF70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_2_OFFSET UNITYSDK_OFFSET(0x97AF90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_3_OFFSET UNITYSDK_OFFSET(0x97AFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_OFFSET UNITYSDK_OFFSET(0x3975A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_MinMaxAABB_TypeDefinitionIndex = 26923;
