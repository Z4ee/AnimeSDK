...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_COMBINELOGINFO_1_OFFSET UNITYSDK_OFFSET(0x1AD07890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_COMBINELOGINFO_OFFSET UNITYSDK_OFFSET(0x1AD077D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1AD07D70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1AD07CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOG_1_OFFSET UNITYSDK_OFFSET(0x1AD07C50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOG_OFFSET UNITYSDK_OFFSET(0x1AD07BC0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LogHelper_TypeDefinitionIndex = 30430;
