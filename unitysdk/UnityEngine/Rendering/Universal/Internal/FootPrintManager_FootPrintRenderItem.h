...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_CHECKTIMEOVER_OFFSET UNITYSDK_OFFSET(0x953090)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_GET_LOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x4C38A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_REFRESHALPHAANDMIRROR_OFFSET UNITYSDK_OFFSET(0x953110)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_REFRESHLIFETIME_OFFSET UNITYSDK_OFFSET(0x9530A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x952F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x952F00)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintManager_FootPrintRenderItem_TypeDefinitionIndex = 26799;
