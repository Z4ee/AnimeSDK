...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x19AB5DD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x19AB5EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19AB5E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19AB5FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x19AB5F20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB5DC0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_MaterialPropertyBlockSetter_TypeDefinitionIndex = 30478;
