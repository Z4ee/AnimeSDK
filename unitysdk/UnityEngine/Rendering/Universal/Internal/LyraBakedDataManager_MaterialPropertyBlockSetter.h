...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x1BDBE610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1BDBE6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1BDBE680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1BDBE7E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1BDBE760)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDBE600)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_MaterialPropertyBlockSetter_TypeDefinitionIndex = 27336;
