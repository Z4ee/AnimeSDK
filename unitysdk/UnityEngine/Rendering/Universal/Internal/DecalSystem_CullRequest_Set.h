...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D306510)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D3063D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D306380)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_GET_CULLINGGROUP_OFFSET UNITYSDK_OFFSET(0x1D306370)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D3065F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D306650)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_Set_TypeDefinitionIndex = 26879;
