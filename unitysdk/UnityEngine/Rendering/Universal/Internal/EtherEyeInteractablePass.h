...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1109D560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1109DC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1109D450)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int EtherEyeInteractablePass_TypeDefinitionIndex = 27146;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::EtherEyeInteractableInfo**)Il2CppClass::FromTypeDefinitionIndex(EtherEyeInteractablePass_TypeDefinitionIndex)->GetStaticField(0x23B00);
		}
