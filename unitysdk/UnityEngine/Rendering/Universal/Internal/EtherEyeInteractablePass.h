...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF79DA60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0xF79E2A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0xF79D950)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int EtherEyeInteractablePass_TypeDefinitionIndex = 26894;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::EtherEyeInteractableInfo**)Il2CppClass::FromTypeDefinitionIndex(EtherEyeInteractablePass_TypeDefinitionIndex)->GetStaticField(0x22390);
		}
