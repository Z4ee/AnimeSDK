...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ADDTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D30E2C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTUREWITHOUTBLIT_1_OFFSET UNITYSDK_OFFSET(0x1D30DD50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTUREWITHOUTBLIT_OFFSET UNITYSDK_OFFSET(0x1D30DCB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1D30DA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_BLIT2DTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D30D630)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_BLITTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D30D990)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x1D30D2A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_GETTEXTUREMIPMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1D30D030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_GET_ATLASTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D30CAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_IS2D_OFFSET UNITYSDK_OFFSET(0x1D30D560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ISCACHED_OFFSET UNITYSDK_OFFSET(0x1D30DF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_MARKGPUTEXTUREINVALID_OFFSET UNITYSDK_OFFSET(0x1D30D930)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_MARKGPUTEXTUREVALID_OFFSET UNITYSDK_OFFSET(0x1D30D8C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_NEEDSUPDATE_OFFSET UNITYSDK_OFFSET(0x1D30DFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D30D0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_RESETALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1D30D170)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_UPDATETEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1D30E5C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_UPDATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1D30E3A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D30E6E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30CAD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int Texture2DAtlas_TypeDefinitionIndex = 27744;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Texture2DAtlas_TypeDefinitionIndex)->GetStaticField(0x7530);
		}
		static ::UnityEngine::Vector4* StaticGet_fullScaleOffset()
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(Texture2DAtlas_TypeDefinitionIndex)->GetStaticField(0x7534);
		}
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::UInt32>* m_IsGPUTextureUpToDate; // 0x10
		::UnityEngine::RenderTexture* m_AtlasTexture; // 0x18
