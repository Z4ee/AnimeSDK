...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x190C8970)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x190C8B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x190C89E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x190C8CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x190C8C40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6EB0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_ComputeShaderSetter_TypeDefinitionIndex = 30476;

	class LyraBakedDataManager_ComputeShaderSetter : public ::System::Object
	{
	public:
		::UnityEngine::ComputeShader* cs; // 0x10
		::UnityEngine::Rendering::CommandBuffer* cb; // 0x18
