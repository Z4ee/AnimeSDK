...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x1AF0A620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1AF0A7C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AF0A690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1AF0A970)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1AF0A8F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF08B60)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_ComputeShaderSetter_TypeDefinitionIndex = 27331;
