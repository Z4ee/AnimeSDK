...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_DRAWBOIDMESH_OFFSET UNITYSDK_OFFSET(0x1BC5B2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_PREPAREBOIDBUFFER_OFFSET UNITYSDK_OFFSET(0x1BC5AEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1BC5AD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1BC5AE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC5B590)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC5B580)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int GpuBoidRendererManager_TypeDefinitionIndex = 26864;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::GpuBoidManager*>**)Il2CppClass::FromTypeDefinitionIndex(GpuBoidRendererManager_TypeDefinitionIndex)->GetStaticField(0x21440);
		}
