...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPYFIELDS_OFFSET UNITYSDK_OFFSET(0x1E79D6E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_1_OFFSET UNITYSDK_OFFSET(0x1E79D320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_OFFSET UNITYSDK_OFFSET(0x1E79CE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_1_OFFSET UNITYSDK_OFFSET(0x1E79D460)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_OFFSET UNITYSDK_OFFSET(0x1E79CFA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_ISPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x1E79CDB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_RECURSIVECOPYBASETYPEPRIVATEFIELDS_OFFSET UNITYSDK_OFFSET(0x1E79D9E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E79DBE0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ObjectExtensions_TypeDefinitionIndex = 27984;
	...
	public:
		...
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(ObjectExtensions_TypeDefinitionIndex)->GetStaticField(0x22B60);
		}
