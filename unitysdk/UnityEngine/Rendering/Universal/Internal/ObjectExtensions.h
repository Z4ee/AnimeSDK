...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPYFIELDS_OFFSET UNITYSDK_OFFSET(0x1B0883E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_1_OFFSET UNITYSDK_OFFSET(0x1B088020)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_OFFSET UNITYSDK_OFFSET(0x1B087B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_1_OFFSET UNITYSDK_OFFSET(0x1B088160)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_OFFSET UNITYSDK_OFFSET(0x1B087C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_ISPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x1B087AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_RECURSIVECOPYBASETYPEPRIVATEFIELDS_OFFSET UNITYSDK_OFFSET(0x1B0886E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0888E0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ObjectExtensions_TypeDefinitionIndex = 30369;
	...
	public:
		...
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(ObjectExtensions_TypeDefinitionIndex)->GetStaticField(0x23AF0);
		}
