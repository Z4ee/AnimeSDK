...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ARRAYEXTENSIONS_ARRAYTRAVERSE_STEP_OFFSET UNITYSDK_OFFSET(0x1C4D3800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ARRAYEXTENSIONS_ARRAYTRAVERSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4D35D0)

namespace UnityEngine::Rendering::Universal::Internal::ArrayExtensions
{
	inline static constexpr unsigned int ArrayTraverse_TypeDefinitionIndex = 27895;
