...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x1BDBE2A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1BDBE400)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1BDBE310)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1BDBE570)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1BDBE4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDBE290)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_GlobalSetter_TypeDefinitionIndex = 27337;
