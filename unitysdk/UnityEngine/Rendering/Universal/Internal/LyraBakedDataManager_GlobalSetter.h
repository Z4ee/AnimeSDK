...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x1CEF90B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1CEF9210)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1CEF9120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1CEF9380)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1CEF9300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF90A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_GlobalSetter_TypeDefinitionIndex = 26911;
