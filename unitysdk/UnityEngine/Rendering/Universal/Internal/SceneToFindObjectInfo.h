...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENETOFINDOBJECTINFO_GET_ENABLEPASS_OFFSET UNITYSDK_OFFSET(0x19B92460)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENETOFINDOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19B92490)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int SceneToFindObjectInfo_TypeDefinitionIndex = 30538;
