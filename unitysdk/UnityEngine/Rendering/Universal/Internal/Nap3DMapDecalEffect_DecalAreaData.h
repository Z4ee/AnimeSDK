...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAP3DMAPDECALEFFECT_DECALAREADATA_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1B7F7B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAP3DMAPDECALEFFECT_DECALAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F7BF0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int Nap3DMapDecalEffect_DecalAreaData_TypeDefinitionIndex = 26994;
