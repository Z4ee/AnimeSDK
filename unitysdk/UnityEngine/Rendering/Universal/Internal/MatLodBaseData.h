...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_1_OFFSET UNITYSDK_OFFSET(0x1928B280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_2_OFFSET UNITYSDK_OFFSET(0x1928AF40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x1928B090)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x1928AB10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_FORCELOD_1_OFFSET UNITYSDK_OFFSET(0x1928B510)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_FORCELOD_OFFSET UNITYSDK_OFFSET(0x1928B320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_GET_M_LODDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1928AAB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_GET_M_LODDISTANCE_OFFSET UNITYSDK_OFFSET(0x1928AA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_RECALCULATELODDISTANCE_OFFSET UNITYSDK_OFFSET(0x1928AAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_SET_M_LODDISTANCE_OFFSET UNITYSDK_OFFSET(0x1928AA50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_UPDATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x1928ABA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_UPDATEMATERIALLOD_OFFSET UNITYSDK_OFFSET(0x1928AC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1928B5C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int MatLodBaseData_TypeDefinitionIndex = 30448;
