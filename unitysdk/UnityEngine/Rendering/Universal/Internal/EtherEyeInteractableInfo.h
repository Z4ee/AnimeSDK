...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEINFO_GET_ENABLEPASS_OFFSET UNITYSDK_OFFSET(0x1DDF90B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDF90E0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int EtherEyeInteractableInfo_TypeDefinitionIndex = 27421;
	...
	public:
		...
		// static const ::System::Int32 RenderPassIndexBeforeDeferredShadingPass = 0x1; // 0x0
