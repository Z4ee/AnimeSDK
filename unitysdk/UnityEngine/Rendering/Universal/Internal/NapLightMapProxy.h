...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B07DDA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY_SETLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x1B07DA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07DDF0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapProxy_TypeDefinitionIndex = 26219;
