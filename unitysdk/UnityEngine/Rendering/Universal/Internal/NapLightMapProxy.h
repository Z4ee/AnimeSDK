...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19110E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY_SETLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x19110B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x19110ED0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapProxy_TypeDefinitionIndex = 30388;
