...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWUTIL_COMPUTEPOINTSHADOWMATRICES_OFFSET UNITYSDK_OFFSET(0x1B073CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWUTIL_COMPUTESPOTSHADOWMATRICES_OFFSET UNITYSDK_OFFSET(0x1B074300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWUTIL_GETNEARPLANEMINBOUND_OFFSET UNITYSDK_OFFSET(0x1B073890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWUTIL_GETPOINTLIGHTSHADOWFRUSTUMFOVBIASINDEGREES_OFFSET UNITYSDK_OFFSET(0x1B0738F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWUTIL_GETSHADOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B073A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_BAKEDPOINTSHADOWUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0746A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int BakedPointShadowUtil_TypeDefinitionIndex = 26358;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(BakedPointShadowUtil_TypeDefinitionIndex)->GetStaticField(0x21C00);
		}
