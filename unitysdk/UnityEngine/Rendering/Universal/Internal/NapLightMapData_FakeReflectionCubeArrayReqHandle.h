...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_FAKEREFLECTIONCUBEARRAYREQHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B07DA30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_FAKEREFLECTIONCUBEARRAYREQHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07DA20)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapData_FakeReflectionCubeArrayReqHandle_TypeDefinitionIndex = 26865;
