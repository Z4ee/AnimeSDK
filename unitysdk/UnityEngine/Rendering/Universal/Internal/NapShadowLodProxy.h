...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C409F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C409CB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1C409F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C40A150)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapShadowLodProxy_TypeDefinitionIndex = 26820;
