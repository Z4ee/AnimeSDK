...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D6E9140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D6E8EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1D6E91C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E9390)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapShadowLodProxy_TypeDefinitionIndex = 27089;
