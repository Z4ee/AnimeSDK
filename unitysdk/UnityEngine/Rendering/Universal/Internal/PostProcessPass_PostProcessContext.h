...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_CREATETEMPTARGET3_OFFSET UNITYSDK_OFFSET(0x965F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_DISPOSECONTEXT_OFFSET UNITYSDK_OFFSET(0x965F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_GETCURRENTSOURCE_OFFSET UNITYSDK_OFFSET(0x965C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_GETDESTINATION_OFFSET UNITYSDK_OFFSET(0x966170)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x965CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_INITCONTEXT_OFFSET UNITYSDK_OFFSET(0x965C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_RELEASERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x965DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_SETTAARESULT_OFFSET UNITYSDK_OFFSET(0x9660C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_SWAP_OFFSET UNITYSDK_OFFSET(0x965F90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_PostProcessContext_TypeDefinitionIndex = 30524;
