...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_CLEARFOOTPRINTDATA_OFFSET UNITYSDK_OFFSET(0x18FE87C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GENERATEWHEELMESH_OFFSET UNITYSDK_OFFSET(0x18FEA4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GET_INSTANCEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18FE83F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GET_MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x18FE8400)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_INITWHEELDATA_OFFSET UNITYSDK_OFFSET(0x18FE8C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18FE8A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x18FE9380)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18FE8950)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x18FE8B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_REMOVEWHEELDATA_OFFSET UNITYSDK_OFFSET(0x18FE8810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_RESETWHEELDATAARRAY_OFFSET UNITYSDK_OFFSET(0x18FEA3E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SETREADYTOSPAWN_OFFSET UNITYSDK_OFFSET(0x18FE8420)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SET_MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x18FE8410)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0x18FE8EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_TICKFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x18FE98D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_TICKWHEELPRINT_OFFSET UNITYSDK_OFFSET(0x18FEA070)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEB780)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintSpawner_TypeDefinitionIndex = 30499;
