...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1BC57120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1BC57440)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1BC573D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC57000)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1BC57930)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1BC57940)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DrawFootPrintPass_TypeDefinitionIndex = 26906;
