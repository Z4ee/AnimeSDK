...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1AF50560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AF50880)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AF50810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF50440)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1AF50DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AF50DF0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DrawFootPrintPass_TypeDefinitionIndex = 27279;
