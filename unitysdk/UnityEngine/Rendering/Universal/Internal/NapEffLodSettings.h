...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D6E6990)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D6E64D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1D6E66E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1D6E68B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E6A10)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapEffLodSettings_TypeDefinitionIndex = 27791;
