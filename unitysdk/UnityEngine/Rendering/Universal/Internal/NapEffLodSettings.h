...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD08690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD081D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1AD083E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1AD085B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD08710)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapEffLodSettings_TypeDefinitionIndex = 30442;
