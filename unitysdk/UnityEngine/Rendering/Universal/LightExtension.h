...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_CALCULATELIGHTMATRIX_OFFSET UNITYSDK_OFFSET(0x1D30EBB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1D30EA20)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1D30EAE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightExtension_TypeDefinitionIndex = 27727;
