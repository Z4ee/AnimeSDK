...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_CALCULATELIGHTMATRIX_OFFSET UNITYSDK_OFFSET(0x1C14F5B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1C14F420)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1C14F4E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightExtension_TypeDefinitionIndex = 27289;
