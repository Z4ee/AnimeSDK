...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIPOSTPROCESSDATA_MARKTEXTURECURVEASDIRTY_OFFSET UNITYSDK_OFFSET(0x1C1506F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIPOSTPROCESSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C150890)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIPostProcessData_TypeDefinitionIndex = 26889;
