...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BC65F50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1BC65ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BC65F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC65F70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_AntiFlickerModeParameter_TypeDefinitionIndex = 27626;
