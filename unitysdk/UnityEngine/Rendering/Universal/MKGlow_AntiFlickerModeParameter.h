...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF5F050)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1AF5EFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF5F060)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF5F070)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_AntiFlickerModeParameter_TypeDefinitionIndex = 27103;
