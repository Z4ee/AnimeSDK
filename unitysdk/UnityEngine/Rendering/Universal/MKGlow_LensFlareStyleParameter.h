...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1ABA7400)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1ABA7380)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1ABA7410)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA7420)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_LensFlareStyleParameter_TypeDefinitionIndex = 30049;
