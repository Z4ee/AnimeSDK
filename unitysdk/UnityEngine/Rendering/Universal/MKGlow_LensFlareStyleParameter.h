...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CF0A1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1CF0A160)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CF0A1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LENSFLARESTYLEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0A200)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_LensFlareStyleParameter_TypeDefinitionIndex = 27100;
