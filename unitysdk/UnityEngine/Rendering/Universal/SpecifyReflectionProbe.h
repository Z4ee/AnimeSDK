...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19AC6830)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19AC6650)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19AC6330)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC69C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SpecifyReflectionProbe_TypeDefinitionIndex = 29895;
