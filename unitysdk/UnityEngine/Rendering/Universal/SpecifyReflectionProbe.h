...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CF096C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CF094E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CF091C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF09850)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SpecifyReflectionProbe_TypeDefinitionIndex = 27596;
