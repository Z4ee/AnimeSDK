...
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_GETGAMEOBJECTVALUE_OFFSET UNITYSDK_OFFSET(0x1C51DDA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_GETPATH_OFFSET UNITYSDK_OFFSET(0x1C51DAB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C51D940)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_LOAD_OFFSET UNITYSDK_OFFSET(0x1C51D880)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_SAVE_OFFSET UNITYSDK_OFFSET(0x1C51D590)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C51D5E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C51DE70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RedirectObject_TypeDefinitionIndex = 27755;
