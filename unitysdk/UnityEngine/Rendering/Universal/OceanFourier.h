...
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_BITREVERSE_OFFSET UNITYSDK_OFFSET(0x19BA0180)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_COMPUTEBUTTERFLYLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x19B9F9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_DISPERSION_OFFSET UNITYSDK_OFFSET(0x19B9FEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_EVALUATEWAVESFFT_OFFSET UNITYSDK_OFFSET(0x19BA1810)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_FFT_1_OFFSET UNITYSDK_OFFSET(0x19BA0330)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_FFT_OFFSET UNITYSDK_OFFSET(0x19BA0210)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_GAUSSIANRANDOMVARIABLE_OFFSET UNITYSDK_OFFSET(0x19BA1330)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_GETSPECTRUM_OFFSET UNITYSDK_OFFSET(0x19B9FFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_INITSPECTRUM_OFFSET UNITYSDK_OFFSET(0x19BA1680)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_PEFORMFFT_OFFSET UNITYSDK_OFFSET(0x19BA0400)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_PHILLIPSSPECTRUM_OFFSET UNITYSDK_OFFSET(0x19BA1440)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x19BA2380)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER_SETDATA_OFFSET UNITYSDK_OFFSET(0x19B9E9E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFOURIER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA2440)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OceanFourier_TypeDefinitionIndex = 29934;

	class OceanFourier : public ::System::Object
	{
	public:
		// static const ::System::Single GRAVITY; // 0x0
		::Il2CppArray<::UnityEngine::Vector3>* m_originPosition; // 0x10
		::Il2CppArray<::UnityEngine::Vector4>* m_slopeBuffer; // 0x18
		::Il2CppArray<::UnityEngine::Vector4>* m_displacementBuffer; // 0x20
		::Il2CppArray<::UnityEngine::Vector3>* m_vertices; // 0x28
		::Il2CppArray<::System::Single>* m_dispersionTable; // 0x30
		::Il2CppArray<::System::Single>* m_jacobian; // 0x38
		::Il2CppArray<::UnityEngine::Vector3>* m_normals; // 0x40
		::Il2CppArray<::UnityEngine::Vector2>* m_heightBuffer; // 0x48
		::Il2CppArray<::UnityEngine::Vector3>* m_positionOffset; // 0x50
		::Il2CppArray<::System::Single>* m_butterflyLookupTable; // 0x58
		::Il2CppArray<::UnityEngine::Vector2>* m_spectrum; // 0x60
		::Il2CppArray<::UnityEngine::Vector2>* m_spectrum_conj; // 0x68
		::System::Single m_fsize; // 0x70
		::System::Single m_windSpeed; // 0x74
		::System::Int32 m_passes; // 0x78
		::UnityEngine::Vector2 m_windDir; // 0x7C
		::System::Single m_waveAmp; // 0x84
		::System::Int32 m_size; // 0x88
