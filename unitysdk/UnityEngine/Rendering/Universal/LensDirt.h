...
#define UNITYENGINE_RENDERING_UNIVERSAL_LENSDIRT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F333A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LensDirt_TypeDefinitionIndex = 30128;
