...
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19B83FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19B84150)
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B84730)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int AmplifyOcclusionPass_NotNative_HistoryBuffer_TypeDefinitionIndex = 30187;
