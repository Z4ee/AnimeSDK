...
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C993060)
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1C993200)
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9937D0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int AmplifyOcclusionPass_NotNative_HistoryBuffer_TypeDefinitionIndex = 27029;
