...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSCULLINGCONFIG_GET_CULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AF4F900)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSCULLINGCONFIG_SET_CULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AF4F910)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSCULLINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4F920)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassCullingConfig_TypeDefinitionIndex = 26403;
