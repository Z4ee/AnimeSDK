...
#define UNITYENGINE_RENDERING_UNIVERSAL_GERSTNERWAVESJOBS_HEIGHTJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x90DA20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GerstnerWavesJobs_HeightJob_TypeDefinitionIndex = 27248;
