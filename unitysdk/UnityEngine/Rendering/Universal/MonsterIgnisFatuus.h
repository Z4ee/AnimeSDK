...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONSTERIGNISFATUUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B089B10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonsterIgnisFatuus_TypeDefinitionIndex = 30137;
