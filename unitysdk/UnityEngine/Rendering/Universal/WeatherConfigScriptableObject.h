...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x1D3E7830)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x1D3E7870)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D3E7850)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x1D3E7890)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x1D3E7840)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x1D3E7880)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D3E7860)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x1D3E78A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E78B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigScriptableObject_TypeDefinitionIndex = 27288;
