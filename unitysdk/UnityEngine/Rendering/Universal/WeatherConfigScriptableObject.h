...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x1B08EEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x1B08EF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B08EF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x1B08EF40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x1B08EEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x1B08EF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B08EF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x1B08EF50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08EF60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigScriptableObject_TypeDefinitionIndex = 29988;
