...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF5F190)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1AF5F100)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF5F1A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF5F1B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_MinMaxRangeParameter_TypeDefinitionIndex = 27102;
