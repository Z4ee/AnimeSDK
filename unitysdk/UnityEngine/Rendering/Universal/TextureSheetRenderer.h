...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B0BF610)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1B0BDE70)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_GET_M_SHEETCONFIG_OFFSET UNITYSDK_OFFSET(0x1B0BC490)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_IGNORESETFXCONFIGS_OFFSET UNITYSDK_OFFSET(0x1B0BDE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B0BD6B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B0BD8F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B0BC4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B0BDD50)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_PLAY_OFFSET UNITYSDK_OFFSET(0x1B0BD100)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_REFRESHORDER_OFFSET UNITYSDK_OFFSET(0x1B0BD9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_RESUME_OFFSET UNITYSDK_OFFSET(0x1B0BDDA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETFXCONFIGS_OFFSET UNITYSDK_OFFSET(0x1B0BE030)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETORDER_OFFSET UNITYSDK_OFFSET(0x1B0BD960)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETSPRITERENDER_OFFSET UNITYSDK_OFFSET(0x1B0BC740)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETTEXTUREANDTILES_OFFSET UNITYSDK_OFFSET(0x1B0BDB50)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_STOP_OFFSET UNITYSDK_OFFSET(0x1B0BDDF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_TICKFRAMERATEINDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B0BF140)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_TICK_OFFSET UNITYSDK_OFFSET(0x1B0BD1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BD180)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF770)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetRenderer_TypeDefinitionIndex = 27226;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(TextureSheetRenderer_TypeDefinitionIndex)->GetStaticField(0x21CA0);
		}
