...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCONTACTSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC3000)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapContactShadow_TypeDefinitionIndex = 26488;
