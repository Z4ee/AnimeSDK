...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CLEANOCEANMATERIAL_OFFSET UNITYSDK_OFFSET(0x1BC38300)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CLEANUPMATERIALS_OFFSET UNITYSDK_OFFSET(0x1BC397E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1BC39850)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CREATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x1BC38E00)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_DRAWSTATICWATER_OFFSET UNITYSDK_OFFSET(0x1BC385C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_DRAWUNDERWATERDEPTH_OFFSET UNITYSDK_OFFSET(0x1BC392E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_DRAWWATER_OFFSET UNITYSDK_OFFSET(0x1BC38BC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GETWATERMESHSTATSREF_OFFSET UNITYSDK_OFFSET(0x1BC29780)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_ENABLEDEBUGCENTER_OFFSET UNITYSDK_OFFSET(0x1BC38230)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_ENABLEFRUSTUMCULL_OFFSET UNITYSDK_OFFSET(0x1BC38210)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1BC295A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_MESHSTATS_OFFSET UNITYSDK_OFFSET(0x1BC37CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_NEEDBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x1BC38270)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1BC38290)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_PREVIEWBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x1BC38250)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_STATICWATERLOWMESH_OFFSET UNITYSDK_OFFSET(0x1BC385A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_STATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x1BC38580)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERGENON_OFFSET UNITYSDK_OFFSET(0x1BC2A9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERGENQUALITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1BC30CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERMATERIALFARLOD_OFFSET UNITYSDK_OFFSET(0x1BC2BF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERMATERIALNEARLOD_OFFSET UNITYSDK_OFFSET(0x1BC2C330)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERMATERIALNORMALLOD_OFFSET UNITYSDK_OFFSET(0x1BC2BB10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_INIT_OFFSET UNITYSDK_OFFSET(0x1BC381D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_LOADSTATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x1BC37E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_ENABLEDEBUGCENTER_OFFSET UNITYSDK_OFFSET(0x1BC38240)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_ENABLEFRUSTUMCULL_OFFSET UNITYSDK_OFFSET(0x1BC38220)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_MESHSTATS_OFFSET UNITYSDK_OFFSET(0x1BC37D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_NEEDBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x1BC38280)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_PREVIEWBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x1BC38260)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_STATICWATERLOWMESH_OFFSET UNITYSDK_OFFSET(0x1BC385B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_STATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x1BC38590)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_UNLOADSTATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x1BC38060)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BC30830)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC398F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC37D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__LOADSTATICWATERMESH_B__14_0_OFFSET UNITYSDK_OFFSET(0x1BC39A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__LOADSTATICWATERMESH_B__14_1_OFFSET UNITYSDK_OFFSET(0x1BC39A60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterGen_TypeDefinitionIndex = 26763;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::WaterGen**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21B10);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Single>** StaticGet_WaterGenNodeEvalC()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21B18);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>** StaticGet_WaterGenEnable()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21B20);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>** StaticGet_ShowWaterMeshStats()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21B28);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>** StaticGet_EnableRTXGI()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21B30);
		}
		::UnityEngine::Rendering::Universal::WaterGen_WaterMeshStats m_MeshStats; // 0x10
		::UnityEngine::Mesh* m_staticWaterMesh; // 0x58
		::Foundation::AssetRequestHandle m_StaticMeshAssetHandle; // 0x60
		::UnityEngine::Mesh* depthQuadMesh; // 0x80
		::Foundation::AssetRequestHandle m_StaticLowMeshAssetHandle; // 0x88
		::UnityEngine::Material* m_WaterMaterialNormalLOD; // 0xA8
		::UnityEngine::Mesh* m_staticWaterLowMesh; // 0xB0
		::UnityEngine::Material* m_WaterMaterialNearLOD; // 0xB8
		::UnityEngine::Material* m_WaterMaterialFarLOD; // 0xC0
		::UnityEngine::Matrix4x4 depthQuadWorldMatrix; // 0xC8
		::System::Boolean m_NeedBakedMesh; // 0x108
		::System::Boolean m_PreviewBakedMesh; // 0x109
		::System::Boolean m_EnableFrustumCull; // 0x10A
		::System::Boolean m_EnableDebugCenter; // 0x10B
		::UnityEngine::Rendering::Universal::EWaterGenQuality m_LastWaterGenQualityLevel; // 0x10C
		::UnityEngine::Vector3 DebugCenter; // 0x110
