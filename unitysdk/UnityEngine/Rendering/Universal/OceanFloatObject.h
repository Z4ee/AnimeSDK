...
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_GET_INITPOSITION_OFFSET UNITYSDK_OFFSET(0x1D3E4150)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_GET_INITROTATION_OFFSET UNITYSDK_OFFSET(0x1D3E4170)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D3E4610)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D3E4180)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_RESETPOSANDROT_OFFSET UNITYSDK_OFFSET(0x1D3E46D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_SETINITPOSROT_OFFSET UNITYSDK_OFFSET(0x1D3E4460)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D3E4770)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E4880)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OceanFloatObject_TypeDefinitionIndex = 27272;
