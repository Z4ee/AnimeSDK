...
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_GET_INITPOSITION_OFFSET UNITYSDK_OFFSET(0x1E7A0CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_GET_INITROTATION_OFFSET UNITYSDK_OFFSET(0x1E7A0CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E7A1130)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E7A0CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_RESETPOSANDROT_OFFSET UNITYSDK_OFFSET(0x1E7A11F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_SETINITPOSROT_OFFSET UNITYSDK_OFFSET(0x1E7A0F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E7A1290)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A13A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OceanFloatObject_TypeDefinitionIndex = 27720;
