...
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C44E000)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_ONGUI_OFFSET UNITYSDK_OFFSET(0x1C44EC30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RAZCOUNTERS_OFFSET UNITYSDK_OFFSET(0x1C44E6E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RESETSTATS_OFFSET UNITYSDK_OFFSET(0x1C44E610)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_TOGGLESTATS_OFFSET UNITYSDK_OFFSET(0x1C44E760)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C44E7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C44EE20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SRPBatcherProfiler_TypeDefinitionIndex = 26210;
