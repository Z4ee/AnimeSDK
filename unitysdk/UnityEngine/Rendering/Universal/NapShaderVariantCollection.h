...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION_ADDSHADERVARIANT_OFFSET UNITYSDK_OFFSET(0x1C9A2290)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1C9A2190)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9A23F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapShaderVariantCollection_TypeDefinitionIndex = 26352;
