...
#define UNITYENGINE_RENDERING_UNIVERSAL_VISUALENVIRONMENTE_WEATHERCONFIGOVERRIDEDATA_GETISVALID_OFFSET UNITYSDK_OFFSET(0x1C9BF780)
#define UNITYENGINE_RENDERING_UNIVERSAL_VISUALENVIRONMENTE_WEATHERCONFIGOVERRIDEDATA_SETISVALID_OFFSET UNITYSDK_OFFSET(0x1C9BF730)
#define UNITYENGINE_RENDERING_UNIVERSAL_VISUALENVIRONMENTE_WEATHERCONFIGOVERRIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9BF7C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VisualEnvironmentE_WeatherConfigOverrideData_TypeDefinitionIndex = 26499;
