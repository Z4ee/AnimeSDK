...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERADDITIONALDATASYN_DOSYNWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1F82A150)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERADDITIONALDATASYN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F82A080)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERADDITIONALDATASYN__CTOR_OFFSET UNITYSDK_OFFSET(0x1F82A3C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherAdditionalDataSyn_TypeDefinitionIndex = 27818;
