...
#define UNITYENGINE_RENDERING_UNIVERSAL_PARTIALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18FFDAA0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PartialBlur_TypeDefinitionIndex = 30151;
