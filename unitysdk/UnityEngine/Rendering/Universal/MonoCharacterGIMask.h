...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_1_OFFSET UNITYSDK_OFFSET(0x1AD0C920)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_OFFSET UNITYSDK_OFFSET(0x1AD0BE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_1_OFFSET UNITYSDK_OFFSET(0x1AD0CB10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_OFFSET UNITYSDK_OFFSET(0x1AD0C750)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_FILTER_OFFSET UNITYSDK_OFFSET(0x1AD0CD00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_GET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD0BE10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1AD0C7E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_SET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD0BE30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0D1C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoCharacterGIMask_TypeDefinitionIndex = 30053;
