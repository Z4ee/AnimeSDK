...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_1_OFFSET UNITYSDK_OFFSET(0x1C40BA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_OFFSET UNITYSDK_OFFSET(0x1C40AF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_1_OFFSET UNITYSDK_OFFSET(0x1C40BC00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_OFFSET UNITYSDK_OFFSET(0x1C40B840)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_FILTER_OFFSET UNITYSDK_OFFSET(0x1C40BDF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_GET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C40AF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1C40B8D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_SET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C40AF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C40C2B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoCharacterGIMask_TypeDefinitionIndex = 26220;
