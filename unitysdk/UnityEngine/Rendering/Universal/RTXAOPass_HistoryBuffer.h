...
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELEASERT_OFFSET UNITYSDK_OFFSET(0x1CEFEF80)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CEFEF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1CEFF0F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELOCATERT_OFFSET UNITYSDK_OFFSET(0x1CEFF330)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEFF670)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RTXAOPass_HistoryBuffer_TypeDefinitionIndex = 26839;

	class RTXAOPass_HistoryBuffer : public ::System::Object
	{
	public:
		::UnityEngine::RenderTexture* hisRT; // 0x10
		::UnityEngine::RenderTexture* depthRT; // 0x18
		::UnityEngine::RenderTexture* normalRT; // 0x20
		::UnityEngine::Matrix4x4 previousVP; // 0x28
		::System::UInt32 frameIndex; // 0x68
