...
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELEASERT_OFFSET UNITYSDK_OFFSET(0x19ABB470)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19ABB410)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19ABB5E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELOCATERT_OFFSET UNITYSDK_OFFSET(0x19ABB820)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABBB60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RTXAOPass_HistoryBuffer_TypeDefinitionIndex = 30214;
