...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x196B2CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x196B2D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GENERATEFOGMESH_OFFSET UNITYSDK_OFFSET(0x196B4DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GETCUBEVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x196B61A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x196B6100)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x196B3F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x196B6220)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196B39C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x196B4050)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x196B69B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG___BASE_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x196B69D0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricFog_TypeDefinitionIndex = 29922;
