...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B81F690)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1B81F720)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GENERATEFOGMESH_OFFSET UNITYSDK_OFFSET(0x1B821790)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GETCUBEVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x1B822B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B822AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B8208E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1B822BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B820390)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B820A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B823380)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG___BASE_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1B8233A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricFog_TypeDefinitionIndex = 26584;
