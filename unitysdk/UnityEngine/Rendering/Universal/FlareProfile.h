...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A696F60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FlareProfile_TypeDefinitionIndex = 30125;
