...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B870E10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FlareProfile_TypeDefinitionIndex = 26913;
