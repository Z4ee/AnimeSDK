...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPSULEAOLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B36D670)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCapsuleAOLighting_TypeDefinitionIndex = 30146;
