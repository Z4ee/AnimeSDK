...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPRENDERCONTEXT_CURRENTFRAMERENDERCONFIGS_INITIALIZECONFIGS_OFFSET UNITYSDK_OFFSET(0x1AD15B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPRENDERCONTEXT_CURRENTFRAMERENDERCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD15E70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapRenderContext_CurrentFrameRenderConfigs_TypeDefinitionIndex = 29999;

	class NapRenderContext_CurrentFrameRenderConfigs : public ::System::Object
	{
	public:
		::UnityEngine::Rendering::Universal::FXColorCorrection* fxColorCorrection; // 0x10
		::UnityEngine::Rendering::Universal::FXFog* fxFog; // 0x18
		::UnityEngine::Rendering::Universal::ColorAdjustments* colorAdjustments; // 0x20
		::WeatherConfig* weatherConfig; // 0x28
		::UnityEngine::Rendering::Universal::Distortion* distortion; // 0x30
		::UnityEngine::Rendering::Universal::VREffects* vrEffects; // 0x38
		::UnityEngine::Rendering::Universal::AmplifyOcclusion* amplifyOcclusion; // 0x40
		::UnityEngine::Rendering::Universal::CharacterIgnisFatuus* characterIgnisFatuus; // 0x48
		::UnityEngine::Rendering::Universal::MonsterIgnisFatuus* monsterIgnisFatuus; // 0x50
		::UnityEngine::Rendering::Universal::NapBloom* napBloom; // 0x58
		::UnityEngine::Rendering::Universal::MKGlow* mkGlow; // 0x60
		::UnityEngine::Rendering::Universal::ScreenEffects* screenEffects; // 0x68
		::UnityEngine::Rendering::Universal::UniversalRenderPipelineAsset* globalSettings; // 0x70
