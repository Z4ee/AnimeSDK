...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_APPLYMOBILEPROFILECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1D6FCB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_CONVERTTORESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x1D6FDD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_COPYPROFILEPARAMS_OFFSET UNITYSDK_OFFSET(0x1D6FCC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_ENSURERUNTIMETEXTURES_OFFSET UNITYSDK_OFFSET(0x1D6FD330)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GETCLOUDQUALITY_OFFSET UNITYSDK_OFFSET(0x1D6FCE60)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GETPROFILE_OFFSET UNITYSDK_OFFSET(0x1D6FC9E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GET_HASRUNTIMENOISE_OFFSET UNITYSDK_OFFSET(0x1D6FD220)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GET_HASRUNTIMEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D6FCFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GET_RUNTIMEVOLUMETRICCLOUDMODELDATA_OFFSET UNITYSDK_OFFSET(0x1D6FCFB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GET_RUNTIMEVOLUMETRICCLOUDNOISE_OFFSET UNITYSDK_OFFSET(0x1D6FCFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_GET_RUNTIMEVOLUMETRICCLOUDSDF_OFFSET UNITYSDK_OFFSET(0x1D6FCFC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_LOADTEXTURE2D_OFFSET UNITYSDK_OFFSET(0x1D6FD5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_LOADTEXTURE3D_OFFSET UNITYSDK_OFFSET(0x1D6FD720)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D6FDEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D6FCCE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_RELEASERUNTIMETEXTURES_OFFSET UNITYSDK_OFFSET(0x1D6FD560)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_RELEASETEXTURE2D_OFFSET UNITYSDK_OFFSET(0x1D6FD850)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_RELEASETEXTURE3D_OFFSET UNITYSDK_OFFSET(0x1D6FDAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG_SHOULDLOADRUNTIMETEXTURES_OFFSET UNITYSDK_OFFSET(0x1D6FD510)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6FE3C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICCLOUDV2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6FDFA0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricCloudV2Config_TypeDefinitionIndex = 26907;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::VolumetricCloudV2Config_VolumetricCloudPerformanceProfile**)Il2CppClass::FromTypeDefinitionIndex(VolumetricCloudV2Config_TypeDefinitionIndex)->GetStaticField(0x237B0);
		}
		static ::UnityEngine::Rendering::Universal::VolumetricCloudV2Quality* StaticGet_previewQuality()
		{
			return (::UnityEngine::Rendering::Universal::VolumetricCloudV2Quality*)Il2CppClass::FromTypeDefinitionIndex(VolumetricCloudV2Config_TypeDefinitionIndex)->GetStaticField(0x6F50);
		}
		static ::System::Boolean* StaticGet_previewMode()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(VolumetricCloudV2Config_TypeDefinitionIndex)->GetStaticField(0x6F54);
		}
