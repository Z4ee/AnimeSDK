...
#define UNITYENGINE_RENDERING_UNIVERSAL_HQBLOOMMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEEC810)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int HQBloomModeParameter_TypeDefinitionIndex = 26842;
