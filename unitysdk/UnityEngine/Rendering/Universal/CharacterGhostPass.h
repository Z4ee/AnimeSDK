...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_DOCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x1C144100)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C143F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1C1451D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_GETCHARACTERGHOSTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C1452B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_ISPASSREADY_OFFSET UNITYSDK_OFFSET(0x1C143B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_SETUPCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x1C1450D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1C143F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C143E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1C145470)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CharacterGhostPass_TypeDefinitionIndex = 26987;
