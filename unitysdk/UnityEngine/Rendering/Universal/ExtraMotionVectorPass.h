...
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D4D9000)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D4D9C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_GET_MAT_OFFSET UNITYSDK_OFFSET(0x1D4D8E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4D9D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D8EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D4D9D40)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ExtraMotionVectorPass_TypeDefinitionIndex = 26546;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ExtraMotionVectorPass_TypeDefinitionIndex)->GetStaticField(0x7010);
		}
