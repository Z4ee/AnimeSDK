...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEYWITHDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x19F387E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEYWITHOUTDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x19F37D10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEY_OFFSET UNITYSDK_OFFSET(0x19F37F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ISKEYEXISTS_OFFSET UNITYSDK_OFFSET(0x19F37D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONCLEARCACHE_OFFSET UNITYSDK_OFFSET(0x19F38EC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19F38F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x19F38850)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F38B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F38F60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherGroupScriptableObject_TypeDefinitionIndex = 29989;
