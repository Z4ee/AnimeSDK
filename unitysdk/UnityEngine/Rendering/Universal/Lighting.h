...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTING_INITNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1E66AE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E66A220)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int Lighting_TypeDefinitionIndex = 27136;
