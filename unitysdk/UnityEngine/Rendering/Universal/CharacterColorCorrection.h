...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A6965D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A696CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION__ONENABLE_G__COPYVALUEIFSKINVALUEISDEFAULT_8_0_OFFSET UNITYSDK_OFFSET(0x1A696C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A696F50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CharacterColorCorrection_TypeDefinitionIndex = 30106;
