...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B870480)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B870B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION__ONENABLE_G__COPYVALUEIFSKINVALUEISDEFAULT_8_0_OFFSET UNITYSDK_OFFSET(0x1B870AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERCOLORCORRECTION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B870E00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CharacterColorCorrection_TypeDefinitionIndex = 26315;
