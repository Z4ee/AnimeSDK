...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDCONST_GET_ISRTXONLYLIGHT_OFFSET UNITYSDK_OFFSET(0x90DA50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightLodManager_UniversalAdditionalLightDataUnmanagedConst_TypeDefinitionIndex = 27541;
