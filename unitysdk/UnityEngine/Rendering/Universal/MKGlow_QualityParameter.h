...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_QUALITYPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B1A0D70)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_QUALITYPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B1A0CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_QUALITYPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B1A0D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_QUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A0BD0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_QualityParameter_TypeDefinitionIndex = 27107;
