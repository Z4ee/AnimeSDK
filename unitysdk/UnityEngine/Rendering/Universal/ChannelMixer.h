...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHANNELMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC17B00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ChannelMixer_TypeDefinitionIndex = 26726;
