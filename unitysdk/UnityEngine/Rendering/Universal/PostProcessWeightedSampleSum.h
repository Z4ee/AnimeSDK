...
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_ADDGAUSSIANBLURPASS_1_OFFSET UNITYSDK_OFFSET(0x19149300)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_ADDGAUSSIANBLURPASS_OFFSET UNITYSDK_OFFSET(0x1914ADE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_COMPUTE1DGAUSSIANFILTERKERNEL_OFFSET UNITYSDK_OFFSET(0x1914A900)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETBLURRADIUS_OFFSET UNITYSDK_OFFSET(0x1914A660)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETCLAMPEDKERNELRADIUS_OFFSET UNITYSDK_OFFSET(0x1914A790)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETINTEGERKERNELRADIUS_OFFSET UNITYSDK_OFFSET(0x1914A800)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETSAMPLECOUNTMAX_OFFSET UNITYSDK_OFFSET(0x1914A6D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_NORMALDISTRIBUTIONUNSCALED_OFFSET UNITYSDK_OFFSET(0x1914A540)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1914B240)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PostProcessWeightedSampleSum_TypeDefinitionIndex = 30249;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x24450);
		}
		static ::Il2CppArray<::UnityEngine::Vector2>** StaticGet_OffsetAndWeight()
		{
			return (::Il2CppArray<::UnityEngine::Vector2>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x24458);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>** StaticGet_SampleWeights()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x24460);
		}
