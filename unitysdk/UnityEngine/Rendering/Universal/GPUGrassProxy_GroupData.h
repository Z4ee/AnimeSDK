...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_ADDTOLIST_1_OFFSET UNITYSDK_OFFSET(0x1BC211E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_ADDTOLIST_OFFSET UNITYSDK_OFFSET(0x1BC21080)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_CHECKFRUSTUMVISIBLEFORL2GROUP_OFFSET UNITYSDK_OFFSET(0x1BC215A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_CHECKGROUPVISIBLE_OFFSET UNITYSDK_OFFSET(0x1BC21690)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_EXTENDBOUND_OFFSET UNITYSDK_OFFSET(0x1BC214A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1BC21580)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_RESETBOUNDBOX_OFFSET UNITYSDK_OFFSET(0x1BC20CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1BC21590)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC20C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA__RESETBOUNDBOX_G__EXTENTSIZE_4_0_OFFSET UNITYSDK_OFFSET(0x1BC20FD0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassProxy_GroupData_TypeDefinitionIndex = 26558;
