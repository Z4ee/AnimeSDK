...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_GET_ISINVALIDATED_OFFSET UNITYSDK_OFFSET(0x1C51DEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_GET_RENDERERFEATURES_OFFSET UNITYSDK_OFFSET(0x1C51DF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_INTERNALCREATERENDERER_OFFSET UNITYSDK_OFFSET(0x1C51DF50)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C51E050)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C51DFF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1C51DF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_SET_ISINVALIDATED_OFFSET UNITYSDK_OFFSET(0x1C51DEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C51E0B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScriptableRendererData_TypeDefinitionIndex = 27838;
