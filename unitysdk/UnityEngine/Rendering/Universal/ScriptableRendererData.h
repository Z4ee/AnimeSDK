...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_GET_ISINVALIDATED_OFFSET UNITYSDK_OFFSET(0x1914CCC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_GET_RENDERERFEATURES_OFFSET UNITYSDK_OFFSET(0x1914CCE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_INTERNALCREATERENDERER_OFFSET UNITYSDK_OFFSET(0x1914CD30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1914CE30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1914CDD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1914CCF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_SET_ISINVALIDATED_OFFSET UNITYSDK_OFFSET(0x1914CCD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1914CE90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScriptableRendererData_TypeDefinitionIndex = 30224;
