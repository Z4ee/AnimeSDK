...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ADD_ONWILLRENDERCAMERA_OFFSET UNITYSDK_OFFSET(0x1A6F7B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_AFMEENABLEOFFSCREENUI_OFFSET UNITYSDK_OFFSET(0x1A7106E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_AREPOSTPROCESSESENABLED_OFFSET UNITYSDK_OFFSET(0x1A70D4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CHECKHISTORYDATA_OFFSET UNITYSDK_OFFSET(0x1A70A420)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CLEARNAPTIME_OFFSET UNITYSDK_OFFSET(0x1A70FA30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CREATEPEROBJECTSHADOWCONFIG_OFFSET UNITYSDK_OFFSET(0x1A6FBC50)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CREATERENDERTEXTUREDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A700910)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A6FE1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETBLITMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A710290)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETCAMERAPROFILERTAG_OFFSET UNITYSDK_OFFSET(0x1A7076C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETGPUQUERYRESULT_OFFSET UNITYSDK_OFFSET(0x1A70AA90)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETINTERPOLATEDVOLUMESTACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A707A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETMAINLIGHTINDEXWITHLOCALSHADOWCACHE_OFFSET UNITYSDK_OFFSET(0x1A70F1C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETPEROBJECTLIGHTFLAGS_OFFSET UNITYSDK_OFFSET(0x1A70E2E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1A6F0B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_ENABLEGPUQUERY_OFFSET UNITYSDK_OFFSET(0x1A6F7D30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAINLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6F7A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXRENDERSCALE_OFFSET UNITYSDK_OFFSET(0x1A6F7A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXSCRIPTABLERENDERERS_OFFSET UNITYSDK_OFFSET(0x1A6F7A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXSHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x1A6F7A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXSHADOWKERNEL_OFFSET UNITYSDK_OFFSET(0x1A6F7A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MINRENDERSCALE_OFFSET UNITYSDK_OFFSET(0x1A6F7A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MINSHADOWKERNEL_OFFSET UNITYSDK_OFFSET(0x1A6F7A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_SEPARATEUIRT_OFFSET UNITYSDK_OFFSET(0x1A710870)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_S_PUNCTUALSHADOWATLASSIZESCALE_OFFSET UNITYSDK_OFFSET(0x1A6F7D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITDAMAGETEXTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1A6FB920)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEADDITIONALCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A70AC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZECAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A705FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1A70D920)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZENAPRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1A6FAD60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTCULLLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1A70F5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTCULLRENDERINGDATA_NATIVED_OFFSET UNITYSDK_OFFSET(0x1A70A080)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTCULLRENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x1A70E320)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTPROCESSINGDATA_OFFSET UNITYSDK_OFFSET(0x1A70E270)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZERENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x1A707DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZESHADOWDATA_OFFSET UNITYSDK_OFFSET(0x1A70DA70)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZESTACKEDCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A70CA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INIT_OFFSET UNITYSDK_OFFSET(0x1A6FBC10)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ISGAMECAMERA_OFFSET UNITYSDK_OFFSET(0x1A702F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ISMULTIPASSSTEREOENABLED_OFFSET UNITYSDK_OFFSET(0x1A7108D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ISSTEREOENABLED_OFFSET UNITYSDK_OFFSET(0x1A707AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_MARKCAMERAFINALTARGET_OFFSET UNITYSDK_OFFSET(0x1A702BC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_OVERRIDECAMERADATAWITHRENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x1A70D8D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_QUERYMAINLIGHTSLOW_OFFSET UNITYSDK_OFFSET(0x1A70D530)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REFRESHOPTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A6FBA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REGISTERDECALSIMPLE_OFFSET UNITYSDK_OFFSET(0x1A7102D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REGISTERVOLUMETYPES_OFFSET UNITYSDK_OFFSET(0x1A6F8950)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REMOVE_ONWILLRENDERCAMERA_OFFSET UNITYSDK_OFFSET(0x1A6F7C50)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERCAMERASTACK_OFFSET UNITYSDK_OFFSET(0x1A703120)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERCUSTOMSINGLECAMERA_OFFSET UNITYSDK_OFFSET(0x1A705AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERSINGLECAMERA_1_OFFSET UNITYSDK_OFFSET(0x1A7060B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERSINGLECAMERA_OFFSET UNITYSDK_OFFSET(0x1A7050D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDER_OFFSET UNITYSDK_OFFSET(0x1A6FEBD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RESETDECALSIMPLERENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x1A7105E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETSUPPORTEDRENDERINGFEATURES_OFFSET UNITYSDK_OFFSET(0x1A6FB8E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPNAPTIME_OFFSET UNITYSDK_OFFSET(0x1A70FAD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPPERFRAMECONSTANTS_OFFSET UNITYSDK_OFFSET(0x1A701440)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPPERFRAMESHADERCONSTANTS_OFFSET UNITYSDK_OFFSET(0x1A701D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPPERFRAMESHADERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1A702880)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1A6FDF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SET_ENABLEGPUQUERY_OFFSET UNITYSDK_OFFSET(0x1A6F7D40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SET_MAINLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6F7B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SET_S_PUNCTUALSHADOWATLASSIZESCALE_OFFSET UNITYSDK_OFFSET(0x1A6F8090)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SORTCAMERAS_OFFSET UNITYSDK_OFFSET(0x1A702B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SORTOTHERLIGHT_OFFSET UNITYSDK_OFFSET(0x1A70F790)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_TRIMUNUSEDCAMERAPROFILINGSAMPLERS_OFFSET UNITYSDK_OFFSET(0x1A701010)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_TRYSCHEDULESRPHELPER_OFFSET UNITYSDK_OFFSET(0x1A709FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_UNREGISTERDECALSIMPLE_OFFSET UNITYSDK_OFFSET(0x1A7103F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_UPDATECAMERASHADERCOMPILERSTAMPS_OFFSET UNITYSDK_OFFSET(0x1A7029F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_UPDATEVOLUMEFRAMEWORK_OFFSET UNITYSDK_OFFSET(0x1A705B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6F83C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6FA620)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__MARKCAMERAFINALTARGET_G__GETORADDADDITIONALCAMERADATA_45_1_OFFSET UNITYSDK_OFFSET(0x1A705410)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__MARKCAMERAFINALTARGET_G__MARKUIBLURSTATES_45_0_OFFSET UNITYSDK_OFFSET(0x1A705600)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE___BASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A710A50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UniversalRenderPipeline_TypeDefinitionIndex = 30260;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::System::Collections::Generic::KeyValuePair_2<::System::Single, ::System::Int32>>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E50);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Camera*, ::UnityEngine::Profiling::CustomSampler*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E58);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Light*>** StaticGet_CachedMainLight()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Light*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E60);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SamplePerObjectShadowUpdateTargets()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E68);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Material*>** StaticGet_s_DecalSimpleMaterialPool()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E70);
		}
		static ::System::Action_1<::UnityEngine::Camera*>** StaticGet_onWillRenderCamera()
		{
			return (::System::Action_1<::UnityEngine::Camera*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E78);
		}
		static ::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate** StaticGet_lightsDelegate()
		{
			return (::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E80);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int64, ::UnityEngine::Rendering::Universal::UniversalRenderPipeline_TempLightData>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E88);
		}
		static ::UnityEngine::Rendering::Unversal::SRPHelperExecuteContext** StaticGet_helperExecuteContext()
		{
			return (::UnityEngine::Rendering::Unversal::SRPHelperExecuteContext**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E90);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Camera*>** StaticGet_s_CamerasToDeleteFromSamplerCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Camera*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23E98);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::NAPRenderPipeline0::NativeAdditionalLightData_NativeSRP*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23EA0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleGetMainLightIndexWithLocalShadowCache()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23EA8);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleUpdateVolumeFramework()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23EB0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleRenderSingleCamera()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23EB8);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::System::Int32>** StaticGet_CachedVisibleLightData()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23EC0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleInitializeCameraData()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x23EC8);
		}
		static ::System::Int32* StaticGet_LaunchSRPHelperStage()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6730);
		}
		static ::System::Boolean* StaticGet__SeparateUIRT_k__BackingField()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6734);
		}
		static ::System::Boolean* StaticGet_s_LastUseNativePerObjectShadow()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6735);
		}
		static ::System::Single* StaticGet_s_QueryResult()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6738);
		}
		static ::System::Boolean* StaticGet_requiresSRGBConversion()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x673C);
		}
		static ::System::Boolean* StaticGet_showOverdrawInfo()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x673D);
		}
		static ::System::Boolean* StaticGet_s_UseNativePerObjectShadowInitialized()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x673E);
		}
		static ::UnityEngine::Vector4* StaticGet__napTimeFaster()
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6740);
		}
		static ::System::Int64* StaticGet_preFrameCount()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6750);
		}
		static ::System::Int32* StaticGet_s_DecalSimpleRenderQueue()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6758);
		}
		static ::UnityEngine::Vector4* StaticGet__napTime()
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x675C);
		}
		static ::System::Int64* StaticGet_lastToonLightErrorTime()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6770);
		}
