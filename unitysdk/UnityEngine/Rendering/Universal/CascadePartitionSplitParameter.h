...
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1A2F5B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1A2F5B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_REPRESENTATIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A2F5C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A2F5C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_INIT_OFFSET UNITYSDK_OFFSET(0x1A2F5FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_SETFINALVALUE_OFFSET UNITYSDK_OFFSET(0x1A2F5E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A2F5C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F5FA0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CascadePartitionSplitParameter_TypeDefinitionIndex = 30136;
