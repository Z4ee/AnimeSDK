...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_BINDTEMPWEATHERLIST_OFFSET UNITYSDK_OFFSET(0x1ABA8E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_GETCURRENTWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1ABA9680)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_SYNWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1ABA9700)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA9950)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigAdditionalDataSO_TypeDefinitionIndex = 29952;
