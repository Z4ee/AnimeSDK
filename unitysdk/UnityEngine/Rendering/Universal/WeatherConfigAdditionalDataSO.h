...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_BINDTEMPWEATHERLIST_OFFSET UNITYSDK_OFFSET(0x1CF0BC30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_GETCURRENTWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1CF0C460)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_SYNWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1CF0C4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0C730)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigAdditionalDataSO_TypeDefinitionIndex = 26594;
