...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEPLANARREFLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C456910)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEPLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C456670)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenSpacePlanarReflection_TypeDefinitionIndex = 26799;
	...
	public:
		...
		{
			return (::UnityEngine::LayerMask*)Il2CppClass::FromTypeDefinitionIndex(ScreenSpacePlanarReflection_TypeDefinitionIndex)->GetStaticField(0x6310);
		}
