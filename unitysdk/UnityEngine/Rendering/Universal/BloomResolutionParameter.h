...
#define UNITYENGINE_RENDERING_UNIVERSAL_BLOOMRESOLUTIONPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x11092AB0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int BloomResolutionParameter_TypeDefinitionIndex = 27449;
