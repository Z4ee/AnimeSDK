...
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_GETCURRENTRENDERSCALE_OFFSET UNITYSDK_OFFSET(0x110985B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_GETCURRENTRENDERTARGETFACTOR_OFFSET UNITYSDK_OFFSET(0x11098630)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_GET_GRAPHICDEVICENAME_OFFSET UNITYSDK_OFFSET(0x110985A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_GET_SFORCEFULLSCREENTRANSPARENTFXCOUNT_OFFSET UNITYSDK_OFFSET(0x110987F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_GET_SFORCERENDERSCALE1PROXYCOUNT_OFFSET UNITYSDK_OFFSET(0x11098A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_GET_URPASSET_OFFSET UNITYSDK_OFFSET(0x110986E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETANTIALIASINGQUALITY_OFFSET UNITYSDK_OFFSET(0x1109AE00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETBLOOMQUALITY_OFFSET UNITYSDK_OFFSET(0x1109CB20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETDAMAGEDECALLEVEL_OFFSET UNITYSDK_OFFSET(0x11098FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETDPIFACTOR_OFFSET UNITYSDK_OFFSET(0x110992D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETMIRRORREFLECTIONQUALITY_OFFSET UNITYSDK_OFFSET(0x1109B6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETPARTICLELIGHTLEVEL_OFFSET UNITYSDK_OFFSET(0x11098E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETPARTICLELODLEVEL_OFFSET UNITYSDK_OFFSET(0x11098DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETPARTICLEQUALITY_OFFSET UNITYSDK_OFFSET(0x11099120)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETPARTICLERESOLUTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x11098C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1109A8A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETRENDERSCALE_OFFSET UNITYSDK_OFFSET(0x11099320)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETSCENEGLAREQUALITY_OFFSET UNITYSDK_OFFSET(0x1109CEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETSHADOWQUALITY_OFFSET UNITYSDK_OFFSET(0x11099B50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETVOLUMETRICCLOUDQUALITY_OFFSET UNITYSDK_OFFSET(0x1109C760)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SETVOLUMETRICFOGQUALITY_OFFSET UNITYSDK_OFFSET(0x1109C3A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SET_SFORCEFULLSCREENTRANSPARENTFXCOUNT_OFFSET UNITYSDK_OFFSET(0x11098850)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS_SET_SFORCERENDERSCALE1PROXYCOUNT_OFFSET UNITYSDK_OFFSET(0x11098A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_GRAPHICSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x110986B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GraphicSettings_TypeDefinitionIndex = 26975;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::UniversalRenderPipelineAsset**)Il2CppClass::FromTypeDefinitionIndex(GraphicSettings_TypeDefinitionIndex)->GetStaticField(0x23AF0);
		}
		static ::System::Int32* StaticGet__forceRenderScale1ProxyCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GraphicSettings_TypeDefinitionIndex)->GetStaticField(0x75E0);
		}
		static ::System::Single* StaticGet_s_CurrentTaauScele()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(GraphicSettings_TypeDefinitionIndex)->GetStaticField(0x75E4);
		}
		static ::System::Int32* StaticGet__forceFullScreenTransparentFXCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GraphicSettings_TypeDefinitionIndex)->GetStaticField(0x75E8);
		}
		static ::System::Single* StaticGet_s_CurrentRenderScele()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(GraphicSettings_TypeDefinitionIndex)->GetStaticField(0x75EC);
		}
		static ::System::Single* StaticGet_s_CurrentRenderTargetFactor()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(GraphicSettings_TypeDefinitionIndex)->GetStaticField(0x75F0);
		}
