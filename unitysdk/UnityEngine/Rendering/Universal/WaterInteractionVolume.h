...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1B1AED50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_WATERHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B1AEE20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1AF1C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B1AF050)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1AEEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B1AF230)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_REGISTERTOMANAGER_OFFSET UNITYSDK_OFFSET(0x1B1AEF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UNREGISTERFROMMANAGER_OFFSET UNITYSDK_OFFSET(0x1B1AF0A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UPDATEMANAGER_OFFSET UNITYSDK_OFFSET(0x1B1AF280)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1AF350)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionVolume_TypeDefinitionIndex = 26234;
