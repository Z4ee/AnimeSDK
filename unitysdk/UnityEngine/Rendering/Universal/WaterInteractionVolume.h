...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x192B4060)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_WATERHEIGHT_OFFSET UNITYSDK_OFFSET(0x192B4130)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x192B44D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x192B4360)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x192B41F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x192B4540)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_REGISTERTOMANAGER_OFFSET UNITYSDK_OFFSET(0x192B4240)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UNREGISTERFROMMANAGER_OFFSET UNITYSDK_OFFSET(0x192B43B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UPDATEMANAGER_OFFSET UNITYSDK_OFFSET(0x192B4590)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x192B4660)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionVolume_TypeDefinitionIndex = 29935;
