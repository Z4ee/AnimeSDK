...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_CULL_OFFSET UNITYSDK_OFFSET(0x8EC960)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_GETLIGHTATINDEX_OFFSET UNITYSDK_OFFSET(0x8ECA00)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_GETVALUE_OFFSET UNITYSDK_OFFSET(0x8EC9F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8EC990)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_TILELIGHTS_OFFSET UNITYSDK_OFFSET(0x8EC950)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightFilter_TypeDefinitionIndex = 30085;
