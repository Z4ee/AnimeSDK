...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x95D410)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_EQUALS_OFFSET UNITYSDK_OFFSET(0x95D370)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x95D420)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_GETSANITIZED_OFFSET UNITYSDK_OFFSET(0x95D340)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_GETSTABLEHASH_OFFSET UNITYSDK_OFFSET(0x95D360)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1C99BA50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS_QUANTIZE_OFFSET UNITYSDK_OFFSET(0x1C99C3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x95D470)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSCATTERPARAMS___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x95D4F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassBillboardScatterParams_TypeDefinitionIndex = 27329;
