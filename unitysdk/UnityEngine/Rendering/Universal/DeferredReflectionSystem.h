...
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_ADDMIRROR_OFFSET UNITYSDK_OFFSET(0x1C997760)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_ADDPROBE_OFFSET UNITYSDK_OFFSET(0x1C99B2C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETMIRRORLISTFORLAYER_OFFSET UNITYSDK_OFFSET(0x1C998050)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETREFLECTIONCUBEARRAY_OFFSET UNITYSDK_OFFSET(0x1C99AAA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETREFLECTIONLIST_OFFSET UNITYSDK_OFFSET(0x1C99B240)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETSUPPORTCUBEMAPARRAY_OFFSET UNITYSDK_OFFSET(0x1C99AA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1C99A930)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_REFRESHTEXTURECACHEARRAY_OFFSET UNITYSDK_OFFSET(0x1C99B1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_RELEASEPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0x1C997B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_REMOVEMIRROR_OFFSET UNITYSDK_OFFSET(0x1C9979A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_REMOVEPROBE_OFFSET UNITYSDK_OFFSET(0x1C99B4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_RENDERPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0x1C9981B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_SETREFRESHFLAG_OFFSET UNITYSDK_OFFSET(0x1C99B1A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C99B790)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C99A6F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DeferredReflectionSystem_TypeDefinitionIndex = 27123;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(DeferredReflectionSystem_TypeDefinitionIndex)->GetStaticField(0x231B0);
		}
		static ::UnityEngine::Rendering::Universal::DeferredReflectionSystem** StaticGet_m_Instance()
		{
			return (::UnityEngine::Rendering::Universal::DeferredReflectionSystem**)Il2CppClass::FromTypeDefinitionIndex(DeferredReflectionSystem_TypeDefinitionIndex)->GetStaticField(0x231B8);
		}
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Camera*>* m_PlannerReflectionOwner; // 0x10
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::UnityEngine::NAPRenderPipeline0::PlanarReflectionProxy_NativeSRP*>*>* m_PlannerReflectionProxies; // 0x20
