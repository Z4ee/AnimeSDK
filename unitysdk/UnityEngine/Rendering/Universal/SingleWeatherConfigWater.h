...
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_CLEARRAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B1AAB80)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_DEFAULTABSORPTIONGRAD_OFFSET UNITYSDK_OFFSET(0x1B1A9AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_DEFAULTSCATTERGRAD_OFFSET UNITYSDK_OFFSET(0x1B1A9CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GENERATERAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B1AA1D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_LEFTCUBE_OFFSET UNITYSDK_OFFSET(0x1B1A99F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_LERPVALUE_OFFSET UNITYSDK_OFFSET(0x1B1A9A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_RIGHTCUBE_OFFSET UNITYSDK_OFFSET(0x1B1A9A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_REFRESHRAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B1AA230)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SETUPWAVES_OFFSET UNITYSDK_OFFSET(0x1B1A9E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_LEFTCUBE_OFFSET UNITYSDK_OFFSET(0x1B1A9A00)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_LERPVALUE_OFFSET UNITYSDK_OFFSET(0x1B1A9A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_RIGHTCUBE_OFFSET UNITYSDK_OFFSET(0x1B1A9A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A9A50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SingleWeatherConfigWater_TypeDefinitionIndex = 26689;
