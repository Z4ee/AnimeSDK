...
#define UNITYENGINE_RENDERING_UNIVERSAL_MAINLIGHTSHADOWQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA74B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MainLightShadowQualityParameter_TypeDefinitionIndex = 30134;
