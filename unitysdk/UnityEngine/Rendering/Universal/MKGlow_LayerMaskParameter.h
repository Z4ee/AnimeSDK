...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C455E00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1C455D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C455E10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C455E20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_LayerMaskParameter_TypeDefinitionIndex = 27627;
