...
#define UNITYENGINE_RENDERING_UNIVERSAL_FXFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4F610)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FXFog_TypeDefinitionIndex = 27164;
