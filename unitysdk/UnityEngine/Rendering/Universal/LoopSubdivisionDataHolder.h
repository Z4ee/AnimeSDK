...
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER_APPLYSETTINGS_OFFSET UNITYSDK_OFFSET(0x19F33EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F33E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F34120)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LoopSubdivisionDataHolder_TypeDefinitionIndex = 30035;
