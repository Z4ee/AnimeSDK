...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0xF7FD290)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_ISVALID_OFFSET UNITYSDK_OFFSET(0xF7FD330)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xF7FD310)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIBakeSettings_TypeDefinitionIndex = 30056;
