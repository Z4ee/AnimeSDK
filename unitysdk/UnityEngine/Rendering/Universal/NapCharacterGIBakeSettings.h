...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0xF7A6CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_ISVALID_OFFSET UNITYSDK_OFFSET(0xF7A6D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xF7A6D70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIBakeSettings_TypeDefinitionIndex = 26822;
