...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B08B2E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B08B3D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B08A440)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08A430)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCaptureAction_TypeDefinitionIndex = 30195;
