...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D3E3C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D3E3D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3E2D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E2D70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCaptureAction_TypeDefinitionIndex = 26915;
