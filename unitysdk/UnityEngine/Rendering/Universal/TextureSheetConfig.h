...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E6710C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1E670FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ITEMPIVOTCENTER_OFFSET UNITYSDK_OFFSET(0x1E671010)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x1E671030)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1E671000)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1E671020)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_STARTFRAME_OFFSET UNITYSDK_OFFSET(0x1E670FE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x1E670FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TILES_OFFSET UNITYSDK_OFFSET(0x1E670FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x1E670DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_REBUILD_OFFSET UNITYSDK_OFFSET(0x1E671040)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E671100)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 27807;
