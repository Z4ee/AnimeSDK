...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D4E7E70)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1D4E7DA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ITEMPIVOTCENTER_OFFSET UNITYSDK_OFFSET(0x1D4E7DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x1D4E7DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1D4E7DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1D4E7DD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_STARTFRAME_OFFSET UNITYSDK_OFFSET(0x1D4E7D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x1D4E7D70)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TILES_OFFSET UNITYSDK_OFFSET(0x1D4E7D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x1D4E7BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_REBUILD_OFFSET UNITYSDK_OFFSET(0x1D4E7DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E7EB0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 26266;
