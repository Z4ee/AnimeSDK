...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_APPLYBILLBOARDBAKETARGETSTOSCATTERDATA_OFFSET UNITYSDK_OFFSET(0x1CC84C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_APPLYBILLBOARDORIGINALMATERIALANDSCALE_OFFSET UNITYSDK_OFFSET(0x1CC8FCA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_APPLYBILLBOARDPLACEHOLDERMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CC901D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_APPLYBILLBOARDSOURCERENDERERMATERIALSTATE_OFFSET UNITYSDK_OFFSET(0x1CC8F9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_AREBILLBOARDMATERIALARRAYSEQUAL_OFFSET UNITYSDK_OFFSET(0x1CC82F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_AREBILLBOARDMATERIALSALLPLACEHOLDER_OFFSET UNITYSDK_OFFSET(0x1CC82C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_BILLBOARDBINDINGKEYSMATCH_OFFSET UNITYSDK_OFFSET(0x1CC84950)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_BINDBILLBOARDPOSITIONBUFFERTOMATERIALS_OFFSET UNITYSDK_OFFSET(0x1CC87B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_BUILDBILLBOARDGROUPINSTANCELOOKUPCACHES_OFFSET UNITYSDK_OFFSET(0x1CC8AD00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_BUILDBILLBOARDPROGRESSIVEGROUPORDER_OFFSET UNITYSDK_OFFSET(0x1CC91A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_BUILDBILLBOARDVISIBLEGROUPORDERBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1CC89D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CACHEBILLBOARDTARGETORIGINALMATERIALSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1CC82960)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CANUSEBOUNDSOURCEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1CC89170)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKBILLBOARDVISIBLEBYBOUNDSOURCEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1CC89310)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKBILLBOARDVISIBLE_OFFSET UNITYSDK_OFFSET(0x1CC87E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKBUFFERVALID_OFFSET UNITYSDK_OFFSET(0x1CC8BC20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKINDIRECTDRAWDATA_OFFSET UNITYSDK_OFFSET(0x1CC9A7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1CC97400)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CLEARRUNTIMEBILLBOARDTARGETREGISTRATIONS_OFFSET UNITYSDK_OFFSET(0x1CC813C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_COLLECTALLOWEDBINDINGKEYSFORBAKEASSET_OFFSET UNITYSDK_OFFSET(0x1CC83690)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_COMPUTEBILLBOARDBAKEGROUPCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC84880)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_COMPUTEBILLBOARDLODTARGETCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC8BD00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWBILLBOARDGRASSFORSOFTEDGE_OFFSET UNITYSDK_OFFSET(0x1CC8F090)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWBILLBOARDGRASSSHADOW_OFFSET UNITYSDK_OFFSET(0x1CC8F030)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWBILLBOARDGRASS_OFFSET UNITYSDK_OFFSET(0x1CC8BE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWBILLBOARDINSTANCESBYMATERIALANDLOD_OFFSET UNITYSDK_OFFSET(0x1CC8C5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWGPUGRASSFORSOFTEDGE_OFFSET UNITYSDK_OFFSET(0x1CC9A4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWGPUGRASSSHADOW_OFFSET UNITYSDK_OFFSET(0x1CC99690)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWGPUGRASS_OFFSET UNITYSDK_OFFSET(0x1CC9A200)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWMESHWITHINDIRECTDRAW_OFFSET UNITYSDK_OFFSET(0x1CC9B000)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWWITHBATCH_OFFSET UNITYSDK_OFFSET(0x1CC99890)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1CC92D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDDISTANCEPLACEHOLDERMATERIALRESOLVED_OFFSET UNITYSDK_OFFSET(0x1CC7E5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDLOD1PRECOMPUTEDINDICES_OFFSET UNITYSDK_OFFSET(0x1CC91990)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDLOD2PRECOMPUTEDINDICES_OFFSET UNITYSDK_OFFSET(0x1CC919E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDPROGRESSIVELODDATA_OFFSET UNITYSDK_OFFSET(0x1CC8B1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDQUADMESH_OFFSET UNITYSDK_OFFSET(0x1CC94300)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ENSUREBILLBOARDSOURCERENDERERORIGINALSTATECACHED_OFFSET UNITYSDK_OFFSET(0x1CC907C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_EXTRACTUNIFORMSCALEFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x1CC91910)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDBAKEASSETMIGRATIONWARNING_OFFSET UNITYSDK_OFFSET(0x1CC7E470)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDBATCHCOUNTPERDRAW_OFFSET UNITYSDK_OFFSET(0x1CC8D7C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDCOREBYTESPERINSTANCEESTIMATE_OFFSET UNITYSDK_OFFSET(0x1CC91400)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDCULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x1CC89090)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDDISTANCEPLACEHOLDERMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CC90180)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDDRAWMATERIALBYINDEX_OFFSET UNITYSDK_OFFSET(0x1CC8C550)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDDRAWMESH_OFFSET UNITYSDK_OFFSET(0x1CC888D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDGROUPSORTCENTERWS_OFFSET UNITYSDK_OFFSET(0x1CC91190)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDINSTANCEDATAFORDRAW_1_OFFSET UNITYSDK_OFFSET(0x1CC8E620)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDINSTANCEDATAFORDRAW_OFFSET UNITYSDK_OFFSET(0x1CC915C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDLODCOUNTRATIO_OFFSET UNITYSDK_OFFSET(0x1CC8BC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC8C3E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDMATERIALINDEXFORINSTANCE_OFFSET UNITYSDK_OFFSET(0x1CC8D8A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDMATERIALSWITCHSTAGEFORGROUP_OFFSET UNITYSDK_OFFSET(0x1CC8F370)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDMAXDRAWCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC8AC20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDRUNTIMEINSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x1CC8AB50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDSAFESLICECOUNT_OFFSET UNITYSDK_OFFSET(0x1CC8BBA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETBILLBOARDSOURCEVISIBLESCALEFORGROUP_OFFSET UNITYSDK_OFFSET(0x1CC8F3F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETGROUPBASEDATA_OFFSET UNITYSDK_OFFSET(0x1CC948E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1CC96CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_HASANYBILLBOARDDRAWMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CC88A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_HASBILLBOARDBAKEASSETMIGRATIONWARNING_OFFSET UNITYSDK_OFFSET(0x1CC7E4C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_HASBILLBOARDBAKEASSETWORKFLOWTARGETINSCENE_OFFSET UNITYSDK_OFFSET(0x1CC84160)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_HASBILLBOARDINSTANCESFORGROUP_OFFSET UNITYSDK_OFFSET(0x1CC8F460)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_INITBILLBOARDGRASS_OFFSET UNITYSDK_OFFSET(0x1CC7E550)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ISBILLBOARDBAKEASSETVALID_OFFSET UNITYSDK_OFFSET(0x1CC83510)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ISBILLBOARDMOBILEPLATFORM_OFFSET UNITYSDK_OFFSET(0x1CC91120)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ISBILLBOARDPLACEHOLDERMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CC82D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ISBILLBOARDSOURCERENDERERVISIBLE_OFFSET UNITYSDK_OFFSET(0x1CC8F0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_MARKBILLBOARDDIRTYANDREBUILD_OFFSET UNITYSDK_OFFSET(0x1CC7E9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_NEEDREBUILDBILLBOARDDATA_OFFSET UNITYSDK_OFFSET(0x1CC92450)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_NORMALIZEBILLBOARDBINDINGKEY_OFFSET UNITYSDK_OFFSET(0x1CC84A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONDISABLEMESHGRASS_OFFSET UNITYSDK_OFFSET(0x1CC97FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CC97F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONENABLEMESHGRASS_OFFSET UNITYSDK_OFFSET(0x1CC96DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CC96D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONPROXYDISABLEFORBILLBOARDTARGETBINDING_OFFSET UNITYSDK_OFFSET(0x1CC80660)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONPROXYENABLEFORBILLBOARDTARGETBINDING_OFFSET UNITYSDK_OFFSET(0x1CC7FF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREBILLBOARDDRAWDATA_OFFSET UNITYSDK_OFFSET(0x1CC8A080)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGPUDRAWDATA_OFFSET UNITYSDK_OFFSET(0x1CC98C40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGROUPDATAFORCUSTOMGRASS_OFFSET UNITYSDK_OFFSET(0x1CC96380)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGROUPDATAFORMASKGRASS_OFFSET UNITYSDK_OFFSET(0x1CC95ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGROUPDATA_OFFSET UNITYSDK_OFFSET(0x1CC94AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REBUILDBILLBOARDDATABYBOUNDS_OFFSET UNITYSDK_OFFSET(0x1CC87110)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REBUILDBILLBOARDDATAIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1CC7E9F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REFRESHBILLBOARDBOUNDSFROMSCATTER_OFFSET UNITYSDK_OFFSET(0x1CC93D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REFRESHBILLBOARDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1CC924F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REFRESHBILLBOARDGROUPBOUNDSFROMINSTANCES_OFFSET UNITYSDK_OFFSET(0x1CC933D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REFRESHBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1CC95490)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REFRESHRUNTIMEBILLBOARDTARGETREGISTRATIONS_OFFSET UNITYSDK_OFFSET(0x1CC80300)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REGISTERBILLBOARDTARGETRUNTIME_OFFSET UNITYSDK_OFFSET(0x1CC81540)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REGISTERRUNTIMEBILLBOARDTARGET_OFFSET UNITYSDK_OFFSET(0x1CC81930)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RELEASEBILLBOARDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1CC87790)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESETBILLBOARDTRANSIENTINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x1CC87A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESETGROUPDATA_OFFSET UNITYSDK_OFFSET(0x1CC95CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESETTEMPGROUPDATA_OFFSET UNITYSDK_OFFSET(0x1CC96830)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESOLVEBILLBOARDBOUNDSOURCERENDERER_OFFSET UNITYSDK_OFFSET(0x1CC873C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESOLVEBILLBOARDGLOBALMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1CC84620)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESOLVEBILLBOARDTARGETBYSOURCERENDERER_OFFSET UNITYSDK_OFFSET(0x1CC82FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESTOREALLBILLBOARDSOURCERENDERERMATERIALS_OFFSET UNITYSDK_OFFSET(0x1CC80990)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESTOREALLBILLBOARDTARGETORIGINALMATERIALSINSCENE_OFFSET UNITYSDK_OFFSET(0x1CC80F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESTOREBILLBOARDDATAFROMBAKEASSET_OFFSET UNITYSDK_OFFSET(0x1CC87080)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESTOREBILLBOARDSOURCERENDERERTOORIGINALSTATE_OFFSET UNITYSDK_OFFSET(0x1CC8F590)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1CC96CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SHOULDKEEPBILLBOARDLODSAMPLE_OFFSET UNITYSDK_OFFSET(0x1CC8DEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SHOULDUSEBILLBOARDORIGINALMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CC8F510)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SYNCBILLBOARDSOURCERENDERERBINDING_OFFSET UNITYSDK_OFFSET(0x1CC82700)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SYNCCACHEDDATARENDERDATATOINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x1CC96E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_TRANSFORMDIRECTIONBYMATRIX_OFFSET UNITYSDK_OFFSET(0x1CC914E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_TRYCOLLECTBILLBOARDBAKETARGETSFROMSCENE_OFFSET UNITYSDK_OFFSET(0x1CC83CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_TRYFILLBILLBOARDBATCHINSTANCE_OFFSET UNITYSDK_OFFSET(0x1CC8D930)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_TRYGETBILLBOARDINSTANCESHADERTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1CC8DF70)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UNREGISTERBILLBOARDTARGETRUNTIME_OFFSET UNITYSDK_OFFSET(0x1CC81E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UNREGISTERRUNTIMEBILLBOARDTARGET_OFFSET UNITYSDK_OFFSET(0x1CC82250)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATEALLBILLBOARDSOURCERENDERERMATERIALSBYPROXYSTATE_OFFSET UNITYSDK_OFFSET(0x1CC88CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATEBILLBOARDGRASS_OFFSET UNITYSDK_OFFSET(0x1CC87AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATEBILLBOARDSOURCERENDERERMATERIALFORGROUP_OFFSET UNITYSDK_OFFSET(0x1CC89A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATEMESHGRASS_OFFSET UNITYSDK_OFFSET(0x1CC98170)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATETEXTURESTREAMINGFAKER_OFFSET UNITYSDK_OFFSET(0x1CC984F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CC980F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_USETRANSIENTBILLBOARDINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x1CC913C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC9BC50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC9B3F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassProxy_TypeDefinitionIndex = 27262;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Matrix4x4>**)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x234F0);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::GPUGrassProxy*>**)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x234F8);
		}
		static ::Il2CppArray<::UnityEngine::Matrix4x4>** StaticGet_m_LocalToWorldMatrixArrayForGPUGrass()
		{
			return (::Il2CppArray<::UnityEngine::Matrix4x4>**)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x23500);
		}
		static ::System::Int32* StaticGet__EnableBillboardPropertyId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x6AC0);
		}
		static ::System::Int32* StaticGet__GrassInstanceBuffer()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x6AC4);
		}
		static ::System::Int32* StaticGet__GPUGrassParams()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x6AC8);
		}
