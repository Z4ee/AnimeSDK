...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATA_LYRAGICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7113F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigAdditionalData_LyraGIConfig_TypeDefinitionIndex = 29957;
