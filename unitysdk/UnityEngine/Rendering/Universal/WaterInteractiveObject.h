...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_COLLECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x1B3723D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B373350)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B3732A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1B372F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B372210)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B372E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B373A10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractiveObject_TypeDefinitionIndex = 29938;
