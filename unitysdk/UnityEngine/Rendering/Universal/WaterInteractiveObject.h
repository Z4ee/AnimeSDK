...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_COLLECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x1D4EA380)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4EB300)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D4EB250)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1D4EAEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D4EA1C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D4EAE10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EB9C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractiveObject_TypeDefinitionIndex = 27295;
