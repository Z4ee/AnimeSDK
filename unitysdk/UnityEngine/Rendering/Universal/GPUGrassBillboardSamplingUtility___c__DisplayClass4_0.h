...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3D3B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDSAMPLINGUTILITY___C__DISPLAYCLASS4_0__TRYSAMPLEPOINTSONMESHSURFACE_B__0_OFFSET UNITYSDK_OFFSET(0x1D3D3B30)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassBillboardSamplingUtility___c__DisplayClass4_0_TypeDefinitionIndex = 26494;
