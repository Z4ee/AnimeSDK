...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLITTONING__CTOR_OFFSET UNITYSDK_OFFSET(0x190CFC80)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SplitToning_TypeDefinitionIndex = 30173;
