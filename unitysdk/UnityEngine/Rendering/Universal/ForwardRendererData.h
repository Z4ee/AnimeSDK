...
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_CLEARCACHEDSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x1E78E610)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1E78E160)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GETALLSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x1E78EA50)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GETSHADERCONFIG_OFFSET UNITYSDK_OFFSET(0x1E78E6B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_DEFAULTSTENCILSTATE_OFFSET UNITYSDK_OFFSET(0x1E78E300)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_OPAQUELAYERMASK_OFFSET UNITYSDK_OFFSET(0x1E78E1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_SHADOWTRANSPARENTRECEIVE_OFFSET UNITYSDK_OFFSET(0x1E78E390)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_TRANSPARENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1E78E270)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_LOGALLSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x1E78EAA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E78E420)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_DEFAULTSTENCILSTATE_OFFSET UNITYSDK_OFFSET(0x1E78E310)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_OPAQUELAYERMASK_OFFSET UNITYSDK_OFFSET(0x1E78E1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_SHADOWTRANSPARENTRECEIVE_OFFSET UNITYSDK_OFFSET(0x1E78E3A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_TRANSPARENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1E78E280)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E78EF40)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E78F020)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ForwardRendererData_TypeDefinitionIndex = 27768;
	...
	public:
		...
		::System::Boolean hasFlushBakeResult; // 0x174
