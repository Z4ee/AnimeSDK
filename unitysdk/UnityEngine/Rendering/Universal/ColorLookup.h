...
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B178920)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B178B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_VALIDATELUT_OFFSET UNITYSDK_OFFSET(0x1B1789C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B178B70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ColorLookup_TypeDefinitionIndex = 26241;
