...
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C5AFAB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1C5AFCD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_VALIDATELUT_OFFSET UNITYSDK_OFFSET(0x1C5AFB60)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5AFD10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ColorLookup_TypeDefinitionIndex = 27494;
