...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERER_RENDERINGFEATURES_GET_CAMERASTACKING_OFFSET UNITYSDK_OFFSET(0x1CB1D5E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERER_RENDERINGFEATURES_SET_CAMERASTACKING_OFFSET UNITYSDK_OFFSET(0x1CB1D5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERER_RENDERINGFEATURES__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB1D600)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScriptableRenderer_RenderingFeatures_TypeDefinitionIndex = 27038;
