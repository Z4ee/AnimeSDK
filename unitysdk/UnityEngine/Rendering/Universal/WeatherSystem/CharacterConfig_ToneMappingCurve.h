...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_CHARACTERCONFIG_TONEMAPPINGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E266AC0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int CharacterConfig_ToneMappingCurve_TypeDefinitionIndex = 27116;
