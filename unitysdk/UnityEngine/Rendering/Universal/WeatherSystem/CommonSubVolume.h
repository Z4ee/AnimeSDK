...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_CHECKINSUBVOLUME_OFFSET UNITYSDK_OFFSET(0x1BDDCE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BDDCBA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BDDCD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDDCF90)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int CommonSubVolume_TypeDefinitionIndex = 26844;
