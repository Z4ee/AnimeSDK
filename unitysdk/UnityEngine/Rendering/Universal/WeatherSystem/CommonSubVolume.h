...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_CHECKINSUBVOLUME_OFFSET UNITYSDK_OFFSET(0x19AD4250)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19AD3FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19AD4190)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD4390)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int CommonSubVolume_TypeDefinitionIndex = 30324;
