...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SKYCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x1D4EBB10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SKYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EBDD0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int SkyConfig_TypeDefinitionIndex = 27312;
