...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_CLEANUPNULLREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B89BB40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_GETREGISTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0x1B89C430)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B89B5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1B89B9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1B89BD30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_UPDATEWEATHERTRANSITION_OFFSET UNITYSDK_OFFSET(0x1B89BE90)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B89C570)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B89B8E0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherTransitionManager_TypeDefinitionIndex = 27042;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::WeatherSystem::WeatherTransitionManager**)Il2CppClass::FromTypeDefinitionIndex(WeatherTransitionManager_TypeDefinitionIndex)->GetStaticField(0x21DF0);
		}
		static ::System::Object** StaticGet__lock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(WeatherTransitionManager_TypeDefinitionIndex)->GetStaticField(0x21DF8);
		}
