...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENETWISTCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x190D2060)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENETWISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190D24A0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int SceneTwistConfig_TypeDefinitionIndex = 30311;
