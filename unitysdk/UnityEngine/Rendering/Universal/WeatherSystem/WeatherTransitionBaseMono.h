...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C155CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C155C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1C155B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C155D40)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherTransitionBaseMono_TypeDefinitionIndex = 26931;
