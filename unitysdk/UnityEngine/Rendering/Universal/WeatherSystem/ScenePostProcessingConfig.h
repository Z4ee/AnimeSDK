...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x1AF145D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG_GETTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1AF14560)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF14B90)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int ScenePostProcessingConfig_TypeDefinitionIndex = 26900;
