...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x190D19B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG_GETTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x190D1940)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190D1F70)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int ScenePostProcessingConfig_TypeDefinitionIndex = 30315;
