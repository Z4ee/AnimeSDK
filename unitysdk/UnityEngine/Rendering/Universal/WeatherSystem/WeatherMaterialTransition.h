...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BDDE100)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BDDDF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1BDDE150)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDDE8C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BDDE9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BDDE9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1BDDE9C0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherMaterialTransition_TypeDefinitionIndex = 27112;
