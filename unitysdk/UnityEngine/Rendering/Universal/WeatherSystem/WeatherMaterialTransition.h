...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CF198A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CF196B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1CF198F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF1A060)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CF1A140)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CF1A150)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1CF1A160)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherMaterialTransition_TypeDefinitionIndex = 26798;
