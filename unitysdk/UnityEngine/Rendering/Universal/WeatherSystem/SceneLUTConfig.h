...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENELUTCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x1F82A410)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENELUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1F82A6D0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int SceneLUTConfig_TypeDefinitionIndex = 27532;
