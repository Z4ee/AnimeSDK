...
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLELAYERCHARACTERGHOSTCONFIGPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19AC62E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLELAYERCHARACTERGHOSTCONFIGPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19AC6300)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLELAYERCHARACTERGHOSTCONFIGPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC62A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SingleLayerCharacterGhostConfigParameter_TypeDefinitionIndex = 30163;
