...
#define UNITYENGINE_RENDERING_UNIVERSAL_WHITEBALANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF15150)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WhiteBalance_TypeDefinitionIndex = 26578;
