...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDBAKEASSET_GET_GROUPCOUNT_OFFSET UNITYSDK_OFFSET(0x1CEF5690)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDBAKEASSET_GET_SCATTERCOUNT_OFFSET UNITYSDK_OFFSET(0x1CEF5640)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSBILLBOARDBAKEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF56E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassBillboardBakeAsset_TypeDefinitionIndex = 26813;
