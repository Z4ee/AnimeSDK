...
#define UNITYENGINE_RENDERING_UNIVERSAL_CAUSTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEEBCC0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int Caustics_TypeDefinitionIndex = 26605;
