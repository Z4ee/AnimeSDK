...
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A6EAFC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A6EAE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_ITEMPIVOTCENTER_OFFSET UNITYSDK_OFFSET(0x1A6EAEC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x1A6EAF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A6EAEA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A6EAEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_STARTFRAME_OFFSET UNITYSDK_OFFSET(0x1A6EAE60)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_TEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x1A6EAE20)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_GET_TILES_OFFSET UNITYSDK_OFFSET(0x1A6EAE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x1A6EAC40)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_REBUILD_OFFSET UNITYSDK_OFFSET(0x1A6EAF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A6EAE90)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_ITEMPIVOTCENTER_OFFSET UNITYSDK_OFFSET(0x1A6EAED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_LOOP_OFFSET UNITYSDK_OFFSET(0x1A6EAF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A6EAEB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A6EAEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_STARTFRAME_OFFSET UNITYSDK_OFFSET(0x1A6EAE70)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_TEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x1A6EAE30)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG_SET_TILES_OFFSET UNITYSDK_OFFSET(0x1A6EAE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_ARCADETEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EB020)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ArcadeTextureSheetConfig_TypeDefinitionIndex = 29898;
	...
	public:
		...
		::UnityEngine::Vector2Int _Tiles_k__BackingField; // 0x24
		::UnityEngine::Vector2 _ItemPivotCenter_k__BackingField; // 0x2C
		::System::Int32 _EndFrame_k__BackingField; // 0x34
		::System::Int32 _StartFrame_k__BackingField; // 0x38
		::System::Int32 _Speed_k__BackingField; // 0x3C
