...
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKPROPERTYMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB17810)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MaterialPropertyBlockPropertyMatrix_TypeDefinitionIndex = 26848;
