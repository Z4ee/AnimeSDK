...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_GETLAYERRANGE_1_OFFSET UNITYSDK_OFFSET(0x1D3E3F70)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_GETLAYERRANGE_OFFSET UNITYSDK_OFFSET(0x1D3E3E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_INDEX2DTOINDEX_OFFSET UNITYSDK_OFFSET(0x1D3E4090)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_INDEXTOINDEX2D_OFFSET UNITYSDK_OFFSET(0x1D3E4030)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_RECALCULATEBASICPARAMS_OFFSET UNITYSDK_OFFSET(0x1D3E3D40)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E40F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGI_TypeDefinitionIndex = 26204;
