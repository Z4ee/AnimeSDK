...
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSUTILS_CONFIGUREDITHERING_OFFSET UNITYSDK_OFFSET(0x1CCA6CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSUTILS_CONFIGUREFILMGRAIN_OFFSET UNITYSDK_OFFSET(0x1CCA6F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSUTILS_ISANTIALIASINGNEEDUPSAMPLE_OFFSET UNITYSDK_OFFSET(0x1CCA6CA0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PostProcessUtils_TypeDefinitionIndex = 27917;
