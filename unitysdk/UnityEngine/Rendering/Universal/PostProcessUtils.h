...
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSUTILS_CONFIGUREDITHERING_OFFSET UNITYSDK_OFFSET(0x1B899D70)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSUTILS_CONFIGUREFILMGRAIN_OFFSET UNITYSDK_OFFSET(0x1B899FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSUTILS_ISANTIALIASINGNEEDUPSAMPLE_OFFSET UNITYSDK_OFFSET(0x1B899D20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PostProcessUtils_TypeDefinitionIndex = 27171;
