...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x822F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_CREATECONSTLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x191447F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_CREATEMUTABLELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x19144C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x822FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_GET_DYNAMICLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x822F70)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_INITALLOCATE_OFFSET UNITYSDK_OFFSET(0x822F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_REMOVEATSWAPBACK_OFFSET UNITYSDK_OFFSET(0x822FA0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightLodManager_UniversalAdditionalLightDataUnmanagedArray_TypeDefinitionIndex = 30024;
