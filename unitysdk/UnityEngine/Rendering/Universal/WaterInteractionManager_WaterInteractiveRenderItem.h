...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM_REFRESHBOUNDANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B823740)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM_TRANSFORMLOCALBOUNDSTOWORLDAABB_OPTIMIZED_OFFSET UNITYSDK_OFFSET(0x1B8234D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B8233C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8233B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionManager_WaterInteractiveRenderItem_TypeDefinitionIndex = 26340;
