...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19692A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISCHARACTERGHOSTACTIVE_OFFSET UNITYSDK_OFFSET(0x19692EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19692AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_LAYERCONFIGTOVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19692B00)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19692F70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenEffects_TypeDefinitionIndex = 30161;
