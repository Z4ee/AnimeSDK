...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B7FE7F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISCHARACTERGHOSTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B7FEC70)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B7FE840)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_LAYERCONFIGTOVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1B7FE880)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7FECF0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenEffects_TypeDefinitionIndex = 26336;
