...
namespace UnityEngine::Rendering::Universal
{
	...
	public:
		...
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* indirectSpecularIntensity; // 0x1E0
		::UnityEngine::NAPRenderPipeline0::BoolParameter* enableLightShaft; // 0x1E8
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* lightShaftThreshold; // 0x1F0
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* lightShaftIntensity; // 0x1F8
		::UnityEngine::NAPRenderPipeline0::BoolParameter* lightShaftColorClamp; // 0x200
		::UnityEngine::NAPRenderPipeline0::ColorParameter* lightShaftColor; // 0x208
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* lightShaftLength; // 0x210
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* lightShaftFadeLength; // 0x218
		::UnityEngine::NAPRenderPipeline0::BoolParameter* lightShaftBlur; // 0x220
		::UnityEngine::NAPRenderPipeline0::BoolParameter* lightShaftUseCustomCenter; // 0x228
		::UnityEngine::NAPRenderPipeline0::Vector2Parameter* lightShaftCustomCenter; // 0x230
		::UnityEngine::NAPRenderPipeline0::BoolParameter* fxLightShaftMaskOn; // 0x238
		::UnityEngine::NAPRenderPipeline0::BoolParameter* ForceUseMsaa; // 0x240
		::UnityEngine::NAPRenderPipeline0::BoolParameter* overrideWeatherConfig; // 0x248
		::UnityEngine::NAPRenderPipeline0::ColorParameter* rainDropColor; // 0x250
		::UnityEngine::NAPRenderPipeline0::Vector2Parameter* wetnessNoiseClamp; // 0x258
		::UnityEngine::NAPRenderPipeline0::ColorParameter* rainDropSplashColor; // 0x260
		::UnityEngine::NAPRenderPipeline0::ClampedIntParameter* rainDropSplashCount; // 0x268
		::UnityEngine::NAPRenderPipeline0::FloatParameter* distanceFogStart; // 0x270
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* fogHorizontalGradient; // 0x278
		::UnityEngine::NAPRenderPipeline0::FloatParameter* heightFogHeight; // 0x280
		::UnityEngine::NAPRenderPipeline0::FloatParameter* heightFogStart; // 0x288
		::UnityEngine::NAPRenderPipeline0::ColorParameter* volumetricFogColor; // 0x290
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* skyVerticalGradient; // 0x298
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* skyHorizontalGradient; // 0x2A0
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* skyHorizontalHeight; // 0x2A8
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* skyHorizontalOffset; // 0x2B0
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* skyCloudHorizontalGradient; // 0x2B8
		::UnityEngine::NAPRenderPipeline0::ColorParameter* sunDiscColor; // 0x2C0
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* layer1MiddleCloudGradient; // 0x2C8
		::UnityEngine::NAPRenderPipeline0::ColorParameter* layer1CloudAroundSunColor; // 0x2D0
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* layer2MiddleCloudGradient; // 0x2D8
		::UnityEngine::NAPRenderPipeline0::ColorParameter* layer2CloudAroundSunColor; // 0x2E0
		::UnityEngine::Rendering::Universal::FXColorCorrection_GradientParameter* layer3MiddleCloudGradient; // 0x2E8
		::UnityEngine::NAPRenderPipeline0::ColorParameter* layer3CloudAroundSunColor; // 0x2F0
		::UnityEngine::NAPRenderPipeline0::ClampedFloatParameter* sceneLutContribution; // 0x2F8
		::UnityEngine::NAPRenderPipeline0::ColorParameter* ambientSkyColor; // 0x300
		::UnityEngine::NAPRenderPipeline0::ColorParameter* ambientEquatorColor; // 0x308
		::UnityEngine::NAPRenderPipeline0::ColorParameter* ambientGroundColor; // 0x310
		::UnityEngine::NAPRenderPipeline0::BoolParameter* overrideWeatherGIConfig; // 0x318
		::UnityEngine::NAPRenderPipeline0::ColorParameter* skyColor; // 0x320
		::UnityEngine::NAPRenderPipeline0::ColorParameter* middleColor; // 0x328
		::UnityEngine::NAPRenderPipeline0::ColorParameter* groundColor; // 0x330
