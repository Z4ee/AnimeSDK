...
#define UNITYENGINE_RENDERING_DEBUGUI_VBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x188E3700)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_VBox_TypeDefinitionIndex = 27814;
