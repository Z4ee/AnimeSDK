...
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_AUTOPROFILECAMERA_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F230)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_AUTOPROFILECAMERA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F56F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_AUTOPROFILECAMERA_OFFSET UNITYSDK_OFFSET(0x9F56F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D58EF30)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERPASS_OFFSET UNITYSDK_OFFSET(0x9F5700)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERQUERY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F110)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERQUERY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5630)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERQUERY_OFFSET UNITYSDK_OFFSET(0x9F5630)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINSUBPASS_1_OFFSET UNITYSDK_OFFSET(0x9F5780)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINSUBPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D58EF40)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINSUBPASS_OFFSET UNITYSDK_OFFSET(0x9F5740)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTUREWITHCAMERAPOSITION_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F1B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTUREWITHCAMERAPOSITION_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5680)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTURE_OFFSET UNITYSDK_OFFSET(0x9F5A50)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CREATEGPUFENCE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F1F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CREATEGPUFENCE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F56D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CREATEGRAPHICSFENCE_OFFSET UNITYSDK_OFFSET(0x9F5A90)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CULL_OFFSET UNITYSDK_OFFSET(0x9F5A10)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWHIZDEBUGRENDERERS_OFFSET UNITYSDK_OFFSET(0x9F5850)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_1_OFFSET UNITYSDK_OFFSET(0x9F5810)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F030)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F55C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_OFFSET UNITYSDK_OFFSET(0x9F57E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWSHADOWS_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F050)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWSHADOWS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F55D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWSHADOWS_OFFSET UNITYSDK_OFFSET(0x9F55D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D58EF60)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERPASS_OFFSET UNITYSDK_OFFSET(0x9F57D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERQUERY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F130)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERQUERY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5640)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERQUERY_OFFSET UNITYSDK_OFFSET(0x9F5640)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDSUBPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D58EF50)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDSUBPASS_OFFSET UNITYSDK_OFFSET(0x9F57C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9F5C60)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9F5C10)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTEANDCLEARCOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x9F5910)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTECOMMANDBUFFER_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F070)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTECOMMANDBUFFER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F55E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTECOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x9F5890)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTESRPCMDBUFFER_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F090)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTESRPCMDBUFFER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F55F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTESRPCMDBUFFER_OFFSET UNITYSDK_OFFSET(0x9F5990)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETCAMERA_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F010)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETCAMERA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F55B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETCAMERA_OFFSET UNITYSDK_OFFSET(0x9F55B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETNUMBEROFCAMERAS_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58EFF0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETNUMBEROFCAMERAS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F55A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETNUMBEROFCAMERAS_OFFSET UNITYSDK_OFFSET(0x9F55A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_HZBCULLINGREADBACK_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F0F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_HZBCULLINGREADBACK_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5620)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_HZBCULLINGREADBACK_OFFSET UNITYSDK_OFFSET(0x9F5620)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INITIALIZESORTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D58EFB0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INTERNAL_CULL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58EF90)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INTERNAL_CULL_OFFSET UNITYSDK_OFFSET(0x1D58EF70)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INVOKEONRENDEROBJECTCALLBACK_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F0D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INVOKEONRENDEROBJECTCALLBACK_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5610)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INVOKEONRENDEROBJECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x9F5610)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_PREPAREFORBUILDRAYTRACINGACCELERATIONSTRUCTURE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F190)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_PREPAREFORBUILDRAYTRACINGACCELERATIONSTRUCTURE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5670)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_PREPAREFORBUILDRAYTRACINGACCELERATIONSTRUCTURE_OFFSET UNITYSDK_OFFSET(0x9F5670)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_RAYTRACINGACCELERATIONSTRUCTURECULLINSTANCES_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F170)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_RAYTRACINGACCELERATIONSTRUCTURECULLINSTANCES_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5660)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_RAYTRACINGACCELERATIONSTRUCTURECULLINSTANCES_OFFSET UNITYSDK_OFFSET(0x9F5660)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETTARGETQUEUETYPE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F1D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETTARGETQUEUETYPE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F56C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETTARGETQUEUETYPE_OFFSET UNITYSDK_OFFSET(0x9F56C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPCAMERAPROPERTIES_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F0B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPCAMERAPROPERTIES_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5600)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPCAMERAPROPERTIES_OFFSET UNITYSDK_OFFSET(0x9F5600)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPSUNSHADOWCULLINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D58EFA0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SUBMIT_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58EFD0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SUBMIT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5590)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SUBMIT_OFFSET UNITYSDK_OFFSET(0x9F5590)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_UPDATEKODAMALIGHTING_BAKEDONLY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F150)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_UPDATEKODAMALIGHTING_BAKEDONLY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F5650)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_UPDATEKODAMALIGHTING_BAKEDONLY_OFFSET UNITYSDK_OFFSET(0x9F5650)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONASYNCGRAPHICSFENCE_1_OFFSET UNITYSDK_OFFSET(0x9F5BC0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONASYNCGRAPHICSFENCE_2_OFFSET UNITYSDK_OFFSET(0x9F5BF0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONASYNCGRAPHICSFENCE_OFFSET UNITYSDK_OFFSET(0x9F5B90)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONGPUFENCE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D58F210)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONGPUFENCE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9F56E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x2B6D10)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ScriptableRenderContext_TypeDefinitionIndex = 6256;
