...
#define UNITYENGINE_RENDERING_CAMERASWITCHER_GETCAMERACOUNT_OFFSET UNITYSDK_OFFSET(0x1B1640F0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_GETNEXTCAMERA_OFFSET UNITYSDK_OFFSET(0x1B1641A0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B164130)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B163B50)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_SETCAMERAINDEX_OFFSET UNITYSDK_OFFSET(0x1B1641F0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1644F0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_0_OFFSET UNITYSDK_OFFSET(0x1B164500)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_1_OFFSET UNITYSDK_OFFSET(0x1B164510)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_2_OFFSET UNITYSDK_OFFSET(0x1B164520)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_3_OFFSET UNITYSDK_OFFSET(0x1B164530)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CameraSwitcher_TypeDefinitionIndex = 33661;
