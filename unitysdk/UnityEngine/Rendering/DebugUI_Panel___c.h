...
namespace UnityEngine::Rendering
{
	...
	public:
		...
		{
			return (::System::Action_1<::UnityEngine::Rendering::DebugUI_Panel*>**)Il2CppClass::FromTypeDefinitionIndex(DebugUI_Panel___c_TypeDefinitionIndex)->GetStaticField(0x8A90);
		}
		static ::UnityEngine::Rendering::DebugUI_Panel___c** StaticGet___9()
		{
			return (::UnityEngine::Rendering::DebugUI_Panel___c**)Il2CppClass::FromTypeDefinitionIndex(DebugUI_Panel___c_TypeDefinitionIndex)->GetStaticField(0x8A98);
		}
