...
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_FALLBACKLIGHTMAPPERBYREF_OFFSET UNITYSDK_OFFSET(0x18A4A5B0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_FALLBACKMIXEDLIGHTINGMODEBYREF_OFFSET UNITYSDK_OFFSET(0x18A49F90)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18A49E30)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_AUTOAMBIENTPROBEBAKING_OFFSET UNITYSDK_OFFSET(0x18A49F70)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_AUTODEFAULTREFLECTIONPROBEBAKING_OFFSET UNITYSDK_OFFSET(0x18A49F80)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_DEFAULTMIXEDLIGHTINGMODES_OFFSET UNITYSDK_OFFSET(0x18A49F20)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_ENLIGHTEN_OFFSET UNITYSDK_OFFSET(0x18A49F60)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_LIGHTMAPBAKETYPES_OFFSET UNITYSDK_OFFSET(0x18A49F40)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_LIGHTMAPSMODES_OFFSET UNITYSDK_OFFSET(0x18A49F50)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_MIXEDLIGHTINGMODES_OFFSET UNITYSDK_OFFSET(0x18A49F30)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISAUTOAMBIENTPROBEBAKINGSUPPORTED_OFFSET UNITYSDK_OFFSET(0x18A4A510)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISAUTODEFAULTREFLECTIONPROBEBAKINGSUPPORTED_OFFSET UNITYSDK_OFFSET(0x18A4A560)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPBAKETYPESUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x18A4A320)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPBAKETYPESUPPORTED_OFFSET UNITYSDK_OFFSET(0x18A4A2E0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPPERSUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x18A4A4B0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPSMODESUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x18A4A460)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISMIXEDLIGHTINGMODESUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x18A4A1A0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISMIXEDLIGHTINGMODESUPPORTED_OFFSET UNITYSDK_OFFSET(0x18A4A160)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18A468F0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A4A5C0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES__CTOR_OFFSET UNITYSDK_OFFSET(0x18A468B0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int SupportedRenderingFeatures_TypeDefinitionIndex = 4580;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::SupportedRenderingFeatures**)Il2CppClass::FromTypeDefinitionIndex(SupportedRenderingFeatures_TypeDefinitionIndex)->GetStaticField(0x13E60);
		}
