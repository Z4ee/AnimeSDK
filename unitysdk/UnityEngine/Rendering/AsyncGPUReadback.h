...
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_1_OFFSET UNITYSDK_OFFSET(0x1B3A5210)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_2_OFFSET UNITYSDK_OFFSET(0x1B3A52B0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_1_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3A5350)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1B3A51D0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3A5360)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_2_OFFSET UNITYSDK_OFFSET(0x1B3A5270)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_1_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3A5370)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1B3A5310)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_OFFSET UNITYSDK_OFFSET(0x1B3A5170)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_SETUPSCRIPTINGREQUEST_OFFSET UNITYSDK_OFFSET(0x1B3A5160)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int AsyncGPUReadback_TypeDefinitionIndex = 6126;
