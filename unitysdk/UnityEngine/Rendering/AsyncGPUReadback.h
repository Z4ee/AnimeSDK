...
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_1_OFFSET UNITYSDK_OFFSET(0x18A3AA50)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_1_INJECTED_OFFSET UNITYSDK_OFFSET(0x18A3AB10)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_1_OFFSET UNITYSDK_OFFSET(0x18A3AA10)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_2_INJECTED_OFFSET UNITYSDK_OFFSET(0x18A3AB20)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_2_OFFSET UNITYSDK_OFFSET(0x18A3AAD0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_OFFSET UNITYSDK_OFFSET(0x18A3A9B0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_SETUPSCRIPTINGREQUEST_OFFSET UNITYSDK_OFFSET(0x18A3A990)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_VALIDATEFORMAT_OFFSET UNITYSDK_OFFSET(0x18A3A890)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int AsyncGPUReadback_TypeDefinitionIndex = 4493;
