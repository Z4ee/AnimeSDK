...
#define UNITYENGINE_RENDERING_SHADOWUTILS_ADDVIRTUALPOSITIONSHADOW_OFFSET UNITYSDK_OFFSET(0x1A480DF0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_BINDSELFSHADOWLIGHT_OFFSET UNITYSDK_OFFSET(0x1A480E20)
#define UNITYENGINE_RENDERING_SHADOWUTILS_CLEANUPSHADOWCACHE_OFFSET UNITYSDK_OFFSET(0x1A480D60)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ENABLELIGHTSHADOW_OFFSET UNITYSDK_OFFSET(0x1A480D80)
#define UNITYENGINE_RENDERING_SHADOWUTILS_FORCEUPDATESHADOW_OFFSET UNITYSDK_OFFSET(0x1A480D70)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETSHADOWRUNTINGSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A480D20)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETSHADOWRUNTINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A480CD0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETVSMSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A480EC0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETVSMSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A480E40)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ISPOSMVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A480DB0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ISVSMDEBUG_OFFSET UNITYSDK_OFFSET(0x1A480EE0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ONLOADINGFINISHED_OFFSET UNITYSDK_OFFSET(0x1A480F00)
#define UNITYENGINE_RENDERING_SHADOWUTILS_REMOVEVIRTUALPOSITIONSHADOW_OFFSET UNITYSDK_OFFSET(0x1A480E10)
#define UNITYENGINE_RENDERING_SHADOWUTILS_RESETTODEFAULTCSMUPDATESETTING_OFFSET UNITYSDK_OFFSET(0x1A480DE0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETCSMCASCADECOUNT_OFFSET UNITYSDK_OFFSET(0x1A480DC0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETCSMUPDATEFRAMES_OFFSET UNITYSDK_OFFSET(0x1A480DD0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETCUSTOMSHADOW_OFFSET UNITYSDK_OFFSET(0x1A480D90)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETOVERRIDESELFSHADOWBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A480E30)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETPEROBJECTSHADOWPRORITY_OFFSET UNITYSDK_OFFSET(0x1A480DA0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETPEROBJECTSHADOWVOLUMEEXTENT_OFFSET UNITYSDK_OFFSET(0x1A480F10)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETRENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A480D50)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETSHADOWPLAYER_OFFSET UNITYSDK_OFFSET(0x1A480D40)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETSHADOWRUNTINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A480D30)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETVSMCULLINGMASK_OFFSET UNITYSDK_OFFSET(0x1A480EF0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETVSMSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A480ED0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_UPDATEVIRTUALPOSITIONSHADOW_OFFSET UNITYSDK_OFFSET(0x1A480E00)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowUtils_TypeDefinitionIndex = 4697;
