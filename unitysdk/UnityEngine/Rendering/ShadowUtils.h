...
#define UNITYENGINE_RENDERING_SHADOWUTILS_ADDVIRTUALPOSITIONSHADOW_OFFSET UNITYSDK_OFFSET(0x1BFAB970)
#define UNITYENGINE_RENDERING_SHADOWUTILS_BINDSELFSHADOWLIGHT_OFFSET UNITYSDK_OFFSET(0x1BFAB9A0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_CLEANUPSHADOWCACHE_OFFSET UNITYSDK_OFFSET(0x1BFAB8E0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ENABLELIGHTSHADOW_OFFSET UNITYSDK_OFFSET(0x1BFAB900)
#define UNITYENGINE_RENDERING_SHADOWUTILS_FORCEUPDATESHADOW_OFFSET UNITYSDK_OFFSET(0x1BFAB8F0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETSHADOWRUNTINGSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1BFAB8A0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETSHADOWRUNTINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BFAB850)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETVSMSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1BFABA40)
#define UNITYENGINE_RENDERING_SHADOWUTILS_GETVSMSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BFAB9C0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ISPOSMVISIBLE_OFFSET UNITYSDK_OFFSET(0x1BFAB930)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ISVSMDEBUG_OFFSET UNITYSDK_OFFSET(0x1BFABA60)
#define UNITYENGINE_RENDERING_SHADOWUTILS_ONLOADINGFINISHED_OFFSET UNITYSDK_OFFSET(0x1BFABA80)
#define UNITYENGINE_RENDERING_SHADOWUTILS_REMOVEVIRTUALPOSITIONSHADOW_OFFSET UNITYSDK_OFFSET(0x1BFAB990)
#define UNITYENGINE_RENDERING_SHADOWUTILS_RESETTODEFAULTCSMUPDATESETTING_OFFSET UNITYSDK_OFFSET(0x1BFAB960)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETCSMCASCADECOUNT_OFFSET UNITYSDK_OFFSET(0x1BFAB940)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETCSMUPDATEFRAMES_OFFSET UNITYSDK_OFFSET(0x1BFAB950)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETCUSTOMSHADOW_OFFSET UNITYSDK_OFFSET(0x1BFAB910)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETOVERRIDESELFSHADOWBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BFAB9B0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETPEROBJECTSHADOWPRORITY_OFFSET UNITYSDK_OFFSET(0x1BFAB920)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETPEROBJECTSHADOWVOLUMEEXTENT_OFFSET UNITYSDK_OFFSET(0x1BFABA90)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETRENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1BFAB8D0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETSHADOWPLAYER_OFFSET UNITYSDK_OFFSET(0x1BFAB8C0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETSHADOWRUNTINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BFAB8B0)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETVSMCULLINGMASK_OFFSET UNITYSDK_OFFSET(0x1BFABA70)
#define UNITYENGINE_RENDERING_SHADOWUTILS_SETVSMSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BFABA50)
#define UNITYENGINE_RENDERING_SHADOWUTILS_UPDATEVIRTUALPOSITIONSHADOW_OFFSET UNITYSDK_OFFSET(0x1BFAB980)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowUtils_TypeDefinitionIndex = 4876;
