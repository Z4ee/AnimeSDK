...
#define UNITYENGINE_RENDERING_VECTOR2PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1C08AED0)
#define UNITYENGINE_RENDERING_VECTOR2PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C08AD80)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Vector2Parameter_TypeDefinitionIndex = 34209;
