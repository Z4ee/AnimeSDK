...
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_GET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1C091DE0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_ISOBJECTPARAMETER_OFFSET UNITYSDK_OFFSET(0x1C08E260)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C091E10)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C091E00)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C091E20)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_SET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1C091DF0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C091E30)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VolumeParameter_TypeDefinitionIndex = 34185;
