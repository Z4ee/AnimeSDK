...
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3BC2870)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0x3BC2810)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3BC2920)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RenderStateBlock_TypeDefinitionIndex = 4761;
