...
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x94F600)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0x94F420)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x94F610)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GET_BLENDSTATE_OFFSET UNITYSDK_OFFSET(0x4000F0)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GET_MASK_OFFSET UNITYSDK_OFFSET(0x94F410)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_BLENDSTATE_OFFSET UNITYSDK_OFFSET(0x94F3B0)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_DEPTHSTATE_OFFSET UNITYSDK_OFFSET(0x94F3E0)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_MASK_OFFSET UNITYSDK_OFFSET(0x870C60)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_STENCILREFERENCE_OFFSET UNITYSDK_OFFSET(0x94F400)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_STENCILSTATE_OFFSET UNITYSDK_OFFSET(0x94F3F0)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x94F310)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RenderStateBlock_TypeDefinitionIndex = 6227;
