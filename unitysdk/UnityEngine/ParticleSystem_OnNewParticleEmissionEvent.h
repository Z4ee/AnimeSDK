...
#define UNITYENGINE_PARTICLESYSTEM_ONNEWPARTICLEEMISSIONEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1313A0)
#define UNITYENGINE_PARTICLESYSTEM_ONNEWPARTICLEEMISSIONEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1313D0)
#define UNITYENGINE_PARTICLESYSTEM_ONNEWPARTICLEEMISSIONEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D12CC60)
#define UNITYENGINE_PARTICLESYSTEM_ONNEWPARTICLEEMISSIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D131330)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleSystem_OnNewParticleEmissionEvent_TypeDefinitionIndex = 5740;
