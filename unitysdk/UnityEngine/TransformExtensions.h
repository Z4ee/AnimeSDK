...
#define UNITYENGINE_TRANSFORMEXTENSIONS_ADDCHILDFROMPREFAB_OFFSET UNITYSDK_OFFSET(0x17888EC0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETDEEPFROMROOT_OFFSET UNITYSDK_OFFSET(0x178881A0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETPATHUNTIL_OFFSET UNITYSDK_OFFSET(0x17889CF0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETPATH_OFFSET UNITYSDK_OFFSET(0x17889B00)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x178875A0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFECREATENODE_OFFSET UNITYSDK_OFFSET(0x17888970)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEDESTROY_OFFSET UNITYSDK_OFFSET(0x17889820)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAMERECURSIVELYINNER_OFFSET UNITYSDK_OFFSET(0x17887F00)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAMERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x17887C60)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAME_OFFSET UNITYSDK_OFFSET(0x178878B0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x17886430)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x178866A0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILD_1_OFFSET UNITYSDK_OFFSET(0x17887120)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILD_OFFSET UNITYSDK_OFFSET(0x17886F20)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDDEEPCHILDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17886880)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDORCREATECHILDWITHINDEX_OFFSET UNITYSDK_OFFSET(0x17888380)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEGETCHILDCOUNTWITHNAME_OFFSET UNITYSDK_OFFSET(0x17888640)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEGETCHILD_OFFSET UNITYSDK_OFFSET(0x17889000)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x17882170)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETALLCHILDACTIVEWITHNAME_OFFSET UNITYSDK_OFFSET(0x17889100)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETALLCHILDACTIVE_OFFSET UNITYSDK_OFFSET(0x17889540)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETLOCALSCALE01_OFFSET UNITYSDK_OFFSET(0x17888B30)

namespace UnityEngine
{
	inline static constexpr unsigned int TransformExtensions_TypeDefinitionIndex = 54450;
