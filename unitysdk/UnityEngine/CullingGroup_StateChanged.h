...
#define UNITYENGINE_CULLINGGROUP_STATECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C16B750)
#define UNITYENGINE_CULLINGGROUP_STATECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C16B7C0)
#define UNITYENGINE_CULLINGGROUP_STATECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C16B6D0)
#define UNITYENGINE_CULLINGGROUP_STATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C16B6E0)

namespace UnityEngine
{
	inline static constexpr unsigned int CullingGroup_StateChanged_TypeDefinitionIndex = 4041;
