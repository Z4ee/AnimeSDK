...
#define UNITYENGINE_CULLINGGROUP_STATECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DECCBF0)
#define UNITYENGINE_CULLINGGROUP_STATECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DECCC60)
#define UNITYENGINE_CULLINGGROUP_STATECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DECCB70)
#define UNITYENGINE_CULLINGGROUP_STATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DECCB80)

namespace UnityEngine
{
	inline static constexpr unsigned int CullingGroup_StateChanged_TypeDefinitionIndex = 4049;
