...
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_CALLIDENTITYTOKENCHANGED_OFFSET UNITYSDK_OFFSET(0x1FC42F30)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_CALLSESSIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1FC42B60)

namespace UnityEngine::Analytics
{
	inline static constexpr unsigned int AnalyticsSessionInfo_TypeDefinitionIndex = 93736;
	...
	public:
		...
		{
			return (::UnityEngine::Analytics::AnalyticsSessionInfo_IdentityTokenChanged**)Il2CppClass::FromTypeDefinitionIndex(AnalyticsSessionInfo_TypeDefinitionIndex)->GetStaticField(0x52410);
		}
		static ::UnityEngine::Analytics::AnalyticsSessionInfo_SessionStateChanged** StaticGet_sessionStateChanged()
		{
			return (::UnityEngine::Analytics::AnalyticsSessionInfo_SessionStateChanged**)Il2CppClass::FromTypeDefinitionIndex(AnalyticsSessionInfo_TypeDefinitionIndex)->GetStaticField(0x52418);
		}
