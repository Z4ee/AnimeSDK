...
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E868050)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E868120)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8676F0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E868030)

namespace UnityEngine::Analytics
{
	inline static constexpr unsigned int AnalyticsSessionInfo_SessionStateChanged_TypeDefinitionIndex = 89806;
