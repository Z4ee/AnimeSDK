...
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FC434F0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FC435C0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FC42BA0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC434D0)

namespace UnityEngine::Analytics
{
	inline static constexpr unsigned int AnalyticsSessionInfo_SessionStateChanged_TypeDefinitionIndex = 93737;
