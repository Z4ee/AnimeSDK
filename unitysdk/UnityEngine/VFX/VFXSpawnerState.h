...
#define UNITYENGINE_VFX_VFXSPAWNERSTATE_CREATESPAWNERSTATEWRAPPER_OFFSET UNITYSDK_OFFSET(0x1E887A30)
#define UNITYENGINE_VFX_VFXSPAWNERSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E887BA0)
#define UNITYENGINE_VFX_VFXSPAWNERSTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E887B20)
#define UNITYENGINE_VFX_VFXSPAWNERSTATE_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E887B10)
#define UNITYENGINE_VFX_VFXSPAWNERSTATE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1E887AE0)
#define UNITYENGINE_VFX_VFXSPAWNERSTATE_SETWRAPVALUE_OFFSET UNITYSDK_OFFSET(0x1E887A70)
#define UNITYENGINE_VFX_VFXSPAWNERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E887A20)

namespace UnityEngine::VFX
{
	inline static constexpr unsigned int VFXSpawnerState_TypeDefinitionIndex = 89815;
