...
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E887870)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E8877E0)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E8877D0)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1E887790)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E887770)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E887760)

namespace UnityEngine::VFX
{
	inline static constexpr unsigned int VFXEventAttribute_TypeDefinitionIndex = 89809;
