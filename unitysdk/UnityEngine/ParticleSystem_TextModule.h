...
#define UNITYENGINE_PARTICLESYSTEM_TEXTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x2E5940)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleSystem_TextModule_TypeDefinitionIndex = 24895;
