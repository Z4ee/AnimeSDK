...
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_AUTOAPPLYDYNAMICSCALE_OFFSET UNITYSDK_OFFSET(0xA07460)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_COLORFORMAT_OFFSET UNITYSDK_OFFSET(0xA06C70)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_DEPTHBUFFERBITS_OFFSET UNITYSDK_OFFSET(0xA06D20)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_DIMENSION_OFFSET UNITYSDK_OFFSET(0x361C30)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_ENABLERANDOMWRITE_OFFSET UNITYSDK_OFFSET(0xA073C0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x46E220)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_GRAPHICSFORMAT_OFFSET UNITYSDK_OFFSET(0x32EC50)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_MIPCOUNT_OFFSET UNITYSDK_OFFSET(0x2B7CC0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_MSAASAMPLES_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_SRGB_OFFSET UNITYSDK_OFFSET(0xA06CD0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_USEDYNAMICSCALE_OFFSET UNITYSDK_OFFSET(0xA07430)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_VOLUMEDEPTH_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_VRUSAGE_OFFSET UNITYSDK_OFFSET(0x3B1DA0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SETORCLEARRENDERTEXTURECREATIONFLAG_OFFSET UNITYSDK_OFFSET(0xA07380)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_AUTOAPPLYDYNAMICSCALE_OFFSET UNITYSDK_OFFSET(0xA07470)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_AUTOGENERATEMIPS_OFFSET UNITYSDK_OFFSET(0xA073B0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_BINDMS_OFFSET UNITYSDK_OFFSET(0xA073F0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_COLORFORMAT_OFFSET UNITYSDK_OFFSET(0xA06C80)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_CREATEDFROMSCRIPT_OFFSET UNITYSDK_OFFSET(0xA07410)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_DEPTHBUFFERBITS_OFFSET UNITYSDK_OFFSET(0xA06DC0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_DIMENSION_OFFSET UNITYSDK_OFFSET(0x8326D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_ENABLERANDOMWRITE_OFFSET UNITYSDK_OFFSET(0xA073D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_FASTCLEAR_OFFSET UNITYSDK_OFFSET(0xA074D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x6427C0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_GRAPHICSFORMAT_OFFSET UNITYSDK_OFFSET(0xA06C40)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x7F7C40)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_LOSSYCOMPRESSION_OFFSET UNITYSDK_OFFSET(0xA07490)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_MEMORYLESS_OFFSET UNITYSDK_OFFSET(0x6427D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_MIPCOUNT_OFFSET UNITYSDK_OFFSET(0x48E3B0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_MSAASAMPLES_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_PRIVATESTORAGE_OFFSET UNITYSDK_OFFSET(0xA074F0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_SHADOWSAMPLINGMODE_OFFSET UNITYSDK_OFFSET(0x3B1E40)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_SRGB_OFFSET UNITYSDK_OFFSET(0xA06CE0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_STENCILFORMAT_OFFSET UNITYSDK_OFFSET(0x2C1270)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_UNIFORMGRIDSAMPLEPATTERN_OFFSET UNITYSDK_OFFSET(0xA074B0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_USEDYNAMICSCALE_OFFSET UNITYSDK_OFFSET(0xA07440)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_USEMIPMAP_OFFSET UNITYSDK_OFFSET(0xA073A0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_VOLUMEDEPTH_OFFSET UNITYSDK_OFFSET(0x52CD90)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_VRUSAGE_OFFSET UNITYSDK_OFFSET(0x6427B0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6ABBF0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA06EC0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA06FB0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CTOR_3_OFFSET UNITYSDK_OFFSET(0xA070E0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CTOR_4_OFFSET UNITYSDK_OFFSET(0xA07200)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CTOR_5_OFFSET UNITYSDK_OFFSET(0xA072D0)
#define UNITYENGINE_RENDERTEXTUREDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA06DF0)
