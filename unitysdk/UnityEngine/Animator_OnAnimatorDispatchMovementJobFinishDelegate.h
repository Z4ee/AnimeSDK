...
#define UNITYENGINE_ANIMATOR_ONANIMATORDISPATCHMOVEMENTJOBFINISHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x189DD270)
#define UNITYENGINE_ANIMATOR_ONANIMATORDISPATCHMOVEMENTJOBFINISHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x189DD2A0)
#define UNITYENGINE_ANIMATOR_ONANIMATORDISPATCHMOVEMENTJOBFINISHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x189DA7E0)
#define UNITYENGINE_ANIMATOR_ONANIMATORDISPATCHMOVEMENTJOBFINISHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x189DD250)

namespace UnityEngine
{
	inline static constexpr unsigned int Animator_OnAnimatorDispatchMovementJobFinishDelegate_TypeDefinitionIndex = 5034;
