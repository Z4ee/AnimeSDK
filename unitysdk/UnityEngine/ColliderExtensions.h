...
#define UNITYENGINE_COLLIDEREXTENSIONS_CONTAINCAMTRANSPARENTTAG_OFFSET UNITYSDK_OFFSET(0x1F1CC1A0)
#define UNITYENGINE_COLLIDEREXTENSIONS_SETUPCOLLIDERPHYSICALMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F1CC310)

namespace UnityEngine
{
	inline static constexpr unsigned int ColliderExtensions_TypeDefinitionIndex = 58467;
