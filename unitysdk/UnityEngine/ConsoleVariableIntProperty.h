...
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY_GET_INTVALUE_OFFSET UNITYSDK_OFFSET(0x3A8C620)
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1C16A6C0)
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C16A6B0)
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x3A8C5E0)

namespace UnityEngine
{
	inline static constexpr unsigned int ConsoleVariableIntProperty_TypeDefinitionIndex = 4048;
