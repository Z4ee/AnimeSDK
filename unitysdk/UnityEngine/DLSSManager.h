...
#define UNITYENGINE_DLSSMANAGER_GET_NUMFRAMESACTUALLYPRESENTED_OFFSET UNITYSDK_OFFSET(0x1D6A4010)
#define UNITYENGINE_DLSSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A4020)
