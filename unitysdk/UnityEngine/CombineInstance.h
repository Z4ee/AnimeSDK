...
#define UNITYENGINE_COMBINEINSTANCE_GET_MESH_OFFSET UNITYSDK_OFFSET(0x9D04F0)
#define UNITYENGINE_COMBINEINSTANCE_SET_MESH_OFFSET UNITYSDK_OFFSET(0x9D0500)
#define UNITYENGINE_COMBINEINSTANCE_SET_SUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define UNITYENGINE_COMBINEINSTANCE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x9D0640)
