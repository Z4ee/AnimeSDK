...
#define UNITYENGINE_COMBINEINSTANCE_GET_MESH_OFFSET UNITYSDK_OFFSET(0x2110950)
#define UNITYENGINE_COMBINEINSTANCE_SET_MESH_OFFSET UNITYSDK_OFFSET(0x2110960)
#define UNITYENGINE_COMBINEINSTANCE_SET_SUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x1D50)
#define UNITYENGINE_COMBINEINSTANCE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x21109B0)

namespace UnityEngine
{
	inline static constexpr unsigned int CombineInstance_TypeDefinitionIndex = 4002;
