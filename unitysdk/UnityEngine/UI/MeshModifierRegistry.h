...
#define UNITYENGINE_UI_MESHMODIFIERREGISTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA2B3D0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int MeshModifierRegistry_TypeDefinitionIndex = 19335;
