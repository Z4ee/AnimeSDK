...
#define UNITYENGINE_UI_POSITIONASUV1_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1E49C020)
#define UNITYENGINE_UI_POSITIONASUV1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E49BF80)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int PositionAsUV1_TypeDefinitionIndex = 18994;
