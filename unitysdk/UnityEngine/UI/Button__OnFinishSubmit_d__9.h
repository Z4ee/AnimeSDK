...
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D312A60)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D312BA0)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D312C00)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D312BB0)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D312A50)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1D312A40)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Button__OnFinishSubmit_d__9_TypeDefinitionIndex = 18847;
