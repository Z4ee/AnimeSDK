...
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DF1AB40)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DF1AC90)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF1AD50)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector4EqualityComparer_TypeDefinitionIndex = 18949;
