...
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1F31D3A0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1F31D4F0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F31D5C0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector4EqualityComparer_TypeDefinitionIndex = 19293;
