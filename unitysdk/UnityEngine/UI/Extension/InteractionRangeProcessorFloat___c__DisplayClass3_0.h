...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC68C60)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___C__DISPLAYCLASS3_0__GOTOVAL_B__0_OFFSET UNITYSDK_OFFSET(0x1EC68C70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___C__DISPLAYCLASS3_0__GOTOVAL_B__1_OFFSET UNITYSDK_OFFSET(0x1EC68CE0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorFloat___c__DisplayClass3_0_TypeDefinitionIndex = 60499;
