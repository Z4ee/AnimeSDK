...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17892370)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x178923D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD_INVOKE_OFFSET UNITYSDK_OFFSET(0x17891E10)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD__CTOR_OFFSET UNITYSDK_OFFSET(0x17891E00)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_DragCallbackOld_TypeDefinitionIndex = 81059;
