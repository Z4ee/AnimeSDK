...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D343A60)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D343AE0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3434A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D343480)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointDragCallback_TypeDefinitionIndex = 71296;
