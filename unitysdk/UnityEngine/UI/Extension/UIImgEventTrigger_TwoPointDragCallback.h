...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5ACCF0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5ACD70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AC750)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AC730)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointDragCallback_TypeDefinitionIndex = 65761;
