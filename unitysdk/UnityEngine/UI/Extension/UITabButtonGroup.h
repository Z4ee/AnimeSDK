...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDLOCKTAB_OFFSET UNITYSDK_OFFSET(0x1CB9C4E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_1_OFFSET UNITYSDK_OFFSET(0x1CB9C990)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_2_OFFSET UNITYSDK_OFFSET(0x1CB9CA40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_OFFSET UNITYSDK_OFFSET(0x1CB9C2E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CB99F10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x1CB9AAB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x1CB9A970)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CHANGEENDTABINDEX_OFFSET UNITYSDK_OFFSET(0x1CB9B6C0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CHANGETWOTABINDEX_OFFSET UNITYSDK_OFFSET(0x1CB9BAB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLEARSELECTTAB_OFFSET UNITYSDK_OFFSET(0x1CB9D140)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLEARTABS_OFFSET UNITYSDK_OFFSET(0x1CB9C230)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLICKTAB_OFFSET UNITYSDK_OFFSET(0x1CB9A160)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_COLLECTUITABLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1CB9E000)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GETENABLETABBUTTONCOUNT_OFFSET UNITYSDK_OFFSET(0x1CB9DA00)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GETORDEREDENABLEDTABS_OFFSET UNITYSDK_OFFSET(0x1CB9E450)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_CURPOSINDEX_OFFSET UNITYSDK_OFFSET(0x1CB99B60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_CURSELECTKEY_OFFSET UNITYSDK_OFFSET(0x1CB99B50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1CB99B70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CB9BFC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_ORDEREDKEYS_OFFSET UNITYSDK_OFFSET(0x1CB99B90)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x1CB99E30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CB99E20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_TABBUTTONCOUNT_OFFSET UNITYSDK_OFFSET(0x1CB99DF0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_HIDEALLTABS_OFFSET UNITYSDK_OFFSET(0x1CB9D890)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ISCANCLICKLOGIC_OFFSET UNITYSDK_OFFSET(0x1CB9CC90)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x1CB9E3C0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CB9A100)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x1CB9DC70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_REGISTERCLICK_OFFSET UNITYSDK_OFFSET(0x1CB9E200)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_RESIZE_OFFSET UNITYSDK_OFFSET(0x1CB9E5D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1CB9B1D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SELECTANDCALLMETHOD_OFFSET UNITYSDK_OFFSET(0x1CB9CD20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SELECTTAB_OFFSET UNITYSDK_OFFSET(0x1CB9CDC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETASSETLOADPROXY_OFFSET UNITYSDK_OFFSET(0x1CB9C0A0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETBUTTONACTIVE_OFFSET UNITYSDK_OFFSET(0x1CB9A350)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETCANCLICKLOGIC_OFFSET UNITYSDK_OFFSET(0x1CB9CC40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x1CB9E250)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1CB9D2B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETSELECTEDIMAGEBYKEY_OFFSET UNITYSDK_OFFSET(0x1CB9D630)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETSELECTEDIMAGE_OFFSET UNITYSDK_OFFSET(0x1CB9D3D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABCOUNT_OFFSET UNITYSDK_OFFSET(0x1CB9B2E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABICON_OFFSET UNITYSDK_OFFSET(0x1CB9A800)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABLOCKBYMETHOD_OFFSET UNITYSDK_OFFSET(0x1CB9AE60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABLOCK_OFFSET UNITYSDK_OFFSET(0x1CB9B0B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNAMEBYMETHOD_OFFSET UNITYSDK_OFFSET(0x1CB9A490)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNAME_OFFSET UNITYSDK_OFFSET(0x1CB9A6E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNOTIFICATIONNODEBYMETHOD_OFFSET UNITYSDK_OFFSET(0x1CB9AC10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1CB99B80)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SHOWBUTTONBYCOUNT_OFFSET UNITYSDK_OFFSET(0x1CB9A2C0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__ADDLOCKTAB_G__WRAPCALLBACK_40_0_OFFSET UNITYSDK_OFFSET(0x1CB9C720)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB9EDC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__GETORDEREDENABLEDTABS_B__69_0_OFFSET UNITYSDK_OFFSET(0x1CB9EEC0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButtonGroup_TypeDefinitionIndex = 50415;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A4D62D05D5EA8464*))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETASSETLOADPROXY_OFFSET))(this, assetLoadProxy);
		}
