...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDLOCKTAB_OFFSET UNITYSDK_OFFSET(0x1BB2F180)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_1_OFFSET UNITYSDK_OFFSET(0x1BB2F630)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_2_OFFSET UNITYSDK_OFFSET(0x1BB2F6E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_OFFSET UNITYSDK_OFFSET(0x1BB2EF80)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BB2CB80)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x1BB2D710)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x1BB2D5E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CHANGEENDTABINDEX_OFFSET UNITYSDK_OFFSET(0x1BB2E340)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CHANGETWOTABINDEX_OFFSET UNITYSDK_OFFSET(0x1BB2E740)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLEARSELECTTAB_OFFSET UNITYSDK_OFFSET(0x1BB2FDF0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLEARTABS_OFFSET UNITYSDK_OFFSET(0x1BB2EED0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLICKTAB_OFFSET UNITYSDK_OFFSET(0x1BB2CDD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_COLLECTUITABLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1BB30CE0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GETENABLETABBUTTONCOUNT_OFFSET UNITYSDK_OFFSET(0x1BB306E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GETORDEREDENABLEDTABS_OFFSET UNITYSDK_OFFSET(0x1BB31130)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_CURPOSINDEX_OFFSET UNITYSDK_OFFSET(0x1BB2C850)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_CURSELECTKEY_OFFSET UNITYSDK_OFFSET(0x1BB2C840)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1BB2C860)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BB2EC60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_ORDEREDKEYS_OFFSET UNITYSDK_OFFSET(0x1BB2C880)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x1BB2CB20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BB2CB10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_TABBUTTONCOUNT_OFFSET UNITYSDK_OFFSET(0x1BB2CAE0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_HIDEALLTABS_OFFSET UNITYSDK_OFFSET(0x1BB30570)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ISCANCLICKLOGIC_OFFSET UNITYSDK_OFFSET(0x1BB2F930)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x1BB310A0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BB2CD70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x1BB30950)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_REGISTERCLICK_OFFSET UNITYSDK_OFFSET(0x1BB30EE0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_RESIZE_OFFSET UNITYSDK_OFFSET(0x1BB312B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1BB2DE40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SELECTANDCALLMETHOD_OFFSET UNITYSDK_OFFSET(0x1BB2F9C0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SELECTTAB_OFFSET UNITYSDK_OFFSET(0x1BB2FA60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETASSETLOADPROXY_OFFSET UNITYSDK_OFFSET(0x1BB2ED40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETBUTTONACTIVE_OFFSET UNITYSDK_OFFSET(0x1BB2CFC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETCANCLICKLOGIC_OFFSET UNITYSDK_OFFSET(0x1BB2F8E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x1BB30F30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1BB2FF60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETSELECTEDIMAGEBYKEY_OFFSET UNITYSDK_OFFSET(0x1BB30300)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETSELECTEDIMAGE_OFFSET UNITYSDK_OFFSET(0x1BB30070)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABCOUNT_OFFSET UNITYSDK_OFFSET(0x1BB2DF50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABICON_OFFSET UNITYSDK_OFFSET(0x1BB2D470)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABLOCKBYMETHOD_OFFSET UNITYSDK_OFFSET(0x1BB2DAD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABLOCK_OFFSET UNITYSDK_OFFSET(0x1BB2DD30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNAMEBYMETHOD_OFFSET UNITYSDK_OFFSET(0x1BB2D0F0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNAME_OFFSET UNITYSDK_OFFSET(0x1BB2D350)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNOTIFICATIONNODEBYMETHOD_OFFSET UNITYSDK_OFFSET(0x1BB2D870)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1BB2C870)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SHOWBUTTONBYCOUNT_OFFSET UNITYSDK_OFFSET(0x1BB2CF30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__ADDLOCKTAB_G__WRAPCALLBACK_40_0_OFFSET UNITYSDK_OFFSET(0x1BB2F3C0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB31AA0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__GETORDEREDENABLEDTABS_B__69_0_OFFSET UNITYSDK_OFFSET(0x1BB31BA0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButtonGroup_TypeDefinitionIndex = 56162;
