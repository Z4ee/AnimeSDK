...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1D5D5400)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1D5D5640)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1D5D5450)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D5260)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1D5D5710)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1D5D57F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1D5D5840)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateY_ByDeltaX_TypeDefinitionIndex = 90297;
