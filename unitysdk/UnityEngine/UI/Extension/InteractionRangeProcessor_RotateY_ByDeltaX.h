...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x16834DA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_GETVALUE_OFFSET UNITYSDK_OFFSET(0x16834FF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_SETVALUE_OFFSET UNITYSDK_OFFSET(0x16834DF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x16834C00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x168350D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x168351B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x16835200)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateY_ByDeltaX_TypeDefinitionIndex = 48659;
