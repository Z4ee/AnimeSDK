...
#define UNITYENGINE_UI_EXTENSION_UITIMESTRUCT_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x18EC0A40)
#define UNITYENGINE_UI_EXTENSION_UITIMESTRUCT_SETTIMECOLOR_OFFSET UNITYSDK_OFFSET(0x18EC04D0)
#define UNITYENGINE_UI_EXTENSION_UITIMESTRUCT_SETTIMEDESCOLOR_OFFSET UNITYSDK_OFFSET(0x18EC0410)
#define UNITYENGINE_UI_EXTENSION_UITIMESTRUCT_SETTIME_OFFSET UNITYSDK_OFFSET(0x18EC0590)
#define UNITYENGINE_UI_EXTENSION_UITIMESTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC0BC0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITimeStruct_TypeDefinitionIndex = 74514;
