...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_ATTACHTOTABLEVIEW_OFFSET UNITYSDK_OFFSET(0x1EC69630)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1EC69060)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1EC68E10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1EC68E30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_RELEASECACHE_OFFSET UNITYSDK_OFFSET(0x1EC69960)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SETSTATEACTIVE_OFFSET UNITYSDK_OFFSET(0x1EC68EB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1EC68E20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1EC68E40)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_START_OFFSET UNITYSDK_OFFSET(0x1EC69150)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC699A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableViewCell_TypeDefinitionIndex = 60151;
