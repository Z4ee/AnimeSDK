...
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_ADD_ONFINISH_OFFSET UNITYSDK_OFFSET(0x19E44B60)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E42D30)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_COMPLETEUPDATENUMBERIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x19E43550)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_FORMATFLOATNUMBER_OFFSET UNITYSDK_OFFSET(0x19E44140)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_FORMATINTNUMBER_OFFSET UNITYSDK_OFFSET(0x19E44900)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_FORMATNUMBER2INT_OFFSET UNITYSDK_OFFSET(0x19E439D0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_GETFORMATNUMBER_OFFSET UNITYSDK_OFFSET(0x19E432E0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_GET_SPEEDCURVE_OFFSET UNITYSDK_OFFSET(0x19E430B0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_NORMALIZEDTIMETOREALTIME_OFFSET UNITYSDK_OFFSET(0x19E43160)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_ONUPDATENUMBERCOMPLETE_OFFSET UNITYSDK_OFFSET(0x19E43440)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_REALTIMETONORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x19E449F0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_REMOVE_ONFINISH_OFFSET UNITYSDK_OFFSET(0x19E44BE0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_RESET_OFFSET UNITYSDK_OFFSET(0x19E42DA0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETFLOATNUMBER_OFFSET UNITYSDK_OFFSET(0x19E43E10)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETNUMBERINST_OFFSET UNITYSDK_OFFSET(0x19E43D70)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETNUMBERSTRING_OFFSET UNITYSDK_OFFSET(0x19E44210)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETNUMBERTHOUSANDTYPE_OFFSET UNITYSDK_OFFSET(0x19E43620)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETNUMBER_1_OFFSET UNITYSDK_OFFSET(0x19E43B30)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETNUMBER_2_OFFSET UNITYSDK_OFFSET(0x19E43680)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x19E438C0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E42DF0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E44CC0)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E44C60)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__SETNUMBERSTRING_G__GETFORMATANDNUMBER_16_2_OFFSET UNITYSDK_OFFSET(0x19E44360)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__SETNUMBERSTRING_G__ISDECIMALSEPARATOR_16_1_OFFSET UNITYSDK_OFFSET(0x19E44D70)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__SETNUMBERSTRING_G__ISNUMBER_16_0_OFFSET UNITYSDK_OFFSET(0x19E44D60)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__SETNUMBER_B__12_0_OFFSET UNITYSDK_OFFSET(0x19E44D40)
#define UNITYENGINE_UI_EXTENSION_UIDYNAMICNUMBERLABEL__SETNUMBER_B__14_0_OFFSET UNITYSDK_OFFSET(0x19E44D50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIDynamicNumberLabel_TypeDefinitionIndex = 49684;
	...
	public:
		...
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(UIDynamicNumberLabel_TypeDefinitionIndex)->GetStaticField(0x3AF20);
		}
