...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x1BB29870)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1BB297C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1BB29760)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_JUDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0x1BB29A40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB29C90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x1BB29D10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1BB29DC0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1BB29E70)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_TwoPointDragFloat_TypeDefinitionIndex = 82326;
