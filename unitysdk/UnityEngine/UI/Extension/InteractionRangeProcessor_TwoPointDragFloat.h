...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x1CB96B80)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1CB96AD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1CB96A70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_JUDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0x1CB96CE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB96F30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x1CB96FB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1CB97060)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1CB97110)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_TwoPointDragFloat_TypeDefinitionIndex = 46485;
