...
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1AAE3120)
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER_START_OFFSET UNITYSDK_OFFSET(0x1AAE2F20)
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE2E80)
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER___BASE_START_OFFSET UNITYSDK_OFFSET(0x1AAE38A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICustomCorner_TypeDefinitionIndex = 53432;
