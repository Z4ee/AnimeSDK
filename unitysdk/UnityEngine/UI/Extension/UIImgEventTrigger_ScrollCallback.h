...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF52230)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF52260)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF51D30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF51D10)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_ScrollCallback_TypeDefinitionIndex = 65772;
