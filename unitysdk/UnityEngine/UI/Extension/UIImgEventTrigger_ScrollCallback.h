...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E2CF80)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E2CFB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E2CA80)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2CA70)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_ScrollCallback_TypeDefinitionIndex = 81051;
