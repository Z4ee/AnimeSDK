...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE4C840)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE4C8A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE4C090)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4C080)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_BeginDragCallback_TypeDefinitionIndex = 81058;
