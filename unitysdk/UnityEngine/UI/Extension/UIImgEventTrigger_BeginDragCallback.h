...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AEB00A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AEB0100)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEAF8F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEAF8D0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_BeginDragCallback_TypeDefinitionIndex = 65755;
