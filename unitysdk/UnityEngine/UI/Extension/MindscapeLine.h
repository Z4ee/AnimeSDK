...
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x19E3D620)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0x19E3CF30)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x19E3D3F0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_LERP_OFFSET UNITYSDK_OFFSET(0x19E3CFF0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0x19E3D7B0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_POINTONLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x19E3D6B0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0x19E3CF40)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3CF50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int MindscapeLine_TypeDefinitionIndex = 46595;

	class MindscapeLine : public ::System::Object
	{
	public:
		::System::Single _Angle_k__BackingField; // 0x10
		::System::Single _t; // 0x14
		::UnityEngine::Vector2 _p; // 0x18
		::UnityEngine::Vector2 _d; // 0x20
