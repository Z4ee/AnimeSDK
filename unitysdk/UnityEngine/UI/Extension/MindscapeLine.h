...
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x1F1D0CA0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1F1D05C0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x1F1D0A70)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_LERP_OFFSET UNITYSDK_OFFSET(0x1F1D0690)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0x1F1D0E30)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_POINTONLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F1D0D30)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1F1D05D0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1D05E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int MindscapeLine_TypeDefinitionIndex = 47556;

	class MindscapeLine : public ::System::Object
	{
	public:
		::System::Single _Angle_k__BackingField; // 0x10
		::UnityEngine::Vector2 _p; // 0x14
		::UnityEngine::Vector2 _d; // 0x1C
		::System::Single _t; // 0x24
