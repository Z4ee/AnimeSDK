...
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1F444230)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_CONVERTWORLDPOSTOLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1F443420)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1F4448C0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F4446E0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1F442BE0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GET_SOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F443020)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F444320)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1F444370)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_PACKTARGETPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1F443EE0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F443900)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITIONS_1_OFFSET UNITYSDK_OFFSET(0x1F443D00)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1F4439A0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1F443C00)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1F443B50)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETWIDTH_OFFSET UNITYSDK_OFFSET(0x1F4449F0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SET_TARGETCOUNT_OFFSET UNITYSDK_OFFSET(0x1F443030)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SET_TRANSITIONEND_OFFSET UNITYSDK_OFFSET(0x1F4432E0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SET_TRANSITIONSTART_OFFSET UNITYSDK_OFFSET(0x1F4431A0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F444A50)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F443E60)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F444B10)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1F444AB0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F444B20)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1F444B30)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIMatchGameTrail_TypeDefinitionIndex = 19347;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMatchGameTrail_TypeDefinitionIndex)->GetStaticField(0x43C0);
		}
		static ::System::Int32* StaticGet_PackedParam0PropId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMatchGameTrail_TypeDefinitionIndex)->GetStaticField(0x43C4);
		}
		static ::System::Int32* StaticGet_TargetPositionsPropId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMatchGameTrail_TypeDefinitionIndex)->GetStaticField(0x43C8);
		}
