...
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x3C9DA0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x324690)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E8312A0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E831210)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x3C9DB0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x324490)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x462A80)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int SetTimeStampCountParam_TypeDefinitionIndex = 82190;
