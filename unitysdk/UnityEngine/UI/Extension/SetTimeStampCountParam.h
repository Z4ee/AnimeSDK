...
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x3E3F20)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x2ACBE0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AEAF2E0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AEAF250)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x446DB0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x2ACBF0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x446DA0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int SetTimeStampCountParam_TypeDefinitionIndex = 50695;
