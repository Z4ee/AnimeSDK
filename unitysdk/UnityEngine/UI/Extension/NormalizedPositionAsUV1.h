...
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_GET_USECUSTOMRECTTRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x1AEAC4E0)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1AEAC790)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_START_OFFSET UNITYSDK_OFFSET(0x1AEAC590)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEAC4F0)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1___BASE_START_OFFSET UNITYSDK_OFFSET(0x1AEAD1D0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int NormalizedPositionAsUV1_TypeDefinitionIndex = 86274;
