...
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_GET_USECUSTOMRECTTRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x1AE4AB30)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1AE4ADE0)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_START_OFFSET UNITYSDK_OFFSET(0x1AE4ABE0)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4AB40)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1___BASE_START_OFFSET UNITYSDK_OFFSET(0x1AE4B820)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int NormalizedPositionAsUV1_TypeDefinitionIndex = 71930;
