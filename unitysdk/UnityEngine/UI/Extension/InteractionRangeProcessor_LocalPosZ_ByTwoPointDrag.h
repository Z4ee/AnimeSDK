...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A1605B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A160530)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A160660)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A160320)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A160700)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A160750)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByTwoPointDrag_TypeDefinitionIndex = 73105;
