...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A0F0AB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A0F0A30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A0F0B60)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F0820)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A0F0C00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A0F0C50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByTwoPointDrag_TypeDefinitionIndex = 73837;
