...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18EBFF50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18EBFF90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18EBF9D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBF9C0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnDataEvent_TypeDefinitionIndex = 63948;
