...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5ADC00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5ADC40)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AD680)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDATAEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AD660)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnDataEvent_TypeDefinitionIndex = 59835;
