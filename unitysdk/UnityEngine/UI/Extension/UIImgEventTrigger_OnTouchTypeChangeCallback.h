...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C64470)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C644A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C61D70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C64450)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_OnTouchTypeChangeCallback_TypeDefinitionIndex = 71310;
