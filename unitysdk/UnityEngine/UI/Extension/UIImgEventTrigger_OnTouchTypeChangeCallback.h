...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC212C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC212F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC1EBB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC212A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_OnTouchTypeChangeCallback_TypeDefinitionIndex = 65757;
