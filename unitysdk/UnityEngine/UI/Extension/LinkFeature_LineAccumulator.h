...
#define UNITYENGINE_UI_EXTENSION_LINKFEATURE_LINEACCUMULATOR_EXPAND_OFFSET UNITYSDK_OFFSET(0x81C7D0)
#define UNITYENGINE_UI_EXTENSION_LINKFEATURE_LINEACCUMULATOR_FLUSHTO_OFFSET UNITYSDK_OFFSET(0x81C8C0)
#define UNITYENGINE_UI_EXTENSION_LINKFEATURE_LINEACCUMULATOR_RESET_OFFSET UNITYSDK_OFFSET(0x81C780)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int LinkFeature_LineAccumulator_TypeDefinitionIndex = 47484;
