...
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7D2D40)
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7D2E40)
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x143BB7A0)
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x143BB920)
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x3E4260)
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7D2E50)
#define UNITYENGINE_UI_EXTENSION_NAP_HIGHLIGHTSTATE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7D2EC0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int NAP_HighlightState_TypeDefinitionIndex = 41584;
