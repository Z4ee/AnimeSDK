...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C6B7610)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C6B7670)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C6B6E60)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6B6E40)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_EndDragCallback_TypeDefinitionIndex = 65771;
