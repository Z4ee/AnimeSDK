...
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_FORCEPIXELPERFECTPOS_OFFSET UNITYSDK_OFFSET(0x18D52200)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x18D52920)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D52160)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIForcePixelPerfect_TypeDefinitionIndex = 55758;
