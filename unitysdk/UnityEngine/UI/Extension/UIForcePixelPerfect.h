...
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_FORCEPIXELPERFECTPOS_OFFSET UNITYSDK_OFFSET(0x1CC1CFA0)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1CC1D6C0)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC1CF00)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIForcePixelPerfect_TypeDefinitionIndex = 70363;
