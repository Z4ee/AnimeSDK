...
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0x1D3424D0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1D341D60)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1D341E10)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1D341EC0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1D341CF0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_RESETPOS_OFFSET UNITYSDK_OFFSET(0x1D341FC0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x1D3420F0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D342A60)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1D342B10)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1D342B20)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1D342B30)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1D342BE0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x1D342BF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int ScrollRectEx_TypeDefinitionIndex = 86531;
