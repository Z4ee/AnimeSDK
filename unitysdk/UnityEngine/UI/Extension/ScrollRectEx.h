...
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0x1B5AB7D0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1B5AB060)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B5AB110)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1B5AB1C0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1B5AAFF0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_RESETPOS_OFFSET UNITYSDK_OFFSET(0x1B5AB2C0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B5AB3F0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5ABD50)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1B5ABE00)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B5ABE10)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1B5ABE20)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1B5ABED0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B5ABEE0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int ScrollRectEx_TypeDefinitionIndex = 65798;
