...
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_CLEAN_OFFSET UNITYSDK_OFFSET(0x143C0230)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_GET_ISEND_OFFSET UNITYSDK_OFFSET(0x143BF9A0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_GET__MODEL_OFFSET UNITYSDK_OFFSET(0x143BF890)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_HIDETIME_OFFSET UNITYSDK_OFFSET(0x143C1AB0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x143C01E0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x143BFA90)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_REMOVEENDCALL_OFFSET UNITYSDK_OFFSET(0x143C0610)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETALLCOLOR_OFFSET UNITYSDK_OFFSET(0x143C1840)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETICONACTIVE_OFFSET UNITYSDK_OFFSET(0x143C2050)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETICONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x143C1B60)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOLOR_OFFSET UNITYSDK_OFFSET(0x1438F7D0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOUNTUP_OFFSET UNITYSDK_OFFSET(0x1438E360)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEDESCOLOR_OFFSET UNITYSDK_OFFSET(0x143C1A10)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEOUT_OFFSET UNITYSDK_OFFSET(0x143C07D0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESHOWTYPE_OFFSET UNITYSDK_OFFSET(0x143C17F0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESTAMPCOUNTDOWN_1_OFFSET UNITYSDK_OFFSET(0x143C0760)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESTAMPCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x143C0660)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x143C17A0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIME_1_OFFSET UNITYSDK_OFFSET(0x1438EA60)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIME_OFFSET UNITYSDK_OFFSET(0x143C0830)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLEACTIVE_OFFSET UNITYSDK_OFFSET(0x1438DAE0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLE_1_OFFSET UNITYSDK_OFFSET(0x143C21E0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLE_OFFSET UNITYSDK_OFFSET(0x1438DC60)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_STOPTIMESTAMPCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x143C04E0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_DEFAULT_OFFSET UNITYSDK_OFFSET(0x143C1340)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_HOURMINUTESECOND_OFFSET UNITYSDK_OFFSET(0x143C0C30)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_HOURMINUTE_OFFSET UNITYSDK_OFFSET(0x143C0AD0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_MINUTESECOND_OFFSET UNITYSDK_OFFSET(0x143C0F80)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_ONLYDAY_OFFSET UNITYSDK_OFFSET(0x143C1210)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_ONLYONE_OFFSET UNITYSDK_OFFSET(0x143C08B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_UPDATETICK_OFFSET UNITYSDK_OFFSET(0x143BFB30)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_UPDATE_OFFSET UNITYSDK_OFFSET(0x143BFAE0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x143C24B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITimeWidget_TypeDefinitionIndex = 65549;
