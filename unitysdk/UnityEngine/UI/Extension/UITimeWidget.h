...
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_CLEAN_OFFSET UNITYSDK_OFFSET(0x18B51D10)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_GET_ISEND_OFFSET UNITYSDK_OFFSET(0x18B51480)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_GET__MODEL_OFFSET UNITYSDK_OFFSET(0x18B51370)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_HIDETIME_OFFSET UNITYSDK_OFFSET(0x18B53E30)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18B51CC0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18B51570)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_REMOVEENDCALL_OFFSET UNITYSDK_OFFSET(0x18B520F0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETALLCOLOR_1_OFFSET UNITYSDK_OFFSET(0x18B53650)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETALLCOLOR_OFFSET UNITYSDK_OFFSET(0x18B535B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETICONACTIVE_OFFSET UNITYSDK_OFFSET(0x18B543D0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETICONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x18B53EE0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOLOR_1_OFFSET UNITYSDK_OFFSET(0x18B53A80)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOLOR_OFFSET UNITYSDK_OFFSET(0x18B53D90)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOUNTUP_OFFSET UNITYSDK_OFFSET(0x18B52310)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEDESCOLOR_1_OFFSET UNITYSDK_OFFSET(0x18B53810)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEDESCOLOR_OFFSET UNITYSDK_OFFSET(0x18B53CF0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18B522B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESHOWTYPE_OFFSET UNITYSDK_OFFSET(0x18B53560)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESTAMPCOUNTDOWN_1_OFFSET UNITYSDK_OFFSET(0x18B52240)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESTAMPCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18B52140)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x18B53510)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIME_1_OFFSET UNITYSDK_OFFSET(0x18B52550)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIME_OFFSET UNITYSDK_OFFSET(0x18B524D0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLEACTIVE_OFFSET UNITYSDK_OFFSET(0x18B54560)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLE_1_OFFSET UNITYSDK_OFFSET(0x18B54870)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLE_OFFSET UNITYSDK_OFFSET(0x18B546E0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_STOPTIMESTAMPCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18B51FC0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_DEFAULT_OFFSET UNITYSDK_OFFSET(0x18B530B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_HOURMINUTESECOND_OFFSET UNITYSDK_OFFSET(0x18B529A0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_HOURMINUTE_OFFSET UNITYSDK_OFFSET(0x18B52840)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_MINUTESECOND_OFFSET UNITYSDK_OFFSET(0x18B52CF0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_ONLYDAY_OFFSET UNITYSDK_OFFSET(0x18B52F80)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_ONLYONE_OFFSET UNITYSDK_OFFSET(0x18B52620)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_UPDATETICK_OFFSET UNITYSDK_OFFSET(0x18B51610)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_UPDATE_OFFSET UNITYSDK_OFFSET(0x18B515C0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18B54B30)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITimeWidget_TypeDefinitionIndex = 61320;
	...
	public:
		...
		::UnityEngine::UI::Extension::UITimeWidget_Model* __model; // 0xD0
		...
		::UnityEngine::UI::Extension::UITimeWidget_Model* get__model()
		{
			return ((::UnityEngine::UI::Extension::UITimeWidget_Model*(*)(::PVOID))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_GET__MODEL_OFFSET))(this);
		}
		...
		::System::Void SetAllColor_1(::UnityEngine::Color color)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Color))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETALLCOLOR_1_OFFSET))(this, color);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Color))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEDESCOLOR_1_OFFSET))(this, color);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Color))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOLOR_1_OFFSET))(this, color);
		}
