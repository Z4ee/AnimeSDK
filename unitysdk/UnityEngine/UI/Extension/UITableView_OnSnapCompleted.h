...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x150AD370)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x150AD3F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_INVOKE_OFFSET UNITYSDK_OFFSET(0x150AC710)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED__CTOR_OFFSET UNITYSDK_OFFSET(0x150AD360)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnSnapCompleted_TypeDefinitionIndex = 63958;
