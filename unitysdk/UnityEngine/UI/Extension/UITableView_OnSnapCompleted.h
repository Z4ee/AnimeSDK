...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE4800)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE4880)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE3B90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE47E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnSnapCompleted_TypeDefinitionIndex = 59841;
