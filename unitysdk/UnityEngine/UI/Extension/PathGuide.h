...
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_CLEARPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x1EF2C460)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1EF2D840)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1EF2D660)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1EF2C110)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_ENDCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1EF2C8F0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EF2B7E0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1EF2BD50)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_PATHGUIDEMESH_OFFSET UNITYSDK_OFFSET(0x1EF2BF30)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EF2B730)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_QUADSIZE_OFFSET UNITYSDK_OFFSET(0x1EF2C530)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_SPACING_OFFSET UNITYSDK_OFFSET(0x1EF2C670)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_STARTCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1EF2C7B0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1EF2BC10)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EF2DF30)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EF2E120)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1EF2CA30)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINTSDIRTY_OFFSET UNITYSDK_OFFSET(0x1EF2C070)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x1EF2C2D0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1EF2C190)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_ENDCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1EF2C900)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1EF2BD60)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_PATHGUIDEMESH_OFFSET UNITYSDK_OFFSET(0x1EF2BF40)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_QUADSIZE_OFFSET UNITYSDK_OFFSET(0x1EF2C540)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_SPACING_OFFSET UNITYSDK_OFFSET(0x1EF2C680)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_STARTCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1EF2C7C0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1EF2BC20)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EF2E1C0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF2B740)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1EF2E280)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EF2E220)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EF2E290)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EF2E2A0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1EF2E340)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1EF2E350)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int PathGuide_TypeDefinitionIndex = 19345;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x4400);
		}
		static ::System::Int32* StaticGet_QuadCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x4404);
		}
		static ::System::Int32* StaticGet_TransformData2Array()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x4408);
		}
