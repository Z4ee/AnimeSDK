...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D343410)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D343470)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D342C20)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D342C00)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_DragCallback_TypeDefinitionIndex = 71297;
