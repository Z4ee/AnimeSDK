...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AC6C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AC720)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5ABF10)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5ABEF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_DragCallback_TypeDefinitionIndex = 65768;
