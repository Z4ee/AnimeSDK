...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CC1D730)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x1CC207C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GETCURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0x1CC1DC50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURCONTROLSINGLEPOINT_OFFSET UNITYSDK_OFFSET(0x1CC1D720)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0x1CC1F170)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_INITINTERACTIONPROCESSORS_OFFSET UNITYSDK_OFFSET(0x1CC1D8E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0x1CC1F440)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISSCROLLRECEIVER_OFFSET UNITYSDK_OFFSET(0x1CC1F340)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISTWOPOINTDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0x1CC1F3C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_KILL_OFFSET UNITYSDK_OFFSET(0x1CC20760)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1CC1D980)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1CC1E4D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CC1E470)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1CC1DDE0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDROP_OFFSET UNITYSDK_OFFSET(0x1CC1E750)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1CC1E610)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1CC1E7E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1CC1EE50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1CC1EEB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1CC1EF10)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1CC1F180)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1CC1EB40)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x1CC1F4C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_CHANGEFOV_SCROLLY_OFFSET UNITYSDK_OFFSET(0x1CC1F980)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_FOV_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x1CC20000)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVECAMY_DRAGY_OFFSET UNITYSDK_OFFSET(0x1CC20520)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_SCROLLY_OFFSET UNITYSDK_OFFSET(0x1CC1F5D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x1CC1FD40)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_ROTATEY_DRAGX_OFFSET UNITYSDK_OFFSET(0x1CC20300)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_WAITALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0x1CC1F520)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC20830)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1CC20940)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1CC209E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDROP_OFFSET UNITYSDK_OFFSET(0x1CC20A80)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1CC20B20)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1CC20BC0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1CC20C60)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1CC20D00)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1CC20DA0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1CC20E40)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TypeDefinitionIndex = 65754;
