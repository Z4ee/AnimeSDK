...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C60920)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x18C63970)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GETCURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0x18C60E40)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURCONTROLSINGLEPOINT_OFFSET UNITYSDK_OFFSET(0x18C60910)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0x18C62320)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_INITINTERACTIONPROCESSORS_OFFSET UNITYSDK_OFFSET(0x18C60AD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0x18C625F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISSCROLLRECEIVER_OFFSET UNITYSDK_OFFSET(0x18C624F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISTWOPOINTDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0x18C62570)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_KILL_OFFSET UNITYSDK_OFFSET(0x18C63910)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18C60B70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x18C616A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C61640)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x18C60FD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDROP_OFFSET UNITYSDK_OFFSET(0x18C61920)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x18C617E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x18C619B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x18C62000)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x18C62060)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x18C620C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x18C62330)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x18C61D00)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x18C62670)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_CHANGEFOV_SCROLLY_OFFSET UNITYSDK_OFFSET(0x18C62B30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_FOV_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x18C631B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVECAMY_DRAGY_OFFSET UNITYSDK_OFFSET(0x18C636D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_SCROLLY_OFFSET UNITYSDK_OFFSET(0x18C62780)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x18C62EF0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_ROTATEY_DRAGX_OFFSET UNITYSDK_OFFSET(0x18C634B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_WAITALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0x18C626D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C639E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x18C63AF0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x18C63B90)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDROP_OFFSET UNITYSDK_OFFSET(0x18C63C30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x18C63CD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x18C63D70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x18C63E10)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x18C63EB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x18C63F50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x18C63FF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TypeDefinitionIndex = 71294;
