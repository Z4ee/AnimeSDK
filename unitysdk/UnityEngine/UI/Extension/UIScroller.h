...
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C69DF0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x18C6C3D0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x18C6C410)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATEOFFSET_OFFSET UNITYSDK_OFFSET(0x18C6A4C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ENSURELAYOUTHASREBUILT_OFFSET UNITYSDK_OFFSET(0x18C6A1C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x18C6C590)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x18C6C540)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x18C6BA80)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x18C6C4A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x18C6C470)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x18C6C4B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x18C6C480)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x18C6C450)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_CONTENT_OFFSET UNITYSDK_OFFSET(0x18C69370)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_DRAGGING_OFFSET UNITYSDK_OFFSET(0x18C693B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18C69390)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x18C6BA70)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x18C6C490)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x18C6C460)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x18C693D0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GRAPHICUPDATECOMPLETE_OFFSET UNITYSDK_OFFSET(0x18C69DB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18C6A000)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18C6ADD0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_LAYOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x18C69D70)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x18C6A690)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C6CB90)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18C69F20)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x18C6A8E0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18C69EB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x18C6A880)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x18C6A620)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x18C6BA10)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x18C6C2E0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x18C6A250)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_REBUILD_OFFSET UNITYSDK_OFFSET(0x18C695F0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_RUBBERDELTA_OFFSET UNITYSDK_OFFSET(0x18C6ABD0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x18C6AC80)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETDIRTYCACHING_OFFSET UNITYSDK_OFFSET(0x18C6CAF0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x18C6C330)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x18C6C4C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x18C6C500)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x18C6BDA0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_CONTENT_OFFSET UNITYSDK_OFFSET(0x18C69380)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_DRAGGING_OFFSET UNITYSDK_OFFSET(0x18C693C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18C693A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x18C6BD40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x18C69450)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UNITYENGINE_UI_ICANVASELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x18C6CC00)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x18C69770)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UPDATEPREVDATA_OFFSET UNITYSDK_OFFSET(0x18C69BA0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C69510)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C6CC50)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18C6CCE0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C6CD70)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18C6CE00)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18C6CE90)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x18C6CF20)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIScroller_TypeDefinitionIndex = 56991;
