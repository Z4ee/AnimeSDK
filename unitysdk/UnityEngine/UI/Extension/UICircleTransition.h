...
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_CALCULATECENTERUV_OFFSET UNITYSDK_OFFSET(0x18AEA200)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_CALCULATEMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x18AE96E0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18AEA480)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18AE9200)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_MODIFIERSORTORDER_OFFSET UNITYSDK_OFFSET(0x18AEA650)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x18AE9300)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x18AE9FC0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x18AEA0E0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18AE9AA0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18AE9EF0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18AE9A00)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18AE9960)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x18AE9CB0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x18AE9DD0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x18AE98E0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x18AEA690)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE9260)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x18AEA6F0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x18AEA780)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18AEA810)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18AEA8A0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18AEA8B0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18AEA8C0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x18AEA8D0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x18AEA960)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICircleTransition_TypeDefinitionIndex = 78934;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UICircleTransition_TypeDefinitionIndex)->GetStaticField(0xBA00);
		}
		static ::System::Int32* StaticGet_CircleSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UICircleTransition_TypeDefinitionIndex)->GetStaticField(0xBA04);
		}
		static ::System::Int32* StaticGet_Invert()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UICircleTransition_TypeDefinitionIndex)->GetStaticField(0xBA08);
		}
