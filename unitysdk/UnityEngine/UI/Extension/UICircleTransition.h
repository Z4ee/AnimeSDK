...
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_CALCULATECENTERUV_OFFSET UNITYSDK_OFFSET(0x1AC7C790)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_CALCULATEMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x1AC7BC70)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AC7CA10)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AC7B790)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_MODIFIERSORTORDER_OFFSET UNITYSDK_OFFSET(0x1AC7CBE0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1AC7B890)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7C550)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7C670)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC7C030)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC7C480)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AC7BF90)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AC7BEF0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AC7C240)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7C360)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1AC7BE70)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC7CC20)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7B7F0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7CC80)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7CD10)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC7CDA0)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC7CE30)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AC7CE40)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AC7CE50)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AC7CE60)
#define UNITYENGINE_UI_EXTENSION_UICIRCLETRANSITION___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7CEF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICircleTransition_TypeDefinitionIndex = 53899;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UICircleTransition_TypeDefinitionIndex)->GetStaticField(0xBF30);
		}
		static ::System::Int32* StaticGet_CircleSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UICircleTransition_TypeDefinitionIndex)->GetStaticField(0xBF34);
		}
		static ::System::Int32* StaticGet_Invert()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UICircleTransition_TypeDefinitionIndex)->GetStaticField(0xBF38);
		}
