...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x143BB310)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x143BB560)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x143BB360)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY__CTOR_OFFSET UNITYSDK_OFFSET(0x143BB1C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x143BB640)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x143BB6D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x143BB720)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateX_ByDeltaY_TypeDefinitionIndex = 50279;
