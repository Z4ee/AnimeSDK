...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18B4CD20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18B4CF60)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18B4CD70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4CBD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18B4D030)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18B4D0C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18B4D110)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateX_ByDeltaY_TypeDefinitionIndex = 54108;
