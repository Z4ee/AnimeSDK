...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG_GETVALUE_OFFSET UNITYSDK_OFFSET(0xF2A8210)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG_SETVALUE_OFFSET UNITYSDK_OFFSET(0xF2A81A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG_SIMULATE_OFFSET UNITYSDK_OFFSET(0xF2A8270)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0xF2A80A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0xF2A8310)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0xF2A8360)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_Fov_ByTwoPointDrag_TypeDefinitionIndex = 42087;
