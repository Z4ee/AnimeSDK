...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8E8E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8E870)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1DE8E940)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE8E770)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8E9E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYTWOPOINTDRAG___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8EA30)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_Fov_ByTwoPointDrag_TypeDefinitionIndex = 47852;
