...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_ADDHANDLE_OFFSET UNITYSDK_OFFSET(0x1A687C00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_DISPOSEALL_OFFSET UNITYSDK_OFFSET(0x1A687340)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x1A687750)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_GETRESOURCE_OFFSET UNITYSDK_OFFSET(0x1A6880E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_HANDLEEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x1A687170)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_HANDLEEVENTDATA_OFFSET UNITYSDK_OFFSET(0x1A686F60)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_ISALLPROCESSORSNOTCLAMPING_OFFSET UNITYSDK_OFFSET(0x1A687F90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_KILL_OFFSET UNITYSDK_OFFSET(0x1A687500)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REFRESHINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x1A687AB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x1A687CD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REMOVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1A687620)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x1A686E10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_WAITUNTILALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0x1A687EE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6881C0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorManager_TypeDefinitionIndex = 85961;
