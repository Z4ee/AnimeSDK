...
#define UNITYENGINE_UI_EXTENSION_UITIMEARROW_CANVASADDITIONALCHANNEL_OFFSET UNITYSDK_OFFSET(0x1EC69B90)
#define UNITYENGINE_UI_EXTENSION_UITIMEARROW_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1EC69DD0)
#define UNITYENGINE_UI_EXTENSION_UITIMEARROW_START_OFFSET UNITYSDK_OFFSET(0x1EC69C20)
#define UNITYENGINE_UI_EXTENSION_UITIMEARROW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1EC69CA0)
#define UNITYENGINE_UI_EXTENSION_UITIMEARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC69AF0)
#define UNITYENGINE_UI_EXTENSION_UITIMEARROW___BASE_START_OFFSET UNITYSDK_OFFSET(0x1EC6A150)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITimeArrow_TypeDefinitionIndex = 62724;
