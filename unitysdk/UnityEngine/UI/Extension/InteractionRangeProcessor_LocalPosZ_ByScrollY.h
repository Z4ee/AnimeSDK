...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18AE76C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18AE77C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18AE7760)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE7590)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18AE7850)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18AE7930)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18AE7980)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByScrollY_TypeDefinitionIndex = 45493;
