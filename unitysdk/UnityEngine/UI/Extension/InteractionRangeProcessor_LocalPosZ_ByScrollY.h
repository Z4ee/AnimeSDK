...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1AC79800)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1AC79900)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1AC798A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC796D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1AC79990)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1AC79A70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1AC79AC0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByScrollY_TypeDefinitionIndex = 67976;
