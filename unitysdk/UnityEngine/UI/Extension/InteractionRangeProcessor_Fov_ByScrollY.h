...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1C3F3E80)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1C3F3F90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1C3F3F20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3F3D50)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1C3F3FF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1C3F40D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1C3F4120)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_Fov_ByScrollY_TypeDefinitionIndex = 81931;
