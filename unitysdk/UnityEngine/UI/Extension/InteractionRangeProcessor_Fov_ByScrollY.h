...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1A160020)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A160130)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A1600C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A15FEF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1A160190)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A160270)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A1602C0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_Fov_ByScrollY_TypeDefinitionIndex = 80623;
