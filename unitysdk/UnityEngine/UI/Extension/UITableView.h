...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ACTIVEDRAG_OFFSET UNITYSDK_OFFSET(0x1BF55A60)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDCELL_OFFSET UNITYSDK_OFFSET(0x1BF58290)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATAAT_1_OFFSET UNITYSDK_OFFSET(0x1BF53A30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATAAT_OFFSET UNITYSDK_OFFSET(0x1BF53980)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATA_1_OFFSET UNITYSDK_OFFSET(0x1BF538E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATA_OFFSET UNITYSDK_OFFSET(0x1BF53790)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BF56A50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATEACTIVECELLSASYNC_OFFSET UNITYSDK_OFFSET(0x1BF5A580)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0x1BF5A110)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECELLOFFSETS_OFFSET UNITYSDK_OFFSET(0x1BF58AA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECELLSIZES_OFFSET UNITYSDK_OFFSET(0x1BF58C20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1BF597C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECURRENTACTIVECELLRANGE_OFFSET UNITYSDK_OFFSET(0x1BF5A2D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATESCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF57940)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CHECKDATASTATE_OFFSET UNITYSDK_OFFSET(0x1BF55E30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CLEARDELAY_OFFSET UNITYSDK_OFFSET(0x1BF55620)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BF55160)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_DEQUEUEORCREATECELL_OFFSET UNITYSDK_OFFSET(0x1BF57D50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_EXPANDLINESIZE_OFFSET UNITYSDK_OFFSET(0x1BF589C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCELLAT_OFFSET UNITYSDK_OFFSET(0x1BF53F50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCELL_OFFSET UNITYSDK_OFFSET(0x1BF55080)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1BF5AEE0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAAT_OFFSET UNITYSDK_OFFSET(0x1BF54590)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAINDEXBYCELL_OFFSET UNITYSDK_OFFSET(0x1BF54F10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x1BF54910)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATA_OFFSET UNITYSDK_OFFSET(0x1BF544D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETLINEINDEXATPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1BF5AA70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETLINEINDEXATPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF57830)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETONETABLEVIEWCELL_OFFSET UNITYSDK_OFFSET(0x1BF57F60)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_AXISRECTS_OFFSET UNITYSDK_OFFSET(0x1BF578E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x1BF53670)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_ISCALCULATE_OFFSET UNITYSDK_OFFSET(0x1BF53430)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_MAXPERLINE_OFFSET UNITYSDK_OFFSET(0x1BF533C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1BF57CD0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF53450)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SCROLLRECTSIZE_OFFSET UNITYSDK_OFFSET(0x1BF53580)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x1BF53720)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SELECTEDITEM_OFFSET UNITYSDK_OFFSET(0x1BF53690)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_HANDLECLICK_OFFSET UNITYSDK_OFFSET(0x1BF56850)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_HANDLEPRESS_OFFSET UNITYSDK_OFFSET(0x1BF56790)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ISDISABLED_OFFSET UNITYSDK_OFFSET(0x1BF55EC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1BF55D70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_JUMPTO_1_OFFSET UNITYSDK_OFFSET(0x1BF55D00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_JUMPTO_OFFSET UNITYSDK_OFFSET(0x1BF55C70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_LINEAR_OFFSET UNITYSDK_OFFSET(0x1BF5AE40)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BF5AF50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BF57740)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BF576F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1BF56490)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1BF56320)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1BF56720)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1BF5A6B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RECYCLECELL_OFFSET UNITYSDK_OFFSET(0x1BF54380)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF5AD70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REFRESH_OFFSET UNITYSDK_OFFSET(0x1BF55AC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RELEASECACHES_OFFSET UNITYSDK_OFFSET(0x1BF558B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REMOVEDATAAT_OFFSET UNITYSDK_OFFSET(0x1BF54110)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REMOVEDATA_OFFSET UNITYSDK_OFFSET(0x1BF54020)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RESIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1BF588D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETCELLPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF58450)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDATAAT_1_OFFSET UNITYSDK_OFFSET(0x1BF53D10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDATAAT_OFFSET UNITYSDK_OFFSET(0x1BF53C50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDISABLEAT_1_OFFSET UNITYSDK_OFFSET(0x1BF54670)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDISABLEAT_OFFSET UNITYSDK_OFFSET(0x1BF54610)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECTAT_1_OFFSET UNITYSDK_OFFSET(0x1BF54AF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECTAT_OFFSET UNITYSDK_OFFSET(0x1BF54BC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECT_1_OFFSET UNITYSDK_OFFSET(0x1BF54890)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECT_OFFSET UNITYSDK_OFFSET(0x1BF547E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSTATE_1_OFFSET UNITYSDK_OFFSET(0x1BF54720)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1BF56110)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_ISCALCULATE_OFFSET UNITYSDK_OFFSET(0x1BF53440)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_MAXPERLINE_OFFSET UNITYSDK_OFFSET(0x1BF533D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF53460)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYCALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0x1BF5A020)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYJUMPTO_OFFSET UNITYSDK_OFFSET(0x1BF5A8D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSHOULDKEEPPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF5A600)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTARTSNAP_OFFSET UNITYSDK_OFFSET(0x1BF56520)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTOPCALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0x1BF55460)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTOPSNAP_OFFSET UNITYSDK_OFFSET(0x1BF55550)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TWEENPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF57BF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATEACTIVECELLSTATES_OFFSET UNITYSDK_OFFSET(0x1BF55F80)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATESELECTION_OFFSET UNITYSDK_OFFSET(0x1BF54C20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BF5AB30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF5B000)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BF5B340)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BF5B350)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BF5B460)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BF5B470)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1BF5B480)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1BF5B530)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1BF5B5E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_TypeDefinitionIndex = 59830;
