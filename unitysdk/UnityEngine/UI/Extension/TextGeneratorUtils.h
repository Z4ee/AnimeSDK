...
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_CLASSIFYZEROWIDTH_OFFSET UNITYSDK_OFFSET(0x1BB2BC50)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_COMPUTEGLYPHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BB2AA50)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_EXTRACTVALIDQUADBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BB2B670)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_GETQUADTAGMATERIAL_OFFSET UNITYSDK_OFFSET(0x1BB2A370)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_ISGLYPHCHARACTER_OFFSET UNITYSDK_OFFSET(0x1BB29F90)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_ISLINECURSORYRELIABLE_OFFSET UNITYSDK_OFFSET(0x1BB2BD30)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_ISNONDEFAULTMATERIALQUAD_OFFSET UNITYSDK_OFFSET(0x1BB2A980)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_ISNONSPACINGMARK_OFFSET UNITYSDK_OFFSET(0x1BB2A090)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_ISPREREORDERBUFFER_OFFSET UNITYSDK_OFFSET(0x1BB29F40)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_ISQUADTAGPLACEHOLDER_OFFSET UNITYSDK_OFFSET(0x1BB2A1A0)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_RESOLVEVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x1BB2B2A0)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_SKIPDEGENGLYPHVERTS_OFFSET UNITYSDK_OFFSET(0x1BB2B390)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS_SKIPDEGENQUADS_OFFSET UNITYSDK_OFFSET(0x1BB2A0E0)
#define UNITYENGINE_UI_EXTENSION_TEXTGENERATORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB2BDD0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int TextGeneratorUtils_TypeDefinitionIndex = 72738;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UI::Extension::TextGeneratorUtils_GlyphBoundsResult>**)Il2CppClass::FromTypeDefinitionIndex(TextGeneratorUtils_TypeDefinitionIndex)->GetStaticField(0x439F0);
		}
