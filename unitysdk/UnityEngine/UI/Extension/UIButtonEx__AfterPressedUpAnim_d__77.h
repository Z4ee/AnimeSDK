...
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F1D7270)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F1D75C0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F1D7620)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F1D75D0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F1D7260)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1D4CE0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIButtonEx__AfterPressedUpAnim_d__77_TypeDefinitionIndex = 85045;
