...
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19E423F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E42740)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E427A0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19E42750)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E423E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77__CTOR_OFFSET UNITYSDK_OFFSET(0x19E40030)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIButtonEx__AfterPressedUpAnim_d__77_TypeDefinitionIndex = 70890;
