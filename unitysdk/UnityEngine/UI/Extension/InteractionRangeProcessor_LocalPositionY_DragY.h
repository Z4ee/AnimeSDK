...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x17928F30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17929050)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17928F80)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY__CTOR_OFFSET UNITYSDK_OFFSET(0x17928E00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x179290C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17929150)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x179291A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPositionY_DragY_TypeDefinitionIndex = 76139;
