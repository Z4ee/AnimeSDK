...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A68D470)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A68D4C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A68CE30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A68CE10)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnCellTouchEvent_TypeDefinitionIndex = 65409;
