...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC7DDB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC7DE00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC7D700)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLTOUCHEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7D6E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnCellTouchEvent_TypeDefinitionIndex = 59842;
