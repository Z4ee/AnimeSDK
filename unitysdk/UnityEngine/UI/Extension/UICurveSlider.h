...
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_ISVALID_OFFSET UNITYSDK_OFFSET(0x150AAEC0)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_REFRESHHANDLE_OFFSET UNITYSDK_OFFSET(0x150AB560)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x150AB4C0)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x150AB930)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x150AB940)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICurveSlider_TypeDefinitionIndex = 62756;
