...
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AAE2340)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_REFRESHHANDLE_OFFSET UNITYSDK_OFFSET(0x1AAE29E0)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AAE2940)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE2DB0)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AAE2DC0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICurveSlider_TypeDefinitionIndex = 79852;
