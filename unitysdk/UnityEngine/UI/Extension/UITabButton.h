...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_ADDBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1A165080)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A1619B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x1A1645B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x1A164410)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_DOCLICK_OFFSET UNITYSDK_OFFSET(0x1A162210)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_ENABLEBADGE_OFFSET UNITYSDK_OFFSET(0x1A165720)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_GET_ISSELECT_OFFSET UNITYSDK_OFFSET(0x1A1619A0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A161B20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1A162830)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1A162C10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A161E10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_INIT_1_OFFSET UNITYSDK_OFFSET(0x1A161AB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_INIT_OFFSET UNITYSDK_OFFSET(0x1A161A40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x1A162F40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_PRECHECKCLICK_OFFSET UNITYSDK_OFFSET(0x1A1634F0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_REMOVEBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1A165130)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETASSETLOADPROXY_OFFSET UNITYSDK_OFFSET(0x1A162C60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETCLICKCHECKSELECTED_OFFSET UNITYSDK_OFFSET(0x1A1649D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x1A163430)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1A163580)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETFINISH_OFFSET UNITYSDK_OFFSET(0x1A1635F0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETFORCETRIGGER_OFFSET UNITYSDK_OFFSET(0x1A165030)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETICON_1_OFFSET UNITYSDK_OFFSET(0x1A1643A0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETICON_OFFSET UNITYSDK_OFFSET(0x1A164210)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETNORMALTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A163150)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETREDPOINT_1_OFFSET UNITYSDK_OFFSET(0x1A165570)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETREDPOINT_OFFSET UNITYSDK_OFFSET(0x1A1651E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETSELECTEDANIM_OFFSET UNITYSDK_OFFSET(0x1A163660)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x1A162CB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABLOCK_1_OFFSET UNITYSDK_OFFSET(0x1A164BB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABLOCK_OFFSET UNITYSDK_OFFSET(0x1A164A20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAMEBYTEXTKEY_1_OFFSET UNITYSDK_OFFSET(0x1A164F70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAMEBYTEXTKEY_OFFSET UNITYSDK_OFFSET(0x1A164EB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAME_OFFSET UNITYSDK_OFFSET(0x1A164620)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABSELECTED_OFFSET UNITYSDK_OFFSET(0x1A1633E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A165AB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A165AA0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A165AF0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON___BASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1A165BB0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButton_TypeDefinitionIndex = 49945;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITabButton_TypeDefinitionIndex)->GetStaticField(0x44E80);
		}
