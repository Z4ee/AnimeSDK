...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_ADDBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1A0F56B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0F1FE0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x1A0F4BE0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x1A0F4A40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_DOCLICK_OFFSET UNITYSDK_OFFSET(0x1A0F2840)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_ENABLEBADGE_OFFSET UNITYSDK_OFFSET(0x1A0F5D50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_GET_ISSELECT_OFFSET UNITYSDK_OFFSET(0x1A0F1FD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A0F2150)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1A0F2E60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1A0F3240)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A0F2440)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_INIT_1_OFFSET UNITYSDK_OFFSET(0x1A0F20E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_INIT_OFFSET UNITYSDK_OFFSET(0x1A0F2070)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x1A0F3570)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_PRECHECKCLICK_OFFSET UNITYSDK_OFFSET(0x1A0F3B20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_REMOVEBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1A0F5760)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETASSETLOADPROXY_OFFSET UNITYSDK_OFFSET(0x1A0F3290)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETCLICKCHECKSELECTED_OFFSET UNITYSDK_OFFSET(0x1A0F5000)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x1A0F3A60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1A0F3BB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETFINISH_OFFSET UNITYSDK_OFFSET(0x1A0F3C20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETFORCETRIGGER_OFFSET UNITYSDK_OFFSET(0x1A0F5660)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETICON_1_OFFSET UNITYSDK_OFFSET(0x1A0F49D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETICON_OFFSET UNITYSDK_OFFSET(0x1A0F4840)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETNORMALTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A0F3780)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETREDPOINT_1_OFFSET UNITYSDK_OFFSET(0x1A0F5BA0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETREDPOINT_OFFSET UNITYSDK_OFFSET(0x1A0F5810)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETSELECTEDANIM_OFFSET UNITYSDK_OFFSET(0x1A0F3C90)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x1A0F32E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABLOCK_1_OFFSET UNITYSDK_OFFSET(0x1A0F51E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABLOCK_OFFSET UNITYSDK_OFFSET(0x1A0F5050)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAMEBYTEXTKEY_1_OFFSET UNITYSDK_OFFSET(0x1A0F55A0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAMEBYTEXTKEY_OFFSET UNITYSDK_OFFSET(0x1A0F54E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAME_OFFSET UNITYSDK_OFFSET(0x1A0F4C50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABSELECTED_OFFSET UNITYSDK_OFFSET(0x1A0F3A10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0F60E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F60D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0F6120)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON___BASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1A0F61E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButton_TypeDefinitionIndex = 79361;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITabButton_TypeDefinitionIndex)->GetStaticField(0x4B550);
		}
		...
		::Class_2_A9A857AD270B9CE1* _assetLoadProxy; // 0x190
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A9A857AD270B9CE1*))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETASSETLOADPROXY_OFFSET))(this, assetLoadProxy);
		}
