...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1879BD60)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1879BD90)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1879B840)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1879B820)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_PointerEnterCallback_TypeDefinitionIndex = 71304;
