...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E783930)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E783960)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E783430)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E783410)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_PointerEnterCallback_TypeDefinitionIndex = 65770;
