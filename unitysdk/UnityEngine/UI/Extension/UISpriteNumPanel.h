...
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_CALLPLAYACTION_OFFSET UNITYSDK_OFFSET(0x1CC2A1A0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_CALLSTOPACTION_OFFSET UNITYSDK_OFFSET(0x1CC2A1F0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_INITACTION_OFFSET UNITYSDK_OFFSET(0x1CC2A140)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_REFRESH_OFFSET UNITYSDK_OFFSET(0x1CC29B90)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1CC2A3E0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_SETNUM_OFFSET UNITYSDK_OFFSET(0x1CC2A240)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CC2A5F0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC2A770)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UISpriteNumPanel_TypeDefinitionIndex = 78918;
