...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D343EC0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D343F70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D343B10)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D343AF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointDragRawCallback_TypeDefinitionIndex = 71312;
