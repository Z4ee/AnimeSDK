...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18EBF4F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18EBF5A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18EBF100)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBF0F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointDragRawCallback_TypeDefinitionIndex = 81062;
