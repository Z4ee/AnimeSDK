...
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BD7BDD0)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BD7BE60)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BD7B5E0)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD7B5D0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITextTagReplacer_MatchReplacer_TypeDefinitionIndex = 49088;
