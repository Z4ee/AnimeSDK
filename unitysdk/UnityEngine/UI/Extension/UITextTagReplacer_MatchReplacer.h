...
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A531990)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A531A20)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5311A0)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_MATCHREPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A531180)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITextTagReplacer_MatchReplacer_TypeDefinitionIndex = 86658;
