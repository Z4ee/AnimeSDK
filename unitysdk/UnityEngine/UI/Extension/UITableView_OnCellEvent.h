...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE4790)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE47D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE4170)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE4150)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnCellEvent_TypeDefinitionIndex = 59839;
