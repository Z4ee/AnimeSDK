...
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x81FC30)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x168358C0)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0x81FCC0)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x81FBE0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILinearTransition_Line_TypeDefinitionIndex = 58926;
