...
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_SINGLETAGGENERATOR_ADD_OFFSET UNITYSDK_OFFSET(0x1DA4EAF0)
#define UNITYENGINE_UI_EXTENSION_UITEXTTAGREPLACER_SINGLETAGGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA4EB90)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITextTagReplacer_SingleTagGenerator_TypeDefinitionIndex = 86661;

	class UITextTagReplacer_SingleTagGenerator : public ::Class_1_D79D852F682C7303_Class_1_E23FBD37533CCEFB
	{
	public:
		::System::Void _ctor()
		{
