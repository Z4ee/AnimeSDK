...
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_DOADD_OFFSET UNITYSDK_OFFSET(0x1AEB2A20)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_EXAMINE_OFFSET UNITYSDK_OFFSET(0x1AEB2EE0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_GET_SOFTNESSFORLINE_OFFSET UNITYSDK_OFFSET(0x1AEB29B0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_SET_SOFTNESSFORLINE_OFFSET UNITYSDK_OFFSET(0x1AEB29C0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB3350)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIRectMask2DExt_TypeDefinitionIndex = 45813;
