...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_APPLYEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x18B4C6F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x18B4C690)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANINTERACT_1_OFFSET UNITYSDK_OFFSET(0x18B4C3D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18B4C340)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANRUNINCURRENTPLATFORM_OFFSET UNITYSDK_OFFSET(0x18B4C230)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CLAMP_OFFSET UNITYSDK_OFFSET(0x18B4C440)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B4C150)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETDELTA_1_OFFSET UNITYSDK_OFFSET(0x18B4C050)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETDELTA_OFFSET UNITYSDK_OFFSET(0x18B4BF90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x18B4C630)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GET_ISCLAMPING_OFFSET UNITYSDK_OFFSET(0x18B4BAF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_HANDLEEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x18B4C560)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_HANDLEEVENTDATA_OFFSET UNITYSDK_OFFSET(0x18B4C480)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_ISINTERACTING_OFFSET UNITYSDK_OFFSET(0x18B4C2B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_REFRESHINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x18B4BB00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_REFRESHSENSITIVITY_OFFSET UNITYSDK_OFFSET(0x18B4BC10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETENABLED_OFFSET UNITYSDK_OFFSET(0x18B4C2F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x18B4BBC0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETQUANTIZATIONTYPE_OFFSET UNITYSDK_OFFSET(0x18B4BEA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETREVERSERATIO_OFFSET UNITYSDK_OFFSET(0x18B4BF30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETRUNINCURRENTPLATFORMFUNC_OFFSET UNITYSDK_OFFSET(0x18B4C1E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4C760)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorBase_TypeDefinitionIndex = 80227;

	class InteractionRangeProcessorBase : public ::System::Object
	{
	public:
		::UnityEngine::AnimationCurve* m_clampCurve; // 0x10
		::UnityEngine::AnimationCurve* m_dampCurve; // 0x18
		::System::Func_2<::UnityEngine::EventSystems::PointerEventData*, ::System::Boolean>* m_canInteractFunc; // 0x20
		::UnityEngine::Camera* m_cam; // 0x28
		::DG::Tweening::Tween* m_objResetTween; // 0x30
		::System::Func_1<::System::Boolean>* m_canRunInCurrentPlatform; // 0x38
		::System::Single m_pcSensitivity; // 0x40
		::System::Boolean m_isInteracting; // 0x44
		::System::Boolean m_enabled; // 0x45
		::System::Boolean m_isClamping; // 0x46
		::System::Single m_mobileSensitivity; // 0x48
		::UnityEngine::UI::Extension::InteractionSegment m_beginInteractSeg; // 0x4C
		::System::Single m_clampDuration; // 0x50
		::UnityEngine::UI::Extension::Quantization m_quantizationType; // 0x54
		::System::Single m_sensitivity; // 0x58
		::System::Single m_consoleSensitivity; // 0x5C
		::UnityEngine::UI::Extension::InteractionSegment m_endInteractSeg; // 0x60
		::System::Single m_reverseRatio; // 0x64
