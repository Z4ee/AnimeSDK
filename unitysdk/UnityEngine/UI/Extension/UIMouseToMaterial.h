...
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_CLEANMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x1879C0D0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1879C580)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1879C330)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1879BDA0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_MODIFIERSORTORDER_OFFSET UNITYSDK_OFFSET(0x1879C540)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1879C2C0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1879C080)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1879BE90)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1879BDB0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1879C6A0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1879C650)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1879C6E0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1879C770)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIMouseToMaterial_TypeDefinitionIndex = 82395;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMouseToMaterial_TypeDefinitionIndex)->GetStaticField(0x11F30);
		}
