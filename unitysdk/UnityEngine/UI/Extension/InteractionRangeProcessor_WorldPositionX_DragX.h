...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1DE8EBC0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8ECD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8EC10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE8EA90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1DE8ED40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8EE20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1DE8EE70)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_WorldPositionX_DragX_TypeDefinitionIndex = 63473;
