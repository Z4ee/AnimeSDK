...
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_EQUALS_OFFSET UNITYSDK_OFFSET(0x882070)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x882080)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x478130)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x324CC0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x324CC0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x44EB60)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_TOP_OFFSET UNITYSDK_OFFSET(0x3D1D70)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_VERTICAL_OFFSET UNITYSDK_OFFSET(0x3D1D70)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x18790940)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x187909D0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18790A60)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x18790B80)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_SET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x53D7C0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_SET_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x881FA0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_SET_LEFT_OFFSET UNITYSDK_OFFSET(0x324A50)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_SET_RIGHT_OFFSET UNITYSDK_OFFSET(0x5A2BC0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_SET_TOP_OFFSET UNITYSDK_OFFSET(0x5A2BD0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET_SET_VERTICAL_OFFSET UNITYSDK_OFFSET(0x882000)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x18790DD0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x882060)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x5E7E90)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8821F0)
#define UNITYENGINE_UI_EXTENSION_NAP_OFFSET___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x882190)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int NAP_Offset_TypeDefinitionIndex = 82536;

	struct alignas(4) NAP_Offset
	{
		static ::UnityEngine::UI::Extension::NAP_Offset* StaticGet_k_ZeroOffset()
		{
			return (::UnityEngine::UI::Extension::NAP_Offset*)Il2CppClass::FromTypeDefinitionIndex(NAP_Offset_TypeDefinitionIndex)->GetStaticField(0x11F10);
		}
