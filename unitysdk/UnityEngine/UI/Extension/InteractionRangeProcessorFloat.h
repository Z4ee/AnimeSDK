...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x16834610)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x168346B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_CLAMP_OFFSET UNITYSDK_OFFSET(0x168342C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x16834950)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_GOTOVAL_OFFSET UNITYSDK_OFFSET(0x16834420)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_INITPARAM_OFFSET UNITYSDK_OFFSET(0x16833F10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_MOCKRANGEEXCFG_OFFSET UNITYSDK_OFFSET(0x168340A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_SETCENTERVAL_OFFSET UNITYSDK_OFFSET(0x16834040)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x168349A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x16834A10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___BASE_CLAMP_OFFSET UNITYSDK_OFFSET(0x16834AC0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x16834B50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorFloat_TypeDefinitionIndex = 74179;
