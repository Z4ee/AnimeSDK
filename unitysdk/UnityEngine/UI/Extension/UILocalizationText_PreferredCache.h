...
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x96CAD0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_FONTTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x96CAB0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_PIXELSPERUNIT_OFFSET UNITYSDK_OFFSET(0x5ED170)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x324CC0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_FONTTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x96CAC0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_PIXELSPERUNIT_OFFSET UNITYSDK_OFFSET(0x5ED180)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x324A50)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x462A80)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILocalizationText_PreferredCache_TypeDefinitionIndex = 53373;
