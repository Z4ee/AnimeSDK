...
#define UNITYENGINE_UI_GRAPHICCAST_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0x1DA4F230)
#define UNITYENGINE_UI_GRAPHICCAST_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1DA4F1D0)
#define UNITYENGINE_UI_GRAPHICCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA4F7E0)
#define UNITYENGINE_UI_GRAPHICCAST___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1DA4F840)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicCast_TypeDefinitionIndex = 61371;
