...
#define UNITYENGINE_UI_CUSTOMUIVECTOT4EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x18B034C0)
#define UNITYENGINE_UI_CUSTOMUIVECTOT4EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18B035A0)
#define UNITYENGINE_UI_CUSTOMUIVECTOT4EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B03620)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVectot4EqualityComparer_TypeDefinitionIndex = 5708;
