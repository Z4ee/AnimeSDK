...
#define UNITYENGINE_UI_GRAPHICREGISTRY_CANVASGRAPHICSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE35E90)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicRegistry_CanvasGraphicsData_TypeDefinitionIndex = 6714;
