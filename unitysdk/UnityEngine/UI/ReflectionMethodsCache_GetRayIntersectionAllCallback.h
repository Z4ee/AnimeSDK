...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FA02EA0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FA02F50)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FA02A10)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA029F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_GetRayIntersectionAllCallback_TypeDefinitionIndex = 19330;
