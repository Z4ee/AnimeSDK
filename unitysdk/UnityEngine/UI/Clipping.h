...
#define UNITYENGINE_UI_CLIPPING_FINDCULLANDCLIPWORLDRECT_OFFSET UNITYSDK_OFFSET(0x1EE1D5B0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Clipping_TypeDefinitionIndex = 6690;
