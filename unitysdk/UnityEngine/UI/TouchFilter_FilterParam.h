...
#define UNITYENGINE_UI_TOUCHFILTER_FILTERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x2CFA0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int TouchFilter_FilterParam_TypeDefinitionIndex = 6029;
