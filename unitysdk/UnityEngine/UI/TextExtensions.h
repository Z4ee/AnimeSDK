...
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFEGETTEXT_OFFSET UNITYSDK_OFFSET(0x1BD7C800)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1BD7C290)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1BD7CFE0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXTWITHELLIPSIS_OFFSET UNITYSDK_OFFSET(0x1BD7CAB0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXT_OFFSET UNITYSDK_OFFSET(0x1BD7C540)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int TextExtensions_TypeDefinitionIndex = 69856;
