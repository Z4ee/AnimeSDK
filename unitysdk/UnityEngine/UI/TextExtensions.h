...
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFEGETTEXT_OFFSET UNITYSDK_OFFSET(0x1A5323C0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A531E50)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A532BA0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXTWITHELLIPSIS_OFFSET UNITYSDK_OFFSET(0x1A532670)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXT_OFFSET UNITYSDK_OFFSET(0x1A532100)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int TextExtensions_TypeDefinitionIndex = 59553;
