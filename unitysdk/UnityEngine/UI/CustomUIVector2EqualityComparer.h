...
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EF2B4E0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EF2B5A0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF2B610)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector2EqualityComparer_TypeDefinitionIndex = 19295;
