...
#define UNITYENGINE_UI_LAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1C19FD30)
#define UNITYENGINE_UI_LAYOUTGROUP_DELAYEDSETDIRTY_OFFSET UNITYSDK_OFFSET(0x1C1A2250)
#define UNITYENGINE_UI_LAYOUTGROUP_GETALIGNMENTONAXIS_OFFSET UNITYSDK_OFFSET(0x1C1A0DA0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETCHILDALONGAXISWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1C1A1BF0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x1C1A0710)
#define UNITYENGINE_UI_LAYOUTGROUP_GETSTARTOFFSET_OFFSET UNITYSDK_OFFSET(0x1C1A0B50)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALFLEXIBLESIZE_OFFSET UNITYSDK_OFFSET(0x1C1A0500)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALMINSIZE_OFFSET UNITYSDK_OFFSET(0x1C1A02E0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALPREFERREDSIZE_OFFSET UNITYSDK_OFFSET(0x1C1A03F0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_CHILDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C19FAD0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x1C1A0690)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x1C1A04A0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_ISROOTLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x1C1A1F50)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C1A0700)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1C1A05B0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1C1A0280)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1C19F8F0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_LEFT_OFFSET UNITYSDK_OFFSET(0x1C19F990)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1C19F600)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_RIGHT_OFFSET UNITYSDK_OFFSET(0x1C19FA30)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_TOP_OFFSET UNITYSDK_OFFSET(0x1C19F6C0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1C1A0620)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1C1A0390)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_RECTCHILDREN_OFFSET UNITYSDK_OFFSET(0x1C19FD20)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C19FB60)
#define UNITYENGINE_UI_LAYOUTGROUP_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C1A0B00)
#define UNITYENGINE_UI_LAYOUTGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C1A0910)
#define UNITYENGINE_UI_LAYOUTGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C1A08A0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C1A09D0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1C1A0A90)
#define UNITYENGINE_UI_LAYOUTGROUP_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1C1A2170)
#define UNITYENGINE_UI_LAYOUTGROUP_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1C1A2200)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXISWITHSCALE_1_OFFSET UNITYSDK_OFFSET(0x1C1A1690)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXISWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1C1A10C0)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1C1A14C0)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXIS_OFFSET UNITYSDK_OFFSET(0x1C1A0F30)
#define UNITYENGINE_UI_LAYOUTGROUP_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1C19F760)
#define UNITYENGINE_UI_LAYOUTGROUP_SETLAYOUTINPUTFORAXIS_OFFSET UNITYSDK_OFFSET(0x1C1A0E30)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_CHILDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C19FAE0)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1C19F910)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_LEFT_OFFSET UNITYSDK_OFFSET(0x1C19F9B0)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x1C19F610)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_RIGHT_OFFSET UNITYSDK_OFFSET(0x1C19FA50)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_TOP_OFFSET UNITYSDK_OFFSET(0x1C19F6E0)
#define UNITYENGINE_UI_LAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A0760)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C1A22D0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C1A2360)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C1A23F0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C1A2480)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1C1A2510)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1C1A25A0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutGroup_TypeDefinitionIndex = 8405;
