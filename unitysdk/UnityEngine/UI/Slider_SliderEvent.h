...
#define UNITYENGINE_UI_SLIDER_SLIDEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A4230)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Slider_SliderEvent_TypeDefinitionIndex = 5724;
