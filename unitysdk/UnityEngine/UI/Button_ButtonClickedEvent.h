...
#define UNITYENGINE_UI_BUTTON_BUTTONCLICKEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC0DFB0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Button_ButtonClickedEvent_TypeDefinitionIndex = 18846;
