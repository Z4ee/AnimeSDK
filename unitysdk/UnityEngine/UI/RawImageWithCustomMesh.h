...
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GETMESH_OFFSET UNITYSDK_OFFSET(0x1BC702B0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1BC6FE70)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1BC703B0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1BC70480)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1BC70A70)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_REBUILD_OFFSET UNITYSDK_OFFSET(0x1BC708A0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SETMESH_OFFSET UNITYSDK_OFFSET(0x1BC70300)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1BC70510)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1BC703C0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1BC70490)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC6FE40)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1BC70AC0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1BC70B20)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1BC70BC0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1BC70BD0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RawImageWithCustomMesh_TypeDefinitionIndex = 8427;
