...
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x18CCB960)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x18CCC430)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x18CCC170)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETENABLED_OFFSET UNITYSDK_OFFSET(0x18CCCA60)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x18CCBE40)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETMATERIAL_OFFSET UNITYSDK_OFFSET(0x18CCC7B0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SETFILLAMOUNTCOMPAREPRE_OFFSET UNITYSDK_OFFSET(0x18CCBC30)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ImageExtensions_TypeDefinitionIndex = 45723;
