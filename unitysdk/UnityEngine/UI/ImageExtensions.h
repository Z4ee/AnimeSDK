...
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1D5D8A30)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x1D5D9420)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1D5D9160)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETENABLED_OFFSET UNITYSDK_OFFSET(0x1D5D9A50)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x1D5D8EA0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D5D97A0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SETFILLAMOUNTCOMPAREPRE_OFFSET UNITYSDK_OFFSET(0x1D5D8D00)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ImageExtensions_TypeDefinitionIndex = 90049;
