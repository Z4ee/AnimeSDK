...
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHORALLOWEDOUTSIDEPARENT_OFFSET UNITYSDK_OFFSET(0x1CC2E200)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHOREDTOLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1CC2E820)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALRECTWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x1CC2C110)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALSIZEWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x1CC2BC20)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_FINDROOTCANVAS_OFFSET UNITYSDK_OFFSET(0x1CC2AC40)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1CC2B3F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETMINMAXBYWORLD_OFFSET UNITYSDK_OFFSET(0x1CC2A8F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETRECTREFERENCECORNER_OFFSET UNITYSDK_OFFSET(0x1CC2CA60)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0x1CC2B2B0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_1_OFFSET UNITYSDK_OFFSET(0x1CC2AEB0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_OFFSET UNITYSDK_OFFSET(0x1CC2AA40)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_LOCALPOSITIONTOANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x1CC2E3F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_1_OFFSET UNITYSDK_OFFSET(0x1CC2E110)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_2_OFFSET UNITYSDK_OFFSET(0x1CC2CEC0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_OFFSET UNITYSDK_OFFSET(0x1CC2CDF0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_1_OFFSET UNITYSDK_OFFSET(0x1CC2C810)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_OFFSET UNITYSDK_OFFSET(0x1CC2C760)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORSBYPOINT_OFFSET UNITYSDK_OFFSET(0x1CC2C4C0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x1CC2C240)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SHOULDDOINTSNAPPING_OFFSET UNITYSDK_OFFSET(0x1CC2E250)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CALSIZEWITHCURRENTANCHORS_G__GETPARENTSIZE_7_0_OFFSET UNITYSDK_OFFSET(0x1CC2BF80)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC2ECD0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RectTransformExtensions_TypeDefinitionIndex = 59280;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(RectTransformExtensions_TypeDefinitionIndex)->GetStaticField(0x388B0);
		}
