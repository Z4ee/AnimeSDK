...
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHORALLOWEDOUTSIDEPARENT_OFFSET UNITYSDK_OFFSET(0x18D63410)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHOREDTOLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x18D63A30)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALRECTWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x18D61320)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALSIZEWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x18D60E30)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_FINDROOTCANVAS_OFFSET UNITYSDK_OFFSET(0x18D5FE50)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x18D60600)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETMINMAXBYWORLD_OFFSET UNITYSDK_OFFSET(0x18D5FB00)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETRECTREFERENCECORNER_OFFSET UNITYSDK_OFFSET(0x18D61C70)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0x18D604C0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_1_OFFSET UNITYSDK_OFFSET(0x18D600C0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_OFFSET UNITYSDK_OFFSET(0x18D5FC50)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_LOCALPOSITIONTOANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x18D63600)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_1_OFFSET UNITYSDK_OFFSET(0x18D63320)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_2_OFFSET UNITYSDK_OFFSET(0x18D620D0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_OFFSET UNITYSDK_OFFSET(0x18D62000)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_1_OFFSET UNITYSDK_OFFSET(0x18D61A20)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_OFFSET UNITYSDK_OFFSET(0x18D61970)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORSBYPOINT_OFFSET UNITYSDK_OFFSET(0x18D616D0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x18D61450)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SHOULDDOINTSNAPPING_OFFSET UNITYSDK_OFFSET(0x18D63460)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CALSIZEWITHCURRENTANCHORS_G__GETPARENTSIZE_7_0_OFFSET UNITYSDK_OFFSET(0x18D61190)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D63EE0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RectTransformExtensions_TypeDefinitionIndex = 65473;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(RectTransformExtensions_TypeDefinitionIndex)->GetStaticField(0x36280);
		}
