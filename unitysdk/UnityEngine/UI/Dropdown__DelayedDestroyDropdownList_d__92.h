...
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19BFEB30)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19BFEBB0)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19BFEC10)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19BFEBC0)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19BFEB20)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFE750)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Dropdown__DelayedDestroyDropdownList_d__92_TypeDefinitionIndex = 5874;
