...
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18B646C0)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18B64A40)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18B64AA0)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18B64A50)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B646B0)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x18B63720)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Scrollbar__ClickRepeat_d__58_TypeDefinitionIndex = 5704;
