...
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DF21690)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DF219C0)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DF21A20)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DF219D0)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DF21680)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF21670)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Scrollbar__ClickRepeat_d__58_TypeDefinitionIndex = 18945;
