...
#define UNITYENGINE_UI_SMOOTHMASKMATERIAL_MATENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A9CA0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int SmoothMaskMaterial_MatEntry_TypeDefinitionIndex = 5737;
