...
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_BUILD_OFFSET UNITYSDK_OFFSET(0x1A5944A0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1A594E00)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A593890)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_ERASE_OFFSET UNITYSDK_OFFSET(0x1A593C60)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_EXECUTECLEARCMDIMPL_OFFSET UNITYSDK_OFFSET(0x1A595280)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_EXECUTECOPYCMDIMPL_OFFSET UNITYSDK_OFFSET(0x1A595690)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_EXECUTECOPYCMD_OFFSET UNITYSDK_OFFSET(0x1A593BD0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_GETVALIDFORMAT_OFFSET UNITYSDK_OFFSET(0x1A5939E0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_GET_ATLASTEX_OFFSET UNITYSDK_OFFSET(0x1A594490)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_GET_CLEARED_OFFSET UNITYSDK_OFFSET(0x1A5937F0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_INSERT_OFFSET UNITYSDK_OFFSET(0x1A5925B0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_ISPACKABLE_OFFSET UNITYSDK_OFFSET(0x1A5939A0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A5930D0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_TRYGETSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A5927C0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_TRYINSERT_OFFSET UNITYSDK_OFFSET(0x1A594930)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_UPDATEAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1A5937E0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A595EC0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A591980)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__INSERT_G__FINDBLOCKSIZE_7_0_OFFSET UNITYSDK_OFFSET(0x1A594880)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__TRYINSERT_G__SPAWNSECONDLEAF_16_0_OFFSET UNITYSDK_OFFSET(0x1A5961A0)
...
namespace UnityEngine::UI
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Experimental::Rendering::GraphicsFormat, ::System::ValueTuple_2<::System::Int32, ::System::Int32>>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeAtlasManager_RuntimeAtlas_TypeDefinitionIndex)->GetStaticField(0x1A9C0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet_k_AtlasSizeToDepth()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeAtlasManager_RuntimeAtlas_TypeDefinitionIndex)->GetStaticField(0x1A9C8);
		}
