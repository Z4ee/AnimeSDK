...
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_BUILD_OFFSET UNITYSDK_OFFSET(0x15DCD030)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x15DCD9A0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x15DCC310)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_ERASE_OFFSET UNITYSDK_OFFSET(0x15DCC6A0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_EXECUTECLEARCMDIMPL_OFFSET UNITYSDK_OFFSET(0x15DCDFC0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_EXECUTECOPYCMDIMPL_OFFSET UNITYSDK_OFFSET(0x15DCE220)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_EXECUTECOPYCMD_OFFSET UNITYSDK_OFFSET(0x15DCC610)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_GETVALIDFORMAT_OFFSET UNITYSDK_OFFSET(0x15DCC460)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_GET_ATLASTEX_OFFSET UNITYSDK_OFFSET(0x15DCD020)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_GET_CLEARED_OFFSET UNITYSDK_OFFSET(0x15DCC220)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_INSERT_OFFSET UNITYSDK_OFFSET(0x15DCB020)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_ISPACKABLE_OFFSET UNITYSDK_OFFSET(0x15DCC420)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_RELEASE_OFFSET UNITYSDK_OFFSET(0x15DCBAB0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_TRYGETSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x15DCB170)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_TRYINSERT_OFFSET UNITYSDK_OFFSET(0x15DCD580)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS_UPDATEAVAILABLE_OFFSET UNITYSDK_OFFSET(0x15DCC210)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__CCTOR_OFFSET UNITYSDK_OFFSET(0x15DCE920)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x15DCA270)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__INSERT_G__FINDBLOCKSIZE_7_0_OFFSET UNITYSDK_OFFSET(0x15DCD400)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_RUNTIMEATLAS__TRYINSERT_G__SPAWNSECONDLEAF_16_0_OFFSET UNITYSDK_OFFSET(0x15DCEC10)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RuntimeAtlasManager_RuntimeAtlas_TypeDefinitionIndex = 5975;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeAtlasManager_RuntimeAtlas_TypeDefinitionIndex)->GetStaticField(0x3FEB0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Experimental::Rendering::GraphicsFormat, ::System::ValueTuple_2<::System::Int32, ::System::Int32>>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeAtlasManager_RuntimeAtlas_TypeDefinitionIndex)->GetStaticField(0x3FEB8);
		}
