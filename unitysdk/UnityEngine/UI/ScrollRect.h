...
#define UNITYENGINE_UI_SCROLLRECT_ADJUSTBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B3E7AD0)
#define UNITYENGINE_UI_SCROLLRECT_AUTOSETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E6600)
#define UNITYENGINE_UI_SCROLLRECT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B3E67D0)
#define UNITYENGINE_UI_SCROLLRECT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1B3E67E0)
#define UNITYENGINE_UI_SCROLLRECT_CALCULATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3E4070)
#define UNITYENGINE_UI_SCROLLRECT_CANAXISSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E94E0)
#define UNITYENGINE_UI_SCROLLRECT_CANSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E48D0)
#define UNITYENGINE_UI_SCROLLRECT_ENSURELAYOUTHASREBUILT_OFFSET UNITYSDK_OFFSET(0x1B3E3B80)
#define UNITYENGINE_UI_SCROLLRECT_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B3E7390)
#define UNITYENGINE_UI_SCROLLRECT_GET_CONTENTLAYOUTTYPE_OFFSET UNITYSDK_OFFSET(0x1B3E9030)
#define UNITYENGINE_UI_SCROLLRECT_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1B3E22E0)
#define UNITYENGINE_UI_SCROLLRECT_GET_DECELERATIONRATE_OFFSET UNITYSDK_OFFSET(0x1B3E23A0)
#define UNITYENGINE_UI_SCROLLRECT_GET_DRAGGING_OFFSET UNITYSDK_OFFSET(0x1B3E2970)
#define UNITYENGINE_UI_SCROLLRECT_GET_ELASTICITY_OFFSET UNITYSDK_OFFSET(0x1B3E2360)
#define UNITYENGINE_UI_SCROLLRECT_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B3E6840)
#define UNITYENGINE_UI_SCROLLRECT_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x1B3E6810)
#define UNITYENGINE_UI_SCROLLRECT_GET_FORBIDDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E8F50)
#define UNITYENGINE_UI_SCROLLRECT_GET_FORCEREVERSEALIGN_OFFSET UNITYSDK_OFFSET(0x1B3E9600)
#define UNITYENGINE_UI_SCROLLRECT_GET_HORIZONTALNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E5E50)
#define UNITYENGINE_UI_SCROLLRECT_GET_HORIZONTALSCROLLBARSPACING_OFFSET UNITYSDK_OFFSET(0x1B3E27C0)
#define UNITYENGINE_UI_SCROLLRECT_GET_HORIZONTALSCROLLBARVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3E2780)
#define UNITYENGINE_UI_SCROLLRECT_GET_HORIZONTALSCROLLBAR_OFFSET UNITYSDK_OFFSET(0x1B3E24E0)
#define UNITYENGINE_UI_SCROLLRECT_GET_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B3E2300)
#define UNITYENGINE_UI_SCROLLRECT_GET_HSCROLLINGNEEDED_OFFSET UNITYSDK_OFFSET(0x1B3E6730)
#define UNITYENGINE_UI_SCROLLRECT_GET_INERTIA_OFFSET UNITYSDK_OFFSET(0x1B3E2380)
#define UNITYENGINE_UI_SCROLLRECT_GET_ISHORIZONTALCANNOTSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E9000)
#define UNITYENGINE_UI_SCROLLRECT_GET_ISINLINEDECELERATION_OFFSET UNITYSDK_OFFSET(0x1B3E8D60)
#define UNITYENGINE_UI_SCROLLRECT_GET_ISVERTICALCANNOTSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E8FD0)
#define UNITYENGINE_UI_SCROLLRECT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3E6870)
#define UNITYENGINE_UI_SCROLLRECT_GET_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B3E6850)
#define UNITYENGINE_UI_SCROLLRECT_GET_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1B3E6860)
#define UNITYENGINE_UI_SCROLLRECT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B3E6820)
#define UNITYENGINE_UI_SCROLLRECT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1B3E67F0)
#define UNITYENGINE_UI_SCROLLRECT_GET_MOVEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B3E2340)
#define UNITYENGINE_UI_SCROLLRECT_GET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E5B20)
#define UNITYENGINE_UI_SCROLLRECT_GET_NOTFULLAUTOCENTER_OFFSET UNITYSDK_OFFSET(0x1B3E8F70)
#define UNITYENGINE_UI_SCROLLRECT_GET_NOTFULLCANSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E8FA0)
#define UNITYENGINE_UI_SCROLLRECT_GET_ONREBOUNDEVENT_OFFSET UNITYSDK_OFFSET(0x1B3E5DA0)
#define UNITYENGINE_UI_SCROLLRECT_GET_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B3E28D0)
#define UNITYENGINE_UI_SCROLLRECT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B3E6830)
#define UNITYENGINE_UI_SCROLLRECT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1B3E6800)
#define UNITYENGINE_UI_SCROLLRECT_GET_REBOUNDEVENTENABLE_OFFSET UNITYSDK_OFFSET(0x1B3E9630)
#define UNITYENGINE_UI_SCROLLRECT_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3E2990)
#define UNITYENGINE_UI_SCROLLRECT_GET_REVERSEHORIZONTALSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E95E0)
#define UNITYENGINE_UI_SCROLLRECT_GET_SCROLLING_OFFSET UNITYSDK_OFFSET(0x1B3E2980)
#define UNITYENGINE_UI_SCROLLRECT_GET_SCROLLSENSITIVITY_OFFSET UNITYSDK_OFFSET(0x1B3E23C0)
#define UNITYENGINE_UI_SCROLLRECT_GET_SHAREDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E8D70)
#define UNITYENGINE_UI_SCROLLRECT_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x1B3E2950)
#define UNITYENGINE_UI_SCROLLRECT_GET_VERTICALNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E5F40)
#define UNITYENGINE_UI_SCROLLRECT_GET_VERTICALSCROLLBARSPACING_OFFSET UNITYSDK_OFFSET(0x1B3E28B0)
#define UNITYENGINE_UI_SCROLLRECT_GET_VERTICALSCROLLBARVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3E27A0)
#define UNITYENGINE_UI_SCROLLRECT_GET_VERTICALSCROLLBAR_OFFSET UNITYSDK_OFFSET(0x1B3E2630)
#define UNITYENGINE_UI_SCROLLRECT_GET_VERTICAL_OFFSET UNITYSDK_OFFSET(0x1B3E2320)
#define UNITYENGINE_UI_SCROLLRECT_GET_VIEWPORT_OFFSET UNITYSDK_OFFSET(0x1B3E23E0)
#define UNITYENGINE_UI_SCROLLRECT_GET_VIEWRECT_OFFSET UNITYSDK_OFFSET(0x1B3E28F0)
#define UNITYENGINE_UI_SCROLLRECT_GET_VSCROLLINGNEEDED_OFFSET UNITYSDK_OFFSET(0x1B3E6780)
#define UNITYENGINE_UI_SCROLLRECT_GRAPHICUPDATECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B3E3810)
#define UNITYENGINE_UI_SCROLLRECT_IGNOREHANDLER_OFFSET UNITYSDK_OFFSET(0x1B3E8D90)
#define UNITYENGINE_UI_SCROLLRECT_INTERNALCALCULATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3E7EF0)
#define UNITYENGINE_UI_SCROLLRECT_INTERNALGETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B3E7BD0)
#define UNITYENGINE_UI_SCROLLRECT_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B3E3B40)
#define UNITYENGINE_UI_SCROLLRECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3E4B70)
#define UNITYENGINE_UI_SCROLLRECT_LAYOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B3E3800)
#define UNITYENGINE_UI_SCROLLRECT_MANUALSTOPDRAGGING_OFFSET UNITYSDK_OFFSET(0x1B3E3C30)
#define UNITYENGINE_UI_SCROLLRECT_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E4110)
#define UNITYENGINE_UI_SCROLLRECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B3E3940)
#define UNITYENGINE_UI_SCROLLRECT_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E4360)
#define UNITYENGINE_UI_SCROLLRECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B3E3820)
#define UNITYENGINE_UI_SCROLLRECT_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E4320)
#define UNITYENGINE_UI_SCROLLRECT_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E40E0)
#define UNITYENGINE_UI_SCROLLRECT_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1B3E65E0)
#define UNITYENGINE_UI_SCROLLRECT_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E3C50)
#define UNITYENGINE_UI_SCROLLRECT_REBUILD_OFFSET UNITYSDK_OFFSET(0x1B3E2B10)
#define UNITYENGINE_UI_SCROLLRECT_REGISTERSCROLLCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B3E3C40)
#define UNITYENGINE_UI_SCROLLRECT_RUBBERDELTA_OFFSET UNITYSDK_OFFSET(0x1B3E49C0)
#define UNITYENGINE_UI_SCROLLRECT_SCROLLTOTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1B3E8360)
#define UNITYENGINE_UI_SCROLLRECT_SCROLLTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3E8340)
#define UNITYENGINE_UI_SCROLLRECT_SETANCHOREDPOSITIONWITHANIM_OFFSET UNITYSDK_OFFSET(0x1B3E8C00)
#define UNITYENGINE_UI_SCROLLRECT_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E4A20)
#define UNITYENGINE_UI_SCROLLRECT_SETDIRTYCACHING_OFFSET UNITYSDK_OFFSET(0x1B3E2400)
#define UNITYENGINE_UI_SCROLLRECT_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1B3E27E0)
#define UNITYENGINE_UI_SCROLLRECT_SETHORIZONTALNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E60B0)
#define UNITYENGINE_UI_SCROLLRECT_SETHORIZONTALSCROLLPERCENT_OFFSET UNITYSDK_OFFSET(0x1B3E9060)
#define UNITYENGINE_UI_SCROLLRECT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B3E6880)
#define UNITYENGINE_UI_SCROLLRECT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1B3E74D0)
#define UNITYENGINE_UI_SCROLLRECT_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E60F0)
#define UNITYENGINE_UI_SCROLLRECT_SETSCROLLPERCENT_OFFSET UNITYSDK_OFFSET(0x1B3E9070)
#define UNITYENGINE_UI_SCROLLRECT_SETVERTICALNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E60D0)
#define UNITYENGINE_UI_SCROLLRECT_SETVERTICALSCROLLPERCENT_OFFSET UNITYSDK_OFFSET(0x1B3E94D0)
#define UNITYENGINE_UI_SCROLLRECT_SET_CONTENTLAYOUTTYPE_OFFSET UNITYSDK_OFFSET(0x1B3E9040)
#define UNITYENGINE_UI_SCROLLRECT_SET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1B3E22F0)
#define UNITYENGINE_UI_SCROLLRECT_SET_DECELERATIONRATE_OFFSET UNITYSDK_OFFSET(0x1B3E23B0)
#define UNITYENGINE_UI_SCROLLRECT_SET_ELASTICITY_OFFSET UNITYSDK_OFFSET(0x1B3E2370)
#define UNITYENGINE_UI_SCROLLRECT_SET_FORBIDDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E8F60)
#define UNITYENGINE_UI_SCROLLRECT_SET_FORCEREVERSEALIGN_OFFSET UNITYSDK_OFFSET(0x1B3E9610)
#define UNITYENGINE_UI_SCROLLRECT_SET_HORIZONTALNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E6070)
#define UNITYENGINE_UI_SCROLLRECT_SET_HORIZONTALSCROLLBARSPACING_OFFSET UNITYSDK_OFFSET(0x1B3E27D0)
#define UNITYENGINE_UI_SCROLLRECT_SET_HORIZONTALSCROLLBARVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3E2790)
#define UNITYENGINE_UI_SCROLLRECT_SET_HORIZONTALSCROLLBAR_OFFSET UNITYSDK_OFFSET(0x1B3E24F0)
#define UNITYENGINE_UI_SCROLLRECT_SET_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B3E2310)
#define UNITYENGINE_UI_SCROLLRECT_SET_INERTIA_OFFSET UNITYSDK_OFFSET(0x1B3E2390)
#define UNITYENGINE_UI_SCROLLRECT_SET_MOVEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B3E2350)
#define UNITYENGINE_UI_SCROLLRECT_SET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E6020)
#define UNITYENGINE_UI_SCROLLRECT_SET_NOTFULLAUTOCENTER_OFFSET UNITYSDK_OFFSET(0x1B3E8F80)
#define UNITYENGINE_UI_SCROLLRECT_SET_NOTFULLCANSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E8FB0)
#define UNITYENGINE_UI_SCROLLRECT_SET_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B3E28E0)
#define UNITYENGINE_UI_SCROLLRECT_SET_REBOUNDEVENTENABLE_OFFSET UNITYSDK_OFFSET(0x1B3E9640)
#define UNITYENGINE_UI_SCROLLRECT_SET_REVERSEHORIZONTALSCROLL_OFFSET UNITYSDK_OFFSET(0x1B3E95F0)
#define UNITYENGINE_UI_SCROLLRECT_SET_SCROLLSENSITIVITY_OFFSET UNITYSDK_OFFSET(0x1B3E23D0)
#define UNITYENGINE_UI_SCROLLRECT_SET_SHAREDRAG_OFFSET UNITYSDK_OFFSET(0x1B3E8D80)
#define UNITYENGINE_UI_SCROLLRECT_SET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x1B3E2960)
#define UNITYENGINE_UI_SCROLLRECT_SET_VERTICALNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B3E6090)
#define UNITYENGINE_UI_SCROLLRECT_SET_VERTICALSCROLLBARSPACING_OFFSET UNITYSDK_OFFSET(0x1B3E28C0)
#define UNITYENGINE_UI_SCROLLRECT_SET_VERTICALSCROLLBARVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3E27B0)
#define UNITYENGINE_UI_SCROLLRECT_SET_VERTICALSCROLLBAR_OFFSET UNITYSDK_OFFSET(0x1B3E2640)
#define UNITYENGINE_UI_SCROLLRECT_SET_VERTICAL_OFFSET UNITYSDK_OFFSET(0x1B3E2330)
#define UNITYENGINE_UI_SCROLLRECT_SET_VIEWPORT_OFFSET UNITYSDK_OFFSET(0x1B3E23F0)
#define UNITYENGINE_UI_SCROLLRECT_STOPMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1B3E3C20)
#define UNITYENGINE_UI_SCROLLRECT_UNITYENGINE_UI_ICANVASELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3E96A0)
#define UNITYENGINE_UI_SCROLLRECT_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B3E2EB0)
#define UNITYENGINE_UI_SCROLLRECT_UPDATECACHEDDATA_OFFSET UNITYSDK_OFFSET(0x1B3E2BD0)
#define UNITYENGINE_UI_SCROLLRECT_UPDATEONESCROLLBARVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3E7A10)
#define UNITYENGINE_UI_SCROLLRECT_UPDATEPREVDATA_OFFSET UNITYSDK_OFFSET(0x1B3E3780)
#define UNITYENGINE_UI_SCROLLRECT_UPDATESCROLLBARLAYOUT_OFFSET UNITYSDK_OFFSET(0x1B3E7650)
#define UNITYENGINE_UI_SCROLLRECT_UPDATESCROLLBARS_OFFSET UNITYSDK_OFFSET(0x1B3E3450)
#define UNITYENGINE_UI_SCROLLRECT_UPDATESCROLLBARVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3E5CD0)
#define UNITYENGINE_UI_SCROLLRECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3E9690)
#define UNITYENGINE_UI_SCROLLRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E2A20)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ScrollRect_TypeDefinitionIndex = 5981;
	...
	public:
		...
		{
			return (::System::ValueTuple_2<::System::Boolean, ::System::Boolean>*)Il2CppClass::FromTypeDefinitionIndex(ScrollRect_TypeDefinitionIndex)->GetStaticField(0xD230);
		}
