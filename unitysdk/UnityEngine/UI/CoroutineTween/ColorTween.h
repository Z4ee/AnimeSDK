...
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_ADDONCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x3BD4180)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GETDURATION_OFFSET UNITYSDK_OFFSET(0x3B7C620)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GETIGNORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x3BB1BC0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x3B7C620)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GET_IGNORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x3BB1BC0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GET_STARTCOLOR_OFFSET UNITYSDK_OFFSET(0x2E25AA0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GET_TARGETCOLOR_OFFSET UNITYSDK_OFFSET(0x2E23010)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_GET_TWEENMODE_OFFSET UNITYSDK_OFFSET(0x112B0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x3BB1BB0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_SET_IGNORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x3BB1BD0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_SET_STARTCOLOR_OFFSET UNITYSDK_OFFSET(0x3B75030)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_SET_TARGETCOLOR_OFFSET UNITYSDK_OFFSET(0x3BB1BA0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_SET_TWEENMODE_OFFSET UNITYSDK_OFFSET(0xC250)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_TWEENVALUE_OFFSET UNITYSDK_OFFSET(0x3BB1BE0)
#define UNITYENGINE_UI_COROUTINETWEEN_COLORTWEEN_VALIDTARGET_OFFSET UNITYSDK_OFFSET(0x32030)
