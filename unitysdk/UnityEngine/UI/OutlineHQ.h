...
#define UNITYENGINE_UI_OUTLINEHQ_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1B168EA0)
#define UNITYENGINE_UI_OUTLINEHQ__CTOR_OFFSET UNITYSDK_OFFSET(0x1B168DF0)
#define UNITYENGINE_UI_OUTLINEHQ___BASE_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1B169220)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int OutlineHQ_TypeDefinitionIndex = 78939;
