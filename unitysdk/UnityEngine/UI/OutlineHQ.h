...
#define UNITYENGINE_UI_OUTLINEHQ_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1CB834F0)
#define UNITYENGINE_UI_OUTLINEHQ__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB83440)
#define UNITYENGINE_UI_OUTLINEHQ___BASE_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1CB83870)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int OutlineHQ_TypeDefinitionIndex = 45960;
