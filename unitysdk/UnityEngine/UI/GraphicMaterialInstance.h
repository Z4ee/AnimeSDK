...
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x18B14920)
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18B14B10)
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18B149B0)
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B14C30)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicMaterialInstance_TypeDefinitionIndex = 5585;
