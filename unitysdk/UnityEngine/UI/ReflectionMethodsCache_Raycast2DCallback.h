...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST2DCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15DC7DA0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST2DCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15DC7E50)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST2DCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15DC7D60)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST2DCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15DC7CF0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_Raycast2DCallback_TypeDefinitionIndex = 6044;
