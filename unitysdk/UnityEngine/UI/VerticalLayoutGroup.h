...
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1D095E20)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1D095E40)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1D095E50)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1D095E60)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D095D60)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int VerticalLayoutGroup_TypeDefinitionIndex = 5952;
