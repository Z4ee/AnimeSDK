...
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BD61E90)
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BD61FA0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD62040)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector3EqualityComparer_TypeDefinitionIndex = 8442;
