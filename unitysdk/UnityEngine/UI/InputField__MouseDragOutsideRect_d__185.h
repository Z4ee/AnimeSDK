...
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EF31A00)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF31DD0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF31E30)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EF31DE0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF319F0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF319E0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField__MouseDragOutsideRect_d__185_TypeDefinitionIndex = 19233;
