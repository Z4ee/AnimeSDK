...
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DC14170)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DC14550)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DC145B0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DC14560)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DC14160)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC14150)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField__MouseDragOutsideRect_d__185_TypeDefinitionIndex = 18891;
