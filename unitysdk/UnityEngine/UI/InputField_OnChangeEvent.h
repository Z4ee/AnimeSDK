...
#define UNITYENGINE_UI_INPUTFIELD_ONCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B28E10)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField_OnChangeEvent_TypeDefinitionIndex = 5613;
