...
#define UNITYENGINE_UI_CACULATENODEDATA_DESERIALIZECACULATENODETREE_OFFSET UNITYSDK_OFFSET(0x19BEB670)
#define UNITYENGINE_UI_CACULATENODEDATA_GETOPVALUE_OFFSET UNITYSDK_OFFSET(0x19BEA800)
#define UNITYENGINE_UI_CACULATENODEDATA_GETREFVALUE_OFFSET UNITYSDK_OFFSET(0x19BEADE0)
#define UNITYENGINE_UI_CACULATENODEDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19BEA770)
#define UNITYENGINE_UI_CACULATENODEDATA_OPTOSTRING_OFFSET UNITYSDK_OFFSET(0x19BEAEF0)
#define UNITYENGINE_UI_CACULATENODEDATA_RECURSIVEADD_OFFSET UNITYSDK_OFFSET(0x19BEB5A0)
#define UNITYENGINE_UI_CACULATENODEDATA_RECURSIVEBUILD_OFFSET UNITYSDK_OFFSET(0x19BEB6B0)
#define UNITYENGINE_UI_CACULATENODEDATA_REFTOSTRING_OFFSET UNITYSDK_OFFSET(0x19BEB4D0)
#define UNITYENGINE_UI_CACULATENODEDATA_SERIALIZECACULATENODEDATA_OFFSET UNITYSDK_OFFSET(0x19BEB520)
#define UNITYENGINE_UI_CACULATENODEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BEAE50)
#define UNITYENGINE_UI_CACULATENODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19BEB740)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CaculateNodeData_TypeDefinitionIndex = 5913;
