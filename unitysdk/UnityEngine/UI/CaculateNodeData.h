...
#define UNITYENGINE_UI_CACULATENODEDATA_DESERIALIZECACULATENODETREE_OFFSET UNITYSDK_OFFSET(0x1B384070)
#define UNITYENGINE_UI_CACULATENODEDATA_GETOPVALUE_OFFSET UNITYSDK_OFFSET(0x1B383200)
#define UNITYENGINE_UI_CACULATENODEDATA_GETREFVALUE_OFFSET UNITYSDK_OFFSET(0x1B3837E0)
#define UNITYENGINE_UI_CACULATENODEDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1B383170)
#define UNITYENGINE_UI_CACULATENODEDATA_OPTOSTRING_OFFSET UNITYSDK_OFFSET(0x1B3838F0)
#define UNITYENGINE_UI_CACULATENODEDATA_RECURSIVEADD_OFFSET UNITYSDK_OFFSET(0x1B383FA0)
#define UNITYENGINE_UI_CACULATENODEDATA_RECURSIVEBUILD_OFFSET UNITYSDK_OFFSET(0x1B3840B0)
#define UNITYENGINE_UI_CACULATENODEDATA_REFTOSTRING_OFFSET UNITYSDK_OFFSET(0x1B383ED0)
#define UNITYENGINE_UI_CACULATENODEDATA_SERIALIZECACULATENODEDATA_OFFSET UNITYSDK_OFFSET(0x1B383F20)
#define UNITYENGINE_UI_CACULATENODEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B383850)
#define UNITYENGINE_UI_CACULATENODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B384140)
