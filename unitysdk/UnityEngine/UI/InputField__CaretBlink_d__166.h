...
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A574210)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A574320)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A574380)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A574330)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A574200)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166__CTOR_OFFSET UNITYSDK_OFFSET(0x1A567C70)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField__CaretBlink_d__166_TypeDefinitionIndex = 5627;
