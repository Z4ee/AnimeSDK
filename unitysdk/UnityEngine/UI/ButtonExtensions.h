...
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1BC45420)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1BC456F0)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETNORMALCOLOR_OFFSET UNITYSDK_OFFSET(0x1BC459A0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ButtonExtensions_TypeDefinitionIndex = 42362;
