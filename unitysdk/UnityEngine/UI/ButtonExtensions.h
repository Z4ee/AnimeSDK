...
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1AAE07A0)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1AAE0A70)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETNORMALCOLOR_OFFSET UNITYSDK_OFFSET(0x1AAE0D20)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ButtonExtensions_TypeDefinitionIndex = 69514;
