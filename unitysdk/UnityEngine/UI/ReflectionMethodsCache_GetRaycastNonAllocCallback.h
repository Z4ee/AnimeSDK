...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E65ED50)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E65EE10)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E65E820)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E65E800)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_GetRaycastNonAllocCallback_TypeDefinitionIndex = 18984;
