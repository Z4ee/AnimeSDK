...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FA2CF90)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FA2D060)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FA2CAC0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA2CAA0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_Raycast3DCallback_TypeDefinitionIndex = 19326;
