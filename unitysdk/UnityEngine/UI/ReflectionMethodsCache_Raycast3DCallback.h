...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E65F980)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E65FA50)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E65F420)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E65F400)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_Raycast3DCallback_TypeDefinitionIndex = 18982;
