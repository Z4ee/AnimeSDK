...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A58F1C0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A58F290)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A58EC50)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_RAYCAST3DCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A58EC30)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_Raycast3DCallback_TypeDefinitionIndex = 5759;
