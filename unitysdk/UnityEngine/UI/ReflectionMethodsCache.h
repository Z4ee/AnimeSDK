...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GET_SINGLETON_OFFSET UNITYSDK_OFFSET(0x18B51B90)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B50950)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_TypeDefinitionIndex = 5746;
	...
	public:
		...
		{
			return (::UnityEngine::UI::ReflectionMethodsCache**)Il2CppClass::FromTypeDefinitionIndex(ReflectionMethodsCache_TypeDefinitionIndex)->GetStaticField(0x5DA0);
		}
