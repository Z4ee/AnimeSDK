...
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE9A80)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE9AB0)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE9580)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE9570)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField_InputFieldCallback_TypeDefinitionIndex = 8378;
