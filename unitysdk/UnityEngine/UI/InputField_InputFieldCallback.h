...
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E6C8690)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E6C86C0)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E6C8170)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6C8150)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField_InputFieldCallback_TypeDefinitionIndex = 19228;
