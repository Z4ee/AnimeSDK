...
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_ADDVOLUMEBYMESHANDMATERIAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A46AF60)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_ADDVOLUMEBYMESHANDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A46AE30)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_ADDVOLUMEREUSED_OFFSET UNITYSDK_OFFSET(0x1A46AE40)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_ADDVOLUME_OFFSET UNITYSDK_OFFSET(0x1A46AD30)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_REMOVEVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x1A46AD20)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_SETVOLUMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A46AF70)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_SET_SCENEID_OFFSET UNITYSDK_OFFSET(0x1A46AF90)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_SET_VOLUMEREUSED_OFFSET UNITYSDK_OFFSET(0x1A46AFA0)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_TRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1A46AF80)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_VOLUMETRANSFORMCHANGED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A46AFC0)
#define UNITYENGINE_RPGINSTANCEDITEMBLOCK_VOLUMETRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1A46AFB0)

namespace UnityEngine
{
	inline static constexpr unsigned int RPGInstancedItemBlock_TypeDefinitionIndex = 4097;
