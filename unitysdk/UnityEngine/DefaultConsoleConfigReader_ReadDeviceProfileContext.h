...
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_GLOBALAPPLYOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ED1F7D0)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_INIFILE_OFFSET UNITYSDK_OFFSET(0x1ED1F7B0)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_SECTIONCACHES_OFFSET UNITYSDK_OFFSET(0x1ED1F7C0)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED1F0D0)

namespace UnityEngine
{
	inline static constexpr unsigned int DefaultConsoleConfigReader_ReadDeviceProfileContext_TypeDefinitionIndex = 4065;
