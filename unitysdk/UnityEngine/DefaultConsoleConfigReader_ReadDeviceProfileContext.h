...
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_GLOBALAPPLYOPTIONS_OFFSET UNITYSDK_OFFSET(0x1DED6760)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_INIFILE_OFFSET UNITYSDK_OFFSET(0x1DED6740)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_SECTIONCACHES_OFFSET UNITYSDK_OFFSET(0x1DED6750)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DED6060)
