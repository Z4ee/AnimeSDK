...
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B2EE090)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1B2EE0B0)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1B2EE0D0)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1B2EE0F0)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1B2EE100)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1B2EE110)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1B2EE120)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_8_OFFSET UNITYSDK_OFFSET(0x1B2EE130)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_9_OFFSET UNITYSDK_OFFSET(0x1B2EE150)
#define UNITYENGINE_CONSOLEVARIABLEDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B2EE070)
#define UNITYENGINE_CONSOLEVARIABLEDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9623F0)
#define UNITYENGINE_CONSOLEVARIABLEDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x962410)
#define UNITYENGINE_CONSOLEVARIABLEDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x962430)
#define UNITYENGINE_CONSOLEVARIABLEDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define UNITYENGINE_CONSOLEVARIABLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9623D0)

namespace UnityEngine
{
	inline static constexpr unsigned int ConsoleVariableData_TypeDefinitionIndex = 5154;
