...
#define UNITYENGINE_RESOURCEREQUEST_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1DCD8610)
#define UNITYENGINE_RESOURCEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCD8640)
