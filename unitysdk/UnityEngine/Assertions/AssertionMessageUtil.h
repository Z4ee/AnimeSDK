...
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_BOOLEANFAILUREMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EA5AA60)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_GETEQUALITYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EA5A540)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_GETMESSAGE_1_OFFSET UNITYSDK_OFFSET(0x1EA5A260)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EA5A0E0)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_NULLFAILUREMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EA5A850)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5AB10)

namespace UnityEngine::Assertions
{
	inline static constexpr unsigned int AssertionMessageUtil_TypeDefinitionIndex = 6356;
