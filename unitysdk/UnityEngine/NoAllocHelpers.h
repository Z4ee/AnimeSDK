...
#define UNITYENGINE_NOALLOCHELPERS_EXTRACTARRAYFROMLIST_OFFSET UNITYSDK_OFFSET(0x1AFBD000)
#define UNITYENGINE_NOALLOCHELPERS_INTERNAL_RESIZELIST_OFFSET UNITYSDK_OFFSET(0x1AFBCFF0)
#define UNITYENGINE_NOALLOCHELPERS_SAFELENGTH_OFFSET UNITYSDK_OFFSET(0x1AFBCEE0)
#define UNITYENGINE_NOALLOCHELPERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFBD010)
