...
#define UNITYENGINE_PARTICLEPHYSICSEXTENSIONS_GETCOLLISIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1F1206D0)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticlePhysicsExtensions_TypeDefinitionIndex = 7741;
