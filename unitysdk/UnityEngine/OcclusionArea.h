...
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB110)
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1D4FB0C0)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB190)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1D4FB140)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB130)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x1D4FB120)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D4FB1B0)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1D4FB1A0)
#define UNITYENGINE_OCCLUSIONAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FB1C0)
