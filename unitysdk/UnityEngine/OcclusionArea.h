...
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E8AF450)
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1E8AF400)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E8AF4D0)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1E8AF480)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E8AF470)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x1E8AF460)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E8AF4F0)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1E8AF4E0)
#define UNITYENGINE_OCCLUSIONAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8AF500)
