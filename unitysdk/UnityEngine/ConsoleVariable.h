...
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1EB4F090)
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB4F0F0)
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1EB4F0C0)
#define UNITYENGINE_CONSOLEVARIABLE_NEWCONSOLEVARIABLEFROMSCRIPT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB4F110)
#define UNITYENGINE_CONSOLEVARIABLE_NEWCONSOLEVARIABLEFROMSCRIPT_OFFSET UNITYSDK_OFFSET(0x1EB4F100)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1EB4F0A0)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB4F0B0)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1EB4F060)
#define UNITYENGINE_CONSOLEVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB4F120)
