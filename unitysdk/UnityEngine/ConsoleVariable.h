...
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1D7AA960)
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AA9C0)
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1D7AA990)
#define UNITYENGINE_CONSOLEVARIABLE_NEWCONSOLEVARIABLEFROMSCRIPT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AA9E0)
#define UNITYENGINE_CONSOLEVARIABLE_NEWCONSOLEVARIABLEFROMSCRIPT_OFFSET UNITYSDK_OFFSET(0x1D7AA9D0)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1D7AA970)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AA980)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1D7AA930)
#define UNITYENGINE_CONSOLEVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7AA9F0)
