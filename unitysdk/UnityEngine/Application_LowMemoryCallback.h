...
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D41A8A0)
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D41A8D0)
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D41A600)
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41A5E0)

namespace UnityEngine
{
	inline static constexpr unsigned int Application_LowMemoryCallback_TypeDefinitionIndex = 5130;
