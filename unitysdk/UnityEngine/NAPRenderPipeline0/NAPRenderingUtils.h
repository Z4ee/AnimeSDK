...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEOBLIQUEMATRIX_OFFSET UNITYSDK_OFFSET(0x1DF579C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEREFLECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1DF57E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CAMERASPACEPLANE_OFFSET UNITYSDK_OFFSET(0x1DF57670)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEAREXTRALIGHTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1DF58C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1DF594A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1DF58250)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FIXUPDEPTHSLICE_OFFSET UNITYSDK_OFFSET(0x1DF59330)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FREEZETHISCAMERA_OFFSET UNITYSDK_OFFSET(0x1DF59910)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETEXTRALIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1DF58D00)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETFROZENRTID_OFFSET UNITYSDK_OFFSET(0x1DF59810)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_1_OFFSET UNITYSDK_OFFSET(0x1DF58510)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_OFFSET UNITYSDK_OFFSET(0x1DF58410)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_ISCAMERAPROJECTIONMATRIXFLIPPED_OFFSET UNITYSDK_OFFSET(0x1DF57FA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_LUMINANCE_OFFSET UNITYSDK_OFFSET(0x1DF58910)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARELIFTGAMMAGAIN_OFFSET UNITYSDK_OFFSET(0x1DF58940)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARESHADOWSMIDTONESHIGHLIGHTS_OFFSET UNITYSDK_OFFSET(0x1DF58750)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SAFERELEASE_OFFSET UNITYSDK_OFFSET(0x1DF58400)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1DF58210)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1DF581D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1DF59510)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1DF59640)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1DF59340)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SGN_OFFSET UNITYSDK_OFFSET(0x1DF57640)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_TOCOLOR_OFFSET UNITYSDK_OFFSET(0x1DF57630)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF59BB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NAPRenderingUtils_TypeDefinitionIndex = 5993;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Light*, ::UnityEngine::NAPRenderPipeline0::NativeAdditionalLightData_NativeSRP*>**)Il2CppClass::FromTypeDefinitionIndex(NAPRenderingUtils_TypeDefinitionIndex)->GetStaticField(0x5410);
		}
		static ::System::Type** StaticGet_s_NativeAdditionalLightDataType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(NAPRenderingUtils_TypeDefinitionIndex)->GetStaticField(0x5418);
		}
