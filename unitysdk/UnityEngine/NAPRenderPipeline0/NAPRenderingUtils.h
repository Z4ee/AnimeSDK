...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEOBLIQUEMATRIX_OFFSET UNITYSDK_OFFSET(0x1BC1D350)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEREFLECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1BC1D7D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CAMERASPACEPLANE_OFFSET UNITYSDK_OFFSET(0x1BC1D000)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEAREXTRALIGHTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1BC1E590)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1BC1EE30)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1BC1DBE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FIXUPDEPTHSLICE_OFFSET UNITYSDK_OFFSET(0x1BC1ECC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FREEZETHISCAMERA_OFFSET UNITYSDK_OFFSET(0x1BC1F2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETEXTRALIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1BC1E690)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETFROZENRTID_OFFSET UNITYSDK_OFFSET(0x1BC1F1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_1_OFFSET UNITYSDK_OFFSET(0x1BC1DEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_OFFSET UNITYSDK_OFFSET(0x1BC1DDA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_ISCAMERAPROJECTIONMATRIXFLIPPED_OFFSET UNITYSDK_OFFSET(0x1BC1D930)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_LUMINANCE_OFFSET UNITYSDK_OFFSET(0x1BC1E2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARELIFTGAMMAGAIN_OFFSET UNITYSDK_OFFSET(0x1BC1E2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARESHADOWSMIDTONESHIGHLIGHTS_OFFSET UNITYSDK_OFFSET(0x1BC1E0E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SAFERELEASE_OFFSET UNITYSDK_OFFSET(0x1BC1DD90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1BC1DBA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1BC1DB60)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1BC1EEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1BC1EFD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1BC1ECD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SGN_OFFSET UNITYSDK_OFFSET(0x1BC1CFD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_TOCOLOR_OFFSET UNITYSDK_OFFSET(0x1BC1CFC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC1F540)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NAPRenderingUtils_TypeDefinitionIndex = 5983;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(NAPRenderingUtils_TypeDefinitionIndex)->GetStaticField(0x53F0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Light*, ::UnityEngine::NAPRenderPipeline0::NativeAdditionalLightData_NativeSRP*>**)Il2CppClass::FromTypeDefinitionIndex(NAPRenderingUtils_TypeDefinitionIndex)->GetStaticField(0x53F8);
		}
