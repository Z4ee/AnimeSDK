...
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E952730)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E9523D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E952420)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E952630)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E952430)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int WhiteBalance_NativeSRP_TypeDefinitionIndex = 6094;
