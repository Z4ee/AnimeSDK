...
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1B18B610)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B18B2B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B18B300)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B18B510)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18B310)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int WhiteBalance_NativeSRP_TypeDefinitionIndex = 6081;
