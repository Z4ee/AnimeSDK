...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B2DC890)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1B2DCB70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2DCFC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXPathTracer_HistoryBuffer_TypeDefinitionIndex = 5790;
