...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D4F5440)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D4F5380)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_SETUPAFTERVOLUMEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4F5470)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D4F5390)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F53A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CharacterColorGradingLutPass_NativeImpl_TypeDefinitionIndex = 5724;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::CharacterColorGradingLutPass_NativeImpl**)Il2CppClass::FromTypeDefinitionIndex(CharacterColorGradingLutPass_NativeImpl_TypeDefinitionIndex)->GetStaticField(0x53C0);
		}
