...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D11C620)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D11C6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D11C6A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D11C6D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D11C630)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D11C6E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11C600)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateUIInfoPassNativeState_TypeDefinitionIndex = 5783;
