...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1AD3D100)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1AD3D1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD3D180)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AD3D1B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AD3D110)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AD3D1C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD3D0E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateUIInfoPassNativeState_TypeDefinitionIndex = 5779;
