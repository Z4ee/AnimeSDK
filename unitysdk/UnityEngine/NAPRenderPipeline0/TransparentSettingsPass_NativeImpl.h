...
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AE73590)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1AE73560)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE734D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TransparentSettingsPass_NativeImpl_TypeDefinitionIndex = 5754;
