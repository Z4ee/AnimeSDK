...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EBE7FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1EBE8120)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE8660)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSRPass_HistoryBuffer_TypeDefinitionIndex = 5826;
