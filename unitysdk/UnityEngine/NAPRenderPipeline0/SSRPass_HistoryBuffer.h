...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D853C50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1D853DB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D854300)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSRPass_HistoryBuffer_TypeDefinitionIndex = 5824;
