...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D2A3BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1D2A40E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D2A3BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D2A4380)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GETTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1D2A3C70)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D2A3CB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D2A3AB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D2A3C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1D2A3BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D2A3AC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A3AD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TextureCurve_TypeDefinitionIndex = 6080;
