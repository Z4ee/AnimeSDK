...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CF32A90)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEBOOL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CF32AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF32A70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ConsoleVariableBool_TypeDefinitionIndex = 5690;
