...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AAD6BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEBOOL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AAD6C20)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD6BC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ConsoleVariableBool_TypeDefinitionIndex = 5688;
