...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B3A3AC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B3A3B60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B3A3B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B3A3B80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B3A3AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B3A3B90)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1B3A3B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A3AA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceShadowResolvePassNativeState_TypeDefinitionIndex = 5769;
