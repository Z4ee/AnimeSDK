...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EA8EE50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EA8EEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA8EED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EA8EF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EA8EE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1EA8EF20)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1EA8EF00)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA8EE30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceShadowResolvePassNativeState_TypeDefinitionIndex = 5775;
