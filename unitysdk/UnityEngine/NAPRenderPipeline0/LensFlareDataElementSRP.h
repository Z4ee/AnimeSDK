...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GETLENSFLARETEXTURE_OFFSET UNITYSDK_OFFSET(0x1C50BE20)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C50BE30)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_EDGEOFFSET_OFFSET UNITYSDK_OFFSET(0x1C50BE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_FALLOFF_OFFSET UNITYSDK_OFFSET(0x1C50BE50)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_INTENSITYVARIATION_OFFSET UNITYSDK_OFFSET(0x1C50BE40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_LOCALINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C50BE10)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_SDFROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1C50BE80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_SIDECOUNT_OFFSET UNITYSDK_OFFSET(0x1C50BE70)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_REFRESHTEXTUREID_OFFSET UNITYSDK_OFFSET(0x1C50BE90)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C50BD70)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_EDGEOFFSET_OFFSET UNITYSDK_OFFSET(0x1C50BDB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_FALLOFF_OFFSET UNITYSDK_OFFSET(0x1C50BD90)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_INTENSITYVARIATION_OFFSET UNITYSDK_OFFSET(0x1C50BD80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_LOCALINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C50BD60)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_SDFROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1C50BDD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_SIDECOUNT_OFFSET UNITYSDK_OFFSET(0x1C50BDF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C50B8E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareDataElementSRP_TypeDefinitionIndex = 24694;
