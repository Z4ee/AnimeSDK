...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GETLENSFLARETEXTURE_OFFSET UNITYSDK_OFFSET(0x1E83E020)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E83E030)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_EDGEOFFSET_OFFSET UNITYSDK_OFFSET(0x1E83E060)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_FALLOFF_OFFSET UNITYSDK_OFFSET(0x1E83E050)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_INTENSITYVARIATION_OFFSET UNITYSDK_OFFSET(0x1E83E040)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_LOCALINTENSITY_OFFSET UNITYSDK_OFFSET(0x1E83E010)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_SDFROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1E83E080)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_SIDECOUNT_OFFSET UNITYSDK_OFFSET(0x1E83E070)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_REFRESHTEXTUREID_OFFSET UNITYSDK_OFFSET(0x1E83E090)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E83DF70)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_EDGEOFFSET_OFFSET UNITYSDK_OFFSET(0x1E83DFB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_FALLOFF_OFFSET UNITYSDK_OFFSET(0x1E83DF90)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_INTENSITYVARIATION_OFFSET UNITYSDK_OFFSET(0x1E83DF80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_LOCALINTENSITY_OFFSET UNITYSDK_OFFSET(0x1E83DF60)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_SDFROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1E83DFD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_SIDECOUNT_OFFSET UNITYSDK_OFFSET(0x1E83DFF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E83DAE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareDataElementSRP_TypeDefinitionIndex = 18479;
