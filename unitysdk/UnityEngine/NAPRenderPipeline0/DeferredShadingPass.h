...
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS_ADDTEXTURETRANSITIONFORPOSTGENERATEHALFSPECULAR_OFFSET UNITYSDK_OFFSET(0x1AFA5180)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFA5510)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFAFAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS__EXECUTE_G__ADDTEXTURETRANSITIONFORGENERATEHALFSPECULAR_27_0_OFFSET UNITYSDK_OFFSET(0x1AFAD0B0)
...
namespace UnityEngine::NAPRenderPipeline0
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(DeferredShadingPass_TypeDefinitionIndex)->GetStaticField(0x2A70);
		}
		static ::UnityEngine::NAPRenderPipeline0::DeferredShadingPerFrameConstants* StaticGet_FrameConstants()
		{
			return (::UnityEngine::NAPRenderPipeline0::DeferredShadingPerFrameConstants*)Il2CppClass::FromTypeDefinitionIndex(DeferredShadingPass_TypeDefinitionIndex)->GetStaticField(0x2A74);
		}
		static ::UnityEngine::Vector2Int* StaticGet_s_PreScreenSize()
		{
			return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(DeferredShadingPass_TypeDefinitionIndex)->GetStaticField(0x2A80);
		}
