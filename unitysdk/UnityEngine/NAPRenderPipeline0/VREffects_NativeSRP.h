...
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D134ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D134EF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D133F20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VREffects_NativeSRP_TypeDefinitionIndex = 6115;
