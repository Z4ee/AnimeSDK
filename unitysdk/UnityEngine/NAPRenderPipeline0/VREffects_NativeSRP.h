...
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E48DCC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E48DCE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E48CD10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VREffects_NativeSRP_TypeDefinitionIndex = 6117;
