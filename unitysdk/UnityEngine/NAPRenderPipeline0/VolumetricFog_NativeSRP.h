...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_CHECKVISIABLE_OFFSET UNITYSDK_OFFSET(0x1B4C71B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1B4C6CC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B4C7400)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7450)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFog_NativeSRP_TypeDefinitionIndex = 5998;
