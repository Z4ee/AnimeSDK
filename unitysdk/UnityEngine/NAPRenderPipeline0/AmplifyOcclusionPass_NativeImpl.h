...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B73B300)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B73B330)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1B73B2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73B250)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusionPass_NativeImpl_TypeDefinitionIndex = 5726;
