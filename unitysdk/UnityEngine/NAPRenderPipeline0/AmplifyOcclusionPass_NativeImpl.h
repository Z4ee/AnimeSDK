...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DA8F100)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1DA8F130)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1DA8F0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8F050)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusionPass_NativeImpl_TypeDefinitionIndex = 5728;
