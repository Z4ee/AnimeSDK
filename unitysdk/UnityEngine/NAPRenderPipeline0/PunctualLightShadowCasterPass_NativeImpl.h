...
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL_ENABLELOCALLIGHTCACHEONCAMERA_OFFSET UNITYSDK_OFFSET(0x1AFB1520)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x1AFB1260)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFB1270)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL_SETUPCULLINGPARAMETER_OFFSET UNITYSDK_OFFSET(0x1AFB12E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1AFB1240)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFB15E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB11E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PunctualLightShadowCasterPass_NativeImpl_TypeDefinitionIndex = 5715;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableBool**)Il2CppClass::FromTypeDefinitionIndex(PunctualLightShadowCasterPass_NativeImpl_TypeDefinitionIndex)->GetStaticField(0x5200);
		}
