...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOMQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA2D910)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapBloomQualityParameter_TypeDefinitionIndex = 6107;
