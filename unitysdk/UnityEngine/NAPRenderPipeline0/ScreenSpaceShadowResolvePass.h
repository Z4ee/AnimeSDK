...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D670510)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D673080)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_GETFRUSTUMCUBE_OFFSET UNITYSDK_OFFSET(0x1D66F8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_ISHALFRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1D670450)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_SETLOCALRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1D670100)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1D673120)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D673130)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D66F760)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__EXECUTE_G__SETTEXTURETRANSITIONFORRESOLVESHADOWS_19_0_OFFSET UNITYSDK_OFFSET(0x1D672E90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceShadowResolvePass_TypeDefinitionIndex = 5839;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(ScreenSpaceShadowResolvePass_TypeDefinitionIndex)->GetStaticField(0x5710);
		}
		static ::System::String** StaticGet_Keyword__HALFRES_SHADOW()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenSpaceShadowResolvePass_TypeDefinitionIndex)->GetStaticField(0x5718);
		}
