...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1B73B9F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B73B920)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B73B950)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1B73B8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73B850)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DistortionPass_NativeImpl_TypeDefinitionIndex = 5729;
