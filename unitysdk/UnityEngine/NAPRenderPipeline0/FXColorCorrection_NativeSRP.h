...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1DA2AC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1DA2A340)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISLUTOVERRIDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1DA2A200)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1DA2A3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISUBERCOLORCORRECTIONACTIVE_OFFSET UNITYSDK_OFFSET(0x1DA2A2E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DA2AB40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA2A3D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FXColorCorrection_NativeSRP_TypeDefinitionIndex = 6087;
