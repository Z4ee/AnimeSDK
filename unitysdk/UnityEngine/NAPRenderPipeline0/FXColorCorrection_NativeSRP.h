...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1B65E5A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B65DCA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISLUTOVERRIDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B65DB60)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B65DD20)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISUBERCOLORCORRECTIONACTIVE_OFFSET UNITYSDK_OFFSET(0x1B65DC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B65E4A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65DD30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FXColorCorrection_NativeSRP_TypeDefinitionIndex = 6076;
