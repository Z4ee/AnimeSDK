...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1F34A800)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1F34A6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1F34A6F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F34A700)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F34A3C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceReflection_NativeSRP_TypeDefinitionIndex = 6101;
