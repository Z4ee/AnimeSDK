...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1BC20F50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1BC20E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1BC20E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC20E50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC20B10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceReflection_NativeSRP_TypeDefinitionIndex = 6088;
