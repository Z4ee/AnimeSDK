...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D7B6BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D7B6C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D7B6B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B6AD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPass_NativeImpl_TypeDefinitionIndex = 5772;
