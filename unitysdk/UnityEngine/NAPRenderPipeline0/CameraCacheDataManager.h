...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1D6F3910)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_GETCACHCEDATA_OFFSET UNITYSDK_OFFSET(0x1D6F3B10)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6F3700)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_TRIMINVALIDDATA_OFFSET UNITYSDK_OFFSET(0x1D6F3CA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6F3830)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CameraCacheDataManager_TypeDefinitionIndex = 6018;
