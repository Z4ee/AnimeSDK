...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISCAUSTICACTIVE_OFFSET UNITYSDK_OFFSET(0x1B185590)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISDISTORTIONACTIVE_OFFSET UNITYSDK_OFFSET(0x1B185570)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISGAUSSIANBLURACTIVE_OFFSET UNITYSDK_OFFSET(0x1B1854D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISLUTOVERRIDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B185460)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISNAPBLOOMACTIVEFORHDR_OFFSET UNITYSDK_OFFSET(0x1B185540)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISNAPBLOOMACTIVE_OFFSET UNITYSDK_OFFSET(0x1B185510)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA_ISNAPBLOOMSECONDARYGLAREACTIVE_OFFSET UNITYSDK_OFFSET(0x1B1854F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEDVOLUMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1855A0)
