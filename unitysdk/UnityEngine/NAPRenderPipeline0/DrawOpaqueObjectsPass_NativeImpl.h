...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWOPAQUEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1EB5EEB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWPARTICLEDECAL_OFFSET UNITYSDK_OFFSET(0x1EB5EEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB5EE70)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1EB5EE40)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5E930)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOpaqueObjectsPass_NativeImpl_TypeDefinitionIndex = 5735;
