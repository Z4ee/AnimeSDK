...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWOPAQUEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1D810F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWPARTICLEDECAL_OFFSET UNITYSDK_OFFSET(0x1D810F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D810F50)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D810F20)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D810A00)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOpaqueObjectsPass_NativeImpl_TypeDefinitionIndex = 5733;
