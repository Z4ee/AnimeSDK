...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EBE14A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EBE1540)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EBE1520)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EBE1550)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EBE14B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE1480)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FxFogMaskPassNativeState_TypeDefinitionIndex = 5744;
