...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B4D3A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B4D3AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B4D3AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4D3B00)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B4D3A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3A30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FxFogMaskPassNativeState_TypeDefinitionIndex = 5740;
