...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBE0C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1EBE0DE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBE0C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE0D90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FloatRangeParameter_TypeDefinitionIndex = 6060;
