...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B4D3230)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B4D3390)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B4D3240)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3340)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FloatRangeParameter_TypeDefinitionIndex = 6047;
