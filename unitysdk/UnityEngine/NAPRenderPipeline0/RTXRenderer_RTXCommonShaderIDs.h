...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXRENDERER_RTXCOMMONSHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6A9C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXRENDERER_RTXCOMMONSHADERIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A9400)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXRenderer_RTXCommonShaderIDs_TypeDefinitionIndex = 5788;
