...
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPINGMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5BAC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TonemappingModeParameter_TypeDefinitionIndex = 6065;
