...
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D6A5C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D6A5D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D6A5D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6A5D50)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D6A5CA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D6A5D60)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1D6A5D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5C70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DeferredShadingPassNativeState_TypeDefinitionIndex = 5763;
