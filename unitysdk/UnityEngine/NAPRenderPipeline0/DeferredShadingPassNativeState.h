...
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EA5F300)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EA5F3A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA5F380)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EA5F3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EA5F310)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1EA5F3D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1EA5F3B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5F2E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DeferredShadingPassNativeState_TypeDefinitionIndex = 5765;
