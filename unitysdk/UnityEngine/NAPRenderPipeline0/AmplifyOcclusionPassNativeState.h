...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1E7C0280)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1E7C0340)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E7C0320)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1E7C0310)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E7C0290)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1E7C0300)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7C0260)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusionPassNativeState_TypeDefinitionIndex = 5729;
