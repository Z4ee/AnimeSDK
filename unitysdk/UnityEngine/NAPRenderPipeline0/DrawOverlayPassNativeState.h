...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B1853A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B185450)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B185430)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B185420)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B1853B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B185380)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOverlayPassNativeState_TypeDefinitionIndex = 5734;
