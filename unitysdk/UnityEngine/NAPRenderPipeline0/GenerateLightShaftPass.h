...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D72E300)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D72F120)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D72E1A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPass_TypeDefinitionIndex = 5832;
