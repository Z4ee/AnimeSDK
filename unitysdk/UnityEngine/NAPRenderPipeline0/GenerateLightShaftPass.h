...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B3C3180)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B3C3FB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C3020)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPass_TypeDefinitionIndex = 5826;
