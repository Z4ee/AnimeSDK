...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1CF321F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1CF31D50)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1CF31D70)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CF320F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF31D80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Caustics_NativeSRP_TypeDefinitionIndex = 6104;
