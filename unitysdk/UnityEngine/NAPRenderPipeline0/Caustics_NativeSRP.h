...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E317010)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E316B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E316B90)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E316F10)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E316BA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Caustics_NativeSRP_TypeDefinitionIndex = 6106;
