...
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_EXECUTECOPYCOLORPASS_OFFSET UNITYSDK_OFFSET(0x1AD3CFE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AD3CFF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AD3D0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3D0C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD3CF80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CopyColorPass_NativeImpl_TypeDefinitionIndex = 5727;
