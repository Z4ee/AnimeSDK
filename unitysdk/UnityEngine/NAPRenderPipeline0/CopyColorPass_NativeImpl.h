...
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_EXECUTECOPYCOLORPASS_OFFSET UNITYSDK_OFFSET(0x1D11C500)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D11C510)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D11C5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1D11C5E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11C4A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CopyColorPass_NativeImpl_TypeDefinitionIndex = 5729;
