...
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D814E20)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D813BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_RENDERPLANARREFLECTIONCUBECORRECTED_OFFSET UNITYSDK_OFFSET(0x1D813D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1D813BB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8139D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ReflectionPass_TypeDefinitionIndex = 5838;
