...
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4C3010)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B4C1DD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_RENDERPLANARREFLECTIONCUBECORRECTED_OFFSET UNITYSDK_OFFSET(0x1B4C1F20)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1B4C1DA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C1BC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ReflectionPass_TypeDefinitionIndex = 5832;
