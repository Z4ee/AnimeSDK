...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1D8175E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_1_OFFSET UNITYSDK_OFFSET(0x1D817A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x1D817820)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_OFFSET UNITYSDK_OFFSET(0x1D817610)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CANCELCONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1D8175A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CHECKSRPHELPERPASSESPROPERLYSYNCED_OFFSET UNITYSDK_OFFSET(0x1D8182E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x1D8175B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_1_OFFSET UNITYSDK_OFFSET(0x1D817470)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1D817410)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1D8175D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_1_OFFSET UNITYSDK_OFFSET(0x1D811840)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_2_OFFSET UNITYSDK_OFFSET(0x1D817BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_3_OFFSET UNITYSDK_OFFSET(0x1D818050)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D814C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_EXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1D817600)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D817390)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D8175F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x1D817340)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARFLAG_OFFSET UNITYSDK_OFFSET(0x1D817320)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1D8172A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1D8172B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_DEPTHATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1D817300)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x1D817360)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x1D817280)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1D818150)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETCANRUNONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1D8182D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETSIGNALONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1D818260)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETUPFORSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1D818180)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_EYEINDEX_OFFSET UNITYSDK_OFFSET(0x1D817350)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_ISBLITRENDERPASS_OFFSET UNITYSDK_OFFSET(0x1D817380)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x1D817370)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x1D817290)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SHOULDEXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1D818200)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_WAITSIGNALONMAIN_OFFSET UNITYSDK_OFFSET(0x1D818220)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8182F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D810A80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScriptableRenderPass_TypeDefinitionIndex = 5958;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::RenderTargetIdentifier*)Il2CppClass::FromTypeDefinitionIndex(ScriptableRenderPass_TypeDefinitionIndex)->GetStaticField(0x2870);
		}
		static ::System::Boolean* StaticGet_EnablePassRefCountDebug()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScriptableRenderPass_TypeDefinitionIndex)->GetStaticField(0x2898);
		}
