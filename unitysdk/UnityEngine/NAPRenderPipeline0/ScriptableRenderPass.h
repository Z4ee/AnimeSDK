...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1EB656F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_1_OFFSET UNITYSDK_OFFSET(0x1EB65B90)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x1EB65940)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_OFFSET UNITYSDK_OFFSET(0x1EB65720)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CANCELCONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1EB656B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CHECKSRPHELPERPASSESPROPERLYSYNCED_OFFSET UNITYSDK_OFFSET(0x1EB66410)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x1EB656C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_1_OFFSET UNITYSDK_OFFSET(0x1EB65580)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1EB65520)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1EB656E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_1_OFFSET UNITYSDK_OFFSET(0x1EB5F740)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_2_OFFSET UNITYSDK_OFFSET(0x1EB65CD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_3_OFFSET UNITYSDK_OFFSET(0x1EB66180)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1EB62D80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_EXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1EB65710)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EB654A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1EB65700)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x1EB65450)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARFLAG_OFFSET UNITYSDK_OFFSET(0x1EB65430)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1EB653B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1EB653C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_DEPTHATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1EB65410)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x1EB65470)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x1EB65390)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1EB66280)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETCANRUNONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1EB66400)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETSIGNALONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1EB66390)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETUPFORSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1EB662B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_EYEINDEX_OFFSET UNITYSDK_OFFSET(0x1EB65460)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_ISBLITRENDERPASS_OFFSET UNITYSDK_OFFSET(0x1EB65490)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x1EB65480)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x1EB653A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SHOULDEXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1EB66330)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_WAITSIGNALONMAIN_OFFSET UNITYSDK_OFFSET(0x1EB66350)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EB66420)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5E9B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScriptableRenderPass_TypeDefinitionIndex = 5960;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScriptableRenderPass_TypeDefinitionIndex)->GetStaticField(0x2880);
		}
		static ::UnityEngine::Rendering::RenderTargetIdentifier* StaticGet_DefaultRTI1()
		{
			return (::UnityEngine::Rendering::RenderTargetIdentifier*)Il2CppClass::FromTypeDefinitionIndex(ScriptableRenderPass_TypeDefinitionIndex)->GetStaticField(0x2888);
		}
