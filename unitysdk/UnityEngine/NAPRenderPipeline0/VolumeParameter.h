...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GETANDCLEARDRITY_OFFSET UNITYSDK_OFFSET(0x1AD56230)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1AD560E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD56210)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD56200)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AD56220)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1AD561A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1AD560F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD562A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD56290)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeParameter_TypeDefinitionIndex = 6032;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(VolumeParameter_TypeDefinitionIndex)->GetStaticField(0x2960);
		}
