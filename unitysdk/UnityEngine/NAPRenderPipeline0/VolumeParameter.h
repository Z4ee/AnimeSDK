...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GETANDCLEARDRITY_OFFSET UNITYSDK_OFFSET(0x1D135840)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1D1356F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D135820)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D135810)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D135830)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1D1357B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1D135700)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D1358B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1358A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeParameter_TypeDefinitionIndex = 6043;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(VolumeParameter_TypeDefinitionIndex)->GetStaticField(0x2970);
		}
