...
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D4F64D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D4F6500)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D4F64A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DEFERREDSHADINGPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F6410)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DeferredShadingPass_NativeImpl_TypeDefinitionIndex = 5764;
