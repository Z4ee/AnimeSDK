...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_DATANUM_OFFSET UNITYSDK_OFFSET(0x1D732560)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_DISPATCHARGS_OFFSET UNITYSDK_OFFSET(0x1D732600)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_DISPATCHIDX_OFFSET UNITYSDK_OFFSET(0x1D7325C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_GROUPSUMS_OFFSET UNITYSDK_OFFSET(0x1D7325A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_SCANGROUPPAYLOAD_OFFSET UNITYSDK_OFFSET(0x1D7325E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_SWAPDATA_OFFSET UNITYSDK_OFFSET(0x1D732580)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_INIT_OFFSET UNITYSDK_OFFSET(0x1D732210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D731760)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_DATANUM_OFFSET UNITYSDK_OFFSET(0x1D732570)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_DISPATCHARGS_OFFSET UNITYSDK_OFFSET(0x1D732610)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_DISPATCHIDX_OFFSET UNITYSDK_OFFSET(0x1D7325D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_GROUPSUMS_OFFSET UNITYSDK_OFFSET(0x1D7325B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_SCANGROUPPAYLOAD_OFFSET UNITYSDK_OFFSET(0x1D7325F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_SWAPDATA_OFFSET UNITYSDK_OFFSET(0x1D732590)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SWAPDATA_OFFSET UNITYSDK_OFFSET(0x1D732620)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D732550)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXGI_RadixSortBuffers_TypeDefinitionIndex = 5798;
