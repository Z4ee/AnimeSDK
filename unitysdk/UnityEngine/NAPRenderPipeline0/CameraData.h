...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_ANTIALIASINGUSETEMPORAL_OFFSET UNITYSDK_OFFSET(0x9F1400)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETGPUPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x9F14B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETNONJITTEREDPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x9F1480)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPREVIOUSVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x9F1420)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPRIVOUSPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x9F1450)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x7E4C70)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x3E4B00)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GET_ISPREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x9F13F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_SCREENTOVIEWPORTPOINT_OFFSET UNITYSDK_OFFSET(0x9F1660)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_SETUPCAMERAVIEWDATA_OFFSET UNITYSDK_OFFSET(0x9F1550)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_WORLDTOSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x9F1630)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_WORLDTOVIEWPORTPOINT_OFFSET UNITYSDK_OFFSET(0x9F1690)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CameraData_TypeDefinitionIndex = 5950;
