...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4DA320)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4DA350)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4DA080)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DA070)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassGetDummyGPUDataSize_TypeDefinitionIndex = 5697;
