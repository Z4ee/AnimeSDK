...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EBE7F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EBE7F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EBE7CD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE7CB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassGetDummyGPUDataSize_TypeDefinitionIndex = 5701;
