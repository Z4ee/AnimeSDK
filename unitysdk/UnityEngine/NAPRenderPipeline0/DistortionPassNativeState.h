...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1AFAFC10)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AFAFC50)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1AFAFB50)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1AFAFC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFAFC20)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFAFC00)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AFAFB80)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1AFAFBF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFAFB20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DistortionPassNativeState_TypeDefinitionIndex = 5728;
