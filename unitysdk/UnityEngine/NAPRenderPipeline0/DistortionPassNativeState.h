...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1D4260D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D426110)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D426010)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D426100)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D4260E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D4260C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D426040)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1D4260B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D425FE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DistortionPassNativeState_TypeDefinitionIndex = 5730;
