...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1D7B0740)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1D7B0890)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_OFFSET UNITYSDK_OFFSET(0x1D7B0570)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1D7B0550)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_ISTEMPBUFFEREXIST_OFFSET UNITYSDK_OFFSET(0x1D7B04F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1D7B0440)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D7B01A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D7B0280)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D7B0360)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B0090)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GlobalBufferManager_GlobalRTWrap_TypeDefinitionIndex = 6026;
