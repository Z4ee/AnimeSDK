...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B4936F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1B493840)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_OFFSET UNITYSDK_OFFSET(0x1B493520)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B493500)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_ISTEMPBUFFEREXIST_OFFSET UNITYSDK_OFFSET(0x1B4934A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1B4933F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B493150)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B493230)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B493310)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B493040)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GlobalBufferManager_GlobalRTWrap_TypeDefinitionIndex = 6016;
