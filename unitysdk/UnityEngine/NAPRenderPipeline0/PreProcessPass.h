...
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D2A2890)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1D2A27F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A2790)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PreProcessPass_TypeDefinitionIndex = 5810;
