...
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AE71580)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AE71590)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AE715B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE715A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_SYNCSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x1AE715C0)
