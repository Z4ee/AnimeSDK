...
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D2A2430)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D2A2440)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D2A2460)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D2A2450)
#define UNITYENGINE_NAPRENDERPIPELINE0_MONOPEROBJECTSHADOWBINDINGS_INTERNAL_SYNCSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x1D2A2470)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MonoPerObjectShadowBindings_TypeDefinitionIndex = 6120;
