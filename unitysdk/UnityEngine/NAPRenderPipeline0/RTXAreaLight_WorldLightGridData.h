...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_WORLDLIGHTGRIDDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1E31A3A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_WORLDLIGHTGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E31A2C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXAreaLight_WorldLightGridData_TypeDefinitionIndex = 5804;
