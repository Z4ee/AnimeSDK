...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFB8270)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShaderIDs_TypeDefinitionIndex = 5801;
