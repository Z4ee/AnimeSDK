...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D42E730)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShaderIDs_TypeDefinitionIndex = 5807;
