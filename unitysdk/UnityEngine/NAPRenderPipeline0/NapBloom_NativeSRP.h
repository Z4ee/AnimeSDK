...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E8AC460)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVEFORHDR_OFFSET UNITYSDK_OFFSET(0x1E8ABAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E8ABA80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISSECONDARYGLAREACTIVE_OFFSET UNITYSDK_OFFSET(0x1E8ABB20)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E8ABB50)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8AC360)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8ABB60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapBloom_NativeSRP_TypeDefinitionIndex = 6112;
