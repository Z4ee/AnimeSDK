...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1B0C2530)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVEFORHDR_OFFSET UNITYSDK_OFFSET(0x1B0C1BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B0C1B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISSECONDARYGLAREACTIVE_OFFSET UNITYSDK_OFFSET(0x1B0C1BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B0C1C20)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0C2430)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C1C30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapBloom_NativeSRP_TypeDefinitionIndex = 6099;
