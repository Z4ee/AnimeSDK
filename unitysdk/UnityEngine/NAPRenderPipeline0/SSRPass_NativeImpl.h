...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DF5B190)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1DF5B1C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5B110)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSRPass_NativeImpl_TypeDefinitionIndex = 5768;
