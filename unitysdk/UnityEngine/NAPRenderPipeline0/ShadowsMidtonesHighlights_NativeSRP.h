...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E7D7760)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E7D7340)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E7D73C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7D7660)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7D73D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShadowsMidtonesHighlights_NativeSRP_TypeDefinitionIndex = 6092;
