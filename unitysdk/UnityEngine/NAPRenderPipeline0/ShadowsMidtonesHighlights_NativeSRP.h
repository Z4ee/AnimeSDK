...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D432AC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D4326A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D432720)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4329C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D432730)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShadowsMidtonesHighlights_NativeSRP_TypeDefinitionIndex = 6090;
