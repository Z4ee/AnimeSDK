...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_ADDINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x1EBE61B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_CLEARINDICATEDLIGHTS_OFFSET UNITYSDK_OFFSET(0x1EBE61C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1EBE60F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1EBE6100)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EBE6180)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1EBE61A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1EBE6190)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETRENDERERHANDLES_OFFSET UNITYSDK_OFFSET(0x1EBE61D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x1EBE6170)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETBONETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1EBE61F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x1EBE6160)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETFLAGS_OFFSET UNITYSDK_OFFSET(0x1EBE6200)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x1EBE6140)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETOVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1EBE61E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETPEROBJECTSHADOWRESOLVEALPHA_OFFSET UNITYSDK_OFFSET(0x1EBE6150)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1EBE6120)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETUP_OFFSET UNITYSDK_OFFSET(0x1EBE6110)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETUSEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1EBE6130)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapRenderEntityBindings_TypeDefinitionIndex = 6124;
	...
	public:
		...
		static ::System::Void Internal_SetEntityType(::System::IntPtr nativeHandle, ::System::Int32 entityType)
		{
			return ((::System::Void(*)(::System::IntPtr, ::System::Int32))((::PBYTE)hIl2Cpp + UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETENTITYTYPE_OFFSET))(nativeHandle, entityType);
		}
