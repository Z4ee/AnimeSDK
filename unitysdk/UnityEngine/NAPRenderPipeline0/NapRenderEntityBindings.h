...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_ADDINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x1D851E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_CLEARINDICATEDLIGHTS_OFFSET UNITYSDK_OFFSET(0x1D851E90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D851DD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D851DE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D851E50)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1D851E70)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1D851E60)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETRENDERERHANDLES_OFFSET UNITYSDK_OFFSET(0x1D851EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_GETZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x1D851E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETBONETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1D851EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETFLAGS_OFFSET UNITYSDK_OFFSET(0x1D851ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x1D851E20)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETOVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1D851EB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETPEROBJECTSHADOWRESOLVEALPHA_OFFSET UNITYSDK_OFFSET(0x1D851E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1D851E00)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D851DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYBINDINGS_INTERNAL_SETUSEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1D851E10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapRenderEntityBindings_TypeDefinitionIndex = 6122;
