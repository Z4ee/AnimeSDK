...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E8ADB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1E8ADAF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_RELOAD_OFFSET UNITYSDK_OFFSET(0x1E8AD620)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8AD610)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeStack_TypeDefinitionIndex = 6073;
