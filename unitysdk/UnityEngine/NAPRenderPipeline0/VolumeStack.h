...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D4F9790)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D4F9750)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_RELOAD_OFFSET UNITYSDK_OFFSET(0x1D4F9290)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F9280)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeStack_TypeDefinitionIndex = 6071;
