...
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D66F670)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D66F710)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D66F6F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D66F740)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D66F680)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D66F750)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_SETUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D66F730)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1D66F720)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D66F650)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ReflectionPassNativeState_TypeDefinitionIndex = 5769;
