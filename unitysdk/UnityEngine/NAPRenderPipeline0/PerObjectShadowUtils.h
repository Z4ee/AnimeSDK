...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWUTILS_GETAXISWITHLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x11092840)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWUTILS_REFRESHAXISWITHLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x11092640)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowUtils_TypeDefinitionIndex = 27214;
