...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWUTILS_GETAXISWITHLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0xF795A90)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWUTILS_REFRESHAXISWITHLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0xF795830)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowUtils_TypeDefinitionIndex = 26634;
