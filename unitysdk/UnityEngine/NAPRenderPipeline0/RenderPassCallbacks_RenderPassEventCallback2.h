...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D817190)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D817250)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D816E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D816DF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassEventCallback2_TypeDefinitionIndex = 5698;
