...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4C5360)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4C5420)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4C4FE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C4FD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassEventCallback2_TypeDefinitionIndex = 5696;
