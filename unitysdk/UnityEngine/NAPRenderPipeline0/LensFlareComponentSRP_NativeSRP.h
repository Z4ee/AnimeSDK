...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C50B2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_GET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1C50B020)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C50B180)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_SET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1C50B030)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C50B620)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareComponentSRP_NativeSRP_TypeDefinitionIndex = 24701;
