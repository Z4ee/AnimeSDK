...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E83D4D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_GET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1E83D220)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E83D380)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_SET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1E83D230)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E83D820)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareComponentSRP_NativeSRP_TypeDefinitionIndex = 18486;
