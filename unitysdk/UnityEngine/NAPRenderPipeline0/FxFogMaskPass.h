...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4D3490)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B4D39B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D33B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FxFogMaskPass_TypeDefinitionIndex = 5825;
