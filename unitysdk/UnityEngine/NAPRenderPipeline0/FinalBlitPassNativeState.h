...
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EA5F750)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EA5F7F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA5F7D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EA5F810)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EA5F760)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1EA5F800)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5F730)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FinalBlitPassNativeState_TypeDefinitionIndex = 5742;
