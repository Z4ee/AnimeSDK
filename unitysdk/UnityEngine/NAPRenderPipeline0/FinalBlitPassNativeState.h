...
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B2F0080)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B2F0120)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2F0100)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B2F0140)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B2F0090)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1B2F0130)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F0060)
