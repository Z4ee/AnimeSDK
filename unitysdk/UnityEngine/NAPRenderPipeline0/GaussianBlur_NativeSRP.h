...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E8AB290)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E8AAF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E8AAF40)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8AB190)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8AAF50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlur_NativeSRP_TypeDefinitionIndex = 6107;
