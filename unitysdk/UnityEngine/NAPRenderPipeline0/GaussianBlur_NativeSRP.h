...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D4F6EF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D4F6B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D4F6BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4F6DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F6BB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlur_NativeSRP_TypeDefinitionIndex = 6105;
