...
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_COLORBLENDMETHODPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5A5A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VREffects_NativeSRP_ColorBlendMethodParameter_TypeDefinitionIndex = 6119;
