...
#define UNITYENGINE_NAPRENDERPIPELINE0_BOOLPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DA8F1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BOOLPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DA8F1E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BOOLPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8F1B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BoolParameter_TypeDefinitionIndex = 6049;
