...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B2DBCB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B2DBD50)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2DBD30)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B2DBD60)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B2DBCC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2DBC90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPassNativeState_TypeDefinitionIndex = 5744;
