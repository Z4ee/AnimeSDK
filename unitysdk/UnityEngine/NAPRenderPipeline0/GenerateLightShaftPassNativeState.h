...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D66E330)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D66E3D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D66E3B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D66E3E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D66E340)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D66E310)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPassNativeState_TypeDefinitionIndex = 5746;
