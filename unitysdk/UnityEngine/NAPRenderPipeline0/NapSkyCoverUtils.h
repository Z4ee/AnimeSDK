...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_GETSKYCOVERTIMEPARAMS_OFFSET UNITYSDK_OFFSET(0x1EA5FAF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETDRAWPARAMS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EA5FAE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETDRAWPARAMS_OFFSET UNITYSDK_OFFSET(0x1EA5FAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETSKYCOVERTIMEPARAMS_OFFSET UNITYSDK_OFFSET(0x1EA5FB00)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5FB10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSkyCoverUtils_TypeDefinitionIndex = 5711;
