...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7CCC30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7CCCF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7CC890)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7CC870)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_GBufferEventCallbackWithCmdBuffer_TypeDefinitionIndex = 5698;
