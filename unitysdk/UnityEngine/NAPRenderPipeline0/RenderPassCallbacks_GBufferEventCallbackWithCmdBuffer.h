...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFB1C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFB1D00)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFB18C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB18B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_GBufferEventCallbackWithCmdBuffer_TypeDefinitionIndex = 5694;
