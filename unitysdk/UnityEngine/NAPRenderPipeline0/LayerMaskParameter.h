...
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D128D20)
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D128D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D128D00)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LayerMaskParameter_TypeDefinitionIndex = 6050;
