...
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_CONVERTTOATLASMATRIX_OFFSET UNITYSDK_OFFSET(0x1D6A9070)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_EXECUTECACHED_OFFSET UNITYSDK_OFFSET(0x1D6A7820)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6A6800)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_FINISHDYNAMICREQ_OFFSET UNITYSDK_OFFSET(0x1D6A9260)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_SETTILEVIEWPORT_OFFSET UNITYSDK_OFFSET(0x1D6A9000)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_SETUPCACHED_OFFSET UNITYSDK_OFFSET(0x1D6A69A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A66A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PunctualLightShadowCasterPass_TypeDefinitionIndex = 5811;
