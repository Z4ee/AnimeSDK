...
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_DRAWLIGHTMAPSCALECALLBACK_OFFSET UNITYSDK_OFFSET(0x1D8119C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ExternalFunctionUtils_TypeDefinitionIndex = 6040;
