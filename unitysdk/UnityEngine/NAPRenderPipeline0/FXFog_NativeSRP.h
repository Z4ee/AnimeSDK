...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D426500)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D426540)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D426120)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FXFog_NativeSRP_TypeDefinitionIndex = 6114;
