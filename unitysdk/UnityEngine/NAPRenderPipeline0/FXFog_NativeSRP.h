...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E7CB000)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E7CB040)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7CAC20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FXFog_NativeSRP_TypeDefinitionIndex = 6116;
