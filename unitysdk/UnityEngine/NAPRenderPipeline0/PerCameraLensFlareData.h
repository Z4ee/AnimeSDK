...
#define UNITYENGINE_NAPRENDERPIPELINE0_PERCAMERALENSFLAREDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C50CE40)
#define UNITYENGINE_NAPRENDERPIPELINE0_PERCAMERALENSFLAREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C50CCD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerCameraLensFlareData_TypeDefinitionIndex = 24698;
