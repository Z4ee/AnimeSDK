...
#define UNITYENGINE_NAPRENDERPIPELINE0_PERCAMERALENSFLAREDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x1E83F040)
#define UNITYENGINE_NAPRENDERPIPELINE0_PERCAMERALENSFLAREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E83EED0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerCameraLensFlareData_TypeDefinitionIndex = 18483;
