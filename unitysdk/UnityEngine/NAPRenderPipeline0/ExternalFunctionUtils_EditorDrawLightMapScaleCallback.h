...
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E8AAE70)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E8AAEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8AA8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8AA8C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ExternalFunctionUtils_EditorDrawLightMapScaleCallback_TypeDefinitionIndex = 6043;
