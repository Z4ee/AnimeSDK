...
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4F6AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D4F6B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4F6550)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F6530)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ExternalFunctionUtils_EditorDrawLightMapScaleCallback_TypeDefinitionIndex = 6041;
