...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_CIEXYTOLMS_OFFSET UNITYSDK_OFFSET(0x1AE71250)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_COLORBALANCETOLMSCOEFFS_OFFSET UNITYSDK_OFFSET(0x1AE712D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_PREPARESPLITTONING_OFFSET UNITYSDK_OFFSET(0x1AE713C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_STANDARDILLUMINANTY_OFFSET UNITYSDK_OFFSET(0x1AE71220)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorUtils_TypeDefinitionIndex = 5980;
