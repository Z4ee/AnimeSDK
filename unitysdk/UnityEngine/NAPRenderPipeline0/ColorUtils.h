...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_CIEXYTOLMS_OFFSET UNITYSDK_OFFSET(0x1E605720)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_COLORBALANCETOLMSCOEFFS_OFFSET UNITYSDK_OFFSET(0x1E6057A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_PREPARESPLITTONING_OFFSET UNITYSDK_OFFSET(0x1E605890)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_STANDARDILLUMINANTY_OFFSET UNITYSDK_OFFSET(0x1E6056F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorUtils_TypeDefinitionIndex = 5992;
