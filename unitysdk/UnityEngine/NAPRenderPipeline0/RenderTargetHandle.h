...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x947CF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x661410)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x947C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x947C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE72BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE72BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_SET_ID_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE72BE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTargetHandle_TypeDefinitionIndex = 5938;

	struct alignas(4) RenderTargetHandle
	{
		static ::UnityEngine::NAPRenderPipeline0::RenderTargetHandle* StaticGet_CameraTarget()
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderTargetHandle*)Il2CppClass::FromTypeDefinitionIndex(RenderTargetHandle_TypeDefinitionIndex)->GetStaticField(0x22F0);
		}
