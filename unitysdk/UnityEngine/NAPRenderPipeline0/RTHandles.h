...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x1D7B2BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x1D7B2D80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_OFFSET UNITYSDK_OFFSET(0x1D7B2A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D7B29D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D7B2EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D7B2F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1D7B2FE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D7B3060)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandles_TypeDefinitionIndex = 6019;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RTHandleSystem**)Il2CppClass::FromTypeDefinitionIndex(RTHandles_TypeDefinitionIndex)->GetStaticField(0x54B0);
		}
