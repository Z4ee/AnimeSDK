...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1EA6AB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EA6A580)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EA6A5B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA6AA30)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA6A5C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusion_NativeSRP_TypeDefinitionIndex = 5818;
