...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D72D300)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D72CD50)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D72CD80)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D72D200)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D72CD90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusion_NativeSRP_TypeDefinitionIndex = 5816;
