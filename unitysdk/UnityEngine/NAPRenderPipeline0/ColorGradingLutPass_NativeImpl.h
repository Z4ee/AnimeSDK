...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D7AEEB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_GETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1D7AEEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_SETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1D7AEDF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7AED70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorGradingLutPass_NativeImpl_TypeDefinitionIndex = 5720;
