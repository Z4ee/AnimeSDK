...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB534F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_GETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1EB534E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_SETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1EB53430)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB533B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorGradingLutPass_NativeImpl_TypeDefinitionIndex = 5722;
