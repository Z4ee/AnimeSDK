...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORCORRECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D6F5620)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORCORRECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D6F4030)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORCORRECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D6F4050)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORCORRECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6F5520)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORCORRECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6F4060)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CharacterColorCorrection_NativeSRP_TypeDefinitionIndex = 6086;
