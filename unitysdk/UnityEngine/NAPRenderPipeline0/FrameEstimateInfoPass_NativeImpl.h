...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D4265D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D426600)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D426550)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateInfoPass_NativeImpl_TypeDefinitionIndex = 5782;
