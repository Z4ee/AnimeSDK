...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D4F5DA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D4F55D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D4F57D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4F5CA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F57E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorAdjustments_NativeSRP_TypeDefinitionIndex = 6089;
