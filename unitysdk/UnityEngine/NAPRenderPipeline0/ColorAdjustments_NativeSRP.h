...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E8AA120)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E8A9950)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E8A9B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8AA020)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8A9B60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorAdjustments_NativeSRP_TypeDefinitionIndex = 6091;
