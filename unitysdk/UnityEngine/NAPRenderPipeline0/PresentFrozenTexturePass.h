...
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1DF5A240)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DF5A2C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5A1E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PresentFrozenTexturePass_TypeDefinitionIndex = 5836;
