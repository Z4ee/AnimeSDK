...
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1B65F6E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B65F3B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B65F430)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B65F5E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65F440)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LiftGammaGain_NativeSRP_TypeDefinitionIndex = 6072;
