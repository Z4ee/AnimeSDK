...
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1EDE3DB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EDE3A80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EDE3B00)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EDE3CB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE3B10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LiftGammaGain_NativeSRP_TypeDefinitionIndex = 6085;
