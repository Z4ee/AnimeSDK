...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B65C9D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B65C9E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65CAE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ClampedFloatParameter_TypeDefinitionIndex = 6046;
