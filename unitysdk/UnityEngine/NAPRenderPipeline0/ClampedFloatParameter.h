...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DA29070)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DA29080)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA29180)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ClampedFloatParameter_TypeDefinitionIndex = 6057;
