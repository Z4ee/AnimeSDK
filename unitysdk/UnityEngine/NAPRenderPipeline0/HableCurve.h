...
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_ASSLOPEINTERCEPT_OFFSET UNITYSDK_OFFSET(0x1AAD8C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_EVALDERIVATIVELINEARGAMMA_OFFSET UNITYSDK_OFFSET(0x1AAD8CD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_GET_INVERSEWHITEPOINT_OFFSET UNITYSDK_OFFSET(0x1AAD8350)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_GET_X0_OFFSET UNITYSDK_OFFSET(0x1AAD8370)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_GET_X1_OFFSET UNITYSDK_OFFSET(0x1AAD8390)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_INITSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1AAD8760)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_INIT_OFFSET UNITYSDK_OFFSET(0x1AAD8570)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SET_INVERSEWHITEPOINT_OFFSET UNITYSDK_OFFSET(0x1AAD8360)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SET_WHITEPOINT_OFFSET UNITYSDK_OFFSET(0x1AAD8340)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SET_X0_OFFSET UNITYSDK_OFFSET(0x1AAD8380)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SET_X1_OFFSET UNITYSDK_OFFSET(0x1AAD83A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SOLVEAB_OFFSET UNITYSDK_OFFSET(0x1AAD8D20)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD83B0)
