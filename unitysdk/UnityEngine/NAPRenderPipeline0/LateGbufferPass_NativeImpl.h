...
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1CF34D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1CF34D70)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1CF34D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF34C80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LateGbufferPass_NativeImpl_TypeDefinitionIndex = 5714;
