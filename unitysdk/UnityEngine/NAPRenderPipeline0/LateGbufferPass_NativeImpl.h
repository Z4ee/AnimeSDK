...
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AAD8E60)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AAD8E90)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1AAD8E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD8DA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LateGbufferPass_NativeImpl_TypeDefinitionIndex = 5712;
