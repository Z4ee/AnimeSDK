...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DA97130)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1DA9A060)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_GETRENDERTARGETRESOURCE_OFFSET UNITYSDK_OFFSET(0x1DA96570)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1DA96550)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA96200)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpacePlanarReflectionsPass_TypeDefinitionIndex = 5837;
