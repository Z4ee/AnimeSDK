...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B742A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B745990)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_GETRENDERTARGETRESOURCE_OFFSET UNITYSDK_OFFSET(0x1B741EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1B741E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B741B30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpacePlanarReflectionsPass_TypeDefinitionIndex = 5831;
