...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4F54B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4F54C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F5570)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ClampedIntParameter_TypeDefinitionIndex = 6052;
