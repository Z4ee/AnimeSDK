...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0BF930)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0BF940)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF9F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ClampedIntParameter_TypeDefinitionIndex = 6041;
