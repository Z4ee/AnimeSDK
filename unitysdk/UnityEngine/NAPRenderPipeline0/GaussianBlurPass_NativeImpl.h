...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1E6059A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1E605970)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6058C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlurPass_NativeImpl_TypeDefinitionIndex = 5747;
