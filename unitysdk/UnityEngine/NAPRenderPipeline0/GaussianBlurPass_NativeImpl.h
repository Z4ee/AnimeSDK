...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D2A2380)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D2A2350)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A22A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlurPass_NativeImpl_TypeDefinitionIndex = 5745;
