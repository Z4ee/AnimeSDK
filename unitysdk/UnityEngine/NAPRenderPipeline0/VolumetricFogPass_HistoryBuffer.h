...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EA16D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1EA16E50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA172D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPass_HistoryBuffer_TypeDefinitionIndex = 5845;
