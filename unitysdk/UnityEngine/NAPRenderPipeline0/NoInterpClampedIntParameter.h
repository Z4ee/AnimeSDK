...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D851EE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D851EF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D851FA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpClampedIntParameter_TypeDefinitionIndex = 6053;
