...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBE6210)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EBE6220)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE62D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpClampedIntParameter_TypeDefinitionIndex = 6055;
