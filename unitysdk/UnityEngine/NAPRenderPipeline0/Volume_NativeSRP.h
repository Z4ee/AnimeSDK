...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_GET_PROFILEREF_OFFSET UNITYSDK_OFFSET(0x1B498B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_GET_PROFILE_OFFSET UNITYSDK_OFFSET(0x1B498770)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_HASINSTANTIATEDPROFILE_OFFSET UNITYSDK_OFFSET(0x1B498C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B498E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B498DA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_SET_PROFILE_OFFSET UNITYSDK_OFFSET(0x1B498B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0x1B498F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B498ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B499020)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Volume_NativeSRP_TypeDefinitionIndex = 6066;
