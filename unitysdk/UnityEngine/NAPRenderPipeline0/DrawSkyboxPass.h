...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_DRAWSKYBOX_OFFSET UNITYSDK_OFFSET(0x1CF32BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_PREPARESKYPARAMS_OFFSET UNITYSDK_OFFSET(0x1CF33360)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_PREPARESKYSHPARAMS_OFFSET UNITYSDK_OFFSET(0x1CF33A00)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF34030)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawSkyboxPass_TypeDefinitionIndex = 5826;
