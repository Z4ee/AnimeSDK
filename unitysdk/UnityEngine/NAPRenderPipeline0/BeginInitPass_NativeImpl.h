...
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_BEGININITPASSGETFROMNATIVE_OFFSET UNITYSDK_OFFSET(0x1DA28F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x1DA28F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DA28F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA28F10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BeginInitPass_NativeImpl_TypeDefinitionIndex = 5712;
