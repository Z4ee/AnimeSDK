...
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_BEGININITPASSGETFROMNATIVE_OFFSET UNITYSDK_OFFSET(0x1B65C8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x1B65C8D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B65C8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65C870)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BeginInitPass_NativeImpl_TypeDefinitionIndex = 5710;
