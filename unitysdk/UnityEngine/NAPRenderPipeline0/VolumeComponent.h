...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D855360)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1D8546A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D8545E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D8546C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D855430)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D854B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D8546E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_OVERRIDE_OFFSET UNITYSDK_OFFSET(0x1D854E00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D855440)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_1_OFFSET UNITYSDK_OFFSET(0x1D855060)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_OFFSET UNITYSDK_OFFSET(0x1D855050)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1D8546B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D8545F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D8546D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D84C470)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__ONENABLE_B__15_2_OFFSET UNITYSDK_OFFSET(0x1D8554E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeComponent_TypeDefinitionIndex = 6068;
