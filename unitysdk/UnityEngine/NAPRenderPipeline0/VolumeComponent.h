...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EBE96E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1EBE8A00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EBE8940)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1EBE8A20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EBE97B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EBE8ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EBE8A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_OVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EBE9160)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EBE97C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_1_OFFSET UNITYSDK_OFFSET(0x1EBE93D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_OFFSET UNITYSDK_OFFSET(0x1EBE93C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1EBE8A10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EBE8950)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1EBE8A30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE0750)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__ONENABLE_B__15_2_OFFSET UNITYSDK_OFFSET(0x1EBE9860)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeComponent_TypeDefinitionIndex = 6070;
