...
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AD3CE90)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD3CE20)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AD3CDB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETGPUBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3CC00)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETNAMEID_OFFSET UNITYSDK_OFFSET(0x1AD3CC20)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1AD3CC10)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_UPLOADIFDIRTY_OFFSET UNITYSDK_OFFSET(0x1AD3CC30)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD3CF40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BaseCachedConstantBuffer_TypeDefinitionIndex = 5987;
