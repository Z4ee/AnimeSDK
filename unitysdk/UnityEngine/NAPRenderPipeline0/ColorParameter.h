...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4F6370)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1D4F6300)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4F6380)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D4F5BB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F62D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorParameter_TypeDefinitionIndex = 6059;
