...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C1990)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B0C1A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C19A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BFA30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int IntParameter_TypeDefinitionIndex = 6040;
