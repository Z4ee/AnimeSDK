...
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D6A6290)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D6A62A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A6380)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MinFloatParameter_TypeDefinitionIndex = 6055;
