...
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B2F0230)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B2F0240)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F0320)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MinFloatParameter_TypeDefinitionIndex = 6044;
