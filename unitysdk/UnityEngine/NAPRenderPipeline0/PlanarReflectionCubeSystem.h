...
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETBLENDCUBEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1B494470)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETCUBEDATA_OFFSET UNITYSDK_OFFSET(0x1B494660)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPOINTNDFINBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B4942B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B494BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMESHES_OFFSET UNITYSDK_OFFSET(0x1B494E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B4941D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_ISPLANARREFLECTIONCUBECORRECTEDENABLE_OFFSET UNITYSDK_OFFSET(0x1B494F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B494270)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PlanarReflectionCubeSystem_TypeDefinitionIndex = 6004;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::PlanarReflectionCubeSystem**)Il2CppClass::FromTypeDefinitionIndex(PlanarReflectionCubeSystem_TypeDefinitionIndex)->GetStaticField(0x5480);
		}
