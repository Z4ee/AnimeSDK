...
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETBLENDCUBEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1EB55AE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETCUBEDATA_OFFSET UNITYSDK_OFFSET(0x1EB55CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPOINTNDFINBOUNDS_OFFSET UNITYSDK_OFFSET(0x1EB55920)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMATERIAL_OFFSET UNITYSDK_OFFSET(0x1EB56210)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMESHES_OFFSET UNITYSDK_OFFSET(0x1EB56460)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1EB55840)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_ISPLANARREFLECTIONCUBECORRECTEDENABLE_OFFSET UNITYSDK_OFFSET(0x1EB565B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB558E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PlanarReflectionCubeSystem_TypeDefinitionIndex = 6016;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::PlanarReflectionCubeSystem**)Il2CppClass::FromTypeDefinitionIndex(PlanarReflectionCubeSystem_TypeDefinitionIndex)->GetStaticField(0x54B0);
		}
