...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B2F4220)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B2F41A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B2F4230)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F4100)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TextureCurveParameter_TypeDefinitionIndex = 6070;
