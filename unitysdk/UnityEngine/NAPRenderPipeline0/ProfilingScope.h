...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x94AE10)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x94ADC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_INITPROFILINGSCOPE_OFFSET UNITYSDK_OFFSET(0x94AE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFB11D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x94AC90)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x94AB60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ProfilingScope_TypeDefinitionIndex = 5968;

	struct alignas(8) ProfilingScope
	{
		static ::System::Boolean* StaticGet_Enabled()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ProfilingScope_TypeDefinitionIndex)->GetStaticField(0x2B00);
		}
