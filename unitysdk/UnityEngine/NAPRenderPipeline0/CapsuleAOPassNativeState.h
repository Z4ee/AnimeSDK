...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D2A1FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D2A2090)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D2A2070)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D2A20B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D2A2000)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D2A20C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1D2A20A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A1FD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CapsuleAOPassNativeState_TypeDefinitionIndex = 5761;
