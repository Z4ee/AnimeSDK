...
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1DF5B9F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1DF5BA90)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DF5BA70)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DF5BAB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DF5BA00)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1DF5BAA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAAFTERGBUFFERPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5B9D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TBLLightDataAfterGbufferPassNativeState_TypeDefinitionIndex = 5779;
