...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EB5F800)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EB5F8A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EB5F880)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB5F8B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EB5F810)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5F7E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawSkyboxPassNativeState_TypeDefinitionIndex = 5740;
