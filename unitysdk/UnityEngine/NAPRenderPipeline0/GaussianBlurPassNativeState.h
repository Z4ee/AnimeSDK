...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AFB0260)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1AFB01A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1AFB0250)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFB0230)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFB0280)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AFB01C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1AFB0270)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB0170)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlurPassNativeState_TypeDefinitionIndex = 5742;
