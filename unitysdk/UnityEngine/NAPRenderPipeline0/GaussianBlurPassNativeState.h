...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D426720)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D426660)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D426710)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D4266F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D426740)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D426680)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1D426730)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D426630)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlurPassNativeState_TypeDefinitionIndex = 5744;
