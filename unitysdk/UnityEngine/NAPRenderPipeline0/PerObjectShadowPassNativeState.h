...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EB55770)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EB55810)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EB557F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB55820)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EB55780)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1EB55830)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB55750)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowPassNativeState_TypeDefinitionIndex = 5787;
