...
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D66E2B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D66E2E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D66E280)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D66E1F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GBufferPass_NativeImpl_TypeDefinitionIndex = 5760;
