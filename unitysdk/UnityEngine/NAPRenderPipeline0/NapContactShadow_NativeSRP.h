...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D5866F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D586330)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D586360)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D5865F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D586370)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapContactShadow_NativeSRP_TypeDefinitionIndex = 6113;
