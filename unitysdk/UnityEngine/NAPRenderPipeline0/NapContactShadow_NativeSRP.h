...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1E94D0E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E94CD20)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1E94CD50)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E94CFE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E94CD60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapContactShadow_NativeSRP_TypeDefinitionIndex = 6115;
