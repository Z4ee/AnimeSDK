...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GETSCALEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B4957F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_NAMEID_OFFSET UNITYSDK_OFFSET(0x1B4951C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1B495150)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B495170)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RT_OFFSET UNITYSDK_OFFSET(0x1B4951B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x1B495110)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_USESCALING_OFFSET UNITYSDK_OFFSET(0x1B495130)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B495210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1B495350)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B4951F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B4956C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B495380)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B495660)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1B495160)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x1B495120)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_USESCALING_OFFSET UNITYSDK_OFFSET(0x1B495140)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4951E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandle_TypeDefinitionIndex = 5944;
