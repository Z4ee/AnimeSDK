...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GETSCALEDSIZE_OFFSET UNITYSDK_OFFSET(0x1D7B2840)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_NAMEID_OFFSET UNITYSDK_OFFSET(0x1D7B2210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1D7B21A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D7B21C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RT_OFFSET UNITYSDK_OFFSET(0x1D7B2200)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x1D7B2160)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_USESCALING_OFFSET UNITYSDK_OFFSET(0x1D7B2180)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D7B2260)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1D7B23A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D7B2240)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D7B2710)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D7B23D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D7B26B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1D7B21B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x1D7B2170)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_USESCALING_OFFSET UNITYSDK_OFFSET(0x1D7B2190)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B2230)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandle_TypeDefinitionIndex = 5954;
