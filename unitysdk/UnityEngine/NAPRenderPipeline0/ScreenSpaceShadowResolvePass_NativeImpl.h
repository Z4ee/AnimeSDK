...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFB8210)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AFB8240)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1AFB81E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB8160)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceShadowResolvePass_NativeImpl_TypeDefinitionIndex = 5770;
