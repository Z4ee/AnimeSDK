...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D42E6D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D42E700)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D42E6A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D42E620)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceShadowResolvePass_NativeImpl_TypeDefinitionIndex = 5774;
