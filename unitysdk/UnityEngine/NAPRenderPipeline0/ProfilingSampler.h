...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B2F0610)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_INLINESAMPLER_OFFSET UNITYSDK_OFFSET(0x1B2F0600)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B2F0620)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_SAMPLER_OFFSET UNITYSDK_OFFSET(0x1B2F05F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2F0630)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F0560)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ProfilingSampler_TypeDefinitionIndex = 5967;
