...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA5FCF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_INLINESAMPLER_OFFSET UNITYSDK_OFFSET(0x1EA5FCE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA5FD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_SAMPLER_OFFSET UNITYSDK_OFFSET(0x1EA5FCD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA5FD10)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5FC40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ProfilingSampler_TypeDefinitionIndex = 5979;
