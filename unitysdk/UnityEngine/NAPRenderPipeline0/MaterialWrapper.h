...
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_CALCDIRTYFLAG_OFFSET UNITYSDK_OFFSET(0x1AFB06F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1AFB0660)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AFB09D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_GETCONSTANTBUFFER_OFFSET UNITYSDK_OFFSET(0x1AFB05D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AFB06E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AFB06C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AFB0610)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB0420)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MaterialWrapper_TypeDefinitionIndex = 5989;
