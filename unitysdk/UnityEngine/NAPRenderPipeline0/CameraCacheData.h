...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B4BEED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_ISANYSHADERCOMPILEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1B4BEF20)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_UPDATESHADERCOMPILESTAMP_OFFSET UNITYSDK_OFFSET(0x1B4BEF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BEF30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CameraCacheData_TypeDefinitionIndex = 5956;
