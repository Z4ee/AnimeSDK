...
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1B4D8130)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B4D7C10)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B4D7C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4D8030)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D7CA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MotionBlur_NativeSRP_TypeDefinitionIndex = 6085;
