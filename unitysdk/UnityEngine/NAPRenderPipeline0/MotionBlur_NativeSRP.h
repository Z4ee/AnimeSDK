...
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D8519E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D8514C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D851540)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8518E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D851550)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MotionBlur_NativeSRP_TypeDefinitionIndex = 6096;
