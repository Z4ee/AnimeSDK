...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_CREATE_OFFSET UNITYSDK_OFFSET(0x1D66E4F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D66E690)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_GETINSTANCEHANDLE_OFFSET UNITYSDK_OFFSET(0x1D66E730)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D66E480)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D66E490)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D66E4A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_SETSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D66E4B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_SETSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1D66E4E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_UPDATEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1D66E4D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_UPDATETARGETS_OFFSET UNITYSDK_OFFSET(0x1D66E4C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_SETSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1D66EC80)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1D66E980)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATESETTINGS_OFFSET UNITYSDK_OFFSET(0x1D66EB00)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATETARGETS_OFFSET UNITYSDK_OFFSET(0x1D66E7F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D66EF00)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowBindings_TypeDefinitionIndex = 6127;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(PerObjectShadowBindings_TypeDefinitionIndex)->GetStaticField(0x2EA0);
		}
