...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_CREATE_OFFSET UNITYSDK_OFFSET(0x1EA11770)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1EA11910)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_GETINSTANCEHANDLE_OFFSET UNITYSDK_OFFSET(0x1EA119B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1EA11700)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1EA11710)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1EA11720)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_SETSETTINGS_OFFSET UNITYSDK_OFFSET(0x1EA11730)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_SETSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1EA11760)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_UPDATEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1EA11750)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_UPDATETARGETS_OFFSET UNITYSDK_OFFSET(0x1EA11740)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_SETSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1EA11ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x1EA11BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATESETTINGS_OFFSET UNITYSDK_OFFSET(0x1EA11D60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATETARGETS_OFFSET UNITYSDK_OFFSET(0x1EA11A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA12140)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowBindings_TypeDefinitionIndex = 6129;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(PerObjectShadowBindings_TypeDefinitionIndex)->GetStaticField(0x2EB0);
		}
