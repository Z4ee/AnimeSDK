...
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x1D6A6500)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6A6510)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_PREPROCESSPASSGETFROMNATIVE_OFFSET UNITYSDK_OFFSET(0x1D6A6520)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A64A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PreProcessPass_NativeImpl_TypeDefinitionIndex = 5716;
