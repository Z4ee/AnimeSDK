...
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B3A3A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B3A3A70)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1B3A39F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A3970)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ReflectionPass_NativeImpl_TypeDefinitionIndex = 5766;
