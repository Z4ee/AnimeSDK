...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CLEARCAMERABOUNDEDBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD45A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATEAOHISTORYBUFFERS_OFFSET UNITYSDK_OFFSET(0x1AD40C10)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATECHARCOLORGRADINGLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD40730)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATECOLORGRADINGLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD3F730)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATEGLOBALSKYLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD3FA50)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATEGLOBALTEMPBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1AD3F210)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATEGLOBALTEMPBUFFER_2_OFFSET UNITYSDK_OFFSET(0x1AD3F2B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATEGLOBALTEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3F160)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATEPLANNERREFLECTIONBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3F050)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATESCENECOLORGRADINGLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD3F8C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_CREATETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD49040)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_DISPOSELEAKINGBUFFERS_OFFSET UNITYSDK_OFFSET(0x1AD457C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD3D990)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETBEFOREUIBLURTEXDESC_OFFSET UNITYSDK_OFFSET(0x1AD45E90)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETCAMERAFROZENTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD3FD30)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETCHARCOLORGRADINGLUTTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1AD40C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETCHARCOLORGRADINGLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD408C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETCLOUDHISTORYBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD42A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETCOLORGRADINGLUTTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1AD403D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETCOLORGRADINGLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD40090)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETFSRHISTORYCOLORBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD41AC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETFSRHISTORYSTATUSBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD42120)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETGLOBALSKYANGLELUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD40080)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETGLOBALSKYLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD40070)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETGLOBALTEMPBUFFERHANDLE_OFFSET UNITYSDK_OFFSET(0x1AD3F570)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETGLOBALTEMPBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1AD3F520)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETGLOBALTEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3F4C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETPLANARREFLECTIONRTSIZE_OFFSET UNITYSDK_OFFSET(0x1AD3F3B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETPLANNERREFLECTIONBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3F020)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETSCENECOLORGRADINGLUTTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1AD40720)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETSCENECOLORGRADINGLUTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD403E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETTAAHISTORYBUFFER2_OFFSET UNITYSDK_OFFSET(0x1AD41010)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GETTAAHISTORYIDBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD412D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AD3D8A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_DEBUGVIEWTYPE_OFFSET UNITYSDK_OFFSET(0x1AD3D280)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_DISABLEHIZCULLING_OFFSET UNITYSDK_OFFSET(0x1AD3D2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_DRAWDEFERREDCHARACTER_OFFSET UNITYSDK_OFFSET(0x1AD3D260)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_ENABLEHIZDEBUG_OFFSET UNITYSDK_OFFSET(0x1AD3D300)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_ENABLEHIZLIGHTCULL_OFFSET UNITYSDK_OFFSET(0x1AD3D2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_ENABLERENDERSHADOWCASTERAFTERGBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3D1E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_LOCALLIGHTDRAWENABLE_OFFSET UNITYSDK_OFFSET(0x1AD3D220)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_LOCALLIGHTENABLE_OFFSET UNITYSDK_OFFSET(0x1AD3D210)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_OPAQUEDISTORTIONWITHSTENCILMASK_OFFSET UNITYSDK_OFFSET(0x1AD3D310)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_PPSDISTORTIONREADY_OFFSET UNITYSDK_OFFSET(0x1AD3D1F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_REFLECTIONPROBEENABLE_OFFSET UNITYSDK_OFFSET(0x1AD3D230)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_SHADOWMASKSAMPLELOD_OFFSET UNITYSDK_OFFSET(0x1AD3D290)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_UIBLURDEPTHSTENCIL_OFFSET UNITYSDK_OFFSET(0x1AD3D240)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GET_S_UIBLURSTENCILWITHOUTDEPTH_OFFSET UNITYSDK_OFFSET(0x1AD3D250)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD45F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_ISGLOBALBUFFEREXIST_OFFSET UNITYSDK_OFFSET(0x1AD3F5C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_QUEUELEAKEDBUFFERFORDISPOSEFROMANYTHREAD_OFFSET UNITYSDK_OFFSET(0x1AD490D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASEBEFORERENDER_OFFSET UNITYSDK_OFFSET(0x1AD43620)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASECAMERAFROZENTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AD3F000)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASEFSRHISTORYCOLORBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD42780)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASEFSRHISTORYSTATUSBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD428E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASEGLOBALTEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD3F650)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASETAAHISTORYBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD41170)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_RELEASETAAHISTORYIDBUFFER_OFFSET UNITYSDK_OFFSET(0x1AD41960)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_SETGLOBALTEMPBUFFERFORMAT_OFFSET UNITYSDK_OFFSET(0x1AD3F360)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_SET_S_DISABLEHIZCULLING_OFFSET UNITYSDK_OFFSET(0x1AD3D2B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_SET_S_DRAWPARTICLEDECAL_OFFSET UNITYSDK_OFFSET(0x1AD3D270)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_SET_S_ENABLEHIZLIGHTCULL_OFFSET UNITYSDK_OFFSET(0x1AD3D2E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_SET_S_HASSHADOWMAPCACHE_OFFSET UNITYSDK_OFFSET(0x1AD3D1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_SET_S_PPSDISTORTIONREADY_OFFSET UNITYSDK_OFFSET(0x1AD3D200)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_TRIMCAMERABOUNDRT_OFFSET UNITYSDK_OFFSET(0x1AD43670)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD491D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD3D320)
...
namespace UnityEngine::NAPRenderPipeline0
{
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::GlobalBufferManager**)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x5040);
		}
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x28F0);
		}
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x290A);
		}
		static ::System::Boolean* StaticGet_s_DisableCachedAdditionalLightData()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x290B);
		}
		static ::System::Boolean* StaticGet_s_DitherOpt()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x290C);
		}
		static ::System::Boolean* StaticGet_s_EnablePVS()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x290D);
		}
		static ::System::Boolean* StaticGet_s_PassOpt()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x290E);
		}
		static ::UnityEngine::Experimental::Rendering::GraphicsFormat* StaticGet_kPlanarReflectionRTFormat()
		{
			return (::UnityEngine::Experimental::Rendering::GraphicsFormat*)Il2CppClass::FromTypeDefinitionIndex(GlobalBufferManager_TypeDefinitionIndex)->GetStaticField(0x2910);
		}
