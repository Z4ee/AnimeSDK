...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D6A5670)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6A54D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5360)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CharacterVolumeProxy_NativeSRP_TypeDefinitionIndex = 6085;
