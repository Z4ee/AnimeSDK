...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1EA5ECF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA5EB50)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5E9E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CharacterVolumeProxy_NativeSRP_TypeDefinitionIndex = 6087;
