...
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D133EF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D133EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D133E40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TBLLightDataPass_NativeImpl_TypeDefinitionIndex = 5778;
