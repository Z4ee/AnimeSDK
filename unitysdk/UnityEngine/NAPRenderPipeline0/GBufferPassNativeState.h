...
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CF341E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1CF34120)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1CF341D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CF341B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1CF34200)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1CF34140)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1CF34210)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1CF341F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF340F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GBufferPassNativeState_TypeDefinitionIndex = 5759;
