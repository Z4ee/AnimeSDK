...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D128FB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D12A0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NAPSECONDARYBLOOMPASSBLUR_OFFSET UNITYSDK_OFFSET(0x1D129CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D128E80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSecondaryBloomPass_TypeDefinitionIndex = 5834;
