...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1DA8F850)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1DA8F8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DA8F8D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DA8F900)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DA8F860)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1DA8F910)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8F830)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateInfoPassNativeState_TypeDefinitionIndex = 5781;
