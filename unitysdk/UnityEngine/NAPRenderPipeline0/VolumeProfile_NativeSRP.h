...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_ADD_OFFSET UNITYSDK_OFFSET(0x1B745F10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_GETCOMPONENTLISTHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B746490)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B7463E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_HASSUBCLASSOF_OFFSET UNITYSDK_OFFSET(0x1B746280)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_HAS_OFFSET UNITYSDK_OFFSET(0x1B746010)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B745E00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_REMOVE_OFFSET UNITYSDK_OFFSET(0x1B746150)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_RESET_OFFSET UNITYSDK_OFFSET(0x1B745F00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B746570)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeProfile_NativeSRP_TypeDefinitionIndex = 6064;
