...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B73BB90)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B73BBC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73BB10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPass_NativeImpl_TypeDefinitionIndex = 5745;
