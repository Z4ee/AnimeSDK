...
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER_GETMIPISREADY_OFFSET UNITYSDK_OFFSET(0x1DA9A0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER_GETRAWVIDEO_OFFSET UNITYSDK_OFFSET(0x1DA9A0A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER_SETBLURAMOUNT_OFFSET UNITYSDK_OFFSET(0x1DA9A090)
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER_SETMIPISREADY_OFFSET UNITYSDK_OFFSET(0x1DA9A0E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER_SETMIPVIDEO_OFFSET UNITYSDK_OFFSET(0x1DA9A0C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER_SETRAWVIDEO_OFFSET UNITYSDK_OFFSET(0x1DA9A0B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VIDEOMIPGENERATORNATIVEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA9A0F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VideoMipGeneratorNativeHelper_TypeDefinitionIndex = 5707;
