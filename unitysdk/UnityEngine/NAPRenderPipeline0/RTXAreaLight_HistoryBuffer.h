...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x1EA6DF00)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EA6DB90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1EA6E040)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA6E490)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXAreaLight_HistoryBuffer_TypeDefinitionIndex = 5805;
