...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x1B3C5600)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B3C5290)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1B3C5740)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C5B90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXAreaLight_HistoryBuffer_TypeDefinitionIndex = 5799;
