...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_ADDVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE76570)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1AE74200)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DENOISE_OFFSET UNITYSDK_OFFSET(0x1AE75C30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOGEXTRA_OFFSET UNITYSDK_OFFSET(0x1AE74F30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE74F40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOREFFECT_OFFSET UNITYSDK_OFFSET(0x1AE74280)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOROPAQUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AE74290)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE742A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE742B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETLIGHTATTENUATION_OFFSET UNITYSDK_OFFSET(0x1AE73D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETVOLUMETRICFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x1AE736B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x1AE73980)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_HASVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE739A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_REMOVEVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE765F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SETUPFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1AE74A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x1AE73990)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE73710)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE___CTOR_B__3_0_OFFSET UNITYSDK_OFFSET(0x1AE76670)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogSystem_Base_TypeDefinitionIndex = 5999;
