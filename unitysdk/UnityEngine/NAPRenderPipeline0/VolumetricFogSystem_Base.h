...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_ADDVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E60AA90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1E6086E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DENOISE_OFFSET UNITYSDK_OFFSET(0x1E60A130)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOGEXTRA_OFFSET UNITYSDK_OFFSET(0x1E609430)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E609440)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOREFFECT_OFFSET UNITYSDK_OFFSET(0x1E608760)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOROPAQUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E608770)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E608780)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E608790)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETLIGHTATTENUATION_OFFSET UNITYSDK_OFFSET(0x1E6081F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETVOLUMETRICFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x1E607B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x1E607E00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_HASVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E607E20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_REMOVEVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E60AB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SETUPFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1E608F40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x1E607E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E607B90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE___CTOR_B__3_0_OFFSET UNITYSDK_OFFSET(0x1E60AB90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogSystem_Base_TypeDefinitionIndex = 6011;
