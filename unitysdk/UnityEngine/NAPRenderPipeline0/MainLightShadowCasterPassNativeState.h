...
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1F346820)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1F3468D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F3468B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1F3468A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1F346830)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1F3468E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F346800)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MainLightShadowCasterPassNativeState_TypeDefinitionIndex = 5727;
