...
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1DF57560)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1DF57610)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DF575F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DF575E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DF57570)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1DF57620)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF57540)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MainLightShadowCasterPassNativeState_TypeDefinitionIndex = 5725;
