...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSDIRT_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D811AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSDIRT_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D811B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSDIRT_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D811B40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensDirt_NativeSRP_TypeDefinitionIndex = 6109;
