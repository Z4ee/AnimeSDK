...
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D734920)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D7349C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D7349A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D7349D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D734930)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D7349E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D734900)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SkyLutPassNativeState_TypeDefinitionIndex = 5765;
