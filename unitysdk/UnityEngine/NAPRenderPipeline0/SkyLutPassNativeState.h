...
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B3C9790)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B3C9830)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B3C9810)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B3C9840)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B3C97A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B3C9850)
#define UNITYENGINE_NAPRENDERPIPELINE0_SKYLUTPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C9770)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SkyLutPassNativeState_TypeDefinitionIndex = 5761;
