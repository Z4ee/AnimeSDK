...
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D7302F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D7302C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D730240)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int OpaquePostProcessPass_NativeImpl_TypeDefinitionIndex = 5752;
