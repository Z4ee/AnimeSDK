...
{
	inline static constexpr unsigned int RenderPassCallbacks_TypeDefinitionIndex = 5694;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_RenderPassGetDummyGPUDataSize**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x57D0);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_GBufferEventCallback**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x57D8);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_RenderPassEventCallback1**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x57E8);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_RenderPassEventCallback1**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x57F8);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_GBufferEventCallback**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x5800);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_GBufferEventCallbackWithCmdBuffer**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x5808);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderPassCallbacks_RenderPassEventCallback1**)Il2CppClass::FromTypeDefinitionIndex(RenderPassCallbacks_TypeDefinitionIndex)->GetStaticField(0x5818);
		}
	};
}
