...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAW3DUIPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB539A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAW3DUIPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB535C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Draw3DUIPass_TypeDefinitionIndex = 5831;
