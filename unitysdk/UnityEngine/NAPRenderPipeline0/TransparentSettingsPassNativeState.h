...
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1D6FC1C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1D6FC260)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D6FC240)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6FC280)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D6FC1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1D6FC270)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6FC1A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TransparentSettingsPassNativeState_TypeDefinitionIndex = 5757;
