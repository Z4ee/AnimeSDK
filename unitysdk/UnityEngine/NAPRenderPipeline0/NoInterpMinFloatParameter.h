...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPMINFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DF59C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPMINFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DF59C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPMINFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF59D70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpMinFloatParameter_TypeDefinitionIndex = 6056;
