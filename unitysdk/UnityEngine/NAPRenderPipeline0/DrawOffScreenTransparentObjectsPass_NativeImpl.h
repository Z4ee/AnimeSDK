...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6A5F30)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D6A5F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_SETUP_1_OFFSET UNITYSDK_OFFSET(0x1D6A5EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1D6A5E20)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5D70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOffScreenTransparentObjectsPass_NativeImpl_TypeDefinitionIndex = 5776;
