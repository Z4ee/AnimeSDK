...
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_LOCALLIGHTSHADOWCACHECONFIGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE71E10)
...
namespace UnityEngine::NAPRenderPipeline0
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(PunctualLightShadowCasterPass_LocalLightShadowCacheConfigs_TypeDefinitionIndex)->GetStaticField(0x2200);
		}
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(PunctualLightShadowCasterPass_LocalLightShadowCacheConfigs_TypeDefinitionIndex)->GetStaticField(0x2208);
		}
		static ::System::UInt32* StaticGet_kSkipUpdateFrames()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(PunctualLightShadowCasterPass_LocalLightShadowCacheConfigs_TypeDefinitionIndex)->GetStaticField(0x220C);
		}
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(PunctualLightShadowCasterPass_LocalLightShadowCacheConfigs_TypeDefinitionIndex)->GetStaticField(0x221C);
		}
