...
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1EDE5F10)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EDE5AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EDE5B10)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EDE5E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE5B20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Tonemapping_NativeSRP_TypeDefinitionIndex = 6086;
