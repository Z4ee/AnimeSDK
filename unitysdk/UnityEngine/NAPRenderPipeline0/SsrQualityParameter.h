...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5A500)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SsrQualityParameter_TypeDefinitionIndex = 6100;
