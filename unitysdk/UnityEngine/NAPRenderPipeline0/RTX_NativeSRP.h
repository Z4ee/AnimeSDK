...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1CF35F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1CF35E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1CF35E70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CF35E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF35980)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTX_NativeSRP_TypeDefinitionIndex = 6100;
