...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D585BB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D585C30)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D585BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D585B90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ConsoleVariableFloat_TypeDefinitionIndex = 5691;
