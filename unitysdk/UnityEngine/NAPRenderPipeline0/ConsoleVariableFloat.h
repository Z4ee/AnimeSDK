...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B1851E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B185260)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B185220)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1851C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ConsoleVariableFloat_TypeDefinitionIndex = 5689;
