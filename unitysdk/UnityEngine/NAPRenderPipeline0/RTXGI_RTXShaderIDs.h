...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RTXSHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6A9410)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RTXSHADERIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A93B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXGI_RTXShaderIDs_TypeDefinitionIndex = 5796;
