...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_ADDTOCHECK_OFFSET UNITYSDK_OFFSET(0xA2AD70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_BEGINCHECK_OFFSET UNITYSDK_OFFSET(0xA2AD60)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_CHECKISCACHED_OFFSET UNITYSDK_OFFSET(0xA2ADD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_GETCURRENT_OFFSET UNITYSDK_OFFSET(0xA2ADE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA2ACF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeApplyCache_TypeDefinitionIndex = 6073;
