...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_ADDTOCHECK_OFFSET UNITYSDK_OFFSET(0xA7FE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_BEGINCHECK_OFFSET UNITYSDK_OFFSET(0xA7FE50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_CHECKISCACHED_OFFSET UNITYSDK_OFFSET(0xA7FEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_GETCURRENT_OFFSET UNITYSDK_OFFSET(0xA7FED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA7FDE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeApplyCache_TypeDefinitionIndex = 6075;
