...
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDE3A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EDE3980)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EDE3A30)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EDE3A10)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EDE3A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EDE39A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1EDE3A70)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1EDE3A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE3950)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LateGbufferPassNativeState_TypeDefinitionIndex = 5715;
