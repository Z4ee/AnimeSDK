...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CHECK_OFFSET UNITYSDK_OFFSET(0x1E83E2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E83E5E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PACKEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1E83E700)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1E83E280)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E83EBB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E83EBA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E83EBC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_SET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1E83E290)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E83EBD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareProfile_NativeSRP_TypeDefinitionIndex = 18487;
