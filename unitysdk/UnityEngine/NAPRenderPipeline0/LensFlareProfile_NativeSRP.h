...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CHECK_OFFSET UNITYSDK_OFFSET(0x1C50C0A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C50C3E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PACKEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1C50C500)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1C50C080)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C50C9B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C50C9A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C50C9C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_SET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1C50C090)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C50C9D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareProfile_NativeSRP_TypeDefinitionIndex = 24702;
