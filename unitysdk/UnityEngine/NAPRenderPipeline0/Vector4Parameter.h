...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C35E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B0C3570)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C35F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C2400)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector4Parameter_TypeDefinitionIndex = 6051;
