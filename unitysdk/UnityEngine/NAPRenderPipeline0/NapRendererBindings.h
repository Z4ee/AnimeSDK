...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1B2DBDA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x1B2DBDD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B2DBD70)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x1B2DBD90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0x1B2DBDF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURESCALE_OFFSET UNITYSDK_OFFSET(0x1B2DBDE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B2DBDB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1B2DBDC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1B2DBD80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapRendererBindings_TypeDefinitionIndex = 6114;
