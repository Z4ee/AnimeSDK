...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1EA116A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x1EA116D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1EA11670)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x1EA11690)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0x1EA116F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURESCALE_OFFSET UNITYSDK_OFFSET(0x1EA116E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EA116B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1EA116C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1EA11680)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapRendererBindings_TypeDefinitionIndex = 6127;
