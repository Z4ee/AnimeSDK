...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AFB0DE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x1AFB0C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x1AFB0EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AFB0DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB0BC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpTextureParameter_TypeDefinitionIndex = 6053;
