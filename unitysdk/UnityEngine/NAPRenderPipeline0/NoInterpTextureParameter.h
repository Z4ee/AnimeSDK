...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D427290)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x1D427110)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x1D427370)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4272A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D427070)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpTextureParameter_TypeDefinitionIndex = 6064;
