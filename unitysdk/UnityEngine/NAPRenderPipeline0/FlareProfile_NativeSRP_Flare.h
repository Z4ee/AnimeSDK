...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACK2VECTOR4_OFFSET UNITYSDK_OFFSET(0x1B3A0E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_1_OFFSET UNITYSDK_OFFSET(0x1B3A0D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_OFFSET UNITYSDK_OFFSET(0x1B3A0C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A1100)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FlareProfile_NativeSRP_Flare_TypeDefinitionIndex = 5691;
