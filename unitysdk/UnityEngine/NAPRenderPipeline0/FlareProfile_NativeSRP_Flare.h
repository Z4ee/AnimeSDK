...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACK2VECTOR4_OFFSET UNITYSDK_OFFSET(0x1EA8C1C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_1_OFFSET UNITYSDK_OFFSET(0x1EA8C0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_OFFSET UNITYSDK_OFFSET(0x1EA8BFE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA8C530)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FlareProfile_NativeSRP_Flare_TypeDefinitionIndex = 5695;
