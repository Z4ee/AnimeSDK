...
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19688180)
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x19688130)
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x196880D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int OffscreenParticleUpdatePass_TypeDefinitionIndex = 29768;
