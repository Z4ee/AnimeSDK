...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D42E5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D42E610)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D42E420)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpacePlanarReflection_NativeSRP_TypeDefinitionIndex = 6112;
