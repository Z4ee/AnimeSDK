...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOCAUTOSIZEDRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EA8E560)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x1EA8E210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x1EA8EAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_3_OFFSET UNITYSDK_OFFSET(0x1EA8EC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_OFFSET UNITYSDK_OFFSET(0x1EA8DD40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DEMANDRESIZE_OFFSET UNITYSDK_OFFSET(0x1EA8DA40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1EA8CAA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EA8CA90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1EA8D420)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1EA8D410)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EA8C8D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EA8CF30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EA8D060)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x1EA8D170)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RESIZE_OFFSET UNITYSDK_OFFSET(0x1EA8D430)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1EA8D750)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETREFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1EA8D1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SWITCHRESIZEMODE_OFFSET UNITYSDK_OFFSET(0x1EA8D920)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA8C8F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandleSystem_TypeDefinitionIndex = 6018;
