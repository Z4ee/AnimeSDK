...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOCAUTOSIZEDRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D6FA620)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x1D6FA2C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x1D6FABE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_3_OFFSET UNITYSDK_OFFSET(0x1D6FAD50)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_OFFSET UNITYSDK_OFFSET(0x1D6F9DD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DEMANDRESIZE_OFFSET UNITYSDK_OFFSET(0x1D6F9AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D6F8B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D6F8B10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1D6F94B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1D6F94A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D6F8950)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6F8FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D6F90F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D6F9200)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RESIZE_OFFSET UNITYSDK_OFFSET(0x1D6F94C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1D6F97E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETREFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1D6F9260)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SWITCHRESIZEMODE_OFFSET UNITYSDK_OFFSET(0x1D6F99B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6F8970)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandleSystem_TypeDefinitionIndex = 6016;
