...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCRIPTORDYNAMICRESOLUTIONEXT_GETDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B1877A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCRIPTORDYNAMICRESOLUTIONEXT_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1B1878A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTextureDescriptorDynamicResolutionExt_TypeDefinitionIndex = 6019;
