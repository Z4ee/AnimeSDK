...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCRIPTORDYNAMICRESOLUTIONEXT_GETDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1E94EB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCRIPTORDYNAMICRESOLUTIONEXT_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1E94EC30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTextureDescriptorDynamicResolutionExt_TypeDefinitionIndex = 6032;
