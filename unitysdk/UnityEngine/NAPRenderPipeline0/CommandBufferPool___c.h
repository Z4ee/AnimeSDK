...
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4F63A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F63E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL___C___CCTOR_B__7_0_OFFSET UNITYSDK_OFFSET(0x1D4F63F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CommandBufferPool___c_TypeDefinitionIndex = 6033;
