...
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTIONPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E318E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E318E70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DynamicResolutionParams_TypeDefinitionIndex = 6030;
