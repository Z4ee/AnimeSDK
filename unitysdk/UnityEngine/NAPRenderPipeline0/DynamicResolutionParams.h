...
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTIONPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CF34050)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF34040)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DynamicResolutionParams_TypeDefinitionIndex = 6028;
