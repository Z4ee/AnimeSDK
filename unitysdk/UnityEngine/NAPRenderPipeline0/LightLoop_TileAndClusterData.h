...
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_TILEANDCLUSTERDATA_ALLOCATERESOLUTIONDEPENDENTBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B65FCB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_TILEANDCLUSTERDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B6604D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_TILEANDCLUSTERDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B65FB20)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_TILEANDCLUSTERDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B660F40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_TILEANDCLUSTERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B660E80)
