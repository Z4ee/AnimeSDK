...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C3460)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B0C3400)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C3480)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C33C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector3Parameter_TypeDefinitionIndex = 6050;
