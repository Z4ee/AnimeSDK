...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4F8FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1D4F8F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D4F9010)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F8F50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector3Parameter_TypeDefinitionIndex = 6061;
