...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_AFTERRENDERERINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B7419B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_AFTERRENDERERING_OFFSET UNITYSDK_OFFSET(0x1B741970)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_DOCULLINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B741950)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_DOCULLING_OFFSET UNITYSDK_OFFSET(0x1B7418A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_GETLIGHTSNUMAFTERCULLING_OFFSET UNITYSDK_OFFSET(0x1B741960)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_INITIALIZEPOSTCULLLIGHTDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B7419F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_INITIALIZEPOSTCULLLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1B7419C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B741A00)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NAPParticleLightsCulling_TypeDefinitionIndex = 5700;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NAPParticleLightsCulling_TypeDefinitionIndex)->GetStaticField(0x2EB0);
		}
		static ::UnityEngine::NAPRenderPipeline0::ParticleLightsCullingOptions* StaticGet_s_CachedParticleLightsCullingOptions()
		{
			return (::UnityEngine::NAPRenderPipeline0::ParticleLightsCullingOptions*)Il2CppClass::FromTypeDefinitionIndex(NAPParticleLightsCulling_TypeDefinitionIndex)->GetStaticField(0x2EB4);
		}
