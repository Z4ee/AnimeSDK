...
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_LIGHTDATAFORCPU_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1AE71500)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_LIGHTDATAFORCPU__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE71570)
