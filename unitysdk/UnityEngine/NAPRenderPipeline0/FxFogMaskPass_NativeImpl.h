...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B65F1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B65F200)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65F150)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FxFogMaskPass_NativeImpl_TypeDefinitionIndex = 5741;
