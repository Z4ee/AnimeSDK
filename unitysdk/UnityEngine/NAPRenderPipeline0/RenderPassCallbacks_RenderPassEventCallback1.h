...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EBE7BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EBE7C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EBE7820)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE7800)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassEventCallback1_TypeDefinitionIndex = 5699;
