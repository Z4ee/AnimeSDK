...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4D9F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4DA040)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4D9C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D9BF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassEventCallback1_TypeDefinitionIndex = 5695;
