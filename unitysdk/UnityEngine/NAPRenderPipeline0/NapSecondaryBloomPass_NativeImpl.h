...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D812440)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D812470)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8123B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSecondaryBloomPass_NativeImpl_TypeDefinitionIndex = 5750;
