...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4C08A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B4C08D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C0810)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSecondaryBloomPass_NativeImpl_TypeDefinitionIndex = 5748;
