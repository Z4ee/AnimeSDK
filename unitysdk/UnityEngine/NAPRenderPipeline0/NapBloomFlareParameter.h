...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOMFLAREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EB55090)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOMFLAREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EB550A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOMFLAREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB54FF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapBloomFlareParameter_TypeDefinitionIndex = 6110;
