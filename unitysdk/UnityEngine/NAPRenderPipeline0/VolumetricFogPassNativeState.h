...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B4990B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B499150)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B499130)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B499170)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B4990C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B499180)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1B499160)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B499090)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPassNativeState_TypeDefinitionIndex = 5767;
