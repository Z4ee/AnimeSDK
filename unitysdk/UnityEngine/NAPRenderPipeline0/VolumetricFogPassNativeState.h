...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EB5AF80)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EB5B020)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EB5B000)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB5B040)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EB5AF90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1EB5B050)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1EB5B030)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5AF60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPassNativeState_TypeDefinitionIndex = 5773;
