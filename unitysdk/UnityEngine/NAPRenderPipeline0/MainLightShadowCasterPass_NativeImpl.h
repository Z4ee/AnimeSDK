...
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0C1AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1B0C1B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_MAINLIGHTSHADOWCASTERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C1A70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MainLightShadowCasterPass_NativeImpl_TypeDefinitionIndex = 5724;
