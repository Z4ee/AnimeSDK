...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1EBE08E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EBE0400)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EBE0480)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBE07E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE0490)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Distortion_NativeSRP_TypeDefinitionIndex = 6105;
