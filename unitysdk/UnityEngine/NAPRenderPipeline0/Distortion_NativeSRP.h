...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D84C600)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D84C120)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D84C1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D84C500)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D84C1B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Distortion_NativeSRP_TypeDefinitionIndex = 6103;
