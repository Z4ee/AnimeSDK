...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1EE299F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_START_OFFSET UNITYSDK_OFFSET(0x1EE299B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE29B10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeBounds_NativeSRP_TypeDefinitionIndex = 6076;
