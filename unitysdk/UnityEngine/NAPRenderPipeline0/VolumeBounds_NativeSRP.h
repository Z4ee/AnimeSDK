...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1B745C30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_START_OFFSET UNITYSDK_OFFSET(0x1B745BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B745D50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeBounds_NativeSRP_TypeDefinitionIndex = 6063;
