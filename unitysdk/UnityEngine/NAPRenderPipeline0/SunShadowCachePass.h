...
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x18FE5030)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18FE4F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18FE4FE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_SETUPCULLINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x18FE4F30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x18FE4EE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE4E60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18FE5070)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SunShadowCachePass_TypeDefinitionIndex = 29769;
