...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D72E090)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1D72E180)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D72E0A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D72E070)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FloatParameter_TypeDefinitionIndex = 6054;
