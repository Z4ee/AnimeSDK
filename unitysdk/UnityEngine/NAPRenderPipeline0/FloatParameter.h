...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EA6B8B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1EA6B9A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EA6B8C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA6B890)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FloatParameter_TypeDefinitionIndex = 6056;
