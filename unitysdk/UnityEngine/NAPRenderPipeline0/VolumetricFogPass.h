...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1D4FA5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1D4FAFB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_SETLOCALRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1D4F9990)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1D4FA580)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F9870)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPass_TypeDefinitionIndex = 5842;
