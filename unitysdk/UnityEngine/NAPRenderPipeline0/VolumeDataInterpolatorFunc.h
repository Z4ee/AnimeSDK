...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E48E3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E48E470)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E48DD10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1E48DCF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeDataInterpolatorFunc_TypeDefinitionIndex = 6068;
