...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD56020)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD560D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD55910)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD55900)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeDataInterpolatorFunc_TypeDefinitionIndex = 6055;
