...
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL_GET_1_OFFSET UNITYSDK_OFFSET(0x1D6A58E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL_GET_OFFSET UNITYSDK_OFFSET(0x1D6A5860)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D6A5960)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5B70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CommandBufferPool_TypeDefinitionIndex = 6032;
