...
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL_GET_OFFSET UNITYSDK_OFFSET(0x1B2EF9B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B2EFA30)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERPOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2EFC40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CommandBufferPool_TypeDefinitionIndex = 6021;
