...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AAD7900)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_GET_1_OFFSET UNITYSDK_OFFSET(0x1AAD7230)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_GET_OFFSET UNITYSDK_OFFSET(0x1AADAB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AADA870)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AADAAF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScopedCommandBuffer_TypeDefinitionIndex = 6020;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScopedCommandBuffer_TypeDefinitionIndex)->GetStaticField(0x25D0);
		}
