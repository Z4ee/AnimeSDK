...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1F349120)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1F3493D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F348FF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowPass_NativeImpl_TypeDefinitionIndex = 5788;
