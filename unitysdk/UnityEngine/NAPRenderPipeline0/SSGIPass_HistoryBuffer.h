...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AFB70F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1AFB75E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB7E70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSGIPass_HistoryBuffer_TypeDefinitionIndex = 5816;
