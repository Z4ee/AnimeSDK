...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x1D128CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_1_OFFSET UNITYSDK_OFFSET(0x1D128C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_2_OFFSET UNITYSDK_OFFSET(0x1D128CB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_3_OFFSET UNITYSDK_OFFSET(0x1D128CC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_OFFSET UNITYSDK_OFFSET(0x1D128BF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int InterpolateUtils_TypeDefinitionIndex = 5992;
