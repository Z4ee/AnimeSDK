...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C32F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1B0C32D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0C3300)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C32B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector2Parameter_TypeDefinitionIndex = 6049;
