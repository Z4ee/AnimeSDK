...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL_GENERATESPHERE_OFFSET UNITYSDK_OFFSET(0x1EA8F8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL_GENERATESPOTSHAPE_OFFSET UNITYSDK_OFFSET(0x1EA8F850)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL_REGENERATESPOTSHAPE_OFFSET UNITYSDK_OFFSET(0x1EA8EF30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA901D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShapeUtil_TypeDefinitionIndex = 5993;
