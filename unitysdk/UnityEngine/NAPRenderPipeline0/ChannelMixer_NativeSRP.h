...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1D4F4EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1D4F4970)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1D4F4AC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4F4DC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F4AD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ChannelMixer_NativeSRP_TypeDefinitionIndex = 6088;
