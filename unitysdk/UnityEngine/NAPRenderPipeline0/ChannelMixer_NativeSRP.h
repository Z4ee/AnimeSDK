...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1B0BF340)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B0BEDF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B0BEF40)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF240)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BEF50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ChannelMixer_NativeSRP_TypeDefinitionIndex = 6077;
