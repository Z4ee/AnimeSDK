...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENBOUND_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x19F25FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENBOUND_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19F26160)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENBOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x19F261B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenBound_TypeDefinitionIndex = 29773;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScreenBound_TypeDefinitionIndex)->GetStaticField(0x7670);
		}
