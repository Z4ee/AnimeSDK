...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENBOUND_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1D2FD3F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENBOUND_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D2FD590)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENBOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FD5E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenBound_TypeDefinitionIndex = 27726;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScreenBound_TypeDefinitionIndex)->GetStaticField(0x73D0);
		}
