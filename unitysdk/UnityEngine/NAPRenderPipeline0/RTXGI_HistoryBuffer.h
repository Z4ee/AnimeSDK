...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x1B3C60B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B3C5BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1B3C66B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C7350)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXGI_HistoryBuffer_TypeDefinitionIndex = 5795;
