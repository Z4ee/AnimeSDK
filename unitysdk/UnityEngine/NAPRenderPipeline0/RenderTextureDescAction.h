...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F349E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F349EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F349B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F349B20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTextureDescAction_TypeDefinitionIndex = 5923;
