...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF5AC60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF5ACD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF5A920)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5A900)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTextureDescAction_TypeDefinitionIndex = 5921;
