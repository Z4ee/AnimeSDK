...
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1DA2D9F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1DA2DA90)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DA2DA70)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1DA2DAB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DA2DA00)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1DA2DAA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA2D9D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TBLLightDataPassNativeState_TypeDefinitionIndex = 5777;
