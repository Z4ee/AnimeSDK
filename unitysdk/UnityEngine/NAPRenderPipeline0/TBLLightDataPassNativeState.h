...
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B661350)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1B6613F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6613D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B661410)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B661360)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1B661400)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B661330)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TBLLightDataPassNativeState_TypeDefinitionIndex = 5773;
