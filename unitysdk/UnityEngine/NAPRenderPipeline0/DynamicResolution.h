...
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_APPLYSCALE_OFFSET UNITYSDK_OFFSET(0x1EA6B2E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICRESOLUTION_1_OFFSET UNITYSDK_OFFSET(0x1EA6B750)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EA6B6F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1EA6B7E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA6B880)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DynamicResolution_TypeDefinitionIndex = 6031;
