...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B2DBB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1B2DBB40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2DBA90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateUIInfoPass_NativeImpl_TypeDefinitionIndex = 5780;
