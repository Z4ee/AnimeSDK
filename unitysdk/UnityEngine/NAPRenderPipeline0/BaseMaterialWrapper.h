...
#define UNITYENGINE_NAPRENDERPIPELINE0_BASEMATERIALWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5350)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BaseMaterialWrapper_TypeDefinitionIndex = 5998;
