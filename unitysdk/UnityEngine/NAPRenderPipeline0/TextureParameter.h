...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EA16920)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x1EA167A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x1EA16CF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EA16B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_SETTO_OFFSET UNITYSDK_OFFSET(0x1EA16C50)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EA16930)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA16700)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TextureParameter_TypeDefinitionIndex = 6065;
