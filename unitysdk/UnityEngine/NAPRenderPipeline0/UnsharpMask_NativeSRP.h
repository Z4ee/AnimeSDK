...
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EBE88B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EBE8930)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE8670)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int UnsharpMask_NativeSRP_TypeDefinitionIndex = 6120;
