...
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B4DAC80)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1B4DAD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DAA40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int UnsharpMask_NativeSRP_TypeDefinitionIndex = 6107;
