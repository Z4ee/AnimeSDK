...
#define UNITYENGINE_ANIMATOR_THREADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EE9B6D0)
#define UNITYENGINE_ANIMATOR_THREADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EE9B7B0)
#define UNITYENGINE_ANIMATOR_THREADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EE9B090)
#define UNITYENGINE_ANIMATOR_THREADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE9B660)
