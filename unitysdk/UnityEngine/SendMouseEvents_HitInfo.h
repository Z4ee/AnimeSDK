...
#define UNITYENGINE_SENDMOUSEEVENTS_HITINFO_COMPARE_OFFSET UNITYSDK_OFFSET(0x18A8C350)
#define UNITYENGINE_SENDMOUSEEVENTS_HITINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x18A8C2F0)
#define UNITYENGINE_SENDMOUSEEVENTS_HITINFO_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0x211EB10)

namespace UnityEngine
{
	inline static constexpr unsigned int SendMouseEvents_HitInfo_TypeDefinitionIndex = 5157;
