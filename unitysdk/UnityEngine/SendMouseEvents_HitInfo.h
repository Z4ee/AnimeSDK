...
#define UNITYENGINE_SENDMOUSEEVENTS_HITINFO_COMPARE_OFFSET UNITYSDK_OFFSET(0x1EFF7120)
#define UNITYENGINE_SENDMOUSEEVENTS_HITINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1EFF70C0)
#define UNITYENGINE_SENDMOUSEEVENTS_HITINFO_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0x3CA0A20)

namespace UnityEngine
{
	inline static constexpr unsigned int SendMouseEvents_HitInfo_TypeDefinitionIndex = 5782;
