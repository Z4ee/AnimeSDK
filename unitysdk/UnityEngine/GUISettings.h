...
#define UNITYENGINE_GUISETTINGS_GET_CURSORCOLOR_OFFSET UNITYSDK_OFFSET(0x1CAD4370)
#define UNITYENGINE_GUISETTINGS_GET_CURSORFLASHSPEED_OFFSET UNITYSDK_OFFSET(0x1CAD4380)
#define UNITYENGINE_GUISETTINGS_GET_DOUBLECLICKSELECTSWORD_OFFSET UNITYSDK_OFFSET(0x1CAC17B0)
#define UNITYENGINE_GUISETTINGS_GET_SELECTIONCOLOR_OFFSET UNITYSDK_OFFSET(0x1CAD43A0)
#define UNITYENGINE_GUISETTINGS_GET_TRIPLECLICKSELECTSLINE_OFFSET UNITYSDK_OFFSET(0x1CAC19F0)
#define UNITYENGINE_GUISETTINGS_INTERNAL_GETCURSORFLASHSPEED_OFFSET UNITYSDK_OFFSET(0x1CAD4360)
#define UNITYENGINE_GUISETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD43B0)
