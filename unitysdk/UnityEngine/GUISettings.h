...
#define UNITYENGINE_GUISETTINGS_GET_CURSORCOLOR_OFFSET UNITYSDK_OFFSET(0x1AECDA90)
#define UNITYENGINE_GUISETTINGS_GET_CURSORFLASHSPEED_OFFSET UNITYSDK_OFFSET(0x1AECDAA0)
#define UNITYENGINE_GUISETTINGS_GET_DOUBLECLICKSELECTSWORD_OFFSET UNITYSDK_OFFSET(0x1AEBB0B0)
#define UNITYENGINE_GUISETTINGS_GET_SELECTIONCOLOR_OFFSET UNITYSDK_OFFSET(0x1AECDAC0)
#define UNITYENGINE_GUISETTINGS_GET_TRIPLECLICKSELECTSLINE_OFFSET UNITYSDK_OFFSET(0x1AEBB2F0)
#define UNITYENGINE_GUISETTINGS_INTERNAL_GETCURSORFLASHSPEED_OFFSET UNITYSDK_OFFSET(0x1AECDA80)
#define UNITYENGINE_GUISETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECDAD0)

namespace UnityEngine
{
	inline static constexpr unsigned int GUISettings_TypeDefinitionIndex = 5226;
