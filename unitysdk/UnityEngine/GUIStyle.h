...
#define UNITYENGINE_GUISTYLE_ASSIGNRECTOFFSET_OFFSET UNITYSDK_OFFSET(0x1E431090)
#define UNITYENGINE_GUISTYLE_ASSIGNSTYLESTATE_OFFSET UNITYSDK_OFFSET(0x1E431070)
#define UNITYENGINE_GUISTYLE_CALCHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E431BD0)
#define UNITYENGINE_GUISTYLE_CALCMINMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1E431BE0)
#define UNITYENGINE_GUISTYLE_CALCSIZEWITHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1E42D010)
#define UNITYENGINE_GUISTYLE_CALCSIZE_OFFSET UNITYSDK_OFFSET(0x1E431BA0)
#define UNITYENGINE_GUISTYLE_DRAW_1_OFFSET UNITYSDK_OFFSET(0x1E41F940)
#define UNITYENGINE_GUISTYLE_DRAW_2_OFFSET UNITYSDK_OFFSET(0x1E421310)
#define UNITYENGINE_GUISTYLE_DRAW_3_OFFSET UNITYSDK_OFFSET(0x1E41E5D0)
#define UNITYENGINE_GUISTYLE_DRAW_4_OFFSET UNITYSDK_OFFSET(0x1E431930)
#define UNITYENGINE_GUISTYLE_DRAW_OFFSET UNITYSDK_OFFSET(0x1E4226E0)
#define UNITYENGINE_GUISTYLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E431260)
#define UNITYENGINE_GUISTYLE_GETRECTOFFSETPTR_OFFSET UNITYSDK_OFFSET(0x1E431080)
#define UNITYENGINE_GUISTYLE_GETSTYLESTATEPTR_OFFSET UNITYSDK_OFFSET(0x1E431060)
#define UNITYENGINE_GUISTYLE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1E431430)
#define UNITYENGINE_GUISTYLE_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E430EE0)
#define UNITYENGINE_GUISTYLE_GET_BORDER_OFFSET UNITYSDK_OFFSET(0x1E431790)
#define UNITYENGINE_GUISTYLE_GET_CLIPPING_OFFSET UNITYSDK_OFFSET(0x1E430F20)
#define UNITYENGINE_GUISTYLE_GET_CONTENTOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E430F70)
#define UNITYENGINE_GUISTYLE_GET_CONTENTOFFSET_OFFSET UNITYSDK_OFFSET(0x1E430F40)
#define UNITYENGINE_GUISTYLE_GET_FIXEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E420D90)
#define UNITYENGINE_GUISTYLE_GET_FIXEDWIDTH_OFFSET UNITYSDK_OFFSET(0x1E420D80)
#define UNITYENGINE_GUISTYLE_GET_FOCUSED_OFFSET UNITYSDK_OFFSET(0x1E431670)
#define UNITYENGINE_GUISTYLE_GET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x1E430FD0)
#define UNITYENGINE_GUISTYLE_GET_FONTSTYLE_OFFSET UNITYSDK_OFFSET(0x1E430FF0)
#define UNITYENGINE_GUISTYLE_GET_FONT_OFFSET UNITYSDK_OFFSET(0x1E430EA0)
#define UNITYENGINE_GUISTYLE_GET_HOVER_OFFSET UNITYSDK_OFFSET(0x1E4313A0)
#define UNITYENGINE_GUISTYLE_GET_IMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x1E430EC0)
#define UNITYENGINE_GUISTYLE_GET_ISHEIGHTDEPENDANTONWIDTH_OFFSET UNITYSDK_OFFSET(0x1E42CE40)
#define UNITYENGINE_GUISTYLE_GET_MARGIN_OFFSET UNITYSDK_OFFSET(0x1E422670)
#define UNITYENGINE_GUISTYLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E420060)
#define UNITYENGINE_GUISTYLE_GET_NONE_OFFSET UNITYSDK_OFFSET(0x1E420ED0)
#define UNITYENGINE_GUISTYLE_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x1E4306E0)
#define UNITYENGINE_GUISTYLE_GET_ONACTIVE_OFFSET UNITYSDK_OFFSET(0x1E4315E0)
#define UNITYENGINE_GUISTYLE_GET_ONFOCUSED_OFFSET UNITYSDK_OFFSET(0x1E431700)
#define UNITYENGINE_GUISTYLE_GET_ONHOVER_OFFSET UNITYSDK_OFFSET(0x1E431550)
#define UNITYENGINE_GUISTYLE_GET_ONNORMAL_OFFSET UNITYSDK_OFFSET(0x1E4314C0)
#define UNITYENGINE_GUISTYLE_GET_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x1E431890)
#define UNITYENGINE_GUISTYLE_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1E429860)
#define UNITYENGINE_GUISTYLE_GET_RAWNAME_OFFSET UNITYSDK_OFFSET(0x1E430E80)
#define UNITYENGINE_GUISTYLE_GET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1E431010)
#define UNITYENGINE_GUISTYLE_GET_STRETCHHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E427A70)
#define UNITYENGINE_GUISTYLE_GET_STRETCHWIDTH_OFFSET UNITYSDK_OFFSET(0x1E427A60)
#define UNITYENGINE_GUISTYLE_GET_WORDWRAP_OFFSET UNITYSDK_OFFSET(0x1E430F00)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E431160)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCMINMAXWIDTH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E4311A0)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCMINMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1E431170)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCSIZEWITHCONSTRAINTS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E431150)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCSIZEWITHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1E431120)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCSIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E431110)
#define UNITYENGINE_GUISTYLE_INTERNAL_CALCSIZE_OFFSET UNITYSDK_OFFSET(0x1E4310E0)
#define UNITYENGINE_GUISTYLE_INTERNAL_COPY_OFFSET UNITYSDK_OFFSET(0x1E431040)
#define UNITYENGINE_GUISTYLE_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1E431030)
#define UNITYENGINE_GUISTYLE_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E431050)
#define UNITYENGINE_GUISTYLE_INTERNAL_DRAW2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E4310D0)
#define UNITYENGINE_GUISTYLE_INTERNAL_DRAW2_OFFSET UNITYSDK_OFFSET(0x1E4310C0)
#define UNITYENGINE_GUISTYLE_INTERNAL_DRAW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E4310B0)
#define UNITYENGINE_GUISTYLE_INTERNAL_DRAW_OFFSET UNITYSDK_OFFSET(0x1E4310A0)
#define UNITYENGINE_GUISTYLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E431A20)
#define UNITYENGINE_GUISTYLE_SETDEFAULTFONT_OFFSET UNITYSDK_OFFSET(0x1E42DEF0)
#define UNITYENGINE_GUISTYLE_SETMOUSETOOLTIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E4311B0)
#define UNITYENGINE_GUISTYLE_SETMOUSETOOLTIP_OFFSET UNITYSDK_OFFSET(0x1E41F9D0)
#define UNITYENGINE_GUISTYLE_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1E431490)
#define UNITYENGINE_GUISTYLE_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E430EF0)
#define UNITYENGINE_GUISTYLE_SET_BORDER_OFFSET UNITYSDK_OFFSET(0x1E431800)
#define UNITYENGINE_GUISTYLE_SET_CLIPPING_OFFSET UNITYSDK_OFFSET(0x1E430F30)
#define UNITYENGINE_GUISTYLE_SET_CONTENTOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E430FA0)
#define UNITYENGINE_GUISTYLE_SET_CONTENTOFFSET_OFFSET UNITYSDK_OFFSET(0x1E430F80)
#define UNITYENGINE_GUISTYLE_SET_FIXEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E430FC0)
#define UNITYENGINE_GUISTYLE_SET_FIXEDWIDTH_OFFSET UNITYSDK_OFFSET(0x1E430FB0)
#define UNITYENGINE_GUISTYLE_SET_FOCUSED_OFFSET UNITYSDK_OFFSET(0x1E4316D0)
#define UNITYENGINE_GUISTYLE_SET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x1E430FE0)
#define UNITYENGINE_GUISTYLE_SET_FONTSTYLE_OFFSET UNITYSDK_OFFSET(0x1E431000)
#define UNITYENGINE_GUISTYLE_SET_FONT_OFFSET UNITYSDK_OFFSET(0x1E430EB0)
#define UNITYENGINE_GUISTYLE_SET_HOVER_OFFSET UNITYSDK_OFFSET(0x1E431400)
#define UNITYENGINE_GUISTYLE_SET_IMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x1E430ED0)
#define UNITYENGINE_GUISTYLE_SET_MARGIN_OFFSET UNITYSDK_OFFSET(0x1E431830)
#define UNITYENGINE_GUISTYLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1E42EAD0)
#define UNITYENGINE_GUISTYLE_SET_NORMAL_OFFSET UNITYSDK_OFFSET(0x1E431370)
#define UNITYENGINE_GUISTYLE_SET_ONACTIVE_OFFSET UNITYSDK_OFFSET(0x1E431640)
#define UNITYENGINE_GUISTYLE_SET_ONFOCUSED_OFFSET UNITYSDK_OFFSET(0x1E431760)
#define UNITYENGINE_GUISTYLE_SET_ONHOVER_OFFSET UNITYSDK_OFFSET(0x1E4315B0)
#define UNITYENGINE_GUISTYLE_SET_ONNORMAL_OFFSET UNITYSDK_OFFSET(0x1E431520)
#define UNITYENGINE_GUISTYLE_SET_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x1E431900)
#define UNITYENGINE_GUISTYLE_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x1E431860)
#define UNITYENGINE_GUISTYLE_SET_RAWNAME_OFFSET UNITYSDK_OFFSET(0x1E430E90)
#define UNITYENGINE_GUISTYLE_SET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1E431020)
#define UNITYENGINE_GUISTYLE_SET_STRETCHHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E4306D0)
#define UNITYENGINE_GUISTYLE_SET_STRETCHWIDTH_OFFSET UNITYSDK_OFFSET(0x1E42D2F0)
#define UNITYENGINE_GUISTYLE_SET_WORDWRAP_OFFSET UNITYSDK_OFFSET(0x1E430F10)
#define UNITYENGINE_GUISTYLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E431C20)
#define UNITYENGINE_GUISTYLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E431D30)
#define UNITYENGINE_GUISTYLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4311C0)
#define UNITYENGINE_GUISTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E42D290)

namespace UnityEngine
{
	inline static constexpr unsigned int GUIStyle_TypeDefinitionIndex = 6423;
	...
	public:
		...
		{
			return (::UnityEngine::GUIStyle**)Il2CppClass::FromTypeDefinitionIndex(GUIStyle_TypeDefinitionIndex)->GetStaticField(0x59E0);
		}
		static ::System::Boolean* StaticGet_showKeyboardFocus()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GUIStyle_TypeDefinitionIndex)->GetStaticField(0x30C0);
		}
