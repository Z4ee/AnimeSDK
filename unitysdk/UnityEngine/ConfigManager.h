...
#define UNITYENGINE_CONFIGMANAGER_ADD_ONAFTERRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x1C169560)
#define UNITYENGINE_CONFIGMANAGER_AFTERRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x1C169530)
#define UNITYENGINE_CONFIGMANAGER_MATCHCONDITION_OFFSET UNITYSDK_OFFSET(0x1C169520)
#define UNITYENGINE_CONFIGMANAGER_REGISTERCUSTOMCONDITION_OFFSET UNITYSDK_OFFSET(0x1C169510)
#define UNITYENGINE_CONFIGMANAGER_RELOADALLCONFIG_OFFSET UNITYSDK_OFFSET(0x1C169500)
#define UNITYENGINE_CONFIGMANAGER_RELOADBYMANAGEDREADER_OFFSET UNITYSDK_OFFSET(0x1C1694F0)
#define UNITYENGINE_CONFIGMANAGER_REMOVE_ONAFTERRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x1C169610)

namespace UnityEngine
{
	inline static constexpr unsigned int ConfigManager_TypeDefinitionIndex = 4045;
	...
	public:
		...
		{
			return (::System::Action_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigManager_TypeDefinitionIndex)->GetStaticField(0x37560);
		}
