...
#define UNITYENGINE_CONFIGMANAGER_ADD_ONAFTERRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x1B285660)
#define UNITYENGINE_CONFIGMANAGER_AFTERRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x1B285630)
#define UNITYENGINE_CONFIGMANAGER_MATCHCONDITION_OFFSET UNITYSDK_OFFSET(0x1B285620)
#define UNITYENGINE_CONFIGMANAGER_REGISTERCUSTOMCONDITION_OFFSET UNITYSDK_OFFSET(0x1B285610)
#define UNITYENGINE_CONFIGMANAGER_RELOADALLCONFIG_OFFSET UNITYSDK_OFFSET(0x1B285600)
#define UNITYENGINE_CONFIGMANAGER_RELOADBYMANAGEDREADER_OFFSET UNITYSDK_OFFSET(0x1B2855F0)
#define UNITYENGINE_CONFIGMANAGER_REMOVE_ONAFTERRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x1B285710)
...
namespace UnityEngine
{
	...
	public:
		...
		{
			return (::System::Action_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigManager_TypeDefinitionIndex)->GetStaticField(0x2EAF0);
		}
