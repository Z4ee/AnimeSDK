...
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19A9EB40)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19A9F330)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x19A9F3C0)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A9EA00)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19A9F4A0)

namespace UnityEngine::NAPRenderPipeline
{
	inline static constexpr unsigned int CopyCharacterColorPass_TypeDefinitionIndex = 29728;
