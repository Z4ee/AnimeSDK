...
#define UNITYENGINE_BONEWEIGHT1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9E92C0)
#define UNITYENGINE_BONEWEIGHT1_EQUALS_OFFSET UNITYSDK_OFFSET(0x9E9230)
#define UNITYENGINE_BONEWEIGHT1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9E9310)
#define UNITYENGINE_BONEWEIGHT1_GET_BONEINDEX_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define UNITYENGINE_BONEWEIGHT1_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x45B300)
