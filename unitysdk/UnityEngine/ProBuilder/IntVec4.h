...
#define UNITYENGINE_PROBUILDER_INTVEC4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x22DAFA0)
#define UNITYENGINE_PROBUILDER_INTVEC4_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x22DAFC0)
#define UNITYENGINE_PROBUILDER_INTVEC4_EQUALS_OFFSET UNITYSDK_OFFSET(0x22DAF80)
#define UNITYENGINE_PROBUILDER_INTVEC4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22DB060)
#define UNITYENGINE_PROBUILDER_INTVEC4_GET_W_OFFSET UNITYSDK_OFFSET(0xCCB0)
#define UNITYENGINE_PROBUILDER_INTVEC4_GET_X_OFFSET UNITYSDK_OFFSET(0xCC50)
#define UNITYENGINE_PROBUILDER_INTVEC4_GET_Y_OFFSET UNITYSDK_OFFSET(0xCC70)
#define UNITYENGINE_PROBUILDER_INTVEC4_GET_Z_OFFSET UNITYSDK_OFFSET(0xCC90)
#define UNITYENGINE_PROBUILDER_INTVEC4_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A248730)
#define UNITYENGINE_PROBUILDER_INTVEC4_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A249780)
#define UNITYENGINE_PROBUILDER_INTVEC4_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A249770)
#define UNITYENGINE_PROBUILDER_INTVEC4_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A248DE0)
#define UNITYENGINE_PROBUILDER_INTVEC4_ROUND_OFFSET UNITYSDK_OFFSET(0x1A248E10)
#define UNITYENGINE_PROBUILDER_INTVEC4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22DAF70)
#define UNITYENGINE_PROBUILDER_INTVEC4__CTOR_OFFSET UNITYSDK_OFFSET(0x1682A10)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int IntVec4_TypeDefinitionIndex = 39921;
