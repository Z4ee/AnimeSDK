...
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_CUBICPOSITION_OFFSET UNITYSDK_OFFSET(0xC03ECA0)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_ENFORCETANGENTMODE_OFFSET UNITYSDK_OFFSET(0xA4B470)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_GETLOOKDIRECTION_OFFSET UNITYSDK_OFFSET(0xC03ED70)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_QUADRATICPOSITION_OFFSET UNITYSDK_OFFSET(0xC03EC20)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xA4B480)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_SETTANGENTIN_OFFSET UNITYSDK_OFFSET(0xA4B4D0)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_SETTANGENTOUT_OFFSET UNITYSDK_OFFSET(0xA4B4F0)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B400)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int BezierPoint_TypeDefinitionIndex = 41534;
