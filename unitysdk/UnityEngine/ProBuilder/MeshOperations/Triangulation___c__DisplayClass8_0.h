...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF91F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__0_OFFSET UNITYSDK_OFFSET(0xCFF9300)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__1_OFFSET UNITYSDK_OFFSET(0xCFF9380)
