...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB75710)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__0_OFFSET UNITYSDK_OFFSET(0x1EB75820)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__1_OFFSET UNITYSDK_OFFSET(0x1EB758A0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int Triangulation___c__DisplayClass8_0_TypeDefinitionIndex = 43326;
