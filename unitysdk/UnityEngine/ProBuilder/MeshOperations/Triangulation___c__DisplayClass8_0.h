...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC0E8E70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__0_OFFSET UNITYSDK_OFFSET(0xC0E8F80)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__1_OFFSET UNITYSDK_OFFSET(0xC0E9000)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int Triangulation___c__DisplayClass8_0_TypeDefinitionIndex = 41715;
