...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_AVERAGENORMALWITHINDEXES_OFFSET UNITYSDK_OFFSET(0x1EB63500)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_CREATEMESHWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EB64DF0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_FILTERUNUSEDSUBMESHINDEXES_OFFSET UNITYSDK_OFFSET(0x1EB48C50)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_RESETPBOBJECTWITHMESHFILTER_OFFSET UNITYSDK_OFFSET(0x1EB671E0)
