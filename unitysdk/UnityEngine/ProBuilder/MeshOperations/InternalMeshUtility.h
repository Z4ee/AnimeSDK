...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_AVERAGENORMALWITHINDEXES_OFFSET UNITYSDK_OFFSET(0x1A288930)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_CREATEMESHWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A28A2E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_FILTERUNUSEDSUBMESHINDEXES_OFFSET UNITYSDK_OFFSET(0x1A26E140)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_INTERNALMESHUTILITY_RESETPBOBJECTWITHMESHFILTER_OFFSET UNITYSDK_OFFSET(0x1A28C940)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int InternalMeshUtility_TypeDefinitionIndex = 40054;
