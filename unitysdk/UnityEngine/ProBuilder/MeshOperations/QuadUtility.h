...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_QUADUTILITY_GETBESTQUADCONNECTION_OFFSET UNITYSDK_OFFSET(0xC0E36F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_QUADUTILITY_GETQUADSCORE_OFFSET UNITYSDK_OFFSET(0xC0E2E80)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_QUADUTILITY_TOQUADS_OFFSET UNITYSDK_OFFSET(0xC0DFF70)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int QuadUtility_TypeDefinitionIndex = 41709;
