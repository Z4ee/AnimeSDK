...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_QUADUTILITY_GETBESTQUADCONNECTION_OFFSET UNITYSDK_OFFSET(0x1EB6FF90)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_QUADUTILITY_GETQUADSCORE_OFFSET UNITYSDK_OFFSET(0x1EB6F720)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_QUADUTILITY_TOQUADS_OFFSET UNITYSDK_OFFSET(0x1EB6C810)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int QuadUtility_TypeDefinitionIndex = 43320;
