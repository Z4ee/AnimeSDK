...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_COMBINEMESHES_ACCUMULATEMESHESINFO_OFFSET UNITYSDK_OFFSET(0xC0B9200)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_COMBINEMESHES_COMBINETONEWMESHES_OFFSET UNITYSDK_OFFSET(0xC0B7C50)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_COMBINEMESHES_COMBINE_1_OFFSET UNITYSDK_OFFSET(0xC0B80C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_COMBINEMESHES_COMBINE_OFFSET UNITYSDK_OFFSET(0xC0B7C40)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_COMBINEMESHES_CREATEMESHFROMSPLIT_OFFSET UNITYSDK_OFFSET(0xC0BD020)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_COMBINEMESHES_SPLITBYMAXVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0xC0BAD40)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int CombineMeshes_TypeDefinitionIndex = 41679;
