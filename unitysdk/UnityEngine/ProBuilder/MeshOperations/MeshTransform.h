...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_CENTERPIVOT_OFFSET UNITYSDK_OFFSET(0x1EB66EA0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_FREEZESCALETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EB6D540)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_SETPIVOT_1_OFFSET UNITYSDK_OFFSET(0x1EB49610)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_SETPIVOT_OFFSET UNITYSDK_OFFSET(0x1EB6D160)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int MeshTransform_TypeDefinitionIndex = 43315;
