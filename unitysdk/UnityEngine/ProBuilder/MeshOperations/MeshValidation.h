...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_COLLECTFACEGROUPS_OFFSET UNITYSDK_OFFSET(0x1EB6E270)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_CONTAINSDEGENERATETRIANGLES_1_OFFSET UNITYSDK_OFFSET(0x1EB6D6E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_CONTAINSDEGENERATETRIANGLES_2_OFFSET UNITYSDK_OFFSET(0x1EB6DE60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_CONTAINSDEGENERATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x1EB6D6C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_CONTAINSNONCONTIGUOUSTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1EB6E0B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_ENSUREFACESARECOMPOSEDOFCONTIGUOUSTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1EB4A050)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_ENSUREMESHISVALID_OFFSET UNITYSDK_OFFSET(0x1EB472E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_REBUILDEDGES_OFFSET UNITYSDK_OFFSET(0x1EB6EC00)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_REBUILDINDEXES_OFFSET UNITYSDK_OFFSET(0x1EB6E6A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_REBUILDSELECTIONINDEXES_OFFSET UNITYSDK_OFFSET(0x1EB6F210)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_REMOVEDEGENERATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x1EB52410)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION_REMOVEUNUSEDVERTICES_OFFSET UNITYSDK_OFFSET(0x1EB533B0)
