...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDFACES_OFFSET UNITYSDK_OFFSET(0x1B0B9EC0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDFACE_OFFSET UNITYSDK_OFFSET(0x1B0B8FA0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOEDGE_1_OFFSET UNITYSDK_OFFSET(0x1B0C1C40)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOEDGE_OFFSET UNITYSDK_OFFSET(0x1B0C1BD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOFACE_1_OFFSET UNITYSDK_OFFSET(0x1B0C08D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOFACE_OFFSET UNITYSDK_OFFSET(0x1B0C08C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_BRIDGE_OFFSET UNITYSDK_OFFSET(0x1B0BE990)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CLEARANDREFRESHMESH_OFFSET UNITYSDK_OFFSET(0x1B0BC3D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATEPOLYGONWITHHOLE_OFFSET UNITYSDK_OFFSET(0x1B0BB070)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATEPOLYGON_OFFSET UNITYSDK_OFFSET(0x1B0BA9C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1B0BC3B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_2_OFFSET UNITYSDK_OFFSET(0x1B0BD6D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_3_OFFSET UNITYSDK_OFFSET(0x1B0BC410)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_OFFSET UNITYSDK_OFFSET(0x1B0BC220)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_DUPLICATEANDFLIP_OFFSET UNITYSDK_OFFSET(0x1B0BDB80)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_FACEWITHVERTICESANDHOLE_OFFSET UNITYSDK_OFFSET(0x1B0BBD40)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_FACEWITHVERTICES_OFFSET UNITYSDK_OFFSET(0x1B0BAFD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_INSERTVERTEXINFACE_OFFSET UNITYSDK_OFFSET(0x1B0C5220)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_INSERTVERTEXINMESH_OFFSET UNITYSDK_OFFSET(0x1B0C7CF0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_INSERTVERTEXONEDGE_OFFSET UNITYSDK_OFFSET(0x1B0C6360)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_TENTCAPWITHVERTICES_OFFSET UNITYSDK_OFFSET(0x1B0BE5B0)
