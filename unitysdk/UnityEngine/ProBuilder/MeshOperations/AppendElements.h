...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDFACES_OFFSET UNITYSDK_OFFSET(0xCFB2750)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDFACE_OFFSET UNITYSDK_OFFSET(0xCFB1830)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOEDGE_1_OFFSET UNITYSDK_OFFSET(0xCFBAA80)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOEDGE_OFFSET UNITYSDK_OFFSET(0xCFBAA10)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOFACE_1_OFFSET UNITYSDK_OFFSET(0xCFB96F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_APPENDVERTICESTOFACE_OFFSET UNITYSDK_OFFSET(0xCFB96E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_BRIDGE_OFFSET UNITYSDK_OFFSET(0xCFB7790)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CLEARANDREFRESHMESH_OFFSET UNITYSDK_OFFSET(0xCFB4D60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATEPOLYGONWITHHOLE_OFFSET UNITYSDK_OFFSET(0xCFB3920)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATEPOLYGON_OFFSET UNITYSDK_OFFSET(0xCFB3260)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_1_OFFSET UNITYSDK_OFFSET(0xCFB4D40)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_2_OFFSET UNITYSDK_OFFSET(0xCFB6380)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_3_OFFSET UNITYSDK_OFFSET(0xCFB4DA0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_CREATESHAPEFROMPOLYGON_OFFSET UNITYSDK_OFFSET(0xCFB4BB0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_DUPLICATEANDFLIP_OFFSET UNITYSDK_OFFSET(0xCFB6850)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_FACEWITHVERTICESANDHOLE_OFFSET UNITYSDK_OFFSET(0xCFB46D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_FACEWITHVERTICES_OFFSET UNITYSDK_OFFSET(0xCFB3880)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_INSERTVERTEXINFACE_OFFSET UNITYSDK_OFFSET(0xCFBE260)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_INSERTVERTEXINMESH_OFFSET UNITYSDK_OFFSET(0xCFC0D60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_INSERTVERTEXONEDGE_OFFSET UNITYSDK_OFFSET(0xCFBF3C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS_TENTCAPWITHVERTICES_OFFSET UNITYSDK_OFFSET(0xCFB73B0)
