...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEFACES_1_OFFSET UNITYSDK_OFFSET(0x1B0DA880)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEFACES_OFFSET UNITYSDK_OFFSET(0x1B0CD880)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEFACE_OFFSET UNITYSDK_OFFSET(0x1B0C1B60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEVERTICES_OFFSET UNITYSDK_OFFSET(0x1B0C4CC0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_REMOVEDEGENERATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x1B0DB290)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_REMOVEUNUSEDVERTICES_OFFSET UNITYSDK_OFFSET(0x1B0DC1F0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int DeleteElements_TypeDefinitionIndex = 40871;
