...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_EDGERINGNEXT_OFFSET UNITYSDK_OFFSET(0xCFDAD80)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FINDHOLES_1_OFFSET UNITYSDK_OFFSET(0xCFDF040)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FINDHOLES_OFFSET UNITYSDK_OFFSET(0xCFDECD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FINDNEXTEDGEINHOLE_OFFSET UNITYSDK_OFFSET(0xCFDFA00)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FLOODSELECTION_OFFSET UNITYSDK_OFFSET(0xCFDE0A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FLOOD_1_OFFSET UNITYSDK_OFFSET(0xCFDDCA0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FLOOD_OFFSET UNITYSDK_OFFSET(0xCFDDC10)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETCONNECTEDEDGES_OFFSET UNITYSDK_OFFSET(0xCFD8110)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOPINTERNALITERATIVE_OFFSET UNITYSDK_OFFSET(0xCFDCCD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOPINTERNAL_OFFSET UNITYSDK_OFFSET(0xCFDC5E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOPITERATIVE_OFFSET UNITYSDK_OFFSET(0xCFDC820)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOP_OFFSET UNITYSDK_OFFSET(0xCFDBFE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGERINGITERATIVE_OFFSET UNITYSDK_OFFSET(0xCFDB720)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGERING_OFFSET UNITYSDK_OFFSET(0xCFDAE00)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETFACELOOP_1_OFFSET UNITYSDK_OFFSET(0xCFDE7A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETFACELOOP_OFFSET UNITYSDK_OFFSET(0xCFDE570)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETFACERINGANDLOOP_OFFSET UNITYSDK_OFFSET(0xCFDEA70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETNEIGHBORFACES_1_OFFSET UNITYSDK_OFFSET(0xCFB9280)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETNEIGHBORFACES_2_OFFSET UNITYSDK_OFFSET(0xCFD78C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETNEIGHBORFACES_OFFSET UNITYSDK_OFFSET(0xCFD74C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETEREDGES_1_OFFSET UNITYSDK_OFFSET(0xCFD9470)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETEREDGES_OFFSET UNITYSDK_OFFSET(0xCFD8BB0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETERFACES_OFFSET UNITYSDK_OFFSET(0xCFD9B90)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETERVERTICES_OFFSET UNITYSDK_OFFSET(0xCFDA730)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETSPOKES_OFFSET UNITYSDK_OFFSET(0xCFDD0A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GROWSELECTION_OFFSET UNITYSDK_OFFSET(0xCFDD580)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_NEXTSPOKE_OFFSET UNITYSDK_OFFSET(0xCFDD500)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xCFDFAD0)
...
namespace UnityEngine::ProBuilder::MeshOperations
{
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(ElementSelection_TypeDefinitionIndex)->GetStaticField(0x14820);
		}
