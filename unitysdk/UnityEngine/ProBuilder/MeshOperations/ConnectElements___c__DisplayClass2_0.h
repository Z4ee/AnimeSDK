...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS___C__DISPLAYCLASS2_0__CONNECT_B__0_OFFSET UNITYSDK_OFFSET(0x1EB51700)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS___C__DISPLAYCLASS2_0__CONNECT_B__3_OFFSET UNITYSDK_OFFSET(0x1EB51770)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB4DC70)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int ConnectElements___c__DisplayClass2_0_TypeDefinitionIndex = 43295;
