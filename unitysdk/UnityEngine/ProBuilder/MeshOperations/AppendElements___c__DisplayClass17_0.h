...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS___C__DISPLAYCLASS17_0__APPENDVERTICESTOEDGE_B__0_OFFSET UNITYSDK_OFFSET(0x1B0C8170)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_APPENDELEMENTS___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C4CB0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int AppendElements___c__DisplayClass17_0_TypeDefinitionIndex = 40858;
