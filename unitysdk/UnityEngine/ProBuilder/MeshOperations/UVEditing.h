...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_ALIGNEDGES_OFFSET UNITYSDK_OFFSET(0x1EB75B90)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_APPLYUVS_OFFSET UNITYSDK_OFFSET(0x1EB77380)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_AUTOSTITCH_OFFSET UNITYSDK_OFFSET(0x1EB75920)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_COLLAPSEUVS_OFFSET UNITYSDK_OFFSET(0x1EB787C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_FINDMINIMALUV_OFFSET UNITYSDK_OFFSET(0x1EB79FB0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_FITUVS_OFFSET UNITYSDK_OFFSET(0x1EB7ADE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_GETUVS_OFFSET UNITYSDK_OFFSET(0x1EB76AE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESAUTO_OFFSET UNITYSDK_OFFSET(0x1EB790A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESBOX_1_OFFSET UNITYSDK_OFFSET(0x1EB7A120)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESBOX_OFFSET UNITYSDK_OFFSET(0x1EB797A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESSPHERE_OFFSET UNITYSDK_OFFSET(0x1EB7A9D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SEWUVS_OFFSET UNITYSDK_OFFSET(0x1EB78150)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SPLITUVS_1_OFFSET UNITYSDK_OFFSET(0x1EB78880)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SPLITUVS_OFFSET UNITYSDK_OFFSET(0x1EB76DF0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int UVEditing_TypeDefinitionIndex = 43327;
