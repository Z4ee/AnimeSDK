...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_ALIGNEDGES_OFFSET UNITYSDK_OFFSET(0xC0E92F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_APPLYUVS_OFFSET UNITYSDK_OFFSET(0xC0EAAE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_AUTOSTITCH_OFFSET UNITYSDK_OFFSET(0xC0E9080)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_COLLAPSEUVS_OFFSET UNITYSDK_OFFSET(0xC0EBF10)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_FINDMINIMALUV_OFFSET UNITYSDK_OFFSET(0xC0ED6A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_FITUVS_OFFSET UNITYSDK_OFFSET(0xC0EE4B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_GETUVS_OFFSET UNITYSDK_OFFSET(0xC0EA240)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESAUTO_OFFSET UNITYSDK_OFFSET(0xC0EC7B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESBOX_1_OFFSET UNITYSDK_OFFSET(0xC0ED810)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESBOX_OFFSET UNITYSDK_OFFSET(0xC0ECE90)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESSPHERE_OFFSET UNITYSDK_OFFSET(0xC0EE0C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SEWUVS_OFFSET UNITYSDK_OFFSET(0xC0EB8B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SPLITUVS_1_OFFSET UNITYSDK_OFFSET(0xC0EBFD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SPLITUVS_OFFSET UNITYSDK_OFFSET(0xC0EA550)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int UVEditing_TypeDefinitionIndex = 41716;
