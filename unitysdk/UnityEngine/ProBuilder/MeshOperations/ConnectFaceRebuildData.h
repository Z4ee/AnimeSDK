...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTFACEREBUILDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C4B50)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int ConnectFaceRebuildData_TypeDefinitionIndex = 41681;
