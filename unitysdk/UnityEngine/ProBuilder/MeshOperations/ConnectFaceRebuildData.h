...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTFACEREBUILDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2758C0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int ConnectFaceRebuildData_TypeDefinitionIndex = 40039;
