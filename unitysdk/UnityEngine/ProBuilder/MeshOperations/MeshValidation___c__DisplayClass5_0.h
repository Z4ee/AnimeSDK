...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION___C__DISPLAYCLASS5_0__COLLECTFACEGROUPS_B__0_OFFSET UNITYSDK_OFFSET(0x1885A0E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHVALIDATION___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x188595C0)
