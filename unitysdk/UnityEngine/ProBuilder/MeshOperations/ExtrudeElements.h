...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_DETACHFACES_1_OFFSET UNITYSDK_OFFSET(0x1884E930)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_DETACHFACES_OFFSET UNITYSDK_OFFSET(0x1884E920)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDEASGROUPS_OFFSET UNITYSDK_OFFSET(0x18847770)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDEPERFACE_OFFSET UNITYSDK_OFFSET(0x18845A60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDE_1_OFFSET UNITYSDK_OFFSET(0x1884D330)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x18820510)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_GETFACEGROUPS_OFFSET UNITYSDK_OFFSET(0x1884F600)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_GETPERIMETEREDGES_OFFSET UNITYSDK_OFFSET(0x1884FB20)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int ExtrudeElements_TypeDefinitionIndex = 34233;
