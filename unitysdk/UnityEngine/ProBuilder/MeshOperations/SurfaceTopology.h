...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_BREAKFACEINTOTRIS_OFFSET UNITYSDK_OFFSET(0x1885B350)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_CONFORMNORMALS_OFFSET UNITYSDK_OFFSET(0x1885C2E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_CONFORMOPPOSITENORMAL_OFFSET UNITYSDK_OFFSET(0x1882F910)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_FLIPEDGE_OFFSET UNITYSDK_OFFSET(0x1885BDE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETCOMMONEDGEINWINDINGORDER_OFFSET UNITYSDK_OFFSET(0x1885CC90)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGFLAGS_OFFSET UNITYSDK_OFFSET(0x1885CB40)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGORDER_1_OFFSET UNITYSDK_OFFSET(0x1885BC30)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGORDER_2_OFFSET UNITYSDK_OFFSET(0x1885B900)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGORDER_OFFSET UNITYSDK_OFFSET(0x1885B7C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_MATCHNORMAL_OFFSET UNITYSDK_OFFSET(0x1885CDF0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_TOTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1885ADA0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int SurfaceTopology_TypeDefinitionIndex = 34250;
