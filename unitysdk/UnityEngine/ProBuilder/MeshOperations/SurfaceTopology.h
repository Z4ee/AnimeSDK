...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_BREAKFACEINTOTRIS_OFFSET UNITYSDK_OFFSET(0xCFF4490)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_CONFORMNORMALS_OFFSET UNITYSDK_OFFSET(0xCFF5710)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_CONFORMOPPOSITENORMAL_OFFSET UNITYSDK_OFFSET(0xCFC7880)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_FLIPEDGE_OFFSET UNITYSDK_OFFSET(0xCFF5380)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETCOMMONEDGEINWINDINGORDER_OFFSET UNITYSDK_OFFSET(0xCFF6000)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGFLAGS_OFFSET UNITYSDK_OFFSET(0xCFF5EC0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGORDER_1_OFFSET UNITYSDK_OFFSET(0xCFF51B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGORDER_2_OFFSET UNITYSDK_OFFSET(0xCFF4CF0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_GETWINDINGORDER_OFFSET UNITYSDK_OFFSET(0xCFF4BB0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_MATCHNORMAL_OFFSET UNITYSDK_OFFSET(0xCFF6130)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_SURFACETOPOLOGY_TOTRIANGLES_OFFSET UNITYSDK_OFFSET(0xCFF3D20)
