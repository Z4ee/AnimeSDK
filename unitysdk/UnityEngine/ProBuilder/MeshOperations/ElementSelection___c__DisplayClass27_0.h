...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDF9F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION___C__DISPLAYCLASS27_0__FINDHOLES_B__1_OFFSET UNITYSDK_OFFSET(0xCFDFD30)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION___C__DISPLAYCLASS27_0__FINDHOLES_B__2_OFFSET UNITYSDK_OFFSET(0xCFDFD60)
