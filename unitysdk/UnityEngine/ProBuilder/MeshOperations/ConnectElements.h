...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTEDGESINFACE_1_OFFSET UNITYSDK_OFFSET(0x1883A5D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTEDGESINFACE_OFFSET UNITYSDK_OFFSET(0x1883AE70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTINDEXESPERFACE_1_OFFSET UNITYSDK_OFFSET(0x18838D00)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTINDEXESPERFACE_OFFSET UNITYSDK_OFFSET(0x18839700)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_1_OFFSET UNITYSDK_OFFSET(0x18837920)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_2_OFFSET UNITYSDK_OFFSET(0x18837980)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_3_OFFSET UNITYSDK_OFFSET(0x18835D70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_OFFSET UNITYSDK_OFFSET(0x18834DB0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_INSERTVERTICES_OFFSET UNITYSDK_OFFSET(0x1883A160)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int ConnectElements_TypeDefinitionIndex = 34221;
