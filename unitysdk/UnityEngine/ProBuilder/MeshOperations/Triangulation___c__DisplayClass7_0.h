...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FCB30)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS7_0__TRIANGULATE_B__0_OFFSET UNITYSDK_OFFSET(0x1B0FCB50)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS7_0__TRIANGULATE_B__1_OFFSET UNITYSDK_OFFSET(0x1B0FCBD0)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int Triangulation___c__DisplayClass7_0_TypeDefinitionIndex = 40899;
