...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MERGEELEMENTS_COLLAPSECOINCIDENTVERTICES_OFFSET UNITYSDK_OFFSET(0x1B0F2240)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MERGEELEMENTS_MERGEPAIRS_OFFSET UNITYSDK_OFFSET(0x1B0F1A30)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MERGEELEMENTS_MERGE_OFFSET UNITYSDK_OFFSET(0x1B0F2870)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int MergeElements_TypeDefinitionIndex = 40883;
