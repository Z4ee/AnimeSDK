...
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1EB849F0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x1EB84AD0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1EB84B10)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1EB311B0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_POLYEDITMODE_OFFSET UNITYSDK_OFFSET(0x1EB84AF0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_ISSNAPENABLED_OFFSET UNITYSDK_OFFSET(0x1EB84B40)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SETCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1EB84A50)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x1EB84AE0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1EB84B20)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_MESH_OFFSET UNITYSDK_OFFSET(0x1EB84B30)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_POLYEDITMODE_OFFSET UNITYSDK_OFFSET(0x1EB84B00)
#define UNITYENGINE_PROBUILDER_POLYSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB84B50)
