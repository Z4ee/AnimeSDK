...
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0xC0FA7B0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_DELETEKEY_OFFSET UNITYSDK_OFFSET(0xC0F9940)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETBOOLDICTIONARY_OFFSET UNITYSDK_OFFSET(0xC0FA750)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETBOOL_OFFSET UNITYSDK_OFFSET(0xC0F9C30)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETCOLORDICTIONARY_OFFSET UNITYSDK_OFFSET(0xC0FA790)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETCOLOR_OFFSET UNITYSDK_OFFSET(0xC0F9EB0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETFLOATDICTIONARY_OFFSET UNITYSDK_OFFSET(0xC0FA770)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETFLOAT_OFFSET UNITYSDK_OFFSET(0xC0F9D70)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETINTDICTIONARY_OFFSET UNITYSDK_OFFSET(0xC0FA760)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETINT_OFFSET UNITYSDK_OFFSET(0xC0F9CC0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETMATERIALDICTIONARY_OFFSET UNITYSDK_OFFSET(0xC0FA7A0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0xC0F9F90)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETSTRINGDICTIONARY_OFFSET UNITYSDK_OFFSET(0xC0FA780)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETSTRING_OFFSET UNITYSDK_OFFSET(0xC0F9E00)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_HASKEY_OFFSET UNITYSDK_OFFSET(0xC0F9710)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC0F8E80)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC0F83D0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETBOOL_OFFSET UNITYSDK_OFFSET(0xC0FA040)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xC0FA4A0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETDEFAULTVALUES_OFFSET UNITYSDK_OFFSET(0xC0F94F0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETFLOAT_OFFSET UNITYSDK_OFFSET(0xC0FA280)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETINT_OFFSET UNITYSDK_OFFSET(0xC0FA180)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0xC0FA610)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETSTRING_OFFSET UNITYSDK_OFFSET(0xC0FA390)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0xC0FA970)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int PreferenceDictionary_TypeDefinitionIndex = 41582;
