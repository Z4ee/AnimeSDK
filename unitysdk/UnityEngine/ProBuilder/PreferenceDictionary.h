...
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0xD00AA40)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_DELETEKEY_OFFSET UNITYSDK_OFFSET(0xD009C00)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETBOOLDICTIONARY_OFFSET UNITYSDK_OFFSET(0xD00A9E0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETBOOL_OFFSET UNITYSDK_OFFSET(0xD009EF0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETCOLORDICTIONARY_OFFSET UNITYSDK_OFFSET(0xD00AA20)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETCOLOR_OFFSET UNITYSDK_OFFSET(0xD00A140)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETFLOATDICTIONARY_OFFSET UNITYSDK_OFFSET(0xD00AA00)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETFLOAT_OFFSET UNITYSDK_OFFSET(0xD00A000)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETINTDICTIONARY_OFFSET UNITYSDK_OFFSET(0xD00A9F0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETINT_OFFSET UNITYSDK_OFFSET(0xD009F80)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETMATERIALDICTIONARY_OFFSET UNITYSDK_OFFSET(0xD00AA30)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0xD00A220)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETSTRINGDICTIONARY_OFFSET UNITYSDK_OFFSET(0xD00AA10)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETSTRING_OFFSET UNITYSDK_OFFSET(0xD00A090)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_HASKEY_OFFSET UNITYSDK_OFFSET(0xD0099D0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD009140)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD008690)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETBOOL_OFFSET UNITYSDK_OFFSET(0xD00A2D0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xD00A730)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETDEFAULTVALUES_OFFSET UNITYSDK_OFFSET(0xD0097B0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETFLOAT_OFFSET UNITYSDK_OFFSET(0xD00A510)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETINT_OFFSET UNITYSDK_OFFSET(0xD00A410)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0xD00A8A0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETSTRING_OFFSET UNITYSDK_OFFSET(0xD00A620)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0xD00AC00)
