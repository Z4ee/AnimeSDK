...
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B10DF00)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_DELETEKEY_OFFSET UNITYSDK_OFFSET(0x1B10D0C0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETBOOLDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B10DEA0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETBOOL_OFFSET UNITYSDK_OFFSET(0x1B10D3B0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETCOLORDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B10DEE0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x1B10D600)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETFLOATDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B10DEC0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B10D4F0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETINTDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B10DEB0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETINT_OFFSET UNITYSDK_OFFSET(0x1B10D440)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETMATERIALDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B10DEF0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B10D6E0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETSTRINGDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B10DED0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1B10D580)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_HASKEY_OFFSET UNITYSDK_OFFSET(0x1B10CE90)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B10C600)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B10BB80)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETBOOL_OFFSET UNITYSDK_OFFSET(0x1B10D790)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1B10DBF0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETDEFAULTVALUES_OFFSET UNITYSDK_OFFSET(0x1B10CC70)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B10D9D0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETINT_OFFSET UNITYSDK_OFFSET(0x1B10D8D0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B10DD60)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1B10DAE0)
#define UNITYENGINE_PROBUILDER_PREFERENCEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B10E0C0)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int PreferenceDictionary_TypeDefinitionIndex = 40767;
