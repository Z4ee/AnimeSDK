...
#define UNITYENGINE_PROBUILDER_COLORUTILITY_APPROX_OFFSET UNITYSDK_OFFSET(0xCF570C0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_CIELABFROMRGB_OFFSET UNITYSDK_OFFSET(0xCF57DD0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_DELTAE_OFFSET UNITYSDK_OFFSET(0xCF57550)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_GETCOLORNAME_OFFSET UNITYSDK_OFFSET(0xCF57AB0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_GETCOLOR_OFFSET UNITYSDK_OFFSET(0xCF570E0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_HSVTORGB_1_OFFSET UNITYSDK_OFFSET(0xCF57770)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_HSVTORGB_OFFSET UNITYSDK_OFFSET(0xCF575C0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_RGBTOHSV_OFFSET UNITYSDK_OFFSET(0xCF578C0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_RGBTOXYZ_1_OFFSET UNITYSDK_OFFSET(0xCF573A0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_RGBTOXYZ_OFFSET UNITYSDK_OFFSET(0xCF57190)
#define UNITYENGINE_PROBUILDER_COLORUTILITY_XYZTOCIE_LAB_OFFSET UNITYSDK_OFFSET(0xCF558B0)
#define UNITYENGINE_PROBUILDER_COLORUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0xCF57E50)
...
namespace UnityEngine::ProBuilder
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::ProBuilder::CIELabColor*>**)Il2CppClass::FromTypeDefinitionIndex(ColorUtility_TypeDefinitionIndex)->GetStaticField(0x635A0);
		}
