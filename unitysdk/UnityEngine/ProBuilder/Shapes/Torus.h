...
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x1B141FD0)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_GETCIRCLEPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B143370)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_GETCIRCLEPOINTS_OFFSET UNITYSDK_OFFSET(0x1B142D80)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x1B142100)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B142070)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1438A0)

namespace UnityEngine::ProBuilder::Shapes
{
	inline static constexpr unsigned int Torus_TypeDefinitionIndex = 40855;

	class Torus : public ::UnityEngine::ProBuilder::Shapes::Shape
	{
	public:
		::System::Single m_TubeRadius; // 0x10
		::System::Int32 m_Rows; // 0x14
		::System::Single m_VerticalCircumference; // 0x18
		::System::Boolean m_Smooth; // 0x1C
		::System::Int32 m_Columns; // 0x20
