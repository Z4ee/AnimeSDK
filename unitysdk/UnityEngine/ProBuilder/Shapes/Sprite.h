...
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x17795640)
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x17795650)
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE__CTOR_OFFSET UNITYSDK_OFFSET(0x17795940)

namespace UnityEngine::ProBuilder::Shapes
{
	inline static constexpr unsigned int Sprite_TypeDefinitionIndex = 41667;
