...
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x1EBBAC10)
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x1EBBAC20)
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBBAF10)

namespace UnityEngine::ProBuilder::Shapes
{
	inline static constexpr unsigned int Sprite_TypeDefinitionIndex = 43278;
