...
#define UNITYENGINE_PROBUILDER_SHAPES_DOOR_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x1778F160)
#define UNITYENGINE_PROBUILDER_SHAPES_DOOR_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x1778F210)
#define UNITYENGINE_PROBUILDER_SHAPES_DOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17790E00)

namespace UnityEngine::ProBuilder::Shapes
{
	inline static constexpr unsigned int Door_TypeDefinitionIndex = 41659;
