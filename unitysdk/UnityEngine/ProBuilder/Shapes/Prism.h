...
#define UNITYENGINE_PROBUILDER_SHAPES_PRISM_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x188A0940)
#define UNITYENGINE_PROBUILDER_SHAPES_PRISM_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x188A0950)
#define UNITYENGINE_PROBUILDER_SHAPES_PRISM__CTOR_OFFSET UNITYSDK_OFFSET(0x188A19C0)

namespace UnityEngine::ProBuilder::Shapes
{
	inline static constexpr unsigned int Prism_TypeDefinitionIndex = 34201;
