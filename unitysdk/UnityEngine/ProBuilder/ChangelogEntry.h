...
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY_GET_RELEASENOTES_OFFSET UNITYSDK_OFFSET(0x1EAD2720)
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY_GET_VERSIONINFO_OFFSET UNITYSDK_OFFSET(0x1EAD2710)
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EAD2730)
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAD2700)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int ChangelogEntry_TypeDefinitionIndex = 43149;
