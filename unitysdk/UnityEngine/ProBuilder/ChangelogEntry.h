...
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY_GET_RELEASENOTES_OFFSET UNITYSDK_OFFSET(0xC0460F0)
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY_GET_VERSIONINFO_OFFSET UNITYSDK_OFFSET(0xC0460E0)
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC046100)
#define UNITYENGINE_PROBUILDER_CHANGELOGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xC0460D0)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int ChangelogEntry_TypeDefinitionIndex = 41538;
