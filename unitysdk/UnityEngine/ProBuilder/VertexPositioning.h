...
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_SETSHAREDVERTEXPOSITION_OFFSET UNITYSDK_OFFSET(0x1924CF40)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_SETSHAREDVERTEXVALUES_OFFSET UNITYSDK_OFFSET(0x1924D500)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1924CA90)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICESINWORLDSPACE_1_OFFSET UNITYSDK_OFFSET(0x1924BF70)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICESINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x1922D4D0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICES_1_OFFSET UNITYSDK_OFFSET(0x1924CDA0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICES_2_OFFSET UNITYSDK_OFFSET(0x1924CE70)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICES_OFFSET UNITYSDK_OFFSET(0x1924C9C0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_VERTICESINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x1924BD60)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1924D910)
...
namespace UnityEngine::ProBuilder
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(VertexPositioning_TypeDefinitionIndex)->GetStaticField(0x64EA0);
		}
