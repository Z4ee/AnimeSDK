...
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_FACERAYCASTBOTHCULLMODES_OFFSET UNITYSDK_OFFSET(0xC08A4B0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_FACERAYCAST_1_OFFSET UNITYSDK_OFFSET(0xC089830)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_FACERAYCAST_2_OFFSET UNITYSDK_OFFSET(0xC08ACB0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_FACERAYCAST_OFFSET UNITYSDK_OFFSET(0xC0897F0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETACTIVEELEMENTPOSITION_1_OFFSET UNITYSDK_OFFSET(0xC08F840)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETACTIVEELEMENTPOSITION_2_OFFSET UNITYSDK_OFFSET(0xC08F940)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETACTIVEELEMENTPOSITION_OFFSET UNITYSDK_OFFSET(0xC08EAB0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETEDGEROTATION_1_OFFSET UNITYSDK_OFFSET(0xC08E8E0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETEDGEROTATION_OFFSET UNITYSDK_OFFSET(0xC08E820)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETFACEROTATION_1_OFFSET UNITYSDK_OFFSET(0xC08E0A0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETFACEROTATION_OFFSET UNITYSDK_OFFSET(0xC08DFD0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETROTATION_OFFSET UNITYSDK_OFFSET(0xC08C2A0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETVERTEXROTATION_1_OFFSET UNITYSDK_OFFSET(0xC08E9F0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_GETVERTEXROTATION_OFFSET UNITYSDK_OFFSET(0xC08E940)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_INVERSETRANSFORMRAY_OFFSET UNITYSDK_OFFSET(0xC08B5F0)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_MESHRAYCAST_1_OFFSET UNITYSDK_OFFSET(0xC08BA10)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_MESHRAYCAST_OFFSET UNITYSDK_OFFSET(0xC08B840)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_POINTISOCCLUDED_OFFSET UNITYSDK_OFFSET(0xC08C020)
#define UNITYENGINE_PROBUILDER_HANDLEUTILITY_SCREENTOGUIPOINT_OFFSET UNITYSDK_OFFSET(0xC089780)
