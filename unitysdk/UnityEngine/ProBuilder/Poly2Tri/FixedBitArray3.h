...
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_CLEAR_OFFSET UNITYSDK_OFFSET(0x3C97500)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_ENUMERATE_OFFSET UNITYSDK_OFFSET(0x3C97510)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x3C97570)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3C97400)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3C97480)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x3C97570)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int FixedBitArray3_TypeDefinitionIndex = 37462;
