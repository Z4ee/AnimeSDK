...
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_CLEAR_OFFSET UNITYSDK_OFFSET(0x2107240)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_ENUMERATE_OFFSET UNITYSDK_OFFSET(0x2107250)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x21072B0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x2107140)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x21071C0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x21072B0)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int FixedBitArray3_TypeDefinitionIndex = 29801;
