...
#define UNITYENGINE_PROBUILDER_POLY2TRI_ADVANCINGFRONTNODE_GET_HASNEXT_OFFSET UNITYSDK_OFFSET(0x1B04F1A0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_ADVANCINGFRONTNODE_GET_HASPREV_OFFSET UNITYSDK_OFFSET(0x1B04F1B0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_ADVANCINGFRONTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B04F170)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int AdvancingFrontNode_TypeDefinitionIndex = 35801;

	class AdvancingFrontNode : public ::System::Object
	{
	public:
		::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* Next; // 0x10
		::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* Prev; // 0x18
		::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* Point; // 0x20
