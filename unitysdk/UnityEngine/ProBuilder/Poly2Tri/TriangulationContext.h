...
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A1F2780)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_DONE_OFFSET UNITYSDK_OFFSET(0x1A1EBA30)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_DEBUGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A1F4D30)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_DTDEBUGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A1EBCB0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_ISDEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x1A1F4DA0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_STEPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1F4D80)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_TRIANGULATABLE_OFFSET UNITYSDK_OFFSET(0x1A1F4D60)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_TRIANGULATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A1F4D40)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_PREPARETRIANGULATION_OFFSET UNITYSDK_OFFSET(0x1A1F2AD0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_SET_STEPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1F4D90)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_SET_TRIANGULATABLE_OFFSET UNITYSDK_OFFSET(0x1A1F4D70)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_SET_TRIANGULATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A1F4D50)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A1EBF80)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F2480)
