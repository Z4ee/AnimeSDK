...
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B058110)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_BOOLEAN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B058260)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_BOOLEAN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0581D0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B0582E0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B058230)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B0581E0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B058100)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1B057FE0)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int FixedBitArray3__Enumerate_d__10_TypeDefinitionIndex = 35822;
