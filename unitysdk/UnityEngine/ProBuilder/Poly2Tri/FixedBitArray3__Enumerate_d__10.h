...
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EF28010)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_BOOLEAN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EF28160)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_BOOLEAN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF280D0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EF281E0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF28130)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EF280E0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF28000)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF27E90)
