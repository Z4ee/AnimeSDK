...
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x187B9650)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_BOOLEAN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187B97A0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_BOOLEAN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187B9710)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187B9820)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187B9770)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x187B9720)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187B9640)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3__ENUMERATE_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x187B9520)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int FixedBitArray3__Enumerate_d__10_TypeDefinitionIndex = 29802;
	...
	public:
		...
		::System::Boolean __2__current; // 0x1C
		::UnityEngine::ProBuilder::Poly2Tri::FixedBitArray3 __4__this; // 0x1D
		::UnityEngine::ProBuilder::Poly2Tri::FixedBitArray3 __3____4__this; // 0x20
