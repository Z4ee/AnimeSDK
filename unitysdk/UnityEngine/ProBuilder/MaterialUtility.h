...
#define UNITYENGINE_PROBUILDER_MATERIALUTILITY_GETMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1A24B270)
#define UNITYENGINE_PROBUILDER_MATERIALUTILITY_GETSHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A24B360)
#define UNITYENGINE_PROBUILDER_MATERIALUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A24B4E0)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int MaterialUtility_TypeDefinitionIndex = 39927;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialUtility_TypeDefinitionIndex)->GetStaticField(0x25B30);
		}
