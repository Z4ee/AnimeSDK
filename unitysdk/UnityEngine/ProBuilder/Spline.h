...
#define UNITYENGINE_PROBUILDER_SPLINE_EXTRUDE_1_OFFSET UNITYSDK_OFFSET(0x188AC8C0)
#define UNITYENGINE_PROBUILDER_SPLINE_EXTRUDE_2_OFFSET UNITYSDK_OFFSET(0x188AD330)
#define UNITYENGINE_PROBUILDER_SPLINE_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x188AC7F0)
#define UNITYENGINE_PROBUILDER_SPLINE_GETCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x188AC980)
#define UNITYENGINE_PROBUILDER_SPLINE_GETRINGROTATION_OFFSET UNITYSDK_OFFSET(0x188ADED0)
#define UNITYENGINE_PROBUILDER_SPLINE_VERTEXRING_OFFSET UNITYSDK_OFFSET(0x188AE7D0)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int Spline_TypeDefinitionIndex = 34175;
