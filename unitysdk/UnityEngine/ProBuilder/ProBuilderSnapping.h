...
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_GETSNAPPINGMASKBASEDONNORMALVECTOR_OFFSET UNITYSDK_OFFSET(0x1920FBE0)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_ISCARDINALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1920F120)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAPVALUEONRAY_OFFSET UNITYSDK_OFFSET(0x1920FC70)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1920F650)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAP_1_OFFSET UNITYSDK_OFFSET(0x1920F380)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAP_OFFSET UNITYSDK_OFFSET(0x1920F2A0)
