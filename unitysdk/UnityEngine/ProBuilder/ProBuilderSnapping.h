...
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_GETSNAPPINGMASKBASEDONNORMALVECTOR_OFFSET UNITYSDK_OFFSET(0x1776EBD0)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_ISCARDINALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1776E110)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAPVALUEONRAY_OFFSET UNITYSDK_OFFSET(0x1776EC60)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1776E640)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAP_1_OFFSET UNITYSDK_OFFSET(0x1776E370)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAP_OFFSET UNITYSDK_OFFSET(0x1776E290)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int ProBuilderSnapping_TypeDefinitionIndex = 41607;
