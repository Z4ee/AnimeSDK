...
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_CONTROLKEYSTRING_OFFSET UNITYSDK_OFFSET(0xC0945E0)
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_EMPTYGAMEOBJECTWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC094460)
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_STRINGTOVECTOR3ARRAY_OFFSET UNITYSDK_OFFSET(0xC0949C0)
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_TRYPARSECOLOR_OFFSET UNITYSDK_OFFSET(0xC094690)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int InternalUtility_TypeDefinitionIndex = 41564;
