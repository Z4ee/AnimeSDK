...
#define UNITYENGINE_PROBUILDER_SELECTIONPICKER_PICKEDGESINRECT_OFFSET UNITYSDK_OFFSET(0x18887950)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKER_PICKFACESINRECT_OFFSET UNITYSDK_OFFSET(0x18885360)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKER_PICKFACE_OFFSET UNITYSDK_OFFSET(0x18888B70)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKER_PICKVERTICESINRECT_OFFSET UNITYSDK_OFFSET(0x18883F70)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int SelectionPicker_TypeDefinitionIndex = 34154;
