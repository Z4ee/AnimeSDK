...
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1923E8E0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1923E560)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1923E8B0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1924F370)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1924F380)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1923E550)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int WingedEdgeEnumerator_TypeDefinitionIndex = 43265;
