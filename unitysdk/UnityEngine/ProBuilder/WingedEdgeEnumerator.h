...
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EBC2F20)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EBC2BA0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EBC2EF0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EBD39B0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EBD39C0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGEENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBC2B90)
