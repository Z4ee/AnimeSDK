...
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_BUILDEDGEMESH_OFFSET UNITYSDK_OFFSET(0x1921F120)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_BUILDVERTEXMESH_OFFSET UNITYSDK_OFFSET(0x1921E550)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_DECODERGBA_OFFSET UNITYSDK_OFFSET(0x1921BF80)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_ENCODERGBA_OFFSET UNITYSDK_OFFSET(0x1921E4E0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GENERATEEDGEPICKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1921DD80)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GENERATEFACEPICKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1921C940)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GENERATEVERTEXPICKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1921D620)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GET_PICKERRENDERER_OFFSET UNITYSDK_OFFSET(0x1921BA90)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GET_RENDERTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1921B8B0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GET_TEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1921BA80)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_PICKEDGESINRECT_OFFSET UNITYSDK_OFFSET(0x1921B150)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_PICKFACESINRECT_OFFSET UNITYSDK_OFFSET(0x19219E90)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_PICKVERTICESINRECT_OFFSET UNITYSDK_OFFSET(0x19217BE0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_RENDERSELECTIONPICKERTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1921BFC0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_RENDERSELECTIONPICKERTEXTURE_2_OFFSET UNITYSDK_OFFSET(0x1921C4F0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_RENDERSELECTIONPICKERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1921BBC0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_SHOULDUSEHDRP_OFFSET UNITYSDK_OFFSET(0x1921BB90)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1921F8E0)
...
namespace UnityEngine::ProBuilder
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RenderTextureFormat>**)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x64870);
		}
		static ::UnityEngine::ProBuilder::SelectionPickerRenderer_ISelectionPickerRenderer** StaticGet_s_PickerRenderer()
		{
			return (::UnityEngine::ProBuilder::SelectionPickerRenderer_ISelectionPickerRenderer**)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x64878);
		}
		static ::UnityEngine::Color* StaticGet_k_Whitef()
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x14AC0);
		}
		static ::UnityEngine::Color* StaticGet_k_Blackf()
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x14AD0);
		}
		static ::System::Boolean* StaticGet_s_Initialized()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x14AE0);
		}
		static ::UnityEngine::RenderTextureFormat* StaticGet_s_RenderTextureFormat()
		{
			return (::UnityEngine::RenderTextureFormat*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x14AE4);
		}
