...
#define UNITYENGINE_PROBUILDER_MESHHANDLE_DRAWMESHNOW_OFFSET UNITYSDK_OFFSET(0x1B0B4620)
#define UNITYENGINE_PROBUILDER_MESHHANDLE_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1B0B4600)
#define UNITYENGINE_PROBUILDER_MESHHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B4610)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int MeshHandle_TypeDefinitionIndex = 40756;
