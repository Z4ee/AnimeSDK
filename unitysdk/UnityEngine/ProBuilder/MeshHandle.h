...
#define UNITYENGINE_PROBUILDER_MESHHANDLE_DRAWMESHNOW_OFFSET UNITYSDK_OFFSET(0x188169C0)
#define UNITYENGINE_PROBUILDER_MESHHANDLE_GET_MESH_OFFSET UNITYSDK_OFFSET(0x188169A0)
#define UNITYENGINE_PROBUILDER_MESHHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x188169B0)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int MeshHandle_TypeDefinitionIndex = 34110;
