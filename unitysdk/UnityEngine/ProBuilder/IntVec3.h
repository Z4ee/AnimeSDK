...
#define UNITYENGINE_PROBUILDER_INTVEC3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2107DA0)
#define UNITYENGINE_PROBUILDER_INTVEC3_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x2108290)
#define UNITYENGINE_PROBUILDER_INTVEC3_EQUALS_OFFSET UNITYSDK_OFFSET(0x2107DA0)
#define UNITYENGINE_PROBUILDER_INTVEC3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x21082A0)
#define UNITYENGINE_PROBUILDER_INTVEC3_GET_X_OFFSET UNITYSDK_OFFSET(0xCC60)
#define UNITYENGINE_PROBUILDER_INTVEC3_GET_Y_OFFSET UNITYSDK_OFFSET(0xCC80)
#define UNITYENGINE_PROBUILDER_INTVEC3_GET_Z_OFFSET UNITYSDK_OFFSET(0xCCA0)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1880C320)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1880E310)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1880E300)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1880CD00)
#define UNITYENGINE_PROBUILDER_INTVEC3_ROUND_OFFSET UNITYSDK_OFFSET(0x1880D200)
#define UNITYENGINE_PROBUILDER_INTVEC3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2107D90)
#define UNITYENGINE_PROBUILDER_INTVEC3__CTOR_OFFSET UNITYSDK_OFFSET(0x79820)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int IntVec3_TypeDefinitionIndex = 34101;
