...
#define UNITYENGINE_PROBUILDER_CLIPPING_COMPUTEOUTCODE_OFFSET UNITYSDK_OFFSET(0xC046140)
#define UNITYENGINE_PROBUILDER_CLIPPING_RECTCONTAINSLINESEGMENT_OFFSET UNITYSDK_OFFSET(0xC046180)

namespace UnityEngine::ProBuilder
{
	inline static constexpr unsigned int Clipping_TypeDefinitionIndex = 41540;
