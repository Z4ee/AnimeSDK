...
namespace UnityEngine
{
	...
	public:
		...
		::System::Boolean _UseForCurrentPlatform_b__1_0(::IniParserEx::IniFile_SectionItem* item)
		{
			return ((::System::Boolean(*)(::PVOID, ::IniParserEx::IniFile_SectionItem*))((::PBYTE)hIl2Cpp + UNITYENGINE_DEFAULTCONSOLECONFIGREADER_CONDITIONDETAIL___C__USEFORCURRENTPLATFORM_B__1_0_OFFSET))(this, item);
		}

		::System::Boolean _MatchModelNameRegEx_b__5_0(::IniParserEx::IniFile_SectionItem* item)
		{
			return ((::System::Boolean(*)(::PVOID, ::IniParserEx::IniFile_SectionItem*))((::PBYTE)hIl2Cpp + UNITYENGINE_DEFAULTCONSOLECONFIGREADER_CONDITIONDETAIL___C__MATCHMODELNAMEREGEX_B__5_0_OFFSET))(this, item);
		}
	};
}
