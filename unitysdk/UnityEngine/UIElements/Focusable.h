...
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_EXECUTEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x197AC890)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_FOCUS_OFFSET UNITYSDK_OFFSET(0x197AC090)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_GETFIRSTFOCUSABLECHILD_OFFSET UNITYSDK_OFFSET(0x197AC450)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_GETFOCUSDELEGATE_OFFSET UNITYSDK_OFFSET(0x197AC3D0)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_GET_CANGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x197AC080)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_GET_DELEGATESFOCUS_OFFSET UNITYSDK_OFFSET(0x197AC070)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_GET_FOCUSABLE_OFFSET UNITYSDK_OFFSET(0x197AC040)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_SET_FOCUSABLE_OFFSET UNITYSDK_OFFSET(0x197AC050)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE_SET_TABINDEX_OFFSET UNITYSDK_OFFSET(0x197AC060)
#define UNITYENGINE_UIELEMENTS_FOCUSABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x197AC030)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int Focusable_TypeDefinitionIndex = 24942;
