...
#define UNITYENGINE_UIELEMENTS_EVENTCALLBACKLISTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x18ACEC20)
#define UNITYENGINE_UIELEMENTS_EVENTCALLBACKLISTPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x18ACED60)
#define UNITYENGINE_UIELEMENTS_EVENTCALLBACKLISTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18ACEDF0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int EventCallbackListPool_TypeDefinitionIndex = 5900;
