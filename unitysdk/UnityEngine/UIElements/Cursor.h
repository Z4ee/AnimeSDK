...
#define UNITYENGINE_UIELEMENTS_CURSOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x97E9A0)
#define UNITYENGINE_UIELEMENTS_CURSOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x97E990)
#define UNITYENGINE_UIELEMENTS_CURSOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x97EA70)
#define UNITYENGINE_UIELEMENTS_CURSOR_GET_DEFAULTCURSORID_OFFSET UNITYSDK_OFFSET(0x325D00)
#define UNITYENGINE_UIELEMENTS_CURSOR_GET_HOTSPOT_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define UNITYENGINE_UIELEMENTS_CURSOR_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x259D70)
#define UNITYENGINE_UIELEMENTS_CURSOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CFF41C0)
#define UNITYENGINE_UIELEMENTS_CURSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x97EA80)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int Cursor_TypeDefinitionIndex = 28040;
