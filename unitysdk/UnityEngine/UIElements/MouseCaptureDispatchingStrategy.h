...
#define UNITYENGINE_UIELEMENTS_MOUSECAPTUREDISPATCHINGSTRATEGY_CANDISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18AD5810)
#define UNITYENGINE_UIELEMENTS_MOUSECAPTUREDISPATCHINGSTRATEGY_DISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18AD5880)
#define UNITYENGINE_UIELEMENTS_MOUSECAPTUREDISPATCHINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x18ACF5A0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int MouseCaptureDispatchingStrategy_TypeDefinitionIndex = 5919;
