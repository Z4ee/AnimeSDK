...
#define UNITYENGINE_UIELEMENTS_REPAINTDATA_GET_CURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0x1BBEF4C0)
#define UNITYENGINE_UIELEMENTS_REPAINTDATA_GET_CURRENTWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBEF4F0)
#define UNITYENGINE_UIELEMENTS_REPAINTDATA_GET_REPAINTEVENT_OFFSET UNITYSDK_OFFSET(0x1BBEF500)
#define UNITYENGINE_UIELEMENTS_REPAINTDATA_SET_REPAINTEVENT_OFFSET UNITYSDK_OFFSET(0x1BBEF510)
#define UNITYENGINE_UIELEMENTS_REPAINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBEF520)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int RepaintData_TypeDefinitionIndex = 27459;
