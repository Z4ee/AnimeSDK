...
#define UNITYENGINE_UIELEMENTS_DEFAULTDISPATCHINGSTRATEGY_CANDISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18ACB9C0)
#define UNITYENGINE_UIELEMENTS_DEFAULTDISPATCHINGSTRATEGY_DISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18ACBA20)
#define UNITYENGINE_UIELEMENTS_DEFAULTDISPATCHINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x18ACBBB0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int DefaultDispatchingStrategy_TypeDefinitionIndex = 5886;
