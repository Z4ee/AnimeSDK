...
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERBOTTOMWIDTH_OFFSET UNITYSDK_OFFSET(0x884B70)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERLEFTWIDTH_OFFSET UNITYSDK_OFFSET(0x884AB0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERRIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x884B30)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERTOPWIDTH_OFFSET UNITYSDK_OFFSET(0x884AF0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_CURSOR_OFFSET UNITYSDK_OFFSET(0x884C70)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x884BB0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_INHERITEDSTYLESDATA_OFFSET UNITYSDK_OFFSET(0x884910)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x884930)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_STYLESDATA_OFFSET UNITYSDK_OFFSET(0x8848F0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_UNITYOVERFLOWCLIPBOX_OFFSET UNITYSDK_OFFSET(0x8849F0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x884CC0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2E5940)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int ComputedStyle_TypeDefinitionIndex = 25075;
