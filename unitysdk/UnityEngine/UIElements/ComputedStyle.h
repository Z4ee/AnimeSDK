...
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x3BD2470)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_INHERITEDSTYLESDATA_OFFSET UNITYSDK_OFFSET(0x3BD23D0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x3BD23F0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_STYLESDATA_OFFSET UNITYSDK_OFFSET(0x3BD23B0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x3BD24F0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int ComputedStyle_TypeDefinitionIndex = 5987;
