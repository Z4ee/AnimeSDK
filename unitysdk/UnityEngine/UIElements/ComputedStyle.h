...
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERBOTTOMWIDTH_OFFSET UNITYSDK_OFFSET(0x932B60)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERLEFTWIDTH_OFFSET UNITYSDK_OFFSET(0x932AA0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERRIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x932B20)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_BORDERTOPWIDTH_OFFSET UNITYSDK_OFFSET(0x932AE0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_CURSOR_OFFSET UNITYSDK_OFFSET(0x932C60)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x932BA0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_INHERITEDSTYLESDATA_OFFSET UNITYSDK_OFFSET(0x932900)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x932920)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_STYLESDATA_OFFSET UNITYSDK_OFFSET(0x9328E0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_UNITYOVERFLOWCLIPBOX_OFFSET UNITYSDK_OFFSET(0x9329E0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x932CB0)
#define UNITYENGINE_UIELEMENTS_COMPUTEDSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2B6D10)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int ComputedStyle_TypeDefinitionIndex = 27578;
