...
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_ADDTOCLASSLIST_OFFSET UNITYSDK_OFFSET(0x1BBE4020)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_ASSIGNMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x1BBFBD10)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_COMPUTEAAALIGNEDBOUND_OFFSET UNITYSDK_OFFSET(0x1BBE69F0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_CONTAINSPOINT_OFFSET UNITYSDK_OFFSET(0x1BBFBB90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_DOMEASURE_OFFSET UNITYSDK_OFFSET(0x1BBFBE60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_EXECUTEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x1BBFB1A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_FOCUS_OFFSET UNITYSDK_OFFSET(0x1BBFB890)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_BOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1BBF9110)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_CANGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x1BBE3950)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_COMPUTEDSTYLE_OFFSET UNITYSDK_OFFSET(0x1BBFAF50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_CONTENTCONTAINER_OFFSET UNITYSDK_OFFSET(0x1BBFC5A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ELEMENTPANEL_OFFSET UNITYSDK_OFFSET(0x1BBFC590)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ENABLEDINHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1BBEB0C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ENABLEDSELF_OFFSET UNITYSDK_OFFSET(0x1BBFB9C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_FOCUSCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1BBE3010)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_GENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x1BBFBB70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_HIERARCHY_OFFSET UNITYSDK_OFFSET(0x1BBFC570)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_INHERITEDSTYLE_OFFSET UNITYSDK_OFFSET(0x1BBDC330)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISCOMPOSITEROOT_OFFSET UNITYSDK_OFFSET(0x1BBF8DB0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISLAYOUTMANUAL_OFFSET UNITYSDK_OFFSET(0x1BBF8F10)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDCLIPDIRTY_OFFSET UNITYSDK_OFFSET(0x1BBFA280)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDTRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x1BBF9C40)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDTRANSFORMINVERSEDIRTY_OFFSET UNITYSDK_OFFSET(0x1BBF9C60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x1BBE7410)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BBFAEA0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PANEL_OFFSET UNITYSDK_OFFSET(0x1BBE60A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1BBF8DC0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PICKINGMODE_OFFSET UNITYSDK_OFFSET(0x1BBFAE90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PSEUDOSTATES_OFFSET UNITYSDK_OFFSET(0x1BBFAE20)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_RECT_OFFSET UNITYSDK_OFFSET(0x1BBF9AA0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_RESOLVEDSTYLE_OFFSET UNITYSDK_OFFSET(0x1BBEAE60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_SPECIFIEDSTYLE_OFFSET UNITYSDK_OFFSET(0x1BBDC300)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BBF8E50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x1BBEB060)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1BBEAF40)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDBOUND_OFFSET UNITYSDK_OFFSET(0x1BBE7B50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDCLIPMINUSGROUP_OFFSET UNITYSDK_OFFSET(0x1BBFA6A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBE69B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDTRANSFORMINVERSE_OFFSET UNITYSDK_OFFSET(0x1BBFA160)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BBE6AC0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_YOGANODE_OFFSET UNITYSDK_OFFSET(0x1BBFAF30)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_INCREMENTVERSION_OFFSET UNITYSDK_OFFSET(0x1BBD89D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_MEASURE_OFFSET UNITYSDK_OFFSET(0x1BBFBE70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_MULTIPLYMATRIX44POINT2_OFFSET UNITYSDK_OFFSET(0x1BBF90C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_PROPAGATEENABLEDTOCHILDREN_OFFSET UNITYSDK_OFFSET(0x1BBFBA70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_REMOVEFROMCLASSLIST_OFFSET UNITYSDK_OFFSET(0x1BBFB9E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_REMOVEMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x1BBFBD90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_RETARGETELEMENT_OFFSET UNITYSDK_OFFSET(0x1BBE2560)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1BBE1CE0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SETENABLEDFROMHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1BBFB8E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SETENABLED_OFFSET UNITYSDK_OFFSET(0x1BBFAF80)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_COMPUTEDSTYLE_OFFSET UNITYSDK_OFFSET(0x1BBFAF60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ENABLEDSELF_OFFSET UNITYSDK_OFFSET(0x1BBFB9D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_GENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x1BBFBB80)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_HIERARCHY_OFFSET UNITYSDK_OFFSET(0x1BBFC580)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDCLIPDIRTY_OFFSET UNITYSDK_OFFSET(0x1BBFA290)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDTRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x1BBF9C50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDTRANSFORMINVERSEDIRTY_OFFSET UNITYSDK_OFFSET(0x1BBF9C70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1BBFAEB0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_PSEUDOSTATES_OFFSET UNITYSDK_OFFSET(0x1BBFAE30)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_RENDERHINTS_OFFSET UNITYSDK_OFFSET(0x1BBF8DD0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_REQUIREMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x1BBE41D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_YOGANODE_OFFSET UNITYSDK_OFFSET(0x1BBFAF40)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SHOULDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBEAF90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SUBSTRACTBORDERPADDING_OFFSET UNITYSDK_OFFSET(0x1BBFA6E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBFC0A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_TRANSFORMALIGNEDRECT_OFFSET UNITYSDK_OFFSET(0x1BBF8F60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERBOTTOMWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBFAD10)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERLEFTWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBFAC20)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERRIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBFACC0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERTOPWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBFAC70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x1BBEAE70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGBOTTOM_OFFSET UNITYSDK_OFFSET(0x1BBFADF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGLEFT_OFFSET UNITYSDK_OFFSET(0x1BBFAD60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGRIGHT_OFFSET UNITYSDK_OFFSET(0x1BBFADC0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGTOP_OFFSET UNITYSDK_OFFSET(0x1BBFAD90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1BBFBB20)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_ITRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1BBF8E60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1BBF9150)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATECURSORSTYLE_OFFSET UNITYSDK_OFFSET(0x1BBFB510)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1BBF98A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBFA2A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BBF9C80)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__ASSIGNMEASUREFUNCTION_B__206_0_OFFSET UNITYSDK_OFFSET(0x1BBFC750)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBFC620)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBE3CD0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int VisualElement_TypeDefinitionIndex = 27476;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x22690);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_s_EmptyClassList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x22698);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>** StaticGet_s_EmptyList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x226A0);
		}
		static ::System::UInt32* StaticGet_s_NextId()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x77E0);
		}
		static ::UnityEngine::PropertyName* StaticGet_userDataPropertyKey()
		{
			return (::UnityEngine::PropertyName*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x77E4);
		}
		static ::UnityEngine::Rect* StaticGet_s_InfiniteRect()
		{
			return (::UnityEngine::Rect*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x77E8);
		}
