...
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_ADDTOCLASSLIST_OFFSET UNITYSDK_OFFSET(0x197AD3C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_ASSIGNMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x197C5120)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_COMPUTEAAALIGNEDBOUND_OFFSET UNITYSDK_OFFSET(0x197AFD90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_CONTAINSPOINT_OFFSET UNITYSDK_OFFSET(0x197C4FA0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_DOMEASURE_OFFSET UNITYSDK_OFFSET(0x197C5260)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_EXECUTEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x197C45B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_FOCUS_OFFSET UNITYSDK_OFFSET(0x197C4CA0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_BOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x197C2520)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_CANGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x197ACCF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_COMPUTEDSTYLE_OFFSET UNITYSDK_OFFSET(0x197C4360)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_CONTENTCONTAINER_OFFSET UNITYSDK_OFFSET(0x197C59A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ELEMENTPANEL_OFFSET UNITYSDK_OFFSET(0x197C5990)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ENABLEDINHIERARCHY_OFFSET UNITYSDK_OFFSET(0x197B4460)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ENABLEDSELF_OFFSET UNITYSDK_OFFSET(0x197C4DD0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_FOCUSCONTROLLER_OFFSET UNITYSDK_OFFSET(0x197AC3B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_GENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x197C4F80)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_HIERARCHY_OFFSET UNITYSDK_OFFSET(0x197C5970)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_INHERITEDSTYLE_OFFSET UNITYSDK_OFFSET(0x197A56B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISCOMPOSITEROOT_OFFSET UNITYSDK_OFFSET(0x197C21C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISLAYOUTMANUAL_OFFSET UNITYSDK_OFFSET(0x197C2320)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDCLIPDIRTY_OFFSET UNITYSDK_OFFSET(0x197C3690)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDTRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x197C3050)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDTRANSFORMINVERSEDIRTY_OFFSET UNITYSDK_OFFSET(0x197C3070)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x197B07B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x197C42B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PANEL_OFFSET UNITYSDK_OFFSET(0x197AF440)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x197C21D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PICKINGMODE_OFFSET UNITYSDK_OFFSET(0x197C42A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PSEUDOSTATES_OFFSET UNITYSDK_OFFSET(0x197C4230)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_RECT_OFFSET UNITYSDK_OFFSET(0x197C2EB0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_RESOLVEDSTYLE_OFFSET UNITYSDK_OFFSET(0x197B4200)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_SPECIFIEDSTYLE_OFFSET UNITYSDK_OFFSET(0x197A5680)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x197C2260)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x197B4400)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x197B42E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDBOUND_OFFSET UNITYSDK_OFFSET(0x197B0EF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDCLIPMINUSGROUP_OFFSET UNITYSDK_OFFSET(0x197C3AB0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDCLIP_OFFSET UNITYSDK_OFFSET(0x197AFD50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDTRANSFORMINVERSE_OFFSET UNITYSDK_OFFSET(0x197C3570)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x197AFE60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_YOGANODE_OFFSET UNITYSDK_OFFSET(0x197C4340)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_INCREMENTVERSION_OFFSET UNITYSDK_OFFSET(0x197A1D50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_MEASURE_OFFSET UNITYSDK_OFFSET(0x197C5270)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_MULTIPLYMATRIX44POINT2_OFFSET UNITYSDK_OFFSET(0x197C24D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_PROPAGATEENABLEDTOCHILDREN_OFFSET UNITYSDK_OFFSET(0x197C4E80)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_REMOVEFROMCLASSLIST_OFFSET UNITYSDK_OFFSET(0x197C4DF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_REMOVEMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x197C51A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_RETARGETELEMENT_OFFSET UNITYSDK_OFFSET(0x197AB900)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x197AB080)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SETENABLEDFROMHIERARCHY_OFFSET UNITYSDK_OFFSET(0x197C4CF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SETENABLED_OFFSET UNITYSDK_OFFSET(0x197C4390)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_COMPUTEDSTYLE_OFFSET UNITYSDK_OFFSET(0x197C4370)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ENABLEDSELF_OFFSET UNITYSDK_OFFSET(0x197C4DE0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_GENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x197C4F90)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_HIERARCHY_OFFSET UNITYSDK_OFFSET(0x197C5980)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDCLIPDIRTY_OFFSET UNITYSDK_OFFSET(0x197C36A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDTRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x197C3060)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDTRANSFORMINVERSEDIRTY_OFFSET UNITYSDK_OFFSET(0x197C3080)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x197C42C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_PSEUDOSTATES_OFFSET UNITYSDK_OFFSET(0x197C4240)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_RENDERHINTS_OFFSET UNITYSDK_OFFSET(0x197C21E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_REQUIREMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x197AD570)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_YOGANODE_OFFSET UNITYSDK_OFFSET(0x197C4350)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SHOULDCLIP_OFFSET UNITYSDK_OFFSET(0x197B4330)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SUBSTRACTBORDERPADDING_OFFSET UNITYSDK_OFFSET(0x197C3AF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197C54A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_TRANSFORMALIGNEDRECT_OFFSET UNITYSDK_OFFSET(0x197C2370)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERBOTTOMWIDTH_OFFSET UNITYSDK_OFFSET(0x197C4120)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERLEFTWIDTH_OFFSET UNITYSDK_OFFSET(0x197C4030)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERRIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x197C40D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERTOPWIDTH_OFFSET UNITYSDK_OFFSET(0x197C4080)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x197B4210)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGBOTTOM_OFFSET UNITYSDK_OFFSET(0x197C4200)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGLEFT_OFFSET UNITYSDK_OFFSET(0x197C4170)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGRIGHT_OFFSET UNITYSDK_OFFSET(0x197C41D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGTOP_OFFSET UNITYSDK_OFFSET(0x197C41A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x197C4F30)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_ITRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x197C2270)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x197C2560)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATECURSORSTYLE_OFFSET UNITYSDK_OFFSET(0x197C4920)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x197C2CB0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x197C36B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x197C3090)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__ASSIGNMEASUREFUNCTION_B__206_0_OFFSET UNITYSDK_OFFSET(0x197C5B50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x197C5A20)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x197AD070)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int VisualElement_TypeDefinitionIndex = 24973;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x1EA60);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_s_EmptyClassList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x1EA68);
		}
		static ::System::String** StaticGet_disabledUssClassName()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x1EA70);
		}
		static ::UnityEngine::PropertyName* StaticGet_userDataPropertyKey()
		{
			return (::UnityEngine::PropertyName*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x4740);
		}
		static ::UnityEngine::Rect* StaticGet_s_InfiniteRect()
		{
			return (::UnityEngine::Rect*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x4744);
		}
		static ::System::UInt32* StaticGet_s_NextId()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x4754);
		}
