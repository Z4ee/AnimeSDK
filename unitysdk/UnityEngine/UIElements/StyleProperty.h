...
#define UNITYENGINE_UIELEMENTS_STYLEPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x197BA2A0)
#define UNITYENGINE_UIELEMENTS_STYLEPROPERTY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x197BA2B0)
#define UNITYENGINE_UIELEMENTS_STYLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x197BA2C0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleProperty_TypeDefinitionIndex = 25092;
