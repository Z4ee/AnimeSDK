...
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1BBE7ED0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BBE7E20)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DOIMGUIREPAINT_OFFSET UNITYSDK_OFFSET(0x1BBE6630)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DOMEASURE_OFFSET UNITYSDK_OFFSET(0x1BBE77E0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DOONGUI_OFFSET UNITYSDK_OFFSET(0x1BBE48D0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_EXECUTEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x1BBE7580)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GETCURRENTTRANSFORMANDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBE7230)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_CACHE_OFFSET UNITYSDK_OFFSET(0x1BBE3770)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_CANGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x1BBE3930)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_CONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x1BBE3900)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_FOCUSONLYIFHASFOCUSABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x1BBE3920)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_GUISTATE_OFFSET UNITYSDK_OFFSET(0x1BBE36B0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_LASTWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBE3750)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_LAYOUTMEASUREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1BBE3870)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_LAYOUTMEASUREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBE37E0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x1BBE35F0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1BBE65C0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEIMGUIEVENT_1_OFFSET UNITYSDK_OFFSET(0x1BBE7140)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEIMGUIEVENT_2_OFFSET UNITYSDK_OFFSET(0x1BBE6B20)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEIMGUIEVENT_OFFSET UNITYSDK_OFFSET(0x1BBE7050)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_MARKDIRTYLAYOUT_OFFSET UNITYSDK_OFFSET(0x1BBE6580)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_ONGENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x1BBE42D0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_RESTOREGLOBALS_OFFSET UNITYSDK_OFFSET(0x1BBE4690)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SAVEGLOBALS_OFFSET UNITYSDK_OFFSET(0x1BBE4420)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SENDEVENTTOIMGUI_OFFSET UNITYSDK_OFFSET(0x1BBDAE90)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SET_CONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x1BBE3910)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SET_LASTWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x1BBE3760)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SET_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x1BBE3600)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBE7EF0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBE3A30)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBE3A20)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int IMGUIContainer_TypeDefinitionIndex = 27450;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(IMGUIContainer_TypeDefinitionIndex)->GetStaticField(0x22520);
		}
