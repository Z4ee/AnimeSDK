...
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLESHEETCACHE_SHEETHANDLEKEYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x197BF780)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLESHEETCACHE_SHEETHANDLEKEYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197BF790)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLESHEETCACHE_SHEETHANDLEKEYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x197BF6B0)

namespace UnityEngine::UIElements::StyleSheets
{
	inline static constexpr unsigned int StyleSheetCache_SheetHandleKeyComparer_TypeDefinitionIndex = 25124;
