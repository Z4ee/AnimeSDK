...
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1D61F340)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1D61F2E0)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_3_OFFSET UNITYSDK_OFFSET(0x1D61F310)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_4_OFFSET UNITYSDK_OFFSET(0x1D61F360)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_OFFSET UNITYSDK_OFFSET(0x1D61F380)

namespace UnityEngine::UIElements::StyleSheets
{
	inline static constexpr unsigned int StyleValue_TypeDefinitionIndex = 6007;
