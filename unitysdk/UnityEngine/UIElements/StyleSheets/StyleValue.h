...
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_1_OFFSET UNITYSDK_OFFSET(0x197BF720)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_2_OFFSET UNITYSDK_OFFSET(0x197BF6C0)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_3_OFFSET UNITYSDK_OFFSET(0x197BF6F0)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_4_OFFSET UNITYSDK_OFFSET(0x197BF740)
#define UNITYENGINE_UIELEMENTS_STYLESHEETS_STYLEVALUE_CREATE_OFFSET UNITYSDK_OFFSET(0x197BF760)

namespace UnityEngine::UIElements::StyleSheets
{
	inline static constexpr unsigned int StyleValue_TypeDefinitionIndex = 25126;
