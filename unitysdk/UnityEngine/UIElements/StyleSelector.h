...
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x1D0074B0)
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D007710)
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D008430)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleSelector_TypeDefinitionIndex = 28199;
