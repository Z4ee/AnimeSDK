...
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x1BBEFFC0)
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBF0220)
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF0F40)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleSelector_TypeDefinitionIndex = 27597;
