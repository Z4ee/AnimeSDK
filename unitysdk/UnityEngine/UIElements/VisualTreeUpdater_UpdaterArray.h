...
#define UNITYENGINE_UIELEMENTS_VISUALTREEUPDATER_UPDATERARRAY_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1D014940)
#define UNITYENGINE_UIELEMENTS_VISUALTREEUPDATER_UPDATERARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D014900)
#define UNITYENGINE_UIELEMENTS_VISUALTREEUPDATER_UPDATERARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D014980)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int VisualTreeUpdater_UpdaterArray_TypeDefinitionIndex = 28085;
