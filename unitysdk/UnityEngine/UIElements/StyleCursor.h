...
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x885690)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x8855A0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8856A0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GET_KEYWORD_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x885550)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x197B97A0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8856E0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleCursor_TypeDefinitionIndex = 25080;
