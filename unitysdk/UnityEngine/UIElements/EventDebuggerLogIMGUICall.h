...
#define UNITYENGINE_UIELEMENTS_EVENTDEBUGGERLOGIMGUICALL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNITYENGINE_UIELEMENTS_EVENTDEBUGGERLOGIMGUICALL__CTOR_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int EventDebuggerLogIMGUICall_TypeDefinitionIndex = 25067;
