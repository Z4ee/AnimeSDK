...
#define UNITYENGINE_UIELEMENTS_KEYBOARDEVENTDISPATCHINGSTRATEGY_CANDISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x1BA3A7C0)
#define UNITYENGINE_UIELEMENTS_KEYBOARDEVENTDISPATCHINGSTRATEGY_DISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x1BA3A820)
#define UNITYENGINE_UIELEMENTS_KEYBOARDEVENTDISPATCHINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA34C10)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int KeyboardEventDispatchingStrategy_TypeDefinitionIndex = 6208;
