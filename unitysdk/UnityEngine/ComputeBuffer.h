...
#define UNITYENGINE_COMPUTEBUFFER_COPYCOUNT_OFFSET UNITYSDK_OFFSET(0x1AAD37D0)
#define UNITYENGINE_COMPUTEBUFFER_DESTROYBUFFER_OFFSET UNITYSDK_OFFSET(0x1AAD2830)
#define UNITYENGINE_COMPUTEBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AAD26E0)
#define UNITYENGINE_COMPUTEBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AAD2760)
#define UNITYENGINE_COMPUTEBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AAD2620)
#define UNITYENGINE_COMPUTEBUFFER_GETBUFFERID_OFFSET UNITYSDK_OFFSET(0x1AAD37E0)
#define UNITYENGINE_COMPUTEBUFFER_GETDATA_1_OFFSET UNITYSDK_OFFSET(0x1AAD3480)
#define UNITYENGINE_COMPUTEBUFFER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AAD3210)
#define UNITYENGINE_COMPUTEBUFFER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AAD2AC0)
#define UNITYENGINE_COMPUTEBUFFER_GET_STRIDE_OFFSET UNITYSDK_OFFSET(0x1AAD2AD0)
#define UNITYENGINE_COMPUTEBUFFER_INITBUFFER_OFFSET UNITYSDK_OFFSET(0x1AAD2840)
#define UNITYENGINE_COMPUTEBUFFER_INTERNALGETDATA_OFFSET UNITYSDK_OFFSET(0x1AAD3470)
#define UNITYENGINE_COMPUTEBUFFER_INTERNALSETDATA_OFFSET UNITYSDK_OFFSET(0x1AAD2D40)
#define UNITYENGINE_COMPUTEBUFFER_INTERNALSETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x1AAD3200)
#define UNITYENGINE_COMPUTEBUFFER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AAD2AB0)
#define UNITYENGINE_COMPUTEBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AAD29E0)
#define UNITYENGINE_COMPUTEBUFFER_SETCOUNTERVALUE_OFFSET UNITYSDK_OFFSET(0x1AAD37C0)
#define UNITYENGINE_COMPUTEBUFFER_SETDATA_1_OFFSET UNITYSDK_OFFSET(0x1AAD2D50)
#define UNITYENGINE_COMPUTEBUFFER_SETDATA_2_OFFSET UNITYSDK_OFFSET(0x1AAD2EE0)
#define UNITYENGINE_COMPUTEBUFFER_SETDATA_OFFSET UNITYSDK_OFFSET(0x1AAD2AE0)
#define UNITYENGINE_COMPUTEBUFFER_SETNAME_OFFSET UNITYSDK_OFFSET(0x1AAD37B0)
#define UNITYENGINE_COMPUTEBUFFER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AAD37A0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAD28A0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AAD28C0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AAD28E0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AAD2880)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AAD2910)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD2850)

namespace UnityEngine
{
	inline static constexpr unsigned int ComputeBuffer_TypeDefinitionIndex = 5385;
