...
#define UNITYENGINE_YOGA_MEASUREFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197C76B0)
#define UNITYENGINE_YOGA_MEASUREFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197C7790)
#define UNITYENGINE_YOGA_MEASUREFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x197C7000)
#define UNITYENGINE_YOGA_MEASUREFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197C51F0)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int MeasureFunction_TypeDefinitionIndex = 24927;
