...
#define UNITYENGINE_YOGA_YOGANODE_BASELINEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BBFE680)
#define UNITYENGINE_YOGA_YOGANODE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BBFE9F0)
#define UNITYENGINE_YOGA_YOGANODE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BBFEA70)
#define UNITYENGINE_YOGA_YOGANODE_GET_ISBASELINEDEFINED_OFFSET UNITYSDK_OFFSET(0x1BBFEA60)
#define UNITYENGINE_YOGA_YOGANODE_GET_ISMEASUREDEFINED_OFFSET UNITYSDK_OFFSET(0x1BBFBD00)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTHEIGHT_OFFSET UNITYSDK_OFFSET(0x1BBF8F50)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGBOTTOM_OFFSET UNITYSDK_OFFSET(0x1BBFC600)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGLEFT_OFFSET UNITYSDK_OFFSET(0x1BBFC5B0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGRIGHT_OFFSET UNITYSDK_OFFSET(0x1BBFC5E0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGTOP_OFFSET UNITYSDK_OFFSET(0x1BBFC5C0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBF8F40)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTX_OFFSET UNITYSDK_OFFSET(0x1BBF8F20)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTY_OFFSET UNITYSDK_OFFSET(0x1BBF8F30)
#define UNITYENGINE_YOGA_YOGANODE_MEASUREINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BBFE530)
#define UNITYENGINE_YOGA_YOGANODE_SETMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x1BBFBE00)
#define UNITYENGINE_YOGA_YOGANODE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BBFEC60)
#define UNITYENGINE_YOGA_YOGANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBFB0E0)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int YogaNode_TypeDefinitionIndex = 27436;
