...
#define UNITYENGINE_YOGA_YOGANODE_BASELINEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D015C40)
#define UNITYENGINE_YOGA_YOGANODE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D015FB0)
#define UNITYENGINE_YOGA_YOGANODE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D016030)
#define UNITYENGINE_YOGA_YOGANODE_GET_ISBASELINEDEFINED_OFFSET UNITYSDK_OFFSET(0x1D016020)
#define UNITYENGINE_YOGA_YOGANODE_GET_ISMEASUREDEFINED_OFFSET UNITYSDK_OFFSET(0x1D0132A0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTHEIGHT_OFFSET UNITYSDK_OFFSET(0x1D010410)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGBOTTOM_OFFSET UNITYSDK_OFFSET(0x1D013BA0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGLEFT_OFFSET UNITYSDK_OFFSET(0x1D013B50)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGRIGHT_OFFSET UNITYSDK_OFFSET(0x1D013B80)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGTOP_OFFSET UNITYSDK_OFFSET(0x1D013B60)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTWIDTH_OFFSET UNITYSDK_OFFSET(0x1D010400)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTX_OFFSET UNITYSDK_OFFSET(0x1D0103E0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTY_OFFSET UNITYSDK_OFFSET(0x1D0103F0)
#define UNITYENGINE_YOGA_YOGANODE_MEASUREINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D015AF0)
#define UNITYENGINE_YOGA_YOGANODE_SETMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x1D0133A0)
#define UNITYENGINE_YOGA_YOGANODE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D016220)
#define UNITYENGINE_YOGA_YOGANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D012680)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int YogaNode_TypeDefinitionIndex = 28038;
