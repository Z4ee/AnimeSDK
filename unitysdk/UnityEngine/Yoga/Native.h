...
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGFREEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BBFE440)
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGFREE_OFFSET UNITYSDK_OFFSET(0x1BBFE430)
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGGETDEFAULT_OFFSET UNITYSDK_OFFSET(0x1BBFE410)
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGNEW_OFFSET UNITYSDK_OFFSET(0x1BBFE420)
#define UNITYENGINE_YOGA_NATIVE_YGNODEBASELINEINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBFE5E0)
#define UNITYENGINE_YOGA_NATIVE_YGNODEFREEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BBFE3F0)
#define UNITYENGINE_YOGA_NATIVE_YGNODEFREE_OFFSET UNITYSDK_OFFSET(0x1BBFE3E0)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1BBFE740)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETLEFT_OFFSET UNITYSDK_OFFSET(0x1BBFE710)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETPADDING_OFFSET UNITYSDK_OFFSET(0x1BBFE750)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETTOP_OFFSET UNITYSDK_OFFSET(0x1BBFE720)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETWIDTH_OFFSET UNITYSDK_OFFSET(0x1BBFE730)
#define UNITYENGINE_YOGA_NATIVE_YGNODEMEASUREINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBFE470)
#define UNITYENGINE_YOGA_NATIVE_YGNODENEWWITHCONFIG_OFFSET UNITYSDK_OFFSET(0x1BBFE3D0)
#define UNITYENGINE_YOGA_NATIVE_YGNODEREMOVEMEASUREFUNC_OFFSET UNITYSDK_OFFSET(0x1BBFE460)
#define UNITYENGINE_YOGA_NATIVE_YGNODESETMEASUREFUNC_OFFSET UNITYSDK_OFFSET(0x1BBFE450)
#define UNITYENGINE_YOGA_NATIVE_YGSETMANAGEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1BBFE400)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int Native_TypeDefinitionIndex = 27435;
