...
#define UNITYENGINE_YOGA_BASELINEFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D0150F0)
#define UNITYENGINE_YOGA_BASELINEFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D015190)
#define UNITYENGINE_YOGA_BASELINEFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D014AE0)
#define UNITYENGINE_YOGA_BASELINEFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D014AC0)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int BaselineFunction_TypeDefinitionIndex = 28031;
