...
#define UNITYENGINE_YOGA_BASELINEFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197C6F30)
#define UNITYENGINE_YOGA_BASELINEFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197C6FD0)
#define UNITYENGINE_YOGA_BASELINEFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x197C6950)
#define UNITYENGINE_YOGA_BASELINEFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197C6940)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int BaselineFunction_TypeDefinitionIndex = 24926;
