...
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x8355A0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_CYCLECOUNT_OFFSET UNITYSDK_OFFSET(0x3C6F2E0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x3C6F2C0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_MINCOUNT_OFFSET UNITYSDK_OFFSET(0x3C6F2A0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_PROBABILITY_OFFSET UNITYSDK_OFFSET(0x3C6F310)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_REPEATINTERVAL_OFFSET UNITYSDK_OFFSET(0x3AE8370)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_TIME_OFFSET UNITYSDK_OFFSET(0x213E0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x3A942C0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_CYCLECOUNT_OFFSET UNITYSDK_OFFSET(0x3C6F2F0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x3C6F2D0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_MINCOUNT_OFFSET UNITYSDK_OFFSET(0x3C6F2B0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_PROBABILITY_OFFSET UNITYSDK_OFFSET(0x3C6F320)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_REPEATINTERVAL_OFFSET UNITYSDK_OFFSET(0x3C6F300)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_TIME_OFFSET UNITYSDK_OFFSET(0x21240)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3C6F160)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3C6F1B0)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3C6F210)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_4_OFFSET UNITYSDK_OFFSET(0x3C6F250)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_OFFSET UNITYSDK_OFFSET(0x3C6F130)
