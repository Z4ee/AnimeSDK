...
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE0410)
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE04E0)
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EDDF850)
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE0390)
