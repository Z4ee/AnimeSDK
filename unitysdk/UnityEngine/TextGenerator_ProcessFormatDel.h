...
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0780)
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0850)
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AFBC0)
#define UNITYENGINE_TEXTGENERATOR_PROCESSFORMATDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B0700)

namespace UnityEngine
{
	inline static constexpr unsigned int TextGenerator_ProcessFormatDel_TypeDefinitionIndex = 5025;
