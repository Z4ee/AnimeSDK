...
#define UNITYENGINE_NETWORKING_PLAYERCONNECTION_PLAYEREDITORCONNECTIONEVENTS___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18A28EE0)
#define UNITYENGINE_NETWORKING_PLAYERCONNECTION_PLAYEREDITORCONNECTIONEVENTS___C__DISPLAYCLASS6_0__INVOKEMESSAGEIDSUBSCRIBERS_B__0_OFFSET UNITYSDK_OFFSET(0x18A28FC0)

namespace UnityEngine::Networking::PlayerConnection
{
	inline static constexpr unsigned int PlayerEditorConnectionEvents___c__DisplayClass6_0_TypeDefinitionIndex = 4487;
