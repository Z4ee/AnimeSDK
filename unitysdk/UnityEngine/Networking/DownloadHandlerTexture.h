...
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A5BECA0)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A5BED00)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A5BED10)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_INTERNALCREATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1A5BECB0)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_INTERNALGETTEXTURENATIVE_OFFSET UNITYSDK_OFFSET(0x1A5BEE30)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_INTERNALGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A5BEDA0)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5BECD0)

namespace UnityEngine::Networking
{
	inline static constexpr unsigned int DownloadHandlerTexture_TypeDefinitionIndex = 5997;
