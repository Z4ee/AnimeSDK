...
#define UNITYENGINE_GL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1EA5E900)
#define UNITYENGINE_GL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1EA5E940)
#define UNITYENGINE_GL_COLOR_OFFSET UNITYSDK_OFFSET(0x1EA5E720)
#define UNITYENGINE_GL_END_OFFSET UNITYSDK_OFFSET(0x1EA5E910)
#define UNITYENGINE_GL_GETGPUPROJECTIONMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EA5E860)
#define UNITYENGINE_GL_GETGPUPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1EA5E800)
#define UNITYENGINE_GL_GLCLEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EA5E930)
#define UNITYENGINE_GL_GLCLEAR_OFFSET UNITYSDK_OFFSET(0x1EA5E920)
#define UNITYENGINE_GL_GLISSUEPLUGINEVENT_OFFSET UNITYSDK_OFFSET(0x1EA5E870)
#define UNITYENGINE_GL_IMMEDIATECOLOR_OFFSET UNITYSDK_OFFSET(0x1EA5E710)
#define UNITYENGINE_GL_ISSUEPLUGINEVENT_OFFSET UNITYSDK_OFFSET(0x1EA5E880)
#define UNITYENGINE_GL_LOADIDENTITY_OFFSET UNITYSDK_OFFSET(0x1EA5E7D0)
#define UNITYENGINE_GL_LOADPROJECTIONMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EA5E7F0)
#define UNITYENGINE_GL_LOADPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1EA5E7E0)
#define UNITYENGINE_GL_POPMATRIX_OFFSET UNITYSDK_OFFSET(0x1EA5E7C0)
#define UNITYENGINE_GL_PUSHMATRIX_OFFSET UNITYSDK_OFFSET(0x1EA5E7B0)
#define UNITYENGINE_GL_SETVIEWMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EA5E760)
#define UNITYENGINE_GL_SETVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x1EA5E750)
#define UNITYENGINE_GL_SET_INVERTCULLING_OFFSET UNITYSDK_OFFSET(0x1EA5E740)
#define UNITYENGINE_GL_SET_MODELVIEW_OFFSET UNITYSDK_OFFSET(0x1EA5E770)
#define UNITYENGINE_GL_VERTEX3_OFFSET UNITYSDK_OFFSET(0x1EA5E6E0)
#define UNITYENGINE_GL_VERTEX_OFFSET UNITYSDK_OFFSET(0x1EA5E6F0)
#define UNITYENGINE_GL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5E970)
