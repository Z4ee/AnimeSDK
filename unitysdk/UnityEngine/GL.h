...
#define UNITYENGINE_GL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1B2EF3D0)
#define UNITYENGINE_GL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B2EF410)
#define UNITYENGINE_GL_COLOR_OFFSET UNITYSDK_OFFSET(0x1B2EF1F0)
#define UNITYENGINE_GL_END_OFFSET UNITYSDK_OFFSET(0x1B2EF3E0)
#define UNITYENGINE_GL_GETGPUPROJECTIONMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B2EF330)
#define UNITYENGINE_GL_GETGPUPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1B2EF2D0)
#define UNITYENGINE_GL_GLCLEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B2EF400)
#define UNITYENGINE_GL_GLCLEAR_OFFSET UNITYSDK_OFFSET(0x1B2EF3F0)
#define UNITYENGINE_GL_GLISSUEPLUGINEVENT_OFFSET UNITYSDK_OFFSET(0x1B2EF340)
#define UNITYENGINE_GL_IMMEDIATECOLOR_OFFSET UNITYSDK_OFFSET(0x1B2EF1E0)
#define UNITYENGINE_GL_ISSUEPLUGINEVENT_OFFSET UNITYSDK_OFFSET(0x1B2EF350)
#define UNITYENGINE_GL_LOADIDENTITY_OFFSET UNITYSDK_OFFSET(0x1B2EF2A0)
#define UNITYENGINE_GL_LOADPROJECTIONMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B2EF2C0)
#define UNITYENGINE_GL_LOADPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1B2EF2B0)
#define UNITYENGINE_GL_POPMATRIX_OFFSET UNITYSDK_OFFSET(0x1B2EF290)
#define UNITYENGINE_GL_PUSHMATRIX_OFFSET UNITYSDK_OFFSET(0x1B2EF280)
#define UNITYENGINE_GL_SETVIEWMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B2EF230)
#define UNITYENGINE_GL_SETVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x1B2EF220)
#define UNITYENGINE_GL_SET_INVERTCULLING_OFFSET UNITYSDK_OFFSET(0x1B2EF210)
#define UNITYENGINE_GL_SET_MODELVIEW_OFFSET UNITYSDK_OFFSET(0x1B2EF240)
#define UNITYENGINE_GL_VERTEX3_OFFSET UNITYSDK_OFFSET(0x1B2EF1B0)
#define UNITYENGINE_GL_VERTEX_OFFSET UNITYSDK_OFFSET(0x1B2EF1C0)
#define UNITYENGINE_GL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EF440)

namespace UnityEngine
{
	inline static constexpr unsigned int GL_TypeDefinitionIndex = 5182;
