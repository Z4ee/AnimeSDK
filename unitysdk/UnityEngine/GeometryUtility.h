...
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEBOUNDSUNSAFE_OFFSET UNITYSDK_OFFSET(0x1D7AB020)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1D7AAEB0)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_1_OFFSET UNITYSDK_OFFSET(0x1D7AAC40)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_2_OFFSET UNITYSDK_OFFSET(0x1D7AADC0)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_OFFSET UNITYSDK_OFFSET(0x1D7AAA90)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDSUNSAFE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AB1D0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDSUNSAFE_OFFSET UNITYSDK_OFFSET(0x1D7AB140)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AB1C0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1D7AAFD0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_EXTRACTPLANES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AB1B0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_EXTRACTPLANES_OFFSET UNITYSDK_OFFSET(0x1D7AAEA0)
#define UNITYENGINE_GEOMETRYUTILITY_TESTPLANESAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D7AB1A0)
#define UNITYENGINE_GEOMETRYUTILITY_TESTPLANESAABB_OFFSET UNITYSDK_OFFSET(0x1D7AB190)
#define UNITYENGINE_GEOMETRYUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7AB1E0)
