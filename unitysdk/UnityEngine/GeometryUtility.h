...
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEBOUNDSUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B48E040)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B48DED0)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_1_OFFSET UNITYSDK_OFFSET(0x1B48DC60)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_2_OFFSET UNITYSDK_OFFSET(0x1B48DDE0)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_OFFSET UNITYSDK_OFFSET(0x1B48DAB0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDSUNSAFE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B48E1F0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDSUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B48E160)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B48E1E0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B48DFF0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_EXTRACTPLANES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B48E1D0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_EXTRACTPLANES_OFFSET UNITYSDK_OFFSET(0x1B48DEC0)
#define UNITYENGINE_GEOMETRYUTILITY_TESTPLANESAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B48E1C0)
#define UNITYENGINE_GEOMETRYUTILITY_TESTPLANESAABB_OFFSET UNITYSDK_OFFSET(0x1B48E1B0)
#define UNITYENGINE_GEOMETRYUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B48E200)

namespace UnityEngine
{
	inline static constexpr unsigned int GeometryUtility_TypeDefinitionIndex = 5162;
