...
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A521F80)
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A521FB0)
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A521CB0)
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A521F60)

namespace UnityEngine
{
	inline static constexpr unsigned int Canvas_WillRenderCanvases_TypeDefinitionIndex = 5269;
