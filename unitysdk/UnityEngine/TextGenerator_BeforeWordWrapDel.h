...
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B34DC90)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B34DD20)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B34D780)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34DC10)

namespace UnityEngine
{
	inline static constexpr unsigned int TextGenerator_BeforeWordWrapDel_TypeDefinitionIndex = 5022;
