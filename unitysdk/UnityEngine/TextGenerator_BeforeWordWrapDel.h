...
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB7EE0)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB7F70)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB79D0)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB7E60)
