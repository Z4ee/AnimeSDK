...
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0650)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B06E0)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0140)
#define UNITYENGINE_TEXTGENERATOR_BEFOREWORDWRAPDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B05D0)

namespace UnityEngine
{
	inline static constexpr unsigned int TextGenerator_BeforeWordWrapDel_TypeDefinitionIndex = 5027;
