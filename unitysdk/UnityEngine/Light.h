...
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CCC6BC0)
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFERASYNC_OFFSET UNITYSDK_OFFSET(0x1CCC6BA0)
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1CCC6B90)
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x1CCC6B80)
#define UNITYENGINE_LIGHT_DOPARTICLELIGHTEVENT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1CCC6E00)
#define UNITYENGINE_LIGHT_GETCOMMANDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1CCC6C00)
#define UNITYENGINE_LIGHT_GETLIGHTS_OFFSET UNITYSDK_OFFSET(0x1CCC6C40)
#define UNITYENGINE_LIGHT_GETLINEDIRECTION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6B30)
#define UNITYENGINE_LIGHT_GETLINEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CCC6AE0)
#define UNITYENGINE_LIGHT_GETLINEPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6AB0)
#define UNITYENGINE_LIGHT_GETLINEPOINT_OFFSET UNITYSDK_OFFSET(0x1CCC6A60)
#define UNITYENGINE_LIGHT_GETNUMLINEPOINTS_OFFSET UNITYSDK_OFFSET(0x1CCC6A50)
#define UNITYENGINE_LIGHT_GETVISRATIO_OFFSET UNITYSDK_OFFSET(0x1CCC6B60)
#define UNITYENGINE_LIGHT_GET_AREAATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x1CCC69F0)
#define UNITYENGINE_LIGHT_GET_AREALIGHTTEX_OFFSET UNITYSDK_OFFSET(0x1CCC69B0)
#define UNITYENGINE_LIGHT_GET_AREASIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6950)
#define UNITYENGINE_LIGHT_GET_AREASIZE_OFFSET UNITYSDK_OFFSET(0x1CCC6920)
#define UNITYENGINE_LIGHT_GET_ATTENUATE_OFFSET UNITYSDK_OFFSET(0x1CCC6C90)
#define UNITYENGINE_LIGHT_GET_BAKEDDESIREDSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC68A0)
#define UNITYENGINE_LIGHT_GET_BAKEDHYBIRDDYNAMICSHADOW_OFFSET UNITYSDK_OFFSET(0x1CCC6860)
#define UNITYENGINE_LIGHT_GET_BAKEDINDEX_OFFSET UNITYSDK_OFFSET(0x1CCC6900)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPENABLED_OFFSET UNITYSDK_OFFSET(0x1CCC6820)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPHIGHQUALITY_OFFSET UNITYSDK_OFFSET(0x1CCC6840)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPRESOLUTIONBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC68C0)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC6880)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAP_OFFSET UNITYSDK_OFFSET(0x1CCC6800)
#define UNITYENGINE_LIGHT_GET_BAKINGOUTPUT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6640)
#define UNITYENGINE_LIGHT_GET_BAKINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1CCC65F0)
#define UNITYENGINE_LIGHT_GET_BOUNCEINTENSITY_OFFSET UNITYSDK_OFFSET(0x1CCC63D0)
#define UNITYENGINE_LIGHT_GET_BOUNDINGSPHEREOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6450)
#define UNITYENGINE_LIGHT_GET_BOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6410)
#define UNITYENGINE_LIGHT_GET_COLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1CCC6370)
#define UNITYENGINE_LIGHT_GET_COLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6340)
#define UNITYENGINE_LIGHT_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1CCC6300)
#define UNITYENGINE_LIGHT_GET_COMMANDBUFFERCOUNT_OFFSET UNITYSDK_OFFSET(0x1CCC6C10)
#define UNITYENGINE_LIGHT_GET_COOKIESIZE_OFFSET UNITYSDK_OFFSET(0x1CCC67A0)
#define UNITYENGINE_LIGHT_GET_COOKIE_OFFSET UNITYSDK_OFFSET(0x1CCC67C0)
#define UNITYENGINE_LIGHT_GET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0x1CCC6670)
#define UNITYENGINE_LIGHT_GET_CURRENTSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC6890)
#define UNITYENGINE_LIGHT_GET_ENABLEAREALIGHTFALLOFF_OFFSET UNITYSDK_OFFSET(0x1CCC69D0)
#define UNITYENGINE_LIGHT_GET_FLARE_OFFSET UNITYSDK_OFFSET(0x1CCC65D0)
#define UNITYENGINE_LIGHT_GET_INNERSPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1CCC62E0)
#define UNITYENGINE_LIGHT_GET_INTENSITY_OFFSET UNITYSDK_OFFSET(0x1CCC63B0)
#define UNITYENGINE_LIGHT_GET_LAYERSHADOWCULLDISTANCES_OFFSET UNITYSDK_OFFSET(0x1CCC6780)
#define UNITYENGINE_LIGHT_GET_LIGHTSHADOWCASTERMODE_OFFSET UNITYSDK_OFFSET(0x1CCC66B0)
#define UNITYENGINE_LIGHT_GET_LINERADIUS_OFFSET UNITYSDK_OFFSET(0x1CCC6A10)
#define UNITYENGINE_LIGHT_GET_NUMLINEPOINTS_OFFSET UNITYSDK_OFFSET(0x1CCC6A30)
#define UNITYENGINE_LIGHT_GET_PIXELLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x1CCC6C20)
#define UNITYENGINE_LIGHT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1CCC65B0)
#define UNITYENGINE_LIGHT_GET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1CCC6690)
#define UNITYENGINE_LIGHT_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0x1CCC68E0)
#define UNITYENGINE_LIGHT_GET_RUNTIMEAREALIGHTSHAPE_OFFSET UNITYSDK_OFFSET(0x1CCC6990)
#define UNITYENGINE_LIGHT_GET_SHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC64A0)
#define UNITYENGINE_LIGHT_GET_SHADOWCONSTANTBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC6C50)
#define UNITYENGINE_LIGHT_GET_SHADOWCUSTOMRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC6480)
#define UNITYENGINE_LIGHT_GET_SHADOWMATRIXOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6580)
#define UNITYENGINE_LIGHT_GET_SHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6520)
#define UNITYENGINE_LIGHT_GET_SHADOWNEARPLANE_OFFSET UNITYSDK_OFFSET(0x1CCC64E0)
#define UNITYENGINE_LIGHT_GET_SHADOWNORMALBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC64C0)
#define UNITYENGINE_LIGHT_GET_SHADOWOBJECTSIZEBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC6C70)
#define UNITYENGINE_LIGHT_GET_SHADOWRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC6720)
#define UNITYENGINE_LIGHT_GET_SHADOWSOFTNESSFADE_OFFSET UNITYSDK_OFFSET(0x1CCC6760)
#define UNITYENGINE_LIGHT_GET_SHADOWSOFTNESS_OFFSET UNITYSDK_OFFSET(0x1CCC6740)
#define UNITYENGINE_LIGHT_GET_SHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1CCC6700)
#define UNITYENGINE_LIGHT_GET_SHADOWS_OFFSET UNITYSDK_OFFSET(0x1CCC66E0)
#define UNITYENGINE_LIGHT_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1CCC62A0)
#define UNITYENGINE_LIGHT_GET_SPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1CCC62C0)
#define UNITYENGINE_LIGHT_GET_SPOTIESTEX_OFFSET UNITYSDK_OFFSET(0x1CCC67E0)
#define UNITYENGINE_LIGHT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CCC6280)
#define UNITYENGINE_LIGHT_GET_USEBOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC63F0)
#define UNITYENGINE_LIGHT_GET_USECOLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1CCC6390)
#define UNITYENGINE_LIGHT_GET_USESHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6500)
#define UNITYENGINE_LIGHT_GET_VCMASK_OFFSET UNITYSDK_OFFSET(0x1CCC6CB0)
#define UNITYENGINE_LIGHT_REMOVEALLCOMMANDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1CCC6BF0)
#define UNITYENGINE_LIGHT_REMOVECOMMANDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1CCC6BE0)
#define UNITYENGINE_LIGHT_REMOVECOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x1CCC6BD0)
#define UNITYENGINE_LIGHT_RESETLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1CCC6CE0)
#define UNITYENGINE_LIGHT_RESET_OFFSET UNITYSDK_OFFSET(0x1CCC66D0)
#define UNITYENGINE_LIGHT_SETGEOMETRYAABB_OFFSET UNITYSDK_OFFSET(0x1CCC6DF0)
#define UNITYENGINE_LIGHT_SETGEOMETRYSHADOW_OFFSET UNITYSDK_OFFSET(0x1CCC6DE0)
#define UNITYENGINE_LIGHT_SETLIGHTCLIPPLANEDATA_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6DB0)
#define UNITYENGINE_LIGHT_SETLIGHTCLIPPLANEDATA_OFFSET UNITYSDK_OFFSET(0x1CCC6DA0)
#define UNITYENGINE_LIGHT_SETLIGHTCLIPPLANEFADEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1CCC6DC0)
#define UNITYENGINE_LIGHT_SETLIGHTDISTANCEFADECURVE_OFFSET UNITYSDK_OFFSET(0x1CCC6D80)
#define UNITYENGINE_LIGHT_SETLINEDIRECTION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6B50)
#define UNITYENGINE_LIGHT_SETLINEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CCC6B40)
#define UNITYENGINE_LIGHT_SETLINEPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6AD0)
#define UNITYENGINE_LIGHT_SETLINEPOINT_OFFSET UNITYSDK_OFFSET(0x1CCC6AC0)
#define UNITYENGINE_LIGHT_SETNUMLIGHTCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1CCC6D90)
#define UNITYENGINE_LIGHT_SETVISRATIO_OFFSET UNITYSDK_OFFSET(0x1CCC6B70)
#define UNITYENGINE_LIGHT_SET_AREAATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x1CCC6A00)
#define UNITYENGINE_LIGHT_SET_AREALIGHTTEX_OFFSET UNITYSDK_OFFSET(0x1CCC69C0)
#define UNITYENGINE_LIGHT_SET_AREASIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6980)
#define UNITYENGINE_LIGHT_SET_AREASIZE_OFFSET UNITYSDK_OFFSET(0x1CCC6960)
#define UNITYENGINE_LIGHT_SET_ATTENUATE_OFFSET UNITYSDK_OFFSET(0x1CCC6CA0)
#define UNITYENGINE_LIGHT_SET_BAKEDDESIREDSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC68B0)
#define UNITYENGINE_LIGHT_SET_BAKEDHYBIRDDYNAMICSHADOW_OFFSET UNITYSDK_OFFSET(0x1CCC6870)
#define UNITYENGINE_LIGHT_SET_BAKEDINDEX_OFFSET UNITYSDK_OFFSET(0x1CCC6910)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAPENABLED_OFFSET UNITYSDK_OFFSET(0x1CCC6830)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAPHIGHQUALITY_OFFSET UNITYSDK_OFFSET(0x1CCC6850)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAPRESOLUTIONBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC68D0)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAP_OFFSET UNITYSDK_OFFSET(0x1CCC6810)
#define UNITYENGINE_LIGHT_SET_BAKINGOUTPUT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6660)
#define UNITYENGINE_LIGHT_SET_BAKINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1CCC6650)
#define UNITYENGINE_LIGHT_SET_BOUNCEINTENSITY_OFFSET UNITYSDK_OFFSET(0x1CCC63E0)
#define UNITYENGINE_LIGHT_SET_BOUNDINGSPHEREOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6470)
#define UNITYENGINE_LIGHT_SET_BOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6460)
#define UNITYENGINE_LIGHT_SET_COLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1CCC6380)
#define UNITYENGINE_LIGHT_SET_COLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC6360)
#define UNITYENGINE_LIGHT_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x1CCC6350)
#define UNITYENGINE_LIGHT_SET_COOKIESIZE_OFFSET UNITYSDK_OFFSET(0x1CCC67B0)
#define UNITYENGINE_LIGHT_SET_COOKIE_OFFSET UNITYSDK_OFFSET(0x1CCC67D0)
#define UNITYENGINE_LIGHT_SET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0x1CCC6680)
#define UNITYENGINE_LIGHT_SET_ENABLEAREALIGHTFALLOFF_OFFSET UNITYSDK_OFFSET(0x1CCC69E0)
#define UNITYENGINE_LIGHT_SET_FLARE_OFFSET UNITYSDK_OFFSET(0x1CCC65E0)
#define UNITYENGINE_LIGHT_SET_INNERSPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1CCC62F0)
#define UNITYENGINE_LIGHT_SET_INTENSITY_OFFSET UNITYSDK_OFFSET(0x1CCC63C0)
#define UNITYENGINE_LIGHT_SET_LAYERSHADOWCULLDISTANCES_OFFSET UNITYSDK_OFFSET(0x1CCC6790)
#define UNITYENGINE_LIGHT_SET_LIGHTSHADOWCASTERMODE_OFFSET UNITYSDK_OFFSET(0x1CCC66C0)
#define UNITYENGINE_LIGHT_SET_LINERADIUS_OFFSET UNITYSDK_OFFSET(0x1CCC6A20)
#define UNITYENGINE_LIGHT_SET_NUMLINEPOINTS_OFFSET UNITYSDK_OFFSET(0x1CCC6A40)
#define UNITYENGINE_LIGHT_SET_PIXELLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x1CCC6C30)
#define UNITYENGINE_LIGHT_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x1CCC65C0)
#define UNITYENGINE_LIGHT_SET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1CCC66A0)
#define UNITYENGINE_LIGHT_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0x1CCC68F0)
#define UNITYENGINE_LIGHT_SET_RUNTIMEAREALIGHTSHAPE_OFFSET UNITYSDK_OFFSET(0x1CCC69A0)
#define UNITYENGINE_LIGHT_SET_SHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC64B0)
#define UNITYENGINE_LIGHT_SET_SHADOWCONSTANTBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC6C60)
#define UNITYENGINE_LIGHT_SET_SHADOWCUSTOMRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC6490)
#define UNITYENGINE_LIGHT_SET_SHADOWMATRIXOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CCC65A0)
#define UNITYENGINE_LIGHT_SET_SHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6590)
#define UNITYENGINE_LIGHT_SET_SHADOWNEARPLANE_OFFSET UNITYSDK_OFFSET(0x1CCC64F0)
#define UNITYENGINE_LIGHT_SET_SHADOWNORMALBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC64D0)
#define UNITYENGINE_LIGHT_SET_SHADOWOBJECTSIZEBIAS_OFFSET UNITYSDK_OFFSET(0x1CCC6C80)
#define UNITYENGINE_LIGHT_SET_SHADOWRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CCC6730)
#define UNITYENGINE_LIGHT_SET_SHADOWSOFTNESSFADE_OFFSET UNITYSDK_OFFSET(0x1CCC6770)
#define UNITYENGINE_LIGHT_SET_SHADOWSOFTNESS_OFFSET UNITYSDK_OFFSET(0x1CCC6750)
#define UNITYENGINE_LIGHT_SET_SHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1CCC6710)
#define UNITYENGINE_LIGHT_SET_SHADOWS_OFFSET UNITYSDK_OFFSET(0x1CCC66F0)
#define UNITYENGINE_LIGHT_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1CCC62B0)
#define UNITYENGINE_LIGHT_SET_SPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1CCC62D0)
#define UNITYENGINE_LIGHT_SET_SPOTIESTEX_OFFSET UNITYSDK_OFFSET(0x1CCC67F0)
#define UNITYENGINE_LIGHT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CCC6290)
#define UNITYENGINE_LIGHT_SET_USEBOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6400)
#define UNITYENGINE_LIGHT_SET_USECOLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1CCC63A0)
#define UNITYENGINE_LIGHT_SET_USESHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1CCC6510)
#define UNITYENGINE_LIGHT_SET_VCMASK_OFFSET UNITYSDK_OFFSET(0x1CCC6CC0)
#define UNITYENGINE_LIGHT_UPDATELIGHTASYNCLOADEDDATA_OFFSET UNITYSDK_OFFSET(0x1CCC6DD0)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATAAREA_OFFSET UNITYSDK_OFFSET(0x1CCC6D50)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATACOMMON_OFFSET UNITYSDK_OFFSET(0x1CCC6CF0)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATADEBUG_OFFSET UNITYSDK_OFFSET(0x1CCC6D60)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATAFADE_OFFSET UNITYSDK_OFFSET(0x1CCC6D70)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATALOCAL2_OFFSET UNITYSDK_OFFSET(0x1CCC6D30)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATALOCALSPOT_OFFSET UNITYSDK_OFFSET(0x1CCC6D40)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATALOCAL_OFFSET UNITYSDK_OFFSET(0x1CCC6D20)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATASPOT_OFFSET UNITYSDK_OFFSET(0x1CCC6D10)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1CCC6CD0)
#define UNITYENGINE_LIGHT_UPDATELIGHTMESHSTENCIL_OFFSET UNITYSDK_OFFSET(0x1CCC6D00)
#define UNITYENGINE_LIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCC6E40)

namespace UnityEngine
{
	inline static constexpr unsigned int Light_TypeDefinitionIndex = 4134;
	...
	public:
		...
		{
			return (::UnityEngine::Light_OnParticleLightEvent**)Il2CppClass::FromTypeDefinitionIndex(Light_TypeDefinitionIndex)->GetStaticField(0x38770);
		}
