...
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1EDFACE0)
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFERASYNC_OFFSET UNITYSDK_OFFSET(0x1EDFACC0)
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1EDFACB0)
#define UNITYENGINE_LIGHT_ADDCOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x1EDFACA0)
#define UNITYENGINE_LIGHT_DOPARTICLELIGHTEVENT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1EDFAF20)
#define UNITYENGINE_LIGHT_GETCOMMANDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1EDFAD20)
#define UNITYENGINE_LIGHT_GETLIGHTS_OFFSET UNITYSDK_OFFSET(0x1EDFAD60)
#define UNITYENGINE_LIGHT_GETLINEDIRECTION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFAC50)
#define UNITYENGINE_LIGHT_GETLINEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EDFAC00)
#define UNITYENGINE_LIGHT_GETLINEPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFABD0)
#define UNITYENGINE_LIGHT_GETLINEPOINT_OFFSET UNITYSDK_OFFSET(0x1EDFAB80)
#define UNITYENGINE_LIGHT_GETNUMLINEPOINTS_OFFSET UNITYSDK_OFFSET(0x1EDFAB70)
#define UNITYENGINE_LIGHT_GETVISRATIO_OFFSET UNITYSDK_OFFSET(0x1EDFAC80)
#define UNITYENGINE_LIGHT_GET_AREAATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x1EDFAB10)
#define UNITYENGINE_LIGHT_GET_AREALIGHTTEX_OFFSET UNITYSDK_OFFSET(0x1EDFAAD0)
#define UNITYENGINE_LIGHT_GET_AREASIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFAA70)
#define UNITYENGINE_LIGHT_GET_AREASIZE_OFFSET UNITYSDK_OFFSET(0x1EDFAA40)
#define UNITYENGINE_LIGHT_GET_ATTENUATE_OFFSET UNITYSDK_OFFSET(0x1EDFADB0)
#define UNITYENGINE_LIGHT_GET_BAKEDDESIREDSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA9C0)
#define UNITYENGINE_LIGHT_GET_BAKEDHYBIRDDYNAMICSHADOW_OFFSET UNITYSDK_OFFSET(0x1EDFA980)
#define UNITYENGINE_LIGHT_GET_BAKEDINDEX_OFFSET UNITYSDK_OFFSET(0x1EDFAA20)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPENABLED_OFFSET UNITYSDK_OFFSET(0x1EDFA940)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPHIGHQUALITY_OFFSET UNITYSDK_OFFSET(0x1EDFA960)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPRESOLUTIONBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFA9E0)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA9A0)
#define UNITYENGINE_LIGHT_GET_BAKEDSHADOWMAP_OFFSET UNITYSDK_OFFSET(0x1EDFA920)
#define UNITYENGINE_LIGHT_GET_BAKINGOUTPUT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA760)
#define UNITYENGINE_LIGHT_GET_BAKINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1EDFA710)
#define UNITYENGINE_LIGHT_GET_BOUNCEINTENSITY_OFFSET UNITYSDK_OFFSET(0x1EDFA4F0)
#define UNITYENGINE_LIGHT_GET_BOUNDINGSPHEREOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA570)
#define UNITYENGINE_LIGHT_GET_BOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA530)
#define UNITYENGINE_LIGHT_GET_COLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1EDFA490)
#define UNITYENGINE_LIGHT_GET_COLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA460)
#define UNITYENGINE_LIGHT_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1EDFA420)
#define UNITYENGINE_LIGHT_GET_COMMANDBUFFERCOUNT_OFFSET UNITYSDK_OFFSET(0x1EDFAD30)
#define UNITYENGINE_LIGHT_GET_COOKIESIZE_OFFSET UNITYSDK_OFFSET(0x1EDFA8C0)
#define UNITYENGINE_LIGHT_GET_COOKIE_OFFSET UNITYSDK_OFFSET(0x1EDFA8E0)
#define UNITYENGINE_LIGHT_GET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0x1EDFA790)
#define UNITYENGINE_LIGHT_GET_CURRENTSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA9B0)
#define UNITYENGINE_LIGHT_GET_ENABLEAREALIGHTFALLOFF_OFFSET UNITYSDK_OFFSET(0x1EDFAAF0)
#define UNITYENGINE_LIGHT_GET_FLARE_OFFSET UNITYSDK_OFFSET(0x1EDFA6F0)
#define UNITYENGINE_LIGHT_GET_INNERSPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1EDFA400)
#define UNITYENGINE_LIGHT_GET_INTENSITY_OFFSET UNITYSDK_OFFSET(0x1EDFA4D0)
#define UNITYENGINE_LIGHT_GET_LAYERSHADOWCULLDISTANCES_OFFSET UNITYSDK_OFFSET(0x1EDFA8A0)
#define UNITYENGINE_LIGHT_GET_LIGHTSHADOWCASTERMODE_OFFSET UNITYSDK_OFFSET(0x1EDFA7D0)
#define UNITYENGINE_LIGHT_GET_LINERADIUS_OFFSET UNITYSDK_OFFSET(0x1EDFAB30)
#define UNITYENGINE_LIGHT_GET_NUMLINEPOINTS_OFFSET UNITYSDK_OFFSET(0x1EDFAB50)
#define UNITYENGINE_LIGHT_GET_PIXELLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EDFAD40)
#define UNITYENGINE_LIGHT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1EDFA6D0)
#define UNITYENGINE_LIGHT_GET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1EDFA7B0)
#define UNITYENGINE_LIGHT_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0x1EDFAA00)
#define UNITYENGINE_LIGHT_GET_RUNTIMEAREALIGHTSHAPE_OFFSET UNITYSDK_OFFSET(0x1EDFAAB0)
#define UNITYENGINE_LIGHT_GET_SHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFA5C0)
#define UNITYENGINE_LIGHT_GET_SHADOWCONSTANTBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFAD70)
#define UNITYENGINE_LIGHT_GET_SHADOWCUSTOMRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA5A0)
#define UNITYENGINE_LIGHT_GET_SHADOWMATRIXOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA6A0)
#define UNITYENGINE_LIGHT_GET_SHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA640)
#define UNITYENGINE_LIGHT_GET_SHADOWNEARPLANE_OFFSET UNITYSDK_OFFSET(0x1EDFA600)
#define UNITYENGINE_LIGHT_GET_SHADOWNORMALBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFA5E0)
#define UNITYENGINE_LIGHT_GET_SHADOWOBJECTSIZEBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFAD90)
#define UNITYENGINE_LIGHT_GET_SHADOWRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA840)
#define UNITYENGINE_LIGHT_GET_SHADOWSOFTNESSFADE_OFFSET UNITYSDK_OFFSET(0x1EDFA880)
#define UNITYENGINE_LIGHT_GET_SHADOWSOFTNESS_OFFSET UNITYSDK_OFFSET(0x1EDFA860)
#define UNITYENGINE_LIGHT_GET_SHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1EDFA820)
#define UNITYENGINE_LIGHT_GET_SHADOWS_OFFSET UNITYSDK_OFFSET(0x1EDFA800)
#define UNITYENGINE_LIGHT_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1EDFA3C0)
#define UNITYENGINE_LIGHT_GET_SPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1EDFA3E0)
#define UNITYENGINE_LIGHT_GET_SPOTIESTEX_OFFSET UNITYSDK_OFFSET(0x1EDFA900)
#define UNITYENGINE_LIGHT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EDFA3A0)
#define UNITYENGINE_LIGHT_GET_USEBOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA510)
#define UNITYENGINE_LIGHT_GET_USECOLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1EDFA4B0)
#define UNITYENGINE_LIGHT_GET_USESHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA620)
#define UNITYENGINE_LIGHT_GET_VCMASK_OFFSET UNITYSDK_OFFSET(0x1EDFADD0)
#define UNITYENGINE_LIGHT_REMOVEALLCOMMANDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1EDFAD10)
#define UNITYENGINE_LIGHT_REMOVECOMMANDBUFFERS_OFFSET UNITYSDK_OFFSET(0x1EDFAD00)
#define UNITYENGINE_LIGHT_REMOVECOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x1EDFACF0)
#define UNITYENGINE_LIGHT_RESETLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1EDFAE00)
#define UNITYENGINE_LIGHT_RESET_OFFSET UNITYSDK_OFFSET(0x1EDFA7F0)
#define UNITYENGINE_LIGHT_SETGEOMETRYAABB_OFFSET UNITYSDK_OFFSET(0x1EDFAF10)
#define UNITYENGINE_LIGHT_SETGEOMETRYSHADOW_OFFSET UNITYSDK_OFFSET(0x1EDFAF00)
#define UNITYENGINE_LIGHT_SETLIGHTCLIPPLANEDATA_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFAED0)
#define UNITYENGINE_LIGHT_SETLIGHTCLIPPLANEDATA_OFFSET UNITYSDK_OFFSET(0x1EDFAEC0)
#define UNITYENGINE_LIGHT_SETLIGHTCLIPPLANEFADEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1EDFAEE0)
#define UNITYENGINE_LIGHT_SETLIGHTDISTANCEFADECURVE_OFFSET UNITYSDK_OFFSET(0x1EDFAEA0)
#define UNITYENGINE_LIGHT_SETLINEDIRECTION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFAC70)
#define UNITYENGINE_LIGHT_SETLINEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EDFAC60)
#define UNITYENGINE_LIGHT_SETLINEPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFABF0)
#define UNITYENGINE_LIGHT_SETLINEPOINT_OFFSET UNITYSDK_OFFSET(0x1EDFABE0)
#define UNITYENGINE_LIGHT_SETNUMLIGHTCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1EDFAEB0)
#define UNITYENGINE_LIGHT_SETVISRATIO_OFFSET UNITYSDK_OFFSET(0x1EDFAC90)
#define UNITYENGINE_LIGHT_SET_AREAATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x1EDFAB20)
#define UNITYENGINE_LIGHT_SET_AREALIGHTTEX_OFFSET UNITYSDK_OFFSET(0x1EDFAAE0)
#define UNITYENGINE_LIGHT_SET_AREASIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFAAA0)
#define UNITYENGINE_LIGHT_SET_AREASIZE_OFFSET UNITYSDK_OFFSET(0x1EDFAA80)
#define UNITYENGINE_LIGHT_SET_ATTENUATE_OFFSET UNITYSDK_OFFSET(0x1EDFADC0)
#define UNITYENGINE_LIGHT_SET_BAKEDDESIREDSHADOWMAPRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA9D0)
#define UNITYENGINE_LIGHT_SET_BAKEDHYBIRDDYNAMICSHADOW_OFFSET UNITYSDK_OFFSET(0x1EDFA990)
#define UNITYENGINE_LIGHT_SET_BAKEDINDEX_OFFSET UNITYSDK_OFFSET(0x1EDFAA30)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAPENABLED_OFFSET UNITYSDK_OFFSET(0x1EDFA950)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAPHIGHQUALITY_OFFSET UNITYSDK_OFFSET(0x1EDFA970)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAPRESOLUTIONBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFA9F0)
#define UNITYENGINE_LIGHT_SET_BAKEDSHADOWMAP_OFFSET UNITYSDK_OFFSET(0x1EDFA930)
#define UNITYENGINE_LIGHT_SET_BAKINGOUTPUT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA780)
#define UNITYENGINE_LIGHT_SET_BAKINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1EDFA770)
#define UNITYENGINE_LIGHT_SET_BOUNCEINTENSITY_OFFSET UNITYSDK_OFFSET(0x1EDFA500)
#define UNITYENGINE_LIGHT_SET_BOUNDINGSPHEREOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA590)
#define UNITYENGINE_LIGHT_SET_BOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA580)
#define UNITYENGINE_LIGHT_SET_COLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1EDFA4A0)
#define UNITYENGINE_LIGHT_SET_COLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA480)
#define UNITYENGINE_LIGHT_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x1EDFA470)
#define UNITYENGINE_LIGHT_SET_COOKIESIZE_OFFSET UNITYSDK_OFFSET(0x1EDFA8D0)
#define UNITYENGINE_LIGHT_SET_COOKIE_OFFSET UNITYSDK_OFFSET(0x1EDFA8F0)
#define UNITYENGINE_LIGHT_SET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0x1EDFA7A0)
#define UNITYENGINE_LIGHT_SET_ENABLEAREALIGHTFALLOFF_OFFSET UNITYSDK_OFFSET(0x1EDFAB00)
#define UNITYENGINE_LIGHT_SET_FLARE_OFFSET UNITYSDK_OFFSET(0x1EDFA700)
#define UNITYENGINE_LIGHT_SET_INNERSPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1EDFA410)
#define UNITYENGINE_LIGHT_SET_INTENSITY_OFFSET UNITYSDK_OFFSET(0x1EDFA4E0)
#define UNITYENGINE_LIGHT_SET_LAYERSHADOWCULLDISTANCES_OFFSET UNITYSDK_OFFSET(0x1EDFA8B0)
#define UNITYENGINE_LIGHT_SET_LIGHTSHADOWCASTERMODE_OFFSET UNITYSDK_OFFSET(0x1EDFA7E0)
#define UNITYENGINE_LIGHT_SET_LINERADIUS_OFFSET UNITYSDK_OFFSET(0x1EDFAB40)
#define UNITYENGINE_LIGHT_SET_NUMLINEPOINTS_OFFSET UNITYSDK_OFFSET(0x1EDFAB60)
#define UNITYENGINE_LIGHT_SET_PIXELLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EDFAD50)
#define UNITYENGINE_LIGHT_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x1EDFA6E0)
#define UNITYENGINE_LIGHT_SET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1EDFA7C0)
#define UNITYENGINE_LIGHT_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0x1EDFAA10)
#define UNITYENGINE_LIGHT_SET_RUNTIMEAREALIGHTSHAPE_OFFSET UNITYSDK_OFFSET(0x1EDFAAC0)
#define UNITYENGINE_LIGHT_SET_SHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFA5D0)
#define UNITYENGINE_LIGHT_SET_SHADOWCONSTANTBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFAD80)
#define UNITYENGINE_LIGHT_SET_SHADOWCUSTOMRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA5B0)
#define UNITYENGINE_LIGHT_SET_SHADOWMATRIXOVERRIDE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EDFA6C0)
#define UNITYENGINE_LIGHT_SET_SHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA6B0)
#define UNITYENGINE_LIGHT_SET_SHADOWNEARPLANE_OFFSET UNITYSDK_OFFSET(0x1EDFA610)
#define UNITYENGINE_LIGHT_SET_SHADOWNORMALBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFA5F0)
#define UNITYENGINE_LIGHT_SET_SHADOWOBJECTSIZEBIAS_OFFSET UNITYSDK_OFFSET(0x1EDFADA0)
#define UNITYENGINE_LIGHT_SET_SHADOWRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EDFA850)
#define UNITYENGINE_LIGHT_SET_SHADOWSOFTNESSFADE_OFFSET UNITYSDK_OFFSET(0x1EDFA890)
#define UNITYENGINE_LIGHT_SET_SHADOWSOFTNESS_OFFSET UNITYSDK_OFFSET(0x1EDFA870)
#define UNITYENGINE_LIGHT_SET_SHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1EDFA830)
#define UNITYENGINE_LIGHT_SET_SHADOWS_OFFSET UNITYSDK_OFFSET(0x1EDFA810)
#define UNITYENGINE_LIGHT_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1EDFA3D0)
#define UNITYENGINE_LIGHT_SET_SPOTANGLE_OFFSET UNITYSDK_OFFSET(0x1EDFA3F0)
#define UNITYENGINE_LIGHT_SET_SPOTIESTEX_OFFSET UNITYSDK_OFFSET(0x1EDFA910)
#define UNITYENGINE_LIGHT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EDFA3B0)
#define UNITYENGINE_LIGHT_SET_USEBOUNDINGSPHEREOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA520)
#define UNITYENGINE_LIGHT_SET_USECOLORTEMPERATURE_OFFSET UNITYSDK_OFFSET(0x1EDFA4C0)
#define UNITYENGINE_LIGHT_SET_USESHADOWMATRIXOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EDFA630)
#define UNITYENGINE_LIGHT_SET_VCMASK_OFFSET UNITYSDK_OFFSET(0x1EDFADE0)
#define UNITYENGINE_LIGHT_UPDATELIGHTASYNCLOADEDDATA_OFFSET UNITYSDK_OFFSET(0x1EDFAEF0)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATAAREA_OFFSET UNITYSDK_OFFSET(0x1EDFAE70)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATACOMMON_OFFSET UNITYSDK_OFFSET(0x1EDFAE10)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATADEBUG_OFFSET UNITYSDK_OFFSET(0x1EDFAE80)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATAFADE_OFFSET UNITYSDK_OFFSET(0x1EDFAE90)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATALOCAL2_OFFSET UNITYSDK_OFFSET(0x1EDFAE50)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATALOCALSPOT_OFFSET UNITYSDK_OFFSET(0x1EDFAE60)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATALOCAL_OFFSET UNITYSDK_OFFSET(0x1EDFAE40)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATASPOT_OFFSET UNITYSDK_OFFSET(0x1EDFAE30)
#define UNITYENGINE_LIGHT_UPDATELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1EDFADF0)
#define UNITYENGINE_LIGHT_UPDATELIGHTMESHSTENCIL_OFFSET UNITYSDK_OFFSET(0x1EDFAE20)
#define UNITYENGINE_LIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDFAF60)

namespace UnityEngine
{
	inline static constexpr unsigned int Light_TypeDefinitionIndex = 4144;
	...
	public:
		...
		{
			return (::UnityEngine::Light_OnParticleLightEvent**)Il2CppClass::FromTypeDefinitionIndex(Light_TypeDefinitionIndex)->GetStaticField(0x117E0);
		}
