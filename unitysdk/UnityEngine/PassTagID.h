...
#define UNITYENGINE_PASSTAGID_INITPASSTAG_1_OFFSET UNITYSDK_OFFSET(0x1D11DC90)
#define UNITYENGINE_PASSTAGID_INITPASSTAG_OFFSET UNITYSDK_OFFSET(0x3AD43A0)
#define UNITYENGINE_PASSTAGID__CTOR_OFFSET UNITYSDK_OFFSET(0x38FA990)

namespace UnityEngine
{
	inline static constexpr unsigned int PassTagID_TypeDefinitionIndex = 4244;
