...
#define UNITYENGINE_TEXTURE2DARRAY_APPLYIMPL_OFFSET UNITYSDK_OFFSET(0x1D4FF540)
#define UNITYENGINE_TEXTURE2DARRAY_APPLY_OFFSET UNITYSDK_OFFSET(0x1D4FFA50)
#define UNITYENGINE_TEXTURE2DARRAY_GET_ALLSLICES_OFFSET UNITYSDK_OFFSET(0x1D4FF440)
#define UNITYENGINE_TEXTURE2DARRAY_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1D4FF450)
#define UNITYENGINE_TEXTURE2DARRAY_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1D4FF460)
#define UNITYENGINE_TEXTURE2DARRAY_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1D4FF470)
#define UNITYENGINE_TEXTURE2DARRAY_INTERNAL_CREATEIMPL_OFFSET UNITYSDK_OFFSET(0x1D4FF480)
#define UNITYENGINE_TEXTURE2DARRAY_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1D4FF490)
#define UNITYENGINE_TEXTURE2DARRAY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D4FF600)
#define UNITYENGINE_TEXTURE2DARRAY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D4FF690)
#define UNITYENGINE_TEXTURE2DARRAY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D4FF810)
#define UNITYENGINE_TEXTURE2DARRAY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1D4FF9C0)
#define UNITYENGINE_TEXTURE2DARRAY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1D4FFA10)
#define UNITYENGINE_TEXTURE2DARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FF550)
