...
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5362E0)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C536310)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C535F90)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5362D0)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteSettings_UpdatedEventHandler_TypeDefinitionIndex = 84220;
