...
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FC43B30)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FC43B60)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FC437E0)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC43B10)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteSettings_UpdatedEventHandler_TypeDefinitionIndex = 93730;
