...
#define UNITYENGINE_CHARACTERCONTROLLER_GET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7B1010)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1B7B0FC0)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_COLLISIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1B7B0F70)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_DETECTCOLLISIONS_OFFSET UNITYSDK_OFFSET(0x1B7B10C0)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_ENABLEOVERLAPRECOVERY_OFFSET UNITYSDK_OFFSET(0x1B7B10E0)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1B7B0FA0)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_ISGROUNDED_OFFSET UNITYSDK_OFFSET(0x1B7B0F60)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_MINMOVEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B7B10A0)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B7B0F80)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_SKINWIDTH_OFFSET UNITYSDK_OFFSET(0x1B7B1080)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_SLOPELIMIT_OFFSET UNITYSDK_OFFSET(0x1B7B1040)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_STEPOFFSET_OFFSET UNITYSDK_OFFSET(0x1B7B1060)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_VELOCITY_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7B0F50)
#define UNITYENGINE_CHARACTERCONTROLLER_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x1B7B0F00)
#define UNITYENGINE_CHARACTERCONTROLLER_MOVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7B0EF0)
#define UNITYENGINE_CHARACTERCONTROLLER_MOVE_OFFSET UNITYSDK_OFFSET(0x1B7B0EE0)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7B1030)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x1B7B1020)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_DETECTCOLLISIONS_OFFSET UNITYSDK_OFFSET(0x1B7B10D0)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_ENABLEOVERLAPRECOVERY_OFFSET UNITYSDK_OFFSET(0x1B7B10F0)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1B7B0FB0)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_MINMOVEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B7B10B0)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B7B0F90)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_SKINWIDTH_OFFSET UNITYSDK_OFFSET(0x1B7B1090)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_SLOPELIMIT_OFFSET UNITYSDK_OFFSET(0x1B7B1050)
#define UNITYENGINE_CHARACTERCONTROLLER_SET_STEPOFFSET_OFFSET UNITYSDK_OFFSET(0x1B7B1070)
#define UNITYENGINE_CHARACTERCONTROLLER_SIMPLEMOVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7B0ED0)
#define UNITYENGINE_CHARACTERCONTROLLER_SIMPLEMOVE_OFFSET UNITYSDK_OFFSET(0x1B7B0EC0)
#define UNITYENGINE_CHARACTERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B1100)
