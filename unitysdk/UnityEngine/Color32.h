...
#define UNITYENGINE_COLOR32_LERP_OFFSET UNITYSDK_OFFSET(0x1A430F60)
#define UNITYENGINE_COLOR32_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A430F10)
#define UNITYENGINE_COLOR32_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A430BA0)
#define UNITYENGINE_COLOR32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22E34F0)
#define UNITYENGINE_COLOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x22E34D0)

namespace UnityEngine
{
	inline static constexpr unsigned int Color32_TypeDefinitionIndex = 4028;
