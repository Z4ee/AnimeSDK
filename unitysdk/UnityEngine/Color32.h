...
#define UNITYENGINE_COLOR32_LERP_OFFSET UNITYSDK_OFFSET(0x1C166C80)
#define UNITYENGINE_COLOR32_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1C166C30)
#define UNITYENGINE_COLOR32_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C1668C0)
#define UNITYENGINE_COLOR32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A8C460)
#define UNITYENGINE_COLOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x3A8C440)

namespace UnityEngine
{
	inline static constexpr unsigned int Color32_TypeDefinitionIndex = 4207;
