...
#define UNITYENGINE_COLOR32_LERP_OFFSET UNITYSDK_OFFSET(0x1DEC8340)
#define UNITYENGINE_COLOR32_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1DEC82F0)
#define UNITYENGINE_COLOR32_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1DEC7F80)
#define UNITYENGINE_COLOR32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3C22FC0)
#define UNITYENGINE_COLOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x3C22FA0)
