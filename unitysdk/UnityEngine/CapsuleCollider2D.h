...
#define UNITYENGINE_CAPSULECOLLIDER2D_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1DF87E00)
#define UNITYENGINE_CAPSULECOLLIDER2D_SET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF87DF0)
#define UNITYENGINE_CAPSULECOLLIDER2D_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1DF87DD0)
#define UNITYENGINE_CAPSULECOLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF87E10)

namespace UnityEngine
{
	inline static constexpr unsigned int CapsuleCollider2D_TypeDefinitionIndex = 18389;
