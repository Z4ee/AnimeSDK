...
#define UNITYENGINE_CAPSULECOLLIDER2D_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1BC4AA90)
#define UNITYENGINE_CAPSULECOLLIDER2D_SET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1BC4AA80)
#define UNITYENGINE_CAPSULECOLLIDER2D_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1BC4AA60)
#define UNITYENGINE_CAPSULECOLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC4AAA0)

namespace UnityEngine
{
	inline static constexpr unsigned int CapsuleCollider2D_TypeDefinitionIndex = 7638;
