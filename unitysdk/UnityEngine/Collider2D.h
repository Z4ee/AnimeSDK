...
#define UNITYENGINE_COLLIDER2D_CASTARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF89A80)
#define UNITYENGINE_COLLIDER2D_CASTARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1DF89660)
#define UNITYENGINE_COLLIDER2D_CASTLIST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF89B10)
#define UNITYENGINE_COLLIDER2D_CASTLIST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1DF89AE0)
#define UNITYENGINE_COLLIDER2D_CAST_1_OFFSET UNITYSDK_OFFSET(0x1DF89690)
#define UNITYENGINE_COLLIDER2D_CAST_2_OFFSET UNITYSDK_OFFSET(0x1DF89810)
#define UNITYENGINE_COLLIDER2D_CAST_3_OFFSET UNITYSDK_OFFSET(0x1DF89990)
#define UNITYENGINE_COLLIDER2D_CAST_4_OFFSET UNITYSDK_OFFSET(0x1DF899E0)
#define UNITYENGINE_COLLIDER2D_CAST_5_OFFSET UNITYSDK_OFFSET(0x1DF89A30)
#define UNITYENGINE_COLLIDER2D_CAST_6_OFFSET UNITYSDK_OFFSET(0x1DF89A90)
#define UNITYENGINE_COLLIDER2D_CAST_OFFSET UNITYSDK_OFFSET(0x1DF89450)
#define UNITYENGINE_COLLIDER2D_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1DF8A1E0)
#define UNITYENGINE_COLLIDER2D_CREATEMESH_OFFSET UNITYSDK_OFFSET(0x1DF87FF0)
#define UNITYENGINE_COLLIDER2D_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1DF881D0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1DF888F0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_2_OFFSET UNITYSDK_OFFSET(0x1DF88B10)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_3_OFFSET UNITYSDK_OFFSET(0x1DF88C50)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_4_OFFSET UNITYSDK_OFFSET(0x1DF88D90)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_5_OFFSET UNITYSDK_OFFSET(0x1DF88FB0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_6_OFFSET UNITYSDK_OFFSET(0x1DF891D0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_7_OFFSET UNITYSDK_OFFSET(0x1DF89310)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1DF88680)
#define UNITYENGINE_COLLIDER2D_GETSHAPEHASH_OFFSET UNITYSDK_OFFSET(0x1DF88000)
#define UNITYENGINE_COLLIDER2D_GET_ATTACHEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1DF87FD0)
#define UNITYENGINE_COLLIDER2D_GET_BOUNCINESS_OFFSET UNITYSDK_OFFSET(0x1DF880C0)
#define UNITYENGINE_COLLIDER2D_GET_BOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF88060)
#define UNITYENGINE_COLLIDER2D_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1DF88010)
#define UNITYENGINE_COLLIDER2D_GET_COMPOSITECAPABLE_OFFSET UNITYSDK_OFFSET(0x1DF88080)
#define UNITYENGINE_COLLIDER2D_GET_COMPOSITE_OFFSET UNITYSDK_OFFSET(0x1DF87F50)
#define UNITYENGINE_COLLIDER2D_GET_DENSITY_OFFSET UNITYSDK_OFFSET(0x1DF87ED0)
#define UNITYENGINE_COLLIDER2D_GET_ERRORSTATE_OFFSET UNITYSDK_OFFSET(0x1DF88070)
#define UNITYENGINE_COLLIDER2D_GET_FRICTION_OFFSET UNITYSDK_OFFSET(0x1DF880B0)
#define UNITYENGINE_COLLIDER2D_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1DF87EF0)
#define UNITYENGINE_COLLIDER2D_GET_OFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF87F90)
#define UNITYENGINE_COLLIDER2D_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1DF87F60)
#define UNITYENGINE_COLLIDER2D_GET_SHAPECOUNT_OFFSET UNITYSDK_OFFSET(0x1DF87FE0)
#define UNITYENGINE_COLLIDER2D_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DF88090)
#define UNITYENGINE_COLLIDER2D_GET_USEDBYCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1DF87F30)
#define UNITYENGINE_COLLIDER2D_GET_USEDBYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF87F10)
#define UNITYENGINE_COLLIDER2D_ISTOUCHINGLAYERS_1_OFFSET UNITYSDK_OFFSET(0x1DF88190)
#define UNITYENGINE_COLLIDER2D_ISTOUCHINGLAYERS_OFFSET UNITYSDK_OFFSET(0x1DF88180)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_1_OFFSET UNITYSDK_OFFSET(0x1DF880E0)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_2_OFFSET UNITYSDK_OFFSET(0x1DF88130)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_ANYCOLLIDERWITHFILTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF88170)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_ANYCOLLIDERWITHFILTER_OFFSET UNITYSDK_OFFSET(0x1DF88160)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_OFFSET UNITYSDK_OFFSET(0x1DF880D0)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_OTHERCOLLIDERWITHFILTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF88120)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_OTHERCOLLIDERWITHFILTER_OFFSET UNITYSDK_OFFSET(0x1DF88110)
#define UNITYENGINE_COLLIDER2D_OVERLAPCOLLIDER_1_OFFSET UNITYSDK_OFFSET(0x1DF88620)
#define UNITYENGINE_COLLIDER2D_OVERLAPCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1DF885C0)
#define UNITYENGINE_COLLIDER2D_OVERLAPPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF881C0)
#define UNITYENGINE_COLLIDER2D_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x1DF881A0)
#define UNITYENGINE_COLLIDER2D_RAYCASTARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF8A150)
#define UNITYENGINE_COLLIDER2D_RAYCASTARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1DF89CB0)
#define UNITYENGINE_COLLIDER2D_RAYCASTLIST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF8A1D0)
#define UNITYENGINE_COLLIDER2D_RAYCASTLIST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1DF8A1A0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1DF89CE0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_2_OFFSET UNITYSDK_OFFSET(0x1DF89DC0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_3_OFFSET UNITYSDK_OFFSET(0x1DF89EB0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_4_OFFSET UNITYSDK_OFFSET(0x1DF89FB0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_5_OFFSET UNITYSDK_OFFSET(0x1DF8A0D0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_6_OFFSET UNITYSDK_OFFSET(0x1DF8A110)
#define UNITYENGINE_COLLIDER2D_RAYCAST_7_OFFSET UNITYSDK_OFFSET(0x1DF8A160)
#define UNITYENGINE_COLLIDER2D_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1DF89B20)
#define UNITYENGINE_COLLIDER2D_SET_DENSITY_OFFSET UNITYSDK_OFFSET(0x1DF87EE0)
#define UNITYENGINE_COLLIDER2D_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1DF87F00)
#define UNITYENGINE_COLLIDER2D_SET_OFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF87FC0)
#define UNITYENGINE_COLLIDER2D_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1DF87FA0)
#define UNITYENGINE_COLLIDER2D_SET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DF880A0)
#define UNITYENGINE_COLLIDER2D_SET_USEDBYCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1DF87F40)
#define UNITYENGINE_COLLIDER2D_SET_USEDBYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF87F20)
#define UNITYENGINE_COLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF87D80)

namespace UnityEngine
{
	inline static constexpr unsigned int Collider2D_TypeDefinitionIndex = 18387;
