...
#define UNITYENGINE_COLLIDER2D_CASTARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C0050)
#define UNITYENGINE_COLLIDER2D_CASTARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3BFC20)
#define UNITYENGINE_COLLIDER2D_CASTLIST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C00E0)
#define UNITYENGINE_COLLIDER2D_CASTLIST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C00B0)
#define UNITYENGINE_COLLIDER2D_CAST_1_OFFSET UNITYSDK_OFFSET(0x1F3BFC50)
#define UNITYENGINE_COLLIDER2D_CAST_2_OFFSET UNITYSDK_OFFSET(0x1F3BFDD0)
#define UNITYENGINE_COLLIDER2D_CAST_3_OFFSET UNITYSDK_OFFSET(0x1F3BFF60)
#define UNITYENGINE_COLLIDER2D_CAST_4_OFFSET UNITYSDK_OFFSET(0x1F3BFFB0)
#define UNITYENGINE_COLLIDER2D_CAST_5_OFFSET UNITYSDK_OFFSET(0x1F3C0000)
#define UNITYENGINE_COLLIDER2D_CAST_6_OFFSET UNITYSDK_OFFSET(0x1F3C0060)
#define UNITYENGINE_COLLIDER2D_CAST_OFFSET UNITYSDK_OFFSET(0x1F3BFA10)
#define UNITYENGINE_COLLIDER2D_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1F3C07B0)
#define UNITYENGINE_COLLIDER2D_CREATEMESH_OFFSET UNITYSDK_OFFSET(0x1F3BE5B0)
#define UNITYENGINE_COLLIDER2D_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1F3BE790)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1F3BEEB0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_2_OFFSET UNITYSDK_OFFSET(0x1F3BF0D0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_3_OFFSET UNITYSDK_OFFSET(0x1F3BF210)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_4_OFFSET UNITYSDK_OFFSET(0x1F3BF350)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_5_OFFSET UNITYSDK_OFFSET(0x1F3BF570)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_6_OFFSET UNITYSDK_OFFSET(0x1F3BF790)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_7_OFFSET UNITYSDK_OFFSET(0x1F3BF8D0)
#define UNITYENGINE_COLLIDER2D_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1F3BEC40)
#define UNITYENGINE_COLLIDER2D_GETSHAPEHASH_OFFSET UNITYSDK_OFFSET(0x1F3BE5C0)
#define UNITYENGINE_COLLIDER2D_GET_ATTACHEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1F3BE590)
#define UNITYENGINE_COLLIDER2D_GET_BOUNCINESS_OFFSET UNITYSDK_OFFSET(0x1F3BE680)
#define UNITYENGINE_COLLIDER2D_GET_BOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3BE620)
#define UNITYENGINE_COLLIDER2D_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1F3BE5D0)
#define UNITYENGINE_COLLIDER2D_GET_COMPOSITECAPABLE_OFFSET UNITYSDK_OFFSET(0x1F3BE640)
#define UNITYENGINE_COLLIDER2D_GET_COMPOSITE_OFFSET UNITYSDK_OFFSET(0x1F3BE510)
#define UNITYENGINE_COLLIDER2D_GET_DENSITY_OFFSET UNITYSDK_OFFSET(0x1F3BE490)
#define UNITYENGINE_COLLIDER2D_GET_ERRORSTATE_OFFSET UNITYSDK_OFFSET(0x1F3BE630)
#define UNITYENGINE_COLLIDER2D_GET_FRICTION_OFFSET UNITYSDK_OFFSET(0x1F3BE670)
#define UNITYENGINE_COLLIDER2D_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1F3BE4B0)
#define UNITYENGINE_COLLIDER2D_GET_OFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3BE550)
#define UNITYENGINE_COLLIDER2D_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1F3BE520)
#define UNITYENGINE_COLLIDER2D_GET_SHAPECOUNT_OFFSET UNITYSDK_OFFSET(0x1F3BE5A0)
#define UNITYENGINE_COLLIDER2D_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F3BE650)
#define UNITYENGINE_COLLIDER2D_GET_USEDBYCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1F3BE4F0)
#define UNITYENGINE_COLLIDER2D_GET_USEDBYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3BE4D0)
#define UNITYENGINE_COLLIDER2D_ISTOUCHINGLAYERS_1_OFFSET UNITYSDK_OFFSET(0x1F3BE750)
#define UNITYENGINE_COLLIDER2D_ISTOUCHINGLAYERS_OFFSET UNITYSDK_OFFSET(0x1F3BE740)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_1_OFFSET UNITYSDK_OFFSET(0x1F3BE6A0)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_2_OFFSET UNITYSDK_OFFSET(0x1F3BE6F0)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_ANYCOLLIDERWITHFILTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3BE730)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_ANYCOLLIDERWITHFILTER_OFFSET UNITYSDK_OFFSET(0x1F3BE720)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_OFFSET UNITYSDK_OFFSET(0x1F3BE690)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_OTHERCOLLIDERWITHFILTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3BE6E0)
#define UNITYENGINE_COLLIDER2D_ISTOUCHING_OTHERCOLLIDERWITHFILTER_OFFSET UNITYSDK_OFFSET(0x1F3BE6D0)
#define UNITYENGINE_COLLIDER2D_OVERLAPCOLLIDER_1_OFFSET UNITYSDK_OFFSET(0x1F3BEBE0)
#define UNITYENGINE_COLLIDER2D_OVERLAPCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1F3BEB80)
#define UNITYENGINE_COLLIDER2D_OVERLAPPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3BE780)
#define UNITYENGINE_COLLIDER2D_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x1F3BE760)
#define UNITYENGINE_COLLIDER2D_RAYCASTARRAY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C0720)
#define UNITYENGINE_COLLIDER2D_RAYCASTARRAY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C0280)
#define UNITYENGINE_COLLIDER2D_RAYCASTLIST_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3C07A0)
#define UNITYENGINE_COLLIDER2D_RAYCASTLIST_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C0770)
#define UNITYENGINE_COLLIDER2D_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1F3C02B0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_2_OFFSET UNITYSDK_OFFSET(0x1F3C0390)
#define UNITYENGINE_COLLIDER2D_RAYCAST_3_OFFSET UNITYSDK_OFFSET(0x1F3C0480)
#define UNITYENGINE_COLLIDER2D_RAYCAST_4_OFFSET UNITYSDK_OFFSET(0x1F3C0580)
#define UNITYENGINE_COLLIDER2D_RAYCAST_5_OFFSET UNITYSDK_OFFSET(0x1F3C06A0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_6_OFFSET UNITYSDK_OFFSET(0x1F3C06E0)
#define UNITYENGINE_COLLIDER2D_RAYCAST_7_OFFSET UNITYSDK_OFFSET(0x1F3C0730)
#define UNITYENGINE_COLLIDER2D_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1F3C00F0)
#define UNITYENGINE_COLLIDER2D_SET_DENSITY_OFFSET UNITYSDK_OFFSET(0x1F3BE4A0)
#define UNITYENGINE_COLLIDER2D_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1F3BE4C0)
#define UNITYENGINE_COLLIDER2D_SET_OFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F3BE580)
#define UNITYENGINE_COLLIDER2D_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1F3BE560)
#define UNITYENGINE_COLLIDER2D_SET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F3BE660)
#define UNITYENGINE_COLLIDER2D_SET_USEDBYCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1F3BE500)
#define UNITYENGINE_COLLIDER2D_SET_USEDBYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3BE4E0)
#define UNITYENGINE_COLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3BE340)

namespace UnityEngine
{
	inline static constexpr unsigned int Collider2D_TypeDefinitionIndex = 18793;
