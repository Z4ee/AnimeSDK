...
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_CHANGETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EABC510)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_GRASSVOLUMEHASINIT_OFFSET UNITYSDK_OFFSET(0x1EABC500)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_REMOVEGRASSVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x1EABC4F0)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_SETGRASSBLOCKDATA_OFFSET UNITYSDK_OFFSET(0x1EABC4E0)
