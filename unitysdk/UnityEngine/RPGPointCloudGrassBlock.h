...
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_CHANGETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ED498F0)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_GRASSVOLUMEHASINIT_OFFSET UNITYSDK_OFFSET(0x1ED498E0)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_REMOVEGRASSVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x1ED498D0)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_SETGRASSBLOCKDATA_OFFSET UNITYSDK_OFFSET(0x1ED498C0)

namespace UnityEngine
{
	inline static constexpr unsigned int RPGPointCloudGrassBlock_TypeDefinitionIndex = 4282;
