...
#define UNITYENGINE_SQLITE3_BACKUPFINISH_OFFSET UNITYSDK_OFFSET(0x1B0C9190)
#define UNITYENGINE_SQLITE3_BACKUPINIT_OFFSET UNITYSDK_OFFSET(0x1B0C9170)
#define UNITYENGINE_SQLITE3_BACKUPSTEP_OFFSET UNITYSDK_OFFSET(0x1B0C9180)
#define UNITYENGINE_SQLITE3_BINDBLOB_OFFSET UNITYSDK_OFFSET(0x1B0C8EB0)
#define UNITYENGINE_SQLITE3_BINDDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B0C8E90)
#define UNITYENGINE_SQLITE3_BINDINT64_OFFSET UNITYSDK_OFFSET(0x1B0C8E80)
#define UNITYENGINE_SQLITE3_BINDINT_OFFSET UNITYSDK_OFFSET(0x1B0C8E70)
#define UNITYENGINE_SQLITE3_BINDNULL_OFFSET UNITYSDK_OFFSET(0x1B0C8E60)
#define UNITYENGINE_SQLITE3_BINDPARAMETERINDEX_OFFSET UNITYSDK_OFFSET(0x1B0C8E50)
#define UNITYENGINE_SQLITE3_BINDTEXT_OFFSET UNITYSDK_OFFSET(0x1B0C8EA0)
#define UNITYENGINE_SQLITE3_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B0C8CF0)
#define UNITYENGINE_SQLITE3_CHANGES_OFFSET UNITYSDK_OFFSET(0x1B0C8D00)
#define UNITYENGINE_SQLITE3_CLOSE2_OFFSET UNITYSDK_OFFSET(0x1B0C8CE0)
#define UNITYENGINE_SQLITE3_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B0C8CD0)
#define UNITYENGINE_SQLITE3_COLUMNBLOB_OFFSET UNITYSDK_OFFSET(0x1B0C8FE0)
#define UNITYENGINE_SQLITE3_COLUMNBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1B0C90B0)
#define UNITYENGINE_SQLITE3_COLUMNBYTES_OFFSET UNITYSDK_OFFSET(0x1B0C8FF0)
#define UNITYENGINE_SQLITE3_COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0x1B0C8EC0)
#define UNITYENGINE_SQLITE3_COLUMNDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B0C8FC0)
#define UNITYENGINE_SQLITE3_COLUMNINT64_OFFSET UNITYSDK_OFFSET(0x1B0C8FB0)
#define UNITYENGINE_SQLITE3_COLUMNINT_OFFSET UNITYSDK_OFFSET(0x1B0C8FA0)
#define UNITYENGINE_SQLITE3_COLUMNNAME16INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B0C8ED0)
#define UNITYENGINE_SQLITE3_COLUMNNAME16_OFFSET UNITYSDK_OFFSET(0x1B0C8EE0)
#define UNITYENGINE_SQLITE3_COLUMNSTRING_OFFSET UNITYSDK_OFFSET(0x1B0C9000)
#define UNITYENGINE_SQLITE3_COLUMNTEXT16_OFFSET UNITYSDK_OFFSET(0x1B0C8FD0)
#define UNITYENGINE_SQLITE3_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1B0C8F90)
#define UNITYENGINE_SQLITE3_ENABLELOADEXTENSION_OFFSET UNITYSDK_OFFSET(0x1B0C8CC0)
#define UNITYENGINE_SQLITE3_ERRMSG_OFFSET UNITYSDK_OFFSET(0x1B0C8D90)
#define UNITYENGINE_SQLITE3_EXTENDEDERRCODE_OFFSET UNITYSDK_OFFSET(0x1B0C9150)
#define UNITYENGINE_SQLITE3_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C8D70)
#define UNITYENGINE_SQLITE3_GETERRMSG_OFFSET UNITYSDK_OFFSET(0x1B0C8DA0)
#define UNITYENGINE_SQLITE3_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1B0C9140)
#define UNITYENGINE_SQLITE3_LASTINSERTROWID_OFFSET UNITYSDK_OFFSET(0x1B0C8D80)
#define UNITYENGINE_SQLITE3_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1B0C9160)
#define UNITYENGINE_SQLITE3_OPEN_1_OFFSET UNITYSDK_OFFSET(0x1B0C8C40)
#define UNITYENGINE_SQLITE3_OPEN_2_OFFSET UNITYSDK_OFFSET(0x1B0C8C80)
#define UNITYENGINE_SQLITE3_OPEN_OFFSET UNITYSDK_OFFSET(0x1B0C8C30)
#define UNITYENGINE_SQLITE3_OPEN_V2_OFFSET UNITYSDK_OFFSET(0x1B0C8C70)
#define UNITYENGINE_SQLITE3_PREPARE2_OFFSET UNITYSDK_OFFSET(0x1B0C8D20)
#define UNITYENGINE_SQLITE3_PREPARE_V2_OFFSET UNITYSDK_OFFSET(0x1B0C8D10)
#define UNITYENGINE_SQLITE3_RESET_OFFSET UNITYSDK_OFFSET(0x1B0C8D60)
#define UNITYENGINE_SQLITE3_STEP_OFFSET UNITYSDK_OFFSET(0x1B0C8D50)
#define UNITYENGINE_SQLITE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C91A0)
