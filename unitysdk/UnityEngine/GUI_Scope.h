...
#define UNITYENGINE_GUI_SCOPE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E424100)
#define UNITYENGINE_GUI_SCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E423E90)
#define UNITYENGINE_GUI_SCOPE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E423F70)
#define UNITYENGINE_GUI_SCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4241B0)

namespace UnityEngine
{
	inline static constexpr unsigned int GUI_Scope_TypeDefinitionIndex = 6405;
