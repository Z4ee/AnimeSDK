...
#define UNITYENGINE_JOINT_GET_CONNECTEDBODY_OFFSET UNITYSDK_OFFSET(0x1DB2CAC0)
#define UNITYENGINE_JOINT_SET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DB2CAE0)
#define UNITYENGINE_JOINT_SET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1DB2CAD0)
#define UNITYENGINE_JOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB2CAF0)

namespace UnityEngine
{
	inline static constexpr unsigned int Joint_TypeDefinitionIndex = 7722;
