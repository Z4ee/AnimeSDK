...
#define UNITYENGINE_SDFUTILS_GETSECTORCOORDHASH_OFFSET UNITYSDK_OFFSET(0x1BFAE1C0)

namespace UnityEngine
{
	inline static constexpr unsigned int SDFUtils_TypeDefinitionIndex = 4254;
