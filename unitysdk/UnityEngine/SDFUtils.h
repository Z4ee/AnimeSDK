...
#define UNITYENGINE_SDFUTILS_GETSECTORCOORDHASH_OFFSET UNITYSDK_OFFSET(0x1ED62520)

namespace UnityEngine
{
	inline static constexpr unsigned int SDFUtils_TypeDefinitionIndex = 4264;
