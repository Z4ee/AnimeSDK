...
#define UNITYENGINE_COLLISION2D_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1F3C1480)
#define UNITYENGINE_COLLISION2D_GETCONTACTS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1F3C0A10)
#define UNITYENGINE_COLLISION2D_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1F3C13F0)
#define UNITYENGINE_COLLISION2D_GETCONTACT_OFFSET UNITYSDK_OFFSET(0x1F3C12E0)
#define UNITYENGINE_COLLISION2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1F3C0A20)
#define UNITYENGINE_COLLISION2D_GET_CONTACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1F3C12D0)
#define UNITYENGINE_COLLISION2D_GET_CONTACTS_OFFSET UNITYSDK_OFFSET(0x1F3C1260)
#define UNITYENGINE_COLLISION2D_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1F3C1250)
#define UNITYENGINE_COLLISION2D_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F3C0F60)
#define UNITYENGINE_COLLISION2D_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1F3C0AC0)
#define UNITYENGINE_COLLISION2D_GET_OTHERRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1F3C0BF0)
#define UNITYENGINE_COLLISION2D_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1F3C1240)
#define UNITYENGINE_COLLISION2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1F3C0B60)
#define UNITYENGINE_COLLISION2D_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F3C0C80)
#define UNITYENGINE_COLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3C1520)

namespace UnityEngine
{
	inline static constexpr unsigned int Collision2D_TypeDefinitionIndex = 18789;
