...
#define UNITYENGINE_COLLISION2D_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1DF8AEB0)
#define UNITYENGINE_COLLISION2D_GETCONTACTS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1DF8A440)
#define UNITYENGINE_COLLISION2D_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1DF8AE20)
#define UNITYENGINE_COLLISION2D_GETCONTACT_OFFSET UNITYSDK_OFFSET(0x1DF8AD10)
#define UNITYENGINE_COLLISION2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1DF8A450)
#define UNITYENGINE_COLLISION2D_GET_CONTACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1DF8AD00)
#define UNITYENGINE_COLLISION2D_GET_CONTACTS_OFFSET UNITYSDK_OFFSET(0x1DF8AC90)
#define UNITYENGINE_COLLISION2D_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1DF8AC80)
#define UNITYENGINE_COLLISION2D_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DF8A990)
#define UNITYENGINE_COLLISION2D_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1DF8A4F0)
#define UNITYENGINE_COLLISION2D_GET_OTHERRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1DF8A620)
#define UNITYENGINE_COLLISION2D_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1DF8AC70)
#define UNITYENGINE_COLLISION2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1DF8A590)
#define UNITYENGINE_COLLISION2D_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DF8A6B0)
#define UNITYENGINE_COLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF8AF50)

namespace UnityEngine
{
	inline static constexpr unsigned int Collision2D_TypeDefinitionIndex = 18383;
