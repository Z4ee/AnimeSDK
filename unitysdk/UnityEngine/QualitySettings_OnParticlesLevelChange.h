...
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DA9B6F0)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DA9B780)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DA9B3B0)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA9B390)
