...
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B747020)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7470B0)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B746CE0)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B746CD0)

namespace UnityEngine
{
	inline static constexpr unsigned int QualitySettings_OnParticlesLevelChange_TypeDefinitionIndex = 5193;
