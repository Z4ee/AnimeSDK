...
#define UNITYENGINE_BOUNDINGSPHERE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1682A10)
#define UNITYENGINE_BOUNDINGSPHERE__CTOR_OFFSET UNITYSDK_OFFSET(0x24650)

namespace UnityEngine
{
	inline static constexpr unsigned int BoundingSphere_TypeDefinitionIndex = 3859;
