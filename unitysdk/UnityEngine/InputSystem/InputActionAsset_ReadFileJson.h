...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_READFILEJSON_TOASSET_OFFSET UNITYSDK_OFFSET(0x979AB0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset_ReadFileJson_TypeDefinitionIndex = 32151;
