...
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLERWINDOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D74BD00)

namespace UnityEngine::InputSystem::XInput
{
	inline static constexpr unsigned int XInputControllerWindows_TypeDefinitionIndex = 31746;
