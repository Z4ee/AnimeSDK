...
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AFA3C20)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1AFA3BD0)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_GET_MENU_OFFSET UNITYSDK_OFFSET(0x1AFA3B00)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_GET_SUBTYPE_OFFSET UNITYSDK_OFFSET(0x1AFA3B40)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0x1AFA3B20)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_PARSECAPABILITIES_OFFSET UNITYSDK_OFFSET(0x1AFA3B90)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_SET_MENU_OFFSET UNITYSDK_OFFSET(0x1AFA3B10)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER_SET_VIEW_OFFSET UNITYSDK_OFFSET(0x1AFA3B30)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFA3C50)

namespace UnityEngine::InputSystem::XInput
{
	inline static constexpr unsigned int XInputController_TypeDefinitionIndex = 29085;

	class XInputController : public ::UnityEngine::InputSystem::Gamepad
	{
	public:
		::UnityEngine::InputSystem::Controls::ButtonControl* _view_k__BackingField; // 0x1D8
		::UnityEngine::InputSystem::Controls::ButtonControl* _menu_k__BackingField; // 0x1E0
