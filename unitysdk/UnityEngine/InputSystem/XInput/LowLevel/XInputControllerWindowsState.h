...
#define UNITYENGINE_INPUTSYSTEM_XINPUT_LOWLEVEL_XINPUTCONTROLLERWINDOWSSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0xA68360)
#define UNITYENGINE_INPUTSYSTEM_XINPUT_LOWLEVEL_XINPUTCONTROLLERWINDOWSSTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0xA68370)

namespace UnityEngine::InputSystem::XInput::LowLevel
{
	inline static constexpr unsigned int XInputControllerWindowsState_TypeDefinitionIndex = 32368;
