...
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_BIND_OFFSET UNITYSDK_OFFSET(0x1B3FF260)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONCHANGEUSAGES_OFFSET UNITYSDK_OFFSET(0x1B3FFAC0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONCONNECTED_OFFSET UNITYSDK_OFFSET(0x1B3FF560)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1B3FF960)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONNEWDEVICE_OFFSET UNITYSDK_OFFSET(0x1B3FFA80)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONNEWEVENTS_OFFSET UNITYSDK_OFFSET(0x1B3FFAA0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONNEWLAYOUT_OFFSET UNITYSDK_OFFSET(0x1B3FFA90)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONREMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x1B3FFAB0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONSTARTSENDING_OFFSET UNITYSDK_OFFSET(0x1B3FFAD0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONSTOPSENDING_OFFSET UNITYSDK_OFFSET(0x1B3FFAE0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SENDTOSUBSCRIBERS_OFFSET UNITYSDK_OFFSET(0x1B3FF7C0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1B3FF5F0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B3FFC80)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONERROR_OFFSET UNITYSDK_OFFSET(0x1B3FFC70)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONNEXT_OFFSET UNITYSDK_OFFSET(0x1B3FFAF0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3FFCF0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FFC90)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int RemoteInputPlayerConnection_TypeDefinitionIndex = 29006;
	...
	public:
		...
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4CC0);
		}
		static ::System::Guid* StaticGet_kNewDeviceMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4CD0);
		}
		static ::System::Guid* StaticGet_kNewLayoutMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4CE0);
		}
		static ::System::Guid* StaticGet_kStartSendingMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4CF0);
		}
		static ::System::Guid* StaticGet_kRemoveDeviceMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4D00);
		}
		static ::System::Guid* StaticGet_kChangeUsagesMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4D10);
		}
		static ::System::Guid* StaticGet_kStopSendingMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4D20);
		}
