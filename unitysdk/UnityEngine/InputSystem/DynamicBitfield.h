...
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_BITCOUNTTOULONGCOUNT_OFFSET UNITYSDK_OFFSET(0x1DD02630)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_CLEARBIT_OFFSET UNITYSDK_OFFSET(0xA3CF70)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_SETBIT_OFFSET UNITYSDK_OFFSET(0xA3CEF0)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_SETLENGTH_OFFSET UNITYSDK_OFFSET(0xA3CEA0)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_TESTBIT_OFFSET UNITYSDK_OFFSET(0xA3CF40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int DynamicBitfield_TypeDefinitionIndex = 31711;
