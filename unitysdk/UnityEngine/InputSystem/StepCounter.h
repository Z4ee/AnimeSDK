...
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1BA6FC40)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BA6FBF0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_GET_STEPCOUNTER_OFFSET UNITYSDK_OFFSET(0x1BA6FBD0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1BA6FC10)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1BA6FC20)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BA6FC00)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_SET_STEPCOUNTER_OFFSET UNITYSDK_OFFSET(0x1BA6FBE0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA6FC90)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int StepCounter_TypeDefinitionIndex = 29020;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::StepCounter**)Il2CppClass::FromTypeDefinitionIndex(StepCounter_TypeDefinitionIndex)->GetStaticField(0x22790);
		}
