...
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1DDEE860)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DDEE810)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_GET_STEPCOUNTER_OFFSET UNITYSDK_OFFSET(0x1DDEE7F0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1DDEE830)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1DDEE840)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DDEE820)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_SET_STEPCOUNTER_OFFSET UNITYSDK_OFFSET(0x1DDEE800)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDEE8B0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int StepCounter_TypeDefinitionIndex = 31676;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::StepCounter**)Il2CppClass::FromTypeDefinitionIndex(StepCounter_TypeDefinitionIndex)->GetStaticField(0x26520);
		}
