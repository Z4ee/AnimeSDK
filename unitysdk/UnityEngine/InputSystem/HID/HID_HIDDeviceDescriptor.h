...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1EB011E0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0xA59360)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDDeviceDescriptor_TypeDefinitionIndex = 32414;
