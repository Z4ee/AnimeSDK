...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATEGLOBAL_GETPHYSICALMAX_OFFSET UNITYSDK_OFFSET(0x9699B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATEGLOBAL_GETPHYSICALMIN_OFFSET UNITYSDK_OFFSET(0x9698B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATEGLOBAL_GETUSAGEPAGE_OFFSET UNITYSDK_OFFSET(0x969830)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDItemStateGlobal_TypeDefinitionIndex = 29149;
