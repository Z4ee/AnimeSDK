...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_PARSEREPORTDESCRIPTOR_1_OFFSET UNITYSDK_OFFSET(0x1F80E960)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_PARSEREPORTDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1F80E8E0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_READDATA_OFFSET UNITYSDK_OFFSET(0x1F80FC20)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_TypeDefinitionIndex = 32421;
