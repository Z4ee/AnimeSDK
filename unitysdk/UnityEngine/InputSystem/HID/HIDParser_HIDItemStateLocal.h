...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_GETUSAGE_OFFSET UNITYSDK_OFFSET(0x9EB860)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_RESET_OFFSET UNITYSDK_OFFSET(0x1D3B80A0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_SETUSAGE_OFFSET UNITYSDK_OFFSET(0x9EB850)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDItemStateLocal_TypeDefinitionIndex = 31804;
