...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_GETUSAGE_OFFSET UNITYSDK_OFFSET(0x9493F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_RESET_OFFSET UNITYSDK_OFFSET(0x1AF8E4F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_SETUSAGE_OFFSET UNITYSDK_OFFSET(0x9493E0)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDItemStateLocal_TypeDefinitionIndex = 29148;
