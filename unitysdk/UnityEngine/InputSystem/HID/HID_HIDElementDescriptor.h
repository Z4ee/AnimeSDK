...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_ADDCHILDCONTROLS_OFFSET UNITYSDK_OFFSET(0x929980)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEAXISNORMALIZATIONPARAMETERS_OFFSET UNITYSDK_OFFSET(0x929850)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x9298C0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x9296F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEFORMAT_OFFSET UNITYSDK_OFFSET(0x929740)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINELAYOUT_OFFSET UNITYSDK_OFFSET(0x929730)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINENAME_OFFSET UNITYSDK_OFFSET(0x9296E0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x929840)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEPROCESSORS_OFFSET UNITYSDK_OFFSET(0x929860)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEUSAGES_OFFSET UNITYSDK_OFFSET(0x929830)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_HASNULLSTATE_OFFSET UNITYSDK_OFFSET(0x929520)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_HASPREFERREDSTATE_OFFSET UNITYSDK_OFFSET(0x929530)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x929540)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x929570)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISNONLINEAR_OFFSET UNITYSDK_OFFSET(0x929550)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISRELATIVE_OFFSET UNITYSDK_OFFSET(0x929560)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x929590)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISWRAPPING_OFFSET UNITYSDK_OFFSET(0x929580)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_MAXFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x929630)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_MINFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x9295A0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_ISUSABLEELEMENT_OFFSET UNITYSDK_OFFSET(0x929700)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_IS_OFFSET UNITYSDK_OFFSET(0x9296D0)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDElementDescriptor_TypeDefinitionIndex = 31792;
