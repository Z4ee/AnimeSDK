...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_GET_HIDDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D750D80)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_GET_QUERYHIDPARSEDREPORTDESCRIPTORDEVICECOMMANDTYPE_OFFSET UNITYSDK_OFFSET(0x1D750D70)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_GET_QUERYHIDREPORTDESCRIPTORDEVICECOMMANDTYPE_OFFSET UNITYSDK_OFFSET(0x1D750D50)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_GET_QUERYHIDREPORTDESCRIPTORSIZEDEVICECOMMANDTYPE_OFFSET UNITYSDK_OFFSET(0x1D750D60)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1D750E10)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_READHIDDEVICEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D7517C0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_USAGEPAGETOSTRING_OFFSET UNITYSDK_OFFSET(0x1D7522A0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_USAGETOSTRING_OFFSET UNITYSDK_OFFSET(0x1D752330)
#define UNITYENGINE_INPUTSYSTEM_HID_HID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7523D0)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_TypeDefinitionIndex = 31786;
