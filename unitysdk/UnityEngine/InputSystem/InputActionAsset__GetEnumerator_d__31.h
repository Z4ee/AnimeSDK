...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D73D3B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTACTION__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D73D4C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D73D520)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D73D4D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D73D3A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0x1D73D390)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset__GetEnumerator_d__31_TypeDefinitionIndex = 31533;
