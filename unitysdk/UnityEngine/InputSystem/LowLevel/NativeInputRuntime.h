...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ALLOCATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1B521D50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_DEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1B521E70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIMEFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B522810)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIMEOFFSETTOREALTIMESINCESTARTUP_OFFSET UNITYSDK_OFFSET(0x1B522880)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1B5227B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ISINBATCHMODE_OFFSET UNITYSDK_OFFSET(0x1B5229F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ISPLAYERFOCUSED_OFFSET UNITYSDK_OFFSET(0x1B522720)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B522000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1B5221E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONPLAYERFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1B522530)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONSHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1B5220F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1B522340)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B521F10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1B522730)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_RUNINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1B5228F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_SCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B5229E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_SCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1B5229B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_UNSCALEDGAMETIME_OFFSET UNITYSDK_OFFSET(0x1B5228E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1B522950)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1B522900)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONWANTSTOSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1B522920)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1B521E10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_REGISTERANALYTICSEVENT_OFFSET UNITYSDK_OFFSET(0x1B522A00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SENDANALYTICSEVENT_OFFSET UNITYSDK_OFFSET(0x1B522A10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B522010)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1B522280)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONPLAYERFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1B522540)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONSHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1B522100)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1B522350)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B521F20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1B522740)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B521DB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B522A30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B522A20)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int NativeInputRuntime_TypeDefinitionIndex = 29281;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::LowLevel::NativeInputRuntime**)Il2CppClass::FromTypeDefinitionIndex(NativeInputRuntime_TypeDefinitionIndex)->GetStaticField(0x22470);
		}
		::System::Action_1<::System::Boolean>* m_FocusChangedMethod; // 0x10
		::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* m_OnUpdate; // 0x18
		::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType, ::System::Boolean>* m_OnShouldRunUpdate; // 0x20
		::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* m_OnBeforeUpdate; // 0x28
		::System::Action* m_ShutdownMethod; // 0x30
		::System::Boolean m_DidCallOnShutdown; // 0x38
		::System::Single m_PollingFrequency; // 0x3C
