...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1D742FD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1D742F20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x1D742E60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA0A0B0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int TextEvent_TypeDefinitionIndex = 31927;
