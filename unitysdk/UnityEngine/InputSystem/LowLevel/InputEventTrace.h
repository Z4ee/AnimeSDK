...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ADD_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1B98CE40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1B98EA60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B98E930)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DISABLE_OFFSET UNITYSDK_OFFSET(0x1B98E510)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B98EAF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENABLE_OFFSET UNITYSDK_OFFSET(0x1B98E950)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B98D930)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GETNEXTEVENT_OFFSET UNITYSDK_OFFSET(0x1B98E8C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_ALLOCATEDSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B98CDB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x1B98CC90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_DEVICEINFOS_OFFSET UNITYSDK_OFFSET(0x1B98CDF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B98CCB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_EVENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B98CD90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_FRAMEMARKEREVENT_OFFSET UNITYSDK_OFFSET(0x1B98CC80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_KFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x1B98D920)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_MAXSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B98CDE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_M_EVENTBUFFERHEAD_OFFSET UNITYSDK_OFFSET(0x1B98E8B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_M_EVENTBUFFERTAIL_OFFSET UNITYSDK_OFFSET(0x1B98EA90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_M_EVENTBUFFER_OFFSET UNITYSDK_OFFSET(0x1B98CDD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_ONFILTEREVENT_OFFSET UNITYSDK_OFFSET(0x1B98CE20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_RECORDFRAMEMARKERS_OFFSET UNITYSDK_OFFSET(0x1B98CCC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_TOTALEVENTSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B98CDA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_LOADFROM_1_OFFSET UNITYSDK_OFFSET(0x1B98E3A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_LOADFROM_OFFSET UNITYSDK_OFFSET(0x1B98E220)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B98EBA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ONINPUTEVENT_OFFSET UNITYSDK_OFFSET(0x1B98ED00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_READFROM_1_OFFSET UNITYSDK_OFFSET(0x1B98DAE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_READFROM_OFFSET UNITYSDK_OFFSET(0x1B98D980)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B98EB50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REMOVE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1B98CE90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAY_OFFSET UNITYSDK_OFFSET(0x1B98E470)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_RESIZE_OFFSET UNITYSDK_OFFSET(0x1B98E630)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x1B98CCA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_M_EVENTBUFFERHEAD_OFFSET UNITYSDK_OFFSET(0x1B98E200)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_M_EVENTBUFFERTAIL_OFFSET UNITYSDK_OFFSET(0x1B98E210)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_M_EVENTBUFFER_OFFSET UNITYSDK_OFFSET(0x1B98E1F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_ONFILTEREVENT_OFFSET UNITYSDK_OFFSET(0x1B98CE30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_RECORDFRAMEMARKERS_OFFSET UNITYSDK_OFFSET(0x1B98CCD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B98EAA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_WRITETO_1_OFFSET UNITYSDK_OFFSET(0x1B98D160)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B98D000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B98F270)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B98CFB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B98CEE0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_TypeDefinitionIndex = 29262;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputEventTrace_TypeDefinitionIndex)->GetStaticField(0x4C70);
		}
