...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYDIMENSIONSCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1C0B3AA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYDIMENSIONSCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9C1E00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYDIMENSIONSCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C0B3A80)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryDimensionsCommand_TypeDefinitionIndex = 29198;
