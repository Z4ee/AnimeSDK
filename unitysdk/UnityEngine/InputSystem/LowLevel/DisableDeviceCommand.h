...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DISABLEDEVICECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1E39DE80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DISABLEDEVICECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA62470)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DISABLEDEVICECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E39DE60)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DisableDeviceCommand_TypeDefinitionIndex = 31844;
