...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_ALLOCATEALL_OFFSET UNITYSDK_OFFSET(0xA02200)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_COMPUTESIZEOFSINGLESTATEBUFFER_OFFSET UNITYSDK_OFFSET(0x1E0E3F00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_FREEALL_OFFSET UNITYSDK_OFFSET(0xA02210)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETBACKBUFFERFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1E0E3D60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETDOUBLEBUFFERSFOR_OFFSET UNITYSDK_OFFSET(0xA021F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETFRONTBUFFERFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1E0E3D20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATEALL_OFFSET UNITYSDK_OFFSET(0xA02310)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATEDOUBLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1E0E41E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATESINGLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1E0E4320)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_NEXTDEVICEOFFSET_OFFSET UNITYSDK_OFFSET(0x1E0E43D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_SETUPDEVICETOBUFFERMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1E0E3F60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1E0E3DA0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateBuffers_TypeDefinitionIndex = 32567;

	struct alignas(8) InputStateBuffers
	{
		static ::System::Void** StaticGet_s_ResetMaskBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C10);
		}
		static ::System::Void** StaticGet_s_NoiseMaskBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C18);
		}
		static ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers* StaticGet_s_CurrentBuffers()
		{
			return (::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers*)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C20);
		}
		static ::System::Void** StaticGet_s_DefaultStateBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C28);
		}
