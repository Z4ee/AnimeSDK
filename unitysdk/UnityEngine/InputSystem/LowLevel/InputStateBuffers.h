...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_ALLOCATEALL_OFFSET UNITYSDK_OFFSET(0x9B8D70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_COMPUTESIZEOFSINGLESTATEBUFFER_OFFSET UNITYSDK_OFFSET(0x1CD2A890)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_FREEALL_OFFSET UNITYSDK_OFFSET(0x9B8D80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETBACKBUFFERFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1CD2A6E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETDOUBLEBUFFERSFOR_OFFSET UNITYSDK_OFFSET(0x9B8D60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETFRONTBUFFERFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1CD2A6A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATEALL_OFFSET UNITYSDK_OFFSET(0x9B8E80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATEDOUBLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1CD2AB70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATESINGLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1CD2ACB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_NEXTDEVICEOFFSET_OFFSET UNITYSDK_OFFSET(0x1CD2AD60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_SETUPDEVICETOBUFFERMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1CD2A8F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1CD2A720)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateBuffers_TypeDefinitionIndex = 31947;

	struct alignas(8) InputStateBuffers
	{
		static ::System::Void** StaticGet_s_DefaultStateBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C20);
		}
		...
		{
			return (::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers*)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C30);
		}
		static ::System::Void** StaticGet_s_ResetMaskBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x7C38);
		}
