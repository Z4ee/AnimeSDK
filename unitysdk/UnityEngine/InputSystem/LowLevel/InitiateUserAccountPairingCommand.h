...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INITIATEUSERACCOUNTPAIRINGCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1D754680)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INITIATEUSERACCOUNTPAIRINGCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA0B790)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INITIATEUSERACCOUNTPAIRINGCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D754660)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InitiateUserAccountPairingCommand_TypeDefinitionIndex = 31848;
