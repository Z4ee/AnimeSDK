...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1C0887B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9C0450)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C088790)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryEnabledStateCommand_TypeDefinitionIndex = 29199;
