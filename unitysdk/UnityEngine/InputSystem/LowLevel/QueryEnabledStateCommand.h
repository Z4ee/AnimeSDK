...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1F7E71D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xAB40A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1F7E71B0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryEnabledStateCommand_TypeDefinitionIndex = 32475;
