...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF78160)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF781F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF77E10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF77DF0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputUpdateDelegate_TypeDefinitionIndex = 31928;
