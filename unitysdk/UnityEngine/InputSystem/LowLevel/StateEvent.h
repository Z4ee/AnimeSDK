...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROMDEFAULTSTATEFOR_OFFSET UNITYSDK_OFFSET(0x1B522E90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROMUNCHECKED_OFFSET UNITYSDK_OFFSET(0x1B51C370)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_1_OFFSET UNITYSDK_OFFSET(0x1B522B70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_2_OFFSET UNITYSDK_OFFSET(0x1B522BA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x1B522AB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x9731D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_STATE_OFFSET UNITYSDK_OFFSET(0x9731E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9731F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x8B6F00)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int StateEvent_TypeDefinitionIndex = 29269;
