...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROMDEFAULTSTATEFOR_OFFSET UNITYSDK_OFFSET(0x1D8DF430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROMUNCHECKED_OFFSET UNITYSDK_OFFSET(0x1D8D8900)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_1_OFFSET UNITYSDK_OFFSET(0x1D8DF110)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_2_OFFSET UNITYSDK_OFFSET(0x1D8DF140)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x1D8DF050)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0xA14590)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_STATE_OFFSET UNITYSDK_OFFSET(0xA145A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA145B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x95D3E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int StateEvent_TypeDefinitionIndex = 31925;
