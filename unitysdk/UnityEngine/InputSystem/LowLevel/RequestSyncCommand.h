...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTSYNCCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1DD07920)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTSYNCCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA3D7E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTSYNCCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DD07900)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int RequestSyncCommand_TypeDefinitionIndex = 31868;
