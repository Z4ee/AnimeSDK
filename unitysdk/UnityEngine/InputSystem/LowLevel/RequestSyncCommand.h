...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTSYNCCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1B990C50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTSYNCCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x99AB80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTSYNCCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B990C30)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int RequestSyncCommand_TypeDefinitionIndex = 29212;
