...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_APPLYDEVICEMAPPING_OFFSET UNITYSDK_OFFSET(0x1DD07430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DD060B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_FINISHED_OFFSET UNITYSDK_OFFSET(0x1DD06F00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_CREATEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1DD06060)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_FINISHED_OFFSET UNITYSDK_OFFSET(0x1DD06000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_PAUSED_OFFSET UNITYSDK_OFFSET(0x1DD06020)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DD06040)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_TRACE_OFFSET UNITYSDK_OFFSET(0x1DD05FF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DD066E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_ONBEGINFRAME_OFFSET UNITYSDK_OFFSET(0x1DD071B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1DD06640)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1DD06630)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYALLEVENTSACCORDINGTOTIMESTAMPS_OFFSET UNITYSDK_OFFSET(0x1DD06F90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYALLEVENTS_OFFSET UNITYSDK_OFFSET(0x1DD06DE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYALLFRAMESONEBYONE_OFFSET UNITYSDK_OFFSET(0x1DD06D60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYONEEVENT_OFFSET UNITYSDK_OFFSET(0x1DD06650)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1DD06A30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_REWIND_OFFSET UNITYSDK_OFFSET(0x1DD06D30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_SET_FINISHED_OFFSET UNITYSDK_OFFSET(0x1DD06010)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_SET_PAUSED_OFFSET UNITYSDK_OFFSET(0x1DD06030)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DD06050)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_WITHALLDEVICESMAPPEDTONEWINSTANCES_OFFSET UNITYSDK_OFFSET(0x1DD06620)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_WITHDEVICEMAPPEDFROMTO_1_OFFSET UNITYSDK_OFFSET(0x1DD06560)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_WITHDEVICEMAPPEDFROMTO_OFFSET UNITYSDK_OFFSET(0x1DD064B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD052B0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_ReplayController_TypeDefinitionIndex = 31921;

	class InputEventTrace_ReplayController : public ::System::Object
	{
	public:
		::System::Action* m_OnFinished; // 0x10
		::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* m_OnEvent; // 0x18
		::UnityEngine::InputSystem::LowLevel::InputEventTrace_Enumerator* m_Enumerator; // 0x20
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::System::Collections::Generic::KeyValuePair_2<::System::Int32, ::System::Int32>> m_DeviceIDMappings; // 0x28
		::UnityEngine::InputSystem::LowLevel::InputEventTrace* m_EventTrace; // 0x40
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputDevice*> m_CreatedDevices; // 0x48
		...
		::System::Int32 _position_k__BackingField; // 0x70
		::System::Boolean _finished_k__BackingField; // 0x74
		::System::Boolean _paused_k__BackingField; // 0x75
		::System::Boolean m_CreateNewDevices; // 0x76
		::System::Int32 m_AllEventsByTimeIndex; // 0x78
		::System::Double m_StartTimeAsPerFirstEvent; // 0x80
