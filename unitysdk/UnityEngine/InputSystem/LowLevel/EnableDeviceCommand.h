...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1D8B3A20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA12000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D8B3A00)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int EnableDeviceCommand_TypeDefinitionIndex = 31845;
