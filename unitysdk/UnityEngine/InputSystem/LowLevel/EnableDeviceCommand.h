...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1EC3F2E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA66550)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EC3F2C0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int EnableDeviceCommand_TypeDefinitionIndex = 32465;
