...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMANDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B978990)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMANDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9789D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMANDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B978310)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMANDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9782F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputDeviceCommandDelegate_TypeDefinitionIndex = 31850;
