...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_MOUSESTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x970530)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_MOUSESTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1B4ED9F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_MOUSESTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0x9704E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int MouseState_TypeDefinitionIndex = 29228;
