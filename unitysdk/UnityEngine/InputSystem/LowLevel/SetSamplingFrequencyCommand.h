...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETSAMPLINGFREQUENCYCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1E3D0D60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETSAMPLINGFREQUENCYCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA63790)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETSAMPLINGFREQUENCYCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E3D0D40)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int SetSamplingFrequencyCommand_TypeDefinitionIndex = 31870;
