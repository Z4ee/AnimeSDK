...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1D7A7870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_ID_OFFSET UNITYSDK_OFFSET(0xA0C8A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA0C8E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA0C920)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D7A7600)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_SET_ID_OFFSET UNITYSDK_OFFSET(0xA0C8D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_SET_NAME_OFFSET UNITYSDK_OFFSET(0xA0C910)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryPairedUserAccountCommand_TypeDefinitionIndex = 31860;
