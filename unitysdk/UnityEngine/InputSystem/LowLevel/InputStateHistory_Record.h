...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x95D310)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_COPYFROM_OFFSET UNITYSDK_OFFSET(0x95D2F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x95D320)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_EQUALS_OFFSET UNITYSDK_OFFSET(0x2C34E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B3EA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEEXTRAMEMORYPTRUNCHECKED_OFFSET UNITYSDK_OFFSET(0x95D2E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEEXTRAMEMORYPTR_OFFSET UNITYSDK_OFFSET(0x95D2B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEMEMORYPTRUNCHECKED_OFFSET UNITYSDK_OFFSET(0x3B3DD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEMEMORYPTR_OFFSET UNITYSDK_OFFSET(0x95D250)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x95D090)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x3B3A80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x95D010)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x95D110)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_PREVIOUS_OFFSET UNITYSDK_OFFSET(0x95D190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_RECORDINDEX_OFFSET UNITYSDK_OFFSET(0x3B3AB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_TIME_OFFSET UNITYSDK_OFFSET(0x95D050)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_VALID_OFFSET UNITYSDK_OFFSET(0x3B3AC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x95D210)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95D390)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x3B3CA0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateHistory_Record_TypeDefinitionIndex = 31954;
