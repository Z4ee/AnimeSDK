...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1F3E0910)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITOR_1_OFFSET UNITYSDK_OFFSET(0x1F3E0770)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1F3E0610)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADD_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F3E0020)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_CHANGE_OFFSET UNITYSDK_OFFSET(0x1F3E0180)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1F3DFFB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_CURRENTUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x1F3DFF90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_UPDATECOUNT_OFFSET UNITYSDK_OFFSET(0x1F3DFFA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ISINTEGERFORMAT_OFFSET UNITYSDK_OFFSET(0x1F3E0400)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1F3E0A20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1F3E0820)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVE_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F3E00D0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputState_TypeDefinitionIndex = 32564;
