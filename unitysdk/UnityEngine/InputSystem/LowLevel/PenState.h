...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_PENSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0xA91690)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_PENSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1F12F500)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_PENSTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0xA91650)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int PenState_TypeDefinitionIndex = 32506;
