...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DUALMOTORRUMBLECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1EC4B800)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DUALMOTORRUMBLECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA68150)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DUALMOTORRUMBLECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EC4B7E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DualMotorRumbleCommand_TypeDefinitionIndex = 32494;
