...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DUALMOTORRUMBLECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1B521D30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DUALMOTORRUMBLECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9731C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DUALMOTORRUMBLECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B521D10)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DualMotorRumbleCommand_TypeDefinitionIndex = 29218;
