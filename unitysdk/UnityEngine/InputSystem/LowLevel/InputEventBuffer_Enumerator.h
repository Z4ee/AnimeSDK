...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x381840)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x970430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x970480)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x970490)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x970410)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventBuffer_Enumerator_TypeDefinitionIndex = 29256;
