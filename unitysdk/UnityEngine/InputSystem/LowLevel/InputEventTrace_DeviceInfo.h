...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x2B7CC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x32EC50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x446DA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x48E3B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x32EC60)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_DeviceInfo_TypeDefinitionIndex = 31924;
