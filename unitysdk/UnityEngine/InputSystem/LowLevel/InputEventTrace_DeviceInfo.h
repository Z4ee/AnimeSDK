...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x325D00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x31D320)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x3253A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x462A80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x5B0840)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x352890)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_DeviceInfo_TypeDefinitionIndex = 32544;
