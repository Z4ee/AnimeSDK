...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_KEYBOARDSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0xAB5390)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_KEYBOARDSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1F810910)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_KEYBOARDSTATE_PRESS_OFFSET UNITYSDK_OFFSET(0xAB5340)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_KEYBOARDSTATE_RELEASE_OFFSET UNITYSDK_OFFSET(0xAB5360)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_KEYBOARDSTATE_SET_OFFSET UNITYSDK_OFFSET(0xAB5300)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_KEYBOARDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB52F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int KeyboardState_TypeDefinitionIndex = 32502;
