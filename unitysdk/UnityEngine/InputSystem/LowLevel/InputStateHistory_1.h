...
#include "unitysdk/UnityEngine/InputSystem/LowLevel/InputStateHistory.h"
...
{
	inline static constexpr unsigned int InputStateHistory_1_TypeDefinitionIndex = 29299;
