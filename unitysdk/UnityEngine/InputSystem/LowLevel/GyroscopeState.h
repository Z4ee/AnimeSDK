...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GYROSCOPESTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0xA59660)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GYROSCOPESTATE_GET_KFORMAT_OFFSET UNITYSDK_OFFSET(0x1EB036C0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int GyroscopeState_TypeDefinitionIndex = 32509;
