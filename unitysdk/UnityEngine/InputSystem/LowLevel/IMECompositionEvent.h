...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1D3C6130)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9EC240)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int IMECompositionEvent_TypeDefinitionIndex = 31906;
