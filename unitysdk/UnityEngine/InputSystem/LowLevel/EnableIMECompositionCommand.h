...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1B9782D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_GET_IMEENABLED_OFFSET UNITYSDK_OFFSET(0x5C9510)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x92A410)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B9782A0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int EnableIMECompositionCommand_TypeDefinitionIndex = 31846;
