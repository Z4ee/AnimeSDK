...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1C3775F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x1C377670)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3776F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputState_StateChangeMonitorDelegate_TypeDefinitionIndex = 31945;
