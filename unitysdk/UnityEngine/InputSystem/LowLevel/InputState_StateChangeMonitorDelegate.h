...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1D7B4DD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x1D7B4E50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B4ED0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputState_StateChangeMonitorDelegate_TypeDefinitionIndex = 32565;
