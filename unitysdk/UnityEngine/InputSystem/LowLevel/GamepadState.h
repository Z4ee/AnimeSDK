...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0xA5B8E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1EB4B620)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0xA5B900)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5B8F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int GamepadState_TypeDefinitionIndex = 32492;
