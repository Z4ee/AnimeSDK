...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDHEADER_GET_STATEPTRWITHCONTROLINDEX_OFFSET UNITYSDK_OFFSET(0x94A2A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDHEADER_GET_STATEPTRWITHOUTCONTROLINDEX_OFFSET UNITYSDK_OFFSET(0x94A2B0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateHistory_RecordHeader_TypeDefinitionIndex = 29295;
