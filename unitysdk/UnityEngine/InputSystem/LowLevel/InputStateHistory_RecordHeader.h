...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDHEADER_GET_STATEPTRWITHCONTROLINDEX_OFFSET UNITYSDK_OFFSET(0x9EC710)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDHEADER_GET_STATEPTRWITHOUTCONTROLINDEX_OFFSET UNITYSDK_OFFSET(0x9EC720)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateHistory_RecordHeader_TypeDefinitionIndex = 31951;
