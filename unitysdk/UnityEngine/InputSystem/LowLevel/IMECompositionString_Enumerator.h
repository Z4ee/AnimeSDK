...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA01FC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA01F80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA01FB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA01FD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA01F50)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int IMECompositionString_Enumerator_TypeDefinitionIndex = 32528;
