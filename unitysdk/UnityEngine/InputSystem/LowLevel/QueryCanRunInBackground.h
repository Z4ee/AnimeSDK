...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYCANRUNINBACKGROUND_CREATE_OFFSET UNITYSDK_OFFSET(0x1DDEE0E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYCANRUNINBACKGROUND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA43AC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYCANRUNINBACKGROUND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DDEE0C0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryCanRunInBackground_TypeDefinitionIndex = 31853;
