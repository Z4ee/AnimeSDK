...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTRESETCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A9264B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTRESETCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x90D990)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTRESETCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A926490)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int RequestResetCommand_TypeDefinitionIndex = 29211;
