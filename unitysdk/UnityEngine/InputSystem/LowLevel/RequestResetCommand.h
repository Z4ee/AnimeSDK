...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTRESETCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1CD2AE20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTRESETCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9B8EC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_REQUESTRESETCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CD2AE00)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int RequestResetCommand_TypeDefinitionIndex = 31867;
