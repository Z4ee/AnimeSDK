...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1D79F0B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA0C930)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D7A78A0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int SetIMECursorPositionCommand_TypeDefinitionIndex = 31869;
