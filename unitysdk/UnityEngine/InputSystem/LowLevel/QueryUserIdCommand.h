...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A04FE70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8B6EF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A04FE20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_READID_OFFSET UNITYSDK_OFFSET(0x8B6EC0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryUserIdCommand_TypeDefinitionIndex = 29209;
