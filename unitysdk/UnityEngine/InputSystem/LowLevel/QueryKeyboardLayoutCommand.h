...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1B38C410)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x967810)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B38C380)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_READLAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x8B6EC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_WRITELAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x9677E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryKeyboardLayoutCommand_TypeDefinitionIndex = 29202;
