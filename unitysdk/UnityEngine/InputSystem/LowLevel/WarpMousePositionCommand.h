...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_WARPMOUSEPOSITIONCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1D754840)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_WARPMOUSEPOSITIONCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA0B800)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_WARPMOUSEPOSITIONCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D754820)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int WarpMousePositionCommand_TypeDefinitionIndex = 31871;
