...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0xA0C870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xA0C880)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x5120D0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputUpdate_UpdateStepCount_TypeDefinitionIndex = 31935;
