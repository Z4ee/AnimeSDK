...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_BEGANINSAMEFRAME_OFFSET UNITYSDK_OFFSET(0xA12220)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0xA12240)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1D8B3D20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISINDIRECTTOUCH_OFFSET UNITYSDK_OFFSET(0xA121C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0xA12160)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISNONEENDEDORCANCELED_OFFSET UNITYSDK_OFFSET(0xA12140)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISORPHANEDPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0xA121A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0xA12180)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAPPRESS_OFFSET UNITYSDK_OFFSET(0xA121E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAPRELEASE_OFFSET UNITYSDK_OFFSET(0xA12200)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAP_OFFSET UNITYSDK_OFFSET(0xA121E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x5CD2D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_BEGANINSAMEFRAME_OFFSET UNITYSDK_OFFSET(0xA12230)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISINDIRECTTOUCH_OFFSET UNITYSDK_OFFSET(0xA121D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISORPHANEDPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0xA121B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0xA12190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAPPRESS_OFFSET UNITYSDK_OFFSET(0xA121F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAPRELEASE_OFFSET UNITYSDK_OFFSET(0xA12210)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAP_OFFSET UNITYSDK_OFFSET(0xA121F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x5CD280)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA12250)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int TouchState_TypeDefinitionIndex = 31894;
