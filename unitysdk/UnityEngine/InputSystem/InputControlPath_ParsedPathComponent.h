...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_COMPAREPATHELEMENTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1F16A2C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA93070)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_ISDOUBLEWILDCARD_OFFSET UNITYSDK_OFFSET(0xA93120)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_ISWILDCARD_OFFSET UNITYSDK_OFFSET(0xA930A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0xA66D40)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA93040)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_USAGES_OFFSET UNITYSDK_OFFSET(0xA93030)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_MATCHES_OFFSET UNITYSDK_OFFSET(0xA931B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_TOHUMANREADABLESTRING_1_OFFSET UNITYSDK_OFFSET(0x1F169E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_TOHUMANREADABLESTRING_OFFSET UNITYSDK_OFFSET(0xA931A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_ParsedPathComponent_TypeDefinitionIndex = 32240;
