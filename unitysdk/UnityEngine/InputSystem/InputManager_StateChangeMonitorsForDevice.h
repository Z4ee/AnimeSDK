...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_ADD_OFFSET UNITYSDK_OFFSET(0xA0C600)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0C620)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_COMPACTARRAYS_OFFSET UNITYSDK_OFFSET(0xA0C660)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x3B1DA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_REMOVEAT_OFFSET UNITYSDK_OFFSET(0xA0C670)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_REMOVE_OFFSET UNITYSDK_OFFSET(0xA0C610)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager_StateChangeMonitorsForDevice_TypeDefinitionIndex = 31686;
