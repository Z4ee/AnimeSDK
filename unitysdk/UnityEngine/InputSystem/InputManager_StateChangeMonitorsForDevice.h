...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_ADD_OFFSET UNITYSDK_OFFSET(0x96A070)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_CLEAR_OFFSET UNITYSDK_OFFSET(0x96A090)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_COMPACTARRAYS_OFFSET UNITYSDK_OFFSET(0x96A0D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2EF960)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x96A0E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_REMOVE_OFFSET UNITYSDK_OFFSET(0x96A080)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager_StateChangeMonitorsForDevice_TypeDefinitionIndex = 29030;
