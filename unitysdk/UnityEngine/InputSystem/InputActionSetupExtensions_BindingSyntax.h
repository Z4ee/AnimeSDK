...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ERASE_OFFSET UNITYSDK_OFFSET(0xA13A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0xA13300)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_BINDING_OFFSET UNITYSDK_OFFSET(0xA13340)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_VALID_OFFSET UNITYSDK_OFFSET(0xA132D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_INSERTPARTBINDING_OFFSET UNITYSDK_OFFSET(0xA13A40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATECOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0xA139F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATEPARTBINDING_OFFSET UNITYSDK_OFFSET(0xA13A10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATE_OFFSET UNITYSDK_OFFSET(0xA138D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTBINDING_OFFSET UNITYSDK_OFFSET(0xA134E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0xA13850)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTPARTBINDING_OFFSET UNITYSDK_OFFSET(0xA13710)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSBINDING_OFFSET UNITYSDK_OFFSET(0xA135F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0xA13890)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSPARTBINDING_OFFSET UNITYSDK_OFFSET(0xA137B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_TO_OFFSET UNITYSDK_OFFSET(0xA13480)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_TRIGGERING_OFFSET UNITYSDK_OFFSET(0xA13460)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHGROUPS_OFFSET UNITYSDK_OFFSET(0xA133C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHGROUP_OFFSET UNITYSDK_OFFSET(0xA133A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHINTERACTIONS_OFFSET UNITYSDK_OFFSET(0xA13400)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHINTERACTION_OFFSET UNITYSDK_OFFSET(0xA133E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHNAME_OFFSET UNITYSDK_OFFSET(0xA13360)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPATH_OFFSET UNITYSDK_OFFSET(0xA13380)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPROCESSORS_OFFSET UNITYSDK_OFFSET(0xA13440)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPROCESSOR_OFFSET UNITYSDK_OFFSET(0xA13420)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x55FD00)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_BindingSyntax_TypeDefinitionIndex = 31557;
