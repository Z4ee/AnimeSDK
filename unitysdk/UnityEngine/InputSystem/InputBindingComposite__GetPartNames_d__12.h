...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D8ACD30)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D8ACEF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8ACE80)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D8ACF70)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8ACEE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D8ACE90)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D8ACD20)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8ACD00)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingComposite__GetPartNames_d__12_TypeDefinitionIndex = 31579;
	...
	public:
		...
		::System::String* composite; // 0x18
		::System::String* __2__current; // 0x20
		::System::String* __3__composite; // 0x28
