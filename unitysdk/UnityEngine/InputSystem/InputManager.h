...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDAVAILABLEDEVICESMATCHINGDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C36BB50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDAVAILABLEDEVICESTHATARENOWRECOGNIZED_OFFSET UNITYSDK_OFFSET(0x1C369390)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1C36DEA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_1_OFFSET UNITYSDK_OFFSET(0x1C36E410)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_2_OFFSET UNITYSDK_OFFSET(0x1C36D3A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_3_OFFSET UNITYSDK_OFFSET(0x1C36CCD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_4_OFFSET UNITYSDK_OFFSET(0x1C36F1A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_5_OFFSET UNITYSDK_OFFSET(0x1C36F1F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_6_OFFSET UNITYSDK_OFFSET(0x1C36F490)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_OFFSET UNITYSDK_OFFSET(0x1C36E300)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDSTATECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C35EF00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDSTATECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1C35C9F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1C369A70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1C35CCA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1C369160)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1C3692A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1C369200)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1C369950)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONFINDCONTROLLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1C369340)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1C3698B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1C369B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_APPLYSETTINGS_OFFSET UNITYSDK_OFFSET(0x1C368B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ASSIGNUNIQUEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1C36E6C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C372390)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_DOESLAYOUTEXIST_OFFSET UNITYSDK_OFFSET(0x1C36A1A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ENABLEORDISABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x1C36ED50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FINDORREGISTERDEVICELAYOUTFORTYPE_OFFSET UNITYSDK_OFFSET(0x1C36D980)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FIRESTATECHANGENOTIFICATIONS_OFFSET UNITYSDK_OFFSET(0x1C375AB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FLIPBUFFERSFORDEVICEIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1C375E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FLUSHDISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1C36F6B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GETDEVICE_OFFSET UNITYSDK_OFFSET(0x1C370460)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GETUNSUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1C370540)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_COMPOSITES_OFFSET UNITYSDK_OFFSET(0x1C368800)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_DEFAULTUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x1C369000)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1C3687C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1C369BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMEISPLAYING_OFFSET UNITYSDK_OFFSET(0x1C369BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMESHOULDGETINPUTREGARDLESSOFFOCUS_OFFSET UNITYSDK_OFFSET(0x1C369BE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_INTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1C3687F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_ISPROCESSINGEVENTS_OFFSET UNITYSDK_OFFSET(0x1C369BB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_METRICS_OFFSET UNITYSDK_OFFSET(0x1C368810)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1C369050)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x1C3687E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1C368960)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x1C368E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDATA_OFFSET UNITYSDK_OFFSET(0x1C3709C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x1C372CB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1C36E8D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C370980)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLBEFOREUPDATEHOOKIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1C3699F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLGLOBALS_OFFSET UNITYSDK_OFFSET(0x1C372190)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLRUNTIME_OFFSET UNITYSDK_OFFSET(0x1C371B90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INVOKEAFTERUPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x1C3755D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISCONTROLORCHILDUSINGLAYOUTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1C36B5D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISCONTROLUSINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C36B4B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISDEVICELAYOUTMARKEDASSUPPORTEDINSETTINGS_OFFSET UNITYSDK_OFFSET(0x1C36DA00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_LISTCONTROLLAYOUTS_OFFSET UNITYSDK_OFFSET(0x1C36DB50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_MAKEDEVICENAMEUNIQUE_OFFSET UNITYSDK_OFFSET(0x1C36E530)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_NOTIFYUSAGECHANGED_OFFSET UNITYSDK_OFFSET(0x1C36DE10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1C3734E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1C3737D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONNATIVEDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1C372E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C373CC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PERFORMLAYOUTPOSTREGISTRATION_OFFSET UNITYSDK_OFFSET(0x1C36A320)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PROCESSSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1C3756C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PROCESSSTATECHANGEMONITORTIMEOUTS_OFFSET UNITYSDK_OFFSET(0x1C375290)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_QUEUEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1C3707F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1C370760)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REALLOCATESTATEBUFFERS_OFFSET UNITYSDK_OFFSET(0x1C368E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICESUSINGLAYOUTWITHINFERIORMATCH_OFFSET UNITYSDK_OFFSET(0x1C36B880)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICESUSINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C36B1F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICE_OFFSET UNITYSDK_OFFSET(0x1C36B690)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTBUILDER_OFFSET UNITYSDK_OFFSET(0x1C36B000)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTMATCHER_1_OFFSET UNITYSDK_OFFSET(0x1C36C0E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTMATCHER_OFFSET UNITYSDK_OFFSET(0x1C36AEE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x1C36AA60)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C369C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVECONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C36D550)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVEDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1C36E100)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x1C36C5D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1C36F580)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C35EF50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1C35CB70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1C369AC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1C35CE30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1C3691B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1C3692F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1C369250)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1C3699A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONFINDCONTROLLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1C369860)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1C369900)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1C369B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESETCONTROLPATHSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1C372C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESETDEVICE_OFFSET UNITYSDK_OFFSET(0x1C36F6E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESTOREDEVICESAFTERDOMAINRELOADIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1C373310)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SETDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1C36DBC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1C369060)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1C368970)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x1C368E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SHOULDRUNDEVICEINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1C36ECA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1C373CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYFINDMATCHINGCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C36C230)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICEBYID_OFFSET UNITYSDK_OFFSET(0x1C36D2F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICE_1_OFFSET UNITYSDK_OFFSET(0x1C3704F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICE_OFFSET UNITYSDK_OFFSET(0x1C3702B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYLOADCONTROLLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x1C36D950)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYLOADCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C36D780)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYMATCHDISCONNECTEDDEVICE_OFFSET UNITYSDK_OFFSET(0x1C373320)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UNINSTALLGLOBALS_OFFSET UNITYSDK_OFFSET(0x1C372720)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATESTATE_1_OFFSET UNITYSDK_OFFSET(0x1C370060)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x1C375630)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1C370910)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C370880)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_WARNABOUTDEVICESFAILINGTORECREATEAFTERDOMAINRELOAD_OFFSET UNITYSDK_OFFSET(0x1C3734D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_WRITESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1C375E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C375F20)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__TRYFINDMATCHINGCONTROLLAYOUT_B__72_0_OFFSET UNITYSDK_OFFSET(0x1C375F30)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager_TypeDefinitionIndex = 31682;

	class InputManager : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::LowLevel::InputDeviceExecuteCommandDelegate* m_DeviceFindExecuteCommandDelegate; // 0x10
		::Il2CppArray<::UnityEngine::InputSystem::InputManager_AvailableDevice>* m_AvailableDevices; // 0x18
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputDevice*, ::UnityEngine::InputSystem::InputDeviceChange>*> m_DeviceChangeListeners; // 0x20
		::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>* m_DisconnectedDevices; // 0x70
		::UnityEngine::InputSystem::Utilities::TypeTable m_Interactions; // 0x78
		::UnityEngine::InputSystem::Utilities::TypeTable m_Processors; // 0x80
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::String*, ::UnityEngine::InputSystem::InputControlLayoutChange>*> m_LayoutChangeListeners; // 0x88
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_AfterUpdateListeners; // 0xD8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::InputSystem::InputDevice*>* m_DevicesById; // 0x128
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_BeforeUpdateListeners; // 0x130
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputDevice*, ::UnityEngine::InputSystem::LowLevel::InputEventPtr>*> m_DeviceStateChangeListeners; // 0x180
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::LowLevel::InputEventPtr, ::UnityEngine::InputSystem::InputDevice*>*> m_EventListeners; // 0x1D0
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_SettingsChangedListeners; // 0x220
		::UnityEngine::InputSystem::InputSettings* m_Settings; // 0x270
		::UnityEngine::InputSystem::Utilities::TypeTable m_Composites; // 0x278
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate*> m_DeviceFindLayoutCallbacks; // 0x280
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputManager_StateChangeMonitorTimeout> m_StateChangeMonitorTimeouts; // 0x2D0
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate*> m_DeviceCommandCallbacks; // 0x308
		::Il2CppArray<::UnityEngine::InputSystem::InputManager_StateChangeMonitorsForDevice>* m_StateChangeMonitors; // 0x358
		::UnityEngine::InputSystem::LowLevel::IInputRuntime* m_Runtime; // 0x360
		::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection m_Layouts; // 0x368
		::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>* m_Devices; // 0x3A8
		::UnityEngine::InputSystem::LowLevel::InputStateBuffers m_StateBuffers; // 0x3B0
		::System::Int32 m_DevicesCount; // 0x3E0
		::System::Boolean m_NativeBeforeUpdateHooked; // 0x3E4
		::System::Boolean m_HaveDevicesWithStateCallbackReceivers; // 0x3E5
		::System::Boolean m_HasFocus; // 0x3E6
		::UnityEngine::InputSystem::LowLevel::InputMetrics m_Metrics; // 0x3E8
		::System::Int32 m_AvailableDeviceCount; // 0x420
		::System::Int32 m_DisconnectedDevicesCount; // 0x424
		::UnityEngine::InputSystem::LowLevel::InputUpdateType m_CurrentUpdate; // 0x428
		::System::Int32 m_DeviceFindExecuteCommandDeviceId; // 0x42C
		::System::Single m_PollingFrequency; // 0x430
		::UnityEngine::InputSystem::LowLevel::InputUpdateType m_UpdateMask; // 0x434
		::System::Int32 m_LayoutRegistrationVersion; // 0x438
		::UnityEngine::InputSystem::LowLevel::InputEventStream m_InputEventStream; // 0x440
