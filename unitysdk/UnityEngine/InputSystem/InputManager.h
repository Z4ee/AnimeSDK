...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDAVAILABLEDEVICESMATCHINGDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A0436A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDAVAILABLEDEVICESTHATARENOWRECOGNIZED_OFFSET UNITYSDK_OFFSET(0x1A040F00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A0459D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_1_OFFSET UNITYSDK_OFFSET(0x1A045F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_2_OFFSET UNITYSDK_OFFSET(0x1A044F00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_3_OFFSET UNITYSDK_OFFSET(0x1A044830)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_4_OFFSET UNITYSDK_OFFSET(0x1A046CC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_5_OFFSET UNITYSDK_OFFSET(0x1A046D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_6_OFFSET UNITYSDK_OFFSET(0x1A046FB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A045E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDSTATECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A036A60)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDSTATECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1A034550)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0415E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A034800)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A040CD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A040E10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A040D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A0414C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONFINDCONTROLLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1A040EB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1A041420)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1A041680)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_APPLYSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A040670)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ASSIGNUNIQUEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1A0461E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A049EA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_DOESLAYOUTEXIST_OFFSET UNITYSDK_OFFSET(0x1A041D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ENABLEORDISABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A046870)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FINDORREGISTERDEVICELAYOUTFORTYPE_OFFSET UNITYSDK_OFFSET(0x1A0454C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FIRESTATECHANGENOTIFICATIONS_OFFSET UNITYSDK_OFFSET(0x1A04D5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FLIPBUFFERSFORDEVICEIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A04D930)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FLUSHDISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A0471D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GETDEVICE_OFFSET UNITYSDK_OFFSET(0x1A047F90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GETUNSUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A048070)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_COMPOSITES_OFFSET UNITYSDK_OFFSET(0x1A040370)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_DEFAULTUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x1A040B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A040330)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1A041740)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMEISPLAYING_OFFSET UNITYSDK_OFFSET(0x1A041730)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMESHOULDGETINPUTREGARDLESSOFFOCUS_OFFSET UNITYSDK_OFFSET(0x1A041750)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_INTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1A040360)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_ISPROCESSINGEVENTS_OFFSET UNITYSDK_OFFSET(0x1A041720)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_METRICS_OFFSET UNITYSDK_OFFSET(0x1A040380)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A040BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x1A040350)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A0404C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x1A040980)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDATA_OFFSET UNITYSDK_OFFSET(0x1A048500)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x1A04A7C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1A0463F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A0484C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLBEFOREUPDATEHOOKIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A041560)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLGLOBALS_OFFSET UNITYSDK_OFFSET(0x1A049CB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLRUNTIME_OFFSET UNITYSDK_OFFSET(0x1A0496B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INVOKEAFTERUPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x1A04D0E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISCONTROLORCHILDUSINGLAYOUTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A043120)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISCONTROLUSINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A043000)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISDEVICELAYOUTMARKEDASSUPPORTEDINSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A045540)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_LISTCONTROLLAYOUTS_OFFSET UNITYSDK_OFFSET(0x1A045690)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_MAKEDEVICENAMEUNIQUE_OFFSET UNITYSDK_OFFSET(0x1A046050)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_NOTIFYUSAGECHANGED_OFFSET UNITYSDK_OFFSET(0x1A045940)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A04AFF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A04B2E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONNATIVEDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1A04A9A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A04B7D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PERFORMLAYOUTPOSTREGISTRATION_OFFSET UNITYSDK_OFFSET(0x1A041E80)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PROCESSSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1A04D1D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PROCESSSTATECHANGEMONITORTIMEOUTS_OFFSET UNITYSDK_OFFSET(0x1A04CDA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_QUEUEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1A048330)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1A0482A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REALLOCATESTATEBUFFERS_OFFSET UNITYSDK_OFFSET(0x1A0409B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICESUSINGLAYOUTWITHINFERIORMATCH_OFFSET UNITYSDK_OFFSET(0x1A0433D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICESUSINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A042D40)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A0431E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTBUILDER_OFFSET UNITYSDK_OFFSET(0x1A042B50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTMATCHER_1_OFFSET UNITYSDK_OFFSET(0x1A043C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTMATCHER_OFFSET UNITYSDK_OFFSET(0x1A042A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x1A0425B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A041780)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVECONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A0450B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVEDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A045C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A044130)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1A0470A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A036AB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1A0346D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A041630)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A034990)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A040D20)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A040E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A040DC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A041510)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONFINDCONTROLLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1A0413D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1A041470)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1A0416D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESETCONTROLPATHSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A04A740)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESETDEVICE_OFFSET UNITYSDK_OFFSET(0x1A047200)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESTOREDEVICESAFTERDOMAINRELOADIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A04AE20)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SETDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A045700)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A040BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A0404D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x1A040990)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SHOULDRUNDEVICEINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1A0467C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1A04B7B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYFINDMATCHINGCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A043D80)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICEBYID_OFFSET UNITYSDK_OFFSET(0x1A044E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICE_1_OFFSET UNITYSDK_OFFSET(0x1A048020)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICE_OFFSET UNITYSDK_OFFSET(0x1A047DE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYLOADCONTROLLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x1A045490)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYLOADCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A0452D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYMATCHDISCONNECTEDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A04AE30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UNINSTALLGLOBALS_OFFSET UNITYSDK_OFFSET(0x1A04A230)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATESTATE_1_OFFSET UNITYSDK_OFFSET(0x1A047B90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x1A04D140)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A048450)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0483C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_WARNABOUTDEVICESFAILINGTORECREATEAFTERDOMAINRELOAD_OFFSET UNITYSDK_OFFSET(0x1A04AFE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_WRITESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A04D9A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04DA30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__TRYFINDMATCHINGCONTROLLAYOUT_B__72_0_OFFSET UNITYSDK_OFFSET(0x1A04DA40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager_TypeDefinitionIndex = 29026;

	class InputManager : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection m_Layouts; // 0x10
		::UnityEngine::InputSystem::Utilities::TypeTable m_Processors; // 0x50
		::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>* m_DisconnectedDevices; // 0x58
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::LowLevel::InputEventPtr, ::UnityEngine::InputSystem::InputDevice*>*> m_EventListeners; // 0x60
		::UnityEngine::InputSystem::LowLevel::IInputRuntime* m_Runtime; // 0xB0
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_SettingsChangedListeners; // 0xB8
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_AfterUpdateListeners; // 0x108
		::Il2CppArray<::UnityEngine::InputSystem::InputManager_AvailableDevice>* m_AvailableDevices; // 0x158
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::String*, ::UnityEngine::InputSystem::InputControlLayoutChange>*> m_LayoutChangeListeners; // 0x160
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::InputSystem::InputDevice*>* m_DevicesById; // 0x1B0
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_BeforeUpdateListeners; // 0x1B8
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate*> m_DeviceFindLayoutCallbacks; // 0x208
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputDevice*, ::UnityEngine::InputSystem::InputDeviceChange>*> m_DeviceChangeListeners; // 0x258
		::UnityEngine::InputSystem::LowLevel::InputDeviceExecuteCommandDelegate* m_DeviceFindExecuteCommandDelegate; // 0x2A8
		::UnityEngine::InputSystem::InputSettings* m_Settings; // 0x2B0
		::Il2CppArray<::UnityEngine::InputSystem::InputManager_StateChangeMonitorsForDevice>* m_StateChangeMonitors; // 0x2B8
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate*> m_DeviceCommandCallbacks; // 0x2C0
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputDevice*, ::UnityEngine::InputSystem::LowLevel::InputEventPtr>*> m_DeviceStateChangeListeners; // 0x310
		::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>* m_Devices; // 0x360
		::UnityEngine::InputSystem::Utilities::TypeTable m_Interactions; // 0x368
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputManager_StateChangeMonitorTimeout> m_StateChangeMonitorTimeouts; // 0x370
		::UnityEngine::InputSystem::Utilities::TypeTable m_Composites; // 0x3A8
		::System::Single m_PollingFrequency; // 0x3B0
		::UnityEngine::InputSystem::LowLevel::InputUpdateType m_CurrentUpdate; // 0x3B4
		::System::Int32 m_AvailableDeviceCount; // 0x3B8
		::System::Boolean m_HaveDevicesWithStateCallbackReceivers; // 0x3BC
		::System::Boolean m_HasFocus; // 0x3BD
		::System::Boolean m_NativeBeforeUpdateHooked; // 0x3BE
		::System::Int32 m_DevicesCount; // 0x3C0
		::System::Int32 m_DeviceFindExecuteCommandDeviceId; // 0x3C4
		::System::Int32 m_DisconnectedDevicesCount; // 0x3C8
		::UnityEngine::InputSystem::LowLevel::InputEventStream m_InputEventStream; // 0x3D0
		::UnityEngine::InputSystem::LowLevel::InputStateBuffers m_StateBuffers; // 0x448
		::UnityEngine::InputSystem::LowLevel::InputMetrics m_Metrics; // 0x478
		::System::Int32 m_LayoutRegistrationVersion; // 0x4B0
		::UnityEngine::InputSystem::LowLevel::InputUpdateType m_UpdateMask; // 0x4B4
