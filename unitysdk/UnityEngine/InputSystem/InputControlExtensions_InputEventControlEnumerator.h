...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_CHECKCURRENT_OFFSET UNITYSDK_OFFSET(0x9B24E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_CHECKDEFAULT_OFFSET UNITYSDK_OFFSET(0x9B24B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B2530)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x400120)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9B2510)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9B2520)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x400120)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9B24A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_InputEventControlEnumerator_TypeDefinitionIndex = 28954;
