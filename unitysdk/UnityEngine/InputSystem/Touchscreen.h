...
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1C380D90)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C380D10)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_GET_PRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x1C380C80)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_GET_TOUCHCONTROLARRAY_OFFSET UNITYSDK_OFFSET(0x1C380CC0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_GET_TOUCHES_OFFSET UNITYSDK_OFFSET(0x1C380CA0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1C380D30)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x1C381DE0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1C3811A0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1C380D50)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1C381510)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C380D20)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_SET_PRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x1C380C90)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_SET_TOUCHCONTROLARRAY_OFFSET UNITYSDK_OFFSET(0x1C380CD0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_SET_TOUCHES_OFFSET UNITYSDK_OFFSET(0x1C380CB0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_TRIGGERTAP_OFFSET UNITYSDK_OFFSET(0x1C381B70)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ICUSTOMDEVICERESET_RESET_OFFSET UNITYSDK_OFFSET(0x1C36FCB0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IEVENTMERGER_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x1C381E60)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1C381BF0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1C381BD0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1C381BE0)
#define UNITYENGINE_INPUTSYSTEM_TOUCHSCREEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C381EE0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Touchscreen_TypeDefinitionIndex = 31678;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Touchscreen**)Il2CppClass::FromTypeDefinitionIndex(Touchscreen_TypeDefinitionIndex)->GetStaticField(0x25E10);
		}
		static ::System::Single* StaticGet_s_TapRadiusSquared()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Touchscreen_TypeDefinitionIndex)->GetStaticField(0x7CC0);
		}
		static ::System::Single* StaticGet_s_TapTime()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Touchscreen_TypeDefinitionIndex)->GetStaticField(0x7CC4);
		}
		static ::System::Single* StaticGet_s_TapDelayTime()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Touchscreen_TypeDefinitionIndex)->GetStaticField(0x7CC8);
		}
