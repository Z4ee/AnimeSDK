...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_DEVICEJSON_FROM_OFFSET UNITYSDK_OFFSET(0x1BC463C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_DEVICEJSON_TODEVICEENTRY_OFFSET UNITYSDK_OFFSET(0x9AC950)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_SchemeJson_DeviceJson_TypeDefinitionIndex = 28938;
