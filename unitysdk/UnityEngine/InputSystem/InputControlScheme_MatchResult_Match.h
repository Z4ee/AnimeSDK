...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x970250)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x970290)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x970330)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_REQUIREMENTINDEX_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_REQUIREMENT_OFFSET UNITYSDK_OFFSET(0x9702F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_MatchResult_Match_TypeDefinitionIndex = 28933;
