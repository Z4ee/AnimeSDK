...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0xA11E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0xA11E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0xA11F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_REQUIREMENTINDEX_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_REQUIREMENT_OFFSET UNITYSDK_OFFSET(0xA11EF0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_MatchResult_Match_TypeDefinitionIndex = 31589;
