...
#define UNITYENGINE_INPUTSYSTEM_SWITCH_LOWLEVEL_SWITCHPROCONTROLLERHIDINPUTSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x9492A0)
#define UNITYENGINE_INPUTSYSTEM_SWITCH_LOWLEVEL_SWITCHPROCONTROLLERHIDINPUTSTATE_GET_LEFTTRIGGER_OFFSET UNITYSDK_OFFSET(0x9A1710)
#define UNITYENGINE_INPUTSYSTEM_SWITCH_LOWLEVEL_SWITCHPROCONTROLLERHIDINPUTSTATE_GET_RIGHTTRIGGER_OFFSET UNITYSDK_OFFSET(0x9A1730)
#define UNITYENGINE_INPUTSYSTEM_SWITCH_LOWLEVEL_SWITCHPROCONTROLLERHIDINPUTSTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0x9A1750)

namespace UnityEngine::InputSystem::Switch::LowLevel
{
	inline static constexpr unsigned int SwitchProControllerHIDInputState_TypeDefinitionIndex = 29124;
