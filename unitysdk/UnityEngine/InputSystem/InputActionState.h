...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ADDTOGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x1C35A1B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CALLACTIONLISTENERS_OFFSET UNITYSDK_OFFSET(0x1C35F870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CANUSEDEVICE_OFFSET UNITYSDK_OFFSET(0x1C35AEB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFACTIONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C35F5F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFACTION_OFFSET UNITYSDK_OFFSET(0x1C35BF80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFINTERACTION_OFFSET UNITYSDK_OFFSET(0x1C35F020)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CLAIMDATAFROM_OFFSET UNITYSDK_OFFSET(0x1C35A0D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CLONE_OFFSET UNITYSDK_OFFSET(0x1C35A900)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPACTGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x1C360D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPUTEMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x1C35E8D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPUTEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1C35E320)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DEFERREDRESOLUTIONOFBINDINGS_OFFSET UNITYSDK_OFFSET(0x1C361E70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DESTROYALLACTIONMAPSTATES_OFFSET UNITYSDK_OFFSET(0x1C361050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C35A320)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLEALLACTIONS_1_OFFSET UNITYSDK_OFFSET(0x1C362140)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x1C35C610)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_1_OFFSET UNITYSDK_OFFSET(0x1C35C890)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_2_OFFSET UNITYSDK_OFFSET(0x1C35A5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x1C35C7A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLESINGLEACTION_OFFSET UNITYSDK_OFFSET(0x1C35C7F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C359C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x1C35C240)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_1_OFFSET UNITYSDK_OFFSET(0x1C35C540)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_2_OFFSET UNITYSDK_OFFSET(0x1C35B5B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x1C35C440)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLESINGLEACTION_OFFSET UNITYSDK_OFFSET(0x1C35C490)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_EVALUATECOMPOSITEPARTMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1C3601C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FETCHACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1C35C1C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FETCHMAPINDICES_OFFSET UNITYSDK_OFFSET(0x1C35C1F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C35A250)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINDALLENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x1C361250)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINISHBINDINGCOMPOSITESETUPS_OFFSET UNITYSDK_OFFSET(0x1C35B200)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONBINDINGSTARTINDEXANDCOUNT_OFFSET UNITYSDK_OFFSET(0x1C35BE80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNONESTRING_OFFSET UNITYSDK_OFFSET(0x1C35FA30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNULL_1_OFFSET UNITYSDK_OFFSET(0x1C35FA80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNULL_OFFSET UNITYSDK_OFFSET(0x1C35FB40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGINDEXINMAP_OFFSET UNITYSDK_OFFSET(0x1C35FCA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGINDEXINSTATE_OFFSET UNITYSDK_OFFSET(0x1C35FCE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGSTATE_OFFSET UNITYSDK_OFFSET(0x1C35FD10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDING_OFFSET UNITYSDK_OFFSET(0x1C35FD30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETCONTROL_OFFSET UNITYSDK_OFFSET(0x1C35FC00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETINTERACTIONORNULL_OFFSET UNITYSDK_OFFSET(0x1C35FC50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETVALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1C35FE00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1C35FEF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x1C359ED0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_BINDINGSTATES_OFFSET UNITYSDK_OFFSET(0x1C359EE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_CONTROLINDEXTOBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x1C359F00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ENABLEDCONTROLS_OFFSET UNITYSDK_OFFSET(0x1C359F10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_INTERACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x1C359EF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ISPROCESSINGCONTROLSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1C359F20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_MAPINDICES_OFFSET UNITYSDK_OFFSET(0x1C359EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1C359E80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALBINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1C359E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALCOMPOSITECOUNT_OFFSET UNITYSDK_OFFSET(0x1C359E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALCONTROLCOUNT_OFFSET UNITYSDK_OFFSET(0x1C359EB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALINTERACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1C359EA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1C359E70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_HASENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x1C35B190)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_HOOKONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1C35B750)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C359F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISACTIONBOUNDTOCONTROLFROMDEVICE_OFFSET UNITYSDK_OFFSET(0x1C35BAB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISACTUATED_OFFSET UNITYSDK_OFFSET(0x1C35EB70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISCONFLICTINGINPUT_OFFSET UNITYSDK_OFFSET(0x1C35DD60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x1C35C960)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISUSINGDEVICE_OFFSET UNITYSDK_OFFSET(0x1C35ACC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_NOTIFYLISTENERSOFACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1C35B820)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ONBEFOREINITIALUPDATE_OFFSET UNITYSDK_OFFSET(0x1C35CE80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1C361790)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSCONTROLSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1C35D080)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSDEFAULTINTERACTION_OFFSET UNITYSDK_OFFSET(0x1C35E370)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1C35DB40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C35D770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READCOMPOSITEPARTVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1C3605A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READCOMPOSITEPARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C360320)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUEASBUTTON_OFFSET UNITYSDK_OFFSET(0x1C3609D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1C360820)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1C35FFE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_REMOVEMAPFROMGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x1C35A770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETACTIONSTATESDRIVENBY_OFFSET UNITYSDK_OFFSET(0x1C35B8C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1C35BBA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETGLOBALS_OFFSET UNITYSDK_OFFSET(0x1C360EF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETINTERACTIONSTATEANDCANCELIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1C35BEB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETINTERACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1C35EA20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESTOREACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x1C35B2C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SAVEANDRESETSTATE_OFFSET UNITYSDK_OFFSET(0x1C360AE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x1C35CB40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETINITIALSTATECHECKPENDING_OFFSET UNITYSDK_OFFSET(0x1C35C9A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETTOTALTIMEOUTCOMPLETIONTIME_OFFSET UNITYSDK_OFFSET(0x1C35EC20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SHOULDIGNOREINPUTONCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x1C35DB20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SPLITUPMAPANDCONTROLANDBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x1C35D720)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_STARTTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C35EC60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_STOPTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C35EE00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1C35ACB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_TOCOMBINEDMAPANDCONTROLANDBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x1C35C980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNHOOKONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1C35CD70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1C35D6E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x1C35D740)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C35ACA0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState_TypeDefinitionIndex = 31561;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputActionState_GlobalState*)Il2CppClass::FromTypeDefinitionIndex(InputActionState_TypeDefinitionIndex)->GetStaticField(0x25E80);
		}
		// static const ::System::Int32 kInvalidIndex = 0xFFFFFFFF; // 0x0
		::System::Action* m_OnBeforeUpdateDelegate; // 0x10
		::Il2CppArray<::UnityEngine::InputSystem::InputProcessor*>* processors; // 0x18
		::Il2CppArray<::UnityEngine::InputSystem::InputControl*>* controls; // 0x20
		::Il2CppArray<::UnityEngine::InputSystem::IInputInteraction*>* interactions; // 0x28
		::Il2CppArray<::UnityEngine::InputSystem::InputActionMap*>* maps; // 0x30
		::Il2CppArray<::UnityEngine::InputSystem::InputBindingComposite*>* composites; // 0x38
		::System::Action* m_OnAfterUpdateDelegate; // 0x40
		::UnityEngine::InputSystem::InputActionState_UnmanagedMemory memory; // 0x48
		::System::Boolean m_OnAfterUpdateHooked; // 0xB8
		::System::Boolean m_OnBeforeUpdateHooked; // 0xB9
		::System::Boolean m_InProcessControlStateChange; // 0xBA
