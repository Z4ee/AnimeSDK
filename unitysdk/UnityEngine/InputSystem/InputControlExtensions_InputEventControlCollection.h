...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9AC700)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLCOLLECTION_GET_EVENTPTR_OFFSET UNITYSDK_OFFSET(0x28B580)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLCOLLECTION_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTCONTROL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9AC750)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLCOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9AC850)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_InputEventControlCollection_TypeDefinitionIndex = 28953;
