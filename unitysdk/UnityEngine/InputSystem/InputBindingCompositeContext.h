...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x99C830)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_GET_CONTROLS_OFFSET UNITYSDK_OFFSET(0x99C7D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_READVALUEASBUTTON_OFFSET UNITYSDK_OFFSET(0x99C860)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x99C8F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_READVALUE_OFFSET UNITYSDK_OFFSET(0x99C8C0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingCompositeContext_TypeDefinitionIndex = 28925;
