...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0xA3FC70)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_GET_CONTROLS_OFFSET UNITYSDK_OFFSET(0xA3FC10)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_READVALUEASBUTTON_OFFSET UNITYSDK_OFFSET(0xA3FCA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0xA3FD30)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_READVALUE_OFFSET UNITYSDK_OFFSET(0xA3FD00)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingCompositeContext_TypeDefinitionIndex = 31581;
