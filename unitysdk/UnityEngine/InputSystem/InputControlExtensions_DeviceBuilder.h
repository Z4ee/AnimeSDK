...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0xA57D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x259D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_ISNOISY_OFFSET UNITYSDK_OFFSET(0xA57C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x324D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCHILDREN_OFFSET UNITYSDK_OFFSET(0xA57C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCONTROLALIAS_OFFSET UNITYSDK_OFFSET(0xA57CC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCONTROLUSAGE_OFFSET UNITYSDK_OFFSET(0xA57C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA57B30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHLAYOUT_OFFSET UNITYSDK_OFFSET(0xA57BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHNAME_OFFSET UNITYSDK_OFFSET(0xA57AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA57B80)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSTATEBLOCK_OFFSET UNITYSDK_OFFSET(0xA57C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSTATEOFFSETTOCONTROLINDEXMAP_OFFSET UNITYSDK_OFFSET(0xA57D20)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_DeviceBuilder_TypeDefinitionIndex = 32232;
