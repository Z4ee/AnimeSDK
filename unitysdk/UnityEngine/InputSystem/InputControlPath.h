...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_CLEANSLASHES_OFFSET UNITYSDK_OFFSET(0x1C366540)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_COMBINE_OFFSET UNITYSDK_OFFSET(0x1C366570)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_CONTROLLAYOUTMATCHESPATHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C367BE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_FINDCONTROLLAYOUTRECURSIVE_1_OFFSET UNITYSDK_OFFSET(0x1C367990)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_FINDCONTROLLAYOUTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1C367700)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHESPREFIX_OFFSET UNITYSDK_OFFSET(0x1C368280)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHESRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1C368210)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHES_OFFSET UNITYSDK_OFFSET(0x1C366F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHPATHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C3683A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSE_OFFSET UNITYSDK_OFFSET(0x1C368760)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHCOMPONENTCANYIELDMULTIPLEMATCHES_OFFSET UNITYSDK_OFFSET(0x1C3686C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_STRINGMATCHES_OFFSET UNITYSDK_OFFSET(0x1C367DC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TOHUMANREADABLESTRING_1_OFFSET UNITYSDK_OFFSET(0x1C3666D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TOHUMANREADABLESTRING_OFFSET UNITYSDK_OFFSET(0x1C3666A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCHILD_OFFSET UNITYSDK_OFFSET(0x1C3681C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCONTROLS_1_OFFSET UNITYSDK_OFFSET(0x1C368160)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCONTROLS_OFFSET UNITYSDK_OFFSET(0x1C368050)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCONTROL_OFFSET UNITYSDK_OFFSET(0x1C35B140)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYGETCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x1C367370)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYGETDEVICELAYOUT_OFFSET UNITYSDK_OFFSET(0x1C3671B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYGETDEVICEUSAGES_OFFSET UNITYSDK_OFFSET(0x1C367030)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_TypeDefinitionIndex = 31617;
