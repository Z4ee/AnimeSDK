...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D754080)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7540C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE___C__SAVEANDRESETSTATE_B__121_0_OFFSET UNITYSDK_OFFSET(0x1D7540D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE___C__SAVEANDRESETSTATE_B__121_1_OFFSET UNITYSDK_OFFSET(0x1D7540F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState___c_TypeDefinitionIndex = 31571;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(InputActionState___c_TypeDefinitionIndex)->GetStaticField(0x25E60);
		}
		static ::UnityEngine::InputSystem::InputActionState___c** StaticGet___9()
		{
			return (::UnityEngine::InputSystem::InputActionState___c**)Il2CppClass::FromTypeDefinitionIndex(InputActionState___c_TypeDefinitionIndex)->GetStaticField(0x25E68);
		}
		...
		{
			return (::UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore<::UnityEngine::InputSystem::InputActionState_GlobalState>**)Il2CppClass::FromTypeDefinitionIndex(InputActionState___c_TypeDefinitionIndex)->GetStaticField(0x25E70);
		}
