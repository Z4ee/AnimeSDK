...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_GET_ISATEND_OFFSET UNITYSDK_OFFSET(0x881330)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_MOVETONEXTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x881380)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_PARSECOMPONENTPART_OFFSET UNITYSDK_OFFSET(0x881390)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x881340)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_PathParser_TypeDefinitionIndex = 28966;
