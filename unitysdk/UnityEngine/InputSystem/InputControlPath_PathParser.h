...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_GET_ISATEND_OFFSET UNITYSDK_OFFSET(0x92A390)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_MOVETONEXTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x92A3E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_PARSECOMPONENTPART_OFFSET UNITYSDK_OFFSET(0x92A3F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x92A3A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_PathParser_TypeDefinitionIndex = 31622;
