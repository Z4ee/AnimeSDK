...
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATERESETEVENT_OFFSET UNITYSDK_OFFSET(0x1DD02DC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATESTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1DD03060)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATE_OFFSET UNITYSDK_OFFSET(0x1DD02F20)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_PROCESS_OFFSET UNITYSDK_OFFSET(0x1DD031A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputRemoting_NewEventsMsg_TypeDefinitionIndex = 31657;
