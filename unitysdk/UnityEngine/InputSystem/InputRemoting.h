...
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_BUILDLAYOUTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1EC4B3C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_FINDLOCALDEVICEID_OFFSET UNITYSDK_OFFSET(0x1EC4B460)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_FINDORCREATESENDERRECORD_OFFSET UNITYSDK_OFFSET(0x1EC4B360)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x1EC4B570)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_GET_SENDING_OFFSET UNITYSDK_OFFSET(0x1EC49A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_REMOVEREMOTEDEVICES_OFFSET UNITYSDK_OFFSET(0x1EC4B580)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDALLDEVICES_OFFSET UNITYSDK_OFFSET(0x1EC4A9B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDALLGENERATEDLAYOUTS_OFFSET UNITYSDK_OFFSET(0x1EC4A800)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1EC4B130)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDDEVICE_OFFSET UNITYSDK_OFFSET(0x1EC4AD90)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1EC4B070)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDINITIALMESSAGES_OFFSET UNITYSDK_OFFSET(0x1EC49C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1EC4B230)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDLAYOUT_OFFSET UNITYSDK_OFFSET(0x1EC4ABA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SEND_OFFSET UNITYSDK_OFFSET(0x1EC4AC00)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SET_SENDING_OFFSET UNITYSDK_OFFSET(0x1EC49A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_STARTSENDING_OFFSET UNITYSDK_OFFSET(0x1EC49AC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_STOPSENDING_OFFSET UNITYSDK_OFFSET(0x1EC49CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1EC4A750)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1EC4A740)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONERROR_OFFSET UNITYSDK_OFFSET(0x1EC4A730)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONNEXT_OFFSET UNITYSDK_OFFSET(0x1EC49E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_TRYGETDEVICEBYREMOTEID_OFFSET UNITYSDK_OFFSET(0x1EC4B4E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC49A40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputRemoting_TypeDefinitionIndex = 32261;
