...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_FROMBINDING_OFFSET UNITYSDK_OFFSET(0x1E3CFFA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_TOBINDING_OFFSET UNITYSDK_OFFSET(0xA63610)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_BindingJson_TypeDefinitionIndex = 31539;
