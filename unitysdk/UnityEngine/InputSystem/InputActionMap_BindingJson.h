...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_FROMBINDING_OFFSET UNITYSDK_OFFSET(0x1C0B2D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_TOBINDING_OFFSET UNITYSDK_OFFSET(0x9C1C90)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_BindingJson_TypeDefinitionIndex = 28883;
