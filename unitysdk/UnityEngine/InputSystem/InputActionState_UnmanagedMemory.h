...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x969D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_CLONE_OFFSET UNITYSDK_OFFSET(0x96A030)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0x969EB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x969E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_GET_ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x2F0450)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x969CC0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState_UnmanagedMemory_TypeDefinitionIndex = 28913;
