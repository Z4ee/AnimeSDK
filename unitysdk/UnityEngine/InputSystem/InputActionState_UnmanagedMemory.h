...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xA0C2A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_CLONE_OFFSET UNITYSDK_OFFSET(0xA0C5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0xA0C440)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0C3F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_GET_ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x2C1A40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0xA0C250)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState_UnmanagedMemory_TypeDefinitionIndex = 31569;
