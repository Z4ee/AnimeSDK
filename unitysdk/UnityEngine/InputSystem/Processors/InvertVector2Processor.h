...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_INVERTVECTOR2PROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1BA6F8D0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_INVERTVECTOR2PROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BA6F910)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_INVERTVECTOR2PROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA6F9B0)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int InvertVector2Processor_TypeDefinitionIndex = 29309;
