...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_INVERTVECTOR2PROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1DDEE4F0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_INVERTVECTOR2PROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DDEE530)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_INVERTVECTOR2PROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDEE5D0)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int InvertVector2Processor_TypeDefinitionIndex = 31965;
