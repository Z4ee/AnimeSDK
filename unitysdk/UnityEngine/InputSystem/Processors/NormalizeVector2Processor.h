...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_NORMALIZEVECTOR2PROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1BA6FAF0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_NORMALIZEVECTOR2PROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BA6FB70)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_NORMALIZEVECTOR2PROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA6FBB0)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int NormalizeVector2Processor_TypeDefinitionIndex = 29312;
