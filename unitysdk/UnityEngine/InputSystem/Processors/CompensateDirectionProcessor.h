...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_COMPENSATEDIRECTIONPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1BA6F570)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_COMPENSATEDIRECTIONPROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BA6F870)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_COMPENSATEDIRECTIONPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA6F8B0)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int CompensateDirectionProcessor_TypeDefinitionIndex = 29306;
