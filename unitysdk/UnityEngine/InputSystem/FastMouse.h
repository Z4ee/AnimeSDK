...
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x1EC44430)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSECLICKCOUNT_OFFSET UNITYSDK_OFFSET(0x1EC44BF0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEDELTAX_OFFSET UNITYSDK_OFFSET(0x1EC451B0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEDELTAY_OFFSET UNITYSDK_OFFSET(0x1EC45390)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEDELTA_OFFSET UNITYSDK_OFFSET(0x1EC433A0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEFORWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x1EC441B0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSELEFTBUTTON_OFFSET UNITYSDK_OFFSET(0x1EC43980)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEMIDDLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1EC43F00)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOINTERID_OFFSET UNITYSDK_OFFSET(0x1EC44A50)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOSITIONX_OFFSET UNITYSDK_OFFSET(0x1EC44D90)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOSITIONY_OFFSET UNITYSDK_OFFSET(0x1EC44FA0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EC431B0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPRESSURE_OFFSET UNITYSDK_OFFSET(0x1EC446B0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPRESS_OFFSET UNITYSDK_OFFSET(0x1EC43710)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERADIUSX_OFFSET UNITYSDK_OFFSET(0x1EC45970)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERADIUSY_OFFSET UNITYSDK_OFFSET(0x1EC45B50)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERADIUS_OFFSET UNITYSDK_OFFSET(0x1EC44890)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERIGHTBUTTON_OFFSET UNITYSDK_OFFSET(0x1EC43C40)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSESCROLLX_OFFSET UNITYSDK_OFFSET(0x1EC45570)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSESCROLLY_OFFSET UNITYSDK_OFFSET(0x1EC45770)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1EC43560)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x1EC45EF0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC45D30)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1EC45D90)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IEVENTMERGER_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x1EC45F90)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC45E80)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1EC45EE0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC42720)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int FastMouse_TypeDefinitionIndex = 32259;
