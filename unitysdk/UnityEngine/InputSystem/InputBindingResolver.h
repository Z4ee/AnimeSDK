...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_ADDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x95CF40)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_ASSIGNCOMPOSITEPARTINDEX_OFFSET UNITYSDK_OFFSET(0x1C366310)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95CEE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x46E220)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALBINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x7F7C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALCONTROLCOUNT_OFFSET UNITYSDK_OFFSET(0x775AC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x3B1DA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_INSTANTIATEBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1C3660C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_RESOLVEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x95CF90)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_RESOLVEPROCESSORS_OFFSET UNITYSDK_OFFSET(0x95CFA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_STARTWITHARRAYSFROM_OFFSET UNITYSDK_OFFSET(0x95CF30)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingResolver_TypeDefinitionIndex = 31585;
