...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_EXCEPTIONHELPERS_ISEXCEPTIONINDICATINGBUGINCODE_OFFSET UNITYSDK_OFFSET(0x1F12FF10)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int ExceptionHelpers_TypeDefinitionIndex = 32665;
