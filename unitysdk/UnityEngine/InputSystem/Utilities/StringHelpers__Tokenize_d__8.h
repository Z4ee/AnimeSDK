...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F16E7B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F16ECD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F16EC20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F16ED50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F16EC80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F16EC30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F16E7A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1F16E780)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers__Tokenize_d__8_TypeDefinitionIndex = 32705;
	...
	public:
		...
		::UnityEngine::InputSystem::Utilities::Substring __2__current; // 0x20
		::System::Int32 _length_5__2; // 0x30
