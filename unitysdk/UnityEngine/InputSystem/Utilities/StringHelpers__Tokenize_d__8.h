...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DD848B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DD84DF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DD84D40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DD84E70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DD84DA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DD84D50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DD848A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD84880)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers__Tokenize_d__8_TypeDefinitionIndex = 32085;

	class StringHelpers__Tokenize_d__8 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::Utilities::Substring __2__current; // 0x10
		::System::String* __3__str; // 0x20
		::System::String* str; // 0x28
		::System::Int32 __1__state; // 0x30
		::System::Int32 __l__initialThreadId; // 0x34
		::System::Int32 _endPos_5__3; // 0x38
