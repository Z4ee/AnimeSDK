...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_VECTOR3MAGNITUDECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x95D8B0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int Vector3MagnitudeComparer_TypeDefinitionIndex = 32042;
