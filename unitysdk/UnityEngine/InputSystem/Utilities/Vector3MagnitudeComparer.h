...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_VECTOR3MAGNITUDECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x9A7650)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int Vector3MagnitudeComparer_TypeDefinitionIndex = 32662;
