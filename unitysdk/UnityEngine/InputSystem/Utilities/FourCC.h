...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x965820)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_EQUALS_OFFSET UNITYSDK_OFFSET(0x661410)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_FROMINT32_OFFSET UNITYSDK_OFFSET(0x1B35DB60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B35DB50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B355070)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B35D7A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B35C940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_TOINT32_OFFSET UNITYSDK_OFFSET(0x1B35DB70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x965810)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9657E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_2_OFFSET UNITYSDK_OFFSET(0x965800)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_OFFSET UNITYSDK_OFFSET(0x2E85F0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int FourCC_TypeDefinitionIndex = 29390;
