...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA12630)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_COMPARE_OFFSET UNITYSDK_OFFSET(0x1D8B4CF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA12450)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0xA12580)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_3_OFFSET UNITYSDK_OFFSET(0xA125C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0xA12440)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA127E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x5CCB30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA128A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1D8B4FF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1D8B50D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D8B4F70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D8B51A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1D8B5060)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1D8B5130)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D8B4FB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_STARTSWITH_OFFSET UNITYSDK_OFFSET(0xA12670)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_SUBSTR_OFFSET UNITYSDK_OFFSET(0xA12780)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA127B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x32DA80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA12410)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0xA123F0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int Substring_TypeDefinitionIndex = 32087;
