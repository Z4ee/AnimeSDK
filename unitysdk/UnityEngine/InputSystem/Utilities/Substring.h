...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA66BB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_COMPARE_OFFSET UNITYSDK_OFFSET(0x1EC405D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA669D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0xA66B00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_3_OFFSET UNITYSDK_OFFSET(0xA66B40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0xA669C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA66D70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xA66960)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA66E20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x330F60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1EC408C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1EC409A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1EC40840)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1EC40A70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1EC40930)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1EC40A00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1EC40880)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_STARTSWITH_OFFSET UNITYSDK_OFFSET(0xA66C00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_SUBSTR_OFFSET UNITYSDK_OFFSET(0xA66D10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA66D40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x355940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA66990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0xA66970)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int Substring_TypeDefinitionIndex = 32707;
