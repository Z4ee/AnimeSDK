...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1F12FFD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONERROR_OFFSET UNITYSDK_OFFSET(0x1F12FFE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONNEXT_OFFSET UNITYSDK_OFFSET(0x1F130040)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F12FFC0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int ForDeviceEventObservable_ForDevice_TypeDefinitionIndex = 32685;
