...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_ACTION_OFFSET UNITYSDK_OFFSET(0xA4E820)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0xA4E860)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xA4E950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_INTERACTION_OFFSET UNITYSDK_OFFSET(0xA4E8B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xA4E850)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0xA4E940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_TIME_OFFSET UNITYSDK_OFFSET(0xA4E910)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0xA4E980)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0xA4E990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_READVALUE_OFFSET UNITYSDK_OFFSET(0xA4E9A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA4E9B0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_ActionEventPtr_TypeDefinitionIndex = 32033;
