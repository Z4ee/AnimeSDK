...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_ACTION_OFFSET UNITYSDK_OFFSET(0xAA04B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0xAA04F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xAA05E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_INTERACTION_OFFSET UNITYSDK_OFFSET(0xAA0540)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xAA04E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0xAA05D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_TIME_OFFSET UNITYSDK_OFFSET(0xAA05A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0xAA0610)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0xAA0620)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_READVALUE_OFFSET UNITYSDK_OFFSET(0xAA0630)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAA0640)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_ActionEventPtr_TypeDefinitionIndex = 32653;
