...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9658C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x965890)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x965930)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B35DF80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B35DFE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B35DFB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x965880)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int JsonParser_JsonString_TypeDefinitionIndex = 29397;
