...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1F16DA10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_DISPOSEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F16DB10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F16E160)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1F16DAA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F16E0E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1F16C830)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1F16C850)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_HOOKONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F16CF70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F16E200)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_RECORDACTION_OFFSET UNITYSDK_OFFSET(0x1F16D5D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETOALL_OFFSET UNITYSDK_OFFSET(0x1F16CDF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETO_1_OFFSET UNITYSDK_OFFSET(0x1F16CC80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETO_OFFSET UNITYSDK_OFFSET(0x1F16C8E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F16E180)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F16DC60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNHOOKONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F16D4F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROMALL_OFFSET UNITYSDK_OFFSET(0x1F16D380)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROM_1_OFFSET UNITYSDK_OFFSET(0x1F16D230)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROM_OFFSET UNITYSDK_OFFSET(0x1F16D060)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F16C870)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F16CAD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F16C860)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_TypeDefinitionIndex = 32652;

	class InputActionTrace : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*> m_ActionMapStateClones; // 0x10
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputAction*> m_SubscribedActions; // 0x28
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*> m_ActionMapStates; // 0x40
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionMap*> m_SubscribedActionMaps; // 0x58
		::System::Action_2<::System::Object*, ::UnityEngine::InputSystem::InputActionChange>* m_ActionChangeDelegate; // 0x70
		::System::Action_1<::UnityEngine::InputSystem::InputAction_CallbackContext>* m_CallbackDelegate; // 0x78
		::UnityEngine::InputSystem::LowLevel::InputEventBuffer m_EventBuffer; // 0x80
		::System::Boolean m_SubscribedToAll; // 0xA0
		::System::Boolean m_OnActionChangeHooked; // 0xA1
