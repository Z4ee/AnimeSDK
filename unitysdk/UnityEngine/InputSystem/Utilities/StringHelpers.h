...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_CHARACTERSEPARATEDLISTSHAVEATLEASTONECOMMONELEMENT_OFFSET UNITYSDK_OFFSET(0x1D8E11E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1D8E0CA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D8DB4E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_COUNTOCCURRENCES_OFFSET UNITYSDK_OFFSET(0x1D8E10D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_ESCAPE_OFFSET UNITYSDK_OFFSET(0x1D8E0550)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_EXPANDTEMPLATESTRING_OFFSET UNITYSDK_OFFSET(0x1D8E2030)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_FROMNICIFIEDMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1D8E0F60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_GETPLURAL_OFFSET UNITYSDK_OFFSET(0x1D8E0CD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_INVARIANTEQUALSIGNORECASE_OFFSET UNITYSDK_OFFSET(0x1D8E2000)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_ISPRINTABLE_OFFSET UNITYSDK_OFFSET(0x1D8E1D40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_NICIFYMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1D8E0E20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_PARSEINT_OFFSET UNITYSDK_OFFSET(0x1D8E18B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_READSTRINGFROMBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1D8E1C10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_READSTRINGFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x1D8E1BF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_SPLIT_OFFSET UNITYSDK_OFFSET(0x1D8E1180)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x1D8E1120)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x1D8E0940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_WITHALLWHITESPACESTRIPPED_OFFSET UNITYSDK_OFFSET(0x1D8E1DE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_WRITESTRINGTOBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1D8E1A00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_WRITESTRINGTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1D8E19E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers_TypeDefinitionIndex = 32084;
