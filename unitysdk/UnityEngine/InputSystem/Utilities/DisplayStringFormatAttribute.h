...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_DISPLAYSTRINGFORMATATTRIBUTE_GET_FORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1B9F4F50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_DISPLAYSTRINGFORMATATTRIBUTE_SET_FORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1B9F4F60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_DISPLAYSTRINGFORMATATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F4F70)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int DisplayStringFormatAttribute_TypeDefinitionIndex = 29388;
