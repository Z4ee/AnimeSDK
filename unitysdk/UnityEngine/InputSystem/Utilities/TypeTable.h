...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_ADDTYPEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x9C1F50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_FINDNAMEFORTYPE_OFFSET UNITYSDK_OFFSET(0x9C1F30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_GET_INTERNEDNAMES_OFFSET UNITYSDK_OFFSET(0x9C1E50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x9C1E40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9C1EA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_LOOKUPTYPEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x9C1F60)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int TypeTable_TypeDefinitionIndex = 29433;
