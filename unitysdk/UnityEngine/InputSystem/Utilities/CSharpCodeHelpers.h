...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_ISEMPTYORPROPERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B35CFD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_ISEMPTYORPROPERNAMESPACENAME_OFFSET UNITYSDK_OFFSET(0x1B35CFF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_ISPROPERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B35CEA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_MAKEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B35D0D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_MAKETYPENAME_OFFSET UNITYSDK_OFFSET(0x1B35D400)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int CSharpCodeHelpers_TypeDefinitionIndex = 29383;
