...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x9ACDD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9ACE30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9ACDF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BC4A470)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMBYTE_OFFSET UNITYSDK_OFFSET(0x1BC4A4B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMCHAR_OFFSET UNITYSDK_OFFSET(0x1BC4A490)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BC4A5D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT16_OFFSET UNITYSDK_OFFSET(0x1BC4A4F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT32_OFFSET UNITYSDK_OFFSET(0x1BC4A530)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT64_OFFSET UNITYSDK_OFFSET(0x1BC4A570)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMOBJECT_OFFSET UNITYSDK_OFFSET(0x1BC49370)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSBYTE_OFFSET UNITYSDK_OFFSET(0x1BC4A4D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSINGLE_OFFSET UNITYSDK_OFFSET(0x1BC4A5B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x1BC49C00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT16_OFFSET UNITYSDK_OFFSET(0x1BC4A510)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT32_OFFSET UNITYSDK_OFFSET(0x1BC4A550)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT64_OFFSET UNITYSDK_OFFSET(0x1BC4A590)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9ACE40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x687BF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BC49790)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_10_OFFSET UNITYSDK_OFFSET(0x1BC49120)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_11_OFFSET UNITYSDK_OFFSET(0x1BC49210)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1BC48C20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1BC48CB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1BC48D40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1BC48DE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1BC4A430)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1BC48E80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1BC4A450)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_8_OFFSET UNITYSDK_OFFSET(0x1BC48F20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_9_OFFSET UNITYSDK_OFFSET(0x1BC49000)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1BC48BA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BC497D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x9ACE70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOBYTE_OFFSET UNITYSDK_OFFSET(0x9ACE80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x9ACEF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODATETIME_OFFSET UNITYSDK_OFFSET(0x9ACF50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x9ACFA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x9AD0A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT16_OFFSET UNITYSDK_OFFSET(0x9AD170)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT32_OFFSET UNITYSDK_OFFSET(0x9AD1F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT64_OFFSET UNITYSDK_OFFSET(0x9AD270)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOOBJECT_OFFSET UNITYSDK_OFFSET(0x9AD680)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSBYTE_OFFSET UNITYSDK_OFFSET(0x9ACE80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x9AD2F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9ACE60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9ACE60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOTYPE_OFFSET UNITYSDK_OFFSET(0x9AD3F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x9AD440)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x9AD500)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x9AD5C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x9ACD90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x9ACDB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9ACC70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9ACC90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9ACCB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x9ACCD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x9ACCF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x9ACD10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x9ACD30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x9ACD50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x9ACD70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x9ACC50)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int PrimitiveValue_TypeDefinitionIndex = 29421;
