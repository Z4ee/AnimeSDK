...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D3CC820)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x9ECE00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9ECDB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9ECE90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D3CA460)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D3CBB40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1D3CBB70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1D3CC470)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1D3CBA90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1D3CBB10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1D3CC4B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1D3CC4E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D3CBE00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D3CD620)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x9ECB50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x9ECD00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOINTEGER_OFFSET UNITYSDK_OFFSET(0x9ECC70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9ECDA0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int JsonParser_JsonValue_TypeDefinitionIndex = 32054;
