...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AFA2CB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x94A990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x94A940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x94AA20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AFA08F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AFA1FD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1AFA2000)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1AFA2900)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1AFA1F20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1AFA1FA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1AFA2940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1AFA2970)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AFA2290)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AFA3AB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x94A6E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x94A890)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOINTEGER_OFFSET UNITYSDK_OFFSET(0x94A800)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94A930)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int JsonParser_JsonValue_TypeDefinitionIndex = 29398;
