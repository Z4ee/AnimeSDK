...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_APPLYTOOBJECT_OFFSET UNITYSDK_OFFSET(0xA0CCC0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_CONVERTTO_OFFSET UNITYSDK_OFFSET(0xA0CA30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA0CB70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA0CB00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA0CC10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3E4320)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D7A88B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D7A8920)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_PARSEMULTIPLE_OFFSET UNITYSDK_OFFSET(0x1D7A3B00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_PARSEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D7A8990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_PARSE_OFFSET UNITYSDK_OFFSET(0x1D7A91D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2B6D10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA0CA20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA0CA70)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int NamedValue_TypeDefinitionIndex = 32062;
