...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x9B2B10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION_OVERLAP_OFFSET UNITYSDK_OFFSET(0x9B2B30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9B2B20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x293FB0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int MemoryHelpers_BitRegion_TypeDefinitionIndex = 29401;
