...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B9F6B80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B9F6E10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B9F6DA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B9F6E90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B9F6E00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B9F6DB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B9F6B70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F6B50)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers__Split_d__9_TypeDefinitionIndex = 29430;

	class StringHelpers__Split_d__9 : public ::System::Object
	{
	public:
		::System::Func_2<::System::Char, ::System::Boolean>* __3__predicate; // 0x10
		::System::String* __2__current; // 0x18
		::System::String* __3__str; // 0x20
		::System::Func_2<::System::Char, ::System::Boolean>* predicate; // 0x28
		::System::String* str; // 0x30
		::System::Int32 __1__state; // 0x38
		::System::Int32 _position_5__3; // 0x3C
		::System::Int32 __l__initialThreadId; // 0x40
		::System::Int32 _length_5__2; // 0x44
