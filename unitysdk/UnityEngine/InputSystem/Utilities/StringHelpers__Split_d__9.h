...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F16E3F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F16E680)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F16E610)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F16E700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F16E670)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F16E620)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F16E3E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1F16E3C0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers__Split_d__9_TypeDefinitionIndex = 32706;

	class StringHelpers__Split_d__9 : public ::System::Object
	{
	public:
		::System::Func_2<::System::Char, ::System::Boolean>* predicate; // 0x10
		::System::String* str; // 0x18
		::System::String* __3__str; // 0x20
		::System::String* __2__current; // 0x28
		::System::Func_2<::System::Char, ::System::Boolean>* __3__predicate; // 0x30
