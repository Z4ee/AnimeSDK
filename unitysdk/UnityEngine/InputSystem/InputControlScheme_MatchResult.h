...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA3D160)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA3D0F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0xA3D030)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_HASMISSINGOPTIONALDEVICES_OFFSET UNITYSDK_OFFSET(0x5882B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_HASMISSINGREQUIREDDEVICES_OFFSET UNITYSDK_OFFSET(0x5882A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_ISSUCCESSFULMATCH_OFFSET UNITYSDK_OFFSET(0xA3D020)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA3D050)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x40C5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA3D0F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_MatchResult_TypeDefinitionIndex = 31587;
