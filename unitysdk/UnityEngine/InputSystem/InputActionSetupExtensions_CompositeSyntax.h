...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_COMPOSITESYNTAX_GET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0xA0B520)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_COMPOSITESYNTAX_WITH_OFFSET UNITYSDK_OFFSET(0xA0B560)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_COMPOSITESYNTAX__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B550)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_CompositeSyntax_TypeDefinitionIndex = 31558;
