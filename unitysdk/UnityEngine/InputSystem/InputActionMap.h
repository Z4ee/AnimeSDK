...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ADD_ACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1E7750A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLEARACTIONLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x1E775710)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLEARCACHEDACTIONDATA_OFFSET UNITYSDK_OFFSET(0x1E776B90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLONE_OFFSET UNITYSDK_OFFSET(0x1E775C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1E775E70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DISABLE_OFFSET UNITYSDK_OFFSET(0x1E775BF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E775160)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ENABLE_OFFSET UNITYSDK_OFFSET(0x1E775B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTIONINDEX_1_OFFSET UNITYSDK_OFFSET(0x1E775780)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1E775180)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTION_1_OFFSET UNITYSDK_OFFSET(0x1E775940)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTION_OFFSET UNITYSDK_OFFSET(0x1E774FB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDBINDINGRELATIVETOMAP_OFFSET UNITYSDK_OFFSET(0x1E7782A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x1E778140)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1E778320)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GENERATEID_OFFSET UNITYSDK_OFFSET(0x1E7748E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETBINDINGSFORSINGLEACTION_OFFSET UNITYSDK_OFFSET(0x1E7761D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETCONTROLSFORSINGLEACTION_OFFSET UNITYSDK_OFFSET(0x1E776B40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E776030)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x1E774980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1E774850)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1E774BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1E7749B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1E774A50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1E774D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1E774970)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_IDDONTGENERATE_OFFSET UNITYSDK_OFFSET(0x1E774930)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ID_OFFSET UNITYSDK_OFFSET(0x1E774860)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E774EA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E774840)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ISUSABLEWITHDEVICE_OFFSET UNITYSDK_OFFSET(0x1E7759A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_LAZYRESOLVEBINDINGS_OFFSET UNITYSDK_OFFSET(0x1E774D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E778510)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E778500)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_REMOVE_ACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1E7750F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_RESOLVEBINDINGSIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1E775BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_RESOLVEBINDINGS_OFFSET UNITYSDK_OFFSET(0x1E776BB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SETUPACTIONLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x1E7754C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SETUPPERACTIONCONTROLANDBINDINGARRAYS_OFFSET UNITYSDK_OFFSET(0x1E776220)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1E774C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1E774E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E776100)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1E775E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1E778430)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOJSON_OFFSET UNITYSDK_OFFSET(0x1E7783A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E775EA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_UNITYENGINE_INPUTSYSTEM_IINPUTACTIONCOLLECTION2_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1E7749E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E775150)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E775140)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_TypeDefinitionIndex = 32155;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputActionMap_TypeDefinitionIndex)->GetStaticField(0x7D40);
		}
