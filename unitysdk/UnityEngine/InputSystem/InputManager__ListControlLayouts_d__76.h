...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D79D6B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D79E040)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D79DFD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D79E0E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D79E030)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D79DFE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D79D620)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79D600)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1D79D650)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1D79D660)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY3_OFFSET UNITYSDK_OFFSET(0x1D79D670)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY4_OFFSET UNITYSDK_OFFSET(0x1D79D680)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY5_OFFSET UNITYSDK_OFFSET(0x1D79D690)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY6_OFFSET UNITYSDK_OFFSET(0x1D79D6A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager__ListControlLayouts_d__76_TypeDefinitionIndex = 31689;

	class InputManager__ListControlLayouts_d__76 : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2_Enumerator<::UnityEngine::InputSystem::Utilities::InternedString, ::System::Type*> __7__wrap2; // 0x10
		::UnityEngine::InputSystem::Utilities::InternedString _internedBasedOn_5__2; // 0x40
		::System::Collections::Generic::Dictionary_2_Enumerator<::UnityEngine::InputSystem::Utilities::InternedString, ::System::Func_1<::UnityEngine::InputSystem::Layouts::InputControlLayout*>*> __7__wrap4; // 0x50
		::System::String* basedOn; // 0x80
		::System::Collections::Generic::Dictionary_2_Enumerator<::UnityEngine::InputSystem::Utilities::InternedString, ::System::String*> __7__wrap3; // 0x88
		::System::String* __2__current; // 0xB8
		::System::String* __3__basedOn; // 0xC0
