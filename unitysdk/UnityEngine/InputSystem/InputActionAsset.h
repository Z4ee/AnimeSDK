...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A031600)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_DISABLE_OFFSET UNITYSDK_OFFSET(0x1A031490)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1A0312F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTIONMAP_1_OFFSET UNITYSDK_OFFSET(0x1A030D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A0309C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTION_1_OFFSET UNITYSDK_OFFSET(0x1A030EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTION_OFFSET UNITYSDK_OFFSET(0x1A0302B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x1A0308E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDCONTROLSCHEMEINDEX_OFFSET UNITYSDK_OFFSET(0x1A030F90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A031090)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1A030850)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A031680)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_ACTIONMAPS_OFFSET UNITYSDK_OFFSET(0x1A02FC80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1A02FD40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1A02FCE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1A02FCB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A02FF60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A02FB20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A030220)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_ISUSABLEWITHDEVICE_OFFSET UNITYSDK_OFFSET(0x1A031180)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_LOADFROMJSON_OFFSET UNITYSDK_OFFSET(0x1A0307C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_MARKASDIRTY_OFFSET UNITYSDK_OFFSET(0x1A031720)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A031730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_RERESOLVEIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A02FEF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1A02FD80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A030000)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0316D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_TOJSON_OFFSET UNITYSDK_OFFSET(0x1A0306E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A031770)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset_TypeDefinitionIndex = 28873;
