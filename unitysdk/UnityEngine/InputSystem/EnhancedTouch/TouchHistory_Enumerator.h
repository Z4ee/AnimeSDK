...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EAD2E50)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EAD2D80)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EAD2D50)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EAD2D70)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EAD2DD0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAD2D30)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchHistory_Enumerator_TypeDefinitionIndex = 32436;
