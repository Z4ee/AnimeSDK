...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B34EB60)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B34EA90)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B34EA60)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B34EA80)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B34EAE0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34EA40)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchHistory_Enumerator_TypeDefinitionIndex = 29160;
