...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ADDPOINTER_OFFSET UNITYSDK_OFFSET(0x1EAFD8F0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_DESTROY_OFFSET UNITYSDK_OFFSET(0x1EAFD5D0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_DISABLE_OFFSET UNITYSDK_OFFSET(0x1EAFD480)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ENABLE_OFFSET UNITYSDK_OFFSET(0x1EAFD250)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1EAFD240)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_GET_SIMULATEDTOUCHSCREEN_OFFSET UNITYSDK_OFFSET(0x1EAFD220)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_INSTALLSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1EAFF4A0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1EAFEB10)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EAFF230)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EAFED50)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1EAFE290)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONSOURCECONTROLCHANGEDVALUE_OFFSET UNITYSDK_OFFSET(0x1EAFF4B0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_REMOVEPOINTER_OFFSET UNITYSDK_OFFSET(0x1EAFDB30)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_SET_SIMULATEDTOUCHSCREEN_OFFSET UNITYSDK_OFFSET(0x1EAFD230)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNINSTALLSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1EAFF4C0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1EAFF480)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x1EAFF490)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UPDATETOUCH_OFFSET UNITYSDK_OFFSET(0x1EAFDE50)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAFF4D0)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchSimulation_TypeDefinitionIndex = 32437;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation**)Il2CppClass::FromTypeDefinitionIndex(TouchSimulation_TypeDefinitionIndex)->GetStaticField(0x27580);
		}
