...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ADDPOINTER_OFFSET UNITYSDK_OFFSET(0x1D74E680)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D74E360)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_DISABLE_OFFSET UNITYSDK_OFFSET(0x1D74E210)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ENABLE_OFFSET UNITYSDK_OFFSET(0x1D74DFE0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D74DFD0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_GET_SIMULATEDTOUCHSCREEN_OFFSET UNITYSDK_OFFSET(0x1D74DFB0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_INSTALLSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1D7502C0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1D74F8B0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D750050)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D74FAF0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1D74F060)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONSOURCECONTROLCHANGEDVALUE_OFFSET UNITYSDK_OFFSET(0x1D7502D0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_REMOVEPOINTER_OFFSET UNITYSDK_OFFSET(0x1D74E8C0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_SET_SIMULATEDTOUCHSCREEN_OFFSET UNITYSDK_OFFSET(0x1D74DFC0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNINSTALLSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x1D7502E0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1D7502A0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x1D7502B0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UPDATETOUCH_OFFSET UNITYSDK_OFFSET(0x1D74EBE0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7502F0)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchSimulation_TypeDefinitionIndex = 31817;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation**)Il2CppClass::FromTypeDefinitionIndex(TouchSimulation_TypeDefinitionIndex)->GetStaticField(0x25E00);
		}
