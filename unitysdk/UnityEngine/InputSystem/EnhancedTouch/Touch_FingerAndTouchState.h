...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_ADDFINGERS_OFFSET UNITYSDK_OFFSET(0x96F9C0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x96F9E0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_REMOVEFINGERS_OFFSET UNITYSDK_OFFSET(0x96F9D0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_UPDATEACTIVEFINGERS_OFFSET UNITYSDK_OFFSET(0x96F9F0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_UPDATEACTIVETOUCHES_OFFSET UNITYSDK_OFFSET(0x96FA00)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int Touch_FingerAndTouchState_TypeDefinitionIndex = 29156;
