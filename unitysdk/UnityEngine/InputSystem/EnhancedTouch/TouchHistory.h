...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_CHECKVALID_OFFSET UNITYSDK_OFFSET(0xA633F0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA63360)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2B7CC0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA633D0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA63360)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xA63300)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchHistory_TypeDefinitionIndex = 31815;
