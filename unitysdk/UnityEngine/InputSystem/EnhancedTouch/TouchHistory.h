...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_CHECKVALID_OFFSET UNITYSDK_OFFSET(0xAB5000)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAB4F70)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x325D00)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xAB4FE0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAB4F70)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xAB4F10)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchHistory_TypeDefinitionIndex = 32435;
