...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_FINDTOUCH_OFFSET UNITYSDK_OFFSET(0x1CE35C70)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GETTOUCHHISTORY_OFFSET UNITYSDK_OFFSET(0x1CE35FF0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_CURRENTTOUCH_OFFSET UNITYSDK_OFFSET(0x1CE35250)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1CE351E0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1CE351F0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_LASTTOUCH_OFFSET UNITYSDK_OFFSET(0x1CE354C0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x1CE353E0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_SCREEN_OFFSET UNITYSDK_OFFSET(0x1CE351D0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_TOUCHHISTORY_OFFSET UNITYSDK_OFFSET(0x1CE35520)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_ONTOUCHRECORDED_OFFSET UNITYSDK_OFFSET(0x1CE35990)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_SHOULDRECORDTOUCH_OFFSET UNITYSDK_OFFSET(0x1CE35920)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE35560)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int Finger_TypeDefinitionIndex = 32429;

	class Finger : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<::UnityEngine::InputSystem::LowLevel::TouchState>* m_StateHistory; // 0x10
		::UnityEngine::InputSystem::Touchscreen* _screen_k__BackingField; // 0x18
