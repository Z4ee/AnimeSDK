...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x1A051B40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A052590)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A052890)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONDEVICELOST_OFFSET UNITYSDK_OFFSET(0x1A052690)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x1A052790)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ASSIGNPLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1A056230)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ASSIGNUSERANDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A050CE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_CACHEMESSAGENAMES_OFFSET UNITYSDK_OFFSET(0x1A055180)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_CLEARCACHES_OFFSET UNITYSDK_OFFSET(0x1A050CD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEACTIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x1A053430)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEBUGLOGACTION_OFFSET UNITYSDK_OFFSET(0x1A0573B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DOINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x1A054720)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_FINDFIRSTPAIREDTODEVICE_OFFSET UNITYSDK_OFFSET(0x1A054170)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GETPLAYERBYINDEX_OFFSET UNITYSDK_OFFSET(0x1A054030)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1A052320)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x1A04FF20)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1A04FEF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ALL_OFFSET UNITYSDK_OFFSET(0x1A052FD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x1A052990)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CONTROLSCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1A052520)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A0521F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CURRENTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A051D10)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEFAULTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A0522A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEFAULTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A051E30)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICELOSTEVENT_OFFSET UNITYSDK_OFFSET(0x1A052440)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICEREGAINEDEVENT_OFFSET UNITYSDK_OFFSET(0x1A0524B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A052D90)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_HASMISSINGREQUIREDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A052EC0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_INPUTISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A04FEE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ISSINGLEPLAYER_OFFSET UNITYSDK_OFFSET(0x1A053050)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_NEVERAUTOSWITCHCONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1A051E50)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0522C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1A04FF00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_SPLITSCREENINDEX_OFFSET UNITYSDK_OFFSET(0x1A04FF10)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_UIINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x1A0529B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_USER_OFFSET UNITYSDK_OFFSET(0x1A052D80)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLECONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A056CF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLEDEVICELOST_OFFSET UNITYSDK_OFFSET(0x1A057410)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLEDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x1A0574F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HAVEBINDINGFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1A055DF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INITIALIZEACTIONS_OFFSET UNITYSDK_OFFSET(0x1A04FF70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTALLONACTIONTRIGGEREDHOOK_OFFSET UNITYSDK_OFFSET(0x1A054F70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0x1A054D00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x1A054500)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A0558D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A058550)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A056E40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A0564B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONPREFILTERUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x1A0577B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x1A0579E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONUSERCHANGE_OFFSET UNITYSDK_OFFSET(0x1A0575D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_PASSIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x1A053470)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A052610)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A052910)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONDEVICELOST_OFFSET UNITYSDK_OFFSET(0x1A052710)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x1A052810)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_ACTIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1A0523C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x1A0507E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_CAMERA_OFFSET UNITYSDK_OFFSET(0x1A0529A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_CURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A052200)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_DEFAULTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A0522B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_DEFAULTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A051E40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_NEVERAUTOSWITCHCONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1A051E60)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0522D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_UIINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x1A0529C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STARTLISTENINGFORDEVICECHANGES_OFFSET UNITYSDK_OFFSET(0x1A056C50)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STARTLISTENINGFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1A051F70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STOPLISTENINGFORDEVICECHANGES_OFFSET UNITYSDK_OFFSET(0x1A056DD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STOPLISTENINGFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1A052120)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCONTROLSCHEMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A053760)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A0531C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTCONTROLSCHEME_1_OFFSET UNITYSDK_OFFSET(0x1A053F40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A0534B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_TRYTOACTIVATECONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A055AA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNASSIGNUSERANDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A055FA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNINITIALIZEACTIONS_OFFSET UNITYSDK_OFFSET(0x1A0509B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNINSTALLONACTIONTRIGGEREDHOOK_OFFSET UNITYSDK_OFFSET(0x1A0556F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A058780)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A058720)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInput_TypeDefinitionIndex = 29045;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x22890);
		}
		static ::System::String** StaticGet_s_InitControlScheme()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x22898);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::PlayerInput*>** StaticGet_s_AllActivePlayers()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::PlayerInput*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x228A0);
		}
		...
		{
			return (::System::Action_3<::UnityEngine::InputSystem::Users::InputUser, ::UnityEngine::InputSystem::Users::InputUserChange, ::UnityEngine::InputSystem::InputDevice*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x228A8);
		}
		static ::System::Int32* StaticGet_s_InitSplitScreenIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D30);
		}
		static ::System::Int32* StaticGet_s_AllActivePlayersCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D34);
		}
		static ::System::Int32* StaticGet_s_InitPairWithDevicesCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D38);
		}
		static ::System::Boolean* StaticGet_s_DestroyIfDeviceSetupUnsuccessful()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D3C);
		}
		static ::System::Int32* StaticGet_s_InitPlayerIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D40);
		}
