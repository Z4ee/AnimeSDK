...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1EAD0630)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_GET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1EAD05D0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_GET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x1EAD0610)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_GET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1EAD05F0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_SET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1EAD05E0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_SET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x1EAD0620)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_SET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1EAD0600)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAD0830)

namespace UnityEngine::InputSystem::DualShock
{
	inline static constexpr unsigned int DualShock3GamepadHID_TypeDefinitionIndex = 32445;
