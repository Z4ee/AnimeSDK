...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B9F04F0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9492B0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B9F04D0)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDUSBOutputReport_TypeDefinitionIndex = 29175;
