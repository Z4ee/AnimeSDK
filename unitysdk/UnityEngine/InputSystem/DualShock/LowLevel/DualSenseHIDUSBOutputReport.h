...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1DD7DE70)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9EB720)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DD7DE50)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDUSBOutputReport_TypeDefinitionIndex = 31831;
