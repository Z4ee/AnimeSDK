...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1EB405A0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA37A20)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EB40580)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDBluetoothOutputReport_TypeDefinitionIndex = 32452;
