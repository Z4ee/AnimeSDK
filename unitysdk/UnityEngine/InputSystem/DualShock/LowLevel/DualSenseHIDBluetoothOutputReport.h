...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1D79BE70)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9EB720)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D79BE50)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDBluetoothOutputReport_TypeDefinitionIndex = 31832;
