...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1AF8E4A0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9492B0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AF8E380)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x949320)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x9492C0)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualShockHIDOutputReport_TypeDefinitionIndex = 29181;
