...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B34C600)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_GET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1B34C5A0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_GET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x1B34C5E0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_GET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1B34C5C0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B34C740)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B34C7C0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B34C860)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1B34CB10)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SETMOTORSPEEDSANDLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1B34CD10)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1B34CC10)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1B34C5B0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x1B34C5F0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1B34C5D0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34CED0)

namespace UnityEngine::InputSystem::DualShock
{
	inline static constexpr unsigned int DualShock4GamepadHID_TypeDefinitionIndex = 29168;
