...
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_HOLDINTERACTION_GET_DURATIONORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1EC3ED80)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_HOLDINTERACTION_GET_PRESSPOINTORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1EC3EE70)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_HOLDINTERACTION_PROCESS_OFFSET UNITYSDK_OFFSET(0x1EC3EE90)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_HOLDINTERACTION_RESET_OFFSET UNITYSDK_OFFSET(0x1EC3F280)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_HOLDINTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC3F290)

namespace UnityEngine::InputSystem::Interactions
{
	inline static constexpr unsigned int HoldInteraction_TypeDefinitionIndex = 32645;

	class HoldInteraction : public ::System::Object
	{
	public:
		::System::Double m_TimePressed; // 0x10
