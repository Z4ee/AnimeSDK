...
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_GET_DURATIONORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1F37A200)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_GET_PRESSPOINTORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1F37A2F0)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_PROCESS_OFFSET UNITYSDK_OFFSET(0x1F37A310)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_RESET_OFFSET UNITYSDK_OFFSET(0x1F37A6A0)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F37A6B0)

namespace UnityEngine::InputSystem::Interactions
{
	inline static constexpr unsigned int SlowTapInteraction_TypeDefinitionIndex = 32650;
