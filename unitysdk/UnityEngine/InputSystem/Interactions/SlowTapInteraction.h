...
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_GET_DURATIONORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1DF77510)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_GET_PRESSPOINTORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1DF77600)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_PROCESS_OFFSET UNITYSDK_OFFSET(0x1DF77620)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION_RESET_OFFSET UNITYSDK_OFFSET(0x1DF779A0)
#define UNITYENGINE_INPUTSYSTEM_INTERACTIONS_SLOWTAPINTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF779B0)

namespace UnityEngine::InputSystem::Interactions
{
	inline static constexpr unsigned int SlowTapInteraction_TypeDefinitionIndex = 32030;
