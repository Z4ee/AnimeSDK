...
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_BACKGROUNDBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1F8101C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_BUTTONRELEASETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1F8100A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_COMPENSATEFORSCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1F80FFB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTBUTTONPRESSPOINT_OFFSET UNITYSDK_OFFSET(0x1F810050)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTDEADZONEMAX_OFFSET UNITYSDK_OFFSET(0x1F810020)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTDEADZONEMIN_OFFSET UNITYSDK_OFFSET(0x1F80FFF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTHOLDTIME_OFFSET UNITYSDK_OFFSET(0x1F810130)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTSLOWTAPTIME_OFFSET UNITYSDK_OFFSET(0x1F810100)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTTAPTIME_OFFSET UNITYSDK_OFFSET(0x1F8100D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DISABLEREDUNDANTEVENTSMERGING_OFFSET UNITYSDK_OFFSET(0x1F810380)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_EDITORINPUTBEHAVIORINPLAYMODE_OFFSET UNITYSDK_OFFSET(0x1F8101E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_FILTERNOISEONCURRENT_OFFSET UNITYSDK_OFFSET(0x1F80FFD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MAXEVENTBYTESPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1F810200)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MAXQUEUEDEVENTSPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1F810220)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MULTITAPDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1F810190)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1F810240)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_TAPRADIUS_OFFSET UNITYSDK_OFFSET(0x1F810160)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1F80FE10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_ISFEATUREENABLED_OFFSET UNITYSDK_OFFSET(0x1F810560)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F80FE30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SETINTERNALFEATUREFLAG_OFFSET UNITYSDK_OFFSET(0x1F8103A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_BACKGROUNDBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1F8101D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_BUTTONRELEASETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1F8100B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_COMPENSATEFORSCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1F80FFC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTBUTTONPRESSPOINT_OFFSET UNITYSDK_OFFSET(0x1F810060)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTDEADZONEMAX_OFFSET UNITYSDK_OFFSET(0x1F810030)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTDEADZONEMIN_OFFSET UNITYSDK_OFFSET(0x1F810000)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTHOLDTIME_OFFSET UNITYSDK_OFFSET(0x1F810140)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTSLOWTAPTIME_OFFSET UNITYSDK_OFFSET(0x1F810110)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTTAPTIME_OFFSET UNITYSDK_OFFSET(0x1F8100E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DISABLEREDUNDANTEVENTSMERGING_OFFSET UNITYSDK_OFFSET(0x1F810390)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_EDITORINPUTBEHAVIORINPLAYMODE_OFFSET UNITYSDK_OFFSET(0x1F8101F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_FILTERNOISEONCURRENT_OFFSET UNITYSDK_OFFSET(0x1F80FFE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MAXEVENTBYTESPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1F810210)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MAXQUEUEDEVENTSPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1F810230)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MULTITAPDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1F8101A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1F810270)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_TAPRADIUS_OFFSET UNITYSDK_OFFSET(0x1F810170)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1F80FE20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8105E0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputSettings_TypeDefinitionIndex = 32311;
