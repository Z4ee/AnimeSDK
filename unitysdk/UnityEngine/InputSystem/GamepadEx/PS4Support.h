...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS4SUPPORT_INITIALIZATION_OFFSET UNITYSDK_OFFSET(0x1DCFC320)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS4SUPPORT_INITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1DCFC190)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS4SUPPORT_RUNINITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1DCFC210)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS4SUPPORT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DCFC0C0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int PS4Support_TypeDefinitionIndex = 39064;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(PS4Support_TypeDefinitionIndex)->GetStaticField(0x9410);
		}
