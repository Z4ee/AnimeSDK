...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCFD200)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCFD2B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCFB830)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCFD1E0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int ProcessGyroInput_TypeDefinitionIndex = 39081;
