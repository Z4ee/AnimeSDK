...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F166850)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F166900)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F164E80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F166830)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int ProcessGyroInput_TypeDefinitionIndex = 39747;
