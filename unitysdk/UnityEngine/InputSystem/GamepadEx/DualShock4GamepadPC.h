...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1DCFB360)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1DCFB2D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1DCFAC30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1DCFAB80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1DCFAB00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1DCFAB40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1DCFAB60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DCFAB20)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCFB3F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1DCFB430)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1DCFAB10)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1DCFAB50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1DCFAB70)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DCFAB30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1DCFB620)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCFB570)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1DCFB5D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCFB680)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1DCFB6C0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualShock4GamepadPC_TypeDefinitionIndex = 39063;
	...
	public:
		...
		::System::Int32 _lastFrameCount; // 0x278
		::UnityEngine::Quaternion _AttitudeV2_k__BackingField; // 0x27C
		::System::Int32 _angularVelocityV2; // 0x28C
		::System::Nullable_1<::System::Double> _lastTimestamp; // 0x290
