...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1B984690)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1B984600)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1B983F60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B983EB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B983E30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B983E70)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1B983E90)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B983E50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B984720)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1B984760)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B983E40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B983E80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1B983EA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B983E60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1B984950)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B9848A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1B984900)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9849B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B9849F0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualShock4GamepadPC_TypeDefinitionIndex = 37437;

	class DualShock4GamepadPC : public ::UnityEngine::InputSystem::DualShock::DualShock4GamepadHID
	{
	public:
		::UnityEngine::InputSystem::Controls::QuaternionControl* _orientation_k__BackingField; // 0x260
		...
		::System::Int32 _angularVelocityV2; // 0x288
		::System::Int32 _lastFrameCount; // 0x28C
		::UnityEngine::Quaternion _AttitudeV2_k__BackingField; // 0x290
