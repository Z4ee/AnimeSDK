...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B9810B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9492B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B983C50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x999AA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x999960)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x9997A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_1_OFFSET UNITYSDK_OFFSET(0x9998F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x9998B0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseHIDOutputReport_TypeDefinitionIndex = 37443;
