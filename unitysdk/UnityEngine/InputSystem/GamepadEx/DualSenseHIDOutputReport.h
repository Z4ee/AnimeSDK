...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1F1612B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA37A20)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1F163F30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0xA92930)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xA927F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0xA92630)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_1_OFFSET UNITYSDK_OFFSET(0xA92780)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0xA92740)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseHIDOutputReport_TypeDefinitionIndex = 39735;
