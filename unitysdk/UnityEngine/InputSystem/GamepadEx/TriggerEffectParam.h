...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1DCFD320)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA3CC40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DCFD2C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA3CC50)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int TriggerEffectParam_TypeDefinitionIndex = 39079;
