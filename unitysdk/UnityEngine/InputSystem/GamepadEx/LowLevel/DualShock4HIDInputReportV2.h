...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSHOCK4HIDINPUTREPORTV2_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0xA37A10)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSHOCK4HIDINPUTREPORTV2_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1F164BF0)

namespace UnityEngine::InputSystem::GamepadEx::LowLevel
{
	inline static constexpr unsigned int DualShock4HIDInputReportV2_TypeDefinitionIndex = 39751;
