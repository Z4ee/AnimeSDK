...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSHOCK4HIDINPUTREPORTV2_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x9EB710)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSHOCK4HIDINPUTREPORTV2_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1DCFB560)

namespace UnityEngine::InputSystem::GamepadEx::LowLevel
{
	inline static constexpr unsigned int DualShock4HIDInputReportV2_TypeDefinitionIndex = 39085;
