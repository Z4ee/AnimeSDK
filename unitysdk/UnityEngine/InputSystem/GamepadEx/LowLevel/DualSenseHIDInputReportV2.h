...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0xA3C7C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1DCFBDF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0ID_OFFSET UNITYSDK_OFFSET(0xA3C8C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0PRESSED_OFFSET UNITYSDK_OFFSET(0xA3C820)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0X_OFFSET UNITYSDK_OFFSET(0xA3C8D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0Y_OFFSET UNITYSDK_OFFSET(0xA3C970)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1ID_OFFSET UNITYSDK_OFFSET(0xA3CAB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1PRESSED_OFFSET UNITYSDK_OFFSET(0xA3CA10)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1X_OFFSET UNITYSDK_OFFSET(0xA3CAC0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1Y_OFFSET UNITYSDK_OFFSET(0xA3CB60)

namespace UnityEngine::InputSystem::GamepadEx::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDInputReportV2_TypeDefinitionIndex = 39084;
