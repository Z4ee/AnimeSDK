...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x999B40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1B985110)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0ID_OFFSET UNITYSDK_OFFSET(0x999C40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0PRESSED_OFFSET UNITYSDK_OFFSET(0x999BA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0X_OFFSET UNITYSDK_OFFSET(0x999C50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0Y_OFFSET UNITYSDK_OFFSET(0x999CF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1ID_OFFSET UNITYSDK_OFFSET(0x999E30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1PRESSED_OFFSET UNITYSDK_OFFSET(0x999D90)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1X_OFFSET UNITYSDK_OFFSET(0x999E40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1Y_OFFSET UNITYSDK_OFFSET(0x999EE0)

namespace UnityEngine::InputSystem::GamepadEx::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDInputReportV2_TypeDefinitionIndex = 37458;
