...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ADDDEVICETOLIST_OFFSET UNITYSDK_OFFSET(0x1DCF7460)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1DCF9790)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1DCF9700)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1DCF9120)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1DCF7910)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GETBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1DCF70C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1DCF6CA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ALL_OFFSET UNITYSDK_OFFSET(0x1DCF6D00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1DCF6CE0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_LIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1DCF6D80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DCF6CC0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_PS5USERID_OFFSET UNITYSDK_OFFSET(0x1DCF7030)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1DCF6F60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x1DCF9DD0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_MERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1DCF9E50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONADDED_OFFSET UNITYSDK_OFFSET(0x1DCF73D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCFA000)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1DCF7660)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1DCFA040)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1DCF7B30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x1DCF98E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PS4COLORIDTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1DCF6EB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_REMOVEDEVICEFROMLIST_OFFSET UNITYSDK_OFFSET(0x1DCF76D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1DCF7FF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1DCF82D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1DCF8780)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1DCF8E50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x1DCF8A60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1DCF6CB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1DCF6CF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DCF6CD0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1DCFA280)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCFA1D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1DCFA230)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UPDATEPADSETTINGSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1DCF6FF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DCFA320)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCFA2E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1DCFA370)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x1DCFA380)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_ONADDED_OFFSET UNITYSDK_OFFSET(0x1DCFA390)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1DCFA3F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1DCFA430)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x1DCFA480)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1DCFA490)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1DCFA4E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1DCFA530)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1DCFA590)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseGamepadPC_TypeDefinitionIndex = 39065;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::GamepadEx::DualSenseGamepadPC*>**)Il2CppClass::FromTypeDefinitionIndex(DualSenseGamepadPC_TypeDefinitionIndex)->GetStaticField(0x29660);
		}
		static ::System::Boolean* StaticGet_UseOld_Haptics_Motor_LightBarColor()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(DualSenseGamepadPC_TypeDefinitionIndex)->GetStaticField(0x93F0);
		}
		...
		::UnityEngine::InputSystem::Controls::Vector3Control* _angularVelocity_k__BackingField; // 0x270
		::System::Int32 m_SlotId; // 0x278
		::System::Int32 m_DefaultColorId; // 0x27C
		::System::Nullable_1<::UnityEngine::Color> m_LightBarColor; // 0x280
		::System::Int32 _lastFrameCount; // 0x294
		::System::Nullable_1<::System::Single> m_SmallMotor; // 0x298
		::System::Nullable_1<::System::Single> m_LargeMotor; // 0x2A0
		::System::Int32 m_PS5UserId; // 0x2A8
		::System::Nullable_1<::System::Double> _lastTimestamp; // 0x2B0
