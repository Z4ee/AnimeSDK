...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ADDDEVICETOLIST_OFFSET UNITYSDK_OFFSET(0x1B980750)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1B982AB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1B982A20)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1B982440)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B980C00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GETBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1B9803B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B97FF90)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ALL_OFFSET UNITYSDK_OFFSET(0x1B97FFF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B97FFD0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_LIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1B980070)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B97FFB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_PS5USERID_OFFSET UNITYSDK_OFFSET(0x1B980320)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1B980250)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x1B9830F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_MERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1B983170)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONADDED_OFFSET UNITYSDK_OFFSET(0x1B9806C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B983320)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1B980950)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1B983360)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B980E30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x1B982C00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PS4COLORIDTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1B9801A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_REMOVEDEVICEFROMLIST_OFFSET UNITYSDK_OFFSET(0x1B9809C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B9812F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B9815F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1B981AA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1B982170)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x1B981D80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B97FFA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B97FFE0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B97FFC0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1B9835A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B9834F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1B983550)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UPDATEPADSETTINGSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1B9802E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B983640)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B983600)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B983690)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x1B9836A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_ONADDED_OFFSET UNITYSDK_OFFSET(0x1B9836B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1B983710)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B983750)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x1B9837A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B9837B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1B983810)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1B983860)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1B9838C0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseGamepadPC_TypeDefinitionIndex = 37439;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::GamepadEx::DualSenseGamepadPC*>**)Il2CppClass::FromTypeDefinitionIndex(DualSenseGamepadPC_TypeDefinitionIndex)->GetStaticField(0x279A0);
		}
		static ::System::Boolean* StaticGet_UseOld_Haptics_Motor_LightBarColor()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(DualSenseGamepadPC_TypeDefinitionIndex)->GetStaticField(0x8EE0);
		}
		...
		::System::Int32 m_PS5UserId; // 0x284
		::System::Int32 _lastFrameCount; // 0x288
		::System::Nullable_1<::UnityEngine::Color> m_LightBarColor; // 0x28C
		::System::Nullable_1<::System::Double> _lastTimestamp; // 0x2A0
		::System::Nullable_1<::System::Single> m_SmallMotor; // 0x2B0
		::System::Int32 m_SlotId; // 0x2B8
