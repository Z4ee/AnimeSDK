...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B980DC0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x1B985C40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B985C90)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int PS5InputDeviceDescriptor_TypeDefinitionIndex = 37454;
