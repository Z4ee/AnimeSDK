...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT_INITIALIZATION_OFFSET UNITYSDK_OFFSET(0x1B985F00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT_INITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1B985D70)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT_RUNINITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1B985DF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B985CA0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int PS5Support_TypeDefinitionIndex = 37457;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(PS5Support_TypeDefinitionIndex)->GetStaticField(0x8F10);
		}
