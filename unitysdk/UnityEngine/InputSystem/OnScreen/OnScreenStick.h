...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_GET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B9F4B50)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_GET_MOVEMENTRANGE_OFFSET UNITYSDK_OFFSET(0x1B9F4B30)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B9F4720)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1B9F4570)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1B9F4A00)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_SET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B9F4B60)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_SET_MOVEMENTRANGE_OFFSET UNITYSDK_OFFSET(0x1B9F4B40)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_START_OFFSET UNITYSDK_OFFSET(0x1B9F4AA0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F4B70)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenStick_TypeDefinitionIndex = 29129;
