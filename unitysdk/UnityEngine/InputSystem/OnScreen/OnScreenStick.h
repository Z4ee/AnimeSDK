...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_GET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F16C400)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_GET_MOVEMENTRANGE_OFFSET UNITYSDK_OFFSET(0x1F16C3E0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1F16C000)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1F16BE50)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1F16C2C0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_SET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F16C410)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_SET_MOVEMENTRANGE_OFFSET UNITYSDK_OFFSET(0x1F16C3F0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_START_OFFSET UNITYSDK_OFFSET(0x1F16C350)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F16C420)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenStick_TypeDefinitionIndex = 32405;
