...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_GET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x1A9264C0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1A926DC0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A926F60)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A926F50)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_SENTDEFAULTVALUETOCONTROL_OFFSET UNITYSDK_OFFSET(0x1A926DD0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_SETUPINPUTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A926510)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_SET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x1A9264D0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A927230)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenControl_TypeDefinitionIndex = 29127;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::OnScreen::OnScreenControl_OnScreenDeviceInfo>*)Il2CppClass::FromTypeDefinitionIndex(OnScreenControl_TypeDefinitionIndex)->GetStaticField(0x22840);
		}
