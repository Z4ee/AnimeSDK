...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_GET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x1E0E44A0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1E0E4DB0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E0E4F50)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E0E4F40)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_SENTDEFAULTVALUETOCONTROL_OFFSET UNITYSDK_OFFSET(0x1E0E4DC0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_SETUPINPUTCONTROL_OFFSET UNITYSDK_OFFSET(0x1E0E44F0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_SET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x1E0E44B0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E5220)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenControl_TypeDefinitionIndex = 32403;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::OnScreen::OnScreenControl_OnScreenDeviceInfo>*)Il2CppClass::FromTypeDefinitionIndex(OnScreenControl_TypeDefinitionIndex)->GetStaticField(0x27D50);
		}
