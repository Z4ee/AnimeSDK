...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_GET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DDEE120)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1DDEE110)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1DDEE100)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_SET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DDEE130)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDEE140)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenButton_TypeDefinitionIndex = 31782;
