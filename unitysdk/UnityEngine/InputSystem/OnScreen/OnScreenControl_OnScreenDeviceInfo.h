...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONSCREENDEVICEINFO_ADDCONTROL_OFFSET UNITYSDK_OFFSET(0x973220)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONSCREENDEVICEINFO_DESTROY_OFFSET UNITYSDK_OFFSET(0x973280)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONSCREENDEVICEINFO_REMOVECONTROL_OFFSET UNITYSDK_OFFSET(0x973260)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenControl_OnScreenDeviceInfo_TypeDefinitionIndex = 29128;
