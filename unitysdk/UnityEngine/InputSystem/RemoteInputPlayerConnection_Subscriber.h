...
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SUBSCRIBER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F12F600)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SUBSCRIBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F12F660)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int RemoteInputPlayerConnection_Subscriber_TypeDefinitionIndex = 32283;
