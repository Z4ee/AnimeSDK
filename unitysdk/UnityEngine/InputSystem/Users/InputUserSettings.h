...
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_APPLY_OFFSET UNITYSDK_OFFSET(0x1E7852A0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_CUSTOMBINDINGS_OFFSET UNITYSDK_OFFSET(0x1E785120)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_INVERTMOUSEX_OFFSET UNITYSDK_OFFSET(0x1E785140)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_INVERTMOUSEY_OFFSET UNITYSDK_OFFSET(0x1E785160)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_INVERTSTICKX_OFFSET UNITYSDK_OFFSET(0x1E7851C0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_INVERTSTICKY_OFFSET UNITYSDK_OFFSET(0x1E7851E0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_MOUSESENSITIVITY_OFFSET UNITYSDK_OFFSET(0x1E7851A0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_MOUSESMOOTHING_OFFSET UNITYSDK_OFFSET(0x1E785180)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_SWAPBUMPERS_OFFSET UNITYSDK_OFFSET(0x1E785220)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_SWAPDPADANDLEFTSTICK_OFFSET UNITYSDK_OFFSET(0x1E785260)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_SWAPSTICKS_OFFSET UNITYSDK_OFFSET(0x1E785200)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_SWAPTRIGGERS_OFFSET UNITYSDK_OFFSET(0x1E785240)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_GET_VIBRATIONSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1E785280)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_CUSTOMBINDINGS_OFFSET UNITYSDK_OFFSET(0x1E785130)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_INVERTMOUSEX_OFFSET UNITYSDK_OFFSET(0x1E785150)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_INVERTMOUSEY_OFFSET UNITYSDK_OFFSET(0x1E785170)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_INVERTSTICKX_OFFSET UNITYSDK_OFFSET(0x1E7851D0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_INVERTSTICKY_OFFSET UNITYSDK_OFFSET(0x1E7851F0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_MOUSESENSITIVITY_OFFSET UNITYSDK_OFFSET(0x1E7851B0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_MOUSESMOOTHING_OFFSET UNITYSDK_OFFSET(0x1E785190)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_SWAPBUMPERS_OFFSET UNITYSDK_OFFSET(0x1E785230)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_SWAPDPADANDLEFTSTICK_OFFSET UNITYSDK_OFFSET(0x1E785270)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_SWAPSTICKS_OFFSET UNITYSDK_OFFSET(0x1E785210)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_SWAPTRIGGERS_OFFSET UNITYSDK_OFFSET(0x1E785250)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS_SET_VIBRATIONSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1E785290)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7852B0)

namespace UnityEngine::InputSystem::Users
{
	inline static constexpr unsigned int InputUserSettings_TypeDefinitionIndex = 32381;
