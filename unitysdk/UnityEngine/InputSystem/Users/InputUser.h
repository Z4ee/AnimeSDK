...
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ACTIVATECONTROLSCHEMEINTERNAL_OFFSET UNITYSDK_OFFSET(0xA58600)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ACTIVATECONTROLSCHEME_1_OFFSET UNITYSDK_OFFSET(0xA585D0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ACTIVATECONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0xA58540)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ADDDEVICETOUSER_OFFSET UNITYSDK_OFFSET(0x1EADEC50)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ADDUSER_OFFSET UNITYSDK_OFFSET(0x1EADE530)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ADD_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EAD9F10)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ADD_ONPREFILTERUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1EADA320)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ADD_ONUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x1EADA010)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ASSOCIATEACTIONSWITHUSER_OFFSET UNITYSDK_OFFSET(0xA58530)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_CREATEUSERWITHOUTPAIREDDEVICES_OFFSET UNITYSDK_OFFSET(0x1EADE3C0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_DISPOSEANDRESETGLOBALSTATE_OFFSET UNITYSDK_OFFSET(0x1EAE0E40)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA58690)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_EQUALS_OFFSET UNITYSDK_OFFSET(0x826600)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_FINDCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0xA585C0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_FINDLOSTDEVICE_OFFSET UNITYSDK_OFFSET(0x1EAE0590)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_FINDUSERBYACCOUNT_OFFSET UNITYSDK_OFFSET(0x1EADE1C0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_FINDUSERPAIREDTODEVICE_OFFSET UNITYSDK_OFFSET(0x1EADDFB0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GETUNPAIREDINPUTDEVICES_1_OFFSET UNITYSDK_OFFSET(0x1EADDCB0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GETUNPAIREDINPUTDEVICES_OFFSET UNITYSDK_OFFSET(0x1EADDC40)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0xA582E0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_ALL_OFFSET UNITYSDK_OFFSET(0x1EAD9EC0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_CONTROLSCHEMEMATCH_OFFSET UNITYSDK_OFFSET(0xA583F0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_CONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0xA58360)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_HASMISSINGREQUIREDDEVICES_OFFSET UNITYSDK_OFFSET(0xA584A0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_ID_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xA57FE0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_LISTENFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1EADA420)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_LOSTDEVICES_OFFSET UNITYSDK_OFFSET(0xA58240)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_PAIREDDEVICES_OFFSET UNITYSDK_OFFSET(0xA581B0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_PLATFORMUSERACCOUNTHANDLE_OFFSET UNITYSDK_OFFSET(0xA58020)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_PLATFORMUSERACCOUNTID_OFFSET UNITYSDK_OFFSET(0xA58130)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_PLATFORMUSERACCOUNTNAME_OFFSET UNITYSDK_OFFSET(0xA580B0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_GET_VALID_OFFSET UNITYSDK_OFFSET(0xA57F40)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_HOOKINTOACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EADAED0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_HOOKINTODEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1EADF890)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_HOOKINTOEVENTS_OFFSET UNITYSDK_OFFSET(0x1EADA0B0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_INITIATEUSERACCOUNTSELECTIONATPLATFORMLEVEL_OFFSET UNITYSDK_OFFSET(0x1EADF7F0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_INITIATEUSERACCOUNTSELECTION_OFFSET UNITYSDK_OFFSET(0x1EADEA60)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1EADB9A0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EADFCF0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1EADFE30)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1EAE0680)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1EADEA50)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1EADEA40)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_PERFORMPAIRINGWITHDEVICE_OFFSET UNITYSDK_OFFSET(0x1EADE640)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_QUERYPAIREDPLATFORMUSERACCOUNT_OFFSET UNITYSDK_OFFSET(0x1EADFB30)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_REMOVEDEVICEFROMUSER_OFFSET UNITYSDK_OFFSET(0x1EADCCB0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_REMOVELOSTDEVICESFORUSER_OFFSET UNITYSDK_OFFSET(0x1EADC940)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_REMOVEUSER_OFFSET UNITYSDK_OFFSET(0x1EADD6E0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_REMOVE_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EAD9F90)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_REMOVE_ONPREFILTERUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1EADA3A0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_REMOVE_ONUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x1EADA180)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_RESETGLOBALS_OFFSET UNITYSDK_OFFSET(0x1EAE0F60)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_SAVEANDRESETSTATE_OFFSET UNITYSDK_OFFSET(0x1EAE0C30)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_SET_LISTENFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1EADA460)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA58520)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_TRYFINDCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0xA585B0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_TRYFINDUSERINDEX_1_OFFSET UNITYSDK_OFFSET(0x1EADE2B0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_TRYFINDUSERINDEX_2_OFFSET UNITYSDK_OFFSET(0x1EADE070)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_TRYFINDUSERINDEX_OFFSET UNITYSDK_OFFSET(0x1EAD9960)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UNHOOKFROMACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1EADFA50)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UNHOOKFROMDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1EADF9D0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UNHOOKFROMDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1EADA2A0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UNPAIRDEVICESANDREMOVEUSER_OFFSET UNITYSDK_OFFSET(0xA58650)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UNPAIRDEVICES_OFFSET UNITYSDK_OFFSET(0xA58640)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UNPAIRDEVICE_OFFSET UNITYSDK_OFFSET(0xA58630)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UPDATECONTROLSCHEMEMATCH_OFFSET UNITYSDK_OFFSET(0x1EADBC20)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_UPDATEPLATFORMUSERACCOUNT_OFFSET UNITYSDK_OFFSET(0x1EADF350)

namespace UnityEngine::InputSystem::Users
{
	inline static constexpr unsigned int InputUser_TypeDefinitionIndex = 32370;

	struct alignas(4) InputUser
	{
		static ::UnityEngine::InputSystem::Users::InputUser_GlobalState* StaticGet_s_GlobalState()
		{
			return (::UnityEngine::InputSystem::Users::InputUser_GlobalState*)Il2CppClass::FromTypeDefinitionIndex(InputUser_TypeDefinitionIndex)->GetStaticField(0x27780);
		}
