...
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_COMPAREDEVICESBYUSERACCOUNT_COMPARE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_COMPAREDEVICESBYUSERACCOUNT_GETUSERACCOUNTHANDLEFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1EAE1160)

namespace UnityEngine::InputSystem::Users
{
	inline static constexpr unsigned int InputUser_CompareDevicesByUserAccount_TypeDefinitionIndex = 32374;
