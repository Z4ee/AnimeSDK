...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E0DE280)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E0DE530)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E0DE420)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E0DE5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E0DE4B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E0DE460)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E0DE270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0DE250)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset__get_bindings_d__8_TypeDefinitionIndex = 32152;

	class InputActionAsset__get_bindings_d__8 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::InputBinding __2__current; // 0x10
		::Il2CppArray<::UnityEngine::InputSystem::InputBinding>* _bindings_5__4; // 0x68
		...
		::System::Int32 _numBindings_5__5; // 0x84
		::System::Int32 __1__state; // 0x88
		::System::Int32 _numActionMaps_5__2; // 0x8C
