...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CD249E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CD24C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD24B80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CD24D20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD24C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CD24BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD249D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD249B0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset__get_bindings_d__8_TypeDefinitionIndex = 31532;
	...
	public:
		...
		::System::Int32 _i_5__3; // 0x78
		::System::Int32 _numBindings_5__5; // 0x7C
		::System::Int32 __l__initialThreadId; // 0x80
		::System::Int32 _numActionMaps_5__2; // 0x84
		::System::Int32 _n_5__6; // 0x88
