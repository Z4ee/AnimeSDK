...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDHAPTICIMPULSECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1DDEEEA0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDHAPTICIMPULSECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA43B60)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDHAPTICIMPULSECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DDEEE80)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int SendHapticImpulseCommand_TypeDefinitionIndex = 31739;
