...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_GET_FREQUENCYHZ_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_GET_MAXBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_GET_NUMCHANNELS_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_SET_FREQUENCYHZ_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_SET_MAXBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_SET_NUMCHANNELS_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES__CTOR_OFFSET UNITYSDK_OFFSET(0x4E6C30)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int HapticCapabilities_TypeDefinitionIndex = 31735;
