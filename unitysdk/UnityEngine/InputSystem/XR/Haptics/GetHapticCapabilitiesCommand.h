...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1DF7B750)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_GET_CAPABILITIES_OFFSET UNITYSDK_OFFSET(0xA4F4F0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA4F4E0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DF7B710)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int GetHapticCapabilitiesCommand_TypeDefinitionIndex = 31736;
