...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1D7A94D0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0xA0CCD0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D7A94A0)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int GetCurrentHapticStateCommand_TypeDefinitionIndex = 31734;
