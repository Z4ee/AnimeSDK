...
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B525E70)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_FIXATIONPOINT_OFFSET UNITYSDK_OFFSET(0x1B525E10)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_LEFTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1B525E30)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B525D90)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B525DB0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_RIGHTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1B525E50)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B525DD0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B525DF0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1B525F70)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_FIXATIONPOINT_OFFSET UNITYSDK_OFFSET(0x1B525E20)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_LEFTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1B525E40)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B525DA0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B525DC0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_RIGHTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1B525E60)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B525DE0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B525E00)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1B526360)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B526680)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int EyesControl_TypeDefinitionIndex = 29074;

	class EyesControl : public ::UnityEngine::InputSystem::InputControl_1<::UnityEngine::InputSystem::XR::Eyes>
	{
	public:
		::UnityEngine::InputSystem::Controls::AxisControl* _leftEyeOpenAmount_k__BackingField; // 0xF0
		::UnityEngine::InputSystem::Controls::Vector3Control* _rightEyePosition_k__BackingField; // 0xF8
		::UnityEngine::InputSystem::Controls::Vector3Control* _fixationPoint_k__BackingField; // 0x100
		::UnityEngine::InputSystem::Controls::Vector3Control* _leftEyePosition_k__BackingField; // 0x108
		::UnityEngine::InputSystem::Controls::QuaternionControl* _rightEyeRotation_k__BackingField; // 0x110
		::UnityEngine::InputSystem::Controls::QuaternionControl* _leftEyeRotation_k__BackingField; // 0x118
		::UnityEngine::InputSystem::Controls::AxisControl* _rightEyeOpenAmount_k__BackingField; // 0x120
