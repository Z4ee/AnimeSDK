...
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x19599230)
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x19599220)
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19599270)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRDeviceDescriptor_TypeDefinitionIndex = 29070;
