...
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B97BBD0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x1B97BBC0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97BC10)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRDeviceDescriptor_TypeDefinitionIndex = 31726;
