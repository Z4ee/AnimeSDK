...
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1B97C690)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_CONVERTPOTENTIALALIASTONAME_OFFSET UNITYSDK_OFFSET(0x1B97C210)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_GETPARENTCONTROLNAME_OFFSET UNITYSDK_OFFSET(0x1B97C480)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_GETSIZEOFFEATURE_OFFSET UNITYSDK_OFFSET(0x1B97BC20)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ISPOSECONTROL_OFFSET UNITYSDK_OFFSET(0x1B97C4C0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ISSUBCONTROL_OFFSET UNITYSDK_OFFSET(0x1B97C450)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1B97BE70)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_SANITIZESTRING_OFFSET UNITYSDK_OFFSET(0x1B97BCA0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B97DA40)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97C200)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRLayoutBuilder_TypeDefinitionIndex = 31720;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XRLayoutBuilder_TypeDefinitionIndex)->GetStaticField(0x26440);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::XR::FeatureType>** StaticGet_poseSubControlTypes()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::XR::FeatureType>**)Il2CppClass::FromTypeDefinitionIndex(XRLayoutBuilder_TypeDefinitionIndex)->GetStaticField(0x26448);
		}
