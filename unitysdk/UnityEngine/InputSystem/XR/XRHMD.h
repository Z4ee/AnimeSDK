...
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B401250)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_GET_CENTEREYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B401210)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_GET_CENTEREYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B401230)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_GET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B401190)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_GET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B4011B0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_GET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4011D0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_GET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B4011F0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_SET_CENTEREYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B401220)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_SET_CENTEREYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B401240)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_SET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4011A0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_SET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B4011C0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_SET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4011E0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD_SET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1B401200)
#define UNITYENGINE_INPUTSYSTEM_XR_XRHMD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B401340)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRHMD_TypeDefinitionIndex = 29058;

	class XRHMD : public ::UnityEngine::InputSystem::TrackedDevice
	{
	public:
		::UnityEngine::InputSystem::Controls::Vector3Control* _leftEyePosition_k__BackingField; // 0x178
		::UnityEngine::InputSystem::Controls::Vector3Control* _rightEyePosition_k__BackingField; // 0x180
		::UnityEngine::InputSystem::Controls::QuaternionControl* _leftEyeRotation_k__BackingField; // 0x188
		::UnityEngine::InputSystem::Controls::Vector3Control* _centerEyePosition_k__BackingField; // 0x190
