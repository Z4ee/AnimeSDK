...
#define UNITYENGINE_INPUTSYSTEM_XR_XRCONTROLLERWITHRUMBLE_SENDIMPULSE_OFFSET UNITYSDK_OFFSET(0x1E3A1420)
#define UNITYENGINE_INPUTSYSTEM_XR_XRCONTROLLERWITHRUMBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3A1460)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRControllerWithRumble_TypeDefinitionIndex = 31716;
