...
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_PARENTBONEINDEX_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x41FCD0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x41E4B0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_PARENTBONEINDEX_OFFSET UNITYSDK_OFFSET(0x3253A0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x826A80)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x56EA80)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 32347;
