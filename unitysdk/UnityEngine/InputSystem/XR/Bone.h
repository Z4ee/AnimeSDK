...
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_PARENTBONEINDEX_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x3A5300)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x3819B0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_PARENTBONEINDEX_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x704010)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x3819C0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 29071;
