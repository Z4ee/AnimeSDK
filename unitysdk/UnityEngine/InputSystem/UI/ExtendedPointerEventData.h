...
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GETPENPOINTERID_OFFSET UNITYSDK_OFFSET(0x1E01FE40)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GETTOUCHPOINTERID_OFFSET UNITYSDK_OFFSET(0x1E0200C0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1E01F6D0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1E01F6F0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x1E01F730)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TOUCHID_OFFSET UNITYSDK_OFFSET(0x1E01F710)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1E01F7B0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1E01F770)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_UITOOLKITPOINTERID_OFFSET UNITYSDK_OFFSET(0x1E01F750)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_MAKEPOINTERIDFORTOUCH_OFFSET UNITYSDK_OFFSET(0x1E01FD10)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_READDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1E01FD30)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1E01F6E0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1E01F700)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x1E01F740)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TOUCHID_OFFSET UNITYSDK_OFFSET(0x1E01F720)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1E01F7C0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1E01F790)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_UITOOLKITPOINTERID_OFFSET UNITYSDK_OFFSET(0x1E01F760)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E01F7D0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_TOUCHIDFROMPOINTERID_OFFSET UNITYSDK_OFFSET(0x1E01FD20)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E01F6C0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int ExtendedPointerEventData_TypeDefinitionIndex = 31764;
	...
	public:
		...
		::UnityEngine::Vector3 _trackedDevicePosition_k__BackingField; // 0x148
		::System::Int32 _touchId_k__BackingField; // 0x154
		::UnityEngine::InputSystem::UI::UIPointerType _pointerType_k__BackingField; // 0x158
		::System::Int32 _uiToolkitPointerId_k__BackingField; // 0x15C
		::UnityEngine::Quaternion _trackedDeviceOrientation_k__BackingField; // 0x160
