...
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GETPENPOINTERID_OFFSET UNITYSDK_OFFSET(0x1BCC8BC0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GETTOUCHPOINTERID_OFFSET UNITYSDK_OFFSET(0x1BCC8E40)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1BCC8450)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1BCC8470)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x1BCC84B0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TOUCHID_OFFSET UNITYSDK_OFFSET(0x1BCC8490)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1BCC8530)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1BCC84F0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_UITOOLKITPOINTERID_OFFSET UNITYSDK_OFFSET(0x1BCC84D0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_MAKEPOINTERIDFORTOUCH_OFFSET UNITYSDK_OFFSET(0x1BCC8A90)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_READDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1BCC8AB0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1BCC8460)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1BCC8480)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x1BCC84C0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TOUCHID_OFFSET UNITYSDK_OFFSET(0x1BCC84A0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1BCC8540)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1BCC8510)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_UITOOLKITPOINTERID_OFFSET UNITYSDK_OFFSET(0x1BCC84E0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BCC8550)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_TOUCHIDFROMPOINTERID_OFFSET UNITYSDK_OFFSET(0x1BCC8AA0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC8440)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int ExtendedPointerEventData_TypeDefinitionIndex = 29108;

	class ExtendedPointerEventData : public ::UnityEngine::EventSystems::PointerEventData
	{
	public:
		::UnityEngine::InputSystem::InputControl* _control_k__BackingField; // 0x138
		::UnityEngine::InputSystem::InputDevice* _device_k__BackingField; // 0x140
		::UnityEngine::Quaternion _trackedDeviceOrientation_k__BackingField; // 0x148
		::UnityEngine::Vector3 _trackedDevicePosition_k__BackingField; // 0x158
		::System::Int32 _touchId_k__BackingField; // 0x164
		::System::Int32 _uiToolkitPointerId_k__BackingField; // 0x168
		::UnityEngine::InputSystem::UI::UIPointerType _pointerType_k__BackingField; // 0x16C
