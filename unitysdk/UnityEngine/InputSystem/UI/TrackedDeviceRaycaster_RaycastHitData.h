...
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x9F06F0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x414340)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_WORLDHITPOSITION_OFFSET UNITYSDK_OFFSET(0x3E3F90)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B830)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int TrackedDeviceRaycaster_RaycastHitData_TypeDefinitionIndex = 31774;
