...
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x94D150)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x3A6250)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_WORLDHITPOSITION_OFFSET UNITYSDK_OFFSET(0x3AAEA0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x967850)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int TrackedDeviceRaycaster_RaycastHitData_TypeDefinitionIndex = 29118;
