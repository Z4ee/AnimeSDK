...
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATEFROM_OFFSET UNITYSDK_OFFSET(0xA93C20)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATETO_OFFSET UNITYSDK_OFFSET(0xA93B50)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA93B10)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0xA93AF0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x324690)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x3D1D70)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASPRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0xA93B30)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASRELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0xA93B40)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_ONENDFRAME_OFFSET UNITYSDK_OFFSET(0xA93CD0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA93B20)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0xA93B00)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0xA93AB0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x5A2BD0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int PointerModel_ButtonState_TypeDefinitionIndex = 32392;
