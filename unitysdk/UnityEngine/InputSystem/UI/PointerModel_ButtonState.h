...
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATEFROM_OFFSET UNITYSDK_OFFSET(0x99D530)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATETO_OFFSET UNITYSDK_OFFSET(0x99D460)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x99D420)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x99D400)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x2E7930)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x3AB430)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASPRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x99D440)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASRELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x99D450)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_ONENDFRAME_OFFSET UNITYSDK_OFFSET(0x99D5E0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x99D430)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x99D410)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x99D3C0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x50C890)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int PointerModel_ButtonState_TypeDefinitionIndex = 29116;
