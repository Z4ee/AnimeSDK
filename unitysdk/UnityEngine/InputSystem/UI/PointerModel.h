...
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_COPYTOUCHORPENSTATEFROM_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_ALTITUDEANGLE_OFFSET UNITYSDK_OFFSET(0x9A7410)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_AZIMUTHANGLE_OFFSET UNITYSDK_OFFSET(0x9A73E0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x9A71D0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_PRESSURE_OFFSET UNITYSDK_OFFSET(0x9A73B0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x9A7470)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x9A7200)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_SCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x9A7350)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_TWIST_OFFSET UNITYSDK_OFFSET(0x9A7440)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_WORLDORIENTATION_OFFSET UNITYSDK_OFFSET(0x9A72F0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_WORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x9A7260)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_ONFRAMEFINISHED_OFFSET UNITYSDK_OFFSET(0x9A75D0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_ALTITUDEANGLE_OFFSET UNITYSDK_OFFSET(0x9A7420)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_AZIMUTHANGLE_OFFSET UNITYSDK_OFFSET(0x9A73F0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_PRESSURE_OFFSET UNITYSDK_OFFSET(0x9A73C0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x9A7480)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x9A7210)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_SCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x9A7360)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_TWIST_OFFSET UNITYSDK_OFFSET(0x9A7450)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_WORLDORIENTATION_OFFSET UNITYSDK_OFFSET(0x9A7300)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_WORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x9A7280)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9A74D0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int PointerModel_TypeDefinitionIndex = 32391;
