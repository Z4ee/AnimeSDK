...
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1D754B80)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ALLOCATEPOINTER_OFFSET UNITYSDK_OFFSET(0x1D75BBD0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ASSIGNDEFAULTACTIONS_OFFSET UNITYSDK_OFFSET(0x1D759880)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D75A2A0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_CHECKFORREMOVEDDEVICE_OFFSET UNITYSDK_OFFSET(0x1D75AEA0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_DISABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x1D75AAE0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_DISABLEINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1D7590F0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ENABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x1D75A9B0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ENABLEINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1D759340)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GETLASTRAYCASTRESULT_OFFSET UNITYSDK_OFFSET(0x1D7550A0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GETPOINTERSTATEFORINDEX_OFFSET UNITYSDK_OFFSET(0x1D75AD30)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GETPOINTERSTATEINDEXFOR_1_OFFSET UNITYSDK_OFFSET(0x1D75AD90)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GETPOINTERSTATEINDEXFOR_2_OFFSET UNITYSDK_OFFSET(0x1D75AF40)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GETPOINTERSTATEINDEXFOR_OFFSET UNITYSDK_OFFSET(0x1D754FB0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_ACTIONSASSET_OFFSET UNITYSDK_OFFSET(0x1D75D800)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1D7597C0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_DESELECTONBACKGROUNDCLICK_OFFSET UNITYSDK_OFFSET(0x1D754B40)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_EXPLICTLYIGNOREFOCUS_OFFSET UNITYSDK_OFFSET(0x1D7587F0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_LEFTCLICK_OFFSET UNITYSDK_OFFSET(0x1D759680)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_MIDDLECLICK_OFFSET UNITYSDK_OFFSET(0x1D7596C0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_MOVEREPEATDELAY_OFFSET UNITYSDK_OFFSET(0x1D7587B0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_MOVEREPEATRATE_OFFSET UNITYSDK_OFFSET(0x1D7587D0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_MOVE_OFFSET UNITYSDK_OFFSET(0x1D759740)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_POINTERBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1D754B60)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_POINT_OFFSET UNITYSDK_OFFSET(0x1D759600)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_REPEATDELAY_OFFSET UNITYSDK_OFFSET(0x1D758A10)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_REPEATRATE_OFFSET UNITYSDK_OFFSET(0x1D7589F0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_RIGHTCLICK_OFFSET UNITYSDK_OFFSET(0x1D759700)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_SCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x1D759640)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_SHOULDIGNOREFOCUS_OFFSET UNITYSDK_OFFSET(0x1D7588D0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1D759780)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_TRACKEDDEVICEDRAGTHRESHOLDMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1D758A50)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1D759800)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D759840)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_TRACKEDDEVICESELECT_OFFSET UNITYSDK_OFFSET(0x1D75A200)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_GET_XRTRACKINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1D758A30)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_HASNOACTIONS_OFFSET UNITYSDK_OFFSET(0x1D75A4E0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_HAVECONTROLFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1D75BAE0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_HOOKACTIONS_OFFSET UNITYSDK_OFFSET(0x1D75A740)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x1D75C630)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ISPOINTEROVERGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D754D40)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x1D75CFF0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D75A330)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D75AA30)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D75A400)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONLEFTCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75C870)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONMIDDLECLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75CAC0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75CD20)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONPOINTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75C440)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONRIGHTCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75C990)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONSCROLLCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75CBF0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONTRACKEDDEVICEORIENTATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75CD80)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_ONTRACKEDDEVICEPOSITIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75CEA0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PERFORMRAYCAST_OFFSET UNITYSDK_OFFSET(0x1D755140)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_POINTERSHOULDIGNORETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1D7571A0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSNAVIGATION_OFFSET UNITYSDK_OFFSET(0x1D757EE0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSPOINTERBUTTONDRAG_OFFSET UNITYSDK_OFFSET(0x1D756B50)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSPOINTERBUTTON_OFFSET UNITYSDK_OFFSET(0x1D755D30)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSPOINTERMOVEMENT_1_OFFSET UNITYSDK_OFFSET(0x1D757340)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSPOINTERMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1D755CD0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSPOINTERSCROLL_OFFSET UNITYSDK_OFFSET(0x1D757060)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESSPOINTER_OFFSET UNITYSDK_OFFSET(0x1D755430)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1D75D000)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_PURGESTALEPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D75C290)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_REMOVEPOINTERATINDEX_OFFSET UNITYSDK_OFFSET(0x1D75C0C0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_RESETPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D75A6F0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SENDPOINTEREXITEVENTSANDREMOVEPOINTER_OFFSET UNITYSDK_OFFSET(0x1D75ABC0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SETACTIONCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1D75D300)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SETACTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D75D410)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_ACTIONSASSET_OFFSET UNITYSDK_OFFSET(0x1D759DA0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1D7597D0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_DESELECTONBACKGROUNDCLICK_OFFSET UNITYSDK_OFFSET(0x1D754B50)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_LEFTCLICK_OFFSET UNITYSDK_OFFSET(0x1D759690)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_MIDDLECLICK_OFFSET UNITYSDK_OFFSET(0x1D7596D0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_MOVEREPEATDELAY_OFFSET UNITYSDK_OFFSET(0x1D7587C0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_MOVEREPEATRATE_OFFSET UNITYSDK_OFFSET(0x1D7587E0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_MOVE_OFFSET UNITYSDK_OFFSET(0x1D759750)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_POINTERBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1D754B70)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_POINT_OFFSET UNITYSDK_OFFSET(0x1D759610)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_REPEATDELAY_OFFSET UNITYSDK_OFFSET(0x1D758A20)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_REPEATRATE_OFFSET UNITYSDK_OFFSET(0x1D758A00)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_RIGHTCLICK_OFFSET UNITYSDK_OFFSET(0x1D759710)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_SCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x1D759650)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1D759790)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_TRACKEDDEVICEDRAGTHRESHOLDMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1D758A60)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1D759810)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D759850)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_TRACKEDDEVICESELECT_OFFSET UNITYSDK_OFFSET(0x1D75A250)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SET_XRTRACKINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1D758A40)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_SWAPACTION_OFFSET UNITYSDK_OFFSET(0x1D758A70)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_UNASSIGNACTIONS_OFFSET UNITYSDK_OFFSET(0x1D75A070)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_UNHOOKACTIONS_OFFSET UNITYSDK_OFFSET(0x1D75A3E0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE_UPDATEREFERENCEFORNEWASSET_OFFSET UNITYSDK_OFFSET(0x1D75D650)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D75D8E0)
#define UNITYENGINE_INPUTSYSTEM_UI_INPUTSYSTEMUIINPUTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D75D810)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int InputSystemUIInputModule_TypeDefinitionIndex = 31767;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::InputSystem::InputAction*, ::UnityEngine::InputSystem::UI::InputSystemUIInputModule_InputActionReferenceState>**)Il2CppClass::FromTypeDefinitionIndex(InputSystemUIInputModule_TypeDefinitionIndex)->GetStaticField(0x25F70);
		}
