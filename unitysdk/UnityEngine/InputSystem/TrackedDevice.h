...
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1DF785E0)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_DEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DF785A0)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_DEVICEROTATION_OFFSET UNITYSDK_OFFSET(0x1DF785C0)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_ISTRACKED_OFFSET UNITYSDK_OFFSET(0x1DF78580)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_TRACKINGSTATE_OFFSET UNITYSDK_OFFSET(0x1DF78560)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_DEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DF785B0)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_DEVICEROTATION_OFFSET UNITYSDK_OFFSET(0x1DF785D0)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_ISTRACKED_OFFSET UNITYSDK_OFFSET(0x1DF78590)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_TRACKINGSTATE_OFFSET UNITYSDK_OFFSET(0x1DF78570)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF78690)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int TrackedDevice_TypeDefinitionIndex = 31679;

	class TrackedDevice : public ::UnityEngine::InputSystem::InputDevice
	{
	public:
		::UnityEngine::InputSystem::Controls::IntegerControl* _trackingState_k__BackingField; // 0x158
		::UnityEngine::InputSystem::Controls::Vector3Control* _devicePosition_k__BackingField; // 0x160
