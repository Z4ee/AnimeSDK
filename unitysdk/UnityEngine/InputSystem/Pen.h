...
#define UNITYENGINE_INPUTSYSTEM_PEN_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1E0E54F0)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E0E5390)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_ERASER_OFFSET UNITYSDK_OFFSET(0x1E0E5290)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_FIRSTBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E52B0)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_FOURTHBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E5310)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_INRANGE_OFFSET UNITYSDK_OFFSET(0x1E0E5330)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E0E53B0)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_SECONDBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E52D0)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_THIRDBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E52F0)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_TILT_OFFSET UNITYSDK_OFFSET(0x1E0E5350)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_TIP_OFFSET UNITYSDK_OFFSET(0x1E0E5270)
#define UNITYENGINE_INPUTSYSTEM_PEN_GET_TWIST_OFFSET UNITYSDK_OFFSET(0x1E0E5370)
#define UNITYENGINE_INPUTSYSTEM_PEN_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1E0E5490)
#define UNITYENGINE_INPUTSYSTEM_PEN_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1E0E54B0)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E0E53A0)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_ERASER_OFFSET UNITYSDK_OFFSET(0x1E0E52A0)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_FIRSTBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E52C0)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_FOURTHBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E5320)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_INRANGE_OFFSET UNITYSDK_OFFSET(0x1E0E5340)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_SECONDBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E52E0)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_THIRDBARRELBUTTON_OFFSET UNITYSDK_OFFSET(0x1E0E5300)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_TILT_OFFSET UNITYSDK_OFFSET(0x1E0E5360)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_TIP_OFFSET UNITYSDK_OFFSET(0x1E0E5280)
#define UNITYENGINE_INPUTSYSTEM_PEN_SET_TWIST_OFFSET UNITYSDK_OFFSET(0x1E0E5380)
#define UNITYENGINE_INPUTSYSTEM_PEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E5630)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Pen_TypeDefinitionIndex = 32256;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Pen**)Il2CppClass::FromTypeDefinitionIndex(Pen_TypeDefinitionIndex)->GetStaticField(0x27D90);
		}
		::UnityEngine::InputSystem::Controls::ButtonControl* _secondBarrelButton_k__BackingField; // 0x180
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _firstBarrelButton_k__BackingField; // 0x198
		::UnityEngine::InputSystem::Controls::ButtonControl* _fourthBarrelButton_k__BackingField; // 0x1A0
		::UnityEngine::InputSystem::Controls::ButtonControl* _thirdBarrelButton_k__BackingField; // 0x1A8
		::UnityEngine::InputSystem::Controls::ButtonControl* _eraser_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::Vector2Control* _tilt_k__BackingField; // 0x1B8
		::UnityEngine::InputSystem::Controls::AxisControl* _twist_k__BackingField; // 0x1C0
