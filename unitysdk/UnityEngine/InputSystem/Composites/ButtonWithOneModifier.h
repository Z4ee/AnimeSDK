...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_BUTTONWITHONEMODIFIER_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1DF74F70)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_BUTTONWITHONEMODIFIER_READVALUE_OFFSET UNITYSDK_OFFSET(0x1DF74EE0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_BUTTONWITHONEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF75000)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int ButtonWithOneModifier_TypeDefinitionIndex = 32093;

	class ButtonWithOneModifier : public ::UnityEngine::InputSystem::InputBindingComposite_1<::System::Single>
	{
	public:
		::System::Int32 button; // 0x10
		::System::Int32 modifier; // 0x14
