...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_BUTTONWITHONEMODIFIER_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1F377C00)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_BUTTONWITHONEMODIFIER_READVALUE_OFFSET UNITYSDK_OFFSET(0x1F377B70)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_BUTTONWITHONEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F377C90)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int ButtonWithOneModifier_TypeDefinitionIndex = 32713;
