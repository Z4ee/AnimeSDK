...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_VECTOR3COMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1B3F32F0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_VECTOR3COMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F37A0)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int Vector3Composite_TypeDefinitionIndex = 29443;

	class Vector3Composite : public ::UnityEngine::InputSystem::InputBindingComposite_1<::UnityEngine::Vector3>
	{
	public:
		::UnityEngine::InputSystem::Composites::Vector3Composite_Mode mode; // 0x10
		::System::Int32 down; // 0x14
		::System::Int32 forward; // 0x18
		::System::Int32 up; // 0x1C
		::System::Int32 backward; // 0x20
		::System::Int32 right; // 0x24
		::System::Int32 left; // 0x28
