...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_VECTOR3COMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1D79B980)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_VECTOR3COMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79BE30)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int Vector3Composite_TypeDefinitionIndex = 32099;
	...
	public:
		...
		::UnityEngine::InputSystem::Composites::Vector3Composite_Mode mode; // 0x24
		::System::Int32 up; // 0x28
