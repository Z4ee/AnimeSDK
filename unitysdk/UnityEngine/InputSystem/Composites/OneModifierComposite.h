...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_DETERMINEVALUETYPEANDSIZE_OFFSET UNITYSDK_OFFSET(0x1C3575B0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1C357470)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1C357590)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1C357460)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1C357450)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1C357A30)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1C3574F0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C357AB0)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int OneModifierComposite_TypeDefinitionIndex = 32095;
