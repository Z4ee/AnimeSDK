...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_DETERMINEVALUETYPEANDSIZE_OFFSET UNITYSDK_OFFSET(0x1A02F110)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1A02EFD0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A02F0F0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1A02EFC0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A02EFB0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1A02F590)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1A02F050)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02F610)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int OneModifierComposite_TypeDefinitionIndex = 29439;
