...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1E39C170)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1E39C330)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1E39C160)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1E39C150)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1E39C350)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1E39C240)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E39C420)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int TwoModifiersComposite_TypeDefinitionIndex = 32096;
