...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_GET_OFFSET UNITYSDK_OFFSET(0x8B64E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_INDEXOF_OFFSET UNITYSDK_OFFSET(0x8B62F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_REMOVE_OFFSET UNITYSDK_OFFSET(0x8B63B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_SET_OFFSET UNITYSDK_OFFSET(0x8B6520)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_DeviceArray_TypeDefinitionIndex = 28880;
