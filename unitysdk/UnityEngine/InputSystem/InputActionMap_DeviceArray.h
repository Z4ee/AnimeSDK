...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_GET_OFFSET UNITYSDK_OFFSET(0x95C9C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_INDEXOF_OFFSET UNITYSDK_OFFSET(0x95C7D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_REMOVE_OFFSET UNITYSDK_OFFSET(0x95C890)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_SET_OFFSET UNITYSDK_OFFSET(0x95CA00)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_DeviceArray_TypeDefinitionIndex = 31536;
