...
#define UNITYENGINE_INPUTSYSTEM_SENSOR_GET_SAMPLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1D8DF9F0)
#define UNITYENGINE_INPUTSYSTEM_SENSOR_SET_SAMPLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1D8DFA90)
#define UNITYENGINE_INPUTSYSTEM_SENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8DF550)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Sensor_TypeDefinitionIndex = 31664;
