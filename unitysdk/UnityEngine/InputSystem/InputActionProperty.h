...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x979D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x979E70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_3_OFFSET UNITYSDK_OFFSET(0x979EE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_OFFSET UNITYSDK_OFFSET(0x979C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x979EF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x979AE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_GET_REFERENCE_OFFSET UNITYSDK_OFFSET(0x979C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE5B110)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE5B1A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x979C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x979C40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionProperty_TypeDefinitionIndex = 32167;
