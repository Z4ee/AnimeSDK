...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x881120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x881280)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_3_OFFSET UNITYSDK_OFFSET(0x8812F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_EQUALS_OFFSET UNITYSDK_OFFSET(0x881090)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x881300)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x880EF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_GET_REFERENCE_OFFSET UNITYSDK_OFFSET(0x881040)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19595150)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x195951E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x881070)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x881050)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionProperty_TypeDefinitionIndex = 28891;
