...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_AT_OFFSET UNITYSDK_OFFSET(0xA67640)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_DONTRESET_OFFSET UNITYSDK_OFFSET(0xA677B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0xA57D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x259D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_ISBUTTON_OFFSET UNITYSDK_OFFSET(0xA67810)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_ISNOISY_OFFSET UNITYSDK_OFFSET(0xA57C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0xA67770)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_SET_CONTROL_OFFSET UNITYSDK_OFFSET(0x324D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHALIASES_OFFSET UNITYSDK_OFFSET(0xA676A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHCHILDREN_OFFSET UNITYSDK_OFFSET(0xA57C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xA676D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA57B30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHLAYOUT_OFFSET UNITYSDK_OFFSET(0xA57BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHMINANDMAX_OFFSET UNITYSDK_OFFSET(0xA67720)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHNAME_OFFSET UNITYSDK_OFFSET(0xA57AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHPARENT_OFFSET UNITYSDK_OFFSET(0xA67650)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHSHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA57B80)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHSTATEBLOCK_OFFSET UNITYSDK_OFFSET(0xA57C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_CONTROLBUILDER_WITHUSAGES_OFFSET UNITYSDK_OFFSET(0xA67670)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_ControlBuilder_TypeDefinitionIndex = 32231;
