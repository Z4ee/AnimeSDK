...
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1F7E6990)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISENDEDORCANCELED_OFFSET UNITYSDK_OFFSET(0x1F7E6980)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1F7E6970)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISMODIFIERKEY_OFFSET UNITYSDK_OFFSET(0x1F7E69B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISTEXTINPUTKEY_OFFSET UNITYSDK_OFFSET(0x1F7E69C0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputExtensions_TypeDefinitionIndex = 32300;
