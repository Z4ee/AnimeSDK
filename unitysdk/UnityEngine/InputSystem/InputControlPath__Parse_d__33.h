...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B354530)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B354770)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B354660)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B354800)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B3546F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B3546A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B354520)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x1B354500)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath__Parse_d__33_TypeDefinitionIndex = 28968;

	class InputControlPath__Parse_d__33 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::InputControlPath_PathParser _parser_5__2; // 0x10
