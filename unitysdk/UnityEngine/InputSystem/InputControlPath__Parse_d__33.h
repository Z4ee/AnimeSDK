...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D742220)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D742450)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D742360)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D7424E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D7423E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D742390)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D742210)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7421F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath__Parse_d__33_TypeDefinitionIndex = 31624;

	class InputControlPath__Parse_d__33 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::InputControlPath_ParsedPathComponent __2__current; // 0x10
		::System::String* path; // 0x60
		::System::String* __3__path; // 0x68
		::UnityEngine::InputSystem::InputControlPath_PathParser _parser_5__2; // 0x70
		::System::Int32 __1__state; // 0xD8
		::System::Int32 __l__initialThreadId; // 0xDC
