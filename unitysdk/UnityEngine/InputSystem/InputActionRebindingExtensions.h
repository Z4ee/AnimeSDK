...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_ADDBINDINGOVERRIDEJSONTO_OFFSET UNITYSDK_OFFSET(0x1EAD7200)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDESONMATCHINGCONTROLS_1_OFFSET UNITYSDK_OFFSET(0x1EAD6C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDESONMATCHINGCONTROLS_OFFSET UNITYSDK_OFFSET(0x1EAD6930)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1EAD6050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_1_OFFSET UNITYSDK_OFFSET(0x1EAD5010)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_2_OFFSET UNITYSDK_OFFSET(0x1EAD5250)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_3_OFFSET UNITYSDK_OFFSET(0x1EAD54C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_4_OFFSET UNITYSDK_OFFSET(0x1EAD50F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_5_OFFSET UNITYSDK_OFFSET(0x1EAD5350)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EAD4EF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_DEFERBINDINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1EAD5E40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_1_OFFSET UNITYSDK_OFFSET(0x1EAD45B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_2_OFFSET UNITYSDK_OFFSET(0x1EAD47D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_3_OFFSET UNITYSDK_OFFSET(0x1EAD4880)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_OFFSET UNITYSDK_OFFSET(0x1EAD4250)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1EAD3ED0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEXFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1EAD4070)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_1_OFFSET UNITYSDK_OFFSET(0x1EAD3C40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_2_OFFSET UNITYSDK_OFFSET(0x1EAD3D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x1EAD3B20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EAD7A70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSON_1_OFFSET UNITYSDK_OFFSET(0x1EAD7D80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSON_OFFSET UNITYSDK_OFFSET(0x1EAD78F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_PERFORMINTERACTIVEREBINDING_OFFSET UNITYSDK_OFFSET(0x1EAD7F10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEALLBINDINGOVERRIDES_1_OFFSET UNITYSDK_OFFSET(0x1EAD5EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEALLBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1EAD5890)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1EAD6480)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_1_OFFSET UNITYSDK_OFFSET(0x1EAD5660)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_2_OFFSET UNITYSDK_OFFSET(0x1EAD57D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EAD5570)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_SAVEBINDINGOVERRIDESASJSON_1_OFFSET UNITYSDK_OFFSET(0x1EAD7480)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_SAVEBINDINGOVERRIDESASJSON_OFFSET UNITYSDK_OFFSET(0x1EAD6D10)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionRebindingExtensions_TypeDefinitionIndex = 32168;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputActionRebindingExtensions_DeferBindingResolutionWrapper**)Il2CppClass::FromTypeDefinitionIndex(InputActionRebindingExtensions_TypeDefinitionIndex)->GetStaticField(0x27710);
		}
