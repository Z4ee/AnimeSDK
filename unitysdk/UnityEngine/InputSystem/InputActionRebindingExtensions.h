...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_ADDBINDINGOVERRIDEJSONTO_OFFSET UNITYSDK_OFFSET(0x1D740CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDESONMATCHINGCONTROLS_1_OFFSET UNITYSDK_OFFSET(0x1D7406C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDESONMATCHINGCONTROLS_OFFSET UNITYSDK_OFFSET(0x1D7403D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1D73FAF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_1_OFFSET UNITYSDK_OFFSET(0x1D73EAA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_2_OFFSET UNITYSDK_OFFSET(0x1D73ECE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_3_OFFSET UNITYSDK_OFFSET(0x1D73EF60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_4_OFFSET UNITYSDK_OFFSET(0x1D73EB80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_5_OFFSET UNITYSDK_OFFSET(0x1D73EDE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1D73E980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_DEFERBINDINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1D73F8E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_1_OFFSET UNITYSDK_OFFSET(0x1D73E040)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_2_OFFSET UNITYSDK_OFFSET(0x1D73E260)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_3_OFFSET UNITYSDK_OFFSET(0x1D73E310)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_OFFSET UNITYSDK_OFFSET(0x1D73DC60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1D73D8E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEXFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1D73DA80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_1_OFFSET UNITYSDK_OFFSET(0x1D73D650)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_2_OFFSET UNITYSDK_OFFSET(0x1D73D740)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x1D73D530)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D741530)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSON_1_OFFSET UNITYSDK_OFFSET(0x1D741830)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSON_OFFSET UNITYSDK_OFFSET(0x1D7413B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_PERFORMINTERACTIVEREBINDING_OFFSET UNITYSDK_OFFSET(0x1D7419C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEALLBINDINGOVERRIDES_1_OFFSET UNITYSDK_OFFSET(0x1D73F960)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEALLBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1D73F330)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1D73FF20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_1_OFFSET UNITYSDK_OFFSET(0x1D73F100)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_2_OFFSET UNITYSDK_OFFSET(0x1D73F270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1D73F010)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_SAVEBINDINGOVERRIDESASJSON_1_OFFSET UNITYSDK_OFFSET(0x1D740F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_SAVEBINDINGOVERRIDESASJSON_OFFSET UNITYSDK_OFFSET(0x1D7407B0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionRebindingExtensions_TypeDefinitionIndex = 31548;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputActionRebindingExtensions_DeferBindingResolutionWrapper**)Il2CppClass::FromTypeDefinitionIndex(InputActionRebindingExtensions_TypeDefinitionIndex)->GetStaticField(0x25F90);
		}
