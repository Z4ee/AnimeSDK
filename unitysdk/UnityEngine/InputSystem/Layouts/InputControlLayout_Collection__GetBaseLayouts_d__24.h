...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BC468D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_UTILITIES_INTERNEDSTRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BC46A50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_UTILITIES_INTERNEDSTRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BC469A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BC46B20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BC46A00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BC469B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BC468C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC468A0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Collection__GetBaseLayouts_d__24_TypeDefinitionIndex = 29335;

	class InputControlLayout_Collection__GetBaseLayouts_d__24 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection __3____4__this; // 0x10
		::UnityEngine::InputSystem::Utilities::InternedString layout; // 0x50
		::UnityEngine::InputSystem::Utilities::InternedString __2__current; // 0x60
		::UnityEngine::InputSystem::Utilities::InternedString __3__layout; // 0x70
		::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection __4__this; // 0x80
		::System::Int32 __l__initialThreadId; // 0xC0
		::System::Int32 __1__state; // 0xC4
		::System::Boolean includeSelf; // 0xC8
		::System::Boolean __3__includeSelf; // 0xC9
