...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_ADDCONTROL_OFFSET UNITYSDK_OFFSET(0x1F12B200)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1F12B430)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_EXTEND_OFFSET UNITYSDK_OFFSET(0x1F12B410)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_CONTROLS_OFFSET UNITYSDK_OFFSET(0x1F12B1E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1F12B110)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_EXTENDSLAYOUT_OFFSET UNITYSDK_OFFSET(0x1F12B190)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1F12B0F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x1F12B150)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1F12B170)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1F12B130)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_UPDATEBEFORERENDER_OFFSET UNITYSDK_OFFSET(0x1F12B1C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1F12B120)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_EXTENDSLAYOUT_OFFSET UNITYSDK_OFFSET(0x1F12B1A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1F12B100)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x1F12B160)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1F12B180)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1F12B140)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_UPDATEBEFORERENDER_OFFSET UNITYSDK_OFFSET(0x1F12B1D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1F12B3B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1F12B3D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHFORMAT_OFFSET UNITYSDK_OFFSET(0x1F12B3C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHNAME_OFFSET UNITYSDK_OFFSET(0x1F12B3A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1F12B400)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F12B5C0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Builder_TypeDefinitionIndex = 32599;
	...
	public:
		...
		::UnityEngine::InputSystem::Utilities::FourCC _stateFormat_k__BackingField; // 0x40
		::System::Int32 _stateSizeInBytes_k__BackingField; // 0x44
