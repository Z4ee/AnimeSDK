...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_ADDCONTROL_OFFSET UNITYSDK_OFFSET(0x1B98C890)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1B98CAD0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_EXTEND_OFFSET UNITYSDK_OFFSET(0x1B98CAB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_CONTROLS_OFFSET UNITYSDK_OFFSET(0x1B98C870)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B98C7A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_EXTENDSLAYOUT_OFFSET UNITYSDK_OFFSET(0x1B98C820)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B98C780)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x1B98C7E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B98C800)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B98C7C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_GET_UPDATEBEFORERENDER_OFFSET UNITYSDK_OFFSET(0x1B98C850)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B98C7B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_EXTENDSLAYOUT_OFFSET UNITYSDK_OFFSET(0x1B98C830)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B98C790)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x1B98C7F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B98C810)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B98C7D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_SET_UPDATEBEFORERENDER_OFFSET UNITYSDK_OFFSET(0x1B98C860)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B98CA50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1B98CA70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHFORMAT_OFFSET UNITYSDK_OFFSET(0x1B98CA60)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHNAME_OFFSET UNITYSDK_OFFSET(0x1B98CA40)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER_WITHSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B98CAA0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B98CC70)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Builder_TypeDefinitionIndex = 29323;
