...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x383610)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CACHE_FINDORLOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x96A220)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Cache_TypeDefinitionIndex = 29337;
