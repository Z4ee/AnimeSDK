...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F16B820)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F16B8B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F16B4D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F16B4B0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceFindControlLayoutDelegate_TypeDefinitionIndex = 32595;
