...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9F3F40)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9F3FD0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9F3BC0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F3BB0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceFindControlLayoutDelegate_TypeDefinitionIndex = 29319;
