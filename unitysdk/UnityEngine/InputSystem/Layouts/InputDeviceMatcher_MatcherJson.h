...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHERJSON_FROMMATCHER_OFFSET UNITYSDK_OFFSET(0x1B3FE500)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHERJSON_TOMATCHER_OFFSET UNITYSDK_OFFSET(0x96A250)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceMatcher_MatcherJson_TypeDefinitionIndex = 29346;
