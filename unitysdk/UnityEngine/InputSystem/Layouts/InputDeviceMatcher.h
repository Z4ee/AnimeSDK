...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA43550)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_EQUALS_OFFSET UNITYSDK_OFFSET(0xA43540)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_FROMDEVICEDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1DDECEE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5DB680)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GETNUMPROPERTIESIN_OFFSET UNITYSDK_OFFSET(0x1DDECE30)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x427580)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GET_PATTERNS_OFFSET UNITYSDK_OFFSET(0xA431A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xA434F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHSINGLEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1DDECD90)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1DDED5E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1DDED600)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA43530)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHDEVICECLASS_OFFSET UNITYSDK_OFFSET(0xA43290)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHINTERFACE_OFFSET UNITYSDK_OFFSET(0xA43200)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHMANUFACTURER_OFFSET UNITYSDK_OFFSET(0xA43320)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHPRODUCT_OFFSET UNITYSDK_OFFSET(0xA433B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHVERSION_OFFSET UNITYSDK_OFFSET(0xA43440)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITH_OFFSET UNITYSDK_OFFSET(0xA434D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DDED6A0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceMatcher_TypeDefinitionIndex = 32001;

	struct alignas(8) InputDeviceMatcher
	{
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kManufacturerKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x26490);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kProductKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x264A0);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kVersionKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x264B0);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kInterfaceKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x264C0);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kDeviceClassKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x264D0);
		}
