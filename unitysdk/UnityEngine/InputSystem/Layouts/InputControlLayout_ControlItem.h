...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ALIASES_OFFSET UNITYSDK_OFFSET(0xA93300)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0xA933E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_BIT_OFFSET UNITYSDK_OFFSET(0xA93380)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xA93400)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x45C240)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DONTRESET_OFFSET UNITYSDK_OFFSET(0xA934F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x9F8100)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0xA933C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0xA93550)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0xA93520)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0xA93460)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISNOISY_OFFSET UNITYSDK_OFFSET(0xA93490)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0xA934C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x41E4B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0xA93440)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0xA93420)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x31EA80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0xA93360)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0xA93320)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0xA93340)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x44DFB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0xA933A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USAGES_OFFSET UNITYSDK_OFFSET(0xA571D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x3D1B20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x7DAE80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_MERGE_OFFSET UNITYSDK_OFFSET(0xA93560)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ALIASES_OFFSET UNITYSDK_OFFSET(0xA93310)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0xA933F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_BIT_OFFSET UNITYSDK_OFFSET(0xA93390)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xA93410)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x7BAEA0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DONTRESET_OFFSET UNITYSDK_OFFSET(0xA93500)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x9F8110)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FORMAT_OFFSET UNITYSDK_OFFSET(0xA933D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0xA93530)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0xA93470)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISNOISY_OFFSET UNITYSDK_OFFSET(0xA934A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0xA934D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x56EA80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0xA93450)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MINVALUE_OFFSET UNITYSDK_OFFSET(0xA93430)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0x31EB80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0xA93370)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0xA93330)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0xA93350)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA932E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0xA933B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USAGES_OFFSET UNITYSDK_OFFSET(0xA932F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x6B88C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x7DAF70)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_ControlItem_TypeDefinitionIndex = 32597;
