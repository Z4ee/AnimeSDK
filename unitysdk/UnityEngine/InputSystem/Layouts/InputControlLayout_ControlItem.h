...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ALIASES_OFFSET UNITYSDK_OFFSET(0xA40050)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0xA40130)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_BIT_OFFSET UNITYSDK_OFFSET(0xA400D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xA40150)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x3E4060)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DONTRESET_OFFSET UNITYSDK_OFFSET(0xA40240)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x9AED10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0xA40110)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0xA402A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0xA40270)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0xA401B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISNOISY_OFFSET UNITYSDK_OFFSET(0xA401E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0xA40210)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x3E6590)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0xA40190)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0xA40170)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2ADAB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0xA400B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0xA40070)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0xA40090)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x449390)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0xA400F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USAGES_OFFSET UNITYSDK_OFFSET(0xA078B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x3E3D10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x803FF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_MERGE_OFFSET UNITYSDK_OFFSET(0xA402B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ALIASES_OFFSET UNITYSDK_OFFSET(0xA40060)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0xA40140)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_BIT_OFFSET UNITYSDK_OFFSET(0xA400E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xA40160)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x7BC8C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DONTRESET_OFFSET UNITYSDK_OFFSET(0xA40250)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x9AED20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FORMAT_OFFSET UNITYSDK_OFFSET(0xA40120)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0xA40280)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0xA401C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISNOISY_OFFSET UNITYSDK_OFFSET(0xA401F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0xA40220)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x446EF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0xA401A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MINVALUE_OFFSET UNITYSDK_OFFSET(0xA40180)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2AD810)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0xA400C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0xA40080)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0xA400A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA40030)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0xA40100)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USAGES_OFFSET UNITYSDK_OFFSET(0xA40040)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x775AF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x803FE0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_ControlItem_TypeDefinitionIndex = 31977;
