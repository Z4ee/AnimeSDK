...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ADDMATCHER_OFFSET UNITYSDK_OFFSET(0x9B2A30)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x9B2560)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_COMPUTEDISTANCEININHERITANCEHIERARCHY_OFFSET UNITYSDK_OFFSET(0x9B2770)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_FINDLAYOUTTHATINTRODUCESCONTROL_OFFSET UNITYSDK_OFFSET(0x9B27A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETBASELAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x9B2640)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETBASELAYOUTS_OFFSET UNITYSDK_OFFSET(0x9B2900)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETCONTROLTYPEFORLAYOUT_OFFSET UNITYSDK_OFFSET(0x9B27C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETROOTLAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x9B26C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_HASLAYOUT_OFFSET UNITYSDK_OFFSET(0x9B25E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ISBASEDON_OFFSET UNITYSDK_OFFSET(0x9B2990)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ISGENERATEDLAYOUT_OFFSET UNITYSDK_OFFSET(0x9B2870)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYFINDLAYOUTFORTYPE_OFFSET UNITYSDK_OFFSET(0x9B2570)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYFINDMATCHINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x9B2590)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYLOADLAYOUTINTERNAL_OFFSET UNITYSDK_OFFSET(0x9B2600)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYLOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x9B2620)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_VALUETYPEISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x9B27E0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Collection_TypeDefinitionIndex = 29332;
