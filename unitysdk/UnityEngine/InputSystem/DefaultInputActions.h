...
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1DD7D7C0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_DISABLE_OFFSET UNITYSDK_OFFSET(0x1DD7D910)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DD7D580)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_ENABLE_OFFSET UNITYSDK_OFFSET(0x1DD7D8F0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_FINDACTION_OFFSET UNITYSDK_OFFSET(0x1DD7D9A0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x1DD7D9C0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DD7D850)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1DD7D2E0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1DD7D630)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1DD7D930)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1DD7D780)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1DD7D6E0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_GAMEPADSCHEME_OFFSET UNITYSDK_OFFSET(0x1DD7DB10)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_JOYSTICKSCHEME_OFFSET UNITYSDK_OFFSET(0x1DD7DCB0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_KEYBOARDMOUSESCHEME_OFFSET UNITYSDK_OFFSET(0x1DD7DA40)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1DD7DA20)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_TOUCHSCHEME_OFFSET UNITYSDK_OFFSET(0x1DD7DBE0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_UI_OFFSET UNITYSDK_OFFSET(0x1DD7DA30)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_XRSCHEME_OFFSET UNITYSDK_OFFSET(0x1DD7DD80)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1DD7D680)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1DD7D740)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DD7D8A0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD7D2F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int DefaultInputActions_TypeDefinitionIndex = 31695;

	class DefaultInputActions : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::InputAction* m_UI_Point; // 0x10
		::UnityEngine::InputSystem::InputAction* m_UI_ScrollWheel; // 0x18
		::UnityEngine::InputSystem::InputAction* m_UI_TrackedDevicePosition; // 0x20
		::UnityEngine::InputSystem::InputAction* m_UI_Cancel; // 0x28
		::UnityEngine::InputSystem::DefaultInputActions_IPlayerActions* m_PlayerActionsCallbackInterface; // 0x30
		::UnityEngine::InputSystem::InputAction* m_UI_Click; // 0x38
		::UnityEngine::InputSystem::InputAction* m_UI_Navigate; // 0x40
		::UnityEngine::InputSystem::InputAction* m_UI_MiddleClick; // 0x48
		::UnityEngine::InputSystem::InputActionMap* m_UI; // 0x50
		::UnityEngine::InputSystem::InputAction* m_UI_RightClick; // 0x58
		::UnityEngine::InputSystem::InputActionAsset* _asset_k__BackingField; // 0x60
		::UnityEngine::InputSystem::InputAction* m_UI_Submit; // 0x68
		::UnityEngine::InputSystem::DefaultInputActions_IUIActions* m_UIActionsCallbackInterface; // 0x70
		::UnityEngine::InputSystem::InputAction* m_UI_TrackedDeviceOrientation; // 0x78
		::UnityEngine::InputSystem::InputAction* m_Player_Fire; // 0x80
		::UnityEngine::InputSystem::InputActionMap* m_Player; // 0x88
		::UnityEngine::InputSystem::InputAction* m_Player_Look; // 0x90
		::UnityEngine::InputSystem::InputAction* m_Player_Move; // 0x98
		::System::Int32 m_JoystickSchemeIndex; // 0xA0
		::System::Int32 m_TouchSchemeIndex; // 0xA4
		::System::Int32 m_GamepadSchemeIndex; // 0xA8
