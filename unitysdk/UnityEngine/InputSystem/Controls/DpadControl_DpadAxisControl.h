...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B9EF6D0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1B9EF6B0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1B9EF810)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_SET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1B9EF6C0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EF8F0)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DpadControl_DpadAxisControl_TypeDefinitionIndex = 29358;
