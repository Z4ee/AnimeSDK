...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1F166F50)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1F166F30)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1F167090)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_SET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1F166F40)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F167170)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DpadControl_DpadAxisControl_TypeDefinitionIndex = 32634;
