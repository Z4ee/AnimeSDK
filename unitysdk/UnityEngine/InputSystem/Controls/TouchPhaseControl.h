...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPHASECONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1E39C860)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPHASECONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1E39C880)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPHASECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E39C7F0)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int TouchPhaseControl_TypeDefinitionIndex = 32021;
