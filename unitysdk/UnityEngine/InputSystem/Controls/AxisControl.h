...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_COMPAREVALUE_OFFSET UNITYSDK_OFFSET(0x1EC324D0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1EC32640)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1EC32370)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x1EC32120)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1EC323E0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_UNPREPROCESS_OFFSET UNITYSDK_OFFSET(0x1EC32260)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1EC32410)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_AXISCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC32300)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int AxisControl_TypeDefinitionIndex = 32627;

	class AxisControl : public ::UnityEngine::InputSystem::InputControl_1<::System::Single>
	{
	public:
		::System::Boolean normalize; // 0xF0
		::System::Boolean scale; // 0xF1
		::System::Boolean invert; // 0xF2
		::System::Single scaleFactor; // 0xF4
		::System::Single clampMax; // 0xF8
		::UnityEngine::InputSystem::Controls::AxisControl_Clamp clamp; // 0xFC
		::System::Single clampMin; // 0x100
		::System::Single normalizeMin; // 0x104
		::System::Single normalizeMax; // 0x108
