...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_GET_KEYCODE_OFFSET UNITYSDK_OFFSET(0x1D795830)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_GET_SCANCODE_OFFSET UNITYSDK_OFFSET(0x1D795850)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_REFRESHCONFIGURATION_OFFSET UNITYSDK_OFFSET(0x1D795890)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_SET_KEYCODE_OFFSET UNITYSDK_OFFSET(0x1D795840)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D795A10)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int KeyControl_TypeDefinitionIndex = 32637;
