...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DOUBLECONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1C086ED0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DOUBLECONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1C086EE0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DOUBLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C086E60)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DoubleControl_TypeDefinitionIndex = 29356;
