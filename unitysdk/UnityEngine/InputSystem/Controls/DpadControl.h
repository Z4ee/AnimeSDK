...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1F377FF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1F377ED0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1F377EF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1F377F10)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_UP_OFFSET UNITYSDK_OFFSET(0x1F377EB0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_MAKEDPADVECTOR_1_OFFSET UNITYSDK_OFFSET(0x1F3785B0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_MAKEDPADVECTOR_OFFSET UNITYSDK_OFFSET(0x1F3784B0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1F3780F0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_DOWN_OFFSET UNITYSDK_OFFSET(0x1F377EE0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_LEFT_OFFSET UNITYSDK_OFFSET(0x1F377F00)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1F377F20)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_UP_OFFSET UNITYSDK_OFFSET(0x1F377EC0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1F378560)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F377F30)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DpadControl_TypeDefinitionIndex = 32633;
