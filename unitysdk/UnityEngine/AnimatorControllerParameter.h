...
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EE9B8A0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EE9B970)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTBOOL_OFFSET UNITYSDK_OFFSET(0x1EE9B880)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTFLOAT_OFFSET UNITYSDK_OFFSET(0x1EE9B840)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTINT_OFFSET UNITYSDK_OFFSET(0x1EE9B860)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0x1EE9B800)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EE9B7F0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1EE9B830)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_SET_DEFAULTBOOL_OFFSET UNITYSDK_OFFSET(0x1EE9B890)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_SET_DEFAULTFLOAT_OFFSET UNITYSDK_OFFSET(0x1EE9B850)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_SET_DEFAULTINT_OFFSET UNITYSDK_OFFSET(0x1EE9B870)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE9BA00)
