...
#define UNITYENGINE_AI_NAVMESHHIT_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xB596C0)
#define UNITYENGINE_AI_NAVMESHHIT_GET_HIT_OFFSET UNITYSDK_OFFSET(0x3C8B8C0)
#define UNITYENGINE_AI_NAVMESHHIT_GET_MASK_OFFSET UNITYSDK_OFFSET(0xF6A0)
#define UNITYENGINE_AI_NAVMESHHIT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x17670)
