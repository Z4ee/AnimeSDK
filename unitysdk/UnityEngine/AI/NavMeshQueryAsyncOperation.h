...
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_CANCEL_OFFSET UNITYSDK_OFFSET(0x1C02C130)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GETCORNERSNONALLOC_OFFSET UNITYSDK_OFFSET(0x1C02C070)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GETNATIVECORNERS_OFFSET UNITYSDK_OFFSET(0x1C02C120)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GET_CORNERCOUNT_OFFSET UNITYSDK_OFFSET(0x1C02C060)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GET_STATUSNUM_OFFSET UNITYSDK_OFFSET(0x1C02C050)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C02C140)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshQueryAsyncOperation_TypeDefinitionIndex = 24812;
