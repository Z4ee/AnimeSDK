...
#define UNITYENGINE_AI_OFFMESHLINKDATA_GET_ENDPOS_OFFSET UNITYSDK_OFFSET(0x97A360)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int OffMeshLinkData_TypeDefinitionIndex = 27996;
