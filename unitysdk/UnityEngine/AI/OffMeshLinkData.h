...
#define UNITYENGINE_AI_OFFMESHLINKDATA_GET_ENDPOS_OFFSET UNITYSDK_OFFSET(0x92A7D0)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int OffMeshLinkData_TypeDefinitionIndex = 27394;
