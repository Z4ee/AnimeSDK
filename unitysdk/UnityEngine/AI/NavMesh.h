...
#define UNITYENGINE_AI_NAVMESH_ADDLINKINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74B270)
#define UNITYENGINE_AI_NAVMESH_ADDLINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74B260)
#define UNITYENGINE_AI_NAVMESH_ADDLINK_OFFSET UNITYSDK_OFFSET(0x1F74B200)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74AFE0)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATATRANSFORMEDINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74B1F0)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATATRANSFORMEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74B180)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATA_1_OFFSET UNITYSDK_OFFSET(0x1F74AFF0)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1F74AE80)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHFILTERINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74B330)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHFILTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74B320)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74ADB0)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74ADA0)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATH_1_OFFSET UNITYSDK_OFFSET(0x1F74B290)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATH_OFFSET UNITYSDK_OFFSET(0x1F74AD00)
#define UNITYENGINE_AI_NAVMESH_CALCULATETRIANGULATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74AE70)
#define UNITYENGINE_AI_NAVMESH_CALCULATETRIANGULATION_OFFSET UNITYSDK_OFFSET(0x1F74AE30)
#define UNITYENGINE_AI_NAVMESH_FINDCLOSESTEDGE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74ADD0)
#define UNITYENGINE_AI_NAVMESH_FINDCLOSESTEDGE_OFFSET UNITYSDK_OFFSET(0x1F74ADC0)
#define UNITYENGINE_AI_NAVMESH_GETAREACOST_OFFSET UNITYSDK_OFFSET(0x1F74AE10)
#define UNITYENGINE_AI_NAVMESH_GETAREAFROMNAME_OFFSET UNITYSDK_OFFSET(0x1F74AE20)
#define UNITYENGINE_AI_NAVMESH_GETSETTINGSBYID_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74B3A0)
#define UNITYENGINE_AI_NAVMESH_GETSETTINGSBYID_OFFSET UNITYSDK_OFFSET(0x1F74B340)
#define UNITYENGINE_AI_NAVMESH_INTERNALSETLINKOWNER_OFFSET UNITYSDK_OFFSET(0x1F74B1E0)
#define UNITYENGINE_AI_NAVMESH_INTERNALSETOWNER_OFFSET UNITYSDK_OFFSET(0x1F74B1D0)
#define UNITYENGINE_AI_NAVMESH_INTERNAL_CALLONNAVMESHPREUPDATE_OFFSET UNITYSDK_OFFSET(0x1F74AA30)
#define UNITYENGINE_AI_NAVMESH_ISVALIDLINKHANDLE_OFFSET UNITYSDK_OFFSET(0x1F74B1C0)
#define UNITYENGINE_AI_NAVMESH_ISVALIDNAVMESHDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x1F74B1B0)
#define UNITYENGINE_AI_NAVMESH_RAYCAST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74ACF0)
#define UNITYENGINE_AI_NAVMESH_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1F74ACE0)
#define UNITYENGINE_AI_NAVMESH_REMOVELINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74B280)
#define UNITYENGINE_AI_NAVMESH_REMOVENAVMESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F74B1A0)
#define UNITYENGINE_AI_NAVMESH_REMOVENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1F74B190)
#define UNITYENGINE_AI_NAVMESH_SAMPLEPOSITION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74ADF0)
#define UNITYENGINE_AI_NAVMESH_SAMPLEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F74ADE0)
#define UNITYENGINE_AI_NAVMESH_SETAREACOST_OFFSET UNITYSDK_OFFSET(0x1F74AE00)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMesh_TypeDefinitionIndex = 28004;
	...
	public:
		...
		{
			return (::UnityEngine::AI::NavMesh_OnNavMeshPreUpdate**)Il2CppClass::FromTypeDefinitionIndex(NavMesh_TypeDefinitionIndex)->GetStaticField(0x23C20);
		}
