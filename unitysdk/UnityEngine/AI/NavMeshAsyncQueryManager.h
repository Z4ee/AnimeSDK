...
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_INJECTED_OFFSET UNITYSDK_OFFSET(0x1F74BE70)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_OFFSET UNITYSDK_OFFSET(0x1F74BE60)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F74BE80)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshAsyncQueryManager_TypeDefinitionIndex = 28008;
