...
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_INJECTED_OFFSET UNITYSDK_OFFSET(0x1E34AB50)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_OFFSET UNITYSDK_OFFSET(0x1E34AB40)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E34AB60)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshAsyncQueryManager_TypeDefinitionIndex = 27406;
