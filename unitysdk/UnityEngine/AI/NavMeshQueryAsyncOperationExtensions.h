...
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATIONEXTENSIONS_ISPATHPARTIALDONE_OFFSET UNITYSDK_OFFSET(0x1E34C470)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATIONEXTENSIONS_ISSTATUSDONE_OFFSET UNITYSDK_OFFSET(0x1E34C440)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATIONEXTENSIONS_ISSTRAIGHTDONE_OFFSET UNITYSDK_OFFSET(0x1E34C4B0)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshQueryAsyncOperationExtensions_TypeDefinitionIndex = 27404;
