...
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ECE1680)
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ECE16F0)
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ECE1240)
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECE1610)
