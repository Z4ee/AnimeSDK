...
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_AREA_OFFSET UNITYSDK_OFFSET(0x1D50)
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_IGNOREFROMBUILD_OFFSET UNITYSDK_OFFSET(0x210CE80)
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_OVERRIDEAREA_OFFSET UNITYSDK_OFFSET(0x210CE70)
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x210CE90)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshBuildMarkup_TypeDefinitionIndex = 5373;
