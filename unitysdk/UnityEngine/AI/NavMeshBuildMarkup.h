...
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_AREA_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_IGNOREFROMBUILD_OFFSET UNITYSDK_OFFSET(0xA5FED0)
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_OVERRIDEAREA_OFFSET UNITYSDK_OFFSET(0xA0E540)
#define UNITYENGINE_AI_NAVMESHBUILDMARKUP_SET_ROOT_OFFSET UNITYSDK_OFFSET(0xA5FEE0)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshBuildMarkup_TypeDefinitionIndex = 27410;
