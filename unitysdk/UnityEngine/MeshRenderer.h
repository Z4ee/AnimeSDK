...
#define UNITYENGINE_MESHRENDERER_DONTSTRIPMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1DA28DC0)
#define UNITYENGINE_MESHRENDERER_GET_ADDITIONALVERTEXSTREAMS_OFFSET UNITYSDK_OFFSET(0x1DA28DD0)
#define UNITYENGINE_MESHRENDERER_GET_BOUNDSSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DA28E70)
#define UNITYENGINE_MESHRENDERER_GET_BOUNDSSCALE_OFFSET UNITYSDK_OFFSET(0x1DA28E20)
#define UNITYENGINE_MESHRENDERER_GET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1DA28E00)
#define UNITYENGINE_MESHRENDERER_GET_SUBMESHSTARTINDEX_OFFSET UNITYSDK_OFFSET(0x1DA28DF0)
#define UNITYENGINE_MESHRENDERER_RESETVISIBLEEFFECTPREFABSQUERY_OFFSET UNITYSDK_OFFSET(0x1DA28EA0)
#define UNITYENGINE_MESHRENDERER_SET_ADDITIONALVERTEXSTREAMS_OFFSET UNITYSDK_OFFSET(0x1DA28DE0)
#define UNITYENGINE_MESHRENDERER_SET_BOUNDSSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DA28E90)
#define UNITYENGINE_MESHRENDERER_SET_BOUNDSSCALE_OFFSET UNITYSDK_OFFSET(0x1DA28E80)
#define UNITYENGINE_MESHRENDERER_SET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1DA28E10)
#define UNITYENGINE_MESHRENDERER_VISIBLEEFFECTPREFABSQUERY_OFFSET UNITYSDK_OFFSET(0x1DA28EB0)
#define UNITYENGINE_MESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA28EC0)
