...
#define UNITYENGINE_MESHRENDERER_DONTSTRIPMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1B65C720)
#define UNITYENGINE_MESHRENDERER_GET_ADDITIONALVERTEXSTREAMS_OFFSET UNITYSDK_OFFSET(0x1B65C730)
#define UNITYENGINE_MESHRENDERER_GET_BOUNDSSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B65C7D0)
#define UNITYENGINE_MESHRENDERER_GET_BOUNDSSCALE_OFFSET UNITYSDK_OFFSET(0x1B65C780)
#define UNITYENGINE_MESHRENDERER_GET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1B65C760)
#define UNITYENGINE_MESHRENDERER_GET_SUBMESHSTARTINDEX_OFFSET UNITYSDK_OFFSET(0x1B65C750)
#define UNITYENGINE_MESHRENDERER_RESETVISIBLEEFFECTPREFABSQUERY_OFFSET UNITYSDK_OFFSET(0x1B65C800)
#define UNITYENGINE_MESHRENDERER_SET_ADDITIONALVERTEXSTREAMS_OFFSET UNITYSDK_OFFSET(0x1B65C740)
#define UNITYENGINE_MESHRENDERER_SET_BOUNDSSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B65C7F0)
#define UNITYENGINE_MESHRENDERER_SET_BOUNDSSCALE_OFFSET UNITYSDK_OFFSET(0x1B65C7E0)
#define UNITYENGINE_MESHRENDERER_SET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1B65C770)
#define UNITYENGINE_MESHRENDERER_VISIBLEEFFECTPREFABSQUERY_OFFSET UNITYSDK_OFFSET(0x1B65C810)
#define UNITYENGINE_MESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65C820)
