...
#define UNITYENGINE_RECTINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C5750)
#define UNITYENGINE_RECTINT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define UNITYENGINE_RECTINT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNITYENGINE_RECTINT_GET_X_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UNITYENGINE_RECTINT_GET_Y_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define UNITYENGINE_RECTINT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x52CD90)
#define UNITYENGINE_RECTINT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define UNITYENGINE_RECTINT_SET_X_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define UNITYENGINE_RECTINT_SET_Y_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define UNITYENGINE_RECTINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA06C30)
#define UNITYENGINE_RECTINT__CTOR_OFFSET UNITYSDK_OFFSET(0x588040)
