...
#define UNITYENGINE_IMAGECONVERSION_ENCODEARRAYTOJPG_OFFSET UNITYSDK_OFFSET(0x1A49C210)
#define UNITYENGINE_IMAGECONVERSION_ENCODEARRAYTOPNG_OFFSET UNITYSDK_OFFSET(0x1A49C200)
#define UNITYENGINE_IMAGECONVERSION_ENCODEARRAYTOTGA_OFFSET UNITYSDK_OFFSET(0x1A49C1F0)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOJPG_1_OFFSET UNITYSDK_OFFSET(0x1A49C1C0)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOJPG_OFFSET UNITYSDK_OFFSET(0x1A49C1B0)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOPNG_OFFSET UNITYSDK_OFFSET(0x1A49C1A0)
#define UNITYENGINE_IMAGECONVERSION_LOADIMAGE_1_OFFSET UNITYSDK_OFFSET(0x1A49C1E0)
#define UNITYENGINE_IMAGECONVERSION_LOADIMAGE_OFFSET UNITYSDK_OFFSET(0x1A49C1D0)
#define UNITYENGINE_IMAGECONVERSION_UNSAFEENCODENATIVEARRAYTOJPG_OFFSET UNITYSDK_OFFSET(0x1A49C240)
#define UNITYENGINE_IMAGECONVERSION_UNSAFEENCODENATIVEARRAYTOPNG_OFFSET UNITYSDK_OFFSET(0x1A49C230)
#define UNITYENGINE_IMAGECONVERSION_UNSAFEENCODENATIVEARRAYTOTGA_OFFSET UNITYSDK_OFFSET(0x1A49C220)

namespace UnityEngine
{
	inline static constexpr unsigned int ImageConversion_TypeDefinitionIndex = 5154;
