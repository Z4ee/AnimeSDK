...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A5C2260)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5C22C0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5C0FA0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5C2240)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_FrameReadyEventHandler_TypeDefinitionIndex = 6024;
