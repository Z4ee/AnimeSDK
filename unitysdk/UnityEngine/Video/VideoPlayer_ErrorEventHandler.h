...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A5C2190)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5C21D0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5C15D0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5C2170)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_ErrorEventHandler_TypeDefinitionIndex = 6023;
