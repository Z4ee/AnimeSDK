...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F00C4F0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F00C530)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F00C3C0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F00C470)
