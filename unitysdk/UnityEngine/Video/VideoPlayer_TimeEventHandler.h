...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E752200)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E752260)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E751A30)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7521E0)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_TimeEventHandler_TypeDefinitionIndex = 19087;
