...
#define UNITYENGINE_RANGEINT_GET_END_OFFSET UNITYSDK_OFFSET(0x8880B0)
#define UNITYENGINE_RANGEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)

namespace UnityEngine
{
	inline static constexpr unsigned int RangeInt_TypeDefinitionIndex = 5354;
