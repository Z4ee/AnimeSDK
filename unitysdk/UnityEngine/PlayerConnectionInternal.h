...
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_DISCONNECTALL_OFFSET UNITYSDK_OFFSET(0x1EDE6690)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EDE6650)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1EDE6670)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_POLLINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EDE6570)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_REGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EDE65D0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0x1EDE6460)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_TRYSENDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EDE6550)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_DISCONNECTALL_OFFSET UNITYSDK_OFFSET(0x1EDE6680)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EDE6640)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1EDE6660)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_POLL_OFFSET UNITYSDK_OFFSET(0x1EDE6560)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_REGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EDE6580)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_SENDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EDE6380)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_TRYSENDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EDE6470)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_UNREGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EDE65E0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNREGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EDE6630)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE66A0)
