...
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_DISCONNECTALL_OFFSET UNITYSDK_OFFSET(0x1A466CC0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A466CA0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A466CB0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_POLLINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A466C70)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_REGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A466C80)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0x1A466C50)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_TRYSENDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A466C60)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_DISCONNECTALL_OFFSET UNITYSDK_OFFSET(0x1A4620B0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A460F40)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A460EA0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_POLL_OFFSET UNITYSDK_OFFSET(0x1A462030)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_REGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4611E0)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_SENDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A461A10)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_TRYSENDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A461C30)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNITYENGINE_IPLAYEREDITORCONNECTIONNATIVE_UNREGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A461670)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL_UNREGISTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A466C90)
#define UNITYENGINE_PLAYERCONNECTIONINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A460F50)

namespace UnityEngine
{
	inline static constexpr unsigned int PlayerConnectionInternal_TypeDefinitionIndex = 4043;
