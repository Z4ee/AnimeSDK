...
#define UNITYENGINE_TARGETJOINT2D_GET_ANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF91590)
#define UNITYENGINE_TARGETJOINT2D_GET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x1DF91560)
#define UNITYENGINE_TARGETJOINT2D_GET_TARGET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF91600)
#define UNITYENGINE_TARGETJOINT2D_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1DF915D0)
#define UNITYENGINE_TARGETJOINT2D_SET_ANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF915C0)
#define UNITYENGINE_TARGETJOINT2D_SET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x1DF915A0)
#define UNITYENGINE_TARGETJOINT2D_SET_AUTOCONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1DF91640)
#define UNITYENGINE_TARGETJOINT2D_SET_DAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1DF91660)
#define UNITYENGINE_TARGETJOINT2D_SET_FREQUENCY_OFFSET UNITYSDK_OFFSET(0x1DF91670)
#define UNITYENGINE_TARGETJOINT2D_SET_MAXFORCE_OFFSET UNITYSDK_OFFSET(0x1DF91650)
#define UNITYENGINE_TARGETJOINT2D_SET_TARGET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1DF91630)
#define UNITYENGINE_TARGETJOINT2D_SET_TARGET_OFFSET UNITYSDK_OFFSET(0x1DF91610)
#define UNITYENGINE_TARGETJOINT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF91680)

namespace UnityEngine
{
	inline static constexpr unsigned int TargetJoint2D_TypeDefinitionIndex = 18397;
