...
#define UNITYENGINE_CHARACTERINFO_GET_ADVANCE_OFFSET UNITYSDK_OFFSET(0x3C9E710)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMLEFTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x379F9F0)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMLEFT_OFFSET UNITYSDK_OFFSET(0x379F9F0)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMRIGHTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x3C9E760)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMRIGHT_OFFSET UNITYSDK_OFFSET(0x3C9E7D0)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPLEFTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x3C9E7B0)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPLEFT_OFFSET UNITYSDK_OFFSET(0x3C9E810)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPRIGHTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x3C9E780)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPRIGHT_OFFSET UNITYSDK_OFFSET(0x3C9E780)
