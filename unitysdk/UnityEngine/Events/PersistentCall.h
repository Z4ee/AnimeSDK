...
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GETOBJECTCALL_OFFSET UNITYSDK_OFFSET(0x1B2EE700)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GETRUNTIMECALL_OFFSET UNITYSDK_OFFSET(0x1B2EE340)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1B2EE1C0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_CALLSTATE_OFFSET UNITYSDK_OFFSET(0x1B2EE1D0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1B2EE190)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1B2EE1A0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1B2EE180)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B2EE1F0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_REGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1B2EEE40)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_SET_CALLSTATE_OFFSET UNITYSDK_OFFSET(0x1B2EE1E0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1B2EE1B0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_UNREGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1B2EEE50)
#define UNITYENGINE_EVENTS_PERSISTENTCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EEE70)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int PersistentCall_TypeDefinitionIndex = 5490;
