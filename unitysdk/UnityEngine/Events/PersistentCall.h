...
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GETOBJECTCALL_OFFSET UNITYSDK_OFFSET(0x1D6A45B0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GETRUNTIMECALL_OFFSET UNITYSDK_OFFSET(0x1D6A41F0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1D6A4070)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_CALLSTATE_OFFSET UNITYSDK_OFFSET(0x1D6A4080)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1D6A4040)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1D6A4050)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1D6A4030)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D6A40A0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_REGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1D6A4CF0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_SET_CALLSTATE_OFFSET UNITYSDK_OFFSET(0x1D6A4090)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1D6A4060)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_UNREGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1D6A4D00)
#define UNITYENGINE_EVENTS_PERSISTENTCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A4D20)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int PersistentCall_TypeDefinitionIndex = 5491;
