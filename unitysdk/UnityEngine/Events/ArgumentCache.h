...
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4AC0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4A80)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4A60)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4AA0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENTASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1AFA4A50)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA48D0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AFA4C90)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AFA4C80)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4AD0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4A90)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4A70)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA4AB0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AFA48E0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_TIDYASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1AFA4AE0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFA4CA0)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int ArgumentCache_TypeDefinitionIndex = 5481;
