...
#define UNITYENGINE_EVENTS_UNITYACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DA8EBB0)
#define UNITYENGINE_EVENTS_UNITYACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DA8EBE0)
#define UNITYENGINE_EVENTS_UNITYACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DA8E910)
#define UNITYENGINE_EVENTS_UNITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8E8F0)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int UnityAction_TypeDefinitionIndex = 5495;
