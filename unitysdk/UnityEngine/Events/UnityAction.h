...
#define UNITYENGINE_EVENTS_UNITYACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B73ADB0)
#define UNITYENGINE_EVENTS_UNITYACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B73ADE0)
#define UNITYENGINE_EVENTS_UNITYACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B73AB10)
#define UNITYENGINE_EVENTS_UNITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73AB00)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int UnityAction_TypeDefinitionIndex = 5494;
