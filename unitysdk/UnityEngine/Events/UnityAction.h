...
#define UNITYENGINE_EVENTS_UNITYACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A08BA0)
#define UNITYENGINE_EVENTS_UNITYACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A08BD0)
#define UNITYENGINE_EVENTS_UNITYACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A07400)
#define UNITYENGINE_EVENTS_UNITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A08B80)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int UnityAction_TypeDefinitionIndex = 4296;
