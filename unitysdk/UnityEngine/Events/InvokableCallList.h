...
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1DA20A60)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_ADDPERSISTENTINVOKABLECALL_OFFSET UNITYSDK_OFFSET(0x1DA209C0)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_CLEARPERSISTENT_OFFSET UNITYSDK_OFFSET(0x1DA20D60)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DA20D10)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DA20990)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_PREPAREINVOKE_OFFSET UNITYSDK_OFFSET(0x1DA20DB0)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1DA20B00)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DA20FE0)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA20FD0)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int InvokableCallList_TypeDefinitionIndex = 5493;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>**)Il2CppClass::FromTypeDefinitionIndex(InvokableCallList_TypeDefinitionIndex)->GetStaticField(0x56A0);
		}
