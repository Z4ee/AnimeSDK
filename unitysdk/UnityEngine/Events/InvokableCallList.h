...
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1B6543C0)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_ADDPERSISTENTINVOKABLECALL_OFFSET UNITYSDK_OFFSET(0x1B654320)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_CLEARPERSISTENT_OFFSET UNITYSDK_OFFSET(0x1B6546C0)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B654670)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B6542F0)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_PREPAREINVOKE_OFFSET UNITYSDK_OFFSET(0x1B654710)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1B654460)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B654950)
#define UNITYENGINE_EVENTS_INVOKABLECALLLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B654940)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int InvokableCallList_TypeDefinitionIndex = 5492;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>**)Il2CppClass::FromTypeDefinitionIndex(InvokableCallList_TypeDefinitionIndex)->GetStaticField(0x5670);
		}
