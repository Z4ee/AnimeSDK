...
#define UNITYENGINE_WAITUNTIL_GET_KEEPWAITING_OFFSET UNITYSDK_OFFSET(0x18A61680)
#define UNITYENGINE_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18A616B0)

namespace UnityEngine
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 4176;
