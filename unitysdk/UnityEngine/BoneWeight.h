...
#define UNITYENGINE_BONEWEIGHT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9F4510)
#define UNITYENGINE_BONEWEIGHT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9F4460)
#define UNITYENGINE_BONEWEIGHT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9F43C0)
#define UNITYENGINE_BONEWEIGHT_GET_BONEINDEX0_OFFSET UNITYSDK_OFFSET(0x2B7CC0)
#define UNITYENGINE_BONEWEIGHT_GET_BONEINDEX1_OFFSET UNITYSDK_OFFSET(0x32EC50)
#define UNITYENGINE_BONEWEIGHT_GET_BONEINDEX2_OFFSET UNITYSDK_OFFSET(0x2C1260)
#define UNITYENGINE_BONEWEIGHT_GET_BONEINDEX3_OFFSET UNITYSDK_OFFSET(0x361CB0)
#define UNITYENGINE_BONEWEIGHT_GET_WEIGHT0_OFFSET UNITYSDK_OFFSET(0x45B300)
#define UNITYENGINE_BONEWEIGHT_GET_WEIGHT1_OFFSET UNITYSDK_OFFSET(0x40C5C0)
#define UNITYENGINE_BONEWEIGHT_GET_WEIGHT2_OFFSET UNITYSDK_OFFSET(0x416EC0)
#define UNITYENGINE_BONEWEIGHT_GET_WEIGHT3_OFFSET UNITYSDK_OFFSET(0x460BA0)
#define UNITYENGINE_BONEWEIGHT_SET_BONEINDEX0_OFFSET UNITYSDK_OFFSET(0x48E3B0)
#define UNITYENGINE_BONEWEIGHT_SET_BONEINDEX1_OFFSET UNITYSDK_OFFSET(0x32EC60)
#define UNITYENGINE_BONEWEIGHT_SET_BONEINDEX2_OFFSET UNITYSDK_OFFSET(0x2C1270)
#define UNITYENGINE_BONEWEIGHT_SET_BONEINDEX3_OFFSET UNITYSDK_OFFSET(0x361CC0)
#define UNITYENGINE_BONEWEIGHT_SET_WEIGHT0_OFFSET UNITYSDK_OFFSET(0x55FE60)
#define UNITYENGINE_BONEWEIGHT_SET_WEIGHT1_OFFSET UNITYSDK_OFFSET(0x55FE70)
#define UNITYENGINE_BONEWEIGHT_SET_WEIGHT2_OFFSET UNITYSDK_OFFSET(0x5CC490)
#define UNITYENGINE_BONEWEIGHT_SET_WEIGHT3_OFFSET UNITYSDK_OFFSET(0x55F270)
