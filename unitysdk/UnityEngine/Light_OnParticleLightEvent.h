...
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A44CEF0)
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A44CF70)
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A44C960)
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A44CED0)

namespace UnityEngine
{
	inline static constexpr unsigned int Light_OnParticleLightEvent_TypeDefinitionIndex = 3957;
