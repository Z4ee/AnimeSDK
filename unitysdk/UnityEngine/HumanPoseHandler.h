...
#define UNITYENGINE_HUMANPOSEHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FA38850)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_1_OFFSET UNITYSDK_OFFSET(0x1FA38C00)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1FA38840)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1FA38820)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1FA38830)
#define UNITYENGINE_HUMANPOSEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA38900)

namespace UnityEngine
{
	inline static constexpr unsigned int HumanPoseHandler_TypeDefinitionIndex = 6649;
