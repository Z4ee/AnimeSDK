...
#define UNITYENGINE_HUMANPOSEHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C3379E0)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C337D90)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1C3379D0)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1C3379B0)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C3379C0)
#define UNITYENGINE_HUMANPOSEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C337A90)

namespace UnityEngine
{
	inline static constexpr unsigned int HumanPoseHandler_TypeDefinitionIndex = 6561;
