...
#define UNITYENGINE_REMOTECONFIGSETTINGS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1FC43670)
#define UNITYENGINE_REMOTECONFIGSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FC436B0)
#define UNITYENGINE_REMOTECONFIGSETTINGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1FC435F0)
#define UNITYENGINE_REMOTECONFIGSETTINGS_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1FC436A0)
#define UNITYENGINE_REMOTECONFIGSETTINGS_REMOTECONFIGSETTINGSUPDATED_OFFSET UNITYSDK_OFFSET(0x1FC43760)
#define UNITYENGINE_REMOTECONFIGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC435E0)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteConfigSettings_TypeDefinitionIndex = 93731;
