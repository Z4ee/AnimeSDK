...
#define UNITYENGINE_REMOTECONFIGSETTINGS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E8681D0)
#define UNITYENGINE_REMOTECONFIGSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E868210)
#define UNITYENGINE_REMOTECONFIGSETTINGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E868150)
#define UNITYENGINE_REMOTECONFIGSETTINGS_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E868200)
#define UNITYENGINE_REMOTECONFIGSETTINGS_REMOTECONFIGSETTINGSUPDATED_OFFSET UNITYSDK_OFFSET(0x1E8682C0)
#define UNITYENGINE_REMOTECONFIGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E868140)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteConfigSettings_TypeDefinitionIndex = 89800;
