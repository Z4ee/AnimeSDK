...
#define UNITYENGINE_CANVASEXTENSIONS_SAFESETWORLDCAMERA_OFFSET UNITYSDK_OFFSET(0x18C5EBD0)

namespace UnityEngine
{
	inline static constexpr unsigned int CanvasExtensions_TypeDefinitionIndex = 68712;
