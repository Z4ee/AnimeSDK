...
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x1C448780)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1C448790)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_ONDELETECLIP_OFFSET UNITYSDK_OFFSET(0x1C4487E0)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4487F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitTrack_TypeDefinitionIndex = 30790;
