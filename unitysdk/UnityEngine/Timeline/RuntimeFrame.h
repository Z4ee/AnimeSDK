...
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_EVALUATEAT_OFFSET UNITYSDK_OFFSET(0x1FC17D40)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALEND_OFFSET UNITYSDK_OFFSET(0x1FC17D20)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALSTART_OFFSET UNITYSDK_OFFSET(0x1FC17D10)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1FC17D30)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC17D50)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int RuntimeFrame_TypeDefinitionIndex = 32999;
