...
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_EVALUATEAT_OFFSET UNITYSDK_OFFSET(0x1E8671D0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALEND_OFFSET UNITYSDK_OFFSET(0x1E8671B0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALSTART_OFFSET UNITYSDK_OFFSET(0x1E8671A0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1E8671C0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8671E0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int RuntimeFrame_TypeDefinitionIndex = 32368;
