...
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1E2DFE10)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1E2DFE00)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1E2DFDC0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_HASMARKERINFO_OFFSET UNITYSDK_OFFSET(0x1E2DF8E0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_ISEDIT_OFFSET UNITYSDK_OFFSET(0x1E2DF8D0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1E2DF9F0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_ONISEDITCHANGE_OFFSET UNITYSDK_OFFSET(0x1E2DF8C0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_ONTAGDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1E2DFA40)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1E2DFA30)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_TAGSSHOWIF_OFFSET UNITYSDK_OFFSET(0x1E2DFDB0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2DFE20)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicEventBase_TypeDefinitionIndex = 32323;
