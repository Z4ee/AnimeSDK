...
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A3AF5A0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A3AF4B0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1A3AF4F0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1A3AF570)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1A3AF560)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1A3AF520)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1A3AF530)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1A3AF540)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3AF550)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1A3AF580)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A3AF590)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AF4A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BasicPlayableBehaviour_TypeDefinitionIndex = 36688;
