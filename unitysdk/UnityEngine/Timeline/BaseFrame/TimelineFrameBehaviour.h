...
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_CHECKISRECORDER_OFFSET UNITYSDK_OFFSET(0x1E564E00)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1E563FE0)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1E5644D0)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1E564FC0)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x1E563E70)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1E564640)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E565270)

namespace UnityEngine::Timeline::BaseFrame
{
	inline static constexpr unsigned int TimelineFrameBehaviour_TypeDefinitionIndex = 32473;

	class TimelineFrameBehaviour : public ::UnityEngine::Playables::PlayableBehaviour
	{
	public:
		::UnityEngine::Timeline::TimelineFrame* frameTrack; // 0x10
		...
		::System::Collections::Generic::List_1<::MoleMole::Timeline::TimeLinePlayableBehaviour*>* RealPlayableBehaviours; // 0x28
