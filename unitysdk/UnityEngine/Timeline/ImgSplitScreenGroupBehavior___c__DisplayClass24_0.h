...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1F996000)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__HANDLESPLITANIM_B__0_OFFSET UNITYSDK_OFFSET(0x1F996010)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__HANDLESPLITANIM_B__1_OFFSET UNITYSDK_OFFSET(0x1F9960B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior___c__DisplayClass24_0_TypeDefinitionIndex = 32978;
