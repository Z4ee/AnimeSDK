...
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1E74BD00)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0x1E74B370)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_ISNULLTYPE_OFFSET UNITYSDK_OFFSET(0x1E74BEE0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_HASRELATIVECOMP_OFFSET UNITYSDK_OFFSET(0x1E74B9D0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1E74B6D0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E74B850)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x1E74B5C0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISINSTANCEOFTYPE_OFFSET UNITYSDK_OFFSET(0x1E74BBC0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E74B480)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E74B520)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E74B3E0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackBindingTypeAttribute_TypeDefinitionIndex = 32410;
