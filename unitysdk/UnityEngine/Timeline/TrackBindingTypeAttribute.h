...
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C407F10)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0x1C407560)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_ISNULLTYPE_OFFSET UNITYSDK_OFFSET(0x1C408100)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_HASRELATIVECOMP_OFFSET UNITYSDK_OFFSET(0x1C407BE0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1C4078C0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1C407A50)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x1C4077B0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISINSTANCEOFTYPE_OFFSET UNITYSDK_OFFSET(0x1C407DD0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C407670)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C407710)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4075D0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackBindingTypeAttribute_TypeDefinitionIndex = 30859;
