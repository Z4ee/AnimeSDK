...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x189B9350)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x189B99D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189B9930)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x189B9A30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189B99A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x189B9950)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189B9030)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x189B5680)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x189B92A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x189B91F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset__get_outputs_d__28_TypeDefinitionIndex = 29837;
