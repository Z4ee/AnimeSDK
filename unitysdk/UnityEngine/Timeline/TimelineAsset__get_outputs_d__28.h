...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A3C5430)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3C5CB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3C5C10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3C5D10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3C5C80)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3C5C30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3C5180)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C0ED0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A3C5330)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A3C5230)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset__get_outputs_d__28_TypeDefinitionIndex = 36639;

	class TimelineAsset__get_outputs_d__28 : public ::System::Object
	{
	public:
		::UnityEngine::Playables::PlayableBinding __2__current; // 0x10
		::UnityEngine::Timeline::TimelineAsset* __4__this; // 0x30
		::System::Collections::Generic::IEnumerator_1<::UnityEngine::Playables::PlayableBinding>* __7__wrap2; // 0x38
