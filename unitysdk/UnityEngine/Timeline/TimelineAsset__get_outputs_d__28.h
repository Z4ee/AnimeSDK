...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ECD2070)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ECD2900)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ECD2860)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ECD2960)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ECD28D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ECD2880)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ECD1DB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECCDB00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1ECD1F70)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1ECD1E70)
...
namespace UnityEngine::Timeline
{
	...
	public:
		...
		::UnityEngine::Timeline::TimelineAsset* __4__this; // 0x18
