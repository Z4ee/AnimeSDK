...
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1B7AD860)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1B7AD740)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1B7AD6F0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B7AD7A0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1B7AD820)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B7AD7E0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B7AD630)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1B7AD650)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETSHOWARROW_OFFSET UNITYSDK_OFFSET(0x1B7AD6B0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1B7AD710)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1B7AD6D0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B7AD770)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1B7AD680)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AD870)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleEvent_TypeDefinitionIndex = 30779;
