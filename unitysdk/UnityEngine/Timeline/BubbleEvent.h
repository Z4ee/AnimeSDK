...
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1DB8FC40)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1DB8FB20)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1DB8FAD0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1DB8FB80)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1DB8FC00)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1DB8FBC0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1DB8FA10)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1DB8FA30)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETSHOWARROW_OFFSET UNITYSDK_OFFSET(0x1DB8FA90)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1DB8FAF0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1DB8FAB0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1DB8FB50)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1DB8FA60)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8FC50)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleEvent_TypeDefinitionIndex = 32330;
