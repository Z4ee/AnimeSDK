...
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E2E0CB0)
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E2E0D80)
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2E0D90)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImagePlayableAsset_TypeDefinitionIndex = 32386;
