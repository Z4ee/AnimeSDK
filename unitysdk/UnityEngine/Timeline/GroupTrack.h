...
#define UNITYENGINE_TIMELINE_GROUPTRACK_CANCOMPILECLIPS_OFFSET UNITYSDK_OFFSET(0x1A3E60F0)
#define UNITYENGINE_TIMELINE_GROUPTRACK_CHECKGROUP_OFFSET UNITYSDK_OFFSET(0x1A3E6130)
#define UNITYENGINE_TIMELINE_GROUPTRACK_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1A3E6100)
#define UNITYENGINE_TIMELINE_GROUPTRACK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3E6140)
#define UNITYENGINE_TIMELINE_GROUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E6150)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int GroupTrack_TypeDefinitionIndex = 35600;
