...
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GETTRACKDEFAULTNAME_OFFSET UNITYSDK_OFFSET(0x1E748CF0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_AUTOPLAYCONTROLTRACK_OFFSET UNITYSDK_OFFSET(0x1E7493B0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_MAININFO_OFFSET UNITYSDK_OFFSET(0x1E7492A0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_MAINTRACK_OFFSET UNITYSDK_OFFSET(0x1E7491E0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_REALEND_OFFSET UNITYSDK_OFFSET(0x1E749190)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_REALSTART_OFFSET UNITYSDK_OFFSET(0x1E7490B0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_SPLITSCREENCLIPS_OFFSET UNITYSDK_OFFSET(0x1E7493F0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_TRIGGERTRACK_OFFSET UNITYSDK_OFFSET(0x1E749360)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E749620)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E749540)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicGroupTrack_TypeDefinitionIndex = 32309;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ComicGroupTrack_TypeDefinitionIndex)->GetStaticField(0x26C80);
		}
		static ::System::Int32* StaticGet_s_ComicTrackDefaultCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ComicGroupTrack_TypeDefinitionIndex)->GetStaticField(0x7FF0);
		}
