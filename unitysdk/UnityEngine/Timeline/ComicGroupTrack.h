...
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GETTRACKDEFAULTNAME_OFFSET UNITYSDK_OFFSET(0x1C404EF0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_AUTOPLAYCONTROLTRACK_OFFSET UNITYSDK_OFFSET(0x1C4055B0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_MAININFO_OFFSET UNITYSDK_OFFSET(0x1C4054A0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_MAINTRACK_OFFSET UNITYSDK_OFFSET(0x1C4053E0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_REALEND_OFFSET UNITYSDK_OFFSET(0x1C405390)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_REALSTART_OFFSET UNITYSDK_OFFSET(0x1C4052B0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_SPLITSCREENCLIPS_OFFSET UNITYSDK_OFFSET(0x1C4055F0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_TRIGGERTRACK_OFFSET UNITYSDK_OFFSET(0x1C405560)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C405820)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C405740)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicGroupTrack_TypeDefinitionIndex = 30758;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ComicGroupTrack_TypeDefinitionIndex)->GetStaticField(0x25210);
		}
		static ::System::Int32* StaticGet_s_ComicTrackDefaultCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ComicGroupTrack_TypeDefinitionIndex)->GetStaticField(0x7B40);
		}
