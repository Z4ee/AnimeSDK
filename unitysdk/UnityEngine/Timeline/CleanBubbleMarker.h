...
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1BB0B280)
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1BB0B290)
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1BB0B270)
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0B2A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int CleanBubbleMarker_TypeDefinitionIndex = 30755;
