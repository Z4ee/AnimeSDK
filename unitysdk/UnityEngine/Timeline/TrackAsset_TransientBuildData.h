...
#define UNITYENGINE_TIMELINE_TRACKASSET_TRANSIENTBUILDDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x3B900A0)
#define UNITYENGINE_TIMELINE_TRACKASSET_TRANSIENTBUILDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1BF821D0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackAsset_TransientBuildData_TypeDefinitionIndex = 37502;
