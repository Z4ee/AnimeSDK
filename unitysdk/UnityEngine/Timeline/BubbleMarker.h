...
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1C225810)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C225830)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1C225820)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C225840)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleMarker_TypeDefinitionIndex = 30751;
