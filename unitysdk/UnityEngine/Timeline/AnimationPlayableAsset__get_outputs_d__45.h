...
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BF56A40)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BF56BE0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF56B40)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BF56C60)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF56BB0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BF56B60)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BF56A30)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF55E10)
