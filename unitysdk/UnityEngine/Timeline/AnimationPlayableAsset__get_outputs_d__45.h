...
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B22C480)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B22C620)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B22C580)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B22C6A0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B22C5F0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B22C5A0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B22C470)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__GET_OUTPUTS_D__45__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22B8A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationPlayableAsset__get_outputs_d__45_TypeDefinitionIndex = 35836;
