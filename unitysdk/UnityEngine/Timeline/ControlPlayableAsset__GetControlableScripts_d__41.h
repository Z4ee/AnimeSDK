...
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x189AA2C0)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_MONOBEHAVIOUR__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x189AA440)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_MONOBEHAVIOUR__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189AA3D0)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x189AA4C0)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189AA430)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x189AA3E0)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189AA2B0)
#define UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x189A8A30)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ControlPlayableAsset__GetControlableScripts_d__41_TypeDefinitionIndex = 29856;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + UNITYENGINE_TIMELINE_CONTROLPLAYABLEASSET__GETCONTROLABLESCRIPTS_D__41__CTOR_OFFSET))(this, __1__state);
		}
