...
#define UNITYENGINE_TIMELINE_UNACTIVATIONPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BA18A50)
#define UNITYENGINE_TIMELINE_UNACTIVATIONPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BA18A40)
#define UNITYENGINE_TIMELINE_UNACTIVATIONPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA18B40)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int UnActivationPlayableAsset_TypeDefinitionIndex = 30807;
