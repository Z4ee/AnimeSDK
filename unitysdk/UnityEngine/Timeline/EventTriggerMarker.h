...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_DRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1EF76310)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1EF763C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1EF763E0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__FRAME_OFFSET UNITYSDK_OFFSET(0x1EF76370)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1EF762F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__TIME_OFFSET UNITYSDK_OFFSET(0x1EF76320)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1EF763D0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EF763F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__FRAME_OFFSET UNITYSDK_OFFSET(0x1EF76380)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1EF76300)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__TIME_OFFSET UNITYSDK_OFFSET(0x1EF76330)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF76410)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarker_TypeDefinitionIndex = 32944;
