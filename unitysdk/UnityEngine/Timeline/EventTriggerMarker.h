...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_DRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1DB90150)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1DB90220)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1DB90240)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__FRAME_OFFSET UNITYSDK_OFFSET(0x1DB901C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1DB90130)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__TIME_OFFSET UNITYSDK_OFFSET(0x1DB90160)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1DB90230)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1DB90250)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__FRAME_OFFSET UNITYSDK_OFFSET(0x1DB901D0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1DB90140)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__TIME_OFFSET UNITYSDK_OFFSET(0x1DB90170)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB90270)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarker_TypeDefinitionIndex = 32313;
