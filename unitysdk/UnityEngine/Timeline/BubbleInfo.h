...
#define UNITYENGINE_TIMELINE_BUBBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F990250)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleInfo_TypeDefinitionIndex = 32934;
