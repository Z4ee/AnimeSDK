...
#define UNITYENGINE_TIMELINE_IMAGEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C289330)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImageBehaviour_TypeDefinitionIndex = 30833;
