...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E2E1210)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E2E1950)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E2E1890)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E2E19D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E2E1900)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E2E18B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E2E0E40)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2E0E20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1E2E1130)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1E2E1050)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset__get_outputs_d__31_TypeDefinitionIndex = 32273;
