...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BFAD510)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BFADC50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BFADB90)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BFADCD0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BFADC00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BFADBB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BFAD140)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFAD120)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1BFAD430)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1BFAD350)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset__get_outputs_d__31_TypeDefinitionIndex = 30722;

	class TimelineAsset__get_outputs_d__31 : public ::System::Object
	{
	public:
		::UnityEngine::Timeline::TimelineAsset* __4__this; // 0x10
		::System::Collections::Generic::IEnumerator_1<::UnityEngine::Playables::PlayableBinding>* __7__wrap2; // 0x18
		::System::Collections::Generic::IEnumerator_1<::UnityEngine::Timeline::TrackAsset*>* __7__wrap1; // 0x20
		::UnityEngine::Playables::PlayableBinding __2__current; // 0x28
