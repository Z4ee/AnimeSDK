...
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1B23F810)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_EMITONCE_OFFSET UNITYSDK_OFFSET(0x1B23F7F0)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_RETROACTIVE_OFFSET UNITYSDK_OFFSET(0x1B23F7D0)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_ASSET_OFFSET UNITYSDK_OFFSET(0x1B23F820)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_EMITONCE_OFFSET UNITYSDK_OFFSET(0x1B23F800)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_RETROACTIVE_OFFSET UNITYSDK_OFFSET(0x1B23F7E0)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_UNITYENGINE_PLAYABLES_INOTIFICATION_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B23F830)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_UNITYENGINE_TIMELINE_INOTIFICATIONOPTIONPROVIDER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B23CC40)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23F890)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SignalEmitter_TypeDefinitionIndex = 35896;
