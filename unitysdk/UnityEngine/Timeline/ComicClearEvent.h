...
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1F990360)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1F990320)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1F9902E0)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F990370)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicClearEvent_TypeDefinitionIndex = 32965;
