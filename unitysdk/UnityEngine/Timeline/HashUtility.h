...
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_1_OFFSET UNITYSDK_OFFSET(0x1E2E0870)
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_2_OFFSET UNITYSDK_OFFSET(0x1E2E08B0)
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_3_OFFSET UNITYSDK_OFFSET(0x1E2E0900)
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_4_OFFSET UNITYSDK_OFFSET(0x1E2E0960)
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_5_OFFSET UNITYSDK_OFFSET(0x1E2E09E0)
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_6_OFFSET UNITYSDK_OFFSET(0x1E2E0A70)
#define UNITYENGINE_TIMELINE_HASHUTILITY_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x1E2E0850)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int HashUtility_TypeDefinitionIndex = 32432;
