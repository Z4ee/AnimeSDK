...
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E6CC970)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E6CC960)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP_INITANIMATIONCOMP_OFFSET UNITYSDK_OFFSET(0x1E6CCA40)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CCA50)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationParamsTriggerClip_TypeDefinitionIndex = 32246;
