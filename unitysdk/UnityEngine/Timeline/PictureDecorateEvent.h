...
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1C172FE0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETANIMINFO_OFFSET UNITYSDK_OFFSET(0x1C172D90)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1C172FA0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1C172F60)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1C172AC0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETSPRITE_OFFSET UNITYSDK_OFFSET(0x1C172AA0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1C172DB0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1C172F50)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C172FF0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PictureDecorateEvent_TypeDefinitionIndex = 30777;
