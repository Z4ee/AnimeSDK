...
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1E4BB600)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETANIMINFO_OFFSET UNITYSDK_OFFSET(0x1E4BB3B0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1E4BB5C0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1E4BB580)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1E4BB0E0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETSPRITE_OFFSET UNITYSDK_OFFSET(0x1E4BB0C0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1E4BB3D0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1E4BB570)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4BB610)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PictureDecorateEvent_TypeDefinitionIndex = 32328;
