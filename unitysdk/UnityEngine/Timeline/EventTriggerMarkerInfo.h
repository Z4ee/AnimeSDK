...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_CONTAINKEY_OFFSET UNITYSDK_OFFSET(0x1E5656A0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_EXISTKEYEVENT_OFFSET UNITYSDK_OFFSET(0x1E5653F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETDECORATEEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1E5654F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETKEYEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1E5653B0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETLOGICEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1E565530)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONADDEVENTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1E5657F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONDECORATEEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1E565800)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONKEYEVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1E5657C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONLOGICEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1E565830)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONMARKEREVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1E565860)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_SETREF_OFFSET UNITYSDK_OFFSET(0x1E565890)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEEVENTS_OFFSET UNITYSDK_OFFSET(0x1E565570)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEKEYS_OFFSET UNITYSDK_OFFSET(0x1E565610)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E565920)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarkerInfo_TypeDefinitionIndex = 32314;
