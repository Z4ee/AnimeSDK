...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_CONTAINKEY_OFFSET UNITYSDK_OFFSET(0x1F963330)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_EXISTKEYEVENT_OFFSET UNITYSDK_OFFSET(0x1F963080)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETDECORATEEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1F963180)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETKEYEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1F963040)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETLOGICEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1F9631C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONADDEVENTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1F963480)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONDECORATEEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1F963490)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONKEYEVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1F963450)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONLOGICEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1F9634C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONMARKEREVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1F9634F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_SETREF_OFFSET UNITYSDK_OFFSET(0x1F963520)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEEVENTS_OFFSET UNITYSDK_OFFSET(0x1F963200)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEKEYS_OFFSET UNITYSDK_OFFSET(0x1F9632A0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9635B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarkerInfo_TypeDefinitionIndex = 32945;
