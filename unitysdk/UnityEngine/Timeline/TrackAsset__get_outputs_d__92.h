...
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EF78A90)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EF78F60)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF78EA0)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EF78FE0)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF78F10)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EF78EC0)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF78A80)
#define UNITYENGINE_TIMELINE_TRACKASSET__GET_OUTPUTS_D__92__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF78A60)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackAsset__get_outputs_d__92_TypeDefinitionIndex = 32913;
