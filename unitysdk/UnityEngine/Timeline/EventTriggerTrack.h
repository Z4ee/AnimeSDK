...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x1DE5FB30)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1DE5FB40)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONCREATEMARKER_OFFSET UNITYSDK_OFFSET(0x1DE5FB90)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONDELETECLIP_OFFSET UNITYSDK_OFFSET(0x1DE5FBA0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONDELETEMARKER_OFFSET UNITYSDK_OFFSET(0x1DE5FBB0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE5FBC0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerTrack_TypeDefinitionIndex = 32322;
