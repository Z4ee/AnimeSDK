...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO_INITTIMELINEASSETCTX_OFFSET UNITYSDK_OFFSET(0x1E757CF0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO_ONCAMERASHAKEEVENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1E757CD0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E757D00)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerZoneInfo_TypeDefinitionIndex = 32321;
