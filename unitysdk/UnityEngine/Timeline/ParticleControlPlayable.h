...
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C0C3040)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_NEWUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1C0C3310)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x1C0C32F0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_UNFIXUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1C0C3330)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C0C32B0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1C0C3D60)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1C0C3D50)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1C0C3520)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SETRANDOMSEED_OFFSET UNITYSDK_OFFSET(0x1C0C3350)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_NEWUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1C0C3320)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x1C0C3300)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_UNFIXUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1C0C3340)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1C0C3C80)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0C3D70)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ParticleControlPlayable_TypeDefinitionIndex = 30846;
	...
	public:
		...
		::System::Single m_SystemTime; // 0x1C
		::System::Single m_LastPlayableTime; // 0x20
		::System::Single m_LastParticleTime; // 0x24
