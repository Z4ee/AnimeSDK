...
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E3DE2E0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_NEWUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E3DE5B0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x1E3DE590)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_UNFIXUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E3DE5D0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E3DE550)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1E3DF090)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1E3DF080)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1E3DE7C0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SETRANDOMSEED_OFFSET UNITYSDK_OFFSET(0x1E3DE5F0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_NEWUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E3DE5C0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x1E3DE5A0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_UNFIXUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E3DE5E0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1E3DEFB0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3DF0A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ParticleControlPlayable_TypeDefinitionIndex = 32397;
	...
	public:
		...
		::System::Boolean _newUpdateMode_k__BackingField; // 0x1C
		::System::Boolean _unFixUpdateMode_k__BackingField; // 0x1D
		::System::UInt32 m_RandomSeed; // 0x20
		::System::Single m_SystemTime; // 0x24
		::System::Single m_LastParticleTime; // 0x28
