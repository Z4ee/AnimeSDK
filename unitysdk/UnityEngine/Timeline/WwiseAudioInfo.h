...
#define UNITYENGINE_TIMELINE_WWISEAUDIOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3ACDA0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseAudioInfo_TypeDefinitionIndex = 33076;
