...
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BA183D0)
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BA184B0)
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA184C0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubblePlayableAsset_TypeDefinitionIndex = 30753;
