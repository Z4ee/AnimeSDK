...
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1DD5D090)
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1DD5D160)
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5D170)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubblePlayableAsset_TypeDefinitionIndex = 32304;
