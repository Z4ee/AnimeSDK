...
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_ASSETONCOPIED_OFFSET UNITYSDK_OFFSET(0x1F98FF70)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_ASSETONCREATED_OFFSET UNITYSDK_OFFSET(0x1F98FF60)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1F98FEB0)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F98FF80)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BasePlayableAsset_TypeDefinitionIndex = 33055;
