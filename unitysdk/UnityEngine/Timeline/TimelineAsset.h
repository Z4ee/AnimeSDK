...
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADDSUBTRACKSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1DD10DF0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADDTRACKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DD112B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADJUSTCHILDTRACK_OFFSET UNITYSDK_OFFSET(0x1DD154C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADJUSTTRACK_OFFSET UNITYSDK_OFFSET(0x1DD152F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ALLOCATETRACK_OFFSET UNITYSDK_OFFSET(0x1DD14370)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CALCULATEDURATION_OFFSET UNITYSDK_OFFSET(0x1DD0E530)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CHECKCLIPISMPBSUBANICLIP_OFFSET UNITYSDK_OFFSET(0x1DD13580)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CLEARTRACKS_OFFSET UNITYSDK_OFFSET(0x1DD117B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATEMARKERTRACK_OFFSET UNITYSDK_OFFSET(0x1DD13AB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1DD12110)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATETRACK_OFFSET UNITYSDK_OFFSET(0x1DD13C90)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETECLIP_OFFSET UNITYSDK_OFFSET(0x1DD14780)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETERECORDEDANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1DD14BD0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETERECORDEDANIMATION_OFFSET UNITYSDK_OFFSET(0x1DD14F60)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETETRACK_OFFSET UNITYSDK_OFFSET(0x1DD11AE0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_FINDPARENTGROUPTRACK_OFFSET UNITYSDK_OFFSET(0x1DD15630)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIESFORMPB_OFFSET UNITYSDK_OFFSET(0x1DD12F80)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1DD12880)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_2_OFFSET UNITYSDK_OFFSET(0x1DD12C00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1DD12550)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETALLOUTPUTTRACKBYGUID_OFFSET UNITYSDK_OFFSET(0x1DD10D40)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETALLTRACKS_OFFSET UNITYSDK_OFFSET(0x1DD11AD0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1DD0FEE0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACKDIC_OFFSET UNITYSDK_OFFSET(0x1DD105F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACKS_OFFSET UNITYSDK_OFFSET(0x1DD10060)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACK_1_OFFSET UNITYSDK_OFFSET(0x1DD0FFA0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACK_OFFSET UNITYSDK_OFFSET(0x1DD0FF50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETROOTTRACKS_OFFSET UNITYSDK_OFFSET(0x1DD0F2A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETROOTTRACK_OFFSET UNITYSDK_OFFSET(0x1DD0FEF0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETVALIDFRAMERATE_OFFSET UNITYSDK_OFFSET(0x1DD0FE40)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1DD0EDE0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_DURATIONMODE_OFFSET UNITYSDK_OFFSET(0x1DD0ED60)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1DD0E510)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_EDITORSETTINGS_OFFSET UNITYSDK_OFFSET(0x1DD0E500)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_FIXEDDURATION_OFFSET UNITYSDK_OFFSET(0x1DD0EB50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_FLATTENEDTRACKS_OFFSET UNITYSDK_OFFSET(0x1DD10400)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_ISDFS_OFFSET UNITYSDK_OFFSET(0x1DD0E4E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_MARKERTRACK_OFFSET UNITYSDK_OFFSET(0x1DD11290)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1DD0ED80)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_OUTPUTTRACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1DD0F3B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_ROOTTRACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1DD0F920)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_TRACKOBJECTS_OFFSET UNITYSDK_OFFSET(0x1DD112A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_INVALIDATE_OFFSET UNITYSDK_OFFSET(0x1DD11330)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_MOVELASTTRACKBEFORE_OFFSET UNITYSDK_OFFSET(0x1DD15B30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1DD0FD00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_REMOVETRACK_OFFSET UNITYSDK_OFFSET(0x1DD115F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SAVEEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1DD0FED0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SET_DURATIONMODE_OFFSET UNITYSDK_OFFSET(0x1DD0ED70)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SET_FIXEDDURATION_OFFSET UNITYSDK_OFFSET(0x1DD0ED50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTCHILDTRACK_OFFSET UNITYSDK_OFFSET(0x1DD158A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTOUTPUTTRACKGUIDS_OFFSET UNITYSDK_OFFSET(0x1DD10080)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTSUBTRACKBYNAME_OFFSET UNITYSDK_OFFSET(0x1DD11350)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTTRACKS_OFFSET UNITYSDK_OFFSET(0x1DD114D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DD12320)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DD12310)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEOUTPUTTRACKCACHE_OFFSET UNITYSDK_OFFSET(0x1DD0F3E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEOUTPUTTRACKDICCACHE_OFFSET UNITYSDK_OFFSET(0x1DD10610)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEROOTTRACKCACHE_OFFSET UNITYSDK_OFFSET(0x1DD0F950)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPGRADETOLATESTVERSION_OFFSET UNITYSDK_OFFSET(0x1DD0E4D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD15E70)
#define UNITYENGINE_TIMELINE_TIMELINEASSET___INTERNALAWAKE_OFFSET UNITYSDK_OFFSET(0x1DD12340)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset_TypeDefinitionIndex = 32267;
