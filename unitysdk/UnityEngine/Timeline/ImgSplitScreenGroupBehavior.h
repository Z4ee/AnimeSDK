...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_COMINIT_OFFSET UNITYSDK_OFFSET(0x1BA87D00)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1BA853F0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETBELONGPOS_OFFSET UNITYSDK_OFFSET(0x1BA87B30)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETIFHIDEINSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x1BA88960)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETSELFCOMICGROUPTRACK_OFFSET UNITYSDK_OFFSET(0x1BA88B50)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_HANDLESPLITANIM_OFFSET UNITYSDK_OFFSET(0x1BA85990)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_IMAGEEXCHANGE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1BA88950)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BA85530)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_INITPARTOFFSETMAP_OFFSET UNITYSDK_OFFSET(0x1BA85550)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PICTUREDECORATIONCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1BA88B90)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PICTUREDECORATIONCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1BA88BA0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1BA88190)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1BA87F70)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_RESET_OFFSET UNITYSDK_OFFSET(0x1BA888E0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1BA87AB0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_TAGSNEEDCLEAR_OFFSET UNITYSDK_OFFSET(0x1BA87FE0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1BA88B60)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1BA88B80)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_TOFINISHSTATE_OFFSET UNITYSDK_OFFSET(0x1BA88B70)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BA88C50)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA88BB0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__INITPARTOFFSETMAP_G__RECORDMAP_16_0_OFFSET UNITYSDK_OFFSET(0x1BA871F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior_TypeDefinitionIndex = 30791;
	...
	public:
		...
		{
			return (::UnityEngine::Timeline::ComicGroupTrack**)Il2CppClass::FromTypeDefinitionIndex(ImgSplitScreenGroupBehavior_TypeDefinitionIndex)->GetStaticField(0x24DF0);
		}
		static ::System::Boolean* StaticGet_MUTE_BEHABIOUR()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ImgSplitScreenGroupBehavior_TypeDefinitionIndex)->GetStaticField(0x7A30);
		}
		...
		::System::Collections::Generic::HashSet_1<::UnityEngine::Timeline::ImgSplitScreenGroupBehavior_ClearCtx>* m_arrClearTags; // 0x28
