...
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1E2E0C10)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1E2E0BD0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1E2E0B90)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1E2E0B60)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1E2E0B80)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_SHOWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1E2E0B70)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2E0C20)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImageExchangeEventZoneVer_TypeDefinitionIndex = 32327;
