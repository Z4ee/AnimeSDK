...
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_PUSHDESTROYUNDO_OFFSET UNITYSDK_OFFSET(0x1A3E6DB0)
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_PUSHUNDO_OFFSET UNITYSDK_OFFSET(0x1A3F8870)
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_REGISTERCREATEDOBJECTUNDO_OFFSET UNITYSDK_OFFSET(0x1A3F8880)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineUndo_TypeDefinitionIndex = 35645;
