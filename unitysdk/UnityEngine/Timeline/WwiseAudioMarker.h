...
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1F1A2650)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1F1A2660)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1F1A2640)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1A2670)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseAudioMarker_TypeDefinitionIndex = 33075;
