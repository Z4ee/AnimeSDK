...
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1BA18BB0)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1BA18BC0)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1BA18BA0)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA18BD0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseAudioMarker_TypeDefinitionIndex = 30893;
