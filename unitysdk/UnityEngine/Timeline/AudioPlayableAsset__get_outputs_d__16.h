...
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B232270)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B232430)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B232390)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B2324B0)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B232400)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B2323B0)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B232260)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x1B232050)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AudioPlayableAsset__get_outputs_d__16_TypeDefinitionIndex = 35870;
