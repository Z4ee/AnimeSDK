...
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_CLEARSUBTRACKS_OFFSET UNITYSDK_OFFSET(0x1F81E540)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_COLLECTLIGHT_OFFSET UNITYSDK_OFFSET(0x1F81E3E0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_GET_BASELIGHT_OFFSET UNITYSDK_OFFSET(0x1F81E0F0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1F81E290)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1F81E130)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1F81E280)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_SETINFINITECLIP_OFFSET UNITYSDK_OFFSET(0x1F81E550)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F81E570)

namespace UnityEngine::Timeline::CutScene::ArrayLightSystem
{
	inline static constexpr unsigned int ArrayLightSystemBehavior_TypeDefinitionIndex = 33084;
