...
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_CLEARSUBTRACKS_OFFSET UNITYSDK_OFFSET(0x1C0C1B00)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_COLLECTLIGHT_OFFSET UNITYSDK_OFFSET(0x1C0C19A0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_GET_BASELIGHT_OFFSET UNITYSDK_OFFSET(0x1C0C16B0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1C0C1850)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1C0C16F0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C0C1840)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_SETINFINITECLIP_OFFSET UNITYSDK_OFFSET(0x1C0C1B10)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0C1B30)

namespace UnityEngine::Timeline::CutScene::ArrayLightSystem
{
	inline static constexpr unsigned int ArrayLightSystemBehavior_TypeDefinitionIndex = 30902;
