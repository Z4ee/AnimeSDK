...
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1F0E1310)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1F0E14C0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0E1590)

namespace UnityEngine::Timeline::CutScene::ArrayLightSystem
{
	inline static constexpr unsigned int ArrayLightSystemTrack_TypeDefinitionIndex = 33088;
