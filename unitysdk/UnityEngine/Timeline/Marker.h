...
#define UNITYENGINE_TIMELINE_MARKER_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1BF66D60)
#define UNITYENGINE_TIMELINE_MARKER_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1BF66D80)
#define UNITYENGINE_TIMELINE_MARKER_ONDRAGGING_OFFSET UNITYSDK_OFFSET(0x1BF66F20)
#define UNITYENGINE_TIMELINE_MARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BF66F00)
#define UNITYENGINE_TIMELINE_MARKER_ONSTOPDRAG_OFFSET UNITYSDK_OFFSET(0x1BF66F10)
#define UNITYENGINE_TIMELINE_MARKER_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1BF66D70)
#define UNITYENGINE_TIMELINE_MARKER_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1BF66D90)
#define UNITYENGINE_TIMELINE_MARKER_UNITYENGINE_TIMELINE_IMARKER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BF66DE0)
#define UNITYENGINE_TIMELINE_MARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF66F30)
