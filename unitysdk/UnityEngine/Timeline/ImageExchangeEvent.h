...
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1C532990)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1C532950)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1C532910)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1C5328E0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1C532900)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_SHOWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1C5328F0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5329A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImageExchangeEvent_TypeDefinitionIndex = 30775;
