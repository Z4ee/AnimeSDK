...
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BC68B60)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BC68D80)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BC68CC0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BC68E00)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BC68D30)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BC68CE0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BC68B50)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC640F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationTrack__get_outputs_d__58_TypeDefinitionIndex = 30709;
