...
#define UNITYENGINE_TIMELINE_TRACKMEDIATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B0AA0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackMediaType_TypeDefinitionIndex = 30854;
