...
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1FC17D70)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1FC17DB0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_LOADSCENE_OFFSET UNITYSDK_OFFSET(0x1FC17DD0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1FC17DA0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1FC17DC0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1FC17D80)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SETSCENEACTIVE_OFFSET UNITYSDK_OFFSET(0x1FC17DF0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x1FC17D90)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHSCENE_OFFSET UNITYSDK_OFFSET(0x1FC17DE0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC18020)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SceneSwitchMarker_TypeDefinitionIndex = 32968;
