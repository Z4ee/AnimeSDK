...
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1E867200)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1E867240)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_LOADSCENE_OFFSET UNITYSDK_OFFSET(0x1E867260)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1E867230)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E867250)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E867210)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SETSCENEACTIVE_OFFSET UNITYSDK_OFFSET(0x1E867280)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x1E867220)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHSCENE_OFFSET UNITYSDK_OFFSET(0x1E867270)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8674B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SceneSwitchMarker_TypeDefinitionIndex = 32337;
