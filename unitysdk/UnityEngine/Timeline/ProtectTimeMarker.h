...
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1BA18760)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1BA18770)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1BA18750)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA18780)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ProtectTimeMarker_TypeDefinitionIndex = 30876;
