...
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1DD5D400)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1DD5D410)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1DD5D3F0)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5D420)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ProtectTimeMarker_TypeDefinitionIndex = 32427;
