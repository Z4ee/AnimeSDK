...
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_AFTERCREATEPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1BB0D920)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BB0CC90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BB0F180)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1BB0CD80)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAME_OFFSET UNITYSDK_OFFSET(0x1BB0DBD0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_1_OFFSET UNITYSDK_OFFSET(0x1BB0E490)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1BB0DD90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_1_OFFSET UNITYSDK_OFFSET(0x1BB111F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1BB10CB0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETREALPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1BB0F620)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_EDITORFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1BB0C960)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x1BB0BEA0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1BB0BE80)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_ISFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1BB0BE90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_TRACKNAME_OFFSET UNITYSDK_OFFSET(0x1BB0C760)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_HASH_OFFSET UNITYSDK_OFFSET(0x1BB0C6F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITFRAMEINFOS_OFFSET UNITYSDK_OFFSET(0x1BB0D910)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1BB0F610)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BB11280)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERALTERPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1BB0FB20)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERUNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1BB106A0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHFRAMESANDPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1BB0BF00)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1BB0D1A0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1BB10FE0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x1BB106B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETFRAMEINFOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1BB0F740)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETINITVALUE_OFFSET UNITYSDK_OFFSET(0x1BB10DC0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETPROPERTYSHOWTIME_OFFSET UNITYSDK_OFFSET(0x1BB0DC90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETVOLUMETYPE_OFFSET UNITYSDK_OFFSET(0x1BB0DAE0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_UNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1BB10690)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB11650)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB11370)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__RECORDERALTERPROPERTYINFOS_G__RECORDERINFOS_43_0_OFFSET UNITYSDK_OFFSET(0x1BB0FCA0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineFrame_TypeDefinitionIndex = 30744;
	...
	public:
		...
		{
			return (::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x24D70);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::Il2CppArray<::System::Reflection::FieldInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x24D78);
		}
