...
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_AFTERCREATEPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1F245E60)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x1F2450C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1F247680)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1F2451B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAME_OFFSET UNITYSDK_OFFSET(0x1F246110)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_1_OFFSET UNITYSDK_OFFSET(0x1F2469B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1F2462C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_1_OFFSET UNITYSDK_OFFSET(0x1F2496C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F249190)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETREALPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F247B20)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_EDITORFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1F244D90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x1F2442E0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1F2442C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_ISFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1F2442D0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_TRACKNAME_OFFSET UNITYSDK_OFFSET(0x1F244B90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_HASH_OFFSET UNITYSDK_OFFSET(0x1F244B20)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITFRAMEINFOS_OFFSET UNITYSDK_OFFSET(0x1F245E50)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1F247B10)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F249750)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERALTERPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1F247FF0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERUNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1F248B80)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHFRAMESANDPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1F244340)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1F2455D0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1F2494B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x1F248B90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETFRAMEINFOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1F247C30)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETINITVALUE_OFFSET UNITYSDK_OFFSET(0x1F2492A0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETPROPERTYSHOWTIME_OFFSET UNITYSDK_OFFSET(0x1F2461D0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETVOLUMETYPE_OFFSET UNITYSDK_OFFSET(0x1F246020)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_UNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1F248B70)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F249B20)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F249840)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__RECORDERALTERPROPERTYINFOS_G__RECORDERINFOS_43_0_OFFSET UNITYSDK_OFFSET(0x1F248170)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineFrame_TypeDefinitionIndex = 32926;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::Il2CppArray<::System::Reflection::FieldInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x27F60);
		}
		static ::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>** StaticGet_RecordKFrame()
		{
			return (::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x27F68);
		}
