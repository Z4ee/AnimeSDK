...
#define UNITYENGINE_TIMELINE_FRAME_ADDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C5327A0)
#define UNITYENGINE_TIMELINE_FRAME_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1C532760)
#define UNITYENGINE_TIMELINE_FRAME_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1C532740)
#define UNITYENGINE_TIMELINE_FRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C532790)
#define UNITYENGINE_TIMELINE_FRAME_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1C532770)
#define UNITYENGINE_TIMELINE_FRAME_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1C532750)
#define UNITYENGINE_TIMELINE_FRAME_UNITYENGINE_TIMELINE_IFRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C532780)
#define UNITYENGINE_TIMELINE_FRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C532820)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int Frame_TypeDefinitionIndex = 30739;
