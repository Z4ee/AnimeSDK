...
#define UNITYENGINE_TIMELINE_FRAME_ADDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E866F10)
#define UNITYENGINE_TIMELINE_FRAME_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E866ED0)
#define UNITYENGINE_TIMELINE_FRAME_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1E866EB0)
#define UNITYENGINE_TIMELINE_FRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E866F00)
#define UNITYENGINE_TIMELINE_FRAME_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E866EE0)
#define UNITYENGINE_TIMELINE_FRAME_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1E866EC0)
#define UNITYENGINE_TIMELINE_FRAME_UNITYENGINE_TIMELINE_IFRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E866EF0)
#define UNITYENGINE_TIMELINE_FRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E866F90)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int Frame_TypeDefinitionIndex = 32290;
