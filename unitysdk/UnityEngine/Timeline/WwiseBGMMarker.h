...
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1FC18170)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1FC18180)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1FC18160)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC18190)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseBGMMarker_TypeDefinitionIndex = 33078;
