...
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1C532E90)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C532EA0)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1C532E80)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C532EB0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseBGMMarker_TypeDefinitionIndex = 30896;
