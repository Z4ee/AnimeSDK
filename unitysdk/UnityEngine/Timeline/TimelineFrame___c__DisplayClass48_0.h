...
#define UNITYENGINE_TIMELINE_TIMELINEFRAME___C__DISPLAYCLASS48_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1A22B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME___C__DISPLAYCLASS48_0__SETCURVEVALUE_B__0_OFFSET UNITYSDK_OFFSET(0x1F1A22C0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineFrame___c__DisplayClass48_0_TypeDefinitionIndex = 32929;
