...
#define UNITYENGINE_TIMELINE_WWISEBGMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9BA460)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseBGMInfo_TypeDefinitionIndex = 33079;
