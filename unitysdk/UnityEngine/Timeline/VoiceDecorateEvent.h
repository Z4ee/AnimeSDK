...
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1E5A9FC0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1E5A9F80)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1E5A9F40)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1E5A9D90)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSTARTPOSCHANGE_OFFSET UNITYSDK_OFFSET(0x1E5A9D80)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1E5A9F30)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A9FD0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int VoiceDecorateEvent_TypeDefinitionIndex = 32329;
