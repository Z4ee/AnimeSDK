...
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1C28A0E0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1C28A0A0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1C28A060)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1C289EB0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSTARTPOSCHANGE_OFFSET UNITYSDK_OFFSET(0x1C289EA0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1C28A050)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C28A0F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int VoiceDecorateEvent_TypeDefinitionIndex = 30778;
