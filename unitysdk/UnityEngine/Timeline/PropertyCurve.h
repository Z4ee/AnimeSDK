...
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ADDKEY_OFFSET UNITYSDK_OFFSET(0x1BA451E0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_DELETEKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1BA44D60)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYTIMES_OFFSET UNITYSDK_OFFSET(0x1BA45230)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1BA44BB0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETLASTKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1BA44C50)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_HASKEYATTIME_OFFSET UNITYSDK_OFFSET(0x1BA44EC0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ISFIRSTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1BA44D10)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_REMOVEKEY_OFFSET UNITYSDK_OFFSET(0x1BA45000)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BA44A70)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA44A10)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PropertyCurve_TypeDefinitionIndex = 30743;
