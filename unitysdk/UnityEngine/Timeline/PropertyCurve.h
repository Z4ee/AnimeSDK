...
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ADDKEY_OFFSET UNITYSDK_OFFSET(0x1DD97A40)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_DELETEKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1DD975C0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYTIMES_OFFSET UNITYSDK_OFFSET(0x1DD97A90)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1DD97410)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETLASTKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1DD974B0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_HASKEYATTIME_OFFSET UNITYSDK_OFFSET(0x1DD97720)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ISFIRSTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1DD97570)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_REMOVEKEY_OFFSET UNITYSDK_OFFSET(0x1DD97860)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD972D0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD97270)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PropertyCurve_TypeDefinitionIndex = 32294;
