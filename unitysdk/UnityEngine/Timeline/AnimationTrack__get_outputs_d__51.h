...
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B2318D0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B231A70)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B2319D0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B231AD0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B231A40)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B2319F0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2318C0)
#define UNITYENGINE_TIMELINE_ANIMATIONTRACK__GET_OUTPUTS_D__51__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22CE70)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationTrack__get_outputs_d__51_TypeDefinitionIndex = 35844;
