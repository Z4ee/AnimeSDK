...
#define UNITYENGINE_TIMELINE_AUDIOCLIPPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C224390)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AudioClipProperties_TypeDefinitionIndex = 30733;
