...
#define UNITYENGINE_TIMELINE_AUDIOCLIPPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x189A3A20)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AudioClipProperties_TypeDefinitionIndex = 29847;
