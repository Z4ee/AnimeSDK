...
#define UNITYENGINE_TIMELINE_AUDIOCLIPPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1F961B10)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AudioClipProperties_TypeDefinitionIndex = 32915;
