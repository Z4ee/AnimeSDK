...
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E5A9C10)
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E5A9CE0)
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A9CF0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitPlayableAsset_TypeDefinitionIndex = 32340;
