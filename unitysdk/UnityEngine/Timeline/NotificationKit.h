...
#define UNITYENGINE_TIMELINE_NOTIFICATIONKIT_NOTIFY_1_OFFSET UNITYSDK_OFFSET(0x1BA88F70)
#define UNITYENGINE_TIMELINE_NOTIFICATIONKIT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1BA88E70)
#define UNITYENGINE_TIMELINE_NOTIFICATIONKIT_REGISTERNAPNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1BA88FD0)
#define UNITYENGINE_TIMELINE_NOTIFICATIONKIT_UNREGISTERNAPNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1BA88FE0)
#define UNITYENGINE_TIMELINE_NOTIFICATIONKIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA89000)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int NotificationKit_TypeDefinitionIndex = 30884;
	...
	public:
		...
		{
			return (::System::Action_1<::UnityEngine::Timeline::INapNotifyData*>**)Il2CppClass::FromTypeDefinitionIndex(NotificationKit_TypeDefinitionIndex)->GetStaticField(0x24E20);
		}
