...
#define UNITYENGINE_TIMELINE_COMIC_MAININFOTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1F0E1110)
#define UNITYENGINE_TIMELINE_COMIC_MAININFOTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0E1160)

namespace UnityEngine::Timeline::Comic
{
	inline static constexpr unsigned int MainInfoTrack_TypeDefinitionIndex = 33091;
