...
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1C3884F0)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1C387F40)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C388270)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3885F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationParamsTriggerBehaviour_TypeDefinitionIndex = 30694;
