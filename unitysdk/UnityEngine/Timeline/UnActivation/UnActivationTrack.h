...
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CANCOMPILECLIPS_OFFSET UNITYSDK_OFFSET(0x1E2E1B00)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1E2E1B70)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1E2E1D70)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1E2E1B20)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1E2E1F50)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_SET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1E2E1B30)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_UPDATETRACKMODE_OFFSET UNITYSDK_OFFSET(0x1E2E1B50)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2E1FA0)

namespace UnityEngine::Timeline::UnActivation
{
	inline static constexpr unsigned int UnActivationTrack_TypeDefinitionIndex = 32450;
