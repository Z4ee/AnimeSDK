...
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CANCOMPILECLIPS_OFFSET UNITYSDK_OFFSET(0x1BFADE00)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BFADE70)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1BFAE070)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1BFADE20)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1BFAE250)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_SET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1BFADE30)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_UPDATETRACKMODE_OFFSET UNITYSDK_OFFSET(0x1BFADE50)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFAE2A0)

namespace UnityEngine::Timeline::UnActivation
{
	inline static constexpr unsigned int UnActivationTrack_TypeDefinitionIndex = 30899;
