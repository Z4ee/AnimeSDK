...
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_INTERNAL_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x1B4D2930)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x1B4D2940)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D29A0)

namespace UnityEngine::NAP::Rendering
{
	inline static constexpr unsigned int NAPLightingManager_TypeDefinitionIndex = 6121;
