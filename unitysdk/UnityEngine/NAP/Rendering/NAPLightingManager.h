...
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_INTERNAL_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x1EBE0380)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x1EBE0390)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBE03F0)

namespace UnityEngine::NAP::Rendering
{
	inline static constexpr unsigned int NAPLightingManager_TypeDefinitionIndex = 6134;
