...
#define UNITYENGINE_CONTACTPOINT2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0xAA1C80)
#define UNITYENGINE_CONTACTPOINT2D_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xAA1EE0)
#define UNITYENGINE_CONTACTPOINT2D_GET_NORMALIMPULSE_OFFSET UNITYSDK_OFFSET(0xA3F7B0)
#define UNITYENGINE_CONTACTPOINT2D_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define UNITYENGINE_CONTACTPOINT2D_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0xAA1D20)
#define UNITYENGINE_CONTACTPOINT2D_GET_OTHERRIGIDBODY_OFFSET UNITYSDK_OFFSET(0xAA1E50)
#define UNITYENGINE_CONTACTPOINT2D_GET_POINT_OFFSET UNITYSDK_OFFSET(0x259D70)
#define UNITYENGINE_CONTACTPOINT2D_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x3C9DA0)
#define UNITYENGINE_CONTACTPOINT2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0xAA1DC0)
#define UNITYENGINE_CONTACTPOINT2D_GET_SEPARATION_OFFSET UNITYSDK_OFFSET(0x61E820)
#define UNITYENGINE_CONTACTPOINT2D_GET_TANGENTIMPULSE_OFFSET UNITYSDK_OFFSET(0x7F6380)

namespace UnityEngine
{
	inline static constexpr unsigned int ContactPoint2D_TypeDefinitionIndex = 18790;
