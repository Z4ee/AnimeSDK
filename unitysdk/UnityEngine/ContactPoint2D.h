...
#define UNITYENGINE_CONTACTPOINT2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x9ADF50)
#define UNITYENGINE_CONTACTPOINT2D_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9AE1B0)
#define UNITYENGINE_CONTACTPOINT2D_GET_NORMALIMPULSE_OFFSET UNITYSDK_OFFSET(0x94D150)
#define UNITYENGINE_CONTACTPOINT2D_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x28B580)
#define UNITYENGINE_CONTACTPOINT2D_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x9ADFF0)
#define UNITYENGINE_CONTACTPOINT2D_GET_OTHERRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x9AE120)
#define UNITYENGINE_CONTACTPOINT2D_GET_POINT_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define UNITYENGINE_CONTACTPOINT2D_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x381840)
#define UNITYENGINE_CONTACTPOINT2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x9AE090)
#define UNITYENGINE_CONTACTPOINT2D_GET_SEPARATION_OFFSET UNITYSDK_OFFSET(0x7D0AF0)
#define UNITYENGINE_CONTACTPOINT2D_GET_TANGENTIMPULSE_OFFSET UNITYSDK_OFFSET(0x6D5120)

namespace UnityEngine
{
	inline static constexpr unsigned int ContactPoint2D_TypeDefinitionIndex = 7633;
