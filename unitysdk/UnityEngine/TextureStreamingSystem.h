...
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM_SETSCREENMAPSTPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1BC226C0)
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM_SETSCREENMAPTEXTUREPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1BC226B0)
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC226D0)
