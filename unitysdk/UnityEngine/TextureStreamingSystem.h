...
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM_SETSCREENMAPSTPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1F34BFD0)
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM_SETSCREENMAPTEXTUREPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1F34BFC0)
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F34BFE0)

namespace UnityEngine
{
	inline static constexpr unsigned int TextureStreamingSystem_TypeDefinitionIndex = 5427;
