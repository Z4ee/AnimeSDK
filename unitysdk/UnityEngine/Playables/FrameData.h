...
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0xA4D940)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVEPARENTSPEED_OFFSET UNITYSDK_OFFSET(0x79AF70)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVEPLAYSTATE_OFFSET UNITYSDK_OFFSET(0xA4D990)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVESPEED_OFFSET UNITYSDK_OFFSET(0x4900A0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EVALUATIONTYPE_OFFSET UNITYSDK_OFFSET(0xA4D950)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_FRAMEID_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x467450)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_SEEKOCCURRED_OFFSET UNITYSDK_OFFSET(0xA4D960)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_TIMEHELD_OFFSET UNITYSDK_OFFSET(0xA4D980)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_TIMELOOPED_OFFSET UNITYSDK_OFFSET(0xA4D970)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_HASFLAGS_OFFSET UNITYSDK_OFFSET(0xA4D930)

namespace UnityEngine::Playables
{
	inline static constexpr unsigned int FrameData_TypeDefinitionIndex = 6276;
