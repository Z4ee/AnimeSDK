...
#define UNITYENGINE_ADAPTIVETESSELLATIONRENDERER_SET_HEIGHTMAP_OFFSET UNITYSDK_OFFSET(0x1B277840)
#define UNITYENGINE_ADAPTIVETESSELLATIONRENDERER_SET_MESHSIZEX_OFFSET UNITYSDK_OFFSET(0x1B277850)
#define UNITYENGINE_ADAPTIVETESSELLATIONRENDERER_SET_MESHSIZEZ_OFFSET UNITYSDK_OFFSET(0x1B277860)
#define UNITYENGINE_ADAPTIVETESSELLATIONRENDERER_SET_RENDERWIREFRAME_OFFSET UNITYSDK_OFFSET(0x1B277890)
#define UNITYENGINE_ADAPTIVETESSELLATIONRENDERER_SET_TESSELLATIONAREAPERCENTAGECLAMP_OFFSET UNITYSDK_OFFSET(0x1B277880)
#define UNITYENGINE_ADAPTIVETESSELLATIONRENDERER_SET_TESSELLATIONAREAPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1B277870)

namespace UnityEngine
{
	inline static constexpr unsigned int AdaptiveTessellationRenderer_TypeDefinitionIndex = 4234;
