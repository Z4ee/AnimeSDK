...
#define UNITYENGINE_BINARYPREFABINSTANTIATEREQUEST_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1D2FA7C0)
#define UNITYENGINE_BINARYPREFABINSTANTIATEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FA7D0)

namespace UnityEngine
{
	inline static constexpr unsigned int BinaryPrefabInstantiateRequest_TypeDefinitionIndex = 5700;
