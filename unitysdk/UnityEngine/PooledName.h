...
#define UNITYENGINE_POOLEDNAME_GETHASHCODEINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ECC99C0)
#define UNITYENGINE_POOLEDNAME_GETHASHCODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x3C6D4A0)
#define UNITYENGINE_POOLEDNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3C6D4A0)
#define UNITYENGINE_POOLEDNAME_TOSTRINGINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ECC9990)
#define UNITYENGINE_POOLEDNAME_TOSTRINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x3C6D490)
#define UNITYENGINE_POOLEDNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3C6D490)
