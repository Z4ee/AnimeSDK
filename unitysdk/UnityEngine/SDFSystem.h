...
#define UNITYENGINE_SDFSYSTEM_ADDSECTORDATA_OFFSET UNITYSDK_OFFSET(0x1ED62500)
#define UNITYENGINE_SDFSYSTEM_ADD_STREAMINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x1ED623E0)
#define UNITYENGINE_SDFSYSTEM_NOTIFYSTREAMING_OFFSET UNITYSDK_OFFSET(0x1ED624E0)
#define UNITYENGINE_SDFSYSTEM_REMOVE_STREAMINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x1ED62460)
#define UNITYENGINE_SDFSYSTEM_UNLOADSECTORDATA_OFFSET UNITYSDK_OFFSET(0x1ED62510)

namespace UnityEngine
{
	inline static constexpr unsigned int SDFSystem_TypeDefinitionIndex = 4263;
