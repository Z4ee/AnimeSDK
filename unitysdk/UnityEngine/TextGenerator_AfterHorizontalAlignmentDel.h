...
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0410)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0480)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AFF70)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B03A0)

namespace UnityEngine
{
	inline static constexpr unsigned int TextGenerator_AfterHorizontalAlignmentDel_TypeDefinitionIndex = 5026;
