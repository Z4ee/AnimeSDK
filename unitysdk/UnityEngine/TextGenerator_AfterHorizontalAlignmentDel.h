...
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE00A0)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EDE0110)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EDDFC00)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDE0030)
