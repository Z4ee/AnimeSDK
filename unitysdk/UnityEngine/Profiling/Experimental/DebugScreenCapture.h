...
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_RAWIMAGEDATAREFERENCE_OFFSET UNITYSDK_OFFSET(0x1682A10)
...
{
	inline static constexpr unsigned int DebugScreenCapture_TypeDefinitionIndex = 4327;
