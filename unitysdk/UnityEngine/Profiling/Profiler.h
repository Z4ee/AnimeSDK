...
#define UNITYENGINE_PROFILING_PROFILER_ENDTHREADPROFILING_OFFSET UNITYSDK_OFFSET(0x1B2E4400)
#define UNITYENGINE_PROFILING_PROFILER_GETMONOHEAPSIZELONG_OFFSET UNITYSDK_OFFSET(0x1B2E4420)
#define UNITYENGINE_PROFILING_PROFILER_GETMONOUSEDSIZELONG_OFFSET UNITYSDK_OFFSET(0x1B2E4430)
#define UNITYENGINE_PROFILING_PROFILER_GETNAPASSETMEMSTATS_OFFSET UNITYSDK_OFFSET(0x1B2E44E0)
#define UNITYENGINE_PROFILING_PROFILER_GETNAPENGINESTATS_OFFSET UNITYSDK_OFFSET(0x1B2E44D0)
#define UNITYENGINE_PROFILING_PROFILER_GETOBJECTMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1B2E44F0)
#define UNITYENGINE_PROFILING_PROFILER_GETRUNTIMEMEMORYSIZELONG_OFFSET UNITYSDK_OFFSET(0x1B2E4410)
#define UNITYENGINE_PROFILING_PROFILER_GETSYSTEMMEMORYUSEDANDTOTALLONGSIZE_1_OFFSET UNITYSDK_OFFSET(0x1B2E4450)
#define UNITYENGINE_PROFILING_PROFILER_GETSYSTEMMEMORYUSEDANDTOTALLONGSIZE_OFFSET UNITYSDK_OFFSET(0x1B2E4440)
#define UNITYENGINE_PROFILING_PROFILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2E4500)
#define UNITYENGINE_PROFILING_PROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E43F0)
...
namespace UnityEngine::Profiling
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Profiler_TypeDefinitionIndex)->GetStaticField(0x2E80);
		}
		static ::System::Boolean* StaticGet_EnableSampleCheck()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Profiler_TypeDefinitionIndex)->GetStaticField(0x2E84);
		}
