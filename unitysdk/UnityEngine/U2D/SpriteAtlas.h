...
#define UNITYENGINE_U2D_SPRITEATLAS_CANBINDTO_OFFSET UNITYSDK_OFFSET(0x1ED72580)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITESSCRIPTING_OFFSET UNITYSDK_OFFSET(0x1ED725B0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITESWITHNAMESCRIPTING_OFFSET UNITYSDK_OFFSET(0x1ED725D0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITES_1_OFFSET UNITYSDK_OFFSET(0x1ED725C0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITES_OFFSET UNITYSDK_OFFSET(0x1ED725A0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITE_OFFSET UNITYSDK_OFFSET(0x1ED72590)
#define UNITYENGINE_U2D_SPRITEATLAS_GET_ISVARIANT_OFFSET UNITYSDK_OFFSET(0x1ED72550)
#define UNITYENGINE_U2D_SPRITEATLAS_GET_SPRITECOUNT_OFFSET UNITYSDK_OFFSET(0x1ED72570)
#define UNITYENGINE_U2D_SPRITEATLAS_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1ED72560)
#define UNITYENGINE_U2D_SPRITEATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED725E0)

namespace UnityEngine::U2D
{
	inline static constexpr unsigned int SpriteAtlas_TypeDefinitionIndex = 4421;
