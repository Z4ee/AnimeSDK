...
#define UNITYENGINE_U2D_SPRITEATLAS_CANBINDTO_OFFSET UNITYSDK_OFFSET(0x1D0DA7A0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITESSCRIPTING_OFFSET UNITYSDK_OFFSET(0x1D0DA7D0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITESWITHNAMESCRIPTING_OFFSET UNITYSDK_OFFSET(0x1D0DA7F0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITES_1_OFFSET UNITYSDK_OFFSET(0x1D0DA7E0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITES_OFFSET UNITYSDK_OFFSET(0x1D0DA7C0)
#define UNITYENGINE_U2D_SPRITEATLAS_GETSPRITE_OFFSET UNITYSDK_OFFSET(0x1D0DA7B0)
#define UNITYENGINE_U2D_SPRITEATLAS_GET_ISVARIANT_OFFSET UNITYSDK_OFFSET(0x1D0DA770)
#define UNITYENGINE_U2D_SPRITEATLAS_GET_SPRITECOUNT_OFFSET UNITYSDK_OFFSET(0x1D0DA790)
#define UNITYENGINE_U2D_SPRITEATLAS_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1D0DA780)
#define UNITYENGINE_U2D_SPRITEATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0DA800)

namespace UnityEngine::U2D
{
	inline static constexpr unsigned int SpriteAtlas_TypeDefinitionIndex = 4411;
