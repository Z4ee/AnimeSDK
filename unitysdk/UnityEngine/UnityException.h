...
#define UNITYENGINE_UNITYEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18A544B0)
#define UNITYENGINE_UNITYEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18A5B4D0)
#define UNITYENGINE_UNITYEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5B430)

namespace UnityEngine
{
	inline static constexpr unsigned int UnityException_TypeDefinitionIndex = 4150;
