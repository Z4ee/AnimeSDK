...
#define UNITYENGINE_RAY_GETPOINT_OFFSET UNITYSDK_OFFSET(0xA64530)
#define UNITYENGINE_RAY_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x457AA0)
#define UNITYENGINE_RAY_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x34AF10)
#define UNITYENGINE_RAY_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0xA644C0)
#define UNITYENGINE_RAY_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x34AC00)
#define UNITYENGINE_RAY_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0xA64570)
#define UNITYENGINE_RAY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA64560)
#define UNITYENGINE_RAY__CTOR_OFFSET UNITYSDK_OFFSET(0xA64450)
