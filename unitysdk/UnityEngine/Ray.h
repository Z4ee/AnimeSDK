...
#define UNITYENGINE_RAY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x22BFC50)
#define UNITYENGINE_RAY_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x245F0)
#define UNITYENGINE_RAY_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x245D0)
#define UNITYENGINE_RAY_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x22E7830)
#define UNITYENGINE_RAY_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0xDE0E0)
#define UNITYENGINE_RAY_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x22E78F0)
#define UNITYENGINE_RAY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22E78E0)
#define UNITYENGINE_RAY__CTOR_OFFSET UNITYSDK_OFFSET(0x22E7780)
