...
#define UNITYENGINE_STREAMINGCONTROLLER_CANCELPRELOADING_OFFSET UNITYSDK_OFFSET(0x1E8912F0)
#define UNITYENGINE_STREAMINGCONTROLLER_GET_STREAMINGMIPMAPBIAS_OFFSET UNITYSDK_OFFSET(0x1E8912C0)
#define UNITYENGINE_STREAMINGCONTROLLER_ISPRELOADING_OFFSET UNITYSDK_OFFSET(0x1E891300)
#define UNITYENGINE_STREAMINGCONTROLLER_SETPRELOADING_OFFSET UNITYSDK_OFFSET(0x1E8912E0)
#define UNITYENGINE_STREAMINGCONTROLLER_SET_STREAMINGMIPMAPBIAS_OFFSET UNITYSDK_OFFSET(0x1E8912D0)
#define UNITYENGINE_STREAMINGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E891310)

namespace UnityEngine
{
	inline static constexpr unsigned int StreamingController_TypeDefinitionIndex = 18828;
