...
#define UNITYENGINE_MATERIALANIMATIONBINDING_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ED31840)
#define UNITYENGINE_MATERIALANIMATIONBINDING_GET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1ED31810)
#define UNITYENGINE_MATERIALANIMATIONBINDING_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ED31830)
#define UNITYENGINE_MATERIALANIMATIONBINDING_SET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1ED31820)
