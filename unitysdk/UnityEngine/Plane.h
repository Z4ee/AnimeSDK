...
#define UNITYENGINE_PLANE_CLOSESTPOINTONPLANE_OFFSET UNITYSDK_OFFSET(0x20EBB40)
#define UNITYENGINE_PLANE_GETDISTANCETOPOINT_OFFSET UNITYSDK_OFFSET(0x20EBBB0)
#define UNITYENGINE_PLANE_GETSIDE_OFFSET UNITYSDK_OFFSET(0x20EBBE0)
#define UNITYENGINE_PLANE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xCCC0)
#define UNITYENGINE_PLANE_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x245E0)
#define UNITYENGINE_PLANE_RAYCAST_OFFSET UNITYSDK_OFFSET(0x2112ED0)
#define UNITYENGINE_PLANE_SETNORMALANDPOSITION_OFFSET UNITYSDK_OFFSET(0x2112DD0)
#define UNITYENGINE_PLANE_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xCCD0)
#define UNITYENGINE_PLANE_SET_NORMAL_OFFSET UNITYSDK_OFFSET(0x79820)
#define UNITYENGINE_PLANE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2112F90)
#define UNITYENGINE_PLANE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x24680)
#define UNITYENGINE_PLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x2112CE0)

namespace UnityEngine
{
	inline static constexpr unsigned int Plane_TypeDefinitionIndex = 3888;
