...
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_ATTACHRIBBONSTOTRANSFORM_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F780)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_ATTACHRIBBONSTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x3894DC0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_COLOROVERLIFETIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F500)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_COLOROVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x3894B70)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_COLOROVERTRAIL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F640)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_COLOROVERTRAIL_OFFSET UNITYSDK_OFFSET(0x3894CA0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_DIEWITHPARTICLES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F3B0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_DIEWITHPARTICLES_OFFSET UNITYSDK_OFFSET(0x3894AF0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F180)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x38949A0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_GENERATELIGHTINGDATA_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F680)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_GENERATELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x3894D40)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_INHERITPARTICLECOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F470)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_INHERITPARTICLECOLOR_OFFSET UNITYSDK_OFFSET(0x3894B50)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_LIFETIMEMULTIPLIER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F2B0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_LIFETIMEMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x3894A70)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_LIFETIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F270)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x3894A00)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_MINVERTEXDISTANCE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F2F0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_MINVERTEXDISTANCE_OFFSET UNITYSDK_OFFSET(0x3894A90)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_MODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F1C0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x38949C0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_NUMHORIZONTALVERTICES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F7C0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_NUMHORIZONTALVERTICES_OFFSET UNITYSDK_OFFSET(0x3894DE0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_RATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F200)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x38949E0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_RIBBONCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F6C0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_RIBBONCOUNT_OFFSET UNITYSDK_OFFSET(0x3894D60)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SHADOWBIAS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F700)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x3894D80)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SIZEAFFECTSLIFETIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F430)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SIZEAFFECTSLIFETIME_OFFSET UNITYSDK_OFFSET(0x3894B30)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SIZEAFFECTSWIDTH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F3F0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SIZEAFFECTSWIDTH_OFFSET UNITYSDK_OFFSET(0x3894B10)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SPLITSUBEMITTERRIBBONS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F740)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_SPLITSUBEMITTERRIBBONS_OFFSET UNITYSDK_OFFSET(0x3894DA0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_TEXTUREMODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F330)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_TEXTUREMODE_OFFSET UNITYSDK_OFFSET(0x3894AB0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_WIDTHOVERTRAILMULTIPLIER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F5B0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_WIDTHOVERTRAILMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x3894C80)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_WIDTHOVERTRAIL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F570)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_WIDTHOVERTRAIL_OFFSET UNITYSDK_OFFSET(0x3894C10)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_WORLDSPACE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F370)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_GET_WORLDSPACE_OFFSET UNITYSDK_OFFSET(0x3894AD0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_ATTACHRIBBONSTOTRANSFORM_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F7A0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_ATTACHRIBBONSTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x3894DD0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_COLOROVERLIFETIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F520)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_COLOROVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x3894BD0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_COLOROVERTRAIL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F660)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_COLOROVERTRAIL_OFFSET UNITYSDK_OFFSET(0x3894D00)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_DIEWITHPARTICLES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F3D0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_DIEWITHPARTICLES_OFFSET UNITYSDK_OFFSET(0x3894B00)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F1A0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x38949B0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_GENERATELIGHTINGDATA_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F6A0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_GENERATELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x3894D50)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_INHERITPARTICLECOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F490)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_INHERITPARTICLECOLOR_OFFSET UNITYSDK_OFFSET(0x3894B60)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_LIFETIMEMULTIPLIER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F2D0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_LIFETIMEMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x3894A80)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_LIFETIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F290)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x3894A40)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_MINVERTEXDISTANCE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F310)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_MINVERTEXDISTANCE_OFFSET UNITYSDK_OFFSET(0x3894AA0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_MODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F1E0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x38949D0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_NUMHORIZONTALVERTICES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F7E0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_NUMHORIZONTALVERTICES_OFFSET UNITYSDK_OFFSET(0x3894DF0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_RATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F220)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x38949F0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_RIBBONCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F6E0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_RIBBONCOUNT_OFFSET UNITYSDK_OFFSET(0x3894D70)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SHADOWBIAS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F720)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x3894D90)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SIZEAFFECTSLIFETIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F450)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SIZEAFFECTSLIFETIME_OFFSET UNITYSDK_OFFSET(0x3894B40)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SIZEAFFECTSWIDTH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F410)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SIZEAFFECTSWIDTH_OFFSET UNITYSDK_OFFSET(0x3894B20)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SPLITSUBEMITTERRIBBONS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F760)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_SPLITSUBEMITTERRIBBONS_OFFSET UNITYSDK_OFFSET(0x3894DB0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_TEXTUREMODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F350)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_TEXTUREMODE_OFFSET UNITYSDK_OFFSET(0x3894AC0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_WIDTHOVERTRAILMULTIPLIER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F5D0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_WIDTHOVERTRAILMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x3894C90)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_WIDTHOVERTRAIL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F590)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_WIDTHOVERTRAIL_OFFSET UNITYSDK_OFFSET(0x3894C50)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_WORLDSPACE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B31F390)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE_SET_WORLDSPACE_OFFSET UNITYSDK_OFFSET(0x3894AE0)
#define UNITYENGINE_PARTICLESYSTEM_TRAILMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC630)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleSystem_TrailModule_TypeDefinitionIndex = 5751;
