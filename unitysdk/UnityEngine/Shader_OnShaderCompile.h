...
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE5440)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE5470)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AAE4F40)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE4F30)

namespace UnityEngine
{
	inline static constexpr unsigned int Shader_OnShaderCompile_TypeDefinitionIndex = 5202;
