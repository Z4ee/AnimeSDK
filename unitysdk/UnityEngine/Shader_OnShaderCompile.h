...
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E326290)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E3262C0)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E325D70)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E325D50)
