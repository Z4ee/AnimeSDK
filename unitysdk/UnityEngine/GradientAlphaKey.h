...
#define UNITYENGINE_GRADIENTALPHAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x4E4210)

namespace UnityEngine
{
	inline static constexpr unsigned int GradientAlphaKey_TypeDefinitionIndex = 5295;
