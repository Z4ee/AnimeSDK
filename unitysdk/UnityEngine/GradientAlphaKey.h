...
#define UNITYENGINE_GRADIENTALPHAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x2CFA0)

namespace UnityEngine
{
	inline static constexpr unsigned int GradientAlphaKey_TypeDefinitionIndex = 4205;
