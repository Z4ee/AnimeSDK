...
#define UNITYENGINE_AVATARMASK_ADDTRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1C559FF0)
#define UNITYENGINE_AVATARMASK_ADDTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1C559FE0)
#define UNITYENGINE_AVATARMASK_APPLYMASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559FD0)
#define UNITYENGINE_AVATARMASK_APPLYMASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559F70)
#define UNITYENGINE_AVATARMASK_APPLYMASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559FA0)
#define UNITYENGINE_AVATARMASK_COPY_OFFSET UNITYSDK_OFFSET(0x1C55A150)
#define UNITYENGINE_AVATARMASK_GETACL2PRECISIONSCALER_OFFSET UNITYSDK_OFFSET(0x1C55A040)
#define UNITYENGINE_AVATARMASK_GETHUMANOIDBODYPARTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C559EF0)
#define UNITYENGINE_AVATARMASK_GETNODEROTATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C55A0A0)
#define UNITYENGINE_AVATARMASK_GETNODETRANSFORMCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C55A060)
#define UNITYENGINE_AVATARMASK_GETNODETRANSLATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C55A080)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMACTIVE_OFFSET UNITYSDK_OFFSET(0x1C55A0E0)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1C55A020)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMWEIGHT_OFFSET UNITYSDK_OFFSET(0x1C55A0C0)
#define UNITYENGINE_AVATARMASK_GET_HASFEETIK_OFFSET UNITYSDK_OFFSET(0x1C55A140)
#define UNITYENGINE_AVATARMASK_GET_HUMANOIDBODYPARTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C559EE0)
#define UNITYENGINE_AVATARMASK_GET_ISACLMASK2_OFFSET UNITYSDK_OFFSET(0x1C559F10)
#define UNITYENGINE_AVATARMASK_GET_MASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559FB0)
#define UNITYENGINE_AVATARMASK_GET_MASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559F50)
#define UNITYENGINE_AVATARMASK_GET_MASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559F80)
#define UNITYENGINE_AVATARMASK_GET_TRANSFORMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C559F30)
#define UNITYENGINE_AVATARMASK_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1C559ED0)
#define UNITYENGINE_AVATARMASK_REMOVETRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1C55A010)
#define UNITYENGINE_AVATARMASK_REMOVETRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1C55A000)
#define UNITYENGINE_AVATARMASK_SETACL2PRECISIONSCALER_OFFSET UNITYSDK_OFFSET(0x1C55A050)
#define UNITYENGINE_AVATARMASK_SETHUMANOIDBODYPARTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C559F00)
#define UNITYENGINE_AVATARMASK_SETNODEROTATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C55A0B0)
#define UNITYENGINE_AVATARMASK_SETNODETRANSFORMCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C55A070)
#define UNITYENGINE_AVATARMASK_SETNODETRANSLATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C55A090)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMACTIVE_OFFSET UNITYSDK_OFFSET(0x1C55A100)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1C55A030)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMWEIGHT_OFFSET UNITYSDK_OFFSET(0x1C55A0D0)
#define UNITYENGINE_AVATARMASK_SET_ISACLMASK2_OFFSET UNITYSDK_OFFSET(0x1C559F20)
#define UNITYENGINE_AVATARMASK_SET_MASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559FC0)
#define UNITYENGINE_AVATARMASK_SET_MASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559F60)
#define UNITYENGINE_AVATARMASK_SET_MASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C559F90)
#define UNITYENGINE_AVATARMASK_SET_TRANSFORMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C559F40)
#define UNITYENGINE_AVATARMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C559E70)

namespace UnityEngine
{
	inline static constexpr unsigned int AvatarMask_TypeDefinitionIndex = 6559;
