...
#define UNITYENGINE_GUILAYOUT_BEGINAREA_1_OFFSET UNITYSDK_OFFSET(0x1D0EE200)
#define UNITYENGINE_GUILAYOUT_BEGINAREA_2_OFFSET UNITYSDK_OFFSET(0x1D0EE280)
#define UNITYENGINE_GUILAYOUT_BEGINAREA_3_OFFSET UNITYSDK_OFFSET(0x1D0EE020)
#define UNITYENGINE_GUILAYOUT_BEGINAREA_OFFSET UNITYSDK_OFFSET(0x1D0EDF90)
#define UNITYENGINE_GUILAYOUT_BEGINHORIZONTAL_1_OFFSET UNITYSDK_OFFSET(0x1D0ED8E0)
#define UNITYENGINE_GUILAYOUT_BEGINHORIZONTAL_2_OFFSET UNITYSDK_OFFSET(0x1D0ED7C0)
#define UNITYENGINE_GUILAYOUT_BEGINHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1D0ED730)
#define UNITYENGINE_GUILAYOUT_BEGINSCROLLVIEW_1_OFFSET UNITYSDK_OFFSET(0x1D0EE950)
#define UNITYENGINE_GUILAYOUT_BEGINSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1D0EE870)
#define UNITYENGINE_GUILAYOUT_BEGINVERTICAL_1_OFFSET UNITYSDK_OFFSET(0x1D0EDF10)
#define UNITYENGINE_GUILAYOUT_BEGINVERTICAL_2_OFFSET UNITYSDK_OFFSET(0x1D0EDDF0)
#define UNITYENGINE_GUILAYOUT_BEGINVERTICAL_OFFSET UNITYSDK_OFFSET(0x1D0EDD60)
#define UNITYENGINE_GUILAYOUT_BOX_OFFSET UNITYSDK_OFFSET(0x1D0ECB50)
#define UNITYENGINE_GUILAYOUT_BUTTON_1_OFFSET UNITYSDK_OFFSET(0x1D0ECFF0)
#define UNITYENGINE_GUILAYOUT_BUTTON_OFFSET UNITYSDK_OFFSET(0x1D0ECD90)
#define UNITYENGINE_GUILAYOUT_DOBOX_OFFSET UNITYSDK_OFFSET(0x1D0ECD10)
#define UNITYENGINE_GUILAYOUT_DOBUTTON_OFFSET UNITYSDK_OFFSET(0x1D0ECEF0)
#define UNITYENGINE_GUILAYOUT_DOLABEL_OFFSET UNITYSDK_OFFSET(0x1D0EC910)
#define UNITYENGINE_GUILAYOUT_DOTOGGLE_OFFSET UNITYSDK_OFFSET(0x1D0ED2A0)
#define UNITYENGINE_GUILAYOUT_DOWINDOW_OFFSET UNITYSDK_OFFSET(0x1D0EEF00)
#define UNITYENGINE_GUILAYOUT_ENDAREA_OFFSET UNITYSDK_OFFSET(0x1D0EE630)
#define UNITYENGINE_GUILAYOUT_ENDHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1D0EDBE0)
#define UNITYENGINE_GUILAYOUT_ENDSCROLLVIEW_1_OFFSET UNITYSDK_OFFSET(0x1D0EECF0)
#define UNITYENGINE_GUILAYOUT_ENDSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1D0EEC80)
#define UNITYENGINE_GUILAYOUT_ENDVERTICAL_OFFSET UNITYSDK_OFFSET(0x1D0EDF80)
#define UNITYENGINE_GUILAYOUT_EXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1D0EF2F0)
#define UNITYENGINE_GUILAYOUT_EXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x1D0EF290)
#define UNITYENGINE_GUILAYOUT_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1D0EB600)
#define UNITYENGINE_GUILAYOUT_LABEL_1_OFFSET UNITYSDK_OFFSET(0x1D0EC990)
#define UNITYENGINE_GUILAYOUT_LABEL_OFFSET UNITYSDK_OFFSET(0x1D0EC750)
#define UNITYENGINE_GUILAYOUT_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1D0EF220)
#define UNITYENGINE_GUILAYOUT_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1D0EF140)
#define UNITYENGINE_GUILAYOUT_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1D0EF1B0)
#define UNITYENGINE_GUILAYOUT_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1D0EF0D0)
#define UNITYENGINE_GUILAYOUT_SPACE_OFFSET UNITYSDK_OFFSET(0x1D0ED320)
#define UNITYENGINE_GUILAYOUT_TOGGLE_OFFSET UNITYSDK_OFFSET(0x1D0ED110)
#define UNITYENGINE_GUILAYOUT_WIDTH_OFFSET UNITYSDK_OFFSET(0x1D0EB590)
#define UNITYENGINE_GUILAYOUT_WINDOW_OFFSET UNITYSDK_OFFSET(0x1D0EED50)
#define UNITYENGINE_GUILAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0EF350)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayout_TypeDefinitionIndex = 6407;
