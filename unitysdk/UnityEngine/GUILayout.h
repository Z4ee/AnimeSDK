...
#define UNITYENGINE_GUILAYOUT_BEGINAREA_1_OFFSET UNITYSDK_OFFSET(0x1ACEB550)
#define UNITYENGINE_GUILAYOUT_BEGINAREA_2_OFFSET UNITYSDK_OFFSET(0x1ACEB5D0)
#define UNITYENGINE_GUILAYOUT_BEGINAREA_3_OFFSET UNITYSDK_OFFSET(0x1ACEB370)
#define UNITYENGINE_GUILAYOUT_BEGINAREA_OFFSET UNITYSDK_OFFSET(0x1ACEB2E0)
#define UNITYENGINE_GUILAYOUT_BEGINHORIZONTAL_1_OFFSET UNITYSDK_OFFSET(0x1ACEAC30)
#define UNITYENGINE_GUILAYOUT_BEGINHORIZONTAL_2_OFFSET UNITYSDK_OFFSET(0x1ACEAB10)
#define UNITYENGINE_GUILAYOUT_BEGINHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1ACEAA80)
#define UNITYENGINE_GUILAYOUT_BEGINSCROLLVIEW_1_OFFSET UNITYSDK_OFFSET(0x1ACEBCA0)
#define UNITYENGINE_GUILAYOUT_BEGINSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1ACEBBC0)
#define UNITYENGINE_GUILAYOUT_BEGINVERTICAL_1_OFFSET UNITYSDK_OFFSET(0x1ACEB260)
#define UNITYENGINE_GUILAYOUT_BEGINVERTICAL_2_OFFSET UNITYSDK_OFFSET(0x1ACEB140)
#define UNITYENGINE_GUILAYOUT_BEGINVERTICAL_OFFSET UNITYSDK_OFFSET(0x1ACEB0B0)
#define UNITYENGINE_GUILAYOUT_BOX_OFFSET UNITYSDK_OFFSET(0x1ACE9EA0)
#define UNITYENGINE_GUILAYOUT_BUTTON_1_OFFSET UNITYSDK_OFFSET(0x1ACEA340)
#define UNITYENGINE_GUILAYOUT_BUTTON_OFFSET UNITYSDK_OFFSET(0x1ACEA0E0)
#define UNITYENGINE_GUILAYOUT_DOBOX_OFFSET UNITYSDK_OFFSET(0x1ACEA060)
#define UNITYENGINE_GUILAYOUT_DOBUTTON_OFFSET UNITYSDK_OFFSET(0x1ACEA240)
#define UNITYENGINE_GUILAYOUT_DOLABEL_OFFSET UNITYSDK_OFFSET(0x1ACE9C60)
#define UNITYENGINE_GUILAYOUT_DOTOGGLE_OFFSET UNITYSDK_OFFSET(0x1ACEA5F0)
#define UNITYENGINE_GUILAYOUT_DOWINDOW_OFFSET UNITYSDK_OFFSET(0x1ACEC250)
#define UNITYENGINE_GUILAYOUT_ENDAREA_OFFSET UNITYSDK_OFFSET(0x1ACEB980)
#define UNITYENGINE_GUILAYOUT_ENDHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1ACEAF30)
#define UNITYENGINE_GUILAYOUT_ENDSCROLLVIEW_1_OFFSET UNITYSDK_OFFSET(0x1ACEC040)
#define UNITYENGINE_GUILAYOUT_ENDSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1ACEBFD0)
#define UNITYENGINE_GUILAYOUT_ENDVERTICAL_OFFSET UNITYSDK_OFFSET(0x1ACEB2D0)
#define UNITYENGINE_GUILAYOUT_EXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1ACEC640)
#define UNITYENGINE_GUILAYOUT_EXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x1ACEC5E0)
#define UNITYENGINE_GUILAYOUT_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1ACE8950)
#define UNITYENGINE_GUILAYOUT_LABEL_1_OFFSET UNITYSDK_OFFSET(0x1ACE9CE0)
#define UNITYENGINE_GUILAYOUT_LABEL_OFFSET UNITYSDK_OFFSET(0x1ACE9AA0)
#define UNITYENGINE_GUILAYOUT_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1ACEC570)
#define UNITYENGINE_GUILAYOUT_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1ACEC490)
#define UNITYENGINE_GUILAYOUT_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1ACEC500)
#define UNITYENGINE_GUILAYOUT_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1ACEC420)
#define UNITYENGINE_GUILAYOUT_SPACE_OFFSET UNITYSDK_OFFSET(0x1ACEA670)
#define UNITYENGINE_GUILAYOUT_TOGGLE_OFFSET UNITYSDK_OFFSET(0x1ACEA460)
#define UNITYENGINE_GUILAYOUT_WIDTH_OFFSET UNITYSDK_OFFSET(0x1ACE88E0)
#define UNITYENGINE_GUILAYOUT_WINDOW_OFFSET UNITYSDK_OFFSET(0x1ACEC0A0)
#define UNITYENGINE_GUILAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACEC6A0)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayout_TypeDefinitionIndex = 6362;
