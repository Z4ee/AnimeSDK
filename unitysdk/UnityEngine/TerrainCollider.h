...
#define UNITYENGINE_TERRAINCOLLIDER_SET_TERRAINDATA_OFFSET UNITYSDK_OFFSET(0x1EDD9860)

namespace UnityEngine
{
	inline static constexpr unsigned int TerrainCollider_TypeDefinitionIndex = 5828;
