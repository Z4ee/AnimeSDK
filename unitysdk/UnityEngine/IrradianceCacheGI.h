...
#define UNITYENGINE_IRRADIANCECACHEGI_SETDEBUGPATHTRACINGINFO_OFFSET UNITYSDK_OFFSET(0x1EDF9DF0)

namespace UnityEngine
{
	inline static constexpr unsigned int IrradianceCacheGI_TypeDefinitionIndex = 4268;
