...
#define UNITYENGINE_IRRADIANCECACHEGI_SETDEBUGPATHTRACINGINFO_OFFSET UNITYSDK_OFFSET(0x1CCC5CC0)

namespace UnityEngine
{
	inline static constexpr unsigned int IrradianceCacheGI_TypeDefinitionIndex = 4258;
