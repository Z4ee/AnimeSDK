...
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA13FF0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA13FF0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA13F90)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA14010)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA13FF0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_UNREALTYPES_ISTRUCT_UNITYENGINE_VECTOR3__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E382680)

namespace UnityEngine
{
	inline static constexpr unsigned int StructWrapper_Vector3_TypeDefinitionIndex = 28264;

	struct alignas(1) StructWrapper_Vector3
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StructWrapper_Vector3_TypeDefinitionIndex)->GetStaticField(0x23F20);
		}
