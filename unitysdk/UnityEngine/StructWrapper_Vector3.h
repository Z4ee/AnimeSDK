...
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9398F0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9398F0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x939890)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x939910)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9398F0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_UNREALTYPES_ISTRUCT_UNITYENGINE_VECTOR3__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD99000)

namespace UnityEngine
{
	inline static constexpr unsigned int StructWrapper_Vector3_TypeDefinitionIndex = 25177;

	struct alignas(1) StructWrapper_Vector3
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StructWrapper_Vector3_TypeDefinitionIndex)->GetStaticField(0x1EB80);
		}
