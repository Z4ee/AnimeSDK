...
#define UNITYENGINE_HEADERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A11BA0)

namespace UnityEngine
{
	inline static constexpr unsigned int HeaderAttribute_TypeDefinitionIndex = 4048;
