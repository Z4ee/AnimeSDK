...
#define UNITYENGINE_XR_XRNODESTATE_SET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define UNITYENGINE_XR_XRNODESTATE_SET_TRACKED_OFFSET UNITYSDK_OFFSET(0x9D89F0)
#define UNITYENGINE_XR_XRNODESTATE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x8CA8E0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRNodeState_TypeDefinitionIndex = 25152;
