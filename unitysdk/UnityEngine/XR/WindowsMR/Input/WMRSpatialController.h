...
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1D8B6BB0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_BATTERYLEVEL_OFFSET UNITYSDK_OFFSET(0x1D8B6B10)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8B6AF0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8B6AD0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8B69F0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1D8B69D0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_JOYSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x1D8B6A70)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x1D8B6990)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_MENU_OFFSET UNITYSDK_OFFSET(0x1D8B6A10)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_POINTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1D8B6B70)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_POINTERROTATION_OFFSET UNITYSDK_OFFSET(0x1D8B6B90)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_SOURCELOSSMITIGATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x1D8B6B50)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_SOURCELOSSRISK_OFFSET UNITYSDK_OFFSET(0x1D8B6B30)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TOUCHPADCLICKED_OFFSET UNITYSDK_OFFSET(0x1D8B6A90)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TOUCHPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1D8B6AB0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1D8B69B0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8B6A50)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1D8B6A30)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_BATTERYLEVEL_OFFSET UNITYSDK_OFFSET(0x1D8B6B20)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8B6B00)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8B6AE0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8B6A00)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1D8B69E0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_JOYSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x1D8B6A80)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x1D8B69A0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_MENU_OFFSET UNITYSDK_OFFSET(0x1D8B6A20)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_POINTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1D8B6B80)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_POINTERROTATION_OFFSET UNITYSDK_OFFSET(0x1D8B6BA0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_SOURCELOSSMITIGATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x1D8B6B60)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_SOURCELOSSRISK_OFFSET UNITYSDK_OFFSET(0x1D8B6B40)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TOUCHPADCLICKED_OFFSET UNITYSDK_OFFSET(0x1D8B6AA0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TOUCHPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1D8B6AC0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1D8B69C0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8B6A60)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1D8B6A40)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8B6DE0)

namespace UnityEngine::XR::WindowsMR::Input
{
	inline static constexpr unsigned int WMRSpatialController_TypeDefinitionIndex = 31520;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::Vector3Control* _pointerPosition_k__BackingField; // 0x1A0
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadClicked_k__BackingField; // 0x1A8
		::UnityEngine::InputSystem::Controls::Vector3Control* _sourceLossMitigationDirection_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::ButtonControl* _menu_k__BackingField; // 0x1B8
		::UnityEngine::InputSystem::Controls::Vector2Control* _touchpad_k__BackingField; // 0x1C0
		...
		::UnityEngine::InputSystem::Controls::Vector2Control* _joystick_k__BackingField; // 0x1D8
		::UnityEngine::InputSystem::Controls::Vector3Control* _deviceVelocity_k__BackingField; // 0x1E0
		::UnityEngine::InputSystem::Controls::ButtonControl* _joystickClicked_k__BackingField; // 0x1E8
		::UnityEngine::InputSystem::Controls::AxisControl* _batteryLevel_k__BackingField; // 0x1F0
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadTouched_k__BackingField; // 0x1F8
