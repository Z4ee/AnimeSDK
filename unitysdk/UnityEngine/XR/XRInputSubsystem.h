...
#define UNITYENGINE_XR_XRINPUTSUBSYSTEM_INVOKEBOUNDARYCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E78ED00)
#define UNITYENGINE_XR_XRINPUTSUBSYSTEM_INVOKETRACKINGORIGINUPDATEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E78EC50)
#define UNITYENGINE_XR_XRINPUTSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E78EDB0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRInputSubsystem_TypeDefinitionIndex = 27652;
