...
#define UNITYENGINE_XR_EYES_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9D8320)
#define UNITYENGINE_XR_EYES_EQUALS_OFFSET UNITYSDK_OFFSET(0x9D8360)
#define UNITYENGINE_XR_EYES_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9D8340)
#define UNITYENGINE_XR_EYES_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define UNITYENGINE_XR_EYES_GET_FEATUREINDEX_OFFSET UNITYSDK_OFFSET(0x2F0420)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int Eyes_TypeDefinitionIndex = 25160;
