...
#define UNITYENGINE_XR_INPUTDEVICE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA7A030)
#define UNITYENGINE_XR_INPUTDEVICE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA79FB0)
#define UNITYENGINE_XR_INPUTDEVICE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA7A060)
#define UNITYENGINE_XR_INPUTDEVICE_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0xA79F90)
#define UNITYENGINE_XR_INPUTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xA79F80)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int InputDevice_TypeDefinitionIndex = 27643;
