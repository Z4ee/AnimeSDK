...
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C551440)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5514C0)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C550E40)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C551430)

namespace UnityEngine::XR::WSA
{
	inline static constexpr unsigned int WorldAnchor_OnTrackingChangedDelegate_TypeDefinitionIndex = 8566;
