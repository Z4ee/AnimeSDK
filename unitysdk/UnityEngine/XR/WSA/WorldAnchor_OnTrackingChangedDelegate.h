...
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E881000)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E881080)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8809F0)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E880FE0)

namespace UnityEngine::XR::WSA
{
	inline static constexpr unsigned int WorldAnchor_OnTrackingChangedDelegate_TypeDefinitionIndex = 8813;
