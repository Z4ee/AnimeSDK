...
#define UNITYENGINE_RENDERERHOOK_INVOKE_ONHOOKRENDERERSETENABLED_OFFSET UNITYSDK_OFFSET(0x1EA74950)
#define UNITYENGINE_RENDERERHOOK_INVOKE_ONHOOKRENDERERSETNAPCB_OFFSET UNITYSDK_OFFSET(0x1EA749C0)
#define UNITYENGINE_RENDERERHOOK_INVOKE_ONHOOKRENDERERSETPROPERTYBLOCKMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1EA74AB0)
#define UNITYENGINE_RENDERERHOOK_INVOKE_ONHOOKRENDERERSETPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1EA74A40)
#define UNITYENGINE_RENDERERHOOK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA74B30)
...
namespace UnityEngine
{
	...
	public:
		...
		{
			return (::System::Action_2<::UnityEngine::Renderer*, ::UnityEngine::MaterialPropertyBlock*>**)Il2CppClass::FromTypeDefinitionIndex(RendererHook_TypeDefinitionIndex)->GetStaticField(0x5690);
		}
		...
		{
			return (::System::Action_3<::UnityEngine::Renderer*, ::UnityEngine::MaterialPropertyBlock*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RendererHook_TypeDefinitionIndex)->GetStaticField(0x56A0);
		}
		static ::System::Action_2<::UnityEngine::Renderer*, ::System::Boolean>** StaticGet_onHookSetEnabled()
		{
			return (::System::Action_2<::UnityEngine::Renderer*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(RendererHook_TypeDefinitionIndex)->GetStaticField(0x56A8);
		}
