...
#define UNITYENGINE_EDGECOLLIDER2D_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1BC4E0A0)
#define UNITYENGINE_EDGECOLLIDER2D_SET_EDGERADIUS_OFFSET UNITYSDK_OFFSET(0x1BC4E090)
#define UNITYENGINE_EDGECOLLIDER2D_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x1BC4E0B0)
#define UNITYENGINE_EDGECOLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC4E0C0)
