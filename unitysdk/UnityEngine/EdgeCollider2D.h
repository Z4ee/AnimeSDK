...
#define UNITYENGINE_EDGECOLLIDER2D_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1DF8B410)
#define UNITYENGINE_EDGECOLLIDER2D_SET_EDGERADIUS_OFFSET UNITYSDK_OFFSET(0x1DF8B400)
#define UNITYENGINE_EDGECOLLIDER2D_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x1DF8B420)
#define UNITYENGINE_EDGECOLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF8B430)

namespace UnityEngine
{
	inline static constexpr unsigned int EdgeCollider2D_TypeDefinitionIndex = 18390;
