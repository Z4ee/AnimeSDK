...
#define UNITYENGINE_BEFORERENDERORDERATTRIBUTE_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x1B27DCD0)

namespace UnityEngine
{
	inline static constexpr unsigned int BeforeRenderOrderAttribute_TypeDefinitionIndex = 4080;
