...
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_APPLYITEMTHREADINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EB5E6B0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_APPLYITEMTHREAD_OFFSET UNITYSDK_OFFSET(0x1EB5E860)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1EB5E680)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1EB5E690)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EB5E790)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EB5E6E0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EB5E760)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_SYNCJOBSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EB5E6A0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5E6C0)

namespace UnityEngine::NAPBatch
{
	inline static constexpr unsigned int MaterialBatchApplier_TypeDefinitionIndex = 6133;
