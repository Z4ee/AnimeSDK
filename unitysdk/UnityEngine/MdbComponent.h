...
#define UNITYENGINE_MDBCOMPONENT_BLENDTOANIMPOSEPERCLOTH_OFFSET UNITYSDK_OFFSET(0x1C54A220)
#define UNITYENGINE_MDBCOMPONENT_BLENDTOANIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A200)
#define UNITYENGINE_MDBCOMPONENT_BLENDTOSIMPOSEPERCLOTH_OFFSET UNITYSDK_OFFSET(0x1C54A230)
#define UNITYENGINE_MDBCOMPONENT_BLENDTOSIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A210)
#define UNITYENGINE_MDBCOMPONENT_CREATEMVDACTORSERVER_OFFSET UNITYSDK_OFFSET(0x1C54A180)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONENAMES_OFFSET UNITYSDK_OFFSET(0x1C54A480)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONEPARENTS_OFFSET UNITYSDK_OFFSET(0x1C54A490)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONEPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1C54A4A0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONEROTATIONS_OFFSET UNITYSDK_OFFSET(0x1C54A4B0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADCTXPARTICLESBONENAME_OFFSET UNITYSDK_OFFSET(0x1C54A390)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMCLOTHSKINCOLLIDERSPHEREPOS_OFFSET UNITYSDK_OFFSET(0x1C54A3F0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMCLOTHSKINCOLLIDERSPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x1C54A400)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESANIMPOSEPOS_OFFSET UNITYSDK_OFFSET(0x1C54A3D0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESANIMPOSEROT_OFFSET UNITYSDK_OFFSET(0x1C54A3E0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESSIMPOSENORM_OFFSET UNITYSDK_OFFSET(0x1C54A3A0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESSIMPOSEPOS_OFFSET UNITYSDK_OFFSET(0x1C54A3B0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESSIMPOSEROT_OFFSET UNITYSDK_OFFSET(0x1C54A3C0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMWINDDATA_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54A470)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMWINDDATA_OFFSET UNITYSDK_OFFSET(0x1C54A410)
#define UNITYENGINE_MDBCOMPONENT_GETBYTEDATAVER_OFFSET UNITYSDK_OFFSET(0x1C54A4C0)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHBLENDRATE_OFFSET UNITYSDK_OFFSET(0x1C54A1F0)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHINITSTATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A240)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHINITSTATE_OFFSET UNITYSDK_OFFSET(0x1C54A250)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHNUM_OFFSET UNITYSDK_OFFSET(0x1C54A0B0)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHSTATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A280)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHSTATE_OFFSET UNITYSDK_OFFSET(0x1C54A290)
#define UNITYENGINE_MDBCOMPONENT_GETMANUALSTEPENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A120)
#define UNITYENGINE_MDBCOMPONENT_GETMDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1C549FF0)
#define UNITYENGINE_MDBCOMPONENT_GETMDBENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A100)
#define UNITYENGINE_MDBCOMPONENT_GETSTEPUNITYBONEENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A150)
#define UNITYENGINE_MDBCOMPONENT_GETSTIFFEXPONENTRATE_OFFSET UNITYSDK_OFFSET(0x1C54A1D0)
#define UNITYENGINE_MDBCOMPONENT_GETTIMESLOWRATE_OFFSET UNITYSDK_OFFSET(0x1C54A1B0)
#define UNITYENGINE_MDBCOMPONENT_GET_BLEND2ANIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A4F0)
#define UNITYENGINE_MDBCOMPONENT_GET_BLEND2SIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A510)
#define UNITYENGINE_MDBCOMPONENT_GET_ENVIRONMENTLODVALUE_OFFSET UNITYSDK_OFFSET(0x1C54A030)
#define UNITYENGINE_MDBCOMPONENT_GET_FORCEUSEAVATARPOSITIONENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A050)
#define UNITYENGINE_MDBCOMPONENT_GET_ISMDBUSESKELETONSCALE_OFFSET UNITYSDK_OFFSET(0x1C54A090)
#define UNITYENGINE_MDBCOMPONENT_GET_LAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1C54A4D0)
#define UNITYENGINE_MDBCOMPONENT_GET_MDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1C549FD0)
#define UNITYENGINE_MDBCOMPONENT_GET_MDBCLOTHFLAGS_OFFSET UNITYSDK_OFFSET(0x1C54A010)
#define UNITYENGINE_MDBCOMPONENT_GET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0x1C549FB0)
#define UNITYENGINE_MDBCOMPONENT_GET_SIMBYREFPOSESETUNITSCALE_OFFSET UNITYSDK_OFFSET(0x1C54A070)
#define UNITYENGINE_MDBCOMPONENT_GET_STATEHASHBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1C54A550)
#define UNITYENGINE_MDBCOMPONENT_GET_STATEHASHTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1C54A5B0)
#define UNITYENGINE_MDBCOMPONENT_GET_STATELISTBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1C54A530)
#define UNITYENGINE_MDBCOMPONENT_GET_STATELISTTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1C54A590)
#define UNITYENGINE_MDBCOMPONENT_GET_TRANSITEPARAMSECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A570)
#define UNITYENGINE_MDBCOMPONENT_ISCOLWITHSCENE_OFFSET UNITYSDK_OFFSET(0x1C54A360)
#define UNITYENGINE_MDBCOMPONENT_MANUALSTEP_OFFSET UNITYSDK_OFFSET(0x1C54A130)
#define UNITYENGINE_MDBCOMPONENT_REBINDMDB_OFFSET UNITYSDK_OFFSET(0x1C54A0C0)
#define UNITYENGINE_MDBCOMPONENT_REFRESHSTATEHASH_OFFSET UNITYSDK_OFFSET(0x1C54A5D0)
#define UNITYENGINE_MDBCOMPONENT_RELOADHUMANDATA_OFFSET UNITYSDK_OFFSET(0x1C54A0D0)
#define UNITYENGINE_MDBCOMPONENT_RELOADSINGLECLOTHDATA_OFFSET UNITYSDK_OFFSET(0x1C54A0E0)
#define UNITYENGINE_MDBCOMPONENT_SETBLENDRATE_OFFSET UNITYSDK_OFFSET(0x1C54A1E0)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHLAYER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A2C0)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHLAYER_OFFSET UNITYSDK_OFFSET(0x1C54A2D0)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSTATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A260)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSTATE_OFFSET UNITYSDK_OFFSET(0x1C54A270)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSUPPLYANIM_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A2E0)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSUPPLYANIM_OFFSET UNITYSDK_OFFSET(0x1C54A2F0)
#define UNITYENGINE_MDBCOMPONENT_SETCOLWITHSCENE_OFFSET UNITYSDK_OFFSET(0x1C54A350)
#define UNITYENGINE_MDBCOMPONENT_SETMANUALSTEPENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A110)
#define UNITYENGINE_MDBCOMPONENT_SETMDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1C54A000)
#define UNITYENGINE_MDBCOMPONENT_SETMDBENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A0F0)
#define UNITYENGINE_MDBCOMPONENT_SETMDBLODDISTS_OFFSET UNITYSDK_OFFSET(0x1C54A190)
#define UNITYENGINE_MDBCOMPONENT_SETMDBLOGENABLED_OFFSET UNITYSDK_OFFSET(0x1C54A170)
#define UNITYENGINE_MDBCOMPONENT_SETQUERYSCENE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A370)
#define UNITYENGINE_MDBCOMPONENT_SETQUERYSCENE_OFFSET UNITYSDK_OFFSET(0x1C54A380)
#define UNITYENGINE_MDBCOMPONENT_SETSTEPUNITYBONEENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A140)
#define UNITYENGINE_MDBCOMPONENT_SETSTIFFEXPONENTRATE_OFFSET UNITYSDK_OFFSET(0x1C54A1C0)
#define UNITYENGINE_MDBCOMPONENT_SETTELEPORTUP_OFFSET UNITYSDK_OFFSET(0x1C54A320)
#define UNITYENGINE_MDBCOMPONENT_SETTIMESLOWRATE_OFFSET UNITYSDK_OFFSET(0x1C54A1A0)
#define UNITYENGINE_MDBCOMPONENT_SETTRANSPORT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54A340)
#define UNITYENGINE_MDBCOMPONENT_SETTRANSPORT_OFFSET UNITYSDK_OFFSET(0x1C54A330)
#define UNITYENGINE_MDBCOMPONENT_SET_BLEND2ANIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A500)
#define UNITYENGINE_MDBCOMPONENT_SET_BLEND2SIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A520)
#define UNITYENGINE_MDBCOMPONENT_SET_ENVIRONMENTLODVALUE_OFFSET UNITYSDK_OFFSET(0x1C54A040)
#define UNITYENGINE_MDBCOMPONENT_SET_FORCEUSEAVATARPOSITIONENABLE_OFFSET UNITYSDK_OFFSET(0x1C54A060)
#define UNITYENGINE_MDBCOMPONENT_SET_ISMDBUSESKELETONSCALE_OFFSET UNITYSDK_OFFSET(0x1C54A0A0)
#define UNITYENGINE_MDBCOMPONENT_SET_LAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1C54A4E0)
#define UNITYENGINE_MDBCOMPONENT_SET_MDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1C549FE0)
#define UNITYENGINE_MDBCOMPONENT_SET_MDBCLOTHFLAGS_OFFSET UNITYSDK_OFFSET(0x1C54A020)
#define UNITYENGINE_MDBCOMPONENT_SET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0x1C549FC0)
#define UNITYENGINE_MDBCOMPONENT_SET_SIMBYREFPOSESETUNITSCALE_OFFSET UNITYSDK_OFFSET(0x1C54A080)
#define UNITYENGINE_MDBCOMPONENT_SET_STATEHASHBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1C54A560)
#define UNITYENGINE_MDBCOMPONENT_SET_STATEHASHTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1C54A5C0)
#define UNITYENGINE_MDBCOMPONENT_SET_STATELISTBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1C54A540)
#define UNITYENGINE_MDBCOMPONENT_SET_STATELISTTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1C54A5A0)
#define UNITYENGINE_MDBCOMPONENT_SET_TRANSITEPARAMSECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A580)
#define UNITYENGINE_MDBCOMPONENT_TELEPORT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1C54A310)
#define UNITYENGINE_MDBCOMPONENT_TELEPORT_OFFSET UNITYSDK_OFFSET(0x1C54A300)
#define UNITYENGINE_MDBCOMPONENT_TRANSITECLOTHSTATESECONDS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C54A2A0)
#define UNITYENGINE_MDBCOMPONENT_TRANSITECLOTHSTATESECONDS_OFFSET UNITYSDK_OFFSET(0x1C54A2B0)
#define UNITYENGINE_MDBCOMPONENT_UNITYBONESTEP_OFFSET UNITYSDK_OFFSET(0x1C54A160)
#define UNITYENGINE_MDBCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54A5E0)

namespace UnityEngine
{
	inline static constexpr unsigned int MdbComponent_TypeDefinitionIndex = 37665;
