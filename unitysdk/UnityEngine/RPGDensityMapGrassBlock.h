...
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_CHANGETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EABC0A0)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_GRASSVOLUMEHASINIT_OFFSET UNITYSDK_OFFSET(0x1EABC090)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_REMOVEGRASSVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x1EABC080)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_SETGRASSBLOCKDATA_OFFSET UNITYSDK_OFFSET(0x1EABC070)

namespace UnityEngine
{
	inline static constexpr unsigned int RPGDensityMapGrassBlock_TypeDefinitionIndex = 4280;
