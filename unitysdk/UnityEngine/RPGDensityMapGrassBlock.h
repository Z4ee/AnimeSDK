...
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_CHANGETRANSFORM_OFFSET UNITYSDK_OFFSET(0x18A30D40)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_GRASSVOLUMEHASINIT_OFFSET UNITYSDK_OFFSET(0x18A30D30)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_REMOVEGRASSVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x18A30D20)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_SETGRASSBLOCKDATA_OFFSET UNITYSDK_OFFSET(0x18A30D10)

namespace UnityEngine
{
	inline static constexpr unsigned int RPGDensityMapGrassBlock_TypeDefinitionIndex = 4089;
