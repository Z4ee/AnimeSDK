...
#define UNITYENGINE_HASHUTILITIES_APPENDHASH_OFFSET UNITYSDK_OFFSET(0x1CCC59F0)

namespace UnityEngine
{
	inline static constexpr unsigned int HashUtilities_TypeDefinitionIndex = 4194;
