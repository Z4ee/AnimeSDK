...
#define UNITYENGINE_GRADIENTCOLORKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x392C120)

namespace UnityEngine
{
	inline static constexpr unsigned int GradientColorKey_TypeDefinitionIndex = 4209;
