...
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_CLOSESCOPE_OFFSET UNITYSDK_OFFSET(0x1E423F10)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_GET_HANDLESCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x1E4274F0)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_GET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1E4274D0)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_SET_HANDLESCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x1E427500)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_SET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1E4274E0)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E427510)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayout_ScrollViewScope_TypeDefinitionIndex = 6413;
