...
#define UNITYENGINE_GUISTATEOBJECTS_GETSTATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ACF5E60)
#define UNITYENGINE_GUISTATEOBJECTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACF6040)
#define UNITYENGINE_GUISTATEOBJECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF6030)
