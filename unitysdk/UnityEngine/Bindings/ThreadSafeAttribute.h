...
#define UNITYENGINE_BINDINGS_THREADSAFEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB7EA0)

namespace UnityEngine::Bindings
{
	inline static constexpr unsigned int ThreadSafeAttribute_TypeDefinitionIndex = 3711;
