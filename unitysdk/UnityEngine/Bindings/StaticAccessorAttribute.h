...
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1D3004A0)
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D3004B0)
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D3004D0)
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3004C0)

namespace UnityEngine::Bindings
{
	inline static constexpr unsigned int StaticAccessorAttribute_TypeDefinitionIndex = 3726;
