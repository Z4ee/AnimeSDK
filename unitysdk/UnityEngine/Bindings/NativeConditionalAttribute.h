...
#define UNITYENGINE_BINDINGS_NATIVECONDITIONALATTRIBUTE_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1D2FFFD0)
#define UNITYENGINE_BINDINGS_NATIVECONDITIONALATTRIBUTE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1D2FFFE0)
#define UNITYENGINE_BINDINGS_NATIVECONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FFFF0)

namespace UnityEngine::Bindings
{
	inline static constexpr unsigned int NativeConditionalAttribute_TypeDefinitionIndex = 3711;
