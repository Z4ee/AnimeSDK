...
#define UNITYENGINE_BINDINGS_FREEFUNCTIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18AB78D0)
#define UNITYENGINE_BINDINGS_FREEFUNCTIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18AB7910)
#define UNITYENGINE_BINDINGS_FREEFUNCTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB78B0)

namespace UnityEngine::Bindings
{
	inline static constexpr unsigned int FreeFunctionAttribute_TypeDefinitionIndex = 3710;
