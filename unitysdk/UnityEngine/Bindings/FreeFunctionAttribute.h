...
#define UNITYENGINE_BINDINGS_FREEFUNCTIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D2FFF10)
#define UNITYENGINE_BINDINGS_FREEFUNCTIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D2FFF50)
#define UNITYENGINE_BINDINGS_FREEFUNCTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FFEF0)

namespace UnityEngine::Bindings
{
	inline static constexpr unsigned int FreeFunctionAttribute_TypeDefinitionIndex = 3723;
