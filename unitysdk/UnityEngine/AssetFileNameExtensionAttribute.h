...
#define UNITYENGINE_ASSETFILENAMEEXTENSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3401A0)

namespace UnityEngine
{
	inline static constexpr unsigned int AssetFileNameExtensionAttribute_TypeDefinitionIndex = 3699;
