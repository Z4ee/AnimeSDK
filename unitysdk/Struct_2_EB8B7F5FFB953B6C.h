...
#define STRUCT_2_EB8B7F5FFB953B6C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x78EFE0)
#define STRUCT_2_EB8B7F5FFB953B6C__CTOR_OFFSET UNITYSDK_OFFSET(0x78EFB0)

inline static constexpr unsigned int Struct_2_EB8B7F5FFB953B6C_TypeDefinitionIndex = 73045;

struct alignas(8) Struct_2_EB8B7F5FFB953B6C
{
	::Struct_2_EB8B7F5FFB953B6C_Enum_3_9491FD024FA2BEE6 Field_2_1; // 0x10
	::Struct_2_A47ACAABA9AAFE92 Field_2_0; // 0x18
