...
#define CLASS_3_8BAC80AEEAF1A1E1_METHOD_3_0C75C7D82E97644D_OFFSET UNITYSDK_OFFSET(0x181A0D60)
#define CLASS_3_8BAC80AEEAF1A1E1_METHOD_3_39A9FE040505BFA5_OFFSET UNITYSDK_OFFSET(0x181A0C50)
#define CLASS_3_8BAC80AEEAF1A1E1_METHOD_3_6929C20FCC70C1A3_OFFSET UNITYSDK_OFFSET(0x181A0F10)
#define CLASS_3_8BAC80AEEAF1A1E1_METHOD_3_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x181A0C00)
#define CLASS_3_8BAC80AEEAF1A1E1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x181A0B50)
#define CLASS_3_8BAC80AEEAF1A1E1__CTOR_OFFSET UNITYSDK_OFFSET(0x181A0B20)

inline static constexpr unsigned int Class_3_8BAC80AEEAF1A1E1_TypeDefinitionIndex = 55801;
