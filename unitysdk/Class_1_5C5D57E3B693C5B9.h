...
#define CLASS_1_5C5D57E3B693C5B9_METHOD_1_975B9AC31CF05C24_OFFSET UNITYSDK_OFFSET(0x1C725310)
#define CLASS_1_5C5D57E3B693C5B9__CTOR_OFFSET UNITYSDK_OFFSET(0x1C725440)
...
{
public:
	::System::UInt32 GPIGNHPKFFB; // 0x10
	::RPG::GameCore::TrainPartyStatType LLCOEPJFGPE; // 0x14
