...
#define CLASS_2_B40829637678745E_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x17AC8C80)
#define CLASS_2_B40829637678745E_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x17AC89F0)
#define CLASS_2_B40829637678745E_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x17AC8B80)
#define CLASS_2_B40829637678745E_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x17AC8B70)
#define CLASS_2_B40829637678745E_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x17AC8B60)
#define CLASS_2_B40829637678745E_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x17AC8B50)
#define CLASS_2_B40829637678745E_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x17AC8AF0)
#define CLASS_2_B40829637678745E_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x17AC8B90)
#define CLASS_2_B40829637678745E_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x17AC8B20)
#define CLASS_2_B40829637678745E_METHOD_2_0743268FA10C2E1A_OFFSET UNITYSDK_OFFSET(0x17AC9370)
#define CLASS_2_B40829637678745E_METHOD_2_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x17AC89D0)
#define CLASS_2_B40829637678745E_METHOD_2_6928FDA7FD8C4635_OFFSET UNITYSDK_OFFSET(0x17AC9060)
#define CLASS_2_B40829637678745E_METHOD_2_69EC02E1DE51ED4F_OFFSET UNITYSDK_OFFSET(0x17AC87F0)
#define CLASS_2_B40829637678745E_METHOD_2_7D201B4343E63821_OFFSET UNITYSDK_OFFSET(0x17AC89E0)
#define CLASS_2_B40829637678745E_METHOD_2_A341FDF37ACC0297_OFFSET UNITYSDK_OFFSET(0x17AC9010)
#define CLASS_2_B40829637678745E_METHOD_2_A367EE0F970DCB81_OFFSET UNITYSDK_OFFSET(0x17AC9310)
#define CLASS_2_B40829637678745E_METHOD_2_E1097147727CB840_OFFSET UNITYSDK_OFFSET(0x17AC9180)
#define CLASS_2_B40829637678745E_METHOD_2_E3551E7D9304A0E0_OFFSET UNITYSDK_OFFSET(0x17AC87E0)
#define CLASS_2_B40829637678745E_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0x17AC8F30)
#define CLASS_2_B40829637678745E_METHOD_2_F5BFB4A8F63C3837_OFFSET UNITYSDK_OFFSET(0x17AC9260)
#define CLASS_2_B40829637678745E_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x17AC8FC0)
#define CLASS_2_B40829637678745E_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x17AC9820)
#define CLASS_2_B40829637678745E_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x17AC8BA0)
#define CLASS_2_B40829637678745E__CTOR_OFFSET UNITYSDK_OFFSET(0x17AC8D80)
#define CLASS_2_B40829637678745E__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x17AC8BB0)
#define CLASS_2_B40829637678745E___N__0_OFFSET UNITYSDK_OFFSET(0x17AC98B0)
...
{
public:
	::System::Collections::Generic::HashSet_1<::System::String*>* JMFJDKJMDEB; // 0x78
	::System::String* ONDHIHPPCIL; // 0x80
	::Class_2_B40829637678745E_TextmapDownloadType BHFBPMLALOL; // 0x88
	::System::Boolean _IsEnable_k__BackingField; // 0x8C
	::System::Boolean MGCGBGFALKO; // 0x8D
