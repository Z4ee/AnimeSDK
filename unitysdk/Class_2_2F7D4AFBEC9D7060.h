...
#define CLASS_2_2F7D4AFBEC9D7060_DISPOSE_OFFSET UNITYSDK_OFFSET(0x136940B0)
#define CLASS_2_2F7D4AFBEC9D7060_METHOD_2_F8235938034DB883_OFFSET UNITYSDK_OFFSET(0x13694150)
#define CLASS_2_2F7D4AFBEC9D7060_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13693DD0)
#define CLASS_2_2F7D4AFBEC9D7060_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13694060)
#define CLASS_2_2F7D4AFBEC9D7060_TICK_OFFSET UNITYSDK_OFFSET(0x13693D70)
#define CLASS_2_2F7D4AFBEC9D7060__CTOR_OFFSET UNITYSDK_OFFSET(0x13693D60)

inline static constexpr unsigned int Class_2_2F7D4AFBEC9D7060_TypeDefinitionIndex = 54640;
