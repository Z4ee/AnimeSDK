...
#define CLASS_2_2F7D4AFBEC9D7060_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FDEAD0)
#define CLASS_2_2F7D4AFBEC9D7060_METHOD_2_F8235938034DB883_OFFSET UNITYSDK_OFFSET(0x19FDEB70)
#define CLASS_2_2F7D4AFBEC9D7060_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19FDE760)
#define CLASS_2_2F7D4AFBEC9D7060_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19FDEA80)
#define CLASS_2_2F7D4AFBEC9D7060_TICK_OFFSET UNITYSDK_OFFSET(0x19FDE700)
#define CLASS_2_2F7D4AFBEC9D7060__CTOR_OFFSET UNITYSDK_OFFSET(0x19FDE6F0)

inline static constexpr unsigned int Class_2_2F7D4AFBEC9D7060_TypeDefinitionIndex = 58631;
