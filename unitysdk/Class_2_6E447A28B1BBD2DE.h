...
#define CLASS_2_6E447A28B1BBD2DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87A3F10)
#define CLASS_2_6E447A28B1BBD2DE_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0x87A3A70)
#define CLASS_2_6E447A28B1BBD2DE_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x87A4030)
#define CLASS_2_6E447A28B1BBD2DE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x87A3670)
#define CLASS_2_6E447A28B1BBD2DE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x87A3E70)
#define CLASS_2_6E447A28B1BBD2DE_TICK_OFFSET UNITYSDK_OFFSET(0x87A3FD0)
#define CLASS_2_6E447A28B1BBD2DE__CTOR_OFFSET UNITYSDK_OFFSET(0x87A3650)

inline static constexpr unsigned int Class_2_6E447A28B1BBD2DE_TypeDefinitionIndex = 47060;

class Class_2_6E447A28B1BBD2DE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropFastDeliverInitEntity* Field_2_1; // 0x18
