...
#define CLASS_2_6E447A28B1BBD2DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BADC20)
#define CLASS_2_6E447A28B1BBD2DE_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0x18BAD780)
#define CLASS_2_6E447A28B1BBD2DE_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x18BADD40)
#define CLASS_2_6E447A28B1BBD2DE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18BAD3F0)
#define CLASS_2_6E447A28B1BBD2DE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18BADB80)
#define CLASS_2_6E447A28B1BBD2DE_TICK_OFFSET UNITYSDK_OFFSET(0x18BADCE0)
#define CLASS_2_6E447A28B1BBD2DE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAD3D0)

inline static constexpr unsigned int Class_2_6E447A28B1BBD2DE_TypeDefinitionIndex = 55741;

class Class_2_6E447A28B1BBD2DE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::PropFastDeliverInitEntity* Field_2_1; // 0x20
