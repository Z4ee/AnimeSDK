...
#define CLASS_2_6E447A28B1BBD2DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A086750)
#define CLASS_2_6E447A28B1BBD2DE_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0x1A0862B0)
#define CLASS_2_6E447A28B1BBD2DE_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x1A086870)
#define CLASS_2_6E447A28B1BBD2DE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A085F20)
#define CLASS_2_6E447A28B1BBD2DE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A0866B0)
#define CLASS_2_6E447A28B1BBD2DE_TICK_OFFSET UNITYSDK_OFFSET(0x1A086810)
#define CLASS_2_6E447A28B1BBD2DE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A085F00)

inline static constexpr unsigned int Class_2_6E447A28B1BBD2DE_TypeDefinitionIndex = 58472;

class Class_2_6E447A28B1BBD2DE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropFastDeliverInitEntity* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::UnityEngine::Quaternion IKCHDCCFADG; // 0x28
