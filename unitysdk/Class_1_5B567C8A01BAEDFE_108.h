...
#define CLASS_1_5B567C8A01BAEDFE_108_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D9FDA40)
#define CLASS_1_5B567C8A01BAEDFE_108_CLONE_OFFSET UNITYSDK_OFFSET(0x1D9FD730)
#define CLASS_1_5B567C8A01BAEDFE_108_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D9FD840)
#define CLASS_1_5B567C8A01BAEDFE_108_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D9FD770)
#define CLASS_1_5B567C8A01BAEDFE_108_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D9FD9A0)
#define CLASS_1_5B567C8A01BAEDFE_108_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D9FDA90)
#define CLASS_1_5B567C8A01BAEDFE_108_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D9FDA60)
#define CLASS_1_5B567C8A01BAEDFE_108_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D9FD6B0)
#define CLASS_1_5B567C8A01BAEDFE_108_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D9FD6E0)
#define CLASS_1_5B567C8A01BAEDFE_108_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D9FD9D0)
#define CLASS_1_5B567C8A01BAEDFE_108_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D9FDA30)
#define CLASS_1_5B567C8A01BAEDFE_108__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D9FDAE0)
#define CLASS_1_5B567C8A01BAEDFE_108__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D9FD700)
#define CLASS_1_5B567C8A01BAEDFE_108__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9FD6F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_108_TypeDefinitionIndex = 27642;

class Class_1_5B567C8A01BAEDFE_108 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_108*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_108*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_108_TypeDefinitionIndex)->GetStaticField(0xB310);
	}
