...
#define CLASS_1_63DA08310CA44C51_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0x1540F770)
#define CLASS_1_63DA08310CA44C51_GET_MARKDISABLE_OFFSET UNITYSDK_OFFSET(0x1540CD80)
#define CLASS_1_63DA08310CA44C51_INIT_OFFSET UNITYSDK_OFFSET(0x1540CDA0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x154108E0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_1B8A7D152370AD2C_OFFSET UNITYSDK_OFFSET(0x1540EF20)
#define CLASS_1_63DA08310CA44C51_METHOD_1_1D897375118954FE_OFFSET UNITYSDK_OFFSET(0x15410940)
#define CLASS_1_63DA08310CA44C51_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1540F7B0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_49085A3FC0F13F5E_OFFSET UNITYSDK_OFFSET(0x1540CE40)
#define CLASS_1_63DA08310CA44C51_METHOD_1_5F1978205E005603_OFFSET UNITYSDK_OFFSET(0x1540D460)
#define CLASS_1_63DA08310CA44C51_METHOD_1_5F9F5EB6A660BE4E_OFFSET UNITYSDK_OFFSET(0x1540F820)
#define CLASS_1_63DA08310CA44C51_METHOD_1_75099E32C09384D8_OFFSET UNITYSDK_OFFSET(0x1540F5B0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_862ACF0AE239B7AE_OFFSET UNITYSDK_OFFSET(0x1540E4C0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_920DE8F4A8DAE754_OFFSET UNITYSDK_OFFSET(0x1540E340)
#define CLASS_1_63DA08310CA44C51_METHOD_1_9954350F2A957B60_OFFSET UNITYSDK_OFFSET(0x15410B30)
#define CLASS_1_63DA08310CA44C51_METHOD_1_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0x15410AA0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_A6D2AE0067E9DC62_OFFSET UNITYSDK_OFFSET(0x1540E3A0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_CC324EA2E7C18FE7_OFFSET UNITYSDK_OFFSET(0x1540D5B0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_E0B3448CE3F4D36A_OFFSET UNITYSDK_OFFSET(0x1540D030)
#define CLASS_1_63DA08310CA44C51_METHOD_1_E1C8EBE68635D7A7_OFFSET UNITYSDK_OFFSET(0x1540D4B0)
#define CLASS_1_63DA08310CA44C51_METHOD_1_ED79705457B92B5C_OFFSET UNITYSDK_OFFSET(0x1540D800)
#define CLASS_1_63DA08310CA44C51_REFRESH_OFFSET UNITYSDK_OFFSET(0x1540D8C0)
#define CLASS_1_63DA08310CA44C51_RESET_OFFSET UNITYSDK_OFFSET(0x1540D1B0)
#define CLASS_1_63DA08310CA44C51_SET_MARKDISABLE_OFFSET UNITYSDK_OFFSET(0x1540CD90)
#define CLASS_1_63DA08310CA44C51__CTOR_OFFSET UNITYSDK_OFFSET(0x15410E10)
...
public:
	...
	::System::String* LAIHAJDPHOM; // 0x10
	::UnityEngine::Transform* ONKOKFADPEJ; // 0x18
	::System::String* DLHOPOMAGBC; // 0x20
	::Class_1_D27BF54F25500E5F* DAHGMPIIOLG; // 0x28
	::Class_1_B2388953D46D7EF4* FHMHLIKKEHN; // 0x30
	::Class_1_63DA08310CA44C51_Class_1_0768C4BEC10E6AAD* DEMJAICIJED; // 0x38
	::System::String* MMBFJDEGBAC; // 0x40
	::RPG::Client::CameraFightStateOrbitCruiseConfig* MAFIONBKPIE; // 0x48
	::UnityEngine::Transform* GIDEPKJMFOL; // 0x50
	::UnityEngine::AnimationCurve* PEFMHBKLOOP; // 0x58
	::Class_2_4C3F9D9CF221EFEC* LEOGIKABIGF; // 0x60
	::RPG::Client::CameraDataAndFlags* OMKPPIGCFDN; // 0x68
	::RPG::Client::CameraFightStateOrbitCruiseConfigData* PLGMKBCJCNJ; // 0x70
	::UnityEngine::AnimationCurve* AMJNOIBCKDD; // 0x78
	::UnityEngine::AnimationCurve* JLGFJFBAGAM; // 0x80
	::Class_1_B2388953D46D7EF4* LINIFIIAPKE; // 0x88
	::UnityEngine::Transform* ONCIGDPDCGB; // 0x90
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::AnimationCurve*>* BLNKMOBDNKE; // 0x98
	::UnityEngine::AnimationCurve* BPAHBKCLOJM; // 0xA0
	::UnityEngine::Vector3 ODPPOOABDOG; // 0xA8
	::System::Int32 ELPAHJLJFNG; // 0xB4
	::System::Single PDBHIPPBDME; // 0xB8
	::RPG::MVector3 BKOABKEHEME; // 0xBC
	::System::Boolean CIHBLPAAELI; // 0xC8
	::System::Boolean FIGOAGIKKDP; // 0xC9
	::System::Int32 KCINJMBNMLF; // 0xCC
	::UnityEngine::Quaternion BMHLLLDCLJE; // 0xD0
	::System::Single ODBLHBMPLHK; // 0xE0
	::UnityEngine::Vector3 LMGAAJFMIHC; // 0xE4
	::RPG::MVector3 FGFBOKEMBOJ; // 0xF0
	::System::Single KEAIMOAAFHH; // 0xFC
	::System::Single CHKACACHMAN; // 0x100
	::System::Single DOCGDFKCIEP; // 0x104
	::UnityEngine::Vector3 BNMNCFJIKLL; // 0x108
	::System::Boolean GILPCBPJLFH; // 0x114
	::System::Boolean _MarkDisable_k__BackingField; // 0x115
	::System::Boolean LNBIOGEHMCK; // 0x116
	::System::Boolean IOEGCBCEGKE; // 0x117
	::System::Int32 IENFJPHJHKB; // 0x118
	::UnityEngine::Vector3 HNINLJGANBI; // 0x11C
	::System::Single DGHNMGPGLGE; // 0x128
