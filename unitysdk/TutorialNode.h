...
#define TUTORIALNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xB9A0300)
#define TUTORIALNODE_CLEAR_OFFSET UNITYSDK_OFFSET(0xB9A04C0)
#define TUTORIALNODE_COPYTO_OFFSET UNITYSDK_OFFSET(0xB99F870)
#define TUTORIALNODE_FORCEREGISTER_OFFSET UNITYSDK_OFFSET(0xB9A0080)
#define TUTORIALNODE_GETSHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xB99F8F0)
#define TUTORIALNODE_ITUTORIALNODE_CANBEREPLACEDBY_OFFSET UNITYSDK_OFFSET(0xB99F930)
#define TUTORIALNODE_ITUTORIALNODE_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB99FC80)
#define TUTORIALNODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB9A0690)
#define TUTORIALNODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB9A0840)
#define TUTORIALNODE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xB9A0890)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB9A0920)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB9A08E0)
#define TUTORIALNODE_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xB9A03D0)
#define TUTORIALNODE_SHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xB99F700)
#define TUTORIALNODE_START_OFFSET UNITYSDK_OFFSET(0xB9A0510)
#define TUTORIALNODE_TRYREGISTER_OFFSET UNITYSDK_OFFSET(0xB99FCD0)
#define TUTORIALNODE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xB9A0200)
#define TUTORIALNODE__CHECKPLATFORM_OFFSET UNITYSDK_OFFSET(0xB9A0970)
#define TUTORIALNODE__CONSTRUCTID_OFFSET UNITYSDK_OFFSET(0xB99F7D0)
#define TUTORIALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A0A00)
#define TUTORIALNODE__ISVALID_OFFSET UNITYSDK_OFFSET(0xB99FB70)
#define TUTORIALNODE__SHOULDREGISTER_OFFSET UNITYSDK_OFFSET(0xB99FE60)
