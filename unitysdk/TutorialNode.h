...
#define TUTORIALNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xE98F6C0)
#define TUTORIALNODE_CLEAR_OFFSET UNITYSDK_OFFSET(0xE98F8E0)
#define TUTORIALNODE_COPYTO_OFFSET UNITYSDK_OFFSET(0xE98EB30)
#define TUTORIALNODE_FORCEREGISTER_OFFSET UNITYSDK_OFFSET(0xE98F400)
#define TUTORIALNODE_GETSHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xE98EBB0)
#define TUTORIALNODE_ITUTORIALNODE_CANBEREPLACEDBY_OFFSET UNITYSDK_OFFSET(0xE98EBF0)
#define TUTORIALNODE_ITUTORIALNODE_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE98F000)
#define TUTORIALNODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE98FB10)
#define TUTORIALNODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE98FD30)
#define TUTORIALNODE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xE98FD80)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xE98FE10)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xE98FDD0)
#define TUTORIALNODE_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xE98F7D0)
#define TUTORIALNODE_SHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xE98E9C0)
#define TUTORIALNODE_START_OFFSET UNITYSDK_OFFSET(0xE98F930)
#define TUTORIALNODE_TRYREGISTER_OFFSET UNITYSDK_OFFSET(0xE98F050)
#define TUTORIALNODE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xE98F580)
#define TUTORIALNODE__CHECKPLATFORM_OFFSET UNITYSDK_OFFSET(0xE98FE60)
#define TUTORIALNODE__CONSTRUCTID_OFFSET UNITYSDK_OFFSET(0xE98EA90)
#define TUTORIALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE98FEF0)
#define TUTORIALNODE__ISVALID_OFFSET UNITYSDK_OFFSET(0xE98EEF0)
#define TUTORIALNODE__SHOULDREGISTER_OFFSET UNITYSDK_OFFSET(0xE98F1E0)
