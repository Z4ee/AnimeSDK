...
#define CLASS_1_5B567C8A01BAEDFE_32_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6A3F70)
#define CLASS_1_5B567C8A01BAEDFE_32_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6A3D80)
#define CLASS_1_5B567C8A01BAEDFE_32_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6A3E80)
#define CLASS_1_5B567C8A01BAEDFE_32_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6A3DF0)
#define CLASS_1_5B567C8A01BAEDFE_32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6A3ED0)
#define CLASS_1_5B567C8A01BAEDFE_32_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6A3FC0)
#define CLASS_1_5B567C8A01BAEDFE_32_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6A3F90)
#define CLASS_1_5B567C8A01BAEDFE_32_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A6A3CD0)
#define CLASS_1_5B567C8A01BAEDFE_32_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A6A3D30)
#define CLASS_1_5B567C8A01BAEDFE_32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6A3F00)
#define CLASS_1_5B567C8A01BAEDFE_32_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A6A3F60)
#define CLASS_1_5B567C8A01BAEDFE_32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6A4010)
#define CLASS_1_5B567C8A01BAEDFE_32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6A3D50)
#define CLASS_1_5B567C8A01BAEDFE_32__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A3D40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_32*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_32_TypeDefinitionIndex)->GetStaticField(0x2E790);
	}
