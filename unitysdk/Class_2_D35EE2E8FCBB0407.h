...
#define CLASS_2_D35EE2E8FCBB0407_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14279EE0)
#define CLASS_2_D35EE2E8FCBB0407_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14279F80)
#define CLASS_2_D35EE2E8FCBB0407_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1427A060)
#define CLASS_2_D35EE2E8FCBB0407_TICK_OFFSET UNITYSDK_OFFSET(0x14279F20)
#define CLASS_2_D35EE2E8FCBB0407__CTOR_OFFSET UNITYSDK_OFFSET(0x14279ED0)

inline static constexpr unsigned int Class_2_D35EE2E8FCBB0407_TypeDefinitionIndex = 52650;

class Class_2_D35EE2E8FCBB0407 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SaveModelWhenDead* Field_2_0; // 0x18
