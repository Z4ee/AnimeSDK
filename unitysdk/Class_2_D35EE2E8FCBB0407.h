...
#define CLASS_2_D35EE2E8FCBB0407_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9536E10)
#define CLASS_2_D35EE2E8FCBB0407_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9536EB0)
#define CLASS_2_D35EE2E8FCBB0407_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9536F90)
#define CLASS_2_D35EE2E8FCBB0407_TICK_OFFSET UNITYSDK_OFFSET(0x9536E50)
#define CLASS_2_D35EE2E8FCBB0407__CTOR_OFFSET UNITYSDK_OFFSET(0x9536E00)

inline static constexpr unsigned int Class_2_D35EE2E8FCBB0407_TypeDefinitionIndex = 51976;

class Class_2_D35EE2E8FCBB0407 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SaveModelWhenDead* Field_2_1; // 0x18
