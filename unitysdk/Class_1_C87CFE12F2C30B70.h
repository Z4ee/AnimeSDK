...
#define CLASS_1_C87CFE12F2C30B70__CTOR_OFFSET UNITYSDK_OFFSET(0x1C329130)
...
{
public:
	::RPG::GameCore::FourRotateVoxelCameraDirectionMask IPMHGBLDCHO; // 0x10
	::RPG::GameCore::FourRotateVoxelCameraDirectionMask CFFABBFHHMJ; // 0x14
	::System::Boolean NIOHOMDPPKA; // 0x18
