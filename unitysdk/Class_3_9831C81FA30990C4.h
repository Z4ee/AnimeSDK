...
#define CLASS_3_9831C81FA30990C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17C8DF90)
#define CLASS_3_9831C81FA30990C4__CTOR_OFFSET UNITYSDK_OFFSET(0x17C8DF60)

inline static constexpr unsigned int Class_3_9831C81FA30990C4_TypeDefinitionIndex = 52672;
