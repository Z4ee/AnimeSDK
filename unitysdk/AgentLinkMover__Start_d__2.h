...
#define AGENTLINKMOVER__START_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x140E7980)
#define AGENTLINKMOVER__START_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x140E7CD0)
#define AGENTLINKMOVER__START_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x140E7D30)
#define AGENTLINKMOVER__START_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x140E7CE0)
#define AGENTLINKMOVER__START_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x140E7970)
#define AGENTLINKMOVER__START_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x140E7960)

inline static constexpr unsigned int AgentLinkMover__Start_d__2_TypeDefinitionIndex = 80472;

class AgentLinkMover__Start_d__2 : public ::System::Object
{
public:
	::UnityEngine::AI::NavMeshAgent* _agent_5__2; // 0x10
