...
#define CLASS_2_8C27963A447275B2_DELETEKEY_OFFSET UNITYSDK_OFFSET(0x18339B50)
#define CLASS_2_8C27963A447275B2_FLUSH_OFFSET UNITYSDK_OFFSET(0x18339A80)
#define CLASS_2_8C27963A447275B2_GET_ISPARTIALSAVE_OFFSET UNITYSDK_OFFSET(0x18339C10)
#define CLASS_2_8C27963A447275B2_LOAD_OFFSET UNITYSDK_OFFSET(0x183399B0)
#define CLASS_2_8C27963A447275B2_METHOD_2_7DAF5B3ADF494895_OFFSET UNITYSDK_OFFSET(0x18339C20)
#define CLASS_2_8C27963A447275B2__CTOR_OFFSET UNITYSDK_OFFSET(0x18339980)

inline static constexpr unsigned int Class_2_8C27963A447275B2_TypeDefinitionIndex = 9546;
...
public:
	...
	{
		return (::Class_0_16E4307DCC419505_7**)Il2CppClass::FromTypeDefinitionIndex(Class_2_8C27963A447275B2_TypeDefinitionIndex)->GetStaticField(0x25890);
	}
