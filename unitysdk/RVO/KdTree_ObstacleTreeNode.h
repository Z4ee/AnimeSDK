...
#define RVO_KDTREE_OBSTACLETREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19252A30)

namespace RVO
{
	inline static constexpr unsigned int KdTree_ObstacleTreeNode_TypeDefinitionIndex = 42709;
