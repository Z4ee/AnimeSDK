...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x1DA06650)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x1DA067B0)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x1DA06620)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1DA08C00)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x1DA09B80)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x1DA0CAB0)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1DA066C0)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1DA06730)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x1DA04820)

namespace RVO
{
	inline static constexpr unsigned int RVOMath_TypeDefinitionIndex = 38068;
