...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x85C5F20)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x85C6090)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x85C5EF0)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x85C84E0)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x85C94E0)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x85CBF80)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x85C5FA0)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x85C6010)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x85C4130)

namespace RVO
{
	inline static constexpr unsigned int RVOMath_TypeDefinitionIndex = 35228;
