...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x19681300)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x19681470)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x196812D0)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x19684A10)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x19686370)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x19689800)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x19681380)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x196813F0)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x1967ED30)
