...
#define RVO_KDTREE_BUILDAGENTTREERECURSIVE_OFFSET UNITYSDK_OFFSET(0x1EDB8F40)
#define RVO_KDTREE_BUILDAGENTTREE_OFFSET UNITYSDK_OFFSET(0x1EDB89E0)
#define RVO_KDTREE_BUILDOBSTACLETREERECURSIVE_OFFSET UNITYSDK_OFFSET(0x1EDB99C0)
#define RVO_KDTREE_BUILDOBSTACLETREE_OFFSET UNITYSDK_OFFSET(0x1EDB9480)
#define RVO_KDTREE_COMPUTEAGENTNEIGHBORS_OFFSET UNITYSDK_OFFSET(0x1EDB3650)
#define RVO_KDTREE_COMPUTEOBSTACLENEIGHBORS_OFFSET UNITYSDK_OFFSET(0x1EDB3640)
#define RVO_KDTREE_QUERYAGENTTREERECURSIVE_OFFSET UNITYSDK_OFFSET(0x1EDBAE00)
#define RVO_KDTREE_QUERYOBSTACLETREERECURSIVE_OFFSET UNITYSDK_OFFSET(0x1EDBB1D0)
#define RVO_KDTREE_QUERYVISIBILITYRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1EDBB370)
#define RVO_KDTREE_QUERYVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1EDBB350)
#define RVO_KDTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDBB7D0)

namespace RVO
{
	inline static constexpr unsigned int KdTree_TypeDefinitionIndex = 38723;

	class KdTree : public ::System::Object
	{
	public:
		// static const ::System::Int32 MAX_LEAF_SIZE = 0xA; // 0x0
		::System::Collections::Generic::List_1<::RVO::Agent*>* agents_; // 0x10
		::RVO::KdTree_ObstacleTreeNode* obstacleTree_; // 0x18
		::Il2CppArray<::RVO::KdTree_AgentTreeNode>* agentTree_; // 0x20

		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RVO_KDTREE__CTOR_OFFSET))(this);
		}
