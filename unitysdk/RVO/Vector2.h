...
#define RVO_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1DA06780)
#define RVO_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1DA06750)
#define RVO_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1DA065F0)
#define RVO_VECTOR2_OP_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x1DA09B90)
#define RVO_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1DA06690)
#define RVO_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1DA065C0)
#define RVO_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1DA06670)
#define RVO_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA29380)
#define RVO_VECTOR2_X_OFFSET UNITYSDK_OFFSET(0x45B300)
#define RVO_VECTOR2_Y_OFFSET UNITYSDK_OFFSET(0x40C5C0)
#define RVO_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x48A560)

namespace RVO
{
	inline static constexpr unsigned int Vector2_TypeDefinitionIndex = 38071;
