...
#define RVO_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x85C6060)
#define RVO_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x85C6030)
#define RVO_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x85C5EC0)
#define RVO_VECTOR2_OP_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x85C8670)
#define RVO_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x85C5F60)
#define RVO_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x85C5E90)
#define RVO_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x85C5F40)
#define RVO_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x298C0)
#define RVO_VECTOR2_X_OFFSET UNITYSDK_OFFSET(0xCC60)
#define RVO_VECTOR2_Y_OFFSET UNITYSDK_OFFSET(0xCC80)
#define RVO_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x29890)

namespace RVO
{
	inline static constexpr unsigned int Vector2_TypeDefinitionIndex = 35231;
