...
#define RVO_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xB2E9580)
#define RVO_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0xB2E9550)
#define RVO_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0xB2E93E0)
#define RVO_VECTOR2_OP_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0xB2ECCE0)
#define RVO_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0xB2E9480)
#define RVO_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xB2E93B0)
#define RVO_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0xB2E9460)
#define RVO_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2F470)
#define RVO_VECTOR2_X_OFFSET UNITYSDK_OFFSET(0xD4B0)
#define RVO_VECTOR2_Y_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define RVO_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x2F440)
