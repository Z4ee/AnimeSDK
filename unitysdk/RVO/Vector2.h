...
#define RVO_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19681440)
#define RVO_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x19681410)
#define RVO_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x196812A0)
#define RVO_VECTOR2_OP_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x19684BA0)
#define RVO_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19681340)
#define RVO_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19681270)
#define RVO_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x19681320)
#define RVO_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3AF99E0)
#define RVO_VECTOR2_X_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RVO_VECTOR2_Y_OFFSET UNITYSDK_OFFSET(0x784700)
#define RVO_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9800)

namespace RVO
{
	inline static constexpr unsigned int Vector2_TypeDefinitionIndex = 44903;
