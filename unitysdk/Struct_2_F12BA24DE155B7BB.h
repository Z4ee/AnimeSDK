...
#define STRUCT_2_F12BA24DE155B7BB_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7B9AA0)
#define STRUCT_2_F12BA24DE155B7BB_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7B9A10)
#define STRUCT_2_F12BA24DE155B7BB_METHOD_2_24FE016FD8ACDD68_OFFSET UNITYSDK_OFFSET(0x7B9B30)
#define STRUCT_2_F12BA24DE155B7BB_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7B9B00)

inline static constexpr unsigned int Struct_2_F12BA24DE155B7BB_TypeDefinitionIndex = 75723;

struct alignas(8) Struct_2_F12BA24DE155B7BB
{
	::UnityEngine::Vector3 Field_2_2; // 0x10
	::UnityEngine::Vector3 Field_2_1; // 0x1C
	::Class_1_E795C5D5DDF30620* Field_2_0; // 0x28
