...
#define CLASS_2_FA069ED5DBC1DE00_GET_NEEDLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x180A1D40)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_0127349B4590106C_OFFSET UNITYSDK_OFFSET(0x1809FDB0)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_100C37D9D1141569_OFFSET UNITYSDK_OFFSET(0x180A0050)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_1092C5537716905B_OFFSET UNITYSDK_OFFSET(0x1809FAE0)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_1C6C20AF82FBBC1A_OFFSET UNITYSDK_OFFSET(0x180A1CD0)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_33F4BD9EF41D729C_OFFSET UNITYSDK_OFFSET(0x180A1BC0)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_4795F6BF5D7D71FF_OFFSET UNITYSDK_OFFSET(0x1809FB40)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_53898BC8CD31F230_OFFSET UNITYSDK_OFFSET(0x1809FA40)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_958AC3A3E274189C_OFFSET UNITYSDK_OFFSET(0x180A0EB0)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_96951D035B9FC668_OFFSET UNITYSDK_OFFSET(0x180A1D50)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_A3551A488EF69206_OFFSET UNITYSDK_OFFSET(0x1809F820)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_AE2843A6516AE60E_OFFSET UNITYSDK_OFFSET(0x180A1A50)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_B8A8F4F120B2F6D5_OFFSET UNITYSDK_OFFSET(0x180A0340)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_D66042666006CE8F_OFFSET UNITYSDK_OFFSET(0x180A1300)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_E10F3359B5E0D724_OFFSET UNITYSDK_OFFSET(0x1809FEF0)
#define CLASS_2_FA069ED5DBC1DE00_METHOD_2_F059F72E8C4C7357_OFFSET UNITYSDK_OFFSET(0x1809F5B0)
#define CLASS_2_FA069ED5DBC1DE00_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x1809F540)
#define CLASS_2_FA069ED5DBC1DE00__CTOR_OFFSET UNITYSDK_OFFSET(0x180A1D60)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::MonoEffect*>* AIEFNELIJON; // 0x20
	::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>* AKEAHBIFDHO; // 0x28
	::Class_1_5F51D4049EA87B7B* MELOOHNGEFL; // 0x30
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x38
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* KJCNIKOOJFJ; // 0x40
	::RPG::GameCore::GlobalVisibilityControl* HMPDKCFLOFJ; // 0x48
	::System::Collections::Generic::HashSet_1<::RPG::Client::MonoEffect*>* AHIMHCMJPBB; // 0x50
	::System::Boolean IGNCAIJCMIF; // 0x58
	::System::Boolean PBKFCPEEMON; // 0x59
