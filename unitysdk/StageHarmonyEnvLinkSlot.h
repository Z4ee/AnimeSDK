...
#define STAGEHARMONYENVLINKSLOT_METHOD_2_08C6766056A70BB1_OFFSET UNITYSDK_OFFSET(0x197EA240)
#define STAGEHARMONYENVLINKSLOT_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x197EA0C0)
#define STAGEHARMONYENVLINKSLOT_METHOD_2_326C0E7732FB1BD8_OFFSET UNITYSDK_OFFSET(0x197EA6F0)
#define STAGEHARMONYENVLINKSLOT_METHOD_2_4C516A7087AA1402_OFFSET UNITYSDK_OFFSET(0x197EAEF0)
#define STAGEHARMONYENVLINKSLOT_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x197EB560)
#define STAGEHARMONYENVLINKSLOT_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x197EA200)
#define STAGEHARMONYENVLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x197EB7A0)

inline static constexpr unsigned int StageHarmonyEnvLinkSlot_TypeDefinitionIndex = 48001;
