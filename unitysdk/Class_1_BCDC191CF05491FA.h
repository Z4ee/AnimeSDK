...
#define CLASS_1_BCDC191CF05491FA_GET_CTRLTYPE_OFFSET UNITYSDK_OFFSET(0x17036080)
#define CLASS_1_BCDC191CF05491FA_GET_DISABLECOUNT_OFFSET UNITYSDK_OFFSET(0x17036350)
#define CLASS_1_BCDC191CF05491FA_GET_LASTMANUALREPLACEDSKILL_OFFSET UNITYSDK_OFFSET(0x17036390)
#define CLASS_1_BCDC191CF05491FA_GET_OCCUPYDATA_OFFSET UNITYSDK_OFFSET(0x17036370)
#define CLASS_1_BCDC191CF05491FA_GET_OVERRIDEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x170360A0)
#define CLASS_1_BCDC191CF05491FA_GET_SLOTTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x17036330)
#define CLASS_1_BCDC191CF05491FA_METHOD_1_00977B442F01EE68_OFFSET UNITYSDK_OFFSET(0x170360D0)
#define CLASS_1_BCDC191CF05491FA_METHOD_1_370E7A8BBFC39E77_OFFSET UNITYSDK_OFFSET(0x170363B0)
#define CLASS_1_BCDC191CF05491FA_METHOD_1_46019E40A12B5629_1_OFFSET UNITYSDK_OFFSET(0x17036320)
#define CLASS_1_BCDC191CF05491FA_METHOD_1_46019E40A12B5629_OFFSET UNITYSDK_OFFSET(0x170360C0)
#define CLASS_1_BCDC191CF05491FA_METHOD_1_C97F07D4514E1BDA_OFFSET UNITYSDK_OFFSET(0x17036000)
#define CLASS_1_BCDC191CF05491FA_SET_CTRLTYPE_OFFSET UNITYSDK_OFFSET(0x17036090)
#define CLASS_1_BCDC191CF05491FA_SET_DISABLECOUNT_OFFSET UNITYSDK_OFFSET(0x17036360)
#define CLASS_1_BCDC191CF05491FA_SET_LASTMANUALREPLACEDSKILL_OFFSET UNITYSDK_OFFSET(0x170363A0)
#define CLASS_1_BCDC191CF05491FA_SET_OCCUPYDATA_OFFSET UNITYSDK_OFFSET(0x17036380)
#define CLASS_1_BCDC191CF05491FA_SET_OVERRIDEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x170360B0)
#define CLASS_1_BCDC191CF05491FA_SET_SLOTTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x17036340)
#define CLASS_1_BCDC191CF05491FA__CTOR_OFFSET UNITYSDK_OFFSET(0x17035F50)

inline static constexpr unsigned int Class_1_BCDC191CF05491FA_TypeDefinitionIndex = 55116;

class Class_1_BCDC191CF05491FA : public ::System::Object
{
public:
	::RPG::GameCore::SkillData* _LastManualReplacedSkill_k__BackingField; // 0x10
	::RPG::GameCore::SkillData* Field_1_1; // 0x18
	::Class_1_E0B28F8F3DFBD083* _OccupyData_k__BackingField; // 0x20
	::RPG::GameCore::SkillData* Field_1_3; // 0x28
	::Class_1_DD56E792A2635894* _OverrideProperties_k__BackingField; // 0x30
	::System::String* _SlotTriggerKey_k__BackingField; // 0x38
