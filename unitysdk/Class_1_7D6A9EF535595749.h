...
#define CLASS_1_7D6A9EF535595749_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C52B20)
#define CLASS_1_7D6A9EF535595749_CLONE_OFFSET UNITYSDK_OFFSET(0x19C52780)
#define CLASS_1_7D6A9EF535595749_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C528F0)
#define CLASS_1_7D6A9EF535595749_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C527E0)
#define CLASS_1_7D6A9EF535595749_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C529A0)
#define CLASS_1_7D6A9EF535595749_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C52C60)
#define CLASS_1_7D6A9EF535595749_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C52BC0)
#define CLASS_1_7D6A9EF535595749_METHOD_1_2E179BEDD6B3AA06_OFFSET UNITYSDK_OFFSET(0x19C527D0)
#define CLASS_1_7D6A9EF535595749_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C52610)
#define CLASS_1_7D6A9EF535595749_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C52670)
#define CLASS_1_7D6A9EF535595749_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C52A10)
#define CLASS_1_7D6A9EF535595749_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C52A70)
#define CLASS_1_7D6A9EF535595749__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C52D40)
#define CLASS_1_7D6A9EF535595749__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C526D0)
#define CLASS_1_7D6A9EF535595749__CTOR_OFFSET UNITYSDK_OFFSET(0x19C52680)

inline static constexpr unsigned int Class_1_7D6A9EF535595749_TypeDefinitionIndex = 25060;

class Class_1_7D6A9EF535595749 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Enum_3_DFCB42601400F441>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Enum_3_DFCB42601400F441>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7D6A9EF535595749_TypeDefinitionIndex)->GetStaticField(0x5D7C0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_7D6A9EF535595749*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7D6A9EF535595749*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7D6A9EF535595749_TypeDefinitionIndex)->GetStaticField(0x5D7C8);
	}
	// static const ::System::Int32 Field_1_2 = 0x4; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Enum_3_DFCB42601400F441>* Field_1_4; // 0x10
