...
#define AKPELLEGRINOSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x18BC7020)
#define AKPELLEGRINOSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x18BC7060)
#define AKPELLEGRINOSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18BC6FE0)
#define AKPELLEGRINOSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC6E40)

inline static constexpr unsigned int AkPellegrinoSettings_TypeDefinitionIndex = 34633;
