...
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B9D470)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B9D550)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B9B9B0)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9D450)

inline static constexpr unsigned int AkCallbackManager_MonitoringCallback_TypeDefinitionIndex = 34560;
