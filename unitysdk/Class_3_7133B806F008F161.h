...
#define CLASS_3_7133B806F008F161_DISPOSE_OFFSET UNITYSDK_OFFSET(0x134B73A0)
#define CLASS_3_7133B806F008F161_METHOD_3_40E6AFCB91524816_OFFSET UNITYSDK_OFFSET(0x134B71E0)
#define CLASS_3_7133B806F008F161_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x134B7330)
#define CLASS_3_7133B806F008F161_METHOD_3_6C730A209B06CE53_OFFSET UNITYSDK_OFFSET(0x134B7430)
#define CLASS_3_7133B806F008F161_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x134B7170)
#define CLASS_3_7133B806F008F161_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x134B7290)
#define CLASS_3_7133B806F008F161__CCTOR_OFFSET UNITYSDK_OFFSET(0x134B80E0)
#define CLASS_3_7133B806F008F161__CTOR_OFFSET UNITYSDK_OFFSET(0x134B7140)
#define CLASS_3_7133B806F008F161___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x134B8120)

inline static constexpr unsigned int Class_3_7133B806F008F161_TypeDefinitionIndex = 48850;

class Class_3_7133B806F008F161 : public ::RPG::GameCore::ST_Task_1<::RPG::GameCore::ST_Side_NotifySpecialEvent*>
{
public:
	static ::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>** StaticGet_Field_3_0()
	{
		return (::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_7133B806F008F161_TypeDefinitionIndex)->GetStaticField(0x35150);
	}
