...
#define CLASS_2_3FF31FCCC548366C_GET_SOLOSTANUID_OFFSET UNITYSDK_OFFSET(0xD7EEEE0)
#define CLASS_2_3FF31FCCC548366C_SET_SOLOSTANUID_OFFSET UNITYSDK_OFFSET(0xD7EEEF0)
#define CLASS_2_3FF31FCCC548366C_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7EEE40)
#define CLASS_2_3FF31FCCC548366C__CTOR_OFFSET UNITYSDK_OFFSET(0xD7EEDC0)
#define CLASS_2_3FF31FCCC548366C___IFIXBASEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7EEF00)

inline static constexpr unsigned int Class_2_3FF31FCCC548366C_TypeDefinitionIndex = 60807;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_B8E6D5AD8534D123*))((::PBYTE)hIl2Cpp + CLASS_2_3FF31FCCC548366C___IFIXBASEPROXY_UPDATE_OFFSET))(this, a1);
	}
};
