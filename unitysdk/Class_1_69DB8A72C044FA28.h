...
#define CLASS_1_69DB8A72C044FA28_METHOD_1_81F3FEDEB8077FC5_OFFSET UNITYSDK_OFFSET(0x1C8C8FC0)
#define CLASS_1_69DB8A72C044FA28__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8C9190)
...
public:
	...
	::RPG::GameCore::HipplenEffectType GMPGDEINODK; // 0x20
