...
#define CHARACTERLINELIGHTGROUP_CHECKCHARACTERREGISTED_OFFSET UNITYSDK_OFFSET(0xC73C3D0)
#define CHARACTERLINELIGHTGROUP_GETDISTPURESQR_OFFSET UNITYSDK_OFFSET(0xC73CBD0)
#define CHARACTERLINELIGHTGROUP_GETTYPEID_OFFSET UNITYSDK_OFFSET(0xC73E190)
#define CHARACTERLINELIGHTGROUP_METHOD_6_6F87951B9D486079_OFFSET UNITYSDK_OFFSET(0xC73C6F0)
#define CHARACTERLINELIGHTGROUP_METHOD_6_B55B4025971E9993_OFFSET UNITYSDK_OFFSET(0xC73CEA0)
#define CHARACTERLINELIGHTGROUP_METHOD_6_E8F71E76BFB1CC01_OFFSET UNITYSDK_OFFSET(0xC73CFB0)
#define CHARACTERLINELIGHTGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC73D680)
#define CHARACTERLINELIGHTGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC73D630)
#define CHARACTERLINELIGHTGROUP_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0xC73E2C0)
#define CHARACTERLINELIGHTGROUP_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0xC73E230)
#define CHARACTERLINELIGHTGROUP_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0xC73E3E0)
#define CHARACTERLINELIGHTGROUP_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0xC73E4B0)
#define CHARACTERLINELIGHTGROUP_ONPREUNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xC73E460)
#define CHARACTERLINELIGHTGROUP_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0xC73E280)
#define CHARACTERLINELIGHTGROUP_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xC73E310)
#define CHARACTERLINELIGHTGROUP_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0xC73E420)
#define CHARACTERLINELIGHTGROUP_REGISTERCHARACTER_OFFSET UNITYSDK_OFFSET(0xC73C4A0)
#define CHARACTERLINELIGHTGROUP_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0xC73E1E0)
#define CHARACTERLINELIGHTGROUP_UNREGISTERCHARACTER_OFFSET UNITYSDK_OFFSET(0xC73CA50)
#define CHARACTERLINELIGHTGROUP_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xC73DCA0)
#define CHARACTERLINELIGHTGROUP_UPDATELIGHTINFO_OFFSET UNITYSDK_OFFSET(0xC73D710)
#define CHARACTERLINELIGHTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xC73DC50)
#define CHARACTERLINELIGHTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC73E4F0)

inline static constexpr unsigned int CharacterLineLightGroup_TypeDefinitionIndex = 44755;
...
public:
	...
	{
		return (::CharacterLineLightGroup**)Il2CppClass::FromTypeDefinitionIndex(CharacterLineLightGroup_TypeDefinitionIndex)->GetStaticField(0x2BD80);
	}
