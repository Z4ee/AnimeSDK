...
#define CHARACTERLINELIGHTGROUP_CHECKCHARACTERREGISTED_OFFSET UNITYSDK_OFFSET(0xA6DDEC0)
#define CHARACTERLINELIGHTGROUP_GETDISTPURESQR_OFFSET UNITYSDK_OFFSET(0xA6DE5A0)
#define CHARACTERLINELIGHTGROUP_GETTYPEID_OFFSET UNITYSDK_OFFSET(0xA6DF950)
#define CHARACTERLINELIGHTGROUP_METHOD_6_6FC2E52CEA145F33_OFFSET UNITYSDK_OFFSET(0xA6DE940)
#define CHARACTERLINELIGHTGROUP_METHOD_6_81477A6564EC4E54_OFFSET UNITYSDK_OFFSET(0xA6DE140)
#define CHARACTERLINELIGHTGROUP_METHOD_6_B55B4025971E9993_OFFSET UNITYSDK_OFFSET(0xA6DE830)
#define CHARACTERLINELIGHTGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6DEFF0)
#define CHARACTERLINELIGHTGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA6DEFA0)
#define CHARACTERLINELIGHTGROUP_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0xA6DFA80)
#define CHARACTERLINELIGHTGROUP_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0xA6DF9F0)
#define CHARACTERLINELIGHTGROUP_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0xA6DFB10)
#define CHARACTERLINELIGHTGROUP_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0xA6DFBE0)
#define CHARACTERLINELIGHTGROUP_ONPREUNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xA6DFB90)
#define CHARACTERLINELIGHTGROUP_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0xA6DFA40)
#define CHARACTERLINELIGHTGROUP_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xA6DFAD0)
#define CHARACTERLINELIGHTGROUP_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0xA6DFB50)
#define CHARACTERLINELIGHTGROUP_REGISTERCHARACTER_OFFSET UNITYSDK_OFFSET(0xA6DDF80)
#define CHARACTERLINELIGHTGROUP_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0xA6DF9A0)
#define CHARACTERLINELIGHTGROUP_UNREGISTERCHARACTER_OFFSET UNITYSDK_OFFSET(0xA6DE470)
#define CHARACTERLINELIGHTGROUP_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xA6DF5E0)
#define CHARACTERLINELIGHTGROUP_UPDATELIGHTINFO_OFFSET UNITYSDK_OFFSET(0xA6DF100)
#define CHARACTERLINELIGHTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xA6DF590)
#define CHARACTERLINELIGHTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA6DFC20)

inline static constexpr unsigned int CharacterLineLightGroup_TypeDefinitionIndex = 38325;
...
public:
	...
	{
		return (::CharacterLineLightGroup**)Il2CppClass::FromTypeDefinitionIndex(CharacterLineLightGroup_TypeDefinitionIndex)->GetStaticField(0xE4B0);
	}
