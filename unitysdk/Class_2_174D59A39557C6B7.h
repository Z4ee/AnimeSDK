...
#define CLASS_2_174D59A39557C6B7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBBF3F40)
#define CLASS_2_174D59A39557C6B7_METHOD_2_C42F96818651C435_OFFSET UNITYSDK_OFFSET(0xBBF48F0)
#define CLASS_2_174D59A39557C6B7_METHOD_2_ED09258A28FE7311_OFFSET UNITYSDK_OFFSET(0xBBF46D0)
#define CLASS_2_174D59A39557C6B7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBBF4200)
#define CLASS_2_174D59A39557C6B7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBBF4120)
#define CLASS_2_174D59A39557C6B7_TICK_OFFSET UNITYSDK_OFFSET(0xBBF5260)
#define CLASS_2_174D59A39557C6B7__CTOR_OFFSET UNITYSDK_OFFSET(0xBBF3E00)

inline static constexpr unsigned int Class_2_174D59A39557C6B7_TypeDefinitionIndex = 55574;

class Class_2_174D59A39557C6B7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_6E5B2D66843DE500* AHFMFKILHLP; // 0x18
	::Class_3_07C3C4D2990C49EE* JPIPPJOPJIL; // 0x20
	::Class_3_07C3C4D2990C49EE* BBLAHCCDCDH; // 0x28
	::RPG::GameCore::SetComponentAssetLoadStateWithAnimState* OFKGLJOAMLD; // 0x30
