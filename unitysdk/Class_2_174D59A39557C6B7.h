...
#define CLASS_2_174D59A39557C6B7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CC5320)
#define CLASS_2_174D59A39557C6B7_METHOD_2_C42F96818651C435_OFFSET UNITYSDK_OFFSET(0x19CC5CD0)
#define CLASS_2_174D59A39557C6B7_METHOD_2_ED09258A28FE7311_OFFSET UNITYSDK_OFFSET(0x19CC5AB0)
#define CLASS_2_174D59A39557C6B7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19CC55E0)
#define CLASS_2_174D59A39557C6B7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19CC5500)
#define CLASS_2_174D59A39557C6B7_TICK_OFFSET UNITYSDK_OFFSET(0x19CC6640)
#define CLASS_2_174D59A39557C6B7__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC51E0)
...
{
public:
	::RPG::GameCore::SetComponentAssetLoadStateWithAnimState* OFKGLJOAMLD; // 0x18
	::Class_3_07C3C4D2990C49EE* BBLAHCCDCDH; // 0x20
	::Class_3_6E5B2D66843DE500* AHFMFKILHLP; // 0x28
	::Class_3_07C3C4D2990C49EE* JPIPPJOPJIL; // 0x30
