...
#define CLASS_1_F1EBB8C2BED43B17__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAAD880)
...
{
public:
	::RPG::Client::LittleGame::PixAir::PixAirPlaneStatistics* FJGMOCJKGCG; // 0x10
	::RPG::Client::LittleGame::PixAir::PixAirPlaneStatistics* KKKMOHDHDAK; // 0x18
