...
#define CLASS_2_4141CE0DB087445D_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xB832750)
#define CLASS_2_4141CE0DB087445D_GET_EFFECTSCALE_OFFSET UNITYSDK_OFFSET(0xB832760)
#define CLASS_2_4141CE0DB087445D_METHOD_2_0724EFB1A18E7075_OFFSET UNITYSDK_OFFSET(0xB831FA0)
#define CLASS_2_4141CE0DB087445D_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xB832660)
#define CLASS_2_4141CE0DB087445D_METHOD_2_25FFB847C318CCEC_OFFSET UNITYSDK_OFFSET(0xB831820)
#define CLASS_2_4141CE0DB087445D_METHOD_2_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xB831A50)
#define CLASS_2_4141CE0DB087445D_METHOD_2_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0xB831BB0)
#define CLASS_2_4141CE0DB087445D_METHOD_2_C33AA82B19159619_OFFSET UNITYSDK_OFFSET(0xB8318F0)
#define CLASS_2_4141CE0DB087445D_METHOD_2_C55DD5B612A4F0D5_OFFSET UNITYSDK_OFFSET(0xB831DE0)
#define CLASS_2_4141CE0DB087445D_METHOD_2_F0CA489855D98510_OFFSET UNITYSDK_OFFSET(0xB832030)
#define CLASS_2_4141CE0DB087445D__CTOR_OFFSET UNITYSDK_OFFSET(0xB831620)
...
{
public:
	::RPG::Client::MockAnimator* KPJGAIFEMOM; // 0x70
	::RPG::Client::AttachPointMapping* CDOFEECPCCI; // 0x78
	::Struct_2_0B84ADD7815498A2 PLJMAEJFGAL; // 0x80
	::UnityEngine::Animator* CKDKOONONCG; // 0x90
	::System::String* _EffectPath_k__BackingField; // 0x98
	::System::Single _EffectScale_k__BackingField; // 0xA0
	::System::UInt32 NOPJJBBDMGO; // 0xA4
