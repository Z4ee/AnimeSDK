...
#define CLASS_3_F61F3C9E55A83BDE_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x13909760)
#define CLASS_3_F61F3C9E55A83BDE_METHOD_3_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x139098E0)
#define CLASS_3_F61F3C9E55A83BDE_METHOD_3_61DC8545148AF227_OFFSET UNITYSDK_OFFSET(0x139099D0)
#define CLASS_3_F61F3C9E55A83BDE_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x13909940)
#define CLASS_3_F61F3C9E55A83BDE_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x13909840)
#define CLASS_3_F61F3C9E55A83BDE_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x139098C0)
#define CLASS_3_F61F3C9E55A83BDE_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x13909700)
#define CLASS_3_F61F3C9E55A83BDE__CCTOR_OFFSET UNITYSDK_OFFSET(0x139097B0)
#define CLASS_3_F61F3C9E55A83BDE__CTOR_OFFSET UNITYSDK_OFFSET(0x13909830)

inline static constexpr unsigned int Class_3_F61F3C9E55A83BDE_TypeDefinitionIndex = 79199;

class Class_3_F61F3C9E55A83BDE : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_12 = 0xBF; // 0x0
	::UnityEngine::Transform* Field_3_6; // 0x48
	::Class_2_EA973170E0B2CCF6* Field_3_1; // 0x50
	::MoleMole::UIActivityHotpotFoodItemRightWidgetController* Field_3_8; // 0x58
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* Field_3_5; // 0x60
	::UnityEngine::Collider2D* Field_3_4; // 0x68
	::UnityEngine::Rigidbody2D* Field_3_3; // 0x70
	::UnityEngine::Transform* Field_3_7; // 0x78
	::Class_3_F61F3C9E55A83BDE_Enum_3_57065CF6DA0D68CE Field_3_2; // 0x80
