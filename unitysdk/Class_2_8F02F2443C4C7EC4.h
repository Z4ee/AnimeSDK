...
#define CLASS_2_8F02F2443C4C7EC4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15AF8D40)
#define CLASS_2_8F02F2443C4C7EC4_METHOD_2_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0x15AF8DF0)
#define CLASS_2_8F02F2443C4C7EC4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15AF8D80)
#define CLASS_2_8F02F2443C4C7EC4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15AF90D0)
#define CLASS_2_8F02F2443C4C7EC4_TICK_OFFSET UNITYSDK_OFFSET(0x15AF9130)
#define CLASS_2_8F02F2443C4C7EC4__CTOR_OFFSET UNITYSDK_OFFSET(0x15AF8A60)
...
public:
	...
	::Class_2_F67FF7EB526BF85C* CHAOCFGKDAP; // 0x28
	::Class_2_A0580152EB393340* DIFOMCDONEO; // 0x30
	::RPG::GameCore::AdvNPCAttack* IGHAHBNLIJA; // 0x38
