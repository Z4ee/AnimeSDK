...
#define CLASS_1_B213C739629BB369_METHOD_1_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xCF884F0)
#define CLASS_1_B213C739629BB369_METHOD_1_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xCF88AF0)
#define CLASS_1_B213C739629BB369_METHOD_1_397374046D61F348_OFFSET UNITYSDK_OFFSET(0xCF88E20)
#define CLASS_1_B213C739629BB369_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCF88600)
#define CLASS_1_B213C739629BB369_METHOD_1_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCF88680)
#define CLASS_1_B213C739629BB369_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCF88470)
#define CLASS_1_B213C739629BB369_METHOD_1_4373A28D9DB718D5_OFFSET UNITYSDK_OFFSET(0xCF88200)
#define CLASS_1_B213C739629BB369_METHOD_1_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0xCF8A7E0)
#define CLASS_1_B213C739629BB369_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0xCF88090)
#define CLASS_1_B213C739629BB369_METHOD_1_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0xCF894F0)
#define CLASS_1_B213C739629BB369_METHOD_1_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0xCF89CC0)
#define CLASS_1_B213C739629BB369_METHOD_1_52A3FEDD63707B13_OFFSET UNITYSDK_OFFSET(0xCF8B0C0)
#define CLASS_1_B213C739629BB369_METHOD_1_5892D030B127E82F_OFFSET UNITYSDK_OFFSET(0xCF8A260)
#define CLASS_1_B213C739629BB369_METHOD_1_753A3CECCA76D6CD_OFFSET UNITYSDK_OFFSET(0xCF8A900)
#define CLASS_1_B213C739629BB369_METHOD_1_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0xCF89250)
#define CLASS_1_B213C739629BB369_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xCF893F0)
#define CLASS_1_B213C739629BB369_METHOD_1_797DA3F60D987CC8_OFFSET UNITYSDK_OFFSET(0xCF8AA10)
#define CLASS_1_B213C739629BB369_METHOD_1_7998F8CA1E002410_OFFSET UNITYSDK_OFFSET(0xCF88FC0)
#define CLASS_1_B213C739629BB369_METHOD_1_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0xCF8B210)
#define CLASS_1_B213C739629BB369_METHOD_1_815FA992A09E827B_OFFSET UNITYSDK_OFFSET(0xCF87AB0)
#define CLASS_1_B213C739629BB369_METHOD_1_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0xCF8B160)
#define CLASS_1_B213C739629BB369_METHOD_1_881B6DBFF210C6D0_OFFSET UNITYSDK_OFFSET(0xCF88700)
#define CLASS_1_B213C739629BB369_METHOD_1_899EC372DEC6EBDF_OFFSET UNITYSDK_OFFSET(0xCF8AD50)
#define CLASS_1_B213C739629BB369_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xCF8A4F0)
#define CLASS_1_B213C739629BB369_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xCF899B0)
#define CLASS_1_B213C739629BB369_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xCF8A5B0)
#define CLASS_1_B213C739629BB369_METHOD_1_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0xCF8A610)
#define CLASS_1_B213C739629BB369_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCF8A670)
#define CLASS_1_B213C739629BB369_METHOD_1_9BA775FA6779D988_OFFSET UNITYSDK_OFFSET(0xCF89BB0)
#define CLASS_1_B213C739629BB369_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0xCF89440)
#define CLASS_1_B213C739629BB369_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xCF89760)
#define CLASS_1_B213C739629BB369_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xCF88A50)
#define CLASS_1_B213C739629BB369_METHOD_1_C03CD642451DA289_OFFSET UNITYSDK_OFFSET(0xCF8AF00)
#define CLASS_1_B213C739629BB369_METHOD_1_C11C83AF9E500688_OFFSET UNITYSDK_OFFSET(0xCF88CA0)
#define CLASS_1_B213C739629BB369_METHOD_1_C154350CD1860109_OFFSET UNITYSDK_OFFSET(0xCF8A6D0)
#define CLASS_1_B213C739629BB369_METHOD_1_C2245EC58D417830_OFFSET UNITYSDK_OFFSET(0xCF879F0)
#define CLASS_1_B213C739629BB369_METHOD_1_C5F9823D509784CD_1_OFFSET UNITYSDK_OFFSET(0xCF8ACC0)
#define CLASS_1_B213C739629BB369_METHOD_1_C5F9823D509784CD_OFFSET UNITYSDK_OFFSET(0xCF8B520)
#define CLASS_1_B213C739629BB369_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xCF88DA0)
#define CLASS_1_B213C739629BB369_METHOD_1_CD762BD492FAC131_OFFSET UNITYSDK_OFFSET(0xCF87AC0)
#define CLASS_1_B213C739629BB369_METHOD_1_D7B5D20B6674C9BD_OFFSET UNITYSDK_OFFSET(0xCF87BB0)
#define CLASS_1_B213C739629BB369_METHOD_1_E3092075506D7C0F_OFFSET UNITYSDK_OFFSET(0xCF877D0)
#define CLASS_1_B213C739629BB369_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0xCF89C40)
#define CLASS_1_B213C739629BB369_METHOD_1_F675341C48ED6437_OFFSET UNITYSDK_OFFSET(0xCF89DE0)
#define CLASS_1_B213C739629BB369__CCTOR_OFFSET UNITYSDK_OFFSET(0xCF8B5B0)
#define CLASS_1_B213C739629BB369__CTOR_OFFSET UNITYSDK_OFFSET(0xCF87850)

inline static constexpr unsigned int Class_1_B213C739629BB369_TypeDefinitionIndex = 78641;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B213C739629BB369_TypeDefinitionIndex)->GetStaticField(0x139D0);
	}
	static ::System::Int32* StaticGet_DJJNGGBOPPM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B213C739629BB369_TypeDefinitionIndex)->GetStaticField(0x139D4);
	}
	static ::System::Int32* StaticGet_AOLONKKFAGP()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B213C739629BB369_TypeDefinitionIndex)->GetStaticField(0x139D8);
	}
	static ::System::Int32* StaticGet_IFPLMHIOAPM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B213C739629BB369_TypeDefinitionIndex)->GetStaticField(0x139DC);
	}
	static ::System::Int32* StaticGet_DKJPHIKLIKJ()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B213C739629BB369_TypeDefinitionIndex)->GetStaticField(0x139E0);
	}
	...
	::UnityEngine::Transform* KNDPLAOCEKG; // 0x10
	::UnityEngine::Transform* OFNKMNBNPFB; // 0x18
	::Class_0_16E4307DCC419505_37* MPJPDNHHENK; // 0x20
	::UnityEngine::GameObject* PEDCCCBPFOM; // 0x28
	::UnityEngine::Animator* APPGGMLEPLN; // 0x30
	::UnityEngine::Transform* CEIICMEKDNE; // 0x38
	::RPG::Client::NamedCurve* IHPJAMCDEFP; // 0x40
	::UnityEngine::GameObject* PFFFHDNFGKB; // 0x48
	::System::Action_2<::System::String*, ::UnityEngine::GameObject*>* JEPGOJGADHI; // 0x50
	::RPG::Client::NamedCurve* OOFILFNOJPG; // 0x58
	::UnityEngine::Transform* FONIIPOKFBC; // 0x60
	::RPG::Client::NamedCurve* DKBKFGAJDLJ; // 0x68
	::UnityEngine::GameObject* DMJGAFPPJCB; // 0x70
	::RPG::Client::MonoAnimationTrigger* GOLLNCJAPJC; // 0x78
	::RPG::Client::UIPrefabLoader* HMELCEOFACP; // 0x80
	::System::Single LMINLHJNCPH; // 0x88
	::System::Single JOPEIKFEFLJ; // 0x8C
	::System::Single AADPCFNNGNM; // 0x90
	::UnityEngine::Vector3 CNFABNFAINN; // 0x94
	::System::Single NAGOFNDKGDB; // 0xA0
	::System::Single KOEMDJNFMKI; // 0xA4
	::System::Single EEEOMMJEGCC; // 0xA8
	::System::Single MJFIPPMLHEA; // 0xAC
	::UnityEngine::Vector3 IKKNJMJCDOJ; // 0xB0
	::Class_1_B213C739629BB369_State JJBOPOPCOCH; // 0xBC
	::System::Single HHBAMKJNMDC; // 0xC0
	::System::Single PELGNOEPMEP; // 0xC4
	::UnityEngine::Vector3 MHINNKLHMFJ; // 0xC8
	::System::Single BMOALGGJNCL; // 0xD4
	::System::Single LMMGCJKEHOF; // 0xD8
	::UnityEngine::Vector3 ENMOJPCNPCO; // 0xDC
	::System::Single FNICEFKGJAF; // 0xE8
	::System::Boolean AMJCALKDCDH; // 0xEC
	::System::Boolean ACICALCCILD; // 0xED
	::System::Single NGDEHDOMDGG; // 0xF0
	::UnityEngine::Vector3 KODEKFOLOAC; // 0xF4
	::System::Single BPHIMOFKKGD; // 0x100
	::UnityEngine::Vector3 BMMLIDOCCKB; // 0x104
	::UnityEngine::Vector3 ADGHBKGNONA; // 0x110
	::System::Single KPIGLDIFOAO; // 0x11C
	::System::Single OJPNEIEIHEA; // 0x120
	::System::Single HGAPOBNBKBJ; // 0x124
	::System::Single DMBFACIJPKN; // 0x128
	::System::Single FJDBLCBNNHF; // 0x12C
	::UnityEngine::Vector3 BJNKIKNBFOJ; // 0x130
	::System::Single FNDLONENDNP; // 0x13C
