...
#define CLASS_2_9E6D5A9635426A19_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15813BE0)
#define CLASS_2_9E6D5A9635426A19_METHOD_2_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0x15813C80)
#define CLASS_2_9E6D5A9635426A19_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15813C20)
#define CLASS_2_9E6D5A9635426A19_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15813D30)
#define CLASS_2_9E6D5A9635426A19_TICK_OFFSET UNITYSDK_OFFSET(0x15813D80)
#define CLASS_2_9E6D5A9635426A19__CTOR_OFFSET UNITYSDK_OFFSET(0x15813BD0)

inline static constexpr unsigned int Class_2_9E6D5A9635426A19_TypeDefinitionIndex = 58215;

class Class_2_9E6D5A9635426A19 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::DarkTeamDestroyCheck* OFKGLJOAMLD; // 0x20
