...
#define NAPMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x134623B0)
#define NAPMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x13462540)

inline static constexpr unsigned int NAPMesh_TypeDefinitionIndex = 74843;
