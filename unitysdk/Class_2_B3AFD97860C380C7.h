...
#define CLASS_2_B3AFD97860C380C7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1632AAD0)
#define CLASS_2_B3AFD97860C380C7_METHOD_2_09A10F5CD917CB8F_OFFSET UNITYSDK_OFFSET(0x1632AB20)
#define CLASS_2_B3AFD97860C380C7_METHOD_2_857F27E039AE217B_OFFSET UNITYSDK_OFFSET(0x1632AE20)
#define CLASS_2_B3AFD97860C380C7_METHOD_2_CDA0A9914149BD0D_OFFSET UNITYSDK_OFFSET(0x1632AFC0)
#define CLASS_2_B3AFD97860C380C7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1632AD70)
#define CLASS_2_B3AFD97860C380C7_TICK_OFFSET UNITYSDK_OFFSET(0x1632ADC0)
#define CLASS_2_B3AFD97860C380C7__CTOR_OFFSET UNITYSDK_OFFSET(0x1632AA20)

inline static constexpr unsigned int Class_2_B3AFD97860C380C7_TypeDefinitionIndex = 50915;

class Class_2_B3AFD97860C380C7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::System::Collections::Generic::List_1<::Class_2_B3AFD97860C380C7_Struct_2_7570EC6852BF10B5>* Field_2_1; // 0x20
