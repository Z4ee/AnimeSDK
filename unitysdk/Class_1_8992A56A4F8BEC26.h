...
#define CLASS_1_8992A56A4F8BEC26_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C327080)
#define CLASS_1_8992A56A4F8BEC26_METHOD_1_9DC11DF2AB61C577_OFFSET UNITYSDK_OFFSET(0x1C326E50)
#define CLASS_1_8992A56A4F8BEC26_METHOD_1_A3ABFEB5E06AF4F2_OFFSET UNITYSDK_OFFSET(0x1C327010)
#define CLASS_1_8992A56A4F8BEC26_METHOD_1_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0x1C326F00)
#define CLASS_1_8992A56A4F8BEC26_ONALLOC_OFFSET UNITYSDK_OFFSET(0x1C3270E0)
#define CLASS_1_8992A56A4F8BEC26_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1C327250)
#define CLASS_1_8992A56A4F8BEC26__CTOR_OFFSET UNITYSDK_OFFSET(0x1C327290)

inline static constexpr unsigned int Class_1_8992A56A4F8BEC26_TypeDefinitionIndex = 41693;

class Class_1_8992A56A4F8BEC26 : public ::System::Object
{
public:
	// static const ::RPG::GameCore::FiveDimLoadMode MFKANGBCHBE; // 0x0
	::RPG::PoolDictionary_2<::RPG::Client::LittleGame::FiveDim::ViewLoadModePriorityLevel, ::RPG::GameCore::FiveDimLoadMode>* OIPECOADLEN; // 0x10
	::RPG::GameCore::FiveDimLoadMode COGNMKIMBMA; // 0x18
	::System::Boolean JFIOJNMDIFK; // 0x1C
