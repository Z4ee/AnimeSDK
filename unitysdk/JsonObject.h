...
#define JSONOBJECT_GETBOOL_OFFSET UNITYSDK_OFFSET(0x1D2E93B0)
#define JSONOBJECT_GETCMD_OFFSET UNITYSDK_OFFSET(0x1D2E9050)
#define JSONOBJECT_GETDICTVALUE_OFFSET UNITYSDK_OFFSET(0x1D2E9110)
#define JSONOBJECT_GETENUM_OFFSET UNITYSDK_OFFSET(0x1D2E98D0)
#define JSONOBJECT_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1D2E9660)
#define JSONOBJECT_GETINT_OFFSET UNITYSDK_OFFSET(0x1D2E9510)
#define JSONOBJECT_GETJSONDICT_OFFSET UNITYSDK_OFFSET(0x1D2E9230)
#define JSONOBJECT_GETJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x1D2E9360)
#define JSONOBJECT_GETLISTJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x1D2E9A30)
#define JSONOBJECT_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1D2E97C0)
#define JSONOBJECT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D2E8F60)
#define JSONOBJECT_KEYEXIST_OFFSET UNITYSDK_OFFSET(0x1D2E91B0)
#define JSONOBJECT_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D2E90F0)
#define JSONOBJECT_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D2E8FE0)
#define JSONOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D2E8EE0)
#define JSONOBJECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D2E8F50)
#define JSONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2E8E60)

inline static constexpr unsigned int JsonObject_TypeDefinitionIndex = 39182;
