...
#define CLASS_1_AE0CA897D782D638__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAEFD0)
...
{
public:
	::System::UInt32 NJEJLFDJIGD; // 0x10
	::RPG::Client::LightConeRecommendType GMPGDEINODK; // 0x14
