...
#define CLASS_1_5B567C8A01BAEDFE_45_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195C8C60)
#define CLASS_1_5B567C8A01BAEDFE_45_CLONE_OFFSET UNITYSDK_OFFSET(0x195C8AD0)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195C8B70)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_OFFSET UNITYSDK_OFFSET(0x195C8B10)
#define CLASS_1_5B567C8A01BAEDFE_45_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195C8BC0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195C8CB0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195C8C80)
#define CLASS_1_5B567C8A01BAEDFE_45_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x195C8A50)
#define CLASS_1_5B567C8A01BAEDFE_45_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195C8A80)
#define CLASS_1_5B567C8A01BAEDFE_45_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195C8BF0)
#define CLASS_1_5B567C8A01BAEDFE_45_WRITETO_OFFSET UNITYSDK_OFFSET(0x195C8C50)
#define CLASS_1_5B567C8A01BAEDFE_45__CCTOR_OFFSET UNITYSDK_OFFSET(0x195C8D00)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C8AA0)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_OFFSET UNITYSDK_OFFSET(0x195C8A90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_45_TypeDefinitionIndex = 25387;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_45*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_45_TypeDefinitionIndex)->GetStaticField(0x53EE0);
	}
