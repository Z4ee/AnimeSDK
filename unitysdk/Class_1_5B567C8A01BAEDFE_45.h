...
#define CLASS_1_5B567C8A01BAEDFE_45_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1C3C50)
#define CLASS_1_5B567C8A01BAEDFE_45_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1C3AC0)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1C3B60)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1C3B00)
#define CLASS_1_5B567C8A01BAEDFE_45_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1C3BB0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1C3CA0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1C3C70)
#define CLASS_1_5B567C8A01BAEDFE_45_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1C3A40)
#define CLASS_1_5B567C8A01BAEDFE_45_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1C3A70)
#define CLASS_1_5B567C8A01BAEDFE_45_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1C3BE0)
#define CLASS_1_5B567C8A01BAEDFE_45_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1C3C40)
#define CLASS_1_5B567C8A01BAEDFE_45__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1C3CF0)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1C3A90)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C3A80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_45_TypeDefinitionIndex = 25242;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_45*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_45_TypeDefinitionIndex)->GetStaticField(0x34CA0);
	}
