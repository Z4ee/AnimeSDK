...
#define CLASS_3_25CC4C12F3A3CCC1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x98F5980)
#define CLASS_3_25CC4C12F3A3CCC1__CTOR_OFFSET UNITYSDK_OFFSET(0x98F5950)

inline static constexpr unsigned int Class_3_25CC4C12F3A3CCC1_TypeDefinitionIndex = 50668;
