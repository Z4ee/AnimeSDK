...
#define CLASS_2_3C8C00F3F8D7A848_1_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x894C350)
#define CLASS_2_3C8C00F3F8D7A848_1_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x894C190)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x894C290)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x894C280)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x894C270)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x894C260)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x894C200)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x894C2A0)
#define CLASS_2_3C8C00F3F8D7A848_1_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x894C230)
#define CLASS_2_3C8C00F3F8D7A848_1_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0x894C540)
#define CLASS_2_3C8C00F3F8D7A848_1_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x894C5D0)
#define CLASS_2_3C8C00F3F8D7A848_1_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x894C4B0)
#define CLASS_2_3C8C00F3F8D7A848_1_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x894C2B0)
#define CLASS_2_3C8C00F3F8D7A848_1__CTOR_OFFSET UNITYSDK_OFFSET(0x894C620)
#define CLASS_2_3C8C00F3F8D7A848_1__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x894C2C0)
#define CLASS_2_3C8C00F3F8D7A848_1___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x894C650)
#define CLASS_2_3C8C00F3F8D7A848_1___IFIXBASEPROXY_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x894C660)

inline static constexpr unsigned int Class_2_3C8C00F3F8D7A848_1_TypeDefinitionIndex = 48116;

class Class_2_3C8C00F3F8D7A848_1 : public ::RPG::Client::AbsDownloadData_1<::Class_1_2F498D21FA7A6C62*>
{
public:
	...
	::Class_1_2F498D21FA7A6C62* _LoadIndexInfo(::System::String* a1)
	{
		return ((::Class_1_2F498D21FA7A6C62*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + CLASS_2_3C8C00F3F8D7A848_1__LOADINDEXINFO_OFFSET))(this, a1);
	}
