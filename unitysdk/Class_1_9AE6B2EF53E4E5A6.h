...
#define CLASS_1_9AE6B2EF53E4E5A6_METHOD_1_0EE9A816A5FD11C4_OFFSET UNITYSDK_OFFSET(0xFD9DDC0)
#define CLASS_1_9AE6B2EF53E4E5A6_METHOD_1_8D1A65C30E6983C1_OFFSET UNITYSDK_OFFSET(0xFD9E0B0)
#define CLASS_1_9AE6B2EF53E4E5A6__CCTOR_OFFSET UNITYSDK_OFFSET(0xFD9DDB0)

inline static constexpr unsigned int Class_1_9AE6B2EF53E4E5A6_TypeDefinitionIndex = 77015;
...
public:
	...
	{
		return (::MoleMole::Config::LevelGlobalCounterstrokeConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9AE6B2EF53E4E5A6_TypeDefinitionIndex)->GetStaticField(0x366E0);
	}
