...
#define CRUISEORBITBGCURVEPLUGIN_APPLYARC_OFFSET UNITYSDK_OFFSET(0xE01E9E0)
#define CRUISEORBITBGCURVEPLUGIN_AWAKE_OFFSET UNITYSDK_OFFSET(0xE01CC40)
#define CRUISEORBITBGCURVEPLUGIN_CALCPOSITIONBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xE020190)
#define CRUISEORBITBGCURVEPLUGIN_GETANGLE_OFFSET UNITYSDK_OFFSET(0xE01E4F0)
#define CRUISEORBITBGCURVEPLUGIN_GETCENTERPOS_OFFSET UNITYSDK_OFFSET(0xE01E480)
#define CRUISEORBITBGCURVEPLUGIN_GETCLOSESTONARCPROJECTIONTORAY_OFFSET UNITYSDK_OFFSET(0xE01F530)
#define CRUISEORBITBGCURVEPLUGIN_GETCORRECTEDPOSITION_OFFSET UNITYSDK_OFFSET(0xE01DF00)
#define CRUISEORBITBGCURVEPLUGIN_GETCURRENTRATIO_OFFSET UNITYSDK_OFFSET(0xE0209B0)
#define CRUISEORBITBGCURVEPLUGIN_GETCURRENTSPEED_OFFSET UNITYSDK_OFFSET(0xE020A00)
#define CRUISEORBITBGCURVEPLUGIN_GETDEATHAREASTATE_OFFSET UNITYSDK_OFFSET(0xE01D4D0)
#define CRUISEORBITBGCURVEPLUGIN_GETDEATHAREATYPEBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xE01DA30)
#define CRUISEORBITBGCURVEPLUGIN_GETDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xE01D9E0)
#define CRUISEORBITBGCURVEPLUGIN_GETNEARESTPOSITIONRATIO_OFFSET UNITYSDK_OFFSET(0xE01FC70)
#define CRUISEORBITBGCURVEPLUGIN_GETNEXTSTEPDISTANCEDELTA_OFFSET UNITYSDK_OFFSET(0xE01DC30)
#define CRUISEORBITBGCURVEPLUGIN_GETRAYFROMARCPOSITION_OFFSET UNITYSDK_OFFSET(0xE01DCB0)
#define CRUISEORBITBGCURVEPLUGIN_GETRAYFROMCRICLETOARCPOSITION_OFFSET UNITYSDK_OFFSET(0xE01DD80)
#define CRUISEORBITBGCURVEPLUGIN_GET_FINALPOSITION_OFFSET UNITYSDK_OFFSET(0xE01DE80)
#define CRUISEORBITBGCURVEPLUGIN_GET_RAWPOSITION_OFFSET UNITYSDK_OFFSET(0xE01DE50)
#define CRUISEORBITBGCURVEPLUGIN_ISLEAVINGDEATHAREA_OFFSET UNITYSDK_OFFSET(0xE01DB00)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_0F2AF21BF93699B5_1_OFFSET UNITYSDK_OFFSET(0xE01E900)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_0F2AF21BF93699B5_OFFSET UNITYSDK_OFFSET(0xE01E870)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0xE01EA80)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_AA43C393D46889E6_OFFSET UNITYSDK_OFFSET(0xE01F6D0)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_AAB36E9C15D550EF_OFFSET UNITYSDK_OFFSET(0xE01FEF0)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_CD6C0B4190E9DEBA_OFFSET UNITYSDK_OFFSET(0xE01E990)
#define CRUISEORBITBGCURVEPLUGIN_RECALCULATECURVE_OFFSET UNITYSDK_OFFSET(0xE01CEA0)
#define CRUISEORBITBGCURVEPLUGIN_REINIT_OFFSET UNITYSDK_OFFSET(0xE01C670)
#define CRUISEORBITBGCURVEPLUGIN_SETTRSPARAMS_OFFSET UNITYSDK_OFFSET(0xE020670)
#define CRUISEORBITBGCURVEPLUGIN_SET_RAWPOSITION_OFFSET UNITYSDK_OFFSET(0xE01DE70)
#define CRUISEORBITBGCURVEPLUGIN_TICK_OFFSET UNITYSDK_OFFSET(0xE0202B0)
#define CRUISEORBITBGCURVEPLUGIN_TRANSFERROTATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0xE020810)
#define CRUISEORBITBGCURVEPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xE020A50)
#define CRUISEORBITBGCURVEPLUGIN__FINDNEXTNONDEATHSECTIONSTARTDISTANCE_OFFSET UNITYSDK_OFFSET(0xE01E530)
