...
#define CLASS_2_0F82F67A2A7EDF5B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1195A850)
#define CLASS_2_0F82F67A2A7EDF5B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1195A890)
#define CLASS_2_0F82F67A2A7EDF5B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1195AEF0)
#define CLASS_2_0F82F67A2A7EDF5B_TICK_OFFSET UNITYSDK_OFFSET(0x1195AF40)
#define CLASS_2_0F82F67A2A7EDF5B__CTOR_OFFSET UNITYSDK_OFFSET(0x1195A7A0)

inline static constexpr unsigned int Class_2_0F82F67A2A7EDF5B_TypeDefinitionIndex = 50988;

class Class_2_0F82F67A2A7EDF5B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RemoveEffect* Field_2_0; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::RPG::GameCore::StringHash Field_2_1; // 0x28
