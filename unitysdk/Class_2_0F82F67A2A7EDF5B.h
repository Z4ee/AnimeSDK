...
#define CLASS_2_0F82F67A2A7EDF5B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A6CFD80)
#define CLASS_2_0F82F67A2A7EDF5B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A6CFDC0)
#define CLASS_2_0F82F67A2A7EDF5B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A6D04C0)
#define CLASS_2_0F82F67A2A7EDF5B_TICK_OFFSET UNITYSDK_OFFSET(0x1A6D0510)
#define CLASS_2_0F82F67A2A7EDF5B__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6CFCD0)

inline static constexpr unsigned int Class_2_0F82F67A2A7EDF5B_TypeDefinitionIndex = 55504;

class Class_2_0F82F67A2A7EDF5B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::RemoveEffect* OFKGLJOAMLD; // 0x20
	::RPG::GameCore::StringHash PPKJNOJIJMH; // 0x28
