...
#define CLASS_2_B0DD2738962C64AF_METHOD_2_125AC30F7B145735_OFFSET UNITYSDK_OFFSET(0x1DB7BD20)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1DB7A7D0)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_5323F2DF46A044DA_1_OFFSET UNITYSDK_OFFSET(0x1DB7B990)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1DB7B980)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_7FF36CBC118F3968_OFFSET UNITYSDK_OFFSET(0x1DB7A9A0)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_9313ED03DFEB0BE0_OFFSET UNITYSDK_OFFSET(0x1DB7A350)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x1DB7B9A0)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1DB7BA00)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_E46509D2BC81F8FB_OFFSET UNITYSDK_OFFSET(0x1DB7BA40)
#define CLASS_2_B0DD2738962C64AF_METHOD_2_ECF912AE8CD24448_OFFSET UNITYSDK_OFFSET(0x1DB7A760)
#define CLASS_2_B0DD2738962C64AF__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB7A980)

inline static constexpr unsigned int Class_2_B0DD2738962C64AF_TypeDefinitionIndex = 89476;

class Class_2_B0DD2738962C64AF : public ::Class_1_321489CFFF7B18E7
{
public:
	::Class_4_D02C44FA813EDE0B* Field_2_0; // 0x18
	::Cinemachine::CinemachineBrain* Field_2_1; // 0x20
	::UnityEngine::Transform* Field_2_21; // 0x28
	::UnityEngine::Camera* Field_2_23; // 0x30
	::Cinemachine::CinemachineVirtualCamera* Field_2_12; // 0x38
	::Cinemachine::CinemachineVirtualCamera* Field_2_13; // 0x40
	::Cinemachine::CinemachineTrackedDolly* Field_2_15; // 0x48
	::MoleMole::Arcade::BallsRace::Client::BrCinemachinePath* Field_2_14; // 0x50
	::UnityEngine::Transform* Field_2_22; // 0x58
	::System::Single Field_2_3; // 0x60
	::System::Single Field_2_17; // 0x64
	::System::UInt64 Field_2_9; // 0x68
