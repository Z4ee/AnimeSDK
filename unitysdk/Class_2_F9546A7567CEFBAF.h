...
#define CLASS_2_F9546A7567CEFBAF_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE01EA60)
#define CLASS_2_F9546A7567CEFBAF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE01EAA0)
#define CLASS_2_F9546A7567CEFBAF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE01ED50)
#define CLASS_2_F9546A7567CEFBAF_TICK_OFFSET UNITYSDK_OFFSET(0xE01EDA0)
#define CLASS_2_F9546A7567CEFBAF__CTOR_OFFSET UNITYSDK_OFFSET(0xE01EA50)

inline static constexpr unsigned int Class_2_F9546A7567CEFBAF_TypeDefinitionIndex = 51168;

class Class_2_F9546A7567CEFBAF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetEntityActionState* Field_2_0; // 0x18
