...
#define CLASS_1_E51BBBE8590DBF5E__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A80B0)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::TurnBasedModifierInstance*>* Field_1_0; // 0x10
