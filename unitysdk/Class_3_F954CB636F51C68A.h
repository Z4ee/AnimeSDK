...
#define CLASS_3_F954CB636F51C68A_EVALUATE_OFFSET UNITYSDK_OFFSET(0x16CFE7F0)
#define CLASS_3_F954CB636F51C68A__CTOR_OFFSET UNITYSDK_OFFSET(0x16CFE7C0)

inline static constexpr unsigned int Class_3_F954CB636F51C68A_TypeDefinitionIndex = 50201;
