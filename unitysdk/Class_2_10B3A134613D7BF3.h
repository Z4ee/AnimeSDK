...
#define CLASS_2_10B3A134613D7BF3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x160C1CD0)
#define CLASS_2_10B3A134613D7BF3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x160C1D10)
#define CLASS_2_10B3A134613D7BF3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x160C1FA0)
#define CLASS_2_10B3A134613D7BF3_TICK_OFFSET UNITYSDK_OFFSET(0x160C1FF0)
#define CLASS_2_10B3A134613D7BF3__CTOR_OFFSET UNITYSDK_OFFSET(0x160C1CC0)

inline static constexpr unsigned int Class_2_10B3A134613D7BF3_TypeDefinitionIndex = 53028;

class Class_2_10B3A134613D7BF3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::EnterMap* OFKGLJOAMLD; // 0x20
