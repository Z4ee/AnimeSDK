...
#define CLASS_2_1B921573BBDB64CF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89C7AC0)
#define CLASS_2_1B921573BBDB64CF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x89C7B00)
#define CLASS_2_1B921573BBDB64CF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89C7E20)
#define CLASS_2_1B921573BBDB64CF_TICK_OFFSET UNITYSDK_OFFSET(0x89C7E70)
#define CLASS_2_1B921573BBDB64CF__CTOR_OFFSET UNITYSDK_OFFSET(0x89C7AB0)
#define CLASS_2_1B921573BBDB64CF__ONTASKBEGIN_B__2_0_OFFSET UNITYSDK_OFFSET(0x89C7ED0)

inline static constexpr unsigned int Class_2_1B921573BBDB64CF_TypeDefinitionIndex = 42847;
