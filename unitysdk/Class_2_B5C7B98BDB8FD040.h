...
#define CLASS_2_B5C7B98BDB8FD040_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10630070)
#define CLASS_2_B5C7B98BDB8FD040_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x106300B0)
#define CLASS_2_B5C7B98BDB8FD040_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x106301A0)
#define CLASS_2_B5C7B98BDB8FD040_TICK_OFFSET UNITYSDK_OFFSET(0x106301F0)
#define CLASS_2_B5C7B98BDB8FD040__CTOR_OFFSET UNITYSDK_OFFSET(0x10630060)

inline static constexpr unsigned int Class_2_B5C7B98BDB8FD040_TypeDefinitionIndex = 52705;

class Class_2_B5C7B98BDB8FD040 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowBossInfoBar* Field_2_0; // 0x18
