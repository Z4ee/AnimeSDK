...
#define CLASS_2_B5C7B98BDB8FD040_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9746E20)
#define CLASS_2_B5C7B98BDB8FD040_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9746E60)
#define CLASS_2_B5C7B98BDB8FD040_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9746F50)
#define CLASS_2_B5C7B98BDB8FD040_TICK_OFFSET UNITYSDK_OFFSET(0x9746FA0)
#define CLASS_2_B5C7B98BDB8FD040__CTOR_OFFSET UNITYSDK_OFFSET(0x9746E10)

inline static constexpr unsigned int Class_2_B5C7B98BDB8FD040_TypeDefinitionIndex = 52031;

class Class_2_B5C7B98BDB8FD040 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ShowBossInfoBar* Field_2_0; // 0x20
