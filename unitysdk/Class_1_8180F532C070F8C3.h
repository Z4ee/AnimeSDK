...
#define CLASS_1_8180F532C070F8C3_METHOD_1_0947F577F1E5AE4F_OFFSET UNITYSDK_OFFSET(0x13530500)
#define CLASS_1_8180F532C070F8C3_METHOD_1_8E2C129DE4FC3609_OFFSET UNITYSDK_OFFSET(0x135305F0)
#define CLASS_1_8180F532C070F8C3_METHOD_1_E3F1F4FF7B6F59D2_OFFSET UNITYSDK_OFFSET(0x135307B0)
#define CLASS_1_8180F532C070F8C3_METHOD_1_EAEE3A2A336305B9_OFFSET UNITYSDK_OFFSET(0x135307C0)

inline static constexpr unsigned int Class_1_8180F532C070F8C3_TypeDefinitionIndex = 63469;
...
public:
	...
	{
		return (::MoleMole::Config::ConfigGachaPerformance**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8180F532C070F8C3_TypeDefinitionIndex)->GetStaticField(0x30160);
	}
