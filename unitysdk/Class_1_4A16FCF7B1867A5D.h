...
#define CLASS_1_4A16FCF7B1867A5D_METHOD_1_420B3D21C111D902_OFFSET UNITYSDK_OFFSET(0x9098300)
#define CLASS_1_4A16FCF7B1867A5D_METHOD_1_BD3A93A2A2BAC8E9_OFFSET UNITYSDK_OFFSET(0x9098400)
#define CLASS_1_4A16FCF7B1867A5D_METHOD_1_D9BA312BE2F68B88_OFFSET UNITYSDK_OFFSET(0x9098180)
#define CLASS_1_4A16FCF7B1867A5D_METHOD_1_F7DCEC68D92235A0_OFFSET UNITYSDK_OFFSET(0x9098240)
#define CLASS_1_4A16FCF7B1867A5D__CTOR_OFFSET UNITYSDK_OFFSET(0x9098470)

inline static constexpr unsigned int Class_1_4A16FCF7B1867A5D_TypeDefinitionIndex = 57880;
...
public:
	...
	::System::Boolean Method_1_BD3A93A2A2BAC8E9(::RPG::Client::AvatarData* a1, ::System::UInt32 a2)
	{
		return ((::System::Boolean(*)(::PVOID, ::RPG::Client::AvatarData*, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_1_4A16FCF7B1867A5D_METHOD_1_BD3A93A2A2BAC8E9_OFFSET))(this, a1, a2);
	}
};
