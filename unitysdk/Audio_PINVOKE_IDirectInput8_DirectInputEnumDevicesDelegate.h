...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17461710)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17461770)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x174613D0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x174613B0)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_DirectInputEnumDevicesDelegate_TypeDefinitionIndex = 86138;
