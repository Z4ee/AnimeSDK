...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14B7C4D0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14B7C530)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x14B7C1B0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x14B7C190)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_DirectInputEnumDevicesDelegate_TypeDefinitionIndex = 80177;
