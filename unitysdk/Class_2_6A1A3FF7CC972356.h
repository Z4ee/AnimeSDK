...
#define CLASS_2_6A1A3FF7CC972356_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1675F510)
#define CLASS_2_6A1A3FF7CC972356_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1675F550)
#define CLASS_2_6A1A3FF7CC972356_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1675F790)
#define CLASS_2_6A1A3FF7CC972356_TICK_OFFSET UNITYSDK_OFFSET(0x1675F7E0)
#define CLASS_2_6A1A3FF7CC972356__CTOR_OFFSET UNITYSDK_OFFSET(0x1675F4E0)

inline static constexpr unsigned int Class_2_6A1A3FF7CC972356_TypeDefinitionIndex = 55044;

class Class_2_6A1A3FF7CC972356 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdventureStackProperty* OFKGLJOAMLD; // 0x18
