...
#define CLASS_2_6A1A3FF7CC972356_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11E7A260)
#define CLASS_2_6A1A3FF7CC972356_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11E7A2A0)
#define CLASS_2_6A1A3FF7CC972356_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11E7A4B0)
#define CLASS_2_6A1A3FF7CC972356_TICK_OFFSET UNITYSDK_OFFSET(0x11E7A500)
#define CLASS_2_6A1A3FF7CC972356__CTOR_OFFSET UNITYSDK_OFFSET(0x11E7A230)

inline static constexpr unsigned int Class_2_6A1A3FF7CC972356_TypeDefinitionIndex = 50595;

class Class_2_6A1A3FF7CC972356 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::AdventureStackProperty* Field_2_0; // 0x20
