...
#define CLASS_2_6A1A3FF7CC972356_DISPOSE_OFFSET UNITYSDK_OFFSET(0x113737B0)
#define CLASS_2_6A1A3FF7CC972356_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x113737F0)
#define CLASS_2_6A1A3FF7CC972356_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11373A00)
#define CLASS_2_6A1A3FF7CC972356_TICK_OFFSET UNITYSDK_OFFSET(0x11373A50)
#define CLASS_2_6A1A3FF7CC972356__CTOR_OFFSET UNITYSDK_OFFSET(0x11373780)

inline static constexpr unsigned int Class_2_6A1A3FF7CC972356_TypeDefinitionIndex = 43895;

class Class_2_6A1A3FF7CC972356 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdventureStackProperty* Field_2_0; // 0x18
