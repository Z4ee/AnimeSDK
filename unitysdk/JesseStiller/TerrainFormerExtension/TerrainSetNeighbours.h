...
#define JESSESTILLER_TERRAINFORMEREXTENSION_TERRAINSETNEIGHBOURS_AWAKE_OFFSET UNITYSDK_OFFSET(0x84B2490)
#define JESSESTILLER_TERRAINFORMEREXTENSION_TERRAINSETNEIGHBOURS_SETNEIGHBOURS_OFFSET UNITYSDK_OFFSET(0x84B2560)
#define JESSESTILLER_TERRAINFORMEREXTENSION_TERRAINSETNEIGHBOURS__CTOR_OFFSET UNITYSDK_OFFSET(0x84B2580)

namespace JesseStiller::TerrainFormerExtension
{
	inline static constexpr unsigned int TerrainSetNeighbours_TypeDefinitionIndex = 35159;
