...
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x168915D0)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16891770)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16891700)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x168917F0)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16891760)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16891710)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x168915C0)
#define CLASS_1_FBFA092366368ABD___USEACTIONEVENT_D__74__CTOR_OFFSET UNITYSDK_OFFSET(0x1688A1D0)

inline static constexpr unsigned int Class_1_FBFA092366368ABD___UseActionEvent_d__74_TypeDefinitionIndex = 56911;

class Class_1_FBFA092366368ABD___UseActionEvent_d__74 : public ::System::Object
{
public:
	::Class_1_C530CE1C0A4E2133* actionEvent; // 0x10
	::Class_1_C530CE1C0A4E2133* __3__actionEvent; // 0x18
	::System::Object* __2__current; // 0x20
	::Class_1_FBFA092366368ABD* __4__this; // 0x28
	::System::String* _lastEventName_5__2; // 0x30
