...
#define CLASS_1_68EB032547196D7A_GET_BATTLEID_OFFSET UNITYSDK_OFFSET(0x1594D0E0)
#define CLASS_1_68EB032547196D7A_GET_ENEMYINFO_OFFSET UNITYSDK_OFFSET(0x1594D100)
#define CLASS_1_68EB032547196D7A_METHOD_1_0D62FC38CC5C1E0E_OFFSET UNITYSDK_OFFSET(0x1594CF50)
#define CLASS_1_68EB032547196D7A_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x1594CFF0)
#define CLASS_1_68EB032547196D7A_SET_BATTLEID_OFFSET UNITYSDK_OFFSET(0x1594D0F0)
#define CLASS_1_68EB032547196D7A_SET_ENEMYINFO_OFFSET UNITYSDK_OFFSET(0x1594D110)
#define CLASS_1_68EB032547196D7A__CTOR_OFFSET UNITYSDK_OFFSET(0x1594CFE0)

inline static constexpr unsigned int Class_1_68EB032547196D7A_TypeDefinitionIndex = 78729;

class Class_1_68EB032547196D7A : public ::System::Object
{
public:
	::Class_1_B357CAB772B661F4* _EnemyInfo_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::System::UInt32>* PLDMJFJLABD; // 0x18
