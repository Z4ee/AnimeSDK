...
#define CLASS_2_A792BB84C3272CCF_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC40BE50)
#define CLASS_2_A792BB84C3272CCF_METHOD_2_3CAD92CFB876DBF6_1_OFFSET UNITYSDK_OFFSET(0xC40BFC0)
#define CLASS_2_A792BB84C3272CCF_METHOD_2_3CAD92CFB876DBF6_OFFSET UNITYSDK_OFFSET(0xC40C640)
#define CLASS_2_A792BB84C3272CCF_METHOD_2_5D9646F4A7309CF6_OFFSET UNITYSDK_OFFSET(0xC40C8A0)
#define CLASS_2_A792BB84C3272CCF_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xC40C400)
#define CLASS_2_A792BB84C3272CCF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC40C520)
#define CLASS_2_A792BB84C3272CCF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC40C740)
#define CLASS_2_A792BB84C3272CCF_TICK_OFFSET UNITYSDK_OFFSET(0xC40C0C0)
#define CLASS_2_A792BB84C3272CCF__CTOR_OFFSET UNITYSDK_OFFSET(0xC40BC20)
...
{
public:
	::Class_1_5F51D4049EA87B7B* HFGKBOHJHGA; // 0x18
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x20
	::RPG::GameCore::NPCComponent* KDJMBIPEAFM; // 0x28
	::Class_2_F67FF7EB526BF85C* IIPADCNLMCJ; // 0x30
	::RPG::GameCore::AdvNpcGuardAlertDeviceInactive* IGHAHBNLIJA; // 0x38
	::Class_1_5F51D4049EA87B7B* MOPJBEJPKBO; // 0x40
