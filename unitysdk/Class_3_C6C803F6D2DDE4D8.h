...
#define CLASS_3_C6C803F6D2DDE4D8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x116ACD40)
#define CLASS_3_C6C803F6D2DDE4D8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x116ACD70)
#define CLASS_3_C6C803F6D2DDE4D8_INVOKE_OFFSET UNITYSDK_OFFSET(0x116AC7F0)
#define CLASS_3_C6C803F6D2DDE4D8__CTOR_OFFSET UNITYSDK_OFFSET(0x116AC7D0)

inline static constexpr unsigned int Class_3_C6C803F6D2DDE4D8_TypeDefinitionIndex = 63492;
