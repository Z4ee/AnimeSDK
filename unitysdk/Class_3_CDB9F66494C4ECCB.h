...
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x14EAF790)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x14EAFB20)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14EAF980)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14EAFAA0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_77EA5BCD93BD96AE_OFFSET UNITYSDK_OFFSET(0x14EB0030)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_866057E5772343C9_1_OFFSET UNITYSDK_OFFSET(0x14EB11E0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_866057E5772343C9_OFFSET UNITYSDK_OFFSET(0x14EB1090)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_9C3D8ED2211D368B_OFFSET UNITYSDK_OFFSET(0x14EB0330)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_BCC1EE49EAAACF06_OFFSET UNITYSDK_OFFSET(0x14EB0800)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x14EB0E50)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x14EB0EE0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x14EB0F70)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x14EB1000)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_5_OFFSET UNITYSDK_OFFSET(0x14EB1150)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14EB0620)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0x14EB00D0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_DB4B43E60DCCA4C1_OFFSET UNITYSDK_OFFSET(0x14EB0760)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_DF36652FF6AEAAC1_OFFSET UNITYSDK_OFFSET(0x14EB06B0)
#define CLASS_3_CDB9F66494C4ECCB__CCTOR_OFFSET UNITYSDK_OFFSET(0x14EB05E0)
#define CLASS_3_CDB9F66494C4ECCB__CTOR_OFFSET UNITYSDK_OFFSET(0x14EB03E0)

inline static constexpr unsigned int Class_3_CDB9F66494C4ECCB_TypeDefinitionIndex = 82665;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_3_CDB9F66494C4ECCB_TypeDefinitionIndex)->GetStaticField(0x429E0);
	}
	::Class_2_04999CCE6E77B4A2_14* Field_3_1; // 0x70
	::Cysharp::Threading::Tasks::UniTask Field_3_8; // 0x78
	::System::Collections::Generic::List_1<::Struct_2_3C85541F28E72E6B>* Field_3_4; // 0x88
	::System::Threading::CancellationTokenSource* Field_3_7; // 0x90
	::System::Collections::Generic::List_1<::MoleMole::TurnBattleUnitBase*>* Field_3_2; // 0x98
	::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>* Field_3_9; // 0xA0
	::Class_4_3D4EFA6B3CC691CC* Field_3_6; // 0xA8
	::System::Collections::Generic::List_1<::Struct_2_3C85541F28E72E6B>* Field_3_5; // 0xB0
	::System::Collections::Generic::List_1<::System::Collections::Generic::KeyValuePair_2<::MoleMole::UIMonsterFantasyRoleItemWidgetController*, ::System::String*>>* Field_3_10; // 0xB8
	::System::Collections::Generic::List_1<::MoleMole::TurnBattleUnitBase*>* Field_3_3; // 0xC0
