...
#define CLASS_2_C559AE27124C0384_DISPOSE_OFFSET UNITYSDK_OFFSET(0x115B8AB0)
#define CLASS_2_C559AE27124C0384_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x115B8B50)
#define CLASS_2_C559AE27124C0384_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x115B8BC0)
#define CLASS_2_C559AE27124C0384_TICK_OFFSET UNITYSDK_OFFSET(0x115B8AF0)
#define CLASS_2_C559AE27124C0384__CTOR_OFFSET UNITYSDK_OFFSET(0x115B8AA0)

inline static constexpr unsigned int Class_2_C559AE27124C0384_TypeDefinitionIndex = 47173;

class Class_2_C559AE27124C0384 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::RogueShowSelectMainPage* Field_2_0; // 0x20
