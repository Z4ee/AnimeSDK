...
#define CLASS_1_8A4A4C3873C3F337_GET_BLOCKNEW_OFFSET UNITYSDK_OFFSET(0xBBB5CE0)
#define CLASS_1_8A4A4C3873C3F337_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xBBB5B20)
#define CLASS_1_8A4A4C3873C3F337_METHOD_1_558C32A1B130B607_OFFSET UNITYSDK_OFFSET(0xBBB5BF0)
#define CLASS_1_8A4A4C3873C3F337_METHOD_1_AFF42269B55377F5_OFFSET UNITYSDK_OFFSET(0xBBB5930)
#define CLASS_1_8A4A4C3873C3F337_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xBBB5A90)
#define CLASS_1_8A4A4C3873C3F337_SET_BLOCKNEW_OFFSET UNITYSDK_OFFSET(0xBBB5CF0)
#define CLASS_1_8A4A4C3873C3F337__CTOR_OFFSET UNITYSDK_OFFSET(0xBBB5D00)

inline static constexpr unsigned int Class_1_8A4A4C3873C3F337_TypeDefinitionIndex = 60797;
...
public:
	...
	::System::Boolean OCCIFHOEJMI; // 0x19
