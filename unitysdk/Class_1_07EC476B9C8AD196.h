...
#define CLASS_1_07EC476B9C8AD196__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE33150)
...
public:
	...
	::System::Int32 NMOKIHDMMNG; // 0x18
	::RPG::GameCore::PixAirSlotType MPADIDFJBEF; // 0x1C
	::RPG::GameCore::PixAirEnchantmentType CCBIIDDBFGK; // 0x20
	::System::Int32 NPHAJEKCBKF; // 0x24
	::System::Int32 NBFOFKGNNIO; // 0x28
	::System::Boolean HGEOCDHCKFN; // 0x2C
	::System::Boolean NCCJHHCGFHF; // 0x2D
	::RPG::Client::LittleGame::PixAir::PixAirEquipmentState MEPFOEEGBEA; // 0x30
	::System::UInt32 AAGKEBFHLMC; // 0x34
	::System::Int32 EEFIPNFMELC; // 0x38
