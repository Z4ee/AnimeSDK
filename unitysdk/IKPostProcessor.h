...
#define IKPOSTPROCESSOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x143E1D90)
#define IKPOSTPROCESSOR_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x143E2650)
#define IKPOSTPROCESSOR_ONLATEANIMAGEIK_OFFSET UNITYSDK_OFFSET(0x143E2730)
#define IKPOSTPROCESSOR_START_OFFSET UNITYSDK_OFFSET(0x143E1C40)
#define IKPOSTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x143E2CE0)

inline static constexpr unsigned int IKPostProcessor_TypeDefinitionIndex = 59217;
