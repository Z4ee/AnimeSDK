...
#define AKAMBIENT_BUILDAKPOSITIONARRAY_OFFSET UNITYSDK_OFFSET(0x18B8B0E0)
#define AKAMBIENT_BUILDMULTIDIRECTIONARRAY_OFFSET UNITYSDK_OFFSET(0x18B8A820)
#define AKAMBIENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18B8BAE0)
#define AKAMBIENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18B8B840)
#define AKAMBIENT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x18B8C220)
#define AKAMBIENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18B8A370)
#define AKAMBIENT_START_OFFSET UNITYSDK_OFFSET(0x18B8AD90)
#define AKAMBIENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B8C870)
#define AKAMBIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8C730)
#define AKAMBIENT___IFIXBASEPROXY_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18B8C9C0)
#define AKAMBIENT___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18B8C910)
#define AKAMBIENT___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18B8C9B0)

inline static constexpr unsigned int AkAmbient_TypeDefinitionIndex = 34645;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::AkMultiPosEvent*>**)Il2CppClass::FromTypeDefinitionIndex(AkAmbient_TypeDefinitionIndex)->GetStaticField(0x300F0);
	}
