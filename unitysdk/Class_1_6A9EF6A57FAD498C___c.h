...
#define CLASS_1_6A9EF6A57FAD498C___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC407360)
#define CLASS_1_6A9EF6A57FAD498C___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC4073A0)
#define CLASS_1_6A9EF6A57FAD498C___C__GETPLAYERUIDS_B__15_0_OFFSET UNITYSDK_OFFSET(0xC4073B0)
...
public:
	...
	{
		return (::System::Func_2<::RPG::Client::FightPlayer*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6A9EF6A57FAD498C___c_TypeDefinitionIndex)->GetStaticField(0x58E30);
	}
	static ::Class_1_6A9EF6A57FAD498C___c** StaticGet___9()
	{
		return (::Class_1_6A9EF6A57FAD498C___c**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6A9EF6A57FAD498C___c_TypeDefinitionIndex)->GetStaticField(0x58E38);
	}
