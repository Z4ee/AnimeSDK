...
#define CLASS_1_5B567C8A01BAEDFE_131_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A26B7D0)
#define CLASS_1_5B567C8A01BAEDFE_131_CLONE_OFFSET UNITYSDK_OFFSET(0x1A26B5E0)
#define CLASS_1_5B567C8A01BAEDFE_131_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A26B6E0)
#define CLASS_1_5B567C8A01BAEDFE_131_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A26B650)
#define CLASS_1_5B567C8A01BAEDFE_131_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A26B730)
#define CLASS_1_5B567C8A01BAEDFE_131_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A26B820)
#define CLASS_1_5B567C8A01BAEDFE_131_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A26B7F0)
#define CLASS_1_5B567C8A01BAEDFE_131_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A26B530)
#define CLASS_1_5B567C8A01BAEDFE_131_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A26B590)
#define CLASS_1_5B567C8A01BAEDFE_131_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A26B760)
#define CLASS_1_5B567C8A01BAEDFE_131_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A26B7C0)
#define CLASS_1_5B567C8A01BAEDFE_131__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A26B870)
#define CLASS_1_5B567C8A01BAEDFE_131__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A26B5B0)
#define CLASS_1_5B567C8A01BAEDFE_131__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26B5A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_131_TypeDefinitionIndex = 27086;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_131*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_131_TypeDefinitionIndex)->GetStaticField(0x45DC0);
	}
