...
#define CLASS_2_D9360773B5A9CAB3_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF3D4260)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_44D54B0829C8FEF6_OFFSET UNITYSDK_OFFSET(0xF3D46E0)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_CB430037C6C53563_OFFSET UNITYSDK_OFFSET(0xF3D47A0)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0xF3D43B0)
#define CLASS_2_D9360773B5A9CAB3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF3D4300)
#define CLASS_2_D9360773B5A9CAB3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xF3D4750)
#define CLASS_2_D9360773B5A9CAB3_TICK_OFFSET UNITYSDK_OFFSET(0xF3D42A0)
#define CLASS_2_D9360773B5A9CAB3__CTOR_OFFSET UNITYSDK_OFFSET(0xF3D4250)
...
public:
	...
	::RPG::GameCore::TeamAction* OFKGLJOAMLD; // 0x20
