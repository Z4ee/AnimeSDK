...
#define CLASS_1_5B567C8A01BAEDFE_39_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CC8BB00)
#define CLASS_1_5B567C8A01BAEDFE_39_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC8B7A0)
#define CLASS_1_5B567C8A01BAEDFE_39_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CC8B900)
#define CLASS_1_5B567C8A01BAEDFE_39_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC8B810)
#define CLASS_1_5B567C8A01BAEDFE_39_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC8BA60)
#define CLASS_1_5B567C8A01BAEDFE_39_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CC8BB50)
#define CLASS_1_5B567C8A01BAEDFE_39_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CC8BB20)
#define CLASS_1_5B567C8A01BAEDFE_39_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1CC8B6F0)
#define CLASS_1_5B567C8A01BAEDFE_39_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CC8B750)
#define CLASS_1_5B567C8A01BAEDFE_39_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC8BA90)
#define CLASS_1_5B567C8A01BAEDFE_39_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CC8BAF0)
#define CLASS_1_5B567C8A01BAEDFE_39__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC8BBA0)
#define CLASS_1_5B567C8A01BAEDFE_39__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC8B770)
#define CLASS_1_5B567C8A01BAEDFE_39__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC8B760)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_39_TypeDefinitionIndex = 25689;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_39*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_39_TypeDefinitionIndex)->GetStaticField(0x5E1D0);
	}
