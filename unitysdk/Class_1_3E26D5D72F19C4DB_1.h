...
#define CLASS_1_3E26D5D72F19C4DB_1_GET_FACTORY_OFFSET UNITYSDK_OFFSET(0x18383310)
#define CLASS_1_3E26D5D72F19C4DB_1_METHOD_1_4D5BEDC75B4151A4_OFFSET UNITYSDK_OFFSET(0x18383330)
#define CLASS_1_3E26D5D72F19C4DB_1_METHOD_1_DDD01EA0C1E2DD26_OFFSET UNITYSDK_OFFSET(0x183834D0)
#define CLASS_1_3E26D5D72F19C4DB_1_SET_FACTORY_OFFSET UNITYSDK_OFFSET(0x18383320)
#define CLASS_1_3E26D5D72F19C4DB_1__CTOR_OFFSET UNITYSDK_OFFSET(0x18383450)

inline static constexpr unsigned int Class_1_3E26D5D72F19C4DB_1_TypeDefinitionIndex = 62816;

class Class_1_3E26D5D72F19C4DB_1 : public ::System::Object
{
public:
	::Class_1_27D7C9B1E553F802* _Factory_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::Struct_2_276321B6B122C69C, ::Class_1_C85C4DAB350DD5FC*>* BFFMOHNLAMI; // 0x18
