...
#define MONOUITABLESCROLLV2_SCROLLTOTARGETRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x15B27D60)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x830520)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETRESULT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x830530)

inline static constexpr unsigned int MonoUITableScrollV2_ScrollToTargetResult_TypeDefinitionIndex = 75010;
