...
#define CLASS_3_F1A485BFEEAD6208_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A5AD90)
#define CLASS_3_F1A485BFEEAD6208_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A5AE50)
#define CLASS_3_F1A485BFEEAD6208_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A5AD60)
#define CLASS_3_F1A485BFEEAD6208__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5ACF0)

inline static constexpr unsigned int Class_3_F1A485BFEEAD6208_TypeDefinitionIndex = 34330;
