...
#define CLASS_2_D394967596A28314_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1629D6B0)
#define CLASS_2_D394967596A28314_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1629D750)
#define CLASS_2_D394967596A28314_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1629D940)
#define CLASS_2_D394967596A28314_TICK_OFFSET UNITYSDK_OFFSET(0x1629D6F0)
#define CLASS_2_D394967596A28314__CTOR_OFFSET UNITYSDK_OFFSET(0x1629D6A0)

inline static constexpr unsigned int Class_2_D394967596A28314_TypeDefinitionIndex = 53330;

class Class_2_D394967596A28314 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::ParkourGameSetCameraFOV* IGHAHBNLIJA; // 0x20
