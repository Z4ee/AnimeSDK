...
#define MONOEFFECTINSTANCERENDERER_ADDCOLORVAL_OFFSET UNITYSDK_OFFSET(0x1C425DA0)
#define MONOEFFECTINSTANCERENDERER_ADDFLOATVAL_OFFSET UNITYSDK_OFFSET(0x1C425BF0)
#define MONOEFFECTINSTANCERENDERER_ADDVEC4VAL_OFFSET UNITYSDK_OFFSET(0x1C425CC0)
#define MONOEFFECTINSTANCERENDERER_CALCULATEFRAMEINDICES_OFFSET UNITYSDK_OFFSET(0x1C4249C0)
#define MONOEFFECTINSTANCERENDERER_CLEARBATCHES_OFFSET UNITYSDK_OFFSET(0x1C4248C0)
#define MONOEFFECTINSTANCERENDERER_CLEARVALMAP_OFFSET UNITYSDK_OFFSET(0x1C425AE0)
#define MONOEFFECTINSTANCERENDERER_ENSUREBATCHCAPACITY_OFFSET UNITYSDK_OFFSET(0x1C424AB0)
#define MONOEFFECTINSTANCERENDERER_GETRENDERBATCHES_OFFSET UNITYSDK_OFFSET(0x1C425AA0)
#define MONOEFFECTINSTANCERENDERER_GET_ANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x1C423F70)
#define MONOEFFECTINSTANCERENDERER_GET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0x1C423B50)
#define MONOEFFECTINSTANCERENDERER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C423BF0)
#define MONOEFFECTINSTANCERENDERER_GET_PARTICLEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C423B40)
#define MONOEFFECTINSTANCERENDERER_GET_PARTICLEMESH_OFFSET UNITYSDK_OFFSET(0x1C423B30)
#define MONOEFFECTINSTANCERENDERER_NEEDUPDATEMPB_OFFSET UNITYSDK_OFFSET(0x1C423BB0)
#define MONOEFFECTINSTANCERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C4244C0)
#define MONOEFFECTINSTANCERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C423910)
#define MONOEFFECTINSTANCERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C4237B0)
#define MONOEFFECTINSTANCERENDERER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C423A70)
#define MONOEFFECTINSTANCERENDERER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1C423AD0)
#define MONOEFFECTINSTANCERENDERER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1C4239D0)
#define MONOEFFECTINSTANCERENDERER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1C423870)
#define MONOEFFECTINSTANCERENDERER_SETNEEDUPDATEMPB_OFFSET UNITYSDK_OFFSET(0x1C423B60)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHES_OFFSET UNITYSDK_OFFSET(0x1C424560)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHMATRICES_OFFSET UNITYSDK_OFFSET(0x1C424F60)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1C425580)
#define MONOEFFECTINSTANCERENDERER_UPDATESINGLEBATCH_OFFSET UNITYSDK_OFFSET(0x1C424D70)
#define MONOEFFECTINSTANCERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C425E10)

inline static constexpr unsigned int MonoEffectInstanceRenderer_TypeDefinitionIndex = 26965;
