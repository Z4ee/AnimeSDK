...
#define MONOEFFECTINSTANCERENDERER_ADDCOLORVAL_OFFSET UNITYSDK_OFFSET(0x1D5DDF30)
#define MONOEFFECTINSTANCERENDERER_ADDFLOATVAL_OFFSET UNITYSDK_OFFSET(0x1D5DDD80)
#define MONOEFFECTINSTANCERENDERER_ADDVEC4VAL_OFFSET UNITYSDK_OFFSET(0x1D5DDE50)
#define MONOEFFECTINSTANCERENDERER_CALCULATEFRAMEINDICES_OFFSET UNITYSDK_OFFSET(0x1D5DCB10)
#define MONOEFFECTINSTANCERENDERER_CLEARBATCHES_OFFSET UNITYSDK_OFFSET(0x1D5DCA10)
#define MONOEFFECTINSTANCERENDERER_CLEARVALMAP_OFFSET UNITYSDK_OFFSET(0x1D5DDC70)
#define MONOEFFECTINSTANCERENDERER_ENSUREBATCHCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D5DCC00)
#define MONOEFFECTINSTANCERENDERER_GETRENDERBATCHES_OFFSET UNITYSDK_OFFSET(0x1D5DDC30)
#define MONOEFFECTINSTANCERENDERER_GET_ANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x1D5DC0B0)
#define MONOEFFECTINSTANCERENDERER_GET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0x1D5DBC90)
#define MONOEFFECTINSTANCERENDERER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D5DBD30)
#define MONOEFFECTINSTANCERENDERER_GET_PARTICLEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D5DBC80)
#define MONOEFFECTINSTANCERENDERER_GET_PARTICLEMESH_OFFSET UNITYSDK_OFFSET(0x1D5DBC70)
#define MONOEFFECTINSTANCERENDERER_NEEDUPDATEMPB_OFFSET UNITYSDK_OFFSET(0x1D5DBCF0)
#define MONOEFFECTINSTANCERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D5DC600)
#define MONOEFFECTINSTANCERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D5DBA50)
#define MONOEFFECTINSTANCERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D5DB8F0)
#define MONOEFFECTINSTANCERENDERER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1D5DBBB0)
#define MONOEFFECTINSTANCERENDERER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1D5DBC10)
#define MONOEFFECTINSTANCERENDERER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1D5DBB10)
#define MONOEFFECTINSTANCERENDERER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1D5DB9B0)
#define MONOEFFECTINSTANCERENDERER_SETNEEDUPDATEMPB_OFFSET UNITYSDK_OFFSET(0x1D5DBCA0)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHES_OFFSET UNITYSDK_OFFSET(0x1D5DC6A0)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHMATRICES_OFFSET UNITYSDK_OFFSET(0x1D5DD0C0)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1D5DD710)
#define MONOEFFECTINSTANCERENDERER_UPDATESINGLEBATCH_OFFSET UNITYSDK_OFFSET(0x1D5DCEB0)
#define MONOEFFECTINSTANCERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DDFA0)

inline static constexpr unsigned int MonoEffectInstanceRenderer_TypeDefinitionIndex = 27611;
