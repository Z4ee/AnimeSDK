...
#define CLASS_2_9D3DA1BFF2F6EABD_GET_REPLACECOUNT_OFFSET UNITYSDK_OFFSET(0x170C76D0)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_038349821F206DD5_OFFSET UNITYSDK_OFFSET(0x170C76F0)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_1577395D9A9E4AFA_OFFSET UNITYSDK_OFFSET(0x18920D60)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_3091BBD11FD1CB39_OFFSET UNITYSDK_OFFSET(0x170C7370)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_4C6E694DFB649B6F_OFFSET UNITYSDK_OFFSET(0x170C6980)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_59BDC73C87D34BE2_OFFSET UNITYSDK_OFFSET(0x170C7170)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x170C74D0)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0x170C7610)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_E1CE0A1C7957700D_OFFSET UNITYSDK_OFFSET(0x170C73F0)
#define CLASS_2_9D3DA1BFF2F6EABD_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x170C76B0)
#define CLASS_2_9D3DA1BFF2F6EABD_SET_REPLACECOUNT_OFFSET UNITYSDK_OFFSET(0x170C76E0)
#define CLASS_2_9D3DA1BFF2F6EABD__CTOR_OFFSET UNITYSDK_OFFSET(0x18920CE0)

inline static constexpr unsigned int Class_2_9D3DA1BFF2F6EABD_TypeDefinitionIndex = 68725;

class Class_2_9D3DA1BFF2F6EABD : public ::Class_1_2BF31F3092BDFD9E
{
public:
	::System::Collections::Generic::List_1<::System::Int32>* DFDFBKCIPHK; // 0x80
	::RPG::Client::WolfBroGunPlayRogue* OPIJBGOENAM; // 0x88
