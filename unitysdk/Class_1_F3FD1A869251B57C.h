...
#define CLASS_1_F3FD1A869251B57C__CTOR_OFFSET UNITYSDK_OFFSET(0x153A62C0)
...
{
public:
	::RPG::GameCore::UnitStatus NOBBBDBMLKE; // 0x10
	::System::UInt32 CEGOPEIKDLA; // 0x14
	::RPG::GameCore::UnitStatus LCFGGFKMJLF; // 0x18
