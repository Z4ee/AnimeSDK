...
#define CLASS_1_F3FD1A869251B57C__CTOR_OFFSET UNITYSDK_OFFSET(0x136AFF00)

inline static constexpr unsigned int Class_1_F3FD1A869251B57C_TypeDefinitionIndex = 53767;
...
public:
	...
	::RPG::GameCore::UnitStatus Field_1_2; // 0x18
