...
#define LINELIGHTING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1FC06FF0)
#define LINELIGHTING_COLLECTLINPOS_OFFSET UNITYSDK_OFFSET(0x1FC076A0)
#define LINELIGHTING_DOSETLINERENDERER_OFFSET UNITYSDK_OFFSET(0x1FC07420)
#define LINELIGHTING_FORCEUPDATEWITHPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1FC07650)
#define LINELIGHTING_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x1FC07620)
#define LINELIGHTING_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1FC06A60)
#define LINELIGHTING_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1FC068A0)
#define LINELIGHTING_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1FC06890)
#define LINELIGHTING_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x1FC07910)
#define LINELIGHTING_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1FC070F0)
#define LINELIGHTING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FC070C0)
#define LINELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC07AA0)

inline static constexpr unsigned int LineLighting_TypeDefinitionIndex = 35312;
