...
#define LINELIGHTING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E8280F0)
#define LINELIGHTING_COLLECTLINPOS_OFFSET UNITYSDK_OFFSET(0x1E8287A0)
#define LINELIGHTING_DOSETLINERENDERER_OFFSET UNITYSDK_OFFSET(0x1E828510)
#define LINELIGHTING_FORCEUPDATEWITHPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1E828750)
#define LINELIGHTING_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E828720)
#define LINELIGHTING_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1E827B30)
#define LINELIGHTING_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1E827970)
#define LINELIGHTING_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1E827960)
#define LINELIGHTING_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x1E828A10)
#define LINELIGHTING_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1E8281F0)
#define LINELIGHTING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E8281C0)
#define LINELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E828BA0)

inline static constexpr unsigned int LineLighting_TypeDefinitionIndex = 34653;
