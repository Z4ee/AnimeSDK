...
#define CLASS_2_6CE592807426216E_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x18504A50)
#define CLASS_2_6CE592807426216E_METHOD_2_2382947EA134E963_OFFSET UNITYSDK_OFFSET(0x18504570)
#define CLASS_2_6CE592807426216E_METHOD_2_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x18504B60)
#define CLASS_2_6CE592807426216E_METHOD_2_60BAB51FAB46DBD1_OFFSET UNITYSDK_OFFSET(0x18504AB0)
#define CLASS_2_6CE592807426216E_METHOD_2_60DC879ACE99CF48_OFFSET UNITYSDK_OFFSET(0x18504BE0)
#define CLASS_2_6CE592807426216E_METHOD_2_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0x18504690)
#define CLASS_2_6CE592807426216E_METHOD_2_F70045D03F5767B0_OFFSET UNITYSDK_OFFSET(0x18504480)
#define CLASS_2_6CE592807426216E__CTOR_OFFSET UNITYSDK_OFFSET(0x18504C50)
#define CLASS_2_6CE592807426216E__ONBIND_OFFSET UNITYSDK_OFFSET(0x185046F0)

inline static constexpr unsigned int Class_2_6CE592807426216E_TypeDefinitionIndex = 71945;

class Class_2_6CE592807426216E : public ::Class_1_34917908B7833130
{
public:
	::UnityEngine::Transform* BJGCAMLMHON; // 0x60
	::UnityEngine::Animation* KNGEOHAPLCF; // 0x68
	::UnityEngine::Transform* BEINMJOCHIL; // 0x70
	::UnityEngine::Transform* PPCNBKDKEKA; // 0x78
	::UnityEngine::Transform* JEDDHPEJCMN; // 0x80
