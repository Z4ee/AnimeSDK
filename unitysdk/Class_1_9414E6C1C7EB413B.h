...
#define CLASS_1_9414E6C1C7EB413B_GET_ATTITUDE_OFFSET UNITYSDK_OFFSET(0xC7191F0)
#define CLASS_1_9414E6C1C7EB413B_GET_GRAVITY_OFFSET UNITYSDK_OFFSET(0xC719190)
#define CLASS_1_9414E6C1C7EB413B_GET_ROTATIONRATEUNBIASED_OFFSET UNITYSDK_OFFSET(0xC719160)
#define CLASS_1_9414E6C1C7EB413B_GET_ROTATIONRATE_OFFSET UNITYSDK_OFFSET(0xC719130)
#define CLASS_1_9414E6C1C7EB413B_GET_USERACCELERATION_OFFSET UNITYSDK_OFFSET(0xC7191C0)
#define CLASS_1_9414E6C1C7EB413B_METHOD_1_8F490265D0A1B8F6_OFFSET UNITYSDK_OFFSET(0xC718EF0)
#define CLASS_1_9414E6C1C7EB413B_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC718EE0)
#define CLASS_1_9414E6C1C7EB413B_METHOD_1_F5504CECAFBA99EF_OFFSET UNITYSDK_OFFSET(0xC718E30)
#define CLASS_1_9414E6C1C7EB413B_SET_ATTITUDE_OFFSET UNITYSDK_OFFSET(0xC719200)
#define CLASS_1_9414E6C1C7EB413B_SET_GRAVITY_OFFSET UNITYSDK_OFFSET(0xC7191B0)
#define CLASS_1_9414E6C1C7EB413B_SET_ROTATIONRATEUNBIASED_OFFSET UNITYSDK_OFFSET(0xC719180)
#define CLASS_1_9414E6C1C7EB413B_SET_ROTATIONRATE_OFFSET UNITYSDK_OFFSET(0xC719150)
#define CLASS_1_9414E6C1C7EB413B_SET_USERACCELERATION_OFFSET UNITYSDK_OFFSET(0xC7191E0)
#define CLASS_1_9414E6C1C7EB413B__CTOR_OFFSET UNITYSDK_OFFSET(0xC718E20)

inline static constexpr unsigned int Class_1_9414E6C1C7EB413B_TypeDefinitionIndex = 62967;

class Class_1_9414E6C1C7EB413B : public ::System::Object
{
public:
	::System::Boolean Field_1_5; // 0x10
	::UnityEngine::Vector3 _UserAcceleration_k__BackingField; // 0x14
	::UnityEngine::Vector3 _RotationRate_k__BackingField; // 0x20
	::UnityEngine::Vector3 _RotationRateUnbiased_k__BackingField; // 0x2C
	::UnityEngine::Quaternion _Attitude_k__BackingField; // 0x38
	::UnityEngine::Vector3 _Gravity_k__BackingField; // 0x48
