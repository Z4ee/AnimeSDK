...
#define CLASS_3_3D5A3B91F7EEEFC2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x93841C0)
#define CLASS_3_3D5A3B91F7EEEFC2__CTOR_OFFSET UNITYSDK_OFFSET(0x93840E0)

inline static constexpr unsigned int Class_3_3D5A3B91F7EEEFC2_TypeDefinitionIndex = 51451;
