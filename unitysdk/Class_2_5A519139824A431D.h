...
#define CLASS_2_5A519139824A431D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17C99E20)
#define CLASS_2_5A519139824A431D_METHOD_2_372E41FA4A171DFD_OFFSET UNITYSDK_OFFSET(0x17C9B390)
#define CLASS_2_5A519139824A431D_METHOD_2_78C62398E94F0FB1_OFFSET UNITYSDK_OFFSET(0x17C99EE0)
#define CLASS_2_5A519139824A431D_METHOD_2_932BC234D35144E8_OFFSET UNITYSDK_OFFSET(0x17C9B890)
#define CLASS_2_5A519139824A431D_METHOD_2_A59C1BC1CD30E8D5_OFFSET UNITYSDK_OFFSET(0x17C9B790)
#define CLASS_2_5A519139824A431D_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17C9B9C0)
#define CLASS_2_5A519139824A431D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17C99FD0)
#define CLASS_2_5A519139824A431D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17C9B400)
#define CLASS_2_5A519139824A431D_TICK_OFFSET UNITYSDK_OFFSET(0x17C9B5B0)
#define CLASS_2_5A519139824A431D__CTOR_OFFSET UNITYSDK_OFFSET(0x17C99D20)
#define CLASS_2_5A519139824A431D___RUNTEMPLATES_G___SORTANDGETNEXTTEMPLATE_5_0_OFFSET UNITYSDK_OFFSET(0x17C9B9D0)

inline static constexpr unsigned int Class_2_5A519139824A431D_TypeDefinitionIndex = 53233;

class Class_2_5A519139824A431D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TriggerParallelTaskListTemplate* Field_2_0; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::StringHash, ::System::String*>* Field_2_2; // 0x28
	::Class_1_1C30CE192ABE4C54* Field_2_3; // 0x30
	::System::Collections::Generic::List_1<::Class_1_E6272F143FEEC786*>* Field_2_4; // 0x38
	::Class_1_07A210D994F284D8_4* Field_2_5; // 0x40
