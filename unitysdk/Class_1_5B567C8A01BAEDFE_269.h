...
#define CLASS_1_5B567C8A01BAEDFE_269_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1869A0)
#define CLASS_1_5B567C8A01BAEDFE_269_CLONE_OFFSET UNITYSDK_OFFSET(0x1A186810)
#define CLASS_1_5B567C8A01BAEDFE_269_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1868B0)
#define CLASS_1_5B567C8A01BAEDFE_269_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A186850)
#define CLASS_1_5B567C8A01BAEDFE_269_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A186900)
#define CLASS_1_5B567C8A01BAEDFE_269_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1869F0)
#define CLASS_1_5B567C8A01BAEDFE_269_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1869C0)
#define CLASS_1_5B567C8A01BAEDFE_269_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A186790)
#define CLASS_1_5B567C8A01BAEDFE_269_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1867C0)
#define CLASS_1_5B567C8A01BAEDFE_269_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A186930)
#define CLASS_1_5B567C8A01BAEDFE_269_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A186990)
#define CLASS_1_5B567C8A01BAEDFE_269__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A186A40)
#define CLASS_1_5B567C8A01BAEDFE_269__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1867E0)
#define CLASS_1_5B567C8A01BAEDFE_269__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1867D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_269_TypeDefinitionIndex = 30467;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_269*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_269_TypeDefinitionIndex)->GetStaticField(0x2E140);
	}
