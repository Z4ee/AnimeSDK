...
#define CLASS_1_FE4EA34D956DAF94_CLASS_1_BBC842CA3CCF8FA2__CTOR_OFFSET UNITYSDK_OFFSET(0xC3BAB40)
...
{
public:
	::RPG::Client::BatchAnimationGraphMaskLayerConfig_BatchAnimationMaskBoneMaskConfig* DDLAEMLDPLM; // 0x10
	::RPG::Client::BatchAnimationGraphMaskLayerConfig_BatchAnimationNPCMaskAnimConfig* EABKOHGCHFP; // 0x18
	::UnityEngine::Rendering::BatchAnimationClip* OBKONNDLKDL; // 0x20
	::System::String* BFLIFKBEOPJ; // 0x28
	::System::String* GPIDKEKIOEG; // 0x30
