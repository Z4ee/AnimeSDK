...
#define CLASS_1_EA5A5E4D07C4CF2B_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E519F90)
#define CLASS_1_EA5A5E4D07C4CF2B_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1E519AF0)
#define CLASS_1_EA5A5E4D07C4CF2B_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E519C80)
#define CLASS_1_EA5A5E4D07C4CF2B_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E519BA0)
#define CLASS_1_EA5A5E4D07C4CF2B_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E519D50)
#define CLASS_1_EA5A5E4D07C4CF2B_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E51A190)
#define CLASS_1_EA5A5E4D07C4CF2B_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E51A140)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E519A60)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0x1E519B70)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_C114A1F8E08B6F92_2_OFFSET UNITYSDK_OFFSET(0x1E519B90)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x1E519B50)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x1E519B60)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_C74CF020AA42ED85_2_OFFSET UNITYSDK_OFFSET(0x1E519B80)
#define CLASS_1_EA5A5E4D07C4CF2B_1_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1E519B40)
#define CLASS_1_EA5A5E4D07C4CF2B_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E519A90)
#define CLASS_1_EA5A5E4D07C4CF2B_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E519D80)
#define CLASS_1_EA5A5E4D07C4CF2B_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E519DE0)
#define CLASS_1_EA5A5E4D07C4CF2B_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E51A350)
#define CLASS_1_EA5A5E4D07C4CF2B_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E519AB0)
#define CLASS_1_EA5A5E4D07C4CF2B_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E519AA0)

inline static constexpr unsigned int Class_1_EA5A5E4D07C4CF2B_1_TypeDefinitionIndex = 25027;

class Class_1_EA5A5E4D07C4CF2B_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_EA5A5E4D07C4CF2B_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EA5A5E4D07C4CF2B_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EA5A5E4D07C4CF2B_1_TypeDefinitionIndex)->GetStaticField(0x166D0);
	}
	// static const ::System::Int32 PLAGKJDJGBN = 0x1; // 0x0
	// static const ::System::Int32 OAPJNMPOKHB = 0x2; // 0x0
	// static const ::System::Int32 MAIOIAOEKKO = 0x3; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Int32 EIKLKDGDLEG; // 0x18
	::System::Int32 IOCAJCJJGOM; // 0x1C
	::System::Int32 KFNMMILCBFP; // 0x20
