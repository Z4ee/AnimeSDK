...
#define CLASS_1_BAF34E22336FA194__CTOR_OFFSET UNITYSDK_OFFSET(0x154B19D0)
...
public:
	...
	::RPG::GameCore::FixPoint KKCKMCDGCGK; // 0x18
	::RPG::GameCore::FeverTimePeriodType JNCLBMMJOFE; // 0x20
