...
#define BNATIVE_DEFAULTDEBUG_ASSETFORMAT_OFFSET UNITYSDK_OFFSET(0x13A2B2E0)
#define BNATIVE_DEFAULTDEBUG_GET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x13A2AD40)
#define BNATIVE_DEFAULTDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x13A2AEC0)
#define BNATIVE_DEFAULTDEBUG_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x13A2B020)
#define BNATIVE_DEFAULTDEBUG_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x13A2B180)
#define BNATIVE_DEFAULTDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x13A2AD60)
#define BNATIVE_DEFAULTDEBUG_SET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x13A2AD50)
#define BNATIVE_DEFAULTDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x13A2B380)

namespace BNative
{
	inline static constexpr unsigned int DefaultDebug_TypeDefinitionIndex = 76159;
