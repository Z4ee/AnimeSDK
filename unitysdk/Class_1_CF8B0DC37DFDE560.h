...
#define CLASS_1_CF8B0DC37DFDE560_GET_ISSTARTED_OFFSET UNITYSDK_OFFSET(0x19533900)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_03B1BF2F2F8589FD_OFFSET UNITYSDK_OFFSET(0x19535B70)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_15F4E4F86182D646_OFFSET UNITYSDK_OFFSET(0x19534E30)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_18A7BF8B592973BC_OFFSET UNITYSDK_OFFSET(0x195346A0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_30E1BE7387CD0701_OFFSET UNITYSDK_OFFSET(0x195357F0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_37B9CAEB4EAE67B7_OFFSET UNITYSDK_OFFSET(0x19535850)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x19533FB0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_49B11BA78A61F1C1_OFFSET UNITYSDK_OFFSET(0x19534FD0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_726BE9283E00DAB1_OFFSET UNITYSDK_OFFSET(0x19534490)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_820BC74DFBBFC7F7_OFFSET UNITYSDK_OFFSET(0x195339A0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_82D51DE4D1764C67_OFFSET UNITYSDK_OFFSET(0x195336B0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_83EF02F8F4B2192A_OFFSET UNITYSDK_OFFSET(0x19534810)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_8B6F11557B375B74_OFFSET UNITYSDK_OFFSET(0x19534140)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_8CB3ABD41F954D02_OFFSET UNITYSDK_OFFSET(0x19535050)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0x19533D00)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_9AB045C54EC604F2_OFFSET UNITYSDK_OFFSET(0x19534300)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x19533920)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x195349D0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x19534AB0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x195342C0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_D41B9F644D365890_OFFSET UNITYSDK_OFFSET(0x19533F60)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0x195341B0)
#define CLASS_1_CF8B0DC37DFDE560_SET_ISSTARTED_OFFSET UNITYSDK_OFFSET(0x19533910)
#define CLASS_1_CF8B0DC37DFDE560__CTOR_OFFSET UNITYSDK_OFFSET(0x19533970)
...
public:
	...
	{
		return (::RPG::Client::Billboard::BillboardNotifyParam**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CF8B0DC37DFDE560_TypeDefinitionIndex)->GetStaticField(0x5FA80);
	}
	static ::System::UInt32* StaticGet_ENBDNGNBAKB()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CF8B0DC37DFDE560_TypeDefinitionIndex)->GetStaticField(0x13630);
	}
	// static const ::System::String* GEHLLIAHIAK; // 0x0
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::GameEntity*>* JLDDEOIICOM; // 0x10
	::Class_1_EED1D87C81F7C2A6* LMCCPIDGDBC; // 0x18
	::System::Collections::Generic::List_1<::Class_1_EED1D87C81F7C2A6*>* FBHMMHICDDG; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::Class_1_CF8B0DC37DFDE560_Struct_2_15DAEDDD7C0F5F31>* KIJICCJEGMF; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_EED1D87C81F7C2A6*>* PGHFDBHKNKI; // 0x30
	::RPG::GameCore::MunicipalChatConfig* EJJEEJENLDA; // 0x38
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* BBCKAEJKLNI; // 0x40
