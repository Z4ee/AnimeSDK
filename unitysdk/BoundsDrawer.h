...
#define BOUNDSDRAWER_GET_CULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FCE5B0)
#define BOUNDSDRAWER_GET_LODTEMPLATECFG_OFFSET UNITYSDK_OFFSET(0x8FCE5D0)
#define BOUNDSDRAWER_GET_PRELOADCULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FCE590)
#define BOUNDSDRAWER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x8FCDEE0)
#define BOUNDSDRAWER_SETBOUND_OFFSET UNITYSDK_OFFSET(0x8FCDD60)
#define BOUNDSDRAWER_SETOWNERINSTANCE_OFFSET UNITYSDK_OFFSET(0x8FCDDE0)
#define BOUNDSDRAWER_SET_CULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FCE5C0)
#define BOUNDSDRAWER_SET_PRELOADCULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FCE5A0)
#define BOUNDSDRAWER_START_OFFSET UNITYSDK_OFFSET(0x8FCDE30)
#define BOUNDSDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FCE630)

inline static constexpr unsigned int BoundsDrawer_TypeDefinitionIndex = 38193;
