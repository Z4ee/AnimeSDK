...
#define CLASS_3_035B8F5A47199758_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15828FA0)
#define CLASS_3_035B8F5A47199758__CTOR_OFFSET UNITYSDK_OFFSET(0x15828EC0)

inline static constexpr unsigned int Class_3_035B8F5A47199758_TypeDefinitionIndex = 55596;
