...
#define CLASS_1_1188AF8BD7013432_METHOD_1_059BD73D68C71853_OFFSET UNITYSDK_OFFSET(0x17843990)
#define CLASS_1_1188AF8BD7013432_METHOD_1_0BB472DC0AD658C2_OFFSET UNITYSDK_OFFSET(0x17843E10)
#define CLASS_1_1188AF8BD7013432_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x17843D30)
#define CLASS_1_1188AF8BD7013432_METHOD_1_50D6A7C67ED3EDC7_OFFSET UNITYSDK_OFFSET(0x178431B0)
#define CLASS_1_1188AF8BD7013432_METHOD_1_6AD559F472687D8E_OFFSET UNITYSDK_OFFSET(0x17843B30)
#define CLASS_1_1188AF8BD7013432_METHOD_1_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x17843250)
#define CLASS_1_1188AF8BD7013432_METHOD_1_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0x17843490)
#define CLASS_1_1188AF8BD7013432_METHOD_1_7EB19CFE09DC3321_OFFSET UNITYSDK_OFFSET(0x17843FD0)
#define CLASS_1_1188AF8BD7013432_METHOD_1_9CE3056B66B7573D_OFFSET UNITYSDK_OFFSET(0x17843C60)
#define CLASS_1_1188AF8BD7013432_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x17843F90)
#define CLASS_1_1188AF8BD7013432_METHOD_1_A9976D5BA569414A_OFFSET UNITYSDK_OFFSET(0x17842C10)
#define CLASS_1_1188AF8BD7013432_METHOD_1_ADF4AD3331B4D7AD_1_OFFSET UNITYSDK_OFFSET(0x17843860)
#define CLASS_1_1188AF8BD7013432_METHOD_1_ADF4AD3331B4D7AD_2_OFFSET UNITYSDK_OFFSET(0x17843F30)
#define CLASS_1_1188AF8BD7013432_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x17843810)
#define CLASS_1_1188AF8BD7013432_METHOD_1_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x17844280)
#define CLASS_1_1188AF8BD7013432_METHOD_1_CD37BA088172EEF7_OFFSET UNITYSDK_OFFSET(0x178437B0)
#define CLASS_1_1188AF8BD7013432_METHOD_1_D9AAE950C6F28BA6_OFFSET UNITYSDK_OFFSET(0x178438B0)
#define CLASS_1_1188AF8BD7013432_METHOD_1_E4FB51E946EDE8A5_OFFSET UNITYSDK_OFFSET(0x17844300)
#define CLASS_1_1188AF8BD7013432_METHOD_1_EBDC7A7D2F421DC3_1_OFFSET UNITYSDK_OFFSET(0x17844200)
#define CLASS_1_1188AF8BD7013432_METHOD_1_EBDC7A7D2F421DC3_OFFSET UNITYSDK_OFFSET(0x17844180)
#define CLASS_1_1188AF8BD7013432__CCTOR_OFFSET UNITYSDK_OFFSET(0x178443D0)
#define CLASS_1_1188AF8BD7013432__CTOR_OFFSET UNITYSDK_OFFSET(0x178443C0)
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1188AF8BD7013432_TypeDefinitionIndex)->GetStaticField(0x5FFF0);
	}
	::UnityEngine::UI::Text* GAKGGMODMNP; // 0x10
	::UnityEngine::Transform* GKNBCPMJHMN; // 0x18
	::UnityEngine::UI::Text* COPJABODJHP; // 0x20
	::System::Collections::Generic::Queue_1<::Class_1_1188AF8BD7013432_ScrollState>* GMACAFIDEFM; // 0x28
	::UnityEngine::Animation* OFDFAIMLJKB; // 0x30
	::System::Action* PPNNHIGJGEP; // 0x38
	::RPG::Client::RPGAnimationEvent* MEDGLNFKGDC; // 0x40
	::System::Single HGFCEHJJGCL; // 0x48
	::System::Single DKOFFPPGEFI; // 0x4C
	::Class_1_1188AF8BD7013432_ScrollState NMMHFEGBFFP; // 0x50
	::System::Boolean EMHAACACFOM; // 0x54
	::System::Boolean OMIPKAAHLDP; // 0x55
	::System::Int32 EELOAMDDHBP; // 0x58
	::System::Int32 JJDGIADDPHM; // 0x5C
	::Class_1_1188AF8BD7013432_ScrollType IOAANMAGJHD; // 0x60
	::System::Int32 ANPAHODBCOB; // 0x64
	::System::Int32 HAOPEJAGHDJ; // 0x68
	::System::Int32 FFNBLDFFMCN; // 0x6C
