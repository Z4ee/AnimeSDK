...
#define CLASS_3_CD13402ED8EA9E5C_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x17CBC450)
#define CLASS_3_CD13402ED8EA9E5C_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x17CBC460)
#define CLASS_3_CD13402ED8EA9E5C__CTOR_OFFSET UNITYSDK_OFFSET(0x17CBC4C0)

inline static constexpr unsigned int Class_3_CD13402ED8EA9E5C_TypeDefinitionIndex = 73905;

class Class_3_CD13402ED8EA9E5C : public ::RPG::Client::OpenWorld::VolumeParameter_1<::System::Int32>
{
public:
	::System::Int32 PJKFLONMKED; // 0x18
	::System::Int32 ENMIPOPKOOL; // 0x1C
