...
#define CLASS_1_2B92ECA1165A1B2F_METHOD_1_7FB527F01618719E_OFFSET UNITYSDK_OFFSET(0x17FA1AD0)
#define CLASS_1_2B92ECA1165A1B2F_METHOD_1_95B948F3B1DB5D12_OFFSET UNITYSDK_OFFSET(0x17FA1D60)
#define CLASS_1_2B92ECA1165A1B2F_METHOD_1_AA2D3E889C8A52CA_1_OFFSET UNITYSDK_OFFSET(0x17FA1C70)
#define CLASS_1_2B92ECA1165A1B2F_METHOD_1_AA2D3E889C8A52CA_2_OFFSET UNITYSDK_OFFSET(0x17FA1CC0)
#define CLASS_1_2B92ECA1165A1B2F_METHOD_1_AA2D3E889C8A52CA_3_OFFSET UNITYSDK_OFFSET(0x17FA1D10)
#define CLASS_1_2B92ECA1165A1B2F_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x17FA1C20)
#define CLASS_1_2B92ECA1165A1B2F__CTOR_OFFSET UNITYSDK_OFFSET(0x17FA1BB0)

inline static constexpr unsigned int Class_1_2B92ECA1165A1B2F_TypeDefinitionIndex = 62330;

class Class_1_2B92ECA1165A1B2F : public ::System::Object
{
public:
	::RPG::GameCore::GridFightStageRouteConfigRow* Field_1_0; // 0x10
	::RPG::GameCore::GridFightNodeTemplateConfigRow* Field_1_1; // 0x18
