...
#define CLASS_1_5B567C8A01BAEDFE_191_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3447B0)
#define CLASS_1_5B567C8A01BAEDFE_191_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3445C0)
#define CLASS_1_5B567C8A01BAEDFE_191_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3446C0)
#define CLASS_1_5B567C8A01BAEDFE_191_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A344630)
#define CLASS_1_5B567C8A01BAEDFE_191_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A344710)
#define CLASS_1_5B567C8A01BAEDFE_191_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A344800)
#define CLASS_1_5B567C8A01BAEDFE_191_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3447D0)
#define CLASS_1_5B567C8A01BAEDFE_191_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A344510)
#define CLASS_1_5B567C8A01BAEDFE_191_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A344570)
#define CLASS_1_5B567C8A01BAEDFE_191_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A344740)
#define CLASS_1_5B567C8A01BAEDFE_191_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3447A0)
#define CLASS_1_5B567C8A01BAEDFE_191__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A344850)
#define CLASS_1_5B567C8A01BAEDFE_191__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A344590)
#define CLASS_1_5B567C8A01BAEDFE_191__CTOR_OFFSET UNITYSDK_OFFSET(0x1A344580)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_191_TypeDefinitionIndex = 28655;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_191*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_191_TypeDefinitionIndex)->GetStaticField(0x12A10);
	}
