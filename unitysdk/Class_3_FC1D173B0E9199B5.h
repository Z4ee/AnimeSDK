...
#define CLASS_3_FC1D173B0E9199B5_METHOD_3_5433D6C708F8C421_OFFSET UNITYSDK_OFFSET(0x1C7B7C60)
#define CLASS_3_FC1D173B0E9199B5_METHOD_3_CC5389287A803194_OFFSET UNITYSDK_OFFSET(0x1C7B7CB0)
#define CLASS_3_FC1D173B0E9199B5__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7B7CA0)

inline static constexpr unsigned int Class_3_FC1D173B0E9199B5_TypeDefinitionIndex = 10215;

class Class_3_FC1D173B0E9199B5 : public ::RPG::GameCore::TaskConfig
{
public:
	::System::UInt32 IHALCLABNOJ; // 0x18
	::System::UInt32 DGLJLJEHNNB; // 0x1C
	::System::Boolean DMKJAJLNEBK; // 0x20
	::System::UInt32 LEAPPNPBINI; // 0x24
