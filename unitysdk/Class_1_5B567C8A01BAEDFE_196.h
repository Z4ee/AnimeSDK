...
#define CLASS_1_5B567C8A01BAEDFE_196_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EC7CB60)
#define CLASS_1_5B567C8A01BAEDFE_196_CLONE_OFFSET UNITYSDK_OFFSET(0x1EC7C850)
#define CLASS_1_5B567C8A01BAEDFE_196_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EC7C960)
#define CLASS_1_5B567C8A01BAEDFE_196_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EC7C890)
#define CLASS_1_5B567C8A01BAEDFE_196_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EC7CAC0)
#define CLASS_1_5B567C8A01BAEDFE_196_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EC7CBB0)
#define CLASS_1_5B567C8A01BAEDFE_196_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EC7CB80)
#define CLASS_1_5B567C8A01BAEDFE_196_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EC7C7D0)
#define CLASS_1_5B567C8A01BAEDFE_196_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EC7C800)
#define CLASS_1_5B567C8A01BAEDFE_196_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EC7CAF0)
#define CLASS_1_5B567C8A01BAEDFE_196_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EC7CB50)
#define CLASS_1_5B567C8A01BAEDFE_196__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC7CC00)
#define CLASS_1_5B567C8A01BAEDFE_196__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EC7C820)
#define CLASS_1_5B567C8A01BAEDFE_196__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC7C810)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_196_TypeDefinitionIndex = 30065;

class Class_1_5B567C8A01BAEDFE_196 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_196*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_196*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_196_TypeDefinitionIndex)->GetStaticField(0x3F6B0);
	}
