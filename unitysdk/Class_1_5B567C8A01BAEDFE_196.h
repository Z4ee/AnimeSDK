...
#define CLASS_1_5B567C8A01BAEDFE_196_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x194BF230)
#define CLASS_1_5B567C8A01BAEDFE_196_CLONE_OFFSET UNITYSDK_OFFSET(0x194BF0A0)
#define CLASS_1_5B567C8A01BAEDFE_196_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x194BF140)
#define CLASS_1_5B567C8A01BAEDFE_196_EQUALS_OFFSET UNITYSDK_OFFSET(0x194BF0E0)
#define CLASS_1_5B567C8A01BAEDFE_196_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x194BF190)
#define CLASS_1_5B567C8A01BAEDFE_196_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x194BF280)
#define CLASS_1_5B567C8A01BAEDFE_196_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x194BF250)
#define CLASS_1_5B567C8A01BAEDFE_196_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x194BF020)
#define CLASS_1_5B567C8A01BAEDFE_196_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x194BF050)
#define CLASS_1_5B567C8A01BAEDFE_196_TOSTRING_OFFSET UNITYSDK_OFFSET(0x194BF1C0)
#define CLASS_1_5B567C8A01BAEDFE_196_WRITETO_OFFSET UNITYSDK_OFFSET(0x194BF220)
#define CLASS_1_5B567C8A01BAEDFE_196__CCTOR_OFFSET UNITYSDK_OFFSET(0x194BF2D0)
#define CLASS_1_5B567C8A01BAEDFE_196__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194BF070)
#define CLASS_1_5B567C8A01BAEDFE_196__CTOR_OFFSET UNITYSDK_OFFSET(0x194BF060)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_196_TypeDefinitionIndex = 28920;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_196*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_196_TypeDefinitionIndex)->GetStaticField(0x51A00);
	}
