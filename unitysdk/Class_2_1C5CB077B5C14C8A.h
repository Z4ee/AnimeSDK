...
#define CLASS_2_1C5CB077B5C14C8A_METHOD_2_52607DE4C357D269_OFFSET UNITYSDK_OFFSET(0x1C27FF90)
#define CLASS_2_1C5CB077B5C14C8A__CTOR_OFFSET UNITYSDK_OFFSET(0x1C27FF80)
...
public:
	...
	::RPG::GameCore::DiceCombatTaskConfig_ClearCustomValue* IGHAHBNLIJA; // 0x20
