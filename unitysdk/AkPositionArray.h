...
#define AKPOSITIONARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1BD724F0)
#define AKPOSITIONARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BD72390)
#define AKPOSITIONARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BD723F0)
#define AKPOSITIONARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1BD72370)
#define AKPOSITIONARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1BD724A0)
#define AKPOSITIONARRAY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1BD72380)
#define AKPOSITIONARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD72330)

inline static constexpr unsigned int AkPositionArray_TypeDefinitionIndex = 42067;
