...
#define AKPOSITIONARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x18BCBBD0)
#define AKPOSITIONARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BCBA70)
#define AKPOSITIONARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18BCBAD0)
#define AKPOSITIONARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x18BCBA50)
#define AKPOSITIONARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x18BCBB80)
#define AKPOSITIONARRAY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x18BCBA60)
#define AKPOSITIONARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCBA10)

inline static constexpr unsigned int AkPositionArray_TypeDefinitionIndex = 34606;
