...
#define AKPOSITIONARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1E7EBC50)
#define AKPOSITIONARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E7EBB90)
#define AKPOSITIONARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E7EBBC0)
#define AKPOSITIONARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E7EBB70)
#define AKPOSITIONARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1E7EBC40)
#define AKPOSITIONARRAY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E7EBB80)
#define AKPOSITIONARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7EBB30)

inline static constexpr unsigned int AkPositionArray_TypeDefinitionIndex = 33094;
