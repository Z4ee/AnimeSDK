...
#define CLASS_2_97E58BBA90464D2F_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x19154C80)
#define CLASS_2_97E58BBA90464D2F_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x19154E90)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x19153E90)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_12FBA0F9DF99A2E2_OFFSET UNITYSDK_OFFSET(0x191545D0)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x19154000)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x191543A0)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_1F0049EB5F9AF3BC_OFFSET UNITYSDK_OFFSET(0x19154080)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x19154120)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_943E1EFDF67DA624_OFFSET UNITYSDK_OFFSET(0x19154B60)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_DF7CEFC0E6C5FD0D_1_OFFSET UNITYSDK_OFFSET(0x19154940)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x19154720)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x19154BC0)
#define CLASS_2_97E58BBA90464D2F_METHOD_2_FA2356D61FA6F9C7_OFFSET UNITYSDK_OFFSET(0x19154400)
#define CLASS_2_97E58BBA90464D2F__CTOR_OFFSET UNITYSDK_OFFSET(0x19155060)
#define CLASS_2_97E58BBA90464D2F__ONBIND_OFFSET UNITYSDK_OFFSET(0x19153AD0)
#define CLASS_2_97E58BBA90464D2F__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x19154500)
#define CLASS_2_97E58BBA90464D2F__ONTICK_OFFSET UNITYSDK_OFFSET(0x19154550)
#define CLASS_2_97E58BBA90464D2F___ONBIND_B__0_1_OFFSET UNITYSDK_OFFSET(0x191550B0)

inline static constexpr unsigned int Class_2_97E58BBA90464D2F_TypeDefinitionIndex = 71980;

class Class_2_97E58BBA90464D2F : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* LPGKOPIGGOB; // 0x0
	// static const ::System::String* GADLIJJAAHF; // 0x0
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* LMHPOFCBFIB; // 0x60
	::Class_2_B49E223DF80566EF* PGBBEEANOPO; // 0x68
	::UnityEngine::Transform* PENDOBEBHNJ; // 0x70
	::Class_2_C3AC14C2FF8CD7D6* PGKJIEGLLCI; // 0x78
	::UnityEngine::Animation* JPHOOFFIAAH; // 0x80
	::Class_2_D8A9B7E75FE2A68B* GLCDGDBCMHJ; // 0x88
	::RPG::Client::BattleAvatarCustomData* JAILPDGOHJB; // 0x90
	::RPG::Client::RPGAnimationEvent* MEDGLNFKGDC; // 0x98
	::UnityEngine::RectTransform* DDMJJAKCOID; // 0xA0
	::Class_2_3744C9F200AC03F4* GGGHKCCNHBD; // 0xA8
	::System::Boolean BNKAECGHLKE; // 0xB0
	::System::Boolean AKKOCKKJMFC; // 0xB1
	::System::Boolean GCKBCJFOLMA; // 0xB2
