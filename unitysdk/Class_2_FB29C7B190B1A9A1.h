...
#define CLASS_2_FB29C7B190B1A9A1_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA1CED40)
#define CLASS_2_FB29C7B190B1A9A1_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xA1CEEC0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xA1CE3C0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_265E3B6BEA7EFC67_OFFSET UNITYSDK_OFFSET(0xA1CDAE0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_3C7DB26DBC02A9C6_OFFSET UNITYSDK_OFFSET(0xA1CDC50)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_42C3EA3461C8132A_OFFSET UNITYSDK_OFFSET(0xA1CDE70)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA1CF140)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5FB1B9EC645AD55B_OFFSET UNITYSDK_OFFSET(0xA1CD9F0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5FF514E44337B43F_OFFSET UNITYSDK_OFFSET(0xA1CE220)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_771ADD86EA4F4522_OFFSET UNITYSDK_OFFSET(0xA1CDFD0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xA1CD7F0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_8EC3255570F308C5_OFFSET UNITYSDK_OFFSET(0xA1CEAF0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_9BCC17D24D0A8A13_OFFSET UNITYSDK_OFFSET(0xA1CDCB0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xA1CEA50)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xA1CEBC0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0xA1CEC80)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xA1CE9B0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_B4A742FFAB70D330_OFFSET UNITYSDK_OFFSET(0xA1CE330)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_C4E2F930A41E34C0_OFFSET UNITYSDK_OFFSET(0xA1CDD60)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0xA1CF0D0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0xA1CD840)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_CF2CFFBCFC8CA900_OFFSET UNITYSDK_OFFSET(0xA1CE6C0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_DBF1456D898098BF_OFFSET UNITYSDK_OFFSET(0xA1CDF60)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_DCC1CBB07F2C3152_OFFSET UNITYSDK_OFFSET(0xA1CE540)
#define CLASS_2_FB29C7B190B1A9A1__CTOR_OFFSET UNITYSDK_OFFSET(0xA1CF010)
#define CLASS_2_FB29C7B190B1A9A1__ONBIND_OFFSET UNITYSDK_OFFSET(0xA1CD6A0)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA1CF1A0)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xA1CF200)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xA1CF070)

inline static constexpr unsigned int Class_2_FB29C7B190B1A9A1_TypeDefinitionIndex = 59248;
