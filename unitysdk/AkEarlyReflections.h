...
#define AKEARLYREFLECTIONS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C091F90)
#define AKEARLYREFLECTIONS_SETEARLYREFLECTIONSVOLUME_OFFSET UNITYSDK_OFFSET(0x1C092090)
#define AKEARLYREFLECTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C092120)

inline static constexpr unsigned int AkEarlyReflections_TypeDefinitionIndex = 31586;
