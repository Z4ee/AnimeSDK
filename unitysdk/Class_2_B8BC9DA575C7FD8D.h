...
#define CLASS_2_B8BC9DA575C7FD8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA35D5D0)
#define CLASS_2_B8BC9DA575C7FD8D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xA35D610)
#define CLASS_2_B8BC9DA575C7FD8D_ONSKIP_OFFSET UNITYSDK_OFFSET(0xA35D790)
#define CLASS_2_B8BC9DA575C7FD8D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA35D620)
#define CLASS_2_B8BC9DA575C7FD8D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA35D690)
#define CLASS_2_B8BC9DA575C7FD8D_TICK_OFFSET UNITYSDK_OFFSET(0xA35D6E0)
#define CLASS_2_B8BC9DA575C7FD8D__CTOR_OFFSET UNITYSDK_OFFSET(0xA35D5C0)

inline static constexpr unsigned int Class_2_B8BC9DA575C7FD8D_TypeDefinitionIndex = 55029;

class Class_2_B8BC9DA575C7FD8D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::WaitFrame* Field_2_1; // 0x20
