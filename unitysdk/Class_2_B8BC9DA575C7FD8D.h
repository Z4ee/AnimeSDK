...
#define CLASS_2_B8BC9DA575C7FD8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1136C6F0)
#define CLASS_2_B8BC9DA575C7FD8D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1136C730)
#define CLASS_2_B8BC9DA575C7FD8D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1136C8B0)
#define CLASS_2_B8BC9DA575C7FD8D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1136C740)
#define CLASS_2_B8BC9DA575C7FD8D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1136C7B0)
#define CLASS_2_B8BC9DA575C7FD8D_TICK_OFFSET UNITYSDK_OFFSET(0x1136C800)
#define CLASS_2_B8BC9DA575C7FD8D__CTOR_OFFSET UNITYSDK_OFFSET(0x1136C6E0)

inline static constexpr unsigned int Class_2_B8BC9DA575C7FD8D_TypeDefinitionIndex = 47565;
