...
#define CLASS_1_5B567C8A01BAEDFE_118_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A746490)
#define CLASS_1_5B567C8A01BAEDFE_118_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7462A0)
#define CLASS_1_5B567C8A01BAEDFE_118_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7463A0)
#define CLASS_1_5B567C8A01BAEDFE_118_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A746310)
#define CLASS_1_5B567C8A01BAEDFE_118_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7463F0)
#define CLASS_1_5B567C8A01BAEDFE_118_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7464E0)
#define CLASS_1_5B567C8A01BAEDFE_118_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7464B0)
#define CLASS_1_5B567C8A01BAEDFE_118_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A7461F0)
#define CLASS_1_5B567C8A01BAEDFE_118_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A746250)
#define CLASS_1_5B567C8A01BAEDFE_118_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A746420)
#define CLASS_1_5B567C8A01BAEDFE_118_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A746480)
#define CLASS_1_5B567C8A01BAEDFE_118__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A746530)
#define CLASS_1_5B567C8A01BAEDFE_118__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A746270)
#define CLASS_1_5B567C8A01BAEDFE_118__CTOR_OFFSET UNITYSDK_OFFSET(0x1A746260)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_118_TypeDefinitionIndex = 26735;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_118*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_118_TypeDefinitionIndex)->GetStaticField(0x423F0);
	}
