...
#define FRAMEENDREFRESHMANAGER_QUEUEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x2BDE80)

inline static constexpr unsigned int FrameEndRefreshManager_QueuedAction_TypeDefinitionIndex = 60367;
