...
#define CLASS_3_F1A1C888430F0DD5_METHOD_3_400CD15A8456AED9_OFFSET UNITYSDK_OFFSET(0xCA39400)
#define CLASS_3_F1A1C888430F0DD5_METHOD_3_7F22A781A9156478_OFFSET UNITYSDK_OFFSET(0xCA39440)
#define CLASS_3_F1A1C888430F0DD5__CTOR_OFFSET UNITYSDK_OFFSET(0xCA39430)
...
{
public:
	::RPG::Client::TextID ONLODCLDLIO; // 0x18
	::System::Boolean IOBCIMIPEOM; // 0x28
	::RPG::Client::TextID EONCGACNBFG; // 0x30
