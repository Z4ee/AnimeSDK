...
#define CLASS_2_AE43BBA620A344B1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13814B50)
#define CLASS_2_AE43BBA620A344B1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13814BF0)
#define CLASS_2_AE43BBA620A344B1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13814F60)
#define CLASS_2_AE43BBA620A344B1_TICK_OFFSET UNITYSDK_OFFSET(0x13814B90)
#define CLASS_2_AE43BBA620A344B1__CTOR_OFFSET UNITYSDK_OFFSET(0x13814B40)

inline static constexpr unsigned int Class_2_AE43BBA620A344B1_TypeDefinitionIndex = 49932;

class Class_2_AE43BBA620A344B1 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TravelShipHideDockMapIcon* Field_2_0; // 0x18
