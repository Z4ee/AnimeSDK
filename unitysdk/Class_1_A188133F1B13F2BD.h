...
#define CLASS_1_A188133F1B13F2BD_GET_DESC_OFFSET UNITYSDK_OFFSET(0xBE8B850)
#define CLASS_1_A188133F1B13F2BD_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBE8B870)
#define CLASS_1_A188133F1B13F2BD_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0xBE8B7E0)
#define CLASS_1_A188133F1B13F2BD_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xBE8B7F0)
#define CLASS_1_A188133F1B13F2BD_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBE8B830)
#define CLASS_1_A188133F1B13F2BD_GET_PARAM_OFFSET UNITYSDK_OFFSET(0xBE8B8F0)
#define CLASS_1_A188133F1B13F2BD_GET_RANKABILITY_OFFSET UNITYSDK_OFFSET(0xBE8B8B0)
#define CLASS_1_A188133F1B13F2BD_GET_SKILLADDLEVELLIST_OFFSET UNITYSDK_OFFSET(0xBE8B890)
#define CLASS_1_A188133F1B13F2BD_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0xBE8B810)
#define CLASS_1_A188133F1B13F2BD_GET_UNLOCKCOST_OFFSET UNITYSDK_OFFSET(0xBE8B8D0)
#define CLASS_1_A188133F1B13F2BD_SET_DESC_OFFSET UNITYSDK_OFFSET(0xBE8B860)
#define CLASS_1_A188133F1B13F2BD_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBE8B880)
#define CLASS_1_A188133F1B13F2BD_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xBE8B800)
#define CLASS_1_A188133F1B13F2BD_SET_NAME_OFFSET UNITYSDK_OFFSET(0xBE8B840)
#define CLASS_1_A188133F1B13F2BD_SET_PARAM_OFFSET UNITYSDK_OFFSET(0xBE8B900)
#define CLASS_1_A188133F1B13F2BD_SET_RANKABILITY_OFFSET UNITYSDK_OFFSET(0xBE8B8C0)
#define CLASS_1_A188133F1B13F2BD_SET_SKILLADDLEVELLIST_OFFSET UNITYSDK_OFFSET(0xBE8B8A0)
#define CLASS_1_A188133F1B13F2BD_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0xBE8B820)
#define CLASS_1_A188133F1B13F2BD_SET_UNLOCKCOST_OFFSET UNITYSDK_OFFSET(0xBE8B8E0)
#define CLASS_1_A188133F1B13F2BD__CTOR_OFFSET UNITYSDK_OFFSET(0xBE8B910)

inline static constexpr unsigned int Class_1_A188133F1B13F2BD_TypeDefinitionIndex = 52254;

class Class_1_A188133F1B13F2BD : public ::System::Object
{
public:
	::Il2CppArray<::System::String*>* _RankAbility_k__BackingField; // 0x10
	::System::String* _Name_k__BackingField; // 0x18
	::System::String* _Desc_k__BackingField; // 0x20
	::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::System::UInt32>* _SkillAddLevelList_k__BackingField; // 0x28
	::Il2CppArray<::RPG::GameCore::FixPoint>* _Param_k__BackingField; // 0x30
	::System::String* _IconPath_k__BackingField; // 0x38
	::Il2CppArray<::RPG::GameCore::ItemConfig*>* _UnlockCost_k__BackingField; // 0x40
	::Struct_2_D645B4E0B73852B6_3 _Identifier_k__BackingField; // 0x48
