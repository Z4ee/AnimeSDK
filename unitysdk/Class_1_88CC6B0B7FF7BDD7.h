...
#define CLASS_1_88CC6B0B7FF7BDD7_CLEAR_OFFSET UNITYSDK_OFFSET(0x16B6EFA0)
#define CLASS_1_88CC6B0B7FF7BDD7__CTOR_OFFSET UNITYSDK_OFFSET(0x16B6EFE0)
...
public:
	...
	::RPG::GameCore::GameModeParamNotifyType Field_1_1; // 0x18
