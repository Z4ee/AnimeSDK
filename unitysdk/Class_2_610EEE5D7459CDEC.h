...
#define CLASS_2_610EEE5D7459CDEC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1835A390)
#define CLASS_2_610EEE5D7459CDEC_METHOD_2_1FC86D2BFE10815E_OFFSET UNITYSDK_OFFSET(0x1835A870)
#define CLASS_2_610EEE5D7459CDEC_METHOD_2_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0x18359C00)
#define CLASS_2_610EEE5D7459CDEC_METHOD_2_2DCDFF29E7FDDAA8_OFFSET UNITYSDK_OFFSET(0x18359920)
#define CLASS_2_610EEE5D7459CDEC_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1835A600)
#define CLASS_2_610EEE5D7459CDEC_METHOD_2_C553BAF25E541FB4_OFFSET UNITYSDK_OFFSET(0x1835A960)
#define CLASS_2_610EEE5D7459CDEC_METHOD_2_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0x18359FE0)
#define CLASS_2_610EEE5D7459CDEC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1835A3F0)
#define CLASS_2_610EEE5D7459CDEC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1835A7D0)
#define CLASS_2_610EEE5D7459CDEC_TICK_OFFSET UNITYSDK_OFFSET(0x1835A680)
#define CLASS_2_610EEE5D7459CDEC__CTOR_OFFSET UNITYSDK_OFFSET(0x18359610)
...
public:
	...
	::System::Collections::Generic::List_1<::RPG::GameCore::ProjectileData*>* LJILIDHFNFJ; // 0x28
	::System::Collections::Generic::List_1<::System::Single>* NBMCBEDFFBH; // 0x30
	::RPG::GameCore::FireMultiProjectilesBase* JKJPFJALGKO; // 0x38
	::Il2CppArray<::Class_1_0AD6129525BF5F86*>* MMGFBHHLLOA; // 0x40
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x48
	::System::Collections::Generic::List_1<::Class_3_07C3C4D2990C49EE*>* NINIMEBKNLO; // 0x50
	::System::Int32 KNLANGKFPLG; // 0x58
	::System::Int32 BLMPGAGBHHK; // 0x5C
	::System::Int32 BCMHNNPGGBD; // 0x60
	::System::Single LCBECIBFJCC; // 0x64
