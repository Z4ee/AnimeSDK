...
#define CLASS_3_574F9B0E9A5893A3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17BDFFF0)
#define CLASS_3_574F9B0E9A5893A3__CTOR_OFFSET UNITYSDK_OFFSET(0x17BDFFC0)

inline static constexpr unsigned int Class_3_574F9B0E9A5893A3_TypeDefinitionIndex = 55183;
