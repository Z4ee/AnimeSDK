...
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1033DD50)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1033C160)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_0_OFFSET UNITYSDK_OFFSET(0x1033C170)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_10_OFFSET UNITYSDK_OFFSET(0x102E2650)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_11_OFFSET UNITYSDK_OFFSET(0x1033C350)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_12_OFFSET UNITYSDK_OFFSET(0x102E0630)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_13_OFFSET UNITYSDK_OFFSET(0x102E1090)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_14_OFFSET UNITYSDK_OFFSET(0x1033C490)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_15_OFFSET UNITYSDK_OFFSET(0x1033C650)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_16_OFFSET UNITYSDK_OFFSET(0x1033C850)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_17_OFFSET UNITYSDK_OFFSET(0x1033CA70)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_18_OFFSET UNITYSDK_OFFSET(0x1033CC80)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_19_OFFSET UNITYSDK_OFFSET(0x1033CE70)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_1_OFFSET UNITYSDK_OFFSET(0x102DEE40)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_20_OFFSET UNITYSDK_OFFSET(0x1033D090)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_21_OFFSET UNITYSDK_OFFSET(0x1033D2D0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_22_OFFSET UNITYSDK_OFFSET(0x1033D4E0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_23_OFFSET UNITYSDK_OFFSET(0x1033D630)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_24_OFFSET UNITYSDK_OFFSET(0x1033D780)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_25_OFFSET UNITYSDK_OFFSET(0x1033D910)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_26_OFFSET UNITYSDK_OFFSET(0x1033DA40)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_27_OFFSET UNITYSDK_OFFSET(0x1033DBD0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_2_OFFSET UNITYSDK_OFFSET(0x102DAF90)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_3_OFFSET UNITYSDK_OFFSET(0x102DF750)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_4_OFFSET UNITYSDK_OFFSET(0x102DEA50)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_5_OFFSET UNITYSDK_OFFSET(0x102DF380)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_6_OFFSET UNITYSDK_OFFSET(0x102DF550)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_7_OFFSET UNITYSDK_OFFSET(0x102DF1C0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_8_OFFSET UNITYSDK_OFFSET(0x102DEBA0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_9_OFFSET UNITYSDK_OFFSET(0x102DEF90)

namespace IFix
{
	inline static constexpr unsigned int ILFixDynamicMethodWrapper_TypeDefinitionIndex = 85957;
	...
	public:
		...
		{
			return (::Il2CppArray<::IFix::ILFixDynamicMethodWrapper*>**)Il2CppClass::FromTypeDefinitionIndex(ILFixDynamicMethodWrapper_TypeDefinitionIndex)->GetStaticField(0x4AC20);
		}
