...
#define IFIX_ILFIXINTERFACEBRIDGE_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x11A0C120)
#define IFIX_ILFIXINTERFACEBRIDGE_REFASYNCBUILDERSTARTMETHOD_OFFSET UNITYSDK_OFFSET(0x11A0D1A0)
#define IFIX_ILFIXINTERFACEBRIDGE_REFAWAITUNSAFEONCOMPLETEMETHOD_OFFSET UNITYSDK_OFFSET(0x11A0D070)
#define IFIX_ILFIXINTERFACEBRIDGE_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x11A0C240)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x11A0CAB0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11A0CC90)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11A0C680)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x11A0C8D0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11A0C380)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x11A0C250)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x11A0C560)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11A0C7B0)
#define IFIX_ILFIXINTERFACEBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x11A0CE70)

namespace IFix
{
	inline static constexpr unsigned int ILFixInterfaceBridge_TypeDefinitionIndex = 91485;

	class ILFixInterfaceBridge : public ::IFix::Core::AnonymousStorey
	{
	public:
		::System::Int32 methodId_2; // 0x40
		::System::Int32 methodId_9; // 0x44
		::System::Int32 methodId_6; // 0x48
		::System::Int32 methodId_0; // 0x4C
		::System::Int32 methodId_4; // 0x50
		::System::Int32 methodId_3; // 0x54
		::System::Int32 methodId_7; // 0x58
		::System::Int32 methodId_1; // 0x5C
		::System::Int32 methodId_8; // 0x60
		::System::Int32 methodId_5; // 0x64
