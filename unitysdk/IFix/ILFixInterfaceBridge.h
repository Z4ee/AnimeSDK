...
#define IFIX_ILFIXINTERFACEBRIDGE_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1033DDA0)
#define IFIX_ILFIXINTERFACEBRIDGE_REFASYNCBUILDERSTARTMETHOD_OFFSET UNITYSDK_OFFSET(0x1033EE20)
#define IFIX_ILFIXINTERFACEBRIDGE_REFAWAITUNSAFEONCOMPLETEMETHOD_OFFSET UNITYSDK_OFFSET(0x1033ECF0)
#define IFIX_ILFIXINTERFACEBRIDGE_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1033DEC0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1033E730)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1033E910)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1033E300)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1033E550)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1033E000)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1033DED0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1033E1E0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1033E430)
#define IFIX_ILFIXINTERFACEBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1033EAF0)

namespace IFix
{
	inline static constexpr unsigned int ILFixInterfaceBridge_TypeDefinitionIndex = 85954;

	class ILFixInterfaceBridge : public ::IFix::Core::AnonymousStorey
	{
	public:
		::System::Int32 methodId_6; // 0x40
		::System::Int32 methodId_7; // 0x44
		::System::Int32 methodId_4; // 0x48
		::System::Int32 methodId_3; // 0x4C
		::System::Int32 methodId_8; // 0x50
		::System::Int32 methodId_1; // 0x54
		::System::Int32 methodId_5; // 0x58
		::System::Int32 methodId_0; // 0x5C
		::System::Int32 methodId_2; // 0x60
