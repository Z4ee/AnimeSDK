...
#define IFIX_CORE_PATCHMANAGER__LOAD_C__ANONSTOREY1__CTOR_OFFSET UNITYSDK_OFFSET(0x15B48D60)
#define IFIX_CORE_PATCHMANAGER__LOAD_C__ANONSTOREY1___M__0_OFFSET UNITYSDK_OFFSET(0x15B4E680)

namespace IFix::Core
{
	inline static constexpr unsigned int PatchManager__Load_c__AnonStorey1_TypeDefinitionIndex = 9782;
