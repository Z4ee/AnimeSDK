...
#define IFIX_CORE_REFLECTIONMETHODINVOKER_DESCRIBEOBJECTARRAY_OFFSET UNITYSDK_OFFSET(0x1B4CEBA0)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_DESCRIBEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4CE6A0)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_DUMPASYNCBUILDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1B4CECF0)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_FORMATARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1B4CE570)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_FORMATVALUE_OFFSET UNITYSDK_OFFSET(0x1B4CE2A0)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B4CDCB0)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4CF760)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_ISASYNCMETHODBUILDERDIAGNOSTICMETHOD_OFFSET UNITYSDK_OFFSET(0x1B4CDD70)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_ISWRITABLEVALUETYPETHISREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4CDD50)
#define IFIX_CORE_REFLECTIONMETHODINVOKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CCE40)
