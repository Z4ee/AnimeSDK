...
#define IFIX_CORE_CALL_BEGINFORSTACK_OFFSET UNITYSDK_OFFSET(0x1A78BCF0)
#define IFIX_CORE_CALL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A78BAD0)
#define IFIX_CORE_CALL_END_OFFSET UNITYSDK_OFFSET(0x1A78CA40)
#define IFIX_CORE_CALL_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8FA700)
#define IFIX_CORE_CALL_GETBYTE_OFFSET UNITYSDK_OFFSET(0x8FA730)
#define IFIX_CORE_CALL_GETCHAR_OFFSET UNITYSDK_OFFSET(0x8FA7C0)
#define IFIX_CORE_CALL_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x8FA970)
#define IFIX_CORE_CALL_GETINT16_OFFSET UNITYSDK_OFFSET(0x8FA7C0)
#define IFIX_CORE_CALL_GETINT32_OFFSET UNITYSDK_OFFSET(0x8FA850)
#define IFIX_CORE_CALL_GETINT64_OFFSET UNITYSDK_OFFSET(0x8FA8B0)
#define IFIX_CORE_CALL_GETINTPTR_OFFSET UNITYSDK_OFFSET(0x8FA8B0)
#define IFIX_CORE_CALL_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x8FAA30)
#define IFIX_CORE_CALL_GETSBYTE_OFFSET UNITYSDK_OFFSET(0x8FA730)
#define IFIX_CORE_CALL_GETSINGLE_OFFSET UNITYSDK_OFFSET(0x8FA910)
#define IFIX_CORE_CALL_GETUINT16_OFFSET UNITYSDK_OFFSET(0x8FA7C0)
#define IFIX_CORE_CALL_GETUINT32_OFFSET UNITYSDK_OFFSET(0x8FA850)
#define IFIX_CORE_CALL_GETUINT64_OFFSET UNITYSDK_OFFSET(0x8FA8B0)
#define IFIX_CORE_CALL_GETUINTPTR_OFFSET UNITYSDK_OFFSET(0x8FA9A0)
#define IFIX_CORE_CALL_PUSHBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8FA6D0)
#define IFIX_CORE_CALL_PUSHBYTE_OFFSET UNITYSDK_OFFSET(0x8FA6D0)
#define IFIX_CORE_CALL_PUSHCHAR_OFFSET UNITYSDK_OFFSET(0x8FA7F0)
#define IFIX_CORE_CALL_PUSHDOUBLE_OFFSET UNITYSDK_OFFSET(0x8FA940)
#define IFIX_CORE_CALL_PUSHINT16_OFFSET UNITYSDK_OFFSET(0x8FA790)
#define IFIX_CORE_CALL_PUSHINT32_OFFSET UNITYSDK_OFFSET(0x8FA820)
#define IFIX_CORE_CALL_PUSHINT64_OFFSET UNITYSDK_OFFSET(0x8FA880)
#define IFIX_CORE_CALL_PUSHINTPTR_OFFSET UNITYSDK_OFFSET(0x8FA880)
#define IFIX_CORE_CALL_PUSHOBJECTASRESULT_OFFSET UNITYSDK_OFFSET(0x8FAA40)
#define IFIX_CORE_CALL_PUSHOBJECT_OFFSET UNITYSDK_OFFSET(0x8FAA10)
#define IFIX_CORE_CALL_PUSHREF_OFFSET UNITYSDK_OFFSET(0x8FAA80)
#define IFIX_CORE_CALL_PUSHSBYTE_OFFSET UNITYSDK_OFFSET(0x8FA760)
#define IFIX_CORE_CALL_PUSHSINGLE_OFFSET UNITYSDK_OFFSET(0x8FA8E0)
#define IFIX_CORE_CALL_PUSHUINT16_OFFSET UNITYSDK_OFFSET(0x8FA7F0)
#define IFIX_CORE_CALL_PUSHUINT32_OFFSET UNITYSDK_OFFSET(0x8FA820)
#define IFIX_CORE_CALL_PUSHUINT64_OFFSET UNITYSDK_OFFSET(0x8FA880)
#define IFIX_CORE_CALL_PUSHUINTPTR_OFFSET UNITYSDK_OFFSET(0x8FA880)
#define IFIX_CORE_CALL_PUSHVALUETYPE_OFFSET UNITYSDK_OFFSET(0x8FAA20)
#define IFIX_CORE_CALL_UPDATEREFERENCE_OFFSET UNITYSDK_OFFSET(0x8FAAC0)

namespace IFix::Core
{
	inline static constexpr unsigned int Call_TypeDefinitionIndex = 6812;
