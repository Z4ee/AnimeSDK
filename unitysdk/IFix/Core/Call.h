...
#define IFIX_CORE_CALL_BEGINFORSTACK_OFFSET UNITYSDK_OFFSET(0x1E07AB70)
#define IFIX_CORE_CALL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1E07A950)
#define IFIX_CORE_CALL_END_OFFSET UNITYSDK_OFFSET(0x1E07B920)
#define IFIX_CORE_CALL_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0xA00A80)
#define IFIX_CORE_CALL_GETBYTE_OFFSET UNITYSDK_OFFSET(0xA00AB0)
#define IFIX_CORE_CALL_GETCHAR_OFFSET UNITYSDK_OFFSET(0xA00B40)
#define IFIX_CORE_CALL_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0xA00CF0)
#define IFIX_CORE_CALL_GETINT16_OFFSET UNITYSDK_OFFSET(0xA00B40)
#define IFIX_CORE_CALL_GETINT32_OFFSET UNITYSDK_OFFSET(0xA00BD0)
#define IFIX_CORE_CALL_GETINT64_OFFSET UNITYSDK_OFFSET(0xA00C30)
#define IFIX_CORE_CALL_GETINTPTR_OFFSET UNITYSDK_OFFSET(0xA00C30)
#define IFIX_CORE_CALL_GETOBJECT_OFFSET UNITYSDK_OFFSET(0xA00DB0)
#define IFIX_CORE_CALL_GETSBYTE_OFFSET UNITYSDK_OFFSET(0xA00AB0)
#define IFIX_CORE_CALL_GETSINGLE_OFFSET UNITYSDK_OFFSET(0xA00C90)
#define IFIX_CORE_CALL_GETUINT16_OFFSET UNITYSDK_OFFSET(0xA00B40)
#define IFIX_CORE_CALL_GETUINT32_OFFSET UNITYSDK_OFFSET(0xA00BD0)
#define IFIX_CORE_CALL_GETUINT64_OFFSET UNITYSDK_OFFSET(0xA00C30)
#define IFIX_CORE_CALL_GETUINTPTR_OFFSET UNITYSDK_OFFSET(0xA00D20)
#define IFIX_CORE_CALL_PUSHBOOLEAN_OFFSET UNITYSDK_OFFSET(0xA00A50)
#define IFIX_CORE_CALL_PUSHBYTE_OFFSET UNITYSDK_OFFSET(0xA00A50)
#define IFIX_CORE_CALL_PUSHCHAR_OFFSET UNITYSDK_OFFSET(0xA00B70)
#define IFIX_CORE_CALL_PUSHDOUBLE_OFFSET UNITYSDK_OFFSET(0xA00CC0)
#define IFIX_CORE_CALL_PUSHINT16_OFFSET UNITYSDK_OFFSET(0xA00B10)
#define IFIX_CORE_CALL_PUSHINT32_OFFSET UNITYSDK_OFFSET(0xA00BA0)
#define IFIX_CORE_CALL_PUSHINT64_OFFSET UNITYSDK_OFFSET(0xA00C00)
#define IFIX_CORE_CALL_PUSHINTPTR_OFFSET UNITYSDK_OFFSET(0xA00C00)
#define IFIX_CORE_CALL_PUSHOBJECTASRESULT_OFFSET UNITYSDK_OFFSET(0xA00DC0)
#define IFIX_CORE_CALL_PUSHOBJECT_OFFSET UNITYSDK_OFFSET(0xA00D90)
#define IFIX_CORE_CALL_PUSHREF_OFFSET UNITYSDK_OFFSET(0xA00E00)
#define IFIX_CORE_CALL_PUSHSBYTE_OFFSET UNITYSDK_OFFSET(0xA00AE0)
#define IFIX_CORE_CALL_PUSHSINGLE_OFFSET UNITYSDK_OFFSET(0xA00C60)
#define IFIX_CORE_CALL_PUSHUINT16_OFFSET UNITYSDK_OFFSET(0xA00B70)
#define IFIX_CORE_CALL_PUSHUINT32_OFFSET UNITYSDK_OFFSET(0xA00BA0)
#define IFIX_CORE_CALL_PUSHUINT64_OFFSET UNITYSDK_OFFSET(0xA00C00)
#define IFIX_CORE_CALL_PUSHUINTPTR_OFFSET UNITYSDK_OFFSET(0xA00C00)
#define IFIX_CORE_CALL_PUSHVALUETYPE_OFFSET UNITYSDK_OFFSET(0xA00DA0)
#define IFIX_CORE_CALL_UPDATEREFERENCE_OFFSET UNITYSDK_OFFSET(0xA00E40)

namespace IFix::Core
{
	inline static constexpr unsigned int Call_TypeDefinitionIndex = 6947;
