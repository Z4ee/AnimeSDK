...
#define IFIX_CORE_SIMPLEVIRTUALMACHINEBUILDER_CREATEVIRTUALMACHINE_OFFSET UNITYSDK_OFFSET(0x1A796720)
#define IFIX_CORE_SIMPLEVIRTUALMACHINEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A796D70)
