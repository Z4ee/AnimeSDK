...
#define IFIX_CORE_SIMPLEVIRTUALMACHINEBUILDER_CREATEVIRTUALMACHINE_OFFSET UNITYSDK_OFFSET(0x1CAA66E0)
#define IFIX_CORE_SIMPLEVIRTUALMACHINEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAA6D40)

namespace IFix::Core
{
	inline static constexpr unsigned int SimpleVirtualMachineBuilder_TypeDefinitionIndex = 6922;
