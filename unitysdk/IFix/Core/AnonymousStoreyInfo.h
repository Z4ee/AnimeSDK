...
#define IFIX_CORE_ANONYMOUSSTOREYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E07A940)

namespace IFix::Core
{
	inline static constexpr unsigned int AnonymousStoreyInfo_TypeDefinitionIndex = 6929;
