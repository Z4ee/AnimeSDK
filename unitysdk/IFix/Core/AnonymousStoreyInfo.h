...
#define IFIX_CORE_ANONYMOUSSTOREYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17F87FE0)

namespace IFix::Core
{
	inline static constexpr unsigned int AnonymousStoreyInfo_TypeDefinitionIndex = 9755;
