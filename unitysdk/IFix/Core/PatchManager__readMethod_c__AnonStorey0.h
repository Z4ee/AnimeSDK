...
#define IFIX_CORE_PATCHMANAGER__READMETHOD_C__ANONSTOREY0__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8D050)
#define IFIX_CORE_PATCHMANAGER__READMETHOD_C__ANONSTOREY0___M__0_OFFSET UNITYSDK_OFFSET(0x17F970C0)

namespace IFix::Core
{
	inline static constexpr unsigned int PatchManager__readMethod_c__AnonStorey0_TypeDefinitionIndex = 9743;
