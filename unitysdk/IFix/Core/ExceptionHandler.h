...
#define IFIX_CORE_EXCEPTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1713F1B0)

namespace IFix::Core
{
	inline static constexpr unsigned int ExceptionHandler_TypeDefinitionIndex = 9926;
