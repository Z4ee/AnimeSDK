...
#define IFIX_CORE_EXCEPTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8A7C0)

namespace IFix::Core
{
	inline static constexpr unsigned int ExceptionHandler_TypeDefinitionIndex = 9753;
