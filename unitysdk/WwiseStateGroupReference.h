...
#define WWISESTATEGROUPREFERENCE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x18C4F710)
#define WWISESTATEGROUPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4F720)

inline static constexpr unsigned int WwiseStateGroupReference_TypeDefinitionIndex = 34625;
