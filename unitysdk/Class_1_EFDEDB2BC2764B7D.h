...
#define CLASS_1_EFDEDB2BC2764B7D_METHOD_1_B801C940FC77F45B_OFFSET UNITYSDK_OFFSET(0x1BF86950)
#define CLASS_1_EFDEDB2BC2764B7D_METHOD_1_F6634A5119C618EF_OFFSET UNITYSDK_OFFSET(0x1BF86A20)
#define CLASS_1_EFDEDB2BC2764B7D__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF887A0)
...
{
public:
	::Class_1_5F4E83900A3DADCA* PNIDCBNNGDC; // 0x10
	::Il2CppArray<::Class_1_3DEF26C653AFADFD*>* KPJHIOKBJEI; // 0x18
	::Class_1_3DEF26C653AFADFD* EOBLJJBOBIN; // 0x20
	::Class_1_3DEF26C653AFADFD* IHIEIEHJJIN; // 0x28
	::Class_1_D975FC0407AA8C9D* DLAKJKEADPN; // 0x30
	::Class_1_D975FC0407AA8C9D* BEGKIKOGEOD; // 0x38
	::Class_1_66C3ADF82330F716* ALPKKNKAFBG; // 0x40
	::System::Collections::Generic::List_1<::Class_1_3DEF26C653AFADFD*>* HGCNLFIMDKL; // 0x48
	::Class_1_3DEF26C653AFADFD* JNICAKGMMPI; // 0x50
	::System::UInt32 GHMHMKINNEJ; // 0x58
	::RPG::Client::LittleGame::Marble::MarbleHpType FGKNABDECLA; // 0x5C
