...
#define CLASS_2_3599A4AF648C0693_DISPOSE_OFFSET UNITYSDK_OFFSET(0x186FF780)
#define CLASS_2_3599A4AF648C0693_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x186FF9D0)
#define CLASS_2_3599A4AF648C0693_METHOD_2_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x186FF810)
#define CLASS_2_3599A4AF648C0693_ONSKIP_OFFSET UNITYSDK_OFFSET(0x186FF9E0)
#define CLASS_2_3599A4AF648C0693_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x186FF7C0)
#define CLASS_2_3599A4AF648C0693_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x186FF920)
#define CLASS_2_3599A4AF648C0693_TICK_OFFSET UNITYSDK_OFFSET(0x186FF970)
#define CLASS_2_3599A4AF648C0693__CTOR_OFFSET UNITYSDK_OFFSET(0x186FF770)

inline static constexpr unsigned int Class_2_3599A4AF648C0693_TypeDefinitionIndex = 55494;

class Class_2_3599A4AF648C0693 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::DestroyCharacter* Field_2_1; // 0x20
