...
#define CLASS_1_5B567C8A01BAEDFE_333_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C87EEF0)
#define CLASS_1_5B567C8A01BAEDFE_333_CLONE_OFFSET UNITYSDK_OFFSET(0x1CF14FB0)
#define CLASS_1_5B567C8A01BAEDFE_333_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C87ECF0)
#define CLASS_1_5B567C8A01BAEDFE_333_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C87EC20)
#define CLASS_1_5B567C8A01BAEDFE_333_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C87EE50)
#define CLASS_1_5B567C8A01BAEDFE_333_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C87EF40)
#define CLASS_1_5B567C8A01BAEDFE_333_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C87EF10)
#define CLASS_1_5B567C8A01BAEDFE_333_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CF14F30)
#define CLASS_1_5B567C8A01BAEDFE_333_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CF14F60)
#define CLASS_1_5B567C8A01BAEDFE_333_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C87EE80)
#define CLASS_1_5B567C8A01BAEDFE_333_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C87EEE0)
#define CLASS_1_5B567C8A01BAEDFE_333__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C87EF90)
#define CLASS_1_5B567C8A01BAEDFE_333__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CF14F80)
#define CLASS_1_5B567C8A01BAEDFE_333__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF14F70)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_333_TypeDefinitionIndex = 32853;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_333*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_333_TypeDefinitionIndex)->GetStaticField(0x64B70);
	}
