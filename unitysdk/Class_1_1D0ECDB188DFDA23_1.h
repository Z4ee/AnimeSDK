...
#define CLASS_1_1D0ECDB188DFDA23_1_METHOD_1_DE4BEDE065ECDB87_OFFSET UNITYSDK_OFFSET(0x17653C90)
#define CLASS_1_1D0ECDB188DFDA23_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17653D30)

inline static constexpr unsigned int Class_1_1D0ECDB188DFDA23_1_TypeDefinitionIndex = 76000;
...
public:
	...
	{
		return ((::RPG::Client::FateRin::Battle::IFateRinBattleHudInputBrain*(*)(::PVOID, ::RPG::Client::FateRin::Battle::IFateRinBattleHudCardAreaViewModel*, ::RPG::Client::FateRin::Battle::IFateRinCardHitTestService*, ::Class_0_16E4307DCC419505_1267*))((::PBYTE)hIl2Cpp + CLASS_1_1D0ECDB188DFDA23_1_METHOD_1_DE4BEDE065ECDB87_OFFSET))(this, a1, a2, a3);
	}
};
