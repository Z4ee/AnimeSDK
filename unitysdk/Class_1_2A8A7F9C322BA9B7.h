...
#define CLASS_1_2A8A7F9C322BA9B7__CTOR_OFFSET UNITYSDK_OFFSET(0x162DB980)
...
public:
	...
	::System::Single AALPICLABCO; // 0x18
	::RPG::GameCore::AnimatorParameterType JBPNBECLGKN; // 0x1C
