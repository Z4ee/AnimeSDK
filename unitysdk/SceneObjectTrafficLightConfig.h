...
#define SCENEOBJECTTRAFFICLIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C59350)

inline static constexpr unsigned int SceneObjectTrafficLightConfig_TypeDefinitionIndex = 67256;
