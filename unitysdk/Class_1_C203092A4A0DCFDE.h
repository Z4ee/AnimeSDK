...
#define CLASS_1_C203092A4A0DCFDE_METHOD_1_BA928C31B09C0D39_OFFSET UNITYSDK_OFFSET(0x1C861210)
#define CLASS_1_C203092A4A0DCFDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C861650)
...
public:
	...
	::System::UInt32 ELGNMHLEEEH; // 0x20
	::RPG::GameCore::LimaoNewsOfficeEventPriorityType GMPGDEINODK; // 0x24
	::RPG::Client::TextID LDBCBEDHFPD; // 0x28
	::System::UInt32 CPCMBMBFBAI; // 0x38
	::System::UInt32 DNOENIFOBLJ; // 0x3C
	::System::UInt32 NALKJIAJIJK; // 0x40
	::System::UInt32 HPLHMBBGAOO; // 0x44
	::System::UInt32 NMBKAIEIAPE; // 0x48
	::System::UInt32 GHOCDNJOCBH; // 0x4C
