...
#define LAYOUTLIMITER_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x14E74BC0)
#define LAYOUTLIMITER_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x14E74C00)
#define LAYOUTLIMITER_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x14E74BA0)
#define LAYOUTLIMITER_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x14E74B90)
#define LAYOUTLIMITER_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x14E74BB0)
#define LAYOUTLIMITER_GET_MINHEIGHTLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E74880)
#define LAYOUTLIMITER_GET_MINHEIGHTLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E747F0)
#define LAYOUTLIMITER_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x14E74B60)
#define LAYOUTLIMITER_GET_MINWIDTHLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E74760)
#define LAYOUTLIMITER_GET_MINWIDTHLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E745C0)
#define LAYOUTLIMITER_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x14E74B50)
#define LAYOUTLIMITER_GET_PREFERREDHEIGHTLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E74AC0)
#define LAYOUTLIMITER_GET_PREFERREDHEIGHTLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E74A30)
#define LAYOUTLIMITER_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x14E74B80)
#define LAYOUTLIMITER_GET_PREFERREDWIDTHLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E749A0)
#define LAYOUTLIMITER_GET_PREFERREDWIDTHLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E74910)
#define LAYOUTLIMITER_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x14E74B70)
#define LAYOUTLIMITER_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x14E74EB0)
#define LAYOUTLIMITER_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x14E74E60)
#define LAYOUTLIMITER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14E74D00)
#define LAYOUTLIMITER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14E74C40)
#define LAYOUTLIMITER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x14E74D80)
#define LAYOUTLIMITER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x14E74DF0)
#define LAYOUTLIMITER_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x14E74CB0)
#define LAYOUTLIMITER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x14E74650)
#define LAYOUTLIMITER_SET_MINHEIGHTLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E74890)
#define LAYOUTLIMITER_SET_MINHEIGHTLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E74800)
#define LAYOUTLIMITER_SET_MINWIDTHLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E74770)
#define LAYOUTLIMITER_SET_MINWIDTHLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E745D0)
#define LAYOUTLIMITER_SET_PREFERREDHEIGHTLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E74AD0)
#define LAYOUTLIMITER_SET_PREFERREDHEIGHTLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E74A40)
#define LAYOUTLIMITER_SET_PREFERREDWIDTHLIMITMAX_OFFSET UNITYSDK_OFFSET(0x14E749B0)
#define LAYOUTLIMITER_SET_PREFERREDWIDTHLIMITMIN_OFFSET UNITYSDK_OFFSET(0x14E74920)
#define LAYOUTLIMITER__CTOR_OFFSET UNITYSDK_OFFSET(0x14E74F00)
#define LAYOUTLIMITER___BASE_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x14E74F60)
#define LAYOUTLIMITER___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x14E74FF0)
#define LAYOUTLIMITER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14E75080)
#define LAYOUTLIMITER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14E75110)
#define LAYOUTLIMITER___BASE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x14E751A0)
#define LAYOUTLIMITER___BASE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x14E75230)
#define LAYOUTLIMITER___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x14E752C0)

inline static constexpr unsigned int LayoutLimiter_TypeDefinitionIndex = 84509;
