...
#define CLASS_3_CBA1E7FD4C82B228_METHOD_3_797574F762C9D389_OFFSET UNITYSDK_OFFSET(0x1CF433E0)
#define CLASS_3_CBA1E7FD4C82B228_METHOD_3_A18832F1E35D7A11_OFFSET UNITYSDK_OFFSET(0x1CF43330)
#define CLASS_3_CBA1E7FD4C82B228__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF433A0)
...
{
public:
	::Il2CppArray<::System::String*>* COIKNMHIEPK; // 0x18
	::RPG::GameCore::ValueEvaluatorConfig* MNDFOPKBHKP; // 0x20
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x28
	::Il2CppArray<::RPG::GameCore::JsonEnum*>* KGIDDABCHON; // 0x30
	::Il2CppArray<::RPG::GameCore::SkillType>* OOOPJAECBIN; // 0x38
	::RPG::GameCore::RtSkillPropertyType ACHILGIPGKL; // 0x40
	::RPG::GameCore::PropertyModifyFunction KFAPHPGFEMK; // 0x44
