...
#define CLASS_1_5B567C8A01BAEDFE_175_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DEF8F50)
#define CLASS_1_5B567C8A01BAEDFE_175_CLONE_OFFSET UNITYSDK_OFFSET(0x1DEF8C40)
#define CLASS_1_5B567C8A01BAEDFE_175_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DEF8D50)
#define CLASS_1_5B567C8A01BAEDFE_175_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEF8C80)
#define CLASS_1_5B567C8A01BAEDFE_175_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEF8EB0)
#define CLASS_1_5B567C8A01BAEDFE_175_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DEF8FA0)
#define CLASS_1_5B567C8A01BAEDFE_175_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DEF8F70)
#define CLASS_1_5B567C8A01BAEDFE_175_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DEF8BC0)
#define CLASS_1_5B567C8A01BAEDFE_175_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DEF8BF0)
#define CLASS_1_5B567C8A01BAEDFE_175_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEF8EE0)
#define CLASS_1_5B567C8A01BAEDFE_175_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DEF8F40)
#define CLASS_1_5B567C8A01BAEDFE_175__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEF8FF0)
#define CLASS_1_5B567C8A01BAEDFE_175__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEF8C10)
#define CLASS_1_5B567C8A01BAEDFE_175__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEF8C00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_175_TypeDefinitionIndex = 29493;

class Class_1_5B567C8A01BAEDFE_175 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_175*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_175*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_175_TypeDefinitionIndex)->GetStaticField(0x3AA50);
	}
