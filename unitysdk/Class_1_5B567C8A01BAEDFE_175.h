...
#define CLASS_1_5B567C8A01BAEDFE_175_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A602080)
#define CLASS_1_5B567C8A01BAEDFE_175_CLONE_OFFSET UNITYSDK_OFFSET(0x1A601E90)
#define CLASS_1_5B567C8A01BAEDFE_175_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A601F90)
#define CLASS_1_5B567C8A01BAEDFE_175_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A601F00)
#define CLASS_1_5B567C8A01BAEDFE_175_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A601FE0)
#define CLASS_1_5B567C8A01BAEDFE_175_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6020D0)
#define CLASS_1_5B567C8A01BAEDFE_175_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6020A0)
#define CLASS_1_5B567C8A01BAEDFE_175_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A601DE0)
#define CLASS_1_5B567C8A01BAEDFE_175_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A601E40)
#define CLASS_1_5B567C8A01BAEDFE_175_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A602010)
#define CLASS_1_5B567C8A01BAEDFE_175_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A602070)
#define CLASS_1_5B567C8A01BAEDFE_175__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A602120)
#define CLASS_1_5B567C8A01BAEDFE_175__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A601E60)
#define CLASS_1_5B567C8A01BAEDFE_175__CTOR_OFFSET UNITYSDK_OFFSET(0x1A601E50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_175_TypeDefinitionIndex = 28246;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_175*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_175_TypeDefinitionIndex)->GetStaticField(0x23250);
	}
