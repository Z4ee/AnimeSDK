...
#define STRUCT_2_0DF816E1E5ADA9CA__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)

inline static constexpr unsigned int Struct_2_0DF816E1E5ADA9CA_TypeDefinitionIndex = 63489;

struct alignas(4) Struct_2_0DF816E1E5ADA9CA
{
	::MoleMole::InputLogicEventType Field_2_1; // 0x10
	::MoleMole::ButtonPressType Field_2_0; // 0x14
