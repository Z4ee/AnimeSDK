...
#define CLASS_2_DAB8355A2CB27364_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17BA0E70)
#define CLASS_2_DAB8355A2CB27364_METHOD_2_123DFB09BD2C9B9E_OFFSET UNITYSDK_OFFSET(0x17BA1F00)
#define CLASS_2_DAB8355A2CB27364_METHOD_2_AC3D041EA6F5D8CC_OFFSET UNITYSDK_OFFSET(0x17BA1DC0)
#define CLASS_2_DAB8355A2CB27364_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17BA0EB0)
#define CLASS_2_DAB8355A2CB27364_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17BA1A80)
#define CLASS_2_DAB8355A2CB27364_TICK_OFFSET UNITYSDK_OFFSET(0x17BA1B40)
#define CLASS_2_DAB8355A2CB27364__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA0DD0)
...
{
public:
	::Struct_2_CC45B4503679E14E_58 EJPILIBEFCB; // 0x18
	::RPG::GameCore::TriggerAnimState* OFKGLJOAMLD; // 0x28
	::RPG::GameCore::GameEntity* IEKCMJJGLOH; // 0x30
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x38
	::UnityEngine::Animator* JDFCDMAPBFJ; // 0x40
	::System::Int32 APNGJPMPMOB; // 0x48
	::System::UInt32 APAOCDBHPKE; // 0x4C
