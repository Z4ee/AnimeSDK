...
#define CLASS_2_4629AB2A15889FA9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16B7A520)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_04614C8577B9CBA7_OFFSET UNITYSDK_OFFSET(0x16B7EB50)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_0C0A3218A683115F_OFFSET UNITYSDK_OFFSET(0x16B7D060)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_2233B4E123DC1DDC_OFFSET UNITYSDK_OFFSET(0x16B7DAE0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_2417C60F698028CC_OFFSET UNITYSDK_OFFSET(0x16B7EA90)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_3135A9ED542D4190_OFFSET UNITYSDK_OFFSET(0x16B7DE60)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_39B767C5ADFEA9A8_OFFSET UNITYSDK_OFFSET(0x16B7E210)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x16B7A960)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0x16B7D670)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x16B7E060)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0x16B7F370)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_99F4734274043F32_OFFSET UNITYSDK_OFFSET(0x16B7E630)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_9E035F4BAE220AC2_OFFSET UNITYSDK_OFFSET(0x16B7E0E0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_A44A18C9451109E4_OFFSET UNITYSDK_OFFSET(0x16B7A9B0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_A874B8D50E15661E_OFFSET UNITYSDK_OFFSET(0x16B7A310)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_AC66361361CE73AE_OFFSET UNITYSDK_OFFSET(0x16B7A4B0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_ACF26DFF0EC20E9A_OFFSET UNITYSDK_OFFSET(0x16B7DCD0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x16B7F360)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_C15A9F455BC461DE_OFFSET UNITYSDK_OFFSET(0x16B7AC30)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_DF5D3BC3B2604D3A_OFFSET UNITYSDK_OFFSET(0x16B7D930)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_EAC2737A96E071C9_OFFSET UNITYSDK_OFFSET(0x16B7A590)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x16B7F0D0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_FD2A5158841A130C_OFFSET UNITYSDK_OFFSET(0x16B7F2C0)
#define CLASS_2_4629AB2A15889FA9__CTOR_OFFSET UNITYSDK_OFFSET(0x16B7F3D0)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x5B220);
	}
	static ::System::Collections::Generic::List_1<::AttachPointSet*>** StaticGet_BGOBEFIFMJJ()
	{
		return (::System::Collections::Generic::List_1<::AttachPointSet*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x5B228);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::Renderer*>** StaticGet_POFDHALAIMC()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Renderer*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x5B230);
	}
	::Class_1_A0302E9AE0B8A2B9* IGABAMILIDM; // 0x18
	::Class_1_1342B57709FD7AC5* OIDAGBPPNBJ; // 0x20
	::RPG::Client::FollowPointMapping* AMIAMLBIEEN; // 0x28
	::UnityEngine::Transform* HKJLEHMGONC; // 0x30
	::RPG::GameCore::CharacterOutfitComponent_CharacterOutfitInstance* FEIFBICKDIJ; // 0x38
	::UnityEngine::GameObject* JIAPNIHGPJA; // 0x40
	::Il2CppArray<::RPG::Client::MonoEffectPluginCharaMaterialBlock*>* HFCELNDHIIH; // 0x48
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* GHKPEACJIAD; // 0x50
	::RPG::Client::AttachPointMapping* KFDNFOFPLII; // 0x58
	::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* GPFNBKEBJII; // 0x60
	::UnityEngine::Animator* APPGGMLEPLN; // 0x68
	::RPG::GameCore::GameEntity* NDDEIKDADAH; // 0x70
	::System::Single HFEBKEBJLME; // 0x78
	::System::Boolean HHIBIFHGOBL; // 0x7C
	::System::Boolean DIMECBLLOGB; // 0x7D
	::System::Int32 KNHPPBIMEGF; // 0x80
