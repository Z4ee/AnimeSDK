...
#define CLASS_2_4629AB2A15889FA9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x144802A0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_04614C8577B9CBA7_OFFSET UNITYSDK_OFFSET(0x144841C0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_0C0A3218A683115F_OFFSET UNITYSDK_OFFSET(0x14482B80)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_2233B4E123DC1DDC_OFFSET UNITYSDK_OFFSET(0x14483150)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_2417C60F698028CC_OFFSET UNITYSDK_OFFSET(0x14484100)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_3135A9ED542D4190_OFFSET UNITYSDK_OFFSET(0x144834D0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_39B767C5ADFEA9A8_OFFSET UNITYSDK_OFFSET(0x14483880)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x144806F0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x144836D0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0x144849E0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_99F4734274043F32_OFFSET UNITYSDK_OFFSET(0x14483CA0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_9E035F4BAE220AC2_OFFSET UNITYSDK_OFFSET(0x14483750)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_A44A18C9451109E4_OFFSET UNITYSDK_OFFSET(0x14480740)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_A874B8D50E15661E_OFFSET UNITYSDK_OFFSET(0x14480090)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_AC66361361CE73AE_OFFSET UNITYSDK_OFFSET(0x14480230)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_ACF26DFF0EC20E9A_OFFSET UNITYSDK_OFFSET(0x14483340)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x144849D0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_C15A9F455BC461DE_OFFSET UNITYSDK_OFFSET(0x144809C0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_DEDB6D705D6319DA_OFFSET UNITYSDK_OFFSET(0x14484A50)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_EAC2737A96E071C9_OFFSET UNITYSDK_OFFSET(0x14480310)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x14484740)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_FD2A5158841A130C_OFFSET UNITYSDK_OFFSET(0x14484930)
#define CLASS_2_4629AB2A15889FA9__CTOR_OFFSET UNITYSDK_OFFSET(0x14484A40)
#define CLASS_2_4629AB2A15889FA9___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14484AB0)

inline static constexpr unsigned int Class_2_4629AB2A15889FA9_TypeDefinitionIndex = 65492;

class Class_2_4629AB2A15889FA9 : public ::RPG::Client::BehaviorBase
{
public:
	static ::System::Collections::Generic::List_1<::UnityEngine::Renderer*>** StaticGet_Field_2_0()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Renderer*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x446D0);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>** StaticGet_Field_2_1()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x446D8);
	}
	static ::System::Collections::Generic::List_1<::AttachPointSet*>** StaticGet_Field_2_2()
	{
		return (::System::Collections::Generic::List_1<::AttachPointSet*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x446E0);
	}
	::RPG::GameCore::GameEntity* Field_2_3; // 0x18
	::RPG::Client::FollowPointMapping* Field_2_4; // 0x20
	::Il2CppArray<::RPG::Client::MonoEffectPluginCharaMaterialBlock*>* Field_2_5; // 0x28
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_2_6; // 0x30
	::Class_1_1342B57709FD7AC5* Field_2_7; // 0x38
	::UnityEngine::Animator* Field_2_8; // 0x40
	::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* Field_2_9; // 0x48
	::UnityEngine::GameObject* Field_2_10; // 0x50
	::UnityEngine::Transform* Field_2_11; // 0x58
	::RPG::Client::AttachPointMapping* Field_2_12; // 0x60
	::RPG::GameCore::CharacterOutfitComponent_CharacterOutfitInstance* Field_2_13; // 0x68
	::Class_1_A0302E9AE0B8A2B9* Field_2_14; // 0x70
	...
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::MonoBehaviour*))((::PBYTE)hIl2Cpp + CLASS_2_4629AB2A15889FA9_METHOD_2_DEDB6D705D6319DA_OFFSET))(this, a1);
	}

	::System::Void __iFixBaseProxy_Dispose()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_4629AB2A15889FA9___IFIXBASEPROXY_DISPOSE_OFFSET))(this);
	}
};
