...
#define CLASS_2_4118F0C63931277E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16CAD380)
#define CLASS_2_4118F0C63931277E_METHOD_2_42D95464172C9267_OFFSET UNITYSDK_OFFSET(0x16CAD530)
#define CLASS_2_4118F0C63931277E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16CAD3C0)
#define CLASS_2_4118F0C63931277E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16CAD6B0)
#define CLASS_2_4118F0C63931277E_TICK_OFFSET UNITYSDK_OFFSET(0x16CAD700)
#define CLASS_2_4118F0C63931277E__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAD370)

inline static constexpr unsigned int Class_2_4118F0C63931277E_TypeDefinitionIndex = 53270;

class Class_2_4118F0C63931277E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::VCameraBlendConfig* Field_2_1; // 0x20
