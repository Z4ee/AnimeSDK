...
#define CLASS_2_E0D2071846C7545F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1387B600)
#define CLASS_2_E0D2071846C7545F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1387B6A0)
#define CLASS_2_E0D2071846C7545F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1387BAA0)
#define CLASS_2_E0D2071846C7545F_TICK_OFFSET UNITYSDK_OFFSET(0x1387BAF0)
#define CLASS_2_E0D2071846C7545F__CTOR_OFFSET UNITYSDK_OFFSET(0x1387B540)

inline static constexpr unsigned int Class_2_E0D2071846C7545F_TypeDefinitionIndex = 51963;

class Class_2_E0D2071846C7545F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StackAdditionalTeamBoostPoint* Field_2_0; // 0x18
	::Class_1_FE960BFE71661018* Field_2_1; // 0x20
