...
#define CLASS_2_E0D2071846C7545F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10BC1A20)
#define CLASS_2_E0D2071846C7545F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10BC1AC0)
#define CLASS_2_E0D2071846C7545F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10BC1E10)
#define CLASS_2_E0D2071846C7545F_TICK_OFFSET UNITYSDK_OFFSET(0x10BC1E60)
#define CLASS_2_E0D2071846C7545F__CTOR_OFFSET UNITYSDK_OFFSET(0x10BC1960)

inline static constexpr unsigned int Class_2_E0D2071846C7545F_TypeDefinitionIndex = 44561;

class Class_2_E0D2071846C7545F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_A0A2B4808490646F* Field_2_2; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::RPG::GameCore::StackAdditionalTeamBoostPoint* Field_2_0; // 0x28
