...
#define SCENETOOLSET_DESIGNTOOL_MONOOBJECTREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A514FF0)

namespace SceneToolSet::DesignTool
{
	inline static constexpr unsigned int MonoObjectRef_TypeDefinitionIndex = 49945;
