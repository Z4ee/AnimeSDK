...
#define EASINGFUNCTION_FUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8365C60)
#define EASINGFUNCTION_FUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8365D00)
#define EASINGFUNCTION_FUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x83658A0)
#define EASINGFUNCTION_FUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8364D30)

inline static constexpr unsigned int EasingFunction_Function_TypeDefinitionIndex = 35103;
