...
#define CLASS_2_E067F907AAEAD5D2_COLLECT_OFFSET UNITYSDK_OFFSET(0x16593C10)
#define CLASS_2_E067F907AAEAD5D2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x165939F0)
#define CLASS_2_E067F907AAEAD5D2_FLUSH_OFFSET UNITYSDK_OFFSET(0x16593D80)
#define CLASS_2_E067F907AAEAD5D2_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x16593FC0)
#define CLASS_2_E067F907AAEAD5D2_METHOD_2_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x16593930)
#define CLASS_2_E067F907AAEAD5D2_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16593990)
#define CLASS_2_E067F907AAEAD5D2_METHOD_2_C62F007113686C62_OFFSET UNITYSDK_OFFSET(0x16593A80)
#define CLASS_2_E067F907AAEAD5D2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16593A40)
#define CLASS_2_E067F907AAEAD5D2_METHOD_2_E960A1DAA7852087_OFFSET UNITYSDK_OFFSET(0x16593B90)
#define CLASS_2_E067F907AAEAD5D2_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16593F80)
#define CLASS_2_E067F907AAEAD5D2_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16593F40)
#define CLASS_2_E067F907AAEAD5D2_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x16593FD0)
#define CLASS_2_E067F907AAEAD5D2__CTOR_OFFSET UNITYSDK_OFFSET(0x16593730)

inline static constexpr unsigned int Class_2_E067F907AAEAD5D2_TypeDefinitionIndex = 71048;

class Class_2_E067F907AAEAD5D2 : public ::RPG::Client::Multithread::JobParallelForThreadTask_1<::Struct_2_E4C0B765BB81CBBA>
{
public:
	::System::Collections::Generic::List_1<::Struct_2_5C05B865B0E3235A_2>* FCIENEOKGDA; // 0x50
	::RPG::GameCore::ThreadTaskConfig* _Config_k__BackingField; // 0x58
	::System::Collections::Generic::List_1<::Struct_2_984AA94FB23486F9_2>* LOCBAFAHGIL; // 0x60
