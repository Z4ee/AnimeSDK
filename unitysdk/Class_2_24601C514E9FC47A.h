...
#define CLASS_2_24601C514E9FC47A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1599C1F0)
#define CLASS_2_24601C514E9FC47A_METHOD_2_638DE61E5889BBE5_OFFSET UNITYSDK_OFFSET(0x1599CBD0)
#define CLASS_2_24601C514E9FC47A_METHOD_2_68805403250CC013_OFFSET UNITYSDK_OFFSET(0x1599C630)
#define CLASS_2_24601C514E9FC47A_METHOD_2_8BA81D51FB5D5B30_OFFSET UNITYSDK_OFFSET(0x1599CA90)
#define CLASS_2_24601C514E9FC47A_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1599C9D0)
#define CLASS_2_24601C514E9FC47A_METHOD_2_B88E6D62135C4817_OFFSET UNITYSDK_OFFSET(0x1599CF10)
#define CLASS_2_24601C514E9FC47A_METHOD_2_F206290BA342BA13_OFFSET UNITYSDK_OFFSET(0x1599C7D0)
#define CLASS_2_24601C514E9FC47A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1599C230)
#define CLASS_2_24601C514E9FC47A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1599C900)
#define CLASS_2_24601C514E9FC47A_TICK_OFFSET UNITYSDK_OFFSET(0x1599C970)
#define CLASS_2_24601C514E9FC47A__CTOR_OFFSET UNITYSDK_OFFSET(0x1599C0C0)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* MHMCJJDFBGK; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::TalkBehaviorRow*>* KKOHGABGELH; // 0x20
	::RPG::Client::LuaUIController* OGOFNHAGOPO; // 0x28
	::RPG::Client::NotifyHandler* ANMLHFBCPCF; // 0x30
	::RPG::GameCore::ShowShop* OFKGLJOAMLD; // 0x38
	::Il2CppArray<::System::Int32>* CFKLLAOPMOG; // 0x40
	::Class_1_F3391C70DC37088D* PJHNKKIDLBE; // 0x48
