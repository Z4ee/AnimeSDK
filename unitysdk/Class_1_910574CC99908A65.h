...
#define CLASS_1_910574CC99908A65_GET_ABILITYCASTSYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0320)
#define CLASS_1_910574CC99908A65_GET_ATTACKSYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0330)
#define CLASS_1_910574CC99908A65_GET_ATTRIBUTESERVICE_OFFSET UNITYSDK_OFFSET(0x158F0390)
#define CLASS_1_910574CC99908A65_GET_DEATHSYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0340)
#define CLASS_1_910574CC99908A65_GET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0x158F03B0)
#define CLASS_1_910574CC99908A65_GET_ENTITYFACTORYSERVICE_OFFSET UNITYSDK_OFFSET(0x158F03A0)
#define CLASS_1_910574CC99908A65_GET_ERRORSET_OFFSET UNITYSDK_OFFSET(0x158F0310)
#define CLASS_1_910574CC99908A65_GET_FRAME_OFFSET UNITYSDK_OFFSET(0x158F02F0)
#define CLASS_1_910574CC99908A65_GET_GAMESTATESYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0350)
#define CLASS_1_910574CC99908A65_GET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x158F02D0)
#define CLASS_1_910574CC99908A65_GET_LOGLEVEL_OFFSET UNITYSDK_OFFSET(0x158F02C0)
#define CLASS_1_910574CC99908A65_GET_SUMMONSYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0360)
#define CLASS_1_910574CC99908A65_GET_TEAMBUFFAPPLYSYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0370)
#define CLASS_1_910574CC99908A65_GET_TURNBASEDSYSTEM_OFFSET UNITYSDK_OFFSET(0x158F0380)
#define CLASS_1_910574CC99908A65_METHOD_1_0E8E4459B26B6D1C_OFFSET UNITYSDK_OFFSET(0x158F0BB0)
#define CLASS_1_910574CC99908A65_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x158F0B70)
#define CLASS_1_910574CC99908A65_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x158F0B20)
#define CLASS_1_910574CC99908A65_SET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0x158F03C0)
#define CLASS_1_910574CC99908A65_SET_FRAME_OFFSET UNITYSDK_OFFSET(0x158F0300)
#define CLASS_1_910574CC99908A65_SET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x158F02E0)
#define CLASS_1_910574CC99908A65__CTOR_OFFSET UNITYSDK_OFFSET(0x158F03D0)

inline static constexpr unsigned int Class_1_910574CC99908A65_TypeDefinitionIndex = 76947;
...
public:
	...
	{
		return (::Class_2_4F1D8B58CEECB454**)Il2CppClass::FromTypeDefinitionIndex(Class_1_910574CC99908A65_TypeDefinitionIndex)->GetStaticField(0x72E0);
	}
	::Class_3_2E396E206DB7778F* _AttributeService_k__BackingField; // 0x10
	::Class_3_CC8F37580A08544F* _DeathSystem_k__BackingField; // 0x18
	::Class_3_5A62B20BB82BEBF5* _AbilityCastSystem_k__BackingField; // 0x20
	::Class_3_DCB7F8B839F0C44B_1* _TeamBuffApplySystem_k__BackingField; // 0x28
	::Class_3_E8059F7236D01C8C* _AttackSystem_k__BackingField; // 0x30
	::System::Collections::Generic::HashSet_1<::System::String*>* _ErrorSet_k__BackingField; // 0x38
	::Class_3_2CC3370C8709BCC1* _TurnBasedSystem_k__BackingField; // 0x40
	::Class_3_04673DB2E35FE564* _EntityFactoryService_k__BackingField; // 0x48
	::Class_3_153521F8C15D539F* _SummonSystem_k__BackingField; // 0x50
	::Class_3_38C152545CDCE97B* _GameStateSystem_k__BackingField; // 0x58
	::System::Boolean _IsShowFrame_k__BackingField; // 0x60
	::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelLogLevel _LogLevel_k__BackingField; // 0x64
