...
#define CLASS_1_29B09BA352CBE40A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBD44A40)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_0B8FA6CA3D6E696A_OFFSET UNITYSDK_OFFSET(0xBD4BF80)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_0C70DE8D34C1B721_OFFSET UNITYSDK_OFFSET(0xBD4C200)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_646B7672F0B3276E_OFFSET UNITYSDK_OFFSET(0xBD4C2E0)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xBD44790)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_9AD9B5D2A67D4172_OFFSET UNITYSDK_OFFSET(0xBD436F0)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_CE74B05EA918B9A4_1_OFFSET UNITYSDK_OFFSET(0xBD4C8F0)
#define CLASS_1_29B09BA352CBE40A_METHOD_1_CE74B05EA918B9A4_OFFSET UNITYSDK_OFFSET(0xBD4C520)
#define CLASS_1_29B09BA352CBE40A__CTOR_OFFSET UNITYSDK_OFFSET(0xBD43630)
#define CLASS_1_29B09BA352CBE40A___SENDSTARTBATTLEREQ_B__8_0_OFFSET UNITYSDK_OFFSET(0xBD4CC00)
#define CLASS_1_29B09BA352CBE40A___SENDSTARTNODEREQ_B__7_0_OFFSET UNITYSDK_OFFSET(0xBD4CB30)

inline static constexpr unsigned int Class_1_29B09BA352CBE40A_TypeDefinitionIndex = 74839;

class Class_1_29B09BA352CBE40A : public ::System::Object
{
public:
	::RPG::Client::Promises::Promise* PFPPONIIGMJ; // 0x10
	::RPG::Client::ActivityIdleLive::StoryLine* GIOECPALNAC; // 0x18
	::RPG::Client::Promises::Promise* EGAGOICMCPA; // 0x20
