...
#define CLASS_3_5B0237AEBE51CEDE_GET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x909F420)
#define CLASS_3_5B0237AEBE51CEDE_GET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x909F460)
#define CLASS_3_5B0237AEBE51CEDE_GET_GUID_OFFSET UNITYSDK_OFFSET(0x909F580)
#define CLASS_3_5B0237AEBE51CEDE_GET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x909F440)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x909F3C0)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x909F400)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0x909F3E0)
#define CLASS_3_5B0237AEBE51CEDE_GET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x909F480)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x909F3B0)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x909F340)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_2720CE40EEFCCE64_OFFSET UNITYSDK_OFFSET(0x909F4A0)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x909F2B0)
#define CLASS_3_5B0237AEBE51CEDE_SET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x909F430)
#define CLASS_3_5B0237AEBE51CEDE_SET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x909F470)
#define CLASS_3_5B0237AEBE51CEDE_SET_GUID_OFFSET UNITYSDK_OFFSET(0x909F590)
#define CLASS_3_5B0237AEBE51CEDE_SET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x909F450)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x909F3D0)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x909F410)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0x909F3F0)
#define CLASS_3_5B0237AEBE51CEDE_SET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x909F490)
#define CLASS_3_5B0237AEBE51CEDE__CTOR_OFFSET UNITYSDK_OFFSET(0x909EE20)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x909F5A0)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x909F6C0)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0x909F7E0)

inline static constexpr unsigned int Class_3_5B0237AEBE51CEDE_TypeDefinitionIndex = 68417;

class Class_3_5B0237AEBE51CEDE : public ::Class_2_E77EE8BE0A609DD9
{
public:
	// static const ::System::String* Field_3_8; // 0x0
	// static const ::System::String* Field_3_9; // 0x0
	::Class_3_290D64E8B1BFF24F* _IssueViewModel_k__BackingField; // 0x20
	::Class_1_ADBE1843AD1E672A* _OnBtnIssue_k__BackingField; // 0x28
	::Class_1_ADBE1843AD1E672A* _OnBtnClose_k__BackingField; // 0x30
	::RPG::Client::MVVM::Service::LimaoNewsIssueService* Field_3_11; // 0x38
	::Class_1_029A7EDCBF9933C8* Field_3_14; // 0x40
	::RPG::Client::MVVM::Service::LimaoNewsNetworkService* Field_3_10; // 0x48
	::Class_3_5D7F408520274939* _SponsorViewModel_k__BackingField; // 0x50
	::System::String* Field_3_15; // 0x58
	::RPG::Client::MVVM::Service::LimaoNewsWindowService* Field_3_13; // 0x60
	::Class_3_D975C797957E43FF* _ForumViewModel_k__BackingField; // 0x68
	::RPG::Client::MVVM::Service::LimaoNewsPostService* Field_3_12; // 0x70
	::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewModelParam* _DefaultParam_k__BackingField; // 0x78
	::Class_1_ADBE1843AD1E672A* _OnBtnForm_k__BackingField; // 0x80
	::System::Guid _Guid_k__BackingField; // 0x88

	::System::Void _ctor(::RPG::Client::MVVM::Service::LimaoNewsNetworkService* a1, ::RPG::Client::MVVM::Service::LimaoNewsIssueService* a2, ::RPG::Client::MVVM::Service::LimaoNewsPostService* a3, ::RPG::Client::MVVM::Service::LimaoNewsWindowService* a4, ::Class_1_029A7EDCBF9933C8* a5, ::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewModelParam* a6)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::MVVM::Service::LimaoNewsNetworkService*, ::RPG::Client::MVVM::Service::LimaoNewsIssueService*, ::RPG::Client::MVVM::Service::LimaoNewsPostService*, ::RPG::Client::MVVM::Service::LimaoNewsWindowService*, ::Class_1_029A7EDCBF9933C8*, ::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewModelParam*))((::PBYTE)hIl2Cpp + CLASS_3_5B0237AEBE51CEDE__CTOR_OFFSET))(this, a1, a2, a3, a4, a5, a6);
	}
