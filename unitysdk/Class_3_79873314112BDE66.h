...
#define CLASS_3_79873314112BDE66_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8827960)
#define CLASS_3_79873314112BDE66_METHOD_3_59B4050C6767C1DB_OFFSET UNITYSDK_OFFSET(0x8827BE0)
#define CLASS_3_79873314112BDE66__CTOR_OFFSET UNITYSDK_OFFSET(0x88275C0)
#define CLASS_3_79873314112BDE66__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x88279C0)
#define CLASS_3_79873314112BDE66__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8827AA0)
#define CLASS_3_79873314112BDE66__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8827B40)
#define CLASS_3_79873314112BDE66___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8827E50)
#define CLASS_3_79873314112BDE66___IFIXBASEPROXY__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x8827EB0)
#define CLASS_3_79873314112BDE66___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8827EC0)
#define CLASS_3_79873314112BDE66___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8827ED0)

inline static constexpr unsigned int Class_3_79873314112BDE66_TypeDefinitionIndex = 43324;

class Class_3_79873314112BDE66 : public ::RPG::GameCore::AdvWaitingTaskBase_1<::RPG::GameCore::WaitSubMissionStateChange*>
{
public:
	::RPG::Client::MapDef* Field_3_2; // 0x68
	::RPG::PoolHashSet_1<::System::UInt32>* Field_3_0; // 0x70
