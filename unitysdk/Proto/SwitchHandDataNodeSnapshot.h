...
#define PROTO_SWITCHHANDDATANODESNAPSHOT_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A12CF70)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_CLONE_OFFSET UNITYSDK_OFFSET(0x1A12C9A0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A12CB30)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A12CAD0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A12CC30)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x1A12C9F0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GET_GETCOINCOUNT_OFFSET UNITYSDK_OFFSET(0x1A12CAB0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GET_HANDPARAM_OFFSET UNITYSDK_OFFSET(0x1A12CA50)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GET_HANDSTATE_OFFSET UNITYSDK_OFFSET(0x1A12CA30)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GET_HANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A12CA10)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1A12C7F0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A12D2C0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A12D1F0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A12C850)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x1A12CA00)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_SET_GETCOINCOUNT_OFFSET UNITYSDK_OFFSET(0x1A12CAC0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_SET_HANDPARAM_OFFSET UNITYSDK_OFFSET(0x1A12CA60)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_SET_HANDSTATE_OFFSET UNITYSDK_OFFSET(0x1A12CA40)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_SET_HANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A12CA20)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A12CDE0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A12CE40)
#define PROTO_SWITCHHANDDATANODESNAPSHOT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A12D3F0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A12C8B0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A12C860)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::SwitchHandDataNodeSnapshot*>**)Il2CppClass::FromTypeDefinitionIndex(SwitchHandDataNodeSnapshot_TypeDefinitionIndex)->GetStaticField(0x46300);
		}
