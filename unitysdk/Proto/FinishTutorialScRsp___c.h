...
#define PROTO_FINISHTUTORIALSCRSP___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D95B970)
#define PROTO_FINISHTUTORIALSCRSP___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95B9B0)
#define PROTO_FINISHTUTORIALSCRSP___C___CCTOR_B__28_0_OFFSET UNITYSDK_OFFSET(0x1D95B9C0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::FinishTutorialScRsp___c**)Il2CppClass::FromTypeDefinitionIndex(FinishTutorialScRsp___c_TypeDefinitionIndex)->GetStaticField(0x58D50);
		}
