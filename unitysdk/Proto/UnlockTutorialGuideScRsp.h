...
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D982910)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x1D9823A0)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D9825F0)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D982470)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D982770)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1D9822D0)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1D982450)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_GET_TUTORIALGUIDE_OFFSET UNITYSDK_OFFSET(0x1D982430)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D982A90)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D9829E0)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D982300)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1D982460)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_SET_TUTORIALGUIDE_OFFSET UNITYSDK_OFFSET(0x1D982440)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D9827D0)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D982830)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D982C20)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D982320)
#define PROTO_UNLOCKTUTORIALGUIDESCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D982310)

namespace Proto
{
	inline static constexpr unsigned int UnlockTutorialGuideScRsp_TypeDefinitionIndex = 34390;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::UnlockTutorialGuideScRsp*>**)Il2CppClass::FromTypeDefinitionIndex(UnlockTutorialGuideScRsp_TypeDefinitionIndex)->GetStaticField(0x9C0);
		}
