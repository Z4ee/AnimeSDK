...
#define PROTO_GETBASICINFOSCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D95DA50)
#define PROTO_GETBASICINFOSCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x1D95D230)
#define PROTO_GETBASICINFOSCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D95D430)
#define PROTO_GETBASICINFOSCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D95D400)
#define PROTO_GETBASICINFOSCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D95D580)
#define PROTO_GETBASICINFOSCRSP_GET_CURDAY_OFFSET UNITYSDK_OFFSET(0x1D95D360)
#define PROTO_GETBASICINFOSCRSP_GET_EXCHANGETIMES_OFFSET UNITYSDK_OFFSET(0x1D95D3A0)
#define PROTO_GETBASICINFOSCRSP_GET_GAMEPLAYBIRTHDAY_OFFSET UNITYSDK_OFFSET(0x1D95D380)
#define PROTO_GETBASICINFOSCRSP_GET_GENDER_OFFSET UNITYSDK_OFFSET(0x1D95D2C0)
#define PROTO_GETBASICINFOSCRSP_GET_ISGENDERSET_OFFSET UNITYSDK_OFFSET(0x1D95D2E0)
#define PROTO_GETBASICINFOSCRSP_GET_LASTSETNICKNAMETIME_OFFSET UNITYSDK_OFFSET(0x1D95D3E0)
#define PROTO_GETBASICINFOSCRSP_GET_NEXTRECOVERTIME_OFFSET UNITYSDK_OFFSET(0x1D95D320)
#define PROTO_GETBASICINFOSCRSP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1D95D160)
#define PROTO_GETBASICINFOSCRSP_GET_PLAYERSETTINGINFO_OFFSET UNITYSDK_OFFSET(0x1D95D300)
#define PROTO_GETBASICINFOSCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1D95D3C0)
#define PROTO_GETBASICINFOSCRSP_GET_WEEKCOCOONFINISHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x1D95D340)
#define PROTO_GETBASICINFOSCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D95E000)
#define PROTO_GETBASICINFOSCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D95DF10)
#define PROTO_GETBASICINFOSCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D95D190)
#define PROTO_GETBASICINFOSCRSP_SET_CURDAY_OFFSET UNITYSDK_OFFSET(0x1D95D370)
#define PROTO_GETBASICINFOSCRSP_SET_EXCHANGETIMES_OFFSET UNITYSDK_OFFSET(0x1D95D3B0)
#define PROTO_GETBASICINFOSCRSP_SET_GAMEPLAYBIRTHDAY_OFFSET UNITYSDK_OFFSET(0x1D95D390)
#define PROTO_GETBASICINFOSCRSP_SET_GENDER_OFFSET UNITYSDK_OFFSET(0x1D95D2D0)
#define PROTO_GETBASICINFOSCRSP_SET_ISGENDERSET_OFFSET UNITYSDK_OFFSET(0x1D95D2F0)
#define PROTO_GETBASICINFOSCRSP_SET_LASTSETNICKNAMETIME_OFFSET UNITYSDK_OFFSET(0x1D95D3F0)
#define PROTO_GETBASICINFOSCRSP_SET_NEXTRECOVERTIME_OFFSET UNITYSDK_OFFSET(0x1D95D330)
#define PROTO_GETBASICINFOSCRSP_SET_PLAYERSETTINGINFO_OFFSET UNITYSDK_OFFSET(0x1D95D310)
#define PROTO_GETBASICINFOSCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1D95D3D0)
#define PROTO_GETBASICINFOSCRSP_SET_WEEKCOCOONFINISHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x1D95D350)
#define PROTO_GETBASICINFOSCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D95D600)
#define PROTO_GETBASICINFOSCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D95D660)
#define PROTO_GETBASICINFOSCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D95E1B0)
#define PROTO_GETBASICINFOSCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D95D1B0)
#define PROTO_GETBASICINFOSCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95D1A0)

namespace Proto
{
	inline static constexpr unsigned int GetBasicInfoScRsp_TypeDefinitionIndex = 31398;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::GetBasicInfoScRsp*>**)Il2CppClass::FromTypeDefinitionIndex(GetBasicInfoScRsp_TypeDefinitionIndex)->GetStaticField(0x58FF0);
		}
		// static const ::System::Int32 GenderFieldNumber = 0x3; // 0x0
		// static const ::System::Int32 IsGenderSetFieldNumber = 0x5; // 0x0
		// static const ::System::Int32 PlayerSettingInfoFieldNumber = 0x8; // 0x0
		// static const ::System::Int32 NextRecoverTimeFieldNumber = 0x4; // 0x0
		// static const ::System::Int32 WeekCocoonFinishedCountFieldNumber = 0x7; // 0x0
		// static const ::System::Int32 CurDayFieldNumber = 0xF; // 0x0
		// static const ::System::Int32 GameplayBirthdayFieldNumber = 0x6; // 0x0
		// static const ::System::Int32 ExchangeTimesFieldNumber = 0x2; // 0x0
		// static const ::System::Int32 RetcodeFieldNumber = 0xC; // 0x0
		// static const ::System::Int32 LastSetNicknameTimeFieldNumber = 0xB; // 0x0
		::Google::Protobuf::UnknownFieldSet* _unknownFields; // 0x10
		::Class_1_144E164D41850A11* playerSettingInfo_; // 0x18
		::System::UInt32 exchangeTimes_; // 0x20
		::System::UInt32 gender_; // 0x24
		::System::Boolean isGenderSet_; // 0x28
		::System::UInt32 curDay_; // 0x2C
		::System::UInt32 gameplayBirthday_; // 0x30
		::System::UInt32 retcode_; // 0x34
		::System::UInt32 weekCocoonFinishedCount_; // 0x38
		::System::Int64 lastSetNicknameTime_; // 0x40
		::System::Int64 nextRecoverTime_; // 0x48
