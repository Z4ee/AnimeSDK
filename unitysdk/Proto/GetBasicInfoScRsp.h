...
#define PROTO_GETBASICINFOSCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0ED8E0)
#define PROTO_GETBASICINFOSCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0ED370)
#define PROTO_GETBASICINFOSCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0ED510)
#define PROTO_GETBASICINFOSCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0ED4E0)
#define PROTO_GETBASICINFOSCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0ED620)
#define PROTO_GETBASICINFOSCRSP_GET_CURDAY_OFFSET UNITYSDK_OFFSET(0x1A0ED4C0)
#define PROTO_GETBASICINFOSCRSP_GET_EXCHANGETIMES_OFFSET UNITYSDK_OFFSET(0x1A0ED3E0)
#define PROTO_GETBASICINFOSCRSP_GET_GAMEPLAYBIRTHDAY_OFFSET UNITYSDK_OFFSET(0x1A0ED440)
#define PROTO_GETBASICINFOSCRSP_GET_GENDER_OFFSET UNITYSDK_OFFSET(0x1A0ED3C0)
#define PROTO_GETBASICINFOSCRSP_GET_ISGENDERSET_OFFSET UNITYSDK_OFFSET(0x1A0ED4A0)
#define PROTO_GETBASICINFOSCRSP_GET_LASTSETNICKNAMETIME_OFFSET UNITYSDK_OFFSET(0x1A0ED420)
#define PROTO_GETBASICINFOSCRSP_GET_NEXTRECOVERTIME_OFFSET UNITYSDK_OFFSET(0x1A0ED480)
#define PROTO_GETBASICINFOSCRSP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1A0ED270)
#define PROTO_GETBASICINFOSCRSP_GET_PLAYERSETTINGINFO_OFFSET UNITYSDK_OFFSET(0x1A0ED3A0)
#define PROTO_GETBASICINFOSCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1A0ED400)
#define PROTO_GETBASICINFOSCRSP_GET_WEEKCOCOONFINISHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0ED460)
#define PROTO_GETBASICINFOSCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0EDEA0)
#define PROTO_GETBASICINFOSCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0EDDB0)
#define PROTO_GETBASICINFOSCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0ED2A0)
#define PROTO_GETBASICINFOSCRSP_SET_CURDAY_OFFSET UNITYSDK_OFFSET(0x1A0ED4D0)
#define PROTO_GETBASICINFOSCRSP_SET_EXCHANGETIMES_OFFSET UNITYSDK_OFFSET(0x1A0ED3F0)
#define PROTO_GETBASICINFOSCRSP_SET_GAMEPLAYBIRTHDAY_OFFSET UNITYSDK_OFFSET(0x1A0ED450)
#define PROTO_GETBASICINFOSCRSP_SET_GENDER_OFFSET UNITYSDK_OFFSET(0x1A0ED3D0)
#define PROTO_GETBASICINFOSCRSP_SET_ISGENDERSET_OFFSET UNITYSDK_OFFSET(0x1A0ED4B0)
#define PROTO_GETBASICINFOSCRSP_SET_LASTSETNICKNAMETIME_OFFSET UNITYSDK_OFFSET(0x1A0ED430)
#define PROTO_GETBASICINFOSCRSP_SET_NEXTRECOVERTIME_OFFSET UNITYSDK_OFFSET(0x1A0ED490)
#define PROTO_GETBASICINFOSCRSP_SET_PLAYERSETTINGINFO_OFFSET UNITYSDK_OFFSET(0x1A0ED3B0)
#define PROTO_GETBASICINFOSCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1A0ED410)
#define PROTO_GETBASICINFOSCRSP_SET_WEEKCOCOONFINISHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0ED470)
#define PROTO_GETBASICINFOSCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0ED6B0)
#define PROTO_GETBASICINFOSCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0ED710)
#define PROTO_GETBASICINFOSCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0EE040)
#define PROTO_GETBASICINFOSCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0ED2C0)
#define PROTO_GETBASICINFOSCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0ED2B0)

namespace Proto
{
	inline static constexpr unsigned int GetBasicInfoScRsp_TypeDefinitionIndex = 30125;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::GetBasicInfoScRsp*>**)Il2CppClass::FromTypeDefinitionIndex(GetBasicInfoScRsp_TypeDefinitionIndex)->GetStaticField(0x43240);
		}
		// static const ::System::Int32 PlayerSettingInfoFieldNumber = 0x7; // 0x0
		// static const ::System::Int32 GenderFieldNumber = 0x6; // 0x0
		// static const ::System::Int32 ExchangeTimesFieldNumber = 0x4; // 0x0
		// static const ::System::Int32 RetcodeFieldNumber = 0x3; // 0x0
		// static const ::System::Int32 LastSetNicknameTimeFieldNumber = 0x2; // 0x0
		// static const ::System::Int32 GameplayBirthdayFieldNumber = 0x5; // 0x0
		// static const ::System::Int32 WeekCocoonFinishedCountFieldNumber = 0x8; // 0x0
		// static const ::System::Int32 NextRecoverTimeFieldNumber = 0x9; // 0x0
		// static const ::System::Int32 IsGenderSetFieldNumber = 0xB; // 0x0
		// static const ::System::Int32 CurDayFieldNumber = 0xC; // 0x0
		::Class_1_144E164D41850A11* playerSettingInfo_; // 0x10
		::Google::Protobuf::UnknownFieldSet* _unknownFields; // 0x18
		::System::Int64 nextRecoverTime_; // 0x20
		::System::UInt32 exchangeTimes_; // 0x28
		::System::UInt32 weekCocoonFinishedCount_; // 0x2C
		::System::Int64 lastSetNicknameTime_; // 0x30
		::System::UInt32 retcode_; // 0x38
		::System::UInt32 curDay_; // 0x3C
		::System::UInt32 gameplayBirthday_; // 0x40
		::System::Boolean isGenderSet_; // 0x44
		::System::UInt32 gender_; // 0x48
