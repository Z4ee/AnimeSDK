...
#define PROTO_SHOP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BEF39B0)
#define PROTO_SHOP_CLONE_OFFSET UNITYSDK_OFFSET(0x1BEF33B0)
#define PROTO_SHOP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BEF34E0)
#define PROTO_SHOP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BEF34B0)
#define PROTO_SHOP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BEF35A0)
#define PROTO_SHOP_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1BEF3400)
#define PROTO_SHOP_GET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1BEF3440)
#define PROTO_SHOP_GET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1BEF33E0)
#define PROTO_SHOP_GET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1BEF3460)
#define PROTO_SHOP_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1BEF3420)
#define PROTO_SHOP_GET_GOODSLIST_OFFSET UNITYSDK_OFFSET(0x1BEF34A0)
#define PROTO_SHOP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1BEF3280)
#define PROTO_SHOP_GET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1BEF3480)
#define PROTO_SHOP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BEF3F00)
#define PROTO_SHOP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BEF3E10)
#define PROTO_SHOP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BEF32B0)
#define PROTO_SHOP_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1BEF3410)
#define PROTO_SHOP_SET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1BEF3450)
#define PROTO_SHOP_SET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1BEF33F0)
#define PROTO_SHOP_SET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1BEF3470)
#define PROTO_SHOP_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1BEF3430)
#define PROTO_SHOP_SET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1BEF3490)
#define PROTO_SHOP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BEF3670)
#define PROTO_SHOP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BEF36D0)
#define PROTO_SHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BEF4040)
#define PROTO_SHOP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BEF3300)
#define PROTO_SHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEF32C0)

namespace Proto
{
	inline static constexpr unsigned int Shop_TypeDefinitionIndex = 32764;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Shop*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0xD280);
		}
		static ::Google::Protobuf::FieldCodec_1<::Proto::Goods*>** StaticGet__repeated_goodsList_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::Goods*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0xD288);
		}
		// static const ::System::Int32 CityLevelFieldNumber = 0x1; // 0x0
		// static const ::System::Int32 BeginTimeFieldNumber = 0xD; // 0x0
		// static const ::System::Int32 EndTimeFieldNumber = 0x7; // 0x0
		// static const ::System::Int32 CityExpFieldNumber = 0xE; // 0x0
		// static const ::System::Int32 CityTakenLevelRewardFieldNumber = 0xF; // 0x0
		// static const ::System::Int32 ShopIdFieldNumber = 0x5; // 0x0
		// static const ::System::Int32 GoodsListFieldNumber = 0xA; // 0x0
		...
		::System::UInt32 cityExp_; // 0x38
		::System::UInt32 cityLevel_; // 0x3C
