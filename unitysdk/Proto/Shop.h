...
#define PROTO_SHOP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD53FF0)
#define PROTO_SHOP_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD539F0)
#define PROTO_SHOP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD53B20)
#define PROTO_SHOP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD53AF0)
#define PROTO_SHOP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD53BE0)
#define PROTO_SHOP_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1DD53A60)
#define PROTO_SHOP_GET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1DD53A80)
#define PROTO_SHOP_GET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1DD53AC0)
#define PROTO_SHOP_GET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1DD53AA0)
#define PROTO_SHOP_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1DD53A20)
#define PROTO_SHOP_GET_GOODSLIST_OFFSET UNITYSDK_OFFSET(0x1DD53AE0)
#define PROTO_SHOP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1DD538B0)
#define PROTO_SHOP_GET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1DD53A40)
#define PROTO_SHOP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD54540)
#define PROTO_SHOP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD54450)
#define PROTO_SHOP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD538E0)
#define PROTO_SHOP_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1DD53A70)
#define PROTO_SHOP_SET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1DD53A90)
#define PROTO_SHOP_SET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1DD53AD0)
#define PROTO_SHOP_SET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1DD53AB0)
#define PROTO_SHOP_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1DD53A30)
#define PROTO_SHOP_SET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1DD53A50)
#define PROTO_SHOP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD53CB0)
#define PROTO_SHOP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD53D10)
#define PROTO_SHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD54680)
#define PROTO_SHOP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD53930)
#define PROTO_SHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD538F0)

namespace Proto
{
	inline static constexpr unsigned int Shop_TypeDefinitionIndex = 33517;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Shop*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0x5C860);
		}
		static ::Google::Protobuf::FieldCodec_1<::Proto::Goods*>** StaticGet__repeated_goodsList_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::Goods*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0x5C868);
		}
		// static const ::System::Int32 EndTimeFieldNumber = 0xE; // 0x0
		// static const ::System::Int32 ShopIdFieldNumber = 0xF; // 0x0
		// static const ::System::Int32 BeginTimeFieldNumber = 0x5; // 0x0
		// static const ::System::Int32 CityExpFieldNumber = 0xD; // 0x0
		// static const ::System::Int32 CityTakenLevelRewardFieldNumber = 0x1; // 0x0
		// static const ::System::Int32 CityLevelFieldNumber = 0x6; // 0x0
		// static const ::System::Int32 GoodsListFieldNumber = 0x3; // 0x0
		::Google::Protobuf::Collections::RepeatedField_1<::Proto::Goods*>* goodsList_; // 0x10
		::Google::Protobuf::UnknownFieldSet* _unknownFields; // 0x18
		::System::Int64 endTime_; // 0x20
		::System::UInt32 shopId_; // 0x28
		::System::UInt32 cityExp_; // 0x2C
		::System::Int64 beginTime_; // 0x30
		::System::UInt32 cityLevel_; // 0x38
		::System::UInt64 cityTakenLevelReward_; // 0x40
