...
#define PROTO_FLOORCUSTOMVALUESNAPSHOT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19339C50)
#define PROTO_FLOORCUSTOMVALUESNAPSHOT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19339C90)
#define PROTO_FLOORCUSTOMVALUESNAPSHOT___C___CCTOR_B__43_0_OFFSET UNITYSDK_OFFSET(0x19339CA0)

namespace Proto
{
	inline static constexpr unsigned int FloorCustomValueSnapshot___c_TypeDefinitionIndex = 24523;
	...
	public:
		...
		{
			return (::Proto::FloorCustomValueSnapshot___c**)Il2CppClass::FromTypeDefinitionIndex(FloorCustomValueSnapshot___c_TypeDefinitionIndex)->GetStaticField(0x63A00);
		}
