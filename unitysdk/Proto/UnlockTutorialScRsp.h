...
#define PROTO_UNLOCKTUTORIALSCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D2F3850)
#define PROTO_UNLOCKTUTORIALSCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x1D2F3300)
#define PROTO_UNLOCKTUTORIALSCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D2F3540)
#define PROTO_UNLOCKTUTORIALSCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D2F33C0)
#define PROTO_UNLOCKTUTORIALSCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D2F36C0)
#define PROTO_UNLOCKTUTORIALSCRSP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1D2F3240)
#define PROTO_UNLOCKTUTORIALSCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1D2F3380)
#define PROTO_UNLOCKTUTORIALSCRSP_GET_TUTORIAL_OFFSET UNITYSDK_OFFSET(0x1D2F33A0)
#define PROTO_UNLOCKTUTORIALSCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D2F39C0)
#define PROTO_UNLOCKTUTORIALSCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D2F3920)
#define PROTO_UNLOCKTUTORIALSCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D2F3270)
#define PROTO_UNLOCKTUTORIALSCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1D2F3390)
#define PROTO_UNLOCKTUTORIALSCRSP_SET_TUTORIAL_OFFSET UNITYSDK_OFFSET(0x1D2F33B0)
#define PROTO_UNLOCKTUTORIALSCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D2F3710)
#define PROTO_UNLOCKTUTORIALSCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D2F3770)
#define PROTO_UNLOCKTUTORIALSCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D2F3B50)
#define PROTO_UNLOCKTUTORIALSCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D2F3290)
#define PROTO_UNLOCKTUTORIALSCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2F3280)

namespace Proto
{
	inline static constexpr unsigned int UnlockTutorialScRsp_TypeDefinitionIndex = 33633;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::UnlockTutorialScRsp*>**)Il2CppClass::FromTypeDefinitionIndex(UnlockTutorialScRsp_TypeDefinitionIndex)->GetStaticField(0x8D0);
		}
