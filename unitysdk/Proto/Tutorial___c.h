...
#define PROTO_TUTORIAL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EFA2C10)
#define PROTO_TUTORIAL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA2C40)
#define PROTO_TUTORIAL___C___CCTOR_B__28_0_OFFSET UNITYSDK_OFFSET(0x1EFA2C50)
