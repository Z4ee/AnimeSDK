...
#define PROTO_PLAYERASSISTINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1204D0)
#define PROTO_PLAYERASSISTINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A120500)
#define PROTO_PLAYERASSISTINFO___C___CCTOR_B__28_0_OFFSET UNITYSDK_OFFSET(0x1A120510)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::PlayerAssistInfo___c**)Il2CppClass::FromTypeDefinitionIndex(PlayerAssistInfo___c_TypeDefinitionIndex)->GetStaticField(0x45290);
		}
