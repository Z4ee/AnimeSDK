...
#define PROTO_DICECOMBATAVATAR___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF78AD0)
#define PROTO_DICECOMBATAVATAR___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF78B00)
#define PROTO_DICECOMBATAVATAR___C___CCTOR_B__38_0_OFFSET UNITYSDK_OFFSET(0x1BF78B10)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::DiceCombatAvatar___c**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatAvatar___c_TypeDefinitionIndex)->GetStaticField(0x3C1C0);
		}
