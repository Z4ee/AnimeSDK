...
#define PROTO_ROTATIONMAPINFOSNAPSHOT_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19356AE0)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_CLONE_OFFSET UNITYSDK_OFFSET(0x193566C0)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19356860)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x19356750)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19356940)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_GET_MAPPOS_OFFSET UNITYSDK_OFFSET(0x19356710)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_GET_MAPROT_OFFSET UNITYSDK_OFFSET(0x19356730)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x193564C0)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19356D00)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19356B70)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19356520)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_SET_MAPPOS_OFFSET UNITYSDK_OFFSET(0x19356720)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_SET_MAPROT_OFFSET UNITYSDK_OFFSET(0x19356740)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19356A00)
#define PROTO_ROTATIONMAPINFOSNAPSHOT_WRITETO_OFFSET UNITYSDK_OFFSET(0x19356A60)
#define PROTO_ROTATIONMAPINFOSNAPSHOT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19356DC0)
#define PROTO_ROTATIONMAPINFOSNAPSHOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19356540)
#define PROTO_ROTATIONMAPINFOSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19356530)

namespace Proto
{
	inline static constexpr unsigned int RotationMapInfoSnapshot_TypeDefinitionIndex = 24551;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::RotationMapInfoSnapshot*>**)Il2CppClass::FromTypeDefinitionIndex(RotationMapInfoSnapshot_TypeDefinitionIndex)->GetStaticField(0x65940);
		}
		// static const ::System::Int32 MapPosFieldNumber = 0x1; // 0x0
		// static const ::System::Int32 MapRotFieldNumber = 0x2; // 0x0
		::Proto::VectorSnapshot* mapRot_; // 0x10
