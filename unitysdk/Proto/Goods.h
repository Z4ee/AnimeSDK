...
#define PROTO_GOODS_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19341160)
#define PROTO_GOODS_CLONE_OFFSET UNITYSDK_OFFSET(0x19340DA0)
#define PROTO_GOODS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19340F20)
#define PROTO_GOODS_EQUALS_OFFSET UNITYSDK_OFFSET(0x19340E90)
#define PROTO_GOODS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19340FA0)
#define PROTO_GOODS_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x19340E50)
#define PROTO_GOODS_GET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x19340E70)
#define PROTO_GOODS_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x19340DF0)
#define PROTO_GOODS_GET_GOODSID_OFFSET UNITYSDK_OFFSET(0x19340E30)
#define PROTO_GOODS_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x19340E10)
#define PROTO_GOODS_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x19340D10)
#define PROTO_GOODS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x193414F0)
#define PROTO_GOODS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19341490)
#define PROTO_GOODS_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19340D40)
#define PROTO_GOODS_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x19340E60)
#define PROTO_GOODS_SET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x19340E80)
#define PROTO_GOODS_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x19340E00)
#define PROTO_GOODS_SET_GOODSID_OFFSET UNITYSDK_OFFSET(0x19340E40)
#define PROTO_GOODS_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x19340E20)
#define PROTO_GOODS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19341000)
#define PROTO_GOODS_WRITETO_OFFSET UNITYSDK_OFFSET(0x19341060)
#define PROTO_GOODS__CCTOR_OFFSET UNITYSDK_OFFSET(0x193415B0)
#define PROTO_GOODS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19340D60)
#define PROTO_GOODS__CTOR_OFFSET UNITYSDK_OFFSET(0x19340D50)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Goods*>**)Il2CppClass::FromTypeDefinitionIndex(Goods_TypeDefinitionIndex)->GetStaticField(0x63F10);
		}
		...
		::System::UInt32 buyTimes_; // 0x2C
		::System::UInt32 goodsId_; // 0x30
