...
#define PROTO_SWITCHHANDDATANODESNAPSHOT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BEF6ED0)
#define PROTO_SWITCHHANDDATANODESNAPSHOT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEF6F10)
#define PROTO_SWITCHHANDDATANODESNAPSHOT___C___CCTOR_B__43_0_OFFSET UNITYSDK_OFFSET(0x1BEF6F20)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::SwitchHandDataNodeSnapshot___c**)Il2CppClass::FromTypeDefinitionIndex(SwitchHandDataNodeSnapshot___c_TypeDefinitionIndex)->GetStaticField(0x40990);
		}
