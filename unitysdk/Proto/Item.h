...
#define PROTO_ITEM_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD3F510)
#define PROTO_ITEM_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD3EFD0)
#define PROTO_ITEM_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD3F170)
#define PROTO_ITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD3F100)
#define PROTO_ITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD3F1D0)
#define PROTO_ITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1DD3F0E0)
#define PROTO_ITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1DD3F0A0)
#define PROTO_ITEM_GET_MAINAFFIXID_OFFSET UNITYSDK_OFFSET(0x1DD3F020)
#define PROTO_ITEM_GET_NUM_OFFSET UNITYSDK_OFFSET(0x1DD3F080)
#define PROTO_ITEM_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1DD3EF40)
#define PROTO_ITEM_GET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x1DD3F0C0)
#define PROTO_ITEM_GET_RANK_OFFSET UNITYSDK_OFFSET(0x1DD3F040)
#define PROTO_ITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1DD3F060)
#define PROTO_ITEM_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD3F900)
#define PROTO_ITEM_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD3F890)
#define PROTO_ITEM_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD3EF70)
#define PROTO_ITEM_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1DD3F0F0)
#define PROTO_ITEM_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1DD3F0B0)
#define PROTO_ITEM_SET_MAINAFFIXID_OFFSET UNITYSDK_OFFSET(0x1DD3F030)
#define PROTO_ITEM_SET_NUM_OFFSET UNITYSDK_OFFSET(0x1DD3F090)
#define PROTO_ITEM_SET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x1DD3F0D0)
#define PROTO_ITEM_SET_RANK_OFFSET UNITYSDK_OFFSET(0x1DD3F050)
#define PROTO_ITEM_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1DD3F070)
#define PROTO_ITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD3F210)
#define PROTO_ITEM_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD3F270)
#define PROTO_ITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD3FA00)
#define PROTO_ITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD3EF90)
#define PROTO_ITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD3EF80)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Item*>**)Il2CppClass::FromTypeDefinitionIndex(Item_TypeDefinitionIndex)->GetStaticField(0x538F0);
		}
		...
		::System::UInt32 mainAffixId_; // 0x18
		::System::UInt32 uniqueId_; // 0x1C
		::System::UInt32 itemId_; // 0x20
		::System::UInt32 promotion_; // 0x24
