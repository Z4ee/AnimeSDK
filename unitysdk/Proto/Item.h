...
#define PROTO_ITEM_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BED8940)
#define PROTO_ITEM_CLONE_OFFSET UNITYSDK_OFFSET(0x1BED8400)
#define PROTO_ITEM_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BED85A0)
#define PROTO_ITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BED8530)
#define PROTO_ITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BED8600)
#define PROTO_ITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1BED8510)
#define PROTO_ITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1BED84F0)
#define PROTO_ITEM_GET_MAINAFFIXID_OFFSET UNITYSDK_OFFSET(0x1BED8450)
#define PROTO_ITEM_GET_NUM_OFFSET UNITYSDK_OFFSET(0x1BED84D0)
#define PROTO_ITEM_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1BED8370)
#define PROTO_ITEM_GET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x1BED8470)
#define PROTO_ITEM_GET_RANK_OFFSET UNITYSDK_OFFSET(0x1BED8490)
#define PROTO_ITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1BED84B0)
#define PROTO_ITEM_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BED8D30)
#define PROTO_ITEM_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BED8CC0)
#define PROTO_ITEM_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BED83A0)
#define PROTO_ITEM_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1BED8520)
#define PROTO_ITEM_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1BED8500)
#define PROTO_ITEM_SET_MAINAFFIXID_OFFSET UNITYSDK_OFFSET(0x1BED8460)
#define PROTO_ITEM_SET_NUM_OFFSET UNITYSDK_OFFSET(0x1BED84E0)
#define PROTO_ITEM_SET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x1BED8480)
#define PROTO_ITEM_SET_RANK_OFFSET UNITYSDK_OFFSET(0x1BED84A0)
#define PROTO_ITEM_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1BED84C0)
#define PROTO_ITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BED8640)
#define PROTO_ITEM_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BED86A0)
#define PROTO_ITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BED8E30)
#define PROTO_ITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BED83C0)
#define PROTO_ITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED83B0)

namespace Proto
{
	inline static constexpr unsigned int Item_TypeDefinitionIndex = 26605;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Item*>**)Il2CppClass::FromTypeDefinitionIndex(Item_TypeDefinitionIndex)->GetStaticField(0x2C980);
		}
		// static const ::System::Int32 MainAffixIdFieldNumber = 0x6; // 0x0
		// static const ::System::Int32 PromotionFieldNumber = 0x2; // 0x0
		// static const ::System::Int32 RankFieldNumber = 0xD; // 0x0
		// static const ::System::Int32 UniqueIdFieldNumber = 0x3; // 0x0
		// static const ::System::Int32 NumFieldNumber = 0x9; // 0x0
		// static const ::System::Int32 LevelFieldNumber = 0xB; // 0x0
		// static const ::System::Int32 ItemIdFieldNumber = 0x5; // 0x0
		::Google::Protobuf::UnknownFieldSet* _unknownFields; // 0x10
		::System::UInt32 level_; // 0x18
		::System::UInt32 mainAffixId_; // 0x1C
		::System::UInt32 itemId_; // 0x20
		::System::UInt32 rank_; // 0x24
		::System::UInt32 uniqueId_; // 0x28
		::System::UInt32 num_; // 0x2C
