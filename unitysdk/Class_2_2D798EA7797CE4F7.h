...
#define CLASS_2_2D798EA7797CE4F7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12AB1910)
#define CLASS_2_2D798EA7797CE4F7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12AB1950)
#define CLASS_2_2D798EA7797CE4F7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12AB1BC0)
#define CLASS_2_2D798EA7797CE4F7_TICK_OFFSET UNITYSDK_OFFSET(0x12AB1C10)
#define CLASS_2_2D798EA7797CE4F7__CTOR_OFFSET UNITYSDK_OFFSET(0x12AB1900)

inline static constexpr unsigned int Class_2_2D798EA7797CE4F7_TypeDefinitionIndex = 54169;

class Class_2_2D798EA7797CE4F7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SwordTrainingEnterGame* Field_2_0; // 0x20
