...
#define CLASS_2_B3CBB17B7F8FA2E2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16DC9230)
#define CLASS_2_B3CBB17B7F8FA2E2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16DC9090)
#define CLASS_2_B3CBB17B7F8FA2E2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16DC91E0)
#define CLASS_2_B3CBB17B7F8FA2E2_TICK_OFFSET UNITYSDK_OFFSET(0x16DC9270)
#define CLASS_2_B3CBB17B7F8FA2E2__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC9080)

inline static constexpr unsigned int Class_2_B3CBB17B7F8FA2E2_TypeDefinitionIndex = 58829;

class Class_2_B3CBB17B7F8FA2E2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::ShowRaidFinishUI* IGHAHBNLIJA; // 0x20
