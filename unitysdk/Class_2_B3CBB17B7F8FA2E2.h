...
#define CLASS_2_B3CBB17B7F8FA2E2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145413A0)
#define CLASS_2_B3CBB17B7F8FA2E2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14541200)
#define CLASS_2_B3CBB17B7F8FA2E2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14541350)
#define CLASS_2_B3CBB17B7F8FA2E2_TICK_OFFSET UNITYSDK_OFFSET(0x145413E0)
#define CLASS_2_B3CBB17B7F8FA2E2__CTOR_OFFSET UNITYSDK_OFFSET(0x145411F0)

inline static constexpr unsigned int Class_2_B3CBB17B7F8FA2E2_TypeDefinitionIndex = 54823;

class Class_2_B3CBB17B7F8FA2E2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowRaidFinishUI* Field_2_0; // 0x18
