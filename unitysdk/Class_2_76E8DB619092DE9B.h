...
#define CLASS_2_76E8DB619092DE9B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4387E0)
#define CLASS_2_76E8DB619092DE9B_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x1A438AF0)
#define CLASS_2_76E8DB619092DE9B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A438A10)
#define CLASS_2_76E8DB619092DE9B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A4388E0)
#define CLASS_2_76E8DB619092DE9B_TICK_OFFSET UNITYSDK_OFFSET(0x1A4389B0)
#define CLASS_2_76E8DB619092DE9B__CTOR_OFFSET UNITYSDK_OFFSET(0x1A438650)

inline static constexpr unsigned int Class_2_76E8DB619092DE9B_TypeDefinitionIndex = 53732;

class Class_2_76E8DB619092DE9B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_07C3C4D2990C49EE* CMBMMHOONBK; // 0x18
	::RPG::GameCore::WaitGroupUnload* IGHAHBNLIJA; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::RPG::Client::RuntimeGroupManager* KDCJFIMPKLP; // 0x30
	::System::UInt32 PEEFHNHDBMF; // 0x38
