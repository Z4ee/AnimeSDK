...
#define CLASS_2_68C2A0BE4805018E_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1CDDC9C0)
#define CLASS_2_68C2A0BE4805018E_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1CDDCA20)
#define CLASS_2_68C2A0BE4805018E__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDDC9B0)

inline static constexpr unsigned int Class_2_68C2A0BE4805018E_TypeDefinitionIndex = 41496;

class Class_2_68C2A0BE4805018E : public ::Class_1_F9FBCC956DFCF137_1
{
public:
	::RPG::GameCore::MarbleAIDegrade* IGHAHBNLIJA; // 0x18
