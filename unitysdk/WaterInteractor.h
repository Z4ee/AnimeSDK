...
#define WATERINTERACTOR_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC72C20)
#define WATERINTERACTOR_TRIGGERWAVE_OFFSET UNITYSDK_OFFSET(0xAC72BC0)
#define WATERINTERACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAC72C70)
#define WATERINTERACTOR___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC72CA0)

inline static constexpr unsigned int WaterInteractor_TypeDefinitionIndex = 38347;
