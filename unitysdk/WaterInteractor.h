...
#define WATERINTERACTOR_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x10509E70)
#define WATERINTERACTOR_TRIGGERWAVE_OFFSET UNITYSDK_OFFSET(0x10509E10)
#define WATERINTERACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x10509EC0)

inline static constexpr unsigned int WaterInteractor_TypeDefinitionIndex = 47945;
