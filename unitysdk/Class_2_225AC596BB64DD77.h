...
#define CLASS_2_225AC596BB64DD77_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA19D850)
#define CLASS_2_225AC596BB64DD77_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xA19D8A0)
#define CLASS_2_225AC596BB64DD77_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xA19DEC0)
#define CLASS_2_225AC596BB64DD77_ONSKIP_OFFSET UNITYSDK_OFFSET(0xA19DCB0)
#define CLASS_2_225AC596BB64DD77_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA19D900)
#define CLASS_2_225AC596BB64DD77_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA19D8B0)
#define CLASS_2_225AC596BB64DD77_TICK_OFFSET UNITYSDK_OFFSET(0xA19DC30)
#define CLASS_2_225AC596BB64DD77__CTOR_OFFSET UNITYSDK_OFFSET(0xA19D840)

inline static constexpr unsigned int Class_2_225AC596BB64DD77_TypeDefinitionIndex = 46785;

class Class_2_225AC596BB64DD77 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::CharacterStopFreeStyle* Field_2_1; // 0x20
