...
#define CLASS_2_225AC596BB64DD77_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12341360)
#define CLASS_2_225AC596BB64DD77_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x123413B0)
#define CLASS_2_225AC596BB64DD77_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x123419D0)
#define CLASS_2_225AC596BB64DD77_ONSKIP_OFFSET UNITYSDK_OFFSET(0x123417C0)
#define CLASS_2_225AC596BB64DD77_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12341410)
#define CLASS_2_225AC596BB64DD77_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x123413C0)
#define CLASS_2_225AC596BB64DD77_TICK_OFFSET UNITYSDK_OFFSET(0x12341740)
#define CLASS_2_225AC596BB64DD77__CTOR_OFFSET UNITYSDK_OFFSET(0x12341350)

inline static constexpr unsigned int Class_2_225AC596BB64DD77_TypeDefinitionIndex = 53494;

class Class_2_225AC596BB64DD77 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterStopFreeStyle* Field_2_1; // 0x18
