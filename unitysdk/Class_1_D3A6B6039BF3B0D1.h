...
#define CLASS_1_D3A6B6039BF3B0D1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C98B3C0)
#define CLASS_1_D3A6B6039BF3B0D1_CLONE_OFFSET UNITYSDK_OFFSET(0x1C98AF50)
#define CLASS_1_D3A6B6039BF3B0D1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C98B040)
#define CLASS_1_D3A6B6039BF3B0D1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C98AFE0)
#define CLASS_1_D3A6B6039BF3B0D1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C98B190)
#define CLASS_1_D3A6B6039BF3B0D1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C98B630)
#define CLASS_1_D3A6B6039BF3B0D1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C98B520)
#define CLASS_1_D3A6B6039BF3B0D1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C98AFC0)
#define CLASS_1_D3A6B6039BF3B0D1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C98AD60)
#define CLASS_1_D3A6B6039BF3B0D1_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x1C98AFB0)
#define CLASS_1_D3A6B6039BF3B0D1_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1C98AFA0)
#define CLASS_1_D3A6B6039BF3B0D1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C98AFD0)
#define CLASS_1_D3A6B6039BF3B0D1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C98ADC0)
#define CLASS_1_D3A6B6039BF3B0D1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C98B220)
#define CLASS_1_D3A6B6039BF3B0D1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C98B280)
#define CLASS_1_D3A6B6039BF3B0D1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C98B8C0)
#define CLASS_1_D3A6B6039BF3B0D1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C98AE40)
#define CLASS_1_D3A6B6039BF3B0D1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C98ADD0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_196CAEC5A1F2ACEA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D3A6B6039BF3B0D1_TypeDefinitionIndex)->GetStaticField(0x264E0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_D3A6B6039BF3B0D1*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_D3A6B6039BF3B0D1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D3A6B6039BF3B0D1_TypeDefinitionIndex)->GetStaticField(0x264E8);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_10F56A639581CEB1_1*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_10F56A639581CEB1_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D3A6B6039BF3B0D1_TypeDefinitionIndex)->GetStaticField(0x264F0);
	}
	// static const ::System::Int32 Field_1_3 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_5 = 0x3; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_10F56A639581CEB1_1*>* Field_1_6; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_196CAEC5A1F2ACEA*>* Field_1_7; // 0x18
