...
#define SYSTEM_INDEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x860DE0)
#define SYSTEM_INDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x3CA98B0)
#define SYSTEM_INDEX_FROMSTART_OFFSET UNITYSDK_OFFSET(0x1F012140)
#define SYSTEM_INDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19050)
#define SYSTEM_INDEX_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x3CA98A0)
#define SYSTEM_INDEX_GET_ISFROMEND_OFFSET UNITYSDK_OFFSET(0x3C6ECE0)
#define SYSTEM_INDEX_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3CA9890)
#define SYSTEM_INDEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1F012260)
#define SYSTEM_INDEX_THROWVALUEARGUMENTOUTOFRANGE_NEEDNONNEGNUMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1F0120D0)
#define SYSTEM_INDEX_TOSTRINGFROMEND_OFFSET UNITYSDK_OFFSET(0x3CA9990)
#define SYSTEM_INDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3CA9910)
#define SYSTEM_INDEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18EB0)
#define SYSTEM_INDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x3CA9820)

namespace System
{
	inline static constexpr unsigned int Index_TypeDefinitionIndex = 5063;
