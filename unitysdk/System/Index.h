...
#define SYSTEM_INDEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2E960)
#define SYSTEM_INDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B5ACC0)
#define SYSTEM_INDEX_FROMSTART_OFFSET UNITYSDK_OFFSET(0x1B6E0640)
#define SYSTEM_INDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5F00)
#define SYSTEM_INDEX_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x3B5ACB0)
#define SYSTEM_INDEX_GET_ISFROMEND_OFFSET UNITYSDK_OFFSET(0x3B5ACA0)
#define SYSTEM_INDEX_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3B5AC90)
#define SYSTEM_INDEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B6E0760)
#define SYSTEM_INDEX_THROWVALUEARGUMENTOUTOFRANGE_NEEDNONNEGNUMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B6E05D0)
#define SYSTEM_INDEX_TOSTRINGFROMEND_OFFSET UNITYSDK_OFFSET(0x3B5ADA0)
#define SYSTEM_INDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B5AD20)
#define SYSTEM_INDEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2E950)
#define SYSTEM_INDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x3B5AC20)
