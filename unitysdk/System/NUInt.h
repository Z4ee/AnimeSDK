...
#define SYSTEM_NUINT_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D127700)
#define SYSTEM_NUINT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1D1276F0)
#define SYSTEM_NUINT_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1D127710)
#define SYSTEM_NUINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x164FF0)
#define SYSTEM_NUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x3AD5CA0)

namespace System
{
	inline static constexpr unsigned int NUInt_TypeDefinitionIndex = 4951;
