...
#define SYSTEM_NUINT_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1ADCBE10)
#define SYSTEM_NUINT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1ADCBE00)
#define SYSTEM_NUINT_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1ADCBE20)
#define SYSTEM_NUINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC630)
#define SYSTEM_NUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x38322B0)

namespace System
{
	inline static constexpr unsigned int NUInt_TypeDefinitionIndex = 4946;
