...
#define SYSTEM_NUINT_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E77CF00)
#define SYSTEM_NUINT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1E77CEF0)
#define SYSTEM_NUINT_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E77CF10)
#define SYSTEM_NUINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC610)
#define SYSTEM_NUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x3B657A0)
