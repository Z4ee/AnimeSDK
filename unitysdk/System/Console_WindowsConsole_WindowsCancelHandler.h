...
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3D510)
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3D580)
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3D210)
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3D1F0)

namespace System
{
	inline static constexpr unsigned int Console_WindowsConsole_WindowsCancelHandler_TypeDefinitionIndex = 370;
