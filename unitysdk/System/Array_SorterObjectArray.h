...
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_DOWNHEAP_OFFSET UNITYSDK_OFFSET(0x8FAC60)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_HEAPSORT_OFFSET UNITYSDK_OFFSET(0x8FABD0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_INSERTIONSORT_OFFSET UNITYSDK_OFFSET(0x8FAC70)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_INTROSORT_OFFSET UNITYSDK_OFFSET(0x8FABB0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_INTROSPECTIVESORT_OFFSET UNITYSDK_OFFSET(0x8FABA0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_PICKPIVOTANDPARTITION_OFFSET UNITYSDK_OFFSET(0x8FABC0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_SORT_OFFSET UNITYSDK_OFFSET(0x8FABA0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_SWAPIFGREATERWITHITEMS_OFFSET UNITYSDK_OFFSET(0x8FAB80)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_SWAP_OFFSET UNITYSDK_OFFSET(0x8FAB90)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x8FAB00)
