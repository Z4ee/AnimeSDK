...
#define SYSTEM_DATA_DATAROWVIEW_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1F0B2EC0)
#define SYSTEM_DATA_DATAROWVIEW_BEGINEDIT_OFFSET UNITYSDK_OFFSET(0x1F0B2DE0)
#define SYSTEM_DATA_DATAROWVIEW_CANCELEDIT_OFFSET UNITYSDK_OFFSET(0x1F0B2DF0)
#define SYSTEM_DATA_DATAROWVIEW_CREATECHILDVIEW_1_OFFSET UNITYSDK_OFFSET(0x1F0B27A0)
#define SYSTEM_DATA_DATAROWVIEW_CREATECHILDVIEW_OFFSET UNITYSDK_OFFSET(0x1F0B2BD0)
#define SYSTEM_DATA_DATAROWVIEW_ENDEDIT_OFFSET UNITYSDK_OFFSET(0x1F0B2E70)
#define SYSTEM_DATA_DATAROWVIEW_EQUALS_OFFSET UNITYSDK_OFFSET(0x1F0B27F0)
#define SYSTEM_DATA_DATAROWVIEW_GETCOLUMNVALUE_OFFSET UNITYSDK_OFFSET(0x1F0B2A60)
#define SYSTEM_DATA_DATAROWVIEW_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1F0B2800)
#define SYSTEM_DATA_DATAROWVIEW_GETRECORD_OFFSET UNITYSDK_OFFSET(0x1F0B2900)
#define SYSTEM_DATA_DATAROWVIEW_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1F0B2E40)
#define SYSTEM_DATA_DATAROWVIEW_GET_ROWVERSIONDEFAULT_OFFSET UNITYSDK_OFFSET(0x1F0B2890)
#define SYSTEM_DATA_DATAROWVIEW_HASRECORD_OFFSET UNITYSDK_OFFSET(0x1F0B2970)
#define SYSTEM_DATA_DATAROWVIEW_RAISEPROPERTYCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1F0B2FC0)
#define SYSTEM_DATA_DATAROWVIEW_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1F0B2F40)
#define SYSTEM_DATA_DATAROWVIEW_SETCOLUMNVALUE_OFFSET UNITYSDK_OFFSET(0x1F0B2B00)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1F0B3070)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1F0B30C0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1F0B30D0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1F0B30E0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTEVENT_OFFSET UNITYSDK_OFFSET(0x1F0B30F0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1F0B3100)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x1F0B3110)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1F0B31A0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_OFFSET UNITYSDK_OFFSET(0x1F0B3120)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1F0B32E0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1F0B3220)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTYOWNER_OFFSET UNITYSDK_OFFSET(0x1F0B3360)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_IDATAERRORINFO_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1F0B2850)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_IDATAERRORINFO_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F0B2830)
#define SYSTEM_DATA_DATAROWVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F0B3370)
#define SYSTEM_DATA_DATAROWVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F0B3400)
#define SYSTEM_DATA_DATAROWVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0B27E0)

namespace System::Data
{
	inline static constexpr unsigned int DataRowView_TypeDefinitionIndex = 39263;
	...
	public:
		...
		{
			return (::System::ComponentModel::PropertyDescriptorCollection**)Il2CppClass::FromTypeDefinitionIndex(DataRowView_TypeDefinitionIndex)->GetStaticField(0x2AAF0);
		}
