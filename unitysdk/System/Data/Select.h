...
#define SYSTEM_DATA_SELECT_ACCEPTRECORD_OFFSET UNITYSDK_OFFSET(0x1DB3E8F0)
#define SYSTEM_DATA_SELECT_ANALYZEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DB3C330)
#define SYSTEM_DATA_SELECT_BUILDLINEAREXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DB3D910)
#define SYSTEM_DATA_SELECT_COMPARECLOSESTCANDIDATEINDEXDESC_OFFSET UNITYSDK_OFFSET(0x1DB3CAB0)
#define SYSTEM_DATA_SELECT_COMPARERECORDS_OFFSET UNITYSDK_OFFSET(0x1DB3F520)
#define SYSTEM_DATA_SELECT_COMPARESORTINDEXDESC_OFFSET UNITYSDK_OFFSET(0x1DB3C730)
#define SYSTEM_DATA_SELECT_CREATEINDEX_OFFSET UNITYSDK_OFFSET(0x1DB3CFE0)
#define SYSTEM_DATA_SELECT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1DB3F210)
#define SYSTEM_DATA_SELECT_EVAL_OFFSET UNITYSDK_OFFSET(0x1DB3EAD0)
#define SYSTEM_DATA_SELECT_FINDCLOSESTCANDIDATEINDEX_OFFSET UNITYSDK_OFFSET(0x1DB3CB80)
#define SYSTEM_DATA_SELECT_FINDFIRSTMATCHINGRECORD_OFFSET UNITYSDK_OFFSET(0x1DB3F3A0)
#define SYSTEM_DATA_SELECT_FINDLASTMATCHINGRECORD_OFFSET UNITYSDK_OFFSET(0x1DB3F460)
#define SYSTEM_DATA_SELECT_FINDSORTINDEX_OFFSET UNITYSDK_OFFSET(0x1DB3C830)
#define SYSTEM_DATA_SELECT_GETBINARYFILTEREDRECORDS_OFFSET UNITYSDK_OFFSET(0x1DB3E0B0)
#define SYSTEM_DATA_SELECT_GETLINEARFILTEREDRECORDS_OFFSET UNITYSDK_OFFSET(0x1DB3E2E0)
#define SYSTEM_DATA_SELECT_GETLINEARFILTEREDROWS_OFFSET UNITYSDK_OFFSET(0x1DB3DE40)
#define SYSTEM_DATA_SELECT_GETROWS_OFFSET UNITYSDK_OFFSET(0x1DB3E780)
#define SYSTEM_DATA_SELECT_INITCANDIDATECOLUMNS_OFFSET UNITYSDK_OFFSET(0x1DB3CE70)
#define SYSTEM_DATA_SELECT_ISOPERATORIN_OFFSET UNITYSDK_OFFSET(0x1DB3D880)
#define SYSTEM_DATA_SELECT_ISSUPPORTEDOPERATOR_OFFSET UNITYSDK_OFFSET(0x1DB3C310)
#define SYSTEM_DATA_SELECT_SELECTROWS_OFFSET UNITYSDK_OFFSET(0x1DB3DAE0)
#define SYSTEM_DATA_SELECT_SORT_OFFSET UNITYSDK_OFFSET(0x1DB3E5C0)
#define SYSTEM_DATA_SELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3C260)

namespace System::Data
{
	inline static constexpr unsigned int Select_TypeDefinitionIndex = 38675;

	class Select : public ::System::Object
	{
	public:
		::System::Data::Index* _index; // 0x10
		...
		::Il2CppArray<::System::Data::Select_ColumnInfo*>* _candidateColumns; // 0x38
		::System::Data::ExpressionNode* _linearExpression; // 0x40
		::Il2CppArray<::System::Data::IndexField>* _indexFields; // 0x48
		::System::Int32 _recordCount; // 0x50
		::System::Data::DataViewRowState _recordStates; // 0x54
		::System::Int32 _matchedCandidates; // 0x58
		::System::Boolean _candidatesForBinarySearch; // 0x5C
		::System::Int32 _nCandidates; // 0x60
