...
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTARGS_INITIALIZECOLUMNCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1DEDB8D0)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEDB860)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEDB800)

namespace System::Data
{
	inline static constexpr unsigned int DataColumnChangeEventArgs_TypeDefinitionIndex = 38568;
