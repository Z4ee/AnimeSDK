...
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A94C0A0)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A94C0E0)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A94BB20)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94BB10)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCreatedEventHandler_TypeDefinitionIndex = 36981;
