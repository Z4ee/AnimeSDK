...
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E0EE700)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E0EE740)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E0EE170)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0EE150)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCreatedEventHandler_TypeDefinitionIndex = 39259;
