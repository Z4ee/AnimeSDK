...
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1F4AFB80)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F4AFBD0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1F4AFB40)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1F4AFC00)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1F4AFD10)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1F4AFD00)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_NAMESEQUAL_OFFSET UNITYSDK_OFFSET(0x1F4AFC10)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F4AFD30)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4AFD20)

namespace System::Data
{
	inline static constexpr unsigned int InternalDataCollectionBase_TypeDefinitionIndex = 39215;
	...
	public:
		...
		{
			return (::System::ComponentModel::CollectionChangeEventArgs**)Il2CppClass::FromTypeDefinitionIndex(InternalDataCollectionBase_TypeDefinitionIndex)->GetStaticField(0x2A9E0);
		}
