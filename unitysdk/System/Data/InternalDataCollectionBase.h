...
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1BD5B330)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BD5B380)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1BD5B2F0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1BD5B3B0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1BD5B4D0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1BD5B4C0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_NAMESEQUAL_OFFSET UNITYSDK_OFFSET(0x1BD5B3C0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BD5B4F0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD5B4E0)

namespace System::Data
{
	inline static constexpr unsigned int InternalDataCollectionBase_TypeDefinitionIndex = 36937;
	...
	public:
		...
		{
			return (::System::ComponentModel::CollectionChangeEventArgs**)Il2CppClass::FromTypeDefinitionIndex(InternalDataCollectionBase_TypeDefinitionIndex)->GetStaticField(0x27410);
		}
