...
#define SYSTEM_DATA_BINARYNODE_BINARYCOMPARE_1_OFFSET UNITYSDK_OFFSET(0x1EAA97B0)
#define SYSTEM_DATA_BINARYNODE_BINARYCOMPARE_OFFSET UNITYSDK_OFFSET(0x1EAA9790)
#define SYSTEM_DATA_BINARYNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1EAA2340)
#define SYSTEM_DATA_BINARYNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1EAA9430)
#define SYSTEM_DATA_BINARYNODE_EVALBINARYOP_OFFSET UNITYSDK_OFFSET(0x1EAA2400)
#define SYSTEM_DATA_BINARYNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1EAA23C0)
#define SYSTEM_DATA_BINARYNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1EAA92B0)
#define SYSTEM_DATA_BINARYNODE_EVAL_3_OFFSET UNITYSDK_OFFSET(0x1EAA9740)
#define SYSTEM_DATA_BINARYNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1EAA23A0)
#define SYSTEM_DATA_BINARYNODE_GETPRECEDENCETYPE_OFFSET UNITYSDK_OFFSET(0x1EAAB7A0)
#define SYSTEM_DATA_BINARYNODE_GETPRECEDENCE_OFFSET UNITYSDK_OFFSET(0x1EAAB780)
#define SYSTEM_DATA_BINARYNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EAA9390)
#define SYSTEM_DATA_BINARYNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EAA93E0)
#define SYSTEM_DATA_BINARYNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1EAA92F0)
#define SYSTEM_DATA_BINARYNODE_ISMIXEDSQL_OFFSET UNITYSDK_OFFSET(0x1EAAB820)
#define SYSTEM_DATA_BINARYNODE_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1EAAB7C0)
#define SYSTEM_DATA_BINARYNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1EAA9340)
#define SYSTEM_DATA_BINARYNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1EAA9490)
#define SYSTEM_DATA_BINARYNODE_RESULTSQLTYPE_OFFSET UNITYSDK_OFFSET(0x1EAAAC60)
#define SYSTEM_DATA_BINARYNODE_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1EAAB290)
#define SYSTEM_DATA_BINARYNODE_SETTYPEMISMATCHERROR_OFFSET UNITYSDK_OFFSET(0x1EAA96F0)
#define SYSTEM_DATA_BINARYNODE_SQLRESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1EAAB880)
#define SYSTEM_DATA_BINARYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAA2320)

namespace System::Data
{
	inline static constexpr unsigned int BinaryNode_TypeDefinitionIndex = 39289;
