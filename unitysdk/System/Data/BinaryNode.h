...
#define SYSTEM_DATA_BINARYNODE_BINARYCOMPARE_1_OFFSET UNITYSDK_OFFSET(0x1D6CC5A0)
#define SYSTEM_DATA_BINARYNODE_BINARYCOMPARE_OFFSET UNITYSDK_OFFSET(0x1D6CC580)
#define SYSTEM_DATA_BINARYNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1D6C5170)
#define SYSTEM_DATA_BINARYNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1D6CC1E0)
#define SYSTEM_DATA_BINARYNODE_EVALBINARYOP_OFFSET UNITYSDK_OFFSET(0x1D6C5230)
#define SYSTEM_DATA_BINARYNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1D6C51F0)
#define SYSTEM_DATA_BINARYNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1D6CC060)
#define SYSTEM_DATA_BINARYNODE_EVAL_3_OFFSET UNITYSDK_OFFSET(0x1D6CC530)
#define SYSTEM_DATA_BINARYNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1D6C51D0)
#define SYSTEM_DATA_BINARYNODE_GETPRECEDENCETYPE_OFFSET UNITYSDK_OFFSET(0x1D6CE820)
#define SYSTEM_DATA_BINARYNODE_GETPRECEDENCE_OFFSET UNITYSDK_OFFSET(0x1D6CE800)
#define SYSTEM_DATA_BINARYNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1D6CC140)
#define SYSTEM_DATA_BINARYNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1D6CC190)
#define SYSTEM_DATA_BINARYNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1D6CC0A0)
#define SYSTEM_DATA_BINARYNODE_ISMIXEDSQL_OFFSET UNITYSDK_OFFSET(0x1D6CE8A0)
#define SYSTEM_DATA_BINARYNODE_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1D6CE840)
#define SYSTEM_DATA_BINARYNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1D6CC0F0)
#define SYSTEM_DATA_BINARYNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1D6CC240)
#define SYSTEM_DATA_BINARYNODE_RESULTSQLTYPE_OFFSET UNITYSDK_OFFSET(0x1D6CDAB0)
#define SYSTEM_DATA_BINARYNODE_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1D6CE280)
#define SYSTEM_DATA_BINARYNODE_SETTYPEMISMATCHERROR_OFFSET UNITYSDK_OFFSET(0x1D6CC4E0)
#define SYSTEM_DATA_BINARYNODE_SQLRESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1D6CE900)
#define SYSTEM_DATA_BINARYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6C5150)

namespace System::Data
{
	inline static constexpr unsigned int BinaryNode_TypeDefinitionIndex = 38628;
