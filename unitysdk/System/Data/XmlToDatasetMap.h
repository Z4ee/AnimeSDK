...
#define SYSTEM_DATA_XMLTODATASETMAP_ADDCOLUMNSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1DC6A630)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDCOLUMNSCHEMA_OFFSET UNITYSDK_OFFSET(0x1DC6A3B0)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDTABLESCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1DC6A140)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDTABLESCHEMA_OFFSET UNITYSDK_OFFSET(0x1DC69FB0)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_1_OFFSET UNITYSDK_OFFSET(0x1DC68130)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_2_OFFSET UNITYSDK_OFFSET(0x1DC68ED0)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_3_OFFSET UNITYSDK_OFFSET(0x1DC69290)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_OFFSET UNITYSDK_OFFSET(0x1DC67A10)
#define SYSTEM_DATA_XMLTODATASETMAP_GETCOLUMNSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1DC6AFB0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETCOLUMNSCHEMA_OFFSET UNITYSDK_OFFSET(0x1DC6ACD0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETSCHEMAFORNODE_OFFSET UNITYSDK_OFFSET(0x1DC6B1A0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETSELFANDDESCENDANTS_OFFSET UNITYSDK_OFFSET(0x1DC6A800)
#define SYSTEM_DATA_XMLTODATASETMAP_GETTABLEFORNODE_OFFSET UNITYSDK_OFFSET(0x1DC6B300)
#define SYSTEM_DATA_XMLTODATASETMAP_HANDLESPECIALCOLUMN_OFFSET UNITYSDK_OFFSET(0x1DC6A4B0)
#define SYSTEM_DATA_XMLTODATASETMAP_ISMAPPEDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1DC69F90)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DC68120)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DC68EC0)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DC69280)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC67A00)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_TypeDefinitionIndex = 38697;

	class XmlToDatasetMap : public ::System::Object
	{
	public:
		::System::Data::XmlToDatasetMap_TableSchemaInfo* _lastTableSchemaInfo; // 0x10
		::System::Data::XmlToDatasetMap_XmlNodeIdHashtable* _tableSchemaMap; // 0x18
