...
#define SYSTEM_DATA_AUTOINCREMENTINT64_BOUNDARYCHECK_OFFSET UNITYSDK_OFFSET(0x1B627170)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B626FA0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1B627090)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1B6270C0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1B627340)
#define SYSTEM_DATA_AUTOINCREMENTINT64_MOVEAFTER_OFFSET UNITYSDK_OFFSET(0x1B6273C0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SETCURRENTANDINCREMENT_OFFSET UNITYSDK_OFFSET(0x1B6273F0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SETCURRENT_OFFSET UNITYSDK_OFFSET(0x1B6273D0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B626FF0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1B6270D0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1B627350)
#define SYSTEM_DATA_AUTOINCREMENTINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1B627520)

namespace System::Data
{
	inline static constexpr unsigned int AutoIncrementInt64_TypeDefinitionIndex = 36949;
