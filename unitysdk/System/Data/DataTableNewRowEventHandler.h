...
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B62F180)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B62F1C0)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B62EC00)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B62EBF0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableNewRowEventHandler_TypeDefinitionIndex = 36996;
