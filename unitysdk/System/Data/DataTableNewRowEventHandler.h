...
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D9FB860)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D9FB8A0)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D9FB2E0)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9FB2C0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableNewRowEventHandler_TypeDefinitionIndex = 38613;
