...
#define SYSTEM_DATA_XMLSCHEMA_FEQUALIDENTITY_OFFSET UNITYSDK_OFFSET(0x1F0B7AD0)
#define SYSTEM_DATA_XMLSCHEMA_GENUNIQUECOLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1F0B7CA0)
#define SYSTEM_DATA_XMLSCHEMA_GETBOOLEANATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1F0B7B60)
#define SYSTEM_DATA_XMLSCHEMA_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1F0B7520)
#define SYSTEM_DATA_XMLSCHEMA_SETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1F0B7580)
#define SYSTEM_DATA_XMLSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0B7DB0)

namespace System::Data
{
	inline static constexpr unsigned int XMLSchema_TypeDefinitionIndex = 39351;
