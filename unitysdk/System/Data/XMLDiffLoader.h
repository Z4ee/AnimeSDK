...
#define SYSTEM_DATA_XMLDIFFLOADER_CREATETABLESHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1E0B1DD0)
#define SYSTEM_DATA_XMLDIFFLOADER_GETTABLE_OFFSET UNITYSDK_OFFSET(0x1E0B41F0)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_1_OFFSET UNITYSDK_OFFSET(0x1E0B21C0)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1E0B11B0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_1_OFFSET UNITYSDK_OFFSET(0x1E0B2450)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_OFFSET UNITYSDK_OFFSET(0x1E0B13C0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_1_OFFSET UNITYSDK_OFFSET(0x1E0B2910)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_OFFSET UNITYSDK_OFFSET(0x1E0B18C0)
#define SYSTEM_DATA_XMLDIFFLOADER_READOLDROWDATA_OFFSET UNITYSDK_OFFSET(0x1E0B3020)
#define SYSTEM_DATA_XMLDIFFLOADER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x1E0B2FD0)
#define SYSTEM_DATA_XMLDIFFLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0B4470)

namespace System::Data
{
	inline static constexpr unsigned int XMLDiffLoader_TypeDefinitionIndex = 38689;
