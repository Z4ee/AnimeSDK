...
#define SYSTEM_DATA_XMLDIFFLOADER_CREATETABLESHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1BD5E800)
#define SYSTEM_DATA_XMLDIFFLOADER_GETTABLE_OFFSET UNITYSDK_OFFSET(0x1BD60C20)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_1_OFFSET UNITYSDK_OFFSET(0x1BD5EBF0)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1BD5DBE0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_1_OFFSET UNITYSDK_OFFSET(0x1BD5EE80)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_OFFSET UNITYSDK_OFFSET(0x1BD5DDF0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_1_OFFSET UNITYSDK_OFFSET(0x1BD5F340)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_OFFSET UNITYSDK_OFFSET(0x1BD5E2F0)
#define SYSTEM_DATA_XMLDIFFLOADER_READOLDROWDATA_OFFSET UNITYSDK_OFFSET(0x1BD5FA50)
#define SYSTEM_DATA_XMLDIFFLOADER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x1BD5FA00)
#define SYSTEM_DATA_XMLDIFFLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD60EA0)

namespace System::Data
{
	inline static constexpr unsigned int XMLDiffLoader_TypeDefinitionIndex = 37072;
