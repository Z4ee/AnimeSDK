...
#define SYSTEM_DATA_SIMPLETYPE_CANHAVEMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1B3231E0)
#define SYSTEM_DATA_SIMPLETYPE_CONVERTTOANNONYMOUSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1B323250)
#define SYSTEM_DATA_SIMPLETYPE_CREATEBYTEARRAYTYPE_OFFSET UNITYSDK_OFFSET(0x1B322F30)
#define SYSTEM_DATA_SIMPLETYPE_CREATEENUMERATEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B322EA0)
#define SYSTEM_DATA_SIMPLETYPE_CREATELIMITEDSTRINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B322FC0)
#define SYSTEM_DATA_SIMPLETYPE_CREATESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1B323050)
#define SYSTEM_DATA_SIMPLETYPE_GET_SIMPLETYPEQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1B322960)
#define SYSTEM_DATA_SIMPLETYPE_HASCONFLICTINGDEFINITION_OFFSET UNITYSDK_OFFSET(0x1B323130)
#define SYSTEM_DATA_SIMPLETYPE_ISPLAINSTRING_OFFSET UNITYSDK_OFFSET(0x1B322760)
#define SYSTEM_DATA_SIMPLETYPE_LOADTYPEVALUES_OFFSET UNITYSDK_OFFSET(0x1B321F30)
#define SYSTEM_DATA_SIMPLETYPE_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1B3229C0)
#define SYSTEM_DATA_SIMPLETYPE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B322710)
#define SYSTEM_DATA_SIMPLETYPE_TONODE_OFFSET UNITYSDK_OFFSET(0x1B322A30)
#define SYSTEM_DATA_SIMPLETYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B321DF0)
#define SYSTEM_DATA_SIMPLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B321D90)

namespace System::Data
{
	inline static constexpr unsigned int SimpleType_TypeDefinitionIndex = 37068;
