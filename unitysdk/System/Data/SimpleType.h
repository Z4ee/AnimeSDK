...
#define SYSTEM_DATA_SIMPLETYPE_CANHAVEMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1EAB8D50)
#define SYSTEM_DATA_SIMPLETYPE_CONVERTTOANNONYMOUSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1EAB8DC0)
#define SYSTEM_DATA_SIMPLETYPE_CREATEBYTEARRAYTYPE_OFFSET UNITYSDK_OFFSET(0x1EAB8AA0)
#define SYSTEM_DATA_SIMPLETYPE_CREATEENUMERATEDTYPE_OFFSET UNITYSDK_OFFSET(0x1EAB8A10)
#define SYSTEM_DATA_SIMPLETYPE_CREATELIMITEDSTRINGTYPE_OFFSET UNITYSDK_OFFSET(0x1EAB8B30)
#define SYSTEM_DATA_SIMPLETYPE_CREATESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1EAB8BC0)
#define SYSTEM_DATA_SIMPLETYPE_GET_SIMPLETYPEQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1EAB84D0)
#define SYSTEM_DATA_SIMPLETYPE_HASCONFLICTINGDEFINITION_OFFSET UNITYSDK_OFFSET(0x1EAB8CA0)
#define SYSTEM_DATA_SIMPLETYPE_ISPLAINSTRING_OFFSET UNITYSDK_OFFSET(0x1EAB82D0)
#define SYSTEM_DATA_SIMPLETYPE_LOADTYPEVALUES_OFFSET UNITYSDK_OFFSET(0x1EAB7A00)
#define SYSTEM_DATA_SIMPLETYPE_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1EAB8530)
#define SYSTEM_DATA_SIMPLETYPE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1EAB8280)
#define SYSTEM_DATA_SIMPLETYPE_TONODE_OFFSET UNITYSDK_OFFSET(0x1EAB85A0)
#define SYSTEM_DATA_SIMPLETYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EAB78C0)
#define SYSTEM_DATA_SIMPLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAB7860)

namespace System::Data
{
	inline static constexpr unsigned int SimpleType_TypeDefinitionIndex = 39346;
