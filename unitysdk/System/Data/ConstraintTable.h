...
#define SYSTEM_DATA_CONSTRAINTTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED69990)

namespace System::Data
{
	inline static constexpr unsigned int ConstraintTable_TypeDefinitionIndex = 39352;
