...
#define SYSTEM_DATA_DATAROWCOLLECTION_ADDWITHCOLUMNEVENTS_OFFSET UNITYSDK_OFFSET(0x1ED6AE30)
#define SYSTEM_DATA_DATAROWCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1ED6AAA0)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYADD_OFFSET UNITYSDK_OFFSET(0x1ED6AF10)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYCLEAR_OFFSET UNITYSDK_OFFSET(0x1ED6B1B0)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYINSERT_OFFSET UNITYSDK_OFFSET(0x1ED6B0A0)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYREMOVE_OFFSET UNITYSDK_OFFSET(0x1ED6B220)
#define SYSTEM_DATA_DATAROWCOLLECTION_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1ED6B3F0)
#define SYSTEM_DATA_DATAROWCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1ED6B390)
#define SYSTEM_DATA_DATAROWCOLLECTION_DIFFINSERTAT_OFFSET UNITYSDK_OFFSET(0x1ED6AAD0)
#define SYSTEM_DATA_DATAROWCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ED6B450)
#define SYSTEM_DATA_DATAROWCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ED6A9D0)
#define SYSTEM_DATA_DATAROWCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1ED6A9F0)
#define SYSTEM_DATA_DATAROWCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1ED6ADA0)
#define SYSTEM_DATA_DATAROWCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED6B540)
#define SYSTEM_DATA_DATAROWCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED6A910)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCollection_TypeDefinitionIndex = 39257;

	class DataRowCollection : public ::System::Data::InternalDataCollectionBase
	{
	public:
		::System::Data::DataRowCollection_DataRowTree* _list; // 0x10
