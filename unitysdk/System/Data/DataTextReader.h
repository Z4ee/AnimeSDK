...
#define SYSTEM_DATA_DATATEXTREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B336DD0)
#define SYSTEM_DATA_DATATEXTREADER_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1B336800)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1B336BF0)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1B336C20)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B336BC0)
#define SYSTEM_DATA_DATATEXTREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1B336B90)
#define SYSTEM_DATA_DATATEXTREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1B336A70)
#define SYSTEM_DATA_DATATEXTREADER_GET_CANREADVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1B336F20)
#define SYSTEM_DATA_DATATEXTREADER_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1B336EC0)
#define SYSTEM_DATA_DATATEXTREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1B336A40)
#define SYSTEM_DATA_DATATEXTREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1B336DA0)
#define SYSTEM_DATA_DATATEXTREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1B336AD0)
#define SYSTEM_DATA_DATATEXTREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1B336AA0)
#define SYSTEM_DATA_DATATEXTREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1B336980)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1B3369B0)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1B336E60)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B336950)
#define SYSTEM_DATA_DATATEXTREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B336920)
#define SYSTEM_DATA_DATATEXTREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1B3369E0)
#define SYSTEM_DATA_DATATEXTREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1B336B00)
#define SYSTEM_DATA_DATATEXTREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1B336E00)
#define SYSTEM_DATA_DATATEXTREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B3368F0)
#define SYSTEM_DATA_DATATEXTREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B336A10)
#define SYSTEM_DATA_DATATEXTREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1B336B60)
#define SYSTEM_DATA_DATATEXTREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1B336B30)
#define SYSTEM_DATA_DATATEXTREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1B336E90)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1B336C80)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B336C50)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1B336D10)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B336CB0)
#define SYSTEM_DATA_DATATEXTREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B336CE0)
#define SYSTEM_DATA_DATATEXTREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1B336D40)
#define SYSTEM_DATA_DATATEXTREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1B336F50)
#define SYSTEM_DATA_DATATEXTREADER_READ_OFFSET UNITYSDK_OFFSET(0x1B336D70)
#define SYSTEM_DATA_DATATEXTREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1B336EF0)
#define SYSTEM_DATA_DATATEXTREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x1B336E30)
#define SYSTEM_DATA_DATATEXTREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B336890)

namespace System::Data
{
	inline static constexpr unsigned int DataTextReader_TypeDefinitionIndex = 37090;
