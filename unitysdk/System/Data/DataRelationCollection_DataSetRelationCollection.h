...
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_ADDCORE_OFFSET UNITYSDK_OFFSET(0x1B7F4770)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B7F4440)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_FINISHINITRELATIONS_OFFSET UNITYSDK_OFFSET(0x1B7F5790)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GETDATASET_OFFSET UNITYSDK_OFFSET(0x1B7F4480)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1B7F46B0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B7F4490)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1B7F4430)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_REMOVECORE_OFFSET UNITYSDK_OFFSET(0x1B7F5360)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F41E0)

namespace System::Data
{
	inline static constexpr unsigned int DataRelationCollection_DataSetRelationCollection_TypeDefinitionIndex = 36972;
	...
	public:
		...
		::Il2CppArray<::System::Data::DataRelation*>* _delayLoadingRelations; // 0x40
