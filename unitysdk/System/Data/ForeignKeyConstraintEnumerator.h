...
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINTENUMERATOR_GETFOREIGNKEYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1B31BC10)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINTENUMERATOR_ISVALIDCANDIDATE_OFFSET UNITYSDK_OFFSET(0x1B31BBA0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31BB30)

namespace System::Data
{
	inline static constexpr unsigned int ForeignKeyConstraintEnumerator_TypeDefinitionIndex = 36944;
