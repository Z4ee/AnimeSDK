...
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ADDAT_OFFSET UNITYSDK_OFFSET(0x1EFB9D40)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ADDCOLUMNSIMPLEMENTINGICHANGETRACKINGLIST_OFFSET UNITYSDK_OFFSET(0x1EFBCDC0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ADD_COLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFBA980)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ADD_COLUMNPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFBAA80)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1EFB9D30)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ARRAYADD_1_OFFSET UNITYSDK_OFFSET(0x1EFBA810)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ARRAYADD_OFFSET UNITYSDK_OFFSET(0x1EFBA880)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ARRAYREMOVE_OFFSET UNITYSDK_OFFSET(0x1EFBABD0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ASSIGNNAME_OFFSET UNITYSDK_OFFSET(0x1EFBAE60)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_BASEADD_OFFSET UNITYSDK_OFFSET(0x1EFBA460)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_BASEGROUPSWITCH_OFFSET UNITYSDK_OFFSET(0x1EFBB940)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_BASEREMOVE_OFFSET UNITYSDK_OFFSET(0x1EFBBCA0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_CANREGISTERNAME_OFFSET UNITYSDK_OFFSET(0x1EFBDAF0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_CANREMOVE_OFFSET UNITYSDK_OFFSET(0x1EFBBE20)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_CHECKICHANGETRACKING_OFFSET UNITYSDK_OFFSET(0x1EFBAB80)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1EFBCEC0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1EFBD390)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1EFBD2C0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_FINISHINITCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1EFBD600)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1EFB9590)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x1EFB9C20)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1EFB9310)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1EFB9300)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_INDEXOFCASEINSENSITIVE_OFFSET UNITYSDK_OFFSET(0x1EFB9850)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1EFBD480)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_MAKENAME_OFFSET UNITYSDK_OFFSET(0x1EFBAF60)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFBA910)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ONCOLLECTIONCHANGING_OFFSET UNITYSDK_OFFSET(0x1EFBA440)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_ONCOLUMNPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFBD6F0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_REGISTERCOLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1EFBB250)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_REMOVECOLUMNSIMPLEMENTINGICHANGETRACKINGLIST_OFFSET UNITYSDK_OFFSET(0x1EFBAD00)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_REMOVE_COLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFBAA00)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_REMOVE_COLUMNPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1EFBAB00)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1EFBDB70)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION_UNREGISTERNAME_OFFSET UNITYSDK_OFFSET(0x1EFBB730)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EFBDDA0)
#define SYSTEM_DATA_DATACOLUMNCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB91B0)

namespace System::Data
{
	inline static constexpr unsigned int DataColumnCollection_TypeDefinitionIndex = 39231;

	class DataColumnCollection : public ::System::Data::InternalDataCollectionBase
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Data::DataColumn*>* _columnFromName; // 0x10
		::System::Collections::ArrayList* _list; // 0x18
		::System::ComponentModel::CollectionChangeEventHandler* ColumnPropertyChanged; // 0x20
		::System::ComponentModel::CollectionChangeEventHandler* CollectionChanged; // 0x28
		::System::Data::DataTable* _table; // 0x30
		::System::ComponentModel::CollectionChangeEventHandler* CollectionChanging; // 0x38
		::Il2CppArray<::System::Data::DataColumn*>* _delayedAddRangeColumns; // 0x40
