...
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B990180)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9901C0)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B98FC00)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B98FBE0)

namespace System::Data
{
	inline static constexpr unsigned int DataRowChangeEventHandler_TypeDefinitionIndex = 38595;
