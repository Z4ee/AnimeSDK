...
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD8CB60)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1CD8CB40)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1CD8BDB0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1CD8BEB0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1CD8BF40)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1CD8BFD0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1CD8C190)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_ISSTREAMCLOSED_OFFSET UNITYSDK_OFFSET(0x1CD8BE40)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1CD8C8D0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_READ_OFFSET UNITYSDK_OFFSET(0x1CD8C450)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_SEEK_OFFSET UNITYSDK_OFFSET(0x1CD8C290)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1CD8CAC0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1CD8C1E0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCANNOTREAD_OFFSET UNITYSDK_OFFSET(0x1CD8C600)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCANNOTSEEK_OFFSET UNITYSDK_OFFSET(0x1CD8C100)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCANNOTWRITE_OFFSET UNITYSDK_OFFSET(0x1CD8C840)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCLOSED_OFFSET UNITYSDK_OFFSET(0x1CD8C040)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1CD8C9F0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_WRITE_OFFSET UNITYSDK_OFFSET(0x1CD8C690)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD8BD40)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlXmlStreamWrapper_TypeDefinitionIndex = 39394;
