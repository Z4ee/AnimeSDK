...
#define SYSTEM_DATA_SQLTYPES_SQLINT32_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0xA589E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA589D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_EQUALS_OFFSET UNITYSDK_OFFSET(0xA589F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA58A00)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1E1841E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x7D28C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA58770)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1E183950)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1E183890)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1E1830F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1E183400)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E183740)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1E183650)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1E183820)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E183530)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1E1835C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E183010)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1E1837B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E1832F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1E1831F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1E183080)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SAMESIGNINT_OFFSET UNITYSDK_OFFSET(0x1E1831E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0xA58A70)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0xA58A80)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0xA58830)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_TOSQLINT64_OFFSET UNITYSDK_OFFSET(0xA588B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA587D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E184260)
#define SYSTEM_DATA_SQLTYPES_SQLINT32__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA58760)
#define SYSTEM_DATA_SQLTYPES_SQLINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x9CEB90)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlInt32_TypeDefinitionIndex = 38721;

	struct alignas(4) SqlInt32
	{
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x9090);
		}
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x9098);
		}
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x90A0);
		}
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x90A8);
		}
		static ::System::Int64* StaticGet_s_lBitNotIntMax()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x90B0);
		}
		static ::System::Int64* StaticGet_s_iIntMin()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x90B8);
		}
