...
#define SYSTEM_DATA_INDEXFIELD_EQUALS_OFFSET UNITYSDK_OFFSET(0x92BF10)
#define SYSTEM_DATA_INDEXFIELD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x92BF70)
#define SYSTEM_DATA_INDEXFIELD_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AC6A840)
#define SYSTEM_DATA_INDEXFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x3493D0)

namespace System::Data
{
	inline static constexpr unsigned int IndexField_TypeDefinitionIndex = 37060;
