...
#define SYSTEM_DATA_COMMON_SQLCONVERT_CHANGETYPE2_OFFSET UNITYSDK_OFFSET(0x1F1A9D90)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CHANGETYPEFORDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1F1A9C20)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CHANGETYPEFORXML_OFFSET UNITYSDK_OFFSET(0x1F1AAA50)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTSTRINGTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x1F1A9B60)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLBINARY_OFFSET UNITYSDK_OFFSET(0x1F1A93B0)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1F1A8F70)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLBYTES_OFFSET UNITYSDK_OFFSET(0x1F1A99E0)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLBYTE_OFFSET UNITYSDK_OFFSET(0x1F1A47B0)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLCHARS_OFFSET UNITYSDK_OFFSET(0x1F1A9860)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLDATETIME_OFFSET UNITYSDK_OFFSET(0x1F1A8D30)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLDECIMAL_OFFSET UNITYSDK_OFFSET(0x1F1A6BF0)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x1F1A5E40)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLGUID_OFFSET UNITYSDK_OFFSET(0x1F1A9180)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLINT16_OFFSET UNITYSDK_OFFSET(0x1F1A49C0)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLINT32_OFFSET UNITYSDK_OFFSET(0x1F1A4D70)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLINT64_OFFSET UNITYSDK_OFFSET(0x1F1A5330)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLMONEY_OFFSET UNITYSDK_OFFSET(0x1F1A8430)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLSINGLE_OFFSET UNITYSDK_OFFSET(0x1F1A77B0)
#define SYSTEM_DATA_COMMON_SQLCONVERT_CONVERTTOSQLSTRING_OFFSET UNITYSDK_OFFSET(0x1F1A95D0)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlConvert_TypeDefinitionIndex = 39413;
