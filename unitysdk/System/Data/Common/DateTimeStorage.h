...
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1F4AC570)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1F4ACBD0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F4ACA50)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1F4AD6D0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1F4ACD50)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1F4AD630)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1F4AD880)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1F4ACF00)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1F4AD840)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1F4ACF90)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1F4AD560)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1F4ADA30)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1F4AD070)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F4ADCF0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4AC430)

namespace System::Data::Common
{
	inline static constexpr unsigned int DateTimeStorage_TypeDefinitionIndex = 39403;
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(DateTimeStorage_TypeDefinitionIndex)->GetStaticField(0x9370);
		}
