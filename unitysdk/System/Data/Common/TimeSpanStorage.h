...
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1F5B46C0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1F5B5A00)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F5B5890)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1F5B6170)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1F5B5B80)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1F5B5D50)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1F5B6100)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1F5B6380)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1F5B5DD0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1F5B6340)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1F5B5E60)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1F5B6030)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1F5B64A0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1F5B5F30)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F5B6530)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5B4580)

namespace System::Data::Common
{
	inline static constexpr unsigned int TimeSpanStorage_TypeDefinitionIndex = 39432;
	...
	public:
		...
		{
			return (::System::TimeSpan*)Il2CppClass::FromTypeDefinitionIndex(TimeSpanStorage_TypeDefinitionIndex)->GetStaticField(0x92E0);
		}
