...
#define SYSTEM_DATA_COMMON_CHARSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1F0AB600)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1F0ABAD0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F0ABA10)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1F0AC250)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1F0ABBD0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1F0AC1E0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1F0AC3D0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1F0ABD80)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1F0AC390)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1F0ABE10)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1F0AC110)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1F0AC4F0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1F0ABE90)
#define SYSTEM_DATA_COMMON_CHARSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0AB4F0)

namespace System::Data::Common
{
	inline static constexpr unsigned int CharStorage_TypeDefinitionIndex = 39399;
