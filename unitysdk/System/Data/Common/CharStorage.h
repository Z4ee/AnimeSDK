...
#define SYSTEM_DATA_COMMON_CHARSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B8F5170)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B8F5650)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B8F5590)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B8F5DD0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B8F5750)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B8F5D60)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B8F5F50)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B8F5900)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B8F5F10)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B8F5990)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B8F5C90)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B8F6070)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B8F5A10)
#define SYSTEM_DATA_COMMON_CHARSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F5060)

namespace System::Data::Common
{
	inline static constexpr unsigned int CharStorage_TypeDefinitionIndex = 37121;
