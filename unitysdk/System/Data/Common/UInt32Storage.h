...
#define SYSTEM_DATA_COMMON_UINT32STORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1CD70480)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1CD70E70)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1CD70DB0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1CD71670)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1CD70FB0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1CD715B0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1CD717A0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1CD71160)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1CD71760)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1CD711F0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1CD714E0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1CD718C0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1CD71290)
#define SYSTEM_DATA_COMMON_UINT32STORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD70360)

namespace System::Data::Common
{
	inline static constexpr unsigned int UInt32Storage_TypeDefinitionIndex = 39434;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(UInt32Storage_TypeDefinitionIndex)->GetStaticField(0x93A0);
		}
