...
#define SYSTEM_DATA_COMMON_UINT32STORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B988E40)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B989860)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B9897A0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B98A070)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B9899A0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B989FB0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B98A1A0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B989B50)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B98A160)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B989BE0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B989EE0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B98A2C0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B989C90)
#define SYSTEM_DATA_COMMON_UINT32STORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B988D20)

namespace System::Data::Common
{
	inline static constexpr unsigned int UInt32Storage_TypeDefinitionIndex = 38773;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(UInt32Storage_TypeDefinitionIndex)->GetStaticField(0x92B0);
		}
