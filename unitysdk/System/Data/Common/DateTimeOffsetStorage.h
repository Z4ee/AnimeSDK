...
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B4F1840)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B4F20E0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B4F1EA0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B4F2820)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B4F22D0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4F27A0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B4F2960)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B4F23A0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B4F2920)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B4F2430)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B4F26D0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B4F2A90)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B4F2570)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4F2B20)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F1700)

namespace System::Data::Common
{
	inline static constexpr unsigned int DateTimeOffsetStorage_TypeDefinitionIndex = 37124;
	...
	public:
		...
		{
			return (::System::DateTimeOffset*)Il2CppClass::FromTypeDefinitionIndex(DateTimeOffsetStorage_TypeDefinitionIndex)->GetStaticField(0x8D80);
		}
