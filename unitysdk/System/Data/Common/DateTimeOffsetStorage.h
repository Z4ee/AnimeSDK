...
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EC16E10)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1EC17690)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1EC17450)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1EC17DD0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1EC17880)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1EC17D50)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1EC17F10)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1EC17950)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1EC17ED0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1EC179E0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1EC17C80)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1EC18040)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1EC17B20)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC180D0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC16CD0)

namespace System::Data::Common
{
	inline static constexpr unsigned int DateTimeOffsetStorage_TypeDefinitionIndex = 39402;
	...
	public:
		...
		{
			return (::System::DateTimeOffset*)Il2CppClass::FromTypeDefinitionIndex(DateTimeOffsetStorage_TypeDefinitionIndex)->GetStaticField(0x9330);
		}
