...
#define SYSTEM_DATA_COMMON_DATASTORAGE_AGGREGATECOUNT_OFFSET UNITYSDK_OFFSET(0x1BFD8670)
#define SYSTEM_DATA_COMMON_DATASTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1BFD8660)
#define SYSTEM_DATA_COMMON_DATASTORAGE_COMPAREBITS_OFFSET UNITYSDK_OFFSET(0x1BFD8730)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1BFD8940)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1BFD8790)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFD8900)
#define SYSTEM_DATA_COMMON_DATASTORAGE_COPYBITS_OFFSET UNITYSDK_OFFSET(0x1BFD87A0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_COPYVALUEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BFD9970)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CREATESTORAGE_OFFSET UNITYSDK_OFFSET(0x1BFD8980)
#define SYSTEM_DATA_COMMON_DATASTORAGE_DETERMINEIFVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1BFD8580)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETBITS_OFFSET UNITYSDK_OFFSET(0x1BFD87E0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETEMPTYSTORAGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BFD9960)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1BFD9AF0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETSTORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1BFD9180)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1BFD8820)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETTYPESTORAGE_OFFSET UNITYSDK_OFFSET(0x1BFD92A0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1BFD99B0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GET_DATETIMEMODE_OFFSET UNITYSDK_OFFSET(0x1BFD85D0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GET_FORMATPROVIDER_OFFSET UNITYSDK_OFFSET(0x1BFD85F0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1BFD8830)
#define SYSTEM_DATA_COMMON_DATASTORAGE_IMPLEMENTSINTERFACES_OFFSET UNITYSDK_OFFSET(0x1BFD94C0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_IMPLEMENTSINULLABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1BFD9780)
#define SYSTEM_DATA_COMMON_DATASTORAGE_INSPECTTYPEFORINTERFACES_OFFSET UNITYSDK_OFFSET(0x1BFD9600)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1BFD8850)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISOBJECTNULL_OFFSET UNITYSDK_OFFSET(0x1BFD9800)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISOBJECTSQLNULL_OFFSET UNITYSDK_OFFSET(0x1BFD9890)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISSQLTYPE_1_OFFSET UNITYSDK_OFFSET(0x1BFD93C0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISSQLTYPE_OFFSET UNITYSDK_OFFSET(0x1BFD93B0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISTYPECUSTOMTYPE_1_OFFSET UNITYSDK_OFFSET(0x1BFD8560)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISTYPECUSTOMTYPE_OFFSET UNITYSDK_OFFSET(0x1BFD9340)
#define SYSTEM_DATA_COMMON_DATASTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1BFD8890)
#define SYSTEM_DATA_COMMON_DATASTORAGE_SETNULLBIT_OFFSET UNITYSDK_OFFSET(0x1BFD8870)
#define SYSTEM_DATA_COMMON_DATASTORAGE_SETSTORAGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BFD99A0)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFD9B70)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BFD8530)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BFD8400)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFD8360)

namespace System::Data::Common
{
	inline static constexpr unsigned int DataStorage_TypeDefinitionIndex = 37123;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Type*, ::System::Tuple_4<::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean>*>**)Il2CppClass::FromTypeDefinitionIndex(DataStorage_TypeDefinitionIndex)->GetStaticField(0x27500);
		}
		static ::Il2CppArray<::System::Type*>** StaticGet_s_storageClassType()
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(DataStorage_TypeDefinitionIndex)->GetStaticField(0x27508);
		}
		...
		{
			return (::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*, ::System::Tuple_4<::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean>*>**)Il2CppClass::FromTypeDefinitionIndex(DataStorage_TypeDefinitionIndex)->GetStaticField(0x27510);
		}
		::System::Data::DataColumn* _column; // 0x10
		::System::Collections::BitArray* _dbNullBits; // 0x18
		::System::Object* _defaultValue; // 0x20
		::System::Data::DataTable* _table; // 0x28
		::System::Type* _dataType; // 0x30
		::System::Object* _nullValue; // 0x38
		::System::Boolean _isCustomDefinedType; // 0x40
		::System::Boolean _isStringType; // 0x41
		::System::Boolean _isCloneable; // 0x42
		::System::Boolean _isValueType; // 0x43
		::System::Data::Common::StorageType _storageTypeCode; // 0x44
