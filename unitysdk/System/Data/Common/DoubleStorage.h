...
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1E0E9A50)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1E0EA390)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1E0EA260)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1E0EAB70)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1E0EA510)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1E0EAB00)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1E0EAC80)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1E0EA6C0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1E0EAC40)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1E0EA750)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1E0EAA30)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1E0EADB0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1E0EA7E0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E9940)

namespace System::Data::Common
{
	inline static constexpr unsigned int DoubleStorage_TypeDefinitionIndex = 39405;
