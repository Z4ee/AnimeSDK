...
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1CD305C0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1CD30F60)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1CD30E30)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1CD31740)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1CD310E0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1CD316D0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1CD31860)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1CD31290)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1CD31820)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1CD31320)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1CD31600)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1CD31990)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1CD313B0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD304B0)

namespace System::Data::Common
{
	inline static constexpr unsigned int DoubleStorage_TypeDefinitionIndex = 38744;
