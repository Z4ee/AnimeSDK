...
#define SYSTEM_DATA_COMMON_BYTESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1D713A80)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1D714410)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1D714350)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1D714C20)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1D714550)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1D714B60)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1D714D50)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1D714700)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1D714D10)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1D714790)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D714A90)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1D714E70)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1D714840)
#define SYSTEM_DATA_COMMON_BYTESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D713970)

namespace System::Data::Common
{
	inline static constexpr unsigned int ByteStorage_TypeDefinitionIndex = 38737;
