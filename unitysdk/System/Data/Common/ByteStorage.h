...
#define SYSTEM_DATA_COMMON_BYTESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EAB9880)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1EABA1D0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1EABA120)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1EABA9D0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1EABA310)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1EABA910)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1EABAB00)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1EABA4C0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1EABAAC0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1EABA550)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1EABA840)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1EABAC20)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1EABA5F0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAB9770)

namespace System::Data::Common
{
	inline static constexpr unsigned int ByteStorage_TypeDefinitionIndex = 39398;
