...
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1E0E89B0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1E0E8E80)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1E0E8DC0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1E0E9640)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1E0E8FD0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1E0E95D0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1E0E9790)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1E0E9180)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1E0E9750)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1E0E9210)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1E0E9500)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1E0E98B0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1E0E92B0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E88A0)

namespace System::Data::Common
{
	inline static constexpr unsigned int BooleanStorage_TypeDefinitionIndex = 39397;
