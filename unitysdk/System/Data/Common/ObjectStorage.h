...
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B97F3C0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B9802A0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B980060)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPAREWITHFAMILIES_OFFSET UNITYSDK_OFFSET(0x1B97F630)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B97F410)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x1B982930)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B982430)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B981640)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B980F10)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B982B10)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B980570)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B982AD0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETFAMILY_OFFSET UNITYSDK_OFFSET(0x1B9804D0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETXMLSERIALIZER_1_OFFSET UNITYSDK_OFFSET(0x1B981D40)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETXMLSERIALIZER_OFFSET UNITYSDK_OFFSET(0x1B9815B0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B980250)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1B980620)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B980EA0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B982E20)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B980660)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_VERIFYIDYNAMICMETAOBJECTPROVIDER_OFFSET UNITYSDK_OFFSET(0x1B983090)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B983180)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97F240)

namespace System::Data::Common
{
	inline static constexpr unsigned int ObjectStorage_TypeDefinitionIndex = 38748;
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x29250);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Collections::Generic::KeyValuePair_2<::System::Type*, ::System::Xml::Serialization::XmlRootAttribute*>, ::System::Xml::Serialization::XmlSerializer*>**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x29258);
		}
		static ::System::Xml::Serialization::XmlSerializerFactory** StaticGet_s_serializerFactory()
		{
			return (::System::Xml::Serialization::XmlSerializerFactory**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x29260);
		}
		static ::System::Object** StaticGet_s_tempAssemblyCacheLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x29268);
		}
