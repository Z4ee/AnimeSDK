...
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B315D50)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B315EA0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B315DA0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTFROMBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1B316770)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B317400)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTTOBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1B315FF0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B316E80)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B317330)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B317520)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B316F60)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B3174E0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B316FF0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B317260)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B317650)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B3170D0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B315C00)

namespace System::Data::Common
{
	inline static constexpr unsigned int BigIntegerStorage_TypeDefinitionIndex = 37118;
