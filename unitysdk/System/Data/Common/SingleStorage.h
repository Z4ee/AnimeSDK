...
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B4F4260)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B4F4BC0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B4F4AA0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B4F53D0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B4F4D50)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4F5360)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B4F54F0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B4F4F00)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B4F54B0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B4F4F90)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B4F5290)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B4F5620)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B4F5040)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F4150)

namespace System::Data::Common
{
	inline static constexpr unsigned int SingleStorage_TypeDefinitionIndex = 37151;
