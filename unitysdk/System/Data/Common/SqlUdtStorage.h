...
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B62AD50)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B62ADE0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B62ADA0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x1B62C070)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B62BCA0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B62B9E0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B62B550)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B62C230)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B62B0F0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B62C1F0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GETSTATICNULLFORUDTTYPE_OFFSET UNITYSDK_OFFSET(0x1B62A720)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B62B1D0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1B62AC00)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B62B480)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B62C3C0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B62B210)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B62C450)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B62AAA0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B62A6A0)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlUdtStorage_TypeDefinitionIndex = 37152;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(SqlUdtStorage_TypeDefinitionIndex)->GetStaticField(0x274D0);
		}
		::Il2CppArray<::System::Object*>* _values; // 0x48
		::System::Boolean _implementsIComparable; // 0x50
		::System::Boolean _implementsIXmlSerializable; // 0x51
