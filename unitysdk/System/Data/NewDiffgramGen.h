...
#define SYSTEM_DATA_NEWDIFFGRAMGEN_CREATETABLEHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1EAC6050)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_DOASSIGNMENTS_OFFSET UNITYSDK_OFFSET(0x1EAC5BC0)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_EMPTYDATA_OFFSET UNITYSDK_OFFSET(0x1EAC6430)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATECOLUMN_OFFSET UNITYSDK_OFFSET(0x1EAC81B0)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATEROW_OFFSET UNITYSDK_OFFSET(0x1EAC7930)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATETABLEERRORS_OFFSET UNITYSDK_OFFSET(0x1EAC6DD0)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATETABLE_OFFSET UNITYSDK_OFFSET(0x1EAC6D50)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1EAC8AC0)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1EAC6540)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_SAVE_OFFSET UNITYSDK_OFFSET(0x1EAC6530)
#define SYSTEM_DATA_NEWDIFFGRAMGEN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EAC5F30)
#define SYSTEM_DATA_NEWDIFFGRAMGEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAC5A50)

namespace System::Data
{
	inline static constexpr unsigned int NewDiffgramGen_TypeDefinitionIndex = 39365;

	class NewDiffgramGen : public ::System::Object
	{
	public:
		::System::Data::DataTable* _dt; // 0x10
		::System::Collections::ArrayList* _tables; // 0x18
		::System::Xml::XmlDocument* _doc; // 0x20
		::System::Collections::Hashtable* _rowsOrder; // 0x28
		::System::Data::DataSet* _ds; // 0x30
		::System::Xml::XmlWriter* _xmlw; // 0x38
		::System::Boolean _writeHierarchy; // 0x40
		::System::Boolean _fErrors; // 0x41
