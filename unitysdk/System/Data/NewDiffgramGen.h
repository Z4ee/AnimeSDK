...
#define SYSTEM_DATA_NEWDIFFGRAMGEN_CREATETABLEHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B341D50)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_DOASSIGNMENTS_OFFSET UNITYSDK_OFFSET(0x1B3418B0)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_EMPTYDATA_OFFSET UNITYSDK_OFFSET(0x1B342140)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATECOLUMN_OFFSET UNITYSDK_OFFSET(0x1B343EF0)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATEROW_OFFSET UNITYSDK_OFFSET(0x1B343680)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATETABLEERRORS_OFFSET UNITYSDK_OFFSET(0x1B342B10)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_GENERATETABLE_OFFSET UNITYSDK_OFFSET(0x1B342A90)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1B344820)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1B342250)
#define SYSTEM_DATA_NEWDIFFGRAMGEN_SAVE_OFFSET UNITYSDK_OFFSET(0x1B342240)
#define SYSTEM_DATA_NEWDIFFGRAMGEN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B341C30)
#define SYSTEM_DATA_NEWDIFFGRAMGEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B341740)

namespace System::Data
{
	inline static constexpr unsigned int NewDiffgramGen_TypeDefinitionIndex = 37087;

	class NewDiffgramGen : public ::System::Object
	{
	public:
		::System::Xml::XmlWriter* _xmlw; // 0x10
		::System::Xml::XmlDocument* _doc; // 0x18
		::System::Data::DataTable* _dt; // 0x20
		::System::Collections::Hashtable* _rowsOrder; // 0x28
		::System::Collections::ArrayList* _tables; // 0x30
