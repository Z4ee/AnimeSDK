...
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EC24690)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EC246D0)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EC24100)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC240E0)

namespace System::Data
{
	inline static constexpr unsigned int DataSetClearEventhandler_TypeDefinitionIndex = 39260;
