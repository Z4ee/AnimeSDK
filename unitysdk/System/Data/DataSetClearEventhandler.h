...
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4FF190)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4FF1D0)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4FEC10)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FEC00)

namespace System::Data
{
	inline static constexpr unsigned int DataSetClearEventhandler_TypeDefinitionIndex = 36982;
