...
#define SYSTEM_DATA_CONSTRAINT_CHECKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1B317CE0)
#define SYSTEM_DATA_CONSTRAINT_CHECKSTATEFORPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B317D40)
#define SYSTEM_DATA_CONSTRAINT_GET_EXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B317C30)
#define SYSTEM_DATA_CONSTRAINT_GET_SCHEMANAME_OFFSET UNITYSDK_OFFSET(0x1B317BC0)
#define SYSTEM_DATA_CONSTRAINT_SET_CONSTRAINTNAME_OFFSET UNITYSDK_OFFSET(0x1B3176E0)
#define SYSTEM_DATA_CONSTRAINT_SET_INCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1B317BF0)
#define SYSTEM_DATA_CONSTRAINT_SET_SCHEMANAME_OFFSET UNITYSDK_OFFSET(0x1B317BE0)
#define SYSTEM_DATA_CONSTRAINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B317E70)
#define SYSTEM_DATA_CONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B317E80)

namespace System::Data
{
	inline static constexpr unsigned int Constraint_TypeDefinitionIndex = 36940;

	class Constraint : public ::System::Object
	{
	public:
		::System::String* _name; // 0x10
		::System::String* _schemaName; // 0x18
		::System::Data::DataSet* _dataSet; // 0x20
		::System::Data::PropertyCollection* _extendedProperties; // 0x28
