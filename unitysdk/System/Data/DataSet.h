...
#define SYSTEM_DATA_DATASET_ADD_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1CD7EF10)
#define SYSTEM_DATA_DATASET_BEGININIT_OFFSET UNITYSDK_OFFSET(0x1CD7F010)
#define SYSTEM_DATA_DATASET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CD7F320)
#define SYSTEM_DATA_DATASET_CLONE_OFFSET UNITYSDK_OFFSET(0x1CD7F520)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASETDATA_OFFSET UNITYSDK_OFFSET(0x1CD79F30)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CD7A190)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD79A10)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASET_OFFSET UNITYSDK_OFFSET(0x1CD78000)
#define SYSTEM_DATA_DATASET_DESERIALIZERELATIONS_OFFSET UNITYSDK_OFFSET(0x1CD7A3A0)
#define SYSTEM_DATA_DATASET_ENABLECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1CD7C6B0)
#define SYSTEM_DATA_DATASET_ENDINIT_OFFSET UNITYSDK_OFFSET(0x1CD7F020)
#define SYSTEM_DATA_DATASET_ESTIMATEDXMLSTRINGSIZE_OFFSET UNITYSDK_OFFSET(0x1CD79540)
#define SYSTEM_DATA_DATASET_FAILEDENABLECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1CD7BBA0)
#define SYSTEM_DATA_DATASET_FINDTABLE_OFFSET UNITYSDK_OFFSET(0x1CD8A7B0)
#define SYSTEM_DATA_DATASET_GETDATASETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD8ABC0)
#define SYSTEM_DATA_DATASET_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1CD78060)
#define SYSTEM_DATA_DATASET_GETREMOTINGDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1CD80EA0)
#define SYSTEM_DATA_DATASET_GETXMLSCHEMAFORREMOTING_OFFSET UNITYSDK_OFFSET(0x1CD79410)
#define SYSTEM_DATA_DATASET_GET_DEFAULTVIEWMANAGER_OFFSET UNITYSDK_OFFSET(0x1CD7C590)
#define SYSTEM_DATA_DATASET_GET_EXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CD7BAF0)
#define SYSTEM_DATA_DATASET_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1CD7D830)
#define SYSTEM_DATA_DATASET_GET_SITE_OFFSET UNITYSDK_OFFSET(0x1CD7ED70)
#define SYSTEM_DATA_DATASET_INFERSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD81660)
#define SYSTEM_DATA_DATASET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1CD87720)
#define SYSTEM_DATA_DATASET_MERGE_1_OFFSET UNITYSDK_OFFSET(0x1CD89CC0)
#define SYSTEM_DATA_DATASET_MERGE_OFFSET UNITYSDK_OFFSET(0x1CD87A70)
#define SYSTEM_DATA_DATASET_MOVETOELEMENT_1_OFFSET UNITYSDK_OFFSET(0x1CD81A40)
#define SYSTEM_DATA_DATASET_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1CD81540)
#define SYSTEM_DATA_DATASET_ONCLEARFUNCTIONCALLED_OFFSET UNITYSDK_OFFSET(0x1CD7F500)
#define SYSTEM_DATA_DATASET_ONDATAROWCREATED_OFFSET UNITYSDK_OFFSET(0x1CD8A090)
#define SYSTEM_DATA_DATASET_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1CD7F2A0)
#define SYSTEM_DATA_DATASET_ONMERGEFAILED_OFFSET UNITYSDK_OFFSET(0x1CD89EE0)
#define SYSTEM_DATA_DATASET_ONPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x1CD89EC0)
#define SYSTEM_DATA_DATASET_ONREMOVEDTABLE_OFFSET UNITYSDK_OFFSET(0x1CD8A0B0)
#define SYSTEM_DATA_DATASET_RAISEMERGEFAILED_OFFSET UNITYSDK_OFFSET(0x1CD89F50)
#define SYSTEM_DATA_DATASET_RAISEPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x1CD7CFB0)
#define SYSTEM_DATA_DATASET_READENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1CD815D0)
#define SYSTEM_DATA_DATASET_READXDRSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD80FA0)
#define SYSTEM_DATA_DATASET_READXMLDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1CD85E40)
#define SYSTEM_DATA_DATASET_READXMLSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1CD7B130)
#define SYSTEM_DATA_DATASET_READXMLSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD80F90)
#define SYSTEM_DATA_DATASET_READXMLSERIALIZABLE_OFFSET UNITYSDK_OFFSET(0x1CD8A8D0)
#define SYSTEM_DATA_DATASET_READXML_1_OFFSET UNITYSDK_OFFSET(0x1CD84B40)
#define SYSTEM_DATA_DATASET_READXML_2_OFFSET UNITYSDK_OFFSET(0x1CD7BAE0)
#define SYSTEM_DATA_DATASET_READXML_3_OFFSET UNITYSDK_OFFSET(0x1CD87BE0)
#define SYSTEM_DATA_DATASET_READXML_OFFSET UNITYSDK_OFFSET(0x1CD84B30)
#define SYSTEM_DATA_DATASET_READXSDSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD81160)
#define SYSTEM_DATA_DATASET_REMOVE_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1CD7EF90)
#define SYSTEM_DATA_DATASET_RESET_OFFSET UNITYSDK_OFFSET(0x1CD8A390)
#define SYSTEM_DATA_DATASET_SERIALIZEDATASETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CD788B0)
#define SYSTEM_DATA_DATASET_SERIALIZEDATASET_OFFSET UNITYSDK_OFFSET(0x1CD78090)
#define SYSTEM_DATA_DATASET_SERIALIZERELATIONS_OFFSET UNITYSDK_OFFSET(0x1CD78C60)
#define SYSTEM_DATA_DATASET_SETLOCALEVALUE_OFFSET UNITYSDK_OFFSET(0x1CD7DA00)
#define SYSTEM_DATA_DATASET_SET_CASESENSITIVE_OFFSET UNITYSDK_OFFSET(0x1CD7BD50)
#define SYSTEM_DATA_DATASET_SET_DATASETNAME_OFFSET UNITYSDK_OFFSET(0x1CD779D0)
#define SYSTEM_DATA_DATASET_SET_ENFORCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1CD7BBF0)
#define SYSTEM_DATA_DATASET_SET_LOCALE_OFFSET UNITYSDK_OFFSET(0x1CD7D840)
#define SYSTEM_DATA_DATASET_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CD7D050)
#define SYSTEM_DATA_DATASET_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1CD7D5C0)
#define SYSTEM_DATA_DATASET_SET_REMOTINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1CD77BD0)
#define SYSTEM_DATA_DATASET_SET_SITE_OFFSET UNITYSDK_OFFSET(0x1CD7ED80)
#define SYSTEM_DATA_DATASET_SYSTEM_COMPONENTMODEL_ILISTSOURCE_GETLIST_OFFSET UNITYSDK_OFFSET(0x1CD80E90)
#define SYSTEM_DATA_DATASET_SYSTEM_COMPONENTMODEL_ILISTSOURCE_GET_CONTAINSLISTCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1CD7C580)
#define SYSTEM_DATA_DATASET_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD8B140)
#define SYSTEM_DATA_DATASET_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x1CD8B3B0)
#define SYSTEM_DATA_DATASET_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x1CD8B6D0)
#define SYSTEM_DATA_DATASET_TOPLEVELTABLES_1_OFFSET UNITYSDK_OFFSET(0x1CD8A110)
#define SYSTEM_DATA_DATASET_TOPLEVELTABLES_OFFSET UNITYSDK_OFFSET(0x1CD8A100)
#define SYSTEM_DATA_DATASET_VALIDATECASECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1CD7C090)
#define SYSTEM_DATA_DATASET_VALIDATELOCALECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1CD7E830)
#define SYSTEM_DATA_DATASET_WRITEXMLSCHEMA_OFFSET UNITYSDK_OFFSET(0x1CD84970)
#define SYSTEM_DATA_DATASET_WRITEXML_OFFSET UNITYSDK_OFFSET(0x1CD79840)
#define SYSTEM_DATA_DATASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CD779A0)
#define SYSTEM_DATA_DATASET__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CD77D00)
#define SYSTEM_DATA_DATASET__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CD77D20)
#define SYSTEM_DATA_DATASET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD777C0)

namespace System::Data
{
	inline static constexpr unsigned int DataSet_TypeDefinitionIndex = 39265;
	...
	public:
		...
		{
			return (::System::Xml::Schema::XmlSchemaComplexType**)Il2CppClass::FromTypeDefinitionIndex(DataSet_TypeDefinitionIndex)->GetStaticField(0x2ABA0);
		}
		static ::System::Int32* StaticGet_s_objectTypeCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataSet_TypeDefinitionIndex)->GetStaticField(0x93C0);
		}
