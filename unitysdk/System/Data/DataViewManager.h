...
#define SYSTEM_DATA_DATAVIEWMANAGER_ADD_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1D077540)
#define SYSTEM_DATA_DATAVIEWMANAGER_CREATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1D077970)
#define SYSTEM_DATA_DATAVIEWMANAGER_ONLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1D077A40)
#define SYSTEM_DATA_DATAVIEWMANAGER_RELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1D077DB0)
#define SYSTEM_DATA_DATAVIEWMANAGER_REMOVE_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1D0775C0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1D077130)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D0770E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1D077100)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1D0770F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D076ED0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1D0771F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D077240)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D077290)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1D077120)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1D077110)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D077190)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1D0772A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1D0772B0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1D077350)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D077300)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D0771A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x1D077640)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1D0773B0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1D077650)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_FIND_OFFSET UNITYSDK_OFFSET(0x1D0776A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWEDIT_OFFSET UNITYSDK_OFFSET(0x1D077400)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWNEW_OFFSET UNITYSDK_OFFSET(0x1D0773A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWREMOVE_OFFSET UNITYSDK_OFFSET(0x1D077410)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1D077450)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1D0774F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1D0774A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSCHANGENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1D077420)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSEARCHING_OFFSET UNITYSDK_OFFSET(0x1D077430)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSORTING_OFFSET UNITYSDK_OFFSET(0x1D077440)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVEINDEX_OFFSET UNITYSDK_OFFSET(0x1D0776F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVESORT_OFFSET UNITYSDK_OFFSET(0x1D077700)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETITEMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D0777E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETLISTNAME_OFFSET UNITYSDK_OFFSET(0x1D077750)
#define SYSTEM_DATA_DATAVIEWMANAGER_TABLECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1D077B60)
#define SYSTEM_DATA_DATAVIEWMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D078000)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D076C40)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D076C30)

namespace System::Data
{
	inline static constexpr unsigned int DataViewManager_TypeDefinitionIndex = 38619;
	...
	public:
		...
		{
			return (::System::NotSupportedException**)Il2CppClass::FromTypeDefinitionIndex(DataViewManager_TypeDefinitionIndex)->GetStaticField(0x292C0);
		}
		::System::Data::DataSet* _dataSet; // 0x20
		::System::Data::DataViewSettingCollection* _dataViewSettingsCollection; // 0x28
		::System::Data::DataViewManagerListItemTypeDescriptor* _item; // 0x30
		::System::ComponentModel::ListChangedEventHandler* ListChanged; // 0x38
