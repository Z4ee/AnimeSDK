...
#define SYSTEM_DATA_DATAVIEWMANAGER_ADD_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3E2E40)
#define SYSTEM_DATA_DATAVIEWMANAGER_CREATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1E3E3270)
#define SYSTEM_DATA_DATAVIEWMANAGER_ONLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3E3340)
#define SYSTEM_DATA_DATAVIEWMANAGER_RELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3E36B0)
#define SYSTEM_DATA_DATAVIEWMANAGER_REMOVE_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3E2EC0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1E3E2A20)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E3E29D0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1E3E29F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1E3E29E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E3E28E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1E3E2AE0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E3E2B30)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1E3E2B80)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1E3E2A10)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1E3E2A00)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E3E2A80)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1E3E2B90)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1E3E2BB0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1E3E2C50)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1E3E2C00)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E3E2A90)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x1E3E2F40)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1E3E2CB0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1E3E2F50)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_FIND_OFFSET UNITYSDK_OFFSET(0x1E3E2FA0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWEDIT_OFFSET UNITYSDK_OFFSET(0x1E3E2D00)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWNEW_OFFSET UNITYSDK_OFFSET(0x1E3E2CA0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWREMOVE_OFFSET UNITYSDK_OFFSET(0x1E3E2D10)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1E3E2D50)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1E3E2DF0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E3E2DA0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSCHANGENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1E3E2D20)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSEARCHING_OFFSET UNITYSDK_OFFSET(0x1E3E2D30)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSORTING_OFFSET UNITYSDK_OFFSET(0x1E3E2D40)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVEINDEX_OFFSET UNITYSDK_OFFSET(0x1E3E2FF0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVESORT_OFFSET UNITYSDK_OFFSET(0x1E3E3000)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETITEMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1E3E30E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETLISTNAME_OFFSET UNITYSDK_OFFSET(0x1E3E3050)
#define SYSTEM_DATA_DATAVIEWMANAGER_TABLECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3E3460)
#define SYSTEM_DATA_DATAVIEWMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3E3900)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3E2650)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3E2640)

namespace System::Data
{
	inline static constexpr unsigned int DataViewManager_TypeDefinitionIndex = 39280;
	...
	public:
		...
		{
			return (::System::NotSupportedException**)Il2CppClass::FromTypeDefinitionIndex(DataViewManager_TypeDefinitionIndex)->GetStaticField(0x2ABF0);
		}
		::System::ComponentModel::ListChangedEventHandler* ListChanged; // 0x20
		::System::Data::DataSet* _dataSet; // 0x28
		::System::Data::DataViewSettingCollection* _dataViewSettingsCollection; // 0x30
		::System::Data::DataViewManagerListItemTypeDescriptor* _item; // 0x38
		::System::Boolean _locked; // 0x40
		::System::Int32 _nViews; // 0x44
