...
#define SYSTEM_DATA_LOOKUPNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1DEE5380)
#define SYSTEM_DATA_LOOKUPNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1DEE5890)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1DEE5640)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1DEE5800)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1DEE55F0)
#define SYSTEM_DATA_LOOKUPNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DEE5870)
#define SYSTEM_DATA_LOOKUPNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DEE5880)
#define SYSTEM_DATA_LOOKUPNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1DEE5850)
#define SYSTEM_DATA_LOOKUPNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1DEE5860)
#define SYSTEM_DATA_LOOKUPNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1DEE58A0)
#define SYSTEM_DATA_LOOKUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEE5370)

namespace System::Data
{
	inline static constexpr unsigned int LookupNode_TypeDefinitionIndex = 38648;

	class LookupNode : public ::System::Data::ExpressionNode
	{
	public:
		::System::Data::DataRelation* _relation; // 0x18
