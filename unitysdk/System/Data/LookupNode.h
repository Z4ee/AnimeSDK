...
#define SYSTEM_DATA_LOOKUPNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1F300E00)
#define SYSTEM_DATA_LOOKUPNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1F301300)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1F3010C0)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1F301270)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1F301070)
#define SYSTEM_DATA_LOOKUPNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1F3012E0)
#define SYSTEM_DATA_LOOKUPNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1F3012F0)
#define SYSTEM_DATA_LOOKUPNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1F3012C0)
#define SYSTEM_DATA_LOOKUPNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1F3012D0)
#define SYSTEM_DATA_LOOKUPNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1F301310)
#define SYSTEM_DATA_LOOKUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F300DF0)

namespace System::Data
{
	inline static constexpr unsigned int LookupNode_TypeDefinitionIndex = 39309;
	...
	public:
		...
		::System::String* _columnName; // 0x28
