...
#define SYSTEM_DATA_CONSTNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A94BA80)
#define SYSTEM_DATA_CONSTNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A94BAA0)
#define SYSTEM_DATA_CONSTNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A94BAB0)
#define SYSTEM_DATA_CONSTNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A94BA90)
#define SYSTEM_DATA_CONSTNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A94BAE0)
#define SYSTEM_DATA_CONSTNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A94BAF0)
#define SYSTEM_DATA_CONSTNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A94BAC0)
#define SYSTEM_DATA_CONSTNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A94BAD0)
#define SYSTEM_DATA_CONSTNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A94BB00)
#define SYSTEM_DATA_CONSTNODE_SMALLESTDECIMAL_OFFSET UNITYSDK_OFFSET(0x1A94B630)
#define SYSTEM_DATA_CONSTNODE_SMALLESTNUMERIC_OFFSET UNITYSDK_OFFSET(0x1A94B0C0)
#define SYSTEM_DATA_CONSTNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A94ADE0)
#define SYSTEM_DATA_CONSTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94ADC0)

namespace System::Data
{
	inline static constexpr unsigned int ConstNode_TypeDefinitionIndex = 37014;
