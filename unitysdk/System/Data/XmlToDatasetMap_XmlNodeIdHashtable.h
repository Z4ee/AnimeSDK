...
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1E3E6E20)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x1E3E6E90)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_3_OFFSET UNITYSDK_OFFSET(0x1E3E6F70)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E3E6DB0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3E6D40)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_XmlNodeIdHashtable_TypeDefinitionIndex = 39360;
