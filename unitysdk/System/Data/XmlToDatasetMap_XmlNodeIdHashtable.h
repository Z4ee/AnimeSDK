...
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1AC6DC30)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x1AC6DCA0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_3_OFFSET UNITYSDK_OFFSET(0x1AC6DD90)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AC6DBC0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6DB50)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_XmlNodeIdHashtable_TypeDefinitionIndex = 37082;
