...
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F0B7370)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F0B73B0)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F0B6DE0)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0B6DC0)

namespace System::Data
{
	inline static constexpr unsigned int MergeFailedEventHandler_TypeDefinitionIndex = 39317;
