...
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B900F50)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B900F90)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9009D0)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9009C0)

namespace System::Data
{
	inline static constexpr unsigned int MergeFailedEventHandler_TypeDefinitionIndex = 37039;
