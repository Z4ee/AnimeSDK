...
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DC66FB0)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC66FF0)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DC66A30)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC66A10)

namespace System::Data
{
	inline static constexpr unsigned int MergeFailedEventHandler_TypeDefinitionIndex = 38656;
