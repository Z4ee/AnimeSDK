...
#define SYSTEM_DATA_RANGE_CHECKNULL_OFFSET UNITYSDK_OFFSET(0x977FC0)
#define SYSTEM_DATA_RANGE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x977F50)
#define SYSTEM_DATA_RANGE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x622C00)
#define SYSTEM_DATA_RANGE_GET_MIN_OFFSET UNITYSDK_OFFSET(0x977F70)
#define SYSTEM_DATA_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x977EF0)

namespace System::Data
{
	inline static constexpr unsigned int Range_TypeDefinitionIndex = 39322;
