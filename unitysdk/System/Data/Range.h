...
#define SYSTEM_DATA_RANGE_CHECKNULL_OFFSET UNITYSDK_OFFSET(0x92AA20)
#define SYSTEM_DATA_RANGE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x92A9B0)
#define SYSTEM_DATA_RANGE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x5C9540)
#define SYSTEM_DATA_RANGE_GET_MIN_OFFSET UNITYSDK_OFFSET(0x92A9D0)
#define SYSTEM_DATA_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x92A950)

namespace System::Data
{
	inline static constexpr unsigned int Range_TypeDefinitionIndex = 38661;
