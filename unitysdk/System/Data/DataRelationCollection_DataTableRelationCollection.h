...
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADDCACHE_OFFSET UNITYSDK_OFFSET(0x1EAB13D0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADDCORE_OFFSET UNITYSDK_OFFSET(0x1EAB1420)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADD_RELATIONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1EAB12D0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ENSUREDATASET_OFFSET UNITYSDK_OFFSET(0x1EAB1070)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GETDATASET_OFFSET UNITYSDK_OFFSET(0x1EAB10D0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1EAB1210)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1EAB1130)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1EAB1060)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVECACHE_OFFSET UNITYSDK_OFFSET(0x1EAB1570)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVECORE_OFFSET UNITYSDK_OFFSET(0x1EAB1660)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVE_RELATIONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1EAB1350)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAB0F20)

namespace System::Data
{
	inline static constexpr unsigned int DataRelationCollection_DataTableRelationCollection_TypeDefinitionIndex = 39249;
