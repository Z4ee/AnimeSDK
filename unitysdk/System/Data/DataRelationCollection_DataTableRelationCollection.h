...
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADDCACHE_OFFSET UNITYSDK_OFFSET(0x1D6D4470)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADDCORE_OFFSET UNITYSDK_OFFSET(0x1D6D44C0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADD_RELATIONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1D6D4370)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ENSUREDATASET_OFFSET UNITYSDK_OFFSET(0x1D6D4110)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GETDATASET_OFFSET UNITYSDK_OFFSET(0x1D6D4170)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1D6D42B0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D6D41D0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1D6D4100)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVECACHE_OFFSET UNITYSDK_OFFSET(0x1D6D4610)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVECORE_OFFSET UNITYSDK_OFFSET(0x1D6D4700)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVE_RELATIONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1D6D43F0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6D3FC0)

namespace System::Data
{
	inline static constexpr unsigned int DataRelationCollection_DataTableRelationCollection_TypeDefinitionIndex = 38588;
