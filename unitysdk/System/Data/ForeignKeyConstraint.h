...
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CANBEREMOVEDFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1DEDC360)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CANENABLECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1DEDC770)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CASCADECOMMIT_OFFSET UNITYSDK_OFFSET(0x1DEDC9E0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CASCADEDELETE_OFFSET UNITYSDK_OFFSET(0x1DEDCB80)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CASCADEROLLBACK_OFFSET UNITYSDK_OFFSET(0x1DEDD280)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CASCADEUPDATE_OFFSET UNITYSDK_OFFSET(0x1DEDD4B0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CHECKCANADDTOCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1DEDC160)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CHECKCANCLEARPARENTTABLE_OFFSET UNITYSDK_OFFSET(0x1DEDDBE0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CHECKCANREMOVEPARENTROW_OFFSET UNITYSDK_OFFSET(0x1DEDDD40)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CHECKCASCADE_OFFSET UNITYSDK_OFFSET(0x1DEDDE50)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CHECKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1DEDDF60)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1DEDE800)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1DEDE970)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CLONE_2_OFFSET UNITYSDK_OFFSET(0x1DEDF6F0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CLONE_OFFSET UNITYSDK_OFFSET(0x1DEDE960)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0x1DEDE890)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_CREATE_OFFSET UNITYSDK_OFFSET(0x1DEDBDE0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEE00B0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_FINDPARENTRELATION_OFFSET UNITYSDK_OFFSET(0x1DEE0280)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEE0250)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_ACCEPTREJECTRULE_OFFSET UNITYSDK_OFFSET(0x1DEDE810)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_CHILDCOLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x1DEDC150)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_CHILDKEY_OFFSET UNITYSDK_OFFSET(0x1DEDC0B0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1DEDC0D0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_DELETERULE_OFFSET UNITYSDK_OFFSET(0x1DEE0030)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_PARENTCOLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x1DEDC140)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_PARENTKEY_OFFSET UNITYSDK_OFFSET(0x1DEDDE30)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_RELATEDCOLUMNSREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DEDF6D0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_RELATEDCOLUMNS_OFFSET UNITYSDK_OFFSET(0x1DEE0260)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_RELATEDTABLE_OFFSET UNITYSDK_OFFSET(0x1DEE03E0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1DEDC0F0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_GET_UPDATERULE_OFFSET UNITYSDK_OFFSET(0x1DEE0430)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_ISCONSTRAINTVIOLATED_OFFSET UNITYSDK_OFFSET(0x1DEDC4C0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_ISKEYNULL_OFFSET UNITYSDK_OFFSET(0x1DEDC370)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_NONVIRTUALCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1DEDE4C0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_SET_ACCEPTREJECTRULE_OFFSET UNITYSDK_OFFSET(0x1DEDE830)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_SET_DELETERULE_OFFSET UNITYSDK_OFFSET(0x1DEE0050)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT_SET_UPDATERULE_OFFSET UNITYSDK_OFFSET(0x1DEE0450)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEDBC40)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DEDBFA0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DEDBFD0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DEDC000)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DEDC050)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEDBC30)

namespace System::Data
{
	inline static constexpr unsigned int ForeignKeyConstraint_TypeDefinitionIndex = 38653;

	class ForeignKeyConstraint : public ::System::Data::Constraint
	{
	public:
		::System::String* _parentTableName; // 0x38
		::Il2CppArray<::System::String*>* _childColumnNames; // 0x40
		::System::Data::DataKey _childKey; // 0x48
		::System::String* _constraintName; // 0x50
		::Il2CppArray<::System::String*>* _parentColumnNames; // 0x58
		::System::String* _parentTableNamespace; // 0x60
		::System::Data::DataKey _parentKey; // 0x68
		::System::Data::AcceptRejectRule _acceptRejectRule; // 0x70
