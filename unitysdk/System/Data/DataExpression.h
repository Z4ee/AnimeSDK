...
#define SYSTEM_DATA_DATAEXPRESSION_BIND_OFFSET UNITYSDK_OFFSET(0x1EFBE540)
#define SYSTEM_DATA_DATAEXPRESSION_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1EFBB600)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1EFBE730)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_2_OFFSET UNITYSDK_OFFSET(0x1EFBEB00)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_3_OFFSET UNITYSDK_OFFSET(0x1EFBEB10)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1EFBE720)
#define SYSTEM_DATA_DATAEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1EFBE6C0)
#define SYSTEM_DATA_DATAEXPRESSION_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1EFBE710)
#define SYSTEM_DATA_DATAEXPRESSION_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EFBF2A0)
#define SYSTEM_DATA_DATAEXPRESSION_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EFBF2C0)
#define SYSTEM_DATA_DATAEXPRESSION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBEDB0)
#define SYSTEM_DATA_DATAEXPRESSION_ISTABLEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1EFBF1A0)
#define SYSTEM_DATA_DATAEXPRESSION_ISUNKNOWN_OFFSET UNITYSDK_OFFSET(0x1EFBF1C0)
#define SYSTEM_DATA_DATAEXPRESSION_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1EFBEEC0)
#define SYSTEM_DATA_DATAEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EFBE3D0)
#define SYSTEM_DATA_DATAEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBE3C0)

namespace System::Data
{
	inline static constexpr unsigned int DataExpression_TypeDefinitionIndex = 39293;

	class DataExpression : public ::System::Object
	{
	public:
		::System::Data::DataTable* _table; // 0x10
		::Il2CppArray<::System::Data::DataColumn*>* _dependency; // 0x18
