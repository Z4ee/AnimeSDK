...
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B31B0F0)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B31B130)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B31AB70)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31AB60)

namespace System::Data
{
	inline static constexpr unsigned int DataColumnChangeEventHandler_TypeDefinitionIndex = 36952;
