...
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EAB0D80)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EAB0DC0)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EAB07F0)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAB07D0)

namespace System::Data
{
	inline static constexpr unsigned int DataColumnChangeEventHandler_TypeDefinitionIndex = 39230;
