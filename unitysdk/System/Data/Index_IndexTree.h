...
#define SYSTEM_DATA_INDEX_INDEXTREE_COMPARENODE_OFFSET UNITYSDK_OFFSET(0x1B31BCB0)
#define SYSTEM_DATA_INDEX_INDEXTREE_COMPARESATELITETREENODE_OFFSET UNITYSDK_OFFSET(0x1B31BCD0)
#define SYSTEM_DATA_INDEX_INDEXTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31BC80)

namespace System::Data
{
	inline static constexpr unsigned int Index_IndexTree_TypeDefinitionIndex = 37062;
