...
#define SYSTEM_DATA_INDEX_INDEXTREE_COMPARENODE_OFFSET UNITYSDK_OFFSET(0x1D6D49E0)
#define SYSTEM_DATA_INDEX_INDEXTREE_COMPARESATELITETREENODE_OFFSET UNITYSDK_OFFSET(0x1D6D4A00)
#define SYSTEM_DATA_INDEX_INDEXTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6D49B0)

namespace System::Data
{
	inline static constexpr unsigned int Index_IndexTree_TypeDefinitionIndex = 38679;
