...
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D9FB270)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D9FB2B0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D9FACF0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9FACD0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableClearEventHandler_TypeDefinitionIndex = 38610;
