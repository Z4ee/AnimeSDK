...
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B62EBA0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B62EBE0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B62E620)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B62E610)

namespace System::Data
{
	inline static constexpr unsigned int DataTableClearEventHandler_TypeDefinitionIndex = 36993;
