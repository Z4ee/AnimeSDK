...
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B900640)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B900840)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B900890)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1B9008F0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B9004A0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1B900900)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1B900910)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B9005A0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B900940)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9003E0)

namespace System::Data
{
	inline static constexpr unsigned int DataViewSettingCollection_TypeDefinitionIndex = 37006;
