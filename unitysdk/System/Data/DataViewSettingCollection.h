...
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1DC66690)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DC66890)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DC668E0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1DC66940)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC664F0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1DC66950)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1DC66960)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC665F0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DC66990)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC66430)

namespace System::Data
{
	inline static constexpr unsigned int DataViewSettingCollection_TypeDefinitionIndex = 38623;
