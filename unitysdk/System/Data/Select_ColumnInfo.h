...
#define SYSTEM_DATA_SELECT_COLUMNINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD8B840)

namespace System::Data
{
	inline static constexpr unsigned int Select_ColumnInfo_TypeDefinitionIndex = 39337;
