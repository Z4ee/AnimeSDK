...
#define SYSTEM_DATA_DATAKEY_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0xA7B370)
#define SYSTEM_DATA_DATAKEY_COLUMNSEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1ED6A030)
#define SYSTEM_DATA_DATAKEY_COLUMNSEQUAL_OFFSET UNITYSDK_OFFSET(0xA7B380)
#define SYSTEM_DATA_DATAKEY_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0xA7B420)
#define SYSTEM_DATA_DATAKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA7B5A0)
#define SYSTEM_DATA_DATAKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0xA7B4F0)
#define SYSTEM_DATA_DATAKEY_GETCOLUMNNAMES_OFFSET UNITYSDK_OFFSET(0xA7B5B0)
#define SYSTEM_DATA_DATAKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA7B490)
#define SYSTEM_DATA_DATAKEY_GETINDEXDESC_OFFSET UNITYSDK_OFFSET(0xA7B5C0)
#define SYSTEM_DATA_DATAKEY_GETKEYVALUES_OFFSET UNITYSDK_OFFSET(0xA7B5D0)
#define SYSTEM_DATA_DATAKEY_GETSORTINDEX_1_OFFSET UNITYSDK_OFFSET(0xA7B5F0)
#define SYSTEM_DATA_DATAKEY_GETSORTINDEX_OFFSET UNITYSDK_OFFSET(0xA7B5E0)
#define SYSTEM_DATA_DATAKEY_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x32EF90)
#define SYSTEM_DATA_DATAKEY_GET_TABLE_OFFSET UNITYSDK_OFFSET(0xA7B320)
#define SYSTEM_DATA_DATAKEY_RECORDSEQUAL_OFFSET UNITYSDK_OFFSET(0xA7B600)
#define SYSTEM_DATA_DATAKEY_TOARRAY_OFFSET UNITYSDK_OFFSET(0xA7B6A0)
#define SYSTEM_DATA_DATAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0xA7B310)

namespace System::Data
{
	inline static constexpr unsigned int DataKey_TypeDefinitionIndex = 39246;
