...
#define SYSTEM_DATA_AGGREGATENODE_BIND_1_OFFSET UNITYSDK_OFFSET(0x1D8926D0)
#define SYSTEM_DATA_AGGREGATENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1D8923F0)
#define SYSTEM_DATA_AGGREGATENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1D892E60)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1D8928A0)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1D892CF0)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1D892890)
#define SYSTEM_DATA_AGGREGATENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1D892E40)
#define SYSTEM_DATA_AGGREGATENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1D892E50)
#define SYSTEM_DATA_AGGREGATENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1D892E20)
#define SYSTEM_DATA_AGGREGATENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1D892E30)
#define SYSTEM_DATA_AGGREGATENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1D892EB0)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D892330)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D892310)

namespace System::Data
{
	inline static constexpr unsigned int AggregateNode_TypeDefinitionIndex = 38627;
