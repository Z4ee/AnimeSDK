...
#define SYSTEM_DATA_AGGREGATENODE_BIND_1_OFFSET UNITYSDK_OFFSET(0x1B4F0F10)
#define SYSTEM_DATA_AGGREGATENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1B4F0C30)
#define SYSTEM_DATA_AGGREGATENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1B4F16A0)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1B4F10E0)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1B4F1530)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1B4F10D0)
#define SYSTEM_DATA_AGGREGATENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B4F1680)
#define SYSTEM_DATA_AGGREGATENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B4F1690)
#define SYSTEM_DATA_AGGREGATENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1B4F1660)
#define SYSTEM_DATA_AGGREGATENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1B4F1670)
#define SYSTEM_DATA_AGGREGATENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1B4F16F0)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4F0B70)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F0B50)

namespace System::Data
{
	inline static constexpr unsigned int AggregateNode_TypeDefinitionIndex = 37010;
	...
	public:
		...
		::System::Data::DataTable* _childTable; // 0x28
		::System::Data::DataRelation* _relation; // 0x30
		::System::String* _relationName; // 0x38
		::System::Data::Aggregate _aggregate; // 0x40
		::System::Boolean _local; // 0x44
		::System::Data::AggregateType _type; // 0x48
