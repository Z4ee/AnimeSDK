...
#define SYSTEM_DATA_DATATABLENEWROWEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD7A620)

namespace System::Data
{
	inline static constexpr unsigned int DataTableNewRowEventArgs_TypeDefinitionIndex = 38612;
