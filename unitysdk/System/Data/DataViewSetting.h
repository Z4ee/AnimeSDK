...
#define SYSTEM_DATA_DATAVIEWSETTING_SETDATATABLE_OFFSET UNITYSDK_OFFSET(0x1D8A09A0)
#define SYSTEM_DATA_DATAVIEWSETTING_SETDATAVIEWMANAGER_OFFSET UNITYSDK_OFFSET(0x1D8A0990)
#define SYSTEM_DATA_DATAVIEWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8A0970)

namespace System::Data
{
	inline static constexpr unsigned int DataViewSetting_TypeDefinitionIndex = 38622;

	class DataViewSetting : public ::System::Object
	{
	public:
		::System::Data::DataViewManager* _dataViewManager; // 0x10
		::System::String* _rowFilter; // 0x18
