...
#define SYSTEM_DATA_RECORDMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B3216B0)
#define SYSTEM_DATA_RECORDMANAGER_COPYRECORD_OFFSET UNITYSDK_OFFSET(0x1B321960)
#define SYSTEM_DATA_RECORDMANAGER_FREERECORD_OFFSET UNITYSDK_OFFSET(0x1B3214E0)
#define SYSTEM_DATA_RECORDMANAGER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B321910)
#define SYSTEM_DATA_RECORDMANAGER_GROWRECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B321190)
#define SYSTEM_DATA_RECORDMANAGER_IMPORTRECORD_OFFSET UNITYSDK_OFFSET(0x1B321950)
#define SYSTEM_DATA_RECORDMANAGER_NEWCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B321240)
#define SYSTEM_DATA_RECORDMANAGER_NEWRECORDBASE_OFFSET UNITYSDK_OFFSET(0x1B321460)
#define SYSTEM_DATA_RECORDMANAGER_NORMALIZEDMINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B321260)
#define SYSTEM_DATA_RECORDMANAGER_SETROWCACHE_OFFSET UNITYSDK_OFFSET(0x1B321D60)
#define SYSTEM_DATA_RECORDMANAGER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B321620)
#define SYSTEM_DATA_RECORDMANAGER_SET_MINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B321400)
#define SYSTEM_DATA_RECORDMANAGER_SET_RECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B3212A0)
#define SYSTEM_DATA_RECORDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B321110)

namespace System::Data
{
	inline static constexpr unsigned int RecordManager_TypeDefinitionIndex = 37053;

	class RecordManager : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* _freeRecordList; // 0x10
		::System::Data::DataTable* _table; // 0x18
		::Il2CppArray<::System::Data::DataRow*>* _rows; // 0x20
		::System::Int32 _lastFreeRecord; // 0x28
		::System::Int32 _recordCapacity; // 0x2C
