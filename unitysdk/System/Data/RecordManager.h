...
#define SYSTEM_DATA_RECORDMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D6DA390)
#define SYSTEM_DATA_RECORDMANAGER_COPYRECORD_OFFSET UNITYSDK_OFFSET(0x1D6DA640)
#define SYSTEM_DATA_RECORDMANAGER_FREERECORD_OFFSET UNITYSDK_OFFSET(0x1D6DA1C0)
#define SYSTEM_DATA_RECORDMANAGER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D6DA5F0)
#define SYSTEM_DATA_RECORDMANAGER_GROWRECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D6D9E70)
#define SYSTEM_DATA_RECORDMANAGER_IMPORTRECORD_OFFSET UNITYSDK_OFFSET(0x1D6DA630)
#define SYSTEM_DATA_RECORDMANAGER_NEWCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D6D9F20)
#define SYSTEM_DATA_RECORDMANAGER_NEWRECORDBASE_OFFSET UNITYSDK_OFFSET(0x1D6DA140)
#define SYSTEM_DATA_RECORDMANAGER_NORMALIZEDMINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D6D9F40)
#define SYSTEM_DATA_RECORDMANAGER_SETROWCACHE_OFFSET UNITYSDK_OFFSET(0x1D6DAA40)
#define SYSTEM_DATA_RECORDMANAGER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D6DA300)
#define SYSTEM_DATA_RECORDMANAGER_SET_MINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D6DA0E0)
#define SYSTEM_DATA_RECORDMANAGER_SET_RECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D6D9F80)
#define SYSTEM_DATA_RECORDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6D9DF0)

namespace System::Data
{
	inline static constexpr unsigned int RecordManager_TypeDefinitionIndex = 38670;
