...
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_BOUNDARYCHECK_OFFSET UNITYSDK_OFFSET(0x1B6268C0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B626650)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1B626740)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1B626770)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1B626A70)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_MOVEAFTER_OFFSET UNITYSDK_OFFSET(0x1B626D20)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SETCURRENTANDINCREMENT_OFFSET UNITYSDK_OFFSET(0x1B626DE0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SETCURRENT_OFFSET UNITYSDK_OFFSET(0x1B626DB0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6266A0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1B626780)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1B626AD0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B626F10)

namespace System::Data
{
	inline static constexpr unsigned int AutoIncrementBigInteger_TypeDefinitionIndex = 36950;

	class AutoIncrementBigInteger : public ::System::Data::AutoIncrementValue
	{
	public:
		::System::Numerics::BigInteger _step; // 0x18
		::System::Numerics::BigInteger _current; // 0x28
