...
#define SYSTEM_DATA_UNIQUECONSTRAINT_CANBEREMOVEDFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D724D30)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CANENABLECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1D725210)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKCANADDTOCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D724D20)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1D7255B0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1D724D00)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1D725800)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_2_OFFSET UNITYSDK_OFFSET(0x1D726190)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_OFFSET UNITYSDK_OFFSET(0x1D7257F0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONSTRAINTINDEXCLEAR_OFFSET UNITYSDK_OFFSET(0x1D724C90)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONSTRAINTINDEXINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D724CC0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0x1D725780)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CREATE_OFFSET UNITYSDK_OFFSET(0x1D724820)
#define SYSTEM_DATA_UNIQUECONSTRAINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D7250D0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D726980)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x1D724C80)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNSREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D725770)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1D726920)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_ISPRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x1D726930)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1D7251C0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_ISCONSTRAINTVIOLATED_OFFSET UNITYSDK_OFFSET(0x1D7252B0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_NONVIRTUALCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1D724D10)
#define SYSTEM_DATA_UNIQUECONSTRAINT_SET_INCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D726990)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D724900)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D7249E0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D724A00)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1D724A20)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1D724A50)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1D724B40)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1D724C30)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1D724C50)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D724730)

namespace System::Data
{
	inline static constexpr unsigned int UniqueConstraint_TypeDefinitionIndex = 38686;
