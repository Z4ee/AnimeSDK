...
#define SYSTEM_DATA_NAMENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1B806FF0)
#define SYSTEM_DATA_NAMENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1B807400)
#define SYSTEM_DATA_NAMENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1B8071F0)
#define SYSTEM_DATA_NAMENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1B807340)
#define SYSTEM_DATA_NAMENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1B8071A0)
#define SYSTEM_DATA_NAMENODE_GET_ISSQLCOLUMN_OFFSET UNITYSDK_OFFSET(0x1B806FD0)
#define SYSTEM_DATA_NAMENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B8073A0)
#define SYSTEM_DATA_NAMENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B8073D0)
#define SYSTEM_DATA_NAMENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1B807390)
#define SYSTEM_DATA_NAMENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1B807310)
#define SYSTEM_DATA_NAMENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1B807450)
#define SYSTEM_DATA_NAMENODE_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1B806D20)
#define SYSTEM_DATA_NAMENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B806FC0)
#define SYSTEM_DATA_NAMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B806CF0)

namespace System::Data
{
	inline static constexpr unsigned int NameNode_TypeDefinitionIndex = 37032;
