...
#define SYSTEM_DATA_NAMENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1DBE94F0)
#define SYSTEM_DATA_NAMENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1DBE9900)
#define SYSTEM_DATA_NAMENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1DBE96F0)
#define SYSTEM_DATA_NAMENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1DBE9840)
#define SYSTEM_DATA_NAMENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1DBE96A0)
#define SYSTEM_DATA_NAMENODE_GET_ISSQLCOLUMN_OFFSET UNITYSDK_OFFSET(0x1DBE94D0)
#define SYSTEM_DATA_NAMENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DBE98A0)
#define SYSTEM_DATA_NAMENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DBE98D0)
#define SYSTEM_DATA_NAMENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1DBE9890)
#define SYSTEM_DATA_NAMENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1DBE9810)
#define SYSTEM_DATA_NAMENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1DBE9950)
#define SYSTEM_DATA_NAMENODE_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1DBE9220)
#define SYSTEM_DATA_NAMENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DBE94C0)
#define SYSTEM_DATA_NAMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBE91F0)

namespace System::Data
{
	inline static constexpr unsigned int NameNode_TypeDefinitionIndex = 38649;
