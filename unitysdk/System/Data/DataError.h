...
#define SYSTEM_DATA_DATAERROR_CLEAR_1_OFFSET UNITYSDK_OFFSET(0x1EFBE1F0)
#define SYSTEM_DATA_DATAERROR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1EFBDF50)
#define SYSTEM_DATA_DATAERROR_GETCOLUMNERROR_OFFSET UNITYSDK_OFFSET(0x1EFBE190)
#define SYSTEM_DATA_DATAERROR_GETCOLUMNSINERROR_OFFSET UNITYSDK_OFFSET(0x1EFBE280)
#define SYSTEM_DATA_DATAERROR_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x1EFBDE50)
#define SYSTEM_DATA_DATAERROR_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1EFBE050)
#define SYSTEM_DATA_DATAERROR_SETCOLUMNERROR_OFFSET UNITYSDK_OFFSET(0x1EFBDE80)
#define SYSTEM_DATA_DATAERROR_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1EFBDE10)
#define SYSTEM_DATA_DATAERROR_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1EFBDE30)
#define SYSTEM_DATA_DATAERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EFBDDF0)
#define SYSTEM_DATA_DATAERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBDDE0)

namespace System::Data
{
	inline static constexpr unsigned int DataError_TypeDefinitionIndex = 39233;
