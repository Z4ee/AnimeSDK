...
#define SYSTEM_DATA_DATAVIEWLISTENER_CHILDRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F742080)
#define SYSTEM_DATA_DATAVIEWLISTENER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1F742130)
#define SYSTEM_DATA_DATAVIEWLISTENER_COLUMNCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F742200)
#define SYSTEM_DATA_DATAVIEWLISTENER_INDEXLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1F742380)
#define SYSTEM_DATA_DATAVIEWLISTENER_MAINTAINDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1F7422C0)
#define SYSTEM_DATA_DATAVIEWLISTENER_PARENTRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F742150)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERLISTCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1F743030)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0x1F7428B0)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERMETADATAEVENTS_OFFSET UNITYSDK_OFFSET(0x1F742430)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERLISTCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1F743150)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERMETADATAEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1F742AE0)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERMETADATAEVENTS_OFFSET UNITYSDK_OFFSET(0x1F742AD0)
#define SYSTEM_DATA_DATAVIEWLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F742010)

namespace System::Data
{
	inline static constexpr unsigned int DataViewListener_TypeDefinitionIndex = 39279;
