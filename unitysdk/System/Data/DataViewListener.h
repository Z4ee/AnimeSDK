...
#define SYSTEM_DATA_DATAVIEWLISTENER_CHILDRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3025F0)
#define SYSTEM_DATA_DATAVIEWLISTENER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1E3026A0)
#define SYSTEM_DATA_DATAVIEWLISTENER_COLUMNCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E302770)
#define SYSTEM_DATA_DATAVIEWLISTENER_INDEXLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1E302900)
#define SYSTEM_DATA_DATAVIEWLISTENER_MAINTAINDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1E302840)
#define SYSTEM_DATA_DATAVIEWLISTENER_PARENTRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E3026C0)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERLISTCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E3035D0)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0x1E302E30)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERMETADATAEVENTS_OFFSET UNITYSDK_OFFSET(0x1E3029B0)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERLISTCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1E3036F0)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERMETADATAEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1E303060)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERMETADATAEVENTS_OFFSET UNITYSDK_OFFSET(0x1E303050)
#define SYSTEM_DATA_DATAVIEWLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E302580)

namespace System::Data
{
	inline static constexpr unsigned int DataViewListener_TypeDefinitionIndex = 38618;
