...
#define SYSTEM_DATA_XMLDATATREEWRITER_CREATETABLESHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B9B7080)
#define SYSTEM_DATA_XMLDATATREEWRITER_CREATETOPLEVELTABLES_OFFSET UNITYSDK_OFFSET(0x1B9B7470)
#define SYSTEM_DATA_XMLDATATREEWRITER_GETNESTEDCHILDRELATIONS_OFFSET UNITYSDK_OFFSET(0x1B9BA6C0)
#define SYSTEM_DATA_XMLDATATREEWRITER_PRESERVESPACE_OFFSET UNITYSDK_OFFSET(0x1B9BAAD0)
#define SYSTEM_DATA_XMLDATATREEWRITER_ROWHASERRORS_OFFSET UNITYSDK_OFFSET(0x1B9B7AA0)
#define SYSTEM_DATA_XMLDATATREEWRITER_SAVEDIFFGRAMDATA_OFFSET UNITYSDK_OFFSET(0x1B9B7C70)
#define SYSTEM_DATA_XMLDATATREEWRITER_SAVE_OFFSET UNITYSDK_OFFSET(0x1B9A1CF0)
#define SYSTEM_DATA_XMLDATATREEWRITER_XMLDATAROWWRITER_OFFSET UNITYSDK_OFFSET(0x1B9B8820)
#define SYSTEM_DATA_XMLDATATREEWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B9B6E50)
#define SYSTEM_DATA_XMLDATATREEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A1950)

namespace System::Data
{
	inline static constexpr unsigned int XmlDataTreeWriter_TypeDefinitionIndex = 38705;

	class XmlDataTreeWriter : public ::System::Object
	{
	public:
		::System::Xml::XmlWriter* _xmlw; // 0x10
		::System::Collections::ArrayList* _dTables; // 0x18
		::Il2CppArray<::System::Data::DataTable*>* _topLevelTables; // 0x20
		::System::Collections::Hashtable* _rowsOrder; // 0x28
		::System::Data::DataTable* _dt; // 0x30
