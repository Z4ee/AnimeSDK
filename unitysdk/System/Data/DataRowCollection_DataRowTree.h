...
#define SYSTEM_DATA_DATAROWCOLLECTION_DATAROWTREE_COMPARENODE_OFFSET UNITYSDK_OFFSET(0x1B4FEB80)
#define SYSTEM_DATA_DATAROWCOLLECTION_DATAROWTREE_COMPARESATELITETREENODE_OFFSET UNITYSDK_OFFSET(0x1B4FEBC0)
#define SYSTEM_DATA_DATAROWCOLLECTION_DATAROWTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FEB10)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCollection_DataRowTree_TypeDefinitionIndex = 36980;
