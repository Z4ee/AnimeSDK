...
#define SYSTEM_DATA_DATAROWCHANGEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED6A8B0)

namespace System::Data
{
	inline static constexpr unsigned int DataRowChangeEventArgs_TypeDefinitionIndex = 39255;
