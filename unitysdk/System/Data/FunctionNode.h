...
#define SYSTEM_DATA_FUNCTIONNODE_ADDARGUMENT_OFFSET UNITYSDK_OFFSET(0x1BB773F0)
#define SYSTEM_DATA_FUNCTIONNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1BB77640)
#define SYSTEM_DATA_FUNCTIONNODE_CHECK_OFFSET UNITYSDK_OFFSET(0x1BB77A20)
#define SYSTEM_DATA_FUNCTIONNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1BB7ADD0)
#define SYSTEM_DATA_FUNCTIONNODE_EVALFUNCTION_OFFSET UNITYSDK_OFFSET(0x1BB78D00)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1BB77D10)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1BB7AB70)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1BB77D00)
#define SYSTEM_DATA_FUNCTIONNODE_GETDATATYPE_OFFSET UNITYSDK_OFFSET(0x1BB78AE0)
#define SYSTEM_DATA_FUNCTIONNODE_GET_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1BB7B190)
#define SYSTEM_DATA_FUNCTIONNODE_GET_ISAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1BB7B240)
#define SYSTEM_DATA_FUNCTIONNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1BB7ACD0)
#define SYSTEM_DATA_FUNCTIONNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1BB7AD50)
#define SYSTEM_DATA_FUNCTIONNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1BB7ABC0)
#define SYSTEM_DATA_FUNCTIONNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1BB7AC50)
#define SYSTEM_DATA_FUNCTIONNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1BB7AE50)
#define SYSTEM_DATA_FUNCTIONNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB7B5E0)
#define SYSTEM_DATA_FUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB772A0)

namespace System::Data
{
	inline static constexpr unsigned int FunctionNode_TypeDefinitionIndex = 37027;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::Function*>**)Il2CppClass::FromTypeDefinitionIndex(FunctionNode_TypeDefinitionIndex)->GetStaticField(0x275F0);
		}
		::Il2CppArray<::System::Data::ExpressionNode*>* _arguments; // 0x18
		::System::String* _name; // 0x20
		::System::Int32 _info; // 0x28
