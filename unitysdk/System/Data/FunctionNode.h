...
#define SYSTEM_DATA_FUNCTIONNODE_ADDARGUMENT_OFFSET UNITYSDK_OFFSET(0x1DEE0600)
#define SYSTEM_DATA_FUNCTIONNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1DEE0850)
#define SYSTEM_DATA_FUNCTIONNODE_CHECK_OFFSET UNITYSDK_OFFSET(0x1DEE0C30)
#define SYSTEM_DATA_FUNCTIONNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1DEE3FE0)
#define SYSTEM_DATA_FUNCTIONNODE_EVALFUNCTION_OFFSET UNITYSDK_OFFSET(0x1DEE1F10)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1DEE0F20)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1DEE3D80)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1DEE0F10)
#define SYSTEM_DATA_FUNCTIONNODE_GETDATATYPE_OFFSET UNITYSDK_OFFSET(0x1DEE1CF0)
#define SYSTEM_DATA_FUNCTIONNODE_GET_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DEE43A0)
#define SYSTEM_DATA_FUNCTIONNODE_GET_ISAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DEE4450)
#define SYSTEM_DATA_FUNCTIONNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DEE3EE0)
#define SYSTEM_DATA_FUNCTIONNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1DEE3F60)
#define SYSTEM_DATA_FUNCTIONNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1DEE3DD0)
#define SYSTEM_DATA_FUNCTIONNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1DEE3E60)
#define SYSTEM_DATA_FUNCTIONNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1DEE4060)
#define SYSTEM_DATA_FUNCTIONNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEE47F0)
#define SYSTEM_DATA_FUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEE04B0)

namespace System::Data
{
	inline static constexpr unsigned int FunctionNode_TypeDefinitionIndex = 38644;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::Function*>**)Il2CppClass::FromTypeDefinitionIndex(FunctionNode_TypeDefinitionIndex)->GetStaticField(0x29290);
		}
