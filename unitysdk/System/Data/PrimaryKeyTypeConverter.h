...
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1D6D9C70)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1D6D9CE0)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1D6D9C60)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6D9BF0)

namespace System::Data
{
	inline static constexpr unsigned int PrimaryKeyTypeConverter_TypeDefinitionIndex = 38659;
