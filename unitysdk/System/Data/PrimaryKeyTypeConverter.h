...
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1B320F90)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1B321000)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1B320F80)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B320F10)

namespace System::Data
{
	inline static constexpr unsigned int PrimaryKeyTypeConverter_TypeDefinitionIndex = 37042;
