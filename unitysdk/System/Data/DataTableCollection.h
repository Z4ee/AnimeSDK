...
#define SYSTEM_DATA_DATATABLECOLLECTION_ADD_COLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1DC64590)
#define SYSTEM_DATA_DATATABLECOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1DC63EA0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ARRAYADD_OFFSET UNITYSDK_OFFSET(0x1DC644B0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ASSIGNNAME_OFFSET UNITYSDK_OFFSET(0x1DC64770)
#define SYSTEM_DATA_DATATABLECOLLECTION_BASEADD_OFFSET UNITYSDK_OFFSET(0x1DC64230)
#define SYSTEM_DATA_DATATABLECOLLECTION_BASEGROUPSWITCH_OFFSET UNITYSDK_OFFSET(0x1DC64C00)
#define SYSTEM_DATA_DATATABLECOLLECTION_BASEREMOVE_OFFSET UNITYSDK_OFFSET(0x1DC64E60)
#define SYSTEM_DATA_DATATABLECOLLECTION_CANREMOVE_OFFSET UNITYSDK_OFFSET(0x1DC64F20)
#define SYSTEM_DATA_DATATABLECOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DC65730)
#define SYSTEM_DATA_DATATABLECOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1DC65A30)
#define SYSTEM_DATA_DATATABLECOLLECTION_CONTAINS_2_OFFSET UNITYSDK_OFFSET(0x1DC65DF0)
#define SYSTEM_DATA_DATATABLECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1DC648A0)
#define SYSTEM_DATA_DATATABLECOLLECTION_FINISHINITCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1DC66110)
#define SYSTEM_DATA_DATATABLECOLLECTION_GETTABLESMART_OFFSET UNITYSDK_OFFSET(0x1DC63C90)
#define SYSTEM_DATA_DATATABLECOLLECTION_GETTABLE_OFFSET UNITYSDK_OFFSET(0x1DC63A80)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1DC63370)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x1DC63670)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC63260)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1DC63250)
#define SYSTEM_DATA_DATATABLECOLLECTION_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1DC66000)
#define SYSTEM_DATA_DATATABLECOLLECTION_INDEXOF_2_OFFSET UNITYSDK_OFFSET(0x1DC66020)
#define SYSTEM_DATA_DATATABLECOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1DC65F10)
#define SYSTEM_DATA_DATATABLECOLLECTION_INTERNALINDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1DC63760)
#define SYSTEM_DATA_DATATABLECOLLECTION_INTERNALINDEXOF_OFFSET UNITYSDK_OFFSET(0x1DC63450)
#define SYSTEM_DATA_DATATABLECOLLECTION_MAKENAME_OFFSET UNITYSDK_OFFSET(0x1DC64830)
#define SYSTEM_DATA_DATATABLECOLLECTION_ONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1DC644E0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ONCOLLECTIONCHANGING_OFFSET UNITYSDK_OFFSET(0x1DC64180)
#define SYSTEM_DATA_DATATABLECOLLECTION_REGISTERNAME_OFFSET UNITYSDK_OFFSET(0x1DC648C0)
#define SYSTEM_DATA_DATATABLECOLLECTION_REMOVE_COLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1DC64680)
#define SYSTEM_DATA_DATATABLECOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1DC66190)
#define SYSTEM_DATA_DATATABLECOLLECTION_REPLACEFROMINFERENCE_OFFSET UNITYSDK_OFFSET(0x1DC660C0)
#define SYSTEM_DATA_DATATABLECOLLECTION_UNREGISTERNAME_OFFSET UNITYSDK_OFFSET(0x1DC65560)
#define SYSTEM_DATA_DATATABLECOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DC663F0)
#define SYSTEM_DATA_DATATABLECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC630D0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableCollection_TypeDefinitionIndex = 38611;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataTableCollection_TypeDefinitionIndex)->GetStaticField(0x9230);
		}
		...
		::System::Int32 _defaultNameIndex; // 0x38
		::System::Int32 _objectID; // 0x3C
