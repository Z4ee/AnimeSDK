...
#define SYSTEM_EMPTY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19EC3520)
#define SYSTEM_EMPTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19EC3510)
#define SYSTEM_EMPTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EC35A0)
#define SYSTEM_EMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC3500)
