...
#define SYSTEM_EMPTY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x162E1030)
#define SYSTEM_EMPTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x162E1020)
#define SYSTEM_EMPTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x162E10B0)
#define SYSTEM_EMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x162E1010)
