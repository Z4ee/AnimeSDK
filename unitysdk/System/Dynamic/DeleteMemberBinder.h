...
#define SYSTEM_DYNAMIC_DELETEMEMBERBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1F519E00)
#define SYSTEM_DYNAMIC_DELETEMEMBERBINDER_FALLBACKDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1F519DE0)

namespace System::Dynamic
{
	inline static constexpr unsigned int DeleteMemberBinder_TypeDefinitionIndex = 4976;
