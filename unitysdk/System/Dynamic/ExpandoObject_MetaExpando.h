...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_ADDDYNAMICTESTANDDEFER_OFFSET UNITYSDK_OFFSET(0x1C003220)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0040D0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C003520)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETORINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C002610)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0035E0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C003740)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETCLASSENSUREINDEX_OFFSET UNITYSDK_OFFSET(0x1C003F00)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x1C003100)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1C004600)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C0030A0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C002570)

namespace System::Dynamic
{
	inline static constexpr unsigned int ExpandoObject_MetaExpando_TypeDefinitionIndex = 4999;
