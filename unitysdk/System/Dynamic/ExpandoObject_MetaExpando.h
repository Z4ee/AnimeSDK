...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_ADDDYNAMICTESTANDDEFER_OFFSET UNITYSDK_OFFSET(0x1F755F60)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1F756E00)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1F756260)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETORINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1F755340)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1F756320)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1F756480)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETCLASSENSUREINDEX_OFFSET UNITYSDK_OFFSET(0x1F756C30)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x1F755E40)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1F757320)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1F755DE0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7552A0)
