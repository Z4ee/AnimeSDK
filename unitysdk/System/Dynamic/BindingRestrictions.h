...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_GETINSTANCERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1BFE68D0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_GETTYPERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x1BFE65D0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_GETTYPERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1BFE6490)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_MERGE_OFFSET UNITYSDK_OFFSET(0x1BFE62F0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TOEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1BFE69D0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFE69E0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE62E0)

namespace System::Dynamic
{
	inline static constexpr unsigned int BindingRestrictions_TypeDefinitionIndex = 4967;
