...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO___C__DISPLAYCLASS3_0__BINDINVOKEMEMBER_B__0_OFFSET UNITYSDK_OFFSET(0x1C1C3B80)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C3B70)

namespace System::Dynamic
{
	inline static constexpr unsigned int ExpandoObject_MetaExpando___c__DisplayClass3_0_TypeDefinitionIndex = 5000;
