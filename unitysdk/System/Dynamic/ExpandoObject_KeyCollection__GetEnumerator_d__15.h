...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_KEYCOLLECTION__GETENUMERATOR_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1FAE8770)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_KEYCOLLECTION__GETENUMERATOR_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FAE8970)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_KEYCOLLECTION__GETENUMERATOR_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FAE89D0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_KEYCOLLECTION__GETENUMERATOR_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1FAE8980)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_KEYCOLLECTION__GETENUMERATOR_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FAE8760)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_KEYCOLLECTION__GETENUMERATOR_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAE8750)

namespace System::Dynamic
{
	inline static constexpr unsigned int ExpandoObject_KeyCollection__GetEnumerator_d__15_TypeDefinitionIndex = 4995;
