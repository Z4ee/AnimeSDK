...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B6C9550)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1B6C95E0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B6C95B0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C94F0)

namespace System::Dynamic
{
	inline static constexpr unsigned int BindingRestrictions_CustomRestriction_TypeDefinitionIndex = 4971;
