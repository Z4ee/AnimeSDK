...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EEEC780)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1EEEC810)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EEEC7E0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEEC720)
