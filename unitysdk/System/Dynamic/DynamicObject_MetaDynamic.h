...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1DC16EC0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x1DC166C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1DC16B20)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1DC17700)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1DC164A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x1DC17370)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1DC15F10)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1DC16910)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC16CF0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x1DC17540)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1DC162E0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1DC17120)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETCONVERTEDARGS_OFFSET UNITYSDK_OFFSET(0x1DC178A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x1DC18590)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1DC18530)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DC184C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_ISOVERRIDDEN_OFFSET UNITYSDK_OFFSET(0x1DC160C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_REFERENCEARGASSIGN_OFFSET UNITYSDK_OFFSET(0x1DC17BF0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC186E0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC15E70)

namespace System::Dynamic
{
	inline static constexpr unsigned int DynamicObject_MetaDynamic_TypeDefinitionIndex = 4980;
