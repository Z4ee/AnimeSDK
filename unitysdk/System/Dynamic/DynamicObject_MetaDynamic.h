...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1C762B40)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x1C762340)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C7627A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1C763380)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C762120)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x1C762FF0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C761BA0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C762590)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C762970)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x1C7631C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C761F60)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1C762DA0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETCONVERTEDARGS_OFFSET UNITYSDK_OFFSET(0x1C763520)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x1C764220)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1C7641C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C764150)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_ISOVERRIDDEN_OFFSET UNITYSDK_OFFSET(0x1C761D50)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_REFERENCEARGASSIGN_OFFSET UNITYSDK_OFFSET(0x1C763870)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C764370)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C761B00)
