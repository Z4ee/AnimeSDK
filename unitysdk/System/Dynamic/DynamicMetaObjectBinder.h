...
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1C760E70)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_CREATEARGUMENTMETAOBJECTS_OFFSET UNITYSDK_OFFSET(0x1C7615B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GETUPDATEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1C7619B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GET_ISSTANDARDBINDER_OFFSET UNITYSDK_OFFSET(0x1C761AF0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1C760E40)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C760DF0)
