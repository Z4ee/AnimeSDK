...
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1DC15200)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_CREATEARGUMENTMETAOBJECTS_OFFSET UNITYSDK_OFFSET(0x1DC15930)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GETUPDATEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DC15D20)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GET_ISSTANDARDBINDER_OFFSET UNITYSDK_OFFSET(0x1DC15E60)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1DC151D0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC15180)

namespace System::Dynamic
{
	inline static constexpr unsigned int DynamicMetaObjectBinder_TypeDefinitionIndex = 4978;
