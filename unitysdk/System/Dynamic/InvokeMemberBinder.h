...
#define SYSTEM_DYNAMIC_INVOKEMEMBERBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1E588D10)
#define SYSTEM_DYNAMIC_INVOKEMEMBERBINDER_FALLBACKINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1E588DE0)
