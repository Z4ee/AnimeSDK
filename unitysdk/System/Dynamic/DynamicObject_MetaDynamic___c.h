...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__BINDCONVERT_B__5_0_OFFSET UNITYSDK_OFFSET(0x1BFE6BC0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__BINDDELETEMEMBER_B__4_0_OFFSET UNITYSDK_OFFSET(0x1BFE6B90)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__BINDGETMEMBER_B__2_0_OFFSET UNITYSDK_OFFSET(0x1BFE6B70)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__BINDUNARYOPERATION_B__10_0_OFFSET UNITYSDK_OFFSET(0x1BFE6BF0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFE6B20)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE6B60)

namespace System::Dynamic
{
	inline static constexpr unsigned int DynamicObject_MetaDynamic___c_TypeDefinitionIndex = 4984;
