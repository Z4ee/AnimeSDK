...
#define SYSTEM_DYNAMIC_GETMEMBERBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1C004870)
#define SYSTEM_DYNAMIC_GETMEMBERBINDER_FALLBACKGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0035C0)
#define SYSTEM_DYNAMIC_GETMEMBERBINDER_GET_ISSTANDARDBINDER_OFFSET UNITYSDK_OFFSET(0x1C0049A0)
#define SYSTEM_DYNAMIC_GETMEMBERBINDER_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1C004840)
#define SYSTEM_DYNAMIC_GETMEMBERBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C004750)
