...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_GETMETAOBJECT_OFFSET UNITYSDK_OFFSET(0x1C06ED90)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1C06ED40)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCONVERT_OFFSET UNITYSDK_OFFSET(0x1C06ED10)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C06ED20)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1C06ED80)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C06ECF0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETINDEX_OFFSET UNITYSDK_OFFSET(0x1C06ED60)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C06ECD0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C06ED00)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKE_OFFSET UNITYSDK_OFFSET(0x1C06ED30)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETINDEX_OFFSET UNITYSDK_OFFSET(0x1C06ED70)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1C06ECE0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1C06ED50)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06ECC0)

namespace System::Dynamic
{
	inline static constexpr unsigned int DynamicObject_TypeDefinitionIndex = 4980;
