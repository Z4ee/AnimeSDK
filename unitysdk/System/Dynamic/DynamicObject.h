...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_GETMETAOBJECT_OFFSET UNITYSDK_OFFSET(0x1F7BFA20)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1F7BF9D0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCONVERT_OFFSET UNITYSDK_OFFSET(0x1F7BF9A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1F7BF9B0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1F7BFA10)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1F7BF980)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETINDEX_OFFSET UNITYSDK_OFFSET(0x1F7BF9F0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1F7BF960)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1F7BF990)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKE_OFFSET UNITYSDK_OFFSET(0x1F7BF9C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETINDEX_OFFSET UNITYSDK_OFFSET(0x1F7BFA00)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1F7BF970)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1F7BF9E0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7BF950)
