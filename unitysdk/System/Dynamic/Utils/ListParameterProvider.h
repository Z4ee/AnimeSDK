...
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GETELEMENT_OFFSET UNITYSDK_OFFSET(0x1B8D8CC0)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GET_ELEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8D8BE0)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GET_FIRST_OFFSET UNITYSDK_OFFSET(0x1B8D8BD0)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D8BB0)

namespace System::Dynamic::Utils
{
	inline static constexpr unsigned int ListParameterProvider_TypeDefinitionIndex = 5021;
