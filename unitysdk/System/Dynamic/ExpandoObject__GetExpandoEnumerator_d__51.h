...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT__GETEXPANDOENUMERATOR_D__51_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19A2A190)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT__GETEXPANDOENUMERATOR_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_OBJECT___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19A2A3B0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT__GETEXPANDOENUMERATOR_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19A2A410)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT__GETEXPANDOENUMERATOR_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19A2A3C0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT__GETEXPANDOENUMERATOR_D__51_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19A2A180)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT__GETEXPANDOENUMERATOR_D__51__CTOR_OFFSET UNITYSDK_OFFSET(0x19A29F20)

namespace System::Dynamic
{
	inline static constexpr unsigned int ExpandoObject__GetExpandoEnumerator_d__51_TypeDefinitionIndex = 3681;
	...
	public:
		...
		::System::Dynamic::ExpandoObject_ExpandoData* data; // 0x20
