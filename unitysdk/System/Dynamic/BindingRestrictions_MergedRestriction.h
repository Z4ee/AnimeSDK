...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_MERGEDRESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1F4EEFF0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_MERGEDRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4EEF80)
