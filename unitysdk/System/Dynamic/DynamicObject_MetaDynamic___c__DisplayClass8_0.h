...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__DISPLAYCLASS8_0__BINDINVOKE_B__0_OFFSET UNITYSDK_OFFSET(0x1FAE8710)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAE8700)
