...
#define SYSTEM_DYNAMIC_GETINDEXBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1F757380)
#define SYSTEM_DYNAMIC_GETINDEXBINDER_FALLBACKGETINDEX_OFFSET UNITYSDK_OFFSET(0x1F757450)
