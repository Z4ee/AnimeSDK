...
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1BE2F3A0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x1BE2EBB0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BE2F230)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1BE2EFF0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1BE2EDC0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x1BE2EE70)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1BE2EC60)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1BE2F0B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE2F170)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x1BE2EF30)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1BE2ED00)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1BE2F2F0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_CREATE_OFFSET UNITYSDK_OFFSET(0x1BE2F670)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GETEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1BE2F460)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1BE2EA60)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_LIMITTYPE_OFFSET UNITYSDK_OFFSET(0x1BE2EB00)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_RESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1BE2EA70)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_RUNTIMETYPE_OFFSET UNITYSDK_OFFSET(0x1BE2EA80)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BE2F8E0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE2E970)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2E890)

namespace System::Dynamic
{
	inline static constexpr unsigned int DynamicMetaObject_TypeDefinitionIndex = 4978;
	...
	public:
		...
		::System::Dynamic::BindingRestrictions* _Restrictions_k__BackingField; // 0x18
