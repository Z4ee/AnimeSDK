...
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_1_OFFSET UNITYSDK_OFFSET(0x1A7D0D70)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_2_OFFSET UNITYSDK_OFFSET(0x1A7D0E30)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_3_OFFSET UNITYSDK_OFFSET(0x1A7D0F50)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_4_OFFSET UNITYSDK_OFFSET(0x1A7D10E0)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_5_OFFSET UNITYSDK_OFFSET(0x1A7D1170)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_6_OFFSET UNITYSDK_OFFSET(0x1A7D1250)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x1A7D0D00)
#define SYSTEM_VALUETUPLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x304470)
#define SYSTEM_VALUETUPLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x48CD40)
#define SYSTEM_VALUETUPLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8FEA80)
#define SYSTEM_VALUETUPLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x304470)
#define SYSTEM_VALUETUPLE_SYSTEM_COLLECTIONS_ISTRUCTURALCOMPARABLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x8FEB30)
#define SYSTEM_VALUETUPLE_SYSTEM_COLLECTIONS_ISTRUCTURALEQUATABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8FEAD0)
#define SYSTEM_VALUETUPLE_SYSTEM_COLLECTIONS_ISTRUCTURALEQUATABLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x304470)
#define SYSTEM_VALUETUPLE_SYSTEM_ICOMPARABLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x8FEB20)
#define SYSTEM_VALUETUPLE_SYSTEM_IVALUETUPLEINTERNAL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x304470)
#define SYSTEM_VALUETUPLE_SYSTEM_IVALUETUPLEINTERNAL_TOSTRINGEND_OFFSET UNITYSDK_OFFSET(0x8FEB80)
#define SYSTEM_VALUETUPLE_SYSTEM_RUNTIME_COMPILERSERVICES_ITUPLE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x304470)
#define SYSTEM_VALUETUPLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8FEB40)
