...
#define SYSTEM_TEXT_UTF32ENCODING_EQUALS_OFFSET UNITYSDK_OFFSET(0x178500B0)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTECOUNT_1_OFFSET UNITYSDK_OFFSET(0x1784DF50)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTECOUNT_2_OFFSET UNITYSDK_OFFSET(0x1784DFD0)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTECOUNT_3_OFFSET UNITYSDK_OFFSET(0x1784DBC0)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1784DA60)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1784E6D0)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x1784E900)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x1784E290)
#define SYSTEM_TEXT_UTF32ENCODING_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1784E090)
#define SYSTEM_TEXT_UTF32ENCODING_GETCHARCOUNT_1_OFFSET UNITYSDK_OFFSET(0x1784EFD0)
#define SYSTEM_TEXT_UTF32ENCODING_GETCHARCOUNT_2_OFFSET UNITYSDK_OFFSET(0x1784EB70)
#define SYSTEM_TEXT_UTF32ENCODING_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1784EA10)
#define SYSTEM_TEXT_UTF32ENCODING_GETCHARS_1_OFFSET UNITYSDK_OFFSET(0x1784F9A0)
#define SYSTEM_TEXT_UTF32ENCODING_GETCHARS_2_OFFSET UNITYSDK_OFFSET(0x1784F2C0)
#define SYSTEM_TEXT_UTF32ENCODING_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1784F090)
#define SYSTEM_TEXT_UTF32ENCODING_GETDECODER_OFFSET UNITYSDK_OFFSET(0x1784FD00)
#define SYSTEM_TEXT_UTF32ENCODING_GETENCODER_OFFSET UNITYSDK_OFFSET(0x1784FDA0)
#define SYSTEM_TEXT_UTF32ENCODING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17850170)
#define SYSTEM_TEXT_UTF32ENCODING_GETHIGHSURROGATE_OFFSET UNITYSDK_OFFSET(0x1784FCE0)
#define SYSTEM_TEXT_UTF32ENCODING_GETLOWSURROGATE_OFFSET UNITYSDK_OFFSET(0x1784FCF0)
#define SYSTEM_TEXT_UTF32ENCODING_GETMAXBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1784FE10)
#define SYSTEM_TEXT_UTF32ENCODING_GETMAXCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1784FF10)
#define SYSTEM_TEXT_UTF32ENCODING_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x1784FFD0)
#define SYSTEM_TEXT_UTF32ENCODING_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1784FAB0)
#define SYSTEM_TEXT_UTF32ENCODING_GETSURROGATE_OFFSET UNITYSDK_OFFSET(0x1784FCC0)
#define SYSTEM_TEXT_UTF32ENCODING_SETDEFAULTFALLBACKS_OFFSET UNITYSDK_OFFSET(0x1784D9F0)
#define SYSTEM_TEXT_UTF32ENCODING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1783D450)
#define SYSTEM_TEXT_UTF32ENCODING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1784D980)
#define SYSTEM_TEXT_UTF32ENCODING__CTOR_OFFSET UNITYSDK_OFFSET(0x1784D940)
