...
#define SYSTEM_TEXT_STRINGBUILDERCACHE_ACQUIRE_OFFSET UNITYSDK_OFFSET(0x1B922920)
#define SYSTEM_TEXT_STRINGBUILDERCACHE_GETSTRINGANDRELEASE_OFFSET UNITYSDK_OFFSET(0x1B922A90)
#define SYSTEM_TEXT_STRINGBUILDERCACHE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B944CC0)
