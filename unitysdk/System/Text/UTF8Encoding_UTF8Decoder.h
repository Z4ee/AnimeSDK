...
#define SYSTEM_TEXT_UTF8ENCODING_UTF8DECODER_GET_HASSTATE_OFFSET UNITYSDK_OFFSET(0x1C509820)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8DECODER_RESET_OFFSET UNITYSDK_OFFSET(0x1C509800)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8DECODER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C509470)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8DECODER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C509160)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8DECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C509130)

namespace System::Text
{
	inline static constexpr unsigned int UTF8Encoding_UTF8Decoder_TypeDefinitionIndex = 495;
