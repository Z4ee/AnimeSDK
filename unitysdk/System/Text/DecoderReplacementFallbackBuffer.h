...
#define SYSTEM_TEXT_DECODERREPLACEMENTFALLBACKBUFFER_FALLBACK_OFFSET UNITYSDK_OFFSET(0x17838790)
#define SYSTEM_TEXT_DECODERREPLACEMENTFALLBACKBUFFER_GETNEXTCHAR_OFFSET UNITYSDK_OFFSET(0x178387E0)
#define SYSTEM_TEXT_DECODERREPLACEMENTFALLBACKBUFFER_GET_REMAINING_OFFSET UNITYSDK_OFFSET(0x17838850)
#define SYSTEM_TEXT_DECODERREPLACEMENTFALLBACKBUFFER_INTERNALFALLBACK_OFFSET UNITYSDK_OFFSET(0x17838880)
#define SYSTEM_TEXT_DECODERREPLACEMENTFALLBACKBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x17838860)
#define SYSTEM_TEXT_DECODERREPLACEMENTFALLBACKBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x17838760)
