...
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER_GET_HASSTATE_OFFSET UNITYSDK_OFFSET(0x178570D0)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER_RESET_OFFSET UNITYSDK_OFFSET(0x178570B0)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x17856E60)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17856BB0)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x17856230)
