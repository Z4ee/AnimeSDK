...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1C0362F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_MATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C036310)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1C0362E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C0362D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C0362B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_PATTERN_OFFSET UNITYSDK_OFFSET(0x1C0362A0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_INITMATCHTIMEOUTDEFAULTFOROLDVERSIONDESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1C035E10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1C036300)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_MATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C036240)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1C0361D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C0360E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C0362C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_PATTERN_OFFSET UNITYSDK_OFFSET(0x1C036070)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C035F00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C035E70)
...
namespace System::Text::RegularExpressions
{
	...
	public:
		...
		::System::String* nspace; // 0x18
		::System::String* pattern; // 0x20
		::System::Boolean isPublic; // 0x28
		::System::Text::RegularExpressions::RegexOptions options; // 0x2C
