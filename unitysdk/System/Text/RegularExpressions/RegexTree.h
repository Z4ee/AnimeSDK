...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x18759D70)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int RegexTree_TypeDefinitionIndex = 2517;
	...
	public:
		...
		::System::Text::RegularExpressions::RegexNode* _root; // 0x30
