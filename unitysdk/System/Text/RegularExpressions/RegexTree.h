...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF6530)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int RegexTree_TypeDefinitionIndex = 2518;
