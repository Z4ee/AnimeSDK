...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC_ADDFC_OFFSET UNITYSDK_OFFSET(0x1B421DF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC_GETFIRSTCHARS_OFFSET UNITYSDK_OFFSET(0x1B421E80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC_ISCASEINSENSITIVE_OFFSET UNITYSDK_OFFSET(0x1B421EC0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B421D10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B421DC0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B421CD0)
