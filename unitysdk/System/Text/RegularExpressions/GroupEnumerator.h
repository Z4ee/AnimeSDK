...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUPENUMERATOR_GET_CAPTURE_OFFSET UNITYSDK_OFFSET(0x1873F5E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUPENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1873F5D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUPENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1873F580)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUPENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1873F680)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUPENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1873F530)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int GroupEnumerator_TypeDefinitionIndex = 2504;
