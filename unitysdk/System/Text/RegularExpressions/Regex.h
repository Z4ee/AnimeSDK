...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_CACHECODE_OFFSET UNITYSDK_OFFSET(0x1A336590)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_COMPILETOASSEMBLY_1_OFFSET UNITYSDK_OFFSET(0x1A33AD30)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_COMPILETOASSEMBLY_2_OFFSET UNITYSDK_OFFSET(0x1A33AD70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_COMPILETOASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1A33ACF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ESCAPE_OFFSET UNITYSDK_OFFSET(0x1A336F80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GETGROUPNAMES_OFFSET UNITYSDK_OFFSET(0x1A3387E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GETGROUPNUMBERS_OFFSET UNITYSDK_OFFSET(0x1A3388E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_CACHESIZE_OFFSET UNITYSDK_OFFSET(0x1A337080)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_CAPNAMES_OFFSET UNITYSDK_OFFSET(0x1A337D90)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_CAPS_OFFSET UNITYSDK_OFFSET(0x1A3372E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_MATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A3387A0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1A338790)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_RIGHTTOLEFT_OFFSET UNITYSDK_OFFSET(0x1A3387B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GROUPNAMEFROMNUMBER_OFFSET UNITYSDK_OFFSET(0x1A338D20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GROUPNUMBERFROMNAME_OFFSET UNITYSDK_OFFSET(0x1A338E70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_INITDEFAULTMATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A336D30)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_INITIALIZEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A3364B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_1_OFFSET UNITYSDK_OFFSET(0x1A3391C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_2_OFFSET UNITYSDK_OFFSET(0x1A339140)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_3_OFFSET UNITYSDK_OFFSET(0x1A339290)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_4_OFFSET UNITYSDK_OFFSET(0x1A339350)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1A339070)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_LOOKUPCACHEDANDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A336210)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_1_OFFSET UNITYSDK_OFFSET(0x1A339C60)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_2_OFFSET UNITYSDK_OFFSET(0x1A339BE0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_3_OFFSET UNITYSDK_OFFSET(0x1A339D30)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_4_OFFSET UNITYSDK_OFFSET(0x1A339E00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_OFFSET UNITYSDK_OFFSET(0x1A339B10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_1_OFFSET UNITYSDK_OFFSET(0x1A339840)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_2_OFFSET UNITYSDK_OFFSET(0x1A3397C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_3_OFFSET UNITYSDK_OFFSET(0x1A339910)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_4_OFFSET UNITYSDK_OFFSET(0x1A3399D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_5_OFFSET UNITYSDK_OFFSET(0x1A339A70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_OFFSET UNITYSDK_OFFSET(0x1A3396F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_10_OFFSET UNITYSDK_OFFSET(0x1A33A770)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_11_OFFSET UNITYSDK_OFFSET(0x1A33A6F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_1_OFFSET UNITYSDK_OFFSET(0x1A33A010)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_2_OFFSET UNITYSDK_OFFSET(0x1A339F20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_3_OFFSET UNITYSDK_OFFSET(0x1A33A090)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_4_OFFSET UNITYSDK_OFFSET(0x1A33A360)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_5_OFFSET UNITYSDK_OFFSET(0x1A33A120)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_6_OFFSET UNITYSDK_OFFSET(0x1A33A3F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_7_OFFSET UNITYSDK_OFFSET(0x1A33A560)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_8_OFFSET UNITYSDK_OFFSET(0x1A33A4D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_9_OFFSET UNITYSDK_OFFSET(0x1A33A640)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_OFFSET UNITYSDK_OFFSET(0x1A339EA0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_RUN_OFFSET UNITYSDK_OFFSET(0x1A3393F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SET_CACHESIZE_OFFSET UNITYSDK_OFFSET(0x1A3370E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SET_CAPNAMES_OFFSET UNITYSDK_OFFSET(0x1A338240)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SET_CAPS_OFFSET UNITYSDK_OFFSET(0x1A3377F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_1_OFFSET UNITYSDK_OFFSET(0x1A33A970)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_2_OFFSET UNITYSDK_OFFSET(0x1A33A8F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_3_OFFSET UNITYSDK_OFFSET(0x1A33AA40)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_4_OFFSET UNITYSDK_OFFSET(0x1A33AB60)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_5_OFFSET UNITYSDK_OFFSET(0x1A33AAE0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_OFFSET UNITYSDK_OFFSET(0x1A33A820)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A336B90)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3387D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x1A337000)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_USEOPTIONC_OFFSET UNITYSDK_OFFSET(0x1A33AC00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_USEOPTIONINVARIANT_OFFSET UNITYSDK_OFFSET(0x1A33ABF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_USEOPTIONR_OFFSET UNITYSDK_OFFSET(0x1A3387C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_VALIDATEMATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A336150)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A33AC10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A335C90)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3360B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A336130)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A335D00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A336A10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A335C30)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int Regex_TypeDefinitionIndex = 2718;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Regex_TypeDefinitionIndex)->GetStaticField(0xFB8);
		}
		...
		{
			return (::System::TimeSpan*)Il2CppClass::FromTypeDefinitionIndex(Regex_TypeDefinitionIndex)->GetStaticField(0xFD0);
		}
		// static const ::System::String* DefaultMatchTimeout_ConfigKeyName; // 0x0
		// static const ::System::Int32 MaxOptionShift = 0xA; // 0x0
		::System::Text::RegularExpressions::ExclusiveReference* runnerref; // 0x10
		::System::Text::RegularExpressions::RegexRunnerFactory* factory; // 0x18
		::System::String* pattern; // 0x20
		::System::Text::RegularExpressions::RegexCode* code; // 0x28
		::Il2CppArray<::System::String*>* capslist; // 0x30
		::System::Text::RegularExpressions::SharedReference* replref; // 0x38
		::System::Collections::Hashtable* capnames; // 0x40
		...
		::System::Boolean refsInitialized; // 0x60
