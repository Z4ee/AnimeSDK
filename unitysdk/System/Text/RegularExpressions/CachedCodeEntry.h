...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY_ADDCOMPILED_OFFSET UNITYSDK_OFFSET(0x1A117E70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A117E30)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int CachedCodeEntry_TypeDefinitionIndex = 2720;
	...
	public:
		...
		::System::Text::RegularExpressions::RegexRunnerFactory* _factory; // 0x30
