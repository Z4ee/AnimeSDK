...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1873E480)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int CachedCodeEntry_TypeDefinitionIndex = 2487;
	...
	public:
		...
		::System::Text::RegularExpressions::RegexRunnerFactory* _factory; // 0x20
		...
		::System::Text::RegularExpressions::ExclusiveReference* _runnerref; // 0x48
