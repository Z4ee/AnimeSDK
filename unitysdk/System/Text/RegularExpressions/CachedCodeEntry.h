...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY_ADDCOMPILED_OFFSET UNITYSDK_OFFSET(0x1D8A2F80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8A2F40)
