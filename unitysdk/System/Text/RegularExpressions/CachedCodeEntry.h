...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY_ADDCOMPILED_OFFSET UNITYSDK_OFFSET(0x1C4AB4D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AB4A0)

namespace System::Text::RegularExpressions
{
	inline static constexpr unsigned int CachedCodeEntry_TypeDefinitionIndex = 2719;

	class CachedCodeEntry : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* _capslist; // 0x10
		::System::Text::RegularExpressions::RegexRunnerFactory* _factory; // 0x18
		::System::Text::RegularExpressions::RegexCode* _code; // 0x20
		...
		::System::Void AddCompiled(::System::Text::RegularExpressions::RegexRunnerFactory* factory)
		{
			return ((::System::Void(*)(::PVOID, ::System::Text::RegularExpressions::RegexRunnerFactory*))((::PBYTE)hIl2Cpp + SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY_ADDCOMPILED_OFFSET))(this, factory);
		}
	};
}
