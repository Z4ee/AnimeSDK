...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCODE_MAKEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1D2586D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCODE_OPCODEBACKTRACKS_OFFSET UNITYSDK_OFFSET(0x1D2585F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCODE_OPCODESIZE_OFFSET UNITYSDK_OFFSET(0x1D258610)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D258500)
