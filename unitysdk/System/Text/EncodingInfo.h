...
#define SYSTEM_TEXT_ENCODINGINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BC15D00)
#define SYSTEM_TEXT_ENCODINGINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BC15D60)
#define SYSTEM_TEXT_ENCODINGINFO_GET_CODEPAGE_OFFSET UNITYSDK_OFFSET(0x1BC15CF0)
#define SYSTEM_TEXT_ENCODINGINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BC15D70)
#define SYSTEM_TEXT_ENCODINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC15CE0)
