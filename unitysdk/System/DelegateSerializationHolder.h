...
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_GETDELEGATEDATA_OFFSET UNITYSDK_OFFSET(0x18D193F0)
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18D1AA90)
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_GETREALOBJECT_OFFSET UNITYSDK_OFFSET(0x18D1AAE0)
#define SYSTEM_DELEGATESERIALIZATIONHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D19DF0)
