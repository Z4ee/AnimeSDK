...
#define SYSTEM_ACCESSVIOLATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC8D200)
#define SYSTEM_ACCESSVIOLATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8D140)
