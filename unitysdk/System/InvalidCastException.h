...
#define SYSTEM_INVALIDCASTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1634E690)
#define SYSTEM_INVALIDCASTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1634FD20)
#define SYSTEM_INVALIDCASTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1634FD90)
#define SYSTEM_INVALIDCASTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1634FC80)
