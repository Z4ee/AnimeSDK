...
#define SYSTEM_VERSION_VERSIONRESULT_GETVERSIONPARSEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x9577F0)
#define SYSTEM_VERSION_VERSIONRESULT_INIT_OFFSET UNITYSDK_OFFSET(0x957700)
#define SYSTEM_VERSION_VERSIONRESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x957780)
#define SYSTEM_VERSION_VERSIONRESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x957710)
