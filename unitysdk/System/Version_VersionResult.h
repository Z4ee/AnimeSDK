...
#define SYSTEM_VERSION_VERSIONRESULT_GETVERSIONPARSEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x20D0C60)
#define SYSTEM_VERSION_VERSIONRESULT_INIT_OFFSET UNITYSDK_OFFSET(0x20D0B70)
#define SYSTEM_VERSION_VERSIONRESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x20D0BF0)
#define SYSTEM_VERSION_VERSIONRESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x20D0B80)
