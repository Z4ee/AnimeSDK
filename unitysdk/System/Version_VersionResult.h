...
#define SYSTEM_VERSION_VERSIONRESULT_GETVERSIONPARSEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x9A4460)
#define SYSTEM_VERSION_VERSIONRESULT_INIT_OFFSET UNITYSDK_OFFSET(0x9A4370)
#define SYSTEM_VERSION_VERSIONRESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x9A43F0)
#define SYSTEM_VERSION_VERSIONRESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x9A4380)
