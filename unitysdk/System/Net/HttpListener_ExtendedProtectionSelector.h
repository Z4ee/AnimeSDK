...
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C079B70)
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C079BA0)
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C079630)
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C079610)
