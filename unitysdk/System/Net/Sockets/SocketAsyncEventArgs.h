...
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ADD_COMPLETED_OFFSET UNITYSDK_OFFSET(0x1AFE8D40)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1AFE9090)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AFE8F30)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFE8F20)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AFE8F10)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHCONNECTBYNAMESYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x1AFE9240)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHOPERATIONASYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x1AFE9290)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHWRAPPERCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x1AFE92E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1AFE8A90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x1AFE8AD0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1AFE8AB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x1AFE8B60)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x1AFE8A70)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTSOCKET_OFFSET UNITYSDK_OFFSET(0x1AFE8D00)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AFE8B80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x1AFE8BA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1AFE8BC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1AFE8BE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1AFE8D20)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x1AFE8C20)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1AFE8C00)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x1AFE8C40)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x1AFE8C60)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE8C80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AFE9320)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x1AFE8CA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x1AFE8CC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1AFE8CE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AFE90B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_REMOVE_COMPLETED_OFFSET UNITYSDK_OFFSET(0x1AFE8DC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1AFE9120)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1AFE9110)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETLASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1AFE8FD0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETRESULTS_OFFSET UNITYSDK_OFFSET(0x1AFE9310)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1AFE8AA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x1AFE8AE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1AFE8AC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x1AFE8B70)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x1AFE8A80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AFE8B90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x1AFE8BB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1AFE8BD0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1AFE8BF0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1AFE8D30)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x1AFE8C30)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1AFE8C10)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x1AFE8C50)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x1AFE8C70)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE8C90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AFE9360)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x1AFE8CB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x1AFE8CD0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1AFE8CF0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONCOMMON_OFFSET UNITYSDK_OFFSET(0x1AFE9220)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONWRAPPERCONNECT_OFFSET UNITYSDK_OFFSET(0x1AFE9230)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFE8EB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE8E40)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int SocketAsyncEventArgs_TypeDefinitionIndex = 3684;

	class SocketAsyncEventArgs : public ::System::EventArgs
	{
	public:
		::System::Exception* _ConnectByNameError_k__BackingField; // 0x10
		::Il2CppArray<::System::Net::Sockets::SendPacketsElement*>* _SendPacketsElements_k__BackingField; // 0x18
		::System::EventHandler_1<::System::Net::Sockets::SocketAsyncEventArgs*>* Completed; // 0x20
		::System::Net::Sockets::SocketAsyncResult* socket_async_result; // 0x28
		::System::Net::EndPoint* remote_ep; // 0x30
		::System::Net::Sockets::IPPacketInformation _ReceiveMessageFromPacketInfo_k__BackingField; // 0x38
		::System::Net::Sockets::Socket* _AcceptSocket_k__BackingField; // 0x48
		::Il2CppArray<::System::Byte>* _Buffer_k__BackingField; // 0x50
		::System::Object* _UserToken_k__BackingField; // 0x58
		::System::Collections::Generic::IList_1<::System::ArraySegment_1<::System::Byte>>* m_BufferList; // 0x60
		::System::Net::Sockets::Socket* current_socket; // 0x68
		::System::Net::Sockets::SocketFlags _SocketFlags_k__BackingField; // 0x70
		::System::Int32 _BytesTransferred_k__BackingField; // 0x74
		::System::Int32 _Offset_k__BackingField; // 0x78
		::System::Net::Sockets::TransmitFileOptions _SendPacketsFlags_k__BackingField; // 0x7C
		::System::Int32 in_progress; // 0x80
		::System::Net::Sockets::SocketError _SocketError_k__BackingField; // 0x84
		::System::Int32 _SendPacketsSendSize_k__BackingField; // 0x88
		::System::Boolean _PolicyRestricted_k__BackingField; // 0x8C
		::System::Boolean disposed; // 0x8D
		::System::Boolean _DisconnectReuseSocket_k__BackingField; // 0x8E
		::System::Int32 _Count_k__BackingField; // 0x90
		::System::Net::Sockets::SocketAsyncOperation _LastOperation_k__BackingField; // 0x94
