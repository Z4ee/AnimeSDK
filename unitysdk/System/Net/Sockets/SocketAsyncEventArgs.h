...
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ADD_COMPLETED_OFFSET UNITYSDK_OFFSET(0x1E7EA160)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1E7EA4A0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E7EA350)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E7EA340)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E7EA330)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHCONNECTBYNAMESYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x1E7EA660)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHOPERATIONASYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x1E7EA6B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHWRAPPERCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x1E7EA700)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1E7E9EB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x1E7E9EF0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1E7E9ED0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x1E7E9F80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x1E7E9E90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTSOCKET_OFFSET UNITYSDK_OFFSET(0x1E7EA120)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E7E9FA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x1E7E9FC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1E7E9FE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1E7EA000)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1E7EA140)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x1E7EA040)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1E7EA020)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x1E7EA060)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x1E7EA080)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x1E7EA0A0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1E7EA750)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x1E7EA0C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x1E7EA0E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1E7EA100)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1E7EA4C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_REMOVE_COMPLETED_OFFSET UNITYSDK_OFFSET(0x1E7EA1E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1E7EA530)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1E7EA520)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETLASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1E7EA3F0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETRESULTS_OFFSET UNITYSDK_OFFSET(0x1E7EA730)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1E7E9EC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x1E7E9F00)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1E7E9EE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x1E7E9F90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x1E7E9EA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E7E9FB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x1E7E9FD0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1E7E9FF0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1E7EA010)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1E7EA150)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x1E7EA050)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1E7EA030)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x1E7EA070)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x1E7EA090)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x1E7EA0B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1E7EA790)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x1E7EA0D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x1E7EA0F0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1E7EA110)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONCOMMON_OFFSET UNITYSDK_OFFSET(0x1E7EA640)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONWRAPPERCONNECT_OFFSET UNITYSDK_OFFSET(0x1E7EA650)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7EA2D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7EA260)
...
namespace System::Net::Sockets
{
	...
	public:
		...
		::System::Object* _UserToken_k__BackingField; // 0x18
		...
		::System::EventHandler_1<::System::Net::Sockets::SocketAsyncEventArgs*>* Completed; // 0x50
		::System::Collections::Generic::IList_1<::System::ArraySegment_1<::System::Byte>>* m_BufferList; // 0x58
		::Il2CppArray<::System::Net::Sockets::SendPacketsElement*>* _SendPacketsElements_k__BackingField; // 0x60
		::System::Exception* _ConnectByNameError_k__BackingField; // 0x68
		::System::Net::Sockets::TransmitFileOptions _SendPacketsFlags_k__BackingField; // 0x70
		::System::Net::Sockets::SocketFlags _SocketFlags_k__BackingField; // 0x74
		::System::Net::Sockets::SocketAsyncOperation _LastOperation_k__BackingField; // 0x78
		::System::Int32 _SendPacketsSendSize_k__BackingField; // 0x7C
		::System::Boolean _DisconnectReuseSocket_k__BackingField; // 0x80
		::System::Boolean disposed; // 0x81
		::System::Boolean _PolicyRestricted_k__BackingField; // 0x82
		::System::Int32 in_progress; // 0x84
		::System::Int32 _BytesTransferred_k__BackingField; // 0x88
		::System::Int32 _Count_k__BackingField; // 0x8C
		::System::Net::Sockets::SocketError _SocketError_k__BackingField; // 0x90
		::System::Int32 _Offset_k__BackingField; // 0x94
