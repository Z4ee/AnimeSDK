...
#define SYSTEM_NET_SOCKETS_UDPCLIENT_ALLOWNATTRAVERSAL_OFFSET UNITYSDK_OFFSET(0x1CED3AD0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINRECEIVE_OFFSET UNITYSDK_OFFSET(0x1CED5400)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINSEND_1_OFFSET UNITYSDK_OFFSET(0x1CED4E20)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINSEND_2_OFFSET UNITYSDK_OFFSET(0x1CED50D0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x1CED4AE0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CHECKFORBROADCAST_OFFSET UNITYSDK_OFFSET(0x1CED41D0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CLOSE_OFFSET UNITYSDK_OFFSET(0x1CED3C10)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CONNECT_1_OFFSET UNITYSDK_OFFSET(0x1CED4030)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CONNECT_2_OFFSET UNITYSDK_OFFSET(0x1CED3E70)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CONNECT_OFFSET UNITYSDK_OFFSET(0x1CED2D30)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CREATECLIENTSOCKET_OFFSET UNITYSDK_OFFSET(0x1CED28F0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1CED3CF0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CED3CD0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DROPMULTICASTGROUP_1_OFFSET UNITYSDK_OFFSET(0x1CED6030)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DROPMULTICASTGROUP_OFFSET UNITYSDK_OFFSET(0x1CED5D70)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_ENDRECEIVE_OFFSET UNITYSDK_OFFSET(0x1CED5520)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_ENDSEND_OFFSET UNITYSDK_OFFSET(0x1CED5100)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_FREERESOURCES_OFFSET UNITYSDK_OFFSET(0x1CED3C30)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1CED3750)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1CED3770)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_CLIENT_OFFSET UNITYSDK_OFFSET(0x1CED3730)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1CED37D0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_ENABLEBROADCAST_OFFSET UNITYSDK_OFFSET(0x1CED38C0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x1CED3980)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_MULTICASTLOOPBACK_OFFSET UNITYSDK_OFFSET(0x1CED3880)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_TTL_OFFSET UNITYSDK_OFFSET(0x1CED3790)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_1_OFFSET UNITYSDK_OFFSET(0x1CED5990)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_2_OFFSET UNITYSDK_OFFSET(0x1CED5A90)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_3_OFFSET UNITYSDK_OFFSET(0x1CED5C10)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_OFFSET UNITYSDK_OFFSET(0x1CED56D0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1CED6550)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_RECEIVE_OFFSET UNITYSDK_OFFSET(0x1CED5230)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CED62E0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SENDASYNC_2_OFFSET UNITYSDK_OFFSET(0x1CED6420)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1CED61B0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SEND_1_OFFSET UNITYSDK_OFFSET(0x1CED4570)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SEND_2_OFFSET UNITYSDK_OFFSET(0x1CED4940)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SEND_OFFSET UNITYSDK_OFFSET(0x1CED42B0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1CED3760)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_CLIENT_OFFSET UNITYSDK_OFFSET(0x1CED3740)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1CED37F0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_ENABLEBROADCAST_OFFSET UNITYSDK_OFFSET(0x1CED38E0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x1CED3A40)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_MULTICASTLOOPBACK_OFFSET UNITYSDK_OFFSET(0x1CED38A0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_TTL_OFFSET UNITYSDK_OFFSET(0x1CED37B0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CED27D0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CED2950)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CED2960)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1CED2B40)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1CED2C40)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED2730)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__RECEIVEASYNC_B__64_0_OFFSET UNITYSDK_OFFSET(0x1CED6630)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__RECEIVEASYNC_B__64_1_OFFSET UNITYSDK_OFFSET(0x1CED6640)
