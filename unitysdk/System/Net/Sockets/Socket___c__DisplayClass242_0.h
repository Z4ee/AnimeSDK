...
#define SYSTEM_NET_SOCKETS_SOCKET___C__DISPLAYCLASS242_0__BEGINSENDCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x19EF1820)
#define SYSTEM_NET_SOCKETS_SOCKET___C__DISPLAYCLASS242_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEE0D0)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int Socket___c__DisplayClass242_0_TypeDefinitionIndex = 2898;
