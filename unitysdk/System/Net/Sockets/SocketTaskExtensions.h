...
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D626E90)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_OFFSET UNITYSDK_OFFSET(0x1D626C60)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D627330)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_2_OFFSET UNITYSDK_OFFSET(0x1D6275A0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_3_OFFSET UNITYSDK_OFFSET(0x1D627810)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x1D6270D0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D627CD0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1D627A80)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x1D627F10)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEMESSAGEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x1D628260)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D628850)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1D628600)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDTOASYNC_OFFSET UNITYSDK_OFFSET(0x1D628A90)
