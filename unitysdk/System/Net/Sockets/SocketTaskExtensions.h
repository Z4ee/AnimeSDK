...
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_1_OFFSET UNITYSDK_OFFSET(0x19E39600)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_OFFSET UNITYSDK_OFFSET(0x19E393D0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x19E39AA0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_2_OFFSET UNITYSDK_OFFSET(0x19E39D10)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_3_OFFSET UNITYSDK_OFFSET(0x19E39F80)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x19E39840)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_1_OFFSET UNITYSDK_OFFSET(0x19E3A450)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x19E3A1F0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x19E3A690)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEMESSAGEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x19E3A9F0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x19E3AFF0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x19E3AD90)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDTOASYNC_OFFSET UNITYSDK_OFFSET(0x19E3B230)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int SocketTaskExtensions_TypeDefinitionIndex = 3690;
