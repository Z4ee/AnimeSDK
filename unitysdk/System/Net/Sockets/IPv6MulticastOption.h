...
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x1B1D3090)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_GET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1B1D30A0)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x1B1D2EE0)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_SET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1B1D2F50)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1D2FD0)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D2DF0)
