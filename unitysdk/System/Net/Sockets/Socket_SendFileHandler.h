...
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AAA0ED0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AAA0F70)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AAA0830)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA0820)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int Socket_SendFileHandler_TypeDefinitionIndex = 3654;
