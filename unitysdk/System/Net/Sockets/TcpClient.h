...
#define SYSTEM_NET_SOCKETS_TCPCLIENT_BEGINCONNECT_1_OFFSET UNITYSDK_OFFSET(0x18FC6390)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_BEGINCONNECT_2_OFFSET UNITYSDK_OFFSET(0x18FC63B0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_BEGINCONNECT_OFFSET UNITYSDK_OFFSET(0x18FC6370)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CLOSE_OFFSET UNITYSDK_OFFSET(0x18FC6990)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x18FC6560)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECTASYNC_2_OFFSET UNITYSDK_OFFSET(0x18FC66C0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x18FC6400)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_1_OFFSET UNITYSDK_OFFSET(0x18FC61A0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_2_OFFSET UNITYSDK_OFFSET(0x18FC60C0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_3_OFFSET UNITYSDK_OFFSET(0x18FC6340)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_OFFSET UNITYSDK_OFFSET(0x18FC5440)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18FC69B0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FC69D0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_ENDCONNECT_OFFSET UNITYSDK_OFFSET(0x18FC63D0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18FC6C00)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x18FC6820)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18FC5F10)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x18FC5F30)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_CLIENT_OFFSET UNITYSDK_OFFSET(0x18FC5EF0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_CONNECTED_OFFSET UNITYSDK_OFFSET(0x18FC5F50)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x18FC5F70)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_LINGERSTATE_OFFSET UNITYSDK_OFFSET(0x18FC6E40)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_NODELAY_OFFSET UNITYSDK_OFFSET(0x18FC6F00)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18FC6C70)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_RECEIVETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FC6DC0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18FC6D80)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_SENDTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FC6E00)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18FC5090)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_NUMERICOPTION_OFFSET UNITYSDK_OFFSET(0x18FC6C80)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18FC5F20)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_CLIENT_OFFSET UNITYSDK_OFFSET(0x18FC5F00)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x18FC6030)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_LINGERSTATE_OFFSET UNITYSDK_OFFSET(0x18FC6ED0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_NODELAY_OFFSET UNITYSDK_OFFSET(0x18FC6F20)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18FC6D50)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_RECEIVETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FC6DD0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18FC6D90)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_SENDTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FC6E10)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FC50F0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FC5190)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FC52B0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18FC5EE0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC4F80)
