...
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1DB924B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1DB90ED0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1DB91890)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1DB90D70)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_CONVERTTONOTSOCKETOWNER_OFFSET UNITYSDK_OFFSET(0x1DB8FCF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB90DE0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1DB92910)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1DB915B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1DB91FB0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DB90EA0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x1DB92BA0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1DB92B90)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1DB8FDE0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1DB8FDF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DB8FE10)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1DB8FE00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CONNECTED_OFFSET UNITYSDK_OFFSET(0x1DB90EB0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_DATAAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1DB901F0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_INTERNALSOCKET_OFFSET UNITYSDK_OFFSET(0x1DB8FB60)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1DB90310)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DB90370)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_READABLE_OFFSET UNITYSDK_OFFSET(0x1DB8FDA0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DB8FE20)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x1DB8FB50)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_WRITEABLE_OFFSET UNITYSDK_OFFSET(0x1DB8FDC0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DB90050)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_INITNETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x1DB8F790)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_INTERNALABORTSOCKET_OFFSET UNITYSDK_OFFSET(0x1DB8FC00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_MULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1DB92290)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_POLLREAD_OFFSET UNITYSDK_OFFSET(0x1DB90490)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_POLL_OFFSET UNITYSDK_OFFSET(0x1DB904B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1DB905D0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1DB90430)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1DB92C00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SETSOCKETTIMEOUTOPTION_OFFSET UNITYSDK_OFFSET(0x1DB8FFC0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DB903D0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_READABLE_OFFSET UNITYSDK_OFFSET(0x1DB8FDB0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DB8FEF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_WRITEABLE_OFFSET UNITYSDK_OFFSET(0x1DB8FDD0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DB90120)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1DB926E0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINREAD_OFFSET UNITYSDK_OFFSET(0x1DB912C0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1DB91C80)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1DB909A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB8F6F0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB8F8A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DB8F950)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DB8FA00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DB8FAA0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8F690)
...
namespace System::Net::Sockets
{
	...
	public:
		...
		::System::Boolean m_OwnsSocket; // 0x3C
		::System::Boolean m_Readable; // 0x3D
		::System::Boolean m_CleanedUp; // 0x3E
		::System::Boolean m_Writeable; // 0x3F
