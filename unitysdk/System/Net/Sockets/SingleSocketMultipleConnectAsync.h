...
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_GETNEXTADDRESS_OFFSET UNITYSDK_OFFSET(0x19BBB3F0)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONFAIL_OFFSET UNITYSDK_OFFSET(0x19BBB490)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x19BBB4C0)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBB3C0)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int SingleSocketMultipleConnectAsync_TypeDefinitionIndex = 3681;
