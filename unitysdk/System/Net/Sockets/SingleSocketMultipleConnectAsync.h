...
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_GETNEXTADDRESS_OFFSET UNITYSDK_OFFSET(0x1D4765C0)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONFAIL_OFFSET UNITYSDK_OFFSET(0x1D476660)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x1D476690)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D476590)
