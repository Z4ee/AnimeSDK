...
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x1DAD0D30)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1DAD0930)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTTCPCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x1DAD0E40)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x1DAD09B0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ALLOWNATTRAVERSAL_OFFSET UNITYSDK_OFFSET(0x1DAD0560)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_BEGINACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1DAD0A50)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_BEGINACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x1DAD0BB0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_CREATE_OFFSET UNITYSDK_OFFSET(0x1DAD01B0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ENDACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1DAD0AE0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ENDACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x1DAD0C40)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1DAD0350)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x1DAD0390)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x1DAD0360)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x1DAD0340)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_PENDING_OFFSET UNITYSDK_OFFSET(0x1DAD08B0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x1DAD0460)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_START_1_OFFSET UNITYSDK_OFFSET(0x1DAD0610)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_START_OFFSET UNITYSDK_OFFSET(0x1DAD0600)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_STOP_OFFSET UNITYSDK_OFFSET(0x1DAD0770)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DACFEF0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DAD0060)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DACFE40)
