...
#define SYSTEM_NET_SOCKETS_LINGEROPTION_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A585C80)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_GET_LINGERTIME_OFFSET UNITYSDK_OFFSET(0x1A585CA0)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A585C90)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_SET_LINGERTIME_OFFSET UNITYSDK_OFFSET(0x1A585CB0)
#define SYSTEM_NET_SOCKETS_LINGEROPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A585C70)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int LingerOption_TypeDefinitionIndex = 3646;
