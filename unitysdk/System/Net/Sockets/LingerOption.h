...
#define SYSTEM_NET_SOCKETS_LINGEROPTION_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1C8A4F40)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_GET_LINGERTIME_OFFSET UNITYSDK_OFFSET(0x1C8A4F60)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1C8A4F50)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_SET_LINGERTIME_OFFSET UNITYSDK_OFFSET(0x1C8A4F70)
#define SYSTEM_NET_SOCKETS_LINGEROPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8A4F30)
