...
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1DD2B6A0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DD2B6B0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_ENDOFPACKET_OFFSET UNITYSDK_OFFSET(0x1DD2B6D0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_FILEPATH_OFFSET UNITYSDK_OFFSET(0x1DD2B690)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1DD2B6C0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1DD2B4C0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD2B320)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DD2B4A0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DD2B3A0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DD2B4E0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DD2B670)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1DD2B560)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2B310)
