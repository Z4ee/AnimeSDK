...
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x1C02B7C0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1C02B7F0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x1C02B7E0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x1C02B7D0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1C02B800)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x1C02B660)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C02B670)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C02B720)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C02B5B0)
