...
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x1D412040)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1D412070)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x1D412060)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x1D412050)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1D412080)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x1D411EE0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D411EF0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D411FA0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D411E30)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int MulticastOption_TypeDefinitionIndex = 3646;

	class MulticastOption : public ::System::Object
	{
	public:
		::System::Net::IPAddress* localAddress; // 0x10
		::System::Net::IPAddress* group; // 0x18
