...
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ASYNCSTATE_OFFSET UNITYSDK_OFFSET(0x1B7672B0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ASYNCWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x1B767390)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_COMPLETEDSYNCHRONOUSLY_OFFSET UNITYSDK_OFFSET(0x1B767470)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_DELEGATE_OFFSET UNITYSDK_OFFSET(0x1B767630)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B767550)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ORIGINAL_OFFSET UNITYSDK_OFFSET(0x1B767640)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7672A0)
