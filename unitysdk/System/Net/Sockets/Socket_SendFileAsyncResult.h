...
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ASYNCSTATE_OFFSET UNITYSDK_OFFSET(0x193BBB40)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ASYNCWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x193BBC20)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_COMPLETEDSYNCHRONOUSLY_OFFSET UNITYSDK_OFFSET(0x193BBD00)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_DELEGATE_OFFSET UNITYSDK_OFFSET(0x193BBEC0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x193BBDE0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ORIGINAL_OFFSET UNITYSDK_OFFSET(0x193BBED0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x193BBB30)
