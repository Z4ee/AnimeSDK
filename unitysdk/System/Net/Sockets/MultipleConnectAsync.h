...
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_ASYNCFAIL_OFFSET UNITYSDK_OFFSET(0x1AAA0400)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_ATTEMPTCONNECTION_OFFSET UNITYSDK_OFFSET(0x1AA9FC80)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_CALLASYNCFAIL_OFFSET UNITYSDK_OFFSET(0x1AAA0620)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_CANCEL_OFFSET UNITYSDK_OFFSET(0x1AAA04D0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_DNSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AA9FB90)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_DODNSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AA9F800)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_FAIL_OFFSET UNITYSDK_OFFSET(0x1AA9FF60)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_INTERNALCONNECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AA9FFC0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_STARTCONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x1AA9F450)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_SUCCEED_OFFSET UNITYSDK_OFFSET(0x1AAA02F0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_SYNCFAIL_OFFSET UNITYSDK_OFFSET(0x1AA9F6B0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA07A0)

namespace System::Net::Sockets
{
	inline static constexpr unsigned int MultipleConnectAsync_TypeDefinitionIndex = 3679;

	class MultipleConnectAsync : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Net::IPAddress*>* addressList; // 0x10
		::System::Net::DnsEndPoint* endPoint; // 0x18
		::System::Object* lockObject; // 0x20
		::System::Net::Sockets::SocketAsyncEventArgs* internalArgs; // 0x28
