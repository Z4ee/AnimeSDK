...
#define SYSTEM_NET_COOKIETOKENIZER_RECOGNIZEDATTRIBUTE_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define SYSTEM_NET_COOKIETOKENIZER_RECOGNIZEDATTRIBUTE_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x39D3890)
#define SYSTEM_NET_COOKIETOKENIZER_RECOGNIZEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E35A0)

namespace System::Net
{
	inline static constexpr unsigned int CookieTokenizer_RecognizedAttribute_TypeDefinitionIndex = 2790;
