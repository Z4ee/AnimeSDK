...
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_GET_POS_OFFSET UNITYSDK_OFFSET(0x193B6160)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_GET_VAL_OFFSET UNITYSDK_OFFSET(0x193B6140)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_SET_POS_OFFSET UNITYSDK_OFFSET(0x193B6170)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_SET_VAL_OFFSET UNITYSDK_OFFSET(0x193B6150)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x193B4050)

namespace System::Net
{
	inline static constexpr unsigned int Base64Stream_ReadStateInfo_TypeDefinitionIndex = 3436;
