...
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_GET_POS_OFFSET UNITYSDK_OFFSET(0x1B7618B0)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_GET_VAL_OFFSET UNITYSDK_OFFSET(0x1B761890)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_SET_POS_OFFSET UNITYSDK_OFFSET(0x1B7618C0)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_SET_VAL_OFFSET UNITYSDK_OFFSET(0x1B7618A0)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75F7A0)
