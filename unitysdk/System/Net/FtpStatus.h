...
#define SYSTEM_NET_FTPSTATUS_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1D471B30)
#define SYSTEM_NET_FTPSTATUS_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D471B40)
#define SYSTEM_NET_FTPSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D471B20)

namespace System::Net
{
	inline static constexpr unsigned int FtpStatus_TypeDefinitionIndex = 3515;
