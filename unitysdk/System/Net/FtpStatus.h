...
#define SYSTEM_NET_FTPSTATUS_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x19BB66B0)
#define SYSTEM_NET_FTPSTATUS_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19BB66C0)
#define SYSTEM_NET_FTPSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB66A0)

namespace System::Net
{
	inline static constexpr unsigned int FtpStatus_TypeDefinitionIndex = 3516;
