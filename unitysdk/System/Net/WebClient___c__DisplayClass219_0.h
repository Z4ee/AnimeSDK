...
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS219_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8A5850)
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS219_0__DOWNLOADSTRINGTASKASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1C8A5860)

namespace System::Net
{
	inline static constexpr unsigned int WebClient___c__DisplayClass219_0_TypeDefinitionIndex = 3446;

	class WebClient___c__DisplayClass219_0 : public ::System::Object
	{
	public:
		::System::Net::DownloadStringCompletedEventHandler* handler; // 0x10
