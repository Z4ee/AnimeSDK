...
#define SYSTEM_NET_DNSPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1B1EAAD0)
#define SYSTEM_NET_DNSPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1B1EAB10)
#define SYSTEM_NET_DNSPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1B1EAB50)
#define SYSTEM_NET_DNSPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1B1EAB90)
#define SYSTEM_NET_DNSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1B1EABD0)
#define SYSTEM_NET_DNSPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1B1EAC10)
#define SYSTEM_NET_DNSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EAA90)

namespace System::Net
{
	inline static constexpr unsigned int DnsPermission_TypeDefinitionIndex = 4111;
