...
#define SYSTEM_NET_DNSPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1E978C80)
#define SYSTEM_NET_DNSPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1E978CC0)
#define SYSTEM_NET_DNSPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1E978D00)
#define SYSTEM_NET_DNSPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1E978D40)
#define SYSTEM_NET_DNSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1E978D80)
#define SYSTEM_NET_DNSPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1E978DC0)
#define SYSTEM_NET_DNSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E978C40)
