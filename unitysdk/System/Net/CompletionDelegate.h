...
#define SYSTEM_NET_COMPLETIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A52990)
#define SYSTEM_NET_COMPLETIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A529D0)
#define SYSTEM_NET_COMPLETIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A52370)
#define SYSTEM_NET_COMPLETIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A52360)

namespace System::Net
{
	inline static constexpr unsigned int CompletionDelegate_TypeDefinitionIndex = 3457;
