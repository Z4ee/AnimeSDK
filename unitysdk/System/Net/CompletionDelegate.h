...
#define SYSTEM_NET_COMPLETIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BEC43A0)
#define SYSTEM_NET_COMPLETIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BEC43E0)
#define SYSTEM_NET_COMPLETIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BEC3D80)
#define SYSTEM_NET_COMPLETIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC3D60)
