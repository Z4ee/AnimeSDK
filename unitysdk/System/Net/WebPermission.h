...
#define SYSTEM_NET_WEBPERMISSION_ADDASPATTERN_OFFSET UNITYSDK_OFFSET(0x1C3021B0)
#define SYSTEM_NET_WEBPERMISSION_ADDPERMISSION_1_OFFSET UNITYSDK_OFFSET(0x1C301AB0)
#define SYSTEM_NET_WEBPERMISSION_ADDPERMISSION_2_OFFSET UNITYSDK_OFFSET(0x1C300F20)
#define SYSTEM_NET_WEBPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x1C3011C0)
#define SYSTEM_NET_WEBPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1C3028A0)
#define SYSTEM_NET_WEBPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1C3061B0)
#define SYSTEM_NET_WEBPERMISSION_GET_ACCEPTLIST_OFFSET UNITYSDK_OFFSET(0x1C3003C0)
#define SYSTEM_NET_WEBPERMISSION_GET_CONNECTLIST_OFFSET UNITYSDK_OFFSET(0x1C2FFE50)
#define SYSTEM_NET_WEBPERMISSION_GET_MATCHALLREGEX_OFFSET UNITYSDK_OFFSET(0x1C2FFD60)
#define SYSTEM_NET_WEBPERMISSION_INTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1C3049E0)
#define SYSTEM_NET_WEBPERMISSION_INTERSECTPAIR_OFFSET UNITYSDK_OFFSET(0x1C307FB0)
#define SYSTEM_NET_WEBPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1C304640)
#define SYSTEM_NET_WEBPERMISSION_ISMATCHEDURI_OFFSET UNITYSDK_OFFSET(0x1C303880)
#define SYSTEM_NET_WEBPERMISSION_ISSPECIALSUBSETCASE_OFFSET UNITYSDK_OFFSET(0x1C3033C0)
#define SYSTEM_NET_WEBPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1C302C50)
#define SYSTEM_NET_WEBPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1C302890)
#define SYSTEM_NET_WEBPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1C306FE0)
#define SYSTEM_NET_WEBPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1C303DF0)
#define SYSTEM_NET_WEBPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C300A60)
#define SYSTEM_NET_WEBPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C300B80)
#define SYSTEM_NET_WEBPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C300CA0)
#define SYSTEM_NET_WEBPERMISSION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C300DE0)
#define SYSTEM_NET_WEBPERMISSION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C301080)
#define SYSTEM_NET_WEBPERMISSION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1C301970)
#define SYSTEM_NET_WEBPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C300930)
...
namespace System::Net
{
	...
	public:
		...
		::System::Boolean m_UnrestrictedConnect; // 0x21
		::System::Boolean m_noRestriction; // 0x22
