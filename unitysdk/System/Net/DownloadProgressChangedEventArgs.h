...
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESRECEIVED_OFFSET UNITYSDK_OFFSET(0x1BED0C70)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTORECEIVE_OFFSET UNITYSDK_OFFSET(0x1BED0C80)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BED0C90)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED0BF0)
