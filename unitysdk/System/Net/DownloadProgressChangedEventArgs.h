...
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESRECEIVED_OFFSET UNITYSDK_OFFSET(0x1D242540)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTORECEIVE_OFFSET UNITYSDK_OFFSET(0x1D242550)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D242560)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2424C0)

namespace System::Net
{
	inline static constexpr unsigned int DownloadProgressChangedEventArgs_TypeDefinitionIndex = 3474;

	class DownloadProgressChangedEventArgs : public ::System::ComponentModel::ProgressChangedEventArgs
	{
	public:
		::System::Int64 m_BytesReceived; // 0x20
