...
#define SYSTEM_NET_WEBREQUEST_ABORT_OFFSET UNITYSDK_OFFSET(0x1AAA96B0)
#define SYSTEM_NET_WEBREQUEST_BEGINGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1AAA8CE0)
#define SYSTEM_NET_WEBREQUEST_BEGINGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x1AAA8C40)
#define SYSTEM_NET_WEBREQUEST_CREATEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1AAA7690)
#define SYSTEM_NET_WEBREQUEST_CREATEHTTP_1_OFFSET UNITYSDK_OFFSET(0x1AAA7810)
#define SYSTEM_NET_WEBREQUEST_CREATEHTTP_OFFSET UNITYSDK_OFFSET(0x1AAA7740)
#define SYSTEM_NET_WEBREQUEST_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AAA7510)
#define SYSTEM_NET_WEBREQUEST_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1AAA75E0)
#define SYSTEM_NET_WEBREQUEST_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAA7060)
#define SYSTEM_NET_WEBREQUEST_ENDGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1AAA8D30)
#define SYSTEM_NET_WEBREQUEST_ENDGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x1AAA8C90)
#define SYSTEM_NET_WEBREQUEST_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AAA82F0)
#define SYSTEM_NET_WEBREQUEST_GETREQUESTSTREAMASYNC_OFFSET UNITYSDK_OFFSET(0x1AAA8D80)
#define SYSTEM_NET_WEBREQUEST_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1AAA8BA0)
#define SYSTEM_NET_WEBREQUEST_GETRESPONSEASYNC_OFFSET UNITYSDK_OFFSET(0x1AAA92A0)
#define SYSTEM_NET_WEBREQUEST_GETRESPONSE_OFFSET UNITYSDK_OFFSET(0x1AAA8BF0)
#define SYSTEM_NET_WEBREQUEST_GETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1AAA9C30)
#define SYSTEM_NET_WEBREQUEST_GET_AUTHENTICATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAA9720)
#define SYSTEM_NET_WEBREQUEST_GET_CACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1AAA8420)
#define SYSTEM_NET_WEBREQUEST_GET_CACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AAA9700)
#define SYSTEM_NET_WEBREQUEST_GET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x1AAA8600)
#define SYSTEM_NET_WEBREQUEST_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1AAA8740)
#define SYSTEM_NET_WEBREQUEST_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AAA87E0)
#define SYSTEM_NET_WEBREQUEST_GET_CREATORINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AAA6EA0)
#define SYSTEM_NET_WEBREQUEST_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1AAA8880)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1AAA8300)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTTIMERQUEUE_OFFSET UNITYSDK_OFFSET(0x1AAA7000)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1AAA9B70)
#define SYSTEM_NET_WEBREQUEST_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1AAA86A0)
#define SYSTEM_NET_WEBREQUEST_GET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAA9740)
#define SYSTEM_NET_WEBREQUEST_GET_INTERNALDEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1AAA97B0)
#define SYSTEM_NET_WEBREQUEST_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x1AAA6F10)
#define SYSTEM_NET_WEBREQUEST_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1AAA8510)
#define SYSTEM_NET_WEBREQUEST_GET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1AAA8A60)
#define SYSTEM_NET_WEBREQUEST_GET_PREFIXLIST_OFFSET UNITYSDK_OFFSET(0x1AAA7330)
#define SYSTEM_NET_WEBREQUEST_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x1AAA89C0)
#define SYSTEM_NET_WEBREQUEST_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x1AAA85B0)
#define SYSTEM_NET_WEBREQUEST_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1AAA8B00)
#define SYSTEM_NET_WEBREQUEST_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1AAA8920)
#define SYSTEM_NET_WEBREQUEST_INTERNALGETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1AAA9CC0)
#define SYSTEM_NET_WEBREQUEST_INTERNALSETCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1AAA84A0)
#define SYSTEM_NET_WEBREQUEST_POPULATEPREFIXLIST_OFFSET UNITYSDK_OFFSET(0x1AAA8110)
#define SYSTEM_NET_WEBREQUEST_REGISTERPORTABLEWEBREQUESTCREATOR_OFFSET UNITYSDK_OFFSET(0x1AAA6F00)
#define SYSTEM_NET_WEBREQUEST_REGISTERPREFIX_OFFSET UNITYSDK_OFFSET(0x1AAA7B80)
#define SYSTEM_NET_WEBREQUEST_REQUESTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AAA9760)
#define SYSTEM_NET_WEBREQUEST_SAFECAPTUREIDENITY_OFFSET UNITYSDK_OFFSET(0x1AAA9190)
#define SYSTEM_NET_WEBREQUEST_SETUPCACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AAA9D00)
#define SYSTEM_NET_WEBREQUEST_SET_AUTHENTICATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAA9730)
#define SYSTEM_NET_WEBREQUEST_SET_CACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1AAA8430)
#define SYSTEM_NET_WEBREQUEST_SET_CACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AAA9710)
#define SYSTEM_NET_WEBREQUEST_SET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x1AAA8650)
#define SYSTEM_NET_WEBREQUEST_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1AAA8790)
#define SYSTEM_NET_WEBREQUEST_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AAA8830)
#define SYSTEM_NET_WEBREQUEST_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1AAA88D0)
#define SYSTEM_NET_WEBREQUEST_SET_DEFAULTCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1AAA8370)
#define SYSTEM_NET_WEBREQUEST_SET_DEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1AAA9BD0)
#define SYSTEM_NET_WEBREQUEST_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1AAA86F0)
#define SYSTEM_NET_WEBREQUEST_SET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAA9750)
#define SYSTEM_NET_WEBREQUEST_SET_INTERNALDEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1AAA99B0)
#define SYSTEM_NET_WEBREQUEST_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1AAA8560)
#define SYSTEM_NET_WEBREQUEST_SET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1AAA8AB0)
#define SYSTEM_NET_WEBREQUEST_SET_PREFIXLIST_OFFSET UNITYSDK_OFFSET(0x1AAA80B0)
#define SYSTEM_NET_WEBREQUEST_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x1AAA8A10)
#define SYSTEM_NET_WEBREQUEST_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1AAA8B50)
#define SYSTEM_NET_WEBREQUEST_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1AAA8970)
#define SYSTEM_NET_WEBREQUEST_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AAA82C0)
#define SYSTEM_NET_WEBREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AAA9F30)
#define SYSTEM_NET_WEBREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAA82B0)
#define SYSTEM_NET_WEBREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA82A0)
#define SYSTEM_NET_WEBREQUEST__GETREQUESTSTREAMASYNC_B__78_0_OFFSET UNITYSDK_OFFSET(0x1AAA9FC0)
#define SYSTEM_NET_WEBREQUEST__GETRESPONSEASYNC_B__79_0_OFFSET UNITYSDK_OFFSET(0x1AAAA170)

namespace System::Net
{
	inline static constexpr unsigned int WebRequest_TypeDefinitionIndex = 3350;
	...
	public:
		...
		{
			return (::System::Net::TimerThread_Queue**)Il2CppClass::FromTypeDefinitionIndex(WebRequest_TypeDefinitionIndex)->GetStaticField(0x3B20);
		}
