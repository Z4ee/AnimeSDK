...
#define SYSTEM_NET_COOKIEPARSER_CHECKQUOTED_OFFSET UNITYSDK_OFFSET(0x1D88BF90)
#define SYSTEM_NET_COOKIEPARSER_GETSERVER_OFFSET UNITYSDK_OFFSET(0x1D88C040)
#define SYSTEM_NET_COOKIEPARSER_GET_OFFSET UNITYSDK_OFFSET(0x1D88B4C0)
#define SYSTEM_NET_COOKIEPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D88B450)
