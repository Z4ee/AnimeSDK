...
#define SYSTEM_NET_CACHE_REQUESTCACHEBINDING_GET_CACHE_OFFSET UNITYSDK_OFFSET(0x1E977FC0)
#define SYSTEM_NET_CACHE_REQUESTCACHEBINDING_GET_POLICY_OFFSET UNITYSDK_OFFSET(0x1E977FE0)
#define SYSTEM_NET_CACHE_REQUESTCACHEBINDING_GET_VALIDATOR_OFFSET UNITYSDK_OFFSET(0x1E977FD0)
#define SYSTEM_NET_CACHE_REQUESTCACHEBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E977FB0)
...
namespace System::Net::Cache
{
	...
	{
	public:
		::System::Net::Cache::RequestCachePolicy* m_Policy; // 0x10
