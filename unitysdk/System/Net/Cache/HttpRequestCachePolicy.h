...
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_CACHESYNCDATE_OFFSET UNITYSDK_OFFSET(0x1DAB3C20)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_INTERNALCACHESYNCDATEUTC_OFFSET UNITYSDK_OFFSET(0x1DAB3C60)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1DAB3C10)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MAXAGE_OFFSET UNITYSDK_OFFSET(0x1DAB3C70)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MAXSTALE_OFFSET UNITYSDK_OFFSET(0x1DAB3C90)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MINFRESH_OFFSET UNITYSDK_OFFSET(0x1DAB3C80)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_MAPLEVEL_OFFSET UNITYSDK_OFFSET(0x1DAB36D0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DAB3CA0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAB40C0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAB3580)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DAB3750)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DAB3930)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DAB3B00)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DAB3BE0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB34B0)
