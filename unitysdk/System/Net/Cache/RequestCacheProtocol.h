...
#define SYSTEM_NET_CACHE_REQUESTCACHEPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C87EF60)

namespace System::Net::Cache
{
	inline static constexpr unsigned int RequestCacheProtocol_TypeDefinitionIndex = 3871;
