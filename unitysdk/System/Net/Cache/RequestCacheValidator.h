...
#define SYSTEM_NET_CACHE_REQUESTCACHEVALIDATOR_CREATEVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1BEC3D00)
#define SYSTEM_NET_CACHE_REQUESTCACHEVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC3D50)
