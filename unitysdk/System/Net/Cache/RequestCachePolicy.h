...
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x186B6BD0)

namespace System::Net::Cache
{
	inline static constexpr unsigned int RequestCachePolicy_TypeDefinitionIndex = 2972;
