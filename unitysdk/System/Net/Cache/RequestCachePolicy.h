...
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A0F1360)

namespace System::Net::Cache
{
	inline static constexpr unsigned int RequestCachePolicy_TypeDefinitionIndex = 2973;
