...
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1B1E9EF0)
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1E9F00)
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1E9E80)
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E9E40)
