...
#define SYSTEM_NET_SERVICENAMESTORE_ADDSINGLESERVICENAME_OFFSET UNITYSDK_OFFSET(0x1D6B0160)
#define SYSTEM_NET_SERVICENAMESTORE_ADD_OFFSET UNITYSDK_OFFSET(0x1D6B0200)
#define SYSTEM_NET_SERVICENAMESTORE_BUILDSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x1D6B02F0)
#define SYSTEM_NET_SERVICENAMESTORE_BUILDSIMPLESERVICENAME_OFFSET UNITYSDK_OFFSET(0x1D6B0810)
#define SYSTEM_NET_SERVICENAMESTORE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D6B0860)
#define SYSTEM_NET_SERVICENAMESTORE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D6B01E0)
#define SYSTEM_NET_SERVICENAMESTORE_EXTRACTHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1D6B08B0)
#define SYSTEM_NET_SERVICENAMESTORE_GET_SERVICENAMES_OFFSET UNITYSDK_OFFSET(0x1D6A9720)
#define SYSTEM_NET_SERVICENAMESTORE_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D6B0740)
#define SYSTEM_NET_SERVICENAMESTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A9300)
