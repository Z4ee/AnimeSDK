...
#define SYSTEM_NET_SECURITYBUFFERDESCRIPTOR_DEBUGDUMP_OFFSET UNITYSDK_OFFSET(0x1D256020)
#define SYSTEM_NET_SECURITYBUFFERDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D256000)
