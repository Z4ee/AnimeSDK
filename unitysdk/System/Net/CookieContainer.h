...
#define SYSTEM_NET_COOKIECONTAINER_ADDREMOVEDOMAIN_OFFSET UNITYSDK_OFFSET(0x1D23D180)
#define SYSTEM_NET_COOKIECONTAINER_ADD_1_OFFSET UNITYSDK_OFFSET(0x1D23C870)
#define SYSTEM_NET_COOKIECONTAINER_ADD_2_OFFSET UNITYSDK_OFFSET(0x1D23D430)
#define SYSTEM_NET_COOKIECONTAINER_ADD_3_OFFSET UNITYSDK_OFFSET(0x1D23D750)
#define SYSTEM_NET_COOKIECONTAINER_ADD_4_OFFSET UNITYSDK_OFFSET(0x1D23D900)
#define SYSTEM_NET_COOKIECONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0x1D23BDA0)
#define SYSTEM_NET_COOKIECONTAINER_AGECOOKIES_OFFSET UNITYSDK_OFFSET(0x1D2360B0)
#define SYSTEM_NET_COOKIECONTAINER_BUILDCOOKIECOLLECTIONFROMDOMAINMATCHES_OFFSET UNITYSDK_OFFSET(0x1D23EB40)
#define SYSTEM_NET_COOKIECONTAINER_COOKIECUTTER_OFFSET UNITYSDK_OFFSET(0x1D23DD70)
#define SYSTEM_NET_COOKIECONTAINER_EXPIRECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D23D290)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIEHEADER_1_OFFSET UNITYSDK_OFFSET(0x1D240110)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIEHEADER_OFFSET UNITYSDK_OFFSET(0x1D240070)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIES_OFFSET UNITYSDK_OFFSET(0x1D23E5C0)
#define SYSTEM_NET_COOKIECONTAINER_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x1D235F50)
#define SYSTEM_NET_COOKIECONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D23BC70)
#define SYSTEM_NET_COOKIECONTAINER_GET_MAXCOOKIESIZE_OFFSET UNITYSDK_OFFSET(0x1D23BC80)
#define SYSTEM_NET_COOKIECONTAINER_GET_PERDOMAINCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D23BD00)
#define SYSTEM_NET_COOKIECONTAINER_INTERNALGETCOOKIES_OFFSET UNITYSDK_OFFSET(0x1D23E660)
#define SYSTEM_NET_COOKIECONTAINER_ISLOCALDOMAIN_OFFSET UNITYSDK_OFFSET(0x1D23C2A0)
#define SYSTEM_NET_COOKIECONTAINER_MERGEUPDATECOLLECTIONS_OFFSET UNITYSDK_OFFSET(0x1D23FE30)
#define SYSTEM_NET_COOKIECONTAINER_SETCOOKIES_OFFSET UNITYSDK_OFFSET(0x1D2404B0)
#define SYSTEM_NET_COOKIECONTAINER_SET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x1D235F60)
#define SYSTEM_NET_COOKIECONTAINER_SET_MAXCOOKIESIZE_OFFSET UNITYSDK_OFFSET(0x1D23BC90)
#define SYSTEM_NET_COOKIECONTAINER_SET_PERDOMAINCAPACITY_OFFSET UNITYSDK_OFFSET(0x1D23BD10)
#define SYSTEM_NET_COOKIECONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D240590)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D235CE0)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D235D60)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D235BA0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Int32 m_maxCookieSize; // 0x20
		::System::Int32 m_maxCookies; // 0x24
