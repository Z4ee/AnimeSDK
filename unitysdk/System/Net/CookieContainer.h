...
#define SYSTEM_NET_COOKIECONTAINER_ADDREMOVEDOMAIN_OFFSET UNITYSDK_OFFSET(0x19A59F30)
#define SYSTEM_NET_COOKIECONTAINER_ADD_1_OFFSET UNITYSDK_OFFSET(0x19A59600)
#define SYSTEM_NET_COOKIECONTAINER_ADD_2_OFFSET UNITYSDK_OFFSET(0x19A5A1E0)
#define SYSTEM_NET_COOKIECONTAINER_ADD_3_OFFSET UNITYSDK_OFFSET(0x19A5A510)
#define SYSTEM_NET_COOKIECONTAINER_ADD_4_OFFSET UNITYSDK_OFFSET(0x19A5A6C0)
#define SYSTEM_NET_COOKIECONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0x19A58B50)
#define SYSTEM_NET_COOKIECONTAINER_AGECOOKIES_OFFSET UNITYSDK_OFFSET(0x19A52FB0)
#define SYSTEM_NET_COOKIECONTAINER_BUILDCOOKIECOLLECTIONFROMDOMAINMATCHES_OFFSET UNITYSDK_OFFSET(0x19A5B920)
#define SYSTEM_NET_COOKIECONTAINER_COOKIECUTTER_OFFSET UNITYSDK_OFFSET(0x19A5AB40)
#define SYSTEM_NET_COOKIECONTAINER_EXPIRECOLLECTION_OFFSET UNITYSDK_OFFSET(0x19A5A040)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIEHEADER_1_OFFSET UNITYSDK_OFFSET(0x19A5CED0)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIEHEADER_OFFSET UNITYSDK_OFFSET(0x19A5CE30)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIES_OFFSET UNITYSDK_OFFSET(0x19A5B390)
#define SYSTEM_NET_COOKIECONTAINER_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x19A52E50)
#define SYSTEM_NET_COOKIECONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19A58A20)
#define SYSTEM_NET_COOKIECONTAINER_GET_MAXCOOKIESIZE_OFFSET UNITYSDK_OFFSET(0x19A58A30)
#define SYSTEM_NET_COOKIECONTAINER_GET_PERDOMAINCAPACITY_OFFSET UNITYSDK_OFFSET(0x19A58AB0)
#define SYSTEM_NET_COOKIECONTAINER_INTERNALGETCOOKIES_OFFSET UNITYSDK_OFFSET(0x19A5B430)
#define SYSTEM_NET_COOKIECONTAINER_ISLOCALDOMAIN_OFFSET UNITYSDK_OFFSET(0x19A59040)
#define SYSTEM_NET_COOKIECONTAINER_MERGEUPDATECOLLECTIONS_OFFSET UNITYSDK_OFFSET(0x19A5CBE0)
#define SYSTEM_NET_COOKIECONTAINER_SETCOOKIES_OFFSET UNITYSDK_OFFSET(0x19A5D280)
#define SYSTEM_NET_COOKIECONTAINER_SET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x19A52E60)
#define SYSTEM_NET_COOKIECONTAINER_SET_MAXCOOKIESIZE_OFFSET UNITYSDK_OFFSET(0x19A58A40)
#define SYSTEM_NET_COOKIECONTAINER_SET_PERDOMAINCAPACITY_OFFSET UNITYSDK_OFFSET(0x19A58AC0)
#define SYSTEM_NET_COOKIECONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A5D360)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A52BE0)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19A52C60)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A52AA0)
