...
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS245_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B768070)
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS245_0__UPLOADVALUESTASKASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1B768080)

namespace System::Net
{
	inline static constexpr unsigned int WebClient___c__DisplayClass245_0_TypeDefinitionIndex = 3455;
	...
	public:
		...
		::System::Net::UploadValuesCompletedEventHandler* handler; // 0x20
