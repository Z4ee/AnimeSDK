...
#define SYSTEM_NET_PROXYCHAIN_ABORT_OFFSET UNITYSDK_OFFSET(0x18FC18D0)
#define SYSTEM_NET_PROXYCHAIN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FC1850)
#define SYSTEM_NET_PROXYCHAIN_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18FC1780)
#define SYSTEM_NET_PROXYCHAIN_GET_DESTINATION_OFFSET UNITYSDK_OFFSET(0x18FC18C0)
#define SYSTEM_NET_PROXYCHAIN_GET_ENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18FC1860)
#define SYSTEM_NET_PROXYCHAIN_GET_HTTPABORTDELEGATE_OFFSET UNITYSDK_OFFSET(0x18FC1900)
#define SYSTEM_NET_PROXYCHAIN_HTTPABORT_OFFSET UNITYSDK_OFFSET(0x18FC18E0)
#define SYSTEM_NET_PROXYCHAIN_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18FC17F0)
#define SYSTEM_NET_PROXYCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC16F0)

namespace System::Net
{
	inline static constexpr unsigned int ProxyChain_TypeDefinitionIndex = 3386;
