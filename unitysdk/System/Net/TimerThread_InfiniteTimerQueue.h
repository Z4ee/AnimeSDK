...
#define SYSTEM_NET_TIMERTHREAD_INFINITETIMERQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1871AE00)

namespace System::Net
{
	inline static constexpr unsigned int TimerThread_InfiniteTimerQueue_TypeDefinitionIndex = 2777;
