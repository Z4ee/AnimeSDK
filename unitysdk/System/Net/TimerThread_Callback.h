...
#define SYSTEM_NET_TIMERTHREAD_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1871B5D0)
#define SYSTEM_NET_TIMERTHREAD_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1871B640)
#define SYSTEM_NET_TIMERTHREAD_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1871B030)
#define SYSTEM_NET_TIMERTHREAD_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1871B010)

namespace System::Net
{
	inline static constexpr unsigned int TimerThread_Callback_TypeDefinitionIndex = 2775;
