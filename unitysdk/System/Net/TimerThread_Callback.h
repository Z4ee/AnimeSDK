...
#define SYSTEM_NET_TIMERTHREAD_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E9C5610)
#define SYSTEM_NET_TIMERTHREAD_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E9C5680)
#define SYSTEM_NET_TIMERTHREAD_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E9C55F0)
#define SYSTEM_NET_TIMERTHREAD_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9C5500)

namespace System::Net
{
	inline static constexpr unsigned int TimerThread_Callback_TypeDefinitionIndex = 2787;
