...
#define SYSTEM_NET_SERVICEPOINTMANAGER_CLOSECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x1C02AE80)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1C02ADB0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_2_OFFSET UNITYSDK_OFFSET(0x1C02A280)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x1C02A220)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GETLEGACYCERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x1C029670)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1C029870)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x1C029520)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x1C0296D0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DEFAULTCONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x1C029790)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DISABLESENDAUXRECORD_OFFSET UNITYSDK_OFFSET(0x1C02A130)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DISABLESTRONGCRYPTO_OFFSET UNITYSDK_OFFSET(0x1C02A120)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C029980)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x1C029A40)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_ENCRYPTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x1C029F90)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x1C029FA0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_MAXSERVICEPOINTIDLETIME_OFFSET UNITYSDK_OFFSET(0x1C029AC0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_MAXSERVICEPOINTS_OFFSET UNITYSDK_OFFSET(0x1C029BA0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_REUSEPORT_OFFSET UNITYSDK_OFFSET(0x1C029C80)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1C029CE0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C029E00)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SERVERCERTVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C029DA0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C02A060)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SETTCPKEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1C02A140)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x1C029610)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x1C029730)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_DEFAULTCONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x1C0297F0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C0299E0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x1C029A80)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x1C02A000)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_MAXSERVICEPOINTIDLETIME_OFFSET UNITYSDK_OFFSET(0x1C029B20)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_MAXSERVICEPOINTS_OFFSET UNITYSDK_OFFSET(0x1C029C00)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_REUSEPORT_OFFSET UNITYSDK_OFFSET(0x1C029C90)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1C029D40)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C029EB0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C02A0C0)
#define SYSTEM_NET_SERVICEPOINTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C029490)
#define SYSTEM_NET_SERVICEPOINTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C029510)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::System::Net::ServerCertValidationCallback**)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0x23D0);
		}
		...
		{
			return (::System::Collections::Specialized::HybridDictionary**)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0x23E0);
		}
		...
		{
			return (::System::Net::SecurityProtocolType*)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0xF0C);
		}
