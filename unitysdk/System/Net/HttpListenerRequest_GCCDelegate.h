...
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4051F0)
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D405220)
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D404F60)
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D404F40)

namespace System::Net
{
	inline static constexpr unsigned int HttpListenerRequest_GCCDelegate_TypeDefinitionIndex = 3529;
