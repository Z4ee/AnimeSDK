...
#define SYSTEM_NET_AUTHENTICATIONMANAGER_AUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1A0FE700)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A0FE5C0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_DOAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1A0FE800)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_DOUNREGISTER_OFFSET UNITYSDK_OFFSET(0x1A0FF790)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_ENSUREMODULES_OFFSET UNITYSDK_OFFSET(0x1A0FE080)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1A0FE3E0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_CREDENTIALPOLICY_OFFSET UNITYSDK_OFFSET(0x1A0FE320)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_CUSTOMTARGETNAMEDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1A0FE4F0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_OSSUPPORTSEXTENDEDPROTECTION_OFFSET UNITYSDK_OFFSET(0x1A0FE5B0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_REGISTEREDMODULES_OFFSET UNITYSDK_OFFSET(0x1A0FE530)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1A0FEEB0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1A0FF590)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_SET_CREDENTIALPOLICY_OFFSET UNITYSDK_OFFSET(0x1A0FE380)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_UNREGISTER_1_OFFSET UNITYSDK_OFFSET(0x1A0FFE90)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1A0FFD70)
#define SYSTEM_NET_AUTHENTICATIONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0FFF10)
#define SYSTEM_NET_AUTHENTICATIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FE070)
