...
#define SYSTEM_NET_HTTPDATEPARSE_MAKE_UPPER_OFFSET UNITYSDK_OFFSET(0x1A108630)
#define SYSTEM_NET_HTTPDATEPARSE_MAPDAYMONTHTODWORD_OFFSET UNITYSDK_OFFSET(0x1A108650)
#define SYSTEM_NET_HTTPDATEPARSE_PARSEHTTPDATE_OFFSET UNITYSDK_OFFSET(0x1A1089F0)

namespace System::Net
{
	inline static constexpr unsigned int HttpDateParse_TypeDefinitionIndex = 3372;
