...
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C653360)
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C6533A0)
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C652DE0)
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C652DC0)

namespace System::Net
{
	inline static constexpr unsigned int DownloadDataCompletedEventHandler_TypeDefinitionIndex = 3463;
