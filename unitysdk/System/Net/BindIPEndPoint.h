...
#define SYSTEM_NET_BINDIPENDPOINT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB40CA0)
#define SYSTEM_NET_BINDIPENDPOINT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB40D10)
#define SYSTEM_NET_BINDIPENDPOINT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB40C80)
#define SYSTEM_NET_BINDIPENDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB40B90)

namespace System::Net
{
	inline static constexpr unsigned int BindIPEndPoint_TypeDefinitionIndex = 2824;
