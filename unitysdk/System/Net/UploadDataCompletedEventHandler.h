...
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE9EC0)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE9F00)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE9940)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE9930)

namespace System::Net
{
	inline static constexpr unsigned int UploadDataCompletedEventHandler_TypeDefinitionIndex = 3468;
