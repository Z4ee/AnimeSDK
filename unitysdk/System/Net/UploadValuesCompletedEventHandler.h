...
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D414AD0)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D414B10)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D414540)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D414520)
