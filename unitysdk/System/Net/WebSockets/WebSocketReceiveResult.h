...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AFEA7B0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1AFEA7A0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AFEA770)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_ENDOFMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AFEA780)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_MESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x1AFEA790)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFEA6E0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEA660)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int WebSocketReceiveResult_TypeDefinitionIndex = 3905;
	...
	public:
		...
		::System::Net::WebSockets::WebSocketMessageType _MessageType_k__BackingField; // 0x24
