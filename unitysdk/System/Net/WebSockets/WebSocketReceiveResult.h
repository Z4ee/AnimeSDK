...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1E7EBC20)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1E7EBC10)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E7EBBE0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_ENDOFMESSAGE_OFFSET UNITYSDK_OFFSET(0x1E7EBBF0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_MESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x1E7EBC00)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7EBB50)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7EBAC0)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		::System::Boolean _EndOfMessage_k__BackingField; // 0x1C
		::System::Net::WebSockets::WebSocketMessageType _MessageType_k__BackingField; // 0x20
		::System::Nullable_1<::System::Net::WebSockets::WebSocketCloseStatus> _CloseStatus_k__BackingField; // 0x24
