...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_ABORT_OFFSET UNITYSDK_OFFSET(0x1C087C70)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1C087BB0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x1C087C10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CONNECTASYNCCORE_OFFSET UNITYSDK_OFFSET(0x1C0878B0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x1C087460)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C087DE0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C087290)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1C087200)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C0871F0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1C0873B0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1C087320)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1C087B50)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1C087A10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_THROWIFNOTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1C087A90)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C086FB0)
