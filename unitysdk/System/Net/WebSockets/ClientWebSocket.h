...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_ABORT_OFFSET UNITYSDK_OFFSET(0x19BC4CD0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x19BC4C10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x19BC4C70)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CONNECTASYNCCORE_OFFSET UNITYSDK_OFFSET(0x19BC4900)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x19BC44B0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19BC4E40)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19BC42E0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x19BC4250)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x19BC4240)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x19BC4400)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19BC4370)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x19BC4BB0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x19BC4A70)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET_THROWIFNOTCONNECTED_OFFSET UNITYSDK_OFFSET(0x19BC4AF0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC4000)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int ClientWebSocket_TypeDefinitionIndex = 3888;

	class ClientWebSocket : public ::System::Net::WebSockets::WebSocket
	{
	public:
		::System::Net::WebSockets::WebSocketHandle* _innerWebSocket; // 0x10
		::System::Net::WebSockets::ClientWebSocketOptions* _options; // 0x18
