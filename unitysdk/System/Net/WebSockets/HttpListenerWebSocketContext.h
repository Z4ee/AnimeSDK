...
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_COPYPRINCIPAL_OFFSET UNITYSDK_OFFSET(0x1C89A4F0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_COOKIECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1C89A700)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1C89A6B0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1C89A720)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISLOCAL_OFFSET UNITYSDK_OFFSET(0x1C89A730)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISSECURECONNECTION_OFFSET UNITYSDK_OFFSET(0x1C89A740)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x1C89A6C0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x1C89A6A0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETKEY_OFFSET UNITYSDK_OFFSET(0x1C89A6F0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1C89A6D0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETVERSION_OFFSET UNITYSDK_OFFSET(0x1C89A6E0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_USER_OFFSET UNITYSDK_OFFSET(0x1C89A710)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_WEBSOCKET_OFFSET UNITYSDK_OFFSET(0x1C89A750)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C89A760)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C89A350)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		::System::Security::Principal::IPrincipal* _user; // 0x18
		::System::Net::WebSockets::WebSocket* _webSocket; // 0x20
		::System::Uri* _requestUri; // 0x28
		::System::String* _secWebSocketKey; // 0x30
		::System::String* _secWebSocketVersion; // 0x38
		::System::Net::CookieCollection* _cookieCollection; // 0x40
		::System::Collections::Specialized::NameValueCollection* _headers; // 0x48
