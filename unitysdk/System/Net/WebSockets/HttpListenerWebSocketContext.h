...
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_COPYPRINCIPAL_OFFSET UNITYSDK_OFFSET(0x1B41ED80)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_COOKIECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1B41EF90)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1B41EF40)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1B41EFB0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISLOCAL_OFFSET UNITYSDK_OFFSET(0x1B41EFC0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISSECURECONNECTION_OFFSET UNITYSDK_OFFSET(0x1B41EFD0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x1B41EF50)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x1B41EF30)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETKEY_OFFSET UNITYSDK_OFFSET(0x1B41EF80)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1B41EF60)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETVERSION_OFFSET UNITYSDK_OFFSET(0x1B41EF70)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_USER_OFFSET UNITYSDK_OFFSET(0x1B41EFA0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_WEBSOCKET_OFFSET UNITYSDK_OFFSET(0x1B41EFE0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B41EFF0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41EBE0)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int HttpListenerWebSocketContext_TypeDefinitionIndex = 3886;

	class HttpListenerWebSocketContext : public ::System::Net::WebSockets::WebSocketContext
	{
	public:
		::System::String* _origin; // 0x10
		::System::Collections::Generic::IEnumerable_1<::System::String*>* _secWebSocketProtocols; // 0x18
		::System::Security::Principal::IPrincipal* _user; // 0x20
		::System::Net::WebSockets::WebSocket* _webSocket; // 0x28
		::System::Net::CookieCollection* _cookieCollection; // 0x30
		::System::String* _secWebSocketKey; // 0x38
		::System::String* _secWebSocketVersion; // 0x40
		::System::Uri* _requestUri; // 0x48
		::System::Collections::Specialized::NameValueCollection* _headers; // 0x50
		::System::Boolean _isLocal; // 0x58
		::System::Boolean _isAuthenticated; // 0x59
		::System::Boolean _isSecureConnection; // 0x5A
