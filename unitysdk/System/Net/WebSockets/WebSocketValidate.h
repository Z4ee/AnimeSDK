...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWIFINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x1CC27420)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWPLATFORMNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1CC27A50)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEARRAYSEGMENT_OFFSET UNITYSDK_OFFSET(0x1CC27AA0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEBUFFER_OFFSET UNITYSDK_OFFSET(0x1CC27BB0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATECLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1CC277D0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATESUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1CC27550)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int WebSocketValidate_TypeDefinitionIndex = 3885;
