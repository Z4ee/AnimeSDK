...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWIFINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x1B773110)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWPLATFORMNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B773740)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEARRAYSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B773790)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B7738B0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATECLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1B7734C0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATESUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B773240)
