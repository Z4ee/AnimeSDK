...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ABORT_OFFSET UNITYSDK_OFFSET(0x1C1D5DF0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ALLOCATESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1C1D69D0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_1_OFFSET UNITYSDK_OFFSET(0x1C1D7AB0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_OFFSET UNITYSDK_OFFSET(0x1C1D6CC0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x1C1D5750)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D5490)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D5950)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEWITHRECEIVEERRORANDTHROWASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D73C0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_COMBINEMASKBYTES_OFFSET UNITYSDK_OFFSET(0x1C1D7880)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CONSUMEFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x1C1D7870)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEFROMCONNECTEDSTREAM_OFFSET UNITYSDK_OFFSET(0x1C1D4310)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEOPERATIONCANCELEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C1D6790)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSECORE_OFFSET UNITYSDK_OFFSET(0x1C1D48C0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C1D4810)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ENSUREBUFFERCONTAINSASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D7890)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C1D4A20)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1C1D4A10)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_RECEIVEASYNCLOCK_OFFSET UNITYSDK_OFFSET(0x1C1D4800)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATEUPDATELOCK_OFFSET UNITYSDK_OFFSET(0x1C1D47F0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1C1D4A30)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1C1D4A40)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDCLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D7140)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDPINGPONGASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D7210)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ISVALIDCLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1C1D7380)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x1C1D53A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D5060)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RELEASESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1C1D6950)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D4A50)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDCLOSEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D5C00)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D4DB0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEFALLBACKASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D6340)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMELOCKACQUIREDNONCANCELABLEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D5EC0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDKEEPALIVEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1C1D6E60)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_THROWIFOPERATIONINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1C1D4CE0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYPARSEMESSAGEHEADERFROMRECEIVEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C1D75E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYVALIDATEUTF8_OFFSET UNITYSDK_OFFSET(0x1C1D7BF0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEFRAMETOSENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1C1D6580)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1C1D6A40)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITERANDOMMASK_OFFSET UNITYSDK_OFFSET(0x1C1D70A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1D7E50)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1D43B0)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		{
			return (::System::Text::UTF8Encoding**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A48);
		}
		...
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A58);
		}
		...
		::System::Threading::Tasks::Task_1<::System::Net::WebSockets::WebSocketReceiveResult*>* _lastReceiveAsync; // 0x18
		::System::String* _subprotocol; // 0x20
		::System::Threading::SemaphoreSlim* _sendFrameAsyncLock; // 0x28
		::System::IO::Stream* _stream; // 0x30
		::Il2CppArray<::System::Byte>* _sendBuffer; // 0x38
		::System::Threading::Tasks::Task* _lastSendAsync; // 0x40
		::System::Net::WebSockets::ManagedWebSocket_Utf8MessageState* _utf8TextState; // 0x48
		::Il2CppArray<::System::Byte>* _receiveBuffer; // 0x50
		::System::String* _closeStatusDescription; // 0x58
		::System::Threading::Timer* _keepAliveTimer; // 0x60
		::System::Int32 _receivedMaskOffsetOffset; // 0x68
		::System::Int32 _receiveBufferOffset; // 0x6C
		::System::Nullable_1<::System::Net::WebSockets::WebSocketCloseStatus> _closeStatus; // 0x70
		::System::Net::WebSockets::ManagedWebSocket_MessageHeader _lastReceiveHeader; // 0x78
		::System::Boolean _receiveBufferFromPool; // 0x88
		::System::Boolean _disposed; // 0x89
		::System::Boolean _isServer; // 0x8A
		::System::Boolean _sentCloseFrame; // 0x8B
		::System::Int32 _receiveBufferCount; // 0x8C
		::System::Boolean _receivedCloseFrame; // 0x90
		::System::Boolean _lastSendWasFragment; // 0x91
		::System::Net::WebSockets::WebSocketState _state; // 0x94
