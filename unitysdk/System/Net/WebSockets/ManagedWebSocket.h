...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ABORT_OFFSET UNITYSDK_OFFSET(0x1D62B630)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ALLOCATESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1D62C210)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_1_OFFSET UNITYSDK_OFFSET(0x1D62D340)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_OFFSET UNITYSDK_OFFSET(0x1D62C510)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x1D62AF60)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62ACA0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x1D62B180)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEWITHRECEIVEERRORANDTHROWASYNC_OFFSET UNITYSDK_OFFSET(0x1D62CC20)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_COMBINEMASKBYTES_OFFSET UNITYSDK_OFFSET(0x1D62D110)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CONSUMEFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x1D62D100)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEFROMCONNECTEDSTREAM_OFFSET UNITYSDK_OFFSET(0x1D629B10)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEOPERATIONCANCELEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1D62BFD0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSECORE_OFFSET UNITYSDK_OFFSET(0x1D62A0D0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D62A020)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ENSUREBUFFERCONTAINSASYNC_OFFSET UNITYSDK_OFFSET(0x1D62D120)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D62A220)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1D62A210)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_RECEIVEASYNCLOCK_OFFSET UNITYSDK_OFFSET(0x1D62A010)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATEUPDATELOCK_OFFSET UNITYSDK_OFFSET(0x1D62A000)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1D62A230)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1D62A240)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDCLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62C9A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDPINGPONGASYNC_OFFSET UNITYSDK_OFFSET(0x1D62CA70)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ISVALIDCLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1D62CBE0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x1D62ABA0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62A850)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RELEASESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1D62C190)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1D62A250)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDCLOSEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62B430)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62A5B0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEFALLBACKASYNC_OFFSET UNITYSDK_OFFSET(0x1D62BB80)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMELOCKACQUIREDNONCANCELABLEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62B700)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDKEEPALIVEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1D62C6C0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_THROWIFOPERATIONINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1D62A4E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYPARSEMESSAGEHEADERFROMRECEIVEBUFFER_OFFSET UNITYSDK_OFFSET(0x1D62CE50)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYVALIDATEUTF8_OFFSET UNITYSDK_OFFSET(0x1D62D480)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEFRAMETOSENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1D62BDC0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1D62C280)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITERANDOMMASK_OFFSET UNITYSDK_OFFSET(0x1D62C900)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D62D6F0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D629BB0)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int ManagedWebSocket_TypeDefinitionIndex = 3872;
	...
	public:
		...
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A40);
		}
		static ::Il2CppArray<::System::Net::WebSockets::WebSocketState>** StaticGet_s_validCloseOutputStates()
		{
			return (::Il2CppArray<::System::Net::WebSockets::WebSocketState>**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A48);
		}
		...
		{
			return (::Il2CppArray<::System::Net::WebSockets::WebSocketState>**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A60);
		}
		static ::System::Text::UTF8Encoding** StaticGet_s_textEncoding()
		{
			return (::System::Text::UTF8Encoding**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A68);
		}
		...
		::System::Threading::Timer* _keepAliveTimer; // 0x10
		::System::Threading::SemaphoreSlim* _sendFrameAsyncLock; // 0x18
		::Il2CppArray<::System::Byte>* _receiveBuffer; // 0x20
		::System::Threading::CancellationTokenSource* _abortSource; // 0x28
		::System::Net::WebSockets::ManagedWebSocket_Utf8MessageState* _utf8TextState; // 0x30
		::Il2CppArray<::System::Byte>* _sendBuffer; // 0x38
		::System::String* _closeStatusDescription; // 0x40
		::System::Threading::Tasks::Task_1<::System::Net::WebSockets::WebSocketReceiveResult*>* _lastReceiveAsync; // 0x48
		::System::String* _subprotocol; // 0x50
		::System::IO::Stream* _stream; // 0x58
		::System::Threading::Tasks::Task* _lastSendAsync; // 0x60
		::System::Int32 _receivedMaskOffsetOffset; // 0x68
		::System::Int32 _receiveBufferCount; // 0x6C
		::System::Nullable_1<::System::Net::WebSockets::WebSocketCloseStatus> _closeStatus; // 0x70
		::System::Net::WebSockets::WebSocketState _state; // 0x78
		::System::Boolean _receiveBufferFromPool; // 0x7C
		::System::Boolean _isServer; // 0x7D
		::System::Net::WebSockets::ManagedWebSocket_MessageHeader _lastReceiveHeader; // 0x80
		::System::Boolean _lastSendWasFragment; // 0x90
		::System::Boolean _disposed; // 0x91
		::System::Boolean _sentCloseFrame; // 0x92
		::System::Boolean _receivedCloseFrame; // 0x93
		::System::Int32 _receiveBufferOffset; // 0x94
