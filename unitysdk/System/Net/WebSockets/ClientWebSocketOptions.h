...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_ADDSUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B1D62E0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1B1D6600)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B1D60C0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1B1D6260)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1B1D5FC0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_KEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B1D6480)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x1B1D6040)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B1D65E0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_REQUESTEDSUBPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1B1D5F30)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_REQUESTHEADERS_OFFSET UNITYSDK_OFFSET(0x1B1D5F20)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B1D65F0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1B1D5F40)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1B1D67C0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1B1D6620)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x1B1D5E20)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETTOREADONLY_OFFSET UNITYSDK_OFFSET(0x1B1D69D0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B1D61A0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1B1D6270)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1B1D5FD0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_KEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B1D6490)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x1B1D6050)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1B1D5F50)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_THROWIFREADONLY_OFFSET UNITYSDK_OFFSET(0x1B1D5EB0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D5CA0)
...
namespace System::Net::WebSockets
{
	...
	{
	public:
		::System::Nullable_1<::System::ArraySegment_1<::System::Byte>> _buffer; // 0x10
		::System::Net::ICredentials* _credentials; // 0x28
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* _clientCertificates; // 0x30
		::System::Net::CookieContainer* _cookies; // 0x38
		::System::Net::WebHeaderCollection* _requestHeaders; // 0x40
		::System::Net::IWebProxy* _proxy; // 0x48
		::System::Collections::Generic::List_1<::System::String*>* _requestedSubProtocols; // 0x50
		::System::Int32 _sendBufferSize; // 0x58
		::System::Boolean _useDefaultCredentials; // 0x5C
		::System::Boolean _isReadOnly; // 0x5D
		::System::Int32 _receiveBufferSize; // 0x60
		::System::TimeSpan _keepAliveInterval; // 0x68
