...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_ADDSUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x18FC81B0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x18FC84D0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x18FC7F90)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x18FC8130)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FC7E90)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_KEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x18FC8350)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x18FC7F10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18FC84B0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_REQUESTEDSUBPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x18FC7E00)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_REQUESTHEADERS_OFFSET UNITYSDK_OFFSET(0x18FC7DF0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18FC84C0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FC7E10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x18FC8690)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x18FC84F0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x18FC7CF0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETTOREADONLY_OFFSET UNITYSDK_OFFSET(0x18FC88A0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x18FC8070)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x18FC8140)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FC7EA0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_KEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x18FC8360)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x18FC7F20)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FC7E20)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_THROWIFREADONLY_OFFSET UNITYSDK_OFFSET(0x18FC7D80)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC7B70)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* _clientCertificates; // 0x38
		...
		::System::Net::CookieContainer* _cookies; // 0x50
		::System::Boolean _useDefaultCredentials; // 0x58
		::System::Boolean _isReadOnly; // 0x59
		::System::TimeSpan _keepAliveInterval; // 0x60
		::System::Int32 _receiveBufferSize; // 0x68
		::System::Int32 _sendBufferSize; // 0x6C
