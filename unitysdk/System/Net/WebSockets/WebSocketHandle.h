...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_ABORT_OFFSET UNITYSDK_OFFSET(0x1E299620)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_BUILDREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x1E299A60)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CHECKPLATFORMSUPPORT_OFFSET UNITYSDK_OFFSET(0x1E2995F0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1E299700)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x1E299730)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CONNECTASYNCCORE_OFFSET UNITYSDK_OFFSET(0x1E299760)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CONNECTSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x1E299940)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CREATESECKEYANDSECWEBSOCKETACCEPT_OFFSET UNITYSDK_OFFSET(0x1E29A1B0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E299480)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E299600)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1E299590)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1E299570)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1E2995B0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1E2995D0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E299560)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_PARSEANDVALIDATECONNECTRESPONSEASYNC_OFFSET UNITYSDK_OFFSET(0x1E29A4B0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_READRESPONSEHEADERLINEASYNC_OFFSET UNITYSDK_OFFSET(0x1E29A6B0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1E2996C0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1E299670)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_VALIDATEANDTRACKHEADER_OFFSET UNITYSDK_OFFSET(0x1E29A5A0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E29A780)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E299500)
