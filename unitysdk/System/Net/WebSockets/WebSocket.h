...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTBUFFER_OFFSET UNITYSDK_OFFSET(0x1DD2D430)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTWEBSOCKET_OFFSET UNITYSDK_OFFSET(0x1DD2D790)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATESERVERBUFFER_OFFSET UNITYSDK_OFFSET(0x1DD2D5F0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_GET_DEFAULTKEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1DD2D2F0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISAPPLICATIONTARGETING45_OFFSET UNITYSDK_OFFSET(0x1DD2D730)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISSTATETERMINAL_OFFSET UNITYSDK_OFFSET(0x1DD2D420)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_REGISTERPREFIXES_OFFSET UNITYSDK_OFFSET(0x1DD2D740)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_THROWONINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x1DD2D330)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2DAB0)
