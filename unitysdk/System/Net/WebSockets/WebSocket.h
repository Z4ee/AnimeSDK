...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTBUFFER_OFFSET UNITYSDK_OFFSET(0x1A587DD0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTWEBSOCKET_OFFSET UNITYSDK_OFFSET(0x1A588130)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATESERVERBUFFER_OFFSET UNITYSDK_OFFSET(0x1A587F90)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_GET_DEFAULTKEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A587C90)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISAPPLICATIONTARGETING45_OFFSET UNITYSDK_OFFSET(0x1A5880D0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISSTATETERMINAL_OFFSET UNITYSDK_OFFSET(0x1A587DC0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_REGISTERPREFIXES_OFFSET UNITYSDK_OFFSET(0x1A5880E0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_THROWONINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x1A587CD0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A588450)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int WebSocket_TypeDefinitionIndex = 3899;
