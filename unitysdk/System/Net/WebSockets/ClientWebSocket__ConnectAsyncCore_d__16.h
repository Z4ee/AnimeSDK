...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET__CONNECTASYNCCORE_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9BCE50)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET__CONNECTASYNCCORE_D__16_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x34D440)
