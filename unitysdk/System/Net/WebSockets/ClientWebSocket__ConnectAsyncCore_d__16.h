...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET__CONNECTASYNCCORE_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8C4FE0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKET__CONNECTASYNCCORE_D__16_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x390820)

namespace System::Net::WebSockets
{
	inline static constexpr unsigned int ClientWebSocket__ConnectAsyncCore_d__16_TypeDefinitionIndex = 3890;
	...
	struct alignas(8) ClientWebSocket__ConnectAsyncCore_d__16
	{
		...
		::System::Net::WebSockets::ClientWebSocket* __4__this; // 0x40
