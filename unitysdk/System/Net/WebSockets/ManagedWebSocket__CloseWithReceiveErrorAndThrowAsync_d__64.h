...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CLOSEWITHRECEIVEERRORANDTHROWASYNC_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x938F30)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CLOSEWITHRECEIVEERRORANDTHROWASYNC_D__64_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x646640)
...
namespace System::Net::WebSockets
{
	...
	{
		::System::Exception* innerException; // 0x10
		...
		::System::Net::WebSockets::WebSocketCloseStatus closeStatus; // 0x54
		::System::Net::WebSockets::WebSocketError error; // 0x58
