...
#define SYSTEM_NET_GLOBALLOG_ADDTOARRAY_OFFSET UNITYSDK_OFFSET(0x1C894490)
#define SYSTEM_NET_GLOBALLOG_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x1C894540)
#define SYSTEM_NET_GLOBALLOG_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x1C894550)
#define SYSTEM_NET_GLOBALLOG_ASSERT_OFFSET UNITYSDK_OFFSET(0x1C8944F0)
#define SYSTEM_NET_GLOBALLOG_DUMPARRAY_OFFSET UNITYSDK_OFFSET(0x1C8945F0)
#define SYSTEM_NET_GLOBALLOG_DUMP_1_OFFSET UNITYSDK_OFFSET(0x1C894610)
#define SYSTEM_NET_GLOBALLOG_DUMP_2_OFFSET UNITYSDK_OFFSET(0x1C894620)
#define SYSTEM_NET_GLOBALLOG_DUMP_3_OFFSET UNITYSDK_OFFSET(0x1C894630)
#define SYSTEM_NET_GLOBALLOG_DUMP_OFFSET UNITYSDK_OFFSET(0x1C894600)
#define SYSTEM_NET_GLOBALLOG_ENTER_1_OFFSET UNITYSDK_OFFSET(0x1C8944E0)
#define SYSTEM_NET_GLOBALLOG_ENTER_OFFSET UNITYSDK_OFFSET(0x1C8944D0)
#define SYSTEM_NET_GLOBALLOG_GET_CURRENTTHREADKIND_OFFSET UNITYSDK_OFFSET(0x1C8943F0)
#define SYSTEM_NET_GLOBALLOG_IGNORE_OFFSET UNITYSDK_OFFSET(0x1C8944A0)
#define SYSTEM_NET_GLOBALLOG_LEAVEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C8945A0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_1_OFFSET UNITYSDK_OFFSET(0x1C8945C0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_2_OFFSET UNITYSDK_OFFSET(0x1C8945D0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_3_OFFSET UNITYSDK_OFFSET(0x1C8945E0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_OFFSET UNITYSDK_OFFSET(0x1C8945B0)
#define SYSTEM_NET_GLOBALLOG_LOGGINGINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C8943B0)
#define SYSTEM_NET_GLOBALLOG_PRINTHEX_OFFSET UNITYSDK_OFFSET(0x1C8944C0)
#define SYSTEM_NET_GLOBALLOG_PRINT_OFFSET UNITYSDK_OFFSET(0x1C8944B0)
#define SYSTEM_NET_GLOBALLOG_SETTHREADSOURCE_OFFSET UNITYSDK_OFFSET(0x1C894400)
#define SYSTEM_NET_GLOBALLOG_THREADCONTRACT_1_OFFSET UNITYSDK_OFFSET(0x1C894420)
#define SYSTEM_NET_GLOBALLOG_THREADCONTRACT_OFFSET UNITYSDK_OFFSET(0x1C894410)
#define SYSTEM_NET_GLOBALLOG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C894640)
