...
#define SYSTEM_NET_FILEWEBRESPONSE_CHECKDISPOSED_OFFSET UNITYSDK_OFFSET(0x1A327970)
#define SYSTEM_NET_FILEWEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A327A90)
#define SYSTEM_NET_FILEWEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A3277A0)
#define SYSTEM_NET_FILEWEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1A327CB0)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A327950)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A327A00)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1A327A40)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x1A327A70)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_SUPPORTSHEADERS_OFFSET UNITYSDK_OFFSET(0x1A327A60)
#define SYSTEM_NET_FILEWEBRESPONSE_SYSTEM_NET_ICLOSEEX_CLOSEEX_OFFSET UNITYSDK_OFFSET(0x1A327B50)
#define SYSTEM_NET_FILEWEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A327780)
#define SYSTEM_NET_FILEWEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3275D0)
#define SYSTEM_NET_FILEWEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A327250)

namespace System::Net
{
	inline static constexpr unsigned int FileWebResponse_TypeDefinitionIndex = 3431;
	...
	public:
		...
		::System::Net::WebHeaderCollection* m_headers; // 0x30
