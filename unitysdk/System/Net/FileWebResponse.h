...
#define SYSTEM_NET_FILEWEBRESPONSE_CHECKDISPOSED_OFFSET UNITYSDK_OFFSET(0x186D22F0)
#define SYSTEM_NET_FILEWEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x186D23C0)
#define SYSTEM_NET_FILEWEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x186D2130)
#define SYSTEM_NET_FILEWEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x186D2640)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x186D22D0)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x186D2380)
#define SYSTEM_NET_FILEWEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x186D23A0)
#define SYSTEM_NET_FILEWEBRESPONSE_SYSTEM_NET_ICLOSEEX_CLOSEEX_OFFSET UNITYSDK_OFFSET(0x186D2480)
#define SYSTEM_NET_FILEWEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x186D2110)
#define SYSTEM_NET_FILEWEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x186D1FC0)
#define SYSTEM_NET_FILEWEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x186D13B0)

namespace System::Net
{
	inline static constexpr unsigned int FileWebResponse_TypeDefinitionIndex = 2799;
