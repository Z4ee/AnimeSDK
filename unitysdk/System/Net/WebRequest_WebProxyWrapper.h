...
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPER_GET_WEBPROXY_OFFSET UNITYSDK_OFFSET(0x1B98E240)

namespace System::Net
{
	inline static constexpr unsigned int WebRequest_WebProxyWrapper_TypeDefinitionIndex = 2769;
