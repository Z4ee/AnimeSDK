...
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS241_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19234AD0)
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS241_0__UPLOADFILETASKASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x19235E50)

namespace System::Net
{
	inline static constexpr unsigned int WebClient___c__DisplayClass241_0_TypeDefinitionIndex = 3455;
	...
	public:
		...
		::System::Net::UploadFileCompletedEventHandler* handler; // 0x20
