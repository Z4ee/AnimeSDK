...
#define SYSTEM_NET_SOCKETPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x1C710EF0)
#define SYSTEM_NET_SOCKETPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1C711060)
#define SYSTEM_NET_SOCKETPERMISSION_FROMXML_1_OFFSET UNITYSDK_OFFSET(0x1C713280)
#define SYSTEM_NET_SOCKETPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1C712CB0)
#define SYSTEM_NET_SOCKETPERMISSION_GET_ACCEPTLIST_OFFSET UNITYSDK_OFFSET(0x1C711000)
#define SYSTEM_NET_SOCKETPERMISSION_GET_CONNECTLIST_OFFSET UNITYSDK_OFFSET(0x1C711030)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECTEMPTY_OFFSET UNITYSDK_OFFSET(0x1C7115A0)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x1C711610)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1C7112D0)
#define SYSTEM_NET_SOCKETPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x1C712080)
#define SYSTEM_NET_SOCKETPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1C711EE0)
#define SYSTEM_NET_SOCKETPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1C712750)
#define SYSTEM_NET_SOCKETPERMISSION_TOXML_1_OFFSET UNITYSDK_OFFSET(0x1C7128D0)
#define SYSTEM_NET_SOCKETPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1C712760)
#define SYSTEM_NET_SOCKETPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1C713920)
#define SYSTEM_NET_SOCKETPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C710CB0)
#define SYSTEM_NET_SOCKETPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C710B80)
