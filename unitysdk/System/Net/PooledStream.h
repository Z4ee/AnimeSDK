...
#define SYSTEM_NET_POOLEDSTREAM_ACTIVATE_1_OFFSET UNITYSDK_OFFSET(0x1C4A2570)
#define SYSTEM_NET_POOLEDSTREAM_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1C4A2550)
#define SYSTEM_NET_POOLEDSTREAM_BEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A30D0)
#define SYSTEM_NET_POOLEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1C4A2FD0)
#define SYSTEM_NET_POOLEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A3050)
#define SYSTEM_NET_POOLEDSTREAM_CHECKLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C4A26F0)
#define SYSTEM_NET_POOLEDSTREAM_CLOSESOCKET_OFFSET UNITYSDK_OFFSET(0x1C4A2ED0)
#define SYSTEM_NET_POOLEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C4A2F20)
#define SYSTEM_NET_POOLEDSTREAM_CONNECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C4A2740)
#define SYSTEM_NET_POOLEDSTREAM_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1C4A2690)
#define SYSTEM_NET_POOLEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4A2E20)
#define SYSTEM_NET_POOLEDSTREAM_ENDMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A3100)
#define SYSTEM_NET_POOLEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1C4A3030)
#define SYSTEM_NET_POOLEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A30B0)
#define SYSTEM_NET_POOLEDSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x1C4A3140)
#define SYSTEM_NET_POOLEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C4A3130)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANBEPOOLED_OFFSET UNITYSDK_OFFSET(0x1C4A2350)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1C4A2C50)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1C4A2C70)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C4A2CA0)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A2C80)
#define SYSTEM_NET_POOLEDSTREAM_GET_ISEMANCIPATED_OFFSET UNITYSDK_OFFSET(0x1C4A23D0)
#define SYSTEM_NET_POOLEDSTREAM_GET_ISINITALIZING_OFFSET UNITYSDK_OFFSET(0x1C4A2340)
#define SYSTEM_NET_POOLEDSTREAM_GET_JUSTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1C4A2320)
#define SYSTEM_NET_POOLEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1C4A2D30)
#define SYSTEM_NET_POOLEDSTREAM_GET_NETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x1C4A2C10)
#define SYSTEM_NET_POOLEDSTREAM_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1C4A2410)
#define SYSTEM_NET_POOLEDSTREAM_GET_POOL_OFFSET UNITYSDK_OFFSET(0x1C4A2520)
#define SYSTEM_NET_POOLEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C4A2D50)
#define SYSTEM_NET_POOLEDSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C4A2CB0)
#define SYSTEM_NET_POOLEDSTREAM_GET_SERVERADDRESS_OFFSET UNITYSDK_OFFSET(0x1C4A2330)
#define SYSTEM_NET_POOLEDSTREAM_GET_SERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x1C4A2530)
#define SYSTEM_NET_POOLEDSTREAM_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x1C4A2C30)
#define SYSTEM_NET_POOLEDSTREAM_GET_USINGSECURESTREAM_OFFSET UNITYSDK_OFFSET(0x1C4A2C00)
#define SYSTEM_NET_POOLEDSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C4A2CF0)
#define SYSTEM_NET_POOLEDSTREAM_MULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A2DF0)
#define SYSTEM_NET_POOLEDSTREAM_POLLREAD_OFFSET UNITYSDK_OFFSET(0x1C4A3290)
#define SYSTEM_NET_POOLEDSTREAM_POLL_OFFSET UNITYSDK_OFFSET(0x1C4A3270)
#define SYSTEM_NET_POOLEDSTREAM_POSTPOP_OFFSET UNITYSDK_OFFSET(0x1C4A2A30)
#define SYSTEM_NET_POOLEDSTREAM_PREPUSH_OFFSET UNITYSDK_OFFSET(0x1C4A2880)
#define SYSTEM_NET_POOLEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C4A2DB0)
#define SYSTEM_NET_POOLEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1C4A2D90)
#define SYSTEM_NET_POOLEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C4A31B0)
#define SYSTEM_NET_POOLEDSTREAM_SETSOCKETTIMEOUTOPTION_OFFSET UNITYSDK_OFFSET(0x1C4A31D0)
#define SYSTEM_NET_POOLEDSTREAM_SET_CANBEPOOLED_OFFSET UNITYSDK_OFFSET(0x1C4A23C0)
#define SYSTEM_NET_POOLEDSTREAM_SET_NETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x1C4A2C20)
#define SYSTEM_NET_POOLEDSTREAM_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x1C4A2450)
#define SYSTEM_NET_POOLEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C4A2D70)
#define SYSTEM_NET_POOLEDSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C4A2CD0)
#define SYSTEM_NET_POOLEDSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C4A2D10)
#define SYSTEM_NET_POOLEDSTREAM_UNSAFEBEGINREAD_OFFSET UNITYSDK_OFFSET(0x1C4A2FF0)
#define SYSTEM_NET_POOLEDSTREAM_UNSAFEBEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1C4A3070)
#define SYSTEM_NET_POOLEDSTREAM_UPDATELIFETIME_OFFSET UNITYSDK_OFFSET(0x1C4A2850)
#define SYSTEM_NET_POOLEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1C4A2DD0)
#define SYSTEM_NET_POOLEDSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4A2210)
#define SYSTEM_NET_POOLEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A20E0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::GeneralAsyncDelegate* m_AsyncCallback; // 0x38
		::System::Net::IPAddress* m_ServerAddress; // 0x40
		::System::Net::Sockets::NetworkStream* m_NetworkStream; // 0x48
		::System::Net::Sockets::Socket* m_AbortSocket; // 0x50
		::System::Net::Sockets::Socket* m_AbortSocket6; // 0x58
		::System::Boolean m_CheckLifetime; // 0x60
		::System::Boolean m_JustConnected; // 0x61
		::System::Boolean m_ConnectionIsDoomed; // 0x62
		::System::Boolean m_Initalizing; // 0x63
		::System::Int32 m_PooledCount; // 0x64
		::System::TimeSpan m_Lifetime; // 0x68
