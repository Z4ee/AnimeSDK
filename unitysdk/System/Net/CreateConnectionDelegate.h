...
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19EEBEF0)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19EEBF20)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19EEB9B0)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEB9A0)

namespace System::Net
{
	inline static constexpr unsigned int CreateConnectionDelegate_TypeDefinitionIndex = 3408;
