...
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D6A6A80)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D6A6AB0)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D6A6560)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A6540)
