...
#define SYSTEM_NET_EMPTYWEBPROXY_GETPROXY_OFFSET UNITYSDK_OFFSET(0x1D471A20)
#define SYSTEM_NET_EMPTYWEBPROXY_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1D471A40)
#define SYSTEM_NET_EMPTYWEBPROXY_ISBYPASSED_OFFSET UNITYSDK_OFFSET(0x1D471A30)
#define SYSTEM_NET_EMPTYWEBPROXY_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1D471A50)
#define SYSTEM_NET_EMPTYWEBPROXY_SYSTEM_NET_IAUTOWEBPROXY_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x1D471A60)
#define SYSTEM_NET_EMPTYWEBPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D471A10)

namespace System::Net
{
	inline static constexpr unsigned int EmptyWebProxy_TypeDefinitionIndex = 3405;
