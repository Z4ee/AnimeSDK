...
#define SYSTEM_NET_SERVERCERTVALIDATIONCALLBACK_CALLBACKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x187047D0)

namespace System::Net
{
	inline static constexpr unsigned int ServerCertValidationCallback_CallbackContext_TypeDefinitionIndex = 2809;

	class ServerCertValidationCallback_CallbackContext : public ::System::Object
	{
	public:
		::System::Object* request; // 0x10
		::System::Security::Cryptography::X509Certificates::X509Chain* chain; // 0x18
