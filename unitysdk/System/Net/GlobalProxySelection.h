...
#define SYSTEM_NET_GLOBALPROXYSELECTION_GETEMPTYWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1E7E3170)
#define SYSTEM_NET_GLOBALPROXYSELECTION_GET_SELECT_OFFSET UNITYSDK_OFFSET(0x1E7E3040)
#define SYSTEM_NET_GLOBALPROXYSELECTION_SET_SELECT_OFFSET UNITYSDK_OFFSET(0x1E7E31B0)
#define SYSTEM_NET_GLOBALPROXYSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E3250)
