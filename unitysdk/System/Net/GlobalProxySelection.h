...
#define SYSTEM_NET_GLOBALPROXYSELECTION_GETEMPTYWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1D458640)
#define SYSTEM_NET_GLOBALPROXYSELECTION_GET_SELECT_OFFSET UNITYSDK_OFFSET(0x1D458510)
#define SYSTEM_NET_GLOBALPROXYSELECTION_SET_SELECT_OFFSET UNITYSDK_OFFSET(0x1D458680)
#define SYSTEM_NET_GLOBALPROXYSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D458720)

namespace System::Net
{
	inline static constexpr unsigned int GlobalProxySelection_TypeDefinitionIndex = 3273;
