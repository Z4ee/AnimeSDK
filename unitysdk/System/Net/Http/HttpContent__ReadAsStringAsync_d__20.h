...
#define SYSTEM_NET_HTTP_HTTPCONTENT__READASSTRINGASYNC_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x38690E0)
#define SYSTEM_NET_HTTP_HTTPCONTENT__READASSTRINGASYNC_D__20_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x38690F0)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpContent__ReadAsStringAsync_d__20_TypeDefinitionIndex = 3755;
