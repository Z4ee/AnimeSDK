...
#define SYSTEM_NET_HTTP_HTTPCONTENT__READASBYTEARRAYASYNC_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA3EB40)
#define SYSTEM_NET_HTTP_HTTPCONTENT__READASBYTEARRAYASYNC_D__19_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x34D440)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpContent__ReadAsByteArrayAsync_d__19_TypeDefinitionIndex = 26688;
