...
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E7E44A0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E7E4660)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_GET_DATE_OFFSET UNITYSDK_OFFSET(0x1E7E43B0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_GET_ENTITYTAG_OFFSET UNITYSDK_OFFSET(0x1E7E43E0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_SET_DATE_OFFSET UNITYSDK_OFFSET(0x1E7E43D0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_SET_ENTITYTAG_OFFSET UNITYSDK_OFFSET(0x1E7E43F0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1E7E4400)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E7E4AB0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1E7E4770)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7E4340)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E4320)
