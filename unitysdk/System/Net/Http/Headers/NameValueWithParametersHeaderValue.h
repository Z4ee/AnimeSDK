...
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0190F0)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0192B0)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B019000)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0190A0)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B019300)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_TRYPARSEELEMENT_OFFSET UNITYSDK_OFFSET(0x1B0194A0)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1B019420)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B019090)
#define SYSTEM_NET_HTTP_HEADERS_NAMEVALUEWITHPARAMETERSHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B018DD0)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int NameValueWithParametersHeaderValue_TypeDefinitionIndex = 24755;
