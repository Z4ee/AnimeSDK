...
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E790A00)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E790B20)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_GET_RANGES_OFFSET UNITYSDK_OFFSET(0x1E790930)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_GET_UNIT_OFFSET UNITYSDK_OFFSET(0x1E7909A0)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1E7909B0)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E791440)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1E790C10)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E790690)
#define SYSTEM_NET_HTTP_HEADERS_RANGEHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E790680)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int RangeHeaderValue_TypeDefinitionIndex = 3822;
