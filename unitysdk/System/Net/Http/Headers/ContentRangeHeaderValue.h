...
#define SYSTEM_NET_HTTP_HEADERS_CONTENTRANGEHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D486CC0)
#define SYSTEM_NET_HTTP_HEADERS_CONTENTRANGEHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D486D90)
#define SYSTEM_NET_HTTP_HEADERS_CONTENTRANGEHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1D486C20)
#define SYSTEM_NET_HTTP_HEADERS_CONTENTRANGEHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D487610)
#define SYSTEM_NET_HTTP_HEADERS_CONTENTRANGEHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1D486F20)
#define SYSTEM_NET_HTTP_HEADERS_CONTENTRANGEHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D486BE0)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int ContentRangeHeaderValue_TypeDefinitionIndex = 26131;
