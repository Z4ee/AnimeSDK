...
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F63D20)
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING____GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F63FC0)
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F64020)
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F63FD0)
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F63CF0)
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x19F630D0)
#define SYSTEM_NET_HTTP_HEADERS_HTTPHEADERS__GETENUMERATOR_D__19___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x19F63D10)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int HttpHeaders__GetEnumerator_d__19_TypeDefinitionIndex = 4816;

	class HttpHeaders__GetEnumerator_d__19 : public ::System::Object
	{
	public:
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::System::Collections::Generic::IEnumerable_1<::System::String*>*> __2__current; // 0x10
		::System::Net::Http::Headers::HttpHeaders* __4__this; // 0x20
