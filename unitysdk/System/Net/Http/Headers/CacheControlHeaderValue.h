...
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E838750)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E838920)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1E838110)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GET_NOCACHEHEADERS_OFFSET UNITYSDK_OFFSET(0x1E8381A0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GET_PRIVATEHEADERS_OFFSET UNITYSDK_OFFSET(0x1E838230)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1E8382C0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E8399F0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1E838B00)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E839890)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int CacheControlHeaderValue_TypeDefinitionIndex = 26699;
	...
	public:
		...
		::System::Boolean _MaxStale_k__BackingField; // 0x28
		::System::Boolean _OnlyIfCached_k__BackingField; // 0x29
		::System::Nullable_1<::System::TimeSpan> _MaxStaleLimit_k__BackingField; // 0x30
		::System::Nullable_1<::System::TimeSpan> _MinFresh_k__BackingField; // 0x40
		::System::Nullable_1<::System::TimeSpan> _SharedMaxAge_k__BackingField; // 0x50
		::System::Nullable_1<::System::TimeSpan> _MaxAge_k__BackingField; // 0x60
		::System::Boolean _NoStore_k__BackingField; // 0x70
		::System::Boolean _MustRevalidate_k__BackingField; // 0x71
		::System::Boolean _ProxyRevalidate_k__BackingField; // 0x72
		::System::Boolean _NoCache_k__BackingField; // 0x73
		::System::Boolean _Private_k__BackingField; // 0x74
		::System::Boolean _NoTransform_k__BackingField; // 0x75
		::System::Boolean _Public_k__BackingField; // 0x76
