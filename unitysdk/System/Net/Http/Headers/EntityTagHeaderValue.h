...
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D4878F0)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D4879A0)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1D487850)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D487E70)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_TRYPARSEELEMENT_OFFSET UNITYSDK_OFFSET(0x1D487AD0)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_TRYPARSE_1_OFFSET UNITYSDK_OFFSET(0x1D487DF0)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1D487A30)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D487EC0)
#define SYSTEM_NET_HTTP_HEADERS_ENTITYTAGHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D487840)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int EntityTagHeaderValue_TypeDefinitionIndex = 26132;
	...
	public:
		...
		{
			return (::System::Net::Http::Headers::EntityTagHeaderValue**)Il2CppClass::FromTypeDefinitionIndex(EntityTagHeaderValue_TypeDefinitionIndex)->GetStaticField(0x1FEA0);
		}
