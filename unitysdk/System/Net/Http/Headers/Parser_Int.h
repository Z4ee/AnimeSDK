...
#define SYSTEM_NET_HTTP_HEADERS_PARSER_INT_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1852C260)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int Parser_Int_TypeDefinitionIndex = 4826;
