...
#define SYSTEM_NET_HTTP_HEADERS_PARSER_LONG_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1D490440)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int Parser_Long_TypeDefinitionIndex = 26163;
