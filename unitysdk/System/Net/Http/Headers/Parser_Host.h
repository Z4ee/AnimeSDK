...
#define SYSTEM_NET_HTTP_HEADERS_PARSER_HOST_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x19F66FD0)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int Parser_Host_TypeDefinitionIndex = 4833;
