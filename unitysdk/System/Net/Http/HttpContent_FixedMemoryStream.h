...
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM_CHECKOVERFLOW_OFFSET UNITYSDK_OFFSET(0x1E79B290)
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1E79B3D0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1E79B4B0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79A0D0)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpContent_FixedMemoryStream_TypeDefinitionIndex = 3765;
