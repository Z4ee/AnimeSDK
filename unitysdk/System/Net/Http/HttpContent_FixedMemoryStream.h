...
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM_CHECKOVERFLOW_OFFSET UNITYSDK_OFFSET(0x1B026410)
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B026540)
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B026570)
#define SYSTEM_NET_HTTP_HTTPCONTENT_FIXEDMEMORYSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B024B90)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpContent_FixedMemoryStream_TypeDefinitionIndex = 24713;
