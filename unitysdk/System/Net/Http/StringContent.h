...
#define SYSTEM_NET_HTTP_STRINGCONTENT_GETBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1CAAA750)
#define SYSTEM_NET_HTTP_STRINGCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAAA460)

namespace System::Net::Http
{
	inline static constexpr unsigned int StringContent_TypeDefinitionIndex = 3767;
