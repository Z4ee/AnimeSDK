...
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x22CEB70)
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x22ACB50)
...
namespace System::Net::Http
{
	...
	{
		::System::Net::Http::HttpResponseMessage* _response_5__1; // 0x10
		...
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Net::Http::HttpResponseMessage*> __t__builder; // 0x40
		::System::Net::Http::HttpRequestMessage* request; // 0x58
		::System::Net::Http::HttpClient* __4__this; // 0x60
