...
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9F0140)
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x3891F0)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpClient__SendAsyncWorker_d__47_TypeDefinitionIndex = 26107;
	...
	struct alignas(8) HttpClient__SendAsyncWorker_d__47
	{
		...
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage*> __u__1; // 0x28
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter __u__2; // 0x38
		...
		::System::Net::Http::HttpResponseMessage* _response_5__1; // 0x60
		::System::Threading::CancellationTokenSource* _lcts_5__2; // 0x68
		::System::Net::Http::HttpCompletionOption completionOption; // 0x70
