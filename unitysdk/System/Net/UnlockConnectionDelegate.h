...
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CED6A00)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CED6A30)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CED6760)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED6740)
