...
#define SYSTEM_NET_DNS_GETHOSTENTRYNAMECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C702530)
#define SYSTEM_NET_DNS_GETHOSTENTRYNAMECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C702560)
#define SYSTEM_NET_DNS_GETHOSTENTRYNAMECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C702010)
#define SYSTEM_NET_DNS_GETHOSTENTRYNAMECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C701FF0)

namespace System::Net
{
	inline static constexpr unsigned int Dns_GetHostEntryNameCallback_TypeDefinitionIndex = 3504;
