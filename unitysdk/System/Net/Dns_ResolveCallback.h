...
#define SYSTEM_NET_DNS_RESOLVECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D6A8880)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D6A88B0)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D6A8360)
#define SYSTEM_NET_DNS_RESOLVECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A8340)

namespace System::Net
{
	inline static constexpr unsigned int Dns_ResolveCallback_TypeDefinitionIndex = 3503;
