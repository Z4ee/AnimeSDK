...
#define SYSTEM_NET_DNS_RESOLVECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2E7980)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2E79B0)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2E7440)
#define SYSTEM_NET_DNS_RESOLVECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E7420)
