...
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_DECODEUTF8FROMSTRING_OFFSET UNITYSDK_OFFSET(0x1D629840)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1D629620)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1D629730)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1D629640)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETSTRING_1_OFFSET UNITYSDK_OFFSET(0x1D6294C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1D629490)
