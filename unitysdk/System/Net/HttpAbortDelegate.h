...
#define SYSTEM_NET_HTTPABORTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E5E30)
#define SYSTEM_NET_HTTPABORTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E5E70)
#define SYSTEM_NET_HTTPABORTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E5890)
#define SYSTEM_NET_HTTPABORTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E5880)

namespace System::Net
{
	inline static constexpr unsigned int HttpAbortDelegate_TypeDefinitionIndex = 3316;
