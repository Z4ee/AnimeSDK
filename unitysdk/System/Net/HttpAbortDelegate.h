...
#define SYSTEM_NET_HTTPABORTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CAF9980)
#define SYSTEM_NET_HTTPABORTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CAF99C0)
#define SYSTEM_NET_HTTPABORTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CAF93F0)
#define SYSTEM_NET_HTTPABORTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAF93D0)
