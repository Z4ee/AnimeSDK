...
#define SYSTEM_NET_HTTPCONTINUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CAF9D50)
#define SYSTEM_NET_HTTPCONTINUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CAF9DD0)
#define SYSTEM_NET_HTTPCONTINUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CAF9A10)
#define SYSTEM_NET_HTTPCONTINUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAF99F0)

namespace System::Net
{
	inline static constexpr unsigned int HttpContinueDelegate_TypeDefinitionIndex = 3317;
