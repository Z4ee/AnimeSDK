...
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE98F0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE9920)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE93B0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE93A0)

namespace System::Net
{
	inline static constexpr unsigned int TrackingValidationObjectDictionary_ValidateAndParseValue_TypeDefinitionIndex = 3441;
