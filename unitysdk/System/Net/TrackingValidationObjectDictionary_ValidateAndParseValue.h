...
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D460390)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D4603C0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D45FE50)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D45FE30)
