...
#define SYSTEM_NET_COOKIEEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C87FCC0)
#define SYSTEM_NET_COOKIEEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C87FCA0)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C87FB30)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C87FBC0)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C87FC50)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C87FA70)
