...
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAYTOCONSOLE_OFFSET UNITYSDK_OFFSET(0x1A7E30F0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAYTOFILE_OFFSET UNITYSDK_OFFSET(0x1A7E3120)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAY_OFFSET UNITYSDK_OFFSET(0x1A7E3110)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_1_OFFSET UNITYSDK_OFFSET(0x1A7E3170)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_2_OFFSET UNITYSDK_OFFSET(0x1A7E3180)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_3_OFFSET UNITYSDK_OFFSET(0x1A7E3190)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_OFFSET UNITYSDK_OFFSET(0x1A7E3160)
#define SYSTEM_NET_BASELOGGINGOBJECT_ENTERFUNC_OFFSET UNITYSDK_OFFSET(0x1A7E30D0)
#define SYSTEM_NET_BASELOGGINGOBJECT_FLUSH_1_OFFSET UNITYSDK_OFFSET(0x1A7E3140)
#define SYSTEM_NET_BASELOGGINGOBJECT_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A7E3130)
#define SYSTEM_NET_BASELOGGINGOBJECT_LEAVEFUNC_OFFSET UNITYSDK_OFFSET(0x1A7E30E0)
#define SYSTEM_NET_BASELOGGINGOBJECT_LOGGINGMONITORTICK_OFFSET UNITYSDK_OFFSET(0x1A7E3150)
#define SYSTEM_NET_BASELOGGINGOBJECT_PRINTLINE_OFFSET UNITYSDK_OFFSET(0x1A7E3100)
#define SYSTEM_NET_BASELOGGINGOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E30C0)

namespace System::Net
{
	inline static constexpr unsigned int BaseLoggingObject_TypeDefinitionIndex = 3380;
