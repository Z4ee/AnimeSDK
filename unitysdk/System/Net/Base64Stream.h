...
#define SYSTEM_NET_BASE64STREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x193B4070)
#define SYSTEM_NET_BASE64STREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x193B4210)
#define SYSTEM_NET_BASE64STREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x193B43B0)
#define SYSTEM_NET_BASE64STREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x193B4730)
#define SYSTEM_NET_BASE64STREAM_ENCODEBYTES_1_OFFSET UNITYSDK_OFFSET(0x193B4CB0)
#define SYSTEM_NET_BASE64STREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x193B4C90)
#define SYSTEM_NET_BASE64STREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x193B5AE0)
#define SYSTEM_NET_BASE64STREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x193B5BD0)
#define SYSTEM_NET_BASE64STREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x193B46E0)
#define SYSTEM_NET_BASE64STREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x193B5CC0)
#define SYSTEM_NET_BASE64STREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x193B59D0)
#define SYSTEM_NET_BASE64STREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x193B59C0)
#define SYSTEM_NET_BASE64STREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x193B3FD0)
#define SYSTEM_NET_BASE64STREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x193B4000)
#define SYSTEM_NET_BASE64STREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x193B4060)
#define SYSTEM_NET_BASE64STREAM_READ_OFFSET UNITYSDK_OFFSET(0x193B5D30)
#define SYSTEM_NET_BASE64STREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x193B5E60)
#define SYSTEM_NET_BASE64STREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x193B5FE0)
#define SYSTEM_NET_BASE64STREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B3EA0)
#define SYSTEM_NET_BASE64STREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193B3F60)
#define SYSTEM_NET_BASE64STREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x193B3D40)

namespace System::Net
{
	inline static constexpr unsigned int Base64Stream_TypeDefinitionIndex = 3433;
	...
	public:
		...
		::System::Net::Mime::Base64WriteStateInfo* writeState; // 0x38
		::System::Net::Base64Stream_ReadStateInfo* readState; // 0x40
