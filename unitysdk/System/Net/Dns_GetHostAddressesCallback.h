...
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E42E0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E4310)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E3DA0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E3D90)

namespace System::Net
{
	inline static constexpr unsigned int Dns_GetHostAddressesCallback_TypeDefinitionIndex = 3507;
