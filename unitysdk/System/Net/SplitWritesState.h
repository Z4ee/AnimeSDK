...
#define SYSTEM_NET_SPLITWRITESSTATE_GETNEXTBUFFERS_OFFSET UNITYSDK_OFFSET(0x19B00270)
#define SYSTEM_NET_SPLITWRITESSTATE_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x19B001E0)
#define SYSTEM_NET_SPLITWRITESSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B001D0)

namespace System::Net
{
	inline static constexpr unsigned int SplitWritesState_TypeDefinitionIndex = 3329;
