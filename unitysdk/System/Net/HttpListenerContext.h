...
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C894BE0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_2_OFFSET UNITYSDK_OFFSET(0x1C894C30)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_3_OFFSET UNITYSDK_OFFSET(0x1C894C80)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x1C894B90)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1C894750)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C894720)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_ERRORSTATUS_OFFSET UNITYSDK_OFFSET(0x1C894700)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_HAVEERROR_OFFSET UNITYSDK_OFFSET(0x1C894740)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_REQUEST_OFFSET UNITYSDK_OFFSET(0x1C894760)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_RESPONSE_OFFSET UNITYSDK_OFFSET(0x1C894770)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_USER_OFFSET UNITYSDK_OFFSET(0x1C894780)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_PARSEAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x1C894790)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_PARSEBASICAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x1C894940)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C894730)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_SET_ERRORSTATUS_OFFSET UNITYSDK_OFFSET(0x1C894710)
#define SYSTEM_NET_HTTPLISTENERCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C894CD0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C894680)
...
namespace System::Net
{
	...
	public:
		...
		::System::Security::Principal::IPrincipal* user; // 0x18
