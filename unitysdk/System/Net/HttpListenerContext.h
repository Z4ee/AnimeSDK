...
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A575930)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_2_OFFSET UNITYSDK_OFFSET(0x1A575980)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_3_OFFSET UNITYSDK_OFFSET(0x1A5759D0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x1A5758E0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1A5754A0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A575470)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_ERRORSTATUS_OFFSET UNITYSDK_OFFSET(0x1A575450)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_HAVEERROR_OFFSET UNITYSDK_OFFSET(0x1A575490)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_REQUEST_OFFSET UNITYSDK_OFFSET(0x1A5754B0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_RESPONSE_OFFSET UNITYSDK_OFFSET(0x1A5754C0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_USER_OFFSET UNITYSDK_OFFSET(0x1A5754D0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_PARSEAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x1A5754E0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_PARSEBASICAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x1A575690)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A575480)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_SET_ERRORSTATUS_OFFSET UNITYSDK_OFFSET(0x1A575460)
#define SYSTEM_NET_HTTPLISTENERCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A575A20)
#define SYSTEM_NET_HTTPLISTENERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5753D0)

namespace System::Net
{
	inline static constexpr unsigned int HttpListenerContext_TypeDefinitionIndex = 3526;

	class HttpListenerContext : public ::System::Object
	{
	public:
		::System::Net::HttpListener* Listener; // 0x10
		::System::Net::HttpConnection* cnc; // 0x18
