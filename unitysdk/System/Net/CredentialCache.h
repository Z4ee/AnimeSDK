...
#define SYSTEM_NET_CREDENTIALCACHE_ADD_1_OFFSET UNITYSDK_OFFSET(0x193B6980)
#define SYSTEM_NET_CREDENTIALCACHE_ADD_OFFSET UNITYSDK_OFFSET(0x193B6760)
#define SYSTEM_NET_CREDENTIALCACHE_GETCREDENTIAL_1_OFFSET UNITYSDK_OFFSET(0x193B7240)
#define SYSTEM_NET_CREDENTIALCACHE_GETCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x193B6E50)
#define SYSTEM_NET_CREDENTIALCACHE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193B7670)
#define SYSTEM_NET_CREDENTIALCACHE_GET_DEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x193B76E0)
#define SYSTEM_NET_CREDENTIALCACHE_GET_DEFAULTNETWORKCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x193B7740)
#define SYSTEM_NET_CREDENTIALCACHE_GET_ISDEFAULTINCACHE_OFFSET UNITYSDK_OFFSET(0x193B6640)
#define SYSTEM_NET_CREDENTIALCACHE_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x193B6D50)
#define SYSTEM_NET_CREDENTIALCACHE_REMOVE_OFFSET UNITYSDK_OFFSET(0x193B6C10)
#define SYSTEM_NET_CREDENTIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x193B6650)

namespace System::Net
{
	inline static constexpr unsigned int CredentialCache_TypeDefinitionIndex = 3266;
