...
#define SYSTEM_NET_WEBPROXYDATABUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1C308500)
#define SYSTEM_NET_WEBPROXYDATABUILDER_BYPASSSTRINGESCAPE_OFFSET UNITYSDK_OFFSET(0x1C309120)
#define SYSTEM_NET_WEBPROXYDATABUILDER_CONVERTREGEXRESERVEDCHARS_OFFSET UNITYSDK_OFFSET(0x1C309620)
#define SYSTEM_NET_WEBPROXYDATABUILDER_CREATEINVALIDPROXYSTRINGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C308FA0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x1C308C40)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEPROTOCOLPROXIES_OFFSET UNITYSDK_OFFSET(0x1C308830)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEPROXYURI_OFFSET UNITYSDK_OFFSET(0x1C3086A0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETAUTODETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1C308F80)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETAUTOPROXYURL_OFFSET UNITYSDK_OFFSET(0x1C308E40)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETPROXYANDBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x1C308550)
#define SYSTEM_NET_WEBPROXYDATABUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C309920)
