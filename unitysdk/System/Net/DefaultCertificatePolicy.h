...
#define SYSTEM_NET_DEFAULTCERTIFICATEPOLICY_CHECKVALIDATIONRESULT_OFFSET UNITYSDK_OFFSET(0x1A7E3C60)
#define SYSTEM_NET_DEFAULTCERTIFICATEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E3D80)

namespace System::Net
{
	inline static constexpr unsigned int DefaultCertificatePolicy_TypeDefinitionIndex = 3498;
