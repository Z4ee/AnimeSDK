...
#define SYSTEM_NET_DEFAULTCERTIFICATEPOLICY_CHECKVALIDATIONRESULT_OFFSET UNITYSDK_OFFSET(0x1DEBEC00)
#define SYSTEM_NET_DEFAULTCERTIFICATEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBED20)
