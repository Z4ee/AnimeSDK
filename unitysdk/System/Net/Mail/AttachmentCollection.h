...
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_CLEARITEMS_OFFSET UNITYSDK_OFFSET(0x1E97A440)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E97A3B0)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x1E97A480)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x1E97A4D0)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x1E97A510)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E97A370)
