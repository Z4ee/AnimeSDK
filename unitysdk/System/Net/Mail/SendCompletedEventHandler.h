...
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1CE360)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1CE3A0)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1CDDE0)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1CDDC0)

namespace System::Net::Mail
{
	inline static constexpr unsigned int SendCompletedEventHandler_TypeDefinitionIndex = 3591;
