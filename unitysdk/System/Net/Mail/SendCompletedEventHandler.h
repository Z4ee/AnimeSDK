...
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D623B90)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D623BD0)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D623600)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6235E0)
