...
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_CLEARITEMS_OFFSET UNITYSDK_OFFSET(0x1C027070)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C027060)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C027000)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x1C0270B0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x1C027100)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x1C027140)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C026FC0)

namespace System::Net::Mail
{
	inline static constexpr unsigned int LinkedResourceCollection_TypeDefinitionIndex = 3586;
