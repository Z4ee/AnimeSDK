...
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x1A7E7070)
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x1A7E7450)
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1A7E6DF0)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7E6980)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_NAMEENCODING_OFFSET UNITYSDK_OFFSET(0x1A7E6DD0)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7E6990)
#define SYSTEM_NET_MAIL_ATTACHMENT_INITNAME_OFFSET UNITYSDK_OFFSET(0x1A7E65B0)
#define SYSTEM_NET_MAIL_ATTACHMENT_SET_NAMEENCODING_OFFSET UNITYSDK_OFFSET(0x1A7E6DE0)
#define SYSTEM_NET_MAIL_ATTACHMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7E68B0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7E6640)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A7E66E0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A7E6780)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A7E6810)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A7E68D0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E6520)

namespace System::Net::Mail
{
	inline static constexpr unsigned int Attachment_TypeDefinitionIndex = 3581;
