...
#define SYSTEM_NET_MAIL_CCREDENTIALSBYHOST_GETCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x1D8945A0)
#define SYSTEM_NET_MAIL_CCREDENTIALSBYHOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D894590)
