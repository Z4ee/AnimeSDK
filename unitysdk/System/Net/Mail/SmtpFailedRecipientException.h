...
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A329970)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION_GET_FAILEDRECIPIENT_OFFSET UNITYSDK_OFFSET(0x1A329960)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A329A60)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A329560)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3295F0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A329690)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A329770)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A329810)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1A3298C0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A329490)

namespace System::Net::Mail
{
	inline static constexpr unsigned int SmtpFailedRecipientException_TypeDefinitionIndex = 3605;
