...
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1DB891B0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION_GET_FAILEDRECIPIENT_OFFSET UNITYSDK_OFFSET(0x1DB891A0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1DB892A0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB88DA0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB88E30)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DB88ED0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DB88FB0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DB89050)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1DB89100)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB88CD0)
