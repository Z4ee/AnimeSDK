...
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C7060D0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION_GET_INNEREXCEPTIONS_OFFSET UNITYSDK_OFFSET(0x1C7060C0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C7061C0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C705DD0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C705E60)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C705F00)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C705FA0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C705D00)
