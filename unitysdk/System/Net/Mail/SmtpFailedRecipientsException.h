...
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FB7410)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION_GET_INNEREXCEPTIONS_OFFSET UNITYSDK_OFFSET(0x18FB7400)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FB7500)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FB7110)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FB71A0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FB7240)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18FB72E0)
#define SYSTEM_NET_MAIL_SMTPFAILEDRECIPIENTSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB7040)

namespace System::Net::Mail
{
	inline static constexpr unsigned int SmtpFailedRecipientsException_TypeDefinitionIndex = 3606;
