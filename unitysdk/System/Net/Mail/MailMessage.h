...
#define SYSTEM_NET_MAIL_MAILMESSAGE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A579B30)
#define SYSTEM_NET_MAIL_MAILMESSAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A579AD0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_ENCODESUBJECTRFC2047_OFFSET UNITYSDK_OFFSET(0x1A579F80)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ALTERNATEVIEWS_OFFSET UNITYSDK_OFFSET(0x1A5791D0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1A5791E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BCC_OFFSET UNITYSDK_OFFSET(0x1A5791F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A579330)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYENCODING_OFFSET UNITYSDK_OFFSET(0x1A5797E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1A579800)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1A579200)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_CC_OFFSET UNITYSDK_OFFSET(0x1A5798B0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_CONTENTTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1A579490)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_DELIVERYNOTIFICATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A5798C0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_FROM_OFFSET UNITYSDK_OFFSET(0x1A5798E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_HEADERSENCODING_OFFSET UNITYSDK_OFFSET(0x1A579950)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1A579900)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ISBODYHTML_OFFSET UNITYSDK_OFFSET(0x1A579910)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A579930)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_REPLYTOLIST_OFFSET UNITYSDK_OFFSET(0x1A579970)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_REPLYTO_OFFSET UNITYSDK_OFFSET(0x1A579980)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x1A579A70)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SUBJECTENCODING_OFFSET UNITYSDK_OFFSET(0x1A579AA0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SUBJECT_OFFSET UNITYSDK_OFFSET(0x1A579A90)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_TO_OFFSET UNITYSDK_OFFSET(0x1A579AC0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_UTF8UNMARKED_OFFSET UNITYSDK_OFFSET(0x1A579B40)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GUESSENCODING_OFFSET UNITYSDK_OFFSET(0x1A579210)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GUESSTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1A5794F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODYENCODING_OFFSET UNITYSDK_OFFSET(0x1A5797F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODYTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1A579860)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODY_OFFSET UNITYSDK_OFFSET(0x1A578E90)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_DELIVERYNOTIFICATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A5798D0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_FROM_OFFSET UNITYSDK_OFFSET(0x1A5798F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_HEADERSENCODING_OFFSET UNITYSDK_OFFSET(0x1A579960)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_ISBODYHTML_OFFSET UNITYSDK_OFFSET(0x1A579920)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A579940)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_REPLYTO_OFFSET UNITYSDK_OFFSET(0x1A579A00)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x1A579A80)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SUBJECTENCODING_OFFSET UNITYSDK_OFFSET(0x1A579AB0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SUBJECT_OFFSET UNITYSDK_OFFSET(0x1A579090)
#define SYSTEM_NET_MAIL_MAILMESSAGE_TO2047_OFFSET UNITYSDK_OFFSET(0x1A579C60)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A57A290)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A578820)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A5788C0)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A578B00)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5784F0)

namespace System::Net::Mail
{
	inline static constexpr unsigned int MailMessage_TypeDefinitionIndex = 3590;
	...
	public:
		...
		::System::String* subject; // 0x10
		::System::Net::Mail::MailAddressCollection* replyTo; // 0x18
		::System::Text::Encoding* bodyEncoding; // 0x20
		::System::Net::Mail::MailAddressCollection* bcc; // 0x28
		::System::Net::Mail::MailAddress* from; // 0x30
		::System::Text::Encoding* headersEncoding; // 0x38
		::System::Net::Mail::MailAddressCollection* cc; // 0x40
		::System::Net::Mail::MailAddress* sender; // 0x48
		::System::Collections::Specialized::NameValueCollection* headers; // 0x50
		::System::String* body; // 0x58
		::System::Net::Mail::AlternateViewCollection* alternateViews; // 0x60
		::System::Net::Mail::MailAddressCollection* to; // 0x68
		::System::Net::Mail::AttachmentCollection* attachments; // 0x70
		::System::Text::Encoding* subjectEncoding; // 0x78
		::System::Net::Mail::MailPriority priority; // 0x80
		::System::Net::Mail::DeliveryNotificationOptions deliveryNotificationOptions; // 0x84
