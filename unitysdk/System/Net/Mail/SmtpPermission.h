...
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x1AA9D280)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1AA9D2C0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1AA9D300)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x1AA9D240)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1AA9D340)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1AA9D380)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1AA9D3C0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1AA9D400)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA9D1C0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AA9D200)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9D180)

namespace System::Net::Mail
{
	inline static constexpr unsigned int SmtpPermission_TypeDefinitionIndex = 4113;
