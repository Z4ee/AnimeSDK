...
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_COMPLETESEQUENCE_OFFSET UNITYSDK_OFFSET(0x1D40DCA0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_DECREMENT_OFFSET UNITYSDK_OFFSET(0x1D40DB60)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x1D40DD40)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_ENTER_OFFSET UNITYSDK_OFFSET(0x1D40DAA0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1D40DA90)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_INCREMENT_OFFSET UNITYSDK_OFFSET(0x1D40DAB0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_LEAVE_1_OFFSET UNITYSDK_OFFSET(0x1D40DC00)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_LEAVE_OFFSET UNITYSDK_OFFSET(0x1D40DAC0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40DA10)
