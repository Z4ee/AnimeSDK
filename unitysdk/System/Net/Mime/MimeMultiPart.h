...
#define SYSTEM_NET_MIME_MIMEMULTIPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x1D24DB30)
#define SYSTEM_NET_MIME_MIMEMULTIPART_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1D24C710)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1D24D580)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D24D380)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GETNEXTBOUNDARY_OFFSET UNITYSDK_OFFSET(0x1D24C600)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x1D24C6A0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1D24CE40)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D24CC40)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1D24CAC0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x1D24C8D0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SEND_OFFSET UNITYSDK_OFFSET(0x1D24DDA0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1D24C3B0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SET_MIMEMULTIPARTTYPE_OFFSET UNITYSDK_OFFSET(0x1D24C300)
#define SYSTEM_NET_MIME_MIMEMULTIPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1D24C2F0)
