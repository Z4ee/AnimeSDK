...
#define SYSTEM_NET_MIME_MIMEMULTIPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x1BEDC240)
#define SYSTEM_NET_MIME_MIMEMULTIPART_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1BEDAE40)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1BEDBCA0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BEDBAA0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GETNEXTBOUNDARY_OFFSET UNITYSDK_OFFSET(0x1BEDAD30)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x1BEDADD0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1BEDB570)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BEDB370)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1BEDB1F0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x1BEDB000)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SEND_OFFSET UNITYSDK_OFFSET(0x1BEDC4B0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1BEDAAE0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SET_MIMEMULTIPARTTYPE_OFFSET UNITYSDK_OFFSET(0x1BEDAA30)
#define SYSTEM_NET_MIME_MIMEMULTIPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEDAA20)

namespace System::Net::Mime
{
	inline static constexpr unsigned int MimeMultiPart_TypeDefinitionIndex = 3620;
	...
	public:
		...
		::System::AsyncCallback* mimePartSentCallback; // 0x28
		::System::Collections::ObjectModel::Collection_1<::System::Net::Mime::MimeBasePart*>* parts; // 0x30
