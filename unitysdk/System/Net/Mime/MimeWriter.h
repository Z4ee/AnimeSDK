...
#define SYSTEM_NET_MIME_MIMEWRITER_BEGINCLOSE_OFFSET UNITYSDK_OFFSET(0x1E7E55C0)
#define SYSTEM_NET_MIME_MIMEWRITER_CHECKBOUNDARY_OFFSET UNITYSDK_OFFSET(0x1E7E59A0)
#define SYSTEM_NET_MIME_MIMEWRITER_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x1E7E5710)
#define SYSTEM_NET_MIME_MIMEWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E7E5910)
#define SYSTEM_NET_MIME_MIMEWRITER_ENDCLOSE_OFFSET UNITYSDK_OFFSET(0x1E7E58D0)
#define SYSTEM_NET_MIME_MIMEWRITER_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1E7E5950)
#define SYSTEM_NET_MIME_MIMEWRITER_WRITEHEADERS_OFFSET UNITYSDK_OFFSET(0x1E7E52B0)
#define SYSTEM_NET_MIME_MIMEWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7E5B10)
#define SYSTEM_NET_MIME_MIMEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E5130)

namespace System::Net::Mime
{
	inline static constexpr unsigned int MimeWriter_TypeDefinitionIndex = 3625;
