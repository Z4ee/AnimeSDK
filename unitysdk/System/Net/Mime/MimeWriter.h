...
#define SYSTEM_NET_MIME_MIMEWRITER_BEGINCLOSE_OFFSET UNITYSDK_OFFSET(0x1D45AAB0)
#define SYSTEM_NET_MIME_MIMEWRITER_CHECKBOUNDARY_OFFSET UNITYSDK_OFFSET(0x1D45AE90)
#define SYSTEM_NET_MIME_MIMEWRITER_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x1D45AC00)
#define SYSTEM_NET_MIME_MIMEWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D45AE00)
#define SYSTEM_NET_MIME_MIMEWRITER_ENDCLOSE_OFFSET UNITYSDK_OFFSET(0x1D45ADC0)
#define SYSTEM_NET_MIME_MIMEWRITER_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1D45AE40)
#define SYSTEM_NET_MIME_MIMEWRITER_WRITEHEADERS_OFFSET UNITYSDK_OFFSET(0x1D45A7A0)
#define SYSTEM_NET_MIME_MIMEWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D45B000)
#define SYSTEM_NET_MIME_MIMEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D45A620)
