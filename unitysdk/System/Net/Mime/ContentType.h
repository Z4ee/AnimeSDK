...
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODETOBUFFER_OFFSET UNITYSDK_OFFSET(0x1A7EA8B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODE_OFFSET UNITYSDK_OFFSET(0x1A7EA2B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7EAA80)
#define SYSTEM_NET_MIME_CONTENTTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7EAB20)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x1A7E9600)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_CHARSET_OFFSET UNITYSDK_OFFSET(0x1A7E9B00)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1A7EA290)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1A7E9C50)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7E69B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A7E9750)
#define SYSTEM_NET_MIME_CONTENTTYPE_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1A7E8AD0)
#define SYSTEM_NET_MIME_CONTENTTYPE_PERSISTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A7EA0E0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x1A7E9850)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_CHARSET_OFFSET UNITYSDK_OFFSET(0x1A7E7700)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1A7E9C90)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7E6B20)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_OFFSET UNITYSDK_OFFSET(0x1A7E9F00)
#define SYSTEM_NET_MIME_CONTENTTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7EA080)
#define SYSTEM_NET_MIME_CONTENTTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7EAC30)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7E7330)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E8A60)

namespace System::Net::Mime
{
	inline static constexpr unsigned int ContentType_TypeDefinitionIndex = 3612;
	...
	public:
		...
		::System::String* subType; // 0x20
		::System::String* mediaType; // 0x28
