...
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODETOBUFFER_OFFSET UNITYSDK_OFFSET(0x1CAFE410)
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODE_OFFSET UNITYSDK_OFFSET(0x1CAFDE10)
#define SYSTEM_NET_MIME_CONTENTTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CAFE5E0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CAFE680)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x1CAFD160)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_CHARSET_OFFSET UNITYSDK_OFFSET(0x1CAFD660)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1CAFDDF0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1CAFD7B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CAFA510)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1CAFD2B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1CAFC630)
#define SYSTEM_NET_MIME_CONTENTTYPE_PERSISTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1CAFDC40)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x1CAFD3B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_CHARSET_OFFSET UNITYSDK_OFFSET(0x1CAFB260)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1CAFD7F0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1CAFA680)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_OFFSET UNITYSDK_OFFSET(0x1CAFDA60)
#define SYSTEM_NET_MIME_CONTENTTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CAFDBE0)
#define SYSTEM_NET_MIME_CONTENTTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CAFE790)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAFAE90)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFC5C0)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Net::TrackingStringDictionary* parameters; // 0x18
