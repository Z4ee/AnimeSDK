...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_BYTE_OFFSET UNITYSDK_OFFSET(0x19E363D0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x19E363B0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_BYTE_OFFSET UNITYSDK_OFFSET(0x19E363E0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x19E363C0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19E363F0)

namespace System::Net::Mime
{
	inline static constexpr unsigned int QEncodedStream_ReadStateInfo_TypeDefinitionIndex = 3629;
