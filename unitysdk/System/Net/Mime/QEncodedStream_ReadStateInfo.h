...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_BYTE_OFFSET UNITYSDK_OFFSET(0x1C1CE430)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x1C1CE410)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_BYTE_OFFSET UNITYSDK_OFFSET(0x1C1CE440)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x1C1CE420)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1CE450)
