...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_GET_BYTE_OFFSET UNITYSDK_OFFSET(0x1DAC6B80)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_GET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x1DAC6B60)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_SET_BYTE_OFFSET UNITYSDK_OFFSET(0x1DAC6B90)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_SET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x1DAC6B70)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAC6BA0)
