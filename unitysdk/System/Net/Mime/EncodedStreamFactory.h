...
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_CREATEFOOTER_OFFSET UNITYSDK_OFFSET(0x1D895380)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_CREATEHEADER_OFFSET UNITYSDK_OFFSET(0x1D895200)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GETENCODERFORHEADER_OFFSET UNITYSDK_OFFSET(0x1D894E60)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GETENCODER_OFFSET UNITYSDK_OFFSET(0x1D894CD0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GET_DEFAULTMAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x1D894CC0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D895400)
