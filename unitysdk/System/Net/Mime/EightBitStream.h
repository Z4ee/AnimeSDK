...
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x193B8B20)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x193B95A0)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x193B95F0)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_ENCODELINES_OFFSET UNITYSDK_OFFSET(0x193B8D90)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x193B91C0)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x193B9650)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x193B9640)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x193B8A30)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x193B9290)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B8B00)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x193B8AF0)

namespace System::Net::Mime
{
	inline static constexpr unsigned int EightBitStream_TypeDefinitionIndex = 3614;
