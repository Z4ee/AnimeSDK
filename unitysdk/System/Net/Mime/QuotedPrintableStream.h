...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19A6B190)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x19A6B330)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x19A6B570)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x19A6BF10)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x19A6D6F0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x19A6B360)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x19A6D7B0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x19A6D4C0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x19A6D4B0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x19A6B020)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x19A6B080)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x19A6D7F0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A6D940)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A6AFD0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6AF50)

namespace System::Net::Mime
{
	inline static constexpr unsigned int QuotedPrintableStream_TypeDefinitionIndex = 3631;
	...
	public:
		...
		::System::Boolean encodeCRLF; // 0x4C
