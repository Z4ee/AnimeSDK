...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1AFE46E0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AFE4880)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x1AFE4940)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x1AFE52E0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1AFE5900)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AFE48F0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AFE59C0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x1AFE57F0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1AFE57E0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1AFE4670)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x1AFE46D0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1AFE5A30)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFE5BB0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE4610)

namespace System::Net::Mime
{
	inline static constexpr unsigned int QEncodedStream_TypeDefinitionIndex = 3628;
