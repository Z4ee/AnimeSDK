...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1D45B160)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D45B300)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x1D45B3C0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x1D45BD60)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1D45C380)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D45B370)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1D45C440)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x1D45C270)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1D45C260)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1D45B0F0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x1D45B150)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1D45C4B0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D45C630)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D45B090)
