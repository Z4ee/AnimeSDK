...
#define SYSTEM_NET_MIME_MIMEPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x1DB8AF30)
#define SYSTEM_NET_MIME_MIMEPART_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1DB89EC0)
#define SYSTEM_NET_MIME_MIMEPART_CONTENTSTREAMCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1DB8AAA0)
#define SYSTEM_NET_MIME_MIMEPART_CONTENTSTREAMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1DB8AD30)
#define SYSTEM_NET_MIME_MIMEPART_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB892E0)
#define SYSTEM_NET_MIME_MIMEPART_GETENCODEDSTREAM_OFFSET UNITYSDK_OFFSET(0x1DB8A910)
#define SYSTEM_NET_MIME_MIMEPART_GET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x1DB89310)
#define SYSTEM_NET_MIME_MIMEPART_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1DB89300)
#define SYSTEM_NET_MIME_MIMEPART_GET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1DB894D0)
#define SYSTEM_NET_MIME_MIMEPART_READCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1DB8A280)
#define SYSTEM_NET_MIME_MIMEPART_READCALLBACK_OFFSET UNITYSDK_OFFSET(0x1DB8A080)
#define SYSTEM_NET_MIME_MIMEPART_RESETSTREAM_OFFSET UNITYSDK_OFFSET(0x1DB8B160)
#define SYSTEM_NET_MIME_MIMEPART_SEND_OFFSET UNITYSDK_OFFSET(0x1DB8B210)
#define SYSTEM_NET_MIME_MIMEPART_SETCONTENT_1_OFFSET UNITYSDK_OFFSET(0x1DB89BB0)
#define SYSTEM_NET_MIME_MIMEPART_SETCONTENT_2_OFFSET UNITYSDK_OFFSET(0x1DB89DF0)
#define SYSTEM_NET_MIME_MIMEPART_SETCONTENT_OFFSET UNITYSDK_OFFSET(0x1DB89B10)
#define SYSTEM_NET_MIME_MIMEPART_SET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x1DB89320)
#define SYSTEM_NET_MIME_MIMEPART_SET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1DB89680)
#define SYSTEM_NET_MIME_MIMEPART_WRITECALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x1DB8A4D0)
#define SYSTEM_NET_MIME_MIMEPART_WRITECALLBACK_OFFSET UNITYSDK_OFFSET(0x1DB8A710)
#define SYSTEM_NET_MIME_MIMEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB892D0)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::AsyncCallback* readCallback; // 0x28
		::System::IO::Stream* stream; // 0x30
		::System::AsyncCallback* writeCallback; // 0x38
