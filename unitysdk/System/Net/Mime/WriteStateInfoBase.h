...
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDCRLF_OFFSET UNITYSDK_OFFSET(0x1D250700)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDFOOTER_OFFSET UNITYSDK_OFFSET(0x1D2510C0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x1D2510E0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_1_OFFSET UNITYSDK_OFFSET(0x1D2507F0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_OFFSET UNITYSDK_OFFSET(0x1D250630)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_BUFFERFLUSHED_OFFSET UNITYSDK_OFFSET(0x1D250C00)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_ENSURESPACEINBUFFER_OFFSET UNITYSDK_OFFSET(0x1D251020)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1D250FF0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_CURRENTLINELENGTH_OFFSET UNITYSDK_OFFSET(0x1D251010)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTERLENGTH_OFFSET UNITYSDK_OFFSET(0x1D250FB0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTER_OFFSET UNITYSDK_OFFSET(0x1D250FD0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x1D250FE0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D251000)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_MAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x1D251100)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1D251110)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D24E410)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D250F30)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D250EB0)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _header; // 0x20
		::System::Int32 _currentBufferUsed; // 0x28
		::System::Int32 _maxLineLength; // 0x2C
		::System::Int32 _currentLineLength; // 0x30
