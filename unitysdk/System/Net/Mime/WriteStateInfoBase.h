...
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDCRLF_OFFSET UNITYSDK_OFFSET(0x19A6D2E0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDFOOTER_OFFSET UNITYSDK_OFFSET(0x19A6DCB0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x19A6DCD0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_1_OFFSET UNITYSDK_OFFSET(0x19A6D3D0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_OFFSET UNITYSDK_OFFSET(0x19A6D200)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_BUFFERFLUSHED_OFFSET UNITYSDK_OFFSET(0x19A6D7E0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_ENSURESPACEINBUFFER_OFFSET UNITYSDK_OFFSET(0x19A6DC10)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19A6DBE0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_CURRENTLINELENGTH_OFFSET UNITYSDK_OFFSET(0x19A6DC00)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTERLENGTH_OFFSET UNITYSDK_OFFSET(0x19A6DBA0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTER_OFFSET UNITYSDK_OFFSET(0x19A6DBC0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x19A6DBD0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19A6DBF0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_MAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x19A6DCF0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_RESET_OFFSET UNITYSDK_OFFSET(0x19A6DD00)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A6B120)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19A6DB20)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6DAA0)

namespace System::Net::Mime
{
	inline static constexpr unsigned int WriteStateInfoBase_TypeDefinitionIndex = 3636;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _footer; // 0x20
		::System::Int32 _currentBufferUsed; // 0x28
		::System::Int32 _currentLineLength; // 0x2C
