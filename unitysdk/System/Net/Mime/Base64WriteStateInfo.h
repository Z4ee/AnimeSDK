...
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_GET_LASTBITS_OFFSET UNITYSDK_OFFSET(0x1CC18440)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1CC18420)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_SET_LASTBITS_OFFSET UNITYSDK_OFFSET(0x1CC18450)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x1CC18430)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC183A0)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC13820)
