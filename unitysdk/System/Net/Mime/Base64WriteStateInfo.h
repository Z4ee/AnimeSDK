...
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_GET_LASTBITS_OFFSET UNITYSDK_OFFSET(0x1B764160)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1B764140)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_SET_LASTBITS_OFFSET UNITYSDK_OFFSET(0x1B764170)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x1B764150)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B7640C0)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75F570)

namespace System::Net::Mime
{
	inline static constexpr unsigned int Base64WriteStateInfo_TypeDefinitionIndex = 3607;

	class Base64WriteStateInfo : public ::System::Net::Mime::WriteStateInfoBase
	{
	public:
		::System::Int32 _Padding_k__BackingField; // 0x38
		::System::Byte _LastBits_k__BackingField; // 0x3C
