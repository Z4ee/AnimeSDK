...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_COMPLETEWRITE_OFFSET UNITYSDK_OFFSET(0x1C027660)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x1C027740)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_ONWRITE_OFFSET UNITYSDK_OFFSET(0x1C0277B0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_WRITE_OFFSET UNITYSDK_OFFSET(0x1C027AA0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C027EE0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0275B0)

namespace System::Net::Mime
{
	inline static constexpr unsigned int QuotedPrintableStream_WriteAsyncResult_TypeDefinitionIndex = 3632;
	...
	public:
		...
		::System::Net::Mime::QuotedPrintableStream* parent; // 0x48
