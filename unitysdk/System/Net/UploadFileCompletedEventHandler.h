...
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFEA4A0)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFEA4E0)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE9F20)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE9F10)

namespace System::Net
{
	inline static constexpr unsigned int UploadFileCompletedEventHandler_TypeDefinitionIndex = 3470;
