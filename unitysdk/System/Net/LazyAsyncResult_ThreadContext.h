...
#define SYSTEM_NET_LAZYASYNCRESULT_THREADCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x186F75C0)

namespace System::Net
{
	inline static constexpr unsigned int LazyAsyncResult_ThreadContext_TypeDefinitionIndex = 2769;
