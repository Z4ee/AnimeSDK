...
#define SYSTEM_NET_ENDPOINTLISTENER_ACCEPT_OFFSET UNITYSDK_OFFSET(0x186CA770)
#define SYSTEM_NET_ENDPOINTLISTENER_ADDPREFIX_OFFSET UNITYSDK_OFFSET(0x186CCEA0)
#define SYSTEM_NET_ENDPOINTLISTENER_ADDSPECIAL_OFFSET UNITYSDK_OFFSET(0x186CBED0)
#define SYSTEM_NET_ENDPOINTLISTENER_BINDCONTEXT_OFFSET UNITYSDK_OFFSET(0x186CB210)
#define SYSTEM_NET_ENDPOINTLISTENER_CHECKIFREMOVE_OFFSET UNITYSDK_OFFSET(0x186CC3D0)
#define SYSTEM_NET_ENDPOINTLISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x186CC6E0)
#define SYSTEM_NET_ENDPOINTLISTENER_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x186CA830)
#define SYSTEM_NET_ENDPOINTLISTENER_MATCHFROMLIST_OFFSET UNITYSDK_OFFSET(0x186CBB90)
#define SYSTEM_NET_ENDPOINTLISTENER_ONACCEPT_OFFSET UNITYSDK_OFFSET(0x186CB110)
#define SYSTEM_NET_ENDPOINTLISTENER_PROCESSACCEPT_OFFSET UNITYSDK_OFFSET(0x186CA840)
#define SYSTEM_NET_ENDPOINTLISTENER_REMOVECONNECTION_OFFSET UNITYSDK_OFFSET(0x186CB120)
#define SYSTEM_NET_ENDPOINTLISTENER_REMOVEPREFIX_OFFSET UNITYSDK_OFFSET(0x186CD200)
#define SYSTEM_NET_ENDPOINTLISTENER_REMOVESPECIAL_OFFSET UNITYSDK_OFFSET(0x186CC2B0)
#define SYSTEM_NET_ENDPOINTLISTENER_SEARCHLISTENER_OFFSET UNITYSDK_OFFSET(0x186CB280)
#define SYSTEM_NET_ENDPOINTLISTENER_UNBINDCONTEXT_OFFSET UNITYSDK_OFFSET(0x186CB980)
#define SYSTEM_NET_ENDPOINTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x186CA000)

namespace System::Net
{
	inline static constexpr unsigned int EndPointListener_TypeDefinitionIndex = 2823;
	...
	public:
		...
		::System::Collections::ArrayList* all; // 0x20
		...
		::System::Collections::Hashtable* prefixes; // 0x48
