...
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID_INDEXOFKNOWNHEADER_OFFSET UNITYSDK_OFFSET(0x19BBBB20)
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BBBC30)
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BBB9F0)

namespace System::Net
{
	inline static constexpr unsigned int UnsafeNclNativeMethods_HttpApi_HTTP_RESPONSE_HEADER_ID_TypeDefinitionIndex = 3484;
