...
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID_INDEXOFKNOWNHEADER_OFFSET UNITYSDK_OFFSET(0x1D476CF0)
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D476E00)
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D476BD0)
