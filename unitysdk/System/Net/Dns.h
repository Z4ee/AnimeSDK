...
#define SYSTEM_NET_DNS_BEGINGETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A243240)
#define SYSTEM_NET_DNS_BEGINGETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x1A243080)
#define SYSTEM_NET_DNS_BEGINGETHOSTENTRY_1_OFFSET UNITYSDK_OFFSET(0x1A2434E0)
#define SYSTEM_NET_DNS_BEGINGETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1A243390)
#define SYSTEM_NET_DNS_BEGINRESOLVE_OFFSET UNITYSDK_OFFSET(0x1A243180)
#define SYSTEM_NET_DNS_ENDGETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A243730)
#define SYSTEM_NET_DNS_ENDGETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x1A2435A0)
#define SYSTEM_NET_DNS_ENDGETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1A2437F0)
#define SYSTEM_NET_DNS_ENDRESOLVE_OFFSET UNITYSDK_OFFSET(0x1A243670)
#define SYSTEM_NET_DNS_ERROR_11001_OFFSET UNITYSDK_OFFSET(0x1A2438F0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESASYNC_OFFSET UNITYSDK_OFFSET(0x1A2447E0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A244450)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESSFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1A243E80)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESS_1_OFFSET UNITYSDK_OFFSET(0x1A244060)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESS_OFFSET UNITYSDK_OFFSET(0x1A243E00)
#define SYSTEM_NET_DNS_GETHOSTBYADDR_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A2438D0)
#define SYSTEM_NET_DNS_GETHOSTBYNAME_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A2438C0)
#define SYSTEM_NET_DNS_GETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x1A244320)
#define SYSTEM_NET_DNS_GETHOSTENTRYASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A244A20)
#define SYSTEM_NET_DNS_GETHOSTENTRYASYNC_OFFSET UNITYSDK_OFFSET(0x1A244900)
#define SYSTEM_NET_DNS_GETHOSTENTRY_1_OFFSET UNITYSDK_OFFSET(0x1A2442A0)
#define SYSTEM_NET_DNS_GETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1A2440D0)
#define SYSTEM_NET_DNS_GETHOSTNAME_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A2438E0)
#define SYSTEM_NET_DNS_GETHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1A244680)
#define SYSTEM_NET_DNS_HOSTENT_TO_IPHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1A243960)
#define SYSTEM_NET_DNS_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1A244710)
#define SYSTEM_NET_DNS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A243070)

namespace System::Net
{
	inline static constexpr unsigned int Dns_TypeDefinitionIndex = 3502;
