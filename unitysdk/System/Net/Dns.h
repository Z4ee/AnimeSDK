...
#define SYSTEM_NET_DNS_BEGINGETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C650F80)
#define SYSTEM_NET_DNS_BEGINGETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x1C650DB0)
#define SYSTEM_NET_DNS_BEGINGETHOSTENTRY_1_OFFSET UNITYSDK_OFFSET(0x1C651220)
#define SYSTEM_NET_DNS_BEGINGETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1C6510D0)
#define SYSTEM_NET_DNS_BEGINRESOLVE_OFFSET UNITYSDK_OFFSET(0x1C650EC0)
#define SYSTEM_NET_DNS_ENDGETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C651470)
#define SYSTEM_NET_DNS_ENDGETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x1C6512E0)
#define SYSTEM_NET_DNS_ENDGETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1C651530)
#define SYSTEM_NET_DNS_ENDRESOLVE_OFFSET UNITYSDK_OFFSET(0x1C6513B0)
#define SYSTEM_NET_DNS_ERROR_11001_OFFSET UNITYSDK_OFFSET(0x1C651630)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESASYNC_OFFSET UNITYSDK_OFFSET(0x1C652520)
#define SYSTEM_NET_DNS_GETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C652190)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESSFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1C651BC0)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESS_1_OFFSET UNITYSDK_OFFSET(0x1C651DA0)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESS_OFFSET UNITYSDK_OFFSET(0x1C651B40)
#define SYSTEM_NET_DNS_GETHOSTBYADDR_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C651610)
#define SYSTEM_NET_DNS_GETHOSTBYNAME_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C651600)
#define SYSTEM_NET_DNS_GETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x1C652060)
#define SYSTEM_NET_DNS_GETHOSTENTRYASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C652760)
#define SYSTEM_NET_DNS_GETHOSTENTRYASYNC_OFFSET UNITYSDK_OFFSET(0x1C652640)
#define SYSTEM_NET_DNS_GETHOSTENTRY_1_OFFSET UNITYSDK_OFFSET(0x1C651FE0)
#define SYSTEM_NET_DNS_GETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1C651E10)
#define SYSTEM_NET_DNS_GETHOSTNAME_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C651620)
#define SYSTEM_NET_DNS_GETHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1C6523C0)
#define SYSTEM_NET_DNS_HOSTENT_TO_IPHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x1C6516A0)
#define SYSTEM_NET_DNS_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1C652450)
#define SYSTEM_NET_DNS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C650DA0)
