...
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ABORT_OFFSET UNITYSDK_OFFSET(0x1C01F2F0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ADDHEADER_OFFSET UNITYSDK_OFFSET(0x1C01F330)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_APPENDCOOKIE_OFFSET UNITYSDK_OFFSET(0x1C01F460)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x1C01F660)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x1C01F790)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_2_OFFSET UNITYSDK_OFFSET(0x1C01DD00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C01F2C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_COOKIETOCLIENTSTRING_OFFSET UNITYSDK_OFFSET(0x1C0208C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1C01F7D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_FINDCOOKIE_OFFSET UNITYSDK_OFFSET(0x1C01F8A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_FORMATHEADERS_OFFSET UNITYSDK_OFFSET(0x1C020B00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x1C01DC40)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTLENGTH64_OFFSET UNITYSDK_OFFSET(0x1C01EBE0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1C01ECF0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1C01ED00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_FORCECLOSECHUNKED_OFFSET UNITYSDK_OFFSET(0x1C01EB10)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1C01EE10)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1C01EE30)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_OUTPUTSTREAM_OFFSET UNITYSDK_OFFSET(0x1C01EF00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1C01EF50)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_REDIRECTLOCATION_OFFSET UNITYSDK_OFFSET(0x1C01F180)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x1C01F250)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1C01F260)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C01F270)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ISTOKEN_OFFSET UNITYSDK_OFFSET(0x1C020E10)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_QUOTEDSTRING_OFFSET UNITYSDK_OFFSET(0x1C020D60)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_REDIRECT_OFFSET UNITYSDK_OFFSET(0x1C01F870)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SENDHEADERS_OFFSET UNITYSDK_OFFSET(0x1C01FD00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SETCOOKIE_OFFSET UNITYSDK_OFFSET(0x1C020F60)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x1C01EB20)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTLENGTH64_OFFSET UNITYSDK_OFFSET(0x1C01EBF0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1C01DB80)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1C01EE00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1C01EE20)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1C01EE40)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1C01EF60)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_REDIRECTLOCATION_OFFSET UNITYSDK_OFFSET(0x1C01F190)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x1C01C5C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1C01DA70)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C01F280)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C01F290)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C021190)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0211D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01E9C0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::ResponseStream* output_stream; // 0x20
		...
		::System::Boolean HeadersSent; // 0x68
		::System::Boolean chunked; // 0x69
		::System::Boolean disposed; // 0x6A
		::System::Boolean force_close_chunked; // 0x6B
