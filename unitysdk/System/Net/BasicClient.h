...
#define SYSTEM_NET_BASICCLIENT_AUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x19181B40)
#define SYSTEM_NET_BASICCLIENT_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19181E80)
#define SYSTEM_NET_BASICCLIENT_GET_AUTHENTICATIONTYPE_OFFSET UNITYSDK_OFFSET(0x19181F50)
#define SYSTEM_NET_BASICCLIENT_INTERNALAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x19181BF0)
#define SYSTEM_NET_BASICCLIENT_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x19181F40)
#define SYSTEM_NET_BASICCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191803F0)

namespace System::Net
{
	inline static constexpr unsigned int BasicClient_TypeDefinitionIndex = 2816;
