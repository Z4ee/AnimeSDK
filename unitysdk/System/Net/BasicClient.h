...
#define SYSTEM_NET_BASICCLIENT_AUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1AA9A480)
#define SYSTEM_NET_BASICCLIENT_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AA9A8A0)
#define SYSTEM_NET_BASICCLIENT_GET_AUTHENTICATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1AA9A9E0)
#define SYSTEM_NET_BASICCLIENT_GET_CANPREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1AA9AA20)
#define SYSTEM_NET_BASICCLIENT_INTERNALAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1AA9A530)
#define SYSTEM_NET_BASICCLIENT_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1AA9A9D0)
#define SYSTEM_NET_BASICCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9AA30)

namespace System::Net
{
	inline static constexpr unsigned int BasicClient_TypeDefinitionIndex = 3493;
