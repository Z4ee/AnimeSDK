...
#define SYSTEM_NET_INTERLOCKEDGATE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x8C4F20)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHSIGNALING_OFFSET UNITYSDK_OFFSET(0x8C4EA0)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHTRIGGERING_OFFSET UNITYSDK_OFFSET(0x8C4DA0)
#define SYSTEM_NET_INTERLOCKEDGATE_RESET_OFFSET UNITYSDK_OFFSET(0x3046B0)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTSIGNALING_OFFSET UNITYSDK_OFFSET(0x8C4E20)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTTRIGGERING_OFFSET UNITYSDK_OFFSET(0x8C4D20)
#define SYSTEM_NET_INTERLOCKEDGATE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x8C4CA0)

namespace System::Net
{
	inline static constexpr unsigned int InterlockedGate_TypeDefinitionIndex = 3296;
