...
#define SYSTEM_NET_INTERLOCKEDGATE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x96FCE0)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHSIGNALING_OFFSET UNITYSDK_OFFSET(0x96FC60)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHTRIGGERING_OFFSET UNITYSDK_OFFSET(0x96FB60)
#define SYSTEM_NET_INTERLOCKEDGATE_RESET_OFFSET UNITYSDK_OFFSET(0x3E1930)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTSIGNALING_OFFSET UNITYSDK_OFFSET(0x96FBE0)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTTRIGGERING_OFFSET UNITYSDK_OFFSET(0x96FAE0)
#define SYSTEM_NET_INTERLOCKEDGATE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x96FA60)
