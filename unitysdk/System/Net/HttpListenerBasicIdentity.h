...
#define SYSTEM_NET_HTTPLISTENERBASICIDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF84D00)

namespace System::Net
{
	inline static constexpr unsigned int HttpListenerBasicIdentity_TypeDefinitionIndex = 2839;
