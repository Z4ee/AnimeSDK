...
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DAB7940)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DAB7980)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DAB73B0)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB7390)

namespace System::Net
{
	inline static constexpr unsigned int DownloadProgressChangedEventHandler_TypeDefinitionIndex = 3473;
