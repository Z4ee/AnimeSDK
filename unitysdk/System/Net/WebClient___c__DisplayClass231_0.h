...
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS231_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C895B40)
#define SYSTEM_NET_WEBCLIENT___C__DISPLAYCLASS231_0__DOWNLOADDATATASKASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1C897480)

namespace System::Net
{
	inline static constexpr unsigned int WebClient___c__DisplayClass231_0_TypeDefinitionIndex = 3451;

	class WebClient___c__DisplayClass231_0 : public ::System::Object
	{
	public:
		::System::Net::DownloadDataCompletedEventHandler* handler; // 0x10
