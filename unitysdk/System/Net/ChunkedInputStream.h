...
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1C6D2000)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C6D2880)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1C6D22A0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_GET_DECODER_OFFSET UNITYSDK_OFFSET(0x1C6D1FB0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_ONREAD_OFFSET UNITYSDK_OFFSET(0x1C6D2540)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C6D1FD0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_SET_DECODER_OFFSET UNITYSDK_OFFSET(0x1C6D1FC0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6D1E60)
