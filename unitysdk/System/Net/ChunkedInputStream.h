...
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1A3242E0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A324B50)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1A324580)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_GET_DECODER_OFFSET UNITYSDK_OFFSET(0x1A324290)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_ONREAD_OFFSET UNITYSDK_OFFSET(0x1A324820)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1A3242B0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM_SET_DECODER_OFFSET UNITYSDK_OFFSET(0x1A3242A0)
#define SYSTEM_NET_CHUNKEDINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A324140)
