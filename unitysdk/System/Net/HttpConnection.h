...
#define SYSTEM_NET_HTTPCONNECTION_BEGINREADREQUEST_OFFSET UNITYSDK_OFFSET(0x1C01C260)
#define SYSTEM_NET_HTTPCONNECTION_CLOSESOCKET_OFFSET UNITYSDK_OFFSET(0x1C01C120)
#define SYSTEM_NET_HTTPCONNECTION_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x1C01CF50)
#define SYSTEM_NET_HTTPCONNECTION_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C01DE00)
#define SYSTEM_NET_HTTPCONNECTION_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1C01C420)
#define SYSTEM_NET_HTTPCONNECTION_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1C01C680)
#define SYSTEM_NET_HTTPCONNECTION_GET_CLIENTCERTIFICATEERRORS_OFFSET UNITYSDK_OFFSET(0x1C01BF00)
#define SYSTEM_NET_HTTPCONNECTION_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1C01BF10)
#define SYSTEM_NET_HTTPCONNECTION_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1C01BF20)
#define SYSTEM_NET_HTTPCONNECTION_GET_ISSECURE_OFFSET UNITYSDK_OFFSET(0x1C01C090)
#define SYSTEM_NET_HTTPCONNECTION_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x1C01BF40)
#define SYSTEM_NET_HTTPCONNECTION_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1C01C0A0)
#define SYSTEM_NET_HTTPCONNECTION_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1C01C010)
#define SYSTEM_NET_HTTPCONNECTION_GET_REUSES_OFFSET UNITYSDK_OFFSET(0x1C01BF30)
#define SYSTEM_NET_HTTPCONNECTION_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1C01BEF0)
#define SYSTEM_NET_HTTPCONNECTION_INIT_OFFSET UNITYSDK_OFFSET(0x1C01BD70)
#define SYSTEM_NET_HTTPCONNECTION_ONREADINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C01C8E0)
#define SYSTEM_NET_HTTPCONNECTION_ONREAD_OFFSET UNITYSDK_OFFSET(0x1C01C7F0)
#define SYSTEM_NET_HTTPCONNECTION_ONTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C01C0C0)
#define SYSTEM_NET_HTTPCONNECTION_PROCESSINPUT_OFFSET UNITYSDK_OFFSET(0x1C01D510)
#define SYSTEM_NET_HTTPCONNECTION_READLINE_OFFSET UNITYSDK_OFFSET(0x1C01D850)
#define SYSTEM_NET_HTTPCONNECTION_REMOVECONNECTION_OFFSET UNITYSDK_OFFSET(0x1C01D800)
#define SYSTEM_NET_HTTPCONNECTION_SENDERROR_1_OFFSET UNITYSDK_OFFSET(0x1C01D4E0)
#define SYSTEM_NET_HTTPCONNECTION_SENDERROR_OFFSET UNITYSDK_OFFSET(0x1C01CD10)
#define SYSTEM_NET_HTTPCONNECTION_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1C01C0B0)
#define SYSTEM_NET_HTTPCONNECTION_UNBIND_OFFSET UNITYSDK_OFFSET(0x1C01C210)
#define SYSTEM_NET_HTTPCONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C01DE10)
#define SYSTEM_NET_HTTPCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01BA20)
#define SYSTEM_NET_HTTPCONNECTION___CTOR_B__24_0_OFFSET UNITYSDK_OFFSET(0x1C01DE70)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::ListenerPrefix* prefix; // 0x18
		::System::Net::RequestStream* i_stream; // 0x20
		::Il2CppArray<::System::Int32>* client_cert_errors; // 0x28
		...
		::System::IO::MemoryStream* ms; // 0x50
		::System::Net::EndPointListener* epl; // 0x58
		::System::Net::HttpListenerContext* context; // 0x60
		::System::Threading::Timer* timer; // 0x68
		::System::Net::HttpListener* last_listener; // 0x70
		::System::Net::IPEndPoint* local_ep; // 0x78
		::System::Text::StringBuilder* current_line; // 0x80
		::System::Net::Sockets::Socket* sock; // 0x88
		::System::Net::ResponseStream* o_stream; // 0x90
		::System::Net::HttpConnection_InputState input_state; // 0x98
		::System::Int32 s_timeout; // 0x9C
		::System::Int32 reuses; // 0xA0
		::System::Int32 position; // 0xA4
