...
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1A7F0630)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A7F0640)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1A7F02B0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A7F0610)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x1A7F02D0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x1A7F0460)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_PERSISTVALUE_OFFSET UNITYSDK_OFFSET(0x1A7EFE70)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A7F0740)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1A7F02C0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A7F0620)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7EFDD0)

namespace System::Net
{
	inline static constexpr unsigned int TrackingValidationObjectDictionary_TypeDefinitionIndex = 3440;
