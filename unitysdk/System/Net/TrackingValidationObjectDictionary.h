...
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1CB041B0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CB041C0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1CB03E30)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CB04190)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x1CB03E50)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x1CB03FE0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_PERSISTVALUE_OFFSET UNITYSDK_OFFSET(0x1CB039F0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1CB042C0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1CB03E40)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CB041A0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB03950)
