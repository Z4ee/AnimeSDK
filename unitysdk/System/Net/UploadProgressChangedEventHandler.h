...
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19F05F90)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19F05FD0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F05A10)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F05A00)

namespace System::Net
{
	inline static constexpr unsigned int UploadProgressChangedEventHandler_TypeDefinitionIndex = 3476;
