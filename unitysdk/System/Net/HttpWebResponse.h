...
#define SYSTEM_NET_HTTPWEBRESPONSE_CHECKDISPOSED_OFFSET UNITYSDK_OFFSET(0x1AFE2BF0)
#define SYSTEM_NET_HTTPWEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AFE35E0)
#define SYSTEM_NET_HTTPWEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFE3660)
#define SYSTEM_NET_HTTPWEBRESPONSE_FILLCOOKIES_OFFSET UNITYSDK_OFFSET(0x1AFE2560)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1AFE2DC0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AFE3280)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x1AFE30D0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1AFE31E0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CHARACTERSET_OFFSET UNITYSDK_OFFSET(0x1AFE29E0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x1AFE2B90)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1AFE2C80)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AFE2B20)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1AFE2C90)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1AFE2DB0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1AFE2ED0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_LASTMODIFIED_OFFSET UNITYSDK_OFFSET(0x1AFE2F20)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1AFE2FD0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1AFE2FF0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x1AFE3010)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x1AFE3030)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1AFE3090)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AFE30A0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_SUPPORTSHEADERS_OFFSET UNITYSDK_OFFSET(0x1AFE30C0)
#define SYSTEM_NET_HTTPWEBRESPONSE_READALL_OFFSET UNITYSDK_OFFSET(0x1AFE3140)
#define SYSTEM_NET_HTTPWEBRESPONSE_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1AFE2D90)
#define SYSTEM_NET_HTTPWEBRESPONSE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFE3610)
#define SYSTEM_NET_HTTPWEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AFE3270)
#define SYSTEM_NET_HTTPWEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFE2700)
#define SYSTEM_NET_HTTPWEBRESPONSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFE36B0)
#define SYSTEM_NET_HTTPWEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE2250)
