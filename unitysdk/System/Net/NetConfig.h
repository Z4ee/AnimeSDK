...
#define SYSTEM_NET_NETCONFIG_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1E28B8C0)
#define SYSTEM_NET_NETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E28B8B0)
