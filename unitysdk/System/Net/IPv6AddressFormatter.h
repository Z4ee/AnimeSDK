...
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_ASIPV4INT_OFFSET UNITYSDK_OFFSET(0x3870160)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_ISIPV4COMPATIBLE_OFFSET UNITYSDK_OFFSET(0x38701A0)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_ISIPV4MAPPED_OFFSET UNITYSDK_OFFSET(0x38701B0)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_SWAPUSHORT_OFFSET UNITYSDK_OFFSET(0x1AF961B0)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3870230)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x80F20)
