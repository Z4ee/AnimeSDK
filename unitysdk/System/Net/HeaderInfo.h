...
#define SYSTEM_NET_HEADERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x195F5160)

namespace System::Net
{
	inline static constexpr unsigned int HeaderInfo_TypeDefinitionIndex = 2769;
	...
	public:
		...
		::System::Boolean IsRequestRestricted; // 0x21
