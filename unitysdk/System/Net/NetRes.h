...
#define SYSTEM_NET_NETRES_GETWEBSTATUSCODESTRING_1_OFFSET UNITYSDK_OFFSET(0x1D6ADB80)
#define SYSTEM_NET_NETRES_GETWEBSTATUSCODESTRING_OFFSET UNITYSDK_OFFSET(0x1D6AD9F0)
#define SYSTEM_NET_NETRES_GETWEBSTATUSSTRING_1_OFFSET UNITYSDK_OFFSET(0x1D6AD990)
#define SYSTEM_NET_NETRES_GETWEBSTATUSSTRING_OFFSET UNITYSDK_OFFSET(0x1D6AD8F0)
#define SYSTEM_NET_NETRES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AD8E0)
