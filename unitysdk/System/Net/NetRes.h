...
#define SYSTEM_NET_NETRES_GETWEBSTATUSCODESTRING_1_OFFSET UNITYSDK_OFFSET(0x1C2ECD00)
#define SYSTEM_NET_NETRES_GETWEBSTATUSCODESTRING_OFFSET UNITYSDK_OFFSET(0x1C2ECB70)
#define SYSTEM_NET_NETRES_GETWEBSTATUSSTRING_1_OFFSET UNITYSDK_OFFSET(0x1C2ECB10)
#define SYSTEM_NET_NETRES_GETWEBSTATUSSTRING_OFFSET UNITYSDK_OFFSET(0x1C2ECA70)
#define SYSTEM_NET_NETRES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2ECA60)

namespace System::Net
{
	inline static constexpr unsigned int NetRes_TypeDefinitionIndex = 3382;
