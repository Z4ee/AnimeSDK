...
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDE910)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDE950)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDE390)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDE370)
