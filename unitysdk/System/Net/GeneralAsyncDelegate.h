...
#define SYSTEM_NET_GENERALASYNCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BED1270)
#define SYSTEM_NET_GENERALASYNCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BED12B0)
#define SYSTEM_NET_GENERALASYNCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BED0CF0)
#define SYSTEM_NET_GENERALASYNCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED0CD0)
