...
#define SYSTEM_NET_WEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B1F0EC0)
#define SYSTEM_NET_WEBRESPONSE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B1F0F80)
#define SYSTEM_NET_WEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1F0ED0)
#define SYSTEM_NET_WEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B1F0EB0)
#define SYSTEM_NET_WEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1B1F1160)
#define SYSTEM_NET_WEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1F1020)
#define SYSTEM_NET_WEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B1F10C0)
#define SYSTEM_NET_WEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1B1F1200)
#define SYSTEM_NET_WEBRESPONSE_GET_ISCACHEFRESH_OFFSET UNITYSDK_OFFSET(0x1B1F0FF0)
#define SYSTEM_NET_WEBRESPONSE_GET_ISFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1B1F0FD0)
#define SYSTEM_NET_WEBRESPONSE_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1B1F1010)
#define SYSTEM_NET_WEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x1B1F11B0)
#define SYSTEM_NET_WEBRESPONSE_GET_SUPPORTSHEADERS_OFFSET UNITYSDK_OFFSET(0x1B1F1250)
#define SYSTEM_NET_WEBRESPONSE_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1F1070)
#define SYSTEM_NET_WEBRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B1F1110)
#define SYSTEM_NET_WEBRESPONSE_SET_INTERNALSETFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1B1F0FE0)
#define SYSTEM_NET_WEBRESPONSE_SET_INTERNALSETISCACHEFRESH_OFFSET UNITYSDK_OFFSET(0x1B1F1000)
#define SYSTEM_NET_WEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B1F0E80)
#define SYSTEM_NET_WEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1F0E70)
#define SYSTEM_NET_WEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F0E60)
