...
#define SYSTEM_NET_WEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E97F030)
#define SYSTEM_NET_WEBRESPONSE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E97F0F0)
#define SYSTEM_NET_WEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E97F040)
#define SYSTEM_NET_WEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1E97F020)
#define SYSTEM_NET_WEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1E97F2D0)
#define SYSTEM_NET_WEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1E97F190)
#define SYSTEM_NET_WEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E97F230)
#define SYSTEM_NET_WEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1E97F370)
#define SYSTEM_NET_WEBRESPONSE_GET_ISCACHEFRESH_OFFSET UNITYSDK_OFFSET(0x1E97F160)
#define SYSTEM_NET_WEBRESPONSE_GET_ISFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1E97F140)
#define SYSTEM_NET_WEBRESPONSE_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1E97F180)
#define SYSTEM_NET_WEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x1E97F320)
#define SYSTEM_NET_WEBRESPONSE_GET_SUPPORTSHEADERS_OFFSET UNITYSDK_OFFSET(0x1E97F3C0)
#define SYSTEM_NET_WEBRESPONSE_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1E97F1E0)
#define SYSTEM_NET_WEBRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E97F280)
#define SYSTEM_NET_WEBRESPONSE_SET_INTERNALSETFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1E97F150)
#define SYSTEM_NET_WEBRESPONSE_SET_INTERNALSETISCACHEFRESH_OFFSET UNITYSDK_OFFSET(0x1E97F170)
#define SYSTEM_NET_WEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1E97EFF0)
#define SYSTEM_NET_WEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E97EFE0)
#define SYSTEM_NET_WEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E97EFD0)
