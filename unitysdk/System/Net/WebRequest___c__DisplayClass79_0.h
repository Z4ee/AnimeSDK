...
#define SYSTEM_NET_WEBREQUEST___C__DISPLAYCLASS79_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1872EC40)
#define SYSTEM_NET_WEBREQUEST___C__DISPLAYCLASS79_0__GETRESPONSEASYNC_B__1_OFFSET UNITYSDK_OFFSET(0x1872F600)

namespace System::Net
{
	inline static constexpr unsigned int WebRequest___c__DisplayClass79_0_TypeDefinitionIndex = 2759;
