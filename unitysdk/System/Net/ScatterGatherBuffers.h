...
#define SYSTEM_NET_SCATTERGATHERBUFFERS_ALLOCATEMEMORYCHUNK_OFFSET UNITYSDK_OFFSET(0x1DECA140)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GETBUFFERS_OFFSET UNITYSDK_OFFSET(0x1DECA1E0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1DECA390)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1DECA3B0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_WRITE_OFFSET UNITYSDK_OFFSET(0x1DECA3C0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DECA080)
#define SYSTEM_NET_SCATTERGATHERBUFFERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DECA070)
...
namespace System::Net
{
	...
	public:
		...
		::System::Int32 nextChunkLength; // 0x20
		::System::Int32 chunkCount; // 0x24
		::System::Int32 totalLength; // 0x28
