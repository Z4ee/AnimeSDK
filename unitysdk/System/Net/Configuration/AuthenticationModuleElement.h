...
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1DEBEA40)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DEBEA80)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DEBEAC0)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEBEA00)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBE9C0)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int AuthenticationModuleElement_TypeDefinitionIndex = 4114;
