...
#define SYSTEM_NET_CONFIGURATION_IPV6ELEMENT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A7E3BA0)
#define SYSTEM_NET_CONFIGURATION_IPV6ELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A7E3C20)
#define SYSTEM_NET_CONFIGURATION_IPV6ELEMENT_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A7E3BE0)
#define SYSTEM_NET_CONFIGURATION_IPV6ELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E3B60)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int Ipv6Element_TypeDefinitionIndex = 4134;
