...
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENT_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1E7E2990)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1E7E2A10)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENT_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1E7E29D0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7E2950)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E2910)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int BypassElement_TypeDefinitionIndex = 4117;
