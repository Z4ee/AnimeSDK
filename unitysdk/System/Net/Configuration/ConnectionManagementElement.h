...
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1B403410)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_MAXCONNECTION_OFFSET UNITYSDK_OFFSET(0x1B403490)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B403510)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1B403450)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_SET_MAXCONNECTION_OFFSET UNITYSDK_OFFSET(0x1B4034D0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4033D0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B403390)
