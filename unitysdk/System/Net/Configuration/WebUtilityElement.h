...
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D46D280)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_GET_UNICODEDECODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1D46D2C0)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_GET_UNICODEENCODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1D46D340)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_SET_UNICODEDECODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1D46D300)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_SET_UNICODEENCODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1D46D380)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D46D240)
