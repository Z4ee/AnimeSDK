...
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1CECD320)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_DEFAULTFTPCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1CECD060)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_DEFAULTHTTPCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x1CECD0A0)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_DEFAULTPOLICYLEVEL_OFFSET UNITYSDK_OFFSET(0x1CECD0E0)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_DISABLEALLCACHING_OFFSET UNITYSDK_OFFSET(0x1CECD160)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_ISPRIVATECACHE_OFFSET UNITYSDK_OFFSET(0x1CECD1E0)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CECD260)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_GET_UNSPECIFIEDMAXIMUMAGE_OFFSET UNITYSDK_OFFSET(0x1CECD2A0)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1CECD360)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_SET_DEFAULTPOLICYLEVEL_OFFSET UNITYSDK_OFFSET(0x1CECD120)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_SET_DISABLEALLCACHING_OFFSET UNITYSDK_OFFSET(0x1CECD1A0)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_SET_ISPRIVATECACHE_OFFSET UNITYSDK_OFFSET(0x1CECD220)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION_SET_UNSPECIFIEDMAXIMUMAGE_OFFSET UNITYSDK_OFFSET(0x1CECD2E0)
#define SYSTEM_NET_CONFIGURATION_REQUESTCACHINGSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECD020)
