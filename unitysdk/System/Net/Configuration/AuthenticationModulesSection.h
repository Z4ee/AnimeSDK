...
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_GET_AUTHENTICATIONMODULES_OFFSET UNITYSDK_OFFSET(0x19AE86F0)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19AE8730)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_INITIALIZEDEFAULT_OFFSET UNITYSDK_OFFSET(0x19AE8770)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AE87B0)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE86B0)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int AuthenticationModulesSection_TypeDefinitionIndex = 4117;
