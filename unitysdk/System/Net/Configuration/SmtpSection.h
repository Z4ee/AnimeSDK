...
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_DELIVERYFORMAT_OFFSET UNITYSDK_OFFSET(0x1B1C11F0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_DELIVERYMETHOD_OFFSET UNITYSDK_OFFSET(0x1B1C1270)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_FROM_OFFSET UNITYSDK_OFFSET(0x1B1C12F0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_NETWORK_OFFSET UNITYSDK_OFFSET(0x1B1C1370)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B1C13B0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_SPECIFIEDPICKUPDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B1C13F0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_SET_DELIVERYFORMAT_OFFSET UNITYSDK_OFFSET(0x1B1C1230)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_SET_DELIVERYMETHOD_OFFSET UNITYSDK_OFFSET(0x1B1C12B0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_SET_FROM_OFFSET UNITYSDK_OFFSET(0x1B1C1330)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C11B0)
