...
#define SYSTEM_NET_CONFIGURATION_HTTPWEBREQUESTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x186B81F0)
#define SYSTEM_NET_CONFIGURATION_HTTPWEBREQUESTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x186B81B0)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int HttpWebRequestElement_TypeDefinitionIndex = 3067;
