...
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_GET_DOWNLOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FB3350)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18FB33D0)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18FB3410)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_SET_DOWNLOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FB3390)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB3310)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int WebProxyScriptElement_TypeDefinitionIndex = 4145;
