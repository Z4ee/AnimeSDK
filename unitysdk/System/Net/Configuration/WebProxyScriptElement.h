...
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_GET_DOWNLOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C701EF0)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C701F70)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C701FB0)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_SET_DOWNLOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C701F30)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C701EB0)
