...
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_GET_ALWAYSUSECOMPLETIONPORTSFORACCEPT_OFFSET UNITYSDK_OFFSET(0x1C493730)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_GET_ALWAYSUSECOMPLETIONPORTSFORCONNECT_OFFSET UNITYSDK_OFFSET(0x1C4937B0)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_GET_IPPROTECTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C493830)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C4938B0)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C4938F0)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_SET_ALWAYSUSECOMPLETIONPORTSFORACCEPT_OFFSET UNITYSDK_OFFSET(0x1C493770)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_SET_ALWAYSUSECOMPLETIONPORTSFORCONNECT_OFFSET UNITYSDK_OFFSET(0x1C4937F0)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT_SET_IPPROTECTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C493870)
#define SYSTEM_NET_CONFIGURATION_SOCKETELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4936F0)
