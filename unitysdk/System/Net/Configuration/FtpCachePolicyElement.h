...
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x19EEA240)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_GET_POLICYLEVEL_OFFSET UNITYSDK_OFFSET(0x19EEA180)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19EEA200)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x19EEA280)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_SET_POLICYLEVEL_OFFSET UNITYSDK_OFFSET(0x19EEA1C0)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEA140)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int FtpCachePolicyElement_TypeDefinitionIndex = 4129;
