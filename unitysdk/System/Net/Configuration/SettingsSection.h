...
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_HTTPLISTENER_OFFSET UNITYSDK_OFFSET(0x1C2E3F40)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_HTTPWEBREQUEST_OFFSET UNITYSDK_OFFSET(0x1C2E3F80)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_IPV6_OFFSET UNITYSDK_OFFSET(0x1C2E3FC0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_PERFORMANCECOUNTERS_OFFSET UNITYSDK_OFFSET(0x1C2E4000)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C2E4040)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_SERVICEPOINTMANAGER_OFFSET UNITYSDK_OFFSET(0x1C2E4080)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x1C2E40C0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_WEBPROXYSCRIPT_OFFSET UNITYSDK_OFFSET(0x1C2E4100)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_WEBUTILITY_OFFSET UNITYSDK_OFFSET(0x1C2E4140)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E3F00)
