...
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_DRAINENTITYBODY_OFFSET UNITYSDK_OFFSET(0x1C015DA0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_ENTITYBODY_OFFSET UNITYSDK_OFFSET(0x1C015DE0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_HEADERWAIT_OFFSET UNITYSDK_OFFSET(0x1C015E20)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_IDLECONNECTION_OFFSET UNITYSDK_OFFSET(0x1C015E60)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_MINSENDBYTESPERSECOND_OFFSET UNITYSDK_OFFSET(0x1C015EA0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C015EE0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_REQUESTQUEUE_OFFSET UNITYSDK_OFFSET(0x1C015F20)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C015D60)

namespace System::Net::Configuration
{
	inline static constexpr unsigned int HttpListenerTimeoutsElement_TypeDefinitionIndex = 4131;
