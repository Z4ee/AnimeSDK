...
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_DRAINENTITYBODY_OFFSET UNITYSDK_OFFSET(0x1D3FC580)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_ENTITYBODY_OFFSET UNITYSDK_OFFSET(0x1D3FC5C0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_HEADERWAIT_OFFSET UNITYSDK_OFFSET(0x1D3FC600)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_IDLECONNECTION_OFFSET UNITYSDK_OFFSET(0x1D3FC640)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_MINSENDBYTESPERSECOND_OFFSET UNITYSDK_OFFSET(0x1D3FC680)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D3FC6C0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_REQUESTQUEUE_OFFSET UNITYSDK_OFFSET(0x1D3FC700)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC540)
