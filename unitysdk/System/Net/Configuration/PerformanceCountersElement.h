...
#define SYSTEM_NET_CONFIGURATION_PERFORMANCECOUNTERSELEMENT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1C1CAF10)
#define SYSTEM_NET_CONFIGURATION_PERFORMANCECOUNTERSELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C1CAF90)
#define SYSTEM_NET_CONFIGURATION_PERFORMANCECOUNTERSELEMENT_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1C1CAF50)
#define SYSTEM_NET_CONFIGURATION_PERFORMANCECOUNTERSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1CAED0)
