...
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT_GET_PICKUPDIRECTORYLOCATION_OFFSET UNITYSDK_OFFSET(0x1D5D1AA0)
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D5D1B20)
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT_SET_PICKUPDIRECTORYLOCATION_OFFSET UNITYSDK_OFFSET(0x1D5D1AE0)
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D1A60)
