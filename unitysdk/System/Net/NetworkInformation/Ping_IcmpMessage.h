...
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_COMPUTECHECKSUM_OFFSET UNITYSDK_OFFSET(0x1DB8CAD0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1DB8CD20)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_CODE_OFFSET UNITYSDK_OFFSET(0x1DB8CBC0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1DB8CCA0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1DB8CC00)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_IPSTATUS_OFFSET UNITYSDK_OFFSET(0x1DB8CD30)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_SEQUENCE_OFFSET UNITYSDK_OFFSET(0x1DB8CC50)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DB8CB80)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB8C820)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8C7B0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Ping_IcmpMessage_TypeDefinitionIndex = 3821;
