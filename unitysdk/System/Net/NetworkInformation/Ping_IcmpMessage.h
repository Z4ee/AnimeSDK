...
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_COMPUTECHECKSUM_OFFSET UNITYSDK_OFFSET(0x1C6DAF00)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C6DB130)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_CODE_OFFSET UNITYSDK_OFFSET(0x1C6DAFD0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C6DB0B0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1C6DB010)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_IPSTATUS_OFFSET UNITYSDK_OFFSET(0x1C6DB140)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_SEQUENCE_OFFSET UNITYSDK_OFFSET(0x1C6DB060)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C6DAF90)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6DACE0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6DAC80)
