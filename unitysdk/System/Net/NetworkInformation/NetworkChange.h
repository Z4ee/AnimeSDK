...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_ADD_NETWORKADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA9D8C0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_ADD_NETWORKAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA9DF00)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_MAYBECREATE_OFFSET UNITYSDK_OFFSET(0x1AA9DB00)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_MAYBEDISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA9DD60)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_REGISTERNETWORKCHANGE_OFFSET UNITYSDK_OFFSET(0x1AA9E2F0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_REMOVE_NETWORKADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA9DBC0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE_REMOVE_NETWORKAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA9E140)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9E2E0)
