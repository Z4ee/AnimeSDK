...
#define SYSTEM_NET_NETWORKINFORMATION_PING_ADD_PINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CAFFC10)
#define SYSTEM_NET_NETWORKINFORMATION_PING_BUILDPINGARGS_OFFSET UNITYSDK_OFFSET(0x1CB018C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_CAPGET_OFFSET UNITYSDK_OFFSET(0x1CAFFF00)
#define SYSTEM_NET_NETWORKINFORMATION_PING_CHECKLINUXCAPABILITIES_OFFSET UNITYSDK_OFFSET(0x1CAFFF90)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ONPINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CB00110)
#define SYSTEM_NET_NETWORKINFORMATION_PING_REMOVE_PINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CAFFC90)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNCCANCEL_OFFSET UNITYSDK_OFFSET(0x1CB020A0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CB01D80)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_2_OFFSET UNITYSDK_OFFSET(0x1CB01E80)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_3_OFFSET UNITYSDK_OFFSET(0x1CB01E90)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_4_OFFSET UNITYSDK_OFFSET(0x1CB01F40)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_5_OFFSET UNITYSDK_OFFSET(0x1CB01FA0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_6_OFFSET UNITYSDK_OFFSET(0x1CB02020)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_7_OFFSET UNITYSDK_OFFSET(0x1CB01BE0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1CB01B30)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CB02400)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_2_OFFSET UNITYSDK_OFFSET(0x1CB02500)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_3_OFFSET UNITYSDK_OFFSET(0x1CB02510)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_4_OFFSET UNITYSDK_OFFSET(0x1CB025C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_5_OFFSET UNITYSDK_OFFSET(0x1CB02620)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_6_OFFSET UNITYSDK_OFFSET(0x1CB026A0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_7_OFFSET UNITYSDK_OFFSET(0x1CB02230)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_OFFSET UNITYSDK_OFFSET(0x1CB02190)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPRIVILEGED_OFFSET UNITYSDK_OFFSET(0x1CB006F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDUNPRIVILEGED_OFFSET UNITYSDK_OFFSET(0x1CB01080)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_1_OFFSET UNITYSDK_OFFSET(0x1CB00230)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_2_OFFSET UNITYSDK_OFFSET(0x1CB00300)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_3_OFFSET UNITYSDK_OFFSET(0x1CB004F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_4_OFFSET UNITYSDK_OFFSET(0x1CB00570)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_5_OFFSET UNITYSDK_OFFSET(0x1CB005F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_6_OFFSET UNITYSDK_OFFSET(0x1CB00690)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_7_OFFSET UNITYSDK_OFFSET(0x1CB00370)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_OFFSET UNITYSDK_OFFSET(0x1CB00160)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CB00100)
#define SYSTEM_NET_NETWORKINFORMATION_PING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CAFFD10)
#define SYSTEM_NET_NETWORKINFORMATION_PING__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFFE20)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Ping_TypeDefinitionIndex)->GetStaticField(0x2850);
		}
		...
		::System::Net::NetworkInformation::PingCompletedEventHandler* PingCompleted; // 0x40
