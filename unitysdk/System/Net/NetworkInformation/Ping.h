...
#define SYSTEM_NET_NETWORKINFORMATION_PING_ADD_PINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1DEC7070)
#define SYSTEM_NET_NETWORKINFORMATION_PING_BUILDPINGARGS_OFFSET UNITYSDK_OFFSET(0x1DEC8CF0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_CAPGET_OFFSET UNITYSDK_OFFSET(0x1DEC7360)
#define SYSTEM_NET_NETWORKINFORMATION_PING_CHECKLINUXCAPABILITIES_OFFSET UNITYSDK_OFFSET(0x1DEC73E0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ONPINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1DEC7560)
#define SYSTEM_NET_NETWORKINFORMATION_PING_REMOVE_PINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1DEC70F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNCCANCEL_OFFSET UNITYSDK_OFFSET(0x1DEC94F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1DEC91C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_2_OFFSET UNITYSDK_OFFSET(0x1DEC92C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_3_OFFSET UNITYSDK_OFFSET(0x1DEC92D0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_4_OFFSET UNITYSDK_OFFSET(0x1DEC9380)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_5_OFFSET UNITYSDK_OFFSET(0x1DEC93E0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_6_OFFSET UNITYSDK_OFFSET(0x1DEC9470)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_7_OFFSET UNITYSDK_OFFSET(0x1DEC9020)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1DEC8F70)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_1_OFFSET UNITYSDK_OFFSET(0x1DEC9850)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_2_OFFSET UNITYSDK_OFFSET(0x1DEC9950)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_3_OFFSET UNITYSDK_OFFSET(0x1DEC9960)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_4_OFFSET UNITYSDK_OFFSET(0x1DEC9A10)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_5_OFFSET UNITYSDK_OFFSET(0x1DEC9A70)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_6_OFFSET UNITYSDK_OFFSET(0x1DEC9AF0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_7_OFFSET UNITYSDK_OFFSET(0x1DEC9680)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_OFFSET UNITYSDK_OFFSET(0x1DEC95E0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPRIVILEGED_OFFSET UNITYSDK_OFFSET(0x1DEC7B40)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDUNPRIVILEGED_OFFSET UNITYSDK_OFFSET(0x1DEC84B0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_1_OFFSET UNITYSDK_OFFSET(0x1DEC7680)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_2_OFFSET UNITYSDK_OFFSET(0x1DEC7750)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_3_OFFSET UNITYSDK_OFFSET(0x1DEC7940)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_4_OFFSET UNITYSDK_OFFSET(0x1DEC79C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_5_OFFSET UNITYSDK_OFFSET(0x1DEC7A40)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_6_OFFSET UNITYSDK_OFFSET(0x1DEC7AE0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_7_OFFSET UNITYSDK_OFFSET(0x1DEC77C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_OFFSET UNITYSDK_OFFSET(0x1DEC75B0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DEC7550)
#define SYSTEM_NET_NETWORKINFORMATION_PING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEC7170)
#define SYSTEM_NET_NETWORKINFORMATION_PING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC7280)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Ping_TypeDefinitionIndex = 3818;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(Ping_TypeDefinitionIndex)->GetStaticField(0x2850);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_PingBinPaths()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Ping_TypeDefinitionIndex)->GetStaticField(0x2858);
		}
		static ::System::String** StaticGet_PingBinPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Ping_TypeDefinitionIndex)->GetStaticField(0x2860);
		}
		...
		::System::ComponentModel::BackgroundWorker* worker; // 0x28
		::System::Object* user_async_state; // 0x30
		::System::Net::NetworkInformation::PingCompletedEventHandler* PingCompleted; // 0x38
		::System::Threading::CancellationTokenSource* cts; // 0x40
