...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ADDRESSPREFERREDLIFETIME_OFFSET UNITYSDK_OFFSET(0x19E38B30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ADDRESSVALIDLIFETIME_OFFSET UNITYSDK_OFFSET(0x19E38B40)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x19E38B00)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_DHCPLEASELIFETIME_OFFSET UNITYSDK_OFFSET(0x19E38B50)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_DUPLICATEADDRESSDETECTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19E38B60)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_IPV4MASK_OFFSET UNITYSDK_OFFSET(0x19E38B70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x19E38B10)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x19E38B20)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_PREFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x19E38BF0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_SUFFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x19E38C00)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_PREFIXLENGTHTOSUBNETMASK_OFFSET UNITYSDK_OFFSET(0x19E38A30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E389D0)
