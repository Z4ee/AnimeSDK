...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ADDRESSPREFERREDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C1D0B90)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ADDRESSVALIDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C1D0BA0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1C1D0B60)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_DHCPLEASELIFETIME_OFFSET UNITYSDK_OFFSET(0x1C1D0BB0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_DUPLICATEADDRESSDETECTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1C1D0BC0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_IPV4MASK_OFFSET UNITYSDK_OFFSET(0x1C1D0BD0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x1C1D0B70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x1C1D0B80)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_PREFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x1C1D0C50)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_GET_SUFFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x1C1D0C60)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION_PREFIXLENGTHTOSUBNETMASK_OFFSET UNITYSDK_OFFSET(0x1C1D0A90)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UNICASTIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1D0A30)
