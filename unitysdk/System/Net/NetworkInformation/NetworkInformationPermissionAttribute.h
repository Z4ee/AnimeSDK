...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1CC19820)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x1CC19800)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_SET_ACCESS_OFFSET UNITYSDK_OFFSET(0x1CC19810)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC197F0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int NetworkInformationPermissionAttribute_TypeDefinitionIndex = 3729;
