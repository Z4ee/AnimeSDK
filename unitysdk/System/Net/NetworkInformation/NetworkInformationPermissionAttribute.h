...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1B7654F0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x1B7654D0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_SET_ACCESS_OFFSET UNITYSDK_OFFSET(0x1B7654E0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7654C0)
