...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYEVENTARGS_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1A32CF10)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A32CF20)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32CEB0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int NetworkAvailabilityEventArgs_TypeDefinitionIndex = 3725;
