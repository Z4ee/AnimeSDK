...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESSPREFERREDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D40F9C0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESSVALIDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D40F9B0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1D40F920)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_DHCPLEASELIFETIME_OFFSET UNITYSDK_OFFSET(0x1D40F9D0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_DUPLICATEADDRESSDETECTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1D40F9A0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x1D40F960)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x1D40F940)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_PREFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x1D40F980)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_SUFFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x1D40F990)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_TOMULTICASTIPADDRESSINFORMATIONCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D40F9E0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D40F910)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40F900)
