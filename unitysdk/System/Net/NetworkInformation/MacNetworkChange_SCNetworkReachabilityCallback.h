...
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A10ACE0)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A10AD90)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A10A950)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10A940)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int MacNetworkChange_SCNetworkReachabilityCallback_TypeDefinitionIndex = 3802;
