...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_ADDSUBSEQUENTLYSTRING_OFFSET UNITYSDK_OFFSET(0x1B1CD9C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMANYCAST_OFFSET UNITYSDK_OFFSET(0x1B1CDD40)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMDNSSERVER_OFFSET UNITYSDK_OFFSET(0x1B1CDF10)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMSOCKETADDRESS_OFFSET UNITYSDK_OFFSET(0x1B1CE0E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMWINSSERVER_OFFSET UNITYSDK_OFFSET(0x1B1CE1C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1CE390)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1CD910)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1CDB80)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CD8C0)
