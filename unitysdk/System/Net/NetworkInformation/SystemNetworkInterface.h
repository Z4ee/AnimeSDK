...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETMASK_OFFSET UNITYSDK_OFFSET(0x1AA9E4E0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETWORKINTERFACES_OFFSET UNITYSDK_OFFSET(0x1AA9E330)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALIPV6LOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1AA9E490)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALLOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1AA9E400)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_INTERNALGETISNETWORKAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AA9E3F0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA9E570)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int SystemNetworkInterface_TypeDefinitionIndex = 3808;
