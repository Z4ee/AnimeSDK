...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETMASK_OFFSET UNITYSDK_OFFSET(0x1E28C950)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETWORKINTERFACES_OFFSET UNITYSDK_OFFSET(0x1E28C7A0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALIPV6LOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1E28C900)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALLOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x1E28C870)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_INTERNALGETISNETWORKAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1E28C860)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E28C9E0)
