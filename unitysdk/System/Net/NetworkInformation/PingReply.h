...
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GETIPSTATUS_OFFSET UNITYSDK_OFFSET(0x1D6AEE70)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1D6AEEF0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1D6AEF20)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1D6AEF10)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_ROUNDTRIPTIME_OFFSET UNITYSDK_OFFSET(0x1D6AEF00)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1D6AEEE0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D6AECE0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D6AED30)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D6AEEC0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AECD0)
