...
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GETIPSTATUS_OFFSET UNITYSDK_OFFSET(0x19EF43C0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x19EF4470)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19EF44A0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x19EF4490)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_ROUNDTRIPTIME_OFFSET UNITYSDK_OFFSET(0x19EF4480)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x19EF4460)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EF4200)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19EF4250)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19EF4440)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF41F0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int PingReply_TypeDefinitionIndex = 3737;
	...
	public:
		...
		::System::Net::NetworkInformation::PingOptions* options; // 0x20
		::System::Net::NetworkInformation::IPStatus ipStatus; // 0x28
		::System::Int64 rtt; // 0x30
