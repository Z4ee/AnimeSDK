...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GETPERADAPTERINFO_OFFSET UNITYSDK_OFFSET(0x1B766190)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1B7664E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGACTIVE_OFFSET UNITYSDK_OFFSET(0x1B7664F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGENABLED_OFFSET UNITYSDK_OFFSET(0x1B766520)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISDHCPENABLED_OFFSET UNITYSDK_OFFSET(0x1B766550)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x1B766560)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x1B766580)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_USESWINS_OFFSET UNITYSDK_OFFSET(0x1B766590)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B766290)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Net::NetworkInformation::Win32_MIB_IFROW mib; // 0x118
