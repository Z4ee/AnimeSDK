...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GETPERADAPTERINFO_OFFSET UNITYSDK_OFFSET(0x193BAA30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x193BAD70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGACTIVE_OFFSET UNITYSDK_OFFSET(0x193BAD80)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGENABLED_OFFSET UNITYSDK_OFFSET(0x193BADB0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISDHCPENABLED_OFFSET UNITYSDK_OFFSET(0x193BADE0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x193BADF0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x193BAE10)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES_GET_USESWINS_OFFSET UNITYSDK_OFFSET(0x193BAE20)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x193BAB30)
