...
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_BEGINGETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D5D3FF0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_ENDGETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D5D4040)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETIPGLOBALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D5D3F20)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETUNICASTADDRESSESASYNC_OFFSET UNITYSDK_OFFSET(0x1D5D4090)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D5D3FA0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GET_PLATFORMNEEDSLIBCWORKAROUND_OFFSET UNITYSDK_OFFSET(0x1D5D3F10)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_INTERNALGETIPGLOBALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D5D3F60)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D4240)
