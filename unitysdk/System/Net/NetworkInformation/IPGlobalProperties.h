...
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_BEGINGETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1EC510)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_ENDGETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1EC560)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETIPGLOBALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B1EC440)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETUNICASTADDRESSESASYNC_OFFSET UNITYSDK_OFFSET(0x1B1EC5B0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1EC4C0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GET_PLATFORMNEEDSLIBCWORKAROUND_OFFSET UNITYSDK_OFFSET(0x1B1EC430)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_INTERNALGETIPGLOBALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B1EC480)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EC760)
