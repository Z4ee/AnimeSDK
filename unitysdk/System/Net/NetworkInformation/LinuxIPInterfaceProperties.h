...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C49DA40)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C49DF70)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_PARSEROUTEINFO_OFFSET UNITYSDK_OFFSET(0x1C49DAB0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49D9D0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int LinuxIPInterfaceProperties_TypeDefinitionIndex = 3768;
