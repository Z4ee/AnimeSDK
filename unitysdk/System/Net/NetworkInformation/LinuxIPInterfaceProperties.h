...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D895480)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D8959C0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_PARSEROUTEINFO_OFFSET UNITYSDK_OFFSET(0x1D8954F0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D895410)
