...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV6INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1AA9E5E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV6INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x1AA9E5F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPV6INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9E590)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32IPv6InterfaceProperties_TypeDefinitionIndex = 3780;
