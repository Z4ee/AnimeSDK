...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMGATEWAYIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1E97D120)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMGATEWAYIPADDRESSINFORMATION_TOGATEWAYIPADDRESSINFORMATIONCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1E97D130)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMGATEWAYIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E97D110)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int SystemGatewayIPAddressInformation_TypeDefinitionIndex = 3740;
