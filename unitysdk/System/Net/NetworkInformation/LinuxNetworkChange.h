...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ADD_NETWORKADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1C027FA0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ADD_NETWORKAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C0281D0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_CLOSENLSOCKET_OFFSET UNITYSDK_OFFSET(0x1C028940)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_CREATENLSOCKET_OFFSET UNITYSDK_OFFSET(0x1C0287A0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C028420)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ENSURESOCKET_OFFSET UNITYSDK_OFFSET(0x1C028430)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_GETAVAILABILITY_OFFSET UNITYSDK_OFFSET(0x1C0289C0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_GET_HASREGISTEREDEVENTS_OFFSET UNITYSDK_OFFSET(0x1C028400)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_MAYBECLOSESOCKET_OFFSET UNITYSDK_OFFSET(0x1C028820)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ONADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1C028B10)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ONAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C028A60)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ONDATAAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1C028E80)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_ONEVENTDUE_OFFSET UNITYSDK_OFFSET(0x1C028B80)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1C028D20)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_READEVENTS_OFFSET UNITYSDK_OFFSET(0x1C028F90)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_REGISTER_1_OFFSET UNITYSDK_OFFSET(0x1C028250)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_REGISTER_OFFSET UNITYSDK_OFFSET(0x1C028020)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_REMOVE_NETWORKADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1C0280A0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_REMOVE_NETWORKAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C0282D0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_UNREGISTER_1_OFFSET UNITYSDK_OFFSET(0x1C0282E0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1C0280B0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C029030)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Threading::Timer* timer; // 0x18
		::System::Net::NetworkInformation::NetworkAvailabilityChangedEventHandler* AvailabilityChanged; // 0x20
		::System::Net::NetworkInformation::NetworkAddressChangedEventHandler* AddressChanged; // 0x28
		::System::Net::Sockets::SocketAsyncEventArgs* nl_args; // 0x30
		::System::Object* _lock; // 0x38
