...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x18FC0380)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x18FC0450)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_TCPINFO_OFFSET UNITYSDK_OFFSET(0x18FC0520)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC06F0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32IPGlobalProperties_Win32_MIB_TCPROW_TypeDefinitionIndex = 3761;
