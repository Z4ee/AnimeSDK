...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x1B1CE4B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1B1CE580)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_TCPINFO_OFFSET UNITYSDK_OFFSET(0x1B1CE650)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CE820)
