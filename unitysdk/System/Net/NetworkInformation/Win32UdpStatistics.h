...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_DATAGRAMSRECEIVED_OFFSET UNITYSDK_OFFSET(0x1A257440)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_DATAGRAMSSENT_OFFSET UNITYSDK_OFFSET(0x1A257450)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_INCOMINGDATAGRAMSDISCARDED_OFFSET UNITYSDK_OFFSET(0x1A257460)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_INCOMINGDATAGRAMSWITHERRORS_OFFSET UNITYSDK_OFFSET(0x1A257470)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_UDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x1A257480)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A257430)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32UdpStatistics_TypeDefinitionIndex = 3831;
