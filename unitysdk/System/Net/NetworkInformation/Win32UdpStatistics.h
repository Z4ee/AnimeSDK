...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_DATAGRAMSRECEIVED_OFFSET UNITYSDK_OFFSET(0x1C665140)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_DATAGRAMSSENT_OFFSET UNITYSDK_OFFSET(0x1C665150)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_INCOMINGDATAGRAMSDISCARDED_OFFSET UNITYSDK_OFFSET(0x1C665160)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_INCOMINGDATAGRAMSWITHERRORS_OFFSET UNITYSDK_OFFSET(0x1C665170)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_UDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x1C665180)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C665130)
