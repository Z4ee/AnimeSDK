...
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C49FF00)
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C49FF50)
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C49FFE0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49FE40)
