...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETADAPTERSINFO_1_OFFSET UNITYSDK_OFFSET(0x1D898BB0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETADAPTERSINFO_OFFSET UNITYSDK_OFFSET(0x1D898960)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIFENTRY_OFFSET UNITYSDK_OFFSET(0x1D898A30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIPPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D8991E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x1D8991F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETPHYSICALADDRESS_OFFSET UNITYSDK_OFFSET(0x1D899200)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D8992B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_ID_OFFSET UNITYSDK_OFFSET(0x1D8992C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x1D8992D0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D8992E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NETWORKINTERFACETYPE_OFFSET UNITYSDK_OFFSET(0x1D8992F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_OPERATIONALSTATUS_OFFSET UNITYSDK_OFFSET(0x1D899300)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1D899310)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_SUPPORTSMULTICAST_OFFSET UNITYSDK_OFFSET(0x1D899330)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1D899280)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D898E80)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Net::NetworkInformation::Win32IPv4InterfaceStatistics* ip4stats; // 0xF8
