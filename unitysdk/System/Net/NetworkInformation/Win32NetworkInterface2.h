...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIFENTRY_OFFSET UNITYSDK_OFFSET(0x1E9A8D30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETPHYSICALADDRESS_OFFSET UNITYSDK_OFFSET(0x1E9A8EB0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1E9A8F30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NETWORKINTERFACETYPE_OFFSET UNITYSDK_OFFSET(0x1E9A8F40)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_OPERATIONALSTATUS_OFFSET UNITYSDK_OFFSET(0x1E9A8F50)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9A7900)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32NetworkInterface2_TypeDefinitionIndex = 2962;
	...
	public:
		...
		::System::Net::NetworkInformation::IPInterfaceProperties* ip_if_props; // 0x88
		::System::Net::NetworkInformation::Win32_IP_ADAPTER_ADDRESSES addr; // 0x90
		::System::Net::NetworkInformation::Win32_MIB_IFROW mib4; // 0x198
