...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETADAPTERSINFO_1_OFFSET UNITYSDK_OFFSET(0x1A10DB70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETADAPTERSINFO_OFFSET UNITYSDK_OFFSET(0x1A10D920)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIFENTRY_OFFSET UNITYSDK_OFFSET(0x1A10D9F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIPPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A10E1A0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x1A10E1B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETPHYSICALADDRESS_OFFSET UNITYSDK_OFFSET(0x1A10E1C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A10E270)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A10E280)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x1A10E290)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A10E2A0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NETWORKINTERFACETYPE_OFFSET UNITYSDK_OFFSET(0x1A10E2B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_OPERATIONALSTATUS_OFFSET UNITYSDK_OFFSET(0x1A10E2C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A10E2D0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_SUPPORTSMULTICAST_OFFSET UNITYSDK_OFFSET(0x1A10E2F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1A10E240)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10DE60)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32NetworkInterface2_TypeDefinitionIndex = 3818;
	...
	public:
		...
		::System::Net::NetworkInformation::Win32_MIB_IFROW mib4; // 0x88
