...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE_GETNETWORKPARAMS_OFFSET UNITYSDK_OFFSET(0x1A10D5E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE_GET_FIXEDINFO_OFFSET UNITYSDK_OFFSET(0x1A10D6B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A10D910)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10D900)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32NetworkInterface_TypeDefinitionIndex = 3835;
