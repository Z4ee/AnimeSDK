...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE_GETNETWORKPARAMS_OFFSET UNITYSDK_OFFSET(0x1C4A0C60)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE_GET_FIXEDINFO_OFFSET UNITYSDK_OFFSET(0x1C4A0D30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0F90)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0F80)
