...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_ADDADDRESS_OFFSET UNITYSDK_OFFSET(0x1BEE4010)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GETPHYSICALADDRESS_OFFSET UNITYSDK_OFFSET(0x1BEE4080)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1BEE4230)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1BEE4240)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x1BEE4250)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_NAMEINDEX_OFFSET UNITYSDK_OFFSET(0x1BEE4290)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BEE4260)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_NETWORKINTERFACETYPE_OFFSET UNITYSDK_OFFSET(0x1BEE4270)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1BEE4280)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_SETLINKLAYERINFO_OFFSET UNITYSDK_OFFSET(0x1BEE4070)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1BEE4100)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEE3F90)
