...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_ADDADDRESS_OFFSET UNITYSDK_OFFSET(0x1D255C00)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GETPHYSICALADDRESS_OFFSET UNITYSDK_OFFSET(0x1D255C70)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D255E20)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1D255E30)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x1D255E40)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_NAMEINDEX_OFFSET UNITYSDK_OFFSET(0x1D255E80)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D255E50)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_NETWORKINTERFACETYPE_OFFSET UNITYSDK_OFFSET(0x1D255E60)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1D255E70)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_SETLINKLAYERINFO_OFFSET UNITYSDK_OFFSET(0x1D255C60)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1D255CF0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXNETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D255B80)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int UnixNetworkInterface_TypeDefinitionIndex = 3814;
	...
	public:
		...
		::System::Net::NetworkInformation::IPInterfaceProperties* ipproperties; // 0x20
		::System::Net::NetworkInformation::IPv4InterfaceStatistics* ipv4stats; // 0x28
