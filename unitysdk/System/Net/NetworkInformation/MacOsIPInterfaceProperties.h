...
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A7EAD00)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A7EAD80)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_PARSEROUTEINFO_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A7EAD70)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7EAC90)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int MacOsIPInterfaceProperties_TypeDefinitionIndex = 3770;
