...
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CAFE860)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1CAFE8E0)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_PARSEROUTEINFO_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1CAFE8D0)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFE7F0)
