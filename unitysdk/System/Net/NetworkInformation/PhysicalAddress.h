...
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AFE7BB0)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_GETADDRESSBYTES_OFFSET UNITYSDK_OFFSET(0x1AFE7E60)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AFE77F0)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_PARSE_OFFSET UNITYSDK_OFFSET(0x1AFE7EE0)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AFE7C70)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFE8350)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE77E0)
