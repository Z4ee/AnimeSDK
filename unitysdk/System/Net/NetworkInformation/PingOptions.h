...
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x193BA600)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_TTL_OFFSET UNITYSDK_OFFSET(0x193BA580)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x193BA610)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_TTL_OFFSET UNITYSDK_OFFSET(0x193BA590)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193BA570)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x193BA4F0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int PingOptions_TypeDefinitionIndex = 3736;
