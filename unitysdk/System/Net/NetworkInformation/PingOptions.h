...
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1CC1A0A0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_TTL_OFFSET UNITYSDK_OFFSET(0x1CC1A020)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1CC1A0B0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_TTL_OFFSET UNITYSDK_OFFSET(0x1CC1A030)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC1A010)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC19F90)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Int32 ttl; // 0x10
		::System::Boolean dontFragment; // 0x14
