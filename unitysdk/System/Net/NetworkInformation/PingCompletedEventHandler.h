...
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC19F40)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC19F80)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC199B0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC19990)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int PingCompletedEventHandler_TypeDefinitionIndex = 3825;
