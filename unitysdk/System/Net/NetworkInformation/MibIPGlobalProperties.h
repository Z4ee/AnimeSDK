...
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1360C0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A135710)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(MibIPGlobalProperties_TypeDefinitionIndex)->GetStaticField(0x140A0);
		}
		::System::String* StatisticsFileIPv6; // 0x10
		::System::String* StatisticsFile; // 0x18
		::System::String* TcpFile; // 0x20
		::System::String* Tcp6File; // 0x28
		::System::String* UdpFile; // 0x30
		::System::String* Udp6File; // 0x38
