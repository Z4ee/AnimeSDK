...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_DDNSENABLED_OFFSET UNITYSDK_OFFSET(0x958630)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_DHCPENABLED_OFFSET UNITYSDK_OFFSET(0x958640)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x958650)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_NOMULTICAST_OFFSET UNITYSDK_OFFSET(0x958660)
