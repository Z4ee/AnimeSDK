...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_DDNSENABLED_OFFSET UNITYSDK_OFFSET(0x8AD9B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_DHCPENABLED_OFFSET UNITYSDK_OFFSET(0x8AD9C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x8AD9D0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_NOMULTICAST_OFFSET UNITYSDK_OFFSET(0x8AD9E0)
