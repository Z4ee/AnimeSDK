...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_UDP6ROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x1A10CDB0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_UDP6ROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10CEA0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32IPGlobalProperties_Win32_MIB_UDP6ROW_TypeDefinitionIndex = 3764;
