...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32LENGTHFLAGSUNION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x9D4F70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32LENGTHFLAGSUNION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x9D4F80)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32LengthFlagsUnion_TypeDefinitionIndex = 3841;
