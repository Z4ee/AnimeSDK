...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32LENGTHFLAGSUNION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x9854F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32LENGTHFLAGSUNION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x985500)
