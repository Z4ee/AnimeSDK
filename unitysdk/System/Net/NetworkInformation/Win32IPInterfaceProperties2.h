...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C70F680)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GETIPV6PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C70F750)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_ANYCASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C70F830)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_DHCPSERVERADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C70FA30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_DNSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C70FB60)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_DNSSUFFIX_OFFSET UNITYSDK_OFFSET(0x1C70FBC0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C70FBD0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_ISDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1C70FE30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_ISDYNAMICDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1C70FE50)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_MULTICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C70FE60)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_UNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C710080)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_WINSSERVERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C7103A0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_WIN32FROMANYCAST_OFFSET UNITYSDK_OFFSET(0x1C70F840)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_WIN32FROMMULTICAST_OFFSET UNITYSDK_OFFSET(0x1C70FE70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_WIN32FROMUNICAST_OFFSET UNITYSDK_OFFSET(0x1C710150)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C70F5B0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32IPInterfaceProperties2_TypeDefinitionIndex = 3770;
	...
	public:
		...
		::System::Net::NetworkInformation::Win32_MIB_IFROW mib6; // 0x118
