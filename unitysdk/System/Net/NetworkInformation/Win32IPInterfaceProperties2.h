...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B1CE8F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GETIPV6PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B1CE9C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_ANYCASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CEA90)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_DHCPSERVERADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CEC90)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_DNSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CEDC0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_DNSSUFFIX_OFFSET UNITYSDK_OFFSET(0x1B1CEE30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CEE40)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_ISDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1B1CF0A0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_ISDYNAMICDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1B1CF0C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_MULTICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CF0D0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_UNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CF2F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_GET_WINSSERVERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B1CF610)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_WIN32FROMANYCAST_OFFSET UNITYSDK_OFFSET(0x1B1CEAA0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_WIN32FROMMULTICAST_OFFSET UNITYSDK_OFFSET(0x1B1CF0E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2_WIN32FROMUNICAST_OFFSET UNITYSDK_OFFSET(0x1B1CF3C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPINTERFACEPROPERTIES2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CE830)
