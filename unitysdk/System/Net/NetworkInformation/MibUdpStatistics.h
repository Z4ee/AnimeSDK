...
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_DATAGRAMSRECEIVED_OFFSET UNITYSDK_OFFSET(0x1E97C490)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_DATAGRAMSSENT_OFFSET UNITYSDK_OFFSET(0x1E97C540)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_INCOMINGDATAGRAMSDISCARDED_OFFSET UNITYSDK_OFFSET(0x1E97C5F0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_INCOMINGDATAGRAMSWITHERRORS_OFFSET UNITYSDK_OFFSET(0x1E97C6A0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_OFFSET UNITYSDK_OFFSET(0x1E97C410)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_UDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x1E97C750)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E97C400)
