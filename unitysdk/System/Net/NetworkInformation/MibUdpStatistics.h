...
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_DATAGRAMSRECEIVED_OFFSET UNITYSDK_OFFSET(0x1D5D5DA0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_DATAGRAMSSENT_OFFSET UNITYSDK_OFFSET(0x1D5D5E50)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_INCOMINGDATAGRAMSDISCARDED_OFFSET UNITYSDK_OFFSET(0x1D5D5F00)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_INCOMINGDATAGRAMSWITHERRORS_OFFSET UNITYSDK_OFFSET(0x1D5D5FB0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_OFFSET UNITYSDK_OFFSET(0x1D5D5D20)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS_GET_UDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x1D5D6060)
#define SYSTEM_NET_NETWORKINFORMATION_MIBUDPSTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D5D10)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int MibUdpStatistics_TypeDefinitionIndex = 3829;
