...
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GETDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x196164D0)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GET_DOMAINNAME_OFFSET UNITYSDK_OFFSET(0x19616560)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x196168F0)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int CommonUnixIPGlobalProperties_TypeDefinitionIndex = 2931;
