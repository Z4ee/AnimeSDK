...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A57F770)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGACTIVE_OFFSET UNITYSDK_OFFSET(0x1A57F820)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGENABLED_OFFSET UNITYSDK_OFFSET(0x1A57F830)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISDHCPENABLED_OFFSET UNITYSDK_OFFSET(0x1A57F840)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_USESWINS_OFFSET UNITYSDK_OFFSET(0x1A57F850)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A57F760)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int UnixIPv4InterfaceProperties_TypeDefinitionIndex = 3772;
