...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1DD24EA0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGACTIVE_OFFSET UNITYSDK_OFFSET(0x1DD24F50)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGENABLED_OFFSET UNITYSDK_OFFSET(0x1DD24F60)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISDHCPENABLED_OFFSET UNITYSDK_OFFSET(0x1DD24F70)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_USESWINS_OFFSET UNITYSDK_OFFSET(0x1DD24F80)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD24E90)
