...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x193BA630)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x193BA720)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_TCPINFO_OFFSET UNITYSDK_OFFSET(0x193BA810)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193BAA20)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32IPGlobalProperties_Win32_MIB_TCP6ROW_TypeDefinitionIndex = 3762;
