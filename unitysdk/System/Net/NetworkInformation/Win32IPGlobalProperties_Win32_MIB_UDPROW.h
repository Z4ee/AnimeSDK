...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_UDPROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x19EF5550)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_UDPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF5620)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int Win32IPGlobalProperties_Win32_MIB_UDPROW_TypeDefinitionIndex = 3763;
