...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GETIPV6PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D6AEF40)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ANYCASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D6AF790)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DHCPSERVERADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D6AF910)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D6AF990)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSSUFFIX_OFFSET UNITYSDK_OFFSET(0x1D6AF9B0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1D6AF9D0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDYNAMICDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1D6AF9E0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_MULTICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D6AF9F0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_UNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D6AFBE0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_WINSSERVERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1D6AFE00)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_PARSERESOLVCONF_OFFSET UNITYSDK_OFFSET(0x1D6AEF90)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6AFE80)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AEF30)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int UnixIPInterfaceProperties_TypeDefinitionIndex = 3767;
	...
	public:
		...
		::System::Net::NetworkInformation::IPAddressCollection* dns_servers; // 0x10
		::System::String* dns_suffix; // 0x18
		::System::Net::NetworkInformation::IPv4InterfaceProperties* ipv4iface_properties; // 0x20
		::System::Net::NetworkInformation::UnixNetworkInterface* iface; // 0x28
		::System::Collections::Generic::List_1<::System::Net::IPAddress*>* addresses; // 0x30
