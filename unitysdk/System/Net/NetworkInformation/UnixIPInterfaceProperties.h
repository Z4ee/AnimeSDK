...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GETIPV6PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C2EE120)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ANYCASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C2EE970)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DHCPSERVERADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C2EEAF0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C2EEB70)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSSUFFIX_OFFSET UNITYSDK_OFFSET(0x1C2EEB90)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1C2EEBB0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDYNAMICDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1C2EEBC0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_MULTICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C2EEBD0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_UNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C2EEDC0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_WINSSERVERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C2EEFE0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_PARSERESOLVCONF_OFFSET UNITYSDK_OFFSET(0x1C2EE170)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2EF060)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2EE110)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Net::NetworkInformation::IPAddressCollection* dns_servers; // 0x18
		::System::String* dns_suffix; // 0x20
