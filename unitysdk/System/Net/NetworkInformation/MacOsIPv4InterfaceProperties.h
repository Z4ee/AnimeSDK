...
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x1C70DC00)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x1C70DC10)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C70DBF0)
