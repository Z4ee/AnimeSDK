...
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x1B1CCE20)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x1B1CCE30)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CCE10)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int MacOsIPv4InterfaceProperties_TypeDefinitionIndex = 3773;
