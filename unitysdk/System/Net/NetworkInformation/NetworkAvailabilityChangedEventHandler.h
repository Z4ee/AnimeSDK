...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C881F20)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C881F60)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C881990)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKAVAILABILITYCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C881970)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int NetworkAvailabilityChangedEventHandler_TypeDefinitionIndex = 3726;
