...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x1B7651B0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x1B7652B0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7651A0)
