...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x193B9A60)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x193B9B60)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x193B9A50)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int LinuxIPv4InterfaceProperties_TypeDefinitionIndex = 3773;
