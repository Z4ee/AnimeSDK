...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1B1EF290)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x1B1EF2B0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x1B1EF2A0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EF280)

namespace System::Net::NetworkInformation
{
	inline static constexpr unsigned int SystemIPAddressInformation_TypeDefinitionIndex = 3742;
