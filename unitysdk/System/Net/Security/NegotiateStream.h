...
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A258470)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_2_OFFSET UNITYSDK_OFFSET(0x1A258670)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_3_OFFSET UNITYSDK_OFFSET(0x1A258800)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_4_OFFSET UNITYSDK_OFFSET(0x1A258850)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x1A2582E0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x1A257DA0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_2_OFFSET UNITYSDK_OFFSET(0x1A257DF0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_3_OFFSET UNITYSDK_OFFSET(0x1A257E40)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_4_OFFSET UNITYSDK_OFFSET(0x1A257E90)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1A257D50)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A258A30)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_2_OFFSET UNITYSDK_OFFSET(0x1A258A80)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_3_OFFSET UNITYSDK_OFFSET(0x1A258AD0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_OFFSET UNITYSDK_OFFSET(0x1A2588A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x1A257F30)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_2_OFFSET UNITYSDK_OFFSET(0x1A257F80)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_3_OFFSET UNITYSDK_OFFSET(0x1A257FD0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1A257EE0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x1A257A30)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_2_OFFSET UNITYSDK_OFFSET(0x1A257A80)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_3_OFFSET UNITYSDK_OFFSET(0x1A257AD0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_4_OFFSET UNITYSDK_OFFSET(0x1A257B20)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1A2579E0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x1A257C10)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_2_OFFSET UNITYSDK_OFFSET(0x1A257C60)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_3_OFFSET UNITYSDK_OFFSET(0x1A257CB0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1A257BC0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1A257B70)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1A257D00)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A258020)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1A258030)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1A2580D0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1A258080)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1A258120)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A258170)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A257600)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1A257630)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A257660)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A2576B0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1A2576E0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1A257730)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1A257780)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1A2577D0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISSERVER_OFFSET UNITYSDK_OFFSET(0x1A257820)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x1A257870)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A2578C0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A2578F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A257950)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_REMOTEIDENTITY_OFFSET UNITYSDK_OFFSET(0x1A257970)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A2579C0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1A2581A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1A2581F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A258240)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A257920)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A257960)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A2579D0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A258290)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2575F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2575E0)
