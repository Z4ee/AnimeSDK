...
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B1F0290)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B1F02F0)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B1EFBA0)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EFB90)

namespace System::Net::Security
{
	inline static constexpr unsigned int LocalCertificateSelectionCallback_TypeDefinitionIndex = 3696;
