...
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E97E3F0)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E97E450)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E97DD30)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E97DD10)
