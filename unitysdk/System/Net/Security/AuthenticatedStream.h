...
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A23A840)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_GET_INNERSTREAM_OFFSET UNITYSDK_OFFSET(0x1A2575D0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_GET_LEAVEINNERSTREAMOPEN_OFFSET UNITYSDK_OFFSET(0x1A2575C0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A236FB0)
