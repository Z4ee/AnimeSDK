...
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C648530)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_GET_INNERSTREAM_OFFSET UNITYSDK_OFFSET(0x1C6652D0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_GET_LEAVEINNERSTREAMOPEN_OFFSET UNITYSDK_OFFSET(0x1C6652C0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C644460)
