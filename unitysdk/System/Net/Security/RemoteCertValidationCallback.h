...
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A585B30)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A585BD0)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A566B00)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A585B20)

namespace System::Net::Security
{
	inline static constexpr unsigned int RemoteCertValidationCallback_TypeDefinitionIndex = 3701;
