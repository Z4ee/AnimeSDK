...
#define SYSTEM_NET_SECURITY_REMOTECERTIFICATEVALIDATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A13E050)
#define SYSTEM_NET_SECURITY_REMOTECERTIFICATEVALIDATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A13E0F0)
#define SYSTEM_NET_SECURITY_REMOTECERTIFICATEVALIDATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A13D990)
#define SYSTEM_NET_SECURITY_REMOTECERTIFICATEVALIDATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A13D970)

namespace System::Net::Security
{
	inline static constexpr unsigned int RemoteCertificateValidationCallback_TypeDefinitionIndex = 2913;
