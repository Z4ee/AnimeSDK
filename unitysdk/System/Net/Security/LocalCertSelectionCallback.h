...
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18703260)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187032B0)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18702BA0)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18702B80)

namespace System::Net::Security
{
	inline static constexpr unsigned int LocalCertSelectionCallback_TypeDefinitionIndex = 2914;
