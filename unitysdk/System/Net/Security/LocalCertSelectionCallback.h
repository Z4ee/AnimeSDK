...
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B1EFB30)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B1EFB80)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B1EF480)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EF470)

namespace System::Net::Security
{
	inline static constexpr unsigned int LocalCertSelectionCallback_TypeDefinitionIndex = 3702;
