...
#define SYSTEM_NET_SIMPLEASYNCCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19BBB380)
#define SYSTEM_NET_SIMPLEASYNCCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19BBB3B0)
#define SYSTEM_NET_SIMPLEASYNCCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BBAE80)
#define SYSTEM_NET_SIMPLEASYNCCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBAE70)

namespace System::Net
{
	inline static constexpr unsigned int SimpleAsyncCallback_TypeDefinitionIndex = 3557;
