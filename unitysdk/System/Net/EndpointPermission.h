...
#define SYSTEM_NET_ENDPOINTPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7E43E0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7E44C0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_HOSTNAME_OFFSET UNITYSDK_OFFSET(0x1A7E43B0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_PORT_OFFSET UNITYSDK_OFFSET(0x1A7E43C0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_TRANSPORT_OFFSET UNITYSDK_OFFSET(0x1A7E43D0)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECTHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1A7E5250)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x1A7E5490)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1A7E5150)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x1A7E4C70)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1A7E4840)
#define SYSTEM_NET_ENDPOINTPERMISSION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1A7E49B0)
#define SYSTEM_NET_ENDPOINTPERMISSION_TONUMBER_OFFSET UNITYSDK_OFFSET(0x1A7E4EE0)
#define SYSTEM_NET_ENDPOINTPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7E4550)
#define SYSTEM_NET_ENDPOINTPERMISSION_UNDORESOLVE_OFFSET UNITYSDK_OFFSET(0x1A7E57C0)
#define SYSTEM_NET_ENDPOINTPERMISSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7E57D0)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7E5840)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E4320)

namespace System::Net
{
	inline static constexpr unsigned int EndpointPermission_TypeDefinitionIndex = 3510;
	...
	public:
		...
		::System::Boolean resolved; // 0x20
		::System::Boolean hasWildcard; // 0x21
		::System::Int32 port; // 0x24
		::System::Net::TransportType transport; // 0x28
