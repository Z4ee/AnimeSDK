...
#define SYSTEM_NET_ENDPOINTPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEBF370)
#define SYSTEM_NET_ENDPOINTPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEBF450)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_HOSTNAME_OFFSET UNITYSDK_OFFSET(0x1DEBF340)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_PORT_OFFSET UNITYSDK_OFFSET(0x1DEBF350)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_TRANSPORT_OFFSET UNITYSDK_OFFSET(0x1DEBF360)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECTHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1DEC01D0)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x1DEC0460)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1DEC00D0)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x1DEBFC00)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1DEBF7D0)
#define SYSTEM_NET_ENDPOINTPERMISSION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1DEBF940)
#define SYSTEM_NET_ENDPOINTPERMISSION_TONUMBER_OFFSET UNITYSDK_OFFSET(0x1DEBFE70)
#define SYSTEM_NET_ENDPOINTPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEBF4E0)
#define SYSTEM_NET_ENDPOINTPERMISSION_UNDORESOLVE_OFFSET UNITYSDK_OFFSET(0x1DEC0790)
#define SYSTEM_NET_ENDPOINTPERMISSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEC07A0)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEC0810)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBF2B0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Boolean resolved; // 0x28
		::System::Boolean hasWildcard; // 0x29
