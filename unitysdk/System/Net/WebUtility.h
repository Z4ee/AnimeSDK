...
#define SYSTEM_NET_WEBUTILITY_CONVERTSMPTOUTF16_OFFSET UNITYSDK_OFFSET(0x1B774B00)
#define SYSTEM_NET_WEBUTILITY_GETNEXTUNICODESCALARVALUEFROMUTF16SURROGATE_OFFSET UNITYSDK_OFFSET(0x1B774070)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLDECODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1B774A30)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLENCODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1B773FA0)
#define SYSTEM_NET_WEBUTILITY_HEXTOINT_OFFSET UNITYSDK_OFFSET(0x1B7758F0)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x1B774380)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x1B7740D0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1B773BE0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x1B773990)
#define SYSTEM_NET_WEBUTILITY_INDEXOFHTMLENCODINGCHARS_OFFSET UNITYSDK_OFFSET(0x1B773A80)
#define SYSTEM_NET_WEBUTILITY_INTTOHEX_OFFSET UNITYSDK_OFFSET(0x1B775240)
#define SYSTEM_NET_WEBUTILITY_ISURLSAFECHAR_OFFSET UNITYSDK_OFFSET(0x1B775200)
#define SYSTEM_NET_WEBUTILITY_STRINGREQUIRESHTMLDECODING_OFFSET UNITYSDK_OFFSET(0x1B7741D0)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1B775930)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B775570)
#define SYSTEM_NET_WEBUTILITY_URLDECODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1B775D10)
#define SYSTEM_NET_WEBUTILITY_URLDECODE_OFFSET UNITYSDK_OFFSET(0x1B775BE0)
#define SYSTEM_NET_WEBUTILITY_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1B775500)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1B774C90)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_2_OFFSET UNITYSDK_OFFSET(0x1B775250)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_OFFSET UNITYSDK_OFFSET(0x1B774B40)
#define SYSTEM_NET_WEBUTILITY_VALIDATEURLENCODINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B775110)
#define SYSTEM_NET_WEBUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B775D80)
