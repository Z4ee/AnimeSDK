...
#define SYSTEM_NET_WEBUTILITY_CONVERTSMPTOUTF16_OFFSET UNITYSDK_OFFSET(0x1CC28E20)
#define SYSTEM_NET_WEBUTILITY_GETNEXTUNICODESCALARVALUEFROMUTF16SURROGATE_OFFSET UNITYSDK_OFFSET(0x1CC28390)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLDECODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1CC28D50)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLENCODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1CC282C0)
#define SYSTEM_NET_WEBUTILITY_HEXTOINT_OFFSET UNITYSDK_OFFSET(0x1CC29C00)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x1CC28690)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x1CC283F0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1CC27EF0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x1CC27C90)
#define SYSTEM_NET_WEBUTILITY_INDEXOFHTMLENCODINGCHARS_OFFSET UNITYSDK_OFFSET(0x1CC27D80)
#define SYSTEM_NET_WEBUTILITY_INTTOHEX_OFFSET UNITYSDK_OFFSET(0x1CC29550)
#define SYSTEM_NET_WEBUTILITY_ISURLSAFECHAR_OFFSET UNITYSDK_OFFSET(0x1CC29510)
#define SYSTEM_NET_WEBUTILITY_STRINGREQUIRESHTMLDECODING_OFFSET UNITYSDK_OFFSET(0x1CC284F0)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1CC29C40)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CC29880)
#define SYSTEM_NET_WEBUTILITY_URLDECODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1CC2A040)
#define SYSTEM_NET_WEBUTILITY_URLDECODE_OFFSET UNITYSDK_OFFSET(0x1CC29F10)
#define SYSTEM_NET_WEBUTILITY_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1CC29810)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1CC28FB0)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_2_OFFSET UNITYSDK_OFFSET(0x1CC29560)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_OFFSET UNITYSDK_OFFSET(0x1CC28E60)
#define SYSTEM_NET_WEBUTILITY_VALIDATEURLENCODINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1CC29420)
#define SYSTEM_NET_WEBUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC2A0B0)

namespace System::Net
{
	inline static constexpr unsigned int WebUtility_TypeDefinitionIndex = 3360;
