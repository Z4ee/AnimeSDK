...
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1921EEA0)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1921EEE0)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1921E920)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1921E910)

namespace System::Net
{
	inline static constexpr unsigned int DownloadStringCompletedEventHandler_TypeDefinitionIndex = 3462;
