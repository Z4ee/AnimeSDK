...
#define SYSTEM_NET_TIMERTHREAD_TIMER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A586580)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A586460)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_EXPIRATION_OFFSET UNITYSDK_OFFSET(0x1A586480)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A586470)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_TIMEREMAINING_OFFSET UNITYSDK_OFFSET(0x1A586490)
#define SYSTEM_NET_TIMERTHREAD_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A586410)
