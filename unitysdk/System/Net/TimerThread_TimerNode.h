...
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_CANCEL_OFFSET UNITYSDK_OFFSET(0x19BBB600)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_FIRE_OFFSET UNITYSDK_OFFSET(0x19BBB760)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_GET_HASEXPIRED_OFFSET UNITYSDK_OFFSET(0x19BBB5B0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x19BBB5C0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_GET_PREV_OFFSET UNITYSDK_OFFSET(0x19BBB5E0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_SET_NEXT_OFFSET UNITYSDK_OFFSET(0x19BBB5D0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_SET_PREV_OFFSET UNITYSDK_OFFSET(0x19BBB5F0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BBB550)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBB4D0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::TimerThread_TimerNode* next; // 0x28
