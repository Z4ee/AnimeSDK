...
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDINTERNALNOTCOMMON_OFFSET UNITYSDK_OFFSET(0x1D47B1E0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D47AEE0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDWITHOUTVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D47A430)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x1D479610)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_2_OFFSET UNITYSDK_OFFSET(0x1D4793C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_3_OFFSET UNITYSDK_OFFSET(0x1D47B720)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1D479260)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ALLOWMULTIVALUES_OFFSET UNITYSDK_OFFSET(0x1D478960)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHANGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D47B000)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHECKBADCHARS_OFFSET UNITYSDK_OFFSET(0x1D47A670)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHECKUPDATE_OFFSET UNITYSDK_OFFSET(0x1D47B170)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D47E790)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CONTAINSNONASCIICHARS_OFFSET UNITYSDK_OFFSET(0x1D47B300)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETASSTRING_OFFSET UNITYSDK_OFFSET(0x1D47BD90)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D47E2D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETKEY_OFFSET UNITYSDK_OFFSET(0x1D47CF30)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1D47CCB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETVALUES_1_OFFSET UNITYSDK_OFFSET(0x1D47E570)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1D47BA50)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_1_OFFSET UNITYSDK_OFFSET(0x1D47D040)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLKEYS_OFFSET UNITYSDK_OFFSET(0x1D47E680)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLOWHTTPREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x1D478A50)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLOWHTTPRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x1D478A80)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CACHECONTROL_OFFSET UNITYSDK_OFFSET(0x1D477D30)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1D477620)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1D477DF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D47CF00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_DATE_OFFSET UNITYSDK_OFFSET(0x1D477EB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ETAG_OFFSET UNITYSDK_OFFSET(0x1D478030)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_EXPIRES_OFFSET UNITYSDK_OFFSET(0x1D477F70)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_INNERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D478890)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1D478DA0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D478AB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1D47E420)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_LASTMODIFIED_OFFSET UNITYSDK_OFFSET(0x1D4780F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x1D4781B0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x1D4776E0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_PROXYAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1D478280)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x1D4784C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SETCOOKIE2_OFFSET UNITYSDK_OFFSET(0x1D478340)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SETCOOKIE_OFFSET UNITYSDK_OFFSET(0x1D478400)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_VIA_OFFSET UNITYSDK_OFFSET(0x1D478580)
#define SYSTEM_NET_WEBHEADERCOLLECTION_INTERNALHASKEYS_OFFSET UNITYSDK_OFFSET(0x1D47E530)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISRESTRICTED_1_OFFSET UNITYSDK_OFFSET(0x1D47C120)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1D47C0C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISVALIDTOKEN_OFFSET UNITYSDK_OFFSET(0x1D47B3B0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_NORMALIZECOMMONHEADERS_OFFSET UNITYSDK_OFFSET(0x1D478640)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ONDESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1D47CCA0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_PARSEHEADERSSTRICT_OFFSET UNITYSDK_OFFSET(0x1D47D7D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_PARSEHEADERS_OFFSET UNITYSDK_OFFSET(0x1D47D150)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D47B120)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1D47A2D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_2_OFFSET UNITYSDK_OFFSET(0x1D47A1C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D47A060)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETADDVERIFIED_OFFSET UNITYSDK_OFFSET(0x1D47AC20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1D474360)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D479E50)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_1_OFFSET UNITYSDK_OFFSET(0x1D479C40)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_2_OFFSET UNITYSDK_OFFSET(0x1D479980)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1D479030)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D478C20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_OFFSET UNITYSDK_OFFSET(0x1D479820)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1D47E2C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_THROWONRESTRICTEDHEADER_OFFSET UNITYSDK_OFFSET(0x1D47B510)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1D47C050)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1D47BFF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D47BD30)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D47E7C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D47C210)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D47C350)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D47C9A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D472210)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3A98);
		}
		static ::Il2CppArray<::System::SByte>** StaticGet_s_CommonHeaderHints()
		{
			return (::Il2CppArray<::System::SByte>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3AA0);
		}
		static ::Il2CppArray<::System::Net::WebHeaderCollection_RfcChar>** StaticGet_RfcCharMap()
		{
			return (::Il2CppArray<::System::Net::WebHeaderCollection_RfcChar>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3AA8);
		}
		static ::Il2CppArray<::System::Char>** StaticGet_HttpTrimCharacters()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3AB0);
		}
