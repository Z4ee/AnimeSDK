...
#define SYSTEM_NET_NETEVENTSOURCE_ASSOCIATE_1_OFFSET UNITYSDK_OFFSET(0x19A71720)
#define SYSTEM_NET_NETEVENTSOURCE_ASSOCIATE_2_OFFSET UNITYSDK_OFFSET(0x19A71710)
#define SYSTEM_NET_NETEVENTSOURCE_ASSOCIATE_OFFSET UNITYSDK_OFFSET(0x19A715C0)
#define SYSTEM_NET_NETEVENTSOURCE_CRITICALFAILURE_OFFSET UNITYSDK_OFFSET(0x19A70DB0)
#define SYSTEM_NET_NETEVENTSOURCE_DEBUGVALIDATEARG_1_OFFSET UNITYSDK_OFFSET(0x19A71930)
#define SYSTEM_NET_NETEVENTSOURCE_DEBUGVALIDATEARG_OFFSET UNITYSDK_OFFSET(0x19A71870)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_1_OFFSET UNITYSDK_OFFSET(0x19A70FA0)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_2_OFFSET UNITYSDK_OFFSET(0x19A71440)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_3_OFFSET UNITYSDK_OFFSET(0x19A71430)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_OFFSET UNITYSDK_OFFSET(0x19A70F30)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_1_OFFSET UNITYSDK_OFFSET(0x19A6F8F0)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_2_OFFSET UNITYSDK_OFFSET(0x19A6FF10)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_3_OFFSET UNITYSDK_OFFSET(0x19A700A0)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_4_OFFSET UNITYSDK_OFFSET(0x19A6F8E0)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_OFFSET UNITYSDK_OFFSET(0x19A6F260)
#define SYSTEM_NET_NETEVENTSOURCE_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x19A70AF0)
#define SYSTEM_NET_NETEVENTSOURCE_ERROR_1_OFFSET UNITYSDK_OFFSET(0x19A70B00)
#define SYSTEM_NET_NETEVENTSOURCE_ERROR_OFFSET UNITYSDK_OFFSET(0x19A709B0)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_1_OFFSET UNITYSDK_OFFSET(0x19A703C0)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_2_OFFSET UNITYSDK_OFFSET(0x19A70530)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_3_OFFSET UNITYSDK_OFFSET(0x19A703B0)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_OFFSET UNITYSDK_OFFSET(0x19A70240)
#define SYSTEM_NET_NETEVENTSOURCE_FAIL_1_OFFSET UNITYSDK_OFFSET(0x19A70DC0)
#define SYSTEM_NET_NETEVENTSOURCE_FAIL_OFFSET UNITYSDK_OFFSET(0x19A70C70)
#define SYSTEM_NET_NETEVENTSOURCE_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x19A6F520)
#define SYSTEM_NET_NETEVENTSOURCE_FORMAT_OFFSET UNITYSDK_OFFSET(0x19A6FA60)
#define SYSTEM_NET_NETEVENTSOURCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A71940)
#define SYSTEM_NET_NETEVENTSOURCE_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x19A6F3D0)
#define SYSTEM_NET_NETEVENTSOURCE_IDOF_OFFSET UNITYSDK_OFFSET(0x19A6F450)
#define SYSTEM_NET_NETEVENTSOURCE_INFO_1_OFFSET UNITYSDK_OFFSET(0x19A70840)
#define SYSTEM_NET_NETEVENTSOURCE_INFO_2_OFFSET UNITYSDK_OFFSET(0x19A70830)
#define SYSTEM_NET_NETEVENTSOURCE_INFO_OFFSET UNITYSDK_OFFSET(0x19A706C0)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_1_OFFSET UNITYSDK_OFFSET(0x19A71980)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_2_OFFSET UNITYSDK_OFFSET(0x19A71990)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_3_OFFSET UNITYSDK_OFFSET(0x19A719A0)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_4_OFFSET UNITYSDK_OFFSET(0x19A719B0)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_5_OFFSET UNITYSDK_OFFSET(0x19A719C0)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_OFFSET UNITYSDK_OFFSET(0x19A71970)
#define SYSTEM_NET_NETEVENTSOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A71A20)
#define SYSTEM_NET_NETEVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A719D0)

namespace System::Net
{
	inline static constexpr unsigned int NetEventSource_TypeDefinitionIndex = 3258;
