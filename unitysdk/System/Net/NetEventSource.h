...
#define SYSTEM_NET_NETEVENTSOURCE_ASSOCIATE_1_OFFSET UNITYSDK_OFFSET(0x1D254CC0)
#define SYSTEM_NET_NETEVENTSOURCE_ASSOCIATE_2_OFFSET UNITYSDK_OFFSET(0x1D254CB0)
#define SYSTEM_NET_NETEVENTSOURCE_ASSOCIATE_OFFSET UNITYSDK_OFFSET(0x1D254B50)
#define SYSTEM_NET_NETEVENTSOURCE_CRITICALFAILURE_OFFSET UNITYSDK_OFFSET(0x1D254330)
#define SYSTEM_NET_NETEVENTSOURCE_DEBUGVALIDATEARG_1_OFFSET UNITYSDK_OFFSET(0x1D254EF0)
#define SYSTEM_NET_NETEVENTSOURCE_DEBUGVALIDATEARG_OFFSET UNITYSDK_OFFSET(0x1D254E30)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1D254520)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_2_OFFSET UNITYSDK_OFFSET(0x1D2549D0)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_3_OFFSET UNITYSDK_OFFSET(0x1D2549C0)
#define SYSTEM_NET_NETEVENTSOURCE_DUMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1D2544B0)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_1_OFFSET UNITYSDK_OFFSET(0x1D252D10)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_2_OFFSET UNITYSDK_OFFSET(0x1D253380)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_3_OFFSET UNITYSDK_OFFSET(0x1D253560)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_4_OFFSET UNITYSDK_OFFSET(0x1D252D00)
#define SYSTEM_NET_NETEVENTSOURCE_ENTER_OFFSET UNITYSDK_OFFSET(0x1D2526C0)
#define SYSTEM_NET_NETEVENTSOURCE_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1D254060)
#define SYSTEM_NET_NETEVENTSOURCE_ERROR_1_OFFSET UNITYSDK_OFFSET(0x1D254070)
#define SYSTEM_NET_NETEVENTSOURCE_ERROR_OFFSET UNITYSDK_OFFSET(0x1D253F10)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_1_OFFSET UNITYSDK_OFFSET(0x1D2538D0)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_2_OFFSET UNITYSDK_OFFSET(0x1D253A40)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_3_OFFSET UNITYSDK_OFFSET(0x1D2538C0)
#define SYSTEM_NET_NETEVENTSOURCE_EXIT_OFFSET UNITYSDK_OFFSET(0x1D253750)
#define SYSTEM_NET_NETEVENTSOURCE_FAIL_1_OFFSET UNITYSDK_OFFSET(0x1D254340)
#define SYSTEM_NET_NETEVENTSOURCE_FAIL_OFFSET UNITYSDK_OFFSET(0x1D2541E0)
#define SYSTEM_NET_NETEVENTSOURCE_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x1D252980)
#define SYSTEM_NET_NETEVENTSOURCE_FORMAT_OFFSET UNITYSDK_OFFSET(0x1D252EC0)
#define SYSTEM_NET_NETEVENTSOURCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D254F00)
#define SYSTEM_NET_NETEVENTSOURCE_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1D252830)
#define SYSTEM_NET_NETEVENTSOURCE_IDOF_OFFSET UNITYSDK_OFFSET(0x1D2528B0)
#define SYSTEM_NET_NETEVENTSOURCE_INFO_1_OFFSET UNITYSDK_OFFSET(0x1D253DA0)
#define SYSTEM_NET_NETEVENTSOURCE_INFO_2_OFFSET UNITYSDK_OFFSET(0x1D253D90)
#define SYSTEM_NET_NETEVENTSOURCE_INFO_OFFSET UNITYSDK_OFFSET(0x1D253C20)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1D254F40)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_2_OFFSET UNITYSDK_OFFSET(0x1D254F50)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_3_OFFSET UNITYSDK_OFFSET(0x1D254F60)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_4_OFFSET UNITYSDK_OFFSET(0x1D254F70)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_5_OFFSET UNITYSDK_OFFSET(0x1D254F80)
#define SYSTEM_NET_NETEVENTSOURCE_WRITEEVENT_OFFSET UNITYSDK_OFFSET(0x1D254F30)
#define SYSTEM_NET_NETEVENTSOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D254FE0)
#define SYSTEM_NET_NETEVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D254F90)
