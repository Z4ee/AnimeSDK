...
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D626750)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D6266A0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GET_URI_OFFSET UNITYSDK_OFFSET(0x1D626620)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GET_USECONNECT_OFFSET UNITYSDK_OFFSET(0x1D626630)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GET_USESPROXY_OFFSET UNITYSDK_OFFSET(0x1D626640)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D626610)
