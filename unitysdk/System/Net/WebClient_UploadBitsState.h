...
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1DAD1380)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_GET_ASYNC_OFFSET UNITYSDK_OFFSET(0x1DAD1030)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_GET_FILEUPLOAD_OFFSET UNITYSDK_OFFSET(0x1DAD1020)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_SETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1DAD1040)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_WRITEBYTES_OFFSET UNITYSDK_OFFSET(0x1DAD1190)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAD0F60)
...
namespace System::Net
{
	...
	{
	public:
		::Il2CppArray<::System::Byte>* Footer; // 0x10
		::System::Net::CompletionDelegate* UploadCompletionDelegate; // 0x18
		::System::Net::CompletionDelegate* DownloadCompletionDelegate; // 0x20
		::System::IO::Stream* ReadStream; // 0x28
		::System::Net::WebRequest* Request; // 0x30
