...
#define SYSTEM_NET_COOKIECOLLECTION_COOKIECOLLECTIONENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19187ED0)
#define SYSTEM_NET_COOKIECOLLECTION_COOKIECOLLECTIONENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19187F90)
#define SYSTEM_NET_COOKIECOLLECTION_COOKIECOLLECTIONENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19188000)
#define SYSTEM_NET_COOKIECOLLECTION_COOKIECOLLECTIONENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19187E20)

namespace System::Net
{
	inline static constexpr unsigned int CookieCollection_CookieCollectionEnumerator_TypeDefinitionIndex = 2795;
