...
#define SYSTEM_NET_TIMERTHREAD_QUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF4070)

namespace System::Net
{
	inline static constexpr unsigned int TimerThread_Queue_TypeDefinitionIndex = 2778;
