...
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1DD2C900)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_ACCEPTPATTERN_OFFSET UNITYSDK_OFFSET(0x1DD2C6C0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1DD2C380)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_CONNECTPATTERN_OFFSET UNITYSDK_OFFSET(0x1DD2C480)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_CONNECT_OFFSET UNITYSDK_OFFSET(0x1DD2C280)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_ACCEPTPATTERN_OFFSET UNITYSDK_OFFSET(0x1DD2C760)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1DD2C3A0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_CONNECTPATTERN_OFFSET UNITYSDK_OFFSET(0x1DD2C520)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_CONNECT_OFFSET UNITYSDK_OFFSET(0x1DD2C2A0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2C270)
