...
#define SYSTEM_NET_SOCKETADDRESS_COPYADDRESSSIZEINTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1DACF480)
#define SYSTEM_NET_SOCKETADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DACF5A0)
#define SYSTEM_NET_SOCKETADDRESS_GETADDRESSSIZEOFFSET_OFFSET UNITYSDK_OFFSET(0x1DACF570)
#define SYSTEM_NET_SOCKETADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DACF640)
#define SYSTEM_NET_SOCKETADDRESS_GETIPADDRESS_OFFSET UNITYSDK_OFFSET(0x1DACF170)
#define SYSTEM_NET_SOCKETADDRESS_GETIPENDPOINT_OFFSET UNITYSDK_OFFSET(0x1DACF3E0)
#define SYSTEM_NET_SOCKETADDRESS_GET_FAMILY_OFFSET UNITYSDK_OFFSET(0x1DACEA80)
#define SYSTEM_NET_SOCKETADDRESS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DACEAE0)
#define SYSTEM_NET_SOCKETADDRESS_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1DACEAD0)
#define SYSTEM_NET_SOCKETADDRESS_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1DACF590)
#define SYSTEM_NET_SOCKETADDRESS_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DACEB70)
#define SYSTEM_NET_SOCKETADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DACF960)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DACEC20)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DACED00)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DACF100)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DACEC10)

namespace System::Net
{
	inline static constexpr unsigned int SocketAddress_TypeDefinitionIndex = 3332;
