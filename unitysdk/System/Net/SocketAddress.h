...
#define SYSTEM_NET_SOCKETADDRESS_COPYADDRESSSIZEINTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1C66B5D0)
#define SYSTEM_NET_SOCKETADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C66B6F0)
#define SYSTEM_NET_SOCKETADDRESS_GETADDRESSSIZEOFFSET_OFFSET UNITYSDK_OFFSET(0x1C66B6C0)
#define SYSTEM_NET_SOCKETADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C66B790)
#define SYSTEM_NET_SOCKETADDRESS_GETIPADDRESS_OFFSET UNITYSDK_OFFSET(0x1C66B290)
#define SYSTEM_NET_SOCKETADDRESS_GETIPENDPOINT_OFFSET UNITYSDK_OFFSET(0x1C66B530)
#define SYSTEM_NET_SOCKETADDRESS_GET_FAMILY_OFFSET UNITYSDK_OFFSET(0x1C66ABA0)
#define SYSTEM_NET_SOCKETADDRESS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C66AC00)
#define SYSTEM_NET_SOCKETADDRESS_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C66ABF0)
#define SYSTEM_NET_SOCKETADDRESS_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1C66B6E0)
#define SYSTEM_NET_SOCKETADDRESS_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C66AC90)
#define SYSTEM_NET_SOCKETADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C66BBB0)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C66AD40)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C66AE20)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C66B220)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C66AD30)
