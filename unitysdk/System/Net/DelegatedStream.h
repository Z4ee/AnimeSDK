...
#define SYSTEM_NET_DELEGATEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1DAB4570)
#define SYSTEM_NET_DELEGATEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1DAB4670)
#define SYSTEM_NET_DELEGATEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1DAB4750)
#define SYSTEM_NET_DELEGATEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1DAB4780)
#define SYSTEM_NET_DELEGATEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1DAB4830)
#define SYSTEM_NET_DELEGATEDSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x1DAB4900)
#define SYSTEM_NET_DELEGATEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1DAB48D0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x1DAB42E0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1DAB42F0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1DAB4320)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1DAB4350)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1DAB4380)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DAB4420)
#define SYSTEM_NET_DELEGATEDSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x1DAB49F0)
#define SYSTEM_NET_DELEGATEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1DAB4930)
#define SYSTEM_NET_DELEGATEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1DAB4AC0)
#define SYSTEM_NET_DELEGATEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1DAB4B70)
#define SYSTEM_NET_DELEGATEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DAB44C0)
#define SYSTEM_NET_DELEGATEDSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x1DAB4CD0)
#define SYSTEM_NET_DELEGATEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1DAB4C20)
#define SYSTEM_NET_DELEGATEDSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAB4220)
#define SYSTEM_NET_DELEGATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB41D0)
