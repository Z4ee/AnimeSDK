...
#define SYSTEM_NET_DELEGATEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1A242860)
#define SYSTEM_NET_DELEGATEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1A242950)
#define SYSTEM_NET_DELEGATEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A242A30)
#define SYSTEM_NET_DELEGATEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1A242A60)
#define SYSTEM_NET_DELEGATEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1A242B10)
#define SYSTEM_NET_DELEGATEDSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x1A242BE0)
#define SYSTEM_NET_DELEGATEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A242BB0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x1A2425D0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A2425E0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1A242610)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A242640)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A242670)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A242710)
#define SYSTEM_NET_DELEGATEDSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x1A242CD0)
#define SYSTEM_NET_DELEGATEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1A242C10)
#define SYSTEM_NET_DELEGATEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1A242DA0)
#define SYSTEM_NET_DELEGATEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A242E50)
#define SYSTEM_NET_DELEGATEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A2427B0)
#define SYSTEM_NET_DELEGATEDSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x1A242FB0)
#define SYSTEM_NET_DELEGATEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A242F00)
#define SYSTEM_NET_DELEGATEDSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A242510)
#define SYSTEM_NET_DELEGATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2424C0)

namespace System::Net
{
	inline static constexpr unsigned int DelegatedStream_TypeDefinitionIndex = 3438;

	class DelegatedStream : public ::System::IO::Stream
	{
	public:
		::System::IO::Stream* stream; // 0x28
		::System::Net::Sockets::NetworkStream* netStream; // 0x30
