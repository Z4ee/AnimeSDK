...
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE8940)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE8980)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE83C0)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE83B0)

namespace System::Net
{
	inline static constexpr unsigned int OpenWriteCompletedEventHandler_TypeDefinitionIndex = 3460;
