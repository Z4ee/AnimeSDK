...
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESRECEIVED_OFFSET UNITYSDK_OFFSET(0x1C4A3AA0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESSENT_OFFSET UNITYSDK_OFFSET(0x1C4A3AC0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTORECEIVE_OFFSET UNITYSDK_OFFSET(0x1C4A3AB0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTOSEND_OFFSET UNITYSDK_OFFSET(0x1C4A3AD0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4A3AE0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A3A10)
...
namespace System::Net
{
	...
	public:
		...
		::System::Int64 m_TotalBytesToReceive; // 0x38
