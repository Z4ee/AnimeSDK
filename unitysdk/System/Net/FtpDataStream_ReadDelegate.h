...
#define SYSTEM_NET_FTPDATASTREAM_READDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF74060)
#define SYSTEM_NET_FTPDATASTREAM_READDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF74210)
#define SYSTEM_NET_FTPDATASTREAM_READDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF74DB0)
#define SYSTEM_NET_FTPDATASTREAM_READDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF74D30)

namespace System::Net
{
	inline static constexpr unsigned int FtpDataStream_ReadDelegate_TypeDefinitionIndex = 2829;
