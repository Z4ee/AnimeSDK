...
#define SYSTEM_MARSHALBYREFOBJECT_CREATEOBJREF_OFFSET UNITYSDK_OFFSET(0x1D480040)
#define SYSTEM_MARSHALBYREFOBJECT_GET_OBJECTIDENTITY_OFFSET UNITYSDK_OFFSET(0x1D47FF00)
#define SYSTEM_MARSHALBYREFOBJECT_INITIALIZELIFETIMESERVICE_OFFSET UNITYSDK_OFFSET(0x1D480090)
#define SYSTEM_MARSHALBYREFOBJECT_SET_OBJECTIDENTITY_OFFSET UNITYSDK_OFFSET(0x1D47FFF0)
#define SYSTEM_MARSHALBYREFOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D464190)

namespace System
{
	inline static constexpr unsigned int MarshalByRefObject_TypeDefinitionIndex = 404;
