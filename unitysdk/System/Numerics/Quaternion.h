...
#define SYSTEM_NUMERICS_QUATERNION_CREATEFROMAXISANGLE_OFFSET UNITYSDK_OFFSET(0x1D5C6820)
#define SYSTEM_NUMERICS_QUATERNION_CREATEFROMYAWPITCHROLL_OFFSET UNITYSDK_OFFSET(0x1D5C68A0)
#define SYSTEM_NUMERICS_QUATERNION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9F77A0)
#define SYSTEM_NUMERICS_QUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C4E00)
#define SYSTEM_NUMERICS_QUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9F7840)
#define SYSTEM_NUMERICS_QUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1D5C6770)
#define SYSTEM_NUMERICS_QUATERNION_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1D5C67B0)
#define SYSTEM_NUMERICS_QUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1D5C6B50)
#define SYSTEM_NUMERICS_QUATERNION_SLERP_OFFSET UNITYSDK_OFFSET(0x1D5C69C0)
#define SYSTEM_NUMERICS_QUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9F7830)
#define SYSTEM_NUMERICS_QUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x776510)

namespace System::Numerics
{
	inline static constexpr unsigned int Quaternion_TypeDefinitionIndex = 6378;
