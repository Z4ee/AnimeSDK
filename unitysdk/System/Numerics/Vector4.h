...
#define SYSTEM_NUMERICS_VECTOR4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3AF88B0)
#define SYSTEM_NUMERICS_VECTOR4_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AFFFE0)
#define SYSTEM_NUMERICS_VECTOR4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AFFF00)
#define SYSTEM_NUMERICS_VECTOR4_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3B00100)
#define SYSTEM_NUMERICS_VECTOR4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B00070)
#define SYSTEM_NUMERICS_VECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x3B00110)

namespace System::Numerics
{
	inline static constexpr unsigned int Vector4_TypeDefinitionIndex = 3857;
