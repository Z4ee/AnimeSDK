...
#define SYSTEM_NUMERICS_VECTOR4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3C91350)
#define SYSTEM_NUMERICS_VECTOR4_EQUALS_OFFSET UNITYSDK_OFFSET(0x3C99E40)
#define SYSTEM_NUMERICS_VECTOR4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3C99D60)
#define SYSTEM_NUMERICS_VECTOR4_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3C99F60)
#define SYSTEM_NUMERICS_VECTOR4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3C99ED0)
#define SYSTEM_NUMERICS_VECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x3C99F70)
