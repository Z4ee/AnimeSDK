...
#define SYSTEM_NUMERICS_VECTOR_CONDITIONALSELECT_OFFSET UNITYSDK_OFFSET(0x1D293DA0)
#define SYSTEM_NUMERICS_VECTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D293EA0)
#define SYSTEM_NUMERICS_VECTOR_GET_ISHARDWAREACCELERATED_OFFSET UNITYSDK_OFFSET(0x1D293FE0)
#define SYSTEM_NUMERICS_VECTOR_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1D293F40)

namespace System::Numerics
{
	inline static constexpr unsigned int Vector_TypeDefinitionIndex = 3854;
