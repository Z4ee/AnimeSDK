...
#define SYSTEM_POINTERSPEC_APPEND_OFFSET UNITYSDK_OFFSET(0x1C6D64C0)
#define SYSTEM_POINTERSPEC_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1C6D6470)
#define SYSTEM_POINTERSPEC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6D64F0)
#define SYSTEM_POINTERSPEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6D6460)
