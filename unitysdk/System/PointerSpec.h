...
#define SYSTEM_POINTERSPEC_APPEND_OFFSET UNITYSDK_OFFSET(0x18B9ACB0)
#define SYSTEM_POINTERSPEC_RESOLVE_OFFSET UNITYSDK_OFFSET(0x18B9AC60)
#define SYSTEM_POINTERSPEC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18B9ACE0)
#define SYSTEM_POINTERSPEC__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9AC50)
