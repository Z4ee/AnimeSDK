...
#define SYSTEM_POINTERSPEC_APPEND_OFFSET UNITYSDK_OFFSET(0x16366780)
#define SYSTEM_POINTERSPEC_RESOLVE_OFFSET UNITYSDK_OFFSET(0x16366730)
#define SYSTEM_POINTERSPEC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x163667B0)
#define SYSTEM_POINTERSPEC__CTOR_OFFSET UNITYSDK_OFFSET(0x16366720)
