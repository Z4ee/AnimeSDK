...
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA18CC0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT16LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA18DF0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA18F20)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT64LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA19050)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_1_OFFSET UNITYSDK_OFFSET(0x1BA18C70)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_2_OFFSET UNITYSDK_OFFSET(0x1BA18C80)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_3_OFFSET UNITYSDK_OFFSET(0x1BA18C90)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_4_OFFSET UNITYSDK_OFFSET(0x1BA18CA0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_5_OFFSET UNITYSDK_OFFSET(0x1BA18CB0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_OFFSET UNITYSDK_OFFSET(0x1BA18C60)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT16LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA19180)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA192C0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT64LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1BA193F0)

namespace System::Buffers::Binary
{
	inline static constexpr unsigned int BinaryPrimitives_TypeDefinitionIndex = 7580;
