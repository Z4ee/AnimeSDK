...
#define SYSTEM_BUFFERS_UTILITIES_GETMAXSIZEFORBUCKET_OFFSET UNITYSDK_OFFSET(0x1C55EAC0)
#define SYSTEM_BUFFERS_UTILITIES_SELECTBUCKETINDEX_OFFSET UNITYSDK_OFFSET(0x1C55EA50)

namespace System::Buffers
{
	inline static constexpr unsigned int Utilities_TypeDefinitionIndex = 6508;
