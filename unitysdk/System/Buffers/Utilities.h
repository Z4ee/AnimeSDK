...
#define SYSTEM_BUFFERS_UTILITIES_GETMAXSIZEFORBUCKET_OFFSET UNITYSDK_OFFSET(0x1847A360)
#define SYSTEM_BUFFERS_UTILITIES_SELECTBUCKETINDEX_OFFSET UNITYSDK_OFFSET(0x1847A2F0)

namespace System::Buffers
{
	inline static constexpr unsigned int Utilities_TypeDefinitionIndex = 4765;
