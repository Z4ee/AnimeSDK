...
#define SYSTEM_ACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A096F50)
#define SYSTEM_ACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A096F80)
#define SYSTEM_ACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A096CB0)
#define SYSTEM_ACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A096CA0)
