...
#define SYSTEM_URITYPECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1AFEDB80)
#define SYSTEM_URITYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1AFEDC40)
#define SYSTEM_URITYPECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AFEDB10)
#define SYSTEM_URITYPECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1AFEDCB0)
#define SYSTEM_URITYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1AFEDE70)
#define SYSTEM_URITYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEDB00)

namespace System
{
	inline static constexpr unsigned int UriTypeConverter_TypeDefinitionIndex = 2705;
