...
#define SYSTEM_INVALIDPROGRAMEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1634FFE0)
#define SYSTEM_INVALIDPROGRAMEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16350050)
#define SYSTEM_INVALIDPROGRAMEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1634FF40)
