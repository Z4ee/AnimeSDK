...
#define SYSTEM_FIELDACCESSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC45C50)
#define SYSTEM_FIELDACCESSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AC45CE0)
#define SYSTEM_FIELDACCESSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC45B90)
