...
#define SYSTEM_ARRAY_SORTERGENERICARRAY_DOWNHEAP_OFFSET UNITYSDK_OFFSET(0xA1B7E0)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_HEAPSORT_OFFSET UNITYSDK_OFFSET(0xA1B750)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_INSERTIONSORT_OFFSET UNITYSDK_OFFSET(0xA1B7F0)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_INTROSORT_OFFSET UNITYSDK_OFFSET(0xA1B730)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_INTROSPECTIVESORT_OFFSET UNITYSDK_OFFSET(0xA1B720)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_PICKPIVOTANDPARTITION_OFFSET UNITYSDK_OFFSET(0xA1B740)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_SORT_OFFSET UNITYSDK_OFFSET(0xA1B720)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_SWAPIFGREATERWITHITEMS_OFFSET UNITYSDK_OFFSET(0xA1B700)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_SWAP_OFFSET UNITYSDK_OFFSET(0xA1B710)
#define SYSTEM_ARRAY_SORTERGENERICARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B680)

namespace System
{
	inline static constexpr unsigned int Array_SorterGenericArray_TypeDefinitionIndex = 131;
