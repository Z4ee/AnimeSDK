...
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_ADD_OFFSET UNITYSDK_OFFSET(0x177F3250)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_CLEAR_OFFSET UNITYSDK_OFFSET(0x177F33C0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_CONTAINS_OFFSET UNITYSDK_OFFSET(0x177F3240)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_COPYTO_OFFSET UNITYSDK_OFFSET(0x177F2E90)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x177F3440)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x177F2FD0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x177F3430)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x177F3420)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x177F2FF0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x177F3000)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x177F31E0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x177F2FE0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x177F3210)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_REMOVE_OFFSET UNITYSDK_OFFSET(0x177F3480)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x177F3070)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x177F2E40)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x177F2E30)

namespace System::Collections
{
	inline static constexpr unsigned int EmptyReadOnlyDictionaryInternal_TypeDefinitionIndex = 1460;
