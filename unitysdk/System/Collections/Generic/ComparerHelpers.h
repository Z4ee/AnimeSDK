...
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_CREATEDEFAULTCOMPARER_OFFSET UNITYSDK_OFFSET(0x1AD410F0)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_CREATEDEFAULTEQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1AD40A00)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_HASICOMPARABLE_OFFSET UNITYSDK_OFFSET(0x1AD40E20)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_HASIEQUATABLE_OFFSET UNITYSDK_OFFSET(0x1AD40740)

namespace System::Collections::Generic
{
	inline static constexpr unsigned int ComparerHelpers_TypeDefinitionIndex = 1764;
