...
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_CREATEDEFAULTCOMPARER_OFFSET UNITYSDK_OFFSET(0x1C9D3650)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_CREATEDEFAULTEQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1C9D2F40)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_HASICOMPARABLE_OFFSET UNITYSDK_OFFSET(0x1C9D3370)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_HASIEQUATABLE_OFFSET UNITYSDK_OFFSET(0x1C9D2C80)
