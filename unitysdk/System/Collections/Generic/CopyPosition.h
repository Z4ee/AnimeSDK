...
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_DEBUGGERDISPLAY_OFFSET UNITYSDK_OFFSET(0x8C50C0)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_ROW_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_START_OFFSET UNITYSDK_OFFSET(0x1B1B3340)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C5090)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x2AB920)
