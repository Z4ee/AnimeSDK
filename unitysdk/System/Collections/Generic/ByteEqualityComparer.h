...
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AD405C0)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AD403D0)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x1AD40610)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AD403E0)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1AD403F0)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_LASTINDEXOF_OFFSET UNITYSDK_OFFSET(0x1AD40560)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD40720)

namespace System::Collections::Generic
{
	inline static constexpr unsigned int ByteEqualityComparer_TypeDefinitionIndex = 1546;
