...
#define SYSTEM_COLLECTIONS_GENERIC_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CB112D0)
#define SYSTEM_COLLECTIONS_GENERIC_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CB11300)
#define SYSTEM_COLLECTIONS_GENERIC_NONRANDOMIZEDSTRINGEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB11390)

namespace System::Collections::Generic
{
	inline static constexpr unsigned int NonRandomizedStringEqualityComparer_TypeDefinitionIndex = 1528;
