...
#define SYSTEM_COLLECTIONS_STACK_STACKENUMERATOR_CLONE_OFFSET UNITYSDK_OFFSET(0x18CDD150)
#define SYSTEM_COLLECTIONS_STACK_STACKENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18CDD2E0)
#define SYSTEM_COLLECTIONS_STACK_STACKENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18CDD1F0)
#define SYSTEM_COLLECTIONS_STACK_STACKENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18CDD390)
#define SYSTEM_COLLECTIONS_STACK_STACKENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDCF10)

namespace System::Collections
{
	inline static constexpr unsigned int Stack_StackEnumerator_TypeDefinitionIndex = 1497;
