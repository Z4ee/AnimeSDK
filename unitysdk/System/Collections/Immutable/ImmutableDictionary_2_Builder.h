...
{
	inline static constexpr unsigned int ImmutableDictionary_2_Builder_TypeDefinitionIndex = 6998;
	...
	public:
		...
		::System::Collections::Immutable::ImmutableDictionary_2<TKey, TValue>* _immutable; // 0x0
