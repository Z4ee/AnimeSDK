...
{
	inline static constexpr unsigned int ImmutableSortedDictionary_2_Builder_TypeDefinitionIndex = 8960;
	...
	public:
		...
		::System::Collections::Immutable::ImmutableSortedDictionary_2<TKey, TValue>* _immutable; // 0x0
