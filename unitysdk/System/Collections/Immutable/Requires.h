...
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_ARGUMENT_OFFSET UNITYSDK_OFFSET(0x1E6BF530)
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_FAILARGUMENTNULLEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1E6BF420)
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_FAILRANGE_OFFSET UNITYSDK_OFFSET(0x1E6BF490)
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_RANGE_OFFSET UNITYSDK_OFFSET(0x1E6BF470)
