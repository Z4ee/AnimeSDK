...
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A6B4820)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A6B4260)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A6B4B40)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A6B3DC0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GET_INNERHASHTABLE_OFFSET UNITYSDK_OFFSET(0x1A6B3D10)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_ONGET_OFFSET UNITYSDK_OFFSET(0x1A6B4CC0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A6B3F60)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A6B40E0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1A6B4750)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A6B4680)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A6B3EA0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A6B3DE0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6B4330)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1A6B4020)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1A6B41A0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A6B48E0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6B4420)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A6B4C00)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B4CD0)

namespace System::Collections
{
	inline static constexpr unsigned int DictionaryBase_TypeDefinitionIndex = 1458;
