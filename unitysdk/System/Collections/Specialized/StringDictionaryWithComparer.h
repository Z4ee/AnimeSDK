...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_ADD_OFFSET UNITYSDK_OFFSET(0x1E970CC0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1E970D50)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E970B90)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_REMOVE_OFFSET UNITYSDK_OFFSET(0x1E970DE0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E970C30)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E970A40)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E970880)
