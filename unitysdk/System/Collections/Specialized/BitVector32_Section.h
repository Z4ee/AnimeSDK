...
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x99C1A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x99C130)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99C1C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GET_MASK_OFFSET UNITYSDK_OFFSET(0x3F8490)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x42A0B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D3EFB00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D3EFB10)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x99C220)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D3EFB80)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x42A0A0)
