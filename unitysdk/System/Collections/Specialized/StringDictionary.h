...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1C1BD5F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_ASGENERICDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1C1BD8B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C1BD6A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1C1BD6D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_CONTAINSVALUE_OFFSET UNITYSDK_OFFSET(0x1C1BD770)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_COPYTO_OFFSET UNITYSDK_OFFSET(0x1C1BD7A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C1BD7D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C1BD390)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1C1BD3C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C1BD3F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1C1BD560)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1C1BD590)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1C1BD5C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1C1BD800)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_REPLACEHASHTABLE_OFFSET UNITYSDK_OFFSET(0x1C1BD8A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C1BD4B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BD2F0)
