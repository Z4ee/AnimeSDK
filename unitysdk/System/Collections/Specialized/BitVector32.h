...
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_COUNTBITSSET_OFFSET UNITYSDK_OFFSET(0x1D224530)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATEMASKFROMHIGHVALUE_OFFSET UNITYSDK_OFFSET(0x1D224610)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATEMASK_1_OFFSET UNITYSDK_OFFSET(0x1D224590)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATEMASK_OFFSET UNITYSDK_OFFSET(0x1D224550)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATESECTIONHELPER_OFFSET UNITYSDK_OFFSET(0x1D224670)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATESECTION_1_OFFSET UNITYSDK_OFFSET(0x1D224850)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATESECTION_OFFSET UNITYSDK_OFFSET(0x1D224660)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_EQUALS_OFFSET UNITYSDK_OFFSET(0x984170)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9841D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GET_DATA_OFFSET UNITYSDK_OFFSET(0x325570)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x984120)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9840F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x984140)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x984100)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x984230)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D224920)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3253A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x3253A0)
