...
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0B5AF0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A0B5B50)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A0B5B80)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A0B5FB0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A0B5F00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0B5FC0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B5A90)

namespace System::Collections::Specialized
{
	inline static constexpr unsigned int NameObjectCollectionBase_KeysCollection_TypeDefinitionIndex = 2986;
