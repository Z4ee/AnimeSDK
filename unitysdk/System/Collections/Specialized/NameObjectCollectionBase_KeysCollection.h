...
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19EE5C00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19EE5C60)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19EE5BF0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x19EE5B50)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19EE5C90)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19EE60F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19EE6010)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EE6100)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE5B40)

namespace System::Collections::Specialized
{
	inline static constexpr unsigned int NameObjectCollectionBase_KeysCollection_TypeDefinitionIndex = 3922;
