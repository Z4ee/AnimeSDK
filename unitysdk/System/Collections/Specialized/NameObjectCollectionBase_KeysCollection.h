...
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D6A0800)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D6A0860)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D6A07F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x1D6A0750)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1D6A0890)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1D6A0CF0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1D6A0C10)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D6A0D00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_KEYSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A0740)
