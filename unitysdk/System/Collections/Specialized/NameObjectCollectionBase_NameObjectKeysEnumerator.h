...
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E9113A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E911180)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E911310)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9102C0)

namespace System::Collections::Specialized
{
	inline static constexpr unsigned int NameObjectCollectionBase_NameObjectKeysEnumerator_TypeDefinitionIndex = 2996;
