...
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C48CC50)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C48CA30)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C48CBC0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_NAMEOBJECTCOLLECTIONBASE_NAMEOBJECTKEYSENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48BB70)
