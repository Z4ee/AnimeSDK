...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_ADD_OFFSET UNITYSDK_OFFSET(0x1C6C1C00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C6C1D50)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1C6C1D20)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C6C27B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C6C1D80)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C6C1DB0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1C6C1E80)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1C6C1F40)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_REMOVE_OFFSET UNITYSDK_OFFSET(0x1C6C2000)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C6C1C90)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___ADD_OFFSET UNITYSDK_OFFSET(0x1C6C20D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___CONTAINS_OFFSET UNITYSDK_OFFSET(0x1C6C2110)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___COPYTO_OFFSET UNITYSDK_OFFSET(0x1C6C21D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1C6C2640)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___REMOVE_OFFSET UNITYSDK_OFFSET(0x1C6C2650)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C6C2760)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1C6C2060)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6C1BF0)
...
namespace System::Collections::Specialized
{
	...
	public:
		...
		::System::Collections::Specialized::StringDictionary_GenericAdapter_ICollectionToGenericCollectionAdapter* _values; // 0x18
		::System::Collections::Specialized::StringDictionary* m_stringDictionary; // 0x20
