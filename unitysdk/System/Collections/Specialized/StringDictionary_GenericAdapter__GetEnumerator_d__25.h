...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C48A220)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C48A510)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C48A570)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C48A520)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C48A120)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48A110)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__GETENUMERATOR_D__25___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1C48A140)

namespace System::Collections::Specialized
{
	inline static constexpr unsigned int StringDictionary_GenericAdapter__GetEnumerator_d__25_TypeDefinitionIndex = 3937;

	class StringDictionary_GenericAdapter__GetEnumerator_d__25 : public ::System::Object
	{
	public:
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::System::String*> __2__current; // 0x10
		::System::Collections::Specialized::StringDictionary_GenericAdapter* __4__this; // 0x20
