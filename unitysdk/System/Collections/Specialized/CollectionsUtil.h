...
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_1_OFFSET UNITYSDK_OFFSET(0x1E9706F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_2_OFFSET UNITYSDK_OFFSET(0x1E970780)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_OFFSET UNITYSDK_OFFSET(0x1E970620)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVESORTEDLIST_OFFSET UNITYSDK_OFFSET(0x1E970810)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E970870)
