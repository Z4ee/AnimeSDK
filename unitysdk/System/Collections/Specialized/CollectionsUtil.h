...
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_1_OFFSET UNITYSDK_OFFSET(0x1D5CA030)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_2_OFFSET UNITYSDK_OFFSET(0x1D5CA0C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_OFFSET UNITYSDK_OFFSET(0x1D5C9F60)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVESORTEDLIST_OFFSET UNITYSDK_OFFSET(0x1D5CA150)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CA1B0)

namespace System::Collections::Specialized
{
	inline static constexpr unsigned int CollectionsUtil_TypeDefinitionIndex = 3909;
