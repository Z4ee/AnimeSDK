...
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1AD471E0)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD473C0)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AD47540)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1AD47420)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1AD474B0)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD44000)

namespace System::Collections
{
	inline static constexpr unsigned int Hashtable_ValueCollection_TypeDefinitionIndex = 1468;
