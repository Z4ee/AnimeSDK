...
#define SYSTEM_WEB_HTTPUTILITY_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1A7F71A0)
#define SYSTEM_WEB_HTTPUTILITY_GETCHAR_1_OFFSET UNITYSDK_OFFSET(0x1A7F74D0)
#define SYSTEM_WEB_HTTPUTILITY_GETCHAR_OFFSET UNITYSDK_OFFSET(0x1A7F7EF0)
#define SYSTEM_WEB_HTTPUTILITY_GETINT_OFFSET UNITYSDK_OFFSET(0x1A7F7EC0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLATTRIBUTEENCODE_1_OFFSET UNITYSDK_OFFSET(0x1A7F69E0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLATTRIBUTEENCODE_OFFSET UNITYSDK_OFFSET(0x1A7F6930)
#define SYSTEM_WEB_HTTPUTILITY_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x1A7F92C0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x1A7F9190)
#define SYSTEM_WEB_HTTPUTILITY_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1A7F94B0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLENCODE_2_OFFSET UNITYSDK_OFFSET(0x1A7F9570)
#define SYSTEM_WEB_HTTPUTILITY_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x1A7F9380)
#define SYSTEM_WEB_HTTPUTILITY_JAVASCRIPTSTRINGENCODE_1_OFFSET UNITYSDK_OFFSET(0x1A7F95C0)
#define SYSTEM_WEB_HTTPUTILITY_JAVASCRIPTSTRINGENCODE_OFFSET UNITYSDK_OFFSET(0x1A7F95B0)
#define SYSTEM_WEB_HTTPUTILITY_PARSEQUERYSTRING_1_OFFSET UNITYSDK_OFFSET(0x1A7F9D00)
#define SYSTEM_WEB_HTTPUTILITY_PARSEQUERYSTRING_2_OFFSET UNITYSDK_OFFSET(0x1A7F9F70)
#define SYSTEM_WEB_HTTPUTILITY_PARSEQUERYSTRING_OFFSET UNITYSDK_OFFSET(0x1A7F9C30)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_1_OFFSET UNITYSDK_OFFSET(0x1A7F82B0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_2_OFFSET UNITYSDK_OFFSET(0x1A7F8380)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_3_OFFSET UNITYSDK_OFFSET(0x1A7F7FE0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1A7F7FC0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_1_OFFSET UNITYSDK_OFFSET(0x1A7F6BE0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_2_OFFSET UNITYSDK_OFFSET(0x1A7F7690)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_3_OFFSET UNITYSDK_OFFSET(0x1A7F76B0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_OFFSET UNITYSDK_OFFSET(0x1A7F6B10)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_1_OFFSET UNITYSDK_OFFSET(0x1A7F8D20)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_2_OFFSET UNITYSDK_OFFSET(0x1A7F8E50)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_3_OFFSET UNITYSDK_OFFSET(0x1A7F8840)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1A7F8C50)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODEUNICODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1A7F9030)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODEUNICODE_OFFSET UNITYSDK_OFFSET(0x1A7F8F30)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1A7F84F0)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_2_OFFSET UNITYSDK_OFFSET(0x1A7F88D0)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_3_OFFSET UNITYSDK_OFFSET(0x1A7F8A90)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_OFFSET UNITYSDK_OFFSET(0x1A7F8420)
#define SYSTEM_WEB_HTTPUTILITY_URLPATHENCODE_OFFSET UNITYSDK_OFFSET(0x1A7F9BB0)
#define SYSTEM_WEB_HTTPUTILITY_WRITECHARBYTES_OFFSET UNITYSDK_OFFSET(0x1A7F7210)
#define SYSTEM_WEB_HTTPUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F6920)

namespace System::Web
{
	inline static constexpr unsigned int HttpUtility_TypeDefinitionIndex = 3118;
