...
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1A118190)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1A1181D0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A118110)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1A118210)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1A118250)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1A118290)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A118150)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1A1182D0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1180D0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A118090)

namespace System::Web
{
	inline static constexpr unsigned int AspNetHostingPermission_TypeDefinitionIndex = 4102;
