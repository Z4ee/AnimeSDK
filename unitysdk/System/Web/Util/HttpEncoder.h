...
#define SYSTEM_WEB_UTIL_HTTPENCODER_ENCODEHEADERSTRING_OFFSET UNITYSDK_OFFSET(0x1D8A6F00)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GETCUSTOMENCODERFROMCONFIG_OFFSET UNITYSDK_OFFSET(0x1D8A8CF0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8A69B0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1D8A6B50)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GET_ENTITIES_OFFSET UNITYSDK_OFFSET(0x1D8A3420)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HEADERNAMEVALUEENCODE_OFFSET UNITYSDK_OFFSET(0x1D8A6E40)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLATTRIBUTEENCODE_1_OFFSET UNITYSDK_OFFSET(0x1D8A7260)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLATTRIBUTEENCODE_OFFSET UNITYSDK_OFFSET(0x1D8A71B0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x1D8A7610)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x1D8A7570)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x1D8A8690)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x1D8A85F0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_INITENTITIES_OFFSET UNITYSDK_OFFSET(0x1D8A35C0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_JAVASCRIPTSTRINGENCODE_OFFSET UNITYSDK_OFFSET(0x1D8A9720)
#define SYSTEM_WEB_UTIL_HTTPENCODER_NOTENCODED_OFFSET UNITYSDK_OFFSET(0x1D8A9700)
#define SYSTEM_WEB_UTIL_HTTPENCODER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8A6AC0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_STRINGBUILDERAPPEND_OFFSET UNITYSDK_OFFSET(0x1D8A7120)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLENCODECHAR_OFFSET UNITYSDK_OFFSET(0x1D8A9340)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x1D8A8B40)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLENCODE_OFFSET UNITYSDK_OFFSET(0x1D8A8AD0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLPATHENCODECHAR_OFFSET UNITYSDK_OFFSET(0x1D8A9010)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLPATHENCODE_OFFSET UNITYSDK_OFFSET(0x1D8A8D70)
#define SYSTEM_WEB_UTIL_HTTPENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8A6BD0)
#define SYSTEM_WEB_UTIL_HTTPENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8A6E30)
...
namespace System::Web::Util
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(HttpEncoder_TypeDefinitionIndex)->GetStaticField(0x2A90);
		}
		static ::System::Lazy_1<::System::Web::Util::HttpEncoder*>** StaticGet_currentEncoderLazy()
		{
			return (::System::Lazy_1<::System::Web::Util::HttpEncoder*>**)Il2CppClass::FromTypeDefinitionIndex(HttpEncoder_TypeDefinitionIndex)->GetStaticField(0x2A98);
		}
