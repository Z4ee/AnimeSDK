...
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE_GET_VALUESERIALIZERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1B1F5E10)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE_GET_VALUESERIALIZERTYPE_OFFSET UNITYSDK_OFFSET(0x1B1F5D60)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1F5D50)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F5D40)

namespace System::Windows::Markup
{
	inline static constexpr unsigned int ValueSerializerAttribute_TypeDefinitionIndex = 2707;
