...
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE_GET_VALUESERIALIZERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1D5DD930)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE_GET_VALUESERIALIZERTYPE_OFFSET UNITYSDK_OFFSET(0x1D5DD880)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D5DD870)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DD860)
