...
#define SYSTEM_ARRAYTYPEMISMATCHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D677BD0)
#define SYSTEM_ARRAYTYPEMISMATCHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D677C60)
#define SYSTEM_ARRAYTYPEMISMATCHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D677B10)
