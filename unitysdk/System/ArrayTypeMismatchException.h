...
#define SYSTEM_ARRAYTYPEMISMATCHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x161B5860)
#define SYSTEM_ARRAYTYPEMISMATCHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x161B58D0)
#define SYSTEM_ARRAYTYPEMISMATCHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x161B2E50)
