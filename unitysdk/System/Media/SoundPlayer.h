...
#define SYSTEM_MEDIA_SOUNDPLAYER_ADD_LOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1C491320)
#define SYSTEM_MEDIA_SOUNDPLAYER_ADD_SOUNDLOCATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1C4913A0)
#define SYSTEM_MEDIA_SOUNDPLAYER_ADD_STREAMCHANGED_OFFSET UNITYSDK_OFFSET(0x1C491420)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_ISLOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1C4910E0)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_LOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C491120)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_SOUNDLOCATION_OFFSET UNITYSDK_OFFSET(0x1C4911A0)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1C491220)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1C4912A0)
#define SYSTEM_MEDIA_SOUNDPLAYER_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x1C4914E0)
#define SYSTEM_MEDIA_SOUNDPLAYER_LOAD_OFFSET UNITYSDK_OFFSET(0x1C4914A0)
#define SYSTEM_MEDIA_SOUNDPLAYER_ONLOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1C491520)
#define SYSTEM_MEDIA_SOUNDPLAYER_ONSOUNDLOCATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1C491560)
#define SYSTEM_MEDIA_SOUNDPLAYER_ONSTREAMCHANGED_OFFSET UNITYSDK_OFFSET(0x1C4915A0)
#define SYSTEM_MEDIA_SOUNDPLAYER_PLAYLOOPING_OFFSET UNITYSDK_OFFSET(0x1C491620)
#define SYSTEM_MEDIA_SOUNDPLAYER_PLAYSYNC_OFFSET UNITYSDK_OFFSET(0x1C491660)
#define SYSTEM_MEDIA_SOUNDPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x1C4915E0)
#define SYSTEM_MEDIA_SOUNDPLAYER_REMOVE_LOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1C491360)
#define SYSTEM_MEDIA_SOUNDPLAYER_REMOVE_SOUNDLOCATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1C4913E0)
#define SYSTEM_MEDIA_SOUNDPLAYER_REMOVE_STREAMCHANGED_OFFSET UNITYSDK_OFFSET(0x1C491460)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_LOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C491160)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_SOUNDLOCATION_OFFSET UNITYSDK_OFFSET(0x1C4911E0)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1C491260)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_TAG_OFFSET UNITYSDK_OFFSET(0x1C4912E0)
#define SYSTEM_MEDIA_SOUNDPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1C4916A0)
#define SYSTEM_MEDIA_SOUNDPLAYER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C4916E0)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C491020)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C491060)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C4910A0)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C490FE0)
