...
#define SYSTEM_TYPESPEC_ADDMODIFIER_OFFSET UNITYSDK_OFFSET(0x1D1B17D0)
#define SYSTEM_TYPESPEC_ADDNAME_OFFSET UNITYSDK_OFFSET(0x1D1B1650)
#define SYSTEM_TYPESPEC_BOUNDCHECK_OFFSET UNITYSDK_OFFSET(0x1D1B19D0)
#define SYSTEM_TYPESPEC_GETDISPLAYFULLNAME_OFFSET UNITYSDK_OFFSET(0x1D1AEDE0)
#define SYSTEM_TYPESPEC_GETMODIFIERSTRING_OFFSET UNITYSDK_OFFSET(0x1D1AF430)
#define SYSTEM_TYPESPEC_GET_DISPLAYFULLNAME_OFFSET UNITYSDK_OFFSET(0x1D1AF400)
#define SYSTEM_TYPESPEC_GET_HASMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1D1AEDD0)
#define SYSTEM_TYPESPEC_PARSEDTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1D1B1780)
#define SYSTEM_TYPESPEC_PARSE_1_OFFSET UNITYSDK_OFFSET(0x1D1AF6F0)
#define SYSTEM_TYPESPEC_PARSE_OFFSET UNITYSDK_OFFSET(0x1D1AF630)
#define SYSTEM_TYPESPEC_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1D1B0F60)
#define SYSTEM_TYPESPEC_SKIPSPACE_OFFSET UNITYSDK_OFFSET(0x1D1B1870)
#define SYSTEM_TYPESPEC_UNESCAPEINTERNALNAME_OFFSET UNITYSDK_OFFSET(0x1D1B0D70)
#define SYSTEM_TYPESPEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B1A50)

namespace System
{
	inline static constexpr unsigned int TypeSpec_TypeDefinitionIndex = 432;

	class TypeSpec : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::TypeIdentifier*>* nested; // 0x10
		::System::Collections::Generic::List_1<::System::TypeSpec*>* generic_params; // 0x18
		::System::Collections::Generic::List_1<::System::ModifierSpec*>* modifier_spec; // 0x20
		::System::String* assembly_name; // 0x28
		::System::String* display_fullname; // 0x30
		::System::TypeIdentifier* name; // 0x38
