...
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DB74820)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DB748D0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GET_DATAMEMBER_OFFSET UNITYSDK_OFFSET(0x1DB74810)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GET_DATASOURCE_OFFSET UNITYSDK_OFFSET(0x1DB74800)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DB748E0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB747E0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB747F0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB747D0)
