...
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3150E0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A315190)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GET_DATAMEMBER_OFFSET UNITYSDK_OFFSET(0x1A3150D0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GET_DATASOURCE_OFFSET UNITYSDK_OFFSET(0x1A3150C0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3151A0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3150A0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3150B0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A315090)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ComplexBindingPropertiesAttribute_TypeDefinitionIndex = 2838;
	...
	public:
		...
		::System::String* dataMember; // 0x10
		::System::String* dataSource; // 0x18
