...
#define SYSTEM_COMPONENTMODEL_COMPONENTEDITOR_EDITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1DAB0DA0)
#define SYSTEM_COMPONENTMODEL_COMPONENTEDITOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB0DC0)
