...
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1939AA20)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1939AAC0)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_GET_INSTALLERTYPE_OFFSET UNITYSDK_OFFSET(0x1939A990)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1939A980)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1939A950)

namespace System::ComponentModel
{
	inline static constexpr unsigned int InstallerTypeAttribute_TypeDefinitionIndex = 2916;
