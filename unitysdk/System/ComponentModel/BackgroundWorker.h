...
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ADD_DOWORK_OFFSET UNITYSDK_OFFSET(0x1CBF1850)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ADD_PROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1CBF1EB0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ADD_RUNWORKERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CBF23B0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ASYNCOPERATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CBF1740)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_CANCELASYNC_OFFSET UNITYSDK_OFFSET(0x1CBF17E0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_CANCELLATIONPENDING_OFFSET UNITYSDK_OFFSET(0x1CBF17D0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_ISBUSY_OFFSET UNITYSDK_OFFSET(0x1CBF1AE0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_WORKERREPORTSPROGRESS_OFFSET UNITYSDK_OFFSET(0x1CBF2640)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_WORKERSUPPORTSCANCELLATION_OFFSET UNITYSDK_OFFSET(0x1CBF2660)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ONDOWORK_OFFSET UNITYSDK_OFFSET(0x1CBF1AF0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ONPROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1CBF1D70)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ONRUNWORKERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CBF1C30)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_PROGRESSREPORTER_OFFSET UNITYSDK_OFFSET(0x1CBF2140)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REMOVE_DOWORK_OFFSET UNITYSDK_OFFSET(0x1CBF19D0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REMOVE_PROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1CBF2030)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REMOVE_RUNWORKERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CBF2530)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REPORTPROGRESS_1_OFFSET UNITYSDK_OFFSET(0x1CBF21D0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REPORTPROGRESS_OFFSET UNITYSDK_OFFSET(0x1CBF21C0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_RUNWORKERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CBF2300)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_RUNWORKERASYNC_OFFSET UNITYSDK_OFFSET(0x1CBF22F0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_SET_WORKERREPORTSPROGRESS_OFFSET UNITYSDK_OFFSET(0x1CBF2650)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_SET_WORKERSUPPORTSCANCELLATION_OFFSET UNITYSDK_OFFSET(0x1CBF2670)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_WORKERTHREADSTART_OFFSET UNITYSDK_OFFSET(0x1CBF2680)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CBF28C0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF1660)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Threading::SendOrPostCallback* operationCompleted; // 0x28
		::System::ComponentModel::BackgroundWorker_WorkerThreadStartDelegate* threadStart; // 0x30
		...
		::System::Boolean cancellationPending; // 0x49
		::System::Boolean canCancelWorker; // 0x4A
		::System::Boolean workerReportsProgress; // 0x4B
