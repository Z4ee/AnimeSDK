...
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS_GET_HANDLED_OFFSET UNITYSDK_OFFSET(0x18FA9BB0)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS_SET_HANDLED_OFFSET UNITYSDK_OFFSET(0x18FA9BC0)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FA9B50)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA9AF0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int HandledEventArgs_TypeDefinitionIndex = 2886;
