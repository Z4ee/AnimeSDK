...
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1914F440)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1914F480)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1914F430)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1914F340)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ListChangedEventHandler_TypeDefinitionIndex = 2604;
