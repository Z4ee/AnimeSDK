...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETKEY_OFFSET UNITYSDK_OFFSET(0x192032A0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETLICENSE_OFFSET UNITYSDK_OFFSET(0x19203330)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_ISKEYVALID_OFFSET UNITYSDK_OFFSET(0x19203260)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19203700)

namespace System::ComponentModel
{
	inline static constexpr unsigned int LicFileLicenseProvider_TypeDefinitionIndex = 2924;
