...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1B3E9350)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETLICENSE_OFFSET UNITYSDK_OFFSET(0x1B3E93E0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_ISKEYVALID_OFFSET UNITYSDK_OFFSET(0x1B3E9310)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E97B0)
