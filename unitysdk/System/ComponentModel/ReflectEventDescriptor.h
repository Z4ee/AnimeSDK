...
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_ADDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1C48CAD0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C48D280)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLEVENTINFOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C48D2D0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLMETHODS_OFFSET UNITYSDK_OFFSET(0x1C48C250)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLSINGLEMETHODATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C48D760)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1C48C240)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1C48C220)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_ISMULTICAST_OFFSET UNITYSDK_OFFSET(0x1C48CA60)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_REMOVEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1C48DC60)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C48C080)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C48C180)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48BEE0)
...
namespace System::ComponentModel
{
	...
	{
	public:
		::System::Type* componentClass; // 0x60
		::System::Reflection::MethodInfo* addMethod; // 0x68
		::System::Reflection::EventInfo* realEvent; // 0x70
		::System::Reflection::MethodInfo* removeMethod; // 0x78
		::System::Type* type; // 0x80
