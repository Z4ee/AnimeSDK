...
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_ADDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A0F9430)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A0F9BE0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLEVENTINFOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A0F9C30)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLMETHODS_OFFSET UNITYSDK_OFFSET(0x1A0F8BD0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLSINGLEMETHODATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A0FA0C0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A0F8BC0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A0F8BA0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_ISMULTICAST_OFFSET UNITYSDK_OFFSET(0x1A0F93D0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_REMOVEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A0FA5C0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F8A10)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0F8B10)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F8870)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Reflection::MethodInfo* removeMethod; // 0x70
		::System::Reflection::MethodInfo* addMethod; // 0x78
