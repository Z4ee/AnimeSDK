...
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS_GET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1C64C190)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS_SET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1C64C1A0)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C64C130)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C64C0D0)
