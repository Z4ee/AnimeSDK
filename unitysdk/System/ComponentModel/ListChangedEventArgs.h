...
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_LISTCHANGEDTYPE_OFFSET UNITYSDK_OFFSET(0x1C6C4BC0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_NEWINDEX_OFFSET UNITYSDK_OFFSET(0x1C6C4BD0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_OLDINDEX_OFFSET UNITYSDK_OFFSET(0x1C6C4BE0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_PROPERTYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6C4BF0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6C4AF0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C6C4B60)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C6C4A80)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6C4A10)
