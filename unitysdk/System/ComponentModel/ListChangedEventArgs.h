...
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_LISTCHANGEDTYPE_OFFSET UNITYSDK_OFFSET(0x1DB76630)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_NEWINDEX_OFFSET UNITYSDK_OFFSET(0x1DB76640)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_OLDINDEX_OFFSET UNITYSDK_OFFSET(0x1DB76650)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_PROPERTYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DB76660)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB76560)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB765D0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DB764F0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB76480)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ListChangedEventArgs_TypeDefinitionIndex = 2935;

	class ListChangedEventArgs : public ::System::EventArgs
	{
	public:
		::System::ComponentModel::PropertyDescriptor* propDesc; // 0x10
		::System::Int32 newIndex; // 0x18
		::System::ComponentModel::ListChangedType listChangedType; // 0x1C
		::System::Int32 oldIndex; // 0x20
