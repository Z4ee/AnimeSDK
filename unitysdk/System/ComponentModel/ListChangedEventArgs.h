...
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB0DAB0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0DA70)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ListChangedEventArgs_TypeDefinitionIndex = 2610;

	class ListChangedEventArgs : public ::System::EventArgs
	{
	public:
		::System::ComponentModel::ListChangedType listChangedType; // 0x10
		::System::Int32 oldIndex; // 0x14
