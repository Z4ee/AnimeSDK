...
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CBFA1E0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CBFA290)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GET_DESIGNERBASETYPENAME_OFFSET UNITYSDK_OFFSET(0x1CBFA130)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GET_DESIGNERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1CBFA140)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GET_TYPEID_OFFSET UNITYSDK_OFFSET(0x1CBFA150)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CBF9FC0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CBFA030)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CBFA080)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1CBFA0E0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF9F40)

namespace System::ComponentModel
{
	inline static constexpr unsigned int DesignerAttribute_TypeDefinitionIndex = 2865;
