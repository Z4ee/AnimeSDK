...
#define SYSTEM_COMPONENTMODEL_LISTSORTDESCRIPTION_GET_PROPERTYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19203720)
#define SYSTEM_COMPONENTMODEL_LISTSORTDESCRIPTION_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x19203740)
#define SYSTEM_COMPONENTMODEL_LISTSORTDESCRIPTION_SET_PROPERTYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19203730)
#define SYSTEM_COMPONENTMODEL_LISTSORTDESCRIPTION_SET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x19203750)
#define SYSTEM_COMPONENTMODEL_LISTSORTDESCRIPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19203710)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ListSortDescription_TypeDefinitionIndex = 2939;
