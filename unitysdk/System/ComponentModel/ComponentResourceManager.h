...
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_APPLYRESOURCES_1_OFFSET UNITYSDK_OFFSET(0x1C88ABC0)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_APPLYRESOURCES_OFFSET UNITYSDK_OFFSET(0x1C88ABA0)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_FILLRESOURCES_OFFSET UNITYSDK_OFFSET(0x1C88B780)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x1C88AB10)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C88AAB0)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C88AA50)
