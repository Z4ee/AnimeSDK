...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS_GET_LASTTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1E972C10)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS_GET_TRANSACTIONCOMMITTED_OFFSET UNITYSDK_OFFSET(0x1E972C00)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E972BA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E972B40)
