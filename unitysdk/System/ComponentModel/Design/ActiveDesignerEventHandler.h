...
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E27FFF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E280030)
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E27FA60)
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E27FA40)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ActiveDesignerEventHandler_TypeDefinitionIndex = 3031;
