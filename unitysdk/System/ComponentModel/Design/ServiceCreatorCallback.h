...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3E8D00)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B3E8D40)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B3E8770)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E8750)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ServiceCreatorCallback_TypeDefinitionIndex = 3088;
