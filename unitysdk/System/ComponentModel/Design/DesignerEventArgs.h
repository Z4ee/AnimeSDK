...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEREVENTARGS_GET_DESIGNER_OFFSET UNITYSDK_OFFSET(0x1DAB0E50)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEREVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB0DF0)
