...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19ADC660)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19ADC6A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19ADC0E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADC0D0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ComponentChangingEventHandler_TypeDefinitionIndex = 3038;
