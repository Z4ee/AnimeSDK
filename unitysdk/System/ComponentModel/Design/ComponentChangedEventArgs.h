...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x192025E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x192025F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x19202600)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_OLDVALUE_OFFSET UNITYSDK_OFFSET(0x19202610)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19202620)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ComponentChangedEventArgs_TypeDefinitionIndex = 3035;
	...
	public:
		...
		::System::Object* oldValue; // 0x20
		::System::Object* newValue; // 0x28
