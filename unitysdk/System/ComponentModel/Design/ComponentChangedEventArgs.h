...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1B3E8690)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x1B3E86A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x1B3E86B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_OLDVALUE_OFFSET UNITYSDK_OFFSET(0x1B3E86C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E86D0)
