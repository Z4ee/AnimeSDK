...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFDDC20)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFDDC60)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFDD6A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDD690)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ComponentEventHandler_TypeDefinitionIndex = 3040;
