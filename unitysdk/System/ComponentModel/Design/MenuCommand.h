...
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_ADD_COMMANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1DEB3AB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_CHECKED_OFFSET UNITYSDK_OFFSET(0x1DEB3760)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_COMMANDID_OFFSET UNITYSDK_OFFSET(0x1DEB3B90)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1DEB3890)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_OLESTATUS_OFFSET UNITYSDK_OFFSET(0x1DEB3CE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1DEB3930)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_SUPPORTED_OFFSET UNITYSDK_OFFSET(0x1DEB3980)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x1DEB3A10)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_INVOKE_1_OFFSET UNITYSDK_OFFSET(0x1DEB3CD0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DEB3BA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_ONCOMMANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1DEB3CF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_REMOVE_COMMANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1DEB3B20)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SETSTATUS_OFFSET UNITYSDK_OFFSET(0x1DEB3800)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_CHECKED_OFFSET UNITYSDK_OFFSET(0x1DEB3770)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1DEB38A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_SUPPORTED_OFFSET UNITYSDK_OFFSET(0x1DEB3990)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x1DEB3A20)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEB3D10)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB3750)
