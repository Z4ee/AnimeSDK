...
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BEB91B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BEB8FB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BEB9040)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BEB90D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1BEB9120)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB8EF0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int CheckoutException_TypeDefinitionIndex = 3032;
