...
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C88C2B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C88C330)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GET_HELPKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C88C2A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C88C340)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C88C440)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C88C1B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C88C220)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C88C1A0)
