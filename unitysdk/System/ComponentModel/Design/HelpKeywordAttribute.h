...
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A56CFF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A56D070)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GET_HELPKEYWORD_OFFSET UNITYSDK_OFFSET(0x1A56CFE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A56D080)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A56D180)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A56CEF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A56CF60)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56CEE0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int HelpKeywordAttribute_TypeDefinitionIndex = 3060;
