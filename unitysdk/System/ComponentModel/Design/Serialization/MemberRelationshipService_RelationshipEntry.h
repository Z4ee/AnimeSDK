...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_RELATIONSHIPENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B7F50)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_RELATIONSHIPENTRY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2E8B50)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_RELATIONSHIPENTRY_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A0F82C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_RELATIONSHIPENTRY_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A0F83A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_RELATIONSHIPENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x8B7EC0)

namespace System::ComponentModel::Design::Serialization
{
	inline static constexpr unsigned int MemberRelationshipService_RelationshipEntry_TypeDefinitionIndex = 3112;
