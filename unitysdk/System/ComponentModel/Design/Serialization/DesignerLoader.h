...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DESIGNERLOADER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1DAB1580)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DESIGNERLOADER_GET_LOADING_OFFSET UNITYSDK_OFFSET(0x1DAB1570)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DESIGNERLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB1590)
