...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_EQUALS_OFFSET UNITYSDK_OFFSET(0x96F9F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96FA50)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x427580)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x246290)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C64D780)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C64D7A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C64D7C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP__CTOR_OFFSET UNITYSDK_OFFSET(0x96F9E0)

namespace System::ComponentModel::Design::Serialization
{
	inline static constexpr unsigned int MemberRelationship_TypeDefinitionIndex = 3112;
