...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_SERIALIZATIONSTORE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D8833F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_SERIALIZATIONSTORE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D8833D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_SERIALIZATIONSTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D883410)
