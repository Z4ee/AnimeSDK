...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1C48AE40)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C48ADD0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48AD50)
