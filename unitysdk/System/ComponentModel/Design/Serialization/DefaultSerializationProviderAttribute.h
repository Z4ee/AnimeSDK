...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1A0F77D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F7760)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F76E0)

namespace System::ComponentModel::Design::Serialization
{
	inline static constexpr unsigned int DefaultSerializationProviderAttribute_TypeDefinitionIndex = 3100;
