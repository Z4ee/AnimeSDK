...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_COMPONENTSERIALIZATIONSERVICE_DESERIALIZETO_1_OFFSET UNITYSDK_OFFSET(0x1C009BB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_COMPONENTSERIALIZATIONSERVICE_DESERIALIZETO_OFFSET UNITYSDK_OFFSET(0x1C009B80)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_COMPONENTSERIALIZATIONSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C009BE0)
