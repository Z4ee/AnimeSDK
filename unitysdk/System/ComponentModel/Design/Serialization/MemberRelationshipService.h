...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_GETRELATIONSHIP_OFFSET UNITYSDK_OFFSET(0x1A0F7B80)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A0F7980)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A0F77E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_SETRELATIONSHIP_OFFSET UNITYSDK_OFFSET(0x1A0F7D80)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A0F7A80)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A0F78B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIPSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F8180)

namespace System::ComponentModel::Design::Serialization
{
	inline static constexpr unsigned int MemberRelationshipService_TypeDefinitionIndex = 3111;
