...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_CANCEL_OFFSET UNITYSDK_OFFSET(0x1E7DF280)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_COMMIT_OFFSET UNITYSDK_OFFSET(0x1E7DF350)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E7DF540)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E7DF420)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_GET_CANCELED_OFFSET UNITYSDK_OFFSET(0x1E7DF250)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_GET_COMMITTED_OFFSET UNITYSDK_OFFSET(0x1E7DF260)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1E7DF270)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E7DF490)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7DF240)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DF200)
