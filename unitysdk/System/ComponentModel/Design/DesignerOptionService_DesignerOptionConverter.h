...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_DESIGNEROPTIONCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1CBF9BE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_DESIGNEROPTIONCONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1CBF9540)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_DESIGNEROPTIONCONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CBF9550)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_DESIGNEROPTIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF9C70)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int DesignerOptionService_DesignerOptionConverter_TypeDefinitionIndex = 3045;
