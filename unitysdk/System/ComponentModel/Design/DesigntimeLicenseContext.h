...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1A23F740)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x1A23F730)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT_SETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1A23F750)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A23F7A0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int DesigntimeLicenseContext_TypeDefinitionIndex = 3053;
