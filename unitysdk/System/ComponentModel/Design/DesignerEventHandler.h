...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A315E40)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A315E80)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3158C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3158B0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int DesignerEventHandler_TypeDefinitionIndex = 3058;
