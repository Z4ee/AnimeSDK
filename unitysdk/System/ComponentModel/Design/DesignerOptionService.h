...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_CREATEOPTIONCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1CEC34A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_GETOPTIONPROPERTY_OFFSET UNITYSDK_OFFSET(0x1CEC3650)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1CEC3410)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_POPULATEOPTIONCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1CEC3880)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_SHOWDIALOG_OFFSET UNITYSDK_OFFSET(0x1CEC3890)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_SYSTEM_COMPONENTMODEL_DESIGN_IDESIGNEROPTIONSERVICE_GETOPTIONVALUE_OFFSET UNITYSDK_OFFSET(0x1CEC38A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE_SYSTEM_COMPONENTMODEL_DESIGN_IDESIGNEROPTIONSERVICE_SETOPTIONVALUE_OFFSET UNITYSDK_OFFSET(0x1CEC38D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNEROPTIONSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEC3910)
