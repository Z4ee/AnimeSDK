...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19BABEC0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x19BAC140)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19BAC000)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BAC280)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BABCA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB__CTOR_OFFSET UNITYSDK_OFFSET(0x19BABA40)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int DesignerVerb_TypeDefinitionIndex = 3051;
