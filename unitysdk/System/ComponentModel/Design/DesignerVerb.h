...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D467420)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1D4676A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D467560)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D4677E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D467200)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB__CTOR_OFFSET UNITYSDK_OFFSET(0x1D466FA0)
