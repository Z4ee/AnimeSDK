...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7D7860)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7D7920)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GET_GUID_OFFSET UNITYSDK_OFFSET(0x1A7D7950)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A7D7850)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7D7960)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D7840)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int CommandID_TypeDefinitionIndex = 3034;
