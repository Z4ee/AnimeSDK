...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A23F6E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A23F720)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A23F160)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A23F150)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int DesignerTransactionCloseEventHandler_TypeDefinitionIndex = 3050;
