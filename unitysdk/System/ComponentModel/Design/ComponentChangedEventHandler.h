...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D466F50)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D466F90)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4669C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4669A0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ComponentChangedEventHandler_TypeDefinitionIndex = 3035;
