...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_1_OFFSET UNITYSDK_OFFSET(0x1B1B6BF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_2_OFFSET UNITYSDK_OFFSET(0x1B1B6F90)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_3_OFFSET UNITYSDK_OFFSET(0x1B1B6FB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_OFFSET UNITYSDK_OFFSET(0x1B1B6BD0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B1B7290)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1B7270)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1B1B74A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x1B1B69D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_DEFAULTSERVICES_OFFSET UNITYSDK_OFFSET(0x1B1B6B00)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x1B1B6B60)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_REMOVESERVICE_1_OFFSET UNITYSDK_OFFSET(0x1B1B78A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_REMOVESERVICE_OFFSET UNITYSDK_OFFSET(0x1B1B7880)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1B7990)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1B69C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B69B0)
