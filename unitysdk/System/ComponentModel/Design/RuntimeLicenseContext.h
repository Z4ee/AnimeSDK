...
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_CASEINSENSITIVEMANIFESTRESOURCESTREAMLOOKUP_OFFSET UNITYSDK_OFFSET(0x1AFDECB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_GETLOCALPATH_OFFSET UNITYSDK_OFFSET(0x1AFDE080)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1AFDE1C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_OPENREAD_OFFSET UNITYSDK_OFFSET(0x1AFDEE60)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFDEFC0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDEFB0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int RuntimeLicenseContext_TypeDefinitionIndex = 3054;
