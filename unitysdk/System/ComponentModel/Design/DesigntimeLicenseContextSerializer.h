...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXTSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A316150)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXTSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A315FA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXTSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A315F90)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int DesigntimeLicenseContextSerializer_TypeDefinitionIndex = 3055;
