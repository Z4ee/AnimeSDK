...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1C88BE90)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_NEWNAME_OFFSET UNITYSDK_OFFSET(0x1C88BEB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x1C88BEA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C88BEC0)

namespace System::ComponentModel::Design
{
	inline static constexpr unsigned int ComponentRenameEventArgs_TypeDefinitionIndex = 3040;
