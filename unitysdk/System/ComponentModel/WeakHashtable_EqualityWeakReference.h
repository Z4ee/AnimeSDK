...
#define SYSTEM_COMPONENTMODEL_WEAKHASHTABLE_EQUALITYWEAKREFERENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19A4F130)
#define SYSTEM_COMPONENTMODEL_WEAKHASHTABLE_EQUALITYWEAKREFERENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A4F200)
#define SYSTEM_COMPONENTMODEL_WEAKHASHTABLE_EQUALITYWEAKREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4F0E0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int WeakHashtable_EqualityWeakReference_TypeDefinitionIndex = 3028;
