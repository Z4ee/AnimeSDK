...
#define SYSTEM_COMPONENTMODEL_INVALIDENUMARGUMENTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BAC5C0)
#define SYSTEM_COMPONENTMODEL_INVALIDENUMARGUMENTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19BAC650)
#define SYSTEM_COMPONENTMODEL_INVALIDENUMARGUMENTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19BAC6E0)
#define SYSTEM_COMPONENTMODEL_INVALIDENUMARGUMENTEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19BAC990)
#define SYSTEM_COMPONENTMODEL_INVALIDENUMARGUMENTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAC530)

namespace System::ComponentModel
{
	inline static constexpr unsigned int InvalidEnumArgumentException_TypeDefinitionIndex = 2923;
