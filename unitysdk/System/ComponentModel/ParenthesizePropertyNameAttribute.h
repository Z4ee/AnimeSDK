...
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D468870)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D4688D0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GET_NEEDPARENTHESIS_OFFSET UNITYSDK_OFFSET(0x1D468860)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D4688E0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4689A0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D468850)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D468840)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ParenthesizePropertyNameAttribute_TypeDefinitionIndex = 3019;
