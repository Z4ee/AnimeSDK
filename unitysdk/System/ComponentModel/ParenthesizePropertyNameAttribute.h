...
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C070240)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0702A0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GET_NEEDPARENTHESIS_OFFSET UNITYSDK_OFFSET(0x1C070230)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C0702B0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C070370)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C070220)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C070210)
