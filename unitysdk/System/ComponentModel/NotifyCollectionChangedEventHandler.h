...
#define SYSTEM_COMPONENTMODEL_NOTIFYCOLLECTIONCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF08040)
#define SYSTEM_COMPONENTMODEL_NOTIFYCOLLECTIONCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF08080)
#define SYSTEM_COMPONENTMODEL_NOTIFYCOLLECTIONCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF08030)
#define SYSTEM_COMPONENTMODEL_NOTIFYCOLLECTIONCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF07F40)
