...
#define SYSTEM_COMPONENTMODEL_PROPERTYCHANGINGEVENTARGS_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A7DB960)
#define SYSTEM_COMPONENTMODEL_PROPERTYCHANGINGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7DB900)
