...
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18FAA160)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18FAA1A0)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18FA9BE0)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA9BD0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int HandledEventHandler_TypeDefinitionIndex = 2887;
