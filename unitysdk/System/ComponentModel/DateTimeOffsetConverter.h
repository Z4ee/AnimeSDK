...
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1B1E3620)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1B1E3690)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1B1E3700)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1B1E3B00)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E4990)

namespace System::ComponentModel
{
	inline static constexpr unsigned int DateTimeOffsetConverter_TypeDefinitionIndex = 2856;
