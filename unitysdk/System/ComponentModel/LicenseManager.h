...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CACHEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1C88D360)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CREATEWITHCONTEXT_1_OFFSET UNITYSDK_OFFSET(0x1C88D6C0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CREATEWITHCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C88D650)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDNOLICENSEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1C88DCF0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDPROVIDERINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C88DEE0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDPROVIDER_OFFSET UNITYSDK_OFFSET(0x1C88DDC0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETLICENSEINTEROPHELPERTYPE_OFFSET UNITYSDK_OFFSET(0x1C88E000)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GET_CURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C88CF20)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x1C88D2A0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISLICENSED_OFFSET UNITYSDK_OFFSET(0x1C88E050)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x1C88E3A0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C88E240)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LOCKCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C88D9D0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_SET_CURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C88D110)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_UNLOCKCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C88DB60)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATEINTERNALRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1C88E470)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C88E1B0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATE_1_OFFSET UNITYSDK_OFFSET(0x1C88EB30)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1C88E9A0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C88EC60)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C88CF10)
...
namespace System::ComponentModel
{
	...
	public:
		...
		{
			return (::System::ComponentModel::LicenseContext**)Il2CppClass::FromTypeDefinitionIndex(LicenseManager_TypeDefinitionIndex)->GetStaticField(0x3040);
		}
