...
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1939B220)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION_GET_LICENSEDTYPE_OFFSET UNITYSDK_OFFSET(0x1939B210)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1939AD80)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1939ACD0)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1939AFE0)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1939B0A0)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1939AB20)

namespace System::ComponentModel
{
	inline static constexpr unsigned int LicenseException_TypeDefinitionIndex = 2928;

	class LicenseException : public ::System::SystemException
	{
	public:
		::System::Type* type; // 0x88
		::System::Object* instance; // 0x90
