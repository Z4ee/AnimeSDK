...
#define SYSTEM_COMPONENTMODEL_COMPONENT_ADD_DISPOSED_OFFSET UNITYSDK_OFFSET(0x1DAB02C0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1DAB0680)
#define SYSTEM_COMPONENTMODEL_COMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DAB05D0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DAB0230)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1DAB0A50)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_CANRAISEEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DAB02B0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_CANRAISEEVENTS_OFFSET UNITYSDK_OFFSET(0x1DAB02A0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x1DAB0970)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_DESIGNMODE_OFFSET UNITYSDK_OFFSET(0x1DAB0B30)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1DAB0440)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_SITE_OFFSET UNITYSDK_OFFSET(0x1DAB05B0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_REMOVE_DISPOSED_OFFSET UNITYSDK_OFFSET(0x1DAB04A0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_SET_SITE_OFFSET UNITYSDK_OFFSET(0x1DAB05C0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DAB0C10)
#define SYSTEM_COMPONENTMODEL_COMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAB0D70)
#define SYSTEM_COMPONENTMODEL_COMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB0D60)
