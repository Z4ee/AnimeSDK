...
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A240690)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2406D0)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A240110)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A240100)

namespace System::ComponentModel
{
	inline static constexpr unsigned int RunWorkerCompletedEventHandler_TypeDefinitionIndex = 2979;
