...
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1B3EBFB0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1B3EBF90)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x1B3EBFA0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_DESIGNMODE_OFFSET UNITYSDK_OFFSET(0x1B3EC060)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1B3EC270)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B3EC330)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B3EC340)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3EBF80)
...
namespace System::ComponentModel
{
	...
	{
	public:
		::System::ComponentModel::NestedContainer* container; // 0x10
