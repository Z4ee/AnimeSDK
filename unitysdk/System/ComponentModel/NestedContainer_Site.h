...
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x19205F00)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x19205EE0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x19205EF0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_DESIGNMODE_OFFSET UNITYSDK_OFFSET(0x19205FB0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x192061C0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19206280)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19206290)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_SITE__CTOR_OFFSET UNITYSDK_OFFSET(0x19205ED0)
