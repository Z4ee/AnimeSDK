...
#define SYSTEM_COMPONENTMODEL_BYTECONVERTER_FROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x1A56B4B0)
#define SYSTEM_COMPONENTMODEL_BYTECONVERTER_FROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x1A56B530)
#define SYSTEM_COMPONENTMODEL_BYTECONVERTER_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x1A56B460)
#define SYSTEM_COMPONENTMODEL_BYTECONVERTER_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1A56B430)
#define SYSTEM_COMPONENTMODEL_BYTECONVERTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A56B590)
#define SYSTEM_COMPONENTMODEL_BYTECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56B650)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ByteConverter_TypeDefinitionIndex = 2828;
