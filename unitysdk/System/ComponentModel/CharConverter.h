...
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A314B20)
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A314E20)
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A314BD0)
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A315070)

namespace System::ComponentModel
{
	inline static constexpr unsigned int CharConverter_TypeDefinitionIndex = 2832;
