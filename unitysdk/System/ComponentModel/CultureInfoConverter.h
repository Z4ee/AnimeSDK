...
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1C6F5640)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1C6F56B0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1C6F5720)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1C6F6300)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETCULTURENAME_OFFSET UNITYSDK_OFFSET(0x1C6F5620)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1C6F6960)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1C6F6970)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x1C6F60F0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GET_DEFAULTCULTURESTRING_OFFSET UNITYSDK_OFFSET(0x1C6F55E0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6F6980)

namespace System::ComponentModel
{
	inline static constexpr unsigned int CultureInfoConverter_TypeDefinitionIndex = 2845;
