...
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1FCBF0)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1FCC30)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1FCBE0)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FCAF0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int AddingNewEventHandler_TypeDefinitionIndex = 9233;
