...
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x19ADD4F0)
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x19ADD5E0)
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19ADD5D0)
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADD5F0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int MultilineStringConverter_TypeDefinitionIndex = 2952;
