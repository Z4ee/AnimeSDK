...
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1B6230)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1B62B0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x1B1B61F0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1B1B6200)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B1B6210)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_PRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x1B1B6220)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1B61B0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1B61D0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B1B6190)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B6170)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Boolean _primaryKey; // 0x14
		::System::Boolean _isIdentity; // 0x15
		::System::Boolean _isNullable; // 0x16
