...
#define SYSTEM_COMPONENTMODEL_CANCELEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D5DB0)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D5DF0)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D5830)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D5820)

namespace System::ComponentModel
{
	inline static constexpr unsigned int CancelEventHandler_TypeDefinitionIndex = 2830;
