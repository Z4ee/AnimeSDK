...
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_CREATESITE_OFFSET UNITYSDK_OFFSET(0x1C6C50B0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C6C5140)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1C6C5260)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GET_OWNERNAME_OFFSET UNITYSDK_OFFSET(0x1C6C4D40)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1C6C4D30)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_ONOWNERDISPOSED_OFFSET UNITYSDK_OFFSET(0x1C6C52D0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6C4C00)

namespace System::ComponentModel
{
	inline static constexpr unsigned int NestedContainer_TypeDefinitionIndex = 2952;
