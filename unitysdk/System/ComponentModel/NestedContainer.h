...
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_CREATESITE_OFFSET UNITYSDK_OFFSET(0x1DB76B30)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB76BC0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1DB76CE0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GET_OWNERNAME_OFFSET UNITYSDK_OFFSET(0x1DB767C0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1DB767B0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_ONOWNERDISPOSED_OFFSET UNITYSDK_OFFSET(0x1DB76D50)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB76670)
