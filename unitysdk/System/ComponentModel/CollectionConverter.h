...
#define SYSTEM_COMPONENTMODEL_COLLECTIONCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A56B660)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1A56B760)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A56B750)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56B770)

namespace System::ComponentModel
{
	inline static constexpr unsigned int CollectionConverter_TypeDefinitionIndex = 2836;
