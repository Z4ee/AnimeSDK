...
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0CF1F0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0CF230)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_GET_CONVERTERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1A0CF1E0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0CF2C0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0CF120)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0CF150)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CF110)
...
namespace System::ComponentModel
{
	...
	public:
		...
		{
			return (::System::ComponentModel::TypeConverterAttribute**)Il2CppClass::FromTypeDefinitionIndex(TypeConverterAttribute_TypeDefinitionIndex)->GetStaticField(0x125D0);
		}
