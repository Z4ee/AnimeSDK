...
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AF37420)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AF37460)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_GET_CONVERTERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1AF37410)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF374F0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF37350)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AF37380)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF37340)

namespace System::ComponentModel
{
	inline static constexpr unsigned int TypeConverterAttribute_TypeDefinitionIndex = 2622;
	...
	public:
		...
		{
			return (::System::ComponentModel::TypeConverterAttribute**)Il2CppClass::FromTypeDefinitionIndex(TypeConverterAttribute_TypeDefinitionIndex)->GetStaticField(0x23470);
		}
