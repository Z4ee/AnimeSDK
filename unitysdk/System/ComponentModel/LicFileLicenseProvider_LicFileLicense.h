...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1E4CE0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE_GET_LICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1B1E4CD0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E4CC0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int LicFileLicenseProvider_LicFileLicense_TypeDefinitionIndex = 2925;
