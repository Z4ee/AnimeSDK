...
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D22B1A0)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D22B200)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_GET_LISTBINDABLE_OFFSET UNITYSDK_OFFSET(0x1D22B190)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D22B210)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D22B2D0)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D22B180)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22B170)
