...
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x18FAA930)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x18FAAA60)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x18FAA9A0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x18FAAB10)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x18FAAE20)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETCREATEINSTANCESUPPORTED_OFFSET UNITYSDK_OFFSET(0x18FAAE40)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x18FAAE90)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18FAAE60)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x18FAB310)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x18FAB2F0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x18FAAEB0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GET_NULLABLETYPE_OFFSET UNITYSDK_OFFSET(0x18FAB430)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GET_UNDERLYINGTYPECONVERTER_OFFSET UNITYSDK_OFFSET(0x18FAB450)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GET_UNDERLYINGTYPE_OFFSET UNITYSDK_OFFSET(0x18FAB440)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_ISVALID_OFFSET UNITYSDK_OFFSET(0x18FAB330)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FAA880)

namespace System::ComponentModel
{
	inline static constexpr unsigned int NullableConverter_TypeDefinitionIndex = 2955;
