...
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19ADD250)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19ADD490)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_GET_LICENSEPROVIDER_OFFSET UNITYSDK_OFFSET(0x19ADD130)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_GET_TYPEID_OFFSET UNITYSDK_OFFSET(0x19ADD1E0)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ADD4A0)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19ADD110)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19ADD120)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADD100)

namespace System::ComponentModel
{
	inline static constexpr unsigned int LicenseProviderAttribute_TypeDefinitionIndex = 2933;
