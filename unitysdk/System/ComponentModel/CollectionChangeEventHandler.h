...
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E276C0)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E27700)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E27140)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E27130)

namespace System::ComponentModel
{
	inline static constexpr unsigned int CollectionChangeEventHandler_TypeDefinitionIndex = 2835;
