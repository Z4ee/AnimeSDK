...
#define SYSTEM_COMPONENTMODEL_COMPONENTCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19E28000)
#define SYSTEM_COMPONENTMODEL_COMPONENTCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19E27ED0)
#define SYSTEM_COMPONENTMODEL_COMPONENTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19E277D0)
#define SYSTEM_COMPONENTMODEL_COMPONENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E27710)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ComponentCollection_TypeDefinitionIndex = 2840;
