...
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1D232050)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTARGS_GET_USERSTATE_OFFSET UNITYSDK_OFFSET(0x1D232070)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D231FD0)
