...
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x19A4ED00)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTARGS_GET_USERSTATE_OFFSET UNITYSDK_OFFSET(0x19A4ED20)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4EC80)

namespace System::ComponentModel
{
	inline static constexpr unsigned int RunWorkerCompletedEventArgs_TypeDefinitionIndex = 2978;
