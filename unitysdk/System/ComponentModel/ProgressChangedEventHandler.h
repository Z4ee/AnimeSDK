...
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C868560)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C8685A0)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C867FD0)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C867FB0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ProgressChangedEventHandler_TypeDefinitionIndex = 2957;
