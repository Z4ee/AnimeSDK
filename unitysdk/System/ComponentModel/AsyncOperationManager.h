...
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATIONMANAGER_CREATEOPERATION_OFFSET UNITYSDK_OFFSET(0x1B3E8400)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATIONMANAGER_GET_SYNCHRONIZATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B3E84D0)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATIONMANAGER_SET_SYNCHRONIZATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B3E8530)
