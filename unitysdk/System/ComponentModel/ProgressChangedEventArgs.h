...
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS_GET_PROGRESSPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1D6A30B0)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS_GET_USERSTATE_OFFSET UNITYSDK_OFFSET(0x1D6A30C0)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A3050)
