...
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS_GET_PROGRESSPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1C2E2120)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS_GET_USERSTATE_OFFSET UNITYSDK_OFFSET(0x1C2E2130)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E20C0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ProgressChangedEventArgs_TypeDefinitionIndex = 2956;
