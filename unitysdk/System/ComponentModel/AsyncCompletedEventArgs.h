...
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTARGS_GET_CANCELLED_OFFSET UNITYSDK_OFFSET(0x19EE6200)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTARGS_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x19EE6210)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTARGS_GET_USERSTATE_OFFSET UNITYSDK_OFFSET(0x19EE6220)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTARGS_RAISEEXCEPTIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x19EE6230)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EE6190)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE6140)
