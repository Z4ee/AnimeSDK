...
#define SYSTEM_COMPONENTMODEL_UINT32CONVERTER_FROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x19167620)
#define SYSTEM_COMPONENTMODEL_UINT32CONVERTER_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x19167570)
#define SYSTEM_COMPONENTMODEL_UINT32CONVERTER_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x19167540)
#define SYSTEM_COMPONENTMODEL_UINT32CONVERTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19167660)

namespace System::ComponentModel
{
	inline static constexpr unsigned int UInt32Converter_TypeDefinitionIndex = 2641;
