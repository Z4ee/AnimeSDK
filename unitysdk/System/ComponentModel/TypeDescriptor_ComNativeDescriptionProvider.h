...
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GETTYPEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C2E2360)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GET_HANDLER_OFFSET UNITYSDK_OFFSET(0x1C2E2340)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_SET_HANDLER_OFFSET UNITYSDK_OFFSET(0x1C2E2350)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E2330)

namespace System::ComponentModel
{
	inline static constexpr unsigned int TypeDescriptor_ComNativeDescriptionProvider_TypeDefinitionIndex = 2997;
