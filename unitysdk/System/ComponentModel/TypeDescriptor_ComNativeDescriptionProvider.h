...
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GETTYPEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D6A32F0)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GET_HANDLER_OFFSET UNITYSDK_OFFSET(0x1D6A32D0)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_SET_HANDLER_OFFSET UNITYSDK_OFFSET(0x1D6A32E0)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A32C0)
