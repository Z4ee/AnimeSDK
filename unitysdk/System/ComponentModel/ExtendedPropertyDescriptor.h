...
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x1E283200)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1E283600)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E283230)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1E283360)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1E283260)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1E283330)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1E283630)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1E283660)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1E2836A0)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E283110)
#define SYSTEM_COMPONENTMODEL_EXTENDEDPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E282EF0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ExtendedPropertyDescriptor_TypeDefinitionIndex = 2882;

	class ExtendedPropertyDescriptor : public ::System::ComponentModel::PropertyDescriptor
	{
	public:
		::System::ComponentModel::IExtenderProvider* provider; // 0x88
		::System::ComponentModel::ReflectPropertyDescriptor* extenderInfo; // 0x90
