...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_ALLOCATEANDVALIDATELICENSE_OFFSET UNITYSDK_OFFSET(0x1C06F970)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_GETCURRENTCONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x1C06FFD0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_GETLICINFO_OFFSET UNITYSDK_OFFSET(0x1C06FD30)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_REQUESTLICKEY_OFFSET UNITYSDK_OFFSET(0x1C06FBB0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_SAVEKEYINCURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C070120)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C070200)
