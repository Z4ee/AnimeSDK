...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_ALLOCATEANDVALIDATELICENSE_OFFSET UNITYSDK_OFFSET(0x1D467F90)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_GETCURRENTCONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x1D468600)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_GETLICINFO_OFFSET UNITYSDK_OFFSET(0x1D468360)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_REQUESTLICKEY_OFFSET UNITYSDK_OFFSET(0x1D4681E0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_SAVEKEYINCURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1D468750)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D468830)

namespace System::ComponentModel
{
	inline static constexpr unsigned int LicenseManager_LicenseInteropHelper_TypeDefinitionIndex = 2929;
	...
	public:
		...
		::System::ComponentModel::LicenseContext* savedLicenseContext; // 0x18
		::System::Type* savedType; // 0x20
