...
#define SYSTEM_COMPONENTMODEL_ARRAYCONVERTER_ARRAYPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18FA53F0)
#define SYSTEM_COMPONENTMODEL_ARRAYCONVERTER_ARRAYPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18FA5470)
#define SYSTEM_COMPONENTMODEL_ARRAYCONVERTER_ARRAYPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA5360)
