...
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS_GET_NEWOBJECT_OFFSET UNITYSDK_OFFSET(0x1E7DE280)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS_SET_NEWOBJECT_OFFSET UNITYSDK_OFFSET(0x1E7DE290)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7DE220)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DE1D0)
