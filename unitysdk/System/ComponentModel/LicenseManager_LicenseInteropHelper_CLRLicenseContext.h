...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_CLRLICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1A7DAEF0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_CLRLICENSECONTEXT_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x1A7DAEE0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_CLRLICENSECONTEXT_SETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1A7DAF00)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_CLRLICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7DAED0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int LicenseManager_LicenseInteropHelper_CLRLicenseContext_TypeDefinitionIndex = 2931;
