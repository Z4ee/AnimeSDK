...
#define SYSTEM_COMPONENTMODEL_INVALIDASYNCHRONOUSSTATEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BAC370)
#define SYSTEM_COMPONENTMODEL_INVALIDASYNCHRONOUSSTATEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19BAC400)
#define SYSTEM_COMPONENTMODEL_INVALIDASYNCHRONOUSSTATEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19BAC490)
#define SYSTEM_COMPONENTMODEL_INVALIDASYNCHRONOUSSTATEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAC2E0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int InvalidAsynchronousStateException_TypeDefinitionIndex = 2922;
