...
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1C0704F0)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1C070560)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1C070910)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1C071360)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1C071370)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x1C070B90)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_ISVALUEALLOWED_OFFSET UNITYSDK_OFFSET(0x1C071380)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C071390)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06E260)
