...
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x19BAD5B0)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x19BAD620)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x19BAD9D0)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x19BAE420)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x19BAE430)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x19BADC50)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER_ISVALUEALLOWED_OFFSET UNITYSDK_OFFSET(0x19BAE440)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BAE450)
#define SYSTEM_COMPONENTMODEL_REFERENCECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAB330)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ReferenceConverter_TypeDefinitionIndex = 2969;
