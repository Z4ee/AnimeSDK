...
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19ADCC10)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19ADCC70)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x19ADCC00)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19ADCCE0)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ADCD70)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19ADCBF0)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADCBE0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int DesignTimeVisibleAttribute_TypeDefinitionIndex = 2865;
