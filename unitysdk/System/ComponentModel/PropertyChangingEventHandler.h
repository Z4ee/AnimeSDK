...
#define SYSTEM_COMPONENTMODEL_PROPERTYCHANGINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA95D20)
#define SYSTEM_COMPONENTMODEL_PROPERTYCHANGINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA95D60)
#define SYSTEM_COMPONENTMODEL_PROPERTYCHANGINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA957A0)
#define SYSTEM_COMPONENTMODEL_PROPERTYCHANGINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA95790)

namespace System::ComponentModel
{
	inline static constexpr unsigned int PropertyChangingEventHandler_TypeDefinitionIndex = 2962;
