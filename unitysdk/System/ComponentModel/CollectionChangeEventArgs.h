...
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1C64C210)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS_GET_ELEMENT_OFFSET UNITYSDK_OFFSET(0x1C64C220)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C64C1B0)
