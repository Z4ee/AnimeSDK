...
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A23E500)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS_GET_ELEMENT_OFFSET UNITYSDK_OFFSET(0x1A23E510)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A23E4A0)

namespace System::ComponentModel
{
	inline static constexpr unsigned int CollectionChangeEventArgs_TypeDefinitionIndex = 2834;
