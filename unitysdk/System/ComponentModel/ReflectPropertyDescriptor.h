...
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_ADDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18FAD4B0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x18FAEC10)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERCANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x18FAD670)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERGETRECEIVERTYPE_OFFSET UNITYSDK_OFFSET(0x18FADB20)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERGETTYPE_OFFSET UNITYSDK_OFFSET(0x18FADB30)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERGETVALUE_OFFSET UNITYSDK_OFFSET(0x18FAD9C0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERRESETVALUE_OFFSET UNITYSDK_OFFSET(0x18FADB40)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERSETVALUE_OFFSET UNITYSDK_OFFSET(0x18FAE0F0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERSHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x18FAE650)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18FAF580)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18FAEEF0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_AMBIENTVALUE_OFFSET UNITYSDK_OFFSET(0x18FABC50)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_CHANGEDEVENTVALUE_OFFSET UNITYSDK_OFFSET(0x18FABDA0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x18FAC120)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x18FAC130)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_GETMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18FAC340)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_IPROPCHANGEDEVENTVALUE_OFFSET UNITYSDK_OFFSET(0x18FABF30)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_ISEXTENDER_OFFSET UNITYSDK_OFFSET(0x18FAC810)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18FAC820)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x18FACEE0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_RESETMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18FACEF0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_SETMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18FAC900)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_SHOULDSERIALIZEMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18FAD1D0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_SUPPORTSCHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x18FB12C0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_ONINOTIFYPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x18FB0270)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18FB0410)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_REMOVEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18FB0520)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x18FB06E0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18FB0BB0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_SET_IPROPCHANGEDEVENTVALUE_OFFSET UNITYSDK_OFFSET(0x18FAC0B0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x18FAF180)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FB1300)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FAB7A0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FAB8B0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FAB970)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18FAB460)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ReflectPropertyDescriptor_TypeDefinitionIndex = 2972;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(ReflectPropertyDescriptor_TypeDefinitionIndex)->GetStaticField(0x2BB0);
		}
		...
		{
			return (::System::Diagnostics::TraceSwitch**)Il2CppClass::FromTypeDefinitionIndex(ReflectPropertyDescriptor_TypeDefinitionIndex)->GetStaticField(0x2BC8);
		}
		...
		::System::Reflection::MethodInfo* resetMethod; // 0x88
		::System::Type* receiverType; // 0x90
		::System::Type* type; // 0x98
		::System::Reflection::MethodInfo* setMethod; // 0xA0
		::System::Reflection::MethodInfo* shouldSerializeMethod; // 0xA8
		::System::Type* componentClass; // 0xB0
		::System::Reflection::PropertyInfo* propInfo; // 0xB8
		::System::ComponentModel::EventDescriptor* realChangedEvent; // 0xC0
		::System::ComponentModel::EventDescriptor* realIPropChangedEvent; // 0xC8
		::System::Reflection::MethodInfo* getMethod; // 0xD0
		::System::Object* defaultValue; // 0xD8
		::System::Object* ambientValue; // 0xE0
