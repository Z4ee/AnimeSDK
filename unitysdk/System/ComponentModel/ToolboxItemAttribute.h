...
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEB8180)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEB84D0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GET_TOOLBOXITEMTYPENAME_OFFSET UNITYSDK_OFFSET(0x1DEB84B0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GET_TOOLBOXITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1DEB8310)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DEB8040)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEB8560)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEB82A0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DEB82E0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB8250)

namespace System::ComponentModel
{
	inline static constexpr unsigned int ToolboxItemAttribute_TypeDefinitionIndex = 3024;
	...
	public:
		...
		::System::String* toolboxItemTypeName; // 0x10
		::System::Type* toolboxItemType; // 0x18
