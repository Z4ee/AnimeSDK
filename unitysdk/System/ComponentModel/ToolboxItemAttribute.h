...
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CAF0D10)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CAF1060)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GET_TOOLBOXITEMTYPENAME_OFFSET UNITYSDK_OFFSET(0x1CAF1040)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GET_TOOLBOXITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1CAF0EA0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1CAF0BC0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CAF10F0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAF0E30)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CAF0E70)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAF0DE0)
