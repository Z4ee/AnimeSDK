...
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0x1CAEE6E0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_ADDHANDLER_OFFSET UNITYSDK_OFFSET(0x1CAEE640)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CAEE7C0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_FIND_OFFSET UNITYSDK_OFFSET(0x1CAEE580)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CAEE550)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_REMOVEHANDLER_OFFSET UNITYSDK_OFFSET(0x1CAEE7D0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CAEE5B0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAEE540)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAEE530)
