...
#define SYSTEM_URI_MOREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x187684D0)

namespace System
{
	inline static constexpr unsigned int Uri_MoreInfo_TypeDefinitionIndex = 2453;
