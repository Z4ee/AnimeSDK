...
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x1AFE0320)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x1AFE0360)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1AFE0260)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1AFE02E0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AFE02A0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1AFE03A0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE0220)

namespace System::Configuration
{
	inline static constexpr unsigned int SchemeSettingElementCollection_TypeDefinitionIndex = 4220;
