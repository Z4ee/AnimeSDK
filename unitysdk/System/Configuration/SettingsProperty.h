...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DEB87D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1DEB8810)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1DEB8890)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DEB8910)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1DEB8990)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1DEB8A10)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1DEB8A90)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_THROWONERRORDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1DEB8B10)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_THROWONERRORSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1DEB8B90)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1DEB8850)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1DEB88D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1DEB8950)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1DEB89D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1DEB8A50)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1DEB8AD0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_THROWONERRORDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1DEB8B50)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_THROWONERRORSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1DEB8BD0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEB8750)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DEB8790)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB8710)
