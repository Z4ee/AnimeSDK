...
#define SYSTEM_CONFIGURATION_SETTINGSGROUPDESCRIPTIONATTRIBUTE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AFE03F0)
#define SYSTEM_CONFIGURATION_SETTINGSGROUPDESCRIPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE03E0)

namespace System::Configuration
{
	inline static constexpr unsigned int SettingsGroupDescriptionAttribute_TypeDefinitionIndex = 4222;
