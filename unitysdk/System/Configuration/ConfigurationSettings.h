...
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x1AFDFF90)
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS_GET_APPSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AFDFF50)
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDFF10)

namespace System::Configuration
{
	inline static constexpr unsigned int ConfigurationSettings_TypeDefinitionIndex = 4205;
