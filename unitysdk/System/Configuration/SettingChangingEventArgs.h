...
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x19AE5390)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGCLASS_OFFSET UNITYSDK_OFFSET(0x19AE53D0)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGKEY_OFFSET UNITYSDK_OFFSET(0x19AE5410)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x19AE5450)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE5350)

namespace System::Configuration
{
	inline static constexpr unsigned int SettingChangingEventArgs_TypeDefinitionIndex = 4195;
