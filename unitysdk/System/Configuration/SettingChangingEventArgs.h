...
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x1D3F8FE0)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGCLASS_OFFSET UNITYSDK_OFFSET(0x1D3F9020)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGKEY_OFFSET UNITYSDK_OFFSET(0x1D3F9060)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x1D3F90A0)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F8FA0)
