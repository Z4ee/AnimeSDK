...
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1B401540)
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B401530)
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B401520)
