...
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E2851C0)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E285200)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E285180)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E285140)
