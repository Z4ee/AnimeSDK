...
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D46B8A0)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D46B8E0)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D46B860)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D46B820)

namespace System::Configuration
{
	inline static constexpr unsigned int SettingChangingEventHandler_TypeDefinitionIndex = 4193;
