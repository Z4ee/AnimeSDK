...
#define SYSTEM_CONFIGURATION_CLIENTSETTINGSSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CC052D0)
#define SYSTEM_CONFIGURATION_CLIENTSETTINGSSECTION_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1CC05310)
#define SYSTEM_CONFIGURATION_CLIENTSETTINGSSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC05290)
