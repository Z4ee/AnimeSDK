...
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2E2A20)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2E2A60)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2E29E0)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E29A0)
