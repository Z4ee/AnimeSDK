...
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AFE00E0)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_GET_KEYATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1AFE0060)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_GET_VALUEATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1AFE00A0)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE0020)

namespace System::Configuration
{
	inline static constexpr unsigned int DictionarySectionHandler_TypeDefinitionIndex = 4208;
