...
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GETPREVIOUSVERSION_OFFSET UNITYSDK_OFFSET(0x1AA96C10)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GETPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x1AA96C50)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GET_APPLICATIONNAME_OFFSET UNITYSDK_OFFSET(0x1AA96B90)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA96C90)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_RESET_OFFSET UNITYSDK_OFFSET(0x1AA96CD0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_SETPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x1AA96D10)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_SET_APPLICATIONNAME_OFFSET UNITYSDK_OFFSET(0x1AA96BD0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_UPGRADE_OFFSET UNITYSDK_OFFSET(0x1AA96D50)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA96B50)

namespace System::Configuration
{
	inline static constexpr unsigned int LocalFileSettingsProvider_TypeDefinitionIndex = 4215;
