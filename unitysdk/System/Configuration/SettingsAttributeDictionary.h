...
#define SYSTEM_CONFIGURATION_SETTINGSATTRIBUTEDICTIONARY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C87D090)
#define SYSTEM_CONFIGURATION_SETTINGSATTRIBUTEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C87D050)
