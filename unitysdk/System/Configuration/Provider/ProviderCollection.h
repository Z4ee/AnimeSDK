...
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1C55D390)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C55D3D0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C55D2D0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1C55D310)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1C55D350)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1C55D410)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C55D290)

namespace System::Configuration::Provider
{
	inline static constexpr unsigned int ProviderCollection_TypeDefinitionIndex = 2517;
