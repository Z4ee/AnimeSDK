...
#define SYSTEM_CONFIGURATION_URISECTION_GET_IDN_OFFSET UNITYSDK_OFFSET(0x1D46B960)
#define SYSTEM_CONFIGURATION_URISECTION_GET_IRIPARSING_OFFSET UNITYSDK_OFFSET(0x1D46B9A0)
#define SYSTEM_CONFIGURATION_URISECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D46B9E0)
#define SYSTEM_CONFIGURATION_URISECTION_GET_SCHEMESETTINGS_OFFSET UNITYSDK_OFFSET(0x1D46BA20)
#define SYSTEM_CONFIGURATION_URISECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D46B920)
