...
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FC6BA30)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1FC6B8B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1FC6B8F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1FC6B930)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1FC6B970)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1FC6B9B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_THROWONDUPLICATE_OFFSET UNITYSDK_OFFSET(0x1FC6B9F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x1FC6BA70)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x1FC6BAF0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_RESET_OFFSET UNITYSDK_OFFSET(0x1FC6BAB0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1FC6BB30)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_UNMERGE_OFFSET UNITYSDK_OFFSET(0x1FC6BB70)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC6B870)
