...
#define SYSTEM_CONFIGURATION_SPECIALSETTINGATTRIBUTE_GET_SPECIALSETTING_OFFSET UNITYSDK_OFFSET(0x1D6A3D40)
#define SYSTEM_CONFIGURATION_SPECIALSETTINGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A3D30)
