...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYWRONGTYPEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A240F80)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYWRONGTYPEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A240FC0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYWRONGTYPEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A241000)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYWRONGTYPEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A240F40)

namespace System::Configuration
{
	inline static constexpr unsigned int SettingsPropertyWrongTypeException_TypeDefinitionIndex = 4228;
