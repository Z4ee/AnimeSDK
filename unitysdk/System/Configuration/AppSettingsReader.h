...
#define SYSTEM_CONFIGURATION_APPSETTINGSREADER_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1D2325A0)
#define SYSTEM_CONFIGURATION_APPSETTINGSREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D232560)
