...
#define SYSTEM_CONFIGURATION_DEFAULTSETTINGVALUEATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D456A50)
#define SYSTEM_CONFIGURATION_DEFAULTSETTINGVALUEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D456A40)
