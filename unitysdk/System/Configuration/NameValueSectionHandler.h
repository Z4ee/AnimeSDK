...
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A570680)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_GET_KEYATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1A570600)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_GET_VALUEATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1A570640)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5705C0)

namespace System::Configuration
{
	inline static constexpr unsigned int NameValueSectionHandler_TypeDefinitionIndex = 4217;
