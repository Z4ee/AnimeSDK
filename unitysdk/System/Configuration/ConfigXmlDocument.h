...
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1C1C18A0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1C1C18E0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_LOADSINGLEELEMENT_OFFSET UNITYSDK_OFFSET(0x1C1C19A0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_SYSTEM_CONFIGURATION_INTERNAL_ICONFIGERRORINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1C1C1920)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_SYSTEM_CONFIGURATION_INTERNAL_ICONFIGERRORINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1C1C1960)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C1860)
