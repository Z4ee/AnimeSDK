...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1CC05490)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CC054D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC05510)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1CC05550)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CC05590)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1CC05390)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1CC053D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CC05410)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1CC05450)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONADDCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1CC05610)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONADD_OFFSET UNITYSDK_OFFSET(0x1CC055D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONCLEARCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1CC05690)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x1CC05650)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONREMOVECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1CC05710)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x1CC056D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1CC05750)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_SETREADONLY_OFFSET UNITYSDK_OFFSET(0x1CC05790)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC05350)
