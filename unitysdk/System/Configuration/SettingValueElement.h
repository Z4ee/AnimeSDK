...
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1D3F91E0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D3F9120)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_GET_VALUEXML_OFFSET UNITYSDK_OFFSET(0x1D3F9160)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x1D3F9220)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x1D3F92A0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x1D3F9260)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_SERIALIZETOXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x1D3F92E0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_SET_VALUEXML_OFFSET UNITYSDK_OFFSET(0x1D3F91A0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_UNMERGE_OFFSET UNITYSDK_OFFSET(0x1D3F9320)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F90E0)

namespace System::Configuration
{
	inline static constexpr unsigned int SettingValueElement_TypeDefinitionIndex = 4203;
