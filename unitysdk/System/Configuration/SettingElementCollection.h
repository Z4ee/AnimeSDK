...
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1D2326A0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D2326E0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x1D232720)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x1D2327A0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1D232620)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1D232660)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x1D232760)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D2327E0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2325E0)

namespace System::Configuration
{
	inline static constexpr unsigned int SettingElementCollection_TypeDefinitionIndex = 4201;
