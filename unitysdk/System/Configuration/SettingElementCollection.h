...
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1BEC0D40)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BEC0D80)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x1BEC0DC0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x1BEC0E40)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1BEC0CC0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1BEC0D00)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x1BEC0E00)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1BEC0E80)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC0C80)
