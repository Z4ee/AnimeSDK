...
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1FC6B670)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1FC6B630)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_INITIALIZEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1FC6B6B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x1FC6B6F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FC6B730)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x1FC6B7B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x1FC6B770)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_SERIALIZETOXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x1FC6B7F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_UNMERGE_OFFSET UNITYSDK_OFFSET(0x1FC6B830)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC6B5F0)
