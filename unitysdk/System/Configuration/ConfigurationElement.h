...
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1C55CA50)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C55CA10)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_INITIALIZEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1C55CA90)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x1C55CAD0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C55CB10)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x1C55CB90)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x1C55CB50)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_SERIALIZETOXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x1C55CBD0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_UNMERGE_OFFSET UNITYSDK_OFFSET(0x1C55CC10)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C55C9D0)

namespace System::Configuration
{
	inline static constexpr unsigned int ConfigurationElement_TypeDefinitionIndex = 2509;
