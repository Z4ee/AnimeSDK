...
#define SYSTEM_CONFIGURATION_IDNELEMENT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1D3F8EE0)
#define SYSTEM_CONFIGURATION_IDNELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1D3F8F60)
#define SYSTEM_CONFIGURATION_IDNELEMENT_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1D3F8F20)
#define SYSTEM_CONFIGURATION_IDNELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F8EA0)
