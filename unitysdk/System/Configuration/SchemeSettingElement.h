...
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_GENERICURIPARSEROPTIONS_OFFSET UNITYSDK_OFFSET(0x1CAF11E0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CAF1220)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CAF1260)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAF11A0)
