...
#define SYSTEM_DATETIMERESULT_INIT_OFFSET UNITYSDK_OFFSET(0x86D330)
#define SYSTEM_DATETIMERESULT_SETDATE_OFFSET UNITYSDK_OFFSET(0x3EABD0)
#define SYSTEM_DATETIMERESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x86D370)
#define SYSTEM_DATETIMERESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x86D360)

namespace System
{
	inline static constexpr unsigned int DateTimeResult_TypeDefinitionIndex = 252;
