...
#define SYSTEM_MONOLIMITATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1850AD10)

namespace System
{
	inline static constexpr unsigned int MonoLimitationAttribute_TypeDefinitionIndex = 3085;
