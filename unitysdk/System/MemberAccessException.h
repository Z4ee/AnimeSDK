...
#define SYSTEM_MEMBERACCESSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CD8EC70)
#define SYSTEM_MEMBERACCESSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CD8ED00)
#define SYSTEM_MEMBERACCESSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD8EBB0)

namespace System
{
	inline static constexpr unsigned int MemberAccessException_TypeDefinitionIndex = 284;
