...
#define SYSTEM_FORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C94C0)
#define SYSTEM_FORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191CF360)
#define SYSTEM_FORMATEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191CF3D0)
#define SYSTEM_FORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191CF2C0)
