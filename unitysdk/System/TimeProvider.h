...
#define SYSTEM_TIMEPROVIDER_GET_SYSTEM_OFFSET UNITYSDK_OFFSET(0x1B6E0970)
#define SYSTEM_TIMEPROVIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6E09E0)
#define SYSTEM_TIMEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E09D0)
