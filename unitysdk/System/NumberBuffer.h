...
#define SYSTEM_NUMBERBUFFER_GET_DIGITS_OFFSET UNITYSDK_OFFSET(0x99E2F0)
#define SYSTEM_NUMBERBUFFER_GET_NUMDIGITS_OFFSET UNITYSDK_OFFSET(0x99E320)
#define SYSTEM_NUMBERBUFFER_GET_UNSAFEDIGITS_OFFSET UNITYSDK_OFFSET(0x99E310)
#define SYSTEM_NUMBERBUFFER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x99E3A0)

namespace System
{
	inline static constexpr unsigned int NumberBuffer_TypeDefinitionIndex = 7541;
