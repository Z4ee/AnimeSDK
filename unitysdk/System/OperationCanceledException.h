...
#define SYSTEM_OPERATIONCANCELEDEXCEPTION_GET_CANCELLATIONTOKEN_OFFSET UNITYSDK_OFFSET(0x1CC0C0F0)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION_SET_CANCELLATIONTOKEN_OFFSET UNITYSDK_OFFSET(0x1CC0C100)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC0C180)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CC0C1F0)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CC0C260)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1CC0C2E0)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1CC0C350)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC0C110)
