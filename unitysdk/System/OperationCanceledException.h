...
#define SYSTEM_OPERATIONCANCELEDEXCEPTION_GET_CANCELLATIONTOKEN_OFFSET UNITYSDK_OFFSET(0x1D061C70)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D061D40)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D061DD0)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D061E60)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1D061F30)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1D061FD0)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1D062070)
#define SYSTEM_OPERATIONCANCELEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D061C80)
