...
#define SYSTEM_METHODACCESSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF383F0)
#define SYSTEM_METHODACCESSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DF38480)
#define SYSTEM_METHODACCESSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF38330)

namespace System
{
	inline static constexpr unsigned int MethodAccessException_TypeDefinitionIndex = 285;
