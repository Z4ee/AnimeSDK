...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1A31A2C0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1A31A1C0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A31A240)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1A31A200)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A31A280)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31A1B0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EventLogPermissionAttribute_TypeDefinitionIndex = 4174;
