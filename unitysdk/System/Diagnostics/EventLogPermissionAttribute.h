...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1C6C7FC0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1C6C7EC0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1C6C7F40)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1C6C7F00)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1C6C7F80)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6C7EB0)
