...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_EXITTIME_OFFSET UNITYSDK_OFFSET(0x1B753280)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1B753290)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1B753270)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1B7532B0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1B7532A0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7532C0)
...
namespace System::Diagnostics
{
	...
	{
	public:
		::System::Int64 exit; // 0x10
		::System::Int64 kernel; // 0x18
		::System::Int64 create; // 0x20
		::System::Int64 user; // 0x28
