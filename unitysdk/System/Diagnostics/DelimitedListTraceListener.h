...
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A319070)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_GET_DELIMITER_OFFSET UNITYSDK_OFFSET(0x1A318D50)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_SET_DELIMITER_OFFSET UNITYSDK_OFFSET(0x1A318E90)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x1A319AD0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x1A3199E0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1A319910)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x1A3190E0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEESCAPED_OFFSET UNITYSDK_OFFSET(0x1A319350)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEFOOTER_OFFSET UNITYSDK_OFFSET(0x1A3194C0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1A319250)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITESTACKESCAPED_OFFSET UNITYSDK_OFFSET(0x1A319C60)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A318AC0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A318B20)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A318BE0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A318C90)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A318CF0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A318A60)
