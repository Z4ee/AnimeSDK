...
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DB787E0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_GET_DELIMITER_OFFSET UNITYSDK_OFFSET(0x1DB784C0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_SET_DELIMITER_OFFSET UNITYSDK_OFFSET(0x1DB78600)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x1DB79250)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x1DB79160)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1DB79090)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x1DB78850)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEESCAPED_OFFSET UNITYSDK_OFFSET(0x1DB78AC0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEFOOTER_OFFSET UNITYSDK_OFFSET(0x1DB78C40)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1DB789C0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITESTACKESCAPED_OFFSET UNITYSDK_OFFSET(0x1DB793F0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB78230)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB78290)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DB78350)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DB78400)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DB78460)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB781D0)
