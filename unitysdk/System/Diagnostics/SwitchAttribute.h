...
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_1_OFFSET UNITYSDK_OFFSET(0x1D5D0110)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1D5CFF80)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALL_OFFSET UNITYSDK_OFFSET(0x1D5CFDB0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D5CFD90)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x1D5CFD70)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x1D5CFD80)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D5CFDA0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x1D5CFC10)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x1D5CFD00)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CFBA0)
