...
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_1_OFFSET UNITYSDK_OFFSET(0x1B1E8630)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1B1E84A0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALL_OFFSET UNITYSDK_OFFSET(0x1B1E82D0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B1E82B0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x1B1E8290)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x1B1E82A0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B1E82C0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x1B1E8130)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x1B1E8220)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E80C0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int SwitchAttribute_TypeDefinitionIndex = 2762;
