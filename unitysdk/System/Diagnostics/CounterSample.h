...
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_CALCULATE_1_OFFSET UNITYSDK_OFFSET(0x1B752C70)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x1B752C30)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x91CAE0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_BASEVALUE_OFFSET UNITYSDK_OFFSET(0x91C8E0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERFREQUENCY_OFFSET UNITYSDK_OFFSET(0x91C920)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x91C960)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERTYPE_OFFSET UNITYSDK_OFFSET(0x91C9A0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x91C9E0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_SYSTEMFREQUENCY_OFFSET UNITYSDK_OFFSET(0x91CA20)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_TIMESTAMP100NSEC_OFFSET UNITYSDK_OFFSET(0x91CAA0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x91CA60)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B752CF0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B752D30)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x91C8A0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x91C860)
...
namespace System::Diagnostics
{
	...
	struct alignas(1) CounterSample
	{
		...
		{
			return (::System::Diagnostics::CounterSample*)Il2CppClass::FromTypeDefinitionIndex(CounterSample_TypeDefinitionIndex)->GetStaticField(0x12FB0);
		}
