...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x19A4FBD0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A4FB10)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19A4FB50)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19A4FB90)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4FAD0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int PerformanceCounterPermission_TypeDefinitionIndex = 4184;
