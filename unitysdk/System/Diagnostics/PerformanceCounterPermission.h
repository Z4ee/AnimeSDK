...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x1D232F20)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D232E60)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D232EA0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D232EE0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D232E20)
