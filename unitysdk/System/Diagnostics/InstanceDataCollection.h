...
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B4020F0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B402130)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x1B401FF0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B402030)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1B402070)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1B4020B0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B401FB0)
