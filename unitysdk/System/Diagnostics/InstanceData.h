...
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA_GET_INSTANCENAME_OFFSET UNITYSDK_OFFSET(0x19BB19B0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA_GET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x19BB19F0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x19BB1A30)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB1970)

namespace System::Diagnostics
{
	inline static constexpr unsigned int InstanceData_TypeDefinitionIndex = 4177;
