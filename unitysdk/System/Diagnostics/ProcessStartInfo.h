...
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A0FB340)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_CREATENOWINDOW_OFFSET UNITYSDK_OFFSET(0x1A0FB370)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1A0FBB80)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ENVIRONMENTVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A0FB390)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ENVIRONMENT_OFFSET UNITYSDK_OFFSET(0x1A0FB9E0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ERRORDIALOGPARENTHANDLE_OFFSET UNITYSDK_OFFSET(0x1A0FBC50)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ERRORDIALOG_OFFSET UNITYSDK_OFFSET(0x1A0FBC30)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A0FBBD0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_HAVEENVVARS_OFFSET UNITYSDK_OFFSET(0x1A0FBDB0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_LOADUSERPROFILE_OFFSET UNITYSDK_OFFSET(0x1A0FBBB0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_PASSWORDINCLEARTEXT_OFFSET UNITYSDK_OFFSET(0x1A0FBB60)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1A0FBB40)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_REDIRECTSTANDARDERROR_OFFSET UNITYSDK_OFFSET(0x1A0FBA90)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_REDIRECTSTANDARDINPUT_OFFSET UNITYSDK_OFFSET(0x1A0FBA50)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_REDIRECTSTANDARDOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A0FBA70)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_STANDARDERRORENCODING_OFFSET UNITYSDK_OFFSET(0x1A0FBAB0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_STANDARDOUTPUTENCODING_OFFSET UNITYSDK_OFFSET(0x1A0FBAD0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1A0FBB10)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_USESHELLEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0FBAF0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_VERBS_OFFSET UNITYSDK_OFFSET(0x1A0FBDC0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_VERB_OFFSET UNITYSDK_OFFSET(0x1A0FB310)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_WINDOWSTYLE_OFFSET UNITYSDK_OFFSET(0x1A0FBC70)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_WORKINGDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1A0FBC00)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A0FB360)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_CREATENOWINDOW_OFFSET UNITYSDK_OFFSET(0x1A0FB380)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1A0FBBA0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_ERRORDIALOGPARENTHANDLE_OFFSET UNITYSDK_OFFSET(0x1A0FBC60)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_ERRORDIALOG_OFFSET UNITYSDK_OFFSET(0x1A0FBC40)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A0FBBF0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_LOADUSERPROFILE_OFFSET UNITYSDK_OFFSET(0x1A0FBBC0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_PASSWORDINCLEARTEXT_OFFSET UNITYSDK_OFFSET(0x1A0FBB70)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1A0FBB50)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_REDIRECTSTANDARDERROR_OFFSET UNITYSDK_OFFSET(0x1A0FBAA0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_REDIRECTSTANDARDINPUT_OFFSET UNITYSDK_OFFSET(0x1A0FBA60)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_REDIRECTSTANDARDOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A0FBA80)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_STANDARDERRORENCODING_OFFSET UNITYSDK_OFFSET(0x1A0FBAC0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_STANDARDOUTPUTENCODING_OFFSET UNITYSDK_OFFSET(0x1A0FBAE0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1A0FBB30)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_USESHELLEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0FBB00)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_VERB_OFFSET UNITYSDK_OFFSET(0x1A0FB330)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_WINDOWSTYLE_OFFSET UNITYSDK_OFFSET(0x1A0FBC80)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_WORKINGDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1A0FBC20)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0FBE20)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0FB290)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0FB2F0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A0FB300)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FB280)
