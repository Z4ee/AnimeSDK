...
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x193AA7B0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x193AA7C0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_OFFSET UNITYSDK_OFFSET(0x193A9F40)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x193A9BA0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FAIL_1_OFFSET UNITYSDK_OFFSET(0x193AA7D0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FAIL_OFFSET UNITYSDK_OFFSET(0x193A9F60)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x193A9390)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_APPNAME_OFFSET UNITYSDK_OFFSET(0x193A7FE0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x193A8060)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x193A80A0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x193A85C0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x193A7B90)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_USEGLOBALLOCK_OFFSET UNITYSDK_OFFSET(0x193A8080)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_INDENT_OFFSET UNITYSDK_OFFSET(0x193A8A50)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_INITIALIZESETTINGS_OFFSET UNITYSDK_OFFSET(0x193AB030)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_REFRESH_OFFSET UNITYSDK_OFFSET(0x193AB040)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SETINDENTSIZE_OFFSET UNITYSDK_OFFSET(0x193A85E0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x193A8070)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x193A80F0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x193A85D0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_USEGLOBALLOCK_OFFSET UNITYSDK_OFFSET(0x193A8090)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x193AB100)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_UNINDENT_OFFSET UNITYSDK_OFFSET(0x193A8EF0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_1_OFFSET UNITYSDK_OFFSET(0x193B0AF0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_2_OFFSET UNITYSDK_OFFSET(0x193B0B00)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_3_OFFSET UNITYSDK_OFFSET(0x193B0B10)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_OFFSET UNITYSDK_OFFSET(0x193B0AE0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_1_OFFSET UNITYSDK_OFFSET(0x193B0B30)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_2_OFFSET UNITYSDK_OFFSET(0x193B0B40)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_3_OFFSET UNITYSDK_OFFSET(0x193B0B50)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_OFFSET UNITYSDK_OFFSET(0x193B0B20)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x193AF1D0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x193AFA20)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_3_OFFSET UNITYSDK_OFFSET(0x193B0280)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_OFFSET UNITYSDK_OFFSET(0x193AE980)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_1_OFFSET UNITYSDK_OFFSET(0x193AD070)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_2_OFFSET UNITYSDK_OFFSET(0x193AD8C0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_3_OFFSET UNITYSDK_OFFSET(0x193AE120)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_OFFSET UNITYSDK_OFFSET(0x193AC820)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x193B0B60)

namespace System::Diagnostics
{
	inline static constexpr unsigned int TraceInternal_TypeDefinitionIndex = 2769;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(TraceInternal_TypeDefinitionIndex)->GetStaticField(0x26F0);
		}
		static ::System::Object** StaticGet_critSec()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(TraceInternal_TypeDefinitionIndex)->GetStaticField(0x26F8);
		}
