...
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1921D150)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1921D180)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1921CC50)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1921CC40)

namespace System::Diagnostics
{
	inline static constexpr unsigned int UserCallBack_TypeDefinitionIndex = 2777;
