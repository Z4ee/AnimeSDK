...
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A31A320)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A31A330)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x1A31A310)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31A300)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EventTypeFilter_TypeDefinitionIndex = 2757;
