...
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DB798C0)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DB79900)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DB79880)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB79840)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EntryWrittenEventHandler_TypeDefinitionIndex = 4094;
