...
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLECALCULATOR_COMPUTECOUNTERVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D6A3DC0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLECALCULATOR_COMPUTECOUNTERVALUE_OFFSET UNITYSDK_OFFSET(0x1D6A3D80)
