...
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1C1C2780)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1C1C2680)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x1C1C26F0)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C2610)

namespace System::Diagnostics
{
	inline static constexpr unsigned int SourceFilter_TypeDefinitionIndex = 2757;
