...
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1D618040)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1D617F40)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x1D617FB0)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D617ED0)
