...
#define SYSTEM_DIAGNOSTICS_CODEANALYSIS_MAYBENULLWHENATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9BEE30)

namespace System::Diagnostics::CodeAnalysis
{
	inline static constexpr unsigned int MaybeNullWhenAttribute_TypeDefinitionIndex = 28681;
