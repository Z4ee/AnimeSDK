...
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x186A7B80)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x186A93A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x186A8520)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x186A9230)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_INITIALIZELISTENER_OFFSET UNITYSDK_OFFSET(0x186A9260)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x186A93F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x186A9D60)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x186A9D50)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x186A9D40)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x186A96F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x186A9980)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x186A96E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x186A96D0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x186A94C0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x186A99B0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x186A99E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x186A9C70)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x186A94F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x186A7A90)

namespace System::Diagnostics
{
	inline static constexpr unsigned int TraceListenerCollection_TypeDefinitionIndex = 2531;
