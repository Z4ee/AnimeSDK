...
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1D5D0200)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEERROR_OFFSET UNITYSDK_OFFSET(0x1D5D02B0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEINFO_OFFSET UNITYSDK_OFFSET(0x1D5D0330)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEVERBOSE_OFFSET UNITYSDK_OFFSET(0x1D5D0370)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEWARNING_OFFSET UNITYSDK_OFFSET(0x1D5D02F0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_ONSWITCHSETTINGCHANGED_OFFSET UNITYSDK_OFFSET(0x1D5D03B0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1D5D0410)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1D5D0240)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D5D0190)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CB070)
