...
#define SYSTEM_DIAGNOSTICS_SWITCH_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19AE6A70)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19AE67B0)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19AE68C0)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19AE68B0)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_INTIALIZEDLOCK_OFFSET UNITYSDK_OFFSET(0x19AE61D0)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_SWITCHSETTING_OFFSET UNITYSDK_OFFSET(0x19AE5F30)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19AE61B0)
#define SYSTEM_DIAGNOSTICS_SWITCH_INITIALIZECONFIGSETTINGS_OFFSET UNITYSDK_OFFSET(0x19AE6A60)
#define SYSTEM_DIAGNOSTICS_SWITCH_INITIALIZEWITHSTATUS_OFFSET UNITYSDK_OFFSET(0x19AE68E0)
#define SYSTEM_DIAGNOSTICS_SWITCH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19AE68A0)
#define SYSTEM_DIAGNOSTICS_SWITCH_ONSWITCHSETTINGCHANGED_OFFSET UNITYSDK_OFFSET(0x19AE6A80)
#define SYSTEM_DIAGNOSTICS_SWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19AE6A90)
#define SYSTEM_DIAGNOSTICS_SWITCH_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x19AE6AE0)
#define SYSTEM_DIAGNOSTICS_SWITCH_REFRESH_OFFSET UNITYSDK_OFFSET(0x19AE6D10)
#define SYSTEM_DIAGNOSTICS_SWITCH_SET_SWITCHSETTING_OFFSET UNITYSDK_OFFSET(0x19AE5F80)
#define SYSTEM_DIAGNOSTICS_SWITCH_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19AE6A30)
#define SYSTEM_DIAGNOSTICS_SWITCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AE6DF0)
#define SYSTEM_DIAGNOSTICS_SWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19AE5D40)
#define SYSTEM_DIAGNOSTICS_SWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE5C80)
#define SYSTEM_DIAGNOSTICS_SWITCH__PRUNECACHEDSWITCHES_OFFSET UNITYSDK_OFFSET(0x19AE6210)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::Object* m_intializedLock; // 0x18
		...
		::System::String* switchValueString; // 0x38
		::System::String* defaultValue; // 0x40
