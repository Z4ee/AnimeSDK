...
#define SYSTEM_DIAGNOSTICS_CONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18697070)

namespace System::Diagnostics
{
	inline static constexpr unsigned int ConditionalAttribute_TypeDefinitionIndex = 1561;
