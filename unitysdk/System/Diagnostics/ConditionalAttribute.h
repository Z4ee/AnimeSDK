...
#define SYSTEM_DIAGNOSTICS_CONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x178DED30)

namespace System::Diagnostics
{
	inline static constexpr unsigned int ConditionalAttribute_TypeDefinitionIndex = 1563;
