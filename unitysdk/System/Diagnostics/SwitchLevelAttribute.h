...
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE_GET_SWITCHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1D457380)
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE_SET_SWITCHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1D457310)
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4572A0)
