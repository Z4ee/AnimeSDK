...
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE_GET_SWITCHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1E7E1EB0)
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE_SET_SWITCHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1E7E1E40)
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E1DD0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int SwitchLevelAttribute_TypeDefinitionIndex = 2762;
