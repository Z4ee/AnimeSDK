...
#define SYSTEM_DIAGNOSTICS_TRACING_INT64TYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x1AB78C70)
#define SYSTEM_DIAGNOSTICS_TRACING_INT64TYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x1AB78BF0)
#define SYSTEM_DIAGNOSTICS_TRACING_INT64TYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB78D00)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int Int64TypeInfo_TypeDefinitionIndex = 1621;
