...
#define SYSTEM_DIAGNOSTICS_TRACING_STRINGTYPEINFO_GETDATA_OFFSET UNITYSDK_OFFSET(0x162DD480)
#define SYSTEM_DIAGNOSTICS_TRACING_STRINGTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x162DD2D0)
#define SYSTEM_DIAGNOSTICS_TRACING_STRINGTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x162DD280)
#define SYSTEM_DIAGNOSTICS_TRACING_STRINGTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x162DD4A0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int StringTypeInfo_TypeDefinitionIndex = 1640;
