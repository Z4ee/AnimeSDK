...
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1869A690)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TUPLE_SYSTEM_INT32_SYSTEM_INT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1869A810)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TUPLE_SYSTEM_INT32_SYSTEM_INT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1869A7A0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1869A9B0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1869A800)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1869A7B0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1869A680)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x1869A140)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int ActivityFilter__GetFilterAsTuple_d__7_TypeDefinitionIndex = 1686;

	class ActivityFilter__GetFilterAsTuple_d__7 : public ::System::Object
	{
	public:
		::System::Diagnostics::Tracing::ActivityFilter* _af_5__1; // 0x10
		::System::Tuple_2<::System::Int32, ::System::Int32>* __2__current; // 0x18
		::System::Diagnostics::Tracing::ActivityFilter* __4__this; // 0x20
		::System::Int32 __1__state; // 0x28
		::System::Int32 __l__initialThreadId; // 0x2C
		::System::Guid sourceGuid; // 0x30
		::System::Guid __3__sourceGuid; // 0x40
