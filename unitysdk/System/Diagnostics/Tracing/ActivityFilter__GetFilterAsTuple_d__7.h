...
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x178E2360)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TUPLE_SYSTEM_INT32_SYSTEM_INT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x178E24B0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TUPLE_SYSTEM_INT32_SYSTEM_INT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x178E2440)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x178E2650)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x178E24A0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x178E2450)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178E2350)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__GETFILTERASTUPLE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x178E1E00)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int ActivityFilter__GetFilterAsTuple_d__7_TypeDefinitionIndex = 1688;
	...
	public:
		...
		::System::Guid __3__sourceGuid; // 0x3C
