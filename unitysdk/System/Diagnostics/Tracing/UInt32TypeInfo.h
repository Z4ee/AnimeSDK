...
#define SYSTEM_DIAGNOSTICS_TRACING_UINT32TYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x162DFB50)
#define SYSTEM_DIAGNOSTICS_TRACING_UINT32TYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x162DFA70)
#define SYSTEM_DIAGNOSTICS_TRACING_UINT32TYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x162DFBE0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int UInt32TypeInfo_TypeDefinitionIndex = 1610;
