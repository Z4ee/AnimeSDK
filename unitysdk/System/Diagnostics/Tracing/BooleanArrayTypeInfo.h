...
#define SYSTEM_DIAGNOSTICS_TRACING_BOOLEANARRAYTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x1AB57490)
#define SYSTEM_DIAGNOSTICS_TRACING_BOOLEANARRAYTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x1AB57160)
#define SYSTEM_DIAGNOSTICS_TRACING_BOOLEANARRAYTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB57640)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int BooleanArrayTypeInfo_TypeDefinitionIndex = 1628;
