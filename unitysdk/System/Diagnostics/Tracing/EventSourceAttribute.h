...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEATTRIBUTE_GET_GUID_OFFSET UNITYSDK_OFFSET(0x186B8380)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEATTRIBUTE_GET_LOCALIZATIONRESOURCES_OFFSET UNITYSDK_OFFSET(0x186B83A0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x186B8360)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEATTRIBUTE_SET_GUID_OFFSET UNITYSDK_OFFSET(0x186B8390)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x186B8370)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x186B83B0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventSourceAttribute_TypeDefinitionIndex = 1681;
