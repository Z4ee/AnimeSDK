...
#define SYSTEM_DIAGNOSTICS_TRACING_MANIFESTBUILDER___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x162DB910)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int ManifestBuilder___c__DisplayClass22_0_TypeDefinitionIndex = 1697;

	class ManifestBuilder___c__DisplayClass22_0 : public ::System::Object
	{
	public:
		::System::Text::StringBuilder* stringBuilder; // 0x10
		::System::String* eventMessage; // 0x18
