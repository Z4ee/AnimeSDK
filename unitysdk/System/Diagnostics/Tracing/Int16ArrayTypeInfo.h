...
#define SYSTEM_DIAGNOSTICS_TRACING_INT16ARRAYTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x17902880)
#define SYSTEM_DIAGNOSTICS_TRACING_INT16ARRAYTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x179027F0)
#define SYSTEM_DIAGNOSTICS_TRACING_INT16ARRAYTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17902A30)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int Int16ArrayTypeInfo_TypeDefinitionIndex = 1622;
