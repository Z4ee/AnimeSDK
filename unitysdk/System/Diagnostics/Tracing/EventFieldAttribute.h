...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTFIELDATTRIBUTE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1919C2C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTFIELDATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1919C2B0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTFIELDATTRIBUTE_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1919C2A0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventFieldAttribute_TypeDefinitionIndex = 1592;
