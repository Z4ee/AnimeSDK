...
#define SYSTEM_DIAGNOSTICS_TRACING_CHARARRAYTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x1AB58270)
#define SYSTEM_DIAGNOSTICS_TRACING_CHARARRAYTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x1AB58190)
#define SYSTEM_DIAGNOSTICS_TRACING_CHARARRAYTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB58420)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int CharArrayTypeInfo_TypeDefinitionIndex = 1639;
