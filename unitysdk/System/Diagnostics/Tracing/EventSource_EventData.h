...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_GET_DATAPOINTER_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SETMETADATA_OFFSET UNITYSDK_OFFSET(0x39CEAC0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SET_DATAPOINTER_OFFSET UNITYSDK_OFFSET(0x164FF0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x38C2BD0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventSource_EventData_TypeDefinitionIndex = 1656;
