...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_GET_DATAPOINTER_OFFSET UNITYSDK_OFFSET(0x161E0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SETMETADATA_OFFSET UNITYSDK_OFFSET(0x3B67680)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SET_DATAPOINTER_OFFSET UNITYSDK_OFFSET(0x16050)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x379F970)
