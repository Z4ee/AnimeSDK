...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ADDEVENTDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x191B66F0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1919CBF0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ADDPROVIDERENUMKIND_OFFSET UNITYSDK_OFFSET(0x191B3F70)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ADDVALUETOMETADATA_OFFSET UNITYSDK_OFFSET(0x191A3FC0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ANYEVENTENABLED_OFFSET UNITYSDK_OFFSET(0x191AFE80)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ATTRIBUTETYPENAMESMATCH_OFFSET UNITYSDK_OFFSET(0x191B35B0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_CREATEMANIFESTANDDESCRIPTORS_OFFSET UNITYSDK_OFFSET(0x191B0BE0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_DEBUGCHECKEVENT_OFFSET UNITYSDK_OFFSET(0x191B59D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_DECODEOBJECT_OFFSET UNITYSDK_OFFSET(0x191AC0D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_DISPATCHTOALLLISTENERS_OFFSET UNITYSDK_OFFSET(0x191AD130)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x191AA2D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1919D090)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_DOCOMMAND_OFFSET UNITYSDK_OFFSET(0x191AAED0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ENABLEEVENTFORDISPATCHER_OFFSET UNITYSDK_OFFSET(0x191AF5C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ENSUREDESCRIPTORSINITIALIZED_OFFSET UNITYSDK_OFFSET(0x191AF0A0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x191AA770)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GENERATEGUIDFROMNAME_OFFSET UNITYSDK_OFFSET(0x191A64D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETCUSTOMATTRIBUTEHELPER_OFFSET UNITYSDK_OFFSET(0x191A49C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETDISPATCHER_OFFSET UNITYSDK_OFFSET(0x191AC860)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETETWSESSIONMASK_OFFSET UNITYSDK_OFFSET(0x191A8360)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETEVENTSOURCEBASETYPE_OFFSET UNITYSDK_OFFSET(0x191B3A00)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETGUID_OFFSET UNITYSDK_OFFSET(0x191A4780)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETHELPERCALLFIRSTARG_OFFSET UNITYSDK_OFFSET(0x191B6DE0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETNAME_1_OFFSET UNITYSDK_OFFSET(0x191A66C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETNAME_OFFSET UNITYSDK_OFFSET(0x191A6690)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETOPCODEWITHDEFAULT_OFFSET UNITYSDK_OFFSET(0x191AEE90)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GETPARAMLENGTHINCLUDINGBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x191AD000)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_CURRENTTHREADACTIVITYID_OFFSET UNITYSDK_OFFSET(0x19197C00)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_FALLBACKACTIVITYID_OFFSET UNITYSDK_OFFSET(0x191A67F0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_GUID_OFFSET UNITYSDK_OFFSET(0x191A46F0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_INTERNALCURRENTTHREADACTIVITYID_OFFSET UNITYSDK_OFFSET(0x19195F20)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x191B0BA0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x191A46E0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_SELFDESCRIBINGEVENTS_OFFSET UNITYSDK_OFFSET(0x191A8730)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_GET_THROWONEVENTWRITEERRORS_OFFSET UNITYSDK_OFFSET(0x191AEE00)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_HEXDIGIT_OFFSET UNITYSDK_OFFSET(0x191A45E0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_INITIALIZEPROVIDERMETADATA_OFFSET UNITYSDK_OFFSET(0x191A3AA0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x191A6BE0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ISENABLEDBYDEFAULT_OFFSET UNITYSDK_OFFSET(0x191AED70)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ISENABLEDCOMMON_OFFSET UNITYSDK_OFFSET(0x191A4750)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ISENABLED_1_OFFSET UNITYSDK_OFFSET(0x191A2420)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ISENABLED_2_OFFSET UNITYSDK_OFFSET(0x191A4710)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ISENABLED_OFFSET UNITYSDK_OFFSET(0x191A4700)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_LOGEVENTARGSMISMATCHES_OFFSET UNITYSDK_OFFSET(0x191AC890)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_ONEVENTCOMMAND_OFFSET UNITYSDK_OFFSET(0x191A70E0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_PARSECOMMANDARGS_OFFSET UNITYSDK_OFFSET(0x191AF680)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_REMOVEFIRSTARGIFRELATEDACTIVITYID_OFFSET UNITYSDK_OFFSET(0x191B57A0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_REPORTACTIVITYSAMPLINGINFO_OFFSET UNITYSDK_OFFSET(0x191B0070)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_REPORTOUTOFBANDMESSAGE_OFFSET UNITYSDK_OFFSET(0x19195870)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SENDCOMMAND_OFFSET UNITYSDK_OFFSET(0x191AEEF0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SENDMANIFEST_OFFSET UNITYSDK_OFFSET(0x191AA370)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SERIALIZEEVENTARGS_OFFSET UNITYSDK_OFFSET(0x191ACCA0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SETCURRENTTHREADACTIVITYID_OFFSET UNITYSDK_OFFSET(0x19197E50)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_THROWEVENTSOURCEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x191A8750)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x191A6900)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_TRIMEVENTDESCRIPTORS_OFFSET UNITYSDK_OFFSET(0x191B6920)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_UPDATEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x191A3970)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_UPDATEETWSESSION_OFFSET UNITYSDK_OFFSET(0x191AFA90)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_UPDATEKWDTRIGGERS_OFFSET UNITYSDK_OFFSET(0x191AFF10)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_VALIDATEEVENTOPCODEFORTRANSFER_OFFSET UNITYSDK_OFFSET(0x191A8320)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_VALIDATESETTINGS_OFFSET UNITYSDK_OFFSET(0x191A6B80)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITECLEANUP_OFFSET UNITYSDK_OFFSET(0x191A3280)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENTCORE_OFFSET UNITYSDK_OFFSET(0x191A7110)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENTRAW_OFFSET UNITYSDK_OFFSET(0x191A3200)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENTSTRING_OFFSET UNITYSDK_OFFSET(0x191AAA20)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENTVARARGS_OFFSET UNITYSDK_OFFSET(0x191A9770)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENTWITHRELATEDACTIVITYIDCORE_OFFSET UNITYSDK_OFFSET(0x191A7890)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_1_OFFSET UNITYSDK_OFFSET(0x191A7130)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_2_OFFSET UNITYSDK_OFFSET(0x191A7270)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_3_OFFSET UNITYSDK_OFFSET(0x191A73D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_4_OFFSET UNITYSDK_OFFSET(0x191A7520)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_5_OFFSET UNITYSDK_OFFSET(0x191A76C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_6_OFFSET UNITYSDK_OFFSET(0x191A9760)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEEVENT_OFFSET UNITYSDK_OFFSET(0x191A70F0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEMULTIMERGEINNER_OFFSET UNITYSDK_OFFSET(0x191A2460)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEMULTIMERGE_1_OFFSET UNITYSDK_OFFSET(0x191A3370)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITEMULTIMERGE_OFFSET UNITYSDK_OFFSET(0x191A2390)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITESTRINGTOALLLISTENERS_OFFSET UNITYSDK_OFFSET(0x191AEA10)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITESTRINGTOLISTENER_OFFSET UNITYSDK_OFFSET(0x191AA840)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITETOALLLISTENERS_1_OFFSET UNITYSDK_OFFSET(0x191ACB70)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_WRITETOALLLISTENERS_OFFSET UNITYSDK_OFFSET(0x191A93F0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x191B7250)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191A6A90)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191A6AA0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x191A6A80)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventSource_TypeDefinitionIndex = 1655;
	...
	public:
		...
		{
			return (::System::Action_1<::System::Guid>**)Il2CppClass::FromTypeDefinitionIndex(EventSource_TypeDefinitionIndex)->GetStaticField(0x53A0);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_namespaceBytes()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(EventSource_TypeDefinitionIndex)->GetStaticField(0x53A8);
		}
		static ::System::Guid* StaticGet_AspNetEventSourceGuid()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(EventSource_TypeDefinitionIndex)->GetStaticField(0x30E0);
		}
		static ::System::UInt32* StaticGet_s_currentPid()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(EventSource_TypeDefinitionIndex)->GetStaticField(0x30F0);
		}
		...
		::Il2CppArray<::System::Byte>* providerMetadata; // 0x10
		::System::Collections::Generic::List_1<::System::Diagnostics::Tracing::EtwSession*>* m_legacySessions; // 0x18
		::Il2CppArray<::System::Diagnostics::Tracing::EtwSession*>* m_etwSessionIdMap; // 0x20
		::System::Diagnostics::Tracing::EventCommandEventArgs* m_deferredCommands; // 0x28
		::Il2CppArray<::System::Byte>* m_rawManifest; // 0x30
		::System::Exception* m_constructionException; // 0x38
		::System::Diagnostics::Tracing::EventDispatcher* m_Dispatchers; // 0x40
		::Il2CppArray<::System::Diagnostics::Tracing::EventSource_EventMetadata>* m_eventData; // 0x48
		::Il2CppArray<::System::String*>* m_traits; // 0x50
		::System::EventHandler_1<::System::Diagnostics::Tracing::EventCommandEventArgs*>* m_eventCommandExecuted; // 0x58
		::System::String* m_name; // 0x60
		::System::Diagnostics::Tracing::EventSource_OverideEventProvider* m_provider; // 0x68
		::System::Diagnostics::Tracing::ActivityTracker* m_activityTracker; // 0x70
		::System::Int32 m_id; // 0x78
		::System::Diagnostics::Tracing::EventKeywords m_matchAnyKeyword; // 0x80
		::System::Int64 m_keywordTriggers; // 0x88
		::System::Diagnostics::Tracing::EventLevel m_level; // 0x90
		::System::Diagnostics::Tracing::SessionMask m_curLiveSessions; // 0x94
		::System::Guid m_guid; // 0x98
		::System::Byte m_outOfBandMessageCount; // 0xA8
		::System::Boolean m_eventSourceEnabled; // 0xA9
		::System::Boolean m_completelyInited; // 0xAA
		::System::Diagnostics::Tracing::EventSourceSettings m_config; // 0xAC
		::System::Diagnostics::Tracing::SessionMask m_activityFilteringForETWEnabled; // 0xB0
