...
#define SYSTEM_DIAGNOSTICS_TRACING_UINT64TYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x1BCF7AF0)
#define SYSTEM_DIAGNOSTICS_TRACING_UINT64TYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x1BCF7A70)
#define SYSTEM_DIAGNOSTICS_TRACING_UINT64TYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCF7B80)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int UInt64TypeInfo_TypeDefinitionIndex = 1622;
