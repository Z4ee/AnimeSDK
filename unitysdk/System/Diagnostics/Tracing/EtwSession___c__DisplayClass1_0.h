...
#define SYSTEM_DIAGNOSTICS_TRACING_ETWSESSION___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x162BA260)
#define SYSTEM_DIAGNOSTICS_TRACING_ETWSESSION___C__DISPLAYCLASS1_0__REMOVEETWSESSION_B__0_OFFSET UNITYSDK_OFFSET(0x162BA380)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EtwSession___c__DisplayClass1_0_TypeDefinitionIndex = 1691;
