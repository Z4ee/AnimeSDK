...
#define SYSTEM_DIAGNOSTICS_TRACING_INT16TYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x186B9690)
#define SYSTEM_DIAGNOSTICS_TRACING_INT16TYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x186B9600)
#define SYSTEM_DIAGNOSTICS_TRACING_INT16TYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x186B97A0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int Int16TypeInfo_TypeDefinitionIndex = 1606;
