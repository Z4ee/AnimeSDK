...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BCE2360)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BCEB820)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BCE0900)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCEB6E0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventSourceException_TypeDefinitionIndex = 1711;
