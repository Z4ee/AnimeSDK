...
#define SYSTEM_DIAGNOSTICS_TRACING_DOUBLETYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x162B9B50)
#define SYSTEM_DIAGNOSTICS_TRACING_DOUBLETYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x162B9AD0)
#define SYSTEM_DIAGNOSTICS_TRACING_DOUBLETYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x162B9BE0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int DoubleTypeInfo_TypeDefinitionIndex = 1615;
