...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTPAYLOAD__GETENUMERATOR_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AB5C640)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTPAYLOAD__GETENUMERATOR_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_OBJECT___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB5C880)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTPAYLOAD__GETENUMERATOR_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB5C8E0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTPAYLOAD__GETENUMERATOR_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AB5C890)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTPAYLOAD__GETENUMERATOR_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AB5C630)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTPAYLOAD__GETENUMERATOR_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5C310)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventPayload__GetEnumerator_d__17_TypeDefinitionIndex = 1603;
