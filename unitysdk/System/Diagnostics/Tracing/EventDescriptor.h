...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B6A8F0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B6A830)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B6A8C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_CHANNEL_OFFSET UNITYSDK_OFFSET(0x14E8B0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x2DE6A30)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x6020)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x7EF00)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_OPCODE_OFFSET UNITYSDK_OFFSET(0x148F30)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x3B6A820)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x14E890)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B6A810)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x3B6A7F0)
