...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEOPTIONS_SET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x20D5B60)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEOPTIONS_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x20D5AA0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEOPTIONS_SET_OPCODE_OFFSET UNITYSDK_OFFSET(0x20D5B00)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventSourceOptions_TypeDefinitionIndex = 1594;
