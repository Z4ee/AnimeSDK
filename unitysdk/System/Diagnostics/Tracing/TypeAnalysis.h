...
#define SYSTEM_DIAGNOSTICS_TRACING_TYPEANALYSIS__CTOR_OFFSET UNITYSDK_OFFSET(0x191C2DA0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int TypeAnalysis_TypeDefinitionIndex = 1666;
