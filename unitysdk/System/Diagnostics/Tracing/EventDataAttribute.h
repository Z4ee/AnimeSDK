...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x1869F490)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1869F470)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1869F460)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_OPCODE_OFFSET UNITYSDK_OFFSET(0x1869F480)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1869F4A0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventDataAttribute_TypeDefinitionIndex = 1586;
	...
	public:
		...
		::System::Diagnostics::Tracing::EventTags _Tags_k__BackingField; // 0x24
