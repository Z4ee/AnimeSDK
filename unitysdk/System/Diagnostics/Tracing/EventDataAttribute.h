...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x162BA660)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x162BA640)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x162BA630)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_OPCODE_OFFSET UNITYSDK_OFFSET(0x162BA650)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDATAATTRIBUTE_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x162BA670)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventDataAttribute_TypeDefinitionIndex = 1587;
	...
	public:
		...
		::System::Diagnostics::Tracing::EventLevel level; // 0x1C
