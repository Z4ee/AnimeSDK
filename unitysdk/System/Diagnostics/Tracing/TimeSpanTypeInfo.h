...
#define SYSTEM_DIAGNOSTICS_TRACING_TIMESPANTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x162DD530)
#define SYSTEM_DIAGNOSTICS_TRACING_TIMESPANTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x162DD4E0)
#define SYSTEM_DIAGNOSTICS_TRACING_TIMESPANTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x162DD5C0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int TimeSpanTypeInfo_TypeDefinitionIndex = 1645;
