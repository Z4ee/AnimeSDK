...
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ACTIVITYCHANGING_OFFSET UNITYSDK_OFFSET(0x19197D50)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ENABLE_OFFSET UNITYSDK_OFFSET(0x19197550)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_FINDACTIVEACTIVITY_OFFSET UNITYSDK_OFFSET(0x19197790)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19197D20)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_NORMALIZEACTIVITYNAME_OFFSET UNITYSDK_OFFSET(0x191975F0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ONSTART_OFFSET UNITYSDK_OFFSET(0x19196FB0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ONSTOP_OFFSET UNITYSDK_OFFSET(0x19197810)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19198150)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19198140)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int ActivityTracker_TypeDefinitionIndex = 1667;
	...
	public:
		...
		{
			return (::System::Diagnostics::Tracing::ActivityTracker**)Il2CppClass::FromTypeDefinitionIndex(ActivityTracker_TypeDefinitionIndex)->GetStaticField(0x53D0);
		}
		static ::System::Int64* StaticGet_m_nextId()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(ActivityTracker_TypeDefinitionIndex)->GetStaticField(0x3100);
		}
