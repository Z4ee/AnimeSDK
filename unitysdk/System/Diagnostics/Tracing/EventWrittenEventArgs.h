...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x186B8820)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS_SET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x186B8810)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS_SET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x186B8860)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS_SET_PAYLOADNAMES_OFFSET UNITYSDK_OFFSET(0x186B8850)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS_SET_PAYLOAD_OFFSET UNITYSDK_OFFSET(0x186B8840)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS_SET_RELATEDACTIVITYID_OFFSET UNITYSDK_OFFSET(0x186B8830)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTWRITTENEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x186AD3A0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventWrittenEventArgs_TypeDefinitionIndex = 1680;
