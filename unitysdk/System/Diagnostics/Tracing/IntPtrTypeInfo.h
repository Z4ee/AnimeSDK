...
#define SYSTEM_DIAGNOSTICS_TRACING_INTPTRTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x162D7140)
#define SYSTEM_DIAGNOSTICS_TRACING_INTPTRTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x162D70A0)
#define SYSTEM_DIAGNOSTICS_TRACING_INTPTRTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x162D7250)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int IntPtrTypeInfo_TypeDefinitionIndex = 1613;
