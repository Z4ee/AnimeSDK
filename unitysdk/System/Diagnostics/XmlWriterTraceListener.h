...
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7E2290)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A7E22D0)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A7E2310)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A7E2350)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A7E2390)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E2250)

namespace System::Diagnostics
{
	inline static constexpr unsigned int XmlWriterTraceListener_TypeDefinitionIndex = 4190;
