...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1D456EE0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1D456F20)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D456EA0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EventLogPermissionEntry_TypeDefinitionIndex = 4171;
