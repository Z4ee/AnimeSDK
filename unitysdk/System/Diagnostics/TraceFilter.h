...
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_1_OFFSET UNITYSDK_OFFSET(0x1D3FAB00)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_2_OFFSET UNITYSDK_OFFSET(0x1D3FAB40)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x1D3FAAC0)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FAB90)
