...
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_1_OFFSET UNITYSDK_OFFSET(0x19AE6EC0)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_2_OFFSET UNITYSDK_OFFSET(0x19AE6F00)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x19AE6E80)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE6F50)

namespace System::Diagnostics
{
	inline static constexpr unsigned int TraceFilter_TypeDefinitionIndex = 2768;
