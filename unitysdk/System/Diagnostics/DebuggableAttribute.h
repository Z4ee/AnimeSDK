...
#define SYSTEM_DIAGNOSTICS_DEBUGGABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A559860)

namespace System::Diagnostics
{
	inline static constexpr unsigned int DebuggableAttribute_TypeDefinitionIndex = 1576;
