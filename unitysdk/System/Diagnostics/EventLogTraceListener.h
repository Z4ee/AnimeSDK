...
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_GET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x1D457020)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_SET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x1D457060)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1D4570E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1D4570A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D456FA0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D456FE0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D456F60)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EventLogTraceListener_TypeDefinitionIndex = 4174;
