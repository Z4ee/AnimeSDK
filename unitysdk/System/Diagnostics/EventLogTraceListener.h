...
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_GET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x1E7E1B50)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_SET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x1E7E1B90)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1E7E1C10)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1E7E1BD0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7E1AD0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E7E1B10)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E1A90)
