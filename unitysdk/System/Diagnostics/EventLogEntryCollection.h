...
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1D46CD70)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D46CDB0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D46CC70)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D46CCB0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1D46CDF0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1D46CCF0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1D46CD30)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D46CC30)
