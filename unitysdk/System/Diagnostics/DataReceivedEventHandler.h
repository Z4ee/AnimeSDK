...
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B401BA0)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B401BE0)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B401620)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B401600)

namespace System::Diagnostics
{
	inline static constexpr unsigned int DataReceivedEventHandler_TypeDefinitionIndex = 2792;
