...
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC07290)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_CATEGORYNUMBER_OFFSET UNITYSDK_OFFSET(0x1CC06F50)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1CC06F10)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1CC06F90)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_ENTRYTYPE_OFFSET UNITYSDK_OFFSET(0x1CC06FD0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x1CC07010)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1CC07050)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x1CC07090)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1CC070D0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1CC07110)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_REPLACEMENTSTRINGS_OFFSET UNITYSDK_OFFSET(0x1CC07150)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1CC07190)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_TIMEGENERATED_OFFSET UNITYSDK_OFFSET(0x1CC071D0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_TIMEWRITTEN_OFFSET UNITYSDK_OFFSET(0x1CC07210)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1CC07250)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1CC072D0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC06ED0)
