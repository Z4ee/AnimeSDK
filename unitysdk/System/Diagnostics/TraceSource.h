...
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1DEB9650)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_CREATESWITCH_OFFSET UNITYSDK_OFFSET(0x1DEBCBF0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1DEB99E0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DEBA250)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DEBCD10)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x1DEBCEB0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DEBAC40)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_SWITCH_OFFSET UNITYSDK_OFFSET(0x1DEBCF70)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1DEB93B0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_NOCONFIGINIT_OFFSET UNITYSDK_OFFSET(0x1DEB9460)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x1DEBA260)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1DEBA540)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_SET_SWITCH_OFFSET UNITYSDK_OFFSET(0x1DEBD030)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x1DEBBF30)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x1DEBB8F0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1DEBAC50)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_2_OFFSET UNITYSDK_OFFSET(0x1DEBB290)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x1DEBA600)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEINFORMATION_1_OFFSET UNITYSDK_OFFSET(0x1DEBC580)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEINFORMATION_OFFSET UNITYSDK_OFFSET(0x1DEBC570)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACETRANSFER_OFFSET UNITYSDK_OFFSET(0x1DEBC590)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEBD150)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEB8C20)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB8C10)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__PRUNECACHEDTRACESOURCES_OFFSET UNITYSDK_OFFSET(0x1DEB8E10)
