...
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D8870D0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D8870C0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D887010)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FAIL_1_OFFSET UNITYSDK_OFFSET(0x1D8873A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FAIL_OFFSET UNITYSDK_OFFSET(0x1D887380)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1D8870E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D8874B0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D886EB0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x1D8871C0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x1D8870F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x1D887120)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_ISTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1D887000)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D886FA0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_NEEDINDENT_OFFSET UNITYSDK_OFFSET(0x1D8871E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_TRACEOUTPUTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1D887200)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1D8888D0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D887280)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x1D8871D0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x1D887100)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x1D887130)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1D886FF0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_NEEDINDENT_OFFSET UNITYSDK_OFFSET(0x1D8871F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_TRACEOUTPUTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1D887210)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x1D888370)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x1D887A80)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1D8885F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_2_OFFSET UNITYSDK_OFFSET(0x1D8886A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x1D8885B0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACETRANSFER_OFFSET UNITYSDK_OFFSET(0x1D8887F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEFOOTER_OFFSET UNITYSDK_OFFSET(0x1D887C70)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1D887B60)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEINDENT_OFFSET UNITYSDK_OFFSET(0x1D887750)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x1D8878D0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x1D8879A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1D887800)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1D887580)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1D887650)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1D8874C0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D886EA0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D886E90)

namespace System::Diagnostics
{
	inline static constexpr unsigned int TraceListener_TypeDefinitionIndex = 2770;
	...
	public:
		...
		::System::Diagnostics::TraceOptions traceOptions; // 0x38
		::System::Int32 indentSize; // 0x3C
