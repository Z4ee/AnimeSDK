...
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C48F760)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C48F750)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C48F6A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FAIL_1_OFFSET UNITYSDK_OFFSET(0x1C48FA30)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FAIL_OFFSET UNITYSDK_OFFSET(0x1C48FA10)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C48F770)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C48FB40)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C48F540)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x1C48F850)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x1C48F780)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x1C48F7B0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_ISTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1C48F690)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C48F630)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_NEEDINDENT_OFFSET UNITYSDK_OFFSET(0x1C48F870)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_TRACEOUTPUTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1C48F890)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1C490F40)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C48F910)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x1C48F860)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x1C48F790)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x1C48F7C0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C48F680)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_NEEDINDENT_OFFSET UNITYSDK_OFFSET(0x1C48F880)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_TRACEOUTPUTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1C48F8A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x1C4909F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x1C490110)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1C490C60)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_2_OFFSET UNITYSDK_OFFSET(0x1C490D10)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x1C490C20)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACETRANSFER_OFFSET UNITYSDK_OFFSET(0x1C490E60)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEFOOTER_OFFSET UNITYSDK_OFFSET(0x1C4902F0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1C4901E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEINDENT_OFFSET UNITYSDK_OFFSET(0x1C48FDE0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x1C48FF60)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x1C490030)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1C48FE90)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1C48FC10)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1C48FCE0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1C48FB50)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C48F530)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48F520)
