...
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1921C520)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1921C5F0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_ENSUREWRITER_OFFSET UNITYSDK_OFFSET(0x1921C300)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1921C7A0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GETENCODINGWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0x1921CB90)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GET_WRITER_OFFSET UNITYSDK_OFFSET(0x1921C2E0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_SET_WRITER_OFFSET UNITYSDK_OFFSET(0x1921C510)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1921CA00)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1921C870)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1921C0A0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1921C0B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1921C1A0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1921C230)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1921C2B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1921C2C0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1921C090)

namespace System::Diagnostics
{
	inline static constexpr unsigned int TextWriterTraceListener_TypeDefinitionIndex = 2764;
