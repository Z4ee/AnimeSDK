...
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C87E200)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C87E2D0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_ENSUREWRITER_OFFSET UNITYSDK_OFFSET(0x1C87DFE0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C87E480)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GETENCODINGWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0x1C87E870)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GET_WRITER_OFFSET UNITYSDK_OFFSET(0x1C87DFC0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_SET_WRITER_OFFSET UNITYSDK_OFFSET(0x1C87E1F0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1C87E6E0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1C87E550)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C87DD80)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C87DD90)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C87DE80)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C87DF10)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C87DF90)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1C87DFA0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C87DD70)
