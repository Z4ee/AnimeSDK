...
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C013340)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1C013520)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C0133C0)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x1C0134E0)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C013120)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C013040)
