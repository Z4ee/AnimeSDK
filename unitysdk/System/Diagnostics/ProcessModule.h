...
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_BASEADDRESS_OFFSET UNITYSDK_OFFSET(0x1BEC1690)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_ENTRYPOINTADDRESS_OFFSET UNITYSDK_OFFSET(0x1BEC16A0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1BEC16B0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_FILEVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x1BEC16C0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_MODULEMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1BEC16D0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1BEC16E0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BEC16F0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BEC1700)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC1600)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::String* modulename; // 0x30
		::System::Diagnostics::FileVersionInfo* version_info; // 0x38
		::System::Int32 memory_size; // 0x40
		::System::IntPtr baseaddr; // 0x48
