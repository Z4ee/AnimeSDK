...
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETFILELINENUMBER_OFFSET UNITYSDK_OFFSET(0x19192DB0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETFILENAME_OFFSET UNITYSDK_OFFSET(0x19192DC0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETILOFFSET_OFFSET UNITYSDK_OFFSET(0x19192ED0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETINTERNALMETHODNAME_OFFSET UNITYSDK_OFFSET(0x19192F20)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHODADDRESS_OFFSET UNITYSDK_OFFSET(0x19192F00)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHODINDEX_OFFSET UNITYSDK_OFFSET(0x19192F10)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x19192EE0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETNATIVEOFFSET_OFFSET UNITYSDK_OFFSET(0x19192EF0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETSECUREFILENAME_OFFSET UNITYSDK_OFFSET(0x19192DD0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GET_FRAME_INFO_OFFSET UNITYSDK_OFFSET(0x19192B10)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19192F30)
#define SYSTEM_DIAGNOSTICS_STACKFRAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19192CE0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19192C00)

namespace System::Diagnostics
{
	inline static constexpr unsigned int StackFrame_TypeDefinitionIndex = 1576;
