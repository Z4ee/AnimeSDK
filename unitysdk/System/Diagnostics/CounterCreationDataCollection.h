...
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_ADDRANGE_1_OFFSET UNITYSDK_OFFSET(0x19E29C50)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x19E29C10)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19E29BD0)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19E29C90)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19E29CD0)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19E29B50)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x19E29D10)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x19E29D50)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x19E29D90)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19E29B90)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E29AD0)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19E29B10)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E29A90)

namespace System::Diagnostics
{
	inline static constexpr unsigned int CounterCreationDataCollection_TypeDefinitionIndex = 4064;
