...
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_GET_CATEGORYID_OFFSET UNITYSDK_OFFSET(0x1C012CA0)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_GET_ENTRYTYPE_OFFSET UNITYSDK_OFFSET(0x1C012D20)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x1C012DA0)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_SET_CATEGORYID_OFFSET UNITYSDK_OFFSET(0x1C012CE0)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_SET_ENTRYTYPE_OFFSET UNITYSDK_OFFSET(0x1C012D60)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x1C012DE0)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C012C60)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C012C20)
