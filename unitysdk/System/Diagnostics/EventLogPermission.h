...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x1CEC8710)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CEC8650)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CEC8690)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CEC86D0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEC8610)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EventLogPermission_TypeDefinitionIndex = 4169;
