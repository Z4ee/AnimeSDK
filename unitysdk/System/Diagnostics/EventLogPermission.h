...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x1E285390)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E2852D0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E285310)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E285350)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E285290)
