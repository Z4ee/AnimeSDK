...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1A5709D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x1A570850)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1A5708D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A570950)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x1A570890)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1A570910)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A570990)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A570840)

namespace System::Diagnostics
{
	inline static constexpr unsigned int PerformanceCounterPermissionAttribute_TypeDefinitionIndex = 4188;
