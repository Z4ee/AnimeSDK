...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1DD16270)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x1DD160F0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1DD16170)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1DD161F0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x1DD16130)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1DD161B0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1DD16230)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD160E0)
