...
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_CONVERTTOBASETYPEORENUM_OFFSET UNITYSDK_OFFSET(0x1D8888F0)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_GETRUNTIMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D8888E0)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_VERIFYATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D887370)

namespace System::Diagnostics
{
	inline static constexpr unsigned int TraceUtils_TypeDefinitionIndex = 2775;
