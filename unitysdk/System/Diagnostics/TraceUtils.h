...
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_CONVERTTOBASETYPEORENUM_OFFSET UNITYSDK_OFFSET(0x1C490F60)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_GETRUNTIMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1C490F50)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_VERIFYATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C48FA00)
