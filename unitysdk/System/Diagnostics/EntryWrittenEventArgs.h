...
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1E974180)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E974140)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E974100)

namespace System::Diagnostics
{
	inline static constexpr unsigned int EntryWrittenEventArgs_TypeDefinitionIndex = 4095;
