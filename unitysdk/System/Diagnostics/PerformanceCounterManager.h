...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER_SYSTEM_DIAGNOSTICS_ICOLLECTDATA_CLOSEDATA_OFFSET UNITYSDK_OFFSET(0x1B7531F0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER_SYSTEM_DIAGNOSTICS_ICOLLECTDATA_COLLECTDATA_OFFSET UNITYSDK_OFFSET(0x1B753230)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7531B0)
