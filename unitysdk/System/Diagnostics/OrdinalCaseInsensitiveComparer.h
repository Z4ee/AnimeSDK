...
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1C012E20)
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C012F00)
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C012EF0)
