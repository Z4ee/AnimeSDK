...
#define SYSTEM_DIAGNOSTICS_DEBUGGER_BREAK_OFFSET UNITYSDK_OFFSET(0x1C1A47E0)
#define SYSTEM_DIAGNOSTICS_DEBUGGER_GET_ISATTACHED_OFFSET UNITYSDK_OFFSET(0x1C1A4760)
#define SYSTEM_DIAGNOSTICS_DEBUGGER_ISATTACHED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C1A47C0)
#define SYSTEM_DIAGNOSTICS_DEBUGGER_ISLOGGING_OFFSET UNITYSDK_OFFSET(0x1C1A47F0)
#define SYSTEM_DIAGNOSTICS_DEBUGGER_LOG_OFFSET UNITYSDK_OFFSET(0x1C1A4800)
#define SYSTEM_DIAGNOSTICS_DEBUGGER_NOTIFYOFCROSSTHREADDEPENDENCY_OFFSET UNITYSDK_OFFSET(0x1C1A4810)
#define SYSTEM_DIAGNOSTICS_DEBUGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1A4830)
#define SYSTEM_DIAGNOSTICS_DEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A4820)
