...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_BASEPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A2415A0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_CURRENTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A2415B0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A2415C0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x1A2415E0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1A241600)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1A241620)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTADDRESS_OFFSET UNITYSDK_OFFSET(0x1A241640)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A241650)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_THREADSTATE_OFFSET UNITYSDK_OFFSET(0x1A241680)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1A241690)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1A2416A0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_WAITREASON_OFFSET UNITYSDK_OFFSET(0x1A2416B0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_RESETIDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A2416C0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_IDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A2415D0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x1A2415F0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1A241610)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PROCESSORAFFINITY_OFFSET UNITYSDK_OFFSET(0x1A241630)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A241550)

namespace System::Diagnostics
{
	inline static constexpr unsigned int ProcessThread_TypeDefinitionIndex = 2799;
