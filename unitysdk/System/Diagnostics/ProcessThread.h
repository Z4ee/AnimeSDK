...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_BASEPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C64F2D0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_CURRENTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C64F2E0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C64F2F0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x1C64F310)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1C64F330)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1C64F350)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTADDRESS_OFFSET UNITYSDK_OFFSET(0x1C64F370)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1C64F380)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_THREADSTATE_OFFSET UNITYSDK_OFFSET(0x1C64F3B0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1C64F3C0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x1C64F3D0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_WAITREASON_OFFSET UNITYSDK_OFFSET(0x1C64F3E0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_RESETIDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1C64F3F0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_IDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1C64F300)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x1C64F320)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1C64F340)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PROCESSORAFFINITY_OFFSET UNITYSDK_OFFSET(0x1C64F360)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C64F280)
