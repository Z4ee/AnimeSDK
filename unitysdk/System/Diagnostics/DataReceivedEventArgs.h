...
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTARGS_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C64EDE0)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C64EDF0)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C64ED80)
