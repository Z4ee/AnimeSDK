...
#define SYSTEM_IOSELECTORJOB_MARKDISPOSED_OFFSET UNITYSDK_OFFSET(0x1A0EA040)
#define SYSTEM_IOSELECTORJOB_SYSTEM_THREADING_ITHREADPOOLWORKITEM_EXECUTEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A0EA000)
#define SYSTEM_IOSELECTORJOB_SYSTEM_THREADING_ITHREADPOOLWORKITEM_MARKABORTED_OFFSET UNITYSDK_OFFSET(0x1A0EA030)
#define SYSTEM_IOSELECTORJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E9FF0)
