...
#define SYSTEM_DIVIDEBYZEROEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A976C60)
#define SYSTEM_DIVIDEBYZEROEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A976CF0)
#define SYSTEM_DIVIDEBYZEROEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A976BA0)
