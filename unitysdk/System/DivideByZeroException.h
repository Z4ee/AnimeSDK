...
#define SYSTEM_DIVIDEBYZEROEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E119090)
#define SYSTEM_DIVIDEBYZEROEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E119120)
#define SYSTEM_DIVIDEBYZEROEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E118FD0)
