...
#define SYSTEM_INVALIDTIMEZONEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195FF610)
#define SYSTEM_INVALIDTIMEZONEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195FF6A0)
#define SYSTEM_INVALIDTIMEZONEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195FF6F0)
#define SYSTEM_INVALIDTIMEZONEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x195FF590)
