...
#define SYSTEM_EVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD86C40)
#define SYSTEM_EVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD86C80)
#define SYSTEM_EVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD866C0)
#define SYSTEM_EVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD866A0)
