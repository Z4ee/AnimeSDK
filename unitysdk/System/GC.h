...
#define SYSTEM_GC_ADDMEMORYPRESSURE_OFFSET UNITYSDK_OFFSET(0x1DF30200)
#define SYSTEM_GC_COLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1DF30730)
#define SYSTEM_GC_COLLECT_1_OFFSET UNITYSDK_OFFSET(0x1DF304E0)
#define SYSTEM_GC_COLLECT_2_OFFSET UNITYSDK_OFFSET(0x1DF30430)
#define SYSTEM_GC_COLLECT_3_OFFSET UNITYSDK_OFFSET(0x1DF305F0)
#define SYSTEM_GC_COLLECT_4_OFFSET UNITYSDK_OFFSET(0x1DF30650)
#define SYSTEM_GC_COLLECT_OFFSET UNITYSDK_OFFSET(0x1DF30320)
#define SYSTEM_GC_GETCOLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1DF30180)
#define SYSTEM_GC_GETMAXGENERATION_OFFSET UNITYSDK_OFFSET(0x1DF30190)
#define SYSTEM_GC_GETTOTALMEMORY_OFFSET UNITYSDK_OFFSET(0x1DF30930)
#define SYSTEM_GC_GET_EPHEMERON_TOMBSTONE_OFFSET UNITYSDK_OFFSET(0x1DF301F0)
#define SYSTEM_GC_GET_MAXGENERATION_OFFSET UNITYSDK_OFFSET(0x1DF30590)
#define SYSTEM_GC_INTERNALCOLLECT_OFFSET UNITYSDK_OFFSET(0x1DF301A0)
#define SYSTEM_GC_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1DF307C0)
#define SYSTEM_GC_RECORDPRESSURE_OFFSET UNITYSDK_OFFSET(0x1DF301D0)
#define SYSTEM_GC_REGISTER_EPHEMERON_ARRAY_OFFSET UNITYSDK_OFFSET(0x1DF301E0)
#define SYSTEM_GC_REMOVEMEMORYPRESSURE_OFFSET UNITYSDK_OFFSET(0x1DF30290)
#define SYSTEM_GC_REREGISTERFORFINALIZE_OFFSET UNITYSDK_OFFSET(0x1DF308B0)
#define SYSTEM_GC_SUPPRESSFINALIZE_OFFSET UNITYSDK_OFFSET(0x1DF30800)
#define SYSTEM_GC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF30970)
#define SYSTEM_GC__REREGISTERFORFINALIZE_OFFSET UNITYSDK_OFFSET(0x1DF30880)
#define SYSTEM_GC__SUPPRESSFINALIZE_OFFSET UNITYSDK_OFFSET(0x1DF307D0)
