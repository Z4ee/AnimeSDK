...
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C43B670)
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C440D70)
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C440DE0)
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C440CD0)

namespace System::Reflection
{
	inline static constexpr unsigned int TargetInvocationException_TypeDefinitionIndex = 588;
