...
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_GETNAME_OFFSET UNITYSDK_OFFSET(0x1875D530)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1875D2B0)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_LOADWITHPARTIALNAMEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1875D410)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_LOADWITHPARTIALNAMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1875D340)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1875D540)
