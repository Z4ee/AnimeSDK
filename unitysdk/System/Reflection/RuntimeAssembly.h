...
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_GETNAME_OFFSET UNITYSDK_OFFSET(0x1BDA3AB0)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1BDA3850)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_LOADWITHPARTIALNAMEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1BDA39B0)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_LOADWITHPARTIALNAMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BDA38E0)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA3AC0)

namespace System::Reflection
{
	inline static constexpr unsigned int RuntimeAssembly_TypeDefinitionIndex = 612;
