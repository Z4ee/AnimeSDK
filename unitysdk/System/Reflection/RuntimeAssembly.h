...
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_GETNAME_OFFSET UNITYSDK_OFFSET(0x1C43E910)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C43E6B0)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_LOADWITHPARTIALNAMEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1C43E810)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY_LOADWITHPARTIALNAMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C43E740)
#define SYSTEM_REFLECTION_RUNTIMEASSEMBLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43E920)
