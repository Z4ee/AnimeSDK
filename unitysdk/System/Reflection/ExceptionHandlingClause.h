...
#define SYSTEM_REFLECTION_EXCEPTIONHANDLINGCLAUSE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193DA620)
#define SYSTEM_REFLECTION_EXCEPTIONHANDLINGCLAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x193DA610)

namespace System::Reflection
{
	inline static constexpr unsigned int ExceptionHandlingClause_TypeDefinitionIndex = 578;
