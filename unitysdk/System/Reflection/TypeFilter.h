...
#define SYSTEM_REFLECTION_TYPEFILTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16381380)
#define SYSTEM_REFLECTION_TYPEFILTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x163813C0)
#define SYSTEM_REFLECTION_TYPEFILTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x16380DC0)
#define SYSTEM_REFLECTION_TYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16380DA0)

namespace System::Reflection
{
	inline static constexpr unsigned int TypeFilter_TypeDefinitionIndex = 589;
