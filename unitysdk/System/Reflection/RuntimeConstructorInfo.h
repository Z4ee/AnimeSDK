...
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1BDA3CB0)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_GETRUNTIMEMODULE_OFFSET UNITYSDK_OFFSET(0x1BDA3B10)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_GET_BINDINGFLAGS_OFFSET UNITYSDK_OFFSET(0x1BDA3BE0)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1BDA3B00)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_GET_REFLECTEDTYPEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BDA3BF0)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_SERIALIZATIONINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDA3E70)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO_SERIALIZATIONTOSTRING_OFFSET UNITYSDK_OFFSET(0x1BDA3E60)
#define SYSTEM_REFLECTION_RUNTIMECONSTRUCTORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA4020)
