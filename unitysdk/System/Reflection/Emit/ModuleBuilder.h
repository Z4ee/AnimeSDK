...
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER_DEFINETYPE_1_OFFSET UNITYSDK_OFFSET(0x19E11A80)
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER_DEFINETYPE_2_OFFSET UNITYSDK_OFFSET(0x19E11AD0)
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER_DEFINETYPE_OFFSET UNITYSDK_OFFSET(0x19E11A30)
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E11B20)
