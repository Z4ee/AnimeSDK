...
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER_DEFINETYPE_1_OFFSET UNITYSDK_OFFSET(0x1D8100F0)
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER_DEFINETYPE_2_OFFSET UNITYSDK_OFFSET(0x1D810140)
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER_DEFINETYPE_OFFSET UNITYSDK_OFFSET(0x1D8100A0)
#define SYSTEM_REFLECTION_EMIT_MODULEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D810190)
