...
#define SYSTEM_REFLECTION_EMIT_OPCODES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE4B110)
#define SYSTEM_REFLECTION_EMIT_OPCODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4B100)
