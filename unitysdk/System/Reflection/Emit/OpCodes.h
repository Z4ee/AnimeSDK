...
#define SYSTEM_REFLECTION_EMIT_OPCODES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C31E910)
#define SYSTEM_REFLECTION_EMIT_OPCODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C31E900)
