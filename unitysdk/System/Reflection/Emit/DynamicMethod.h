...
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GETILGENERATOR_OFFSET UNITYSDK_OFFSET(0x1E7B81F0)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E7B8240)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E7B8010)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GET_CALLINGCONVENTION_OFFSET UNITYSDK_OFFSET(0x1E7B8060)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1E7B80B0)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E7B8100)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GET_RETURNPARAMETER_OFFSET UNITYSDK_OFFSET(0x1E7B8150)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1E7B81A0)
#define SYSTEM_REFLECTION_EMIT_DYNAMICMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B7FC0)
