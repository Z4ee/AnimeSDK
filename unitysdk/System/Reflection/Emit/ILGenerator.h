...
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_DECLARELOCAL_OFFSET UNITYSDK_OFFSET(0x1AFCADB0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_DEFINELABEL_OFFSET UNITYSDK_OFFSET(0x1AFCAE00)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_10_OFFSET UNITYSDK_OFFSET(0x1AFCB170)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_11_OFFSET UNITYSDK_OFFSET(0x1AFCB1C0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_12_OFFSET UNITYSDK_OFFSET(0x1AFCB210)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_13_OFFSET UNITYSDK_OFFSET(0x1AFCB260)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_1_OFFSET UNITYSDK_OFFSET(0x1AFCAEA0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_2_OFFSET UNITYSDK_OFFSET(0x1AFCAEF0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_3_OFFSET UNITYSDK_OFFSET(0x1AFCAF40)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_4_OFFSET UNITYSDK_OFFSET(0x1AFCAF90)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_5_OFFSET UNITYSDK_OFFSET(0x1AFCAFE0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_6_OFFSET UNITYSDK_OFFSET(0x1AFCB030)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_7_OFFSET UNITYSDK_OFFSET(0x1AFCB080)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_8_OFFSET UNITYSDK_OFFSET(0x1AFCB0D0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_9_OFFSET UNITYSDK_OFFSET(0x1AFCB120)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_OFFSET UNITYSDK_OFFSET(0x1AFCAE50)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_MARKLABEL_OFFSET UNITYSDK_OFFSET(0x1AFCB2B0)
