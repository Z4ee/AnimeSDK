...
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_DECLARELOCAL_OFFSET UNITYSDK_OFFSET(0x1BD920A0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_DEFINELABEL_OFFSET UNITYSDK_OFFSET(0x1BD920F0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_10_OFFSET UNITYSDK_OFFSET(0x1BD92460)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_11_OFFSET UNITYSDK_OFFSET(0x1BD924B0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_12_OFFSET UNITYSDK_OFFSET(0x1BD92500)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_13_OFFSET UNITYSDK_OFFSET(0x1BD92550)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_1_OFFSET UNITYSDK_OFFSET(0x1BD92190)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_2_OFFSET UNITYSDK_OFFSET(0x1BD921E0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_3_OFFSET UNITYSDK_OFFSET(0x1BD92230)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_4_OFFSET UNITYSDK_OFFSET(0x1BD92280)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_5_OFFSET UNITYSDK_OFFSET(0x1BD922D0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_6_OFFSET UNITYSDK_OFFSET(0x1BD92320)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_7_OFFSET UNITYSDK_OFFSET(0x1BD92370)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_8_OFFSET UNITYSDK_OFFSET(0x1BD923C0)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_9_OFFSET UNITYSDK_OFFSET(0x1BD92410)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_EMIT_OFFSET UNITYSDK_OFFSET(0x1BD92140)
#define SYSTEM_REFLECTION_EMIT_ILGENERATOR_MARKLABEL_OFFSET UNITYSDK_OFFSET(0x1BD925A0)
