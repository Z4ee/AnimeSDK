...
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER_DEFINEDYNAMICASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1D0B2F20)
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER_DEFINEDYNAMICMODULE_OFFSET UNITYSDK_OFFSET(0x1D0B2F70)
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B2FC0)
