...
#define SYSTEM_REFLECTION_EMIT_TYPEBUILDERINSTANTIATION_MAKEGENERICTYPE_OFFSET UNITYSDK_OFFSET(0x1A7C1930)
#define SYSTEM_REFLECTION_EMIT_TYPEBUILDERINSTANTIATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C1980)
