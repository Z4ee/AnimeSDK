...
#define SYSTEM_REFLECTION_EMIT_LOCALBUILDER_GET_LOCALINDEX_OFFSET UNITYSDK_OFFSET(0x1BE24DD0)
#define SYSTEM_REFLECTION_EMIT_LOCALBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE24DE0)
