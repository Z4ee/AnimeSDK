...
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A80F140)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_METHODINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A80F350)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_METHODINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A80F2E0)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A80F3D0)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A80F340)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A80F2F0)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A80F130)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80EEE0)
