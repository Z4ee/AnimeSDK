...
#define SYSTEM_REFLECTION_POINTER_BOX_OFFSET UNITYSDK_OFFSET(0x1637E120)
#define SYSTEM_REFLECTION_POINTER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1637E280)
#define SYSTEM_REFLECTION_POINTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1637DFC0)
#define SYSTEM_REFLECTION_POINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1637DFB0)

namespace System::Reflection
{
	inline static constexpr unsigned int Pointer_TypeDefinitionIndex = 582;
