...
#define SYSTEM_REFLECTION_POINTER_BOX_OFFSET UNITYSDK_OFFSET(0x179AAE00)
#define SYSTEM_REFLECTION_POINTER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x179AAF60)
#define SYSTEM_REFLECTION_POINTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x179AACA0)
#define SYSTEM_REFLECTION_POINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x179AAC90)
