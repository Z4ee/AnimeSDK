...
#define SYSTEM_REFLECTION_POINTER_BOX_OFFSET UNITYSDK_OFFSET(0x199720D0)
#define SYSTEM_REFLECTION_POINTER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19972260)
#define SYSTEM_REFLECTION_POINTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19971F40)
#define SYSTEM_REFLECTION_POINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19971F30)
