...
#define SYSTEM_REFLECTION_PARAMETERINFO_FORMATPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C43C160)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1C43CFD0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C43CFC0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETDEFAULTVALUEIMPL_OFFSET UNITYSDK_OFFSET(0x1C43CF60)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETPSEUDOCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C43C880)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETREALOBJECT_OFFSET UNITYSDK_OFFSET(0x1C43CFE0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETREQUIREDCUSTOMMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1C43D040)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETTYPEMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1C43A0B0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C43C6C0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1C43CF70)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISIN_OFFSET UNITYSDK_OFFSET(0x1C43C6D0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x1C43C750)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISOUT_OFFSET UNITYSDK_OFFSET(0x1C43C7D0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISRETVAL_OFFSET UNITYSDK_OFFSET(0x1C43C0E0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x1C43C850)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C43C860)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_PARAMETERTYPE_OFFSET UNITYSDK_OFFSET(0x1C43C6B0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C43C870)
#define SYSTEM_REFLECTION_PARAMETERINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1C43D030)
#define SYSTEM_REFLECTION_PARAMETERINFO_NEW_1_OFFSET UNITYSDK_OFFSET(0x1C4399A0)
#define SYSTEM_REFLECTION_PARAMETERINFO_NEW_OFFSET UNITYSDK_OFFSET(0x1C43AC60)
#define SYSTEM_REFLECTION_PARAMETERINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C43BBC0)
#define SYSTEM_REFLECTION_PARAMETERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43BBB0)
