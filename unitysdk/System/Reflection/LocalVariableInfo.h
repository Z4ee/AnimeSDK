...
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_GET_LOCALINDEX_OFFSET UNITYSDK_OFFSET(0x16374BB0)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_GET_LOCALTYPE_OFFSET UNITYSDK_OFFSET(0x16374BC0)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16374BD0)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16374BA0)
