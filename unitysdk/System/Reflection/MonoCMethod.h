...
#define SYSTEM_REFLECTION_MONOCMETHOD_DOINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC253F0)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETCUSTOMATTRIBUTESDATA_OFFSET UNITYSDK_OFFSET(0x1CC262D0)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1CC25E60)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1CC25E50)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETMETHODBODY_OFFSET UNITYSDK_OFFSET(0x1CC25E70)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETMETHODIMPLEMENTATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1CC24FF0)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETPARAMETERSCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC250D0)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETPARAMETERSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CC25090)
#define SYSTEM_REFLECTION_MONOCMETHOD_GETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1CC25050)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1CC25C40)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_CALLINGCONVENTION_OFFSET UNITYSDK_OFFSET(0x1CC25C50)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_CONTAINSGENERICPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1CC25CB0)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_CORE_CLR_SECURITY_LEVEL_OFFSET UNITYSDK_OFFSET(0x1CC26350)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1CC25390)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_ISSECURITYCRITICAL_OFFSET UNITYSDK_OFFSET(0x1CC26360)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_METHODHANDLE_OFFSET UNITYSDK_OFFSET(0x1CC25C30)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CC25D90)
#define SYSTEM_REFLECTION_MONOCMETHOD_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1CC25D80)
#define SYSTEM_REFLECTION_MONOCMETHOD_INTERNALINVOKE_1_OFFSET UNITYSDK_OFFSET(0x1CC25B10)
#define SYSTEM_REFLECTION_MONOCMETHOD_INTERNALINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC25120)
#define SYSTEM_REFLECTION_MONOCMETHOD_INVOKE_1_OFFSET UNITYSDK_OFFSET(0x1CC25C00)
#define SYSTEM_REFLECTION_MONOCMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC25140)
#define SYSTEM_REFLECTION_MONOCMETHOD_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1CC25E40)
#define SYSTEM_REFLECTION_MONOCMETHOD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC25E80)
#define SYSTEM_REFLECTION_MONOCMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC26370)
