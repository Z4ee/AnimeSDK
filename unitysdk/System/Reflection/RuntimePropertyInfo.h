...
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_FORMATNAMEANDSIG_OFFSET UNITYSDK_OFFSET(0x1875E590)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_GETDECLARINGTYPEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1875E4E0)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1875E6E0)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_GETRUNTIMEMODULE_OFFSET UNITYSDK_OFFSET(0x1875E470)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_GET_BINDINGFLAGS_OFFSET UNITYSDK_OFFSET(0x1875E3F0)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1875E400)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_GET_REFLECTEDTYPEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1875E530)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_SERIALIZATIONTOSTRING_OFFSET UNITYSDK_OFFSET(0x1875E800)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1875E580)
#define SYSTEM_REFLECTION_RUNTIMEPROPERTYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1875B5A0)
