...
#define SYSTEM_REFLECTION_MONOPROPERTYINFO_GETTYPEMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1637CBF0)
#define SYSTEM_REFLECTION_MONOPROPERTYINFO_GET_DEFAULT_VALUE_OFFSET UNITYSDK_OFFSET(0x1637C280)
#define SYSTEM_REFLECTION_MONOPROPERTYINFO_GET_PROPERTY_INFO_OFFSET UNITYSDK_OFFSET(0x1637B890)
