...
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_CREATEDELEGATE_1_OFFSET UNITYSDK_OFFSET(0x1C43F9C0)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_CREATEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1C43F9A0)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_FORMATNAMEANDSIG_OFFSET UNITYSDK_OFFSET(0x1C43F6F0)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C43FB10)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_GETRUNTIMEMODULE_OFFSET UNITYSDK_OFFSET(0x1C43F560)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_GET_BINDINGFLAGS_OFFSET UNITYSDK_OFFSET(0x1C43F540)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1C43F550)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_GET_REFLECTEDTYPEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C43F630)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_SERIALIZATIONTOSTRING_OFFSET UNITYSDK_OFFSET(0x1C43FDD0)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C43F9F0)
#define SYSTEM_REFLECTION_RUNTIMEMETHODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43FEF0)
