...
#define SYSTEM_REFLECTION_CUSTOMATTRIBUTEFORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD8FCF0)
#define SYSTEM_REFLECTION_CUSTOMATTRIBUTEFORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BD8FD60)
#define SYSTEM_REFLECTION_CUSTOMATTRIBUTEFORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD8FC50)

namespace System::Reflection
{
	inline static constexpr unsigned int CustomAttributeFormatException_TypeDefinitionIndex = 601;
