...
#define SYSTEM_REFLECTION_MONOPARAMETERINFO_METHOD_3_227461ECA347F719_OFFSET UNITYSDK_OFFSET(0x19601C10)
#define SYSTEM_REFLECTION_MONOPARAMETERINFO_METHOD_3_3FEA8408C5ED329C_OFFSET UNITYSDK_OFFSET(0x19601C20)
#define SYSTEM_REFLECTION_MONOPARAMETERINFO_METHOD_3_A886283F1E86B93E_OFFSET UNITYSDK_OFFSET(0x19601C30)
#define SYSTEM_REFLECTION_MONOPARAMETERINFO_METHOD_3_ACB6C6E15D765345_OFFSET UNITYSDK_OFFSET(0x19601A20)
#define SYSTEM_REFLECTION_MONOPARAMETERINFO_METHOD_3_D0751B0BE077AEC4_OFFSET UNITYSDK_OFFSET(0x19601990)
#define SYSTEM_REFLECTION_MONOPARAMETERINFO_METHOD_3_D11F921D2AEB66BD_OFFSET UNITYSDK_OFFSET(0x196019C0)
