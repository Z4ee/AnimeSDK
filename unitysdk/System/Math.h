...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x1D688CD0)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x1D688BD0)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x1D688C40)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x1D688D50)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x1D688D60)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x1D688D70)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x1D688B50)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x1D688370)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x1D688380)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x1D6883A0)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x1D688390)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x1D6883B0)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x1D6883C0)
#define SYSTEM_MATH_DIVREM_OFFSET UNITYSDK_OFFSET(0x1D689330)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x1D688B30)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x1D6883D0)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x1D6883E0)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x1D6886A0)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x1D688B20)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x1D6891B0)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x1D688B10)
#define SYSTEM_MATH_MAX_10_OFFSET UNITYSDK_OFFSET(0x1D688F20)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x1D688E60)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x1D688E70)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x1D688E80)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x1D688E90)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x1D688EA0)
#define SYSTEM_MATH_MAX_6_OFFSET UNITYSDK_OFFSET(0x1D688EB0)
#define SYSTEM_MATH_MAX_7_OFFSET UNITYSDK_OFFSET(0x1D688EC0)
#define SYSTEM_MATH_MAX_8_OFFSET UNITYSDK_OFFSET(0x1D688ED0)
#define SYSTEM_MATH_MAX_9_OFFSET UNITYSDK_OFFSET(0x1D688EF0)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x1D688E50)
#define SYSTEM_MATH_MIN_10_OFFSET UNITYSDK_OFFSET(0x1D6890D0)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x1D689010)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x1D689020)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x1D689030)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x1D689040)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x1D689050)
#define SYSTEM_MATH_MIN_6_OFFSET UNITYSDK_OFFSET(0x1D689060)
#define SYSTEM_MATH_MIN_7_OFFSET UNITYSDK_OFFSET(0x1D689070)
#define SYSTEM_MATH_MIN_8_OFFSET UNITYSDK_OFFSET(0x1D689080)
#define SYSTEM_MATH_MIN_9_OFFSET UNITYSDK_OFFSET(0x1D6890A0)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x1D689000)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x1D688B40)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x1D688790)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x1D688820)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x1D688830)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x1D688970)
#define SYSTEM_MATH_ROUND_5_OFFSET UNITYSDK_OFFSET(0x1D688A40)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x1D6886E0)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1D689270)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1D689290)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x1D688600)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x1D689260)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x1D6886C0)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D6885F0)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1D688AF0)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x1D6886D0)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1D688AD0)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D689340)
