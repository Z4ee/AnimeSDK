...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x19ECDDF0)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x19ECDCF0)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x19ECDD60)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x19ECDE70)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x19ECDE80)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x19ECDE90)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x19ECDC70)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x19ECD490)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x19ECD4A0)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x19ECD4C0)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x19ECD4B0)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x19ECD4D0)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x19ECD4E0)
#define SYSTEM_MATH_DIVREM_OFFSET UNITYSDK_OFFSET(0x19ECE4C0)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x19ECDC50)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x19ECD4F0)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x19ECD500)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x19ECD7C0)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x19ECDC40)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x19ECE340)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x19ECDC30)
#define SYSTEM_MATH_MAX_10_OFFSET UNITYSDK_OFFSET(0x19ECE070)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x19ECDF80)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x19ECDF90)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x19ECDFA0)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x19ECDFB0)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x19ECDFC0)
#define SYSTEM_MATH_MAX_6_OFFSET UNITYSDK_OFFSET(0x19ECDFD0)
#define SYSTEM_MATH_MAX_7_OFFSET UNITYSDK_OFFSET(0x19ECDFE0)
#define SYSTEM_MATH_MAX_8_OFFSET UNITYSDK_OFFSET(0x19ECDFF0)
#define SYSTEM_MATH_MAX_9_OFFSET UNITYSDK_OFFSET(0x19ECE020)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x19ECDF70)
#define SYSTEM_MATH_MIN_10_OFFSET UNITYSDK_OFFSET(0x19ECE260)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x19ECE160)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x19ECE170)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x19ECE180)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x19ECE190)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x19ECE1A0)
#define SYSTEM_MATH_MIN_6_OFFSET UNITYSDK_OFFSET(0x19ECE1B0)
#define SYSTEM_MATH_MIN_7_OFFSET UNITYSDK_OFFSET(0x19ECE1C0)
#define SYSTEM_MATH_MIN_8_OFFSET UNITYSDK_OFFSET(0x19ECE1D0)
#define SYSTEM_MATH_MIN_9_OFFSET UNITYSDK_OFFSET(0x19ECE210)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x19ECE150)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x19ECDC60)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x19ECD8B0)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x19ECD940)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x19ECD950)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x19ECDA90)
#define SYSTEM_MATH_ROUND_5_OFFSET UNITYSDK_OFFSET(0x19ECDB60)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x19ECD800)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x19ECE400)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x19ECE420)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x19ECD720)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x19ECE3F0)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x19ECD7E0)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x19ECD710)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x19ECDC10)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x19ECD7F0)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x19ECDBF0)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ECE4D0)
