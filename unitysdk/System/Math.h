...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x1D480D20)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x1D480C20)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x1D480C90)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x1D480DA0)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x1D480DB0)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x1D480DC0)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x1D480BA0)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x1D4800E0)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x1D4800F0)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x1D480110)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x1D480100)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x1D480120)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x1D480130)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x1D480900)
#define SYSTEM_MATH_FLOOR_1_OFFSET UNITYSDK_OFFSET(0x1D4801B0)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x1D480140)
#define SYSTEM_MATH_IEEEREMAINDER_OFFSET UNITYSDK_OFFSET(0x1D480920)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x1D4801C0)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x1D480480)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x1D4808F0)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x1D480FE0)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x1D4808E0)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x1D463C80)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x1D480E70)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x1D480E80)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x1D480E90)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x1D480EA0)
#define SYSTEM_MATH_MAX_6_OFFSET UNITYSDK_OFFSET(0x1D480ED0)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x1D480E60)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x1D463A90)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x1D480F30)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x1D480F40)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x1D480F50)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x1D480F90)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x1D480F20)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x1D480910)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x1D480570)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x1D480600)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x1D480610)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x1D480750)
#define SYSTEM_MATH_ROUND_5_OFFSET UNITYSDK_OFFSET(0x1D4807C0)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x1D4804C0)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1D4810A0)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1D4810C0)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x1D4803E0)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x1D481090)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x1D4804A0)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D4803D0)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1D4808C0)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x1D4804B0)
#define SYSTEM_MATH_TRUNCATE_1_OFFSET UNITYSDK_OFFSET(0x1D4808A0)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1D480830)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D481160)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0xD490);
		}
		static ::System::Double* StaticGet_doubleRoundLimit()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x4070);
		}
