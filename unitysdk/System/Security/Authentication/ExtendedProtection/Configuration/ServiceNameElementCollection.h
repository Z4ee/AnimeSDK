...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19239D90)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x19239DD0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x19239E10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x19239E50)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19239D10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19239C90)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x19239E90)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x19239F50)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x19239F10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x19239ED0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19239D50)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19239CD0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_SERVICENAMEELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19239C50)

namespace System::Security::Authentication::ExtendedProtection::Configuration
{
	inline static constexpr unsigned int ServiceNameElementCollection_TypeDefinitionIndex = 4088;
