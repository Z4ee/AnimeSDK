...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_BUILDPOLICY_OFFSET UNITYSDK_OFFSET(0x1DAD26D0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_CUSTOMSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x1DAD2550)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x1DAD2590)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1DAD2610)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x1DAD2650)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_SET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x1DAD25D0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_SET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x1DAD2690)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAD2510)
