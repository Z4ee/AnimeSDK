...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_BUILDPOLICY_OFFSET UNITYSDK_OFFSET(0x1C66EA40)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_CUSTOMSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x1C66E8C0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x1C66E900)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C66E980)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x1C66E9C0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_SET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x1C66E940)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_SET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x1C66EA00)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C66E880)

namespace System::Security::Authentication::ExtendedProtection::Configuration
{
	inline static constexpr unsigned int ExtendedProtectionPolicyElement_TypeDefinitionIndex = 4086;
