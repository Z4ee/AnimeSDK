...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_ADDIFNEW_OFFSET UNITYSDK_OFFSET(0x19BC5FA0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x19BC7030)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19BC6C70)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x19BC7010)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_1_OFFSET UNITYSDK_OFFSET(0x19BC61F0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_OFFSET UNITYSDK_OFFSET(0x19BC6050)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_NORMALIZESERVICENAME_OFFSET UNITYSDK_OFFSET(0x19BC6680)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC5BA0)

namespace System::Security::Authentication::ExtendedProtection
{
	inline static constexpr unsigned int ServiceNameCollection_TypeDefinitionIndex = 3151;
