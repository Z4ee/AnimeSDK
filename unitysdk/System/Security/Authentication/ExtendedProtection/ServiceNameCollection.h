...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_ADDIFNEW_OFFSET UNITYSDK_OFFSET(0x1C088F40)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1C089FD0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1C089C10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x1C089FB0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_1_OFFSET UNITYSDK_OFFSET(0x1C089190)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_OFFSET UNITYSDK_OFFSET(0x1C088FF0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_NORMALIZESERVICENAME_OFFSET UNITYSDK_OFFSET(0x1C089620)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C088B40)
