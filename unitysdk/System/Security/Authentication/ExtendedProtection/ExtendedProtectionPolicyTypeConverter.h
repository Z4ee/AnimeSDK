...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICYTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1E981AE0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICYTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1E981B30)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICYTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E981B80)

namespace System::Security::Authentication::ExtendedProtection
{
	inline static constexpr unsigned int ExtendedProtectionPolicyTypeConverter_TypeDefinitionIndex = 3156;
