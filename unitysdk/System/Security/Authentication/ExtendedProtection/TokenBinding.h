...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_GETRAWTOKENBINDINGID_OFFSET UNITYSDK_OFFSET(0x1A111230)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_GET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A111330)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_SET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A111340)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A111350)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A111220)

namespace System::Security::Authentication::ExtendedProtection
{
	inline static constexpr unsigned int TokenBinding_TypeDefinitionIndex = 3153;
