...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_GETRAWTOKENBINDINGID_OFFSET UNITYSDK_OFFSET(0x1D89C280)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_GET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x1D89C380)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_SET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x1D89C390)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D89C3A0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D89C270)
