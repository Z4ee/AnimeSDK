...
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESSPATH_OFFSET UNITYSDK_OFFSET(0x1C7178F0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1C7178B0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C717870)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C717830)
