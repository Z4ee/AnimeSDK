...
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESSPATH_OFFSET UNITYSDK_OFFSET(0x1B1D6B40)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1B1D6B00)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1D6AC0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D6A80)

namespace System::Security::Permissions
{
	inline static constexpr unsigned int ResourcePermissionBaseEntry_TypeDefinitionIndex = 4085;
