...
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1C89D3C0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_ADDTOSTORE_OFFSET UNITYSDK_OFFSET(0x1C89CFC0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_CREATESTORE_OFFSET UNITYSDK_OFFSET(0x1C89D040)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_DELETESTORE_OFFSET UNITYSDK_OFFSET(0x1C89D0C0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_ENUMERATECERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1C89D140)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_ENUMERATESTORES_OFFSET UNITYSDK_OFFSET(0x1C89D1C0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C89D240)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_OPENSTORE_OFFSET UNITYSDK_OFFSET(0x1C89D2C0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_GET_REMOVEFROMSTORE_OFFSET UNITYSDK_OFFSET(0x1C89D340)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_ADDTOSTORE_OFFSET UNITYSDK_OFFSET(0x1C89D000)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_CREATESTORE_OFFSET UNITYSDK_OFFSET(0x1C89D080)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_DELETESTORE_OFFSET UNITYSDK_OFFSET(0x1C89D100)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_ENUMERATECERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1C89D180)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_ENUMERATESTORES_OFFSET UNITYSDK_OFFSET(0x1C89D200)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C89D280)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_OPENSTORE_OFFSET UNITYSDK_OFFSET(0x1C89D300)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE_SET_REMOVEFROMSTORE_OFFSET UNITYSDK_OFFSET(0x1C89D380)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C89CFB0)
