...
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_CAST_OFFSET UNITYSDK_OFFSET(0x1C2D4F50)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1C2D4BF0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1C2D4C40)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1C2D4D80)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1C2D4FD0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1C2D4FC0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C2D4B50)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1C2D5070)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1C2D51E0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2D4B40)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D4B10)
