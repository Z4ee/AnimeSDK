...
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_CAST_OFFSET UNITYSDK_OFFSET(0x1D695F70)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1D695C00)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1D695C50)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1D695DA0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1D695FF0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1D695FE0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1D695B60)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1D696090)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1D696200)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D695B50)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D695B20)

namespace System::Security::Permissions
{
	inline static constexpr unsigned int ReflectionPermission_TypeDefinitionIndex = 955;
