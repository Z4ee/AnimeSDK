...
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1DAD30C0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1DAD3570)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1DAD2F10)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1DAD3250)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1DAD3110)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1DAD2F20)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_RESET_OFFSET UNITYSDK_OFFSET(0x1DAD2EE0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_SETUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1DAD2E10)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1DAD2EF0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1DAD33B0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1DAD2F30)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_VERIFYACCESS_OFFSET UNITYSDK_OFFSET(0x1DAD2E40)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_VERIFYFLAGS_OFFSET UNITYSDK_OFFSET(0x1DAD38C0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAD2E20)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAD2DA0)
