...
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1CB08D40)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1CB08C40)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_GET_RESTRICTEDREGISTRATIONACCESS_OFFSET UNITYSDK_OFFSET(0x1CB08CC0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1CB08C80)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_SET_RESTRICTEDREGISTRATIONACCESS_OFFSET UNITYSDK_OFFSET(0x1CB08D00)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB08C30)
