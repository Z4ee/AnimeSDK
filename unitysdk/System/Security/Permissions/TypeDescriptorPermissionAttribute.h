...
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1A7F51C0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1A7F50C0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_GET_RESTRICTEDREGISTRATIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A7F5140)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1A7F5100)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_SET_RESTRICTEDREGISTRATIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A7F5180)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F50B0)

namespace System::Security::Permissions
{
	inline static constexpr unsigned int TypeDescriptorPermissionAttribute_TypeDefinitionIndex = 4108;
