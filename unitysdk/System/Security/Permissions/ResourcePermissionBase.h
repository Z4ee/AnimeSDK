...
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_ADDPERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1DD32250)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DD32290)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_COPY_OFFSET UNITYSDK_OFFSET(0x1DD322D0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_FROMXML_OFFSET UNITYSDK_OFFSET(0x1DD32310)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_GETPERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x1DD32350)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_GET_PERMISSIONACCESSTYPE_OFFSET UNITYSDK_OFFSET(0x1DD32150)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_GET_TAGNAMES_OFFSET UNITYSDK_OFFSET(0x1DD321D0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1DD32390)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1DD323D0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1DD32410)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_REMOVEPERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1DD32450)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_SET_PERMISSIONACCESSTYPE_OFFSET UNITYSDK_OFFSET(0x1DD32190)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_SET_TAGNAMES_OFFSET UNITYSDK_OFFSET(0x1DD32210)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_TOXML_OFFSET UNITYSDK_OFFSET(0x1DD32490)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD32110)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD320D0)
