...
#define SYSTEM_SECURITY_UTIL_TOKENIZERSTRINGBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x178200C0)

namespace System::Security::Util
{
	inline static constexpr unsigned int TokenizerStringBlock_TypeDefinitionIndex = 975;
