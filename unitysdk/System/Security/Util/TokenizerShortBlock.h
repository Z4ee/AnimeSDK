...
#define SYSTEM_SECURITY_UTIL_TOKENIZERSHORTBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A98DF60)

namespace System::Security::Util
{
	inline static constexpr unsigned int TokenizerShortBlock_TypeDefinitionIndex = 1012;
