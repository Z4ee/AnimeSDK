...
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_CREATEFROMBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1A6C7950)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6C7AB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6C7C80)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_AUDITFLAGS_OFFSET UNITYSDK_OFFSET(0x1A6C78F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_INHERITANCEFLAGS_OFFSET UNITYSDK_OFFSET(0x1A6C7910)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_ISINHERITED_OFFSET UNITYSDK_OFFSET(0x1A6C7930)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_PROPAGATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1A6C7940)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_ISOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1A6C7A90)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A6C7B20)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A6C7D90)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_READINT_OFFSET UNITYSDK_OFFSET(0x1A6C7F50)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_READUSHORT_OFFSET UNITYSDK_OFFSET(0x1A6C7EF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1A6C7FF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_WRITEUSHORT_OFFSET UNITYSDK_OFFSET(0x1A6C8080)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6C77E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A6C80D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C7770)
