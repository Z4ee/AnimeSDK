...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_CONVERTTYPE_OFFSET UNITYSDK_OFFSET(0x1C503140)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1C503670)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1C503610)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5032B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5030C0)
