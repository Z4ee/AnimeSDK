...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_CONVERTTYPE_OFFSET UNITYSDK_OFFSET(0x1A0B7020)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1A0B7550)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A0B74F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0B7190)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B6FA0)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int CommonAce_TypeDefinitionIndex = 973;
