...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFONATIVECALL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E17960)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFONATIVECALL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E17A70)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFONATIVECALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E174A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFONATIVECALL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E17490)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int NativeObjectSecurity_GetSecurityInfoNativeCall_TypeDefinitionIndex = 990;
