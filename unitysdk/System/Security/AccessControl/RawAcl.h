...
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1C5059E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1C505820)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C505910)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C505930)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_INSERTACE_OFFSET UNITYSDK_OFFSET(0x1C505CE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_READUSHORT_OFFSET UNITYSDK_OFFSET(0x1C5057C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_REMOVEACE_OFFSET UNITYSDK_OFFSET(0x1C505D90)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C505990)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_WRITEUSHORT_OFFSET UNITYSDK_OFFSET(0x1C505C90)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C505490)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C505410)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int RawAcl_TypeDefinitionIndex = 1000;
