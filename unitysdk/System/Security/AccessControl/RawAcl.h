...
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1D8D21A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1D8D1FE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D8D20D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D8D20F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_INSERTACE_OFFSET UNITYSDK_OFFSET(0x1D8D24A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_READUSHORT_OFFSET UNITYSDK_OFFSET(0x1D8D1F80)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_REMOVEACE_OFFSET UNITYSDK_OFFSET(0x1D8D2550)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D8D2150)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_WRITEUSHORT_OFFSET UNITYSDK_OFFSET(0x1D8D2450)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D8D1C50)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8D1BD0)
