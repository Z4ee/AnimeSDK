...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACEGETQUALIFIEDACE_OFFSET UNITYSDK_OFFSET(0x19982380)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACE_1_OFFSET UNITYSDK_OFFSET(0x19982470)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACE_OFFSET UNITYSDK_OFFSET(0x19982290)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x19981F30)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_CANONICALIZEANDCLEARAEFA_OFFSET UNITYSDK_OFFSET(0x19980C50)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_COPYACE_OFFSET UNITYSDK_OFFSET(0x19980E90)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETACEFLAGS_OFFSET UNITYSDK_OFFSET(0x199825A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x19980F60)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETCANONICALEXPLICITACECOUNT_OFFSET UNITYSDK_OFFSET(0x199819C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETCANONICALEXPLICITDENYACECOUNT_OFFSET UNITYSDK_OFFSET(0x19981820)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETOBJECTACETYPEGUIDS_OFFSET UNITYSDK_OFFSET(0x19981EE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x19980D50)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19980D70)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19980DA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_INIT_OFFSET UNITYSDK_OFFSET(0x19980990)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x19981730)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_MERGEEXPLICITACEPAIR_OFFSET UNITYSDK_OFFSET(0x19981A70)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_MERGEEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x199814D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_PURGE_OFFSET UNITYSDK_OFFSET(0x19980F80)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_REMOVEACESPECIFIC_OFFSET UNITYSDK_OFFSET(0x19982680)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_REQUIRECANONICITY_OFFSET UNITYSDK_OFFSET(0x19981070)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SETACE_1_OFFSET UNITYSDK_OFFSET(0x199828C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SETACE_OFFSET UNITYSDK_OFFSET(0x199827D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19980F10)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_TESTCANONICITY_OFFSET UNITYSDK_OFFSET(0x199810E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199809A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19980AC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_3_OFFSET UNITYSDK_OFFSET(0x199829D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_OFFSET UNITYSDK_OFFSET(0x199807A0)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int CommonAcl_TypeDefinitionIndex = 974;
	...
	public:
		...
		::System::Boolean is_aefa; // 0x19
		::System::Boolean is_canonical; // 0x1A
		::System::Boolean is_container; // 0x1B
