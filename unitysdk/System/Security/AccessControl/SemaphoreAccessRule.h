...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE_GET_SEMAPHORERIGHTS_OFFSET UNITYSDK_OFFSET(0x1B41FD00)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B41FC20)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41FB80)
