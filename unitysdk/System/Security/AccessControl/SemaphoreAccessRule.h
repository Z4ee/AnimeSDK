...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE_GET_SEMAPHORERIGHTS_OFFSET UNITYSDK_OFFSET(0x19239C40)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19239B60)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x19239AC0)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int SemaphoreAccessRule_TypeDefinitionIndex = 3139;
