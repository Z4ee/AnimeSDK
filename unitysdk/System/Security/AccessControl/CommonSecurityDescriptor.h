...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_CHECKACLCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x1C8C86C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_GET_CONTROLFLAGS_OFFSET UNITYSDK_OFFSET(0x1C8C86A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_INIT_1_OFFSET UNITYSDK_OFFSET(0x1C8C8540)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_INIT_OFFSET UNITYSDK_OFFSET(0x1C8C83C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_PURGEACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x1C8C8770)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_PURGEAUDIT_OFFSET UNITYSDK_OFFSET(0x1C8C8790)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_SET_DISCRETIONARYACL_OFFSET UNITYSDK_OFFSET(0x1C8C85A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_SET_SYSTEMACL_OFFSET UNITYSDK_OFFSET(0x1C8C8310)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C8C84E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8C8340)
...
namespace System::Security::AccessControl
{
	...
	public:
		...
		::System::Security::Principal::SecurityIdentifier* group; // 0x18
		::System::Security::AccessControl::DiscretionaryAcl* discretionary_acl; // 0x20
		::System::Security::AccessControl::SystemAcl* system_acl; // 0x28
		::System::Security::AccessControl::ControlFlags flags; // 0x30
		::System::Boolean is_container; // 0x34
		::System::Boolean is_ds; // 0x35
