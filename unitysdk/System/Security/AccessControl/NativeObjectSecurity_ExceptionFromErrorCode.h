...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E173E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E17480)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E16FF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16FE0)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int NativeObjectSecurity_ExceptionFromErrorCode_TypeDefinitionIndex = 989;
