...
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_CONVERTTYPE_OFFSET UNITYSDK_OFFSET(0x1C702320)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1C702870)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1C702810)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_INHERITEDOBJECTACETYPEPRESENT_OFFSET UNITYSDK_OFFSET(0x1C702780)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_OBJECTACETYPEPRESENT_OFFSET UNITYSDK_OFFSET(0x1C702770)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_READGUID_OFFSET UNITYSDK_OFFSET(0x1C702790)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1C702AA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C702410)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C702270)
...
namespace System::Security::AccessControl
{
	...
	{
	public:
		::System::Guid inherited_object_type; // 0x30
		::System::Security::AccessControl::ObjectAceFlags object_ace_flags; // 0x40
		::System::Guid object_ace_type; // 0x44
