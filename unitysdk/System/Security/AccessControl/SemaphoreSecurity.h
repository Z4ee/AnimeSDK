...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ACCESSRULEFACTORY_OFFSET UNITYSDK_OFFSET(0x1DB93EE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ADDACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1DB93FB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ADDAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1DB94190)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_AUDITRULEFACTORY_OFFSET UNITYSDK_OFFSET(0x1DB940C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_ACCESSRIGHTTYPE_OFFSET UNITYSDK_OFFSET(0x1DB93E50)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_ACCESSRULETYPE_OFFSET UNITYSDK_OFFSET(0x1DB93E80)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_AUDITRULETYPE_OFFSET UNITYSDK_OFFSET(0x1DB93EB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x1DB94270)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULEALL_OFFSET UNITYSDK_OFFSET(0x1DB94000)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULESPECIFIC_OFFSET UNITYSDK_OFFSET(0x1DB94030)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1DB93FD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULEALL_OFFSET UNITYSDK_OFFSET(0x1DB941E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULESPECIFIC_OFFSET UNITYSDK_OFFSET(0x1DB94210)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1DB941B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_RESETACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1DB94060)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_SETACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1DB94090)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_SETAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1DB94240)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB93DF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB93E20)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB93DC0)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int SemaphoreSecurity_TypeDefinitionIndex = 3141;
