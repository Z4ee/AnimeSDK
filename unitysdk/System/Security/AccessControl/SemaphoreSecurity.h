...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ACCESSRULEFACTORY_OFFSET UNITYSDK_OFFSET(0x1C6E2320)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ADDACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1C6E23F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ADDAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1C6E25D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_AUDITRULEFACTORY_OFFSET UNITYSDK_OFFSET(0x1C6E2500)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_ACCESSRIGHTTYPE_OFFSET UNITYSDK_OFFSET(0x1C6E2290)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_ACCESSRULETYPE_OFFSET UNITYSDK_OFFSET(0x1C6E22C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_AUDITRULETYPE_OFFSET UNITYSDK_OFFSET(0x1C6E22F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x1C6E26B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULEALL_OFFSET UNITYSDK_OFFSET(0x1C6E2440)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULESPECIFIC_OFFSET UNITYSDK_OFFSET(0x1C6E2470)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1C6E2410)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULEALL_OFFSET UNITYSDK_OFFSET(0x1C6E2620)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULESPECIFIC_OFFSET UNITYSDK_OFFSET(0x1C6E2650)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1C6E25F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_RESETACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1C6E24A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_SETACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1C6E24D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_SETAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1C6E2680)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6E2230)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C6E2260)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6E2200)
