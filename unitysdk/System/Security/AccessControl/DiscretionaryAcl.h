...
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_ADDACCESS_OFFSET UNITYSDK_OFFSET(0x1C6E6060)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x1C6E6300)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_GETACEINSERTPOSITION_OFFSET UNITYSDK_OFFSET(0x1C6E6340)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_GETACEQUALIFIER_OFFSET UNITYSDK_OFFSET(0x1C6E6100)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x1C6E6350)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_REMOVEACCESSSPECIFIC_OFFSET UNITYSDK_OFFSET(0x1C6E61C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_REMOVEACCESS_OFFSET UNITYSDK_OFFSET(0x1C6E6170)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_SETACCESS_OFFSET UNITYSDK_OFFSET(0x1C6E6260)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6E6050)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6E6040)
