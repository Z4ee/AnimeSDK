...
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ADDAUDIT_OFFSET UNITYSDK_OFFSET(0x1D816030)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x1D816110)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_GETACEINSERTPOSITION_OFFSET UNITYSDK_OFFSET(0x1D816130)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x1D816140)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ISVALIDAUDITFLAGS_OFFSET UNITYSDK_OFFSET(0x1D816240)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_REMOVEAUDITSPECIFIC_OFFSET UNITYSDK_OFFSET(0x1D8160B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_REMOVEAUDIT_OFFSET UNITYSDK_OFFSET(0x1D816060)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_SETAUDIT_OFFSET UNITYSDK_OFFSET(0x1D8160E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D816020)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D816010)
