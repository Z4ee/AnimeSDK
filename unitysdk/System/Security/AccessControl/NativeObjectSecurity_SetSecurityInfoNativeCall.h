...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7CC030)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7CC0E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7CB7E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7CB2A0)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int NativeObjectSecurity_SetSecurityInfoNativeCall_TypeDefinitionIndex = 991;
