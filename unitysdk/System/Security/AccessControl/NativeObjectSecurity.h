...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_CLEARACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1DF42450)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_DEFAULTEXCEPTIONFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x1DF426A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETNAMEDSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x1DF43A10)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYDESCRIPTORLENGTH_OFFSET UNITYSDK_OFFSET(0x1DF43330)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x1DF438F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_1_OFFSET UNITYSDK_OFFSET(0x1DF42DA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x1DF42A50)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x1DF42E40)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_ISVALIDSECURITYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DF432B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_LOCALFREE_OFFSET UNITYSDK_OFFSET(0x1DF433B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x1DF42510)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_RAISEEXCEPTIONONFAILURE_OFFSET UNITYSDK_OFFSET(0x1DF423A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x1DF43AF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32FIXNAME_OFFSET UNITYSDK_OFFSET(0x1DF43840)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32GETHELPER_OFFSET UNITYSDK_OFFSET(0x1DF42AF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32SETHELPER_OFFSET UNITYSDK_OFFSET(0x1DF42F00)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF41FF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DF42020)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DF421E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DF42040)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1DF42200)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF41FC0)
