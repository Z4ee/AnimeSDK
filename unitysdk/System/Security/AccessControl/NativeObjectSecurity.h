...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_CLEARACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1CB2AD20)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_DEFAULTEXCEPTIONFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x1CB2AF60)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETNAMEDSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x1CB2C330)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYDESCRIPTORLENGTH_OFFSET UNITYSDK_OFFSET(0x1CB2BC00)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x1CB2C210)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_1_OFFSET UNITYSDK_OFFSET(0x1CB2B670)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x1CB2B310)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x1CB2B710)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_ISVALIDSECURITYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CB2BB80)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_LOCALFREE_OFFSET UNITYSDK_OFFSET(0x1CB2BC80)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x1CB2ADE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_RAISEEXCEPTIONONFAILURE_OFFSET UNITYSDK_OFFSET(0x1CB2AC70)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x1CB2C420)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32FIXNAME_OFFSET UNITYSDK_OFFSET(0x1CB2C160)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32GETHELPER_OFFSET UNITYSDK_OFFSET(0x1CB2B3B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32SETHELPER_OFFSET UNITYSDK_OFFSET(0x1CB2B7D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CB2A8C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CB2A8F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CB2AAB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1CB2A910)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1CB2AAD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB2A890)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int NativeObjectSecurity_TypeDefinitionIndex = 987;
