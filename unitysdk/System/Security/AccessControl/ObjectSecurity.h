...
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_AREACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B80D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_COPYSDDLFORM_OFFSET UNITYSDK_OFFSET(0x1A0B8910)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GETGROUP_OFFSET UNITYSDK_OFFSET(0x1A0B8230)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GETOWNER_OFFSET UNITYSDK_OFFSET(0x1A0B8380)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B7E10)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ACCESSRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B80B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AREACCESSRULESPROTECTED_OFFSET UNITYSDK_OFFSET(0x1A0B7C40)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AREAUDITRULESPROTECTED_OFFSET UNITYSDK_OFFSET(0x1A0B7D50)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AUDITRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B8160)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_GROUPMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B81B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ISCONTAINER_OFFSET UNITYSDK_OFFSET(0x1A0B81D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ISDS_OFFSET UNITYSDK_OFFSET(0x1A0B81F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_OWNERMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B8210)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_PURGEACCESSRULES_OFFSET UNITYSDK_OFFSET(0x1A0B84D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_PURGEAUDITRULES_OFFSET UNITYSDK_OFFSET(0x1A0B8710)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READING_OFFSET UNITYSDK_OFFSET(0x1A0B7E30)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B7D00)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READUNLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B7D30)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SETACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B8120)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SETSECURITYDESCRIPTORBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1A0B8840)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_ACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B7F70)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_ACCESSRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B80F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_AUDITRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A0B8180)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SIDFROMIR_OFFSET UNITYSDK_OFFSET(0x1A0B8640)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITELOCK_OFFSET UNITYSDK_OFFSET(0x1A0B8610)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITEUNLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B86F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITING_OFFSET UNITYSDK_OFFSET(0x1A0B7F90)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0B79A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0B7B60)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B7990)

namespace System::Security::AccessControl
{
	inline static constexpr unsigned int ObjectSecurity_TypeDefinitionIndex = 997;

	class ObjectSecurity : public ::System::Object
	{
	public:
		::System::Threading::ReaderWriterLock* rw_lock; // 0x10
		::System::Security::AccessControl::CommonSecurityDescriptor* descriptor; // 0x18
