...
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GETOPAQUE_OFFSET UNITYSDK_OFFSET(0x1D8D00A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_ACEQUALIFIER_OFFSET UNITYSDK_OFFSET(0x1D8D1AE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_ISCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D8D1B80)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_OPAQUELENGTH_OFFSET UNITYSDK_OFFSET(0x1D8CFE20)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_SETOPAQUE_OFFSET UNITYSDK_OFFSET(0x1D8CFCA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D8CFC90)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D8D1B90)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8CF9E0)
