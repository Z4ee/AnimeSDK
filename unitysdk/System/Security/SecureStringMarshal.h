...
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOCOTASKMEMANSI_OFFSET UNITYSDK_OFFSET(0x19E45E30)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOCOTASKMEMUNICODE_OFFSET UNITYSDK_OFFSET(0x19E45EB0)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOGLOBALALLOCANSI_OFFSET UNITYSDK_OFFSET(0x19E45E40)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOGLOBALALLOCUNICODE_OFFSET UNITYSDK_OFFSET(0x19E45EC0)
