...
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOCOTASKMEMANSI_OFFSET UNITYSDK_OFFSET(0x1D6337D0)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOCOTASKMEMUNICODE_OFFSET UNITYSDK_OFFSET(0x1D633850)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOGLOBALALLOCANSI_OFFSET UNITYSDK_OFFSET(0x1D6337E0)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOGLOBALALLOCUNICODE_OFFSET UNITYSDK_OFFSET(0x1D633860)
