...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA256_CREATE_OFFSET UNITYSDK_OFFSET(0x1D183BF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA256__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A7CB0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int SHA256_TypeDefinitionIndex = 1096;
