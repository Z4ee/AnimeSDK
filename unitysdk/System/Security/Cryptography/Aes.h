...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_AES_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19ED6F80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_AES_CREATE_OFFSET UNITYSDK_OFFSET(0x19ED6F10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_AES__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ED7020)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_AES__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED6E90)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int Aes_TypeDefinitionIndex = 1038;
