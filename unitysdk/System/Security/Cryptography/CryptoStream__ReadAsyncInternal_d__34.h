...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__READASYNCINTERNAL_D__34_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x22ACB40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__READASYNCINTERNAL_D__34_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x22ACB50)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int CryptoStream__ReadAsyncInternal_d__34_TypeDefinitionIndex = 1008;
	...
	struct alignas(8) CryptoStream__ReadAsyncInternal_d__34
	{
		...
		::System::Threading::SemaphoreSlim* _sem_5__4; // 0x20
		::Il2CppArray<::System::Byte>* buffer; // 0x28
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Int32> __u__3; // 0x30
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Int32> __t__builder; // 0x40
		::System::Threading::CancellationToken cancellationToken; // 0x58
		::Il2CppArray<::System::Byte>* _tempInputBuffer_5__1; // 0x60
		::System::Security::Cryptography::CryptoStream* __4__this; // 0x68
		::System::Int32 __7__wrap1; // 0x70
		::System::Security::Cryptography::CryptoStream_HopToThreadPoolAwaitable __u__1; // 0x74
		::System::Int32 _bytesToDeliver_5__3; // 0x78
		::System::Int32 count; // 0x7C
		::System::Int32 offset; // 0x80
