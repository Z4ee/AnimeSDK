...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_FROMFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C89BC70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_FROMOIDVALUE_OFFSET UNITYSDK_OFFSET(0x1C89BD70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_GET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C89BE90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C89BE70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_SET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C89BF40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C89BE80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C89BA70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C89BB00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C89BBD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C89BBE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C89BC60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_OFFSET UNITYSDK_OFFSET(0x1C89BA60)
