...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPARAMETERS_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1BE53010)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPARAMETERS_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1BE53020)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPARAMETERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE53190)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPARAMETERS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BE53140)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPARAMETERS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BE531E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE530F0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int CspParameters_TypeDefinitionIndex = 1010;

	class CspParameters : public ::System::Object
	{
	public:
		::System::String* KeyContainerName; // 0x10
		::System::String* ProviderName; // 0x18
		::System::Int32 KeyNumber; // 0x20
		::System::Int32 ProviderType; // 0x24
		::System::Int32 m_flags; // 0x28
