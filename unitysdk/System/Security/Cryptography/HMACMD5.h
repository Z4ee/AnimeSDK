...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_HMACMD5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E18600)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_HMACMD5__CTOR_OFFSET UNITYSDK_OFFSET(0x19E185D0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int HMACMD5_TypeDefinitionIndex = 1065;
