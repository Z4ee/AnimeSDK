...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREDEFORMATTER_SETHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1AC9CB80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREDEFORMATTER_SETKEY_OFFSET UNITYSDK_OFFSET(0x1AC9CAC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREDEFORMATTER_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AC9CC30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREDEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC9C9A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREDEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC9C940)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int DSASignatureDeformatter_TypeDefinitionIndex = 1061;
