...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_MD5_CREATE_OFFSET UNITYSDK_OFFSET(0x19E18DF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_MD5__CTOR_OFFSET UNITYSDK_OFFSET(0x19E18DE0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int MD5_TypeDefinitionIndex = 1076;
