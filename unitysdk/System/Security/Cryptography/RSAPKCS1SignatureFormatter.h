...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SIGNATUREFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17800850)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int RSAPKCS1SignatureFormatter_TypeDefinitionIndex = 1073;
