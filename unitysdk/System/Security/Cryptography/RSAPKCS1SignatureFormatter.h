...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SIGNATUREFORMATTER_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x19553880)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SIGNATUREFORMATTER_SETHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x19553990)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SIGNATUREFORMATTER_SETKEY_OFFSET UNITYSDK_OFFSET(0x195537C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SIGNATUREFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195537B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SIGNATUREFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x195537A0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int RSAPKCS1SignatureFormatter_TypeDefinitionIndex = 1121;

	class RSAPKCS1SignatureFormatter : public ::System::Security::Cryptography::AsymmetricSignatureFormatter
	{
	public:
		::System::String* hash; // 0x10
