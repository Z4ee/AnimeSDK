...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DERIVEBYTES_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1DF43DC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DERIVEBYTES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DF43D10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_DERIVEBYTES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF43DD0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int DeriveBytes_TypeDefinitionIndex = 1055;
