...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFARRAYCREATE_OFFSET UNITYSDK_OFFSET(0x1CEE0120)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x1CEDFF90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFRELEASE_OFFSET UNITYSDK_OFFSET(0x1CEE00A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFRETAIN_OFFSET UNITYSDK_OFFSET(0x1CEE0020)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFSTRINGCREATEWITHCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1CEDFEF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_FROMINTPTRS_OFFSET UNITYSDK_OFFSET(0x1CEE0270)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_GETCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1CEE0320)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_MAKECFDATA_OFFSET UNITYSDK_OFFSET(0x1CEE01C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECCERTIFICATECREATEWITHDATA_OFFSET UNITYSDK_OFFSET(0x1CEDFC20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECPOLICYCREATESSL_OFFSET UNITYSDK_OFFSET(0x1CEDFDD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTCREATEWITHCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1CEDFCB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1CEDFE60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTSETANCHORCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1CEDFD40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_TRUSTEVALUATESSL_OFFSET UNITYSDK_OFFSET(0x1CEE05C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES__TRUSTEVALUATESSL_OFFSET UNITYSDK_OFFSET(0x1CEE0630)
