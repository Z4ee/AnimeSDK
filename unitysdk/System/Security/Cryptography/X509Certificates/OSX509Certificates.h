...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFARRAYCREATE_OFFSET UNITYSDK_OFFSET(0x1AAAE950)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x1AAAE7C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFRELEASE_OFFSET UNITYSDK_OFFSET(0x1AAAE8D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFRETAIN_OFFSET UNITYSDK_OFFSET(0x1AAAE850)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFSTRINGCREATEWITHCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1AAAE720)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_FROMINTPTRS_OFFSET UNITYSDK_OFFSET(0x1AAAEAA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_GETCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AAAEB50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_MAKECFDATA_OFFSET UNITYSDK_OFFSET(0x1AAAE9F0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECCERTIFICATECREATEWITHDATA_OFFSET UNITYSDK_OFFSET(0x1AAAE450)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECPOLICYCREATESSL_OFFSET UNITYSDK_OFFSET(0x1AAAE600)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTCREATEWITHCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AAAE4E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1AAAE690)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTSETANCHORCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AAAE570)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_TRUSTEVALUATESSL_OFFSET UNITYSDK_OFFSET(0x1AAAEDF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES__TRUSTEVALUATESSL_OFFSET UNITYSDK_OFFSET(0x1AAAEE60)
