...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_AREEQUAL_OFFSET UNITYSDK_OFFSET(0x1B421620)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_CANONIZE_OFFSET UNITYSDK_OFFSET(0x1B4213A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_DECODERAWDATA_OFFSET UNITYSDK_OFFSET(0x1B420940)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_DECODE_OFFSET UNITYSDK_OFFSET(0x1B420E90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_FORMAT_OFFSET UNITYSDK_OFFSET(0x1B4212F0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GETSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1B421240)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GET_CANONICALENCODING_OFFSET UNITYSDK_OFFSET(0x1B421220)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B421230)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4209E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B420B00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B420B10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B421040)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B421150)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B420890)
