...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_AREEQUAL_OFFSET UNITYSDK_OFFSET(0x1C89CD40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_CANONIZE_OFFSET UNITYSDK_OFFSET(0x1C89CAE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_DECODERAWDATA_OFFSET UNITYSDK_OFFSET(0x1C89C090)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_DECODE_OFFSET UNITYSDK_OFFSET(0x1C89C5E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_FORMAT_OFFSET UNITYSDK_OFFSET(0x1C89CA30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GETSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1C89C990)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GET_CANONICALENCODING_OFFSET UNITYSDK_OFFSET(0x1C89C970)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C89C980)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C89C130)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C89C260)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C89C270)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C89C790)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C89C8A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C89BFE0)

namespace System::Security::Cryptography::X509Certificates
{
	inline static constexpr unsigned int X500DistinguishedName_TypeDefinitionIndex = 3185;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* canonEncoding; // 0x20
