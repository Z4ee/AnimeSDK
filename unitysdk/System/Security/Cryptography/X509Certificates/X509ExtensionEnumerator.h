...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509EXTENSIONENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC2B200)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509EXTENSIONENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CC2B400)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509EXTENSIONENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CC2B4E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509EXTENSIONENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC2B320)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509EXTENSIONENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC2B5C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509EXTENSIONENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC2B120)

namespace System::Security::Cryptography::X509Certificates
{
	inline static constexpr unsigned int X509ExtensionEnumerator_TypeDefinitionIndex = 3206;
