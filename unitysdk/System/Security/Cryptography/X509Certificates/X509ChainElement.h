...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_COUNT_OFFSET UNITYSDK_OFFSET(0x1A111400)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A1113B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_CHAINELEMENTSTATUS_OFFSET UNITYSDK_OFFSET(0x1A1113C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_INFORMATION_OFFSET UNITYSDK_OFFSET(0x1A1113D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_STATUSFLAGS_OFFSET UNITYSDK_OFFSET(0x1A1113E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_SET_OFFSET UNITYSDK_OFFSET(0x1A111530)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_SET_STATUSFLAGS_OFFSET UNITYSDK_OFFSET(0x1A1113F0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_UNCOMPRESSFLAGS_OFFSET UNITYSDK_OFFSET(0x1A1115B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1127B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A111390)

namespace System::Security::Cryptography::X509Certificates
{
	inline static constexpr unsigned int X509ChainElement_TypeDefinitionIndex = 3197;

	class X509ChainElement : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Security::Cryptography::X509Certificates::X509ChainStatus>* status; // 0x10
		::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate; // 0x18
