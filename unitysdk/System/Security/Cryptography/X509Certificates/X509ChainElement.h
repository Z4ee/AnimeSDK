...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_COUNT_OFFSET UNITYSDK_OFFSET(0x1C4A4A70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1C4A4A20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_CHAINELEMENTSTATUS_OFFSET UNITYSDK_OFFSET(0x1C4A4A30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_INFORMATION_OFFSET UNITYSDK_OFFSET(0x1C4A4A40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_STATUSFLAGS_OFFSET UNITYSDK_OFFSET(0x1C4A4A50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_SET_OFFSET UNITYSDK_OFFSET(0x1C4A4BA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_SET_STATUSFLAGS_OFFSET UNITYSDK_OFFSET(0x1C4A4A60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_UNCOMPRESSFLAGS_OFFSET UNITYSDK_OFFSET(0x1C4A4C20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4A5E20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A4A00)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate; // 0x20
