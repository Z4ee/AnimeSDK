...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509UTILS_FINDOIDINFOWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0x167CAD70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509UTILS_FINDOIDINFO_OFFSET UNITYSDK_OFFSET(0x167CAC90)

namespace System::Security::Cryptography::X509Certificates
{
	inline static constexpr unsigned int X509Utils_TypeDefinitionIndex = 2681;
