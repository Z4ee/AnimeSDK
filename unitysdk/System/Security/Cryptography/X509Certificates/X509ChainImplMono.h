...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_BUILDCHAINFROM_OFFSET UNITYSDK_OFFSET(0x1D89E6E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_BUILD_OFFSET UNITYSDK_OFFSET(0x1D89DFB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKCRLS_OFFSET UNITYSDK_OFFSET(0x1D8A2A70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATIONONCHAIN_OFFSET UNITYSDK_OFFSET(0x1D8A0C20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATION_1_OFFSET UNITYSDK_OFFSET(0x1D8A1A40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATION_OFFSET UNITYSDK_OFFSET(0x1D8A1710)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_FINDCRL_OFFSET UNITYSDK_OFFSET(0x1D8A1CB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_FINDPARENT_OFFSET UNITYSDK_OFFSET(0x1D89F740)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_1_OFFSET UNITYSDK_OFFSET(0x1D8A1690)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_2_OFFSET UNITYSDK_OFFSET(0x1D8A1500)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1D89FD20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETSUBJECTKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1D89FDB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CERTIFICATEAUTHORITIES_OFFSET UNITYSDK_OFFSET(0x1D89F130)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CERTIFICATECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D89F5E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINELEMENTS_OFFSET UNITYSDK_OFFSET(0x1D89DF10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINPOLICY_OFFSET UNITYSDK_OFFSET(0x1D89DF20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINSTATUS_OFFSET UNITYSDK_OFFSET(0x1D89DF40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1D89DF00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D89DEF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_LMCASTORE_OFFSET UNITYSDK_OFFSET(0x1D89F440)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_LMROOTSTORE_OFFSET UNITYSDK_OFFSET(0x1D89EEF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_ROOTS_OFFSET UNITYSDK_OFFSET(0x1D89EB70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_USERCASTORE_OFFSET UNITYSDK_OFFSET(0x1D89F510)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_USERROOTSTORE_OFFSET UNITYSDK_OFFSET(0x1D89F010)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISCHAINCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1D89F900)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISSELFISSUED_OFFSET UNITYSDK_OFFSET(0x1D89FEC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISSIGNEDWITH_OFFSET UNITYSDK_OFFSET(0x1D8A1330)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PREPAREFORNEXTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1D8A06F0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCERTIFICATEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1D8A1380)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCRLENTRYEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1D8A2200)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCRLEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1D8A2610)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESS_OFFSET UNITYSDK_OFFSET(0x1D8A0040)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_RESET_OFFSET UNITYSDK_OFFSET(0x1D89E590)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_SELECTBESTFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D89FB20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_SET_CHAINPOLICY_OFFSET UNITYSDK_OFFSET(0x1D89DF30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_VALIDATECHAIN_OFFSET UNITYSDK_OFFSET(0x1D89E920)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_WRAPUP_OFFSET UNITYSDK_OFFSET(0x1D8A1030)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8A2EF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D89DD80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D89DEA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D89DD70)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* cas; // 0x10
		::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* elements; // 0x18
		::System::Security::Cryptography::X509Certificates::X500DistinguishedName* working_issuer_name; // 0x20
		::System::Security::Cryptography::X509Certificates::X509ChainPolicy* policy; // 0x28
		::Il2CppArray<::System::Security::Cryptography::X509Certificates::X509ChainStatus>* status; // 0x30
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* roots; // 0x38
		...
		::System::Security::Cryptography::AsymmetricAlgorithm* working_public_key; // 0x50
		::System::Security::Cryptography::X509Certificates::X509Store* root_store; // 0x58
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* collection; // 0x60
		::System::Security::Cryptography::X509Certificates::X509Store* ca_store; // 0x68
		::System::Security::Cryptography::X509Certificates::X509ChainElement* bce_restriction; // 0x70
