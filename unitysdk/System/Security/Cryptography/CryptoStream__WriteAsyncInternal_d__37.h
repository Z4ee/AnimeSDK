...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__WRITEASYNCINTERNAL_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x383C7A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__WRITEASYNCINTERNAL_D__37_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2BCB5E0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int CryptoStream__WriteAsyncInternal_d__37_TypeDefinitionIndex = 1008;
	...
	struct alignas(8) CryptoStream__WriteAsyncInternal_d__37
	{
		...
		::System::Int32 _currentInputIndex_5__2; // 0x70
