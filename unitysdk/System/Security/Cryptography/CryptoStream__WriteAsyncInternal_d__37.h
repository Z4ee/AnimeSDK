...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__WRITEASYNCINTERNAL_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x397C5B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__WRITEASYNCINTERNAL_D__37_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x393A090)
...
namespace System::Security::Cryptography
{
	...
	struct alignas(8) CryptoStream__WriteAsyncInternal_d__37
	{
		...
		::System::Security::Cryptography::CryptoStream_HopToThreadPoolAwaitable __u__1; // 0x60
