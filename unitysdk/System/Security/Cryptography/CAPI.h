...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CAPI_CRYPTFINDOIDINFOKEYFROMNAME_OFFSET UNITYSDK_OFFSET(0x19F0FD40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CAPI_CRYPTFINDOIDINFONAMEFROMKEY_OFFSET UNITYSDK_OFFSET(0x19F0F690)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int CAPI_TypeDefinitionIndex = 2671;
