...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TRIPLEDESTRANSFORM_ECB_OFFSET UNITYSDK_OFFSET(0x1E4509E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TRIPLEDESTRANSFORM_GETSTRONGKEY_OFFSET UNITYSDK_OFFSET(0x1E450940)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TRIPLEDESTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4505C0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int TripleDESTransform_TypeDefinitionIndex = 1123;

	class TripleDESTransform : public ::Mono::Security::Cryptography::SymmetricTransform
	{
	public:
		::System::Security::Cryptography::DESTransform* D1; // 0x50
		::System::Security::Cryptography::DESTransform* E3; // 0x58
		...
		::System::Security::Cryptography::DESTransform* D3; // 0x78
