...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RSAPKCS1SHA1SIGNATUREDESCRIPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x166BB420)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int RSAPKCS1SHA1SignatureDescription_TypeDefinitionIndex = 1065;
