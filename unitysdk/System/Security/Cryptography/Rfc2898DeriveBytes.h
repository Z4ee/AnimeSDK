...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD9AA10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_FUNC_OFFSET UNITYSDK_OFFSET(0x1CD9A540)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1CD9A3B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CD9A330)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_SET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1CD9A250)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_SET_SALT_OFFSET UNITYSDK_OFFSET(0x1CD9A050)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CD99F70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD99EC0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int Rfc2898DeriveBytes_TypeDefinitionIndex = 1080;

	class Rfc2898DeriveBytes : public ::System::Security::Cryptography::DeriveBytes
	{
	public:
		::Il2CppArray<::System::Byte>* m_buffer; // 0x10
		::System::Security::Cryptography::HMACSHA1* m_hmacsha1; // 0x18
		::Il2CppArray<::System::Byte>* m_salt; // 0x20
		::Il2CppArray<::System::Byte>* m_password; // 0x28
		::System::Int32 m_endIndex; // 0x30
		::System::UInt32 m_iterations; // 0x34
		::System::Int32 m_startIndex; // 0x38
