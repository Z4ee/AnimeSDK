...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C6E9C10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C6E9C20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C6E9F00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1C6E9CA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1C6E9DB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1C6E9DC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1C6E9DD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1C6E9DE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C6E9E40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C6E9FD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1C6E9F10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C6E9F70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C6E9EA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1C6EA030)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_TAILSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6E9BA0)

namespace System::Security::Cryptography
{
	inline static constexpr unsigned int TailStream_TypeDefinitionIndex = 1073;

	class TailStream : public ::System::IO::Stream
	{
	public:
		::Il2CppArray<::System::Byte>* _Buffer; // 0x28
		::System::Int32 _BufferIndex; // 0x30
