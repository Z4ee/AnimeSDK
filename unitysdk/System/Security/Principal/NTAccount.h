...
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7CD640)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7CD700)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A7CD630)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A7CD6C0)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7CD790)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1A7CD7A0)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7CD580)

namespace System::Security::Principal
{
	inline static constexpr unsigned int NTAccount_TypeDefinitionIndex = 1022;
