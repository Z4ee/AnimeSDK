...
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1CD59A20)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_CREATEFROMBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1CD59550)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CD59D40)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CD59C30)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1CD59DE0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CD59EB0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1CD59840)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDSUBAUTHORITYCOUNT_OFFSET UNITYSDK_OFFSET(0x1CD599E0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDSUBAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1CD59930)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1CD59640)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CD59660)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CD59BC0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CD5A120)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_PARSESDDLFORM_OFFSET UNITYSDK_OFFSET(0x1CD58E90)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CD59F40)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1CD59F50)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRYPARSEAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1CD5A190)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRYPARSESUBAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1CD5A290)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CD5A390)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CD59470)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD58E00)
