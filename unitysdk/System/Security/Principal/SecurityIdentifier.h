...
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B93CBC0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_CREATEFROMBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1B93C6F0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B93CEE0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B93CDD0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1B93CF80)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B93D050)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1B93C9E0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDSUBAUTHORITYCOUNT_OFFSET UNITYSDK_OFFSET(0x1B93CB80)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDSUBAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1B93CAD0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1B93C7E0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B93C800)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B93CD60)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B93D2C0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_PARSESDDLFORM_OFFSET UNITYSDK_OFFSET(0x1B93C020)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B93D0E0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1B93D0F0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRYPARSEAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1B93D330)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRYPARSESUBAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1B93D430)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B93D530)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B93C610)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93BF90)

namespace System::Security::Principal
{
	inline static constexpr unsigned int SecurityIdentifier_TypeDefinitionIndex = 1022;
