...
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_CHECKPERMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x1BE36030)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_CHECKSECURITYELEMENT_OFFSET UNITYSDK_OFFSET(0x1BE360C0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_DEMAND_OFFSET UNITYSDK_OFFSET(0x1BE35D70)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_ELEMENT_OFFSET UNITYSDK_OFFSET(0x1BE35F00)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BE35D80)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BE35E60)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1BE36390)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_THROWINVALIDPERMISSION_OFFSET UNITYSDK_OFFSET(0x1BE364A0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BE35E70)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1BE35EA0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE35D60)
