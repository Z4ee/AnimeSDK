...
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_CHECKPERMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x19983070)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_CHECKSECURITYELEMENT_OFFSET UNITYSDK_OFFSET(0x19983100)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_DEMAND_OFFSET UNITYSDK_OFFSET(0x19982DB0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_ELEMENT_OFFSET UNITYSDK_OFFSET(0x19982F40)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x19982DC0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19982EA0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x199833D0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_THROWINVALIDPERMISSION_OFFSET UNITYSDK_OFFSET(0x199834E0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19982EB0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x19982EE0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19982DA0)
