...
#define SYSTEM_SECURITY_POLICY_POLICYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x150B6C80)
...
namespace System::Security::Policy
{
	...
	public:
		...
		::System::Collections::Hashtable* fullNames; // 0x20
		::System::Collections::ArrayList* full_trust_assemblies; // 0x28
		::System::String* _location; // 0x30
		::System::Security::SecurityElement* xml; // 0x38
		::System::Security::Policy::CodeGroup* root_code_group; // 0x40
