...
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CCBE6D0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_SECURITY_CLAIMS_CLAIM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CCBEBD0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SECURITY_CLAIMS_CLAIM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CCBEB60)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CCBEC50)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CCBEBC0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CCBEB70)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CCBE500)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCBE4E0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1CCBE5F0)

namespace System::Security::Claims
{
	inline static constexpr unsigned int ClaimsIdentity__get_Claims_d__51_TypeDefinitionIndex = 1032;

	class ClaimsIdentity__get_Claims_d__51 : public ::System::Object
	{
	public:
		::System::Security::Claims::ClaimsIdentity* __4__this; // 0x10
