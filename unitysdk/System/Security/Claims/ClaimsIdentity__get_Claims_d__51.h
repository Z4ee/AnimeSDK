...
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x187E2180)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_SECURITY_CLAIMS_CLAIM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187E2650)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SECURITY_CLAIMS_CLAIM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187E25E0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187E26D0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187E2640)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x187E25F0)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187E2030)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51__CTOR_OFFSET UNITYSDK_OFFSET(0x187E0C30)
#define SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY__GET_CLAIMS_D__51___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x187E20E0)

namespace System::Security::Claims
{
	inline static constexpr unsigned int ClaimsIdentity__get_Claims_d__51_TypeDefinitionIndex = 986;
