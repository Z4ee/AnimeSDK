...
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GETRESOURCEFILENAME_OFFSET UNITYSDK_OFFSET(0x1D8C2720)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAMEFIELD_OFFSET UNITYSDK_OFFSET(0x1D8C26E0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAME_OFFSET UNITYSDK_OFFSET(0x1D8C28F0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_CALLINGASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1D8C2850)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_FALLBACKLOC_OFFSET UNITYSDK_OFFSET(0x1D8C2830)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOCATIONINFO_OFFSET UNITYSDK_OFFSET(0x1D8C26A0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1D8C2750)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MAINASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1D8C2870)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MODULEDIR_OFFSET UNITYSDK_OFFSET(0x1D8C2680)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x1D8C2700)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1D8C2790)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_USERRESOURCESET_OFFSET UNITYSDK_OFFSET(0x1D8C26C0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_OBTAINSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1D8C27D0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1D8C2770)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1D8C27B0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8C2610)
