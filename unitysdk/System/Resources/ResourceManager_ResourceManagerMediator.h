...
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GETRESOURCEFILENAME_OFFSET UNITYSDK_OFFSET(0x1A0AA100)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAMEFIELD_OFFSET UNITYSDK_OFFSET(0x1A0AA0C0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAME_OFFSET UNITYSDK_OFFSET(0x1A0AA2D0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_CALLINGASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1A0AA230)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_FALLBACKLOC_OFFSET UNITYSDK_OFFSET(0x1A0AA210)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOCATIONINFO_OFFSET UNITYSDK_OFFSET(0x1A0AA080)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1A0AA130)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MAINASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1A0AA250)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MODULEDIR_OFFSET UNITYSDK_OFFSET(0x1A0AA060)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x1A0AA0E0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1A0AA170)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_USERRESOURCESET_OFFSET UNITYSDK_OFFSET(0x1A0AA0A0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_OBTAINSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1A0AA1B0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1A0AA150)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1A0AA190)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A9FF0)

namespace System::Resources
{
	inline static constexpr unsigned int ResourceManager_ResourceManagerMediator_TypeDefinitionIndex = 513;
