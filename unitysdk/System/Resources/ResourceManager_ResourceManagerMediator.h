...
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GETRESOURCEFILENAME_OFFSET UNITYSDK_OFFSET(0x1C4F61E0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAMEFIELD_OFFSET UNITYSDK_OFFSET(0x1C4F61A0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAME_OFFSET UNITYSDK_OFFSET(0x1C4F63B0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_CALLINGASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1C4F6310)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_FALLBACKLOC_OFFSET UNITYSDK_OFFSET(0x1C4F62F0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOCATIONINFO_OFFSET UNITYSDK_OFFSET(0x1C4F6160)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1C4F6210)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MAINASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1C4F6330)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MODULEDIR_OFFSET UNITYSDK_OFFSET(0x1C4F6140)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x1C4F61C0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1C4F6250)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_USERRESOURCESET_OFFSET UNITYSDK_OFFSET(0x1C4F6180)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_OBTAINSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1C4F6290)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1C4F6230)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x1C4F6270)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F60D0)
