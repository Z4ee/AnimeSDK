...
#define SYSTEM_RESOURCES_MISSINGMANIFESTRESOURCEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BDA7AA0)
#define SYSTEM_RESOURCES_MISSINGMANIFESTRESOURCEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BDABBA0)
#define SYSTEM_RESOURCES_MISSINGMANIFESTRESOURCEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDABB00)

namespace System::Resources
{
	inline static constexpr unsigned int MissingManifestResourceException_TypeDefinitionIndex = 521;
