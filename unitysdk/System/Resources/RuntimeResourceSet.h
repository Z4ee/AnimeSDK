...
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BDB8790)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETENUMERATORHELPER_OFFSET UNITYSDK_OFFSET(0x1BDB8B30)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BDB8B20)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1BDB9BB0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1BDB8C70)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x1BDB9BA0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETSTRING_1_OFFSET UNITYSDK_OFFSET(0x1BDB9B70)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1BDB8C40)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_RESOLVERESOURCELOCATOR_OFFSET UNITYSDK_OFFSET(0x1BDB9BC0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BDB8C30)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BDAAD50)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA7DF0)
