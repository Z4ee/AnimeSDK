...
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_CREATERESOURCESET_OFFSET UNITYSDK_OFFSET(0x1CE8B100)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_FINDRESOURCEFILE_OFFSET UNITYSDK_OFFSET(0x1CE8B000)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_GROVELFORRESOURCESET_OFFSET UNITYSDK_OFFSET(0x1CE8ACC0)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8ACB0)
