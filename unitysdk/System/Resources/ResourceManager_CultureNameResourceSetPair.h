...
#define SYSTEM_RESOURCES_RESOURCEMANAGER_CULTURENAMERESOURCESETPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDAC3A0)

namespace System::Resources
{
	inline static constexpr unsigned int ResourceManager_CultureNameResourceSetPair_TypeDefinitionIndex = 527;
