...
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1876BA90)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_GET_DATAPOSITION_OFFSET UNITYSDK_OFFSET(0x1876C000)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1876BAC0)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1876B990)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1876C010)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1876B940)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1876C110)
#define SYSTEM_RESOURCES_RESOURCEREADER_RESOURCEENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18767C00)

namespace System::Resources
{
	inline static constexpr unsigned int ResourceReader_ResourceEnumerator_TypeDefinitionIndex = 528;
