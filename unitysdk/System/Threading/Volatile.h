...
#define SYSTEM_THREADING_VOLATILE_READ_1_OFFSET UNITYSDK_OFFSET(0x1DDF19C0)
#define SYSTEM_THREADING_VOLATILE_READ_2_OFFSET UNITYSDK_OFFSET(0x1DDF19D0)
#define SYSTEM_THREADING_VOLATILE_READ_OFFSET UNITYSDK_OFFSET(0x1DDF19B0)
#define SYSTEM_THREADING_VOLATILE_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1DDF19F0)
#define SYSTEM_THREADING_VOLATILE_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1DDF1A00)
#define SYSTEM_THREADING_VOLATILE_WRITE_OFFSET UNITYSDK_OFFSET(0x1DDF19E0)
