...
#define SYSTEM_THREADING_VOLATILE_READ_1_OFFSET UNITYSDK_OFFSET(0x1C9E41D0)
#define SYSTEM_THREADING_VOLATILE_READ_2_OFFSET UNITYSDK_OFFSET(0x1C9E41E0)
#define SYSTEM_THREADING_VOLATILE_READ_OFFSET UNITYSDK_OFFSET(0x1C9E41C0)
#define SYSTEM_THREADING_VOLATILE_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1C9E4200)
#define SYSTEM_THREADING_VOLATILE_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1C9E4210)
#define SYSTEM_THREADING_VOLATILE_WRITE_OFFSET UNITYSDK_OFFSET(0x1C9E41F0)
