...
#define SYSTEM_THREADING_CANCELLATIONCALLBACKCOREWORKARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x77400)

namespace System::Threading
{
	inline static constexpr unsigned int CancellationCallbackCoreWorkArguments_TypeDefinitionIndex = 799;
