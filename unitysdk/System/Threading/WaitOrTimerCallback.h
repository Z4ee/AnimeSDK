...
#define SYSTEM_THREADING_WAITORTIMERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DC11C50)
#define SYSTEM_THREADING_WAITORTIMERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC11CD0)
#define SYSTEM_THREADING_WAITORTIMERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DC11640)
#define SYSTEM_THREADING_WAITORTIMERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC11620)
