...
#define SYSTEM_THREADING_WAITORTIMERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3BAA70)
#define SYSTEM_THREADING_WAITORTIMERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3BAAF0)
#define SYSTEM_THREADING_WAITORTIMERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3BA480)
#define SYSTEM_THREADING_WAITORTIMERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BA470)
