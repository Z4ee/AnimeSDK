...
#define SYSTEM_THREADING_WAITHANDLECANNOTBEOPENEDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A73F870)
#define SYSTEM_THREADING_WAITHANDLECANNOTBEOPENEDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A73F8E0)
#define SYSTEM_THREADING_WAITHANDLECANNOTBEOPENEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A73F7D0)
