...
#define SYSTEM_THREADING_SENDORPOSTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7CF5C0)
#define SYSTEM_THREADING_SENDORPOSTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7CF5F0)
#define SYSTEM_THREADING_SENDORPOSTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7CF0C0)
#define SYSTEM_THREADING_SENDORPOSTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7CF0B0)

namespace System::Threading
{
	inline static constexpr unsigned int SendOrPostCallback_TypeDefinitionIndex = 826;
