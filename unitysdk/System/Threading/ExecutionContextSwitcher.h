...
#define SYSTEM_THREADING_EXECUTIONCONTEXTSWITCHER_UNDONOTHROW_OFFSET UNITYSDK_OFFSET(0x92C560)
#define SYSTEM_THREADING_EXECUTIONCONTEXTSWITCHER_UNDO_OFFSET UNITYSDK_OFFSET(0x92C620)

namespace System::Threading
{
	inline static constexpr unsigned int ExecutionContextSwitcher_TypeDefinitionIndex = 815;
