...
#define SYSTEM_THREADING_AUTORESETEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1622F2E0)

namespace System::Threading
{
	inline static constexpr unsigned int AutoResetEvent_TypeDefinitionIndex = 821;
