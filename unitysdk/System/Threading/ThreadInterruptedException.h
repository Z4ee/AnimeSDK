...
#define SYSTEM_THREADING_THREADINTERRUPTEDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0BFCE0)
#define SYSTEM_THREADING_THREADINTERRUPTEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BFBF0)

namespace System::Threading
{
	inline static constexpr unsigned int ThreadInterruptedException_TypeDefinitionIndex = 839;
