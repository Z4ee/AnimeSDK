...
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_LOCALFINDANDPOP_OFFSET UNITYSDK_OFFSET(0x1624F060)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_LOCALPOP_OFFSET UNITYSDK_OFFSET(0x1624F5E0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_LOCALPUSH_OFFSET UNITYSDK_OFFSET(0x1624E9B0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_TRYSTEAL_1_OFFSET UNITYSDK_OFFSET(0x162501E0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_TRYSTEAL_OFFSET UNITYSDK_OFFSET(0x1624FA80)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16250500)

namespace System::Threading
{
	inline static constexpr unsigned int ThreadPoolWorkQueue_WorkStealingQueue_TypeDefinitionIndex = 855;
