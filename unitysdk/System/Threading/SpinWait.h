...
#define SYSTEM_THREADING_SPINWAIT_GET_NEXTSPINWILLYIELD_OFFSET UNITYSDK_OFFSET(0x954400)
#define SYSTEM_THREADING_SPINWAIT_RESET_OFFSET UNITYSDK_OFFSET(0x3E1930)
#define SYSTEM_THREADING_SPINWAIT_SPINONCE_OFFSET UNITYSDK_OFFSET(0x954490)
#define SYSTEM_THREADING_SPINWAIT_SPINUNTIL_OFFSET UNITYSDK_OFFSET(0x1C1B7AD0)
