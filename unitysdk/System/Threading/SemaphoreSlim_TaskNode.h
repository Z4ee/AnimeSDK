...
#define SYSTEM_THREADING_SEMAPHORESLIM_TASKNODE_SYSTEM_THREADING_ITHREADPOOLWORKITEM_EXECUTEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1B8C02D0)
#define SYSTEM_THREADING_SEMAPHORESLIM_TASKNODE_SYSTEM_THREADING_ITHREADPOOLWORKITEM_MARKABORTED_OFFSET UNITYSDK_OFFSET(0x1B8C02E0)
#define SYSTEM_THREADING_SEMAPHORESLIM_TASKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C0230)

namespace System::Threading
{
	inline static constexpr unsigned int SemaphoreSlim_TaskNode_TypeDefinitionIndex = 796;
