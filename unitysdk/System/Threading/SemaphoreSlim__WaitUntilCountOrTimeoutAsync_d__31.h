...
#define SYSTEM_THREADING_SEMAPHORESLIM__WAITUNTILCOUNTORTIMEOUTASYNC_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x20CDC10)
#define SYSTEM_THREADING_SEMAPHORESLIM__WAITUNTILCOUNTORTIMEOUTASYNC_D__31_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x20CDC20)

namespace System::Threading
{
	inline static constexpr unsigned int SemaphoreSlim__WaitUntilCountOrTimeoutAsync_d__31_TypeDefinitionIndex = 807;

	struct alignas(8) SemaphoreSlim__WaitUntilCountOrTimeoutAsync_d__31
	{
		::System::Threading::CancellationToken cancellationToken; // 0x10
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Boolean> __u__2; // 0x18
		...
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Threading::Tasks::Task*> __u__1; // 0x48
		::System::Threading::SemaphoreSlim* __4__this; // 0x58
