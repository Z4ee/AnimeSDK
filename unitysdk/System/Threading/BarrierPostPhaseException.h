...
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193CD0C0)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193CCFF0)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x193CD180)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x193CD250)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x193CCF30)

namespace System::Threading
{
	inline static constexpr unsigned int BarrierPostPhaseException_TypeDefinitionIndex = 2708;
