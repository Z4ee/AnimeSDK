...
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17864F30)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17864F60)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_INVOKE_OFFSET UNITYSDK_OFFSET(0x178649E0)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x178649C0)

namespace System::Threading
{
	inline static constexpr unsigned int ParameterizedThreadStart_TypeDefinitionIndex = 835;
