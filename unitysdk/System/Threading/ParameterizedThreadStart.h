...
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16238730)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16238760)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_INVOKE_OFFSET UNITYSDK_OFFSET(0x162381E0)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x162381C0)

namespace System::Threading
{
	inline static constexpr unsigned int ParameterizedThreadStart_TypeDefinitionIndex = 833;
