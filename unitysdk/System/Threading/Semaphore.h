...
#define SYSTEM_THREADING_SEMAPHORE_CREATESEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D493D50)
#define SYSTEM_THREADING_SEMAPHORE_GETACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x1D494370)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTINGWORKER_OFFSET UNITYSDK_OFFSET(0x1D4940F0)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTING_1_OFFSET UNITYSDK_OFFSET(0x1D4940B0)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTING_OFFSET UNITYSDK_OFFSET(0x1D494070)
#define SYSTEM_THREADING_SEMAPHORE_OPENSEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D494460)
#define SYSTEM_THREADING_SEMAPHORE_RELEASESEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D494350)
#define SYSTEM_THREADING_SEMAPHORE_RELEASE_1_OFFSET UNITYSDK_OFFSET(0x1D494270)
#define SYSTEM_THREADING_SEMAPHORE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D494260)
#define SYSTEM_THREADING_SEMAPHORE_SETACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x1D4943E0)
#define SYSTEM_THREADING_SEMAPHORE_TRYOPENEXISTING_1_OFFSET UNITYSDK_OFFSET(0x1D494250)
#define SYSTEM_THREADING_SEMAPHORE_TRYOPENEXISTING_OFFSET UNITYSDK_OFFSET(0x1D494240)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D493AB0)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D493D60)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D493D80)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1D494020)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D493AA0)
