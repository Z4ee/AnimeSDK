...
#define SYSTEM_THREADING_CONTEXTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BB2CD0)
#define SYSTEM_THREADING_CONTEXTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BB2D00)
#define SYSTEM_THREADING_CONTEXTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BB27D0)
#define SYSTEM_THREADING_CONTEXTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB27C0)

namespace System::Threading
{
	inline static constexpr unsigned int ContextCallback_TypeDefinitionIndex = 814;
