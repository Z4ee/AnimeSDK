...
#define SYSTEM_THREADING_CONTEXTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3E2A10)
#define SYSTEM_THREADING_CONTEXTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B3E2A40)
#define SYSTEM_THREADING_CONTEXTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B3E2A00)
#define SYSTEM_THREADING_CONTEXTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E2910)

namespace System::Threading
{
	inline static constexpr unsigned int ContextCallback_TypeDefinitionIndex = 828;
