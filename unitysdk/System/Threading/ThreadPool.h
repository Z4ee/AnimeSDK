...
#define SYSTEM_THREADING_THREADPOOL_ENSUREVMINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1787A9F0)
#define SYSTEM_THREADING_THREADPOOL_GETMINTHREADSNATIVE_OFFSET UNITYSDK_OFFSET(0x1787A390)
#define SYSTEM_THREADING_THREADPOOL_GETMINTHREADS_OFFSET UNITYSDK_OFFSET(0x1787A350)
#define SYSTEM_THREADING_THREADPOOL_INITIALIZEVMTP_OFFSET UNITYSDK_OFFSET(0x1787ACC0)
#define SYSTEM_THREADING_THREADPOOL_ISTHREADPOOLHOSTED_OFFSET UNITYSDK_OFFSET(0x1787AE30)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1787ACD0)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMPROGRESSNATIVE_OFFSET UNITYSDK_OFFSET(0x1787ADA0)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMPROGRESS_OFFSET UNITYSDK_OFFSET(0x17878610)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEMHELPER_OFFSET UNITYSDK_OFFSET(0x1787A890)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEM_1_OFFSET UNITYSDK_OFFSET(0x1787A9D0)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEM_OFFSET UNITYSDK_OFFSET(0x1787A650)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1787A690)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1787A730)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x1787A3D0)
#define SYSTEM_THREADING_THREADPOOL_REPORTTHREADSTATUS_OFFSET UNITYSDK_OFFSET(0x1787AD90)
#define SYSTEM_THREADING_THREADPOOL_REQUESTWORKERTHREAD_OFFSET UNITYSDK_OFFSET(0x1787ACB0)
#define SYSTEM_THREADING_THREADPOOL_TRYPOPCUSTOMWORKITEM_OFFSET UNITYSDK_OFFSET(0x17878410)
#define SYSTEM_THREADING_THREADPOOL_UNSAFEQUEUECUSTOMWORKITEM_OFFSET UNITYSDK_OFFSET(0x178712B0)
#define SYSTEM_THREADING_THREADPOOL_UNSAFEQUEUEUSERWORKITEM_OFFSET UNITYSDK_OFFSET(0x1787A670)

namespace System::Threading
{
	inline static constexpr unsigned int ThreadPool_TypeDefinitionIndex = 862;
