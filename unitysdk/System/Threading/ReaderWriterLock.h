...
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C5099A0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_2_OFFSET UNITYSDK_OFFSET(0x1C50A0D0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1C504DB0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C509EC0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_2_OFFSET UNITYSDK_OFFSET(0x1C50A240)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1C504FB0)
#define SYSTEM_THREADING_READERWRITERLOCK_CHECKTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C50A190)
#define SYSTEM_THREADING_READERWRITERLOCK_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C509990)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1C504BD0)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1C504CE0)
#define SYSTEM_THREADING_READERWRITERLOCK_HASWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1C509E90)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C50A300)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1C504DC0)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C50A530)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1C504FC0)
#define SYSTEM_THREADING_READERWRITERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C503B50)
...
namespace System::Threading
{
	...
	public:
		...
		::System::Int32 seq_num; // 0x20
		::System::Int32 readers; // 0x24
		::System::Int32 state; // 0x28
		::System::Int32 writer_lock_owner; // 0x2C
