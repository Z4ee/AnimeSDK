...
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1A0BD890)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_2_OFFSET UNITYSDK_OFFSET(0x1A0BDFC0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B8C90)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1A0BDDB0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_2_OFFSET UNITYSDK_OFFSET(0x1A0BE130)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B8E90)
#define SYSTEM_THREADING_READERWRITERLOCK_CHECKTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A0BE080)
#define SYSTEM_THREADING_READERWRITERLOCK_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A0BD880)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1A0B8AB0)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1A0B8BC0)
#define SYSTEM_THREADING_READERWRITERLOCK_HASWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1A0BDD80)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1A0BE1F0)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B8CA0)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1A0BE420)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1A0B8EA0)
#define SYSTEM_THREADING_READERWRITERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B7A30)
...
namespace System::Threading
{
	...
	{
	public:
		::System::Threading::LockQueue* writer_queue; // 0x10
		::System::Collections::Hashtable* reader_locks; // 0x18
		::System::Int32 state; // 0x20
		::System::Int32 writer_lock_owner; // 0x24
		::System::Int32 readers; // 0x28
		::System::Int32 seq_num; // 0x2C
