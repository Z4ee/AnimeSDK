...
#define SYSTEM_THREADING_WAITCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D81FED0)
#define SYSTEM_THREADING_WAITCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D81FF00)
#define SYSTEM_THREADING_WAITCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D81F9B0)
#define SYSTEM_THREADING_WAITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D81F990)
