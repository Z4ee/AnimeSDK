...
#define SYSTEM_THREADING_WAITCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E21820)
#define SYSTEM_THREADING_WAITCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E21850)
#define SYSTEM_THREADING_WAITCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E21320)
#define SYSTEM_THREADING_WAITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E21310)
