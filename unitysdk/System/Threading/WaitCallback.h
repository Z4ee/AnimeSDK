...
#define SYSTEM_THREADING_WAITCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16252E30)
#define SYSTEM_THREADING_WAITCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16252E60)
#define SYSTEM_THREADING_WAITCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x162528E0)
#define SYSTEM_THREADING_WAITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1624DDD0)

namespace System::Threading
{
	inline static constexpr unsigned int WaitCallback_TypeDefinitionIndex = 850;
