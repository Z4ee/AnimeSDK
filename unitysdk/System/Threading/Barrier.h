...
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x1C7196B0)
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x1C7195D0)
#define SYSTEM_THREADING_BARRIER_DISCONTINUOUSWAIT_OFFSET UNITYSDK_OFFSET(0x1C71A940)
#define SYSTEM_THREADING_BARRIER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C71ADE0)
#define SYSTEM_THREADING_BARRIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C71AC30)
#define SYSTEM_THREADING_BARRIER_FINISHPHASE_OFFSET UNITYSDK_OFFSET(0x1C719E80)
#define SYSTEM_THREADING_BARRIER_GETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x1C719570)
#define SYSTEM_THREADING_BARRIER_GET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x1C7192A0)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C719290)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTSREMAINING_OFFSET UNITYSDK_OFFSET(0x1C719270)
#define SYSTEM_THREADING_BARRIER_INVOKEPOSTPHASEACTION_OFFSET UNITYSDK_OFFSET(0x1C71ABB0)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x1C719B60)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x1C719B50)
#define SYSTEM_THREADING_BARRIER_SETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x1C7195A0)
#define SYSTEM_THREADING_BARRIER_SETRESETEVENTS_OFFSET UNITYSDK_OFFSET(0x1C71AB40)
#define SYSTEM_THREADING_BARRIER_SET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x1C7192B0)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_1_OFFSET UNITYSDK_OFFSET(0x1C71A190)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_2_OFFSET UNITYSDK_OFFSET(0x1C71A830)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_3_OFFSET UNITYSDK_OFFSET(0x1C71A840)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_4_OFFSET UNITYSDK_OFFSET(0x1C71A930)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_5_OFFSET UNITYSDK_OFFSET(0x1C71A1A0)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_OFFSET UNITYSDK_OFFSET(0x1C71A180)
#define SYSTEM_THREADING_BARRIER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x1C719AE0)
#define SYSTEM_THREADING_BARRIER_WAITCURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x1C71AAA0)
#define SYSTEM_THREADING_BARRIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7192D0)
#define SYSTEM_THREADING_BARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7192C0)
...
namespace System::Threading
{
	...
	public:
		...
		::System::Threading::ManualResetEventSlim* m_oddEvent; // 0x20
		::System::Action_1<::System::Threading::Barrier*>* m_postPhaseAction; // 0x28
		...
		::System::Int64 m_currentPhase; // 0x40
