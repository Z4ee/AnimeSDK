...
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x18FCA760)
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x18FCA680)
#define SYSTEM_THREADING_BARRIER_DISCONTINUOUSWAIT_OFFSET UNITYSDK_OFFSET(0x18FCB980)
#define SYSTEM_THREADING_BARRIER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18FCBE10)
#define SYSTEM_THREADING_BARRIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FCBC60)
#define SYSTEM_THREADING_BARRIER_FINISHPHASE_OFFSET UNITYSDK_OFFSET(0x18FCAF20)
#define SYSTEM_THREADING_BARRIER_GETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x18FCA620)
#define SYSTEM_THREADING_BARRIER_GET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x18FCA350)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTCOUNT_OFFSET UNITYSDK_OFFSET(0x18FCA340)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTSREMAINING_OFFSET UNITYSDK_OFFSET(0x18FCA320)
#define SYSTEM_THREADING_BARRIER_INVOKEPOSTPHASEACTION_OFFSET UNITYSDK_OFFSET(0x18FCBBE0)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x18FCAC10)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x18FCAC00)
#define SYSTEM_THREADING_BARRIER_SETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x18FCA650)
#define SYSTEM_THREADING_BARRIER_SETRESETEVENTS_OFFSET UNITYSDK_OFFSET(0x18FCBB70)
#define SYSTEM_THREADING_BARRIER_SET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x18FCA360)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_1_OFFSET UNITYSDK_OFFSET(0x18FCB220)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_2_OFFSET UNITYSDK_OFFSET(0x18FCB870)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_3_OFFSET UNITYSDK_OFFSET(0x18FCB880)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_4_OFFSET UNITYSDK_OFFSET(0x18FCB970)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_5_OFFSET UNITYSDK_OFFSET(0x18FCB230)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_OFFSET UNITYSDK_OFFSET(0x18FCB210)
#define SYSTEM_THREADING_BARRIER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x18FCAB90)
#define SYSTEM_THREADING_BARRIER_WAITCURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x18FCBAD0)
#define SYSTEM_THREADING_BARRIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FCA380)
#define SYSTEM_THREADING_BARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCA370)

namespace System::Threading
{
	inline static constexpr unsigned int Barrier_TypeDefinitionIndex = 2709;
	...
	public:
		...
		::System::Threading::ManualResetEventSlim* m_evenEvent; // 0x10
		::System::Threading::ManualResetEventSlim* m_oddEvent; // 0x18
		::System::Action_1<::System::Threading::Barrier*>* m_postPhaseAction; // 0x20
		::System::Exception* m_exception; // 0x28
		::System::Threading::ExecutionContext* m_ownerThreadContext; // 0x30
		::System::Int32 m_actionCallerID; // 0x38
		::System::Boolean m_disposed; // 0x3C
		::System::Int32 m_currentTotalCount; // 0x40
		::System::Int64 m_currentPhase; // 0x48
