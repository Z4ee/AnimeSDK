...
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_GET_LOGGINGON_OFFSET UNITYSDK_OFFSET(0x1BC41C80)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACEOPERATIONCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1BC41CA0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACEOPERATIONCREATION_OFFSET UNITYSDK_OFFSET(0x1BC41C90)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACEOPERATIONRELATION_OFFSET UNITYSDK_OFFSET(0x1BC41CB0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACESYNCHRONOUSWORKCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1BC41CD0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACESYNCHRONOUSWORKSTART_OFFSET UNITYSDK_OFFSET(0x1BC41CC0)
