...
#define SYSTEM_THREADING_TASKS_PARALLEL_LOOPTIMER_LIMITEXCEEDED_OFFSET UNITYSDK_OFFSET(0x98F480)
#define SYSTEM_THREADING_TASKS_PARALLEL_LOOPTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x98F3B0)
