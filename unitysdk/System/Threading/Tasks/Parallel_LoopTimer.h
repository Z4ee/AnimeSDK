...
#define SYSTEM_THREADING_TASKS_PARALLEL_LOOPTIMER_LIMITEXCEEDED_OFFSET UNITYSDK_OFFSET(0x9DAFA0)
#define SYSTEM_THREADING_TASKS_PARALLEL_LOOPTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x9DAED0)
