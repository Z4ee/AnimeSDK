...
#define SYSTEM_THREADING_TASKS_PARALLEL_FOR_OFFSET UNITYSDK_OFFSET(0x1C1B8050)
#define SYSTEM_THREADING_TASKS_PARALLEL_THROWIFREDUCABLETOSINGLEOCE_OFFSET UNITYSDK_OFFSET(0x1C1B8140)
#define SYSTEM_THREADING_TASKS_PARALLEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1B8550)
