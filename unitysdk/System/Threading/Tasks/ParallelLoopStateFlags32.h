...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_GET_LOWESTBREAKITERATION_OFFSET UNITYSDK_OFFSET(0x1AC5DF10)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_SHOULDEXITLOOP_1_OFFSET UNITYSDK_OFFSET(0x1AC5DFF0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_SHOULDEXITLOOP_OFFSET UNITYSDK_OFFSET(0x1AC5DF20)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5E080)
