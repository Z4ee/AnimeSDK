...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_GET_LOWESTBREAKITERATION_OFFSET UNITYSDK_OFFSET(0x1D06B8C0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_SHOULDEXITLOOP_1_OFFSET UNITYSDK_OFFSET(0x1D06B9A0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_SHOULDEXITLOOP_OFFSET UNITYSDK_OFFSET(0x1D06B8D0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06BA30)
