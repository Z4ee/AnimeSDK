...
#define SYSTEM_THREADING_TASKS_TASK_SETONINVOKEMRES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9E41B0)
#define SYSTEM_THREADING_TASKS_TASK_SETONINVOKEMRES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E4070)

namespace System::Threading::Tasks
{
	inline static constexpr unsigned int Task_SetOnInvokeMres_TypeDefinitionIndex = 902;
