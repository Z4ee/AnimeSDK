...
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_HANDEDOVERCHILDREPLICA_OFFSET UNITYSDK_OFFSET(0x19E207E0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_SAVEDSTATEFORNEXTREPLICA_OFFSET UNITYSDK_OFFSET(0x19E207A0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_SAVEDSTATEFROMPREVIOUSREPLICA_OFFSET UNITYSDK_OFFSET(0x19E207C0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_HANDEDOVERCHILDREPLICA_OFFSET UNITYSDK_OFFSET(0x19E207F0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_SAVEDSTATEFORNEXTREPLICA_OFFSET UNITYSDK_OFFSET(0x19E207B0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_SAVEDSTATEFROMPREVIOUSREPLICA_OFFSET UNITYSDK_OFFSET(0x19E207D0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E20670)

namespace System::Threading::Tasks
{
	inline static constexpr unsigned int ParallelForReplicaTask_TypeDefinitionIndex = 910;

	class ParallelForReplicaTask : public ::System::Threading::Tasks::Task
	{
	public:
		::System::Object* m_stateFromPreviousReplica; // 0x48
		::System::Object* m_stateForNextReplica; // 0x50
		::System::Threading::Tasks::Task* m_handedOverChildReplica; // 0x58
