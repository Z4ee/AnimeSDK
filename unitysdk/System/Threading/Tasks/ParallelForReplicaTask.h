...
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_HANDEDOVERCHILDREPLICA_OFFSET UNITYSDK_OFFSET(0x1D81EE70)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_SAVEDSTATEFORNEXTREPLICA_OFFSET UNITYSDK_OFFSET(0x1D81EE30)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_SAVEDSTATEFROMPREVIOUSREPLICA_OFFSET UNITYSDK_OFFSET(0x1D81EE50)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_HANDEDOVERCHILDREPLICA_OFFSET UNITYSDK_OFFSET(0x1D81EE80)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_SAVEDSTATEFORNEXTREPLICA_OFFSET UNITYSDK_OFFSET(0x1D81EE40)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_SAVEDSTATEFROMPREVIOUSREPLICA_OFFSET UNITYSDK_OFFSET(0x1D81EE60)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D81ED00)
