...
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKCREATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BA2F880)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKFROMASYNCOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BA2FDA0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKMULTITASKCONTINUATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BA2F790)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_COMMONCWANYLOGIC_OFFSET UNITYSDK_OFFSET(0x1BA2FE90)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_1_OFFSET UNITYSDK_OFFSET(0x1BA2FD70)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_OFFSET UNITYSDK_OFFSET(0x1BA2FD40)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_GETDEFAULTSCHEDULER_OFFSET UNITYSDK_OFFSET(0x1BA2F5D0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_1_OFFSET UNITYSDK_OFFSET(0x1BA2FA30)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_2_OFFSET UNITYSDK_OFFSET(0x1BA2FBF0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_OFFSET UNITYSDK_OFFSET(0x1BA2F8F0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BA2F6F0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA2F690)
