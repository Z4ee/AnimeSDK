...
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKCREATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1CE94E90)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKFROMASYNCOPTIONS_OFFSET UNITYSDK_OFFSET(0x1CE953B0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKMULTITASKCONTINUATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1CE94DA0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_COMMONCWANYLOGIC_OFFSET UNITYSDK_OFFSET(0x1CE954A0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CE95380)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_OFFSET UNITYSDK_OFFSET(0x1CE95350)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_GETDEFAULTSCHEDULER_OFFSET UNITYSDK_OFFSET(0x1CE94BE0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_1_OFFSET UNITYSDK_OFFSET(0x1CE95040)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_2_OFFSET UNITYSDK_OFFSET(0x1CE95200)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_OFFSET UNITYSDK_OFFSET(0x1CE94F00)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CE94D00)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE94CA0)

namespace System::Threading::Tasks
{
	inline static constexpr unsigned int TaskFactory_TypeDefinitionIndex = 931;
