...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_1_OFFSET UNITYSDK_OFFSET(0x1D0BF5A0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D0BF530)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_CANCEL_OFFSET UNITYSDK_OFFSET(0x1D0BF6D0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_GET_LOOPSTATEFLAGS_OFFSET UNITYSDK_OFFSET(0x1D0BF520)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_SETEXCEPTIONAL_OFFSET UNITYSDK_OFFSET(0x1D0BF620)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D0BF7E0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BF780)
