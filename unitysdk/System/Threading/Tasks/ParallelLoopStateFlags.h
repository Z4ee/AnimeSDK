...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_1_OFFSET UNITYSDK_OFFSET(0x1E4518D0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E451860)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_CANCEL_OFFSET UNITYSDK_OFFSET(0x1E451A00)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_GET_LOOPSTATEFLAGS_OFFSET UNITYSDK_OFFSET(0x1E451850)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_SETEXCEPTIONAL_OFFSET UNITYSDK_OFFSET(0x1E451950)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E451B10)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E451AB0)
