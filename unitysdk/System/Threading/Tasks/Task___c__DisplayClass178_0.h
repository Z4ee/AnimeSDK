...
#define SYSTEM_THREADING_TASKS_TASK___C__DISPLAYCLASS178_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16242740)
#define SYSTEM_THREADING_TASKS_TASK___C__DISPLAYCLASS178_0__EXECUTESELFREPLICATING_B__0_OFFSET UNITYSDK_OFFSET(0x162485F0)

namespace System::Threading::Tasks
{
	inline static constexpr unsigned int Task___c__DisplayClass178_0_TypeDefinitionIndex = 899;
