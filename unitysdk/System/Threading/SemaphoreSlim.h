...
#define SYSTEM_THREADING_SEMAPHORESLIM_CANCELLATIONTOKENCANCELEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1B3EA450)
#define SYSTEM_THREADING_SEMAPHORESLIM_CHECKDISPOSE_OFFSET UNITYSDK_OFFSET(0x1B3E9500)
#define SYSTEM_THREADING_SEMAPHORESLIM_CREATEANDADDASYNCWAITER_OFFSET UNITYSDK_OFFSET(0x1B3E9C50)
#define SYSTEM_THREADING_SEMAPHORESLIM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B3EA400)
#define SYSTEM_THREADING_SEMAPHORESLIM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B3EA320)
#define SYSTEM_THREADING_SEMAPHORESLIM_GETRESOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1B3E8DF0)
#define SYSTEM_THREADING_SEMAPHORESLIM_GET_CURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B3E8CC0)
#define SYSTEM_THREADING_SEMAPHORESLIM_QUEUEWAITERTASK_OFFSET UNITYSDK_OFFSET(0x1B3EA310)
#define SYSTEM_THREADING_SEMAPHORESLIM_RELEASE_1_OFFSET UNITYSDK_OFFSET(0x1B3E9FB0)
#define SYSTEM_THREADING_SEMAPHORESLIM_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B3E9FA0)
#define SYSTEM_THREADING_SEMAPHORESLIM_REMOVEASYNCWAITER_OFFSET UNITYSDK_OFFSET(0x1B3E9F10)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B3E95F0)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITASYNC_OFFSET UNITYSDK_OFFSET(0x1B3E9C40)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITUNTILCOUNTORTIMEOUTASYNC_OFFSET UNITYSDK_OFFSET(0x1B3E9D00)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITUNTILCOUNTORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B3E9930)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAIT_1_OFFSET UNITYSDK_OFFSET(0x1B3E94F0)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAIT_2_OFFSET UNITYSDK_OFFSET(0x1B3E8E10)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAIT_OFFSET UNITYSDK_OFFSET(0x1B3E8E00)
#define SYSTEM_THREADING_SEMAPHORESLIM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3EA540)
#define SYSTEM_THREADING_SEMAPHORESLIM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B3E8CE0)
#define SYSTEM_THREADING_SEMAPHORESLIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E8CD0)
...
namespace System::Threading
{
	...
	public:
		...
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(SemaphoreSlim_TypeDefinitionIndex)->GetStaticField(0x14340);
		}
		static ::System::Threading::Tasks::Task_1<::System::Boolean>** StaticGet_s_trueTask()
		{
			return (::System::Threading::Tasks::Task_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(SemaphoreSlim_TypeDefinitionIndex)->GetStaticField(0x14348);
		}
		::System::Threading::ManualResetEvent* m_waitHandle; // 0x10
		::System::Threading::SemaphoreSlim_TaskNode* m_asyncHead; // 0x18
