...
#define SYSTEM_THREADING_MUTEX_CREATEMUTEX_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D068320)
#define SYSTEM_THREADING_MUTEX_RELEASEMUTEX_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D068300)
#define SYSTEM_THREADING_MUTEX_RELEASEMUTEX_OFFSET UNITYSDK_OFFSET(0x1D068480)
#define SYSTEM_THREADING_MUTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D068430)
#define SYSTEM_THREADING_MUTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D068330)
