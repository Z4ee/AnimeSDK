...
#define SYSTEM_THREADING_LOCKQUEUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1ADD54A0)
#define SYSTEM_THREADING_LOCKQUEUE_PULSE_OFFSET UNITYSDK_OFFSET(0x1ADD5550)
#define SYSTEM_THREADING_LOCKQUEUE_WAIT_OFFSET UNITYSDK_OFFSET(0x1ADD5270)
#define SYSTEM_THREADING_LOCKQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD5260)
