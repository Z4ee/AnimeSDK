...
#define SYSTEM_THREADING_LOCKQUEUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1C6EE7B0)
#define SYSTEM_THREADING_LOCKQUEUE_PULSE_OFFSET UNITYSDK_OFFSET(0x1C6EE860)
#define SYSTEM_THREADING_LOCKQUEUE_WAIT_OFFSET UNITYSDK_OFFSET(0x1C6EE580)
#define SYSTEM_THREADING_LOCKQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6EE570)
