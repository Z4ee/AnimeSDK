...
#define SYSTEM_THREADING_OSSPECIFICSYNCHRONIZATIONCONTEXT_INVOCATIONENTRYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B947480)
#define SYSTEM_THREADING_OSSPECIFICSYNCHRONIZATIONCONTEXT_INVOCATIONENTRYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9474D0)
#define SYSTEM_THREADING_OSSPECIFICSYNCHRONIZATIONCONTEXT_INVOCATIONENTRYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B947190)
#define SYSTEM_THREADING_OSSPECIFICSYNCHRONIZATIONCONTEXT_INVOCATIONENTRYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B947170)

namespace System::Threading
{
	inline static constexpr unsigned int OSSpecificSynchronizationContext_InvocationEntryDelegate_TypeDefinitionIndex = 830;
