...
#define SYSTEM_THREADING_TIMEOUTHELPER_GETTIME_OFFSET UNITYSDK_OFFSET(0x16250860)
#define SYSTEM_THREADING_TIMEOUTHELPER_UPDATETIMEOUT_OFFSET UNITYSDK_OFFSET(0x162508A0)

namespace System::Threading
{
	inline static constexpr unsigned int TimeoutHelper_TypeDefinitionIndex = 811;
