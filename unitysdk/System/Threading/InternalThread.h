...
#define SYSTEM_THREADING_INTERNALTHREAD_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19982D30)
#define SYSTEM_THREADING_INTERNALTHREAD_THREAD_FREE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19982C80)
#define SYSTEM_THREADING_INTERNALTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x19982E20)

namespace System::Threading
{
	inline static constexpr unsigned int InternalThread_TypeDefinitionIndex = 874;
