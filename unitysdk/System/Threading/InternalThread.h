...
#define SYSTEM_THREADING_INTERNALTHREAD_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C6EE470)
#define SYSTEM_THREADING_INTERNALTHREAD_THREAD_FREE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1C6EE3C0)
#define SYSTEM_THREADING_INTERNALTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6EE560)
