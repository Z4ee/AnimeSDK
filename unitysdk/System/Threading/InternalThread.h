...
#define SYSTEM_THREADING_INTERNALTHREAD_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BC3AE80)
#define SYSTEM_THREADING_INTERNALTHREAD_THREAD_FREE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1BC3ADD0)
#define SYSTEM_THREADING_INTERNALTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3AF70)

namespace System::Threading
{
	inline static constexpr unsigned int InternalThread_TypeDefinitionIndex = 878;
