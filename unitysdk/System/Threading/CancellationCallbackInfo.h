...
#define SYSTEM_THREADING_CANCELLATIONCALLBACKINFO_EXECUTECALLBACK_OFFSET UNITYSDK_OFFSET(0x18C88060)
#define SYSTEM_THREADING_CANCELLATIONCALLBACKINFO_EXECUTIONCONTEXTCALLBACK_OFFSET UNITYSDK_OFFSET(0x18C88190)
#define SYSTEM_THREADING_CANCELLATIONCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18C88040)

namespace System::Threading
{
	inline static constexpr unsigned int CancellationCallbackInfo_TypeDefinitionIndex = 788;
	...
	public:
		...
		::System::Threading::ExecutionContext* TargetExecutionContext; // 0x18
