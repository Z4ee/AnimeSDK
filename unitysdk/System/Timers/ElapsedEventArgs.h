...
#define SYSTEM_TIMERS_ELAPSEDEVENTARGS_GET_SIGNALTIME_OFFSET UNITYSDK_OFFSET(0x1C4AB6A0)
#define SYSTEM_TIMERS_ELAPSEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4AB6B0)
#define SYSTEM_TIMERS_ELAPSEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AB640)

namespace System::Timers
{
	inline static constexpr unsigned int ElapsedEventArgs_TypeDefinitionIndex = 2716;
