...
#define SYSTEM_INSUFFICIENTEXECUTIONSTACKEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0A8500)
#define SYSTEM_INSUFFICIENTEXECUTIONSTACKEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0A8590)
#define SYSTEM_INSUFFICIENTEXECUTIONSTACKEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A8440)
