...
#define SYSTEM_URIFORMATEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AFEDAE0)
#define SYSTEM_URIFORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFED970)
#define SYSTEM_URIFORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFEDA00)
#define SYSTEM_URIFORMATEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AFEDA90)
#define SYSTEM_URIFORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFED8B0)

namespace System
{
	inline static constexpr unsigned int UriFormatException_TypeDefinitionIndex = 2670;
