...
#define SYSTEM_NETTCPSTYLEURIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC88C0)

namespace System
{
	inline static constexpr unsigned int NetTcpStyleUriParser_TypeDefinitionIndex = 2687;
