...
#define SYSTEM_RUNTIMEFIELDHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x20DA950)
#define SYSTEM_RUNTIMEFIELDHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define SYSTEM_RUNTIMEFIELDHANDLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x20DA940)
#define SYSTEM_RUNTIMEFIELDHANDLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x5580)
#define SYSTEM_RUNTIMEFIELDHANDLE_SETVALUEDIRECT_OFFSET UNITYSDK_OFFSET(0x163F67C0)
#define SYSTEM_RUNTIMEFIELDHANDLE_SETVALUEINTERNAL_OFFSET UNITYSDK_OFFSET(0x163F67A0)
#define SYSTEM_RUNTIMEFIELDHANDLE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x163F67B0)
#define SYSTEM_RUNTIMEFIELDHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20DA930)
#define SYSTEM_RUNTIMEFIELDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD0)
