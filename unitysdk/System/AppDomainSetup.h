...
#define SYSTEM_APPDOMAINSETUP_GETAPPBASE_OFFSET UNITYSDK_OFFSET(0x18C4FE60)
#define SYSTEM_APPDOMAINSETUP_GET_APPLICATIONBASE_OFFSET UNITYSDK_OFFSET(0x18C504E0)
#define SYSTEM_APPDOMAINSETUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18C4E700)
#define SYSTEM_APPDOMAINSETUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4FE50)
