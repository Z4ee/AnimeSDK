...
#define SYSTEM_APPDOMAINSETUP_GETAPPBASE_OFFSET UNITYSDK_OFFSET(0x1AE3A3C0)
#define SYSTEM_APPDOMAINSETUP_GET_APPLICATIONBASE_OFFSET UNITYSDK_OFFSET(0x1AE3AA40)
#define SYSTEM_APPDOMAINSETUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE38C70)
#define SYSTEM_APPDOMAINSETUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3A3B0)
