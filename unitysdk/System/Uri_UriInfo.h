...
#define SYSTEM_URI_URIINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x167FA9D0)

namespace System
{
	inline static constexpr unsigned int Uri_UriInfo_TypeDefinitionIndex = 2456;
	...
	public:
		...
		::System::String* DnsSafeHost; // 0x20
