...
#define SYSTEM_URIPARSER_BUILTINURIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAD6650)

namespace System
{
	inline static constexpr unsigned int UriParser_BuiltInUriParser_TypeDefinitionIndex = 2689;
