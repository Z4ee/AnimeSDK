...
#define SYSTEM_URIPARSER_BUILTINURIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x16805CB0)

namespace System
{
	inline static constexpr unsigned int UriParser_BuiltInUriParser_TypeDefinitionIndex = 2472;
