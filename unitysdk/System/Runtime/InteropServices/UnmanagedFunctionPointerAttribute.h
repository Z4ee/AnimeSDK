...
#define SYSTEM_RUNTIME_INTEROPSERVICES_UNMANAGEDFUNCTIONPOINTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16395620)

namespace System::Runtime::InteropServices
{
	inline static constexpr unsigned int UnmanagedFunctionPointerAttribute_TypeDefinitionIndex = 1391;
	...
	public:
		...
		::System::Boolean ThrowOnUnmappableChar; // 0x18
		::System::Boolean SetLastError; // 0x19
