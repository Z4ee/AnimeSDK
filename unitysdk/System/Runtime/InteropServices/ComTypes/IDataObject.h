...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_DADVISE_OFFSET UNITYSDK_OFFSET(0x1B41F060)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_DUNADVISE_OFFSET UNITYSDK_OFFSET(0x1B41F130)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_ENUMDADVISE_OFFSET UNITYSDK_OFFSET(0x1B41F170)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_ENUMFORMATETC_OFFSET UNITYSDK_OFFSET(0x1B41F260)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_GETCANONICALFORMATETC_OFFSET UNITYSDK_OFFSET(0x1B41F330)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_GETDATAHERE_OFFSET UNITYSDK_OFFSET(0x1B41F470)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B41F380)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_QUERYGETDATA_OFFSET UNITYSDK_OFFSET(0x1B41F5C0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_SETDATA_OFFSET UNITYSDK_OFFSET(0x1B41F610)
