...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD2DAC0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_NEXT_OFFSET UNITYSDK_OFFSET(0x1DD2DBA0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_RESET_OFFSET UNITYSDK_OFFSET(0x1DD2DE40)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_SKIP_OFFSET UNITYSDK_OFFSET(0x1DD2DE80)
