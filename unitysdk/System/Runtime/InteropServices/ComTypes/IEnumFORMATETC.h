...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_CLONE_OFFSET UNITYSDK_OFFSET(0x1C8A7710)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_NEXT_OFFSET UNITYSDK_OFFSET(0x1C8A77F0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_RESET_OFFSET UNITYSDK_OFFSET(0x1C8A7A70)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_SKIP_OFFSET UNITYSDK_OFFSET(0x1C8A7AB0)

namespace System::Runtime::InteropServices::ComTypes
{
	inline static constexpr unsigned int IEnumFORMATETC_TypeDefinitionIndex = 3131;
