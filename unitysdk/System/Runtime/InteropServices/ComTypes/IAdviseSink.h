...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x19A73110)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONDATACHANGE_OFFSET UNITYSDK_OFFSET(0x19A73140)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONRENAME_OFFSET UNITYSDK_OFFSET(0x19A731E0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONSAVE_OFFSET UNITYSDK_OFFSET(0x19A73280)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x19A732B0)

namespace System::Runtime::InteropServices::ComTypes
{
	inline static constexpr unsigned int IAdviseSink_TypeDefinitionIndex = 3130;
