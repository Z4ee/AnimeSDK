...
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_ADD_OFFSET UNITYSDK_OFFSET(0x1E9814A0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E981460)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_INITIALTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1E981470)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_MAXIMUMTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1E981480)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E981490)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_REMOVE_OFFSET UNITYSDK_OFFSET(0x1E981850)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E981330)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E981320)
...
namespace System::Runtime::InteropServices
{
	...
	public:
		...
		::System::Int32 maximumThreshold; // 0x20
		::System::Int32 handleCount; // 0x24
		::System::Int32 initialThreshold; // 0x28
		::System::Int32 threshold; // 0x2C
		::System::Int32 gc_gen; // 0x30
