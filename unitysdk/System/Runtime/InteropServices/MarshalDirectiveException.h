...
#define SYSTEM_RUNTIME_INTEROPSERVICES_MARSHALDIRECTIVEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16394B20)
#define SYSTEM_RUNTIME_INTEROPSERVICES_MARSHALDIRECTIVEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16394B90)
#define SYSTEM_RUNTIME_INTEROPSERVICES_MARSHALDIRECTIVEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16394A80)

namespace System::Runtime::InteropServices
{
	inline static constexpr unsigned int MarshalDirectiveException_TypeDefinitionIndex = 1421;
