...
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_ADD_OFFSET UNITYSDK_OFFSET(0x18336F50)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_ENLARGEARRAY_OFFSET UNITYSDK_OFFSET(0x18337020)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x183370A0)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18337130)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x183370C0)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_REMOVEELEMENT_OFFSET UNITYSDK_OFFSET(0x18337160)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_STARTENUMERATION_OFFSET UNITYSDK_OFFSET(0x183370B0)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18336F20)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18336EF0)

namespace System::Runtime::Serialization
{
	inline static constexpr unsigned int LongList_TypeDefinitionIndex = 1106;
