...
#define SYSTEM_RUNTIME_SERIALIZATION_FIXUPHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1790FBB0)

namespace System::Runtime::Serialization
{
	inline static constexpr unsigned int FixupHolder_TypeDefinitionIndex = 1104;
