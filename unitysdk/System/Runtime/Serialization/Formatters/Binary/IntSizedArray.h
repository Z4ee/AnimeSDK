...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTSIZEDARRAY_CLONE_OFFSET UNITYSDK_OFFSET(0x163D2CB0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTSIZEDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x163D2D00)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTSIZEDARRAY_INCREASECAPACITY_OFFSET UNITYSDK_OFFSET(0x163D2E20)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTSIZEDARRAY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x163D2D70)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTSIZEDARRAY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x163D2BF0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTSIZEDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x163D2BB0)

namespace System::Runtime::Serialization::Formatters::Binary
{
	inline static constexpr unsigned int IntSizedArray_TypeDefinitionIndex = 1185;

	class IntSizedArray : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Int32>* objects; // 0x10
		::Il2CppArray<::System::Int32>* negObjects; // 0x18
