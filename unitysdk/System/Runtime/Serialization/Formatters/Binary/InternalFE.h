...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTERNALFE__CTOR_OFFSET UNITYSDK_OFFSET(0x163CE250)

namespace System::Runtime::Serialization::Formatters::Binary
{
	inline static constexpr unsigned int InternalFE_TypeDefinitionIndex = 1188;
	...
	public:
		...
		::System::Runtime::Serialization::Formatters::FormatterTypeStyle FEtypeFormat; // 0x18
