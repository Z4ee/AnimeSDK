...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_INTERNALFE__CTOR_OFFSET UNITYSDK_OFFSET(0x17917180)

namespace System::Runtime::Serialization::Formatters::Binary
{
	inline static constexpr unsigned int InternalFE_TypeDefinitionIndex = 1191;
