...
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C075200)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C075220)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C075320)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0751F0)

namespace System::Runtime::CompilerServices
{
	inline static constexpr unsigned int RuntimeOps_RuntimeVariables_TypeDefinitionIndex = 4952;
