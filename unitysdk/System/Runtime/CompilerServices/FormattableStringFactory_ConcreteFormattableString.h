...
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GETARGUMENTS_OFFSET UNITYSDK_OFFSET(0x193DB560)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x193DB590)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x193DB570)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x193DB550)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193DB5D0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x193DB540)

namespace System::Runtime::CompilerServices
{
	inline static constexpr unsigned int FormattableStringFactory_ConcreteFormattableString_TypeDefinitionIndex = 1386;
