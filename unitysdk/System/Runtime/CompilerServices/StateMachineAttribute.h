...
#define SYSTEM_RUNTIME_COMPILERSERVICES_STATEMACHINEATTRIBUTE_SET_STATEMACHINETYPE_OFFSET UNITYSDK_OFFSET(0x18770020)
#define SYSTEM_RUNTIME_COMPILERSERVICES_STATEMACHINEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1876F150)

namespace System::Runtime::CompilerServices
{
	inline static constexpr unsigned int StateMachineAttribute_TypeDefinitionIndex = 1358;
