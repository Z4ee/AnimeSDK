...
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_COPYBLOCKUNALIGNED_OFFSET UNITYSDK_OFFSET(0x1C561240)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_COPYBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C561230)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_COPYBLOCK_OFFSET UNITYSDK_OFFSET(0x1C561220)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCKUNALIGNED_1_OFFSET UNITYSDK_OFFSET(0x1C561280)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCKUNALIGNED_OFFSET UNITYSDK_OFFSET(0x1C561270)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C561260)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1C561250)
