...
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6C0180)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_GETOBJECTVALUE_OFFSET UNITYSDK_OFFSET(0x1A6C0190)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_GET_OFFSETTOSTRINGDATA_OFFSET UNITYSDK_OFFSET(0x1A6B9A70)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_INITIALIZEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1A6C0110)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_INITIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1A6C0100)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_RUNCLASSCONSTRUCTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6C0290)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_RUNCLASSCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A6C0250)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_SUFFICIENTEXECUTIONSTACK_OFFSET UNITYSDK_OFFSET(0x1A6C0310)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEHELPERS_TRYENSURESUFFICIENTEXECUTIONSTACK_OFFSET UNITYSDK_OFFSET(0x1A6C0320)

namespace System::Runtime::CompilerServices
{
	inline static constexpr unsigned int RuntimeHelpers_TypeDefinitionIndex = 1410;
