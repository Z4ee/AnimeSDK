...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CALLCONTEXTSECURITYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x163AB9F0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CALLCONTEXTSECURITYDATA_GET_HASINFO_OFFSET UNITYSDK_OFFSET(0x163AB9E0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CALLCONTEXTSECURITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x163ABA50)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int CallContextSecurityData_TypeDefinitionIndex = 1284;
