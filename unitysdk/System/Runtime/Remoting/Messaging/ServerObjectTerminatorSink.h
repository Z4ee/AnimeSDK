...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_SERVEROBJECTTERMINATORSINK_ASYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x187955C0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_SERVEROBJECTTERMINATORSINK_SYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x187953C0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_SERVEROBJECTTERMINATORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x187953B0)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int ServerObjectTerminatorSink_TypeDefinitionIndex = 1326;
