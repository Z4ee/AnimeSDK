...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_SERVERCONTEXTTERMINATORSINK_ASYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x1BDEAC30)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_SERVERCONTEXTTERMINATORSINK_SYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x1BDEAAC0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_SERVERCONTEXTTERMINATORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDEAD70)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int ServerContextTerminatorSink_TypeDefinitionIndex = 1334;
