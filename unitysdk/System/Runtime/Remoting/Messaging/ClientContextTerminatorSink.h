...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CLIENTCONTEXTTERMINATORSINK_ASYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x1BDDBAA0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CLIENTCONTEXTTERMINATORSINK_SYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x1BDDB830)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CLIENTCONTEXTTERMINATORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDDB820)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int ClientContextTerminatorSink_TypeDefinitionIndex = 1305;
