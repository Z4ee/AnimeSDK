...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CLIENTCONTEXTTERMINATORSINK_ASYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x178EB820)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CLIENTCONTEXTTERMINATORSINK_SYNCPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x178EB5B0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CLIENTCONTEXTTERMINATORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x178EB5A0)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int ClientContextTerminatorSink_TypeDefinitionIndex = 1298;
