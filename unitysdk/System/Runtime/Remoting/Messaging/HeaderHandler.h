...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_HEADERHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDDF4E0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_HEADERHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDDF510)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_HEADERHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDDF4D0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_HEADERHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDDF3E0)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int HeaderHandler_TypeDefinitionIndex = 1313;
