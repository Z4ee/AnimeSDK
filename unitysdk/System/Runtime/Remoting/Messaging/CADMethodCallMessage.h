...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODCALLMESSAGE_CREATE_OFFSET UNITYSDK_OFFSET(0x1BDD9CB0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODCALLMESSAGE_GETARGS_OFFSET UNITYSDK_OFFSET(0x1BDDA220)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODCALLMESSAGE_GETARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BDDA150)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODCALLMESSAGE_GET_PROPERTIESCOUNT_OFFSET UNITYSDK_OFFSET(0x1BDDA230)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODCALLMESSAGE_GET_URI_OFFSET UNITYSDK_OFFSET(0x1BDD9CA0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODCALLMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDD9D20)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int CADMethodCallMessage_TypeDefinitionIndex = 1303;
