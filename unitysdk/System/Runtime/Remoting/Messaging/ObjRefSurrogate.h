...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_OBJREFSURROGATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x178F9490)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_OBJREFSURROGATE_SETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x178F9630)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_OBJREFSURROGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9680)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int ObjRefSurrogate_TypeDefinitionIndex = 1324;
