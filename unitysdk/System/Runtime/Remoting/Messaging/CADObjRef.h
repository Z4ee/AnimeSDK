...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADOBJREF__CTOR_OFFSET UNITYSDK_OFFSET(0x163A9450)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int CADObjRef_TypeDefinitionIndex = 1290;

	class CADObjRef : public ::System::Object
	{
	public:
		::System::Runtime::Remoting::ObjRef* objref; // 0x10
		::Il2CppArray<::System::Byte>* TypeInfo; // 0x18
