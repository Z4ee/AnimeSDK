...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE_CREATE_OFFSET UNITYSDK_OFFSET(0x179D7590)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE_GETARGS_OFFSET UNITYSDK_OFFSET(0x179D7BB0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE_GETARGUMENTS_OFFSET UNITYSDK_OFFSET(0x179D7AE0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x179D7BD0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE_GETRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x179D7BC0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE_GET_PROPERTIESCOUNT_OFFSET UNITYSDK_OFFSET(0x179D7C50)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_CADMETHODRETURNMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x179D7600)

namespace System::Runtime::Remoting::Messaging
{
	inline static constexpr unsigned int CADMethodReturnMessage_TypeDefinitionIndex = 1296;
