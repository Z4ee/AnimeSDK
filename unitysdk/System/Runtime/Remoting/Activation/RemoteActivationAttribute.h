...
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_GETPROPERTIESFORNEWCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C6D8840)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_ISCONTEXTOK_OFFSET UNITYSDK_OFFSET(0x1C6D8830)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6D8820)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6D8810)

namespace System::Runtime::Remoting::Activation
{
	inline static constexpr unsigned int RemoteActivationAttribute_TypeDefinitionIndex = 1316;
