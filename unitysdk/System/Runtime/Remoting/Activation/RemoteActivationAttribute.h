...
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_GETPROPERTIESFORNEWCONTEXT_OFFSET UNITYSDK_OFFSET(0x1ADBF3C0)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_ISCONTEXTOK_OFFSET UNITYSDK_OFFSET(0x1ADBF3B0)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ADBF3A0)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBF390)
