...
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY_ASYNCOBJECTPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x163C6B30)
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY_GETSERVEROBJECT_OFFSET UNITYSDK_OFFSET(0x163C6820)
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY_SYNCOBJECTPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x163C6A20)
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x163C5A40)

namespace System::Runtime::Remoting
{
	inline static constexpr unsigned int SingletonIdentity_TypeDefinitionIndex = 1212;
