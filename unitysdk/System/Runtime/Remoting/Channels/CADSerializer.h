...
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_DESERIALIZEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1DDE2410)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_DESERIALIZEOBJECTSAFE_OFFSET UNITYSDK_OFFSET(0x1DDE2600)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_DESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DDE2680)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_SERIALIZEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1DDE2460)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DDE2730)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDE2890)

namespace System::Runtime::Remoting::Channels
{
	inline static constexpr unsigned int CADSerializer_TypeDefinitionIndex = 1299;
