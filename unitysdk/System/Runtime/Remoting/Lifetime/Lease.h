...
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1BA264D0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_CHECKNEXTSPONSOR_OFFSET UNITYSDK_OFFSET(0x1BA26B60)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_GET_CURRENTLEASETIME_OFFSET UNITYSDK_OFFSET(0x1BA26470)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x1BA264C0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_GET_RENEWONCALLTIME_OFFSET UNITYSDK_OFFSET(0x1BA26670)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_PROCESSSPONSORRESPONSE_OFFSET UNITYSDK_OFFSET(0x1BA26E10)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEW_OFFSET UNITYSDK_OFFSET(0x1BA267C0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_SET_INITIALLEASETIME_OFFSET UNITYSDK_OFFSET(0x1BA264E0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_SET_RENEWONCALLTIME_OFFSET UNITYSDK_OFFSET(0x1BA26680)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_SET_SPONSORSHIPTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1BA26720)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1BA268D0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x1BA26A10)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA26310)

namespace System::Runtime::Remoting::Lifetime
{
	inline static constexpr unsigned int Lease_TypeDefinitionIndex = 1275;
	...
	public:
		...
		::System::TimeSpan _initialLeaseTime; // 0x48
