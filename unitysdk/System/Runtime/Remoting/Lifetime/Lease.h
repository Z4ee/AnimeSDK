...
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1CE8BB70)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_CHECKNEXTSPONSOR_OFFSET UNITYSDK_OFFSET(0x1CE8C200)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_GET_CURRENTLEASETIME_OFFSET UNITYSDK_OFFSET(0x1CE8BB10)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x1CE8BB60)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_GET_RENEWONCALLTIME_OFFSET UNITYSDK_OFFSET(0x1CE8BD10)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_PROCESSSPONSORRESPONSE_OFFSET UNITYSDK_OFFSET(0x1CE8C4B0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEW_OFFSET UNITYSDK_OFFSET(0x1CE8BE60)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_SET_INITIALLEASETIME_OFFSET UNITYSDK_OFFSET(0x1CE8BB80)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_SET_RENEWONCALLTIME_OFFSET UNITYSDK_OFFSET(0x1CE8BD20)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_SET_SPONSORSHIPTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1CE8BDC0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1CE8BF70)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x1CE8C0B0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8B9B0)
...
namespace System::Runtime::Remoting::Lifetime
{
	...
	public:
		...
		::System::DateTime _leaseExpireTime; // 0x50
