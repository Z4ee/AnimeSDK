...
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6C1270)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6C12A0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6C0D30)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C0D20)

namespace System::Runtime::Remoting::Lifetime
{
	inline static constexpr unsigned int Lease_RenewalDelegate_TypeDefinitionIndex = 1277;
