...
#define SYSTEM_RUNTIME_REMOTING_CONTEXTS_CROSSCONTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187817C0)
#define SYSTEM_RUNTIME_REMOTING_CONTEXTS_CROSSCONTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187817F0)
#define SYSTEM_RUNTIME_REMOTING_CONTEXTS_CROSSCONTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x187817B0)
#define SYSTEM_RUNTIME_REMOTING_CONTEXTS_CROSSCONTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18781740)

namespace System::Runtime::Remoting::Contexts
{
	inline static constexpr unsigned int CrossContextDelegate_TypeDefinitionIndex = 1243;
