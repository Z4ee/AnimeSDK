...
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES_GETCACHEDSOAPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1E1241E0)
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E124680)
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1241D0)
