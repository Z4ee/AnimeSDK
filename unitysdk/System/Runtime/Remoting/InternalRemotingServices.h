...
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES_GETCACHEDSOAPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A981DC0)
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A982250)
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A981DB0)
