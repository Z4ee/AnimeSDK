...
#define SYSTEM_RUNTIME_REMOTING_FORMATTERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D812F40)

namespace System::Runtime::Remoting
{
	inline static constexpr unsigned int FormatterData_TypeDefinitionIndex = 1252;
