...
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE56590)
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE56620)
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AE56670)
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE564D0)

namespace System::Runtime::Remoting
{
	inline static constexpr unsigned int RemotingException_TypeDefinitionIndex = 1253;
