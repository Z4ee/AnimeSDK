...
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BDDA3F0)
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BDF9830)
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BDF9880)
#define SYSTEM_RUNTIME_REMOTING_REMOTINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF9790)
