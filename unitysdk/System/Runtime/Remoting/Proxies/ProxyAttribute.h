...
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B8AFC10)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_CREATEPROXY_OFFSET UNITYSDK_OFFSET(0x1B8AFCF0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_GETPROPERTIESFORNEWCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B8AFD50)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_ISCONTEXTOK_OFFSET UNITYSDK_OFFSET(0x1B8AFD60)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8AFC00)
