...
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY_GETPROXYTYPE_OFFSET UNITYSDK_OFFSET(0x179048F0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY_GET_ISCONTEXTBOUNDOBJECT_OFFSET UNITYSDK_OFFSET(0x17904960)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY_GET_TARGETCONTEXT_OFFSET UNITYSDK_OFFSET(0x17904A50)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY_INCURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x17904A70)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY_LOADREMOTEFIELDNEW_OFFSET UNITYSDK_OFFSET(0x17904AD0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY_STOREREMOTEFIELD_OFFSET UNITYSDK_OFFSET(0x17904FB0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_TRANSPARENTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x179054C0)

namespace System::Runtime::Remoting::Proxies
{
	inline static constexpr unsigned int TransparentProxy_TypeDefinitionIndex = 1228;
