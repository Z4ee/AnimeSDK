...
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_GET_XMLELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1944C6F0)
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_ISINTEROPXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x1944C700)
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_SETREFLECTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1944C710)
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19430D30)

namespace System::Runtime::Remoting::Metadata
{
	inline static constexpr unsigned int SoapFieldAttribute_TypeDefinitionIndex = 1286;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_SETREFLECTIONOBJECT_OFFSET))(this, a1);
		}
	};
}
