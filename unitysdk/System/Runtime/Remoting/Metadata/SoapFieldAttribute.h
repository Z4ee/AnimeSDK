...
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_GET_XMLELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x179E6DE0)
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_ISINTEROPXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x179E6DF0)
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE_SETREFLECTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x179E6E00)
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x179E6DD0)

namespace System::Runtime::Remoting::Metadata
{
	inline static constexpr unsigned int SoapFieldAttribute_TypeDefinitionIndex = 1278;
