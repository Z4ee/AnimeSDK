...
#define SYSTEM_RUNTIME_REMOTING_METADATA_SOAPPARAMETERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD4EFA0)

namespace System::Runtime::Remoting::Metadata
{
	inline static constexpr unsigned int SoapParameterAttribute_TypeDefinitionIndex = 1321;
