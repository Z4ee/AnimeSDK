...
#define SYSTEM_RUNTIME_REMOTING_PROVIDERDATA_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1944E7D0)
#define SYSTEM_RUNTIME_REMOTING_PROVIDERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1944F4C0)
...
namespace System::Runtime::Remoting
{
	...
	{
	public:
		::System::Collections::Hashtable* CustomProperties; // 0x10
