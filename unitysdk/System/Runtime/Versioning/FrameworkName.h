...
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E29B8E0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E29B790)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E29B9D0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1E29B490)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1E29B460)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_PROFILE_OFFSET UNITYSDK_OFFSET(0x1E29B480)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1E29B470)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E29C3D0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E29C4D0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E29BB30)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E29BB50)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E29BDC0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E29BB40)
...
namespace System::Runtime::Versioning
{
	...
	public:
		...
		::System::String* m_identifier; // 0x10
		::System::String* m_fullName; // 0x18
