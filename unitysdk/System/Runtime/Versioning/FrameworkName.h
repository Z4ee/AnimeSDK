...
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AAAD620)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AAAD4D0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AAAD710)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1AAAD1C0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AAAD190)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_PROFILE_OFFSET UNITYSDK_OFFSET(0x1AAAD1B0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AAAD1A0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AAAE110)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AAAE210)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AAAD870)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAAD890)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AAADB00)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAAD880)

namespace System::Runtime::Versioning
{
	inline static constexpr unsigned int FrameworkName_TypeDefinitionIndex = 3123;
	...
	public:
		...
		::System::String* m_identifier; // 0x18
		::System::String* m_profile; // 0x20
