...
#define SYSTEM_RUNTIME_VERSIONING_BINARYCOMPATIBILITY_GET_TARGETSATLEAST_DESKTOP_V4_5_2_OFFSET UNITYSDK_OFFSET(0x1E44F840)
#define SYSTEM_RUNTIME_VERSIONING_BINARYCOMPATIBILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E44F850)

namespace System::Runtime::Versioning
{
	inline static constexpr unsigned int BinaryCompatibility_TypeDefinitionIndex = 1132;
