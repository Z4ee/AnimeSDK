...
#define SYSTEM_CONSOLECANCELEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19D200)
#define SYSTEM_CONSOLECANCELEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19D240)
#define SYSTEM_CONSOLECANCELEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19CC80)
#define SYSTEM_CONSOLECANCELEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19CC60)
