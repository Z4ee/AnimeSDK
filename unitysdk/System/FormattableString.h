...
#define SYSTEM_FORMATTABLESTRING_SYSTEM_IFORMATTABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7B8470)
#define SYSTEM_FORMATTABLESTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7B84A0)
#define SYSTEM_FORMATTABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7B84D0)
