...
#define SYSTEM_FORMATTABLESTRING_SYSTEM_IFORMATTABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CB18960)
#define SYSTEM_FORMATTABLESTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CB18990)
#define SYSTEM_FORMATTABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB189C0)
