...
#define SYSTEM_IO_RENAMEDEVENTARGS_GET_OLDFULLPATH_OFFSET UNITYSDK_OFFSET(0x1A323700)
#define SYSTEM_IO_RENAMEDEVENTARGS_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x1A323710)
#define SYSTEM_IO_RENAMEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A323670)

namespace System::IO
{
	inline static constexpr unsigned int RenamedEventArgs_TypeDefinitionIndex = 3233;
