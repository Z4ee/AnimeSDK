...
#define SYSTEM_IO_PORTS_SERIALDATARECEIVEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC124C0)
#define SYSTEM_IO_PORTS_SERIALDATARECEIVEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC12500)
#define SYSTEM_IO_PORTS_SERIALDATARECEIVEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC12480)
#define SYSTEM_IO_PORTS_SERIALDATARECEIVEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC12440)

namespace System::IO::Ports
{
	inline static constexpr unsigned int SerialDataReceivedEventHandler_TypeDefinitionIndex = 4156;
