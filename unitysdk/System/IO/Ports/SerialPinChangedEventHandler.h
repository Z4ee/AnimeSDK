...
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AE7650)
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AE7690)
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AE7610)
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE75D0)

namespace System::IO::Ports
{
	inline static constexpr unsigned int SerialPinChangedEventHandler_TypeDefinitionIndex = 4163;
