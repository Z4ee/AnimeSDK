...
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_ENDOFFILE_OFFSET UNITYSDK_OFFSET(0x1B1C0B60)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_ENDREADCALLEDTWICE_OFFSET UNITYSDK_OFFSET(0x1B1C0D70)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_ENDWRITECALLEDTWICE_OFFSET UNITYSDK_OFFSET(0x1B1C0DD0)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_FILENOTOPEN_OFFSET UNITYSDK_OFFSET(0x1B1C0CB0)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B1C0BC0)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_MAKEHRFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x1B1C1120)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_WINIOERROR_OFFSET UNITYSDK_OFFSET(0x1B1C0E30)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_WRONGASYNCRESULT_OFFSET UNITYSDK_OFFSET(0x1B1C0D10)
