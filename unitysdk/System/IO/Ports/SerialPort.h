...
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_DATARECEIVED_OFFSET UNITYSDK_OFFSET(0x1B75EF10)
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_ERRORRECEIVED_OFFSET UNITYSDK_OFFSET(0x1B75EF90)
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_PINCHANGED_OFFSET UNITYSDK_OFFSET(0x1B75F010)
#define SYSTEM_IO_PORTS_SERIALPORT_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B75F090)
#define SYSTEM_IO_PORTS_SERIALPORT_DISCARDINBUFFER_OFFSET UNITYSDK_OFFSET(0x1B75F0D0)
#define SYSTEM_IO_PORTS_SERIALPORT_DISCARDOUTBUFFER_OFFSET UNITYSDK_OFFSET(0x1B75F110)
#define SYSTEM_IO_PORTS_SERIALPORT_GETPORTNAMES_OFFSET UNITYSDK_OFFSET(0x1B75F150)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x1B75E450)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BAUDRATE_OFFSET UNITYSDK_OFFSET(0x1B75E490)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BREAKSTATE_OFFSET UNITYSDK_OFFSET(0x1B75E510)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BYTESTOREAD_OFFSET UNITYSDK_OFFSET(0x1B75E590)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BYTESTOWRITE_OFFSET UNITYSDK_OFFSET(0x1B75E5D0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_CDHOLDING_OFFSET UNITYSDK_OFFSET(0x1B75E610)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_CTSHOLDING_OFFSET UNITYSDK_OFFSET(0x1B75E650)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DATABITS_OFFSET UNITYSDK_OFFSET(0x1B75E690)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DISCARDNULL_OFFSET UNITYSDK_OFFSET(0x1B75E710)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DSRHOLDING_OFFSET UNITYSDK_OFFSET(0x1B75E790)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DTRENABLE_OFFSET UNITYSDK_OFFSET(0x1B75E7D0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x1B75E850)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_HANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1B75E8D0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1B75E950)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1B75E990)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PARITYREPLACE_OFFSET UNITYSDK_OFFSET(0x1B75EA90)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PARITY_OFFSET UNITYSDK_OFFSET(0x1B75EA10)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1B75EB10)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_READBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B75EB90)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B75EC10)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_RECEIVEDBYTESTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B75EC90)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_RTSENABLE_OFFSET UNITYSDK_OFFSET(0x1B75ED10)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_STOPBITS_OFFSET UNITYSDK_OFFSET(0x1B75ED90)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_WRITEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B75EE10)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B75EE90)
#define SYSTEM_IO_PORTS_SERIALPORT_OPEN_OFFSET UNITYSDK_OFFSET(0x1B75F190)
#define SYSTEM_IO_PORTS_SERIALPORT_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B75F250)
#define SYSTEM_IO_PORTS_SERIALPORT_READCHAR_OFFSET UNITYSDK_OFFSET(0x1B75F290)
#define SYSTEM_IO_PORTS_SERIALPORT_READEXISTING_OFFSET UNITYSDK_OFFSET(0x1B75F2D0)
#define SYSTEM_IO_PORTS_SERIALPORT_READLINE_OFFSET UNITYSDK_OFFSET(0x1B75F310)
#define SYSTEM_IO_PORTS_SERIALPORT_READTO_OFFSET UNITYSDK_OFFSET(0x1B75F350)
#define SYSTEM_IO_PORTS_SERIALPORT_READ_1_OFFSET UNITYSDK_OFFSET(0x1B75F210)
#define SYSTEM_IO_PORTS_SERIALPORT_READ_OFFSET UNITYSDK_OFFSET(0x1B75F1D0)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_DATARECEIVED_OFFSET UNITYSDK_OFFSET(0x1B75EF50)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_ERRORRECEIVED_OFFSET UNITYSDK_OFFSET(0x1B75EFD0)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_PINCHANGED_OFFSET UNITYSDK_OFFSET(0x1B75F050)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_BAUDRATE_OFFSET UNITYSDK_OFFSET(0x1B75E4D0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_BREAKSTATE_OFFSET UNITYSDK_OFFSET(0x1B75E550)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DATABITS_OFFSET UNITYSDK_OFFSET(0x1B75E6D0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DISCARDNULL_OFFSET UNITYSDK_OFFSET(0x1B75E750)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DTRENABLE_OFFSET UNITYSDK_OFFSET(0x1B75E810)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_ENCODING_OFFSET UNITYSDK_OFFSET(0x1B75E890)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_HANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1B75E910)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1B75E9D0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PARITYREPLACE_OFFSET UNITYSDK_OFFSET(0x1B75EAD0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PARITY_OFFSET UNITYSDK_OFFSET(0x1B75EA50)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1B75EB50)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_READBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B75EBD0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B75EC50)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_RECEIVEDBYTESTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B75ECD0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_RTSENABLE_OFFSET UNITYSDK_OFFSET(0x1B75ED50)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_STOPBITS_OFFSET UNITYSDK_OFFSET(0x1B75EDD0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_WRITEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B75EE50)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B75EED0)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1B75F450)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1B75F3D0)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1B75F410)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_OFFSET UNITYSDK_OFFSET(0x1B75F390)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B75E2D0)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B75E310)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B75E350)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B75E390)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B75E3D0)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B75E410)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75E290)

namespace System::IO::Ports
{
	inline static constexpr unsigned int SerialPort_TypeDefinitionIndex = 4163;
