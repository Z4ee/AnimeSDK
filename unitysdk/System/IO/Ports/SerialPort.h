...
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_DATARECEIVED_OFFSET UNITYSDK_OFFSET(0x1CC131C0)
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_ERRORRECEIVED_OFFSET UNITYSDK_OFFSET(0x1CC13240)
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_PINCHANGED_OFFSET UNITYSDK_OFFSET(0x1CC132C0)
#define SYSTEM_IO_PORTS_SERIALPORT_CLOSE_OFFSET UNITYSDK_OFFSET(0x1CC13340)
#define SYSTEM_IO_PORTS_SERIALPORT_DISCARDINBUFFER_OFFSET UNITYSDK_OFFSET(0x1CC13380)
#define SYSTEM_IO_PORTS_SERIALPORT_DISCARDOUTBUFFER_OFFSET UNITYSDK_OFFSET(0x1CC133C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GETPORTNAMES_OFFSET UNITYSDK_OFFSET(0x1CC13400)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x1CC12700)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BAUDRATE_OFFSET UNITYSDK_OFFSET(0x1CC12740)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BREAKSTATE_OFFSET UNITYSDK_OFFSET(0x1CC127C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BYTESTOREAD_OFFSET UNITYSDK_OFFSET(0x1CC12840)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BYTESTOWRITE_OFFSET UNITYSDK_OFFSET(0x1CC12880)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_CDHOLDING_OFFSET UNITYSDK_OFFSET(0x1CC128C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_CTSHOLDING_OFFSET UNITYSDK_OFFSET(0x1CC12900)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DATABITS_OFFSET UNITYSDK_OFFSET(0x1CC12940)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DISCARDNULL_OFFSET UNITYSDK_OFFSET(0x1CC129C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DSRHOLDING_OFFSET UNITYSDK_OFFSET(0x1CC12A40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DTRENABLE_OFFSET UNITYSDK_OFFSET(0x1CC12A80)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x1CC12B00)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_HANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1CC12B80)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1CC12C00)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1CC12C40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PARITYREPLACE_OFFSET UNITYSDK_OFFSET(0x1CC12D40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PARITY_OFFSET UNITYSDK_OFFSET(0x1CC12CC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1CC12DC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_READBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1CC12E40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1CC12EC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_RECEIVEDBYTESTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1CC12F40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_RTSENABLE_OFFSET UNITYSDK_OFFSET(0x1CC12FC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_STOPBITS_OFFSET UNITYSDK_OFFSET(0x1CC13040)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_WRITEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1CC130C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1CC13140)
#define SYSTEM_IO_PORTS_SERIALPORT_OPEN_OFFSET UNITYSDK_OFFSET(0x1CC13440)
#define SYSTEM_IO_PORTS_SERIALPORT_READBYTE_OFFSET UNITYSDK_OFFSET(0x1CC13500)
#define SYSTEM_IO_PORTS_SERIALPORT_READCHAR_OFFSET UNITYSDK_OFFSET(0x1CC13540)
#define SYSTEM_IO_PORTS_SERIALPORT_READEXISTING_OFFSET UNITYSDK_OFFSET(0x1CC13580)
#define SYSTEM_IO_PORTS_SERIALPORT_READLINE_OFFSET UNITYSDK_OFFSET(0x1CC135C0)
#define SYSTEM_IO_PORTS_SERIALPORT_READTO_OFFSET UNITYSDK_OFFSET(0x1CC13600)
#define SYSTEM_IO_PORTS_SERIALPORT_READ_1_OFFSET UNITYSDK_OFFSET(0x1CC134C0)
#define SYSTEM_IO_PORTS_SERIALPORT_READ_OFFSET UNITYSDK_OFFSET(0x1CC13480)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_DATARECEIVED_OFFSET UNITYSDK_OFFSET(0x1CC13200)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_ERRORRECEIVED_OFFSET UNITYSDK_OFFSET(0x1CC13280)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_PINCHANGED_OFFSET UNITYSDK_OFFSET(0x1CC13300)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_BAUDRATE_OFFSET UNITYSDK_OFFSET(0x1CC12780)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_BREAKSTATE_OFFSET UNITYSDK_OFFSET(0x1CC12800)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DATABITS_OFFSET UNITYSDK_OFFSET(0x1CC12980)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DISCARDNULL_OFFSET UNITYSDK_OFFSET(0x1CC12A00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DTRENABLE_OFFSET UNITYSDK_OFFSET(0x1CC12AC0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_ENCODING_OFFSET UNITYSDK_OFFSET(0x1CC12B40)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_HANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1CC12BC0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1CC12C80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PARITYREPLACE_OFFSET UNITYSDK_OFFSET(0x1CC12D80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PARITY_OFFSET UNITYSDK_OFFSET(0x1CC12D00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1CC12E00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_READBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1CC12E80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1CC12F00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_RECEIVEDBYTESTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1CC12F80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_RTSENABLE_OFFSET UNITYSDK_OFFSET(0x1CC13000)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_STOPBITS_OFFSET UNITYSDK_OFFSET(0x1CC13080)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_WRITEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1CC13100)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1CC13180)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1CC13700)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1CC13680)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1CC136C0)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_OFFSET UNITYSDK_OFFSET(0x1CC13640)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC12580)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CC125C0)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CC12600)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1CC12640)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1CC12680)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1CC126C0)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC12540)
