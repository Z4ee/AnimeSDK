...
#define SYSTEM_IO_PORTS_SERIALERRORRECEIVEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE10D0)
#define SYSTEM_IO_PORTS_SERIALERRORRECEIVEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE1110)
#define SYSTEM_IO_PORTS_SERIALERRORRECEIVEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE1090)
#define SYSTEM_IO_PORTS_SERIALERRORRECEIVEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE1050)

namespace System::IO::Ports
{
	inline static constexpr unsigned int SerialErrorReceivedEventHandler_TypeDefinitionIndex = 4160;
