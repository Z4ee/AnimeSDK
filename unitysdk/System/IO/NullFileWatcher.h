...
#define SYSTEM_IO_NULLFILEWATCHER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C87EEC0)
#define SYSTEM_IO_NULLFILEWATCHER_STARTDISPATCHING_OFFSET UNITYSDK_OFFSET(0x1C87EEA0)
#define SYSTEM_IO_NULLFILEWATCHER_STOPDISPATCHING_OFFSET UNITYSDK_OFFSET(0x1C87EEB0)
#define SYSTEM_IO_NULLFILEWATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C87EF40)
