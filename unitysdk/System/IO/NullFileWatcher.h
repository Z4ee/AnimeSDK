...
#define SYSTEM_IO_NULLFILEWATCHER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1921D1B0)
#define SYSTEM_IO_NULLFILEWATCHER_STARTDISPATCHING_OFFSET UNITYSDK_OFFSET(0x1921D190)
#define SYSTEM_IO_NULLFILEWATCHER_STOPDISPATCHING_OFFSET UNITYSDK_OFFSET(0x1921D1A0)
#define SYSTEM_IO_NULLFILEWATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1921D230)

namespace System::IO
{
	inline static constexpr unsigned int NullFileWatcher_TypeDefinitionIndex = 3232;
