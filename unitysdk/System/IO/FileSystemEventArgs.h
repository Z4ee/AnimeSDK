...
#define SYSTEM_IO_FILESYSTEMEVENTARGS_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1A241750)
#define SYSTEM_IO_FILESYSTEMEVENTARGS_GET_FULLPATH_OFFSET UNITYSDK_OFFSET(0x1A241760)
#define SYSTEM_IO_FILESYSTEMEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A241770)
#define SYSTEM_IO_FILESYSTEMEVENTARGS_SETNAME_OFFSET UNITYSDK_OFFSET(0x1A241740)
#define SYSTEM_IO_FILESYSTEMEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2416D0)

namespace System::IO
{
	inline static constexpr unsigned int FileSystemEventArgs_TypeDefinitionIndex = 3223;
