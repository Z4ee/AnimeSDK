...
#define SYSTEM_IO_ERROREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D3FB1E0)
#define SYSTEM_IO_ERROREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D3FB220)
#define SYSTEM_IO_ERROREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3FAC50)
#define SYSTEM_IO_ERROREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FAC30)
