...
#define SYSTEM_IO_FILESYSTEMENUMERABLEFACTORY_CREATEFILENAMEITERATOR_OFFSET UNITYSDK_OFFSET(0x17965C30)

namespace System::IO
{
	inline static constexpr unsigned int FileSystemEnumerableFactory_TypeDefinitionIndex = 670;
