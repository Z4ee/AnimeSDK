...
#define SYSTEM_IO_FILESYSTEMENUMERABLEHELPERS_ISDIR_OFFSET UNITYSDK_OFFSET(0x17965CF0)
#define SYSTEM_IO_FILESYSTEMENUMERABLEHELPERS_ISFILE_OFFSET UNITYSDK_OFFSET(0x17965D80)

namespace System::IO
{
	inline static constexpr unsigned int FileSystemEnumerableHelpers_TypeDefinitionIndex = 676;
