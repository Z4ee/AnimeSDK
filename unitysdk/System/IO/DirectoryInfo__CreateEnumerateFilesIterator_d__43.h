...
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x172EA8E0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_IO_FILEINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x172EADA0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_IO_FILEINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x172EAD30)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x172EAE10)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x172EAD90)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x172EAD40)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x172EA7C0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x172EA0D0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x172EA7E0)

namespace System::IO
{
	inline static constexpr unsigned int DirectoryInfo__CreateEnumerateFilesIterator_d__43_TypeDefinitionIndex = 707;

	class DirectoryInfo__CreateEnumerateFilesIterator_d__43 : public ::System::Object
	{
	public:
		::System::String* searchPattern; // 0x10
