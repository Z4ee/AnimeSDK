...
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1795AC10)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_IO_FILEINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1795B030)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_IO_FILEINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1795AFC0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1795B0A0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1795B020)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1795AFD0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1795AAA0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x1795A400)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEFILESITERATOR_D__43___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1795AB60)
