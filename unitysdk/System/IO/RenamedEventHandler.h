...
#define SYSTEM_IO_RENAMEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DEBDA30)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DEBDA70)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DEBD4A0)
#define SYSTEM_IO_RENAMEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBD480)
