...
#define SYSTEM_IO_RENAMEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E2A80)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E2AC0)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7E2500)
#define SYSTEM_IO_RENAMEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E24F0)

namespace System::IO
{
	inline static constexpr unsigned int RenamedEventHandler_TypeDefinitionIndex = 3234;
