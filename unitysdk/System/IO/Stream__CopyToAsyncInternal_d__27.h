...
#define SYSTEM_IO_STREAM__COPYTOASYNCINTERNAL_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x86D560)
#define SYSTEM_IO_STREAM__COPYTOASYNCINTERNAL_D__27_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x777AB0)
...
namespace System::IO
{
	...
	struct alignas(8) Stream__CopyToAsyncInternal_d__27
	{
		...
		::System::IO::Stream* __4__this; // 0x20
		::System::IO::Stream* destination; // 0x28
