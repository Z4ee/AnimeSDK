...
#define SYSTEM_IO_STREAM__COPYTOASYNCINTERNAL_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A3EFD0)
#define SYSTEM_IO_STREAM__COPYTOASYNCINTERNAL_D__27_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x91BC40)
...
namespace System::IO
{
	...
	struct alignas(8) Stream__CopyToAsyncInternal_d__27
	{
		...
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Int32> __u__2; // 0x48
		::System::IO::Stream* destination; // 0x58
