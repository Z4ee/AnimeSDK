...
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_WRITEMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC12320)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_WRITEMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC123C0)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_WRITEMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC11D70)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_WRITEMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC11D50)

namespace System::IO::Compression
{
	inline static constexpr unsigned int DeflateStream_WriteMethod_TypeDefinitionIndex = 3245;
