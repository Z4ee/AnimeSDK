...
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186AE500)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186AE590)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE_INVOKE_OFFSET UNITYSDK_OFFSET(0x186AE170)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE__CTOR_OFFSET UNITYSDK_OFFSET(0x186ADB20)

namespace System::IO::Compression
{
	inline static constexpr unsigned int DeflateStreamNative_UnmanagedReadOrWrite_TypeDefinitionIndex = 2709;
