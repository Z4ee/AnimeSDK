...
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_READMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A50340)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_READMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A503E0)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_READMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A4FD60)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAM_READMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4FD50)

namespace System::IO::Compression
{
	inline static constexpr unsigned int DeflateStream_ReadMethod_TypeDefinitionIndex = 3245;
