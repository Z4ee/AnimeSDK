...
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CECBBA0)
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CECBBE0)
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CECB620)
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECB600)

namespace System::IO
{
	inline static constexpr unsigned int FileSystemEventHandler_TypeDefinitionIndex = 3223;
