...
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_CLOSEMAPPING_OFFSET UNITYSDK_OFFSET(0x19A26660)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_CREATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19A338E0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_FLUSH_OFFSET UNITYSDK_OFFSET(0x19A26750)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_MAPINTERNAL_OFFSET UNITYSDK_OFFSET(0x19A33760)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_MAP_OFFSET UNITYSDK_OFFSET(0x19A33810)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_OPENFILEINTERNAL_OFFSET UNITYSDK_OFFSET(0x19A33750)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_OPENFILE_OFFSET UNITYSDK_OFFSET(0x19A33D10)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_UNMAP_OFFSET UNITYSDK_OFFSET(0x19A267D0)
