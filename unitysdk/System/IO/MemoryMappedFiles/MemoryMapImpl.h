...
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_CLOSEMAPPING_OFFSET UNITYSDK_OFFSET(0x1E6C04B0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_CREATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1E6CD720)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E6C05A0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_MAPINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E6CD5A0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_MAP_OFFSET UNITYSDK_OFFSET(0x1E6CD650)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_OPENFILEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E6CD590)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_OPENFILE_OFFSET UNITYSDK_OFFSET(0x1E6CDB50)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_UNMAP_OFFSET UNITYSDK_OFFSET(0x1E6C0620)

namespace System::IO::MemoryMappedFiles
{
	inline static constexpr unsigned int MemoryMapImpl_TypeDefinitionIndex = 3126;
