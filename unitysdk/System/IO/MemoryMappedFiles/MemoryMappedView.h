...
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_CREATE_OFFSET UNITYSDK_OFFSET(0x1E6CE180)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E6CE880)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E6CE740)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E6CE710)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x1E6CE700)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1E6CE960)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_POINTEROFFSET_OFFSET UNITYSDK_OFFSET(0x1E6CE6E0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1E6CE6F0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_VIEWHANDLE_OFFSET UNITYSDK_OFFSET(0x1E6CE6D0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CE6B0)

namespace System::IO::MemoryMappedFiles
{
	inline static constexpr unsigned int MemoryMappedView_TypeDefinitionIndex = 3128;

	class MemoryMappedView : public ::System::Object
	{
	public:
		::Microsoft::Win32::SafeHandles::SafeMemoryMappedViewHandle* m_viewHandle; // 0x10
		::System::Int64 m_pointerOffset; // 0x18
		::System::Int64 m_size; // 0x20
		::System::IO::MemoryMappedFiles::MemoryMappedFileAccess m_access; // 0x28
