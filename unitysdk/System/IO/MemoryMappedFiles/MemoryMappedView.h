...
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_CREATE_OFFSET UNITYSDK_OFFSET(0x19A34340)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19A34A40)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19A34900)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_FLUSH_OFFSET UNITYSDK_OFFSET(0x19A348D0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x19A348C0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x19A34B20)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_POINTEROFFSET_OFFSET UNITYSDK_OFFSET(0x19A348A0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19A348B0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW_GET_VIEWHANDLE_OFFSET UNITYSDK_OFFSET(0x19A34890)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPPEDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A34870)
