...
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6D1220)
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C6D12B0)
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C6D1300)
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6D1160)

namespace System::IO
{
	inline static constexpr unsigned int InternalBufferOverflowException_TypeDefinitionIndex = 3228;
