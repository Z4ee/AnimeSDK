...
#define SYSTEM_IO_FILESYSTEMINFO_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C9CFD60)
#define SYSTEM_IO_FILESYSTEMINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C9CFBE0)
#define SYSTEM_IO_FILESYSTEMINFO_GET_CREATIONTIMEUTC_OFFSET UNITYSDK_OFFSET(0x1C9CF510)
#define SYSTEM_IO_FILESYSTEMINFO_GET_CREATIONTIME_OFFSET UNITYSDK_OFFSET(0x1C9CF3A0)
#define SYSTEM_IO_FILESYSTEMINFO_GET_EXTENSION_OFFSET UNITYSDK_OFFSET(0x1C9CF290)
#define SYSTEM_IO_FILESYSTEMINFO_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1C9CF280)
#define SYSTEM_IO_FILESYSTEMINFO_GET_LASTACCESSTIMEUTC_OFFSET UNITYSDK_OFFSET(0x1C9CF7D0)
#define SYSTEM_IO_FILESYSTEMINFO_GET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1C9CF660)
#define SYSTEM_IO_FILESYSTEMINFO_GET_LASTWRITETIMEUTC_OFFSET UNITYSDK_OFFSET(0x1C9CFA90)
#define SYSTEM_IO_FILESYSTEMINFO_GET_LASTWRITETIME_OFFSET UNITYSDK_OFFSET(0x1C9CF920)
#define SYSTEM_IO_FILESYSTEMINFO_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C9CE5E0)
#define SYSTEM_IO_FILESYSTEMINFO_SET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C9CFC80)
#define SYSTEM_IO_FILESYSTEMINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9CE490)
#define SYSTEM_IO_FILESYSTEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CE060)
