...
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18DAAC20)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_IO_DIRECTORYINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18DAB0B0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_IO_DIRECTORYINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18DAB040)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18DAB140)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18DAB0A0)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18DAB050)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18DAAB00)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x18DAA930)
#define SYSTEM_IO_DIRECTORYINFO__CREATEENUMERATEDIRECTORIESITERATOR_D__39___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x18DAAB20)
...
namespace System::IO
{
	...
	{
	public:
		::System::IO::DirectoryInfo* __4__this; // 0x10
		::System::Collections::Generic::IEnumerator_1<::System::String*>* __7__wrap1; // 0x18
		::System::String* searchPattern; // 0x20
