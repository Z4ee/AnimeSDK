...
#define SYSTEM_IO_DIRECTORY_SEARCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBFCB20)

namespace System::IO
{
	inline static constexpr unsigned int Directory_SearchData_TypeDefinitionIndex = 631;
