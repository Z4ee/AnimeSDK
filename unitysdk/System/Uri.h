...
#define SYSTEM_URI_ALLOWIDNSTATIC_OFFSET UNITYSDK_OFFSET(0x1B1DA4C0)
#define SYSTEM_URI_CALCULATECASEINSENSITIVEHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1E3470)
#define SYSTEM_URI_CANONICALIZE_OFFSET UNITYSDK_OFFSET(0x1B1EBD90)
#define SYSTEM_URI_CHECKAUTHORITYHELPERHANDLEANYHOSTIRI_OFFSET UNITYSDK_OFFSET(0x1B1EB150)
#define SYSTEM_URI_CHECKAUTHORITYHELPERHANDLEDNSIRI_OFFSET UNITYSDK_OFFSET(0x1B1EACF0)
#define SYSTEM_URI_CHECKAUTHORITYHELPER_OFFSET UNITYSDK_OFFSET(0x1B1E5A50)
#define SYSTEM_URI_CHECKCANONICAL_OFFSET UNITYSDK_OFFSET(0x1B1E7640)
#define SYSTEM_URI_CHECKFORCOLONINFIRSTPATHSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B1E4AD0)
#define SYSTEM_URI_CHECKFORCONFIGLOAD_OFFSET UNITYSDK_OFFSET(0x1B1ECC50)
#define SYSTEM_URI_CHECKFORESCAPEDUNRESERVED_OFFSET UNITYSDK_OFFSET(0x1B1ECEA0)
#define SYSTEM_URI_CHECKFORUNICODE_OFFSET UNITYSDK_OFFSET(0x1B1ECD10)
#define SYSTEM_URI_CHECKHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1B1E2380)
#define SYSTEM_URI_CHECKKNOWNSCHEMES_OFFSET UNITYSDK_OFFSET(0x1B1EA960)
#define SYSTEM_URI_CHECKSCHEMENAME_OFFSET UNITYSDK_OFFSET(0x1B1E2CF0)
#define SYSTEM_URI_CHECKSCHEMESYNTAX_OFFSET UNITYSDK_OFFSET(0x1B1DE060)
#define SYSTEM_URI_CHECKSECURITY_OFFSET UNITYSDK_OFFSET(0x1B1EBFB0)
#define SYSTEM_URI_COMBINEURI_OFFSET UNITYSDK_OFFSET(0x1B1DE260)
#define SYSTEM_URI_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B1ED910)
#define SYSTEM_URI_COMPRESS_OFFSET UNITYSDK_OFFSET(0x1B1E1380)
#define SYSTEM_URI_CREATEHELPER_OFFSET UNITYSDK_OFFSET(0x1B1ED0B0)
#define SYSTEM_URI_CREATEHOSTSTRINGHELPER_OFFSET UNITYSDK_OFFSET(0x1B1E74C0)
#define SYSTEM_URI_CREATEHOSTSTRING_OFFSET UNITYSDK_OFFSET(0x1B1DC340)
#define SYSTEM_URI_CREATETHISFROMURI_OFFSET UNITYSDK_OFFSET(0x1B1DD760)
#define SYSTEM_URI_CREATETHIS_OFFSET UNITYSDK_OFFSET(0x1B1DC8D0)
#define SYSTEM_URI_CREATEURIINFO_OFFSET UNITYSDK_OFFSET(0x1B1DA6C0)
#define SYSTEM_URI_CREATEURI_OFFSET UNITYSDK_OFFSET(0x1B1DCC60)
#define SYSTEM_URI_ENSUREHOSTSTRING_OFFSET UNITYSDK_OFFSET(0x1B1DC2E0)
#define SYSTEM_URI_ENSUREPARSEREMAINING_OFFSET UNITYSDK_OFFSET(0x1B1DAF60)
#define SYSTEM_URI_ENSUREURIINFO_OFFSET UNITYSDK_OFFSET(0x1B1DA690)
#define SYSTEM_URI_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1E38B0)
#define SYSTEM_URI_ESCAPEDATASTRING_OFFSET UNITYSDK_OFFSET(0x1B1EE740)
#define SYSTEM_URI_ESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x1B1EBEF0)
#define SYSTEM_URI_ESCAPEUNESCAPEIRI_OFFSET UNITYSDK_OFFSET(0x1B1EA940)
#define SYSTEM_URI_ESCAPEURISTRING_OFFSET UNITYSDK_OFFSET(0x1B1EE640)
#define SYSTEM_URI_ESCAPE_OFFSET UNITYSDK_OFFSET(0x1B1EBDA0)
#define SYSTEM_URI_FINDENDOFCOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x1B1EB640)
#define SYSTEM_URI_FINDENDOFCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B1EA8B0)
#define SYSTEM_URI_FROMHEX_OFFSET UNITYSDK_OFFSET(0x1B1E3070)
#define SYSTEM_URI_GETCANONICALPATH_OFFSET UNITYSDK_OFFSET(0x1B1E9E80)
#define SYSTEM_URI_GETCOMBINEDSTRING_OFFSET UNITYSDK_OFFSET(0x1B1DDD10)
#define SYSTEM_URI_GETCOMPONENTSHELPER_OFFSET UNITYSDK_OFFSET(0x1B1E3680)
#define SYSTEM_URI_GETCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B1E7BE0)
#define SYSTEM_URI_GETESCAPEDPARTS_OFFSET UNITYSDK_OFFSET(0x1B1E7D40)
#define SYSTEM_URI_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B1DF2A0)
#define SYSTEM_URI_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1E3110)
#define SYSTEM_URI_GETHOSTVIACUSTOMSYNTAX_OFFSET UNITYSDK_OFFSET(0x1B1E6F00)
#define SYSTEM_URI_GETLEFTPART_OFFSET UNITYSDK_OFFSET(0x1B1E25A0)
#define SYSTEM_URI_GETLOCALPATH_OFFSET UNITYSDK_OFFSET(0x1B1DFAB0)
#define SYSTEM_URI_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B1DF500)
#define SYSTEM_URI_GETPARTS_OFFSET UNITYSDK_OFFSET(0x1B1DF770)
#define SYSTEM_URI_GETRELATIVESERIALIZATIONSTRING_OFFSET UNITYSDK_OFFSET(0x1B1ED6A0)
#define SYSTEM_URI_GETUNESCAPEDPARTS_OFFSET UNITYSDK_OFFSET(0x1B1E1950)
#define SYSTEM_URI_GETURIPARTSFROMUSERSTRING_OFFSET UNITYSDK_OFFSET(0x1B1E7EB0)
#define SYSTEM_URI_GET_ABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x1B1DF780)
#define SYSTEM_URI_GET_ABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x1B1DF950)
#define SYSTEM_URI_GET_ALLOWIDN_OFFSET UNITYSDK_OFFSET(0x1B1DA3F0)
#define SYSTEM_URI_GET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x1B1E08E0)
#define SYSTEM_URI_GET_DNSSAFEHOST_OFFSET UNITYSDK_OFFSET(0x1B1E1F00)
#define SYSTEM_URI_GET_FRAGMENT_OFFSET UNITYSDK_OFFSET(0x1B1E1CA0)
#define SYSTEM_URI_GET_HASAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1B1EBA20)
#define SYSTEM_URI_GET_HOSTNAMETYPE_OFFSET UNITYSDK_OFFSET(0x1B1E0960)
#define SYSTEM_URI_GET_HOSTTYPE_OFFSET UNITYSDK_OFFSET(0x1B1DA340)
#define SYSTEM_URI_GET_HOST_OFFSET UNITYSDK_OFFSET(0x1B1E1030)
#define SYSTEM_URI_GET_IDNHOST_OFFSET UNITYSDK_OFFSET(0x1B1E2290)
#define SYSTEM_URI_GET_INITIALIZELOCK_OFFSET UNITYSDK_OFFSET(0x1B1E10D0)
#define SYSTEM_URI_GET_ISABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x1B1DCC50)
#define SYSTEM_URI_GET_ISDEFAULTPORT_OFFSET UNITYSDK_OFFSET(0x1B1E0A90)
#define SYSTEM_URI_GET_ISDOSPATH_OFFSET UNITYSDK_OFFSET(0x1B1DA320)
#define SYSTEM_URI_GET_ISFILE_OFFSET UNITYSDK_OFFSET(0x1B1E0B50)
#define SYSTEM_URI_GET_ISIMPLICITFILE_OFFSET UNITYSDK_OFFSET(0x1B1DA300)
#define SYSTEM_URI_GET_ISLOOPBACK_OFFSET UNITYSDK_OFFSET(0x1B1E0BF0)
#define SYSTEM_URI_GET_ISNOTABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x1B1DA360)
#define SYSTEM_URI_GET_ISUNCORDOSPATH_OFFSET UNITYSDK_OFFSET(0x1B1DA310)
#define SYSTEM_URI_GET_ISUNCPATH_OFFSET UNITYSDK_OFFSET(0x1B1DA330)
#define SYSTEM_URI_GET_ISUNC_OFFSET UNITYSDK_OFFSET(0x1B1E0FB0)
#define SYSTEM_URI_GET_LOCALPATH_OFFSET UNITYSDK_OFFSET(0x1B1DFA40)
#define SYSTEM_URI_GET_ORIGINALSTRINGSWITCHED_OFFSET UNITYSDK_OFFSET(0x1B1E1E10)
#define SYSTEM_URI_GET_ORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x1B1DE170)
#define SYSTEM_URI_GET_PATHANDQUERY_OFFSET UNITYSDK_OFFSET(0x1B1E0CA0)
#define SYSTEM_URI_GET_PORT_OFFSET UNITYSDK_OFFSET(0x1B1E1AC0)
#define SYSTEM_URI_GET_PRIVATEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x1B1DF890)
#define SYSTEM_URI_GET_QUERY_OFFSET UNITYSDK_OFFSET(0x1B1E1BB0)
#define SYSTEM_URI_GET_SCHEME_OFFSET UNITYSDK_OFFSET(0x1B1E1D90)
#define SYSTEM_URI_GET_SECUREDPATHINDEX_OFFSET UNITYSDK_OFFSET(0x1B1DA5D0)
#define SYSTEM_URI_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1B1E0DC0)
#define SYSTEM_URI_GET_SYNTAX_OFFSET UNITYSDK_OFFSET(0x1B1DA350)
#define SYSTEM_URI_GET_USERDRIVENPARSING_OFFSET UNITYSDK_OFFSET(0x1B1DA5A0)
#define SYSTEM_URI_GET_USERESCAPED_OFFSET UNITYSDK_OFFSET(0x1B1E22F0)
#define SYSTEM_URI_GET_USERINFO_OFFSET UNITYSDK_OFFSET(0x1B1E2300)
#define SYSTEM_URI_HEXESCAPE_OFFSET UNITYSDK_OFFSET(0x1B1E26E0)
#define SYSTEM_URI_HEXUNESCAPE_OFFSET UNITYSDK_OFFSET(0x1B1E2840)
#define SYSTEM_URI_INFACT_OFFSET UNITYSDK_OFFSET(0x1B1DA670)
#define SYSTEM_URI_INITIALIZEURICONFIG_OFFSET UNITYSDK_OFFSET(0x1B1E11C0)
#define SYSTEM_URI_INITIALIZEURI_OFFSET UNITYSDK_OFFSET(0x1B1EC290)
#define SYSTEM_URI_INTERNALESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x1B1E4C10)
#define SYSTEM_URI_INTERNALISWELLFORMEDORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x1B1EDC00)
#define SYSTEM_URI_IRIPARSINGSTATIC_OFFSET UNITYSDK_OFFSET(0x1B1DA370)
#define SYSTEM_URI_ISASCIILETTERORDIGIT_OFFSET UNITYSDK_OFFSET(0x1B1E2FE0)
#define SYSTEM_URI_ISASCIILETTER_OFFSET UNITYSDK_OFFSET(0x1B1E2FD0)
#define SYSTEM_URI_ISBADFILESYSTEMCHARACTER_OFFSET UNITYSDK_OFFSET(0x1B1EC0F0)
#define SYSTEM_URI_ISBASEOFHELPER_OFFSET UNITYSDK_OFFSET(0x1B1EE900)
#define SYSTEM_URI_ISBASEOF_OFFSET UNITYSDK_OFFSET(0x1B1EE850)
#define SYSTEM_URI_ISBIDICONTROLCHARACTER_OFFSET UNITYSDK_OFFSET(0x1B1EBA30)
#define SYSTEM_URI_ISEXCLUDEDCHARACTER_OFFSET UNITYSDK_OFFSET(0x1B1EC090)
#define SYSTEM_URI_ISGENDELIM_OFFSET UNITYSDK_OFFSET(0x1B1E2CD0)
#define SYSTEM_URI_ISHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1B1E3050)
#define SYSTEM_URI_ISHEXENCODING_OFFSET UNITYSDK_OFFSET(0x1B1E2AF0)
#define SYSTEM_URI_ISINTRANET_OFFSET UNITYSDK_OFFSET(0x1B1DA590)
#define SYSTEM_URI_ISLWS_OFFSET UNITYSDK_OFFSET(0x1B1E5A30)
#define SYSTEM_URI_ISRESERVEDCHARACTER_OFFSET UNITYSDK_OFFSET(0x1B1EC070)
#define SYSTEM_URI_ISWELLFORMEDORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x1B1EDBD0)
#define SYSTEM_URI_ISWELLFORMEDURISTRING_OFFSET UNITYSDK_OFFSET(0x1B1EE350)
#define SYSTEM_URI_MAKERELATIVEURI_OFFSET UNITYSDK_OFFSET(0x1B1E4030)
#define SYSTEM_URI_MAKERELATIVE_OFFSET UNITYSDK_OFFSET(0x1B1EBA60)
#define SYSTEM_URI_NOTANY_OFFSET UNITYSDK_OFFSET(0x1B1DA4B0)
#define SYSTEM_URI_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1CFD80)
#define SYSTEM_URI_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1DD720)
#define SYSTEM_URI_PARSEMINIMAL_OFFSET UNITYSDK_OFFSET(0x1B1E52A0)
#define SYSTEM_URI_PARSEREMAINING_OFFSET UNITYSDK_OFFSET(0x1B1DAF70)
#define SYSTEM_URI_PARSESCHEMECHECKIMPLICITFILE_OFFSET UNITYSDK_OFFSET(0x1B1E4D80)
#define SYSTEM_URI_PARSESCHEME_OFFSET UNITYSDK_OFFSET(0x1B1E4CD0)
#define SYSTEM_URI_PARSE_OFFSET UNITYSDK_OFFSET(0x1B1EBD80)
#define SYSTEM_URI_PATHDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1B1E4570)
#define SYSTEM_URI_PRIVATEPARSEMINIMALIRI_OFFSET UNITYSDK_OFFSET(0x1B1E6CA0)
#define SYSTEM_URI_PRIVATEPARSEMINIMAL_OFFSET UNITYSDK_OFFSET(0x1B1E5310)
#define SYSTEM_URI_RECREATEPARTS_OFFSET UNITYSDK_OFFSET(0x1B1E8860)
#define SYSTEM_URI_RESOLVEHELPER_OFFSET UNITYSDK_OFFSET(0x1B1DCF30)
#define SYSTEM_URI_SETUSERDRIVENPARSING_OFFSET UNITYSDK_OFFSET(0x1B1DA5B0)
#define SYSTEM_URI_STATICINFACT_OFFSET UNITYSDK_OFFSET(0x1B1DA680)
#define SYSTEM_URI_STATICISFILE_OFFSET UNITYSDK_OFFSET(0x1B1E10B0)
#define SYSTEM_URI_STATICNOTANY_OFFSET UNITYSDK_OFFSET(0x1B1DA580)
#define SYSTEM_URI_STRIPBIDICONTROLCHARACTER_OFFSET UNITYSDK_OFFSET(0x1B1EB4B0)
#define SYSTEM_URI_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B1DF4F0)
#define SYSTEM_URI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1E3500)
#define SYSTEM_URI_TRYCREATE_1_OFFSET UNITYSDK_OFFSET(0x1B1ED3A0)
#define SYSTEM_URI_TRYCREATE_2_OFFSET UNITYSDK_OFFSET(0x1B1ED500)
#define SYSTEM_URI_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1B1E3F80)
#define SYSTEM_URI_UNESCAPEDATASTRING_OFFSET UNITYSDK_OFFSET(0x1B1EE490)
#define SYSTEM_URI_UNESCAPEONLY_OFFSET UNITYSDK_OFFSET(0x1B1EB6D0)
#define SYSTEM_URI_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x1B1EBDB0)
#define SYSTEM_URI__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1EEB50)
#define SYSTEM_URI__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1DCB10)
#define SYSTEM_URI__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1DCB90)
#define SYSTEM_URI__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B1DCE00)
#define SYSTEM_URI__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B1DCE80)
#define SYSTEM_URI__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B1DDAF0)
#define SYSTEM_URI__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B1DF420)
#define SYSTEM_URI__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1B1EE840)
#define SYSTEM_URI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1DC850)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2CA0);
		}
		static ::System::Object** StaticGet_s_initLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2CA8);
		}
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2CD0);
		}
		...
		::System::String* m_DnsSafeHost; // 0x10
