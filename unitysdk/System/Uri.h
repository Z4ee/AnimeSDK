...
#define SYSTEM_URI_ALLOWIDNSTATIC_OFFSET UNITYSDK_OFFSET(0x18FCC390)
#define SYSTEM_URI_CALCULATECASEINSENSITIVEHASHCODE_OFFSET UNITYSDK_OFFSET(0x18FD5340)
#define SYSTEM_URI_CANONICALIZE_OFFSET UNITYSDK_OFFSET(0x18FDDC60)
#define SYSTEM_URI_CHECKAUTHORITYHELPERHANDLEANYHOSTIRI_OFFSET UNITYSDK_OFFSET(0x18FDD020)
#define SYSTEM_URI_CHECKAUTHORITYHELPERHANDLEDNSIRI_OFFSET UNITYSDK_OFFSET(0x18FDCBC0)
#define SYSTEM_URI_CHECKAUTHORITYHELPER_OFFSET UNITYSDK_OFFSET(0x18FD7920)
#define SYSTEM_URI_CHECKCANONICAL_OFFSET UNITYSDK_OFFSET(0x18FD9510)
#define SYSTEM_URI_CHECKFORCOLONINFIRSTPATHSEGMENT_OFFSET UNITYSDK_OFFSET(0x18FD69A0)
#define SYSTEM_URI_CHECKFORCONFIGLOAD_OFFSET UNITYSDK_OFFSET(0x18FDEB20)
#define SYSTEM_URI_CHECKFORESCAPEDUNRESERVED_OFFSET UNITYSDK_OFFSET(0x18FDED70)
#define SYSTEM_URI_CHECKFORUNICODE_OFFSET UNITYSDK_OFFSET(0x18FDEBE0)
#define SYSTEM_URI_CHECKHOSTNAME_OFFSET UNITYSDK_OFFSET(0x18FD4250)
#define SYSTEM_URI_CHECKKNOWNSCHEMES_OFFSET UNITYSDK_OFFSET(0x18FDC830)
#define SYSTEM_URI_CHECKSCHEMENAME_OFFSET UNITYSDK_OFFSET(0x18FD4BC0)
#define SYSTEM_URI_CHECKSCHEMESYNTAX_OFFSET UNITYSDK_OFFSET(0x18FCFF30)
#define SYSTEM_URI_CHECKSECURITY_OFFSET UNITYSDK_OFFSET(0x18FDDE80)
#define SYSTEM_URI_COMBINEURI_OFFSET UNITYSDK_OFFSET(0x18FD0130)
#define SYSTEM_URI_COMPARE_OFFSET UNITYSDK_OFFSET(0x18FDF7E0)
#define SYSTEM_URI_COMPRESS_OFFSET UNITYSDK_OFFSET(0x18FD3250)
#define SYSTEM_URI_CREATEHELPER_OFFSET UNITYSDK_OFFSET(0x18FDEF80)
#define SYSTEM_URI_CREATEHOSTSTRINGHELPER_OFFSET UNITYSDK_OFFSET(0x18FD9390)
#define SYSTEM_URI_CREATEHOSTSTRING_OFFSET UNITYSDK_OFFSET(0x18FCE210)
#define SYSTEM_URI_CREATETHISFROMURI_OFFSET UNITYSDK_OFFSET(0x18FCF630)
#define SYSTEM_URI_CREATETHIS_OFFSET UNITYSDK_OFFSET(0x18FCE7A0)
#define SYSTEM_URI_CREATEURIINFO_OFFSET UNITYSDK_OFFSET(0x18FCC590)
#define SYSTEM_URI_CREATEURI_OFFSET UNITYSDK_OFFSET(0x18FCEB30)
#define SYSTEM_URI_ENSUREHOSTSTRING_OFFSET UNITYSDK_OFFSET(0x18FCE1B0)
#define SYSTEM_URI_ENSUREPARSEREMAINING_OFFSET UNITYSDK_OFFSET(0x18FCCE30)
#define SYSTEM_URI_ENSUREURIINFO_OFFSET UNITYSDK_OFFSET(0x18FCC560)
#define SYSTEM_URI_EQUALS_OFFSET UNITYSDK_OFFSET(0x18FD5780)
#define SYSTEM_URI_ESCAPEDATASTRING_OFFSET UNITYSDK_OFFSET(0x18FE0610)
#define SYSTEM_URI_ESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x18FDDDC0)
#define SYSTEM_URI_ESCAPEUNESCAPEIRI_OFFSET UNITYSDK_OFFSET(0x18FDC810)
#define SYSTEM_URI_ESCAPEURISTRING_OFFSET UNITYSDK_OFFSET(0x18FE0510)
#define SYSTEM_URI_ESCAPE_OFFSET UNITYSDK_OFFSET(0x18FDDC70)
#define SYSTEM_URI_FINDENDOFCOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x18FDD510)
#define SYSTEM_URI_FINDENDOFCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18FDC780)
#define SYSTEM_URI_FROMHEX_OFFSET UNITYSDK_OFFSET(0x18FD4F40)
#define SYSTEM_URI_GETCANONICALPATH_OFFSET UNITYSDK_OFFSET(0x18FDBD50)
#define SYSTEM_URI_GETCOMBINEDSTRING_OFFSET UNITYSDK_OFFSET(0x18FCFBE0)
#define SYSTEM_URI_GETCOMPONENTSHELPER_OFFSET UNITYSDK_OFFSET(0x18FD5550)
#define SYSTEM_URI_GETCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x18FD9AB0)
#define SYSTEM_URI_GETESCAPEDPARTS_OFFSET UNITYSDK_OFFSET(0x18FD9C10)
#define SYSTEM_URI_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x18FD1170)
#define SYSTEM_URI_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18FD4FE0)
#define SYSTEM_URI_GETHOSTVIACUSTOMSYNTAX_OFFSET UNITYSDK_OFFSET(0x18FD8DD0)
#define SYSTEM_URI_GETLEFTPART_OFFSET UNITYSDK_OFFSET(0x18FD4470)
#define SYSTEM_URI_GETLOCALPATH_OFFSET UNITYSDK_OFFSET(0x18FD1980)
#define SYSTEM_URI_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FD13D0)
#define SYSTEM_URI_GETPARTS_OFFSET UNITYSDK_OFFSET(0x18FD1640)
#define SYSTEM_URI_GETRELATIVESERIALIZATIONSTRING_OFFSET UNITYSDK_OFFSET(0x18FDF570)
#define SYSTEM_URI_GETUNESCAPEDPARTS_OFFSET UNITYSDK_OFFSET(0x18FD3820)
#define SYSTEM_URI_GETURIPARTSFROMUSERSTRING_OFFSET UNITYSDK_OFFSET(0x18FD9D80)
#define SYSTEM_URI_GET_ABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x18FD1650)
#define SYSTEM_URI_GET_ABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x18FD1820)
#define SYSTEM_URI_GET_ALLOWIDN_OFFSET UNITYSDK_OFFSET(0x18FCC2C0)
#define SYSTEM_URI_GET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x18FD27B0)
#define SYSTEM_URI_GET_DNSSAFEHOST_OFFSET UNITYSDK_OFFSET(0x18FD3DD0)
#define SYSTEM_URI_GET_FRAGMENT_OFFSET UNITYSDK_OFFSET(0x18FD3B70)
#define SYSTEM_URI_GET_HASAUTHORITY_OFFSET UNITYSDK_OFFSET(0x18FDD8F0)
#define SYSTEM_URI_GET_HOSTNAMETYPE_OFFSET UNITYSDK_OFFSET(0x18FD2830)
#define SYSTEM_URI_GET_HOSTTYPE_OFFSET UNITYSDK_OFFSET(0x18FCC210)
#define SYSTEM_URI_GET_HOST_OFFSET UNITYSDK_OFFSET(0x18FD2F00)
#define SYSTEM_URI_GET_IDNHOST_OFFSET UNITYSDK_OFFSET(0x18FD4160)
#define SYSTEM_URI_GET_INITIALIZELOCK_OFFSET UNITYSDK_OFFSET(0x18FD2FA0)
#define SYSTEM_URI_GET_ISABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x18FCEB20)
#define SYSTEM_URI_GET_ISDEFAULTPORT_OFFSET UNITYSDK_OFFSET(0x18FD2960)
#define SYSTEM_URI_GET_ISDOSPATH_OFFSET UNITYSDK_OFFSET(0x18FCC1F0)
#define SYSTEM_URI_GET_ISFILE_OFFSET UNITYSDK_OFFSET(0x18FD2A20)
#define SYSTEM_URI_GET_ISIMPLICITFILE_OFFSET UNITYSDK_OFFSET(0x18FCC1D0)
#define SYSTEM_URI_GET_ISLOOPBACK_OFFSET UNITYSDK_OFFSET(0x18FD2AC0)
#define SYSTEM_URI_GET_ISNOTABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x18FCC230)
#define SYSTEM_URI_GET_ISUNCORDOSPATH_OFFSET UNITYSDK_OFFSET(0x18FCC1E0)
#define SYSTEM_URI_GET_ISUNCPATH_OFFSET UNITYSDK_OFFSET(0x18FCC200)
#define SYSTEM_URI_GET_ISUNC_OFFSET UNITYSDK_OFFSET(0x18FD2E80)
#define SYSTEM_URI_GET_LOCALPATH_OFFSET UNITYSDK_OFFSET(0x18FD1910)
#define SYSTEM_URI_GET_ORIGINALSTRINGSWITCHED_OFFSET UNITYSDK_OFFSET(0x18FD3CE0)
#define SYSTEM_URI_GET_ORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x18FD0040)
#define SYSTEM_URI_GET_PATHANDQUERY_OFFSET UNITYSDK_OFFSET(0x18FD2B70)
#define SYSTEM_URI_GET_PORT_OFFSET UNITYSDK_OFFSET(0x18FD3990)
#define SYSTEM_URI_GET_PRIVATEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x18FD1760)
#define SYSTEM_URI_GET_QUERY_OFFSET UNITYSDK_OFFSET(0x18FD3A80)
#define SYSTEM_URI_GET_SCHEME_OFFSET UNITYSDK_OFFSET(0x18FD3C60)
#define SYSTEM_URI_GET_SECUREDPATHINDEX_OFFSET UNITYSDK_OFFSET(0x18FCC4A0)
#define SYSTEM_URI_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x18FD2C90)
#define SYSTEM_URI_GET_SYNTAX_OFFSET UNITYSDK_OFFSET(0x18FCC220)
#define SYSTEM_URI_GET_USERDRIVENPARSING_OFFSET UNITYSDK_OFFSET(0x18FCC470)
#define SYSTEM_URI_GET_USERESCAPED_OFFSET UNITYSDK_OFFSET(0x18FD41C0)
#define SYSTEM_URI_GET_USERINFO_OFFSET UNITYSDK_OFFSET(0x18FD41D0)
#define SYSTEM_URI_HEXESCAPE_OFFSET UNITYSDK_OFFSET(0x18FD45B0)
#define SYSTEM_URI_HEXUNESCAPE_OFFSET UNITYSDK_OFFSET(0x18FD4710)
#define SYSTEM_URI_INFACT_OFFSET UNITYSDK_OFFSET(0x18FCC540)
#define SYSTEM_URI_INITIALIZEURICONFIG_OFFSET UNITYSDK_OFFSET(0x18FD3090)
#define SYSTEM_URI_INITIALIZEURI_OFFSET UNITYSDK_OFFSET(0x18FDE160)
#define SYSTEM_URI_INTERNALESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x18FD6AE0)
#define SYSTEM_URI_INTERNALISWELLFORMEDORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x18FDFAD0)
#define SYSTEM_URI_IRIPARSINGSTATIC_OFFSET UNITYSDK_OFFSET(0x18FCC240)
#define SYSTEM_URI_ISASCIILETTERORDIGIT_OFFSET UNITYSDK_OFFSET(0x18FD4EB0)
#define SYSTEM_URI_ISASCIILETTER_OFFSET UNITYSDK_OFFSET(0x18FD4EA0)
#define SYSTEM_URI_ISBADFILESYSTEMCHARACTER_OFFSET UNITYSDK_OFFSET(0x18FDDFC0)
#define SYSTEM_URI_ISBASEOFHELPER_OFFSET UNITYSDK_OFFSET(0x18FE07D0)
#define SYSTEM_URI_ISBASEOF_OFFSET UNITYSDK_OFFSET(0x18FE0720)
#define SYSTEM_URI_ISBIDICONTROLCHARACTER_OFFSET UNITYSDK_OFFSET(0x18FDD900)
#define SYSTEM_URI_ISEXCLUDEDCHARACTER_OFFSET UNITYSDK_OFFSET(0x18FDDF60)
#define SYSTEM_URI_ISGENDELIM_OFFSET UNITYSDK_OFFSET(0x18FD4BA0)
#define SYSTEM_URI_ISHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x18FD4F20)
#define SYSTEM_URI_ISHEXENCODING_OFFSET UNITYSDK_OFFSET(0x18FD49C0)
#define SYSTEM_URI_ISINTRANET_OFFSET UNITYSDK_OFFSET(0x18FCC460)
#define SYSTEM_URI_ISLWS_OFFSET UNITYSDK_OFFSET(0x18FD7900)
#define SYSTEM_URI_ISRESERVEDCHARACTER_OFFSET UNITYSDK_OFFSET(0x18FDDF40)
#define SYSTEM_URI_ISWELLFORMEDORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x18FDFAA0)
#define SYSTEM_URI_ISWELLFORMEDURISTRING_OFFSET UNITYSDK_OFFSET(0x18FE0220)
#define SYSTEM_URI_MAKERELATIVEURI_OFFSET UNITYSDK_OFFSET(0x18FD5F00)
#define SYSTEM_URI_MAKERELATIVE_OFFSET UNITYSDK_OFFSET(0x18FDD930)
#define SYSTEM_URI_NOTANY_OFFSET UNITYSDK_OFFSET(0x18FCC380)
#define SYSTEM_URI_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18FC1C50)
#define SYSTEM_URI_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18FCF5F0)
#define SYSTEM_URI_PARSEMINIMAL_OFFSET UNITYSDK_OFFSET(0x18FD7170)
#define SYSTEM_URI_PARSEREMAINING_OFFSET UNITYSDK_OFFSET(0x18FCCE40)
#define SYSTEM_URI_PARSESCHEMECHECKIMPLICITFILE_OFFSET UNITYSDK_OFFSET(0x18FD6C50)
#define SYSTEM_URI_PARSESCHEME_OFFSET UNITYSDK_OFFSET(0x18FD6BA0)
#define SYSTEM_URI_PARSE_OFFSET UNITYSDK_OFFSET(0x18FDDC50)
#define SYSTEM_URI_PATHDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x18FD6440)
#define SYSTEM_URI_PRIVATEPARSEMINIMALIRI_OFFSET UNITYSDK_OFFSET(0x18FD8B70)
#define SYSTEM_URI_PRIVATEPARSEMINIMAL_OFFSET UNITYSDK_OFFSET(0x18FD71E0)
#define SYSTEM_URI_RECREATEPARTS_OFFSET UNITYSDK_OFFSET(0x18FDA730)
#define SYSTEM_URI_RESOLVEHELPER_OFFSET UNITYSDK_OFFSET(0x18FCEE00)
#define SYSTEM_URI_SETUSERDRIVENPARSING_OFFSET UNITYSDK_OFFSET(0x18FCC480)
#define SYSTEM_URI_STATICINFACT_OFFSET UNITYSDK_OFFSET(0x18FCC550)
#define SYSTEM_URI_STATICISFILE_OFFSET UNITYSDK_OFFSET(0x18FD2F80)
#define SYSTEM_URI_STATICNOTANY_OFFSET UNITYSDK_OFFSET(0x18FCC450)
#define SYSTEM_URI_STRIPBIDICONTROLCHARACTER_OFFSET UNITYSDK_OFFSET(0x18FDD380)
#define SYSTEM_URI_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FD13C0)
#define SYSTEM_URI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18FD53D0)
#define SYSTEM_URI_TRYCREATE_1_OFFSET UNITYSDK_OFFSET(0x18FDF270)
#define SYSTEM_URI_TRYCREATE_2_OFFSET UNITYSDK_OFFSET(0x18FDF3D0)
#define SYSTEM_URI_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x18FD5E50)
#define SYSTEM_URI_UNESCAPEDATASTRING_OFFSET UNITYSDK_OFFSET(0x18FE0360)
#define SYSTEM_URI_UNESCAPEONLY_OFFSET UNITYSDK_OFFSET(0x18FDD5A0)
#define SYSTEM_URI_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x18FDDC80)
#define SYSTEM_URI__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FE0A20)
#define SYSTEM_URI__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FCE9E0)
#define SYSTEM_URI__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FCEA60)
#define SYSTEM_URI__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FCECD0)
#define SYSTEM_URI__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18FCED50)
#define SYSTEM_URI__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18FCF9C0)
#define SYSTEM_URI__CTOR_6_OFFSET UNITYSDK_OFFSET(0x18FD12F0)
#define SYSTEM_URI__CTOR_7_OFFSET UNITYSDK_OFFSET(0x18FE0710)
#define SYSTEM_URI__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCE720)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2C90);
		}
		static ::System::Object** StaticGet_s_initLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2C98);
		}
		...
		::System::String* m_DnsSafeHost; // 0x18
		::System::UriParser* m_Syntax; // 0x20
