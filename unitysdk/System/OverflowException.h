...
#define SYSTEM_OVERFLOWEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x163633C0)
#define SYSTEM_OVERFLOWEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16363430)
#define SYSTEM_OVERFLOWEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x163634A0)
#define SYSTEM_OVERFLOWEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16363320)
