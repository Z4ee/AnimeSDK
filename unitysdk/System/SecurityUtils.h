...
#define SYSTEM_SECURITYUTILS_ARRAYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D461DE0)
#define SYSTEM_SECURITYUTILS_CONSTRUCTORINFOINVOKE_OFFSET UNITYSDK_OFFSET(0x1D461D20)
#define SYSTEM_SECURITYUTILS_DEMANDGRANTSET_OFFSET UNITYSDK_OFFSET(0x1D461840)
#define SYSTEM_SECURITYUTILS_DEMANDREFLECTIONACCESS_OFFSET UNITYSDK_OFFSET(0x1D461830)
#define SYSTEM_SECURITYUTILS_FIELDINFOGETVALUE_OFFSET UNITYSDK_OFFSET(0x1D461BA0)
#define SYSTEM_SECURITYUTILS_GENERICARGUMENTSAREVISIBLE_OFFSET UNITYSDK_OFFSET(0x1D461AF0)
#define SYSTEM_SECURITYUTILS_GET_MEMBERACCESSPERMISSION_OFFSET UNITYSDK_OFFSET(0x1D4616D0)
#define SYSTEM_SECURITYUTILS_GET_RESTRICTEDMEMBERACCESSPERMISSION_OFFSET UNITYSDK_OFFSET(0x1D461780)
#define SYSTEM_SECURITYUTILS_HASREFLECTIONPERMISSION_OFFSET UNITYSDK_OFFSET(0x1D461850)
#define SYSTEM_SECURITYUTILS_METHODINFOINVOKE_OFFSET UNITYSDK_OFFSET(0x1D461C40)
#define SYSTEM_SECURITYUTILS_SECURECONSTRUCTORINVOKE_1_OFFSET UNITYSDK_OFFSET(0x1D461980)
#define SYSTEM_SECURITYUTILS_SECURECONSTRUCTORINVOKE_OFFSET UNITYSDK_OFFSET(0x1D461960)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1D461890)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1D461950)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D461880)
#define SYSTEM_SECURITYUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D461E60)
