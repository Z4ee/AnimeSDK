...
#define SYSTEM_SECURITYUTILS_ARRAYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AFEB320)
#define SYSTEM_SECURITYUTILS_CONSTRUCTORINFOINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFEB260)
#define SYSTEM_SECURITYUTILS_DEMANDGRANTSET_OFFSET UNITYSDK_OFFSET(0x1AFEAD80)
#define SYSTEM_SECURITYUTILS_DEMANDREFLECTIONACCESS_OFFSET UNITYSDK_OFFSET(0x1AFEAD70)
#define SYSTEM_SECURITYUTILS_FIELDINFOGETVALUE_OFFSET UNITYSDK_OFFSET(0x1AFEB0E0)
#define SYSTEM_SECURITYUTILS_GENERICARGUMENTSAREVISIBLE_OFFSET UNITYSDK_OFFSET(0x1AFEB030)
#define SYSTEM_SECURITYUTILS_GET_MEMBERACCESSPERMISSION_OFFSET UNITYSDK_OFFSET(0x1AFEAC10)
#define SYSTEM_SECURITYUTILS_GET_RESTRICTEDMEMBERACCESSPERMISSION_OFFSET UNITYSDK_OFFSET(0x1AFEACC0)
#define SYSTEM_SECURITYUTILS_HASREFLECTIONPERMISSION_OFFSET UNITYSDK_OFFSET(0x1AFEAD90)
#define SYSTEM_SECURITYUTILS_METHODINFOINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFEB180)
#define SYSTEM_SECURITYUTILS_SECURECONSTRUCTORINVOKE_1_OFFSET UNITYSDK_OFFSET(0x1AFEAEC0)
#define SYSTEM_SECURITYUTILS_SECURECONSTRUCTORINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFEAEA0)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1AFEADD0)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1AFEAE90)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AFEADC0)
#define SYSTEM_SECURITYUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFEB3A0)

namespace System
{
	inline static constexpr unsigned int SecurityUtils_TypeDefinitionIndex = 2658;
