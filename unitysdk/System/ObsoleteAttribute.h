...
#define SYSTEM_OBSOLETEATTRIBUTE_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1AFBB170)
#define SYSTEM_OBSOLETEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFBB150)
#define SYSTEM_OBSOLETEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFBB160)
#define SYSTEM_OBSOLETEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFBB140)
