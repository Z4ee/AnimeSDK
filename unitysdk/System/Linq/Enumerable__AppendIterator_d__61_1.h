...
{
	inline static constexpr unsigned int Enumerable__AppendIterator_d__61_1_TypeDefinitionIndex = 3143;

	template <typename TSource>
	class Enumerable__AppendIterator_d__61_1 : public ::System::Object
	{
	public:
