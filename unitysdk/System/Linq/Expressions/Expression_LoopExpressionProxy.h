...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1BFE6E80)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_BREAKLABEL_OFFSET UNITYSDK_OFFSET(0x1BFE6EA0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1BFE6EC0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_CONTINUELABEL_OFFSET UNITYSDK_OFFSET(0x1BFE6EE0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1BFE6F00)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1BFE6F20)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1BFE6F30)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LOOPEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE6DE0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_LoopExpressionProxy_TypeDefinitionIndex = 4415;
