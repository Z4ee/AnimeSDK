...
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1C009A60)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C009A40)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C009A10)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1C009A50)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C009A90)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C009B20)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0099B0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int RuntimeVariablesExpression_TypeDefinitionIndex = 4535;
