...
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1C0750F0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_BYVALPARAMETERTYPEEQUAL_OFFSET UNITYSDK_OFFSET(0x1C074B90)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1C074310)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C074300)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_TYPEOPERAND_OFFSET UNITYSDK_OFFSET(0x1C074320)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C0742D0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_REDUCECONSTANTTYPEEQUAL_OFFSET UNITYSDK_OFFSET(0x1C074A40)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_REDUCETYPEEQUAL_OFFSET UNITYSDK_OFFSET(0x1C074330)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C075120)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0751B0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074260)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int TypeBinaryExpression_TypeDefinitionIndex = 4547;
