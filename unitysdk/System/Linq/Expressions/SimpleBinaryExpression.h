...
#define SYSTEM_LINQ_EXPRESSIONS_SIMPLEBINARYEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1F47BBA0)
#define SYSTEM_LINQ_EXPRESSIONS_SIMPLEBINARYEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1F47BBB0)
#define SYSTEM_LINQ_EXPRESSIONS_SIMPLEBINARYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F47BB20)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int SimpleBinaryExpression_TypeDefinitionIndex = 4398;
