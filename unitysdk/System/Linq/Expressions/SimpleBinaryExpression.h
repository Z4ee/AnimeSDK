...
#define SYSTEM_LINQ_EXPRESSIONS_SIMPLEBINARYEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1BD327A0)
#define SYSTEM_LINQ_EXPRESSIONS_SIMPLEBINARYEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1BD327B0)
#define SYSTEM_LINQ_EXPRESSIONS_SIMPLEBINARYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD32720)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int SimpleBinaryExpression_TypeDefinitionIndex = 4399;
