...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C005130)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C005150)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1C005170)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x1C005190)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C0051C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C0051D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_MEMBEREXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C005090)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_MemberExpressionProxy_TypeDefinitionIndex = 4416;
