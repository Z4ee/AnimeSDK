...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1B6CEE70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_CASES_OFFSET UNITYSDK_OFFSET(0x1B6CEE90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_COMPARISON_OFFSET UNITYSDK_OFFSET(0x1B6CEEB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1B6CEED0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_DEFAULTBODY_OFFSET UNITYSDK_OFFSET(0x1B6CEEF0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B6CEF10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_SWITCHVALUE_OFFSET UNITYSDK_OFFSET(0x1B6CEF20)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B6CEF40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CEDD0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_SwitchExpressionProxy_TypeDefinitionIndex = 4424;
