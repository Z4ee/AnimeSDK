...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1DAE2210)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_CASES_OFFSET UNITYSDK_OFFSET(0x1DAE2230)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_COMPARISON_OFFSET UNITYSDK_OFFSET(0x1DAE2250)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1DAE2270)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_DEFAULTBODY_OFFSET UNITYSDK_OFFSET(0x1DAE2290)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1DAE22B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_SWITCHVALUE_OFFSET UNITYSDK_OFFSET(0x1DAE22C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DAE22E0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAE2170)
