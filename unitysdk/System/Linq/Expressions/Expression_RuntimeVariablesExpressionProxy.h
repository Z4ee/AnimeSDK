...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_RUNTIMEVARIABLESEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1BF37BF0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_RUNTIMEVARIABLESEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1BF37C10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_RUNTIMEVARIABLESEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1BF37C30)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_RUNTIMEVARIABLESEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1BF37C40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_RUNTIMEVARIABLESEXPRESSIONPROXY_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1BF37C80)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_RUNTIMEVARIABLESEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF37B50)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_RuntimeVariablesExpressionProxy_TypeDefinitionIndex = 4422;
