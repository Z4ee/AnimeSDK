...
#define SYSTEM_LINQ_EXPRESSIONS_SCOPE1_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x185051C0)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPE1_GETORMAKEEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x18505230)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPE1_GET_EXPRESSIONCOUNT_OFFSET UNITYSDK_OFFSET(0x18505220)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPE1_REWRITE_OFFSET UNITYSDK_OFFSET(0x18505240)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPE1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x185050F0)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPE1__CTOR_OFFSET UNITYSDK_OFFSET(0x18505080)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Scope1_TypeDefinitionIndex = 3184;
