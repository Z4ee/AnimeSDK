...
#define SYSTEM_LINQ_EXPRESSIONS_BYREFASSIGNBINARYEXPRESSION_GET_ISBYREF_OFFSET UNITYSDK_OFFSET(0x1F51C8D0)
#define SYSTEM_LINQ_EXPRESSIONS_BYREFASSIGNBINARYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F51C860)
