...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1E304D00)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1E304D30)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1E304D50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1E304D70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1E304D90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E304DA0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INVOCATIONEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E304C60)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_InvocationExpressionProxy_TypeDefinitionIndex = 4410;
