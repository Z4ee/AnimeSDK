...
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1E07F5D0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1E07F5C0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1E07F590)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NEWEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1E07F5B0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1E07F5A0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E07F550)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCELISTINIT_OFFSET UNITYSDK_OFFSET(0x1E07FB30)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCEMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1E07FA00)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCEMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1E07F620)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCE_OFFSET UNITYSDK_OFFSET(0x1E07F600)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E07FF70)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E080000)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E07F4E0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int MemberInitExpression_TypeDefinitionIndex = 4508;
