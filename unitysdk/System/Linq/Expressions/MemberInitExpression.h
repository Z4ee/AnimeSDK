...
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x18502920)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NEWEXPRESSION_OFFSET UNITYSDK_OFFSET(0x18502910)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int MemberInitExpression_TypeDefinitionIndex = 3231;
