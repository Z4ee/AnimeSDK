...
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1F47AA20)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1F47AA10)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1F47A9E0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NEWEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1F47AA00)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1F47A9F0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1F47A9A0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCELISTINIT_OFFSET UNITYSDK_OFFSET(0x1F47AF70)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCEMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1F47AE40)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCEMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1F47AA60)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCE_OFFSET UNITYSDK_OFFSET(0x1F47AA50)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F47B3B0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F47B440)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F47A930)
