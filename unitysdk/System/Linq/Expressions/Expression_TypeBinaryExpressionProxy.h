...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C78F190)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C78F1B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1C78F1D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C78F1F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_TYPEOPERAND_OFFSET UNITYSDK_OFFSET(0x1C78F250)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C78F210)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C78F0F0)
