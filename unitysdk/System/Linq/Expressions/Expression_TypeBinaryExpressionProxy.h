...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1A3EC2B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1A3EC2D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A3EC2F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A3EC310)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_TYPEOPERAND_OFFSET UNITYSDK_OFFSET(0x1A3EC370)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A3EC330)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TYPEBINARYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EC210)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_TypeBinaryExpressionProxy_TypeDefinitionIndex = 4426;
