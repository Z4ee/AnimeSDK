...
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERMEMBERBINDING_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x19F3D7D0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int MemberMemberBinding_TypeDefinitionIndex = 3235;
