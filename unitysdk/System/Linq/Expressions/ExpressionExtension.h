...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_1_OFFSET UNITYSDK_OFFSET(0x1B8DF900)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_2_OFFSET UNITYSDK_OFFSET(0x1B8DFB10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_3_OFFSET UNITYSDK_OFFSET(0x1B8DFE00)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_4_OFFSET UNITYSDK_OFFSET(0x1B8E01C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_5_OFFSET UNITYSDK_OFFSET(0x1B8DF7F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B8DF6E0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_GETVALIDMETHODFORDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B8DF5F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_1_OFFSET UNITYSDK_OFFSET(0x1B8DE170)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_2_OFFSET UNITYSDK_OFFSET(0x1B8DE9F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_3_OFFSET UNITYSDK_OFFSET(0x1B8DEC40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_4_OFFSET UNITYSDK_OFFSET(0x1B8DEF00)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_5_OFFSET UNITYSDK_OFFSET(0x1B8DF240)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_6_OFFSET UNITYSDK_OFFSET(0x1B8E0670)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B8DE160)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_VALIDATEDYNAMICARGUMENT_1_OFFSET UNITYSDK_OFFSET(0x1B8E0940)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_VALIDATEDYNAMICARGUMENT_OFFSET UNITYSDK_OFFSET(0x1B8DF6D0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int ExpressionExtension_TypeDefinitionIndex = 4469;
