...
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_CHECKBREAK_OFFSET UNITYSDK_OFFSET(0x1DC4E9F0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_CONTAINSWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1DC52870)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_DEDENT_OFFSET UNITYSDK_OFFSET(0x1DC4E2A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_DUMPLABEL_OFFSET UNITYSDK_OFFSET(0x1DC51450)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETCONSTANTVALUESUFFIX_OFFSET UNITYSDK_OFFSET(0x1DC4FBD0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1DC4F3D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETFLOW_OFFSET UNITYSDK_OFFSET(0x1DC4E900)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLABELTARGETID_OFFSET UNITYSDK_OFFSET(0x1DC4E360)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLABELTARGETNAME_OFFSET UNITYSDK_OFFSET(0x1DC51610)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLAMBDAID_OFFSET UNITYSDK_OFFSET(0x1DC4E2C0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLAMBDANAME_OFFSET UNITYSDK_OFFSET(0x1DC52780)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETOPERATORPRECEDENCE_OFFSET UNITYSDK_OFFSET(0x1DC50100)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETPARAMID_OFFSET UNITYSDK_OFFSET(0x1DC4E310)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_BASE_OFFSET UNITYSDK_OFFSET(0x1DC4E210)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1DC4E240)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1DC4E250)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_INDENT_OFFSET UNITYSDK_OFFSET(0x1DC4E290)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_ISSIMPLEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DC4F580)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_NEEDSPARENTHESES_OFFSET UNITYSDK_OFFSET(0x1DC4F160)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1DC4E2B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUTMEMBER_OFFSET UNITYSDK_OFFSET(0x1DC4FDD0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_1_OFFSET UNITYSDK_OFFSET(0x1DC4E8E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_2_OFFSET UNITYSDK_OFFSET(0x1DC4E8F0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_3_OFFSET UNITYSDK_OFFSET(0x1DC4E790)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_OFFSET UNITYSDK_OFFSET(0x1DC4E780)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_PARENTHESIZEDVISIT_OFFSET UNITYSDK_OFFSET(0x1DC4F090)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_QUOTENAME_OFFSET UNITYSDK_OFFSET(0x1DC529D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITBINARY_OFFSET UNITYSDK_OFFSET(0x1DC4EAD0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITBLOCK_OFFSET UNITYSDK_OFFSET(0x1DC51080)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCATCHBLOCK_OFFSET UNITYSDK_OFFSET(0x1DC51D90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCONDITIONAL_OFFSET UNITYSDK_OFFSET(0x1DC4F630)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCONSTANT_OFFSET UNITYSDK_OFFSET(0x1DC4F870)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x1DC52380)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDECLARATIONS_OFFSET UNITYSDK_OFFSET(0x1DC4EA50)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDEFAULT_OFFSET UNITYSDK_OFFSET(0x1DC512A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITELEMENTINIT_OFFSET UNITYSDK_OFFSET(0x1DC505C0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITEXTENSION_OFFSET UNITYSDK_OFFSET(0x1DC52220)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITGOTO_OFFSET UNITYSDK_OFFSET(0x1DC514E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITINDEX_OFFSET UNITYSDK_OFFSET(0x1DC520A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITINVOCATION_OFFSET UNITYSDK_OFFSET(0x1DC4FFB0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLABEL_OFFSET UNITYSDK_OFFSET(0x1DC51330)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLISTINIT_OFFSET UNITYSDK_OFFSET(0x1DC506C0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLOOP_OFFSET UNITYSDK_OFFSET(0x1DC516C0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1DC50780)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1DC50A20)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERLISTBINDING_OFFSET UNITYSDK_OFFSET(0x1DC50840)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1DC50930)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBER_OFFSET UNITYSDK_OFFSET(0x1DC4FF60)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMETHODCALL_OFFSET UNITYSDK_OFFSET(0x1DC50140)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITNEWARRAY_OFFSET UNITYSDK_OFFSET(0x1DC50370)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITNEW_OFFSET UNITYSDK_OFFSET(0x1DC504A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITPARAMETER_OFFSET UNITYSDK_OFFSET(0x1DC4F2F0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITRUNTIMEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1DC4FD40)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITSWITCHCASE_OFFSET UNITYSDK_OFFSET(0x1DC518B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITSWITCH_OFFSET UNITYSDK_OFFSET(0x1DC51BE0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITTRY_OFFSET UNITYSDK_OFFSET(0x1DC51EF0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITTYPEBINARY_OFFSET UNITYSDK_OFFSET(0x1DC50AE0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITUNARY_OFFSET UNITYSDK_OFFSET(0x1DC50C40)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITELAMBDA_OFFSET UNITYSDK_OFFSET(0x1DC4E560)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1DC4E750)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITETO_1_OFFSET UNITYSDK_OFFSET(0x1DC4E450)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DC4E3B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x1DC4E9B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC4E1A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITDECLARATIONS_B__38_0_OFFSET UNITYSDK_OFFSET(0x1DC52A40)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITLISTINIT_B__58_0_OFFSET UNITYSDK_OFFSET(0x1DC52B30)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERINIT_B__62_0_OFFSET UNITYSDK_OFFSET(0x1DC52B60)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERLISTBINDING_B__60_0_OFFSET UNITYSDK_OFFSET(0x1DC52B40)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERMEMBERBINDING_B__61_0_OFFSET UNITYSDK_OFFSET(0x1DC52B50)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		::System::IO::TextWriter* _out; // 0x10
		::System::Collections::Generic::Queue_1<::System::Linq::Expressions::LambdaExpression*>* _lambdas; // 0x18
		::System::Collections::Generic::Stack_1<::System::Int32>* _stack; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::LambdaExpression*, ::System::Int32>* _lambdaIds; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::LabelTarget*, ::System::Int32>* _labelIds; // 0x30
		...
		::System::Linq::Expressions::DebugViewWriter_Flow _flow; // 0x44
