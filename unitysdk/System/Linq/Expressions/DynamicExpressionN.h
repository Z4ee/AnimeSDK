...
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSIONN_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BD22430)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSIONN_REWRITE_OFFSET UNITYSDK_OFFSET(0x1BD22470)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSIONN_SAMEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BD22300)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSIONN_SYSTEM_LINQ_EXPRESSIONS_IARGUMENTPROVIDER_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1BD22220)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSIONN_SYSTEM_LINQ_EXPRESSIONS_IARGUMENTPROVIDER_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BD22350)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSIONN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD1FA80)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int DynamicExpressionN_TypeDefinitionIndex = 4459;
