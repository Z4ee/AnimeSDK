...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1DC42C40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1DC42C60)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1DC42C80)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1DC42CA0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1DC42CB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DC42CD0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LABELEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC42BA0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_LabelExpressionProxy_TypeDefinitionIndex = 4411;
