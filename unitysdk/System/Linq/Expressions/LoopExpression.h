...
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1E70DC50)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1E70DC20)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_BREAKLABEL_OFFSET UNITYSDK_OFFSET(0x1E70DC30)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_CONTINUELABEL_OFFSET UNITYSDK_OFFSET(0x1E70DC40)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1E70DC10)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E70DBD0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E70DC80)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E70DD10)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E70DB60)
