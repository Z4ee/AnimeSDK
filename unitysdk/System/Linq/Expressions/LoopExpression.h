...
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1C3C9580)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1C3C9550)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_BREAKLABEL_OFFSET UNITYSDK_OFFSET(0x1C3C9560)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_CONTINUELABEL_OFFSET UNITYSDK_OFFSET(0x1C3C9570)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C3C9540)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C3C9500)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C3C95B0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3C9640)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3C9490)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int LoopExpression_TypeDefinitionIndex = 4502;
	...
	public:
		...
		::System::Linq::Expressions::LabelTarget* _BreakLabel_k__BackingField; // 0x20
