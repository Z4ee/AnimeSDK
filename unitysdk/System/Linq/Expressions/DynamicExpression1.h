...
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION1_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BD20BD0)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION1_REWRITE_OFFSET UNITYSDK_OFFSET(0x1BD20BE0)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION1_SAMEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BD20840)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION1_SYSTEM_LINQ_EXPRESSIONS_IARGUMENTPROVIDER_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1BD207B0)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION1_SYSTEM_LINQ_EXPRESSIONS_IARGUMENTPROVIDER_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BD20830)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION1__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD1FC40)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int DynamicExpression1_TypeDefinitionIndex = 4461;
