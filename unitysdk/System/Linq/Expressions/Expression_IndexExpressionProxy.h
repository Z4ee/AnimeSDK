...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BBDD3F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1BBDD440)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1BBDD460)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_INDEXER_OFFSET UNITYSDK_OFFSET(0x1BBDD480)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1BBDD4A0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_OBJECT_OFFSET UNITYSDK_OFFSET(0x1BBDD4B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1BBDD4D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_INDEXEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBDD350)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_IndexExpressionProxy_TypeDefinitionIndex = 4410;
