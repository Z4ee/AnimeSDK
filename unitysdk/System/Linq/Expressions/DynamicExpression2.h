...
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION2_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BD21210)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION2_REWRITE_OFFSET UNITYSDK_OFFSET(0x1BD21220)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION2_SAMEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1BD20CC0)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION2_SYSTEM_LINQ_EXPRESSIONS_IARGUMENTPROVIDER_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1BD20C20)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION2_SYSTEM_LINQ_EXPRESSIONS_IARGUMENTPROVIDER_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BD20CB0)
#define SYSTEM_LINQ_EXPRESSIONS_DYNAMICEXPRESSION2__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD1FE10)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int DynamicExpression2_TypeDefinitionIndex = 4463;
