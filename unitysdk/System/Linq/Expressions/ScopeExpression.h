...
#define SYSTEM_LINQ_EXPRESSIONS_SCOPEEXPRESSION_GETORMAKEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1DC47E60)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPEEXPRESSION_GET_VARIABLESLIST_OFFSET UNITYSDK_OFFSET(0x1DC47EA0)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPEEXPRESSION_REUSEORVALIDATEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1DC47EB0)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPEEXPRESSION_SAMEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1DC47E10)
#define SYSTEM_LINQ_EXPRESSIONS_SCOPEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC47DB0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int ScopeExpression_TypeDefinitionIndex = 4436;
