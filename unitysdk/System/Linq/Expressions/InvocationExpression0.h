...
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1FAEB360)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1FAEB300)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1FAEB3B0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_REWRITE_OFFSET UNITYSDK_OFFSET(0x1FAEB3C0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAEB290)
