...
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1C3C93D0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1C3C9370)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C3C9420)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0_REWRITE_OFFSET UNITYSDK_OFFSET(0x1C3C9430)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3C9300)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int InvocationExpression0_TypeDefinitionIndex = 4484;
