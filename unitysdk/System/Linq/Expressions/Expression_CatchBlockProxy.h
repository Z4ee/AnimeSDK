...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CATCHBLOCKPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1DC52C10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CATCHBLOCKPROXY_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x1DC52C30)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CATCHBLOCKPROXY_GET_TEST_OFFSET UNITYSDK_OFFSET(0x1DC52C50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CATCHBLOCKPROXY_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1DC52C70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CATCHBLOCKPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC52B70)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_CatchBlockProxy_TypeDefinitionIndex = 4403;
