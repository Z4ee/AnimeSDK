...
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1BBDD0C0)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_GETORMAKEEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1BBDD280)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_GET_EXPRESSIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBDD1A0)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_REWRITE_OFFSET UNITYSDK_OFFSET(0x1BBDD2C0)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_SAMEEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1BBDD070)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBDD010)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int BlockN_TypeDefinitionIndex = 4436;
