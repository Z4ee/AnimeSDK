...
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x17E31540)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_GETORMAKEEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x17E317A0)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_GET_EXPRESSIONCOUNT_OFFSET UNITYSDK_OFFSET(0x17E31670)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN_REWRITE_OFFSET UNITYSDK_OFFSET(0x17E317E0)
#define SYSTEM_LINQ_EXPRESSIONS_BLOCKN__CTOR_OFFSET UNITYSDK_OFFSET(0x17E314E0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int BlockN_TypeDefinitionIndex = 3189;
