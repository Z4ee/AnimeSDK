...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_GETINSTRUCTIONVIEWS_1_OFFSET UNITYSDK_OFFSET(0x1C06BA10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_GETINSTRUCTIONVIEWS_OFFSET UNITYSDK_OFFSET(0x1C06B970)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_GET_A0_OFFSET UNITYSDK_OFFSET(0x1C06B8E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06B840)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW__GETINSTRUCTIONVIEWS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1C06C090)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InstructionList_DebugView_TypeDefinitionIndex = 4705;
