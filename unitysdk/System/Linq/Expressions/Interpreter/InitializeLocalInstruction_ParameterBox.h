...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETERBOX_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x184CC660)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETERBOX_RUN_OFFSET UNITYSDK_OFFSET(0x184CC550)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETERBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x184CC540)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InitializeLocalInstruction_ParameterBox_TypeDefinitionIndex = 3498;
