...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETERBOX_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1E5075F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETERBOX_RUN_OFFSET UNITYSDK_OFFSET(0x1E5074E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETERBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5074D0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InitializeLocalInstruction_ParameterBox_TypeDefinitionIndex = 4784;
