...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED_CONVERTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1C1BD220)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED_CONVERTINT32_OFFSET UNITYSDK_OFFSET(0x1C1BCAD0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED_CONVERTINT64_OFFSET UNITYSDK_OFFSET(0x1C1BCD20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED_CONVERTUINT64_OFFSET UNITYSDK_OFFSET(0x1C1BCF90)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED_CONVERT_OFFSET UNITYSDK_OFFSET(0x1C1BC4E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1C1BC490)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_CHECKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BC4D0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NumericConvertInstruction_Checked_TypeDefinitionIndex = 3589;
