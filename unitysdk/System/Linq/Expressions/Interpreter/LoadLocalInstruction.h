...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LOADLOCALINSTRUCTION_BOXIFINDEXMATCHES_OFFSET UNITYSDK_OFFSET(0x1FAEA3B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LOADLOCALINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1FAEA2B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LOADLOCALINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1FAEA2A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LOADLOCALINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1FAEA2F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LOADLOCALINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAEA290)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int LoadLocalInstruction_TypeDefinitionIndex = 4769;
