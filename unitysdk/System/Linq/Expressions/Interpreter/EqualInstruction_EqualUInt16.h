...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_EQUALINSTRUCTION_EQUALUINT16_RUN_OFFSET UNITYSDK_OFFSET(0x1AD77D60)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_EQUALINSTRUCTION_EQUALUINT16__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD76500)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int EqualInstruction_EqualUInt16_TypeDefinitionIndex = 3355;
