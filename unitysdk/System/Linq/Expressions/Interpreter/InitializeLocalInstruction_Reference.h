...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_REFERENCE_BOXIFINDEXMATCHES_OFFSET UNITYSDK_OFFSET(0x19576C20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_REFERENCE_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x19576CF0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_REFERENCE_RUN_OFFSET UNITYSDK_OFFSET(0x19576BE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_REFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19576BD0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InitializeLocalInstruction_Reference_TypeDefinitionIndex = 3501;
