...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INDEXMETHODBYREFUPDATER_UNDEFINETEMPS_OFFSET UNITYSDK_OFFSET(0x19575EE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INDEXMETHODBYREFUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19575BA0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INDEXMETHODBYREFUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x19575B80)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int IndexMethodByRefUpdater_TypeDefinitionIndex = 3484;
	...
	public:
		...
		::System::Reflection::MethodInfo* _indexer; // 0x30
