...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_BOXIFINDEXMATCHES_OFFSET UNITYSDK_OFFSET(0x1F90BF50)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1F90BFE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_RUN_OFFSET UNITYSDK_OFFSET(0x1F90BF40)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F90BF30)
