...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_BOXIFINDEXMATCHES_OFFSET UNITYSDK_OFFSET(0x1C1C6310)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1C1C63A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_RUN_OFFSET UNITYSDK_OFFSET(0x1C1C6300)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C62F0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InitializeLocalInstruction_Parameter_TypeDefinitionIndex = 4786;
