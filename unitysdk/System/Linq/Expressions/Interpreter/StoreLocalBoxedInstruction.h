...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_STORELOCALBOXEDINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1FAEAF30)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_STORELOCALBOXEDINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1FAEAF40)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_STORELOCALBOXEDINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1FAEAF80)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_STORELOCALBOXEDINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAEAF20)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int StoreLocalBoxedInstruction_TypeDefinitionIndex = 4776;
