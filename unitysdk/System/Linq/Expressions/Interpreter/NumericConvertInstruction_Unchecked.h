...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1DC47460)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTINT32_OFFSET UNITYSDK_OFFSET(0x1DC46EC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTINT64_OFFSET UNITYSDK_OFFSET(0x1DC470A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTUINT64_OFFSET UNITYSDK_OFFSET(0x1DC47270)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERT_OFFSET UNITYSDK_OFFSET(0x1DC46900)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1DC468B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC468F0)
