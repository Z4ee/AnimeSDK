...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1C1BE4E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTINT32_OFFSET UNITYSDK_OFFSET(0x1C1BDEB0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTINT64_OFFSET UNITYSDK_OFFSET(0x1C1BE0C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTUINT64_OFFSET UNITYSDK_OFFSET(0x1C1BE2C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERT_OFFSET UNITYSDK_OFFSET(0x1C1BD8C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1C1BD870)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BD8B0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NumericConvertInstruction_Unchecked_TypeDefinitionIndex = 3588;
