...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEGATECHECKEDINSTRUCTION_NEGATECHECKEDINT64_RUN_OFFSET UNITYSDK_OFFSET(0x1C1B6AC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEGATECHECKEDINSTRUCTION_NEGATECHECKEDINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B6570)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NegateCheckedInstruction_NegateCheckedInt64_TypeDefinitionIndex = 3548;
