...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYINITINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BD30990)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYINITINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1BD309B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYINITINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BD309A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYINITINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1BD309F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYINITINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD30980)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NewArrayInitInstruction_TypeDefinitionIndex = 4576;
