...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYBOUNDSINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BFEA730)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYBOUNDSINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1BFEA750)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYBOUNDSINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BFEA740)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYBOUNDSINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1BFEA790)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWARRAYBOUNDSINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFEA720)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NewArrayBoundsInstruction_TypeDefinitionIndex = 4578;
