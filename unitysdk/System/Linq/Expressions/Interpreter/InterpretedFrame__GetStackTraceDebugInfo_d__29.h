...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AFEB370)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAMEINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AFEB510)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAMEINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AFEB460)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AFEB590)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AFEB4C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AFEB470)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFEB360)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEAA80)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InterpretedFrame__GetStackTraceDebugInfo_d__29_TypeDefinitionIndex = 3437;

	class InterpretedFrame__GetStackTraceDebugInfo_d__29 : public ::System::Object
	{
	public:
		::System::Linq::Expressions::Interpreter::InterpretedFrame* __4__this; // 0x10
		::System::Linq::Expressions::Interpreter::InterpretedFrame* _frame_5__1; // 0x18
		::System::Linq::Expressions::Interpreter::InterpretedFrameInfo __2__current; // 0x20
