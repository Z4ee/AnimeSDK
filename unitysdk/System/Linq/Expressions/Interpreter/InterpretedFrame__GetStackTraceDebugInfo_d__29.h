...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BDAC8D0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAMEINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BDACA60)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAMEINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BDAC9B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BDACAE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BDACA10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BDAC9C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BDAC8C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INTERPRETEDFRAME__GETSTACKTRACEDEBUGINFO_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDAC8A0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InterpretedFrame__GetStackTraceDebugInfo_d__29_TypeDefinitionIndex = 4708;
