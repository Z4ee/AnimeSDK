...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NULLABLEMETHODCALLINSTRUCTION_EQUALSCLASS_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1C1BB7E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NULLABLEMETHODCALLINSTRUCTION_EQUALSCLASS_RUN_OFFSET UNITYSDK_OFFSET(0x1C1BB7F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NULLABLEMETHODCALLINSTRUCTION_EQUALSCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BB6A0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NullableMethodCallInstruction_EqualsClass_TypeDefinitionIndex = 3640;
