...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DIVINSTRUCTION_DIVSINGLE_RUN_OFFSET UNITYSDK_OFFSET(0x1956BC30)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DIVINSTRUCTION_DIVSINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1956B510)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int DivInstruction_DivSingle_TypeDefinitionIndex = 3349;
