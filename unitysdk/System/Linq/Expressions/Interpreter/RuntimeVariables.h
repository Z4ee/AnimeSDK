...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLES_CREATE_OFFSET UNITYSDK_OFFSET(0x1E0F57A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E0F5560)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E0F5580)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E0F5680)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0F5550)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int RuntimeVariables_TypeDefinitionIndex = 4889;
