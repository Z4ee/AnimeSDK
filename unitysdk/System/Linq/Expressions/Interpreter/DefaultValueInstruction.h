...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEFAULTVALUEINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1956A720)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEFAULTVALUEINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1956A710)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEFAULTVALUEINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1956A760)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEFAULTVALUEINSTRUCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1956A800)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEFAULTVALUEINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1956A700)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int DefaultValueInstruction_TypeDefinitionIndex = 3341;
