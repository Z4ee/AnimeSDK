...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO_DEBUGINFOCOMPARER_SYSTEM_COLLECTIONS_GENERIC_ICOMPARER_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO__COMPARE_OFFSET UNITYSDK_OFFSET(0x1BDABAC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO_DEBUGINFOCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDABB00)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int DebugInfo_DebugInfoComparer_TypeDefinitionIndex = 4753;
