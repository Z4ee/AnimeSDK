...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ADDHANDLEREXIT_OFFSET UNITYSDK_OFFSET(0x1EEF4BD0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ADDTRYSTART_OFFSET UNITYSDK_OFFSET(0x1EEF4B30)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ANALYZE_OFFSET UNITYSDK_OFFSET(0x1EEF4170)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_DEDENT_OFFSET UNITYSDK_OFFSET(0x1EEF4C80)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_EMITEXITS_OFFSET UNITYSDK_OFFSET(0x1EEF56F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_INDENT_OFFSET UNITYSDK_OFFSET(0x1EEF4C40)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EEF4CC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF3F70)
...
namespace System::Linq::Expressions::Interpreter
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _handlerExit; // 0x10
		::System::String* _indent; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>* _handlerEnter; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _tryStart; // 0x28
		::System::Linq::Expressions::Interpreter::Interpreter* _interpreter; // 0x30
