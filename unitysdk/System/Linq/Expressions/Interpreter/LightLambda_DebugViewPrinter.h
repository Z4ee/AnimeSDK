...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ADDHANDLEREXIT_OFFSET UNITYSDK_OFFSET(0x1B6D19F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ADDTRYSTART_OFFSET UNITYSDK_OFFSET(0x1B6D1950)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ANALYZE_OFFSET UNITYSDK_OFFSET(0x1B6D0F90)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_DEDENT_OFFSET UNITYSDK_OFFSET(0x1B6D1AA0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_EMITEXITS_OFFSET UNITYSDK_OFFSET(0x1B6D2500)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_INDENT_OFFSET UNITYSDK_OFFSET(0x1B6D1A60)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B6D1AE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D0D90)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int LightLambda_DebugViewPrinter_TypeDefinitionIndex = 4766;

	class LightLambda_DebugViewPrinter : public ::System::Object
	{
	public:
		::System::String* _indent; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _handlerExit; // 0x18
		::System::Linq::Expressions::Interpreter::Interpreter* _interpreter; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>* _handlerEnter; // 0x28
