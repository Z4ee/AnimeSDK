...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CASTINSTRUCTION_CASTINSTRUCTIONNOT_CREATE_OFFSET UNITYSDK_OFFSET(0x1BFE8960)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CASTINSTRUCTION_CASTINSTRUCTIONNOT_RUN_OFFSET UNITYSDK_OFFSET(0x1BFE8A20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CASTINSTRUCTION_CASTINSTRUCTIONNOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE8950)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int CastInstruction_CastInstructionNoT_TypeDefinitionIndex = 4925;
