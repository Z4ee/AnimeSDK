...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_MULINSTRUCTION_MULUINT16_RUN_OFFSET UNITYSDK_OFFSET(0x184F06A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_MULINSTRUCTION_MULUINT16__CTOR_OFFSET UNITYSDK_OFFSET(0x184EFD10)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int MulInstruction_MulUInt16_TypeDefinitionIndex = 3520;
