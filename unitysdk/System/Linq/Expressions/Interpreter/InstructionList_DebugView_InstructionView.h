...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW_GETDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xA61BC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW_GETNAME_OFFSET UNITYSDK_OFFSET(0xA61BB0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW_GETVALUE_OFFSET UNITYSDK_OFFSET(0x3E3F20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA61BD0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InstructionList_DebugView_InstructionView_TypeDefinitionIndex = 4705;
