...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONARRAY_DEBUGVIEW_GETINSTRUCTIONVIEWS_OFFSET UNITYSDK_OFFSET(0x1BF381B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONARRAY_DEBUGVIEW_GET_A0_OFFSET UNITYSDK_OFFSET(0x1BF38140)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONARRAY_DEBUGVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF38070)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONARRAY_DEBUGVIEW__GETINSTRUCTIONVIEWS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1BF38230)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int InstructionArray_DebugView_TypeDefinitionIndex = 4703;
