...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GETDEBUGCOOKIE_OFFSET UNITYSDK_OFFSET(0x1BDCEF10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_CONSUMEDCONTINUATIONS_OFFSET UNITYSDK_OFFSET(0x1BDCEE00)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BDCEDE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_CONTINUATIONSBALANCE_OFFSET UNITYSDK_OFFSET(0x1BDCEE60)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_PRODUCEDCONTINUATIONS_OFFSET UNITYSDK_OFFSET(0x1BDCEE10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BDCEDF0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_STACKBALANCE_OFFSET UNITYSDK_OFFSET(0x1BDCEE20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_NULLCHECK_OFFSET UNITYSDK_OFFSET(0x1BDCEF20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_TODEBUGSTRING_OFFSET UNITYSDK_OFFSET(0x1BDCEEF0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BDCEE90)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCD830)
