...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LOCALVARIABLES_VARIABLESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B1EB0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int LocalVariables_VariableScope_TypeDefinitionIndex = 3513;

	class LocalVariables_VariableScope : public ::System::Object
	{
	public:
		::System::Linq::Expressions::Interpreter::LocalVariable* Variable; // 0x10
		::System::Collections::Generic::List_1<::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope*>* ChildScopes; // 0x18
		::System::Linq::Expressions::Interpreter::LocalVariables_VariableScope* Parent; // 0x20
