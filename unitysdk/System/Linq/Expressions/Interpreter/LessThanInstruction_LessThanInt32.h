...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LESSTHANINSTRUCTION_LESSTHANINT32_RUN_OFFSET UNITYSDK_OFFSET(0x184D5060)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LESSTHANINSTRUCTION_LESSTHANINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x184D4A60)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int LessThanInstruction_LessThanInt32_TypeDefinitionIndex = 3441;
