...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_EXCEPTIONFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x184C63E0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int ExceptionFilter_TypeDefinitionIndex = 3461;
