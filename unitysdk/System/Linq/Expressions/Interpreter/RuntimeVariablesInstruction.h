...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLESINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1ADAFDD0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLESINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1ADAFDE0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLESINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1ADAFDC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLESINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1ADAFE20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_RUNTIMEVARIABLESINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAFDB0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int RuntimeVariablesInstruction_TypeDefinitionIndex = 3505;
