...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BFE8450)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1BFE8470)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1BFE8460)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1BFE84B0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE8440)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int AssignLocalBoxedInstruction_TypeDefinitionIndex = 4776;
