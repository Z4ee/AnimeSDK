...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x184BB170)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x184BB190)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x184BB180)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x184BB1D0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_ASSIGNLOCALBOXEDINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x184BB160)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int AssignLocalBoxedInstruction_TypeDefinitionIndex = 3489;
