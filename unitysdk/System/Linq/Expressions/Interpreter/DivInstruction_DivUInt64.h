...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DIVINSTRUCTION_DIVUINT64_RUN_OFFSET UNITYSDK_OFFSET(0x1AD74820)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DIVINSTRUCTION_DIVUINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD73BA0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int DivInstruction_DivUInt64_TypeDefinitionIndex = 3344;
