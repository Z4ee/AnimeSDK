...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_PARAMETERBYREFUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E75D3E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_PARAMETERBYREFUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E75D3D0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int ParameterByRefUpdater_TypeDefinitionIndex = 3488;
