...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NOTEQUALINSTRUCTION_NOTEQUALINT64_RUN_OFFSET UNITYSDK_OFFSET(0x1C06C9F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NOTEQUALINSTRUCTION_NOTEQUALINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06CB60)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int NotEqualInstruction_NotEqualInt64_TypeDefinitionIndex = 4837;
