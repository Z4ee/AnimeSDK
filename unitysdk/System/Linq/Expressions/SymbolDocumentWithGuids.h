...
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BE37600)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_LANGUAGEVENDOR_OFFSET UNITYSDK_OFFSET(0x1BE375F0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x1BE375E0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE373A0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BE374C0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE37290)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int SymbolDocumentWithGuids_TypeDefinitionIndex = 4545;

	class SymbolDocumentWithGuids : public ::System::Linq::Expressions::SymbolDocumentInfo
	{
	public:
		::System::Guid _DocumentType_k__BackingField; // 0x18
		::System::Guid _LanguageVendor_k__BackingField; // 0x28
