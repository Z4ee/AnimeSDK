...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C78F310)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C78F340)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_ISLIFTEDTONULL_OFFSET UNITYSDK_OFFSET(0x1C78F380)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_ISLIFTED_OFFSET UNITYSDK_OFFSET(0x1C78F360)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1C78F410)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C78F430)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x1C78F450)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C78F470)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C78F270)
