...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1A3EC430)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1A3EC460)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_ISLIFTEDTONULL_OFFSET UNITYSDK_OFFSET(0x1A3EC4A0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_ISLIFTED_OFFSET UNITYSDK_OFFSET(0x1A3EC480)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A3EC530)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A3EC550)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x1A3EC570)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A3EC590)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_UNARYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EC390)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_UnaryExpressionProxy_TypeDefinitionIndex = 4427;
