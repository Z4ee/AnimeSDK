...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C004FC0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C004FE0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_KIND_OFFSET UNITYSDK_OFFSET(0x1C005000)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C005020)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1C005030)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C005050)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C005070)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_GOTOEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C004F20)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_GotoExpressionProxy_TypeDefinitionIndex = 4409;
