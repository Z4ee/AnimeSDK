...
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1BDAF180)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ENDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1BDAF160)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ENDLINE_OFFSET UNITYSDK_OFFSET(0x1BDAF150)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ISCLEAR_OFFSET UNITYSDK_OFFSET(0x1BDAF170)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_STARTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1BDAF140)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_STARTLINE_OFFSET UNITYSDK_OFFSET(0x1BDAF130)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDAF0B0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int SpanDebugInfoExpression_TypeDefinitionIndex = 4453;

	class SpanDebugInfoExpression : public ::System::Linq::Expressions::DebugInfoExpression
	{
	public:
		::System::Int32 _startColumn; // 0x18
		::System::Int32 _endLine; // 0x1C
		::System::Int32 _endColumn; // 0x20
		::System::Int32 _startLine; // 0x24
