...
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1F51D860)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x1F51DBE0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETNEXTTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1F51D170)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKECALLSITEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1F51DF70)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKEDELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1F51C8E0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKENEWCUSTOMDELEGATE_OFFSET UNITYSDK_OFFSET(0x1F51D810)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKENEWDELEGATE_OFFSET UNITYSDK_OFFSET(0x1F51CD80)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_NEXTTYPEINFO_1_OFFSET UNITYSDK_OFFSET(0x1F51CBC0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_NEXTTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1F51D030)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_TRYMAKEVBSTYLEDCALLSITE_OFFSET UNITYSDK_OFFSET(0x1F51D2A0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F51E1E0)
