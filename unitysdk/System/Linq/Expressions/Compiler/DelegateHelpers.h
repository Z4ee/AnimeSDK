...
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1BDCC580)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x1BDCC950)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETNEXTTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1BDCBE70)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKECALLSITEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1BDCCD20)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKEDELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1BDCB5D0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKENEWCUSTOMDELEGATE_OFFSET UNITYSDK_OFFSET(0x1BDCC530)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKENEWDELEGATE_OFFSET UNITYSDK_OFFSET(0x1BDCBA80)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_NEXTTYPEINFO_1_OFFSET UNITYSDK_OFFSET(0x1BDCB8B0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_NEXTTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1BDCBD30)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_TRYMAKEVBSTYLEDCALLSITE_OFFSET UNITYSDK_OFFSET(0x1BDCBFA0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BDCCF90)

namespace System::Linq::Expressions::Compiler
{
	inline static constexpr unsigned int DelegateHelpers_TypeDefinitionIndex = 4939;
