...
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_TYPEINFOEXTENSIONS_MAKEDELEGATETYPE_1_OFFSET UNITYSDK_OFFSET(0x1F7C1100)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_TYPEINFOEXTENSIONS_MAKEDELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1F7C10F0)
