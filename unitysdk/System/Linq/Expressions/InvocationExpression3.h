...
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION3_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1F5A15F0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION3_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1F5A15E0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION3_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1F5A1680)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION3_REWRITE_OFFSET UNITYSDK_OFFSET(0x1F5A1690)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION3__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5A1560)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int InvocationExpression3_TypeDefinitionIndex = 4486;
