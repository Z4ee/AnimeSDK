...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1FAE8C50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1FAE8C70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1FAE8C90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_FAULT_OFFSET UNITYSDK_OFFSET(0x1FAE8CB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_FINALLY_OFFSET UNITYSDK_OFFSET(0x1FAE8CD0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_HANDLERS_OFFSET UNITYSDK_OFFSET(0x1FAE8CF0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1FAE8D10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1FAE8D20)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAE8BB0)
