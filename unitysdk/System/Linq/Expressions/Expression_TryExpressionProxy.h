...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1C3C6CF0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C3C6D10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C3C6D30)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_FAULT_OFFSET UNITYSDK_OFFSET(0x1C3C6D50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_FINALLY_OFFSET UNITYSDK_OFFSET(0x1C3C6D70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_HANDLERS_OFFSET UNITYSDK_OFFSET(0x1C3C6D90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C3C6DB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C3C6DC0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3C6C50)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_TryExpressionProxy_TypeDefinitionIndex = 4425;
