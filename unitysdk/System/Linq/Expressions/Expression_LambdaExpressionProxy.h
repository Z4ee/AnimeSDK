...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1C1C4E50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C1C4E70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C1C4E90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C1C4EB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C1C4EF0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C1C4F00)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1C1C4F40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_TAILCALL_OFFSET UNITYSDK_OFFSET(0x1C1C4FA0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C1C4FE0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_LAMBDAEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C4DB0)
