...
#define SYSTEM_LINQ_EXPRESSIONS_NEWARRAYBOUNDSEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C1C9BC0)
#define SYSTEM_LINQ_EXPRESSIONS_NEWARRAYBOUNDSEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C9AE0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int NewArrayBoundsExpression_TypeDefinitionIndex = 3257;
