...
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B8E62D0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1B8E62A0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_LANGUAGEVENDOR_OFFSET UNITYSDK_OFFSET(0x1B8E62C0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x1B8E62B0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B8E6330)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B8E6360)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E6200)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int SymbolDocumentInfo_TypeDefinitionIndex = 4544;
