...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_NEWARRAYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1C1C50C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_NEWARRAYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1C1C50E0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_NEWARRAYEXPRESSIONPROXY_GET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1C1C5100)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_NEWARRAYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1C1C5120)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_NEWARRAYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C1C5150)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_NEWARRAYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C5020)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_NewArrayExpressionProxy_TypeDefinitionIndex = 4419;
