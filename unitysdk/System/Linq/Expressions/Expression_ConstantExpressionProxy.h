...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CONSTANTEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1BDCD070)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CONSTANTEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1BDCD090)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CONSTANTEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1BDCD0B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CONSTANTEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1BDCD0C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CONSTANTEXPRESSIONPROXY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BDCD100)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_CONSTANTEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCCFD0)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int Expression_ConstantExpressionProxy_TypeDefinitionIndex = 4406;
