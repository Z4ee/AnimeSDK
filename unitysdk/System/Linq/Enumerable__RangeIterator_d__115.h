...
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD3BD70)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_INT32__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD3BE50)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_INT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD3BDC0)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD3BEB0)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD3BE20)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD3BDD0)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD3BD60)
#define SYSTEM_LINQ_ENUMERABLE__RANGEITERATOR_D__115__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD39DB0)

namespace System::Linq
{
	inline static constexpr unsigned int Enumerable__RangeIterator_d__115_TypeDefinitionIndex = 3149;
