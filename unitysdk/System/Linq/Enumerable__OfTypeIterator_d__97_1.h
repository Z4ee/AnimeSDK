...
{
	inline static constexpr unsigned int Enumerable__OfTypeIterator_d__97_1_TypeDefinitionIndex = 3151;

	template <typename TResult>
	class Enumerable__OfTypeIterator_d__97_1 : public ::System::Object
	{
	public:
