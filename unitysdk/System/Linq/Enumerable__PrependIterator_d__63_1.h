...
{
	inline static constexpr unsigned int Enumerable__PrependIterator_d__63_1_TypeDefinitionIndex = 4359;

	template <typename TSource>
	class Enumerable__PrependIterator_d__63_1 : public ::System::Object
	{
	public:
