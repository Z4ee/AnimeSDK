...
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x178D1A60)
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x178D1B10)
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x178D0500)
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178D1A40)
