...
#define SYSTEM___FILTERS_FILTERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1865F420)
#define SYSTEM___FILTERS_FILTERIGNORECASE_OFFSET UNITYSDK_OFFSET(0x1865F990)
#define SYSTEM___FILTERS_FILTERNAME_OFFSET UNITYSDK_OFFSET(0x1865F810)
#define SYSTEM___FILTERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1865FB20)
#define SYSTEM___FILTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1865FB10)
