...
#define SYSTEM_UNHANDLEDEXCEPTIONEVENTARGS_GET_EXCEPTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1EEB1760)
#define SYSTEM_UNHANDLEDEXCEPTIONEVENTARGS_GET_ISTERMINATING_OFFSET UNITYSDK_OFFSET(0x1EEB1770)
#define SYSTEM_UNHANDLEDEXCEPTIONEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEB1720)
