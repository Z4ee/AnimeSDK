...
#define SYSTEM_CLRCONFIG_CHECKTHROWUNOBSERVEDTASKEXCEPTIONS_OFFSET UNITYSDK_OFFSET(0x1DDD4E20)
#define SYSTEM_CLRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDD4E30)
