...
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1C30BF30)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1C30C0E0)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_3_OFFSET UNITYSDK_OFFSET(0x1C30C110)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_4_OFFSET UNITYSDK_OFFSET(0x1C30C140)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_5_OFFSET UNITYSDK_OFFSET(0x1C30C150)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C30BF00)
#define SYSTEM_ACTIVATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C30BEF0)
