...
#define SYSTEM_RANDOM_GETSAMPLEFORLARGERANGE_OFFSET UNITYSDK_OFFSET(0x1D0B2BF0)
#define SYSTEM_RANDOM_INTERNALSAMPLE_OFFSET UNITYSDK_OFFSET(0x1D0B2B30)
#define SYSTEM_RANDOM_NEXTBYTES_OFFSET UNITYSDK_OFFSET(0x1D0B2E70)
#define SYSTEM_RANDOM_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D0B2E60)
#define SYSTEM_RANDOM_NEXT_1_OFFSET UNITYSDK_OFFSET(0x1D0B2C30)
#define SYSTEM_RANDOM_NEXT_2_OFFSET UNITYSDK_OFFSET(0x1D0B2D90)
#define SYSTEM_RANDOM_NEXT_OFFSET UNITYSDK_OFFSET(0x1D0B2BE0)
#define SYSTEM_RANDOM_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1D0B2B10)
#define SYSTEM_RANDOM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D0B2830)
#define SYSTEM_RANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B27E0)

namespace System
{
	inline static constexpr unsigned int Random_TypeDefinitionIndex = 305;
