...
#define SYSTEM_GUID_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x3AEEF10)
#define SYSTEM_GUID_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3AEEF00)
#define SYSTEM_GUID_EATALLWHITESPACE_OFFSET UNITYSDK_OFFSET(0x18D9FEB0)
#define SYSTEM_GUID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3AEEE80)
#define SYSTEM_GUID_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AEEE00)
#define SYSTEM_GUID_FASTNEWGUIDARRAY_OFFSET UNITYSDK_OFFSET(0x18DA16A0)
#define SYSTEM_GUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AEEDD0)
#define SYSTEM_GUID_GETRESULT_OFFSET UNITYSDK_OFFSET(0x3AEEEF0)
#define SYSTEM_GUID_HEXSTOCHARS_1_OFFSET UNITYSDK_OFFSET(0x18DA1470)
#define SYSTEM_GUID_HEXSTOCHARS_OFFSET UNITYSDK_OFFSET(0x18DA13F0)
#define SYSTEM_GUID_HEXTOCHAR_OFFSET UNITYSDK_OFFSET(0x18DA13E0)
#define SYSTEM_GUID_ISHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x18D9FFB0)
#define SYSTEM_GUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x18DA1520)
#define SYSTEM_GUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18DA12E0)
#define SYSTEM_GUID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18DA1350)
#define SYSTEM_GUID_PARSEEXACT_OFFSET UNITYSDK_OFFSET(0x18D9EB00)
#define SYSTEM_GUID_PARSE_OFFSET UNITYSDK_OFFSET(0x18D9E9F0)
#define SYSTEM_GUID_STRINGTOINT_1_OFFSET UNITYSDK_OFFSET(0x18DA0140)
#define SYSTEM_GUID_STRINGTOINT_2_OFFSET UNITYSDK_OFFSET(0x18DA01D0)
#define SYSTEM_GUID_STRINGTOINT_OFFSET UNITYSDK_OFFSET(0x18DA00B0)
#define SYSTEM_GUID_STRINGTOLONG_1_OFFSET UNITYSDK_OFFSET(0x18DA0130)
#define SYSTEM_GUID_STRINGTOLONG_2_OFFSET UNITYSDK_OFFSET(0x18DA03A0)
#define SYSTEM_GUID_STRINGTOLONG_OFFSET UNITYSDK_OFFSET(0x18DA0380)
#define SYSTEM_GUID_STRINGTOSHORT_1_OFFSET UNITYSDK_OFFSET(0x18DA0190)
#define SYSTEM_GUID_STRINGTOSHORT_2_OFFSET UNITYSDK_OFFSET(0x18DA0150)
#define SYSTEM_GUID_STRINGTOSHORT_OFFSET UNITYSDK_OFFSET(0x18DA00E0)
#define SYSTEM_GUID_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x3AEEDB0)
#define SYSTEM_GUID_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3AEEFC0)
#define SYSTEM_GUID_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x3AEEFC0)
#define SYSTEM_GUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3AEEDC0)
#define SYSTEM_GUID_TRYPARSEEXACT_OFFSET UNITYSDK_OFFSET(0x18D9EDA0)
#define SYSTEM_GUID_TRYPARSEGUIDWITHDASHES_OFFSET UNITYSDK_OFFSET(0x18D9EF90)
#define SYSTEM_GUID_TRYPARSEGUIDWITHHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x18D9F440)
#define SYSTEM_GUID_TRYPARSEGUIDWITHNOSTYLE_OFFSET UNITYSDK_OFFSET(0x18D9FAA0)
#define SYSTEM_GUID_TRYPARSEGUID_OFFSET UNITYSDK_OFFSET(0x18D9E240)
#define SYSTEM_GUID_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x18D9EAA0)
#define SYSTEM_GUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x18DA1810)
#define SYSTEM_GUID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3AEED20)
#define SYSTEM_GUID__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3AEED90)
#define SYSTEM_GUID__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3AEED20)
#define SYSTEM_GUID__CTOR_4_OFFSET UNITYSDK_OFFSET(0x3AEEDA0)
#define SYSTEM_GUID__CTOR_OFFSET UNITYSDK_OFFSET(0x3AEED10)
...
namespace System
{
	...
	struct alignas(4) Guid
	{
		...
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x2BB0);
		}
		static ::System::Security::Cryptography::RandomNumberGenerator** StaticGet__rng()
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x2BB8);
		}
		static ::System::Object** StaticGet__rngAccess()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x2BC0);
		}
		static ::System::Guid* StaticGet_Empty()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0xFB0);
		}
