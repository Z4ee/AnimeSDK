...
#define SYSTEM_GUID_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x3953020)
#define SYSTEM_GUID_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3953010)
#define SYSTEM_GUID_EATALLWHITESPACE_OFFSET UNITYSDK_OFFSET(0x172DF440)
#define SYSTEM_GUID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3952F90)
#define SYSTEM_GUID_EQUALS_OFFSET UNITYSDK_OFFSET(0x3952F10)
#define SYSTEM_GUID_FASTNEWGUIDARRAY_OFFSET UNITYSDK_OFFSET(0x172E0C30)
#define SYSTEM_GUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3952EE0)
#define SYSTEM_GUID_GETRESULT_OFFSET UNITYSDK_OFFSET(0x3953000)
#define SYSTEM_GUID_HEXSTOCHARS_1_OFFSET UNITYSDK_OFFSET(0x172E0A00)
#define SYSTEM_GUID_HEXSTOCHARS_OFFSET UNITYSDK_OFFSET(0x172E0980)
#define SYSTEM_GUID_HEXTOCHAR_OFFSET UNITYSDK_OFFSET(0x172E0970)
#define SYSTEM_GUID_ISHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x172DF540)
#define SYSTEM_GUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x172E0AB0)
#define SYSTEM_GUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x172E0870)
#define SYSTEM_GUID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x172E08E0)
#define SYSTEM_GUID_PARSEEXACT_OFFSET UNITYSDK_OFFSET(0x172DE090)
#define SYSTEM_GUID_PARSE_OFFSET UNITYSDK_OFFSET(0x172DDF80)
#define SYSTEM_GUID_STRINGTOINT_1_OFFSET UNITYSDK_OFFSET(0x172DF6D0)
#define SYSTEM_GUID_STRINGTOINT_2_OFFSET UNITYSDK_OFFSET(0x172DF760)
#define SYSTEM_GUID_STRINGTOINT_OFFSET UNITYSDK_OFFSET(0x172DF640)
#define SYSTEM_GUID_STRINGTOLONG_1_OFFSET UNITYSDK_OFFSET(0x172DF6C0)
#define SYSTEM_GUID_STRINGTOLONG_2_OFFSET UNITYSDK_OFFSET(0x172DF930)
#define SYSTEM_GUID_STRINGTOLONG_OFFSET UNITYSDK_OFFSET(0x172DF910)
#define SYSTEM_GUID_STRINGTOSHORT_1_OFFSET UNITYSDK_OFFSET(0x172DF720)
#define SYSTEM_GUID_STRINGTOSHORT_2_OFFSET UNITYSDK_OFFSET(0x172DF6E0)
#define SYSTEM_GUID_STRINGTOSHORT_OFFSET UNITYSDK_OFFSET(0x172DF670)
#define SYSTEM_GUID_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x3952EC0)
#define SYSTEM_GUID_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x39530D0)
#define SYSTEM_GUID_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x39530D0)
#define SYSTEM_GUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3952ED0)
#define SYSTEM_GUID_TRYPARSEEXACT_OFFSET UNITYSDK_OFFSET(0x172DE330)
#define SYSTEM_GUID_TRYPARSEGUIDWITHDASHES_OFFSET UNITYSDK_OFFSET(0x172DE520)
#define SYSTEM_GUID_TRYPARSEGUIDWITHHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x172DE9D0)
#define SYSTEM_GUID_TRYPARSEGUIDWITHNOSTYLE_OFFSET UNITYSDK_OFFSET(0x172DF030)
#define SYSTEM_GUID_TRYPARSEGUID_OFFSET UNITYSDK_OFFSET(0x172DD7D0)
#define SYSTEM_GUID_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x172DE030)
#define SYSTEM_GUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x172E0DA0)
#define SYSTEM_GUID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3952E30)
#define SYSTEM_GUID__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3952EA0)
#define SYSTEM_GUID__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3952E30)
#define SYSTEM_GUID__CTOR_4_OFFSET UNITYSDK_OFFSET(0x3952EB0)
#define SYSTEM_GUID__CTOR_OFFSET UNITYSDK_OFFSET(0x3952E20)
...
namespace System
{
	...
	struct alignas(4) Guid
	{
		...
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x1B90);
		}
		static ::System::Security::Cryptography::RandomNumberGenerator** StaticGet__fastRng()
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x1B98);
		}
		static ::System::Object** StaticGet__rngAccess()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x1BA0);
		}
		static ::System::Guid* StaticGet_Empty()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0xB90);
		}
