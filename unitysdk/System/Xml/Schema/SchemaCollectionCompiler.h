...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_BUILDPARTICLECONTENTMODEL_OFFSET UNITYSDK_OFFSET(0x1AB21E50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATEEFFECTIVETOTALRANGE_OFFSET UNITYSDK_OFFSET(0x1AB202C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATESEQUENCERANGE_OFFSET UNITYSDK_OFFSET(0x1AB21480)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEALL_OFFSET UNITYSDK_OFFSET(0x1AB1D000)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZECHOICE_OFFSET UNITYSDK_OFFSET(0x1AB1D830)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1AB1C5D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEGROUPREF_OFFSET UNITYSDK_OFFSET(0x1AB1C780)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1AB17090)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZESEQUENCE_OFFSET UNITYSDK_OFFSET(0x1AB1E1A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKPARTICLEDERIVATION_OFFSET UNITYSDK_OFFSET(0x1AB16A70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKSUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x1AB16B60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKUNIONTYPE_OFFSET UNITYSDK_OFFSET(0x1AB17990)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1AB11360)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB16E50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AB11A50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1AB114B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPELEMENT_OFFSET UNITYSDK_OFFSET(0x1AB118B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPGROUP_OFFSET UNITYSDK_OFFSET(0x1AB11330)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPPARTICLE_OFFSET UNITYSDK_OFFSET(0x1AB16F20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1AB11890)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_1_OFFSET UNITYSDK_OFFSET(0x1AB11A90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1AB0B7C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1AB21CB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEUNION_OFFSET UNITYSDK_OFFSET(0x1AB21D80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1AB12D30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AB15C90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEBASEMEMBERTYPES_OFFSET UNITYSDK_OFFSET(0x1AB17530)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPEXTYPEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1AB169B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x1AB18310)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1AB188F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENT_OFFSET UNITYSDK_OFFSET(0x1AB1B400)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1AB13AB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECONTENTTYPEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1AB1B200)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEELEMENT_OFFSET UNITYSDK_OFFSET(0x1AB14F00)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEGROUP_OFFSET UNITYSDK_OFFSET(0x1AB12C80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AB164D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILELOCALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB18C70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEPARTICLEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1AB22870)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x1AB17A90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1AB17D60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1AB14800)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x1AB12510)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x1AB0CDF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AB0B250)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETANYSCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x1AB1BDA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1AB1BF30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETMAPPINGPARTICLE_OFFSET UNITYSDK_OFFSET(0x1AB21370)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSCHEMACONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AB1B3A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1AB17270)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISANYFROMANY_OFFSET UNITYSDK_OFFSET(0x1AB1EDC0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMANY_OFFSET UNITYSDK_OFFSET(0x1AB1ED10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x1AB1EB20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x1AB1F100)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMANY_OFFSET UNITYSDK_OFFSET(0x1AB1EE50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x1AB1F7B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISPARTICLEEMPTIABLE_OFFSET UNITYSDK_OFFSET(0x1AB1EA40)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMALL_OFFSET UNITYSDK_OFFSET(0x1AB1FBB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMCHOICE_OFFSET UNITYSDK_OFFSET(0x1AB20040)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x1AB211C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1AB20250)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1AB1C040)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1AB0FD30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PREPARE_OFFSET UNITYSDK_OFFSET(0x1AB0B2A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PUSHCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1AB21C80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0B120)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int SchemaCollectionCompiler_TypeDefinitionIndex = 2080;
