...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_BUILDPARTICLECONTENTMODEL_OFFSET UNITYSDK_OFFSET(0x1E3760F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATEEFFECTIVETOTALRANGE_OFFSET UNITYSDK_OFFSET(0x1E3745D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATESEQUENCERANGE_OFFSET UNITYSDK_OFFSET(0x1E375720)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEALL_OFFSET UNITYSDK_OFFSET(0x1E3715A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZECHOICE_OFFSET UNITYSDK_OFFSET(0x1E371CA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1E370C20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEGROUPREF_OFFSET UNITYSDK_OFFSET(0x1E370DD0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1E36B700)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZESEQUENCE_OFFSET UNITYSDK_OFFSET(0x1E3725A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKPARTICLEDERIVATION_OFFSET UNITYSDK_OFFSET(0x1E36B110)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKSUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x1E36B200)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKUNIONTYPE_OFFSET UNITYSDK_OFFSET(0x1E36C010)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1E365A90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E36B4F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1E3661B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1E365BE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPELEMENT_OFFSET UNITYSDK_OFFSET(0x1E366000)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPGROUP_OFFSET UNITYSDK_OFFSET(0x1E365A60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPPARTICLE_OFFSET UNITYSDK_OFFSET(0x1E36B5C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1E365FE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_1_OFFSET UNITYSDK_OFFSET(0x1E3661E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1E35FF80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1E375F50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEUNION_OFFSET UNITYSDK_OFFSET(0x1E376020)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1E367420)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1E36A330)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEBASEMEMBERTYPES_OFFSET UNITYSDK_OFFSET(0x1E36BB90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPEXTYPEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1E36B050)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x1E36C9A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1E36CF80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENT_OFFSET UNITYSDK_OFFSET(0x1E36FA50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1E368180)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECONTENTTYPEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1E36F850)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEELEMENT_OFFSET UNITYSDK_OFFSET(0x1E3695B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEGROUP_OFFSET UNITYSDK_OFFSET(0x1E367370)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1E36AB70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILELOCALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E36D300)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEPARTICLEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1E376B10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x1E36C120)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1E36C3F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1E368EB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x1E366C50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x1E3615B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1E35FA20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETANYSCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x1E3703F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1E370590)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETMAPPINGPARTICLE_OFFSET UNITYSDK_OFFSET(0x1E375630)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSCHEMACONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E36F9F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1E36B8D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISANYFROMANY_OFFSET UNITYSDK_OFFSET(0x1E373120)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMANY_OFFSET UNITYSDK_OFFSET(0x1E373070)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x1E372E90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x1E373430)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMANY_OFFSET UNITYSDK_OFFSET(0x1E3731B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x1E373AE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISPARTICLEEMPTIABLE_OFFSET UNITYSDK_OFFSET(0x1E372DB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMALL_OFFSET UNITYSDK_OFFSET(0x1E373EE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMCHOICE_OFFSET UNITYSDK_OFFSET(0x1E374370)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x1E375480)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1E374560)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1E3706A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1E3644E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PREPARE_OFFSET UNITYSDK_OFFSET(0x1E35FA70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PUSHCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1E375F20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E35F8F0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaObjectTable* examplars; // 0x48
