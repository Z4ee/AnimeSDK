...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1ECA9010)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_GET_ATTRIBUTEUSES_OFFSET UNITYSDK_OFFSET(0x1ECA8F90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECA8FF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECA9000)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECA91A0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaAttributeGroup_TypeDefinitionIndex = 2121;

	class XmlSchemaAttributeGroup : public ::System::Xml::Schema::XmlSchemaAnnotated
	{
	public:
		::System::Xml::Schema::XmlSchemaObjectTable* attributeUses; // 0x50
		::System::Xml::Schema::XmlSchemaAttributeGroup* redefined; // 0x58
		::System::Xml::Schema::XmlSchemaAnyAttribute* anyAttribute; // 0x60
		::System::String* name; // 0x68
		::System::Xml::Schema::XmlSchemaObjectCollection* attributes; // 0x70
		::System::Xml::Schema::XmlSchemaAnyAttribute* attributeWildcard; // 0x78
