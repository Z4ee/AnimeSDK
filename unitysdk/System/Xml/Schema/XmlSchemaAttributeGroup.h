...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1D9369B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_GET_ATTRIBUTEUSES_OFFSET UNITYSDK_OFFSET(0x1D936930)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D936990)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D9369A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D936B30)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaAnyAttribute* attributeWildcard; // 0x60
		::System::String* name; // 0x68
		::System::Xml::Schema::XmlSchemaAnyAttribute* anyAttribute; // 0x70
		::System::Xml::XmlQualifiedName* qname; // 0x78
		::System::Xml::Schema::XmlSchemaAttributeGroup* redefined; // 0x80
