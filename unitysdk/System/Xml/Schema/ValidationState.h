...
#define SYSTEM_XML_SCHEMA_VALIDATIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C32C0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::Il2CppArray<::System::Xml::Schema::BitSet*>* CurPos; // 0x28
		::System::Xml::Schema::BitSet* AllElementsSet; // 0x30
		::System::Collections::Generic::List_1<::System::Xml::Schema::RangePositionInfo>* RunningPositions; // 0x38
		::Il2CppArray<::System::Xml::Schema::ConstraintStruct*>* Constr; // 0x40
		::System::String* Namespace; // 0x48
		::System::Boolean IsDefault; // 0x50
		::System::Boolean HasMatched; // 0x51
		::System::Boolean ValidationSkipped; // 0x52
		::System::Xml::Schema::XmlSchemaContentProcessing ProcessContents; // 0x54
		::System::Xml::Schema::StateUnion CurrentState; // 0x58
		::System::Xml::Schema::XmlSchemaValidity Validity; // 0x5C
		::System::Boolean NeedValidateChildren; // 0x60
		::System::Boolean CheckRequiredAttribute; // 0x61
		::System::Boolean IsNill; // 0x62
		::System::Boolean TooComplex; // 0x63
