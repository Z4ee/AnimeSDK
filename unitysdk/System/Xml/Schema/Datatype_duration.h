...
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_COMPARE_OFFSET UNITYSDK_OFFSET(0x18587CE0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x18587B50)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x18587CD0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x18587BA0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x18587C70)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x18587C00)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x18587C10)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x18587DE0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x18588000)
#define SYSTEM_XML_SCHEMA_DATATYPE_DURATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1857F2B0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_duration_TypeDefinitionIndex = 2089;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_duration_TypeDefinitionIndex)->GetStaticField(0x7AC0);
		}
		static ::System::Type** StaticGet_listValueType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_duration_TypeDefinitionIndex)->GetStaticField(0x7AC8);
		}
