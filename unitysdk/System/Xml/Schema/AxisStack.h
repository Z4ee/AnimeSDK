...
#define SYSTEM_XML_SCHEMA_AXISSTACK_EQUAL_OFFSET UNITYSDK_OFFSET(0x1ECA5460)
#define SYSTEM_XML_SCHEMA_AXISSTACK_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1ECA5360)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECA5120)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOCHILD_OFFSET UNITYSDK_OFFSET(0x1ECA4A70)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x1ECA4DF0)
#define SYSTEM_XML_SCHEMA_AXISSTACK_POP_OFFSET UNITYSDK_OFFSET(0x1ECA5420)
#define SYSTEM_XML_SCHEMA_AXISSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1ECA5390)
#define SYSTEM_XML_SCHEMA_AXISSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECA4790)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::ActiveAxis* parent; // 0x10
		::System::Collections::ArrayList* stack; // 0x18
