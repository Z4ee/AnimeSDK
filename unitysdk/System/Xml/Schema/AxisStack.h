...
#define SYSTEM_XML_SCHEMA_AXISSTACK_EQUAL_OFFSET UNITYSDK_OFFSET(0x1D932E60)
#define SYSTEM_XML_SCHEMA_AXISSTACK_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D932D60)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D932B20)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOCHILD_OFFSET UNITYSDK_OFFSET(0x1D932490)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x1D932800)
#define SYSTEM_XML_SCHEMA_AXISSTACK_POP_OFFSET UNITYSDK_OFFSET(0x1D932E20)
#define SYSTEM_XML_SCHEMA_AXISSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1D932D90)
#define SYSTEM_XML_SCHEMA_AXISSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9321B0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int AxisStack_TypeDefinitionIndex = 1940;

	class AxisStack : public ::System::Object
	{
	public:
		::System::Collections::ArrayList* stack; // 0x10
		::System::Xml::Schema::ForwardAxis* subtree; // 0x18
		::System::Xml::Schema::ActiveAxis* parent; // 0x20
