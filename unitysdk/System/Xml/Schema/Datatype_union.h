...
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_COMPARE_OFFSET UNITYSDK_OFFSET(0x1ECA6140)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1ECA6050)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x1ECA62B0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1ECA6310)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1ECA62A0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_VALIDRESTRICTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1ECA6370)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1ECA6240)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_HASATOMICMEMBERS_OFFSET UNITYSDK_OFFSET(0x1ECA6380)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_ISUNIONBASEOF_OFFSET UNITYSDK_OFFSET(0x1ECA6410)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_TRYPARSEVALUE_1_OFFSET UNITYSDK_OFFSET(0x1ECA6710)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1ECA64B0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ECA6B80)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECA60A0)
