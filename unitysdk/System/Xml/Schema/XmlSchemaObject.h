...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_ADDANNOTATION_OFFSET UNITYSDK_OFFSET(0x1BCFF4E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_CLONE_OFFSET UNITYSDK_OFFSET(0x1BCFF510)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_GET_IDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCFF4B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCFF4F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1BCFF460)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_SETUNHANDLEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1BCFF4D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_SET_IDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCFF4C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCFF500)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCFEDE0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaObject_TypeDefinitionIndex = 2170;
	...
	public:
		...
		::System::String* sourceUri; // 0x20
		::System::Int32 lineNum; // 0x28
