...
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GETBUILTINCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1ECAA5C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GETBUILTINSIMPLETYPE_1_OFFSET UNITYSDK_OFFSET(0x1ECAA4E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GETBUILTINSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1ECAA430)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_ELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1ECAA8D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1ECAA770)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECAAB70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1ECAA760)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1ECAA790)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_VALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1ECAA830)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_ISDERIVEDFROMDATATYPE_OFFSET UNITYSDK_OFFSET(0x1ECAAAC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_ISDERIVEDFROM_OFFSET UNITYSDK_OFFSET(0x1ECAA8F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SETQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1ECAA8C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SET_ELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1ECAA8E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1ECAA780)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECAAB80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECAAB90)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaType_TypeDefinitionIndex = 2195;

	class XmlSchemaType : public ::System::Xml::Schema::XmlSchemaAnnotated
	{
	public:
		::System::Xml::Schema::XmlSchemaType* redefined; // 0x50
		...
		::System::Xml::Schema::XmlSchemaDerivationMethod derivedBy; // 0x80
		::System::Xml::Schema::XmlSchemaContentType contentType; // 0x84
		::System::Xml::Schema::XmlSchemaDerivationMethod finalResolved; // 0x88
