...
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GETBUILTINCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1D937F60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GETBUILTINSIMPLETYPE_1_OFFSET UNITYSDK_OFFSET(0x1D937E80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GETBUILTINSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1D937DD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_ELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1D938270)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1D938110)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D938510)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1D938100)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1D938130)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_GET_VALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1D9381D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_ISDERIVEDFROMDATATYPE_OFFSET UNITYSDK_OFFSET(0x1D938460)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_ISDERIVEDFROM_OFFSET UNITYSDK_OFFSET(0x1D938290)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SETQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1D938260)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SET_ELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1D938280)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1D938120)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D938520)
#define SYSTEM_XML_SCHEMA_XMLSCHEMATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D938530)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaType* redefined; // 0x70
		...
		::System::Xml::Schema::XmlSchemaContentType contentType; // 0x8C
