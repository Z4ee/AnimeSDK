...
#define SYSTEM_XML_SCHEMA_SEQUENCENODE_CONSTRUCTPOS_OFFSET UNITYSDK_OFFSET(0x19FCF700)
#define SYSTEM_XML_SCHEMA_SEQUENCENODE_EXPANDTREE_OFFSET UNITYSDK_OFFSET(0x19FCFE30)
#define SYSTEM_XML_SCHEMA_SEQUENCENODE_GET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x19FCFC80)
#define SYSTEM_XML_SCHEMA_SEQUENCENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCFE40)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int SequenceNode_TypeDefinitionIndex = 2061;
