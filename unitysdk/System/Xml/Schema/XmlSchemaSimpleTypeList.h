...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPELIST_GET_BASEITEMTYPE_OFFSET UNITYSDK_OFFSET(0x185B0C30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPELIST_SET_BASEITEMTYPE_OFFSET UNITYSDK_OFFSET(0x185B0C40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPELIST_SET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x185B0C20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x185B0C50)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaSimpleTypeList_TypeDefinitionIndex = 2201;
	...
	public:
		...
		::System::Xml::XmlQualifiedName* itemTypeName; // 0x18
