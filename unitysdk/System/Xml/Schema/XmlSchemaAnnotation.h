...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANNOTATION_GET_IDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DCEBDC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANNOTATION_SETUNHANDLEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DCEBDE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANNOTATION_SET_IDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DCEBDD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCEBDF0)
