...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANNOTATED__CTOR_OFFSET UNITYSDK_OFFSET(0x185ADD10)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaAnnotated_TypeDefinitionIndex = 2172;
