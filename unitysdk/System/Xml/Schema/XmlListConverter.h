...
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CHANGELISTTYPE_OFFSET UNITYSDK_OFFSET(0x1965F400)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1966D7D0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CREATEINVALIDCLRMAPPINGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1966D9C0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CREATE_OFFSET UNITYSDK_OFFSET(0x1966D580)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_ISLISTTYPE_OFFSET UNITYSDK_OFFSET(0x1966D900)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_LISTASSTRING_OFFSET UNITYSDK_OFFSET(0x1966DE50)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_STRINGASLIST_OFFSET UNITYSDK_OFFSET(0x1966E5D0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_TOLIST_OFFSET UNITYSDK_OFFSET(0x1966E6F0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1966D540)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1966D570)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1965F1E0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlListConverter_TypeDefinitionIndex = 2225;
