...
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_CONCATENATEDTOSTRING_OFFSET UNITYSDK_OFFSET(0x1EA2E970)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_DERIVEBYUNION_OFFSET UNITYSDK_OFFSET(0x1EA2F430)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_FROMXDRNAME_OFFSET UNITYSDK_OFFSET(0x1EA2F3D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_FROMXMLTOKENIZEDTYPEXSD_OFFSET UNITYSDK_OFFSET(0x1EA2F2F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_FROMXMLTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1EA2F210)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_GET_TYPECODESTRING_OFFSET UNITYSDK_OFFSET(0x1EA27DF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1EA2E680)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_GET_VARIETY_OFFSET UNITYSDK_OFFSET(0x1EA2E670)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_ISDERIVEDFROM_OFFSET UNITYSDK_OFFSET(0x1EA2E690)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_TYPECODETOSTRING_OFFSET UNITYSDK_OFFSET(0x1EA2E6A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_XDRCANONIZEURI_OFFSET UNITYSDK_OFFSET(0x1EA2F490)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA2F5E0)
