...
#define SYSTEM_XML_SCHEMA_NFACONTENTVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE94A0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int NfaContentValidator_TypeDefinitionIndex = 2082;
