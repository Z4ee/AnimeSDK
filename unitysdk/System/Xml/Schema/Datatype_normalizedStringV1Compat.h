...
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRINGV1COMPAT_GET_HASVALUEFACETS_OFFSET UNITYSDK_OFFSET(0x1BAC68E0)
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRINGV1COMPAT_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1BAC68D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRINGV1COMPAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAC68F0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_normalizedStringV1Compat_TypeDefinitionIndex = 2020;
