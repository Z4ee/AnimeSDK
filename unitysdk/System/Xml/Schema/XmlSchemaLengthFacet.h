...
#define SYSTEM_XML_SCHEMA_XMLSCHEMALENGTHFACET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFD030)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaLengthFacet_TypeDefinitionIndex = 2146;
