...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENTRESTRICTION_SET_BASETYPENAME_OFFSET UNITYSDK_OFFSET(0x1C79AE30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENTRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C79AED0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaComplexContentRestriction_TypeDefinitionIndex = 2130;
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaParticle* particle; // 0x68
