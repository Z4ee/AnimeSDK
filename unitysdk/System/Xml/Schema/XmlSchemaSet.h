...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADDSCHEMATOSET_OFFSET UNITYSDK_OFFSET(0x1D0D60C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADDTOTABLE_OFFSET UNITYSDK_OFFSET(0x1D0D7F00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_1_OFFSET UNITYSDK_OFFSET(0x1D0D1850)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_2_OFFSET UNITYSDK_OFFSET(0x1D0D17F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_3_OFFSET UNITYSDK_OFFSET(0x1D0D6810)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_OFFSET UNITYSDK_OFFSET(0x1D0CE410)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1D0CE040)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_CLEARTABLES_OFFSET UNITYSDK_OFFSET(0x1D0D3A80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COMPILE_OFFSET UNITYSDK_OFFSET(0x1D0D3390)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D0D3350)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYFROMCOMPILEDSET_OFFSET UNITYSDK_OFFSET(0x1D0CEFB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x1D0D5F20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_FINDSCHEMABYNSANDURL_OFFSET UNITYSDK_OFFSET(0x1D0D1510)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x1D0D83F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETSCHEMABYURI_OFFSET UNITYSDK_OFFSET(0x1D0D8410)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETSCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x1D0D8270)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETTARGETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1D0D2DD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D0CE1F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D0CE280)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALELEMENTS_OFFSET UNITYSDK_OFFSET(0x1D0CE220)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALTYPES_OFFSET UNITYSDK_OFFSET(0x1D0CE2F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x1D0CDB70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_SUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x1D0CE350)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_TYPEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1D0CE3B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D0D8540)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ISSCHEMALOADED_OFFSET UNITYSDK_OFFSET(0x1D0D6DB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PARSESCHEMA_OFFSET UNITYSDK_OFFSET(0x1D0D7300)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PREPROCESSSCHEMA_OFFSET UNITYSDK_OFFSET(0x1D0D5DC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PROCESSNEWSUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x1D0D7500)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVERECURSIVE_OFFSET UNITYSDK_OFFSET(0x1D0D1A90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVESCHEMAFROMCACHES_OFFSET UNITYSDK_OFFSET(0x1D0D54D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVESCHEMAFROMGLOBALTABLES_OFFSET UNITYSDK_OFFSET(0x1D0D46E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D0D2ED0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVE_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1D0CE120)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REPROCESS_OFFSET UNITYSDK_OFFSET(0x1D0D3CB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_RESOLVESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x1D0D79F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SCHEMAS_1_OFFSET UNITYSDK_OFFSET(0x1D0D5BD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SCHEMAS_OFFSET UNITYSDK_OFFSET(0x1D0D6090)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1D0D2E10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SET_XMLRESOLVER_OFFSET UNITYSDK_OFFSET(0x1D0CE190)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_VERIFYTABLES_OFFSET UNITYSDK_OFFSET(0x1D0D8300)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D0CDC70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0CDBB0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::SchemaInfo* cachedCompiledInfo; // 0x20
		::System::Collections::Hashtable* chameleonSchemas; // 0x28
		::System::Collections::Hashtable* targetNamespaces; // 0x30
		::System::Collections::SortedList* schemas; // 0x38
		::System::Xml::XmlNameTable* nameTable; // 0x40
		::System::Collections::Hashtable* schemaLocations; // 0x48
		::System::Xml::Schema::XmlSchemaObjectTable* substitutionGroups; // 0x50
		::System::Xml::Schema::XmlSchemaObjectTable* typeExtensions; // 0x58
		::System::Xml::Schema::ValidationEventHandler* eventHandler; // 0x60
		::System::Xml::Schema::XmlSchemaObjectTable* elements; // 0x68
		::System::Xml::Schema::XmlSchemaObjectTable* schemaTypes; // 0x70
		::System::Object* internalSyncObject; // 0x78
		::System::Xml::Schema::SchemaNames* schemaNames; // 0x80
		::System::Xml::XmlReaderSettings* readerSettings; // 0x88
