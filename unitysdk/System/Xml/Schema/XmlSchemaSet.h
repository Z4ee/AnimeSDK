...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x1AE5FBF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AE5FBC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AE5FD60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE5F860)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5F7A0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Collections::Hashtable* chameleonSchemas; // 0x18
		::System::Xml::Schema::ValidationEventHandler* eventHandler; // 0x20
		::System::Xml::Schema::SchemaInfo* cachedCompiledInfo; // 0x28
		::System::Xml::XmlReaderSettings* readerSettings; // 0x30
		::System::Collections::Hashtable* targetNamespaces; // 0x38
		::System::Collections::SortedList* schemas; // 0x40
		::System::Collections::Hashtable* schemaLocations; // 0x48
		::System::Xml::Schema::ValidationEventHandler* internalEventHandler; // 0x50
