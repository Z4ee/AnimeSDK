...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x185B09B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x185B0980)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x185B0B20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x185B0630)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x185B0570)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaSet_TypeDefinitionIndex = 2198;

	class XmlSchemaSet : public ::System::Object
	{
	public:
		::System::Xml::Schema::ValidationEventHandler* eventHandler; // 0x10
		::System::Collections::Hashtable* targetNamespaces; // 0x18
		::System::Collections::SortedList* schemas; // 0x20
		::System::Xml::XmlReaderSettings* readerSettings; // 0x28
		::System::Collections::Hashtable* schemaLocations; // 0x30
		::System::Xml::Schema::SchemaInfo* cachedCompiledInfo; // 0x38
		::System::Xml::XmlNameTable* nameTable; // 0x40
		::System::Xml::Schema::XmlSchemaCompilationSettings* compilationSettings; // 0x48
