...
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE_EXPANDTREE_OFFSET UNITYSDK_OFFSET(0x1B591020)
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE_GET_ISRANGENODE_OFFSET UNITYSDK_OFFSET(0x1B591010)
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B590FF0)
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B590FB0)
