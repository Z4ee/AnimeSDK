...
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1BAC6C10)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_EXPECTEDELEMENTS_OFFSET UNITYSDK_OFFSET(0x1BAC6C30)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_EXPECTEDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1BAC6EB0)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_INITVALIDATION_OFFSET UNITYSDK_OFFSET(0x1BAC6A10)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1BAC6A90)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAC6990)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int DfaContentValidator_TypeDefinitionIndex = 1977;
