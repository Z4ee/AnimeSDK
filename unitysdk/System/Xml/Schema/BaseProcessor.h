...
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ADDTOTABLE_OFFSET UNITYSDK_OFFSET(0x1C795210)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x1C795200)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_GET_SCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x1C795190)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ISVALIDATTRIBUTEGROUPREDEFINE_OFFSET UNITYSDK_OFFSET(0x1C7955E0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ISVALIDGROUPREDEFINE_OFFSET UNITYSDK_OFFSET(0x1C795890)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ISVALIDTYPEREDEFINE_OFFSET UNITYSDK_OFFSET(0x1C795780)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENTNOTHROW_OFFSET UNITYSDK_OFFSET(0x1C796650)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x1C7959A0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x1C795CF0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x1C795E90)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x1C7960A0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_5_OFFSET UNITYSDK_OFFSET(0x1C796300)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_6_OFFSET UNITYSDK_OFFSET(0x1C796440)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_7_OFFSET UNITYSDK_OFFSET(0x1C796500)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_8_OFFSET UNITYSDK_OFFSET(0x1C795BF0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1C795AD0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C795110)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C795070)
