...
#define SYSTEM_XML_SCHEMA_DATATYPE_YEARMONTH_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x19FA8450)
#define SYSTEM_XML_SCHEMA_DATATYPE_YEARMONTH__CTOR_OFFSET UNITYSDK_OFFSET(0x19F9B260)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_yearMonth_TypeDefinitionIndex = 2105;
