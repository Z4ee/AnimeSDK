...
#define SYSTEM_XML_SCHEMA_DATATYPE_YEARMONTH_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1BAE59B0)
#define SYSTEM_XML_SCHEMA_DATATYPE_YEARMONTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAD8840)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_yearMonth_TypeDefinitionIndex = 2112;
