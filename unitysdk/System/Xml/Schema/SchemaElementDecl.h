...
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_ADDATTDEF_OFFSET UNITYSDK_OFFSET(0x1B8E9E70)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_CHECKATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B8EA090)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_CLONE_OFFSET UNITYSDK_OFFSET(0x1B8E9D70)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_CREATEANYTYPEELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1B8E9A40)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_GETATTDEF_OFFSET UNITYSDK_OFFSET(0x1B8E9FD0)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_GET_DEFAULTATTDEFS_OFFSET UNITYSDK_OFFSET(0x1B8EA080)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_GET_HASDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B8E9E60)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_GET_HASNONCDATAATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B8E9D60)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_SYSTEM_XML_IDTDATTRIBUTELISTINFO_GET_HASNONCDATAATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B8E9C40)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_SYSTEM_XML_IDTDATTRIBUTELISTINFO_LOOKUPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B8E9C50)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL_SYSTEM_XML_IDTDATTRIBUTELISTINFO_LOOKUPDEFAULTATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B8E9D50)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B8EA410)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B8E9710)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B8E98C0)
#define SYSTEM_XML_SCHEMA_SCHEMAELEMENTDECL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E9590)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*, ::System::Xml::Schema::SchemaAttDef*>* attdefs; // 0x68
		::Il2CppArray<::System::Xml::Schema::CompiledIdentityConstraint*>* constraints; // 0x70
		...
		::System::Collections::Generic::List_1<::System::Xml::IDtdDefaultAttributeInfo*>* defaultAttdefs; // 0x88
		::System::Xml::Schema::XmlSchemaElement* schemaElement; // 0x90
		::System::Boolean isIdDeclared; // 0x98
		::System::Boolean hasNonCDataAttribute; // 0x99
		::System::Boolean isNotationDeclared; // 0x9A
		::System::Boolean isAbstract; // 0x9B
		::System::Boolean hasRequiredAttribute; // 0x9C
		::System::Boolean isNillable; // 0x9D
