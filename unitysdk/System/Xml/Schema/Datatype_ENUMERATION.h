...
#define SYSTEM_XML_SCHEMA_DATATYPE_ENUMERATION_GET_TOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B29EC80)
#define SYSTEM_XML_SCHEMA_DATATYPE_ENUMERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29EC90)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_ENUMERATION_TypeDefinitionIndex = 2047;
