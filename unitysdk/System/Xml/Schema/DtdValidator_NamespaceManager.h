...
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_NAMESPACEMANAGER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1AE3B360)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_NAMESPACEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3B350)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int DtdValidator_NamespaceManager_TypeDefinitionIndex = 2143;
