...
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ADDIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DE71000)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ADDID_OFFSET UNITYSDK_OFFSET(0x1DE70F10)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ATTRIBUTEIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DE6FEC0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x1DE6B290)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1DE6DE60)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1DE6B280)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DE71650)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ENDELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DE6E3E0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_FASTGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1DE6BB20)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1DE70EF0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_HASIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DE6E3D0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_HASSCHEMA_OFFSET UNITYSDK_OFFSET(0x1DE6CC50)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_ISINLINESCHEMASTARTED_OFFSET UNITYSDK_OFFSET(0x1DE6AAB0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1DE70B90)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x1DE6A4F0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ISXSDROOT_OFFSET UNITYSDK_OFFSET(0x1DE6B6E0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_LOADSCHEMAFROMLOCATION_OFFSET UNITYSDK_OFFSET(0x1DE70510)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x1DE6DBB0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x1DE6FD40)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE6B700)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSINLINESCHEMA_OFFSET UNITYSDK_OFFSET(0x1DE6AAC0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1DE70BE0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSXSIATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DE6BBD0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x1DE6A890)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_THOROUGHGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1DE6C620)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_UNWRAPUNION_OFFSET UNITYSDK_OFFSET(0x1DE6FE50)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATECHILDELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE6B3E0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE6ADD0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE6AFE0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATEENDSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE6D7D0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATESTARTELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DE6CC70)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATESTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE6CCC0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1DE6A9E0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE71C30)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE6A860)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE6A490)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::String* NsXmlNs; // 0x80
		::System::Xml::HWStack* validationStack; // 0x88
		::System::String* XsiType; // 0x90
		::System::Xml::Schema::IdRefNode* idRefListHead; // 0x98
		::System::String* XsiNoNamespaceSchemaLocation; // 0xA0
		::System::Xml::Schema::Parser* inlineSchemaParser; // 0xA8
		::System::Xml::XmlNamespaceManager* nsManager; // 0xB0
		::System::String* XsiNil; // 0xB8
		::System::Collections::Hashtable* IDs; // 0xC0
		::System::Collections::Hashtable* attPresence; // 0xC8
		::System::String* NsXsi; // 0xD0
		::System::String* NsXs; // 0xD8
		::System::String* XsiSchemaLocation; // 0xE0
		::System::String* XsdSchema; // 0xE8
		::System::Int32 startIDConstraint; // 0xF0
		::System::Boolean bManageNamespaces; // 0xF4
		::System::Xml::Schema::XmlSchemaContentProcessing processContents; // 0xF8
