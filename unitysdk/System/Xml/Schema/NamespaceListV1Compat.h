...
#define SYSTEM_XML_SCHEMA_NAMESPACELISTV1COMPAT_ALLOWS_OFFSET UNITYSDK_OFFSET(0x1F108D50)
#define SYSTEM_XML_SCHEMA_NAMESPACELISTV1COMPAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F108D40)
