...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRINITFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE880B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRINITFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE880F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRINITFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE87B30)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRINITFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE87B20)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XdrBuilder_XdrInitFunction_TypeDefinitionIndex = 2105;
