...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B99A150)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaContent_TypeDefinitionIndex = 2133;
