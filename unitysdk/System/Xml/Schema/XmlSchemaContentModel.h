...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACONTENTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8E490)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaContentModel_TypeDefinitionIndex = 2134;
