...
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A7692B0)
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A7694E0)
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7692A0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int SchemaNamespaceManager_TypeDefinitionIndex = 2091;
