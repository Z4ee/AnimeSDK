...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ELEMENTCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D662750)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Collections::Hashtable* _AttDefList; // 0x10
		::System::Xml::Schema::SchemaElementDecl* _ElementDecl; // 0x18
		::System::Boolean _EnumerationRequired; // 0x20
		::System::Boolean _HasDataType; // 0x21
		::System::Int32 _ContentAttr; // 0x24
		::System::Boolean _AllowDataType; // 0x28
		::System::Boolean _ExistTerminal; // 0x29
		::System::Boolean _HasType; // 0x2A
		::System::Boolean _MasterGroupRequired; // 0x2B
		::System::UInt32 _MaxLength; // 0x2C
