...
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKDUPFLAG_OFFSET UNITYSDK_OFFSET(0x9990D0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKPROHIBITEDFLAG_OFFSET UNITYSDK_OFFSET(0x999040)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x999000)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEENUMERATIONFACET_OFFSET UNITYSDK_OFFSET(0x998F70)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEFACETCOMBINATIONS_OFFSET UNITYSDK_OFFSET(0x999010)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEFRACTIONDIGITSFACET_OFFSET UNITYSDK_OFFSET(0x998FE0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILELENGTHFACET_OFFSET UNITYSDK_OFFSET(0x998F30)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXEXCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x998FA0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXINCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x998F90)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXLENGTHFACET_OFFSET UNITYSDK_OFFSET(0x998F50)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMINEXCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x998FC0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMININCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x998FB0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMINLENGTHFACET_OFFSET UNITYSDK_OFFSET(0x998F40)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEPATTERNFACET_OFFSET UNITYSDK_OFFSET(0x998F60)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILETOTALDIGITSFACET_OFFSET UNITYSDK_OFFSET(0x998FD0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x998F80)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COPYFACETSFROMBASETYPE_OFFSET UNITYSDK_OFFSET(0x999020)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_FINISHFACETCOMPILE_OFFSET UNITYSDK_OFFSET(0x998FF0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_PARSEFACETVALUE_OFFSET UNITYSDK_OFFSET(0x999030)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x1B971900)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_SETFLAG_1_OFFSET UNITYSDK_OFFSET(0x999190)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_SETFLAG_OFFSET UNITYSDK_OFFSET(0x999160)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B972400)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x998F20)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int FacetsChecker_FacetsCompiler_TypeDefinitionIndex = 2054;
