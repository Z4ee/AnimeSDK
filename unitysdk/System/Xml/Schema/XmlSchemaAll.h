...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DCEBBC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1DCEBBB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_SETITEMS_OFFSET UNITYSDK_OFFSET(0x1DCEBC10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCEBC20)
