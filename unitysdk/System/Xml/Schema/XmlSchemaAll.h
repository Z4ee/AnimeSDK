...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B974EC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1B974EB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_SETITEMS_OFFSET UNITYSDK_OFFSET(0x1B974F10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B974F20)
