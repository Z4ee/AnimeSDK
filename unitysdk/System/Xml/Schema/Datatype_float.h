...
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_COMPARE_OFFSET UNITYSDK_OFFSET(0x18588A60)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x185888D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x18588A50)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x18588920)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x185889F0)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x18588980)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x18588990)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x18588BB0)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18588D30)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1857F790)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_float_TypeDefinitionIndex = 2086;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_float_TypeDefinitionIndex)->GetStaticField(0x7AF0);
		}
		static ::System::Type** StaticGet_listValueType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_float_TypeDefinitionIndex)->GetStaticField(0x7AF8);
		}
