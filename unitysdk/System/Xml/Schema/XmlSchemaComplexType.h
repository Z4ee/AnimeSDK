...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLEARCOMPILEDSTATE_OFFSET UNITYSDK_OFFSET(0x1DD21C30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DD21290)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEGROUPBASEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1DD21E50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1DD218C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1DD20800)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD207F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CONTAINSIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DD20370)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CREATEANYTYPE_OFFSET UNITYSDK_OFFSET(0x1DD1F950)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GETRESOLVEDELEMENTFORM_OFFSET UNITYSDK_OFFSET(0x1DD22010)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ANYTYPECONTENTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1DD200A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DD20170)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ATTRIBUTEUSES_OFFSET UNITYSDK_OFFSET(0x1DD20270)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1DD20130)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1DD20160)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_LOCALELEMENTS_OFFSET UNITYSDK_OFFSET(0x1DD202E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_HASATTRIBUTEQNAMEREF_OFFSET UNITYSDK_OFFSET(0x1DD21CC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_HASPARTICLEREF_OFFSET UNITYSDK_OFFSET(0x1DD215D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_HASWILDCARD_OFFSET UNITYSDK_OFFSET(0x1DD20350)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1DD20140)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1DD20080)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD1F5F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD1FF90)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaObjectTable* localElements; // 0x90
		::System::Xml::Schema::XmlSchemaParticle* particle; // 0x98
		::System::Xml::Schema::XmlSchemaAnyAttribute* attributeWildcard; // 0xA0
		::System::Xml::Schema::XmlSchemaAnyAttribute* anyAttribute; // 0xA8
		::System::Xml::Schema::XmlSchemaContentModel* contentModel; // 0xB0
		::System::Xml::Schema::XmlSchemaObjectTable* attributeUses; // 0xB8
		::System::Xml::Schema::XmlSchemaParticle* contentTypeParticle; // 0xC0
		::System::Xml::Schema::XmlSchemaObjectCollection* attributes; // 0xC8
