...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLEARCOMPILEDSTATE_OFFSET UNITYSDK_OFFSET(0x1B999D30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B999390)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEGROUPBASEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1B999F50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1B9999C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1B998900)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONE_OFFSET UNITYSDK_OFFSET(0x1B9988F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CONTAINSIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B998470)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CREATEANYTYPE_OFFSET UNITYSDK_OFFSET(0x1B997A50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GETRESOLVEDELEMENTFORM_OFFSET UNITYSDK_OFFSET(0x1B99A110)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ANYTYPECONTENTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1B9981A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B998270)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ATTRIBUTEUSES_OFFSET UNITYSDK_OFFSET(0x1B998370)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1B998230)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1B998260)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_LOCALELEMENTS_OFFSET UNITYSDK_OFFSET(0x1B9983E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_HASATTRIBUTEQNAMEREF_OFFSET UNITYSDK_OFFSET(0x1B999DC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_HASPARTICLEREF_OFFSET UNITYSDK_OFFSET(0x1B9996D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_HASWILDCARD_OFFSET UNITYSDK_OFFSET(0x1B998450)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1B998240)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1B998180)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B9976F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B998090)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaComplexType_TypeDefinitionIndex = 2132;
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaAnyAttribute* attributeWildcard; // 0x98
		::System::Xml::Schema::XmlSchemaParticle* contentTypeParticle; // 0xA0
		::System::Xml::Schema::XmlSchemaParticle* particle; // 0xA8
		::System::Xml::Schema::XmlSchemaObjectTable* attributeUses; // 0xB0
		::System::Xml::Schema::XmlSchemaContentModel* contentModel; // 0xB8
		::System::Xml::Schema::XmlSchemaObjectCollection* attributes; // 0xC0
		::System::Xml::Schema::XmlSchemaObjectTable* localElements; // 0xC8
		::System::Xml::Schema::XmlSchemaDerivationMethod block; // 0xD0
		::System::Byte pvFlags; // 0xD4
