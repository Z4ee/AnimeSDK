...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ADDORDER_OFFSET UNITYSDK_OFFSET(0x1ACC5CD0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_CHECKDATATYPE_OFFSET UNITYSDK_OFFSET(0x1ACC51B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_CHECKDEFAULTATTVALUE_OFFSET UNITYSDK_OFFSET(0x1ACC5900)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_COMPAREMINMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC49F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ENDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1ACC20D0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1ACC3180)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETMODEL_OFFSET UNITYSDK_OFFSET(0x1ACC3480)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x1ACC0A90)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETORDER_OFFSET UNITYSDK_OFFSET(0x1ACC3670)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_HANDLEMINMAX_OFFSET UNITYSDK_OFFSET(0x1ACC64E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISCONTENTPARSED_OFFSET UNITYSDK_OFFSET(0x1ACC1FB0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1ACC1400)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISSKIPABLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ACC1B10)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISSKIPABLEELEMENT_OFFSET UNITYSDK_OFFSET(0x1ACC0D50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISXDRSCHEMA_OFFSET UNITYSDK_OFFSET(0x1ACC1410)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISYES_OFFSET UNITYSDK_OFFSET(0x1ACC4FD0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x1ACC14B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEDTMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC3AF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEDTMINLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC3E70)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEINTEGER_OFFSET UNITYSDK_OFFSET(0x1ACC7740)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEMAXOCCURS_OFFSET UNITYSDK_OFFSET(0x1ACC6140)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEMINOCCURS_OFFSET UNITYSDK_OFFSET(0x1ACC5E00)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_POPGROUPINFO_OFFSET UNITYSDK_OFFSET(0x1ACC2380)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_POP_OFFSET UNITYSDK_OFFSET(0x1ACC21B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ACC0F40)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSCDATA_OFFSET UNITYSDK_OFFSET(0x1ACC2020)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x1ACC08E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSMARKUP_OFFSET UNITYSDK_OFFSET(0x1ACC1FC0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PUSHGROUPINFO_OFFSET UNITYSDK_OFFSET(0x1ACC2260)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PUSH_OFFSET UNITYSDK_OFFSET(0x1ACC0D00)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x1ACC3990)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x1ACC0E50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x1ACC7840)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1ACC1E00)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SETATTRIBUTEPRESENCE_OFFSET UNITYSDK_OFFSET(0x1ACC5A10)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_STARTCHILDREN_OFFSET UNITYSDK_OFFSET(0x1ACC2090)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x1ACC55B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ACC6840)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC4170)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINROOT_OFFSET UNITYSDK_OFFSET(0x1ACC2500)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1ACC50D0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC54B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTMINLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC5530)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC5100)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTVALUES_OFFSET UNITYSDK_OFFSET(0x1ACC53E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_NAME_OFFSET UNITYSDK_OFFSET(0x1ACC4BB0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_REQUIRED_OFFSET UNITYSDK_OFFSET(0x1ACC4F50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTE_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1ACC6810)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTE_REQUIRED_OFFSET UNITYSDK_OFFSET(0x1ACC6780)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTE_TYPE_OFFSET UNITYSDK_OFFSET(0x1ACC66B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_CONTENT_OFFSET UNITYSDK_OFFSET(0x1ACC30E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC3A70)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTMINLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACC3DF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC3820)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTVALUES_OFFSET UNITYSDK_OFFSET(0x1ACC39A0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_MODEL_OFFSET UNITYSDK_OFFSET(0x1ACC33E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_NAME_OFFSET UNITYSDK_OFFSET(0x1ACC2E50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_ORDER_OFFSET UNITYSDK_OFFSET(0x1ACC35B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENT_MAXOCCURS_OFFSET UNITYSDK_OFFSET(0x1ACC60C0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENT_MINOCCURS_OFFSET UNITYSDK_OFFSET(0x1ACC5D80)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENT_TYPE_OFFSET UNITYSDK_OFFSET(0x1ACC5B00)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDGROUP_MAXOCCURS_OFFSET UNITYSDK_OFFSET(0x1ACC70F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDGROUP_MINOCCURS_OFFSET UNITYSDK_OFFSET(0x1ACC7060)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDGROUP_ORDER_OFFSET UNITYSDK_OFFSET(0x1ACC6F60)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDROOT_ID_OFFSET UNITYSDK_OFFSET(0x1ACC24F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDROOT_NAME_OFFSET UNITYSDK_OFFSET(0x1ACC2490)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_CHECKATTRIBUTEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1ACC2C10)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDATTRIBUTEDTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC7640)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x1ACC5650)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ACC6D80)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDELEMENTDTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC74E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC4530)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1ACC6380)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDGROUP_OFFSET UNITYSDK_OFFSET(0x1ACC7180)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDROOT_OFFSET UNITYSDK_OFFSET(0x1ACC2600)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITATTRIBUTEDTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC75D0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x1ACC4A60)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ACC6590)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITELEMENTDTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC7440)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC2CA0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITELEMENT_OFFSET UNITYSDK_OFFSET(0x1ACC5A60)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITGROUP_OFFSET UNITYSDK_OFFSET(0x1ACC6E50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITROOT_OFFSET UNITYSDK_OFFSET(0x1ACC2430)
#define SYSTEM_XML_SCHEMA_XDRBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACC7930)
#define SYSTEM_XML_SCHEMA_XDRBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC05D0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(XdrBuilder_TypeDefinitionIndex)->GetStaticField(0x1C50);
		}
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(XdrBuilder_TypeDefinitionIndex)->GetStaticField(0x1C60);
		}
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(XdrBuilder_TypeDefinitionIndex)->GetStaticField(0x1C88);
		}
		...
		{
			return (::Il2CppArray<::System::Xml::Schema::XdrBuilder_XdrAttributeEntry*>**)Il2CppClass::FromTypeDefinitionIndex(XdrBuilder_TypeDefinitionIndex)->GetStaticField(0x1CA8);
		}
		::System::Xml::XmlNamespaceManager* _CurNsMgr; // 0x10
		::System::String* _TargetNamespace; // 0x18
		::System::Xml::HWStack* _StateHistory; // 0x20
		::System::Xml::Schema::ValidationEventHandler* validationEventHandler; // 0x28
		::System::Xml::PositionInfo* positionInfo; // 0x30
		::System::Xml::Schema::XdrBuilder_GroupContent* _GroupDef; // 0x38
		::System::String* _XdrName; // 0x40
		::System::String* _Text; // 0x48
		::System::Xml::Schema::XdrBuilder_DeclBaseInfo* _UndefinedAttributeTypes; // 0x50
		::System::Xml::HWStack* _GroupStack; // 0x58
		::System::String* _XdrPrefix; // 0x60
		::System::Xml::XmlNameTable* _NameTable; // 0x68
		::System::Xml::Schema::ParticleContentValidator* _contentValidator; // 0x70
		::System::Collections::Hashtable* _UndeclaredElements; // 0x78
		::System::Xml::Schema::XdrBuilder_XdrEntry* _CurState; // 0x80
		::System::Xml::Schema::SchemaNames* _SchemaNames; // 0x88
		::System::Xml::Schema::XdrBuilder_DeclBaseInfo* _BaseDecl; // 0x90
		::System::Xml::XmlReader* _reader; // 0x98
		::System::Xml::Schema::SchemaInfo* _SchemaInfo; // 0xA0
		::System::Xml::XmlResolver* xmlResolver; // 0xA8
		::System::Xml::Schema::XdrBuilder_AttributeContent* _AttributeDef; // 0xB0
		::System::Xml::Schema::XdrBuilder_ElementContent* _ElementDef; // 0xB8
		::System::Xml::Schema::XdrBuilder_XdrEntry* _NextState; // 0xC0
