...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9976A0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9976E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B997080)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B997070)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XdrBuilder_XdrBuildFunction_TypeDefinitionIndex = 2104;
