...
#define SYSTEM_XML_SCHEMA_MISCFACETSCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1857E750)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int MiscFacetsChecker_TypeDefinitionIndex = 2150;
