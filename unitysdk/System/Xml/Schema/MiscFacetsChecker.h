...
#define SYSTEM_XML_SCHEMA_MISCFACETSCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB9490)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int MiscFacetsChecker_TypeDefinitionIndex = 2151;
