...
#define SYSTEM_XML_SCHEMA_POSITIONS_ADD_OFFSET UNITYSDK_OFFSET(0x1E61BD80)
#define SYSTEM_XML_SCHEMA_POSITIONS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E61BEE0)
#define SYSTEM_XML_SCHEMA_POSITIONS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E61BE00)
#define SYSTEM_XML_SCHEMA_POSITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E61BF10)
