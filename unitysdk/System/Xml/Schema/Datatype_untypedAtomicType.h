...
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1858BC70)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1858BCD0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1858BCE0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x185810F0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_untypedAtomicType_TypeDefinitionIndex = 2083;
