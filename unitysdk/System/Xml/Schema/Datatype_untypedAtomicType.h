...
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1E4E5B70)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1E4E5BD0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1E4E5BE0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4E5BF0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_untypedAtomicType_TypeDefinitionIndex = 1992;
