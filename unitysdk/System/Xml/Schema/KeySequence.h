...
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CA49D80)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CA49380)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CA491B0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_ISQUALIFIED_OFFSET UNITYSDK_OFFSET(0x1CA49310)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CA491F0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CA4A350)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA49150)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Int32 poscol; // 0x20
		::System::Int32 posline; // 0x24
