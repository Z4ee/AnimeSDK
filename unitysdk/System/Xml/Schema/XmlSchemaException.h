...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION_CREATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1F06F250)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1F06F3A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1F06DF60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION_SETSOURCE_1_OFFSET UNITYSDK_OFFSET(0x1F070000)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION_SETSOURCE_OFFSET UNITYSDK_OFFSET(0x1F06D820)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1F06FC50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_11_OFFSET UNITYSDK_OFFSET(0x1F06FE90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_12_OFFSET UNITYSDK_OFFSET(0x1F06FD80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_13_OFFSET UNITYSDK_OFFSET(0x1F06F850)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F06F680)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F06F6A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F068F80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1F06F6C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1F06F960)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1F06A6A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1F06EA50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1F06FA30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1F06FB40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F06EDA0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaException_TypeDefinitionIndex = 2140;

	class XmlSchemaException : public ::System::SystemException
	{
	public:
		::Il2CppArray<::System::String*>* args; // 0x88
		::System::Xml::Schema::XmlSchemaObject* sourceSchemaObject; // 0x90
