...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRENDCHILDFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D9368F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRENDCHILDFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D936920)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRENDCHILDFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D9363F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRENDCHILDFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9363D0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XdrBuilder_XdrEndChildFunction_TypeDefinitionIndex = 2106;
