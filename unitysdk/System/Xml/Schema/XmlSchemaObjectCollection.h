...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x1C170AB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1C170630)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_CLONE_OFFSET UNITYSDK_OFFSET(0x1C170920)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C170510)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C170320)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x1C170710)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x1C170900)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONINSERT_OFFSET UNITYSDK_OFFSET(0x1C1708E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x1C170910)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONSET_OFFSET UNITYSDK_OFFSET(0x1C1708F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1C170800)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C170430)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C170280)
