...
#define SYSTEM_XML_SCHEMA_VALIDATIONEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D176070)
#define SYSTEM_XML_SCHEMA_VALIDATIONEVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D1760D0)
#define SYSTEM_XML_SCHEMA_VALIDATIONEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176010)
