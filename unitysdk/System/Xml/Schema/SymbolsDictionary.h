...
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_ADDNAMESPACELIST_OFFSET UNITYSDK_OFFSET(0x1DE65650)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_ADDNAME_OFFSET UNITYSDK_OFFSET(0x1DE654E0)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_ADDWILDCARD_OFFSET UNITYSDK_OFFSET(0x1DE65A40)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_EXISTS_OFFSET UNITYSDK_OFFSET(0x1DE665A0)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_GETNAMESPACELISTSYMBOLS_OFFSET UNITYSDK_OFFSET(0x1DE65C30)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_GETPARTICLE_OFFSET UNITYSDK_OFFSET(0x1DE665D0)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DE654D0)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DE664A0)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY_NAMEOF_OFFSET UNITYSDK_OFFSET(0x1DE66610)
#define SYSTEM_XML_SCHEMA_SYMBOLSDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE653C0)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Collections::Hashtable* names; // 0x10
