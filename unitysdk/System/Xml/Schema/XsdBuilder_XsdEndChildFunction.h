...
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDENDCHILDFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD22A40)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDENDCHILDFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD22A70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDENDCHILDFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD22540)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDENDCHILDFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD22520)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XsdBuilder_XsdEndChildFunction_TypeDefinitionIndex = 2223;
