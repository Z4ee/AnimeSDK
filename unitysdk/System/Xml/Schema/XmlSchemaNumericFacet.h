...
#define SYSTEM_XML_SCHEMA_XMLSCHEMANUMERICFACET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A740320)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaNumericFacet_TypeDefinitionIndex = 2145;
