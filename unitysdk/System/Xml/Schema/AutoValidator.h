...
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1B8E80C0)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_DETECTVALIDATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B8E7AF0)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1B8E80D0)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1B8E7900)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1B8E7910)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E7890)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int AutoValidator_TypeDefinitionIndex = 1946;
