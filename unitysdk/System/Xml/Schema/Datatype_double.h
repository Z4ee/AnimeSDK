...
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_COMPARE_OFFSET UNITYSDK_OFFSET(0x19FA2F10)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x19FA2D80)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x19FA2F00)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x19FA2DD0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x19FA2EA0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x19FA2E30)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x19FA2E40)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x19FA3070)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FA32D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F99660)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_double_TypeDefinitionIndex = 2092;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_double_TypeDefinitionIndex)->GetStaticField(0x23570);
		}
		static ::System::Type** StaticGet_atomicValueType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_double_TypeDefinitionIndex)->GetStaticField(0x23578);
		}
