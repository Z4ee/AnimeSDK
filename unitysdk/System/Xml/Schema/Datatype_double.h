...
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_COMPARE_OFFSET UNITYSDK_OFFSET(0x18587670)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x185874E0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x18587660)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x18587530)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x18587600)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x18587590)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x185875A0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x185877D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18587950)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1857F120)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_double_TypeDefinitionIndex = 2087;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_double_TypeDefinitionIndex)->GetStaticField(0x7A90);
		}
		static ::System::Type** StaticGet_atomicValueType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_double_TypeDefinitionIndex)->GetStaticField(0x7A98);
		}
