...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_BUILDREFNAMESPACES_OFFSET UNITYSDK_OFFSET(0x1BCF5440)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1BCF8640)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1BCF8830)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDGROUP_OFFSET UNITYSDK_OFFSET(0x1BCF85C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1BCF8A70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1BCF0D70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_COUNTGROUPSELFREFERENCE_OFFSET UNITYSDK_OFFSET(0x1BCF8BB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1BCF0AF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_GETSCHEMAENTITY_OFFSET UNITYSDK_OFFSET(0x1BCF5360)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_LOADEXTERNALS_OFFSET UNITYSDK_OFFSET(0x1BCF1130)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSANNOTATION_OFFSET UNITYSDK_OFFSET(0x1BCF56B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTECONTENT_OFFSET UNITYSDK_OFFSET(0x1BCF93B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1BCF6F10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1BCF9940)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCF6DE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1BCF7000)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSELEMENTCONTENT_OFFSET UNITYSDK_OFFSET(0x1BCF9C40)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x1BCF7F50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSGROUP_OFFSET UNITYSDK_OFFSET(0x1BCF81D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1BCFA6E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSLOCALATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCF95F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSLOCALELEMENT_OFFSET UNITYSDK_OFFSET(0x1BCFA2D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSNOTATION_OFFSET UNITYSDK_OFFSET(0x1BCF83B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSPARTICLE_OFFSET UNITYSDK_OFFSET(0x1BCFAAA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSREDEFINE_OFFSET UNITYSDK_OFFSET(0x1BCF57C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1BCF78F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x1BCF2120)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_RESOLVESCHEMALOCATIONURI_OFFSET UNITYSDK_OFFSET(0x1BCF52E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_SETPARENT_OFFSET UNITYSDK_OFFSET(0x1BCF5690)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATEIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCF1EC0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATENAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCF8F80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATEQNAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BCF97E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCF0A50)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::String* targetNamespace; // 0x40
		::System::String* Xmlns; // 0x48
		::System::Collections::Hashtable* schemaLocations; // 0x50
		::System::Collections::Hashtable* referenceNamespaces; // 0x58
		...
		::System::Xml::Schema::XmlSchemaForm elementFormDefault; // 0x78
		::System::Xml::Schema::XmlSchemaForm attributeFormDefault; // 0x7C
