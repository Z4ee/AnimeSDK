...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINFERENCEEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AFFCDA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINFERENCEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFFCDC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINFERENCEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFFCDE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINFERENCEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AFFCF20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINFERENCEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFCD80)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaInferenceException_TypeDefinitionIndex = 2069;
