...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x1AD638B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_2_OFFSET UNITYSDK_OFFSET(0x1AD639D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1AD63880)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD63430)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETSCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x1AD63760)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETSCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x1AD637F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AD63310)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD63340)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1AD63490)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AD63730)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1AD63710)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1AD63720)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD633D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD63190)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD630D0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaCollection_TypeDefinitionIndex = 2125;

	class XmlSchemaCollection : public ::System::Object
	{
	public:
		::System::Xml::XmlResolver* xmlResolver; // 0x10
		::System::Collections::Hashtable* collection; // 0x18
		::System::Threading::ReaderWriterLock* wLock; // 0x20
		::System::Xml::Schema::SchemaNames* schemaNames; // 0x28
		::System::Xml::Schema::ValidationEventHandler* validationEventHandler; // 0x30
		::System::Xml::XmlNameTable* nameTable; // 0x38
		::System::Boolean isThreadSafe; // 0x40
