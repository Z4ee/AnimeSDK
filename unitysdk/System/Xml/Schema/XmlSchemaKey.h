...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E49F980)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaKey_TypeDefinitionIndex = 2164;
