...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBEGINCHILDFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFFCA50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBEGINCHILDFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFFCA80)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBEGINCHILDFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFFC550)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBEGINCHILDFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFC540)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XdrBuilder_XdrBeginChildFunction_TypeDefinitionIndex = 2106;
