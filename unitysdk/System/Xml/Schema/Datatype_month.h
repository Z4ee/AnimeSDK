...
#define SYSTEM_XML_SCHEMA_DATATYPE_MONTH_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x19FC4B90)
#define SYSTEM_XML_SCHEMA_DATATYPE_MONTH__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBAA40)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_month_TypeDefinitionIndex = 2105;
