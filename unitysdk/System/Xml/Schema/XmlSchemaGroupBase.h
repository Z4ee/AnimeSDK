...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAGROUPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x185B0160)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaGroupBase_TypeDefinitionIndex = 2189;
