...
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDBUILDFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B8F0230)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDBUILDFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B8F0270)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDBUILDFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B8EFCB0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDBUILDFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8EFCA0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XsdBuilder_XsdBuildFunction_TypeDefinitionIndex = 2222;
