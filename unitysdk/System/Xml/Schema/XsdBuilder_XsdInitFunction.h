...
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDINITFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B8F0810)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDINITFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B8F0850)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDINITFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B8F0290)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_XSDINITFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F0280)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XsdBuilder_XsdInitFunction_TypeDefinitionIndex = 2223;
