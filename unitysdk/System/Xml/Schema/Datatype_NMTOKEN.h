...
#define SYSTEM_XML_SCHEMA_DATATYPE_NMTOKEN_GET_TOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x18583E80)
#define SYSTEM_XML_SCHEMA_DATATYPE_NMTOKEN_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x18583E70)
#define SYSTEM_XML_SCHEMA_DATATYPE_NMTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x185800A0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_NMTOKEN_TypeDefinitionIndex = 2114;
