...
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_ALLOWS_1_OFFSET UNITYSDK_OFFSET(0x19D352F0)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_ALLOWS_OFFSET UNITYSDK_OFFSET(0x19D35260)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_CLONE_OFFSET UNITYSDK_OFFSET(0x19D35040)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_COMPARESETTOOTHER_OFFSET UNITYSDK_OFFSET(0x19D36270)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_GET_ENUMERATE_OFFSET UNITYSDK_OFFSET(0x19D351E0)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x19D36390)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_ISSUBSET_OFFSET UNITYSDK_OFFSET(0x19D35820)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_REMOVENAMESPACE_OFFSET UNITYSDK_OFFSET(0x19D36AA0)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19D35320)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_UNION_OFFSET UNITYSDK_OFFSET(0x19D35C70)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D34C90)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19D34C80)
