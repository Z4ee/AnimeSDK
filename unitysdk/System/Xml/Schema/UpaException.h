...
#define SYSTEM_XML_SCHEMA_UPAEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E803FA0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int UpaException_TypeDefinitionIndex = 2064;
