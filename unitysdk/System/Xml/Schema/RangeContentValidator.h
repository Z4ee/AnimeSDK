...
#define SYSTEM_XML_SCHEMA_RANGECONTENTVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19FAF060)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int RangeContentValidator_TypeDefinitionIndex = 2076;
