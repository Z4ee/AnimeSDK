...
#define SYSTEM_XML_SCHEMA_DATATYPE_TIMETIMEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E74E0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_timeTimeZone_TypeDefinitionIndex = 2109;
