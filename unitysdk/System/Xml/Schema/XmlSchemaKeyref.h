...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAKEYREF_SET_REFER_OFFSET UNITYSDK_OFFSET(0x1EA2F5F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAKEYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA2F690)
