...
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLEXDR_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1AFFB1C0)
#define SYSTEM_XML_SCHEMA_DATATYPE_DOUBLEXDR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFB630)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int Datatype_doubleXdr_TypeDefinitionIndex = 2044;
