...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENT_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1B8EE830)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENT_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1B8EE820)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8EE840)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaComplexContent_TypeDefinitionIndex = 2129;
