...
{
	inline static constexpr unsigned int RestrictionFacets_TypeDefinitionIndex = 2076;
	...
	public:
		...
		::System::Collections::ArrayList* Patterns; // 0x28
		::System::Object* MaxInclusive; // 0x30
		...
		::System::Xml::Schema::RestrictionFlags Flags; // 0x50
		::System::Xml::Schema::XmlSchemaWhiteSpace WhiteSpace; // 0x54
		::System::Int32 MinLength; // 0x58
	};
}
