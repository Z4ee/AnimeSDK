...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_VALUESCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1ACCAD70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_VALUESCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ACCAE70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_VALUESCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ACCAC70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_VALUESCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1ACCAD60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_VALUESCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1ACCAC80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_VALUESCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACCAC60)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaObjectTable_ValuesCollection_TypeDefinitionIndex = 2177;
