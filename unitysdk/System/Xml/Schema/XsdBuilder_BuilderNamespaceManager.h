...
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDERNAMESPACEMANAGER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1DCEBF90)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDERNAMESPACEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCEBF70)
