...
#define SYSTEM_XML_SCHEMA_DOUBLELINKAXIS_CONVERTTREE_OFFSET UNITYSDK_OFFSET(0x1F069880)
#define SYSTEM_XML_SCHEMA_DOUBLELINKAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F069820)
