...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLECONTENTRESTRICTION_SET_BASETYPENAME_OFFSET UNITYSDK_OFFSET(0x1D937B60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLECONTENTRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D937C00)
