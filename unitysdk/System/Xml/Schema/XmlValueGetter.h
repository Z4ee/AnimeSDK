...
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C172790)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1727C0)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1724F0)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1724D0)
