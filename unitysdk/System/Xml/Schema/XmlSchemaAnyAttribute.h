...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_ALLOWS_OFFSET UNITYSDK_OFFSET(0x1C16F690)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_BUILDNAMESPACELISTV1COMPAT_OFFSET UNITYSDK_OFFSET(0x1C16F610)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_BUILDNAMESPACELIST_OFFSET UNITYSDK_OFFSET(0x1C16F5B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_GET_PROCESSCONTENTSCORRECT_OFFSET UNITYSDK_OFFSET(0x1C16F5A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x1C16F700)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_ISSUBSET_OFFSET UNITYSDK_OFFSET(0x1C16F6D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE_UNION_OFFSET UNITYSDK_OFFSET(0x1C16F7A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C16F790)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::NamespaceList* namespaceList; // 0x50
		::System::String* ns; // 0x58
