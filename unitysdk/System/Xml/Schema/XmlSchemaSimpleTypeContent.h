...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPECONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76EB90)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaSimpleTypeContent_TypeDefinitionIndex = 2190;
