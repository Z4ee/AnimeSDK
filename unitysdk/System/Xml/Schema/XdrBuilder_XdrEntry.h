...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::XdrBuilder_XdrInitFunction* _InitFunc; // 0x10
		::System::Xml::Schema::XdrBuilder_XdrBeginChildFunction* _BeginChildFunc; // 0x18
		::Il2CppArray<::System::Xml::Schema::XdrBuilder_XdrAttributeEntry*>* _Attributes; // 0x20
		::Il2CppArray<::System::Int32>* _NextStates; // 0x28
		::System::Xml::Schema::XdrBuilder_XdrEndChildFunction* _EndChildFunc; // 0x30
		::System::Boolean _AllowText; // 0x38
		::System::Xml::Schema::SchemaNames_Token _Name; // 0x3C
