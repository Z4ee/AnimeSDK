...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAPATTERNFACET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8207F0)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaPatternFacet_TypeDefinitionIndex = 2199;
