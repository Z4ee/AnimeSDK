...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAPATTERNFACET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5F780)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaPatternFacet_TypeDefinitionIndex = 2188;
