...
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_CHECKPREFIXNS_OFFSET UNITYSDK_OFFSET(0x887300)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x8871F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x887500)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x887310)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_GETNSHASHCODE_OFFSET UNITYSDK_OFFSET(0x887430)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_MATCHNS_OFFSET UNITYSDK_OFFSET(0x887210)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_MATCHPREFIX_OFFSET UNITYSDK_OFFSET(0x887290)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19897420)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_SET_OFFSET UNITYSDK_OFFSET(0x399A00)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x887510)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x399A00)

namespace System::Xml
{
	inline static constexpr unsigned int XmlSqlBinaryReader_QName_TypeDefinitionIndex = 1673;
