...
#define SYSTEM_XML_BITSTACK_PEEKBIT_OFFSET UNITYSDK_OFFSET(0x1AE14280)
#define SYSTEM_XML_BITSTACK_POPBIT_OFFSET UNITYSDK_OFFSET(0x1AE141F0)
#define SYSTEM_XML_BITSTACK_POPCURR_OFFSET UNITYSDK_OFFSET(0x1AE14240)
#define SYSTEM_XML_BITSTACK_PUSHBIT_OFFSET UNITYSDK_OFFSET(0x1AE14120)
#define SYSTEM_XML_BITSTACK_PUSHCURR_OFFSET UNITYSDK_OFFSET(0x1AE14150)
#define SYSTEM_XML_BITSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE14110)
