...
#define SYSTEM_XML_CACHINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DC48C30)
#define SYSTEM_XML_CACHINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC48C60)
#define SYSTEM_XML_CACHINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DC48710)
#define SYSTEM_XML_CACHINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC486F0)
