...
#define SYSTEM_XML_CACHINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C795030)
#define SYSTEM_XML_CACHINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C795060)
#define SYSTEM_XML_CACHINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C794B30)
#define SYSTEM_XML_CACHINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C794B10)

namespace System::Xml
{
	inline static constexpr unsigned int CachingEventHandler_TypeDefinitionIndex = 1745;
