...
#define SYSTEM_XML_BYTESTACK_POP_OFFSET UNITYSDK_OFFSET(0x185632F0)
#define SYSTEM_XML_BYTESTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x18563260)
#define SYSTEM_XML_BYTESTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18563220)
