...
#define SYSTEM_XML_BYTESTACK_POP_OFFSET UNITYSDK_OFFSET(0x1BABB6D0)
#define SYSTEM_XML_BYTESTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1BABB650)
#define SYSTEM_XML_BYTESTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BABB610)
