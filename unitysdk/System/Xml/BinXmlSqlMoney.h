...
#define SYSTEM_XML_BINXMLSQLMONEY_TODECIMAL_OFFSET UNITYSDK_OFFSET(0xA462E0)
#define SYSTEM_XML_BINXMLSQLMONEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA46350)
#define SYSTEM_XML_BINXMLSQLMONEY__CTOR_OFFSET UNITYSDK_OFFSET(0x966DC0)
