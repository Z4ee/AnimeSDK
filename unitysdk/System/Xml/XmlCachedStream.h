...
#define SYSTEM_XML_XMLCACHEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x162BE060)

namespace System::Xml
{
	inline static constexpr unsigned int XmlCachedStream_TypeDefinitionIndex = 1942;
