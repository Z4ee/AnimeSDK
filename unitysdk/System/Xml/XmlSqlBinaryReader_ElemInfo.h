...
#define SYSTEM_XML_XMLSQLBINARYREADER_ELEMINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0xA3B930)
#define SYSTEM_XML_XMLSQLBINARYREADER_ELEMINFO_SET_OFFSET UNITYSDK_OFFSET(0xA3B900)
