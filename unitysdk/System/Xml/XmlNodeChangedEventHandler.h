...
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AED1360)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AED13A0)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEB8280)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AED1270)

namespace System::Xml
{
	inline static constexpr unsigned int XmlNodeChangedEventHandler_TypeDefinitionIndex = 1905;
