...
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x183F54B0)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x183F54F0)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x183D1020)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183F53C0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlNodeChangedEventHandler_TypeDefinitionIndex = 1916;
