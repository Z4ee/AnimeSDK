...
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAD16F0)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BAD1630)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BAD16C0)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAD1600)

namespace System::Xml
{
	inline static constexpr unsigned int XmlElementListEnumerator_TypeDefinitionIndex = 1764;
