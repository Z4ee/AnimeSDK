...
#define SYSTEM_XML_UCS4ENCODING2143_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x1AEA1490)
#define SYSTEM_XML_UCS4ENCODING2143_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x1AEA1450)
#define SYSTEM_XML_UCS4ENCODING2143__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA1230)
