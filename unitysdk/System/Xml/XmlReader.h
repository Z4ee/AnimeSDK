...
#define SYSTEM_XML_XMLREADER_CALCBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1D18FC40)
#define SYSTEM_XML_XMLREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D18DE60)
#define SYSTEM_XML_XMLREADER_CREATESQLREADER_OFFSET UNITYSDK_OFFSET(0x1D18F8B0)
#define SYSTEM_XML_XMLREADER_CREATEWRITERFORINNEROUTERXML_OFFSET UNITYSDK_OFFSET(0x1D18EC30)
#define SYSTEM_XML_XMLREADER_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1D18F6A0)
#define SYSTEM_XML_XMLREADER_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1D18F7D0)
#define SYSTEM_XML_XMLREADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1D18F5B0)
#define SYSTEM_XML_XMLREADER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D18F3F0)
#define SYSTEM_XML_XMLREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D18F3D0)
#define SYSTEM_XML_XMLREADER_GET_CANREADVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1D18DFF0)
#define SYSTEM_XML_XMLREADER_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1D18DFE0)
#define SYSTEM_XML_XMLREADER_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1D18F5A0)
#define SYSTEM_XML_XMLREADER_GET_HASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D18F3B0)
#define SYSTEM_XML_XMLREADER_GET_ISDEFAULTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D18F4A0)
#define SYSTEM_XML_XMLREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1D18DD00)
#define SYSTEM_XML_XMLREADER_GET_NAMESPACEMANAGER_OFFSET UNITYSDK_OFFSET(0x1D18F430)
#define SYSTEM_XML_XMLREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D18DC30)
#define SYSTEM_XML_XMLREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1D18DD10)
#define SYSTEM_XML_XMLREADER_GET_SCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x1D18DD40)
#define SYSTEM_XML_XMLREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1D18DC20)
#define SYSTEM_XML_XMLREADER_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1D18DD80)
#define SYSTEM_XML_XMLREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1D18DD30)
#define SYSTEM_XML_XMLREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1D18DD20)
#define SYSTEM_XML_XMLREADER_HASVALUEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D18F440)
#define SYSTEM_XML_XMLREADER_ISSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1D18E6D0)
#define SYSTEM_XML_XMLREADER_ISTEXTUALNODE_OFFSET UNITYSDK_OFFSET(0x1D18E220)
#define SYSTEM_XML_XMLREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D18DDB0)
#define SYSTEM_XML_XMLREADER_MOVETOCONTENT_OFFSET UNITYSDK_OFFSET(0x1D18E280)
#define SYSTEM_XML_XMLREADER_READELEMENTSTRING_OFFSET UNITYSDK_OFFSET(0x1D18E3E0)
#define SYSTEM_XML_XMLREADER_READENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1D18E5F0)
#define SYSTEM_XML_XMLREADER_READINNERXML_OFFSET UNITYSDK_OFFSET(0x1D18E8A0)
#define SYSTEM_XML_XMLREADER_READSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1D18E300)
#define SYSTEM_XML_XMLREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1D18E060)
#define SYSTEM_XML_XMLREADER_READTOFOLLOWING_OFFSET UNITYSDK_OFFSET(0x1D18E780)
#define SYSTEM_XML_XMLREADER_READVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1D18E000)
#define SYSTEM_XML_XMLREADER_SETNAMESPACESFLAG_OFFSET UNITYSDK_OFFSET(0x1D18F260)
#define SYSTEM_XML_XMLREADER_SKIPSUBTREE_OFFSET UNITYSDK_OFFSET(0x1D18DF30)
#define SYSTEM_XML_XMLREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x1D18DE70)
#define SYSTEM_XML_XMLREADER_WRITEATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1D18EC90)
#define SYSTEM_XML_XMLREADER_WRITENODE_OFFSET UNITYSDK_OFFSET(0x1D18ED90)
#define SYSTEM_XML_XMLREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D18FCD0)
#define SYSTEM_XML_XMLREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18FCC0)
