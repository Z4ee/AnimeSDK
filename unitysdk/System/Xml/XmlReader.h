...
#define SYSTEM_XML_XMLREADER_CALCBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1AD7CBA0)
#define SYSTEM_XML_XMLREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AD7ADD0)
#define SYSTEM_XML_XMLREADER_CREATESQLREADER_OFFSET UNITYSDK_OFFSET(0x1AD7C810)
#define SYSTEM_XML_XMLREADER_CREATEWRITERFORINNEROUTERXML_OFFSET UNITYSDK_OFFSET(0x1AD7BB90)
#define SYSTEM_XML_XMLREADER_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AD7C600)
#define SYSTEM_XML_XMLREADER_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1AD7C730)
#define SYSTEM_XML_XMLREADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AD7C510)
#define SYSTEM_XML_XMLREADER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AD7C350)
#define SYSTEM_XML_XMLREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD7C330)
#define SYSTEM_XML_XMLREADER_GET_CANREADVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1AD7AF60)
#define SYSTEM_XML_XMLREADER_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1AD7AF50)
#define SYSTEM_XML_XMLREADER_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1AD7C500)
#define SYSTEM_XML_XMLREADER_GET_HASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AD7C310)
#define SYSTEM_XML_XMLREADER_GET_ISDEFAULTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD7C400)
#define SYSTEM_XML_XMLREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1AD7AC70)
#define SYSTEM_XML_XMLREADER_GET_NAMESPACEMANAGER_OFFSET UNITYSDK_OFFSET(0x1AD7C390)
#define SYSTEM_XML_XMLREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AD7ABA0)
#define SYSTEM_XML_XMLREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1AD7AC80)
#define SYSTEM_XML_XMLREADER_GET_SCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x1AD7ACB0)
#define SYSTEM_XML_XMLREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1AD7AB90)
#define SYSTEM_XML_XMLREADER_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1AD7ACF0)
#define SYSTEM_XML_XMLREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1AD7ACA0)
#define SYSTEM_XML_XMLREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1AD7AC90)
#define SYSTEM_XML_XMLREADER_HASVALUEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD7C3A0)
#define SYSTEM_XML_XMLREADER_ISSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1AD7B640)
#define SYSTEM_XML_XMLREADER_ISTEXTUALNODE_OFFSET UNITYSDK_OFFSET(0x1AD7B190)
#define SYSTEM_XML_XMLREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AD7AD20)
#define SYSTEM_XML_XMLREADER_MOVETOCONTENT_OFFSET UNITYSDK_OFFSET(0x1AD7B1F0)
#define SYSTEM_XML_XMLREADER_READELEMENTSTRING_OFFSET UNITYSDK_OFFSET(0x1AD7B350)
#define SYSTEM_XML_XMLREADER_READENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1AD7B560)
#define SYSTEM_XML_XMLREADER_READINNERXML_OFFSET UNITYSDK_OFFSET(0x1AD7B810)
#define SYSTEM_XML_XMLREADER_READSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1AD7B270)
#define SYSTEM_XML_XMLREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1AD7AFD0)
#define SYSTEM_XML_XMLREADER_READTOFOLLOWING_OFFSET UNITYSDK_OFFSET(0x1AD7B6F0)
#define SYSTEM_XML_XMLREADER_READVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1AD7AF70)
#define SYSTEM_XML_XMLREADER_SETNAMESPACESFLAG_OFFSET UNITYSDK_OFFSET(0x1AD7C1C0)
#define SYSTEM_XML_XMLREADER_SKIPSUBTREE_OFFSET UNITYSDK_OFFSET(0x1AD7AEA0)
#define SYSTEM_XML_XMLREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x1AD7ADE0)
#define SYSTEM_XML_XMLREADER_WRITEATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1AD7BBF0)
#define SYSTEM_XML_XMLREADER_WRITENODE_OFFSET UNITYSDK_OFFSET(0x1AD7BCF0)
#define SYSTEM_XML_XMLREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD7CC30)
#define SYSTEM_XML_XMLREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD7CC20)
