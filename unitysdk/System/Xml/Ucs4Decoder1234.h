...
#define SYSTEM_XML_UCS4DECODER1234_GETFULLCHARS_OFFSET UNITYSDK_OFFSET(0x185F3370)
#define SYSTEM_XML_UCS4DECODER1234__CTOR_OFFSET UNITYSDK_OFFSET(0x185F36F0)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Decoder1234_TypeDefinitionIndex = 1947;
