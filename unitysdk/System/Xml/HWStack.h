...
#define SYSTEM_XML_HWSTACK_ADDTOTOP_OFFSET UNITYSDK_OFFSET(0x1AD5CDB0)
#define SYSTEM_XML_HWSTACK_CLONE_OFFSET UNITYSDK_OFFSET(0x1AD5CFE0)
#define SYSTEM_XML_HWSTACK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD5CE40)
#define SYSTEM_XML_HWSTACK_PEEK_OFFSET UNITYSDK_OFFSET(0x1AD5CD60)
#define SYSTEM_XML_HWSTACK_POP_OFFSET UNITYSDK_OFFSET(0x1AD5CD10)
#define SYSTEM_XML_HWSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1AD5CC20)
#define SYSTEM_XML_HWSTACK_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD5CED0)
#define SYSTEM_XML_HWSTACK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD5CBC0)
#define SYSTEM_XML_HWSTACK__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AD5CFC0)
#define SYSTEM_XML_HWSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD5CB60)

namespace System::Xml
{
	inline static constexpr unsigned int HWStack_TypeDefinitionIndex = 1792;

	class HWStack : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Object*>* stack; // 0x10
		::System::Int32 used; // 0x18
		::System::Int32 growthRate; // 0x1C
