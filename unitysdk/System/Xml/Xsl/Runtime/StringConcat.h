...
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_CLEAR_OFFSET UNITYSDK_OFFSET(0x386E110)
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_CONCATNODELIMITER_OFFSET UNITYSDK_OFFSET(0x386E130)
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_GETRESULT_OFFSET UNITYSDK_OFFSET(0x386E120)
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2CC10A0)
