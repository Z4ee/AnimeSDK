...
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E8B9B40)
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E8B9BC0)
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8B9410)
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8B9AC0)
