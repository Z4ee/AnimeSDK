...
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E80DA30)
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E80DAD0)
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E80D480)
#define SYSTEM_XML_XMLQUALIFIEDNAME_HASHCODEOFSTRINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E80D460)
