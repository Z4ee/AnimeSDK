...
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x183F1610)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x183F1670)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x183F1690)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x183F1600)

namespace System::Xml
{
	inline static constexpr unsigned int XmlNamedNodeMap_SmallXmlNodeList_SingleObjectEnumerator_TypeDefinitionIndex = 1913;
