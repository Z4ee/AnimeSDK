...
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18621EB0)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18621F10)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18621F30)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_SINGLEOBJECTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18621EA0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlNamedNodeMap_SmallXmlNodeList_SingleObjectEnumerator_TypeDefinitionIndex = 1901;
