...
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_ADJUSTPOSITION_OFFSET UNITYSDK_OFFSET(0xA1E470)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURIANDHASH_OFFSET UNITYSDK_OFFSET(0xA1E3C0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURI_OFFSET UNITYSDK_OFFSET(0xA1E3B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHHASHNS_OFFSET UNITYSDK_OFFSET(0xA1E3F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHNS_OFFSET UNITYSDK_OFFSET(0x981650)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xA1E380)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_OFFSET UNITYSDK_OFFSET(0xA1E350)

namespace System::Xml
{
	inline static constexpr unsigned int XmlSqlBinaryReader_AttrInfo_TypeDefinitionIndex = 1674;
