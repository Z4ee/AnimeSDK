...
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_ADJUSTPOSITION_OFFSET UNITYSDK_OFFSET(0x9D3430)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURIANDHASH_OFFSET UNITYSDK_OFFSET(0x9D3380)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x9D3370)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHHASHNS_OFFSET UNITYSDK_OFFSET(0x9D33B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHNS_OFFSET UNITYSDK_OFFSET(0x935890)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x9D3340)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_OFFSET UNITYSDK_OFFSET(0x9D3310)
