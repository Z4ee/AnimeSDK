...
#define SYSTEM_XML_XMLCHILDNODES_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE96D00)
#define SYSTEM_XML_XMLCHILDNODES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AE96CA0)
#define SYSTEM_XML_XMLCHILDNODES_ITEM_OFFSET UNITYSDK_OFFSET(0x1AE96C30)
#define SYSTEM_XML_XMLCHILDNODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE96C10)
