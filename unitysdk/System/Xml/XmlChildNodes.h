...
#define SYSTEM_XML_XMLCHILDNODES_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D2E0A90)
#define SYSTEM_XML_XMLCHILDNODES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D2E0A30)
#define SYSTEM_XML_XMLCHILDNODES_ITEM_OFFSET UNITYSDK_OFFSET(0x1D2E09C0)
#define SYSTEM_XML_XMLCHILDNODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2E09A0)
