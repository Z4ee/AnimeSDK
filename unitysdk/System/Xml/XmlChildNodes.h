...
#define SYSTEM_XML_XMLCHILDNODES_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x185DA760)
#define SYSTEM_XML_XMLCHILDNODES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x185DA700)
#define SYSTEM_XML_XMLCHILDNODES__CTOR_OFFSET UNITYSDK_OFFSET(0x185FE180)

namespace System::Xml
{
	inline static constexpr unsigned int XmlChildNodes_TypeDefinitionIndex = 1884;
