...
#define SYSTEM_XML_UCS4ENCODING3412_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x162B1330)
#define SYSTEM_XML_UCS4ENCODING3412_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x162B12F0)
#define SYSTEM_XML_UCS4ENCODING3412__CTOR_OFFSET UNITYSDK_OFFSET(0x162B0FF0)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Encoding3412_TypeDefinitionIndex = 1949;
