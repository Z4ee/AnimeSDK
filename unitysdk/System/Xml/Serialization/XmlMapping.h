...
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19694FE0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1627A0E0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x19694FF0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_GET_OBJECTMAP_OFFSET UNITYSDK_OFFSET(0x1627A0A0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_GET_RELATEDMAPS_OFFSET UNITYSDK_OFFSET(0x1627A0C0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_SETKEY_OFFSET UNITYSDK_OFFSET(0x1627A090)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_SET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1627A0F0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_SET_OBJECTMAP_OFFSET UNITYSDK_OFFSET(0x1627A0B0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING_SET_RELATEDMAPS_OFFSET UNITYSDK_OFFSET(0x1627A0D0)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x19694FD0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlMapping_TypeDefinitionIndex = 2005;
