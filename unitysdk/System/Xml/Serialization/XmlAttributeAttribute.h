...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_ATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1A001840)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A001860)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_FORM_OFFSET UNITYSDK_OFFSET(0x1A001890)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A0018A0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_SET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A001880)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A001830)
