...
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19892880)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlTypeMapMemberList_TypeDefinitionIndex = 1928;
