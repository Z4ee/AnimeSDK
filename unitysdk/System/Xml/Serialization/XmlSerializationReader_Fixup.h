...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADER_FIXUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47DB70)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlSerializationReader_Fixup_TypeDefinitionIndex = 1907;
