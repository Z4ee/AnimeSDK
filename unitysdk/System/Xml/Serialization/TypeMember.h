...
#define SYSTEM_XML_SERIALIZATION_TYPEMEMBER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E834A10)
#define SYSTEM_XML_SERIALIZATION_TYPEMEMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E834980)
#define SYSTEM_XML_SERIALIZATION_TYPEMEMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E834850)
#define SYSTEM_XML_SERIALIZATION_TYPEMEMBER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E834A70)
#define SYSTEM_XML_SERIALIZATION_TYPEMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E834840)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int TypeMember_TypeDefinitionIndex = 1994;
