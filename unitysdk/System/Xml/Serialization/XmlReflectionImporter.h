...
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_CANBENULL_OFFSET UNITYSDK_OFFSET(0x1627EA50)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_CREATEMAPMEMBER_OFFSET UNITYSDK_OFFSET(0x16282030)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_CREATETYPEMAPPING_OFFSET UNITYSDK_OFFSET(0x1627E4A0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x162855F0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_GETREFLECTIONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1627F9E0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_GETTYPENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1627F8B0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTANYELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x16283430)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTCLASSMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1627AA50)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTCLASSMAPPING_OFFSET UNITYSDK_OFFSET(0x1627F7E0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x16283DD0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTENUMMAPPING_OFFSET UNITYSDK_OFFSET(0x1627DA00)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTINCLUDEDTYPES_OFFSET UNITYSDK_OFFSET(0x16283020)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTLISTMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1627C110)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTLISTMAPPING_OFFSET UNITYSDK_OFFSET(0x162831A0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTPRIMITIVEMAPPING_OFFSET UNITYSDK_OFFSET(0x1627D940)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTEXTELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x16285770)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1627A630)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_2_OFFSET UNITYSDK_OFFSET(0x1627A4A0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_3_OFFSET UNITYSDK_OFFSET(0x1627A640)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_OFFSET UNITYSDK_OFFSET(0x1627A490)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTXMLNODEMAPPING_OFFSET UNITYSDK_OFFSET(0x1627D6C0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTXMLSERIALIZABLEMAPPING_OFFSET UNITYSDK_OFFSET(0x1627E380)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_INCLUDETYPE_OFFSET UNITYSDK_OFFSET(0x16285CB0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_REGISTERDERIVEDMAP_OFFSET UNITYSDK_OFFSET(0x16282D70)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x162864F0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1627A2D0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlReflectionImporter_TypeDefinitionIndex = 2011;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(XmlReflectionImporter_TypeDefinitionIndex)->GetStaticField(0x25760);
		}
		static ::System::String** StaticGet_errSimple2()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(XmlReflectionImporter_TypeDefinitionIndex)->GetStaticField(0x25768);
		}
		...
		::System::Collections::ArrayList* includedTypes; // 0x30
