...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERIMPLEMENTATION_GET_WRITER_OFFSET UNITYSDK_OFFSET(0x1E800EB0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERIMPLEMENTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E800F00)
