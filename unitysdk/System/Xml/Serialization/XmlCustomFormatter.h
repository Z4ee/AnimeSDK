...
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMENUM_OFFSET UNITYSDK_OFFSET(0x196855C0)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMXMLNAME_OFFSET UNITYSDK_OFFSET(0x19693390)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMXMLNCNAME_OFFSET UNITYSDK_OFFSET(0x19693440)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMXMLSTRING_OFFSET UNITYSDK_OFFSET(0x19694040)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x196934F0)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19694970)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlCustomFormatter_TypeDefinitionIndex = 1999;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XmlCustomFormatter_TypeDefinitionIndex)->GetStaticField(0x24D00);
		}
