...
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMENUM_OFFSET UNITYSDK_OFFSET(0x1B99AF50)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMXMLNAME_OFFSET UNITYSDK_OFFSET(0x1B99B320)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMXMLNCNAME_OFFSET UNITYSDK_OFFSET(0x1B99B3D0)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_FROMXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1B99BEB0)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1B99B480)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B99C790)
#define SYSTEM_XML_SERIALIZATION_XMLCUSTOMFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B99C780)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlCustomFormatter_TypeDefinitionIndex = 1883;
