...
#define SYSTEM_XML_SERIALIZATION_LISTMAP_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FFA6B0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_FINDELEMENT_1_OFFSET UNITYSDK_OFFSET(0x19FF9C20)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_FINDELEMENT_OFFSET UNITYSDK_OFFSET(0x19FF91B0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_FINDTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x19FFA060)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_GETARRAYTYPE_OFFSET UNITYSDK_OFFSET(0x19FFA490)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FFA7D0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_GET_ITEMINFO_OFFSET UNITYSDK_OFFSET(0x19FF9190)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_SET_CHOICEMEMBER_OFFSET UNITYSDK_OFFSET(0x19FF9180)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_SET_ITEMINFO_OFFSET UNITYSDK_OFFSET(0x19FF91A0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFA7E0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int ListMap_TypeDefinitionIndex = 2048;
