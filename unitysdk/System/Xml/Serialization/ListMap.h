...
#define SYSTEM_XML_SERIALIZATION_LISTMAP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D0DE3C0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_FINDELEMENT_1_OFFSET UNITYSDK_OFFSET(0x1D0DD9A0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_FINDELEMENT_OFFSET UNITYSDK_OFFSET(0x1D0DCFB0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_FINDTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x1D0DDDB0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_GETARRAYTYPE_OFFSET UNITYSDK_OFFSET(0x1D0DE1A0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D0DE4E0)
#define SYSTEM_XML_SERIALIZATION_LISTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0DE4F0)
