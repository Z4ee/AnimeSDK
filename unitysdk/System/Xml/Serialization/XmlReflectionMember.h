...
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x162866C0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER_GET_ISRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x16286690)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x162866A0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x162866B0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER_GET_XMLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x16281FC0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER_SET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x162866D0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x162833A0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlReflectionMember_TypeDefinitionIndex = 2013;
