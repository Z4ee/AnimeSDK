...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONWRITER_WRITECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1629DF10)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlSerializationWriter_WriteCallbackInfo_TypeDefinitionIndex = 2030;
