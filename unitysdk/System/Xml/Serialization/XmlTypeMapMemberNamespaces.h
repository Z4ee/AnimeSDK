...
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERNAMESPACES__CTOR_OFFSET UNITYSDK_OFFSET(0x185D1F40)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlTypeMapMemberNamespaces_TypeDefinitionIndex = 2043;
