...
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x185C6400)
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x185C6440)
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x185C5E80)
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x185C5E60)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int UnreferencedObjectEventHandler_TypeDefinitionIndex = 1975;
