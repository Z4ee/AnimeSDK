...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADER_COLLECTIONITEMFIXUP_GET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1AE88B40)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADER_COLLECTIONITEMFIXUP_GET_ID_OFFSET UNITYSDK_OFFSET(0x1AE88B60)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADER_COLLECTIONITEMFIXUP_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1AE88B50)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADER_COLLECTIONITEMFIXUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE85880)
