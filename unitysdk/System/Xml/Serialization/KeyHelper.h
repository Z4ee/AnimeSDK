...
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x19892420)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_2_OFFSET UNITYSDK_OFFSET(0x198924D0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_3_OFFSET UNITYSDK_OFFSET(0x19892520)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_4_OFFSET UNITYSDK_OFFSET(0x19892570)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_5_OFFSET UNITYSDK_OFFSET(0x198925F0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x19892410)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19892670)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int KeyHelper_TypeDefinitionIndex = 1864;
