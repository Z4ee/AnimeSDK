...
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x1D0A0DE0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_2_OFFSET UNITYSDK_OFFSET(0x1D0A0E90)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_3_OFFSET UNITYSDK_OFFSET(0x1D0A0EE0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_4_OFFSET UNITYSDK_OFFSET(0x1D0A0F30)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_5_OFFSET UNITYSDK_OFFSET(0x1D0A0FB0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x1D0A0DD0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A1030)
