...
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1BACCFC0)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES_ADD_OFFSET UNITYSDK_OFFSET(0x1BACCEE0)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BACCDD0)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES__CTOR_OFFSET UNITYSDK_OFFSET(0x1BACD0F0)
