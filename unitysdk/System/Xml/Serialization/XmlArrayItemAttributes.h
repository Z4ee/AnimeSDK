...
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1F255050)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES_ADD_OFFSET UNITYSDK_OFFSET(0x1F254F70)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F254E60)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYITEMATTRIBUTES__CTOR_OFFSET UNITYSDK_OFFSET(0x1F255190)
