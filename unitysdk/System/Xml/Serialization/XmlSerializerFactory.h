...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_1_OFFSET UNITYSDK_OFFSET(0x1CFBF080)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_2_OFFSET UNITYSDK_OFFSET(0x1CFBEE00)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_OFFSET UNITYSDK_OFFSET(0x1CFBEDE0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF0B0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBEDD0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlSerializerFactory_TypeDefinitionIndex = 1918;
