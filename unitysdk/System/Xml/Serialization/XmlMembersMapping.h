...
#define SYSTEM_XML_SERIALIZATION_XMLMEMBERSMAPPING_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DE3C890)
#define SYSTEM_XML_SERIALIZATION_XMLMEMBERSMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE3C880)
