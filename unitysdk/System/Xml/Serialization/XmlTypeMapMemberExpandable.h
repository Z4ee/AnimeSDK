...
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBEREXPANDABLE_GET_FLATARRAYINDEX_OFFSET UNITYSDK_OFFSET(0x162AE390)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBEREXPANDABLE_SET_FLATARRAYINDEX_OFFSET UNITYSDK_OFFSET(0x162AE3A0)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBEREXPANDABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x162AE270)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlTypeMapMemberExpandable_TypeDefinitionIndex = 2044;
