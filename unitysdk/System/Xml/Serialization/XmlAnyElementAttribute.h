...
#define SYSTEM_XML_SERIALIZATION_XMLANYELEMENTATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1ACDB880)
#define SYSTEM_XML_SERIALIZATION_XMLANYELEMENTATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1ACDB860)
#define SYSTEM_XML_SERIALIZATION_XMLANYELEMENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDB850)
