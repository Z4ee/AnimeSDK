...
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D3C500)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D3C540)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D3BF80)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D3BF70)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlElementEventHandler_TypeDefinitionIndex = 1856;
