...
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19694F40)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19694F80)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19694F30)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19694E40)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlElementEventHandler_TypeDefinitionIndex = 1976;
