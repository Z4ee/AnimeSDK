...
#define SYSTEM_XML_SERIALIZATION_XMLARRAYATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1DCEC5C0)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYATTRIBUTE_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1DCEC5A0)
#define SYSTEM_XML_SERIALIZATION_XMLARRAYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCEC590)
