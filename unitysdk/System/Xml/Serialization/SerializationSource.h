...
#define SYSTEM_XML_SERIALIZATION_SERIALIZATIONSOURCE_BASEEQUALS_OFFSET UNITYSDK_OFFSET(0x1D0A1060)
#define SYSTEM_XML_SERIALIZATION_SERIALIZATIONSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A1050)
