...
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE_GET_ISANY_OFFSET UNITYSDK_OFFSET(0x16286740)
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x16286730)
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE_SET_ISANY_OFFSET UNITYSDK_OFFSET(0x16286750)
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16286720)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlSchemaProviderAttribute_TypeDefinitionIndex = 2015;
