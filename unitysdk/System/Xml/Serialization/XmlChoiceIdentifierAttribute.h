...
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1AD75AF0)
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AD75AD0)
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD75AC0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlChoiceIdentifierAttribute_TypeDefinitionIndex = 1882;
