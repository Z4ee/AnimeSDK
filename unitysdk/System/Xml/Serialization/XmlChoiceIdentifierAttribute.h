...
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1E4FB730)
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1E4FB710)
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4FB700)
