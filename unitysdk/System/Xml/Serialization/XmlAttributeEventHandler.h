...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B599B50)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B599B90)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5995D0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5995C0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlAttributeEventHandler_TypeDefinitionIndex = 1854;
