...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADER_WRITECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFFAD0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlSerializationReader_WriteCallbackInfo_TypeDefinitionIndex = 1905;

	class XmlSerializationReader_WriteCallbackInfo : public ::System::Object
	{
	public:
		::System::Xml::Serialization::XmlSerializationReadCallback* Callback; // 0x10
