...
#define SYSTEM_XML_SERIALIZATION_XMLENUMATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1DE3C7C0)
#define SYSTEM_XML_SERIALIZATION_XMLENUMATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE3C7B0)
#define SYSTEM_XML_SERIALIZATION_XMLENUMATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE3C7A0)
