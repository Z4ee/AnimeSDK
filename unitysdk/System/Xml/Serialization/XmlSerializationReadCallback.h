...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17C479C0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17C479F0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17C479B0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZATIONREADCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17C47940)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlSerializationReadCallback_TypeDefinitionIndex = 2026;
