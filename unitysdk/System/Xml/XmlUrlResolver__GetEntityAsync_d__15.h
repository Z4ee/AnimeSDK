...
#define SYSTEM_XML_XMLURLRESOLVER__GETENTITYASYNC_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x21001C0)
#define SYSTEM_XML_XMLURLRESOLVER__GETENTITYASYNC_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x20CDC20)

namespace System::Xml
{
	inline static constexpr unsigned int XmlUrlResolver__GetEntityAsync_d__15_TypeDefinitionIndex = 1959;
	...
	struct alignas(8) XmlUrlResolver__GetEntityAsync_d__15
	{
		...
		::System::Xml::XmlUrlResolver* __4__this; // 0x20
		::System::Type* ofObjectToReturn; // 0x28
