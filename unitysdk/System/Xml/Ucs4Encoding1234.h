...
#define SYSTEM_XML_UCS4ENCODING1234_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x185F4820)
#define SYSTEM_XML_UCS4ENCODING1234_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x185F47E0)
#define SYSTEM_XML_UCS4ENCODING1234__CTOR_OFFSET UNITYSDK_OFFSET(0x185F4530)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Encoding1234_TypeDefinitionIndex = 1941;
