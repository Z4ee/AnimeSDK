...
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_CLEAR_OFFSET UNITYSDK_OFFSET(0x22D2A40)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_CLOSE_OFFSET UNITYSDK_OFFSET(0x22D2AA0)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_GET_LINENO_OFFSET UNITYSDK_OFFSET(0x38020)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_GET_LINEPOS_OFFSET UNITYSDK_OFFSET(0x22D2AE0)
