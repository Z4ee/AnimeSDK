...
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_CLEAR_OFFSET UNITYSDK_OFFSET(0x3C59DA0)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_CLOSE_OFFSET UNITYSDK_OFFSET(0x3C59E00)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_GET_LINENO_OFFSET UNITYSDK_OFFSET(0x3C34920)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_GET_LINEPOS_OFFSET UNITYSDK_OFFSET(0x3C59E10)

namespace System::Xml
{
	inline static constexpr unsigned int XmlTextReaderImpl_ParsingState_TypeDefinitionIndex = 1854;
