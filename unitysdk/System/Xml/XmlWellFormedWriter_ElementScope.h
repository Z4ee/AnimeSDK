...
#define SYSTEM_XML_XMLWELLFORMEDWRITER_ELEMENTSCOPE_SET_OFFSET UNITYSDK_OFFSET(0x3C5A430)
#define SYSTEM_XML_XMLWELLFORMEDWRITER_ELEMENTSCOPE_WRITEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x3C5A460)
#define SYSTEM_XML_XMLWELLFORMEDWRITER_ELEMENTSCOPE_WRITEFULLENDELEMENT_OFFSET UNITYSDK_OFFSET(0x3C5A510)

namespace System::Xml
{
	inline static constexpr unsigned int XmlWellFormedWriter_ElementScope_TypeDefinitionIndex = 1875;
