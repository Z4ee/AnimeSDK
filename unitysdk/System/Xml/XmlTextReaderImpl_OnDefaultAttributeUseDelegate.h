...
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DC74500)
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC74540)
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DC73F70)
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC73F50)

namespace System::Xml
{
	inline static constexpr unsigned int XmlTextReaderImpl_OnDefaultAttributeUseDelegate_TypeDefinitionIndex = 1728;
