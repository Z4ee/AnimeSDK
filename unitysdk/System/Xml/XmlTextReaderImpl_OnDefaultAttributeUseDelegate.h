...
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AEED070)
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AEED0B0)
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEEBA60)
#define SYSTEM_XML_XMLTEXTREADERIMPL_ONDEFAULTATTRIBUTEUSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEECF80)
