...
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING_ADDHANDLER_OFFSET UNITYSDK_OFFSET(0x1D0E1FE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING_SYSTEM_XML_IVALIDATIONEVENTHANDLING_GET_EVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1D0E1E60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING_SYSTEM_XML_IVALIDATIONEVENTHANDLING_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1D0E1E70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E1E50)
