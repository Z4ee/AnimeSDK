...
#define SYSTEM_XML_BITS_COUNT_OFFSET UNITYSDK_OFFSET(0x1D654450)
#define SYSTEM_XML_BITS_LEASTPOSITION_OFFSET UNITYSDK_OFFSET(0x1D6544F0)
#define SYSTEM_XML_BITS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D654610)
