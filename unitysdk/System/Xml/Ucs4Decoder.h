...
#define SYSTEM_XML_UCS4DECODER_CONVERT_OFFSET UNITYSDK_OFFSET(0x1AB24CC0)
#define SYSTEM_XML_UCS4DECODER_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB24A70)
#define SYSTEM_XML_UCS4DECODER_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1AB24A90)
#define SYSTEM_XML_UCS4DECODER_UCS4TOUTF16_OFFSET UNITYSDK_OFFSET(0x1AB25000)
#define SYSTEM_XML_UCS4DECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB25080)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Decoder_TypeDefinitionIndex = 1827;
