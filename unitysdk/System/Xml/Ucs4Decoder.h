...
#define SYSTEM_XML_UCS4DECODER_CONVERT_OFFSET UNITYSDK_OFFSET(0x1CFBF3A0)
#define SYSTEM_XML_UCS4DECODER_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1CFBF150)
#define SYSTEM_XML_UCS4DECODER_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1CFBF170)
#define SYSTEM_XML_UCS4DECODER_UCS4TOUTF16_OFFSET UNITYSDK_OFFSET(0x1CFBF6E0)
#define SYSTEM_XML_UCS4DECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF760)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Decoder_TypeDefinitionIndex = 1826;
