...
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_CLONENODE_OFFSET UNITYSDK_OFFSET(0x1E8BDD90)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_ISTEXT_OFFSET UNITYSDK_OFFSET(0x1E8BE040)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1E8BDBF0)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E8BDBD0)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1E8BDC10)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x1E8BDC20)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E8BDE40)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E8BDE60)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_WRITECONTENTTO_OFFSET UNITYSDK_OFFSET(0x1E8BE030)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E8BDF80)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8ADC50)
