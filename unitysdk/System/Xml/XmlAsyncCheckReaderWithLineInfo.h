...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1E500550)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1E500630)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E500420)
