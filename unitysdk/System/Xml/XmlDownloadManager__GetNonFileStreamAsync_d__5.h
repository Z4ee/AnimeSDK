...
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9CA500)
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x5B0AE0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlDownloadManager__GetNonFileStreamAsync_d__5_TypeDefinitionIndex = 1815;

	struct alignas(8) XmlDownloadManager__GetNonFileStreamAsync_d__5
	{
		::System::Net::WebRequest* _req_5__1; // 0x10
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::IO::Stream*> __t__builder; // 0x18
		::System::Net::ICredentials* credentials; // 0x30
		::System::Xml::XmlDownloadManager* __4__this; // 0x38
		::System::Uri* uri; // 0x40
		::System::Net::IWebProxy* proxy; // 0x48
		::System::Net::Cache::RequestCachePolicy* cachePolicy; // 0x50
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::WebResponse*> __u__1; // 0x58
