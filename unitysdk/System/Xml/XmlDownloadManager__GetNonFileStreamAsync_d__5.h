...
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x22D2440)
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x15AC940)
...
namespace System::Xml
{
	...
	{
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::IO::Stream*> __t__builder; // 0x10
		::System::Net::ICredentials* credentials; // 0x28
		::System::Net::Cache::RequestCachePolicy* cachePolicy; // 0x30
		::System::Uri* uri; // 0x38
		::System::Net::WebRequest* _req_5__1; // 0x40
		...
		::System::Net::IWebProxy* proxy; // 0x60
