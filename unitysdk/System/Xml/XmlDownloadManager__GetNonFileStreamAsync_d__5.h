...
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BA3CC0)
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x159290)

namespace System::Xml
{
	inline static constexpr unsigned int XmlDownloadManager__GetNonFileStreamAsync_d__5_TypeDefinitionIndex = 1946;
	...
	struct alignas(8) XmlDownloadManager__GetNonFileStreamAsync_d__5
	{
		...
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::IO::Stream*> __t__builder; // 0x38
