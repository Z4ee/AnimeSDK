...
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x393A080)
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x393A090)

namespace System::Xml
{
	inline static constexpr unsigned int XmlDownloadManager__GetNonFileStreamAsync_d__5_TypeDefinitionIndex = 1939;

	struct alignas(8) XmlDownloadManager__GetNonFileStreamAsync_d__5
	{
		::System::Net::IWebProxy* proxy; // 0x10
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::WebResponse*> __u__1; // 0x18
		::System::Net::ICredentials* credentials; // 0x28
		::System::Net::WebRequest* _req_5__1; // 0x30
		::System::Uri* uri; // 0x38
