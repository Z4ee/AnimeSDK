...
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1BD011F0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1BD018B0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1BD019F0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1BD016F0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1BD01360)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1BD01B50)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD014E0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BD01500)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BD017F0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1BD01630)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD00F00)
