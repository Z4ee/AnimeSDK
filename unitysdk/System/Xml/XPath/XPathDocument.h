...
#define SYSTEM_XML_XPATH_XPATHDOCUMENT_GETXMLNAMESPACENODE_OFFSET UNITYSDK_OFFSET(0x1DCED5E0)
#define SYSTEM_XML_XPATH_XPATHDOCUMENT_LOOKUPNAMESPACES_OFFSET UNITYSDK_OFFSET(0x1DCED5F0)
#define SYSTEM_XML_XPATH_XPATHDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCED520)
