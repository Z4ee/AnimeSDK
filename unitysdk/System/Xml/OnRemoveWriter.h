...
#define SYSTEM_XML_ONREMOVEWRITER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19F908B0)
#define SYSTEM_XML_ONREMOVEWRITER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19F908E0)
#define SYSTEM_XML_ONREMOVEWRITER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F908A0)
#define SYSTEM_XML_ONREMOVEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F907B0)

namespace System::Xml
{
	inline static constexpr unsigned int OnRemoveWriter_TypeDefinitionIndex = 1808;
