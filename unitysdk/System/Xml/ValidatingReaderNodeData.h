...
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CA64070)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_GETATOMIZEDNAMEWPREFIX_OFFSET UNITYSDK_OFFSET(0x1CA641B0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETITEMDATA_1_OFFSET UNITYSDK_OFFSET(0x1CA643E0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETITEMDATA_2_OFFSET UNITYSDK_OFFSET(0x1CA643F0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0x1CA643B0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETLINEINFO_1_OFFSET UNITYSDK_OFFSET(0x1CA64250)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETLINEINFO_OFFSET UNITYSDK_OFFSET(0x1CA64240)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CA64110)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA63FD0)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Xml::AttributePSVIInfo* attributePSVIInfo; // 0x18
		::System::String* originalStringValue; // 0x20
		::System::String* rawValue; // 0x28
		::System::String* namespaceUri; // 0x30
