...
#define SYSTEM_XML_XMLVALIDATINGREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1DE4CA90)
#define SYSTEM_XML_XMLVALIDATINGREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1DE4CAD0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DE4CA50)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1DE4CA10)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1DE4C990)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1DE4C950)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1DE4CC90)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE4C9D0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1DE4C850)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1DE4CE20)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1DE4C890)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1DE4CD20)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1DE4C810)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1DE4C8D0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1DE4CCD0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DE4C910)
#define SYSTEM_XML_XMLVALIDATINGREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1DE4CD60)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DE4CB10)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1DE4CBD0)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DE4CB50)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DE4CB90)
#define SYSTEM_XML_XMLVALIDATINGREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1DE4CC10)
#define SYSTEM_XML_XMLVALIDATINGREADER_READ_OFFSET UNITYSDK_OFFSET(0x1DE4CC70)
#define SYSTEM_XML_XMLVALIDATINGREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1DE4CDD0)
