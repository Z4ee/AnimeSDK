...
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19681280)
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19681300)
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19681130)
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19681200)

namespace System::Xml
{
	inline static constexpr unsigned int SecureStringHasher_HashCodeOfStringDelegate_TypeDefinitionIndex = 1820;
