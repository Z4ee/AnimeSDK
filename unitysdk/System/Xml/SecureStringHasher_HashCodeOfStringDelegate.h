...
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FF58E0)
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FF5960)
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FF5220)
#define SYSTEM_XML_SECURESTRINGHASHER_HASHCODEOFSTRINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF58C0)

namespace System::Xml
{
	inline static constexpr unsigned int SecureStringHasher_HashCodeOfStringDelegate_TypeDefinitionIndex = 1816;
