...
#define SYSTEM_XML_UCS4ENCODING4321_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x162B13B0)
#define SYSTEM_XML_UCS4ENCODING4321_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x162B1370)
#define SYSTEM_XML_UCS4ENCODING4321__CTOR_OFFSET UNITYSDK_OFFSET(0x162B0A80)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Encoding4321_TypeDefinitionIndex = 1947;
