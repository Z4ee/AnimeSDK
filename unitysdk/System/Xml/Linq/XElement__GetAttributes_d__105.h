...
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1855E0D0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_XML_LINQ_XATTRIBUTE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1855E1E0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_XML_LINQ_XATTRIBUTE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1855E170)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1855E260)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1855E1D0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1855E180)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1855E0C0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105__CTOR_OFFSET UNITYSDK_OFFSET(0x1855DBD0)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int XElement__GetAttributes_d__105_TypeDefinitionIndex = 4909;
