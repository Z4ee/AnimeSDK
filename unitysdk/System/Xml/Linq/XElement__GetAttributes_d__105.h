...
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AE0F6A0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_XML_LINQ_XATTRIBUTE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE0F7B0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_XML_LINQ_XATTRIBUTE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AE0F740)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE0F830)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AE0F7A0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AE0F750)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AE0F690)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE0F1F0)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int XElement__GetAttributes_d__105_TypeDefinitionIndex = 3884;
	...
	public:
		...
		::System::Xml::Linq::XName* __3__name; // 0x28
