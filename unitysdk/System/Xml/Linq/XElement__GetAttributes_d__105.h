...
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D1A4D40)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_XML_LINQ_XATTRIBUTE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D1A4E50)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_XML_LINQ_XATTRIBUTE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D1A4DE0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D1A4ED0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D1A4E40)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D1A4DF0)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D1A4D30)
#define SYSTEM_XML_LINQ_XELEMENT__GETATTRIBUTES_D__105__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A4890)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int XElement__GetAttributes_d__105_TypeDefinitionIndex = 3888;

	class XElement__GetAttributes_d__105 : public ::System::Object
	{
	public:
		::System::Xml::Linq::XName* __3__name; // 0x10
		::System::Xml::Linq::XAttribute* _a_5__1; // 0x18
