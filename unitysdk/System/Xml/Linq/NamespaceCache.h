...
#define SYSTEM_XML_LINQ_NAMESPACECACHE_GET_OFFSET UNITYSDK_OFFSET(0x20FDDB0)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int NamespaceCache_TypeDefinitionIndex = 4907;
