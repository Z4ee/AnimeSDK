...
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AE0CE10)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_XML_LINQ_XNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE0CF10)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_XML_LINQ_XNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AE0CEA0)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE0CF90)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AE0CF00)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AE0CEB0)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AE0CE00)
#define SYSTEM_XML_LINQ_XCONTAINER__NODES_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE09B60)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int XContainer__Nodes_d__18_TypeDefinitionIndex = 3881;
