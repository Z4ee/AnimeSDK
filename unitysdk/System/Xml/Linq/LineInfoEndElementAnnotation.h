...
#define SYSTEM_XML_LINQ_LINEINFOENDELEMENTANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19F8FE90)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int LineInfoEndElementAnnotation_TypeDefinitionIndex = 4906;
