...
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_CLONENODE_OFFSET UNITYSDK_OFFSET(0x1D1A6BA0)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1D1A6A80)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1D1A6A90)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1D1A6AA0)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_VALIDATENAME_OFFSET UNITYSDK_OFFSET(0x1D1A68D0)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D1A6AB0)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1A6A10)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19EBC0)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int XProcessingInstruction_TypeDefinitionIndex = 3896;
