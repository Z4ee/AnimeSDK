...
#define SYSTEM_XML_LINQ_XTEXT_APPENDTEXT_OFFSET UNITYSDK_OFFSET(0x1D1A6DD0)
#define SYSTEM_XML_LINQ_XTEXT_CLONENODE_OFFSET UNITYSDK_OFFSET(0x1D1A6E00)
#define SYSTEM_XML_LINQ_XTEXT_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1D1A6C40)
#define SYSTEM_XML_LINQ_XTEXT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D1A6C50)
#define SYSTEM_XML_LINQ_XTEXT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D19D2B0)
#define SYSTEM_XML_LINQ_XTEXT_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D1A6C60)
#define SYSTEM_XML_LINQ_XTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D19AE50)
#define SYSTEM_XML_LINQ_XTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19AD70)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int XText_TypeDefinitionIndex = 3882;
