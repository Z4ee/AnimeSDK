...
#define SYSTEM_XML_LINQ_BASEURIANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE9CA90)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int BaseUriAnnotation_TypeDefinitionIndex = 3883;
