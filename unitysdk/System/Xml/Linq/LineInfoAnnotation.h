...
#define SYSTEM_XML_LINQ_LINEINFOANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE06610)

namespace System::Xml::Linq
{
	inline static constexpr unsigned int LineInfoAnnotation_TypeDefinitionIndex = 3872;
