...
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_FALLBACK_1_OFFSET UNITYSDK_OFFSET(0x19F7EA40)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_FALLBACK_OFFSET UNITYSDK_OFFSET(0x19F7E680)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_GETNEXTCHAR_OFFSET UNITYSDK_OFFSET(0x19F7EEA0)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_GET_REMAINING_OFFSET UNITYSDK_OFFSET(0x19F7EF40)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_MOVEPREVIOUS_OFFSET UNITYSDK_OFFSET(0x19F7EF20)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x19F7EF70)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER_SURROGATECHARTOUTF32_OFFSET UNITYSDK_OFFSET(0x19F7EE80)
#define SYSTEM_XML_CHARENTITYENCODERFALLBACKBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F7E5C0)

namespace System::Xml
{
	inline static constexpr unsigned int CharEntityEncoderFallbackBuffer_TypeDefinitionIndex = 1790;
