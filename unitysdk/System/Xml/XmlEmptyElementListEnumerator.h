...
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D18DC10)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D18DBF0)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D18DC00)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18DBE0)
