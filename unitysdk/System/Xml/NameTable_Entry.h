...
#define SYSTEM_XML_NAMETABLE_ENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19F90630)

namespace System::Xml
{
	inline static constexpr unsigned int NameTable_Entry_TypeDefinitionIndex = 1922;
