...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1BACF950)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1BACFA30)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1BACFB10)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BACF820)

namespace System::Xml
{
	inline static constexpr unsigned int XmlAsyncCheckReaderWithNS_TypeDefinitionIndex = 1705;
