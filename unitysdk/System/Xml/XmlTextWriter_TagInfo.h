...
#define SYSTEM_XML_XMLTEXTWRITER_TAGINFO_INIT_OFFSET UNITYSDK_OFFSET(0xA8C7C0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlTextWriter_TagInfo_TypeDefinitionIndex = 1732;
