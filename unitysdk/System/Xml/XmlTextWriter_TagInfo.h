...
#define SYSTEM_XML_XMLTEXTWRITER_TAGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x9980B0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlTextWriter_TagInfo_TypeDefinitionIndex = 1733;
