...
#define SYSTEM_XML_BASE64ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x18561C30)
#define SYSTEM_XML_BASE64ENCODER_FLUSH_OFFSET UNITYSDK_OFFSET(0x18561FB0)
#define SYSTEM_XML_BASE64ENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x18561C00)

namespace System::Xml
{
	inline static constexpr unsigned int Base64Encoder_TypeDefinitionIndex = 1775;
