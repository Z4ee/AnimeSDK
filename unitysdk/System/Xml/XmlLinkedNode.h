...
#define SYSTEM_XML_XMLLINKEDNODE_GET_NEXTSIBLING_OFFSET UNITYSDK_OFFSET(0x1B00C110)
#define SYSTEM_XML_XMLLINKEDNODE_GET_PREVIOUSSIBLING_OFFSET UNITYSDK_OFFSET(0x1B00C0B0)
#define SYSTEM_XML_XMLLINKEDNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B00B920)
#define SYSTEM_XML_XMLLINKEDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00C0A0)
