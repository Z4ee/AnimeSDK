...
#define SYSTEM_XML_XMLSQLBINARYREADER_NAMESPACEDECL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA366A0)
...
namespace System::Xml
{
	...
	{
	public:
		::System::Xml::XmlSqlBinaryReader_NamespaceDecl* scopeLink; // 0x10
		::System::String* prefix; // 0x18
		::System::Xml::XmlSqlBinaryReader_NamespaceDecl* prevLink; // 0x20
