...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1B9777F0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1B9778D0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1B9779B0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B976AF0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlAsyncCheckReaderWithLineInfoNS_TypeDefinitionIndex = 1707;
