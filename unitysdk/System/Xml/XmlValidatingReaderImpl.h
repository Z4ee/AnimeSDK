...
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_ADDDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECB2D90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1ECB2540)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1ECB1DE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1ECB1E10)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECB1DB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1ECB29A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x1ECB15A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1ECB1D80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1ECB1BC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1ECB2620)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1ECB1B90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1ECB2DB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1ECB1D20)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1ECB1C20)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1ECB1BF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1ECB2740)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1ECB2860)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1ECB1AD0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEMANAGER_OFFSET UNITYSDK_OFFSET(0x1ECB2CC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1ECB2BC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1ECB1B00)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1ECB1D50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1ECB1AA0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1ECB1A70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1ECB1B30)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1ECB1C50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1ECB1CE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1ECB18A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x1ECB2CE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ECB2D30)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1ECB1B60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1ECB1CB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1ECB1C80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1ECB2570)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1ECB2AE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVEOFFENTITYREFERENCE_OFFSET UNITYSDK_OFFSET(0x1ECB2670)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1ECB1E80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECB1E40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1ECB1F30)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECB1EB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1ECB1EF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PARSEDTDFROMPARSERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1ECB2250)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PROCESSCOREREADEREVENT_OFFSET UNITYSDK_OFFSET(0x1ECB2050)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1ECB25C0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READSTRING_OFFSET UNITYSDK_OFFSET(0x1ECB2720)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READ_OFFSET UNITYSDK_OFFSET(0x1ECB1F70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITYINTERNALLY_OFFSET UNITYSDK_OFFSET(0x1ECB24B0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1ECB2630)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SETUPVALIDATION_OFFSET UNITYSDK_OFFSET(0x1ECB1640)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_SCHEMATYPEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ECB2D00)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ECB2D60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1ECB2990)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1ECB2A80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1ECB2AD0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDEFAULTATTRIBUTEONUSE_OFFSET UNITYSDK_OFFSET(0x1ECB2DD0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDTD_OFFSET UNITYSDK_OFFSET(0x1ECB2BE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECB11E0)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaCollection* schemaCollection; // 0x18
		::System::Xml::XmlTextReaderImpl* coreReaderImpl; // 0x20
		::System::Xml::XmlValidatingReaderImpl_ValidationEventHandling* eventHandling; // 0x28
		::System::Xml::Schema::BaseValidator* validator; // 0x30
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x38
		::System::Xml::XmlReader* outerReader; // 0x40
		::System::Xml::XmlParserContext* parserContext; // 0x48
		::System::Xml::IXmlNamespaceResolver* coreReaderNSResolver; // 0x50
