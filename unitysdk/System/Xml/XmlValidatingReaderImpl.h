...
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_ADDDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D940740)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D93FF00)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1D93F780)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1D93F7B0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D93F750)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1D940350)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x1D93EF40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1D93F720)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1D93F560)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1D93FFE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1D93F530)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1D940760)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1D93F6C0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1D93F5C0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1D93F590)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1D940100)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D940220)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1D93F470)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEMANAGER_OFFSET UNITYSDK_OFFSET(0x1D940670)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1D940570)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1D93F4A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1D93F6F0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D93F440)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1D93F410)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1D93F4D0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1D93F5F0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1D93F680)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1D93F240)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x1D940690)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D9406E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D93F500)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1D93F650)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1D93F620)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1D93FF30)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1D940490)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVEOFFENTITYREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D940030)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1D93F820)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D93F7E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1D93F8D0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D93F850)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1D93F890)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PARSEDTDFROMPARSERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1D93FC00)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PROCESSCOREREADEREVENT_OFFSET UNITYSDK_OFFSET(0x1D93FA00)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1D93FF80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READSTRING_OFFSET UNITYSDK_OFFSET(0x1D9400E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READ_OFFSET UNITYSDK_OFFSET(0x1D93F910)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITYINTERNALLY_OFFSET UNITYSDK_OFFSET(0x1D93FE70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1D93FFF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SETUPVALIDATION_OFFSET UNITYSDK_OFFSET(0x1D93EFE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_SCHEMATYPEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D9406B0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D940710)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1D940340)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1D940430)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1D940480)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDEFAULTATTRIBUTEONUSE_OFFSET UNITYSDK_OFFSET(0x1D940780)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDTD_OFFSET UNITYSDK_OFFSET(0x1D940590)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D93EB80)

namespace System::Xml
{
	inline static constexpr unsigned int XmlValidatingReaderImpl_TypeDefinitionIndex = 1738;
	...
	public:
		...
		::System::Xml::XmlTextReaderImpl* coreReaderImpl; // 0x18
		::System::Xml::XmlParserContext* parserContext; // 0x20
		::System::Xml::XmlReader* outerReader; // 0x28
		::System::Xml::IXmlNamespaceResolver* coreReaderNSResolver; // 0x30
		::System::Xml::XmlReader* coreReader; // 0x38
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x40
		::System::Xml::XmlValidatingReaderImpl_ValidationEventHandling* eventHandling; // 0x48
		::System::Xml::Schema::BaseValidator* validator; // 0x50
		::System::Xml::ValidationType validationType; // 0x58
		::System::Boolean processIdentityConstraints; // 0x5C
		::System::Xml::XmlValidatingReaderImpl_ParsingFunction parsingFunction; // 0x60
