...
#define SYSTEM_XML_XMLNODECHANGEDEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1AED1260)
#define SYSTEM_XML_XMLNODECHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB80E0)

namespace System::Xml
{
	inline static constexpr unsigned int XmlNodeChangedEventArgs_TypeDefinitionIndex = 1904;
