...
#define SYSTEM_XML_XMLNODECHANGEDEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x18624270)
#define SYSTEM_XML_XMLNODECHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1860AD00)
...
namespace System::Xml
{
	...
	public:
		...
		::System::String* newValue; // 0x18
		::System::Xml::XmlNode* node; // 0x20
		::System::String* oldValue; // 0x28
