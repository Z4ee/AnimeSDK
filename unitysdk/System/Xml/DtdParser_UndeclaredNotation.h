...
#define SYSTEM_XML_DTDPARSER_UNDECLAREDNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7AA40)

namespace System::Xml
{
	inline static constexpr unsigned int DtdParser_UndeclaredNotation_TypeDefinitionIndex = 1805;
