...
#define SYSTEM_ASSEMBLYLOADEVENTARGS_GET_LOADEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1AE3AA50)
#define SYSTEM_ASSEMBLYLOADEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE39480)
