...
#define SYSTEM_ASSEMBLYLOADEVENTARGS_GET_LOADEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x18C504F0)
#define SYSTEM_ASSEMBLYLOADEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4EF10)
