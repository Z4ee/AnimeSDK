...
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION_GET_CREATETYPE_OFFSET UNITYSDK_OFFSET(0x1A23CE30)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A23CEB0)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION_SET_CREATETYPE_OFFSET UNITYSDK_OFFSET(0x1A23CE70)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A23CD70)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A23CDB0)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A23CDF0)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A23CD30)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeObjectCreateExpression_TypeDefinitionIndex = 4269;
