...
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D69FF50)
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D69FF90)
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D69FF10)
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69FED0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeDefaultValueExpression_TypeDefinitionIndex = 4251;
