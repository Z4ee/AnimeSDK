...
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_GET_REGIONMODE_OFFSET UNITYSDK_OFFSET(0x19201750)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_GET_REGIONTEXT_OFFSET UNITYSDK_OFFSET(0x192017D0)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_SET_REGIONMODE_OFFSET UNITYSDK_OFFSET(0x19201790)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_SET_REGIONTEXT_OFFSET UNITYSDK_OFFSET(0x19201810)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19201710)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x192016D0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeRegionDirective_TypeDefinitionIndex = 4273;
