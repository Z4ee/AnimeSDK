...
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_GET_REGIONMODE_OFFSET UNITYSDK_OFFSET(0x1C863410)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_GET_REGIONTEXT_OFFSET UNITYSDK_OFFSET(0x1C863490)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_SET_REGIONMODE_OFFSET UNITYSDK_OFFSET(0x1C863450)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_SET_REGIONTEXT_OFFSET UNITYSDK_OFFSET(0x1C8634D0)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C8633D0)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C863390)
