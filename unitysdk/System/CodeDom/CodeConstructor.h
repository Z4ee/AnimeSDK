...
#define SYSTEM_CODEDOM_CODECONSTRUCTOR_GET_BASECONSTRUCTORARGS_OFFSET UNITYSDK_OFFSET(0x1A7D2E20)
#define SYSTEM_CODEDOM_CODECONSTRUCTOR_GET_CHAINEDCONSTRUCTORARGS_OFFSET UNITYSDK_OFFSET(0x1A7D2E60)
#define SYSTEM_CODEDOM_CODECONSTRUCTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D2DE0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeConstructor_TypeDefinitionIndex = 4251;
