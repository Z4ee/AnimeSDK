...
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_CATCHEXCEPTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1C862C00)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1C862C80)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x1C862D00)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_SET_CATCHEXCEPTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1C862C40)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_SET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1C862CC0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C862B40)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C862B80)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C862BC0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C862B00)
