...
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_CATCHEXCEPTIONTYPE_OFFSET UNITYSDK_OFFSET(0x19200F40)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x19200FC0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x19201040)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_SET_CATCHEXCEPTIONTYPE_OFFSET UNITYSDK_OFFSET(0x19200F80)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_SET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x19201000)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19200E80)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19200EC0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19200F00)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19200E40)
