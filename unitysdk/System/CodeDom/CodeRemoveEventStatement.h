...
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x1D6A00D0)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1D6A0150)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_SET_EVENT_OFFSET UNITYSDK_OFFSET(0x1D6A0110)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_SET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1D6A0190)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D6A0050)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D6A0090)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A0010)
