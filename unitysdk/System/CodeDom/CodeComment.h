...
#define SYSTEM_CODEDOM_CODECOMMENT_GET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x1E7DD7C0)
#define SYSTEM_CODEDOM_CODECOMMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1E7DD840)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x1E7DD800)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1E7DD880)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7DD740)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E7DD780)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DD700)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeComment_TypeDefinitionIndex = 4042;
