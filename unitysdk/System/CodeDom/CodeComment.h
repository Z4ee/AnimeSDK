...
#define SYSTEM_CODEDOM_CODECOMMENT_GET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x1D452C80)
#define SYSTEM_CODEDOM_CODECOMMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1D452D00)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x1D452CC0)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1D452D40)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D452C00)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D452C40)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D452BC0)
