...
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT_GET_TOTHROW_OFFSET UNITYSDK_OFFSET(0x1C888DB0)
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT_SET_TOTHROW_OFFSET UNITYSDK_OFFSET(0x1C888DF0)
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C888D70)
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C888D30)
