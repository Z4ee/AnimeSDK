...
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DEAE560)
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DEAE5A0)
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEAE520)
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAE4E0)
