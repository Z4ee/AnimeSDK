...
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_CATCHCLAUSES_OFFSET UNITYSDK_OFFSET(0x18FA4250)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_FINALLYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x18FA4290)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_TRYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x18FA42D0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FA41D0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FA4210)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA4190)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeTryCatchFinallyStatement_TypeDefinitionIndex = 4282;
