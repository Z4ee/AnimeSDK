...
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_CATCHCLAUSES_OFFSET UNITYSDK_OFFSET(0x1B1B2320)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_FINALLYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1B1B2360)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_TRYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1B1B23A0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1B22A0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1B22E0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B2260)
