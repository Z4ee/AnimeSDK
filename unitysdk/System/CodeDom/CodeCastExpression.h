...
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DAADE30)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1DAADEB0)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DAADE70)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1DAADEF0)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAADD70)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DAADDB0)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DAADDF0)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAADD30)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeCastExpression_TypeDefinitionIndex = 4245;
