...
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1C1BCC30)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_GET_ATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x1C1BCC70)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C1BCCB0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C1BCCF0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C1BCB30)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C1BCB70)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C1BCBB0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C1BCBF0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BCAF0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeAttributeDeclaration_TypeDefinitionIndex = 4050;
