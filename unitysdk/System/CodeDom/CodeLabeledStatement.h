...
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_GET_LABEL_OFFSET UNITYSDK_OFFSET(0x1CAE6C50)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_GET_STATEMENT_OFFSET UNITYSDK_OFFSET(0x1CAE6CD0)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_SET_LABEL_OFFSET UNITYSDK_OFFSET(0x1CAE6C90)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_SET_STATEMENT_OFFSET UNITYSDK_OFFSET(0x1CAE6D10)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAE6BD0)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CAE6C10)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE6B90)
