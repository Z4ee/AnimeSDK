...
#define SYSTEM_CODEDOM_CODEMEMBEREVENT_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x19201590)
#define SYSTEM_CODEDOM_CODEMEMBEREVENT_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x192015D0)
#define SYSTEM_CODEDOM_CODEMEMBEREVENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19201650)
#define SYSTEM_CODEDOM_CODEMEMBEREVENT_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x19201610)
#define SYSTEM_CODEDOM_CODEMEMBEREVENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19201690)
#define SYSTEM_CODEDOM_CODEMEMBEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19201550)
