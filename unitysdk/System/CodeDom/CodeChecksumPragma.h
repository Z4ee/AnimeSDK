...
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_CHECKSUMALGORITHMID_OFFSET UNITYSDK_OFFSET(0x1CAE6750)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_CHECKSUMDATA_OFFSET UNITYSDK_OFFSET(0x1CAE67D0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1CAE6850)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_CHECKSUMALGORITHMID_OFFSET UNITYSDK_OFFSET(0x1CAE6790)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_CHECKSUMDATA_OFFSET UNITYSDK_OFFSET(0x1CAE6810)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1CAE6890)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAE6710)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE66D0)
