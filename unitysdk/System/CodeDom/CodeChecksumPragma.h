...
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_CHECKSUMALGORITHMID_OFFSET UNITYSDK_OFFSET(0x1A7D2C60)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_CHECKSUMDATA_OFFSET UNITYSDK_OFFSET(0x1A7D2CE0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A7D2D60)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_CHECKSUMALGORITHMID_OFFSET UNITYSDK_OFFSET(0x1A7D2CA0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_CHECKSUMDATA_OFFSET UNITYSDK_OFFSET(0x1A7D2D20)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A7D2DA0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7D2C20)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D2BE0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeChecksumPragma_TypeDefinitionIndex = 4249;
