...
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_ADD_POPULATEIMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1D223900)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_ADD_POPULATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D223980)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_ADD_POPULATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1D223A00)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1D2236C0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D223700)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1D223740)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_RETURNTYPECUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1D223840)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1D2237C0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x1D223880)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_TYPEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D2238C0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_REMOVE_POPULATEIMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1D223940)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_REMOVE_POPULATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D2239C0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_REMOVE_POPULATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1D223A40)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1D223780)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_SET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1D223800)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D223680)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeMemberMethod_TypeDefinitionIndex = 4081;
