...
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_ADD_POPULATEIMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1BEB1FA0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_ADD_POPULATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BEB2020)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_ADD_POPULATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1BEB20A0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1BEB1D60)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BEB1DA0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1BEB1DE0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_RETURNTYPECUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1BEB1EE0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1BEB1E60)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x1BEB1F20)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_GET_TYPEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BEB1F60)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_REMOVE_POPULATEIMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1BEB1FE0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_REMOVE_POPULATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BEB2060)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_REMOVE_POPULATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1BEB20E0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1BEB1E20)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD_SET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1BEB1EA0)
#define SYSTEM_CODEDOM_CODEMEMBERMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB1D20)
