...
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_GETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1DAAE430)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASGET_OFFSET UNITYSDK_OFFSET(0x1DAAE470)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASSET_OFFSET UNITYSDK_OFFSET(0x1DAAE4F0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1DAAE570)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1DAAE5B0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1DAAE5F0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_SETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1DAAE670)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DAAE6B0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASGET_OFFSET UNITYSDK_OFFSET(0x1DAAE4B0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASSET_OFFSET UNITYSDK_OFFSET(0x1DAAE530)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1DAAE630)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DAAE6F0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAAE3F0)
