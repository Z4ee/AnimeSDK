...
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_GETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1A23C6F0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASGET_OFFSET UNITYSDK_OFFSET(0x1A23C730)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASSET_OFFSET UNITYSDK_OFFSET(0x1A23C7B0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1A23C830)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A23C870)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A23C8B0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_SETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1A23C930)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A23C970)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASGET_OFFSET UNITYSDK_OFFSET(0x1A23C770)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASSET_OFFSET UNITYSDK_OFFSET(0x1A23C7F0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A23C8F0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A23C9B0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A23C6B0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeMemberProperty_TypeDefinitionIndex = 4265;
