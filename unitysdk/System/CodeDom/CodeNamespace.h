...
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATECOMMENTS_OFFSET UNITYSDK_OFFSET(0x1A7D3520)
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATEIMPORTS_OFFSET UNITYSDK_OFFSET(0x1A7D35A0)
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATETYPES_OFFSET UNITYSDK_OFFSET(0x1A7D3620)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1A7D33E0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_IMPORTS_OFFSET UNITYSDK_OFFSET(0x1A7D3420)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7D3460)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_TYPES_OFFSET UNITYSDK_OFFSET(0x1A7D34E0)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATECOMMENTS_OFFSET UNITYSDK_OFFSET(0x1A7D3560)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATEIMPORTS_OFFSET UNITYSDK_OFFSET(0x1A7D35E0)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATETYPES_OFFSET UNITYSDK_OFFSET(0x1A7D3660)
#define SYSTEM_CODEDOM_CODENAMESPACE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7D34A0)
#define SYSTEM_CODEDOM_CODENAMESPACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7D33A0)
#define SYSTEM_CODEDOM_CODENAMESPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D3360)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeNamespace_TypeDefinitionIndex = 4036;
