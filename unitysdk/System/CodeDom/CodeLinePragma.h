...
#define SYSTEM_CODEDOM_CODELINEPRAGMA_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1D87E180)
#define SYSTEM_CODEDOM_CODELINEPRAGMA_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1D87E200)
#define SYSTEM_CODEDOM_CODELINEPRAGMA_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1D87E1C0)
#define SYSTEM_CODEDOM_CODELINEPRAGMA_SET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1D87E240)
#define SYSTEM_CODEDOM_CODELINEPRAGMA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D87E140)
#define SYSTEM_CODEDOM_CODELINEPRAGMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D87E100)
