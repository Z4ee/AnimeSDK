...
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION_GET_PARAMETERNAME_OFFSET UNITYSDK_OFFSET(0x1A568FE0)
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION_SET_PARAMETERNAME_OFFSET UNITYSDK_OFFSET(0x1A569020)
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A568FA0)
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A568F60)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeArgumentReferenceExpression_TypeDefinitionIndex = 4100;
