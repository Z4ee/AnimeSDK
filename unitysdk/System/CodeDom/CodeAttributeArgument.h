...
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19ADB480)
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19ADB500)
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19ADB4C0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19ADB540)
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19ADB400)
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19ADB440)
#define SYSTEM_CODEDOM_CODEATTRIBUTEARGUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADB3C0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeAttributeArgument_TypeDefinitionIndex = 4052;
