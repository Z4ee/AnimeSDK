...
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_ARRAYELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19ADB880)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_ARRAYRANK_OFFSET UNITYSDK_OFFSET(0x19ADB900)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_BASETYPE_OFFSET UNITYSDK_OFFSET(0x19ADB980)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x19ADBA00)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_TYPEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x19ADBA80)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_ARRAYELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19ADB8C0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_ARRAYRANK_OFFSET UNITYSDK_OFFSET(0x19ADB940)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_BASETYPE_OFFSET UNITYSDK_OFFSET(0x19ADB9C0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x19ADBA40)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19ADB680)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19ADB6C0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19ADB700)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19ADB740)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19ADB780)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x19ADB7C0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x19ADB800)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x19ADB840)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADB640)
