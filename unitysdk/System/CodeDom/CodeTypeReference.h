...
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_ARRAYELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1C008D40)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_ARRAYRANK_OFFSET UNITYSDK_OFFSET(0x1C008DC0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_BASETYPE_OFFSET UNITYSDK_OFFSET(0x1C008E40)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C008EC0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_TYPEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1C008F40)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_ARRAYELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1C008D80)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_ARRAYRANK_OFFSET UNITYSDK_OFFSET(0x1C008E00)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_BASETYPE_OFFSET UNITYSDK_OFFSET(0x1C008E80)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C008F00)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C008B40)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C008B80)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C008BC0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C008C00)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C008C40)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1C008C80)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1C008CC0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1C008D00)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C008B00)
