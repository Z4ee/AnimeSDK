...
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_1_OFFSET UNITYSDK_OFFSET(0x1B3E7AC0)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_2_OFFSET UNITYSDK_OFFSET(0x1B3E7B00)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_3_OFFSET UNITYSDK_OFFSET(0x1B3E7B40)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_OFFSET UNITYSDK_OFFSET(0x1B3E7A80)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAIT_OFFSET UNITYSDK_OFFSET(0x1B3E7A40)
