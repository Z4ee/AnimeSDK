...
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_1_OFFSET UNITYSDK_OFFSET(0x1C8636D0)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_2_OFFSET UNITYSDK_OFFSET(0x1C863710)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_3_OFFSET UNITYSDK_OFFSET(0x1C863750)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_OFFSET UNITYSDK_OFFSET(0x1C863690)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAIT_OFFSET UNITYSDK_OFFSET(0x1C863650)

namespace System::CodeDom::Compiler
{
	inline static constexpr unsigned int Executor_TypeDefinitionIndex = 4291;
