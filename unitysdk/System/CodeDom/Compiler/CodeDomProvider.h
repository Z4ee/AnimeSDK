...
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMDOM_OFFSET UNITYSDK_OFFSET(0x1DEAEE20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1DEAEE60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1DEAEEA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEESCAPEDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1DEAEEE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEGENERATOR_1_OFFSET UNITYSDK_OFFSET(0x1DEAEF60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEGENERATOR_OFFSET UNITYSDK_OFFSET(0x1DEAEF20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPARSER_OFFSET UNITYSDK_OFFSET(0x1DEAEFA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x1DEAF020)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1DEAEFE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1DEAF060)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1DEAF0A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1DEAF0E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x1DEAF120)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1DEAF160)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1DEAF1A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMTYPE_OFFSET UNITYSDK_OFFSET(0x1DEAF1E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETALLCOMPILERINFO_OFFSET UNITYSDK_OFFSET(0x1DEAF220)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETCOMPILERINFO_OFFSET UNITYSDK_OFFSET(0x1DEAF260)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1DEAF2A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETLANGUAGEFROMEXTENSION_OFFSET UNITYSDK_OFFSET(0x1DEAF2E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETTYPEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1DEAF320)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GET_FILEEXTENSION_OFFSET UNITYSDK_OFFSET(0x1DEAEDA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GET_LANGUAGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1DEAEDE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISDEFINEDEXTENSION_OFFSET UNITYSDK_OFFSET(0x1DEAF360)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISDEFINEDLANGUAGE_OFFSET UNITYSDK_OFFSET(0x1DEAF3A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1DEAF3E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_PARSE_OFFSET UNITYSDK_OFFSET(0x1DEAF420)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1DEAF460)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAED60)
