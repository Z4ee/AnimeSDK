...
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMDOM_OFFSET UNITYSDK_OFFSET(0x1A7D3BA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1A7D3BE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1A7D3C20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEESCAPEDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A7D3C60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEGENERATOR_1_OFFSET UNITYSDK_OFFSET(0x1A7D3CE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEGENERATOR_OFFSET UNITYSDK_OFFSET(0x1A7D3CA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPARSER_OFFSET UNITYSDK_OFFSET(0x1A7D3D20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x1A7D3DA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A7D3D60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A7D3DE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1A7D3E20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A7D3E60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x1A7D3EA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A7D3EE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1A7D3F20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMTYPE_OFFSET UNITYSDK_OFFSET(0x1A7D3F60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETALLCOMPILERINFO_OFFSET UNITYSDK_OFFSET(0x1A7D3FA0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETCOMPILERINFO_OFFSET UNITYSDK_OFFSET(0x1A7D3FE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A7D4020)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETLANGUAGEFROMEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A7D4060)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETTYPEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A7D40A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GET_FILEEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A7D3B20)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GET_LANGUAGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A7D3B60)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISDEFINEDEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A7D40E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISDEFINEDLANGUAGE_OFFSET UNITYSDK_OFFSET(0x1A7D4120)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A7D4160)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_PARSE_OFFSET UNITYSDK_OFFSET(0x1A7D41A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1A7D41E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D3AE0)

namespace System::CodeDom::Compiler
{
	inline static constexpr unsigned int CodeDomProvider_TypeDefinitionIndex = 4027;
