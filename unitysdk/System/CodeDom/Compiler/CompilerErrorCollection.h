...
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_ADDRANGE_1_OFFSET UNITYSDK_OFFSET(0x1DAAF1F0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x1DAAF1B0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1DAAF170)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1DAAF230)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1DAAF270)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x1DAAF070)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_GET_HASWARNINGS_OFFSET UNITYSDK_OFFSET(0x1DAAF0B0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DAAF0F0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1DAAF2B0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x1DAAF2F0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1DAAF330)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DAAF130)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAAEFF0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DAAF030)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAAEFB0)
