...
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_BLANKLINESBETWEENMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DEAF4E0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_BRACINGSTYLE_OFFSET UNITYSDK_OFFSET(0x1DEAF560)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_ELSEONCLOSING_OFFSET UNITYSDK_OFFSET(0x1DEAF5E0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_INDENTSTRING_OFFSET UNITYSDK_OFFSET(0x1DEAF660)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DEAF6E0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_VERBATIMORDER_OFFSET UNITYSDK_OFFSET(0x1DEAF760)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_BLANKLINESBETWEENMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DEAF520)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_BRACINGSTYLE_OFFSET UNITYSDK_OFFSET(0x1DEAF5A0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_ELSEONCLOSING_OFFSET UNITYSDK_OFFSET(0x1DEAF620)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_INDENTSTRING_OFFSET UNITYSDK_OFFSET(0x1DEAF6A0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DEAF720)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_VERBATIMORDER_OFFSET UNITYSDK_OFFSET(0x1DEAF7A0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAF4A0)
