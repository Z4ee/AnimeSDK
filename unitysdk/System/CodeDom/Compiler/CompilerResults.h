...
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_COMPILEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x18FA4350)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_ERRORS_OFFSET UNITYSDK_OFFSET(0x18FA43D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x18FA4410)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_NATIVECOMPILERRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x18FA4490)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x18FA4510)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_PATHTOASSEMBLY_OFFSET UNITYSDK_OFFSET(0x18FA4550)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x18FA45D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_COMPILEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x18FA4390)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x18FA4450)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_NATIVECOMPILERRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x18FA44D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_PATHTOASSEMBLY_OFFSET UNITYSDK_OFFSET(0x18FA4590)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x18FA4610)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA4310)

namespace System::CodeDom::Compiler
{
	inline static constexpr unsigned int CompilerResults_TypeDefinitionIndex = 4030;
