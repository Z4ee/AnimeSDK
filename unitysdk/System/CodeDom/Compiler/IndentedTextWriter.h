...
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x18FA4840)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x18FA4870)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x18FA4780)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x18FA4810)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_GET_INNERWRITER_OFFSET UNITYSDK_OFFSET(0x18FA4830)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_GET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x18FA47B0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_OUTPUTTABS_OFFSET UNITYSDK_OFFSET(0x18FA48A0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x18FA4820)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_SET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x18FA47E0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINENOTABS_OFFSET UNITYSDK_OFFSET(0x18FA4CC0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_10_OFFSET UNITYSDK_OFFSET(0x18FA4FB0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_11_OFFSET UNITYSDK_OFFSET(0x18FA4FF0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_12_OFFSET UNITYSDK_OFFSET(0x18FA5040)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_13_OFFSET UNITYSDK_OFFSET(0x18FA50A0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_14_OFFSET UNITYSDK_OFFSET(0x18FA50F0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x18FA4D30)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x18FA4D70)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_3_OFFSET UNITYSDK_OFFSET(0x18FA4DB0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_4_OFFSET UNITYSDK_OFFSET(0x18FA4DF0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_5_OFFSET UNITYSDK_OFFSET(0x18FA4E30)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_6_OFFSET UNITYSDK_OFFSET(0x18FA4E90)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_7_OFFSET UNITYSDK_OFFSET(0x18FA4EE0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_8_OFFSET UNITYSDK_OFFSET(0x18FA4F30)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_9_OFFSET UNITYSDK_OFFSET(0x18FA4F70)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x18FA4CF0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_10_OFFSET UNITYSDK_OFFSET(0x18FA4BC0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_11_OFFSET UNITYSDK_OFFSET(0x18FA4C10)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_12_OFFSET UNITYSDK_OFFSET(0x18FA4C70)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x18FA4940)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x18FA4980)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_3_OFFSET UNITYSDK_OFFSET(0x18FA49C0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_4_OFFSET UNITYSDK_OFFSET(0x18FA4A00)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_5_OFFSET UNITYSDK_OFFSET(0x18FA4A60)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_6_OFFSET UNITYSDK_OFFSET(0x18FA4AB0)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_7_OFFSET UNITYSDK_OFFSET(0x18FA4B00)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_8_OFFSET UNITYSDK_OFFSET(0x18FA4B40)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_9_OFFSET UNITYSDK_OFFSET(0x18FA4B80)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x18FA4900)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FA4700)
#define SYSTEM_CODEDOM_COMPILER_INDENTEDTEXTWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA4650)
...
namespace System::CodeDom::Compiler
{
	...
	public:
		...
		::System::Boolean _tabsPending; // 0x38
		::System::Int32 _indentLevel; // 0x3C
