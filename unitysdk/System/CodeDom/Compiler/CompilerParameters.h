...
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_COMPILEROPTIONS_OFFSET UNITYSDK_OFFSET(0x1C889440)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_COREASSEMBLYFILENAME_OFFSET UNITYSDK_OFFSET(0x1C8894C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_EMBEDDEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1C889540)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x1C889580)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_GENERATEEXECUTABLE_OFFSET UNITYSDK_OFFSET(0x1C889600)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_GENERATEINMEMORY_OFFSET UNITYSDK_OFFSET(0x1C889680)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_INCLUDEDEBUGINFORMATION_OFFSET UNITYSDK_OFFSET(0x1C889700)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_LINKEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1C889780)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_MAINCLASS_OFFSET UNITYSDK_OFFSET(0x1C8897C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_OUTPUTASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1C889840)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_REFERENCEDASSEMBLIES_OFFSET UNITYSDK_OFFSET(0x1C8898C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x1C889900)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_TREATWARNINGSASERRORS_OFFSET UNITYSDK_OFFSET(0x1C889980)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1C889A00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_WARNINGLEVEL_OFFSET UNITYSDK_OFFSET(0x1C889A80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_WIN32RESOURCE_OFFSET UNITYSDK_OFFSET(0x1C889B00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_COMPILEROPTIONS_OFFSET UNITYSDK_OFFSET(0x1C889480)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_COREASSEMBLYFILENAME_OFFSET UNITYSDK_OFFSET(0x1C889500)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x1C8895C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_GENERATEEXECUTABLE_OFFSET UNITYSDK_OFFSET(0x1C889640)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_GENERATEINMEMORY_OFFSET UNITYSDK_OFFSET(0x1C8896C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_INCLUDEDEBUGINFORMATION_OFFSET UNITYSDK_OFFSET(0x1C889740)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_MAINCLASS_OFFSET UNITYSDK_OFFSET(0x1C889800)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_OUTPUTASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1C889880)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x1C889940)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_TREATWARNINGSASERRORS_OFFSET UNITYSDK_OFFSET(0x1C8899C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1C889A40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_WARNINGLEVEL_OFFSET UNITYSDK_OFFSET(0x1C889AC0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_WIN32RESOURCE_OFFSET UNITYSDK_OFFSET(0x1C889B40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C889380)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C8893C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C889400)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C889340)
