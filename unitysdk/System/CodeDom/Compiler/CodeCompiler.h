...
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMDOMBATCH_OFFSET UNITYSDK_OFFSET(0x1DB732C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMDOM_OFFSET UNITYSDK_OFFSET(0x1DB73280)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMFILEBATCH_OFFSET UNITYSDK_OFFSET(0x1DB73340)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMFILE_OFFSET UNITYSDK_OFFSET(0x1DB73300)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMSOURCEBATCH_OFFSET UNITYSDK_OFFSET(0x1DB733C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1DB73380)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_GETRESPONSEFILECMDARGS_OFFSET UNITYSDK_OFFSET(0x1DB73400)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_JOINSTRINGARRAY_OFFSET UNITYSDK_OFFSET(0x1DB73440)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMDOMBATCH_OFFSET UNITYSDK_OFFSET(0x1DB734C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMDOM_OFFSET UNITYSDK_OFFSET(0x1DB73480)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMFILEBATCH_OFFSET UNITYSDK_OFFSET(0x1DB73540)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1DB73500)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMSOURCEBATCH_OFFSET UNITYSDK_OFFSET(0x1DB735C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1DB73580)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB73240)
