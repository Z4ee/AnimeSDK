...
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEDEFAULTCOMPILERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D5C9DF0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x1D5C9E70)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1D5C9E30)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GETEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1D5C9EB0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GETLANGUAGES_OFFSET UNITYSDK_OFFSET(0x1D5C9EF0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GET_CODEDOMPROVIDERTYPE_OFFSET UNITYSDK_OFFSET(0x1D5C9D70)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GET_ISCODEDOMPROVIDERTYPEVALID_OFFSET UNITYSDK_OFFSET(0x1D5C9DB0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C9D30)
