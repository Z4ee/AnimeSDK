...
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_CONTINUEONNEWLINE_OFFSET UNITYSDK_OFFSET(0x1CEC0870)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEBINARYOPERATOREXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC08B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x1CEC08F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMMENTSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1CEC0970)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1CEC0930)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNITEND_OFFSET UNITYSDK_OFFSET(0x1CEC09F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNITSTART_OFFSET UNITYSDK_OFFSET(0x1CEC0A30)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1CEC09B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDECIMALVALUE_OFFSET UNITYSDK_OFFSET(0x1CEC0A70)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDEFAULTVALUEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0AB0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDIRECTIONEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0AF0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x1CEC0B30)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDOUBLEVALUE_OFFSET UNITYSDK_OFFSET(0x1CEC0B70)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0BB0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACEIMPORTS_OFFSET UNITYSDK_OFFSET(0x1CEC0C30)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACES_OFFSET UNITYSDK_OFFSET(0x1CEC0C70)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CEC0BF0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEPARAMETERDECLARATIONEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0CB0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEPRIMITIVEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0CF0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESINGLEFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x1CEC0D30)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESNIPPETCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1CEC0D70)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESNIPPETSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1CEC0DB0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1CEC0E30)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESTATEMENT_OFFSET UNITYSDK_OFFSET(0x1CEC0DF0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPEOFEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0E70)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPEREFERENCEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC0EB0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPES_OFFSET UNITYSDK_OFFSET(0x1CEC0EF0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTCLASS_OFFSET UNITYSDK_OFFSET(0x1CEC0530)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1CEC05B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTMEMBER_OFFSET UNITYSDK_OFFSET(0x1CEC0570)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTTYPENAME_OFFSET UNITYSDK_OFFSET(0x1CEC05F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x1CEC0630)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTCLASS_OFFSET UNITYSDK_OFFSET(0x1CEC06B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTDELEGATE_OFFSET UNITYSDK_OFFSET(0x1CEC06F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTENUM_OFFSET UNITYSDK_OFFSET(0x1CEC0730)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTINTERFACE_OFFSET UNITYSDK_OFFSET(0x1CEC0770)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1CEC07B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1CEC07F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1CEC0830)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_ISVALIDLANGUAGEINDEPENDENTIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC0F30)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTATTRIBUTEARGUMENT_OFFSET UNITYSDK_OFFSET(0x1CEC0F70)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTATTRIBUTEDECLARATIONS_OFFSET UNITYSDK_OFFSET(0x1CEC0FB0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CEC0FF0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTEXPRESSIONLIST_1_OFFSET UNITYSDK_OFFSET(0x1CEC1070)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTEXPRESSIONLIST_OFFSET UNITYSDK_OFFSET(0x1CEC1030)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTFIELDSCOPEMODIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC10B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC10F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTMEMBERACCESSMODIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC1130)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTMEMBERSCOPEMODIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC1170)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTOPERATOR_OFFSET UNITYSDK_OFFSET(0x1CEC11B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1CEC11F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTTYPEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1CEC1230)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTTYPENAMEPAIR_OFFSET UNITYSDK_OFFSET(0x1CEC1270)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x1CEC0670)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_CREATEESCAPEDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC12B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_CREATEVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC12F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1CEC1330)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1CEC1370)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CEC13B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1CEC13F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMTYPE_OFFSET UNITYSDK_OFFSET(0x1CEC1430)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GETTYPEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1CEC1470)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_ISVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC14B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1CEC14F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_VALIDATEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC1530)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_VALIDATEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x1CEC15B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_VALIDATEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1CEC1570)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEC04F0)
