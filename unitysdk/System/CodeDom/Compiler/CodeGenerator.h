...
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_CONTINUEONNEWLINE_OFFSET UNITYSDK_OFFSET(0x1AA8F140)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEBINARYOPERATOREXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F180)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA8F1C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMMENTSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1AA8F240)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1AA8F200)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNITEND_OFFSET UNITYSDK_OFFSET(0x1AA8F2C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNITSTART_OFFSET UNITYSDK_OFFSET(0x1AA8F300)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1AA8F280)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDECIMALVALUE_OFFSET UNITYSDK_OFFSET(0x1AA8F340)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDEFAULTVALUEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F380)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDIRECTIONEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F3C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x1AA8F400)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDOUBLEVALUE_OFFSET UNITYSDK_OFFSET(0x1AA8F440)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F480)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACEIMPORTS_OFFSET UNITYSDK_OFFSET(0x1AA8F500)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACES_OFFSET UNITYSDK_OFFSET(0x1AA8F540)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1AA8F4C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEPARAMETERDECLARATIONEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F580)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEPRIMITIVEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F5C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESINGLEFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x1AA8F600)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESNIPPETCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1AA8F640)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESNIPPETSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1AA8F680)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1AA8F700)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESTATEMENT_OFFSET UNITYSDK_OFFSET(0x1AA8F6C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPEOFEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F740)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPEREFERENCEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8F780)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPES_OFFSET UNITYSDK_OFFSET(0x1AA8F7C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTCLASS_OFFSET UNITYSDK_OFFSET(0x1AA8EE00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AA8EE80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA8EE40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTTYPENAME_OFFSET UNITYSDK_OFFSET(0x1AA8EEC0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x1AA8EF00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTCLASS_OFFSET UNITYSDK_OFFSET(0x1AA8EF80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTDELEGATE_OFFSET UNITYSDK_OFFSET(0x1AA8EFC0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTENUM_OFFSET UNITYSDK_OFFSET(0x1AA8F000)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTINTERFACE_OFFSET UNITYSDK_OFFSET(0x1AA8F040)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1AA8F080)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1AA8F0C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1AA8F100)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_ISVALIDLANGUAGEINDEPENDENTIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8F800)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTATTRIBUTEARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AA8F840)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTATTRIBUTEDECLARATIONS_OFFSET UNITYSDK_OFFSET(0x1AA8F880)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AA8F8C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTEXPRESSIONLIST_1_OFFSET UNITYSDK_OFFSET(0x1AA8F940)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTEXPRESSIONLIST_OFFSET UNITYSDK_OFFSET(0x1AA8F900)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTFIELDSCOPEMODIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8F980)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8F9C0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTMEMBERACCESSMODIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FA00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTMEMBERSCOPEMODIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FA40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTOPERATOR_OFFSET UNITYSDK_OFFSET(0x1AA8FA80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AA8FAC0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTTYPEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AA8FB00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTTYPENAMEPAIR_OFFSET UNITYSDK_OFFSET(0x1AA8FB40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x1AA8EF40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_CREATEESCAPEDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FB80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_CREATEVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FBC0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x1AA8FC00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA8FC40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1AA8FC80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1AA8FCC0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMTYPE_OFFSET UNITYSDK_OFFSET(0x1AA8FD00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GETTYPEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1AA8FD40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_ISVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FD80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x1AA8FDC0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_VALIDATEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FE00)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_VALIDATEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x1AA8FE80)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_VALIDATEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AA8FE40)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8EDC0)

namespace System::CodeDom::Compiler
{
	inline static constexpr unsigned int CodeGenerator_TypeDefinitionIndex = 4290;
