...
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x1A7D2AE0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1A7D2B60)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_SET_EVENT_OFFSET UNITYSDK_OFFSET(0x1A7D2B20)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_SET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1A7D2BA0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7D2A60)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A7D2AA0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D2A20)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeAttachEventStatement_TypeDefinitionIndex = 4241;
