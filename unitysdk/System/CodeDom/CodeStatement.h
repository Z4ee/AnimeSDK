...
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_ENDDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x1B1E1CE0)
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x1B1E1D20)
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_STARTDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x1B1E1DA0)
#define SYSTEM_CODEDOM_CODESTATEMENT_SET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x1B1E1D60)
#define SYSTEM_CODEDOM_CODESTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E1CA0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeStatement_TypeDefinitionIndex = 4039;
