...
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B1E1EE0)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B1E1F20)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1E1E20)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1E1E60)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B1E1EA0)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E1DE0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeTypeOfExpression_TypeDefinitionIndex = 4285;
