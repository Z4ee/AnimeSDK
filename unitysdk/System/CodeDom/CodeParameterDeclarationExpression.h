...
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_GET_CUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A0F35C0)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1A0F3640)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A0F36C0)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A0F3740)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_SET_CUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A0F3600)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1A0F3680)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A0F3700)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A0F3780)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F3500)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0F3540)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A0F3580)
#define SYSTEM_CODEDOM_CODEPARAMETERDECLARATIONEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F34C0)

namespace System::CodeDom
{
	inline static constexpr unsigned int CodeParameterDeclarationExpression_TypeDefinitionIndex = 4084;
