...
#define SYSTEM_NUMBER_DECIMALTONUMBER_OFFSET UNITYSDK_OFFSET(0x1E778C80)
#define SYSTEM_NUMBER_NUMBERBUFFERTODECIMAL_OFFSET UNITYSDK_OFFSET(0x1E77B8C0)
#define SYSTEM_NUMBER_ROUNDNUMBER_OFFSET UNITYSDK_OFFSET(0x1E779980)
#define SYSTEM_NUMBER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E77CF30)
