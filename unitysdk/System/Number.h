...
#define SYSTEM_NUMBER_DECIMALTONUMBER_OFFSET UNITYSDK_OFFSET(0x19F52F10)
#define SYSTEM_NUMBER_NUMBERBUFFERTODECIMAL_OFFSET UNITYSDK_OFFSET(0x19F55AF0)
#define SYSTEM_NUMBER_ROUNDNUMBER_OFFSET UNITYSDK_OFFSET(0x19F53BF0)
#define SYSTEM_NUMBER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F57160)

namespace System
{
	inline static constexpr unsigned int Number_TypeDefinitionIndex = 4974;
