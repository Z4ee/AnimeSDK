...
#define SYSTEM_CURRENTSYSTEMTIMEZONE_GETTIMEZONEDATA_OFFSET UNITYSDK_OFFSET(0x18CEF0A0)
#define SYSTEM_CURRENTSYSTEMTIMEZONE_GETUTCOFFSET_OFFSET UNITYSDK_OFFSET(0x18CEF020)
#define SYSTEM_CURRENTSYSTEMTIMEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CEEF50)
