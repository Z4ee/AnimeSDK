...
#define SYSTEM___IL2CPPCOMDELEGATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x178A5E90)

namespace System
{
	inline static constexpr unsigned int __Il2CppComDelegate_TypeDefinitionIndex = 1763;
