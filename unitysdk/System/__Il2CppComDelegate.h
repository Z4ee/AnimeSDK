...
#define SYSTEM___IL2CPPCOMDELEGATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x16279590)

namespace System
{
	inline static constexpr unsigned int __Il2CppComDelegate_TypeDefinitionIndex = 1762;
