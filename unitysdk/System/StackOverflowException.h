...
#define SYSTEM_STACKOVERFLOWEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DC0D3E0)
#define SYSTEM_STACKOVERFLOWEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DC0D470)
#define SYSTEM_STACKOVERFLOWEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC0D320)

namespace System
{
	inline static constexpr unsigned int StackOverflowException_TypeDefinitionIndex = 317;
