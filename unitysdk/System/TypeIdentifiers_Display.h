...
#define SYSTEM_TYPEIDENTIFIERS_DISPLAY_GETINTERNALNAME_OFFSET UNITYSDK_OFFSET(0x1626D8D0)
#define SYSTEM_TYPEIDENTIFIERS_DISPLAY_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1626D890)
#define SYSTEM_TYPEIDENTIFIERS_DISPLAY_GET_INTERNALNAME_OFFSET UNITYSDK_OFFSET(0x1626D8A0)
#define SYSTEM_TYPEIDENTIFIERS_DISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1626D870)
