...
#define SYSTEM_DLLNOTFOUNDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1790C950)
#define SYSTEM_DLLNOTFOUNDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1790C9C0)
#define SYSTEM_DLLNOTFOUNDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1790C8E0)
