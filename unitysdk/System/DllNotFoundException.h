...
#define SYSTEM_DLLNOTFOUNDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A597E00)
#define SYSTEM_DLLNOTFOUNDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A597E90)
#define SYSTEM_DLLNOTFOUNDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A597D40)
