...
#define SYSTEM_MISSINGMEMBEREXCEPTION_FORMATSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AE4A2F0)
#define SYSTEM_MISSINGMEMBEREXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1AE4A530)
#define SYSTEM_MISSINGMEMBEREXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1AE4A1C0)
#define SYSTEM_MISSINGMEMBEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE49FE0)
#define SYSTEM_MISSINGMEMBEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE4A070)
#define SYSTEM_MISSINGMEMBEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE49F20)

namespace System
{
	inline static constexpr unsigned int MissingMemberException_TypeDefinitionIndex = 288;
