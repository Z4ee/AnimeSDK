...
#define SYSTEM_GLOBALIZATION_GLOBALIZATIONASSEMBLY_GETGLOBALIZATIONRESOURCEBYTEPTR_OFFSET UNITYSDK_OFFSET(0x1CD8D690)
#define SYSTEM_GLOBALIZATION_GLOBALIZATIONASSEMBLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD8D740)
