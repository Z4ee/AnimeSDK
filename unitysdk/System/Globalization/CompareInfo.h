...
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ASSIGN_SORTKEY_OFFSET UNITYSDK_OFFSET(0x1CE76520)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPAREORDINAL_OFFSET UNITYSDK_OFFSET(0x1CE73600)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPARE_1_OFFSET UNITYSDK_OFFSET(0x1CE72DB0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPARE_2_OFFSET UNITYSDK_OFFSET(0x1CE73190)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPARE_3_OFFSET UNITYSDK_OFFSET(0x1CE731E0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPARE_4_OFFSET UNITYSDK_OFFSET(0x1CE732A0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPARE_5_OFFSET UNITYSDK_OFFSET(0x1CE732D0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_COMPARE_OFFSET UNITYSDK_OFFSET(0x1CE72D90)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_CREATESORTKEYCORE_OFFSET UNITYSDK_OFFSET(0x1CE75B90)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_CREATESORTKEY_OFFSET UNITYSDK_OFFSET(0x1CE75A40)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CE75E50)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETCOLLATOR_OFFSET UNITYSDK_OFFSET(0x1CE73AF0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETCOMPAREINFO_1_OFFSET UNITYSDK_OFFSET(0x1CE72800)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETCOMPAREINFO_2_OFFSET UNITYSDK_OFFSET(0x1CE727D0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETCOMPAREINFO_3_OFFSET UNITYSDK_OFFSET(0x1CE729C0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETCOMPAREINFO_OFFSET UNITYSDK_OFFSET(0x1CE72660)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETHASHCODEOFSTRING_1_OFFSET UNITYSDK_OFFSET(0x1CE76230)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETHASHCODEOFSTRING_OFFSET UNITYSDK_OFFSET(0x1CE763E0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x1CE75F90)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CE75F00)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETNATIVECOMPAREFLAGS_OFFSET UNITYSDK_OFFSET(0x1CE72D50)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETSORTKEY_1_OFFSET UNITYSDK_OFFSET(0x1CE75B10)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GETSORTKEY_OFFSET UNITYSDK_OFFSET(0x1CE75A30)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GET_INTERNALSORTVERSION_OFFSET UNITYSDK_OFFSET(0x1CE76490)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GET_ISLEGACY20SORTINGBEHAVIORREQUESTED_OFFSET UNITYSDK_OFFSET(0x1CE76480)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GET_LCID_OFFSET UNITYSDK_OFFSET(0x1CE76450)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CE72CC0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GET_USEMANAGEDCOLLATION_OFFSET UNITYSDK_OFFSET(0x1CE739B0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1CE764A0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_10_OFFSET UNITYSDK_OFFSET(0x1CE74790)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_11_OFFSET UNITYSDK_OFFSET(0x1CE74C80)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1CE74290)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_2_OFFSET UNITYSDK_OFFSET(0x1CE74330)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_3_OFFSET UNITYSDK_OFFSET(0x1CE743D0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_4_OFFSET UNITYSDK_OFFSET(0x1CE74470)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_5_OFFSET UNITYSDK_OFFSET(0x1CE74520)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_6_OFFSET UNITYSDK_OFFSET(0x1CE745D0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_7_OFFSET UNITYSDK_OFFSET(0x1CE74680)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_8_OFFSET UNITYSDK_OFFSET(0x1CE74730)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_9_OFFSET UNITYSDK_OFFSET(0x1CE74760)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1CE741F0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_COMPARE_MANAGED_OFFSET UNITYSDK_OFFSET(0x1CE76840)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1CE76830)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_COMPARE_SWITCH_OFFSET UNITYSDK_OFFSET(0x1CE72F20)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_INDEX_1_OFFSET UNITYSDK_OFFSET(0x1CE766A0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_INDEX_MANAGED_1_OFFSET UNITYSDK_OFFSET(0x1CE76790)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_INDEX_MANAGED_OFFSET UNITYSDK_OFFSET(0x1CE76600)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_INDEX_OFFSET UNITYSDK_OFFSET(0x1CE765F0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_INDEX_SWITCH_1_OFFSET UNITYSDK_OFFSET(0x1CE74ED0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_INTERNAL_INDEX_SWITCH_OFFSET UNITYSDK_OFFSET(0x1CE749E0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ISPREFIX_1_OFFSET UNITYSDK_OFFSET(0x1CE73E10)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ISPREFIX_OFFSET UNITYSDK_OFFSET(0x1CE73650)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ISSORTABLE_1_OFFSET UNITYSDK_OFFSET(0x1CE72B00)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ISSORTABLE_OFFSET UNITYSDK_OFFSET(0x1CE72A50)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ISSUFFIX_1_OFFSET UNITYSDK_OFFSET(0x1CE741D0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ISSUFFIX_OFFSET UNITYSDK_OFFSET(0x1CE73E30)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_10_OFFSET UNITYSDK_OFFSET(0x1CE755B0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_11_OFFSET UNITYSDK_OFFSET(0x1CE75800)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1CE752B0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_2_OFFSET UNITYSDK_OFFSET(0x1CE75350)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_3_OFFSET UNITYSDK_OFFSET(0x1CE753F0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_4_OFFSET UNITYSDK_OFFSET(0x1CE75490)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_5_OFFSET UNITYSDK_OFFSET(0x1CE754C0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_6_OFFSET UNITYSDK_OFFSET(0x1CE754F0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_7_OFFSET UNITYSDK_OFFSET(0x1CE75520)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_8_OFFSET UNITYSDK_OFFSET(0x1CE75550)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_9_OFFSET UNITYSDK_OFFSET(0x1CE75580)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_LASTINDEXOF_OFFSET UNITYSDK_OFFSET(0x1CE75210)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ONDESERIALIZED_1_OFFSET UNITYSDK_OFFSET(0x1CE72BE0)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1CE72B90)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1CE72B80)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1CE72C30)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_SYSTEM_RUNTIME_SERIALIZATION_IDESERIALIZATIONCALLBACK_ONDESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1CE72C70)
#define SYSTEM_GLOBALIZATION_COMPAREINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CE76400)
#define SYSTEM_GLOBALIZATION_COMPAREINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CE76880)
#define SYSTEM_GLOBALIZATION_COMPAREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE72640)
...
namespace System::Globalization
{
	...
	public:
		...
		::System::String* m_sortName; // 0x10
		::Mono::Globalization::Unicode::SimpleCollator* collator; // 0x18
		::System::Globalization::SortVersion* m_SortVersion; // 0x20
