...
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x18C5E250)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x18C5E110)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x18C5DF80)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x18C5E0F0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x18C5E270)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x18C5DF20)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x18C5DE30)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x18C5E290)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x18C5E280)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x18C5DE50)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x18C5DEC0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18C5DDD0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x18C5DE40)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x18C5DE60)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18C5DD70)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C5E2B0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5E130)
