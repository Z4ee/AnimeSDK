...
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x1D054AA0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x1D054F00)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x1D053900)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKHEBREWDAYVALUE_OFFSET UNITYSDK_OFFSET(0x1D053BC0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKHEBREWMONTHVALUE_OFFSET UNITYSDK_OFFSET(0x1D053990)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKHEBREWYEARVALUE_OFFSET UNITYSDK_OFFSET(0x1D053780)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x1D053E70)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x1D054270)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1D055A90)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x1D0551D0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x1D055200)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x1D0552F0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1D053CA0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1D0554D0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1D0555D0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETHEBREWYEARTYPE_OFFSET UNITYSDK_OFFSET(0x1D055250)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1D0559E0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETLUNARMONTHDAY_OFFSET UNITYSDK_OFFSET(0x1D054050)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1D053B10)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x1D0556C0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1D053FB0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1D0553B0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1D053750)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1D055630)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1D053770)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1D0536F0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1D053690)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1D055FB0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_HEBREWTOGREGORIAN_OFFSET UNITYSDK_OFFSET(0x1D055DB0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1D055790)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1D055910)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1D0556F0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1D056020)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1D0553D0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1D0560F0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D056210)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D053760)
