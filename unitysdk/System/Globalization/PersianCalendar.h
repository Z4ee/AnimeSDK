...
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x1C6CEE50)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x1C6CF1A0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x1C6CE570)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x1C6CE430)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x1C6CE780)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x1C6CE600)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_DAYSINPREVIOUSMONTHS_OFFSET UNITYSDK_OFFSET(0x1C6CE390)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETABSOLUTEDATEPERSIAN_OFFSET UNITYSDK_OFFSET(0x1C6CE1D0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x1C6CE9C0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x1C6CF1B0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x1C6CF1D0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x1C6CF210)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1C6CF230)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1C6CF370)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1C6CF590)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1C6CF9A0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1C6CF6B0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x1C6CF690)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1C6CF720)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1C6CE190)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1C6CE1B0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1C6CF600)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C6CE1C0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1C6CE130)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1C6CE0D0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1C6CFA70)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1C6CF800)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1C6CFA00)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1C6CF4F0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_MONTHFROMORDINALDAY_OFFSET UNITYSDK_OFFSET(0x1C6CE8C0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1C6CFAE0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1C6CEC70)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1C6CFC10)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6CFD30)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6CE1A0)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(PersianCalendar_TypeDefinitionIndex)->GetStaticField(0xD78);
		}
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(PersianCalendar_TypeDefinitionIndex)->GetStaticField(0xD88);
		}
