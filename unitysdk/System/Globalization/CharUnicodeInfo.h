...
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETDECIMALDIGITVALUE_1_OFFSET UNITYSDK_OFFSET(0x1CB19C00)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETDECIMALDIGITVALUE_OFFSET UNITYSDK_OFFSET(0x1CB19BA0)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETDIGITVALUE_1_OFFSET UNITYSDK_OFFSET(0x1CB19D30)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETDIGITVALUE_OFFSET UNITYSDK_OFFSET(0x1CB19CD0)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETNUMERICVALUE_1_OFFSET UNITYSDK_OFFSET(0x1CB19AD0)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETNUMERICVALUE_OFFSET UNITYSDK_OFFSET(0x1CB19A70)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETUNICODECATEGORY_1_OFFSET UNITYSDK_OFFSET(0x1CB19560)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_GETUNICODECATEGORY_OFFSET UNITYSDK_OFFSET(0x1CB19740)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALCONVERTTOUTF32_1_OFFSET UNITYSDK_OFFSET(0x1CB19360)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALCONVERTTOUTF32_OFFSET UNITYSDK_OFFSET(0x1CB191F0)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALGETCATEGORYVALUE_OFFSET UNITYSDK_OFFSET(0x1CB19F10)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALGETDIGITVALUES_OFFSET UNITYSDK_OFFSET(0x1CB19930)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALGETNUMERICVALUE_OFFSET UNITYSDK_OFFSET(0x1CB197F0)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALGETUNICODECATEGORY_1_OFFSET UNITYSDK_OFFSET(0x1CB19E60)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALGETUNICODECATEGORY_2_OFFSET UNITYSDK_OFFSET(0x1CB1A050)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_INTERNALGETUNICODECATEGORY_OFFSET UNITYSDK_OFFSET(0x1CB19E00)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_ISCOMBININGCATEGORY_OFFSET UNITYSDK_OFFSET(0x1CB1A110)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_ISWHITESPACE_1_OFFSET UNITYSDK_OFFSET(0x1CB19620)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1CB194F0)
#define SYSTEM_GLOBALIZATION_CHARUNICODEINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB1A150)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt16>**)Il2CppClass::FromTypeDefinitionIndex(CharUnicodeInfo_TypeDefinitionIndex)->GetStaticField(0x1180);
		}
