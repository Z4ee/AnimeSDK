...
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_DAYHOURSEP_OFFSET UNITYSDK_OFFSET(0x38389F0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_END_OFFSET UNITYSDK_OFFSET(0x3838AB0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_HOURMINUTESEP_OFFSET UNITYSDK_OFFSET(0x3838A20)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_MINUTESECONDSEP_OFFSET UNITYSDK_OFFSET(0x3838A50)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_SECONDFRACTIONSEP_OFFSET UNITYSDK_OFFSET(0x3838A80)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_START_OFFSET UNITYSDK_OFFSET(0x38389C0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_INITINVARIANT_OFFSET UNITYSDK_OFFSET(0x186F81C0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_INIT_OFFSET UNITYSDK_OFFSET(0x3838AE0)
