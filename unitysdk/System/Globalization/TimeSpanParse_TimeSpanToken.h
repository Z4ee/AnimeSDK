...
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKEN_ISINVALIDNUMBER_OFFSET UNITYSDK_OFFSET(0x20D7550)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKEN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20D7530)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x20D7510)

namespace System::Globalization
{
	inline static constexpr unsigned int TimeSpanParse_TimeSpanToken_TypeDefinitionIndex = 772;
