...
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDDAYS_OFFSET UNITYSDK_OFFSET(0x18C5C5C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDHOURS_OFFSET UNITYSDK_OFFSET(0x18C5C5D0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x18C5C5B0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMINUTES_OFFSET UNITYSDK_OFFSET(0x18C5C5E0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDSECONDS_OFFSET UNITYSDK_OFFSET(0x18C5C5F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDWEEKS_OFFSET UNITYSDK_OFFSET(0x18C5C600)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADD_OFFSET UNITYSDK_OFFSET(0x18C5C430)
#define SYSTEM_GLOBALIZATION_CALENDAR_CHECKADDRESULT_OFFSET UNITYSDK_OFFSET(0x18C5C310)
#define SYSTEM_GLOBALIZATION_CALENDAR_CLONE_OFFSET UNITYSDK_OFFSET(0x18C5BFC0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x18C5C620)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x18C5C640)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETFIRSTDAYWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x18C5C790)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETHOUR_OFFSET UNITYSDK_OFFSET(0x18C5C660)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_1_OFFSET UNITYSDK_OFFSET(0x18C5CFE0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18C5CFC0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x18C5C6A0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMINUTE_OFFSET UNITYSDK_OFFSET(0x18C5C6F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x18C5C730)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSECOND_OFFSET UNITYSDK_OFFSET(0x18C5C750)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSYSTEMTWODIGITYEARSETTING_OFFSET UNITYSDK_OFFSET(0x18C5D6F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEARFULLDAYS_OFFSET UNITYSDK_OFFSET(0x18C5C860)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAROFMINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18C5CB10)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x18C5CC90)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x18C5BFA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x18C5BF90)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_CURRENTERAVALUE_OFFSET UNITYSDK_OFFSET(0x18C5C280)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x18C5CC80)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x18C5BF80)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18C5BFB0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18C5BF60)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18C5BF50)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18C5D380)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x18C5CF70)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18C5CFA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x18C5D080)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDDAY_OFFSET UNITYSDK_OFFSET(0x18C5D310)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDMONTH_OFFSET UNITYSDK_OFFSET(0x18C5D2B0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDYEAR_OFFSET UNITYSDK_OFFSET(0x18C5D250)
#define SYSTEM_GLOBALIZATION_CALENDAR_READONLY_OFFSET UNITYSDK_OFFSET(0x18C5C0C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_SETREADONLYSTATE_OFFSET UNITYSDK_OFFSET(0x18C5C270)
#define SYSTEM_GLOBALIZATION_CALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18C5D390)
#define SYSTEM_GLOBALIZATION_CALENDAR_TIMETOTICKS_OFFSET UNITYSDK_OFFSET(0x18C5D4E0)
#define SYSTEM_GLOBALIZATION_CALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x18C5D0A0)
#define SYSTEM_GLOBALIZATION_CALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x18C5D400)
#define SYSTEM_GLOBALIZATION_CALENDAR_TRYTODATETIME_OFFSET UNITYSDK_OFFSET(0x18C5D100)
#define SYSTEM_GLOBALIZATION_CALENDAR_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x18C5C200)
#define SYSTEM_GLOBALIZATION_CALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5BF70)
