...
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDDAYS_OFFSET UNITYSDK_OFFSET(0x1AE46A70)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDHOURS_OFFSET UNITYSDK_OFFSET(0x1AE46A80)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1AE46A60)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMINUTES_OFFSET UNITYSDK_OFFSET(0x1AE46A90)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDSECONDS_OFFSET UNITYSDK_OFFSET(0x1AE46AA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDWEEKS_OFFSET UNITYSDK_OFFSET(0x1AE46AB0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADD_OFFSET UNITYSDK_OFFSET(0x1AE468E0)
#define SYSTEM_GLOBALIZATION_CALENDAR_CHECKADDRESULT_OFFSET UNITYSDK_OFFSET(0x1AE467C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_CLONE_OFFSET UNITYSDK_OFFSET(0x1AE46470)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1AE46AD0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1AE46AF0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETFIRSTDAYWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x1AE46C40)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETHOUR_OFFSET UNITYSDK_OFFSET(0x1AE46B10)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_1_OFFSET UNITYSDK_OFFSET(0x1AE47490)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1AE47470)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1AE46B50)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMINUTE_OFFSET UNITYSDK_OFFSET(0x1AE46BA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1AE46BE0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSECOND_OFFSET UNITYSDK_OFFSET(0x1AE46C00)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSYSTEMTWODIGITYEARSETTING_OFFSET UNITYSDK_OFFSET(0x1AE47BA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEARFULLDAYS_OFFSET UNITYSDK_OFFSET(0x1AE46D10)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAROFMINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1AE46FC0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x1AE47140)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1AE46450)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1AE46440)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_CURRENTERAVALUE_OFFSET UNITYSDK_OFFSET(0x1AE46730)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1AE47130)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1AE46430)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1AE46460)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1AE46410)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1AE46400)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1AE47830)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1AE47420)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1AE47450)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1AE47530)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDDAY_OFFSET UNITYSDK_OFFSET(0x1AE477C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDMONTH_OFFSET UNITYSDK_OFFSET(0x1AE47760)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDYEAR_OFFSET UNITYSDK_OFFSET(0x1AE47700)
#define SYSTEM_GLOBALIZATION_CALENDAR_READONLY_OFFSET UNITYSDK_OFFSET(0x1AE46570)
#define SYSTEM_GLOBALIZATION_CALENDAR_SETREADONLYSTATE_OFFSET UNITYSDK_OFFSET(0x1AE46720)
#define SYSTEM_GLOBALIZATION_CALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1AE47840)
#define SYSTEM_GLOBALIZATION_CALENDAR_TIMETOTICKS_OFFSET UNITYSDK_OFFSET(0x1AE47990)
#define SYSTEM_GLOBALIZATION_CALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1AE47550)
#define SYSTEM_GLOBALIZATION_CALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1AE478B0)
#define SYSTEM_GLOBALIZATION_CALENDAR_TRYTODATETIME_OFFSET UNITYSDK_OFFSET(0x1AE475B0)
#define SYSTEM_GLOBALIZATION_CALENDAR_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x1AE466B0)
#define SYSTEM_GLOBALIZATION_CALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE46420)
