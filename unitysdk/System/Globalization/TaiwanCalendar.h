...
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x195FB0A0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x195FB0C0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x195FB170)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x195FB1B0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x195FB220)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x195FB0F0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x195FB110)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETDEFAULTINSTANCE_OFFSET UNITYSDK_OFFSET(0x195DDA30)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x195FB2C0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x195FB3B0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x195FB260)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x195FB2E0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x195FB290)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x195FB320)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x195FAF00)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x195FB410)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x195FB090)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x195FAEF0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x195FAE90)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x195FB430)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x195FB340)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x195FB3D0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x195FB360)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x195FB4A0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x195FB3F0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x195FB5F0)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x195FB710)
#define SYSTEM_GLOBALIZATION_TAIWANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x195FACC0)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Globalization::EraInfo*>**)Il2CppClass::FromTypeDefinitionIndex(TaiwanCalendar_TypeDefinitionIndex)->GetStaticField(0xF10);
		}
		static ::System::Globalization::Calendar** StaticGet_s_defaultInstance()
		{
			return (::System::Globalization::Calendar**)Il2CppClass::FromTypeDefinitionIndex(TaiwanCalendar_TypeDefinitionIndex)->GetStaticField(0xF18);
		}
