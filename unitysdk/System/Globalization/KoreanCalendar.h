...
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x19E0CB00)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x19E0CB20)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x19E0CBD0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x19E0CC10)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x19E0CC80)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x19E0CB50)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x19E0CB70)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x19E0CD20)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x19E0CE10)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x19E0CCC0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x19E0CD40)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x19E0CCF0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x19E0CD80)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x19E0C910)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x19E0CE70)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x19E0CAF0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x19E0C900)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x19E0C8F0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x19E0CE90)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x19E0CDA0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x19E0CE30)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x19E0CDC0)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x19E0CF00)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x19E0CE50)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x19E0D050)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E0D140)
#define SYSTEM_GLOBALIZATION_KOREANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0C920)
