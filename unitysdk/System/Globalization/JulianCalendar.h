...
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x1C8B7830)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x1C8B7C30)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_CHECKDAYRANGE_OFFSET UNITYSDK_OFFSET(0x1C8B7430)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x1C8B71B0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_CHECKMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x1C8B73C0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_CHECKYEARERARANGE_OFFSET UNITYSDK_OFFSET(0x1C8B7240)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_DATETOTICKS_OFFSET UNITYSDK_OFFSET(0x1C8B7760)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x1C8B75D0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x1C8B7C40)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x1C8B7CB0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x1C8B7D00)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1C8B7E00)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1C8B7F80)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1C8B7FC0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1C8B8390)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1C8B8120)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x1C8B8020)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1C8B8140)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1C8B7170)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1C8B8090)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C8B71A0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1C8B7160)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1C8B7150)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1C8B8780)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1C8B8240)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1C8B83A0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1C8B7FA0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1C8B8790)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1C8B8470)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1C8B88C0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C8B89D0)
#define SYSTEM_GLOBALIZATION_JULIANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8B7180)
