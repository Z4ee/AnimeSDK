...
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_BACKONE_OFFSET UNITYSDK_OFFSET(0x20D7620)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GETNEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x20D75D0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GET_CURRENTCHAR_OFFSET UNITYSDK_OFFSET(0x20D7670)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GET_EOL_OFFSET UNITYSDK_OFFSET(0x20D75F0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x20D7630)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_INIT_1_OFFSET UNITYSDK_OFFSET(0x1635270)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_INIT_OFFSET UNITYSDK_OFFSET(0x20D75C0)

namespace System::Globalization
{
	inline static constexpr unsigned int TimeSpanParse_TimeSpanTokenizer_TypeDefinitionIndex = 773;
