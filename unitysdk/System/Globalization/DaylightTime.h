...
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1B91D620)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME_GET_END_OFFSET UNITYSDK_OFFSET(0x1B91D610)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME_GET_START_OFFSET UNITYSDK_OFFSET(0x1B91D600)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B91D5F0)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B91D5E0)
