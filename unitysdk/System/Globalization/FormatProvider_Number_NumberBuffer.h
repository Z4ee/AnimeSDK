...
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_NUMBERBUFFER_GET_DIGITS_OFFSET UNITYSDK_OFFSET(0x14410)

namespace System::Globalization
{
	inline static constexpr unsigned int FormatProvider_Number_NumberBuffer_TypeDefinitionIndex = 3834;
