...
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x195F6F10)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x195F6BF0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x195F6A70)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x195F6BD0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x195F6F30)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x195F6A10)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x195F6920)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x195F6F50)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x195F6F40)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x195F6940)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x195F69B0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x195F68C0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x195F6930)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x195F6950)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x195F6860)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_TRIMERAS_OFFSET UNITYSDK_OFFSET(0x195F6C10)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x195F6F70)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x195F6DC0)
