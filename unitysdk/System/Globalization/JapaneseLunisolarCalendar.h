...
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1BA1A6B0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x1BA1A390)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x1BA1A210)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1BA1A370)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1BA1A6D0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x1BA1A1B0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1BA1A0C0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1BA1A6F0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1BA1A6E0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1BA1A0E0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1BA1A150)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1BA1A060)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1BA1A0D0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1BA1A0F0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1BA1A000)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_TRIMERAS_OFFSET UNITYSDK_OFFSET(0x1BA1A3B0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BA1A710)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1A560)
