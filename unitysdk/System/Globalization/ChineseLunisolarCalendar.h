...
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1E443BF0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x1E443A80)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x1E443900)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1E443A70)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1E443C20)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x1E4438F0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1E443800)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1E443C30)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1E443C10)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1E443820)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1E443890)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1E4437A0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1E443810)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1E443830)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1E443740)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E443C90)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E443B90)
