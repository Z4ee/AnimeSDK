...
#define SYSTEM_GLOBALIZATION_IDNMAPPING_CONVERT_OFFSET UNITYSDK_OFFSET(0x1B920000)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B91FD30)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_1_OFFSET UNITYSDK_OFFSET(0x1B91FF80)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_2_OFFSET UNITYSDK_OFFSET(0x1B91FE80)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_OFFSET UNITYSDK_OFFSET(0x1B91FDA0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B91FD90)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_1_OFFSET UNITYSDK_OFFSET(0x1B921210)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_2_OFFSET UNITYSDK_OFFSET(0x1B921110)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_OFFSET UNITYSDK_OFFSET(0x1B921030)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GET_ALLOWUNASSIGNED_OFFSET UNITYSDK_OFFSET(0x1B91FCF0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GET_USESTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x1B91FD10)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_NAMEPREP_OFFSET UNITYSDK_OFFSET(0x1B920880)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_SET_ALLOWUNASSIGNED_OFFSET UNITYSDK_OFFSET(0x1B91FD00)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_SET_USESTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x1B91FD20)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_TOASCII_OFFSET UNITYSDK_OFFSET(0x1B920380)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_TOUNICODE_OFFSET UNITYSDK_OFFSET(0x1B920670)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYLENGTH_OFFSET UNITYSDK_OFFSET(0x1B920C40)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYPROHIBITEDCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1B920D30)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYSTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x1B920A00)
#define SYSTEM_GLOBALIZATION_IDNMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B91FC90)
