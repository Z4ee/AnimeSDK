...
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_GETTIMESPANPARSEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x97AA20)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_INIT_OFFSET UNITYSDK_OFFSET(0x97A8B0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x97A930)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_SETFAILURE_2_OFFSET UNITYSDK_OFFSET(0x97A9A0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x97A8C0)

namespace System::Globalization
{
	inline static constexpr unsigned int TimeSpanParse_TimeSpanResult_TypeDefinitionIndex = 763;
