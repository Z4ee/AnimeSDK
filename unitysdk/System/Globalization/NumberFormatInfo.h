...
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_CHECKGROUPSIZE_OFFSET UNITYSDK_OFFSET(0x1CE81150)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x1CE80E50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GETFORMAT_OFFSET UNITYSDK_OFFSET(0x1CE83210)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1CE80BA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE80F40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE81080)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE81AA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x1CE81230)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE81D70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE82740)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE81BB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENTINFO_OFFSET UNITYSDK_OFFSET(0x1CE80D00)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_DIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x1CE83100)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_INVARIANTINFO_OFFSET UNITYSDK_OFFSET(0x1CE809C0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1CE81140)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NANSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE81C90)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE82F40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NEGATIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82270)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NEGATIVESIGN_OFFSET UNITYSDK_OFFSET(0x1CE82350)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE82430)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82570)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82630)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x1CE81500)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE81EB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE82A40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82B80)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82C40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x1CE817D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE82130)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE81FF0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82D60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERMILLESYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82E50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_POSITIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82880)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_POSITIVESIGN_OFFSET UNITYSDK_OFFSET(0x1CE82960)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1CE80440)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1CE80430)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1CE80320)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_READONLY_OFFSET UNITYSDK_OFFSET(0x1CE80A70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE80F50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE81090)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE81AB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x1CE81340)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE81D80)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE82750)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE81BC0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_DIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x1CE83110)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NANSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE81CA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE83050)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NEGATIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82280)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NEGATIVESIGN_OFFSET UNITYSDK_OFFSET(0x1CE82360)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE82440)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82580)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82640)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x1CE81610)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE81EC0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE82A50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82B90)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE82C50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x1CE818E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE82140)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x1CE82000)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82D70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERMILLESYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82E60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_POSITIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CE82890)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_POSITIVESIGN_OFFSET UNITYSDK_OFFSET(0x1CE82970)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VALIDATEPARSESTYLEFLOATINGPOINT_OFFSET UNITYSDK_OFFSET(0x1CE83320)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VALIDATEPARSESTYLEINTEGER_OFFSET UNITYSDK_OFFSET(0x1CE83260)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE80450)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYDIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x1CE808E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1CE80500)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYNATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x1CE80570)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x1CE80950)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CE7FF60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7FF50)
