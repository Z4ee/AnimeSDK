...
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GETTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x172CFFA0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x172CFF90)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x172CFF40)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x172CFED0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x172CFEC0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x172CFF30)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x172CFE70)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x172D0060)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x172CF6B0)
...
namespace System::Globalization
{
	...
	public:
		...
		::System::Globalization::UnicodeCategory uc; // 0x1C
		::System::Int32 endIndex; // 0x20
		::System::Int32 nextTextElementLen; // 0x24
		::System::Int32 strLen; // 0x28
		::System::Int32 startIndex; // 0x2C
		::System::Int32 currTextElementLen; // 0x30
