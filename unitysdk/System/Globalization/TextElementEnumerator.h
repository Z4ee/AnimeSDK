...
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GETTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A7BDA40)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7BDA30)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GET_ELEMENTINDEX_OFFSET UNITYSDK_OFFSET(0x1A7BDB00)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7BD9E0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A7BD950)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1A7BD940)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1A7BD9D0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7BD8C0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7BDB70)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BD830)

namespace System::Globalization
{
	inline static constexpr unsigned int TextElementEnumerator_TypeDefinitionIndex = 748;

	class TextElementEnumerator : public ::System::Object
	{
	public:
		::System::String* str; // 0x10
		::System::Int32 charLen; // 0x18
		::System::Int32 strLen; // 0x1C
		::System::Int32 endIndex; // 0x20
		::System::Int32 currTextElementLen; // 0x24
		::System::Int32 index; // 0x28
		::System::Int32 startIndex; // 0x2C
		::System::Int32 nextTextElementLen; // 0x30
		::System::Globalization::UnicodeCategory uc; // 0x34
		...
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GET_ELEMENTINDEX_OFFSET))(this);
		}
