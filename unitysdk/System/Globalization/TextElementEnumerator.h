...
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GETTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x1BD2D410)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BD2D400)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BD2D3B0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1BD2D340)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1BD2D330)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1BD2D3A0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BD2D2E0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD2D4D0)
#define SYSTEM_GLOBALIZATION_TEXTELEMENTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2CB30)

namespace System::Globalization
{
	inline static constexpr unsigned int TextElementEnumerator_TypeDefinitionIndex = 765;

	class TextElementEnumerator : public ::System::Object
	{
	public:
		::System::String* str; // 0x10
		::System::Globalization::UnicodeCategory uc; // 0x18
		::System::Int32 startIndex; // 0x1C
		::System::Int32 currTextElementLen; // 0x20
		::System::Int32 strLen; // 0x24
		::System::Int32 endIndex; // 0x28
		::System::Int32 index; // 0x2C
		::System::Int32 charLen; // 0x30
		::System::Int32 nextTextElementLen; // 0x34
