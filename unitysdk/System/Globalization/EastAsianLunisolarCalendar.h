...
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x1ADB1B20)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x1ADB1DA0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x1ADB0B00)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x1ADB0300)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x1ADB0DC0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x1ADB0C60)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETCELESTIALSTEM_OFFSET UNITYSDK_OFFSET(0x1ADB0510)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x1ADB1FC0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x1ADB2170)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB1EF0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1ADB0EE0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB2020)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1ADB23D0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB21D0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x1ADB20A0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETSEXAGENARYYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB0280)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETTERRESTRIALBRANCH_OFFSET UNITYSDK_OFFSET(0x1ADB0630)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB2100)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1ADB0270)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1ADB2440)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GREGORIANISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB0F30)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GREGORIANTOLUNAR_OFFSET UNITYSDK_OFFSET(0x1ADB1590)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_INTERNALGETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1ADB0EA0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_INTERNALISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB1D80)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1ADB2210)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1ADB2390)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB2410)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_LUNARTOGREGORIAN_OFFSET UNITYSDK_OFFSET(0x1ADB11B0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_LUNARTOTIME_OFFSET UNITYSDK_OFFSET(0x1ADB1940)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_MAXERACALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB0920)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_MINERACALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB0750)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1ADB2520)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_TIMETOLUNAR_OFFSET UNITYSDK_OFFSET(0x1ADB0410)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1ADB0F70)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1ADB26A0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADB2730)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADB0AF0)
