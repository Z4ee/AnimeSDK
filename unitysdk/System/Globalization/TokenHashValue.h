...
#define SYSTEM_GLOBALIZATION_TOKENHASHVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x193D2C80)

namespace System::Globalization
{
	inline static constexpr unsigned int TokenHashValue_TypeDefinitionIndex = 714;
