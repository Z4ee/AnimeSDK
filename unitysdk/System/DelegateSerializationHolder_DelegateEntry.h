...
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_DELEGATEENTRY_DESERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x178DE790)
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_DELEGATEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x178DEB50)

namespace System
{
	inline static constexpr unsigned int DelegateSerializationHolder_DelegateEntry_TypeDefinitionIndex = 388;
	...
	public:
		...
		::System::String* targetTypeName; // 0x28
		::System::Object* target; // 0x30
		::System::DelegateSerializationHolder_DelegateEntry* delegateEntry; // 0x38
		::System::String* targetTypeAssembly; // 0x40
