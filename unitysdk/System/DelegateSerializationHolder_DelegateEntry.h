...
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_DELEGATEENTRY_DESERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x162B1E80)
#define SYSTEM_DELEGATESERIALIZATIONHOLDER_DELEGATEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x162B2240)
...
namespace System
{
	...
	public:
		...
		::System::DelegateSerializationHolder_DelegateEntry* delegateEntry; // 0x40
