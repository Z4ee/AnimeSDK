...
#define CLASS_2_B8F1B4256AA603E4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x198F75C0)
#define CLASS_2_B8F1B4256AA603E4_METHOD_2_48088EB3A1EB3C82_OFFSET UNITYSDK_OFFSET(0x198F85D0)
#define CLASS_2_B8F1B4256AA603E4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x198F5940)
#define CLASS_2_B8F1B4256AA603E4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x198F7500)
#define CLASS_2_B8F1B4256AA603E4_TICK_OFFSET UNITYSDK_OFFSET(0x198F7610)
#define CLASS_2_B8F1B4256AA603E4__CCTOR_OFFSET UNITYSDK_OFFSET(0x198F8720)
#define CLASS_2_B8F1B4256AA603E4__CTOR_OFFSET UNITYSDK_OFFSET(0x198F56F0)
...
public:
	...
	{
		return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B8F1B4256AA603E4_TypeDefinitionIndex)->GetStaticField(0x48500);
	}
	::System::Collections::Generic::List_1<::RPG::GameCore::Triple_3<::System::Boolean, ::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::GameEntityList*>*>* NEFGIAGAMLD; // 0x18
	::RPG::GameCore::TriggerParallelAbility* OFKGLJOAMLD; // 0x20
	::Class_1_07A210D994F284D8_6* ONPOGINJBCB; // 0x28
	::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* PDJBMIJCFIK; // 0x30
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x38
	::System::Collections::Generic::List_1<::Class_2_1DB6C02CA182EEBA*>* PKGNHLKEFKE; // 0x40
