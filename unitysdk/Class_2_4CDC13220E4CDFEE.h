...
#define CLASS_2_4CDC13220E4CDFEE_METHOD_2_920F08E4FDC4E588_OFFSET UNITYSDK_OFFSET(0x1A40FCE0)
#define CLASS_2_4CDC13220E4CDFEE_METHOD_2_A3DDF587C60A9EF5_OFFSET UNITYSDK_OFFSET(0x1A40FB70)
#define CLASS_2_4CDC13220E4CDFEE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A40FCD0)

inline static constexpr unsigned int Class_2_4CDC13220E4CDFEE_TypeDefinitionIndex = 20824;

class Class_2_4CDC13220E4CDFEE : public ::RPG::GameCore::JsonConfig
{
public:
	::Il2CppArray<::Class_2_9D9E51CBF6547B9C*>* JFBLHELPACE; // 0x10
	::System::Boolean MHFNDIBPLKK; // 0x18
	::System::Single DEHNNOGKBJO; // 0x1C
