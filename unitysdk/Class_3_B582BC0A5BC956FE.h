...
#define CLASS_3_B582BC0A5BC956FE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1355F610)
#define CLASS_3_B582BC0A5BC956FE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1355F650)
#define CLASS_3_B582BC0A5BC956FE__CTOR_OFFSET UNITYSDK_OFFSET(0x1355F5A0)
#define CLASS_3_B582BC0A5BC956FE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1355FC80)

inline static constexpr unsigned int Class_3_B582BC0A5BC956FE_TypeDefinitionIndex = 50341;
