...
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7FC410)
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7FC490)
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7FBEB0)
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7FBE90)

inline static constexpr unsigned int AkSoundEngine_RegisterGameObjectCallback_TypeDefinitionIndex = 33029;
