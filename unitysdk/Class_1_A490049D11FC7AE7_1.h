...
#define CLASS_1_A490049D11FC7AE7_1_METHOD_1_1F29F81CADD13A09_OFFSET UNITYSDK_OFFSET(0x1C72F910)
#define CLASS_1_A490049D11FC7AE7_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C72FC00)
...
{
public:
	::System::String* EDFFEFOCCBN; // 0x10
	::Il2CppArray<::System::UInt32>* JBJJIOFBBCN; // 0x18
	::System::String* EGCJJGJJLOE; // 0x20
	::System::UInt32 PBAOJGFDKDG; // 0x28
	::System::UInt32 EKJGBBEIHMD; // 0x2C
	::RPG::Client::TextID KNFOBJPKBPN; // 0x30
	::System::UInt32 LPNBEANGIGE; // 0x40
	::System::UInt32 ELGNMHLEEEH; // 0x44
