...
#define CLASS_2_D7EA947EB97BE467_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11A4D150)
#define CLASS_2_D7EA947EB97BE467_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x11A4D240)
#define CLASS_2_D7EA947EB97BE467_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11A4CFF0)
#define CLASS_2_D7EA947EB97BE467_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11A4D190)
#define CLASS_2_D7EA947EB97BE467_TICK_OFFSET UNITYSDK_OFFSET(0x11A4D1E0)
#define CLASS_2_D7EA947EB97BE467__CTOR_OFFSET UNITYSDK_OFFSET(0x11A4CFE0)
#define CLASS_2_D7EA947EB97BE467___ONGAMEAREALOADED_B__5_0_OFFSET UNITYSDK_OFFSET(0x11A4D3C0)
#define CLASS_2_D7EA947EB97BE467___ONGAMEAREALOADED_B__5_1_OFFSET UNITYSDK_OFFSET(0x11A4D450)

inline static constexpr unsigned int Class_2_D7EA947EB97BE467_TypeDefinitionIndex = 48290;

class Class_2_D7EA947EB97BE467 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::OpenMarbleMainPage* Field_2_0; // 0x20
