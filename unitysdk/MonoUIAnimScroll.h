...
#define MONOUIANIMSCROLL_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1166D180)
#define MONOUIANIMSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1166C7A0)
#define MONOUIANIMSCROLL_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1166E200)
#define MONOUIANIMSCROLL_GETUIELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x1166D100)
#define MONOUIANIMSCROLL_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x1166F420)
#define MONOUIANIMSCROLL_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x1166F490)
#define MONOUIANIMSCROLL_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1166F480)
#define MONOUIANIMSCROLL_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1166F390)
#define MONOUIANIMSCROLL_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1166F300)
#define MONOUIANIMSCROLL_ONCONTENTBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1166E9C0)
#define MONOUIANIMSCROLL_ONCONTENTDRAG_OFFSET UNITYSDK_OFFSET(0x1166EEB0)
#define MONOUIANIMSCROLL_ONCONTENTENDDRAG_OFFSET UNITYSDK_OFFSET(0x1166EC10)
#define MONOUIANIMSCROLL_ONSCROLLBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1166F030)
#define MONOUIANIMSCROLL_ONSCROLLDRAG_OFFSET UNITYSDK_OFFSET(0x1166F080)
#define MONOUIANIMSCROLL_ONSCROLLENDDRAG_OFFSET UNITYSDK_OFFSET(0x1166F0E0)
#define MONOUIANIMSCROLL_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1166D500)
#define MONOUIANIMSCROLL_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1166E770)
#define MONOUIANIMSCROLL_ONVERTICALBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1166F130)
#define MONOUIANIMSCROLL_ONVERTICALDRAG_OFFSET UNITYSDK_OFFSET(0x1166F250)
#define MONOUIANIMSCROLL_ONVERTICALPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1166F2A0)
#define MONOUIANIMSCROLL_ONVERTICALPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1166F1F0)
#define MONOUIANIMSCROLL_ONVERTICALVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1166F180)
#define MONOUIANIMSCROLL_OUTOFRANGE_OFFSET UNITYSDK_OFFSET(0x1166D360)
#define MONOUIANIMSCROLL_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1166D7E0)
#define MONOUIANIMSCROLL_REFRESH_OFFSET UNITYSDK_OFFSET(0x1166D8A0)
#define MONOUIANIMSCROLL_SCROLLMOVE_OFFSET UNITYSDK_OFFSET(0x1166D5D0)
#define MONOUIANIMSCROLL_SETFIXPOSITION_OFFSET UNITYSDK_OFFSET(0x1166E710)
#define MONOUIANIMSCROLL_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x1166F450)
#define MONOUIANIMSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1166E830)
#define MONOUIANIMSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1166F4F0)
#define MONOUIANIMSCROLL___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1166F590)
#define MONOUIANIMSCROLL___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1166F620)

inline static constexpr unsigned int MonoUIAnimScroll_TypeDefinitionIndex = 84704;
