...
#define MONOUIANIMSCROLL_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xD081A90)
#define MONOUIANIMSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0xD0810B0)
#define MONOUIANIMSCROLL_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0xD082B00)
#define MONOUIANIMSCROLL_GETUIELEMENTINFO_OFFSET UNITYSDK_OFFSET(0xD081A10)
#define MONOUIANIMSCROLL_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0xD083D30)
#define MONOUIANIMSCROLL_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0xD083DA0)
#define MONOUIANIMSCROLL_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xD083D90)
#define MONOUIANIMSCROLL_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD083CA0)
#define MONOUIANIMSCROLL_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD083C10)
#define MONOUIANIMSCROLL_ONCONTENTBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD0832D0)
#define MONOUIANIMSCROLL_ONCONTENTDRAG_OFFSET UNITYSDK_OFFSET(0xD0837C0)
#define MONOUIANIMSCROLL_ONCONTENTENDDRAG_OFFSET UNITYSDK_OFFSET(0xD083520)
#define MONOUIANIMSCROLL_ONSCROLLBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD083940)
#define MONOUIANIMSCROLL_ONSCROLLDRAG_OFFSET UNITYSDK_OFFSET(0xD083990)
#define MONOUIANIMSCROLL_ONSCROLLENDDRAG_OFFSET UNITYSDK_OFFSET(0xD0839F0)
#define MONOUIANIMSCROLL_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xD081E10)
#define MONOUIANIMSCROLL_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xD083070)
#define MONOUIANIMSCROLL_ONVERTICALBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD083A40)
#define MONOUIANIMSCROLL_ONVERTICALDRAG_OFFSET UNITYSDK_OFFSET(0xD083B60)
#define MONOUIANIMSCROLL_ONVERTICALPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xD083BB0)
#define MONOUIANIMSCROLL_ONVERTICALPOINTERUP_OFFSET UNITYSDK_OFFSET(0xD083B00)
#define MONOUIANIMSCROLL_ONVERTICALVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xD083A90)
#define MONOUIANIMSCROLL_OUTOFRANGE_OFFSET UNITYSDK_OFFSET(0xD081C70)
#define MONOUIANIMSCROLL_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xD0820F0)
#define MONOUIANIMSCROLL_REFRESH_OFFSET UNITYSDK_OFFSET(0xD0821B0)
#define MONOUIANIMSCROLL_SCROLLMOVE_OFFSET UNITYSDK_OFFSET(0xD081EF0)
#define MONOUIANIMSCROLL_SETFIXPOSITION_OFFSET UNITYSDK_OFFSET(0xD083010)
#define MONOUIANIMSCROLL_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0xD083D60)
#define MONOUIANIMSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0xD083130)
#define MONOUIANIMSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0xD083E00)
#define MONOUIANIMSCROLL___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD083EA0)
#define MONOUIANIMSCROLL___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xD083F30)

inline static constexpr unsigned int MonoUIAnimScroll_TypeDefinitionIndex = 68847;
