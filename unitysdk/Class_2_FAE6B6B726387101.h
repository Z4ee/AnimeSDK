...
#define CLASS_2_FAE6B6B726387101_METHOD_2_327B657776861CA3_OFFSET UNITYSDK_OFFSET(0xC4260B0)
#define CLASS_2_FAE6B6B726387101_METHOD_2_330762CC819CBCA4_OFFSET UNITYSDK_OFFSET(0xC4263C0)
#define CLASS_2_FAE6B6B726387101_METHOD_2_368884BBCA3D2697_OFFSET UNITYSDK_OFFSET(0xC4264C0)
#define CLASS_2_FAE6B6B726387101_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC426210)
#define CLASS_2_FAE6B6B726387101_METHOD_2_7E7A2F143AE85529_OFFSET UNITYSDK_OFFSET(0xC426300)
#define CLASS_2_FAE6B6B726387101_METHOD_2_E31B4948BF7B7146_OFFSET UNITYSDK_OFFSET(0xC426270)
#define CLASS_2_FAE6B6B726387101__CTOR_OFFSET UNITYSDK_OFFSET(0xC426520)
#define CLASS_2_FAE6B6B726387101__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xC426150)

inline static constexpr unsigned int Class_2_FAE6B6B726387101_TypeDefinitionIndex = 71200;

class Class_2_FAE6B6B726387101 : public ::Class_1_34917908B7833130
{
public:
	::UnityEngine::GameObject* LBNBPMIFDHI; // 0x60
	::Class_1_F7F129640441419D* PICMKGJOBLH; // 0x68
	::Class_0_16E4307DCC419505_1081* EFCFPGDPOPG; // 0x70
