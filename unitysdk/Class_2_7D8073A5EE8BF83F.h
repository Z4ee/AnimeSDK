...
#define CLASS_2_7D8073A5EE8BF83F_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xBE637C0)
#define CLASS_2_7D8073A5EE8BF83F_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xBE638B0)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_126D1245D1EBB1FC_OFFSET UNITYSDK_OFFSET(0xBE62980)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_3923AB821AB9D6A6_OFFSET UNITYSDK_OFFSET(0xBE62A50)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xBE62760)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_5187D2A0E6751251_OFFSET UNITYSDK_OFFSET(0xBE62EC0)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_553552D8C8FC3B9E_OFFSET UNITYSDK_OFFSET(0xBE63100)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0xBE62A00)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xBE63420)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xBE63650)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_E6E0E86A3E0935A0_OFFSET UNITYSDK_OFFSET(0xBE62E60)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_E83D3547A9015657_OFFSET UNITYSDK_OFFSET(0xBE62B10)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xBE63700)
#define CLASS_2_7D8073A5EE8BF83F_METHOD_2_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0xBE634A0)
#define CLASS_2_7D8073A5EE8BF83F__CTOR_OFFSET UNITYSDK_OFFSET(0xBE63980)
#define CLASS_2_7D8073A5EE8BF83F__ONBIND_OFFSET UNITYSDK_OFFSET(0xBE626A0)
#define CLASS_2_7D8073A5EE8BF83F__ONTICK_OFFSET UNITYSDK_OFFSET(0xBE62AB0)

inline static constexpr unsigned int Class_2_7D8073A5EE8BF83F_TypeDefinitionIndex = 72085;

class Class_2_7D8073A5EE8BF83F : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* DJCBDJMACFH; // 0x0
	::RPG::Client::PrefabLoadMeta* OGJJJANDJMP; // 0x60
	::UnityEngine::Animator* CFNGLMDMENE; // 0x68
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_2_49DD3E60D823A726*>* NPMBAGJOEIF; // 0x70
	::UnityEngine::UI::Text* KPGIMPEHLBB; // 0x78
	::System::Int32 GJMILDOCNBE; // 0x80
	::System::Int32 GPPCJJELDHJ; // 0x84
	::System::Boolean FMNEEONAMNO; // 0x88
	::System::Int32 BELMHOPIJOM; // 0x8C
	::System::Int32 ICDKPDIMLKL; // 0x90
	::System::Int32 FBGKMMIPDGG; // 0x94
