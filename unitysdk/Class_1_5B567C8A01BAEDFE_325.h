...
#define CLASS_1_5B567C8A01BAEDFE_325_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7C43F0)
#define CLASS_1_5B567C8A01BAEDFE_325_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7C4260)
#define CLASS_1_5B567C8A01BAEDFE_325_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7C4300)
#define CLASS_1_5B567C8A01BAEDFE_325_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7C42A0)
#define CLASS_1_5B567C8A01BAEDFE_325_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7C4350)
#define CLASS_1_5B567C8A01BAEDFE_325_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7C4440)
#define CLASS_1_5B567C8A01BAEDFE_325_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7C4410)
#define CLASS_1_5B567C8A01BAEDFE_325_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7C41E0)
#define CLASS_1_5B567C8A01BAEDFE_325_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7C4210)
#define CLASS_1_5B567C8A01BAEDFE_325_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7C4380)
#define CLASS_1_5B567C8A01BAEDFE_325_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7C43E0)
#define CLASS_1_5B567C8A01BAEDFE_325__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7C4490)
#define CLASS_1_5B567C8A01BAEDFE_325__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7C4230)
#define CLASS_1_5B567C8A01BAEDFE_325__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C4220)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_325_TypeDefinitionIndex = 31641;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_325*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_325_TypeDefinitionIndex)->GetStaticField(0x4AB60);
	}
