...
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0xA84EA50)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0xA84EEC0)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_8A4C6820E5F5715F_OFFSET UNITYSDK_OFFSET(0xA84E6F0)
#define MONOPROGRAMMATRIXTRANSFERANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA84F810)
#define MONOPROGRAMMATRIXTRANSFERANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0xA84F860)
#define MONOPROGRAMMATRIXTRANSFERANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xA84F8B0)

inline static constexpr unsigned int MonoProgramMatrixTransferAnim_TypeDefinitionIndex = 44801;
