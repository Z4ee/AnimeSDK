...
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x88BDA50)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_D460587695D41831_OFFSET UNITYSDK_OFFSET(0x88BD2A0)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x88BD5D0)
#define MONOPROGRAMMATRIXTRANSFERANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x88BE410)
#define MONOPROGRAMMATRIXTRANSFERANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x88BE460)
#define MONOPROGRAMMATRIXTRANSFERANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x88BE4B0)

inline static constexpr unsigned int MonoProgramMatrixTransferAnim_TypeDefinitionIndex = 38371;
