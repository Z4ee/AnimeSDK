...
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x19C95440)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x19C958B0)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_8A4C6820E5F5715F_OFFSET UNITYSDK_OFFSET(0x19C950E0)
#define MONOPROGRAMMATRIXTRANSFERANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19C96200)
#define MONOPROGRAMMATRIXTRANSFERANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x19C96250)
#define MONOPROGRAMMATRIXTRANSFERANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C962A0)
