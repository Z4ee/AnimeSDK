...
#define CLASS_1_C65FEFFCB1D746BA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1927DFB0)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_017C915772AE00E9_OFFSET UNITYSDK_OFFSET(0x1927DE60)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_0BF1620F1E4289BD_OFFSET UNITYSDK_OFFSET(0x1927E350)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_0D8DB2DC8B47A973_OFFSET UNITYSDK_OFFSET(0x1927E0D0)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0x1927E120)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0x1927DC70)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_787019EE92D868C3_OFFSET UNITYSDK_OFFSET(0x1927D270)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_7C5C5C5A38DD51E4_OFFSET UNITYSDK_OFFSET(0x1927D620)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_8377BC0DCBA8CDB6_OFFSET UNITYSDK_OFFSET(0x1927E480)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_8A0C05ECADC6319B_OFFSET UNITYSDK_OFFSET(0x1927DF20)
#define CLASS_1_C65FEFFCB1D746BA_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1927E470)
#define CLASS_1_C65FEFFCB1D746BA__CTOR_OFFSET UNITYSDK_OFFSET(0x1927E490)
...
{
public:
	::RPG::GameCore::GameEntity* PLDMPCFJCJE; // 0x10
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* MFKNLHMKNDM; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* OOEJOOBDCHC; // 0x28
	::RPG::GameCore::GameEntity* DLFPPIGGCJG; // 0x30
	::Class_3_07C3C4D2990C49EE* HFOFIODMFGB; // 0x38
	::System::Boolean NLLJJFMOHFC; // 0x40
	::System::Boolean MABFMALCGKF; // 0x41
