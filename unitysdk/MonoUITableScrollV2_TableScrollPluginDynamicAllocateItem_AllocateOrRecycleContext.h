...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x19516090)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_GET_NEEDREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x86D5B0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginDynamicAllocateItem_AllocateOrRecycleContext_TypeDefinitionIndex = 69957;
