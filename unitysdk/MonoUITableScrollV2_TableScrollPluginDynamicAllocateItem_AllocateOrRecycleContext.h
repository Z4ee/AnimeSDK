...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x187C8020)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_GET_NEEDREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x7E4560)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginDynamicAllocateItem_AllocateOrRecycleContext_TypeDefinitionIndex = 54105;
