...
#define CLASS_2_47FD4BF0D9EF891D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1953F1E0)
#define CLASS_2_47FD4BF0D9EF891D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1953F220)
#define CLASS_2_47FD4BF0D9EF891D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1953F420)
#define CLASS_2_47FD4BF0D9EF891D_TICK_OFFSET UNITYSDK_OFFSET(0x1953F470)
#define CLASS_2_47FD4BF0D9EF891D__CTOR_OFFSET UNITYSDK_OFFSET(0x1953F1D0)

inline static constexpr unsigned int Class_2_47FD4BF0D9EF891D_TypeDefinitionIndex = 58020;

class Class_2_47FD4BF0D9EF891D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AddTimelineMenuItem* OFKGLJOAMLD; // 0x18
