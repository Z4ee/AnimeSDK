...
#define CLASS_2_47FD4BF0D9EF891D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1843E760)
#define CLASS_2_47FD4BF0D9EF891D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1843E7A0)
#define CLASS_2_47FD4BF0D9EF891D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1843E9A0)
#define CLASS_2_47FD4BF0D9EF891D_TICK_OFFSET UNITYSDK_OFFSET(0x1843E9F0)
#define CLASS_2_47FD4BF0D9EF891D__CTOR_OFFSET UNITYSDK_OFFSET(0x1843E750)

inline static constexpr unsigned int Class_2_47FD4BF0D9EF891D_TypeDefinitionIndex = 55296;

class Class_2_47FD4BF0D9EF891D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AddTimelineMenuItem* Field_2_0; // 0x18
