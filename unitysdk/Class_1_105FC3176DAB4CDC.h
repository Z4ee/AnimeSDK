...
class Class_1_C9D22B8BA5AA3474;
namespace RPG::GameCore { class IronTombNormalModeThresholdConfig; }
namespace RPG::GameCore { class TaskContext; }

#define CLASS_1_105FC3176DAB4CDC_CLEAR_OFFSET UNITYSDK_OFFSET(0x134C7860)
#define CLASS_1_105FC3176DAB4CDC_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x134C7CA0)
#define CLASS_1_105FC3176DAB4CDC_GET_NORMALMODETHRESHOLDCONFIG_OFFSET UNITYSDK_OFFSET(0x134C7C80)
#define CLASS_1_105FC3176DAB4CDC_GET_PROGRESSMODE_OFFSET UNITYSDK_OFFSET(0x134C7C00)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_0093FF1335E94929_OFFSET UNITYSDK_OFFSET(0x134C7AD0)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_1A54E3DF1B02B1B9_OFFSET UNITYSDK_OFFSET(0x134C7A10)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x134C79D0)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x134C7C30)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x134C76A0)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_C04C10246EBC8F79_OFFSET UNITYSDK_OFFSET(0x134C78F0)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x134C7C20)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_D20BF56E36607D54_OFFSET UNITYSDK_OFFSET(0x134C7BB0)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_D576072A5004A133_OFFSET UNITYSDK_OFFSET(0x134C7700)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_D7DDA895983CCCB2_OFFSET UNITYSDK_OFFSET(0x134C7960)
#define CLASS_1_105FC3176DAB4CDC_METHOD_1_F8E85EDFA790EAA1_OFFSET UNITYSDK_OFFSET(0x134C7570)
#define CLASS_1_105FC3176DAB4CDC_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x134C7CB0)
#define CLASS_1_105FC3176DAB4CDC_SET_NORMALMODETHRESHOLDCONFIG_OFFSET UNITYSDK_OFFSET(0x134C7C90)
#define CLASS_1_105FC3176DAB4CDC_SET_PROGRESSMODE_OFFSET UNITYSDK_OFFSET(0x134C7C10)
#define CLASS_1_105FC3176DAB4CDC__CTOR_OFFSET UNITYSDK_OFFSET(0x134C7690)

inline static constexpr unsigned int Class_1_105FC3176DAB4CDC_TypeDefinitionIndex = 51859;

class Class_1_105FC3176DAB4CDC : public ::System::Object
{
public:
	// static const ::System::Int32 Field_1_0 = 0x64; // 0x0
	::Class_1_C9D22B8BA5AA3474* _NormalModeThresholdConfig_k__BackingField; // 0x10
	::System::Single _Duration_k__BackingField; // 0x18
	::System::Int32 Field_1_3; // 0x1C
	::RPG::GameCore::IronTombProgressMode _ProgressMode_k__BackingField; // 0x20
	...
	::Class_1_C9D22B8BA5AA3474* get_NormalModeThresholdConfig()
	{
		return ((::Class_1_C9D22B8BA5AA3474*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_105FC3176DAB4CDC_GET_NORMALMODETHRESHOLDCONFIG_OFFSET))(this);
	}

	::System::Void set_NormalModeThresholdConfig(::Class_1_C9D22B8BA5AA3474* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_C9D22B8BA5AA3474*))((::PBYTE)hIl2Cpp + CLASS_1_105FC3176DAB4CDC_SET_NORMALMODETHRESHOLDCONFIG_OFFSET))(this, a1);
	}
