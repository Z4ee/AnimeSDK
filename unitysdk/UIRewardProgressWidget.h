...
#define UIREWARDPROGRESSWIDGET_CONVERTPROGRESS_OFFSET UNITYSDK_OFFSET(0x1CC1A100)
#define UIREWARDPROGRESSWIDGET_GETMAXVAL_OFFSET UNITYSDK_OFFSET(0x1CC1A160)
#define UIREWARDPROGRESSWIDGET_INITPROGRESS_OFFSET UNITYSDK_OFFSET(0x1CC19990)
#define UIREWARDPROGRESSWIDGET_SETPROGERSS_OFFSET UNITYSDK_OFFSET(0x1CC19A00)
#define UIREWARDPROGRESSWIDGET_SETREWARD_OFFSET UNITYSDK_OFFSET(0x1CC1A1B0)
#define UIREWARDPROGRESSWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC1A3C0)

inline static constexpr unsigned int UIRewardProgressWidget_TypeDefinitionIndex = 79687;
