...
#define CLASS_1_6B515A9CEAE60C25_METHOD_1_1E2CD75DC8B80C0C_OFFSET UNITYSDK_OFFSET(0x14EC2D10)
#define CLASS_1_6B515A9CEAE60C25_METHOD_1_8FF806A71A32FBEC_1_OFFSET UNITYSDK_OFFSET(0x14EC3210)
#define CLASS_1_6B515A9CEAE60C25_METHOD_1_8FF806A71A32FBEC_OFFSET UNITYSDK_OFFSET(0x14EC2F30)
#define CLASS_1_6B515A9CEAE60C25_METHOD_1_E09076A4D4E448D7_OFFSET UNITYSDK_OFFSET(0x14EC34F0)
#define CLASS_1_6B515A9CEAE60C25__CCTOR_OFFSET UNITYSDK_OFFSET(0x14EC2C80)

inline static constexpr unsigned int Class_1_6B515A9CEAE60C25_TypeDefinitionIndex = 77787;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::MoleMole::UICloudController*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6B515A9CEAE60C25_TypeDefinitionIndex)->GetStaticField(0x4BA50);
	}
