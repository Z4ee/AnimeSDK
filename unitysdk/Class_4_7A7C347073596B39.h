...
#define CLASS_4_7A7C347073596B39_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x938BC20)
#define CLASS_4_7A7C347073596B39_METHOD_4_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x938A310)
#define CLASS_4_7A7C347073596B39_METHOD_4_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x938B050)
#define CLASS_4_7A7C347073596B39_METHOD_4_20FFB454FEEDDC86_OFFSET UNITYSDK_OFFSET(0x938A810)
#define CLASS_4_7A7C347073596B39_METHOD_4_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x938B970)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x938C320)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x938C380)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x938C3E0)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x938C2C0)
#define CLASS_4_7A7C347073596B39_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x938B660)
#define CLASS_4_7A7C347073596B39_METHOD_4_74B53E9267CE3010_OFFSET UNITYSDK_OFFSET(0x938A850)
#define CLASS_4_7A7C347073596B39_METHOD_4_847FE1E8693369EC_OFFSET UNITYSDK_OFFSET(0x938A610)
#define CLASS_4_7A7C347073596B39_METHOD_4_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x938B910)
#define CLASS_4_7A7C347073596B39_METHOD_4_9A91A67DCFAFF737_OFFSET UNITYSDK_OFFSET(0x938A960)
#define CLASS_4_7A7C347073596B39_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x938BEE0)
#define CLASS_4_7A7C347073596B39_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x938BF30)
#define CLASS_4_7A7C347073596B39_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x938BFC0)
#define CLASS_4_7A7C347073596B39_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x938BE30)
#define CLASS_4_7A7C347073596B39_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x938BDF0)
#define CLASS_4_7A7C347073596B39_TICK_OFFSET UNITYSDK_OFFSET(0x938BA20)
#define CLASS_4_7A7C347073596B39_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x938BC70)
#define CLASS_4_7A7C347073596B39__CCTOR_OFFSET UNITYSDK_OFFSET(0x938C1C0)
#define CLASS_4_7A7C347073596B39__CTOR_OFFSET UNITYSDK_OFFSET(0x938C1B0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x938C580)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x938C5F0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x938C660)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x938C510)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x938C4B0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x938C440)

inline static constexpr unsigned int Class_4_7A7C347073596B39_TypeDefinitionIndex = 65276;
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x6AF40);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_0()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x6AF48);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_1()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x6AF50);
	}
	::UnityEngine::MeshFilter* Field_4_4; // 0x48
	::UnityEngine::Mesh* Field_4_3; // 0x50
	::UnityEngine::Material* Field_4_2; // 0x58
	::UnityEngine::Material* Field_4_8; // 0x60
	::UnityEngine::MeshRenderer* Field_4_5; // 0x68
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_4_7A7C347073596B39_METHOD_4_3C56C1AF247AC1EC_OFFSET))(this);
	}
