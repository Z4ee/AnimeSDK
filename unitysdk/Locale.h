...
#define LOCALE_GETTEXT_1_OFFSET UNITYSDK_OFFSET(0x1F4C3130)
#define LOCALE_GETTEXT_OFFSET UNITYSDK_OFFSET(0x1F4C3120)
#define LOCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4C3110)
