...
#define CONSTANTSCREENSIZERATIO_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10FA1F30)
#define CONSTANTSCREENSIZERATIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10FA1CA0)
#define CONSTANTSCREENSIZERATIO_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x10FA1ED0)
#define CONSTANTSCREENSIZERATIO_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x10FA1D60)
#define CONSTANTSCREENSIZERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x10FA2370)

inline static constexpr unsigned int ConstantScreenSizeRatio_TypeDefinitionIndex = 52623;
