...
#define CONSTANTSCREENSIZERATIO_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15BC8970)
#define CONSTANTSCREENSIZERATIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15BC86E0)
#define CONSTANTSCREENSIZERATIO_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x15BC8910)
#define CONSTANTSCREENSIZERATIO_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x15BC87A0)
#define CONSTANTSCREENSIZERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC8D90)

inline static constexpr unsigned int ConstantScreenSizeRatio_TypeDefinitionIndex = 44399;
