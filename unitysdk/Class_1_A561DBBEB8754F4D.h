...
#define CLASS_1_A561DBBEB8754F4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18DC7F80)
#define CLASS_1_A561DBBEB8754F4D_EQUALS_OFFSET UNITYSDK_OFFSET(0x18DC7EF0)
#define CLASS_1_A561DBBEB8754F4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18DC8070)
#define CLASS_1_A561DBBEB8754F4D_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x18DC7ED0)
#define CLASS_1_A561DBBEB8754F4D_GET_ISBATTLEDISPLAY_OFFSET UNITYSDK_OFFSET(0x18DC7E90)
#define CLASS_1_A561DBBEB8754F4D_GET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0x18DC7E70)
#define CLASS_1_A561DBBEB8754F4D_GET_MAINRELICFILTER_OFFSET UNITYSDK_OFFSET(0x18DC7DF0)
#define CLASS_1_A561DBBEB8754F4D_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x18DC7EB0)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYCLASSIFY_OFFSET UNITYSDK_OFFSET(0x18DC7E50)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYINSTRUCTIONID_OFFSET UNITYSDK_OFFSET(0x18DC7E30)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAMEFILTER_OFFSET UNITYSDK_OFFSET(0x18DC7DD0)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAMERELIC_OFFSET UNITYSDK_OFFSET(0x18DC7DB0)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAMESKILLTREE_OFFSET UNITYSDK_OFFSET(0x18DC7D90)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x18DC7D70)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x18DC7D50)
#define CLASS_1_A561DBBEB8754F4D_GET_SUBRELICFILTER_OFFSET UNITYSDK_OFFSET(0x18DC7E10)
#define CLASS_1_A561DBBEB8754F4D_METHOD_1_148214CEA2F00B70_OFFSET UNITYSDK_OFFSET(0x18DC8190)
#define CLASS_1_A561DBBEB8754F4D_METHOD_1_6062BB7D9634C869_OFFSET UNITYSDK_OFFSET(0x18DC80B0)
#define CLASS_1_A561DBBEB8754F4D_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x18DC7EE0)
#define CLASS_1_A561DBBEB8754F4D_SET_ISBATTLEDISPLAY_OFFSET UNITYSDK_OFFSET(0x18DC7EA0)
#define CLASS_1_A561DBBEB8754F4D_SET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0x18DC7E80)
#define CLASS_1_A561DBBEB8754F4D_SET_MAINRELICFILTER_OFFSET UNITYSDK_OFFSET(0x18DC7E00)
#define CLASS_1_A561DBBEB8754F4D_SET_ORDER_OFFSET UNITYSDK_OFFSET(0x18DC7EC0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYCLASSIFY_OFFSET UNITYSDK_OFFSET(0x18DC7E60)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYINSTRUCTIONID_OFFSET UNITYSDK_OFFSET(0x18DC7E40)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAMEFILTER_OFFSET UNITYSDK_OFFSET(0x18DC7DE0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAMERELIC_OFFSET UNITYSDK_OFFSET(0x18DC7DC0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAMESKILLTREE_OFFSET UNITYSDK_OFFSET(0x18DC7DA0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x18DC7D80)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x18DC7D60)
#define CLASS_1_A561DBBEB8754F4D_SET_SUBRELICFILTER_OFFSET UNITYSDK_OFFSET(0x18DC7E20)
#define CLASS_1_A561DBBEB8754F4D__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC8270)

inline static constexpr unsigned int Class_1_A561DBBEB8754F4D_TypeDefinitionIndex = 49603;

class Class_1_A561DBBEB8754F4D : public ::System::Object
{
public:
	::System::String* _IconPath_k__BackingField; // 0x10
	::System::UInt32 _MainRelicFilter_k__BackingField; // 0x18
	::System::UInt32 _PropertyClassify_k__BackingField; // 0x1C
	::RPG::Client::TextID _PropertyNameRelic_k__BackingField; // 0x20
	::RPG::Client::TextID _PropertyName_k__BackingField; // 0x30
	::RPG::GameCore::AvatarPropertyType _PropertyType_k__BackingField; // 0x40
	::System::UInt32 _PropertyInstructionID_k__BackingField; // 0x44
	::System::UInt32 _SubRelicFilter_k__BackingField; // 0x48
	::System::UInt32 _Order_k__BackingField; // 0x4C
	::RPG::Client::TextID _PropertyNameFilter_k__BackingField; // 0x50
	::RPG::Client::TextID _PropertyNameSkillTree_k__BackingField; // 0x60
	::System::Boolean _IsBattleDisplay_k__BackingField; // 0x70
	::System::Boolean _IsDisplay_k__BackingField; // 0x71
	...
	{
		return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_422*))((::PBYTE)hIl2Cpp + CLASS_1_A561DBBEB8754F4D_EQUALS_OFFSET))(this, a1);
	}
