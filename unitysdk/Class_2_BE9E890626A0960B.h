...
#define CLASS_2_BE9E890626A0960B_METHOD_2_572E53F76E315839_OFFSET UNITYSDK_OFFSET(0x16352F90)
#define CLASS_2_BE9E890626A0960B_METHOD_2_B6EEC4B10357AB73_OFFSET UNITYSDK_OFFSET(0x16352D50)
#define CLASS_2_BE9E890626A0960B_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x163530A0)
#define CLASS_2_BE9E890626A0960B__CTOR_OFFSET UNITYSDK_OFFSET(0x16353090)

inline static constexpr unsigned int Class_2_BE9E890626A0960B_TypeDefinitionIndex = 60522;

class Class_2_BE9E890626A0960B : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_3_6F805C3FA3D1D41D<::MoleMole::UIVHSStoreLimitBtnsWidgetController*>* Field_2_2; // 0x18
	::MoleMole::MonoGamepadRegion* Field_2_5; // 0x20
	::Class_3_6F805C3FA3D1D41D<::MoleMole::UIVHSStoreLimitRoleInfoWidgetController*>* Field_2_1; // 0x28
	::Class_3_6F805C3FA3D1D41D<::MoleMole::UIVHSStoreRecommandWidgetController*>* Field_2_3; // 0x30
