...
#define CLASS_1_5B567C8A01BAEDFE_12_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C7C42B0)
#define CLASS_1_5B567C8A01BAEDFE_12_CLONE_OFFSET UNITYSDK_OFFSET(0x1C7C3F50)
#define CLASS_1_5B567C8A01BAEDFE_12_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C7C40B0)
#define CLASS_1_5B567C8A01BAEDFE_12_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C7C3FC0)
#define CLASS_1_5B567C8A01BAEDFE_12_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C7C4210)
#define CLASS_1_5B567C8A01BAEDFE_12_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7C4300)
#define CLASS_1_5B567C8A01BAEDFE_12_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C7C42D0)
#define CLASS_1_5B567C8A01BAEDFE_12_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C7C3EA0)
#define CLASS_1_5B567C8A01BAEDFE_12_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7C3F00)
#define CLASS_1_5B567C8A01BAEDFE_12_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C7C4240)
#define CLASS_1_5B567C8A01BAEDFE_12_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C7C42A0)
#define CLASS_1_5B567C8A01BAEDFE_12__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C7C4350)
#define CLASS_1_5B567C8A01BAEDFE_12__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7C3F20)
#define CLASS_1_5B567C8A01BAEDFE_12__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7C3F10)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_12_TypeDefinitionIndex = 25086;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_12*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_12_TypeDefinitionIndex)->GetStaticField(0x290F0);
	}
