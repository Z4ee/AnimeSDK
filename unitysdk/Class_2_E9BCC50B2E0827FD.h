...
#define CLASS_2_E9BCC50B2E0827FD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11958520)
#define CLASS_2_E9BCC50B2E0827FD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11958560)
#define CLASS_2_E9BCC50B2E0827FD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11958600)
#define CLASS_2_E9BCC50B2E0827FD_TICK_OFFSET UNITYSDK_OFFSET(0x11958650)
#define CLASS_2_E9BCC50B2E0827FD__CTOR_OFFSET UNITYSDK_OFFSET(0x11958510)

inline static constexpr unsigned int Class_2_E9BCC50B2E0827FD_TypeDefinitionIndex = 54387;

class Class_2_E9BCC50B2E0827FD : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TriggerPamActionPhaseSettle* Field_2_1; // 0x20
