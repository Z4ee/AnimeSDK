...
#define CLASS_2_E9BCC50B2E0827FD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BEC4D0)
#define CLASS_2_E9BCC50B2E0827FD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8BEC510)
#define CLASS_2_E9BCC50B2E0827FD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8BEC5B0)
#define CLASS_2_E9BCC50B2E0827FD_TICK_OFFSET UNITYSDK_OFFSET(0x8BEC600)
#define CLASS_2_E9BCC50B2E0827FD__CTOR_OFFSET UNITYSDK_OFFSET(0x8BEC4C0)

inline static constexpr unsigned int Class_2_E9BCC50B2E0827FD_TypeDefinitionIndex = 47649;

class Class_2_E9BCC50B2E0827FD : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TriggerPamActionPhaseSettle* Field_2_1; // 0x18
