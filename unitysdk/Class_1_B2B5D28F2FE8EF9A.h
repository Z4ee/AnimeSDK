...
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_381355C35959B3A0_OFFSET UNITYSDK_OFFSET(0x170135F0)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_4993EDAE54425105_OFFSET UNITYSDK_OFFSET(0x17012F80)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_4DFFE08D848C0BBD_OFFSET UNITYSDK_OFFSET(0x170124C0)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_4EABA0671C5D4363_OFFSET UNITYSDK_OFFSET(0x17013600)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_56EEA7C893A52EF2_OFFSET UNITYSDK_OFFSET(0x17012E90)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_5D060AEFC9F7D9B8_OFFSET UNITYSDK_OFFSET(0x170132B0)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_856985C4DC46A933_OFFSET UNITYSDK_OFFSET(0x17012CD0)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_8DAD834C952342F4_OFFSET UNITYSDK_OFFSET(0x17013480)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_95729F59F958FA96_OFFSET UNITYSDK_OFFSET(0x17012990)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_9F8499824BE26DFD_OFFSET UNITYSDK_OFFSET(0x17013570)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x17013580)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_D34185CA6A692B79_OFFSET UNITYSDK_OFFSET(0x170132C0)
#define CLASS_1_B2B5D28F2FE8EF9A_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0x17012F90)
#define CLASS_1_B2B5D28F2FE8EF9A__CTOR_OFFSET UNITYSDK_OFFSET(0x170122B0)

inline static constexpr unsigned int Class_1_B2B5D28F2FE8EF9A_TypeDefinitionIndex = 72181;

class Class_1_B2B5D28F2FE8EF9A : public ::System::Object
{
public:
	::System::Collections::Generic::HashSet_1<::Struct_2_143B7A497B890286_1>* Field_1_1; // 0x10
	::System::Collections::Generic::Dictionary_2<::MoleMole::Vector2Int, ::Class_1_E49938F4BFE74407*>* Field_1_0; // 0x18
	::System::Collections::Generic::Dictionary_2<::MoleMole::Vector2Int, ::System::Collections::Generic::List_1<::MoleMole::Vector2Int>*>* Field_1_7; // 0x20
	::System::Collections::Generic::HashSet_1<::System::Int32>* Field_1_5; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_E49938F4BFE74407*>* Field_1_6; // 0x30
	::System::Collections::Generic::List_1<::Class_1_E49938F4BFE74407*>* Field_1_2; // 0x38
	::MoleMole::Vector2Int Field_1_3; // 0x40
