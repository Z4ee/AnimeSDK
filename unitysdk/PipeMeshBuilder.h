...
#define PIPEMESHBUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1B5A3960)
#define PIPEMESHBUILDER_COMPUTEFRAMES_OFFSET UNITYSDK_OFFSET(0x1B5A5A70)
#define PIPEMESHBUILDER_COMPUTETANGENTS_OFFSET UNITYSDK_OFFSET(0x1B5A53C0)
#define PIPEMESHBUILDER_EXPANDWITHDIVISIONS_OFFSET UNITYSDK_OFFSET(0x1B5A4CC0)
#define PIPEMESHBUILDER_GETPERP_OFFSET UNITYSDK_OFFSET(0x1B5A65D0)

inline static constexpr unsigned int PipeMeshBuilder_TypeDefinitionIndex = 64205;
