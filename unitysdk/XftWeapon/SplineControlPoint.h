...
#define XFTWEAPON_SPLINECONTROLPOINT_GETNEXT2NORMAL_OFFSET UNITYSDK_OFFSET(0x1D5700C0)
#define XFTWEAPON_SPLINECONTROLPOINT_GETNEXT2POSITION_OFFSET UNITYSDK_OFFSET(0x1D56FF90)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D56FAD0)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_NEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1D56FC30)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_NEXTNORMAL_OFFSET UNITYSDK_OFFSET(0x1D56FE60)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_NEXTPOSITION_OFFSET UNITYSDK_OFFSET(0x1D56FD30)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_PREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1D56FCB0)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_PREVIOUSNORMAL_OFFSET UNITYSDK_OFFSET(0x1D56FEF0)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_PREVIOUSPOSITION_OFFSET UNITYSDK_OFFSET(0x1D56FDC0)
#define XFTWEAPON_SPLINECONTROLPOINT_INIT_OFFSET UNITYSDK_OFFSET(0x1D56F790)
#define XFTWEAPON_SPLINECONTROLPOINT_INTERPOLATENORMAL_OFFSET UNITYSDK_OFFSET(0x1D56F360)
#define XFTWEAPON_SPLINECONTROLPOINT_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1D56EF80)
#define XFTWEAPON_SPLINECONTROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D56E150)

namespace XftWeapon
{
	inline static constexpr unsigned int SplineControlPoint_TypeDefinitionIndex = 39301;
	...
	public:
		...
		::System::Single Dist; // 0x20
		::UnityEngine::Vector3 forward; // 0x24
		::System::Int32 ControlPointIndex; // 0x30
		::UnityEngine::Vector3 right; // 0x34
		::UnityEngine::Vector3 Normal; // 0x40
		::UnityEngine::Vector3 up; // 0x4C
		::UnityEngine::Vector3 Position; // 0x58
		::System::Int32 SegmentIndex; // 0x64
