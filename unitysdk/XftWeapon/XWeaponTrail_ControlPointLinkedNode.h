...
#define XFTWEAPON_XWEAPONTRAIL_CONTROLPOINTLINKEDNODE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E92FED0)
#define XFTWEAPON_XWEAPONTRAIL_CONTROLPOINTLINKEDNODE_GET_OFFSET UNITYSDK_OFFSET(0x1E925560)
#define XFTWEAPON_XWEAPONTRAIL_CONTROLPOINTLINKEDNODE_RETURN_OFFSET UNITYSDK_OFFSET(0x1E924E00)
#define XFTWEAPON_XWEAPONTRAIL_CONTROLPOINTLINKEDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E92FF70)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_ControlPointLinkedNode_TypeDefinitionIndex = 39971;
