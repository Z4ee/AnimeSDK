...
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B1804E0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x1B1804C0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTINACTIVE_OFFSET UNITYSDK_OFFSET(0x1B180500)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x1B180040)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B1800B0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_SET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x1B1804D0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17CEC0)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_ElementPool_TypeDefinitionIndex = 37682;
