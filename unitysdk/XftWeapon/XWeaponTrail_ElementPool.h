...
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTACTIVE_OFFSET UNITYSDK_OFFSET(0x1D580EC0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x1D580EA0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTINACTIVE_OFFSET UNITYSDK_OFFSET(0x1D580EE0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x1D580A20)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D580A90)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_SET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x1D580EB0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D57D8B0)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_ElementPool_TypeDefinitionIndex = 39308;
