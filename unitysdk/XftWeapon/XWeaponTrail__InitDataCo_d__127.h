...
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B180260)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B180300)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B180360)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B180310)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B180250)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17D110)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail__InitDataCo_d__127_TypeDefinitionIndex = 37683;
