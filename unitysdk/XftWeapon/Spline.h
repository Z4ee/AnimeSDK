...
#define XFTWEAPON_SPLINE_ADDCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1B16ECB0)
#define XFTWEAPON_SPLINE_CATMULROM_OFFSET UNITYSDK_OFFSET(0x1B16DEB0)
#define XFTWEAPON_SPLINE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B16ED70)
#define XFTWEAPON_SPLINE_GET_BSPLINE_OFFSET UNITYSDK_OFFSET(0x1B16E0B0)
#define XFTWEAPON_SPLINE_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1B16D880)
#define XFTWEAPON_SPLINE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B16D810)
#define XFTWEAPON_SPLINE_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1B16D870)
#define XFTWEAPON_SPLINE_INTERPOLATEBYLEN_OFFSET UNITYSDK_OFFSET(0x1B16E4F0)
#define XFTWEAPON_SPLINE_INTERPOLATENORMALBYLEN_OFFSET UNITYSDK_OFFSET(0x1B16E8D0)
#define XFTWEAPON_SPLINE_INTERPOLATE_BONESHAPE_OFFSET UNITYSDK_OFFSET(0x1B16E3B0)
#define XFTWEAPON_SPLINE_INTERPOLATE_CUSTOMSHAPE_OFFSET UNITYSDK_OFFSET(0x1B16E250)
#define XFTWEAPON_SPLINE_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1B16E110)
#define XFTWEAPON_SPLINE_LENTOSEGMENT_FORBSPLINE_OFFSET UNITYSDK_OFFSET(0x1B16DD50)
#define XFTWEAPON_SPLINE_LENTOSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B16DC10)
#define XFTWEAPON_SPLINE_NEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1B16D890)
#define XFTWEAPON_SPLINE_NEXTNORMAL_OFFSET UNITYSDK_OFFSET(0x1B16DB70)
#define XFTWEAPON_SPLINE_NEXTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B16D990)
#define XFTWEAPON_SPLINE_PREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1B16D910)
#define XFTWEAPON_SPLINE_PREVIOUSNORMAL_OFFSET UNITYSDK_OFFSET(0x1B16DAD0)
#define XFTWEAPON_SPLINE_PREVIOUSPOSITION_OFFSET UNITYSDK_OFFSET(0x1B16DA30)
#define XFTWEAPON_SPLINE_REFRESHDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B16EDB0)
#define XFTWEAPON_SPLINE_REFRESHSPLINE_OFFSET UNITYSDK_OFFSET(0x1B16EF20)
#define XFTWEAPON_SPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B16F120)

namespace XftWeapon
{
	inline static constexpr unsigned int Spline_TypeDefinitionIndex = 37674;
