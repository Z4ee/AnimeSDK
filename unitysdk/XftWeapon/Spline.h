...
#define XFTWEAPON_SPLINE_ADDCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1D56F6E0)
#define XFTWEAPON_SPLINE_CATMULROM_OFFSET UNITYSDK_OFFSET(0x1D56E8E0)
#define XFTWEAPON_SPLINE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D56F7A0)
#define XFTWEAPON_SPLINE_GET_BSPLINE_OFFSET UNITYSDK_OFFSET(0x1D56EAE0)
#define XFTWEAPON_SPLINE_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1D56E2B0)
#define XFTWEAPON_SPLINE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D56E240)
#define XFTWEAPON_SPLINE_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1D56E2A0)
#define XFTWEAPON_SPLINE_INTERPOLATEBYLEN_OFFSET UNITYSDK_OFFSET(0x1D56EF20)
#define XFTWEAPON_SPLINE_INTERPOLATENORMALBYLEN_OFFSET UNITYSDK_OFFSET(0x1D56F300)
#define XFTWEAPON_SPLINE_INTERPOLATE_BONESHAPE_OFFSET UNITYSDK_OFFSET(0x1D56EDE0)
#define XFTWEAPON_SPLINE_INTERPOLATE_CUSTOMSHAPE_OFFSET UNITYSDK_OFFSET(0x1D56EC80)
#define XFTWEAPON_SPLINE_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1D56EB40)
#define XFTWEAPON_SPLINE_LENTOSEGMENT_FORBSPLINE_OFFSET UNITYSDK_OFFSET(0x1D56E780)
#define XFTWEAPON_SPLINE_LENTOSEGMENT_OFFSET UNITYSDK_OFFSET(0x1D56E640)
#define XFTWEAPON_SPLINE_NEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1D56E2C0)
#define XFTWEAPON_SPLINE_NEXTNORMAL_OFFSET UNITYSDK_OFFSET(0x1D56E5A0)
#define XFTWEAPON_SPLINE_NEXTPOSITION_OFFSET UNITYSDK_OFFSET(0x1D56E3C0)
#define XFTWEAPON_SPLINE_PREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1D56E340)
#define XFTWEAPON_SPLINE_PREVIOUSNORMAL_OFFSET UNITYSDK_OFFSET(0x1D56E500)
#define XFTWEAPON_SPLINE_PREVIOUSPOSITION_OFFSET UNITYSDK_OFFSET(0x1D56E460)
#define XFTWEAPON_SPLINE_REFRESHDISTANCE_OFFSET UNITYSDK_OFFSET(0x1D56F7E0)
#define XFTWEAPON_SPLINE_REFRESHSPLINE_OFFSET UNITYSDK_OFFSET(0x1D56F950)
#define XFTWEAPON_SPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D56FB50)

namespace XftWeapon
{
	inline static constexpr unsigned int Spline_TypeDefinitionIndex = 39300;
