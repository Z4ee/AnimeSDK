...
#define XFTWEAPON_XWEAPONTRAIL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E91BA20)
#define XFTWEAPON_XWEAPONTRAIL_ADDFORCEDISWEIGHTMINMESHDISLIMITSHOWIF_OFFSET UNITYSDK_OFFSET(0x1E9271C0)
#define XFTWEAPON_XWEAPONTRAIL_AFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1E927100)
#define XFTWEAPON_XWEAPONTRAIL_APPLYATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x1E922AB0)
#define XFTWEAPON_XWEAPONTRAIL_BEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1E927080)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEBONESHAPERECORDPOINTS_OFFSET UNITYSDK_OFFSET(0x1E92DA70)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEBONESHAPERECORDSNAPSHOTELEMDATA_OFFSET UNITYSDK_OFFSET(0x1E92DE20)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEFORDFSPOINTS_OFFSET UNITYSDK_OFFSET(0x1E92F3D0)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEREMOVEPOOLLASTPOINT_OFFSET UNITYSDK_OFFSET(0x1E92F290)
#define XFTWEAPON_XWEAPONTRAIL_BUILDBSPLINECUSTOMSHAPERATELIST_OFFSET UNITYSDK_OFFSET(0x1E923170)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_ADDHEADPOINT_OFFSET UNITYSDK_OFFSET(0x1E924F00)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_DFS_OFFSET UNITYSDK_OFFSET(0x1E9262C0)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_OFFSET UNITYSDK_OFFSET(0x1E923A90)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_SPAWNNEWPOINT_OFFSET UNITYSDK_OFFSET(0x1E925680)
#define XFTWEAPON_XWEAPONTRAIL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E91B9A0)
#define XFTWEAPON_XWEAPONTRAIL_DESTROYVERTEXPOOL_OFFSET UNITYSDK_OFFSET(0x1E92FCB0)
#define XFTWEAPON_XWEAPONTRAIL_ENSUREBSPLINECUSTOMSHAPETRANSFORMLISTPOSCACHE_OFFSET UNITYSDK_OFFSET(0x1E92A240)
#define XFTWEAPON_XWEAPONTRAIL_GETMESHRENDER_OFFSET UNITYSDK_OFFSET(0x1E92CC20)
#define XFTWEAPON_XWEAPONTRAIL_GET_ACTIVATED_OFFSET UNITYSDK_OFFSET(0x1E92C8F0)
#define XFTWEAPON_XWEAPONTRAIL_GET_BSPLINEBONESHAPE_OFFSET UNITYSDK_OFFSET(0x1E923150)
#define XFTWEAPON_XWEAPONTRAIL_GET_BSPLINECUSTOMSHAPE_OFFSET UNITYSDK_OFFSET(0x1E926910)
#define XFTWEAPON_XWEAPONTRAIL_GET_CURFRAMEISSTOPFRAME_OFFSET UNITYSDK_OFFSET(0x1E92FA70)
#define XFTWEAPON_XWEAPONTRAIL_GET_CURHEADPOS_OFFSET UNITYSDK_OFFSET(0x1E92C900)
#define XFTWEAPON_XWEAPONTRAIL_GET_DYNAMICMESHPOINTLENGTH_OFFSET UNITYSDK_OFFSET(0x1E920150)
#define XFTWEAPON_XWEAPONTRAIL_GET_NEEDCALCMESHPERPOINTDIS_OFFSET UNITYSDK_OFFSET(0x1E927190)
#define XFTWEAPON_XWEAPONTRAIL_GET_NEEDRECORDINITPOS_OFFSET UNITYSDK_OFFSET(0x1E92DA50)
#define XFTWEAPON_XWEAPONTRAIL_GET_TRAILWIDTH_OFFSET UNITYSDK_OFFSET(0x1E92C9C0)
#define XFTWEAPON_XWEAPONTRAIL_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E928960)
#define XFTWEAPON_XWEAPONTRAIL_GET_UPDATE_CONTROLPOINT_FULL_MODE_OFFSET UNITYSDK_OFFSET(0x1E923A60)
#define XFTWEAPON_XWEAPONTRAIL_GET_USEJOBOPT_OFFSET UNITYSDK_OFFSET(0x1E927450)
#define XFTWEAPON_XWEAPONTRAIL_GOSTART_OFFSET UNITYSDK_OFFSET(0x1E92D9D0)
#define XFTWEAPON_XWEAPONTRAIL_GRAPHICSSETTINGSHOWIF_OFFSET UNITYSDK_OFFSET(0x1E927180)
#define XFTWEAPON_XWEAPONTRAIL_HASAPPLIEDBYFORCE_OFFSET UNITYSDK_OFFSET(0x1E9271B0)
#define XFTWEAPON_XWEAPONTRAIL_INITDATACO_OFFSET UNITYSDK_OFFSET(0x1E92CBC0)
#define XFTWEAPON_XWEAPONTRAIL_INITMESHOBJ_OFFSET UNITYSDK_OFFSET(0x1E92CAA0)
#define XFTWEAPON_XWEAPONTRAIL_INITORIGINALELEMENTS_OFFSET UNITYSDK_OFFSET(0x1E9277D0)
#define XFTWEAPON_XWEAPONTRAIL_INITSPLINE_OFFSET UNITYSDK_OFFSET(0x1E927A00)
#define XFTWEAPON_XWEAPONTRAIL_INIT_OFFSET UNITYSDK_OFFSET(0x1E91AB90)
#define XFTWEAPON_XWEAPONTRAIL_MYPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1E92C0E0)
#define XFTWEAPON_XWEAPONTRAIL_MYPRERENDER_OFFSET UNITYSDK_OFFSET(0x1E92D730)
#define XFTWEAPON_XWEAPONTRAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E92D930)
#define XFTWEAPON_XWEAPONTRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E92C570)
#define XFTWEAPON_XWEAPONTRAIL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E92C270)
#define XFTWEAPON_XWEAPONTRAIL_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1E92C890)
#define XFTWEAPON_XWEAPONTRAIL_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1E92C8C0)
#define XFTWEAPON_XWEAPONTRAIL_ONMATERIALVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E92FCE0)
#define XFTWEAPON_XWEAPONTRAIL_ONMAXFRAMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E92FCA0)
#define XFTWEAPON_XWEAPONTRAIL_ONPOINTENDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E92FD30)
#define XFTWEAPON_XWEAPONTRAIL_ONPOINTSTARTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E92FD20)
#define XFTWEAPON_XWEAPONTRAIL_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1E92C600)
#define XFTWEAPON_XWEAPONTRAIL_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1E92C300)
#define XFTWEAPON_XWEAPONTRAIL_POSTSIMULATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E92CFD0)
#define XFTWEAPON_XWEAPONTRAIL_RECORDCURELEM_OFFSET UNITYSDK_OFFSET(0x1E928980)
#define XFTWEAPON_XWEAPONTRAIL_REFRESHSPLINE_OFFSET UNITYSDK_OFFSET(0x1E929740)
#define XFTWEAPON_XWEAPONTRAIL_RESETVERTEXTDATA_OFFSET UNITYSDK_OFFSET(0x1E928640)
#define XFTWEAPON_XWEAPONTRAIL_SET_NEEDRECORDINITPOS_OFFSET UNITYSDK_OFFSET(0x1E92DA60)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x1E92A570)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1E92D4C0)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_RECORDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E9274B0)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_SENDDATATORENDERER_OFFSET UNITYSDK_OFFSET(0x1E92C0C0)
#define XFTWEAPON_XWEAPONTRAIL_SPAWNNEWPOINT_OFFSET UNITYSDK_OFFSET(0x1E92DFC0)
#define XFTWEAPON_XWEAPONTRAIL_START_OFFSET UNITYSDK_OFFSET(0x1E92D950)
#define XFTWEAPON_XWEAPONTRAIL_STOPSMOOTHLY_OFFSET UNITYSDK_OFFSET(0x1E91BA80)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEADDFORCEMESHWEIGHTAVECACHE_OFFSET UNITYSDK_OFFSET(0x1E9271D0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEFADE_OFFSET UNITYSDK_OFFSET(0x1E92A180)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEHEADELEM_OFFSET UNITYSDK_OFFSET(0x1E9286A0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_DYNAMICVERSION_GCOPT_OFFSET UNITYSDK_OFFSET(0x1E926D50)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_DYNAMICVERSION_OFFSET UNITYSDK_OFFSET(0x1E925290)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_GCOPT_OFFSET UNITYSDK_OFFSET(0x1E926930)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_OFFSET UNITYSDK_OFFSET(0x1E928350)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEVERTEX_OFFSET UNITYSDK_OFFSET(0x1E92A5C0)
#define XFTWEAPON_XWEAPONTRAIL_VECTOREQUAL_OFFSET UNITYSDK_OFFSET(0x1E92FA80)
#define XFTWEAPON_XWEAPONTRAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E92FD50)
#define XFTWEAPON_XWEAPONTRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E91A7E0)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_TypeDefinitionIndex = 39970;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x2C7F0);
		}
		static ::System::Boolean* StaticGet_UseGCOpt()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x9990);
		}
		static ::System::Boolean* StaticGet_bSplineUseToArray()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x9991);
		}
		static ::System::Boolean* StaticGet_USE_JOB_SWITCH()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x9992);
		}
		static ::System::Single* StaticGet_EPS()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x9994);
		}
		...
		::System::Void DestroyVertexPool()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + XFTWEAPON_XWEAPONTRAIL_DESTROYVERTEXPOOL_OFFSET))(this);
		}
