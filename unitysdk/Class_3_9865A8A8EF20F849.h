...
#define CLASS_3_9865A8A8EF20F849_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1138FAC0)
#define CLASS_3_9865A8A8EF20F849__CTOR_OFFSET UNITYSDK_OFFSET(0x1138FA90)

inline static constexpr unsigned int Class_3_9865A8A8EF20F849_TypeDefinitionIndex = 46802;
