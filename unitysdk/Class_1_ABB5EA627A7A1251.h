...
#define CLASS_1_ABB5EA627A7A1251_GET_CONDITIONTYPE_OFFSET UNITYSDK_OFFSET(0xB8BDD90)
#define CLASS_1_ABB5EA627A7A1251_GET_ID_OFFSET UNITYSDK_OFFSET(0xB8BDD10)
#define CLASS_1_ABB5EA627A7A1251_GET_TARGETGRIDTYPE_OFFSET UNITYSDK_OFFSET(0xB8BDD70)
#define CLASS_1_ABB5EA627A7A1251_GET_TOAST_OFFSET UNITYSDK_OFFSET(0xB8BDDB0)
#define CLASS_1_ABB5EA627A7A1251_GET_USECARDID_OFFSET UNITYSDK_OFFSET(0xB8BDD50)
#define CLASS_1_ABB5EA627A7A1251_GET_USECARDTYPE_OFFSET UNITYSDK_OFFSET(0xB8BDD30)
#define CLASS_1_ABB5EA627A7A1251_METHOD_1_F3E869ED418D765A_OFFSET UNITYSDK_OFFSET(0xB8BDDD0)
#define CLASS_1_ABB5EA627A7A1251_SET_CONDITIONTYPE_OFFSET UNITYSDK_OFFSET(0xB8BDDA0)
#define CLASS_1_ABB5EA627A7A1251_SET_ID_OFFSET UNITYSDK_OFFSET(0xB8BDD20)
#define CLASS_1_ABB5EA627A7A1251_SET_TARGETGRIDTYPE_OFFSET UNITYSDK_OFFSET(0xB8BDD80)
#define CLASS_1_ABB5EA627A7A1251_SET_TOAST_OFFSET UNITYSDK_OFFSET(0xB8BDDC0)
#define CLASS_1_ABB5EA627A7A1251_SET_USECARDID_OFFSET UNITYSDK_OFFSET(0xB8BDD60)
#define CLASS_1_ABB5EA627A7A1251_SET_USECARDTYPE_OFFSET UNITYSDK_OFFSET(0xB8BDD40)
#define CLASS_1_ABB5EA627A7A1251__CTOR_OFFSET UNITYSDK_OFFSET(0xB8BDE70)

inline static constexpr unsigned int Class_1_ABB5EA627A7A1251_TypeDefinitionIndex = 75867;
...
public:
	...
	::RPG::GameCore::ChenLingGridStatus _TargetGridType_k__BackingField; // 0x18
	::System::UInt32 _UseCardID_k__BackingField; // 0x1C
	::RPG::GameCore::ChenLingCardPreCheckType _ConditionType_k__BackingField; // 0x20
