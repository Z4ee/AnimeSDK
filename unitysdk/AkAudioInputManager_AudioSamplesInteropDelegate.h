...
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B90170)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B90210)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B8FDE0)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8F870)

inline static constexpr unsigned int AkAudioInputManager_AudioSamplesInteropDelegate_TypeDefinitionIndex = 34550;
