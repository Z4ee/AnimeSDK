...
#define CLASS_2_312BA1A8CEA7866C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191B1120)
#define CLASS_2_312BA1A8CEA7866C_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x191B1200)
#define CLASS_2_312BA1A8CEA7866C_METHOD_2_C0FBE2EB5AC963BC_OFFSET UNITYSDK_OFFSET(0x191B1370)
#define CLASS_2_312BA1A8CEA7866C_ONCANCELSPAWN_OFFSET UNITYSDK_OFFSET(0x191B1FA0)
#define CLASS_2_312BA1A8CEA7866C_ONSPAWNASYNC_OFFSET UNITYSDK_OFFSET(0x191B1F20)
#define CLASS_2_312BA1A8CEA7866C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x191B1320)
#define CLASS_2_312BA1A8CEA7866C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x191B1E10)
#define CLASS_2_312BA1A8CEA7866C_TICK_OFFSET UNITYSDK_OFFSET(0x191B1E60)
#define CLASS_2_312BA1A8CEA7866C_USELIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x191B2000)
#define CLASS_2_312BA1A8CEA7866C__CTOR_OFFSET UNITYSDK_OFFSET(0x191B1090)
...
public:
	...
	::RPG::GameCore::CharacterChangeModel* OFKGLJOAMLD; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::System::String* CGBLGAHEEKJ; // 0x30
