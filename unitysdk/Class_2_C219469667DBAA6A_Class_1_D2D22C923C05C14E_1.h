...
#define CLASS_2_C219469667DBAA6A_CLASS_1_D2D22C923C05C14E_1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12C97500)
#define CLASS_2_C219469667DBAA6A_CLASS_1_D2D22C923C05C14E_1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12C97D40)
#define CLASS_2_C219469667DBAA6A_CLASS_1_D2D22C923C05C14E_1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12C97DA0)
#define CLASS_2_C219469667DBAA6A_CLASS_1_D2D22C923C05C14E_1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12C97D50)
#define CLASS_2_C219469667DBAA6A_CLASS_1_D2D22C923C05C14E_1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12C974F0)
#define CLASS_2_C219469667DBAA6A_CLASS_1_D2D22C923C05C14E_1__CTOR_OFFSET UNITYSDK_OFFSET(0x12C974E0)

inline static constexpr unsigned int Class_2_C219469667DBAA6A_Class_1_D2D22C923C05C14E_1_TypeDefinitionIndex = 65646;

class Class_2_C219469667DBAA6A_Class_1_D2D22C923C05C14E_1 : public ::System::Object
{
public:
	::Class_2_C219469667DBAA6A* Field_1_7; // 0x10
