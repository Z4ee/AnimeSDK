...
#define CLASS_2_C0950EB832EDE5B7_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x99D4250)
#define CLASS_2_C0950EB832EDE5B7__CTOR_OFFSET UNITYSDK_OFFSET(0x99D42E0)
#define CLASS_2_C0950EB832EDE5B7__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x99D4300)
#define CLASS_2_C0950EB832EDE5B7___IFIXBASEPROXY_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x99D43E0)
#define CLASS_2_C0950EB832EDE5B7___IFIXBASEPROXY__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x99D4450)

inline static constexpr unsigned int Class_2_C0950EB832EDE5B7_TypeDefinitionIndex = 55250;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::HashSet_1<::RPG::Client::NotifyType>*))((::PBYTE)hIl2Cpp + CLASS_2_C0950EB832EDE5B7___IFIXBASEPROXY_FILLNOTIFYTYPESTO_OFFSET))(this, P0);
	}
