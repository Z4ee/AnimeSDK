...
#define MB_TEXARRAYSLICE_CONTAINSMATERIALANDMESH_OFFSET UNITYSDK_OFFSET(0x1DE8D9C0)
#define MB_TEXARRAYSLICE_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DE8D760)
#define MB_TEXARRAYSLICE_GETALLUSEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1DE8DB10)
#define MB_TEXARRAYSLICE_GETALLUSEDRENDERERS_OFFSET UNITYSDK_OFFSET(0x1DE8DBE0)
#define MB_TEXARRAYSLICE_GETDISTINCTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1DE8D830)
#define MB_TEXARRAYSLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE8DCF0)

inline static constexpr unsigned int MB_TexArraySlice_TypeDefinitionIndex = 90522;
