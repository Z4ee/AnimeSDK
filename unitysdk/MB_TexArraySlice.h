...
#define MB_TEXARRAYSLICE_CONTAINSMATERIALANDMESH_OFFSET UNITYSDK_OFFSET(0x1F2AA7F0)
#define MB_TEXARRAYSLICE_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F2AA590)
#define MB_TEXARRAYSLICE_GETALLUSEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1F2AA940)
#define MB_TEXARRAYSLICE_GETALLUSEDRENDERERS_OFFSET UNITYSDK_OFFSET(0x1F2AAA10)
#define MB_TEXARRAYSLICE_GETDISTINCTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1F2AA660)
#define MB_TEXARRAYSLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2AAB20)

inline static constexpr unsigned int MB_TexArraySlice_TypeDefinitionIndex = 94455;
