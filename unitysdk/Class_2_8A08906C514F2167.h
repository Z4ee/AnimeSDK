...
#define CLASS_2_8A08906C514F2167_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE81D60)
#define CLASS_2_8A08906C514F2167_METHOD_2_0BC5469359019175_OFFSET UNITYSDK_OFFSET(0xBE82BE0)
#define CLASS_2_8A08906C514F2167_METHOD_2_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xBE826C0)
#define CLASS_2_8A08906C514F2167_METHOD_2_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xBE82310)
#define CLASS_2_8A08906C514F2167_METHOD_2_A52062643A2DBAD8_OFFSET UNITYSDK_OFFSET(0xBE82560)
#define CLASS_2_8A08906C514F2167_METHOD_2_BA3668D75F932A95_OFFSET UNITYSDK_OFFSET(0xBE82B20)
#define CLASS_2_8A08906C514F2167_METHOD_2_F5C8A89B67E293AE_OFFSET UNITYSDK_OFFSET(0xBE823F0)
#define CLASS_2_8A08906C514F2167_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBE81E00)
#define CLASS_2_8A08906C514F2167_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBE827E0)
#define CLASS_2_8A08906C514F2167_TICK_OFFSET UNITYSDK_OFFSET(0xBE82830)
#define CLASS_2_8A08906C514F2167__CTOR_OFFSET UNITYSDK_OFFSET(0xBE81D40)

inline static constexpr unsigned int Class_2_8A08906C514F2167_TypeDefinitionIndex = 58852;

class Class_2_8A08906C514F2167 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::Client::InverseMask* AHFPLGOENNH; // 0x20
	::UnityEngine::RectTransform* AFOCLDFKOCI; // 0x28
	::UnityEngine::MeshRenderer* GFEHCONCNCA; // 0x30
	::RPG::GameCore::ShowTutorialUIMask* OFKGLJOAMLD; // 0x38
	::UnityEngine::Vector2 IKKNJMJCDOJ; // 0x40
	::System::Single EHLMEPDCBBC; // 0x48
	::System::Int32 POHBPGJFONJ; // 0x4C
	::System::Single DJKKCALPBJE; // 0x50
