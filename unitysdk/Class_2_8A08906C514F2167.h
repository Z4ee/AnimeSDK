...
#define CLASS_2_8A08906C514F2167_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1985B8B0)
#define CLASS_2_8A08906C514F2167_METHOD_2_0BC5469359019175_OFFSET UNITYSDK_OFFSET(0x1985C710)
#define CLASS_2_8A08906C514F2167_METHOD_2_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0x1985C1F0)
#define CLASS_2_8A08906C514F2167_METHOD_2_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0x1985BE50)
#define CLASS_2_8A08906C514F2167_METHOD_2_A52062643A2DBAD8_OFFSET UNITYSDK_OFFSET(0x1985C090)
#define CLASS_2_8A08906C514F2167_METHOD_2_BA3668D75F932A95_OFFSET UNITYSDK_OFFSET(0x1985C650)
#define CLASS_2_8A08906C514F2167_METHOD_2_F5C8A89B67E293AE_OFFSET UNITYSDK_OFFSET(0x1985BF30)
#define CLASS_2_8A08906C514F2167_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1985B950)
#define CLASS_2_8A08906C514F2167_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1985C310)
#define CLASS_2_8A08906C514F2167_TICK_OFFSET UNITYSDK_OFFSET(0x1985C360)
#define CLASS_2_8A08906C514F2167__CTOR_OFFSET UNITYSDK_OFFSET(0x1985B890)
...
public:
	...
	::RPG::GameCore::ShowTutorialUIMask* OFKGLJOAMLD; // 0x30
	::UnityEngine::RectTransform* AFOCLDFKOCI; // 0x38
	::System::Single DJKKCALPBJE; // 0x40
	::System::Int32 POHBPGJFONJ; // 0x44
	::System::Single EHLMEPDCBBC; // 0x48
	::UnityEngine::Vector2 IKKNJMJCDOJ; // 0x4C
