...
#define CLASS_2_8A08906C514F2167_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB00CEA0)
#define CLASS_2_8A08906C514F2167_METHOD_2_0BC5469359019175_OFFSET UNITYSDK_OFFSET(0xB00DBD0)
#define CLASS_2_8A08906C514F2167_METHOD_2_5B2CAD1A0582F9BB_OFFSET UNITYSDK_OFFSET(0xB00D800)
#define CLASS_2_8A08906C514F2167_METHOD_2_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xB00D450)
#define CLASS_2_8A08906C514F2167_METHOD_2_A52062643A2DBAD8_OFFSET UNITYSDK_OFFSET(0xB00D6A0)
#define CLASS_2_8A08906C514F2167_METHOD_2_BA3668D75F932A95_OFFSET UNITYSDK_OFFSET(0xB00DB10)
#define CLASS_2_8A08906C514F2167_METHOD_2_F5C8A89B67E293AE_OFFSET UNITYSDK_OFFSET(0xB00D530)
#define CLASS_2_8A08906C514F2167_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB00CF40)
#define CLASS_2_8A08906C514F2167_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB00D8B0)
#define CLASS_2_8A08906C514F2167_TICK_OFFSET UNITYSDK_OFFSET(0xB00D900)
#define CLASS_2_8A08906C514F2167__CTOR_OFFSET UNITYSDK_OFFSET(0xB00CE80)

inline static constexpr unsigned int Class_2_8A08906C514F2167_TypeDefinitionIndex = 54120;

class Class_2_8A08906C514F2167 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::InverseMask* Field_2_3; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::UnityEngine::MeshRenderer* Field_2_8; // 0x28
	::RPG::GameCore::ShowTutorialUIMask* Field_2_0; // 0x30
