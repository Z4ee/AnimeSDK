...
#define COLORCURVEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEB56E0)
#define COLORCURVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB56A0)

inline static constexpr unsigned int ColorCurveAttribute_TypeDefinitionIndex = 26230;

class ColorCurveAttribute : public ::UnityEngine::PropertyAttribute
{
public:
	::System::String* lumVsSat; // 0x10
	::System::String* satVsSat; // 0x18
	::System::String* bluePropertyName; // 0x20
	::System::String* redPropertyName; // 0x28
	::System::String* hueVsSat; // 0x30
	::System::String* hueVsHue; // 0x38
	::System::String* masterPropertyName; // 0x40
	::System::String* greenPropertyName; // 0x48
