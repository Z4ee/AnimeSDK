...
#define CLASS_2_1FAB2FDBD0E565C2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x198AC330)
#define CLASS_2_1FAB2FDBD0E565C2_METHOD_2_120D7C5085CC5C86_OFFSET UNITYSDK_OFFSET(0x198AC8B0)
#define CLASS_2_1FAB2FDBD0E565C2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x198AC440)
#define CLASS_2_1FAB2FDBD0E565C2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x198ACA50)
#define CLASS_2_1FAB2FDBD0E565C2_TICK_OFFSET UNITYSDK_OFFSET(0x198ACAA0)
#define CLASS_2_1FAB2FDBD0E565C2__CTOR_OFFSET UNITYSDK_OFFSET(0x198AC2C0)
...
public:
	...
	::RPG::GameCore::QteCatchGhostRewind* OFKGLJOAMLD; // 0x20
	::RPG::Client::QteCatchGhostRewindInstance* FLMODBLFAGD; // 0x28
