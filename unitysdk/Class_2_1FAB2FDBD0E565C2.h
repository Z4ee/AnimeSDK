...
#define CLASS_2_1FAB2FDBD0E565C2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x104FD610)
#define CLASS_2_1FAB2FDBD0E565C2_METHOD_2_240B9CD8AFBDC4FE_OFFSET UNITYSDK_OFFSET(0x104FDAD0)
#define CLASS_2_1FAB2FDBD0E565C2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x104FD710)
#define CLASS_2_1FAB2FDBD0E565C2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x104FDBF0)
#define CLASS_2_1FAB2FDBD0E565C2_TICK_OFFSET UNITYSDK_OFFSET(0x104FDC40)
#define CLASS_2_1FAB2FDBD0E565C2__CTOR_OFFSET UNITYSDK_OFFSET(0x104FD5A0)
...
public:
	...
	::RPG::GameCore::QteCatchGhostRewind* Field_2_1; // 0x20
	::RPG::Client::QteCatchGhostRewindInstance* Field_2_2; // 0x28
