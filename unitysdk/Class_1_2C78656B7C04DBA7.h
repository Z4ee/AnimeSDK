...
#define CLASS_1_2C78656B7C04DBA7_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C76CE10)
#define CLASS_1_2C78656B7C04DBA7__CTOR_OFFSET UNITYSDK_OFFSET(0x1C76CE80)
...
public:
	...
	::System::UInt32 GJNJCGFIDEB; // 0x1C
