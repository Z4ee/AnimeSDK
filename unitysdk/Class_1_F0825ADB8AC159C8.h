...
#define CLASS_1_F0825ADB8AC159C8_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD08A00)
#define CLASS_1_F0825ADB8AC159C8_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD08350)
#define CLASS_1_F0825ADB8AC159C8_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD08480)
#define CLASS_1_F0825ADB8AC159C8_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD08450)
#define CLASS_1_F0825ADB8AC159C8_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD086A0)
#define CLASS_1_F0825ADB8AC159C8_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD08B60)
#define CLASS_1_F0825ADB8AC159C8_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD08B00)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DD08410)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1DD083C0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1DD083B0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DD082B0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DD08420)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1DD08440)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1DD08430)
#define CLASS_1_F0825ADB8AC159C8_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD082E0)
#define CLASS_1_F0825ADB8AC159C8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD08840)
#define CLASS_1_F0825ADB8AC159C8_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD088A0)
#define CLASS_1_F0825ADB8AC159C8__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD08DA0)
#define CLASS_1_F0825ADB8AC159C8__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD08300)
#define CLASS_1_F0825ADB8AC159C8__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD082F0)

inline static constexpr unsigned int Class_1_F0825ADB8AC159C8_TypeDefinitionIndex = 25122;

class Class_1_F0825ADB8AC159C8 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F0825ADB8AC159C8*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F0825ADB8AC159C8*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F0825ADB8AC159C8_TypeDefinitionIndex)->GetStaticField(0x3FBE0);
	}
	// static const ::System::Int32 IMENFKCDPOK = 0x1; // 0x0
	// static const ::System::Int32 HOHDLIKKMBH = 0x2; // 0x0
	// static const ::System::Int32 MELOPNPCNIH = 0x3; // 0x0
	::System::String* OKPDLDHJNPG; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::UInt32 BFOBOOGAHKB; // 0x20
	::System::Double AHNEBPEHFLP; // 0x28
