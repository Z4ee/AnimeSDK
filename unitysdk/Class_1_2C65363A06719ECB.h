...
#define CLASS_1_2C65363A06719ECB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x163FEFF0)
#define CLASS_1_2C65363A06719ECB_METHOD_1_22FF9A78A8EACE10_OFFSET UNITYSDK_OFFSET(0x163FFEB0)
#define CLASS_1_2C65363A06719ECB_METHOD_1_4B1E26575F5F2545_OFFSET UNITYSDK_OFFSET(0x163FF610)
#define CLASS_1_2C65363A06719ECB_METHOD_1_6C78BE0F58E59620_OFFSET UNITYSDK_OFFSET(0x163FF720)
#define CLASS_1_2C65363A06719ECB_METHOD_1_7F1787152CE4767B_OFFSET UNITYSDK_OFFSET(0x163FF4E0)
#define CLASS_1_2C65363A06719ECB_METHOD_1_89A8E479036925D6_OFFSET UNITYSDK_OFFSET(0x163FF850)
#define CLASS_1_2C65363A06719ECB_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x163FF2A0)
#define CLASS_1_2C65363A06719ECB_METHOD_1_C152C26DEFE0BAA5_OFFSET UNITYSDK_OFFSET(0x163FF780)
#define CLASS_1_2C65363A06719ECB_METHOD_1_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0x163FF040)
#define CLASS_1_2C65363A06719ECB_METHOD_1_CDFCB4F1AB271783_OFFSET UNITYSDK_OFFSET(0x163FF7F0)
#define CLASS_1_2C65363A06719ECB_METHOD_1_D8E6DC0B27699F85_OFFSET UNITYSDK_OFFSET(0x163FF110)
#define CLASS_1_2C65363A06719ECB_METHOD_1_DA610FEA2EB85750_OFFSET UNITYSDK_OFFSET(0x16400250)
#define CLASS_1_2C65363A06719ECB_METHOD_1_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x163FF330)
#define CLASS_1_2C65363A06719ECB__CCTOR_OFFSET UNITYSDK_OFFSET(0x16400990)
#define CLASS_1_2C65363A06719ECB__CTOR_OFFSET UNITYSDK_OFFSET(0x164008D0)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_2C65363A06719ECB_TypeDefinitionIndex)->GetStaticField(0xFED0);
	}
	::Class_1_9B3591E177CAF203* DIOOIEHBNHJ; // 0x10
	::System::Collections::Generic::List_1<::Class_1_469A5FF005CF3F5C*>* GFEGDMAMPBF; // 0x18
	::UnityEngine::Transform* GMPKDNDENLK; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_469A5FF005CF3F5C*>* MAIFJIALPLJ; // 0x28
	::System::Collections::Generic::List_1<::Class_1_2C65363A06719ECB_Class_1_E9C30BE229F37179*>* BCKPDLCEFHH; // 0x30
	::RPGTools::Timeline::VirtualCameraNoiseConfig* IPINEPCDFDO; // 0x38
	::UnityEngine::Vector3 LOMMNBIANJO; // 0x40
	::System::Nullable_1<::System::Single> OFABLKBBNHC; // 0x4C
	::UnityEngine::Vector3 JHLJODHMEMP; // 0x54
