...
#define CLASS_1_5B567C8A01BAEDFE_51_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19967BB0)
#define CLASS_1_5B567C8A01BAEDFE_51_CLONE_OFFSET UNITYSDK_OFFSET(0x19967A20)
#define CLASS_1_5B567C8A01BAEDFE_51_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19967AC0)
#define CLASS_1_5B567C8A01BAEDFE_51_EQUALS_OFFSET UNITYSDK_OFFSET(0x19967A60)
#define CLASS_1_5B567C8A01BAEDFE_51_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19967B10)
#define CLASS_1_5B567C8A01BAEDFE_51_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19967C00)
#define CLASS_1_5B567C8A01BAEDFE_51_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19967BD0)
#define CLASS_1_5B567C8A01BAEDFE_51_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x199679A0)
#define CLASS_1_5B567C8A01BAEDFE_51_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x199679D0)
#define CLASS_1_5B567C8A01BAEDFE_51_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19967B40)
#define CLASS_1_5B567C8A01BAEDFE_51_WRITETO_OFFSET UNITYSDK_OFFSET(0x19967BA0)
#define CLASS_1_5B567C8A01BAEDFE_51__CCTOR_OFFSET UNITYSDK_OFFSET(0x19967C50)
#define CLASS_1_5B567C8A01BAEDFE_51__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199679F0)
#define CLASS_1_5B567C8A01BAEDFE_51__CTOR_OFFSET UNITYSDK_OFFSET(0x199679E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_51_TypeDefinitionIndex = 25462;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_51*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_51_TypeDefinitionIndex)->GetStaticField(0x61760);
	}
