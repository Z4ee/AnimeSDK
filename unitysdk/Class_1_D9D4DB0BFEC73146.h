...
#define CLASS_1_D9D4DB0BFEC73146_EXECUTE_OFFSET UNITYSDK_OFFSET(0x158C6730)
#define CLASS_1_D9D4DB0BFEC73146_TICK_OFFSET UNITYSDK_OFFSET(0x158C6960)
#define CLASS_1_D9D4DB0BFEC73146__CTOR_OFFSET UNITYSDK_OFFSET(0x158C66B0)

inline static constexpr unsigned int Class_1_D9D4DB0BFEC73146_TypeDefinitionIndex = 77188;
