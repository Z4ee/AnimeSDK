...
#define CLASS_1_F966CC1261619DFB__CTOR_OFFSET UNITYSDK_OFFSET(0x17C72C50)

inline static constexpr unsigned int Class_1_F966CC1261619DFB_TypeDefinitionIndex = 51378;
...
public:
	...
	::RPG::GameCore::AttackDamageType Field_1_3; // 0x28
