...
#define CLASS_1_4B5AF17DBB1E699A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19AD80C0)
#define CLASS_1_4B5AF17DBB1E699A_GET_BUFFCONFIG_OFFSET UNITYSDK_OFFSET(0x19AD8880)
#define CLASS_1_4B5AF17DBB1E699A_GET_CELLCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x19AD8800)
#define CLASS_1_4B5AF17DBB1E699A_GET_CHENLINGCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x19AD87E0)
#define CLASS_1_4B5AF17DBB1E699A_GET_FIELDCONFIG_OFFSET UNITYSDK_OFFSET(0x19AD87A0)
#define CLASS_1_4B5AF17DBB1E699A_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x19AD88A0)
#define CLASS_1_4B5AF17DBB1E699A_GET_ITEMCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x19AD87C0)
#define CLASS_1_4B5AF17DBB1E699A_GET_ITEMRULEGROUPIDMAP_OFFSET UNITYSDK_OFFSET(0x19AD8820)
#define CLASS_1_4B5AF17DBB1E699A_GET_REGIONCONFIG_OFFSET UNITYSDK_OFFSET(0x19AD8860)
#define CLASS_1_4B5AF17DBB1E699A_GET_UNLOCKNORMALCELLPREFABPATH_OFFSET UNITYSDK_OFFSET(0x19AD8840)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_0E6A03665498E7FE_1_OFFSET UNITYSDK_OFFSET(0x19AD8650)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_0E6A03665498E7FE_OFFSET UNITYSDK_OFFSET(0x19AD8500)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_1624976974349EA1_OFFSET UNITYSDK_OFFSET(0x19AD82F0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_7BDBE8E7DCCDC6EB_OFFSET UNITYSDK_OFFSET(0x19AD8250)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_AA041EC2967F998A_OFFSET UNITYSDK_OFFSET(0x19AD8410)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_B13A68870DC37DD0_OFFSET UNITYSDK_OFFSET(0x19AD88C0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x19AD7CC0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_C35E27D6493C2262_OFFSET UNITYSDK_OFFSET(0x19AD82A0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_D81AF5D2D64FAA0F_OFFSET UNITYSDK_OFFSET(0x19AD84A0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x19AD7590)
#define CLASS_1_4B5AF17DBB1E699A_SET_BUFFCONFIG_OFFSET UNITYSDK_OFFSET(0x19AD8890)
#define CLASS_1_4B5AF17DBB1E699A_SET_CELLCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x19AD8810)
#define CLASS_1_4B5AF17DBB1E699A_SET_CHENLINGCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x19AD87F0)
#define CLASS_1_4B5AF17DBB1E699A_SET_FIELDCONFIG_OFFSET UNITYSDK_OFFSET(0x19AD87B0)
#define CLASS_1_4B5AF17DBB1E699A_SET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x19AD88B0)
#define CLASS_1_4B5AF17DBB1E699A_SET_ITEMCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x19AD87D0)
#define CLASS_1_4B5AF17DBB1E699A_SET_ITEMRULEGROUPIDMAP_OFFSET UNITYSDK_OFFSET(0x19AD8830)
#define CLASS_1_4B5AF17DBB1E699A_SET_REGIONCONFIG_OFFSET UNITYSDK_OFFSET(0x19AD8870)
#define CLASS_1_4B5AF17DBB1E699A_SET_UNLOCKNORMALCELLPREFABPATH_OFFSET UNITYSDK_OFFSET(0x19AD8850)
#define CLASS_1_4B5AF17DBB1E699A__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AD88D0)
#define CLASS_1_4B5AF17DBB1E699A__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD7370)

inline static constexpr unsigned int Class_1_4B5AF17DBB1E699A_TypeDefinitionIndex = 77278;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4B5AF17DBB1E699A_TypeDefinitionIndex)->GetStaticField(0x29160);
	}
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::System::UInt32>*>* _ItemRuleGroupIDMap_k__BackingField; // 0x10
	::Class_3_97041AE90E3B2214* PDENFEFCAGN; // 0x18
	::RPG::GameCore::LittleGameLevelConfig* COBGCAHFFBJ; // 0x20
	::RPG::GameCore::LittleGameLevelConfig* ECINADEAPFJ; // 0x28
	::RPG::GameCore::ChenLingFesBuffConfig* BGPCJNLAFAN; // 0x30
	::RPG::GameCore::ChenLingFesLevelConfigRow* DCEHAKOFMHB; // 0x38
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* _CellConfigMap_k__BackingField; // 0x40
	...
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* _ItemConfigMap_k__BackingField; // 0x50
	::RPG::GameCore::ChenLingFesRegionConfig* _RegionConfig_k__BackingField; // 0x58
	::RPG::GameCore::ChenLingFesBuffConfig* _BuffConfig_k__BackingField; // 0x60
	::RPG::GameCore::LittleGameLevelConfig* JIHKFMLPMLF; // 0x68
	::RPG::GameCore::LittleGameEntityConfig* _FieldConfig_k__BackingField; // 0x70
	::System::String* _UnlockNormalCellPrefabPath_k__BackingField; // 0x78
