...
#define CLASS_1_B590C31C505191E5_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E213190)
#define CLASS_1_B590C31C505191E5_4_CLONE_OFFSET UNITYSDK_OFFSET(0x1E212C30)
#define CLASS_1_B590C31C505191E5_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E212DF0)
#define CLASS_1_B590C31C505191E5_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E212CB0)
#define CLASS_1_B590C31C505191E5_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E212EF0)
#define CLASS_1_B590C31C505191E5_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E213280)
#define CLASS_1_B590C31C505191E5_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E213230)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E212AE0)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1E212C80)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E212CA0)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E212C90)
#define CLASS_1_B590C31C505191E5_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E212B40)
#define CLASS_1_B590C31C505191E5_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E212FF0)
#define CLASS_1_B590C31C505191E5_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E213050)
#define CLASS_1_B590C31C505191E5_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E213460)
#define CLASS_1_B590C31C505191E5_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E212BA0)
#define CLASS_1_B590C31C505191E5_4__CTOR_OFFSET UNITYSDK_OFFSET(0x1E212B50)

inline static constexpr unsigned int Class_1_B590C31C505191E5_4_TypeDefinitionIndex = 28851;

class Class_1_B590C31C505191E5_4 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_4*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_4_TypeDefinitionIndex)->GetStaticField(0x5F2A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_COOIKKHKLDK()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_4_TypeDefinitionIndex)->GetStaticField(0x5F2A8);
	}
	// static const ::System::Int32 FGFBDLFAMHM = 0x1; // 0x0
	// static const ::System::Int32 IEJLAFHELMJ = 0x6; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* AFCAMGHCFPH; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::Boolean OGDGLKLJOFI; // 0x20
