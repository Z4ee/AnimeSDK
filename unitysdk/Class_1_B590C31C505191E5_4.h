...
#define CLASS_1_B590C31C505191E5_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3BFFE0)
#define CLASS_1_B590C31C505191E5_4_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3BFBB0)
#define CLASS_1_B590C31C505191E5_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3BFD00)
#define CLASS_1_B590C31C505191E5_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3BFC30)
#define CLASS_1_B590C31C505191E5_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3BFDA0)
#define CLASS_1_B590C31C505191E5_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3C00C0)
#define CLASS_1_B590C31C505191E5_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3C0070)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3BFA60)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A3BFC20)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A3BFC10)
#define CLASS_1_B590C31C505191E5_4_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A3BFC00)
#define CLASS_1_B590C31C505191E5_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3BFAC0)
#define CLASS_1_B590C31C505191E5_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3BFEA0)
#define CLASS_1_B590C31C505191E5_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3BFF00)
#define CLASS_1_B590C31C505191E5_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3C02A0)
#define CLASS_1_B590C31C505191E5_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3BFB20)
#define CLASS_1_B590C31C505191E5_4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BFAD0)

inline static constexpr unsigned int Class_1_B590C31C505191E5_4_TypeDefinitionIndex = 27611;

class Class_1_B590C31C505191E5_4 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_4*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_4_TypeDefinitionIndex)->GetStaticField(0x60830);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_4_TypeDefinitionIndex)->GetStaticField(0x60838);
	}
