...
#define STRUCT_2_9DAF9339360A18FD_METHOD_2_9F84D1FF74319152_OFFSET UNITYSDK_OFFSET(0x7825A0)
#define STRUCT_2_9DAF9339360A18FD__CCTOR_OFFSET UNITYSDK_OFFSET(0x11E7EB90)
#define STRUCT_2_9DAF9339360A18FD__CTOR_OFFSET UNITYSDK_OFFSET(0x782620)

inline static constexpr unsigned int Struct_2_9DAF9339360A18FD_TypeDefinitionIndex = 51357;

struct alignas(8) Struct_2_9DAF9339360A18FD
{
	static ::System::Int32* StaticGet_Field_2_2()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_9DAF9339360A18FD_TypeDefinitionIndex)->GetStaticField(0xAB60);
	}
	::MoleMole::EntityHandle Field_2_1; // 0x10
	::Foundation::Unreal::FTransform Field_2_0; // 0x20
