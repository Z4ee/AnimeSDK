...
#define CLASS_1_DBCACC13E7FD61BE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DC7D530)
#define CLASS_1_DBCACC13E7FD61BE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DC7D540)
#define CLASS_1_DBCACC13E7FD61BE_METHOD_1_528BD4865C714C5C_OFFSET UNITYSDK_OFFSET(0x1DC7D4E0)
#define CLASS_1_DBCACC13E7FD61BE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC7D520)

inline static constexpr unsigned int Class_1_DBCACC13E7FD61BE_TypeDefinitionIndex = 15288;

class Class_1_DBCACC13E7FD61BE : public ::System::Object
{
public:
	static ::Class_1_DBCACC13E7FD61BE** StaticGet_FLMODBLFAGD()
	{
		return (::Class_1_DBCACC13E7FD61BE**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DBCACC13E7FD61BE_TypeDefinitionIndex)->GetStaticField(0x59230);
	}
