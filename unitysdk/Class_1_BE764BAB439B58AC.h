...
#define CLASS_1_BE764BAB439B58AC_GET_DEBUGSTATE_OFFSET UNITYSDK_OFFSET(0x15BC51C0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_18B8B3C7AE5E95BB_OFFSET UNITYSDK_OFFSET(0x15BC5300)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_1B1F361718F73A20_OFFSET UNITYSDK_OFFSET(0x15BC62C0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_240CE54A2093CC15_OFFSET UNITYSDK_OFFSET(0x15BC6590)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_39825F7B9A5124F8_OFFSET UNITYSDK_OFFSET(0x15BC5970)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_4581E6F285FC1202_OFFSET UNITYSDK_OFFSET(0x15BC5AF0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_6BE33309F5C49CC7_OFFSET UNITYSDK_OFFSET(0x15BC5DD0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_6FCDE4DB27EDEA53_OFFSET UNITYSDK_OFFSET(0x15BC60C0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_B27A4756A951DBDD_OFFSET UNITYSDK_OFFSET(0x15BC68E0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_B66743395D9743AC_OFFSET UNITYSDK_OFFSET(0x15BC6390)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_BF49A14094DB94AB_OFFSET UNITYSDK_OFFSET(0x15BC6270)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_CCAFBB327280DC21_OFFSET UNITYSDK_OFFSET(0x15BC5A80)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_DE2473C3425C1AAC_OFFSET UNITYSDK_OFFSET(0x15BC67C0)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_E0CB7EF718DB0DB7_OFFSET UNITYSDK_OFFSET(0x15BC6440)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_EF2B018840867312_OFFSET UNITYSDK_OFFSET(0x15BC5290)
#define CLASS_1_BE764BAB439B58AC_METHOD_1_F55DD84C7E4B28F2_OFFSET UNITYSDK_OFFSET(0x15BC5800)
#define CLASS_1_BE764BAB439B58AC_SET_DEBUGSTATE_OFFSET UNITYSDK_OFFSET(0x15BC51D0)
#define CLASS_1_BE764BAB439B58AC__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC51E0)
#define CLASS_1_BE764BAB439B58AC___SHOWBATTLESUCCTOAST_B__30_0_OFFSET UNITYSDK_OFFSET(0x15BC72C0)
#define CLASS_1_BE764BAB439B58AC___SHOWBOSSSUCCDIALOG_B__29_0_OFFSET UNITYSDK_OFFSET(0x15BC7290)
#define CLASS_1_BE764BAB439B58AC___SHOWCATCHUPREWARDDIALOG_B__27_0_OFFSET UNITYSDK_OFFSET(0x15BC7260)
#define CLASS_1_BE764BAB439B58AC___SHOWEQUIPORB_B__24_0_OFFSET UNITYSDK_OFFSET(0x15BC7230)

inline static constexpr unsigned int Class_1_BE764BAB439B58AC_TypeDefinitionIndex = 74964;

class Class_1_BE764BAB439B58AC : public ::System::Object
{
public:
	// static const ::System::Int32 ENEDNPEBCJK = 0x5; // 0x0
	::System::Collections::Generic::List_1<::RPG::Client::ItemDisplayData*>* BDFPNINIPKE; // 0x10
	::RPG::Client::Promises::Promise* DPGLAJCOOCH; // 0x18
	::RPG::Client::Promises::Promise* AFGBNAAFJFO; // 0x20
	::RPG::Client::Promises::Promise* GLJPMGNOKNI; // 0x28
	::System::Collections::Generic::List_1<::System::UInt32>* FEKELAENMNH; // 0x30
	::RPG::Client::Promises::Promise* BLOOOMDHGFG; // 0x38
	::System::Collections::Generic::List_1<::RPG::Client::ItemDisplayData*>* EGKCFNBCICI; // 0x40
	::System::UInt32 _DebugState_k__BackingField; // 0x48
	::System::Boolean FJHCJAKGLGK; // 0x4C
	::System::UInt32 LPFLIFFMJEL; // 0x50
	::System::UInt32 IJHAJEABAJF; // 0x54
