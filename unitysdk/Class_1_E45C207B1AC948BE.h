...
#define CLASS_1_E45C207B1AC948BE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC96DA40)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_17CC2BD66F7B3D3B_OFFSET UNITYSDK_OFFSET(0xC96DF40)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_1BFA9D447C938D84_OFFSET UNITYSDK_OFFSET(0xC96DFD0)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_1DE357EB37CCCA0C_OFFSET UNITYSDK_OFFSET(0xC96E600)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_46715AFA2A23D2D8_OFFSET UNITYSDK_OFFSET(0xC96E430)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xC96E070)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_98A399CC8B751747_OFFSET UNITYSDK_OFFSET(0xC96DA90)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_AFBE1E4C3048B787_OFFSET UNITYSDK_OFFSET(0xC96DD50)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_BED4BABD08BFA389_OFFSET UNITYSDK_OFFSET(0xC96E810)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_CE03D988B128D491_OFFSET UNITYSDK_OFFSET(0xC96DE80)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_E550319D2BFACD8F_OFFSET UNITYSDK_OFFSET(0xC96E210)
#define CLASS_1_E45C207B1AC948BE__CTOR_OFFSET UNITYSDK_OFFSET(0xC96D9E0)

inline static constexpr unsigned int Class_1_E45C207B1AC948BE_TypeDefinitionIndex = 64328;

class Class_1_E45C207B1AC948BE : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Struct_2_57BF88AA3D4ADFA2>* Field_1_0; // 0x10
	::Struct_2_0B84ADD7815498A2 Field_1_1; // 0x18
	::RPG::Client::TriggerEffectParamsRef Field_1_2; // 0x28
	::UnityEngine::Animator* Field_1_3; // 0x38
	::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* Field_1_4; // 0x40
	...
	::System::Void Method_1_AFBE1E4C3048B787(::RPG::Client::TriggerEffectParams* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::TriggerEffectParams*))((::PBYTE)hIl2Cpp + CLASS_1_E45C207B1AC948BE_METHOD_1_AFBE1E4C3048B787_OFFSET))(this, a1);
	}
