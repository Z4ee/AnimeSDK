...
#define CLASS_1_E45C207B1AC948BE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE0507E0)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_17CC2BD66F7B3D3B_OFFSET UNITYSDK_OFFSET(0xE2AA650)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_1BFA9D447C938D84_OFFSET UNITYSDK_OFFSET(0xE2AA6E0)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_1DE357EB37CCCA0C_OFFSET UNITYSDK_OFFSET(0xE2AAD20)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_46715AFA2A23D2D8_OFFSET UNITYSDK_OFFSET(0xE2AAB40)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_611343FD7972BFAD_OFFSET UNITYSDK_OFFSET(0xE2AA1A0)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xE2AA780)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_96AA0089A7F831C0_OFFSET UNITYSDK_OFFSET(0xE2AAF30)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_98A399CC8B751747_OFFSET UNITYSDK_OFFSET(0xE2AA2D0)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_CE03D988B128D491_OFFSET UNITYSDK_OFFSET(0xE2AA590)
#define CLASS_1_E45C207B1AC948BE_METHOD_1_E550319D2BFACD8F_OFFSET UNITYSDK_OFFSET(0xE2AA920)
#define CLASS_1_E45C207B1AC948BE__CTOR_OFFSET UNITYSDK_OFFSET(0xE050780)
...
{
public:
	::UnityEngine::Animator* BNGAPGKMAEG; // 0x10
	::System::Collections::Generic::List_1<::Struct_2_57BF88AA3D4ADFA2>* FCJMMJPPFGN; // 0x18
	::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* PNELGAPKCLO; // 0x20
	::Struct_2_0B84ADD7815498A2 OFPEBOOCBCA; // 0x28
	::RPG::Client::TriggerEffectParamsRef JMLEIELGEJH; // 0x38
