...
#define TWOPOINTSLINKGENERATOR_SETUPMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A0EB5B0)
#define TWOPOINTSLINKGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0EB810)
#define TWOPOINTSLINKGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EBD70)

inline static constexpr unsigned int TwoPointsLinkGenerator_TypeDefinitionIndex = 49892;
