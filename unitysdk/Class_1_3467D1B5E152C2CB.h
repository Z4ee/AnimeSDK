...
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_1AB9693E41D970DC_OFFSET UNITYSDK_OFFSET(0x113F44B0)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x113F4370)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x113F3DD0)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x113F43D0)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0x113F3FF0)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_743D4EB34AAA211A_OFFSET UNITYSDK_OFFSET(0x113F3C40)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x113F3F60)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_D7B7C909A67BD350_OFFSET UNITYSDK_OFFSET(0x113F4070)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x113F44D0)
#define CLASS_1_3467D1B5E152C2CB_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x113F44C0)
#define CLASS_1_3467D1B5E152C2CB__CTOR_OFFSET UNITYSDK_OFFSET(0x113F44E0)

inline static constexpr unsigned int Class_1_3467D1B5E152C2CB_TypeDefinitionIndex = 47527;

class Class_1_3467D1B5E152C2CB : public ::System::Object
{
public:
	::Class_3_5775A4FEC79026BC* Field_1_6; // 0x10
	::Class_2_27F1679D48D10C64* Field_1_0; // 0x18
	::RPG::GameCore::TaskContext* Field_1_2; // 0x20
	::Class_1_5F51D4049EA87B7B* Field_1_5; // 0x28
	::RPG::GameCore::WaitBatchItem* Field_1_1; // 0x30
