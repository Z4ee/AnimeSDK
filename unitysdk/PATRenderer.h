...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8CB02F0)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x8CB06C0)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x8CAFBF0)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8CB0B40)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8CAFC70)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x8CAFCC0)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CB0BE0)

inline static constexpr unsigned int PATRenderer_TypeDefinitionIndex = 38306;
