...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9853FB0)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x9854380)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x98538B0)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9854800)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9853930)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x9853980)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x98548A0)

inline static constexpr unsigned int PATRenderer_TypeDefinitionIndex = 44190;
