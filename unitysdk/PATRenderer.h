...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19262D30)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x19263100)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x192626D0)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19263580)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19262750)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x192627A0)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x19263640)
