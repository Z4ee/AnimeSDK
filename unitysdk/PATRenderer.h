...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAD11980)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xAD11D50)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0xAD11320)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAD121D0)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAD113A0)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0xAD113F0)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD122A0)

inline static constexpr unsigned int PATRenderer_TypeDefinitionIndex = 44736;
