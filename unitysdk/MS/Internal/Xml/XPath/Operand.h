...
#define MS_INTERNAL_XML_XPATH_OPERAND_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1A75FDC0)
#define MS_INTERNAL_XML_XPATH_OPERAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A75FDB0)
#define MS_INTERNAL_XML_XPATH_OPERAND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A75FD80)
#define MS_INTERNAL_XML_XPATH_OPERAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A75FD70)

namespace MS::Internal::Xml::XPath
{
	inline static constexpr unsigned int Operand_TypeDefinitionIndex = 1646;
