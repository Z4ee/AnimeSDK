...
#define MS_INTERNAL_XML_XPATH_OPERATOR_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x19D2A840)
#define MS_INTERNAL_XML_XPATH_OPERATOR_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19D2A830)
#define MS_INTERNAL_XML_XPATH_OPERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D2A860)
#define MS_INTERNAL_XML_XPATH_OPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19D2A820)

namespace MS::Internal::Xml::XPath
{
	inline static constexpr unsigned int Operator_TypeDefinitionIndex = 1647;
