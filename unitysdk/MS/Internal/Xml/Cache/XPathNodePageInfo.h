...
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_NEXTPAGE_OFFSET UNITYSDK_OFFSET(0x1E7C8F30)
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_NODECOUNT_OFFSET UNITYSDK_OFFSET(0x1E7C8F20)
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_PAGENUMBER_OFFSET UNITYSDK_OFFSET(0x1E7C8F10)
