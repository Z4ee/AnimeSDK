...
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_NEXTPAGE_OFFSET UNITYSDK_OFFSET(0x1AE12BD0)
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_NODECOUNT_OFFSET UNITYSDK_OFFSET(0x1AE12BC0)
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_PAGENUMBER_OFFSET UNITYSDK_OFFSET(0x1AE12BB0)

namespace MS::Internal::Xml::Cache
{
	inline static constexpr unsigned int XPathNodePageInfo_TypeDefinitionIndex = 1772;
