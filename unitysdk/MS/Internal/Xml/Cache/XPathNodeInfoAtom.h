...
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_DOCUMENT_OFFSET UNITYSDK_OFFSET(0x1AE12B80)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_LINENUMBERBASE_OFFSET UNITYSDK_OFFSET(0x1AE12B90)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_LINEPOSITIONBASE_OFFSET UNITYSDK_OFFSET(0x1AE12BA0)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1AE12B30)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1AE12B40)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_PAGEINFO_OFFSET UNITYSDK_OFFSET(0x1AE12B20)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_PARENTPAGE_OFFSET UNITYSDK_OFFSET(0x1AE12B70)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1AE12B50)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_SIBLINGPAGE_OFFSET UNITYSDK_OFFSET(0x1AE12B60)

namespace MS::Internal::Xml::Cache
{
	inline static constexpr unsigned int XPathNodeInfoAtom_TypeDefinitionIndex = 1773;
	...
	public:
		...
		::MS::Internal::Xml::Cache::XPathNodePageInfo* pageInfo; // 0x28
		::System::Xml::XPath::XPathDocument* doc; // 0x30
		::System::String* prefix; // 0x38
		::System::String* namespaceUri; // 0x40
		::System::Int32 linePosBase; // 0x48
		::System::Int32 lineNumBase; // 0x4C
