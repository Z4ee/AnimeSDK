...
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GETPARENT_OFFSET UNITYSDK_OFFSET(0x20FE170)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GETSIBLING_OFFSET UNITYSDK_OFFSET(0x20FE1A0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_COLLAPSEDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x20FE120)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_DOCUMENT_OFFSET UNITYSDK_OFFSET(0x20FE0B0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASCOLLAPSEDTEXT_OFFSET UNITYSDK_OFFSET(0x20FE270)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASNAMESPACEDECLS_OFFSET UNITYSDK_OFFSET(0x20FE2F0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASSIBLING_OFFSET UNITYSDK_OFFSET(0x20FE260)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_ISTEXT_OFFSET UNITYSDK_OFFSET(0x20FE280)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_ISXMLNAMESPACENODE_OFFSET UNITYSDK_OFFSET(0x20FE1D0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x20FE0D0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x20FE100)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x20FE070)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x20FE090)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x20FE040)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_PAGEINFO_OFFSET UNITYSDK_OFFSET(0x20FE150)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x20FE050)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x28E30)

namespace MS::Internal::Xml::Cache
{
	inline static constexpr unsigned int XPathNode_TypeDefinitionIndex = 1768;
	...
	struct alignas(8) XPathNode
	{
		...
		::System::Int32 GetParent(::Il2CppArray<::MS::Internal::Xml::Cache::XPathNode>*& pageNode)
		{
			return ((::System::Int32(*)(::PVOID, ::Il2CppArray<::MS::Internal::Xml::Cache::XPathNode>*&))((::PBYTE)hIl2Cpp + MS_INTERNAL_XML_CACHE_XPATHNODE_GETPARENT_OFFSET))(this, pageNode);
		}

		::System::Int32 GetSibling(::Il2CppArray<::MS::Internal::Xml::Cache::XPathNode>*& pageNode)
		{
			return ((::System::Int32(*)(::PVOID, ::Il2CppArray<::MS::Internal::Xml::Cache::XPathNode>*&))((::PBYTE)hIl2Cpp + MS_INTERNAL_XML_CACHE_XPATHNODE_GETSIBLING_OFFSET))(this, pageNode);
		}
