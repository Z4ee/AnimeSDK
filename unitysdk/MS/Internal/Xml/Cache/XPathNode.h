...
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GETPARENT_OFFSET UNITYSDK_OFFSET(0xA7ADE0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GETSIBLING_OFFSET UNITYSDK_OFFSET(0xA7AE10)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_COLLAPSEDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0xA7ADB0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_DOCUMENT_OFFSET UNITYSDK_OFFSET(0x8632F0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASCOLLAPSEDTEXT_OFFSET UNITYSDK_OFFSET(0xA7AEE0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASNAMESPACEDECLS_OFFSET UNITYSDK_OFFSET(0xA7AF60)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASSIBLING_OFFSET UNITYSDK_OFFSET(0xA7AED0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_ISTEXT_OFFSET UNITYSDK_OFFSET(0xA7AEF0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_ISXMLNAMESPACENODE_OFFSET UNITYSDK_OFFSET(0xA7AE40)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0xA7AD60)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0xA7AD90)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0xA7AD20)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0xA7AD40)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0xA7ACF0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_PAGEINFO_OFFSET UNITYSDK_OFFSET(0x863200)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0xA7AD00)

namespace MS::Internal::Xml::Cache
{
	inline static constexpr unsigned int XPathNode_TypeDefinitionIndex = 1655;
