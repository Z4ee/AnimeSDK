...
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1423C190)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_7900DB25C44BBC9B_OFFSET UNITYSDK_OFFSET(0x1423BA40)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_CE50258D081DC33B_OFFSET UNITYSDK_OFFSET(0x1423BA90)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x1423C230)

inline static constexpr unsigned int IRI_BaseBuildingCustomData_IndependentRenderObj_TypeDefinitionIndex = 44504;
