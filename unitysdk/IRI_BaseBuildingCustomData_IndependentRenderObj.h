...
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x161BAF30)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_7900DB25C44BBC9B_OFFSET UNITYSDK_OFFSET(0x161BA7E0)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_CE50258D081DC33B_OFFSET UNITYSDK_OFFSET(0x161BA830)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x161BAFD0)

inline static constexpr unsigned int IRI_BaseBuildingCustomData_IndependentRenderObj_TypeDefinitionIndex = 47623;
