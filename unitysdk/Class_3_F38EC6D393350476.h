...
#define CLASS_3_F38EC6D393350476_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1990C720)
#define CLASS_3_F38EC6D393350476_METHOD_3_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0x1990BF90)
#define CLASS_3_F38EC6D393350476_METHOD_3_BF9BB9E2BBF3B6F4_OFFSET UNITYSDK_OFFSET(0x1990BCB0)
#define CLASS_3_F38EC6D393350476_METHOD_3_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0x1990C370)
#define CLASS_3_F38EC6D393350476__CTOR_OFFSET UNITYSDK_OFFSET(0x1990BCA0)

inline static constexpr unsigned int Class_3_F38EC6D393350476_TypeDefinitionIndex = 55432;

class Class_3_F38EC6D393350476 : public ::Class_2_610EEE5D7459CDEC
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::NewProjectileConfig*>* FNJMGKNBPKK; // 0x68
