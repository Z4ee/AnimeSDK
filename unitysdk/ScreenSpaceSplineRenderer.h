...
#define SCREENSPACESPLINERENDERER_CALCULATEARRAYSIZES_OFFSET UNITYSDK_OFFSET(0x143B80A0)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x143B7D60)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERTANGENT_OFFSET UNITYSDK_OFFSET(0x143B7EB0)
#define SCREENSPACESPLINERENDERER_GENERATESPLINEMESH_OFFSET UNITYSDK_OFFSET(0x143B6320)
#define SCREENSPACESPLINERENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x143B7BF0)
#define SCREENSPACESPLINERENDERER_INIT_OFFSET UNITYSDK_OFFSET(0x143B7600)
#define SCREENSPACESPLINERENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x143B62C0)
#define SCREENSPACESPLINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x143B6270)
#define SCREENSPACESPLINERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x143B6150)
#define SCREENSPACESPLINERENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0x143B61A0)
#define SCREENSPACESPLINERENDERER_SETUPTARGETS_OFFSET UNITYSDK_OFFSET(0x143B75A0)
#define SCREENSPACESPLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x143B81A0)

inline static constexpr unsigned int ScreenSpaceSplineRenderer_TypeDefinitionIndex = 86217;
