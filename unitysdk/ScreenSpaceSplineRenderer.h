...
#define SCREENSPACESPLINERENDERER_CALCULATEARRAYSIZES_OFFSET UNITYSDK_OFFSET(0x179262B0)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x17925F70)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERTANGENT_OFFSET UNITYSDK_OFFSET(0x179260C0)
#define SCREENSPACESPLINERENDERER_GENERATESPLINEMESH_OFFSET UNITYSDK_OFFSET(0x17924530)
#define SCREENSPACESPLINERENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x17925E00)
#define SCREENSPACESPLINERENDERER_INIT_OFFSET UNITYSDK_OFFSET(0x17925810)
#define SCREENSPACESPLINERENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x179244D0)
#define SCREENSPACESPLINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17924480)
#define SCREENSPACESPLINERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17924360)
#define SCREENSPACESPLINERENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0x179243B0)
#define SCREENSPACESPLINERENDERER_SETUPTARGETS_OFFSET UNITYSDK_OFFSET(0x179257B0)
#define SCREENSPACESPLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x179263B0)

inline static constexpr unsigned int ScreenSpaceSplineRenderer_TypeDefinitionIndex = 52169;
