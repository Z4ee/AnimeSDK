...
#define CLASS_2_ADC16073F2E5921A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1783E8A0)
#define CLASS_2_ADC16073F2E5921A_METHOD_2_6BD012F436E1844D_OFFSET UNITYSDK_OFFSET(0x1783EBE0)
#define CLASS_2_ADC16073F2E5921A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1783E750)
#define CLASS_2_ADC16073F2E5921A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1783E850)
#define CLASS_2_ADC16073F2E5921A_TICK_OFFSET UNITYSDK_OFFSET(0x1783F0A0)
#define CLASS_2_ADC16073F2E5921A__CTOR_OFFSET UNITYSDK_OFFSET(0x1783E530)
...
public:
	...
	::Class_3_07C3C4D2990C49EE* BJLJAHMLKIO; // 0x20
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x28
	::Class_3_07C3C4D2990C49EE* ENHDENNMJFB; // 0x30
	::RPG::GameCore::MarbleEventListener* IGHAHBNLIJA; // 0x38
