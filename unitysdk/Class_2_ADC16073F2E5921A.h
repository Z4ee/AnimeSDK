...
#define CLASS_2_ADC16073F2E5921A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1062CCE0)
#define CLASS_2_ADC16073F2E5921A_METHOD_2_5F3AE37087DCC4E1_OFFSET UNITYSDK_OFFSET(0x1062CE60)
#define CLASS_2_ADC16073F2E5921A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1062CBA0)
#define CLASS_2_ADC16073F2E5921A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1062CC90)
#define CLASS_2_ADC16073F2E5921A_TICK_OFFSET UNITYSDK_OFFSET(0x1062D1F0)
#define CLASS_2_ADC16073F2E5921A__CTOR_OFFSET UNITYSDK_OFFSET(0x1062C9D0)

inline static constexpr unsigned int Class_2_ADC16073F2E5921A_TypeDefinitionIndex = 42897;
...
public:
	...
	::RPG::GameCore::MarbleEventListener* Field_2_1; // 0x30
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_375*))((::PBYTE)hIl2Cpp + CLASS_2_ADC16073F2E5921A_METHOD_2_5F3AE37087DCC4E1_OFFSET))(this, a1);
	}
