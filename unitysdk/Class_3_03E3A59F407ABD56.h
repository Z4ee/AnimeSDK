...
#define CLASS_3_03E3A59F407ABD56_METHOD_3_4077B7F0C83FF920_OFFSET UNITYSDK_OFFSET(0x19972C70)
#define CLASS_3_03E3A59F407ABD56_METHOD_3_5A30A2F2D7363E37_OFFSET UNITYSDK_OFFSET(0x19972C30)
#define CLASS_3_03E3A59F407ABD56__CTOR_OFFSET UNITYSDK_OFFSET(0x19972C60)

inline static constexpr unsigned int Class_3_03E3A59F407ABD56_TypeDefinitionIndex = 17348;

class Class_3_03E3A59F407ABD56 : public ::Class_2_68C34B5C1C40C2FF
{
public:
	::Il2CppArray<::Class_2_68C34B5C1C40C2FF*>* Field_3_0; // 0x10
	::RPG::GameCore::LogicOperation Field_3_1; // 0x18
