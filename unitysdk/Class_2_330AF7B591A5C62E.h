...
#define CLASS_2_330AF7B591A5C62E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B5C040)
#define CLASS_2_330AF7B591A5C62E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14B5C080)
#define CLASS_2_330AF7B591A5C62E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14B5C580)
#define CLASS_2_330AF7B591A5C62E_TICK_OFFSET UNITYSDK_OFFSET(0x14B5C5D0)
#define CLASS_2_330AF7B591A5C62E__CTOR_OFFSET UNITYSDK_OFFSET(0x14B5C030)

inline static constexpr unsigned int Class_2_330AF7B591A5C62E_TypeDefinitionIndex = 52694;

class Class_2_330AF7B591A5C62E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifyCoolDown* Field_2_0; // 0x18
