...
#define CLASS_1_5B567C8A01BAEDFE_361_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19AD1900)
#define CLASS_1_5B567C8A01BAEDFE_361_CLONE_OFFSET UNITYSDK_OFFSET(0x19AD1710)
#define CLASS_1_5B567C8A01BAEDFE_361_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19AD1810)
#define CLASS_1_5B567C8A01BAEDFE_361_EQUALS_OFFSET UNITYSDK_OFFSET(0x19AD1780)
#define CLASS_1_5B567C8A01BAEDFE_361_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19AD1860)
#define CLASS_1_5B567C8A01BAEDFE_361_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19AD1950)
#define CLASS_1_5B567C8A01BAEDFE_361_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19AD1920)
#define CLASS_1_5B567C8A01BAEDFE_361_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19AD1660)
#define CLASS_1_5B567C8A01BAEDFE_361_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19AD16C0)
#define CLASS_1_5B567C8A01BAEDFE_361_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19AD1890)
#define CLASS_1_5B567C8A01BAEDFE_361_WRITETO_OFFSET UNITYSDK_OFFSET(0x19AD18F0)
#define CLASS_1_5B567C8A01BAEDFE_361__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AD19A0)
#define CLASS_1_5B567C8A01BAEDFE_361__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19AD16E0)
#define CLASS_1_5B567C8A01BAEDFE_361__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD16D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_361_TypeDefinitionIndex = 32652;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_361*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_361_TypeDefinitionIndex)->GetStaticField(0x5BC70);
	}
