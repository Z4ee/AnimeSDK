...
#define CLASS_1_C3A033C60E10FDC7_CLEAR_OFFSET UNITYSDK_OFFSET(0x1615EDF0)
#define CLASS_1_C3A033C60E10FDC7__CTOR_OFFSET UNITYSDK_OFFSET(0x1615EE40)

inline static constexpr unsigned int Class_1_C3A033C60E10FDC7_TypeDefinitionIndex = 66403;

class Class_1_C3A033C60E10FDC7 : public ::System::Object
{
public:
	::RPG::GameCore::VCameraNoiseChange* Field_1_0; // 0x10
	::RPG::GameCore::VCameraBlend* Field_1_1; // 0x18
