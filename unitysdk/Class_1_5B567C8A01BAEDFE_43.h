...
#define CLASS_1_5B567C8A01BAEDFE_43_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C76A6A0)
#define CLASS_1_5B567C8A01BAEDFE_43_CLONE_OFFSET UNITYSDK_OFFSET(0x1C76A390)
#define CLASS_1_5B567C8A01BAEDFE_43_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C76A4A0)
#define CLASS_1_5B567C8A01BAEDFE_43_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C76A3D0)
#define CLASS_1_5B567C8A01BAEDFE_43_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C76A600)
#define CLASS_1_5B567C8A01BAEDFE_43_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C76A6F0)
#define CLASS_1_5B567C8A01BAEDFE_43_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C76A6C0)
#define CLASS_1_5B567C8A01BAEDFE_43_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C76A310)
#define CLASS_1_5B567C8A01BAEDFE_43_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C76A340)
#define CLASS_1_5B567C8A01BAEDFE_43_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C76A630)
#define CLASS_1_5B567C8A01BAEDFE_43_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C76A690)
#define CLASS_1_5B567C8A01BAEDFE_43__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C76A740)
#define CLASS_1_5B567C8A01BAEDFE_43__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C76A360)
#define CLASS_1_5B567C8A01BAEDFE_43__CTOR_OFFSET UNITYSDK_OFFSET(0x1C76A350)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_43_TypeDefinitionIndex = 25740;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_43*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_43_TypeDefinitionIndex)->GetStaticField(0x56580);
	}
