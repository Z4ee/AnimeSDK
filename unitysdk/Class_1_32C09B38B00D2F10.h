...
#define CLASS_1_32C09B38B00D2F10_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x163B41B0)
#define CLASS_1_32C09B38B00D2F10__CTOR_OFFSET UNITYSDK_OFFSET(0x163B4200)
...
{
public:
	::RPG::GameCore::AssistWayPoint* JIAPCOBPBHO; // 0x10
	::RPG::GameCore::AssistWayPoint* NDLEBNGAIFH; // 0x18
	::System::Boolean KHGJLFPNJAJ; // 0x20
	::System::Boolean GBDHIOOJNBE; // 0x21
	::System::Boolean OMEENINDLFC; // 0x22
