...
#define CLASS_2_01E36AFA5FDDCBCA_METHOD_2_10633FB61A0D692F_OFFSET UNITYSDK_OFFSET(0x163F20B0)
#define CLASS_2_01E36AFA5FDDCBCA_METHOD_2_6F8D0E1AE17C99D8_OFFSET UNITYSDK_OFFSET(0x163F2290)
#define CLASS_2_01E36AFA5FDDCBCA__CTOR_OFFSET UNITYSDK_OFFSET(0x163F2320)
#define CLASS_2_01E36AFA5FDDCBCA__ONBIND_OFFSET UNITYSDK_OFFSET(0x163F1EB0)

inline static constexpr unsigned int Class_2_01E36AFA5FDDCBCA_TypeDefinitionIndex = 72200;

class Class_2_01E36AFA5FDDCBCA : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* JFCMCPFPDFP; // 0x0
	::UnityEngine::Transform* EHHMNHMEFEB; // 0x60
	::UnityEngine::Transform* IILLJBCGOOJ; // 0x68
	::UnityEngine::Transform* PBAMNMKPJIN; // 0x70
	::UnityEngine::Transform* MGKMPLIICNA; // 0x78
