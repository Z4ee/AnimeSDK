...
#define CLASS_1_1ACE0263147688BB_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x11B80620)
#define CLASS_1_1ACE0263147688BB_METHOD_1_31FFEEDCDA06DC9B_OFFSET UNITYSDK_OFFSET(0x11B80720)
#define CLASS_1_1ACE0263147688BB_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x11B80450)
#define CLASS_1_1ACE0263147688BB_METHOD_1_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x11B80A30)
#define CLASS_1_1ACE0263147688BB_METHOD_1_54757B8B62FBF467_OFFSET UNITYSDK_OFFSET(0x11B80C40)
#define CLASS_1_1ACE0263147688BB_METHOD_1_54C8654A7A9113B5_OFFSET UNITYSDK_OFFSET(0x11B80300)
#define CLASS_1_1ACE0263147688BB_METHOD_1_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x11B80510)
#define CLASS_1_1ACE0263147688BB_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11B80B30)
#define CLASS_1_1ACE0263147688BB_METHOD_1_CAFA167EB82E09FC_OFFSET UNITYSDK_OFFSET(0x11B80B80)
#define CLASS_1_1ACE0263147688BB_METHOD_1_CED7A2E9A352C6FD_OFFSET UNITYSDK_OFFSET(0x11B80680)
#define CLASS_1_1ACE0263147688BB_METHOD_1_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0x11B809D0)
#define CLASS_1_1ACE0263147688BB__CTOR_OFFSET UNITYSDK_OFFSET(0x11B802C0)

inline static constexpr unsigned int Class_1_1ACE0263147688BB_TypeDefinitionIndex = 78507;

class Class_1_1ACE0263147688BB : public ::System::Object
{
public:
	::UnityEngine::GameObject* GNGICBBHKEJ; // 0x10
	::UnityEngine::Transform* KMBHJOPDEJK; // 0x18
	::UnityEngine::Collider* GBDKBLPAHEL; // 0x20
	::RPG::Client::Prop::CoilPuzzle::RigCoilPuzzleBoard* MIPPNCGOJNM; // 0x28
	::UnityEngine::Vector3 GNPBGAKIAHM; // 0x30
	::System::Boolean FMNEEONAMNO; // 0x3C
	::UnityEngine::Vector3 KNGEKPKBIDK; // 0x40
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_1ACE0263147688BB_METHOD_1_CA373AA1C7054598_OFFSET))(this);
	}
