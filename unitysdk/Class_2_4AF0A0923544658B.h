...
#define CLASS_2_4AF0A0923544658B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA54E870)
#define CLASS_2_4AF0A0923544658B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA54E8C0)
#define CLASS_2_4AF0A0923544658B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA54EA20)
#define CLASS_2_4AF0A0923544658B_TICK_OFFSET UNITYSDK_OFFSET(0xA54EA70)
#define CLASS_2_4AF0A0923544658B__CTOR_OFFSET UNITYSDK_OFFSET(0xA54E860)

inline static constexpr unsigned int Class_2_4AF0A0923544658B_TypeDefinitionIndex = 50619;

class Class_2_4AF0A0923544658B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::BlinkToPosition* Field_2_0; // 0x20
