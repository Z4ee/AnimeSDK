...
#define CLASS_2_4AF0A0923544658B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8845490)
#define CLASS_2_4AF0A0923544658B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x88454E0)
#define CLASS_2_4AF0A0923544658B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8845640)
#define CLASS_2_4AF0A0923544658B_TICK_OFFSET UNITYSDK_OFFSET(0x8845690)
#define CLASS_2_4AF0A0923544658B__CTOR_OFFSET UNITYSDK_OFFSET(0x8845480)

inline static constexpr unsigned int Class_2_4AF0A0923544658B_TypeDefinitionIndex = 43919;

class Class_2_4AF0A0923544658B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::BlinkToPosition* Field_2_0; // 0x18
