...
#define CLASS_2_4AF0A0923544658B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16925810)
#define CLASS_2_4AF0A0923544658B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16925860)
#define CLASS_2_4AF0A0923544658B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16925A40)
#define CLASS_2_4AF0A0923544658B_TICK_OFFSET UNITYSDK_OFFSET(0x16925A90)
#define CLASS_2_4AF0A0923544658B__CTOR_OFFSET UNITYSDK_OFFSET(0x16925800)

inline static constexpr unsigned int Class_2_4AF0A0923544658B_TypeDefinitionIndex = 55088;

class Class_2_4AF0A0923544658B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::BlinkToPosition* OFKGLJOAMLD; // 0x18
