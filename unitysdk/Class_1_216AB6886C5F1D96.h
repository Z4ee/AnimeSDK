...
#define CLASS_1_216AB6886C5F1D96__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA3640)
...
{
public:
	::System::Int32 JDILJDFJBMM; // 0x10
	::System::Int32 CJCCLNEDGKB; // 0x14
	::System::Single AHHLEOHHJLB; // 0x18
	::RPG::GameCore::OnHitAnimType GMPGDEINODK; // 0x1C
