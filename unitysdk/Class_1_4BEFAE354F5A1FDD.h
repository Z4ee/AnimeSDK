...
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x1CB37100)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_1B6BA7F4584859AD_OFFSET UNITYSDK_OFFSET(0x1CB36CE0)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_4B841B25749ECDB2_OFFSET UNITYSDK_OFFSET(0x1CB36B70)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_66D0710E1E8CB9BD_OFFSET UNITYSDK_OFFSET(0x1CB36860)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1CB36F30)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x1CB36FC0)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_B75EBCAF2DDD8E9B_OFFSET UNITYSDK_OFFSET(0x1CB37150)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x1CB36B10)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x1CB368E0)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x1CB36EF0)
#define CLASS_1_4BEFAE354F5A1FDD_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x1CB37060)
#define CLASS_1_4BEFAE354F5A1FDD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB37520)

inline static constexpr unsigned int Class_1_4BEFAE354F5A1FDD_TypeDefinitionIndex = 13421;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4BEFAE354F5A1FDD_TypeDefinitionIndex)->GetStaticField(0x572C0);
	}
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::GridFightBackendRoleEquipmentConfigRow*>** StaticGet_EHNHPCGDOIO()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::GridFightBackendRoleEquipmentConfigRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4BEFAE354F5A1FDD_TypeDefinitionIndex)->GetStaticField(0x572C8);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_MPCODIGIBGL()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4BEFAE354F5A1FDD_TypeDefinitionIndex)->GetStaticField(0x572D0);
	}
	static ::System::Boolean* StaticGet_AHBLLGCADBB()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4BEFAE354F5A1FDD_TypeDefinitionIndex)->GetStaticField(0x124C0);
	}
	static ::System::Byte* StaticGet_GDMLAIBCKIP()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4BEFAE354F5A1FDD_TypeDefinitionIndex)->GetStaticField(0x124C1);
	}
