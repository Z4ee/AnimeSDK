...
#define PUSHBOXTILEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0E3B50)
#define PUSHBOXTILEVIEW_GETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1A0E4350)
#define PUSHBOXTILEVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A0E4A90)
#define PUSHBOXTILEVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A0E4920)
#define PUSHBOXTILEVIEW_INIT_OFFSET UNITYSDK_OFFSET(0x1A0E3FA0)
#define PUSHBOXTILEVIEW_PLAYFRONTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A0E3D40)
#define PUSHBOXTILEVIEW_PLAYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A0E4610)
#define PUSHBOXTILEVIEW_REFRESHBYSERVERINFO_OFFSET UNITYSDK_OFFSET(0x1A0E43F0)
#define PUSHBOXTILEVIEW_SETHIDDEN_OFFSET UNITYSDK_OFFSET(0x1A0E3BB0)
#define PUSHBOXTILEVIEW_SETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1A0E42C0)
#define PUSHBOXTILEVIEW_SHOWREALTILE_OFFSET UNITYSDK_OFFSET(0x1A0E3EF0)
#define PUSHBOXTILEVIEW_SHOWRESETFRAME_OFFSET UNITYSDK_OFFSET(0x1A0E3CA0)
#define PUSHBOXTILEVIEW_SHOWWHITE_OFFSET UNITYSDK_OFFSET(0x1A0E3C10)
#define PUSHBOXTILEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0E47C0)
#define PUSHBOXTILEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E4C00)

inline static constexpr unsigned int PushBoxTileView_TypeDefinitionIndex = 83268;
