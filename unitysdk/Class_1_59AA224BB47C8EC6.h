...
#define CLASS_1_59AA224BB47C8EC6_ADD_EXITREQUESTED_OFFSET UNITYSDK_OFFSET(0xB86A870)
#define CLASS_1_59AA224BB47C8EC6_GET_CONTACTS_OFFSET UNITYSDK_OFFSET(0xB86A370)
#define CLASS_1_59AA224BB47C8EC6_GET_FIRSTONLINECONTACT_OFFSET UNITYSDK_OFFSET(0xB868F70)
#define CLASS_1_59AA224BB47C8EC6_GET_ISPAMCHATENABLED_OFFSET UNITYSDK_OFFSET(0xB86A340)
#define CLASS_1_59AA224BB47C8EC6_GET_ISPAMCHATLLMENABLED_OFFSET UNITYSDK_OFFSET(0xB86A350)
#define CLASS_1_59AA224BB47C8EC6_GET_ISPAMSELECTED_OFFSET UNITYSDK_OFFSET(0xB86A3A0)
#define CLASS_1_59AA224BB47C8EC6_GET_ISSENDPANELVISIBLE_OFFSET UNITYSDK_OFFSET(0xB86A3D0)
#define CLASS_1_59AA224BB47C8EC6_GET_SELECTEDCONTACT_OFFSET UNITYSDK_OFFSET(0xB868F80)
#define CLASS_1_59AA224BB47C8EC6_GET_SELECTEDTABINDEX_OFFSET UNITYSDK_OFFSET(0xB86A380)
#define CLASS_1_59AA224BB47C8EC6_GET_SELECTEDTAB_OFFSET UNITYSDK_OFFSET(0xB86A390)
#define CLASS_1_59AA224BB47C8EC6_GET_SUBTITLETEXTID_OFFSET UNITYSDK_OFFSET(0xB86A3B0)
#define CLASS_1_59AA224BB47C8EC6_GET_TABS_OFFSET UNITYSDK_OFFSET(0xB86A360)
#define CLASS_1_59AA224BB47C8EC6_GET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0xB86A3C0)
#define CLASS_1_59AA224BB47C8EC6_GET_UISTATENAME_OFFSET UNITYSDK_OFFSET(0xB86A3E0)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_8AE653474AE4DD46_OFFSET UNITYSDK_OFFSET(0xB868D80)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_8B5BF39581014B56_OFFSET UNITYSDK_OFFSET(0xB86A4B0)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_8E9E3E0D1D6E6E24_OFFSET UNITYSDK_OFFSET(0xB868A10)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_B213056103887067_1_OFFSET UNITYSDK_OFFSET(0xB86A570)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_B213056103887067_2_OFFSET UNITYSDK_OFFSET(0xB86A630)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_B213056103887067_3_OFFSET UNITYSDK_OFFSET(0xB86A6F0)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_B213056103887067_4_OFFSET UNITYSDK_OFFSET(0xB86A7B0)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_B213056103887067_OFFSET UNITYSDK_OFFSET(0xB86A3F0)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_CFE6FB160FFF5938_1_OFFSET UNITYSDK_OFFSET(0xB868F90)
#define CLASS_1_59AA224BB47C8EC6_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0xB868DC0)
#define CLASS_1_59AA224BB47C8EC6_REMOVE_EXITREQUESTED_OFFSET UNITYSDK_OFFSET(0xB86A8E0)
#define CLASS_1_59AA224BB47C8EC6__CTOR_OFFSET UNITYSDK_OFFSET(0xB8692A0)
#define CLASS_1_59AA224BB47C8EC6__GET_ONEXITCOMMAND_B__55_0_OFFSET UNITYSDK_OFFSET(0xB86AD10)
#define CLASS_1_59AA224BB47C8EC6__GET_ONNEXTTABCOMMAND_B__52_0_OFFSET UNITYSDK_OFFSET(0xB86AB30)
#define CLASS_1_59AA224BB47C8EC6__GET_ONPREVIOUSTABCOMMAND_B__49_0_OFFSET UNITYSDK_OFFSET(0xB86A950)
#define CLASS_1_59AA224BB47C8EC6__GET_REMOVELASTCONTACTCOMMAND_B__64_0_OFFSET UNITYSDK_OFFSET(0xB86AF30)
#define CLASS_1_59AA224BB47C8EC6__GET_RENAMEFIRSTCONTACTCOMMAND_B__58_0_OFFSET UNITYSDK_OFFSET(0xB86AD30)

inline static constexpr unsigned int Class_1_59AA224BB47C8EC6_TypeDefinitionIndex = 73347;

class Class_1_59AA224BB47C8EC6 : public ::System::Object
{
public:
	::R3::ReactiveProperty_1<::System::Int32>* _SelectedTabIndex_k__BackingField; // 0x10
	::R3::ReactiveProperty_1<::RPG::Client::Ui::Samples::FriendChatTabViewModel*>* _SelectedTab_k__BackingField; // 0x18
	::R3::ReactiveProperty_1<::RPG::Client::Ui::Samples::FriendChatContactVM*>* _SelectedContact_k__BackingField; // 0x20
	::Class_1_BF01A723AB4005C0<::System::Int32>* LPEGKFBPJOI; // 0x28
	::Sofa::Core::SimpleCommand* PHAKDIJILEK; // 0x30
	::Sofa::Core::SimpleCommand* FJAHLMCIIJM; // 0x38
	::R3::ReactiveProperty_1<::RPG::Client::Ui::Samples::FriendChatContactVM*>* _FirstOnlineContact_k__BackingField; // 0x40
	::Sofa::Core::SimpleCommand* BJLGNMENHAA; // 0x48
	::R3::Observable_1<::System::Boolean>* _IsSendPanelVisible_k__BackingField; // 0x50
	::R3::Observable_1<::System::Boolean>* _IsPamSelected_k__BackingField; // 0x58
	::Sofa::Core::SimpleCommand* GFFLPAOPOHA; // 0x60
	::R3::Subject_1<::System::Int32>* DKKGMPPEGNI; // 0x68
	::ObservableCollections::ObservableList_1<::RPG::Client::Ui::Samples::FriendChatContactVM*>* _Contacts_k__BackingField; // 0x70
	::System::Collections::Generic::List_1<::System::String*>* CJMFBDCOJGK; // 0x78
	::ObservableCollections::ObservableList_1<::RPG::Client::Ui::Samples::FriendChatTabViewModel*>* _Tabs_k__BackingField; // 0x80
	::Sofa::Core::SimpleCommand* LJGHCLANIEB; // 0x88
	::R3::ReactiveProperty_1<::System::String*>* _UiStateName_k__BackingField; // 0x90
	::R3::Observable_1<::System::String*>* _TitleText_k__BackingField; // 0x98
	::R3::Observable_1<::System::String*>* _SubTitleTextID_k__BackingField; // 0xA0
