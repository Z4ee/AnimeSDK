...
#define CLASS_3_C7C568476C40FF8F_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x105DF070)
#define CLASS_3_C7C568476C40FF8F_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x105DF0D0)
#define CLASS_3_C7C568476C40FF8F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105DEFD0)
#define CLASS_3_C7C568476C40FF8F__CTOR_OFFSET UNITYSDK_OFFSET(0x105DEFA0)

inline static constexpr unsigned int Class_3_C7C568476C40FF8F_TypeDefinitionIndex = 58545;
