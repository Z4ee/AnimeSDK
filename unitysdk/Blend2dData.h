...
#define BLEND2DDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x10E91C50)
#define BLEND2DDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x10E90760)
#define BLEND2DDATA_FROMJSON_OFFSET UNITYSDK_OFFSET(0x10E90800)
#define BLEND2DDATA_TOBINARY_OFFSET UNITYSDK_OFFSET(0x10E91CE0)
#define BLEND2DDATA_TOJSON_OFFSET UNITYSDK_OFFSET(0x10E91BD0)
#define BLEND2DDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10E91D70)

inline static constexpr unsigned int Blend2dData_TypeDefinitionIndex = 54627;
