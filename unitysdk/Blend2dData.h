...
#define BLEND2DDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175A3E80)
#define BLEND2DDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x175A2990)
#define BLEND2DDATA_FROMJSON_OFFSET UNITYSDK_OFFSET(0x175A2A30)
#define BLEND2DDATA_TOBINARY_OFFSET UNITYSDK_OFFSET(0x175A3F10)
#define BLEND2DDATA_TOJSON_OFFSET UNITYSDK_OFFSET(0x175A3E00)
#define BLEND2DDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x175A3FA0)

inline static constexpr unsigned int Blend2dData_TypeDefinitionIndex = 55092;
