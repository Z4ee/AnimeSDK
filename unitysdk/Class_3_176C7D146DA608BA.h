...
#define CLASS_3_176C7D146DA608BA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17A9C970)
#define CLASS_3_176C7D146DA608BA__CTOR_OFFSET UNITYSDK_OFFSET(0x17A9C940)

inline static constexpr unsigned int Class_3_176C7D146DA608BA_TypeDefinitionIndex = 55972;
