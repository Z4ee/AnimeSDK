...
#define BABYHIPPLENCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC153BE0)
#define BABYHIPPLENCONTROLLER_ENABLENECKIK_OFFSET UNITYSDK_OFFSET(0xC153B90)
#define BABYHIPPLENCONTROLLER_GETHEADTRANS_OFFSET UNITYSDK_OFFSET(0xC153680)
#define BABYHIPPLENCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC153EF0)
#define BABYHIPPLENCONTROLLER_METHOD_5_0BA114B592B3A582_OFFSET UNITYSDK_OFFSET(0xC154B90)
#define BABYHIPPLENCONTROLLER_METHOD_5_491027A35182E1D6_OFFSET UNITYSDK_OFFSET(0xC153AD0)
#define BABYHIPPLENCONTROLLER_METHOD_5_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0xC153A30)
#define BABYHIPPLENCONTROLLER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xC1539B0)
#define BABYHIPPLENCONTROLLER_METHOD_5_6A6A96FBD090C99D_OFFSET UNITYSDK_OFFSET(0xC154020)
#define BABYHIPPLENCONTROLLER_METHOD_5_DE4BD3007909A465_OFFSET UNITYSDK_OFFSET(0xC155CE0)
#define BABYHIPPLENCONTROLLER_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC155920)
#define BABYHIPPLENCONTROLLER_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0xC153FB0)
#define BABYHIPPLENCONTROLLER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xC155DB0)
#define BABYHIPPLENCONTROLLER_PLAYANIMSEQ_OFFSET UNITYSDK_OFFSET(0xC1537E0)
#define BABYHIPPLENCONTROLLER_RISEHEADFORSECONDS_OFFSET UNITYSDK_OFFSET(0xC153740)
#define BABYHIPPLENCONTROLLER_SETATTENTIONTRANS_OFFSET UNITYSDK_OFFSET(0xC1536C0)
#define BABYHIPPLENCONTROLLER_STARTPETTING_OFFSET UNITYSDK_OFFSET(0xC155EA0)
#define BABYHIPPLENCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xC153CC0)
#define BABYHIPPLENCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC153E20)
#define BABYHIPPLENCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1562C0)
