...
#define STRUCT_2_8F6F975610E51F6E__CTOR_OFFSET UNITYSDK_OFFSET(0x6AAA90)

inline static constexpr unsigned int Struct_2_8F6F975610E51F6E_TypeDefinitionIndex = 77224;

struct alignas(4) Struct_2_8F6F975610E51F6E
{
	::MoleMole::ConfigCameraPosType Field_2_2; // 0x10
	::UnityEngine::Vector3 Field_2_1; // 0x14
	::UnityEngine::Quaternion Field_2_0; // 0x20
	::System::Int32 Field_2_7; // 0x30
	::Cinemachine::LensSettings Field_2_6; // 0x34
