...
#define UNITYCHAN_SPRINGMANAGER_SPRINGBONECLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x104FD940)

namespace UnityChan
{
	inline static constexpr unsigned int SpringManager_SpringBoneClass_TypeDefinitionIndex = 48157;
