...
#define UNITYCHAN_SPRINGBONE_AWAKE_OFFSET UNITYSDK_OFFSET(0xAC2A160)
#define UNITYCHAN_SPRINGBONE_GET_CURRTIPPOS_OFFSET UNITYSDK_OFFSET(0xAC2A3F0)
#define UNITYCHAN_SPRINGBONE_GET_CUSTOMCHILDPOS_OFFSET UNITYSDK_OFFSET(0xAC2A440)
#define UNITYCHAN_SPRINGBONE_GET_PREVTIPPOS_OFFSET UNITYSDK_OFFSET(0xAC2A410)
#define UNITYCHAN_SPRINGBONE_GET_SPRINGLENGTH_OFFSET UNITYSDK_OFFSET(0xAC2A430)
#define UNITYCHAN_SPRINGBONE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xAC2A460)
#define UNITYCHAN_SPRINGBONE_METHOD_5_B4952912C3FBCEAE_OFFSET UNITYSDK_OFFSET(0xAC2A150)
#define UNITYCHAN_SPRINGBONE_METHOD_5_D1AA082DEC215AEF_OFFSET UNITYSDK_OFFSET(0xAC2BC60)
#define UNITYCHAN_SPRINGBONE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xAC2BBE0)
#define UNITYCHAN_SPRINGBONE_PREUPDATESPRING_OFFSET UNITYSDK_OFFSET(0xAC2A560)
#define UNITYCHAN_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xAC2A640)
#define UNITYCHAN_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC2BCE0)

namespace UnityChan
{
	inline static constexpr unsigned int SpringBone_TypeDefinitionIndex = 38541;
	...
	public:
		...
		::UnityEngine::Transform* Field_5_16; // 0x80
		::UnityEngine::Vector3 Field_5_17; // 0x88
		::UnityEngine::Vector3 Field_5_18; // 0x94
		::UnityEngine::Quaternion Field_5_19; // 0xA0
		...
		::System::Void Method_5_B4952912C3FBCEAE()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + UNITYCHAN_SPRINGBONE_METHOD_5_B4952912C3FBCEAE_OFFSET))(this);
		}
