...
#define UNITYCHAN_SPRINGBONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1052B510)
#define UNITYCHAN_SPRINGBONE_GET_CURRTIPPOS_OFFSET UNITYSDK_OFFSET(0x1052B7A0)
#define UNITYCHAN_SPRINGBONE_GET_CUSTOMCHILDPOS_OFFSET UNITYSDK_OFFSET(0x1052B7F0)
#define UNITYCHAN_SPRINGBONE_GET_PREVTIPPOS_OFFSET UNITYSDK_OFFSET(0x1052B7C0)
#define UNITYCHAN_SPRINGBONE_GET_SPRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1052B7E0)
#define UNITYCHAN_SPRINGBONE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1052B810)
#define UNITYCHAN_SPRINGBONE_METHOD_5_D1AA082DEC215AEF_OFFSET UNITYSDK_OFFSET(0x1052CF70)
#define UNITYCHAN_SPRINGBONE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1052CEF0)
#define UNITYCHAN_SPRINGBONE_PREUPDATESPRING_OFFSET UNITYSDK_OFFSET(0x1052B910)
#define UNITYCHAN_SPRINGBONE_RESETSPRINGBONEDATA_OFFSET UNITYSDK_OFFSET(0x1052B500)
#define UNITYCHAN_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0x1052B9F0)
#define UNITYCHAN_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1052CFF0)

namespace UnityChan
{
	inline static constexpr unsigned int SpringBone_TypeDefinitionIndex = 45887;
