...
#define UNITYCHAN_SPRINGBONE_AWAKE_OFFSET UNITYSDK_OFFSET(0xB9A0E90)
#define UNITYCHAN_SPRINGBONE_GET_CURRTIPPOS_OFFSET UNITYSDK_OFFSET(0xB9A1120)
#define UNITYCHAN_SPRINGBONE_GET_CUSTOMCHILDPOS_OFFSET UNITYSDK_OFFSET(0xB9A1170)
#define UNITYCHAN_SPRINGBONE_GET_PREVTIPPOS_OFFSET UNITYSDK_OFFSET(0xB9A1140)
#define UNITYCHAN_SPRINGBONE_GET_SPRINGLENGTH_OFFSET UNITYSDK_OFFSET(0xB9A1160)
#define UNITYCHAN_SPRINGBONE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xB9A1190)
#define UNITYCHAN_SPRINGBONE_METHOD_5_D1AA082DEC215AEF_OFFSET UNITYSDK_OFFSET(0xB9A2970)
#define UNITYCHAN_SPRINGBONE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xB9A28F0)
#define UNITYCHAN_SPRINGBONE_PREUPDATESPRING_OFFSET UNITYSDK_OFFSET(0xB9A1290)
#define UNITYCHAN_SPRINGBONE_RESETSPRINGBONEDATA_OFFSET UNITYSDK_OFFSET(0xB9A0E80)
#define UNITYCHAN_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xB9A1370)
#define UNITYCHAN_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A29F0)

namespace UnityChan
{
	inline static constexpr unsigned int SpringBone_TypeDefinitionIndex = 44423;
