...
#define UNITYCHAN_SPRINGCOLLIDER_METHOD_5_FCCE5510573026EA_OFFSET UNITYSDK_OFFSET(0xD0EA280)
#define UNITYCHAN_SPRINGCOLLIDER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xD0EACB0)
#define UNITYCHAN_SPRINGCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0EAF70)

namespace UnityChan
{
	inline static constexpr unsigned int SpringCollider_TypeDefinitionIndex = 44971;
