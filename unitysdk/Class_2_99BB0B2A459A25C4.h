...
#define CLASS_2_99BB0B2A459A25C4_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0xB416E20)
#define CLASS_2_99BB0B2A459A25C4_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0xB416E70)
#define CLASS_2_99BB0B2A459A25C4_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0xB416EF0)
#define CLASS_2_99BB0B2A459A25C4_GETRECT_OFFSET UNITYSDK_OFFSET(0xB416F70)
#define CLASS_2_99BB0B2A459A25C4_GET_GROUPINFO_OFFSET UNITYSDK_OFFSET(0xB4170F0)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_5F8005963FD8C985_OFFSET UNITYSDK_OFFSET(0xB416FD0)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_72CFCD74ED0E448D_OFFSET UNITYSDK_OFFSET(0xB417200)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_B168DD36E5A49BB4_OFFSET UNITYSDK_OFFSET(0xB417110)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0xB4171A0)
#define CLASS_2_99BB0B2A459A25C4_SET_GROUPINFO_OFFSET UNITYSDK_OFFSET(0xB417100)
#define CLASS_2_99BB0B2A459A25C4__CTOR_OFFSET UNITYSDK_OFFSET(0xB416AA0)

inline static constexpr unsigned int Class_2_99BB0B2A459A25C4_TypeDefinitionIndex = 73693;
...
public:
	...
	::System::UInt32 LLDCHLHNADA; // 0xC8
	::UnityEngine::Rect JAKMENOCECF; // 0xCC
	::System::Single KGMFNLGJOHO; // 0xDC
	::UnityEngine::Bounds PDCCCBKGHNL; // 0xE0
