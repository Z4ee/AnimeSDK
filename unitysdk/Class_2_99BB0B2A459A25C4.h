...
#define CLASS_2_99BB0B2A459A25C4_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x8FD97B0)
#define CLASS_2_99BB0B2A459A25C4_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0x8FD9800)
#define CLASS_2_99BB0B2A459A25C4_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0x8FD9880)
#define CLASS_2_99BB0B2A459A25C4_GETRECT_OFFSET UNITYSDK_OFFSET(0x8FD9900)
#define CLASS_2_99BB0B2A459A25C4_GET_GROUPINFO_OFFSET UNITYSDK_OFFSET(0x8FD9A80)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_5F8005963FD8C985_OFFSET UNITYSDK_OFFSET(0x8FD9960)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_6BFD1AD809E415D7_OFFSET UNITYSDK_OFFSET(0x8FD9AA0)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_72CFCD74ED0E448D_OFFSET UNITYSDK_OFFSET(0x8FD9B70)
#define CLASS_2_99BB0B2A459A25C4_METHOD_2_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x8FD9B10)
#define CLASS_2_99BB0B2A459A25C4_SET_GROUPINFO_OFFSET UNITYSDK_OFFSET(0x8FD9A90)
#define CLASS_2_99BB0B2A459A25C4__CTOR_OFFSET UNITYSDK_OFFSET(0x8FD9430)

inline static constexpr unsigned int Class_2_99BB0B2A459A25C4_TypeDefinitionIndex = 60500;

class Class_2_99BB0B2A459A25C4 : public ::RPG::Client::OpenWorld::StreamingItemData
{
public:
	// static const ::System::Boolean Field_2_0; // 0x0
	::Class_1_0DC54D6E576BF484* Field_2_4; // 0xA0
	::RPG::GameCore::RuntimeGroupInfo* _GroupInfo_k__BackingField; // 0xA8
	::UnityEngine::Bounds Field_2_2; // 0xB0
	::System::UInt32 Field_2_5; // 0xC8
	::System::Single Field_2_1; // 0xCC
	::UnityEngine::Rect Field_2_3; // 0xD0
