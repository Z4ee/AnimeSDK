...
#define CLASS_2_A7B769B7A1A5FACD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1798A760)
#define CLASS_2_A7B769B7A1A5FACD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1798A7A0)
#define CLASS_2_A7B769B7A1A5FACD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1798A900)
#define CLASS_2_A7B769B7A1A5FACD_TICK_OFFSET UNITYSDK_OFFSET(0x1798A950)
#define CLASS_2_A7B769B7A1A5FACD__CTOR_OFFSET UNITYSDK_OFFSET(0x1798A750)

inline static constexpr unsigned int Class_2_A7B769B7A1A5FACD_TypeDefinitionIndex = 50767;

class Class_2_A7B769B7A1A5FACD : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::QteCatchGhostSendNotify* Field_2_0; // 0x18
