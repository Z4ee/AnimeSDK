...
#define CLASS_2_A7B769B7A1A5FACD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15941900)
#define CLASS_2_A7B769B7A1A5FACD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15941940)
#define CLASS_2_A7B769B7A1A5FACD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15941AA0)
#define CLASS_2_A7B769B7A1A5FACD_TICK_OFFSET UNITYSDK_OFFSET(0x15941AF0)
#define CLASS_2_A7B769B7A1A5FACD__CTOR_OFFSET UNITYSDK_OFFSET(0x159418F0)
