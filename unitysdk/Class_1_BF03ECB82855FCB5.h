...
#define CLASS_1_BF03ECB82855FCB5_METHOD_1_1D2BD77962F12ABD_OFFSET UNITYSDK_OFFSET(0x188CE9E0)
#define CLASS_1_BF03ECB82855FCB5_METHOD_1_DF1A63E59EE6C532_OFFSET UNITYSDK_OFFSET(0x188CE910)
#define CLASS_1_BF03ECB82855FCB5__CCTOR_OFFSET UNITYSDK_OFFSET(0x188CEA80)
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::RuntimeTypeHandle, ::Struct_2_698098A743D71086>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BF03ECB82855FCB5_TypeDefinitionIndex)->GetStaticField(0x2BE0);
	}
	static ::System::Int32* StaticGet_ENOKMMBIHKP()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_BF03ECB82855FCB5_TypeDefinitionIndex)->GetStaticField(0xFC0);
	}
