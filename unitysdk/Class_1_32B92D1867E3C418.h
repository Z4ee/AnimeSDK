...
#define CLASS_1_32B92D1867E3C418_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C578590)
#define CLASS_1_32B92D1867E3C418_METHOD_1_17AABD2931A13657_OFFSET UNITYSDK_OFFSET(0x1C578330)
#define CLASS_1_32B92D1867E3C418_METHOD_1_18718D3F1E94D72C_OFFSET UNITYSDK_OFFSET(0x1C5782D0)
#define CLASS_1_32B92D1867E3C418_METHOD_1_47992F195E01AA10_OFFSET UNITYSDK_OFFSET(0x1C5783B0)
#define CLASS_1_32B92D1867E3C418_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x1C578260)
#define CLASS_1_32B92D1867E3C418_METHOD_1_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0x1C578520)
#define CLASS_1_32B92D1867E3C418_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x1C5784B0)
#define CLASS_1_32B92D1867E3C418_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1C578440)
#define CLASS_1_32B92D1867E3C418__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5785F0)

inline static constexpr unsigned int Class_1_32B92D1867E3C418_TypeDefinitionIndex = 40515;

class Class_1_32B92D1867E3C418 : public ::System::Object
{
public:
	::RPG::GameCore::ElfSpecialEventConfig* GFDMIMMOMFI; // 0x10
	::System::Int32 NBMAGDOJDFD; // 0x18
	::System::UInt32 LJHMJMMKHMB; // 0x1C
	::System::UInt32 MKGEGDICAJO; // 0x20
	::System::UInt32 NMBKAIEIAPE; // 0x24
	::System::Boolean AEAJOFDIPCJ; // 0x28
