...
#define CLASS_2_2E9294067799BBD7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15B08450)
#define CLASS_2_2E9294067799BBD7_METHOD_2_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x15B07360)
#define CLASS_2_2E9294067799BBD7_METHOD_2_155EBEDB7DB8B929_OFFSET UNITYSDK_OFFSET(0x15B08850)
#define CLASS_2_2E9294067799BBD7_METHOD_2_19B14977ABA39612_OFFSET UNITYSDK_OFFSET(0x15B073B0)
#define CLASS_2_2E9294067799BBD7_METHOD_2_2AEC92CC1DC59B8B_OFFSET UNITYSDK_OFFSET(0x15B072F0)
#define CLASS_2_2E9294067799BBD7_METHOD_2_3FA1D91279A7F0C8_OFFSET UNITYSDK_OFFSET(0x15B08950)
#define CLASS_2_2E9294067799BBD7_METHOD_2_6FCD5ED083C67CF0_OFFSET UNITYSDK_OFFSET(0x15B087B0)
#define CLASS_2_2E9294067799BBD7_METHOD_2_7EAA8879197594BA_OFFSET UNITYSDK_OFFSET(0x15B07F20)
#define CLASS_2_2E9294067799BBD7_METHOD_2_BA00D508D791624D_OFFSET UNITYSDK_OFFSET(0x15B08710)
#define CLASS_2_2E9294067799BBD7_METHOD_2_DB4D7D07EC5D0482_OFFSET UNITYSDK_OFFSET(0x15B086B0)
#define CLASS_2_2E9294067799BBD7__CTOR_OFFSET UNITYSDK_OFFSET(0x15B08A50)
...
{
public:
	::UnityEngine::Texture2D* FIHHFOKOMPJ; // 0x18
	::System::String* EEGNPMNAFFH; // 0x20
	::Il2CppArray<::UnityEngine::Vector2>* CMGDDDMAHJN; // 0x28
	::System::Single CNACJMMOFNL; // 0x30
	::System::Nullable_1<::UnityEngine::Vector2> CMKEKJKNIKE; // 0x34
	::System::Single CMBLMGDPAFN; // 0x40
	::System::Nullable_1<::System::Single> BFHMKJJCKKG; // 0x44
	::System::Nullable_1<::UnityEngine::Color> NFAOFJMMFIA; // 0x4C
	::System::Boolean FJMFKJEIOIO; // 0x60
	::System::Nullable_1<::System::Boolean> JGMGCPNCLPC; // 0x61
	::System::Nullable_1<::UnityEngine::Vector2> CFJAJIHFMIH; // 0x64
	::System::Single AOLGEMLDKAE; // 0x70
	::System::Single MIJAKIMPCGJ; // 0x74
