...
#define AKTIMELINERTPCPLAYABLE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D2D1AB0)
#define AKTIMELINERTPCPLAYABLE_GET_OWNINGCLIP_OFFSET UNITYSDK_OFFSET(0x1D2D1A80)
#define AKTIMELINERTPCPLAYABLE_SETUPCLIPDISPLAY_OFFSET UNITYSDK_OFFSET(0x1D2D1A40)
#define AKTIMELINERTPCPLAYABLE_SET_OWNINGCLIP_OFFSET UNITYSDK_OFFSET(0x1D2D1A90)
#define AKTIMELINERTPCPLAYABLE_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D2D1AA0)
#define AKTIMELINERTPCPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D1C50)

inline static constexpr unsigned int AkTimelineRtpcPlayable_TypeDefinitionIndex = 43687;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::Timeline::TimelineClip*))((::PBYTE)hIl2Cpp + AKTIMELINERTPCPLAYABLE_SET_OWNINGCLIP_OFFSET))(this, a1);
	}
	...
	{
		return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + AKTIMELINERTPCPLAYABLE_CREATEPLAYABLE_OFFSET))(this, a1, a2);
	}
};
