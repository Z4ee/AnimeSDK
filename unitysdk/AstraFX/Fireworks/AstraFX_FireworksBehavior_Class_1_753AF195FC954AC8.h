...
#define ASTRAFX_FIREWORKS_ASTRAFX_FIREWORKSBEHAVIOR_CLASS_1_753AF195FC954AC8__CTOR_OFFSET UNITYSDK_OFFSET(0x17663740)
...
namespace AstraFX::Fireworks
{
	...
	public:
		...
		::System::Int32 EAFOPCOOJDA; // 0x18
		::UnityEngine::Vector3 FILFKDALEPE; // 0x1C
		::System::Single FAHLBOLIGNH; // 0x28
		::System::Single ACHAOEPNEBC; // 0x2C
		::System::Int32 AAEHGBPKDPK; // 0x30
		::UnityEngine::Vector3 JHOGJELLFPF; // 0x34
