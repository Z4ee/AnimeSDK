...
#define ASTRAFX_FIREWORKS_ASTRAFX_FIREWORKSEMITTERBEHAVIOR_GET__OWNEREMITTER_OFFSET UNITYSDK_OFFSET(0x17665400)
#define ASTRAFX_FIREWORKS_ASTRAFX_FIREWORKSEMITTERBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17665480)
#define ASTRAFX_FIREWORKS_ASTRAFX_FIREWORKSEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x176654E0)
