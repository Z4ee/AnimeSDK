...
#define CLASS_1_17A5886A757514FA_METHOD_1_0882BA2CA10E8E8E_OFFSET UNITYSDK_OFFSET(0x17A41C60)
#define CLASS_1_17A5886A757514FA__CTOR_OFFSET UNITYSDK_OFFSET(0x17A41D10)

inline static constexpr unsigned int Class_1_17A5886A757514FA_TypeDefinitionIndex = 77716;

class Class_1_17A5886A757514FA : public ::System::Object
{
public:
	::Class_1_4F54BF4C6B55D9A9* LBLEOKEHLBB; // 0x10
	::UnityEngine::GameObject* JGOOCFAJAFF; // 0x18
	::FiveDimRenderingItem* FJCJGFGMCCP; // 0x20
	::RPG::GameCore::AnchorInfo* FEEBOGKKGIG; // 0x28
	::RPG::GameCore::LevelAnchorCoin40Parameter* HGCAPCENLLP; // 0x30
