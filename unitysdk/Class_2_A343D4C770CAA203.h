...
#define CLASS_2_A343D4C770CAA203_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC47C750)
#define CLASS_2_A343D4C770CAA203_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xC47CA00)
#define CLASS_2_A343D4C770CAA203_METHOD_2_06A2B758FCB8A24E_1_OFFSET UNITYSDK_OFFSET(0xC47C7A0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_06A2B758FCB8A24E_OFFSET UNITYSDK_OFFSET(0xC47C580)
#define CLASS_2_A343D4C770CAA203_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xC47DEE0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_261C2B64774FC8E4_OFFSET UNITYSDK_OFFSET(0xC47F780)
#define CLASS_2_A343D4C770CAA203_METHOD_2_32D4A70A38448E14_OFFSET UNITYSDK_OFFSET(0xC47D4E0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_4979CB832B65C8C1_OFFSET UNITYSDK_OFFSET(0xC47E2A0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_5C0C256643E989F8_OFFSET UNITYSDK_OFFSET(0xC47C2C0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0xC47E910)
#define CLASS_2_A343D4C770CAA203_METHOD_2_63D11069727DDC9C_OFFSET UNITYSDK_OFFSET(0xC47F0A0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0xC47EC60)
#define CLASS_2_A343D4C770CAA203_METHOD_2_716BA667B58090A4_OFFSET UNITYSDK_OFFSET(0xC47E9D0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_80EBA5B20C4C4A1C_OFFSET UNITYSDK_OFFSET(0xC47C340)
#define CLASS_2_A343D4C770CAA203_METHOD_2_8BBD8CCCCD8B609C_OFFSET UNITYSDK_OFFSET(0xC47DF70)
#define CLASS_2_A343D4C770CAA203_METHOD_2_B7E6ED31D1624EEC_OFFSET UNITYSDK_OFFSET(0xC47D320)
#define CLASS_2_A343D4C770CAA203_METHOD_2_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0xC47D610)
#define CLASS_2_A343D4C770CAA203_METHOD_2_DCC0CC5DBC127BF8_OFFSET UNITYSDK_OFFSET(0xC47D270)
#define CLASS_2_A343D4C770CAA203_METHOD_2_E6CB7ED296472BDD_OFFSET UNITYSDK_OFFSET(0xC47F540)
#define CLASS_2_A343D4C770CAA203_METHOD_2_EB522918F22FFA3B_OFFSET UNITYSDK_OFFSET(0xC47C4B0)
#define CLASS_2_A343D4C770CAA203_METHOD_2_EE07004C8154E49B_OFFSET UNITYSDK_OFFSET(0xC47F3B0)
#define CLASS_2_A343D4C770CAA203_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC47D670)
#define CLASS_2_A343D4C770CAA203_ONSKIP_OFFSET UNITYSDK_OFFSET(0xC47CA10)
#define CLASS_2_A343D4C770CAA203_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC47D960)
#define CLASS_2_A343D4C770CAA203_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC47C990)
#define CLASS_2_A343D4C770CAA203_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0xC47D910)
#define CLASS_2_A343D4C770CAA203_TICK_OFFSET UNITYSDK_OFFSET(0xC47D870)
#define CLASS_2_A343D4C770CAA203__CTOR_OFFSET UNITYSDK_OFFSET(0xC47C1B0)
#define CLASS_2_A343D4C770CAA203__ONTASKBEGIN_B__11_0_OFFSET UNITYSDK_OFFSET(0xC47F930)
#define CLASS_2_A343D4C770CAA203___ONSCREENTRANSFERTEXTEND_B__15_0_OFFSET UNITYSDK_OFFSET(0xC47FAA0)
#define CLASS_2_A343D4C770CAA203___PROMISEKEEPTIMEOUT_B__19_0_OFFSET UNITYSDK_OFFSET(0xC47FB00)
...
public:
	...
	::Class_1_23F67DD15593C8D6* PCOMMLHHNOA; // 0x18
	::RPG::Client::Promises::Promise* PDDACOMPKNI; // 0x20
	::System::Exception* LMLAIDOEMCK; // 0x28
	::RPG::Client::Promises::Promise* BGKEPMJFAIK; // 0x30
	::RPG::GameCore::PlayFullScreenTransfer* OFKGLJOAMLD; // 0x38
	::RPG::Client::Promises::Promise* MDIGLAGDEDM; // 0x40
	::RPG::Client::Promises::Promise* JIACFFCJACB; // 0x48
	::Class_1_5F51D4049EA87B7B* CJHJNLGOJLA; // 0x50
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x58
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_465*>* JHJOELGJNIA; // 0x60
	::RPG::Client::Promises::Promise* BBECMOPMKHK; // 0x68
	::RPG::GameCore::ScreenTransferActionState LFGGBEKCIAH; // 0x70
	::RPG::GameCore::ScreenTransferReason FBPGLJAFBHF; // 0x74
	::System::UInt32 ENFEOOMNNJN; // 0x78
	::System::Int32 GAHGABBBDFF; // 0x7C
	::System::Boolean BKDIOGMOHAG; // 0x80
	::System::Boolean PMNBLDFOJJO; // 0x81
	::System::Boolean OGCIFIFIAEP; // 0x82
