...
#define CLASS_1_5B567C8A01BAEDFE_285_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9EFFD0)
#define CLASS_1_5B567C8A01BAEDFE_285_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9EFDE0)
#define CLASS_1_5B567C8A01BAEDFE_285_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9EFEE0)
#define CLASS_1_5B567C8A01BAEDFE_285_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9EFE50)
#define CLASS_1_5B567C8A01BAEDFE_285_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9EFF30)
#define CLASS_1_5B567C8A01BAEDFE_285_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9F0020)
#define CLASS_1_5B567C8A01BAEDFE_285_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9EFFF0)
#define CLASS_1_5B567C8A01BAEDFE_285_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A9EFD30)
#define CLASS_1_5B567C8A01BAEDFE_285_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9EFD90)
#define CLASS_1_5B567C8A01BAEDFE_285_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9EFF60)
#define CLASS_1_5B567C8A01BAEDFE_285_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9EFFC0)
#define CLASS_1_5B567C8A01BAEDFE_285__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9F0070)
#define CLASS_1_5B567C8A01BAEDFE_285__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9EFDB0)
#define CLASS_1_5B567C8A01BAEDFE_285__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EFDA0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_285_TypeDefinitionIndex = 30897;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_285*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_285_TypeDefinitionIndex)->GetStaticField(0x68140);
	}
