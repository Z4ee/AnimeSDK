...
#define CLASS_1_5B567C8A01BAEDFE_285_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DFA6A50)
#define CLASS_1_5B567C8A01BAEDFE_285_CLONE_OFFSET UNITYSDK_OFFSET(0x1DFA6740)
#define CLASS_1_5B567C8A01BAEDFE_285_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DFA6850)
#define CLASS_1_5B567C8A01BAEDFE_285_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DFA6780)
#define CLASS_1_5B567C8A01BAEDFE_285_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DFA69B0)
#define CLASS_1_5B567C8A01BAEDFE_285_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DFA6AA0)
#define CLASS_1_5B567C8A01BAEDFE_285_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DFA6A70)
#define CLASS_1_5B567C8A01BAEDFE_285_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DFA66C0)
#define CLASS_1_5B567C8A01BAEDFE_285_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DFA66F0)
#define CLASS_1_5B567C8A01BAEDFE_285_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DFA69E0)
#define CLASS_1_5B567C8A01BAEDFE_285_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DFA6A40)
#define CLASS_1_5B567C8A01BAEDFE_285__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DFA6AF0)
#define CLASS_1_5B567C8A01BAEDFE_285__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFA6710)
#define CLASS_1_5B567C8A01BAEDFE_285__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFA6700)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_285_TypeDefinitionIndex = 32072;

class Class_1_5B567C8A01BAEDFE_285 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_285*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_285*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_285_TypeDefinitionIndex)->GetStaticField(0x19980);
	}
