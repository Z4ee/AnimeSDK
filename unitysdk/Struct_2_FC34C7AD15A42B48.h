...
#define STRUCT_2_FC34C7AD15A42B48_EQUALS_OFFSET UNITYSDK_OFFSET(0x787DF0)
#define STRUCT_2_FC34C7AD15A42B48_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x787E90)
#define STRUCT_2_FC34C7AD15A42B48_METHOD_2_140AEBD840D7BBC4_OFFSET UNITYSDK_OFFSET(0x787F50)
#define STRUCT_2_FC34C7AD15A42B48_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x787F60)
#define STRUCT_2_FC34C7AD15A42B48_METHOD_2_4E84FD21E7EECC5B_OFFSET UNITYSDK_OFFSET(0x788050)
#define STRUCT_2_FC34C7AD15A42B48_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x787FE0)
#define STRUCT_2_FC34C7AD15A42B48_TOSTRING_OFFSET UNITYSDK_OFFSET(0x787F40)
#define STRUCT_2_FC34C7AD15A42B48__CCTOR_OFFSET UNITYSDK_OFFSET(0x123D04E0)

inline static constexpr unsigned int Struct_2_FC34C7AD15A42B48_TypeDefinitionIndex = 71235;

struct alignas(8) Struct_2_FC34C7AD15A42B48
{
	static ::Struct_2_FC34C7AD15A42B48* StaticGet_Field_2_0()
	{
		return (::Struct_2_FC34C7AD15A42B48*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FC34C7AD15A42B48_TypeDefinitionIndex)->GetStaticField(0x39500);
	}
