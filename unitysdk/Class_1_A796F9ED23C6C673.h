...
#define CLASS_1_A796F9ED23C6C673_CLEAR_OFFSET UNITYSDK_OFFSET(0x1571B3D0)
#define CLASS_1_A796F9ED23C6C673_METHOD_1_2B32279AD66917FA_OFFSET UNITYSDK_OFFSET(0x1571B460)
#define CLASS_1_A796F9ED23C6C673_METHOD_1_A52062643A2DBAD8_OFFSET UNITYSDK_OFFSET(0x1571B630)
#define CLASS_1_A796F9ED23C6C673__CTOR_OFFSET UNITYSDK_OFFSET(0x1571B780)
...
{
public:
	::RPG::Client::FollowPointMapping* CFIOFNEOCMI; // 0x10
	::System::String* IPKCFNKIDMB; // 0x18
	::UnityEngine::Transform* MCLLALGABAB; // 0x20
	::RPG::Client::CameraBlendCurve* NLIFDJHPHLP; // 0x28
	::System::Single PMHMEGEJDGP; // 0x30
	::System::Single IEHPFADHJFD; // 0x34
	::UnityEngine::Quaternion FICPPFFOIFB; // 0x38
	::UnityEngine::Quaternion ANGPCKDKKIJ; // 0x48
