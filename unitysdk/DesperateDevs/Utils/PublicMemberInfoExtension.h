...
#define DESPERATEDEVS_UTILS_PUBLICMEMBERINFOEXTENSION_COPYPUBLICMEMBERVALUES_OFFSET UNITYSDK_OFFSET(0x11A57360)
#define DESPERATEDEVS_UTILS_PUBLICMEMBERINFOEXTENSION_GETPUBLICMEMBERINFOS_OFFSET UNITYSDK_OFFSET(0x11A56F90)
#define DESPERATEDEVS_UTILS_PUBLICMEMBERINFOEXTENSION_PUBLICMEMBERCLONE_OFFSET UNITYSDK_OFFSET(0x11A57310)

namespace DesperateDevs::Utils
{
	inline static constexpr unsigned int PublicMemberInfoExtension_TypeDefinitionIndex = 8997;
