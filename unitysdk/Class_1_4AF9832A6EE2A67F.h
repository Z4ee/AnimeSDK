...
#define CLASS_1_4AF9832A6EE2A67F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EBFA740)
#define CLASS_1_4AF9832A6EE2A67F_CLONE_OFFSET UNITYSDK_OFFSET(0x1EBFA340)
#define CLASS_1_4AF9832A6EE2A67F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EBFA500)
#define CLASS_1_4AF9832A6EE2A67F_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EBFA3E0)
#define CLASS_1_4AF9832A6EE2A67F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EBFA5F0)
#define CLASS_1_4AF9832A6EE2A67F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EBFA830)
#define CLASS_1_4AF9832A6EE2A67F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EBFA7E0)
#define CLASS_1_4AF9832A6EE2A67F_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1EBFA230)
#define CLASS_1_4AF9832A6EE2A67F_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1EBFA3D0)
#define CLASS_1_4AF9832A6EE2A67F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EBFA290)
#define CLASS_1_4AF9832A6EE2A67F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EBFA630)
#define CLASS_1_4AF9832A6EE2A67F_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EBFA690)
#define CLASS_1_4AF9832A6EE2A67F__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBFA9F0)
#define CLASS_1_4AF9832A6EE2A67F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EBFA2D0)
#define CLASS_1_4AF9832A6EE2A67F__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBFA2A0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4AF9832A6EE2A67F_TypeDefinitionIndex)->GetStaticField(0x613C0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_4AF9832A6EE2A67F*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_4AF9832A6EE2A67F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4AF9832A6EE2A67F_TypeDefinitionIndex)->GetStaticField(0x613C8);
	}
	// static const ::System::Int32 PGDMMDENEOH = 0x7; // 0x0
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::UInt32>* ECMHNEICIAO; // 0x10
