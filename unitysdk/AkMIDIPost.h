...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x1E7190A0)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E718AB0)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1E718A10)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1E719140)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1E718D00)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x1E718D80)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1E718A20)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1E718C80)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7191C0)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E718980)

inline static constexpr unsigned int AkMIDIPost_TypeDefinitionIndex = 32987;
