...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x1C3D49D0)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C3D43E0)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1C3D4340)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1C3D4A70)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1C3D4630)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x1C3D46B0)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1C3D4350)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1C3D45B0)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3D4AF0)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3D42B0)

inline static constexpr unsigned int AkMIDIPost_TypeDefinitionIndex = 31436;
