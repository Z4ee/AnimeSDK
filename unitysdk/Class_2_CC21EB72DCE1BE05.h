...
#define CLASS_2_CC21EB72DCE1BE05_DISPOSE_OFFSET UNITYSDK_OFFSET(0x123EDF20)
#define CLASS_2_CC21EB72DCE1BE05_METHOD_2_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0x123EE0C0)
#define CLASS_2_CC21EB72DCE1BE05_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x123EDD90)
#define CLASS_2_CC21EB72DCE1BE05_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x123EDE30)
#define CLASS_2_CC21EB72DCE1BE05_TICK_OFFSET UNITYSDK_OFFSET(0x123EDFE0)
#define CLASS_2_CC21EB72DCE1BE05__CTOR_OFFSET UNITYSDK_OFFSET(0x123EDD10)

inline static constexpr unsigned int Class_2_CC21EB72DCE1BE05_TypeDefinitionIndex = 54367;

class Class_2_CC21EB72DCE1BE05 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_E21F6DE9B7FA4D05* Field_2_2; // 0x18
	::RPG::GameCore::WolfBroPuzzleFuncBtnListener* Field_2_1; // 0x20
