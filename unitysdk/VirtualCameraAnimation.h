...
#define VIRTUALCAMERAANIMATION_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1053C440)
#define VIRTUALCAMERAANIMATION_METHOD_5_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0x1053C510)
#define VIRTUALCAMERAANIMATION_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0x1053C680)
#define VIRTUALCAMERAANIMATION_METHOD_5_CB47EF435F4257BC_OFFSET UNITYSDK_OFFSET(0x1053C330)
#define VIRTUALCAMERAANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1053C2E0)
#define VIRTUALCAMERAANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1053C710)

inline static constexpr unsigned int VirtualCameraAnimation_TypeDefinitionIndex = 45805;
