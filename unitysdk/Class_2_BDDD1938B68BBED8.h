...
#define CLASS_2_BDDD1938B68BBED8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AC0410)
#define CLASS_2_BDDD1938B68BBED8_METHOD_2_C7C402E704FC0E28_OFFSET UNITYSDK_OFFSET(0x10AC07F0)
#define CLASS_2_BDDD1938B68BBED8_METHOD_2_C7C512AC553191BF_OFFSET UNITYSDK_OFFSET(0x10AC0960)
#define CLASS_2_BDDD1938B68BBED8_METHOD_2_FBCDDF7B6BFEFA65_OFFSET UNITYSDK_OFFSET(0x10AC0A40)
#define CLASS_2_BDDD1938B68BBED8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10AC0450)
#define CLASS_2_BDDD1938B68BBED8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10AC0740)
#define CLASS_2_BDDD1938B68BBED8_TICK_OFFSET UNITYSDK_OFFSET(0x10AC0790)
#define CLASS_2_BDDD1938B68BBED8__CTOR_OFFSET UNITYSDK_OFFSET(0x10AC0400)
#define CLASS_2_BDDD1938B68BBED8__ONTASKBEGIN_B__2_0_OFFSET UNITYSDK_OFFSET(0x10AC0C60)
#define CLASS_2_BDDD1938B68BBED8__ONTASKBEGIN_B__2_1_OFFSET UNITYSDK_OFFSET(0x10AC0E40)

inline static constexpr unsigned int Class_2_BDDD1938B68BBED8_TypeDefinitionIndex = 49123;

class Class_2_BDDD1938B68BBED8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ShowGroupChallengeSelectPage* Field_2_0; // 0x20
	...
	::System::Void _OnTaskBegin_b__2_0(::System::Collections::Generic::List_1<::RPG::Client::MainMissionData*>* data)
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::RPG::Client::MainMissionData*>*))((::PBYTE)hIl2Cpp + CLASS_2_BDDD1938B68BBED8__ONTASKBEGIN_B__2_0_OFFSET))(this, data);
	}
