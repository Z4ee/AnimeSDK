...
#define MONOANIMATIONHDRPROPERTY_APPLY_OFFSET UNITYSDK_OFFSET(0xF644890)
#define MONOANIMATIONHDRPROPERTY_FETCHALLRENDERERS_OFFSET UNITYSDK_OFFSET(0xF643F60)
#define MONOANIMATIONHDRPROPERTY_INIT_OFFSET UNITYSDK_OFFSET(0xF644140)
#define MONOANIMATIONHDRPROPERTY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xF644840)
#define MONOANIMATIONHDRPROPERTY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF6440F0)
#define MONOANIMATIONHDRPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xF6457C0)
#define MONOANIMATIONHDRPROPERTY_SHOWRENDERERS_OFFSET UNITYSDK_OFFSET(0xF6440A0)
#define MONOANIMATIONHDRPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF645810)

inline static constexpr unsigned int MonoAnimationHDRProperty_TypeDefinitionIndex = 64704;
