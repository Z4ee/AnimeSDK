...
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x12CA7330)
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x12CA7370)
#define MONOCOPYLAYOUTELEMENT_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x12CA7430)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x12CA6FB0)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x12CA7170)
#define MONOCOPYLAYOUTELEMENT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x12CA6FA0)
#define MONOCOPYLAYOUTELEMENT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x12CA6DD0)
#define MONOCOPYLAYOUTELEMENT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x12CA6C00)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x12CA6A30)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x12CA6860)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x12CA73B0)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x12CA73F0)
#define MONOCOPYLAYOUTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x12CA7480)

inline static constexpr unsigned int MonoCopyLayoutElement_TypeDefinitionIndex = 81437;
