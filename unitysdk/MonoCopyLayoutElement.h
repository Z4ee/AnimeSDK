...
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x12E87120)
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x12E87160)
#define MONOCOPYLAYOUTELEMENT_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x12E87220)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x12E86DA0)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x12E86F60)
#define MONOCOPYLAYOUTELEMENT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x12E86D90)
#define MONOCOPYLAYOUTELEMENT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x12E86BC0)
#define MONOCOPYLAYOUTELEMENT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x12E869F0)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x12E86820)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x12E86650)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x12E871A0)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x12E871E0)
#define MONOCOPYLAYOUTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x12E87270)

inline static constexpr unsigned int MonoCopyLayoutElement_TypeDefinitionIndex = 66766;
