...
#define CLASS_2_E5D38AB31F1F266B_METHOD_2_BB96740FC520E8ED_OFFSET UNITYSDK_OFFSET(0x1D0D8CC0)
#define CLASS_2_E5D38AB31F1F266B__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0D9090)
...
{
public:
	::RPG::GameCore::DynamicFloat* HBAMPJPOOLM; // 0x10
	::RPG::GameCore::DynamicFloat* NEMDKBKDFDN; // 0x18
	::RPG::GameCore::DynamicFloat* IKMMBBLANIC; // 0x20
	::RPG::GameCore::DynamicFloat* DBFCBDAFGAP; // 0x28
	::RPG::GameCore::DynamicFloat* IDKONBFPBLH; // 0x30
	::RPG::GameCore::DynamicFloat* NHJNGNINNIL; // 0x38
