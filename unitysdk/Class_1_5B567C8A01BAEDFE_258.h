...
#define CLASS_1_5B567C8A01BAEDFE_258_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD01C80)
#define CLASS_1_5B567C8A01BAEDFE_258_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD01970)
#define CLASS_1_5B567C8A01BAEDFE_258_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD01A80)
#define CLASS_1_5B567C8A01BAEDFE_258_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD019B0)
#define CLASS_1_5B567C8A01BAEDFE_258_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD01BE0)
#define CLASS_1_5B567C8A01BAEDFE_258_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD01CD0)
#define CLASS_1_5B567C8A01BAEDFE_258_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD01CA0)
#define CLASS_1_5B567C8A01BAEDFE_258_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DD018F0)
#define CLASS_1_5B567C8A01BAEDFE_258_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD01920)
#define CLASS_1_5B567C8A01BAEDFE_258_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD01C10)
#define CLASS_1_5B567C8A01BAEDFE_258_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD01C70)
#define CLASS_1_5B567C8A01BAEDFE_258__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD01D20)
#define CLASS_1_5B567C8A01BAEDFE_258__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD01940)
#define CLASS_1_5B567C8A01BAEDFE_258__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD01930)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_258_TypeDefinitionIndex = 31416;

class Class_1_5B567C8A01BAEDFE_258 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_258*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_258*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_258_TypeDefinitionIndex)->GetStaticField(0xB700);
	}
