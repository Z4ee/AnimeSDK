...
#define CLASS_1_5B567C8A01BAEDFE_258_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A644E40)
#define CLASS_1_5B567C8A01BAEDFE_258_CLONE_OFFSET UNITYSDK_OFFSET(0x1A644CB0)
#define CLASS_1_5B567C8A01BAEDFE_258_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A644D50)
#define CLASS_1_5B567C8A01BAEDFE_258_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A644CF0)
#define CLASS_1_5B567C8A01BAEDFE_258_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A644DA0)
#define CLASS_1_5B567C8A01BAEDFE_258_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A644E90)
#define CLASS_1_5B567C8A01BAEDFE_258_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A644E60)
#define CLASS_1_5B567C8A01BAEDFE_258_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A644C30)
#define CLASS_1_5B567C8A01BAEDFE_258_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A644C60)
#define CLASS_1_5B567C8A01BAEDFE_258_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A644DD0)
#define CLASS_1_5B567C8A01BAEDFE_258_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A644E30)
#define CLASS_1_5B567C8A01BAEDFE_258__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A644EE0)
#define CLASS_1_5B567C8A01BAEDFE_258__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A644C80)
#define CLASS_1_5B567C8A01BAEDFE_258__CTOR_OFFSET UNITYSDK_OFFSET(0x1A644C70)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_258_TypeDefinitionIndex = 30219;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_258*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_258_TypeDefinitionIndex)->GetStaticField(0x27390);
	}
