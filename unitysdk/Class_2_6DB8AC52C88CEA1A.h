...
#define CLASS_2_6DB8AC52C88CEA1A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89D2910)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x89D2950)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89D2A80)
#define CLASS_2_6DB8AC52C88CEA1A_TICK_OFFSET UNITYSDK_OFFSET(0x89D2AD0)
#define CLASS_2_6DB8AC52C88CEA1A__CTOR_OFFSET UNITYSDK_OFFSET(0x89D2900)

inline static constexpr unsigned int Class_2_6DB8AC52C88CEA1A_TypeDefinitionIndex = 44046;

class Class_2_6DB8AC52C88CEA1A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::EnableNegativeHP* Field_2_0; // 0x20
