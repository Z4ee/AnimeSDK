...
#define CLASS_2_6DB8AC52C88CEA1A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x152CDD80)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x152CDDC0)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x152CDEE0)
#define CLASS_2_6DB8AC52C88CEA1A_TICK_OFFSET UNITYSDK_OFFSET(0x152CDF30)
#define CLASS_2_6DB8AC52C88CEA1A__CTOR_OFFSET UNITYSDK_OFFSET(0x152CDD70)

inline static constexpr unsigned int Class_2_6DB8AC52C88CEA1A_TypeDefinitionIndex = 55224;

class Class_2_6DB8AC52C88CEA1A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::EnableNegativeHP* OFKGLJOAMLD; // 0x20
