...
#define CLASS_2_6DB8AC52C88CEA1A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9056FB0)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9056FF0)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9057120)
#define CLASS_2_6DB8AC52C88CEA1A_TICK_OFFSET UNITYSDK_OFFSET(0x9057170)
#define CLASS_2_6DB8AC52C88CEA1A__CTOR_OFFSET UNITYSDK_OFFSET(0x9056FA0)

inline static constexpr unsigned int Class_2_6DB8AC52C88CEA1A_TypeDefinitionIndex = 50748;
