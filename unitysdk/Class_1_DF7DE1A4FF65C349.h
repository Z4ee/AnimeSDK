...
#define CLASS_1_DF7DE1A4FF65C349_CLEAR_OFFSET UNITYSDK_OFFSET(0x17F2A230)
#define CLASS_1_DF7DE1A4FF65C349__CTOR_OFFSET UNITYSDK_OFFSET(0x17F2A2D0)

inline static constexpr unsigned int Class_1_DF7DE1A4FF65C349_TypeDefinitionIndex = 39371;
