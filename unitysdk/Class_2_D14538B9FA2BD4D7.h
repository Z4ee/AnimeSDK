...
#define CLASS_2_D14538B9FA2BD4D7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105B61B0)
#define CLASS_2_D14538B9FA2BD4D7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105B61F0)
#define CLASS_2_D14538B9FA2BD4D7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x105B6A30)
#define CLASS_2_D14538B9FA2BD4D7_TICK_OFFSET UNITYSDK_OFFSET(0x105B6A80)
#define CLASS_2_D14538B9FA2BD4D7__CTOR_OFFSET UNITYSDK_OFFSET(0x105B61A0)

inline static constexpr unsigned int Class_2_D14538B9FA2BD4D7_TypeDefinitionIndex = 44201;

class Class_2_D14538B9FA2BD4D7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ModifyStance* Field_2_0; // 0x20
