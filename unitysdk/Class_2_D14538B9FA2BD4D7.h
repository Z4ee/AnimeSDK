...
#define CLASS_2_D14538B9FA2BD4D7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18760260)
#define CLASS_2_D14538B9FA2BD4D7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x187602A0)
#define CLASS_2_D14538B9FA2BD4D7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18760850)
#define CLASS_2_D14538B9FA2BD4D7_TICK_OFFSET UNITYSDK_OFFSET(0x187608A0)
#define CLASS_2_D14538B9FA2BD4D7__CTOR_OFFSET UNITYSDK_OFFSET(0x18760250)

inline static constexpr unsigned int Class_2_D14538B9FA2BD4D7_TypeDefinitionIndex = 55419;

class Class_2_D14538B9FA2BD4D7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifyStance* OFKGLJOAMLD; // 0x18
