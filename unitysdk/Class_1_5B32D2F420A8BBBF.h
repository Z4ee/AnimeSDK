...
#define CLASS_1_5B32D2F420A8BBBF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED52870)
#define CLASS_1_5B32D2F420A8BBBF_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED52420)
#define CLASS_1_5B32D2F420A8BBBF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED524C0)
#define CLASS_1_5B32D2F420A8BBBF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED52490)
#define CLASS_1_5B32D2F420A8BBBF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED525E0)
#define CLASS_1_5B32D2F420A8BBBF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED529F0)
#define CLASS_1_5B32D2F420A8BBBF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED52980)
#define CLASS_1_5B32D2F420A8BBBF_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1ED52450)
#define CLASS_1_5B32D2F420A8BBBF_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1ED52480)
#define CLASS_1_5B32D2F420A8BBBF_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ED522A0)
#define CLASS_1_5B32D2F420A8BBBF_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1ED52460)
#define CLASS_1_5B32D2F420A8BBBF_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1ED52470)
#define CLASS_1_5B32D2F420A8BBBF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED522D0)
#define CLASS_1_5B32D2F420A8BBBF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED52710)
#define CLASS_1_5B32D2F420A8BBBF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED52770)
#define CLASS_1_5B32D2F420A8BBBF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED52B10)
#define CLASS_1_5B32D2F420A8BBBF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED52350)
#define CLASS_1_5B32D2F420A8BBBF__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED522E0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B32D2F420A8BBBF_TypeDefinitionIndex)->GetStaticField(0x447C0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_IKDNPMKDIOI()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B32D2F420A8BBBF_TypeDefinitionIndex)->GetStaticField(0x447C8);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B32D2F420A8BBBF*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B32D2F420A8BBBF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B32D2F420A8BBBF_TypeDefinitionIndex)->GetStaticField(0x447D0);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* NEPNNABNKED; // 0x10
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::UInt32>* ABMBOCHMHBA; // 0x18
