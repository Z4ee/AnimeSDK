...
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_1757A5346B290CED_1_OFFSET UNITYSDK_OFFSET(0xB4C2410)
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_1757A5346B290CED_OFFSET UNITYSDK_OFFSET(0xB4C2330)
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_19575D1AD52D1399_OFFSET UNITYSDK_OFFSET(0xB4C26B0)
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_2B37EFC04765C317_OFFSET UNITYSDK_OFFSET(0xB4C07E0)
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_66F501070C8F9EA1_OFFSET UNITYSDK_OFFSET(0xB4C24F0)
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_C03074CAF4801A1C_OFFSET UNITYSDK_OFFSET(0xB4C1660)
#define CLASS_1_8345B8E9167A0BA3_METHOD_1_FDC75E773C3424A0_OFFSET UNITYSDK_OFFSET(0xB4C0880)
#define CLASS_1_8345B8E9167A0BA3__CCTOR_OFFSET UNITYSDK_OFFSET(0xB4C2880)
#define CLASS_1_8345B8E9167A0BA3__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C0560)

inline static constexpr unsigned int Class_1_8345B8E9167A0BA3_TypeDefinitionIndex = 70200;

class Class_1_8345B8E9167A0BA3 : public ::System::Object
{
public:
	static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet_BOMDLHIEJHJ()
	{
		return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8345B8E9167A0BA3_TypeDefinitionIndex)->GetStaticField(0x411F0);
	}
	::System::Collections::Generic::Dictionary_2<::Class_1_5F96B92B05C740DB*, ::Class_1_F4428E4EEF88CB9C*>* CKINPNIALOA; // 0x10
	::Class_1_31F7AA61A6C51B11* EHJGKDIFINJ; // 0x18
	::System::Collections::Generic::Dictionary_2<::Class_1_5F96B92B05C740DB*, ::Class_1_F4428E4EEF88CB9C*>* ACBLKAECPNE; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::Client::TimeSpaceCrisscrossLightsBehavior_Class_1_157DF0DD0C4E4084*, ::Class_1_F4428E4EEF88CB9C*>* JPMIGLBGPIP; // 0x28
	::System::Collections::Generic::Dictionary_2<::RPG::Client::TimeSpaceCrisscrossLightsBehavior_Class_1_157DF0DD0C4E4084*, ::Class_1_F4428E4EEF88CB9C*>* JOICGHIMGDN; // 0x30
