...
#define CLASS_1_EBB10EC01CCC4716_9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C27FF70)
#define CLASS_1_EBB10EC01CCC4716_9_CLONE_OFFSET UNITYSDK_OFFSET(0x1C27F910)
#define CLASS_1_EBB10EC01CCC4716_9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C27FB40)
#define CLASS_1_EBB10EC01CCC4716_9_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C27FA80)
#define CLASS_1_EBB10EC01CCC4716_9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C27FBB0)
#define CLASS_1_EBB10EC01CCC4716_9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C280270)
#define CLASS_1_EBB10EC01CCC4716_9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C280200)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C27F9E0)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1C27FA00)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1C27FA20)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x1C27FA40)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C27F9C0)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C27F840)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C27F9F0)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1C27FA10)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1C27FA30)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x1C27FA50)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C27F9D0)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x1C27FA70)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C27F9B0)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1C27FA60)
#define CLASS_1_EBB10EC01CCC4716_9_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C27F9A0)
#define CLASS_1_EBB10EC01CCC4716_9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C27F8A0)
#define CLASS_1_EBB10EC01CCC4716_9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C27FC00)
#define CLASS_1_EBB10EC01CCC4716_9_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C27FC60)
#define CLASS_1_EBB10EC01CCC4716_9__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C280370)
#define CLASS_1_EBB10EC01CCC4716_9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C27F8C0)
#define CLASS_1_EBB10EC01CCC4716_9__CTOR_OFFSET UNITYSDK_OFFSET(0x1C27F8B0)

inline static constexpr unsigned int Class_1_EBB10EC01CCC4716_9_TypeDefinitionIndex = 26745;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EBB10EC01CCC4716_9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB10EC01CCC4716_9_TypeDefinitionIndex)->GetStaticField(0x38100);
	}
