...
#define CLASS_1_97FA2C9E6D76C943_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x16295350)
#define CLASS_1_97FA2C9E6D76C943_LATEEXECUTE_OFFSET UNITYSDK_OFFSET(0x16294F10)
#define CLASS_1_97FA2C9E6D76C943_METHOD_1_E727F9956B5BD78B_OFFSET UNITYSDK_OFFSET(0x16295620)
#define CLASS_1_97FA2C9E6D76C943_METHOD_1_FD647A48096EB173_OFFSET UNITYSDK_OFFSET(0x16294F60)
#define CLASS_1_97FA2C9E6D76C943_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x162951F0)
#define CLASS_1_97FA2C9E6D76C943__CTOR_OFFSET UNITYSDK_OFFSET(0x16294D30)

inline static constexpr unsigned int Class_1_97FA2C9E6D76C943_TypeDefinitionIndex = 76689;

class Class_1_97FA2C9E6D76C943 : public ::System::Object
{
public:
	::Entitas::ICollector_1<::Class_2_B9E8C2EEAA5C96EC*>* MFFBACCILJA; // 0x10
	::Class_3_1E4F9B0ED3BF21DE* PDENFEFCAGN; // 0x18
	::Class_2_F47F7A3F5E97970D* EEFMDEHLLFI; // 0x20
	::Entitas::IGroup_1<::Class_2_B9E8C2EEAA5C96EC*>* MCIKCILKNON; // 0x28
	::Entitas::IGroup_1<::Class_2_B9E8C2EEAA5C96EC*>* LKCDPPOENAH; // 0x30
