...
#define CLASS_1_5B567C8A01BAEDFE_100_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195EC1D0)
#define CLASS_1_5B567C8A01BAEDFE_100_CLONE_OFFSET UNITYSDK_OFFSET(0x195EBFE0)
#define CLASS_1_5B567C8A01BAEDFE_100_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195EC0E0)
#define CLASS_1_5B567C8A01BAEDFE_100_EQUALS_OFFSET UNITYSDK_OFFSET(0x195EC050)
#define CLASS_1_5B567C8A01BAEDFE_100_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195EC130)
#define CLASS_1_5B567C8A01BAEDFE_100_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195EC220)
#define CLASS_1_5B567C8A01BAEDFE_100_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195EC1F0)
#define CLASS_1_5B567C8A01BAEDFE_100_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195EBF30)
#define CLASS_1_5B567C8A01BAEDFE_100_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195EBF90)
#define CLASS_1_5B567C8A01BAEDFE_100_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195EC160)
#define CLASS_1_5B567C8A01BAEDFE_100_WRITETO_OFFSET UNITYSDK_OFFSET(0x195EC1C0)
#define CLASS_1_5B567C8A01BAEDFE_100__CCTOR_OFFSET UNITYSDK_OFFSET(0x195EC270)
#define CLASS_1_5B567C8A01BAEDFE_100__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195EBFB0)
#define CLASS_1_5B567C8A01BAEDFE_100__CTOR_OFFSET UNITYSDK_OFFSET(0x195EBFA0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_100_TypeDefinitionIndex = 26363;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_100*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_100_TypeDefinitionIndex)->GetStaticField(0x56A80);
	}
