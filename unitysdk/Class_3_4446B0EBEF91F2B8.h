...
#define CLASS_3_4446B0EBEF91F2B8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA8C00E0)
#define CLASS_3_4446B0EBEF91F2B8__CTOR_OFFSET UNITYSDK_OFFSET(0xA8C00B0)

inline static constexpr unsigned int Class_3_4446B0EBEF91F2B8_TypeDefinitionIndex = 49898;
