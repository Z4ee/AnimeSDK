...
#define CLASS_3_4446B0EBEF91F2B8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14B50030)
#define CLASS_3_4446B0EBEF91F2B8__CTOR_OFFSET UNITYSDK_OFFSET(0x14B50000)

inline static constexpr unsigned int Class_3_4446B0EBEF91F2B8_TypeDefinitionIndex = 50975;
