...
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E5A2290)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E5A2500)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E5A2490)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E5A2580)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E5A24F0)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E5A24A0)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E5A2270)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A06C0)
#define SIMPLEJSON_JSONCLASS__GET_KEYS_D__15___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1E5A2280)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONClass__get_Keys_d__15_TypeDefinitionIndex = 9906;
	...
	public:
		...
		::SimpleJSON::JSONClass* __4__this; // 0x28
