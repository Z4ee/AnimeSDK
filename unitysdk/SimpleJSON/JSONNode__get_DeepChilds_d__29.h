...
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19DAEFA0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19DAF640)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19DAF5D0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19DAF6C0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19DAF630)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19DAF5E0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DAEC40)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAA6B0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x19DAEEF0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x19DAEE40)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONNode__get_DeepChilds_d__29_TypeDefinitionIndex = 9776;

	class JSONNode__get_DeepChilds_d__29 : public ::System::Object
	{
	public:
		::SimpleJSON::JSONNode* __2__current; // 0x10
		::System::Collections::Generic::IEnumerator_1<::SimpleJSON::JSONNode*>* __7__wrap3; // 0x18
		::SimpleJSON::JSONNode* _C_5__3; // 0x20
