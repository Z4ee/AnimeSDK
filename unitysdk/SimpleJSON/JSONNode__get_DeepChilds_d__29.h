...
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1835D880)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1835DF10)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1835DEA0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1835DF90)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1835DF00)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1835DEB0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1835D520)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x18358F20)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1835D7D0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1835D720)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONNode__get_DeepChilds_d__29_TypeDefinitionIndex = 9643;
	...
	public:
		...
		::System::Collections::Generic::IEnumerator_1<::SimpleJSON::JSONNode*>* __7__wrap1; // 0x18
		::SimpleJSON::JSONNode* __2__current; // 0x20
		::SimpleJSON::JSONNode* _C_5__3; // 0x28
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29__CTOR_OFFSET))(this, __1__state);
		}
