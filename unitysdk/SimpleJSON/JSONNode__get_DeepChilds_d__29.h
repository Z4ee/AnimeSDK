...
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E5AAB10)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E5AB350)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E5AB2E0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E5AB3D0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E5AB340)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E5AB2F0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E5AA840)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A4BB0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1E5AAA10)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__29___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1E5AA910)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONNode__get_DeepChilds_d__29_TypeDefinitionIndex = 9896;

	class JSONNode__get_DeepChilds_d__29 : public ::System::Object
	{
	public:
		::SimpleJSON::JSONNode* __4__this; // 0x10
		...
		::SimpleJSON::JSONNode* __2__current; // 0x28
		::SimpleJSON::JSONNode* _C_5__3; // 0x30
