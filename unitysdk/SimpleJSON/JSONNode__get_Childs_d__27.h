...
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1835D3B0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1835D440)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1835D3D0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1835D4B0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1835D430)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1835D3E0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1835D3A0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0x18358EA0)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONNode__get_Childs_d__27_TypeDefinitionIndex = 9642;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + SIMPLEJSON_JSONNODE__GET_CHILDS_D__27__CTOR_OFFSET))(this, __1__state);
		}
