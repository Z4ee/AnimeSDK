...
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC22F90)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AC23170)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC23100)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AC231F0)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC23160)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC23110)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC22F70)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC22350)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__13___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1AC22F80)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONArray__get_Childs_d__13_TypeDefinitionIndex = 9608;
	...
	public:
		...
		::SimpleJSON::JSONArray* __4__this; // 0x28
