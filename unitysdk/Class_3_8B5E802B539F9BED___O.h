...
public:
	...
	{
		return (::System::Func_4<::RPG::GameCore::GameEntity*, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_8B5E802B539F9BED___O_TypeDefinitionIndex)->GetStaticField(0x655B0);
	}
};
