...
#define MARBLESUBSEALROTATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x186EDE80)
#define MARBLESUBSEALROTATOR_INIT_OFFSET UNITYSDK_OFFSET(0x186ED6D0)
#define MARBLESUBSEALROTATOR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x186ED870)
#define MARBLESUBSEALROTATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x186EDFA0)
#define MARBLESUBSEALROTATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x186EDF50)
#define MARBLESUBSEALROTATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x186EDED0)
#define MARBLESUBSEALROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x186EDFF0)

inline static constexpr unsigned int MarbleSubSealRotator_TypeDefinitionIndex = 45350;
