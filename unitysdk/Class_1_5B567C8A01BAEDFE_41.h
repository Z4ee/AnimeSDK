...
#define CLASS_1_5B567C8A01BAEDFE_41_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A801030)
#define CLASS_1_5B567C8A01BAEDFE_41_CLONE_OFFSET UNITYSDK_OFFSET(0x1A800E40)
#define CLASS_1_5B567C8A01BAEDFE_41_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A800F40)
#define CLASS_1_5B567C8A01BAEDFE_41_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A800EB0)
#define CLASS_1_5B567C8A01BAEDFE_41_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A800F90)
#define CLASS_1_5B567C8A01BAEDFE_41_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A801080)
#define CLASS_1_5B567C8A01BAEDFE_41_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A801050)
#define CLASS_1_5B567C8A01BAEDFE_41_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A800D90)
#define CLASS_1_5B567C8A01BAEDFE_41_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A800DF0)
#define CLASS_1_5B567C8A01BAEDFE_41_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A800FC0)
#define CLASS_1_5B567C8A01BAEDFE_41_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A801020)
#define CLASS_1_5B567C8A01BAEDFE_41__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8010D0)
#define CLASS_1_5B567C8A01BAEDFE_41__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A800E10)
#define CLASS_1_5B567C8A01BAEDFE_41__CTOR_OFFSET UNITYSDK_OFFSET(0x1A800E00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_41_TypeDefinitionIndex = 25160;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_41*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_41_TypeDefinitionIndex)->GetStaticField(0x4FFF0);
	}
