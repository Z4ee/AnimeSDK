...
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x10AB9350)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_INT32__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x10AB94F0)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_INT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10AB9460)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x10AB9570)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10AB94C0)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x10AB9470)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AB9340)
#define CLASS_4_6A0D46987C287112__SELECTENTITYIDS_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x10AB8EF0)

inline static constexpr unsigned int Class_4_6A0D46987C287112__SelectEntityIDs_d__3_TypeDefinitionIndex = 63182;
