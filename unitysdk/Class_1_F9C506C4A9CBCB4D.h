...
#define CLASS_1_F9C506C4A9CBCB4D_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x115D4370)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_49D6CC7F7A3090A6_OFFSET UNITYSDK_OFFSET(0x115D4BD0)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_585FC7B29EB12CF9_OFFSET UNITYSDK_OFFSET(0x115D47C0)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_655DDB722F1FDE73_OFFSET UNITYSDK_OFFSET(0x115D4500)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_A370720754FE8924_OFFSET UNITYSDK_OFFSET(0x115D4900)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0x115D4390)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_D7FE3FCFB1E0B054_OFFSET UNITYSDK_OFFSET(0x115D4720)
#define CLASS_1_F9C506C4A9CBCB4D_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x115D4380)
#define CLASS_1_F9C506C4A9CBCB4D__CTOR_OFFSET UNITYSDK_OFFSET(0x115D4480)

inline static constexpr unsigned int Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex = 60700;
...
public:
	...
	{
		return (::Class_1_F9C506C4A9CBCB4D**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex)->GetStaticField(0x45420);
	}
