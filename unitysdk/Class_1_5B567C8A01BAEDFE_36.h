...
#define CLASS_1_5B567C8A01BAEDFE_36_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x196B1590)
#define CLASS_1_5B567C8A01BAEDFE_36_CLONE_OFFSET UNITYSDK_OFFSET(0x196B13A0)
#define CLASS_1_5B567C8A01BAEDFE_36_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x196B14A0)
#define CLASS_1_5B567C8A01BAEDFE_36_EQUALS_OFFSET UNITYSDK_OFFSET(0x196B1410)
#define CLASS_1_5B567C8A01BAEDFE_36_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x196B14F0)
#define CLASS_1_5B567C8A01BAEDFE_36_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x196B15E0)
#define CLASS_1_5B567C8A01BAEDFE_36_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x196B15B0)
#define CLASS_1_5B567C8A01BAEDFE_36_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x196B12F0)
#define CLASS_1_5B567C8A01BAEDFE_36_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x196B1350)
#define CLASS_1_5B567C8A01BAEDFE_36_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196B1520)
#define CLASS_1_5B567C8A01BAEDFE_36_WRITETO_OFFSET UNITYSDK_OFFSET(0x196B1580)
#define CLASS_1_5B567C8A01BAEDFE_36__CCTOR_OFFSET UNITYSDK_OFFSET(0x196B1630)
#define CLASS_1_5B567C8A01BAEDFE_36__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196B1370)
#define CLASS_1_5B567C8A01BAEDFE_36__CTOR_OFFSET UNITYSDK_OFFSET(0x196B1360)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_36_TypeDefinitionIndex = 25242;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_36*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_36_TypeDefinitionIndex)->GetStaticField(0x47CF0);
	}
