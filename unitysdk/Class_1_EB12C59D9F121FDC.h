...
#define CLASS_1_EB12C59D9F121FDC_CLEAR_OFFSET UNITYSDK_OFFSET(0xB917F30)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xB9183F0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_2450CFC043E97F54_1_OFFSET UNITYSDK_OFFSET(0xB9177A0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xB9176E0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_264C4240ED75E08B_OFFSET UNITYSDK_OFFSET(0xB917B80)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_2B3F866319C4A343_OFFSET UNITYSDK_OFFSET(0xB918EE0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_51AA029DE3B8B5BD_OFFSET UNITYSDK_OFFSET(0xB918E30)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_833800FBC4323F5D_OFFSET UNITYSDK_OFFSET(0xB917860)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xB917EA0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_AA194C2184220475_OFFSET UNITYSDK_OFFSET(0xB9175F0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_AB1A9623E03F063F_OFFSET UNITYSDK_OFFSET(0xB918C30)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_AC6F03C43CEB1DC1_OFFSET UNITYSDK_OFFSET(0xB917CB0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_B9F72A112CB05C02_OFFSET UNITYSDK_OFFSET(0xB917510)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_CA14057CB80292C5_OFFSET UNITYSDK_OFFSET(0xB918500)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB917EF0)
#define CLASS_1_EB12C59D9F121FDC_METHOD_1_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0xB918010)
#define CLASS_1_EB12C59D9F121FDC__CTOR_OFFSET UNITYSDK_OFFSET(0xB9190A0)
...
{
public:
	::RPG::Client::MonoEffect* HJBEGIDAMBP; // 0x10
	::Il2CppArray<::RPG::Client::Effect_RendererMatBackwardMonoPlugin*>* IEPOMLMMJAM; // 0x18
	::RPG::Client::EntityTimelineControlNode* KKCAIADKCNE; // 0x20
	::Class_1_F65DC6656DEF8159* EPMPEFJBAPM; // 0x28
	::RPG::Client::MonoEffectPluginFollow* AIBMIBKCDIP; // 0x30
	::Class_1_E45C207B1AC948BE* CDAECNCKMJO; // 0x38
	::RPG::GameCore::GameEntity* ICHEDAEHEBG; // 0x40
	::RPG::GameCore::TimeRewindEffConfig* HFFOACNOGFC; // 0x48
	::Il2CppArray<::RPG::Client::Effect_ParticleBackwardMonoPlugin*>* PKBDLIKMEBF; // 0x50
	::RPG::GameCore::TimeRewindState PPNPFHEGGCI; // 0x58
	::System::Single KBDPMBDJIOF; // 0x5C
	::System::Boolean MCAPIAKDMAA; // 0x60
	::System::Boolean AIEALCOCIIK; // 0x61
	::System::Single HBDJCFFDGDD; // 0x64
	::System::Single BHLNBIGFJIG; // 0x68
	::System::Single CNDJDPHMHNK; // 0x6C
