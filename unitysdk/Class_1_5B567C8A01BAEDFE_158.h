...
#define CLASS_1_5B567C8A01BAEDFE_158_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E14AD90)
#define CLASS_1_5B567C8A01BAEDFE_158_CLONE_OFFSET UNITYSDK_OFFSET(0x1E14AA80)
#define CLASS_1_5B567C8A01BAEDFE_158_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E14AB90)
#define CLASS_1_5B567C8A01BAEDFE_158_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E14AAC0)
#define CLASS_1_5B567C8A01BAEDFE_158_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E14ACF0)
#define CLASS_1_5B567C8A01BAEDFE_158_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E14ADE0)
#define CLASS_1_5B567C8A01BAEDFE_158_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E14ADB0)
#define CLASS_1_5B567C8A01BAEDFE_158_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E14AA00)
#define CLASS_1_5B567C8A01BAEDFE_158_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E14AA30)
#define CLASS_1_5B567C8A01BAEDFE_158_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E14AD20)
#define CLASS_1_5B567C8A01BAEDFE_158_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E14AD80)
#define CLASS_1_5B567C8A01BAEDFE_158__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E14AE30)
#define CLASS_1_5B567C8A01BAEDFE_158__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E14AA50)
#define CLASS_1_5B567C8A01BAEDFE_158__CTOR_OFFSET UNITYSDK_OFFSET(0x1E14AA40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_158_TypeDefinitionIndex = 29041;

class Class_1_5B567C8A01BAEDFE_158 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_158*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_158*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_158_TypeDefinitionIndex)->GetStaticField(0x44490);
	}
