...
#define CLASS_2_3AC793AC922B6D20_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xAB1BB50)
#define CLASS_2_3AC793AC922B6D20_METHOD_2_30E134A2CEDB3A22_OFFSET UNITYSDK_OFFSET(0xAB1B9A0)
#define CLASS_2_3AC793AC922B6D20_METHOD_2_A0433AB55CC45192_OFFSET UNITYSDK_OFFSET(0xAB1BA50)
#define CLASS_2_3AC793AC922B6D20_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB1D2A0)
#define CLASS_2_3AC793AC922B6D20_METHOD_2_DD325FEFA053DBEF_OFFSET UNITYSDK_OFFSET(0xAB1D2F0)
#define CLASS_2_3AC793AC922B6D20__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAB1B970)
#define CLASS_2_3AC793AC922B6D20__CTOR_OFFSET UNITYSDK_OFFSET(0xAB1B960)

inline static constexpr unsigned int Class_2_3AC793AC922B6D20_TypeDefinitionIndex = 65089;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::PipelineCameraEngine*, ::RPG::Client::CameraModuleConfigCollection*, ::RPG::Client::PipelineCameraGlobalConfig*, ::RPG::Client::CameraDataAndFlags*, ::RPG::Client::CameraModuleType))((::PBYTE)hIl2Cpp + CLASS_2_3AC793AC922B6D20_METHOD_2_DD325FEFA053DBEF_OFFSET))(this, a1, a2, a3, a4, a5);
	}
};
