...
#define CLASS_1_892C8E99BD4BE910_METHOD_1_0BE1846AC20D43BE_OFFSET UNITYSDK_OFFSET(0x1412AF20)
#define CLASS_1_892C8E99BD4BE910_METHOD_1_7FEDD024C6EF610C_OFFSET UNITYSDK_OFFSET(0x1412B130)
#define CLASS_1_892C8E99BD4BE910_METHOD_1_99F0C32FED83C683_OFFSET UNITYSDK_OFFSET(0x1412B180)
#define CLASS_1_892C8E99BD4BE910_METHOD_1_A8AE4A9A45E37F95_OFFSET UNITYSDK_OFFSET(0x1412AE30)

inline static constexpr unsigned int Class_1_892C8E99BD4BE910_TypeDefinitionIndex = 69000;
...
public:
	...
	{
		return (::MoleMole::DitherConfigSeparate**)Il2CppClass::FromTypeDefinitionIndex(Class_1_892C8E99BD4BE910_TypeDefinitionIndex)->GetStaticField(0x42920);
	}
