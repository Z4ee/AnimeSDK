...
#define CLASS_1_CCB3A003D9DADECF_GET_ATKSPD_OFFSET UNITYSDK_OFFSET(0x16160A00)
#define CLASS_1_CCB3A003D9DADECF_GET_ATK_OFFSET UNITYSDK_OFFSET(0x161609C0)
#define CLASS_1_CCB3A003D9DADECF_GET_ATTACKCD_OFFSET UNITYSDK_OFFSET(0x16160A20)
#define CLASS_1_CCB3A003D9DADECF_GET_ATTACKRANGE_OFFSET UNITYSDK_OFFSET(0x16160AA0)
#define CLASS_1_CCB3A003D9DADECF_GET_CRTCHANCE_OFFSET UNITYSDK_OFFSET(0x16160A60)
#define CLASS_1_CCB3A003D9DADECF_GET_CRTDAMAGERATIO_OFFSET UNITYSDK_OFFSET(0x16160A80)
#define CLASS_1_CCB3A003D9DADECF_GET_HP_OFFSET UNITYSDK_OFFSET(0x161609E0)
#define CLASS_1_CCB3A003D9DADECF_GET_MOVESPD_OFFSET UNITYSDK_OFFSET(0x16160A40)
#define CLASS_1_CCB3A003D9DADECF_GET_READYSCALE_OFFSET UNITYSDK_OFFSET(0x161609A0)
#define CLASS_1_CCB3A003D9DADECF_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x16160980)
#define CLASS_1_CCB3A003D9DADECF_GET_SIZETIER_OFFSET UNITYSDK_OFFSET(0x16160960)
#define CLASS_1_CCB3A003D9DADECF_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0x16160940)
#define CLASS_1_CCB3A003D9DADECF_GET_UNITID_OFFSET UNITYSDK_OFFSET(0x16160920)
#define CLASS_1_CCB3A003D9DADECF_METHOD_1_25373A99E7C2BF9C_OFFSET UNITYSDK_OFFSET(0x161606A0)
#define CLASS_1_CCB3A003D9DADECF_METHOD_1_8C90C775EAE86885_OFFSET UNITYSDK_OFFSET(0x16160790)
#define CLASS_1_CCB3A003D9DADECF_METHOD_1_EA672F77F1086A27_OFFSET UNITYSDK_OFFSET(0x161608D0)
#define CLASS_1_CCB3A003D9DADECF_SET_ATKSPD_OFFSET UNITYSDK_OFFSET(0x16160A10)
#define CLASS_1_CCB3A003D9DADECF_SET_ATK_OFFSET UNITYSDK_OFFSET(0x161609D0)
#define CLASS_1_CCB3A003D9DADECF_SET_ATTACKCD_OFFSET UNITYSDK_OFFSET(0x16160A30)
#define CLASS_1_CCB3A003D9DADECF_SET_ATTACKRANGE_OFFSET UNITYSDK_OFFSET(0x16160AB0)
#define CLASS_1_CCB3A003D9DADECF_SET_CRTCHANCE_OFFSET UNITYSDK_OFFSET(0x16160A70)
#define CLASS_1_CCB3A003D9DADECF_SET_CRTDAMAGERATIO_OFFSET UNITYSDK_OFFSET(0x16160A90)
#define CLASS_1_CCB3A003D9DADECF_SET_HP_OFFSET UNITYSDK_OFFSET(0x161609F0)
#define CLASS_1_CCB3A003D9DADECF_SET_MOVESPD_OFFSET UNITYSDK_OFFSET(0x16160A50)
#define CLASS_1_CCB3A003D9DADECF_SET_READYSCALE_OFFSET UNITYSDK_OFFSET(0x161609B0)
#define CLASS_1_CCB3A003D9DADECF_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x16160990)
#define CLASS_1_CCB3A003D9DADECF_SET_SIZETIER_OFFSET UNITYSDK_OFFSET(0x16160970)
#define CLASS_1_CCB3A003D9DADECF_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0x16160950)
#define CLASS_1_CCB3A003D9DADECF_SET_UNITID_OFFSET UNITYSDK_OFFSET(0x16160930)
#define CLASS_1_CCB3A003D9DADECF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16160460)
#define CLASS_1_CCB3A003D9DADECF__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16160520)
#define CLASS_1_CCB3A003D9DADECF__CTOR_OFFSET UNITYSDK_OFFSET(0x16160300)

inline static constexpr unsigned int Class_1_CCB3A003D9DADECF_TypeDefinitionIndex = 74025;

class Class_1_CCB3A003D9DADECF : public ::System::Object
{
public:
	::RPG::GameCore::FixPoint _Atk_k__BackingField; // 0x10
	::RPG::GameCore::FixPoint _CrtChance_k__BackingField; // 0x18
	::RPG::GameCore::FixPoint _AttackRange_k__BackingField; // 0x20
	::RPG::GameCore::FixPoint _AtkSpd_k__BackingField; // 0x28
	::RPG::GameCore::FixPoint _CrtDamageRatio_k__BackingField; // 0x30
	::System::UInt32 _UnitID_k__BackingField; // 0x38
	...
	::RPG::GameCore::FixPoint _Hp_k__BackingField; // 0x50
	::System::Single _ReadyScale_k__BackingField; // 0x58
	::System::Single _AttackCD_k__BackingField; // 0x5C
