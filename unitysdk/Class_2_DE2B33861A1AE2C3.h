...
#define CLASS_2_DE2B33861A1AE2C3_METHOD_2_326AAA53D203A730_OFFSET UNITYSDK_OFFSET(0x15C78990)
#define CLASS_2_DE2B33861A1AE2C3_METHOD_2_57FC422C238CCA4F_OFFSET UNITYSDK_OFFSET(0x15C793A0)
#define CLASS_2_DE2B33861A1AE2C3_METHOD_2_BEBC8F4773DC82AA_OFFSET UNITYSDK_OFFSET(0x15C79080)
#define CLASS_2_DE2B33861A1AE2C3__CTOR_OFFSET UNITYSDK_OFFSET(0x15C78900)
#define CLASS_2_DE2B33861A1AE2C3__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x15C790F0)
#define CLASS_2_DE2B33861A1AE2C3__ONTICK_OFFSET UNITYSDK_OFFSET(0x15C79340)
#define CLASS_2_DE2B33861A1AE2C3__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x15C79190)

inline static constexpr unsigned int Class_2_DE2B33861A1AE2C3_TypeDefinitionIndex = 72411;

class Class_2_DE2B33861A1AE2C3 : public ::RPG::Client::UIController
{
public:
	::System::Boolean JPPFGNBCEIL; // 0x188
	::System::Single KEKHDBKLHOK; // 0x18C
	::System::Single KJIGEHNHMOH; // 0x190
	::System::UInt32 MGLEPKGFODH; // 0x194
