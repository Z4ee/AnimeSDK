...
#define CLASS_2_7F8A3A18912E32CC_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC3ADF0)
#define CLASS_2_7F8A3A18912E32CC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAC3AE60)
#define CLASS_2_7F8A3A18912E32CC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAC3AFD0)
#define CLASS_2_7F8A3A18912E32CC_TICK_OFFSET UNITYSDK_OFFSET(0xAC3B020)
#define CLASS_2_7F8A3A18912E32CC__CTOR_OFFSET UNITYSDK_OFFSET(0xAC3AD60)

inline static constexpr unsigned int Class_2_7F8A3A18912E32CC_TypeDefinitionIndex = 42532;

class Class_2_7F8A3A18912E32CC : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterModelComponent* Field_2_4; // 0x18
