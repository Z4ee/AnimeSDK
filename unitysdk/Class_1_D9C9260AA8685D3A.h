...
#define CLASS_1_D9C9260AA8685D3A_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0x17FB6480)
#define CLASS_1_D9C9260AA8685D3A_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x17FB63E0)
#define CLASS_1_D9C9260AA8685D3A_GET_LIGHTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17FB6260)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x17FB6300)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_8CC9D262040F004A_OFFSET UNITYSDK_OFFSET(0x17FB6550)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_9519692C1DBF10E6_1_OFFSET UNITYSDK_OFFSET(0x17FB6660)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_9519692C1DBF10E6_OFFSET UNITYSDK_OFFSET(0x17FB6600)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x17FB62C0)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17FB6270)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_FDD9D091D27FA33F_OFFSET UNITYSDK_OFFSET(0x17FB64D0)
#define CLASS_1_D9C9260AA8685D3A_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x17FB6DF0)
#define CLASS_1_D9C9260AA8685D3A_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x17FB6FC0)
#define CLASS_1_D9C9260AA8685D3A_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x17FB6E80)
#define CLASS_1_D9C9260AA8685D3A_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x17FB7060)
#define CLASS_1_D9C9260AA8685D3A_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0x17FB6B40)
#define CLASS_1_D9C9260AA8685D3A_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0x17FB6390)
#define CLASS_1_D9C9260AA8685D3A_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0x17FB6350)
#define CLASS_1_D9C9260AA8685D3A_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x17FB72A0)
#define CLASS_1_D9C9260AA8685D3A_ONPREUNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x17FB7210)
#define CLASS_1_D9C9260AA8685D3A_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0x17FB6AC0)
#define CLASS_1_D9C9260AA8685D3A_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x17FB6BD0)
#define CLASS_1_D9C9260AA8685D3A_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x17FB6D50)
#define CLASS_1_D9C9260AA8685D3A_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x17FB6F10)
#define CLASS_1_D9C9260AA8685D3A_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0x17FB7100)
#define CLASS_1_D9C9260AA8685D3A_ONTURNOFF_OFFSET UNITYSDK_OFFSET(0x17FB6CD0)
#define CLASS_1_D9C9260AA8685D3A_ONTURNON_OFFSET UNITYSDK_OFFSET(0x17FB6C50)
#define CLASS_1_D9C9260AA8685D3A_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x17FB7190)
#define CLASS_1_D9C9260AA8685D3A_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0x17FB6430)
#define CLASS_1_D9C9260AA8685D3A_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x17FB66C0)
#define CLASS_1_D9C9260AA8685D3A__CTOR_OFFSET UNITYSDK_OFFSET(0x17FB62B0)
#define CLASS_1_D9C9260AA8685D3A__UNSERIALIZEASYNC_B__21_0_OFFSET UNITYSDK_OFFSET(0x17FB7320)
#define CLASS_1_D9C9260AA8685D3A__UNSERIALIZEASYNC_B__21_1_OFFSET UNITYSDK_OFFSET(0x17FB7380)
...
{
public:
	::RPG::CustomRP::CRPProbe* BHNADPMKCDF; // 0x10
	::UnityEngine::ReflectionProbe* DFDGGMEIICL; // 0x18
	::RPG::CustomRP::CRPProbe* GMIOPBAGHNN; // 0x20
	::UnityEngine::ReflectionProbe* FMKHAJEINDH; // 0x28
