...
#define CLASS_1_5B567C8A01BAEDFE_15_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A52C080)
#define CLASS_1_5B567C8A01BAEDFE_15_CLONE_OFFSET UNITYSDK_OFFSET(0x1A52BE90)
#define CLASS_1_5B567C8A01BAEDFE_15_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A52BF90)
#define CLASS_1_5B567C8A01BAEDFE_15_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A52BF00)
#define CLASS_1_5B567C8A01BAEDFE_15_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A52BFE0)
#define CLASS_1_5B567C8A01BAEDFE_15_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A52C0D0)
#define CLASS_1_5B567C8A01BAEDFE_15_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A52C0A0)
#define CLASS_1_5B567C8A01BAEDFE_15_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A52BDE0)
#define CLASS_1_5B567C8A01BAEDFE_15_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A52BE40)
#define CLASS_1_5B567C8A01BAEDFE_15_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A52C010)
#define CLASS_1_5B567C8A01BAEDFE_15_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A52C070)
#define CLASS_1_5B567C8A01BAEDFE_15__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A52C120)
#define CLASS_1_5B567C8A01BAEDFE_15__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A52BE60)
#define CLASS_1_5B567C8A01BAEDFE_15__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52BE50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_15_TypeDefinitionIndex = 24654;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_15*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_15_TypeDefinitionIndex)->GetStaticField(0xF320);
	}
