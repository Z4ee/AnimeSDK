...
#define STAGEHARMONYAUDIODEMODULATOR_METHOD_3_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xABDA680)
#define STAGEHARMONYAUDIODEMODULATOR_METHOD_3_E1105A7D5DEEC97F_OFFSET UNITYSDK_OFFSET(0xABDA580)
#define STAGEHARMONYAUDIODEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xABDA530)
#define STAGEHARMONYAUDIODEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xABDA6C0)

inline static constexpr unsigned int StageHarmonyAudioDemodulator_TypeDefinitionIndex = 38381;
