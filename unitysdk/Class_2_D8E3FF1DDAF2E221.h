...
#define CLASS_2_D8E3FF1DDAF2E221_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1177F5B0)
#define CLASS_2_D8E3FF1DDAF2E221_METHOD_2_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x1177F7D0)
#define CLASS_2_D8E3FF1DDAF2E221_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1177F660)
#define CLASS_2_D8E3FF1DDAF2E221_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1177F710)
#define CLASS_2_D8E3FF1DDAF2E221_TICK_OFFSET UNITYSDK_OFFSET(0x1177F760)
#define CLASS_2_D8E3FF1DDAF2E221__CTOR_OFFSET UNITYSDK_OFFSET(0x1177F5A0)

inline static constexpr unsigned int Class_2_D8E3FF1DDAF2E221_TypeDefinitionIndex = 42685;

class Class_2_D8E3FF1DDAF2E221 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::DevPlayPerformanceE* Field_2_1; // 0x18
