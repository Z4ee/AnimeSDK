...
#define CLASS_2_D8E3FF1DDAF2E221_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15219AA0)
#define CLASS_2_D8E3FF1DDAF2E221_METHOD_2_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x15219CD0)
#define CLASS_2_D8E3FF1DDAF2E221_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15219B50)
#define CLASS_2_D8E3FF1DDAF2E221_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15219C10)
#define CLASS_2_D8E3FF1DDAF2E221_TICK_OFFSET UNITYSDK_OFFSET(0x15219C60)
#define CLASS_2_D8E3FF1DDAF2E221__CTOR_OFFSET UNITYSDK_OFFSET(0x15219A90)

inline static constexpr unsigned int Class_2_D8E3FF1DDAF2E221_TypeDefinitionIndex = 53008;

class Class_2_D8E3FF1DDAF2E221 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* APKCDIIEJLO; // 0x18
	::RPG::GameCore::LevelGraphComponent* HDHOHOOHBPF; // 0x20
	::RPG::GameCore::DevPlayPerformanceE* EJJEEJENLDA; // 0x28
