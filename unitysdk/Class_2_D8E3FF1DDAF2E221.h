...
#define CLASS_2_D8E3FF1DDAF2E221_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC3B5850)
#define CLASS_2_D8E3FF1DDAF2E221_METHOD_2_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xC3B5A80)
#define CLASS_2_D8E3FF1DDAF2E221_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC3B5900)
#define CLASS_2_D8E3FF1DDAF2E221_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC3B59C0)
#define CLASS_2_D8E3FF1DDAF2E221_TICK_OFFSET UNITYSDK_OFFSET(0xC3B5A10)
#define CLASS_2_D8E3FF1DDAF2E221__CTOR_OFFSET UNITYSDK_OFFSET(0xC3B5840)
...
{
public:
	::RPG::GameCore::DevPlayPerformanceE* EJJEEJENLDA; // 0x18
	::RPG::GameCore::LevelGraphComponent* HDHOHOOHBPF; // 0x20
	::RPG::GameCore::TaskContext* APKCDIIEJLO; // 0x28
