...
#define CLASS_1_5B567C8A01BAEDFE_165_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D038470)
#define CLASS_1_5B567C8A01BAEDFE_165_CLONE_OFFSET UNITYSDK_OFFSET(0x1D038160)
#define CLASS_1_5B567C8A01BAEDFE_165_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D038270)
#define CLASS_1_5B567C8A01BAEDFE_165_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D0381A0)
#define CLASS_1_5B567C8A01BAEDFE_165_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D0383D0)
#define CLASS_1_5B567C8A01BAEDFE_165_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D0384C0)
#define CLASS_1_5B567C8A01BAEDFE_165_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D038490)
#define CLASS_1_5B567C8A01BAEDFE_165_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D0380E0)
#define CLASS_1_5B567C8A01BAEDFE_165_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D038110)
#define CLASS_1_5B567C8A01BAEDFE_165_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D038400)
#define CLASS_1_5B567C8A01BAEDFE_165_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D038460)
#define CLASS_1_5B567C8A01BAEDFE_165__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D038510)
#define CLASS_1_5B567C8A01BAEDFE_165__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D038130)
#define CLASS_1_5B567C8A01BAEDFE_165__CTOR_OFFSET UNITYSDK_OFFSET(0x1D038120)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_165_TypeDefinitionIndex = 28611;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_165*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_165_TypeDefinitionIndex)->GetStaticField(0x2470);
	}
