...
#define CLASS_1_5B567C8A01BAEDFE_165_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FDC970)
#define CLASS_1_5B567C8A01BAEDFE_165_CLONE_OFFSET UNITYSDK_OFFSET(0x19FDC7E0)
#define CLASS_1_5B567C8A01BAEDFE_165_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FDC880)
#define CLASS_1_5B567C8A01BAEDFE_165_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FDC820)
#define CLASS_1_5B567C8A01BAEDFE_165_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FDC8D0)
#define CLASS_1_5B567C8A01BAEDFE_165_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FDC9C0)
#define CLASS_1_5B567C8A01BAEDFE_165_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FDC990)
#define CLASS_1_5B567C8A01BAEDFE_165_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19FDC760)
#define CLASS_1_5B567C8A01BAEDFE_165_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FDC790)
#define CLASS_1_5B567C8A01BAEDFE_165_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FDC900)
#define CLASS_1_5B567C8A01BAEDFE_165_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FDC960)
#define CLASS_1_5B567C8A01BAEDFE_165__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FDCA10)
#define CLASS_1_5B567C8A01BAEDFE_165__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FDC7B0)
#define CLASS_1_5B567C8A01BAEDFE_165__CTOR_OFFSET UNITYSDK_OFFSET(0x19FDC7A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_165_TypeDefinitionIndex = 27997;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_165*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_165_TypeDefinitionIndex)->GetStaticField(0x26580);
	}
