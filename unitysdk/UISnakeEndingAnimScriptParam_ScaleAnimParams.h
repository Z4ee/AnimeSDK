...
#define UISNAKEENDINGANIMSCRIPTPARAM_SCALEANIMPARAMS_CALVALUEBYEVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1B8D8810)
#define UISNAKEENDINGANIMSCRIPTPARAM_SCALEANIMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D88C0)

inline static constexpr unsigned int UISnakeEndingAnimScriptParam_ScaleAnimParams_TypeDefinitionIndex = 85449;
