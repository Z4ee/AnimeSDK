...
#define PREVIEWTRACKCAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB06C3E0)
#define PREVIEWTRACKCAMERA_PREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0xB06C6C0)
#define PREVIEWTRACKCAMERA_STOPPREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0xB06C5E0)
#define PREVIEWTRACKCAMERA_TICK_OFFSET UNITYSDK_OFFSET(0xB06C430)
#define PREVIEWTRACKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xB06C7D0)

inline static constexpr unsigned int PreviewTrackCamera_TypeDefinitionIndex = 44616;
