...
#define PREVIEWTRACKCAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8EBB7D0)
#define PREVIEWTRACKCAMERA_PREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x8EBBAA0)
#define PREVIEWTRACKCAMERA_STOPPREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x8EBB9D0)
#define PREVIEWTRACKCAMERA_TICK_OFFSET UNITYSDK_OFFSET(0x8EBB820)
#define PREVIEWTRACKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBBBB0)

inline static constexpr unsigned int PreviewTrackCamera_TypeDefinitionIndex = 38186;
