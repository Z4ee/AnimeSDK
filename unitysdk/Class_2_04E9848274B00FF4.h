...
#define CLASS_2_04E9848274B00FF4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x186C9270)
#define CLASS_2_04E9848274B00FF4_METHOD_2_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x186C9710)
#define CLASS_2_04E9848274B00FF4_METHOD_2_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x186C9160)
#define CLASS_2_04E9848274B00FF4_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x186C9350)
#define CLASS_2_04E9848274B00FF4_METHOD_2_F8F3571ABAE8B95A_OFFSET UNITYSDK_OFFSET(0x186C98B0)
#define CLASS_2_04E9848274B00FF4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x186C9450)
#define CLASS_2_04E9848274B00FF4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x186C9760)
#define CLASS_2_04E9848274B00FF4_TICK_OFFSET UNITYSDK_OFFSET(0x186C97B0)
#define CLASS_2_04E9848274B00FF4__CTOR_OFFSET UNITYSDK_OFFSET(0x186C90D0)

inline static constexpr unsigned int Class_2_04E9848274B00FF4_TypeDefinitionIndex = 55655;
...
public:
	...
	::RPG::GameCore::OnMuseumPerformanceBegin* Field_2_3; // 0x28
	...
	::System::Void Method_2_F8F3571ABAE8B95A(::Class_0_16E4307DCC419505_425* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_425*))((::PBYTE)hIl2Cpp + CLASS_2_04E9848274B00FF4_METHOD_2_F8F3571ABAE8B95A_OFFSET))(this, a1);
	}
};
