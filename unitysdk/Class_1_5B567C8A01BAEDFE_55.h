...
#define CLASS_1_5B567C8A01BAEDFE_55_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C3CAA70)
#define CLASS_1_5B567C8A01BAEDFE_55_CLONE_OFFSET UNITYSDK_OFFSET(0x1C3CA760)
#define CLASS_1_5B567C8A01BAEDFE_55_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C3CA870)
#define CLASS_1_5B567C8A01BAEDFE_55_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C3CA7A0)
#define CLASS_1_5B567C8A01BAEDFE_55_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C3CA9D0)
#define CLASS_1_5B567C8A01BAEDFE_55_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C3CAAC0)
#define CLASS_1_5B567C8A01BAEDFE_55_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C3CAA90)
#define CLASS_1_5B567C8A01BAEDFE_55_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C3CA6E0)
#define CLASS_1_5B567C8A01BAEDFE_55_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C3CA710)
#define CLASS_1_5B567C8A01BAEDFE_55_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C3CAA00)
#define CLASS_1_5B567C8A01BAEDFE_55_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C3CAA60)
#define CLASS_1_5B567C8A01BAEDFE_55__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3CAB10)
#define CLASS_1_5B567C8A01BAEDFE_55__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3CA730)
#define CLASS_1_5B567C8A01BAEDFE_55__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3CA720)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_55_TypeDefinitionIndex = 25910;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_55*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_55_TypeDefinitionIndex)->GetStaticField(0x20FC0);
	}
