...
#define CLASS_1_5B567C8A01BAEDFE_55_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E511D50)
#define CLASS_1_5B567C8A01BAEDFE_55_CLONE_OFFSET UNITYSDK_OFFSET(0x1E511A40)
#define CLASS_1_5B567C8A01BAEDFE_55_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E511B50)
#define CLASS_1_5B567C8A01BAEDFE_55_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E511A80)
#define CLASS_1_5B567C8A01BAEDFE_55_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E511CB0)
#define CLASS_1_5B567C8A01BAEDFE_55_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E511DA0)
#define CLASS_1_5B567C8A01BAEDFE_55_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E511D70)
#define CLASS_1_5B567C8A01BAEDFE_55_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E5119C0)
#define CLASS_1_5B567C8A01BAEDFE_55_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E5119F0)
#define CLASS_1_5B567C8A01BAEDFE_55_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E511CE0)
#define CLASS_1_5B567C8A01BAEDFE_55_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E511D40)
#define CLASS_1_5B567C8A01BAEDFE_55__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E511DF0)
#define CLASS_1_5B567C8A01BAEDFE_55__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E511A10)
#define CLASS_1_5B567C8A01BAEDFE_55__CTOR_OFFSET UNITYSDK_OFFSET(0x1E511A00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_55_TypeDefinitionIndex = 26567;

class Class_1_5B567C8A01BAEDFE_55 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_55*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_55*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_55_TypeDefinitionIndex)->GetStaticField(0x5D800);
	}
