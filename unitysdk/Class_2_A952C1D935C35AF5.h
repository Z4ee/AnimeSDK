...
#define CLASS_2_A952C1D935C35AF5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0013F0)
#define CLASS_2_A952C1D935C35AF5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A001430)
#define CLASS_2_A952C1D935C35AF5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A001530)
#define CLASS_2_A952C1D935C35AF5_TICK_OFFSET UNITYSDK_OFFSET(0x1A001580)
#define CLASS_2_A952C1D935C35AF5__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0013E0)

inline static constexpr unsigned int Class_2_A952C1D935C35AF5_TypeDefinitionIndex = 53467;

class Class_2_A952C1D935C35AF5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::RestoreTrackingMission* OFKGLJOAMLD; // 0x20
