...
#define CLASS_2_A952C1D935C35AF5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10502930)
#define CLASS_2_A952C1D935C35AF5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10502970)
#define CLASS_2_A952C1D935C35AF5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10502A70)
#define CLASS_2_A952C1D935C35AF5_TICK_OFFSET UNITYSDK_OFFSET(0x10502AC0)
#define CLASS_2_A952C1D935C35AF5__CTOR_OFFSET UNITYSDK_OFFSET(0x10502920)

inline static constexpr unsigned int Class_2_A952C1D935C35AF5_TypeDefinitionIndex = 43078;
