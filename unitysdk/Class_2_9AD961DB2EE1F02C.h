...
#define CLASS_2_9AD961DB2EE1F02C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0380C0)
#define CLASS_2_9AD961DB2EE1F02C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A038100)
#define CLASS_2_9AD961DB2EE1F02C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A0382B0)
#define CLASS_2_9AD961DB2EE1F02C_TICK_OFFSET UNITYSDK_OFFSET(0x1A0382F0)
#define CLASS_2_9AD961DB2EE1F02C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0380B0)
#define CLASS_2_9AD961DB2EE1F02C__ONTASKBEGIN_B__2_0_OFFSET UNITYSDK_OFFSET(0x1A038350)

inline static constexpr unsigned int Class_2_9AD961DB2EE1F02C_TypeDefinitionIndex = 53190;

class Class_2_9AD961DB2EE1F02C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::GravityBallPuzzleSwitchBoardWaitFinish* OFKGLJOAMLD; // 0x20
