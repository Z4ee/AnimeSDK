...
#define CLASS_2_9AD961DB2EE1F02C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x115C4940)
#define CLASS_2_9AD961DB2EE1F02C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x115C4980)
#define CLASS_2_9AD961DB2EE1F02C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x115C4B10)
#define CLASS_2_9AD961DB2EE1F02C_TICK_OFFSET UNITYSDK_OFFSET(0x115C4B50)
#define CLASS_2_9AD961DB2EE1F02C__CTOR_OFFSET UNITYSDK_OFFSET(0x115C4930)
#define CLASS_2_9AD961DB2EE1F02C__ONTASKBEGIN_B__2_0_OFFSET UNITYSDK_OFFSET(0x115C4BB0)

inline static constexpr unsigned int Class_2_9AD961DB2EE1F02C_TypeDefinitionIndex = 42822;

class Class_2_9AD961DB2EE1F02C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::GravityBallPuzzleSwitchBoardWaitFinish* Field_2_1; // 0x18
