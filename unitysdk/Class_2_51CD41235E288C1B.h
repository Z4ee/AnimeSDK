...
#define CLASS_2_51CD41235E288C1B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10670510)
#define CLASS_2_51CD41235E288C1B_METHOD_2_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x1066FFE0)
#define CLASS_2_51CD41235E288C1B_METHOD_2_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0x10670600)
#define CLASS_2_51CD41235E288C1B_METHOD_2_A61A196E6AD5766D_OFFSET UNITYSDK_OFFSET(0x10670240)
#define CLASS_2_51CD41235E288C1B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1066FCA0)
#define CLASS_2_51CD41235E288C1B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10670550)
#define CLASS_2_51CD41235E288C1B_TICK_OFFSET UNITYSDK_OFFSET(0x106705A0)
#define CLASS_2_51CD41235E288C1B__CTOR_OFFSET UNITYSDK_OFFSET(0x1066FC90)
...
{
public:
	::RPG::GameCore::PlayPenaconyEndmostShowPage* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x20
	::Class_2_A48F3719AA1CF200_4* JLMAKNFAEBH; // 0x28
	::RPG::GameCore::GameEntity* GGPBBEOEPCB; // 0x30
