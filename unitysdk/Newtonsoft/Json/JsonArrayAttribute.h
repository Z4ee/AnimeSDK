...
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE_GET_ALLOWNULLITEMS_OFFSET UNITYSDK_OFFSET(0x1FC31030)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE_SET_ALLOWNULLITEMS_OFFSET UNITYSDK_OFFSET(0x1FC31040)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FC31060)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1FC31070)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC31050)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonArrayAttribute_TypeDefinitionIndex = 6992;
