...
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE_GET_ALLOWNULLITEMS_OFFSET UNITYSDK_OFFSET(0x1C51C990)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE_SET_ALLOWNULLITEMS_OFFSET UNITYSDK_OFFSET(0x1C51C9A0)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C51C9C0)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C51C9D0)
#define NEWTONSOFT_JSON_JSONARRAYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C51C9B0)
