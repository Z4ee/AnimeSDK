...
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1642E790)
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1642E4A0)
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1642EC30)

namespace Newtonsoft::Json::Converters
{
	inline static constexpr unsigned int JavaScriptDateTimeConverter_TypeDefinitionIndex = 8426;
