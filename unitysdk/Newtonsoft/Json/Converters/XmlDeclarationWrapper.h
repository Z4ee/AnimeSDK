...
#define NEWTONSOFT_JSON_CONVERTERS_XMLDECLARATIONWRAPPER_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x18127F10)
#define NEWTONSOFT_JSON_CONVERTERS_XMLDECLARATIONWRAPPER_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x18127F30)
#define NEWTONSOFT_JSON_CONVERTERS_XMLDECLARATIONWRAPPER_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x18127EF0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLDECLARATIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18127ED0)

namespace Newtonsoft::Json::Converters
{
	inline static constexpr unsigned int XmlDeclarationWrapper_TypeDefinitionIndex = 9769;
