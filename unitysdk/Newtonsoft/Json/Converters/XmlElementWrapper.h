...
#define NEWTONSOFT_JSON_CONVERTERS_XMLELEMENTWRAPPER_GETPREFIXOFNAMESPACE_OFFSET UNITYSDK_OFFSET(0x165D9C20)
#define NEWTONSOFT_JSON_CONVERTERS_XMLELEMENTWRAPPER_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x165D9C60)
#define NEWTONSOFT_JSON_CONVERTERS_XMLELEMENTWRAPPER_SETATTRIBUTENODE_OFFSET UNITYSDK_OFFSET(0x165D9AE0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLELEMENTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x165D9680)

namespace Newtonsoft::Json::Converters
{
	inline static constexpr unsigned int XmlElementWrapper_TypeDefinitionIndex = 9489;
