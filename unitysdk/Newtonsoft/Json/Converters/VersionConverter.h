...
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x16431640)
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x16431440)
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x16431370)
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16431680)

namespace Newtonsoft::Json::Converters
{
	inline static constexpr unsigned int VersionConverter_TypeDefinitionIndex = 8424;
