...
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_GET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1FC27490)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_GET_DATETIMEFORMAT_OFFSET UNITYSDK_OFFSET(0x1FC27440)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_GET_DATETIMESTYLES_OFFSET UNITYSDK_OFFSET(0x1FC27420)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1FC27750)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_SET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1FC274A0)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_SET_DATETIMEFORMAT_OFFSET UNITYSDK_OFFSET(0x1FC27460)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_SET_DATETIMESTYLES_OFFSET UNITYSDK_OFFSET(0x1FC27430)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1FC274B0)
#define NEWTONSOFT_JSON_CONVERTERS_ISODATETIMECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC27DB0)

namespace Newtonsoft::Json::Converters
{
	inline static constexpr unsigned int IsoDateTimeConverter_TypeDefinitionIndex = 7227;
