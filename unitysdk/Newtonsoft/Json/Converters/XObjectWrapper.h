...
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_APPENDCHILD_OFFSET UNITYSDK_OFFSET(0x181279D0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x181279A0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_CHILDNODES_OFFSET UNITYSDK_OFFSET(0x18127940)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x18127930)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x18127A20)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x181278A0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x181279B0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x181279C0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_WRAPPEDNODE_OFFSET UNITYSDK_OFFSET(0x18127890)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18127A30)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18123DA0)
...
namespace Newtonsoft::Json::Converters
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>**)Il2CppClass::FromTypeDefinitionIndex(XObjectWrapper_TypeDefinitionIndex)->GetStaticField(0x3CC30);
		}
