...
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BF7D320)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BF7D340)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1BF7D330)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BF7D350)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF7D360)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonProperty_TypeDefinitionIndex = 7111;
