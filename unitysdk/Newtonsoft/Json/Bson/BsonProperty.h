...
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1F6E1130)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1F6E1150)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1F6E1140)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1F6E1160)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6E1170)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonProperty_TypeDefinitionIndex = 7246;
