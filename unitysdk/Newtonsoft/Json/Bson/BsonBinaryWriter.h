...
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CALCULATESIZEWITHLENGTH_OFFSET UNITYSDK_OFFSET(0x1E9E72C0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CALCULATESIZE_1_OFFSET UNITYSDK_OFFSET(0x1E9E52B0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E9E72B0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E9E5250)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E9E5220)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_GET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1E9E51F0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_SET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1E9E5200)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1E9E7090)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITETOKENINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E9E5DD0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITETOKEN_OFFSET UNITYSDK_OFFSET(0x1E9E5280)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITEUTF8BYTES_OFFSET UNITYSDK_OFFSET(0x1E9E7100)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E9E72D0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9E5210)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonBinaryWriter_TypeDefinitionIndex = 7234;
	...
	public:
		...
		{
			return (::System::Text::Encoding**)Il2CppClass::FromTypeDefinitionIndex(BsonBinaryWriter_TypeDefinitionIndex)->GetStaticField(0x5FE0);
		}
