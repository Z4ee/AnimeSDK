...
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_GET_CALCULATEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B603DC0)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B603DA0)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_SET_CALCULATEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B603DD0)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B603DB0)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B603DE0)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonToken_TypeDefinitionIndex = 7104;
