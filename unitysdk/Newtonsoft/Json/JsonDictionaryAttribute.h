...
#define NEWTONSOFT_JSON_JSONDICTIONARYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16440080)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonDictionaryAttribute_TypeDefinitionIndex = 8189;
