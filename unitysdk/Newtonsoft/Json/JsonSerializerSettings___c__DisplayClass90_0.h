...
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS___C__DISPLAYCLASS90_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C131FE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS___C__DISPLAYCLASS90_0__SET_REFERENCERESOLVER_B__0_OFFSET UNITYSDK_OFFSET(0x1C131FF0)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonSerializerSettings___c__DisplayClass90_0_TypeDefinitionIndex = 6879;
