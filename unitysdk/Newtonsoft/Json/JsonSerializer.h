...
#define NEWTONSOFT_JSON_JSONSERIALIZER_ADD_ERROR_OFFSET UNITYSDK_OFFSET(0x1BDF7490)
#define NEWTONSOFT_JSON_JSONSERIALIZER_APPLYSERIALIZERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BDF8350)
#define NEWTONSOFT_JSON_JSONSERIALIZER_CREATEDEFAULT_1_OFFSET UNITYSDK_OFFSET(0x1BDF8CA0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_CREATEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1BDF8B50)
#define NEWTONSOFT_JSON_JSONSERIALIZER_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1BDF82F0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_CREATE_OFFSET UNITYSDK_OFFSET(0x1BDF82A0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_DESERIALIZEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BDF9B40)
#define NEWTONSOFT_JSON_JSONSERIALIZER_DESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1BDF9A50)
#define NEWTONSOFT_JSON_JSONSERIALIZER_DESERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1BDF9A40)
#define NEWTONSOFT_JSON_JSONSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BDF9A20)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GETMATCHINGCONVERTER_1_OFFSET UNITYSDK_OFFSET(0x1BDFA7A0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GETMATCHINGCONVERTER_OFFSET UNITYSDK_OFFSET(0x1BDFA790)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GETREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1BDF75E0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1BDF76A0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_CHECKADDITIONALCONTENT_OFFSET UNITYSDK_OFFSET(0x1BDF8110)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_CONSTRUCTORHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7B60)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1BDF7DB0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_CONTRACTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1BDF7CE0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_CONVERTERS_OFFSET UNITYSDK_OFFSET(0x1BDF7C60)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1BDF7FF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_DATEFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7E10)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_DATEFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1BDF7F90)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_DATEPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7E90)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_DATETIMEZONEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7E50)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_DEFAULTVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7A60)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_EQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1BDF7740)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_FLOATFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7F10)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_FLOATPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7ED0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_FORMATTING_OFFSET UNITYSDK_OFFSET(0x1BDF7DD0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0x1BDF8070)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_METADATAPROPERTYHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7BE0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_MISSINGMEMBERHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7960)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_NULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF79E0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_OBJECTCREATIONHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7AE0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_PRESERVEREFERENCESHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7860)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_REFERENCELOOPHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF78E0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_REFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1BDF7590)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_STRINGESCAPEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7F50)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_TRACEWRITER_OFFSET UNITYSDK_OFFSET(0x1BDF7720)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_TYPENAMEASSEMBLYFORMAT_OFFSET UNITYSDK_OFFSET(0x1BDF77E0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_GET_TYPENAMEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7760)
#define NEWTONSOFT_JSON_JSONSERIALIZER_ISCHECKADDITIONALCONTENTSET_OFFSET UNITYSDK_OFFSET(0x1BDF8140)
#define NEWTONSOFT_JSON_JSONSERIALIZER_ONERROR_OFFSET UNITYSDK_OFFSET(0x1BDFA960)
#define NEWTONSOFT_JSON_JSONSERIALIZER_POPULATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BDF8DD0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_POPULATE_1_OFFSET UNITYSDK_OFFSET(0x1BDF8DC0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_POPULATE_OFFSET UNITYSDK_OFFSET(0x1BDF8CD0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_REMOVE_ERROR_OFFSET UNITYSDK_OFFSET(0x1BDF7510)
#define NEWTONSOFT_JSON_JSONSERIALIZER_RESETREADER_OFFSET UNITYSDK_OFFSET(0x1BDF9760)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SERIALIZEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BDF9F30)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1BDF9E90)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1BDF9EB0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1BDF9E70)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BDF9DF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SETUPREADER_OFFSET UNITYSDK_OFFSET(0x1BDF90A0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1BDF76B0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_CHECKADDITIONALCONTENT_OFFSET UNITYSDK_OFFSET(0x1BDF8130)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_CONSTRUCTORHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7B70)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1BDF7DC0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_CONTRACTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1BDF7CF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1BDF8060)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_DATEFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7E30)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_DATEFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1BDF7FE0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_DATEPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7EB0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_DATETIMEZONEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7E70)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_DEFAULTVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7A70)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_EQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1BDF7750)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_FLOATFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7F30)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_FLOATPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7EF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_FORMATTING_OFFSET UNITYSDK_OFFSET(0x1BDF7DF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0x1BDF8080)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_METADATAPROPERTYHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7BF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_MISSINGMEMBERHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7970)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_NULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF79F0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_OBJECTCREATIONHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7AF0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_PRESERVEREFERENCESHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7870)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_REFERENCELOOPHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF78F0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_REFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1BDF7630)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_STRINGESCAPEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7F70)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_TRACEWRITER_OFFSET UNITYSDK_OFFSET(0x1BDF7730)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_TYPENAMEASSEMBLYFORMAT_OFFSET UNITYSDK_OFFSET(0x1BDF77F0)
#define NEWTONSOFT_JSON_JSONSERIALIZER_SET_TYPENAMEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BDF7770)
#define NEWTONSOFT_JSON_JSONSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF8150)
...
namespace Newtonsoft::Json
{
	...
	public:
		...
		::Newtonsoft::Json::JsonConverterCollection* _converters; // 0x28
		::System::Collections::IEqualityComparer* _equalityComparer; // 0x30
		::Newtonsoft::Json::Serialization::IContractResolver* _contractResolver; // 0x38
		::System::Runtime::Serialization::StreamingContext _context; // 0x40
		::System::Runtime::Serialization::SerializationBinder* _binder; // 0x50
		::System::EventHandler_1<::Newtonsoft::Json::Serialization::ErrorEventArgs*>* Error; // 0x58
		::Newtonsoft::Json::Serialization::IReferenceResolver* _referenceResolver; // 0x60
		::System::Nullable_1<::Newtonsoft::Json::FloatFormatHandling> _floatFormatHandling; // 0x68
		...
		::System::Nullable_1<::Newtonsoft::Json::DateTimeZoneHandling> _dateTimeZoneHandling; // 0x88
		::Newtonsoft::Json::MissingMemberHandling _missingMemberHandling; // 0x90
		::Newtonsoft::Json::ObjectCreationHandling _objectCreationHandling; // 0x94
		::System::Nullable_1<::Newtonsoft::Json::DateFormatHandling> _dateFormatHandling; // 0x98
		::Newtonsoft::Json::NullValueHandling _nullValueHandling; // 0xA0
		::Newtonsoft::Json::ReferenceLoopHandling _referenceLoopHandling; // 0xA4
		::Newtonsoft::Json::ConstructorHandling _constructorHandling; // 0xA8
		::System::Nullable_1<::Newtonsoft::Json::StringEscapeHandling> _stringEscapeHandling; // 0xAC
		::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle _typeNameAssemblyFormat; // 0xB4
		...
		::Newtonsoft::Json::TypeNameHandling _typeNameHandling; // 0xC8
		::Newtonsoft::Json::PreserveReferencesHandling _preserveReferencesHandling; // 0xCC
		::Newtonsoft::Json::DefaultValueHandling _defaultValueHandling; // 0xD0
