...
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER_GET_GETTER_OFFSET UNITYSDK_OFFSET(0x1EF14FC0)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x1EF14FA0)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER_GET_SETTER_OFFSET UNITYSDK_OFFSET(0x1EF14FE0)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER_SET_GETTER_OFFSET UNITYSDK_OFFSET(0x1EF14FD0)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER_SET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x1EF14FB0)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER_SET_SETTER_OFFSET UNITYSDK_OFFSET(0x1EF14FF0)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF15000)

namespace Newtonsoft::Json::Utilities
{
	inline static constexpr unsigned int ReflectionMember_TypeDefinitionIndex = 7078;
