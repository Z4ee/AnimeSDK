...
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONOBJECT___C__DISPLAYCLASS13_1__CREATE_B__1_OFFSET UNITYSDK_OFFSET(0x164A2D90)
#define NEWTONSOFT_JSON_UTILITIES_REFLECTIONOBJECT___C__DISPLAYCLASS13_1__CTOR_OFFSET UNITYSDK_OFFSET(0x164A2A20)

namespace Newtonsoft::Json::Utilities
{
	inline static constexpr unsigned int ReflectionObject___c__DisplayClass13_1_TypeDefinitionIndex = 8250;
