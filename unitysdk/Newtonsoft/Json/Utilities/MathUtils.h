...
#define NEWTONSOFT_JSON_UTILITIES_MATHUTILS_APPROXEQUALS_OFFSET UNITYSDK_OFFSET(0x1EF14F40)
#define NEWTONSOFT_JSON_UTILITIES_MATHUTILS_INTLENGTH_OFFSET UNITYSDK_OFFSET(0x1EF14C90)
#define NEWTONSOFT_JSON_UTILITIES_MATHUTILS_INTTOHEX_OFFSET UNITYSDK_OFFSET(0x1EF14E00)
#define NEWTONSOFT_JSON_UTILITIES_MATHUTILS_MAX_1_OFFSET UNITYSDK_OFFSET(0x1EF14ED0)
#define NEWTONSOFT_JSON_UTILITIES_MATHUTILS_MAX_OFFSET UNITYSDK_OFFSET(0x1EF14E70)
#define NEWTONSOFT_JSON_UTILITIES_MATHUTILS_MIN_OFFSET UNITYSDK_OFFSET(0x1EF14E10)

namespace Newtonsoft::Json::Utilities
{
	inline static constexpr unsigned int MathUtils_TypeDefinitionIndex = 7071;
