...
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_COPYFROMJAGGEDTOMULTIDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x15BC0B50)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_GETDIMENSIONS_OFFSET UNITYSDK_OFFSET(0x15BC0580)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_ISDICTIONARYTYPE_OFFSET UNITYSDK_OFFSET(0x15B95320)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_JAGGEDARRAYGETVALUE_OFFSET UNITYSDK_OFFSET(0x15BC0EF0)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_RESOLVEENUMERABLECOLLECTIONCONSTRUCTOR_1_OFFSET UNITYSDK_OFFSET(0x15B9CDD0)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_RESOLVEENUMERABLECOLLECTIONCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x15B9A580)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_TOMULTIDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x15BAAA80)

namespace Newtonsoft::Json::Utilities
{
	inline static constexpr unsigned int CollectionUtils_TypeDefinitionIndex = 9338;
