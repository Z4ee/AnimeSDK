...
#define NEWTONSOFT_JSON_UTILITIES_CONVERTUTILS___C__DISPLAYCLASS9_0__CREATECASTCONVERTER_B__0_OFFSET UNITYSDK_OFFSET(0x1649A420)
#define NEWTONSOFT_JSON_UTILITIES_CONVERTUTILS___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16496ED0)

namespace Newtonsoft::Json::Utilities
{
	inline static constexpr unsigned int ConvertUtils___c__DisplayClass9_0_TypeDefinitionIndex = 8262;
