...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYEXPRESSION_GET_OPERATOR_OFFSET UNITYSDK_OFFSET(0x1BDFB900)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYEXPRESSION_SET_OPERATOR_OFFSET UNITYSDK_OFFSET(0x1BDFB910)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFB920)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int QueryExpression_TypeDefinitionIndex = 7081;
