...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BF815F0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BF81BF0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF81B80)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BF81DE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF81BE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BF81B90)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BF81410)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF81340)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1BF81510)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int ScanFilter__ExecuteFilter_d__4_TypeDefinitionIndex = 7087;
	...
	public:
		...
		::Newtonsoft::Json::Linq::JsonPath::ScanFilter* __4__this; // 0x20
		::Newtonsoft::Json::Linq::JToken* _root_5__1; // 0x28
		...
		::Newtonsoft::Json::Linq::JToken* _value_5__2; // 0x40
