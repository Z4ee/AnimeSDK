...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1ED32C20)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1ED32C00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1ED32C10)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED32C90)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int QueryFilter_TypeDefinitionIndex = 7219;
