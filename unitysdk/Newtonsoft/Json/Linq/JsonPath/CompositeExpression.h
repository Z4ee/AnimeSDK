...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_GET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1DF70960)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1DF70A00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_SET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1DF70970)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF70980)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int CompositeExpression_TypeDefinitionIndex = 7213;
