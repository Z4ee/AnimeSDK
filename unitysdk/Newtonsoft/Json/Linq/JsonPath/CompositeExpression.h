...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_GET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1F35F480)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1F35F520)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_SET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1F35F490)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F35F4A0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int CompositeExpression_TypeDefinitionIndex = 7217;
