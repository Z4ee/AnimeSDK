...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E2F3980)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E2F4060)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E2F3FF0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E2F4250)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E2F4050)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E2F4000)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E2F35B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2F34E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1E2F38A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1E2F37C0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int QueryFilter__ExecuteFilter_d__4_TypeDefinitionIndex = 7216;
	...
	public:
		...
		::Newtonsoft::Json::Linq::JsonPath::QueryFilter* __4__this; // 0x28
