...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1F307800)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_ENSURELENGTH_OFFSET UNITYSDK_OFFSET(0x1F3083A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1F30B890)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1F30B880)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_GET_FILTERS_OFFSET UNITYSDK_OFFSET(0x1F3073F0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_MATCH_OFFSET UNITYSDK_OFFSET(0x1F30B390)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEARRAYINDEXER_OFFSET UNITYSDK_OFFSET(0x1F308C00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1F3096F0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEINDEXER_OFFSET UNITYSDK_OFFSET(0x1F308160)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEMAIN_OFFSET UNITYSDK_OFFSET(0x1F307510)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEOPERATOR_OFFSET UNITYSDK_OFFSET(0x1F30A4A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x1F3078A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEQUERY_OFFSET UNITYSDK_OFFSET(0x1F308860)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEQUOTEDFIELD_OFFSET UNITYSDK_OFFSET(0x1F308420)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1F30AB60)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_READQUOTEDSTRING_OFFSET UNITYSDK_OFFSET(0x1F30B4C0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_SET_FILTERS_OFFSET UNITYSDK_OFFSET(0x1F307400)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1F307410)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int JPath_TypeDefinitionIndex = 7213;
