...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1BBA3A60)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_ENSURELENGTH_OFFSET UNITYSDK_OFFSET(0x1BBA4790)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1BBA7CA0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1BBA7C90)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_GET_FILTERS_OFFSET UNITYSDK_OFFSET(0x1BBA3650)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_MATCH_OFFSET UNITYSDK_OFFSET(0x1BBA7750)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEARRAYINDEXER_OFFSET UNITYSDK_OFFSET(0x1BBA4FE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1BBA5AD0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEINDEXER_OFFSET UNITYSDK_OFFSET(0x1BBA4550)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEMAIN_OFFSET UNITYSDK_OFFSET(0x1BBA3770)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEOPERATOR_OFFSET UNITYSDK_OFFSET(0x1BBA6870)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x1BBA3B00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEQUERY_OFFSET UNITYSDK_OFFSET(0x1BBA4C40)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEQUOTEDFIELD_OFFSET UNITYSDK_OFFSET(0x1BBA4810)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1BBA6F20)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_READQUOTEDSTRING_OFFSET UNITYSDK_OFFSET(0x1BBA7880)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_SET_FILTERS_OFFSET UNITYSDK_OFFSET(0x1BBA3660)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBA3670)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int JPath_TypeDefinitionIndex = 7078;
