...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1C0A16C0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C0A16A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C0A16B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0A18B0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int FieldFilter_TypeDefinitionIndex = 7073;
