...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1F7FFCB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1F7FFC90)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1F7FFCA0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7FFEA0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int FieldFilter_TypeDefinitionIndex = 7208;
