...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1C51CA00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1C51C9E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_SET_NAMES_OFFSET UNITYSDK_OFFSET(0x1C51C9F0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C51CA70)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int FieldMultipleFilter_TypeDefinitionIndex = 7075;
