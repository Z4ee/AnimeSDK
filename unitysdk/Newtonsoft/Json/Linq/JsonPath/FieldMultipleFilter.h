...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1FC310A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1FC31080)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_SET_NAMES_OFFSET UNITYSDK_OFFSET(0x1FC31090)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC31110)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int FieldMultipleFilter_TypeDefinitionIndex = 7210;
