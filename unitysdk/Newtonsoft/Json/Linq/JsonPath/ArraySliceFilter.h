...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1ED32B60)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_END_OFFSET UNITYSDK_OFFSET(0x1ED32B20)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_START_OFFSET UNITYSDK_OFFSET(0x1ED32B00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1ED32B40)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1ED32BD0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_END_OFFSET UNITYSDK_OFFSET(0x1ED32B30)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_START_OFFSET UNITYSDK_OFFSET(0x1ED32B10)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1ED32B50)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED32BF0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int ArraySliceFilter_TypeDefinitionIndex = 7206;

	class ArraySliceFilter : public ::Newtonsoft::Json::Linq::JsonPath::PathFilter
	{
	public:
		::System::Nullable_1<::System::Int32> _Step_k__BackingField; // 0x10
		::System::Nullable_1<::System::Int32> _Start_k__BackingField; // 0x18
