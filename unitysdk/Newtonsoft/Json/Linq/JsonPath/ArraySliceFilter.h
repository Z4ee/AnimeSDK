...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1D9BD930)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_END_OFFSET UNITYSDK_OFFSET(0x1D9BD8F0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_START_OFFSET UNITYSDK_OFFSET(0x1D9BD8D0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1D9BD910)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D9BD9A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_END_OFFSET UNITYSDK_OFFSET(0x1D9BD900)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_START_OFFSET UNITYSDK_OFFSET(0x1D9BD8E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1D9BD920)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9BD9C0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int ArraySliceFilter_TypeDefinitionIndex = 7202;
