...
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E870C90)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E870D90)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E870D20)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E870F70)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E870D80)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E870D30)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E870C80)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__BEFORESELF_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x1E870BB0)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken__BeforeSelf_d__43_TypeDefinitionIndex = 7188;

	class JToken__BeforeSelf_d__43 : public ::System::Object
	{
	public:
		::Newtonsoft::Json::Linq::JToken* __2__current; // 0x10
		::Newtonsoft::Json::Linq::JToken* __4__this; // 0x18
