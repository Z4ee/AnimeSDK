...
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C1321D0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C132410)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C1323A0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C132600)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C132400)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C1323B0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C1321C0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__ANNOTATIONS_D__172__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1320F0)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken__Annotations_d__172_TypeDefinitionIndex = 7059;
