...
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E469970)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E469A70)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E469A00)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E469C60)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E469A60)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E469A10)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E469960)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x1E469890)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken__GetAncestors_d__41_TypeDefinitionIndex = 7186;
	...
	public:
		...
		::Newtonsoft::Json::Linq::JToken* _current_5__1; // 0x20
		::System::Int32 __l__initialThreadId; // 0x28
		::System::Boolean __3__self; // 0x2C
		::System::Boolean self; // 0x2D
