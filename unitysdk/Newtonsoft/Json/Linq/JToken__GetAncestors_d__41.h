...
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C1326F0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C1327F0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C132780)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C1329E0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C1327E0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C132790)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C1326E0)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x1C132610)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken__GetAncestors_d__41_TypeDefinitionIndex = 7055;
