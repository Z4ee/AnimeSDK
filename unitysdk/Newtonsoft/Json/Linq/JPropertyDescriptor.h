...
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x1ED327F0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_CASTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ED32780)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1ED32800)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ED32A80)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1ED32AB0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_NAMEHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED32AF0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1ED32AC0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1ED328B0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1ED328C0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1ED32A70)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED32770)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JPropertyDescriptor_TypeDefinitionIndex = 7183;
