...
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_GET_COMMENTHANDLING_OFFSET UNITYSDK_OFFSET(0x1FC4F920)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_GET_LINEINFOHANDLING_OFFSET UNITYSDK_OFFSET(0x1FC4F9A0)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_SET_COMMENTHANDLING_OFFSET UNITYSDK_OFFSET(0x1FC4F930)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_SET_LINEINFOHANDLING_OFFSET UNITYSDK_OFFSET(0x1FC4F9B0)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC4FA20)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JsonLoadSettings_TypeDefinitionIndex = 7186;
