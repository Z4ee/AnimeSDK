...
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_GET_COMMENTHANDLING_OFFSET UNITYSDK_OFFSET(0x1C53FE60)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_GET_LINEINFOHANDLING_OFFSET UNITYSDK_OFFSET(0x1C53FEE0)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_SET_COMMENTHANDLING_OFFSET UNITYSDK_OFFSET(0x1C53FE70)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS_SET_LINEINFOHANDLING_OFFSET UNITYSDK_OFFSET(0x1C53FEF0)
#define NEWTONSOFT_JSON_LINQ_JSONLOADSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C53FF60)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JsonLoadSettings_TypeDefinitionIndex = 7051;
