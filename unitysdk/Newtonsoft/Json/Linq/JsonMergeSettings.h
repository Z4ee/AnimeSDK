...
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_GET_MERGEARRAYHANDLING_OFFSET UNITYSDK_OFFSET(0x1BBA3540)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_GET_MERGENULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BBA35C0)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_SET_MERGEARRAYHANDLING_OFFSET UNITYSDK_OFFSET(0x1BBA3550)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_SET_MERGENULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1BBA35D0)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBA3640)
