...
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__GETENUMERATOR_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C132020)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__GETENUMERATOR_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C132080)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__GETENUMERATOR_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C1320E0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__GETENUMERATOR_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C132090)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__GETENUMERATOR_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C132010)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__GETENUMERATOR_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C132000)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JProperty_JPropertyList__GetEnumerator_d__1_TypeDefinitionIndex = 7047;
