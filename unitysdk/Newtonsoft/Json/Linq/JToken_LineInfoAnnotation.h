...
#define NEWTONSOFT_JSON_LINQ_JTOKEN_LINEINFOANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F89D2D0)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken_LineInfoAnnotation_TypeDefinitionIndex = 7189;
