...
#define NEWTONSOFT_JSON_LINQ_JTOKEN_LINEINFOANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18843500)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken_LineInfoAnnotation_TypeDefinitionIndex = 9432;
