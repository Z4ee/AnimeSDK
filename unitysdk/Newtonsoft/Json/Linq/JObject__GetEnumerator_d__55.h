...
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D621740)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_NEWTONSOFT_JSON_LINQ_JTOKEN___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D621AB0)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D621B10)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D621AC0)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D621570)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55__CTOR_OFFSET UNITYSDK_OFFSET(0x1D621560)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__55___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1D621660)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JObject__GetEnumerator_d__55_TypeDefinitionIndex = 7175;

	class JObject__GetEnumerator_d__55 : public ::System::Object
	{
	public:
		::Newtonsoft::Json::Linq::JObject* __4__this; // 0x10
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::Newtonsoft::Json::Linq::JToken*> __2__current; // 0x18
