...
#define NEWTONSOFT_JSON_LINQ_JVALUE_CLONETOKEN_OFFSET UNITYSDK_OFFSET(0x1C0A0090)
#define NEWTONSOFT_JSON_LINQ_JVALUE_COMPAREFLOAT_OFFSET UNITYSDK_OFFSET(0x1C09FDB0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1C0A1030)
#define NEWTONSOFT_JSON_LINQ_JVALUE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1C09F660)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATECOMMENT_OFFSET UNITYSDK_OFFSET(0x1C0A0140)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATENULL_OFFSET UNITYSDK_OFFSET(0x1C0A0260)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATESTRING_OFFSET UNITYSDK_OFFSET(0x1C0A01D0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATEUNDEFINED_OFFSET UNITYSDK_OFFSET(0x1C0A02F0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_DEEPEQUALS_OFFSET UNITYSDK_OFFSET(0x1C09F570)
#define NEWTONSOFT_JSON_LINQ_JVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C0A0D40)
#define NEWTONSOFT_JSON_LINQ_JVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C0A0CF0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETDEEPHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0A0CB0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0A0DE0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETSTRINGVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1C0A0380)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1C09F2F0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GET_HASVALUES_OFFSET UNITYSDK_OFFSET(0x1C09F650)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C0A03B0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C0A03C0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C0A03D0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICOMPARABLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1C0A0FB0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x1C0A1050)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1C0A1140)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOBYTE_OFFSET UNITYSDK_OFFSET(0x1C0A1260)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x1C0A11A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1C0A1630)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x1C0A15C0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1C0A1560)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOINT16_OFFSET UNITYSDK_OFFSET(0x1C0A12C0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOINT32_OFFSET UNITYSDK_OFFSET(0x1C0A1380)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOINT64_OFFSET UNITYSDK_OFFSET(0x1C0A1440)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOSBYTE_OFFSET UNITYSDK_OFFSET(0x1C0A1200)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x1C0A1500)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOTYPE_OFFSET UNITYSDK_OFFSET(0x1C0A1690)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x1C0A1320)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x1C0A13E0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x1C0A14A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1C0A0E40)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x1C0A0FA0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x1C0A0E70)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C0A0E10)
#define NEWTONSOFT_JSON_LINQ_JVALUE_VALUESEQUALS_OFFSET UNITYSDK_OFFSET(0x1C09F600)
#define NEWTONSOFT_JSON_LINQ_JVALUE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C0A0450)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1C09EFC0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x1C09F060)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_12_OFFSET UNITYSDK_OFFSET(0x1C09F0C0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_13_OFFSET UNITYSDK_OFFSET(0x1C09F140)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_14_OFFSET UNITYSDK_OFFSET(0x1C09F200)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_15_OFFSET UNITYSDK_OFFSET(0x1C09F280)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C09EAB0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C09EB20)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C09EBC0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C09EC60)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C09ECE0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1C09ED80)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1C09EE00)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1C09EEA0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1C09EF20)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C09EA50)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JValue_TypeDefinitionIndex = 7064;
