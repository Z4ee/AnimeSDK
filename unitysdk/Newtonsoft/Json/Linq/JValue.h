...
#define NEWTONSOFT_JSON_LINQ_JVALUE_CLONETOKEN_OFFSET UNITYSDK_OFFSET(0x1E3BE8F0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_COMPAREFLOAT_OFFSET UNITYSDK_OFFSET(0x1E3BE610)
#define NEWTONSOFT_JSON_LINQ_JVALUE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1E3BF890)
#define NEWTONSOFT_JSON_LINQ_JVALUE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1E3BDEC0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATECOMMENT_OFFSET UNITYSDK_OFFSET(0x1E3BE9A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATENULL_OFFSET UNITYSDK_OFFSET(0x1E3BEAC0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATESTRING_OFFSET UNITYSDK_OFFSET(0x1E3BEA30)
#define NEWTONSOFT_JSON_LINQ_JVALUE_CREATEUNDEFINED_OFFSET UNITYSDK_OFFSET(0x1E3BEB50)
#define NEWTONSOFT_JSON_LINQ_JVALUE_DEEPEQUALS_OFFSET UNITYSDK_OFFSET(0x1E3BDDD0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E3BF5A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E3BF550)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETDEEPHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3BF510)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3BF640)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETSTRINGVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1E3BEBE0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1E3BDB50)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GET_HASVALUES_OFFSET UNITYSDK_OFFSET(0x1E3BDEB0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1E3BEC10)
#define NEWTONSOFT_JSON_LINQ_JVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E3BEC20)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E3BEC30)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICOMPARABLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1E3BF810)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x1E3BF8B0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1E3BF9A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOBYTE_OFFSET UNITYSDK_OFFSET(0x1E3BFAC0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x1E3BFA00)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1E3BFE90)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x1E3BFE20)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1E3BFDC0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOINT16_OFFSET UNITYSDK_OFFSET(0x1E3BFB20)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOINT32_OFFSET UNITYSDK_OFFSET(0x1E3BFBE0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOINT64_OFFSET UNITYSDK_OFFSET(0x1E3BFCA0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOSBYTE_OFFSET UNITYSDK_OFFSET(0x1E3BFA60)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x1E3BFD60)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOTYPE_OFFSET UNITYSDK_OFFSET(0x1E3BFEF0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x1E3BFB80)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x1E3BFC40)
#define NEWTONSOFT_JSON_LINQ_JVALUE_SYSTEM_ICONVERTIBLE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x1E3BFD00)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1E3BF6A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x1E3BF800)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x1E3BF6D0)
#define NEWTONSOFT_JSON_LINQ_JVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3BF670)
#define NEWTONSOFT_JSON_LINQ_JVALUE_VALUESEQUALS_OFFSET UNITYSDK_OFFSET(0x1E3BDE60)
#define NEWTONSOFT_JSON_LINQ_JVALUE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E3BECB0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1E3BD820)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x1E3BD8C0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_12_OFFSET UNITYSDK_OFFSET(0x1E3BD920)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_13_OFFSET UNITYSDK_OFFSET(0x1E3BD9A0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_14_OFFSET UNITYSDK_OFFSET(0x1E3BDA60)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_15_OFFSET UNITYSDK_OFFSET(0x1E3BDAE0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3BD310)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E3BD380)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E3BD420)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1E3BD4C0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1E3BD540)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1E3BD5E0)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1E3BD660)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1E3BD700)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1E3BD780)
#define NEWTONSOFT_JSON_LINQ_JVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3BD2B0)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JValue_TypeDefinitionIndex = 7195;
