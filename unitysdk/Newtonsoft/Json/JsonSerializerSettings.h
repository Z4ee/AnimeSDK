...
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1D9D00D0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CHECKADDITIONALCONTENT_OFFSET UNITYSDK_OFFSET(0x1D9D04E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONSTRUCTORHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFF20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1D9D0110)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONTRACTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1D9CFF60)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONVERTERS_OFFSET UNITYSDK_OFFSET(0x1D9CFE00)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1D9D0460)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATEFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D02E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATEFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1D9D01A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATEPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0360)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATETIMEZONEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0320)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DEFAULTVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFDC0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_EQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1D9CFF80)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1D9D00F0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_FLOATFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D03A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_FLOATPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D03E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_FORMATTING_OFFSET UNITYSDK_OFFSET(0x1D9D02A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0x1D9D0200)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_METADATAPROPERTYHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFEA0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_MISSINGMEMBERHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFD00)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_NULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFD80)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_OBJECTCREATIONHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFD40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_PRESERVEREFERENCESHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFE20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_REFERENCELOOPHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFCC0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_REFERENCERESOLVERPROVIDER_OFFSET UNITYSDK_OFFSET(0x1D9D0090)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_REFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1D9CFFA0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_STRINGESCAPEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0420)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_TRACEWRITER_OFFSET UNITYSDK_OFFSET(0x1D9D00B0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_TYPENAMEASSEMBLYFORMAT_OFFSET UNITYSDK_OFFSET(0x1D9CFEE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_TYPENAMEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFE60)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1D9D00E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CHECKADDITIONALCONTENT_OFFSET UNITYSDK_OFFSET(0x1D9D0500)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONSTRUCTORHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFF40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1D9D0180)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONTRACTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1D9CFF70)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONVERTERS_OFFSET UNITYSDK_OFFSET(0x1D9CFE10)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1D9D04D0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATEFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0300)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATEFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1D9D01F0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATEPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0380)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATETIMEZONEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0340)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DEFAULTVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFDE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_EQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1D9CFF90)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_ERROR_OFFSET UNITYSDK_OFFSET(0x1D9D0100)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_FLOATFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D03C0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_FLOATPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0400)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_FORMATTING_OFFSET UNITYSDK_OFFSET(0x1D9D02C0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0x1D9D0210)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_METADATAPROPERTYHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFEC0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_MISSINGMEMBERHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFD20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_NULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFDA0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_OBJECTCREATIONHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFD60)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_PRESERVEREFERENCESHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFE40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_REFERENCELOOPHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFCE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_REFERENCERESOLVERPROVIDER_OFFSET UNITYSDK_OFFSET(0x1D9D00A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_REFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1D9CFFF0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_STRINGESCAPEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9D0440)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_TRACEWRITER_OFFSET UNITYSDK_OFFSET(0x1D9D00C0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_TYPENAMEASSEMBLYFORMAT_OFFSET UNITYSDK_OFFSET(0x1D9CFF00)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_TYPENAMEHANDLING_OFFSET UNITYSDK_OFFSET(0x1D9CFE80)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D9D0510)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9D0560)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonSerializerSettings_TypeDefinitionIndex = 7009;
	...
	public:
		...
		{
			return (::System::Runtime::Serialization::StreamingContext*)Il2CppClass::FromTypeDefinitionIndex(JsonSerializerSettings_TypeDefinitionIndex)->GetStaticField(0x5F70);
		}
		...
		::System::Func_1<::Newtonsoft::Json::Serialization::IReferenceResolver*>* _ReferenceResolverProvider_k__BackingField; // 0x30
		...
		::Newtonsoft::Json::Serialization::ITraceWriter* _TraceWriter_k__BackingField; // 0x50
		::Newtonsoft::Json::Serialization::IContractResolver* _ContractResolver_k__BackingField; // 0x58
		::System::Runtime::Serialization::SerializationBinder* _Binder_k__BackingField; // 0x60
		::System::Collections::IEqualityComparer* _EqualityComparer_k__BackingField; // 0x68
		::System::Nullable_1<::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle> _typeNameAssemblyFormat; // 0x70
		...
		::System::Nullable_1<::Newtonsoft::Json::ObjectCreationHandling> _objectCreationHandling; // 0x90
		::System::Nullable_1<::Newtonsoft::Json::PreserveReferencesHandling> _preserveReferencesHandling; // 0x98
		::System::Nullable_1<::Newtonsoft::Json::MissingMemberHandling> _missingMemberHandling; // 0xA0
		::System::Nullable_1<::Newtonsoft::Json::DateParseHandling> _dateParseHandling; // 0xA8
		::System::Nullable_1<::Newtonsoft::Json::MetadataPropertyHandling> _metadataPropertyHandling; // 0xB0
		::System::Nullable_1<::Newtonsoft::Json::TypeNameHandling> _typeNameHandling; // 0xB8
		::System::Nullable_1<::Newtonsoft::Json::StringEscapeHandling> _stringEscapeHandling; // 0xC0
		::System::Nullable_1<::Newtonsoft::Json::ConstructorHandling> _constructorHandling; // 0xC8
		::System::Nullable_1<::Newtonsoft::Json::DefaultValueHandling> _defaultValueHandling; // 0xD0
		::System::Nullable_1<::Newtonsoft::Json::Formatting> _formatting; // 0xD8
		::System::Nullable_1<::Newtonsoft::Json::NullValueHandling> _nullValueHandling; // 0xE0
		::System::Nullable_1<::System::Int32> _maxDepth; // 0xE8
		::System::Boolean _maxDepthSet; // 0xF0
		::System::Boolean _dateFormatStringSet; // 0xF1
		::System::Nullable_1<::System::Boolean> _checkAdditionalContent; // 0xF2
		::System::Nullable_1<::Newtonsoft::Json::FloatFormatHandling> _floatFormatHandling; // 0xF4
		::System::Nullable_1<::Newtonsoft::Json::DateTimeZoneHandling> _dateTimeZoneHandling; // 0xFC
