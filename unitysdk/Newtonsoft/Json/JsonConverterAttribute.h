...
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE_GET_CONVERTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E870A00)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE_GET_CONVERTERTYPE_OFFSET UNITYSDK_OFFSET(0x1E8709F0)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE_SET_CONVERTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E870A10)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E870A90)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E870A20)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonConverterAttribute_TypeDefinitionIndex = 6993;
