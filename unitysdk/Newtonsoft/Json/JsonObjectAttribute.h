...
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_GET_ITEMREQUIRED_OFFSET UNITYSDK_OFFSET(0x1C4A2FC0)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_GET_MEMBERSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1C4A2FA0)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_SET_ITEMREQUIRED_OFFSET UNITYSDK_OFFSET(0x1C4A2FE0)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_SET_MEMBERSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1C4A2FB0)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4A3010)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C4A3020)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A3000)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonObjectAttribute_TypeDefinitionIndex = 6868;
