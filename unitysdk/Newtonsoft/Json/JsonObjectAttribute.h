...
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_GET_ITEMREQUIRED_OFFSET UNITYSDK_OFFSET(0x1FBBCD50)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_GET_MEMBERSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1FBBCD30)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_SET_ITEMREQUIRED_OFFSET UNITYSDK_OFFSET(0x1FBBCD70)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE_SET_MEMBERSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1FBBCD40)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBBCDA0)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1FBBCDB0)
#define NEWTONSOFT_JSON_JSONOBJECTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBBCD90)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonObjectAttribute_TypeDefinitionIndex = 7003;
