...
#define NEWTONSOFT_JSON_SERIALIZATION_EXTENSIONDATASETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF82D80)
#define NEWTONSOFT_JSON_SERIALIZATION_EXTENSIONDATASETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF82DC0)
#define NEWTONSOFT_JSON_SERIALIZATION_EXTENSIONDATASETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF82760)
#define NEWTONSOFT_JSON_SERIALIZATION_EXTENSIONDATASETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF82750)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int ExtensionDataSetter_TypeDefinitionIndex = 6991;
