...
#define NEWTONSOFT_JSON_SERIALIZATION_JSONISERIALIZABLECONTRACT_GET_ISERIALIZABLECREATOR_OFFSET UNITYSDK_OFFSET(0x1ED3CA10)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONISERIALIZABLECONTRACT_SET_ISERIALIZABLECREATOR_OFFSET UNITYSDK_OFFSET(0x1ED3CA20)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONISERIALIZABLECONTRACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED3A720)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int JsonISerializableContract_TypeDefinitionIndex = 7133;
