...
#define NEWTONSOFT_JSON_SERIALIZATION_JSONISERIALIZABLECONTRACT_GET_ISERIALIZABLECREATOR_OFFSET UNITYSDK_OFFSET(0x1647D370)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONISERIALIZABLECONTRACT_SET_ISERIALIZABLECREATOR_OFFSET UNITYSDK_OFFSET(0x1647D380)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONISERIALIZABLECONTRACT__CTOR_OFFSET UNITYSDK_OFFSET(0x16474CD0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int JsonISerializableContract_TypeDefinitionIndex = 8299;
