...
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALBASE_CLEARERRORCONTEXT_OFFSET UNITYSDK_OFFSET(0x17AA9DF0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALBASE_GETERRORCONTEXT_OFFSET UNITYSDK_OFFSET(0x17AA9D40)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALBASE_GET_DEFAULTREFERENCEMAPPINGS_OFFSET UNITYSDK_OFFSET(0x17AA3090)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALBASE_ISERRORHANDLED_OFFSET UNITYSDK_OFFSET(0x17AA9E60)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17AA9CD0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int JsonSerializerInternalBase_TypeDefinitionIndex = 8481;

	class JsonSerializerInternalBase : public ::System::Object
	{
	public:
		::Newtonsoft::Json::JsonSerializer* Serializer; // 0x10
		::Newtonsoft::Json::Serialization::ErrorContext* _currentErrorContext; // 0x18
		::Newtonsoft::Json::Serialization::JsonSerializerProxy* InternalSerializer; // 0x20
		::Newtonsoft::Json::Serialization::ITraceWriter* TraceWriter; // 0x28
		::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::System::String*, ::System::Object*>* _mappings; // 0x30
