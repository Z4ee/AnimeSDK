...
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F3623B0)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F362430)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F361C80)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F361C60)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int SerializationCallback_TypeDefinitionIndex = 7124;
