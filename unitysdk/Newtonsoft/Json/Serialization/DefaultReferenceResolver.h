...
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_ADDREFERENCE_OFFSET UNITYSDK_OFFSET(0x15B98A20)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_GETMAPPINGS_OFFSET UNITYSDK_OFFSET(0x15B98690)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_GETREFERENCE_OFFSET UNITYSDK_OFFSET(0x15B98960)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_ISREFERENCED_OFFSET UNITYSDK_OFFSET(0x15B98A90)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_RESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x15B988F0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B98B00)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int DefaultReferenceResolver_TypeDefinitionIndex = 9364;
