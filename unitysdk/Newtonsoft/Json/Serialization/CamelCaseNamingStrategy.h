...
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY_RESOLVEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B5F2670)
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5F2660)
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F2650)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int CamelCaseNamingStrategy_TypeDefinitionIndex = 6962;
