...
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY_RESOLVEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ED32CC0)
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED32CB0)
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED32CA0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int CamelCaseNamingStrategy_TypeDefinitionIndex = 7097;
