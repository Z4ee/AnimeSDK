...
#define NEWTONSOFT_JSON_SERIALIZATION_DIAGNOSTICSTRACEWRITER_GETTRACEEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x17AA3A40)
#define NEWTONSOFT_JSON_SERIALIZATION_DIAGNOSTICSTRACEWRITER_GET_LEVELFILTER_OFFSET UNITYSDK_OFFSET(0x17AA3A30)
#define NEWTONSOFT_JSON_SERIALIZATION_DIAGNOSTICSTRACEWRITER_TRACE_OFFSET UNITYSDK_OFFSET(0x17AA3AB0)
#define NEWTONSOFT_JSON_SERIALIZATION_DIAGNOSTICSTRACEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x17AA3F80)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int DiagnosticsTraceWriter_TypeDefinitionIndex = 8436;
