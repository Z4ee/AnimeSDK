...
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER___C__DISPLAYCLASS34_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15B8E7C0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER___C__DISPLAYCLASS34_1__SETEXTENSIONDATADELEGATES_B__0_OFFSET UNITYSDK_OFFSET(0x15B981D0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int DefaultContractResolver___c__DisplayClass34_1_TypeDefinitionIndex = 9373;
