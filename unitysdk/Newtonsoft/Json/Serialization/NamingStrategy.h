...
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY_GETDICTIONARYKEY_OFFSET UNITYSDK_OFFSET(0x1DF0B290)
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1DF0B260)
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY_GET_OVERRIDESPECIFIEDNAMES_OFFSET UNITYSDK_OFFSET(0x1DF0B240)
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY_GET_PROCESSDICTIONARYKEYS_OFFSET UNITYSDK_OFFSET(0x1DF0B220)
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY_SET_OVERRIDESPECIFIEDNAMES_OFFSET UNITYSDK_OFFSET(0x1DF0B250)
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY_SET_PROCESSDICTIONARYKEYS_OFFSET UNITYSDK_OFFSET(0x1DF0B230)
#define NEWTONSOFT_JSON_SERIALIZATION_NAMINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF0B2B0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int NamingStrategy_TypeDefinitionIndex = 7149;
