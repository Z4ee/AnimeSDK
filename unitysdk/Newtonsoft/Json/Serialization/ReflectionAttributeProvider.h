...
#define NEWTONSOFT_JSON_SERIALIZATION_REFLECTIONATTRIBUTEPROVIDER_GETATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1E7DB5F0)
#define NEWTONSOFT_JSON_SERIALIZATION_REFLECTIONATTRIBUTEPROVIDER_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E7DB580)
#define NEWTONSOFT_JSON_SERIALIZATION_REFLECTIONATTRIBUTEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DB4E0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int ReflectionAttributeProvider_TypeDefinitionIndex = 7152;
