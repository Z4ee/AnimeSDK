...
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_ADDPROPERTY_OFFSET UNITYSDK_OFFSET(0x16470180)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_GETCLOSESTMATCHPROPERTY_OFFSET UNITYSDK_OFFSET(0x16470040)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_GETKEYFORITEM_OFFSET UNITYSDK_OFFSET(0x1647E270)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1647E290)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1647E3E0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1646FF10)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int JsonPropertyCollection_TypeDefinitionIndex = 8332;
