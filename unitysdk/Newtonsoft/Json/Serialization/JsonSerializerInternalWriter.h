...
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_CALCULATEPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x16490B00)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_CHECKFORCIRCULARREFERENCE_OFFSET UNITYSDK_OFFSET(0x1648FBB0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_GETCONTRACTSAFE_OFFSET UNITYSDK_OFFSET(0x1648C160)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_GETINTERNALSERIALIZER_OFFSET UNITYSDK_OFFSET(0x1648CCA0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x16490E10)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_GETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1648FFF0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_HANDLEERROR_OFFSET UNITYSDK_OFFSET(0x1648CBD0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_HASFLAG_1_OFFSET UNITYSDK_OFFSET(0x1648FAB0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_HASFLAG_2_OFFSET UNITYSDK_OFFSET(0x16491B40)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_HASFLAG_OFFSET UNITYSDK_OFFSET(0x1648FBA0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_ISSPECIFIED_OFFSET UNITYSDK_OFFSET(0x164914F0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_ONSERIALIZED_OFFSET UNITYSDK_OFFSET(0x16490690)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x16490380)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_RESOLVEISREFERENCE_OFFSET UNITYSDK_OFFSET(0x1648FA30)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZECONVERTABLE_OFFSET UNITYSDK_OFFSET(0x1648D370)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1648ECA0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEISERIALIZABLE_OFFSET UNITYSDK_OFFSET(0x1648F520)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZELIST_OFFSET UNITYSDK_OFFSET(0x1648E2E0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEMULTIDIMENSIONALARRAY_1_OFFSET UNITYSDK_OFFSET(0x16491DC0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEMULTIDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1648EAC0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1648DAE0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x1648CDA0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1648EC20)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1648C6B0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1648BF50)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SHOULDSERIALIZE_OFFSET UNITYSDK_OFFSET(0x164911D0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SHOULDWRITEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1648FAC0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SHOULDWRITEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1648C1B0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_SHOULDWRITETYPE_OFFSET UNITYSDK_OFFSET(0x1648CED0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_TRYCONVERTTOSTRING_OFFSET UNITYSDK_OFFSET(0x16490150)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_WRITEOBJECTSTART_OFFSET UNITYSDK_OFFSET(0x164909A0)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_WRITEREFERENCEIDPROPERTY_OFFSET UNITYSDK_OFFSET(0x16491810)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_WRITEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1648C340)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_WRITESTARTARRAY_OFFSET UNITYSDK_OFFSET(0x16491B50)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER_WRITETYPEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1648D000)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONSERIALIZERINTERNALWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1648BEC0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int JsonSerializerInternalWriter_TypeDefinitionIndex = 8342;
