...
#define NEWTONSOFT_JSON_SERIALIZATION_ERROREVENTARGS_GET_CURRENTOBJECT_OFFSET UNITYSDK_OFFSET(0x1E2B52B0)
#define NEWTONSOFT_JSON_SERIALIZATION_ERROREVENTARGS_GET_ERRORCONTEXT_OFFSET UNITYSDK_OFFSET(0x1E2B52D0)
#define NEWTONSOFT_JSON_SERIALIZATION_ERROREVENTARGS_SET_CURRENTOBJECT_OFFSET UNITYSDK_OFFSET(0x1E2B52C0)
#define NEWTONSOFT_JSON_SERIALIZATION_ERROREVENTARGS_SET_ERRORCONTEXT_OFFSET UNITYSDK_OFFSET(0x1E2B52E0)
#define NEWTONSOFT_JSON_SERIALIZATION_ERROREVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2B52F0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int ErrorEventArgs_TypeDefinitionIndex = 7111;
