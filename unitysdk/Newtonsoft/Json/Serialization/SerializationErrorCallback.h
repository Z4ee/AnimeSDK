...
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15BBC9B0)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15BBCA40)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15B9C8B0)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15BBC8C0)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int SerializationErrorCallback_TypeDefinitionIndex = 9385;
