...
#define NEWTONSOFT_JSON_SHIMS_PRESERVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BBFB00)

namespace Newtonsoft::Json::Shims
{
	inline static constexpr unsigned int PreserveAttribute_TypeDefinitionIndex = 9350;
