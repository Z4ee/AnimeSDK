...
#define CLASS_1_B638B471FA6B79D1_METHOD_1_23D843E3C6034180_OFFSET UNITYSDK_OFFSET(0xB8A3BE0)
#define CLASS_1_B638B471FA6B79D1_METHOD_1_516B288F8E366B49_OFFSET UNITYSDK_OFFSET(0xB8A3910)
#define CLASS_1_B638B471FA6B79D1_METHOD_1_DADDE85C223C9E39_OFFSET UNITYSDK_OFFSET(0xB8A3960)
#define CLASS_1_B638B471FA6B79D1_METHOD_1_E5711DD469507973_OFFSET UNITYSDK_OFFSET(0xB8A3B50)
#define CLASS_1_B638B471FA6B79D1__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A37E0)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::AvatarSystem::Avatar*>* IGDOPPODBGI; // 0x10
	::Class_1_D94DE62B6FBACBEE* HEJEGOGBFMP; // 0x18
	::Class_1_B2F03AF2376A5DC0* IIGOMJPLLBD; // 0x20
	::Class_1_7D46F1066EF90FA6_5* LPFNKPGFIFA; // 0x28
