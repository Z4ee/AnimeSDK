...
#define NAPSCENEEFFECTLODPROXY_INITBIND_OFFSET UNITYSDK_OFFSET(0x1C400D70)
#define NAPSCENEEFFECTLODPROXY_ISONETIMELODPROXY_OFFSET UNITYSDK_OFFSET(0x1C4013B0)
#define NAPSCENEEFFECTLODPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C400A10)
#define NAPSCENEEFFECTLODPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C400810)
#define NAPSCENEEFFECTLODPROXY_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C400C10)
#define NAPSCENEEFFECTLODPROXY_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1C400CC0)
#define NAPSCENEEFFECTLODPROXY_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1C400B90)
#define NAPSCENEEFFECTLODPROXY_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1C400990)
#define NAPSCENEEFFECTLODPROXY_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1C4013F0)
#define NAPSCENEEFFECTLODPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C401AC0)
#define NAPSCENEEFFECTLODPROXY___BASE_ISONETIMELODPROXY_OFFSET UNITYSDK_OFFSET(0x1C401BF0)

inline static constexpr unsigned int NapSceneEffectLodProxy_TypeDefinitionIndex = 27394;
