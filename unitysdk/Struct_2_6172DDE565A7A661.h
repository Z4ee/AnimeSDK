...
#define STRUCT_2_6172DDE565A7A661__CTOR_OFFSET UNITYSDK_OFFSET(0x425140)

inline static constexpr unsigned int Struct_2_6172DDE565A7A661_TypeDefinitionIndex = 89702;

struct alignas(8) Struct_2_6172DDE565A7A661
{
	::Foundation::ViewObject::ViewObjectHandle Field_2_1; // 0x10
	::Struct_2_55AD8E2146FD678C Field_2_0; // 0x20
