...
#define CLASS_1_A17F0CCA3D2B239E_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0xBBB2E30)
#define CLASS_1_A17F0CCA3D2B239E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xBBB2010)
#define CLASS_1_A17F0CCA3D2B239E_EQUALS_OFFSET UNITYSDK_OFFSET(0xBBB2D10)
#define CLASS_1_A17F0CCA3D2B239E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xBBB2500)
#define CLASS_1_A17F0CCA3D2B239E_GET_BATTLEICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1760)
#define CLASS_1_A17F0CCA3D2B239E_GET_CARDOWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1720)
#define CLASS_1_A17F0CCA3D2B239E_GET_EQUALITYCONTRACT_OFFSET UNITYSDK_OFFSET(0xBBB1690)
#define CLASS_1_A17F0CCA3D2B239E_GET_HANDBOOKCARDTABICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1740)
#define CLASS_1_A17F0CCA3D2B239E_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xBBB16C0)
#define CLASS_1_A17F0CCA3D2B239E_GET_SOURCEAVATARID_OFFSET UNITYSDK_OFFSET(0xBBB16E0)
#define CLASS_1_A17F0CCA3D2B239E_GET_SWITCHDAYTALKICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1780)
#define CLASS_1_A17F0CCA3D2B239E_GET_SYSTEMFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xBBB1700)
#define CLASS_1_A17F0CCA3D2B239E_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xBBB17A0)
#define CLASS_1_A17F0CCA3D2B239E_GET_ULTRABTNEFFECTPREFABPATH_OFFSET UNITYSDK_OFFSET(0xBBB17C0)
#define CLASS_1_A17F0CCA3D2B239E_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xBBB1FF0)
#define CLASS_1_A17F0CCA3D2B239E_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xBBB1FC0)
#define CLASS_1_A17F0CCA3D2B239E_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0xBBB19A0)
#define CLASS_1_A17F0CCA3D2B239E_SET_BATTLEICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1770)
#define CLASS_1_A17F0CCA3D2B239E_SET_CARDOWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1730)
#define CLASS_1_A17F0CCA3D2B239E_SET_HANDBOOKCARDTABICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1750)
#define CLASS_1_A17F0CCA3D2B239E_SET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xBBB16D0)
#define CLASS_1_A17F0CCA3D2B239E_SET_SOURCEAVATARID_OFFSET UNITYSDK_OFFSET(0xBBB16F0)
#define CLASS_1_A17F0CCA3D2B239E_SET_SWITCHDAYTALKICONPATH_OFFSET UNITYSDK_OFFSET(0xBBB1790)
#define CLASS_1_A17F0CCA3D2B239E_SET_SYSTEMFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xBBB1710)
#define CLASS_1_A17F0CCA3D2B239E_SET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xBBB17B0)
#define CLASS_1_A17F0CCA3D2B239E_SET_ULTRABTNEFFECTPREFABPATH_OFFSET UNITYSDK_OFFSET(0xBBB17D0)
#define CLASS_1_A17F0CCA3D2B239E_TOSTRING_OFFSET UNITYSDK_OFFSET(0xBBB17E0)
#define CLASS_1_A17F0CCA3D2B239E__CLONE___OFFSET UNITYSDK_OFFSET(0xBBB2D70)
#define CLASS_1_A17F0CCA3D2B239E__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBBB2DF0)
#define CLASS_1_A17F0CCA3D2B239E__CTOR_OFFSET UNITYSDK_OFFSET(0xBBB1640)

inline static constexpr unsigned int Class_1_A17F0CCA3D2B239E_TypeDefinitionIndex = 79881;

class Class_1_A17F0CCA3D2B239E : public ::System::Object
{
public:
	::System::String* _HandbookCardTabIconPath_k__BackingField; // 0x10
	::System::String* _CardOwnerMarkerIconPath_k__BackingField; // 0x18
	::System::String* _UltraBtnEffectPrefabPath_k__BackingField; // 0x20
	::System::String* _BattleIconPath_k__BackingField; // 0x28
	::System::String* _SystemFigurePath_k__BackingField; // 0x30
