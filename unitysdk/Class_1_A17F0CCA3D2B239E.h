...
#define CLASS_1_A17F0CCA3D2B239E_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x176630A0)
#define CLASS_1_A17F0CCA3D2B239E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x176622D0)
#define CLASS_1_A17F0CCA3D2B239E_EQUALS_OFFSET UNITYSDK_OFFSET(0x17662F80)
#define CLASS_1_A17F0CCA3D2B239E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17662790)
#define CLASS_1_A17F0CCA3D2B239E_GET_BATTLEICONPATH_OFFSET UNITYSDK_OFFSET(0x17661A20)
#define CLASS_1_A17F0CCA3D2B239E_GET_CARDOWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0x176619E0)
#define CLASS_1_A17F0CCA3D2B239E_GET_EQUALITYCONTRACT_OFFSET UNITYSDK_OFFSET(0x17661950)
#define CLASS_1_A17F0CCA3D2B239E_GET_HANDBOOKCARDTABICONPATH_OFFSET UNITYSDK_OFFSET(0x17661A00)
#define CLASS_1_A17F0CCA3D2B239E_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0x17661980)
#define CLASS_1_A17F0CCA3D2B239E_GET_SOURCEAVATARID_OFFSET UNITYSDK_OFFSET(0x176619A0)
#define CLASS_1_A17F0CCA3D2B239E_GET_SWITCHDAYTALKICONPATH_OFFSET UNITYSDK_OFFSET(0x17661A40)
#define CLASS_1_A17F0CCA3D2B239E_GET_SYSTEMFIGUREPATH_OFFSET UNITYSDK_OFFSET(0x176619C0)
#define CLASS_1_A17F0CCA3D2B239E_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0x17661A60)
#define CLASS_1_A17F0CCA3D2B239E_GET_ULTRABTNEFFECTPREFABPATH_OFFSET UNITYSDK_OFFSET(0x17661A80)
#define CLASS_1_A17F0CCA3D2B239E_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x176622B0)
#define CLASS_1_A17F0CCA3D2B239E_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17662280)
#define CLASS_1_A17F0CCA3D2B239E_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x17661C60)
#define CLASS_1_A17F0CCA3D2B239E_SET_BATTLEICONPATH_OFFSET UNITYSDK_OFFSET(0x17661A30)
#define CLASS_1_A17F0CCA3D2B239E_SET_CARDOWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0x176619F0)
#define CLASS_1_A17F0CCA3D2B239E_SET_HANDBOOKCARDTABICONPATH_OFFSET UNITYSDK_OFFSET(0x17661A10)
#define CLASS_1_A17F0CCA3D2B239E_SET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0x17661990)
#define CLASS_1_A17F0CCA3D2B239E_SET_SOURCEAVATARID_OFFSET UNITYSDK_OFFSET(0x176619B0)
#define CLASS_1_A17F0CCA3D2B239E_SET_SWITCHDAYTALKICONPATH_OFFSET UNITYSDK_OFFSET(0x17661A50)
#define CLASS_1_A17F0CCA3D2B239E_SET_SYSTEMFIGUREPATH_OFFSET UNITYSDK_OFFSET(0x176619D0)
#define CLASS_1_A17F0CCA3D2B239E_SET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0x17661A70)
#define CLASS_1_A17F0CCA3D2B239E_SET_ULTRABTNEFFECTPREFABPATH_OFFSET UNITYSDK_OFFSET(0x17661A90)
#define CLASS_1_A17F0CCA3D2B239E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17661AA0)
#define CLASS_1_A17F0CCA3D2B239E__CLONE___OFFSET UNITYSDK_OFFSET(0x17662FE0)
#define CLASS_1_A17F0CCA3D2B239E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17663060)
#define CLASS_1_A17F0CCA3D2B239E__CTOR_OFFSET UNITYSDK_OFFSET(0x17661910)

inline static constexpr unsigned int Class_1_A17F0CCA3D2B239E_TypeDefinitionIndex = 76247;

class Class_1_A17F0CCA3D2B239E : public ::System::Object
{
public:
	::System::String* _UltraBtnEffectPrefabPath_k__BackingField; // 0x10
	::System::String* _BattleIconPath_k__BackingField; // 0x18
	::System::String* _SwitchDayTalkIconPath_k__BackingField; // 0x20
	::System::String* _UIColorState_k__BackingField; // 0x28
	::System::String* _HandbookCardTabIconPath_k__BackingField; // 0x30
	::System::String* _SystemFigurePath_k__BackingField; // 0x38
	::System::String* _CardOwnerMarkerIconPath_k__BackingField; // 0x40
