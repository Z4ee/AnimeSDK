...
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_CLEARRECORD_OFFSET UNITYSDK_OFFSET(0x1B75C400)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_FPSBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1B75B6B0)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x1B75BE30)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_MEMBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1B75AFB0)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_ONDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1B75AF70)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B75B980)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_ONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0x1B75C550)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_RECORDREALTIMEMEM_OFFSET UNITYSDK_OFFSET(0x1B75B250)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_SETUPUI_OFFSET UNITYSDK_OFFSET(0x1B7594B0)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_START_OFFSET UNITYSDK_OFFSET(0x1B759490)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_TRACKCURMEM_OFFSET UNITYSDK_OFFSET(0x1B75C500)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_UPDATEFPS_OFFSET UNITYSDK_OFFSET(0x1B75AD30)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_UPDATEMEM_OFFSET UNITYSDK_OFFSET(0x1B75A740)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B75A2A0)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75C560)

namespace RPGTools
{
	inline static constexpr unsigned int AppDevicePerformanceBehavior_TypeDefinitionIndex = 45149;
