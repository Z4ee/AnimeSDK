...
#define RPGTOOLS_MONOTIMELINEEFFECT_ALLPARTICALSYSTEMSPLAY_OFFSET UNITYSDK_OFFSET(0x19D66340)
#define RPGTOOLS_MONOTIMELINEEFFECT_ALLPARTICALSYSTEMSSTOPANDCLEAR_OFFSET UNITYSDK_OFFSET(0x19D662B0)
#define RPGTOOLS_MONOTIMELINEEFFECT_ALLPARTICALSYSTEMSSTOPEMITTING_OFFSET UNITYSDK_OFFSET(0x19D66210)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORCROSSFADE_OFFSET UNITYSDK_OFFSET(0x19D65D20)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETBOOL_OFFSET UNITYSDK_OFFSET(0x19D65BC0)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETFLOAT_OFFSET UNITYSDK_OFFSET(0x19D65B00)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETINTEGER_OFFSET UNITYSDK_OFFSET(0x19D65A50)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETTRIGGER_OFFSET UNITYSDK_OFFSET(0x19D65C70)
#define RPGTOOLS_MONOTIMELINEEFFECT_GETINACCURATEDURATION_OFFSET UNITYSDK_OFFSET(0x19D66800)
#define RPGTOOLS_MONOTIMELINEEFFECT_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0x19D646C0)
#define RPGTOOLS_MONOTIMELINEEFFECT_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x19D645B0)
#define RPGTOOLS_MONOTIMELINEEFFECT_INIT_OFFSET UNITYSDK_OFFSET(0x19D65E00)
#define RPGTOOLS_MONOTIMELINEEFFECT_ISPARTICALSYSTEMSALIVE_OFFSET UNITYSDK_OFFSET(0x19D66170)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_1713F44301AA802F_OFFSET UNITYSDK_OFFSET(0x19D65090)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19D65720)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_45714050EDEF8291_OFFSET UNITYSDK_OFFSET(0x19D64D40)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_5B6CC23D54F693F4_OFFSET UNITYSDK_OFFSET(0x19D665C0)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0x19D65770)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x19D653A0)
#define RPGTOOLS_MONOTIMELINEEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19D656A0)
#define RPGTOOLS_MONOTIMELINEEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19D65040)
#define RPGTOOLS_MONOTIMELINEEFFECT_REPLAYPARTICLESYSTEMS_OFFSET UNITYSDK_OFFSET(0x19D663D0)
#define RPGTOOLS_MONOTIMELINEEFFECT_RETAINEXTERNALASSETS_OFFSET UNITYSDK_OFFSET(0x19D64800)
#define RPGTOOLS_MONOTIMELINEEFFECT_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0x19D64E90)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETEFFECTSCALE_OFFSET UNITYSDK_OFFSET(0x19D66420)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETMONOEFFECT_OFFSET UNITYSDK_OFFSET(0x19D645D0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETPREFABASSET_OFFSET UNITYSDK_OFFSET(0x19D647B0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETRANDOMSEED_OFFSET UNITYSDK_OFFSET(0x19D66500)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETSPEED_OFFSET UNITYSDK_OFFSET(0x19D669F0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x19D645C0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SIMULATEPARTICLE_OFFSET UNITYSDK_OFFSET(0x19D66080)
#define RPGTOOLS_MONOTIMELINEEFFECT_TICKMONO_OFFSET UNITYSDK_OFFSET(0x19D64E00)
#define RPGTOOLS_MONOTIMELINEEFFECT_UPDATEANIMATOR_OFFSET UNITYSDK_OFFSET(0x19D658C0)
#define RPGTOOLS_MONOTIMELINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D66A50)

namespace RPGTools
{
	inline static constexpr unsigned int MonoTimelineEffect_TypeDefinitionIndex = 46014;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Object*>* Field_5_12; // 0x70
		::RPG::Client::MonoEffect* Field_5_13; // 0x78
