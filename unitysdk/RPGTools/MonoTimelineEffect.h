...
#define RPGTOOLS_MONOTIMELINEEFFECT_ALLPARTICALSYSTEMSPLAY_OFFSET UNITYSDK_OFFSET(0xAB169B0)
#define RPGTOOLS_MONOTIMELINEEFFECT_ALLPARTICALSYSTEMSSTOPANDCLEAR_OFFSET UNITYSDK_OFFSET(0xAB16910)
#define RPGTOOLS_MONOTIMELINEEFFECT_ALLPARTICALSYSTEMSSTOPEMITTING_OFFSET UNITYSDK_OFFSET(0xAB16870)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORCROSSFADE_OFFSET UNITYSDK_OFFSET(0xAB16330)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETBOOL_OFFSET UNITYSDK_OFFSET(0xAB161C0)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETFLOAT_OFFSET UNITYSDK_OFFSET(0xAB16100)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETINTEGER_OFFSET UNITYSDK_OFFSET(0xAB16040)
#define RPGTOOLS_MONOTIMELINEEFFECT_ANIMATORSETTRIGGER_OFFSET UNITYSDK_OFFSET(0xAB16280)
#define RPGTOOLS_MONOTIMELINEEFFECT_GETINACCURATEDURATION_OFFSET UNITYSDK_OFFSET(0xAB16EE0)
#define RPGTOOLS_MONOTIMELINEEFFECT_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xAB152E0)
#define RPGTOOLS_MONOTIMELINEEFFECT_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xAB151D0)
#define RPGTOOLS_MONOTIMELINEEFFECT_INIT_OFFSET UNITYSDK_OFFSET(0xAB16420)
#define RPGTOOLS_MONOTIMELINEEFFECT_ISPARTICALSYSTEMSALIVE_OFFSET UNITYSDK_OFFSET(0xAB167D0)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAB15D00)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_5B6CC23D54F693F4_OFFSET UNITYSDK_OFFSET(0xAB16C70)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_8B4B3FEAD1B0C4A6_OFFSET UNITYSDK_OFFSET(0xAB156A0)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0xAB159A0)
#define RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0xAB15D50)
#define RPGTOOLS_MONOTIMELINEEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAB15C80)
#define RPGTOOLS_MONOTIMELINEEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAB15650)
#define RPGTOOLS_MONOTIMELINEEFFECT_REPLAYPARTICLESYSTEMS_OFFSET UNITYSDK_OFFSET(0xAB16A50)
#define RPGTOOLS_MONOTIMELINEEFFECT_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0xAB154B0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETEFFECTSCALE_OFFSET UNITYSDK_OFFSET(0xAB16AA0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETMONOEFFECT_OFFSET UNITYSDK_OFFSET(0xAB151F0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETPREFABASSET_OFFSET UNITYSDK_OFFSET(0xAB153D0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETRANDOMSEED_OFFSET UNITYSDK_OFFSET(0xAB16BA0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SETSPEED_OFFSET UNITYSDK_OFFSET(0xAB170E0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xAB151E0)
#define RPGTOOLS_MONOTIMELINEEFFECT_SIMULATEPARTICLE_OFFSET UNITYSDK_OFFSET(0xAB166D0)
#define RPGTOOLS_MONOTIMELINEEFFECT_TICKMONO_OFFSET UNITYSDK_OFFSET(0xAB15420)
#define RPGTOOLS_MONOTIMELINEEFFECT_UPDATEANIMATOR_OFFSET UNITYSDK_OFFSET(0xAB15EA0)
#define RPGTOOLS_MONOTIMELINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB17140)

namespace RPGTools
{
	inline static constexpr unsigned int MonoTimelineEffect_TypeDefinitionIndex = 38657;

	class MonoTimelineEffect : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Boolean EnablePOSM; // 0x18
		::Il2CppArray<::UnityEngine::Renderer*>* Field_5_1; // 0x20
		::Il2CppArray<::UnityEngine::ParticleSystem*>* Field_5_2; // 0x28
		::Il2CppArray<::UnityEngine::Animation*>* Field_5_3; // 0x30
		::Il2CppArray<::UnityEngine::Animator*>* Field_5_4; // 0x38
		::System::Boolean Field_5_5; // 0x40
		::System::Single Field_5_6; // 0x44
		::System::Int32 Field_5_7; // 0x48
		::Il2CppArray<::System::Single>* Field_5_8; // 0x50
		::Il2CppArray<::System::Single>* Field_5_9; // 0x58
		::System::String* Field_5_10; // 0x60
		::UnityEngine::Object* Field_5_11; // 0x68
		::RPG::Client::MonoEffect* Field_5_12; // 0x70
		...
		{
			return ((::Class_1_9CBC71DC5240DC00*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_MONOTIMELINEEFFECT_GET_GORENDERERCACHE_OFFSET))(this);
		}
		...
		::System::Void Method_5_8B4B3FEAD1B0C4A6()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_8B4B3FEAD1B0C4A6_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_MONOTIMELINEEFFECT_METHOD_5_8C704EC832EDEFC8_OFFSET))(this);
		}
