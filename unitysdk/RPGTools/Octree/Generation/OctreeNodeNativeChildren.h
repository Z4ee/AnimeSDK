...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xE2F40)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xE2F50)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_0F3ED20595B696E9_OFFSET UNITYSDK_OFFSET(0xE2F80)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_9A1147DF38EDFEA5_OFFSET UNITYSDK_OFFSET(0xE2F70)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xE2F60)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeNodeNativeChildren_TypeDefinitionIndex = 45540;
