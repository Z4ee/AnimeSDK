...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xE5E0D0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x39E90B0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_206F77E5E3F223C5_OFFSET UNITYSDK_OFFSET(0x39E90E0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_276E1CDD7DFA6E40_OFFSET UNITYSDK_OFFSET(0x39E90D0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x39E90C0)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeNodeNativeChildren_TypeDefinitionIndex = 47062;
