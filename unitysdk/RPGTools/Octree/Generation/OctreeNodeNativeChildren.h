...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x88FD0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x88FE0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_0F3ED20595B696E9_OFFSET UNITYSDK_OFFSET(0x89010)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_9A1147DF38EDFEA5_OFFSET UNITYSDK_OFFSET(0x89000)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x88FF0)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeNodeNativeChildren_TypeDefinitionIndex = 39631;
