...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDNAVIGATIONPATH_OFFSET UNITYSDK_OFFSET(0xAB18280)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDOCTREE_OFFSET UNITYSDK_OFFSET(0xAB17760)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_DISPOSETREE_OFFSET UNITYSDK_OFFSET(0xAB17700)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_GET_TREE_OFFSET UNITYSDK_OFFSET(0xAB18270)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAB17680)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xAB17530)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__BUILDOCTREE_B__11_0_OFFSET UNITYSDK_OFFSET(0xAB18540)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB184E0)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeManager_TypeDefinitionIndex = 39638;
	...
	public:
		...
		::Class_1_C84A84118567060F* Field_5_8; // 0x50
		::UnityEngine::Transform* Start; // 0x58
		::UnityEngine::Transform* End; // 0x60
		::Class_1_C0325AE94F8526BE* Field_5_11; // 0x68
		...
		::RPGTools::Octree::Generation::OctreeLinkData* _BuildOctree_b__11_0(::RPGTools::Octree::Generation::OctreeManager_LinkData linkData)
		{
			return ((::RPGTools::Octree::Generation::OctreeLinkData*(*)(::PVOID, ::RPGTools::Octree::Generation::OctreeManager_LinkData))((::PBYTE)hIl2Cpp + RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__BUILDOCTREE_B__11_0_OFFSET))(this, linkData);
		}
	};
}
