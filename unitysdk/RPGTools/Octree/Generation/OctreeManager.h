...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDNAVIGATIONPATH_OFFSET UNITYSDK_OFFSET(0x19D67A60)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDOCTREE_OFFSET UNITYSDK_OFFSET(0x19D67090)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_DISPOSETREE_OFFSET UNITYSDK_OFFSET(0x19D67030)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_GET_TREE_OFFSET UNITYSDK_OFFSET(0x19D67A50)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19D66FB0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19D66E60)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__BUILDOCTREE_B__11_0_OFFSET UNITYSDK_OFFSET(0x19D67D00)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D67CA0)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeManager_TypeDefinitionIndex = 47069;
