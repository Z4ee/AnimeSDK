...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDNAVIGATIONPATH_OFFSET UNITYSDK_OFFSET(0xCFD0AD0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDOCTREE_OFFSET UNITYSDK_OFFSET(0xCFCFFA0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_DISPOSETREE_OFFSET UNITYSDK_OFFSET(0xCFCFF40)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_GET_TREE_OFFSET UNITYSDK_OFFSET(0xCFD0AC0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCFCFEC0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xCFCFD70)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__BUILDOCTREE_B__11_0_OFFSET UNITYSDK_OFFSET(0xCFD0D70)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD0D10)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeManager_TypeDefinitionIndex = 46130;
