...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xAB17200)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeAsset_TypeDefinitionIndex = 39626;
