...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_AREADATA_CURVE_METHOD_2_B3C2DB7D307B56BB_OFFSET UNITYSDK_OFFSET(0x19D674D0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_AREADATA_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D67E20)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeManager_AreaData_Curve_TypeDefinitionIndex = 47070;
