...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA_METHOD_2_C8288CA38627F3DC_OFFSET UNITYSDK_OFFSET(0xE30A0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA_METHOD_2_E613829602ABB720_OFFSET UNITYSDK_OFFSET(0xE30B0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE3030)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeNodeNativeData_TypeDefinitionIndex = 45541;
