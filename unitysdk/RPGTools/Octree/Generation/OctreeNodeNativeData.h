...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA_METHOD_2_4F98D710DEC1E009_OFFSET UNITYSDK_OFFSET(0x3B89DA0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA_METHOD_2_9FAD2B943055017C_OFFSET UNITYSDK_OFFSET(0x3B89DB0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3B89D30)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeNodeNativeData_TypeDefinitionIndex = 49326;
