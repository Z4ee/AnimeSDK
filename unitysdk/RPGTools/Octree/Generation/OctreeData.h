...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB17210)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeData_TypeDefinitionIndex = 39630;
