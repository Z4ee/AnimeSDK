...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB88AFD0)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeData_TypeDefinitionIndex = 45539;
