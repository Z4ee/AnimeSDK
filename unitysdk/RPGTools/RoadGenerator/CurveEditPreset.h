...
#define RPGTOOLS_ROADGENERATOR_CURVEEDITPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0xAB18EB0)

namespace RPGTools::RoadGenerator
{
	inline static constexpr unsigned int CurveEditPreset_TypeDefinitionIndex = 39615;
