...
#define RPGTOOLS_ROADGENERATOR_CURVEEDITPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5286F0)

namespace RPGTools::RoadGenerator
{
	inline static constexpr unsigned int CurveEditPreset_TypeDefinitionIndex = 49309;
