...
#define RPGTOOLS_ROADGENERATOR_CURVEEDITPRESET_CURVECREATEPARAM__CCTOR_OFFSET UNITYSDK_OFFSET(0xAB18F20)

namespace RPGTools::RoadGenerator
{
	inline static constexpr unsigned int CurveEditPreset_CurveCreateParam_TypeDefinitionIndex = 39616;
	...
	struct alignas(4) CurveEditPreset_CurveCreateParam
	{
		...
		{
			return (::RPGTools::RoadGenerator::CurveEditPreset_CurveCreateParam*)Il2CppClass::FromTypeDefinitionIndex(CurveEditPreset_CurveCreateParam_TypeDefinitionIndex)->GetStaticField(0x12860);
		}
