...
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_GETCURRENTCOLOR_OFFSET UNITYSDK_OFFSET(0xA242070)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0xA242030)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_ONDRAG_OFFSET UNITYSDK_OFFSET(0xA2420F0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_RESETTAG_OFFSET UNITYSDK_OFFSET(0xA2423E0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_SETUPUI_OFFSET UNITYSDK_OFFSET(0xA2413E0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_START_OFFSET UNITYSDK_OFFSET(0xA2413D0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_SWITHBTNCLICK_OFFSET UNITYSDK_OFFSET(0xA242460)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_TAGBTNCLICK_OFFSET UNITYSDK_OFFSET(0xA242310)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_UPDATECRITICALIMAGESTATE_OFFSET UNITYSDK_OFFSET(0xA2420B0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xA241BC0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA242530)

namespace RPGTools
{
	inline static constexpr unsigned int AppDeviceMemBehavior_TypeDefinitionIndex = 44277;
