...
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1924A000)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19248DB0)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19249FF0)

namespace RPGTools::HoudiniToUnity
{
	inline static constexpr unsigned int CurveSplitPoint_TypeDefinitionIndex = 45156;
