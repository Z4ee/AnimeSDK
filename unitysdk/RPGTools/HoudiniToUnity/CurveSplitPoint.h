...
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1967E910)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1967D6C0)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1967E900)

namespace RPGTools::HoudiniToUnity
{
	inline static constexpr unsigned int CurveSplitPoint_TypeDefinitionIndex = 47392;
