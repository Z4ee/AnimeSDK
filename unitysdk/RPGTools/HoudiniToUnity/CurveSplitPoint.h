...
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT_COMPARETO_OFFSET UNITYSDK_OFFSET(0xB2E6A50)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB2E5800)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xB2E6A40)
