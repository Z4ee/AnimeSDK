...
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ENSURECONSISTENCY_OFFSET UNITYSDK_OFFSET(0x19248FA0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_EVALUATEASSTRING_OFFSET UNITYSDK_OFFSET(0x19249640)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETHUECOLOR_OFFSET UNITYSDK_OFFSET(0x19249410)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTCOLOR_OFFSET UNITYSDK_OFFSET(0x19249210)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x19248D40)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTRANGE_OFFSET UNITYSDK_OFFSET(0x19249570)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTVALUE_OFFSET UNITYSDK_OFFSET(0x192490D0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SEGMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x19248A20)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SEGMENTVALUES_OFFSET UNITYSDK_OFFSET(0x19248B50)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SPLITPOINTS_OFFSET UNITYSDK_OFFSET(0x19248B40)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_INSERTSPLITPOINT_OFFSET UNITYSDK_OFFSET(0x19248B60)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19249C60)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19249C50)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_REMOVESPLITPOINT_OFFSET UNITYSDK_OFFSET(0x19248DD0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SETSEGMENTCOLOR_OFFSET UNITYSDK_OFFSET(0x19249140)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SETSEGMENTVALUE_OFFSET UNITYSDK_OFFSET(0x19248F30)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SORTSPLITPOINTS_OFFSET UNITYSDK_OFFSET(0x19249720)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x19249B80)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19249DB0)

namespace RPGTools::HoudiniToUnity
{
	inline static constexpr unsigned int CurveAttribute_TypeDefinitionIndex = 45157;
