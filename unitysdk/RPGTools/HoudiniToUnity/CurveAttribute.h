...
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ENSURECONSISTENCY_OFFSET UNITYSDK_OFFSET(0xA2481B0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_EVALUATEASSTRING_OFFSET UNITYSDK_OFFSET(0xA247C70)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETHUECOLOR_OFFSET UNITYSDK_OFFSET(0xA2482E0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTCOLOR_OFFSET UNITYSDK_OFFSET(0xA2479A0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0xA247620)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTRANGE_OFFSET UNITYSDK_OFFSET(0xA247BA0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTVALUE_OFFSET UNITYSDK_OFFSET(0xA247860)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SEGMENTCOUNT_OFFSET UNITYSDK_OFFSET(0xA2472F0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SEGMENTVALUES_OFFSET UNITYSDK_OFFSET(0xA247430)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SPLITPOINTS_OFFSET UNITYSDK_OFFSET(0xA247420)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_INSERTSPLITPOINT_OFFSET UNITYSDK_OFFSET(0xA247440)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA248520)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA248510)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_REMOVESPLITPOINT_OFFSET UNITYSDK_OFFSET(0xA247690)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SETSEGMENTCOLOR_OFFSET UNITYSDK_OFFSET(0xA2478D0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SETSEGMENTVALUE_OFFSET UNITYSDK_OFFSET(0xA2477F0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SORTSPLITPOINTS_OFFSET UNITYSDK_OFFSET(0xA247D50)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0xA248440)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xA248670)

namespace RPGTools::HoudiniToUnity
{
	inline static constexpr unsigned int CurveAttribute_TypeDefinitionIndex = 44287;
