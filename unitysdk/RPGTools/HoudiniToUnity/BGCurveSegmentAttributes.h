...
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_COMPUTEFINGERPRINT_OFFSET UNITYSDK_OFFSET(0x19248740)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19248580)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x19247D30)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19247D20)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_CURRENTEDITINGATTRINDEX_OFFSET UNITYSDK_OFFSET(0x19247E10)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_CURRENTEDITINGINSTANCE_OFFSET UNITYSDK_OFFSET(0x19247D50)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_CURRENTEDITINGSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x19247ED0)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_ISINEDITMODE_OFFSET UNITYSDK_OFFSET(0x19247F90)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_GET_OVERLAYWINDOWRECT_OFFSET UNITYSDK_OFFSET(0x19248050)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_NOTIFYSEGMENTCHANGED_OFFSET UNITYSDK_OFFSET(0x192485D0)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_OVERRIDEBGCURVEGIZMOSFOR_OFFSET UNITYSDK_OFFSET(0x19248110)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_RESTOREBGCURVEGIZMOSFOR_OFFSET UNITYSDK_OFFSET(0x19248320)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_SET_CURRENTEDITINGATTRINDEX_OFFSET UNITYSDK_OFFSET(0x19247E70)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_SET_CURRENTEDITINGINSTANCE_OFFSET UNITYSDK_OFFSET(0x19247DB0)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_SET_CURRENTEDITINGSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x19247F30)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_SET_ISINEDITMODE_OFFSET UNITYSDK_OFFSET(0x19247FF0)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES_SET_OVERLAYWINDOWRECT_OFFSET UNITYSDK_OFFSET(0x192480B0)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES__CCTOR_OFFSET UNITYSDK_OFFSET(0x19248A90)
#define RPGTOOLS_HOUDINITOUNITY_BGCURVESEGMENTATTRIBUTES__CTOR_OFFSET UNITYSDK_OFFSET(0x19248A40)

namespace RPGTools::HoudiniToUnity
{
	inline static constexpr unsigned int BGCurveSegmentAttributes_TypeDefinitionIndex = 45159;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::BansheeGz::BGSpline::Curve::BGCurve*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(BGCurveSegmentAttributes_TypeDefinitionIndex)->GetStaticField(0x21590);
		}
		static ::RPGTools::HoudiniToUnity::BGCurveSegmentAttributes** StaticGet__CurrentEditingInstance_k__BackingField()
		{
			return (::RPGTools::HoudiniToUnity::BGCurveSegmentAttributes**)Il2CppClass::FromTypeDefinitionIndex(BGCurveSegmentAttributes_TypeDefinitionIndex)->GetStaticField(0x21598);
		}
		static ::System::Int32* StaticGet__CurrentEditingSegmentIndex_k__BackingField()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BGCurveSegmentAttributes_TypeDefinitionIndex)->GetStaticField(0x6A50);
		}
		static ::System::Int32* StaticGet__CurrentEditingAttrIndex_k__BackingField()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BGCurveSegmentAttributes_TypeDefinitionIndex)->GetStaticField(0x6A54);
		}
		static ::System::Boolean* StaticGet__IsInEditMode_k__BackingField()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BGCurveSegmentAttributes_TypeDefinitionIndex)->GetStaticField(0x6A58);
		}
		static ::UnityEngine::Rect* StaticGet__OverlayWindowRect_k__BackingField()
		{
			return (::UnityEngine::Rect*)Il2CppClass::FromTypeDefinitionIndex(BGCurveSegmentAttributes_TypeDefinitionIndex)->GetStaticField(0x6A5C);
		}
