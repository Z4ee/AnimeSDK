...
#define RPGTOOLS_STORY_CAPTUREANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAB19CD0)

namespace RPGTools::Story
{
	inline static constexpr unsigned int CaptureAnchorConfig_TypeDefinitionIndex = 39670;
