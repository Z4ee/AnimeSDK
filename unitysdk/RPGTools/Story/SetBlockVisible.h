...
#define RPGTOOLS_STORY_SETBLOCKVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB88DAA0)

namespace RPGTools::Story
{
	inline static constexpr unsigned int SetBlockVisible_TypeDefinitionIndex = 45582;
