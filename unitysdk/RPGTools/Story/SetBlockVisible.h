...
#define RPGTOOLS_STORY_SETBLOCKVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB19D10)

namespace RPGTools::Story
{
	inline static constexpr unsigned int SetBlockVisible_TypeDefinitionIndex = 39673;
