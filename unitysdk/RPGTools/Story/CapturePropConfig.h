...
#define RPGTOOLS_STORY_CAPTUREPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B529520)

namespace RPGTools::Story
{
	inline static constexpr unsigned int CapturePropConfig_TypeDefinitionIndex = 49393;
