...
#define RPGTOOLS_STORY_CAPTUREPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAB19CE0)

namespace RPGTools::Story
{
	inline static constexpr unsigned int CapturePropConfig_TypeDefinitionIndex = 39671;
