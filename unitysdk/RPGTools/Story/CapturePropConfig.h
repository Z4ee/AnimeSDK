...
#define RPGTOOLS_STORY_CAPTUREPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB88DA70)

namespace RPGTools::Story
{
	inline static constexpr unsigned int CapturePropConfig_TypeDefinitionIndex = 45580;
