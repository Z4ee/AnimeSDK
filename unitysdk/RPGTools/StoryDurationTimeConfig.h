...
#define RPGTOOLS_STORYDURATIONTIMECONFIG_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19D6A1A0)
#define RPGTOOLS_STORYDURATIONTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6A1F0)

namespace RPGTools
{
	inline static constexpr unsigned int StoryDurationTimeConfig_TypeDefinitionIndex = 46016;
	...
	public:
		...
		{
			return (::RPGTools::StoryDurationTimeConfig**)Il2CppClass::FromTypeDefinitionIndex(StoryDurationTimeConfig_TypeDefinitionIndex)->GetStaticField(0x6B240);
		}
