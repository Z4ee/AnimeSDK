...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xE804990)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_GET_OWNERREGION_OFFSET UNITYSDK_OFFSET(0xE8049B0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_READLAYER_OFFSET UNITYSDK_OFFSET(0xE804BB0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_SET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xE8049A0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_STORELAYER_OFFSET UNITYSDK_OFFSET(0xE804AF0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xE804CE0)
