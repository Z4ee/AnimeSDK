...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B522B10)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_GET_OWNERREGION_OFFSET UNITYSDK_OFFSET(0x1B522B30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_READLAYER_OFFSET UNITYSDK_OFFSET(0x1B522D30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_SET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B522B20)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_STORELAYER_OFFSET UNITYSDK_OFFSET(0x1B522C70)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B522E60)

namespace RPGTools::LDWhiteBox
{
	inline static constexpr unsigned int WhiteBoxPolishLayer_TypeDefinitionIndex = 49385;
