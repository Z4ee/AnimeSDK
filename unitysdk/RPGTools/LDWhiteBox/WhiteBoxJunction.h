...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xE8031C0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_DISCCOLOR_OFFSET UNITYSDK_OFFSET(0xE803770)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_JUNCTIONID_OFFSET UNITYSDK_OFFSET(0xE803140)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_JUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0xE8031A0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_JUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0xE803160)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_OWNERREGION_OFFSET UNITYSDK_OFFSET(0xE803270)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_QUALIFIEDID_OFFSET UNITYSDK_OFFSET(0xE803200)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0xE803180)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_VIEWHIDDEN_OFFSET UNITYSDK_OFFSET(0xE8031E0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_METHOD_5_57D95388FFE72045_OFFSET UNITYSDK_OFFSET(0xE8036A0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE8034A0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xE803520)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE803420)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xE8031D0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_JUNCTIONID_OFFSET UNITYSDK_OFFSET(0xE803150)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_JUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0xE8031B0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_JUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0xE803170)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0xE803190)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_VIEWHIDDEN_OFFSET UNITYSDK_OFFSET(0xE8031F0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE803890)
