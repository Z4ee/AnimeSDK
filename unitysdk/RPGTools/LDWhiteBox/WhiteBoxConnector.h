...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_CLAMPINTOOWNERREGION_OFFSET UNITYSDK_OFFSET(0x1B520C80)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_GET_CONNECTEDPATHID_OFFSET UNITYSDK_OFFSET(0x1B520B80)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_GET_CONNECTORID_OFFSET UNITYSDK_OFFSET(0x1B520B30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B520BA0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1B520B50)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_GET_QUALIFIEDID_OFFSET UNITYSDK_OFFSET(0x1B520BE0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_GET_VIEWHIDDEN_OFFSET UNITYSDK_OFFSET(0x1B520BC0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_METHOD_5_2C6213D33BFB37E3_OFFSET UNITYSDK_OFFSET(0x1B520F30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B521160)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B5211E0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5210E0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_SET_CONNECTEDPATHID_OFFSET UNITYSDK_OFFSET(0x1B520B90)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_SET_CONNECTORID_OFFSET UNITYSDK_OFFSET(0x1B520B40)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B520BB0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1B520B70)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR_SET_VIEWHIDDEN_OFFSET UNITYSDK_OFFSET(0x1B520BD0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXCONNECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5212A0)
