...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xE8046A0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM_GET_KIND_OFFSET UNITYSDK_OFFSET(0xE804680)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM_READITEM_OFFSET UNITYSDK_OFFSET(0xE8047C0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xE8046B0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM_SET_KIND_OFFSET UNITYSDK_OFFSET(0xE804690)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM_STOREITEM_OFFSET UNITYSDK_OFFSET(0xE8046C0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE804980)
