...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1B523120)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B522EB0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_DIRECTCHILDREGIONS_OFFSET UNITYSDK_OFFSET(0x1B5232C0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_HASCHILDREGIONS_OFFSET UNITYSDK_OFFSET(0x1B523140)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_REGIONID_OFFSET UNITYSDK_OFFSET(0x1B522E70)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_REGIONNAME_OFFSET UNITYSDK_OFFSET(0x1B522E90)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1B522ED0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B523090)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B523560)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B523490)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B523370)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B523510)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x1B522F30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1B523130)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B522EC0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_REGIONID_OFFSET UNITYSDK_OFFSET(0x1B522E80)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_REGIONNAME_OFFSET UNITYSDK_OFFSET(0x1B522EA0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1B522EE0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B5230B0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5235C0)
