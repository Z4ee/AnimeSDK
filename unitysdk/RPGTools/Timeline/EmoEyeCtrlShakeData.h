...
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKEDATA_METHOD_1_1D64A06884287378_OFFSET UNITYSDK_OFFSET(0x19A3F250)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKEDATA_METHOD_1_37AFF23E5EB159ED_OFFSET UNITYSDK_OFFSET(0x19A3FAB0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKEDATA_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x19A3F7F0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3FE30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeCtrlShakeData_TypeDefinitionIndex = 46331;
