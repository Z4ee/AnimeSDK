...
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B86F0)
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199B8830)
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199B8840)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StopStoryLightControlClip_TypeDefinitionIndex = 46554;
