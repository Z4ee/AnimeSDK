...
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABA1D20)
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABA1EC0)
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABA1ED0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StopStoryLightControlClip_TypeDefinitionIndex = 39163;
