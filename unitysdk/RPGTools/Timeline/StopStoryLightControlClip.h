...
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD057970)
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD057AB0)
#define RPGTOOLS_TIMELINE_STOPSTORYLIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD057AC0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StopStoryLightControlClip_TypeDefinitionIndex = 45620;
