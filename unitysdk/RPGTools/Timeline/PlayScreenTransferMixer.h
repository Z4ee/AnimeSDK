...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_2F1D36D2B56EFA9E_OFFSET UNITYSDK_OFFSET(0x199919C0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_416EC8B7F32859DE_OFFSET UNITYSDK_OFFSET(0x19991CB0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x19992270)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_80EF3B5D9A572F5D_OFFSET UNITYSDK_OFFSET(0x19992080)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_B8BA6E85AEC72F3E_OFFSET UNITYSDK_OFFSET(0x19991E10)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_DB24A3DBF686F687_OFFSET UNITYSDK_OFFSET(0x19991BA0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_F94B4ABE3953A8DB_OFFSET UNITYSDK_OFFSET(0x199918B0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19990EF0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x19990F70)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x199910A0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19991140)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0x199922C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferMixer_TypeDefinitionIndex = 46441;
