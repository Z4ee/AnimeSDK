...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_2F1D36D2B56EFA9E_OFFSET UNITYSDK_OFFSET(0x1B09D7E0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_416EC8B7F32859DE_OFFSET UNITYSDK_OFFSET(0x1B09DAD0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x1B09E090)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_80EF3B5D9A572F5D_OFFSET UNITYSDK_OFFSET(0x1B09DEA0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_B8BA6E85AEC72F3E_OFFSET UNITYSDK_OFFSET(0x1B09DC30)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_DB24A3DBF686F687_OFFSET UNITYSDK_OFFSET(0x1B09D9C0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_F94B4ABE3953A8DB_OFFSET UNITYSDK_OFFSET(0x1B09D6D0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B09CD10)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1B09CD90)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B09CEC0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B09CF60)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09E0E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferMixer_TypeDefinitionIndex = 48676;
	...
	public:
		...
		::System::Boolean Method_2_2F1D36D2B56EFA9E(::UnityEngine::Playables::Playable a1, ::System::Single a2, ::System::Single a3, ::RPG::GameCore::ScreenTransferType a4, ::System::UInt32 a5)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Playables::Playable, ::System::Single, ::System::Single, ::RPG::GameCore::ScreenTransferType, ::System::UInt32))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_2F1D36D2B56EFA9E_OFFSET))(this, a1, a2, a3, a4, a5);
		}

		::RPG::GameCore::PlayScreenTransfer* Method_2_DB24A3DBF686F687(::System::Single a1, ::System::Single a2, ::RPG::GameCore::ScreenTransferType a3, ::RPGTools::Timeline::PlayScreenTransferBehaviour* a4, ::RPGTools::Timeline::ScreenTransferTextBehaviour* a5)
		{
			return ((::RPG::GameCore::PlayScreenTransfer*(*)(::PVOID, ::System::Single, ::System::Single, ::RPG::GameCore::ScreenTransferType, ::RPGTools::Timeline::PlayScreenTransferBehaviour*, ::RPGTools::Timeline::ScreenTransferTextBehaviour*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_DB24A3DBF686F687_OFFSET))(this, a1, a2, a3, a4, a5);
		}
