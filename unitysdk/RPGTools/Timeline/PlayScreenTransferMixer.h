...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_56EE24C58B6B4B13_OFFSET UNITYSDK_OFFSET(0xAB7F9C0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xAB7FF80)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_80EF3B5D9A572F5D_OFFSET UNITYSDK_OFFSET(0xAB7FD90)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_AC48B20BF4361CA7_OFFSET UNITYSDK_OFFSET(0xAB7F6F0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_B8BA6E85AEC72F3E_OFFSET UNITYSDK_OFFSET(0xAB7FB20)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_CEB6E0A2EBF74DA7_OFFSET UNITYSDK_OFFSET(0xAB7F890)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_METHOD_2_F94B4ABE3953A8DB_OFFSET UNITYSDK_OFFSET(0xAB7F5E0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB7EB80)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xAB7EC00)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xAB7ED10)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB7EDA0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7FFD0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB7FFE0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER___IFIXBASEPROXY_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xAB7FFF0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER___IFIXBASEPROXY_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xAB80000)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB80010)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferMixer_TypeDefinitionIndex = 39056;
