...
#define RPGTOOLS_TIMELINE_SHOWUICLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0C36B0)
#define RPGTOOLS_TIMELINE_SHOWUICLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C3850)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ShowUIClip_TypeDefinitionIndex = 48863;
