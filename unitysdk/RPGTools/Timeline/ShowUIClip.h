...
#define RPGTOOLS_TIMELINE_SHOWUICLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD055B60)
#define RPGTOOLS_TIMELINE_SHOWUICLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD055D00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ShowUIClip_TypeDefinitionIndex = 45680;
