...
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BF28EC0)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1BF29040)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF290B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBgEffectFrameTrack_TypeDefinitionIndex = 48836;
