...
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D14A7B0)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D14A7A0)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14A940)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceHpChangeClip_TypeDefinitionIndex = 48503;
