...
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFFBCF0)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFFBCE0)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFBE80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceHpChangeClip_TypeDefinitionIndex = 45345;
