...
#define RPGTOOLS_TIMELINE_TALKIMAGEV2SHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB922AF0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2SHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB922AE0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2SHOWCLIP_METHOD_4_32F5E8B0F86B286F_OFFSET UNITYSDK_OFFSET(0xB922CB0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2SHOWCLIP_METHOD_4_79A0DD953C362A58_OFFSET UNITYSDK_OFFSET(0xB922D30)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2SHOWCLIP_METHOD_4_E4AE005360690BC3_OFFSET UNITYSDK_OFFSET(0xB922DB0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2SHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB922E30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkImageV2ShowClip_TypeDefinitionIndex = 45117;
