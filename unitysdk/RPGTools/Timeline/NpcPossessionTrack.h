...
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB7C270)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB7C380)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7C3F0)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB7C410)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB7C450)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NpcPossessionTrack_TypeDefinitionIndex = 39053;
