...
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR_METHOD_3_484762C2E531AD16_OFFSET UNITYSDK_OFFSET(0xABAC490)
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xABAC510)
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR_METHOD_3_649C3F0ABF636A99_OFFSET UNITYSDK_OFFSET(0xABAC2A0)
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xABAC500)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkImageEvtBehaviour_TypeDefinitionIndex = 39202;
