...
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINECLIP_AWAKE_OFFSET UNITYSDK_OFFSET(0x19990A40)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19990A80)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19990A20)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x19990A30)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19990C20)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformerEventTimelineClip_TypeDefinitionIndex = 46662;
