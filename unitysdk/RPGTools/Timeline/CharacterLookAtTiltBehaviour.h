...
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB382C0)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB38610)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB38620)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterLookAtTiltBehaviour_TypeDefinitionIndex = 38830;
