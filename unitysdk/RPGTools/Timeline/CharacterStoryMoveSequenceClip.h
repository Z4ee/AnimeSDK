...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESEQUENCECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF68C0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESEQUENCECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF6A50)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESEQUENCECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF6A60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveSequenceClip_TypeDefinitionIndex = 45312;
