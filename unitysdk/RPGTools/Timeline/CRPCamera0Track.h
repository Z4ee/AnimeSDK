...
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D1316D0)
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D131820)
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1318F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCamera0Track_TypeDefinitionIndex = 48336;
