...
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB2A4A0)
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB2A650)
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2A710)
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB2A7F0)
#define RPGTOOLS_TIMELINE_CRPCAMERA0TRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB2A890)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCamera0Track_TypeDefinitionIndex = 38734;
