...
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A3CBD0)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A3CBC0)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3CD60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoAnimLayerEmotionFullClip_TypeDefinitionIndex = 46316;
