...
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_GET_PROPCOMPONENT_OFFSET UNITYSDK_OFFSET(0xD022F00)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_GET_VISIBLECOMPONENT_OFFSET UNITYSDK_OFFSET(0xD0230C0)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_METHOD_2_A1168610D32C43E0_OFFSET UNITYSDK_OFFSET(0xD022F90)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD0231C0)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD023220)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD023230)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HidePropBehaviour_TypeDefinitionIndex = 45428;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET))(this, a1);
		}
	};
}
