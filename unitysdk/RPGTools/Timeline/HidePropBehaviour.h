...
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_GET_PROPCOMPONENT_OFFSET UNITYSDK_OFFSET(0x19A5E390)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_GET_VISIBLECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19A5E540)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_METHOD_2_A1168610D32C43E0_OFFSET UNITYSDK_OFFSET(0x19A5E420)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x19A5E640)
#define RPGTOOLS_TIMELINE_HIDEPROPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A5E6A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HidePropBehaviour_TypeDefinitionIndex = 46362;
