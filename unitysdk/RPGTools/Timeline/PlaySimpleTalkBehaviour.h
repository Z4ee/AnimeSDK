...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB81420)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB80B90)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xAB815B0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xAB80AB0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB81730)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB81760)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB81750)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xAB81770)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKBEHAVIOUR___IFIXBASEPROXY_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xAB81740)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlaySimpleTalkBehaviour_TypeDefinitionIndex = 39062;
