...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_METHOD_2_8F527828D3994AB7_OFFSET UNITYSDK_OFFSET(0xAB3FFB0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_METHOD_2_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0xAB3F9B0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB3FE90)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB3F890)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xAB3FF10)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xAB3FF60)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xAB401A0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB3F910)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB40220)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB40250)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB40230)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR___IFIXBASEPROXY_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xAB40260)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR___IFIXBASEPROXY_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xAB40270)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR___IFIXBASEPROXY_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xAB40280)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB40240)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStorySteerBehaviour_TypeDefinitionIndex = 38871;
