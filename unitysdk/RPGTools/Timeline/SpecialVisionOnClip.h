...
#define RPGTOOLS_TIMELINE_SPECIALVISIONONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9169B0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB9169A0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB916B70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SpecialVisionOnClip_TypeDefinitionIndex = 45046;
