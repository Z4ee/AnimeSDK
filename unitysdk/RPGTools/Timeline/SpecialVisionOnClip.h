...
#define RPGTOOLS_TIMELINE_SPECIALVISIONONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8E6900)
#define RPGTOOLS_TIMELINE_SPECIALVISIONONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE8E68F0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E6A90)
