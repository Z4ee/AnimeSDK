...
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB49C00)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB49A20)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB49CB0)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB49E30)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB49D90)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int CameraCompositionTrack_TypeDefinitionIndex = 39563;
