...
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE83D280)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE83D330)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTTRACK_METHOD_5_24C8975D66D2BDF0_OFFSET UNITYSDK_OFFSET(0xE83D500)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE83DC40)
