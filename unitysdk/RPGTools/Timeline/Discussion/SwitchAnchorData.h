...
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD002040)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xD002080)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD002000)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0020C0)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int SwitchAnchorData_TypeDefinitionIndex = 46050;
