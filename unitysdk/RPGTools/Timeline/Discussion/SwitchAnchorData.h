...
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB8BEBE0)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xB8BEC20)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8BEBA0)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8BEC60)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int SwitchAnchorData_TypeDefinitionIndex = 45467;
