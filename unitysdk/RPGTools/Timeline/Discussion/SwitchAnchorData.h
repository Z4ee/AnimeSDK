...
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xAB49F00)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xAB49F40)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB49EC0)
#define RPGTOOLS_TIMELINE_DISCUSSION_SWITCHANCHORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB49F80)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int SwitchAnchorData_TypeDefinitionIndex = 39558;
