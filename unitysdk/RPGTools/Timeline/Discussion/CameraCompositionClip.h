...
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB49830)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB49820)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_ENABLEEDIT_OFFSET UNITYSDK_OFFSET(0xAB49810)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xAB497F0)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xAB49800)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB499F0)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int CameraCompositionClip_TypeDefinitionIndex = 39561;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_SET_STREAMINGSOURCEINDEX_OFFSET))(this, value);
		}
