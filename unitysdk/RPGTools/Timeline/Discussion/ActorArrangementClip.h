...
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A39170)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A39160)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTCLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19A392D0)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A39310)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int ActorArrangementClip_TypeDefinitionIndex = 46987;
