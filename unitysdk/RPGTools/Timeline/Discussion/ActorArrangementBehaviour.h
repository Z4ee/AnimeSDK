...
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x19A37D30)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_1_OFFSET UNITYSDK_OFFSET(0x19A38380)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x19A37E00)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x19A38700)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_C1F4FF5533AF9A70_OFFSET UNITYSDK_OFFSET(0x19A38AB0)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_C4EFD31239F98A71_OFFSET UNITYSDK_OFFSET(0x19A38D30)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19A37D50)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x19A37D40)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A39150)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int ActorArrangementBehaviour_TypeDefinitionIndex = 46990;
