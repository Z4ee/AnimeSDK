...
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xE83BC40)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_1_OFFSET UNITYSDK_OFFSET(0xE83C290)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xE83BD10)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0xE83C610)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_C1F4FF5533AF9A70_OFFSET UNITYSDK_OFFSET(0xE83C9F0)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_C4EFD31239F98A71_OFFSET UNITYSDK_OFFSET(0xE83CC70)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE83BC60)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xE83BC50)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE83D080)
