...
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB47700)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_1_OFFSET UNITYSDK_OFFSET(0xAB47D60)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xAB477D0)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xAB480F0)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_C1F4FF5533AF9A70_OFFSET UNITYSDK_OFFSET(0xAB484C0)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_METHOD_2_C4EFD31239F98A71_OFFSET UNITYSDK_OFFSET(0xAB48740)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB47720)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB47710)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB48B60)
#define RPGTOOLS_TIMELINE_DISCUSSION_ACTORARRANGEMENTBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB48B70)

namespace RPGTools::Timeline::Discussion
{
	inline static constexpr unsigned int ActorArrangementBehaviour_TypeDefinitionIndex = 39559;
