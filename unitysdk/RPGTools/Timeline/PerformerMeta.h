...
#define RPGTOOLS_TIMELINE_PERFORMERMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7E980)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformerMeta_TypeDefinitionIndex = 39268;
