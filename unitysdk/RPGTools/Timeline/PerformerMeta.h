...
#define RPGTOOLS_TIMELINE_PERFORMERMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xD034CA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformerMeta_TypeDefinitionIndex = 45725;
