...
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_GET_SIMPLETALKCONFIG_OFFSET UNITYSDK_OFFSET(0xE83A500)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xE83A520)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_GET_USEDISCUSSIONMOUTHTALK_OFFSET UNITYSDK_OFFSET(0xE83A540)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_METHOD_2_885DF4DA0F709E3E_OFFSET UNITYSDK_OFFSET(0xE83A820)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE83A560)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xE83A5E0)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE83A760)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_SET_SIMPLETALKCONFIG_OFFSET UNITYSDK_OFFSET(0xE83A510)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xE83A530)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR_SET_USEDISCUSSIONMOUTHTALK_OFFSET UNITYSDK_OFFSET(0xE83A550)
#define RPGTOOLS_TIMELINE_DEBATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE83AD30)
