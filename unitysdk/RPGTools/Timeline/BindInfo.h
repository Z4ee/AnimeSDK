...
#define RPGTOOLS_TIMELINE_BINDINFO_METHOD_2_8915213097B92E4D_OFFSET UNITYSDK_OFFSET(0x3A2E1C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BindInfo_TypeDefinitionIndex = 46715;
