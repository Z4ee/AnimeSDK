...
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_7EE675974ADCBBF3_OFFSET UNITYSDK_OFFSET(0x148A10)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x148930)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1489A0)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_F42C65D64DDCFCC1_OFFSET UNITYSDK_OFFSET(0xCFE2C20)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBackgroundData_TypeDefinitionIndex = 45185;
