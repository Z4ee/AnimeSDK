...
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_7EE675974ADCBBF3_OFFSET UNITYSDK_OFFSET(0xE3210)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0xE3130)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE31A0)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDDATA_METHOD_2_F42C65D64DDCFCC1_OFFSET UNITYSDK_OFFSET(0xB89EC50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBackgroundData_TypeDefinitionIndex = 44638;
