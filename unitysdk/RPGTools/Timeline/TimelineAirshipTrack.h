...
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABAE510)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xABAE770)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xABAE890)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABAE970)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xABAE9B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TimelineAirshipTrack_TypeDefinitionIndex = 38709;
	...
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK__CTOR_OFFSET))(this);
		}

		::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph a1, ::UnityEngine::GameObject* a2, ::UnityEngine::Timeline::TimelineClip* a3)
		{
			return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*, ::UnityEngine::Timeline::TimelineClip*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK_CREATEPLAYABLE_OFFSET))(this, a1, a2, a3);
		}
