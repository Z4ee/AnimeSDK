...
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199AC000)
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199ABFF0)
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199AC190)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropSetSceneTVMenuClip_TypeDefinitionIndex = 46477;
