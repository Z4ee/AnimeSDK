...
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0B8360)
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0B8350)
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B84F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropSetSceneTVMenuClip_TypeDefinitionIndex = 48712;
