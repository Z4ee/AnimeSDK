...
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB95BF0)
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB95BE0)
#define RPGTOOLS_TIMELINE_PROPSETSCENETVMENUCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB95DB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropSetSceneTVMenuClip_TypeDefinitionIndex = 39092;
