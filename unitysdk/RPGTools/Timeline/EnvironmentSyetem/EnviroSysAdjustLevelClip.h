...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSADJUSTLEVELCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8D6DC0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSADJUSTLEVELCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8D6EE0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSADJUSTLEVELCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8D6EF0)

namespace RPGTools::Timeline::EnvironmentSyetem
{
	inline static constexpr unsigned int EnviroSysAdjustLevelClip_TypeDefinitionIndex = 45347;
