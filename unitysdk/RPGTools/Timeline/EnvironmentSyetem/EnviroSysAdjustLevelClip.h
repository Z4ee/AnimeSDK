...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSADJUSTLEVELCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB63310)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSADJUSTLEVELCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB63430)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSADJUSTLEVELCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB63440)

namespace RPGTools::Timeline::EnvironmentSyetem
{
	inline static constexpr unsigned int EnviroSysAdjustLevelClip_TypeDefinitionIndex = 39438;
