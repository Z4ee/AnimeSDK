...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_54D96652D3FC94F2_OFFSET UNITYSDK_OFFSET(0xB8DA220)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xB8D9C90)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xB8DA690)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xB8D9E70)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xB8D9C00)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB8D9B40)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xB8DA970)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_DAE8DBED9D81F8BB_OFFSET UNITYSDK_OFFSET(0xB8DA510)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_DD784213055292FB_OFFSET UNITYSDK_OFFSET(0xB8DA830)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xB8D9930)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xB8D9D00)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8D9D70)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB8DA930)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8DA910)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xB8DA940)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xB8DA950)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8DA960)

namespace RPGTools::Timeline::EnvironmentSyetem
{
	inline static constexpr unsigned int EnviroSysTransitionBehaviour_TypeDefinitionIndex = 45353;
	...
	public:
		...
		{
			return (::RPGTools::Timeline::EnvironmentSyetem::EnviroSysTransitionBehaviour**)Il2CppClass::FromTypeDefinitionIndex(EnviroSysTransitionBehaviour_TypeDefinitionIndex)->GetStaticField(0x695B0);
		}
		static ::System::Int32* StaticGet__LastEnvTransitionHandle()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviroSysTransitionBehaviour_TypeDefinitionIndex)->GetStaticField(0x11720);
		}
