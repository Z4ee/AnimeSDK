...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A57DE0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A57EB0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19A57EC0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A57F20)

namespace RPGTools::Timeline::EnvironmentSyetem
{
	inline static constexpr unsigned int EnviroSysTransitionClip_TypeDefinitionIndex = 46853;
