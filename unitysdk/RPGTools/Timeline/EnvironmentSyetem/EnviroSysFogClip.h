...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSFOGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8D9660)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSFOGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8D9780)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSFOGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8D9790)

namespace RPGTools::Timeline::EnvironmentSyetem
{
	inline static constexpr unsigned int EnviroSysFogClip_TypeDefinitionIndex = 45351;
