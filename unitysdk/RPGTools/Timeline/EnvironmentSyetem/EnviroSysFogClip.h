...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSFOGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A56520)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSFOGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A565F0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSFOGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A56600)

namespace RPGTools::Timeline::EnvironmentSyetem
{
	inline static constexpr unsigned int EnviroSysFogClip_TypeDefinitionIndex = 46847;
