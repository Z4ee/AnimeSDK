...
#define RPGTOOLS_TIMELINE_DEBATETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE83AF70)
#define RPGTOOLS_TIMELINE_DEBATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE83B020)
#define RPGTOOLS_TIMELINE_DEBATETRACK_METHOD_5_F9F9B43450663CAC_OFFSET UNITYSDK_OFFSET(0xE83B280)
#define RPGTOOLS_TIMELINE_DEBATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE83B8A0)
