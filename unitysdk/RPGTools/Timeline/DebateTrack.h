...
#define RPGTOOLS_TIMELINE_DEBATETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A37090)
#define RPGTOOLS_TIMELINE_DEBATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A37140)
#define RPGTOOLS_TIMELINE_DEBATETRACK_METHOD_5_F9F9B43450663CAC_OFFSET UNITYSDK_OFFSET(0x19A373A0)
#define RPGTOOLS_TIMELINE_DEBATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A379C0)
