...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWBACKGROUNDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D133200)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWBACKGROUNDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D1331F0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWBACKGROUNDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1332F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowBackgroundClip_TypeDefinitionIndex = 48349;
