...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWBACKGROUNDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB2C3F0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWBACKGROUNDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB2C3E0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWBACKGROUNDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2C540)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowBackgroundClip_TypeDefinitionIndex = 38747;
