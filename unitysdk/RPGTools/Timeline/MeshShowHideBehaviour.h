...
#define RPGTOOLS_TIMELINE_MESHSHOWHIDEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB77B00)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB77D80)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB77D90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MeshShowHideBehaviour_TypeDefinitionIndex = 39025;
