...
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0216E0)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD0216D0)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_GET_END_OFFSET UNITYSDK_OFFSET(0xD0216B0)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_SET_END_OFFSET UNITYSDK_OFFSET(0xD0216C0)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD021870)

namespace RPGTools::Timeline::GamePlay
{
	inline static constexpr unsigned int GamePlayTimeRewindClip_TypeDefinitionIndex = 45922;
