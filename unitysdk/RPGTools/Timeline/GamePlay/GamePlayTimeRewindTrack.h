...
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A5B400)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A5B280)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A5B540)

namespace RPGTools::Timeline::GamePlay
{
	inline static constexpr unsigned int GamePlayTimeRewindTrack_TypeDefinitionIndex = 46863;
