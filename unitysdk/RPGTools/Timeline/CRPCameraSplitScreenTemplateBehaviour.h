...
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB301C0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB301E0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB301D0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB30440)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB30450)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSplitScreenTemplateBehaviour_TypeDefinitionIndex = 38768;
