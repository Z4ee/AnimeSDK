...
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xE904AF0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYBEHAVIOUR_METHOD_2_F6C7E9EFFF4F7C6C_OFFSET UNITYSDK_OFFSET(0xE904CA0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE904B10)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xE904B00)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE904DE0)
