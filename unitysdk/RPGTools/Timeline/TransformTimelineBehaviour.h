...
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xB9251E0)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_GET_TIMELINEORIGINPOSITION_OFFSET UNITYSDK_OFFSET(0xB925200)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_GET_TIMELINEORIGINROTATION_OFFSET UNITYSDK_OFFSET(0xB925230)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xB925260)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB9253A0)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB9252E0)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xB9251F0)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_SET_TIMELINEORIGINPOSITION_OFFSET UNITYSDK_OFFSET(0xB925220)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR_SET_TIMELINEORIGINROTATION_OFFSET UNITYSDK_OFFSET(0xB925250)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB925400)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xB925410)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB925430)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB925420)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransformTimelineBehaviour_TypeDefinitionIndex = 45234;
