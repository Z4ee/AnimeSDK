...
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F52B70)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F52B60)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_METHOD_4_32F5E8B0F86B286F_OFFSET UNITYSDK_OFFSET(0x19F52CD0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_METHOD_4_E4AE005360690BC3_OFFSET UNITYSDK_OFFSET(0x19F52D50)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F52DD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkImageV2HideClip_TypeDefinitionIndex = 46600;
