...
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8F4AE0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE8F4AD0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_METHOD_4_32F5E8B0F86B286F_OFFSET UNITYSDK_OFFSET(0xE8F4C40)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_METHOD_4_E4AE005360690BC3_OFFSET UNITYSDK_OFFSET(0xE8F4CC0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8F4D40)
