...
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD062060)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD062050)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_METHOD_4_32F5E8B0F86B286F_OFFSET UNITYSDK_OFFSET(0xD0621C0)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP_METHOD_4_E4AE005360690BC3_OFFSET UNITYSDK_OFFSET(0xD062240)
#define RPGTOOLS_TIMELINE_TALKIMAGEV2HIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0622C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkImageV2HideClip_TypeDefinitionIndex = 45662;
