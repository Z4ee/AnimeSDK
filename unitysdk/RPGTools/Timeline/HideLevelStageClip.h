...
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD022840)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD0227D0)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xD0227E0)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0229E0)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP___IFIXBASEPROXY_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xD022A30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideLevelStageClip_TypeDefinitionIndex = 45707;
