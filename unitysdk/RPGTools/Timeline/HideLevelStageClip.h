...
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8DF910)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8DF8A0)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xB8DF8B0)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8DFB20)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGECLIP___IFIXBASEPROXY_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xB8DFB70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideLevelStageClip_TypeDefinitionIndex = 45159;
