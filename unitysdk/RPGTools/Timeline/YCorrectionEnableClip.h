...
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF3C150)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF3C2E0)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF3C2F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int YCorrectionEnableClip_TypeDefinitionIndex = 48872;
