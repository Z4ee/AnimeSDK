...
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB92F930)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB92FB20)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB92FB30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int YCorrectionEnableClip_TypeDefinitionIndex = 45141;
