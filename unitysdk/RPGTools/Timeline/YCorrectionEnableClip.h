...
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABBA340)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABBA530)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABBA540)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int YCorrectionEnableClip_TypeDefinitionIndex = 39232;
