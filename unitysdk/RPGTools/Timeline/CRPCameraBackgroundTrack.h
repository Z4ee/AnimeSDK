...
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB2AF30)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2B0E0)
#define RPGTOOLS_TIMELINE_CRPCAMERABACKGROUNDTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB2B1C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBackgroundTrack_TypeDefinitionIndex = 38738;
