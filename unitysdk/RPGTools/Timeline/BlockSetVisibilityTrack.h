...
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB89D940)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xB89DB20)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB89DB90)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB89DC70)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xB89DD10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BlockSetVisibilityTrack_TypeDefinitionIndex = 44631;
