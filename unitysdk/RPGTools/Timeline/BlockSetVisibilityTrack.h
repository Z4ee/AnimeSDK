...
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D130C70)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D130DF0)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D130E60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BlockSetVisibilityTrack_TypeDefinitionIndex = 48334;
