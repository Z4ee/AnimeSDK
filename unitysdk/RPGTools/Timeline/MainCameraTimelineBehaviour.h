...
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x19A6A8F0)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x19A6A950)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_GET_ROLL_OFFSET UNITYSDK_OFFSET(0x19A6A930)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_GET_TIMELINEORIGINPOSITION_OFFSET UNITYSDK_OFFSET(0x19A6A970)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_GET_TIMELINEORIGINROTATION_OFFSET UNITYSDK_OFFSET(0x19A6A9B0)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19A6B450)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x19A6AD00)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19A6A9D0)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x19A6B2D0)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19A6ADD0)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_SET_FORWARD_OFFSET UNITYSDK_OFFSET(0x19A6A910)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x19A6A960)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_SET_ROLL_OFFSET UNITYSDK_OFFSET(0x19A6A940)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_SET_TIMELINEORIGINPOSITION_OFFSET UNITYSDK_OFFSET(0x19A6A990)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR_SET_TIMELINEORIGINROTATION_OFFSET UNITYSDK_OFFSET(0x19A6A9C0)
#define RPGTOOLS_TIMELINE_MAINCAMERATIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6B490)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MainCameraTimelineBehaviour_TypeDefinitionIndex = 46657;
