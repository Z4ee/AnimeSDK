...
#define RPGTOOLS_TIMELINE_MOCAPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB784B0)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB784A0)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_GET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0xAB78470)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_SET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0xAB78490)
#define RPGTOOLS_TIMELINE_MOCAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB786A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MocapClip_TypeDefinitionIndex = 39028;
