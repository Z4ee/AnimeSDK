...
#define RPGTOOLS_TIMELINE_MOCAPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1998B160)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1998B150)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_GET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x1998B120)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_SET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x1998B140)
#define RPGTOOLS_TIMELINE_MOCAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1998B2F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MocapClip_TypeDefinitionIndex = 46413;
