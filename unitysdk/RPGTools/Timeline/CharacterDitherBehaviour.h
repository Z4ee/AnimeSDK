...
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1D13BB50)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR_METHOD_2_4DAE53B8419F40B2_OFFSET UNITYSDK_OFFSET(0x1D13C010)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR_METHOD_2_681F6715D9F8296E_OFFSET UNITYSDK_OFFSET(0x1D13BC40)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D13BB70)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1D13BE90)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1D13BB60)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13C0E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDitherBehaviour_TypeDefinitionIndex = 48406;
