...
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B532170)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B532160)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5322D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AtmosphereCenterClip_TypeDefinitionIndex = 48320;
