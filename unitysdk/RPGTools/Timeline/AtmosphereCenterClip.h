...
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB21590)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB21580)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB21750)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AtmosphereCenterClip_TypeDefinitionIndex = 38718;
