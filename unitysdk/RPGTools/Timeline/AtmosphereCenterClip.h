...
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFD9B80)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFD9B70)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD9CE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AtmosphereCenterClip_TypeDefinitionIndex = 45164;
