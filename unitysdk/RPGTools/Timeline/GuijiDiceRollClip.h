...
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE861610)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE861600)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xE8614B0)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_RESULTLOCALEULERANGLES_OFFSET UNITYSDK_OFFSET(0xE860FF0)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_WWISEEVENT_OFFSET UNITYSDK_OFFSET(0xE861550)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8617A0)
