...
#define RPGTOOLS_TIMELINE_ANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xAB203F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorParam_TypeDefinitionIndex = 38958;
