...
#define RPGTOOLS_TIMELINE_ANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB894170)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorParam_TypeDefinitionIndex = 44861;
