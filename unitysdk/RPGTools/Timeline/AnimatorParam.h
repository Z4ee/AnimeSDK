...
#define RPGTOOLS_TIMELINE_ANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B530470)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorParam_TypeDefinitionIndex = 48582;
