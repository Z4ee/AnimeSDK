...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_2C6BB5BD685E1939_OFFSET UNITYSDK_OFFSET(0xB8F69F0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_4FFABA760D86B308_OFFSET UNITYSDK_OFFSET(0xB8F61B0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_AB1A253BFABC50A9_OFFSET UNITYSDK_OFFSET(0xB8F6630)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xB8F6460)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB8F65A0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8F6100)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F6A40)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER___IFIXBASEPROXY_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xB8F6A60)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER___IFIXBASEPROXY_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB8F6A70)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8F6A50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlaySimpleTalkMixer_TypeDefinitionIndex = 44969;
