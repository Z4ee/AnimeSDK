...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_2C6BB5BD685E1939_OFFSET UNITYSDK_OFFSET(0x1B0A02E0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_BE1FA6C0D940BC7C_OFFSET UNITYSDK_OFFSET(0x1B09F9F0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_C7B58231E4F61838_OFFSET UNITYSDK_OFFSET(0x1B09FEC0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1B09FCC0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B09FE10)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B09F940)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A0330)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlaySimpleTalkMixer_TypeDefinitionIndex = 48686;
