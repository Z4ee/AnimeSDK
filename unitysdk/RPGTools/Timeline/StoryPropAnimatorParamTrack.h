...
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB91C3B0)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB91C4B0)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB91C4C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropAnimatorParamTrack_TypeDefinitionIndex = 44979;
