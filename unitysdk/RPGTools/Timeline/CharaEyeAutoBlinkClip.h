...
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D1397C0)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D1397B0)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D139950)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharaEyeAutoBlinkClip_TypeDefinitionIndex = 48386;
