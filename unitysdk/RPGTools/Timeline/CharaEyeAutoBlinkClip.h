...
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B353690)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B353680)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B353820)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharaEyeAutoBlinkClip_TypeDefinitionIndex = 46152;
