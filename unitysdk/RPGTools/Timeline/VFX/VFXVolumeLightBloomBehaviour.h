...
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xD06F860)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_METHOD_2_1E866EA42109D73D_OFFSET UNITYSDK_OFFSET(0xD06F690)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_METHOD_2_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xD06EE80)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_METHOD_2_41B039A4E2A7F091_OFFSET UNITYSDK_OFFSET(0xD06F7B0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xD06ED20)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_METHOD_2_E029264C30E5920C_OFFSET UNITYSDK_OFFSET(0xD06F2C0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD06F190)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD06EBD0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD06F270)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD06EDE0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xD06F870)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD06F880)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD06F8B0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD06F890)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD06F8C0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD06F8A0)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXVolumeLightBloomBehaviour_TypeDefinitionIndex = 45963;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_ProcessFrame(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2, ::System::Object* a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData, ::System::Object*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET))(this, a1, a2, a3);
		}

		::System::Void __iFixBaseProxy_OnBehaviourPause(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_OnGraphStop(::UnityEngine::Playables::Playable a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET))(this, a1);
		}
	};
}
