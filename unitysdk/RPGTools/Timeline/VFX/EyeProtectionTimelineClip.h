...
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABB2870)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABB29C0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABB29D0)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int EyeProtectionTimelineClip_TypeDefinitionIndex = 39477;
