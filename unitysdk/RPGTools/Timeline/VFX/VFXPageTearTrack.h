...
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BF36E40)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1BF36FC0)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF370B0)
