...
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F5F370)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F5F360)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5F500)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXPageTearFadeClip_TypeDefinitionIndex = 46890;
