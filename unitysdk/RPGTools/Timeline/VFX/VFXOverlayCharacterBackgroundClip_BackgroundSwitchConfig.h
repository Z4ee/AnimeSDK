...
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_BACKGROUNDSWITCHCONFIG_METHOD_1_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x19F5DE30)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_BACKGROUNDSWITCHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5E4A0)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXOverlayCharacterBackgroundClip_BackgroundSwitchConfig_TypeDefinitionIndex = 46881;
