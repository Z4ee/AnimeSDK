...
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9282B0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB928360)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB928440)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int EyeProtectionTimelineTrack_TypeDefinitionIndex = 45387;
