...
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE900490)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE900480)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_EFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0xE900430)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_HASBACKGROUNDSWITCHLIST_OFFSET UNITYSDK_OFFSET(0xE9000A0)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_ISMULTIPLEBACKGROUNDMODE_OFFSET UNITYSDK_OFFSET(0xE900470)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_ISSINGLEBACKGROUNDMODE_OFFSET UNITYSDK_OFFSET(0xE900020)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_PARENTTRACK_OFFSET UNITYSDK_OFFSET(0xE900450)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xE900030)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_SET_EFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0xE900440)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_SET_PARENTTRACK_OFFSET UNITYSDK_OFFSET(0xE900460)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE900630)
