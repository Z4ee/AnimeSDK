...
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF35A40)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF35A30)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_EFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0x1BF359E0)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_HASBACKGROUNDSWITCHLIST_OFFSET UNITYSDK_OFFSET(0x1BF35650)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_ISMULTIPLEBACKGROUNDMODE_OFFSET UNITYSDK_OFFSET(0x1BF35A20)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_ISSINGLEBACKGROUNDMODE_OFFSET UNITYSDK_OFFSET(0x1BF355D0)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_PARENTTRACK_OFFSET UNITYSDK_OFFSET(0x1BF35A00)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x1BF355E0)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_SET_EFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0x1BF359F0)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_SET_PARENTTRACK_OFFSET UNITYSDK_OFFSET(0x1BF35A10)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF35BE0)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXOverlayCharacterBackgroundClip_TypeDefinitionIndex = 49125;
	...
	public:
		...
		::System::String* TexturePathMale; // 0x60
		::System::String* TexturePathFemale; // 0x68
		::System::Collections::Generic::List_1<::RPGTools::Timeline::VFX::VFXOverlayCharacterBackgroundClip_BackgroundSwitchConfig*>* BackgroundSwitchList; // 0x70
		::UnityEngine::Vector2 BackgroundAspect; // 0x78
		::System::Single FadeInDuration; // 0x80
		::UnityEngine::AnimationCurve* FadeInCurve; // 0x88
		::System::Single FadeOutDuration; // 0x90
		::UnityEngine::AnimationCurve* FadeOutCurve; // 0x98
		::System::Boolean UseDissolve; // 0xA0
		::RPGTools::Timeline::VFX::VFXOverlayDissolveConfig* DissolveConfig; // 0xA8
		::RPGTools::Timeline::VFX::VFXOverlayCharacterBackgroundBehaviour* template_; // 0xB0
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_METHOD_4_35EA095E1AFDD9C8_OFFSET))(this);
		}
