...
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F5E190)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F5E180)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_EFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0x19F5E130)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_HASBACKGROUNDSWITCHLIST_OFFSET UNITYSDK_OFFSET(0x19F5DDD0)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_ISMULTIPLEBACKGROUNDMODE_OFFSET UNITYSDK_OFFSET(0x19F5E170)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_ISSINGLEBACKGROUNDMODE_OFFSET UNITYSDK_OFFSET(0x19F5DD50)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_GET_PARENTTRACK_OFFSET UNITYSDK_OFFSET(0x19F5E150)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x19F5DD60)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_SET_EFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0x19F5E140)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP_SET_PARENTTRACK_OFFSET UNITYSDK_OFFSET(0x19F5E160)
#define RPGTOOLS_TIMELINE_VFX_VFXOVERLAYCHARACTERBACKGROUNDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5E300)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXOverlayCharacterBackgroundClip_TypeDefinitionIndex = 46879;
