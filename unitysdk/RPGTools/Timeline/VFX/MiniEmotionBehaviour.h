...
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xABB2C00)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_0B52F2DF5119EE9C_OFFSET UNITYSDK_OFFSET(0xABB3E60)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_1F52320B28500330_OFFSET UNITYSDK_OFFSET(0xABB4690)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_26BB0ACC0529E465_OFFSET UNITYSDK_OFFSET(0xABB3DC0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_53651991BEDFF978_OFFSET UNITYSDK_OFFSET(0xABB3330)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_7A3332CA5E4D024F_OFFSET UNITYSDK_OFFSET(0xABB3F50)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0xABB3080)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_DD1EE3A48E307831_OFFSET UNITYSDK_OFFSET(0xABB2ED0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_E1A071FA52BCFDC6_OFFSET UNITYSDK_OFFSET(0xABB43C0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_E9E55F90B2DD5E38_OFFSET UNITYSDK_OFFSET(0xABB44C0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_METHOD_2_F206290BA342BA13_OFFSET UNITYSDK_OFFSET(0xABB4580)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xABB3AD0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xABB2C20)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xABB3BA0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xABB2C10)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xABB47D0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xABB47F0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xABB47E0)
#define RPGTOOLS_TIMELINE_VFX_MINIEMOTIONBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xABB4800)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int MiniEmotionBehaviour_TypeDefinitionIndex = 39460;
