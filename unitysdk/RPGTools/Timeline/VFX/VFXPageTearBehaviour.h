...
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x19F5E8D0)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR_METHOD_2_CBB16AE705BCA424_OFFSET UNITYSDK_OFFSET(0x19F5EC50)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x19F5ECD0)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19F5E8F0)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19F5EA70)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x19F5E8E0)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5ED50)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXPageTearBehaviour_TypeDefinitionIndex = 46887;
