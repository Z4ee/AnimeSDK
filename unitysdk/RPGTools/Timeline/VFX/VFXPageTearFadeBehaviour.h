...
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x19F5EF10)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR_METHOD_2_CBB16AE705BCA424_OFFSET UNITYSDK_OFFSET(0x19F5F240)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x19F5F2C0)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19F5EF30)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19F5F060)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x19F5EF20)
#define RPGTOOLS_TIMELINE_VFX_VFXPAGETEARFADEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5F350)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXPageTearFadeBehaviour_TypeDefinitionIndex = 46891;
