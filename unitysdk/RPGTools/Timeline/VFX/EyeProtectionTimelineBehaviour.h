...
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xD067070)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0xD067000)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_6FB03FD62E1385C7_OFFSET UNITYSDK_OFFSET(0xD066DB0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD066D20)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xD067950)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_CADFED087C30D5D0_OFFSET UNITYSDK_OFFSET(0xD0673D0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_METHOD_3_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0xD0671C0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD066E20)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD066BF0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD066ED0)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD067900)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD067930)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD067920)
#define RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD067940)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int EyeProtectionTimelineBehaviour_TypeDefinitionIndex = 45968;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_OnBehaviourPause(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_ProcessFrame(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2, ::System::Object* a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData, ::System::Object*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_VFX_EYEPROTECTIONTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET))(this, a1, a2, a3);
		}
