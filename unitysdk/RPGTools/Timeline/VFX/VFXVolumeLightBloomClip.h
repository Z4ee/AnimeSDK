...
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F60980)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F60970)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F60B10)

namespace RPGTools::Timeline::VFX
{
	inline static constexpr unsigned int VFXVolumeLightBloomClip_TypeDefinitionIndex = 46901;
