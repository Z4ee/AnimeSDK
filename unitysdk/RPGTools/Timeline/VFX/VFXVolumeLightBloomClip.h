...
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF382B0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF382A0)
#define RPGTOOLS_TIMELINE_VFX_VFXVOLUMELIGHTBLOOMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF38440)
