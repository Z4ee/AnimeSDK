...
#define RPGTOOLS_TIMELINE_VFXTEARTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF3A6A0)
#define RPGTOOLS_TIMELINE_VFXTEARTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BF3A550)
#define RPGTOOLS_TIMELINE_VFXTEARTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1BF3A7D0)
#define RPGTOOLS_TIMELINE_VFXTEARTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF3A840)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VFXTearTrack_TypeDefinitionIndex = 48544;
