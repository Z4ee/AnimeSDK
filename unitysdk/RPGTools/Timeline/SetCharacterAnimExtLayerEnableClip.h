...
#define RPGTOOLS_TIMELINE_SETCHARACTERANIMEXTLAYERENABLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0BFA60)
#define RPGTOOLS_TIMELINE_SETCHARACTERANIMEXTLAYERENABLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0BFA50)
#define RPGTOOLS_TIMELINE_SETCHARACTERANIMEXTLAYERENABLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BFBF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SetCharacterAnimExtLayerEnableClip_TypeDefinitionIndex = 48393;
