...
#define RPGTOOLS_TIMELINE_SETCHARACTERANIMEXTLAYERENABLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB9CE30)
#define RPGTOOLS_TIMELINE_SETCHARACTERANIMEXTLAYERENABLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB9CE20)
#define RPGTOOLS_TIMELINE_SETCHARACTERANIMEXTLAYERENABLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9D020)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SetCharacterAnimExtLayerEnableClip_TypeDefinitionIndex = 38789;
