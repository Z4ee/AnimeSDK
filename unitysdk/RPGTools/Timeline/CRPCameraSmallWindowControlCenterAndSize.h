...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWCONTROLCENTERANDSIZE_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0xB8A14E0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWCONTROLCENTERANDSIZE_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0xB8A16F0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWCONTROLCENTERANDSIZE_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB8A0C90)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWCONTROLCENTERANDSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A1CD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowControlCenterAndSize_TypeDefinitionIndex = 44652;
