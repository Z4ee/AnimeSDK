...
#define RPGTOOLS_TIMELINE_SETSTORYDANMUENABLEBEHAVIOUR_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x199B4030)
#define RPGTOOLS_TIMELINE_SETSTORYDANMUENABLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x199B4050)
#define RPGTOOLS_TIMELINE_SETSTORYDANMUENABLEBEHAVIOUR_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x199B4040)
#define RPGTOOLS_TIMELINE_SETSTORYDANMUENABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x199B4100)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SetStoryDanmuEnableBehaviour_TypeDefinitionIndex = 46291;
