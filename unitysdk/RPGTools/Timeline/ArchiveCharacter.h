...
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x1B342B80)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_GET_ISPLAYER_OFFSET UNITYSDK_OFFSET(0x1B342B10)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_METHOD_4_784C221F8D8DF4FC_OFFSET UNITYSDK_OFFSET(0x1B342BA0)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0x1B342B90)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B342C70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveCharacter_TypeDefinitionIndex = 46711;
