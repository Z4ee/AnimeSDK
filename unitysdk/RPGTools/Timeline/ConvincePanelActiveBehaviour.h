...
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1D14AC20)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D14AC40)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1D14AC30)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14AE50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvincePanelActiveBehaviour_TypeDefinitionIndex = 48508;
