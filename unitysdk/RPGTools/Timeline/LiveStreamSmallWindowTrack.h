...
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A69470)
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19A695F0)
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A69660)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSmallWindowTrack_TypeDefinitionIndex = 46402;
