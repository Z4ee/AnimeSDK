...
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A3CF30)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A3CD80)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19A3D070)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3D0E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoAnimLayerEmotionFullTrack_TypeDefinitionIndex = 46318;
