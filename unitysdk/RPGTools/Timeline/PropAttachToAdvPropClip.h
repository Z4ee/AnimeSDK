...
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB909330)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB909320)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB909520)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropAttachToAdvPropClip_TypeDefinitionIndex = 44980;
