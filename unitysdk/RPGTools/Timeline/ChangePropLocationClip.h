...
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFE9D10)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFE9D00)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE9EB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ChangePropLocationClip_TypeDefinitionIndex = 45218;
