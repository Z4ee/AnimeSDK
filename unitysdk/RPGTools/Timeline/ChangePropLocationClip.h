...
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8A5FA0)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8A5F90)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A61A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ChangePropLocationClip_TypeDefinitionIndex = 44671;
