...
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8261A0)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE826190)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE826340)
