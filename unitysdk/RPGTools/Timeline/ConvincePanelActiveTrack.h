...
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE8385B0)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xE838730)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE8387A0)
