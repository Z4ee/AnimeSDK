...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFFCED0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFFCEC0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFD060)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineChangeClip_TypeDefinitionIndex = 45353;
