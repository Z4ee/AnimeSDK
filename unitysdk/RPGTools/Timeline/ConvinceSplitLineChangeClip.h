...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B9B10)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8B9B00)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B9D00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineChangeClip_TypeDefinitionIndex = 44806;
