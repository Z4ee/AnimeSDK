...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A34DD0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A34DC0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A34F60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineChangeClip_TypeDefinitionIndex = 46277;
