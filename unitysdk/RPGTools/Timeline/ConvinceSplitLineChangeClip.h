...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D14B800)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D14B7F0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECHANGECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14B990)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineChangeClip_TypeDefinitionIndex = 48511;
