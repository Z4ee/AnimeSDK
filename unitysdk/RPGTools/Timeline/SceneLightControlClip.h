...
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0BE300)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0BE470)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x1B0BE2B0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BE480)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SceneLightControlClip_TypeDefinitionIndex = 48621;
