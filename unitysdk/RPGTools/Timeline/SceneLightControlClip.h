...
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB9B6F0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB9B8C0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xAB9B6A0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9B8D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SceneLightControlClip_TypeDefinitionIndex = 39001;
