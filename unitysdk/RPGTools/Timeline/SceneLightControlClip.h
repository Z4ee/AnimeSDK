...
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B1E30)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199B1FA0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x199B1DE0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199B1FB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SceneLightControlClip_TypeDefinitionIndex = 46386;
