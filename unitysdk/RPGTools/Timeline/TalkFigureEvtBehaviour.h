...
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_41E028BA4D0D3010_OFFSET UNITYSDK_OFFSET(0xB921150)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB921300)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_C6159FCF4A6D407A_OFFSET UNITYSDK_OFFSET(0xB9210E0)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB9212F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkFigureEvtBehaviour_TypeDefinitionIndex = 45108;
