...
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_41E028BA4D0D3010_OFFSET UNITYSDK_OFFSET(0xABABA90)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xABABC40)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_C6159FCF4A6D407A_OFFSET UNITYSDK_OFFSET(0xABABA20)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xABABC30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkFigureEvtBehaviour_TypeDefinitionIndex = 39199;
