...
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKBEHAVIOUR_METHOD_3_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0x1D140240)
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKBEHAVIOUR_METHOD_3_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1D140490)
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1405A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSetSkirtIKBehaviour_TypeDefinitionIndex = 48443;
