...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERTRACK_CREATELAYERMIXER_OFFSET UNITYSDK_OFFSET(0x199923A0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199924A0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x199922D0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19992740)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERTRACK_UNITYENGINE_TIMELINE_ILAYERABLE_SHOWDEFAULTLAYEREDTRACKCOMMANDS_OFFSET UNITYSDK_OFFSET(0x19992460)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19992B60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferTrack_TypeDefinitionIndex = 46442;
