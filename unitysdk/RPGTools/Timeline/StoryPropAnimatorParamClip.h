...
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F4D360)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F4D350)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4D4F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropAnimatorParamClip_TypeDefinitionIndex = 46459;
