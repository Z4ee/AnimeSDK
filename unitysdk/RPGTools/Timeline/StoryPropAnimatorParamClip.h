...
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD05C590)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD05C580)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD05C6F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropAnimatorParamClip_TypeDefinitionIndex = 45525;
