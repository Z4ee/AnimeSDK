...
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABA6C50)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABA6C40)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABA6E10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropAnimatorParamClip_TypeDefinitionIndex = 39074;
