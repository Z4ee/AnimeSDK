...
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8EF300)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE8EF2F0)
#define RPGTOOLS_TIMELINE_STORYPROPANIMATORPARAMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8EF460)
