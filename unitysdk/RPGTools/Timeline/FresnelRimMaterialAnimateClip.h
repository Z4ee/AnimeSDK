...
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B58CDD0)
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B58CF40)
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B58CF50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FresnelRimMaterialAnimateClip_TypeDefinitionIndex = 48532;
