...
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A5A630)
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A5A7A0)
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A5A7B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FresnelRimMaterialAnimateClip_TypeDefinitionIndex = 46298;
