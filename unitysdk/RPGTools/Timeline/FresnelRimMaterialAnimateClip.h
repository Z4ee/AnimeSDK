...
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD020BF0)
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD020D60)
#define RPGTOOLS_TIMELINE_FRESNELRIMMATERIALANIMATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD020D70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FresnelRimMaterialAnimateClip_TypeDefinitionIndex = 45369;
