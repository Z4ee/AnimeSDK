...
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_0039B43FD4E0E048_OFFSET UNITYSDK_OFFSET(0xB89E110)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_0E36A5F5CC6CF609_OFFSET UNITYSDK_OFFSET(0xB89DDA0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB89DD20)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_33796CF18653C823_OFFSET UNITYSDK_OFFSET(0xB89DE90)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_B6B434482276FBDF_OFFSET UNITYSDK_OFFSET(0xB89E200)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB89E040)
#define RPGTOOLS_TIMELINE_BLUSHERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB89DE80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BlusherData_TypeDefinitionIndex = 44859;
