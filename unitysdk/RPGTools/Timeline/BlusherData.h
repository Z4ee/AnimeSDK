...
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_0039B43FD4E0E048_OFFSET UNITYSDK_OFFSET(0xCFE20F0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xCFE1CD0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_33796CF18653C823_OFFSET UNITYSDK_OFFSET(0xCFE1E70)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_66C16B4A540CB1F6_OFFSET UNITYSDK_OFFSET(0xCFE21E0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCFE2020)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_E60BEBC26BA58440_OFFSET UNITYSDK_OFFSET(0xCFE1D50)
#define RPGTOOLS_TIMELINE_BLUSHERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE1E60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BlusherData_TypeDefinitionIndex = 45416;
