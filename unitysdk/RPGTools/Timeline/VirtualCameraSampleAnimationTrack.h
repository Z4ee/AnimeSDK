...
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F643A0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19F644F0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19F645F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VirtualCameraSampleAnimationTrack_TypeDefinitionIndex = 46069;
