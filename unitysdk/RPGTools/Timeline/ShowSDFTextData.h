...
#define RPGTOOLS_TIMELINE_SHOWSDFTEXTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD04B360)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ShowSDFTextData_TypeDefinitionIndex = 45540;
