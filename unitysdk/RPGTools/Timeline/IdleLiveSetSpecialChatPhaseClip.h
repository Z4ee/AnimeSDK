...
#define RPGTOOLS_TIMELINE_IDLELIVESETSPECIALCHATPHASECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A61A50)
#define RPGTOOLS_TIMELINE_IDLELIVESETSPECIALCHATPHASECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A61B40)
#define RPGTOOLS_TIMELINE_IDLELIVESETSPECIALCHATPHASECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A61B50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int IdleLiveSetSpecialChatPhaseClip_TypeDefinitionIndex = 46029;
