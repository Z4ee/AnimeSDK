...
#define RPGTOOLS_TIMELINE_IDLELIVESETSPECIALCHATPHASECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8E3930)
#define RPGTOOLS_TIMELINE_IDLELIVESETSPECIALCHATPHASECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8E3A80)
#define RPGTOOLS_TIMELINE_IDLELIVESETSPECIALCHATPHASECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E3A90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int IdleLiveSetSpecialChatPhaseClip_TypeDefinitionIndex = 44564;
