...
#define RPGTOOLS_TIMELINE_STORYCHARACTERVISIBLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABA26D0)
#define RPGTOOLS_TIMELINE_STORYCHARACTERVISIBLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABA26C0)
#define RPGTOOLS_TIMELINE_STORYCHARACTERVISIBLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABA2890)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryCharacterVisibleClip_TypeDefinitionIndex = 39147;
