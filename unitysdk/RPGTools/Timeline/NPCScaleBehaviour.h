...
#define RPGTOOLS_TIMELINE_NPCSCALEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB7B310)
#define RPGTOOLS_TIMELINE_NPCSCALEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB7B330)
#define RPGTOOLS_TIMELINE_NPCSCALEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB7B320)
#define RPGTOOLS_TIMELINE_NPCSCALEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7B490)
#define RPGTOOLS_TIMELINE_NPCSCALEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB7B4A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCScaleBehaviour_TypeDefinitionIndex = 39048;
