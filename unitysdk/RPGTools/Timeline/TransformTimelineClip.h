...
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD064E90)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD064E80)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD064F80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransformTimelineClip_TypeDefinitionIndex = 45792;
