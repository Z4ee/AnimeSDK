...
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F55670)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F55660)
#define RPGTOOLS_TIMELINE_TRANSFORMTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F55760)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransformTimelineClip_TypeDefinitionIndex = 46731;
