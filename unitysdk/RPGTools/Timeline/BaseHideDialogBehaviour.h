...
#define RPGTOOLS_TIMELINE_BASEHIDEDIALOGBEHAVIOUR_GET_CLOSENOTIFYTYPE_OFFSET UNITYSDK_OFFSET(0xE817830)
#define RPGTOOLS_TIMELINE_BASEHIDEDIALOGBEHAVIOUR_GET_UINAME_OFFSET UNITYSDK_OFFSET(0xE817810)
#define RPGTOOLS_TIMELINE_BASEHIDEDIALOGBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE817850)
#define RPGTOOLS_TIMELINE_BASEHIDEDIALOGBEHAVIOUR_SET_CLOSENOTIFYTYPE_OFFSET UNITYSDK_OFFSET(0xE817840)
#define RPGTOOLS_TIMELINE_BASEHIDEDIALOGBEHAVIOUR_SET_UINAME_OFFSET UNITYSDK_OFFSET(0xE817820)
#define RPGTOOLS_TIMELINE_BASEHIDEDIALOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE8178E0)
