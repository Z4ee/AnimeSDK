...
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB909540)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xB909680)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB9096F0)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB909700)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xB909740)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropAttachToAdvPropTrack_TypeDefinitionIndex = 44982;
