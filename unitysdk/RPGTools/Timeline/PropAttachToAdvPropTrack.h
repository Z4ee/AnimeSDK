...
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199AAF80)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x199AB0C0)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199AB130)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropAttachToAdvPropTrack_TypeDefinitionIndex = 46464;
