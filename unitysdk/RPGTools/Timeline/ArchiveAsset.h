...
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_GET_BASETARGET_OFFSET UNITYSDK_OFFSET(0x1B531280)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_METHOD_3_EE73EC1D0D6BA806_OFFSET UNITYSDK_OFFSET(0x1B5312A0)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_SET_BASETARGET_OFFSET UNITYSDK_OFFSET(0x1B531290)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B531320)
