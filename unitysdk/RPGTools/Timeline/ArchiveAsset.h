...
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_GET_BASETARGET_OFFSET UNITYSDK_OFFSET(0xAB20400)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_METHOD_3_EE73EC1D0D6BA806_OFFSET UNITYSDK_OFFSET(0xAB20420)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_SET_BASETARGET_OFFSET UNITYSDK_OFFSET(0xAB20410)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xAB204A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveAsset_TypeDefinitionIndex = 39309;
