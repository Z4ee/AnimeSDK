...
#define RPGTOOLS_TIMELINE_SHIFTCAMERALOOKATTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8E2CF0)
#define RPGTOOLS_TIMELINE_SHIFTCAMERALOOKATTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE8E2DA0)
#define RPGTOOLS_TIMELINE_SHIFTCAMERALOOKATTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E2EF0)
