...
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F56160)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19F56280)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19F56350)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransitEnvProfileTrack_TypeDefinitionIndex = 46624;
