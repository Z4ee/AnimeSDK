...
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF2D700)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BF2D820)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF2D8F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransitEnvProfileTrack_TypeDefinitionIndex = 48869;
