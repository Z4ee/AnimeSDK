...
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1B342E80)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1B342EA0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_METHOD_2_57463EAF62638A1C_OFFSET UNITYSDK_OFFSET(0x1B342F60)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B342EC0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1B342E90)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1B342EB0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B343040)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AtlasFaceEmotionBehaviour_TypeDefinitionIndex = 46255;
