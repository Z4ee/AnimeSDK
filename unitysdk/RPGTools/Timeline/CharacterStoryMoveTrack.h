...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D145EA0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D1460A0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1462F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveTrack_TypeDefinitionIndex = 48478;
