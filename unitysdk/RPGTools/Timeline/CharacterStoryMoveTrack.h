...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B35F5F0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B35F7F0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35FA40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveTrack_TypeDefinitionIndex = 46244;
