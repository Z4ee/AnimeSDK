...
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A5EAA0)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A5EA90)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A5EC30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HidePropForStoryClip_TypeDefinitionIndex = 46366;
