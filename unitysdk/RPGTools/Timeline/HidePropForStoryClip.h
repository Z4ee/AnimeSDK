...
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6C830)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB6C820)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6CA20)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HidePropForStoryClip_TypeDefinitionIndex = 38972;
