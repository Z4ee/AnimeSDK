...
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE862D80)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE862D70)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE862F10)
