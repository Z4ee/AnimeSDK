...
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9165E0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB9165D0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9167A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SpecialVisionOffClip_TypeDefinitionIndex = 45044;
