...
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABA1040)
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABA1030)
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABA1200)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SpecialVisionOffClip_TypeDefinitionIndex = 39135;
