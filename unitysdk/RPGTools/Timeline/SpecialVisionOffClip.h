...
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B79D0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199B79C0)
#define RPGTOOLS_TIMELINE_SPECIALVISIONOFFCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199B7B60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SpecialVisionOffClip_TypeDefinitionIndex = 46526;
