...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB3C730)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB3C8F0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB3C900)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveClip_TypeDefinitionIndex = 38851;
