...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF42A0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF4400)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF4410)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveClip_TypeDefinitionIndex = 45301;
