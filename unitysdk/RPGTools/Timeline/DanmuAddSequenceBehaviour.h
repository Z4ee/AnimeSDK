...
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR_GET_GROUPIDSET_OFFSET UNITYSDK_OFFSET(0x1D14CBC0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D14CBF0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR_SET_GROUPIDSET_OFFSET UNITYSDK_OFFSET(0x1D14CBE0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14CCD0)
