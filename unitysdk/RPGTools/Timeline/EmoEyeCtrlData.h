...
#define RPGTOOLS_TIMELINE_EMOEYECTRLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B570D70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeCtrlData_TypeDefinitionIndex = 48571;
