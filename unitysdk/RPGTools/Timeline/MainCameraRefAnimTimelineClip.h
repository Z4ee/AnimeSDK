...
#define RPGTOOLS_TIMELINE_MAINCAMERAREFANIMTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD02D220)
#define RPGTOOLS_TIMELINE_MAINCAMERAREFANIMTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD02D200)
#define RPGTOOLS_TIMELINE_MAINCAMERAREFANIMTIMELINECLIP_SET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD02D210)
#define RPGTOOLS_TIMELINE_MAINCAMERAREFANIMTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD02D3B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MainCameraRefAnimTimelineClip_TypeDefinitionIndex = 45716;
