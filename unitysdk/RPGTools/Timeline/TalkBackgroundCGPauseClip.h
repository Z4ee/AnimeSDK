...
#define RPGTOOLS_TIMELINE_TALKBACKGROUNDCGPAUSECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF28220)
#define RPGTOOLS_TIMELINE_TALKBACKGROUNDCGPAUSECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF28210)
#define RPGTOOLS_TIMELINE_TALKBACKGROUNDCGPAUSECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF283B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBackgroundCGPauseClip_TypeDefinitionIndex = 48829;
