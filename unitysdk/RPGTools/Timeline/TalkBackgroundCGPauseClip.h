...
#define RPGTOOLS_TIMELINE_TALKBACKGROUNDCGPAUSECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABAA730)
#define RPGTOOLS_TIMELINE_TALKBACKGROUNDCGPAUSECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABAA720)
#define RPGTOOLS_TIMELINE_TALKBACKGROUNDCGPAUSECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABAA920)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBackgroundCGPauseClip_TypeDefinitionIndex = 39189;
