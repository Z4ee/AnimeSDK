...
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0308D0)
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD030A60)
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD030A70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MoveVirtualCameraOnDollyPathClip_TypeDefinitionIndex = 45136;
