...
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1998CB90)
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1998CCF0)
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1998CD00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MoveVirtualCameraOnDollyPathClip_TypeDefinitionIndex = 46054;
