...
#define RPGTOOLS_TIMELINE_CLOCKBOYMOUTHTALKTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B74A0)
#define RPGTOOLS_TIMELINE_CLOCKBOYMOUTHTALKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B75E0)
#define RPGTOOLS_TIMELINE_CLOCKBOYMOUTHTALKTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B76C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ClockBoyMouthTalkTrack_TypeDefinitionIndex = 44791;
