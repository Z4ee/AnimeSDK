...
#define RPGTOOLS_TIMELINE_CLOCKBOYMOUTHTALKTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB42740)
#define RPGTOOLS_TIMELINE_CLOCKBOYMOUTHTALKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB42880)
#define RPGTOOLS_TIMELINE_CLOCKBOYMOUTHTALKTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB42960)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ClockBoyMouthTalkTrack_TypeDefinitionIndex = 38888;
