...
#define RPGTOOLS_TIMELINE_CRPCAMERA1TRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B34B720)
#define RPGTOOLS_TIMELINE_CRPCAMERA1TRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B34B8A0)
#define RPGTOOLS_TIMELINE_CRPCAMERA1TRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34B970)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCamera1Track_TypeDefinitionIndex = 46106;
