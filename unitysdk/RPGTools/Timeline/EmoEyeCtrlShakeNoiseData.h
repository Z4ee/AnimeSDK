...
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA_METHOD_1_9E9BA2E1C4AD5533_OFFSET UNITYSDK_OFFSET(0xD007680)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD007320)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA_METHOD_1_EADB2ABA0DC53DB5_OFFSET UNITYSDK_OFFSET(0xD007010)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0077F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeCtrlShakeNoiseData_TypeDefinitionIndex = 45403;
