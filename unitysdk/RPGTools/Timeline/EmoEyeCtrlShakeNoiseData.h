...
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA_METHOD_1_9E9BA2E1C4AD5533_OFFSET UNITYSDK_OFFSET(0x19A3FDC0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19A3FA60)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA_METHOD_1_EADB2ABA0DC53DB5_OFFSET UNITYSDK_OFFSET(0x19A3F750)
#define RPGTOOLS_TIMELINE_EMOEYECTRLSHAKENOISEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3FF30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeCtrlShakeNoiseData_TypeDefinitionIndex = 46332;
