...
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB74F00)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB750B0)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB75120)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB75200)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB752A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamBulletCommentsTrack_TypeDefinitionIndex = 39013;
