...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD025E30)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD025FD0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD025FE0)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenMiniAnimClip_TypeDefinitionIndex = 45921;
