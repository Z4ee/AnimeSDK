...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6F380)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB6F580)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6F590)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenMiniAnimClip_TypeDefinitionIndex = 39455;
