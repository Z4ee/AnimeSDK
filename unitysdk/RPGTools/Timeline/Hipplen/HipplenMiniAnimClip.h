...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8654F0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE865690)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8656A0)
