...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0xB8E30D0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_E05261A829A32D91_OFFSET UNITYSDK_OFFSET(0xB8E2F50)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB8E2E50)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E31D0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB8E31E0)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenMiniAnimBehaviour_TypeDefinitionIndex = 45363;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, P0, P1);
		}
	};
}
