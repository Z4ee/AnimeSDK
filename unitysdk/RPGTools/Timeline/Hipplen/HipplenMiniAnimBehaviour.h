...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0xAB6F260)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_E05261A829A32D91_OFFSET UNITYSDK_OFFSET(0xAB6F0E0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6EFE0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6F360)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6F370)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenMiniAnimBehaviour_TypeDefinitionIndex = 39454;
