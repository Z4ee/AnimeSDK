...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x1B593FB0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_E05261A829A32D91_OFFSET UNITYSDK_OFFSET(0x1B593E30)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B593D30)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5940B0)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenMiniAnimBehaviour_TypeDefinitionIndex = 49105;
