...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0xD025D10)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_METHOD_2_E05261A829A32D91_OFFSET UNITYSDK_OFFSET(0xD025B90)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD025A90)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD025E10)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD025E20)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenMiniAnimBehaviour_TypeDefinitionIndex = 45920;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENMINIANIMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, a1, a2);
		}
	};
}
