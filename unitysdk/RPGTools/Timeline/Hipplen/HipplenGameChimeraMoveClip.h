...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8E2A30)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8E2C20)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E2C30)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenGameChimeraMoveClip_TypeDefinitionIndex = 45361;
