...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0256C0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD025850)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD025860)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenGameChimeraMoveClip_TypeDefinitionIndex = 45918;
