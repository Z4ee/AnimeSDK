...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6EBC0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB6EDB0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6EDC0)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenGameChimeraMoveClip_TypeDefinitionIndex = 39452;
