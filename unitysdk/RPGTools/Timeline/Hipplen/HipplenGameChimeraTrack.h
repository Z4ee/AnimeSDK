...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERATRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6EE00)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERATRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6EF90)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERATRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6EFA0)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenGameChimeraTrack_TypeDefinitionIndex = 39453;
