...
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVEBEHAVIOUR_METHOD_2_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0xAB6E890)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6E640)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVEBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xAB6EA90)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6EB90)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6EBA0)
#define RPGTOOLS_TIMELINE_HIPPLEN_HIPPLENGAMECHIMERAMOVEBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xAB6EBB0)

namespace RPGTools::Timeline::Hipplen
{
	inline static constexpr unsigned int HipplenGameChimeraMoveBehaviour_TypeDefinitionIndex = 39451;
