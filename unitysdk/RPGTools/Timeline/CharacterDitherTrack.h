...
#define RPGTOOLS_TIMELINE_CHARACTERDITHERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D13C2A0)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D13C3A0)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13C410)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDitherTrack_TypeDefinitionIndex = 48407;
