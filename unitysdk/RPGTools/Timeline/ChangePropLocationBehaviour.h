...
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONBEHAVIOUR_GET_TRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B352910)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B352930)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONBEHAVIOUR_SET_TRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B352920)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B352A60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ChangePropLocationBehaviour_TypeDefinitionIndex = 46143;
