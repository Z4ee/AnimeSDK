...
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB7E230)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB7E220)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xAB7E210)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7E350)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PauseMarkerClip_TypeDefinitionIndex = 39061;
