...
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199906C0)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199906B0)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x199906A0)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19990790)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PauseMarkerClip_TypeDefinitionIndex = 46446;
