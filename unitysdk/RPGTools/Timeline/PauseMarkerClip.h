...
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8F28C0)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8F28B0)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xB8F28A0)
#define RPGTOOLS_TIMELINE_PAUSEMARKERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F29E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PauseMarkerClip_TypeDefinitionIndex = 44964;
