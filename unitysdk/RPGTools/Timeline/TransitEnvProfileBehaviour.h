...
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR_METHOD_3_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0x19F558E0)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR_METHOD_3_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x19F55890)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F55F90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransitEnvProfileBehaviour_TypeDefinitionIndex = 46622;
