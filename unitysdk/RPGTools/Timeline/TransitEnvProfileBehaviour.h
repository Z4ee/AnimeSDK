...
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR_METHOD_3_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0xB925720)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB925BA0)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR_METHOD_3_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0xB9256D0)
#define RPGTOOLS_TIMELINE_TRANSITENVPROFILEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB925B90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TransitEnvProfileBehaviour_TypeDefinitionIndex = 45136;
