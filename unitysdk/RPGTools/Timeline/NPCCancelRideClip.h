...
#define RPGTOOLS_TIMELINE_NPCCANCELRIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8EEF90)
#define RPGTOOLS_TIMELINE_NPCCANCELRIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8EEF80)
#define RPGTOOLS_TIMELINE_NPCCANCELRIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8EF150)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCCancelRideClip_TypeDefinitionIndex = 44944;
