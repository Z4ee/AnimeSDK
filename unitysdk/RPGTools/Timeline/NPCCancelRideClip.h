...
#define RPGTOOLS_TIMELINE_NPCCANCELRIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B5A0C50)
#define RPGTOOLS_TIMELINE_NPCCANCELRIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B5A0C40)
#define RPGTOOLS_TIMELINE_NPCCANCELRIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A0DE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCCancelRideClip_TypeDefinitionIndex = 48661;
