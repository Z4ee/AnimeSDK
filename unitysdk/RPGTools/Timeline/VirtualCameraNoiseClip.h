...
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0726E0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD0726D0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_GET_VIRTUALCAMERANOISECONFIGS_OFFSET UNITYSDK_OFFSET(0xD072620)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD0725E0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xD072650)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xD072690)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD0725A0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD072840)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VirtualCameraNoiseClip_TypeDefinitionIndex = 45144;
