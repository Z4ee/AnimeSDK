...
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF3AC50)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF3AC40)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_GET_VIRTUALCAMERANOISECONFIGS_OFFSET UNITYSDK_OFFSET(0x1BF3AB90)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1BF3AB50)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1BF3ABC0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x1BF3AC00)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1BF3AB10)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF3ADE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VirtualCameraNoiseClip_TypeDefinitionIndex = 48286;
