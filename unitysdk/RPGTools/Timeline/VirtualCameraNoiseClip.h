...
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABB8A20)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABB8A10)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_GET_VIRTUALCAMERANOISECONFIGS_OFFSET UNITYSDK_OFFSET(0xABB8960)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xABB8920)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xABB8990)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xABB89D0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xABB88E0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERANOISECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABB8BE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VirtualCameraNoiseClip_TypeDefinitionIndex = 38698;
