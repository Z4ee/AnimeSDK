...
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B5A03D0)
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B5A0680)
#define RPGTOOLS_TIMELINE_MOVEVIRTUALCAMERAONDOLLYPATHBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A07D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MoveVirtualCameraOnDollyPathBehaviour_TypeDefinitionIndex = 48277;
