...
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_METHOD_2_6D71CC7A9DF62322_OFFSET UNITYSDK_OFFSET(0xAB67410)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_METHOD_2_FFBC3E5986CAC663_OFFSET UNITYSDK_OFFSET(0xAB67600)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB67360)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB67820)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB67830)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EventTimelineBehaviour_TypeDefinitionIndex = 39239;
