...
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB3AC40)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB3AE40)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAB3AE50)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xAB3AED0)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB3AF30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStopBodyControlClip_TypeDefinitionIndex = 38799;
