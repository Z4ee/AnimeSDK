...
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF2A00)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF2B90)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xCFF2BA0)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xCFF2C20)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF2C80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStopBodyControlClip_TypeDefinitionIndex = 45245;
