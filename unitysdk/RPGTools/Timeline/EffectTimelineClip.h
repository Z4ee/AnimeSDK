...
#define RPGTOOLS_TIMELINE_EFFECTTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B56E970)
#define RPGTOOLS_TIMELINE_EFFECTTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B56E900)
#define RPGTOOLS_TIMELINE_EFFECTTIMELINECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1B56E910)
#define RPGTOOLS_TIMELINE_EFFECTTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56EB10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EffectTimelineClip_TypeDefinitionIndex = 48877;
