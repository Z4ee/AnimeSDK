...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B34FD00)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B34FD20)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B34FD10)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34FFA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowTemplateBehaviour_TypeDefinitionIndex = 46130;
