...
#define RPGTOOLS_TIMELINE_SHOWUIBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xABA05D0)
#define RPGTOOLS_TIMELINE_SHOWUIBEHAVIOUR_METHOD_3_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0xABA0550)
#define RPGTOOLS_TIMELINE_SHOWUIBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xABA05C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ShowUIBehaviour_TypeDefinitionIndex = 39222;
