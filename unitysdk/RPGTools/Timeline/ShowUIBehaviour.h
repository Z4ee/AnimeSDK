...
#define RPGTOOLS_TIMELINE_SHOWUIBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB915240)
#define RPGTOOLS_TIMELINE_SHOWUIBEHAVIOUR_METHOD_3_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0xB9151C0)
#define RPGTOOLS_TIMELINE_SHOWUIBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB915230)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ShowUIBehaviour_TypeDefinitionIndex = 45131;
