...
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B340F70)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B3410C0)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3410D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorEnableControlClip_TypeDefinitionIndex = 46423;
