...
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB1ECC0)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB1EE70)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB1EE80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorEnableControlClip_TypeDefinitionIndex = 39038;
