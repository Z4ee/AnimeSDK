...
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB892A40)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB892BF0)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB892C00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorEnableControlClip_TypeDefinitionIndex = 44941;
