...
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD051F90)
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD051F80)
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD052120)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SetAudienceGroupVisibleClip_TypeDefinitionIndex = 45563;
