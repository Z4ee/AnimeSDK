...
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B2D70)
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199B2D60)
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199B2F00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SetAudienceGroupVisibleClip_TypeDefinitionIndex = 46497;
