...
#define RPGTOOLS_TIMELINE_DESTROYEMOJIBUBBLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFFF780)
#define RPGTOOLS_TIMELINE_DESTROYEMOJIBUBBLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFFF770)
#define RPGTOOLS_TIMELINE_DESTROYEMOJIBUBBLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFF910)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int DestroyEmojiBubbleClip_TypeDefinitionIndex = 45391;
