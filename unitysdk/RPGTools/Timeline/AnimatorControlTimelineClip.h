...
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB892380)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB892360)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xB892370)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8925A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorControlTimelineClip_TypeDefinitionIndex = 44570;
