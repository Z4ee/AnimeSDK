...
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B340940)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B340920)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1B340930)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B340B00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorControlTimelineClip_TypeDefinitionIndex = 46035;
