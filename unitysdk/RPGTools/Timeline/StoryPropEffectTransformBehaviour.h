...
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B0CD820)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B0CD840)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B0CD830)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CD970)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropEffectTransformBehaviour_TypeDefinitionIndex = 48810;
