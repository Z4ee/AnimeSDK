...
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_GET_DESTROYONCLIPEND_OFFSET UNITYSDK_OFFSET(0x1B351A90)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1B351A70)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x1B351C90)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_70C856AE64234BE0_OFFSET UNITYSDK_OFFSET(0x1B351E90)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_C86CA48475AE1200_OFFSET UNITYSDK_OFFSET(0x1B352050)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_D240830C442C70A4_OFFSET UNITYSDK_OFFSET(0x1B351F90)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_E4EC0FD7A76783C9_OFFSET UNITYSDK_OFFSET(0x1B351C10)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B351EF0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B351AB0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_SET_DESTROYONCLIPEND_OFFSET UNITYSDK_OFFSET(0x1B351AA0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1B351A80)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3521F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CameraShakeBehaviour_TypeDefinitionIndex = 46043;
