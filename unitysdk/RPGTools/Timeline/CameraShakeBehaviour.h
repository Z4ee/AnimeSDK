...
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_GET_DESTROYONCLIPEND_OFFSET UNITYSDK_OFFSET(0x1D137BC0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1D137BA0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x1D137DC0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_70C856AE64234BE0_OFFSET UNITYSDK_OFFSET(0x1D137FC0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_C86CA48475AE1200_OFFSET UNITYSDK_OFFSET(0x1D138180)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_D240830C442C70A4_OFFSET UNITYSDK_OFFSET(0x1D1380C0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_METHOD_2_E4EC0FD7A76783C9_OFFSET UNITYSDK_OFFSET(0x1D137D40)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1D138020)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D137BE0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_SET_DESTROYONCLIPEND_OFFSET UNITYSDK_OFFSET(0x1D137BD0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1D137BB0)
#define RPGTOOLS_TIMELINE_CAMERASHAKEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D138320)
