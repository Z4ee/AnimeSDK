...
#define RPGTOOLS_TIMELINE_MESHSHOWHIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1998AB30)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1998ACC0)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1998ACD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MeshShowHideClip_TypeDefinitionIndex = 46411;
