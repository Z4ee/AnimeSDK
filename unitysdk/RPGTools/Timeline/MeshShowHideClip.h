...
#define RPGTOOLS_TIMELINE_MESHSHOWHIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB77DA0)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB77FA0)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB77FB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MeshShowHideClip_TypeDefinitionIndex = 39026;
