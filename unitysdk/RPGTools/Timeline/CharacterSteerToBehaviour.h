...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_GET_EDITORFINALROTATION_OFFSET UNITYSDK_OFFSET(0xE82E120)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_METHOD_2_050D955490C4C3D0_OFFSET UNITYSDK_OFFSET(0xE82E180)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xE82E600)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE82E570)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xE82E680)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xE82E6D0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE82E720)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE82E860)
