...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D12DC10)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D12DD80)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x1D12DB40)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D12DB50)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D12DE80)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterHeadLookAtTrack_TypeDefinitionIndex = 49264;
