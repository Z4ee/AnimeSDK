...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B349410)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B349400)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B349570)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPTalkClip_TypeDefinitionIndex = 47016;
