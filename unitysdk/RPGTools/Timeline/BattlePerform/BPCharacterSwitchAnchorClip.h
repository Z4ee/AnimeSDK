...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB27A80)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB27A70)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB27C40)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterSwitchAnchorClip_TypeDefinitionIndex = 39581;
