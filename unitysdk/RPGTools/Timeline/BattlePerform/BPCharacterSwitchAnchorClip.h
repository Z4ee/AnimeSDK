...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB89B8A0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB89B890)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB89BA60)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterSwitchAnchorClip_TypeDefinitionIndex = 45490;
