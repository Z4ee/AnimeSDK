...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B3489B0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B3489D0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B3489C0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B348D90)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterSwitchAnchorBehaviour_TypeDefinitionIndex = 47013;
