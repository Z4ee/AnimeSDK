...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB289F0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK_METHOD_5_C441C887BCDF806F_OFFSET UNITYSDK_OFFSET(0xAB28C00)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB28EB0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB28F90)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPTalkTrack_TypeDefinitionIndex = 39591;
