...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B346FA0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B346F90)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_GET_END_OFFSET UNITYSDK_OFFSET(0x1B346F70)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_GET_START_OFFSET UNITYSDK_OFFSET(0x1B346F50)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_SET_END_OFFSET UNITYSDK_OFFSET(0x1B346F80)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_SET_START_OFFSET UNITYSDK_OFFSET(0x1B346F60)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B347110)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCameraClip_TypeDefinitionIndex = 46998;
