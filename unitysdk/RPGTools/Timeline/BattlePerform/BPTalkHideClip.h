...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFE04A0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFE0490)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE0580)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPTalkHideClip_TypeDefinitionIndex = 46079;
