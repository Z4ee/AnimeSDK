...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB28540)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB28530)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB28650)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPTalkHideClip_TypeDefinitionIndex = 39587;
