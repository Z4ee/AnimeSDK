...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB89C360)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB89C350)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKHIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB89C4B0)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPTalkHideClip_TypeDefinitionIndex = 45496;
