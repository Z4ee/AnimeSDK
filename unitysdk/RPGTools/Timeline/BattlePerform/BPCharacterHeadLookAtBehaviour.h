...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1D12D3D0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATBEHAVIOUR_METHOD_2_927E8B22CB9C2007_OFFSET UNITYSDK_OFFSET(0x1D12D690)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D12D3F0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1D12D3E0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D12D8A0)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterHeadLookAtBehaviour_TypeDefinitionIndex = 49263;
