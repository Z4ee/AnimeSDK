...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B348FA0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B3490A0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x1B348F20)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B348F30)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERSWITCHANCHORTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B349170)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterSwitchAnchorTrack_TypeDefinitionIndex = 47014;
