...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB89A9E0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB89A9D0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERHEADLOOKATCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB89ABD0)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterHeadLookAtClip_TypeDefinitionIndex = 45484;
