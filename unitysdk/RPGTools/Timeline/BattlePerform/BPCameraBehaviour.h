...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xE817AF0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_METHOD_3_106289055FB804CE_OFFSET UNITYSDK_OFFSET(0xE817B10)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_METHOD_3_41B039A4E2A7F091_OFFSET UNITYSDK_OFFSET(0xE818290)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_METHOD_3_CB3263D82A4CBC36_OFFSET UNITYSDK_OFFSET(0xE818040)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xE817B00)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE8183A0)
