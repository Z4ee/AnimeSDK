...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERANIMCROSSFADECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFDE140)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERANIMCROSSFADECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFDE130)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCHARACTERANIMCROSSFADECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDE2D0)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPCharacterAnimCrossFadeClip_TypeDefinitionIndex = 46063;
