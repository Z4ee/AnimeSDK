...
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B350F90)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_METHOD_5_DB6F9C3D439B5DF2_OFFSET UNITYSDK_OFFSET(0x1B351170)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B351860)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3518D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraTemplateTrack_TypeDefinitionIndex = 46140;
