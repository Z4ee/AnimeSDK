...
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTLISTONCHARACTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD065EA0)
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTLISTONCHARACTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD066130)
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTLISTONCHARACTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD066140)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TriggerEffectListOnCharacterClip_TypeDefinitionIndex = 45615;
