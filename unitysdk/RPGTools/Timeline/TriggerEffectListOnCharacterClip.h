...
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTLISTONCHARACTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABB0C90)
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTLISTONCHARACTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABB0F70)
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTLISTONCHARACTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABB0F80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TriggerEffectListOnCharacterClip_TypeDefinitionIndex = 39158;
