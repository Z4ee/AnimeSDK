...
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD031880)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD031870)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0319E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCScaleClip_TypeDefinitionIndex = 45498;
