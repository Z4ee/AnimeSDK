...
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0996E0)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0996D0)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B099870)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCScaleClip_TypeDefinitionIndex = 48667;
