...
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB7B4C0)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB7B4B0)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7B6B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCScaleClip_TypeDefinitionIndex = 39047;
