...
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8EFB50)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8EFB40)
#define RPGTOOLS_TIMELINE_NPCSCALECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8EFD40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCScaleClip_TypeDefinitionIndex = 44950;
