...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A59D10)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A59D00)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_067D4BA23D87C002_OFFSET UNITYSDK_OFFSET(0x19A59B10)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19A59EA0)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A59F00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomStringClip_TypeDefinitionIndex = 46353;
