...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8DD070)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8DD060)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_067D4BA23D87C002_OFFSET UNITYSDK_OFFSET(0xB8DCE60)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB8DD260)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8DD2C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomStringClip_TypeDefinitionIndex = 44867;
