...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB69070)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB69060)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_067D4BA23D87C002_OFFSET UNITYSDK_OFFSET(0xAB68E60)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAB69260)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB692C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomStringClip_TypeDefinitionIndex = 38964;
