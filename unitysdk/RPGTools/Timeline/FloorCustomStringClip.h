...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD020110)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD020100)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_067D4BA23D87C002_OFFSET UNITYSDK_OFFSET(0xD01FF00)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD0202A0)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMSTRINGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD020300)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomStringClip_TypeDefinitionIndex = 45424;
