...
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B5309B0)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B530C60)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMECLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B530B50)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMECLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0x1B530C00)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B530C70)
