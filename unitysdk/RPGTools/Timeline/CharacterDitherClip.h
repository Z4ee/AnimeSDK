...
#define RPGTOOLS_TIMELINE_CHARACTERDITHERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB354F0)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB354E0)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB356E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDitherClip_TypeDefinitionIndex = 38801;
