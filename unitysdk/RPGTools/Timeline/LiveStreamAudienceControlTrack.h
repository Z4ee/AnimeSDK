...
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE86CA80)
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xE86CC00)
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE86CC70)
