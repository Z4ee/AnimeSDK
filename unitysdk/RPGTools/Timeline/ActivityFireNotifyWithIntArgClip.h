...
#define RPGTOOLS_TIMELINE_ACTIVITYFIRENOTIFYWITHINTARGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFD4A80)
#define RPGTOOLS_TIMELINE_ACTIVITYFIRENOTIFYWITHINTARGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFD4B70)
#define RPGTOOLS_TIMELINE_ACTIVITYFIRENOTIFYWITHINTARGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD4B80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ActivityFireNotifyWithIntArgClip_TypeDefinitionIndex = 45107;
