...
#define RPGTOOLS_TIMELINE_ACTIVITYFIRENOTIFYWITHINTARGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE80D700)
#define RPGTOOLS_TIMELINE_ACTIVITYFIRENOTIFYWITHINTARGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE80D7F0)
#define RPGTOOLS_TIMELINE_ACTIVITYFIRENOTIFYWITHINTARGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE80D800)
