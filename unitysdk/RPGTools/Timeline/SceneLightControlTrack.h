...
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE8E0260)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E08C0)
