...
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x19F514F0)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWBEHAVIOUR_METHOD_2_52AAE9CCF700C74B_OFFSET UNITYSDK_OFFSET(0x19F515F0)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19F51510)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x19F51500)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F517F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBgEffectFrameShowBehaviour_TypeDefinitionIndex = 46590;
