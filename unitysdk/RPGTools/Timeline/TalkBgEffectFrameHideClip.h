...
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMEHIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD060570)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMEHIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD060560)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMEHIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD060700)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBgEffectFrameHideClip_TypeDefinitionIndex = 45649;
