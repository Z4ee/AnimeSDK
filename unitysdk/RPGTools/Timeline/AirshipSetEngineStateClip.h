...
#define RPGTOOLS_TIMELINE_AIRSHIPSETENGINESTATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB890300)
#define RPGTOOLS_TIMELINE_AIRSHIPSETENGINESTATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB890510)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AirshipSetEngineStateClip_TypeDefinitionIndex = 44607;
