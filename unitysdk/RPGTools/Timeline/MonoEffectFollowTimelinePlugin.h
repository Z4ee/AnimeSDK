...
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_EXECUTEFOLLOW_OFFSET UNITYSDK_OFFSET(0xD02FE00)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xD02FBE0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD02FDB0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0xD02FBF0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETFOLLOWTRAGET_OFFSET UNITYSDK_OFFSET(0xD02FC30)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETOFFSET_OFFSET UNITYSDK_OFFSET(0xD02FC90)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETSCALE_OFFSET UNITYSDK_OFFSET(0xD02FD30)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD030420)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MonoEffectFollowTimelinePlugin_TypeDefinitionIndex = 45731;
