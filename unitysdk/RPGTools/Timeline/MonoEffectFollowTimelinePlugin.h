...
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_EXECUTEFOLLOW_OFFSET UNITYSDK_OFFSET(0x1998C100)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1998BEE0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1998C0B0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1998BEF0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETFOLLOWTRAGET_OFFSET UNITYSDK_OFFSET(0x1998BF30)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x1998BF90)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETSCALE_OFFSET UNITYSDK_OFFSET(0x1998C030)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1998C720)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MonoEffectFollowTimelinePlugin_TypeDefinitionIndex = 46670;
