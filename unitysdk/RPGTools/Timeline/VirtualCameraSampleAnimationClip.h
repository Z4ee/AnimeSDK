...
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF3BBB0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF3BBA0)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_GET_FARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1BF3BB80)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_GET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1BF3BB60)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_GET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF3BB30)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_SET_FARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1BF3BB90)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_SET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x1BF3BB70)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP_SET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF3BB50)
#define RPGTOOLS_TIMELINE_VIRTUALCAMERASAMPLEANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF3BD60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VirtualCameraSampleAnimationClip_TypeDefinitionIndex = 48291;
