...
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6B640)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6B870)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6B880)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideLevelStageBehaviour_TypeDefinitionIndex = 39249;
