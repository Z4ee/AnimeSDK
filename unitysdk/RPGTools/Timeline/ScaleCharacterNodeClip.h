...
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB99C80)
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB99C70)
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB99E40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ScaleCharacterNodeClip_TypeDefinitionIndex = 39107;
