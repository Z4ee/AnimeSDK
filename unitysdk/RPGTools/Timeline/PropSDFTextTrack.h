...
#define RPGTOOLS_TIMELINE_PROPSDFTEXTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199AB8B0)
#define RPGTOOLS_TIMELINE_PROPSDFTEXTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x199AB7B0)
#define RPGTOOLS_TIMELINE_PROPSDFTEXTTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x199ABA20)
#define RPGTOOLS_TIMELINE_PROPSDFTEXTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199ABC90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropSDFTextTrack_TypeDefinitionIndex = 46472;
