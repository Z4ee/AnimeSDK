...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D14BB50)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D14BCD0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14BD40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineTrack_TypeDefinitionIndex = 48515;
