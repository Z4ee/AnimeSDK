...
#define RPGTOOLS_TIMELINE_TIMELINEACTIVITYTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8F5FA0)
#define RPGTOOLS_TIMELINE_TIMELINEACTIVITYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE8F6050)
