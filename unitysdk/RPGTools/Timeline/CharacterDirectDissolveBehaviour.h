...
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR_METHOD_2_C8EED11299FD17DB_OFFSET UNITYSDK_OFFSET(0x1B354F60)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B354ED0)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B355390)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B355620)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDirectDissolveBehaviour_TypeDefinitionIndex = 46174;
