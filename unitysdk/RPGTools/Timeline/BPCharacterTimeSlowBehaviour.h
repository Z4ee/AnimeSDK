...
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xB897D00)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR_METHOD_2_20A391A342486B59_OFFSET UNITYSDK_OFFSET(0xB897F40)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB897D20)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB897E60)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xB897D10)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB898020)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB898030)
#define RPGTOOLS_TIMELINE_BPCHARACTERTIMESLOWBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB898040)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BPCharacterTimeSlowBehaviour_TypeDefinitionIndex = 44575;
