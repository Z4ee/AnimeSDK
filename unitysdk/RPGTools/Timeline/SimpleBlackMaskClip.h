...
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB915830)
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB915820)
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB915A90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SimpleBlackMaskClip_TypeDefinitionIndex = 45041;
