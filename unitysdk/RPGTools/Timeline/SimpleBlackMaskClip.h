...
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B6DD0)
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199B6DC0)
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199B6FD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SimpleBlackMaskClip_TypeDefinitionIndex = 46523;
