...
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFE7A80)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFE7A70)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE7B70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSplitScreenControlClip_TypeDefinitionIndex = 45209;
