...
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINEBEHAVIOUR_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x1B52E010)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B52E220)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B52E1D0)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B52DEC0)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52E2A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorControlTimelineBehaviour_TypeDefinitionIndex = 48258;
