...
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F4D7D0)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F4D7C0)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4D930)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropEffectTransformClip_TypeDefinitionIndex = 46564;
