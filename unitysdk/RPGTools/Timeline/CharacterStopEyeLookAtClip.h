...
#define RPGTOOLS_TIMELINE_CHARACTERSTOPEYELOOKATCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF2ED0)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPEYELOOKATCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF3110)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPEYELOOKATCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xCFF3030)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPEYELOOKATCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xCFF30B0)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPEYELOOKATCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF3120)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStopEyeLookAtClip_TypeDefinitionIndex = 45289;
