...
#define RPGTOOLS_TIMELINE_SYNCSHADOWANDSCENELIGHTDIRCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F50820)
#define RPGTOOLS_TIMELINE_SYNCSHADOWANDSCENELIGHTDIRCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F509C0)
#define RPGTOOLS_TIMELINE_SYNCSHADOWANDSCENELIGHTDIRCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F509D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SyncShadowAndSceneLightDirClip_TypeDefinitionIndex = 46563;
