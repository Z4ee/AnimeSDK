...
#define RPGTOOLS_TIMELINE_SYNCSHADOWANDSCENELIGHTDIRCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF27D30)
#define RPGTOOLS_TIMELINE_SYNCSHADOWANDSCENELIGHTDIRCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF27ED0)
#define RPGTOOLS_TIMELINE_SYNCSHADOWANDSCENELIGHTDIRCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF27EE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SyncShadowAndSceneLightDirClip_TypeDefinitionIndex = 48808;
