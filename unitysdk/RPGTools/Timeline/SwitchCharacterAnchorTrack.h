...
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB91F050)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB91F160)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB91F410)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB91F420)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB91F460)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SwitchCharacterAnchorTrack_TypeDefinitionIndex = 45095;
