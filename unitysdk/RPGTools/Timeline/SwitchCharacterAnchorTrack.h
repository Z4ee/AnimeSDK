...
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF27870)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BF27990)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF27BE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SwitchCharacterAnchorTrack_TypeDefinitionIndex = 48826;
