...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_GET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B35D070)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B35CE60)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_GET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B35CED0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_GET__LOCKY_OFFSET UNITYSDK_OFFSET(0x1B35D6C0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_0A7A666C0F9466D1_OFFSET UNITYSDK_OFFSET(0x1B35D4B0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_13803BC6B54C35A0_OFFSET UNITYSDK_OFFSET(0x1B35D6D0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_1CB130E56D456949_OFFSET UNITYSDK_OFFSET(0x1B35DE50)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_23FE1B2C3BAED74B_OFFSET UNITYSDK_OFFSET(0x1B35DD50)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_3208E93919C079BD_OFFSET UNITYSDK_OFFSET(0x1B35DAA0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_3A2B594F0AE6254E_OFFSET UNITYSDK_OFFSET(0x1B35D130)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_4AD634C3483E64F5_OFFSET UNITYSDK_OFFSET(0x1B35D280)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_55E34085A14646D6_OFFSET UNITYSDK_OFFSET(0x1B35D880)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_5B02F1D0434EA06A_OFFSET UNITYSDK_OFFSET(0x1B35EC90)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_B747564CDCCF97BD_OFFSET UNITYSDK_OFFSET(0x1B35EA70)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_CD7772AD2FBA7595_OFFSET UNITYSDK_OFFSET(0x1B35CF40)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA_METHOD_1_DEB311B5FEAE68BE_OFFSET UNITYSDK_OFFSET(0x1B35E780)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35CD30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveData_TypeDefinitionIndex = 46226;
