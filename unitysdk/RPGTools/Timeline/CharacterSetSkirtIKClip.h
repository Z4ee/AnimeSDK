...
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B359FF0)
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B35A1C0)
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35A1D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSetSkirtIKClip_TypeDefinitionIndex = 46210;
