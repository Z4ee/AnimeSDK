...
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF1500)
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF16B0)
#define RPGTOOLS_TIMELINE_CHARACTERSETSKIRTIKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF16C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSetSkirtIKClip_TypeDefinitionIndex = 45286;
