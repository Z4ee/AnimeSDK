...
#define RPGTOOLS_TIMELINE_MOCAPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB78720)
#define RPGTOOLS_TIMELINE_MOCAPTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB78870)
#define RPGTOOLS_TIMELINE_MOCAPTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB786B0)
#define RPGTOOLS_TIMELINE_MOCAPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB789D0)
#define RPGTOOLS_TIMELINE_MOCAPTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB789F0)
#define RPGTOOLS_TIMELINE_MOCAPTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB78A30)
#define RPGTOOLS_TIMELINE_MOCAPTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB789E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MocapTrack_TypeDefinitionIndex = 39030;
