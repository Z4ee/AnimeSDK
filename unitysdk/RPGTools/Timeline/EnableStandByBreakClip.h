...
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A4FB80)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A4FB70)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4FD10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EnableStandByBreakClip_TypeDefinitionIndex = 46327;
