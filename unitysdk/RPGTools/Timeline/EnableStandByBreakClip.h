...
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD018630)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD018620)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0187C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EnableStandByBreakClip_TypeDefinitionIndex = 45398;
