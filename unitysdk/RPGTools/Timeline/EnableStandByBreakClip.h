...
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8535E0)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE8535D0)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE853770)
