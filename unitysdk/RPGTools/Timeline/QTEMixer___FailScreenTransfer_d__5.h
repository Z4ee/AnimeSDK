...
#define RPGTOOLS_TIMELINE_QTEMIXER___FAILSCREENTRANSFER_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD04D6A0)
#define RPGTOOLS_TIMELINE_QTEMIXER___FAILSCREENTRANSFER_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD04D830)
#define RPGTOOLS_TIMELINE_QTEMIXER___FAILSCREENTRANSFER_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD04D890)
#define RPGTOOLS_TIMELINE_QTEMIXER___FAILSCREENTRANSFER_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD04D840)
#define RPGTOOLS_TIMELINE_QTEMIXER___FAILSCREENTRANSFER_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD04D690)
#define RPGTOOLS_TIMELINE_QTEMIXER___FAILSCREENTRANSFER_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0xD04D4D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int QTEMixer___FailScreenTransfer_d__5_TypeDefinitionIndex = 45557;
