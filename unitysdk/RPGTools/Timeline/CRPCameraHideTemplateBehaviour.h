...
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xE820240)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE820260)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xE820250)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE8203C0)
