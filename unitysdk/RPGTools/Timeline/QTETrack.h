...
#define RPGTOOLS_TIMELINE_QTETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB97D50)
#define RPGTOOLS_TIMELINE_QTETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB97EB0)
#define RPGTOOLS_TIMELINE_QTETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB98090)
#define RPGTOOLS_TIMELINE_QTETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB98170)
#define RPGTOOLS_TIMELINE_QTETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB981B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int QTETrack_TypeDefinitionIndex = 39103;
