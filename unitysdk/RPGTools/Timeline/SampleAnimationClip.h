...
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0BBEF0)
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0BBEE0)
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BC080)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SampleAnimationClip_TypeDefinitionIndex = 48317;
