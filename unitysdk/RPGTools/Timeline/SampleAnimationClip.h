...
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199AFAC0)
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199AFAB0)
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199AFC50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SampleAnimationClip_TypeDefinitionIndex = 46085;
