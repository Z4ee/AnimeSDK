...
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFD63F0)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFD6770)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xCFD6560)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xCFD6710)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD6780)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorControlClip_TypeDefinitionIndex = 45158;
