...
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB891AD0)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB891E90)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xB891CB0)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xB891E30)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB891EA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorControlClip_TypeDefinitionIndex = 44611;
