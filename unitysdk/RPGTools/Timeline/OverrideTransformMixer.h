...
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_06F38768260E973C_OFFSET UNITYSDK_OFFSET(0xE8BD540)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE8BDA30)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_7F6BD08C06250CBF_OFFSET UNITYSDK_OFFSET(0xE8BD4D0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_C365440D57901CE0_OFFSET UNITYSDK_OFFSET(0xE8BD400)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_FEDFCE5C3EA7AA9D_OFFSET UNITYSDK_OFFSET(0xE8BDA80)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_FF36942ED4CD4426_OFFSET UNITYSDK_OFFSET(0xE8BC980)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xE8BD690)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xE8BD6F0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE8BD760)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8BDE90)
