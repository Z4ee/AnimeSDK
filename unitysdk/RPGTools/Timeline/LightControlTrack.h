...
#define RPGTOOLS_TIMELINE_LIGHTCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB8E8840)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E8CB0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB8E8D90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LightControlTrack_TypeDefinitionIndex = 45165;
