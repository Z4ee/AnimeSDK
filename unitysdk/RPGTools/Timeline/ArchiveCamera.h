...
#define RPGTOOLS_TIMELINE_ARCHIVECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xB894230)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveCamera_TypeDefinitionIndex = 45214;
