...
#define RPGTOOLS_TIMELINE_ARCHIVECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B531330)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveCamera_TypeDefinitionIndex = 48956;
