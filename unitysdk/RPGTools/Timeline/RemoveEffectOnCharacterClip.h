...
#define RPGTOOLS_TIMELINE_REMOVEEFFECTONCHARACTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD04EB60)
#define RPGTOOLS_TIMELINE_REMOVEEFFECTONCHARACTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD04EDF0)
#define RPGTOOLS_TIMELINE_REMOVEEFFECTONCHARACTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD04EE00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int RemoveEffectOnCharacterClip_TypeDefinitionIndex = 45611;
