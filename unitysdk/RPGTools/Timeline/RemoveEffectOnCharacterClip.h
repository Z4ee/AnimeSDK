...
#define RPGTOOLS_TIMELINE_REMOVEEFFECTONCHARACTERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB90DC60)
#define RPGTOOLS_TIMELINE_REMOVEEFFECTONCHARACTERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB90DF40)
#define RPGTOOLS_TIMELINE_REMOVEEFFECTONCHARACTERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB90DF50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int RemoveEffectOnCharacterClip_TypeDefinitionIndex = 45063;
