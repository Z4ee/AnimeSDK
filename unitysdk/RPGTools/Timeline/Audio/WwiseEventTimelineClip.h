...
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8965F0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8965D0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xB8965E0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_GET_ISPLAYERINVOLVED_OFFSET UNITYSDK_OFFSET(0xB8965B0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_SET_ISPLAYERINVOLVED_OFFSET UNITYSDK_OFFSET(0xB8965C0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8967D0)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int WwiseEventTimelineClip_TypeDefinitionIndex = 45506;
