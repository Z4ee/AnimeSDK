...
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B344930)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B344910)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1B344920)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_GET_ISPLAYERINVOLVED_OFFSET UNITYSDK_OFFSET(0x1B3448F0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP_SET_ISPLAYERINVOLVED_OFFSET UNITYSDK_OFFSET(0x1B344900)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEVENTTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B344AB0)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int WwiseEventTimelineClip_TypeDefinitionIndex = 47028;
