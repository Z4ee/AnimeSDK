...
#define RPGTOOLS_TIMELINE_AUDIO_WWISEUNMUTEPROPAUDIOBEHAVIOUR_GET_OWNER_OFFSET UNITYSDK_OFFSET(0xE816500)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEUNMUTEPROPAUDIOBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE816520)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEUNMUTEPROPAUDIOBEHAVIOUR_SET_OWNER_OFFSET UNITYSDK_OFFSET(0xE816510)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEUNMUTEPROPAUDIOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE816820)
