...
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB895F50)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB895F40)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB896120)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int BGMEmotionClip_TypeDefinitionIndex = 45503;
