...
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B344430)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B344420)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3445A0)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int BGMEmotionClip_TypeDefinitionIndex = 47025;
