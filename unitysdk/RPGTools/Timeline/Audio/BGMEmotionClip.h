...
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE814A90)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE814A80)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE814C00)
