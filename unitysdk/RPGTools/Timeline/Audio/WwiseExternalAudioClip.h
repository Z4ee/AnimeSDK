...
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALAUDIOCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFDB2A0)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALAUDIOCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFDB290)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALAUDIOCLIP_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0xCFDB270)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALAUDIOCLIP_METHOD_4_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xCFDB410)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALAUDIOCLIP_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0xCFDB280)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALAUDIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDB520)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int WwiseExternalAudioClip_TypeDefinitionIndex = 46096;
