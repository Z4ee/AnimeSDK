...
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONBEHAVIOUR_METHOD_3_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x1B3443D0)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONBEHAVIOUR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1B344390)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONBEHAVIOUR_METHOD_3_4A41C63BFE58D26F_OFFSET UNITYSDK_OFFSET(0x1B343E00)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONBEHAVIOUR_METHOD_3_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x1B3440B0)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B344330)
#define RPGTOOLS_TIMELINE_AUDIO_BGMEMOTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B344410)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int BGMEmotionBehaviour_TypeDefinitionIndex = 47024;
