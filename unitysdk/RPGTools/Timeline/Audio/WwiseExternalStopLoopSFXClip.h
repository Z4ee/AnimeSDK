...
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALSTOPLOOPSFXCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB23650)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALSTOPLOOPSFXCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB23640)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALSTOPLOOPSFXCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB23840)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int WwiseExternalStopLoopSFXClip_TypeDefinitionIndex = 39612;
