...
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALSTOPLOOPSFXCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFDBA40)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALSTOPLOOPSFXCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFDBA30)
#define RPGTOOLS_TIMELINE_AUDIO_WWISEEXTERNALSTOPLOOPSFXCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDBBD0)

namespace RPGTools::Timeline::Audio
{
	inline static constexpr unsigned int WwiseExternalStopLoopSFXClip_TypeDefinitionIndex = 46104;
