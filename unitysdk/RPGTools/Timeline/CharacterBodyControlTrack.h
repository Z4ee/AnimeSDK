...
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB34000)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB341C0)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB34740)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB34750)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB34790)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterBodyControlTrack_TypeDefinitionIndex = 38796;
