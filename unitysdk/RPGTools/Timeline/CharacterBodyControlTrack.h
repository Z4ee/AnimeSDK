...
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B3545D0)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B354760)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B354EC0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterBodyControlTrack_TypeDefinitionIndex = 46166;
