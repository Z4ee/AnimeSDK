...
#define RPGTOOLS_TIMELINE_CHARACTERFULLBODYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE82AE20)
#define RPGTOOLS_TIMELINE_CHARACTERFULLBODYCLIP_GET_CHAINS_OFFSET UNITYSDK_OFFSET(0xE82AC60)
#define RPGTOOLS_TIMELINE_CHARACTERFULLBODYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE82AFA0)
#define RPGTOOLS_TIMELINE_CHARACTERFULLBODYCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xE82AFB0)
#define RPGTOOLS_TIMELINE_CHARACTERFULLBODYCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xE82B010)
#define RPGTOOLS_TIMELINE_CHARACTERFULLBODYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE82B070)
