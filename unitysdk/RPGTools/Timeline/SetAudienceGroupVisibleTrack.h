...
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x199B2F20)
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x199B30A0)
#define RPGTOOLS_TIMELINE_SETAUDIENCEGROUPVISIBLETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199B3110)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SetAudienceGroupVisibleTrack_TypeDefinitionIndex = 46499;
