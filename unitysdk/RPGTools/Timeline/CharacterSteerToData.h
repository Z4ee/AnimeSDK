...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35AD80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSteerToData_TypeDefinitionIndex = 46220;
