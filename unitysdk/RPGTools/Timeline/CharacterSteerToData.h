...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1414A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSteerToData_TypeDefinitionIndex = 48454;
