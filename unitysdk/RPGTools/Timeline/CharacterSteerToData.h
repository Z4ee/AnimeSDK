...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTODATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AF220)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSteerToData_TypeDefinitionIndex = 44749;
