...
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B0C1E30)
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C1EA0)
