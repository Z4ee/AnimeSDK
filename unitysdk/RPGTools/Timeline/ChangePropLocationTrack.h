...
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B352C30)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B352D30)
#define RPGTOOLS_TIMELINE_CHANGEPROPLOCATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B352DA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ChangePropLocationTrack_TypeDefinitionIndex = 46145;
