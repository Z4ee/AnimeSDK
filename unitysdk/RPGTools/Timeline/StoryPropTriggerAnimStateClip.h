...
#define RPGTOOLS_TIMELINE_STORYPROPTRIGGERANIMSTATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F4F2B0)
#define RPGTOOLS_TIMELINE_STORYPROPTRIGGERANIMSTATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F4F2A0)
#define RPGTOOLS_TIMELINE_STORYPROPTRIGGERANIMSTATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4F460)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropTriggerAnimStateClip_TypeDefinitionIndex = 46480;
