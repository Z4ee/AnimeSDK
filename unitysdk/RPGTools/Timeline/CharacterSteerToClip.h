...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF2170)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF2300)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF2310)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSteerToClip_TypeDefinitionIndex = 45295;
