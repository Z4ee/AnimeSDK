...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8AEFD0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8AF1C0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AF1D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSteerToClip_TypeDefinitionIndex = 44748;
