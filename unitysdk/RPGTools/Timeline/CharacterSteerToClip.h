...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D1412B0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D141440)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D141450)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterSteerToClip_TypeDefinitionIndex = 48453;
