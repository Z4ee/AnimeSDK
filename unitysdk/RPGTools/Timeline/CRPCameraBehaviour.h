...
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xCFE31B0)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_196B667215CC6C04_OFFSET UNITYSDK_OFFSET(0xCFE37A0)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_2487CF59EC1C5F04_OFFSET UNITYSDK_OFFSET(0xCFE36D0)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_6BF81B6CD305D3E3_OFFSET UNITYSDK_OFFSET(0xCFE3600)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_729EA78A8E85039F_OFFSET UNITYSDK_OFFSET(0xCFE3870)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_959B5968D9A47AC1_OFFSET UNITYSDK_OFFSET(0xCFE3590)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xCFE31D0)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xCFE31C0)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE3A90)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xCFE3AA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBehaviour_TypeDefinitionIndex = 45190;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, a1, a2);
		}
	};
}
