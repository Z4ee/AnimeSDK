...
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB2B260)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_196B667215CC6C04_OFFSET UNITYSDK_OFFSET(0xAB2B850)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_2487CF59EC1C5F04_OFFSET UNITYSDK_OFFSET(0xAB2B780)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_6BF81B6CD305D3E3_OFFSET UNITYSDK_OFFSET(0xAB2B6B0)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_729EA78A8E85039F_OFFSET UNITYSDK_OFFSET(0xAB2B920)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_METHOD_2_959B5968D9A47AC1_OFFSET UNITYSDK_OFFSET(0xAB2B640)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB2B280)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB2B270)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2BB40)
#define RPGTOOLS_TIMELINE_CRPCAMERABEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB2BB50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBehaviour_TypeDefinitionIndex = 38744;
