...
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8A44C0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8A44B0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_METHOD_4_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0xB8A4680)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_METHOD_4_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xB8A4440)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A46E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSplitScreenTemplateClip_TypeDefinitionIndex = 44666;
