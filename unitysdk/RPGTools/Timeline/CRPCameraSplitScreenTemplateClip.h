...
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFE81C0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFE81B0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_METHOD_4_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xCFE8120)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP_METHOD_4_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0xCFE8350)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENTEMPLATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE83B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSplitScreenTemplateClip_TypeDefinitionIndex = 45213;
