...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19990D70)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19990ED0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19990EE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferClip_TypeDefinitionIndex = 46439;
