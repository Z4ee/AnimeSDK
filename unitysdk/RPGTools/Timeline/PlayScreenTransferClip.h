...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8F3030)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8F31F0)
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F3200)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferClip_TypeDefinitionIndex = 44957;
