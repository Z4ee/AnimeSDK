...
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8ACE40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterLookAtData_TypeDefinitionIndex = 44732;
