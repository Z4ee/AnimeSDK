...
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13F200)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterLookAtData_TypeDefinitionIndex = 48437;
