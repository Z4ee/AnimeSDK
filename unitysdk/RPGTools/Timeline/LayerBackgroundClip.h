...
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6F840)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB6F830)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6FA40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LayerBackgroundClip_TypeDefinitionIndex = 38985;
