...
#define RPGTOOLS_TIMELINE_DEBATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB46C00)
#define RPGTOOLS_TIMELINE_DEBATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB46BB0)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB46B70)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0xAB46BC0)
#define RPGTOOLS_TIMELINE_DEBATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB46E00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int DebateClip_TypeDefinitionIndex = 38913;
