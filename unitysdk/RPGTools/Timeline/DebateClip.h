...
#define RPGTOOLS_TIMELINE_DEBATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFFEB70)
#define RPGTOOLS_TIMELINE_DEBATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFFEB20)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCFFEAE0)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0xCFFEB30)
#define RPGTOOLS_TIMELINE_DEBATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFED00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int DebateClip_TypeDefinitionIndex = 45363;
