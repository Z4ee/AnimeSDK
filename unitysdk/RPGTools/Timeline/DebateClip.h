...
#define RPGTOOLS_TIMELINE_DEBATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8BB8C0)
#define RPGTOOLS_TIMELINE_DEBATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8BB870)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8BB830)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0xB8BB880)
#define RPGTOOLS_TIMELINE_DEBATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8BBAC0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int DebateClip_TypeDefinitionIndex = 44816;
