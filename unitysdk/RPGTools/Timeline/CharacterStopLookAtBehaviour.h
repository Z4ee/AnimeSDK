...
#define RPGTOOLS_TIMELINE_CHARACTERSTOPLOOKATBEHAVIOUR_METHOD_3_5EBCF276C230582C_OFFSET UNITYSDK_OFFSET(0xB8B09C0)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPLOOKATBEHAVIOUR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8B0C10)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPLOOKATBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B0C00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStopLookAtBehaviour_TypeDefinitionIndex = 44744;
