...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B4FF0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8B51B0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B51C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStorySteerClip_TypeDefinitionIndex = 44775;
