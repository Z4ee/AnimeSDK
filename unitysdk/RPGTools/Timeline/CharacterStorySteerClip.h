...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF7F90)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF80F0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF8100)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStorySteerClip_TypeDefinitionIndex = 45322;
