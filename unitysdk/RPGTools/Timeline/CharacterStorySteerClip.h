...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B3603F0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B360550)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYSTEERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B360560)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStorySteerClip_TypeDefinitionIndex = 46246;
