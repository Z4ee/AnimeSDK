...
#define RPGTOOLS_TIMELINE_QTEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xD04BF80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int QTEMissionCustomValue_TypeDefinitionIndex = 45553;
