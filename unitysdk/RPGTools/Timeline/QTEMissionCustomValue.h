...
#define RPGTOOLS_TIMELINE_QTEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xB90AF90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int QTEMissionCustomValue_TypeDefinitionIndex = 45005;
