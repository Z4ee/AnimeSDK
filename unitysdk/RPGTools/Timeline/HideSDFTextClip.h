...
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B592450)
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B592440)
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5925E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideSDFTextClip_TypeDefinitionIndex = 48705;
