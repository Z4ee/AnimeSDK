...
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A5F5A0)
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A5F590)
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A5F730)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideSDFTextClip_TypeDefinitionIndex = 46470;
