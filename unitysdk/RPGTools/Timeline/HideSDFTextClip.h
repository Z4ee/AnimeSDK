...
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE863880)
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE863870)
#define RPGTOOLS_TIMELINE_HIDESDFTEXTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE863A10)
