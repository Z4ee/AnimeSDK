...
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A5EC40)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19A5EDC0)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A5EE30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HidePropForStoryTrack_TypeDefinitionIndex = 46368;
