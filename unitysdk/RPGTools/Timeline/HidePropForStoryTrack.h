...
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B591AF0)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B591C70)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B591CE0)
