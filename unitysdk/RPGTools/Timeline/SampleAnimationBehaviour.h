...
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x199AF840)
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x199AF8C0)
#define RPGTOOLS_TIMELINE_SAMPLEANIMATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x199AFAA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SampleAnimationBehaviour_TypeDefinitionIndex = 46087;
