...
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F52040)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19F52160)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19F52230)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkFigureEvtTrack_TypeDefinitionIndex = 46595;
