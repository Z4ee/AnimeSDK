...
#define RPGTOOLS_TIMELINE_FCVSIMULATIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19A58AF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FCVSimulationParam_TypeDefinitionIndex = 46346;
