...
#define RPGTOOLS_TIMELINE_FCVSIMULATIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xAB67CD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FCVSimulationParam_TypeDefinitionIndex = 38957;
