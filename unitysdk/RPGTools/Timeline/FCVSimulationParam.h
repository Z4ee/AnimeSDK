...
#define RPGTOOLS_TIMELINE_FCVSIMULATIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B58B180)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FCVSimulationParam_TypeDefinitionIndex = 48581;
