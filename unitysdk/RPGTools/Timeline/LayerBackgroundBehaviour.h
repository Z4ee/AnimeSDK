...
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB6F5A0)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB6F760)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6F5C0)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB6F5B0)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6F800)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB6F820)
#define RPGTOOLS_TIMELINE_LAYERBACKGROUNDBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB6F810)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LayerBackgroundBehaviour_TypeDefinitionIndex = 38986;
