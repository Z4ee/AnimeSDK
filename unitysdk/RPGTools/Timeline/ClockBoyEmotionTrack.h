...
#define RPGTOOLS_TIMELINE_CLOCKBOYEMOTIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB41D80)
#define RPGTOOLS_TIMELINE_CLOCKBOYEMOTIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB41EC0)
#define RPGTOOLS_TIMELINE_CLOCKBOYEMOTIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB42130)
#define RPGTOOLS_TIMELINE_CLOCKBOYEMOTIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB42210)
#define RPGTOOLS_TIMELINE_CLOCKBOYEMOTIONTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB42250)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ClockBoyEmotionTrack_TypeDefinitionIndex = 38885;
