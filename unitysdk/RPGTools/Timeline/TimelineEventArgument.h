...
#define RPGTOOLS_TIMELINE_TIMELINEEVENTARGUMENT_METHOD_1_19FAEE8D27FE7B2E_OFFSET UNITYSDK_OFFSET(0xABAF090)
#define RPGTOOLS_TIMELINE_TIMELINEEVENTARGUMENT_METHOD_1_2FEDAD90B1F012D7_OFFSET UNITYSDK_OFFSET(0xABAEEC0)
#define RPGTOOLS_TIMELINE_TIMELINEEVENTARGUMENT_METHOD_1_5BF2E2AD860B1DBA_OFFSET UNITYSDK_OFFSET(0xABAF030)
#define RPGTOOLS_TIMELINE_TIMELINEEVENTARGUMENT_METHOD_1_70D6F522F3C40980_OFFSET UNITYSDK_OFFSET(0xABAEE50)
#define RPGTOOLS_TIMELINE_TIMELINEEVENTARGUMENT_METHOD_1_D6D7DE7A8E2DC3B7_OFFSET UNITYSDK_OFFSET(0xABAEFD0)
#define RPGTOOLS_TIMELINE_TIMELINEEVENTARGUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xABAF120)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TimelineEventArgument_TypeDefinitionIndex = 39244;
