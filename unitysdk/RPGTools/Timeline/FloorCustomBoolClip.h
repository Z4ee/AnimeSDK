...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8DC670)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8DC660)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB8DC860)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_7859EEE32925E270_OFFSET UNITYSDK_OFFSET(0xB8DC4A0)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8DC8C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomBoolClip_TypeDefinitionIndex = 44863;
