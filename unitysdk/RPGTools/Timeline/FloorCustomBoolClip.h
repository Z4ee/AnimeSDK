...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B58BA00)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B58B9F0)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B58BB90)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_45B767B6C90F92B7_OFFSET UNITYSDK_OFFSET(0x1B58B810)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B58BBF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomBoolClip_TypeDefinitionIndex = 48584;
	...
	public:
		...
		::System::Void Method_4_45B767B6C90F92B7(::RPGTools::Timeline::FloorCustomBoolClip* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPGTools::Timeline::FloorCustomBoolClip*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_45B767B6C90F92B7_OFFSET))(this, a1);
		}
	};
}
