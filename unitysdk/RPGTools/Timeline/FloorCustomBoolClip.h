...
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A59340)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A59330)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19A594D0)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP_METHOD_4_7859EEE32925E270_OFFSET UNITYSDK_OFFSET(0x19A59180)
#define RPGTOOLS_TIMELINE_FLOORCUSTOMBOOLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A59530)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int FloorCustomBoolClip_TypeDefinitionIndex = 46349;
