...
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE839750)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xE83A050)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_METHOD_5_C6DC054D33B475B3_OFFSET UNITYSDK_OFFSET(0xE839F20)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_METHOD_5_F821272A6F60651E_OFFSET UNITYSDK_OFFSET(0xE839E40)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE83A060)
