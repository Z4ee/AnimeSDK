...
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A35870)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x19A36170)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_METHOD_5_C6DC054D33B475B3_OFFSET UNITYSDK_OFFSET(0x19A36040)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_METHOD_5_F821272A6F60651E_OFFSET UNITYSDK_OFFSET(0x19A35F60)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A36180)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CutsceneCameraTrack_TypeDefinitionIndex = 46285;
