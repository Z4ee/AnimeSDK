...
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A692D0)
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A692C0)
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A69460)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSmallWindowClip_TypeDefinitionIndex = 46400;
