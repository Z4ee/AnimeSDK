...
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8E9C20)
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8E9C10)
#define RPGTOOLS_TIMELINE_LIVESTREAMSMALLWINDOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E9DE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSmallWindowClip_TypeDefinitionIndex = 44918;
