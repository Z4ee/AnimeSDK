...
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6B310)
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB6B430)
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6B440)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int GlobalMainIntensityTimelineClip_TypeDefinitionIndex = 39276;
