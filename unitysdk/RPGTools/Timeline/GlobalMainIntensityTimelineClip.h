...
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD022280)
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD022350)
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD022360)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int GlobalMainIntensityTimelineClip_TypeDefinitionIndex = 45742;
