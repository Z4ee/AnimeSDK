...
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE85FC80)
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE85FD50)
#define RPGTOOLS_TIMELINE_GLOBALMAININTENSITYTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE85FD60)
