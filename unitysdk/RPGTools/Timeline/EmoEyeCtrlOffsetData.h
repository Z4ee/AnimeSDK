...
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_568AE7A1499723FD_OFFSET UNITYSDK_OFFSET(0xB8C21F0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_67CB654BCD33D174_OFFSET UNITYSDK_OFFSET(0xB8C27D0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_755F3799E9E38886_OFFSET UNITYSDK_OFFSET(0xB8C2CC0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_83E5962F76A0F76D_OFFSET UNITYSDK_OFFSET(0xB8C2DC0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_A26F042E7DB6E731_OFFSET UNITYSDK_OFFSET(0xB8C2B30)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_A828CA1097710F12_OFFSET UNITYSDK_OFFSET(0xB8C24B0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8C2EF0)
#define RPGTOOLS_TIMELINE_EMOEYECTRLOFFSETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C3010)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeCtrlOffsetData_TypeDefinitionIndex = 44849;
