...
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xE8E35F0)
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDBEHAVIOUR_METHOD_2_700EA064073BB2CC_OFFSET UNITYSDK_OFFSET(0xE8E3800)
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE8E3610)
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xE8E3600)
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xE8E39A0)
#define RPGTOOLS_TIMELINE_SHOWCUMULATIVESCOREBOARDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E3990)
...
namespace RPGTools::Timeline
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ShowCumulativeScoreBoardBehaviour_TypeDefinitionIndex)->GetStaticField(0x3D240);
		}
