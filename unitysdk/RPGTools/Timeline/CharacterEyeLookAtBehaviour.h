...
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB35900)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB35C80)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB35C90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterEyeLookAtBehaviour_TypeDefinitionIndex = 38824;
