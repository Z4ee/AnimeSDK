...
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xB8A6C00)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_GET_EYEBLINKTYPE_OFFSET UNITYSDK_OFFSET(0xB8A6C20)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xB8A6DE0)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB8A6C40)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xB8A6C10)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_SET_EYEBLINKTYPE_OFFSET UNITYSDK_OFFSET(0xB8A6C30)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A6E80)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xB8A6EA0)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB8A6E90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharaEyeAutoBlinkBehaviour_TypeDefinitionIndex = 44683;
