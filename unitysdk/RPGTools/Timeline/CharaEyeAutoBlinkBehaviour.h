...
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xCFEA7F0)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_GET_EYEBLINKTYPE_OFFSET UNITYSDK_OFFSET(0xCFEA810)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xCFEA9D0)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xCFEA830)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xCFEA800)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR_SET_EYEBLINKTYPE_OFFSET UNITYSDK_OFFSET(0xCFEA820)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xCFEAA70)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xCFEAA90)
#define RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xCFEAA80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharaEyeAutoBlinkBehaviour_TypeDefinitionIndex = 45230;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_OnBehaviourPause(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_CHARAEYEAUTOBLINKBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET))(this, a1, a2);
		}
	};
}
