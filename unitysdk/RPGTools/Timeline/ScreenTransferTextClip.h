...
#define RPGTOOLS_TIMELINE_SCREENTRANSFERTEXTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0BEC20)
#define RPGTOOLS_TIMELINE_SCREENTRANSFERTEXTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0BEDA0)
#define RPGTOOLS_TIMELINE_SCREENTRANSFERTEXTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BEDB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ScreenTransferTextClip_TypeDefinitionIndex = 48678;
