...
#define RPGTOOLS_TIMELINE_SCREENTRANSFERTEXTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD051950)
#define RPGTOOLS_TIMELINE_SCREENTRANSFERTEXTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD051AD0)
#define RPGTOOLS_TIMELINE_SCREENTRANSFERTEXTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD051AE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ScreenTransferTextClip_TypeDefinitionIndex = 45509;
