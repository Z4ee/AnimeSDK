...
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB442A0)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB44290)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB44490)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvincePanelActiveClip_TypeDefinitionIndex = 38899;
