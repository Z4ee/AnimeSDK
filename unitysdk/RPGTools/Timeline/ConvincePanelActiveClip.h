...
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B9000)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8B8FF0)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B91F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvincePanelActiveClip_TypeDefinitionIndex = 44802;
