...
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D14AE70)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D14AE60)
#define RPGTOOLS_TIMELINE_CONVINCEPANELACTIVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14B000)
