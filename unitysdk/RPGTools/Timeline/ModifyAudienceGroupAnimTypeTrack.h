...
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB8ED9F0)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xB8EDBD0)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB8EDC40)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB8EDD20)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPETRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xB8EDDC0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ModifyAudienceGroupAnimTypeTrack_TypeDefinitionIndex = 44938;
