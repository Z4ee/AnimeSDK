...
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D13C870)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D13CA00)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1D13CA10)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0x1D13CAC0)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13CB20)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterEyeLookAtClip_TypeDefinitionIndex = 48433;
