...
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFED6F0)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFED850)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xCFED860)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xCFED910)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFED970)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterEyeLookAtClip_TypeDefinitionIndex = 45275;
