...
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB20DE0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB20EE0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB20EF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AtlasFaceEmotionTrack_TypeDefinitionIndex = 38882;
