...
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0x19D6A610)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_2A86A6EF98F53C91_OFFSET UNITYSDK_OFFSET(0x19D6B680)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_45340C1DF3AEADA4_OFFSET UNITYSDK_OFFSET(0x19D6B060)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_47964386227B3C92_OFFSET UNITYSDK_OFFSET(0x19D6B970)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_4DF9D318A497852F_OFFSET UNITYSDK_OFFSET(0x19D6B700)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_5EBCF276C230582C_OFFSET UNITYSDK_OFFSET(0x19D6B2B0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x19D6B230)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_908A3655CE42CB9A_OFFSET UNITYSDK_OFFSET(0x19D6ADD0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_A65AC190C0D0526C_OFFSET UNITYSDK_OFFSET(0x19D6AC80)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_C31A82607DD7D975_OFFSET UNITYSDK_OFFSET(0x19D6AA50)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0x19D6AFB0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x19D6A630)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0x19D6A620)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6BA10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ActiveVirtualCameraBehaviour_TypeDefinitionIndex = 46047;
