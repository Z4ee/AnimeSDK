...
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xE80B860)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_2A86A6EF98F53C91_OFFSET UNITYSDK_OFFSET(0xE80C8D0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_45340C1DF3AEADA4_OFFSET UNITYSDK_OFFSET(0xE80C2A0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_47964386227B3C92_OFFSET UNITYSDK_OFFSET(0xE80CBC0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_4DF9D318A497852F_OFFSET UNITYSDK_OFFSET(0xE80C950)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_5EBCF276C230582C_OFFSET UNITYSDK_OFFSET(0xE80C4F0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0xE80C470)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_908A3655CE42CB9A_OFFSET UNITYSDK_OFFSET(0xE80C010)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_A65AC190C0D0526C_OFFSET UNITYSDK_OFFSET(0xE80BEC0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_C31A82607DD7D975_OFFSET UNITYSDK_OFFSET(0xE80BCA0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0xE80C1F0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0xE80B880)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xE80B870)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE80CC60)
