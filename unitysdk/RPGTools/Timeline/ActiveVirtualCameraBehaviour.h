...
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xAB1A250)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_2A86A6EF98F53C91_OFFSET UNITYSDK_OFFSET(0xAB1B280)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_45340C1DF3AEADA4_OFFSET UNITYSDK_OFFSET(0xAB1ACA0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_45714050EDEF8291_OFFSET UNITYSDK_OFFSET(0xAB1ABF0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_47964386227B3C92_OFFSET UNITYSDK_OFFSET(0xAB1B560)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xAB1B610)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_5EBCF276C230582C_OFFSET UNITYSDK_OFFSET(0xAB1AEF0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0xAB1AE70)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_7179D7610C5244E3_OFFSET UNITYSDK_OFFSET(0xAB1B300)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_908A3655CE42CB9A_OFFSET UNITYSDK_OFFSET(0xAB1AA10)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_A65AC190C0D0526C_OFFSET UNITYSDK_OFFSET(0xAB1A8C0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_C31A82607DD7D975_OFFSET UNITYSDK_OFFSET(0xAB1A690)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_METHOD_3_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0xAB1A270)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xAB1A260)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB1B600)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ActiveVirtualCameraBehaviour_TypeDefinitionIndex = 38683;
