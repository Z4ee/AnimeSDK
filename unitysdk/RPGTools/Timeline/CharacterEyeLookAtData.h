...
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AA2C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterEyeLookAtData_TypeDefinitionIndex = 44729;
