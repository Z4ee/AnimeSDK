...
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFED9D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterEyeLookAtData_TypeDefinitionIndex = 45276;
