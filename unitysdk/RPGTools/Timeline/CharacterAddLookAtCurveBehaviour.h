...
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB33760)
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB33A10)
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB33A20)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterAddLookAtCurveBehaviour_TypeDefinitionIndex = 38821;
