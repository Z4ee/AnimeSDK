...
#define RPGTOOLS_TIMELINE_CONVINCEDOUBLESCREENSHAKECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB42CF0)
#define RPGTOOLS_TIMELINE_CONVINCEDOUBLESCREENSHAKECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB42CE0)
#define RPGTOOLS_TIMELINE_CONVINCEDOUBLESCREENSHAKECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB42EE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceDoubleScreenShakeClip_TypeDefinitionIndex = 38889;
