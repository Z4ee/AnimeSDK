...
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB1B690)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB1BA70)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xAB1B670)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xAB1B680)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAB1B990)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xAB1BA10)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB1BA80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ActiveVirtualCameraClip_TypeDefinitionIndex = 38684;
