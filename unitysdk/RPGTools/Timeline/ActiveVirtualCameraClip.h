...
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB88F410)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB88F7F0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xB88F3F0)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xB88F400)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xB88F710)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xB88F790)
#define RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB88F800)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ActiveVirtualCameraClip_TypeDefinitionIndex = 44583;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_ACTIVEVIRTUALCAMERACLIP_SET_STREAMINGSOURCEINDEX_OFFSET))(this, value);
		}
