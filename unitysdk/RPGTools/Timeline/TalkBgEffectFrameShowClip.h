...
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB920B00)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB920AF0)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB920CF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBgEffectFrameShowClip_TypeDefinitionIndex = 45103;
