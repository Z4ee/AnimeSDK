...
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABAB440)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABAB430)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABAB630)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBgEffectFrameShowClip_TypeDefinitionIndex = 39194;
