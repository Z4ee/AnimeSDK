...
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F51810)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F51800)
#define RPGTOOLS_TIMELINE_TALKBGEFFECTFRAMESHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F519A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TalkBgEffectFrameShowClip_TypeDefinitionIndex = 46589;
