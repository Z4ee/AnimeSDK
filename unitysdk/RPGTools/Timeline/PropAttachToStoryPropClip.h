...
#define RPGTOOLS_TIMELINE_PROPATTACHTOSTORYPROPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB94EA0)
#define RPGTOOLS_TIMELINE_PROPATTACHTOSTORYPROPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB94E90)
#define RPGTOOLS_TIMELINE_PROPATTACHTOSTORYPROPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB95090)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropAttachToStoryPropClip_TypeDefinitionIndex = 39081;
