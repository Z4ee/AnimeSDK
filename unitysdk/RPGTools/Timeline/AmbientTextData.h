...
#define RPGTOOLS_TIMELINE_AMBIENTTEXTDATA_GETENABLEDTEXTIDS_OFFSET UNITYSDK_OFFSET(0xE80DCF0)
#define RPGTOOLS_TIMELINE_AMBIENTTEXTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE80DE30)
