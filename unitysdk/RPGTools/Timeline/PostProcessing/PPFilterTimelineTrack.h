...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B0AF860)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AF9D0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int PPFilterTimelineTrack_TypeDefinitionIndex = 49046;
