...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB902B40)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB902C60)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB902C70)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int PPFilterTimelineClip_TypeDefinitionIndex = 45303;
