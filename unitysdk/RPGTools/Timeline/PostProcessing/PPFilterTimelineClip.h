...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0AF6A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0AF770)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AF780)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int PPFilterTimelineClip_TypeDefinitionIndex = 49045;
