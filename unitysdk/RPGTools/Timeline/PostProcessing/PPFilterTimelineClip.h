...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199A33A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199A3470)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199A3480)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int PPFilterTimelineClip_TypeDefinitionIndex = 46799;
