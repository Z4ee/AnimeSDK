...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_GAUSSIANBLURTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB8BD30)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_GAUSSIANBLURTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB8C000)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_GAUSSIANBLURTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB8C040)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int GaussianBlurTimelineBehaviour_TypeDefinitionIndex = 39376;
