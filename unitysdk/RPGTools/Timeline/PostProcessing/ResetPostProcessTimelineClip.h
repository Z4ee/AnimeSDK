...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RESETPOSTPROCESSTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0466B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RESETPOSTPROCESSTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD0466A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RESETPOSTPROCESSTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0467A0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int ResetPostProcessTimelineClip_TypeDefinitionIndex = 45878;
