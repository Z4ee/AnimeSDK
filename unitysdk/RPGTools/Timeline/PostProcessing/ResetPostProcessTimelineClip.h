...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RESETPOSTPROCESSTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB905380)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RESETPOSTPROCESSTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB905370)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RESETPOSTPROCESSTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9054D0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int ResetPostProcessTimelineClip_TypeDefinitionIndex = 45321;
