...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKPARAMETER_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x39E57A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKPARAMETER_METHOD_2_9550997717DE4AD0_OFFSET UNITYSDK_OFFSET(0x19996F50)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BlinkParameter_TypeDefinitionIndex = 46749;
