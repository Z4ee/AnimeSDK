...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKPARAMETER_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x89F20)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKPARAMETER_METHOD_2_9550997717DE4AD0_OFFSET UNITYSDK_OFFSET(0xAB848D0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BlinkParameter_TypeDefinitionIndex = 39344;
