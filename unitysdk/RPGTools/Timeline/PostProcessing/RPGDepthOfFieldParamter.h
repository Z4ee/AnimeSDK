...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_3BB56FCCFBEBE786_OFFSET UNITYSDK_OFFSET(0xB903930)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_A4EFC29299D9E71E_OFFSET UNITYSDK_OFFSET(0xB903730)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_C4F5DCDE1EBB7C70_OFFSET UNITYSDK_OFFSET(0xB903850)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB900740)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int RPGDepthOfFieldParamter_TypeDefinitionIndex = 45275;
