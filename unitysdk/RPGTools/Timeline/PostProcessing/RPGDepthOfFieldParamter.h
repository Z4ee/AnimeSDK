...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_3BB56FCCFBEBE786_OFFSET UNITYSDK_OFFSET(0x1B0B06F0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_A4EFC29299D9E71E_OFFSET UNITYSDK_OFFSET(0x1B0B04F0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_C4F5DCDE1EBB7C70_OFFSET UNITYSDK_OFFSET(0x1B0B0610)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AC400)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int RPGDepthOfFieldParamter_TypeDefinitionIndex = 49017;
