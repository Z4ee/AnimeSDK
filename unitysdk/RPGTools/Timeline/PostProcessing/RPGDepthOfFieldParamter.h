...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_3BB56FCCFBEBE786_OFFSET UNITYSDK_OFFSET(0xE8D2490)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_A4EFC29299D9E71E_OFFSET UNITYSDK_OFFSET(0xE8D2290)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER_METHOD_1_C4F5DCDE1EBB7C70_OFFSET UNITYSDK_OFFSET(0xE8D23B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RPGDEPTHOFFIELDPARAMTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8CE1A0)
