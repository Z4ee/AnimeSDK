...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8FDD60)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8FDD50)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FDF70)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int DOFTimelineClip_TypeDefinitionIndex = 45276;
