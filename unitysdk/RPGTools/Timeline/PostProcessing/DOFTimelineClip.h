...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB89720)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB89710)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB89930)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int DOFTimelineClip_TypeDefinitionIndex = 39367;
