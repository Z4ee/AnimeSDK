...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0A55F0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0A56E0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A56F0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BlinkTimelineClip_TypeDefinitionIndex = 48998;
