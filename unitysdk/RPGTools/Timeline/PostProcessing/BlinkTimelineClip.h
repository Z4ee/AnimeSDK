...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD03C960)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD03CA30)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD03CA40)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BlinkTimelineClip_TypeDefinitionIndex = 45813;
