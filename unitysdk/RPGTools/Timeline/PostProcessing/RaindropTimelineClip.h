...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199A5CA0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199A5D90)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199A5DA0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int RaindropTimelineClip_TypeDefinitionIndex = 46814;
