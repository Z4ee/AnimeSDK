...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD046050)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD046140)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD046150)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int RaindropTimelineClip_TypeDefinitionIndex = 45875;
