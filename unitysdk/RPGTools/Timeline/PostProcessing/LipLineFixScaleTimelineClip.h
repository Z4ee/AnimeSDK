...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199A1EE0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_GET_AUTORESET_OFFSET UNITYSDK_OFFSET(0x199A1EB0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199A1ED0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_SET_AUTORESET_OFFSET UNITYSDK_OFFSET(0x199A1EC0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199A2080)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int LipLineFixScaleTimelineClip_TypeDefinitionIndex = 46790;
