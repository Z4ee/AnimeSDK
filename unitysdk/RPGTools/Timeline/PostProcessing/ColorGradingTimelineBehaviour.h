...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_COLORGRADINGTIMELINEBEHAVIOUR_METHOD_4_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1B0A7E70)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_COLORGRADINGTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B0A6F80)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_COLORGRADINGTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A7F10)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int ColorGradingTimelineBehaviour_TypeDefinitionIndex = 49012;
