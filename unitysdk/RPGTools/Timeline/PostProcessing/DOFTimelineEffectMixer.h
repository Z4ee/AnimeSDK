...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTMIXER_GET_ISEDITORMODE_OFFSET UNITYSDK_OFFSET(0xAB8A9A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB8A9B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB8AE50)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB8AE70)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int DOFTimelineEffectMixer_TypeDefinitionIndex = 39371;
