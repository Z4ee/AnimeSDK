...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERPARAMETER_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x8AB90)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_PPFILTERPARAMETER_METHOD_2_DF84F9773DC0FC4C_OFFSET UNITYSDK_OFFSET(0xAB8D6E0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int PPFilterParameter_TypeDefinitionIndex = 39391;
