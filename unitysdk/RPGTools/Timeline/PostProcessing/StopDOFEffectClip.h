...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_STOPDOFEFFECTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199A79B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_STOPDOFEFFECTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199A79A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_STOPDOFEFFECTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199A7B40)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int StopDOFEffectClip_TypeDefinitionIndex = 46827;
