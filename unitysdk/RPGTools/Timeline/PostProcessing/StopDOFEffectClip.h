...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_STOPDOFEFFECTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9063E0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_STOPDOFEFFECTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB9063D0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_STOPDOFEFFECTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9065D0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int StopDOFEffectClip_TypeDefinitionIndex = 45331;
