...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_GET_ENABLEDOF_OFFSET UNITYSDK_OFFSET(0xE8CB450)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_GET_TARGETFAR_OFFSET UNITYSDK_OFFSET(0xE8CB490)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_GET_TARGET_OFFSET UNITYSDK_OFFSET(0xE8CB470)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_METHOD_2_5D09A94649A55CAE_OFFSET UNITYSDK_OFFSET(0xE8CB6B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xE8CB5F0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xE8CB4B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE8CBBA0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_SET_ENABLEDOF_OFFSET UNITYSDK_OFFSET(0xE8CB460)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_SET_TARGETFAR_OFFSET UNITYSDK_OFFSET(0xE8CB4A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_SET_TARGET_OFFSET UNITYSDK_OFFSET(0xE8CB480)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE8CCB60)
