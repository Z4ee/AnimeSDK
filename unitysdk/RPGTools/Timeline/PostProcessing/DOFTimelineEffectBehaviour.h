...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_GET_ENABLEDOF_OFFSET UNITYSDK_OFFSET(0xD03F610)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_GET_TARGETFAR_OFFSET UNITYSDK_OFFSET(0xD03F650)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_GET_TARGET_OFFSET UNITYSDK_OFFSET(0xD03F630)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_METHOD_2_2E866BF7FD6485AB_OFFSET UNITYSDK_OFFSET(0xD03F870)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xD03F7B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xD03F670)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD03FA40)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_SET_ENABLEDOF_OFFSET UNITYSDK_OFFSET(0xD03F620)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_SET_TARGETFAR_OFFSET UNITYSDK_OFFSET(0xD03F660)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR_SET_TARGET_OFFSET UNITYSDK_OFFSET(0xD03F640)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD0407B0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xD0407D0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD0407E0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int DOFTimelineEffectBehaviour_TypeDefinitionIndex = 45835;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTART_OFFSET))(this, a1);
		}

		::System::Void __iFixBaseProxy_ProcessFrame(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2, ::System::Object* a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData, ::System::Object*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_DOFTIMELINEEFFECTBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET))(this, a1, a2, a3);
		}
	};
}
