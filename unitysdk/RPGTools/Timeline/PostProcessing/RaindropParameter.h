...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPPARAMETER_METHOD_2_8B323DFEC7527767_OFFSET UNITYSDK_OFFSET(0x199A4F70)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPPARAMETER_METHOD_2_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x39E6600)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int RaindropParameter_TypeDefinitionIndex = 46811;
