...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPPARAMETER_METHOD_2_8B323DFEC7527767_OFFSET UNITYSDK_OFFSET(0x1B0B1280)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_RAINDROPPARAMETER_METHOD_2_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x3B78250)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int RaindropParameter_TypeDefinitionIndex = 49057;
