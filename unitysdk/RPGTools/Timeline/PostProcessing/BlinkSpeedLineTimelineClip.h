...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKSPEEDLINETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD03BAE0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKSPEEDLINETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD03BBD0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKSPEEDLINETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD03BBE0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BlinkSpeedLineTimelineClip_TypeDefinitionIndex = 45808;
