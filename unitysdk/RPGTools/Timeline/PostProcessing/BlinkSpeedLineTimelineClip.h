...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKSPEEDLINETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB858D0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKSPEEDLINETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB85A20)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLINKSPEEDLINETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB85A30)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BlinkSpeedLineTimelineClip_TypeDefinitionIndex = 39342;
