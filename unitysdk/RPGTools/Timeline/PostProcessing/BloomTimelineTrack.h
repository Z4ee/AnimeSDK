...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLOOMTIMELINETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB87670)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLOOMTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB87720)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_BLOOMTIMELINETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB878E0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int BloomTimelineTrack_TypeDefinitionIndex = 39355;
	...
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_BLOOMTIMELINETRACK__CTOR_OFFSET))(this);
		}
