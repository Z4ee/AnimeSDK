...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199A93A0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199A9490)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199A94A0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int TransitionTimelineClip_TypeDefinitionIndex = 46835;
