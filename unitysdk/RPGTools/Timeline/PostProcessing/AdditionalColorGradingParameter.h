...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_ADDITIONALCOLORGRADINGPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x39E56A0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int AdditionalColorGradingParameter_TypeDefinitionIndex = 46736;
