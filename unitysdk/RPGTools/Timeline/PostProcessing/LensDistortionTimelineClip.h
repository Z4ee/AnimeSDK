...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LENSDISTORTIONTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0425D0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int LensDistortionTimelineClip_TypeDefinitionIndex = 45847;
