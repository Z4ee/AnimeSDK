...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_GET_EASEINDURATION_OFFSET UNITYSDK_OFFSET(0xD048E10)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_GET_EASEOUTDURATION_OFFSET UNITYSDK_OFFSET(0xD048E30)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_METHOD_4_5892D030B127E82F_OFFSET UNITYSDK_OFFSET(0xD049100)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xD048E50)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD049090)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD049360)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_SET_EASEINDURATION_OFFSET UNITYSDK_OFFSET(0xD048E20)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR_SET_EASEOUTDURATION_OFFSET UNITYSDK_OFFSET(0xD048E40)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD049590)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xD0495D0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD0495F0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD049660)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int VignetteTimelineBehaviour_TypeDefinitionIndex = 45899;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTART_OFFSET))(this, a1);
		}

		::System::Void __iFixBaseProxy_OnGraphStop(::UnityEngine::Playables::Playable a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET))(this, a1);
		}

		::System::Void __iFixBaseProxy_ProcessFrame(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2, ::System::Object* a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData, ::System::Object*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET))(this, a1, a2, a3);
		}
	};
}
