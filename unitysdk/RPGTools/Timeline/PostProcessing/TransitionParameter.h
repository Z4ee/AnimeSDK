...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONPARAMETER_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xE4F50)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONPARAMETER_METHOD_2_A86D5792F2D697F7_OFFSET UNITYSDK_OFFSET(0xB906AF0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int TransitionParameter_TypeDefinitionIndex = 45336;
