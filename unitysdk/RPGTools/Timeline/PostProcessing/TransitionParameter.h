...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONPARAMETER_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x39E6820)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONPARAMETER_METHOD_2_A86D5792F2D697F7_OFFSET UNITYSDK_OFFSET(0x199A82D0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int TransitionParameter_TypeDefinitionIndex = 46832;
