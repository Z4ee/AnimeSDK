...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONPARAMETER_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x3B78470)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_TRANSITIONPARAMETER_METHOD_2_A86D5792F2D697F7_OFFSET UNITYSDK_OFFSET(0x1B0B45F0)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int TransitionParameter_TypeDefinitionIndex = 49078;
