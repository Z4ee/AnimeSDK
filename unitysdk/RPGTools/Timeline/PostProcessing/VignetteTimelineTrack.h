...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0B6C70)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B0B6520)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_VIGNETTETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B6D20)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int VignetteTimelineTrack_TypeDefinitionIndex = 49086;
