...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_2D14439CE3AB3ED3_OFFSET UNITYSDK_OFFSET(0x1B0A8B10)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_87FD5195E34BA98F_OFFSET UNITYSDK_OFFSET(0x3B77DE0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x3B77D90)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int DOFParameter_TypeDefinitionIndex = 49015;
	...
	struct alignas(4) DOFParameter
	{
		...
		::System::Void Method_2_87FD5195E34BA98F(::RPG::CustomRP::RPGDepthOfField* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::CustomRP::RPGDepthOfField*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_87FD5195E34BA98F_OFFSET))(this, a1);
		}

		static ::RPGTools::Timeline::PostProcessing::DOFParameter Method_2_2D14439CE3AB3ED3(::RPG::CustomRP::RPGDepthOfField* a1)
		{
			return ((::RPGTools::Timeline::PostProcessing::DOFParameter(*)(::RPG::CustomRP::RPGDepthOfField*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_2D14439CE3AB3ED3_OFFSET))(a1);
		}
	};
}
