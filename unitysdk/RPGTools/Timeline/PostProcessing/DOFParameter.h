...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_08B71824168C8C01_OFFSET UNITYSDK_OFFSET(0xB8FD640)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_B18EA9401F533EFA_OFFSET UNITYSDK_OFFSET(0xE48C0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_DOFPARAMETER_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE4870)

namespace RPGTools::Timeline::PostProcessing
{
	inline static constexpr unsigned int DOFParameter_TypeDefinitionIndex = 45273;
