...
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B59A9A0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B59ABA0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x1B59A950)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59ABB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LightControlClip_TypeDefinitionIndex = 48896;
