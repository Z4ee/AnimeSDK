...
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE86BDD0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE86BFD0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xE86BD80)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE86BFE0)
