...
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A67D00)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A67F00)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x19A67CB0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A67F10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LightControlClip_TypeDefinitionIndex = 46651;
