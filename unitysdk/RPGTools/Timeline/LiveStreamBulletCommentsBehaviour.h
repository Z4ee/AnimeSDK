...
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x19A68C70)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19A68C90)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x19A68C80)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A68D30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamBulletCommentsBehaviour_TypeDefinitionIndex = 46397;
