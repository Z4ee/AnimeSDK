...
#define RPGTOOLS_TIMELINE_CUSTOMEVENTCLIP_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A35480)
#define RPGTOOLS_TIMELINE_CUSTOMEVENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A35490)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CustomEventClip_TypeDefinitionIndex = 46608;
