...
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x19A3C780)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLBEHAVIOUR_METHOD_2_C701845A47AEF344_OFFSET UNITYSDK_OFFSET(0x19A3C8B0)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19A3C7A0)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x19A3C790)
#define RPGTOOLS_TIMELINE_EMOANIMLAYEREMOTIONFULLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3CBB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoAnimLayerEmotionFullBehaviour_TypeDefinitionIndex = 46317;
