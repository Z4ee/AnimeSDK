...
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A601C0)
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A601B0)
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A60380)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideTalkRecordingDialogClip_TypeDefinitionIndex = 46503;
