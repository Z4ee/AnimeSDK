...
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD024CD0)
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD024CC0)
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD024E90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideTalkRecordingDialogClip_TypeDefinitionIndex = 45569;
