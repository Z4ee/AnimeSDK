...
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB6E290)
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB6E280)
#define RPGTOOLS_TIMELINE_HIDETALKRECORDINGDIALOGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6E480)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideTalkRecordingDialogClip_TypeDefinitionIndex = 39118;
