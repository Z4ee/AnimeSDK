...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFFD080)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFFD070)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFD210)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineClip_TypeDefinitionIndex = 45355;
