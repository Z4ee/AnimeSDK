...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D14B9B0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D14B9A0)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14BB40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineClip_TypeDefinitionIndex = 48513;
