...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE838F50)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE838F40)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8390E0)
