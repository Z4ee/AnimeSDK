...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A34F80)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A34F70)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A35110)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineClip_TypeDefinitionIndex = 46279;
