...
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B9D20)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8B9D10)
#define RPGTOOLS_TIMELINE_CONVINCESPLITLINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B9F10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceSplitLineClip_TypeDefinitionIndex = 44808;
