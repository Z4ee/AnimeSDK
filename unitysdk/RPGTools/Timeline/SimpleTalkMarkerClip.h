...
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B7620)
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x199B7610)
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x199B77A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SimpleTalkMarkerClip_TypeDefinitionIndex = 46457;
