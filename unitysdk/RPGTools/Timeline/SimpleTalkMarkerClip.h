...
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD056950)
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD056940)
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD056AD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SimpleTalkMarkerClip_TypeDefinitionIndex = 45523;
