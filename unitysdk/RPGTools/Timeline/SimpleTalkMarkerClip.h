...
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9161B0)
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB9161A0)
#define RPGTOOLS_TIMELINE_SIMPLETALKMARKERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9163A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SimpleTalkMarkerClip_TypeDefinitionIndex = 44975;
