...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8F5E30)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8F60C0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8F5DF0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0xB8F6080)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F60D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlaySimpleTalkClip_TypeDefinitionIndex = 44966;
