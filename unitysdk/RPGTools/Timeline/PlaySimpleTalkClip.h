...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0379A0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD037BD0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD037960)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0xD037B90)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD037BE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlaySimpleTalkClip_TypeDefinitionIndex = 45514;
