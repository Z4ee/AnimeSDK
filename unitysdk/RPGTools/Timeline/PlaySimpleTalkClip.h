...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B09F6D0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B09F900)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B09F690)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0x1B09F8C0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09F910)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlaySimpleTalkClip_TypeDefinitionIndex = 48683;
