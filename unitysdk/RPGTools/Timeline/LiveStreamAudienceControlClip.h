...
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A68800)
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A687F0)
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A68990)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamAudienceControlClip_TypeDefinitionIndex = 46390;
