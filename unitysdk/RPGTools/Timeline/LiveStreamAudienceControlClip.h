...
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD02B0F0)
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD02B0E0)
#define RPGTOOLS_TIMELINE_LIVESTREAMAUDIENCECONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD02B280)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamAudienceControlClip_TypeDefinitionIndex = 45456;
