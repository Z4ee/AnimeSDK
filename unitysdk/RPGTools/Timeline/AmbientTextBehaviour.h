...
#define RPGTOOLS_TIMELINE_AMBIENTTEXTBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B52BBE0)
#define RPGTOOLS_TIMELINE_AMBIENTTEXTBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B52BC00)
#define RPGTOOLS_TIMELINE_AMBIENTTEXTBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B52BBF0)
#define RPGTOOLS_TIMELINE_AMBIENTTEXTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52BCA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AmbientTextBehaviour_TypeDefinitionIndex = 48306;
