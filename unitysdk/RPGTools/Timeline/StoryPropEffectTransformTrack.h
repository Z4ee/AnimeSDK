...
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F4DA90)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19F4D940)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19F4DB90)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4DC00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryPropEffectTransformTrack_TypeDefinitionIndex = 46566;
