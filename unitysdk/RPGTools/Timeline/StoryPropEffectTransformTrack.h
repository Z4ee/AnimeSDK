...
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8EFA30)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE8EF8B0)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xE8EFB70)
#define RPGTOOLS_TIMELINE_STORYPROPEFFECTTRANSFORMTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE8EFBE0)
