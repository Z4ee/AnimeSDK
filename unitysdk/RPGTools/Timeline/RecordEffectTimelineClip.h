...
#define RPGTOOLS_TIMELINE_RECORDEFFECTTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B0BA9A0)
#define RPGTOOLS_TIMELINE_RECORDEFFECTTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B0BA990)
#define RPGTOOLS_TIMELINE_RECORDEFFECTTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BAA90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int RecordEffectTimelineClip_TypeDefinitionIndex = 48929;
