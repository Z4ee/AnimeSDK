...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTOPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B35F420)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTOPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B35F580)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTOPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35F590)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveStopClip_TypeDefinitionIndex = 46243;
