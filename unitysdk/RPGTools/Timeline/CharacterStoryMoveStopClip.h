...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTOPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8B3D70)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTOPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8B3F30)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTOPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B3F40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveStopClip_TypeDefinitionIndex = 44772;
