...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5E060)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5E1A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5E300)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5E3E0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5E420)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoDiscussionMouthTrack_TypeDefinitionIndex = 39539;
	...
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK__CTOR_OFFSET))(this);
		}

		::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph a1, ::UnityEngine::GameObject* a2, ::UnityEngine::Timeline::TimelineClip* a3)
		{
			return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*, ::UnityEngine::Timeline::TimelineClip*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONMOUTHTRACK_CREATEPLAYABLE_OFFSET))(this, a1, a2, a3);
		}
