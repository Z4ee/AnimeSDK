...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYEBLOOMBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB56170)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYEBLOOMBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB56190)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYEBLOOMBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xAB56180)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYEBLOOMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB563F0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYEBLOOMBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB56400)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionEyeBloomBehaviour_TypeDefinitionIndex = 39496;
