...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD00F420)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD00F410)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD00F5B0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionFaceExpressionClip_TypeDefinitionIndex = 45995;
