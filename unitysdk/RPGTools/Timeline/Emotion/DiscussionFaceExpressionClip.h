...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8CCDD0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8CCDC0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CCFC0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionFaceExpressionClip_TypeDefinitionIndex = 45412;
