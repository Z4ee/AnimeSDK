...
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CAF20)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int BaseEmoTrack_TypeDefinitionIndex = 45403;
