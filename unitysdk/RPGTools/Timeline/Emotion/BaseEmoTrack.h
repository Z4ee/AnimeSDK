...
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B578BE0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int BaseEmoTrack_TypeDefinitionIndex = 49171;
