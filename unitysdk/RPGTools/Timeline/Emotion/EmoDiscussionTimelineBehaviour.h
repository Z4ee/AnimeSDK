...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINEBEHAVIOUR_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xE8509B0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xE850B30)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE8509D0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINEBEHAVIOUR_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xE8509C0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE850BB0)
