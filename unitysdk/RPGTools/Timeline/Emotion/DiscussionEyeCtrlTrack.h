...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB578E0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB57700)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB57A20)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB57BA0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB57B00)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionEyeCtrlTrack_TypeDefinitionIndex = 39501;
