...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A475A0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A47420)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A476E0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionEyeCtrlTrack_TypeDefinitionIndex = 46932;
