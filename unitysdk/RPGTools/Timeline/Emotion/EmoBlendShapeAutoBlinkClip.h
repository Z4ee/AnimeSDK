...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOBLINKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB587E0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOBLINKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB58B30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOBLINKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB58B40)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeAutoBlinkClip_TypeDefinitionIndex = 39508;
