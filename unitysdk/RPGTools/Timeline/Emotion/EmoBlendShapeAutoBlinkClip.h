...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOBLINKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A480A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOBLINKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A483A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOBLINKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A483B0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeAutoBlinkClip_TypeDefinitionIndex = 46939;
