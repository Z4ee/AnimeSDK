...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5E700)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB5E6F0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5E8D0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoDiscussionTimelineClip_TypeDefinitionIndex = 39541;
