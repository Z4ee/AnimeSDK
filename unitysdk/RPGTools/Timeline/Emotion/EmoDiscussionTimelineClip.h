...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD015150)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD015140)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0152C0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoDiscussionTimelineClip_TypeDefinitionIndex = 46033;
