...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B57F7A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B57F790)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONTIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57F910)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoDiscussionTimelineClip_TypeDefinitionIndex = 49218;
