...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xD00E1F0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_METHOD_2_5329A39CC7215E7B_OFFSET UNITYSDK_OFFSET(0xD00E660)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_METHOD_2_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xD00E760)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD00EA80)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD00E210)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD00E960)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xD00E200)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD00EB20)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD00EB50)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD00EB30)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD00EB40)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionEyeCtrlBehaviour_TypeDefinitionIndex = 45992;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_ProcessFrame(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2, ::System::Object* a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData, ::System::Object*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET))(this, a1, a2, a3);
		}

		::System::Void __iFixBaseProxy_OnBehaviourPause(::UnityEngine::Playables::Playable a1, ::UnityEngine::Playables::FrameData a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONEYECTRLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET))(this, a1, a2);
		}
	};
}
