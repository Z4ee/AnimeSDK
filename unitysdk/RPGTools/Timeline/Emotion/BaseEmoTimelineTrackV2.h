...
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xAB52480)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_CREATELAYERMIXER_OFFSET UNITYSDK_OFFSET(0xAB53EA0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB52A30)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0xAB521D0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_DEFAULTCLIP_OFFSET UNITYSDK_OFFSET(0xAB52220)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_MONOEMOPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xAB520F0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0xAB522F0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_TRACKTYPE_OFFSET UNITYSDK_OFFSET(0xAB52210)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xAB521F0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET__FINALANIMLAYERMIXER_OFFSET UNITYSDK_OFFSET(0xAB53C70)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_135C4934B2227080_OFFSET UNITYSDK_OFFSET(0xAB547E0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xAB522B0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_599F562C167DA44B_OFFSET UNITYSDK_OFFSET(0xAB55140)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_74588BEDD66375BF_OFFSET UNITYSDK_OFFSET(0xAB52330)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_8143B69953D09724_OFFSET UNITYSDK_OFFSET(0xAB54DA0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_9E4B9CA8FDF2FCBA_OFFSET UNITYSDK_OFFSET(0xAB52660)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_BB08A9D2DE9BCA34_OFFSET UNITYSDK_OFFSET(0xAB52260)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_D69A37A91B336CE9_OFFSET UNITYSDK_OFFSET(0xAB55E80)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB53D60)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_SET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0xAB521E0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xAB52200)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_SET__FINALANIMLAYERMIXER_OFFSET UNITYSDK_OFFSET(0xAB546F0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_UNITYENGINE_TIMELINE_ILAYERABLE_SHOWDEFAULTLAYEREDTRACKCOMMANDS_OFFSET UNITYSDK_OFFSET(0xAB547A0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2__CTOR_OFFSET UNITYSDK_OFFSET(0xAB55EE0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2___IFIXBASEPROXY_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xAB560B0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB560C0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB56160)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int BaseEmoTimelineTrackV2_TypeDefinitionIndex = 39521;
