...
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xE846F80)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_CREATELAYERMIXER_OFFSET UNITYSDK_OFFSET(0xE848060)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE847340)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0xE846D40)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_DEFAULTCLIP_OFFSET UNITYSDK_OFFSET(0xE846D90)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_MONOEMOPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xE846C50)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0xE846E60)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_TRACKTYPE_OFFSET UNITYSDK_OFFSET(0xE846D80)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xE846D60)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_GET__FINALANIMLAYERMIXER_OFFSET UNITYSDK_OFFSET(0xE847E20)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_1ECD2F1A689739A1_OFFSET UNITYSDK_OFFSET(0xE848E60)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE846E20)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_B16AF638490AB7B0_OFFSET UNITYSDK_OFFSET(0xE8491F0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_BB08A9D2DE9BCA34_OFFSET UNITYSDK_OFFSET(0xE846DD0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_C7959CA0476B8CD6_OFFSET UNITYSDK_OFFSET(0xE849FB0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_E822FF084339B7A4_OFFSET UNITYSDK_OFFSET(0xE846EA0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_EC3D8044F820B408_OFFSET UNITYSDK_OFFSET(0xE8470A0)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_METHOD_7_F1C7356344F3059E_OFFSET UNITYSDK_OFFSET(0xE848760)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xE847F20)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_SET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0xE846D50)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xE846D70)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_SET__FINALANIMLAYERMIXER_OFFSET UNITYSDK_OFFSET(0xE848660)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2_UNITYENGINE_TIMELINE_ILAYERABLE_SHOWDEFAULTLAYEREDTRACKCOMMANDS_OFFSET UNITYSDK_OFFSET(0xE848720)
#define RPGTOOLS_TIMELINE_EMOTION_BASEEMOTIMELINETRACKV2__CTOR_OFFSET UNITYSDK_OFFSET(0xE84A010)
