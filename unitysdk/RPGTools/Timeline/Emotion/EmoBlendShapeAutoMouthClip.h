...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A48910)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A48C10)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A48C20)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeAutoMouthClip_TypeDefinitionIndex = 46942;
