...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB590E0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB59440)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB59450)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeAutoMouthClip_TypeDefinitionIndex = 39511;
