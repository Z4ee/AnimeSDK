...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHBEHAVIOURMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB59D50)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHBEHAVIOURMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB59DE0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHBEHAVIOURMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB59DF0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeMouthBehaviourMixer_TypeDefinitionIndex = 39526;
