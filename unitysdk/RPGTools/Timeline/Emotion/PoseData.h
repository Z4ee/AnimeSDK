...
#define RPGTOOLS_TIMELINE_EMOTION_POSEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B582020)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int PoseData_TypeDefinitionIndex = 49195;
