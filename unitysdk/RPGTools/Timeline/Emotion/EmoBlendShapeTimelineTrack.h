...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xAB5B660)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5BA50)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5BCB0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xAB5B580)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xAB5B570)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_METHOD_7_2776DE49AA80CEE7_OFFSET UNITYSDK_OFFSET(0xAB5B760)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5BF60)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK___IFIXBASEPROXY_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xAB5C040)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5C050)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5C090)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeTimelineTrack_TypeDefinitionIndex = 39529;
