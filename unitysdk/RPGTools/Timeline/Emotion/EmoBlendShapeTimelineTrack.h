...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0x19A4A910)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A4AD10)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A4AE30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x19A4A820)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x19A4A810)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_METHOD_7_2776DE49AA80CEE7_OFFSET UNITYSDK_OFFSET(0x19A4AA10)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4AFB0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeTimelineTrack_TypeDefinitionIndex = 46960;
