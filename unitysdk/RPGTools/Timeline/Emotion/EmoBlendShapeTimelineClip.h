...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A4A3D0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A4A760)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_METHOD_4_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x19A4A330)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4A770)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeTimelineClip_TypeDefinitionIndex = 46945;
