...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8CFFB0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8D03A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_METHOD_4_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xB8CFF30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8D03B0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeTimelineClip_TypeDefinitionIndex = 45423;
