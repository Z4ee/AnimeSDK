...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B57CF80)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B57D310)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_METHOD_4_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1B57CEE0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57D320)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeTimelineClip_TypeDefinitionIndex = 49191;
