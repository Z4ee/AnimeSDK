...
#define RPGTOOLS_TIMELINE_EMOTION_EMOFACEBLUSHERTIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A4E370)
#define RPGTOOLS_TIMELINE_EMOTION_EMOFACEBLUSHERTIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x19A4E360)
#define RPGTOOLS_TIMELINE_EMOTION_EMOFACEBLUSHERTIMELINETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19A4E4C0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOFACEBLUSHERTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4E5C0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoFaceBlusherTimelineTrack_TypeDefinitionIndex = 46986;
