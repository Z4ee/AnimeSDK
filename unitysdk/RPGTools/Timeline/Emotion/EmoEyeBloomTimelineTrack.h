...
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5ED70)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xAB5ED60)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB5EF20)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5F010)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5F0F0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB5F190)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoEyeBloomTimelineTrack_TypeDefinitionIndex = 39554;
