...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBAKEDPOSEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD00FAE0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBAKEDPOSEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD00FAD0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBakedPoseData_TypeDefinitionIndex = 46016;
	...
	public:
		...
		{
			return (::UnityEngine::AnimationCurve**)Il2CppClass::FromTypeDefinitionIndex(EmoBakedPoseData_TypeDefinitionIndex)->GetStaticField(0x89F0);
		}
