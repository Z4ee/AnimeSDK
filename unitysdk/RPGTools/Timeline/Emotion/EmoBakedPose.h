...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBAKEDPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CD530)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBakedPose_TypeDefinitionIndex = 45432;
