...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B57A770)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B57A5F0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B57A8B0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57A920)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionFaceExpressionTrack_TypeDefinitionIndex = 49182;
