...
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB58300)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB58120)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB58440)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB584B0)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB58630)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB58590)
#define RPGTOOLS_TIMELINE_EMOTION_DISCUSSIONFACEEXPRESSIONTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xAB58670)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int DiscussionFaceExpressionTrack_TypeDefinitionIndex = 39505;
