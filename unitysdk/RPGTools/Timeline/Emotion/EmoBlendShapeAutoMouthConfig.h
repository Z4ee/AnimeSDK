...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0xE84C530)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_METHOD_1_07EB81D91557654A_OFFSET UNITYSDK_OFFSET(0xE84CC20)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_METHOD_1_701B232B239695EF_OFFSET UNITYSDK_OFFSET(0xE84CDD0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_METHOD_1_C0F35A31FAC15CA9_OFFSET UNITYSDK_OFFSET(0xE84C590)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_METHOD_1_D450AEAD37089609_OFFSET UNITYSDK_OFFSET(0xE84CE20)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE84CC10)
