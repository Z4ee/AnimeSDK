...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xE84D610)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE84D950)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE84DA60)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xE84D520)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xE84D510)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_METHOD_7_1D3E0D19D91C431C_OFFSET UNITYSDK_OFFSET(0xE84D710)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE84DBE0)
