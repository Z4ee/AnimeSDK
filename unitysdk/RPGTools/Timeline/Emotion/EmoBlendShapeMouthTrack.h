...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xAB59EF0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5A230)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5A420)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xAB59E10)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xAB59E00)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_METHOD_7_1D3E0D19D91C431C_OFFSET UNITYSDK_OFFSET(0xAB59FF0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5A6D0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK___IFIXBASEPROXY_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xAB5A7B0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5A7C0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xAB5A800)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeMouthTrack_TypeDefinitionIndex = 39527;
