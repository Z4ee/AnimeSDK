...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0x19A49560)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A498A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A499B0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x19A49470)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x19A49460)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_METHOD_7_1D3E0D19D91C431C_OFFSET UNITYSDK_OFFSET(0x19A49660)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A49B30)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeMouthTrack_TypeDefinitionIndex = 46958;
