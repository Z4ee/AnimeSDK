...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONBLENDSHAPECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD013A90)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONBLENDSHAPECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD013A80)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONBLENDSHAPECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD013C00)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoDiscussionBlendShapeClip_TypeDefinitionIndex = 46023;
