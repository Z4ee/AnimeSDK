...
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONBLENDSHAPECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB5CEB0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONBLENDSHAPECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB5CEA0)
#define RPGTOOLS_TIMELINE_EMOTION_EMODISCUSSIONBLENDSHAPECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5D080)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoDiscussionBlendShapeClip_TypeDefinitionIndex = 39531;
