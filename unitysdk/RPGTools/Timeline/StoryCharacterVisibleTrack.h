...
#define RPGTOOLS_TIMELINE_STORYCHARACTERVISIBLETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B8FC0)
#define RPGTOOLS_TIMELINE_STORYCHARACTERVISIBLETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x199B90C0)
#define RPGTOOLS_TIMELINE_STORYCHARACTERVISIBLETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199B9130)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryCharacterVisibleTrack_TypeDefinitionIndex = 46540;
