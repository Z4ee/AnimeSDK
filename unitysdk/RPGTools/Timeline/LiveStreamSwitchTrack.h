...
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A699C0)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19A69B40)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A69BB0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSwitchTrack_TypeDefinitionIndex = 46408;
