...
#define RPGTOOLS_TIMELINE_IDLELIVEADDGIFTTOSHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD0261C0)
#define RPGTOOLS_TIMELINE_IDLELIVEADDGIFTTOSHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD0262B0)
#define RPGTOOLS_TIMELINE_IDLELIVEADDGIFTTOSHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0262C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int IdleLiveAddGiftToShowClip_TypeDefinitionIndex = 45109;
