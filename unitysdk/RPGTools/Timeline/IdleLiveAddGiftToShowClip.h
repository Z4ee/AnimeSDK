...
#define RPGTOOLS_TIMELINE_IDLELIVEADDGIFTTOSHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE865870)
#define RPGTOOLS_TIMELINE_IDLELIVEADDGIFTTOSHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE865960)
#define RPGTOOLS_TIMELINE_IDLELIVEADDGIFTTOSHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE865970)
