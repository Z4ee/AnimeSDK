...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTARTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B35F250)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTARTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B35F3B0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTARTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35F3C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveStartClip_TypeDefinitionIndex = 46240;
