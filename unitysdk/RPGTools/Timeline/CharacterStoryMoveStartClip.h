...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTARTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFF6B00)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTARTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFF6C60)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVESTARTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF6C70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStoryMoveStartClip_TypeDefinitionIndex = 45316;
