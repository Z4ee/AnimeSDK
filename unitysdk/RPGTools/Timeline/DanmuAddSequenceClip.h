...
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A363A0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A36390)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A36530)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int DanmuAddSequenceClip_TypeDefinitionIndex = 46287;
