...
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE83A280)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xE83A270)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE83A410)
