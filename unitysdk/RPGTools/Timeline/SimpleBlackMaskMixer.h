...
#define RPGTOOLS_TIMELINE_SIMPLEBLACKMASKMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0562B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SimpleBlackMaskMixer_TypeDefinitionIndex = 45591;
