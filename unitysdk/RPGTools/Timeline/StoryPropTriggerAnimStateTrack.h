...
#define RPGTOOLS_TIMELINE_STORYPROPTRIGGERANIMSTATETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xE8F1420)
#define RPGTOOLS_TIMELINE_STORYPROPTRIGGERANIMSTATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE8F1520)
