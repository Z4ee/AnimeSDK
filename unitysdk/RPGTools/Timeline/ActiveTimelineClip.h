...
#define RPGTOOLS_TIMELINE_ACTIVETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19D6A3F0)
#define RPGTOOLS_TIMELINE_ACTIVETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19D6A3E0)
#define RPGTOOLS_TIMELINE_ACTIVETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6A4E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ActiveTimelineClip_TypeDefinitionIndex = 46022;
