...
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_2439B52C953E2E46_OFFSET UNITYSDK_OFFSET(0xAB4A6B0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xAB4A020)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xAB4A910)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB4A600)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB49F90)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB4A0B0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB4A8D0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xAB4A900)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB4A8E0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB4A8F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EffectLightControlBehaviour_TypeDefinitionIndex = 38997;
