...
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x19A3AD60)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x19A3A550)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x19A3ACB0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x19A3A4C0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19A3A5E0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3AFF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EffectLightControlBehaviour_TypeDefinitionIndex = 46382;
