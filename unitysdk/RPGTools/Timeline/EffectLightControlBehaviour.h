...
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xE83EC90)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xE83E480)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xE83EBE0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE83E3F0)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE83E510)
#define RPGTOOLS_TIMELINE_EFFECTLIGHTCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE83EF20)
