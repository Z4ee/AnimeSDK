...
#define RPGTOOLS_TIMELINE_LIGHTPARAMETER_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1493E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LightParameter_TypeDefinitionIndex = 45709;
