...
#define RPGTOOLS_TIMELINE_LIFECYCLEEVENTARGUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD026890)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LifeCycleEventArgument_TypeDefinitionIndex = 45444;
