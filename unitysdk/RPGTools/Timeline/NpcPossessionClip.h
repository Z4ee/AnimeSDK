...
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB7C010)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB7BFE0)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_GET_TRACKINSTANCEID_OFFSET UNITYSDK_OFFSET(0xAB7BFF0)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_METHOD_4_6C88CD2F7D698314_OFFSET UNITYSDK_OFFSET(0xAB7C1D0)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_METHOD_4_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xAB7C210)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_SET_TRACKINSTANCEID_OFFSET UNITYSDK_OFFSET(0xAB7C000)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7C260)
