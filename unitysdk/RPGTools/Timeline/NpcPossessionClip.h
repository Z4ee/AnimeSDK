...
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1998E240)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1998E210)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_GET_TRACKINSTANCEID_OFFSET UNITYSDK_OFFSET(0x1998E220)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_METHOD_4_6C88CD2F7D698314_OFFSET UNITYSDK_OFFSET(0x1998E3D0)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_METHOD_4_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x1998E410)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP_SET_TRACKINSTANCEID_OFFSET UNITYSDK_OFFSET(0x1998E230)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1998E460)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NpcPossessionClip_TypeDefinitionIndex = 46436;
