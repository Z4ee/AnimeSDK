...
#define RPGTOOLS_TIMELINE_HIDEPROMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB6BC80)
#define RPGTOOLS_TIMELINE_HIDEPROMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6C230)
#define RPGTOOLS_TIMELINE_HIDEPROMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB6C240)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideProMixer_TypeDefinitionIndex = 38970;
