...
#define RPGTOOLS_TIMELINE_EMOJIBUBBLEBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B574880)
#define RPGTOOLS_TIMELINE_EMOJIBUBBLEBEHAVIOUR_METHOD_2_525399CADFF973AB_OFFSET UNITYSDK_OFFSET(0x1B574DB0)
#define RPGTOOLS_TIMELINE_EMOJIBUBBLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B5748A0)
#define RPGTOOLS_TIMELINE_EMOJIBUBBLEBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B574890)
#define RPGTOOLS_TIMELINE_EMOJIBUBBLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B575240)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmojiBubbleBehaviour_TypeDefinitionIndex = 48557;
