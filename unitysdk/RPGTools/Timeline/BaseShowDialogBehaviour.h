...
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_GET_UILUAPATH_OFFSET UNITYSDK_OFFSET(0x1D12A310)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_GET_UINAME_OFFSET UNITYSDK_OFFSET(0x1D12A330)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_GET_UIPARAM_OFFSET UNITYSDK_OFFSET(0x1D12A350)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D12A370)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_SET_UILUAPATH_OFFSET UNITYSDK_OFFSET(0x1D12A320)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_SET_UINAME_OFFSET UNITYSDK_OFFSET(0x1D12A340)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_SET_UIPARAM_OFFSET UNITYSDK_OFFSET(0x1D12A360)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D12A500)
