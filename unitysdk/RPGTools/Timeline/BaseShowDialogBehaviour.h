...
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_GET_UILUAPATH_OFFSET UNITYSDK_OFFSET(0xAB24B40)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_GET_UINAME_OFFSET UNITYSDK_OFFSET(0xAB24B60)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_GET_UIPARAM_OFFSET UNITYSDK_OFFSET(0xAB24B80)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB24BA0)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_SET_UILUAPATH_OFFSET UNITYSDK_OFFSET(0xAB24B50)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_SET_UINAME_OFFSET UNITYSDK_OFFSET(0xAB24B70)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR_SET_UIPARAM_OFFSET UNITYSDK_OFFSET(0xAB24B90)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB24D40)
#define RPGTOOLS_TIMELINE_BASESHOWDIALOGBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xAB24D50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BaseShowDialogBehaviour_TypeDefinitionIndex = 39123;
