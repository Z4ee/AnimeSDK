...
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B355630)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B355720)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B355730)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDirectDissolveClip_TypeDefinitionIndex = 46175;
