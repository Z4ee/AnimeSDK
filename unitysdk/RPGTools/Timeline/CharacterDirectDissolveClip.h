...
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFECB50)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFECC40)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFECC50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDirectDissolveClip_TypeDefinitionIndex = 45251;
