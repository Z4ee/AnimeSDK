...
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB34FC0)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB35110)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB35120)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDirectDissolveClip_TypeDefinitionIndex = 38805;
