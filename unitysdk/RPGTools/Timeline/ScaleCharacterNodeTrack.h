...
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x199B0000)
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x199AFEC0)
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x199AFF90)
#define RPGTOOLS_TIMELINE_SCALECHARACTERNODETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199B0100)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ScaleCharacterNodeTrack_TypeDefinitionIndex = 46494;
