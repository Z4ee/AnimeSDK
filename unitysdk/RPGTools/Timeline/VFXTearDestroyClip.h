...
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABB7F60)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xABB7F50)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xABB8150)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VFXTearDestroyClip_TypeDefinitionIndex = 38929;
