...
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BF3A3B0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BF3A3A0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF3A540)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VFXTearDestroyClip_TypeDefinitionIndex = 48542;
