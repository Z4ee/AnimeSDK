...
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB92D6F0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB92D6E0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB92D8E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VFXTearDestroyClip_TypeDefinitionIndex = 44832;
