...
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD071CE0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD071CD0)
#define RPGTOOLS_TIMELINE_VFXTEARDESTROYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD071E70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int VFXTearDestroyClip_TypeDefinitionIndex = 45379;
