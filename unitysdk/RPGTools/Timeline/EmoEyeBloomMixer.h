...
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_METHOD_2_49B17BDAFA3D54D9_OFFSET UNITYSDK_OFFSET(0x19A3D730)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_METHOD_2_7C95720B8B9EAE7D_OFFSET UNITYSDK_OFFSET(0x19A3DD30)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_METHOD_2_823FA1EEB61BCA73_OFFSET UNITYSDK_OFFSET(0x19A3E080)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19A3D0F0)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3E210)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeBloomMixer_TypeDefinitionIndex = 46338;
