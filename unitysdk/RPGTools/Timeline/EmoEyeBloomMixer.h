...
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_METHOD_2_49B17BDAFA3D54D9_OFFSET UNITYSDK_OFFSET(0xAB4CCB0)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_METHOD_2_7C95720B8B9EAE7D_OFFSET UNITYSDK_OFFSET(0xAB4D2C0)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_METHOD_2_823FA1EEB61BCA73_OFFSET UNITYSDK_OFFSET(0xAB4D610)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB4C5C0)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB4D7A0)
#define RPGTOOLS_TIMELINE_EMOEYEBLOOMMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xAB4D7B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeBloomMixer_TypeDefinitionIndex = 38949;
