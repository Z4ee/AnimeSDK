...
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B582450)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B582350)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B582590)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B582600)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EnableStandByBreakTrack_TypeDefinitionIndex = 48564;
