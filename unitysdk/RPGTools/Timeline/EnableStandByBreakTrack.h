...
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A4FE20)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19A4FD20)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x19A4FF60)
#define RPGTOOLS_TIMELINE_ENABLESTANDBYBREAKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4FFD0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EnableStandByBreakTrack_TypeDefinitionIndex = 46329;
