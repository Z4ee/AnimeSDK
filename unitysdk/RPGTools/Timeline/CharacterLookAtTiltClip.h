...
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B359040)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B3591B0)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3591C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterLookAtTiltClip_TypeDefinitionIndex = 46205;
