...
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB38630)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB38800)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB38810)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterLookAtTiltClip_TypeDefinitionIndex = 38831;
