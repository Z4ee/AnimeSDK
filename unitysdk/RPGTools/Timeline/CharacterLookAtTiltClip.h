...
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8AD200)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8AD3D0)
#define RPGTOOLS_TIMELINE_CHARACTERLOOKATTILTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AD3E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterLookAtTiltClip_TypeDefinitionIndex = 44734;
