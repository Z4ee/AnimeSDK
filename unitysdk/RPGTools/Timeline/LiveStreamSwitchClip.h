...
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB75A30)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB75A20)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB75BF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSwitchClip_TypeDefinitionIndex = 39021;
