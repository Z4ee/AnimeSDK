...
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B59C4D0)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B59C4C0)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59C660)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSwitchClip_TypeDefinitionIndex = 48641;
