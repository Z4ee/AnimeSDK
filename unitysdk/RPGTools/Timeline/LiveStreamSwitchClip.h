...
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD02C350)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD02C340)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD02C4E0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamSwitchClip_TypeDefinitionIndex = 45472;
