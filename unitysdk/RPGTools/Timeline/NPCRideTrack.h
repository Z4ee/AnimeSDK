...
#define RPGTOOLS_TIMELINE_NPCRIDETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1998D600)
#define RPGTOOLS_TIMELINE_NPCRIDETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1998D4B0)
#define RPGTOOLS_TIMELINE_NPCRIDETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1998D740)
#define RPGTOOLS_TIMELINE_NPCRIDETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1998D7B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCRideTrack_TypeDefinitionIndex = 46430;
