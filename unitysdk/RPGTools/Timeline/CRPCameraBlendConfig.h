...
#define RPGTOOLS_TIMELINE_CRPCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB89FB00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBlendConfig_TypeDefinitionIndex = 44641;
