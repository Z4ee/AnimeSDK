...
#define RPGTOOLS_TIMELINE_CRPCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2BB60)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBlendConfig_TypeDefinitionIndex = 38742;
