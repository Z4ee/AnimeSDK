...
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMEBEHAVIOUR_METHOD_2_C47A6EBDAFAB8B19_OFFSET UNITYSDK_OFFSET(0xE80F7E0)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMEBEHAVIOUR_METHOD_2_E93F40BE377F5563_OFFSET UNITYSDK_OFFSET(0xE8123D0)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xE812750)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE812310)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xE8127D0)
#define RPGTOOLS_TIMELINE_ANIMATORSTATICFRAMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE812820)
