...
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTONANCHORDATA_METHOD_1_07E2EFC50BA85CEB_OFFSET UNITYSDK_OFFSET(0xE8F8F80)
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTONANCHORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE8F9040)
