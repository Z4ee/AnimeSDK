...
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTONANCHORDATA_METHOD_1_95D745151349AC1F_OFFSET UNITYSDK_OFFSET(0xABB15E0)
#define RPGTOOLS_TIMELINE_TRIGGEREFFECTONANCHORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABB16C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TriggerEffectOnAnchorData_TypeDefinitionIndex = 39162;
