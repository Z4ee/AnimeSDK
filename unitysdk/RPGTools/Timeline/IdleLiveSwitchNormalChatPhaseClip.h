...
#define RPGTOOLS_TIMELINE_IDLELIVESWITCHNORMALCHATPHASECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD026740)
#define RPGTOOLS_TIMELINE_IDLELIVESWITCHNORMALCHATPHASECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD026830)
#define RPGTOOLS_TIMELINE_IDLELIVESWITCHNORMALCHATPHASECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD026840)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int IdleLiveSwitchNormalChatPhaseClip_TypeDefinitionIndex = 45113;
