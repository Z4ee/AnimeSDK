...
#define RPGTOOLS_TIMELINE_IDLELIVESWITCHNORMALCHATPHASECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19A61D00)
#define RPGTOOLS_TIMELINE_IDLELIVESWITCHNORMALCHATPHASECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19A61DF0)
#define RPGTOOLS_TIMELINE_IDLELIVESWITCHNORMALCHATPHASECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A61E00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int IdleLiveSwitchNormalChatPhaseClip_TypeDefinitionIndex = 46031;
