...
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR_GET_TRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE8265A0)
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE8265C0)
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR_SET_TRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE8265B0)
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE8266F0)
