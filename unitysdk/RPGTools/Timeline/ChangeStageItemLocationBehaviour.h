...
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR_GET_TRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D138FB0)
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1D138FD0)
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR_SET_TRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D138FC0)
#define RPGTOOLS_TIMELINE_CHANGESTAGEITEMLOCATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D139100)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ChangeStageItemLocationBehaviour_TypeDefinitionIndex = 48381;
