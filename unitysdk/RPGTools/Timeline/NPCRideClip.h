...
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1998D330)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1998D320)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1998D490)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCRideClip_TypeDefinitionIndex = 46428;
