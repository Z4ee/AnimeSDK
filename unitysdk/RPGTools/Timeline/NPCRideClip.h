...
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8EF360)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8EF350)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8EF520)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCRideClip_TypeDefinitionIndex = 44946;
