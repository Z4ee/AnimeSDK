...
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD031150)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD031140)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0312B0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCRideClip_TypeDefinitionIndex = 45494;
