...
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB74D30)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB74D20)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB74EF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamBulletCommentsClip_TypeDefinitionIndex = 39011;
