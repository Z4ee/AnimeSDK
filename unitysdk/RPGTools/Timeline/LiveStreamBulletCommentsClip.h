...
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD02B700)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD02B6F0)
#define RPGTOOLS_TIMELINE_LIVESTREAMBULLETCOMMENTSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD02B890)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LiveStreamBulletCommentsClip_TypeDefinitionIndex = 45462;
