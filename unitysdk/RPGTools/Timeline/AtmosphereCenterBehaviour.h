...
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xE813990)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_METHOD_2_A5EAA5E1A08BAC94_OFFSET UNITYSDK_OFFSET(0xE813AA0)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_METHOD_2_E9D6A791F654E920_OFFSET UNITYSDK_OFFSET(0xE813CB0)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE8139B0)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xE8139A0)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE813FD0)
