...
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8A7C20)
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8A7DF0)
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A7E00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterAddLookAtCurveClip_TypeDefinitionIndex = 44725;
