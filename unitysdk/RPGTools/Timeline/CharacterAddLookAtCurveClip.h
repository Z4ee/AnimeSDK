...
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFEB5A0)
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFEB710)
#define RPGTOOLS_TIMELINE_CHARACTERADDLOOKATCURVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFEB720)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterAddLookAtCurveClip_TypeDefinitionIndex = 45272;
