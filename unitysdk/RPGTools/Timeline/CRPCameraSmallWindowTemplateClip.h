...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xAB2F4B0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xAB2F4A0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATECLIP_METHOD_4_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0xAB2F6A0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATECLIP_METHOD_4_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xAB2F430)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWTEMPLATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2F700)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowTemplateClip_TypeDefinitionIndex = 38759;
