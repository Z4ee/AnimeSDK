...
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLBEHAVIOUR_METHOD_2_444B74B8EC727ACC_OFFSET UNITYSDK_OFFSET(0x1B52D480)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B52DA20)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B52D310)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1B52D9D0)
#define RPGTOOLS_TIMELINE_ANIMATORCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52DAA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorControlBehaviour_TypeDefinitionIndex = 48309;
