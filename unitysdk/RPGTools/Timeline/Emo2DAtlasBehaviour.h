...
#define RPGTOOLS_TIMELINE_EMO2DATLASBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B56EC50)
#define RPGTOOLS_TIMELINE_EMO2DATLASBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B56EC70)
#define RPGTOOLS_TIMELINE_EMO2DATLASBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B56EC60)
#define RPGTOOLS_TIMELINE_EMO2DATLASBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56ED70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int Emo2DAtlasBehaviour_TypeDefinitionIndex = 48547;
