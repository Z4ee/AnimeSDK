...
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B354350)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B3544C0)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B3544D0)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLCLIP_UNITYENGINE_TIMELINE_ICUSTOMTIMELINECLIPGUI_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0x1B354530)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B354590)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterBodyControlClip_TypeDefinitionIndex = 46164;
