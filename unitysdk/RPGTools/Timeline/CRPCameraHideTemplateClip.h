...
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B34CBA0)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B34CB90)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34CD30)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraHideTemplateClip_TypeDefinitionIndex = 46115;
