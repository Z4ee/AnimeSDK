...
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCFE3E30)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xCFE3E20)
#define RPGTOOLS_TIMELINE_CRPCAMERAHIDETEMPLATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE3FC0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraHideTemplateClip_TypeDefinitionIndex = 45191;
