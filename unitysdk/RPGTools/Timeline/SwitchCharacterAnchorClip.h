...
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB91ED60)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB91EF20)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xB91EF30)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0xB91EFA0)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB91F010)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SwitchCharacterAnchorClip_TypeDefinitionIndex = 45093;
