...
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19F500D0)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19F50230)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_OVERRIDEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19F50240)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP_OVERRIDEDURATION_OFFSET UNITYSDK_OFFSET(0x19F502B0)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F50320)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SwitchCharacterAnchorClip_TypeDefinitionIndex = 46579;
