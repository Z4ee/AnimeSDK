...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_ACTIVECRP_OFFSET UNITYSDK_OFFSET(0x1B34E690)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0x1B34E120)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x1B34E460)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_METHOD_1_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0x1B34D8D0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B34E830)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34FCF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowSyncUIRect_TypeDefinitionIndex = 46124;
