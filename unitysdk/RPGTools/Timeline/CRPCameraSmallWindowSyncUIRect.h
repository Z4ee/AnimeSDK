...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_ACTIVECRP_OFFSET UNITYSDK_OFFSET(0xAB2DAC0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0xAB2D570)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0xAB2D8A0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_METHOD_1_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xAB2CD20)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB2DC60)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2F220)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowSyncUIRect_TypeDefinitionIndex = 38754;
