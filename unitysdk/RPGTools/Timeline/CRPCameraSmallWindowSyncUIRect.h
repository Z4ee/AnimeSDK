...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_ACTIVECRP_OFFSET UNITYSDK_OFFSET(0xE821EA0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0xE821930)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0xE821C70)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_METHOD_1_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xE8210E0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE822040)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWSYNCUIRECT__CTOR_OFFSET UNITYSDK_OFFSET(0xE823580)
