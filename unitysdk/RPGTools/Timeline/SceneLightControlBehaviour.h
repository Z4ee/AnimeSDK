...
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLBEHAVIOUR_METHOD_3_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x1B0BD820)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1B0BC670)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B0BD770)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B0BC5E0)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B0BC710)
#define RPGTOOLS_TIMELINE_SCENELIGHTCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BE2A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SceneLightControlBehaviour_TypeDefinitionIndex = 48620;
