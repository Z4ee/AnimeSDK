...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVE_CHARACTERSTORYMOVESEQUENCECONFIG_METHOD_3_20D49EF32D4513D5_OFFSET UNITYSDK_OFFSET(0xCFF3EE0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVE_CHARACTERSTORYMOVESEQUENCECONFIG_METHOD_3_736C85A2248DC1F8_OFFSET UNITYSDK_OFFSET(0xCFF3D70)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVE_CHARACTERSTORYMOVESEQUENCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF4050)

namespace RPGTools::Timeline::CharacterStoryMove
{
	inline static constexpr unsigned int CharacterStoryMoveSequenceConfig_TypeDefinitionIndex = 45982;
