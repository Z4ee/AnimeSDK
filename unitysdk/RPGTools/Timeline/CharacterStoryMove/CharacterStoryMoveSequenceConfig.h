...
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVE_CHARACTERSTORYMOVESEQUENCECONFIG_METHOD_3_20D49EF32D4513D5_OFFSET UNITYSDK_OFFSET(0x1B35C6D0)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVE_CHARACTERSTORYMOVESEQUENCECONFIG_METHOD_3_736C85A2248DC1F8_OFFSET UNITYSDK_OFFSET(0x1B35C560)
#define RPGTOOLS_TIMELINE_CHARACTERSTORYMOVE_CHARACTERSTORYMOVESEQUENCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35C840)

namespace RPGTools::Timeline::CharacterStoryMove
{
	inline static constexpr unsigned int CharacterStoryMoveSequenceConfig_TypeDefinitionIndex = 46921;
