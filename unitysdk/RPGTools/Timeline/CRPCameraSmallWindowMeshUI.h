...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x148AF0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0x13E040)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_MESH_OFFSET UNITYSDK_OFFSET(0x25CF0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_SWITCHDATA_OFFSET UNITYSDK_OFFSET(0x148BF0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x148A70)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET__WIDTHHEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x148B50)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x148D20)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_53101C986CC2F71A_OFFSET UNITYSDK_OFFSET(0x148D40)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x148D30)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_6828C34A483313B0_OFFSET UNITYSDK_OFFSET(0x148D60)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x148D50)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x148CC0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_AA972BE565DAF9E3_OFFSET UNITYSDK_OFFSET(0x148CB0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x148D70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowMeshUI_TypeDefinitionIndex = 45201;
