...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0xE32F0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0x73B30)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_MESH_OFFSET UNITYSDK_OFFSET(0x24F70)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_SWITCHDATA_OFFSET UNITYSDK_OFFSET(0xE33F0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0xE3270)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET__WIDTHHEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0xE3350)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xE3520)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_53101C986CC2F71A_OFFSET UNITYSDK_OFFSET(0xE3540)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0xE3530)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_6828C34A483313B0_OFFSET UNITYSDK_OFFSET(0xE3560)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0xE3550)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xE34C0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_AA972BE565DAF9E3_OFFSET UNITYSDK_OFFSET(0xE34B0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE3570)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowMeshUI_TypeDefinitionIndex = 44654;
