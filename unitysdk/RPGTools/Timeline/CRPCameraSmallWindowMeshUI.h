...
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x3A2E3D0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_CENTERPOINT_OFFSET UNITYSDK_OFFSET(0x38CBC60)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_MESH_OFFSET UNITYSDK_OFFSET(0xC390B0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_SWITCHDATA_OFFSET UNITYSDK_OFFSET(0x3A2E4D0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET_WINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x3A2E350)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_GET__WIDTHHEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x3A2E430)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x3A2E600)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_53101C986CC2F71A_OFFSET UNITYSDK_OFFSET(0x3A2E620)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x3A2E610)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_6828C34A483313B0_OFFSET UNITYSDK_OFFSET(0x3A2E640)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x3A2E630)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x3A2E5A0)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_AA972BE565DAF9E3_OFFSET UNITYSDK_OFFSET(0x3A2E590)
#define RPGTOOLS_TIMELINE_CRPCAMERASMALLWINDOWMESHUI_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x3A2E650)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSmallWindowMeshUI_TypeDefinitionIndex = 46125;
