...
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B3625C0)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B3625B0)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B362750)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ColorGradingMaskClip_TypeDefinitionIndex = 46676;
