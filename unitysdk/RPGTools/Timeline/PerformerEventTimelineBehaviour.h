...
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_METHOD_2_A15EF7939F75CCED_OFFSET UNITYSDK_OFFSET(0xD034890)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_METHOD_2_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0xD034900)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD034770)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD034950)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD034960)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformerEventTimelineBehaviour_TypeDefinitionIndex = 45721;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable, ::UnityEngine::Playables::FrameData, ::System::Object*))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET))(this, a1, a2, a3);
		}
	};
}
