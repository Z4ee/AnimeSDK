...
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_METHOD_2_A15EF7939F75CCED_OFFSET UNITYSDK_OFFSET(0xB8F2BA0)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_METHOD_2_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0xB8F2C10)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8F2A80)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F2C60)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8F2C70)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformerEventTimelineBehaviour_TypeDefinitionIndex = 45173;
