...
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_METHOD_2_A15EF7939F75CCED_OFFSET UNITYSDK_OFFSET(0x19990950)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_METHOD_2_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x199909C0)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19990830)
#define RPGTOOLS_TIMELINE_PERFORMEREVENTTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19990A10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformerEventTimelineBehaviour_TypeDefinitionIndex = 46660;
