...
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B362760)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B3628E0)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B362950)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ColorGradingMaskTrack_TypeDefinitionIndex = 46678;
