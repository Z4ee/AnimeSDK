...
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D149600)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D149780)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1497F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ColorGradingMaskTrack_TypeDefinitionIndex = 48923;
