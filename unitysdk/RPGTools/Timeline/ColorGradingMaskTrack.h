...
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xE836BA0)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xE836D20)
#define RPGTOOLS_TIMELINE_COLORGRADINGMASKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE836D90)
