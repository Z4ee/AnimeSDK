...
#define RPGTOOLS_TIMELINE_CHARACTERFOLLOWPLATFORMMOVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1D13D320)
#define RPGTOOLS_TIMELINE_CHARACTERFOLLOWPLATFORMMOVETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1D13D4A0)
#define RPGTOOLS_TIMELINE_CHARACTERFOLLOWPLATFORMMOVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13D510)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterFollowPlatformMoveTrack_TypeDefinitionIndex = 48417;
