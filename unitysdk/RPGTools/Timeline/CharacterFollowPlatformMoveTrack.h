...
#define RPGTOOLS_TIMELINE_CHARACTERFOLLOWPLATFORMMOVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B356EA0)
#define RPGTOOLS_TIMELINE_CHARACTERFOLLOWPLATFORMMOVETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B357020)
#define RPGTOOLS_TIMELINE_CHARACTERFOLLOWPLATFORMMOVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B357090)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterFollowPlatformMoveTrack_TypeDefinitionIndex = 46183;
