...
#define RPGTOOLS_TIMELINEDATASCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF3C8E0)

namespace RPGTools
{
	inline static constexpr unsigned int TimelineDataScriptableObject_TypeDefinitionIndex = 48243;
