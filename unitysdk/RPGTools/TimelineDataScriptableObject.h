...
#define RPGTOOLS_TIMELINEDATASCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD074590)

namespace RPGTools
{
	inline static constexpr unsigned int TimelineDataScriptableObject_TypeDefinitionIndex = 45101;
