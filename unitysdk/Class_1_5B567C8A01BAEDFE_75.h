...
#define CLASS_1_5B567C8A01BAEDFE_75_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EB5DD80)
#define CLASS_1_5B567C8A01BAEDFE_75_CLONE_OFFSET UNITYSDK_OFFSET(0x1EB5DA70)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EB5DB80)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EB5DAB0)
#define CLASS_1_5B567C8A01BAEDFE_75_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EB5DCE0)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EB5DDD0)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EB5DDA0)
#define CLASS_1_5B567C8A01BAEDFE_75_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EB5D9F0)
#define CLASS_1_5B567C8A01BAEDFE_75_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EB5DA20)
#define CLASS_1_5B567C8A01BAEDFE_75_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EB5DD10)
#define CLASS_1_5B567C8A01BAEDFE_75_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EB5DD70)
#define CLASS_1_5B567C8A01BAEDFE_75__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EB5DE20)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EB5DA40)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB5DA30)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_75_TypeDefinitionIndex = 26939;

class Class_1_5B567C8A01BAEDFE_75 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_75*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_75*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_75_TypeDefinitionIndex)->GetStaticField(0x3870);
	}
