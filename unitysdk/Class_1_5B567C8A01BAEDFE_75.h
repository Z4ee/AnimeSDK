...
#define CLASS_1_5B567C8A01BAEDFE_75_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A899D20)
#define CLASS_1_5B567C8A01BAEDFE_75_CLONE_OFFSET UNITYSDK_OFFSET(0x1A899B30)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A899C30)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A899BA0)
#define CLASS_1_5B567C8A01BAEDFE_75_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A899C80)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A899D70)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A899D40)
#define CLASS_1_5B567C8A01BAEDFE_75_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A899A80)
#define CLASS_1_5B567C8A01BAEDFE_75_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A899AE0)
#define CLASS_1_5B567C8A01BAEDFE_75_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A899CB0)
#define CLASS_1_5B567C8A01BAEDFE_75_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A899D10)
#define CLASS_1_5B567C8A01BAEDFE_75__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A899DC0)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A899B00)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_OFFSET UNITYSDK_OFFSET(0x1A899AF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_75_TypeDefinitionIndex = 25771;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_75*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_75_TypeDefinitionIndex)->GetStaticField(0x57700);
	}
