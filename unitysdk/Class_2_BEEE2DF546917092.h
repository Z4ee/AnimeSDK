...
#define CLASS_2_BEEE2DF546917092_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x16CB9300)
#define CLASS_2_BEEE2DF546917092_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0x16CB91B0)
#define CLASS_2_BEEE2DF546917092_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0x16CB9220)
#define CLASS_2_BEEE2DF546917092_GETPERSISTENTASSETPATH_OFFSET UNITYSDK_OFFSET(0x16CB94A0)
#define CLASS_2_BEEE2DF546917092_GETRECT_OFFSET UNITYSDK_OFFSET(0x16CB92A0)
#define CLASS_2_BEEE2DF546917092_METHOD_2_18193BE05A4121FF_OFFSET UNITYSDK_OFFSET(0x16CB9140)
#define CLASS_2_BEEE2DF546917092_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16CB9460)
#define CLASS_2_BEEE2DF546917092__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB8A60)

inline static constexpr unsigned int Class_2_BEEE2DF546917092_TypeDefinitionIndex = 73682;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_BEEE2DF546917092_TypeDefinitionIndex)->GetStaticField(0x2760);
	}
	::RPG::GameCore::GrassData* NFEKIEANHJI; // 0xB8
	::Class_1_303D5A33D1401D59* NCEAKEDDIIF; // 0xC0
	::System::Boolean HLJINKCCGON; // 0xC8
	::System::Byte CKNIIAHDNHC; // 0xC9
	::System::Single LBJEHIBFAJL; // 0xCC
	::UnityEngine::Rect OELFHMCCBBD; // 0xD0
	::System::Single KNHBFMOFBFC; // 0xE0
