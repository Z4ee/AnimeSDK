...
#define CLASS_1_D6F7CE49B90DAD0D_METHOD_1_27A3B0E81A55EF85_OFFSET UNITYSDK_OFFSET(0x184DA3A0)
#define CLASS_1_D6F7CE49B90DAD0D_METHOD_1_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0x184DA260)
#define CLASS_1_D6F7CE49B90DAD0D_METHOD_1_BB9E84D4A0178E06_OFFSET UNITYSDK_OFFSET(0x184DA300)
#define CLASS_1_D6F7CE49B90DAD0D__CTOR_OFFSET UNITYSDK_OFFSET(0x184DA1F0)
...
{
public:
	::Il2CppArray<::System::String*>* PMNMJEKKIJP; // 0x10
	::System::String* IOCBBJLGEAJ; // 0x18
	::System::Boolean LOFJANMAILC; // 0x20
	::System::Int32 MDBPILHONEH; // 0x24
	::System::Single KHBCIBHMIOG; // 0x28
	::UnityEngine::Vector2 BKIHBBGJAPK; // 0x2C
