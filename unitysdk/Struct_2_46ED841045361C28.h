...
#define STRUCT_2_46ED841045361C28_METHOD_2_75098065C229FA1A_OFFSET UNITYSDK_OFFSET(0x70E530)
#define STRUCT_2_46ED841045361C28_METHOD_2_AE783234D688F12D_OFFSET UNITYSDK_OFFSET(0x10F7A040)
#define STRUCT_2_46ED841045361C28__CTOR_OFFSET UNITYSDK_OFFSET(0x70E520)

inline static constexpr unsigned int Struct_2_46ED841045361C28_TypeDefinitionIndex = 57850;

struct alignas(8) Struct_2_46ED841045361C28
{
	::MoleMole::Cameras::CameraMiscSetting* Field_2_1; // 0x10
	::PipelineCamera::TimeBasedAlphaGenerator* Field_2_0; // 0x18
	::System::Single Field_2_7; // 0x20
	::System::Func_1<::System::Single>* Field_2_6; // 0x28
