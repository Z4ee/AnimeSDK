...
#define CLASS_3_E4C440F1BFCA5CB3_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x1765C530)
#define CLASS_3_E4C440F1BFCA5CB3_METHOD_3_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x1765C890)
#define CLASS_3_E4C440F1BFCA5CB3_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1765C800)
#define CLASS_3_E4C440F1BFCA5CB3_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x1765C8F0)
#define CLASS_3_E4C440F1BFCA5CB3_METHOD_3_E525695F9EB5A471_OFFSET UNITYSDK_OFFSET(0x1765C620)
#define CLASS_3_E4C440F1BFCA5CB3_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1765C610)
#define CLASS_3_E4C440F1BFCA5CB3_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x1765C4D0)
#define CLASS_3_E4C440F1BFCA5CB3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1765C580)
#define CLASS_3_E4C440F1BFCA5CB3__CTOR_OFFSET UNITYSDK_OFFSET(0x1765C600)

inline static constexpr unsigned int Class_3_E4C440F1BFCA5CB3_TypeDefinitionIndex = 69065;

class Class_3_E4C440F1BFCA5CB3 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_15 = 0x5; // 0x0
	::MoleMole::Battle::Entity* Field_3_0; // 0x48
	::System::String* Field_3_6; // 0x50
	::MoleMole::Config::ConfigAraTrail* Field_3_7; // 0x58
	::UnityEngine::GameObject* Field_3_4; // 0x60
	::UnityEngine::Transform* Field_3_5; // 0x68
	::Ara::AraTrail* Field_3_11; // 0x70
