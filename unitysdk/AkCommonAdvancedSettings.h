...
#define AKCOMMONADVANCEDSETTINGS_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1EEBCEE0)
#define AKCOMMONADVANCEDSETTINGS_COPYTO_2_OFFSET UNITYSDK_OFFSET(0x1EEBD820)
#define AKCOMMONADVANCEDSETTINGS_COPYTO_3_OFFSET UNITYSDK_OFFSET(0x1EEBD870)
#define AKCOMMONADVANCEDSETTINGS_COPYTO_4_OFFSET UNITYSDK_OFFSET(0x1EEBDA60)
#define AKCOMMONADVANCEDSETTINGS_COPYTO_OFFSET UNITYSDK_OFFSET(0x1EEBC890)
#define AKCOMMONADVANCEDSETTINGS_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1EEBDAB0)
#define AKCOMMONADVANCEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEAAC70)

inline static constexpr unsigned int AkCommonAdvancedSettings_TypeDefinitionIndex = 43648;
