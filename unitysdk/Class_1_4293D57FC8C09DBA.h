...
#define CLASS_1_4293D57FC8C09DBA_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15992DE0)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_1F9DE9833BB75805_OFFSET UNITYSDK_OFFSET(0x15995A60)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_2404A785C9F84991_OFFSET UNITYSDK_OFFSET(0x15994D90)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0x159931C0)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_459C073F0CEC7726_OFFSET UNITYSDK_OFFSET(0x15996E70)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_4AA7827CFB505DDD_OFFSET UNITYSDK_OFFSET(0x15994230)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_534CCDF644FB9DD7_OFFSET UNITYSDK_OFFSET(0x15996720)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_5477F1A41451B700_OFFSET UNITYSDK_OFFSET(0x15993870)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_59AD45407DE31C4F_OFFSET UNITYSDK_OFFSET(0x15995930)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_5D307139D6E0A19D_OFFSET UNITYSDK_OFFSET(0x15997390)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_61FD3B9C0D9CB619_OFFSET UNITYSDK_OFFSET(0x15994290)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_6ED52388A49459A8_OFFSET UNITYSDK_OFFSET(0x15995C90)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_868AEE498FC5E9DF_OFFSET UNITYSDK_OFFSET(0x15997730)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_9100CB4E31994B68_OFFSET UNITYSDK_OFFSET(0x159963A0)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_98322C1E60391C5D_OFFSET UNITYSDK_OFFSET(0x15996300)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_A0529F9E6E9763B9_OFFSET UNITYSDK_OFFSET(0x15993050)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_A9D675469BFEA4B7_OFFSET UNITYSDK_OFFSET(0x159969A0)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_AB1FFCA8EF89FB20_OFFSET UNITYSDK_OFFSET(0x15994F60)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_C2074E4F7DEFFE27_OFFSET UNITYSDK_OFFSET(0x15995DD0)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_D16C3D7D2A005C41_OFFSET UNITYSDK_OFFSET(0x15994020)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_DE25FD5BFE850651_OFFSET UNITYSDK_OFFSET(0x15996C80)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_DF7960F9635E4EEF_OFFSET UNITYSDK_OFFSET(0x15997010)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_E28B6E31CE3395EC_OFFSET UNITYSDK_OFFSET(0x15997530)
#define CLASS_1_4293D57FC8C09DBA_METHOD_1_FF816DC3F260E91A_OFFSET UNITYSDK_OFFSET(0x159949F0)
#define CLASS_1_4293D57FC8C09DBA__CTOR_OFFSET UNITYSDK_OFFSET(0x15992780)

inline static constexpr unsigned int Class_1_4293D57FC8C09DBA_TypeDefinitionIndex = 77126;

class Class_1_4293D57FC8C09DBA : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::ChimeraDuelEventType>* PMBACELLNND; // 0x10
	::Class_1_3B1EA953A4067E26* FKINCGODJEP; // 0x18
	::Class_3_E6ABB31B8050F1C6* PDENFEFCAGN; // 0x20

	::System::Void _ctor(::Class_1_3B1EA953A4067E26* a1, ::Class_3_E6ABB31B8050F1C6* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_3B1EA953A4067E26*, ::Class_3_E6ABB31B8050F1C6*))((::PBYTE)hIl2Cpp + CLASS_1_4293D57FC8C09DBA__CTOR_OFFSET))(this, a1, a2);
	}
