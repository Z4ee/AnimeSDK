...
#define CLASS_1_5B567C8A01BAEDFE_302_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7FF960)
#define CLASS_1_5B567C8A01BAEDFE_302_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7FF7D0)
#define CLASS_1_5B567C8A01BAEDFE_302_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7FF870)
#define CLASS_1_5B567C8A01BAEDFE_302_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7FF810)
#define CLASS_1_5B567C8A01BAEDFE_302_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7FF8C0)
#define CLASS_1_5B567C8A01BAEDFE_302_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7FF9B0)
#define CLASS_1_5B567C8A01BAEDFE_302_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7FF980)
#define CLASS_1_5B567C8A01BAEDFE_302_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7FF750)
#define CLASS_1_5B567C8A01BAEDFE_302_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7FF780)
#define CLASS_1_5B567C8A01BAEDFE_302_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7FF8F0)
#define CLASS_1_5B567C8A01BAEDFE_302_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7FF950)
#define CLASS_1_5B567C8A01BAEDFE_302__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7FFA00)
#define CLASS_1_5B567C8A01BAEDFE_302__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7FF7A0)
#define CLASS_1_5B567C8A01BAEDFE_302__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7FF790)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_302_TypeDefinitionIndex = 31061;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_302*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_302_TypeDefinitionIndex)->GetStaticField(0x4FF40);
	}
