...
#define CLASS_1_5B567C8A01BAEDFE_302_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x196C29F0)
#define CLASS_1_5B567C8A01BAEDFE_302_CLONE_OFFSET UNITYSDK_OFFSET(0x196C2860)
#define CLASS_1_5B567C8A01BAEDFE_302_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x196C2900)
#define CLASS_1_5B567C8A01BAEDFE_302_EQUALS_OFFSET UNITYSDK_OFFSET(0x196C28A0)
#define CLASS_1_5B567C8A01BAEDFE_302_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x196C2950)
#define CLASS_1_5B567C8A01BAEDFE_302_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x196C2A40)
#define CLASS_1_5B567C8A01BAEDFE_302_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x196C2A10)
#define CLASS_1_5B567C8A01BAEDFE_302_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x196C27E0)
#define CLASS_1_5B567C8A01BAEDFE_302_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x196C2810)
#define CLASS_1_5B567C8A01BAEDFE_302_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196C2980)
#define CLASS_1_5B567C8A01BAEDFE_302_WRITETO_OFFSET UNITYSDK_OFFSET(0x196C29E0)
#define CLASS_1_5B567C8A01BAEDFE_302__CCTOR_OFFSET UNITYSDK_OFFSET(0x196C2A90)
#define CLASS_1_5B567C8A01BAEDFE_302__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196C2830)
#define CLASS_1_5B567C8A01BAEDFE_302__CTOR_OFFSET UNITYSDK_OFFSET(0x196C2820)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_302*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_302_TypeDefinitionIndex)->GetStaticField(0x495E0);
	}
