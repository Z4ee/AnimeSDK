...
#define CLASS_3_441B7C0415B9DC03_DISPOSE_OFFSET UNITYSDK_OFFSET(0x887FF40)
#define CLASS_3_441B7C0415B9DC03_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x887FF80)
#define CLASS_3_441B7C0415B9DC03__CTOR_OFFSET UNITYSDK_OFFSET(0x887FF10)
#define CLASS_3_441B7C0415B9DC03___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8880560)

inline static constexpr unsigned int Class_3_441B7C0415B9DC03_TypeDefinitionIndex = 44509;
