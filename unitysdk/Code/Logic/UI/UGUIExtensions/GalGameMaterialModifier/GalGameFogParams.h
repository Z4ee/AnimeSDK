...
#define CODE_LOGIC_UI_UGUIEXTENSIONS_GALGAMEMATERIALMODIFIER_GALGAMEFOGPARAMS_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x124F1960)
#define CODE_LOGIC_UI_UGUIEXTENSIONS_GALGAMEMATERIALMODIFIER_GALGAMEFOGPARAMS_METHOD_1_391A84BCD9F51317_2_OFFSET UNITYSDK_OFFSET(0x124F19B0)
#define CODE_LOGIC_UI_UGUIEXTENSIONS_GALGAMEMATERIALMODIFIER_GALGAMEFOGPARAMS_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x124F1910)
#define CODE_LOGIC_UI_UGUIEXTENSIONS_GALGAMEMATERIALMODIFIER_GALGAMEFOGPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x124F18F0)

namespace Code::Logic::UI::UGUIExtensions::GalGameMaterialModifier
{
	inline static constexpr unsigned int GalGameFogParams_TypeDefinitionIndex = 57457;
