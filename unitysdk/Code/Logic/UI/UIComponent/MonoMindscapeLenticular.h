...
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_GET_MOUSEXCURVE_OFFSET UNITYSDK_OFFSET(0x17A46AE0)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_GET_NORMALIZEDMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x17A46A00)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17A46B40)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_SET_MOUSEXCURVE_OFFSET UNITYSDK_OFFSET(0x17A46AF0)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_SET_NORMALIZEDMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x17A46A10)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_UPDATE_OFFSET UNITYSDK_OFFSET(0x17A46C40)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17A47220)

namespace Code::Logic::UI::UIComponent
{
	inline static constexpr unsigned int MonoMindscapeLenticular_TypeDefinitionIndex = 47952;
