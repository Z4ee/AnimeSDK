...
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_GET_MOUSEXCURVE_OFFSET UNITYSDK_OFFSET(0x1009F640)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_GET_NORMALIZEDMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1009F560)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1009F6A0)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_SET_MOUSEXCURVE_OFFSET UNITYSDK_OFFSET(0x1009F650)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_SET_NORMALIZEDMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1009F570)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1009F7A0)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1009FDE0)

namespace Code::Logic::UI::UIComponent
{
	inline static constexpr unsigned int MonoMindscapeLenticular_TypeDefinitionIndex = 80998;
