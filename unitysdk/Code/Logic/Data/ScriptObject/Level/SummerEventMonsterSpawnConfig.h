...
#define CODE_LOGIC_DATA_SCRIPTOBJECT_LEVEL_SUMMEREVENTMONSTERSPAWNCONFIG_GETFORMATTOSERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x128BBBD0)
#define CODE_LOGIC_DATA_SCRIPTOBJECT_LEVEL_SUMMEREVENTMONSTERSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x128BBC20)

namespace Code::Logic::Data::ScriptObject::Level
{
	inline static constexpr unsigned int SummerEventMonsterSpawnConfig_TypeDefinitionIndex = 77124;
