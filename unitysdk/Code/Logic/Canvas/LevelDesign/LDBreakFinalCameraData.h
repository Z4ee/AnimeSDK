...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKFINALCAMERADATA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10FA16A0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKFINALCAMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10FA1820)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDBreakFinalCameraData_TypeDefinitionIndex = 73717;
