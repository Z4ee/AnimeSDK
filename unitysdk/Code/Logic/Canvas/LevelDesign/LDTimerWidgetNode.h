...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_BEGIN_OFFSET UNITYSDK_OFFSET(0x14DFB270)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_PAUSECOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0x14DFB7C0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_PAUSE_OFFSET UNITYSDK_OFFSET(0x14DFB740)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14DFB040)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_RESUME_OFFSET UNITYSDK_OFFSET(0x14DFBA00)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_SHOWCOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0x14DFB480)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0x14DFBA80)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x14DFBB80)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x14DFBBC0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDTIMERWIDGETNODE__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x14DFBBD0)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDTimerWidgetNode_TypeDefinitionIndex = 65437;
	...
	public:
		...
		::Class_1_8289F2785D9AA990* timer; // 0xB8
