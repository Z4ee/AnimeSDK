...
#define CLASS_1_2BC4C797B07A85AD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4EE030)
...
public:
	...
	::System::Int32 LPEHHMHPCMG; // 0x14
	::System::Int32 OGOADCDDCIG; // 0x18
	::System::Int32 GLANPLEGMPG; // 0x1C
	::System::Int32 AMMPNOLLCIN; // 0x20
	::RPG::Client::LittleGame::Match3::MatchThreeOpponentLiveState KGDEJHBLAGP; // 0x24
	::System::Boolean EOJMKPPFNHN; // 0x28
