...
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_0169F0DBABDADCA6_OFFSET UNITYSDK_OFFSET(0x159498E0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_041ABD736B82E9F1_OFFSET UNITYSDK_OFFSET(0x1594A700)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_04F7BD7F299911C7_OFFSET UNITYSDK_OFFSET(0x15949C10)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0x1594A670)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x15949E00)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x15947BB0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_2FF8165EECCF923A_OFFSET UNITYSDK_OFFSET(0x15949EA0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0x15948ED0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_388F6655552B4D3E_OFFSET UNITYSDK_OFFSET(0x1594B4D0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1594A8C0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_5F08B426ADF31FF5_OFFSET UNITYSDK_OFFSET(0x15948280)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_66E67324E0AB3AD4_OFFSET UNITYSDK_OFFSET(0x1594B1F0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_67E99E5CA0BBEF6F_OFFSET UNITYSDK_OFFSET(0x15949180)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_8CB3ABD41F954D02_OFFSET UNITYSDK_OFFSET(0x15948630)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_8E4ED9FA27613068_OFFSET UNITYSDK_OFFSET(0x1594AA10)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1594A850)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x15948500)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x15948F40)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_B8ADD1482F0B3E5B_OFFSET UNITYSDK_OFFSET(0x1594B6E0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_BBC3576C1739CB7F_OFFSET UNITYSDK_OFFSET(0x1594AEB0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_D2967792C8AA78E6_OFFSET UNITYSDK_OFFSET(0x15948BE0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_D5E2E9CBB5BC346D_OFFSET UNITYSDK_OFFSET(0x159475C0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_E146CE61ABF70C1C_OFFSET UNITYSDK_OFFSET(0x159490A0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1594A910)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_EA1CDF7B7BFCD14E_OFFSET UNITYSDK_OFFSET(0x159496D0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_EC90937CEA9AFCA9_OFFSET UNITYSDK_OFFSET(0x15948FC0)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_F5909B5FD6F94F42_OFFSET UNITYSDK_OFFSET(0x15947A20)
#define CLASS_2_D8E60A4D7D755F3F_METHOD_2_FA1645600B45B128_OFFSET UNITYSDK_OFFSET(0x159481A0)
#define CLASS_2_D8E60A4D7D755F3F__CCTOR_OFFSET UNITYSDK_OFFSET(0x1594B8B0)
#define CLASS_2_D8E60A4D7D755F3F__CTOR_OFFSET UNITYSDK_OFFSET(0x15947880)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_D8E60A4D7D755F3F_TypeDefinitionIndex)->GetStaticField(0x14830);
	}
	...
	::System::Collections::Generic::HashSet_1<::Class_1_B87B48EBDCE76E87*>* DLLEDDKIOCJ; // 0x20
	::System::Collections::Generic::List_1<::Class_1_B87B48EBDCE76E87*>* NNOHIEKGFJA; // 0x28
	::Il2CppArray<::RPG::GameCore::LevelPedestrianV2ChenLingStackOffsetInfo*>* JCKHHGCDAAM; // 0x30
	::Class_1_B87B48EBDCE76E87* BCMKMMEPCMJ; // 0x38
	::System::Collections::Generic::List_1<::Class_1_B87B48EBDCE76E87*>* KEFLEMEGPNA; // 0x40
	::UnityEngine::GameObject* PHMKPFPFGDF; // 0x48
	::RPG::Client::ChenLingStackDropProxy* AKHDANNKLAL; // 0x50
	::System::Collections::Generic::HashSet_1<::System::Int32>* INNECGBHKMB; // 0x58
	::Class_2_9065242F5CF3F064* NFCIHBOIBOP; // 0x60
	::System::Collections::Generic::List_1<::Class_2_D8E60A4D7D755F3F_Class_1_E4E1541F984B635D*>* GFPJBPBCHCL; // 0x68
	::System::Collections::Generic::List_1<::Class_2_D8E60A4D7D755F3F_Class_1_9F51B00CD5DB549F*>* PDOIBEHBBOL; // 0x70
	::Class_1_4F54BF4C6B55D9A9* DKOFBCEICPO; // 0x78
	::System::Single OOACJDJLBIN; // 0x80
	::UnityEngine::Vector3 MIFKHBDOGLN; // 0x84
	::UnityEngine::Quaternion NCMEPPHLGEG; // 0x90
	::System::Int32 MJBOFNNMDPE; // 0xA0
	::Struct_2_085541A9CFF64383 FEKJGGNNLLI; // 0xA4
	::System::Boolean LGNGBOPCNIO; // 0xAC
	::System::Boolean PPIGLCIEIIM; // 0xAD
	::System::Boolean DBPJOCPHCAF; // 0xAE
	::System::Boolean GMCHEBEKICB; // 0xAF
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_2_D8E60A4D7D755F3F_METHOD_2_F5909B5FD6F94F42_OFFSET))(this, a1);
	}
