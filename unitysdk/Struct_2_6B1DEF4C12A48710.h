...
#define STRUCT_2_6B1DEF4C12A48710_GET_ACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x1E110)
#define STRUCT_2_6B1DEF4C12A48710_GET_AGGREGATEDSTATEV2_OFFSET UNITYSDK_OFFSET(0x26200)
#define STRUCT_2_6B1DEF4C12A48710_GET_COMPATKEY_OFFSET UNITYSDK_OFFSET(0x6EF0)
#define STRUCT_2_6B1DEF4C12A48710_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define STRUCT_2_6B1DEF4C12A48710_GET_USESSOURCEPROFILE_OFFSET UNITYSDK_OFFSET(0x89B40)
#define STRUCT_2_6B1DEF4C12A48710_GET_VISUALSTATE_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define STRUCT_2_6B1DEF4C12A48710__CTOR_OFFSET UNITYSDK_OFFSET(0x2BBF3D0)

inline static constexpr unsigned int Struct_2_6B1DEF4C12A48710_TypeDefinitionIndex = 58130;
