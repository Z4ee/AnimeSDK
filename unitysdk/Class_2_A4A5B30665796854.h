...
#define CLASS_2_A4A5B30665796854_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C49680)
#define CLASS_2_A4A5B30665796854_METHOD_2_5362A3A054DBA0D2_OFFSET UNITYSDK_OFFSET(0x8C49D60)
#define CLASS_2_A4A5B30665796854_METHOD_2_5B9761C1A72C4D1A_OFFSET UNITYSDK_OFFSET(0x8C49C30)
#define CLASS_2_A4A5B30665796854_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8C496C0)
#define CLASS_2_A4A5B30665796854_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8C49CB0)
#define CLASS_2_A4A5B30665796854_TICK_OFFSET UNITYSDK_OFFSET(0x8C49D00)
#define CLASS_2_A4A5B30665796854__CTOR_OFFSET UNITYSDK_OFFSET(0x8C49670)

inline static constexpr unsigned int Class_2_A4A5B30665796854_TypeDefinitionIndex = 47423;

class Class_2_A4A5B30665796854 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SwitchCharacterAnchor* Field_2_0; // 0x20
