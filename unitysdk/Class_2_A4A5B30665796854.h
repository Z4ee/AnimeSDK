...
#define CLASS_2_A4A5B30665796854_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA624920)
#define CLASS_2_A4A5B30665796854_METHOD_2_5362A3A054DBA0D2_OFFSET UNITYSDK_OFFSET(0xA625000)
#define CLASS_2_A4A5B30665796854_METHOD_2_5B9761C1A72C4D1A_OFFSET UNITYSDK_OFFSET(0xA624ED0)
#define CLASS_2_A4A5B30665796854_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA624960)
#define CLASS_2_A4A5B30665796854_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA624F50)
#define CLASS_2_A4A5B30665796854_TICK_OFFSET UNITYSDK_OFFSET(0xA624FA0)
#define CLASS_2_A4A5B30665796854__CTOR_OFFSET UNITYSDK_OFFSET(0xA624910)

inline static constexpr unsigned int Class_2_A4A5B30665796854_TypeDefinitionIndex = 54884;
