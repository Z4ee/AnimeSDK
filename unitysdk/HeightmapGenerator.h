...
#define HEIGHTMAPGENERATOR_GENERATEHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x18DC5C70)
#define HEIGHTMAPGENERATOR_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x18DC63E0)
#define HEIGHTMAPGENERATOR_SAVETOEXR_OFFSET UNITYSDK_OFFSET(0x18DC6510)
#define HEIGHTMAPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC6650)

inline static constexpr unsigned int HeightmapGenerator_TypeDefinitionIndex = 47776;
