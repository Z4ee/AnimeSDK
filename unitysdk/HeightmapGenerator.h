...
#define HEIGHTMAPGENERATOR_GENERATEHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x15ACDF30)
#define HEIGHTMAPGENERATOR_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x15ACE6A0)
#define HEIGHTMAPGENERATOR_SAVETOEXR_OFFSET UNITYSDK_OFFSET(0x15ACE7D0)
#define HEIGHTMAPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15ACE910)
