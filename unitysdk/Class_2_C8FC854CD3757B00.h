...
#define CLASS_2_C8FC854CD3757B00_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0BD700)
#define CLASS_2_C8FC854CD3757B00_METHOD_2_8B37A17B7A3F06D8_OFFSET UNITYSDK_OFFSET(0xC0BDC30)
#define CLASS_2_C8FC854CD3757B00_METHOD_2_8CA56FF24F45C9F3_OFFSET UNITYSDK_OFFSET(0xC0BE1E0)
#define CLASS_2_C8FC854CD3757B00_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC0BDD20)
#define CLASS_2_C8FC854CD3757B00_METHOD_2_DFC11C3DC1DE053B_OFFSET UNITYSDK_OFFSET(0xC0BDF10)
#define CLASS_2_C8FC854CD3757B00_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC0BDD60)
#define CLASS_2_C8FC854CD3757B00_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC0BD7D0)
#define CLASS_2_C8FC854CD3757B00_TICK_OFFSET UNITYSDK_OFFSET(0xC0BD8F0)
#define CLASS_2_C8FC854CD3757B00__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BD330)
...
{
public:
	::Struct_2_D3027B1CDFF61281 EJEDAHOENCD; // 0x18
	::Class_2_2B9847232031B19F* BAMECAHHEKC; // 0x48
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x50
	::Struct_2_D3027B1CDFF61281 EHHDIJMGHGG; // 0x58
	::RPG::GameCore::HandleMapRotationInteract* IGHAHBNLIJA; // 0x88
	::Class_2_1C9C081C3F4294E9* IFEPIOPPBJJ; // 0x90
	::System::Boolean AADLKMCFFOL; // 0x98
	::System::Boolean GMALPHFHLDM; // 0x99
	::System::UInt32 JGGDKOCIEGH; // 0x9C
	::System::UInt32 PEEFHNHDBMF; // 0xA0
