...
#define CLASS_1_29327D508CD1E435__CTOR_OFFSET UNITYSDK_OFFSET(0x13551000)
...
public:
	...
	::RPG::GameCore::SkillType Field_1_1; // 0x18
	::RPG::GameCore::ControlSkillType Field_1_2; // 0x1C
