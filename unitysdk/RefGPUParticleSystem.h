...
#define REFGPUPARTICLESYSTEM_ADDATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1D988B00)
#define REFGPUPARTICLESYSTEM_ADDBURST_1_OFFSET UNITYSDK_OFFSET(0x1D988A40)
#define REFGPUPARTICLESYSTEM_ADDBURST_OFFSET UNITYSDK_OFFSET(0x1D988930)
#define REFGPUPARTICLESYSTEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D987CD0)
#define REFGPUPARTICLESYSTEM_CLEARPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x1D987B10)
#define REFGPUPARTICLESYSTEM_DEACTIVATESKINNEDMESHEMITTER_OFFSET UNITYSDK_OFFSET(0x1D98D9A0)
#define REFGPUPARTICLESYSTEM_DEBUGOFF_OFFSET UNITYSDK_OFFSET(0x1D992B40)
#define REFGPUPARTICLESYSTEM_DEBUGON_OFFSET UNITYSDK_OFFSET(0x1D992AA0)
#define REFGPUPARTICLESYSTEM_EMITNUMPARTICLES_OFFSET UNITYSDK_OFFSET(0x1D9885F0)
#define REFGPUPARTICLESYSTEM_EMIT_OFFSET UNITYSDK_OFFSET(0x1D9885E0)
#define REFGPUPARTICLESYSTEM_FORCERECREATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1D98C5A0)
#define REFGPUPARTICLESYSTEM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x1D98B520)
#define REFGPUPARTICLESYSTEM_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x1D988280)
#define REFGPUPARTICLESYSTEM_METHOD_5_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x1D9876D0)
#define REFGPUPARTICLESYSTEM_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x1D987F00)
#define REFGPUPARTICLESYSTEM_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x1D989D90)
#define REFGPUPARTICLESYSTEM_METHOD_5_64F3965CE4C4DB47_OFFSET UNITYSDK_OFFSET(0x1D988100)
#define REFGPUPARTICLESYSTEM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1D98BBE0)
#define REFGPUPARTICLESYSTEM_METHOD_5_925162CF519D5A91_OFFSET UNITYSDK_OFFSET(0x1D987120)
#define REFGPUPARTICLESYSTEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x1D98F5E0)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_1_OFFSET UNITYSDK_OFFSET(0x1D98D0C0)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_2_OFFSET UNITYSDK_OFFSET(0x1D98A250)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x1D98A1D0)
#define REFGPUPARTICLESYSTEM_METHOD_5_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x1D988090)
#define REFGPUPARTICLESYSTEM_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x1D987BF0)
#define REFGPUPARTICLESYSTEM_METHOD_5_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0x1D9883F0)
#define REFGPUPARTICLESYSTEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1D98D140)
#define REFGPUPARTICLESYSTEM_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x1D987FA0)
#define REFGPUPARTICLESYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D987C90)
#define REFGPUPARTICLESYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D987A00)
#define REFGPUPARTICLESYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D986FC0)
#define REFGPUPARTICLESYSTEM_PAUSE_OFFSET UNITYSDK_OFFSET(0x1D988500)
#define REFGPUPARTICLESYSTEM_PLAY_OFFSET UNITYSDK_OFFSET(0x1D988460)
#define REFGPUPARTICLESYSTEM_PREPAREPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x1D987050)
#define REFGPUPARTICLESYSTEM_PREPARESKINNEDMESH_OFFSET UNITYSDK_OFFSET(0x1D98DAB0)
#define REFGPUPARTICLESYSTEM_REMOVEATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1D988BF0)
#define REFGPUPARTICLESYSTEM_REMOVEBURST_OFFSET UNITYSDK_OFFSET(0x1D988D10)
#define REFGPUPARTICLESYSTEM_REMOVELASTATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1D988C90)
#define REFGPUPARTICLESYSTEM_REMOVELASTBURST_OFFSET UNITYSDK_OFFSET(0x1D988DB0)
#define REFGPUPARTICLESYSTEM_RENDERSKINNEDMESHEMITTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1D98DA20)
#define REFGPUPARTICLESYSTEM_RESEED_OFFSET UNITYSDK_OFFSET(0x1D9887D0)
#define REFGPUPARTICLESYSTEM_RESETSEED_OFFSET UNITYSDK_OFFSET(0x1D98E440)
#define REFGPUPARTICLESYSTEM_RESTART_OFFSET UNITYSDK_OFFSET(0x1D988510)
#define REFGPUPARTICLESYSTEM_SETATTRACTORKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D9929D0)
#define REFGPUPARTICLESYSTEM_SETBLENDMODE_1_OFFSET UNITYSDK_OFFSET(0x1D9921E0)
#define REFGPUPARTICLESYSTEM_SETBLENDMODE_OFFSET UNITYSDK_OFFSET(0x1D991BF0)
#define REFGPUPARTICLESYSTEM_SETCIRCULARFORCE_OFFSET UNITYSDK_OFFSET(0x1D991B60)
#define REFGPUPARTICLESYSTEM_SETCOLLISIONTYPE_OFFSET UNITYSDK_OFFSET(0x1D991070)
#define REFGPUPARTICLESYSTEM_SETEMISSIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98D040)
#define REFGPUPARTICLESYSTEM_SETEMISSIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98CF60)
#define REFGPUPARTICLESYSTEM_SETEMITFROMBASE_OFFSET UNITYSDK_OFFSET(0x1D992940)
#define REFGPUPARTICLESYSTEM_SETEMITFROMSHELL_OFFSET UNITYSDK_OFFSET(0x1D9928B0)
#define REFGPUPARTICLESYSTEM_SETEMITTERSHAPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98A4F0)
#define REFGPUPARTICLESYSTEM_SETLAYER_OFFSET UNITYSDK_OFFSET(0x1D992750)
#define REFGPUPARTICLESYSTEM_SETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x1D989C60)
#define REFGPUPARTICLESYSTEM_SETLIMITVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D991AD0)
#define REFGPUPARTICLESYSTEM_SETMAINTEXTUREKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98CB10)
#define REFGPUPARTICLESYSTEM_SETMAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98CA30)
#define REFGPUPARTICLESYSTEM_SETMESHTARGETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D990FA0)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98CCA0)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98CB90)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSVALUE_OFFSET UNITYSDK_OFFSET(0x1D98CD20)
#define REFGPUPARTICLESYSTEM_SETNORMALKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98CEE0)
#define REFGPUPARTICLESYSTEM_SETNORMALMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98CDD0)
#define REFGPUPARTICLESYSTEM_SETPARTICLETYPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98A560)
#define REFGPUPARTICLESYSTEM_SETRANDOMINDEXKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D991450)
#define REFGPUPARTICLESYSTEM_SETREFRACTIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98AD50)
#define REFGPUPARTICLESYSTEM_SETRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x1D9879D0)
#define REFGPUPARTICLESYSTEM_SETROTATIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D991170)
#define REFGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1D990380)
#define REFGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D9911F0)
#define REFGPUPARTICLESYSTEM_SETSHADOWSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D98AB60)
#define REFGPUPARTICLESYSTEM_SETSIMULATIONSPACE_OFFSET UNITYSDK_OFFSET(0x1D98A7C0)
#define REFGPUPARTICLESYSTEM_SETSIZEOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D98FD40)
#define REFGPUPARTICLESYSTEM_SETTEXTURESHEETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D991270)
#define REFGPUPARTICLESYSTEM_SETTURBULENCEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D9910A0)
#define REFGPUPARTICLESYSTEM_SETUPDATATEXTURES_OFFSET UNITYSDK_OFFSET(0x1D98F280)
#define REFGPUPARTICLESYSTEM_SETUPSKINNEDMESHEMITTERCAMERA_OFFSET UNITYSDK_OFFSET(0x1D98D470)
#define REFGPUPARTICLESYSTEM_SETZBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1D992850)
#define REFGPUPARTICLESYSTEM_SETZBUFFER_OFFSET UNITYSDK_OFFSET(0x1D9927E0)
#define REFGPUPARTICLESYSTEM_STOP_OFFSET UNITYSDK_OFFSET(0x1D987AD0)
#define REFGPUPARTICLESYSTEM_UPDATEAIRRESISTANCE_OFFSET UNITYSDK_OFFSET(0x1D98BAF0)
#define REFGPUPARTICLESYSTEM_UPDATEAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1D990620)
#define REFGPUPARTICLESYSTEM_UPDATEASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1D98C9B0)
#define REFGPUPARTICLESYSTEM_UPDATECIRCULARFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98F500)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONCAMERA_OFFSET UNITYSDK_OFFSET(0x1D98AF20)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONMATRICES_OFFSET UNITYSDK_OFFSET(0x1D98BD60)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONPLANES_OFFSET UNITYSDK_OFFSET(0x1D98E520)
#define REFGPUPARTICLESYSTEM_UPDATECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x1D98F410)
#define REFGPUPARTICLESYSTEM_UPDATECOLOROVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98F130)
#define REFGPUPARTICLESYSTEM_UPDATEDEPTHCOLLISIONVALUES_OFFSET UNITYSDK_OFFSET(0x1D98AF90)
#define REFGPUPARTICLESYSTEM_UPDATEDISTRIBUTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x1D98D990)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERMATRIX_OFFSET UNITYSDK_OFFSET(0x1D98B010)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D98EEF0)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98A2D0)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTER_OFFSET UNITYSDK_OFFSET(0x1D988600)
#define REFGPUPARTICLESYSTEM_UPDATEFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98BC80)
#define REFGPUPARTICLESYSTEM_UPDATEFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1D9906F0)
#define REFGPUPARTICLESYSTEM_UPDATEGRAVITY_OFFSET UNITYSDK_OFFSET(0x1D98B0F0)
#define REFGPUPARTICLESYSTEM_UPDATEINDEXOFREFRACTION_OFFSET UNITYSDK_OFFSET(0x1D98AEA0)
#define REFGPUPARTICLESYSTEM_UPDATEMAXVELOCITYOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98F4D0)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETMATRIX_OFFSET UNITYSDK_OFFSET(0x1D98B2C0)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D98B280)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98DF50)
#define REFGPUPARTICLESYSTEM_UPDATEMOTIONVECTORSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1D98ED10)
#define REFGPUPARTICLESYSTEM_UPDATEMOTIONVECTORTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98ED90)
#define REFGPUPARTICLESYSTEM_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1D990870)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x1D98F0A0)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLEMAINTEX_OFFSET UNITYSDK_OFFSET(0x1D98EBA0)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLETYPEKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1D98C640)
#define REFGPUPARTICLESYSTEM_UPDATEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1D98C910)
#define REFGPUPARTICLESYSTEM_UPDATEROTATIONOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98FEA0)
#define REFGPUPARTICLESYSTEM_UPDATESIZEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98F790)
#define REFGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERCAMERALAYER_OFFSET UNITYSDK_OFFSET(0x1D98D750)
#define REFGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERPOSITIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D98D780)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSIZEANDROTATION_OFFSET UNITYSDK_OFFSET(0x1D98EE30)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSIZE_OFFSET UNITYSDK_OFFSET(0x1D991A90)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSPEEDANDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1D98AFD0)
#define REFGPUPARTICLESYSTEM_UPDATESTRETCHMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1D98ADD0)
#define REFGPUPARTICLESYSTEM_UPDATETEXTURESHEETDIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1D990F00)
#define REFGPUPARTICLESYSTEM_UPDATETIGHTNESS_OFFSET UNITYSDK_OFFSET(0x1D9907D0)
#define REFGPUPARTICLESYSTEM_UPDATETRAILVALUES_OFFSET UNITYSDK_OFFSET(0x1D98C840)
#define REFGPUPARTICLESYSTEM_UPDATETURBULENCETEXTURE_OFFSET UNITYSDK_OFFSET(0x1D9904E0)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELDFILE_OFFSET UNITYSDK_OFFSET(0x1D990960)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELDMATRIX_OFFSET UNITYSDK_OFFSET(0x1D98B980)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELD_OFFSET UNITYSDK_OFFSET(0x1D990580)
#define REFGPUPARTICLESYSTEM_UPDATEWORLDSPACEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1D98B770)
#define REFGPUPARTICLESYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D987CE0)
#define REFGPUPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D992BB0)
