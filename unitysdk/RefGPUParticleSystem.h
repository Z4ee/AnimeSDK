...
#define REFGPUPARTICLESYSTEM_ADDATTRACTOR_OFFSET UNITYSDK_OFFSET(0x19D5AAF0)
#define REFGPUPARTICLESYSTEM_ADDBURST_1_OFFSET UNITYSDK_OFFSET(0x19D5AA80)
#define REFGPUPARTICLESYSTEM_ADDBURST_OFFSET UNITYSDK_OFFSET(0x19D5A9E0)
#define REFGPUPARTICLESYSTEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x19D59D90)
#define REFGPUPARTICLESYSTEM_CLEARPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x19D59BC0)
#define REFGPUPARTICLESYSTEM_DEACTIVATESKINNEDMESHEMITTER_OFFSET UNITYSDK_OFFSET(0x19D5F930)
#define REFGPUPARTICLESYSTEM_DEBUGOFF_OFFSET UNITYSDK_OFFSET(0x19D64B20)
#define REFGPUPARTICLESYSTEM_DEBUGON_OFFSET UNITYSDK_OFFSET(0x19D64A70)
#define REFGPUPARTICLESYSTEM_EMITNUMPARTICLES_OFFSET UNITYSDK_OFFSET(0x19D5A6A0)
#define REFGPUPARTICLESYSTEM_EMIT_OFFSET UNITYSDK_OFFSET(0x19D5A690)
#define REFGPUPARTICLESYSTEM_FORCERECREATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x19D5E520)
#define REFGPUPARTICLESYSTEM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x19D5D480)
#define REFGPUPARTICLESYSTEM_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x19D5A330)
#define REFGPUPARTICLESYSTEM_METHOD_5_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x19D59770)
#define REFGPUPARTICLESYSTEM_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x19D59FC0)
#define REFGPUPARTICLESYSTEM_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x19D5BCB0)
#define REFGPUPARTICLESYSTEM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x19D5DB60)
#define REFGPUPARTICLESYSTEM_METHOD_5_925162CF519D5A91_OFFSET UNITYSDK_OFFSET(0x19D59260)
#define REFGPUPARTICLESYSTEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x19D61600)
#define REFGPUPARTICLESYSTEM_METHOD_5_9D0688AE2E08E349_OFFSET UNITYSDK_OFFSET(0x19D5A1C0)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_1_OFFSET UNITYSDK_OFFSET(0x19D5F050)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_2_OFFSET UNITYSDK_OFFSET(0x19D5C170)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x19D5C0F0)
#define REFGPUPARTICLESYSTEM_METHOD_5_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x19D5A150)
#define REFGPUPARTICLESYSTEM_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x19D59CA0)
#define REFGPUPARTICLESYSTEM_METHOD_5_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0x19D5A4A0)
#define REFGPUPARTICLESYSTEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19D5F0D0)
#define REFGPUPARTICLESYSTEM_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x19D5A060)
#define REFGPUPARTICLESYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19D59D50)
#define REFGPUPARTICLESYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19D59AA0)
#define REFGPUPARTICLESYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19D59100)
#define REFGPUPARTICLESYSTEM_PAUSE_OFFSET UNITYSDK_OFFSET(0x19D5A5B0)
#define REFGPUPARTICLESYSTEM_PLAY_OFFSET UNITYSDK_OFFSET(0x19D5A510)
#define REFGPUPARTICLESYSTEM_PREPAREPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x19D59190)
#define REFGPUPARTICLESYSTEM_PREPARESKINNEDMESH_OFFSET UNITYSDK_OFFSET(0x19D5FA40)
#define REFGPUPARTICLESYSTEM_REMOVEATTRACTOR_OFFSET UNITYSDK_OFFSET(0x19D5AB90)
#define REFGPUPARTICLESYSTEM_REMOVEBURST_OFFSET UNITYSDK_OFFSET(0x19D5AC70)
#define REFGPUPARTICLESYSTEM_REMOVELASTATTRACTOR_OFFSET UNITYSDK_OFFSET(0x19D5AC10)
#define REFGPUPARTICLESYSTEM_REMOVELASTBURST_OFFSET UNITYSDK_OFFSET(0x19D5ACF0)
#define REFGPUPARTICLESYSTEM_RENDERSKINNEDMESHEMITTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x19D5F9B0)
#define REFGPUPARTICLESYSTEM_RESEED_OFFSET UNITYSDK_OFFSET(0x19D5A880)
#define REFGPUPARTICLESYSTEM_RESETSEED_OFFSET UNITYSDK_OFFSET(0x19D603F0)
#define REFGPUPARTICLESYSTEM_RESTART_OFFSET UNITYSDK_OFFSET(0x19D5A5C0)
#define REFGPUPARTICLESYSTEM_SETATTRACTORKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D649A0)
#define REFGPUPARTICLESYSTEM_SETBLENDMODE_1_OFFSET UNITYSDK_OFFSET(0x19D641B0)
#define REFGPUPARTICLESYSTEM_SETBLENDMODE_OFFSET UNITYSDK_OFFSET(0x19D63BC0)
#define REFGPUPARTICLESYSTEM_SETCIRCULARFORCE_OFFSET UNITYSDK_OFFSET(0x19D63B30)
#define REFGPUPARTICLESYSTEM_SETCOLLISIONTYPE_OFFSET UNITYSDK_OFFSET(0x19D63040)
#define REFGPUPARTICLESYSTEM_SETEMISSIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D5EFD0)
#define REFGPUPARTICLESYSTEM_SETEMISSIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5EEF0)
#define REFGPUPARTICLESYSTEM_SETEMITFROMBASE_OFFSET UNITYSDK_OFFSET(0x19D64910)
#define REFGPUPARTICLESYSTEM_SETEMITFROMSHELL_OFFSET UNITYSDK_OFFSET(0x19D64880)
#define REFGPUPARTICLESYSTEM_SETEMITTERSHAPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D5C410)
#define REFGPUPARTICLESYSTEM_SETLAYER_OFFSET UNITYSDK_OFFSET(0x19D64720)
#define REFGPUPARTICLESYSTEM_SETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x19D5BB80)
#define REFGPUPARTICLESYSTEM_SETLIMITVELOCITY_OFFSET UNITYSDK_OFFSET(0x19D63AA0)
#define REFGPUPARTICLESYSTEM_SETMAINTEXTUREKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D5EAA0)
#define REFGPUPARTICLESYSTEM_SETMAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5E9C0)
#define REFGPUPARTICLESYSTEM_SETMESHTARGETKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D62F70)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D5EC30)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5EB20)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSVALUE_OFFSET UNITYSDK_OFFSET(0x19D5ECB0)
#define REFGPUPARTICLESYSTEM_SETNORMALKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D5EE70)
#define REFGPUPARTICLESYSTEM_SETNORMALMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5ED60)
#define REFGPUPARTICLESYSTEM_SETPARTICLETYPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D5C480)
#define REFGPUPARTICLESYSTEM_SETRANDOMINDEXKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D63420)
#define REFGPUPARTICLESYSTEM_SETREFRACTIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5CCB0)
#define REFGPUPARTICLESYSTEM_SETRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x19D59A70)
#define REFGPUPARTICLESYSTEM_SETROTATIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D63140)
#define REFGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x19D623A0)
#define REFGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D631C0)
#define REFGPUPARTICLESYSTEM_SETSHADOWSETTINGS_OFFSET UNITYSDK_OFFSET(0x19D5CAA0)
#define REFGPUPARTICLESYSTEM_SETSIMULATIONSPACE_OFFSET UNITYSDK_OFFSET(0x19D5C6E0)
#define REFGPUPARTICLESYSTEM_SETSIZEOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D61D60)
#define REFGPUPARTICLESYSTEM_SETTEXTURESHEETKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D63240)
#define REFGPUPARTICLESYSTEM_SETTURBULENCEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19D63070)
#define REFGPUPARTICLESYSTEM_SETUPDATATEXTURES_OFFSET UNITYSDK_OFFSET(0x19D612D0)
#define REFGPUPARTICLESYSTEM_SETUPSKINNEDMESHEMITTERCAMERA_OFFSET UNITYSDK_OFFSET(0x19D5F400)
#define REFGPUPARTICLESYSTEM_SETZBUFFER_1_OFFSET UNITYSDK_OFFSET(0x19D64820)
#define REFGPUPARTICLESYSTEM_SETZBUFFER_OFFSET UNITYSDK_OFFSET(0x19D647B0)
#define REFGPUPARTICLESYSTEM_STOP_OFFSET UNITYSDK_OFFSET(0x19D59B80)
#define REFGPUPARTICLESYSTEM_UPDATEAIRRESISTANCE_OFFSET UNITYSDK_OFFSET(0x19D5DA70)
#define REFGPUPARTICLESYSTEM_UPDATEAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x19D62640)
#define REFGPUPARTICLESYSTEM_UPDATEASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x19D5E940)
#define REFGPUPARTICLESYSTEM_UPDATECIRCULARFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D61520)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONCAMERA_OFFSET UNITYSDK_OFFSET(0x19D5CE80)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONMATRICES_OFFSET UNITYSDK_OFFSET(0x19D5DCE0)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONPLANES_OFFSET UNITYSDK_OFFSET(0x19D604D0)
#define REFGPUPARTICLESYSTEM_UPDATECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x19D61430)
#define REFGPUPARTICLESYSTEM_UPDATECOLOROVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D61180)
#define REFGPUPARTICLESYSTEM_UPDATEDEPTHCOLLISIONVALUES_OFFSET UNITYSDK_OFFSET(0x19D5CEF0)
#define REFGPUPARTICLESYSTEM_UPDATEDISTRIBUTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x19D5F920)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERMATRIX_OFFSET UNITYSDK_OFFSET(0x19D5CF70)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19D60F40)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5C1F0)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTER_OFFSET UNITYSDK_OFFSET(0x19D5A6B0)
#define REFGPUPARTICLESYSTEM_UPDATEFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D5DC00)
#define REFGPUPARTICLESYSTEM_UPDATEFREQUENCY_OFFSET UNITYSDK_OFFSET(0x19D62710)
#define REFGPUPARTICLESYSTEM_UPDATEGRAVITY_OFFSET UNITYSDK_OFFSET(0x19D5D050)
#define REFGPUPARTICLESYSTEM_UPDATEINDEXOFREFRACTION_OFFSET UNITYSDK_OFFSET(0x19D5CE00)
#define REFGPUPARTICLESYSTEM_UPDATEMAXVELOCITYOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D614F0)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETMATRIX_OFFSET UNITYSDK_OFFSET(0x19D5D220)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19D5D1E0)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5FF00)
#define REFGPUPARTICLESYSTEM_UPDATEMOTIONVECTORSTRENGTH_OFFSET UNITYSDK_OFFSET(0x19D60D60)
#define REFGPUPARTICLESYSTEM_UPDATEMOTIONVECTORTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D60DE0)
#define REFGPUPARTICLESYSTEM_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x19D62890)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x19D610F0)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLEMAINTEX_OFFSET UNITYSDK_OFFSET(0x19D60BF0)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLETYPEKEYWORDS_OFFSET UNITYSDK_OFFSET(0x19D5E5D0)
#define REFGPUPARTICLESYSTEM_UPDATEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x19D5E8A0)
#define REFGPUPARTICLESYSTEM_UPDATEROTATIONOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D61EC0)
#define REFGPUPARTICLESYSTEM_UPDATESIZEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D617B0)
#define REFGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERCAMERALAYER_OFFSET UNITYSDK_OFFSET(0x19D5F6E0)
#define REFGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERPOSITIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D5F710)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSIZEANDROTATION_OFFSET UNITYSDK_OFFSET(0x19D60E80)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSIZE_OFFSET UNITYSDK_OFFSET(0x19D63A60)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSPEEDANDLIFETIME_OFFSET UNITYSDK_OFFSET(0x19D5CF30)
#define REFGPUPARTICLESYSTEM_UPDATESTRETCHMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x19D5CD30)
#define REFGPUPARTICLESYSTEM_UPDATETEXTURESHEETDIMENSIONS_OFFSET UNITYSDK_OFFSET(0x19D62ED0)
#define REFGPUPARTICLESYSTEM_UPDATETIGHTNESS_OFFSET UNITYSDK_OFFSET(0x19D627F0)
#define REFGPUPARTICLESYSTEM_UPDATETRAILVALUES_OFFSET UNITYSDK_OFFSET(0x19D5E7D0)
#define REFGPUPARTICLESYSTEM_UPDATETURBULENCETEXTURE_OFFSET UNITYSDK_OFFSET(0x19D62500)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELDFILE_OFFSET UNITYSDK_OFFSET(0x19D62980)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELDMATRIX_OFFSET UNITYSDK_OFFSET(0x19D5D900)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELD_OFFSET UNITYSDK_OFFSET(0x19D625A0)
#define REFGPUPARTICLESYSTEM_UPDATEWORLDSPACEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x19D5D6D0)
#define REFGPUPARTICLESYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x19D59DA0)
#define REFGPUPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19D64BA0)

inline static constexpr unsigned int RefGPUParticleSystem_TypeDefinitionIndex = 39711;
