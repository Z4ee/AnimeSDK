...
#include "unitysdk/Class_1_36BB65AB28C47D14_Enum_3_C780BFBFED223F30_3.h"
...
#define CLASS_1_36BB65AB28C47D14_METHOD_1_19F1BB11890A12EF_OFFSET UNITYSDK_OFFSET(0x158519E0)
#define CLASS_1_36BB65AB28C47D14_METHOD_1_70E4F26A47681690_OFFSET UNITYSDK_OFFSET(0x15851B50)
#define CLASS_1_36BB65AB28C47D14_METHOD_1_972A94DAC39DEA69_OFFSET UNITYSDK_OFFSET(0x15852520)
#define CLASS_1_36BB65AB28C47D14_METHOD_1_B62C76ED985CE536_OFFSET UNITYSDK_OFFSET(0x15852100)
#define CLASS_1_36BB65AB28C47D14_METHOD_1_E8CD6026B7EF9225_OFFSET UNITYSDK_OFFSET(0x15851E40)
#define CLASS_1_36BB65AB28C47D14__CCTOR_OFFSET UNITYSDK_OFFSET(0x15851A90)
#define CLASS_1_36BB65AB28C47D14__CTOR_OFFSET UNITYSDK_OFFSET(0x15851850)

inline static constexpr unsigned int Class_1_36BB65AB28C47D14_TypeDefinitionIndex = 64526;

class Class_1_36BB65AB28C47D14 : public ::System::Object
{
public:
	static ::PipelineCamera::CameraSequence::CameraSequenceBlendSetting** StaticGet_Field_1_7()
	{
		return (::PipelineCamera::CameraSequence::CameraSequenceBlendSetting**)Il2CppClass::FromTypeDefinitionIndex(Class_1_36BB65AB28C47D14_TypeDefinitionIndex)->GetStaticField(0x484D0);
	}
	static ::Foundation::Unreal::FName* StaticGet_Field_1_6()
	{
		return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(Class_1_36BB65AB28C47D14_TypeDefinitionIndex)->GetStaticField(0x10C20);
	}
	::PipelineCamera::SubModule::CameraSequenceCollectionPlayer_1<::PipelineCamera::WorldBasicCameraData>* Field_1_0; // 0x10
	::MoleMole::Utils::TaskBasedEventCollection_1<::Class_1_36BB65AB28C47D14_Enum_3_C780BFBFED223F30_3>* Field_1_1; // 0x18
