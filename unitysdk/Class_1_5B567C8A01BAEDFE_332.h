...
#define CLASS_1_5B567C8A01BAEDFE_332_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1975A3F0)
#define CLASS_1_5B567C8A01BAEDFE_332_CLONE_OFFSET UNITYSDK_OFFSET(0x1975A200)
#define CLASS_1_5B567C8A01BAEDFE_332_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1975A300)
#define CLASS_1_5B567C8A01BAEDFE_332_EQUALS_OFFSET UNITYSDK_OFFSET(0x1975A270)
#define CLASS_1_5B567C8A01BAEDFE_332_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1975A350)
#define CLASS_1_5B567C8A01BAEDFE_332_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1975A440)
#define CLASS_1_5B567C8A01BAEDFE_332_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1975A410)
#define CLASS_1_5B567C8A01BAEDFE_332_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1975A150)
#define CLASS_1_5B567C8A01BAEDFE_332_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1975A1B0)
#define CLASS_1_5B567C8A01BAEDFE_332_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1975A380)
#define CLASS_1_5B567C8A01BAEDFE_332_WRITETO_OFFSET UNITYSDK_OFFSET(0x1975A3E0)
#define CLASS_1_5B567C8A01BAEDFE_332__CCTOR_OFFSET UNITYSDK_OFFSET(0x1975A490)
#define CLASS_1_5B567C8A01BAEDFE_332__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1975A1D0)
#define CLASS_1_5B567C8A01BAEDFE_332__CTOR_OFFSET UNITYSDK_OFFSET(0x1975A1C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_332_TypeDefinitionIndex = 31918;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_332*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_332_TypeDefinitionIndex)->GetStaticField(0x5A730);
	}
