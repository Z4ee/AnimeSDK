...
#define CLASS_1_5B567C8A01BAEDFE_356_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D8C0FA0)
#define CLASS_1_5B567C8A01BAEDFE_356_CLONE_OFFSET UNITYSDK_OFFSET(0x1D8C0C90)
#define CLASS_1_5B567C8A01BAEDFE_356_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D8C0DA0)
#define CLASS_1_5B567C8A01BAEDFE_356_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D8C0CD0)
#define CLASS_1_5B567C8A01BAEDFE_356_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D8C0F00)
#define CLASS_1_5B567C8A01BAEDFE_356_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D8C0FF0)
#define CLASS_1_5B567C8A01BAEDFE_356_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D8C0FC0)
#define CLASS_1_5B567C8A01BAEDFE_356_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D8C0C10)
#define CLASS_1_5B567C8A01BAEDFE_356_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D8C0C40)
#define CLASS_1_5B567C8A01BAEDFE_356_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D8C0F30)
#define CLASS_1_5B567C8A01BAEDFE_356_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D8C0F90)
#define CLASS_1_5B567C8A01BAEDFE_356__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8C1040)
#define CLASS_1_5B567C8A01BAEDFE_356__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D8C0C60)
#define CLASS_1_5B567C8A01BAEDFE_356__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8C0C50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_356*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_356_TypeDefinitionIndex)->GetStaticField(0x3EDF0);
	}
