...
#define CLASS_2_D74DAA5A749CC0EA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x151F3190)
#define CLASS_2_D74DAA5A749CC0EA_METHOD_2_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x151F35B0)
#define CLASS_2_D74DAA5A749CC0EA_METHOD_2_FAC1A2CEF0BE5FB4_OFFSET UNITYSDK_OFFSET(0x151F33B0)
#define CLASS_2_D74DAA5A749CC0EA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x151F3250)
#define CLASS_2_D74DAA5A749CC0EA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x151F3670)
#define CLASS_2_D74DAA5A749CC0EA_TICK_OFFSET UNITYSDK_OFFSET(0x151F36C0)
#define CLASS_2_D74DAA5A749CC0EA__CTOR_OFFSET UNITYSDK_OFFSET(0x151F3180)
...
public:
	...
	::RPG::GameCore::WaitRaidExitNotify* OFKGLJOAMLD; // 0x20
