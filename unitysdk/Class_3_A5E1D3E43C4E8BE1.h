...
#define CLASS_3_A5E1D3E43C4E8BE1_METHOD_3_387C40D074FB1980_OFFSET UNITYSDK_OFFSET(0x1C8D2DA0)
#define CLASS_3_A5E1D3E43C4E8BE1_METHOD_3_8C07A6A51F854693_OFFSET UNITYSDK_OFFSET(0x1C8D2E40)
#define CLASS_3_A5E1D3E43C4E8BE1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8D2E00)

inline static constexpr unsigned int Class_3_A5E1D3E43C4E8BE1_TypeDefinitionIndex = 19955;

class Class_3_A5E1D3E43C4E8BE1 : public ::RPG::GameCore::TaskConfig
{
public:
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* OFJJBPMHEJD; // 0x18
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x20
	::RPG::GameCore::SpecialStateType CMBLAFNGAOB; // 0x28
