...
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x1787CCC0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_0B52F2DF5119EE9C_OFFSET UNITYSDK_OFFSET(0x1787C690)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_130CFB61EF066AEC_OFFSET UNITYSDK_OFFSET(0x1787C0A0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_1C62453C3F38D037_OFFSET UNITYSDK_OFFSET(0x1787C500)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_1CC4F6DB6780B6F9_OFFSET UNITYSDK_OFFSET(0x1787CEA0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_2A6AEF91C7092C97_OFFSET UNITYSDK_OFFSET(0x1787CBC0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_2F69830808EBC78F_OFFSET UNITYSDK_OFFSET(0x1787BBE0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_4DFAC2FFB6CD6806_OFFSET UNITYSDK_OFFSET(0x1787C2A0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x1787C320)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_6055A93732CC885D_OFFSET UNITYSDK_OFFSET(0x1787C1D0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_84EAB34EABC7F508_OFFSET UNITYSDK_OFFSET(0x1787BDB0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0x1787BF30)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1787C4C0)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1787C240)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1787C480)
#define CLASS_1_4BA5BF6D6AE6A5EC_METHOD_1_E523145A68B8EA84_OFFSET UNITYSDK_OFFSET(0x1787C760)
#define CLASS_1_4BA5BF6D6AE6A5EC__CTOR_OFFSET UNITYSDK_OFFSET(0x1787D0C0)

inline static constexpr unsigned int Class_1_4BA5BF6D6AE6A5EC_TypeDefinitionIndex = 48530;

class Class_1_4BA5BF6D6AE6A5EC : public ::System::Object
{
public:
	::System::String* CDEEHGCEOKN; // 0x10
	::UnityEngine::Transform* ACNOFONLALP; // 0x18
	::RPG::Client::MonoEffectPluginFollow* CDIMAMFFGMM; // 0x20
	::System::String* GFNAPNFFGPJ; // 0x28
	::RPGTools::MonoTimelineEffect* ICFIFHFPCJB; // 0x30
	::UnityEngine::Transform* CIMHBBGGADG; // 0x38
	::UnityEngine::Object* NCPNKDBIINJ; // 0x40
	::System::String* BJCBMNHOAGO; // 0x48
	::Class_1_4B703F2764047929* PGNKDKLMBJJ; // 0x50
	::RPG::Client::MonoEffect* HJBEGIDAMBP; // 0x58
	::UnityEngine::Vector3 LJDEHCKDLHF; // 0x60
	::System::Boolean HEOAJBPIPAH; // 0x6C
	::UnityEngine::Vector3 BJFMJCJELPC; // 0x70
