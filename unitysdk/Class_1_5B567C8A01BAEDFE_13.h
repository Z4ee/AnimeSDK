...
#define CLASS_1_5B567C8A01BAEDFE_13_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A265470)
#define CLASS_1_5B567C8A01BAEDFE_13_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2652E0)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A265380)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A265320)
#define CLASS_1_5B567C8A01BAEDFE_13_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2653D0)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2654C0)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A265490)
#define CLASS_1_5B567C8A01BAEDFE_13_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A265260)
#define CLASS_1_5B567C8A01BAEDFE_13_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A265290)
#define CLASS_1_5B567C8A01BAEDFE_13_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A265400)
#define CLASS_1_5B567C8A01BAEDFE_13_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A265460)
#define CLASS_1_5B567C8A01BAEDFE_13__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A265510)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2652B0)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2652A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex = 24612;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_13*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex)->GetStaticField(0x458E0);
	}
