...
#define CLASS_1_5B567C8A01BAEDFE_13_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CFC1B90)
#define CLASS_1_5B567C8A01BAEDFE_13_CLONE_OFFSET UNITYSDK_OFFSET(0x1CFC1880)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CFC1990)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CFC18C0)
#define CLASS_1_5B567C8A01BAEDFE_13_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CFC1AF0)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CFC1BE0)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CFC1BB0)
#define CLASS_1_5B567C8A01BAEDFE_13_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CFC1800)
#define CLASS_1_5B567C8A01BAEDFE_13_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1830)
#define CLASS_1_5B567C8A01BAEDFE_13_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CFC1B20)
#define CLASS_1_5B567C8A01BAEDFE_13_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CFC1B80)
#define CLASS_1_5B567C8A01BAEDFE_13__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1C30)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CFC1850)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1840)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex = 25106;

class Class_1_5B567C8A01BAEDFE_13 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_13*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_13*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex)->GetStaticField(0x47FE0);
	}
