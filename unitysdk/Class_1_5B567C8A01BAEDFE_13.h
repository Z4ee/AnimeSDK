...
#define CLASS_1_5B567C8A01BAEDFE_13_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1945DC20)
#define CLASS_1_5B567C8A01BAEDFE_13_CLONE_OFFSET UNITYSDK_OFFSET(0x1945DA90)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1945DB30)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_OFFSET UNITYSDK_OFFSET(0x1945DAD0)
#define CLASS_1_5B567C8A01BAEDFE_13_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1945DB80)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1945DC70)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1945DC40)
#define CLASS_1_5B567C8A01BAEDFE_13_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1945DA10)
#define CLASS_1_5B567C8A01BAEDFE_13_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1945DA40)
#define CLASS_1_5B567C8A01BAEDFE_13_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1945DBB0)
#define CLASS_1_5B567C8A01BAEDFE_13_WRITETO_OFFSET UNITYSDK_OFFSET(0x1945DC10)
#define CLASS_1_5B567C8A01BAEDFE_13__CCTOR_OFFSET UNITYSDK_OFFSET(0x1945DCC0)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1945DA60)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_OFFSET UNITYSDK_OFFSET(0x1945DA50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex = 24751;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_13*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex)->GetStaticField(0x17230);
	}
