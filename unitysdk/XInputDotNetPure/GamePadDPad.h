...
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x784260)
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x12370)
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x784470)
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_UP_OFFSET UNITYSDK_OFFSET(0x19050)
#define XINPUTDOTNETPURE_GAMEPADDPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x784430)
