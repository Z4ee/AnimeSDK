...
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_A_OFFSET UNITYSDK_OFFSET(0xF020)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_BACK_OFFSET UNITYSDK_OFFSET(0x784260)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_B_OFFSET UNITYSDK_OFFSET(0xF6A0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_LEFTSHOULDER_OFFSET UNITYSDK_OFFSET(0x7845E0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_LEFTSTICK_OFFSET UNITYSDK_OFFSET(0x12370)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_RIGHTSHOULDER_OFFSET UNITYSDK_OFFSET(0xF080)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_RIGHTSTICK_OFFSET UNITYSDK_OFFSET(0x784470)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_START_OFFSET UNITYSDK_OFFSET(0x19050)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_X_OFFSET UNITYSDK_OFFSET(0xF640)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_Y_OFFSET UNITYSDK_OFFSET(0xFDB0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS__CTOR_OFFSET UNITYSDK_OFFSET(0x784590)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadButtons_TypeDefinitionIndex = 39484;
