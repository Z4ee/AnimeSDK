...
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_A_OFFSET UNITYSDK_OFFSET(0x7A7FB0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_BACK_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_B_OFFSET UNITYSDK_OFFSET(0x7A7FC0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_LEFTSHOULDER_OFFSET UNITYSDK_OFFSET(0x691EF0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_LEFTSTICK_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_RIGHTSHOULDER_OFFSET UNITYSDK_OFFSET(0x7A7FA0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_RIGHTSTICK_OFFSET UNITYSDK_OFFSET(0x7A7E30)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_START_OFFSET UNITYSDK_OFFSET(0x167710)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_X_OFFSET UNITYSDK_OFFSET(0x7A7FD0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_Y_OFFSET UNITYSDK_OFFSET(0x7A7FE0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS__CTOR_OFFSET UNITYSDK_OFFSET(0x7A7F50)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadButtons_TypeDefinitionIndex = 38625;
