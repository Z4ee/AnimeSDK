...
#define XINPUTDOTNETPURE_GAMEPADSTATE_GET_BUTTONS_OFFSET UNITYSDK_OFFSET(0x7A80A0)
#define XINPUTDOTNETPURE_GAMEPADSTATE_GET_DPAD_OFFSET UNITYSDK_OFFSET(0x7A80C0)
#define XINPUTDOTNETPURE_GAMEPADSTATE_GET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x167D30)
#define XINPUTDOTNETPURE_GAMEPADSTATE_GET_PACKETNUMBER_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define XINPUTDOTNETPURE_GAMEPADSTATE_GET_THUMBSTICKS_OFFSET UNITYSDK_OFFSET(0x7A80E0)
#define XINPUTDOTNETPURE_GAMEPADSTATE_GET_TRIGGERS_OFFSET UNITYSDK_OFFSET(0x7A80D0)
#define XINPUTDOTNETPURE_GAMEPADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A8070)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadState_TypeDefinitionIndex = 38630;
