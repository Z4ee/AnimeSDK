...
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_STICKVALUE_GET_VECTOR_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_STICKVALUE_GET_X_OFFSET UNITYSDK_OFFSET(0x167F50)
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_STICKVALUE_GET_Y_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_STICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8510)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadThumbSticks_StickValue_TypeDefinitionIndex = 38628;
