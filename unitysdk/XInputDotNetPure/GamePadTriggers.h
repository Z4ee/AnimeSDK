...
#define XINPUTDOTNETPURE_GAMEPADTRIGGERS__CTOR_OFFSET UNITYSDK_OFFSET(0x2A140)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadTriggers_TypeDefinitionIndex = 37089;
