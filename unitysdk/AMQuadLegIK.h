...
#define AMQUADLEGIK_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x168CA2F0)
#define AMQUADLEGIK_GET_ENABLEDEBUGHIPHIT_OFFSET UNITYSDK_OFFSET(0x168C8170)
#define AMQUADLEGIK_GET_ENABLEDEBUGNOTLOCKFOOT_OFFSET UNITYSDK_OFFSET(0x168C8190)
#define AMQUADLEGIK_GET_ENABLEDEBUGSHOWSKELETON_OFFSET UNITYSDK_OFFSET(0x168C8150)
#define AMQUADLEGIK_GET_LASTFRAMETHETA_OFFSET UNITYSDK_OFFSET(0x168C8130)
#define AMQUADLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x168C8320)
#define AMQUADLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x168CA240)
#define AMQUADLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x168C8800)
#define AMQUADLEGIK_QUADAMLEGIKPASS_OFFSET UNITYSDK_OFFSET(0x168C8A00)
#define AMQUADLEGIK_SET_ENABLEDEBUGHIPHIT_OFFSET UNITYSDK_OFFSET(0x168C8180)
#define AMQUADLEGIK_SET_ENABLEDEBUGNOTLOCKFOOT_OFFSET UNITYSDK_OFFSET(0x168C81A0)
#define AMQUADLEGIK_SET_ENABLEDEBUGSHOWSKELETON_OFFSET UNITYSDK_OFFSET(0x168C8160)
#define AMQUADLEGIK_SET_LASTFRAMETHETA_OFFSET UNITYSDK_OFFSET(0x168C8140)
#define AMQUADLEGIK_START_OFFSET UNITYSDK_OFFSET(0x168C81B0)
#define AMQUADLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x168C8970)
#define AMQUADLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x168CA5D0)

inline static constexpr unsigned int AMQuadLegIK_TypeDefinitionIndex = 53187;
