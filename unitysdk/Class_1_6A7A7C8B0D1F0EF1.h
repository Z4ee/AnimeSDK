...
#define CLASS_1_6A7A7C8B0D1F0EF1_METHOD_1_60082323116883CC_OFFSET UNITYSDK_OFFSET(0x1571FA30)
#define CLASS_1_6A7A7C8B0D1F0EF1_METHOD_1_A3CD8010EE7E2C0B_OFFSET UNITYSDK_OFFSET(0x1571F9D0)
#define CLASS_1_6A7A7C8B0D1F0EF1__CTOR_OFFSET UNITYSDK_OFFSET(0x15720120)

inline static constexpr unsigned int Class_1_6A7A7C8B0D1F0EF1_TypeDefinitionIndex = 80618;
