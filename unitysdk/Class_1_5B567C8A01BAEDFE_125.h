...
#define CLASS_1_5B567C8A01BAEDFE_125_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x197B1CB0)
#define CLASS_1_5B567C8A01BAEDFE_125_CLONE_OFFSET UNITYSDK_OFFSET(0x197B1B20)
#define CLASS_1_5B567C8A01BAEDFE_125_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x197B1BC0)
#define CLASS_1_5B567C8A01BAEDFE_125_EQUALS_OFFSET UNITYSDK_OFFSET(0x197B1B60)
#define CLASS_1_5B567C8A01BAEDFE_125_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197B1C10)
#define CLASS_1_5B567C8A01BAEDFE_125_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x197B1D00)
#define CLASS_1_5B567C8A01BAEDFE_125_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x197B1CD0)
#define CLASS_1_5B567C8A01BAEDFE_125_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x197B1AA0)
#define CLASS_1_5B567C8A01BAEDFE_125_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x197B1AD0)
#define CLASS_1_5B567C8A01BAEDFE_125_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197B1C40)
#define CLASS_1_5B567C8A01BAEDFE_125_WRITETO_OFFSET UNITYSDK_OFFSET(0x197B1CA0)
#define CLASS_1_5B567C8A01BAEDFE_125__CCTOR_OFFSET UNITYSDK_OFFSET(0x197B1D50)
#define CLASS_1_5B567C8A01BAEDFE_125__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197B1AF0)
#define CLASS_1_5B567C8A01BAEDFE_125__CTOR_OFFSET UNITYSDK_OFFSET(0x197B1AE0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_125_TypeDefinitionIndex = 27115;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_125*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_125_TypeDefinitionIndex)->GetStaticField(0x1E260);
	}
