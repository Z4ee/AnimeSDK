...
#define CLASS_3_DDCBE1DF9A72F9EF_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12C6CB50)
#define CLASS_3_DDCBE1DF9A72F9EF_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12C6CBD0)
#define CLASS_3_DDCBE1DF9A72F9EF_INVOKE_OFFSET UNITYSDK_OFFSET(0x12C6C5B0)
#define CLASS_3_DDCBE1DF9A72F9EF__CTOR_OFFSET UNITYSDK_OFFSET(0x12C6C5A0)

inline static constexpr unsigned int Class_3_DDCBE1DF9A72F9EF_TypeDefinitionIndex = 47908;
