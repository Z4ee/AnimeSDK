...
#define STRUCT_2_8575AB9DC5C5268F_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x3B7E3A0)
#define STRUCT_2_8575AB9DC5C5268F__CTOR_OFFSET UNITYSDK_OFFSET(0x3B7E340)

inline static constexpr unsigned int Struct_2_8575AB9DC5C5268F_TypeDefinitionIndex = 41886;

struct alignas(4) Struct_2_8575AB9DC5C5268F
{
	::UnityEngine::Vector3 EAKMJDBLGKN; // 0x10
	::UnityEngine::Vector3 NBHLHKJLOAE; // 0x1C
