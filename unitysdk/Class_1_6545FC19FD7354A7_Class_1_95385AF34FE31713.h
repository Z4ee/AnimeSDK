...
#define CLASS_1_6545FC19FD7354A7_CLASS_1_95385AF34FE31713__CTOR_OFFSET UNITYSDK_OFFSET(0x134FB3E0)
...
{
public:
	::RPG::GameCore::CreateCharacter* LPLGFNAGHON; // 0x10
	::System::String* LIGGALJGCFH; // 0x18
	::RPG::GameCore::GameEntity* GGKGFABFGFE; // 0x20
	::System::String* OJDMHBKCEEM; // 0x28
	::System::String* EPGBFPKDFNF; // 0x30
	::Class_1_6545FC19FD7354A7_StoryCharacterType FMCILNHKMNO; // 0x38
	::RPG::GameCore::NPCSubType KCEMHIBMNGH; // 0x3C
