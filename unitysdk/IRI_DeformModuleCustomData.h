...
#define IRI_DEFORMMODULECUSTOMDATA_COLLECTOBJECT_OFFSET UNITYSDK_OFFSET(0x18E6CB00)
#define IRI_DEFORMMODULECUSTOMDATA_ENCODEDATA_OFFSET UNITYSDK_OFFSET(0x18E6EA50)
#define IRI_DEFORMMODULECUSTOMDATA_GETELEMENTMATRIXLIST_OFFSET UNITYSDK_OFFSET(0x18E6E5B0)
#define IRI_DEFORMMODULECUSTOMDATA_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x18E6C550)
#define IRI_DEFORMMODULECUSTOMDATA_GET_MPB_OFFSET UNITYSDK_OFFSET(0x18E6C7C0)
#define IRI_DEFORMMODULECUSTOMDATA_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18E6EC30)
#define IRI_DEFORMMODULECUSTOMDATA_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x18E6FD60)
#define IRI_DEFORMMODULECUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18E6E560)
#define IRI_DEFORMMODULECUSTOMDATA_RESETCUSTOMDEFORMBOUNDS_OFFSET UNITYSDK_OFFSET(0x18E6C4F0)
#define IRI_DEFORMMODULECUSTOMDATA_RESETDATA_OFFSET UNITYSDK_OFFSET(0x18E6DAF0)
#define IRI_DEFORMMODULECUSTOMDATA_SETSIZE_OFFSET UNITYSDK_OFFSET(0x18E6ECC0)
#define IRI_DEFORMMODULECUSTOMDATA_SET_MPB_OFFSET UNITYSDK_OFFSET(0x18E6C830)
#define IRI_DEFORMMODULECUSTOMDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E6FF30)
#define IRI_DEFORMMODULECUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6FF00)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(IRI_DeformModuleCustomData_TypeDefinitionIndex)->GetStaticField(0x10760);
	}
