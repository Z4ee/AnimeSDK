...
#define CLASS_2_7FC6A0FDC1765FA8_METHOD_2_78C62398E94F0FB1_OFFSET UNITYSDK_OFFSET(0x16260540)
#define CLASS_2_7FC6A0FDC1765FA8_METHOD_2_D3271A54A24C6AD0_OFFSET UNITYSDK_OFFSET(0x16260420)
#define CLASS_2_7FC6A0FDC1765FA8__CTOR_OFFSET UNITYSDK_OFFSET(0x162606C0)
#define CLASS_2_7FC6A0FDC1765FA8__ONBIND_OFFSET UNITYSDK_OFFSET(0x16260380)

inline static constexpr unsigned int Class_2_7FC6A0FDC1765FA8_TypeDefinitionIndex = 72202;

class Class_2_7FC6A0FDC1765FA8 : public ::Class_1_34917908B7833130
{
public:
	::RPG::Client::MonoUIColorSwitcher* NFNKELKMJPJ; // 0x60
	::UnityEngine::Sprite* EKHDCANFFIL; // 0x68
	::UnityEngine::UI::SmoothMask* LMAMGADEJDM; // 0x70
	::RPG::Client::GridFightAugmentConfig* IGHAHBNLIJA; // 0x78
	::Class_1_9015B34004B876E5* AKEKCBLCBEK; // 0x80
