...
#define CLASS_1_8F8B7368C48977DE_CLEAR_OFFSET UNITYSDK_OFFSET(0xB9ECA60)
#define CLASS_1_8F8B7368C48977DE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9ECAB0)
...
public:
	...
	::RPG::GameCore::GameEntity* OICNIIBMFLK; // 0x18
	::System::Single GCJMFBKLGHI; // 0x20
	::RPG::GameCore::AdventureMoveOnNavMeshFaceToType OGMHHHNEEGI; // 0x24
	::System::Single MLINDPFAGFJ; // 0x28
	::System::Single JMPPNFDHDPJ; // 0x2C
