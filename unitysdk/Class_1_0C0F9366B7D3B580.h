...
#define CLASS_1_0C0F9366B7D3B580_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E425690)
#define CLASS_1_0C0F9366B7D3B580_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4251A0)
#define CLASS_1_0C0F9366B7D3B580_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4252E0)
#define CLASS_1_0C0F9366B7D3B580_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E425280)
#define CLASS_1_0C0F9366B7D3B580_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E425380)
#define CLASS_1_0C0F9366B7D3B580_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E425A20)
#define CLASS_1_0C0F9366B7D3B580_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E425950)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E425230)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1E425250)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E425210)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E425020)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1E425200)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1E425270)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E425240)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1E425260)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E425220)
#define CLASS_1_0C0F9366B7D3B580_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1E4251F0)
#define CLASS_1_0C0F9366B7D3B580_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E425080)
#define CLASS_1_0C0F9366B7D3B580_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E425410)
#define CLASS_1_0C0F9366B7D3B580_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E425470)
#define CLASS_1_0C0F9366B7D3B580__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E425B40)
#define CLASS_1_0C0F9366B7D3B580__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4250E0)
#define CLASS_1_0C0F9366B7D3B580__CTOR_OFFSET UNITYSDK_OFFSET(0x1E425090)

inline static constexpr unsigned int Class_1_0C0F9366B7D3B580_TypeDefinitionIndex = 25251;

class Class_1_0C0F9366B7D3B580 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_0C0F9366B7D3B580*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0C0F9366B7D3B580*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0C0F9366B7D3B580_TypeDefinitionIndex)->GetStaticField(0x9FB0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_23C1B7E6B450FFB8_3*>** StaticGet_FCNMONMFJEF()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_23C1B7E6B450FFB8_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0C0F9366B7D3B580_TypeDefinitionIndex)->GetStaticField(0x9FB8);
	}
	// static const ::System::Int32 GDFHGOOLLFD = 0x1; // 0x0
	// static const ::System::Int32 NOBLDDEFEKI = 0x2; // 0x0
	// static const ::System::Int32 JJDOFLLPDJE = 0x3; // 0x0
	// static const ::System::Int32 AOEBNCAILPJ = 0x4; // 0x0
	// static const ::System::Int32 GEJEJNNMGGP = 0x5; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_23C1B7E6B450FFB8_3*>* AFNHANNCAMC; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::UInt32 DNKADAFBILN; // 0x20
	::System::UInt32 NPFBAFODCBI; // 0x24
	::System::UInt32 FOBLPJCIGJE; // 0x28
	::Enum_3_01618AD0437C8486_1 GMPNCOBOFDM; // 0x2C
