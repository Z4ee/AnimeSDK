...
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1105FCE0)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_4E5B7B892608BDE0_OFFSET UNITYSDK_OFFSET(0x11060070)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_63E8F19CFED33AB3_OFFSET UNITYSDK_OFFSET(0x1105FFE0)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x110602E0)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_8B649337F27852CC_OFFSET UNITYSDK_OFFSET(0x1105FF20)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_93852A59E9597849_OFFSET UNITYSDK_OFFSET(0x1105FE90)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_9DBC9E6BCD10AD9A_OFFSET UNITYSDK_OFFSET(0x1105FBF0)
#define CLASS_1_D2B8D50DD9833CFC_METHOD_1_E8C317B86F9B81D9_OFFSET UNITYSDK_OFFSET(0x11060330)
#define CLASS_1_D2B8D50DD9833CFC__CTOR_OFFSET UNITYSDK_OFFSET(0x110603E0)

inline static constexpr unsigned int Class_1_D2B8D50DD9833CFC_TypeDefinitionIndex = 56986;

class Class_1_D2B8D50DD9833CFC : public ::System::Object
{
public:
	::Il2CppArray<::UnityEngine::Plane>* Field_1_2; // 0x10
	::UnityEngine::Matrix4x4 Field_1_0; // 0x18
	::UnityEngine::Matrix4x4 Field_1_1; // 0x58
	::System::Boolean Field_1_4; // 0x98
