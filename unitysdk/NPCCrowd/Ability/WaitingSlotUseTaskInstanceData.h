...
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xF860EA0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x66A390)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x66A3F0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x463A20)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x66A450)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xF860FD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotUseTaskInstanceData_TypeDefinitionIndex = 69112;

	struct alignas(1) WaitingSlotUseTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotUseTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x40F00);
		}
