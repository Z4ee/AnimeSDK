...
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5A0EA0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x12D09ED0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x7BF160)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x12604AF0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x12604A50)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7BEB30)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7BF180)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x7BEB20)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_LINK_OFFSET UNITYSDK_OFFSET(0x12604990)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5A0EA0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x7BEF90)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7BF090)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x7BF010)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x7BEF10)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x7BEE10)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x7BEC90)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x7BEC10)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x7BED90)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x7BED10)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x7BEB90)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x7BEE90)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x7BEAA0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x12604DF0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7BF1E0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x12D0A380)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int SetStateMachineParamTask_TypeDefinitionIndex = 78993;

	struct alignas(4) SetStateMachineParamTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(SetStateMachineParamTask_TypeDefinitionIndex)->GetStaticField(0x43230);
		}
		...
		::NPCCrowd::Animation::NPCUnionAnimatorManager_NPCAnimationStateParams key; // 0x34
