...
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5CA730)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xFFABB20)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x696960)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xFFAAEE0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xFFAAE40)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x696330)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x696980)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x696320)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_LINK_OFFSET UNITYSDK_OFFSET(0xFFAAD80)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5CA730)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x696790)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x696890)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x696810)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x696710)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x696610)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x696490)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x696410)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x696590)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x696510)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x696390)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x696690)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6962A0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xFFAB1E0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6969E0)
#define NPCCROWD_ABILITY_SETSTATEMACHINEPARAMTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xFFABFD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int SetStateMachineParamTask_TypeDefinitionIndex = 67470;

	struct alignas(4) SetStateMachineParamTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(SetStateMachineParamTask_TypeDefinitionIndex)->GetStaticField(0x41AA0);
		}
