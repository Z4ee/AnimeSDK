...
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6DB220)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x246290)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x109F4CF0)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6DB1C0)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6DB230)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x6DB220)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x246290)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x364380)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6DB290)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x109F4E20)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int MoveToTaskInstanceData_TypeDefinitionIndex = 46718;

	struct alignas(4) MoveToTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(MoveToTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x43710);
		}
