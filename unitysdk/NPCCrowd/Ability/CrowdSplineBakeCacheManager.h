...
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_DISPOSENATIVESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xFFA9B70)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFFA71A0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GETSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xFFA6DE0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_ACTIVESPLINEFOLLOWCOUNT_OFFSET UNITYSDK_OFFSET(0xFFA6D60)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_DISTANCES_OFFSET UNITYSDK_OFFSET(0xFFA6D30)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_HASACTIVESPLINEFOLLOW_OFFSET UNITYSDK_OFFSET(0xFFA6D50)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_HASCACHE_OFFSET UNITYSDK_OFFSET(0xFFA6D70)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_NORMALS_OFFSET UNITYSDK_OFFSET(0xFFA6D20)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0xFFA6ED0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0xFFA6D00)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_RANGES_OFFSET UNITYSDK_OFFSET(0xFFA6D40)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_GET_TANGENTS_OFFSET UNITYSDK_OFFSET(0xFFA6D10)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_HANDLESTARTSPLINEFOLLOWCOMMAND_OFFSET UNITYSDK_OFFSET(0xFFA7D80)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_HANDLESTOPSPLINEFOLLOWCOMMAND_OFFSET UNITYSDK_OFFSET(0xFFA81F0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_NAVMESHTOSPLINEFOLLOWASYNC_OFFSET UNITYSDK_OFFSET(0xFFA7410)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_ONABILITYREMOVED_OFFSET UNITYSDK_OFFSET(0xFFA7820)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_PROCESSPENDINGCOMMANDS_OFFSET UNITYSDK_OFFSET(0xFFA7A40)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_REBUILDSNAPSHOTIFNEEDED_OFFSET UNITYSDK_OFFSET(0xFFA84F0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_RECOUNTACTIVESPLINEFOLLOWCOUNT_OFFSET UNITYSDK_OFFSET(0xFFA8BE0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_RELEASEENTRYARRAYS_OFFSET UNITYSDK_OFFSET(0xFFA98A0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_RELEASESINGLETON_OFFSET UNITYSDK_OFFSET(0xFFA7140)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_RELEASE_OFFSET UNITYSDK_OFFSET(0xFFA78E0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_RESOLVESPLINEFOLLOWSPEED_OFFSET UNITYSDK_OFFSET(0xFFAA070)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_STARTSPLINEFOLLOW_OFFSET UNITYSDK_OFFSET(0xFFA74D0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_STOPSPLINEFOLLOW_OFFSET UNITYSDK_OFFSET(0xFFA76C0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_TRYACQUIRE_OFFSET UNITYSDK_OFFSET(0xFFA8D30)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_TRYBAKESPLINEDATA_OFFSET UNITYSDK_OFFSET(0xFFA90A0)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER_TRYGETNEARESTDISTANCEONSPLINE_OFFSET UNITYSDK_OFFSET(0xFFA9C70)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xFFA6F70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CrowdSplineBakeCacheManager_TypeDefinitionIndex = 84854;
	...
	public:
		...
		{
			return (::NPCCrowd::Ability::CrowdSplineBakeCacheManager**)Il2CppClass::FromTypeDefinitionIndex(CrowdSplineBakeCacheManager_TypeDefinitionIndex)->GetStaticField(0x419F0);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _cacheIdBySplineInstanceId; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::Ability::CrowdSplineBakeEntry*>* _entriesByCacheId; // 0x20
		::System::Collections::Generic::List_1<::NPCCrowd::Ability::CrowdSplineBakeCacheManager_SplineFollowCommand>* _pendingSplineFollowCommands; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* _pendingNavmeshSplineFollows; // 0x30
		::System::Int32 _activeSplineFollowCount; // 0x38
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> _tangents; // 0x40
		::Unity::Collections::NativeHashMap_2<::System::Int32, ::NPCCrowd::Ability::CrowdSplineBakeRange> _ranges; // 0x50
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> _normals; // 0x60
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> _positions; // 0x70
		::Unity::Collections::NativeArray_1<::System::Single> _distances; // 0x80
		::System::Boolean _snapshotDirty; // 0x90
		::System::Int32 _nextCacheId; // 0x94
