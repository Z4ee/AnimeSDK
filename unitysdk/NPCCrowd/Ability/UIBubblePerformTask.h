...
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x697170)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xFFAD4F0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x697150)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xFFAC1F0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xFFAC790)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xFFAC150)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x696B20)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6971D0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x696B10)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_LINK_OFFSET UNITYSDK_OFFSET(0xFFAC090)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x697170)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x696F80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x697080)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x697000)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x696F00)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x696E00)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x696C80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x696C00)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x696D80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x696D00)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x696B80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x696E80)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x696A90)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_TICK_OFFSET UNITYSDK_OFFSET(0xFFACBB0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x697230)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xFFAD980)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int UIBubblePerformTask_TypeDefinitionIndex = 61341;

	struct alignas(8) UIBubblePerformTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(UIBubblePerformTask_TypeDefinitionIndex)->GetStaticField(0x41AB0);
		}
