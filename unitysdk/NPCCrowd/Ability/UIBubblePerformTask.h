...
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7BF970)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x12D0B8A0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x7BF950)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x12D0A5A0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x12D0AB40)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x12D0A500)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7BF320)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7BF9D0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x7BF310)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_LINK_OFFSET UNITYSDK_OFFSET(0x12D0A440)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7BF970)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x7BF780)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7BF880)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x7BF800)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x7BF700)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x7BF600)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x7BF480)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x7BF400)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x7BF580)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x7BF500)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x7BF380)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x7BF680)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x7BF290)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_TICK_OFFSET UNITYSDK_OFFSET(0x12D0AF60)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7BFA30)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x12D0BD50)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int UIBubblePerformTask_TypeDefinitionIndex = 65886;

	struct alignas(8) UIBubblePerformTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(UIBubblePerformTask_TypeDefinitionIndex)->GetStaticField(0x43240);
		}
