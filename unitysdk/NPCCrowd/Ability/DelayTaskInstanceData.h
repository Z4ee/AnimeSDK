...
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463B40)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x951DFB0)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x463AE0)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x463B60)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463B40)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x463B50)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463BC0)
#define NPCCROWD_ABILITY_DELAYTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x951E0E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DelayTaskInstanceData_TypeDefinitionIndex = 43294;

	struct alignas(4) DelayTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(DelayTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x51130);
		}
