...
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x106FC2D0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x106FC270)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0x106FC200)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0x106FC340)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x106FC3C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_WaitingSlotUseTask_TypeDefinitionIndex = 81912;

	class VirtualProxy_WaitingSlotUseTask : public ::NPCCrowd::Ability::VirtualProxy_StateTreeCrowdTaskBase
	{
	public:
		::System::Void _ctor()
		{
