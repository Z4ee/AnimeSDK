...
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x697490)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xF8514E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x697A40)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xF850470)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xF850800)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF8503D0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x4B6B00)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x4B6AA0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4B6A40)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x697640)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x697A60)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4B6B60)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x697630)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_LINK_OFFSET UNITYSDK_OFFSET(0xF850130)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x697490)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_RESET_OFFSET UNITYSDK_OFFSET(0x4B6E10)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x697920)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x6979C0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x697970)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6978D0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x697830)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x697740)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x6976F0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x6977E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x697790)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x6976A0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x697880)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6975E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_TICK_OFFSET UNITYSDK_OFFSET(0xF8508C0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x697AC0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xF851930)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotMoveToSlotTask_TypeDefinitionIndex = 74277;

	struct alignas(4) WaitingSlotMoveToSlotTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotMoveToSlotTask_TypeDefinitionIndex)->GetStaticField(0x45F60);
		}
