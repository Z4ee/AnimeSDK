...
#define NPCCROWD_ABILITY_REACTIONTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_REACTIONTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5A25B0)
#define NPCCROWD_ABILITY_REACTIONTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xF601B00)
#define NPCCROWD_ABILITY_REACTIONTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x652C00)
#define NPCCROWD_ABILITY_REACTIONTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_REACTIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF600F60)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6525D0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x652C20)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x6525C0)
#define NPCCROWD_ABILITY_REACTIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0xF600EA0)
#define NPCCROWD_ABILITY_REACTIONTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_REACTIONTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5A25B0)
#define NPCCROWD_ABILITY_REACTIONTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x652A30)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x652B30)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x652AB0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6529B0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x6528B0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x652730)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x6526B0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x652830)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x6527B0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x652630)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x652930)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x652540)
#define NPCCROWD_ABILITY_REACTIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0xF601000)
#define NPCCROWD_ABILITY_REACTIONTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_REACTIONTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x652C80)
#define NPCCROWD_ABILITY_REACTIONTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xF601F80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int ReactionTask_TypeDefinitionIndex = 53110;

	struct alignas(4) ReactionTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(ReactionTask_TypeDefinitionIndex)->GetStaticField(0x3D810);
		}
