...
#define NPCCROWD_ABILITY_REACTIONTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_REACTIONTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x50C120)
#define NPCCROWD_ABILITY_REACTIONTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xFB54130)
#define NPCCROWD_ABILITY_REACTIONTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6B5050)
#define NPCCROWD_ABILITY_REACTIONTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_REACTIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xFB537F0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x4B6B00)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x4B6AA0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4B6A40)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6B4C50)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6B5070)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4B6B60)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x6B4C40)
#define NPCCROWD_ABILITY_REACTIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0xFB53720)
#define NPCCROWD_ABILITY_REACTIONTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_REACTIONTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x50C120)
#define NPCCROWD_ABILITY_REACTIONTASK_RESET_OFFSET UNITYSDK_OFFSET(0x4B6E10)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x6B4F30)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x6B4FD0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x6B4F80)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6B4EE0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x6B4E40)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x6B4D50)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x6B4D00)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x6B4DF0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x6B4DA0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x6B4CB0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x6B4E90)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6B4BF0)
#define NPCCROWD_ABILITY_REACTIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0xFB53890)
#define NPCCROWD_ABILITY_REACTIONTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_REACTIONTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6B50D0)
#define NPCCROWD_ABILITY_REACTIONTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xFB545A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int ReactionTask_TypeDefinitionIndex = 80495;

	struct alignas(4) ReactionTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(ReactionTask_TypeDefinitionIndex)->GetStaticField(0x38620);
		}
