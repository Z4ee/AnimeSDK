...
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xF9A0F90)
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF99F150)
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF9A1390)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySteerToMoveTargetProcessor_TypeDefinitionIndex = 85933;
