...
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_GETMOVEMENTPARAMBYANIMID_OFFSET UNITYSDK_OFFSET(0xBDD8700)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_RANDDESIREDMOVESPEED_OFFSET UNITYSDK_OFFSET(0xBDD7960)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_REFRESH_OFFSET UNITYSDK_OFFSET(0xBDD7380)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0xBDDC3C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMovementParameters_TypeDefinitionIndex = 44998;
