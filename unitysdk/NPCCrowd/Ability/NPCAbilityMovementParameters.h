...
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_GETMOVEMENTPARAMBYANIMID_OFFSET UNITYSDK_OFFSET(0xD92DC80)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_RANDDESIREDMOVESPEED_OFFSET UNITYSDK_OFFSET(0xD92CED0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_REFRESH_OFFSET UNITYSDK_OFFSET(0xD92C8F0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0xD931980)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMovementParameters_TypeDefinitionIndex = 74107;
