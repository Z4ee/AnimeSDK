...
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6DAF20)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x6DAD80)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_CREATENEWACTION_OFFSET UNITYSDK_OFFSET(0x6DAC80)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x109F4380)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6DAD60)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6DB010)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_ENABLEWARPING_OFFSET UNITYSDK_OFFSET(0x6DAA40)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONID_OFFSET UNITYSDK_OFFSET(0x6DAC30)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONSERVERSTARTTIME_OFFSET UNITYSDK_OFFSET(0x6DABE0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x6DAB90)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTMOVEACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x6DAB40)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETPREVIOUSACTION_OFFSET UNITYSDK_OFFSET(0x6DAAF0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6DAD00)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6DB050)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x6DAF70)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x6DAE50)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_POPWARPINGTARGET_OFFSET UNITYSDK_OFFSET(0x6DA9D0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_PUSHWARPINGTARGET_OFFSET UNITYSDK_OFFSET(0x6DA990)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x6DAFC0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6DB0B0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x109F48A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityMoveTargetFragment_TypeDefinitionIndex = 52010;

	struct alignas(4) FNPCAbilityMoveTargetFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAbilityMoveTargetFragment_TypeDefinitionIndex)->GetStaticField(0x43700);
		}
		static ::System::Boolean* StaticGet_DebugEnableWarping()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FNPCAbilityMoveTargetFragment_TypeDefinitionIndex)->GetStaticField(0x10480);
		}
