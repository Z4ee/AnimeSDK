...
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x68D7B0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x68D610)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_CREATENEWACTION_OFFSET UNITYSDK_OFFSET(0x68D510)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xF4EA6E0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x68D5F0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x68D8A0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_ENABLEWARPING_OFFSET UNITYSDK_OFFSET(0x68D2D0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONID_OFFSET UNITYSDK_OFFSET(0x68D4C0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONSERVERSTARTTIME_OFFSET UNITYSDK_OFFSET(0x68D470)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x68D420)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTMOVEACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x68D3D0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETPREVIOUSACTION_OFFSET UNITYSDK_OFFSET(0x68D380)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x68D590)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x68D8E0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x68D800)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x68D6E0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_POPWARPINGTARGET_OFFSET UNITYSDK_OFFSET(0x68D260)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_PUSHWARPINGTARGET_OFFSET UNITYSDK_OFFSET(0x68D220)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x68D850)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x68D940)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xF4EAC00)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityMoveTargetFragment_TypeDefinitionIndex = 44007;

	struct alignas(4) FNPCAbilityMoveTargetFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAbilityMoveTargetFragment_TypeDefinitionIndex)->GetStaticField(0x40C60);
		}
		static ::System::Boolean* StaticGet_DebugEnableWarping()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FNPCAbilityMoveTargetFragment_TypeDefinitionIndex)->GetStaticField(0xFB00);
		}
