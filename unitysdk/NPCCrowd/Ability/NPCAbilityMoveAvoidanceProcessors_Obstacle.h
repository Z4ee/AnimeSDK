...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_GET_CANAVOID_OFFSET UNITYSDK_OFFSET(0x5A2770)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x5A2790)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_SET_CANAVOID_OFFSET UNITYSDK_OFFSET(0x5A2780)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_SET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x5A27A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_Obstacle_TypeDefinitionIndex = 59519;
