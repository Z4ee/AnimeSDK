...
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xFB50860)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xFB50270)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_INITDEFAULTANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0xFB4FF90)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_INITPATHFOLLOWANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0xFB4FC70)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0xFB50A70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityAnimateProcessors_TypeDefinitionIndex = 56314;
