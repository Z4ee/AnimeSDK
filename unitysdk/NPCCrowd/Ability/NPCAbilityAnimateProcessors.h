...
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xF5FE170)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF5FDB20)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_INITDEFAULTANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0xF5FD990)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_INITPATHFOLLOWANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0xF5FD7D0)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0xF5FE370)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityAnimateProcessors_TypeDefinitionIndex = 72246;
