...
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x4637C0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x951D800)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x4637A0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x951CBB0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x951CB10)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x4630F0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x4638D0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x4630E0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_LINK_OFFSET UNITYSDK_OFFSET(0x951C9B0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x4637C0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635C0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x4636D0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463650)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x463530)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463420)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463270)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631E0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463390)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x463300)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x463150)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634B0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x463060)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_TICK_OFFSET UNITYSDK_OFFSET(0x951CC00)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORFINDTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463930)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x951DC70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorFindTask_TypeDefinitionIndex = 51962;

	struct alignas(4) AttractorFindTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorFindTask_TypeDefinitionIndex)->GetStaticField(0x51110);
		}
