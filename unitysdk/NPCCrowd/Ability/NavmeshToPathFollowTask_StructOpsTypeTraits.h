...
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1178C420)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1178C430)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NavmeshToPathFollowTask_StructOpsTypeTraits_TypeDefinitionIndex = 48300;
