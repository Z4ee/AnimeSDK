...
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0xD5C5050)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD5C51A0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xD5C5100)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xD5C5200)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0xD5C5270)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_GameplayTagContainerMatchCondition_TypeDefinitionIndex = 61622;
