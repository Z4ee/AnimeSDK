...
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x10296970)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x464480)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x102972B0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x69D100)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x10296A90)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x69CCD0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x69D120)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x69CCC0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x102969D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x464480)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x464510)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x69CF30)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x69CDB0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x69CE30)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x69D030)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x69CFB0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x69CEB0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x69CD30)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x69CC40)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x10296B30)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x69D180)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x10297730)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowBlockedCondition_TypeDefinitionIndex = 77890;

	struct alignas(4) PathFollowBlockedCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowBlockedCondition_TypeDefinitionIndex)->GetStaticField(0x338E0);
		}
