...
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0xF3E8FA0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0xF3E9740)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6875F0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF3E90C0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x687330)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x687610)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x687320)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xF3E8FF0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x4B76F0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x6874D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x6873E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x687430)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x687570)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x687520)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x687480)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x687390)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6872D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xF3E9160)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x687670)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0xF3E9B90)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowBlockedCondition_TypeDefinitionIndex = 44064;

	struct alignas(4) PathFollowBlockedCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowBlockedCondition_TypeDefinitionIndex)->GetStaticField(0x2F550);
		}
