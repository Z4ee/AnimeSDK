...
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x6DA570)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x10B3F3E0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6DA550)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x10B3DB00)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x10B3E540)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x10B3DA60)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GETPREDICTOFFSETS_OFFSET UNITYSDK_OFFSET(0x10B3E8A0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6D9F20)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6DA5D0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x6D9F10)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_LINK_OFFSET UNITYSDK_OFFSET(0x10B3D700)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x6DA570)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x6DA380)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x6DA480)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x6DA400)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6DA300)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x6DA200)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x6DA080)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x6DA000)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x6DA180)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x6DA100)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x6D9F80)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x6DA280)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6D9E90)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x10B3E690)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_TICKLOGIC_OFFSET UNITYSDK_OFFSET(0x10B3DBA0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_TICK_OFFSET UNITYSDK_OFFSET(0x10B3E7E0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FOLLOWMOVETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6DA630)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x10B3F8A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FollowMoveTask_TypeDefinitionIndex = 56216;

	struct alignas(4) FollowMoveTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FollowMoveTask_TypeDefinitionIndex)->GetStaticField(0x4C7F0);
		}
