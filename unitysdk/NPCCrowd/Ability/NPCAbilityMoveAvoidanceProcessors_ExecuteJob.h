...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_COLLECTCLOSESTOBSTACLE_OFFSET UNITYSDK_OFFSET(0x650BE0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_COMPUTECLOSESTPOINTOFAPPROACH_OFFSET UNITYSDK_OFFSET(0x650CB0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x650C10)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_FINDCLOSESTOBSTACLES_OFFSET UNITYSDK_OFFSET(0x650B10)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETAVOIDANCEFORCE_OFFSET UNITYSDK_OFFSET(0x650C50)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETLOCATIONXZ_OFFSET UNITYSDK_OFFSET(0x650B80)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x650BA0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETSEPARATIONFORCE_OFFSET UNITYSDK_OFFSET(0x650C20)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETVELOCITYXZ_OFFSET UNITYSDK_OFFSET(0x650BC0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x650B00)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_ExecuteJob_TypeDefinitionIndex = 40058;
