...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_COLLECTCLOSESTOBSTACLE_OFFSET UNITYSDK_OFFSET(0x652430)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_COMPUTECLOSESTPOINTOFAPPROACH_OFFSET UNITYSDK_OFFSET(0x652500)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x652460)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_FINDCLOSESTOBSTACLES_OFFSET UNITYSDK_OFFSET(0x652360)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETAVOIDANCEFORCE_OFFSET UNITYSDK_OFFSET(0x6524A0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETLOCATIONXZ_OFFSET UNITYSDK_OFFSET(0x6523D0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x6523F0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETSEPARATIONFORCE_OFFSET UNITYSDK_OFFSET(0x652470)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETVELOCITYXZ_OFFSET UNITYSDK_OFFSET(0x652410)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x652350)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_ExecuteJob_TypeDefinitionIndex = 59523;
