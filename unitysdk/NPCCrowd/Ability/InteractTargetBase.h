...
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_CHECKINTERACTVALID_OFFSET UNITYSDK_OFFSET(0x13DE5B60)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_INITSLOTS_OFFSET UNITYSDK_OFFSET(0x13DE5B10)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_ONSTARTINTERACT_OFFSET UNITYSDK_OFFSET(0x13DE5C80)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYOCCUPYVALIDSLOT_OFFSET UNITYSDK_OFFSET(0x13DE5BF0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYRELEASESLOT_OFFSET UNITYSDK_OFFSET(0x13DE5D30)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_UPDATESLOTS_OFFSET UNITYSDK_OFFSET(0x13DE5CD0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x13DE5D80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int InteractTargetBase_TypeDefinitionIndex = 76378;
