...
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_CHECKINTERACTVALID_OFFSET UNITYSDK_OFFSET(0x11D84BD0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_INITSLOTS_OFFSET UNITYSDK_OFFSET(0x11D84B80)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_ONSTARTINTERACT_OFFSET UNITYSDK_OFFSET(0x11D84CF0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYOCCUPYVALIDSLOT_OFFSET UNITYSDK_OFFSET(0x11D84C60)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYRELEASESLOT_OFFSET UNITYSDK_OFFSET(0x11D84DA0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_UPDATESLOTS_OFFSET UNITYSDK_OFFSET(0x11D84D40)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x11D84DF0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int InteractTargetBase_TypeDefinitionIndex = 67428;
