...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x109F7700)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x109F7840)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x109F77D0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x109F78D0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_HasReactionCondition_TypeDefinitionIndex = 69260;
