...
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xD411ED0)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xD411120)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_INITPROCESSOR_OFFSET UNITYSDK_OFFSET(0xD410EC0)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0xD4121F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySmoothOrientationProcessors_TypeDefinitionIndex = 58113;
