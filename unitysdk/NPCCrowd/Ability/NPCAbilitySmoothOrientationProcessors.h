...
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xCD2E450)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xCD2D690)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_INITPROCESSOR_OFFSET UNITYSDK_OFFSET(0xCD2D430)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2E770)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySmoothOrientationProcessors_TypeDefinitionIndex = 80817;
