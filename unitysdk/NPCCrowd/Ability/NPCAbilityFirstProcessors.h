...
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xEC797E0)
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xEC796C0)
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0xEC799F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityFirstProcessors_TypeDefinitionIndex = 82032;
