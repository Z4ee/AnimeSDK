...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_ATTRACTORUSETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xF0D3F30)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_ATTRACTORUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xF0D3FD0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_ATTRACTORUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF0D3EA0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_ATTRACTORUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0xF0D3E30)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_ATTRACTORUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0xF0D4070)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_AttractorUseTask_TypeDefinitionIndex = 78265;
