...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0xA678560)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xA6786D0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xA678630)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xA678760)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_GameplayTagContainerMatchCondition_TypeDefinitionIndex = 65184;
