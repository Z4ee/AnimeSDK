...
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0xFAC8900)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0xFAC91F0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6B3400)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xFAC8A20)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6B3140)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6B3420)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x6B3130)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xFAC8950)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x4B76F0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x6B32E0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x6B31F0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x6B3240)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x6B3380)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x6B3330)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6B3290)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x6B31A0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6B30E0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xFAC8AC0)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_HASREACTIONCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6B3480)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0xFAC9640)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int HasReactionCondition_TypeDefinitionIndex = 70232;

	struct alignas(4) HasReactionCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(HasReactionCondition_TypeDefinitionIndex)->GetStaticField(0x48BE0);
		}
