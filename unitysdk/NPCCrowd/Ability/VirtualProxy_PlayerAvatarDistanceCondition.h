...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0xF84FF40)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF850050)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xF84FFE0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xF8500B0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0xF850120)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PlayerAvatarDistanceCondition_TypeDefinitionIndex = 72291;

	class VirtualProxy_PlayerAvatarDistanceCondition : public ::StateTreeCore::VirtualProxy_StateTreeConditionBase
	{
	public:
		::System::Void _ctor()
		{
