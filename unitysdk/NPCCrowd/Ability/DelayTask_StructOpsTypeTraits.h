...
#define NPCCROWD_ABILITY_DELAYTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0xE5576D0)
#define NPCCROWD_ABILITY_DELAYTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0xE5576E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DelayTask_StructOpsTypeTraits_TypeDefinitionIndex = 57089;
