...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xFFAE290)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xFFAE200)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_LINK_OFFSET UNITYSDK_OFFSET(0xFFAE190)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xFFAE330)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_SetStateMachineParamTask_TypeDefinitionIndex = 74917;
