...
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x8C28550)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x8C28560)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCNavmeshFragment_StructOpsTypeTraits_TypeDefinitionIndex = 56462;
