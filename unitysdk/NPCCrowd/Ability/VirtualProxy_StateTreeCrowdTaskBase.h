...
#define NPCCROWD_ABILITY_VIRTUALPROXY_STATETREECROWDTASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD932AB0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_STATETREECROWDTASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xD932B50)
#define NPCCROWD_ABILITY_VIRTUALPROXY_STATETREECROWDTASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xD932BF0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_STATETREECROWDTASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0xD932C90)
#define NPCCROWD_ABILITY_VIRTUALPROXY_STATETREECROWDTASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0xD932D40)
#define NPCCROWD_ABILITY_VIRTUALPROXY_STATETREECROWDTASKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD932DE0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_StateTreeCrowdTaskBase_TypeDefinitionIndex = 80919;
