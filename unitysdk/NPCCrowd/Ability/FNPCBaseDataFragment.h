...
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5ECA80)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5EC9A0)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xE557750)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5EC980)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5ECB70)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5EC920)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5ECBB0)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x5ECAD0)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5ECA10)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x5ECB20)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5ECC10)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xE557B00)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCBaseDataFragment_TypeDefinitionIndex = 69889;

	struct alignas(4) FNPCBaseDataFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCBaseDataFragment_TypeDefinitionIndex)->GetStaticField(0x37550);
		}
