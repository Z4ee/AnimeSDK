...
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x631680)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x6315A0)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xEC78230)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x631580)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x631770)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x631520)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6317B0)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x6316D0)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x631610)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x631720)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x631810)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC785E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCBaseDataFragment_TypeDefinitionIndex = 48138;

	struct alignas(4) FNPCBaseDataFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCBaseDataFragment_TypeDefinitionIndex)->GetStaticField(0x32E70);
		}
