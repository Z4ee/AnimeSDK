...
#define NPCCROWD_ABILITY_LOOKATIKTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_LOOKATIKTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5A25B0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xD882F10)
#define NPCCROWD_ABILITY_LOOKATIKTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5A2590)
#define NPCCROWD_ABILITY_LOOKATIKTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD882190)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD8820F0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5A1F60)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5A2600)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x5A1F50)
#define NPCCROWD_ABILITY_LOOKATIKTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD882030)
#define NPCCROWD_ABILITY_LOOKATIKTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_LOOKATIKTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5A25B0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x5A23C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x5A24C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x5A2440)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x5A2340)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x5A2240)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x5A20C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x5A2040)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x5A21C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x5A2140)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x5A1FC0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x5A22C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x5A1ED0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xD882570)
#define NPCCROWD_ABILITY_LOOKATIKTASK_TICK_OFFSET UNITYSDK_OFFSET(0xD8825D0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_LOOKATIKTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5A2660)
#define NPCCROWD_ABILITY_LOOKATIKTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xD883390)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int LookAtIKTask_TypeDefinitionIndex = 56651;

	struct alignas(4) LookAtIKTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(LookAtIKTask_TypeDefinitionIndex)->GetStaticField(0x51BC0);
		}
