...
#define NPCCROWD_ABILITY_CROWDSCHEMA_ISEXTERNALITEMALLOWED_OFFSET UNITYSDK_OFFSET(0xF0CAE10)
#define NPCCROWD_ABILITY_CROWDSCHEMA_ISSTRUCTALLOWED_OFFSET UNITYSDK_OFFSET(0xF0CACF0)
#define NPCCROWD_ABILITY_CROWDSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0xF0CAED0)
#define NPCCROWD_ABILITY_CROWDSCHEMA___BASE_ISEXTERNALITEMALLOWED_OFFSET UNITYSDK_OFFSET(0xF0CAF50)
#define NPCCROWD_ABILITY_CROWDSCHEMA___BASE_ISSTRUCTALLOWED_OFFSET UNITYSDK_OFFSET(0xF0CAF60)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CrowdSchema_TypeDefinitionIndex = 46324;
