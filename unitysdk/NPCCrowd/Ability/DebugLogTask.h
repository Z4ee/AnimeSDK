...
#define NPCCROWD_ABILITY_DEBUGLOGTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5A0EA0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xD880B40)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5A0E80)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD87FF20)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD87FE80)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5A0850)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5A0F00)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x5A0840)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD87FDC0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5A0EA0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x5A0CB0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x5A0DB0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x5A0D30)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x5A0C30)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x5A0B30)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x5A09B0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x5A0930)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x5A0AB0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x5A0A30)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x5A08B0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x5A0BB0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x5A07C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_DEBUGLOGTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5A0F60)
#define NPCCROWD_ABILITY_DEBUGLOGTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xD880FF0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DebugLogTask_TypeDefinitionIndex = 73578;

	struct alignas(4) DebugLogTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(DebugLogTask_TypeDefinitionIndex)->GetStaticField(0x51B80);
		}
