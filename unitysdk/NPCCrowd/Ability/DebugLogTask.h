...
#define NPCCROWD_ABILITY_DEBUGLOGTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5CA730)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xD927550)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5CA710)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD926930)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD926890)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5CA0E0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5CA790)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x5CA0D0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD9267D0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5CA730)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x5CA540)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x5CA640)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x5CA5C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x5CA4C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x5CA3C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x5CA240)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x5CA1C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x5CA340)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x5CA2C0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x5CA140)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x5CA440)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x5CA050)
#define NPCCROWD_ABILITY_DEBUGLOGTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_DEBUGLOGTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5CA7F0)
#define NPCCROWD_ABILITY_DEBUGLOGTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xD927A00)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DebugLogTask_TypeDefinitionIndex = 58335;

	struct alignas(4) DebugLogTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(DebugLogTask_TypeDefinitionIndex)->GetStaticField(0x4B2E0);
		}
