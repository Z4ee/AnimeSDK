...
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5A0EA0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xF0CC5C0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x633160)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xF0CB9A0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xF0CBB40)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF0CB900)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x632B30)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x633180)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x632B20)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0xF0CB720)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5A0EA0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x632F90)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x633090)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x633010)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x632F10)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x632E10)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x632C90)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x632C10)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x632D90)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x632D10)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x632B90)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x632E90)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x632AA0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_IDLEANIMATIONTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6331E0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xF0CCA70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int IdleAnimationTask_TypeDefinitionIndex = 41935;

	struct alignas(4) IdleAnimationTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(IdleAnimationTask_TypeDefinitionIndex)->GetStaticField(0x4ED90);
		}
