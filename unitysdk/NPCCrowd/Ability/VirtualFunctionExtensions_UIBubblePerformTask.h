...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xE55A010)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xE55A0B0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xE559F80)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_LINK_OFFSET UNITYSDK_OFFSET(0xE559F10)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_TICK_OFFSET UNITYSDK_OFFSET(0xE55A150)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_UIBubblePerformTask_TypeDefinitionIndex = 67166;
