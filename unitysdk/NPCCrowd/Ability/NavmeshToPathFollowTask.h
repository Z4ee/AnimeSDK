...
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x633970)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x11279FE0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x72B0C0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x11278F90)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x11279510)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x11278EF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x72AA90)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x72B0E0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x72AA80)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_LINK_OFFSET UNITYSDK_OFFSET(0x11278C90)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x633970)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x72AEF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x72AFF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x72AF70)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x72AE70)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x72AD70)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x72ABF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x72AB70)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x72ACF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x72AC70)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x72AAF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x72ADF0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x72AA00)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x112795D0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_TICK_OFFSET UNITYSDK_OFFSET(0x11279630)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_TRYNAVMESHTOPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x112792A0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x72B140)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1127A470)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NavmeshToPathFollowTask_TypeDefinitionIndex = 68662;

	struct alignas(4) NavmeshToPathFollowTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(NavmeshToPathFollowTask_TypeDefinitionIndex)->GetStaticField(0x501A0);
		}
