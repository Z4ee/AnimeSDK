...
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_GET_ACCESSARRAY_OFFSET UNITYSDK_OFFSET(0x1029A790)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1029A9F0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_REBUILD_OFFSET UNITYSDK_OFFSET(0x1029A7E0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_REPLACE_OFFSET UNITYSDK_OFFSET(0x1029A8B0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_SAFEDISPOSE_OFFSET UNITYSDK_OFFSET(0x1029A980)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1029A740)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityTransformAdaptor_TypeDefinitionIndex = 83746;

	class NPCAbilityTransformAdaptor : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::Transform*>* _transformArray; // 0x10
		::System::Boolean _shouldRebuild; // 0x18
		::UnityEngine::Jobs::TransformAccessArray _transform; // 0x20
