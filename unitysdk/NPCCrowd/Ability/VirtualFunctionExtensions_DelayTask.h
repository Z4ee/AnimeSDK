...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DELAYTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xF3EAE90)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DELAYTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF3EAE00)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DELAYTASK_TICK_OFFSET UNITYSDK_OFFSET(0xF3EAF60)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_DelayTask_TypeDefinitionIndex = 62496;
