...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1178D090)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x1178D020)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x1178D0F0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1178D160)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PathFollowIgnoreBlockCondition_TypeDefinitionIndex = 75760;
