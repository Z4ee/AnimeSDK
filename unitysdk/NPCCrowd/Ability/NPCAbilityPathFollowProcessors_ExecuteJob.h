...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x624A50)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_PROCESSMOVEACTION_OFFSET UNITYSDK_OFFSET(0xE8A9A70)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_SETMOVEACTION_OFFSET UNITYSDK_OFFSET(0xE8A9910)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessors_ExecuteJob_TypeDefinitionIndex = 81492;
