...
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x697490)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x11B1AD00)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x72E8F0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x11B1A0F0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x11B1A050)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x4B6B00)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x4B6AA0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4B6A40)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x72E4F0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x72E910)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4B6B60)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x72E4E0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0x11B19DB0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x697490)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_RESET_OFFSET UNITYSDK_OFFSET(0x4B6E10)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x72E7D0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x72E870)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x72E820)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x72E780)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x72E6E0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x72E5F0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x72E5A0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x72E690)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x72E640)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x72E550)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x72E730)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x72E490)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0x11B1A4A0)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTUSETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x72E970)
#define NPCCROWD_ABILITY_WAITINGSLOTUSETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x11B1B150)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotUseTask_TypeDefinitionIndex = 58911;

	struct alignas(4) WaitingSlotUseTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotUseTask_TypeDefinitionIndex)->GetStaticField(0x46D70);
		}
