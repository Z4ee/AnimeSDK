...
#define NPCCROWD_ABILITY_REACTIONTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x106FAFF0)
#define NPCCROWD_ABILITY_REACTIONTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x106FB000)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int ReactionTask_StructOpsTypeTraits_TypeDefinitionIndex = 44715;
