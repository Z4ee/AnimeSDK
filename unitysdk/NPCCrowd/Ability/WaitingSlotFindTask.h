...
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x609720)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x12D0DC60)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x7C0180)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x12D0CF80)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x12D0CDF0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7BFB50)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7C01A0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x7BFB40)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_LINK_OFFSET UNITYSDK_OFFSET(0x12D0CBB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x609720)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x7BFFB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7C00B0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x7C0030)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x7BFF30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x7BFE30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x7BFCB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x7BFC30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x7BFDB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x7BFD30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x7BFBB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x7BFEB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x7BFAC0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_TICKLOGIC_OFFSET UNITYSDK_OFFSET(0x12D0D030)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTFINDTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7C0200)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x12D0E0F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotFindTask_TypeDefinitionIndex = 82248;

	struct alignas(4) WaitingSlotFindTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotFindTask_TypeDefinitionIndex)->GetStaticField(0x43250);
		}
