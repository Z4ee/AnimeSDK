...
#define NPCCROWD_ABILITY_NPCSTATETREEPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x592920)
#define NPCCROWD_ABILITY_NPCSTATETREEPROCESSOR_EXECUTEJOB_GETFRAGMENTSTRUCTVIEW_OFFSET UNITYSDK_OFFSET(0x592900)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCStateTreeProcessor_ExecuteJob_TypeDefinitionIndex = 87474;
