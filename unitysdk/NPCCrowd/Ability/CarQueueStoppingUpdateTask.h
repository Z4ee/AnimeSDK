...
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x56FA40)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_CREATE_OFFSET UNITYSDK_OFFSET(0xF4E9DB0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x68CFD0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xF4E8DC0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0xF4E9620)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x4B6B00)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x4B6AA0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4B6A40)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x68CBD0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x68CFF0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4B6B60)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x68CBC0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_LINK_OFFSET UNITYSDK_OFFSET(0xF4E8C40)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x56FA40)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_RESET_OFFSET UNITYSDK_OFFSET(0x4B6E10)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x68CEB0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x68CF50)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x68CF00)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x68CE60)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x68CDC0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x68CCD0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x68CC80)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x68CD70)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x68CD20)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x68CC30)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x68CE10)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x68CB70)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_TICK_OFFSET UNITYSDK_OFFSET(0xF4E8E60)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x68D050)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xF4EA210)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueStoppingUpdateTask_TypeDefinitionIndex = 42963;

	struct alignas(4) CarQueueStoppingUpdateTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CarQueueStoppingUpdateTask_TypeDefinitionIndex)->GetStaticField(0x40C50);
		}
