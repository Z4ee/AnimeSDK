...
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x591C20)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x109F3A20)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6DA740)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x109F2800)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x109F3030)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x6DA110)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x6DA760)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x6DA100)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_LINK_OFFSET UNITYSDK_OFFSET(0x109F26A0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x591C20)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x6DA570)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x6DA670)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x6DA5F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6DA4F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x6DA3F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x6DA270)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x6DA1F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x6DA370)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x6DA2F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x6DA170)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x6DA470)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x6DA080)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_TICK_OFFSET UNITYSDK_OFFSET(0x109F28A0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6DA7C0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x109F3EB0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueStoppingUpdateTask_TypeDefinitionIndex = 65092;

	struct alignas(4) CarQueueStoppingUpdateTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CarQueueStoppingUpdateTask_TypeDefinitionIndex)->GetStaticField(0x436F0);
		}
