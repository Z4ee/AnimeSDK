...
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_ADDNODE_OFFSET UNITYSDK_OFFSET(0x748540)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_CLEARNODE_OFFSET UNITYSDK_OFFSET(0x7485A0)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_GETNODE_OFFSET UNITYSDK_OFFSET(0x748480)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_SETNODE_OFFSET UNITYSDK_OFFSET(0x7484E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityPathFollowFragment_TypeDefinitionIndex = 86645;
