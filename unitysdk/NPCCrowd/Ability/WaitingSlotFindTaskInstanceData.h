...
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x952D970)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x464BF0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x464C50)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x463A20)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x464CB0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x952DAA0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotFindTaskInstanceData_TypeDefinitionIndex = 40505;

	struct alignas(1) WaitingSlotFindTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotFindTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x511C0);
		}
