...
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1192BBA0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x753BD0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x753C40)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x463B50)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x753CA0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1192BCD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorUseTaskInstanceData_TypeDefinitionIndex = 64506;

	struct alignas(4) AttractorUseTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorUseTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x45570);
		}
