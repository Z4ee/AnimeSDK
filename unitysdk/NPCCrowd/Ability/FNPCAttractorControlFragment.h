...
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x718450)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x718350)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x114FE720)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x718330)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x718540)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_FORCESETDATA_OFFSET UNITYSDK_OFFSET(0x718270)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7182D0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x718580)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x7184A0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7183D0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x7184F0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_SETBEHAVIOURSSTATE_OFFSET UNITYSDK_OFFSET(0x718220)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7185E0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x114FEAD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAttractorControlFragment_TypeDefinitionIndex = 81555;

	struct alignas(4) FNPCAttractorControlFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAttractorControlFragment_TypeDefinitionIndex)->GetStaticField(0x47D10);
		}
