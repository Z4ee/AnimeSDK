...
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5EC8F0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5EC7F0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xE00E270)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5EC7D0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5EC9E0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_FORCESETDATA_OFFSET UNITYSDK_OFFSET(0x5EC710)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5EC770)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5ECA20)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x5EC940)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5EC870)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x5EC990)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_SETBEHAVIOURSSTATE_OFFSET UNITYSDK_OFFSET(0x5EC6C0)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5ECA80)
#define NPCCROWD_ABILITY_FNPCATTRACTORCONTROLFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xE00E620)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAttractorControlFragment_TypeDefinitionIndex = 74233;

	struct alignas(4) FNPCAttractorControlFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAttractorControlFragment_TypeDefinitionIndex)->GetStaticField(0x4A240);
		}
