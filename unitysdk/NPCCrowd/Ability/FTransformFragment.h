...
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5B1600)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5B1500)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_CREATEFROMGO_OFFSET UNITYSDK_OFFSET(0xD5AFC70)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xD5AFEC0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5B14E0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_DEFAULT_OFFSET UNITYSDK_OFFSET(0xD5AFDA0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5B16F0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_GETLOCATION_OFFSET UNITYSDK_OFFSET(0x5B1300)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_GETROTATION_OFFSET UNITYSDK_OFFSET(0x5B1370)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x5B1260)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5B1480)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5B1730)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x5B1650)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5B1580)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x5B16A0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_SETROTATION_OFFSET UNITYSDK_OFFSET(0x5B1390)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_SETTRANSLATION_OFFSET UNITYSDK_OFFSET(0x5B1400)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x5B12E0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FTRANSFORMFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5B1790)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xD5B02B0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FTransformFragment_TypeDefinitionIndex = 84102;

	struct alignas(4) FTransformFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FTransformFragment_TypeDefinitionIndex)->GetStaticField(0x4CEF0);
		}
