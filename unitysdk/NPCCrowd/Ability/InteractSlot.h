...
#define NPCCROWD_ABILITY_INTERACTSLOT_ONRELEASED_OFFSET UNITYSDK_OFFSET(0x102967F0)
#define NPCCROWD_ABILITY_INTERACTSLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x102967D0)
#define NPCCROWD_ABILITY_INTERACTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x102967C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int InteractSlot_TypeDefinitionIndex = 70879;
