...
#define NPCCROWD_ABILITY_VIRTUALPROXY_LOOKATIKTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD448B10)
#define NPCCROWD_ABILITY_VIRTUALPROXY_LOOKATIKTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD448AB0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_LOOKATIKTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD448A40)
#define NPCCROWD_ABILITY_VIRTUALPROXY_LOOKATIKTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xD448B80)
#define NPCCROWD_ABILITY_VIRTUALPROXY_LOOKATIKTASK_TICK_OFFSET UNITYSDK_OFFSET(0xD448C20)
#define NPCCROWD_ABILITY_VIRTUALPROXY_LOOKATIKTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xD448CD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_LookAtIKTask_TypeDefinitionIndex = 60101;

	class VirtualProxy_LookAtIKTask : public ::StateTreeCore::VirtualProxy_StateTreeTaskBase
	{
	public:
		::System::Void _ctor()
		{
