...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xA676610)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0xA675BF0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_INITPATHPROCESSOR_OFFSET UNITYSDK_OFFSET(0xA66D660)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_INITPOINTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xA66C3E0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_ISPATHFOLLOWMOVING_OFFSET UNITYSDK_OFFSET(0xA670860)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_PREEXECUTEBEFOREJOB_OFFSET UNITYSDK_OFFSET(0xA673CD0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS__CCTOR_OFFSET UNITYSDK_OFFSET(0xA676830)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0xA66B630)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessors_TypeDefinitionIndex = 81491;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessors_TypeDefinitionIndex)->GetStaticField(0xF490);
		}
