...
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x464480)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x952C190)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x464460)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x952B660)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x463EC0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x464590)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x463EB0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x952B5A0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x464480)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x464510)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4641D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x463FA0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x464020)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x464430)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x464300)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x4640A0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x463F20)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x463D80)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x952B700)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4645F0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x952C7C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowIgnoreBlockCondition_TypeDefinitionIndex = 53517;

	struct alignas(4) PathFollowIgnoreBlockCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowIgnoreBlockCondition_TypeDefinitionIndex)->GetStaticField(0x51170);
		}
