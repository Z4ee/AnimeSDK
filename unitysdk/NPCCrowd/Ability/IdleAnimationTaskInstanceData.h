...
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x12602EB0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7B20B0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7B2110)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x463B50)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7B2170)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x12602FE0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int IdleAnimationTaskInstanceData_TypeDefinitionIndex = 64865;

	struct alignas(4) IdleAnimationTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(IdleAnimationTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x43160);
		}
