...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_COMPARE_OFFSET UNITYSDK_OFFSET(0x6C7680)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_FOUNDATION_CONTAINER_IHIERARCHICALHASHGRIDCOMPAREKEYFUNC_NPCCROWD_ABILITY_NAVIGATIONOBSTACLEITEM__GETKEY_OFFSET UNITYSDK_OFFSET(0x6C76E0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_GETCELLKEY_OFFSET UNITYSDK_OFFSET(0x6C7480)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_GETKEY_OFFSET UNITYSDK_OFFSET(0x6C7570)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x6C7310)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_NavigationObstacleCellCompareKeyFunc_TypeDefinitionIndex = 40061;
