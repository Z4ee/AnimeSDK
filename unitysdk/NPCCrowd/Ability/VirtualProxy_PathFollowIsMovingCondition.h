...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD0C4A90)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xD0C4A20)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xD0C4AF0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C4B60)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PathFollowIsMovingCondition_TypeDefinitionIndex = 42663;

	class VirtualProxy_PathFollowIsMovingCondition : public ::StateTreeCore::VirtualProxy_StateTreeConditionBase
	{
	public:
		::System::Void _ctor()
		{
