...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1178D1E0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x1178D170)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x1178D240)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1178D2B0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PathFollowIsMovingCondition_TypeDefinitionIndex = 74133;
