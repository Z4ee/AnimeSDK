...
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD927B20)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5CA880)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5CA8E0)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x4105E0)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5CA940)
#define NPCCROWD_ABILITY_DEBUGLOGTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD927C50)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DebugLogTaskInstanceData_TypeDefinitionIndex = 45848;

	struct alignas(1) DebugLogTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(DebugLogTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x4B2F0);
		}
