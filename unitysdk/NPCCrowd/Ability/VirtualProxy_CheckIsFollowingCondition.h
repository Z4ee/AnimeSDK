...
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x109F7C20)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x109F7BB0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x109F7C80)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x109F7CF0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_CheckIsFollowingCondition_TypeDefinitionIndex = 73872;
