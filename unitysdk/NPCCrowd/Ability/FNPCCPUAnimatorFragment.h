...
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ANIMATIONCLIPID_OFFSET UNITYSDK_OFFSET(0x3A4E50)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_BHASANIMATION_OFFSET UNITYSDK_OFFSET(0x72DBC0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_CLIPSPEED_OFFSET UNITYSDK_OFFSET(0x3AB430)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x72DE80)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x72DB80)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x72DD80)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ISTURNING_OFFSET UNITYSDK_OFFSET(0x72DDA0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_MAINCLIPNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x43E9B0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ROOTMOTIONROTATION_OFFSET UNITYSDK_OFFSET(0x50A9E0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ROOTMOTIONTRANSLATION_OFFSET UNITYSDK_OFFSET(0x3A7600)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_ANIMATIONCLIPID_OFFSET UNITYSDK_OFFSET(0x72DCD0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_BHASANIMATION_OFFSET UNITYSDK_OFFSET(0x72DC70)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_CLIPSPEED_OFFSET UNITYSDK_OFFSET(0x72DDC0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x72DE90)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x72DD90)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_ISTURNING_OFFSET UNITYSDK_OFFSET(0x72DDB0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SYNCWITHSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x72DEA0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCCPUAnimatorFragment_TypeDefinitionIndex = 43885;
