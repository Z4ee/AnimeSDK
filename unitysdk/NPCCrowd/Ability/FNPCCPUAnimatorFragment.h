...
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ANIMATIONCLIPID_OFFSET UNITYSDK_OFFSET(0x424ED0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_BHASANIMATION_OFFSET UNITYSDK_OFFSET(0x632920)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_CLIPSPEED_OFFSET UNITYSDK_OFFSET(0x3D1D70)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x632A20)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x6328E0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x6329E0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ISTURNING_OFFSET UNITYSDK_OFFSET(0x632A00)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_MAINCLIPNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x478130)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ROOTMOTIONROTATION_OFFSET UNITYSDK_OFFSET(0x6328D0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_GET_ROOTMOTIONTRANSLATION_OFFSET UNITYSDK_OFFSET(0x420BA0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_ANIMATIONCLIPID_OFFSET UNITYSDK_OFFSET(0x6329D0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_BHASANIMATION_OFFSET UNITYSDK_OFFSET(0x632970)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_CLIPSPEED_OFFSET UNITYSDK_OFFSET(0x5A2BD0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x632A30)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x6329F0)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SET_ISTURNING_OFFSET UNITYSDK_OFFSET(0x632A10)
#define NPCCROWD_ABILITY_FNPCCPUANIMATORFRAGMENT_SYNCWITHSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x632A40)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCCPUAnimatorFragment_TypeDefinitionIndex = 86269;
