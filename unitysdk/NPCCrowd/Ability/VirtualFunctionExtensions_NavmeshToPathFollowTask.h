...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_NAVMESHTOPATHFOLLOWTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD932650)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_NAVMESHTOPATHFOLLOWTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xD9326F0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_NAVMESHTOPATHFOLLOWTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD9325C0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_NAVMESHTOPATHFOLLOWTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD932550)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_NAVMESHTOPATHFOLLOWTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xD932790)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_NAVMESHTOPATHFOLLOWTASK_TICK_OFFSET UNITYSDK_OFFSET(0xD932870)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_NavmeshToPathFollowTask_TypeDefinitionIndex = 82830;
