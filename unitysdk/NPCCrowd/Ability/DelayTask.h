...
#define NPCCROWD_ABILITY_DELAYTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_DELAYTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x748140)
#define NPCCROWD_ABILITY_DELAYTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x1178B010)
#define NPCCROWD_ABILITY_DELAYTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x748120)
#define NPCCROWD_ABILITY_DELAYTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_DELAYTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1178A650)
#define NPCCROWD_ABILITY_DELAYTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1178A5B0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define NPCCROWD_ABILITY_DELAYTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define NPCCROWD_ABILITY_DELAYTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define NPCCROWD_ABILITY_DELAYTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define NPCCROWD_ABILITY_DELAYTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define NPCCROWD_ABILITY_DELAYTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x747AF0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x748190)
#define NPCCROWD_ABILITY_DELAYTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define NPCCROWD_ABILITY_DELAYTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define NPCCROWD_ABILITY_DELAYTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x747AE0)
#define NPCCROWD_ABILITY_DELAYTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_DELAYTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x748140)
#define NPCCROWD_ABILITY_DELAYTASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define NPCCROWD_ABILITY_DELAYTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x747F50)
#define NPCCROWD_ABILITY_DELAYTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x748050)
#define NPCCROWD_ABILITY_DELAYTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x747FD0)
#define NPCCROWD_ABILITY_DELAYTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x747ED0)
#define NPCCROWD_ABILITY_DELAYTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x747DD0)
#define NPCCROWD_ABILITY_DELAYTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x747C50)
#define NPCCROWD_ABILITY_DELAYTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x747BD0)
#define NPCCROWD_ABILITY_DELAYTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x747D50)
#define NPCCROWD_ABILITY_DELAYTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x747CD0)
#define NPCCROWD_ABILITY_DELAYTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x747B50)
#define NPCCROWD_ABILITY_DELAYTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x747E50)
#define NPCCROWD_ABILITY_DELAYTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x747A60)
#define NPCCROWD_ABILITY_DELAYTASK_TICK_OFFSET UNITYSDK_OFFSET(0x1178A6D0)
#define NPCCROWD_ABILITY_DELAYTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_DELAYTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7481F0)
#define NPCCROWD_ABILITY_DELAYTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1178B490)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DelayTask_TypeDefinitionIndex = 57743;

	struct alignas(4) DelayTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(DelayTask_TypeDefinitionIndex)->GetStaticField(0x382A0);
		}
