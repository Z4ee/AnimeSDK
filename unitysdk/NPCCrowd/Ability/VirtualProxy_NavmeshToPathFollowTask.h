...
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x11932180)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x119321F0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x11932120)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_LINK_OFFSET UNITYSDK_OFFSET(0x119320B0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x11932260)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_TICK_OFFSET UNITYSDK_OFFSET(0x11932300)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x11932380)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_NavmeshToPathFollowTask_TypeDefinitionIndex = 47808;
