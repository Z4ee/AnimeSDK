...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_STATETREECROWDTASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x10C93030)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_STATETREECROWDTASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x10C930C0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_STATETREECROWDTASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x10C93150)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_STATETREECROWDTASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x10C931E0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_STATETREECROWDTASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x10C93270)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_StateTreeCrowdTaskBase_TypeDefinitionIndex = 67090;
