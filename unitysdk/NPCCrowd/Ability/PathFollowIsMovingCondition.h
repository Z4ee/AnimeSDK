...
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x464480)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x119300B0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x755170)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1192F8A0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x754D40)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x755190)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x754D30)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x1192F7E0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x464480)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x464510)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x754FA0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x754E20)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x754EA0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7550A0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x755020)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x754F20)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x754DA0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x754CB0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x1192F940)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7551F0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x11930530)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowIsMovingCondition_TypeDefinitionIndex = 75858;

	struct alignas(4) PathFollowIsMovingCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowIsMovingCondition_TypeDefinitionIndex)->GetStaticField(0x455D0);
		}
