...
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x11502980)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x7192A0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x11502310)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x718FE0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7192C0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x718FD0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x11502240)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x4B76F0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x719180)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x719090)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x7190E0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x719220)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x7191D0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x719130)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x719040)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x718F80)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x115023B0)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x719320)
#define NPCCROWD_ABILITY_PATHFOLLOWISMOVINGCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x11502DD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowIsMovingCondition_TypeDefinitionIndex = 62831;

	struct alignas(4) PathFollowIsMovingCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowIsMovingCondition_TypeDefinitionIndex)->GetStaticField(0x47D60);
		}
