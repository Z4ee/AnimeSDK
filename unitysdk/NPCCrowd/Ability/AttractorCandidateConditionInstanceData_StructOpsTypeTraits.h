...
#define NPCCROWD_ABILITY_ATTRACTORCANDIDATECONDITIONINSTANCEDATA_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0xFFA6AC0)
#define NPCCROWD_ABILITY_ATTRACTORCANDIDATECONDITIONINSTANCEDATA_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0xFFA6AD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorCandidateConditionInstanceData_StructOpsTypeTraits_TypeDefinitionIndex = 79522;
