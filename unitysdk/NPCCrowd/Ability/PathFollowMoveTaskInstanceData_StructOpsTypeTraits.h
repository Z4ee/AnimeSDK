...
#define NPCCROWD_ABILITY_PATHFOLLOWMOVETASKINSTANCEDATA_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0xFB53700)
#define NPCCROWD_ABILITY_PATHFOLLOWMOVETASKINSTANCEDATA_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0xFB53710)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowMoveTaskInstanceData_StructOpsTypeTraits_TypeDefinitionIndex = 72999;
