...
#define NPCCROWD_ABILITY_MOVETOTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_MOVETOTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7329B0)
#define NPCCROWD_ABILITY_MOVETOTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x114E0820)
#define NPCCROWD_ABILITY_MOVETOTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x732990)
#define NPCCROWD_ABILITY_MOVETOTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_MOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x114DF9A0)
#define NPCCROWD_ABILITY_MOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x114DFC80)
#define NPCCROWD_ABILITY_MOVETOTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x114DF900)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x732360)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x732A10)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x732350)
#define NPCCROWD_ABILITY_MOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0x114DF6A0)
#define NPCCROWD_ABILITY_MOVETOTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_MOVETOTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7329B0)
#define NPCCROWD_ABILITY_MOVETOTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x7327C0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7328C0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x732840)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x732740)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x732640)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x7324C0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x732440)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x7325C0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x732540)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x7323C0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x7326C0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x7322D0)
#define NPCCROWD_ABILITY_MOVETOTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x114DFCD0)
#define NPCCROWD_ABILITY_MOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0x114DFE70)
#define NPCCROWD_ABILITY_MOVETOTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_MOVETOTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x732A70)
#define NPCCROWD_ABILITY_MOVETOTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x114E0CE0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int MoveToTask_TypeDefinitionIndex = 48545;

	struct alignas(4) MoveToTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(MoveToTask_TypeDefinitionIndex)->GetStaticField(0x49450);
		}
