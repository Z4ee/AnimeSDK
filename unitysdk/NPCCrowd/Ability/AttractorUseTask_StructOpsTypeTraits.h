...
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x109F2680)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x109F2690)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorUseTask_StructOpsTypeTraits_TypeDefinitionIndex = 85182;
