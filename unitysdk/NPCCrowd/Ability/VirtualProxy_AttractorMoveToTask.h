...
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD4488D0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xD448940)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD448860)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0xD4489B0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xD448A30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_AttractorMoveToTask_TypeDefinitionIndex = 49105;
