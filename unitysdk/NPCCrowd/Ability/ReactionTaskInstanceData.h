...
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD413520)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x592A50)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x592AB0)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x4105E0)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x592B10)
#define NPCCROWD_ABILITY_REACTIONTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD413650)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int ReactionTaskInstanceData_TypeDefinitionIndex = 72490;

	struct alignas(1) ReactionTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(ReactionTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x45590);
		}
