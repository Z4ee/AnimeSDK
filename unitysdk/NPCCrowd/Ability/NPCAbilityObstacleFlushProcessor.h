...
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_CLEAN_OFFSET UNITYSDK_OFFSET(0xF4EB5F0)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF4EB070)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_PREPARE_OFFSET UNITYSDK_OFFSET(0xF4EB390)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF4EB630)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityObstacleFlushProcessor_TypeDefinitionIndex = 43749;
