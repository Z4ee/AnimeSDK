...
#define NPCCROWD_ABILITY_CROWDSPLINEFOLLOWPROCESSOR_EXECUTEATINDEX_OFFSET UNITYSDK_OFFSET(0xD5AE8C0)
#define NPCCROWD_ABILITY_CROWDSPLINEFOLLOWPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0xD5AF340)
#define NPCCROWD_ABILITY_CROWDSPLINEFOLLOWPROCESSOR_FINDSAMPLEINDEX_OFFSET UNITYSDK_OFFSET(0xD5AF050)
#define NPCCROWD_ABILITY_CROWDSPLINEFOLLOWPROCESSOR_UPDATECACHESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xD5AF140)
#define NPCCROWD_ABILITY_CROWDSPLINEFOLLOWPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD5AF570)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CrowdSplineFollowProcessor_TypeDefinitionIndex = 55130;
