...
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5811E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xD0C04D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5811C0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD0BE540)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xD0BF140)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x4B6B00)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x4B6AA0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4B6A40)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x580B90)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x581240)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4B6B60)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x580B80)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD0BE250)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5811E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_REALEXITACTION_OFFSET UNITYSDK_OFFSET(0xD0BEE70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_RESET_OFFSET UNITYSDK_OFFSET(0x4B6E10)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SETSTAIRBLEND_OFFSET UNITYSDK_OFFSET(0xD0BF0D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x580FF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x5810F0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x581070)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x580F70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x580E70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x580CF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x580C70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x580DF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x580D70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x580BF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x580EF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x580B00)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0xD0BF360)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORMOVETOTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5812A0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xD0C09B0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorMoveToTask_TypeDefinitionIndex = 73852;

	struct alignas(4) AttractorMoveToTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorMoveToTask_TypeDefinitionIndex)->GetStaticField(0x35830);
		}
