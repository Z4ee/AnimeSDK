...
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x608EF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xE92F920)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x608ED0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xE92D800)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xE92E3D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x608700)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x608F50)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x6086F0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0xE92D550)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x608EF0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_REALEXITACTION_OFFSET UNITYSDK_OFFSET(0xE92E100)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SETSTAIRBLEND_OFFSET UNITYSDK_OFFSET(0xE92E360)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x608CE0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x608E40)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x608D90)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x608C30)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x608AD0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x6088C0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x608810)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x608A20)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x608970)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x608760)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x608B80)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x608640)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0xE92E5F0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORMOVETOTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x608FB0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xE92FE30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorMoveToTask_TypeDefinitionIndex = 42040;

	struct alignas(4) AttractorMoveToTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorMoveToTask_TypeDefinitionIndex)->GetStaticField(0x3AB80);
		}
