...
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x11364E60)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x11364E00)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_LINK_OFFSET UNITYSDK_OFFSET(0x11364D90)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x11364ED0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x11364F70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_SetStateMachineParamTask_TypeDefinitionIndex = 54477;
