...
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER__NAVMESHTOSPLINEFOLLOWASYNC_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x48F830)
#define NPCCROWD_ABILITY_CROWDSPLINEBAKECACHEMANAGER__NAVMESHTOSPLINEFOLLOWASYNC_D__36_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CrowdSplineBakeCacheManager__NavmeshToSplineFollowAsync_d__36_TypeDefinitionIndex = 84857;

	struct alignas(8) CrowdSplineBakeCacheManager__NavmeshToSplineFollowAsync_d__36
	{
		::NPCCrowd::AI::NPCCrowdActionManager* _actionManager_5__2; // 0x10
		::NPCCrowd::Ability::CrowdSplineBakeCacheManager* __4__this; // 0x18
		...
		::System::Single stopRadius; // 0x34
		::System::UInt32 entityId; // 0x38
		::Cysharp::Threading::Tasks::YieldAwaitable_Awaiter __u__1; // 0x3C
		::System::Int32 _navHandler_5__3; // 0x40
		::System::Boolean snapToGround; // 0x44
