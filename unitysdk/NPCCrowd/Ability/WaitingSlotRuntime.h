...
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME_ONRELEASED_OFFSET UNITYSDK_OFFSET(0xB538380)
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xB537FE0)
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME___BASE_ONRELEASED_OFFSET UNITYSDK_OFFSET(0xB5383F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotRuntime_TypeDefinitionIndex = 44121;
