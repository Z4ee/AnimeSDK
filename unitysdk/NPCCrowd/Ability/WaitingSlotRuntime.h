...
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME_ONRELEASED_OFFSET UNITYSDK_OFFSET(0xFF93AA0)
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xFF93700)
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME___BASE_ONRELEASED_OFFSET UNITYSDK_OFFSET(0xFF93B10)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotRuntime_TypeDefinitionIndex = 54485;
