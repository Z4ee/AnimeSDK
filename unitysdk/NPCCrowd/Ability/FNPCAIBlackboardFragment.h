...
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x696D50)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x696C10)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xF84D200)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x696BF0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x696E40)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x696B90)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x696E80)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x696DA0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x696CB0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x696DF0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x696EE0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xF84D660)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAIBlackboardFragment_TypeDefinitionIndex = 62842;

	struct alignas(4) FNPCAIBlackboardFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAIBlackboardFragment_TypeDefinitionIndex)->GetStaticField(0x45F00);
		}
