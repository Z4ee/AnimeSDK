...
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x624720)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x6245E0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xE8A9420)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x6245C0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x624810)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x624560)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x624850)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x624770)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x624680)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x6247C0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x6248B0)
#define NPCCROWD_ABILITY_FNPCAIBLACKBOARDFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xE8A9860)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAIBlackboardFragment_TypeDefinitionIndex = 72082;

	struct alignas(4) FNPCAIBlackboardFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAIBlackboardFragment_TypeDefinitionIndex)->GetStaticField(0x46F50);
		}
		...
		::System::Int32 serverIdleMontageKey; // 0x5C
