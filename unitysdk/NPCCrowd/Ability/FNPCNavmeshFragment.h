...
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x50BA00)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x50B880)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xBDD4230)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x50B860)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x50BAF0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x50B800)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x50BB30)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x50BA50)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x50B940)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x50BAA0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x50BB90)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xBDD4720)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCNavmeshFragment_TypeDefinitionIndex = 64452;

	struct alignas(4) FNPCNavmeshFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCNavmeshFragment_TypeDefinitionIndex)->GetStaticField(0x44BF0);
		}
