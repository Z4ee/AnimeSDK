...
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5A1C30)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5A1AB0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0xD881A90)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x5A1A90)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5A1D20)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x5A1A30)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x5A1D60)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x5A1C80)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5A1B70)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x5A1CD0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5A1DC0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xD881F80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCNavmeshFragment_TypeDefinitionIndex = 82401;

	struct alignas(4) FNPCNavmeshFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCNavmeshFragment_TypeDefinitionIndex)->GetStaticField(0x51BB0);
		}
