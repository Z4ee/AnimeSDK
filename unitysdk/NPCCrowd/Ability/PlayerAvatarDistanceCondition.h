...
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x119305F0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x755750)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x11931050)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x755730)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x119307B0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x463260)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x755300)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7557A0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x7552F0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x11930650)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4644D0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x755750)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x464510)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x755560)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x7553E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x755460)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x755660)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x7555E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x7554E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x755360)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x755270)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x11930850)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x755800)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x119314C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PlayerAvatarDistanceCondition_TypeDefinitionIndex = 49109;

	struct alignas(4) PlayerAvatarDistanceCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PlayerAvatarDistanceCondition_TypeDefinitionIndex)->GetStaticField(0x455F0);
		}
