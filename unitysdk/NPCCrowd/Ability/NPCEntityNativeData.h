...
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA_FOUNDATION_CONTAINER_IKEYFUNC_NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__GET_ALLOWDUPLICATEKEYS_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA_FOUNDATION_IEQUALSFUNC_NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__EQUALS_OFFSET UNITYSDK_OFFSET(0x6DB360)
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA_FOUNDATION_IHASHFUNC_NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__HASH_OFFSET UNITYSDK_OFFSET(0x6DB370)
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6DB340)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCEntityNativeData_TypeDefinitionIndex = 84198;
