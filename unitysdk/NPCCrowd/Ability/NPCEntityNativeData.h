...
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA_FOUNDATION_CONTAINER_IKEYFUNC_NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__GET_ALLOWDUPLICATEKEYS_OFFSET UNITYSDK_OFFSET(0x304470)
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA_FOUNDATION_IEQUALSFUNC_NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__EQUALS_OFFSET UNITYSDK_OFFSET(0x68DC00)
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA_FOUNDATION_IHASHFUNC_NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__HASH_OFFSET UNITYSDK_OFFSET(0x4CA170)
#define NPCCROWD_ABILITY_NPCENTITYNATIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x68DBE0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCEntityNativeData_TypeDefinitionIndex = 59285;
