...
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x6979A0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x1178A040)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x747950)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x11788470)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x117888C0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x117883D0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x747320)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x747970)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x747310)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0x11788170)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x6979A0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_REALEXITACTION_OFFSET UNITYSDK_OFFSET(0x11789420)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x747780)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x747880)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x747800)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x747700)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x747600)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x747480)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x747400)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x747580)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x747500)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x747380)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x747680)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x747290)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0x11788C50)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORUSETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7479D0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1178A4D0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorUseTask_TypeDefinitionIndex = 85181;

	struct alignas(4) AttractorUseTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorUseTask_TypeDefinitionIndex)->GetStaticField(0x38280);
		}
