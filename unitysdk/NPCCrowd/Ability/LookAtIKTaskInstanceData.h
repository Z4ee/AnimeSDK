...
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x13DE5ED0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7E3440)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x7E34A0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x463A20)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7E3500)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x13DE6000)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int LookAtIKTaskInstanceData_TypeDefinitionIndex = 67836;

	struct alignas(1) LookAtIKTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(LookAtIKTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x4DBF0);
		}
