...
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x11D84F40)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x73BF70)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x73BFD0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x4B6FE0)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x73C030)
#define NPCCROWD_ABILITY_LOOKATIKTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x11D85070)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int LookAtIKTaskInstanceData_TypeDefinitionIndex = 73455;

	struct alignas(1) LookAtIKTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(LookAtIKTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x43B20);
		}
