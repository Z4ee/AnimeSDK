...
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0xD230450)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x58B720)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD22FDE0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x4B6980)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x4B69E0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x3F06C0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x58B460)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x58B740)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x58B450)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0xD22FD10)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B76B0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x4B7660)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x4B76F0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x58B600)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x58B510)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x58B560)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x58B6A0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x58B650)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x58B5B0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x58B4C0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x58B400)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0xD22FE80)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x58B7A0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0xD2308A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CheckIsFollowingCondition_TypeDefinitionIndex = 59837;

	struct alignas(4) CheckIsFollowingCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CheckIsFollowingCondition_TypeDefinitionIndex)->GetStaticField(0x3D0F0);
		}
