...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_IDLEANIMATIONTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD4143E0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_IDLEANIMATIONTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xD414480)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_IDLEANIMATIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xD414350)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_IDLEANIMATIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0xD4142E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_IdleAnimationTask_TypeDefinitionIndex = 80019;
