...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0xFB59690)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_ONCHANGELOD_OFFSET UNITYSDK_OFFSET(0xFB59090)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_ONREMOVELOD_OFFSET UNITYSDK_OFFSET(0xFB59350)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_UPDATEBATCH_OFFSET UNITYSDK_OFFSET(0xFB59530)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xFB58E40)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_TypeDefinitionIndex = 76523;
