...
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ACTIVATEINTASKQUEUE_OFFSET UNITYSDK_OFFSET(0xCD4BD90)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0xCD4BAF0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ENDTASK_OFFSET UNITYSDK_OFFSET(0xCD4B080)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_EXTERNALCANCEL_OFFSET UNITYSDK_OFFSET(0xCD4B3F0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_EXTERNALCONFIRM_OFFSET UNITYSDK_OFFSET(0xCD4B390)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETDEBUGSTRING_OFFSET UNITYSDK_OFFSET(0xCD4B440)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETINSTANCENAME_OFFSET UNITYSDK_OFFSET(0xCD4B7B0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETNAME_OFFSET UNITYSDK_OFFSET(0xCD4B510)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETSTATE_OFFSET UNITYSDK_OFFSET(0xCD4B8B0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETTASKOWNER_OFFSET UNITYSDK_OFFSET(0xCD4B9E0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETTASKSTATENAME_OFFSET UNITYSDK_OFFSET(0xCD4BF30)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_GETTASKTYPENAME_OFFSET UNITYSDK_OFFSET(0xCD4BE70)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_HASOWNERFINISHED_OFFSET UNITYSDK_OFFSET(0xCD4B870)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_INITTASK_OFFSET UNITYSDK_OFFSET(0xCD4B150)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_INIT_OFFSET UNITYSDK_OFFSET(0xCD4AF00)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xCD4B8F0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xCD4B990)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ISPAUSABLE_OFFSET UNITYSDK_OFFSET(0xCD4B830)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xCD4B940)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ISTICKINGTASK_OFFSET UNITYSDK_OFFSET(0xCD4B7F0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ISVALID_OFFSET UNITYSDK_OFFSET(0xCD4B2D0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD4B320)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_PAUSEINTASKQUEUE_OFFSET UNITYSDK_OFFSET(0xCD4BE10)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0xCD4BCD0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_PERFORMACTIVATION_OFFSET UNITYSDK_OFFSET(0xCD4BA20)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_READYFORACTIVATION_OFFSET UNITYSDK_OFFSET(0xCD4AF50)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_RESUME_OFFSET UNITYSDK_OFFSET(0xCD4BD30)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_TASKOWNERENDED_OFFSET UNITYSDK_OFFSET(0xCD4B200)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE_TICKTASK_OFFSET UNITYSDK_OFFSET(0xCD4B1A0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD4BFC0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD4BFB0)

namespace NPCCrowd::GameplayTask
{
	inline static constexpr unsigned int NPCGameplayTaskBase_TypeDefinitionIndex = 58195;
	...
	public:
		...
		{
			return (::NPCCrowd::GameplayTask::EActionType*)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskBase_TypeDefinitionIndex)->GetStaticField(0xFFC0);
		}
		::NPCCrowd::GameplayTask::NPCGameplayTaskContainer* TaskOwner; // 0x10
		::System::String* overrideName; // 0x18
		::System::Boolean bIsNeedUpdate; // 0x20
		::System::Boolean bIsPausable; // 0x21
		::NPCCrowd::GameplayTask::EAbilityActionTaskState TaskState; // 0x24
		::System::UInt16 actionNo; // 0x28
		::System::Boolean bOwnerFinished; // 0x2A
		::System::Boolean bTickingTask; // 0x2B
