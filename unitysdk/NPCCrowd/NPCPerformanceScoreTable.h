...
#define NPCCROWD_NPCPERFORMANCESCORETABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0xFFD5D30)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_DESERIALIZEFROMFILE_OFFSET UNITYSDK_OFFSET(0xFFD6CA0)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFFD6440)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_GETSCORE_OFFSET UNITYSDK_OFFSET(0xFFD5D90)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xFFD57E0)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_LOADFROMBINARY_OFFSET UNITYSDK_OFFSET(0xFFD57F0)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_SERIALIZETOFILE_OFFSET UNITYSDK_OFFSET(0xFFD6A60)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0xFFD5EE0)
#define NPCCROWD_NPCPERFORMANCESCORETABLE_TRYGETSCORE_OFFSET UNITYSDK_OFFSET(0xFFD5E30)
#define NPCCROWD_NPCPERFORMANCESCORETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xFFD6E50)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCPerformanceScoreTable_TypeDefinitionIndex = 40039;

	class NPCPerformanceScoreTable : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Int32>* _voIds; // 0x10
		::Il2CppArray<::System::Single>* _scores; // 0x18
