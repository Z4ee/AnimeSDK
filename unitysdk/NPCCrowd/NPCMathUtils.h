...
#define NPCCROWD_NPCMATHUTILS_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0x1150BB40)
#define NPCCROWD_NPCMATHUTILS_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x1150B770)
#define NPCCROWD_NPCMATHUTILS_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0x1150B910)
#define NPCCROWD_NPCMATHUTILS_LENGTH_OFFSET UNITYSDK_OFFSET(0x1150BAB0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathUtils_TypeDefinitionIndex = 40052;
