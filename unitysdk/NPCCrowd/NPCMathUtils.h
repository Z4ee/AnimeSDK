...
#define NPCCROWD_NPCMATHUTILS_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0xE02E450)
#define NPCCROWD_NPCMATHUTILS_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0xE013590)
#define NPCCROWD_NPCMATHUTILS_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0xE02E220)
#define NPCCROWD_NPCMATHUTILS_LENGTH_OFFSET UNITYSDK_OFFSET(0xE02E3C0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathUtils_TypeDefinitionIndex = 69648;
