...
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0xBDEDBE0)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBDEDCF0)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBDEDFB0)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCAccessoryAttachedManager_TypeDefinitionIndex = 56599;
