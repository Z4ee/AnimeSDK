...
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0xD949430)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD949540)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD949800)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCAccessoryAttachedManager_TypeDefinitionIndex = 43390;
