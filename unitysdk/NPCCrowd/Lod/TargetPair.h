...
#define NPCCROWD_LOD_TARGETPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x656980)
#define NPCCROWD_LOD_TARGETPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x656A80)
#define NPCCROWD_LOD_TARGETPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)
#define NPCCROWD_LOD_TARGETPAIR___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x656A90)
#define NPCCROWD_LOD_TARGETPAIR___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x656B00)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int TargetPair_TypeDefinitionIndex = 79411;
