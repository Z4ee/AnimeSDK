...
#define NPCCROWD_LOD_TARGETPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x60FB90)
#define NPCCROWD_LOD_TARGETPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x60FC90)
#define NPCCROWD_LOD_TARGETPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x346F70)
#define NPCCROWD_LOD_TARGETPAIR___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x60FCA0)
#define NPCCROWD_LOD_TARGETPAIR___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x60FD10)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int TargetPair_TypeDefinitionIndex = 46101;
