...
#define NPCCROWD_LOD_TARGETPAIRINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x698850)
#define NPCCROWD_LOD_TARGETPAIRINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x698940)
#define NPCCROWD_LOD_TARGETPAIRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x698830)
#define NPCCROWD_LOD_TARGETPAIRINT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6989A0)
#define NPCCROWD_LOD_TARGETPAIRINT___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x698A00)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int TargetPairInt_TypeDefinitionIndex = 46794;
