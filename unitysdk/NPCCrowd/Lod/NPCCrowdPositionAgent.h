...
#define NPCCROWD_LOD_NPCCROWDPOSITIONAGENT_GETMOVEMENTMAG_OFFSET UNITYSDK_OFFSET(0xD25E580)
#define NPCCROWD_LOD_NPCCROWDPOSITIONAGENT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0xD25E5C0)
#define NPCCROWD_LOD_NPCCROWDPOSITIONAGENT_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xD25E620)
#define NPCCROWD_LOD_NPCCROWDPOSITIONAGENT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xD25E520)
#define NPCCROWD_LOD_NPCCROWDPOSITIONAGENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD25E4A0)
#define NPCCROWD_LOD_NPCCROWDPOSITIONAGENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD25E490)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdPositionAgent_TypeDefinitionIndex = 62148;
