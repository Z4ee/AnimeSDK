...
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17FAFF30)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17FAFFE0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17FAF220)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x17FAFF10)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceManager_NpcCrowdDistanceCheck_TypeDefinitionIndex = 70916;
