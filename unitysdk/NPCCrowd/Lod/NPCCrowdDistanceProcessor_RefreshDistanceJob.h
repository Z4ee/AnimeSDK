...
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_CHECKDISTANCE2D_OFFSET UNITYSDK_OFFSET(0x117A7500)
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x117A7470)
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x74E370)
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_UPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x117A7580)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceProcessor_RefreshDistanceJob_TypeDefinitionIndex = 46423;
