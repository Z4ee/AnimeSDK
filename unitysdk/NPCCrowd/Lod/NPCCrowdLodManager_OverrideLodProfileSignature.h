...
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x6A6E50)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6A6DA0)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE_FLOATTOBITS_OFFSET UNITYSDK_OFFSET(0x102C4C10)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE_FROM_OFFSET UNITYSDK_OFFSET(0x102C2EE0)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6A6E60)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x6A6D70)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6A6ED0)
#define NPCCROWD_LOD_NPCCROWDLODMANAGER_OVERRIDELODPROFILESIGNATURE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6A6F40)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdLodManager_OverrideLodProfileSignature_TypeDefinitionIndex = 44643;
