...
#define NPCCROWD_NPCQUOTAMANAGER_APPLYEDITEDCURRENTTIERSETTINGS_OFFSET UNITYSDK_OFFSET(0xE02EF20)
#define NPCCROWD_NPCQUOTAMANAGER_APPLYTIERSETTINGS_OFFSET UNITYSDK_OFFSET(0xE02EA10)
#define NPCCROWD_NPCQUOTAMANAGER_GETCROWDTHRESHOLDRATIO_OFFSET UNITYSDK_OFFSET(0xE02E680)
#define NPCCROWD_NPCQUOTAMANAGER_GETCURRENTOMITLEVEL_OFFSET UNITYSDK_OFFSET(0xE02E920)
#define NPCCROWD_NPCQUOTAMANAGER_GETEDITABLECURRENTTIERSETTINGS_OFFSET UNITYSDK_OFFSET(0xE02ED10)
#define NPCCROWD_NPCQUOTAMANAGER_GETSERVERNPCTHRESHOLDRATIO_OFFSET UNITYSDK_OFFSET(0xE02E7F0)
#define NPCCROWD_NPCQUOTAMANAGER_GET_BASECROWDCOUNT_OFFSET UNITYSDK_OFFSET(0xE02E590)
#define NPCCROWD_NPCQUOTAMANAGER_GET_CROWDSCORETHRESHOLD_OFFSET UNITYSDK_OFFSET(0xE02E5A0)
#define NPCCROWD_NPCQUOTAMANAGER_GET_CURRENTOMITLEVEL_OFFSET UNITYSDK_OFFSET(0xE02E910)
#define NPCCROWD_NPCQUOTAMANAGER_GET_SCORETHRESHOLD_OFFSET UNITYSDK_OFFSET(0xE02E580)
#define NPCCROWD_NPCQUOTAMANAGER_GET_SERVERNPCCOUNT_OFFSET UNITYSDK_OFFSET(0xE02E880)
#define NPCCROWD_NPCQUOTAMANAGER_GET_SERVERNPCSCORETHRESHOLD_OFFSET UNITYSDK_OFFSET(0xE02E710)
#define NPCCROWD_NPCQUOTAMANAGER_REFRESHTIERSETTINGSIFCHANGED_OFFSET UNITYSDK_OFFSET(0xE02EC20)
#define NPCCROWD_NPCQUOTAMANAGER_REFRESHTIERSETTINGS_OFFSET UNITYSDK_OFFSET(0xE02E520)
#define NPCCROWD_NPCQUOTAMANAGER_SETCURRENTTIERBASECROWDCOUNT_OFFSET UNITYSDK_OFFSET(0xE02F100)
#define NPCCROWD_NPCQUOTAMANAGER_SETCURRENTTIERSCORETHRESHOLD_OFFSET UNITYSDK_OFFSET(0xE02EC90)
#define NPCCROWD_NPCQUOTAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xE02E4C0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCQuotaManager_TypeDefinitionIndex = 72122;
	...
	public:
		...
		::NPCCrowd::NPCPerformanceTierSettings _tierSettings; // 0x20
		::MoleMole::PerformanceSettingProfile_ENPCOmitLevel _cachedOmitLevel; // 0x28
		::System::Boolean _bHasCachedOmitLevel; // 0x2C
