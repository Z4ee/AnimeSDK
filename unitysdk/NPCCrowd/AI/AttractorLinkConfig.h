...
#define NPCCROWD_AI_ATTRACTORLINKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x157A6E30)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorLinkConfig_TypeDefinitionIndex = 79081;
