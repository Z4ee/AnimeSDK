...
#define NPCCROWD_AI_ATTRACTORLINKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE8B64F0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorLinkConfig_TypeDefinitionIndex = 58729;
