...
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x5C9F10)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTEJOB_FINDCLOSESTENTITYBYTAG_OFFSET UNITYSDK_OFFSET(0x5C9F20)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x5C9F00)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorQueryEntityProcessor_ExecuteJob_TypeDefinitionIndex = 84711;
