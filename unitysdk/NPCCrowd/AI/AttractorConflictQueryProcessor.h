...
#define NPCCROWD_AI_ATTRACTORCONFLICTQUERYPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x106EDA70)
#define NPCCROWD_AI_ATTRACTORCONFLICTQUERYPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x106EDC50)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorConflictQueryProcessor_TypeDefinitionIndex = 61515;
