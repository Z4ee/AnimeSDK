...
#define NPCCROWD_AI_AIACTIONRANDOMBUBBLECHATCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x6241B0)
#define NPCCROWD_AI_AIACTIONRANDOMBUBBLECHATCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x624200)
#define NPCCROWD_AI_AIACTIONRANDOMBUBBLECHATCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0xE8A1010)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRandomBubbleChatConfig_TypeDefinitionIndex = 44920;
	...
	struct alignas(8) AIActionRandomBubbleChatConfig
	{
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AIActionRandomBubbleChatConfig_TypeDefinitionIndex)->GetStaticField(0x34D50);
		}
