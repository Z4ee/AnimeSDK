...
#define NPCCROWD_AI_FEATUREPOINTPATHREFLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x11B0FA80)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FeaturePointPathRefList_TypeDefinitionIndex = 76893;
