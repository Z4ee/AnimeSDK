...
#define NPCCROWD_AI_FEATUREPOINTPATHREFLIST__CTOR_OFFSET UNITYSDK_OFFSET(0xF99C420)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FeaturePointPathRefList_TypeDefinitionIndex = 69583;
