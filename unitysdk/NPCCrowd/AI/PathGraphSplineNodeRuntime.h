...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x114F78F0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETAFTERVERTICALSEGMENT_OFFSET UNITYSDK_OFFSET(0x114F95F0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETCONTROLPOINTPOS_OFFSET UNITYSDK_OFFSET(0x114F86A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETDIRECTIONBYPOSITION_OFFSET UNITYSDK_OFFSET(0x114F9A10)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANECENTEROFFSET_OFFSET UNITYSDK_OFFSET(0x114F8430)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x114F8180)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x114F8070)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x114F7940)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0x114F7F50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETNEXTCONNECTORNODEID_OFFSET UNITYSDK_OFFSET(0x114F7C00)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETOTHERINVERSELANE_OFFSET UNITYSDK_OFFSET(0x114FA0D0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPATHDISTANCEBYPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x114F9EB0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_1_OFFSET UNITYSDK_OFFSET(0x114F8A20)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_OFFSET UNITYSDK_OFFSET(0x114F8860)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSLOPETYPE_OFFSET UNITYSDK_OFFSET(0x114F9490)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTRANSITIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x114F9130)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTYPE_OFFSET UNITYSDK_OFFSET(0x114F8DB0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTUPAXIS_OFFSET UNITYSDK_OFFSET(0x114F8C50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINDEX_OFFSET UNITYSDK_OFFSET(0x114F7CD0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0x114F7DC0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETSLOPEANGLECOSINE_OFFSET UNITYSDK_OFFSET(0x114F9780)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_1_OFFSET UNITYSDK_OFFSET(0x114F9DD0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x114F9C40)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETVERTICALDIRECTION_OFFSET UNITYSDK_OFFSET(0x114F8F50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x114F6FE0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONTROLPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0x114F7840)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x114F7A80)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x114F7870)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x114F6900)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x114FA660)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x114FA6A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x114FA6C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_TypeDefinitionIndex = 66628;

	class PathGraphSplineNodeRuntime : public ::NPCCrowd::AI::PathGraphNodeRuntime
	{
	public:
		::NPCCrowd::AI::PathGraphSplineNodeRuntime_BlockState* BlockBackward; // 0x20
		::System::Collections::Generic::List_1<::System::Int32>* cache; // 0x28
		::NPCCrowd::AI::PathGraphSplineNodeRuntime_BlockState* BlockForward; // 0x30
		...
		::UnityEngine::Vector3 GetLanePosition(::System::Int32 pointIndex, ::System::Int32 laneIndex, ::System::Single laneInnerOffset)
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::System::Int32, ::System::Int32, ::System::Single))((::PBYTE)hIl2Cpp + NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_OFFSET))(this, pointIndex, laneIndex, laneInnerOffset);
		}

		static ::UnityEngine::Vector3 GetLanePosition_1(::NPCCrowd::AI::PathGraphSplineConfig* splineConfig, ::System::Int32 pointIndex, ::System::Int32 laneIndex, ::System::Single laneInnerOffset)
		{
			return ((::UnityEngine::Vector3(*)(::NPCCrowd::AI::PathGraphSplineConfig*, ::System::Int32, ::System::Int32, ::System::Single))((::PBYTE)hIl2Cpp + NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_1_OFFSET))(splineConfig, pointIndex, laneIndex, laneInnerOffset);
		}
