...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x11923880)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETAFTERVERTICALSEGMENT_OFFSET UNITYSDK_OFFSET(0x11925670)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETCONTROLPOINTPOS_OFFSET UNITYSDK_OFFSET(0x119247B0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETDIRECTIONBYPOSITION_OFFSET UNITYSDK_OFFSET(0x11925A90)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANECENTEROFFSET_OFFSET UNITYSDK_OFFSET(0x11924550)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x11924230)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x11924110)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x119238D0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0x11923FE0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETNEXTCONNECTORNODEID_OFFSET UNITYSDK_OFFSET(0x11923B90)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETOTHERINVERSELANE_OFFSET UNITYSDK_OFFSET(0x11926320)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPATHDESIREDSPEED_OFFSET UNITYSDK_OFFSET(0x11923700)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPATHDISTANCEBYPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x119260F0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_1_OFFSET UNITYSDK_OFFSET(0x11924B30)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_OFFSET UNITYSDK_OFFSET(0x11924970)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSLOPETYPE_OFFSET UNITYSDK_OFFSET(0x11925500)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTRANSITIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x11925210)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTYPE_OFFSET UNITYSDK_OFFSET(0x11924E90)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTUPAXIS_OFFSET UNITYSDK_OFFSET(0x11924D30)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINDEX_OFFSET UNITYSDK_OFFSET(0x11923C60)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINNEROFFSET2D_OFFSET UNITYSDK_OFFSET(0x11923EE0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0x11923D50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETSLOPEANGLECOSINE_OFFSET UNITYSDK_OFFSET(0x11925840)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_1_OFFSET UNITYSDK_OFFSET(0x11925F00)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x11925C40)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETVERTICALDIRECTION_OFFSET UNITYSDK_OFFSET(0x11925030)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x11922EA0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONTROLPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0x119237D0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x11923A10)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x11923800)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x119227E0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x119268A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x119268E0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x11926900)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_TypeDefinitionIndex = 84109;
