...
#define NPCCROWD_AI_ATTRACTORMANAGER___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD226F30)
#define NPCCROWD_AI_ATTRACTORMANAGER___C__DISPLAYCLASS40_0__INITHANDLECONFLICT_B__1_OFFSET UNITYSDK_OFFSET(0xD226F40)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorManager___c__DisplayClass40_0_TypeDefinitionIndex = 74666;

	class AttractorManager___c__DisplayClass40_0 : public ::System::Object
	{
	public:
		::NPCCrowd::AI::AttractorManager* __4__this; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* id2Handler; // 0x18
