...
#define NPCCROWD_AI_ATTRACTORTESTINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x117842D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorTestInstance_TypeDefinitionIndex = 81970;
