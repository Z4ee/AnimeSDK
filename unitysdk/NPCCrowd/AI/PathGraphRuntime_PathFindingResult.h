...
#define NPCCROWD_AI_PATHGRAPHRUNTIME_PATHFINDINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xF764FE0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphRuntime_PathFindingResult_TypeDefinitionIndex = 60102;
	...
	public:
		...
		::System::Int32 PathID; // 0x20
		::System::Int32 EndPointID; // 0x24
		::System::Int32 StartPointID; // 0x28
