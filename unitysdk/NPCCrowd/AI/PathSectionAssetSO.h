...
#define NPCCROWD_AI_PATHSECTIONASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x10B39840)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathSectionAssetSO_TypeDefinitionIndex = 43057;
