...
#define NPCCROWD_AI_PATHSECTIONASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0xD5AC280)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathSectionAssetSO_TypeDefinitionIndex = 43799;
