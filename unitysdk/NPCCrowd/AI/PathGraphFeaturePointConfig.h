...
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x15B71920)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTSPLINENODEINDEX_OFFSET UNITYSDK_OFFSET(0x15B71910)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0x15B71860)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15B71800)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphFeaturePointConfig_TypeDefinitionIndex = 84750;
