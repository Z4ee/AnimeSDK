...
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1135DC00)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTSPLINENODEINDEX_OFFSET UNITYSDK_OFFSET(0x1135DBF0)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0x1135DB40)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1135DAE0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphFeaturePointConfig_TypeDefinitionIndex = 75748;
