...
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETNODE_OFFSET UNITYSDK_OFFSET(0xF84C360)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATHBETWEEN_1_OFFSET UNITYSDK_OFFSET(0xF84C690)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATHBETWEEN_OFFSET UNITYSDK_OFFSET(0xF84C520)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATH_OFFSET UNITYSDK_OFFSET(0xF84C440)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_REGENERATEIDS_OFFSET UNITYSDK_OFFSET(0xF84C710)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0xF84C120)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphDataAssetSO_TypeDefinitionIndex = 80337;
