...
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1826BED0)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1826B1D0)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_RETURNTOINITSTATE_OFFSET UNITYSDK_OFFSET(0x1826B090)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1826C100)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCFindAttractorProcessor_TypeDefinitionIndex = 67504;
