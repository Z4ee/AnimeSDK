...
#define NPCCROWD_AI_NPCCROWDREACTIONMANAGER___C__DISPLAYCLASS24_1__CTOR_OFFSET UNITYSDK_OFFSET(0x10297540)
#define NPCCROWD_AI_NPCCROWDREACTIONMANAGER___C__DISPLAYCLASS24_1__HANDLEEVENTCONFIGSTIMULUSENABLE_B__0_OFFSET UNITYSDK_OFFSET(0x10297550)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCCrowdReactionManager___c__DisplayClass24_1_TypeDefinitionIndex = 69220;

	class NPCCrowdReactionManager___c__DisplayClass24_1 : public ::System::Object
	{
	public:
		::MoleMole::Battle::Entity* owner; // 0x10
		::NPCCrowd::AI::NPCCrowdReactionManager___c__DisplayClass24_0* CS___8__locals1; // 0x18
