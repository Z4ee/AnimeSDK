...
#define NPCCROWD_AI_ATTRACTORCLUSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xFFA19C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorClusterConfig_TypeDefinitionIndex = 67506;
