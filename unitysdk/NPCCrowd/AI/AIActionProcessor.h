...
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0xF8478D0)
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF846F20)
#define NPCCROWD_AI_AIACTIONPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF847B80)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionProcessor_TypeDefinitionIndex = 60755;
