...
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE_GET_ALLOWEDMAXCROWD_OFFSET UNITYSDK_OFFSET(0x8C23E30)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE_REFRESHRUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0x8C24050)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C24090)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineConfig_PathGraphLane_TypeDefinitionIndex = 53545;
