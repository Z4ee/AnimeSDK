...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xE556430)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointComponent_TypeDefinitionIndex = 80327;
