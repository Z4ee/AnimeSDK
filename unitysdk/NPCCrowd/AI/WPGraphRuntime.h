...
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETALLENTERNODE_OFFSET UNITYSDK_OFFSET(0xBDD2350)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODEBYIDX_OFFSET UNITYSDK_OFFSET(0xBDD1FC0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODECALMEMORYBYIDX_OFFSET UNITYSDK_OFFSET(0xBDD2040)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODECALMEMORY_OFFSET UNITYSDK_OFFSET(0xBDD20B0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODECFG_OFFSET UNITYSDK_OFFSET(0xBDD2250)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODEINDEX_OFFSET UNITYSDK_OFFSET(0xBDD2190)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODE_OFFSET UNITYSDK_OFFSET(0xBDD1BC0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATHBETWEEN_1_OFFSET UNITYSDK_OFFSET(0xBDD27D0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATHBETWEEN_OFFSET UNITYSDK_OFFSET(0xBDD26B0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATHCFG_OFFSET UNITYSDK_OFFSET(0xBDD25C0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATH_OFFSET UNITYSDK_OFFSET(0xBDD1CC0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETSTATEID_OFFSET UNITYSDK_OFFSET(0xBDD1DF0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_HASSTATE_OFFSET UNITYSDK_OFFSET(0xBDD1E40)
#define NPCCROWD_AI_WPGRAPHRUNTIME_SETSTATEID_OFFSET UNITYSDK_OFFSET(0xBDD16F0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_TRYGETNODECOPY_OFFSET UNITYSDK_OFFSET(0xBDD1EA0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_TRYGETPATH_OFFSET UNITYSDK_OFFSET(0xBDD24A0)
#define NPCCROWD_AI_WPGRAPHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD12B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphRuntime_TypeDefinitionIndex = 49097;

	class WPGraphRuntime : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt16>* nodeIds; // 0x10
		::Il2CppArray<::NPCCrowd::AI::FNodeRuntime>* nodes; // 0x18
		::NPCCrowd::AI::WPGraphDataStateAssetSO* wpGraphStateCfg; // 0x20
		::Il2CppArray<::System::UInt16>* pathIds; // 0x28
		::NPCCrowd::AI::WPPathSetting* graphPathSetting; // 0x30
		::Il2CppArray<::NPCCrowd::AI::NodeCaluateMemory*>* nodeCalMemory; // 0x38
		::Il2CppArray<::NPCCrowd::AI::FPathRuntime>* paths; // 0x40
		::NPCCrowd::AI::WPGraphDataStateAssetSO_WPGraphDataState* currentState; // 0x48
		::NPCCrowd::AI::WPGraphDataAssetSO* wpGraphCfg; // 0x50
