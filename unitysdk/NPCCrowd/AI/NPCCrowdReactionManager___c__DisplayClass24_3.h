...
#define NPCCROWD_AI_NPCCROWDREACTIONMANAGER___C__DISPLAYCLASS24_3__CTOR_OFFSET UNITYSDK_OFFSET(0x11277FB0)
#define NPCCROWD_AI_NPCCROWDREACTIONMANAGER___C__DISPLAYCLASS24_3__HANDLEEVENTCONFIGSTIMULUSENABLE_B__1_OFFSET UNITYSDK_OFFSET(0x11277FC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCCrowdReactionManager___c__DisplayClass24_3_TypeDefinitionIndex = 46388;
