...
#define NPCCROWD_AI_WAITINGSLOTTEMPLATESSO__CTOR_OFFSET UNITYSDK_OFFSET(0xF5FB970)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WaitingSlotTemplatesSO_TypeDefinitionIndex = 75885;
