...
#define NPCCROWD_AI_WAITINGSLOTTEMPLATESSO__CTOR_OFFSET UNITYSDK_OFFSET(0xFB4E0B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WaitingSlotTemplatesSO_TypeDefinitionIndex = 49651;
