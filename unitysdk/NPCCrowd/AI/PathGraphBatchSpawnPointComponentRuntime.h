...
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x11B0FB90)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x11B0FB00)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_PAIRITEMSFROMTWOLISTSRANDOMLYKEEPINGORDER_OFFSET UNITYSDK_OFFSET(0x11B0FEA0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_SPAWNBATCH_OFFSET UNITYSDK_OFFSET(0x11B0FBE0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x11B101A0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x11B101B0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x11B10240)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphBatchSpawnPointComponentRuntime_TypeDefinitionIndex = 67943;
