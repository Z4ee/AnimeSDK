...
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xF0CA490)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xF0CA400)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_PAIRITEMSFROMTWOLISTSRANDOMLYKEEPINGORDER_OFFSET UNITYSDK_OFFSET(0xF0CA7A0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_SPAWNBATCH_OFFSET UNITYSDK_OFFSET(0xF0CA4E0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xF0CAAA0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0xF0CAAB0)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xF0CAB40)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphBatchSpawnPointComponentRuntime_TypeDefinitionIndex = 65395;
