...
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG_PATHGRAPHCONNECTION_GET_ENDNODEINDEX_OFFSET UNITYSDK_OFFSET(0xE8B66C0)
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG_PATHGRAPHCONNECTION_GET_STARTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xE8B66B0)
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG_PATHGRAPHCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE8B66D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConnectorConfig_PathGraphConnection_TypeDefinitionIndex = 77674;
