...
#define NPCCROWD_AI_PATHSTATEASSETSO_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8C241A0)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8C24160)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8C24120)
#define NPCCROWD_AI_PATHSTATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x8C241E0)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8C245E0)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8C245F0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathStateAssetSO_TypeDefinitionIndex = 84576;
