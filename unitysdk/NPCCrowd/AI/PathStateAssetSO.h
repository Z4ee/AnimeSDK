...
#define NPCCROWD_AI_PATHSTATEASSETSO_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10295600)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x102955C0)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10295580)
#define NPCCROWD_AI_PATHSTATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x10295640)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10295A40)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10295A50)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathStateAssetSO_TypeDefinitionIndex = 81245;
