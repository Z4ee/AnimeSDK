...
#define NPCCROWD_AI_COMPARECONDITION_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0x951C420)
#define NPCCROWD_AI_COMPARECONDITION_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0x951C2F0)
#define NPCCROWD_AI_COMPARECONDITION_CHECKINT_OFFSET UNITYSDK_OFFSET(0x951C480)
#define NPCCROWD_AI_COMPARECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x951C2E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int CompareCondition_TypeDefinitionIndex = 54789;
