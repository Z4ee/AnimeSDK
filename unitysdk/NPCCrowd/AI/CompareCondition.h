...
#define NPCCROWD_AI_COMPARECONDITION_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0xB52B7A0)
#define NPCCROWD_AI_COMPARECONDITION_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0xB52B650)
#define NPCCROWD_AI_COMPARECONDITION_CHECKINT_OFFSET UNITYSDK_OFFSET(0xB52B800)
#define NPCCROWD_AI_COMPARECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0xB52B640)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int CompareCondition_TypeDefinitionIndex = 73011;
