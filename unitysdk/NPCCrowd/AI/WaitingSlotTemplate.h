...
#define NPCCROWD_AI_WAITINGSLOTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0xF99CD00)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WaitingSlotTemplate_TypeDefinitionIndex = 43297;
