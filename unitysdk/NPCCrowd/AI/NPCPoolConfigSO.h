...
#define NPCCROWD_AI_NPCPOOLCONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x10B391A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCPoolConfigSO_TypeDefinitionIndex = 62291;
