...
#define NPCCROWD_AI_NPCPOOLCONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0xD5ABBE0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCPoolConfigSO_TypeDefinitionIndex = 60803;
