...
#define NPCCROWD_AI_TRIGGEREVENTSTIMULUSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD87FC30)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int TriggerEventStimulusItem_TypeDefinitionIndex = 55765;
