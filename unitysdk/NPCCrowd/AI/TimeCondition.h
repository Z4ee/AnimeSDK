...
#define NPCCROWD_AI_TIMECONDITION_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x695FF0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int TimeCondition_TypeDefinitionIndex = 60623;
