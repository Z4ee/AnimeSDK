...
#define NPCCROWD_AI_PATHGRAPHASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0xF84EF10)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphAssetSO_TypeDefinitionIndex = 71474;
