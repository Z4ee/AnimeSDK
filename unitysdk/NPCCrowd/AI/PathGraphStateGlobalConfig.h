...
#define NPCCROWD_AI_PATHGRAPHSTATEGLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF99CCE0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphStateGlobalConfig_TypeDefinitionIndex = 81011;
