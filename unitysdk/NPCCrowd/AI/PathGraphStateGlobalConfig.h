...
#define NPCCROWD_AI_PATHGRAPHSTATEGLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11B10340)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphStateGlobalConfig_TypeDefinitionIndex = 45575;
