...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x10294F50)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__DISPLAYCLASS20_0__SPAWNIMMEDIATELYFORPATH_B__0_OFFSET UNITYSDK_OFFSET(0x10294F60)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__DISPLAYCLASS20_0__SPAWNIMMEDIATELYFORPATH_B__1_OFFSET UNITYSDK_OFFSET(0x10295250)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointPathSpawnGroupRuntime___c__DisplayClass20_0_TypeDefinitionIndex = 42283;

	class PathGraphGuidePointPathSpawnGroupRuntime___c__DisplayClass20_0 : public ::System::Object
	{
	public:
		::NPCCrowd::AI::PathGraphSplineControlPointLocatorComponent* locator; // 0x10
		::NPCCrowd::AI::PathGraphFeaturePointV2Config* pointConfig; // 0x18
		...
		::NPCCrowd::AI::PathGraphGuidePointPathSpawnGroupRuntime* __4__this; // 0x30
		::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime* spawnPoint; // 0x38
