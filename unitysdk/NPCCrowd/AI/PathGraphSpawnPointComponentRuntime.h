...
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xBDD02F0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_ENABLESPAWN_OFFSET UNITYSDK_OFFSET(0xBDD0540)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_GET_ISIDLE_OFFSET UNITYSDK_OFFSET(0xBDD0590)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xBDD01D0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_ISINAVATARDISTANCERANGE_OFFSET UNITYSDK_OFFSET(0xBDD09F0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_ISINMAINCAMERAFRUSTUM_OFFSET UNITYSDK_OFFSET(0xBDD0BA0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_PROCESSLIMITCONDITIONS_OFFSET UNITYSDK_OFFSET(0xBDD0710)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_REMOVESPAWNEDNPC_OFFSET UNITYSDK_OFFSET(0xBDD0990)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_SPAWNIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xBDD0820)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_SPAWNQUEUED_OFFSET UNITYSDK_OFFSET(0xBDD05F0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_UPDATESPAWNQUEUE_OFFSET UNITYSDK_OFFSET(0xBDD0440)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0xBDD03E0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD0C60)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0xBDD0CC0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xBDD0D50)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xBDD0DE0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSpawnPointComponentRuntime_TypeDefinitionIndex = 47624;

	class PathGraphSpawnPointComponentRuntime : public ::NPCCrowd::AI::PathGraphFeaturePointComponentRuntime
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* _spawnedTags; // 0x18
		::NPCCrowd::AI::PathGraphSplineLaneLocatorComponent* _locator; // 0x20
		::System::Collections::Generic::Queue_1<::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime_SpawnAction*>* _spawnQueue; // 0x28
