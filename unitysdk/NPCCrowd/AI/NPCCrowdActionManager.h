...
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_CREATEWRAPPERFORJOB_OFFSET UNITYSDK_OFFSET(0x11274500)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_DELAYAWAKEACTION_OFFSET UNITYSDK_OFFSET(0x11273AA0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_DELAYSLEEPACTION_OFFSET UNITYSDK_OFFSET(0x112739B0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_DELAYUNREGISTERACTION_OFFSET UNITYSDK_OFFSET(0x11273830)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_GETCOMMONCHANGEPATHFOLLOWACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x11273B90)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_GETENTITYACTION_OFFSET UNITYSDK_OFFSET(0x11270ED0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x11270D50)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_ISSTATEEND_OFFSET UNITYSDK_OFFSET(0x11276B20)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_MOVEACTIONTOSLEEP_OFFSET UNITYSDK_OFFSET(0x112735A0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11271C90)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x11271820)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11272D00)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x112716F0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x11271CF0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_QUERYACTIONFINISHSTATE_OFFSET UNITYSDK_OFFSET(0x112772C0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_QUERYACTIONSTATEFORJOB_OFFSET UNITYSDK_OFFSET(0x11276B60)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_QUERYACTION_OFFSET UNITYSDK_OFFSET(0x112773B0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REGISTERACTION_1_OFFSET UNITYSDK_OFFSET(0x112741E0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REGISTERACTION_2_OFFSET UNITYSDK_OFFSET(0x11274290)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REGISTERACTION_3_OFFSET UNITYSDK_OFFSET(0x11274430)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REGISTERACTION_4_OFFSET UNITYSDK_OFFSET(0x11273D60)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REGISTERACTION_OFFSET UNITYSDK_OFFSET(0x11273BD0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REMOVEACTION_OFFSET UNITYSDK_OFFSET(0x11276470)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_REMOVEENTITYACTION_OFFSET UNITYSDK_OFFSET(0x112766C0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_SETHANDLEREFFECTFORCECULLED_OFFSET UNITYSDK_OFFSET(0x11276180)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_SHOULDREMOVEACTION_OFFSET UNITYSDK_OFFSET(0x11273740)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x11271600)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_SYNCPLAYEFFECTFORCECULLEDBYLOD_OFFSET UNITYSDK_OFFSET(0x11276030)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_TRYGETACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x112758E0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_UNREGISTERACTION_OFFSET UNITYSDK_OFFSET(0x11274690)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_UNREGISTERENTITYPLAYEFFECTACTIONS_OFFSET UNITYSDK_OFFSET(0x11275630)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER_WAKEACTION_OFFSET UNITYSDK_OFFSET(0x11272B60)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x11277C60)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x112776A0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11277CC0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x11277D50)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER___BASE_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11277DE0)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER___BASE_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x11277E80)
#define NPCCROWD_AI_NPCCROWDACTIONMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x11277F20)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCCrowdActionManager_TypeDefinitionIndex = 60937;
	...
	public:
		...
		{
			return (::NPCCrowd::IdGenerator**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdActionManager_TypeDefinitionIndex)->GetStaticField(0x50150);
		}
		static ::Foundation::AssetRequestHandle* StaticGet_AssetRequest()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdActionManager_TypeDefinitionIndex)->GetStaticField(0x50158);
		}
		static ::System::String** StaticGet_TEMPLATE_ASSET_SO()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdActionManager_TypeDefinitionIndex)->GetStaticField(0x50178);
		}
		static ::NPCCrowd::AI::AIActionConfigAssetSO** StaticGet_ActionConfigSO()
		{
			return (::NPCCrowd::AI::AIActionConfigAssetSO**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdActionManager_TypeDefinitionIndex)->GetStaticField(0x50180);
		}
		::Foundation::ObjectPool_1<::System::Collections::Generic::List_1<::System::Int32>*>* intListPool; // 0x18
		::System::Collections::Generic::HashSet_1<::System::Int32>* delayAwakeActions; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>*>* entityCache; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::System::Int32>*>* registedEntities; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AIActionWrapperForJob>* queuedActions; // 0x38
		::System::Collections::Generic::HashSet_1<::System::Int32>* delaySleepActions; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AIActionWrapperForJob>* sleepActions; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AIActionWrapperForJob>* actions; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AIActionWrapperForJob>* sleepActionsForJob; // 0x58
		::NPCCrowd::AI::AIActionReturnToPathFollowConfig commonChangePathFollowActionConfig; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AIActionWrapperForJob>* actionsForJob; // 0x68
		::System::Collections::Generic::List_1<::System::Int32>* cache; // 0x70
