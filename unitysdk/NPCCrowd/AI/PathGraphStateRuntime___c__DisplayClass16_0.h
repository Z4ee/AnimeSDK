...
#define NPCCROWD_AI_PATHGRAPHSTATERUNTIME___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xF84FD90)
#define NPCCROWD_AI_PATHGRAPHSTATERUNTIME___C__DISPLAYCLASS16_0__GETSPAWNGROUP_B__0_OFFSET UNITYSDK_OFFSET(0xF84FDA0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphStateRuntime___c__DisplayClass16_0_TypeDefinitionIndex = 68726;
