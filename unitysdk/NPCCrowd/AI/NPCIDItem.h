...
#define NPCCROWD_AI_NPCIDITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x830D60)
#define NPCCROWD_AI_NPCIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x830DB0)
#define NPCCROWD_AI_NPCIDITEM___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x830DC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCIDItem_TypeDefinitionIndex = 88635;
