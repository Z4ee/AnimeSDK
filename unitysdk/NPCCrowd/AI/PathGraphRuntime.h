...
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARNODES_OFFSET UNITYSDK_OFFSET(0x11922940)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARPATHFINDING_OFFSET UNITYSDK_OFFSET(0x11922B10)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x11922840)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_1_OFFSET UNITYSDK_OFFSET(0x11923150)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_OFFSET UNITYSDK_OFFSET(0x11922F60)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_GETNODE_OFFSET UNITYSDK_OFFSET(0x11922080)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITNODES_OFFSET UNITYSDK_OFFSET(0x119221B0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITPATHFINDING_OFFSET UNITYSDK_OFFSET(0x11922710)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x11922160)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_REFRESH_OFFSET UNITYSDK_OFFSET(0x11922B70)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_SETPATHGRAPHSTATE_OFFSET UNITYSDK_OFFSET(0x11922F10)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x119233D0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__15_0_OFFSET UNITYSDK_OFFSET(0x11923460)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__16_0_OFFSET UNITYSDK_OFFSET(0x11923570)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphRuntime_TypeDefinitionIndex = 60101;

	class PathGraphRuntime : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::PathGraphNodeRuntime*>* _nodeDictionary; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::PathGraphRuntime_PathFindingResult*>* _pathCache; // 0x18
		::NPCCrowd::AI::PathGraphConfig* Config; // 0x20
		::NPCCrowd::AI::PathGraphStateRuntime* _stateRuntime; // 0x28
		::NPCCrowd::AI::PathFindingGraph* _pathFindingGraph; // 0x30
