...
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARNODES_OFFSET UNITYSDK_OFFSET(0xE004270)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARPATHFINDING_OFFSET UNITYSDK_OFFSET(0xE004440)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xE004170)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_1_OFFSET UNITYSDK_OFFSET(0xE004AA0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_OFFSET UNITYSDK_OFFSET(0xE0048B0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_GETNODE_OFFSET UNITYSDK_OFFSET(0xE0039B0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITNODES_OFFSET UNITYSDK_OFFSET(0xE003AE0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITPATHFINDING_OFFSET UNITYSDK_OFFSET(0xE004040)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xE003A90)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_REFRESH_OFFSET UNITYSDK_OFFSET(0xE0044A0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_SETPATHGRAPHSTATE_OFFSET UNITYSDK_OFFSET(0xE004860)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xE004D30)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__15_0_OFFSET UNITYSDK_OFFSET(0xE004DC0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__16_0_OFFSET UNITYSDK_OFFSET(0xE004ED0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphRuntime_TypeDefinitionIndex = 45973;

	class PathGraphRuntime : public ::System::Object
	{
	public:
		::NPCCrowd::AI::PathGraphStateRuntime* _stateRuntime; // 0x10
		::NPCCrowd::AI::PathGraphConfig* Config; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::PathGraphRuntime_PathFindingResult*>* _pathCache; // 0x20
