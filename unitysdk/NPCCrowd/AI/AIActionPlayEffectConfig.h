...
#define NPCCROWD_AI_AIACTIONPLAYEFFECTCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x6D9ED0)
#define NPCCROWD_AI_AIACTIONPLAYEFFECTCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x6D9F20)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionPlayEffectConfig_TypeDefinitionIndex = 52763;
