...
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xCD23570)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_GET_GM_SWITCHOFF_OFFSET UNITYSDK_OFFSET(0xCD236C0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xCD23360)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_SETSWITCHOFF_OFFSET UNITYSDK_OFFSET(0xCD236D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xCD23FA0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__SETSWITCHOFF_G__GETSTARTBLOCKSTATE_9_1_OFFSET UNITYSDK_OFFSET(0xCD23F80)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__SETSWITCHOFF_G__GETSTOPBLOCKSTATE_9_0_OFFSET UNITYSDK_OFFSET(0xCD23F60)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0xCD23FB0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xCD24040)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphCrossingPointComponentRuntime_TypeDefinitionIndex = 79881;
