...
#define NPCCROWD_AI_ATTRACTORMANAGER_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xB529CD0)
#define NPCCROWD_AI_ATTRACTORMANAGER_CLAIMATTRACTORSLOT_OFFSET UNITYSDK_OFFSET(0xB52A300)
#define NPCCROWD_AI_ATTRACTORMANAGER_CLEARATTRACTED_OFFSET UNITYSDK_OFFSET(0xB52AA50)
#define NPCCROWD_AI_ATTRACTORMANAGER_CLEARDATA_OFFSET UNITYSDK_OFFSET(0xB5241D0)
#define NPCCROWD_AI_ATTRACTORMANAGER_CREATECROWDENTITYWITHATTRACTOR_1_OFFSET UNITYSDK_OFFSET(0xB528370)
#define NPCCROWD_AI_ATTRACTORMANAGER_CREATECROWDENTITYWITHATTRACTOR_OFFSET UNITYSDK_OFFSET(0xB528240)
#define NPCCROWD_AI_ATTRACTORMANAGER_DEBUGSETALLATTRACTORCONDITIONIGNORE_OFFSET UNITYSDK_OFFSET(0xB52ACD0)
#define NPCCROWD_AI_ATTRACTORMANAGER_DELAYREFRESHALLCONFLICT_OFFSET UNITYSDK_OFFSET(0xB5270E0)
#define NPCCROWD_AI_ATTRACTORMANAGER_DELAYREFRESHSERVERATTRACTORCONFLICT_OFFSET UNITYSDK_OFFSET(0xB5273B0)
#define NPCCROWD_AI_ATTRACTORMANAGER_DELAYSETATTRACTORENABLE_OFFSET UNITYSDK_OFFSET(0xB52A290)
#define NPCCROWD_AI_ATTRACTORMANAGER_DISABLEENTITYATTRACT_OFFSET UNITYSDK_OFFSET(0xB527E80)
#define NPCCROWD_AI_ATTRACTORMANAGER_FORCEATTRACTORSPAWNENTITY_OFFSET UNITYSDK_OFFSET(0xB52A710)
#define NPCCROWD_AI_ATTRACTORMANAGER_FORCESETATTRACTENTITY_1_OFFSET UNITYSDK_OFFSET(0xB52A450)
#define NPCCROWD_AI_ATTRACTORMANAGER_FORCESETATTRACTENTITY_OFFSET UNITYSDK_OFFSET(0xB523B50)
#define NPCCROWD_AI_ATTRACTORMANAGER_GETATTRACTORRUNTIME_OFFSET UNITYSDK_OFFSET(0xB5239C0)
#define NPCCROWD_AI_ATTRACTORMANAGER_GETINSTANCESECTIONID_OFFSET UNITYSDK_OFFSET(0xB523700)
#define NPCCROWD_AI_ATTRACTORMANAGER_GET_NEEDREFRESHCONFLICT_OFFSET UNITYSDK_OFFSET(0xB523310)
#define NPCCROWD_AI_ATTRACTORMANAGER_GET_OFFSET UNITYSDK_OFFSET(0xB523320)
#define NPCCROWD_AI_ATTRACTORMANAGER_HANDLEMAINCITYOBJECTAREA_OFFSET UNITYSDK_OFFSET(0xB52AAF0)
#define NPCCROWD_AI_ATTRACTORMANAGER_HANDLESERVERDATA_OFFSET UNITYSDK_OFFSET(0xB523760)
#define NPCCROWD_AI_ATTRACTORMANAGER_INITHANDLECONFLICT_OFFSET UNITYSDK_OFFSET(0xB525830)
#define NPCCROWD_AI_ATTRACTORMANAGER_INITLINANDCLUSTER_OFFSET UNITYSDK_OFFSET(0xB524F60)
#define NPCCROWD_AI_ATTRACTORMANAGER_INITNEARESTDATA_OFFSET UNITYSDK_OFFSET(0xB526120)
#define NPCCROWD_AI_ATTRACTORMANAGER_INITRUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0xB524A30)
#define NPCCROWD_AI_ATTRACTORMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xB523440)
#define NPCCROWD_AI_ATTRACTORMANAGER_LOADCURSECTIONDATA_OFFSET UNITYSDK_OFFSET(0xB524680)
#define NPCCROWD_AI_ATTRACTORMANAGER_ONATTRACTORSPAWNEDENTITYLOADED_OFFSET UNITYSDK_OFFSET(0xB5290B0)
#define NPCCROWD_AI_ATTRACTORMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB523DC0)
#define NPCCROWD_AI_ATTRACTORMANAGER_ONENTITYDESTROY_OFFSET UNITYSDK_OFFSET(0xB52A8B0)
#define NPCCROWD_AI_ATTRACTORMANAGER_ONREFRESHDATABIGSCENE_OFFSET UNITYSDK_OFFSET(0xB523EE0)
#define NPCCROWD_AI_ATTRACTORMANAGER_ONREFRESHDATA_OFFSET UNITYSDK_OFFSET(0xB5269B0)
#define NPCCROWD_AI_ATTRACTORMANAGER_ONSETATTRACTORENABLE_OFFSET UNITYSDK_OFFSET(0xB529E60)
#define NPCCROWD_AI_ATTRACTORMANAGER_POSTREFRESHDATABIGSCENE_OFFSET UNITYSDK_OFFSET(0xB5260D0)
#define NPCCROWD_AI_ATTRACTORMANAGER_REFRESHALLCONFLICT_OFFSET UNITYSDK_OFFSET(0xB527090)
#define NPCCROWD_AI_ATTRACTORMANAGER_REFRESHSERVERATTRACTORCONFLICT_OFFSET UNITYSDK_OFFSET(0xB523AE0)
#define NPCCROWD_AI_ATTRACTORMANAGER_REGISTERATTRACTORCONFIG_OFFSET UNITYSDK_OFFSET(0xB523670)
#define NPCCROWD_AI_ATTRACTORMANAGER_REGISTERATTRACTOR_1_OFFSET UNITYSDK_OFFSET(0xB529890)
#define NPCCROWD_AI_ATTRACTORMANAGER_REGISTERATTRACTOR_2_OFFSET UNITYSDK_OFFSET(0xB526C30)
#define NPCCROWD_AI_ATTRACTORMANAGER_REGISTERATTRACTOR_OFFSET UNITYSDK_OFFSET(0xB5296A0)
#define NPCCROWD_AI_ATTRACTORMANAGER_SETATTRACTORENABLE_OFFSET UNITYSDK_OFFSET(0xB525700)
#define NPCCROWD_AI_ATTRACTORMANAGER_SETATTRACTORINITENABLE_OFFSET UNITYSDK_OFFSET(0xB52A150)
#define NPCCROWD_AI_ATTRACTORMANAGER_SETENTITYBEATTRACTED_OFFSET UNITYSDK_OFFSET(0xB52A610)
#define NPCCROWD_AI_ATTRACTORMANAGER_SETENTITYTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB528050)
#define NPCCROWD_AI_ATTRACTORMANAGER_SPAWNDEFAULTNPC_OFFSET UNITYSDK_OFFSET(0xB526750)
#define NPCCROWD_AI_ATTRACTORMANAGER_UNREGISTERATTRACTOR_OFFSET UNITYSDK_OFFSET(0xB529350)
#define NPCCROWD_AI_ATTRACTORMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB52B4E0)
#define NPCCROWD_AI_ATTRACTORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB52AEC0)
#define NPCCROWD_AI_ATTRACTORMANAGER__DELAYREFRESHSERVERATTRACTORCONFLICT_B__45_2_OFFSET UNITYSDK_OFFSET(0xB52B5B0)
#define NPCCROWD_AI_ATTRACTORMANAGER__LOADCURSECTIONDATA_B__36_0_OFFSET UNITYSDK_OFFSET(0xB52B530)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorManager_TypeDefinitionIndex = 74665;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AttractorManager_TypeDefinitionIndex)->GetStaticField(0x3AE30);
		}
		static ::System::String** StaticGet_AttractorTemplateConfigAssetSOPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AttractorManager_TypeDefinitionIndex)->GetStaticField(0x3AE38);
		}
		::NPCCrowd::AI::AttractorTemplateAssetSO* _templateConfig; // 0x10
		::System::Collections::Generic::List_1<::NPCCrowd::AI::AttractorInstance*>* curInstances; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* entityBeAttracted; // 0x20
		::NPCCrowd::NPCIDGeneratorInt* IDGen; // 0x28
		::System::Collections::Generic::List_1<::System::Int32>* attractorHandler; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>* delayEnableDict; // 0x38
		::Foundation::AssetRequestHandle _baseHandle; // 0x40
		::System::Collections::Generic::List_1<::System::Int32>* curMainCityObjectAreaList; // 0x60
		::System::Collections::Generic::List_1<::System::Int32>* serverAttractorHandlers; // 0x68
		::Foundation::AssetRequestHandle _configHandle; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::ValueTuple_2<::System::Int32, ::NPCCrowd::AI::AttractorRuntime*>>* entityBeAttractedSpawn; // 0x90
		::System::Collections::Generic::List_1<::System::Int32>* debugIgnoreConditionList; // 0x98
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AttractorRuntime*>* attractorRuntimes; // 0xA0
		::Foundation::AssetRequestHandle _templateHandle; // 0xA8
		::System::Collections::Generic::List_1<::System::Int32>* serverConflictResult; // 0xC8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>* linkValidDict; // 0xD0
		::NPCCrowd::AI::AllAttractorsConfigAssetSO* _baseConfig; // 0xD8
		::System::Collections::Generic::List_1<::System::Int32>* defaultMainAttractorHandler; // 0xE0
		::NPCCrowd::AI::AttractorConfigAssetSO* _attractorConfig; // 0xE8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::AttractorTemplate*>* attractorConfigs; // 0xF0
		...
		static ::System::Void HandleServerData(::Class_3_840FB8C8E5613817* attractorData, ::System::Boolean handleTag)
		{
			return ((::System::Void(*)(::Class_3_840FB8C8E5613817*, ::System::Boolean))((::PBYTE)hIl2Cpp + NPCCROWD_AI_ATTRACTORMANAGER_HANDLESERVERDATA_OFFSET))(attractorData, handleTag);
		}
