...
#define NPCCROWD_AI_PATHFINDINGGRAPH_PATHFINDINGNODE_FPATHFINDINGEDGE_CLEARPATHFINDINGCACHE_OFFSET UNITYSDK_OFFSET(0x4104A0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_PATHFINDINGNODE_FPATHFINDINGEDGE_ISENABLED_OFFSET UNITYSDK_OFFSET(0x410450)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathFindingGraph_PathFindingNode_FPathFindingEdge_TypeDefinitionIndex = 48773;
