...
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF99C200)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0xF99C100)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF99C410)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorQueryEntityProcessor_TypeDefinitionIndex = 84710;
