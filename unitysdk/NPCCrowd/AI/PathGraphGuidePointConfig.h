...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF0CABD0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointConfig_TypeDefinitionIndex = 60932;
