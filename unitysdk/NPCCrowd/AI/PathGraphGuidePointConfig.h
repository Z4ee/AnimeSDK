...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF99CC70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointConfig_TypeDefinitionIndex = 44496;
