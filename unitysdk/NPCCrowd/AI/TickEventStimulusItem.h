...
#define NPCCROWD_AI_TICKEVENTSTIMULUSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x951C9A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int TickEventStimulusItem_TypeDefinitionIndex = 42699;
