...
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xE002D30)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_INITCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xE002A00)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xE0029B0)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0xE002EC0)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xE003030)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphFeaturePointRuntime_TypeDefinitionIndex = 40217;
