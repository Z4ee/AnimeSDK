...
#define NPCCROWD_AI_PATHFINDINGGRAPH_CALHEURISTICDISTANCE_OFFSET UNITYSDK_OFFSET(0x1138B190)
#define NPCCROWD_AI_PATHFINDINGGRAPH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1138A600)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1138A900)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1138A6B0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_GETPATHGRAPHNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1138A840)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INITPATHFINDINGNODES_OFFSET UNITYSDK_OFFSET(0x11388E10)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0x11388DC0)
#define NPCCROWD_AI_PATHFINDINGGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1138B3B0)
#define NPCCROWD_AI_PATHFINDINGGRAPH__INITPATHFINDINGNODES_G__GETSPLINEPATHFINDINGNODEBYPOSITION_3_1_OFFSET UNITYSDK_OFFSET(0x1138A570)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathFindingGraph_TypeDefinitionIndex = 47983;
