...
#define NPCCROWD_AI_PATHFINDINGGRAPH_CALHEURISTICDISTANCE_OFFSET UNITYSDK_OFFSET(0x1135D670)
#define NPCCROWD_AI_PATHFINDINGGRAPH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1135CAE0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1135CDE0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1135CB90)
#define NPCCROWD_AI_PATHFINDINGGRAPH_GETPATHGRAPHNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1135CD20)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INITPATHFINDINGNODES_OFFSET UNITYSDK_OFFSET(0x1135AF60)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0x1135AF10)
#define NPCCROWD_AI_PATHFINDINGGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1135D890)
#define NPCCROWD_AI_PATHFINDINGGRAPH__INITPATHFINDINGNODES_G__GETSPLINEPATHFINDINGNODEBYPOSITION_3_1_OFFSET UNITYSDK_OFFSET(0x1135CA50)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathFindingGraph_TypeDefinitionIndex = 48771;
