...
#define NPCCROWD_AI_WPGRAPHUTILS_CHECKISFORWARD_OFFSET UNITYSDK_OFFSET(0x11784810)
#define NPCCROWD_AI_WPGRAPHUTILS_GETARANDOMNODEWAY_OFFSET UNITYSDK_OFFSET(0x11784990)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_1_OFFSET UNITYSDK_OFFSET(0x117851F0)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_2_OFFSET UNITYSDK_OFFSET(0x117853B0)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_3_OFFSET UNITYSDK_OFFSET(0x11785010)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_OFFSET UNITYSDK_OFFSET(0x11784E50)
#define NPCCROWD_AI_WPGRAPHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x11785560)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphUtils_TypeDefinitionIndex = 69054;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WPGraphUtils_TypeDefinitionIndex)->GetStaticField(0xB310);
		}
