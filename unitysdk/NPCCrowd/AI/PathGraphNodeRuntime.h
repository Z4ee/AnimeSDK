...
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x11921DB0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_CONNECTORCONFIG_OFFSET UNITYSDK_OFFSET(0x11921EE0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x11921F90)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISCONNECTORNODE_OFFSET UNITYSDK_OFFSET(0x11921EC0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISSPLINENODE_OFFSET UNITYSDK_OFFSET(0x11921DF0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_SPLINECONFIG_OFFSET UNITYSDK_OFFSET(0x11921E10)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x11921D70)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x11922020)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x11921FB0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x11922070)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphNodeRuntime_TypeDefinitionIndex = 56527;
