...
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xE0036E0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_CONNECTORCONFIG_OFFSET UNITYSDK_OFFSET(0xE003810)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0xE0038C0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISCONNECTORNODE_OFFSET UNITYSDK_OFFSET(0xE0037F0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISSPLINENODE_OFFSET UNITYSDK_OFFSET(0xE003720)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_SPLINECONFIG_OFFSET UNITYSDK_OFFSET(0xE003740)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xE0036A0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0xE003950)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_OFFSET UNITYSDK_OFFSET(0xE0038E0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xE0039A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphNodeRuntime_TypeDefinitionIndex = 72571;
