...
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xD22F9F0)
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xD22FA80)
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xD22F220)
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD22F210)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ReactionConditionDelegate_TypeDefinitionIndex = 71781;
