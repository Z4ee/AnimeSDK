...
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xEC76E40)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xEC76E70)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC76BA0)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC76B90)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FloatValueGetterDelegate_TypeDefinitionIndex = 67467;
