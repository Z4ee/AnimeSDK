...
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xE556320)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xE556350)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE556080)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xE556060)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FloatValueGetterDelegate_TypeDefinitionIndex = 83829;
