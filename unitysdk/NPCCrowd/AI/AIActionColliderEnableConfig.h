...
#define NPCCROWD_AI_AIACTIONCOLLIDERENABLECONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x830B60)
#define NPCCROWD_AI_AIACTIONCOLLIDERENABLECONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x830BB0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionColliderEnableConfig_TypeDefinitionIndex = 52070;
