...
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11920840)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11920870)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x119205B0)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x11920590)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int BoolValueGetterDelegate_TypeDefinitionIndex = 45027;
