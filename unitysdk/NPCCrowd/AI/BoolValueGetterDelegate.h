...
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x114F49C0)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x114F49F0)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x114F4720)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x114F4710)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int BoolValueGetterDelegate_TypeDefinitionIndex = 48880;
