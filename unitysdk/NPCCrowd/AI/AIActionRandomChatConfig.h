...
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x693290)
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x6932E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRandomChatConfig_TypeDefinitionIndex = 49729;
