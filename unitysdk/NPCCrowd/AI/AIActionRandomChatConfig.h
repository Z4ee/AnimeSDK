...
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x695F20)
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x695F70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRandomChatConfig_TypeDefinitionIndex = 71051;
