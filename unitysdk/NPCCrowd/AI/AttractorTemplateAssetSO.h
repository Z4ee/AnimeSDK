...
#define NPCCROWD_AI_ATTRACTORTEMPLATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x10294AA0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorTemplateAssetSO_TypeDefinitionIndex = 53395;
