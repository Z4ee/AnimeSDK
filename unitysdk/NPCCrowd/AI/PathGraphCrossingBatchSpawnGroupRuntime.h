...
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_BATCHSPAWN_OFFSET UNITYSDK_OFFSET(0x114D7B40)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_BATCHSTARTMOVING_OFFSET UNITYSDK_OFFSET(0x114D7430)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x114D6F40)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x114D7760)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x114D6C70)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x114D6CE0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_SETENABLED_OFFSET UNITYSDK_OFFSET(0x114D73D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_SETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x114D7DA0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_SPAWNCURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x114D7860)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_STARTMOVING_OFFSET UNITYSDK_OFFSET(0x114D7EF0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_STOPMOVING_OFFSET UNITYSDK_OFFSET(0x114D8040)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_TRYREMOVENPC_OFFSET UNITYSDK_OFFSET(0x114D7210)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_TRYSPAWNNPC_OFFSET UNITYSDK_OFFSET(0x114D7370)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x114D7160)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME__BATCHSPAWN_B__14_0_OFFSET UNITYSDK_OFFSET(0x114D8130)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x114D8120)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x114D8640)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x114D86D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x114D86E0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_SETENABLED_OFFSET UNITYSDK_OFFSET(0x114D8770)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x114D8800)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphCrossingBatchSpawnGroupRuntime_TypeDefinitionIndex = 87466;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::System::Int32, ::Class_3_F2DAD7F45F518868*>>* _spawnedNpcIndexList; // 0x48
