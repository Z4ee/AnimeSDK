...
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_BATCHSPAWN_OFFSET UNITYSDK_OFFSET(0x1826CF90)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_BATCHSTARTMOVING_OFFSET UNITYSDK_OFFSET(0x1826C930)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x1826C440)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x1826CC60)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1826C170)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x1826C1E0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_SETENABLED_OFFSET UNITYSDK_OFFSET(0x1826C8D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_SETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1826D1F0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_SPAWNCURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x1826CCC0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_STARTMOVING_OFFSET UNITYSDK_OFFSET(0xCD229A0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_STOPMOVING_OFFSET UNITYSDK_OFFSET(0xCD22B00)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_TRYREMOVENPC_OFFSET UNITYSDK_OFFSET(0x1826C710)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_TRYSPAWNNPC_OFFSET UNITYSDK_OFFSET(0x1826C870)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x1826C660)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME__BATCHSPAWN_B__14_0_OFFSET UNITYSDK_OFFSET(0xCD22C00)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xCD22BF0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0xCD23100)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0xCD23190)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xCD231A0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_SETENABLED_OFFSET UNITYSDK_OFFSET(0xCD23230)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD232C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphCrossingBatchSpawnGroupRuntime_TypeDefinitionIndex = 66373;

	class PathGraphCrossingBatchSpawnGroupRuntime : public ::NPCCrowd::AI::PathGraphSpawnGroupRuntime
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* _tagIndexPool; // 0x40
		::System::Collections::Generic::List_1<::Class_3_F2DAD7F45F518868*>* _spawnedNpcCurrentPhase; // 0x48
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::System::Int32, ::Class_3_F2DAD7F45F518868*>>* _spawnedNpcIndexList; // 0x50
