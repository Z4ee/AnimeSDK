...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_BLOCKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE462C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_BlockState_TypeDefinitionIndex = 66629;
	...
	public:
		...
		::NPCCrowd::AI::PathGraphSplineNodeRuntime_BlockState_EBlockState State; // 0x18
		::System::Boolean IsForward; // 0x1C
		::NPCCrowd::AI::PathGraphSplineNodeRuntime_BlockState_EBlockType Type; // 0x20
