...
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x651760)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionProcessor_ExecuteJob_TypeDefinitionIndex = 66001;
