...
#define NPCCROWD_NPCMODULEAVATARASSETSPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x12D3A060)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCModuleAvatarAssetsPacked_TypeDefinitionIndex = 58451;
