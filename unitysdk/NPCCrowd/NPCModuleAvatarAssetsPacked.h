...
#define NPCCROWD_NPCMODULEAVATARASSETSPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0xFC1B1D0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCModuleAvatarAssetsPacked_TypeDefinitionIndex = 70925;
