...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE8AE6D0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS27_0__GETACCESSORYINFOBYAVATARNAME_B__0_OFFSET UNITYSDK_OFFSET(0xE8AE6E0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS27_0__GETACCESSORYINFOBYAVATARNAME_B__1_OFFSET UNITYSDK_OFFSET(0xE8AE760)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass27_0_TypeDefinitionIndex = 64546;
