...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_CREATEBUFFER_OFFSET UNITYSDK_OFFSET(0xE016670)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INITENTITY_OFFSET UNITYSDK_OFFSET(0xE016730)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INIT_OFFSET UNITYSDK_OFFSET(0xE016590)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0xE0167A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE016820)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAbilityRuntimeData_TypeDefinitionIndex = 67532;
