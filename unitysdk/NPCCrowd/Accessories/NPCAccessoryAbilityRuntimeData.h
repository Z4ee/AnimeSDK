...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_CREATEBUFFER_OFFSET UNITYSDK_OFFSET(0x11504A60)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INITENTITY_OFFSET UNITYSDK_OFFSET(0x11504B20)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x11504980)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x11504B90)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x11504C10)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAbilityRuntimeData_TypeDefinitionIndex = 54223;

	class NPCAccessoryAbilityRuntimeData : public ::System::Object
	{
	public:
		::Unity::Collections::NativeArray_1<::NPCCrowd::Animation::FNPCAnimatorRuntimeInstanceAnimClipData> animatorBufferData; // 0x10
		::Unity::Collections::NativeArray_1<::System::Boolean> bIsUsing; // 0x20
