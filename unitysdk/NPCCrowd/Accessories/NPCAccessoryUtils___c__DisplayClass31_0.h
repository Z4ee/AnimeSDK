...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS31_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11364FD0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS31_0__GENERATEGALGAMENPCACCESSORYINFO_B__0_OFFSET UNITYSDK_OFFSET(0x11364FE0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS31_0__GENERATEGALGAMENPCACCESSORYINFO_B__1_OFFSET UNITYSDK_OFFSET(0x11365010)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS31_0__GENERATEGALGAMENPCACCESSORYINFO_B__2_OFFSET UNITYSDK_OFFSET(0x11365020)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass31_0_TypeDefinitionIndex = 64553;
