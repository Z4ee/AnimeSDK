...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_ALLFOLLOWANIMATIONCLIPSETTINGS_OFFSET UNITYSDK_OFFSET(0xFBFF2A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBCLOTHS_OFFSET UNITYSDK_OFFSET(0xFBFF4F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBCONTROLLER_OFFSET UNITYSDK_OFFSET(0xFBFF770)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0xFBFF330)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_REFRESHANIMDATA_OFFSET UNITYSDK_OFFSET(0xFBFF930)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_REFRESH_OFFSET UNITYSDK_OFFSET(0xFBFFFD0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0xFC00150)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0xFC00430)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimationAssetsSO_TypeDefinitionIndex = 65686;
