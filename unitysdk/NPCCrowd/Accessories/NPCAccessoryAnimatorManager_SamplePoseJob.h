...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_BUILDREQUESTS_OFFSET UNITYSDK_OFFSET(0x69D210)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x69D270)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x69D200)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_REMOVEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x69D250)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimatorManager_SamplePoseJob_TypeDefinitionIndex = 87993;
