...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_BUILDREQUESTS_OFFSET UNITYSDK_OFFSET(0x687700)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x687760)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x6876F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_REMOVEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x687740)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimatorManager_SamplePoseJob_TypeDefinitionIndex = 75927;
