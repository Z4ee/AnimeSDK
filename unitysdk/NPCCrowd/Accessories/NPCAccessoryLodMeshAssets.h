...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS_GETMESH_OFFSET UNITYSDK_OFFSET(0xCD31A70)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0xCD31EF0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS__CTOR_OFFSET UNITYSDK_OFFSET(0xCD31F40)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryLodMeshAssets_TypeDefinitionIndex = 57093;
