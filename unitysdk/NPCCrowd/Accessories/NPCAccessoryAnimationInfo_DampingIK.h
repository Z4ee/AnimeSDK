...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONINFO_DAMPINGIK__CTOR_OFFSET UNITYSDK_OFFSET(0xEC7AC50)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimationInfo_DampingIK_TypeDefinitionIndex = 41366;
