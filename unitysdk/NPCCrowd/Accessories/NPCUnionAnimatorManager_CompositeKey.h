...
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x6DB4C0)
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6DB520)
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6DB570)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCUnionAnimatorManager_CompositeKey_TypeDefinitionIndex = 84741;
