...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMANAGER__SETACCESSORYHIDDEN_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x5CC350)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMANAGER__SETACCESSORYHIDDEN_D__12_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryManager__SetAccessoryHidden_d__12_TypeDefinitionIndex = 49539;
