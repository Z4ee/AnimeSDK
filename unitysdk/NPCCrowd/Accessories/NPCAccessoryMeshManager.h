...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETACCESSORYAVATARASSET_OFFSET UNITYSDK_OFFSET(0xBDE09B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETACCESSORYMESHASSET_OFFSET UNITYSDK_OFFSET(0xBDE08A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETALLLODMESH_OFFSET UNITYSDK_OFFSET(0xBDDF910)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GET_OFFSET UNITYSDK_OFFSET(0xBDDF660)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xBDDF7E0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBDE1010)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0xBDDFBF0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0xBDDF950)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_RELEASERESOURCES_OFFSET UNITYSDK_OFFSET(0xBDE0EC0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_SETAVATARASSETS_OFFSET UNITYSDK_OFFSET(0xBDE0450)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBDE1220)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xBDE1230)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBDE12C0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0xBDE1350)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryMeshManager_TypeDefinitionIndex = 38657;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryMeshManager_TypeDefinitionIndex)->GetStaticField(0x44C80);
		}
