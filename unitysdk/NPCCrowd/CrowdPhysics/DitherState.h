...
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_CLEAN_OFFSET UNITYSDK_OFFSET(0x74E230)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEDITHER_OFFSET UNITYSDK_OFFSET(0x74E360)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEIN_OFFSET UNITYSDK_OFFSET(0x74E2F0)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEOUT_OFFSET UNITYSDK_OFFSET(0x74E280)

namespace NPCCrowd::CrowdPhysics
{
	inline static constexpr unsigned int DitherState_TypeDefinitionIndex = 76657;
