...
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_CLEAN_OFFSET UNITYSDK_OFFSET(0x6567E0)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEDITHER_OFFSET UNITYSDK_OFFSET(0x656910)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEIN_OFFSET UNITYSDK_OFFSET(0x6568A0)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEOUT_OFFSET UNITYSDK_OFFSET(0x656830)

namespace NPCCrowd::CrowdPhysics
{
	inline static constexpr unsigned int DitherState_TypeDefinitionIndex = 51699;
