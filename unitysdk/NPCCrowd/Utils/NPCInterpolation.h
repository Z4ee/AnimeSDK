...
#define NPCCROWD_UTILS_NPCINTERPOLATION_CALCULATECATMULLROMCENTRIPETALTANGENT_OFFSET UNITYSDK_OFFSET(0x142B0970)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CALCULATECENTRIPETALPARAMETERS_OFFSET UNITYSDK_OFFSET(0x142B07F0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CATMULLROMCENTRIPETAL_OFFSET UNITYSDK_OFFSET(0x142B03C0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CATMULLROMTANGENT_OFFSET UNITYSDK_OFFSET(0x142B0160)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x142AFF50)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CUBIC_OFFSET UNITYSDK_OFFSET(0x142AFDA0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_EASEINOUTCUBIC_OFFSET UNITYSDK_OFFSET(0x142B0D00)
#define NPCCROWD_UTILS_NPCINTERPOLATION_INTERPOLATETOWARDS_OFFSET UNITYSDK_OFFSET(0x142B0DF0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPEXPN_OFFSET UNITYSDK_OFFSET(0x142B1670)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS2_1_OFFSET UNITYSDK_OFFSET(0x142B1260)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS2_2_OFFSET UNITYSDK_OFFSET(0x142B1350)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS2_OFFSET UNITYSDK_OFFSET(0x142B11B0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS3_1_OFFSET UNITYSDK_OFFSET(0x142B14C0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS3_2_OFFSET UNITYSDK_OFFSET(0x142B1580)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS3_OFFSET UNITYSDK_OFFSET(0x142B1410)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS_1_OFFSET UNITYSDK_OFFSET(0x142B0FE0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS_2_OFFSET UNITYSDK_OFFSET(0x142B10B0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS_OFFSET UNITYSDK_OFFSET(0x142B0F30)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERP_OFFSET UNITYSDK_OFFSET(0x142B0EA0)

namespace NPCCrowd::Utils
{
	inline static constexpr unsigned int NPCInterpolation_TypeDefinitionIndex = 58698;
