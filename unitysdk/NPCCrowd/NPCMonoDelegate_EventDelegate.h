...
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xF0783A0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xF0783D0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xF078100)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xF0780F0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMonoDelegate_EventDelegate_TypeDefinitionIndex = 81953;
