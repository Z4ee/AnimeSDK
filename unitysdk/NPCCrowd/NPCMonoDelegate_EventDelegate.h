...
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x117B18C0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x117B18F0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x117B1620)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x117B1600)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMonoDelegate_EventDelegate_TypeDefinitionIndex = 60355;
