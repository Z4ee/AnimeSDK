...
#define NPCCROWD_MONOBONEROTATER_CACHEINITIALROTATION_OFFSET UNITYSDK_OFFSET(0x17FB0040)
#define NPCCROWD_MONOBONEROTATER_GETAXISVECTOR_OFFSET UNITYSDK_OFFSET(0x17FB06A0)
#define NPCCROWD_MONOBONEROTATER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17FB0230)
#define NPCCROWD_MONOBONEROTATER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17FAFFF0)
#define NPCCROWD_MONOBONEROTATER_REBINDBASEROTATION_OFFSET UNITYSDK_OFFSET(0x17FB0750)
#define NPCCROWD_MONOBONEROTATER_RESOLVEBONE_OFFSET UNITYSDK_OFFSET(0x17FB0660)
#define NPCCROWD_MONOBONEROTATER__CTOR_OFFSET UNITYSDK_OFFSET(0x17FB07A0)

namespace NPCCrowd
{
	inline static constexpr unsigned int MonoBoneRotater_TypeDefinitionIndex = 83178;
