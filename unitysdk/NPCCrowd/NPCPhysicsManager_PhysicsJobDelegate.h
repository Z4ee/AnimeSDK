...
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x127484F0)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12748560)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x12748200)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x127481E0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCPhysicsManager_PhysicsJobDelegate_TypeDefinitionIndex = 48671;
