...
#define NPCCROWD_NPCIDGENERATORINT_GENID_OFFSET UNITYSDK_OFFSET(0xEA59BB0)
#define NPCCROWD_NPCIDGENERATORINT_SETIDSTART_OFFSET UNITYSDK_OFFSET(0xEA59C00)
#define NPCCROWD_NPCIDGENERATORINT__CTOR_OFFSET UNITYSDK_OFFSET(0xEA59C50)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCIDGeneratorInt_TypeDefinitionIndex = 71105;
