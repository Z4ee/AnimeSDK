...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_COLLECTROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD0C5690)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xD0C4D60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xD0C4D50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xD0C4DC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xD0C4E10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C5AC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_CollectPostUpdateProcessor_TypeDefinitionIndex = 70475;
