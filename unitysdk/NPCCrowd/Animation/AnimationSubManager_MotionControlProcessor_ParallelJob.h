...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x5ED000)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_GET__BONEADJUSTMASTERBONE_OFFSET UNITYSDK_OFFSET(0x5ECFE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_GET__LOOKATIKSETTING_OFFSET UNITYSDK_OFFSET(0x5ECFC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_ISWITHINANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0xE56C680)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_MOTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x5ED010)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_PREPROCESSBONEADJUST_OFFSET UNITYSDK_OFFSET(0xE56E1A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_TRYADJUSTPELVIS_OFFSET UNITYSDK_OFFSET(0xE56C960)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_TRYRESOLVEDISPATCHINDEX_OFFSET UNITYSDK_OFFSET(0xE563DF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_TRYSOLVELOOKATIK_OFFSET UNITYSDK_OFFSET(0xE56B330)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_TRYSOLVETWOBONEIK_OFFSET UNITYSDK_OFFSET(0xE566FE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_UPDATELOOKATIKCONTROL_OFFSET UNITYSDK_OFFSET(0xE569C00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_PARALLELJOB_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0xE56C7F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MotionControlProcessor_ParallelJob_TypeDefinitionIndex = 88342;
	...
	struct alignas(8) AnimationSubManager_MotionControlProcessor_ParallelJob
	{
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationSubManager_AvatarArchetypeData*>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_MotionControlProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0x37740);
		}
