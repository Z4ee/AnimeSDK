...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_ADJUSTROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9535DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x9534900)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_APPLY_OFFSET UNITYSDK_OFFSET(0x9536BD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_CALCROOTINERTIALIZATIONSPACE_OFFSET UNITYSDK_OFFSET(0x9536880)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_CAPTURE_OFFSET UNITYSDK_OFFSET(0x9536E20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x464D60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_GENERATEDELTADATA_OFFSET UNITYSDK_OFFSET(0x9535140)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_HANDLEREQUEST_OFFSET UNITYSDK_OFFSET(0x9534880)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_START_OFFSET UNITYSDK_OFFSET(0x95349A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_PARALLELJOB_TRYRESOLVEDISPATCHINDEX_OFFSET UNITYSDK_OFFSET(0x9532E90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_InertializationProcessor_ParallelJob_TypeDefinitionIndex = 88256;
	...
	struct alignas(4) AnimationSubManager_InertializationProcessor_ParallelJob
	{
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationSubManager_AvatarArchetypeData*>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_InertializationProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0x3ACC0);
		}
