...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_PARALLELJOB_FLUSHER_GET_SUCCEED_OFFSET UNITYSDK_OFFSET(0x72C600)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_PARALLELJOB_FLUSHER__CTOR_OFFSET UNITYSDK_OFFSET(0x72C610)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_RequestAdjustmentBlendingByMotionProcessor_ParallelJob_Flusher_TypeDefinitionIndex = 88316;
