...
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_APPLYTRANSITION_OFFSET UNITYSDK_OFFSET(0xF879E20)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_BLENDANIMATIONS_OFFSET UNITYSDK_OFFSET(0xF87E900)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_CANCELPREFETCHCLIPTEXTURE_OFFSET UNITYSDK_OFFSET(0xF883D90)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETACTIVEANIMIDS_OFFSET UNITYSDK_OFFSET(0xF882E70)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPDATA_OFFSET UNITYSDK_OFFSET(0xF87F470)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPFRAME_1_OFFSET UNITYSDK_OFFSET(0xF8825D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPFRAME_OFFSET UNITYSDK_OFFSET(0xF882500)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPTIME_OFFSET UNITYSDK_OFFSET(0xF880CD0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPTOTALTIME_OFFSET UNITYSDK_OFFSET(0xF882140)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCPUSYNCMAINCLIPSEED_OFFSET UNITYSDK_OFFSET(0xF882410)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCPUSYNCMAINCLIPTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0xF881E40)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCURRENTCLIPINDEX_OFFSET UNITYSDK_OFFSET(0xF882050)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCURRENTCLIPSPEEDS_OFFSET UNITYSDK_OFFSET(0xF882360)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETMAINCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xF881DA0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSLOTLOCALPRS_1_OFFSET UNITYSDK_OFFSET(0xF882D00)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSLOTLOCALPRS_OFFSET UNITYSDK_OFFSET(0xF882B70)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSLOTTRANSFORMINDEX_OFFSET UNITYSDK_OFFSET(0xF882C50)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSPEEDRELATIVESTARTTIME_OFFSET UNITYSDK_OFFSET(0xF881430)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSTATESYNCMAINCLIPTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0xF8822D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_PREFETCHCLIPTEXTURES_OFFSET UNITYSDK_OFFSET(0xF8837F0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_PREFETCHCLIPTEXTURE_OFFSET UNITYSDK_OFFSET(0xF883520)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_REMOVEFROMTRANSITIONINGANIMATORSSWAPBACK_OFFSET UNITYSDK_OFFSET(0xF881C00)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_RESETANIMATOR_OFFSET UNITYSDK_OFFSET(0xF87D220)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONMANUALLY_OFFSET UNITYSDK_OFFSET(0xF87E0D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONSPEEDS_OFFSET UNITYSDK_OFFSET(0xF881510)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONSPEED_1_OFFSET UNITYSDK_OFFSET(0xF880E60)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0xF880DE0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETCLIPTIME_1_OFFSET UNITYSDK_OFFSET(0xF8827B0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETCLIPTIME_OFFSET UNITYSDK_OFFSET(0xF882670)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETLAYERFLAGS_OFFSET UNITYSDK_OFFSET(0xF882DE0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTANIMATION_1_OFFSET UNITYSDK_OFFSET(0xF87D610)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTANIMATION_2_OFFSET UNITYSDK_OFFSET(0xF87D8D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTANIMATION_OFFSET UNITYSDK_OFFSET(0xF87D530)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTBLEND_1_OFFSET UNITYSDK_OFFSET(0xF87F5D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTBLEND_OFFSET UNITYSDK_OFFSET(0xF87F2B0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SYNCSTATUSMANUALLY_OFFSET UNITYSDK_OFFSET(0xF87E780)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_TRYGETANIMATION_OFFSET UNITYSDK_OFFSET(0xF87E550)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_UPDATEINDEX_OFFSET UNITYSDK_OFFSET(0xF882A80)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF87D210)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdAnimator_TypeDefinitionIndex = 81736;

	class NPCCrowdAnimator : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::Vector4>* currentLayerClipStartTimes; // 0x10
		::NPCCrowd::Animation::NPCCrowdAnimationData* crowdAnimPrototype; // 0x18
		...
		::Il2CppArray<::UnityEngine::Vector4>* currentLayerAnimationClipDataWeights; // 0x78
		::Il2CppArray<::Il2CppArray<::System::Single>*>* currentLayerClipSpeeds; // 0x80
		::NPCCrowd::Animation::GPUICrowdTransition* transition; // 0x88
		::NPCCrowd::Animation::NPCCrowdAnimationInstancerRuntimeData* crowdRuntimeData; // 0x90
		::Il2CppArray<::UnityEngine::Vector4>* newLayerClipStartTimes; // 0x98
		::Il2CppArray<::NPCCrowd::Animation::GPUIAnimationClipData>* newAnimationClipData; // 0xA0
		::System::Int32 activeClipCount; // 0xA8
		::System::Boolean bIsNeedFlushMBGPUID; // 0xAC
		::System::UInt32 layerFlags; // 0xB0
		::UnityEngine::Vector4 currentAnimationFrames; // 0xB4
		::System::Int32 gpuAnimationInstanceID; // 0xC4
		::System::Int32 transitionIndex; // 0xC8
