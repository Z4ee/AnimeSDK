...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xD0C5AE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xD0C5AD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xD0C5B40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESSWARPINGCOMPENSATE_OFFSET UNITYSDK_OFFSET(0xD0C7240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xD0C5C60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_SYNCSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0xD0C68D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C7C30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushUpdateProcessor_TypeDefinitionIndex = 70496;
