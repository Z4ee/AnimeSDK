...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xE935BE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xE935BD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xE935C40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESSWARPINGCOMPENSATE_OFFSET UNITYSDK_OFFSET(0xE9374D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xE935D60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_SYNCSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0xE936B60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE937E50)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushUpdateProcessor_TypeDefinitionIndex = 88331;
