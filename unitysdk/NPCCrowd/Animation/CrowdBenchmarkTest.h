...
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x1136E830)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0x1136E7F0)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1136EB40)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST__GETCROWDNPCTESTCASES_B__7_0_OFFSET UNITYSDK_OFFSET(0x1136ECD0)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST___BASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x1136EDC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdBenchmarkTest_TypeDefinitionIndex = 63963;
