...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0x13DEDC40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x13DEDC50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x13DEDCE0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_Dispatchable_TypeDefinitionIndex = 88335;
