...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0x11D87190)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x11D871A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x11D87230)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_Dispatchable_TypeDefinitionIndex = 70419;
