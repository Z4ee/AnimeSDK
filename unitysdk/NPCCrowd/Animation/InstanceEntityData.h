...
#define NPCCROWD_ANIMATION_INSTANCEENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x687EE0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int InstanceEntityData_TypeDefinitionIndex = 61676;
