...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ADDDEPENDENCY_OFFSET UNITYSDK_OFFSET(0xF871890)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_BEGINFRAME_OFFSET UNITYSDK_OFFSET(0xF871050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENDFRAME_OFFSET UNITYSDK_OFFSET(0xF871700)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENSUREOPERATIONBUFFEREMPTY_OFFSET UNITYSDK_OFFSET(0xF871350)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENSUREOPERATIONBUFFER_OFFSET UNITYSDK_OFFSET(0xF8711D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_FORCECOMPLETEALL_OFFSET UNITYSDK_OFFSET(0xF871750)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETMAXPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xF8719F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETMINPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xF871960)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xF871950)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_INITIALIZEPHASEEVENT_OFFSET UNITYSDK_OFFSET(0xF870F80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULE_OFFSET UNITYSDK_OFFSET(0xF871540)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER__CCTOR_OFFSET UNITYSDK_OFFSET(0xF871A80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER__CTOR_OFFSET UNITYSDK_OFFSET(0xF870F00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_TypeDefinitionIndex = 88348;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AnimationScheduler_TypeDefinitionIndex)->GetStaticField(0x13570);
		}
		...
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_AnimationScheduler_OperationBuffer*>* _operationBuffers; // 0x20
