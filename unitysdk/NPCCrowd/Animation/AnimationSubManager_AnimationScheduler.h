...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ADDDEPENDENCY_OFFSET UNITYSDK_OFFSET(0xA689B10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_BEGINFRAME_OFFSET UNITYSDK_OFFSET(0xA6892C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENDFRAME_OFFSET UNITYSDK_OFFSET(0xA689980)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENSUREOPERATIONBUFFEREMPTY_OFFSET UNITYSDK_OFFSET(0xA6895D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENSUREOPERATIONBUFFER_OFFSET UNITYSDK_OFFSET(0xA689450)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_FORCECOMPLETEALL_OFFSET UNITYSDK_OFFSET(0xA6899D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETMAXPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xA689C70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETMINPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xA689BE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xA689BD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_INITIALIZEPHASEEVENT_OFFSET UNITYSDK_OFFSET(0xA6891F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULE_OFFSET UNITYSDK_OFFSET(0xA6897C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA689D00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER__CTOR_OFFSET UNITYSDK_OFFSET(0xA689170)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_TypeDefinitionIndex = 57445;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AnimationScheduler_TypeDefinitionIndex)->GetStaticField(0x12F60);
		}
		...
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_AnimationScheduler_OperationBuffer*>* _operationBuffers; // 0x10
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_AnimationScheduler_Node>* _nodes; // 0x18
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_IAnimationProcessor*>* _processors; // 0x20
		::Il2CppArray<::Unity::Jobs::JobHandle>* _jobHandles; // 0x28
