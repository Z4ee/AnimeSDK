...
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB_BUILDSAMPLEPOSEREQUEST_OFFSET UNITYSDK_OFFSET(0x719E20)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x719E10)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x719DC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCustomIdleManager_CreatRequestJob_TypeDefinitionIndex = 38861;
