...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADJUSTROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCD46960)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADVANCETIME_1_OFFSET UNITYSDK_OFFSET(0xCD45FD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x570B80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_APPLY_1_OFFSET UNITYSDK_OFFSET(0xCD473F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_APPLY_OFFSET UNITYSDK_OFFSET(0x570BA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CALCROOTINERTIALIZATIONSPACE_OFFSET UNITYSDK_OFFSET(0xCD470D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CAPTURE_1_OFFSET UNITYSDK_OFFSET(0xCD47650)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CAPTURE_OFFSET UNITYSDK_OFFSET(0x570BB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_GENERATEDELTADATA_OFFSET UNITYSDK_OFFSET(0xCD46470)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_HANDLEREQUEST_1_OFFSET UNITYSDK_OFFSET(0xCD45F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_HANDLEREQUEST_OFFSET UNITYSDK_OFFSET(0x570B70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_START_1_OFFSET UNITYSDK_OFFSET(0xCD46070)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_START_OFFSET UNITYSDK_OFFSET(0x570B90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x570910)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_InertializationProcessor_Job_ExecuteContext_TypeDefinitionIndex = 70453;

	struct alignas(8) AnimationSubManager_InertializationProcessor_Job_ExecuteContext
	{
		...
		{
			return ((::System::Void(*)(::NPCCrowd::Animation::AnimationSubManager_PoseInertializationRequest&, ::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData&, ::System::Int32))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_HANDLEREQUEST_1_OFFSET))(request, instanceData, frameCount);
		}
		...
		{
			return ((::System::Void(*)(::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData&, ::System::Single))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADVANCETIME_1_OFFSET))(instanceData, deltaTime);
		}
		...
		{
			return ((::System::Void(*)(::Foundation::Unreal::FName, ::UnityEngine::NapTransformData, ::NPCCrowd::Animation::AnimationSubManager_PoseInertializationCacheAdditionalData&, ::NPCCrowd::Animation::AnimationSubManager_PoseInertializationCacheAdditionalData&, ::UnityEngine::NapTransformData&, ::UnityEngine::NapTransformData&))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADJUSTROOTTRANSFORM_OFFSET))(attachingParent, meshTransform, lastAdditionalData, lastLastAdditionalData, last, lastLast);
		}
		...
		{
			return ((::NPCCrowd::Animation::AnimationSubManager_PoseInertializationSpace(*)(::Foundation::Unreal::FName, ::UnityEngine::Quaternion, ::NPCCrowd::Animation::AnimationSubManager_PoseInertializationCacheAdditionalData&, ::NPCCrowd::Animation::AnimationSubManager_PoseInertializationCacheAdditionalData&))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CALCROOTINERTIALIZATIONSPACE_OFFSET))(attachPoint, meshRotationInverse, lastAdditionalData, lastLastAdditionalData);
		}
		*/
		...
		{
			return ((::System::Void(*)(::System::Int32, ::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData&, ::System::ReadOnlySpan_1<::NPCCrowd::Animation::AnimationSubManager_PoseInertializationBoneDeltaData16>, ::System::Span_1<::UnityEngine::NapTransformData>))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_APPLY_1_OFFSET))(boneCount, instanceData, delta, pose);
		}
