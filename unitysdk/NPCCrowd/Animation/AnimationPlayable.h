...
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ADDLAYER_OFFSET UNITYSDK_OFFSET(0xD417050)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_GETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xD417750)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_GETLAYER_OFFSET UNITYSDK_OFFSET(0xD4173E0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xD416C40)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD416EB0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0xD417300)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xD416F60)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xD417670)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERMASK_OFFSET UNITYSDK_OFFSET(0xD4175F0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERSPEED_OFFSET UNITYSDK_OFFSET(0xD417460)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD417850)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xD417890)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD4178A0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xD4178B0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationPlayable_TypeDefinitionIndex = 57104;
