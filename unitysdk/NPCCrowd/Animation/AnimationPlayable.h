...
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ADDLAYER_OFFSET UNITYSDK_OFFSET(0xCD33950)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_GETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xCD34050)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_GETLAYER_OFFSET UNITYSDK_OFFSET(0xCD33CE0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xCD33540)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xCD337B0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0xCD33C00)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xCD33860)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xCD33F70)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERMASK_OFFSET UNITYSDK_OFFSET(0xCD33EF0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERSPEED_OFFSET UNITYSDK_OFFSET(0xCD33D60)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD34150)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xCD34190)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xCD341A0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xCD341B0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationPlayable_TypeDefinitionIndex = 42900;
	...
	public:
		...
		::UnityEngine::Animations::AnimationLayerMixerPlayable layerMixer; // 0x18
		::UnityEngine::Playables::PlayableGraph graph; // 0x28
		::UnityEngine::Playables::Playable playable; // 0x38
