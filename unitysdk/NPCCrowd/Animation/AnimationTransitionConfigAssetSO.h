...
#define NPCCROWD_ANIMATION_ANIMATIONTRANSITIONCONFIGASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0xF611BE0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationTransitionConfigAssetSO_TypeDefinitionIndex = 40235;
