...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOROTATION_OFFSET UNITYSDK_OFFSET(0x4905F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOSCALE_OFFSET UNITYSDK_OFFSET(0x490940)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOTRANSLATION_OFFSET UNITYSDK_OFFSET(0x4902C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTO_OFFSET UNITYSDK_OFFSET(0x490270)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_CALCULATEINERTIALIZATIONFLOAT_OFFSET UNITYSDK_OFFSET(0xA68D890)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x490020)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x4900E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x490100)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x490060)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x490120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x490140)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x48FFE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x4900A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x4900C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITROTATION_OFFSET UNITYSDK_OFFSET(0x490250)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITSCALE_OFFSET UNITYSDK_OFFSET(0x490260)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITTRANSLATION_OFFSET UNITYSDK_OFFSET(0x490240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INIT_OFFSET UNITYSDK_OFFSET(0x490160)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IPOSEINERTIALIZATIONBONEDELTADATA_INIT_OFFSET UNITYSDK_OFFSET(0x490C70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x490040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x4900F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x490110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x490080)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x490130)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x490150)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x490000)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x4900B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x4900D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationBoneDeltaData16_TypeDefinitionIndex = 57345;
