...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOROTATION_OFFSET UNITYSDK_OFFSET(0x66B020)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOSCALE_OFFSET UNITYSDK_OFFSET(0x66B350)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOTRANSLATION_OFFSET UNITYSDK_OFFSET(0x66ACF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTO_OFFSET UNITYSDK_OFFSET(0x66ACA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_CALCULATEINERTIALIZATIONFLOAT_OFFSET UNITYSDK_OFFSET(0xF8753F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x5ED0F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x5ED1B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x66AB30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x5ED130)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x66AB50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x66AB70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x5ED0B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x5ED170)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x5ED190)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITROTATION_OFFSET UNITYSDK_OFFSET(0x66AC80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITSCALE_OFFSET UNITYSDK_OFFSET(0x66AC90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITTRANSLATION_OFFSET UNITYSDK_OFFSET(0x66AC70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INIT_OFFSET UNITYSDK_OFFSET(0x66AB90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IPOSEINERTIALIZATIONBONEDELTADATA_INIT_OFFSET UNITYSDK_OFFSET(0x66B680)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x5ED110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x5ED1C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x66AB40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x5ED150)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x66AB60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x66AB80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x5ED0D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x5ED180)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x5ED1A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationBoneDeltaData16_TypeDefinitionIndex = 88253;
