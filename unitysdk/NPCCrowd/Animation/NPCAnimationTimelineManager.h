...
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_CACHEPATTERN_OFFSET UNITYSDK_OFFSET(0xE575CE0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_DISPATCHEVENTS_OFFSET UNITYSDK_OFFSET(0xE5749F0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_DISPATCHZONES_OFFSET UNITYSDK_OFFSET(0xE574EB0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_ENTERZONE_OFFSET UNITYSDK_OFFSET(0xE5746A0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_EXITALLZONE_OFFSET UNITYSDK_OFFSET(0xE5744A0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_GETFILENAMEWITHOUTEXTENSION_OFFSET UNITYSDK_OFFSET(0xE573C70)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0xE572CE0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_INITZONEDATA_OFFSET UNITYSDK_OFFSET(0xE575FF0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xE572E60)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE572F40)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_ONENTITYADD_OFFSET UNITYSDK_OFFSET(0xE575470)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_ONENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0xE577B00)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_UPDATECLIP_OFFSET UNITYSDK_OFFSET(0xE573DE0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xE577D30)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xE578170)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE578200)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAnimationTimelineManager_TypeDefinitionIndex = 47803;

	class NPCAnimationTimelineManager : public ::NPCCrowd::NPCCrowdModuleManagerBase
	{
	public:
		// static const ::System::Int32 FRAME_RATE = 0x3C; // 0x0
		::System::Collections::Generic::HashSet_1<::System::String*>* cachedZoneConfig; // 0x18
		::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimatorZoneSegmentWrap*>* removeCache; // 0x20
		::System::Collections::Generic::HashSet_1<::System::String*>* animNameCache; // 0x28
		::System::Collections::Generic::List_1<::NPCCrowd::Animation::ZoneEventItem>* curValidZones; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* fileNameCache; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::String*, ::NPCCrowd::Animation::AnimatorEventPatternWrap*>* animID2Patten; // 0x40
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::System::UInt32, ::Struct_2_4859D873C1433FD9>>* curValidEvent; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::NPCCrowd::Animation::ProcessItem*>* entity2Item; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimatorZoneSegmentWrap*>*>* animID2Zones; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_3_F2DAD7F45F518868*>* entity2Cmp; // 0x60
