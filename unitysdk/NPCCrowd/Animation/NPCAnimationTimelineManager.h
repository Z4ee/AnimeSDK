...
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_CACHEPATTERN_OFFSET UNITYSDK_OFFSET(0x102B73F0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_DISPATCHEVENTS_OFFSET UNITYSDK_OFFSET(0x102B6110)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_DISPATCHZONES_OFFSET UNITYSDK_OFFSET(0x102B65D0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_ENTERZONE_OFFSET UNITYSDK_OFFSET(0x102B5DD0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_EXITALLZONE_OFFSET UNITYSDK_OFFSET(0x102B5BD0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_GETFILENAMEWITHOUTEXTENSION_OFFSET UNITYSDK_OFFSET(0x102B53A0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x102B43B0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_INITZONEDATA_OFFSET UNITYSDK_OFFSET(0x102B7700)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x102B4530)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x102B4610)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_ONENTITYADD_OFFSET UNITYSDK_OFFSET(0x102B6B90)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_ONENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x102B9540)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER_UPDATECLIP_OFFSET UNITYSDK_OFFSET(0x102B5510)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x102B9760)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x102B9BA0)
#define NPCCROWD_ANIMATION_NPCANIMATIONTIMELINEMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x102B9C30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAnimationTimelineManager_TypeDefinitionIndex = 56595;

	class NPCAnimationTimelineManager : public ::NPCCrowd::NPCCrowdModuleManagerBase
	{
	public:
		// static const ::System::Int32 FRAME_RATE = 0x3C; // 0x0
		::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimatorZoneSegmentWrap*>* removeCache; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* fileNameCache; // 0x20
		::System::Collections::Generic::HashSet_1<::System::String*>* cachedZoneConfig; // 0x28
		::System::Collections::Generic::List_1<::NPCCrowd::Animation::ZoneEventItem>* curValidZones; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::NPCCrowd::Animation::ProcessItem*>* entity2Item; // 0x38
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* animNameCache; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_3_F2DAD7F45F518868*>* entity2Cmp; // 0x58
