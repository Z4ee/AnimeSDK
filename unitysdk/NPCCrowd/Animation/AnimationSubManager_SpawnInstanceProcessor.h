...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xD88EC20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FINDORADDINSTANCELIST_OFFSET UNITYSDK_OFFSET(0xD88F190)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0xD88F050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xD88E590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xD88E580)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xD88E5F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xD88E6C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD88F440)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SpawnInstanceProcessor_TypeDefinitionIndex = 88232;

	class AnimationSubManager_SpawnInstanceProcessor : public ::NPCCrowd::Animation::AnimationSubManager_NoDispatchable
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::NPCCrowd::Animation::InstanceEntityData>*>* _instanceMap; // 0x10
		::System::Collections::Generic::Dictionary_2<::NPCCrowd::Animation::InstanceKey, ::System::Collections::Generic::List_1<::NPCCrowd::Animation::InstanceEntityData>*>* _cache; // 0x18
