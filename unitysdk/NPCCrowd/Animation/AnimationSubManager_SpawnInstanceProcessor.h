...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xBDE3D00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FINDORADDINSTANCELIST_OFFSET UNITYSDK_OFFSET(0xBDE4280)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0xBDE4140)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xBDE3650)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xBDE3640)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xBDE36B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xBDE3780)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBDE4530)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SpawnInstanceProcessor_TypeDefinitionIndex = 70467;
