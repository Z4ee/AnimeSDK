...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xFC08390)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xFC08380)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xFC083F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xFC084C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFC08510)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushPostUpdateProcessor_TypeDefinitionIndex = 70418;
