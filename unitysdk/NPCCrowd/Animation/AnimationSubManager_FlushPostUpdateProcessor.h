...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xFFBAE30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xFFBAE20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xFFBAE90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xFFBAF60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPOSTUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFFBAFB0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushPostUpdateProcessor_TypeDefinitionIndex = 57472;
