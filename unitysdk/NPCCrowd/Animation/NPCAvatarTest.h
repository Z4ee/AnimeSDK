...
#define NPCCROWD_ANIMATION_NPCAVATARTEST_CHECKINIT_OFFSET UNITYSDK_OFFSET(0x11D937F0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_CREATETESTNPC_OFFSET UNITYSDK_OFFSET(0x11D93CC0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_ICREATETESTNPC_OFFSET UNITYSDK_OFFSET(0x11D93D90)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_OPENDEBUGINSPECTOR_OFFSET UNITYSDK_OFFSET(0x11D93B80)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x11D93F90)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_PLAYGRAPH_OFFSET UNITYSDK_OFFSET(0x11D94190)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0x11D94150)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SETCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x11D940D0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SETPATHSTATE_OFFSET UNITYSDK_OFFSET(0x11D93950)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SPAWNCOLLECTION_OFFSET UNITYSDK_OFFSET(0x11D93A10)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STARTSPAWNNPC_OFFSET UNITYSDK_OFFSET(0x11D93E20)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STOPANIM_OFFSET UNITYSDK_OFFSET(0x11D94010)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STOPSPAWN_OFFSET UNITYSDK_OFFSET(0x11D93F50)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_TEST500ABILITY_OFFSET UNITYSDK_OFFSET(0x11D941D0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x11D937A0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_WHILESPAWN_OFFSET UNITYSDK_OFFSET(0x11D93ED0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x11D94270)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAvatarTest_TypeDefinitionIndex = 40586;
