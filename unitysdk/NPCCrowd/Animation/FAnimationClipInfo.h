...
#define NPCCROWD_ANIMATION_FANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x39EDC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int FAnimationClipInfo_TypeDefinitionIndex = 65781;
