...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0xF603900)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x652EA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x652E90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x652F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_ISWITHINANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0xF60C360)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_MOTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x652EB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_PREPROCESSBONEADJUST_OFFSET UNITYSDK_OFFSET(0xF60DEE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_TRYADJUSTPELVIS_OFFSET UNITYSDK_OFFSET(0xF60C6A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_TRYSOLVELOOKATIK_OFFSET UNITYSDK_OFFSET(0xF60B010)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_TRYSOLVETWOBONEIK_OFFSET UNITYSDK_OFFSET(0xF606CC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_UPDATELOOKATIKCONTROL_OFFSET UNITYSDK_OFFSET(0xF6098E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLPROCESSOR_LEGACYJOB_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0xF60C4D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MotionControlProcessor_LegacyJob_TypeDefinitionIndex = 88341;
