...
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATEJOBS_OFFSET UNITYSDK_OFFSET(0x10707F30)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x10708360)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10707560)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_ENSUREINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x107078D0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_FINDAVATARINDEX_OFFSET UNITYSDK_OFFSET(0x107089C0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x10706920)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x10706F10)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x107086D0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x107074F0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_ONENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x107072C0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_POSTUPDATE_OFFSET UNITYSDK_OFFSET(0x10707740)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_REGISTERENTITY_OFFSET UNITYSDK_OFFSET(0x10706AA0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x10708920)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_WRITEBACKPOSE_OFFSET UNITYSDK_OFFSET(0x10708740)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10708AD0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x10708CB0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10708D40)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10708DE0)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER___BASE_POSTUPDATE_OFFSET UNITYSDK_OFFSET(0x10708E70)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x10708F10)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCustomIdleManager_TypeDefinitionIndex = 53776;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _entityIds; // 0x20
		...
		::Unity::Collections::NativeList_1<::Unity::Jobs::JobHandle> _sampleHandles; // 0x40
		::Unity::Collections::NativeList_1<::UnityEngine::NapTransformData> _bones; // 0x50
		::Unity::Collections::NativeList_1<::UnityEngine::NapAnimator_SampleAnimationJobRequest> _sampleRequests; // 0x60
		::Unity::Jobs::JobHandle _jobHandle; // 0x70
		::Unity::Collections::NativeList_1<::NPCCrowd::Animation::NPCCustomIdleManager_CustomIdleInstanceData> _instanceData; // 0x80
		::System::Boolean _shouldEnsureData; // 0x90
