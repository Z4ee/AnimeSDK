...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1179A8B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x1179AA50)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1179AC00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationClipInfo_TypeDefinitionIndex = 66756;
