...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_CLAMPANGLE_OFFSET UNITYSDK_OFFSET(0xF9ADDE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_GET_ISNOTNULL_OFFSET UNITYSDK_OFFSET(0x67F810)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_ISAPPLICABLE_OFFSET UNITYSDK_OFFSET(0x67F880)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_MAKE_OFFSET UNITYSDK_OFFSET(0xF9ADFA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_PROCESSCOMPENSATEROTATION_OFFSET UNITYSDK_OFFSET(0x67F960)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_PROCESS_OFFSET UNITYSDK_OFFSET(0x67F8D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xF9AEF70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x67F730)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPerBoneControlData_TypeDefinitionIndex = 57347;
	...
	struct alignas(4) AnimationSubManager_AdjustmentBlendingPerBoneControlData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingPerBoneControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AdjustmentBlendingPerBoneControlData_TypeDefinitionIndex)->GetStaticField(0x13080);
		}
