...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xFF98040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xFF98030)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xFF980A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xFF980F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFF98140)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_CollectLateUpdateProcessor_TypeDefinitionIndex = 57360;
