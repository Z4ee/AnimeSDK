...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERDATA_ANIMATIONCONTROLLERDATA_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xD5C54B0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERDATA_ANIMATIONCONTROLLERDATA_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xD5C54C0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERDATA_ANIMATIONCONTROLLERDATA_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xD5C56A0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERDATA_ANIMATIONCONTROLLERDATA_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD5C5840)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERDATA_ANIMATIONCONTROLLERDATA_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD5C5800)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerData_AnimationControllerData_UnityGeneratedFormatter_TypeDefinitionIndex = 46778;
