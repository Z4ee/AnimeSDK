...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_BUILDREQUEST_OFFSET UNITYSDK_OFFSET(0xFFC0920)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_CALCULATEGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x697F10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_CHECKANDUPDATEFOOTSEGMENTS_OFFSET UNITYSDK_OFFSET(0x697EB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_DOORDINARYRAYCAST_OFFSET UNITYSDK_OFFSET(0x697D90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_DOPREDICTRAYCAST_OFFSET UNITYSDK_OFFSET(0x697DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_DORAYCASTONSTAIR_OFFSET UNITYSDK_OFFSET(0x697D20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_DORAYCAST_OFFSET UNITYSDK_OFFSET(0x697B50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x697B40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_GET__AVATARID_OFFSET UNITYSDK_OFFSET(0x697B10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_GET__LEFTFOOTIKWEIGHTCURVEID_OFFSET UNITYSDK_OFFSET(0x697B20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_GET__RIGHTFOOTIKWEIGHTCURVEID_OFFSET UNITYSDK_OFFSET(0x697B30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_GET__SETTING_OFFSET UNITYSDK_OFFSET(0x697AF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_HITGROUNDFORSLOPE_OFFSET UNITYSDK_OFFSET(0x697E70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_HITGROUND_OFFSET UNITYSDK_OFFSET(0x697E30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x697D10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_PROCESSFADEINOUT_OFFSET UNITYSDK_OFFSET(0x697C30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_RESET_OFFSET UNITYSDK_OFFSET(0x697C40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_SAMPLECURVE_OFFSET UNITYSDK_OFFSET(0x697C70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0x697CB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_PARALLELJOB_TRYRESOLVEDISPATCHINDEX_OFFSET UNITYSDK_OFFSET(0xFFBB270)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepPreProcessor_ParallelJob_TypeDefinitionIndex = 57404;
	...
	struct alignas(4) AnimationSubManager_FootStepPreProcessor_ParallelJob
	{
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationSubManager_AvatarArchetypeData*>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepPreProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0x41AF0);
		}
		static ::System::Double* StaticGet_s_timestamp()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepPreProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0xFE10);
		}
