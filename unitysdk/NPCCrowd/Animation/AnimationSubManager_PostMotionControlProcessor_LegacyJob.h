...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x109FD880)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x6DBB20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x6DBB10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x6DBBC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_MOTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x6DBB30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_TRYADJUSTPELVIS_OFFSET UNITYSDK_OFFSET(0x109FE890)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_TRYSOLVELOOKATIK_OFFSET UNITYSDK_OFFSET(0x10A01A70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_LEGACYJOB_TRYSOLVETWOBONEIK_OFFSET UNITYSDK_OFFSET(0x109FE9D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PostMotionControlProcessor_LegacyJob_TypeDefinitionIndex = 57392;
