...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULEALGORITHM_MULTIPLEDEPENDENCYREMOVER_INVOKE_OFFSET UNITYSDK_OFFSET(0x756110)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_ScheduleAlgorithm_MultipleDependencyRemover_TypeDefinitionIndex = 88363;
