...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_COLLECT_OFFSET UNITYSDK_OFFSET(0xCE59820)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_FETCHCURVEID_OFFSET UNITYSDK_OFFSET(0x573820)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_FETCHCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x573850)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__COLLECT_G__GENERATEPERBONECONFIG_5_0_OFFSET UNITYSDK_OFFSET(0xCE61560)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x37DE40)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingWarpingPerBoneConfig_TypeDefinitionIndex = 70455;
