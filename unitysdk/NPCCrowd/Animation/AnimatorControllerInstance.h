...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_ISBUFFERVALID_OFFSET UNITYSDK_OFFSET(0x6B52F0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x6B52E0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x6B5350)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_PLAYABLE_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_STATES_OFFSET UNITYSDK_OFFSET(0x6B5370)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_RESET_1_OFFSET UNITYSDK_OFFSET(0x6B53F0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_RESET_OFFSET UNITYSDK_OFFSET(0x6B53E0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETBOOL_OFFSET UNITYSDK_OFFSET(0x6B53C0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x6B53A0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETINTEGER_OFFSET UNITYSDK_OFFSET(0x6B53B0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETSTATE_OFFSET UNITYSDK_OFFSET(0x6B5390)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x6B53D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerInstance_TypeDefinitionIndex = 52386;
