...
#define NPCCROWD_ANIMATION_ANIMATOREVENTPATTERNWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0xE8BF790)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorEventPatternWrap_TypeDefinitionIndex = 45936;

	class AnimatorEventPatternWrap : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::Config::AnimatorEvent*>* normalEvent; // 0x10
		::System::Collections::Generic::List_1<::MoleMole::Config::AnimatorEvent*>* exitEvent; // 0x18
		::System::Collections::Generic::List_1<::MoleMole::Config::AnimatorEvent*>* enterEvent; // 0x20
		::MoleMole::Config::AnimatorEventPattern* patten; // 0x28
