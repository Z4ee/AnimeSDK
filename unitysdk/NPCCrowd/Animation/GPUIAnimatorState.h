...
#define NPCCROWD_ANIMATION_GPUIANIMATORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x11507D60)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GPUIAnimatorState_TypeDefinitionIndex = 77363;
