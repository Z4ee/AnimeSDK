...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_GETANIMATIONID_OFFSET UNITYSDK_OFFSET(0xFFC9A40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_SPLITANIMATIONINFO_OFFSET UNITYSDK_OFFSET(0xFFC9AB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_SPLITMONTAGEINFOBYID_OFFSET UNITYSDK_OFFSET(0xFFC9EB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEANIMATIONIDBYNAME_OFFSET UNITYSDK_OFFSET(0xFFC9C40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEANIMATIONID_OFFSET UNITYSDK_OFFSET(0xFFC9B90)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEMONTAGEIDBYNAME_OFFSET UNITYSDK_OFFSET(0xFFC9D70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0xFFC9F80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationDefine_TypeDefinitionIndex = 77078;
