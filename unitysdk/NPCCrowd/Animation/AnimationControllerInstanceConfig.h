...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG_ISVALID_OFFSET UNITYSDK_OFFSET(0xFC006C0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFC00680)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xFC00950)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFC00A90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerInstanceConfig_TypeDefinitionIndex = 59438;
