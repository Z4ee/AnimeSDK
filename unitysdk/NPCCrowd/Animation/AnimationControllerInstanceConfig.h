...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG_ISVALID_OFFSET UNITYSDK_OFFSET(0xFFB2390)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFFB2350)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xFFB2620)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFFB2760)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerInstanceConfig_TypeDefinitionIndex = 72037;
