...
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_BUILDCURVEID_OFFSET UNITYSDK_OFFSET(0xE572C70)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE5729F0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDANIMATION_OFFSET UNITYSDK_OFFSET(0xE572000)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDGENERICCURVE_OFFSET UNITYSDK_OFFSET(0xE5726C0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDORADDANIMATION_OFFSET UNITYSDK_OFFSET(0xE572300)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GETBONEINDEX_OFFSET UNITYSDK_OFFSET(0xE572900)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GETSKELETON_OFFSET UNITYSDK_OFFSET(0xE5727A0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0xE571F60)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xE571F20)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xE571F40)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0xE571F00)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0xE571F70)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xE571F30)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xE571F50)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_SKELETON_OFFSET UNITYSDK_OFFSET(0xE571F10)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE572CA0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0xE571F80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAnimationLib_AvatarAnimatorCache_TypeDefinitionIndex = 61823;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(NPCAnimationLib_AvatarAnimatorCache_TypeDefinitionIndex)->GetStaticField(0xD0A0);
		}
		::NPCCrowd::Animation::AnimationControllerInstanceConfig* _Config_k__BackingField; // 0x10
		::System::Collections::Generic::Dictionary_2<::UnityEngine::AnimationClip*, ::System::Int32>* _clipLookupTable; // 0x18
		::UnityEngine::NapAnimator* _animator; // 0x20
		::UnityEngine::Avatar* _Skeleton_k__BackingField; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* _boneIndexLookupTable; // 0x30
		::System::Collections::Generic::Dictionary_2<::UnityEngine::NapAnimator_GenericCurveID, ::System::Int32>* _curveLookupTable; // 0x38
