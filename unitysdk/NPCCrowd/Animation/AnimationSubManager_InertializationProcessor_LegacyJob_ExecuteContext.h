...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_ADJUSTROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x10C95950)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_ADVANCETIME_1_OFFSET UNITYSDK_OFFSET(0x10C95110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x6F4550)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_APPLY_1_OFFSET UNITYSDK_OFFSET(0x10C96430)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_APPLY_OFFSET UNITYSDK_OFFSET(0x6F4570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_CALCROOTINERTIALIZATIONSPACE_OFFSET UNITYSDK_OFFSET(0x10C960E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_CAPTURE_1_OFFSET UNITYSDK_OFFSET(0x10C96680)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_CAPTURE_OFFSET UNITYSDK_OFFSET(0x6F4580)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_GENERATEDELTADATA_OFFSET UNITYSDK_OFFSET(0x10C95480)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_HANDLEREQUEST_1_OFFSET UNITYSDK_OFFSET(0x10C95090)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_HANDLEREQUEST_OFFSET UNITYSDK_OFFSET(0x6F4540)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_START_1_OFFSET UNITYSDK_OFFSET(0x10C951B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT_START_OFFSET UNITYSDK_OFFSET(0x6F4560)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_LEGACYJOB_EXECUTECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6F42E0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_InertializationProcessor_LegacyJob_ExecuteContext_TypeDefinitionIndex = 88258;
