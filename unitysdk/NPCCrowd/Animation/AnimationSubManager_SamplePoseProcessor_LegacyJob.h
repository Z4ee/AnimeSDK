...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_BONEEXTRACT_OFFSET UNITYSDK_OFFSET(0xEBD9830)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x651A20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_EXTRACTPOSE_OFFSET UNITYSDK_OFFSET(0xEBD7EA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x651A10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x651810)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SamplePoseProcessor_LegacyJob_TypeDefinitionIndex = 57389;

	struct alignas(8) AnimationSubManager_SamplePoseProcessor_LegacyJob
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::NPCCrowd::Chunk::ReadOnlyChunkView_1<::NPCCrowd::Animation::CPUStateMachine::AnimationClipDataMultiLayer>, ::NPCCrowd::Chunk::ChunkView2D_1<::UnityEngine::NapTransformData>, ::System::Int32, ::System::Int32, ::Unity::Collections::NativeArray_1<::Foundation::BitSet256>, ::System::Int32, ::System::Int32, ::NPCCrowd::Chunk::ReadOnlyChunkView_1<::System::UInt32>, ::Unity::Collections::NativeHashMap_2_ParallelWriter<::System::UInt32, ::ExtractBoneInfo>, ::System::Int32))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB__CTOR_OFFSET))(this, clipData, output, avatarId, boneCount, layerMaskList, indexBip001, rootIndex, entityIds, extractBoneMap, headBoneIndex);
		}

		::System::Int32 get_ChunkCount()
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_GET_CHUNKCOUNT_OFFSET))(this);
		}

		::System::Void Execute(::System::Int32 chunkIndex)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_EXECUTE_OFFSET))(this, chunkIndex);
		}
		...
		{
			return ((::System::Void(*)(::System::Int32, ::System::Int32, ::System::Int32, ::System::Int32, ::System::Int32, ::System::Int32, ::System::ReadOnlySpan_1<::NPCCrowd::Animation::CPUStateMachine::AnimationClipDataMultiLayer>, ::NPCCrowd::Chunk::Span2D_1<::UnityEngine::NapTransformData>, ::System::ReadOnlySpan_1<::System::UInt32>, ::Unity::Collections::NativeArray_1<::Foundation::BitSet256>, ::Unity::Collections::NativeHashMap_2_ParallelWriter<::System::UInt32, ::ExtractBoneInfo>))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_EXTRACTPOSE_OFFSET))(avatarId, boneCount, indexBip001, rootIndex, headBoneIndex, middlePointIndex, data, result, instanceId, layerMaskList, extractBoneMap);
		}
		*/
		...
		{
			return ((::System::Void(*)(::System::UInt32, ::UnityEngine::NapTransformData, ::UnityEngine::NapTransformData, ::Unity::Collections::NativeHashMap_2_ParallelWriter<::System::UInt32, ::ExtractBoneInfo>))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_LEGACYJOB_BONEEXTRACT_OFFSET))(entityID, headBone, middlePoint, extractBoneMap);
		}
	};
}
