...
#define NPCCROWD_ANIMATION_NPCCROWDFRAMEKEYMANAGER_SEQFRAMERUNTIMEKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x5A2EB0)
#define NPCCROWD_ANIMATION_NPCCROWDFRAMEKEYMANAGER_SEQFRAMERUNTIMEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x5A2E10)
#define NPCCROWD_ANIMATION_NPCCROWDFRAMEKEYMANAGER_SEQFRAMERUNTIMEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5A2EC0)
#define NPCCROWD_ANIMATION_NPCCROWDFRAMEKEYMANAGER_SEQFRAMERUNTIMEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x5A2E00)
#define NPCCROWD_ANIMATION_NPCCROWDFRAMEKEYMANAGER_SEQFRAMERUNTIMEKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x5A2F20)
#define NPCCROWD_ANIMATION_NPCCROWDFRAMEKEYMANAGER_SEQFRAMERUNTIMEKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5A2F90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdFrameKeyManager_SeqFrameRuntimeKey_TypeDefinitionIndex = 56701;
