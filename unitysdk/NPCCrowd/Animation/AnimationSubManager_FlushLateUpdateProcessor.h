...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xF0D76D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xF0D76C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xF0D7730)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xF0D7800)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKBLENDSHAPE_OFFSET UNITYSDK_OFFSET(0xF0D9B30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKMONTAGEDATA_OFFSET UNITYSDK_OFFSET(0xF0D9810)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKPOSE_OFFSET UNITYSDK_OFFSET(0xF0D93F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF0DAA70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushLateUpdateProcessor_TypeDefinitionIndex = 88245;
	...
	public:
		...
		static ::System::Void WriteBackMontageData(::NPCCrowd::Animation::AnimationSubManager_AnimationArchetypeData* animation)
		{
			return ((::System::Void(*)(::NPCCrowd::Animation::AnimationSubManager_AnimationArchetypeData*))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKMONTAGEDATA_OFFSET))(animation);
		}
