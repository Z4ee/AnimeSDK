...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xF9AF110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xF9AF100)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xF9AF170)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xF9AF240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKBLENDSHAPE_OFFSET UNITYSDK_OFFSET(0xF9B1560)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKMONTAGEDATA_OFFSET UNITYSDK_OFFSET(0xF9B1250)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKPOSE_OFFSET UNITYSDK_OFFSET(0xF9B0E50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF9B24F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushLateUpdateProcessor_TypeDefinitionIndex = 57356;
