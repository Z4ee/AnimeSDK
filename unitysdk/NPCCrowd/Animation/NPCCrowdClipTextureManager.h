...
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_ACQUIRECLIPTEXTURES_OFFSET UNITYSDK_OFFSET(0xD941300)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_ACQUIRECLIPTEXTURE_OFFSET UNITYSDK_OFFSET(0xD940640)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_ADDTOPENDINGUNLOAD_OFFSET UNITYSDK_OFFSET(0xD940F50)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_CANCELPREFETCHCLIPTEXTURES_OFFSET UNITYSDK_OFFSET(0xD942200)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_CANCELPREFETCH_OFFSET UNITYSDK_OFFSET(0xD942010)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_DESTROYINSTANCE_OFFSET UNITYSDK_OFFSET(0xD93FCC0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_FORCECOMPACTALLATLASES_OFFSET UNITYSDK_OFFSET(0xD943D80)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETALLATLASSTATS_OFFSET UNITYSDK_OFFSET(0xD9440B0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETATLASBYPROTOTYPE_OFFSET UNITYSDK_OFFSET(0xD943570)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETATLASTEXTUREBYPROTOTYPE_OFFSET UNITYSDK_OFFSET(0xD9430E0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETATLASTEXTURE_OFFSET UNITYSDK_OFFSET(0xD940400)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETCLIPATLASOFFSETX_OFFSET UNITYSDK_OFFSET(0xD942DF0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETCLIPATLASOFFSETY_OFFSET UNITYSDK_OFFSET(0xD942AF0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETCLIPREFCOUNT_OFFSET UNITYSDK_OFFSET(0xD942740)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETCOMPATIBLETEXTURE_OFFSET UNITYSDK_OFFSET(0xD940230)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xD944890)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GETORCREATEATLAS_OFFSET UNITYSDK_OFFSET(0xD9431D0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GET_ATLASVERSION_OFFSET UNITYSDK_OFFSET(0xD940060)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD93F9C0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_ISCLIPGRANULARLOADINGSUPPORTED_OFFSET UNITYSDK_OFFSET(0xD940070)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_ISCLIPLOADEDTOATLAS_OFFSET UNITYSDK_OFFSET(0xD942910)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_ISPREFETCHED_OFFSET UNITYSDK_OFFSET(0xD942550)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_LOADCLIPTOATLAS_OFFSET UNITYSDK_OFFSET(0xD940970)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_PREFETCHCLIPTEXTURES_OFFSET UNITYSDK_OFFSET(0xD941CC0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_PREFETCHCLIPTEXTURE_OFFSET UNITYSDK_OFFSET(0xD9419A0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_RELEASEALL_OFFSET UNITYSDK_OFFSET(0xD93FD20)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_RELEASECLIPTEXTURES_OFFSET UNITYSDK_OFFSET(0xD941650)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_RELEASECLIPTEXTURE_OFFSET UNITYSDK_OFFSET(0xD940E70)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_REMOVEFROMPENDINGUNLOAD_OFFSET UNITYSDK_OFFSET(0xD940840)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0xD943650)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_TRYCOMPACTATLAS_OFFSET UNITYSDK_OFFSET(0xD943940)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_UNLOADCLIPFROMATLAS_OFFSET UNITYSDK_OFFSET(0xD941090)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER_VALIDATECLIPTEXTUREFORATLAS_OFFSET UNITYSDK_OFFSET(0xD943EF0)
#define NPCCROWD_ANIMATION_NPCCROWDCLIPTEXTUREMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD93FA40)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdClipTextureManager_TypeDefinitionIndex = 84946;
	...
	public:
		...
		{
			return (::NPCCrowd::Animation::NPCCrowdClipTextureManager**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdClipTextureManager_TypeDefinitionIndex)->GetStaticField(0x4B3A0);
		}
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::NPCCrowd::Animation::NPCCrowdClipTextureManager_LoadedClipInfo>*>* _loadedClipsPerAtlas; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _prototypeBoneCountMap; // 0x18
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>* _prototypeNameMap; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::Animation::NPCCrowdVerticalAtlas*>* _atlasMap; // 0x38
		::System::Single delayUnloadTime; // 0x40
		::System::Boolean bEnableDelayUnload; // 0x44
		::System::Single prefetchDelayUnloadTime; // 0x48
		::System::Single compactionWasteThreshold; // 0x4C
		::System::Int32 _atlasVersion; // 0x50
		::System::Int32 compactionMinSavingRows; // 0x54
