...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_DISPATCH_OFFSET UNITYSDK_OFFSET(0xFFC2500)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xFFC2410)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0xFFC2400)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0xFFC23F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xFFC2470)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFFC2960)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PostMotionControlProcessor_TypeDefinitionIndex = 57391;
