...
#include "unitysdk/NPCCrowd/Animation/AnimationSubManager_PostMotionControlProcessor_Job.h"
#include "unitysdk/Unity/Jobs/JobHandle.h"

namespace NPCCrowd::Animation { class AnimationSubManager; }
namespace System { class String; }

#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_DISPATCH_OFFSET UNITYSDK_OFFSET(0xFC08630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xFC08540)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0xFC08530)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0xFC08520)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xFC085A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSTMOTIONCONTROLPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFC09600)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PostMotionControlProcessor_TypeDefinitionIndex = 70477;

	class AnimationSubManager_PostMotionControlProcessor : public ::NPCCrowd::Animation::AnimationSubManager_Dispatchable
	{
	public:
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_PostMotionControlProcessor_Job>* _buffer; // 0x10
