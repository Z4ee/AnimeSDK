...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_COMPLETE_OFFSET UNITYSDK_OFFSET(0x592D60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_DISPATCH_OFFSET UNITYSDK_OFFSET(0x592DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x592CE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWCOMPLETEOPERATION_OFFSET UNITYSDK_OFFSET(0xD41BED0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWDISPATCHOPERATION_OFFSET UNITYSDK_OFFSET(0xD41C460)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWPROCESSOPERATION_OFFSET UNITYSDK_OFFSET(0xD41BD30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_PROCESS_OFFSET UNITYSDK_OFFSET(0x592D20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x592C70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_Operation_TypeDefinitionIndex = 57448;
