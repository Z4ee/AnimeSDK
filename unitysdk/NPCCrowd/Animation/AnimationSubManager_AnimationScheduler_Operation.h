...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_COMPLETE_OFFSET UNITYSDK_OFFSET(0x6A95F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_DISPATCH_OFFSET UNITYSDK_OFFSET(0x6A9630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x6A9570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWCOMPLETEOPERATION_OFFSET UNITYSDK_OFFSET(0x10649090)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWDISPATCHOPERATION_OFFSET UNITYSDK_OFFSET(0x10649630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWPROCESSOPERATION_OFFSET UNITYSDK_OFFSET(0x10648EF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_PROCESS_OFFSET UNITYSDK_OFFSET(0x6A95B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x6A94F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_Operation_TypeDefinitionIndex = 88350;
