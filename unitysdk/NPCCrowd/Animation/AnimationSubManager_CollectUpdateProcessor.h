...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x106FDFE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x106FDFD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x106FE040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x106FE090)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x106FE0E0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_CollectUpdateProcessor_TypeDefinitionIndex = 57375;
