...
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEDAMPEDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x6B8B90)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEJOINTLOCALROTATIONS_OFFSET UNITYSDK_OFFSET(0x6B8BD0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALPOS_OFFSET UNITYSDK_OFFSET(0x6B8A20)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x6B8A40)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOC_OFFSET UNITYSDK_OFFSET(0x6B89E0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTROT_OFFSET UNITYSDK_OFFSET(0x6B8A00)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDPOS_OFFSET UNITYSDK_OFFSET(0x6B8A60)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x6B8A80)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_INIT_OFFSET UNITYSDK_OFFSET(0x6B8AA0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x6B8B50)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x6B8B10)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_SETROOTLOCANDROT_OFFSET UNITYSDK_OFFSET(0x6B8970)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int DampingJob_TypeDefinitionIndex = 81299;
