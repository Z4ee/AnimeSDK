...
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEDAMPEDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x6981E0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEJOINTLOCALROTATIONS_OFFSET UNITYSDK_OFFSET(0x698220)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALPOS_OFFSET UNITYSDK_OFFSET(0x698070)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x698090)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOC_OFFSET UNITYSDK_OFFSET(0x698030)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTROT_OFFSET UNITYSDK_OFFSET(0x698050)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDPOS_OFFSET UNITYSDK_OFFSET(0x6980B0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x6980D0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_INIT_OFFSET UNITYSDK_OFFSET(0x6980F0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x6981A0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x698160)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_SETROOTLOCANDROT_OFFSET UNITYSDK_OFFSET(0x697FC0)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int DampingJob_TypeDefinitionIndex = 58847;
