...
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x6C8870)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x6C8830)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_SETUP_OFFSET UNITYSDK_OFFSET(0x6C8820)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_SOLVE_OFFSET UNITYSDK_OFFSET(0x10704C70)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_TRIANGLEANGLE_OFFSET UNITYSDK_OFFSET(0x10705680)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int TwoBoneIKJob_TypeDefinitionIndex = 74530;
