...
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x72CB10)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0x11291120)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITJOINTS_OFFSET UNITYSDK_OFFSET(0x72CB70)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITPARAMBUFFER_OFFSET UNITYSDK_OFFSET(0x72CB20)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_LOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0x11291620)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x72CC70)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x72CC30)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETCLAMPWEIGHTS_OFFSET UNITYSDK_OFFSET(0x72CC20)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETTARGET_OFFSET UNITYSDK_OFFSET(0x72CB30)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHTS_OFFSET UNITYSDK_OFFSET(0x72CC10)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x72CB60)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0x11290AA0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x11290430)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1128FE10)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int LookAtJob_TypeDefinitionIndex = 43489;
