...
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x697ED0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0xF858300)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITJOINTS_OFFSET UNITYSDK_OFFSET(0x697F30)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITPARAMBUFFER_OFFSET UNITYSDK_OFFSET(0x697EE0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_LOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0xF858800)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x698030)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x697FF0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETCLAMPWEIGHTS_OFFSET UNITYSDK_OFFSET(0x697FE0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETTARGET_OFFSET UNITYSDK_OFFSET(0x697EF0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHTS_OFFSET UNITYSDK_OFFSET(0x697FD0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x697F20)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0xF857C60)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0xF857590)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0xF856F50)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int LookAtJob_TypeDefinitionIndex = 81349;
