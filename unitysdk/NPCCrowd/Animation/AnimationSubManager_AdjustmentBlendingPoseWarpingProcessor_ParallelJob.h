...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_CLEARCONTROLDATA_1_OFFSET UNITYSDK_OFFSET(0x48FE00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_CLEARCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x48FDF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x48F9A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_GETPOSE_OFFSET UNITYSDK_OFFSET(0x48FA90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_GET__SKELETON_OFFSET UNITYSDK_OFFSET(0x48F980)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_SAMPLEPOSE_1_OFFSET UNITYSDK_OFFSET(0x48F9B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_SAMPLEPOSE_OFFSET UNITYSDK_OFFSET(0xA6843A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_SETBONEDATA_OFFSET UNITYSDK_OFFSET(0x48FC80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x48FD40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_TRYRESOLVEDISPATCHINDEX_OFFSET UNITYSDK_OFFSET(0xA681420)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_WARPPOSE_OFFSET UNITYSDK_OFFSET(0x48FBA0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_ParallelJob_TypeDefinitionIndex = 57370;
	...
	struct alignas(8) AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_ParallelJob
	{
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationSubManager_AvatarArchetypeData*>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0x3F950);
		}
