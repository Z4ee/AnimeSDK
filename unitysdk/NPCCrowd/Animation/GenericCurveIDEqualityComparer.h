...
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0xE5719C0)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0xE571960)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xE5719E0)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xE571A50)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GenericCurveIDEqualityComparer_TypeDefinitionIndex = 48846;
