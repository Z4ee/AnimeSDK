...
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x102B3080)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x102B3020)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x102B30A0)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x102B3110)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GenericCurveIDEqualityComparer_TypeDefinitionIndex = 72260;
