...
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_ANIMATIONID_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x490D20)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_ANIMATIONID__CCTOR_OFFSET UNITYSDK_OFFSET(0xA690280)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_ANIMATIONID__CTOR_OFFSET UNITYSDK_OFFSET(0x2AB920)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAnimationLib_AnimationId_TypeDefinitionIndex = 71437;

	struct alignas(4) NPCAnimationLib_AnimationId
	{
		static ::NPCCrowd::Animation::NPCAnimationLib_AnimationId* StaticGet_Null()
		{
			return (::NPCCrowd::Animation::NPCAnimationLib_AnimationId*)Il2CppClass::FromTypeDefinitionIndex(NPCAnimationLib_AnimationId_TypeDefinitionIndex)->GetStaticField(0xD060);
		}
