...
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0xD450E90)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GETGENDERSIZEANIMATIONS_OFFSET UNITYSDK_OFFSET(0xD4509A0)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0xD450960)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xD451040)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST___BASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0xD4510C0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdAnimationUnitTest_TypeDefinitionIndex = 54305;
