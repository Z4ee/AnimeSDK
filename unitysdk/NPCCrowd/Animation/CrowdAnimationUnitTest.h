...
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x10703640)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GETGENDERSIZEANIMATIONS_OFFSET UNITYSDK_OFFSET(0x10703150)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0x10703110)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x107037F0)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST___BASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x10703870)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdAnimationUnitTest_TypeDefinitionIndex = 40630;
