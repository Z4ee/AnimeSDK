...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xF0DAA90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xF0DAA80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xF0DAAF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xF0DABC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xF0DAD70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushPreUpdateProcessor_TypeDefinitionIndex = 88281;
