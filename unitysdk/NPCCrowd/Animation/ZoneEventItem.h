...
#define NPCCROWD_ANIMATION_ZONEEVENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x698590)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int ZoneEventItem_TypeDefinitionIndex = 53898;
