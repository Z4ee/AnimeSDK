...
#define NPCCROWD_ANIMATION_ZONEEVENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7C0B40)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int ZoneEventItem_TypeDefinitionIndex = 48439;
