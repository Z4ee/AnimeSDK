...
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_ADDLAYER_OFFSET UNITYSDK_OFFSET(0xFC14500)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_DISCONNECT_OFFSET UNITYSDK_OFFSET(0xFC144C0)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_GETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xFC14790)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0xFC14570)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_SETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xFC14720)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_SETLAYERMASK_OFFSET UNITYSDK_OFFSET(0xFC14670)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_SETLAYERSPEED_OFFSET UNITYSDK_OFFSET(0xFC14600)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS__CTOR_OFFSET UNITYSDK_OFFSET(0xFC14370)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS___BASE_DISCONNECT_OFFSET UNITYSDK_OFFSET(0xFC147F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUNormalFKPass_TypeDefinitionIndex = 79811;
