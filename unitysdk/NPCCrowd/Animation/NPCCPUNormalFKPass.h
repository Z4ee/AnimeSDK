...
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_ADDLAYER_OFFSET UNITYSDK_OFFSET(0x12D28200)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_DISCONNECT_OFFSET UNITYSDK_OFFSET(0x12D281C0)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_GETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0x12D28490)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0x12D28270)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_SETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0x12D28420)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_SETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x12D28370)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS_SETLAYERSPEED_OFFSET UNITYSDK_OFFSET(0x12D28300)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x12D28070)
#define NPCCROWD_ANIMATION_NPCCPUNORMALFKPASS___BASE_DISCONNECT_OFFSET UNITYSDK_OFFSET(0x12D284F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUNormalFKPass_TypeDefinitionIndex = 77648;
