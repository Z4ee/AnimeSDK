...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_FLUSHER_APPLYLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x5ECF80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_FLUSHER_FOUNDATION_IIN_OFFSET UNITYSDK_OFFSET(0x5ECF70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_PARALLELJOB_FLUSHER__CTOR_OFFSET UNITYSDK_OFFSET(0x5ECE80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_ParallelJob_Flusher_TypeDefinitionIndex = 88274;
