...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_APPLYPARAMTO_OFFSET UNITYSDK_OFFSET(0x109F8E70)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_CREATEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x109F9390)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_1_OFFSET UNITYSDK_OFFSET(0x109F8CA0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_OFFSET UNITYSDK_OFFSET(0x109F8BA0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHSTATE_OFFSET UNITYSDK_OFFSET(0x109F9870)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GETEXPOSEDPARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x109F8B20)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GET_ISANIMATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x109F8490)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0x109F8A60)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x109F8540)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_ISMATCH_OFFSET UNITYSDK_OFFSET(0x109F84A0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x109F9AE0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerInstanceEntry_TypeDefinitionIndex = 52367;
