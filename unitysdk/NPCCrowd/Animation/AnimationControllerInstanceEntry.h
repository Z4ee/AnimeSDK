...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_APPLYPARAMTO_OFFSET UNITYSDK_OFFSET(0xF4EE830)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_CREATEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0xF4EED50)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_1_OFFSET UNITYSDK_OFFSET(0xF4EE660)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_OFFSET UNITYSDK_OFFSET(0xF4EE560)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHSTATE_OFFSET UNITYSDK_OFFSET(0xF4EF230)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GETEXPOSEDPARAMCOUNT_OFFSET UNITYSDK_OFFSET(0xF4EE4E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GET_ISANIMATIONCONFIG_OFFSET UNITYSDK_OFFSET(0xF4EDE50)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0xF4EE420)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xF4EDF00)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_ISMATCH_OFFSET UNITYSDK_OFFSET(0xF4EDE60)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xF4EF4A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerInstanceEntry_TypeDefinitionIndex = 67224;
