...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x109F83A0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x109F8400)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x109F8480)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerAnimationClipOverrideItem_TypeDefinitionIndex = 65568;
