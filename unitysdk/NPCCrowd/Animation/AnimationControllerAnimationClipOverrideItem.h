...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x157AC860)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x157AC8C0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x157AC940)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerAnimationClipOverrideItem_TypeDefinitionIndex = 88778;
