...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURECURVECOUNT_OFFSET UNITYSDK_OFFSET(0x66A9E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURESECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x66A9F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVECOUNT_OFFSET UNITYSDK_OFFSET(0x66A970)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVETIMEPTR_OFFSET UNITYSDK_OFFSET(0x259D70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVEVALUEPTR_OFFSET UNITYSDK_OFFSET(0x3C9DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x32E550)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONPTR_OFFSET UNITYSDK_OFFSET(0x3D1A20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_NEW_OFFSET UNITYSDK_OFFSET(0xF8730D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_SLICESECTION_OFFSET UNITYSDK_OFFSET(0x66AB00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PhaseMatchingProcessor_Buffer_TypeDefinitionIndex = 88286;
