...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURECURVECOUNT_OFFSET UNITYSDK_OFFSET(0x48FE90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURESECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x48FEA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVECOUNT_OFFSET UNITYSDK_OFFSET(0x48FE20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVETIMEPTR_OFFSET UNITYSDK_OFFSET(0x246290)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVEVALUEPTR_OFFSET UNITYSDK_OFFSET(0x3E3F20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x3B1DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONPTR_OFFSET UNITYSDK_OFFSET(0x40C750)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_NEW_OFFSET UNITYSDK_OFFSET(0xA68B440)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_SLICESECTION_OFFSET UNITYSDK_OFFSET(0x48FFB0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PhaseMatchingProcessor_Buffer_TypeDefinitionIndex = 57364;
