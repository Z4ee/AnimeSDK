...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x5A13C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x5A1380)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x5A1370)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x5A1350)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x5A1390)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_SET_STATE_OFFSET UNITYSDK_OFFSET(0x5A1360)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD44BAC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x464E40)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationInstanceData_TypeDefinitionIndex = 70506;
	...
	struct alignas(4) AnimationSubManager_PoseInertializationInstanceData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_PoseInertializationInstanceData_TypeDefinitionIndex)->GetStaticField(0xAD70);
		}
