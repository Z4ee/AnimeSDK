...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x668FB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x668F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x668F60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x668F40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x668F80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_SET_STATE_OFFSET UNITYSDK_OFFSET(0x668F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xF76E0A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3C9050)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationInstanceData_TypeDefinitionIndex = 88262;
	...
	struct alignas(4) AnimationSubManager_PoseInertializationInstanceData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_PoseInertializationInstanceData_TypeDefinitionIndex)->GetStaticField(0xB510);
		}
