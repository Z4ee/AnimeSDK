...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_1_OFFSET UNITYSDK_OFFSET(0xBDE1C40)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_OFFSET UNITYSDK_OFFSET(0xBDE1610)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0xBDE1D50)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xBDE1B40)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0xBDE1DE0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_MATCHES_OFFSET UNITYSDK_OFFSET(0xBDE1580)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0xBDE1870)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBDE1E70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerParameterOverrideItem_TypeDefinitionIndex = 54923;
