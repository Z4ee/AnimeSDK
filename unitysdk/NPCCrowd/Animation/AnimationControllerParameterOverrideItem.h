...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_1_OFFSET UNITYSDK_OFFSET(0xD88D770)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_OFFSET UNITYSDK_OFFSET(0xD88D1B0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0xD88D860)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xD88D690)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0xD88D8F0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_MATCHES_OFFSET UNITYSDK_OFFSET(0xD88D120)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0xD88D3E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD88D980)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerParameterOverrideItem_TypeDefinitionIndex = 84728;
