...
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_GETANIMATORDATA_OFFSET UNITYSDK_OFFSET(0xFB57020)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0xFB573A0)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_GETAVATAR_OFFSET UNITYSDK_OFFSET(0xFB57310)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0xFB56D90)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xFB572B0)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFB56D00)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_PLAYANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0xFB56D40)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_SETANIMATORLOD_OFFSET UNITYSDK_OFFSET(0xFB57350)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_SETATTACHMENTPOSITION_OFFSET UNITYSDK_OFFSET(0xFB570D0)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_SETATTACHMENTROTATION_OFFSET UNITYSDK_OFFSET(0xFB57140)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_SETATTACHMENTSCALE_OFFSET UNITYSDK_OFFSET(0xFB571A0)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_SETTICKPAUSESTATE_OFFSET UNITYSDK_OFFSET(0xFB56FD0)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_STOPMAINANIMATION_OFFSET UNITYSDK_OFFSET(0xFB57210)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xFB57250)
#define NPCCROWD_ANIMATION_NPCACCESSORYNORMALANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFB573E0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAccessoryNormalAnimator_TypeDefinitionIndex = 42109;
