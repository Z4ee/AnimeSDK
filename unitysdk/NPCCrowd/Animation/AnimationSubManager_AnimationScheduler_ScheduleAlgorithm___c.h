...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULEALGORITHM___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD88DA20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULEALGORITHM___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD88DA60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULEALGORITHM___C___CCTOR_B__22_0_OFFSET UNITYSDK_OFFSET(0xD88DA70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULEALGORITHM___C___CCTOR_B__22_1_OFFSET UNITYSDK_OFFSET(0xD88DA90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_ScheduleAlgorithm___c_TypeDefinitionIndex = 88364;
	...
	public:
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_AnimationScheduler_ScheduleAlgorithm___c**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AnimationScheduler_ScheduleAlgorithm___c_TypeDefinitionIndex)->GetStaticField(0x45650);
		}
