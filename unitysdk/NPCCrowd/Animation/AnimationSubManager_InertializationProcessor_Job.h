...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x50C870)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x50C860)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB__CTOR_OFFSET UNITYSDK_OFFSET(0x50C640)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_InertializationProcessor_Job_TypeDefinitionIndex = 70452;

	struct alignas(8) AnimationSubManager_InertializationProcessor_Job
	{
