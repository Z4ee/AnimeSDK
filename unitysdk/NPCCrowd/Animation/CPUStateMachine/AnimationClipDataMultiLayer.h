...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_CLEARMASK_OFFSET UNITYSDK_OFFSET(0x72CA20)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_GETLAYERCLIPDATA_OFFSET UNITYSDK_OFFSET(0x72CAD0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_INITDATA_OFFSET UNITYSDK_OFFSET(0x72C9F0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_SETVALIDLAYERMASK_OFFSET UNITYSDK_OFFSET(0x72CA70)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationClipDataMultiLayer_TypeDefinitionIndex = 63904;
