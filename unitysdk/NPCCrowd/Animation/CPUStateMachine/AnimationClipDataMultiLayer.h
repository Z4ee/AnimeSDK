...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_CLEARMASK_OFFSET UNITYSDK_OFFSET(0x626A60)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_GETLAYERCLIPDATA_OFFSET UNITYSDK_OFFSET(0x626B10)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_INITDATA_OFFSET UNITYSDK_OFFSET(0x626A30)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_SETVALIDLAYERMASK_OFFSET UNITYSDK_OFFSET(0x626AB0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationClipDataMultiLayer_TypeDefinitionIndex = 80780;
