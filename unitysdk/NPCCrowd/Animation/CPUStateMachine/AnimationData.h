...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_EXTRACTROOTMOTION_OFFSET UNITYSDK_OFFSET(0x72F5B0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GETNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x72F530)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GETSAMPLETIME_OFFSET UNITYSDK_OFFSET(0x72F560)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASADJUSTMENTBLENDING_OFFSET UNITYSDK_OFFSET(0x72F4C0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASPHASEMATCHING_OFFSET UNITYSDK_OFFSET(0x70CD70)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x70CD80)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x70CD60)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_STRIPBIPMOTION_OFFSET UNITYSDK_OFFSET(0x72F4D0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x72F4E0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationData_TypeDefinitionIndex = 57402;
