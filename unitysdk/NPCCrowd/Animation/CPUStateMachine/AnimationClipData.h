...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA_GET_HASADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x593960)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA_GET_SAMPLETIME_OFFSET UNITYSDK_OFFSET(0x593910)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x5939B0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x593980)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationClipData_TypeDefinitionIndex = 44471;
