...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_GET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x36DBB0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_GET_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x36DBB0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_1_OFFSET UNITYSDK_OFFSET(0x12D10BD0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_2_OFFSET UNITYSDK_OFFSET(0x12D10BE0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_3_OFFSET UNITYSDK_OFFSET(0x12D10BF0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_OFFSET UNITYSDK_OFFSET(0x12D10BC0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x463A20)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_SETTRIGGER_OFFSET UNITYSDK_OFFSET(0x663E80)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_SET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x324490)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerParamValue_TypeDefinitionIndex = 55401;
