...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_DISPATCH_OFFSET UNITYSDK_OFFSET(0x106614A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0x10661490)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x10661570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0x10661560)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x106558C0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_NoDispatchable_TypeDefinitionIndex = 88278;
