...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_DISPATCH_OFFSET UNITYSDK_OFFSET(0xD434840)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0xD434830)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0xD434910)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0xD434900)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD428930)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_NoDispatchable_TypeDefinitionIndex = 57397;
