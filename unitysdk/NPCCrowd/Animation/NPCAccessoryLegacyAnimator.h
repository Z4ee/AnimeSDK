...
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_BINDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0xFDEE6F0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_FORCESYNCANIMATOR_OFFSET UNITYSDK_OFFSET(0xFDEDFA0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_FORCESYNC_OFFSET UNITYSDK_OFFSET(0xFDED9F0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATORDATA_1_OFFSET UNITYSDK_OFFSET(0xFDECCF0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATORDATA_OFFSET UNITYSDK_OFFSET(0xFDECC50)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATORTRANSFORM_OFFSET UNITYSDK_OFFSET(0xFDEE490)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0xFDEE450)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETAVATAR_OFFSET UNITYSDK_OFFSET(0xFDEDDB0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETBINDEDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0xFDEE610)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETWORLDTIME_OFFSET UNITYSDK_OFFSET(0xFDED430)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0xFDEC560)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_LATEUPDATE_1_OFFSET UNITYSDK_OFFSET(0xFDEDD50)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xFDEDCB0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFDEE390)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_PLAYANIMATIONCLIPBYID_OFFSET UNITYSDK_OFFSET(0xFDED050)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_PLAYANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0xFDED480)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_REFRESHBINDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0xFDEE960)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0xFDECFA0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETANIMATORLOD_OFFSET UNITYSDK_OFFSET(0xFDEDF30)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETATTACHMENTPOSITION_OFFSET UNITYSDK_OFFSET(0xFDECD40)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETATTACHMENTROTATION_OFFSET UNITYSDK_OFFSET(0xFDECDD0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETATTACHMENTSCALE_OFFSET UNITYSDK_OFFSET(0xFDECE60)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETHIGHQUALITYCULLMODE_OFFSET UNITYSDK_OFFSET(0xFDEE3F0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETTICKPAUSESTATE_OFFSET UNITYSDK_OFFSET(0xFDECEF0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_STOPMAINANIMATION_OFFSET UNITYSDK_OFFSET(0xFDED530)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SYNCMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0xFDEE130)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_UPDATEANIMATORDATA_OFFSET UNITYSDK_OFFSET(0xFDED6B0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_UPDATE_1_OFFSET UNITYSDK_OFFSET(0xFDEDC50)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xFDED5E0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFDEEC60)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAccessoryLegacyAnimator_TypeDefinitionIndex = 71006;

	class NPCAccessoryLegacyAnimator : public ::NPCCrowd::Animation::NPCAccessoryCPUAnimator
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Transform*>* bindedTransforms; // 0x10
		::NPCCrowd::Animation::NPCCPUNormalFKPass* FKPass; // 0x18
		::UnityEngine::Animator* unityAnimator; // 0x20
		::NPCCrowd::Accessories::NPCAccessoryAnimationAssetsSO* dataset; // 0x28
		::NPCCrowd::Animation::NPCCPUAnimationGraphScript_Core* coreGraph; // 0x30
		::NPCCrowd::Ability::FTransformFragment _attachedLocalPrs; // 0x38
		::NPCCrowd::Animation::FNPCAnimatorRuntimeInstanceAnimClipData animatorBufferData_Cur; // 0x68
		::System::Boolean bNeedForceSync; // 0x7C
		::System::Boolean bIsEnableUpdate; // 0x7D
		::System::Boolean bInited; // 0x7E
		::System::Boolean bWasVisible; // 0x7F
