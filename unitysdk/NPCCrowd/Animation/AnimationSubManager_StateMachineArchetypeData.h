...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_ADDADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x953AA90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_ADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x953A0E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_CHECKSHAREDSTATEDATA_OFFSET UNITYSDK_OFFSET(0x953B620)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_CLEARCOLLECTDATA_OFFSET UNITYSDK_OFFSET(0x953BBA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_COLLECT_OFFSET UNITYSDK_OFFSET(0x953BCB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x953BF50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_FINDORADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x9539ED0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x953B830)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDPARAMDATA_OFFSET UNITYSDK_OFFSET(0x953BA70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDSTATEDATA_OFFSET UNITYSDK_OFFSET(0x953B940)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x9539DE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_ISCHUNKVALID_OFFSET UNITYSDK_OFFSET(0x9539E40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9539CD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_SHAREDDATAVIEW_OFFSET UNITYSDK_OFFSET(0x953BEC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_SHAREDSTATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x953BE20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x953BD10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95390E0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_StateMachineArchetypeData_TypeDefinitionIndex = 88246;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_StateMachineArchetypeData_TypeDefinitionIndex)->GetStaticField(0x40FA0);
		}
		// static const ::System::Int32 ChunkSizeBit = 0x4; // 0x0
		// static const ::System::String* NormalizedTimeLayer; // 0x0
		::Il2CppArray<::Foundation::StateMachine::StateId>* DefaultState; // 0x10
		::Foundation::Adapter::ChunkList2D_1<::NPCCrowd::Animation::CPUStateMachine::SharedStateData>* _sharedStateData; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt64, ::System::Int32>* _sharedDataMap; // 0x20
		::Foundation::Adapter::ChunkList2D_1<::Foundation::StateMachine::Parameter>* _sharedParamData; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::StateMachine::ParameterId>* ParamLookupTable; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* StateLookupTable; // 0x38
		::NPCCrowd::Animation::AnimationControllerTemplateConfig* _templateConfig; // 0x40
		::Il2CppArray<::Foundation::Container::NativeVector_1<::System::IntPtr>>* _chunkData; // 0x48
		::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationControllerInstanceConfig*>* _instanceConfigs; // 0x50
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::CPUStateMachine::SharedData>* _sharedData; // 0x58
		::Foundation::Container::NativeVector_1<::System::Int32> _count; // 0x60
		::Foundation::Container::NativeVector_1<::Foundation::StateMachine::ParameterId> NormalizedTimeIds; // 0x70
		::Foundation::Container::NativeVector_1<::System::Int32> _dimensions; // 0x80
		::Foundation::StateMachine::Machine MachineData; // 0x90
