...
#define NPCCROWD_ANIMATION_EXPOSEBONEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x157B77A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int ExposeBoneInfo_TypeDefinitionIndex = 71547;
