...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_CONTAINS_OFFSET UNITYSDK_OFFSET(0x719A60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_GETBONEFLAGS_OFFSET UNITYSDK_OFFSET(0x719A50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x7198A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_RESET_OFFSET UNITYSDK_OFFSET(0x7198B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x11505090)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingControlData_TypeDefinitionIndex = 70474;
	...
	struct alignas(8) AnimationSubManager_AdjustmentBlendingControlData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AdjustmentBlendingControlData_TypeDefinitionIndex)->GetStaticField(0xB140);
		}
