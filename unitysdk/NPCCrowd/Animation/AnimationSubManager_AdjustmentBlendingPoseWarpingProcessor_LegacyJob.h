...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_CLEARCONTROLDATA_1_OFFSET UNITYSDK_OFFSET(0x5EEAD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_CLEARCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x5EEAC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0xE017C30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x5EE670)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_GETPOSE_OFFSET UNITYSDK_OFFSET(0x5EE760)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x5EE660)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x5EEAE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_SAMPLEPOSE_1_OFFSET UNITYSDK_OFFSET(0x5EE680)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_SAMPLEPOSE_OFFSET UNITYSDK_OFFSET(0xE01AC10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_SETBONEDATA_OFFSET UNITYSDK_OFFSET(0x5EE950)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x5EEA10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_WARPPOSE_OFFSET UNITYSDK_OFFSET(0x5EE870)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_LegacyJob_TypeDefinitionIndex = 57372;
