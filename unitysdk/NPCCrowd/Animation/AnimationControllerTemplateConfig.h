...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_CLEARSERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0xD416890)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_FETCHSTATEID_OFFSET UNITYSDK_OFFSET(0xD416910)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_ANIMCLIPS_OFFSET UNITYSDK_OFFSET(0xD416590)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREACURVE_OFFSET UNITYSDK_OFFSET(0xD416790)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREADERIVATIVECURVE_OFFSET UNITYSDK_OFFSET(0xD4167D0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREASECTIONCURVE_OFFSET UNITYSDK_OFFSET(0xD416810)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0xD416850)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_LEFTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0xD416710)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_RIGHTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0xD416750)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD416A10)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD416BD0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD416C30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerTemplateConfig_TypeDefinitionIndex = 52095;
