...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_CLEARSERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0xCD33190)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_FETCHSTATEID_OFFSET UNITYSDK_OFFSET(0xCD33210)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_ANIMCLIPS_OFFSET UNITYSDK_OFFSET(0xCD32E90)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREACURVE_OFFSET UNITYSDK_OFFSET(0xCD33090)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREADERIVATIVECURVE_OFFSET UNITYSDK_OFFSET(0xCD330D0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREASECTIONCURVE_OFFSET UNITYSDK_OFFSET(0xCD33110)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0xCD33150)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_LEFTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0xCD33010)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_RIGHTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0xCD33050)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCD33310)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD334D0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCD33530)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerTemplateConfig_TypeDefinitionIndex = 64126;
