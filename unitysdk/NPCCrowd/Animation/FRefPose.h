...
#define NPCCROWD_ANIMATION_FREFPOSE_GETGLOBALSPACETRANSFORM_OFFSET UNITYSDK_OFFSET(0x7496B0)
#define NPCCROWD_ANIMATION_FREFPOSE_GETGLOBALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x74A970)
#define NPCCROWD_ANIMATION_FREFPOSE_GETLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x749E60)
#define NPCCROWD_ANIMATION_FREFPOSE_GETMESHSPACETRANSFORM_OFFSET UNITYSDK_OFFSET(0x749050)
#define NPCCROWD_ANIMATION_FREFPOSE_GETMESHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x74A020)
#define NPCCROWD_ANIMATION_FREFPOSE_GETPARENT_OFFSET UNITYSDK_OFFSET(0x749CB0)
#define NPCCROWD_ANIMATION_FREFPOSE_GET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0x748D20)
#define NPCCROWD_ANIMATION_FREFPOSE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x748D00)
#define NPCCROWD_ANIMATION_FREFPOSE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x748D40)
#define NPCCROWD_ANIMATION_FREFPOSE_ISVALIDBONE_OFFSET UNITYSDK_OFFSET(0x749DE0)
#define NPCCROWD_ANIMATION_FREFPOSE_SETGLOBALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x74CA30)
#define NPCCROWD_ANIMATION_FREFPOSE_SETLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x74B8D0)
#define NPCCROWD_ANIMATION_FREFPOSE_SETMESHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x74BA20)
#define NPCCROWD_ANIMATION_FREFPOSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x748F00)
#define NPCCROWD_ANIMATION_FREFPOSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x749010)
#define NPCCROWD_ANIMATION_FREFPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x748E80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int FRefPose_TypeDefinitionIndex = 70526;
