...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x6340C0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISBOOL_OFFSET UNITYSDK_OFFSET(0x69E540)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x69E500)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISINTEGER_OFFSET UNITYSDK_OFFSET(0x69E520)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x634790)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x69E560)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWBOOLPARAM_OFFSET UNITYSDK_OFFSET(0x102B7100)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x102B70E0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWINTPARAM_OFFSET UNITYSDK_OFFSET(0x102B70F0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWTRIGGERPARAM_OFFSET UNITYSDK_OFFSET(0x102B7110)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x102B7120)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerParamIdentifier_TypeDefinitionIndex = 90055;
	...
	struct alignas(4) AnimatorControllerParamIdentifier
	{
		...
		{
			return (::NPCCrowd::Animation::AnimatorControllerParamIdentifier*)Il2CppClass::FromTypeDefinitionIndex(AnimatorControllerParamIdentifier_TypeDefinitionIndex)->GetStaticField(0xBE30);
		}
