...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FLUSHER_FOUNDATION_IINVOCABLEBYREF_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__INVOKE_OFFSET UNITYSDK_OFFSET(0x72F320)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FLUSHER_GET_SUCCEED_OFFSET UNITYSDK_OFFSET(0x72F1B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FLUSHER__CTOR_OFFSET UNITYSDK_OFFSET(0x72F1C0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_RequestAdjustmentBlendingByMotionProcessor_Job_Flusher_TypeDefinitionIndex = 70525;

	struct alignas(8) AnimationSubManager_RequestAdjustmentBlendingByMotionProcessor_Job_Flusher
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::NapTransformData, ::UnityEngine::NapTransformData, ::UnityEngine::NapTransformData, ::UnityEngine::NapTransformData, ::System::Single*, ::System::Single*, ::System::Int32, ::Unity::Collections::NativeArray_1<::System::Int32>, ::UnityEngine::NapTransformData*, ::System::Int32, ::System::Single))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FLUSHER__CTOR_OFFSET))(this, beginMeshTransform, endMeshTransform, beginGlobalTransform, endGlobalTransform, beginValues, endValues, capacity, skeleton, pose, loopCount, threshold);
		}
		*/

		::System::Boolean get_Succeed()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FLUSHER_GET_SUCCEED_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingWarpingPerBoneConfig&, ::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingPerBoneControlData&))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FLUSHER_FOUNDATION_IINVOCABLEBYREF_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__INVOKE_OFFSET))(this, config, result);
		}
		*/
	};
}
