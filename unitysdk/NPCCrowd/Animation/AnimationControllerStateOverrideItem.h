...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x1127D770)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_HASANIMATION_OFFSET UNITYSDK_OFFSET(0x1127D6E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x1127D7E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1127D830)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerStateOverrideItem_TypeDefinitionIndex = 86522;
