...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0xE8AE8B0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_HASANIMATION_OFFSET UNITYSDK_OFFSET(0xE8AE820)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0xE8AE920)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE8AE970)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerStateOverrideItem_TypeDefinitionIndex = 45985;
