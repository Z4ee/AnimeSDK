...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_ADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0xD4186F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_CLEARCOLLECTDATA_OFFSET UNITYSDK_OFFSET(0xD4345A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_COLLECT_OFFSET UNITYSDK_OFFSET(0xD434680)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD41A480)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_GETMONTAGESTARTIDX_OFFSET UNITYSDK_OFFSET(0xD418F60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_GETSHAREDDATA_OFFSET UNITYSDK_OFFSET(0xD4346E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0xD434540)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA_GET_SHAREDDATAVIEW_OFFSET UNITYSDK_OFFSET(0xD4344B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEARCHETYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD4182D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MontageArchetypeData_TypeDefinitionIndex = 57465;
	...
	public:
		...
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::MontageChunkData>* _sharedData; // 0x18
