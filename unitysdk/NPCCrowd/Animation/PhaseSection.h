...
#define NPCCROWD_ANIMATION_PHASESECTION_CALCULATELOSSFUNCTIONVALUE_OFFSET UNITYSDK_OFFSET(0x698630)
#define NPCCROWD_ANIMATION_PHASESECTION_CALCULATELOSSFUNCTION_OFFSET UNITYSDK_OFFSET(0x698430)
#define NPCCROWD_ANIMATION_PHASESECTION_COULDMATCHPHASE_OFFSET UNITYSDK_OFFSET(0xF85C3F0)
#define NPCCROWD_ANIMATION_PHASESECTION_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x6982B0)
#define NPCCROWD_ANIMATION_PHASESECTION_ENSURETIME01_OFFSET UNITYSDK_OFFSET(0xF85BCC0)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATEPHASE_OFFSET UNITYSDK_OFFSET(0x698340)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATETIME_OFFSET UNITYSDK_OFFSET(0x698390)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATE_OFFSET UNITYSDK_OFFSET(0x698170)
#define NPCCROWD_ANIMATION_PHASESECTION_GENERATELOSSFUNCTIONDERIVATIVEZEROEQUATION_OFFSET UNITYSDK_OFFSET(0x698500)
#define NPCCROWD_ANIMATION_PHASESECTION_GETZEROEQUATIONINPUTRANGE_OFFSET UNITYSDK_OFFSET(0x6984E0)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x698070)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x6980B0)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_ISZEROSECTION_OFFSET UNITYSDK_OFFSET(0x6983B0)
#define NPCCROWD_ANIMATION_PHASESECTION_ISSINGLEFOOT_OFFSET UNITYSDK_OFFSET(0xF85C3E0)
#define NPCCROWD_ANIMATION_PHASESECTION_MATCHZEROSECTION_OFFSET UNITYSDK_OFFSET(0x6983D0)
#define NPCCROWD_ANIMATION_PHASESECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x698400)
#define NPCCROWD_ANIMATION_PHASESECTION_SELECT_OFFSET UNITYSDK_OFFSET(0x6983A0)
#define NPCCROWD_ANIMATION_PHASESECTION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x698080)
#define NPCCROWD_ANIMATION_PHASESECTION_SET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x6980C0)
#define NPCCROWD_ANIMATION_PHASESECTION_SLICE_OFFSET UNITYSDK_OFFSET(0x698150)
#define NPCCROWD_ANIMATION_PHASESECTION_UPDATEBYLOSSFUNCTIONEXTREME_OFFSET UNITYSDK_OFFSET(0x698480)
#define NPCCROWD_ANIMATION_PHASESECTION_UPDATELOSSFUNCTIONRESULT_OFFSET UNITYSDK_OFFSET(0x698590)
#define NPCCROWD_ANIMATION_PHASESECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xF85E350)
#define NPCCROWD_ANIMATION_PHASESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x698120)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int PhaseSection_TypeDefinitionIndex = 40986;

	struct alignas(4) PhaseSection
	{
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_DecelerateDecreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10DE0);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_DecelerateIncreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10DF0);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_AccelerateIncreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10E00);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_AccelerateDecreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10E10);
		}
