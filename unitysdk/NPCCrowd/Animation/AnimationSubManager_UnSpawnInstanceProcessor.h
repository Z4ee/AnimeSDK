...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xE93C140)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0xE93C100)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xE93B9F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xE93B9E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0xE93BA50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xE93BAA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE93C1B0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_UnSpawnInstanceProcessor_TypeDefinitionIndex = 88259;

	class AnimationSubManager_UnSpawnInstanceProcessor : public ::NPCCrowd::Animation::AnimationSubManager_NoDispatchable
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _instanceIds; // 0x10
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _instanceIdSet; // 0x18
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::UInt32>*>* _cache; // 0x20
