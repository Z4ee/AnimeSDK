...
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_GET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x651C40)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x651C00)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_SET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x651C50)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x651C10)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int PhaseSectionFlag_TypeDefinitionIndex = 74902;
