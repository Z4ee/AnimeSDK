...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0xD0DD070)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_DISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0xD0DDD20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_ENABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0xD0DD340)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0xD0DD2D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0xD0DD280)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_GETMAINANIMCLIPSTATUES_OFFSET UNITYSDK_OFFSET(0xD0DC420)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_GETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0xD0DC4C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_INIT_OFFSET UNITYSDK_OFFSET(0xD0DCDA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_PLAY_OFFSET UNITYSDK_OFFSET(0xD0DBE00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0xD0DA860)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETBLENDANIMATION_OFFSET UNITYSDK_OFFSET(0xD0DC600)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETBLENDCLIPSPEED_OFFSET UNITYSDK_OFFSET(0xD0DCB30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETBLENDWEIGHT_OFFSET UNITYSDK_OFFSET(0xD0DD110)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xD0DDE00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0xD0DDD80)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMATIONMANUALLY_OFFSET UNITYSDK_OFFSET(0xD0DC100)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMCLIPSPEED_OFFSET UNITYSDK_OFFSET(0xD0DC2D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0xD0DBFB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMCLIP_OFFSET UNITYSDK_OFFSET(0xD0DBB40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINCLIPSPEED_OFFSET UNITYSDK_OFFSET(0xD0DBE60)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_STOPBLENDANIMATION1_OFFSET UNITYSDK_OFFSET(0xD0DCD20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0DD000)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0xD0DDE90)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DDE80)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0xD0DDED0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_OneState_TypeDefinitionIndex = 65943;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_OneState_TypeDefinitionIndex)->GetStaticField(0x35970);
		}
		...
		::UnityEngine::AvatarMask* _blendAvatarMask1; // 0x58
		::UnityEngine::AnimationClip* _blendClip2; // 0x60
		::UnityEngine::Animations::AnimationLayerMixerPlayable _mixerPlayable; // 0x68
		::UnityEngine::Animations::AnimationClipPlayable _blendClip1Playable; // 0x78
		::UnityEngine::Animations::AnimationClipPlayable _mainClipPlayable; // 0x88
		::NPCCrowd::Animation::Job::LookAtJob _lookAtJob; // 0x98
		::System::Boolean _isUsingBlendClip2; // 0x168
		::System::Boolean _bIsEnableLookAtIK; // 0x169
		::System::Boolean _isUsingBlendClip1; // 0x16A
		::UnityEngine::Animations::AnimationClipPlayable _blendClip2Playable; // 0x170
		::UnityEngine::Animations::AnimationScriptPlayable _lookAtPlayable; // 0x180
