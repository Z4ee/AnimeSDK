...
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA6907C0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA___C__DISPLAYCLASS38_0__GETSKINNEDMESHDATABYNAME_B__0_OFFSET UNITYSDK_OFFSET(0xA6907D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdAnimationData___c__DisplayClass38_0_TypeDefinitionIndex = 42882;
