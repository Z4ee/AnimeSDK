...
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_CLEARLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x11D960B0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_DESTROY_OFFSET UNITYSDK_OFFSET(0x11D961C0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_DISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x11D95CC0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_ENABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x11D955C0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_ENDLOOKATIKJOB_OFFSET UNITYSDK_OFFSET(0x11D95F70)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_INITIKJOBS_OFFSET UNITYSDK_OFFSET(0x11D94C00)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_INIT_OFFSET UNITYSDK_OFFSET(0x11D95900)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_INNERDISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x11D957B0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_ISRUNNINGLOOKATIK_OFFSET UNITYSDK_OFFSET(0x11D95E70)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_SETLOOKATTARGET_1_OFFSET UNITYSDK_OFFSET(0x11D96160)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x11D95880)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x11D95800)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_STARTLOOKATIKJOB_OFFSET UNITYSDK_OFFSET(0x11D95EC0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_UPDATE_OFFSET UNITYSDK_OFFSET(0x11D95B40)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x11D94610)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x11D96240)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPULookAtPass_TypeDefinitionIndex = 63203;

	class NPCCPULookAtPass : public ::NPCCrowd::Animation::NPCCPUJobPassBase
	{
	public:
		::UnityEngine::Transform* headBone; // 0x38
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* spineBones; // 0x40
		::UnityEngine::Animator* animator; // 0x48
		::NPCCrowd::Animation::NPCCPUAnimationLookAtIKInfo* IKInfo; // 0x50
		::NPCCrowd::Animation::NPCCPUAnimator_LookAtIKFadeJob lookAtIKAnimStateJob; // 0x58
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* eyeBones; // 0xE8
		::UnityEngine::Animations::AnimationScriptPlayable _lookAtPlayable; // 0xF0
		::System::Boolean _bIsEnableLookAtIK; // 0x100
		::System::Boolean bPendingDisableLookAtIK; // 0x101
		::System::Boolean bIsRunningLookAtIK; // 0x102
