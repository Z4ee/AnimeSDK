...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER_APPLYLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x5EEC20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER_FOUNDATION_IIN_OFFSET UNITYSDK_OFFSET(0x5EEC10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER__CTOR_OFFSET UNITYSDK_OFFSET(0x5EEAF0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_LegacyJob_Flusher_TypeDefinitionIndex = 57373;
