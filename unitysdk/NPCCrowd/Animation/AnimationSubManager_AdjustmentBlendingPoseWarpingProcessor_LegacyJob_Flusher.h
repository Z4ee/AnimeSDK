...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER_APPLYLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x5ECF80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER_FOUNDATION_IIN_OFFSET UNITYSDK_OFFSET(0x755F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER__CTOR_OFFSET UNITYSDK_OFFSET(0x5ECE80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_LegacyJob_Flusher_TypeDefinitionIndex = 88276;

	struct alignas(8) AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_LegacyJob_Flusher
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single*, ::System::Int32, ::Unity::Collections::NativeArray_1<::System::Int32>, ::UnityEngine::NapTransformData*, ::UnityEngine::NapTransformData, ::UnityEngine::NapTransformData, ::System::Int32))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER__CTOR_OFFSET))(this, buffer, capacity, skeleton, bones, loop, origin, loopCount);
		}
		*/
		...
		{
			return ((::System::Void(*)(::PVOID, ::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingWarpingPerBoneConfig&, ::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingPerBoneControlData&, ::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingWarpingPerBoneSampleData&))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_LEGACYJOB_FLUSHER_FOUNDATION_IIN_OFFSET))(this, config, controlData, sampleData);
		}
		*/
