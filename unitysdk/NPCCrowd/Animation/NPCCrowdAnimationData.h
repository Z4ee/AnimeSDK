...
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_BONESETPARENT_OFFSET UNITYSDK_OFFSET(0x12D28FA0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEBYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12D28BE0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEEXPORTINDEXBYBONEID_OFFSET UNITYSDK_OFFSET(0x12D28F00)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEINDEXBYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12D28EA0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETCLIPTEXTUREENTRY_OFFSET UNITYSDK_OFFSET(0x12D29110)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETCOMPATIBILITYSTATUS_OFFSET UNITYSDK_OFFSET(0x12D29360)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETFALLBACKTEXTURE_OFFSET UNITYSDK_OFFSET(0x12D292D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETPROTOTYPEKEY_OFFSET UNITYSDK_OFFSET(0x12D28560)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETSKINNEDMESHDATABYNAME_OFFSET UNITYSDK_OFFSET(0x12D29020)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GET_ANIMATIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x12D285A0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GET_BUSECLIPGRANULARLOADING_OFFSET UNITYSDK_OFFSET(0x12D28500)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GET_HASVALIDBAKEDDATA_OFFSET UNITYSDK_OFFSET(0x12D288C0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GET_ISANIMATIONTEXTURELOADED_OFFSET UNITYSDK_OFFSET(0x12D28920)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_HASCLIPTEXTURE_OFFSET UNITYSDK_OFFSET(0x12D291F0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x12D28A30)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12D28750)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdAnimationData_TypeDefinitionIndex = 76312;
