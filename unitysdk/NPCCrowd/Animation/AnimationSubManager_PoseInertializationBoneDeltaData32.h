...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTOROTATION_OFFSET UNITYSDK_OFFSET(0x631E80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTOSCALE_OFFSET UNITYSDK_OFFSET(0x632030)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTOTRANSLATION_OFFSET UNITYSDK_OFFSET(0x631D10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTO_OFFSET UNITYSDK_OFFSET(0x632290)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_EVALUATE_OFFSET UNITYSDK_OFFSET(0xEC83F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GENERATE_OFFSET UNITYSDK_OFFSET(0xEC840B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x58C050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_ROTATIONDURATION_OFFSET UNITYSDK_OFFSET(0x58C0F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_ROTATIONPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x631B60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x58C090)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_SCALEDURATION_OFFSET UNITYSDK_OFFSET(0x58C110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_SCALEPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x631C20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x58C010)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_TRANSLATIONDURATION_OFFSET UNITYSDK_OFFSET(0x58C0D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_TRANSLATIONPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x631AA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INITROTATION_OFFSET UNITYSDK_OFFSET(0x631CF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INITSCALE_OFFSET UNITYSDK_OFFSET(0x631D00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INITTRANSLATION_OFFSET UNITYSDK_OFFSET(0x631CE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INIT_OFFSET UNITYSDK_OFFSET(0x6321A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IPOSEINERTIALIZATIONBONEDELTADATA_INIT_OFFSET UNITYSDK_OFFSET(0x6327B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x58C070)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_ROTATIONDURATION_OFFSET UNITYSDK_OFFSET(0x58C100)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x58C0B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_SCALEDURATION_OFFSET UNITYSDK_OFFSET(0x58C120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x58C030)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_TRANSLATIONDURATION_OFFSET UNITYSDK_OFFSET(0x58C0E0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationBoneDeltaData32_TypeDefinitionIndex = 70484;
