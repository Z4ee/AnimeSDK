...
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x632B40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_END_OFFSET UNITYSDK_OFFSET(0x6329D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x632BC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_INIT_OFFSET UNITYSDK_OFFSET(0x632890)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISCREATED_OFFSET UNITYSDK_OFFSET(0x632A30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISEND_OFFSET UNITYSDK_OFFSET(0x6329E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETPOSTARGET_OFFSET UNITYSDK_OFFSET(0x632A90)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETTRANSFORMTARGET_OFFSET UNITYSDK_OFFSET(0x632A80)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_START_OFFSET UNITYSDK_OFFSET(0x632980)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEGRAPHTARGET_OFFSET UNITYSDK_OFFSET(0x632D10)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATELOCK_OFFSET UNITYSDK_OFFSET(0x632CF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x632D00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x632CE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x632CD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_OFFSET UNITYSDK_OFFSET(0x632CC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC8EC50)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex = 76435;

	struct alignas(8) NPCCPUAnimator_LookAtIKFadeJob
	{
		static ::System::Single* StaticGet__minLookAtWeight()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex)->GetStaticField(0xC7A0);
		}
