...
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x5EE2E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_END_OFFSET UNITYSDK_OFFSET(0x5EE170)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x5EE360)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_INIT_OFFSET UNITYSDK_OFFSET(0x5EE020)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISCREATED_OFFSET UNITYSDK_OFFSET(0x5EE1D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISEND_OFFSET UNITYSDK_OFFSET(0x5EE180)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETPOSTARGET_OFFSET UNITYSDK_OFFSET(0x5EE230)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETTRANSFORMTARGET_OFFSET UNITYSDK_OFFSET(0x5EE220)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_START_OFFSET UNITYSDK_OFFSET(0x5EE120)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEGRAPHTARGET_OFFSET UNITYSDK_OFFSET(0x5EE4B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATELOCK_OFFSET UNITYSDK_OFFSET(0x5EE490)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x5EE4A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x5EE480)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x5EE470)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_OFFSET UNITYSDK_OFFSET(0x5EE460)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB__CCTOR_OFFSET UNITYSDK_OFFSET(0xE57B960)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex = 65056;

	struct alignas(8) NPCCPUAnimator_LookAtIKFadeJob
	{
		static ::System::Single* StaticGet__minLookAtWeight()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex)->GetStaticField(0xD0B0);
		}
