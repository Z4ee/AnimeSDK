...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_PARALLELJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x48FE10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_PARALLELJOB_TRYRESOLVEDISPATCHINDEX_OFFSET UNITYSDK_OFFSET(0xA689D10)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MontageProcessor_ParallelJob_TypeDefinitionIndex = 57377;
	...
	struct alignas(4) AnimationSubManager_MontageProcessor_ParallelJob
	{
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationSubManager_MontageArchetypeData*>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_MontageProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0x3F960);
		}
