...
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD253FF0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD254480)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD2544E0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD254490)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD253FE0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0xD253FD0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAvatarTest__ICreateTestNPC_d__11_TypeDefinitionIndex = 40588;

	class NPCAvatarTest__ICreateTestNPC_d__11 : public ::System::Object
	{
	public:
		::MoleMole::Battle::Entity* _entity_5__2; // 0x10
		::Class_3_F2DAD7F45F518868* _selfnpc_5__3; // 0x18
		::System::Object* __2__current; // 0x20
		::NPCCrowd::Animation::NPCAvatarTest* __4__this; // 0x28
