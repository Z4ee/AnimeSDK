...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_CALCULATEFOOTTARGETFORPREDICT_OFFSET UNITYSDK_OFFSET(0x69DE20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_CALCULATEFOOTTARGETONSLOPE_OFFSET UNITYSDK_OFFSET(0x69DD80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x69DC90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_CALCULATEPELVISDELTA_OFFSET UNITYSDK_OFFSET(0x69E020)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_CHECKCURRENTFOOTSTEPSEGMENT_OFFSET UNITYSDK_OFFSET(0x69D7B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_DOFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x69D720)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_DOFOOTSTEPFORPREDICT_OFFSET UNITYSDK_OFFSET(0x69DB70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_DOFOOTSTEPIK_OFFSET UNITYSDK_OFFSET(0x69D810)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_DOFOOTSTEPONSLOPE_OFFSET UNITYSDK_OFFSET(0x69DA60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_DOFOOTSTEPONSTAIR_OFFSET UNITYSDK_OFFSET(0x69D8D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x69D710)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_GETFOOTPRINTSPAWNERTYPE_OFFSET UNITYSDK_OFFSET(0x69D7A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_GET__SETTING_OFFSET UNITYSDK_OFFSET(0x69D6F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_HIPHEIGHTLIFTINGDELTABYLIMITDIST_OFFSET UNITYSDK_OFFSET(0x102B5D20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_PELVISPD_OFFSET UNITYSDK_OFFSET(0x69DEC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_PRECALCULATEPELVISDELTA_OFFSET UNITYSDK_OFFSET(0x69DFB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_RESET_OFFSET UNITYSDK_OFFSET(0x69DC80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_SAMPLEPARABOLA_OFFSET UNITYSDK_OFFSET(0x69DED0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x69DF70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_PARALLELJOB_TRYRESOLVEDISPATCHINDEX_OFFSET UNITYSDK_OFFSET(0x102AB540)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepProcessor_ParallelJob_TypeDefinitionIndex = 88292;
	...
	struct alignas(8) AnimationSubManager_FootStepProcessor_ParallelJob
	{
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationSubManager_AvatarArchetypeData*>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0x33A20);
		}
		static ::System::Double* StaticGet_s_timestamp()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepProcessor_ParallelJob_TypeDefinitionIndex)->GetStaticField(0xBE20);
		}
