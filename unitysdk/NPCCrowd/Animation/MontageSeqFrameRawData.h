...
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_GETCLIPTYPE_OFFSET UNITYSDK_OFFSET(0x7E45A0)
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_GETDURATION_OFFSET UNITYSDK_OFFSET(0x7E4690)
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_GETEFFECTIVESPEEDSCALE_OFFSET UNITYSDK_OFFSET(0x7E46A0)
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_GETPLAYSTARTTIME_OFFSET UNITYSDK_OFFSET(0x7E4750)
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_GETTIMEDATA_OFFSET UNITYSDK_OFFSET(0x7E45F0)
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_ISLOOPENABLED_OFFSET UNITYSDK_OFFSET(0x7E4700)
#define NPCCROWD_ANIMATION_MONTAGESEQFRAMERAWDATA_ISVALIDCLIP_OFFSET UNITYSDK_OFFSET(0x7E4530)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int MontageSeqFrameRawData_TypeDefinitionIndex = 70699;
