...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_CREATEDAMPINGIKBUFFER_OFFSET UNITYSDK_OFFSET(0x106668A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x106660B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_DISABLEDAMPINGIK_OFFSET UNITYSDK_OFFSET(0x10666AF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_ENABLEDAMPINGIK_OFFSET UNITYSDK_OFFSET(0x10666300)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x106662B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_GETMAINANIMCLIPSTATUES_OFFSET UNITYSDK_OFFSET(0x10665DB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_GETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x10665C70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_INIT_OFFSET UNITYSDK_OFFSET(0x10665E50)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_PLAY_OFFSET UNITYSDK_OFFSET(0x106657E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0x10665190)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_RELEASEDAMPINGIKBUFFER_OFFSET UNITYSDK_OFFSET(0x10666150)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETDAMPINGROOTTRANS_OFFSET UNITYSDK_OFFSET(0x10666B50)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x10665AA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINANIMCLIP_OFFSET UNITYSDK_OFFSET(0x10665530)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x10665840)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_STOPMAINANIMATION_OFFSET UNITYSDK_OFFSET(0x10665990)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x10666D30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x10666D20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x10666D70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_SimpleOneState_TypeDefinitionIndex = 50985;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_SimpleOneState_TypeDefinitionIndex)->GetStaticField(0x49540);
		}
		::UnityEngine::AnimationClip* clip; // 0x40
		::UnityEngine::Animations::AnimationScriptPlayable dampingPlayable; // 0x48
		::Unity::Collections::NativeArray_1<::UnityEngine::Animations::TransformStreamHandle> damping_Handles; // 0x58
		::Unity::Collections::NativeArray_1<::UnityEngine::Quaternion> damping_LocalRotations; // 0x68
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_LocalPositions; // 0x78
		::System::Boolean bIsEnableDampingIK; // 0x88
		::Unity::Collections::NativeArray_1<::System::Single> damping_smooths; // 0x90
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_Positions; // 0xA0
		::NPCCrowd::Animation::Job::DampingJob dampingJob; // 0xB0
		::UnityEngine::Animations::AnimationClipPlayable mainClipPlayable; // 0x138
		::Unity::Collections::NativeArray_1<::System::Single> damping_rootParams; // 0x148
