...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETCURRENTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A10B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETFOOTGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x5A0F40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETFOOTHEIGHT_OFFSET UNITYSDK_OFFSET(0x5A0EC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETGROUNDEDSTATE_OFFSET UNITYSDK_OFFSET(0x5A11F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETHITHEIGHT_OFFSET UNITYSDK_OFFSET(0x5A1000)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x5A0FC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETISGROUNDEDFORFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A1270)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETNEXTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A1180)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETPREDICTENABLE_OFFSET UNITYSDK_OFFSET(0x5A1240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETPREDICTTARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x5A1120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GET_TARGETENABLE_OFFSET UNITYSDK_OFFSET(0x2E7930)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETCURRENTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A1080)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETFOOTGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x5A0F90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETFOOTHEIGHT_OFFSET UNITYSDK_OFFSET(0x5A0F20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETGROUNDEDSTATE_OFFSET UNITYSDK_OFFSET(0x5A11D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETHITHEIGHT_OFFSET UNITYSDK_OFFSET(0x5A1020)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x5A0FE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETISGROUNDEDFORFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A12E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETNEXTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A1150)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETPREDICTENABLE_OFFSET UNITYSDK_OFFSET(0x5A1220)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETPREDICTTARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x5A1100)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SET_TARGETENABLE_OFFSET UNITYSDK_OFFSET(0x5A0E70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_UPDATEFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x5A1040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD44B8A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepControlData_TypeDefinitionIndex = 70462;

	struct alignas(4) AnimationSubManager_FootStepControlData
	{
		static ::UnityEngine::NapTransformData* StaticGet_DummyTransform()
		{
			return (::UnityEngine::NapTransformData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepControlData_TypeDefinitionIndex)->GetStaticField(0xB540);
		}
		static ::NPCCrowd::Animation::AnimationSubManager_FootStepControlData* StaticGet_Default()
		{
			return (::NPCCrowd::Animation::AnimationSubManager_FootStepControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepControlData_TypeDefinitionIndex)->GetStaticField(0xB570);
		}
