...
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_BUILDSPAWNLIST_OFFSET UNITYSDK_OFFSET(0x117A5A20)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_CLEARSPAWNEDGROUPS_OFFSET UNITYSDK_OFFSET(0x117A5720)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_CLOSESHADOW_OFFSET UNITYSDK_OFFSET(0x117A6740)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_DESTROYSPAWNEDOBJECT_OFFSET UNITYSDK_OFFSET(0x117A60E0)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_ENSURESPAWNROOT_OFFSET UNITYSDK_OFFSET(0x117A5D80)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_INSTANTIATEGROUPPREFAB_OFFSET UNITYSDK_OFFSET(0x117A5FA0)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_ONGUI_OFFSET UNITYSDK_OFFSET(0x117A62C0)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_REFRESHSUMMARY_OFFSET UNITYSDK_OFFSET(0x117A4B10)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_RESPAWNCROWDGROUPS_OFFSET UNITYSDK_OFFSET(0x117A3D60)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_START_OFFSET UNITYSDK_OFFSET(0x117A3D10)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x117A4A80)
#define NPCCROWD_GPUPREFAB_GPUPREFABCROWDBENCHMARKBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x117A6850)

namespace NPCCrowd::GPUPrefab
{
	inline static constexpr unsigned int GPUPrefabCrowdBenchmarkBehavior_TypeDefinitionIndex = 42788;
