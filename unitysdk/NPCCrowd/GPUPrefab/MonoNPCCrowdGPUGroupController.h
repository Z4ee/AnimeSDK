...
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYALLINSTANCEPROPSTORENDERERS_OFFSET UNITYSDK_OFFSET(0x11947C30)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYALLINSTANCEPROPSTORENDERER_OFFSET UNITYSDK_OFFSET(0x11947DF0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYALPHATOLOD_OFFSET UNITYSDK_OFFSET(0x11948D40)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYALPHATORENDERER_OFFSET UNITYSDK_OFFSET(0x11948EB0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYANIMPARAMSVIARENDERERMPB_OFFSET UNITYSDK_OFFSET(0x11946640)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYDITHERMATSTORENDERER_OFFSET UNITYSDK_OFFSET(0x11948F10)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYDITHERTORENDERERS_OFFSET UNITYSDK_OFFSET(0x11947A80)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYLODSTATE_OFFSET UNITYSDK_OFFSET(0x119464B0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_APPLYNORMALMATSTORENDERER_OFFSET UNITYSDK_OFFSET(0x11949260)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_BEGINTRANSITION_OFFSET UNITYSDK_OFFSET(0x11948690)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_CONFIGUREGPUCROWDSHADERPASSES_OFFSET UNITYSDK_OFFSET(0x11946360)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_CONFIGUREMATSFORGPUCROWD_OFFSET UNITYSDK_OFFSET(0x119469F0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_EVALUATETARGETLOD_OFFSET UNITYSDK_OFFSET(0x119475D0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_FINISHTRANSITION_OFFSET UNITYSDK_OFFSET(0x11948590)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_GETRENDERERMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x11947D90)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x11945EF0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_INITMATERIALANIMPARAMS_OFFSET UNITYSDK_OFFSET(0x11946240)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x11946C50)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_MAPTOGPULODSTATE_OFFSET UNITYSDK_OFFSET(0x11948540)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x119461E0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11945E80)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_SETLODGOACTIVE_OFFSET UNITYSDK_OFFSET(0x11948800)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_SWITCHTODITHERMATERIALS_OFFSET UNITYSDK_OFFSET(0x11948AE0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_SWITCHTONORMALMATERIALS_OFFSET UNITYSDK_OFFSET(0x11948C10)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_UPDATECAMERADITHER_OFFSET UNITYSDK_OFFSET(0x11947830)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_UPDATECROSSFADE_OFFSET UNITYSDK_OFFSET(0x11947790)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_UPDATELODTARGET_OFFSET UNITYSDK_OFFSET(0x119476D0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER_UPDATEPREVIOUSMATRIX_OFFSET UNITYSDK_OFFSET(0x119474F0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x119495C0)
#define NPCCROWD_GPUPREFAB_MONONPCCROWDGPUGROUPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11949570)

namespace NPCCrowd::GPUPrefab
{
	inline static constexpr unsigned int MonoNPCCrowdGPUGroupController_TypeDefinitionIndex = 56496;
	...
	public:
		...
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(MonoNPCCrowdGPUGroupController_TypeDefinitionIndex)->GetStaticField(0x45690);
		}
		static ::System::Int32* StaticGet_SHADERID_USE_CLIP_GRANULAR()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoNPCCrowdGPUGroupController_TypeDefinitionIndex)->GetStaticField(0x101F0);
		}
		static ::System::Int32* StaticGet_SHADERID_PREV_MATRIX_ROW1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoNPCCrowdGPUGroupController_TypeDefinitionIndex)->GetStaticField(0x101F4);
		}
		static ::System::Int32* StaticGet_SHADERID_PREV_MATRIX_ROW2()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoNPCCrowdGPUGroupController_TypeDefinitionIndex)->GetStaticField(0x101F8);
		}
		static ::System::Int32* StaticGet_SHADERID_DITHER_ALPHA()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoNPCCrowdGPUGroupController_TypeDefinitionIndex)->GetStaticField(0x101FC);
		}
		static ::System::Int32* StaticGet_SHADERID_PREV_MATRIX_ROW0()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoNPCCrowdGPUGroupController_TypeDefinitionIndex)->GetStaticField(0x10200);
		}
