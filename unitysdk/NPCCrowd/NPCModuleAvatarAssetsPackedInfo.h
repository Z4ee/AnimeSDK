...
#define NPCCROWD_NPCMODULEAVATARASSETSPACKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xF6161D0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCModuleAvatarAssetsPackedInfo_TypeDefinitionIndex = 80557;
