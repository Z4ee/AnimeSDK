...
#define NPCCROWD_NPCMATHF_ARRIVALSPEEDENVELOPE_OFFSET UNITYSDK_OFFSET(0x13A08ED0)
#define NPCCROWD_NPCMATHF_CALCDIRECTIONALSPEEDSCALE_OFFSET UNITYSDK_OFFSET(0x13A08F40)
#define NPCCROWD_NPCMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x13A08460)
#define NPCCROWD_NPCMATHF_DISTANCE_OFFSET UNITYSDK_OFFSET(0x13A08330)
#define NPCCROWD_NPCMATHF_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0x13A083C0)
#define NPCCROWD_NPCMATHF_EXPONENTIALSMOOTHINGANGLE_OFFSET UNITYSDK_OFFSET(0x13A07E60)
#define NPCCROWD_NPCMATHF_FMOD_OFFSET UNITYSDK_OFFSET(0x13A08040)
#define NPCCROWD_NPCMATHF_FRAC_OFFSET UNITYSDK_OFFSET(0x13A07FE0)
#define NPCCROWD_NPCMATHF_FRANDINT_OFFSET UNITYSDK_OFFSET(0x13A08D10)
#define NPCCROWD_NPCMATHF_FRAND_OFFSET UNITYSDK_OFFSET(0x13A08B20)
#define NPCCROWD_NPCMATHF_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0x13A088E0)
#define NPCCROWD_NPCMATHF_GETBOOL3_OFFSET UNITYSDK_OFFSET(0x13A092B0)
#define NPCCROWD_NPCMATHF_GETYAWFROMDIRECTION_OFFSET UNITYSDK_OFFSET(0x13A082B0)
#define NPCCROWD_NPCMATHF_INVEXPAPPROX_OFFSET UNITYSDK_OFFSET(0x13A07DD0)
#define NPCCROWD_NPCMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x13A081E0)
#define NPCCROWD_NPCMATHF_MAKEBOOL3_OFFSET UNITYSDK_OFFSET(0x13A09250)
#define NPCCROWD_NPCMATHF_MULTI_OFFSET UNITYSDK_OFFSET(0x13A07D20)
#define NPCCROWD_NPCMATHF_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x13A08C90)
#define NPCCROWD_NPCMATHF_RANDRANGE_2_OFFSET UNITYSDK_OFFSET(0x13A08DB0)
#define NPCCROWD_NPCMATHF_RANDRANGE_3_OFFSET UNITYSDK_OFFSET(0x13A08E60)
#define NPCCROWD_NPCMATHF_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x13A08BC0)
#define NPCCROWD_NPCMATHF_SQUARE_OFFSET UNITYSDK_OFFSET(0x13A08A80)
#define NPCCROWD_NPCMATHF_UPZERO_OFFSET UNITYSDK_OFFSET(0x13A08AD0)
#define NPCCROWD_NPCMATHF_VECTORDAMPERSPRINTCRITICAL_OFFSET UNITYSDK_OFFSET(0x13A08580)
#define NPCCROWD_NPCMATHF_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x13A080B0)
#define NPCCROWD_NPCMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x13A09320)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathf_TypeDefinitionIndex = 42052;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCMathf_TypeDefinitionIndex)->GetStaticField(0xBD90);
		}
