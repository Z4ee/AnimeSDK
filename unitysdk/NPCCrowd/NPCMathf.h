...
#define NPCCROWD_NPCMATHF_ARRIVALSPEEDENVELOPE_OFFSET UNITYSDK_OFFSET(0xF888DE0)
#define NPCCROWD_NPCMATHF_CALCDIRECTIONALSPEEDSCALE_OFFSET UNITYSDK_OFFSET(0xF888E50)
#define NPCCROWD_NPCMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0xF888380)
#define NPCCROWD_NPCMATHF_DISTANCE_OFFSET UNITYSDK_OFFSET(0xF888260)
#define NPCCROWD_NPCMATHF_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0xF8882E0)
#define NPCCROWD_NPCMATHF_EXPONENTIALSMOOTHINGANGLE_OFFSET UNITYSDK_OFFSET(0xF887D80)
#define NPCCROWD_NPCMATHF_FMOD_OFFSET UNITYSDK_OFFSET(0xF887F70)
#define NPCCROWD_NPCMATHF_FRAC_OFFSET UNITYSDK_OFFSET(0xF887F10)
#define NPCCROWD_NPCMATHF_FRANDINT_OFFSET UNITYSDK_OFFSET(0xF888C20)
#define NPCCROWD_NPCMATHF_FRAND_OFFSET UNITYSDK_OFFSET(0xF888A30)
#define NPCCROWD_NPCMATHF_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0xF8887F0)
#define NPCCROWD_NPCMATHF_GETBOOL3_OFFSET UNITYSDK_OFFSET(0xF8891B0)
#define NPCCROWD_NPCMATHF_GETYAWFROMDIRECTION_OFFSET UNITYSDK_OFFSET(0xF8881E0)
#define NPCCROWD_NPCMATHF_INVEXPAPPROX_OFFSET UNITYSDK_OFFSET(0xF887CF0)
#define NPCCROWD_NPCMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0xF888110)
#define NPCCROWD_NPCMATHF_MAKEBOOL3_OFFSET UNITYSDK_OFFSET(0xF889150)
#define NPCCROWD_NPCMATHF_MULTI_OFFSET UNITYSDK_OFFSET(0xF887C40)
#define NPCCROWD_NPCMATHF_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0xF888BA0)
#define NPCCROWD_NPCMATHF_RANDRANGE_2_OFFSET UNITYSDK_OFFSET(0xF888CC0)
#define NPCCROWD_NPCMATHF_RANDRANGE_3_OFFSET UNITYSDK_OFFSET(0xF888D70)
#define NPCCROWD_NPCMATHF_RANDRANGE_OFFSET UNITYSDK_OFFSET(0xF888AD0)
#define NPCCROWD_NPCMATHF_SQUARE_OFFSET UNITYSDK_OFFSET(0xF888990)
#define NPCCROWD_NPCMATHF_UPZERO_OFFSET UNITYSDK_OFFSET(0xF8889E0)
#define NPCCROWD_NPCMATHF_VECTORDAMPERSPRINTCRITICAL_OFFSET UNITYSDK_OFFSET(0xF8884A0)
#define NPCCROWD_NPCMATHF_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0xF887FE0)
#define NPCCROWD_NPCMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0xF889220)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathf_TypeDefinitionIndex = 72440;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCMathf_TypeDefinitionIndex)->GetStaticField(0xC340);
		}
