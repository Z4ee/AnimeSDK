...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARPARTSANDACCESSORIESASYNC_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6691F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARPARTSANDACCESSORIESASYNC_D__19_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__CreateAvatarPartsAndAccessoriesAsync_d__19_TypeDefinitionIndex = 60730;

	struct alignas(8) NPCCrowdAvatarManager__CreateAvatarPartsAndAccessoriesAsync_d__19
	{
		::NPCCrowd::Avatar::NPCAvatarGOReference* goRef; // 0x10
		...
		::Il2CppArray<::FNpcAvatarGenericParams_PartInfo*>* partInfos; // 0x38
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::ValueTuple_2<::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>*, ::System::Collections::Generic::List_1<::NPCCrowd::Accessories::NPCAccessory*>*>> __u__1; // 0x50
		::System::Threading::CancellationToken cancellationToken; // 0x70
		::NPCAvatarMeshAssetsSO* assetSo; // 0x78
