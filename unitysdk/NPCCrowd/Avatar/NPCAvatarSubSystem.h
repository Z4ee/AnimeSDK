...
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ADDAUDIOJOBDATA_OFFSET UNITYSDK_OFFSET(0x10C9C190)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_CACHEANDDISPATCHAUDIOJOB_OFFSET UNITYSDK_OFFSET(0x10C9C6C0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_COMPLETEAUDIOJOB_OFFSET UNITYSDK_OFFSET(0x10C9CBF0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x10C9D740)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_DELAYADDAUDIOENTITY_OFFSET UNITYSDK_OFFSET(0x10C9BED0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_DELAYREMOVEAUDIOENTITY_OFFSET UNITYSDK_OFFSET(0x10C9BF40)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_FLUSHAUDIODATACHANGE_OFFSET UNITYSDK_OFFSET(0x10C9BFB0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_FLUSHAUDIOMAINTHREADWORK_OFFSET UNITYSDK_OFFSET(0x10C9CC50)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_GET_INS_OFFSET UNITYSDK_OFFSET(0x10C9B9C0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x10C9E3B0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITANIMATION_OFFSET UNITYSDK_OFFSET(0x10C9E690)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITAUDIOJOB_OFFSET UNITYSDK_OFFSET(0x10C9B9E0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITAUDIO_OFFSET UNITYSDK_OFFSET(0x10C9E4F0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITLOOKATIK_OFFSET UNITYSDK_OFFSET(0x10C9FFC0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INIT_OFFSET UNITYSDK_OFFSET(0x10C9D460)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_NPCAUDIOUPDATETHREADSAFE_OFFSET UNITYSDK_OFFSET(0x10C9D0F0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONBIGSCENEFLOORCHANGE_OFFSET UNITYSDK_OFFSET(0x10CA1ED0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10CA1A40)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONENTITYADD_OFFSET UNITYSDK_OFFSET(0x10C9D930)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x10C9EEE0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x10CA04D0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONMAINCITYTIMESYNCED_OFFSET UNITYSDK_OFFSET(0x10CA1D00)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_POSTUPDATE_OFFSET UNITYSDK_OFFSET(0x10CA19C0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_REFRESHALLNPCTIMEPERIODTAGS_OFFSET UNITYSDK_OFFSET(0x10CA1DB0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_RELEASEAUDIOJOB_OFFSET UNITYSDK_OFFSET(0x10C9BB50)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_RELEASEAUDIO_OFFSET UNITYSDK_OFFSET(0x10CA0C70)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_REMOVEAUDIOJOBDATA_OFFSET UNITYSDK_OFFSET(0x10C9C540)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_SET_INS_OFFSET UNITYSDK_OFFSET(0x10C9B9D0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_UPDATEAUDIO_OFFSET UNITYSDK_OFFSET(0x10CA24C0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_UPDATEDITHERSTATE_OFFSET UNITYSDK_OFFSET(0x10CA21A0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x10CA1830)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x10CA2C40)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x10CA2C30)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM__INITANIMATION_G__PLAYANIMATION_41_0_OFFSET UNITYSDK_OFFSET(0x10CA1F80)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x10CA2C50)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x10CA2C60)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10CA2CF0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_POSTUPDATE_OFFSET UNITYSDK_OFFSET(0x10CA2D80)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x10CA2E20)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarSubSystem_TypeDefinitionIndex = 58537;
	...
	public:
		...
		{
			return (::NPCCrowd::NPCIDGeneratorInt**)Il2CppClass::FromTypeDefinitionIndex(NPCAvatarSubSystem_TypeDefinitionIndex)->GetStaticField(0x413A0);
		}
		static ::NPCCrowd::Avatar::NPCAvatarSubSystem** StaticGet__Ins_k__BackingField()
		{
			return (::NPCCrowd::Avatar::NPCAvatarSubSystem**)Il2CppClass::FromTypeDefinitionIndex(NPCAvatarSubSystem_TypeDefinitionIndex)->GetStaticField(0x413A8);
		}
		static ::System::Boolean* StaticGet_EnableAudioJob()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NPCAvatarSubSystem_TypeDefinitionIndex)->GetStaticField(0xF320);
		}
		::Unity::Collections::ManagedBlockQueue_1<::NPCCrowd::Avatar::DelayNpcAudioRtpcEvent>* _delayAudioRtpcQueue; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* _audioEntityIndexMap; // 0x28
		::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NpcAudioJobData*>* _audioJobData; // 0x30
		::System::Collections::Generic::List_1<::Struct_2_92DA5310F390EF4D<::System::UInt32>>* _audioDelayOptEntities; // 0x38
		::Unity::Collections::ManagedBlockQueue_1<::NPCCrowd::Avatar::DelayNpcAudioTriggerEvent>* _delayAudioTriggerQueue; // 0x40
		::Unity::Jobs::JobHandle _audioJobHandle; // 0x48
		::ProtoScript::TimePeriodType _lastRefreshPeriod; // 0x58
		::System::Boolean _needFlushMainThreadWork; // 0x5C
		::System::Boolean _hasLastRefreshPeriod; // 0x5D
		::System::Boolean _audioNeedRefresh; // 0x5E
		::NPCCrowd::Avatar::NPCAvatarSubSystem_NPCAudioUpdateJob _audioUpdateJob; // 0x60
		...
		static ::System::Boolean InitLookAtIK(::Class_3_707412604A129938* baseDataComp, ::Class_3_F2DAD7F45F518868* npcComp, ::Class_3_430D60B7258267AD* voComp)
		{
			return ((::System::Boolean(*)(::Class_3_707412604A129938*, ::Class_3_F2DAD7F45F518868*, ::Class_3_430D60B7258267AD*))((::PBYTE)hIl2Cpp + NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITLOOKATIK_OFFSET))(baseDataComp, npcComp, voComp);
		}
