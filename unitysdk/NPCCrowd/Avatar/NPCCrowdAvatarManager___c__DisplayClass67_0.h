...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0xF06E230)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS67_0__INITACCESSORYMDBCOMPONENT_B__0_OFFSET UNITYSDK_OFFSET(0xF06E240)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS67_0__INITACCESSORYMDBCOMPONENT_G__GETMDBSTATE_1_OFFSET UNITYSDK_OFFSET(0xF06E250)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager___c__DisplayClass67_0_TypeDefinitionIndex = 58953;
