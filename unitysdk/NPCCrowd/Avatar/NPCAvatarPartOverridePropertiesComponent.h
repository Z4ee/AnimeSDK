...
#define NPCCROWD_AVATAR_NPCAVATARPARTOVERRIDEPROPERTIESCOMPONENT_APPLYAVATARPARTOVERRIDEPROP_OFFSET UNITYSDK_OFFSET(0xF8840C0)
#define NPCCROWD_AVATAR_NPCAVATARPARTOVERRIDEPROPERTIESCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF884070)
#define NPCCROWD_AVATAR_NPCAVATARPARTOVERRIDEPROPERTIESCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF884340)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarPartOverridePropertiesComponent_TypeDefinitionIndex = 80065;
