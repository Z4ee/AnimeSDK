...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS71_0__CTOR_OFFSET UNITYSDK_OFFSET(0x102BDC50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS71_0__INITACCESSORYMDBPOSE_B__0_OFFSET UNITYSDK_OFFSET(0x102BDC60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS71_0__INITACCESSORYMDBPOSE_B__1_OFFSET UNITYSDK_OFFSET(0x102BDC80)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager___c__DisplayClass71_0_TypeDefinitionIndex = 66890;
