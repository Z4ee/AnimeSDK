...
#define NPCCROWD_AVATAR_NPCAUDIOJOBDATA_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x11945BF0)
#define NPCCROWD_AVATAR_NPCAUDIOJOBDATA_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x11945C80)
#define NPCCROWD_AVATAR_NPCAUDIOJOBDATA_RESET_OFFSET UNITYSDK_OFFSET(0x11945E00)
#define NPCCROWD_AVATAR_NPCAUDIOJOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x11945E60)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NpcAudioJobData_TypeDefinitionIndex = 71577;
	...
	public:
		...
		::System::Single TriggerDistanceSqr; // 0x40
		::System::Single TriggerCooldown; // 0x44
		::UnityEngine::Vector3 Velocity; // 0x48
		::System::Boolean Enabled; // 0x54
		::System::Boolean ShouldTriggerAudio; // 0x55
		::System::Boolean AudioEnableTrigger; // 0x56
		::System::Single AudioLastTriggerTime; // 0x58
