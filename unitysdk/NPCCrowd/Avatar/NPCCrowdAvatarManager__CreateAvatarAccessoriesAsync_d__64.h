...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARACCESSORIESASYNC_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x5EE4C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARACCESSORIESASYNC_D__64_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__CreateAvatarAccessoriesAsync_d__64_TypeDefinitionIndex = 60732;
	...
	struct alignas(8) NPCCrowdAvatarManager__CreateAvatarAccessoriesAsync_d__64
	{
		...
		::System::Collections::Generic::List_1<::NPCCrowd::Accessories::NPCAccessory*>* _accessories_5__2; // 0x40
