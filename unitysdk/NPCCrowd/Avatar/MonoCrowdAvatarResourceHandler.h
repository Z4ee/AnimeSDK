...
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x9542F70)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9542DB0)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_SETPARTSANDACCESSORIES_OFFSET UNITYSDK_OFFSET(0x9542D50)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9542F80)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int MonoCrowdAvatarResourceHandler_TypeDefinitionIndex = 49346;
