...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARBODYPARTSASYNC_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x5CC890)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARBODYPARTSASYNC_D__41_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__CreateAvatarBodyPartsAsync_d__41_TypeDefinitionIndex = 66883;

	struct alignas(8) NPCCrowdAvatarManager__CreateAvatarBodyPartsAsync_d__41
	{
		::System::Threading::CancellationToken cancellationToken; // 0x10
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder_1<::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>*> __t__builder; // 0x18
		::NPCCrowd::Avatar::NPCCrowdAvatarManager* __4__this; // 0x30
		::UnityEngine::GameObject* avatarGo; // 0x38
		::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>* _allPartsGo_5__2; // 0x40
		::Il2CppArray<::FNpcAvatarGenericParams_PartInfo*>* partInfos; // 0x48
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x50
		::NPCAvatarMeshAssetsSO* assetSo; // 0x60
		::NPCCrowd::Animation::NPCCrowdAnimator* gpuAnimator; // 0x68
