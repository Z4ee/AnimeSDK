...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_BEFOREAVATARFADEOUT_OFFSET UNITYSDK_OFFSET(0x12736A50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_BINDBONESLOTSGALGAME_OFFSET UNITYSDK_OFFSET(0x1273E740)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARACCESSORIESASYNC_OFFSET UNITYSDK_OFFSET(0x127454B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARBODYPARTSASYNC_OFFSET UNITYSDK_OFFSET(0x12743EB0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARGO_1_OFFSET UNITYSDK_OFFSET(0x12738F50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARGO_OFFSET UNITYSDK_OFFSET(0x12738B80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_1_OFFSET UNITYSDK_OFFSET(0x1273A920)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_2_OFFSET UNITYSDK_OFFSET(0x1273AA70)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_OFFSET UNITYSDK_OFFSET(0x1273A5D0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESGALGAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1273E5C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATAR_OFFSET UNITYSDK_OFFSET(0x127380B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARANIMATOR_OFFSET UNITYSDK_OFFSET(0x1273A3A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARCOLLIDER_OFFSET UNITYSDK_OFFSET(0x12739170)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARGOGALGAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1273DF70)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x12744DA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOCLIPSHAPEMANAGER_OFFSET UNITYSDK_OFFSET(0x12739F00)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOEMOSYNC_OFFSET UNITYSDK_OFFSET(0x1273A1C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOEYEKEY_OFFSET UNITYSDK_OFFSET(0x12739D60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOFEATUREPOINT_OFFSET UNITYSDK_OFFSET(0x12739830)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOINTERACTPOINT_OFFSET UNITYSDK_OFFSET(0x12739A60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOITEMSTATE_OFFSET UNITYSDK_OFFSET(0x12739C90)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARNAVMESHOBSTACLE_OFFSET UNITYSDK_OFFSET(0x12739670)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_ENABLEIKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x127404F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GETAVATARSHAREDGPUMATERIALS_OFFSET UNITYSDK_OFFSET(0x12744A40)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GETAVATARSHAREDGPUMATERIAL_OFFSET UNITYSDK_OFFSET(0x1273C3B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x127349E0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GPUMATPARAMPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1273C870)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYANIMATORCULLINGMODEASYNC_OFFSET UNITYSDK_OFFSET(0x1273DCA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYANIMATOR_OFFSET UNITYSDK_OFFSET(0x1273CCE0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYDEVICENUMBERPLATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1273D930)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYMDBCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1273D000)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYMDBPOSE_OFFSET UNITYSDK_OFFSET(0x12746020)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1273D6D0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITCPUMATERIALCOLORS_OFFSET UNITYSDK_OFFSET(0x127331F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITGPUMATERIALCOLORS_OFFSET UNITYSDK_OFFSET(0x12745090)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITGPUMATERIALS_OFFSET UNITYSDK_OFFSET(0x12744EC0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITLOGICTAGS_OFFSET UNITYSDK_OFFSET(0x1273DD10)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x12737590)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12737F50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_PLAYMDBREFERENCEPOSECLIP_OFFSET UNITYSDK_OFFSET(0x12746300)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARACCESSORYGALGAME_OFFSET UNITYSDK_OFFSET(0x127411A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARACCESSORY_OFFSET UNITYSDK_OFFSET(0x1273CA80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARGOGALGAME_OFFSET UNITYSDK_OFFSET(0x1273EF80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARGO_OFFSET UNITYSDK_OFFSET(0x1273AC60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RANDOMSPAWNNPCFROMLIB_OFFSET UNITYSDK_OFFSET(0x12738850)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARPARTS_OFFSET UNITYSDK_OFFSET(0x12741700)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARROOTCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x12743410)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARSHADOWPROXY_OFFSET UNITYSDK_OFFSET(0x12742950)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARSIMPLEMODEL_OFFSET UNITYSDK_OFFSET(0x12742460)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATAR_OFFSET UNITYSDK_OFFSET(0x12734B60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASENPCFORRANDOMLIB_OFFSET UNITYSDK_OFFSET(0x12743D00)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPACCESSORYSIMPLERENDERER_OFFSET UNITYSDK_OFFSET(0x12745940)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOFBXASYNC_OFFSET UNITYSDK_OFFSET(0x127455F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOMATERIALASYNC_OFFSET UNITYSDK_OFFSET(0x12745750)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOMATERIALFORDEVICENUMBERPLATE_OFFSET UNITYSDK_OFFSET(0x12745E70)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARPARTINFOASYNC_OFFSET UNITYSDK_OFFSET(0x12744040)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPCPUPARTINFO_OFFSET UNITYSDK_OFFSET(0x127441A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPGPUPARTINFO_OFFSET UNITYSDK_OFFSET(0x12744810)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPNPCAVATARLOD0MESH_OFFSET UNITYSDK_OFFSET(0x1273FD80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_UPDATENPCAVATARANIMATORFORGALGAME_OFFSET UNITYSDK_OFFSET(0x12744C00)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x127464C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x127464B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPCPUPARTINFO_G__GETPARTBOUNDINGBOXBYPARTTYPE_43_0_OFFSET UNITYSDK_OFFSET(0x127446E0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x12746630)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x127466C0)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager_TypeDefinitionIndex = 66879;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x34FC0);
		}
		static ::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>** StaticGet_AvatarPartAsyncLoadTasks()
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x34FC8);
		}
		static ::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>** StaticGet_AvatarAccessoryAsyncLoadTasks()
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x34FD0);
		}
		// static const ::System::Int32 MaxPoolNum = 0x32; // 0x0
		// static const ::System::String* _IK_POINT_NAME; // 0x0
		::NPCCrowd::NPCGoPool* simpleModelGoPool; // 0x18
		::NPCCrowd::NPCGoPool* shadowProxySkinnedGoPool; // 0x20
		::NPCCrowd::NPCGoPool* cpuPartGoPool; // 0x28
		::NPCCrowd::NPCGoPool* shadowProxyStaticGoPool; // 0x30
		::Il2CppArray<::MoleMole::ECrowdShadowFineness>* lodShadowFineness; // 0x38
		::NPCCrowd::NPCGoPool* rootGoPool; // 0x40
		::NPCCrowd::NPCGoPool* gpuPartGoPool; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* _npcRandomLibTagPools; // 0x50
		::System::Boolean bUseShadowProxy; // 0x58
		::System::Boolean bCreateStaticShadowProxy; // 0x59
		::System::Boolean bCreateSkinnedShadowProxy; // 0x5A
