...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_BINDBONESLOTSGALGAME_OFFSET UNITYSDK_OFFSET(0xCE6D760)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARACCESSORIESASYNC_OFFSET UNITYSDK_OFFSET(0xCE74440)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARBODYPARTSASYNC_OFFSET UNITYSDK_OFFSET(0xCE72E60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARGO_1_OFFSET UNITYSDK_OFFSET(0xCE68B80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARGO_OFFSET UNITYSDK_OFFSET(0xCE687B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_1_OFFSET UNITYSDK_OFFSET(0xCE69E00)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_2_OFFSET UNITYSDK_OFFSET(0xCE69F60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_OFFSET UNITYSDK_OFFSET(0xCE69AB0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESGALGAMEASYNC_OFFSET UNITYSDK_OFFSET(0xCE6D5F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATAR_OFFSET UNITYSDK_OFFSET(0xCE67D80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARANIMATOR_OFFSET UNITYSDK_OFFSET(0xCE69960)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARCOLLIDER_OFFSET UNITYSDK_OFFSET(0xCE68D70)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARGOGALGAMEASYNC_OFFSET UNITYSDK_OFFSET(0xCE6CFA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xCE73D30)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOFEATUREPOINT_OFFSET UNITYSDK_OFFSET(0xCE69430)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOINTERACTPOINT_OFFSET UNITYSDK_OFFSET(0xCE69660)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOITEMSTATE_OFFSET UNITYSDK_OFFSET(0xCE69890)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARNAVMESHOBSTACLE_OFFSET UNITYSDK_OFFSET(0xCE69270)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_ENABLEIKCOMPONENT_OFFSET UNITYSDK_OFFSET(0xCE6F500)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GETAVATARSHAREDGPUMATERIALS_OFFSET UNITYSDK_OFFSET(0xCE739D0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GETAVATARSHAREDGPUMATERIAL_OFFSET UNITYSDK_OFFSET(0xCE6B3E0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GET_OFFSET UNITYSDK_OFFSET(0xCE65C50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GPUMATPARAMPROCESSOR_OFFSET UNITYSDK_OFFSET(0xCE6B8F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYANIMATORCULLINGMODEASYNC_OFFSET UNITYSDK_OFFSET(0xCE6CCB0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYANIMATOR_OFFSET UNITYSDK_OFFSET(0xCE6BD50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYDEVICENUMBERPLATECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCE6C940)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYMDBCOMPONENT_OFFSET UNITYSDK_OFFSET(0xCE6C070)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYMDBPOSE_OFFSET UNITYSDK_OFFSET(0xCE74A40)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0xCE6C730)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITCPUMATERIALCOLORS_OFFSET UNITYSDK_OFFSET(0xCE64500)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITGPUMATERIALCOLORS_OFFSET UNITYSDK_OFFSET(0xCE74020)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITGPUMATERIALS_OFFSET UNITYSDK_OFFSET(0xCE73E50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITLOGICTAGS_OFFSET UNITYSDK_OFFSET(0xCE6CD30)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xCE67100)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCE67B80)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_PLAYMDBREFERENCEPOSECLIP_OFFSET UNITYSDK_OFFSET(0xCE74D20)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARACCESSORYGALGAME_OFFSET UNITYSDK_OFFSET(0xCE701B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARACCESSORY_OFFSET UNITYSDK_OFFSET(0xCE6BAE0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARGOGALGAME_OFFSET UNITYSDK_OFFSET(0xCE6DFA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARGO_OFFSET UNITYSDK_OFFSET(0xCE6A160)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RANDOMSPAWNNPCFROMLIB_OFFSET UNITYSDK_OFFSET(0xCE68480)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARPARTS_OFFSET UNITYSDK_OFFSET(0xCE70740)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARROOTCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xCE72450)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARSHADOWPROXY_OFFSET UNITYSDK_OFFSET(0xCE71990)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARSIMPLEMODEL_OFFSET UNITYSDK_OFFSET(0xCE714A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATAR_OFFSET UNITYSDK_OFFSET(0xCE65DD0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASENPCFORRANDOMLIB_OFFSET UNITYSDK_OFFSET(0xCE72CB0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOFBXASYNC_OFFSET UNITYSDK_OFFSET(0xCE74580)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOMATERIALASYNC_OFFSET UNITYSDK_OFFSET(0xCE746C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOMATERIALFORDEVICENUMBERPLATE_OFFSET UNITYSDK_OFFSET(0xCE74890)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARPARTINFOASYNC_OFFSET UNITYSDK_OFFSET(0xCE72FE0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPCPUPARTINFO_OFFSET UNITYSDK_OFFSET(0xCE73130)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPGPUPARTINFO_OFFSET UNITYSDK_OFFSET(0xCE737A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPNPCAVATARLOD0MESH_OFFSET UNITYSDK_OFFSET(0xCE6ED90)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_UPDATENPCAVATARANIMATORFORGALGAME_OFFSET UNITYSDK_OFFSET(0xCE73B90)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCE74F30)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCE74F20)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPCPUPARTINFO_G__GETPARTBOUNDINGBOXBYPARTTYPE_44_0_OFFSET UNITYSDK_OFFSET(0xCE73670)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xCE750A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCE75130)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager_TypeDefinitionIndex = 58940;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x38700);
		}
		static ::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>** StaticGet_AvatarAsyncLoadTasks()
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x38708);
		}
		static ::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>** StaticGet_AvatarAccessoryAsyncLoadTasks()
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x38710);
		}
		// static const ::System::Int32 MaxPoolNum = 0x32; // 0x0
		// static const ::System::String* _IK_POINT_NAME; // 0x0
		::NPCCrowd::NPCGoPool* gpuPartGoPool; // 0x18
		::NPCCrowd::NPCGoPool* shadowProxyStaticGoPool; // 0x20
		::NPCCrowd::NPCGoPool* shadowProxySkinnedGoPool; // 0x28
		::NPCCrowd::NPCGoPool* rootGoPool; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* _npcRandomLibTagPools; // 0x38
		::Foundation::AssetRequestHandle _deviceNumberPlateAssetHandle; // 0x40
		::Il2CppArray<::MoleMole::ECrowdShadowFineness>* lodShadowFineness; // 0x60
		::NPCCrowd::NPCGoPool* cpuPartGoPool; // 0x68
		::MonoNotRelateGameLogic::DynamicCarPlateAssetCfg* _deviceNumberPlateAssetSo; // 0x70
		::NPCCrowd::NPCGoPool* simpleModelGoPool; // 0x78
		::System::Boolean bCreateSkinnedShadowProxy; // 0x80
		::System::Boolean bUseShadowProxy; // 0x81
		::System::Boolean bCreateStaticShadowProxy; // 0x82
		...
		static ::UnityEngine::Bounds _SetupCPUPartInfo_g__GetPartBoundingBoxByPartType_44_0(::ENPCAvatarBodyPart partType)
		{
			return ((::UnityEngine::Bounds(*)(::ENPCAvatarBodyPart))((::PBYTE)hIl2Cpp + NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPCPUPARTINFO_G__GETPARTBOUNDINGBOXBYPARTTYPE_44_0_OFFSET))(partType);
		}
