...
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETALLPARTS_OFFSET UNITYSDK_OFFSET(0x11B2BB60)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0x11B2BBA0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x11B2BAB0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11B2B8C0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x11B2BBE0)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarGOReferenceComponent_TypeDefinitionIndex = 76450;
