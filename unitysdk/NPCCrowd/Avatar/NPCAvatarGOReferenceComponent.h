...
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETALLPARTS_OFFSET UNITYSDK_OFFSET(0xF9B8990)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0xF9B89D0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0xF9B88E0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF9B86F0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF9B8A10)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarGOReferenceComponent_TypeDefinitionIndex = 63656;
