...
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD43A290)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___C__DISPLAYCLASS39_0__REFRESHALLNPCTIMEPERIODTAGS_B__0_OFFSET UNITYSDK_OFFSET(0xD43A2A0)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarSubSystem___c__DisplayClass39_0_TypeDefinitionIndex = 82935;
