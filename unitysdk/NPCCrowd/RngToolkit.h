...
#define NPCCROWD_RNGTOOLKIT_ASBOOL_OFFSET UNITYSDK_OFFSET(0xEBDEA80)
#define NPCCROWD_RNGTOOLKIT_ASFLOAT_1_OFFSET UNITYSDK_OFFSET(0xEBDEC60)
#define NPCCROWD_RNGTOOLKIT_ASFLOAT_OFFSET UNITYSDK_OFFSET(0xEBDEC10)
#define NPCCROWD_RNGTOOLKIT_ASINT_1_OFFSET UNITYSDK_OFFSET(0xEBDEB10)
#define NPCCROWD_RNGTOOLKIT_ASINT_OFFSET UNITYSDK_OFFSET(0xEBDEAD0)
#define NPCCROWD_RNGTOOLKIT_ASUINT_1_OFFSET UNITYSDK_OFFSET(0xEBDEBD0)
#define NPCCROWD_RNGTOOLKIT_ASUINT_OFFSET UNITYSDK_OFFSET(0xEBDEB70)

namespace NPCCrowd
{
	inline static constexpr unsigned int RngToolkit_TypeDefinitionIndex = 47404;
