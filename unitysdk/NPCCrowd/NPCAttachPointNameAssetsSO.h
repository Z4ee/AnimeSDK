...
#define NPCCROWD_NPCATTACHPOINTNAMEASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0x12747D20)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCAttachPointNameAssetsSO_TypeDefinitionIndex = 68239;
