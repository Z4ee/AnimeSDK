...
#define NPCCROWD_NPCDEVICEPERFORMANCECONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x11949970)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCDevicePerformanceConfigSO_TypeDefinitionIndex = 49353;
