...
#define NPCCROWD_NPCSOFTGAMEOBJECTPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD443990)
#define NPCCROWD_NPCSOFTGAMEOBJECTPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xD443970)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCSoftGameObjectPath_TypeDefinitionIndex = 53803;
