...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_GETVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x72D3A0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_RECYCLEVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x72D3B0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_REFRESHVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x72D330)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_UPDATEBATCHTICK_OFFSET UNITYSDK_OFFSET(0x72D410)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x72D320)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_LODData_TypeDefinitionIndex = 68761;
