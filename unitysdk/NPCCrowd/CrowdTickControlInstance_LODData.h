...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_GETVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x77D990)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_RECYCLEVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x77D9A0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_REFRESHVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x77D920)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_UPDATEBATCHTICK_OFFSET UNITYSDK_OFFSET(0x77DA00)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x77D910)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_LODData_TypeDefinitionIndex = 79364;
