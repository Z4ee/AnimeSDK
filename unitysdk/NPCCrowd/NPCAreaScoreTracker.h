...
#define NPCCROWD_NPCAREASCORETRACKER_BEGINVALIDATION_OFFSET UNITYSDK_OFFSET(0x17FB0D00)
#define NPCCROWD_NPCAREASCORETRACKER_CLEAR_OFFSET UNITYSDK_OFFSET(0x17FB1370)
#define NPCCROWD_NPCAREASCORETRACKER_CONTINUEVALIDATION_OFFSET UNITYSDK_OFFSET(0x17FB11D0)
#define NPCCROWD_NPCAREASCORETRACKER_FINISHVALIDATION_OFFSET UNITYSDK_OFFSET(0x17FB13D0)
#define NPCCROWD_NPCAREASCORETRACKER_GETAREAPERFORMANCESCORE_OFFSET UNITYSDK_OFFSET(0x17FB0BB0)
#define NPCCROWD_NPCAREASCORETRACKER_GET_ACTIVEGADGETCOUNT_OFFSET UNITYSDK_OFFSET(0x17FB0810)
#define NPCCROWD_NPCAREASCORETRACKER_GET_ACTIVESERVERNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x17FB0820)
#define NPCCROWD_NPCAREASCORETRACKER_GET_CACHEDGADGETSCORE_OFFSET UNITYSDK_OFFSET(0x17FB0800)
#define NPCCROWD_NPCAREASCORETRACKER_GET_CACHEDSERVERNPCVOSCORE_OFFSET UNITYSDK_OFFSET(0x17FB0830)
#define NPCCROWD_NPCAREASCORETRACKER_GET_ISVALIDATING_OFFSET UNITYSDK_OFFSET(0x17FB0900)
#define NPCCROWD_NPCAREASCORETRACKER_GET_SERVERNPCCOUNTSCORE_OFFSET UNITYSDK_OFFSET(0x17FB0840)
#define NPCCROWD_NPCAREASCORETRACKER_GET_SERVERNPCTOTALSCORE_OFFSET UNITYSDK_OFFSET(0x17FB08A0)
#define NPCCROWD_NPCAREASCORETRACKER_ONENTITYACTIVATED_OFFSET UNITYSDK_OFFSET(0x17FB0920)
#define NPCCROWD_NPCAREASCORETRACKER_ONENTITYDEACTIVATED_OFFSET UNITYSDK_OFFSET(0x17FB09D0)
#define NPCCROWD_NPCAREASCORETRACKER_PROCESSGROUPFORVALIDATION_OFFSET UNITYSDK_OFFSET(0x17FB1490)
#define NPCCROWD_NPCAREASCORETRACKER_REFRESHFROMPOLLINGSTATS_OFFSET UNITYSDK_OFFSET(0x17FB0B10)
#define NPCCROWD_NPCAREASCORETRACKER_UPDATECROWDCOUNT_OFFSET UNITYSDK_OFFSET(0x17FB0AC0)
#define NPCCROWD_NPCAREASCORETRACKER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17FB0C80)
#define NPCCROWD_NPCAREASCORETRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x17FB0910)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCAreaScoreTracker_TypeDefinitionIndex = 76438;
	...
	public:
		...
		::System::Int32 _validationAccumGadgetCount; // 0x28
		::System::Int32 _validationAccumServerNPCCount; // 0x2C
		::System::Single _validationAccumGadgetScore; // 0x30
		::System::Single _validationAccumServerNPCVOScore; // 0x34
		::System::Int32 _activeServerNPCCount; // 0x38
		::System::Int32 _activeGadgetCount; // 0x3C
		::System::Single _cachedServerNPCVOScore; // 0x40
		::System::Int32 _cachedCrowdCount; // 0x44
		::NPCCrowd::NPCAreaScoreTracker_EValidationState _validationState; // 0x48
		::System::Single _cachedGadgetScore; // 0x4C
		::System::Int32 _validationGroupIndex; // 0x50
		::System::Int32 _framesSinceLastValidation; // 0x54
