...
#define CLASS_1_AE784B0D4E05F70E_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E7A16E0)
#define CLASS_1_AE784B0D4E05F70E_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1E7A1300)
#define CLASS_1_AE784B0D4E05F70E_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E7A1470)
#define CLASS_1_AE784B0D4E05F70E_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E7A1390)
#define CLASS_1_AE784B0D4E05F70E_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E7A1540)
#define CLASS_1_AE784B0D4E05F70E_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E7A18E0)
#define CLASS_1_AE784B0D4E05F70E_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E7A18A0)
#define CLASS_1_AE784B0D4E05F70E_1_METHOD_1_4C4B9DFE092840D4_1_OFFSET UNITYSDK_OFFSET(0x1E7A1380)
#define CLASS_1_AE784B0D4E05F70E_1_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1E7A1360)
#define CLASS_1_AE784B0D4E05F70E_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E7A1280)
#define CLASS_1_AE784B0D4E05F70E_1_METHOD_1_7ADD5F1F5E247E3B_1_OFFSET UNITYSDK_OFFSET(0x1E7A1370)
#define CLASS_1_AE784B0D4E05F70E_1_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1E7A1350)
#define CLASS_1_AE784B0D4E05F70E_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E7A12B0)
#define CLASS_1_AE784B0D4E05F70E_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E7A15A0)
#define CLASS_1_AE784B0D4E05F70E_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E7A1600)
#define CLASS_1_AE784B0D4E05F70E_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7A1A60)
#define CLASS_1_AE784B0D4E05F70E_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7A12D0)
#define CLASS_1_AE784B0D4E05F70E_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A12C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_AE784B0D4E05F70E_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE784B0D4E05F70E_1_TypeDefinitionIndex)->GetStaticField(0x30520);
	}
	// static const ::System::Int32 AFOFJJCLHGB = 0x6; // 0x0
	// static const ::System::Int32 FBBEFJLLAHM = 0xA; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Int64 JECNIFENDIP; // 0x18
	::System::Int64 CBDABAKGEIK; // 0x20
