...
#define CLASS_1_6C587B1DA6AB62AC_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x15B851B0)
#define CLASS_1_6C587B1DA6AB62AC_FROMFLX_OFFSET UNITYSDK_OFFSET(0x15B85790)
#define CLASS_1_6C587B1DA6AB62AC_METHOD_1_0578713EDB32B89E_OFFSET UNITYSDK_OFFSET(0x15B85810)
#define CLASS_1_6C587B1DA6AB62AC_METHOD_1_6064CE8C10DDEFF7_OFFSET UNITYSDK_OFFSET(0x15B85210)
#define CLASS_1_6C587B1DA6AB62AC__CTOR_OFFSET UNITYSDK_OFFSET(0x15B868C0)

inline static constexpr unsigned int Class_1_6C587B1DA6AB62AC_TypeDefinitionIndex = 81850;

class Class_1_6C587B1DA6AB62AC : public ::System::Object
{
public:
	::MoleMole::Config::DynamicFloat* Field_1_6; // 0x10
	::Class_1_4ED21A115C97704D* Field_1_9; // 0x18
	::Class_1_4ED21A115C97704D* Field_1_11; // 0x20
	::MoleMole::Config::DynamicString* Field_1_7; // 0x28
	::MoleMole::Config::DynamicInt* Field_1_0; // 0x30
