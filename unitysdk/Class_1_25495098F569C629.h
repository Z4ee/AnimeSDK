...
#define CLASS_1_25495098F569C629_GET_ATTACKERHP_OFFSET UNITYSDK_OFFSET(0x17D95520)
#define CLASS_1_25495098F569C629_GET_ATTACKERPOINT_OFFSET UNITYSDK_OFFSET(0x17D95600)
#define CLASS_1_25495098F569C629_GET_ATTACKER_OFFSET UNITYSDK_OFFSET(0x17D954E0)
#define CLASS_1_25495098F569C629_GET_CONFIRMRESULT_OFFSET UNITYSDK_OFFSET(0x17D956C0)
#define CLASS_1_25495098F569C629_GET_CONFIRMSUM_OFFSET UNITYSDK_OFFSET(0x17D956E0)
#define CLASS_1_25495098F569C629_GET_DAMAGETARGET_OFFSET UNITYSDK_OFFSET(0x17D955E0)
#define CLASS_1_25495098F569C629_GET_DAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0x17D95640)
#define CLASS_1_25495098F569C629_GET_DEFENDERHP_OFFSET UNITYSDK_OFFSET(0x17D95540)
#define CLASS_1_25495098F569C629_GET_DEFENDERPOINT_OFFSET UNITYSDK_OFFSET(0x17D95620)
#define CLASS_1_25495098F569C629_GET_DEFENDER_OFFSET UNITYSDK_OFFSET(0x17D95500)
#define CLASS_1_25495098F569C629_GET_FIRSTATTACK_OFFSET UNITYSDK_OFFSET(0x17D95480)
#define CLASS_1_25495098F569C629_GET_HEALTARGET_OFFSET UNITYSDK_OFFSET(0x17D95660)
#define CLASS_1_25495098F569C629_GET_HEALVALUE_OFFSET UNITYSDK_OFFSET(0x17D95680)
#define CLASS_1_25495098F569C629_GET_LOGTYPE_OFFSET UNITYSDK_OFFSET(0x17D95460)
#define CLASS_1_25495098F569C629_GET_LOSER_OFFSET UNITYSDK_OFFSET(0x17D954A0)
#define CLASS_1_25495098F569C629_GET_MODIFIERID_OFFSET UNITYSDK_OFFSET(0x17D95580)
#define CLASS_1_25495098F569C629_GET_MODIFIERLIFETIME_OFFSET UNITYSDK_OFFSET(0x17D955C0)
#define CLASS_1_25495098F569C629_GET_MODIFIERSTACK_OFFSET UNITYSDK_OFFSET(0x17D955A0)
#define CLASS_1_25495098F569C629_GET_MODIFIERTARGET_OFFSET UNITYSDK_OFFSET(0x17D95560)
#define CLASS_1_25495098F569C629_GET_ROLLRESULT_OFFSET UNITYSDK_OFFSET(0x17D956A0)
#define CLASS_1_25495098F569C629_GET_TURN_OFFSET UNITYSDK_OFFSET(0x17D954C0)
#define CLASS_1_25495098F569C629_METHOD_1_242CCED06054A364_OFFSET UNITYSDK_OFFSET(0x17D95700)
#define CLASS_1_25495098F569C629_METHOD_1_9239663B8D029640_OFFSET UNITYSDK_OFFSET(0x17D95830)
#define CLASS_1_25495098F569C629_SET_ATTACKERHP_OFFSET UNITYSDK_OFFSET(0x17D95530)
#define CLASS_1_25495098F569C629_SET_ATTACKERPOINT_OFFSET UNITYSDK_OFFSET(0x17D95610)
#define CLASS_1_25495098F569C629_SET_ATTACKER_OFFSET UNITYSDK_OFFSET(0x17D954F0)
#define CLASS_1_25495098F569C629_SET_CONFIRMRESULT_OFFSET UNITYSDK_OFFSET(0x17D956D0)
#define CLASS_1_25495098F569C629_SET_CONFIRMSUM_OFFSET UNITYSDK_OFFSET(0x17D956F0)
#define CLASS_1_25495098F569C629_SET_DAMAGETARGET_OFFSET UNITYSDK_OFFSET(0x17D955F0)
#define CLASS_1_25495098F569C629_SET_DAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0x17D95650)
#define CLASS_1_25495098F569C629_SET_DEFENDERHP_OFFSET UNITYSDK_OFFSET(0x17D95550)
#define CLASS_1_25495098F569C629_SET_DEFENDERPOINT_OFFSET UNITYSDK_OFFSET(0x17D95630)
#define CLASS_1_25495098F569C629_SET_DEFENDER_OFFSET UNITYSDK_OFFSET(0x17D95510)
#define CLASS_1_25495098F569C629_SET_FIRSTATTACK_OFFSET UNITYSDK_OFFSET(0x17D95490)
#define CLASS_1_25495098F569C629_SET_HEALTARGET_OFFSET UNITYSDK_OFFSET(0x17D95670)
#define CLASS_1_25495098F569C629_SET_HEALVALUE_OFFSET UNITYSDK_OFFSET(0x17D95690)
#define CLASS_1_25495098F569C629_SET_LOGTYPE_OFFSET UNITYSDK_OFFSET(0x17D95470)
#define CLASS_1_25495098F569C629_SET_LOSER_OFFSET UNITYSDK_OFFSET(0x17D954B0)
#define CLASS_1_25495098F569C629_SET_MODIFIERID_OFFSET UNITYSDK_OFFSET(0x17D95590)
#define CLASS_1_25495098F569C629_SET_MODIFIERLIFETIME_OFFSET UNITYSDK_OFFSET(0x17D955D0)
#define CLASS_1_25495098F569C629_SET_MODIFIERSTACK_OFFSET UNITYSDK_OFFSET(0x17D955B0)
#define CLASS_1_25495098F569C629_SET_MODIFIERTARGET_OFFSET UNITYSDK_OFFSET(0x17D95570)
#define CLASS_1_25495098F569C629_SET_ROLLRESULT_OFFSET UNITYSDK_OFFSET(0x17D956B0)
#define CLASS_1_25495098F569C629_SET_TURN_OFFSET UNITYSDK_OFFSET(0x17D954D0)
#define CLASS_1_25495098F569C629__CTOR_OFFSET UNITYSDK_OFFSET(0x17D962E0)

inline static constexpr unsigned int Class_1_25495098F569C629_TypeDefinitionIndex = 34053;

class Class_1_25495098F569C629 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::System::String*>* _RollResult_k__BackingField; // 0x10
	::System::String* _FirstAttack_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::System::String*>* _ConfirmResult_k__BackingField; // 0x20
	::System::String* _Defender_k__BackingField; // 0x28
	::System::String* _Attacker_k__BackingField; // 0x30
	::System::UInt32 _HealTarget_k__BackingField; // 0x38
	::System::Int32 _DamageValue_k__BackingField; // 0x3C
	::System::UInt32 _DamageTarget_k__BackingField; // 0x40
	::System::UInt32 _ModifierID_k__BackingField; // 0x44
	::System::UInt32 _Loser_k__BackingField; // 0x48
	::System::Int32 _DefenderHP_k__BackingField; // 0x4C
	::System::Int32 _HealValue_k__BackingField; // 0x50
	::System::UInt32 _Turn_k__BackingField; // 0x54
	::System::Int32 _DefenderPoint_k__BackingField; // 0x58
	::System::Int32 _AttackerHP_k__BackingField; // 0x5C
	::System::Int32 _ModifierStack_k__BackingField; // 0x60
	::System::Int32 _ConfirmSum_k__BackingField; // 0x64
	::System::UInt32 _ModifierTarget_k__BackingField; // 0x68
	::System::Int32 _ModifierLifetime_k__BackingField; // 0x6C
	::RPG::LittleGameShare::DiceCombatCore::AutoTestLogType _LogType_k__BackingField; // 0x70
	::System::Int32 _AttackerPoint_k__BackingField; // 0x74
