...
#define NAVMESHSOURCETAG_COLLECT_OFFSET UNITYSDK_OFFSET(0x11956960)
#define NAVMESHSOURCETAG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x119565A0)
#define NAVMESHSOURCETAG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x119561E0)
#define NAVMESHSOURCETAG__CCTOR_OFFSET UNITYSDK_OFFSET(0x11957220)
#define NAVMESHSOURCETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x119571D0)

inline static constexpr unsigned int NavMeshSourceTag_TypeDefinitionIndex = 42815;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::MeshFilter*>**)Il2CppClass::FromTypeDefinitionIndex(NavMeshSourceTag_TypeDefinitionIndex)->GetStaticField(0x456E0);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::Terrain*>** StaticGet_m_Terrains()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Terrain*>**)Il2CppClass::FromTypeDefinitionIndex(NavMeshSourceTag_TypeDefinitionIndex)->GetStaticField(0x456E8);
	}
