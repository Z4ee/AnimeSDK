...
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xF194FC0)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0xF194D50)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_582A1DD1E3B84C82_OFFSET UNITYSDK_OFFSET(0xF195060)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_7A9EE6E4B8F1006C_OFFSET UNITYSDK_OFFSET(0xF194C30)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_F18927F2B6DBB806_OFFSET UNITYSDK_OFFSET(0xF1951C0)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xF194B80)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF194AD0)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroBoolProperty_TypeDefinitionIndex = 47739;
