...
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP_METHOD_2_06D8B02BA841B626_OFFSET UNITYSDK_OFFSET(0xFBB76A0)
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP_METHOD_2_8EE0DEE68564597C_OFFSET UNITYSDK_OFFSET(0xFBB7750)
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xFBB7740)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroWeatherClip_TypeDefinitionIndex = 40268;
