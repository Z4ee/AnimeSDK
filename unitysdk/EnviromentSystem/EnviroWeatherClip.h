...
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP_METHOD_2_06D8B02BA841B626_OFFSET UNITYSDK_OFFSET(0xF1C9360)
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP_METHOD_2_A89B5C4872F9F9B3_OFFSET UNITYSDK_OFFSET(0xF1C9410)
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xF1C9400)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroWeatherClip_TypeDefinitionIndex = 47725;
