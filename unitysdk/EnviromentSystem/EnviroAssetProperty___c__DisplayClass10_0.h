...
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152F7910)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY___C__DISPLAYCLASS10_0___ASYNCLOAD_B__0_OFFSET UNITYSDK_OFFSET(0x152F7C50)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroAssetProperty___c__DisplayClass10_0_TypeDefinitionIndex = 50042;

	class EnviroAssetProperty___c__DisplayClass10_0 : public ::System::Object
	{
	public:
		::EnviromentSystem::EnviroAssetProperty* __4__this; // 0x10
		...
		::System::Collections::Generic::List_1<::EnviromentSystem::EnviroAssetProperty_Class_1_A15A0E0681486F86*>* temp; // 0x28
