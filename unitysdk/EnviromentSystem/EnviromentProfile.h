...
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0x106BBDF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_NAMEEX_OFFSET UNITYSDK_OFFSET(0x106BBEE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0x106BBEC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_01244C5D42565CB2_OFFSET UNITYSDK_OFFSET(0x106C31C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_063ADB01C44981A7_OFFSET UNITYSDK_OFFSET(0x106C3590)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0C42DDDF06BF692D_OFFSET UNITYSDK_OFFSET(0x106BBF50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0DABAC67FBEEEDA6_OFFSET UNITYSDK_OFFSET(0x106C6C40)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_10DB17F922C0D999_OFFSET UNITYSDK_OFFSET(0x106C5450)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1454625925CA73F5_OFFSET UNITYSDK_OFFSET(0x106C71B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_16E2C4C5C61F8FDB_OFFSET UNITYSDK_OFFSET(0x106BE3A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x106C6050)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B0CF56F555C9A93_OFFSET UNITYSDK_OFFSET(0x106C63F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B214D9710BB7534_OFFSET UNITYSDK_OFFSET(0x106C7080)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2092EACB383790AB_OFFSET UNITYSDK_OFFSET(0x106BCDC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x106BC1A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2839AE123F8ECAA7_OFFSET UNITYSDK_OFFSET(0x106BC690)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BA9010C7C33DCAE_OFFSET UNITYSDK_OFFSET(0x106C41F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BB7E72A7E700799_OFFSET UNITYSDK_OFFSET(0x106BC360)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_OFFSET UNITYSDK_OFFSET(0x106C6580)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2F68009C40503107_OFFSET UNITYSDK_OFFSET(0x106C1C70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_OFFSET UNITYSDK_OFFSET(0x106C61C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_33A7DE6DC0669409_OFFSET UNITYSDK_OFFSET(0x106C58B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_35DD9F229AF5C1D0_1_OFFSET UNITYSDK_OFFSET(0x106C69F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_35DD9F229AF5C1D0_OFFSET UNITYSDK_OFFSET(0x1067D160)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_39CF31F4D7DD3B81_OFFSET UNITYSDK_OFFSET(0x106C5B70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_408445D4519BA880_OFFSET UNITYSDK_OFFSET(0x106BED20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_41206355B1BC7902_OFFSET UNITYSDK_OFFSET(0x106C4DA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x106C3360)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_2_OFFSET UNITYSDK_OFFSET(0x106C3640)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x106BCD10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4E4D3005862CA49B_OFFSET UNITYSDK_OFFSET(0x106C5EB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4FF38CFCA5B3077D_OFFSET UNITYSDK_OFFSET(0x106BE5D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_511BD23D89CDE949_OFFSET UNITYSDK_OFFSET(0x106C1BA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_52084BFE92581342_OFFSET UNITYSDK_OFFSET(0x106C6670)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5A0DB1B7B9BE25BD_OFFSET UNITYSDK_OFFSET(0x106BBDA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D22ABED9373C2B3_OFFSET UNITYSDK_OFFSET(0x106C6AA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_658323AD993800CF_OFFSET UNITYSDK_OFFSET(0x106BEAD0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_6964C65990684D4A_OFFSET UNITYSDK_OFFSET(0x106A3900)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_70D35EA6595005E0_OFFSET UNITYSDK_OFFSET(0x106C30F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_722196BE0640FA62_OFFSET UNITYSDK_OFFSET(0x106BC2E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x106C6600)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_79B90490025ABC83_OFFSET UNITYSDK_OFFSET(0x106C70D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7C70D627BA6F6091_OFFSET UNITYSDK_OFFSET(0x106C6CC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7EC8FB1E5C75BFDC_OFFSET UNITYSDK_OFFSET(0x106C5700)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_803856DB6C5D9DB5_OFFSET UNITYSDK_OFFSET(0x106C7CF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0x106C6B70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8F673316E45525AC_OFFSET UNITYSDK_OFFSET(0x106C4FF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9216B801ACD0B564_OFFSET UNITYSDK_OFFSET(0x106BD1D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_98B7D142FBED6D85_OFFSET UNITYSDK_OFFSET(0x106C36F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x106C6130)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A50B0776CACF3F3C_OFFSET UNITYSDK_OFFSET(0x106C37D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A8C3CD0F3AB51701_OFFSET UNITYSDK_OFFSET(0x106C6850)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A9A048D3B4CDDD40_OFFSET UNITYSDK_OFFSET(0x106C44C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AA05F99BBEDA8B55_OFFSET UNITYSDK_OFFSET(0x106C5D20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AD7283B0EE0C18A1_OFFSET UNITYSDK_OFFSET(0x106C4870)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0x106BE470)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B50425D0A09C6F35_OFFSET UNITYSDK_OFFSET(0x106C6250)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B81E7C3D0102EBE3_OFFSET UNITYSDK_OFFSET(0x106C4310)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B8988AFA2C9F74D0_OFFSET UNITYSDK_OFFSET(0x106BCF20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C137F5CD6FDEBE03_OFFSET UNITYSDK_OFFSET(0x106BBD50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C17DDF50E9F40898_OFFSET UNITYSDK_OFFSET(0x106C60C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C706B1EC6D2E1C64_OFFSET UNITYSDK_OFFSET(0x106C6DB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CE13F95478F90C1E_OFFSET UNITYSDK_OFFSET(0x106BD700)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D33218A492B26449_OFFSET UNITYSDK_OFFSET(0x106BED80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D60F4BA24E06086B_OFFSET UNITYSDK_OFFSET(0x106C1BF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D92CEBF2FF830E5C_OFFSET UNITYSDK_OFFSET(0x106C1CF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DCEDA9CA86F04212_OFFSET UNITYSDK_OFFSET(0x106C3CE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E34FD37B13C162FC_OFFSET UNITYSDK_OFFSET(0x106BF990)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E59CAA2089D7E8B1_OFFSET UNITYSDK_OFFSET(0x106C3410)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_ECCE25DC2E771DF4_OFFSET UNITYSDK_OFFSET(0x106BA2F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F25FA9F7CFC308C3_1_OFFSET UNITYSDK_OFFSET(0x106C3B00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F25FA9F7CFC308C3_OFFSET UNITYSDK_OFFSET(0x106C3920)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F441ACB416811999_OFFSET UNITYSDK_OFFSET(0x106C4670)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F8EC8B3D73CFFDCF_OFFSET UNITYSDK_OFFSET(0x106809B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_FA4F4834B590F55F_OFFSET UNITYSDK_OFFSET(0x106C4A60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x106C7670)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x106C7630)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0x106BBE00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_NAMEEX_OFFSET UNITYSDK_OFFSET(0x106BBEF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0x106BBED0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CCTOR_OFFSET UNITYSDK_OFFSET(0x106C7E20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x106C7D70)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x64A30);
		}
		static ::EnviromentSystem::EnviromentProfile** StaticGet__DefaultProfileTemplate()
		{
			return (::EnviromentSystem::EnviromentProfile**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x64A38);
		}
		static ::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>** StaticGet__DefaultProfilePool()
		{
			return (::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x64A40);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet__EnvPropShaderIDToIndex()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x64A48);
		}
		static ::System::Int32* StaticGet_GlobalRotMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x14C40);
		}
		static ::System::Int32* StaticGet_TransitionRateID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x14C44);
		}
		static ::System::Int32* StaticGet_ShadowDirID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x14C48);
		}
