...
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_3383F5B5B7F87651_OFFSET UNITYSDK_OFFSET(0xF19B410)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_1_OFFSET UNITYSDK_OFFSET(0xF1CD800)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_2_OFFSET UNITYSDK_OFFSET(0xF1CE000)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0xF1CD6B0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0xF1CD950)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xF1CD540)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_6BB3BCA076D98E60_OFFSET UNITYSDK_OFFSET(0xF1CDC90)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_70D35EA6595005E0_OFFSET UNITYSDK_OFFSET(0xF1CD5F0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_8E7FE57CA6DE88E1_OFFSET UNITYSDK_OFFSET(0xF1CDD50)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_CFC9D07F42C4C720_OFFSET UNITYSDK_OFFSET(0xF1CDA00)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_D114AD6D57BD6A9C_OFFSET UNITYSDK_OFFSET(0xF1CDEA0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xF1CDBC0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xF19CF40)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviromentClip_TypeDefinitionIndex = 47727;
