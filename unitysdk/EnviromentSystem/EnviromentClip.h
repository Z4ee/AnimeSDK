...
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_3383F5B5B7F87651_OFFSET UNITYSDK_OFFSET(0x15304650)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_1_OFFSET UNITYSDK_OFFSET(0x15337850)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_2_OFFSET UNITYSDK_OFFSET(0x15338050)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0x15337700)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x153379A0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x15337590)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_6BB3BCA076D98E60_OFFSET UNITYSDK_OFFSET(0x15337CE0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_70D35EA6595005E0_OFFSET UNITYSDK_OFFSET(0x15337640)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_8E7FE57CA6DE88E1_OFFSET UNITYSDK_OFFSET(0x15337DA0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_CFC9D07F42C4C720_OFFSET UNITYSDK_OFFSET(0x15337A50)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_D114AD6D57BD6A9C_OFFSET UNITYSDK_OFFSET(0x15337EF0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x15337C10)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x15306180)
