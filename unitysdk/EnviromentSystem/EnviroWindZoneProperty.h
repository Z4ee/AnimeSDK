...
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_19691C230ADAC7D3_OFFSET UNITYSDK_OFFSET(0x15336220)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_4867D67F27947ACE_OFFSET UNITYSDK_OFFSET(0x15336C50)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_653151ACD8E3C108_OFFSET UNITYSDK_OFFSET(0x15336C00)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0x15336E30)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x153373B0)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_AA7E3074254D484A_OFFSET UNITYSDK_OFFSET(0x15336AE0)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x15336540)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY_METHOD_3_FC9D73DAE431D642_OFFSET UNITYSDK_OFFSET(0x15336B80)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15336120)
#define ENVIROMENTSYSTEM_ENVIROWINDZONEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x15336010)
