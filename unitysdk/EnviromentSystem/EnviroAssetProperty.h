...
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0xF18D780)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_CA5F6DB703947009_OFFSET UNITYSDK_OFFSET(0xF18DE30)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_D08A551686938D7D_OFFSET UNITYSDK_OFFSET(0xF18DC80)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E5630A859AA24FB3_OFFSET UNITYSDK_OFFSET(0xF18D500)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E9EEDFB818CD2681_OFFSET UNITYSDK_OFFSET(0xF18E430)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EA7C9571288E1295_OFFSET UNITYSDK_OFFSET(0xF18E770)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EBAB6A35C21A2A5B_OFFSET UNITYSDK_OFFSET(0xF18D930)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0xF18D4A0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF18D580)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroAssetProperty_TypeDefinitionIndex = 47759;

	class EnviroAssetProperty : public ::EnviromentSystem::EnviroProperty
	{
	public:
		static ::Class_2_7F7BFA8C5E418566** StaticGet___Loader()
		{
			return (::Class_2_7F7BFA8C5E418566**)Il2CppClass::FromTypeDefinitionIndex(EnviroAssetProperty_TypeDefinitionIndex)->GetStaticField(0x349F0);
		}
		...
		static ::Class_2_7F7BFA8C5E418566* Method_2_E5630A859AA24FB3()
		{
			return ((::Class_2_7F7BFA8C5E418566*(*)())((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E5630A859AA24FB3_OFFSET))();
		}
