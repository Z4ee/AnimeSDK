...
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0x1067A430)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_CA5F6DB703947009_OFFSET UNITYSDK_OFFSET(0x1067AAE0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_D08A551686938D7D_OFFSET UNITYSDK_OFFSET(0x1067A930)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E5630A859AA24FB3_OFFSET UNITYSDK_OFFSET(0x1067A1B0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E9EEDFB818CD2681_OFFSET UNITYSDK_OFFSET(0x1067B0E0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EA7C9571288E1295_OFFSET UNITYSDK_OFFSET(0x1067B420)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EBAB6A35C21A2A5B_OFFSET UNITYSDK_OFFSET(0x1067A5E0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x1067A150)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1067A230)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::Class_2_7D53347CD75A5D8B**)Il2CppClass::FromTypeDefinitionIndex(EnviroAssetProperty_TypeDefinitionIndex)->GetStaticField(0x645E0);
		}
