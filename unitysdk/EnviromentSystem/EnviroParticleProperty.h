...
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_0AA98B52501920FC_OFFSET UNITYSDK_OFFSET(0x153241D0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_0DA2366A4A7DBAA7_OFFSET UNITYSDK_OFFSET(0x15325FD0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x15324370)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x15321F30)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_367B828F03288F81_OFFSET UNITYSDK_OFFSET(0x153266F0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_42B2BB88AE2FB02E_OFFSET UNITYSDK_OFFSET(0x15323AF0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_46B69F9383394A79_OFFSET UNITYSDK_OFFSET(0x15324BA0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_61929A3103595552_OFFSET UNITYSDK_OFFSET(0x15325B40)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_6265C7118C397180_OFFSET UNITYSDK_OFFSET(0x153245E0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_65286758AD0A6377_OFFSET UNITYSDK_OFFSET(0x153260D0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_772D67C1BB94E51A_1_OFFSET UNITYSDK_OFFSET(0x15322E20)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_772D67C1BB94E51A_OFFSET UNITYSDK_OFFSET(0x15322540)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_840D76A628A32BA4_OFFSET UNITYSDK_OFFSET(0x15325810)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_8C5640BC001B297D_OFFSET UNITYSDK_OFFSET(0x15326600)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_A1181F48E2FBC750_OFFSET UNITYSDK_OFFSET(0x15326530)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x15325960)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_B61816188D411E7A_OFFSET UNITYSDK_OFFSET(0x153267D0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_BF32778AFC3501D1_OFFSET UNITYSDK_OFFSET(0x15321BB0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15326C10)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15326BD0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0x15324840)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0x153239C0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_DCCE11FE949CAADF_OFFSET UNITYSDK_OFFSET(0x15325CE0)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_E05012375B3FEA38_OFFSET UNITYSDK_OFFSET(0x15326410)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_EC90937CEA9AFCA9_OFFSET UNITYSDK_OFFSET(0x15325F00)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY_METHOD_3_FCC585F890185F8B_OFFSET UNITYSDK_OFFSET(0x15323B70)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15321830)
#define ENVIROMENTSYSTEM_ENVIROPARTICLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x153216B0)
