...
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0xFBAE5C0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_0A1B064727BE410F_OFFSET UNITYSDK_OFFSET(0xFBAE0A0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xFBAE170)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_19295F9E95CC8034_OFFSET UNITYSDK_OFFSET(0xFBAE570)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xFBAE510)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_289256236CBF6273_OFFSET UNITYSDK_OFFSET(0xFBAE4A0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_2B43621760F6D081_OFFSET UNITYSDK_OFFSET(0xFBAE430)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_3B142DD188989577_OFFSET UNITYSDK_OFFSET(0xFBAE6B0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_4329D8CC8C08D0C1_OFFSET UNITYSDK_OFFSET(0xFBAE620)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_5693914D0131014B_OFFSET UNITYSDK_OFFSET(0xFBADD90)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_778A0F95AAA239C1_OFFSET UNITYSDK_OFFSET(0xFBAE250)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xFBADE80)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0xFBADAD0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xFBAE340)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xFBAE670)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xFBAE700)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xFBAE740)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0xFBAE780)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA373AA1C7054598_5_OFFSET UNITYSDK_OFFSET(0xFBAE7C0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xFBAE3F0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xFBAE030)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_CEAC9CDAE2EF9114_OFFSET UNITYSDK_OFFSET(0xFBADFE0)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xFBADF30)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xFBADA30)
#define ENVIROMENTSYSTEM_ENVIROPREFABPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xFBAD9A0)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroPrefabProperty_TypeDefinitionIndex = 40299;
