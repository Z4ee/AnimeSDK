...
#define ENVIROMENTSYSTEM_WINDTRIGGERDATA_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x2BBBC20)
#define ENVIROMENTSYSTEM_WINDTRIGGERDATA_METHOD_2_DFCBD1685FB122E4_OFFSET UNITYSDK_OFFSET(0x2BBBC10)

namespace EnviromentSystem
{
	inline static constexpr unsigned int WindTriggerData_TypeDefinitionIndex = 46809;
