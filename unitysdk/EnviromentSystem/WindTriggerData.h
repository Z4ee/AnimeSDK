...
#define ENVIROMENTSYSTEM_WINDTRIGGERDATA_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x13FE4A0)
#define ENVIROMENTSYSTEM_WINDTRIGGERDATA_METHOD_2_DFCBD1685FB122E4_OFFSET UNITYSDK_OFFSET(0x13FE490)

namespace EnviromentSystem
{
	inline static constexpr unsigned int WindTriggerData_TypeDefinitionIndex = 40317;
