...
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xF1C8E80)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0xF1C89D0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_582A1DD1E3B84C82_OFFSET UNITYSDK_OFFSET(0xF1C8F20)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_5A94CFCFB167E3E2_OFFSET UNITYSDK_OFFSET(0xF1C9010)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xF1C92F0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xF1B4990)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0xF1B4A80)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_3_OFFSET UNITYSDK_OFFSET(0xF19CEA0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_4_OFFSET UNITYSDK_OFFSET(0xF1C8870)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_5_OFFSET UNITYSDK_OFFSET(0xF1C8930)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B4B20)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroVectorProperty_TypeDefinitionIndex = 47771;
