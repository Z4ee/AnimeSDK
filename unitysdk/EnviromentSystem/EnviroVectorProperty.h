...
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0xF907ED0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_19295F9E95CC8034_OFFSET UNITYSDK_OFFSET(0xF907E80)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xF907E20)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_289256236CBF6273_OFFSET UNITYSDK_OFFSET(0xF907DB0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xF9073C0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_5693914D0131014B_OFFSET UNITYSDK_OFFSET(0xF907970)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_5A94CFCFB167E3E2_OFFSET UNITYSDK_OFFSET(0xF907A60)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xF9078C0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xF907F30)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xF907D40)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xF905DC0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0xF905F50)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_3_OFFSET UNITYSDK_OFFSET(0xF905EB0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_4_OFFSET UNITYSDK_OFFSET(0xF907260)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_5_OFFSET UNITYSDK_OFFSET(0xF907320)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF906090)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroVectorProperty_TypeDefinitionIndex = 46223;
