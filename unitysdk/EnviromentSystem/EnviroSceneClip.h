...
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP_METHOD_2_11C61C26889D4FC4_OFFSET UNITYSDK_OFFSET(0x1532D1A0)
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP_METHOD_2_6C79D4B046F2D11A_OFFSET UNITYSDK_OFFSET(0x1532CA20)
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP_METHOD_2_BA78F91931F4B77B_OFFSET UNITYSDK_OFFSET(0x1532CB40)
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1532CB00)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroSceneClip_TypeDefinitionIndex = 50002;
