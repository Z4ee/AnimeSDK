...
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP_METHOD_2_11C61C26889D4FC4_OFFSET UNITYSDK_OFFSET(0xFBB27F0)
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP_METHOD_2_6C79D4B046F2D11A_OFFSET UNITYSDK_OFFSET(0xFBB1ED0)
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP_METHOD_2_BA78F91931F4B77B_OFFSET UNITYSDK_OFFSET(0xFBB1FF0)
#define ENVIROMENTSYSTEM_ENVIROSCENECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xFBB1FB0)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroSceneClip_TypeDefinitionIndex = 40264;
