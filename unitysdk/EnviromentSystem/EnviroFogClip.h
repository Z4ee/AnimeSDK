...
#define ENVIROMENTSYSTEM_ENVIROFOGCLIP_METHOD_2_1B0916E27D8401AA_OFFSET UNITYSDK_OFFSET(0xFB8DAC0)
#define ENVIROMENTSYSTEM_ENVIROFOGCLIP_METHOD_2_6AA875EA08DEE2B3_OFFSET UNITYSDK_OFFSET(0xFB8DB70)
#define ENVIROMENTSYSTEM_ENVIROFOGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xFB8DB60)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroFogClip_TypeDefinitionIndex = 40262;
