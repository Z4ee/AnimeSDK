...
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY_METHOD_3_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0xF195470)
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xF195390)
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF1952E0)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroEProbeOverrideProperty_TypeDefinitionIndex = 47740;
