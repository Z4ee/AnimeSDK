...
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY_METHOD_3_793FFA9A76FE6840_OFFSET UNITYSDK_OFFSET(0xF2FF3B0)
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY_METHOD_3_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0xF2FF2D0)
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xF2FF1F0)
#define ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xF2FF140)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroEProbeOverrideProperty_TypeDefinitionIndex = 46192;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROEPROBEOVERRIDEPROPERTY_METHOD_3_793FFA9A76FE6840_OFFSET))(this, P0);
		}
	};
}
