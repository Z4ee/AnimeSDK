...
#define CLASS_2_E89D615EF06C478F_METHOD_2_47EDBC4CA1AB8BEE_OFFSET UNITYSDK_OFFSET(0x1C1A4830)
#define CLASS_2_E89D615EF06C478F__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A4820)

inline static constexpr unsigned int Class_2_E89D615EF06C478F_TypeDefinitionIndex = 35612;

class Class_2_E89D615EF06C478F : public ::Class_1_B55037134F9E6688
{
public:
	::Class_2_48488E8DBD9F6BCE* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::DiceCombatTaskConfig_RemoveModifier* IGHAHBNLIJA; // 0x20
