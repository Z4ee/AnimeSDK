...
#define CLASS_3_B463C45003E834B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17DC36A0)
#define CLASS_3_B463C45003E834B4_METHOD_3_0352744742F7C457_OFFSET UNITYSDK_OFFSET(0x17DC50F0)
#define CLASS_3_B463C45003E834B4_METHOD_3_106289055FB804CE_OFFSET UNITYSDK_OFFSET(0x17DC3880)
#define CLASS_3_B463C45003E834B4_METHOD_3_185B399CB78CCCB0_OFFSET UNITYSDK_OFFSET(0x17DC4520)
#define CLASS_3_B463C45003E834B4_METHOD_3_DDFE24F2AFD1C7C5_OFFSET UNITYSDK_OFFSET(0x17DC5230)
#define CLASS_3_B463C45003E834B4_METHOD_3_F2ACC5B1FFC4D55A_OFFSET UNITYSDK_OFFSET(0x17DC51F0)
#define CLASS_3_B463C45003E834B4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17DC3820)
#define CLASS_3_B463C45003E834B4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17DC4D20)
#define CLASS_3_B463C45003E834B4_TICK_OFFSET UNITYSDK_OFFSET(0x17DC5060)
#define CLASS_3_B463C45003E834B4__CTOR_OFFSET UNITYSDK_OFFSET(0x17DC35A0)

inline static constexpr unsigned int Class_3_B463C45003E834B4_TypeDefinitionIndex = 52287;

class Class_3_B463C45003E834B4 : public ::Class_2_A48F3719AA1CF200_4
{
public:
	::RPG::GameCore::RandomConfig* Field_3_0; // 0x18
	::Class_1_43B0AF86156D9901* Field_3_1; // 0x20
	::RPG::GameCore::TaskContext* Field_3_2; // 0x28
	::System::Collections::Generic::List_1<::Class_1_5F51D4049EA87B7B*>* Field_3_3; // 0x30
