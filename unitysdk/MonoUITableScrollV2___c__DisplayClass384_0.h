...
inline static constexpr unsigned int MonoUITableScrollV2___c__DisplayClass384_0_TypeDefinitionIndex = 54097;
...
struct alignas(8) MonoUITableScrollV2___c__DisplayClass384_0
{
	...
	::HorizontalFlowLayoutGroup* hfLayout; // 0x20
	::UnityEngine::UI::HorizontalLayoutGroup* hlayout; // 0x28
	::MonoUITableScrollV2* __4__this; // 0x30
