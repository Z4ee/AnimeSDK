...
#define SCENEPROP_SPRINGBONE_INIT_OFFSET UNITYSDK_OFFSET(0xABBD2A0)
#define SCENEPROP_SPRINGBONE_METHOD_5_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xABBD2F0)
#define SCENEPROP_SPRINGBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xABBD4C0)
#define SCENEPROP_SPRINGBONE_TICK_OFFSET UNITYSDK_OFFSET(0xABBD6D0)
#define SCENEPROP_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xABBD730)
#define SCENEPROP_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xABBE0F0)

inline static constexpr unsigned int SceneProp_SpringBone_TypeDefinitionIndex = 38323;
