...
#define SCENEPROP_SPRINGBONE_INIT_OFFSET UNITYSDK_OFFSET(0xD077610)
#define SCENEPROP_SPRINGBONE_METHOD_5_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xD077660)
#define SCENEPROP_SPRINGBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD077830)
#define SCENEPROP_SPRINGBONE_TICK_OFFSET UNITYSDK_OFFSET(0xD077A40)
#define SCENEPROP_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xD077AA0)
#define SCENEPROP_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xD078460)

inline static constexpr unsigned int SceneProp_SpringBone_TypeDefinitionIndex = 44753;
