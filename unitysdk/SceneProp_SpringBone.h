...
#define SCENEPROP_SPRINGBONE_INIT_OFFSET UNITYSDK_OFFSET(0xB932CE0)
#define SCENEPROP_SPRINGBONE_METHOD_5_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xB932D30)
#define SCENEPROP_SPRINGBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB932F00)
#define SCENEPROP_SPRINGBONE_TICK_OFFSET UNITYSDK_OFFSET(0xB933110)
#define SCENEPROP_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xB933170)
#define SCENEPROP_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xB933B30)

inline static constexpr unsigned int SceneProp_SpringBone_TypeDefinitionIndex = 44207;
