...
#define CLASS_1_4AF9832A6EE2A67F_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E5D19E0)
#define CLASS_1_4AF9832A6EE2A67F_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1E5D15E0)
#define CLASS_1_4AF9832A6EE2A67F_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E5D17A0)
#define CLASS_1_4AF9832A6EE2A67F_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E5D1680)
#define CLASS_1_4AF9832A6EE2A67F_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E5D1890)
#define CLASS_1_4AF9832A6EE2A67F_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E5D1AD0)
#define CLASS_1_4AF9832A6EE2A67F_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E5D1A80)
#define CLASS_1_4AF9832A6EE2A67F_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E5D14D0)
#define CLASS_1_4AF9832A6EE2A67F_1_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1E5D1670)
#define CLASS_1_4AF9832A6EE2A67F_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E5D1530)
#define CLASS_1_4AF9832A6EE2A67F_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E5D18D0)
#define CLASS_1_4AF9832A6EE2A67F_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E5D1930)
#define CLASS_1_4AF9832A6EE2A67F_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E5D1C90)
#define CLASS_1_4AF9832A6EE2A67F_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5D1570)
#define CLASS_1_4AF9832A6EE2A67F_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5D1540)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_4AF9832A6EE2A67F_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4AF9832A6EE2A67F_1_TypeDefinitionIndex)->GetStaticField(0x53CB0);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>** StaticGet_MIJGAGLDBKP()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4AF9832A6EE2A67F_1_TypeDefinitionIndex)->GetStaticField(0x53CB8);
	}
	// static const ::System::Int32 PKCJPOMLOBD = 0x3; // 0x0
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::UInt32>* LDFHCAHNJCB; // 0x10
