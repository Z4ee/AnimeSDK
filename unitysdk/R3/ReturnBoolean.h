...
#define R3_RETURNBOOLEAN_SUBSCRIBECORE_OFFSET UNITYSDK_OFFSET(0x1BF186B0)
#define R3_RETURNBOOLEAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF18730)
#define R3_RETURNBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF18690)
