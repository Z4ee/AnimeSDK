...
#define R3_SINGLEASSIGNMENTDISPOSABLECORE_DISPOSEDSENTINEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EFBBFF0)
#define R3_SINGLEASSIGNMENTDISPOSABLECORE_DISPOSEDSENTINEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EFBC000)
#define R3_SINGLEASSIGNMENTDISPOSABLECORE_DISPOSEDSENTINEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBBFE0)
