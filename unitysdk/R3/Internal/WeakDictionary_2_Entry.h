...
{
	inline static constexpr unsigned int WeakDictionary_2_Entry_TypeDefinitionIndex = 35291;
	...
	public:
		...
		::R3::Internal::WeakDictionary_2_Entry<TKey, TValue>* Prev; // 0x0
		::R3::Internal::WeakDictionary_2_Entry<TKey, TValue>* Next; // 0x0
	};
}
