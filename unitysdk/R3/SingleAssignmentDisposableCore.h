...
#define R3_SINGLEASSIGNMENTDISPOSABLECORE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3B72660)
#define R3_SINGLEASSIGNMENTDISPOSABLECORE_SET_DISPOSABLE_OFFSET UNITYSDK_OFFSET(0x3B72650)
#define R3_SINGLEASSIGNMENTDISPOSABLECORE_THROWALREADYASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1BF18DB0)
