...
#define R3_TRACKINGSTATE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3B726B0)
#define R3_TRACKINGSTATE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B72780)
#define R3_TRACKINGSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B72710)
#define R3_TRACKINGSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B72700)
#define R3_TRACKINGSTATE_GET_ADDTIME_OFFSET UNITYSDK_OFFSET(0x14420)
#define R3_TRACKINGSTATE_GET_FORMATTEDTYPE_OFFSET UNITYSDK_OFFSET(0x6020)
#define R3_TRACKINGSTATE_GET_STACKTRACE_OFFSET UNITYSDK_OFFSET(0x2CFE0)
#define R3_TRACKINGSTATE_GET_TRACKINGID_OFFSET UNITYSDK_OFFSET(0x5F00)
#define R3_TRACKINGSTATE_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x3B726E0)
#define R3_TRACKINGSTATE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B726D0)
#define R3_TRACKINGSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x3B72690)
