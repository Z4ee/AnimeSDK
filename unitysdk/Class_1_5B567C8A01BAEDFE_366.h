...
#define CLASS_1_5B567C8A01BAEDFE_366_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CBB5ED0)
#define CLASS_1_5B567C8A01BAEDFE_366_CLONE_OFFSET UNITYSDK_OFFSET(0x1CBB5BC0)
#define CLASS_1_5B567C8A01BAEDFE_366_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CBB5CD0)
#define CLASS_1_5B567C8A01BAEDFE_366_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CBB5C00)
#define CLASS_1_5B567C8A01BAEDFE_366_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CBB5E30)
#define CLASS_1_5B567C8A01BAEDFE_366_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CBB5F20)
#define CLASS_1_5B567C8A01BAEDFE_366_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CBB5EF0)
#define CLASS_1_5B567C8A01BAEDFE_366_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CBB5B40)
#define CLASS_1_5B567C8A01BAEDFE_366_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CBB5B70)
#define CLASS_1_5B567C8A01BAEDFE_366_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CBB5E60)
#define CLASS_1_5B567C8A01BAEDFE_366_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CBB5EC0)
#define CLASS_1_5B567C8A01BAEDFE_366__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CBB5F70)
#define CLASS_1_5B567C8A01BAEDFE_366__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CBB5B90)
#define CLASS_1_5B567C8A01BAEDFE_366__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBB5B80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_366_TypeDefinitionIndex = 33623;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_366*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_366_TypeDefinitionIndex)->GetStaticField(0x5F780);
	}
