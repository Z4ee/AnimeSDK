...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams))((::PBYTE)hIl2Cpp + CLASS_2_5AC0D8B32AD9BFBE___C__DISPLAYCLASS18_0___FIRETRAILEFFECT_B__0_OFFSET))(this, a1, a2);
	}
};
