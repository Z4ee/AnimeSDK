...
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x18496FE0)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_7A6818D24D36DCBD_OFFSET UNITYSDK_OFFSET(0x18496D20)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_93204878B13617E3_OFFSET UNITYSDK_OFFSET(0x18496710)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x184963E0)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x18496F20)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0x184964F0)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_BEF66C62729AE5AC_OFFSET UNITYSDK_OFFSET(0x18496650)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_D9F540258BBD3958_OFFSET UNITYSDK_OFFSET(0x18496EB0)
#define CLASS_1_0B2B0A0A770F731E_METHOD_1_DB894BACD5A3D28E_OFFSET UNITYSDK_OFFSET(0x18496830)
#define CLASS_1_0B2B0A0A770F731E__CTOR_OFFSET UNITYSDK_OFFSET(0x18497030)
#define CLASS_1_0B2B0A0A770F731E___TRYSHOWINVITATIONDIALOG_B__6_0_OFFSET UNITYSDK_OFFSET(0x18497040)

inline static constexpr unsigned int Class_1_0B2B0A0A770F731E_TypeDefinitionIndex = 75654;

class Class_1_0B2B0A0A770F731E : public ::System::Object
{
public:
	::RPG::Client::UIController* CJIMJEIJLHL; // 0x10
	::System::Collections::Generic::Queue_1<::RPG::Client::ChatMessageData*>* NOPONMHIMMM; // 0x18
	::System::Boolean HDJOGGDMCIO; // 0x20
