...
#define CLASS_2_F9A00379C2678C49_METHOD_2_4186C2378364AF02_OFFSET UNITYSDK_OFFSET(0x16898E50)
#define CLASS_2_F9A00379C2678C49_METHOD_2_5B099EFC0259C285_OFFSET UNITYSDK_OFFSET(0x16898670)
#define CLASS_2_F9A00379C2678C49_METHOD_2_8DCA4BB49D9B3469_OFFSET UNITYSDK_OFFSET(0x16898B80)
#define CLASS_2_F9A00379C2678C49_METHOD_2_B3DBF903EFF6133D_OFFSET UNITYSDK_OFFSET(0x16898750)
#define CLASS_2_F9A00379C2678C49_METHOD_2_CF45B637E197CFE9_OFFSET UNITYSDK_OFFSET(0x16898A50)
#define CLASS_2_F9A00379C2678C49__CTOR_OFFSET UNITYSDK_OFFSET(0x16898660)

inline static constexpr unsigned int Class_2_F9A00379C2678C49_TypeDefinitionIndex = 32998;
...
public:
	...
	::Class_1_B470ECE8B4D9EC2E* Method_2_5B099EFC0259C285(::System::Single a1, ::System::Boolean a2, ::Class_0_16E4307DCC419505_198* a3)
	{
		return ((::Class_1_B470ECE8B4D9EC2E*(*)(::PVOID, ::System::Single, ::System::Boolean, ::Class_0_16E4307DCC419505_198*))((::PBYTE)hIl2Cpp + CLASS_2_F9A00379C2678C49_METHOD_2_5B099EFC0259C285_OFFSET))(this, a1, a2, a3);
	}
	...
	::Class_1_1BEA1E49225DA2AF* Method_2_CF45B637E197CFE9(::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroup& a1, ::Il2CppArray<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroupAction*>* a2)
	{
		return ((::Class_1_1BEA1E49225DA2AF*(*)(::PVOID, ::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroup&, ::Il2CppArray<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroupAction*>*))((::PBYTE)hIl2Cpp + CLASS_2_F9A00379C2678C49_METHOD_2_CF45B637E197CFE9_OFFSET))(this, a1, a2);
	}

	::Class_2_54AE1C44DE8123D2* Method_2_8DCA4BB49D9B3469(::Class_1_1BEA1E49225DA2AF* a1, ::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCell& a2, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellDrop> a3, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellTrigger> a4, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellSaver> a5)
	{
		return ((::Class_2_54AE1C44DE8123D2*(*)(::PVOID, ::Class_1_1BEA1E49225DA2AF*, ::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCell&, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellDrop>, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellTrigger>, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellSaver>))((::PBYTE)hIl2Cpp + CLASS_2_F9A00379C2678C49_METHOD_2_8DCA4BB49D9B3469_OFFSET))(this, a1, a2, a3, a4, a5);
	}
