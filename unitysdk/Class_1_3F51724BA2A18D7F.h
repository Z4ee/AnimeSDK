...
#define CLASS_1_3F51724BA2A18D7F_GET_AUTOBUBBLE_OFFSET UNITYSDK_OFFSET(0x163B9C60)
#define CLASS_1_3F51724BA2A18D7F_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x163B9D20)
#define CLASS_1_3F51724BA2A18D7F_GET_FAILINPUT_OFFSET UNITYSDK_OFFSET(0x163B9E00)
#define CLASS_1_3F51724BA2A18D7F_GET_IGNORELOOP_OFFSET UNITYSDK_OFFSET(0x163B9DA0)
#define CLASS_1_3F51724BA2A18D7F_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x163B9C20)
#define CLASS_1_3F51724BA2A18D7F_GET_INPUTNOTECOUNT_OFFSET UNITYSDK_OFFSET(0x163B9CA0)
#define CLASS_1_3F51724BA2A18D7F_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x163B9C40)
#define CLASS_1_3F51724BA2A18D7F_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x163B9D80)
#define CLASS_1_3F51724BA2A18D7F_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x163B9D60)
#define CLASS_1_3F51724BA2A18D7F_GET_OWNERMODE_OFFSET UNITYSDK_OFFSET(0x163B9C80)
#define CLASS_1_3F51724BA2A18D7F_GET_PERFECTINPUT_OFFSET UNITYSDK_OFFSET(0x163B9DE0)
#define CLASS_1_3F51724BA2A18D7F_GET_REALENDTIME_OFFSET UNITYSDK_OFFSET(0x163B9CE0)
#define CLASS_1_3F51724BA2A18D7F_GET_REALSTARTTIME_OFFSET UNITYSDK_OFFSET(0x163B9CC0)
#define CLASS_1_3F51724BA2A18D7F_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x163B9D00)
#define CLASS_1_3F51724BA2A18D7F_GET_SUCCESSINPUT_OFFSET UNITYSDK_OFFSET(0x163B9DC0)
#define CLASS_1_3F51724BA2A18D7F_GET_TUTORIALSCORE_OFFSET UNITYSDK_OFFSET(0x163B9D40)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_05253A2C50FAEC90_OFFSET UNITYSDK_OFFSET(0x163B9990)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_0A7E56A59F184B0A_OFFSET UNITYSDK_OFFSET(0x163B98C0)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_1397E3708A9DBEBA_OFFSET UNITYSDK_OFFSET(0x163B8EA0)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x163B9BC0)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x163B9B70)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x163B9460)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_7EACFD3740004695_OFFSET UNITYSDK_OFFSET(0x163B9850)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0x163B93B0)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x163B9510)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x163B94C0)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_FAF01E6C61157965_OFFSET UNITYSDK_OFFSET(0x163B9560)
#define CLASS_1_3F51724BA2A18D7F_METHOD_1_FCB7990FCD402039_OFFSET UNITYSDK_OFFSET(0x163B96D0)
#define CLASS_1_3F51724BA2A18D7F_SET_AUTOBUBBLE_OFFSET UNITYSDK_OFFSET(0x163B9C70)
#define CLASS_1_3F51724BA2A18D7F_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x163B9D30)
#define CLASS_1_3F51724BA2A18D7F_SET_FAILINPUT_OFFSET UNITYSDK_OFFSET(0x163B9E10)
#define CLASS_1_3F51724BA2A18D7F_SET_IGNORELOOP_OFFSET UNITYSDK_OFFSET(0x163B9DB0)
#define CLASS_1_3F51724BA2A18D7F_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x163B9C30)
#define CLASS_1_3F51724BA2A18D7F_SET_INPUTNOTECOUNT_OFFSET UNITYSDK_OFFSET(0x163B9CB0)
#define CLASS_1_3F51724BA2A18D7F_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x163B9C50)
#define CLASS_1_3F51724BA2A18D7F_SET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x163B9D90)
#define CLASS_1_3F51724BA2A18D7F_SET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x163B9D70)
#define CLASS_1_3F51724BA2A18D7F_SET_OWNERMODE_OFFSET UNITYSDK_OFFSET(0x163B9C90)
#define CLASS_1_3F51724BA2A18D7F_SET_PERFECTINPUT_OFFSET UNITYSDK_OFFSET(0x163B9DF0)
#define CLASS_1_3F51724BA2A18D7F_SET_REALENDTIME_OFFSET UNITYSDK_OFFSET(0x163B9CF0)
#define CLASS_1_3F51724BA2A18D7F_SET_REALSTARTTIME_OFFSET UNITYSDK_OFFSET(0x163B9CD0)
#define CLASS_1_3F51724BA2A18D7F_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x163B9D10)
#define CLASS_1_3F51724BA2A18D7F_SET_SUCCESSINPUT_OFFSET UNITYSDK_OFFSET(0x163B9DD0)
#define CLASS_1_3F51724BA2A18D7F_SET_TUTORIALSCORE_OFFSET UNITYSDK_OFFSET(0x163B9D50)
#define CLASS_1_3F51724BA2A18D7F__CCTOR_OFFSET UNITYSDK_OFFSET(0x163B9E20)
#define CLASS_1_3F51724BA2A18D7F__CTOR_OFFSET UNITYSDK_OFFSET(0x163B8520)

inline static constexpr unsigned int Class_1_3F51724BA2A18D7F_TypeDefinitionIndex = 60309;

class Class_1_3F51724BA2A18D7F : public ::System::Object
{
public:
	static ::System::String** StaticGet_FLIIKCMBHMF()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3F51724BA2A18D7F_TypeDefinitionIndex)->GetStaticField(0x5C5F0);
	}
	::RPG::GameCore::GameEntity* JIKFGDDKPGD; // 0x10
	::Class_1_422F2D395BEF4FA5* _OwnerMode_k__BackingField; // 0x18
	::Il2CppArray<::System::String*>* EMJEMMIDBOA; // 0x20
	::Il2CppArray<::System::String*>* DFBLMGNPONL; // 0x28
	::System::Collections::Generic::List_1<::Class_1_C67F599303150E7F*>* AFEDOJIIAOK; // 0x30
	::System::String* IIOKHKJFPJP; // 0x38
	::System::Collections::Generic::List_1<::System::Int32>* BHIELOIELOF; // 0x40
	::System::Single _StartTime_k__BackingField; // 0x48
	::System::Single IDMGGEHNDBC; // 0x4C
	::System::Single _RealEndTime_k__BackingField; // 0x50
	::System::Int32 _Index_k__BackingField; // 0x54
	::System::Int32 _PerfectInput_k__BackingField; // 0x58
	::System::Boolean _IsFinish_k__BackingField; // 0x5C
	::System::Boolean _IsEmpty_k__BackingField; // 0x5D
	::System::Boolean _IgnoreLoop_k__BackingField; // 0x5E
	::System::Boolean _IsActive_k__BackingField; // 0x5F
	::System::Single JGJBJKELJDD; // 0x60
	::System::Boolean _AutoBubble_k__BackingField; // 0x64
	::System::Boolean _TutorialScore_k__BackingField; // 0x65
	::System::Single _RealStartTime_k__BackingField; // 0x68
	::System::Int32 IKDNNMFCBPE; // 0x6C
	::System::Int32 _FailInput_k__BackingField; // 0x70
	::System::UInt32 _InputNoteCount_k__BackingField; // 0x74
	::System::Int32 _SuccessInput_k__BackingField; // 0x78
	::System::Int32 INLKDCHNFPP; // 0x7C
	::System::Single _EndTime_k__BackingField; // 0x80
