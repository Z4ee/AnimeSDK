...
#define AKGAMEOBJPOSOFFSETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A20A0)

inline static constexpr unsigned int AkGameObjPosOffsetData_TypeDefinitionIndex = 43740;
