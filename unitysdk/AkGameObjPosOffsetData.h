...
#define AKGAMEOBJPOSOFFSETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8BF150)

inline static constexpr unsigned int AkGameObjPosOffsetData_TypeDefinitionIndex = 33790;
