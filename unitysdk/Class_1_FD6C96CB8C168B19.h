...
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_11E65074F3057FE0_OFFSET UNITYSDK_OFFSET(0x120CC6A0)
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_32430858A26EFDC4_OFFSET UNITYSDK_OFFSET(0x120CC5B0)
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_53D54D7564011497_OFFSET UNITYSDK_OFFSET(0x120CC080)
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_D323E239C12BCD26_OFFSET UNITYSDK_OFFSET(0x120CC430)
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_E1DD8B28A740414D_OFFSET UNITYSDK_OFFSET(0x120CC330)
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_EF68057CA19E8AFD_OFFSET UNITYSDK_OFFSET(0x120CCD20)
#define CLASS_1_FD6C96CB8C168B19_METHOD_1_F7727D8D7C86D0AF_OFFSET UNITYSDK_OFFSET(0x120CC8C0)

inline static constexpr unsigned int Class_1_FD6C96CB8C168B19_TypeDefinitionIndex = 52964;

class Class_1_FD6C96CB8C168B19 : public ::System::Object
{
public:
	static ::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::AvatarShowSetting*>** StaticGet_Field_1_0()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::AvatarShowSetting*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FD6C96CB8C168B19_TypeDefinitionIndex)->GetStaticField(0x2EBC0);
	}
	static ::MoleMole::ConfigGalGameAvatarShow** StaticGet_Field_1_1()
	{
		return (::MoleMole::ConfigGalGameAvatarShow**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FD6C96CB8C168B19_TypeDefinitionIndex)->GetStaticField(0x2EBC8);
	}
