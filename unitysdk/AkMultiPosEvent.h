...
#define AKMULTIPOSEVENT_FINISHEDPLAYING_OFFSET UNITYSDK_OFFSET(0x18BC1650)
#define AKMULTIPOSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC16B0)

inline static constexpr unsigned int AkMultiPosEvent_TypeDefinitionIndex = 34644;
