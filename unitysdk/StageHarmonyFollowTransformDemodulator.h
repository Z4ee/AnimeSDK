...
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_ISCUSTOMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD097720)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_MAINCAMTRANS_OFFSET UNITYSDK_OFFSET(0xD097730)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_BFED9CB4A51C4631_OFFSET UNITYSDK_OFFSET(0xD0977E0)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xD0982E0)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD098330)

inline static constexpr unsigned int StageHarmonyFollowTransformDemodulator_TypeDefinitionIndex = 44822;
