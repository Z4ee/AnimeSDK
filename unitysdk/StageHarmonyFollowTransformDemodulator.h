...
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_ISCUSTOMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB952380)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_MAINCAMTRANS_OFFSET UNITYSDK_OFFSET(0xB952390)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_BFED9CB4A51C4631_OFFSET UNITYSDK_OFFSET(0xB952440)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xB952F50)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB952FA0)

inline static constexpr unsigned int StageHarmonyFollowTransformDemodulator_TypeDefinitionIndex = 44276;
