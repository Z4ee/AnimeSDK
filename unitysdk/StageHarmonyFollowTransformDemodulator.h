...
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_ISCUSTOMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xABDC770)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_MAINCAMTRANS_OFFSET UNITYSDK_OFFSET(0xABDC780)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_BFED9CB4A51C4631_OFFSET UNITYSDK_OFFSET(0xABDC830)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xABDD340)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xABDD390)

inline static constexpr unsigned int StageHarmonyFollowTransformDemodulator_TypeDefinitionIndex = 38392;
