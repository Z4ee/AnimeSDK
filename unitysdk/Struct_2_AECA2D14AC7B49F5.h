...
#define STRUCT_2_AECA2D14AC7B49F5_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x3B398D0)
#define STRUCT_2_AECA2D14AC7B49F5_METHOD_2_260E97EFE04A5125_OFFSET UNITYSDK_OFFSET(0x1A831510)
#define STRUCT_2_AECA2D14AC7B49F5_METHOD_2_6775604F93DD7110_OFFSET UNITYSDK_OFFSET(0x3B39940)
#define STRUCT_2_AECA2D14AC7B49F5_METHOD_2_9C92150C5035DA7C_OFFSET UNITYSDK_OFFSET(0x3B39830)

inline static constexpr unsigned int Struct_2_AECA2D14AC7B49F5_TypeDefinitionIndex = 57328;

struct alignas(4) Struct_2_AECA2D14AC7B49F5
{
	::System::Int32 OJDMPJIOBMJ; // 0x10
	::System::Single NFELGGAPKMO; // 0x14
	::System::Boolean MGLKMINMINB; // 0x18
	::System::Single JBCFPAEELBL; // 0x1C
	::System::Boolean ANDIMGMEJED; // 0x20
