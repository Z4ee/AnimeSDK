...
#define CLASS_2_4CB946A6903FE355_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18478C90)
#define CLASS_2_4CB946A6903FE355_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18478DA0)
#define CLASS_2_4CB946A6903FE355_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18478CF0)
#define CLASS_2_4CB946A6903FE355_TICK_OFFSET UNITYSDK_OFFSET(0x18478D40)
#define CLASS_2_4CB946A6903FE355__CTOR_OFFSET UNITYSDK_OFFSET(0x18478C80)

inline static constexpr unsigned int Class_2_4CB946A6903FE355_TypeDefinitionIndex = 53483;

class Class_2_4CB946A6903FE355 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetClientGroupProperty* OFKGLJOAMLD; // 0x18
