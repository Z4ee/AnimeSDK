...
#define CLASS_3_332C73C39C8B53F9_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1424B750)
#define CLASS_3_332C73C39C8B53F9__CTOR_OFFSET UNITYSDK_OFFSET(0x1424B720)

inline static constexpr unsigned int Class_3_332C73C39C8B53F9_TypeDefinitionIndex = 49383;
