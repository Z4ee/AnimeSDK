...
#define CLASS_1_B93C65313845AAEB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A54220)
#define CLASS_1_B93C65313845AAEB_METHOD_1_098E71CA53F64B12_OFFSET UNITYSDK_OFFSET(0x18A54330)
#define CLASS_1_B93C65313845AAEB_METHOD_1_0DC6BC4DBC5B422B_OFFSET UNITYSDK_OFFSET(0x18A545E0)
#define CLASS_1_B93C65313845AAEB_METHOD_1_F4AB2CFCF5494DB7_OFFSET UNITYSDK_OFFSET(0x18A54530)
#define CLASS_1_B93C65313845AAEB__CTOR_OFFSET UNITYSDK_OFFSET(0x18A53B10)

inline static constexpr unsigned int Class_1_B93C65313845AAEB_TypeDefinitionIndex = 50428;

class Class_1_B93C65313845AAEB : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_3_F946D4081774B88D*>* ECIKLDGMMNJ; // 0x10
	::Il2CppArray<::System::Collections::Generic::HashSet_1<::Class_3_F946D4081774B88D*>*>* IDJPMKDPMKJ; // 0x18
	::System::Boolean IKCCLIAIGCL; // 0x20
