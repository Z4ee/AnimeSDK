...
#define MESSAGEPACK_TINYJSONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCC710)

namespace MessagePack
{
	inline static constexpr unsigned int TinyJsonException_TypeDefinitionIndex = 27439;
