...
#define MESSAGEPACK_MESSAGEPACKSECURITY_INT64EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EA99BE0)
#define MESSAGEPACK_MESSAGEPACKSECURITY_INT64EQUALITYCOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA99CA0)
#define MESSAGEPACK_MESSAGEPACKSECURITY_INT64EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA99C40)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSecurity_Int64EqualityComparer_TypeDefinitionIndex = 29832;
	...
	public:
		...
		{
			return (::MessagePack::MessagePackSecurity_Int64EqualityComparer**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSecurity_Int64EqualityComparer_TypeDefinitionIndex)->GetStaticField(0x26390);
		}
