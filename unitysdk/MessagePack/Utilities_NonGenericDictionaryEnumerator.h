...
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x3828610)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2BF00A0)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x2BF0150)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x38286D0)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x3828550)

namespace MessagePack
{
	inline static constexpr unsigned int Utilities_NonGenericDictionaryEnumerator_TypeDefinitionIndex = 7203;
