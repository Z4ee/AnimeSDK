...
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x3B5ABD0)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B5AC00)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x3B5AC10)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x3B5ABF0)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x3B5ABC0)
