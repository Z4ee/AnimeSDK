...
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x20C8EC0)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1517960)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1517A10)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x20C8F80)
#define MESSAGEPACK_UTILITIES_NONGENERICDICTIONARYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x20C8E00)

namespace MessagePack
{
	inline static constexpr unsigned int Utilities_NonGenericDictionaryEnumerator_TypeDefinitionIndex = 9103;
