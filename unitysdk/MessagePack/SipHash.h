...
#define MESSAGEPACK_SIPHASH_COMPUTE_OFFSET UNITYSDK_OFFSET(0x15D75E90)
#define MESSAGEPACK_SIPHASH__CTOR_OFFSET UNITYSDK_OFFSET(0x15D76950)

namespace MessagePack
{
	inline static constexpr unsigned int SipHash_TypeDefinitionIndex = 9098;

	class SipHash : public ::System::Object
	{
	public:
		::System::UInt64 initialState0; // 0x10
		::System::UInt64 initialState1; // 0x18
