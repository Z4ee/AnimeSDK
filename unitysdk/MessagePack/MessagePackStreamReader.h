...
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_DISCARDBUFFEREDDATA_OFFSET UNITYSDK_OFFSET(0x1A1FDEE0)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1FDF20)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_GET_READDATA_OFFSET UNITYSDK_OFFSET(0x1A1FDED0)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_GET_REMAININGBYTES_OFFSET UNITYSDK_OFFSET(0x1A1FDCB0)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_RECYCLELASTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1FDF70)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_TRYREADNEXTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1FE010)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1FDBE0)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1FDBD0)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackStreamReader_TypeDefinitionIndex = 27145;

	class MessagePackStreamReader : public ::System::Object
	{
	public:
		::MessagePack::SequencePool_Rental sequenceRental; // 0x10
		::System::Nullable_1<::System::SequencePosition> endOfLastMessage; // 0x20
