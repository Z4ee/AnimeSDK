...
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E6CDAD0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E6D0ED0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E6D0F60)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6D0E50)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializationException_TypeDefinitionIndex = 31394;
