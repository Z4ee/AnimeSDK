...
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF23C50)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AF270B0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AF27140)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF27030)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializationException_TypeDefinitionIndex = 26970;
