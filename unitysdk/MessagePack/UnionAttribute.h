...
#define MESSAGEPACK_UNIONATTRIBUTE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1D069B50)
#define MESSAGEPACK_UNIONATTRIBUTE_GET_SUBTYPE_OFFSET UNITYSDK_OFFSET(0x1D069B70)
#define MESSAGEPACK_UNIONATTRIBUTE_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1D069B60)
#define MESSAGEPACK_UNIONATTRIBUTE_SET_SUBTYPE_OFFSET UNITYSDK_OFFSET(0x1D069B80)
#define MESSAGEPACK_UNIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D069BA0)
#define MESSAGEPACK_UNIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069B90)

namespace MessagePack
{
	inline static constexpr unsigned int UnionAttribute_TypeDefinitionIndex = 31393;
