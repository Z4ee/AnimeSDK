...
#define MESSAGEPACK_MESSAGEPACKPRIMITIVES_DECODERS_READINT64NEGATIVEFIXINT_READ_OFFSET UNITYSDK_OFFSET(0x14FAEB50)
#define MESSAGEPACK_MESSAGEPACKPRIMITIVES_DECODERS_READINT64NEGATIVEFIXINT__CCTOR_OFFSET UNITYSDK_OFFSET(0x14FAEB90)
#define MESSAGEPACK_MESSAGEPACKPRIMITIVES_DECODERS_READINT64NEGATIVEFIXINT__CTOR_OFFSET UNITYSDK_OFFSET(0x14FAEB40)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackPrimitives_Decoders_ReadInt64NegativeFixInt_TypeDefinitionIndex = 7139;
	...
	public:
		...
		{
			return (::MessagePack::MessagePackPrimitives_Decoders_ReadInt64NegativeFixInt**)Il2CppClass::FromTypeDefinitionIndex(MessagePackPrimitives_Decoders_ReadInt64NegativeFixInt_TypeDefinitionIndex)->GetStaticField(0xAFD0);
		}
