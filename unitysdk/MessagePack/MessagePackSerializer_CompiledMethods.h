...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x15D7EA80)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_GET_PREFERINTERPRETATION_OFFSET UNITYSDK_OFFSET(0x15D7EA30)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_THROWREFSTRUCTNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x15D7ECE0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x15D7AB00)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializer_CompiledMethods_TypeDefinitionIndex = 9070;
