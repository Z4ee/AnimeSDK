...
#define MESSAGEPACK_LZ4_LZ4CODEC_HASHTABLEPOOL_GETINTHASHTABLEPOOL_OFFSET UNITYSDK_OFFSET(0x1D40B0A0)
#define MESSAGEPACK_LZ4_LZ4CODEC_HASHTABLEPOOL_GETUINTHASHTABLEPOOL_OFFSET UNITYSDK_OFFSET(0x1D40AEE0)
#define MESSAGEPACK_LZ4_LZ4CODEC_HASHTABLEPOOL_GETUSHORTHASHTABLEPOOL_OFFSET UNITYSDK_OFFSET(0x1D40AD30)

namespace MessagePack::LZ4
{
	inline static constexpr unsigned int LZ4Codec_HashTablePool_TypeDefinitionIndex = 30587;
