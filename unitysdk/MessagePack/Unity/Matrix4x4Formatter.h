...
#define MESSAGEPACK_UNITY_MATRIX4X4FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D282250)
#define MESSAGEPACK_UNITY_MATRIX4X4FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D282130)
#define MESSAGEPACK_UNITY_MATRIX4X4FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D282F30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Matrix4x4Formatter_TypeDefinitionIndex = 9837;
