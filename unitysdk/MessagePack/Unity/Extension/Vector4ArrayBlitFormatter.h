...
#define MESSAGEPACK_UNITY_EXTENSION_VECTOR4ARRAYBLITFORMATTER_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1D280630)
#define MESSAGEPACK_UNITY_EXTENSION_VECTOR4ARRAYBLITFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D280640)

namespace MessagePack::Unity::Extension
{
	inline static constexpr unsigned int Vector4ArrayBlitFormatter_TypeDefinitionIndex = 9867;
