...
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BCC8110)
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BCC80E0)
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC8280)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int LayerMaskFormatter_TypeDefinitionIndex = 30092;
