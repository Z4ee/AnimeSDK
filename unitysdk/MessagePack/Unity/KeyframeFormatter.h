...
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C62B7E0)
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C62B780)
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C62BA30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int KeyframeFormatter_TypeDefinitionIndex = 30865;
