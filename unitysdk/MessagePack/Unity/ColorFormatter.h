...
#define MESSAGEPACK_UNITY_COLORFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D27F5D0)
#define MESSAGEPACK_UNITY_COLORFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D27F560)
#define MESSAGEPACK_UNITY_COLORFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27FA30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int ColorFormatter_TypeDefinitionIndex = 9830;
