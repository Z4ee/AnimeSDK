...
#define MESSAGEPACK_UNITY_UNITYRESOLVER_WITHSTANDARDRESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EF759A0)
#define MESSAGEPACK_UNITY_UNITYRESOLVER_WITHSTANDARDRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF75990)
