...
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6E4BC0)
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6E4B80)
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E4D60)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector2IntFormatter_TypeDefinitionIndex = 29629;
