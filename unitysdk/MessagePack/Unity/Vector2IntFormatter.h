...
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EA9A900)
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1EA9A8C0)
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA9AAA0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector2IntFormatter_TypeDefinitionIndex = 30765;
