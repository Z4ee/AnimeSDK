...
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B66D310)
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B66D2B0)
#define MESSAGEPACK_UNITY_VECTOR2INTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66CF30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector2IntFormatter_TypeDefinitionIndex = 10123;
