...
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15D23860)
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x15D237F0)
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D23CC0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int QuaternionFormatter_TypeDefinitionIndex = 9852;
