...
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D803C00)
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D803BA0)
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D803E40)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int QuaternionFormatter_TypeDefinitionIndex = 29313;
