...
#define MESSAGEPACK_UNITY_BOUNDSFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D27E3F0)
#define MESSAGEPACK_UNITY_BOUNDSFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D27E0E0)
#define MESSAGEPACK_UNITY_BOUNDSFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27E890)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int BoundsFormatter_TypeDefinitionIndex = 9831;
