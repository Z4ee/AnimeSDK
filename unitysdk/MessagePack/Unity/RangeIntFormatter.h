...
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B32BC90)
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B32BC50)
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B32BE30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RangeIntFormatter_TypeDefinitionIndex = 27654;
