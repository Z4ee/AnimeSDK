...
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6E49D0)
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6E4990)
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E4B70)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RangeIntFormatter_TypeDefinitionIndex = 30499;
