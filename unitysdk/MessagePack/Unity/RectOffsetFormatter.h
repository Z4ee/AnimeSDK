...
#define MESSAGEPACK_UNITY_RECTOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0B5820)
#define MESSAGEPACK_UNITY_RECTOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0B57A0)
#define MESSAGEPACK_UNITY_RECTOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5A30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RectOffsetFormatter_TypeDefinitionIndex = 27003;
