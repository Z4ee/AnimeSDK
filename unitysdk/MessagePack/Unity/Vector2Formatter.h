...
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18134C90)
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x18134C10)
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18134BB0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector2Formatter_TypeDefinitionIndex = 9811;
