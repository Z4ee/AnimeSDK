...
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17326350)
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x173262F0)
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17326290)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector2Formatter_TypeDefinitionIndex = 9984;
