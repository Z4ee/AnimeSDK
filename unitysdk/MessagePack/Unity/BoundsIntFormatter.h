...
#define MESSAGEPACK_UNITY_BOUNDSINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D27EBA0)
#define MESSAGEPACK_UNITY_BOUNDSINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D27E8A0)
#define MESSAGEPACK_UNITY_BOUNDSINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27F070)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int BoundsIntFormatter_TypeDefinitionIndex = 9848;
