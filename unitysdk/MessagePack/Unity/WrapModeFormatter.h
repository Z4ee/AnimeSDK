...
#define MESSAGEPACK_UNITY_WRAPMODEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D289360)
#define MESSAGEPACK_UNITY_WRAPMODEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D289350)
#define MESSAGEPACK_UNITY_WRAPMODEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D287FE0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int WrapModeFormatter_TypeDefinitionIndex = 9833;
