...
#define MESSAGEPACK_UNITY_WRAPMODEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D7C2F60)
#define MESSAGEPACK_UNITY_WRAPMODEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D7C2F50)
#define MESSAGEPACK_UNITY_WRAPMODEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C2F70)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int WrapModeFormatter_TypeDefinitionIndex = 29526;
