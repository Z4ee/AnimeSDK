...
#define MESSAGEPACK_UNITY_VECTOR3FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADB6840)
#define MESSAGEPACK_UNITY_VECTOR3FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADB67F0)
#define MESSAGEPACK_UNITY_VECTOR3FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADB6A30)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector3Formatter_TypeDefinitionIndex = 27936;
