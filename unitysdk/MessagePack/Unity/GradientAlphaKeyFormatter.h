...
#define MESSAGEPACK_UNITY_GRADIENTALPHAKEYFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D536DA0)
#define MESSAGEPACK_UNITY_GRADIENTALPHAKEYFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D536D40)
#define MESSAGEPACK_UNITY_GRADIENTALPHAKEYFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D536F60)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int GradientAlphaKeyFormatter_TypeDefinitionIndex = 29221;
