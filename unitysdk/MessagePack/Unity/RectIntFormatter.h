...
#define MESSAGEPACK_UNITY_RECTINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17321F40)
#define MESSAGEPACK_UNITY_RECTINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x17321ED0)
#define MESSAGEPACK_UNITY_RECTINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x173223A0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RectIntFormatter_TypeDefinitionIndex = 10005;
