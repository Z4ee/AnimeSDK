...
#define MESSAGEPACK_UNITY_COLOR32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15D1FC20)
#define MESSAGEPACK_UNITY_COLOR32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x15D1FBA0)
#define MESSAGEPACK_UNITY_COLOR32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D20070)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Color32Formatter_TypeDefinitionIndex = 9864;
