...
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D390E50)
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D390B70)
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3912E0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int AnimationCurveFormatter_TypeDefinitionIndex = 29556;
