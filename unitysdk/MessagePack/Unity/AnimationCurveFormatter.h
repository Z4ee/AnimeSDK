...
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15D1EA20)
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x15D1E720)
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D1EEB0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int AnimationCurveFormatter_TypeDefinitionIndex = 9859;
