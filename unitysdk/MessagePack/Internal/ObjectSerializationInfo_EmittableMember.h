...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1DB99170)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1DB99210)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GETDATAMEMBERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DB99120)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GETMESSAGEPACKFORMATTERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DB990D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x1DB98FD0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1DB98F50)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISEXPLICITCONTRACT_OFFSET UNITYSDK_OFFSET(0x1DB990B0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISFIELD_OFFSET UNITYSDK_OFFSET(0x1DB98F00)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1DB98EF0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1DB98F30)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1DB99050)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x1DB98F10)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DB99010)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1DB98FF0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1DB98F70)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DB98F90)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x1DB98FE0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1DB98F60)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISEXPLICITCONTRACT_OFFSET UNITYSDK_OFFSET(0x1DB990C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1DB98F40)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x1DB98F20)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1DB99000)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1DB98F80)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB992B0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo_EmittableMember_TypeDefinitionIndex = 30387;
	...
	public:
		...
		::System::Boolean _IsWritable_k__BackingField; // 0x2C
		::System::Boolean _IsReadable_k__BackingField; // 0x2D
		::System::Boolean _IsExplicitContract_k__BackingField; // 0x2E
