...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x15D53A50)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITPRESTOREVALUE_OFFSET UNITYSDK_OFFSET(0x15D575E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x15D566E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GETDATAMEMBERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x15D5F4B0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GETMESSAGEPACKFORMATTERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x15D52D30)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x15D5E890)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_INTKEY_OFFSET UNITYSDK_OFFSET(0x15D608D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISEXPLICITCONTRACT_OFFSET UNITYSDK_OFFSET(0x15D60920)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISINITONLY_OFFSET UNITYSDK_OFFSET(0x15D5E5D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISPROBLEMATICINITPROPERTY_OFFSET UNITYSDK_OFFSET(0x15D60940)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISPROPERTY_OFFSET UNITYSDK_OFFSET(0x15D53030)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x15D608B0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x15D569A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x15D60870)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISWRITTENBYCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x15D60890)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_MEMBERINFO_OFFSET UNITYSDK_OFFSET(0x15D60910)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15D52DE0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x15D5E740)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x15D608F0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x15D52EA0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_ONTYPECREATED_OFFSET UNITYSDK_OFFSET(0x15D52930)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_INTKEY_OFFSET UNITYSDK_OFFSET(0x15D608E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISEXPLICITCONTRACT_OFFSET UNITYSDK_OFFSET(0x15D60930)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISPROBLEMATICINITPROPERTY_OFFSET UNITYSDK_OFFSET(0x15D60950)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x15D608C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x15D60880)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISWRITTENBYCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x15D608A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x15D60900)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D5F960)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo_EmittableMember_TypeDefinitionIndex = 9187;

	class ObjectSerializationInfo_EmittableMember : public ::System::Object
	{
	public:
		::System::Reflection::MemberInfo* _MemberInfo_k__BackingField; // 0x10
		::System::Delegate* setterHelperDelegate; // 0x18
		::System::String* _StringKey_k__BackingField; // 0x20
		::System::Reflection::Emit::FieldBuilder* setterHelperField; // 0x28
		::System::Boolean _IsWrittenByConstructor_k__BackingField; // 0x30
		::System::Boolean _IsExplicitContract_k__BackingField; // 0x31
		::System::Int32 _IntKey_k__BackingField; // 0x34
		::System::Boolean _IsProblematicInitProperty_k__BackingField; // 0x38
		::System::Boolean _IsReadable_k__BackingField; // 0x39
		::System::Boolean _IsWritable_k__BackingField; // 0x3A
