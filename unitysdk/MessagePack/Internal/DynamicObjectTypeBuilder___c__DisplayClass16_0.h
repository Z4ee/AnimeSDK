...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS16_0__BUILDDESERIALIZEINTERNALDESERIALIZELOOPINTKEY_G__FORBODY_0_OFFSET UNITYSDK_OFFSET(0x15D5A230)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15D56A90)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass16_0_TypeDefinitionIndex = 9176;
	...
	public:
		...
		::System::Reflection::Emit::LocalBuilder* localResolver; // 0x28
		::MessagePack::Internal::ArgumentField options; // 0x30
		::MessagePack::Internal::ArgumentField reader; // 0x40
		::System::Reflection::Emit::LocalBuilder* key; // 0x50
		...
		::System::Boolean canOverwrite; // 0x70
		::System::Reflection::Emit::Label switchDefault; // 0x74
