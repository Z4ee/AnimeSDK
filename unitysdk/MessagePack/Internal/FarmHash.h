...
#define MESSAGEPACK_INTERNAL_FARMHASH_FETCH32_OFFSET UNITYSDK_OFFSET(0x1A29BF60)
#define MESSAGEPACK_INTERNAL_FARMHASH_FETCH64_OFFSET UNITYSDK_OFFSET(0x1A29C620)
#define MESSAGEPACK_INTERNAL_FARMHASH_FMIX_OFFSET UNITYSDK_OFFSET(0x1A29BF80)
#define MESSAGEPACK_INTERNAL_FARMHASH_H32_OFFSET UNITYSDK_OFFSET(0x1A29CC30)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN0TO4_OFFSET UNITYSDK_OFFSET(0x1A29BFD0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN13TO24_OFFSET UNITYSDK_OFFSET(0x1A29C220)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN5TO12_OFFSET UNITYSDK_OFFSET(0x1A29C180)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32_1_OFFSET UNITYSDK_OFFSET(0x1A29C2E0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32_OFFSET UNITYSDK_OFFSET(0x1A29BE60)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64NA_OFFSET UNITYSDK_OFFSET(0x1A29CFA0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64UO_OFFSET UNITYSDK_OFFSET(0x1A29D260)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64_1_OFFSET UNITYSDK_OFFSET(0x1A29C690)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64_OFFSET UNITYSDK_OFFSET(0x1A29C5E0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN0TO16_OFFSET UNITYSDK_OFFSET(0x1A29CAB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN16_OFFSET UNITYSDK_OFFSET(0x1A29C660)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN17TO32_OFFSET UNITYSDK_OFFSET(0x1A29CBB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN33TO64_OFFSET UNITYSDK_OFFSET(0x1A29CCB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN65TO96_OFFSET UNITYSDK_OFFSET(0x1A29CDB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_H_OFFSET UNITYSDK_OFFSET(0x1A29D230)
#define MESSAGEPACK_INTERNAL_FARMHASH_MUR_OFFSET UNITYSDK_OFFSET(0x1A29BFB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_ROTATE32_OFFSET UNITYSDK_OFFSET(0x1A29BF70)
#define MESSAGEPACK_INTERNAL_FARMHASH_ROTATE64_OFFSET UNITYSDK_OFFSET(0x1A29C630)
#define MESSAGEPACK_INTERNAL_FARMHASH_SHIFTMIX_OFFSET UNITYSDK_OFFSET(0x1A29C650)
#define MESSAGEPACK_INTERNAL_FARMHASH_SWAP_OFFSET UNITYSDK_OFFSET(0x1A29C610)
#define MESSAGEPACK_INTERNAL_FARMHASH_WEAKHASHLEN32WITHSEEDS_1_OFFSET UNITYSDK_OFFSET(0x1A29CF60)
#define MESSAGEPACK_INTERNAL_FARMHASH_WEAKHASHLEN32WITHSEEDS_OFFSET UNITYSDK_OFFSET(0x1A29CF20)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int FarmHash_TypeDefinitionIndex = 26521;
