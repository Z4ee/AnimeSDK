...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_CREATEORNULL_OFFSET UNITYSDK_OFFSET(0x1A29D600)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1A2A2160)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A2A2100)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A29D590)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A29D5B0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1A29D560)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x1A29D530)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRINGKEY_OFFSET UNITYSDK_OFFSET(0x1A29D550)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A29D580)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1A29D5D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A29D510)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A29D5A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A29D5C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1A29D570)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x1A29D540)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1A29D5E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A29D520)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_TRYGETNEXTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A2A21C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29D5F0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo_TypeDefinitionIndex = 27833;
