...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BDF90)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__EMITSEARCHNEXTCORE_B__2_OFFSET UNITYSDK_OFFSET(0x1D7BDFD0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__EMITSEARCHNEXTCORE_B__3_OFFSET UNITYSDK_OFFSET(0x1D7BDFA0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode___c__DisplayClass16_0_TypeDefinitionIndex = 29677;
