...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14F7DFD0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__EMITSEARCHNEXTCORE_B__2_OFFSET UNITYSDK_OFFSET(0x14F7E210)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__EMITSEARCHNEXTCORE_B__3_OFFSET UNITYSDK_OFFSET(0x14F7E180)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode___c__DisplayClass16_0_TypeDefinitionIndex = 7244;
