...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B6AC790)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_PROPERTYINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B6ACE50)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_PROPERTYINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6ACDE0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B6ACED0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6ACE40)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B6ACDF0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6AC670)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AB060)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLPROPERTIES_D__30___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B6AC690)
