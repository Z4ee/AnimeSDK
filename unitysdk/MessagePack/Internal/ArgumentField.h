...
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARGA_OFFSET UNITYSDK_OFFSET(0x9EB650)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARG_OFFSET UNITYSDK_OFFSET(0x9EB640)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0x9EB620)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0x9EB660)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9EB530)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB520)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 30160;
