...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1814E6C0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1814E7F0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1814E780)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1814E870)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1814E7E0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1814E790)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1814E6B0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1814D100)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode__YieldChildren_d__14_TypeDefinitionIndex = 7239;
