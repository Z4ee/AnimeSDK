...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x14F7BAB0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_INT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x14F7C300)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_INT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14F7C250)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x14F7C380)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14F7C2B0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x14F7C260)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14F7B7F0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x14F7B6C0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x14F7B9B0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x14F7B8B0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary__YieldCore_d__9_TypeDefinitionIndex = 7246;
	...
	public:
		...
		::System::Collections::Generic::IEnumerable_1<::MessagePack::Internal::AutomataDictionary_AutomataNode*>* nexts; // 0x20
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::System::Int32> __2__current; // 0x28
		::MessagePack::Internal::AutomataDictionary_AutomataNode* _item_5__3; // 0x38
