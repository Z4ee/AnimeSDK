...
#define MESSAGEPACK_INTERNAL_RESOLVERUTILITIES_ACTIVATEFORMATTER_OFFSET UNITYSDK_OFFSET(0x1735E380)
#define MESSAGEPACK_INTERNAL_RESOLVERUTILITIES_FETCHSINGLETONFIELD_OFFSET UNITYSDK_OFFSET(0x17350920)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ResolverUtilities_TypeDefinitionIndex = 9394;
