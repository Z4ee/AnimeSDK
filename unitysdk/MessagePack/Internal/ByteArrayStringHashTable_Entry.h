...
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ENTRY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA5D920)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ByteArrayStringHashTable_Entry_TypeDefinitionIndex = 30241;
