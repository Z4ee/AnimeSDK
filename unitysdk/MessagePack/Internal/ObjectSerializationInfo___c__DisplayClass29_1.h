...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO___C__DISPLAYCLASS29_1__CREATEORNULL_B__12_OFFSET UNITYSDK_OFFSET(0x1DB31E90)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO___C__DISPLAYCLASS29_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB31E80)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo___c__DisplayClass29_1_TypeDefinitionIndex = 31324;
