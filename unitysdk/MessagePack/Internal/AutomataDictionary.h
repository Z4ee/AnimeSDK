...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1BC52FB0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_EMITMATCH_OFFSET UNITYSDK_OFFSET(0x1BC53F50)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BC53D90)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BC53D80)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TOSTRINGCORE_OFFSET UNITYSDK_OFFSET(0x1BC53910)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC53820)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1BC537B0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1BC536C0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_YIELDCORE_OFFSET UNITYSDK_OFFSET(0x1BC53EF0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC52F40)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary_TypeDefinitionIndex = 29674;
