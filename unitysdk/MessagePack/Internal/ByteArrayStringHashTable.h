...
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1BCB9840)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ADD_OFFSET UNITYSDK_OFFSET(0x1BCB8F30)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_BYTEARRAYGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BCBA330)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_CALCULATECAPACITY_OFFSET UNITYSDK_OFFSET(0x1BCB8EF0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BCBA4F0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BCBA540)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BCB9090)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUESLOW_OFFSET UNITYSDK_OFFSET(0x1BCBA090)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1BCB9D80)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1BCB9A90)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BCBA590)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BCB8E40)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB8D90)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ByteArrayStringHashTable_TypeDefinitionIndex = 30350;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ByteArrayStringHashTable_TypeDefinitionIndex)->GetStaticField(0x7AD0);
		}
