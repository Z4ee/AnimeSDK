...
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1984B8E0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ADD_OFFSET UNITYSDK_OFFSET(0x1984AFD0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_BYTEARRAYGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1984C3D0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_CALCULATECAPACITY_OFFSET UNITYSDK_OFFSET(0x1984AF90)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1984C590)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1984C5E0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1984B130)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUESLOW_OFFSET UNITYSDK_OFFSET(0x1984C130)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1984BE20)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1984BB30)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1984C630)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1984AEE0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1984AE30)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ByteArrayStringHashTable_TypeDefinitionIndex = 26792;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ByteArrayStringHashTable_TypeDefinitionIndex)->GetStaticField(0x4A20);
		}
