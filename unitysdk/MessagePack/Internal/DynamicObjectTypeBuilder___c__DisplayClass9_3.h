...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_3__BUILDDESERIALIZE_B__6_OFFSET UNITYSDK_OFFSET(0x1D408CB0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_3__BUILDDESERIALIZE_B__7_OFFSET UNITYSDK_OFFSET(0x1D408EC0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1D408BA0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass9_3_TypeDefinitionIndex = 29292;
