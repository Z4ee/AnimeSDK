...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__BUILDFORMATTERTODYNAMICMETHOD_B__3_OFFSET UNITYSDK_OFFSET(0x1AFC7A20)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__BUILDFORMATTERTODYNAMICMETHOD_B__4_OFFSET UNITYSDK_OFFSET(0x1AFC7CA0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFC7A10)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass4_1_TypeDefinitionIndex = 26705;
