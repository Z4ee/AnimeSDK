...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__BUILDFORMATTERTODYNAMICMETHOD_B__3_OFFSET UNITYSDK_OFFSET(0x1D4079C0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__BUILDFORMATTERTODYNAMICMETHOD_B__4_OFFSET UNITYSDK_OFFSET(0x1D407C40)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4079B0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass4_1_TypeDefinitionIndex = 29304;

	class DynamicObjectTypeBuilder___c__DisplayClass4_1 : public ::System::Object
	{
	public:
		::System::Reflection::Emit::ILGenerator* il; // 0x10
		::MessagePack::Internal::DynamicObjectTypeBuilder___c__DisplayClass4_0* CS___8__locals1; // 0x18
