...
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D520E90)
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D5202B0)
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D521470)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_BinderConnection_Formatter_TypeDefinitionIndex = 29966;
