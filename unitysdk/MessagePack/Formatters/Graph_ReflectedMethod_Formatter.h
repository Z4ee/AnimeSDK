...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDMETHOD_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0B0970)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDMETHOD_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0B02E0)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDMETHOD_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B11C0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedMethod_Formatter_TypeDefinitionIndex = 26683;
