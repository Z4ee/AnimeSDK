...
#define MESSAGEPACK_FORMATTERS_FORCEUINT32BLOCKFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B49E2F0)
#define MESSAGEPACK_FORMATTERS_FORCEUINT32BLOCKFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B49E2E0)
#define MESSAGEPACK_FORMATTERS_FORCEUINT32BLOCKFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B49E300)
#define MESSAGEPACK_FORMATTERS_FORCEUINT32BLOCKFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49E2D0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int ForceUInt32BlockFormatter_TypeDefinitionIndex = 26971;
	...
	public:
		...
		{
			return (::MessagePack::Formatters::ForceUInt32BlockFormatter**)Il2CppClass::FromTypeDefinitionIndex(ForceUInt32BlockFormatter_TypeDefinitionIndex)->GetStaticField(0x20E00);
		}
