...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDCONSTRUCTORINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A299BF0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDCONSTRUCTORINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A299BB0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDCONSTRUCTORINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A299D00)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedConstructorInfo_Formatter_TypeDefinitionIndex = 27043;
