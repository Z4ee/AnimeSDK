...
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D535370)
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D534F60)
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D535880)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_MarcoNodeWrapper_Formatter_TypeDefinitionIndex = 29661;
