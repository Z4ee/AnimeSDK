...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6E2610)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D6E1F90)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E2E60)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedConstructor_Formatter_TypeDefinitionIndex = 29963;
