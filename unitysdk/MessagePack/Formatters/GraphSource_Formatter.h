...
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D520710)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D51FD40)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D521430)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__GETVALUE_OFFSET UNITYSDK_OFFSET(0x1D51FAC0)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__WRITEOBJMETA_OFFSET UNITYSDK_OFFSET(0x1D51FB60)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int GraphSource_Formatter_TypeDefinitionIndex = 29692;
