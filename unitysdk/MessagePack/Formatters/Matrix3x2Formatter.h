...
#define MESSAGEPACK_FORMATTERS_MATRIX3X2FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x14F6DF20)
#define MESSAGEPACK_FORMATTERS_MATRIX3X2FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x14F6DE90)
#define MESSAGEPACK_FORMATTERS_MATRIX3X2FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14F6E340)
#define MESSAGEPACK_FORMATTERS_MATRIX3X2FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x14F6DE80)
...
namespace MessagePack::Formatters
{
	...
	public:
		...
		{
			return (::MessagePack::Formatters::IMessagePackFormatter_1<::System::Numerics::Matrix3x2>**)Il2CppClass::FromTypeDefinitionIndex(Matrix3x2Formatter_TypeDefinitionIndex)->GetStaticField(0x8FC0);
		}
