...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D5358B0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D535890)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5359B0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedTypeInfo_Formatter_TypeDefinitionIndex = 30483;
