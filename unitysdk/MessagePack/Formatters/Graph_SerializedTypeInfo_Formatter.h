...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0EF070)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0EF050)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EF170)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedTypeInfo_Formatter_TypeDefinitionIndex = 27487;
