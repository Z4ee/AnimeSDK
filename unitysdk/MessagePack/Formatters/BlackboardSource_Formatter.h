...
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D38B710)
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D38B5A0)
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D38B880)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int BlackboardSource_Formatter_TypeDefinitionIndex = 29554;
