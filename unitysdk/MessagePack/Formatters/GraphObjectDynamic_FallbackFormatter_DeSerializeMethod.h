...
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6FF10)
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6FFA0)
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6F940)
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB6F920)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int GraphObjectDynamic_FallbackFormatter_DeSerializeMethod_TypeDefinitionIndex = 30637;
