...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDFIELDINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D1DF9D0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDFIELDINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D1DF9B0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDFIELDINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DFAD0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedFieldInfo_Formatter_TypeDefinitionIndex = 30691;
