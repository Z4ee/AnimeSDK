...
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C621200)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C621290)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C620BE0)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C620BC0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int DeserializeFunc_TypeDefinitionIndex = 30731;
