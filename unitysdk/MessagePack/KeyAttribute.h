...
#define MESSAGEPACK_KEYATTRIBUTE_GET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1DB992C0)
#define MESSAGEPACK_KEYATTRIBUTE_GET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1DB992E0)
#define MESSAGEPACK_KEYATTRIBUTE_SET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1DB992D0)
#define MESSAGEPACK_KEYATTRIBUTE_SET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1DB992F0)
#define MESSAGEPACK_KEYATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB99320)
#define MESSAGEPACK_KEYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB99300)

namespace MessagePack
{
	inline static constexpr unsigned int KeyAttribute_TypeDefinitionIndex = 30159;
