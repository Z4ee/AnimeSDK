...
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1D5252C0)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_GET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1D5252A0)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_SET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1D5252D0)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_SET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1D5252B0)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D5252F0)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5252E0)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackFormatterAttribute_TypeDefinitionIndex = 30129;
