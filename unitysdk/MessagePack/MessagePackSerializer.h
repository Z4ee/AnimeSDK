...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTFROMJSON_1_OFFSET UNITYSDK_OFFSET(0x1A1FABE0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTFROMJSON_2_OFFSET UNITYSDK_OFFSET(0x1A1FA630)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTFROMJSON_OFFSET UNITYSDK_OFFSET(0x1A1FA4B0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTTOJSON_1_OFFSET UNITYSDK_OFFSET(0x1A1F8890)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTTOJSON_2_OFFSET UNITYSDK_OFFSET(0x1A1F89C0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTTOJSON_OFFSET UNITYSDK_OFFSET(0x1A1F87F0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1A1FD010)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1A1FD160)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1A1FD2C0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1FCEE0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_FROMJSONCORE_OFFSET UNITYSDK_OFFSET(0x1A1FAFB0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_GETORADD_OFFSET UNITYSDK_OFFSET(0x1A1FC8E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_GETUINT32WRITESIZE_OFFSET UNITYSDK_OFFSET(0x1A1FD8D0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_GET_DEFAULTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A1FD420)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_ISMESSAGEPACKFIXEDSIZEPRIMITIVETYPEHELPER_OFFSET UNITYSDK_OFFSET(0x1A1FDA00)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_LZ4OPERATION_OFFSET UNITYSDK_OFFSET(0x1A1FD4E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x1A1FCD80)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1A1FC970)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1A1FCAD0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1A1FCC20)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1FC7A0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SET_DEFAULTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A1FD480)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_TOJSONCORE_OFFSET UNITYSDK_OFFSET(0x1A1F99C0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_TOLZ4BINARYCORE_OFFSET UNITYSDK_OFFSET(0x1A1FB9B0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_TRYDECOMPRESS_OFFSET UNITYSDK_OFFSET(0x1A1F8E70)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_WRITEBIN32HEADER_OFFSET UNITYSDK_OFFSET(0x1A1FD900)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_WRITEJSONSTRING_OFFSET UNITYSDK_OFFSET(0x1A1FC3C0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1FC5E0)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializer_TypeDefinitionIndex = 28176;
	...
	public:
		...
		{
			return (::MessagePack::MessagePackSerializer_LZ4Transform**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1FCF0);
		}
		...
		{
			return (::MessagePack::Internal::ThreadsafeTypeKeyHashTable_1<::MessagePack::MessagePackSerializer_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1FCF8);
		}
		static ::MessagePack::MessagePackSerializer_LZ4Transform** StaticGet_LZ4CodecDecode()
		{
			return (::MessagePack::MessagePackSerializer_LZ4Transform**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1FD00);
		}
		static ::MessagePack::MessagePackSerializerOptions** StaticGet__DefaultOptions_k__BackingField()
		{
			return (::MessagePack::MessagePackSerializerOptions**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1FD08);
		}
		static ::System::Func_2<::System::Type*, ::MessagePack::MessagePackSerializer_CompiledMethods*>** StaticGet_CreateCompiledMethods()
		{
			return (::System::Func_2<::System::Type*, ::MessagePack::MessagePackSerializer_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1FD10);
		}
