...
#define MESSAGEPACK_MESSAGEPACKPRIMITIVES_DECODERS_READINT64UINT64_READ_OFFSET UNITYSDK_OFFSET(0x181774B0)
#define MESSAGEPACK_MESSAGEPACKPRIMITIVES_DECODERS_READINT64UINT64__CCTOR_OFFSET UNITYSDK_OFFSET(0x18177560)
#define MESSAGEPACK_MESSAGEPACKPRIMITIVES_DECODERS_READINT64UINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x181774A0)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackPrimitives_Decoders_ReadInt64UInt64_TypeDefinitionIndex = 7137;
	...
	public:
		...
		{
			return (::MessagePack::MessagePackPrimitives_Decoders_ReadInt64UInt64**)Il2CppClass::FromTypeDefinitionIndex(MessagePackPrimitives_Decoders_ReadInt64UInt64_TypeDefinitionIndex)->GetStaticField(0x9B10);
		}
