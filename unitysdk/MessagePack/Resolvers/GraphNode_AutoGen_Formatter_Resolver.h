...
#define MESSAGEPACK_RESOLVERS_GRAPHNODE_AUTOGEN_FORMATTER_RESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D34F590)
#define MESSAGEPACK_RESOLVERS_GRAPHNODE_AUTOGEN_FORMATTER_RESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D34F500)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int GraphNode_AutoGen_Formatter_Resolver_TypeDefinitionIndex = 30732;
	...
	public:
		...
		{
			return (::MessagePack::Resolvers::GraphNode_AutoGen_Formatter_Resolver**)Il2CppClass::FromTypeDefinitionIndex(GraphNode_AutoGen_Formatter_Resolver_TypeDefinitionIndex)->GetStaticField(0x23C00);
		}
