...
#define MESSAGEPACK_RESOLVERS_COMPOSITERESOLVER_CACHINGRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D0240)
...
namespace MessagePack::Resolvers
{
	...
	public:
		...
		::MessagePack::Internal::ThreadsafeTypeKeyHashTable_1<::MessagePack::Formatters::IMessagePackFormatter*>* formattersCache; // 0x18
