...
#define MESSAGEPACK_RESOLVERS_STATICCOMPOSITERESOLVER_REGISTER_1_OFFSET UNITYSDK_OFFSET(0x1D069370)
#define MESSAGEPACK_RESOLVERS_STATICCOMPOSITERESOLVER_REGISTER_2_OFFSET UNITYSDK_OFFSET(0x1D069420)
#define MESSAGEPACK_RESOLVERS_STATICCOMPOSITERESOLVER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1D0692C0)
#define MESSAGEPACK_RESOLVERS_STATICCOMPOSITERESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D069500)
#define MESSAGEPACK_RESOLVERS_STATICCOMPOSITERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0692A0)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int StaticCompositeResolver_TypeDefinitionIndex = 31348;
	...
	public:
		...
		{
			return (::MessagePack::Resolvers::StaticCompositeResolver**)Il2CppClass::FromTypeDefinitionIndex(StaticCompositeResolver_TypeDefinitionIndex)->GetStaticField(0x25B10);
		}
