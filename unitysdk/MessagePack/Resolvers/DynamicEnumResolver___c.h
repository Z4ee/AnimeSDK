...
#define MESSAGEPACK_RESOLVERS_DYNAMICENUMRESOLVER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF286C0)
#define MESSAGEPACK_RESOLVERS_DYNAMICENUMRESOLVER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF28700)
#define MESSAGEPACK_RESOLVERS_DYNAMICENUMRESOLVER___C___CCTOR_B__5_0_OFFSET UNITYSDK_OFFSET(0x1AF28710)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int DynamicEnumResolver___c_TypeDefinitionIndex = 27386;
	...
	public:
		...
		{
			return (::MessagePack::Resolvers::DynamicEnumResolver___c**)Il2CppClass::FromTypeDefinitionIndex(DynamicEnumResolver___c_TypeDefinitionIndex)->GetStaticField(0x20DA0);
		}
