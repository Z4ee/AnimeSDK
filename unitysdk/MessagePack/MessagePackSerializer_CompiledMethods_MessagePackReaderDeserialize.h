...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6CC6F0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6CC770)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6CC6E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CC660)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializer_CompiledMethods_MessagePackReaderDeserialize_TypeDefinitionIndex = 7164;
