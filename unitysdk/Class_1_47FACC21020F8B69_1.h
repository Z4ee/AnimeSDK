...
#define CLASS_1_47FACC21020F8B69_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ECD2750)
#define CLASS_1_47FACC21020F8B69_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1ECD2170)
#define CLASS_1_47FACC21020F8B69_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ECD22F0)
#define CLASS_1_47FACC21020F8B69_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ECD2230)
#define CLASS_1_47FACC21020F8B69_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ECD2400)
#define CLASS_1_47FACC21020F8B69_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ECD2940)
#define CLASS_1_47FACC21020F8B69_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ECD28E0)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1ECD21E0)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1ECD21C0)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1ECD2010)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1ECD2200)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1ECD21F0)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1ECD21D0)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1ECD2220)
#define CLASS_1_47FACC21020F8B69_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1ECD2210)
#define CLASS_1_47FACC21020F8B69_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ECD2070)
#define CLASS_1_47FACC21020F8B69_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ECD2500)
#define CLASS_1_47FACC21020F8B69_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ECD2560)
#define CLASS_1_47FACC21020F8B69_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ECD2A50)
#define CLASS_1_47FACC21020F8B69_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ECD20D0)
#define CLASS_1_47FACC21020F8B69_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECD2080)

inline static constexpr unsigned int Class_1_47FACC21020F8B69_1_TypeDefinitionIndex = 34418;

class Class_1_47FACC21020F8B69_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_47FACC21020F8B69_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_47FACC21020F8B69_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_47FACC21020F8B69_1_TypeDefinitionIndex)->GetStaticField(0x5DA10);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_KJMMLMPKFCI()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_47FACC21020F8B69_1_TypeDefinitionIndex)->GetStaticField(0x5DA18);
	}
	// static const ::System::Int32 HDMOEMDGMLM = 0x7; // 0x0
	// static const ::System::Int32 AKFFJEHMCCB = 0xE; // 0x0
	// static const ::System::Int32 JCIJLBHDJHF = 0x9; // 0x0
	// static const ::System::Int32 OOLLDLHKDOH = 0x2; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* HJFJBCADHHB; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::UInt32 GEMFJILOPLL; // 0x20
	::System::UInt32 ILOLCJEHFGK; // 0x24
	::System::Boolean DHMADBLCKKD; // 0x28
