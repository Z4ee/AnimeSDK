...
#define CLASS_1_20A5FC2DE45BF4AF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E21BFB0)
#define CLASS_1_20A5FC2DE45BF4AF_CLONE_OFFSET UNITYSDK_OFFSET(0x1E21B960)
#define CLASS_1_20A5FC2DE45BF4AF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E21BA90)
#define CLASS_1_20A5FC2DE45BF4AF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E21BA30)
#define CLASS_1_20A5FC2DE45BF4AF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E21BB30)
#define CLASS_1_20A5FC2DE45BF4AF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E21C1E0)
#define CLASS_1_20A5FC2DE45BF4AF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E21C160)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E21B9D0)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E21B9B0)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E21B760)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1E21BA00)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1E21B9F0)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E21B9E0)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E21B9C0)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E21BA20)
#define CLASS_1_20A5FC2DE45BF4AF_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E21BA10)
#define CLASS_1_20A5FC2DE45BF4AF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E21B7C0)
#define CLASS_1_20A5FC2DE45BF4AF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E21BD00)
#define CLASS_1_20A5FC2DE45BF4AF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E21BD60)
#define CLASS_1_20A5FC2DE45BF4AF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E21C350)
#define CLASS_1_20A5FC2DE45BF4AF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E21B860)
#define CLASS_1_20A5FC2DE45BF4AF__CTOR_OFFSET UNITYSDK_OFFSET(0x1E21B7D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_20A5FC2DE45BF4AF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_20A5FC2DE45BF4AF_TypeDefinitionIndex)->GetStaticField(0x410A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_CIHLCECLEHB()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_20A5FC2DE45BF4AF_TypeDefinitionIndex)->GetStaticField(0x410A8);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_KMKPCNECENO()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_20A5FC2DE45BF4AF_TypeDefinitionIndex)->GetStaticField(0x410B0);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* GGCJAODKJFK; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* FDJMHALCAMG; // 0x18
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x20
	::System::UInt32 ODCKBAEKGJG; // 0x28
	::System::UInt32 MJIMFDKFGDE; // 0x2C
	::System::Boolean BIFOCPDIOBP; // 0x30
