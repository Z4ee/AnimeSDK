...
#define CLASS_1_EA5A5E4D07C4CF2B_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E126480)
#define CLASS_1_EA5A5E4D07C4CF2B_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1E1260B0)
#define CLASS_1_EA5A5E4D07C4CF2B_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E1261E0)
#define CLASS_1_EA5A5E4D07C4CF2B_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E126110)
#define CLASS_1_EA5A5E4D07C4CF2B_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E126350)
#define CLASS_1_EA5A5E4D07C4CF2B_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E126560)
#define CLASS_1_EA5A5E4D07C4CF2B_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E126530)
#define CLASS_1_EA5A5E4D07C4CF2B_7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E126030)
#define CLASS_1_EA5A5E4D07C4CF2B_7_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x1E126100)
#define CLASS_1_EA5A5E4D07C4CF2B_7_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1E1260F0)
#define CLASS_1_EA5A5E4D07C4CF2B_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E126060)
#define CLASS_1_EA5A5E4D07C4CF2B_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E126380)
#define CLASS_1_EA5A5E4D07C4CF2B_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E1263E0)
#define CLASS_1_EA5A5E4D07C4CF2B_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1266C0)
#define CLASS_1_EA5A5E4D07C4CF2B_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E126080)
#define CLASS_1_EA5A5E4D07C4CF2B_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1E126070)

inline static constexpr unsigned int Class_1_EA5A5E4D07C4CF2B_7_TypeDefinitionIndex = 26937;

class Class_1_EA5A5E4D07C4CF2B_7 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_EA5A5E4D07C4CF2B_7*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EA5A5E4D07C4CF2B_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EA5A5E4D07C4CF2B_7_TypeDefinitionIndex)->GetStaticField(0x43750);
	}
	// static const ::System::Int32 JGOPKCJPHKH = 0x8; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Int32 ADDHGJADLCG; // 0x18
