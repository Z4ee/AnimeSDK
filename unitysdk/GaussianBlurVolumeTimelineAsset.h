...
#define GAUSSIANBLURVOLUMETIMELINEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1724CDB0)
#define GAUSSIANBLURVOLUMETIMELINEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1724CDA0)
#define GAUSSIANBLURVOLUMETIMELINEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1724CFB0)

inline static constexpr unsigned int GaussianBlurVolumeTimelineAsset_TypeDefinitionIndex = 47373;
