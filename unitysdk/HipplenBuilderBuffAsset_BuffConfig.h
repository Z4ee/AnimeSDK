...
#define HIPPLENBUILDERBUFFASSET_BUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10C1AD90)

inline static constexpr unsigned int HipplenBuilderBuffAsset_BuffConfig_TypeDefinitionIndex = 38136;
