...
#define WWISEEVENTREFERENCE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x18C4F5B0)
#define WWISEEVENTREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4F5C0)

inline static constexpr unsigned int WwiseEventReference_TypeDefinitionIndex = 34620;
