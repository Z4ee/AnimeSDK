...
#define STRUCT_2_D72C8878059D4DFF_METHOD_2_016E85CEDEE00FF4_OFFSET UNITYSDK_OFFSET(0x7300E0)
#define STRUCT_2_D72C8878059D4DFF_METHOD_2_D32EB3A51853ADA1_OFFSET UNITYSDK_OFFSET(0x11427C30)
#define STRUCT_2_D72C8878059D4DFF__CTOR_OFFSET UNITYSDK_OFFSET(0x72FFB0)

inline static constexpr unsigned int Struct_2_D72C8878059D4DFF_TypeDefinitionIndex = 80244;

struct alignas(8) Struct_2_D72C8878059D4DFF
{
	::Class_1_A312CF7E24F3D126* Field_2_2; // 0x10
	...
	::Class_0_16E4307DCC419505_233* Method_2_016E85CEDEE00FF4()
	{
		return ((::Class_0_16E4307DCC419505_233*(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_D72C8878059D4DFF_METHOD_2_016E85CEDEE00FF4_OFFSET))(this);
	}
};
