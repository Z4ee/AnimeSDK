...
#define CLASS_2_6DDA91CFFA134F45__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0x142097F0)
#define CLASS_2_6DDA91CFFA134F45__CTOR_OFFSET UNITYSDK_OFFSET(0x14209490)
#define CLASS_2_6DDA91CFFA134F45__REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0x14209D30)
#define CLASS_2_6DDA91CFFA134F45__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x14209690)
#define CLASS_2_6DDA91CFFA134F45___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x14209E70)

inline static constexpr unsigned int Class_2_6DDA91CFFA134F45_TypeDefinitionIndex = 71595;

class Class_2_6DDA91CFFA134F45 : public ::RPG::Client::LittleGame::FiveDim::BaseChestSystem_1<::Class_2_B9E8C2EEAA5C96EC*>
{
public:
	::Class_3_1E4F9B0ED3BF21DE* Field_2_0; // 0x40
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_6DDA91CFFA134F45___IFIXBASEPROXY__TEARDOWN_OFFSET))(this);
	}
};
