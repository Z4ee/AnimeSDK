...
#define CLASS_1_4FCC8C206307C76F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1037D0A0)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_2B66C008535F8B01_OFFSET UNITYSDK_OFFSET(0x1037CE50)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_599D97DBBAB2CBCE_OFFSET UNITYSDK_OFFSET(0x1037D200)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_A124427AABD6F076_OFFSET UNITYSDK_OFFSET(0x1037D370)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_A396886527012FF7_OFFSET UNITYSDK_OFFSET(0x1037CFA0)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_CB81EEE9CC7C2687_OFFSET UNITYSDK_OFFSET(0x1037CC80)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_D072FA229F253A0B_OFFSET UNITYSDK_OFFSET(0x1037D120)
#define CLASS_1_4FCC8C206307C76F__CTOR_OFFSET UNITYSDK_OFFSET(0x1037CDB0)

inline static constexpr unsigned int Class_1_4FCC8C206307C76F_TypeDefinitionIndex = 63553;

class Class_1_4FCC8C206307C76F : public ::System::Object
{
public:
	::Class_3_626F93E2306641CC* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CakeRaceTriggerEventType, ::Class_1_671CF0E35C67EB11*>* Field_1_1; // 0x18
