...
#define CLASS_2_C7B8DD31C872C201_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13966320)
#define CLASS_2_C7B8DD31C872C201_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13966360)
#define CLASS_2_C7B8DD31C872C201_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13966550)
#define CLASS_2_C7B8DD31C872C201_TICK_OFFSET UNITYSDK_OFFSET(0x139665A0)
#define CLASS_2_C7B8DD31C872C201__CTOR_OFFSET UNITYSDK_OFFSET(0x13966310)

inline static constexpr unsigned int Class_2_C7B8DD31C872C201_TypeDefinitionIndex = 54305;

class Class_2_C7B8DD31C872C201 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::EnableInput* Field_2_1; // 0x20
