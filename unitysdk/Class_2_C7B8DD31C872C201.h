...
#define CLASS_2_C7B8DD31C872C201_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191B7220)
#define CLASS_2_C7B8DD31C872C201_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x191B7260)
#define CLASS_2_C7B8DD31C872C201_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x191B7450)
#define CLASS_2_C7B8DD31C872C201_TICK_OFFSET UNITYSDK_OFFSET(0x191B74A0)
#define CLASS_2_C7B8DD31C872C201__CTOR_OFFSET UNITYSDK_OFFSET(0x191B7210)
...
{
public:
	::RPG::GameCore::EnableInput* OFKGLJOAMLD; // 0x18
