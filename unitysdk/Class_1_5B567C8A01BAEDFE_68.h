...
#define CLASS_1_5B567C8A01BAEDFE_68_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A761910)
#define CLASS_1_5B567C8A01BAEDFE_68_CLONE_OFFSET UNITYSDK_OFFSET(0x1A761780)
#define CLASS_1_5B567C8A01BAEDFE_68_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A761820)
#define CLASS_1_5B567C8A01BAEDFE_68_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7617C0)
#define CLASS_1_5B567C8A01BAEDFE_68_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A761870)
#define CLASS_1_5B567C8A01BAEDFE_68_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A761960)
#define CLASS_1_5B567C8A01BAEDFE_68_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A761930)
#define CLASS_1_5B567C8A01BAEDFE_68_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A761700)
#define CLASS_1_5B567C8A01BAEDFE_68_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A761730)
#define CLASS_1_5B567C8A01BAEDFE_68_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7618A0)
#define CLASS_1_5B567C8A01BAEDFE_68_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A761900)
#define CLASS_1_5B567C8A01BAEDFE_68__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7619B0)
#define CLASS_1_5B567C8A01BAEDFE_68__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A761750)
#define CLASS_1_5B567C8A01BAEDFE_68__CTOR_OFFSET UNITYSDK_OFFSET(0x1A761740)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_68_TypeDefinitionIndex = 25578;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_68*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_68_TypeDefinitionIndex)->GetStaticField(0x440A0);
	}
