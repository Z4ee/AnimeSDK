...
#define CLASS_1_BB4D2C803A0829A1_METHOD_1_6DCA9A3382B0B6B8_OFFSET UNITYSDK_OFFSET(0x16CBDA60)
#define CLASS_1_BB4D2C803A0829A1__CCTOR_OFFSET UNITYSDK_OFFSET(0x16CBDCE0)

inline static constexpr unsigned int Class_1_BB4D2C803A0829A1_TypeDefinitionIndex = 80774;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::RuntimeTypeHandle, ::Class_0_16E4307DCC419505_1439*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BB4D2C803A0829A1_TypeDefinitionIndex)->GetStaticField(0x5CD0);
	}
