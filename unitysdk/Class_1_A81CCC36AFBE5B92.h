...
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_3BBF367E911FF8D6_OFFSET UNITYSDK_OFFSET(0x15485C10)
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_47442C2BE57F201C_OFFSET UNITYSDK_OFFSET(0x15484DD0)
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_6671F1CF091A0296_OFFSET UNITYSDK_OFFSET(0x154848A0)
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_7B9874BAA1185BBE_OFFSET UNITYSDK_OFFSET(0x15484510)
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_C71920165E08B0A2_OFFSET UNITYSDK_OFFSET(0x15486050)
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_E0A6CCC2EA110CDB_OFFSET UNITYSDK_OFFSET(0x15484F60)
#define CLASS_1_A81CCC36AFBE5B92_METHOD_1_F911478D6AC45A79_OFFSET UNITYSDK_OFFSET(0x15486A00)
#define CLASS_1_A81CCC36AFBE5B92__CCTOR_OFFSET UNITYSDK_OFFSET(0x154844A0)

inline static constexpr unsigned int Class_1_A81CCC36AFBE5B92_TypeDefinitionIndex = 51827;
...
public:
	...
	{
		return (::UnityEngine::GameObject**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A81CCC36AFBE5B92_TypeDefinitionIndex)->GetStaticField(0x3D950);
	}
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_Field_1_0()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A81CCC36AFBE5B92_TypeDefinitionIndex)->GetStaticField(0x3D958);
	}
	static ::UnityEngine::SphereCollider** StaticGet_Field_1_2()
	{
		return (::UnityEngine::SphereCollider**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A81CCC36AFBE5B92_TypeDefinitionIndex)->GetStaticField(0x3D960);
	}
	static ::Il2CppArray<::System::Int32>** StaticGet_Field_1_1()
	{
		return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A81CCC36AFBE5B92_TypeDefinitionIndex)->GetStaticField(0x3D968);
	}
