...
#define CLASS_3_1ACADD354F8A3264_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1448ED10)
#define CLASS_3_1ACADD354F8A3264__CTOR_OFFSET UNITYSDK_OFFSET(0x1448EB80)
#define CLASS_3_1ACADD354F8A3264___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1448ED90)

inline static constexpr unsigned int Class_3_1ACADD354F8A3264_TypeDefinitionIndex = 70507;

class Class_3_1ACADD354F8A3264 : public ::RPG::Client::LittleGame::Services_1<::Class_2_C01BA129C3E40259*>
{
public:
	::Class_1_07F3159234271541* Field_3_0; // 0x90
	::Class_1_26B10E55247AB428* Field_3_1; // 0x98
	::Class_1_E17CC0467667494B* Field_3_2; // 0xA0
	::Class_1_3B1EA953A4067E26_1* Field_3_3; // 0xA8
