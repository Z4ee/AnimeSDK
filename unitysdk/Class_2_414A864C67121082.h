...
#define CLASS_2_414A864C67121082_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBFB7410)
#define CLASS_2_414A864C67121082_METHOD_2_2E29038CF17E20BD_OFFSET UNITYSDK_OFFSET(0xBFB7E00)
#define CLASS_2_414A864C67121082_METHOD_2_467ECC487C2581DD_OFFSET UNITYSDK_OFFSET(0xBFB76D0)
#define CLASS_2_414A864C67121082_METHOD_2_6F9CFB69CAB3BEF0_OFFSET UNITYSDK_OFFSET(0xBFB8560)
#define CLASS_2_414A864C67121082_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xBFB7800)
#define CLASS_2_414A864C67121082_METHOD_2_7E3C0318CC90CDC0_OFFSET UNITYSDK_OFFSET(0xBFB8270)
#define CLASS_2_414A864C67121082_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0xBFB83D0)
#define CLASS_2_414A864C67121082_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xBFB8340)
#define CLASS_2_414A864C67121082_METHOD_2_CEA32FF190776922_OFFSET UNITYSDK_OFFSET(0xBFB8C20)
#define CLASS_2_414A864C67121082_METHOD_2_F5B4708E7805566C_OFFSET UNITYSDK_OFFSET(0xBFB84F0)
#define CLASS_2_414A864C67121082_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBFB79D0)
#define CLASS_2_414A864C67121082_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBFB7A80)
#define CLASS_2_414A864C67121082_TICK_OFFSET UNITYSDK_OFFSET(0xBFB8BB0)
#define CLASS_2_414A864C67121082__CTOR_OFFSET UNITYSDK_OFFSET(0xBFB6EB0)
...
public:
	...
	::Class_2_19E76B515E7B257C* IEJKMJCAJDF; // 0x20
	::Class_1_5F51D4049EA87B7B* JLBEOOBDBLB; // 0x28
	::Class_2_A0580152EB393340* DIICJHOADFP; // 0x30
	::RPG::GameCore::AdvNpcMoveAlongPath* IGHAHBNLIJA; // 0x38
	::RPG::GameCore::NPCComponent* ACMDKOBBDNJ; // 0x40
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x48
	::RPG::GameCore::AdvNpcMoveAlongPathStatus OOLOHGCPNCO; // 0x50
	::System::Single CCIEKNJANFE; // 0x54
	::UnityEngine::Vector3 NLINJIGDPED; // 0x58
