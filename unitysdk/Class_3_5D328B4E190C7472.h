...
#define CLASS_3_5D328B4E190C7472_METHOD_3_DF36652FF6AEAAC1_OFFSET UNITYSDK_OFFSET(0x156385D0)
#define CLASS_3_5D328B4E190C7472__CTOR_1_OFFSET UNITYSDK_OFFSET(0x156385C0)
#define CLASS_3_5D328B4E190C7472__CTOR_2_OFFSET UNITYSDK_OFFSET(0x156385B0)
#define CLASS_3_5D328B4E190C7472__CTOR_OFFSET UNITYSDK_OFFSET(0x15638590)

inline static constexpr unsigned int Class_3_5D328B4E190C7472_TypeDefinitionIndex = 73416;

class Class_3_5D328B4E190C7472 : public ::UnityEngine::PropertyAttribute
{
public:
	::Class_3_5D328B4E190C7472_Enum_3_E43BF90DB9A1BFDC Field_3_1; // 0x10
	::System::Int32 Field_3_7; // 0x14
