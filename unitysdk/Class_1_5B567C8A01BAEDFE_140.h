...
#define CLASS_1_5B567C8A01BAEDFE_140_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3782F0)
#define CLASS_1_5B567C8A01BAEDFE_140_CLONE_OFFSET UNITYSDK_OFFSET(0x1A378100)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A378200)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A378170)
#define CLASS_1_5B567C8A01BAEDFE_140_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A378250)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A378340)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A378310)
#define CLASS_1_5B567C8A01BAEDFE_140_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A378050)
#define CLASS_1_5B567C8A01BAEDFE_140_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3780B0)
#define CLASS_1_5B567C8A01BAEDFE_140_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A378280)
#define CLASS_1_5B567C8A01BAEDFE_140_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3782E0)
#define CLASS_1_5B567C8A01BAEDFE_140__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A378390)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3780D0)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3780C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_140_TypeDefinitionIndex = 27523;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_140*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_140_TypeDefinitionIndex)->GetStaticField(0x58A20);
	}
