...
#define CLASS_1_5B567C8A01BAEDFE_140_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E02BBC0)
#define CLASS_1_5B567C8A01BAEDFE_140_CLONE_OFFSET UNITYSDK_OFFSET(0x1E02B860)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E02B9C0)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E02B8D0)
#define CLASS_1_5B567C8A01BAEDFE_140_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E02BB20)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E02BC10)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E02BBE0)
#define CLASS_1_5B567C8A01BAEDFE_140_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E02B7B0)
#define CLASS_1_5B567C8A01BAEDFE_140_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E02B810)
#define CLASS_1_5B567C8A01BAEDFE_140_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E02BB50)
#define CLASS_1_5B567C8A01BAEDFE_140_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E02BBB0)
#define CLASS_1_5B567C8A01BAEDFE_140__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E02BC60)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E02B830)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_OFFSET UNITYSDK_OFFSET(0x1E02B820)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_140_TypeDefinitionIndex = 28755;

class Class_1_5B567C8A01BAEDFE_140 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_140*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_140*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_140_TypeDefinitionIndex)->GetStaticField(0x36050);
	}
