...
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x1AA16640)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x1AA16710)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_3_OFFSET UNITYSDK_OFFSET(0x1AA16780)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_4_OFFSET UNITYSDK_OFFSET(0x1AA16840)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_5_OFFSET UNITYSDK_OFFSET(0x1AA16900)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_6_OFFSET UNITYSDK_OFFSET(0x1AA170A0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1AA16570)
#define STANDART_HASH_XXHASH_XXHASH64_UNSAFECOMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1AA171E0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_AVALANCHE_OFFSET UNITYSDK_OFFSET(0x1AA16230)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AA162B0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_MERGEROUND_OFFSET UNITYSDK_OFFSET(0x1AA16160)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_OFFSET UNITYSDK_OFFSET(0x1AA15800)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_ROUND_OFFSET UNITYSDK_OFFSET(0x1AA160F0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH_ROTL64_OFFSET UNITYSDK_OFFSET(0x1AA157F0)
#define STANDART_HASH_XXHASH_XXHASH64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA17250)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_OFFSET UNITYSDK_OFFSET(0x1AA14D80)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_STREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AA153F0)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_STREAM_PROCESS_OFFSET UNITYSDK_OFFSET(0x1AA15270)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int xxHash64_TypeDefinitionIndex = 8243;
	...
	public:
		...
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36D0);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_4()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36D8);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_5()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36E0);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_2()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36E8);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_3()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36F0);
		}
