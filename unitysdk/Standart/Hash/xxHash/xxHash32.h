...
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x1D2F5880)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x1D2F5950)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_3_OFFSET UNITYSDK_OFFSET(0x1D2F59C0)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_4_OFFSET UNITYSDK_OFFSET(0x1D2F5A80)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_5_OFFSET UNITYSDK_OFFSET(0x1D2F5B40)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_6_OFFSET UNITYSDK_OFFSET(0x1D2F61E0)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1D2F57B0)
#define STANDART_HASH_XXHASH_XXHASH32_UNSAFECOMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1D2F6320)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_AVALANCHE_OFFSET UNITYSDK_OFFSET(0x1D2F54E0)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D2F5560)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_OFFSET UNITYSDK_OFFSET(0x1D2F4F30)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_ROUND_OFFSET UNITYSDK_OFFSET(0x1D2F5470)
#define STANDART_HASH_XXHASH_XXHASH32_XXH_ROTL32_OFFSET UNITYSDK_OFFSET(0x1D2F4F20)
#define STANDART_HASH_XXHASH_XXHASH32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D2F6390)
#define STANDART_HASH_XXHASH_XXHASH32___INLINE__XXH32_OFFSET UNITYSDK_OFFSET(0x1D2F4760)
#define STANDART_HASH_XXHASH_XXHASH32___INLINE__XXH32_STREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D2F4C70)
#define STANDART_HASH_XXHASH_XXHASH32___INLINE__XXH32_STREAM_PROCESS_OFFSET UNITYSDK_OFFSET(0x1D2F4B00)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int xxHash32_TypeDefinitionIndex = 8259;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x38B0);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_3()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x38B4);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_2()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x38B8);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_4()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x38BC);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_5()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x38C0);
		}
