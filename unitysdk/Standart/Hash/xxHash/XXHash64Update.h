...
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGESTBYTES_OFFSET UNITYSDK_OFFSET(0x1BEE26A0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGEST_1_OFFSET UNITYSDK_OFFSET(0x1BEE2A80)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGEST_OFFSET UNITYSDK_OFFSET(0x1BEE2550)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_1_OFFSET UNITYSDK_OFFSET(0x1BEE1F70)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_2_OFFSET UNITYSDK_OFFSET(0x1BEE2820)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_OFFSET UNITYSDK_OFFSET(0x1BEE1E00)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1BEE21A0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1BEE2260)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_3_OFFSET UNITYSDK_OFFSET(0x1BEE2360)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_4_OFFSET UNITYSDK_OFFSET(0x1BEE2940)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_5_OFFSET UNITYSDK_OFFSET(0x1BEE29B0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BEE20E0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_DIGEST_OFFSET UNITYSDK_OFFSET(0x1BEE16C0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_RESET_OFFSET UNITYSDK_OFFSET(0x1BEE1150)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BEE1200)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_COPY_OFFSET UNITYSDK_OFFSET(0x1BEE1140)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_READ32_OFFSET UNITYSDK_OFFSET(0x1BEE1110)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_READ64_OFFSET UNITYSDK_OFFSET(0x1BEE1120)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_ZERO_OFFSET UNITYSDK_OFFSET(0x1BEE1130)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BEE2B80)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BEE1C90)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEE1C80)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE___INLINE__XXH64_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BEE18C0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE___INLINE__XXH64_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BEE1760)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int XXHash64Update_TypeDefinitionIndex = 7701;
	...
	public:
		...
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x36A0);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_5()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x36A8);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_1()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x36B0);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_3()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x36B8);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_2()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x36C0);
		}
