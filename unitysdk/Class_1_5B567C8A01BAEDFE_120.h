...
#define CLASS_1_5B567C8A01BAEDFE_120_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A31C480)
#define CLASS_1_5B567C8A01BAEDFE_120_CLONE_OFFSET UNITYSDK_OFFSET(0x1A31C290)
#define CLASS_1_5B567C8A01BAEDFE_120_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A31C390)
#define CLASS_1_5B567C8A01BAEDFE_120_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A31C300)
#define CLASS_1_5B567C8A01BAEDFE_120_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A31C3E0)
#define CLASS_1_5B567C8A01BAEDFE_120_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A31C4D0)
#define CLASS_1_5B567C8A01BAEDFE_120_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A31C4A0)
#define CLASS_1_5B567C8A01BAEDFE_120_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A31C1E0)
#define CLASS_1_5B567C8A01BAEDFE_120_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A31C240)
#define CLASS_1_5B567C8A01BAEDFE_120_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A31C410)
#define CLASS_1_5B567C8A01BAEDFE_120_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A31C470)
#define CLASS_1_5B567C8A01BAEDFE_120__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A31C520)
#define CLASS_1_5B567C8A01BAEDFE_120__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A31C260)
#define CLASS_1_5B567C8A01BAEDFE_120__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31C250)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_120_TypeDefinitionIndex = 26755;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_120*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_120_TypeDefinitionIndex)->GetStaticField(0x53F40);
	}
