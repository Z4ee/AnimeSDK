...
#define CLASS_3_ED823159C0D529ED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1A3DE0)
#define CLASS_3_ED823159C0D529ED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1A3E70)
#define CLASS_3_ED823159C0D529ED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1A3DC0)
#define CLASS_3_ED823159C0D529ED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A3D50)

inline static constexpr unsigned int Class_3_ED823159C0D529ED_TypeDefinitionIndex = 35549;
