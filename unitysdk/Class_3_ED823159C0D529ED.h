...
#define CLASS_3_ED823159C0D529ED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x165E81C0)
#define CLASS_3_ED823159C0D529ED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x165E8250)
#define CLASS_3_ED823159C0D529ED_INVOKE_OFFSET UNITYSDK_OFFSET(0x165C9580)
#define CLASS_3_ED823159C0D529ED__CTOR_OFFSET UNITYSDK_OFFSET(0x165E81A0)

inline static constexpr unsigned int Class_3_ED823159C0D529ED_TypeDefinitionIndex = 28374;
