...
#define CLASS_3_ED823159C0D529ED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AADE40)
#define CLASS_3_ED823159C0D529ED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AADED0)
#define CLASS_3_ED823159C0D529ED_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AADE20)
#define CLASS_3_ED823159C0D529ED__CTOR_OFFSET UNITYSDK_OFFSET(0x18AADDB0)

inline static constexpr unsigned int Class_3_ED823159C0D529ED_TypeDefinitionIndex = 34306;
