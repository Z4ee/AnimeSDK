...
#define UIMOVEANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB9A0BD0)
#define UIMOVEANIMATION_START_OFFSET UNITYSDK_OFFSET(0xB9A0A10)
#define UIMOVEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A0E60)
