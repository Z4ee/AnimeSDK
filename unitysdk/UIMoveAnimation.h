...
#define UIMOVEANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAC29EA0)
#define UIMOVEANIMATION_START_OFFSET UNITYSDK_OFFSET(0xAC29CE0)
#define UIMOVEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xAC2A130)

inline static constexpr unsigned int UIMoveAnimation_TypeDefinitionIndex = 38191;
