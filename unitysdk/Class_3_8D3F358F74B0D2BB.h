...
#define CLASS_3_8D3F358F74B0D2BB_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x14912CB0)
#define CLASS_3_8D3F358F74B0D2BB_METHOD_3_149BCC7B62EEC1D9_OFFSET UNITYSDK_OFFSET(0x14912D90)
#define CLASS_3_8D3F358F74B0D2BB_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x14912E70)
#define CLASS_3_8D3F358F74B0D2BB_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x14912F00)
#define CLASS_3_8D3F358F74B0D2BB_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x14912C60)
#define CLASS_3_8D3F358F74B0D2BB__CCTOR_OFFSET UNITYSDK_OFFSET(0x14912D00)
#define CLASS_3_8D3F358F74B0D2BB__CTOR_OFFSET UNITYSDK_OFFSET(0x14912D80)

inline static constexpr unsigned int Class_3_8D3F358F74B0D2BB_TypeDefinitionIndex = 56389;

class Class_3_8D3F358F74B0D2BB : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_4 = 0xCB; // 0x0
	::Class_1_0E33DF6F3EFCEEBD* Field_3_5; // 0x48
	::MoleMole::Config::LevelGlobalCounterstrokeConfig* Field_3_7; // 0x50
	::MoleMole::Config::LevelGlobalAICounterstrokeData* Field_3_6; // 0x58
	::System::Collections::Generic::List_1<::Class_1_E944D5DF6BBB6FC4*>* Field_3_0; // 0x60
