...
#define CLASS_3_8D3F358F74B0D2BB_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x1500FE50)
#define CLASS_3_8D3F358F74B0D2BB_METHOD_3_149BCC7B62EEC1D9_OFFSET UNITYSDK_OFFSET(0x1500FFC0)
#define CLASS_3_8D3F358F74B0D2BB_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1500FF30)
#define CLASS_3_8D3F358F74B0D2BB_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x150100A0)
#define CLASS_3_8D3F358F74B0D2BB_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x1500FDF0)
#define CLASS_3_8D3F358F74B0D2BB__CCTOR_OFFSET UNITYSDK_OFFSET(0x1500FEA0)
#define CLASS_3_8D3F358F74B0D2BB__CTOR_OFFSET UNITYSDK_OFFSET(0x1500FF20)

inline static constexpr unsigned int Class_3_8D3F358F74B0D2BB_TypeDefinitionIndex = 62405;

class Class_3_8D3F358F74B0D2BB : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_7 = 0xC9; // 0x0
	::MoleMole::Config::LevelGlobalAICounterstrokeData* Field_3_5; // 0x48
	::System::Collections::Generic::List_1<::Class_1_E944D5DF6BBB6FC4*>* Field_3_3; // 0x50
	::Class_1_0E33DF6F3EFCEEBD* Field_3_6; // 0x58
