...
#define TMPRO_TMP_MATH_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1EC51A90)
#define TMPRO_TMP_MATH_MOD_OFFSET UNITYSDK_OFFSET(0x1EC51AC0)
#define TMPRO_TMP_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC51AE0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Math_TypeDefinitionIndex = 43487;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(TMP_Math_TypeDefinitionIndex)->GetStaticField(0x1A00);
		}
		static ::UnityEngine::Vector2* StaticGet_MAX_16BIT()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(TMP_Math_TypeDefinitionIndex)->GetStaticField(0x1A08);
		}
