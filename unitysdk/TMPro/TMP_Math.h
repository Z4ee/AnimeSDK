...
#define TMPRO_TMP_MATH_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1B1CE040)
#define TMPRO_TMP_MATH_MOD_OFFSET UNITYSDK_OFFSET(0x1B1CE070)
#define TMPRO_TMP_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1CE090)
...
namespace TMPro
{
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(TMP_Math_TypeDefinitionIndex)->GetStaticField(0x11A90);
		}
		static ::UnityEngine::Vector2* StaticGet_MAX_16BIT()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(TMP_Math_TypeDefinitionIndex)->GetStaticField(0x11A98);
		}
