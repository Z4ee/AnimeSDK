...
#define TMPRO_FASTACTION_ADD_OFFSET UNITYSDK_OFFSET(0x18903C10)
#define TMPRO_FASTACTION_CALL_OFFSET UNITYSDK_OFFSET(0x18903E30)
#define TMPRO_FASTACTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x18903D20)
#define TMPRO_FASTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18903E90)

namespace TMPro
{
	inline static constexpr unsigned int FastAction_TypeDefinitionIndex = 34268;
