...
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x171C1C70)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x171C1F70)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x171C1FD0)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x171C1F80)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x171C1C60)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294__CTOR_OFFSET UNITYSDK_OFFSET(0x171B8180)

namespace TMPro
{
	inline static constexpr unsigned int TMP_InputField__MouseDragOutsideRect_d__294_TypeDefinitionIndex = 41803;
