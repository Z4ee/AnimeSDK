...
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EC4DA10)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EC4DD10)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EC4DD70)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EC4DD20)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EC4DA00)
#define TMPRO_TMP_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__294__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC44650)
