...
#define TMPRO_TMP_INPUTFIELD_SELECTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C495C10)

namespace TMPro
{
	inline static constexpr unsigned int TMP_InputField_SelectionEvent_TypeDefinitionIndex = 37533;
