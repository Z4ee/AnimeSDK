...
#define TMPRO_TMP_INPUTFIELD_SELECTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC3BCE0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_InputField_SelectionEvent_TypeDefinitionIndex = 43409;
