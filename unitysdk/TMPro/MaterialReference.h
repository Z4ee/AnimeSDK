...
#define TMPRO_MATERIALREFERENCE_ADDMATERIALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x17192AB0)
#define TMPRO_MATERIALREFERENCE_ADDMATERIALREFERENCE_OFFSET UNITYSDK_OFFSET(0x171928B0)
#define TMPRO_MATERIALREFERENCE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x171927D0)
#define TMPRO_MATERIALREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x394EBE0)

namespace TMPro
{
	inline static constexpr unsigned int MaterialReference_TypeDefinitionIndex = 41736;
