...
#define TMPRO_TMP_TEXT_CHARACTERSUBSTITUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x73E20)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Text_CharacterSubstitution_TypeDefinitionIndex = 40211;
