...
#define TMPRO_TMP_TEXT_CHARACTERSUBSTITUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBE0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Text_CharacterSubstitution_TypeDefinitionIndex = 41038;
