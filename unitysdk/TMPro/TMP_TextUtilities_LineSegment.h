...
#define TMPRO_TMP_TEXTUTILITIES_LINESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x3975A0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_TextUtilities_LineSegment_TypeDefinitionIndex = 39896;
