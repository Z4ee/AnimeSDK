...
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x1E7472B0)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E7472D0)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1E747290)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_GET_TOGGLE_OFFSET UNITYSDK_OFFSET(0x1E7472F0)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x1E747390)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1E747310)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_SET_IMAGE_OFFSET UNITYSDK_OFFSET(0x1E7472C0)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_SET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E7472E0)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1E7472A0)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM_SET_TOGGLE_OFFSET UNITYSDK_OFFSET(0x1E747300)
#define TMPRO_TMP_DROPDOWN_DROPDOWNITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7474C0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Dropdown_DropdownItem_TypeDefinitionIndex = 39121;
