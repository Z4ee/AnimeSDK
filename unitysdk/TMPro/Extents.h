...
#define TMPRO_EXTENTS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x387A0C0)
#define TMPRO_EXTENTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B198020)
#define TMPRO_EXTENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x80F20)
...
namespace TMPro
{
	...
	struct alignas(4) Extents
	{
		...
		{
			return (::TMPro::Extents*)Il2CppClass::FromTypeDefinitionIndex(Extents_TypeDefinitionIndex)->GetStaticField(0x11640);
		}
		static ::TMPro::Extents* StaticGet_zero()
		{
			return (::TMPro::Extents*)Il2CppClass::FromTypeDefinitionIndex(Extents_TypeDefinitionIndex)->GetStaticField(0x11650);
		}
