...
#define TMPRO_TMP_DROPDOWN___C__DISPLAYCLASS69_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1890FF00)
#define TMPRO_TMP_DROPDOWN___C__DISPLAYCLASS69_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x18910B10)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Dropdown___c__DisplayClass69_0_TypeDefinitionIndex = 34301;

	class TMP_Dropdown___c__DisplayClass69_0 : public ::System::Object
	{
	public:
		::TMPro::TMP_Dropdown_DropdownItem* item; // 0x10
