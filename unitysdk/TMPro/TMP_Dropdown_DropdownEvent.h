...
#define TMPRO_TMP_DROPDOWN_DROPDOWNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1890DC00)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Dropdown_DropdownEvent_TypeDefinitionIndex = 34300;
