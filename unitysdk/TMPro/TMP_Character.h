...
#define TMPRO_TMP_CHARACTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B28E70)
#define TMPRO_TMP_CHARACTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18B28EB0)
#define TMPRO_TMP_CHARACTER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18B28EF0)
#define TMPRO_TMP_CHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B28E60)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Character_TypeDefinitionIndex = 43349;
