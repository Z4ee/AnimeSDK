...
#define TMPRO_TMP_SPRITECHARACTER_GET_HASHCODE_OFFSET UNITYSDK_OFFSET(0x1EC5AD80)
#define TMPRO_TMP_SPRITECHARACTER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EC5AD70)
#define TMPRO_TMP_SPRITECHARACTER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1EC5AB20)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EC5AD90)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EC5ADC0)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EC5AE00)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC5AB10)
