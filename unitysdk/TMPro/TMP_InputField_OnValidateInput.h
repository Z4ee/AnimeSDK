...
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18936AD0)
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18936B50)
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18929860)
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x18936AB0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_InputField_OnValidateInput_TypeDefinitionIndex = 34334;
