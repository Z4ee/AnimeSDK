...
#define TMPRO_TMP_DROPDOWN_OPTIONDATA_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x1BF4A690)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1BF4A670)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA_SET_IMAGE_OFFSET UNITYSDK_OFFSET(0x1BF4A6A0)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1BF4A680)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF4A6C0)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BF4A6D0)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BF4A6E0)
#define TMPRO_TMP_DROPDOWN_OPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF4A6B0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Dropdown_OptionData_TypeDefinitionIndex = 37496;
