...
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C470AA0)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C470B10)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C470B70)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C470B20)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C470A90)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89__CTOR_OFFSET UNITYSDK_OFFSET(0x1C470A80)

namespace TMPro
{
	inline static constexpr unsigned int TextMeshProUGUI__DelayedGraphicRebuild_d__89_TypeDefinitionIndex = 37625;
