...
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A3D5400)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3D5470)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3D54D0)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3D5480)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3D53F0)
#define TMPRO_TEXTMESHPROUGUI__DELAYEDGRAPHICREBUILD_D__89__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D25D0)

namespace TMPro
{
	inline static constexpr unsigned int TextMeshProUGUI__DelayedGraphicRebuild_d__89_TypeDefinitionIndex = 40248;
