...
#define TMPRO_TMP_FONTFEATURETABLE_GET_GLYPHPAIRADJUSTMENTRECORDS_OFFSET UNITYSDK_OFFSET(0x1FC208A0)
#define TMPRO_TMP_FONTFEATURETABLE_SET_GLYPHPAIRADJUSTMENTRECORDS_OFFSET UNITYSDK_OFFSET(0x1FC208B0)
#define TMPRO_TMP_FONTFEATURETABLE_SORTGLYPHPAIRADJUSTMENTRECORDS_OFFSET UNITYSDK_OFFSET(0x1FC209B0)
#define TMPRO_TMP_FONTFEATURETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC208C0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_FontFeatureTable_TypeDefinitionIndex = 39810;
