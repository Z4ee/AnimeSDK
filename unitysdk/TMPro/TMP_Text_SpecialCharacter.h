...
#define TMPRO_TMP_TEXT_SPECIALCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xACB260)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Text_SpecialCharacter_TypeDefinitionIndex = 39883;
