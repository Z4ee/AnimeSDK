...
#define TMPRO_TMP_VERTEX_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1896EE50)
#define TMPRO_TMP_VERTEX__CCTOR_OFFSET UNITYSDK_OFFSET(0x1896EEA0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Vertex_TypeDefinitionIndex = 34278;

	struct alignas(4) TMP_Vertex
	{
		static ::TMPro::TMP_Vertex* StaticGet_k_Zero()
		{
			return (::TMPro::TMP_Vertex*)Il2CppClass::FromTypeDefinitionIndex(TMP_Vertex_TypeDefinitionIndex)->GetStaticField(0xF550);
		}
