...
#define TMPRO_FONTASSETCREATIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x394E950)

namespace TMPro
{
	inline static constexpr unsigned int FontAssetCreationSettings_TypeDefinitionIndex = 41771;
