...
#define TMPRO_TMP_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__81_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F6A2C00)
#define TMPRO_TMP_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__81_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F6A2CA0)
#define TMPRO_TMP_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__81_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F6A2D00)
#define TMPRO_TMP_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__81_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F6A2CB0)
#define TMPRO_TMP_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__81_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F6A2BF0)
#define TMPRO_TMP_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__81__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6A2BE0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Dropdown__DelayedDestroyDropdownList_d__81_TypeDefinitionIndex = 39792;
