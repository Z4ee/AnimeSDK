...
#define TMPRO_TMP_SETTINGS_LINEBREAKINGTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18940A10)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Settings_LineBreakingTable_TypeDefinitionIndex = 34366;
