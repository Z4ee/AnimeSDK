...
#define TMPRO_TMP_SETTINGS_LINEBREAKINGTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C560EB0)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Settings_LineBreakingTable_TypeDefinitionIndex = 37562;
