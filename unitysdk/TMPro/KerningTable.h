...
#define TMPRO_KERNINGTABLE_ADDGLYPHPAIRADJUSTMENTRECORD_OFFSET UNITYSDK_OFFSET(0x1EC1EA70)
#define TMPRO_KERNINGTABLE_ADDKERNINGPAIR_1_OFFSET UNITYSDK_OFFSET(0x1EC1E8B0)
#define TMPRO_KERNINGTABLE_ADDKERNINGPAIR_OFFSET UNITYSDK_OFFSET(0x1EC1E6D0)
#define TMPRO_KERNINGTABLE_REMOVEKERNINGPAIR_1_OFFSET UNITYSDK_OFFSET(0x1EC1EDD0)
#define TMPRO_KERNINGTABLE_REMOVEKERNINGPAIR_OFFSET UNITYSDK_OFFSET(0x1EC1EC50)
#define TMPRO_KERNINGTABLE_SORTKERNINGPAIRS_OFFSET UNITYSDK_OFFSET(0x1EC1EE70)
#define TMPRO_KERNINGTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC1E690)

namespace TMPro
{
	inline static constexpr unsigned int KerningTable_TypeDefinitionIndex = 43387;
