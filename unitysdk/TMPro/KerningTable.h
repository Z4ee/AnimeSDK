...
#define TMPRO_KERNINGTABLE_ADDGLYPHPAIRADJUSTMENTRECORD_OFFSET UNITYSDK_OFFSET(0x1FBDAAA0)
#define TMPRO_KERNINGTABLE_ADDKERNINGPAIR_1_OFFSET UNITYSDK_OFFSET(0x1FBDA950)
#define TMPRO_KERNINGTABLE_ADDKERNINGPAIR_OFFSET UNITYSDK_OFFSET(0x1FBDA820)
#define TMPRO_KERNINGTABLE_REMOVEKERNINGPAIR_1_OFFSET UNITYSDK_OFFSET(0x1FBDAD90)
#define TMPRO_KERNINGTABLE_REMOVEKERNINGPAIR_OFFSET UNITYSDK_OFFSET(0x1FBDAC10)
#define TMPRO_KERNINGTABLE_SORTKERNINGPAIRS_OFFSET UNITYSDK_OFFSET(0x1FBDAE10)
#define TMPRO_KERNINGTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBDA7A0)

namespace TMPro
{
	inline static constexpr unsigned int KerningTable_TypeDefinitionIndex = 39803;
