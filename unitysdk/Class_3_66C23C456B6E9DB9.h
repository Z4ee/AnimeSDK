...
#define CLASS_3_66C23C456B6E9DB9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11963980)
#define CLASS_3_66C23C456B6E9DB9_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x11963970)
#define CLASS_3_66C23C456B6E9DB9_METHOD_3_F2566C84FEF1DF87_OFFSET UNITYSDK_OFFSET(0x11963A20)
#define CLASS_3_66C23C456B6E9DB9_ONSKIP_OFFSET UNITYSDK_OFFSET(0x119639C0)
#define CLASS_3_66C23C456B6E9DB9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11963BB0)
#define CLASS_3_66C23C456B6E9DB9__CTOR_OFFSET UNITYSDK_OFFSET(0x11963940)
#define CLASS_3_66C23C456B6E9DB9___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11963C00)
