...
#define STRUCT_2_ABBDBB7B60DE9902_METHOD_2_2605F0751F5E30D5_OFFSET UNITYSDK_OFFSET(0x80D0D0)
#define STRUCT_2_ABBDBB7B60DE9902_METHOD_2_7CE29E791A6BAC06_OFFSET UNITYSDK_OFFSET(0x80D2A0)
#define STRUCT_2_ABBDBB7B60DE9902_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x427580)
#define STRUCT_2_ABBDBB7B60DE9902_METHOD_2_FC4D88BEF78643FE_OFFSET UNITYSDK_OFFSET(0x80D270)
#define STRUCT_2_ABBDBB7B60DE9902__CCTOR_OFFSET UNITYSDK_OFFSET(0x15D2A0E0)
#define STRUCT_2_ABBDBB7B60DE9902__CTOR_OFFSET UNITYSDK_OFFSET(0x2AD810)

inline static constexpr unsigned int Struct_2_ABBDBB7B60DE9902_TypeDefinitionIndex = 73792;

struct alignas(8) Struct_2_ABBDBB7B60DE9902
{
	static ::Struct_2_ABBDBB7B60DE9902* StaticGet_Field_2_1()
	{
		return (::Struct_2_ABBDBB7B60DE9902*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_ABBDBB7B60DE9902_TypeDefinitionIndex)->GetStaticField(0xB040);
	}
