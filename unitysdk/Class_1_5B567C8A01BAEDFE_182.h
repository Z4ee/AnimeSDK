...
#define CLASS_1_5B567C8A01BAEDFE_182_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D90A300)
#define CLASS_1_5B567C8A01BAEDFE_182_CLONE_OFFSET UNITYSDK_OFFSET(0x1D909FF0)
#define CLASS_1_5B567C8A01BAEDFE_182_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D90A100)
#define CLASS_1_5B567C8A01BAEDFE_182_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D90A030)
#define CLASS_1_5B567C8A01BAEDFE_182_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D90A260)
#define CLASS_1_5B567C8A01BAEDFE_182_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D90A350)
#define CLASS_1_5B567C8A01BAEDFE_182_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D90A320)
#define CLASS_1_5B567C8A01BAEDFE_182_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D909F70)
#define CLASS_1_5B567C8A01BAEDFE_182_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D909FA0)
#define CLASS_1_5B567C8A01BAEDFE_182_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D90A290)
#define CLASS_1_5B567C8A01BAEDFE_182_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D90A2F0)
#define CLASS_1_5B567C8A01BAEDFE_182__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D90A3A0)
#define CLASS_1_5B567C8A01BAEDFE_182__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D909FC0)
#define CLASS_1_5B567C8A01BAEDFE_182__CTOR_OFFSET UNITYSDK_OFFSET(0x1D909FB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_182_TypeDefinitionIndex = 29756;

class Class_1_5B567C8A01BAEDFE_182 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_182*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_182*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_182_TypeDefinitionIndex)->GetStaticField(0x526B0);
	}
