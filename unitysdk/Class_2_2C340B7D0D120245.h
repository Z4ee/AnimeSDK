...
#define CLASS_2_2C340B7D0D120245_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11956D90)
#define CLASS_2_2C340B7D0D120245_METHOD_2_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x11956F50)
#define CLASS_2_2C340B7D0D120245_METHOD_2_1290EA767C459179_2_OFFSET UNITYSDK_OFFSET(0x11957030)
#define CLASS_2_2C340B7D0D120245_METHOD_2_1290EA767C459179_3_OFFSET UNITYSDK_OFFSET(0x11957110)
#define CLASS_2_2C340B7D0D120245_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x11956E70)
#define CLASS_2_2C340B7D0D120245_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11956680)
#define CLASS_2_2C340B7D0D120245_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11956A90)
#define CLASS_2_2C340B7D0D120245_TICK_OFFSET UNITYSDK_OFFSET(0x119571F0)
#define CLASS_2_2C340B7D0D120245__CTOR_OFFSET UNITYSDK_OFFSET(0x119564B0)

inline static constexpr unsigned int Class_2_2C340B7D0D120245_TypeDefinitionIndex = 47061;

class Class_2_2C340B7D0D120245 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_5775A4FEC79026BC* Field_2_3; // 0x18
	::RPG::GameCore::PropFastDeliverPuzzleListener* Field_2_1; // 0x20
	::RPG::Client::Prop::FastDeliverPuzzleBoard* Field_2_2; // 0x28
	::Class_3_5775A4FEC79026BC* Field_2_9; // 0x30
