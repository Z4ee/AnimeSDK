...
#define CLASS_2_1FFAB51C508E8509_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB59AA80)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_0742B6775750851D_OFFSET UNITYSDK_OFFSET(0xB59BF80)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_125EBF3466E4530A_OFFSET UNITYSDK_OFFSET(0xB59C400)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_261C2B64774FC8E4_OFFSET UNITYSDK_OFFSET(0xB59BDD0)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_2B66C008535F8B01_OFFSET UNITYSDK_OFFSET(0xB59AB70)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_4919B89B94C0D6A5_OFFSET UNITYSDK_OFFSET(0xB59C210)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_5C0C256643E989F8_OFFSET UNITYSDK_OFFSET(0xB59AA00)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_5FE08FC6FFC33008_OFFSET UNITYSDK_OFFSET(0xB59BAC0)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xB59BC20)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_9C45022812211693_OFFSET UNITYSDK_OFFSET(0xB59B9F0)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_C0E1A11BAA953771_OFFSET UNITYSDK_OFFSET(0xB59C0F0)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0xB59B500)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0xB59BBC0)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xB59B2D0)
#define CLASS_2_1FFAB51C508E8509_METHOD_2_EB522918F22FFA3B_OFFSET UNITYSDK_OFFSET(0xB59BD00)
#define CLASS_2_1FFAB51C508E8509_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xB59BA60)
#define CLASS_2_1FFAB51C508E8509_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB59AC40)
#define CLASS_2_1FFAB51C508E8509_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB59B8F0)
#define CLASS_2_1FFAB51C508E8509_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0xB59ABF0)
#define CLASS_2_1FFAB51C508E8509_TICK_OFFSET UNITYSDK_OFFSET(0xB59B940)
#define CLASS_2_1FFAB51C508E8509__CTOR_OFFSET UNITYSDK_OFFSET(0xB59A7E0)
#define CLASS_2_1FFAB51C508E8509___PROMISEFULLKEEPTIMEOUT_B__19_0_OFFSET UNITYSDK_OFFSET(0xB59C5E0)
#define CLASS_2_1FFAB51C508E8509___STARTFULLWITHTEXT_B__14_0_OFFSET UNITYSDK_OFFSET(0xB59C4C0)
...
public:
	...
	::RPG::Client::Promises::Promise* KALNJICBIGJ; // 0x20
	::RPG::GameCore::PlayScreenTransfer* OFKGLJOAMLD; // 0x28
	::System::Exception* LMLAIDOEMCK; // 0x30
	::Class_1_5F51D4049EA87B7B* CJHJNLGOJLA; // 0x38
	::RPG::Client::Promises::Promise* JCCIDPKEOPA; // 0x40
	::Class_1_23F67DD15593C8D6* MMKPAPCNEAC; // 0x48
	::RPG::Client::Promises::Promise* FBGJLIMGKIA; // 0x50
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x58
	::RPG::GameCore::ScreenTransferReason FBPGLJAFBHF; // 0x60
	::System::Boolean JNPKMIGKDJP; // 0x64
	::System::Boolean OGCIFIFIAEP; // 0x65
