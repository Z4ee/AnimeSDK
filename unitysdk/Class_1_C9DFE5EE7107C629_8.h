...
#define CLASS_1_C9DFE5EE7107C629_8_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17F50120)
#define CLASS_1_C9DFE5EE7107C629_8_CLONE_OFFSET UNITYSDK_OFFSET(0x17F4FB30)
#define CLASS_1_C9DFE5EE7107C629_8_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17F4FC80)
#define CLASS_1_C9DFE5EE7107C629_8_EQUALS_OFFSET UNITYSDK_OFFSET(0x17F4FC20)
#define CLASS_1_C9DFE5EE7107C629_8_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17F4FD50)
#define CLASS_1_C9DFE5EE7107C629_8_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17F50440)
#define CLASS_1_C9DFE5EE7107C629_8_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17F503C0)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17F4FBD0)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17F4FB80)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17F4FC10)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x17F4FBF0)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17F4FBC0)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17F4FBE0)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17F4FB90)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17F4FC00)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17F4FBB0)
#define CLASS_1_C9DFE5EE7107C629_8_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17F4FBA0)
#define CLASS_1_C9DFE5EE7107C629_8_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17F4F990)
#define CLASS_1_C9DFE5EE7107C629_8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F4FF30)
#define CLASS_1_C9DFE5EE7107C629_8_WRITETO_OFFSET UNITYSDK_OFFSET(0x17F4FF90)
#define CLASS_1_C9DFE5EE7107C629_8__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F505F0)
#define CLASS_1_C9DFE5EE7107C629_8__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17F4FA30)
#define CLASS_1_C9DFE5EE7107C629_8__CTOR_OFFSET UNITYSDK_OFFSET(0x17F4F9A0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_8_TypeDefinitionIndex)->GetStaticField(0x31E70);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_11()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_8_TypeDefinitionIndex)->GetStaticField(0x31E78);
	}
