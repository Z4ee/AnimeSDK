...
#define CLASS_1_3EE9A6D817C1ADA3_ADD_ONRECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x177E1BE0)
#define CLASS_1_3EE9A6D817C1ADA3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x177E2090)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_13FE76C7C96BEC2E_OFFSET UNITYSDK_OFFSET(0x177E1B30)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_5F1CE4B44626D198_OFFSET UNITYSDK_OFFSET(0x177E1B70)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x177E1E50)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x177E2280)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_F0BD65B017F2AC0B_1_OFFSET UNITYSDK_OFFSET(0x177E2310)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x177E2230)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_FD407F543E29DD0C_OFFSET UNITYSDK_OFFSET(0x177E1F00)
#define CLASS_1_3EE9A6D817C1ADA3_REMOVE_ONRECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x177E1C40)
#define CLASS_1_3EE9A6D817C1ADA3__CTOR_OFFSET UNITYSDK_OFFSET(0x177E1CA0)

inline static constexpr unsigned int Class_1_3EE9A6D817C1ADA3_TypeDefinitionIndex = 80244;

class Class_1_3EE9A6D817C1ADA3 : public ::System::Object
{
public:
	::System::Action* OnRecordChanged; // 0x10
	::Class_1_DFB5A9B3A6CD66C9* FCNCPKGEMJF; // 0x18
	::Class_1_06E38C65842C3B24* JHINGAOJMBI; // 0x20
	::RPG::Client::Challenge::Tierce::ChallengeTierceRecordBase* IKMGKHNGJHB; // 0x28
