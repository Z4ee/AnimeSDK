...
#define CLASS_2_6340C04A047766BC_METHOD_2_0CAD65B68E26D548_OFFSET UNITYSDK_OFFSET(0xFB0AB50)
#define CLASS_2_6340C04A047766BC_METHOD_2_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xFB0AC90)
#define CLASS_2_6340C04A047766BC_METHOD_2_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0xFB0A8B0)
#define CLASS_2_6340C04A047766BC_METHOD_2_3302777B3F94C762_OFFSET UNITYSDK_OFFSET(0xFB0ACC0)
#define CLASS_2_6340C04A047766BC_METHOD_2_45A4CA3368909146_OFFSET UNITYSDK_OFFSET(0xFB0AA40)
#define CLASS_2_6340C04A047766BC_METHOD_2_7D201B4343E63821_OFFSET UNITYSDK_OFFSET(0xFB0ACB0)
#define CLASS_2_6340C04A047766BC_METHOD_2_A49CFCC54F551DDE_OFFSET UNITYSDK_OFFSET(0xFB0A8D0)
#define CLASS_2_6340C04A047766BC_METHOD_2_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xFB0AD20)
#define CLASS_2_6340C04A047766BC_METHOD_2_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xFB0ACA0)
#define CLASS_2_6340C04A047766BC_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xFB0A8C0)
#define CLASS_2_6340C04A047766BC__CTOR_OFFSET UNITYSDK_OFFSET(0xFB0AC80)

inline static constexpr unsigned int Class_2_6340C04A047766BC_TypeDefinitionIndex = 47194;

class Class_2_6340C04A047766BC : public ::Class_1_C36D127C88299910
{
public:
	::MoleMole::Config::ConfigHollowCameraStretchV2* Field_2_3; // 0x78
	::System::String* Field_2_0; // 0x80
	::System::Boolean Field_2_1; // 0x88
	::UnityEngine::Vector3 Field_2_2; // 0x8C
	...
	::Class_0_16E4307DCC419505_190* Method_2_45A4CA3368909146(::MoleMole::UICameraAtom a1, ::MoleMole::UICameraAtom a2)
	{
		return ((::Class_0_16E4307DCC419505_190*(*)(::PVOID, ::MoleMole::UICameraAtom, ::MoleMole::UICameraAtom))((::PBYTE)hIl2Cpp + CLASS_2_6340C04A047766BC_METHOD_2_45A4CA3368909146_OFFSET))(this, a1, a2);
	}
