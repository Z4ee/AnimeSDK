...
#define CLASS_1_F279323643B7008A__CTOR_OFFSET UNITYSDK_OFFSET(0x1C753A60)
...
{
public:
	::System::Single KKHAELMENEH; // 0x10
	::System::Int32 DEICFHOKPOB; // 0x14
	::System::Int32 HNLLIOJDOEL; // 0x18
	::System::Int32 AAHCOCFCAJD; // 0x1C
	::RPG::GameCore::PingPongPatrolType GMPGDEINODK; // 0x20
	::System::UInt32 FEFGPOPNHDI; // 0x24
	::System::Single EMNHIJAIMBE; // 0x28
