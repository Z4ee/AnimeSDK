...
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1E102AF0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOBOOL_OFFSET UNITYSDK_OFFSET(0x1E101940)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOBYTE_OFFSET UNITYSDK_OFFSET(0x1E101DA0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1E101E10)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTODOUBLE_OFFSET UNITYSDK_OFFSET(0x1E101730)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOFLOAT_OFFSET UNITYSDK_OFFSET(0x1E1015F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOINT_OFFSET UNITYSDK_OFFSET(0x1E101160)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1E102D30)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOLONG_OFFSET UNITYSDK_OFFSET(0x1E101870)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1E102790)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1E102510)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTORECT_OFFSET UNITYSDK_OFFSET(0x1E102660)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOSTRING_OFFSET UNITYSDK_OFFSET(0x1E101990)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOUINT_OFFSET UNITYSDK_OFFSET(0x1E101270)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOULONG_OFFSET UNITYSDK_OFFSET(0x1E1013B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOUSHORT_OFFSET UNITYSDK_OFFSET(0x1E1014E0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1E102070)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1E101F60)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1E1022A0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1E102160)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1E1023C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_CRC32_OFFSET UNITYSDK_OFFSET(0x1E101C20)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_GETFIELDSIZE_OFFSET UNITYSDK_OFFSET(0x1E1010C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_GET_CRCTABLE_OFFSET UNITYSDK_OFFSET(0x1E100D60)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_INDEXTOUNITYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1E1053A0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_INDEXTOUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1E102DF0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGHASH_OFFSET UNITYSDK_OFFSET(0x1E100DC0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1E104630)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1E103FC0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1E103D60)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTORECT_OFFSET UNITYSDK_OFFSET(0x1E1048A0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1E103530)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1E103380)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1E1038F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1E1036D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1E103AF0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_TRYGETFIELDINDEX_1_OFFSET UNITYSDK_OFFSET(0x1E103110)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_TRYGETFIELDINDEX_OFFSET UNITYSDK_OFFSET(0x1E102E90)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_VALUETOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1E104BE0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_VALUETOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1E104BA0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E105440)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E105430)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int PrecompiledTypeDeserializer_TypeDefinitionIndex = 33254;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::PrecompiledTypeDeserializer_WrongVersionException**)Il2CppClass::FromTypeDefinitionIndex(PrecompiledTypeDeserializer_TypeDefinitionIndex)->GetStaticField(0x27570);
		}
