...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDGAMEOBJECTLIST_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1BEB26A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDGAMEOBJECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB2760)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedGameObjectList_TypeDefinitionIndex = 31730;
