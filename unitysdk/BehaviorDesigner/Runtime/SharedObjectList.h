...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDOBJECTLIST_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E4FAFF0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDOBJECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4FB0B0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedObjectList_TypeDefinitionIndex = 33290;
