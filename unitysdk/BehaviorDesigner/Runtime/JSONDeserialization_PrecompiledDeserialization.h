...
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D4A72C0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEREFERENCEDTASK_OFFSET UNITYSDK_OFFSET(0x1D4A7040)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1D4A65B0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1D4A63C0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZETASK_OFFSET UNITYSDK_OFFSET(0x1D4A52D0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1D4A4D90)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x1D4A5F20)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x1D4A0850)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 33246;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x27400);
		}
