...
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E85B710)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEREFERENCEDTASK_OFFSET UNITYSDK_OFFSET(0x1E85B490)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1E85AA00)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1E85A800)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZETASK_OFFSET UNITYSDK_OFFSET(0x1E8596F0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1E8591B0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x1E85A360)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x1E854CB0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 33882;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x28C20);
		}
