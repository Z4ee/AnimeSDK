...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BEB2500)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BEB2530)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BEB2000)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB1FF0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int Behavior_BehaviorHandler_TypeDefinitionIndex = 31663;
