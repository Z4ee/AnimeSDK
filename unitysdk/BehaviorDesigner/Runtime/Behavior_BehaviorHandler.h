...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E1F7B30)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E1F7B60)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E1F7630)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F7610)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int Behavior_BehaviorHandler_TypeDefinitionIndex = 33214;
