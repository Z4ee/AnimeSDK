...
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E3C21F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E3C23D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E3C2430)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E3C23E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E3C21E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C21D0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int TaskCoroutine__RunCoroutine_d__9_TypeDefinitionIndex = 33267;
