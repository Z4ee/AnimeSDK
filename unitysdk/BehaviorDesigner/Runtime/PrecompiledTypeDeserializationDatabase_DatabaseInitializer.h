...
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F9A9D00)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F9A9D30)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F9A9A10)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9A99F0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int PrecompiledTypeDeserializationDatabase_DatabaseInitializer_TypeDefinitionIndex = 33898;
