...
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2664F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C266520)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2661C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_DATABASEINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2661B0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int PrecompiledTypeDeserializationDatabase_DatabaseInitializer_TypeDefinitionIndex = 31711;
