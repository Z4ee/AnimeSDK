...
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_GET_COROUTINE_OFFSET UNITYSDK_OFFSET(0x1F528A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1F528B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_STOP_OFFSET UNITYSDK_OFFSET(0x1F528A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F528AC0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int TaskCoroutine_TypeDefinitionIndex = 33902;

	class TaskCoroutine : public ::System::Object
	{
	public:
		::BehaviorDesigner::Runtime::Behavior* mParent; // 0x10
		::UnityEngine::Coroutine* mCoroutine; // 0x18
		::System::Collections::IEnumerator* mCoroutineEnumerator; // 0x20
		::System::String* mCoroutineName; // 0x28
