...
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_GET_COROUTINE_OFFSET UNITYSDK_OFFSET(0x1E1058E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1E1059D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_STOP_OFFSET UNITYSDK_OFFSET(0x1E1058F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E105930)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int TaskCoroutine_TypeDefinitionIndex = 33266;
