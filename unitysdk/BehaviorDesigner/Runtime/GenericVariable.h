...
#define BEHAVIORDESIGNER_RUNTIME_GENERICVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B046B90)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int GenericVariable_TypeDefinitionIndex = 31731;
