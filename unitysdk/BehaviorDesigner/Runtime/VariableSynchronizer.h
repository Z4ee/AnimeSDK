...
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E206260)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_COROUTINEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E207ED0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_CREATEGETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E2072C0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_CREATESETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E207480)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_SYNCHRONIZEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1E2061F0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1E206180)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E206030)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_SYNCHRONIZEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1E206200)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1E206190)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E206040)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_TICK_OFFSET UNITYSDK_OFFSET(0x1E2078E0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_UPDATEINTERVALCHANGED_OFFSET UNITYSDK_OFFSET(0x1E206090)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E207890)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E207F50)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int VariableSynchronizer_TypeDefinitionIndex = 33269;
