...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B04BA90)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1B04BA70)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x1B04BB50)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1B04BAB0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISSHARED_OFFSET UNITYSDK_OFFSET(0x1B04BA50)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B04BAD0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_NETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1B04BB30)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1B04BB10)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1B04BAF0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B04B990)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1B04B970)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1B04B9B0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISSHARED_OFFSET UNITYSDK_OFFSET(0x1B04B950)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMNAME_OFFSET UNITYSDK_OFFSET(0x1B04B9D0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMNETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1B04BA30)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMPROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1B04BA10)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1B04B9F0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_INITIALIZEPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1B04BC00)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B04BAA0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1B04BA80)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1B04BAC0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISSHARED_OFFSET UNITYSDK_OFFSET(0x1B04BA60)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B04BAE0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_NETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1B04BB40)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1B04BB20)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1B04BB00)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B04B9A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1B04B980)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1B04B9C0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISSHARED_OFFSET UNITYSDK_OFFSET(0x1B04B960)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMNAME_OFFSET UNITYSDK_OFFSET(0x1B04B9E0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMNETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1B04BA40)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMPROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1B04BA20)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1B04BA00)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B04BBC0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B04BC60)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B04BC50)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedVariable_TypeDefinitionIndex = 31687;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SharedVariable_TypeDefinitionIndex)->GetStaticField(0x7D30);
		}
