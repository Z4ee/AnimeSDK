...
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_CHECKFORSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1C0CD950)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_DOMAINRESET_OFFSET UNITYSDK_OFFSET(0x1C0CE3A0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1C0CDEC0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1C0CDD50)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1C0CD600)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VARIABLEDATA_OFFSET UNITYSDK_OFFSET(0x1C0CDD10)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1C0CDAA0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1C0CDD30)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1C0CE350)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1C0CE250)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1C0CDF10)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VARIABLEDATA_OFFSET UNITYSDK_OFFSET(0x1C0CDD20)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1C0CDAB0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1C0CDD40)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_UPDATEVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x1C0CE2E0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_UPDATEVARIABLESINDEX_OFFSET UNITYSDK_OFFSET(0x1C0CDB00)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C0CE450)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0CE3F0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int GlobalVariables_TypeDefinitionIndex = 31691;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::GlobalVariables**)Il2CppClass::FromTypeDefinitionIndex(GlobalVariables_TypeDefinitionIndex)->GetStaticField(0x25B20);
		}
