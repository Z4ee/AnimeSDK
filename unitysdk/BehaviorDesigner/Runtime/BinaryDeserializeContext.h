...
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT_GET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1F217500)
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT_SET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1F217510)
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F217520)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BinaryDeserializeContext_TypeDefinitionIndex = 33889;

	class BinaryDeserializeContext : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* FieldIndexMap; // 0x10
		::System::Security::Cryptography::SHA1* Sha1; // 0x18
		::BehaviorDesigner::Runtime::FieldSerializationData* FieldSerializationData; // 0x20
		::Il2CppArray<::System::Byte>* BytesBuffer; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>* StringCache; // 0x30
		::BehaviorDesigner::Runtime::IVariableSource* VariableSource; // 0x38
		::System::Boolean UpdatedSerialization; // 0x40
		::System::Boolean ShaHashSerialization; // 0x41
