...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D10E6C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D10E730)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D10E610)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_ThirdPartyTaskComparer_TypeDefinitionIndex = 33228;
