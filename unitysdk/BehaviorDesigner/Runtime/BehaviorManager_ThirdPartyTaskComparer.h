...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AD2F160)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AD2F1D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD2F0A0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_ThirdPartyTaskComparer_TypeDefinitionIndex = 31677;
