...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1F9A9970)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1F9A9960)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1F9A9980)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9A99E0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_TaskAddData_OverrideFieldValue_TypeDefinitionIndex = 33866;
