...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1C266130)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C266120)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C266140)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2661A0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_TaskAddData_OverrideFieldValue_TypeDefinitionIndex = 31679;
