...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D110080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D10FF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D110180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D110210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D1102A0)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetFloatList_TypeDefinitionIndex = 33383;
