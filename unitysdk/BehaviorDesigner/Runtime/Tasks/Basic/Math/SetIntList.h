...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD30F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD30DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD31050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD310E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD31170)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetIntList_TypeDefinitionIndex = 31833;
