...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDBDC40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDBDAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDBDD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDBDDC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDBDE50)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetBoolList_TypeDefinitionIndex = 31831;
