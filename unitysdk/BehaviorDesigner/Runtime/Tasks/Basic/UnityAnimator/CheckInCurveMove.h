...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x134D3D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x134D39C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x134D3E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x134D3B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x134D3ED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x134D3F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x134D3FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_CHECKINCURVEMOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x134D4080)

namespace BehaviorDesigner::Runtime::Tasks::Basic::UnityAnimator
{
	inline static constexpr unsigned int CheckInCurveMove_TypeDefinitionIndex = 72139;
