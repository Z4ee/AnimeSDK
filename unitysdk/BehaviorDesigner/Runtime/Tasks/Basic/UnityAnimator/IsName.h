...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDB350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDDADE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDAF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDDB3E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDB470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDDB500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISNAME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDB590)

namespace BehaviorDesigner::Runtime::Tasks::Basic::UnityAnimator
{
	inline static constexpr unsigned int IsName_TypeDefinitionIndex = 33385;
