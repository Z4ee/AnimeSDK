...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1F5D2C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETDEFAULTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F5D1CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1F5D2460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETUTILITY_OFFSET UNITYSDK_OFFSET(0x1F5D24A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1F5D2E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1F5D2E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F5D2BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_ID_OFFSET UNITYSDK_OFFSET(0x1F5D2E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x1F5D2E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_LASTSTATUS_OFFSET UNITYSDK_OFFSET(0x1F5D2100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1F5D2DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1F5D20C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYID_OFFSET UNITYSDK_OFFSET(0x1F5D20A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYINSTANT_OFFSET UNITYSDK_OFFSET(0x1F5D20E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYOWNER_OFFSET UNITYSDK_OFFSET(0x1F5D2080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_REFERENCEID_OFFSET UNITYSDK_OFFSET(0x1F5D2E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1F5D2B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1F5D2290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1F5D2520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONBEHAVIORRESTART_OFFSET UNITYSDK_OFFSET(0x1F5D24E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1F5D2970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1F5D2830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1F5D29C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1F5D2880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1F5D2420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1F5D2AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1F5D2560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONDRAWNODETEXT_OFFSET UNITYSDK_OFFSET(0x1F5D25A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONEND_OFFSET UNITYSDK_OFFSET(0x1F5D2390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D2350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D2310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1F5D23D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D1FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D22D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1F5D2A10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1F5D28D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1F5D2A60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1F5D2920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D2030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_DELETEALL_OFFSET UNITYSDK_OFFSET(0x1F5D38E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_DELETEKEY_OFFSET UNITYSDK_OFFSET(0x1F5D37C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1F5D2EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_GETINT_OFFSET UNITYSDK_OFFSET(0x1F5D3120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1F5D3360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_HASKEY_OFFSET UNITYSDK_OFFSET(0x1F5D35A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1F5D3000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_SETINT_OFFSET UNITYSDK_OFFSET(0x1F5D3260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1F5D34A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1F5D2240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SETGAMEOBJECTGETTER_OFFSET UNITYSDK_OFFSET(0x1F5D2B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1F5D2EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1F5D2E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F5D2B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_ID_OFFSET UNITYSDK_OFFSET(0x1F5D2E20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x1F5D2E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_LASTSTATUS_OFFSET UNITYSDK_OFFSET(0x1F5D2110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x1F5D2E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1F5D20D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYID_OFFSET UNITYSDK_OFFSET(0x1F5D20B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYINSTANT_OFFSET UNITYSDK_OFFSET(0x1F5D20F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYOWNER_OFFSET UNITYSDK_OFFSET(0x1F5D2090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_REFERENCEID_OFFSET UNITYSDK_OFFSET(0x1F5D2E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_TASKTAGID_OFFSET UNITYSDK_OFFSET(0x1F5D2C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F5D2C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STARTCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1F5D2650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STARTCOROUTINE_2_OFFSET UNITYSDK_OFFSET(0x1F5D26B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1F5D25F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STOPALLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x1F5D27E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STOPCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1F5D2780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1F5D2720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_TASKCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1F5D2120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_TRYGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1F5D2D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F5D3B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D3AF0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Task_TypeDefinitionIndex = 33943;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x28C40);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>** StaticGet_sharedFloatValueMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x28C48);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_sharedStringValueMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x28C50);
		}
		static ::System::Int32* StaticGet_sharedMapState()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x81D0);
		}
		::UnityEngine::GameObject* _innerGameObject; // 0x10
		::BehaviorDesigner::Runtime::Tasks::GameObjectGetter* _innerGameObjectGetter; // 0x18
		::UnityEngine::Transform* transform; // 0x20
		::BehaviorDesigner::Runtime::Behavior* owner; // 0x28
		::System::String* friendlyName; // 0x30
		::System::Int32 _taskTagID; // 0x38
		::System::Int32 referenceID; // 0x3C
		::System::Int32 id; // 0x40
		::BehaviorDesigner::Runtime::Tasks::TaskStatus _LastStatus_k__BackingField; // 0x44
		::System::Boolean disabled; // 0x48
		::System::Boolean instant; // 0x49
