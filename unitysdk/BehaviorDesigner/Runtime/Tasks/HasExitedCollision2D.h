...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1E3C2C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1E3C2C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C2E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C2BE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1E3C2B70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C2F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1E3C2FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1E3C3060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C30F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C3180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1E3C3210)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedCollision2D_TypeDefinitionIndex = 33313;
