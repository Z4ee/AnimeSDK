...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REQUIREDCOMPONENTATTRIBUTE_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1F8F72A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REQUIREDCOMPONENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8F72B0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RequiredComponentAttribute_TypeDefinitionIndex = 33967;
