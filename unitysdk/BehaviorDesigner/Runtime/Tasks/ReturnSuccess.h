...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E860000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_DECORATE_OFFSET UNITYSDK_OFFSET(0x1E8600A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1E860050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_ONEND_OFFSET UNITYSDK_OFFSET(0x1E8600F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E860140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E8601D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_DECORATE_OFFSET UNITYSDK_OFFSET(0x1E860260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1E8602F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1E860380)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ReturnSuccess_TypeDefinitionIndex = 34008;
