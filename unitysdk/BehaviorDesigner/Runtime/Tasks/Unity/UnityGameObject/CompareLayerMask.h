...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BAA5780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BAA5680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAA57D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BAA5860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BAA58F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int CompareLayerMask_TypeDefinitionIndex = 32162;
