...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE09670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE09570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE096C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE09750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE097E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int CompareLayerMask_TypeDefinitionIndex = 33713;
