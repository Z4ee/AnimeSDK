...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB75E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB74E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB7630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB76C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB7750)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int ActiveSelf_TypeDefinitionIndex = 32161;
