...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FCC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FCB00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1FCC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FCCE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVESELF___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FCD70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int ActiveSelf_TypeDefinitionIndex = 33712;
