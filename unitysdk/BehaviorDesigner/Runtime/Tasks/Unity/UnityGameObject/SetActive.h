...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB8240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB80E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB8290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB8320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB83B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SetActive_TypeDefinitionIndex = 32173;
