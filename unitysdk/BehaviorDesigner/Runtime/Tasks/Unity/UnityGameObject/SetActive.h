...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FD860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FD700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1FD8B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FD940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FD9D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SetActive_TypeDefinitionIndex = 33724;
