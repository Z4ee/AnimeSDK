...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1BA5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1BA480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BA620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1BA6B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1BA740)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int DestroyImmediate_TypeDefinitionIndex = 32165;
