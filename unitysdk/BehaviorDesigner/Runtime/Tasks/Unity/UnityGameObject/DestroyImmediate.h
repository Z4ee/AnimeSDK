...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E4FF020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4FEED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4FF070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E4FF100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROYIMMEDIATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4FF190)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int DestroyImmediate_TypeDefinitionIndex = 33716;
