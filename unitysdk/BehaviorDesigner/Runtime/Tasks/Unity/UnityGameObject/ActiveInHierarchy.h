...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7691F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7690F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F769240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7692D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F769360)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int ActiveInHierarchy_TypeDefinitionIndex = 34347;
