...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E46DE20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E46DD00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E46DEA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E46DF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E46DFC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetTag_TypeDefinitionIndex = 34357;
