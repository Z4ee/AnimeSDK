...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD36670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD36550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD366F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD36780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD36810)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetTag_TypeDefinitionIndex = 32170;

	class GetTag : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* storeValue; // 0x58
