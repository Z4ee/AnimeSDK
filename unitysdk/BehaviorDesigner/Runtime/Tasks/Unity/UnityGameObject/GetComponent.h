...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E196720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1965B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1967D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E196860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1968A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetComponent_TypeDefinitionIndex = 33720;

	class GetComponent : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* type; // 0x58
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x60
		::BehaviorDesigner::Runtime::SharedObject* storeValue; // 0x68
