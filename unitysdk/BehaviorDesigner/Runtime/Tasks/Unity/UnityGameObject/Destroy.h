...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FCFA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FCE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1FCFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FD080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FD110)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Destroy_TypeDefinitionIndex = 33715;
