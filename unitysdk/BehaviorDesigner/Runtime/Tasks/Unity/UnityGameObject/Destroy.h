...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60B6A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60B500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F60B6F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60B780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60B810)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Destroy_TypeDefinitionIndex = 34351;
