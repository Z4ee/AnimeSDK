...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC8F680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC8F460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC8F720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC8F7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC8F840)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int FindWithTag_TypeDefinitionIndex = 34355;

	class FindWithTag : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedBool* random; // 0x58
