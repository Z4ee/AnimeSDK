...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C2B1080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C2B1010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2B10D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C2B1160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C2B11F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetTimeScale_TypeDefinitionIndex = 31913;
