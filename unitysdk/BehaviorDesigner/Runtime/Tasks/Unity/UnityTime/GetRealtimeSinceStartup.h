...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBEC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBEC20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBECE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBED70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBEE00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetRealtimeSinceStartup_TypeDefinitionIndex = 31911;
