...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D11AF60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D11AEC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11AFC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D11B050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D11B0E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int SetTimeScale_TypeDefinitionIndex = 33465;
