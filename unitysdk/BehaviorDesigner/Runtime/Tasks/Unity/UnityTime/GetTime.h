...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBEF00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBEE90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBEF50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBEFE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBF070)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetTime_TypeDefinitionIndex = 31912;
