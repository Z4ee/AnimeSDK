...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D7BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D77E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D7970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D7C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D7CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D7D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D7DD0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetCenterOfMass_TypeDefinitionIndex = 32012;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* centerOfMass; // 0x68
