...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3EAD90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3EA9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3EAB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3EAE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3EAE90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3EAF20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETCENTEROFMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3EAFB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetCenterOfMass_TypeDefinitionIndex = 33563;

	class SetCenterOfMass : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* centerOfMass; // 0x60
