...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F612050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F611C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F611E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6120C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F612150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F6121E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETVELOCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F612270)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetVelocity_TypeDefinitionIndex = 34208;
