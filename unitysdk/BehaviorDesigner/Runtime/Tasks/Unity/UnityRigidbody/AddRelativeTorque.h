...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC90C10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1EC90970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC90B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC90C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC90D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1EC90DA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC90E30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddRelativeTorque_TypeDefinitionIndex = 34180;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* torque; // 0x68
