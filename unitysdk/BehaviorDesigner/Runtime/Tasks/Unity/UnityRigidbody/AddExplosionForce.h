...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E19A0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E199BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E199D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E19A130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E19A1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E19A200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E19A240)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddExplosionForce_TypeDefinitionIndex = 33540;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* explosionPosition; // 0x80
