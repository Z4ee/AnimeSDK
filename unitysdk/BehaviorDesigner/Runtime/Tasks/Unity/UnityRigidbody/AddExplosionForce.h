...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE664A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BE65FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE66150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE66530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE665C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BE66600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE66640)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddExplosionForce_TypeDefinitionIndex = 31989;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* explosionRadius; // 0x70
		::BehaviorDesigner::Runtime::SharedVector3* explosionPosition; // 0x78
		::UnityEngine::GameObject* prevGameObject; // 0x80
		::UnityEngine::ForceMode forceMode; // 0x88
		::System::Single upwardsModifier; // 0x8C
