...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D7EB120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D7EAD90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D7EAF20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7EB190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D7EB220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D7EB2B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETCENTEROFMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D7EB340)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetCenterOfMass_TypeDefinitionIndex = 33548;
