...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5DC9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5DC690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5DC820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5DCA10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5DCAA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5DCAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5DCB20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int UseGravity_TypeDefinitionIndex = 34210;
