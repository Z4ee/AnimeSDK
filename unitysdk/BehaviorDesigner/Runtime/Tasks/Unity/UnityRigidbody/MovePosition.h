...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBD060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEBCC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBCE20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBD0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBD160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEBD1F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBD280)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int MovePosition_TypeDefinitionIndex = 32008;
