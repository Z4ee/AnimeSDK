...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C88C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3C8500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C8690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C8930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C89C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3C8A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C8AE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int SetOffset_TypeDefinitionIndex = 33734;
