...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE072F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE06F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE070E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE07390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE07430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE074C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE07550)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int CrossFadeQueued_TypeDefinitionIndex = 33790;
