...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D1210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D0E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D1000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D12A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D1340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D13D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D1460)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Blend_TypeDefinitionIndex = 32237;
