...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1E6AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1E6700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1E6890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1E6B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1E6BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1E6C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1E6CE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int PlayQueued_TypeDefinitionIndex = 34430;
	...
	public:
		...
		::UnityEngine::QueueMode queue; // 0x78
