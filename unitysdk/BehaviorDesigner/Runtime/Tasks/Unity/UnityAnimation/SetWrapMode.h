...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3E5100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3E4DC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3E4F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3E5150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3E51E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3E5270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3E5300)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int SetWrapMode_TypeDefinitionIndex = 33798;
