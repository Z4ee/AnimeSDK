...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D113F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D113C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D113DE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D113FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D114060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D1140F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D114180)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Sample_TypeDefinitionIndex = 33796;
