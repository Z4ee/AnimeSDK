...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9DEEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9DEAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9DEC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9DEF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9DF000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9DF090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9DF120)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 34429;
