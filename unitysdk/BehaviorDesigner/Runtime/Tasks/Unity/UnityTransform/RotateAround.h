...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C4C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C4520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C46B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1C4CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C4D60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C4DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C4E80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int RotateAround_TypeDefinitionIndex = 34078;

	class RotateAround : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::GameObject* prevGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* angle; // 0x60
