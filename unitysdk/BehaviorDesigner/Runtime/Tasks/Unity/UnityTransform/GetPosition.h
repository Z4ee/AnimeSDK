...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E10EF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E10EBA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E10ED30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E10EFA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E10F030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E10F0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E10F150)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetPosition_TypeDefinitionIndex = 33435;
