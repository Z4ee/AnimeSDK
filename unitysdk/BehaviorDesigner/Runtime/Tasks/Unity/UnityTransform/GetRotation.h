...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE0E920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE0E5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0E730)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE0E980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE0EA10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE0EAA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0EB30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetRotation_TypeDefinitionIndex = 33437;
