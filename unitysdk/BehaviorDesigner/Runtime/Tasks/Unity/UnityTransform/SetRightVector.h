...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC7D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC78F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC7A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC7D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC7E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC7E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC7F20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetRightVector_TypeDefinitionIndex = 31900;
