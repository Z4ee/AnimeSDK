...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E10FCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E10F890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E10FA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E10FD10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E10FDA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E10FE30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E10FEC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetRightVector_TypeDefinitionIndex = 33451;
