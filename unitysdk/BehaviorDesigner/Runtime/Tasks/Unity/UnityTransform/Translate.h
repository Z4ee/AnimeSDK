...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDBF050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDBEB80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDBED10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBF0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDBF160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDBF1F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDBF280)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int Translate_TypeDefinitionIndex = 33454;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* translation; // 0x68
