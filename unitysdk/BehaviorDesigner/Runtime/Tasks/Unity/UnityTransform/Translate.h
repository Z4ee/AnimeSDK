...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C5A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C5570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C5700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1C5AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C5B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C5BE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C5C70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int Translate_TypeDefinitionIndex = 34090;

	class Translate : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector3* translation; // 0x58
