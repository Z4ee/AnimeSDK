...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C5A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C56E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C5870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C5A90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C5B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C5BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPARENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C5C40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetParent_TypeDefinitionIndex = 33434;
