...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEC02E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEBFF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEC00A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC0350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEC03E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEC0470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALSCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEC0500)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetLocalScale_TypeDefinitionIndex = 31897;
