...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD3BFE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD3BC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD3BDE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD3C050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD3C0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD3C170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD3C200)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetLocalPosition_TypeDefinitionIndex = 31880;
