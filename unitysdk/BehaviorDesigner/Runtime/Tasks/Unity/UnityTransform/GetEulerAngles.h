...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7D1530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7D10F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7D1280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7D15A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7D1630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7D16C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETEULERANGLES___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7D1750)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetEulerAngles_TypeDefinitionIndex = 34064;
