...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C5440)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C5080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C5210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C54A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C5530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C55C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C5650)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetChild_TypeDefinitionIndex = 33426;
