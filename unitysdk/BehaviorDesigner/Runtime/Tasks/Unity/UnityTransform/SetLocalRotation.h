...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E868D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E868940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E868AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E868D60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E868DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E868E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E868F10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetLocalRotation_TypeDefinitionIndex = 34083;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedQuaternion* localRotation; // 0x68
