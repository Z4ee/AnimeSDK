...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4B49D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4B4610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4B47A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B4A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4B4AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4B4B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4B4BE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetLocalRotation_TypeDefinitionIndex = 33447;

	class SetLocalRotation : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedQuaternion* localRotation; // 0x58
