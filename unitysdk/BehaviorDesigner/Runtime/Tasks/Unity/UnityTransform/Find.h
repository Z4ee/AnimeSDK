...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F221B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F2216F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F221880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1F221B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F221BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F221C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F221D10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int Find_TypeDefinitionIndex = 34060;
