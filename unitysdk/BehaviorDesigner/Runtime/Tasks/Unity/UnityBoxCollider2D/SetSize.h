...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D6890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D64F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D6680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D68F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D6980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D69C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D6A00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBoxCollider2D
{
	inline static constexpr unsigned int SetSize_TypeDefinitionIndex = 34381;
