...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C2710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C2370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C2500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C2760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C27F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C2880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C2910)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int SetSpeed_TypeDefinitionIndex = 33648;
