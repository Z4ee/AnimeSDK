...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E333680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E333350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3334E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3336D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E333760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3337F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E333880)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int IsStopped_TypeDefinitionIndex = 33640;
