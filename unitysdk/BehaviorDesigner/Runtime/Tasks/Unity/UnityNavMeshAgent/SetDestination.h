...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FFCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E1FF8F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FFA80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1FFD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FFDC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E1FFE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FFEE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int SetDestination_TypeDefinitionIndex = 33646;
