...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60E3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60DFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60E180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F60E430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60E4C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60E550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETDESTINATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60E5E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int SetDestination_TypeDefinitionIndex = 34282;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* destination; // 0x70
