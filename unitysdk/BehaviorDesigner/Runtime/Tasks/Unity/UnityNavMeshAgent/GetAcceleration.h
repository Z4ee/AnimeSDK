...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9E2AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9E2770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9E2900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9E2B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9E2BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9E2C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETACCELERATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9E2CC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int GetAcceleration_TypeDefinitionIndex = 34270;
