...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E333CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E333910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E333AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E333D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E333D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E333E20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E333EB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int SetAngularSpeed_TypeDefinitionIndex = 33645;
