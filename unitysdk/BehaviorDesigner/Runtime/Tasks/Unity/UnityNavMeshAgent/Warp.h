...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D4E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D4A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D4BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D4E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D4F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D4F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D5020)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Warp_TypeDefinitionIndex = 32099;

	class Warp : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector3* newPosition; // 0x58
