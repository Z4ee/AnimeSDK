...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BAA6F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BAA6BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BAA6D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAA7000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BAA7090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BAA7120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BAA71B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Move_TypeDefinitionIndex = 32090;

	class Move : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::GameObject* prevGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* offset; // 0x60
