...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60DD60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60DA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60DBB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F60DDB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60DE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60DED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60DF60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 34279;
