...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB6470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEB6120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB62B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB64C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB6550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEB65E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB6670)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int GetDirection_TypeDefinitionIndex = 32186;
