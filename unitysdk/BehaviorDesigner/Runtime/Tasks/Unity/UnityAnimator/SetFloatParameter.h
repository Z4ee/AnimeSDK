...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AEA30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4AE3F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AE580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1D4AE9A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AEAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AEB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4AEBE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AEC70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetFloatParameter_TypeDefinitionIndex = 33821;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(SetFloatParameter_TypeDefinitionIndex)->GetStaticField(0x27520);
		}
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x58
		::UnityEngine::Animator* animator; // 0x60
		::BehaviorDesigner::Runtime::SharedFloat* floatValue; // 0x68
