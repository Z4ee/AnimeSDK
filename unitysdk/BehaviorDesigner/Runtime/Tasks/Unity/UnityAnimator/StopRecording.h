...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F608340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F608010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F6081A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1F608390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F608420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F6084B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F608540)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int StopRecording_TypeDefinitionIndex = 34466;
