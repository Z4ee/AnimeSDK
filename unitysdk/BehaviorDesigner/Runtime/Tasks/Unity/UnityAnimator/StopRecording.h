...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB4620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEB42F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB4480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB4670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB4700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEB4790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB4820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int StopRecording_TypeDefinitionIndex = 32279;
