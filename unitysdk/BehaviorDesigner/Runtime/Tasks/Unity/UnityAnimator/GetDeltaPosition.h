...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE5FC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BE5F880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE5FA10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE5FC80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE5FD10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BE5FD50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE5FD90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetDeltaPosition_TypeDefinitionIndex = 32254;
