...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B42BA00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B42C210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B42BAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B42BFD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42C2A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B42C340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B42C3D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B42C460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_WAITFORSTATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B42C4F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int WaitForState_TypeDefinitionIndex = 32280;

	class WaitForState : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* stateName; // 0x58
		::BehaviorDesigner::Runtime::SharedInt* layer; // 0x60
