...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21B130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21ADE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21AF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F21B180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21B210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21B2A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21B330)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetGravityWeight_TypeDefinitionIndex = 34444;
