...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AE120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4ADD60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4ADEF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AE1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AE240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4AE2D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AE360)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 33817;
	...
	public:
		...
		::System::Single normalizedTime; // 0x78
		::System::Int32 layer; // 0x7C
