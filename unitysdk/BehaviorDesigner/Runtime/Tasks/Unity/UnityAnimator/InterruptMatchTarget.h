...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA27710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA273D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA27560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA27760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA27800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA27890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA27920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int InterruptMatchTarget_TypeDefinitionIndex = 32262;
