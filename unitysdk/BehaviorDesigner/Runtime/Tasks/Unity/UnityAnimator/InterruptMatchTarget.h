...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1BEC30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1BE8F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1BEA80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1BEC80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1BED20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1BEDB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1BEE40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int InterruptMatchTarget_TypeDefinitionIndex = 34449;
