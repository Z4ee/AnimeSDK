...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8F8280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8F7F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8F8090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8F82E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8F8370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8F8400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8F8490)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetDeltaRotation_TypeDefinitionIndex = 34442;
