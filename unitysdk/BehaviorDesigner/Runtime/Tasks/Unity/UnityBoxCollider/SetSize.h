...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C1860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C1490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C1620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1C18D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C1960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C19F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C1A80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBoxCollider
{
	inline static constexpr unsigned int SetSize_TypeDefinitionIndex = 34385;

	class SetSize : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector3* size; // 0x58
