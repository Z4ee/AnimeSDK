...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AC250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AC0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AC2E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AC370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AC400)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Collider
{
	inline static constexpr unsigned int SetEnabled_TypeDefinitionIndex = 33731;
