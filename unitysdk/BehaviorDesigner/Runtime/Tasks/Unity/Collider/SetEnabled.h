...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E8605A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E860420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E860630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E8606C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E860750)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Collider
{
	inline static constexpr unsigned int SetEnabled_TypeDefinitionIndex = 34367;
