...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E32F3E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E32F2B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E32F470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E32F500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E32F590)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Collider
{
	inline static constexpr unsigned int GetEnabled_TypeDefinitionIndex = 33730;
