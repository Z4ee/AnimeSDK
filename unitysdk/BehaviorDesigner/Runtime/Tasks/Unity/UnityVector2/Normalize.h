...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F222FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F222ED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F223040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F2230D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F223160)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Normalize_TypeDefinitionIndex = 34055;
