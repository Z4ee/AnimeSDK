...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDBFA00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDBF950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBFA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDBFAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDBFB70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int SetValue_TypeDefinitionIndex = 33422;
