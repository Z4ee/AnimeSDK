...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D11B900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D11B7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11B960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D11B9F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D11BA80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Distance_TypeDefinitionIndex = 33408;
