...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD3C6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD3C5F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD3C730)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD3C7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD3C850)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int GetMagnitude_TypeDefinitionIndex = 31859;
