...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_CLAMPMAGNITUDE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C5E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_CLAMPMAGNITUDE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C5D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_CLAMPMAGNITUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1C5EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_CLAMPMAGNITUDE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C5F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_CLAMPMAGNITUDE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C6010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int ClampMagnitude_TypeDefinitionIndex = 34043;
