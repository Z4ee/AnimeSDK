...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B430E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B430AF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B430EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B430F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B431010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Operator_TypeDefinitionIndex = 31869;
