...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC92AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC92740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC92B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC92BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_OPERATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC92C60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Operator_TypeDefinitionIndex = 34056;
