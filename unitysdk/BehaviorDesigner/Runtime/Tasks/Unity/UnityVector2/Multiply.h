...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C62C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C6160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C6320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C63B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C6440)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Multiply_TypeDefinitionIndex = 33418;
