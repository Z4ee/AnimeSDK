...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETVECTOR3_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1ED350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETVECTOR3_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1ED280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1ED3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETVECTOR3___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1ED450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETVECTOR3___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1ED4E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int GetVector3_TypeDefinitionIndex = 34050;
