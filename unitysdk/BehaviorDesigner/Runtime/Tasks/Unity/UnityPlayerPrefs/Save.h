...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SAVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0B720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE0B770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SAVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0B800)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int Save_TypeDefinitionIndex = 33595;
