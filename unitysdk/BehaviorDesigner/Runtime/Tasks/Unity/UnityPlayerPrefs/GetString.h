...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3CAFD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3CAE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3CB060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3CB0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3CB180)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int GetString_TypeDefinitionIndex = 33593;

	class GetString : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* storeResult; // 0x58
		::BehaviorDesigner::Runtime::SharedString* defaultValue; // 0x60
