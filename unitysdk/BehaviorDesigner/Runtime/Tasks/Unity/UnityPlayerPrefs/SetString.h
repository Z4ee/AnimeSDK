...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC90740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC905E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC907C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC90850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC908E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int SetString_TypeDefinitionIndex = 34234;
