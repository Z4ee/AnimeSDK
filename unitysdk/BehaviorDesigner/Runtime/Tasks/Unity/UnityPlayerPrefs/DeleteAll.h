...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_DELETEALL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B42E7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_DELETEALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42E870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_DELETEALL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B42E900)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int DeleteAll_TypeDefinitionIndex = 32038;
