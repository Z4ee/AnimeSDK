...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1BD3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1BD230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BD450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1BD4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1BD570)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int GetInt_TypeDefinitionIndex = 32041;

	class GetInt : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedInt* defaultValue; // 0x58
