...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9E41D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9E3FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9E4260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9E4300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9E4390)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics
{
	inline static constexpr unsigned int Linecast_TypeDefinitionIndex = 34238;

	class Linecast : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector3* startPosition; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* endPosition; // 0x60
