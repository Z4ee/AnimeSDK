...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_SPHERECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E865E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_SPHERECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E8654B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_SPHERECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E865F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_SPHERECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E865FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_SPHERECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E866060)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics
{
	inline static constexpr unsigned int SphereCast_TypeDefinitionIndex = 34240;

	class SphereCast : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* distance; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* storeHitPoint; // 0x60
		::BehaviorDesigner::Runtime::SharedFloat* storeHitDistance; // 0x68
		::BehaviorDesigner::Runtime::SharedVector3* storeHitNormal; // 0x70
		::BehaviorDesigner::Runtime::SharedVector3* originPosition; // 0x78
		::BehaviorDesigner::Runtime::SharedGameObject* originGameObject; // 0x80
		::BehaviorDesigner::Runtime::SharedFloat* radius; // 0x88
		::BehaviorDesigner::Runtime::SharedGameObject* storeHitObject; // 0x90
		::BehaviorDesigner::Runtime::SharedVector3* direction; // 0x98
