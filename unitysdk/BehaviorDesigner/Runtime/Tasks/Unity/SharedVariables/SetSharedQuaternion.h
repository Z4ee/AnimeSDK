...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDQUATERNION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1F9020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDQUATERNION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1F8F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F9090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDQUATERNION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1F9120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDQUATERNION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1F91B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedQuaternion_TypeDefinitionIndex = 33503;
