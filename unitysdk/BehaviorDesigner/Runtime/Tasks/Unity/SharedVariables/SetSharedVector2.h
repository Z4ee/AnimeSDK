...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AD4D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AD420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AD530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AD5C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AD650)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedVector2_TypeDefinitionIndex = 33508;
