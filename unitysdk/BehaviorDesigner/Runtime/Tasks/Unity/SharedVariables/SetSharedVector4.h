...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR4_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C52C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR4_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C51E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C5330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR4___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C53C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR4___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C5450)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedVector4_TypeDefinitionIndex = 33510;

	class SetSharedVector4 : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector4* targetValue; // 0x58
		::BehaviorDesigner::Runtime::SharedVector4* targetVariable; // 0x60
