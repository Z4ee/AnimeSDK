...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E46A880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E46A5F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E46A8F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E46A980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E46AA10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedQuaternion_TypeDefinitionIndex = 34123;
