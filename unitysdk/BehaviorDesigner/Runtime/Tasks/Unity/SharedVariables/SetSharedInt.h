...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1B7E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1B7DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B7EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1B7F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1B7FE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedInt_TypeDefinitionIndex = 31949;
