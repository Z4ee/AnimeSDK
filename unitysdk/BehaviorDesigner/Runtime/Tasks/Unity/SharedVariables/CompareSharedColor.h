...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDCOLOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D111880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDCOLOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D111600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D111900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDCOLOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D111990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDCOLOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D111A20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedColor_TypeDefinitionIndex = 33480;
