...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21A520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21A370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1F21A5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21A630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21A6C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedString_TypeDefinitionIndex = 34125;
