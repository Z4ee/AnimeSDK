...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1B8150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1B8070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B81D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1B8260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1B82F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedRect_TypeDefinitionIndex = 31953;

	class SetSharedRect : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedRect* targetVariable; // 0x58
		::BehaviorDesigner::Runtime::SharedRect* targetValue; // 0x60
