...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDGAMEOBJECTTOTRANSFORM_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDDA80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDGAMEOBJECTTOTRANSFORM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDD7A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDGAMEOBJECTTOTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDDDAD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDGAMEOBJECTTOTRANSFORM___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDDB60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDGAMEOBJECTTOTRANSFORM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDDBF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SharedGameObjectToTransform_TypeDefinitionIndex = 33511;
