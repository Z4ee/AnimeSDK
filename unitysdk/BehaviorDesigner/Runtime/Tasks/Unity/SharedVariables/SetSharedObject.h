...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDOBJECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1E5D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1E5C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1E5D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDOBJECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1E5E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDOBJECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1E5EA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedObject_TypeDefinitionIndex = 34137;
