...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC8CB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC8C900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC8CBC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC8CC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC8CCE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SharedTransformToGameObject_TypeDefinitionIndex = 34149;

	class SharedTransformToGameObject : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedGameObject* sharedGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedTransform* sharedTransform; // 0x60
