...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B42AF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B42AC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42AF60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B42AFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B42B080)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SharedTransformToGameObject_TypeDefinitionIndex = 31962;
