...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA80A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA80690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA80820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA80A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA80B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA80BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA80C30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetTime_TypeDefinitionIndex = 32080;
