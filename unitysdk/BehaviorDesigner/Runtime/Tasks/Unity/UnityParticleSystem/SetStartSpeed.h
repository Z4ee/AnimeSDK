...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4B0EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4B0B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4B0CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B0F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4B0FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4B1060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4B10F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartSpeed_TypeDefinitionIndex = 33630;
