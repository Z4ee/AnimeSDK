...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E500D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E500970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E500B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E500D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E500E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E500EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E500F30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetPlaybackSpeed_TypeDefinitionIndex = 33624;

	class SetPlaybackSpeed : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* playbackSpeed; // 0x58
