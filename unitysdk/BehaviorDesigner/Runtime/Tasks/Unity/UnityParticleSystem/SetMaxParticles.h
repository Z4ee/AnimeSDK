...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC901B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES_ONSTART_OFFSET UNITYSDK_OFFSET(0x1EC8FE10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC8FFA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC90200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EC90290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1EC90320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EC903B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetMaxParticles_TypeDefinitionIndex = 34259;

	class SetMaxParticles : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedInt* maxParticles; // 0x58
