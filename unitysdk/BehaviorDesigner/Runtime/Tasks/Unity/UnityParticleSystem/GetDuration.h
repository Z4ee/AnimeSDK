...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA2B500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA2B1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA2B330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA2B550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA2B5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA2B670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA2B700)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetDuration_TypeDefinitionIndex = 32055;
