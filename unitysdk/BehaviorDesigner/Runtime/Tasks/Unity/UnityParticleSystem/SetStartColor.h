...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1BC950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C1BC570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1BC700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1BC9B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C1BCA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C1BCAD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1BCB60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartColor_TypeDefinitionIndex = 32074;

	class SetStartColor : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::ParticleSystem* particleSystem; // 0x58
		::BehaviorDesigner::Runtime::SharedColor* startColor; // 0x60
