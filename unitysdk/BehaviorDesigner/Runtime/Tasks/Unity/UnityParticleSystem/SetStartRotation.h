...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60F620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60F270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60F400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F60F670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60F700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60F790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60F820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartRotation_TypeDefinitionIndex = 34264;

	class SetStartRotation : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* startRotation; // 0x60
