...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5FD2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5FCF50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5FD0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5FD340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5FD3D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5FD460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5FD4F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetLoop_TypeDefinitionIndex = 33622;
