...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE0B490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE0B130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0B2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE0B4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE0B570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE0B600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0B690)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetEmissionRate_TypeDefinitionIndex = 33620;
