...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21EC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21E930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21EAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F21ECE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21ED70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21EE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETEMISSIONRATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21EE90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetEmissionRate_TypeDefinitionIndex = 34256;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* emissionRate; // 0x68
