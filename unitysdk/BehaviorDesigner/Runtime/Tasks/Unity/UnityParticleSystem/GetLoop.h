...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5FCCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5FC960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5FCAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5FCD10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5FCDA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5FCE30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5FCEC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetLoop_TypeDefinitionIndex = 33609;
