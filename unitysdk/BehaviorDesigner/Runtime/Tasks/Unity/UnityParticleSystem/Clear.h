...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AFCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4AF980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AFB10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AFD10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AFDA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D4AFE30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AFEC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int Clear_TypeDefinitionIndex = 33605;
