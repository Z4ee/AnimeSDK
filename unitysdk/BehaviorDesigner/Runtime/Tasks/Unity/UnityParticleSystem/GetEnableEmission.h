...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F832A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8326D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F832860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F832A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F832B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F832BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F832C30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetEnableEmission_TypeDefinitionIndex = 34244;
