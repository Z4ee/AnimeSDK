...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBB2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEBAF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBB0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBB310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEBB3A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BEBB430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEBB4C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartDelay_TypeDefinitionIndex = 32075;

	class SetStartDelay : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::GameObject* prevGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* startDelay; // 0x60
