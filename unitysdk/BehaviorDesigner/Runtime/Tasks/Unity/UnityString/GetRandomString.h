...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B055F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B055E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B055F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B056010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0560A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int GetRandomString_TypeDefinitionIndex = 31919;
