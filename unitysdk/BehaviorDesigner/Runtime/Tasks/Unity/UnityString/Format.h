...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1D11A0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D11A4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D11A170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11A520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1D11A5B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D11A640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D11A6D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int Format_TypeDefinitionIndex = 33468;

	class Format : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* storeResult; // 0x58
		::BehaviorDesigner::Runtime::SharedString* format; // 0x60
		::Il2CppArray<::BehaviorDesigner::Runtime::SharedGenericVariable*>* variables; // 0x68
