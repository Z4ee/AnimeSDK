...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3EC2B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3EC1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3EC330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3EC3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3EC450)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int GetLength_TypeDefinitionIndex = 33469;
