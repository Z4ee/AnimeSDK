...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA81440)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA810B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA81240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA81490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA81520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA815B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRENDERER_SETMATERIAL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA81640)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRenderer
{
	inline static constexpr unsigned int SetMaterial_TypeDefinitionIndex = 32026;
