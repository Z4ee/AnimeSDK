...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLOPERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDB68C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLOPERATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDB6480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLOPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDB6920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLOPERATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDB69B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLOPERATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDB6A40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int BoolOperator_TypeDefinitionIndex = 33653;

	class BoolOperator : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedBool* storeResult; // 0x58
		::BehaviorDesigner::Runtime::SharedBool* bool2; // 0x60
