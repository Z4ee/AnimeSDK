...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD31E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD31C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD31F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD31FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD32030)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int RandomInt_TypeDefinitionIndex = 32123;
