...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCLAMP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE5EE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCLAMP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE5ECA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCLAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE5EE80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCLAMP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE5EF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCLAMP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE5EF50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntClamp_TypeDefinitionIndex = 32111;

	class IntClamp : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedInt* intVariable; // 0x58
		::BehaviorDesigner::Runtime::SharedInt* maxValue; // 0x60
