...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D0600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0CFFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D0680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D0710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D07A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int FloatComparison_TypeDefinitionIndex = 32106;
