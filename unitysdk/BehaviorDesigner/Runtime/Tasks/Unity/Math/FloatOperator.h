...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATOPERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0167B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATOPERATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0160A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATOPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C016820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATOPERATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0168B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATOPERATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C016940)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int FloatOperator_TypeDefinitionIndex = 32108;
