...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AC530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AC490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AC580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AC610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AC6A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntAbs_TypeDefinitionIndex = 33661;
