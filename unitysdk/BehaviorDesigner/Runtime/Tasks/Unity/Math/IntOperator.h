...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E861150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E860A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8611C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E861250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E8612E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntOperator_TypeDefinitionIndex = 34301;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedInt* integer2; // 0x68
