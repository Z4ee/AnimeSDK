...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B04EF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B04E820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B04EF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B04F010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTOPERATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B04F0A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntOperator_TypeDefinitionIndex = 32114;
