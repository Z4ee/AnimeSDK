...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3E2FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3E2F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3E3030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3E30C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3E3150)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int FloatAbs_TypeDefinitionIndex = 33655;
