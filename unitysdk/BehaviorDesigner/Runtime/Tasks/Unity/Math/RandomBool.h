...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMBOOL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D3FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D4050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMBOOL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D40E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int RandomBool_TypeDefinitionIndex = 34307;
