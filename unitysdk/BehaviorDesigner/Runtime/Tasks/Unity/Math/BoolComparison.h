...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C4290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C4190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C42F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C4380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C4410)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int BoolComparison_TypeDefinitionIndex = 33651;
