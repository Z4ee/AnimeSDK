...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C019300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C019200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C019380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C019410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0194A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetButton_TypeDefinitionIndex = 32150;
