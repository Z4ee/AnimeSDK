...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD36E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD36C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD36E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD36F20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD36FB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetAxisRaw_TypeDefinitionIndex = 32149;
