...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONDOWN_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AF760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONDOWN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AF6A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AF7D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONDOWN___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AF860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONDOWN___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AF8F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsButtonDown_TypeDefinitionIndex = 33705;
