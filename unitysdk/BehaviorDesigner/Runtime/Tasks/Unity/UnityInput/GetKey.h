...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D7DA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D7D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D7DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D7E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D7EC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetKey_TypeDefinitionIndex = 34338;
