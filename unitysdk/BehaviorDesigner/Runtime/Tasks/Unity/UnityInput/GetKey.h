...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E196960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1968F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1969B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E196A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E196A80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetKey_TypeDefinitionIndex = 33702;
