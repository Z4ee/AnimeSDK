...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC4540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC44F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC4590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC4620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC46B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsKeyUp_TypeDefinitionIndex = 32157;
