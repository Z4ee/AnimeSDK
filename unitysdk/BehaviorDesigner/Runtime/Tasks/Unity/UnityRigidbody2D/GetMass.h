...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FE180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FDE30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FDFC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8FE1D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FE260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FE2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FE380)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetMass_TypeDefinitionIndex = 34159;
