...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C3C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C38B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C3A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1C3CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C3D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C3DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C3E60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetVelocity_TypeDefinitionIndex = 34173;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector2* velocity; // 0x68
