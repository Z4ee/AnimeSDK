...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C26DAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C26D7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C26D950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C26DB40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C26DBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C26DC60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SLEEP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C26DCF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int Sleep_TypeDefinitionIndex = 31987;
