...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC63B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC6010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC61A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC6400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC6490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC6520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC65B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int MoveRotation_TypeDefinitionIndex = 31979;
