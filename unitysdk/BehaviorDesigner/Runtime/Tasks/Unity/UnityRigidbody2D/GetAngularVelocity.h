...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FDBA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FD850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FD9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8FDBF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FDC80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FDD10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARVELOCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FDDA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetAngularVelocity_TypeDefinitionIndex = 34155;
