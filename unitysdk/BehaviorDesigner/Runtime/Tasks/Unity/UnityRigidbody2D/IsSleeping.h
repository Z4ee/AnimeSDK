...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C4270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C3F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C40D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C42C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C4350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5C43E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C4470)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int IsSleeping_TypeDefinitionIndex = 33528;
