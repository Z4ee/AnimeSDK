...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7D0810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7D0470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7D0600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7D0860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7D08F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7D0980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7D0A10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetIsKinematic_TypeDefinitionIndex = 34171;
