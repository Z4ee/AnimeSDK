...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F531AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F531780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F531910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F531B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F531B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F531C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F531CB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int WakeUp_TypeDefinitionIndex = 34175;
