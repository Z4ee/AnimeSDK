...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3CBBA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3CB840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3CB9D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3CBC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3CBC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3CBD20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3CBDB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetPosition_TypeDefinitionIndex = 33524;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector2* storeValue; // 0x70
