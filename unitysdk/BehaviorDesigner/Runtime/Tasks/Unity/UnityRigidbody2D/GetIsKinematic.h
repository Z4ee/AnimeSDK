...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC5D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC5A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC5BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC5DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC5E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC5EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC5F80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetIsKinematic_TypeDefinitionIndex = 31971;
