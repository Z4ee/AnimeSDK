...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE62800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BE624B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE62640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE62850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BE628E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BE62920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE62960)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetStepOffset_TypeDefinitionIndex = 32286;
