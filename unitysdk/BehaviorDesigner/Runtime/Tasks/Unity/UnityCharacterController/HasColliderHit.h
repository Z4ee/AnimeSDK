...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1BEB6E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONEND_OFFSET UNITYSDK_OFFSET(0x1BEB6E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB70D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB6DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1BEB6D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB7150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1BEB7210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1BEB72A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BEB7330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BEB73C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1BEB7450)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int HasColliderHit_TypeDefinitionIndex = 32281;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedGameObject* collidedGameObject; // 0x60
