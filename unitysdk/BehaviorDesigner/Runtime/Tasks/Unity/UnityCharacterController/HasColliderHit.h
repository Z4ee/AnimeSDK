...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1E1FC4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONEND_OFFSET UNITYSDK_OFFSET(0x1E1FC460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FC6F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FC410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1E1FC3A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1FC770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1E1FC830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1E1FC8C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FC950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FC9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1E1FCA70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int HasColliderHit_TypeDefinitionIndex = 33832;
