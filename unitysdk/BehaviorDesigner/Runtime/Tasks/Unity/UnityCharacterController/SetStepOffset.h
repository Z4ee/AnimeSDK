...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD362C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD35F20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD360B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD36310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD363A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD36430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD364C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int SetStepOffset_TypeDefinitionIndex = 32294;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* stepOffset; // 0x68
