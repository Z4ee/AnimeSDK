...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7CCE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7CCA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7CCC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7CCE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7CCF00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7CCF90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7CD020)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetVelocity_TypeDefinitionIndex = 34474;
