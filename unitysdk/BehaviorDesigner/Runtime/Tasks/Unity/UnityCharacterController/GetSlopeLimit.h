...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F808000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F807CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F807E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F808050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8080E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F808170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F808200)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetSlopeLimit_TypeDefinitionIndex = 34472;
