...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7CDA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7CD670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7CD800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7CDAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F7CDB40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F7CDBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7CDC60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int Move_TypeDefinitionIndex = 34476;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* motion; // 0x68
