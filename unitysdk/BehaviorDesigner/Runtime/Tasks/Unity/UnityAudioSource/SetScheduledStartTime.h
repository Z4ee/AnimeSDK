...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D6330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D5F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D6120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D6380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D6420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D6460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDSTARTTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D64A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetScheduledStartTime_TypeDefinitionIndex = 34418;
