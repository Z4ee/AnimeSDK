...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B051150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B050E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B050F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0511A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B051230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0512C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B051350)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetLoop_TypeDefinitionIndex = 32204;
