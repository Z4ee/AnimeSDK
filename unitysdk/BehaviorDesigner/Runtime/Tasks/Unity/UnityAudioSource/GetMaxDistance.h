...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9E1A90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9E1740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9E18D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9E1AF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9E1B80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9E1C10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9E1CA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMaxDistance_TypeDefinitionIndex = 34392;
