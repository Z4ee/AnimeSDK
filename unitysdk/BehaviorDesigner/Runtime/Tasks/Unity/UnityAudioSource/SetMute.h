...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE08C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE088C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE08A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE08CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE08D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE08DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE08E60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetMute_TypeDefinitionIndex = 33777;
