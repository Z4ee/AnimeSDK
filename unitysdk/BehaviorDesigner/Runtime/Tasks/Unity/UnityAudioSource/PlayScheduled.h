...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C6A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3C6680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C6810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C6A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C6B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3C6BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C6C40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int PlayScheduled_TypeDefinitionIndex = 33770;
