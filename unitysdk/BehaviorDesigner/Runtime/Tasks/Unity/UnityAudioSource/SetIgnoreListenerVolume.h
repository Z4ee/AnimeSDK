...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDEC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDDE8B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDEA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDDECA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDED30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDDEDC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETIGNORELISTENERVOLUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDEE50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetIgnoreListenerVolume_TypeDefinitionIndex = 33772;

	class SetIgnoreListenerVolume : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::AudioSource* audioSource; // 0x58
		::BehaviorDesigner::Runtime::SharedBool* ignoreListenerVolume; // 0x60
