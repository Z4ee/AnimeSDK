...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1944A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E194150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1942E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E194500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E194590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E1945D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETVOLUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E194610)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetVolume_TypeDefinitionIndex = 33764;
