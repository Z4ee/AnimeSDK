...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D3550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D3130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D32C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D35B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D3650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D36E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYONESHOT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D3770)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int PlayOneShot_TypeDefinitionIndex = 32218;
