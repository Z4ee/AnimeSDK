...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D3B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D3800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D3990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D3B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D3C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0D3CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D3D40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetAudioClip_TypeDefinitionIndex = 32220;
