...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8F8EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8F8B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8F8CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8F8F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8F8FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8F9030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPITCH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8F90C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetPitch_TypeDefinitionIndex = 34414;

	class SetPitch : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* pitch; // 0x58
