...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE08620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE08280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE08410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE08680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE08710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE087A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE08830)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetMinDistance_TypeDefinitionIndex = 33776;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* minDistance; // 0x70
