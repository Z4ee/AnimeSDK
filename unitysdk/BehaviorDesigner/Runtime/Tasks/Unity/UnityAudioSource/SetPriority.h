...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC1F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC1BE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC1D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC1FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BDC2070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BDC2100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC2190)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetPriority_TypeDefinitionIndex = 32228;
