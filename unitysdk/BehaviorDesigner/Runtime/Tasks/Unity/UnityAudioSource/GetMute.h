...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0509F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0506A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C050830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C050A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C050AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C050B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C050BF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMute_TypeDefinitionIndex = 32207;
