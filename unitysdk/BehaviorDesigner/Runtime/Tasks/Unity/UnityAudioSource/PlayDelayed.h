...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA29050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA28CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA28E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA290A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BA29140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1BA291D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYDELAYED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BA29260)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int PlayDelayed_TypeDefinitionIndex = 32217;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* delay; // 0x70
