...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5F7720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5F72F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5F7480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5F7770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5F7800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E5F7890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5F7920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 33459;

	class Resume : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::Playables::PlayableDirector* playableDirector; // 0x58
		::BehaviorDesigner::Runtime::SharedBool* stopWhenComplete; // 0x60
