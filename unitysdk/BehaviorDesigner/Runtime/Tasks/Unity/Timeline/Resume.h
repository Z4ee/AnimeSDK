...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9DE150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9DDD20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9DDEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9DE1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9DE230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F9DE2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9DE350)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 34095;
	...
	public:
		...
		::UnityEngine::Playables::PlayableDirector* playableDirector; // 0x70
