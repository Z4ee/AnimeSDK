...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_CIRCLECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D6030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_CIRCLECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D56A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_CIRCLECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D60D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_CIRCLECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C0D6190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_CIRCLECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0D6220)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics2D
{
	inline static constexpr unsigned int Circlecast_TypeDefinitionIndex = 32048;
