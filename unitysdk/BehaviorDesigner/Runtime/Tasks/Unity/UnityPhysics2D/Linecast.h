...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3E9630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3E9490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3E96A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3E9740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3E97D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics2D
{
	inline static constexpr unsigned int Linecast_TypeDefinitionIndex = 33600;
