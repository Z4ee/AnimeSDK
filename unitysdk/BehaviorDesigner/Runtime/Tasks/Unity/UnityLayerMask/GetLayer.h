...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D116680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D116560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D116700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D116790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D116820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLayerMask
{
	inline static constexpr unsigned int GetLayer_TypeDefinitionIndex = 33696;
