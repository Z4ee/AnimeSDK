...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AF460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AF2E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AF4F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D4AF580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D4AF610)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBehaviour
{
	inline static constexpr unsigned int SetEnabled_TypeDefinitionIndex = 33752;
