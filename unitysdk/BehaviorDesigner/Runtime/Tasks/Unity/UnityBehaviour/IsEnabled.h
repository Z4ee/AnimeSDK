...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C051950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C051840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0519D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C051A60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C051AF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBehaviour
{
	inline static constexpr unsigned int IsEnabled_TypeDefinitionIndex = 32200;
