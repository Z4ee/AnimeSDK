...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDF640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDF510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDDF6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDF760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDF7F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBehaviour
{
	inline static constexpr unsigned int GetEnabled_TypeDefinitionIndex = 33750;
