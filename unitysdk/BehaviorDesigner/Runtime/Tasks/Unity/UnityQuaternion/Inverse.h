...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C01ADF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C01ACF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01AE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C01AEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C01AF70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Inverse_TypeDefinitionIndex = 32033;
