...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E334360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E334260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3343C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E334450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3344E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Inverse_TypeDefinitionIndex = 33584;
