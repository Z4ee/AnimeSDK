...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F610340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60FFB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6103B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F610440)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F6104D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int RotateTowards_TypeDefinitionIndex = 34223;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* maxDeltaDegrees; // 0x60
