...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E4707D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4706A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E470850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E4708E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E470970)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int LookRotation_TypeDefinitionIndex = 34222;

	class LookRotation : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector3* secondVector3; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* forwardVector; // 0x60
