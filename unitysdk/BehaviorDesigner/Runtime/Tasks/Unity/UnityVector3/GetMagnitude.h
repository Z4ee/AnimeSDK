...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C65C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C64D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C6630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C66C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C6750)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetMagnitude_TypeDefinitionIndex = 33392;
