...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_LERP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FF840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_LERP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FF580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_LERP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8FF8C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_LERP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FF950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_LERP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FF9E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Lerp_TypeDefinitionIndex = 34034;
