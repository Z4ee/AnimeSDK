...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9B3480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9B3280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9B3500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F9B3590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9B3620)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetXYZ_TypeDefinitionIndex = 34033;

	class GetXYZ : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* storeY; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* storeZ; // 0x60
