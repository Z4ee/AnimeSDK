...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C69E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C67E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C6A60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E5C6AF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETXYZ___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E5C6B80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetXYZ_TypeDefinitionIndex = 33397;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* storeZ; // 0x68
		::BehaviorDesigner::Runtime::SharedFloat* storeX; // 0x70
