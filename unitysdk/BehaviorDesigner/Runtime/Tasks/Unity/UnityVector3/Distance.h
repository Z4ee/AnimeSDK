...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E337C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E337A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E337C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E337D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E337DB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Distance_TypeDefinitionIndex = 33389;
