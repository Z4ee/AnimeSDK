...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60C500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60C160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60C2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F60C550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60C5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60C670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60C700)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCookieSize_TypeDefinitionIndex = 34323;
