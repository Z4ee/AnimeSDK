...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FDE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E1FDA60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FDBF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1FDE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E1FDEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E1FDF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1FE000)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCookieSize_TypeDefinitionIndex = 33687;
