...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE09C10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE09870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE09A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE09C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE09CF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE09D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE09E10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetShadowBias_TypeDefinitionIndex = 33691;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* shadowBias; // 0x68
