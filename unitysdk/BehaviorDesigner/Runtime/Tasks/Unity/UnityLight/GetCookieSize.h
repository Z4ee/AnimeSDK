...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D87D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D8490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D8620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D8820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D88B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D88F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D8930)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetCookieSize_TypeDefinitionIndex = 34315;
