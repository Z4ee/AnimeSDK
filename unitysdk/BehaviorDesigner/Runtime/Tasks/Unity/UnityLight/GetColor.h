...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C053D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C053A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C053BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C053DE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C053E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C053F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C053F90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetColor_TypeDefinitionIndex = 32127;

	class GetColor : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedColor* storeValue; // 0x58
