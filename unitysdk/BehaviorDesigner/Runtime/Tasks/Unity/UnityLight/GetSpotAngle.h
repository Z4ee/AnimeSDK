...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D116BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D1168B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D116A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D116C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D116CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1D116D60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D116DF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetSpotAngle_TypeDefinitionIndex = 33684;
