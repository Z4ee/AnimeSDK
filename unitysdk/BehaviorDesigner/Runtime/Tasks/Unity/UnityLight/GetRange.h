...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E4FF560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E4FF220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4FF3B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4FF5B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E4FF640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E4FF6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E4FF760)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetRange_TypeDefinitionIndex = 33681;
