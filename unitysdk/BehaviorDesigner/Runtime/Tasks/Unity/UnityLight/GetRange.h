...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FA370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FA030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FA1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8FA3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FA450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FA4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FA570)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetRange_TypeDefinitionIndex = 34317;
