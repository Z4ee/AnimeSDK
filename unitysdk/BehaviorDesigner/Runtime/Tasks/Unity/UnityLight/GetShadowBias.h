...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C1E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C1B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C1CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1C1EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F1C1F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F1C1FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F1C2050)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetShadowBias_TypeDefinitionIndex = 34318;
