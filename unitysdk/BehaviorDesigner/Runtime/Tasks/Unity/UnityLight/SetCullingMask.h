...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FA940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FA600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FA790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8FA990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F8FAA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F8FAAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8FAB40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCullingMask_TypeDefinitionIndex = 34324;
