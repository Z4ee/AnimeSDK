...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D9BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D9850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D99E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5D9C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F5D9CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F5D9D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5D9D50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetSpotAngle_TypeDefinitionIndex = 34330;
