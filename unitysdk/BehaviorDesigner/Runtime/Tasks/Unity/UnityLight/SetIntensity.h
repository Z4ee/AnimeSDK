...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60CB30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60C790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60C920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F60CB80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F60CC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F60CCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F60CD30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetIntensity_TypeDefinitionIndex = 34325;
