...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21D9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21D6A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21D830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F21DA30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21DAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21DB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21DBE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetType_TypeDefinitionIndex = 34331;
