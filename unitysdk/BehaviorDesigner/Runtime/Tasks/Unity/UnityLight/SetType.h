...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE0A1E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE09EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0A030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE0A230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DE0A2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DE0A350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETTYPE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DE0A3E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetType_TypeDefinitionIndex = 33695;
