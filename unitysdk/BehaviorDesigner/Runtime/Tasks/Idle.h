...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D7E43E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E4430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D7E44C0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Idle_TypeDefinitionIndex = 33336;
