...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21A0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F219EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F219F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_SETLINKSUBBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1F219E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F21A130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F21A1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F21A250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F21A2E0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int SubTreeBehaviorReference_TypeDefinitionIndex = 34013;
	...
	public:
		...
		::System::String* SubTreeName; // 0x60
