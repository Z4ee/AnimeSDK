...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ALLOCATECONTINUESTICKTASK_OFFSET UNITYSDK_OFFSET(0x14960130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_DEALLOCATECONTINUESTICKTASK_OFFSET UNITYSDK_OFFSET(0x14960240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1495FCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ONEND_OFFSET UNITYSDK_OFFSET(0x14960860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x14960680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x149607D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1495FEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x14960380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x149608B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x14960980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x14960A10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT___BASE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x14960AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x14960B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x14960BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_WAIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x14960C50)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Wait_TypeDefinitionIndex = 63216;

	class Wait : public ::BehaviorDesigner::Runtime::Tasks::ContinuesTickAction
	{
	public:
		::Class_3_6D73516CC6FEADD7* _aiCharacter; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* waitTime; // 0x60
		::BehaviorDesigner::Runtime::SharedFloat* randomWaitMax; // 0x68
		::BehaviorDesigner::Runtime::SharedBool* randomWait; // 0x70
		::BehaviorDesigner::Runtime::SharedFloat* randomWaitMin; // 0x78
		::Class_2_9DAFE6A077A11AC9* waitTask; // 0x80
		::System::Single waitDuration; // 0x88
		::System::Single startTime; // 0x8C
