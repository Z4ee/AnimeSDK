...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_INNERDECORATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E107BA0)

namespace BehaviorDesigner::Runtime::Tasks::Services
{
	inline static constexpr unsigned int InnerDecorator_TypeDefinitionIndex = 33848;
