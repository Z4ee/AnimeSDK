...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_DRAWSTATUSINFO_OFFSET UNITYSDK_OFFSET(0x1C0145E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1C0145A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_EXECUTIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1C0145C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C014580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C014560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1C0145B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_EXECUTIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1C0145D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C014590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1C014570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C014630)

namespace BehaviorDesigner::Runtime::Tasks::Services
{
	inline static constexpr unsigned int SubTask_TypeDefinitionIndex = 32296;
