...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SERVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5F6900)

namespace BehaviorDesigner::Runtime::Tasks::Services
{
	inline static constexpr unsigned int Services_TypeDefinitionIndex = 33849;
