...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_BEHAVIORENDED_OFFSET UNITYSDK_OFFSET(0x1DDDCBB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONEND_OFFSET UNITYSDK_OFFSET(0x1DDDCC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDCE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDDC3D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDC9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDDCEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1DDDCF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1DDDD010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1DDDD0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDDD130)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int StartBehaviorTree_TypeDefinitionIndex = 33346;

	class StartBehaviorTree : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedBool* synchronizeVariables; // 0x58
		...
		::BehaviorDesigner::Runtime::SharedGameObject* behaviorGameObject; // 0x78
