...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONEND_OFFSET UNITYSDK_OFFSET(0x1C04C740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C04C9A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1C04C780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C04C6F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1C04C680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C04CA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1C04CAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1C04CB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1C04CC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C04CC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1C04CD20)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredTrigger_TypeDefinitionIndex = 31759;
