...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_GETFIELDVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B04CB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_GETFIELDVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B04C700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_GETFIELDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B04CBC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_GETFIELDVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B04CC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_GETFIELDVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B04CCE0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int GetFieldValue_TypeDefinitionIndex = 31788;
