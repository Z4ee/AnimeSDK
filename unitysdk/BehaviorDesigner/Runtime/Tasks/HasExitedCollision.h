...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1B04CE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONEND_OFFSET UNITYSDK_OFFSET(0x1B04CE30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B04D090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B04CDE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B04CD70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B04D0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1B04D1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B04D230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B04D2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B04D350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B04D3E0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedCollision_TypeDefinitionIndex = 31761;
