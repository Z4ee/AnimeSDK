...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1E3C32C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C3460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C33B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C34D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1E3C3570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E3C3600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E3C3690)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RandomProbability_TypeDefinitionIndex = 33362;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* useSeed; // 0x58
		::BehaviorDesigner::Runtime::SharedInt* seed; // 0x60
