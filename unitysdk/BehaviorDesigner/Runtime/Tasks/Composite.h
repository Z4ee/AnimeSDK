...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_GET_ABORTTYPE_OFFSET UNITYSDK_OFFSET(0x1E4689E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_GET_PROXYABORTTYPE_OFFSET UNITYSDK_OFFSET(0x1E4689C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1E468A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1E4689F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_SET_PROXYABORTTYPE_OFFSET UNITYSDK_OFFSET(0x1E4689D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E468A80)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Composite_TypeDefinitionIndex = 33941;
