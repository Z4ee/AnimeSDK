...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E3CBFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1E3CC330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E3CC2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1E3CBF60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1E3CC060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1E3CBFA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1E3CC200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1E3CC250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1E3CC3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1E3CC370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3CBE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1E3CC2A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3CC5C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E3CC6B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1E3CC740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E3CC7D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1E3CC860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1E3CC8F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1E3CC990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1E3CCA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1E3CCAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1E3CCB40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1E3CCBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1E3CCC60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1E3CCCF0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int UtilitySelector_TypeDefinitionIndex = 33358;
	...
	public:
		...
		::System::Single highestUtility; // 0x68
