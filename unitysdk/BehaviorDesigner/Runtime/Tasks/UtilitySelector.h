...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1C0AED80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1C0AF0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1C0AF080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1C0AECF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1C0AEDF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1C0AED30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1C0AEF90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1C0AEFE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1C0AF150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1C0AF100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0AEBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1C0AF030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0AF350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1C0AF440)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1C0AF4D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1C0AF560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1C0AF5F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1C0AF680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1C0AF720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1C0AF7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1C0AF840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1C0AF8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1C0AF960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1C0AF9F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1C0AFA80)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int UtilitySelector_TypeDefinitionIndex = 31807;
