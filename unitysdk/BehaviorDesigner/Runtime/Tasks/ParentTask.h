...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1E4FC150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E4FB890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1E4FBEA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4FB910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1E4FB990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_DECORATE_OFFSET UNITYSDK_OFFSET(0x1E4FBE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_FINALOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1E4FBE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_GETUTILITY_OFFSET UNITYSDK_OFFSET(0x1E4FBFC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4FBD90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_GET_PROXYCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4FBD70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4FBDB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ONCHILDEXECUTED_1_OFFSET UNITYSDK_OFFSET(0x1E4FBAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1E4FBEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ONCHILDSTARTED_1_OFFSET UNITYSDK_OFFSET(0x1E4FBB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1E4FBF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1E4FBBF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1E4FC090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1E4FBF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1E4FBD20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_REPLACEADDCHILD_OFFSET UNITYSDK_OFFSET(0x1E4FC230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_SET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4FBDA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK_SET_PROXYCHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4FBD80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4FC2E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK___BASE_GETUTILITY_OFFSET UNITYSDK_OFFSET(0x1E4FC370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARENTTASK___BASE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1E4FC400)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ParentTask_TypeDefinitionIndex = 33306;
