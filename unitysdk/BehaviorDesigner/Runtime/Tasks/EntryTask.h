...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ENTRYTASK_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1EC8A220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ENTRYTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC8A3B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ENTRYTASK___BASE_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1EC8A440)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int EntryTask_TypeDefinitionIndex = 34012;
