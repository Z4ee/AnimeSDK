...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1F529C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONEND_OFFSET UNITYSDK_OFFSET(0x1F529390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F529F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F529000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F529340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_1_OFFSET UNITYSDK_OFFSET(0x1F529720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_2_OFFSET UNITYSDK_OFFSET(0x1F529840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_3_OFFSET UNITYSDK_OFFSET(0x1F529A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_OFFSET UNITYSDK_OFFSET(0x1F5296E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F52A000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1F52A0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1F52A150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1F52A1E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1F52A270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F52A300)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasReceivedEvent_TypeDefinitionIndex = 33997;
