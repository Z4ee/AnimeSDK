...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1F7C6200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1F7C62D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1F7C6320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_ONEND_OFFSET UNITYSDK_OFFSET(0x1F7C6500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1F7C64A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1F7C6380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7C6550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1F7C6600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1F7C6690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1F7C6720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1F7C67B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1F7C68D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1F7C6840)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Cooldown_TypeDefinitionIndex = 34002;
	...
	public:
		...
		::System::Single cooldownTime; // 0x64
