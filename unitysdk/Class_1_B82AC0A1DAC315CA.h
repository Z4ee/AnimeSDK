...
#define CLASS_1_B82AC0A1DAC315CA_EXECUTE_OFFSET UNITYSDK_OFFSET(0x153E05A0)
#define CLASS_1_B82AC0A1DAC315CA__CTOR_OFFSET UNITYSDK_OFFSET(0x153E0570)

inline static constexpr unsigned int Class_1_B82AC0A1DAC315CA_TypeDefinitionIndex = 76804;

class Class_1_B82AC0A1DAC315CA : public ::System::Object
{
public:
	::Class_3_F4528A5C0F861AF2* PDENFEFCAGN; // 0x10
	::Entitas::IGroup_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* KIAIODODLEJ; // 0x18
	::Class_2_80F8710F847F1248* EEFMDEHLLFI; // 0x20
	::System::Single PJMDHCDIPPK; // 0x28
	::System::Single JCEICLMJAOF; // 0x2C
