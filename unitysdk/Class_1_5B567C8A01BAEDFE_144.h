...
#define CLASS_1_5B567C8A01BAEDFE_144_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A569120)
#define CLASS_1_5B567C8A01BAEDFE_144_CLONE_OFFSET UNITYSDK_OFFSET(0x1A568F30)
#define CLASS_1_5B567C8A01BAEDFE_144_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A569030)
#define CLASS_1_5B567C8A01BAEDFE_144_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A568FA0)
#define CLASS_1_5B567C8A01BAEDFE_144_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A569080)
#define CLASS_1_5B567C8A01BAEDFE_144_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A569170)
#define CLASS_1_5B567C8A01BAEDFE_144_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A569140)
#define CLASS_1_5B567C8A01BAEDFE_144_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A568E80)
#define CLASS_1_5B567C8A01BAEDFE_144_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A568EE0)
#define CLASS_1_5B567C8A01BAEDFE_144_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5690B0)
#define CLASS_1_5B567C8A01BAEDFE_144_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A569110)
#define CLASS_1_5B567C8A01BAEDFE_144__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5691C0)
#define CLASS_1_5B567C8A01BAEDFE_144__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A568F00)
#define CLASS_1_5B567C8A01BAEDFE_144__CTOR_OFFSET UNITYSDK_OFFSET(0x1A568EF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_144_TypeDefinitionIndex = 27559;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_144*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_144_TypeDefinitionIndex)->GetStaticField(0x13C40);
	}
