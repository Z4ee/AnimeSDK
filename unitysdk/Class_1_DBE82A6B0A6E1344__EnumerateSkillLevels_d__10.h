...
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15218040)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_VALUETUPLE_SYSTEM_UINT32_SYSTEM_UINT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x15218310)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_VALUETUPLE_SYSTEM_UINT32_SYSTEM_UINT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15218280)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x15218390)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x152182E0)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15218290)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15218020)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x15218000)
#define CLASS_1_DBE82A6B0A6E1344__ENUMERATESKILLLEVELS_D__10___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x15218030)

inline static constexpr unsigned int Class_1_DBE82A6B0A6E1344__EnumerateSkillLevels_d__10_TypeDefinitionIndex = 49576;

class Class_1_DBE82A6B0A6E1344__EnumerateSkillLevels_d__10 : public ::System::Object
{
public:
	::Class_1_DBE82A6B0A6E1344* __4__this; // 0x10
	::System::Collections::Generic::Dictionary_2_KeyCollection_Enumerator<::System::UInt32, ::Class_1_C85C4DAB350DD5FC_1*> __7__wrap1; // 0x18
