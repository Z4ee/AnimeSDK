...
#define CLASS_3_3A92B9AFE98444E6_METHOD_3_1F96CACAEB5EDB64_OFFSET UNITYSDK_OFFSET(0x1AF23CD0)
#define CLASS_3_3A92B9AFE98444E6_METHOD_3_A6F54A9E721BB5D2_OFFSET UNITYSDK_OFFSET(0x1AF23D10)
#define CLASS_3_3A92B9AFE98444E6__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF23D00)

inline static constexpr unsigned int Class_3_3A92B9AFE98444E6_TypeDefinitionIndex = 23368;

class Class_3_3A92B9AFE98444E6 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::ValueEvaluatorConfig* Field_3_0; // 0x18
	::Il2CppArray<::RPG::GameCore::SkillType>* Field_3_1; // 0x20
	::Il2CppArray<::System::String*>* Field_3_2; // 0x28
	::Il2CppArray<::RPG::GameCore::JsonEnum*>* Field_3_3; // 0x30
