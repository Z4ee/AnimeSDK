...
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5519F0)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B551A90)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B551650)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B551640)

inline static constexpr unsigned int AkAudioInputManager_AudioSamplesDelegate_TypeDefinitionIndex = 31490;
