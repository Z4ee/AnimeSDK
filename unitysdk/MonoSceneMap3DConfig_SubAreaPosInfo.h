...
#define MONOSCENEMAP3DCONFIG_SUBAREAPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x12B2E6B0)

inline static constexpr unsigned int MonoSceneMap3DConfig_SubAreaPosInfo_TypeDefinitionIndex = 50695;
