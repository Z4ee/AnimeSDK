...
#define DYNAMICSCENELIGHTCHAINPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CAFE750)
#define DYNAMICSCENELIGHTCHAINPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CAFE6D0)
#define DYNAMICSCENELIGHTCHAINPROXY_TRIGGERLIGHT_OFFSET UNITYSDK_OFFSET(0x1CAFE7D0)
#define DYNAMICSCENELIGHTCHAINPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFE880)

inline static constexpr unsigned int DynamicSceneLightChainProxy_TypeDefinitionIndex = 27052;
