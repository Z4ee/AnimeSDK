...
#define CLASS_2_0270D3FEC2A14EF7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x157FF1B0)
#define CLASS_2_0270D3FEC2A14EF7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x157FF030)
#define CLASS_2_0270D3FEC2A14EF7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x157FF160)
#define CLASS_2_0270D3FEC2A14EF7_TICK_OFFSET UNITYSDK_OFFSET(0x157FF080)
#define CLASS_2_0270D3FEC2A14EF7__CTOR_OFFSET UNITYSDK_OFFSET(0x157FF020)
...
{
public:
	::RPG::GameCore::WaitHipplenGameExit* OFKGLJOAMLD; // 0x18
