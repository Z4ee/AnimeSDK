...
#define CLASS_2_0270D3FEC2A14EF7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C66840)
#define CLASS_2_0270D3FEC2A14EF7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8C666B0)
#define CLASS_2_0270D3FEC2A14EF7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8C667F0)
#define CLASS_2_0270D3FEC2A14EF7_TICK_OFFSET UNITYSDK_OFFSET(0x8C66700)
#define CLASS_2_0270D3FEC2A14EF7__CTOR_OFFSET UNITYSDK_OFFSET(0x8C666A0)

inline static constexpr unsigned int Class_2_0270D3FEC2A14EF7_TypeDefinitionIndex = 42324;

class Class_2_0270D3FEC2A14EF7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::WaitHipplenGameExit* Field_2_1; // 0x18
