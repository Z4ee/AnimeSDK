...
#define MB3_MESHBAKERROOT_ZSORTOBJECTS_ITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC97A0)

inline static constexpr unsigned int MB3_MeshBakerRoot_ZSortObjects_Item_TypeDefinitionIndex = 84972;
