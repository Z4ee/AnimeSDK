...
inline static constexpr unsigned int Struct_2_CC1AD73BA07FC070_TypeDefinitionIndex = 49214;

struct alignas(8) Struct_2_CC1AD73BA07FC070
{
	::System::String* Field_2_0; // 0x10
	::System::Int32 Field_2_7; // 0x18
	::MoleMole::FlowCanvas::Nodes::AnchorPointForwardAxis Field_2_6; // 0x1C
	::System::Nullable_1<::UnityEngine::Vector3> Field_2_5; // 0x20
