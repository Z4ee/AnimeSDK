...
#define OCEANSYSTEM_OCEANSHAREDWAVE_METHOD_5_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xACECD30)
#define OCEANSYSTEM_OCEANSHAREDWAVE_METHOD_5_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0xACECCE0)
#define OCEANSYSTEM_OCEANSHAREDWAVE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xACED130)
#define OCEANSYSTEM_OCEANSHAREDWAVE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xACED110)
#define OCEANSYSTEM_OCEANSHAREDWAVE_UPDATE_OFFSET UNITYSDK_OFFSET(0xACED120)
#define OCEANSYSTEM_OCEANSHAREDWAVE__CCTOR_OFFSET UNITYSDK_OFFSET(0xACED1C0)
#define OCEANSYSTEM_OCEANSHAREDWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0xACED190)

namespace OceanSystem
{
	inline static constexpr unsigned int OceanSharedWave_TypeDefinitionIndex = 46174;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(OceanSharedWave_TypeDefinitionIndex)->GetStaticField(0x8870);
		}
