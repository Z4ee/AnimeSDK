...
#define OCEANSYSTEM_OCEANRENDERER_GET_REALTIMEWAVE_OFFSET UNITYSDK_OFFSET(0xC0CA9B0)
#define OCEANSYSTEM_OCEANRENDERER_GET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0xC0CA3B0)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_2D0199B582B44DFC_OFFSET UNITYSDK_OFFSET(0xC0CAD60)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_637DBA7901C3991A_OFFSET UNITYSDK_OFFSET(0xC0CA3F0)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xC0CAA30)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_A3AEEF7CBD6BBC1D_OFFSET UNITYSDK_OFFSET(0xC0CBA30)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xC0CA6B0)
#define OCEANSYSTEM_OCEANRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC0CAD50)
#define OCEANSYSTEM_OCEANRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC0CAA10)
#define OCEANSYSTEM_OCEANRENDERER_SET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0xC0CA3C0)
#define OCEANSYSTEM_OCEANRENDERER_UPDATEMATERIALPARAMETERS_OFFSET UNITYSDK_OFFSET(0xC0CAF30)
#define OCEANSYSTEM_OCEANRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC0CAA20)
#define OCEANSYSTEM_OCEANRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CBF20)
