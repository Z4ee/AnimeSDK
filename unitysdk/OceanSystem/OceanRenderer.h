...
#define OCEANSYSTEM_OCEANRENDERER_GET_REALTIMEWAVE_OFFSET UNITYSDK_OFFSET(0x9834C80)
#define OCEANSYSTEM_OCEANRENDERER_GET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0x9834640)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x9834680)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x9834D00)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_A3AEEF7CBD6BBC1D_OFFSET UNITYSDK_OFFSET(0x9835CF0)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_CCED8C9A4E131333_OFFSET UNITYSDK_OFFSET(0x9835030)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x9834980)
#define OCEANSYSTEM_OCEANRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9835020)
#define OCEANSYSTEM_OCEANRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9834CE0)
#define OCEANSYSTEM_OCEANRENDERER_SET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0x9834650)
#define OCEANSYSTEM_OCEANRENDERER_UPDATEMATERIALPARAMETERS_OFFSET UNITYSDK_OFFSET(0x98351D0)
#define OCEANSYSTEM_OCEANRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9834CF0)
#define OCEANSYSTEM_OCEANRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x98361E0)

namespace OceanSystem
{
	inline static constexpr unsigned int OceanRenderer_TypeDefinitionIndex = 45586;
