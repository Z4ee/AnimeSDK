...
#define OCEANSYSTEM_OCEANRENDERER_GET_REALTIMEWAVE_OFFSET UNITYSDK_OFFSET(0x15F620F0)
#define OCEANSYSTEM_OCEANRENDERER_GET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0x15F61AF0)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_2D0199B582B44DFC_OFFSET UNITYSDK_OFFSET(0x15F624A0)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_637DBA7901C3991A_OFFSET UNITYSDK_OFFSET(0x15F61B30)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x15F62170)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_A3AEEF7CBD6BBC1D_OFFSET UNITYSDK_OFFSET(0x15F63170)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x15F61DF0)
#define OCEANSYSTEM_OCEANRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15F62490)
#define OCEANSYSTEM_OCEANRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15F62150)
#define OCEANSYSTEM_OCEANRENDERER_SET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0x15F61B00)
#define OCEANSYSTEM_OCEANRENDERER_UPDATEMATERIALPARAMETERS_OFFSET UNITYSDK_OFFSET(0x15F62670)
#define OCEANSYSTEM_OCEANRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15F62160)
#define OCEANSYSTEM_OCEANRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F63660)

namespace OceanSystem
{
	inline static constexpr unsigned int OceanRenderer_TypeDefinitionIndex = 47134;
