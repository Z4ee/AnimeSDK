...
#define OCEANSYSTEM_OCEANRENDERER_GET_REALTIMEWAVE_OFFSET UNITYSDK_OFFSET(0xACEB5E0)
#define OCEANSYSTEM_OCEANRENDERER_GET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0xACEAFE0)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_2D0199B582B44DFC_OFFSET UNITYSDK_OFFSET(0xACEB990)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_637DBA7901C3991A_OFFSET UNITYSDK_OFFSET(0xACEB020)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xACEB660)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_A3AEEF7CBD6BBC1D_OFFSET UNITYSDK_OFFSET(0xACEC660)
#define OCEANSYSTEM_OCEANRENDERER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xACEB2E0)
#define OCEANSYSTEM_OCEANRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xACEB980)
#define OCEANSYSTEM_OCEANRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xACEB640)
#define OCEANSYSTEM_OCEANRENDERER_SET_RENDERERTYPE_OFFSET UNITYSDK_OFFSET(0xACEAFF0)
#define OCEANSYSTEM_OCEANRENDERER_UPDATEMATERIALPARAMETERS_OFFSET UNITYSDK_OFFSET(0xACEBB60)
#define OCEANSYSTEM_OCEANRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0xACEB650)
#define OCEANSYSTEM_OCEANRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xACECB50)

namespace OceanSystem
{
	inline static constexpr unsigned int OceanRenderer_TypeDefinitionIndex = 46169;
