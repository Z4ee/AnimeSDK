...
#define CLASS_1_2178DA8BBAE007EC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16094B00)
#define CLASS_1_2178DA8BBAE007EC_GET_CURRENTATTACKER_OFFSET UNITYSDK_OFFSET(0x16098BC0)
#define CLASS_1_2178DA8BBAE007EC_GET_CURRENTDEFENDER_OFFSET UNITYSDK_OFFSET(0x16098BE0)
#define CLASS_1_2178DA8BBAE007EC_GET_ISMAZETOBATTLETRANSITIONSHOWSTARTED_OFFSET UNITYSDK_OFFSET(0x16098BA0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_094E160C5DF6DF66_1_OFFSET UNITYSDK_OFFSET(0x16098170)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_094E160C5DF6DF66_OFFSET UNITYSDK_OFFSET(0x16097E00)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_09D92EE02A83C51D_OFFSET UNITYSDK_OFFSET(0x16096770)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x16097010)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1808E1CF7A125519_2_OFFSET UNITYSDK_OFFSET(0x16098890)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x16096DF0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x160963F0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_1_OFFSET UNITYSDK_OFFSET(0x16095BA0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_2_OFFSET UNITYSDK_OFFSET(0x16095E60)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_3_OFFSET UNITYSDK_OFFSET(0x16096160)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_4_OFFSET UNITYSDK_OFFSET(0x160964D0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0x160952C0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x16095090)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16096FC0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_3BF9B67F74EEB9FA_OFFSET UNITYSDK_OFFSET(0x16095590)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_43D99DDD80B1E30C_OFFSET UNITYSDK_OFFSET(0x16098700)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_57D7671870F3331B_OFFSET UNITYSDK_OFFSET(0x16096CB0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_5AD211D08ADF3F6E_OFFSET UNITYSDK_OFFSET(0x16098B70)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_5CC589A90C8895C1_OFFSET UNITYSDK_OFFSET(0x160989C0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_6B4A3A1B5816B81E_OFFSET UNITYSDK_OFFSET(0x16093C00)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_721C8F8A1B12BAFC_OFFSET UNITYSDK_OFFSET(0x160979B0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_74DC427A9191C639_OFFSET UNITYSDK_OFFSET(0x160970A0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x16098970)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_88A5355116A88152_1_OFFSET UNITYSDK_OFFSET(0x16096100)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_88A5355116A88152_OFFSET UNITYSDK_OFFSET(0x16095E00)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_8C1DD01C5F096716_OFFSET UNITYSDK_OFFSET(0x16097690)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_8DFE27A803774727_OFFSET UNITYSDK_OFFSET(0x16094E60)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_8F6A1B72899F4EA4_OFFSET UNITYSDK_OFFSET(0x16094D80)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_934A67A86EB996AE_OFFSET UNITYSDK_OFFSET(0x16095890)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_A41E5E09290EF5A0_OFFSET UNITYSDK_OFFSET(0x16093CE0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_A693F2E8D4F4A766_OFFSET UNITYSDK_OFFSET(0x16096450)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_A8272415FB0F8D75_OFFSET UNITYSDK_OFFSET(0x160984E0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_B4FEB1F5D516A801_OFFSET UNITYSDK_OFFSET(0x16094B90)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x160963A0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x16098540)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_DE1755B73A3E9F2E_OFFSET UNITYSDK_OFFSET(0x16097210)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_EA1355C3DBBA00B4_OFFSET UNITYSDK_OFFSET(0x16098920)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_EC2956354B919FE0_OFFSET UNITYSDK_OFFSET(0x16096E80)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_F05F95789250CAA6_OFFSET UNITYSDK_OFFSET(0x16097750)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_F755ED20B18F4BDE_OFFSET UNITYSDK_OFFSET(0x16096A40)
#define CLASS_1_2178DA8BBAE007EC_SET_CURRENTATTACKER_OFFSET UNITYSDK_OFFSET(0x16098BD0)
#define CLASS_1_2178DA8BBAE007EC_SET_CURRENTDEFENDER_OFFSET UNITYSDK_OFFSET(0x16098BF0)
#define CLASS_1_2178DA8BBAE007EC_SET_ISMAZETOBATTLETRANSITIONSHOWSTARTED_OFFSET UNITYSDK_OFFSET(0x16098BB0)
#define CLASS_1_2178DA8BBAE007EC__CCTOR_OFFSET UNITYSDK_OFFSET(0x16098C00)
#define CLASS_1_2178DA8BBAE007EC__CTOR_OFFSET UNITYSDK_OFFSET(0x16093B60)
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x26EC0);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_ECPOIFJJMAE()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x26EC8);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_KJOGJIMKFAC()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x26ED0);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_OMIPBJBBHPC()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x26ED8);
	}
	::Class_3_07C3C4D2990C49EE* JJMDDMPHMMM; // 0x10
	::Class_3_07C3C4D2990C49EE* BMODALJIEFF; // 0x18
	::System::Action* MKCOENMILLE; // 0x20
	::Class_3_07C3C4D2990C49EE* ECAHDDPJIAE; // 0x28
	::Class_3_07C3C4D2990C49EE* ENLHHHHLDDM; // 0x30
	::Class_3_07C3C4D2990C49EE* DIFGAPACOBF; // 0x38
	::Class_3_07C3C4D2990C49EE* KPFPLNAGJBE; // 0x40
	::Class_3_07C3C4D2990C49EE* HKMCLGPNHCH; // 0x48
	::System::Action* IGIBHLAJFPK; // 0x50
	::System::Action* AAEAOOJPEDH; // 0x58
	::Class_3_07C3C4D2990C49EE* JDDLNENDKIC; // 0x60
	::Class_3_07C3C4D2990C49EE* AIOOHHBNFLK; // 0x68
	::Class_3_07C3C4D2990C49EE* PMEPGPKHNLE; // 0x70
	::Class_3_07C3C4D2990C49EE* BJGABKCJAOE; // 0x78
	::Class_3_07C3C4D2990C49EE* MEJPPBPJHAM; // 0x80
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x88
	::RPG::GameCore::TransitionPerformConfig* BELOGLIJJOM; // 0x90
	::RPG::GameCore::GameEntity* _CurrentAttacker_k__BackingField; // 0x98
	::Class_3_07C3C4D2990C49EE* FPAFGKJELKK; // 0xA0
	::RPG::GameCore::GameEntity* _CurrentDefender_k__BackingField; // 0xA8
	::System::Action* BCFPKMGLLLA; // 0xB0
	::System::Boolean _IsMazeToBattleTransitionShowStarted_k__BackingField; // 0xB8
	::System::Boolean JKHLCLEDDDB; // 0xB9
	::System::Boolean MDCPEKPIFEH; // 0xBA
	::System::Boolean PBNNFAIFELK; // 0xBB
	::System::Single AOFLNHMMAIC; // 0xBC
	::System::UInt32 DHBCHLIOOKO; // 0xC0
	::RPG::Client::TransitionMode BJDEPLPPMGL; // 0xC4
	::System::Single PBPBGJCGHND; // 0xC8
