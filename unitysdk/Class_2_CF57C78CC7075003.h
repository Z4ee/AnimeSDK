...
#define CLASS_2_CF57C78CC7075003_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x90E6AE0)
#define CLASS_2_CF57C78CC7075003_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x90E6C30)
#define CLASS_2_CF57C78CC7075003_METHOD_2_048FA601E6EC5C91_OFFSET UNITYSDK_OFFSET(0x90E6450)
#define CLASS_2_CF57C78CC7075003_METHOD_2_123DFB09BD2C9B9E_OFFSET UNITYSDK_OFFSET(0x90E62A0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0x90E6120)
#define CLASS_2_CF57C78CC7075003_METHOD_2_39A9FE040505BFA5_OFFSET UNITYSDK_OFFSET(0x90E6310)
#define CLASS_2_CF57C78CC7075003_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x90E5830)
#define CLASS_2_CF57C78CC7075003_METHOD_2_49864B3B164A1961_OFFSET UNITYSDK_OFFSET(0x90E5B80)
#define CLASS_2_CF57C78CC7075003_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x90E6DE0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_77A1C88EE6B459EB_OFFSET UNITYSDK_OFFSET(0x90E59F0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_7E1BADD1D133FA1C_OFFSET UNITYSDK_OFFSET(0x90E6180)
#define CLASS_2_CF57C78CC7075003_METHOD_2_8CA1933EC1F9B137_OFFSET UNITYSDK_OFFSET(0x90E59A0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x90E6930)
#define CLASS_2_CF57C78CC7075003_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x90E6880)
#define CLASS_2_CF57C78CC7075003_METHOD_2_CEE2550285AA5985_OFFSET UNITYSDK_OFFSET(0x90E69D0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x90E67B0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_FD1726F5C8763865_OFFSET UNITYSDK_OFFSET(0x90E5BE0)
#define CLASS_2_CF57C78CC7075003__CTOR_OFFSET UNITYSDK_OFFSET(0x90E6D50)
#define CLASS_2_CF57C78CC7075003___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x90E6E40)
#define CLASS_2_CF57C78CC7075003___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x90E6EA0)

inline static constexpr unsigned int Class_2_CF57C78CC7075003_TypeDefinitionIndex = 66358;

class Class_2_CF57C78CC7075003 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::Il2CppArray<::RPG::GameCore::BattleTargetConfigType>* Field_2_2; // 0x60
