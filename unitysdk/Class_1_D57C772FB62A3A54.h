...
#define CLASS_1_D57C772FB62A3A54_ENTER_OFFSET UNITYSDK_OFFSET(0x1558FCB0)
#define CLASS_1_D57C772FB62A3A54_EXIT_OFFSET UNITYSDK_OFFSET(0x15590220)
#define CLASS_1_D57C772FB62A3A54_TICK_OFFSET UNITYSDK_OFFSET(0x1558FF90)
#define CLASS_1_D57C772FB62A3A54__CTOR_OFFSET UNITYSDK_OFFSET(0x15590260)

inline static constexpr unsigned int Class_1_D57C772FB62A3A54_TypeDefinitionIndex = 64515;

class Class_1_D57C772FB62A3A54 : public ::System::Object
{
public:
	::Class_1_23F67DD15593C8D6* PGMIOKKLHIE; // 0x10
