...
#define CLASS_1_5B567C8A01BAEDFE_233_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1973B420)
#define CLASS_1_5B567C8A01BAEDFE_233_CLONE_OFFSET UNITYSDK_OFFSET(0x1973B230)
#define CLASS_1_5B567C8A01BAEDFE_233_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1973B330)
#define CLASS_1_5B567C8A01BAEDFE_233_EQUALS_OFFSET UNITYSDK_OFFSET(0x1973B2A0)
#define CLASS_1_5B567C8A01BAEDFE_233_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1973B380)
#define CLASS_1_5B567C8A01BAEDFE_233_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1973B470)
#define CLASS_1_5B567C8A01BAEDFE_233_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1973B440)
#define CLASS_1_5B567C8A01BAEDFE_233_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1973B180)
#define CLASS_1_5B567C8A01BAEDFE_233_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1973B1E0)
#define CLASS_1_5B567C8A01BAEDFE_233_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1973B3B0)
#define CLASS_1_5B567C8A01BAEDFE_233_WRITETO_OFFSET UNITYSDK_OFFSET(0x1973B410)
#define CLASS_1_5B567C8A01BAEDFE_233__CCTOR_OFFSET UNITYSDK_OFFSET(0x1973B4C0)
#define CLASS_1_5B567C8A01BAEDFE_233__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1973B200)
#define CLASS_1_5B567C8A01BAEDFE_233__CTOR_OFFSET UNITYSDK_OFFSET(0x1973B1F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_233_TypeDefinitionIndex = 29925;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_233*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_233_TypeDefinitionIndex)->GetStaticField(0x54D10);
	}
