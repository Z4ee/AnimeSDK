...
#define CLASS_1_5B567C8A01BAEDFE_233_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D805340)
#define CLASS_1_5B567C8A01BAEDFE_233_CLONE_OFFSET UNITYSDK_OFFSET(0x1D805030)
#define CLASS_1_5B567C8A01BAEDFE_233_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D805140)
#define CLASS_1_5B567C8A01BAEDFE_233_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D805070)
#define CLASS_1_5B567C8A01BAEDFE_233_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D8052A0)
#define CLASS_1_5B567C8A01BAEDFE_233_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D805390)
#define CLASS_1_5B567C8A01BAEDFE_233_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D805360)
#define CLASS_1_5B567C8A01BAEDFE_233_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D804FB0)
#define CLASS_1_5B567C8A01BAEDFE_233_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D804FE0)
#define CLASS_1_5B567C8A01BAEDFE_233_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D8052D0)
#define CLASS_1_5B567C8A01BAEDFE_233_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D805330)
#define CLASS_1_5B567C8A01BAEDFE_233__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8053E0)
#define CLASS_1_5B567C8A01BAEDFE_233__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D805000)
#define CLASS_1_5B567C8A01BAEDFE_233__CTOR_OFFSET UNITYSDK_OFFSET(0x1D804FF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_233_TypeDefinitionIndex = 30806;

class Class_1_5B567C8A01BAEDFE_233 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_233*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_233*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_233_TypeDefinitionIndex)->GetStaticField(0x5FF0);
	}
