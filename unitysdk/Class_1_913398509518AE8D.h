...
#define CLASS_1_913398509518AE8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19525980)
#define CLASS_1_913398509518AE8D_METHOD_1_0561AC0B333408CE_OFFSET UNITYSDK_OFFSET(0x19527BE0)
#define CLASS_1_913398509518AE8D_METHOD_1_212AF17406B18044_OFFSET UNITYSDK_OFFSET(0x195267B0)
#define CLASS_1_913398509518AE8D_METHOD_1_38E69361EEE42B73_OFFSET UNITYSDK_OFFSET(0x195269B0)
#define CLASS_1_913398509518AE8D_METHOD_1_46859238AB0A73BC_OFFSET UNITYSDK_OFFSET(0x19525DD0)
#define CLASS_1_913398509518AE8D_METHOD_1_563C59C17604D14E_1_OFFSET UNITYSDK_OFFSET(0x195275F0)
#define CLASS_1_913398509518AE8D_METHOD_1_563C59C17604D14E_OFFSET UNITYSDK_OFFSET(0x19527230)
#define CLASS_1_913398509518AE8D_METHOD_1_5FB1373E8E0055DC_OFFSET UNITYSDK_OFFSET(0x19526560)
#define CLASS_1_913398509518AE8D_METHOD_1_6208FA43F279AEEE_OFFSET UNITYSDK_OFFSET(0x19525B50)
#define CLASS_1_913398509518AE8D_METHOD_1_68B8C33DE0EB9090_OFFSET UNITYSDK_OFFSET(0x19526C10)
#define CLASS_1_913398509518AE8D_METHOD_1_7BD278425D663CED_1_OFFSET UNITYSDK_OFFSET(0x19526F60)
#define CLASS_1_913398509518AE8D_METHOD_1_7BD278425D663CED_OFFSET UNITYSDK_OFFSET(0x19526C90)
#define CLASS_1_913398509518AE8D_METHOD_1_8E7A18194BF0EB2C_OFFSET UNITYSDK_OFFSET(0x195278E0)
#define CLASS_1_913398509518AE8D_METHOD_1_9258752F7C89A5F1_OFFSET UNITYSDK_OFFSET(0x19526060)
#define CLASS_1_913398509518AE8D_METHOD_1_9370E860FD1240D0_OFFSET UNITYSDK_OFFSET(0x19526B70)
#define CLASS_1_913398509518AE8D_METHOD_1_9F6ECC272DF0C4BB_1_OFFSET UNITYSDK_OFFSET(0x195263C0)
#define CLASS_1_913398509518AE8D_METHOD_1_9F6ECC272DF0C4BB_OFFSET UNITYSDK_OFFSET(0x19526220)
#define CLASS_1_913398509518AE8D_METHOD_1_B450FF0D131C4D0D_OFFSET UNITYSDK_OFFSET(0x19527AC0)
#define CLASS_1_913398509518AE8D_METHOD_1_D863039DF5865808_OFFSET UNITYSDK_OFFSET(0x19526840)
#define CLASS_1_913398509518AE8D_METHOD_1_E37E81B1F1A73317_OFFSET UNITYSDK_OFFSET(0x19525A10)
#define CLASS_1_913398509518AE8D__CTOR_OFFSET UNITYSDK_OFFSET(0x19527C70)

inline static constexpr unsigned int Class_1_913398509518AE8D_TypeDefinitionIndex = 73458;

class Class_1_913398509518AE8D : public ::System::Object
{
public:
	static ::System::Int32* StaticGet_NBDNJGMLKIG()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_913398509518AE8D_TypeDefinitionIndex)->GetStaticField(0x150D0);
	}
	::System::Collections::Generic::List_1<::UnityEngine::Animations::AnimationClipPlayable>* NLKCHEGFHHF; // 0x10
	::UnityEngine::AnimationClip* CHBIDCFBJOC; // 0x18
	::RPG::Client::MonoEmoPlayableGraph* KDMNKFICNOH; // 0x20
	::System::Collections::Generic::List_1<::Struct_2_CF025126BE358084>* GKPJMHACCKK; // 0x28
	::RPG::Client::Emotion::EmoPartType NODMDJIPJJG; // 0x30
	::Class_1_913398509518AE8D_MixerType DGIJOJOBDDM; // 0x34
	::System::Int32 FFNBLDFFMCN; // 0x38
	::System::Boolean CPABHJIMMHC; // 0x3C
	::UnityEngine::Animations::AnimationLayerMixerPlayable MFMDJPBAPND; // 0x40
	::UnityEngine::Animations::AnimationMixerPlayable AHMMFGBELPA; // 0x50
	::UnityEngine::Animations::AnimationClipPlayable DEKKMFEMHKM; // 0x60
