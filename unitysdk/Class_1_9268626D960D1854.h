...
#define CLASS_1_9268626D960D1854__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BB110)
...
public:
	...
	::System::Boolean GNDCCBNILML; // 0x24
	::RPG::GameCore::BattleScreenEffectType DLMINHHKKMK; // 0x28
