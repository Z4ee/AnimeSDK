...
#define CLASS_2_6C5EEF625C3EB9FC_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBAA1D50)
#define CLASS_2_6C5EEF625C3EB9FC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBAA1D90)
#define CLASS_2_6C5EEF625C3EB9FC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBAA1F20)
#define CLASS_2_6C5EEF625C3EB9FC_TICK_OFFSET UNITYSDK_OFFSET(0xBAA1F70)
#define CLASS_2_6C5EEF625C3EB9FC__CTOR_OFFSET UNITYSDK_OFFSET(0xBAA1D40)
