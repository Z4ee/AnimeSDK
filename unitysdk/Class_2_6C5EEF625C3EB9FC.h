...
#define CLASS_2_6C5EEF625C3EB9FC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16E42090)
#define CLASS_2_6C5EEF625C3EB9FC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16E420D0)
#define CLASS_2_6C5EEF625C3EB9FC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16E42260)
#define CLASS_2_6C5EEF625C3EB9FC_TICK_OFFSET UNITYSDK_OFFSET(0x16E422B0)
#define CLASS_2_6C5EEF625C3EB9FC__CTOR_OFFSET UNITYSDK_OFFSET(0x16E42080)

inline static constexpr unsigned int Class_2_6C5EEF625C3EB9FC_TypeDefinitionIndex = 55923;

class Class_2_6C5EEF625C3EB9FC : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SetGameplayBGMEmotionState* Field_2_1; // 0x20
