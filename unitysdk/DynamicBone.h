...
#define DYNAMICBONE_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1ADF30)
#define DYNAMICBONE_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E1ADA60)
#define DYNAMICBONE_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1E1AB1D0)
#define DYNAMICBONE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1AB0D0)
#define DYNAMICBONE_GETPATH_OFFSET UNITYSDK_OFFSET(0x1E1AAB50)
#define DYNAMICBONE_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1E1AC080)
#define DYNAMICBONE_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E1AB910)
#define DYNAMICBONE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1AB160)
#define DYNAMICBONE_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1E1AEF60)
#define DYNAMICBONE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E1AAA50)
#define DYNAMICBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E1AA860)
#define DYNAMICBONE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1E1AAAF0)
#define DYNAMICBONE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1E1AAB20)
#define DYNAMICBONE_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1E1AAAE0)
#define DYNAMICBONE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1E1AA8F0)
#define DYNAMICBONE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E1ABE10)
#define DYNAMICBONE_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1AB100)
#define DYNAMICBONE_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1E1ABB10)
#define DYNAMICBONE_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1AAD10)
#define DYNAMICBONE_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1E1AC020)
#define DYNAMICBONE_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1AD240)
#define DYNAMICBONE_START_OFFSET UNITYSDK_OFFSET(0x1E1AAD00)
#define DYNAMICBONE_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1E1AB5D0)
#define DYNAMICBONE_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E1AE910)
#define DYNAMICBONE_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1E1AC090)
#define DYNAMICBONE_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1E1AC430)
#define DYNAMICBONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E1AB130)
#define DYNAMICBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1AEFC0)

inline static constexpr unsigned int DynamicBone_TypeDefinitionIndex = 34619;
