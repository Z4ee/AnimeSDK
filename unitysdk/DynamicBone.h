...
#define DYNAMICBONE_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1BE6D880)
#define DYNAMICBONE_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BE6D3B0)
#define DYNAMICBONE_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1BE6AB30)
#define DYNAMICBONE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE6AA30)
#define DYNAMICBONE_GETPATH_OFFSET UNITYSDK_OFFSET(0x1BE6A4B0)
#define DYNAMICBONE_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1BE6B9E0)
#define DYNAMICBONE_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BE6B270)
#define DYNAMICBONE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE6AAC0)
#define DYNAMICBONE_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1BE6E8D0)
#define DYNAMICBONE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BE6A3B0)
#define DYNAMICBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BE6A1C0)
#define DYNAMICBONE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1BE6A450)
#define DYNAMICBONE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1BE6A480)
#define DYNAMICBONE_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1BE6A440)
#define DYNAMICBONE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1BE6A250)
#define DYNAMICBONE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1BE6B770)
#define DYNAMICBONE_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1BE6AA60)
#define DYNAMICBONE_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1BE6B470)
#define DYNAMICBONE_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1BE6A670)
#define DYNAMICBONE_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1BE6B980)
#define DYNAMICBONE_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1BE6CB90)
#define DYNAMICBONE_START_OFFSET UNITYSDK_OFFSET(0x1BE6A660)
#define DYNAMICBONE_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1BE6AF30)
#define DYNAMICBONE_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BE6E260)
#define DYNAMICBONE_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1BE6B9F0)
#define DYNAMICBONE_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1BE6BD80)
#define DYNAMICBONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BE6AA90)
#define DYNAMICBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE6E930)

inline static constexpr unsigned int DynamicBone_TypeDefinitionIndex = 33061;
