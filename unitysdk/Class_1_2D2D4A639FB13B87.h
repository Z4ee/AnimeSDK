...
#define CLASS_1_2D2D4A639FB13B87_METHOD_1_3544DE82549493A9_OFFSET UNITYSDK_OFFSET(0xBF5B7E0)
#define CLASS_1_2D2D4A639FB13B87_METHOD_1_BC3DC4F0CC25EA0A_OFFSET UNITYSDK_OFFSET(0xBF5B670)
#define CLASS_1_2D2D4A639FB13B87__CTOR_OFFSET UNITYSDK_OFFSET(0xBF5B870)

inline static constexpr unsigned int Class_1_2D2D4A639FB13B87_TypeDefinitionIndex = 76096;

class Class_1_2D2D4A639FB13B87 : public ::System::Object
{
public:
	::System::Action* EDHFCGNFFBF; // 0x10
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_413*>* IHAPLODILIG; // 0x18
	::System::Func_2<::System::UInt32, ::Class_0_16E4307DCC419505_413*>* BKEGFOPHOKL; // 0x20
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_413*>* GKCIFCIHJBK; // 0x28
