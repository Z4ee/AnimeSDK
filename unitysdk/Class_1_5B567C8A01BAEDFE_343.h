...
#define CLASS_1_5B567C8A01BAEDFE_343_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19329640)
#define CLASS_1_5B567C8A01BAEDFE_343_CLONE_OFFSET UNITYSDK_OFFSET(0x19329450)
#define CLASS_1_5B567C8A01BAEDFE_343_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19329550)
#define CLASS_1_5B567C8A01BAEDFE_343_EQUALS_OFFSET UNITYSDK_OFFSET(0x193294C0)
#define CLASS_1_5B567C8A01BAEDFE_343_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x193295A0)
#define CLASS_1_5B567C8A01BAEDFE_343_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19329690)
#define CLASS_1_5B567C8A01BAEDFE_343_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19329660)
#define CLASS_1_5B567C8A01BAEDFE_343_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x193293A0)
#define CLASS_1_5B567C8A01BAEDFE_343_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19329400)
#define CLASS_1_5B567C8A01BAEDFE_343_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193295D0)
#define CLASS_1_5B567C8A01BAEDFE_343_WRITETO_OFFSET UNITYSDK_OFFSET(0x19329630)
#define CLASS_1_5B567C8A01BAEDFE_343__CCTOR_OFFSET UNITYSDK_OFFSET(0x193296E0)
#define CLASS_1_5B567C8A01BAEDFE_343__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19329420)
#define CLASS_1_5B567C8A01BAEDFE_343__CTOR_OFFSET UNITYSDK_OFFSET(0x19329410)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_343_TypeDefinitionIndex = 32349;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_343*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_343_TypeDefinitionIndex)->GetStaticField(0x627B0);
	}
