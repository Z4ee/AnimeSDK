...
#define CLASS_2_755B65A0E1B34CE2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x117C7080)
#define CLASS_2_755B65A0E1B34CE2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x117C7120)
#define CLASS_2_755B65A0E1B34CE2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x117C7250)
#define CLASS_2_755B65A0E1B34CE2_TICK_OFFSET UNITYSDK_OFFSET(0x117C70C0)
#define CLASS_2_755B65A0E1B34CE2__CTOR_OFFSET UNITYSDK_OFFSET(0x117C7070)

inline static constexpr unsigned int Class_2_755B65A0E1B34CE2_TypeDefinitionIndex = 49267;

class Class_2_755B65A0E1B34CE2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TravelShipHideUI* Field_2_1; // 0x18
