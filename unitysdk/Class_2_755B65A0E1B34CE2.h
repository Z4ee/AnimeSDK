...
#define CLASS_2_755B65A0E1B34CE2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x141C52E0)
#define CLASS_2_755B65A0E1B34CE2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x141C5380)
#define CLASS_2_755B65A0E1B34CE2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x141C54B0)
#define CLASS_2_755B65A0E1B34CE2_TICK_OFFSET UNITYSDK_OFFSET(0x141C5320)
#define CLASS_2_755B65A0E1B34CE2__CTOR_OFFSET UNITYSDK_OFFSET(0x141C52D0)

inline static constexpr unsigned int Class_2_755B65A0E1B34CE2_TypeDefinitionIndex = 49934;

class Class_2_755B65A0E1B34CE2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TravelShipHideUI* Field_2_0; // 0x18
