...
#define STRUCT_2_E80D1D3A0BDE4011__CTOR_OFFSET UNITYSDK_OFFSET(0x87AC80)

inline static constexpr unsigned int Struct_2_E80D1D3A0BDE4011_TypeDefinitionIndex = 60844;

struct alignas(4) Struct_2_E80D1D3A0BDE4011
{
	::ProtoScript::NodeState Field_2_2; // 0x10
	::ProtoScript::NodeVisible Field_2_1; // 0x14
	::Enum_3_7CF131C413C919AF Field_2_0; // 0x18
	::Enum_3_C6E8F7731271F88A Field_2_7; // 0x1C
