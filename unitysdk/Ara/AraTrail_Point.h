...
#define ARA_ARATRAIL_POINT_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x1BECE310)
#define ARA_ARATRAIL_POINT_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1BED1AB0)
#define ARA_ARATRAIL_POINT_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1BED1B20)
#define ARA_ARATRAIL_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B85A0)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_Point_TypeDefinitionIndex = 31377;
