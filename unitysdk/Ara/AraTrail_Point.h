...
#define ARA_ARATRAIL_POINT_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x1E21A940)
#define ARA_ARATRAIL_POINT_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1E21E0E0)
#define ARA_ARATRAIL_POINT_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1E21E150)
#define ARA_ARATRAIL_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5BDA0)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_Point_TypeDefinitionIndex = 32928;
