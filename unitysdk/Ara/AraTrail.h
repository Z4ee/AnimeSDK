...
#define ARA_ARATRAIL_ADD_ONUPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1BECADF0)
#define ARA_ARATRAIL_APPENDFLATTRAIL_OFFSET UNITYSDK_OFFSET(0x1BED0610)
#define ARA_ARATRAIL_APPENDSECTION_OFFSET UNITYSDK_OFFSET(0x1BED0050)
#define ARA_ARATRAIL_ATTACHTOCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1BECB2F0)
#define ARA_ARATRAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BECB1E0)
#define ARA_ARATRAIL_CLEARMESHDATA_OFFSET UNITYSDK_OFFSET(0x1BECCA40)
#define ARA_ARATRAIL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BECB500)
#define ARA_ARATRAIL_COMMITMESHDATA_OFFSET UNITYSDK_OFFSET(0x1BECCBA0)
#define ARA_ARATRAIL_DETACHFROMCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1BECB400)
#define ARA_ARATRAIL_EMISSIONSTEP_OFFSET UNITYSDK_OFFSET(0x1BECB6F0)
#define ARA_ARATRAIL_EMITPOINT_OFFSET UNITYSDK_OFFSET(0x1BECC290)
#define ARA_ARATRAIL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1BECC980)
#define ARA_ARATRAIL_GETLENGHT_OFFSET UNITYSDK_OFFSET(0x1BECD220)
#define ARA_ARATRAIL_GETRENDERABLEPOINTS_OFFSET UNITYSDK_OFFSET(0x1BECD320)
#define ARA_ARATRAIL_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1BECAF10)
#define ARA_ARATRAIL_GET_FIXEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x1BECAF30)
#define ARA_ARATRAIL_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1BECAF50)
#define ARA_ARATRAIL_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x1BECAEF0)
#define ARA_ARATRAIL_GET_WORLDTOTRAIL_OFFSET UNITYSDK_OFFSET(0x1BECAF60)
#define ARA_ARATRAIL_INITIALIZECURVEFRAME_OFFSET UNITYSDK_OFFSET(0x1BECE3C0)
#define ARA_ARATRAIL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1BECB690)
#define ARA_ARATRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BECAAF0)
#define ARA_ARATRAIL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BECA890)
#define ARA_ARATRAIL_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1BECACF0)
#define ARA_ARATRAIL_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1BECAD20)
#define ARA_ARATRAIL_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1BECAC30)
#define ARA_ARATRAIL_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1BECA920)
#define ARA_ARATRAIL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1BECB1B0)
#define ARA_ARATRAIL_PHYSICSSTEP_OFFSET UNITYSDK_OFFSET(0x1BECC830)
#define ARA_ARATRAIL_REMOVE_ONUPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1BECAE70)
#define ARA_ARATRAIL_RENDERMESH_OFFSET UNITYSDK_OFFSET(0x1BECCF30)
#define ARA_ARATRAIL_SNAPLASTPOINTTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BECB900)
#define ARA_ARATRAIL_UPDATEPOINTSLIFECYCLE_OFFSET UNITYSDK_OFFSET(0x1BECC010)
#define ARA_ARATRAIL_UPDATESEGMENTMESH_OFFSET UNITYSDK_OFFSET(0x1BECEEE0)
#define ARA_ARATRAIL_UPDATETRAILMESH_OFFSET UNITYSDK_OFFSET(0x1BECEB60)
#define ARA_ARATRAIL_UPDATEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1BECB530)
#define ARA_ARATRAIL_WARMUP_OFFSET UNITYSDK_OFFSET(0x1BECB1F0)
#define ARA_ARATRAIL__ATTACHTOCAMERARENDERING_B__88_0_OFFSET UNITYSDK_OFFSET(0x1BED1AA0)
#define ARA_ARATRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED1630)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_TypeDefinitionIndex = 31370;
