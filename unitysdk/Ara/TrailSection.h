...
#define ARA_TRAILSECTION_CIRCLEPRESET_OFFSET UNITYSDK_OFFSET(0x1BED2DC0)
#define ARA_TRAILSECTION_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1BED1610)
#define ARA_TRAILSECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BED2D50)
#define ARA_TRAILSECTION_SNAPTO_OFFSET UNITYSDK_OFFSET(0x1BED2EE0)
#define ARA_TRAILSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED2F30)

namespace Ara
{
	inline static constexpr unsigned int TrailSection_TypeDefinitionIndex = 31383;
