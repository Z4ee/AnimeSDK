...
#define ARA_TRAILSECTION_CIRCLEPRESET_OFFSET UNITYSDK_OFFSET(0x1E21F3F0)
#define ARA_TRAILSECTION_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1E21DC40)
#define ARA_TRAILSECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E21F380)
#define ARA_TRAILSECTION_SNAPTO_OFFSET UNITYSDK_OFFSET(0x1E21F510)
#define ARA_TRAILSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E21F560)

namespace Ara
{
	inline static constexpr unsigned int TrailSection_TypeDefinitionIndex = 32934;
