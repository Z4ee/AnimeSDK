...
#define ARA_TIRETRACK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BED28F0)
#define ARA_TIRETRACK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BED27A0)
#define ARA_TIRETRACK_PROJECTTOGROUND_OFFSET UNITYSDK_OFFSET(0x1BED29D0)
#define ARA_TIRETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED2CF0)

namespace Ara
{
	inline static constexpr unsigned int TireTrack_TypeDefinitionIndex = 31382;
