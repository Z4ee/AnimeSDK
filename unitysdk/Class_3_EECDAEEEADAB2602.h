...
#define CLASS_3_EECDAEEEADAB2602_DISPOSE_OFFSET UNITYSDK_OFFSET(0x966F430)
#define CLASS_3_EECDAEEEADAB2602_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x966F330)
#define CLASS_3_EECDAEEEADAB2602_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x966F3E0)
#define CLASS_3_EECDAEEEADAB2602_TICK_OFFSET UNITYSDK_OFFSET(0x966F380)
#define CLASS_3_EECDAEEEADAB2602__CTOR_OFFSET UNITYSDK_OFFSET(0x966F2B0)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x966F560)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x966F470)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x966F4F0)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x966F480)
