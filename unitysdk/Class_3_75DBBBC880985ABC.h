...
#define CLASS_3_75DBBBC880985ABC_EVALUATE_OFFSET UNITYSDK_OFFSET(0x17882B30)
#define CLASS_3_75DBBBC880985ABC__CTOR_OFFSET UNITYSDK_OFFSET(0x17882AB0)
...
public:
	...
	::RPG::GameCore::UniversalHotFixBasePredicate* OPCCJDHNKEC; // 0x40
