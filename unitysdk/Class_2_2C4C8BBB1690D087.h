...
#define CLASS_2_2C4C8BBB1690D087_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CC2570)
#define CLASS_2_2C4C8BBB1690D087_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19CC2640)
#define CLASS_2_2C4C8BBB1690D087_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19CC25F0)
#define CLASS_2_2C4C8BBB1690D087_TICK_OFFSET UNITYSDK_OFFSET(0x19CC28F0)
#define CLASS_2_2C4C8BBB1690D087__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC2560)

inline static constexpr unsigned int Class_2_2C4C8BBB1690D087_TypeDefinitionIndex = 53612;

class Class_2_2C4C8BBB1690D087 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TeleportToRotatableRegion* IGHAHBNLIJA; // 0x18
