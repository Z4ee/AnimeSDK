...
#define CLASS_2_F1245CC53B2FD441_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12993FC0)
#define CLASS_2_F1245CC53B2FD441_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12994000)
#define CLASS_2_F1245CC53B2FD441_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12994080)
#define CLASS_2_F1245CC53B2FD441_TICK_OFFSET UNITYSDK_OFFSET(0x129940D0)
#define CLASS_2_F1245CC53B2FD441__CTOR_OFFSET UNITYSDK_OFFSET(0x12993FB0)

inline static constexpr unsigned int Class_2_F1245CC53B2FD441_TypeDefinitionIndex = 52030;

class Class_2_F1245CC53B2FD441 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ShowBossHPValue* Field_2_0; // 0x20
