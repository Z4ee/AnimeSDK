...
#define CLASS_1_04E8A8CB715F95A7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19A824B0)
#define CLASS_1_04E8A8CB715F95A7_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x19A95170)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_0A97C142F8308A62_OFFSET UNITYSDK_OFFSET(0x19A848F0)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_0B739117C1792146_OFFSET UNITYSDK_OFFSET(0x19A83F30)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_18FB5F0211403A3D_OFFSET UNITYSDK_OFFSET(0x19A82ED0)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_1C0F0B7BB20C36C7_OFFSET UNITYSDK_OFFSET(0x19A94210)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_1C1393D0FFA2D9FA_OFFSET UNITYSDK_OFFSET(0x19A94510)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x19A838B0)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_52128BE59C7EF2D3_OFFSET UNITYSDK_OFFSET(0x19A93F50)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_7955878C72ACC403_OFFSET UNITYSDK_OFFSET(0x19A94930)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x19A93CF0)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0x19A939C0)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_B5D72D2A9ACC08C2_OFFSET UNITYSDK_OFFSET(0x19A82820)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x19A938A0)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_BAB1B94DF957C3D5_OFFSET UNITYSDK_OFFSET(0x19A94120)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_D3A3EB4626083A97_OFFSET UNITYSDK_OFFSET(0x19A94F20)
#define CLASS_1_04E8A8CB715F95A7_METHOD_1_DC4B15126B344D9B_OFFSET UNITYSDK_OFFSET(0x19A83990)
#define CLASS_1_04E8A8CB715F95A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A95180)
#define CLASS_1_04E8A8CB715F95A7__CTOR_OFFSET UNITYSDK_OFFSET(0x19A84240)
...
public:
	...
	{
		return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_04E8A8CB715F95A7_TypeDefinitionIndex)->GetStaticField(0x56DF0);
	}
	// static const ::System::Single OBJJKPKOLKM; // 0x0
	// static const ::System::Single HFAHICMDFOK; // 0x0
	::System::Collections::Generic::LinkedList_1<::Class_1_04E8A8CB715F95A7_Class_1_F9EEB1063E933248*>* NMHGPOINNDE; // 0x10
	::Class_2_94088BD52F494C82* JHFKOHNKLMH; // 0x18
	...
	::System::Collections::Generic::List_1<::Class_1_61F66DDFF6FC7B36*>* GFFAGJOELCH; // 0x30
	::System::Collections::Generic::LinkedList_1<::Class_1_04E8A8CB715F95A7_Class_1_149B209B067A3FA8*>* OMDOJLJEJEM; // 0x38
	::RPG::GameCore::GameEntity* CFKHNPGEAJA; // 0x40
	::System::Single OIKOMNFPCDD; // 0x48
	::System::Single BHHHGKKOFAK; // 0x4C
	::System::Single FNKPBGKLFED; // 0x50
	::System::Single IKPGEMHGIME; // 0x54
	::System::Single BDDGMAOMCPI; // 0x58
	::System::Single BPAIDCADMDO; // 0x5C
	::System::Boolean DKLMKMCGGPC; // 0x60
	::System::Single HBDJCFFDGDD; // 0x64
	::System::Single LAMPDMCDDLF; // 0x68
	::System::Single FGFCCDEBKJA; // 0x6C
