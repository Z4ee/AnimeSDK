...
#define WWISEACOUSTICTEXTUREREFERENCE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1C152820)
#define WWISEACOUSTICTEXTUREREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C152830)

inline static constexpr unsigned int WwiseAcousticTextureReference_TypeDefinitionIndex = 31554;
