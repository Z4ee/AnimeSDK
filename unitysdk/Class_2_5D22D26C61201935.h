...
#define CLASS_2_5D22D26C61201935_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16DCCB50)
#define CLASS_2_5D22D26C61201935_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x16DCCB30)
#define CLASS_2_5D22D26C61201935_METHOD_2_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x16DCFAE0)
#define CLASS_2_5D22D26C61201935_METHOD_2_2E29038CF17E20BD_OFFSET UNITYSDK_OFFSET(0x16DCF3A0)
#define CLASS_2_5D22D26C61201935_METHOD_2_524DEE2D6E894C01_OFFSET UNITYSDK_OFFSET(0x16DCFE40)
#define CLASS_2_5D22D26C61201935_METHOD_2_6562D9334740F852_OFFSET UNITYSDK_OFFSET(0x16DD04E0)
#define CLASS_2_5D22D26C61201935_METHOD_2_84C3BE9BB646C7FD_OFFSET UNITYSDK_OFFSET(0x16DCEA60)
#define CLASS_2_5D22D26C61201935_METHOD_2_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0x16DD0190)
#define CLASS_2_5D22D26C61201935_METHOD_2_BC46FCF99873D9DD_1_OFFSET UNITYSDK_OFFSET(0x16DD04A0)
#define CLASS_2_5D22D26C61201935_METHOD_2_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0x16DD0460)
#define CLASS_2_5D22D26C61201935_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16DD0410)
#define CLASS_2_5D22D26C61201935_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x16DCCBB0)
#define CLASS_2_5D22D26C61201935_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x16DCE8F0)
#define CLASS_2_5D22D26C61201935_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x16DCFD70)
#define CLASS_2_5D22D26C61201935_ONSKIP_OFFSET UNITYSDK_OFFSET(0x16DCFF00)
#define CLASS_2_5D22D26C61201935_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16DCCC90)
#define CLASS_2_5D22D26C61201935_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16DCFC40)
#define CLASS_2_5D22D26C61201935_TICK_OFFSET UNITYSDK_OFFSET(0x16DCFCA0)
#define CLASS_2_5D22D26C61201935__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCCB40)
...
{
public:
	::RPG::GameCore::GameEntity* NHNJKCPPLBA; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::System::String* AAKJCKGCAPF; // 0x28
	::RPG::GameCore::VCameraBlend* OBJFPLFEEBD; // 0x30
	::Cinemachine::CinemachineBrain* NDFNHOJDLPK; // 0x38
	::RPG::GameCore::ActiveVirtualCamera* OFKGLJOAMLD; // 0x40
	::RPG::GameCore::GameEntity* DIHCNFOOEFF; // 0x48
	::System::String* CENMHIGCEDG; // 0x50
	::System::String* MLHHKCCAOJK; // 0x58
	::System::String* ALGOGGCGNEJ; // 0x60
	::System::UInt32 LEJCBJNHIEG; // 0x68
	::System::UInt64 BHOBDDBFMEH; // 0x70
