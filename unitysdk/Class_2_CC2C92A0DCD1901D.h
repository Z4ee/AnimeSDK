...
#define CLASS_2_CC2C92A0DCD1901D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11358290)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x113582D0)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x113584E0)
#define CLASS_2_CC2C92A0DCD1901D_TICK_OFFSET UNITYSDK_OFFSET(0x11358530)
#define CLASS_2_CC2C92A0DCD1901D__CTOR_OFFSET UNITYSDK_OFFSET(0x11358280)

inline static constexpr unsigned int Class_2_CC2C92A0DCD1901D_TypeDefinitionIndex = 42632;

class Class_2_CC2C92A0DCD1901D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ChangeTrackingMission* Field_2_0; // 0x20
