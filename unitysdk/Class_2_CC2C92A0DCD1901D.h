...
#define CLASS_2_CC2C92A0DCD1901D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x173F8D00)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x173F8D40)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x173F8F70)
#define CLASS_2_CC2C92A0DCD1901D_TICK_OFFSET UNITYSDK_OFFSET(0x173F8FC0)
#define CLASS_2_CC2C92A0DCD1901D__CTOR_OFFSET UNITYSDK_OFFSET(0x173F8CF0)

inline static constexpr unsigned int Class_2_CC2C92A0DCD1901D_TypeDefinitionIndex = 50253;

class Class_2_CC2C92A0DCD1901D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ChangeTrackingMission* Field_2_1; // 0x20
