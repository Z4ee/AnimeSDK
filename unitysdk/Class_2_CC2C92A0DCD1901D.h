...
#define CLASS_2_CC2C92A0DCD1901D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xACD79D0)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xACD7A10)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xACD7BD0)
#define CLASS_2_CC2C92A0DCD1901D_TICK_OFFSET UNITYSDK_OFFSET(0xACD7C20)
#define CLASS_2_CC2C92A0DCD1901D__CTOR_OFFSET UNITYSDK_OFFSET(0xACD79C0)

inline static constexpr unsigned int Class_2_CC2C92A0DCD1901D_TypeDefinitionIndex = 49238;
