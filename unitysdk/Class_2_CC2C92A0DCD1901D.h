...
#define CLASS_2_CC2C92A0DCD1901D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0B3690)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC0B36D0)
#define CLASS_2_CC2C92A0DCD1901D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC0B3900)
#define CLASS_2_CC2C92A0DCD1901D_TICK_OFFSET UNITYSDK_OFFSET(0xC0B3950)
#define CLASS_2_CC2C92A0DCD1901D__CTOR_OFFSET UNITYSDK_OFFSET(0xC0B3680)
...
{
public:
	::RPG::GameCore::ChangeTrackingMission* OFKGLJOAMLD; // 0x18
