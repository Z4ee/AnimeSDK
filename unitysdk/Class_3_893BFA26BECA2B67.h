...
#define CLASS_3_893BFA26BECA2B67_METHOD_3_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0x1A827680)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_1DBAEC6E40278058_OFFSET UNITYSDK_OFFSET(0x1A826020)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_4C7BB19246732602_OFFSET UNITYSDK_OFFSET(0x1A826E80)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0x1A826100)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1A825EB0)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x1A8278B0)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_B12B4E4A39A083D2_OFFSET UNITYSDK_OFFSET(0x1A826C90)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x1A826700)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x1A825F40)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x1A827CB0)
#define CLASS_3_893BFA26BECA2B67_METHOD_3_ED79705457B92B5C_OFFSET UNITYSDK_OFFSET(0x1A826060)
#define CLASS_3_893BFA26BECA2B67_TICK_OFFSET UNITYSDK_OFFSET(0x1A826350)
#define CLASS_3_893BFA26BECA2B67__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A827DA0)
#define CLASS_3_893BFA26BECA2B67__CTOR_OFFSET UNITYSDK_OFFSET(0x1A827D70)

inline static constexpr unsigned int Class_3_893BFA26BECA2B67_TypeDefinitionIndex = 70295;

class Class_3_893BFA26BECA2B67 : public ::RPG::Client::TABehaviorBase
{
public:
	static ::System::Collections::Generic::List_1<::UnityEngine::Collider*>** StaticGet_LPKKNEBFMFF()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_893BFA26BECA2B67_TypeDefinitionIndex)->GetStaticField(0xC930);
	}
	::System::Single JBJNJAIMFGD; // 0x38
	::System::Single HDHPNOOMAGE; // 0x3C
	::System::Single DADEEMLDLNC; // 0x40
	::UnityEngine::Vector3 BCJIIOELICG; // 0x44
	::System::Boolean GFGGJHIEPMN; // 0x50
	::UnityEngine::Quaternion AIIALNAMCLJ; // 0x54
