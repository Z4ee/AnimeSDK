...
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE_METHOD_2_B756CDAE3ECDB56F_OFFSET UNITYSDK_OFFSET(0x933B760)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE_METHOD_2_E10B4092FFA54980_OFFSET UNITYSDK_OFFSET(0x933B6C0)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x933BB90)

inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementMatInstance_TypeDefinitionIndex = 44221;
