...
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE_METHOD_2_173B4412467E28D4_OFFSET UNITYSDK_OFFSET(0xA850A90)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE_METHOD_2_B756CDAE3ECDB56F_OFFSET UNITYSDK_OFFSET(0xA850B40)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xA850F10)

inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementMatInstance_TypeDefinitionIndex = 44767;
