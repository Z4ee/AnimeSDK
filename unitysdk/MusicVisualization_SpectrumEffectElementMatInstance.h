...
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE_METHOD_2_173B4412467E28D4_OFFSET UNITYSDK_OFFSET(0xBBC6960)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE_METHOD_2_B756CDAE3ECDB56F_OFFSET UNITYSDK_OFFSET(0xBBC6A10)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTMATINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBC6E50)
