...
#define PARTICLERECORDER_PARTICLERECORDERS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9FF70)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleRecorders_TypeDefinitionIndex = 35158;
