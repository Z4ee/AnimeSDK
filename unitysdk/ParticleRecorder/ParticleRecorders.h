...
#define PARTICLERECORDER_PARTICLERECORDERS__CTOR_OFFSET UNITYSDK_OFFSET(0x177F6D10)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleRecorders_TypeDefinitionIndex = 35940;
