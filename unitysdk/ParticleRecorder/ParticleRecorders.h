...
#define PARTICLERECORDER_PARTICLERECORDERS__CTOR_OFFSET UNITYSDK_OFFSET(0x19296700)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleRecorders_TypeDefinitionIndex = 36801;
