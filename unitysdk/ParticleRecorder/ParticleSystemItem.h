...
#define PARTICLERECORDER_PARTICLESYSTEMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x180FD130)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleSystemItem_TypeDefinitionIndex = 34876;
