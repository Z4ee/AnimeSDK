...
#define PARTICLERECORDER_PARTICLESYSTEMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x177F6D30)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleSystemItem_TypeDefinitionIndex = 35941;
