...
#define PARTICLERECORDER_PARTICLESYSTEMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5B140)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleSystemItem_TypeDefinitionIndex = 29132;
