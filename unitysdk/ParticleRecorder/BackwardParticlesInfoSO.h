...
#define PARTICLERECORDER_BACKWARDPARTICLESINFOSO__CTOR_OFFSET UNITYSDK_OFFSET(0x177F6BF0)

namespace ParticleRecorder
{
	inline static constexpr unsigned int BackwardParticlesInfoSO_TypeDefinitionIndex = 35943;
