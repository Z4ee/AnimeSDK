...
#define PARTICLERECORDER_PARTICLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19296640)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleClip_TypeDefinitionIndex = 36803;
