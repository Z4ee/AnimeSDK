...
#define CLASS_1_5B567C8A01BAEDFE_178_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DEA4E10)
#define CLASS_1_5B567C8A01BAEDFE_178_CLONE_OFFSET UNITYSDK_OFFSET(0x1DEA4B00)
#define CLASS_1_5B567C8A01BAEDFE_178_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DEA4C10)
#define CLASS_1_5B567C8A01BAEDFE_178_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEA4B40)
#define CLASS_1_5B567C8A01BAEDFE_178_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEA4D70)
#define CLASS_1_5B567C8A01BAEDFE_178_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DEA4E60)
#define CLASS_1_5B567C8A01BAEDFE_178_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DEA4E30)
#define CLASS_1_5B567C8A01BAEDFE_178_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DEA4A80)
#define CLASS_1_5B567C8A01BAEDFE_178_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DEA4AB0)
#define CLASS_1_5B567C8A01BAEDFE_178_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEA4DA0)
#define CLASS_1_5B567C8A01BAEDFE_178_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DEA4E00)
#define CLASS_1_5B567C8A01BAEDFE_178__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEA4EB0)
#define CLASS_1_5B567C8A01BAEDFE_178__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEA4AD0)
#define CLASS_1_5B567C8A01BAEDFE_178__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEA4AC0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_178_TypeDefinitionIndex = 29567;

class Class_1_5B567C8A01BAEDFE_178 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_178*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_178*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_178_TypeDefinitionIndex)->GetStaticField(0x38500);
	}
