...
#define PVSSTAGEBUDGETHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA99C0)

inline static constexpr unsigned int PvsStageBudgetHandle_TypeDefinitionIndex = 47860;
