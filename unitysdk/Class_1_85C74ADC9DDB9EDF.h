...
#define CLASS_1_85C74ADC9DDB9EDF_METHOD_1_4B5B0B4E28D31F7A_OFFSET UNITYSDK_OFFSET(0x121C46F0)
#define CLASS_1_85C74ADC9DDB9EDF_METHOD_1_B2C3C6DB5457B4DB_OFFSET UNITYSDK_OFFSET(0x121C4770)
#define CLASS_1_85C74ADC9DDB9EDF_SYSTEM_ICOMPARABLE_MOLEMOLE_BATTLE_OPENCAMERASHOTBANNERREQUEST__COMPARETO_OFFSET UNITYSDK_OFFSET(0x121C4690)
#define CLASS_1_85C74ADC9DDB9EDF__CCTOR_OFFSET UNITYSDK_OFFSET(0x121C46E0)
#define CLASS_1_85C74ADC9DDB9EDF__CTOR_OFFSET UNITYSDK_OFFSET(0x121C46C0)

inline static constexpr unsigned int Class_1_85C74ADC9DDB9EDF_TypeDefinitionIndex = 45271;
...
public:
	...
	{
		return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(Class_1_85C74ADC9DDB9EDF_TypeDefinitionIndex)->GetStaticField(0x10160);
	}
	::System::Action* Field_1_1; // 0x10
	::Struct_2_DA3A109C3E0BFF6B Field_1_0; // 0x18
