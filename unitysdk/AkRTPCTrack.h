...
#define AKRTPCTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1E71B030)
#define AKRTPCTRACK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E71B1E0)
#define AKRTPCTRACK_SETPLAYABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1E71B110)
#define AKRTPCTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E71B2B0)

inline static constexpr unsigned int AkRTPCTrack_TypeDefinitionIndex = 33164;
