...
#define AKRTPCTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1BD74B80)
#define AKRTPCTRACK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1BD75230)
#define AKRTPCTRACK_SETPLAYABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1BD74C90)
#define AKRTPCTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD757D0)

inline static constexpr unsigned int AkRTPCTrack_TypeDefinitionIndex = 42139;
