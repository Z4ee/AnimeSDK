...
#define AKRTPCTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1C3D6970)
#define AKRTPCTRACK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C3D6B20)
#define AKRTPCTRACK_SETPLAYABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C3D6A50)
#define AKRTPCTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3D6BF0)

inline static constexpr unsigned int AkRTPCTrack_TypeDefinitionIndex = 31613;
