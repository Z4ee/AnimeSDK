...
#define AKRTPCTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18BCE290)
#define AKRTPCTRACK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x18BCE7A0)
#define AKRTPCTRACK_SETPLAYABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18BCE400)
#define AKRTPCTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCEB20)
#define AKRTPCTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18BCEC00)

inline static constexpr unsigned int AkRTPCTrack_TypeDefinitionIndex = 34678;
