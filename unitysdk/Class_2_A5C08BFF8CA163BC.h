...
#define CLASS_2_A5C08BFF8CA163BC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1351EB90)
#define CLASS_2_A5C08BFF8CA163BC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1351EBD0)
#define CLASS_2_A5C08BFF8CA163BC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1351EC70)
#define CLASS_2_A5C08BFF8CA163BC_TICK_OFFSET UNITYSDK_OFFSET(0x1351ECC0)
#define CLASS_2_A5C08BFF8CA163BC__CTOR_OFFSET UNITYSDK_OFFSET(0x1351EB80)
...
{
public:
	::RPG::GameCore::PauseToTurnEnd* OFKGLJOAMLD; // 0x18
