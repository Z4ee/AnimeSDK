...
#define ZLINQ_LINQ_FROMENUMERABLECONTENT_THROWIFNOENUMERABLE_OFFSET UNITYSDK_OFFSET(0x3B088B0)
#define ZLINQ_LINQ_FROMENUMERABLECONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x3B088A0)
#define ZLINQ_LINQ_FROMENUMERABLECONTENT__THROWIFNOENUMERABLE_G__THROW_3_0_OFFSET UNITYSDK_OFFSET(0x1D2FBD80)

namespace ZLinq::Linq
{
	inline static constexpr unsigned int FromEnumerableContent_TypeDefinitionIndex = 6343;
