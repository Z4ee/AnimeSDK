...
#define ZLINQ_INTERNAL_ENUMERATORHELPER_TRYGETSLICERANGE_OFFSET UNITYSDK_OFFSET(0x1D2FADB0)

namespace ZLinq::Internal
{
	inline static constexpr unsigned int EnumeratorHelper_TypeDefinitionIndex = 6394;
