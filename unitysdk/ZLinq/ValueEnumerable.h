...
#define ZLINQ_VALUEENUMERABLE_ASVALUEENUMERABLE_OFFSET UNITYSDK_OFFSET(0x1F0090E0)
#define ZLINQ_VALUEENUMERABLE_RANGE_OFFSET UNITYSDK_OFFSET(0x1F009180)

namespace ZLinq
{
	inline static constexpr unsigned int ValueEnumerable_TypeDefinitionIndex = 6083;
