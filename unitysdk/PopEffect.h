...
#define POPEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A513C60)
#define POPEFFECT_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x1A5130D0)
#define POPEFFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1A513F20)
#define POPEFFECT_REGISTERIMG_OFFSET UNITYSDK_OFFSET(0x1A513880)
#define POPEFFECT_RESETIMG_OFFSET UNITYSDK_OFFSET(0x1A513A90)
#define POPEFFECT_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1A513610)
#define POPEFFECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0x1A513B70)
#define POPEFFECT_SETTEXTWITHOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x1A5133A0)
#define POPEFFECT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1A5130E0)
#define POPEFFECT_UPDATEIMGSIZE_OFFSET UNITYSDK_OFFSET(0x1A513670)
#define POPEFFECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A513D80)
#define POPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A514910)
#define POPEFFECT___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A5149D0)

inline static constexpr unsigned int PopEffect_TypeDefinitionIndex = 47681;
