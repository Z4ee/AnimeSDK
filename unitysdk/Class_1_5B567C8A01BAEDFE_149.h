...
#define CLASS_1_5B567C8A01BAEDFE_149_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2C5920)
#define CLASS_1_5B567C8A01BAEDFE_149_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2C5730)
#define CLASS_1_5B567C8A01BAEDFE_149_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2C5830)
#define CLASS_1_5B567C8A01BAEDFE_149_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2C57A0)
#define CLASS_1_5B567C8A01BAEDFE_149_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2C5880)
#define CLASS_1_5B567C8A01BAEDFE_149_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2C5970)
#define CLASS_1_5B567C8A01BAEDFE_149_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2C5940)
#define CLASS_1_5B567C8A01BAEDFE_149_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2C5680)
#define CLASS_1_5B567C8A01BAEDFE_149_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2C56E0)
#define CLASS_1_5B567C8A01BAEDFE_149_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2C58B0)
#define CLASS_1_5B567C8A01BAEDFE_149_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2C5910)
#define CLASS_1_5B567C8A01BAEDFE_149__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2C59C0)
#define CLASS_1_5B567C8A01BAEDFE_149__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2C5700)
#define CLASS_1_5B567C8A01BAEDFE_149__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2C56F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_149_TypeDefinitionIndex = 27714;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_149*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_149_TypeDefinitionIndex)->GetStaticField(0x4CF00);
	}
