...
#define CLASS_1_5B567C8A01BAEDFE_149_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C1318A0)
#define CLASS_1_5B567C8A01BAEDFE_149_CLONE_OFFSET UNITYSDK_OFFSET(0x1C131540)
#define CLASS_1_5B567C8A01BAEDFE_149_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C1316A0)
#define CLASS_1_5B567C8A01BAEDFE_149_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C1315B0)
#define CLASS_1_5B567C8A01BAEDFE_149_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C131800)
#define CLASS_1_5B567C8A01BAEDFE_149_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C1318F0)
#define CLASS_1_5B567C8A01BAEDFE_149_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C1318C0)
#define CLASS_1_5B567C8A01BAEDFE_149_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C131490)
#define CLASS_1_5B567C8A01BAEDFE_149_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C1314F0)
#define CLASS_1_5B567C8A01BAEDFE_149_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C131830)
#define CLASS_1_5B567C8A01BAEDFE_149_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C131890)
#define CLASS_1_5B567C8A01BAEDFE_149__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C131940)
#define CLASS_1_5B567C8A01BAEDFE_149__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C131510)
#define CLASS_1_5B567C8A01BAEDFE_149__CTOR_OFFSET UNITYSDK_OFFSET(0x1C131500)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_149_TypeDefinitionIndex = 28271;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_149*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_149_TypeDefinitionIndex)->GetStaticField(0x59C10);
	}
