...
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES_START_OFFSET UNITYSDK_OFFSET(0x1DA6E6B0)
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DA6E8D0)
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA6EA10)

inline static constexpr unsigned int MB2_UpdateSkinnedMeshBoundsFromBones_TypeDefinitionIndex = 90533;
