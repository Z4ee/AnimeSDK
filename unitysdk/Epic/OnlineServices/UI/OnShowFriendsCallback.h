...
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83CD260)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83CD290)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83CCD10)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83CCCF0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnShowFriendsCallback_TypeDefinitionIndex = 35319;
