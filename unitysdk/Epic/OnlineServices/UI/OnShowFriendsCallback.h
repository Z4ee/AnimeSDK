...
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4456F0)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D445720)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4456E0)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4455F0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnShowFriendsCallback_TypeDefinitionIndex = 44991;
