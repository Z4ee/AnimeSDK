...
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS_GET_KEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0xB169B40)
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS_SET_KEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0xB169B50)
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xB169B60)
