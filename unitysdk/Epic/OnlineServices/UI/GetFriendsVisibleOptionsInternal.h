...
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x20A60)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x20A50)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x208C0)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x20980)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int GetFriendsVisibleOptionsInternal_TypeDefinitionIndex = 41933;
