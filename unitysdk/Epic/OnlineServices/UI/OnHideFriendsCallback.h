...
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BF4950)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BF4980)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BF4400)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8BF43E0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnHideFriendsCallback_TypeDefinitionIndex = 41143;
