...
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E80F0)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9E7FC0)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9E7E30)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9E7EF0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ShowFriendsOptionsInternal_TypeDefinitionIndex = 34940;
