...
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x945390)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x945260)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9450D0)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x945190)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ShowFriendsOptionsInternal_TypeDefinitionIndex = 33377;
