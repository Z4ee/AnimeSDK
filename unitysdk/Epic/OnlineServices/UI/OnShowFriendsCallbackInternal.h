...
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA102A30)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA102A80)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA102A20)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA1029B0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnShowFriendsCallbackInternal_TypeDefinitionIndex = 41949;
