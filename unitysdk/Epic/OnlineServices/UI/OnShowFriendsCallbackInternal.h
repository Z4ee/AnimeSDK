...
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E4F60)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E4FB0)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E4F50)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E4EE0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnShowFriendsCallbackInternal_TypeDefinitionIndex = 42810;
