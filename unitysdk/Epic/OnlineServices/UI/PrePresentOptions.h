...
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONS_GET_PLATFORMSPECIFICDATA_OFFSET UNITYSDK_OFFSET(0x1B7E4FC0)
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONS_SET_PLATFORMSPECIFICDATA_OFFSET UNITYSDK_OFFSET(0x1B7E4FD0)
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E4FE0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int PrePresentOptions_TypeDefinitionIndex = 42811;
