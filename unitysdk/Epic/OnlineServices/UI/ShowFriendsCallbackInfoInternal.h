...
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x950110)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x950120)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ShowFriendsCallbackInfoInternal_TypeDefinitionIndex = 34938;
