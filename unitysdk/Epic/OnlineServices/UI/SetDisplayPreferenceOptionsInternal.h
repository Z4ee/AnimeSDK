...
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F00)
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3BCCA10)
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONSINTERNAL_SET_NOTIFICATIONLOCATION_OFFSET UNITYSDK_OFFSET(0xB596A0)
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3BCC9F0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int SetDisplayPreferenceOptionsInternal_TypeDefinitionIndex = 44998;
