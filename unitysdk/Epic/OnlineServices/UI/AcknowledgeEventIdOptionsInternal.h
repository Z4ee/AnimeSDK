...
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x667A60)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A391D0)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A391B0)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x38C6D30)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_UIEVENTID_OFFSET UNITYSDK_OFFSET(0x7BE220)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int AcknowledgeEventIdOptionsInternal_TypeDefinitionIndex = 42790;
