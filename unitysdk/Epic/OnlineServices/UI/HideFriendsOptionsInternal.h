...
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x20EA0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x20E90)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x20D00)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x20DC0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int HideFriendsOptionsInternal_TypeDefinitionIndex = 41939;
