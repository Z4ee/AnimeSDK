...
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4F5B30)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4F5B60)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4F5630)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F5620)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnDisplaySettingsUpdatedCallback_TypeDefinitionIndex = 33358;
