...
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83CB870)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83CB8A0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83CB320)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83CB300)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnDisplaySettingsUpdatedCallback_TypeDefinitionIndex = 35313;
