...
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BF3880)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BF38B0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BF3330)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8BF3310)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnDisplaySettingsUpdatedCallback_TypeDefinitionIndex = 41139;
