...
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C82B2B0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C82B2E0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C82ADB0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82AD90)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnDisplaySettingsUpdatedCallback_TypeDefinitionIndex = 34921;
