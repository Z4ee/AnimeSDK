...
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1B7E5A30)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1B7E5A40)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E5A50)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ShowFriendsOptions_TypeDefinitionIndex = 42821;
