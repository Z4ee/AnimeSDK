...
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1B61A200)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1B61A210)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B61A220)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int HideFriendsOptions_TypeDefinitionIndex = 34917;
