...
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83CA580)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83CA590)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x83CA5A0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int GetFriendsVisibleOptions_TypeDefinitionIndex = 35303;
