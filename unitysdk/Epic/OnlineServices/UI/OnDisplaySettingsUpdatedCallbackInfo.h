...
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xB168AE0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xB168A80)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GET_ISEXCLUSIVEINPUT_OFFSET UNITYSDK_OFFSET(0xB168AC0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xB168AA0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xB169100)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xB168A90)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_ISEXCLUSIVEINPUT_OFFSET UNITYSDK_OFFSET(0xB168AD0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xB168AB0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xB168AF0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB169220)
