...
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91B030)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x91AFC0)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B4520)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_PLATFORMSPECIFICINPUTDATA_OFFSET UNITYSDK_OFFSET(0x446DA0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ReportKeyEventOptionsInternal_TypeDefinitionIndex = 34932;
