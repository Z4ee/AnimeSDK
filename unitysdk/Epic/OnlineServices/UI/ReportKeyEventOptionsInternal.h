...
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x20AB0)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x20A40)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9650)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_PLATFORMSPECIFICINPUTDATA_OFFSET UNITYSDK_OFFSET(0x8D10)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ReportKeyEventOptionsInternal_TypeDefinitionIndex = 41150;
