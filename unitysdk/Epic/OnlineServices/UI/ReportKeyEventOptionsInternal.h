...
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9653C0)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x965350)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x905640)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_PLATFORMSPECIFICINPUTDATA_OFFSET UNITYSDK_OFFSET(0x462A80)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ReportKeyEventOptionsInternal_TypeDefinitionIndex = 35591;
