...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDB2E00)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDB2E30)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDAA490)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDB2D10)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int OnAchievementsUnlockedCallbackV2_TypeDefinitionIndex = 44281;
