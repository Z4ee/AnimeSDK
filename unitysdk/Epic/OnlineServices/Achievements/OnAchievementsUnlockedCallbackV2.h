...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E518D50)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E518D80)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E518830)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E518810)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int OnAchievementsUnlockedCallbackV2_TypeDefinitionIndex = 37058;
