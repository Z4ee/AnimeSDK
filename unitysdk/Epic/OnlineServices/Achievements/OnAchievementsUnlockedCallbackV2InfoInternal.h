...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INFOINTERNAL_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x96DA30)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x259D70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x96D8B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INFOINTERNAL_GET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x96DAE0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INFOINTERNAL_GET_USERID_OFFSET UNITYSDK_OFFSET(0x96D9C0)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int OnAchievementsUnlockedCallbackV2InfoInternal_TypeDefinitionIndex = 37061;
