...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ADDNOTIFYACHIEVEMENTSUNLOCKEDV2OPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1F40)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ADDNOTIFYACHIEVEMENTSUNLOCKEDV2OPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1F30)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int AddNotifyAchievementsUnlockedV2OptionsInternal_TypeDefinitionIndex = 43389;
