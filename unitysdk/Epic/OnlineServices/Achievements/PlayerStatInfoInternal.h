...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9F8B10)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x325D00)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9F88C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_GET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x31D320)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9F8B00)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x5B0840)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x9F8970)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9F8A20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x352890)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int PlayerStatInfoInternal_TypeDefinitionIndex = 37077;
