...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDB37C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDB3810)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDB37B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDB3740)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int OnAchievementsUnlockedCallbackV2Internal_TypeDefinitionIndex = 44282;
