...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6780)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x5E10)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x62E0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x6180)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_FLAVORTEXT_OFFSET UNITYSDK_OFFSET(0x65A0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_ICONURL_OFFSET UNITYSDK_OFFSET(0x6440)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x5F70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_STATINFO_OFFSET UNITYSDK_OFFSET(0x60A0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x5F90)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6710)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x5EC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x6390)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x6230)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_FLAVORTEXT_OFFSET UNITYSDK_OFFSET(0x6650)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_ICONURL_OFFSET UNITYSDK_OFFSET(0x64F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6700)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x5F80)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_STATINFO_OFFSET UNITYSDK_OFFSET(0x6110)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x6010)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int PlayerAchievementInternal_TypeDefinitionIndex = 36808;
