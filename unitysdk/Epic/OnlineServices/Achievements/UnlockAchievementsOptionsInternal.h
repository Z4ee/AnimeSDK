...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x913A90)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x913A20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_ACHIEVEMENTIDS_OFFSET UNITYSDK_OFFSET(0x9138F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x913A10)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_USERID_OFFSET UNITYSDK_OFFSET(0x913830)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int UnlockAchievementsOptionsInternal_TypeDefinitionIndex = 36426;
