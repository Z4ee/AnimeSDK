...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ADDNOTIFYACHIEVEMENTSUNLOCKEDV2_OFFSET UNITYSDK_OFFSET(0x1ADD7DF0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ADDNOTIFYACHIEVEMENTSUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1ADD7B70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYACHIEVEMENTDEFINITIONBYACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x1ADD8070)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYACHIEVEMENTDEFINITIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x1ADD8300)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYACHIEVEMENTDEFINITIONV2BYACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x1ADD8500)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYACHIEVEMENTDEFINITIONV2BYINDEX_OFFSET UNITYSDK_OFFSET(0x1ADD8790)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYPLAYERACHIEVEMENTBYACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x1ADD8990)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYPLAYERACHIEVEMENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x1ADD8B90)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYUNLOCKEDACHIEVEMENTBYACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x1ADD8D90)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_COPYUNLOCKEDACHIEVEMENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x1ADD8F90)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_GETACHIEVEMENTDEFINITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADD9240)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_GETPLAYERACHIEVEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADD9460)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_GETUNLOCKEDACHIEVEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADD9660)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ONACHIEVEMENTSUNLOCKEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1ADD7880)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ONACHIEVEMENTSUNLOCKEDCALLBACKV2INTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1ADD7910)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ONQUERYDEFINITIONSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1ADD79A0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ONQUERYPLAYERACHIEVEMENTSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1ADD7A30)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_ONUNLOCKACHIEVEMENTSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1ADD7AC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_QUERYDEFINITIONS_OFFSET UNITYSDK_OFFSET(0x1ADD9860)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_QUERYPLAYERACHIEVEMENTS_OFFSET UNITYSDK_OFFSET(0x1ADD9A20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_REMOVENOTIFYACHIEVEMENTSUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1ADD9BE0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE_UNLOCKACHIEVEMENTS_OFFSET UNITYSDK_OFFSET(0x1ADD9CC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ADD7B60)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ACHIEVEMENTSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD7B50)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int AchievementsInterface_TypeDefinitionIndex = 36364;
