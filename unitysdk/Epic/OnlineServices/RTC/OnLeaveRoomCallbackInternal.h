...
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A872340)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A872390)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A872040)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A872030)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnLeaveRoomCallbackInternal_TypeDefinitionIndex = 33763;
