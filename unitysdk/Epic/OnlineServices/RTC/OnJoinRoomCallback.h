...
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA33CB60)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA33CB90)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA33CB50)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA33CA60)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnJoinRoomCallback_TypeDefinitionIndex = 42344;
