...
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4C65D0)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4C6600)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4C60D0)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C60B0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnLeaveRoomCallback_TypeDefinitionIndex = 35325;
