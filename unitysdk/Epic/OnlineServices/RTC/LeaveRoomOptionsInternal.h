...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C155F0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C15570)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C153F0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C15560)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x3C154B0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int LeaveRoomOptionsInternal_TypeDefinitionIndex = 45382;
