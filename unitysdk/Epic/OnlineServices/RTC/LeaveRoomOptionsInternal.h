...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9145D0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x914560)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9143E0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x914550)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x9144A0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int LeaveRoomOptionsInternal_TypeDefinitionIndex = 33755;
