...
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_BLOCKED_OFFSET UNITYSDK_OFFSET(0x65BD0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AF0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x65930)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x65A40)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x65B60)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x65AB0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int BlockParticipantCallbackInfoInternal_TypeDefinitionIndex = 35697;
