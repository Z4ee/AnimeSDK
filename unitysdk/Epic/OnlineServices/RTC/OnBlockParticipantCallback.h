...
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86E1170)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86E11A0)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86E0C20)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86E0C00)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnBlockParticipantCallback_TypeDefinitionIndex = 35711;
