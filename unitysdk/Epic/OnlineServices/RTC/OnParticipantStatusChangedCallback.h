...
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A30D90)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A30DC0)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A30890)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A30880)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnParticipantStatusChangedCallback_TypeDefinitionIndex = 33764;
