...
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD8A5C0)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD8A610)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD8A2C0)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8A2B0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnBlockParticipantCallbackInternal_TypeDefinitionIndex = 33757;
