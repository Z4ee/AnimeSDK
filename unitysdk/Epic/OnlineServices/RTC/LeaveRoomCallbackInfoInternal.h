...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AF0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x675B0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x676C0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x67730)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int LeaveRoomCallbackInfoInternal_TypeDefinitionIndex = 41534;
