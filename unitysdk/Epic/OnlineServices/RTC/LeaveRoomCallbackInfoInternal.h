...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x962C40)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x962D50)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x962DC0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int LeaveRoomCallbackInfoInternal_TypeDefinitionIndex = 35975;
