...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x60D0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x6CC30)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x6CD40)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMCALLBACKINFOINTERNAL_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6CDB0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int LeaveRoomCallbackInfoInternal_TypeDefinitionIndex = 42337;
