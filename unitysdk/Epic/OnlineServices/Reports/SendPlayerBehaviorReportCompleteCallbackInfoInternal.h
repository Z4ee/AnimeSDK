...
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x70440)
...
{
	inline static constexpr unsigned int SendPlayerBehaviorReportCompleteCallbackInfoInternal_TypeDefinitionIndex = 41414;
