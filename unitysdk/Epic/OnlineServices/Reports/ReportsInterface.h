...
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1C0BE710)
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE_SENDPLAYERBEHAVIORREPORT_OFFSET UNITYSDK_OFFSET(0x1C0BE7D0)
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0BE7C0)
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0BE7B0)

namespace Epic::OnlineServices::Reports
{
	inline static constexpr unsigned int ReportsInterface_TypeDefinitionIndex = 43076;
