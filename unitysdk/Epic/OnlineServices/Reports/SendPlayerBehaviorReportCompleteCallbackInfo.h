...
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xA354020)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA354000)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xA353FE0)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xA3542C0)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA354010)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xA354040)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xA353FF0)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA3543E0)

namespace Epic::OnlineServices::Reports
{
	inline static constexpr unsigned int SendPlayerBehaviorReportCompleteCallbackInfo_TypeDefinitionIndex = 42216;
