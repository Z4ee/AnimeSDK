...
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7D640)
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7D670)
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7D120)
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF7D100)

namespace Epic::OnlineServices::Reports
{
	inline static constexpr unsigned int OnSendPlayerBehaviorReportCompleteCallback_TypeDefinitionIndex = 35850;
