...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONS_GET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x1C5477C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONS_SET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x1C5477D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5477E0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchSetMaxResultsOptions_TypeDefinitionIndex = 35155;
