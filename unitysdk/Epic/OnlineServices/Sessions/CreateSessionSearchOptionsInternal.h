...
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x667A60)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A8DE30)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_SET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0xA4B350)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A39E50)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CreateSessionSearchOptionsInternal_TypeDefinitionIndex = 42920;
