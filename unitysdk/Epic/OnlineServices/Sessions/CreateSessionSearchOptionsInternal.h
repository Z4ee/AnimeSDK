...
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9A7340)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_SET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x916EA0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CreateSessionSearchOptionsInternal_TypeDefinitionIndex = 35038;
