...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONS_GET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0xA0EA520)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONS_SET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0xA0EA530)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xA0EA540)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetHostAddressOptions_TypeDefinitionIndex = 42153;
