...
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITERECEIVEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83A6280)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITERECEIVEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83A62D0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITERECEIVEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x83A5F90)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITERECEIVEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x83A5F70)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnSessionInviteReceivedCallbackInternal_TypeDefinitionIndex = 35472;
