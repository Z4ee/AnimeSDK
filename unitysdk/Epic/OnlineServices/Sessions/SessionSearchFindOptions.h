...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C9D4570)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C9D4580)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9D4590)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchFindOptions_TypeDefinitionIndex = 35806;
