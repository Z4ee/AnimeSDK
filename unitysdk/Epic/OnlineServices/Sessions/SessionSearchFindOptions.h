...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF111A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF111B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF111C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchFindOptions_TypeDefinitionIndex = 45211;
