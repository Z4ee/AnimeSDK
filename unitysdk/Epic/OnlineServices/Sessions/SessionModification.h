...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_ADDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C4C90F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C4C9320)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_REMOVEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C4C93A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETBUCKETID_OFFSET UNITYSDK_OFFSET(0x1C4C95A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETHOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x1C4C97A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETINVITESALLOWED_OFFSET UNITYSDK_OFFSET(0x1C4C99A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETJOININPROGRESSALLOWED_OFFSET UNITYSDK_OFFSET(0x1C4C9B90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETMAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x1C4C9D80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETPERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C4C9EE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4C90E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C90D0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModification_TypeDefinitionIndex = 35125;
