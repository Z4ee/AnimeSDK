...
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEAFC0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEB010)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEACD0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEACB0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnStartSessionCallbackInternal_TypeDefinitionIndex = 35082;
