...
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83A6BA0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83A6BF0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x83A68B0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x83A6890)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnStartSessionCallbackInternal_TypeDefinitionIndex = 35474;
