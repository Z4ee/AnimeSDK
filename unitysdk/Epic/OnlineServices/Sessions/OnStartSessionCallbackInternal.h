...
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2BEAC0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2BEB10)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2BE7B0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2BE790)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnStartSessionCallbackInternal_TypeDefinitionIndex = 35741;
