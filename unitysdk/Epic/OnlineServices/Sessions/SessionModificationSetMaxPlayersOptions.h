...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS_GET_MAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x1E5D9FC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS_SET_MAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x1E5D9FD0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5D9FE0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetMaxPlayersOptions_TypeDefinitionIndex = 35797;
