...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS_GET_MAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x83B0B00)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS_SET_MAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x83B0B10)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x83B0B20)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetMaxPlayersOptions_TypeDefinitionIndex = 35530;
