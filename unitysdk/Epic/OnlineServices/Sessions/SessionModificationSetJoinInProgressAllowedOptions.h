...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETJOININPROGRESSALLOWEDOPTIONS_GET_ALLOWJOININPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A9DF7C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETJOININPROGRESSALLOWEDOPTIONS_SET_ALLOWJOININPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A9DF7D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETJOININPROGRESSALLOWEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9DF7E0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetJoinInProgressAllowedOptions_TypeDefinitionIndex = 33573;
