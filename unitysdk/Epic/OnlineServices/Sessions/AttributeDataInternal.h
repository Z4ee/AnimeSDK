...
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C21C90)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_GET_KEY_OFFSET UNITYSDK_OFFSET(0x3C21920)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3C21A80)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C21C10)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_KEY_OFFSET UNITYSDK_OFFSET(0x3C219D0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C21C00)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x3C21B90)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int AttributeDataInternal_TypeDefinitionIndex = 45088;
