...
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BCB1A0)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BCB1D0)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BCAC50)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8BCAC30)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnQueryInvitesCallback_TypeDefinitionIndex = 41287;
