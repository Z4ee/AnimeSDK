...
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x974D70)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x974C50)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x974B80)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x974AD0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int EndSessionOptionsInternal_TypeDefinitionIndex = 35707;
