...
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83A1630)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83A1660)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83A10E0)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83A10C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnEndSessionCallback_TypeDefinitionIndex = 35455;
