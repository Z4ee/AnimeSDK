...
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF05340)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF05370)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF05330)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF05240)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnEndSessionCallback_TypeDefinitionIndex = 45127;
