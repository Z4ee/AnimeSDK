...
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x944F10)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x944DF0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x944D20)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x944C70)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int StartSessionOptionsInternal_TypeDefinitionIndex = 33604;
