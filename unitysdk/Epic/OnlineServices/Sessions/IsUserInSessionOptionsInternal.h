...
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93E900)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x93E890)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x93E880)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x93E710)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x93E7C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int IsUserInSessionOptionsInternal_TypeDefinitionIndex = 33491;
