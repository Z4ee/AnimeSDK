...
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E19E0)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9E1970)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9E1960)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x9E17F0)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x9E18A0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int IsUserInSessionOptionsInternal_TypeDefinitionIndex = 35054;
