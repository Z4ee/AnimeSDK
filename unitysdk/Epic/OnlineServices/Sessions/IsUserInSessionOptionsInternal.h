...
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA2CAF0)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA2CA80)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA2CA70)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0xA2C900)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xA2C9B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int IsUserInSessionOptionsInternal_TypeDefinitionIndex = 35713;
