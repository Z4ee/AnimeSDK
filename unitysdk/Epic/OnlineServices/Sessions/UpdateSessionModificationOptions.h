...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONMODIFICATIONOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1C194850)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONMODIFICATIONOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1C194860)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONMODIFICATIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C194870)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionModificationOptions_TypeDefinitionIndex = 43056;
