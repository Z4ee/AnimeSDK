...
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONGETREGISTEREDPLAYERBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x71BB0)
...
{
	inline static constexpr unsigned int ActiveSessionGetRegisteredPlayerByIndexOptionsInternal_TypeDefinitionIndex = 41230;
