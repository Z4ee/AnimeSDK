...
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C181C60)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C181C90)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C181C50)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C181B60)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnDestroySessionCallback_TypeDefinitionIndex = 42943;
