...
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONGETREGISTEREDPLAYERBYINDEXOPTIONS_GET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1DE57EF0)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONGETREGISTEREDPLAYERBYINDEXOPTIONS_SET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1DE57F00)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONGETREGISTEREDPLAYERBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE57F10)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int ActiveSessionGetRegisteredPlayerByIndexOptions_TypeDefinitionIndex = 45075;
