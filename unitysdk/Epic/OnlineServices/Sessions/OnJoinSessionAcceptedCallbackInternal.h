...
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7DF70)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7DFC0)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7DC60)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF7DC40)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnJoinSessionAcceptedCallbackInternal_TypeDefinitionIndex = 35725;
