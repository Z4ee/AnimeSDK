...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_GET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x1DF0A880)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_GET_NUMOPENPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1DF0A8A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1DF0A860)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1DF0A8C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1DF0AE50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_SET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x1DF0A890)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_SET_NUMOPENPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1DF0A8B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_SET_OFFSET UNITYSDK_OFFSET(0x1DF0A8E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1DF0A870)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1DF0A8D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF0AF80)
...
namespace Epic::OnlineServices::Sessions
{
	...
	public:
		...
		::Epic::OnlineServices::Sessions::SessionDetailsSettings* _Settings_k__BackingField; // 0x18
