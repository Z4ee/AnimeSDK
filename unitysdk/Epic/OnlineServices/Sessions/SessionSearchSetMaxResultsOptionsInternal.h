...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x186A0)
...
{
	inline static constexpr unsigned int SessionSearchSetMaxResultsOptionsInternal_TypeDefinitionIndex = 35548;
