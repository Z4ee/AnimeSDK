...
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1C4C84F0)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1C4C8510)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1C4C8500)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1C4C8520)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C8530)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int IsUserInSessionOptions_TypeDefinitionIndex = 35053;
