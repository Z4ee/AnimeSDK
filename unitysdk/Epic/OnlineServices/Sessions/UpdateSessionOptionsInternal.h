...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C2CD40)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C2CD30)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C2CC60)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x3C2CBA0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionOptionsInternal_TypeDefinitionIndex = 45241;
