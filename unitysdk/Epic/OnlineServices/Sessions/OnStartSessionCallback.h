...
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA0E1AB0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0E1AE0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0E1AA0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA0E19B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnStartSessionCallback_TypeDefinitionIndex = 42102;
