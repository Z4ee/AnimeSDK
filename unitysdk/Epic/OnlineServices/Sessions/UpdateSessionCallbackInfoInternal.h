...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x9FE560)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x9FE720)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x9FE670)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionCallbackInfoInternal_TypeDefinitionIndex = 35832;
