...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1A590)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1A750)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONCALLBACKINFOINTERNAL_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1A6A0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionCallbackInfoInternal_TypeDefinitionIndex = 35565;
