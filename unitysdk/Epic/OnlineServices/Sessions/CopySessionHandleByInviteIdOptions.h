...
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONS_GET_INVITEID_OFFSET UNITYSDK_OFFSET(0x87076A0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONS_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x87076B0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x87076C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CopySessionHandleByInviteIdOptions_TypeDefinitionIndex = 35421;
