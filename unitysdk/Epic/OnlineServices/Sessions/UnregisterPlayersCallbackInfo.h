...
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1DF16C50)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1DF16C30)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1DF16C10)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1DF16EF0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1DF16C40)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1DF16C70)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1DF16C20)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF17010)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UnregisterPlayersCallbackInfo_TypeDefinitionIndex = 45232;
