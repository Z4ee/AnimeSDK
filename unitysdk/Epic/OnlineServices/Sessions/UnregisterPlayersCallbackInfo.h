...
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xA0F20A0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA0F2080)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xA0F2060)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xA0F2340)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA0F2090)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xA0F20C0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xA0F2070)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F2460)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UnregisterPlayersCallbackInfo_TypeDefinitionIndex = 42189;
