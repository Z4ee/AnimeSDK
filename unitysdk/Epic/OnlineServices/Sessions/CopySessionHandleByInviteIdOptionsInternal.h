...
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11AA0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x72860)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONSINTERNAL_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x726E0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYINVITEIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x72790)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CopySessionHandleByInviteIdOptionsInternal_TypeDefinitionIndex = 35422;
