...
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONS_GET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x1BFB8050)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONS_SET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x1BFB8060)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFB8070)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CreateSessionSearchOptions_TypeDefinitionIndex = 35037;
