...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_COPYSEARCHRESULTBYINDEX_OFFSET UNITYSDK_OFFSET(0x1C18C760)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_FIND_OFFSET UNITYSDK_OFFSET(0x1C18C8F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_GETSEARCHRESULTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C18CB50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_ONFINDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1C18C6A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C18CD90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1C18CE10)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETMAXRESULTS_OFFSET UNITYSDK_OFFSET(0x1C18D040)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETPARAMETER_OFFSET UNITYSDK_OFFSET(0x1C18D1A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETSESSIONID_OFFSET UNITYSDK_OFFSET(0x1C18D3D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETTARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1C18D5D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C18C750)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C18C740)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearch_TypeDefinitionIndex = 43024;
