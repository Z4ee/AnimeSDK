...
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEFORPRESENCEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D27CFF0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEFORPRESENCEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D27D000)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEFORPRESENCEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27D010)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CopySessionHandleForPresenceOptions_TypeDefinitionIndex = 35033;
