...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETTARGETUSERIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x988AF0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETTARGETUSERIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9889C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETTARGETUSERIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9888F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETTARGETUSERIDOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x988830)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchSetTargetUserIdOptionsInternal_TypeDefinitionIndex = 35821;
