...
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93CC60)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x93CB40)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x93CA70)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x93C9C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int DestroySessionOptionsInternal_TypeDefinitionIndex = 35042;
