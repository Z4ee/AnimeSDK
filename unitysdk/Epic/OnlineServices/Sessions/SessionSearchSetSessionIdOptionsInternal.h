...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A937C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A937B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A936E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x3A93630)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchSetSessionIdOptionsInternal_TypeDefinitionIndex = 43042;
