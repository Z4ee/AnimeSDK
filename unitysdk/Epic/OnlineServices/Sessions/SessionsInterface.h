...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ADDNOTIFYJOINSESSIONACCEPTED_OFFSET UNITYSDK_OFFSET(0x1D260AB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ADDNOTIFYSESSIONINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x1D260D30)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ADDNOTIFYSESSIONINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x1D260FB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_COPYACTIVESESSIONHANDLE_OFFSET UNITYSDK_OFFSET(0x1D261230)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_COPYSESSIONHANDLEBYINVITEID_OFFSET UNITYSDK_OFFSET(0x1D261440)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_COPYSESSIONHANDLEBYUIEVENTID_OFFSET UNITYSDK_OFFSET(0x1D261650)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_COPYSESSIONHANDLEFORPRESENCE_OFFSET UNITYSDK_OFFSET(0x1D2617E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_CREATESESSIONMODIFICATION_OFFSET UNITYSDK_OFFSET(0x1D2619F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_CREATESESSIONSEARCH_OFFSET UNITYSDK_OFFSET(0x1D261B80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_DESTROYSESSION_OFFSET UNITYSDK_OFFSET(0x1D261D10)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_DUMPSESSIONSTATE_OFFSET UNITYSDK_OFFSET(0x1D261F60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ENDSESSION_OFFSET UNITYSDK_OFFSET(0x1D262160)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_GETINVITECOUNT_OFFSET UNITYSDK_OFFSET(0x1D2623B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_GETINVITEIDBYINDEX_OFFSET UNITYSDK_OFFSET(0x1D2625B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ISUSERINSESSION_OFFSET UNITYSDK_OFFSET(0x1D262920)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_JOINSESSION_OFFSET UNITYSDK_OFFSET(0x1D262A80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONDESTROYSESSIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260340)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONENDSESSIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D2603D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONJOINSESSIONACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260460)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONJOINSESSIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D2604F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONQUERYINVITESCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260580)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONREGISTERPLAYERSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260610)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONREJECTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D2606A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONSENDINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260730)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONSESSIONINVITEACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D2607C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONSESSIONINVITERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260850)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONSTARTSESSIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D2608E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONUNREGISTERPLAYERSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260970)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_ONUPDATESESSIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1D260A00)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_QUERYINVITES_OFFSET UNITYSDK_OFFSET(0x1D262C40)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_REGISTERPLAYERS_OFFSET UNITYSDK_OFFSET(0x1D262E90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_REJECTINVITE_OFFSET UNITYSDK_OFFSET(0x1D263050)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_REMOVENOTIFYJOINSESSIONACCEPTED_OFFSET UNITYSDK_OFFSET(0x1D263210)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_REMOVENOTIFYSESSIONINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x1D2632F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_REMOVENOTIFYSESSIONINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x1D2633D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_SENDINVITE_OFFSET UNITYSDK_OFFSET(0x1D2634B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_STARTSESSION_OFFSET UNITYSDK_OFFSET(0x1D263670)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_UNREGISTERPLAYERS_OFFSET UNITYSDK_OFFSET(0x1D2638C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_UPDATESESSIONMODIFICATION_OFFSET UNITYSDK_OFFSET(0x1D263CD0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE_UPDATESESSION_OFFSET UNITYSDK_OFFSET(0x1D263A80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D260AA0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D260A90)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionsInterface_TypeDefinitionIndex = 35163;
