...
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1ADED3D0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1ADED3B0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1ADED390)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1ADED480)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1ADED3C0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1ADED3F0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1ADED3A0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADED5E0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int StartSessionCallbackInfo_TypeDefinitionIndex = 35164;
