...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A92730)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A92720)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_SET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x3A925A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A92650)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetHostAddressOptionsInternal_TypeDefinitionIndex = 43015;
