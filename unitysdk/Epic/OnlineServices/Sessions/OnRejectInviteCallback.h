...
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83A43D0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83A4400)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83A3E80)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83A3E60)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRejectInviteCallback_TypeDefinitionIndex = 35465;
