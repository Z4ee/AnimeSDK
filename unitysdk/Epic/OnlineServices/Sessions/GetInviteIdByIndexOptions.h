...
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1C17FF40)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C17FF20)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1C17FF50)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C17FF30)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C17FF60)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int GetInviteIdByIndexOptions_TypeDefinitionIndex = 42933;
