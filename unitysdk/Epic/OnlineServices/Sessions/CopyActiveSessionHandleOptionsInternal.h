...
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x976DB0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x976C90)
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x976BC0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x976B10)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CopyActiveSessionHandleOptionsInternal_TypeDefinitionIndex = 35028;
