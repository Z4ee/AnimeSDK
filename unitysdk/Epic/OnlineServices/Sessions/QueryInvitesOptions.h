...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A4F3ED0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A4F3EE0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F3EF0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int QueryInvitesOptions_TypeDefinitionIndex = 33528;
