...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BD03F0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BD0400)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8BD0410)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int QueryInvitesOptions_TypeDefinitionIndex = 41309;
