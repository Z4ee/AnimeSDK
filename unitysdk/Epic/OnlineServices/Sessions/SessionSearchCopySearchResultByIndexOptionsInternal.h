...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHCOPYSEARCHRESULTBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x17F00)
...
{
	inline static constexpr unsigned int SessionSearchCopySearchResultByIndexOptionsInternal_TypeDefinitionIndex = 35536;
