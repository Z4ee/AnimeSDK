...
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x125C0)
...
{
	inline static constexpr unsigned int DestroySessionCallbackInfoInternal_TypeDefinitionIndex = 35432;
