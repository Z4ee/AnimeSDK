...
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C182700)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C182730)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1826F0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C182600)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRegisterPlayersCallback_TypeDefinitionIndex = 42953;
