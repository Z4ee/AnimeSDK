...
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF05BC0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF05BF0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF05BB0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF05AC0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRegisterPlayersCallback_TypeDefinitionIndex = 45135;
