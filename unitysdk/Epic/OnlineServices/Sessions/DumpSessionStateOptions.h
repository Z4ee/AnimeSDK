...
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1DCB1630)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1DCB1640)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB1650)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int DumpSessionStateOptions_TypeDefinitionIndex = 35702;
