...
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1A4F2E30)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1A4F2E40)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F2E50)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int DumpSessionStateOptions_TypeDefinitionIndex = 33480;
