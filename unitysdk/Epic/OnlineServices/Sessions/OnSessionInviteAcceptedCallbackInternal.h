...
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC613C0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC61410)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC610D0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC610B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnSessionInviteAcceptedCallbackInternal_TypeDefinitionIndex = 35078;
