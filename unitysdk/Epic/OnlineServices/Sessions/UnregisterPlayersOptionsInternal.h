...
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x965C40)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x965BD0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x965BC0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_PLAYERSTOUNREGISTER_OFFSET UNITYSDK_OFFSET(0x965B50)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x965AA0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UnregisterPlayersOptionsInternal_TypeDefinitionIndex = 35171;
