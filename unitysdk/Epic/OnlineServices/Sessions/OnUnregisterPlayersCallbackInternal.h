...
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198B4450)
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198B44A0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x198B4150)
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x198B4140)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnUnregisterPlayersCallbackInternal_TypeDefinitionIndex = 33521;
