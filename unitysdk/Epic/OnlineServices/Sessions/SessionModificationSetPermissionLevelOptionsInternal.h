...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETPERMISSIONLEVELOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x17D80)
...
{
	inline static constexpr unsigned int SessionModificationSetPermissionLevelOptionsInternal_TypeDefinitionIndex = 35533;
