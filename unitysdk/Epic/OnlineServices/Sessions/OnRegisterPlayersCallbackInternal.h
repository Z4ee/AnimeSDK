...
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83A3E00)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83A3E50)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x83A3B10)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x83A3AF0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRegisterPlayersCallbackInternal_TypeDefinitionIndex = 35464;
