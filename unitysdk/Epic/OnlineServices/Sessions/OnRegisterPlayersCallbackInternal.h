...
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7E300)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7E350)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7DFF0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF7DFD0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRegisterPlayersCallbackInternal_TypeDefinitionIndex = 35731;
