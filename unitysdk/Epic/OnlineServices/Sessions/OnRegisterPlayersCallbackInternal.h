...
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CBDBC30)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CBDBC80)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CBDB940)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBDB920)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRegisterPlayersCallbackInternal_TypeDefinitionIndex = 35072;
