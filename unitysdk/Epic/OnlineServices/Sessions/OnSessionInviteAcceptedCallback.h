...
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DFF6680)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DFF66B0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFF6160)
#define EPIC_ONLINESERVICES_SESSIONS_ONSESSIONINVITEACCEPTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFF6140)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnSessionInviteAcceptedCallback_TypeDefinitionIndex = 35736;
