...
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1820A0)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1820D0)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C182090)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONACCEPTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C181FA0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnJoinSessionAcceptedCallback_TypeDefinitionIndex = 42947;
