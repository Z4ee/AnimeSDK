...
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x12D60)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int EndSessionCallbackInfoInternal_TypeDefinitionIndex = 41264;
