...
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x94F280)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int EndSessionCallbackInfoInternal_TypeDefinitionIndex = 35046;
