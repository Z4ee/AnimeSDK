...
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYUIEVENTIDOPTIONS_GET_UIEVENTID_OFFSET UNITYSDK_OFFSET(0x1C4C84C0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYUIEVENTIDOPTIONS_SET_UIEVENTID_OFFSET UNITYSDK_OFFSET(0x1C4C84D0)
#define EPIC_ONLINESERVICES_SESSIONS_COPYSESSIONHANDLEBYUIEVENTIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C84E0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CopySessionHandleByUiEventIdOptions_TypeDefinitionIndex = 35031;
