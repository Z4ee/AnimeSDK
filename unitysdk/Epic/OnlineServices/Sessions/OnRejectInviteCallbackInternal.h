...
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA0E12F0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0E1340)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0E12E0)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA0E1270)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRejectInviteCallbackInternal_TypeDefinitionIndex = 42095;
