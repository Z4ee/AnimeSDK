...
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x28B580)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x938840)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int StartSessionCallbackInfoInternal_TypeDefinitionIndex = 33602;
