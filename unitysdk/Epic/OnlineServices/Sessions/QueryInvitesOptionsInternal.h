...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9654F0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9653C0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x965230)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9652F0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int QueryInvitesOptionsInternal_TypeDefinitionIndex = 35092;
