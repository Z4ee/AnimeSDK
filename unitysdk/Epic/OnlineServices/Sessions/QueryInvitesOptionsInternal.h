...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C0230)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8C0100)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BFF70)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8C0030)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int QueryInvitesOptionsInternal_TypeDefinitionIndex = 33529;
