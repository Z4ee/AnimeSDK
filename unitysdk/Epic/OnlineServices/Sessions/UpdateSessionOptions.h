...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONS_GET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x83B95B0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONS_SET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x83B95C0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x83B95D0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionOptions_TypeDefinitionIndex = 35568;
