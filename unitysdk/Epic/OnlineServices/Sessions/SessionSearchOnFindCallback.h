...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83B2C60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83B2C90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83B1DB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83B2C40)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchOnFindCallback_TypeDefinitionIndex = 35543;
