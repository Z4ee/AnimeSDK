...
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1ADEEB10)
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1ADEEB20)
#define EPIC_ONLINESERVICES_SESSIONS_COPYACTIVESESSIONHANDLEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEEB30)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CopyActiveSessionHandleOptions_TypeDefinitionIndex = 33464;
