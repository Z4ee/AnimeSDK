...
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83A7DE0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83A7E30)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x83A7AF0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x83A7AD0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnUpdateSessionCallbackInternal_TypeDefinitionIndex = 35478;
