...
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1836A0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1836F0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C183690)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C183620)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnUpdateSessionCallbackInternal_TypeDefinitionIndex = 42968;
