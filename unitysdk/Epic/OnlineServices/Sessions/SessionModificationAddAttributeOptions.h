...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DF608E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_GET_SESSIONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DF608C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DF608F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_SET_SESSIONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1DF608D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF60900)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationAddAttributeOptions_TypeDefinitionIndex = 35785;
