...
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A2B9C0)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A2B9F0)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A2B4C0)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2B4B0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnRedeemEntitlementsCallback_TypeDefinitionIndex = 34423;
