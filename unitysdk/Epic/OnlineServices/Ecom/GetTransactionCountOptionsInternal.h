...
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3DE00)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3DDF0)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3DC60)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3DD20)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetTransactionCountOptionsInternal_TypeDefinitionIndex = 42189;
