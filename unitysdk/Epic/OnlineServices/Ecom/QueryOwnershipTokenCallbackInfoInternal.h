...
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3E3F0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPTOKENCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3E400)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPTOKENCALLBACKINFOINTERNAL_GET_OWNERSHIPTOKEN_OFFSET UNITYSDK_OFFSET(0x3E470)
...
{
	inline static constexpr unsigned int QueryOwnershipTokenCallbackInfoInternal_TypeDefinitionIndex = 36394;
