...
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x28B580)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8C80D0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8C81E0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x8C8250)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CheckoutCallbackInfoInternal_TypeDefinitionIndex = 34360;
