...
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x60D0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3CE40)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3CF50)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x3CFC0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CheckoutCallbackInfoInternal_TypeDefinitionIndex = 42944;
