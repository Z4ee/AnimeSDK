...
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x39550)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x39660)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x396D0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CheckoutCallbackInfoInternal_TypeDefinitionIndex = 42141;
