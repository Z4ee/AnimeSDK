...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2C0A60)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2C0AB0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2C0A50)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2C09E0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryEntitlementsCallbackInternal_TypeDefinitionIndex = 43000;
