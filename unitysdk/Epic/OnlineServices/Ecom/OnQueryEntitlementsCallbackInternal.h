...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6310)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6360)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6300)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAA6290)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryEntitlementsCallbackInternal_TypeDefinitionIndex = 43861;
