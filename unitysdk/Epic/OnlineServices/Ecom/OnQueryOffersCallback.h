...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOFFERSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6460)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOFFERSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6490)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOFFERSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA14D0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOFFERSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAA6370)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryOffersCallback_TypeDefinitionIndex = 43862;
