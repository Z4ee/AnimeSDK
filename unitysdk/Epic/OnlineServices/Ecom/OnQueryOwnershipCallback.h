...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x864C020)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x864C050)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8645B40)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x864C000)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryOwnershipCallback_TypeDefinitionIndex = 36374;
