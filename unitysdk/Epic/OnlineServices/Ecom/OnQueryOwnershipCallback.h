...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CB89ED0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CB89F00)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CB899D0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB899B0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryOwnershipCallback_TypeDefinitionIndex = 35982;
