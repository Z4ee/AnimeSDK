...
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AFC50)
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_GET_ID_OFFSET UNITYSDK_OFFSET(0x8AFA70)
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_GET_OWNERSHIPSTATUS_OFFSET UNITYSDK_OFFSET(0x2E8B50)
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8AFBE0)
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_SET_ID_OFFSET UNITYSDK_OFFSET(0x8AFB20)
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8AFBD0)
#define EPIC_ONLINESERVICES_ECOM_ITEMOWNERSHIPINTERNAL_SET_OWNERSHIPSTATUS_OFFSET UNITYSDK_OFFSET(0x577FD0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int ItemOwnershipInternal_TypeDefinitionIndex = 34410;
