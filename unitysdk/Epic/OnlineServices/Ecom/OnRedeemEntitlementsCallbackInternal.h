...
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D684360)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D6843B0)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D684350)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6842E0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnRedeemEntitlementsCallbackInternal_TypeDefinitionIndex = 46051;
