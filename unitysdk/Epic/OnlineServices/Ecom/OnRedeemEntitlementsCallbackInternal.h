...
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6B50)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6BA0)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6B40)
#define EPIC_ONLINESERVICES_ECOM_ONREDEEMENTITLEMENTSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAA6AD0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnRedeemEntitlementsCallbackInternal_TypeDefinitionIndex = 43869;
