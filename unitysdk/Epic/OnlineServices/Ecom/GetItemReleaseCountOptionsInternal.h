...
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3CC00)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3CB90)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x3CAD0)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3CA10)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3CB80)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetItemReleaseCountOptionsInternal_TypeDefinitionIndex = 36355;
