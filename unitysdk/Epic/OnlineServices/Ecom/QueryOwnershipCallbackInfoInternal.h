...
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x60D0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x42870)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_ITEMOWNERSHIP_OFFSET UNITYSDK_OFFSET(0x428F0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x42880)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5FB0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryOwnershipCallbackInfoInternal_TypeDefinitionIndex = 43019;
