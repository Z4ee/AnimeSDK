...
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x9A2280)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_ITEMOWNERSHIP_OFFSET UNITYSDK_OFFSET(0x9A2400)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9A2390)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryOwnershipCallbackInfoInternal_TypeDefinitionIndex = 35998;
