...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3AD10)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AD00)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AB60)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_OFFERINDEX_OFFSET UNITYSDK_OFFSET(0x26F0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AC20)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyOfferByIndexOptionsInternal_TypeDefinitionIndex = 36335;
