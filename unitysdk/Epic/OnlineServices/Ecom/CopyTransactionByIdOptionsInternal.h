...
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A44980)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A44900)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A44780)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A448F0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x3A44840)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyTransactionByIdOptionsInternal_TypeDefinitionIndex = 43831;
