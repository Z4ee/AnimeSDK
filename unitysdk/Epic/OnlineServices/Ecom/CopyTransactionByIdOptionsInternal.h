...
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C8210)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9C81A0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9C8020)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9C8190)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x9C80E0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyTransactionByIdOptionsInternal_TypeDefinitionIndex = 36608;
