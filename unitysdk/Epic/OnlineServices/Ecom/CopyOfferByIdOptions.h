...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF33F70)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONS_GET_OFFERID_OFFSET UNITYSDK_OFFSET(0x1DF33F90)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF33F80)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONS_SET_OFFERID_OFFSET UNITYSDK_OFFSET(0x1DF33FA0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF33FB0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyOfferByIdOptions_TypeDefinitionIndex = 46004;
