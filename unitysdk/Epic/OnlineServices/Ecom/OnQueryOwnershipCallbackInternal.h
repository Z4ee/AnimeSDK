...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2C0E80)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2C0ED0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2C0E70)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2C0E00)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryOwnershipCallbackInternal_TypeDefinitionIndex = 43004;
