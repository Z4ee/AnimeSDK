...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6730)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6780)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAA6720)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYOWNERSHIPCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAA66B0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryOwnershipCallbackInternal_TypeDefinitionIndex = 43865;
