...
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DFEAF20)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DFEAF50)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFEAA00)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFEA9E0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnCheckoutCallback_TypeDefinitionIndex = 36635;
