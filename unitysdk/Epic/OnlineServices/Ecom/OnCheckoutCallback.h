...
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x864B510)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x864B540)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8644B50)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x864B4F0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnCheckoutCallback_TypeDefinitionIndex = 36368;
