...
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC55A90)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC55AC0)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC55590)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC55570)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnCheckoutCallback_TypeDefinitionIndex = 35976;
