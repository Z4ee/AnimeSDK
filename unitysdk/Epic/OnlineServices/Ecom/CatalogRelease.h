...
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_GET_COMPATIBLEAPPIDS_OFFSET UNITYSDK_OFFSET(0x863B140)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_GET_COMPATIBLEPLATFORMS_OFFSET UNITYSDK_OFFSET(0x863B160)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_GET_RELEASENOTE_OFFSET UNITYSDK_OFFSET(0x863B180)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_SET_1_OFFSET UNITYSDK_OFFSET(0x863B8C0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_SET_COMPATIBLEAPPIDS_OFFSET UNITYSDK_OFFSET(0x863B150)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_SET_COMPATIBLEPLATFORMS_OFFSET UNITYSDK_OFFSET(0x863B170)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_SET_OFFSET UNITYSDK_OFFSET(0x863B1A0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE_SET_RELEASENOTE_OFFSET UNITYSDK_OFFSET(0x863B190)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASE__CTOR_OFFSET UNITYSDK_OFFSET(0x863B9F0)
