...
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A47E60)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A47DE0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_CATALOGITEMIDS_OFFSET UNITYSDK_OFFSET(0x3A47CB0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_CATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x3A47D20)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A47BF0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A47DD0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryOwnershipOptionsInternal_TypeDefinitionIndex = 43882;
