...
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3E000)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3DF90)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3DE10)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3DF80)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_OVERRIDECATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x3DED0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryOffersOptionsInternal_TypeDefinitionIndex = 36388;
