...
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C8D20)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8C8CB0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8C8B30)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8C8CA0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOFFERSOPTIONSINTERNAL_SET_OVERRIDECATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x8C8BF0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryOffersOptionsInternal_TypeDefinitionIndex = 34433;
