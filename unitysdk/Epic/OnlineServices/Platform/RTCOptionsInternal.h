...
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E0C40)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONSINTERNAL_GET_PLATFORMSPECIFICOPTIONS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9E0BD0)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B4520)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONSINTERNAL_SET_PLATFORMSPECIFICOPTIONS_OFFSET UNITYSDK_OFFSET(0x446DA0)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int RTCOptionsInternal_TypeDefinitionIndex = 36355;
