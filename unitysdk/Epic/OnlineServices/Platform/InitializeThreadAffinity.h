...
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_HTTPREQUESTIO_OFFSET UNITYSDK_OFFSET(0x1D93AD50)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_NETWORKWORK_OFFSET UNITYSDK_OFFSET(0x1D93ACD0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_P2PIO_OFFSET UNITYSDK_OFFSET(0x1D93AD30)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_STORAGEIO_OFFSET UNITYSDK_OFFSET(0x1D93ACF0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_WEBSOCKETIO_OFFSET UNITYSDK_OFFSET(0x1D93AD10)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_1_OFFSET UNITYSDK_OFFSET(0x1D93AEB0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_HTTPREQUESTIO_OFFSET UNITYSDK_OFFSET(0x1D93AD60)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_NETWORKWORK_OFFSET UNITYSDK_OFFSET(0x1D93ACE0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_OFFSET UNITYSDK_OFFSET(0x1D93AD70)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_P2PIO_OFFSET UNITYSDK_OFFSET(0x1D93AD40)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_STORAGEIO_OFFSET UNITYSDK_OFFSET(0x1D93AD00)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_WEBSOCKETIO_OFFSET UNITYSDK_OFFSET(0x1D93AD20)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D93B000)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int InitializeThreadAffinity_TypeDefinitionIndex = 37008;

	class InitializeThreadAffinity : public ::System::Object
	{
	public:
		::System::UInt64 _WebSocketIo_k__BackingField; // 0x10
		::System::UInt64 _HttpRequestIo_k__BackingField; // 0x18
		::System::UInt64 _P2PIo_k__BackingField; // 0x20
		::System::UInt64 _StorageIo_k__BackingField; // 0x28
		::System::UInt64 _NetworkWork_k__BackingField; // 0x30
