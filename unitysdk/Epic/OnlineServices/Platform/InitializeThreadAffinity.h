...
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_HTTPREQUESTIO_OFFSET UNITYSDK_OFFSET(0x86B4AF0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_NETWORKWORK_OFFSET UNITYSDK_OFFSET(0x86B4A70)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_P2PIO_OFFSET UNITYSDK_OFFSET(0x86B4AD0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_STORAGEIO_OFFSET UNITYSDK_OFFSET(0x86B4A90)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_WEBSOCKETIO_OFFSET UNITYSDK_OFFSET(0x86B4AB0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_1_OFFSET UNITYSDK_OFFSET(0x86B4C50)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_HTTPREQUESTIO_OFFSET UNITYSDK_OFFSET(0x86B4B00)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_NETWORKWORK_OFFSET UNITYSDK_OFFSET(0x86B4A80)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_OFFSET UNITYSDK_OFFSET(0x86B4B10)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_P2PIO_OFFSET UNITYSDK_OFFSET(0x86B4AE0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_STORAGEIO_OFFSET UNITYSDK_OFFSET(0x86B4AA0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_WEBSOCKETIO_OFFSET UNITYSDK_OFFSET(0x86B4AC0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY__CTOR_OFFSET UNITYSDK_OFFSET(0x86B4D90)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int InitializeThreadAffinity_TypeDefinitionIndex = 36741;

	class InitializeThreadAffinity : public ::System::Object
	{
	public:
		::System::UInt64 _NetworkWork_k__BackingField; // 0x10
