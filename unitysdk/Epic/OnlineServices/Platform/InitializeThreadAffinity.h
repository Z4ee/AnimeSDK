...
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_HTTPREQUESTIO_OFFSET UNITYSDK_OFFSET(0x1A2C0160)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_NETWORKWORK_OFFSET UNITYSDK_OFFSET(0x1A2C00E0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_P2PIO_OFFSET UNITYSDK_OFFSET(0x1A2C0140)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_STORAGEIO_OFFSET UNITYSDK_OFFSET(0x1A2C0100)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_GET_WEBSOCKETIO_OFFSET UNITYSDK_OFFSET(0x1A2C0120)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_1_OFFSET UNITYSDK_OFFSET(0x1A2C02C0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_HTTPREQUESTIO_OFFSET UNITYSDK_OFFSET(0x1A2C0170)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_NETWORKWORK_OFFSET UNITYSDK_OFFSET(0x1A2C00F0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_OFFSET UNITYSDK_OFFSET(0x1A2C0180)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_P2PIO_OFFSET UNITYSDK_OFFSET(0x1A2C0150)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_STORAGEIO_OFFSET UNITYSDK_OFFSET(0x1A2C0110)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY_SET_WEBSOCKETIO_OFFSET UNITYSDK_OFFSET(0x1A2C0130)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZETHREADAFFINITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2C0410)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int InitializeThreadAffinity_TypeDefinitionIndex = 34786;

	class InitializeThreadAffinity : public ::System::Object
	{
	public:
		::System::UInt64 _HttpRequestIo_k__BackingField; // 0x10
		::System::UInt64 _NetworkWork_k__BackingField; // 0x18
		::System::UInt64 _StorageIo_k__BackingField; // 0x20
		::System::UInt64 _P2PIo_k__BackingField; // 0x28
