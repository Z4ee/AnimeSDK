...
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_GET_PLATFORMSPECIFICOPTIONS_OFFSET UNITYSDK_OFFSET(0x1E5D5EF0)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_SET_1_OFFSET UNITYSDK_OFFSET(0x1E5D5F80)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_SET_OFFSET UNITYSDK_OFFSET(0x1E5D5F10)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_SET_PLATFORMSPECIFICOPTIONS_OFFSET UNITYSDK_OFFSET(0x1E5D5F00)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5D60C0)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int RTCOptions_TypeDefinitionIndex = 37013;
