...
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x61CB0)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_GET_XAUDIO29DLLPATH_OFFSET UNITYSDK_OFFSET(0x61A70)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x61CA0)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x61BD0)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_SET_XAUDIO29DLLPATH_OFFSET UNITYSDK_OFFSET(0x61B20)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int WindowsRTCOptionsPlatformSpecificOptionsInternal_TypeDefinitionIndex = 43384;
