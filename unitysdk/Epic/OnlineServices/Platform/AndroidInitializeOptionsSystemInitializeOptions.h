...
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_OPTIONALEXTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1D38C580)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_OPTIONALINTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1D38C560)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_RESERVED_OFFSET UNITYSDK_OFFSET(0x1D38C540)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_1_OFFSET UNITYSDK_OFFSET(0x1D38C830)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OFFSET UNITYSDK_OFFSET(0x1D38C5A0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OPTIONALEXTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1D38C590)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OPTIONALINTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1D38C570)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_RESERVED_OFFSET UNITYSDK_OFFSET(0x1D38C550)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D38CB60)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int AndroidInitializeOptionsSystemInitializeOptions_TypeDefinitionIndex = 37000;
