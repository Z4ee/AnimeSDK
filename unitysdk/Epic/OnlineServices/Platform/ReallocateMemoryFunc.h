...
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EECDF0)
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EECE80)
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EECA50)
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x8EECA30)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int ReallocateMemoryFunc_TypeDefinitionIndex = 42574;
