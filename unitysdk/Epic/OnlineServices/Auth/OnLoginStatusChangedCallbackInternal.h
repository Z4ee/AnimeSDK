...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E51B3A0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E51B3F0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E51B090)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E51B070)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginStatusChangedCallbackInternal_TypeDefinitionIndex = 36835;
