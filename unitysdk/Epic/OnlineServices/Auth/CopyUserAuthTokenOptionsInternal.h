...
#define EPIC_ONLINESERVICES_AUTH_COPYUSERAUTHTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F00)
#define EPIC_ONLINESERVICES_AUTH_COPYUSERAUTHTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C400A0)
#define EPIC_ONLINESERVICES_AUTH_COPYUSERAUTHTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3BCBDF0)
