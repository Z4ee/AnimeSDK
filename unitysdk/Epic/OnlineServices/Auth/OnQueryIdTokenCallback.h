...
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E256B0)
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E256E0)
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E25160)
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8E25140)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnQueryIdTokenCallback_TypeDefinitionIndex = 42397;
