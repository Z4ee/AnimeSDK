...
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3AAA5F0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AAA5E0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x3AAA4F0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AAA560)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x38C6D30)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IOSLoginOptionsInternal_TypeDefinitionIndex = 44088;
