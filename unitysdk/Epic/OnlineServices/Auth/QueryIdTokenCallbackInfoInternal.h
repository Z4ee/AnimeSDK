...
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA06DB0)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA06EC0)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_TARGETACCOUNTID_OFFSET UNITYSDK_OFFSET(0xA06F30)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int QueryIdTokenCallbackInfoInternal_TypeDefinitionIndex = 36847;
