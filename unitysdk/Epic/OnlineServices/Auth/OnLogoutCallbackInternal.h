...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E250E0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E25130)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E24DF0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8E24DD0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallbackInternal_TypeDefinitionIndex = 42396;
