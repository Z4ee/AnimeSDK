...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A865330)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A865380)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A865030)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A865020)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallbackInternal_TypeDefinitionIndex = 34615;
