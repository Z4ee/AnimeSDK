...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x85FB6C0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85FB710)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x85FB3D0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x85FB3B0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallbackInternal_TypeDefinitionIndex = 36570;
