...
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x11830)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x11940)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_PINGRANTINFO_OFFSET UNITYSDK_OFFSET(0x119B0)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_SELECTEDACCOUNTID_OFFSET UNITYSDK_OFFSET(0x11A20)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LinkAccountCallbackInfoInternal_TypeDefinitionIndex = 42372;
