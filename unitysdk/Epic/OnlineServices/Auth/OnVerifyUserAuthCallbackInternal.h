...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4876D0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A487720)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4873D0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4873C0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyUserAuthCallbackInternal_TypeDefinitionIndex = 34621;
