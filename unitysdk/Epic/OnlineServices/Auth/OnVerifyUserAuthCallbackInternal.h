...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C713C00)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C713C50)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C713910)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7138F0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyUserAuthCallbackInternal_TypeDefinitionIndex = 36184;
