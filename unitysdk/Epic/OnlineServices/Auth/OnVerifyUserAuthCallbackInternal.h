...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DBCC820)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DBCC870)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DBCC510)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBCC4F0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyUserAuthCallbackInternal_TypeDefinitionIndex = 36843;
