...
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2CAF0)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x2CA80)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x2C8F0)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x2CA70)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_TARGETACCOUNTID_OFFSET UNITYSDK_OFFSET(0x2C9B0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int QueryIdTokenOptionsInternal_TypeDefinitionIndex = 42408;
