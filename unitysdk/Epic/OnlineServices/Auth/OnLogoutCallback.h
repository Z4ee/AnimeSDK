...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B605120)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B605150)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B604C20)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B604C00)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallback_TypeDefinitionIndex = 36177;
