...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198A0E60)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198A0E90)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x198A0960)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x198A0950)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallback_TypeDefinitionIndex = 34614;
