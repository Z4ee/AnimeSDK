...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x85FB370)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85FB3A0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x85FAE20)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x85FAE00)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallback_TypeDefinitionIndex = 36569;
