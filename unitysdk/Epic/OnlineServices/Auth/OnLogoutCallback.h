...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E24D90)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E24DC0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E24840)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8E24820)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallback_TypeDefinitionIndex = 42395;
