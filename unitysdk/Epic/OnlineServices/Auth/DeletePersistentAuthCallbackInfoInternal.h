...
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x9F24A0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int DeletePersistentAuthCallbackInfoInternal_TypeDefinitionIndex = 36807;
