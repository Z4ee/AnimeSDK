...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBBE6D0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBBE700)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBBE6C0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBBE5D0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyUserAuthCallback_TypeDefinitionIndex = 44065;
