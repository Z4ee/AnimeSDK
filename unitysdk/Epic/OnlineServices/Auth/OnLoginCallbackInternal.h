...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE72D0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE7320)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE6FD0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE6FC0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginCallbackInternal_TypeDefinitionIndex = 34611;
