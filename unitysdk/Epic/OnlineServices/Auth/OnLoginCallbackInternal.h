...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E23EA0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E23EF0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E23BB0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8E23B90)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginCallbackInternal_TypeDefinitionIndex = 42392;
