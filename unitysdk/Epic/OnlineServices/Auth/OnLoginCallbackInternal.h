...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x85FA480)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85FA4D0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x85FA190)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x85FA170)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginCallbackInternal_TypeDefinitionIndex = 36566;
