...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x902EA0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x902D70)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x902BE0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x902CA0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutOptionsInternal_TypeDefinitionIndex = 36827;
