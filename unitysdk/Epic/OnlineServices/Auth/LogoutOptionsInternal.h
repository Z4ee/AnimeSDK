...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2CBD0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x2CAA0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x2C910)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x2C9D0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutOptionsInternal_TypeDefinitionIndex = 36560;
