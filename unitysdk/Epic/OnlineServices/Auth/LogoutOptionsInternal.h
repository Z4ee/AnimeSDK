...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2C000)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x2BED0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x2BD40)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x2BE00)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutOptionsInternal_TypeDefinitionIndex = 42386;
