...
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x100C0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xFF90)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xFE00)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xFEC0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int CopyIdTokenOptionsInternal_TypeDefinitionIndex = 42360;
