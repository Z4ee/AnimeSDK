...
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x100D0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xFFA0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xFE10)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xFED0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int CopyIdTokenOptionsInternal_TypeDefinitionIndex = 36534;
