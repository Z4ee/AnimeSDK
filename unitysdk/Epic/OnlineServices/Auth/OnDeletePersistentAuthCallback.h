...
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC32430)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC32460)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC31F10)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC31EF0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnDeletePersistentAuthCallback_TypeDefinitionIndex = 36828;
