...
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x1DF6A840)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x1DF6A850)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF6A860)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int CopyIdTokenOptions_TypeDefinitionIndex = 46205;
