...
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x1AD7E7B0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x1AD7E7C0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD7E7D0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int CopyIdTokenOptions_TypeDefinitionIndex = 34578;
