...
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_GET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x1DBCBA90)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1DBCBBF0)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_OFFSET UNITYSDK_OFFSET(0x1DBCBAB0)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x1DBCBAA0)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBCBE10)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int AccountFeatureRestrictedInfo_TypeDefinitionIndex = 36793;
