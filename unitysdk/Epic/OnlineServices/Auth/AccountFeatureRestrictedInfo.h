...
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_GET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x8BBD850)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x8BBDA60)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_OFFSET UNITYSDK_OFFSET(0x8BBD870)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x8BBD860)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8BBDC70)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int AccountFeatureRestrictedInfo_TypeDefinitionIndex = 42352;
