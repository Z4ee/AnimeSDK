...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8B1940)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8B1A50)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutCallbackInfoInternal_TypeDefinitionIndex = 36166;
