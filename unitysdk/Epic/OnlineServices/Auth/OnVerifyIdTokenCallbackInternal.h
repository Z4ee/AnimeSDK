...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E51B730)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E51B780)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E51B420)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E51B400)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyIdTokenCallbackInternal_TypeDefinitionIndex = 36841;
