...
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A4E820)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A4E810)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_SET_AUTHTOKEN_OFFSET UNITYSDK_OFFSET(0x3A4E720)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A4E790)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int VerifyUserAuthOptionsInternal_TypeDefinitionIndex = 44082;
