...
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONS_GET_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0x1DF6BD40)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONS_SET_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0x1DF6BD50)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF6BD60)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int DeletePersistentAuthOptions_TypeDefinitionIndex = 46213;
