...
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1C222A10)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_GET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x1C222A30)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1C222A20)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x1C222A40)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C222A50)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IOSLoginOptions_TypeDefinitionIndex = 44087;
