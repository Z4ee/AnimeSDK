...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E5CD6B0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E5CD6C0)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5CD6D0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutOptions_TypeDefinitionIndex = 36826;
