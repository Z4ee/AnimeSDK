...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D76DD30)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D76DD40)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D76DD50)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutOptions_TypeDefinitionIndex = 46231;
