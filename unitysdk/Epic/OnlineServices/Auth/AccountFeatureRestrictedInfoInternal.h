...
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FF950)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_GET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x8FF600)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FF830)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FF760)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_SET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x8FF6B0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int AccountFeatureRestrictedInfoInternal_TypeDefinitionIndex = 34572;
