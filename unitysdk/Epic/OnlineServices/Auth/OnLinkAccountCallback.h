...
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBBDA10)
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBBDA40)
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBBDA00)
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBBD910)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLinkAccountCallback_TypeDefinitionIndex = 44053;
