...
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD81580)
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD815B0)
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD81080)
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD81070)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnTransferDeviceIdAccountCallback_TypeDefinitionIndex = 34543;
