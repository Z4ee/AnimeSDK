...
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DD30)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DD60)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DD20)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19DC30)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnLinkAccountCallback_TypeDefinitionIndex = 43978;
