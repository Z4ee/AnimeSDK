...
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4BAB60)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4BAB90)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4BA660)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BA640)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnLoginStatusChangedCallback_TypeDefinitionIndex = 36100;
