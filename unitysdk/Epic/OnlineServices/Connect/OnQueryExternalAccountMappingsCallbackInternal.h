...
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF4BEA0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF4BEF0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF4BB90)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF4BB70)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnQueryExternalAccountMappingsCallbackInternal_TypeDefinitionIndex = 36762;
