...
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CB87FA0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CB87FF0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CB87CB0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB87C90)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnQueryExternalAccountMappingsCallbackInternal_TypeDefinitionIndex = 36103;
