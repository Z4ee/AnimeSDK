...
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x862A230)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x862A280)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8629F40)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8629F20)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnQueryExternalAccountMappingsCallbackInternal_TypeDefinitionIndex = 36495;
