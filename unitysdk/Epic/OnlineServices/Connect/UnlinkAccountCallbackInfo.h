...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x862EAA0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x862EA60)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x862EA80)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x862EA40)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x862EEA0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x862EA70)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x862EA90)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x862EAC0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x862EA50)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x862EFB0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountCallbackInfo_TypeDefinitionIndex = 36516;
