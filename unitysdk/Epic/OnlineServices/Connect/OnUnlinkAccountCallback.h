...
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19E9F0)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19EA20)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19E9E0)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19E8F0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnUnlinkAccountCallback_TypeDefinitionIndex = 43990;
