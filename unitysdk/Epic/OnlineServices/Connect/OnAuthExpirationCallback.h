...
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C537070)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5370A0)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C536B70)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C536B50)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnAuthExpirationCallback_TypeDefinitionIndex = 36088;
