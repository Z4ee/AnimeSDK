...
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8625F00)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8625F30)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86259B0)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8625990)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnAuthExpirationCallback_TypeDefinitionIndex = 36480;
