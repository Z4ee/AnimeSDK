...
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D933C20)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D933C50)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D933700)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9336E0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnAuthExpirationCallback_TypeDefinitionIndex = 36747;
