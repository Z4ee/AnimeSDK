...
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2B9140)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2B9170)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2B8C40)
#define EPIC_ONLINESERVICES_CONNECT_ONAUTHEXPIRATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2B8C30)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnAuthExpirationCallback_TypeDefinitionIndex = 34525;
