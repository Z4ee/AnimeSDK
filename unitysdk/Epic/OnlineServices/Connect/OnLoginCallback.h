...
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DF50)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DF80)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DF40)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19DE50)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnLoginCallback_TypeDefinitionIndex = 43980;
