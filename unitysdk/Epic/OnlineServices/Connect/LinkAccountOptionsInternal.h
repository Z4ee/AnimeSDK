...
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A993F0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A99370)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x3A992A0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A991E0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A99360)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LinkAccountOptionsInternal_TypeDefinitionIndex = 43963;
