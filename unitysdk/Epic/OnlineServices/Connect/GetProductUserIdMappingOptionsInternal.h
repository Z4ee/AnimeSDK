...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x32EA0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x32E30)
...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x32CA0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x32E20)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_TARGETPRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x32D60)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int GetProductUserIdMappingOptionsInternal_TypeDefinitionIndex = 42293;
