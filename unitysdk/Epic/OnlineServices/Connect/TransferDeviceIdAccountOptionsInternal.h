...
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A9AA30)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A9A9B0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONSINTERNAL_SET_LOCALDEVICEUSERID_OFFSET UNITYSDK_OFFSET(0x3A9A820)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A9A9A0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONSINTERNAL_SET_PRIMARYLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A9A760)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONSINTERNAL_SET_PRODUCTUSERIDTOPRESERVE_OFFSET UNITYSDK_OFFSET(0x3A9A8E0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int TransferDeviceIdAccountOptionsInternal_TypeDefinitionIndex = 44005;
