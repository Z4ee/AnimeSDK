...
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1C819FF0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1C819FB0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C819FD0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1C819F90)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1C81A1A0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1C819FC0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C819FE0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1C81A010)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1C819FA0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81A3C0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CreateUserCallbackInfo_TypeDefinitionIndex = 36058;
