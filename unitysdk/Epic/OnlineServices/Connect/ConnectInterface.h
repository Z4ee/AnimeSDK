...
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ADDNOTIFYAUTHEXPIRATION_OFFSET UNITYSDK_OFFSET(0x1BBD68F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ADDNOTIFYLOGINSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1BBD6BA0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYIDTOKEN_OFFSET UNITYSDK_OFFSET(0x1BBD6E50)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSEREXTERNALACCOUNTBYACCOUNTID_OFFSET UNITYSDK_OFFSET(0x1BBD70C0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSEREXTERNALACCOUNTBYACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x1BBD72C0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSEREXTERNALACCOUNTBYINDEX_OFFSET UNITYSDK_OFFSET(0x1BBD7550)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSERINFO_OFFSET UNITYSDK_OFFSET(0x1BBD77E0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_CREATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1BBD7A50)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_CREATEUSER_OFFSET UNITYSDK_OFFSET(0x1BBD7CC0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_DELETEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1BBD7F30)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETEXTERNALACCOUNTMAPPING_OFFSET UNITYSDK_OFFSET(0x1BBD81D0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETLOGGEDINUSERBYINDEX_OFFSET UNITYSDK_OFFSET(0x1BBD8330)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETLOGGEDINUSERSCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBD8420)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETLOGINSTATUS_OFFSET UNITYSDK_OFFSET(0x1BBD84A0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETPRODUCTUSEREXTERNALACCOUNTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBD8600)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETPRODUCTUSERIDMAPPING_OFFSET UNITYSDK_OFFSET(0x1BBD8800)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_LINKACCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBD8AB0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_LOGIN_OFFSET UNITYSDK_OFFSET(0x1BBD8C90)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONAUTHEXPIRATIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6150)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONCREATEDEVICEIDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD61F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONCREATEUSERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6290)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONDELETEDEVICEIDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6330)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONLINKACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD63D0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONLOGINCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6470)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONLOGINSTATUSCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6510)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD65B0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6650)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONTRANSFERDEVICEIDACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD66F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONUNLINKACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6790)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONVERIFYIDTOKENCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BBD6830)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_QUERYEXTERNALACCOUNTMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1BBD8E70)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_QUERYPRODUCTUSERIDMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1BBD9050)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_REMOVENOTIFYAUTHEXPIRATION_OFFSET UNITYSDK_OFFSET(0x1BBD9230)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_REMOVENOTIFYLOGINSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1BBD9310)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_TRANSFERDEVICEIDACCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBD93F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_UNLINKACCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBD95D0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_VERIFYIDTOKEN_OFFSET UNITYSDK_OFFSET(0x1BBD9840)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBD68E0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD68D0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int ConnectInterface_TypeDefinitionIndex = 43925;
