...
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE293A0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE293D0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE28EA0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE28E90)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnCreateUserCallback_TypeDefinitionIndex = 34529;
