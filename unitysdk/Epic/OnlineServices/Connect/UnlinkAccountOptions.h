...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1AD815C0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1AD815D0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD815E0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountOptions_TypeDefinitionIndex = 34563;
