...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF24B30)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF24B40)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF24B50)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountOptions_TypeDefinitionIndex = 46190;
