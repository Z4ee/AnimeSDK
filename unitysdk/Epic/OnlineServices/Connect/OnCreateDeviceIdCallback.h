...
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD1870)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD18A0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD1370)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD1360)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnCreateDeviceIdCallback_TypeDefinitionIndex = 34527;
