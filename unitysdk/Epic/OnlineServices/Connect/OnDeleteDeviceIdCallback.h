...
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF20FD0)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF21000)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF20FC0)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF20ED0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnDeleteDeviceIdCallback_TypeDefinitionIndex = 46158;
