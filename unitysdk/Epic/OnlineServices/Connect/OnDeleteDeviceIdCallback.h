...
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DB10)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DB40)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DB00)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19DA10)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnDeleteDeviceIdCallback_TypeDefinitionIndex = 43976;
