...
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x32EC0)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x33040)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x32FD0)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LoginCallbackInfoInternal_TypeDefinitionIndex = 36475;
