...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x34980)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x34850)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x346C0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x34780)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountOptionsInternal_TypeDefinitionIndex = 36519;
