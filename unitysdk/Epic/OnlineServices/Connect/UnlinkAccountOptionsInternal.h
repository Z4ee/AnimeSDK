...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9EBC40)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9EBB10)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9EB980)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9EBA40)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountOptionsInternal_TypeDefinitionIndex = 36786;
