...
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19D9B0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19DA00)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19D9A0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19D930)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnCreateUserCallbackInternal_TypeDefinitionIndex = 43975;
