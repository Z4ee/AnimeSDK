...
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D258C80)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D258CB0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D258780)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D258760)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnQueryProductUserIdMappingsCallback_TypeDefinitionIndex = 36104;
