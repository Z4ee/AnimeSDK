...
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x862A800)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x862A830)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x862A2B0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x862A290)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnQueryProductUserIdMappingsCallback_TypeDefinitionIndex = 36496;
