...
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E5ACC10)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E5ACC40)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AC6F0)
#define EPIC_ONLINESERVICES_CONNECT_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5AC6D0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnQueryProductUserIdMappingsCallback_TypeDefinitionIndex = 36763;
