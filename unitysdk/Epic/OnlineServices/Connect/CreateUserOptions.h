...
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONS_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x1C197C40)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONS_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x1C197C50)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C197C60)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CreateUserOptions_TypeDefinitionIndex = 43942;
