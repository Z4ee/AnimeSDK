...
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9A1860)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B18C0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int DeleteDeviceIdOptionsInternal_TypeDefinitionIndex = 36067;
