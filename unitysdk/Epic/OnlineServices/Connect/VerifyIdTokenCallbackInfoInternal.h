...
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x361CB0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x93A550)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x93A320)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_DEVICETYPE_OFFSET UNITYSDK_OFFSET(0x93A6B0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ISACCOUNTINFOPRESENT_OFFSET UNITYSDK_OFFSET(0x93A4A0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_PLATFORM_OFFSET UNITYSDK_OFFSET(0x93A600)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x93A430)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int VerifyIdTokenCallbackInfoInternal_TypeDefinitionIndex = 36131;
