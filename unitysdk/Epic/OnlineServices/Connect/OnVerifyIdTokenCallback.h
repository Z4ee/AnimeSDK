...
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x862C360)
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x862C390)
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x862BE10)
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x862BDF0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnVerifyIdTokenCallback_TypeDefinitionIndex = 36502;
