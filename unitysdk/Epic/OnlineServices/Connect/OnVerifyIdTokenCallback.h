...
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C81B120)
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C81B150)
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C81AC20)
#define EPIC_ONLINESERVICES_CONNECT_ONVERIFYIDTOKENCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81AC00)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnVerifyIdTokenCallback_TypeDefinitionIndex = 36110;
