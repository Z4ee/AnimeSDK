...
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_GET_LOCALDEVICEUSERID_OFFSET UNITYSDK_OFFSET(0x8E61C90)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_GET_PRIMARYLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8E61C70)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_GET_PRODUCTUSERIDTOPRESERVE_OFFSET UNITYSDK_OFFSET(0x8E61CB0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_SET_LOCALDEVICEUSERID_OFFSET UNITYSDK_OFFSET(0x8E61CA0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_SET_PRIMARYLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8E61C80)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_SET_PRODUCTUSERIDTOPRESERVE_OFFSET UNITYSDK_OFFSET(0x8E61CC0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8E61CD0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int TransferDeviceIdAccountOptions_TypeDefinitionIndex = 42340;
	...
	public:
		...
		::Epic::OnlineServices::ProductUserId* _PrimaryLocalUserId_k__BackingField; // 0x18
		::Epic::OnlineServices::ProductUserId* _ProductUserIdToPreserve_k__BackingField; // 0x20
