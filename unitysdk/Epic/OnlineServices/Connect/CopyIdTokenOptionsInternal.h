...
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x34110)
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x34100)
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x33F70)
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x34030)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CopyIdTokenOptionsInternal_TypeDefinitionIndex = 43066;
