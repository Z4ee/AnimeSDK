...
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83BC1F0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83BC220)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83BBCA0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83BBC80)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int OnIngestStatCompleteCallback_TypeDefinitionIndex = 35389;
