...
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C82A210)
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C82A240)
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C829D10)
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C829CF0)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int OnQueryStatsCompleteCallback_TypeDefinitionIndex = 34999;
