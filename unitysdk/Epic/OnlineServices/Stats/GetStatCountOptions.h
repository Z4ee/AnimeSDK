...
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x83BA270)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x83BA280)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x83BA290)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int GetStatCountOptions_TypeDefinitionIndex = 35381;
