...
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4CAED0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4CAF20)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4CABE0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4CABC0)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int OnIngestStatCompleteCallbackInternal_TypeDefinitionIndex = 34998;
