...
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B9D0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1B950)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B890)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1B940)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1B7D0)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int CopyStatByNameOptionsInternal_TypeDefinitionIndex = 42009;
