...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x5FEA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x60020)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x5FFB0)
...
{
	inline static constexpr unsigned int ReadFileCallbackInfoInternal_TypeDefinitionIndex = 41680;
