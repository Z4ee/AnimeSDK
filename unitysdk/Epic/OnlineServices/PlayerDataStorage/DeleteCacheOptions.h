...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF99AA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF99AB0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF99AC0)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DeleteCacheOptions_TypeDefinitionIndex = 45479;
