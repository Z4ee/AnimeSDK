...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EF66E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EF6730)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EF63F0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF63D0)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnQueryFileCompleteCallbackInternal_TypeDefinitionIndex = 41658;
