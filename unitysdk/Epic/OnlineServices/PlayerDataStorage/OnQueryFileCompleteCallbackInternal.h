...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE30810)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE30860)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE30510)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILECOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE30500)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnQueryFileCompleteCallbackInternal_TypeDefinitionIndex = 33877;
