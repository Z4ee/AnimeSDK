...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DUPLICATEFILECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x676DC0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DUPLICATEFILECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3AB22A0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DUPLICATEFILECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AB23B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DUPLICATEFILECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x167710)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DuplicateFileCallbackInfoInternal_TypeDefinitionIndex = 43304;
