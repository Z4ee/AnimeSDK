...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x906F10)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x907020)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DeleteCacheCallbackInfoInternal_TypeDefinitionIndex = 36073;
