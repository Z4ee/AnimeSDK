...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x5D100)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x5D210)
...
{
	inline static constexpr unsigned int DeleteCacheCallbackInfoInternal_TypeDefinitionIndex = 41632;
