...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILELISTCOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C23D790)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILELISTCOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C23D7E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILELISTCOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C23D780)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONQUERYFILELISTCOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23D710)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnQueryFileListCompleteCallbackInternal_TypeDefinitionIndex = 43324;
