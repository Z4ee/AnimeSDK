...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1C823A70)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1C823A30)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C823A50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1C823A10)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1C823C20)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1C823A40)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C823A60)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1C823A90)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1C823A20)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C823E40)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DeleteFileCallbackInfo_TypeDefinitionIndex = 35417;
