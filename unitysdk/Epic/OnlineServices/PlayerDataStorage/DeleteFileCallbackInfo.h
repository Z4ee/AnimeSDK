...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x86BD040)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x86BD000)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x86BD020)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x86BCFE0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x86BD440)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x86BD010)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x86BD030)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x86BD060)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x86BCFF0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETEFILECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x86BD550)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DeleteFileCallbackInfo_TypeDefinitionIndex = 35809;
