...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C48890)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C48880)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C486F0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C487B0)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DeleteCacheOptionsInternal_TypeDefinitionIndex = 45480;
