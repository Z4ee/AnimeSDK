...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3AB1D40)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AB1D30)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AB1BA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_DELETECACHEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AB1C60)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int DeleteCacheOptionsInternal_TypeDefinitionIndex = 43298;
