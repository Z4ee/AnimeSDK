...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FA5A40)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FA5A90)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FA5740)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA5730)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnFileTransferProgressCallbackInternal_TypeDefinitionIndex = 33875;
