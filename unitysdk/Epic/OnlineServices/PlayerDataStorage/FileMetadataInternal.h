...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5E4B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x5E1C0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1DA80)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x5E320)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x5E060)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1CCB0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5E440)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x5E270)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x5E3A0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x5E110)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x5E430)
...
{
	inline static constexpr unsigned int FileMetadataInternal_TypeDefinitionIndex = 41644;
