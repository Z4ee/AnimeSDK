...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILEDATACALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D19C510)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILEDATACALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D19C550)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILEDATACALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D19BF80)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILEDATACALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19BF60)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnWriteFileDataCallback_TypeDefinitionIndex = 35449;
