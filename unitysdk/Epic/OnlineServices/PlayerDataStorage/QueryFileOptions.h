...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_QUERYFILEOPTIONS_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1ADE7E50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_QUERYFILEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1ADE7E30)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_QUERYFILEOPTIONS_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1ADE7E60)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_QUERYFILEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1ADE7E40)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_QUERYFILEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE7E70)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int QueryFileOptions_TypeDefinitionIndex = 35459;
