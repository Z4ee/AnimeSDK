...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C1670)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_GET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1DBD7990)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_GET_WRITEFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x1DBD7900)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9C1600)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_SET_CHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x36CDA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x9C1540)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9C1480)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9C15F0)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int WriteFileOptionsInternal_TypeDefinitionIndex = 36132;
	...
	struct alignas(8) WriteFileOptionsInternal
	{
		...
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnWriteFileDataCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(WriteFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x29D20);
		}
		...
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnFileTransferProgressCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(WriteFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x29D28);
		}
