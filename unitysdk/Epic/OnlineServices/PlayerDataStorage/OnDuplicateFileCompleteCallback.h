...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDUPLICATEFILECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B613DA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDUPLICATEFILECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B613DD0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDUPLICATEFILECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6138A0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDUPLICATEFILECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B613880)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnDuplicateFileCompleteCallback_TypeDefinitionIndex = 35435;
