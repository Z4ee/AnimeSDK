...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9ACA50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_GET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1CBD6DE0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_GET_READFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x1CBD6D50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9AC9E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x9AC920)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9AC860)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9AC9D0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_READCHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x2C1270)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int ReadFileOptionsInternal_TypeDefinitionIndex = 35466;
	...
	struct alignas(8) ReadFileOptionsInternal
	{
		...
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnFileTransferProgressCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(ReadFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x284F0);
		}
		static ::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallbackInternal** StaticGet_s_ReadFileDataCallback()
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(ReadFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x284F8);
		}
