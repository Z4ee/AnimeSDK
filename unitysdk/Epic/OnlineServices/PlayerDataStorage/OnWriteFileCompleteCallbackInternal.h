...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILECOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD79BD0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILECOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD79C20)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILECOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD79BC0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONWRITEFILECOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD79B50)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnWriteFileCompleteCallbackInternal_TypeDefinitionIndex = 45512;
