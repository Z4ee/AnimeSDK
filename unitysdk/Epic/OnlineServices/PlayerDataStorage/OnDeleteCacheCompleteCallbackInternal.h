...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETECACHECOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198AF520)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETECACHECOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198AF570)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETECACHECOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x198AF220)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETECACHECOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x198AF210)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnDeleteCacheCompleteCallbackInternal_TypeDefinitionIndex = 33869;
