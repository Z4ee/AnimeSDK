...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_CHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x1D25D810)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1D25D7F0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D25D850)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D25D7D0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_WRITEFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x1D25D830)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_CHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x1D25D820)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1D25D800)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D25D860)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D25D7E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_WRITEFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x1D25D840)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25D870)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int WriteFileOptions_TypeDefinitionIndex = 35472;

	class WriteFileOptions : public ::System::Object
	{
	public:
		::Epic::OnlineServices::PlayerDataStorage::OnWriteFileDataCallback* _WriteFileDataCallback_k__BackingField; // 0x10
