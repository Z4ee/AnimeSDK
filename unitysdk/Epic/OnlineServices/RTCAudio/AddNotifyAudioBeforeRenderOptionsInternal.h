...
#define EPIC_ONLINESERVICES_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x914C00)
#define EPIC_ONLINESERVICES_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x914B90)
#define EPIC_ONLINESERVICES_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x914960)
#define EPIC_ONLINESERVICES_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x914B80)
#define EPIC_ONLINESERVICES_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDEROPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x914A20)
#define EPIC_ONLINESERVICES_RTCAUDIO_ADDNOTIFYAUDIOBEFORERENDEROPTIONSINTERNAL_SET_UNMIXEDAUDIO_OFFSET UNITYSDK_OFFSET(0x914AD0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int AddNotifyAudioBeforeRenderOptionsInternal_TypeDefinitionIndex = 33637;
