...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86F7B50)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86F7BA0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x86F7860)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x86F7840)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallbackInternal_TypeDefinitionIndex = 35642;
