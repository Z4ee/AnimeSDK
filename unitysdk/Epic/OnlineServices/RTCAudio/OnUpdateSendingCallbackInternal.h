...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8F2B3D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8F2B420)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F2B0E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8F2B0C0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallbackInternal_TypeDefinitionIndex = 41468;
