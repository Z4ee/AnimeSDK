...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF06000)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF06050)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF05D10)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF05CF0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallbackInternal_TypeDefinitionIndex = 35250;
