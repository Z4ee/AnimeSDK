...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2777E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D277830)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2774D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2774B0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallbackInternal_TypeDefinitionIndex = 35909;
