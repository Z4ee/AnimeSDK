...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD9360)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD9390)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD8E40)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBD8E20)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeRenderCallback_TypeDefinitionIndex = 35894;
