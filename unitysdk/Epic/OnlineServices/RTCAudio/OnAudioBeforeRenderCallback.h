...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C720530)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C720560)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C720030)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C720010)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeRenderCallback_TypeDefinitionIndex = 35235;
