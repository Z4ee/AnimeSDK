...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIODEVICESCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86F4A60)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIODEVICESCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86F4A90)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIODEVICESCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86F4510)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIODEVICESCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86F44F0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioDevicesChangedCallback_TypeDefinitionIndex = 35631;
