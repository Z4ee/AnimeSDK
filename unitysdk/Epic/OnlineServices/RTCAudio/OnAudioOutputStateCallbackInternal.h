...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BFB7380)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BFB73D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BFB7090)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFB7070)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioOutputStateCallbackInternal_TypeDefinitionIndex = 35244;
