...
#define EPIC_ONLINESERVICES_RTCAUDIO_GETAUDIOINPUTDEVICEBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6D590)
...
{
	inline static constexpr unsigned int GetAudioInputDeviceByIndexOptionsInternal_TypeDefinitionIndex = 41446;
