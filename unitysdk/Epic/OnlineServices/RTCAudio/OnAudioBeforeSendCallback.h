...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4BC00)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4BC30)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4BBF0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE4BB00)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeSendCallback_TypeDefinitionIndex = 45301;
