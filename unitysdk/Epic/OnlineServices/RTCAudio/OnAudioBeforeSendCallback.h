...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0B6490)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0B64C0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0B6480)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0B6390)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeSendCallback_TypeDefinitionIndex = 43119;
