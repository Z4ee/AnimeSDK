...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4BCC0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4BD10)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4BCB0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORESENDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE4BC40)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeSendCallbackInternal_TypeDefinitionIndex = 45302;
