...
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6F7D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6F760)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_AUDIOSTATUS_OFFSET UNITYSDK_OFFSET(0xBC50)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x6F5E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6F750)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6F6A0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int UpdateSendingOptionsInternal_TypeDefinitionIndex = 35666;
