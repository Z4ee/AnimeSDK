...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4C760)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4C7B0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DE4C750)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE4C6E0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateReceivingCallbackInternal_TypeDefinitionIndex = 45312;
