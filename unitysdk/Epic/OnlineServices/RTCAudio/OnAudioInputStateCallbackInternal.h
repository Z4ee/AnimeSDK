...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A32130)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A32180)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A31E30)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19A31E20)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioInputStateCallbackInternal_TypeDefinitionIndex = 33679;
