...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA34BF00)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA34BF30)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA34BEF0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOINPUTSTATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA34BE00)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioInputStateCallback_TypeDefinitionIndex = 42262;
