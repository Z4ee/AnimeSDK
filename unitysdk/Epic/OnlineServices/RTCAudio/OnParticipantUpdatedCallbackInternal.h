...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D835BB0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D835C00)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D8358A0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D835880)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnParticipantUpdatedCallbackInternal_TypeDefinitionIndex = 35905;
