...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC45C60)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC45C90)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC45740)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC45720)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallback_TypeDefinitionIndex = 35908;
