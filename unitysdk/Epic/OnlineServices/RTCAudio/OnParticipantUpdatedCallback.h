...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEA290)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEA2C0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE9D90)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONPARTICIPANTUPDATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE9D70)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnParticipantUpdatedCallback_TypeDefinitionIndex = 35245;
