...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF05CB0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF05CE0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF057B0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF05790)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateReceivingCallback_TypeDefinitionIndex = 35247;
