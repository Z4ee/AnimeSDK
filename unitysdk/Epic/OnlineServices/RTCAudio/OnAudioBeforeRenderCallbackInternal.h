...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BE0F0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BE140)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BDE00)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BDDE0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeRenderCallbackInternal_TypeDefinitionIndex = 35236;
