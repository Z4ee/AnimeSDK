...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8F273F0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8F27440)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F27100)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8F270E0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeRenderCallbackInternal_TypeDefinitionIndex = 41454;
