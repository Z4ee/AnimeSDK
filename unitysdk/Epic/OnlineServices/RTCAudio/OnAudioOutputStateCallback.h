...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9DDAA0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9DDAD0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9DD5A0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOOUTPUTSTATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9DD590)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioOutputStateCallback_TypeDefinitionIndex = 33680;
