...
#define EPIC_ONLINESERVICES_ALLOCATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x837CA00)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int AllocationException_TypeDefinitionIndex = 35236;
