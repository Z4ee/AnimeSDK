...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS_GET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1A80EF00)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS_SET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1A80EF10)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80EF20)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetRawRichTextOptions_TypeDefinitionIndex = 33831;
