...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS_GET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x8F0A1F0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS_SET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x8F0A200)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0A210)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetRawRichTextOptions_TypeDefinitionIndex = 41612;
