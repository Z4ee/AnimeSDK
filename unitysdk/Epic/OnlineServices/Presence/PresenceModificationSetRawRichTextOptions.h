...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS_GET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1DF5DEA0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS_SET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x1DF5DEB0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5DEC0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetRawRichTextOptions_TypeDefinitionIndex = 36053;
