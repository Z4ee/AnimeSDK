...
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E1ADD10)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1E1ADD30)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E1ADD20)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1E1ADD40)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1ADD50)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int GetJoinInfoOptions_TypeDefinitionIndex = 36027;
