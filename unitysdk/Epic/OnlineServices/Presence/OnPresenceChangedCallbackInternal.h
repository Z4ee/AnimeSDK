...
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BAFB0)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BB000)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BACC0)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BACA0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int OnPresenceChangedCallbackInternal_TypeDefinitionIndex = 35379;
