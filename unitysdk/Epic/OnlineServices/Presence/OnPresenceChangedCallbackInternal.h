...
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86D2590)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86D25E0)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x86D22A0)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x86D2280)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int OnPresenceChangedCallbackInternal_TypeDefinitionIndex = 35771;
