...
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19423DD0)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19423E20)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19423AD0)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19423AC0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int OnPresenceChangedCallbackInternal_TypeDefinitionIndex = 33816;
