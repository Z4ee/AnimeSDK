...
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8F05E00)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8F05E50)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F05B10)
#define EPIC_ONLINESERVICES_PRESENCE_ONPRESENCECHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8F05AF0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int OnPresenceChangedCallbackInternal_TypeDefinitionIndex = 41597;
