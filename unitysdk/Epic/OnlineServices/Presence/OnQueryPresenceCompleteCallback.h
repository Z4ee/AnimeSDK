...
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD85B50)
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD85B80)
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD85B40)
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD85A50)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int OnQueryPresenceCompleteCallback_TypeDefinitionIndex = 45444;
