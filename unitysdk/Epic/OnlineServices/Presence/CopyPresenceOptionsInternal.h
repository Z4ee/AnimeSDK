...
#define EPIC_ONLINESERVICES_PRESENCE_COPYPRESENCEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x66AA0)
#define EPIC_ONLINESERVICES_PRESENCE_COPYPRESENCEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x66A20)
#define EPIC_ONLINESERVICES_PRESENCE_COPYPRESENCEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x66890)
#define EPIC_ONLINESERVICES_PRESENCE_COPYPRESENCEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x66A10)
#define EPIC_ONLINESERVICES_PRESENCE_COPYPRESENCEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x66950)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int CopyPresenceOptionsInternal_TypeDefinitionIndex = 42384;
