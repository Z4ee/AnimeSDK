...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONS_GET_RECORDS_OFFSET UNITYSDK_OFFSET(0x1C8256D0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONS_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x1C8256E0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8256F0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetDataOptions_TypeDefinitionIndex = 35390;
