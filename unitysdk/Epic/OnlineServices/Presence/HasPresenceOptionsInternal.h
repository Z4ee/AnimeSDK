...
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C0FD80)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C0FD00)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C0FB70)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C0FCF0)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x3C0FC30)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int HasPresenceOptionsInternal_TypeDefinitionIndex = 45435;
