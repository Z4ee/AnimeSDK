...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C11890)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C11880)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C117F0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x3C11780)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationDeleteDataOptionsInternal_TypeDefinitionIndex = 45453;
