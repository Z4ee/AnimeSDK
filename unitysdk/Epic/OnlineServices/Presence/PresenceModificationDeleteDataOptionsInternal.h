...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x964540)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x964530)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9644A0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x964430)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationDeleteDataOptionsInternal_TypeDefinitionIndex = 35389;
