...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BF280)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BF270)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BF1E0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONSINTERNAL_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x8BF170)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationDeleteDataOptionsInternal_TypeDefinitionIndex = 33826;
