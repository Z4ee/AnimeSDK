...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1DBD8080)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1DBD8090)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBD80A0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetStatusOptions_TypeDefinitionIndex = 36055;
