...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x86D6D00)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x86D6D10)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x86D6D20)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetStatusOptions_TypeDefinitionIndex = 35788;
