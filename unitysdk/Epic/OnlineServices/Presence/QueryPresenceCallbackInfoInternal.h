...
#define EPIC_ONLINESERVICES_PRESENCE_QUERYPRESENCECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x639A0)
#define EPIC_ONLINESERVICES_PRESENCE_QUERYPRESENCECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x63AB0)
#define EPIC_ONLINESERVICES_PRESENCE_QUERYPRESENCECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_PRESENCE_QUERYPRESENCECALLBACKINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x63B20)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int QueryPresenceCallbackInfoInternal_TypeDefinitionIndex = 35791;
