...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D19CE40)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D19CE70)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D19C940)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19C920)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceCompleteCallback_TypeDefinitionIndex = 35404;
