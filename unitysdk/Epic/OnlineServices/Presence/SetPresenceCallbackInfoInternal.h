...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8B5F70)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8B6080)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceCallbackInfoInternal_TypeDefinitionIndex = 35403;
