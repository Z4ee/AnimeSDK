...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x907090)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9071A0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceCallbackInfoInternal_TypeDefinitionIndex = 36062;
