...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_GET_JOININFO_OFFSET UNITYSDK_OFFSET(0x86D6600)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_SET_JOININFO_OFFSET UNITYSDK_OFFSET(0x86D6610)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x86D6620)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetJoinInfoOptions_TypeDefinitionIndex = 35784;
