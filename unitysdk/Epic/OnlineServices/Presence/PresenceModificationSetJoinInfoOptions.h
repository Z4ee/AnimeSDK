...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_GET_JOININFO_OFFSET UNITYSDK_OFFSET(0x1D2750C0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_SET_JOININFO_OFFSET UNITYSDK_OFFSET(0x1D2750D0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2750E0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetJoinInfoOptions_TypeDefinitionIndex = 36051;
