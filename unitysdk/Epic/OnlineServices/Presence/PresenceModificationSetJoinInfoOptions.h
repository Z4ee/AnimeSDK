...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_GET_JOININFO_OFFSET UNITYSDK_OFFSET(0x19A303A0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_SET_JOININFO_OFFSET UNITYSDK_OFFSET(0x19A303B0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A303C0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetJoinInfoOptions_TypeDefinitionIndex = 33829;
