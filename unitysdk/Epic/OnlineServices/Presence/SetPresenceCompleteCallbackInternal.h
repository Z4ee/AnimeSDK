...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7BDA0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7BDF0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF7BA90)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF7BA70)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceCompleteCallbackInternal_TypeDefinitionIndex = 36064;
