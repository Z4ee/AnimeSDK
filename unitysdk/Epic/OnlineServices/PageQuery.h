...
#define EPIC_ONLINESERVICES_PAGEQUERY_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC59890)
#define EPIC_ONLINESERVICES_PAGEQUERY_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x1CC59870)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_1_OFFSET UNITYSDK_OFFSET(0x1CC59930)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1CC598A0)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_OFFSET UNITYSDK_OFFSET(0x1CC598B0)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x1CC59880)
#define EPIC_ONLINESERVICES_PAGEQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC59A80)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int PageQuery_TypeDefinitionIndex = 34868;
