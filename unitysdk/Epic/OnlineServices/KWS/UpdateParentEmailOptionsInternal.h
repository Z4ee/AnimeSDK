...
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA23720)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA236B0)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA23530)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA236A0)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0xA235F0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int UpdateParentEmailOptionsInternal_TypeDefinitionIndex = 36536;
