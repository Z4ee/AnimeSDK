...
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D694B40)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D694B70)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D6941F0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D694A50)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnRequestPermissionsCallback_TypeDefinitionIndex = 45918;
