...
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86619C0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86619F0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8660040)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86619A0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnRequestPermissionsCallback_TypeDefinitionIndex = 36246;
