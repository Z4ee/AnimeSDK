...
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B0ED0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9B0E60)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_KEY_OFFSET UNITYSDK_OFFSET(0x9B0DA0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9B0CE0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9B0E50)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int GetPermissionByKeyOptionsInternal_TypeDefinitionIndex = 35841;
