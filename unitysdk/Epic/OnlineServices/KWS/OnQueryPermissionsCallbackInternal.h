...
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2D1A60)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2D1AB0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2D1A50)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2D19E0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryPermissionsCallbackInternal_TypeDefinitionIndex = 42874;
