...
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAB7240)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAB7290)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAB7230)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAB71C0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryPermissionsCallbackInternal_TypeDefinitionIndex = 43735;
