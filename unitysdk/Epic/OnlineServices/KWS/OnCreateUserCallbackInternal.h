...
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B60CC60)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B60CCB0)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C970)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60C950)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnCreateUserCallbackInternal_TypeDefinitionIndex = 35847;
