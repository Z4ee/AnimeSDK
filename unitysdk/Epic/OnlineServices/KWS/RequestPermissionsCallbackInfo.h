...
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xA2D4050)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA2D4010)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA2D4030)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xA2D3FF0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xA2D4450)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA2D4020)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA2D4040)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xA2D4070)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xA2D4000)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA2D4570)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int RequestPermissionsCallbackInfo_TypeDefinitionIndex = 42891;
