...
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B60CFD0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B60D020)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B60CCE0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60CCC0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnRequestPermissionsCallbackInternal_TypeDefinitionIndex = 35855;
