...
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E95560)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E955B0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E95270)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8E92170)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnRequestPermissionsCallbackInternal_TypeDefinitionIndex = 42073;
