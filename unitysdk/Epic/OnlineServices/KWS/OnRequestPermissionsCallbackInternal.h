...
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9C7D10)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9C7D60)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9C7A00)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9C79E0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnRequestPermissionsCallbackInternal_TypeDefinitionIndex = 36514;
