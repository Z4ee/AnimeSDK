...
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD73C0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD73F0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD6EB0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD73B0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryPermissionsCallback_TypeDefinitionIndex = 34289;
