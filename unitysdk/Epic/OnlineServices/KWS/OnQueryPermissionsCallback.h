...
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8661610)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8661640)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x865FAF0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86615F0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryPermissionsCallback_TypeDefinitionIndex = 36244;
