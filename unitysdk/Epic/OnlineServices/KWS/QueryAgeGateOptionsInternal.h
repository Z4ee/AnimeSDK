...
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x962170)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B18C0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryAgeGateOptionsInternal_TypeDefinitionIndex = 35865;
