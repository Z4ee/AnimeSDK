...
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AA430)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9AA3C0)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_DATEOFBIRTH_OFFSET UNITYSDK_OFFSET(0x9AA250)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9AA190)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9AA3B0)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x9AA300)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int CreateUserOptionsInternal_TypeDefinitionIndex = 35839;
