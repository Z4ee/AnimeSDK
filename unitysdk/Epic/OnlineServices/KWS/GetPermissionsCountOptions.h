...
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1AE2C000)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1AE2C010)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2C020)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int GetPermissionsCountOptions_TypeDefinitionIndex = 34279;
