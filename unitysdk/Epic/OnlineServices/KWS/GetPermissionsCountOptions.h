...
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D2756C0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D2756D0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2756E0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int GetPermissionsCountOptions_TypeDefinitionIndex = 35842;
