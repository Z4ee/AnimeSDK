...
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x45C40)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x45C30)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x45AA0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x45B60)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int GetPermissionsCountOptionsInternal_TypeDefinitionIndex = 42864;
