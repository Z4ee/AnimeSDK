...
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_AGEOFCONSENT_OFFSET UNITYSDK_OFFSET(0x7A7FB0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x676DC0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3A4BDC0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_COUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x3A4BDD0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x167710)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryAgeGateCallbackInfoInternal_TypeDefinitionIndex = 43745;
