...
#define EPIC_ONLINESERVICES_KWS_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E94A50)
#define EPIC_ONLINESERVICES_KWS_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E94AA0)
#define EPIC_ONLINESERVICES_KWS_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E94760)
#define EPIC_ONLINESERVICES_KWS_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8E911E0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnPermissionsUpdateReceivedCallbackInternal_TypeDefinitionIndex = 42067;
