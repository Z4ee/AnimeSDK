...
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3AB3CD0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AB3C50)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AB3A60)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AB3C40)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_PERMISSIONKEYS_OFFSET UNITYSDK_OFFSET(0x3AB3B20)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int RequestPermissionsOptionsInternal_TypeDefinitionIndex = 43755;
