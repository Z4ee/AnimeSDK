...
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ADDNOTIFYPERMISSIONSUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0xB372C60)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_COPYPERMISSIONBYINDEX_OFFSET UNITYSDK_OFFSET(0xB372F10)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_CREATEUSER_OFFSET UNITYSDK_OFFSET(0xB3731A0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_GETPERMISSIONBYKEY_OFFSET UNITYSDK_OFFSET(0xB373380)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_GETPERMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0xB3734F0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONCREATEUSERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB372880)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB372920)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONQUERYAGEGATECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB3729C0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONQUERYPERMISSIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB372A60)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONREQUESTPERMISSIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB372B00)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONUPDATEPARENTEMAILCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB372BA0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_QUERYAGEGATE_OFFSET UNITYSDK_OFFSET(0xB3736E0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_QUERYPERMISSIONS_OFFSET UNITYSDK_OFFSET(0xB373980)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_REMOVENOTIFYPERMISSIONSUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0xB373BF0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_REQUESTPERMISSIONS_OFFSET UNITYSDK_OFFSET(0xB373CD0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_UPDATEPARENTEMAIL_OFFSET UNITYSDK_OFFSET(0xB373EB0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB372C50)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xB372C40)
