...
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF51170)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF511A0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF50C50)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF50C30)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryAgeGateCallback_TypeDefinitionIndex = 36509;
