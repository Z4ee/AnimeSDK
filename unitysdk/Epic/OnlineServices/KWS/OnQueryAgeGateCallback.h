...
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E94AD0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E94B00)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E92E10)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8E94AB0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryAgeGateCallback_TypeDefinitionIndex = 42068;
