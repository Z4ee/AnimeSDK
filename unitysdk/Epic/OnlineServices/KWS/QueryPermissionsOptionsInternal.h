...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C4A380)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C4A370)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C4A1E0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C4A2A0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryPermissionsOptionsInternal_TypeDefinitionIndex = 45933;
	...
	struct alignas(8) QueryPermissionsOptionsInternal
	{
		...
		::System::Void Dispose()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET))(this);
		}
	};
}
