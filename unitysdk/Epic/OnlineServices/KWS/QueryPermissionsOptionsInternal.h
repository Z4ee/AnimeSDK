...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA23480)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA23350)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA231C0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA23280)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryPermissionsOptionsInternal_TypeDefinitionIndex = 36528;
