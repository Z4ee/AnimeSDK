...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x60D0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x46CE0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_DATEOFBIRTH_OFFSET UNITYSDK_OFFSET(0x46F10)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_ISMINOR_OFFSET UNITYSDK_OFFSET(0x46FC0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_KWSUSERID_OFFSET UNITYSDK_OFFSET(0x46E60)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x46DF0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5FB0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryPermissionsCallbackInfoInternal_TypeDefinitionIndex = 42888;
