...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AF0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x41A40)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_DATEOFBIRTH_OFFSET UNITYSDK_OFFSET(0x41C70)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_ISMINOR_OFFSET UNITYSDK_OFFSET(0x41D20)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_KWSUSERID_OFFSET UNITYSDK_OFFSET(0x41BC0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x41B50)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryPermissionsCallbackInfoInternal_TypeDefinitionIndex = 36259;
