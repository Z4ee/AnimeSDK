...
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8662100)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x8662120)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_1_OFFSET UNITYSDK_OFFSET(0x86623A0)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_NAME_OFFSET UNITYSDK_OFFSET(0x8662110)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_OFFSET UNITYSDK_OFFSET(0x8662140)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x8662130)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x86624B0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int PermissionStatus_TypeDefinitionIndex = 36250;
