...
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB374D50)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xB374D70)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_1_OFFSET UNITYSDK_OFFSET(0xB374FF0)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_NAME_OFFSET UNITYSDK_OFFSET(0xB374D60)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_OFFSET UNITYSDK_OFFSET(0xB374D90)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xB374D80)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0xB375110)
