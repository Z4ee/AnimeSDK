...
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D6947E0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D694830)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D6947D0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D694760)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryAgeGateCallbackInternal_TypeDefinitionIndex = 45915;
