...
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2D1850)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2D18A0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2D1840)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2D17D0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryAgeGateCallbackInternal_TypeDefinitionIndex = 42872;
