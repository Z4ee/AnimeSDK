...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x57980)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x6EE0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x57A30)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageInternal_TypeDefinitionIndex = 42610;
