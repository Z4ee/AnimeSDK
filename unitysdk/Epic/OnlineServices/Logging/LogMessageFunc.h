...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7C820)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7C850)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7C320)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA7C310)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFunc_TypeDefinitionIndex = 34027;
