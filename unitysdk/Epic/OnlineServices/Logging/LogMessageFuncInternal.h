...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8699510)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8699560)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8699220)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8699200)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFuncInternal_TypeDefinitionIndex = 35983;
