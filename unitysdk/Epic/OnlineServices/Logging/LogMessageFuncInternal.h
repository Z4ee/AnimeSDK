...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8ECCD80)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8ECCDD0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8ECCA90)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECCA70)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFuncInternal_TypeDefinitionIndex = 41809;
