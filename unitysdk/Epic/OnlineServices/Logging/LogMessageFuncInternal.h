...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CBD1220)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CBD1270)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CBD0F30)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBD0F10)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFuncInternal_TypeDefinitionIndex = 35591;
