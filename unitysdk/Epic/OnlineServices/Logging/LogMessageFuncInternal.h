...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF73810)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF73860)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF73500)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNCINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF734E0)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFuncInternal_TypeDefinitionIndex = 36250;
