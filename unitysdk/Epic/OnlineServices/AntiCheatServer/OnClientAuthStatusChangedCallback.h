...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5358A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5358D0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C5353A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C535380)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientAuthStatusChangedCallback_TypeDefinitionIndex = 36222;
