...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS_GET_DATALENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x1ADE6DB0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS_SET_DATALENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x1ADE6DC0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE6DD0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int GetProtectMessageOutputLengthOptions_TypeDefinitionIndex = 34655;
