...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_RECEIVEMESSAGEFROMCLIENTOPTIONS_GET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x1D2706B0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_RECEIVEMESSAGEFROMCLIENTOPTIONS_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1D2706D0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_RECEIVEMESSAGEFROMCLIENTOPTIONS_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x1D2706C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_RECEIVEMESSAGEFROMCLIENTOPTIONS_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1D2706E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_RECEIVEMESSAGEFROMCLIENTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2706F0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int ReceiveMessageFromClientOptions_TypeDefinitionIndex = 36228;
