...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ENDSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xE2A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ENDSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1900)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int EndSessionOptionsInternal_TypeDefinitionIndex = 36609;
