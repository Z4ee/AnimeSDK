...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1989FFD0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198A0000)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1989FAD0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1989FAC0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnMessageToClientCallback_TypeDefinitionIndex = 34661;
