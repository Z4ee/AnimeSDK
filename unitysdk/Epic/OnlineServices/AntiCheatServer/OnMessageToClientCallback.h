...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8393F10)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8393F40)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83929E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8393EF0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnMessageToClientCallback_TypeDefinitionIndex = 36616;
