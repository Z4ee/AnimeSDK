...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9BEF90)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9BEFC0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9BEA70)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9BEA50)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnMessageToClientCallback_TypeDefinitionIndex = 36883;
