...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B604280)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6042B0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B603D80)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONMESSAGETOCLIENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B603D60)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnMessageToClientCallback_TypeDefinitionIndex = 36224;
