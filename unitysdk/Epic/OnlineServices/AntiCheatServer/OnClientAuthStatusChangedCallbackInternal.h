...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC30F50)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC30FA0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC30C40)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC30C20)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientAuthStatusChangedCallbackInternal_TypeDefinitionIndex = 36882;
