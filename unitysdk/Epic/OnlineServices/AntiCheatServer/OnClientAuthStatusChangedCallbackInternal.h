...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BBBE90)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BBBEE0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BBBBA0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8BB7340)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientAuthStatusChangedCallbackInternal_TypeDefinitionIndex = 42441;
