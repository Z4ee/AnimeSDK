...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA0D35C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0D35F0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0D2C30)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA0D34D0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientActionRequiredCallback_TypeDefinitionIndex = 43241;
