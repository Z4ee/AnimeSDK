...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C00C700)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C00C730)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C00C6F0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C00C600)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int OnDeleteSnapshotCallback_TypeDefinitionIndex = 43231;
