...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ENDSNAPSHOTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x64EE0)
...
{
	inline static constexpr unsigned int EndSnapshotOptionsInternal_TypeDefinitionIndex = 35740;
