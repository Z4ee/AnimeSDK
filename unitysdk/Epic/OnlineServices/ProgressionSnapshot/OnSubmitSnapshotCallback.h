...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BC000)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BC030)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7BBB00)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BBAE0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int OnSubmitSnapshotCallback_TypeDefinitionIndex = 35351;
