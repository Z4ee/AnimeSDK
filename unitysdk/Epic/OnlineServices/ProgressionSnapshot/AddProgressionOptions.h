...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AE32000)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_SNAPSHOTID_OFFSET UNITYSDK_OFFSET(0x1AE31FE0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AE32020)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1AE32010)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_SNAPSHOTID_OFFSET UNITYSDK_OFFSET(0x1AE31FF0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AE32030)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE32040)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int AddProgressionOptions_TypeDefinitionIndex = 33776;
