...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1D27B6E0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_SNAPSHOTID_OFFSET UNITYSDK_OFFSET(0x1D27B6C0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D27B700)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1D27B6F0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_SNAPSHOTID_OFFSET UNITYSDK_OFFSET(0x1D27B6D0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D27B710)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27B720)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int AddProgressionOptions_TypeDefinitionIndex = 35339;
