...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_DELETESNAPSHOTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A9D9D20)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_DELETESNAPSHOTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A9D9D30)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_DELETESNAPSHOTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9D9D40)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int DeleteSnapshotOptions_TypeDefinitionIndex = 33782;
