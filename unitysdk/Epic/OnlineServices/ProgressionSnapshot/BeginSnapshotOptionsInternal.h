...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A7CDD0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A7CDC0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A7CC30)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A7CCF0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int BeginSnapshotOptionsInternal_TypeDefinitionIndex = 43224;
