...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C12EA0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C12E90)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C12D00)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C12DC0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int BeginSnapshotOptionsInternal_TypeDefinitionIndex = 45406;
