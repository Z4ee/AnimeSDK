...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E5B1EA0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E5B1EB0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_BEGINSNAPSHOTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5B1EC0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int BeginSnapshotOptions_TypeDefinitionIndex = 36000;
