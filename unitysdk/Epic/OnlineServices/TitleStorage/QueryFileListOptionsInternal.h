...
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E970)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1E900)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_LISTOFTAGS_OFFSET UNITYSDK_OFFSET(0x1E880)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1E7C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1E8F0)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int QueryFileListOptionsInternal_TypeDefinitionIndex = 35365;
