...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA0FBFF0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0FC040)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0FBFE0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FBF70)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int OnReadFileDataCallbackInternal_TypeDefinitionIndex = 41988;
