...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DFF8840)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DFF8870)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFF8320)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFF8300)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int OnReadFileCompleteCallback_TypeDefinitionIndex = 35623;
