...
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DDD0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1DBF0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1DA80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x1DA90)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x5E00)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1DD60)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1DCA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D50)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x1DB40)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1DD50)
...
{
	inline static constexpr unsigned int FileMetadataInternal_TypeDefinitionIndex = 41169;
