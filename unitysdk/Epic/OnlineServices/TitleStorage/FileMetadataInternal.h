...
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x906060)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x905E80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x3A4E50)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x905D20)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x319030)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x905FF0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x905F30)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x5B6810)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x905DD0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x905FE0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x319040)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int FileMetadataInternal_TypeDefinitionIndex = 33388;
