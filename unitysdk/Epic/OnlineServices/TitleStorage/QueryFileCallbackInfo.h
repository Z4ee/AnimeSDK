...
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x83C58C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x83C5880)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83C58A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x83C5860)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x83C5CC0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x83C5890)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83C58B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x83C58E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x83C5870)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x83C5DD0)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int QueryFileCallbackInfo_TypeDefinitionIndex = 35360;
