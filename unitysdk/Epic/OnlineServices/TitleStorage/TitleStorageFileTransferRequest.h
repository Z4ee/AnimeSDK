...
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_CANCELREQUEST_OFFSET UNITYSDK_OFFSET(0x8BF0AB0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_GETFILENAME_OFFSET UNITYSDK_OFFSET(0x8BF0BB0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_GETFILEREQUESTSTATE_OFFSET UNITYSDK_OFFSET(0x8BF0B30)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_RELEASE_OFFSET UNITYSDK_OFFSET(0x8BF0DE0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8BF0AA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x8BF0A90)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int TitleStorageFileTransferRequest_TypeDefinitionIndex = 41201;
