...
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1B7DC210)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1B7DC1D0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x1B7DC1F0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1B7DC230)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_SET_1_OFFSET UNITYSDK_OFFSET(0x1B7DC6A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1B7DC220)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1B7DC1E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x1B7DC200)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_SET_OFFSET UNITYSDK_OFFSET(0x1B7DC250)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA_SET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1B7DC240)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DC7D0)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int FileMetadata_TypeDefinitionIndex = 42832;
