...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONDELETECACHECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB3B40)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONDELETECACHECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB3B70)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONDELETECACHECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB3620)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONDELETECACHECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB3600)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int OnDeleteCacheCompleteCallback_TypeDefinitionIndex = 35615;
