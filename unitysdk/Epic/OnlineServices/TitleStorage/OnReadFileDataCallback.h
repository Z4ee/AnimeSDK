...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A875E70)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A875EA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A875930)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A875920)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int OnReadFileDataCallback_TypeDefinitionIndex = 33403;
