...
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EC80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1EC10)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1EB50)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1EA90)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1EC00)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int QueryFileOptionsInternal_TypeDefinitionIndex = 41193;
