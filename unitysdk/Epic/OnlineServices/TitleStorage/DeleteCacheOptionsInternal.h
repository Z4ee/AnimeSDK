...
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E060)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1E050)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DEC0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1DF80)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int DeleteCacheOptionsInternal_TypeDefinitionIndex = 41970;
