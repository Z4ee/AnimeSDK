...
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1BAAFC90)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1BAAFCA0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAAFCB0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int QueryFriendsOptions_TypeDefinitionIndex = 43788;
