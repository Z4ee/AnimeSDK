...
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA2CA3E0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA2CA3F0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xA2CA400)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int QueryFriendsOptions_TypeDefinitionIndex = 42927;
