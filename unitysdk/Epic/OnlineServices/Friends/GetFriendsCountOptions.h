...
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1BAADD40)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1BAADD50)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAADD60)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int GetFriendsCountOptions_TypeDefinitionIndex = 43770;
