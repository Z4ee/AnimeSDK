...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x246290)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x94A5D0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x361CB0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x94A5E0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_PREVIOUSSTATUS_OFFSET UNITYSDK_OFFSET(0x2C1260)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x94A650)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateInfoInternal_TypeDefinitionIndex = 35897;
