...
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAAF330)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAAF380)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAAF320)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAAF2B0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnQueryFriendsCallbackInternal_TypeDefinitionIndex = 43781;
