...
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ACCEPTINVITE_OFFSET UNITYSDK_OFFSET(0xB369C20)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ADDNOTIFYFRIENDSUPDATE_OFFSET UNITYSDK_OFFSET(0xB369E00)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETFRIENDATINDEX_OFFSET UNITYSDK_OFFSET(0xB36A210)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETFRIENDSCOUNT_OFFSET UNITYSDK_OFFSET(0xB36A420)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0xB36A610)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONACCEPTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB3698E0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONFRIENDSUPDATECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB369980)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONQUERYFRIENDSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB369A20)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONREJECTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB369AC0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONSENDINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xB369B60)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_QUERYFRIENDS_OFFSET UNITYSDK_OFFSET(0xB36A770)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_REJECTINVITE_OFFSET UNITYSDK_OFFSET(0xB36A9D0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_REMOVENOTIFYFRIENDSUPDATE_OFFSET UNITYSDK_OFFSET(0xB36ABB0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_SENDINVITE_OFFSET UNITYSDK_OFFSET(0xB36AE00)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB369C10)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xB369C00)
