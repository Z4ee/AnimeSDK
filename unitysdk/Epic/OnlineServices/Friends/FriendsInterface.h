...
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ACCEPTINVITE_OFFSET UNITYSDK_OFFSET(0x8652390)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ADDNOTIFYFRIENDSUPDATE_OFFSET UNITYSDK_OFFSET(0x8652570)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETFRIENDATINDEX_OFFSET UNITYSDK_OFFSET(0x86529B0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETFRIENDSCOUNT_OFFSET UNITYSDK_OFFSET(0x8652BC0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x8652DB0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONACCEPTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x86520A0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONFRIENDSUPDATECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x8652130)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONQUERYFRIENDSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x86521C0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONREJECTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x8652250)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONSENDINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x86522E0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_QUERYFRIENDS_OFFSET UNITYSDK_OFFSET(0x8652F10)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_REJECTINVITE_OFFSET UNITYSDK_OFFSET(0x8653170)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_REMOVENOTIFYFRIENDSUPDATE_OFFSET UNITYSDK_OFFSET(0x8653350)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_SENDINVITE_OFFSET UNITYSDK_OFFSET(0x8653590)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8652380)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x8652370)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int FriendsInterface_TypeDefinitionIndex = 36276;
