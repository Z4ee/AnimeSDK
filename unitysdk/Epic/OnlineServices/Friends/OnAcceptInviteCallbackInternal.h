...
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2C8F30)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2C8F80)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2C8F20)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2C8EB0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnAcceptInviteCallbackInternal_TypeDefinitionIndex = 42914;
