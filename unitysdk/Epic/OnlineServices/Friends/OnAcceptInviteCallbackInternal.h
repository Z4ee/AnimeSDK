...
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D68BFF0)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D68C040)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D68BFE0)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D68BF70)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnAcceptInviteCallbackInternal_TypeDefinitionIndex = 45957;
