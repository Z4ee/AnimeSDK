...
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x921FA0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x921E70)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x921CE0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x921DA0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int QueryFriendsOptionsInternal_TypeDefinitionIndex = 35907;
