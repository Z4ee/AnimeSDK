...
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DBCE530)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1DBCE550)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DBCE540)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1DBCE560)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBCE570)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int AcceptInviteOptions_TypeDefinitionIndex = 36539;
