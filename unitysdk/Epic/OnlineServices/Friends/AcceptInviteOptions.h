...
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1BAABC00)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1BAABC20)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1BAABC10)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1BAABC30)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAABC40)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int AcceptInviteOptions_TypeDefinitionIndex = 43762;
