...
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3EDA0)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3ED30)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3EBA0)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3ED20)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x3EC60)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int AcceptInviteOptionsInternal_TypeDefinitionIndex = 36273;
