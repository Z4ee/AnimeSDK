...
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A48850)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A487D0)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A48640)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A487C0)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x3A48700)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int AcceptInviteOptionsInternal_TypeDefinitionIndex = 43763;
