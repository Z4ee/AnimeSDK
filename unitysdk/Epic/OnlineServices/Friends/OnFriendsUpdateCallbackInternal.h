...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E89F70)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E89FC0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E89C80)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8E86180)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateCallbackInternal_TypeDefinitionIndex = 42113;
