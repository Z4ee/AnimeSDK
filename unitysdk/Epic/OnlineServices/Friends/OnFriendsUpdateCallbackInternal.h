...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86565E0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8656630)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x86562F0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x86527F0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateCallbackInternal_TypeDefinitionIndex = 36287;
