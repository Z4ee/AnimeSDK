...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D196730)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D196780)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D196440)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D196420)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateCallbackInternal_TypeDefinitionIndex = 35895;
