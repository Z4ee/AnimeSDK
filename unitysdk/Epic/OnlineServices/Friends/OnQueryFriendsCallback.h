...
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A489E30)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A489E60)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A489930)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A489920)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnQueryFriendsCallback_TypeDefinitionIndex = 34335;
