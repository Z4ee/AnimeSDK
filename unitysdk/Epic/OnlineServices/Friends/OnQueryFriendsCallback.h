...
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E8A720)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E8A750)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E87BA0)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8E8A700)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnQueryFriendsCallback_TypeDefinitionIndex = 42116;
