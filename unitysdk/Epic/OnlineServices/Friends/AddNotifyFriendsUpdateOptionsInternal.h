...
#define EPIC_ONLINESERVICES_FRIENDS_ADDNOTIFYFRIENDSUPDATEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x45B20)
#define EPIC_ONLINESERVICES_FRIENDS_ADDNOTIFYFRIENDSUPDATEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1EC0)
