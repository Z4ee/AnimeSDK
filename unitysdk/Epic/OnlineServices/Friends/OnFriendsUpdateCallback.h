...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C3A0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C3D0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B60BEA0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60BE80)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateCallback_TypeDefinitionIndex = 35894;
