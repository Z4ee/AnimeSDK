...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198A80D0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198A8100)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x198A7BD0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x198A7BC0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateCallback_TypeDefinitionIndex = 34331;
