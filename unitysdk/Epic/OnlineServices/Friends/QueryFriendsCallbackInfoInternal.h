...
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x60D0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x44830)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x44840)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5FB0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int QueryFriendsCallbackInfoInternal_TypeDefinitionIndex = 42926;
