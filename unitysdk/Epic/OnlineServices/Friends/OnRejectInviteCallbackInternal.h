...
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C6F0)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C740)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C400)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60C3E0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnRejectInviteCallbackInternal_TypeDefinitionIndex = 35901;
