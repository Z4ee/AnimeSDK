...
#define EPIC_ONLINESERVICES_MODS_MODINFO_GET_MODS_OFFSET UNITYSDK_OFFSET(0x1DCF0790)
#define EPIC_ONLINESERVICES_MODS_MODINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DCF07B0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1DCF09A0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_MODS_OFFSET UNITYSDK_OFFSET(0x1DCF07A0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_OFFSET UNITYSDK_OFFSET(0x1DCF07D0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DCF07C0)
#define EPIC_ONLINESERVICES_MODS_MODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCF0AC0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int ModInfo_TypeDefinitionIndex = 45620;
