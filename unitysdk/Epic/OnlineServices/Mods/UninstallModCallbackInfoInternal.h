...
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x84C7C0)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3C0AEF0)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C0AE80)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x3C0B000)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x19050)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UninstallModCallbackInfoInternal_TypeDefinitionIndex = 45632;
