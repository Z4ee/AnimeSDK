...
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x13C30)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x55930)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x558C0)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x55A40)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UninstallModCallbackInfoInternal_TypeDefinitionIndex = 41786;
