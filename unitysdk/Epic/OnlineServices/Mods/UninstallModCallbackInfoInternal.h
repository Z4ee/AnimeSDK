...
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x381840)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x912E50)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x912DE0)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x912F60)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UninstallModCallbackInfoInternal_TypeDefinitionIndex = 34005;
