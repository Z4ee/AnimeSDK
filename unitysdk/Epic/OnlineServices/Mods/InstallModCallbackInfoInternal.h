...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x381840)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8D2E10)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D2DA0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x8D2F20)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int InstallModCallbackInfoInternal_TypeDefinitionIndex = 33987;
