...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x84C7C0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3C097F0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C09780)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x3C09900)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x19050)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int InstallModCallbackInfoInternal_TypeDefinitionIndex = 45614;
