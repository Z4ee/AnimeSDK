...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x13C40)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x53BD0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x53B60)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x53CE0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int InstallModCallbackInfoInternal_TypeDefinitionIndex = 35942;
