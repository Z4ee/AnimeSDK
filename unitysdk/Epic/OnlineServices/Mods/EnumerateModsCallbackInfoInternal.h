...
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x13C40)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x537F0)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x53780)
...
{
	inline static constexpr unsigned int EnumerateModsCallbackInfoInternal_TypeDefinitionIndex = 35938;
