...
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA3076F0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA307720)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA3073C0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA307600)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnInstallModCallback_TypeDefinitionIndex = 42582;
