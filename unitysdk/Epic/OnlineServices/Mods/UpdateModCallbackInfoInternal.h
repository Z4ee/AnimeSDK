...
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x676BA0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3A6F630)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A6F5C0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x3A6F740)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x167710)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UpdateModCallbackInfoInternal_TypeDefinitionIndex = 43454;
