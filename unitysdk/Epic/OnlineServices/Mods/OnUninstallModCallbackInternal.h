...
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA3079C0)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA307A10)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA3079B0)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA307940)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnUninstallModCallbackInternal_TypeDefinitionIndex = 42585;
