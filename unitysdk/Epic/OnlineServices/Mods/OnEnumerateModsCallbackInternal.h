...
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF9FC80)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF9FCD0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF9FC70)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF9FC00)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnEnumerateModsCallbackInternal_TypeDefinitionIndex = 43442;
