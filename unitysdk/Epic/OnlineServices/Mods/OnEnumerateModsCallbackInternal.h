...
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA3075A0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA3075F0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA307590)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA307520)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnEnumerateModsCallbackInternal_TypeDefinitionIndex = 42581;
