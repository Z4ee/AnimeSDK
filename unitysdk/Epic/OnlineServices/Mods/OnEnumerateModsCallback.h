...
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCF1BF0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCF1C20)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCF1AC0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCF1B00)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnEnumerateModsCallback_TypeDefinitionIndex = 45623;
