...
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x553D0)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_GET_MODS_OFFSET UNITYSDK_OFFSET(0x55250)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x68F0)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x553C0)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_MODS_OFFSET UNITYSDK_OFFSET(0x552C0)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x55330)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x26F0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int ModInfoInternal_TypeDefinitionIndex = 41775;
