...
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AC870)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9AC860)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9AC6C0)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9AC780)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x5B0840)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int EnumerateModsOptionsInternal_TypeDefinitionIndex = 36207;
