...
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x53AB0)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x53AA0)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x53900)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x539C0)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSOPTIONSINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x26F0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int EnumerateModsOptionsInternal_TypeDefinitionIndex = 35940;
