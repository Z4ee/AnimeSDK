...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19F956A0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19F956F0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F953A0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19F929B0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToPeerCallbackInternal_TypeDefinitionIndex = 34753;
