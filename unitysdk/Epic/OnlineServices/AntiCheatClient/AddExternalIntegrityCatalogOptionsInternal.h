...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FF290)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FF170)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FF0A0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_SET_PATHTOBINFILE_OFFSET UNITYSDK_OFFSET(0x8FEFF0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int AddExternalIntegrityCatalogOptionsInternal_TypeDefinitionIndex = 34734;
