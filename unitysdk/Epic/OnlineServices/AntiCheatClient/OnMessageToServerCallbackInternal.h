...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C20A900)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C20A950)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C20A8F0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C20A880)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToServerCallbackInternal_TypeDefinitionIndex = 44200;
