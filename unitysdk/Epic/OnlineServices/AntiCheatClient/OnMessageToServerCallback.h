...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BA8C70)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BA8CA0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BA8720)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8BA8700)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToServerCallback_TypeDefinitionIndex = 42535;
