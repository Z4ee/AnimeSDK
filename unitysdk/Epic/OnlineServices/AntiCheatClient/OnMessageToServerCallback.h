...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AA870)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AA8A0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5AA350)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5AA330)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToServerCallback_TypeDefinitionIndex = 36976;
