...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C38AE0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C38AD0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONSINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x3C389E0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C38A50)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int ReceiveMessageFromServerOptionsInternal_TypeDefinitionIndex = 46396;
