...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDNOTIFYMESSAGETOSERVEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8510)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDNOTIFYMESSAGETOSERVEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1EC0)
