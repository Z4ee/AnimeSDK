...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x86F750)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86F730)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0x5B6810)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int PollStatusOptionsInternal_TypeDefinitionIndex = 34763;
