...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9390)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x2200)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0x21F0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int PollStatusOptionsInternal_TypeDefinitionIndex = 43347;
