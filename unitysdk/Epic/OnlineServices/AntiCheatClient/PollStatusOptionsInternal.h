...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x91E7C0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x916EA0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONSINTERNAL_SET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0x5120D0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int PollStatusOptionsInternal_TypeDefinitionIndex = 36326;
