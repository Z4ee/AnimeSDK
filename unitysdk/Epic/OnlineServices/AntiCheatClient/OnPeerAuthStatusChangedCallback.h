...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DFE7A10)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DFE7A40)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFE74F0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFE74D0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnPeerAuthStatusChangedCallback_TypeDefinitionIndex = 36982;
