...
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x8BFC980)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x8BFC940)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8BFC8E0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GET_EXTERNALACCOUNTID_OFFSET UNITYSDK_OFFSET(0x8BFC920)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BFC900)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x8BFC8C0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8BFC960)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x8BFD0F0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x8BFC950)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8BFC8F0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_EXTERNALACCOUNTID_OFFSET UNITYSDK_OFFSET(0x8BFC930)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BFC910)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x8BFC9A0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x8BFC8D0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8BFC970)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8BFD230)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int QueryUserInfoByExternalAccountCallbackInfo_TypeDefinitionIndex = 41114;
	...
	public:
		...
		::System::String* _ExternalAccountId_k__BackingField; // 0x28
