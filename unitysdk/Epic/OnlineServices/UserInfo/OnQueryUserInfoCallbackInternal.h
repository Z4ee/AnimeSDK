...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE36F50)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE36FA0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE36C50)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE36C40)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoCallbackInternal_TypeDefinitionIndex = 33328;
