...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BFBA10)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BFBA60)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BFB720)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8BFB700)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoCallbackInternal_TypeDefinitionIndex = 41109;
