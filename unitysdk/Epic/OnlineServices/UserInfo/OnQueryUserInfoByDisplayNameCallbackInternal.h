...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83D27C0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83D2810)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x83D24D0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x83D24B0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByDisplayNameCallbackInternal_TypeDefinitionIndex = 35279;
