...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8BFA7D0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8BFA820)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8BFA4E0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8BFA4C0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByDisplayNameCallbackInternal_TypeDefinitionIndex = 41105;
