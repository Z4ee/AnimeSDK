...
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x23570)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x23680)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x236F0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int QueryUserInfoCallbackInfoInternal_TypeDefinitionIndex = 41119;
