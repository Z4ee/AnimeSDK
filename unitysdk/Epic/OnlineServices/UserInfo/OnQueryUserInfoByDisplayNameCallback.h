...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C548F50)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C548F80)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C548A50)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYDISPLAYNAMECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C548A30)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByDisplayNameCallback_TypeDefinitionIndex = 34886;
