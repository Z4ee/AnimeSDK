...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC4B650)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC4B680)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC4B130)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4B110)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByExternalAccountCallback_TypeDefinitionIndex = 35547;
