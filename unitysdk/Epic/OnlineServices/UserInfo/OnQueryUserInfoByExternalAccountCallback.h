...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA1077E0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA107810)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA1077D0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA1076E0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByExternalAccountCallback_TypeDefinitionIndex = 41909;
