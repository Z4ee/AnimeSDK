...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E9DD0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E9E20)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E9DC0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E9D50)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByExternalAccountCallbackInternal_TypeDefinitionIndex = 42771;
