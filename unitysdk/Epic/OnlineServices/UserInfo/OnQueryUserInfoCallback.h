...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x83D36B0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x83D36E0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x83D3160)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x83D3140)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoCallback_TypeDefinitionIndex = 35282;
