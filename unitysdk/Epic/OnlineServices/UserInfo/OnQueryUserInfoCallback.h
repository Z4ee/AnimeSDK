...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA107A00)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA107A30)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA1079F0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA107900)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoCallback_TypeDefinitionIndex = 41911;
