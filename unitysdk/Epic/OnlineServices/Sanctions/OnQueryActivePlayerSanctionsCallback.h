...
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D393CE0)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D393D10)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3937C0)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3937A0)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int OnQueryActivePlayerSanctionsCallback_TypeDefinitionIndex = 35841;
