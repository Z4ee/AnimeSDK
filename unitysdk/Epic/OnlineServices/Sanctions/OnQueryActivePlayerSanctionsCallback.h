...
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BFB8010)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BFB8040)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BFB7B10)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFB7AF0)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int OnQueryActivePlayerSanctionsCallback_TypeDefinitionIndex = 35182;
