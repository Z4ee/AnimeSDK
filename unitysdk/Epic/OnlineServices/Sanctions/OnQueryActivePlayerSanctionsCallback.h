...
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8701290)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x87012C0)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8700D40)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8700D20)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int OnQueryActivePlayerSanctionsCallback_TypeDefinitionIndex = 35574;
