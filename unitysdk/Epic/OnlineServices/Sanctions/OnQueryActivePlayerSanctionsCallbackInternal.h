...
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DBDAB30)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DBDAB80)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DBDA820)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBDA800)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int OnQueryActivePlayerSanctionsCallbackInternal_TypeDefinitionIndex = 35842;
