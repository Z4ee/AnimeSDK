...
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4956A0)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4956F0)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4953A0)
#define EPIC_ONLINESERVICES_SANCTIONS_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A495390)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int OnQueryActivePlayerSanctionsCallbackInternal_TypeDefinitionIndex = 33620;
