...
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE_BEGINPLAYERSESSION_OFFSET UNITYSDK_OFFSET(0x1A80C8B0)
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE_ENDPLAYERSESSION_OFFSET UNITYSDK_OFFSET(0x1A80CA10)
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A80C8A0)
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80C890)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int MetricsInterface_TypeDefinitionIndex = 34021;
