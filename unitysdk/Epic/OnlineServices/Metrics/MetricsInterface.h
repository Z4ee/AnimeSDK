...
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE_BEGINPLAYERSESSION_OFFSET UNITYSDK_OFFSET(0x1BF9B320)
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE_ENDPLAYERSESSION_OFFSET UNITYSDK_OFFSET(0x1BF9B480)
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF9B310)
#define EPIC_ONLINESERVICES_METRICS_METRICSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF9B300)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int MetricsInterface_TypeDefinitionIndex = 43466;
