...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS_GET_WINNINGTEAMID_OFFSET UNITYSDK_OFFSET(0x1C210B30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS_SET_WINNINGTEAMID_OFFSET UNITYSDK_OFFSET(0x1C210B40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C210B50)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogGameRoundEndOptions_TypeDefinitionIndex = 44140;
