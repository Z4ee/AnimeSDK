...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS_GET_WINNINGTEAMID_OFFSET UNITYSDK_OFFSET(0x1DF5B350)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS_SET_WINNINGTEAMID_OFFSET UNITYSDK_OFFSET(0x1DF5B360)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5B370)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogGameRoundEndOptions_TypeDefinitionIndex = 46322;
