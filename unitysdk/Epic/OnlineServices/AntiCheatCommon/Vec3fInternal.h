...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x667A60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_GET_X_OFFSET UNITYSDK_OFFSET(0x167F50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_GET_Y_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_GET_Z_OFFSET UNITYSDK_OFFSET(0xA4BEB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AA65D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AA65B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_X_OFFSET UNITYSDK_OFFSET(0x167DB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_Y_OFFSET UNITYSDK_OFFSET(0x38DAE60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_Z_OFFSET UNITYSDK_OFFSET(0x38DAF30)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int Vec3fInternal_TypeDefinitionIndex = 44177;
