...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_GET_X_OFFSET UNITYSDK_OFFSET(0x45B300)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_GET_Y_OFFSET UNITYSDK_OFFSET(0x40C5C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_GET_Z_OFFSET UNITYSDK_OFFSET(0x416EC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x972470)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x972450)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_X_OFFSET UNITYSDK_OFFSET(0x55FE60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_Y_OFFSET UNITYSDK_OFFSET(0x55FE70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3FINTERNAL_SET_Z_OFFSET UNITYSDK_OFFSET(0x5CC490)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int Vec3fInternal_TypeDefinitionIndex = 36295;
