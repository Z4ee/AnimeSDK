...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD840)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xD7C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x21F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_SET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xD5E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xD7B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONSINTERNAL_SET_PARAMDEFS_OFFSET UNITYSDK_OFFSET(0xD690)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int RegisterEventOptionsInternal_TypeDefinitionIndex = 43308;
