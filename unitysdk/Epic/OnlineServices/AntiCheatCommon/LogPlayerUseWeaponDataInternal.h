...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC430)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_GET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0xC0F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_GET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0xBF90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_GET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x5580)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_GET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0xBDD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_GET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0xBEB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_GET_WEAPONNAME_OFFSET UNITYSDK_OFFSET(0xC250)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xC3C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0xC1A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0xC040)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xC3B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0xBDC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0xBE40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0xBF20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATAINTERNAL_SET_WEAPONNAME_OFFSET UNITYSDK_OFFSET(0xC300)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseWeaponDataInternal_TypeDefinitionIndex = 42493;
