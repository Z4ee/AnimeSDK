...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1ADE60A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1ADE60C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1ADE60B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1ADE60D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE60E0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerReviveOptions_TypeDefinitionIndex = 34701;
