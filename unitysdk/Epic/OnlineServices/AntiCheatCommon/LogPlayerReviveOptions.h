...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388AD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388AF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388AE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388B00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8388B10)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerReviveOptions_TypeDefinitionIndex = 36656;
