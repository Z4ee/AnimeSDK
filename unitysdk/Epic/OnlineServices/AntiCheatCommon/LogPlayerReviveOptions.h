...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1D256970)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1D256990)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1D256980)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1D2569A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2569B0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerReviveOptions_TypeDefinitionIndex = 36264;
