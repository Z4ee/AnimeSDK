...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x870D60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x870CF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x686700)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8708A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x870910)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x870C70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x870BE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x870BC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x870BA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x870BD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x870A30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x870BB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x870B90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x870AE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x870980)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x870CE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x870BF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x870C60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x381830)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8707C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x870830)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptionsInternal_TypeDefinitionIndex = 34706;
