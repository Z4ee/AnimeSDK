...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS_GET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0xA0C9490)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS_SET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0xA0C94A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C94B0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerDespawnOptions_TypeDefinitionIndex = 43283;
