...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA21080)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_GET_PARAMNAME_OFFSET UNITYSDK_OFFSET(0xA20D30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_GET_PARAMTYPE_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA20F60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA20E90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_SET_PARAMNAME_OFFSET UNITYSDK_OFFSET(0xA20DE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTPARAMDEFINTERNAL_SET_PARAMTYPE_OFFSET UNITYSDK_OFFSET(0x3C9D90)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int RegisterEventParamDefInternal_TypeDefinitionIndex = 36948;
