...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS_GET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x838E340)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x838E350)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x838E360)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int SetGameSessionIdOptions_TypeDefinitionIndex = 36684;
