...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1DCA1B30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1DCA1B50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1DCA1B70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DCA1CF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x1DCA1C90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x1DCA1C50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x1DCA1C10)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1DCA1C70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x1DCA1BB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x1DCA1C30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x1DCA1BF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x1DCA1BD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x1DCA1B90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x1DCA1CB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x1DCA1CD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1DCA1AD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1DCA1AF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1DCA1B10)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1DCA1B40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1DCA1B60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1DCA1B80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DCA1D00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x1DCA1CA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x1DCA1C60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x1DCA1C20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1DCA1C80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x1DCA1BC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x1DCA1C40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x1DCA1C00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x1DCA1BE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x1DCA1BA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x1DCA1CC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x1DCA1CE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1DCA1AE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1DCA1B00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1DCA1B20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA1D10)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptions_TypeDefinitionIndex = 36927;
	...
	public:
		...
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _VictimPlayerPosition_k__BackingField; // 0x18
		...
		::Epic::OnlineServices::AntiCheatCommon::LogPlayerUseWeaponData* _PlayerUseWeaponData_k__BackingField; // 0x38
		...
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageSource _DamageSource_k__BackingField; // 0x4C
		::System::Boolean _IsCriticalHit_k__BackingField; // 0x50
		::System::Boolean _IsHitscanAttack_k__BackingField; // 0x51
		::System::Boolean _HasLineOfSight_k__BackingField; // 0x52
		...
		::System::IntPtr _AttackerPlayerHandle_k__BackingField; // 0x60
