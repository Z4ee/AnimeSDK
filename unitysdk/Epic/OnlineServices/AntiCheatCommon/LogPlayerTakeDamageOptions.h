...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1A4E3420)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E3440)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1A4E3460)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E35E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x1A4E3580)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x1A4E3540)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x1A4E3500)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1A4E3560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x1A4E34A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x1A4E3520)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x1A4E34E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x1A4E34C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x1A4E3480)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x1A4E35A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x1A4E35C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1A4E33C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E33E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1A4E3400)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1A4E3430)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E3450)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1A4E3470)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E35F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x1A4E3590)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x1A4E3550)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x1A4E3510)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1A4E3570)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x1A4E34B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x1A4E3530)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x1A4E34F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x1A4E34D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x1A4E3490)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x1A4E35B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x1A4E35D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1A4E33D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E33F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1A4E3410)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E3600)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptions_TypeDefinitionIndex = 34705;

	class LogPlayerTakeDamageOptions : public ::System::Object
	{
	public:
		::Epic::OnlineServices::AntiCheatCommon::Quat* _VictimPlayerViewRotation_k__BackingField; // 0x10
		...
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _VictimPlayerPosition_k__BackingField; // 0x30
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _DamagePosition_k__BackingField; // 0x38
		::System::Single _DamageTaken_k__BackingField; // 0x40
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageResult _DamageResult_k__BackingField; // 0x44
		...
		::System::UInt32 _TimeSincePlayerUseWeaponMs_k__BackingField; // 0x54
		::System::UInt32 _HitBoneId_DEPRECATED_k__BackingField; // 0x58
		::System::Boolean _HasLineOfSight_k__BackingField; // 0x5C
		::System::Boolean _IsHitscanAttack_k__BackingField; // 0x5D
		::System::Boolean _IsCriticalHit_k__BackingField; // 0x5E
		::System::IntPtr _VictimPlayerHandle_k__BackingField; // 0x60
		::System::Single _HealthRemaining_k__BackingField; // 0x68
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageSource _DamageSource_k__BackingField; // 0x6C
