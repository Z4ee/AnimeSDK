...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388F60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8388F80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8388FA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x8389120)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x83890C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x8389080)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x8389040)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x83890A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x8388FE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x8389060)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x8389020)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x8389000)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x8388FC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x83890E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x8389100)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388F00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8388F20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8388F40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388F70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8388F90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8388FB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x8389130)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x83890D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x8389090)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x8389050)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x83890B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x8388FF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x8389070)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x8389030)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x8389010)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x8388FD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x83890F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x8389110)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8388F10)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8388F30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8388F50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8389140)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptions_TypeDefinitionIndex = 36660;

	class LogPlayerTakeDamageOptions : public ::System::Object
	{
	public:
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _AttackerPlayerPosition_k__BackingField; // 0x10
		...
		::System::Single _HealthRemaining_k__BackingField; // 0x44
		::System::UInt32 _TimeSincePlayerUseWeaponMs_k__BackingField; // 0x48
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageResult _DamageResult_k__BackingField; // 0x4C
		::System::IntPtr _AttackerPlayerHandle_k__BackingField; // 0x50
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageSource _DamageSource_k__BackingField; // 0x58
		::System::Boolean _IsCriticalHit_k__BackingField; // 0x5C
		::System::Boolean _HasLineOfSight_k__BackingField; // 0x5D
		::System::Boolean _IsHitscanAttack_k__BackingField; // 0x5E
		::System::UInt32 _HitBoneId_DEPRECATED_k__BackingField; // 0x60
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageType _DamageType_k__BackingField; // 0x64
		::System::IntPtr _VictimPlayerHandle_k__BackingField; // 0x68
