...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8BB0F60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB0F80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8BB0FA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB1120)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x8BB10C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x8BB1080)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x8BB1040)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x8BB10A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x8BB0FE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x8BB1060)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x8BB1020)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x8BB1000)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x8BB0FC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x8BB10E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x8BB1100)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8BB0F00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB0F20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_GET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8BB0F40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8BB0F70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB0F90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8BB0FB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB1130)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x8BB10D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x8BB1090)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x8BB1050)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x8BB10B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x8BB0FF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x8BB1070)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x8BB1030)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x8BB1010)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x8BB0FD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x8BB10F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x8BB1110)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x8BB0F10)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB0F30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8BB0F50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8BB1140)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptions_TypeDefinitionIndex = 42486;

	class LogPlayerTakeDamageOptions : public ::System::Object
	{
	public:
		::Epic::OnlineServices::AntiCheatCommon::LogPlayerUseWeaponData* _PlayerUseWeaponData_k__BackingField; // 0x10
		::Epic::OnlineServices::AntiCheatCommon::Quat* _AttackerPlayerViewRotation_k__BackingField; // 0x18
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _VictimPlayerPosition_k__BackingField; // 0x20
		::Epic::OnlineServices::AntiCheatCommon::Quat* _VictimPlayerViewRotation_k__BackingField; // 0x28
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _DamagePosition_k__BackingField; // 0x30
		::Epic::OnlineServices::AntiCheatCommon::Vec3f* _AttackerPlayerPosition_k__BackingField; // 0x38
		::System::IntPtr _AttackerPlayerHandle_k__BackingField; // 0x40
		::System::Boolean _HasLineOfSight_k__BackingField; // 0x48
		::System::Boolean _IsHitscanAttack_k__BackingField; // 0x49
		::System::Boolean _IsCriticalHit_k__BackingField; // 0x4A
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageResult _DamageResult_k__BackingField; // 0x4C
		::System::UInt32 _HitBoneId_DEPRECATED_k__BackingField; // 0x50
		::System::Single _HealthRemaining_k__BackingField; // 0x54
		::System::IntPtr _VictimPlayerHandle_k__BackingField; // 0x58
		::System::UInt32 _TimeSincePlayerUseWeaponMs_k__BackingField; // 0x60
		::System::Single _DamageTaken_k__BackingField; // 0x64
		::Epic::OnlineServices::AntiCheatCommon::AntiCheatCommonPlayerTakeDamageSource _DamageSource_k__BackingField; // 0x68
