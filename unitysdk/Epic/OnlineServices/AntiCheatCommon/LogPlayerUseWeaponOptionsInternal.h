...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC750)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xC740)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xC6C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_SET_USEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0xC650)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseWeaponOptionsInternal_TypeDefinitionIndex = 42495;
