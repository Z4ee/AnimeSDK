...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95E410)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x95E400)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x95E380)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONSINTERNAL_SET_USEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x95E310)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseWeaponOptionsInternal_TypeDefinitionIndex = 36936;
