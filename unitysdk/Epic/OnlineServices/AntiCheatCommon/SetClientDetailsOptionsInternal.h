...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9EB0F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9EB070)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_CLIENTFLAGS_OFFSET UNITYSDK_OFFSET(0x5B0840)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x462A80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_CLIENTINPUTMETHOD_OFFSET UNITYSDK_OFFSET(0x352890)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9EB040)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int SetClientDetailsOptionsInternal_TypeDefinitionIndex = 36950;
