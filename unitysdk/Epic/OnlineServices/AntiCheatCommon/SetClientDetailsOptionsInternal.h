...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FF550)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FF4D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_CLIENTFLAGS_OFFSET UNITYSDK_OFFSET(0x577FD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x381830)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_CLIENTINPUTMETHOD_OFFSET UNITYSDK_OFFSET(0x34DBE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETCLIENTDETAILSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FF4A0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int SetClientDetailsOptionsInternal_TypeDefinitionIndex = 34728;
