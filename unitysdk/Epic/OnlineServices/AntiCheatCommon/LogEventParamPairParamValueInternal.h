...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91F5E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x91EBC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_INT32_OFFSET UNITYSDK_OFFSET(0x91EF40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_INT64_OFFSET UNITYSDK_OFFSET(0x91F1A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_QUAT_OFFSET UNITYSDK_OFFSET(0x91F420)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_STRING_OFFSET UNITYSDK_OFFSET(0x91ED00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_UINT32_OFFSET UNITYSDK_OFFSET(0x91EE20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_UINT64_OFFSET UNITYSDK_OFFSET(0x91F060)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_VEC3F_OFFSET UNITYSDK_OFFSET(0x91F2E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x91F570)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x91EC50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_INT32_OFFSET UNITYSDK_OFFSET(0x91EFC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_INT64_OFFSET UNITYSDK_OFFSET(0x91F230)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x91F560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_QUAT_OFFSET UNITYSDK_OFFSET(0x91F4C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_STRING_OFFSET UNITYSDK_OFFSET(0x91ED80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_UINT32_OFFSET UNITYSDK_OFFSET(0x91EEA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_UINT64_OFFSET UNITYSDK_OFFSET(0x91F0F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_VEC3F_OFFSET UNITYSDK_OFFSET(0x91F380)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogEventParamPairParamValueInternal_TypeDefinitionIndex = 36257;
