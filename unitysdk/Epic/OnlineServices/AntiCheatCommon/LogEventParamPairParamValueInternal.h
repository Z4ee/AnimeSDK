...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA910)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x9EF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_INT32_OFFSET UNITYSDK_OFFSET(0xA270)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_INT64_OFFSET UNITYSDK_OFFSET(0xA4D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_QUAT_OFFSET UNITYSDK_OFFSET(0xA750)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_STRING_OFFSET UNITYSDK_OFFSET(0xA030)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_UINT32_OFFSET UNITYSDK_OFFSET(0xA150)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_UINT64_OFFSET UNITYSDK_OFFSET(0xA390)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_GET_VEC3F_OFFSET UNITYSDK_OFFSET(0xA610)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA8A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x9F80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_INT32_OFFSET UNITYSDK_OFFSET(0xA2F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_INT64_OFFSET UNITYSDK_OFFSET(0xA560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA890)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_QUAT_OFFSET UNITYSDK_OFFSET(0xA7F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_STRING_OFFSET UNITYSDK_OFFSET(0xA0B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_UINT32_OFFSET UNITYSDK_OFFSET(0xA1D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_UINT64_OFFSET UNITYSDK_OFFSET(0xA420)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRPARAMVALUEINTERNAL_SET_VEC3F_OFFSET UNITYSDK_OFFSET(0xA6B0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogEventParamPairParamValueInternal_TypeDefinitionIndex = 42475;
