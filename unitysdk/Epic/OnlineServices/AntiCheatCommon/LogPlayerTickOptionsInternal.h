...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B13A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B1330)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0x8B1270)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B1320)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x446DA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERHEALTH_OFFSET UNITYSDK_OFFSET(0x4900B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERMOVEMENTSTATE_OFFSET UNITYSDK_OFFSET(0x6427B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x8B1190)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x8B1200)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTickOptionsInternal_TypeDefinitionIndex = 36271;
