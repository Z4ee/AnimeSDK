...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BE080)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9BE010)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_LEVELNAME_OFFSET UNITYSDK_OFFSET(0x9BDEA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_MODENAME_OFFSET UNITYSDK_OFFSET(0x9BDF50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9BE000)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_ROUNDTIMESECONDS_OFFSET UNITYSDK_OFFSET(0x86B770)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_SESSIONIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x9BDDF0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogGameRoundStartOptionsInternal_TypeDefinitionIndex = 36920;
