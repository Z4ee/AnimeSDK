...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C3A730)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C3A6B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_LEVELNAME_OFFSET UNITYSDK_OFFSET(0x3C3A540)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_MODENAME_OFFSET UNITYSDK_OFFSET(0x3C3A5F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C3A6A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_ROUNDTIMESECONDS_OFFSET UNITYSDK_OFFSET(0x3AF6880)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDSTARTOPTIONSINTERNAL_SET_SESSIONIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x3C3A490)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogGameRoundStartOptionsInternal_TypeDefinitionIndex = 46325;
