...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C3B770)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C3B6E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYCOOLDOWNMS_OFFSET UNITYSDK_OFFSET(0x3AA1870)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYDURATIONMS_OFFSET UNITYSDK_OFFSET(0xF090)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYID_OFFSET UNITYSDK_OFFSET(0x3A2C790)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C3B6B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x869800)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseAbilityOptionsInternal_TypeDefinitionIndex = 46337;
