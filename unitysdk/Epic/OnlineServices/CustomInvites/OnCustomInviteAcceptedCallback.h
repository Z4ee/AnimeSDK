...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8E66E40)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8E66E70)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8E656A0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8E66E20)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int OnCustomInviteAcceptedCallback_TypeDefinitionIndex = 42239;
