...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF29B60)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF29B90)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF278C0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF29A70)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int OnSendCustomInviteCallback_TypeDefinitionIndex = 46093;
