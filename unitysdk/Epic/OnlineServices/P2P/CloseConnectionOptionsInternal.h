...
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AB670)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9AB600)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9AB380)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9AB5F0)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONOPTIONSINTERNAL_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x9AB440)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x9AB500)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int CloseConnectionOptionsInternal_TypeDefinitionIndex = 35488;
