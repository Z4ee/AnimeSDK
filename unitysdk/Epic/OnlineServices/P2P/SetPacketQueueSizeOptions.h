...
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONS_GET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1A86C280)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONS_GET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1A86C2A0)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONS_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1A86C290)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONS_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1A86C2B0)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A86C2C0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetPacketQueueSizeOptions_TypeDefinitionIndex = 33972;
