...
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C9CD260)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_GET_MAXDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1C9CD280)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_GET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x1C9CD2A0)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C9CD270)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_SET_MAXDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1C9CD290)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_SET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x1C9CD2B0)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CD2C0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int ReceivePacketOptions_TypeDefinitionIndex = 36189;
