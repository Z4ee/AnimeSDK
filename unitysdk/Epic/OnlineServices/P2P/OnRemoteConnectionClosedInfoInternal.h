...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x246290)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x97C270)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x97C380)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_REASON_OFFSET UNITYSDK_OFFSET(0x361C30)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x97C3F0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x97C460)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnRemoteConnectionClosedInfoInternal_TypeDefinitionIndex = 35523;
