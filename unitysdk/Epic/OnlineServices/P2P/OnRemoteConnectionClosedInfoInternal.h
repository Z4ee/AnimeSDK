...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x57FC0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x580D0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_REASON_OFFSET UNITYSDK_OFFSET(0x1CCC0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x58140)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x581B0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnRemoteConnectionClosedInfoInternal_TypeDefinitionIndex = 35915;
