...
#define EPIC_ONLINESERVICES_P2P_GETPORTRANGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5D010)
#define EPIC_ONLINESERVICES_P2P_GETPORTRANGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1EB0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int GetPortRangeOptionsInternal_TypeDefinitionIndex = 42521;
