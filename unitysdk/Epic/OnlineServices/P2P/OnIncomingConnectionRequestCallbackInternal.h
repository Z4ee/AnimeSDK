...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86A8220)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86A8270)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x86A7F30)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x86A7F10)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingConnectionRequestCallbackInternal_TypeDefinitionIndex = 35897;
