...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x9CA010)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x325D00)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteInfoInternal_TypeDefinitionIndex = 36178;
