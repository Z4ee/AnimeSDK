...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x588B0)
...
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteInfoInternal_TypeDefinitionIndex = 41737;
