...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C227810)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C227860)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C227800)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C227790)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingPacketQueueFullCallbackInternal_TypeDefinitionIndex = 43391;
