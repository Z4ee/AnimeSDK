...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86AB2F0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86AB320)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86AADA0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86AAD80)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteCallback_TypeDefinitionIndex = 35908;
