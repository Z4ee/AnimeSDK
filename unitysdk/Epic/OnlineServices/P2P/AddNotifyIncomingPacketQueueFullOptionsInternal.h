...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYINCOMINGPACKETQUEUEFULLOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5B530)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYINCOMINGPACKETQUEUEFULLOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1EB0)
