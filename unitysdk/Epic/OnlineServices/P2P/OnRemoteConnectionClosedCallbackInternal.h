...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D19BF00)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D19BF50)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D19BC10)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19BBF0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnRemoteConnectionClosedCallbackInternal_TypeDefinitionIndex = 35521;
