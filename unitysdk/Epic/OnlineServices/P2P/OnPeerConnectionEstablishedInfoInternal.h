...
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8BE760)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_CONNECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x367EB0)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BE870)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x8BE8E0)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x8BE950)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnPeerConnectionEstablishedInfoInternal_TypeDefinitionIndex = 33952;
