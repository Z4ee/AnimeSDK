...
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x58650)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_CONNECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1CCB0)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x58760)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x587D0)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x58840)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnPeerConnectionEstablishedInfoInternal_TypeDefinitionIndex = 41733;
