...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x8EDCD20)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8EDCC60)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETCHANNEL_OFFSET UNITYSDK_OFFSET(0x8EDCCE0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8EDCCC0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EDCD00)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_PACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EDCCA0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_PACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EDCC80)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x8EDD250)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8EDCC70)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OFFSET UNITYSDK_OFFSET(0x8EDCD30)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETCHANNEL_OFFSET UNITYSDK_OFFSET(0x8EDCCF0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8EDCCD0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EDCD10)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_PACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EDCCB0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_PACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EDCC90)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8EDD380)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingPacketQueueFullInfo_TypeDefinitionIndex = 41728;
	...
	public:
		...
		::System::UInt64 _PacketQueueMaxSizeBytes_k__BackingField; // 0x20
