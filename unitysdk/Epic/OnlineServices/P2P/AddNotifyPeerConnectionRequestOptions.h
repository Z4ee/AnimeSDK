...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA30A730)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0xA30A750)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA30A740)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0xA30A760)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xA30A770)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionRequestOptions_TypeDefinitionIndex = 42504;
