...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF84EF0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x1DF84F10)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DF84F00)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x1DF84F20)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF84F30)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionRequestOptions_TypeDefinitionIndex = 45547;
