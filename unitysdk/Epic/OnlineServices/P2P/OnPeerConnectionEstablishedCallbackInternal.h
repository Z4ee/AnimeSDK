...
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86AA430)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86AA480)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x86AA140)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x86AA120)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnPeerConnectionEstablishedCallbackInternal_TypeDefinitionIndex = 35905;
