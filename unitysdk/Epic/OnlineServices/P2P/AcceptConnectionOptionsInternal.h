...
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A6FDA0)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A6FD20)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A6FAA0)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A6FD10)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x3A6FB60)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x3A6FC20)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AcceptConnectionOptionsInternal_TypeDefinitionIndex = 43358;
