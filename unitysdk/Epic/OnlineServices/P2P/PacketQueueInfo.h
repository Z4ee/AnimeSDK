...
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADEBB00)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBAE0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBAC0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADEBB60)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBB40)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBB20)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1ADEBCC0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADEBB10)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBAF0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBAD0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OFFSET UNITYSDK_OFFSET(0x1ADEBB80)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADEBB70)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBB50)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1ADEBB30)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEBE10)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int PacketQueueInfo_TypeDefinitionIndex = 33962;

	class PacketQueueInfo : public ::System::Object
	{
	public:
		::System::UInt64 _OutgoingPacketQueueMaxSizeBytes_k__BackingField; // 0x10
		::System::UInt64 _IncomingPacketQueueMaxSizeBytes_k__BackingField; // 0x18
		::System::UInt64 _OutgoingPacketQueueCurrentPacketCount_k__BackingField; // 0x20
		::System::UInt64 _OutgoingPacketQueueCurrentSizeBytes_k__BackingField; // 0x28
		::System::UInt64 _IncomingPacketQueueCurrentSizeBytes_k__BackingField; // 0x30
		::System::UInt64 _IncomingPacketQueueCurrentPacketCount_k__BackingField; // 0x38
