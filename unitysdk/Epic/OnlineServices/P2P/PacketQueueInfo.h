...
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1E5B03F0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B03D0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B03B0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1E5B0450)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B0430)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B0410)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1E5B05B0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1E5B0400)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B03E0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B03C0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OFFSET UNITYSDK_OFFSET(0x1E5B0470)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1E5B0460)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B0440)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1E5B0420)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5B0700)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int PacketQueueInfo_TypeDefinitionIndex = 36184;
	...
	public:
		...
		::System::UInt64 _OutgoingPacketQueueMaxSizeBytes_k__BackingField; // 0x38
