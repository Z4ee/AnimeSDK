...
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x8EE3020)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE3000)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE2FE0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x8EE3080)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE3060)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE3040)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x8EE31E0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x8EE3030)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE3010)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE2FF0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OFFSET UNITYSDK_OFFSET(0x8EE30A0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x8EE3090)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE3070)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x8EE3050)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8EE3320)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int PacketQueueInfo_TypeDefinitionIndex = 41743;
	...
	public:
		...
		::System::UInt64 _IncomingPacketQueueCurrentSizeBytes_k__BackingField; // 0x28
