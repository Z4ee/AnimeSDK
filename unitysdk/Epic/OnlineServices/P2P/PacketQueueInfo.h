...
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1D25C400)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C3E0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C3C0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1D25C460)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C440)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_GET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C420)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1D25C5C0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1D25C410)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C3F0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C3D0)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OFFSET UNITYSDK_OFFSET(0x1D25C480)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTPACKETCOUNT_OFFSET UNITYSDK_OFFSET(0x1D25C470)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C450)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D25C430)
#define EPIC_ONLINESERVICES_P2P_PACKETQUEUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25C710)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int PacketQueueInfo_TypeDefinitionIndex = 35525;
