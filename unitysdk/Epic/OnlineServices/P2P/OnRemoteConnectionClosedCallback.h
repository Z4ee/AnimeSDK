...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EDF940)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EDF970)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EDF3F0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8EDF3D0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnRemoteConnectionClosedCallback_TypeDefinitionIndex = 41738;
