...
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C42E00)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C42D80)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C42BE0)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C42D70)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x3C42CA0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int CloseConnectionsOptionsInternal_TypeDefinitionIndex = 45554;
