...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C226CE0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C226D10)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C226CD0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C226BE0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingConnectionRequestCallback_TypeDefinitionIndex = 43386;
