...
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9F4D00)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x462A80)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9F4CE0)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x3C9DB0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetPacketQueueSizeOptionsInternal_TypeDefinitionIndex = 36195;
