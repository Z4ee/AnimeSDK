...
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x943440)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86F730)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x5B6810)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetRelayControlOptionsInternal_TypeDefinitionIndex = 33977;
