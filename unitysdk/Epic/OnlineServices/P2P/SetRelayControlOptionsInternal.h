...
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA31660)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x961230)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x6329D0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetRelayControlOptionsInternal_TypeDefinitionIndex = 36199;
