...
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9E61A0)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x916EA0)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x5120D0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetRelayControlOptionsInternal_TypeDefinitionIndex = 35540;
