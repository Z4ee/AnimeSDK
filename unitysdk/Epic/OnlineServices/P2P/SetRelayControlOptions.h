...
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONS_GET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x1DBD6B90)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONS_SET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x1DBD6BA0)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBD6BB0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetRelayControlOptions_TypeDefinitionIndex = 36198;
