...
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86AA0E0)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86AA110)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86A9B90)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86A9B70)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnPeerConnectionEstablishedCallback_TypeDefinitionIndex = 35904;
