...
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EDD950)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EDD980)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EDD400)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8EDD3E0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnPeerConnectionEstablishedCallback_TypeDefinitionIndex = 41730;
