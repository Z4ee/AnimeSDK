...
#define EPIC_ONLINESERVICES_P2P_QUERYNATTYPEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x667A60)
#define EPIC_ONLINESERVICES_P2P_QUERYNATTYPEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AADCD0)
#define EPIC_ONLINESERVICES_P2P_QUERYNATTYPEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A39250)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int QueryNATTypeOptionsInternal_TypeDefinitionIndex = 43411;
