...
#define EPIC_ONLINESERVICES_P2P_QUERYNATTYPEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F00)
#define EPIC_ONLINESERVICES_P2P_QUERYNATTYPEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C44850)
#define EPIC_ONLINESERVICES_P2P_QUERYNATTYPEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3BCBDF0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int QueryNATTypeOptionsInternal_TypeDefinitionIndex = 45593;
