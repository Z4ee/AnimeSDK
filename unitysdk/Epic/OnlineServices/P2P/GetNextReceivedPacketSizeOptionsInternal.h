...
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x904670)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x904600)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x904480)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9045F0)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONSINTERNAL_SET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x904540)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int GetNextReceivedPacketSizeOptionsInternal_TypeDefinitionIndex = 33933;
