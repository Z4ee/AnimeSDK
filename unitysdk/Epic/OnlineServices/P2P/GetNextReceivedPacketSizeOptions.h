...
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D19BB10)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONS_GET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x1D19BB30)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1D19BB20)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONS_SET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x1D19BB40)
#define EPIC_ONLINESERVICES_P2P_GETNEXTRECEIVEDPACKETSIZEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19BB50)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int GetNextReceivedPacketSizeOptions_TypeDefinitionIndex = 35495;
