...
#define EPIC_ONLINESERVICES_P2P_GETPACKETQUEUEINFOOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define EPIC_ONLINESERVICES_P2P_GETPACKETQUEUEINFOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x917C40)
#define EPIC_ONLINESERVICES_P2P_GETPACKETQUEUEINFOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B18C0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int GetPacketQueueInfoOptionsInternal_TypeDefinitionIndex = 35498;
