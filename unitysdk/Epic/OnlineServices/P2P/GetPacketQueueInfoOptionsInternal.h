...
#define EPIC_ONLINESERVICES_P2P_GETPACKETQUEUEINFOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5CFA0)
#define EPIC_ONLINESERVICES_P2P_GETPACKETQUEUEINFOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1EB0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int GetPacketQueueInfoOptionsInternal_TypeDefinitionIndex = 42519;
