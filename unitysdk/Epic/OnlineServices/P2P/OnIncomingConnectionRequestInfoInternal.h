...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x88BF20)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x88C030)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x88C0A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x88C110)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingConnectionRequestInfoInternal_TypeDefinitionIndex = 33944;
