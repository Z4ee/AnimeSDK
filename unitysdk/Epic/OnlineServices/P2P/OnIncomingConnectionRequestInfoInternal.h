...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3AAC8A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AAC9B0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x3AACA20)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x3AACA90)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingConnectionRequestInfoInternal_TypeDefinitionIndex = 43389;
