...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x86A5280)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x86A52A0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x86A5290)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x86A52B0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x86A52C0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionEstablishedOptions_TypeDefinitionIndex = 35873;
