...
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x28B580)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x9365C0)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int KickCompleteCallbackInfoInternal_TypeDefinitionIndex = 33717;
