...
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xA26380)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x325570)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int KickCompleteCallbackInfoInternal_TypeDefinitionIndex = 35939;
