...
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86E82D0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86E8300)
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86E7D80)
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86E7D60)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int OnKickCompleteCallback_TypeDefinitionIndex = 35675;
