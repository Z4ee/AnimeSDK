...
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x68C90)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x68C20)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x68C10)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x68AA0)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x68B50)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int KickOptionsInternal_TypeDefinitionIndex = 35674;
