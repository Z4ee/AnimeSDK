...
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x86E9510)
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x86E9540)
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x86E8FC0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x86E8FA0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int OnSetParticipantHardMuteCompleteCallback_TypeDefinitionIndex = 35679;
