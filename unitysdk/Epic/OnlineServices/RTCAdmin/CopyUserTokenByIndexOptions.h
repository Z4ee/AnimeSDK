...
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_GET_QUERYID_OFFSET UNITYSDK_OFFSET(0x1D275BD0)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_GET_USERTOKENINDEX_OFFSET UNITYSDK_OFFSET(0x1D275BB0)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_SET_QUERYID_OFFSET UNITYSDK_OFFSET(0x1D275BE0)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_SET_USERTOKENINDEX_OFFSET UNITYSDK_OFFSET(0x1D275BC0)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D275BF0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int CopyUserTokenByIndexOptions_TypeDefinitionIndex = 35934;
