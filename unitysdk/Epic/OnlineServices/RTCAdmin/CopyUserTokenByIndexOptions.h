...
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_GET_QUERYID_OFFSET UNITYSDK_OFFSET(0x19A30E80)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_GET_USERTOKENINDEX_OFFSET UNITYSDK_OFFSET(0x19A30E60)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_SET_QUERYID_OFFSET UNITYSDK_OFFSET(0x19A30E90)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_SET_USERTOKENINDEX_OFFSET UNITYSDK_OFFSET(0x19A30E70)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A30EA0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int CopyUserTokenByIndexOptions_TypeDefinitionIndex = 33712;
