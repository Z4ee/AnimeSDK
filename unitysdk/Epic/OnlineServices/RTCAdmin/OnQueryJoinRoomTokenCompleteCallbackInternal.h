...
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CE78990)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CE789E0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE786A0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE78680)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int OnQueryJoinRoomTokenCompleteCallbackInternal_TypeDefinitionIndex = 35286;
