...
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1D391780)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1D391760)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1D391740)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1D391830)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1D391770)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1D3917A0)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1D391750)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKCOMPLETECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D391990)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int KickCompleteCallbackInfo_TypeDefinitionIndex = 35938;
