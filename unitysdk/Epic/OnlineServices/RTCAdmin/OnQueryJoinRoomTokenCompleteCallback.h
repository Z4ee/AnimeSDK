...
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D276140)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D276170)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D275C20)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D275C00)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int OnQueryJoinRoomTokenCompleteCallback_TypeDefinitionIndex = 35944;
