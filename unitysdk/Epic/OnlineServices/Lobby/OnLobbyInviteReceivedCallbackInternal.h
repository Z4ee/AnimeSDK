...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91F30)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91F80)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91F20)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF91EB0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyInviteReceivedCallbackInternal_TypeDefinitionIndex = 43625;
