...
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1D81B0)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1D8200)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1D7EB0)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D7EA0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnDestroyLobbyCallbackInternal_TypeDefinitionIndex = 34168;
