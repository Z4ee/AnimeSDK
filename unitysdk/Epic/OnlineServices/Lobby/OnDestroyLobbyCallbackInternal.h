...
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4C0D70)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4C0DC0)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4C0A80)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C0A60)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnDestroyLobbyCallbackInternal_TypeDefinitionIndex = 35731;
