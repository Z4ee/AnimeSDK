...
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EBED40)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EBED90)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EBEA50)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBEA30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnDestroyLobbyCallbackInternal_TypeDefinitionIndex = 41949;
