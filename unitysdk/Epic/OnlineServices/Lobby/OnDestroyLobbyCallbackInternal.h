...
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D82F000)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D82F050)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D82ECF0)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D82ECD0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnDestroyLobbyCallbackInternal_TypeDefinitionIndex = 36390;
