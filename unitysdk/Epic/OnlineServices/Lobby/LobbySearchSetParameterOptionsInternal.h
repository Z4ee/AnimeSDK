...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETPARAMETEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4F980)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETPARAMETEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4F970)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETPARAMETEROPTIONSINTERNAL_SET_COMPARISONOP_OFFSET UNITYSDK_OFFSET(0x26F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETPARAMETEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4F8F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETPARAMETEROPTIONSINTERNAL_SET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x4F880)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchSetParameterOptionsInternal_TypeDefinitionIndex = 36113;
