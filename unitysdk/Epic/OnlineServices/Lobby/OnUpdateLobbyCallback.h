...
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD6180)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD61B0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD5C60)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBD5C40)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnUpdateLobbyCallback_TypeDefinitionIndex = 36419;
