...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS_GET_MAXMEMBERS_OFFSET UNITYSDK_OFFSET(0xA2F4D20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS_SET_MAXMEMBERS_OFFSET UNITYSDK_OFFSET(0xA2F4D30)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xA2F4D40)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyModificationSetMaxMembersOptions_TypeDefinitionIndex = 42719;
