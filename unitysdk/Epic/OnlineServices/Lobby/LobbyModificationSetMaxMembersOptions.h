...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS_GET_MAXMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DCDEF90)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS_SET_MAXMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DCDEFA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCDEFB0)
