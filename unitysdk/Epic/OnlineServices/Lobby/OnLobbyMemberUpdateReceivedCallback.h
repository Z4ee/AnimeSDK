...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF01C00)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF01C30)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF01700)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF016E0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyMemberUpdateReceivedCallback_TypeDefinitionIndex = 35746;
