...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EC32F0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EC3320)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EC2DA0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC2D80)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyMemberUpdateReceivedCallback_TypeDefinitionIndex = 41964;
