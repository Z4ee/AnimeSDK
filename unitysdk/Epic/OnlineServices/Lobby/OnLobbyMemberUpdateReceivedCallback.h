...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x868FA80)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x868FAB0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x868F530)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x868F510)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyMemberUpdateReceivedCallback_TypeDefinitionIndex = 36138;
