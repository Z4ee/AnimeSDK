...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A2E650)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A2E680)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A2E150)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERUPDATERECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2E140)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyMemberUpdateReceivedCallback_TypeDefinitionIndex = 34183;
