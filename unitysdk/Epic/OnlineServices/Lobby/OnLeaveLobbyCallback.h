...
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE2B20)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE2B50)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE2620)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE2600)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLeaveLobbyCallback_TypeDefinitionIndex = 35738;
