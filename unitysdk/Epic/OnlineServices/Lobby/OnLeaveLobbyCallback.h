...
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD80F0)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD8120)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7BF0)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD7BE0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLeaveLobbyCallback_TypeDefinitionIndex = 34175;
