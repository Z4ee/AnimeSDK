...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C05000)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C04FF0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C04E60)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C04F20)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchFindOptionsInternal_TypeDefinitionIndex = 45773;
