...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D272D20)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D272D70)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D272A10)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2729F0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallbackInternal_TypeDefinitionIndex = 36388;
