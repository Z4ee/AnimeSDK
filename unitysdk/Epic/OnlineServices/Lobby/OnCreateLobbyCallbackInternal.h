...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A2E0E0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A2E130)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A2DDE0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2DDD0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallbackInternal_TypeDefinitionIndex = 34166;
