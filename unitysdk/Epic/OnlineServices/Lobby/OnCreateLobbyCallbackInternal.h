...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EBE420)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EBE470)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EBE130)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBE110)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallbackInternal_TypeDefinitionIndex = 41947;
