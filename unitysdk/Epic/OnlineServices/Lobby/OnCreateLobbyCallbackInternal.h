...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF01680)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF016D0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF01390)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF01370)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallbackInternal_TypeDefinitionIndex = 35729;
