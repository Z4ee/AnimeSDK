...
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x93B040)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x93B150)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int DestroyLobbyCallbackInfoInternal_TypeDefinitionIndex = 35626;
