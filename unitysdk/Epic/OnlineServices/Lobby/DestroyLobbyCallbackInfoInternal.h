...
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x7846F0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x3C50420)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x3C50530)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x19050)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int DestroyLobbyCallbackInfoInternal_TypeDefinitionIndex = 45690;
