...
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AF0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x48C00)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x48D10)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int DestroyLobbyCallbackInfoInternal_TypeDefinitionIndex = 41844;
