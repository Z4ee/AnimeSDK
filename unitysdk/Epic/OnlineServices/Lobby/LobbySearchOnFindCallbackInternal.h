...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE0D80)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE0DD0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE0D70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE0D00)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchOnFindCallbackInternal_TypeDefinitionIndex = 45777;
