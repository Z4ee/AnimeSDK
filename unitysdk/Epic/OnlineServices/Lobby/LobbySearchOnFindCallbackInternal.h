...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2F6B10)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2F6B60)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2F6B00)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2F6A90)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchOnFindCallbackInternal_TypeDefinitionIndex = 42734;
