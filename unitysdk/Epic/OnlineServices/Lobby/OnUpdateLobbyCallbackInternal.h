...
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EC7620)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EC7670)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EC7330)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC7310)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnUpdateLobbyCallbackInternal_TypeDefinitionIndex = 41979;
