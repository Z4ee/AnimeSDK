...
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4911A0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4911F0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A490EA0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A490E90)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnUpdateLobbyCallbackInternal_TypeDefinitionIndex = 34198;
