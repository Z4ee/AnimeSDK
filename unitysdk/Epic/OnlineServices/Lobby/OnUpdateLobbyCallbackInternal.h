...
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD64F0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD6540)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DBD61E0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBD61C0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnUpdateLobbyCallbackInternal_TypeDefinitionIndex = 36420;
