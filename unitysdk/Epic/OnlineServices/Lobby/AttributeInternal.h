...
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9EDB40)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_GET_DATA_OFFSET UNITYSDK_OFFSET(0x9ED9D0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x325D00)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9EDB30)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x9EDA40)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9EDAB0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEINTERNAL_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x5B0840)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AttributeInternal_TypeDefinitionIndex = 36267;
