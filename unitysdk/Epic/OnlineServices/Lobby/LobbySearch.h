...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_COPYSEARCHRESULTBYINDEX_OFFSET UNITYSDK_OFFSET(0x1BF8D1E0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_FIND_OFFSET UNITYSDK_OFFSET(0x1BF8D370)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_GETSEARCHRESULTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BF8D5D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_ONFINDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1BF8D120)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_RELEASE_OFFSET UNITYSDK_OFFSET(0x1BF8D810)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1BF8D890)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETLOBBYID_OFFSET UNITYSDK_OFFSET(0x1BF8DAC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETMAXRESULTS_OFFSET UNITYSDK_OFFSET(0x1BF8DCC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETPARAMETER_OFFSET UNITYSDK_OFFSET(0x1BF8DE20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETTARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1BF8E050)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF8D1D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF8D1C0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearch_TypeDefinitionIndex = 43585;
