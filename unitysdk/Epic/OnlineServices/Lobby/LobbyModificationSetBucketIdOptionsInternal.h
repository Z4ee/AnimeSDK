...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8DEEB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8DED90)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_SET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x8DEC10)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8DECC0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyModificationSetBucketIdOptionsInternal_TypeDefinitionIndex = 34132;
