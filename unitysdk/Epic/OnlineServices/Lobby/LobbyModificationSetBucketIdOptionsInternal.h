...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C9110)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9C8FF0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_SET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x9C8E70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETBUCKETIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9C8F20)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyModificationSetBucketIdOptionsInternal_TypeDefinitionIndex = 36354;
