...
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BFADE40)
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BFADE70)
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BFAD940)
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFAD920)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnRTCRoomConnectionChangedCallback_TypeDefinitionIndex = 35754;
