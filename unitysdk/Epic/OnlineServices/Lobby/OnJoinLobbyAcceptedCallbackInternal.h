...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7B860)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7B8B0)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7B560)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA7B550)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyAcceptedCallbackInternal_TypeDefinitionIndex = 34170;
