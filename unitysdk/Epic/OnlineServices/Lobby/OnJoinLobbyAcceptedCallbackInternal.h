...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E1AA780)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E1AA7D0)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E1AA470)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYACCEPTEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1AA450)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyAcceptedCallbackInternal_TypeDefinitionIndex = 36392;
