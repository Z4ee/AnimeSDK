...
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE3B20)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE3B70)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE3B10)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE3AA0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLeaveLobbyCallbackInternal_TypeDefinitionIndex = 45803;
