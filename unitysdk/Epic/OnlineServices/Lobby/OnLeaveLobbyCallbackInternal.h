...
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91AF0)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91B40)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91AE0)
#define EPIC_ONLINESERVICES_LOBBY_ONLEAVELOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF91A70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLeaveLobbyCallbackInternal_TypeDefinitionIndex = 43621;
