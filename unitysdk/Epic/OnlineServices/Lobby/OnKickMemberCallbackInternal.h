...
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE3900)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE3950)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE38F0)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE3880)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnKickMemberCallbackInternal_TypeDefinitionIndex = 45801;
