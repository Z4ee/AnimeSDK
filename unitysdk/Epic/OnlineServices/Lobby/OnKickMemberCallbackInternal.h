...
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF918D0)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF91920)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF918C0)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF91850)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnKickMemberCallbackInternal_TypeDefinitionIndex = 43619;
