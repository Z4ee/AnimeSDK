...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS_GET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x1E5D3B20)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS_SET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x1E5D3B30)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5D3B40)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyOptions_TypeDefinitionIndex = 36443;
