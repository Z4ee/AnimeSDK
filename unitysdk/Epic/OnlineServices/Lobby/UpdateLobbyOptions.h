...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS_GET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x1DCE9850)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS_SET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x1DCE9860)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE9870)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyOptions_TypeDefinitionIndex = 45848;
