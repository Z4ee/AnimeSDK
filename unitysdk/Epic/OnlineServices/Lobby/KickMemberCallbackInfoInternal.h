...
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x28B580)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x898620)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x898730)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int KickMemberCallbackInfoInternal_TypeDefinitionIndex = 34081;
