...
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x49B00)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x49C10)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBERCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int KickMemberCallbackInfoInternal_TypeDefinitionIndex = 36036;
