...
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A6A760)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A6A6E0)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x3A6A4A0)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A6A550)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A6A6D0)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x3A6A610)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int PromoteMemberOptionsInternal_TypeDefinitionIndex = 43647;
