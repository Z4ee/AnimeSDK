...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETPERMISSIONLEVELOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4EBA0)
...
{
	inline static constexpr unsigned int LobbyModificationSetPermissionLevelOptionsInternal_TypeDefinitionIndex = 36093;
