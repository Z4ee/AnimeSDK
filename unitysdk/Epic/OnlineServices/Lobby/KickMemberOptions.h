...
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x1DBD0E80)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DBD0EA0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1DBD0EC0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x1DBD0E90)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1DBD0EB0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1DBD0ED0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBD0EE0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int KickMemberOptions_TypeDefinitionIndex = 36304;
