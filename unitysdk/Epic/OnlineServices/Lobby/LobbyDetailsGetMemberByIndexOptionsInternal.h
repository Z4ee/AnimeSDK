...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4B400)
...
{
	inline static constexpr unsigned int LobbyDetailsGetMemberByIndexOptionsInternal_TypeDefinitionIndex = 36062;
