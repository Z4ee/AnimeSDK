...
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1A2BCD10)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1A2BCD30)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_1_OFFSET UNITYSDK_OFFSET(0x1A2BCEB0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1A2BCD20)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_OFFSET UNITYSDK_OFFSET(0x1A2BCD50)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1A2BCD40)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2BD0A0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int Attribute_TypeDefinitionIndex = 34044;
