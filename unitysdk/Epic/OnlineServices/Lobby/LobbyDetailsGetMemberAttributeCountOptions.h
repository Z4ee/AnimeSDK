...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERATTRIBUTECOUNTOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xA2E9FA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERATTRIBUTECOUNTOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xA2E9FB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERATTRIBUTECOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xA2E9FC0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyDetailsGetMemberAttributeCountOptions_TypeDefinitionIndex = 42688;
