...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4DC80)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4DC70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONSINTERNAL_SET_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x4DB80)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4DBF0)
...
{
	inline static constexpr unsigned int LobbyModificationAddAttributeOptionsInternal_TypeDefinitionIndex = 36079;
