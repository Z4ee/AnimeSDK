...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONS_GET_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x8684AA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONS_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x8684AC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONS_SET_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x8684AB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONS_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x8684AD0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDATTRIBUTEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8684AE0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyModificationAddAttributeOptions_TypeDefinitionIndex = 36078;
