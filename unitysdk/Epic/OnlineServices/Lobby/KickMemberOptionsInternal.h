...
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9029E0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x902970)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x902730)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9027E0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x902960)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x9028A0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int KickMemberOptionsInternal_TypeDefinitionIndex = 34083;
