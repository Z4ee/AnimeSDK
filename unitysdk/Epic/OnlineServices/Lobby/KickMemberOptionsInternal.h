...
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4A970)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4A900)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x4A6C0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x4A770)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4A8F0)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x4A830)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int KickMemberOptionsInternal_TypeDefinitionIndex = 41864;
