...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYJOINLOBBYACCEPTED_OFFSET UNITYSDK_OFFSET(0x1CB91330)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x1CB915B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB91830)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYMEMBERSTATUSRECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB91AB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYMEMBERUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB91D30)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB91FB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYRTCROOMCONNECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1CB92230)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_COPYLOBBYDETAILSHANDLEBYINVITEID_OFFSET UNITYSDK_OFFSET(0x1CB925A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_COPYLOBBYDETAILSHANDLEBYUIEVENTID_OFFSET UNITYSDK_OFFSET(0x1CB927B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_COPYLOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x1CB92410)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_CREATELOBBYSEARCH_OFFSET UNITYSDK_OFFSET(0x1CB92B00)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_CREATELOBBY_OFFSET UNITYSDK_OFFSET(0x1CB92940)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_DESTROYLOBBY_OFFSET UNITYSDK_OFFSET(0x1CB92C90)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_GETINVITECOUNT_OFFSET UNITYSDK_OFFSET(0x1CB92E50)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_GETINVITEIDBYINDEX_OFFSET UNITYSDK_OFFSET(0x1CB93040)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_GETRTCROOMNAME_OFFSET UNITYSDK_OFFSET(0x1CB933B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ISRTCROOMCONNECTED_OFFSET UNITYSDK_OFFSET(0x1CB936D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_JOINLOBBY_OFFSET UNITYSDK_OFFSET(0x1CB938A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_KICKMEMBER_OFFSET UNITYSDK_OFFSET(0x1CB93A60)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_LEAVELOBBY_OFFSET UNITYSDK_OFFSET(0x1CB93C20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONCREATELOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90980)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONDESTROYLOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90A10)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONJOINLOBBYACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90AA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONJOINLOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90B30)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONKICKMEMBERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90BC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLEAVELOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90C50)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYINVITEACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90CE0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYINVITERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90D70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90E00)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYMEMBERUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90E90)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90F20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONPROMOTEMEMBERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB90FB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONQUERYINVITESCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB91040)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONREJECTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB91160)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONRTCROOMCONNECTIONCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB910D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONSENDINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB911F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONUPDATELOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1CB91280)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_PROMOTEMEMBER_OFFSET UNITYSDK_OFFSET(0x1CB93DE0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_QUERYINVITES_OFFSET UNITYSDK_OFFSET(0x1CB93FC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REJECTINVITE_OFFSET UNITYSDK_OFFSET(0x1CB94210)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYJOINLOBBYACCEPTED_OFFSET UNITYSDK_OFFSET(0x1CB943F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x1CB944D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB945B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYMEMBERSTATUSRECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB94690)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYMEMBERUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB94770)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x1CB94850)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYRTCROOMCONNECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1CB94930)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_SENDINVITE_OFFSET UNITYSDK_OFFSET(0x1CB94A10)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_UPDATELOBBYMODIFICATION_OFFSET UNITYSDK_OFFSET(0x1CB94E10)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_UPDATELOBBY_OFFSET UNITYSDK_OFFSET(0x1CB94BD0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CB91320)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB91310)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyInterface_TypeDefinitionIndex = 35675;
