...
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x4A120)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x4A230)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LeaveLobbyCallbackInfoInternal_TypeDefinitionIndex = 36040;
