...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSCOPYATTRIBUTEBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4B000)
...
{
	inline static constexpr unsigned int LobbyDetailsCopyAttributeByIndexOptionsInternal_TypeDefinitionIndex = 41872;
