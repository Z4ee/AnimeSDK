...
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C71CB30)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C71CB60)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C71C630)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C71C610)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnPromoteMemberCallback_TypeDefinitionIndex = 35750;
