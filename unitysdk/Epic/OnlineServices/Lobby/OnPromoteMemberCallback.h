...
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8690CC0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8690CF0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8690770)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8690750)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnPromoteMemberCallback_TypeDefinitionIndex = 36142;
