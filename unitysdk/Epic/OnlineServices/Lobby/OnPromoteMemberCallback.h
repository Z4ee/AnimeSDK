...
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A490590)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4905C0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A490090)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A490080)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnPromoteMemberCallback_TypeDefinitionIndex = 34187;
