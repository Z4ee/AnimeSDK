...
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE47E0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE4830)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE47D0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE4760)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnPromoteMemberCallbackInternal_TypeDefinitionIndex = 45815;
