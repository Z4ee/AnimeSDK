...
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF927B0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF92800)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF927A0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF92730)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnPromoteMemberCallbackInternal_TypeDefinitionIndex = 43633;
