...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA24580)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA24510)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_ALLOWINVITES_OFFSET UNITYSDK_OFFSET(0xA24120)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_BUCKETID_OFFSET UNITYSDK_OFFSET(0xA241D0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_DISABLEHOSTMIGRATION_OFFSET UNITYSDK_OFFSET(0xA24280)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_ENABLERTCROOM_OFFSET UNITYSDK_OFFSET(0xA24330)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xA24450)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0xA243E0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA23FB0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_MAXLOBBYMEMBERS_OFFSET UNITYSDK_OFFSET(0x5B0840)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA24500)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_PERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0x352890)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0xA24070)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbyOptionsInternal_TypeDefinitionIndex = 36281;
