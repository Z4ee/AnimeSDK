...
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A6AC30)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3A6AC20)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3A6AA90)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3A6AB50)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int QueryInvitesOptionsInternal_TypeDefinitionIndex = 43651;
