...
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C069D0)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C069C0)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C06830)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C068F0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int QueryInvitesOptionsInternal_TypeDefinitionIndex = 45833;
