...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x52490)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x52360)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x521D0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x52290)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyOptionsInternal_TypeDefinitionIndex = 36177;
