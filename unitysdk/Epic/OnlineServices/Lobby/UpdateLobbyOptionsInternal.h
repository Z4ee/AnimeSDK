...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x52E90)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x52D60)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x52BD0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x52C90)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyOptionsInternal_TypeDefinitionIndex = 42003;
