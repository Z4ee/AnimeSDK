...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYUPDATERECEIVEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FA16B0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYUPDATERECEIVEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FA1700)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYUPDATERECEIVEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FA13B0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYUPDATERECEIVEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA13A0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyUpdateReceivedCallbackInternal_TypeDefinitionIndex = 34186;
