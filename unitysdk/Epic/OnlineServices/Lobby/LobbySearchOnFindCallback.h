...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE0CC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE0CF0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCE0270)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHONFINDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE0BD0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchOnFindCallback_TypeDefinitionIndex = 45776;
