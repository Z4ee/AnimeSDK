...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDMEMBERATTRIBUTEOPTIONS_GET_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BF8BF40)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDMEMBERATTRIBUTEOPTIONS_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1BF8BF60)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDMEMBERATTRIBUTEOPTIONS_SET_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1BF8BF50)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDMEMBERATTRIBUTEOPTIONS_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1BF8BF70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONADDMEMBERATTRIBUTEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF8BF80)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyModificationAddMemberAttributeOptions_TypeDefinitionIndex = 43570;
