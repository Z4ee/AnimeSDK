...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETMAXRESULTSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4F810)
...
{
	inline static constexpr unsigned int LobbySearchSetMaxResultsOptionsInternal_TypeDefinitionIndex = 36111;
