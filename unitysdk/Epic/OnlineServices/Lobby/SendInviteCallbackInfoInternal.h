...
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x9E0320)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x9E0430)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2B68B0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int SendInviteCallbackInfoInternal_TypeDefinitionIndex = 35777;
