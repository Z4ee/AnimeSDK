...
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A3260)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9A31F0)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x9A3070)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9A3120)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9A31E0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AddNotifyRTCRoomConnectionChangedOptionsInternal_TypeDefinitionIndex = 35606;
