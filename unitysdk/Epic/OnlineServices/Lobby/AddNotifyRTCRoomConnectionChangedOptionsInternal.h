...
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3AB7B00)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AB7A80)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x3AB7900)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AB79B0)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AB7A70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AddNotifyRTCRoomConnectionChangedOptionsInternal_TypeDefinitionIndex = 43488;
