...
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1AE2D5E0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1AE2D5F0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2D600)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetInviteCountOptions_TypeDefinitionIndex = 34066;
