...
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D38A300)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D38A350)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D389FF0)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D389FD0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnSendInviteCallbackInternal_TypeDefinitionIndex = 36418;
