...
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1C2B7010)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C2B6FF0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1C2B7020)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C2B7000)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2B7030)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetInviteIdByIndexOptions_TypeDefinitionIndex = 43513;
