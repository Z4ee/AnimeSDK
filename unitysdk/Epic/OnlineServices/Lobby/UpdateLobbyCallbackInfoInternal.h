...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x28B580)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8194D0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8195E0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyCallbackInfoInternal_TypeDefinitionIndex = 34218;
