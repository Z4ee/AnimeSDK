...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x526F0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x52800)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyCallbackInfoInternal_TypeDefinitionIndex = 41999;
