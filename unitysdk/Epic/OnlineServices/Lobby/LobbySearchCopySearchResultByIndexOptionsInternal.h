...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHCOPYSEARCHRESULTBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4ED20)
...
{
	inline static constexpr unsigned int LobbySearchCopySearchResultByIndexOptionsInternal_TypeDefinitionIndex = 36097;
