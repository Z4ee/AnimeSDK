...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x868A860)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x868A890)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x868A310)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x868A2F0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallback_TypeDefinitionIndex = 36120;
