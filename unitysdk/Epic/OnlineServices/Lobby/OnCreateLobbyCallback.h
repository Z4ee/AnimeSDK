...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A80BD80)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A80BDB0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A809FB0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80BD70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallback_TypeDefinitionIndex = 34165;
