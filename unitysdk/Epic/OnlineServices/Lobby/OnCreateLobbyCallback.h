...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CB96D80)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CB96DB0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CB94FA0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB96D60)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallback_TypeDefinitionIndex = 35728;
