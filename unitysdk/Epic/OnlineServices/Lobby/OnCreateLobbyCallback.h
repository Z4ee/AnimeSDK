...
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EBE0D0)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EBE100)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EBDB80)
#define EPIC_ONLINESERVICES_LOBBY_ONCREATELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBDB60)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnCreateLobbyCallback_TypeDefinitionIndex = 41946;
