...
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA24990)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA24920)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xA247A0)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xA24850)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA24910)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetRTCRoomNameOptionsInternal_TypeDefinitionIndex = 36293;
