...
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONS_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8675BA0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8675BC0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONS_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8675BB0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8675BD0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x8675BE0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int IsRTCRoomConnectedOptions_TypeDefinitionIndex = 36027;
