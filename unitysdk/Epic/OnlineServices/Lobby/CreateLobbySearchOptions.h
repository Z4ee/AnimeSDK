...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS_GET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x1B60DBA0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS_SET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x1B60DBB0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60DBC0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbySearchOptions_TypeDefinitionIndex = 35623;
