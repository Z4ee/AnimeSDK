...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS_GET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x86742B0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS_SET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x86742C0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x86742D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbySearchOptions_TypeDefinitionIndex = 36015;
