...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8EBFF80)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8EBFFD0)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x8EBFC90)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBFC70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyCallbackInternal_TypeDefinitionIndex = 41953;
