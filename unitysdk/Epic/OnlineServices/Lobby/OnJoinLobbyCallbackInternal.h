...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x868C710)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x868C760)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x868C420)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x868C400)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyCallbackInternal_TypeDefinitionIndex = 36127;
