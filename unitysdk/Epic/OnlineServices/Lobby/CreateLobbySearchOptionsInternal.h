...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9023A0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_SET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x5B6810)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86F730)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbySearchOptionsInternal_TypeDefinitionIndex = 34061;
