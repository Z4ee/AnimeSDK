...
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D939A50)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D939A80)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D939530)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D939510)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnSendInviteCallback_TypeDefinitionIndex = 36417;
