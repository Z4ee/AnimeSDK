...
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AC190)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9AC120)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x9ABEE0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9ABF90)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9AC110)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x9AC050)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int SendInviteOptionsInternal_TypeDefinitionIndex = 36438;
