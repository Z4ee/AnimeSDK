...
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C512F0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C51270)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x3C510F0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3C511A0)
#define EPIC_ONLINESERVICES_LOBBY_ISRTCROOMCONNECTEDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C51260)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int IsRTCRoomConnectedOptionsInternal_TypeDefinitionIndex = 45700;
