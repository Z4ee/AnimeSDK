...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x868F160)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x868F190)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x868EC10)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x868EBF0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnLobbyMemberStatusReceivedCallback_TypeDefinitionIndex = 36136;
