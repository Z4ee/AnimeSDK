...
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4A4D0)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4A460)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x4A3A0)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x4A2E0)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4A450)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LeaveLobbyOptionsInternal_TypeDefinitionIndex = 36042;
