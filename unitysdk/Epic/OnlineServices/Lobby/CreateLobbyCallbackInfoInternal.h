...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x477E0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x478F0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x59D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbyCallbackInfoInternal_TypeDefinitionIndex = 36012;
