...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x28B580)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8DE9E0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8DEAF0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbyCallbackInfoInternal_TypeDefinitionIndex = 34057;
