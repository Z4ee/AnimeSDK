...
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A40F0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9A4080)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x9A3FC0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9A3F00)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9A4070)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int DestroyLobbyOptionsInternal_TypeDefinitionIndex = 35628;
