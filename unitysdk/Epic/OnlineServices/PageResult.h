...
#define EPIC_ONLINESERVICES_PAGERESULT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ADEC120)
#define EPIC_ONLINESERVICES_PAGERESULT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x1ADEC100)
#define EPIC_ONLINESERVICES_PAGERESULT_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADEC140)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_1_OFFSET UNITYSDK_OFFSET(0x1ADEC230)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ADEC130)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_OFFSET UNITYSDK_OFFSET(0x1ADEC160)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x1ADEC110)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADEC150)
#define EPIC_ONLINESERVICES_PAGERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEC390)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int PageResult_TypeDefinitionIndex = 33307;
