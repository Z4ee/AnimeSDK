...
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x49080)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x49070)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x48FA0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x48EF0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int GetLeaderboardUserScoreCountOptionsInternal_TypeDefinitionIndex = 42826;
