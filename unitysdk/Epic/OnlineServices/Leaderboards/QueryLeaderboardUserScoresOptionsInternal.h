...
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3AB71C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3AB7140)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x3AB6FE0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x3AB7070)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3AB7130)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x3AB6F50)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_STATINFO_OFFSET UNITYSDK_OFFSET(0x3AB6E30)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_USERIDS_OFFSET UNITYSDK_OFFSET(0x3AB6DC0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int QueryLeaderboardUserScoresOptionsInternal_TypeDefinitionIndex = 43711;
