...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x1D25AB80)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1D25AB60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_1_OFFSET UNITYSDK_OFFSET(0x1D25AD00)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_OFFSET UNITYSDK_OFFSET(0x1D25ABA0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x1D25AB90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1D25AB70)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25AEF0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int LeaderboardUserScore_TypeDefinitionIndex = 35809;
