...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x497A0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x6EE0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_GET_USERID_OFFSET UNITYSDK_OFFSET(0x49580)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x49790)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x496B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_USERID_OFFSET UNITYSDK_OFFSET(0x495F0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int LeaderboardUserScoreInternal_TypeDefinitionIndex = 42831;
