...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONS_GET_LEADERBOARDRECORDINDEX_OFFSET UNITYSDK_OFFSET(0x1C81EA20)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONS_SET_LEADERBOARDRECORDINDEX_OFFSET UNITYSDK_OFFSET(0x1C81EA30)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81EA40)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int CopyLeaderboardRecordByIndexOptions_TypeDefinitionIndex = 35790;
