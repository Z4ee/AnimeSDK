...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1ADE1E60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1ADE1E40)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1ADE1E70)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1ADE1E50)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE1E80)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int CopyLeaderboardUserScoreByUserIdOptions_TypeDefinitionIndex = 35796;
