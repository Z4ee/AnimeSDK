...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x86664D0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_GET_USERID_OFFSET UNITYSDK_OFFSET(0x86664B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x86664E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_SET_USERID_OFFSET UNITYSDK_OFFSET(0x86664C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x86664F0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int CopyLeaderboardUserScoreByUserIdOptions_TypeDefinitionIndex = 36188;
