...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x18CD7450)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_GET_USERID_OFFSET UNITYSDK_OFFSET(0x18CD7430)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x18CD7460)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS_SET_USERID_OFFSET UNITYSDK_OFFSET(0x18CD7440)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYUSERIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD7470)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int CopyLeaderboardUserScoreByUserIdOptions_TypeDefinitionIndex = 34233;
