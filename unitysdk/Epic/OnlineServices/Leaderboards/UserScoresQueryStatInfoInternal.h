...
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3C4E100)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_GET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x7845E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x3C4DEC0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3C4E0F0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x3A2C790)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3C4E020)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x3C4DF70)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int UserScoresQueryStatInfoInternal_TypeDefinitionIndex = 45895;
