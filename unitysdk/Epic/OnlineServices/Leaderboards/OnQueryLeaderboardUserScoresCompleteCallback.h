...
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDUSERSCORESCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE23B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDUSERSCORESCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE23E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDUSERSCORESCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADE1EB0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDUSERSCORESCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE1E90)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int OnQueryLeaderboardUserScoresCompleteCallback_TypeDefinitionIndex = 35820;
