...
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x866C340)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x866C370)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x866B0B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x866C320)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int OnQueryLeaderboardRanksCompleteCallback_TypeDefinitionIndex = 36208;
