...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x438B0)
...
{
	inline static constexpr unsigned int CopyLeaderboardRecordByIndexOptionsInternal_TypeDefinitionIndex = 42009;
