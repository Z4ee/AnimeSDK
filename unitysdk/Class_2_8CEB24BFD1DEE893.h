...
#define CLASS_2_8CEB24BFD1DEE893_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16EF92B0)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_0595A0AC6EC83CE8_OFFSET UNITYSDK_OFFSET(0x16EF9C40)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x16EF9E50)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_715628F49D103CE6_OFFSET UNITYSDK_OFFSET(0x16EF9750)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_963F877DAF55B26E_OFFSET UNITYSDK_OFFSET(0x16EF91B0)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_B03F6D31318CC2B8_OFFSET UNITYSDK_OFFSET(0x16EF9940)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_B7797AF42220DD8F_OFFSET UNITYSDK_OFFSET(0x16EF92D0)
#define CLASS_2_8CEB24BFD1DEE893_METHOD_2_CE15DB2E8BA8BB3E_OFFSET UNITYSDK_OFFSET(0x16EF9320)
#define CLASS_2_8CEB24BFD1DEE893_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16EF92C0)
#define CLASS_2_8CEB24BFD1DEE893__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFA130)
#define CLASS_2_8CEB24BFD1DEE893__ONBIND_OFFSET UNITYSDK_OFFSET(0x16EF8F20)
#define CLASS_2_8CEB24BFD1DEE893__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x16EF9260)

inline static constexpr unsigned int Class_2_8CEB24BFD1DEE893_TypeDefinitionIndex = 72147;
...
public:
	...
	{
		return (::Class_2_8CEB24BFD1DEE893**)Il2CppClass::FromTypeDefinitionIndex(Class_2_8CEB24BFD1DEE893_TypeDefinitionIndex)->GetStaticField(0x4880);
	}
	...
	::Class_1_23F67DD15593C8D6* GIKJFPPGCHA; // 0x60
	::UnityEngine::RectTransform* FPCDGPHNCJE; // 0x68
	::UnityEngine::UI::Slider* LMBCAPKPNMH; // 0x70
	::UnityEngine::Animation* OFDFAIMLJKB; // 0x78
	::UnityEngine::RectTransform* MDAALDPJNAL; // 0x80
	::UnityEngine::UI::Slider* KODEHPGLFJD; // 0x88
	::UnityEngine::RectTransform* DCNCKFCJJKL; // 0x90
	::UnityEngine::UI::Slider* KINFJKKKIHH; // 0x98
	::UnityEngine::UI::Slider* GDPAHPLCMLO; // 0xA0
	::UnityEngine::RectTransform* NPFLAHJMJGC; // 0xA8
	::System::Boolean FNECNBDADDJ; // 0xB0
	::System::Boolean JLFOHMHDMHM; // 0xB1
