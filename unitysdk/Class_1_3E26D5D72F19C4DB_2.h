...
#define CLASS_1_3E26D5D72F19C4DB_2_GET_FACTORY_OFFSET UNITYSDK_OFFSET(0x19CC9D30)
#define CLASS_1_3E26D5D72F19C4DB_2_METHOD_1_4D5BEDC75B4151A4_OFFSET UNITYSDK_OFFSET(0x19CC9D50)
#define CLASS_1_3E26D5D72F19C4DB_2_METHOD_1_DDD01EA0C1E2DD26_OFFSET UNITYSDK_OFFSET(0x19CC9EF0)
#define CLASS_1_3E26D5D72F19C4DB_2_SET_FACTORY_OFFSET UNITYSDK_OFFSET(0x19CC9D40)
#define CLASS_1_3E26D5D72F19C4DB_2__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC9E70)

inline static constexpr unsigned int Class_1_3E26D5D72F19C4DB_2_TypeDefinitionIndex = 62811;

class Class_1_3E26D5D72F19C4DB_2 : public ::System::Object
{
public:
	::Class_1_AE30349E456D5B05* _Factory_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::Struct_2_276321B6B122C69C_1, ::Class_1_C85C4DAB350DD5FC_1*>* IEHKMMAEDMH; // 0x18
