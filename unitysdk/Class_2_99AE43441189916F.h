...
#define CLASS_2_99AE43441189916F_GET_BPSTYLE_OFFSET UNITYSDK_OFFSET(0x18A58EA0)
#define CLASS_2_99AE43441189916F_METHOD_2_078D85152011B919_1_OFFSET UNITYSDK_OFFSET(0x18A587E0)
#define CLASS_2_99AE43441189916F_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x18A58780)
#define CLASS_2_99AE43441189916F_METHOD_2_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x18A58FF0)
#define CLASS_2_99AE43441189916F_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x18A58EC0)
#define CLASS_2_99AE43441189916F_METHOD_2_35785E988ABA54BD_OFFSET UNITYSDK_OFFSET(0x18A58A40)
#define CLASS_2_99AE43441189916F_METHOD_2_45E06D1A6A217312_OFFSET UNITYSDK_OFFSET(0x18A58BA0)
#define CLASS_2_99AE43441189916F_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x18A58E50)
#define CLASS_2_99AE43441189916F_METHOD_2_F641587F832F1EE5_OFFSET UNITYSDK_OFFSET(0x18A58850)
#define CLASS_2_99AE43441189916F_SET_BPSTYLE_OFFSET UNITYSDK_OFFSET(0x18A58EB0)
#define CLASS_2_99AE43441189916F__CTOR_OFFSET UNITYSDK_OFFSET(0x18A590A0)
#define CLASS_2_99AE43441189916F___ONEFFECTFINISH_B__19_0_OFFSET UNITYSDK_OFFSET(0x18A590D0)

inline static constexpr unsigned int Class_2_99AE43441189916F_TypeDefinitionIndex = 71448;
...
public:
	...
	::Class_2_99AE43441189916F_Struct_2_F4FD9E85E8CC031F CBGJNJGLGAG; // 0x70
	::RPG::Client::RPGAnimationEvent* MEDGLNFKGDC; // 0x98
	::RPG::Client::PrefabLoadMeta* MIOEBLHIJHL; // 0xA0
	::UnityEngine::Transform* CDJGLKECPHI; // 0xA8
	::UnityEngine::Transform* HHJBHFGCBPN; // 0xB0
	::UnityEngine::UI::Image* EIAEMNMJOJI; // 0xB8
	::UnityEngine::Transform* FIACEDOMPEA; // 0xC0
	::UnityEngine::Animation* JPHOOFFIAAH; // 0xC8
	::UnityEngine::Transform* MFCELDGNMON; // 0xD0
