...
#define CLASS_1_D97B032D25740832_METHOD_1_27EEF2365AEB96A1_OFFSET UNITYSDK_OFFSET(0xC011160)
#define CLASS_1_D97B032D25740832_METHOD_1_5E72916301E347E2_OFFSET UNITYSDK_OFFSET(0xC011450)
#define CLASS_1_D97B032D25740832_METHOD_1_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0xC011360)
#define CLASS_1_D97B032D25740832_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC011530)
#define CLASS_1_D97B032D25740832__CTOR_OFFSET UNITYSDK_OFFSET(0xC011130)

inline static constexpr unsigned int Class_1_D97B032D25740832_TypeDefinitionIndex = 78621;

class Class_1_D97B032D25740832 : public ::System::Object
{
public:
	::UnityEngine::Transform* OJAHLJGABMJ; // 0x10
	::Class_3_3F1B1DE9D9F51912* EPKIDMNCGAA; // 0x18
	::System::Single JGLKOOAFOBO; // 0x20
	::System::Single MDALIGIMJLE; // 0x24
	::System::Single AJILPHGIIKO; // 0x28
	::System::Single BKMLJMADLGL; // 0x2C
