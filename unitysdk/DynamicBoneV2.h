...
#define DYNAMICBONEV2_AFTERSWITCHLOD_OFFSET UNITYSDK_OFFSET(0x1F5EB390)
#define DYNAMICBONEV2_APPENDPARTICLESV2_OFFSET UNITYSDK_OFFSET(0x1F5EEE00)
#define DYNAMICBONEV2_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1F5EF680)
#define DYNAMICBONEV2_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1F5EE930)
#define DYNAMICBONEV2_BINDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F5EB380)
#define DYNAMICBONEV2_CACHEANIMPOSE_OFFSET UNITYSDK_OFFSET(0x1F5EC500)
#define DYNAMICBONEV2_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1F5EC0F0)
#define DYNAMICBONEV2_GETLABELTEXT_OFFSET UNITYSDK_OFFSET(0x1F5EAEF0)
#define DYNAMICBONEV2_GETPATH_OFFSET UNITYSDK_OFFSET(0x1F5EB1D0)
#define DYNAMICBONEV2_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1F5EBBB0)
#define DYNAMICBONEV2_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1F5EBBD0)
#define DYNAMICBONEV2_GET_M_COLLIDERS_OFFSET UNITYSDK_OFFSET(0x1F5EB190)
#define DYNAMICBONEV2_GET_M_DISTANCETOOBJECT_OFFSET UNITYSDK_OFFSET(0x1F5EB170)
#define DYNAMICBONEV2_GET_M_DISTANTDISABLE_OFFSET UNITYSDK_OFFSET(0x1F5EB130)
#define DYNAMICBONEV2_GET_M_EXCLUSIONS_OFFSET UNITYSDK_OFFSET(0x1F5EB1B0)
#define DYNAMICBONEV2_GET_M_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0x1F5EB110)
#define DYNAMICBONEV2_GET_M_REFERENCEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F5EB150)
#define DYNAMICBONEV2_GET_M_ROOT_OFFSET UNITYSDK_OFFSET(0x1F5EAED0)
#define DYNAMICBONEV2_GET_M_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1F5EB0F0)
#define DYNAMICBONEV2_GET_M_UPDATERATE_OFFSET UNITYSDK_OFFSET(0x1F5EB0B0)
#define DYNAMICBONEV2_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F5EBBC0)
#define DYNAMICBONEV2_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1F5EB6C0)
#define DYNAMICBONEV2_MANUALFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5EBFD0)
#define DYNAMICBONEV2_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5ECB30)
#define DYNAMICBONEV2_MANUALONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F5EBCC0)
#define DYNAMICBONEV2_MANUALONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1F5ECCB0)
#define DYNAMICBONEV2_MANUALONENABLE_OFFSET UNITYSDK_OFFSET(0x1F5EBC60)
#define DYNAMICBONEV2_MANUALONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F5ECBD0)
#define DYNAMICBONEV2_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x1F5EBCD0)
#define DYNAMICBONEV2_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5ECB20)
#define DYNAMICBONEV2_MANUALWAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5EC050)
#define DYNAMICBONEV2_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1F5F0F10)
#define DYNAMICBONEV2_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1F5EC010)
#define DYNAMICBONEV2_REBINDTRANSFORMTOPARTICLES_OFFSET UNITYSDK_OFFSET(0x1F5EB3A0)
#define DYNAMICBONEV2_RECURSIONPROCESSPARTICLES_OFFSET UNITYSDK_OFFSET(0x1F5F0750)
#define DYNAMICBONEV2_RECURSIONSETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1F5EF570)
#define DYNAMICBONEV2_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1F5EB8C0)
#define DYNAMICBONEV2_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1F5EB660)
#define DYNAMICBONEV2_SETUPPARTICLES_1_OFFSET UNITYSDK_OFFSET(0x1F5F00C0)
#define DYNAMICBONEV2_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1F5EBCE0)
#define DYNAMICBONEV2_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1F5EB670)
#define DYNAMICBONEV2_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1F5EBBE0)
#define DYNAMICBONEV2_SET_M_UPDATERATE_OFFSET UNITYSDK_OFFSET(0x1F5EB0D0)
#define DYNAMICBONEV2_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1F5EE140)
#define DYNAMICBONEV2_UPDATEDYNAMICBONES_1_OFFSET UNITYSDK_OFFSET(0x1F5EC7D0)
#define DYNAMICBONEV2_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1F5ED050)
#define DYNAMICBONEV2_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1F5EEF60)
#define DYNAMICBONEV2_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1F5ED060)
#define DYNAMICBONEV2_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1F5ED3F0)
#define DYNAMICBONEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5F0F70)
#define DYNAMICBONEV2__RECURSIONSETUPPARTICLES_B__70_0_OFFSET UNITYSDK_OFFSET(0x1F5F10B0)

inline static constexpr unsigned int DynamicBoneV2_TypeDefinitionIndex = 35290;
