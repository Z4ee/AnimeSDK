...
#define DYNAMICBONEV2_AFTERSWITCHLOD_OFFSET UNITYSDK_OFFSET(0x1E1B1580)
#define DYNAMICBONEV2_APPENDPARTICLESV2_OFFSET UNITYSDK_OFFSET(0x1E1B5220)
#define DYNAMICBONEV2_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1B5AA0)
#define DYNAMICBONEV2_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E1B4D30)
#define DYNAMICBONEV2_BINDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E1B1570)
#define DYNAMICBONEV2_CACHEANIMPOSE_OFFSET UNITYSDK_OFFSET(0x1E1B26F0)
#define DYNAMICBONEV2_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1E1B22E0)
#define DYNAMICBONEV2_GETLABELTEXT_OFFSET UNITYSDK_OFFSET(0x1E1B10E0)
#define DYNAMICBONEV2_GETPATH_OFFSET UNITYSDK_OFFSET(0x1E1B13C0)
#define DYNAMICBONEV2_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1E1B1DA0)
#define DYNAMICBONEV2_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1E1B1DC0)
#define DYNAMICBONEV2_GET_M_COLLIDERS_OFFSET UNITYSDK_OFFSET(0x1E1B1380)
#define DYNAMICBONEV2_GET_M_DISTANCETOOBJECT_OFFSET UNITYSDK_OFFSET(0x1E1B1360)
#define DYNAMICBONEV2_GET_M_DISTANTDISABLE_OFFSET UNITYSDK_OFFSET(0x1E1B1320)
#define DYNAMICBONEV2_GET_M_EXCLUSIONS_OFFSET UNITYSDK_OFFSET(0x1E1B13A0)
#define DYNAMICBONEV2_GET_M_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0x1E1B1300)
#define DYNAMICBONEV2_GET_M_REFERENCEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E1B1340)
#define DYNAMICBONEV2_GET_M_ROOT_OFFSET UNITYSDK_OFFSET(0x1E1B10C0)
#define DYNAMICBONEV2_GET_M_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E1B12E0)
#define DYNAMICBONEV2_GET_M_UPDATERATE_OFFSET UNITYSDK_OFFSET(0x1E1B12A0)
#define DYNAMICBONEV2_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E1B1DB0)
#define DYNAMICBONEV2_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E1B18B0)
#define DYNAMICBONEV2_MANUALFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1B21C0)
#define DYNAMICBONEV2_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1B2D20)
#define DYNAMICBONEV2_MANUALONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E1B1EB0)
#define DYNAMICBONEV2_MANUALONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1E1B2E90)
#define DYNAMICBONEV2_MANUALONENABLE_OFFSET UNITYSDK_OFFSET(0x1E1B1E50)
#define DYNAMICBONEV2_MANUALONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E1B2DC0)
#define DYNAMICBONEV2_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x1E1B1EC0)
#define DYNAMICBONEV2_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1B2D10)
#define DYNAMICBONEV2_MANUALWAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1B2240)
#define DYNAMICBONEV2_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1E1B73B0)
#define DYNAMICBONEV2_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1E1B2200)
#define DYNAMICBONEV2_REBINDTRANSFORMTOPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1B1590)
#define DYNAMICBONEV2_RECURSIONPROCESSPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1B6BE0)
#define DYNAMICBONEV2_RECURSIONSETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1B5990)
#define DYNAMICBONEV2_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1E1B1AB0)
#define DYNAMICBONEV2_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1E1B1850)
#define DYNAMICBONEV2_SETUPPARTICLES_1_OFFSET UNITYSDK_OFFSET(0x1E1B6530)
#define DYNAMICBONEV2_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1B1ED0)
#define DYNAMICBONEV2_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1E1B1860)
#define DYNAMICBONEV2_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1E1B1DD0)
#define DYNAMICBONEV2_SET_M_UPDATERATE_OFFSET UNITYSDK_OFFSET(0x1E1B12C0)
#define DYNAMICBONEV2_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1E1B44E0)
#define DYNAMICBONEV2_UPDATEDYNAMICBONES_1_OFFSET UNITYSDK_OFFSET(0x1E1B29C0)
#define DYNAMICBONEV2_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1E1B3230)
#define DYNAMICBONEV2_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E1B5380)
#define DYNAMICBONEV2_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1E1B3240)
#define DYNAMICBONEV2_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1E1B35E0)
#define DYNAMICBONEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B7410)
#define DYNAMICBONEV2__RECURSIONSETUPPARTICLES_B__70_0_OFFSET UNITYSDK_OFFSET(0x1E1B7550)

inline static constexpr unsigned int DynamicBoneV2_TypeDefinitionIndex = 34631;
