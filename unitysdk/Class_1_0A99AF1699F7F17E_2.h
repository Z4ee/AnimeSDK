...
#define CLASS_1_0A99AF1699F7F17E_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E434A10)
#define CLASS_1_0A99AF1699F7F17E_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4345F0)
#define CLASS_1_0A99AF1699F7F17E_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E434770)
#define CLASS_1_0A99AF1699F7F17E_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E434630)
#define CLASS_1_0A99AF1699F7F17E_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E434890)
#define CLASS_1_0A99AF1699F7F17E_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E434B50)
#define CLASS_1_0A99AF1699F7F17E_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E434AB0)
#define CLASS_1_0A99AF1699F7F17E_2_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4344E0)
#define CLASS_1_0A99AF1699F7F17E_2_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1E434620)
#define CLASS_1_0A99AF1699F7F17E_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E434510)
#define CLASS_1_0A99AF1699F7F17E_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E434900)
#define CLASS_1_0A99AF1699F7F17E_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E434960)
#define CLASS_1_0A99AF1699F7F17E_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E434CF0)
#define CLASS_1_0A99AF1699F7F17E_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E434560)
#define CLASS_1_0A99AF1699F7F17E_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E434520)

inline static constexpr unsigned int Class_1_0A99AF1699F7F17E_2_TypeDefinitionIndex = 25836;

class Class_1_0A99AF1699F7F17E_2 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E_2*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_2_TypeDefinitionIndex)->GetStaticField(0x3DC40);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_DB57B006CFFCF00A*>** StaticGet_CLHOEPIPJKN()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_DB57B006CFFCF00A*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_2_TypeDefinitionIndex)->GetStaticField(0x3DC48);
	}
	// static const ::System::Int32 LALJFALNFPA = 0xF; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_DB57B006CFFCF00A*>* KCHFJNEFCDE; // 0x18
