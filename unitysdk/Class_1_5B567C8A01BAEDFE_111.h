...
#define CLASS_1_5B567C8A01BAEDFE_111_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E318440)
#define CLASS_1_5B567C8A01BAEDFE_111_CLONE_OFFSET UNITYSDK_OFFSET(0x1E318130)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E318240)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E318170)
#define CLASS_1_5B567C8A01BAEDFE_111_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3183A0)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E318490)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E318460)
#define CLASS_1_5B567C8A01BAEDFE_111_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E3180B0)
#define CLASS_1_5B567C8A01BAEDFE_111_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E3180E0)
#define CLASS_1_5B567C8A01BAEDFE_111_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3183D0)
#define CLASS_1_5B567C8A01BAEDFE_111_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E318430)
#define CLASS_1_5B567C8A01BAEDFE_111__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3184E0)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E318100)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3180F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_111_TypeDefinitionIndex = 27712;

class Class_1_5B567C8A01BAEDFE_111 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_111*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_111*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_111_TypeDefinitionIndex)->GetStaticField(0x462E0);
	}
