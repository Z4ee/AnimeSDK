...
#define CLASS_1_5B567C8A01BAEDFE_111_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19601230)
#define CLASS_1_5B567C8A01BAEDFE_111_CLONE_OFFSET UNITYSDK_OFFSET(0x19601040)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19601140)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_OFFSET UNITYSDK_OFFSET(0x196010B0)
#define CLASS_1_5B567C8A01BAEDFE_111_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19601190)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19601280)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19601250)
#define CLASS_1_5B567C8A01BAEDFE_111_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19600F90)
#define CLASS_1_5B567C8A01BAEDFE_111_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19600FF0)
#define CLASS_1_5B567C8A01BAEDFE_111_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196011C0)
#define CLASS_1_5B567C8A01BAEDFE_111_WRITETO_OFFSET UNITYSDK_OFFSET(0x19601220)
#define CLASS_1_5B567C8A01BAEDFE_111__CCTOR_OFFSET UNITYSDK_OFFSET(0x196012D0)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19601010)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_OFFSET UNITYSDK_OFFSET(0x19601000)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_111_TypeDefinitionIndex = 26756;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_111*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_111_TypeDefinitionIndex)->GetStaticField(0x5B180);
	}
