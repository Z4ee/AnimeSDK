...
#define CLASS_1_753802C34A8927F4_CLEAR_OFFSET UNITYSDK_OFFSET(0x180C2140)
#define CLASS_1_753802C34A8927F4__CTOR_OFFSET UNITYSDK_OFFSET(0x180C2390)
...
{
public:
	::RPG::PoolList_1<::Class_1_945C969C6B974032*>* BHCFEGGELJF; // 0x10
	::RPG::PoolList_1<::Class_1_6DE8726ADEF173A7_7*>* FEADGLLKKOL; // 0x18
	::RPG::GameCore::LightningStrikeAreaConfig* EABKOHGCHFP; // 0x20
	::System::Single MMGCACMNDMP; // 0x28
	::System::UInt32 BFNHBJAGMJK; // 0x2C
