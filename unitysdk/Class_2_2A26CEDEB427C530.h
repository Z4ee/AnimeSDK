...
#define CLASS_2_2A26CEDEB427C530_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18C78C30)
#define CLASS_2_2A26CEDEB427C530_FILTER_OFFSET UNITYSDK_OFFSET(0x18C78B40)
#define CLASS_2_2A26CEDEB427C530_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x18C78A20)
#define CLASS_2_2A26CEDEB427C530__CTOR_OFFSET UNITYSDK_OFFSET(0x18C789A0)

inline static constexpr unsigned int Class_2_2A26CEDEB427C530_TypeDefinitionIndex = 39198;

class Class_2_2A26CEDEB427C530 : public ::Entitas::ReactiveSystem_1<::Class_2_FD51057495DB654F*>
{
public:
	::Class_0_16E4307DCC419505_83* Field_2_0; // 0x28
	::Class_0_16E4307DCC419505_84* Field_2_1; // 0x30
	::System::Boolean Field_2_2; // 0x38

	::System::Void _ctor(::Class_0_16E4307DCC419505_84* a1, ::Class_2_40B4F44059E8FC53* a2, ::System::Boolean a3)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_84*, ::Class_2_40B4F44059E8FC53*, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_2_2A26CEDEB427C530__CTOR_OFFSET))(this, a1, a2, a3);
	}
