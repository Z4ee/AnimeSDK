...
#define CLASS_2_B10CDD9027235140_METHOD_2_056D88F34E1FCE48_OFFSET UNITYSDK_OFFSET(0x111C6B40)
#define CLASS_2_B10CDD9027235140_METHOD_2_218124418542E081_OFFSET UNITYSDK_OFFSET(0x111C6980)
#define CLASS_2_B10CDD9027235140_METHOD_2_BEBC8F4773DC82AA_OFFSET UNITYSDK_OFFSET(0x111C68C0)
#define CLASS_2_B10CDD9027235140__CTOR_OFFSET UNITYSDK_OFFSET(0x111C6750)
#define CLASS_2_B10CDD9027235140__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x111C67C0)
#define CLASS_2_B10CDD9027235140__ONTICK_OFFSET UNITYSDK_OFFSET(0x111C6AB0)
#define CLASS_2_B10CDD9027235140__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x111C6920)
#define CLASS_2_B10CDD9027235140___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x111C6BA0)
#define CLASS_2_B10CDD9027235140___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x111C6C60)
#define CLASS_2_B10CDD9027235140___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x111C6C00)

inline static constexpr unsigned int Class_2_B10CDD9027235140_TypeDefinitionIndex = 59240;
