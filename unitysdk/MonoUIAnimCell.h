...
#define MONOUIANIMCELL_APPLYDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x13B4BFC0)
#define MONOUIANIMCELL_CLEARDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x13B4BF70)
#define MONOUIANIMCELL_GET_K_OFFSET UNITYSDK_OFFSET(0x13B4BE20)
#define MONOUIANIMCELL_ONCHANGEINNER_OFFSET UNITYSDK_OFFSET(0x13B4C100)
#define MONOUIANIMCELL_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x13B4BE40)
#define MONOUIANIMCELL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13B4CAB0)
#define MONOUIANIMCELL_ONRESETINNER_OFFSET UNITYSDK_OFFSET(0x13B4C730)
#define MONOUIANIMCELL_ONRESET_OFFSET UNITYSDK_OFFSET(0x13B4C6A0)
#define MONOUIANIMCELL_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x13B4C640)
#define MONOUIANIMCELL_SET_K_OFFSET UNITYSDK_OFFSET(0x13B4BE30)
#define MONOUIANIMCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x13B4CAF0)

inline static constexpr unsigned int MonoUIAnimCell_TypeDefinitionIndex = 79997;
