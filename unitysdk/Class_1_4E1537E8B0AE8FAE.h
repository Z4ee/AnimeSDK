...
#define CLASS_1_4E1537E8B0AE8FAE_METHOD_1_42BACE3BC7DBBCAD_OFFSET UNITYSDK_OFFSET(0x1ADF03B0)
#define CLASS_1_4E1537E8B0AE8FAE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF0530)

inline static constexpr unsigned int Class_1_4E1537E8B0AE8FAE_TypeDefinitionIndex = 14974;

class Class_1_4E1537E8B0AE8FAE : public ::System::Object
{
public:
	::System::UInt32 DBLDCKODNEN; // 0x10
	::RPG::GameCore::BattleResultConditionType LOAGIPDPLFM; // 0x14
	::System::Single FHPMEIECKLG; // 0x18
