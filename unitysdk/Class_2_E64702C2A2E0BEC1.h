...
#define CLASS_2_E64702C2A2E0BEC1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188BC400)
#define CLASS_2_E64702C2A2E0BEC1_METHOD_2_D3A565A802E80D24_OFFSET UNITYSDK_OFFSET(0x188BCF10)
#define CLASS_2_E64702C2A2E0BEC1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188BC570)
#define CLASS_2_E64702C2A2E0BEC1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188BD310)
#define CLASS_2_E64702C2A2E0BEC1_TICK_OFFSET UNITYSDK_OFFSET(0x188BD4C0)
#define CLASS_2_E64702C2A2E0BEC1__CTOR_OFFSET UNITYSDK_OFFSET(0x188BC0D0)
...
public:
	...
	::Class_2_24A88014580ADDB3* JDNLKGBPHDC; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::Struct_2_CC45B4503679E14E_58 EJPILIBEFCB; // 0x30
	::System::Collections::Generic::List_1<::System::Boolean>* NFJNDAFJCAG; // 0x40
	::RPG::GameCore::GameEntity* KCKEHDGBGGG; // 0x48
	::System::Collections::Generic::List_1<::Class_3_07C3C4D2990C49EE*>* KELALIPPMIM; // 0x50
	::RPG::GameCore::TriggerAnimStateWithMove* OFKGLJOAMLD; // 0x58
	::System::Int32 APNGJPMPMOB; // 0x60
	::System::Boolean HHCFIHBHPLB; // 0x64
	::System::Boolean PFMNLFEOAGO; // 0x65
