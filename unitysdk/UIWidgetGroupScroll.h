...
#define UIWIDGETGROUPSCROLL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AE4A700)
#define UIWIDGETGROUPSCROLL_GETWIDGETBYINDEX_OFFSET UNITYSDK_OFFSET(0x1AE4A660)
#define UIWIDGETGROUPSCROLL_SETDATA_OFFSET UNITYSDK_OFFSET(0x1AE4A6B0)
#define UIWIDGETGROUPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4A7A0)
#define UIWIDGETGROUPSCROLL___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AE4A820)

inline static constexpr unsigned int UIWidgetGroupScroll_TypeDefinitionIndex = 50136;
