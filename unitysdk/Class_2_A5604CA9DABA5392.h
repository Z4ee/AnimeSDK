...
#define CLASS_2_A5604CA9DABA5392_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14541200)
#define CLASS_2_A5604CA9DABA5392_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14541240)
#define CLASS_2_A5604CA9DABA5392_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14541430)
#define CLASS_2_A5604CA9DABA5392_TICK_OFFSET UNITYSDK_OFFSET(0x14541480)
#define CLASS_2_A5604CA9DABA5392__CTOR_OFFSET UNITYSDK_OFFSET(0x145411F0)

inline static constexpr unsigned int Class_2_A5604CA9DABA5392_TypeDefinitionIndex = 50820;

class Class_2_A5604CA9DABA5392 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetMissionWayPoint* Field_2_0; // 0x18
