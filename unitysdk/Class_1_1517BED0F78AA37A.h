...
#define CLASS_1_1517BED0F78AA37A_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xC009200)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_03FA5E4304FE71D4_1_OFFSET UNITYSDK_OFFSET(0xC008600)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_03FA5E4304FE71D4_OFFSET UNITYSDK_OFFSET(0xC008510)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xC009570)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xC0083F0)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_3DDAEA3DE5989862_OFFSET UNITYSDK_OFFSET(0xC008A80)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_5BF231913C0566B0_OFFSET UNITYSDK_OFFSET(0xC009000)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_80C22100EDC18845_OFFSET UNITYSDK_OFFSET(0xC008700)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_84EAB34EABC7F508_1_OFFSET UNITYSDK_OFFSET(0xC008DC0)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_84EAB34EABC7F508_2_OFFSET UNITYSDK_OFFSET(0xC0095E0)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_84EAB34EABC7F508_OFFSET UNITYSDK_OFFSET(0xC008B80)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xC008450)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_C4CECF3CAEE6CDC9_OFFSET UNITYSDK_OFFSET(0xC009450)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_D4E4C187F2359C4A_OFFSET UNITYSDK_OFFSET(0xC009100)
#define CLASS_1_1517BED0F78AA37A_METHOD_1_D65D6257FB73E1EC_OFFSET UNITYSDK_OFFSET(0xC0084A0)
#define CLASS_1_1517BED0F78AA37A_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xC009210)
#define CLASS_1_1517BED0F78AA37A__CTOR_OFFSET UNITYSDK_OFFSET(0xC009220)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1517BED0F78AA37A_TypeDefinitionIndex)->GetStaticField(0x3270);
	}
	::Il2CppArray<::UnityEngine::Color32>* ACPCFKLMHGL; // 0x10
	::Il2CppArray<::UnityEngine::Vector3>* GCPIKOFOCDD; // 0x18
	::Il2CppArray<::System::Int32>* KMEFELKKHLH; // 0x20
	::Il2CppArray<::UnityEngine::Vector3>* BGCIECHFCAN; // 0x28
	::Il2CppArray<::UnityEngine::Material*>* _Materials_k__BackingField; // 0x30
	::UnityEngine::Mesh* BBBBPICMJMN; // 0x38
	::Il2CppArray<::UnityEngine::Vector4>* NNENIMEGHMH; // 0x40
	::Il2CppArray<::UnityEngine::Vector3>* LJLEHEGLILM; // 0x48
	::Il2CppArray<::UnityEngine::Vector2>* FCPBNGFPGAN; // 0x50
