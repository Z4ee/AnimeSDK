...
#define WORLDTWISTSPECIALCONFIG_MESHRENDERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D3E8220)
#define WORLDTWISTSPECIALCONFIG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D3E8500)
#define WORLDTWISTSPECIALCONFIG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D3E7F90)
#define WORLDTWISTSPECIALCONFIG_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1D3E8130)
#define WORLDTWISTSPECIALCONFIG_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1D3E80C0)
#define WORLDTWISTSPECIALCONFIG_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D3E8570)
#define WORLDTWISTSPECIALCONFIG_SETUPMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x1D3E8360)
#define WORLDTWISTSPECIALCONFIG_START_OFFSET UNITYSDK_OFFSET(0x1D3E81D0)
#define WORLDTWISTSPECIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E85C0)

inline static constexpr unsigned int WorldTwistSpecialConfig_TypeDefinitionIndex = 27206;
