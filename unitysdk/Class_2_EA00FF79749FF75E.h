...
#define CLASS_2_EA00FF79749FF75E_METHOD_2_8AE01EFA7526266A_OFFSET UNITYSDK_OFFSET(0x108F6830)
#define CLASS_2_EA00FF79749FF75E_METHOD_2_9FA85F81BF5EE3CA_OFFSET UNITYSDK_OFFSET(0x108F6A80)
#define CLASS_2_EA00FF79749FF75E_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x108F6B30)
#define CLASS_2_EA00FF79749FF75E__CTOR_OFFSET UNITYSDK_OFFSET(0x108F6B20)

inline static constexpr unsigned int Class_2_EA00FF79749FF75E_TypeDefinitionIndex = 42298;

class Class_2_EA00FF79749FF75E : public ::Class_1_EEA0111A28582B57
{
public:
	::UnityEngine::GameObject* Field_2_3; // 0x18
	::Class_3_30A064D7BE47C07D<::MoleMole::UICommonTimeCoolDownWidgetController*>* Field_2_5; // 0x20
