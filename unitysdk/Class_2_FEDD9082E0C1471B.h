...
#define CLASS_2_FEDD9082E0C1471B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9929030)
#define CLASS_2_FEDD9082E0C1471B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9929070)
#define CLASS_2_FEDD9082E0C1471B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9929210)
#define CLASS_2_FEDD9082E0C1471B_TICK_OFFSET UNITYSDK_OFFSET(0x9929260)
#define CLASS_2_FEDD9082E0C1471B__CTOR_OFFSET UNITYSDK_OFFSET(0x9929020)

inline static constexpr unsigned int Class_2_FEDD9082E0C1471B_TypeDefinitionIndex = 53579;

class Class_2_FEDD9082E0C1471B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ElfManagerRestaurant* Field_2_0; // 0x18
