...
#define CLASS_2_368F3AB2A2D30D63_DISPOSE_OFFSET UNITYSDK_OFFSET(0x909C660)
#define CLASS_2_368F3AB2A2D30D63_METHOD_2_63D396B662030C2A_OFFSET UNITYSDK_OFFSET(0x909CAC0)
#define CLASS_2_368F3AB2A2D30D63_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x909C6A0)
#define CLASS_2_368F3AB2A2D30D63_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x909CB70)
#define CLASS_2_368F3AB2A2D30D63_TICK_OFFSET UNITYSDK_OFFSET(0x909CBC0)
#define CLASS_2_368F3AB2A2D30D63__CTOR_OFFSET UNITYSDK_OFFSET(0x909C650)

inline static constexpr unsigned int Class_2_368F3AB2A2D30D63_TypeDefinitionIndex = 50171;

class Class_2_368F3AB2A2D30D63 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SelectAISkillTarget* Field_2_1; // 0x18
