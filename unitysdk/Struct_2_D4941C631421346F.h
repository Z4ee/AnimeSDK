...
#define STRUCT_2_D4941C631421346F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x848320)
#define STRUCT_2_D4941C631421346F_EQUALS_OFFSET UNITYSDK_OFFSET(0x848260)
#define STRUCT_2_D4941C631421346F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x848330)
#define STRUCT_2_D4941C631421346F_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x166185C0)
#define STRUCT_2_D4941C631421346F_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x16618640)
#define STRUCT_2_D4941C631421346F_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x8483B0)
#define STRUCT_2_D4941C631421346F_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x848340)
#define STRUCT_2_D4941C631421346F_METHOD_2_DDB10665A2EAC088_OFFSET UNITYSDK_OFFSET(0x166184A0)
#define STRUCT_2_D4941C631421346F__CTOR_OFFSET UNITYSDK_OFFSET(0x66EFE0)

inline static constexpr unsigned int Struct_2_D4941C631421346F_TypeDefinitionIndex = 88063;

struct alignas(8) Struct_2_D4941C631421346F
{
	::MoleMole::Config::InlevelCameraState Field_2_2; // 0x10
