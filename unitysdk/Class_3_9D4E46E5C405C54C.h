...
#define CLASS_3_9D4E46E5C405C54C_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12BF7060)
#define CLASS_3_9D4E46E5C405C54C_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12BF7700)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_147377F29C401A8D_OFFSET UNITYSDK_OFFSET(0x12BF8350)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_529A9CA1CFAF7016_OFFSET UNITYSDK_OFFSET(0x12BF70C0)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_8741A88D50268453_OFFSET UNITYSDK_OFFSET(0x12BF7780)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_979D2C8BE7EA3C3D_OFFSET UNITYSDK_OFFSET(0x12BF81F0)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_AB36750697462AE2_OFFSET UNITYSDK_OFFSET(0x12BF7590)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_B1FCFA7C1C5829AA_OFFSET UNITYSDK_OFFSET(0x12BF7490)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_B91B1B63B65BCA05_OFFSET UNITYSDK_OFFSET(0x12BF8110)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x12BF7690)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_D692029B7700F7B0_OFFSET UNITYSDK_OFFSET(0x12BF6F60)
#define CLASS_3_9D4E46E5C405C54C_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x12BF7050)
#define CLASS_3_9D4E46E5C405C54C__CTOR_OFFSET UNITYSDK_OFFSET(0x12BF8100)

inline static constexpr unsigned int Class_3_9D4E46E5C405C54C_TypeDefinitionIndex = 68481;

class Class_3_9D4E46E5C405C54C : public ::Class_2_7C9A70DC3FC57CDC
{
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_3_F41D242A20F8FE06*, ::Class_2_7C9A70DC3FC57CDC*, ::Class_2_167BB37617B940E3*, ::Class_2_EA995402651EF7A9*, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_1_B7E341C5F1A6F199*))((::PBYTE)hIl2Cpp + CLASS_3_9D4E46E5C405C54C_METHOD_3_D692029B7700F7B0_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7);
	}
	...
	{
		return ((::Class_2_7C9A70DC3FC57CDC*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_9D4E46E5C405C54C_METHOD_3_AB36750697462AE2_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_3_F41D242A20F8FE06*, ::Class_2_7C9A70DC3FC57CDC*, ::Class_2_167BB37617B940E3*, ::Class_2_EA995402651EF7A9*, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_1_B7E341C5F1A6F199*))((::PBYTE)hIl2Cpp + CLASS_3_9D4E46E5C405C54C_METHOD_3_B91B1B63B65BCA05_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7);
	}
