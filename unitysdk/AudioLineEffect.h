...
#define AUDIOLINEEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x196512E0)
#define AUDIOLINEEFFECT_GETCURRENTCURVE_OFFSET UNITYSDK_OFFSET(0x19651AF0)
#define AUDIOLINEEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19651780)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_1_OFFSET UNITYSDK_OFFSET(0x19651C70)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_OFFSET UNITYSDK_OFFSET(0x196518A0)
#define AUDIOLINEEFFECT_SETDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x19651BC0)
#define AUDIOLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19651DD0)

inline static constexpr unsigned int AudioLineEffect_TypeDefinitionIndex = 75675;
