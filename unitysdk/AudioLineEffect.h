...
#define AUDIOLINEEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x13C254B0)
#define AUDIOLINEEFFECT_GETCURRENTCURVE_OFFSET UNITYSDK_OFFSET(0x13C25CC0)
#define AUDIOLINEEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13C25950)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_1_OFFSET UNITYSDK_OFFSET(0x13C25E40)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_OFFSET UNITYSDK_OFFSET(0x13C25A70)
#define AUDIOLINEEFFECT_SETDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x13C25D90)
#define AUDIOLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x13C25FA0)

inline static constexpr unsigned int AudioLineEffect_TypeDefinitionIndex = 61684;
