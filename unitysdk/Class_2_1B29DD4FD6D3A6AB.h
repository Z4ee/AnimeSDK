...
#define CLASS_2_1B29DD4FD6D3A6AB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1004E680)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_018E23A6BFBE4F07_OFFSET UNITYSDK_OFFSET(0x1004E960)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_0D64676477D5996D_OFFSET UNITYSDK_OFFSET(0x1004EC70)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_0FA0973E87FBD363_OFFSET UNITYSDK_OFFSET(0x1004FBE0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_1AC289536ACFCBF7_OFFSET UNITYSDK_OFFSET(0x1004F240)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_22C031C2E2271C85_OFFSET UNITYSDK_OFFSET(0x1004EFA0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_29861B2485680DBB_OFFSET UNITYSDK_OFFSET(0x1004FB00)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_2F2AAD4F857EEAF2_OFFSET UNITYSDK_OFFSET(0x1004D1C0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_3A6BA667BEB66A7B_OFFSET UNITYSDK_OFFSET(0x1004F380)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_40608173835C5AA5_OFFSET UNITYSDK_OFFSET(0x1004BD30)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_41AA181104E03F2C_OFFSET UNITYSDK_OFFSET(0x1004C4B0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_481AC0E4E3F3D73B_OFFSET UNITYSDK_OFFSET(0x1004CFA0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_50F388BA53C37D92_OFFSET UNITYSDK_OFFSET(0x1004FFA0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_512D0C099C5FEC54_OFFSET UNITYSDK_OFFSET(0x1004E310)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_52C78C4FB0FA67B1_OFFSET UNITYSDK_OFFSET(0x1004C540)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_56E5DB6CD9DEE332_OFFSET UNITYSDK_OFFSET(0x1004E5A0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_5906F1C536BB1219_OFFSET UNITYSDK_OFFSET(0x1004FFB0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_594946548B397366_OFFSET UNITYSDK_OFFSET(0x1004E9F0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_6296A4FDF807C4BF_OFFSET UNITYSDK_OFFSET(0x1004EB00)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_7E462A97DE7ACFDA_OFFSET UNITYSDK_OFFSET(0x1004F9A0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_86C481A3D49D6F8C_OFFSET UNITYSDK_OFFSET(0x1004F510)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_AF769CD15806BD66_OFFSET UNITYSDK_OFFSET(0x1004FEF0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_B7B7628F0F1CBB5D_OFFSET UNITYSDK_OFFSET(0x1004CBB0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_C50B93169B85DAEA_OFFSET UNITYSDK_OFFSET(0x1004FE00)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1004E8F0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_D99F7A1200193152_OFFSET UNITYSDK_OFFSET(0x1004CE10)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_DFC952E721F9A35E_OFFSET UNITYSDK_OFFSET(0x1004CFF0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_E34D65A3EBA8DAE3_OFFSET UNITYSDK_OFFSET(0x1004FE50)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_E647A07FFD9E8CA5_OFFSET UNITYSDK_OFFSET(0x1004DB60)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1004FEE0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x1004BE80)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_F735CB8DA6A8EFD7_OFFSET UNITYSDK_OFFSET(0x1004BEB0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_FEDE09C198114DBE_OFFSET UNITYSDK_OFFSET(0x1004CDC0)
#define CLASS_2_1B29DD4FD6D3A6AB_ONMODELARTLOADED_OFFSET UNITYSDK_OFFSET(0x1004E710)
#define CLASS_2_1B29DD4FD6D3A6AB_ONMODELARTUNLOADED_OFFSET UNITYSDK_OFFSET(0x1004E8A0)
#define CLASS_2_1B29DD4FD6D3A6AB_TICK_OFFSET UNITYSDK_OFFSET(0x1004BF50)
#define CLASS_2_1B29DD4FD6D3A6AB__CCTOR_OFFSET UNITYSDK_OFFSET(0x1004FFD0)
#define CLASS_2_1B29DD4FD6D3A6AB__CTOR_OFFSET UNITYSDK_OFFSET(0x1004DC70)
#define CLASS_2_1B29DD4FD6D3A6AB___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x10050080)

inline static constexpr unsigned int Class_2_1B29DD4FD6D3A6AB_TypeDefinitionIndex = 52819;
...
public:
	...
	{
		return (::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_1B29DD4FD6D3A6AB_TypeDefinitionIndex)->GetStaticField(0x12350);
	}
	::RPG::Client::LookAtIK* Field_2_6; // 0x18
	::RPG::GameCore::LevelLookAtPositionInfo* Field_2_3; // 0x20
	::Struct_2_4C8316D252AABDF5 Field_2_14; // 0x28
	::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::Struct_2_4C8316D252AABDF5>*>* Field_2_10; // 0x48
	::RPG::GameCore::LevelNpcLookAtTargetInfo* Field_2_2; // 0x50
	::System::Nullable_1<::Struct_2_4C8316D252AABDF5> Field_2_9; // 0x58
	::RPG::GameCore::CharacterAnimZone* Field_2_5; // 0x80
	::RPG::GameCore::OnEventCallBack* Field_2_13; // 0x88
	::System::Collections::Generic::List_1<::System::Func_2<::System::Collections::Generic::List_1<::Struct_2_4C8316D252AABDF5>*, ::System::Boolean>*>* Field_2_12; // 0x90
	::RPG::Client::CharacterMonoAvatar* Field_2_7; // 0x98
	::RPG::GameCore::ENpcLookAtMode Field_2_1; // 0xA0
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_382*))((::PBYTE)hIl2Cpp + CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_0FA0973E87FBD363_OFFSET))(this, a1);
	}

	::System::Void Method_2_C50B93169B85DAEA(::Class_0_16E4307DCC419505_382* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_382*))((::PBYTE)hIl2Cpp + CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_C50B93169B85DAEA_OFFSET))(this, a1);
	}
