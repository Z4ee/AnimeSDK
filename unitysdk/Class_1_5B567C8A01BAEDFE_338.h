...
#define CLASS_1_5B567C8A01BAEDFE_338_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198CDB80)
#define CLASS_1_5B567C8A01BAEDFE_338_CLONE_OFFSET UNITYSDK_OFFSET(0x198CD9F0)
#define CLASS_1_5B567C8A01BAEDFE_338_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198CDA90)
#define CLASS_1_5B567C8A01BAEDFE_338_EQUALS_OFFSET UNITYSDK_OFFSET(0x198CDA30)
#define CLASS_1_5B567C8A01BAEDFE_338_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198CDAE0)
#define CLASS_1_5B567C8A01BAEDFE_338_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198CDBD0)
#define CLASS_1_5B567C8A01BAEDFE_338_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198CDBA0)
#define CLASS_1_5B567C8A01BAEDFE_338_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x198CD970)
#define CLASS_1_5B567C8A01BAEDFE_338_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198CD9A0)
#define CLASS_1_5B567C8A01BAEDFE_338_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198CDB10)
#define CLASS_1_5B567C8A01BAEDFE_338_WRITETO_OFFSET UNITYSDK_OFFSET(0x198CDB70)
#define CLASS_1_5B567C8A01BAEDFE_338__CCTOR_OFFSET UNITYSDK_OFFSET(0x198CDC20)
#define CLASS_1_5B567C8A01BAEDFE_338__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198CD9C0)
#define CLASS_1_5B567C8A01BAEDFE_338__CTOR_OFFSET UNITYSDK_OFFSET(0x198CD9B0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_338_TypeDefinitionIndex = 32194;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_338*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_338_TypeDefinitionIndex)->GetStaticField(0x50FC0);
	}
