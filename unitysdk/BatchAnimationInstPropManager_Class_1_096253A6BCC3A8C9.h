...
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_08EBD5BD5A27944B_OFFSET UNITYSDK_OFFSET(0xC4F1620)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_467AC3F076594137_OFFSET UNITYSDK_OFFSET(0xC4F14B0)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_4E256203C3F64C93_OFFSET UNITYSDK_OFFSET(0xC4F1220)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xC4F1B40)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_6317AB9E889AF215_OFFSET UNITYSDK_OFFSET(0xC4F1880)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_91F86025970D7006_OFFSET UNITYSDK_OFFSET(0xC4F1750)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0xC4F19B0)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9_METHOD_1_BA18C603081098EF_OFFSET UNITYSDK_OFFSET(0xC4F1A80)
#define BATCHANIMATIONINSTPROPMANAGER_CLASS_1_096253A6BCC3A8C9__CTOR_OFFSET UNITYSDK_OFFSET(0xC4F10A0)
...
{
public:
	::System::Collections::Generic::Stack_1<::System::UInt32>* BFJNMKAOLDG; // 0x10
	::System::String* LNCOKKIPAEP; // 0x18
	::System::Collections::Generic::Dictionary_2<::UnityEngine::Rendering::BatchAnimationInstance*, ::System::UInt32>* JCLBOPFALAN; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::BatchAnimationInstPropManager_Struct_2_CEA3583D515FCB73>* HDOCDCHFKCA; // 0x28
	::System::Int32 OBPKAPNLJEK; // 0x30
	::System::Int32 OJILJLBIMIC; // 0x34
	::System::Int32 LECPAKBIAHA; // 0x38
	::System::Int32 JIKGOAPHOKF; // 0x3C
	::System::Int32 CJPKHBAMFML; // 0x40
	::System::Boolean GFJPFAOKHCG; // 0x44
	::Unity::Collections::NativeArray_1<::System::Single> JAHJLFPNFGJ; // 0x48
