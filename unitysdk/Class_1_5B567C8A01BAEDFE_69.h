...
#define CLASS_1_5B567C8A01BAEDFE_69_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EBB3F70)
#define CLASS_1_5B567C8A01BAEDFE_69_CLONE_OFFSET UNITYSDK_OFFSET(0x1EBB3C60)
#define CLASS_1_5B567C8A01BAEDFE_69_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EBB3D70)
#define CLASS_1_5B567C8A01BAEDFE_69_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EBB3CA0)
#define CLASS_1_5B567C8A01BAEDFE_69_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EBB3ED0)
#define CLASS_1_5B567C8A01BAEDFE_69_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EBB3FC0)
#define CLASS_1_5B567C8A01BAEDFE_69_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EBB3F90)
#define CLASS_1_5B567C8A01BAEDFE_69_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EBB3BE0)
#define CLASS_1_5B567C8A01BAEDFE_69_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EBB3C10)
#define CLASS_1_5B567C8A01BAEDFE_69_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EBB3F00)
#define CLASS_1_5B567C8A01BAEDFE_69_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EBB3F60)
#define CLASS_1_5B567C8A01BAEDFE_69__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBB4010)
#define CLASS_1_5B567C8A01BAEDFE_69__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EBB3C30)
#define CLASS_1_5B567C8A01BAEDFE_69__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBB3C20)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_69_TypeDefinitionIndex = 26865;

class Class_1_5B567C8A01BAEDFE_69 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_69*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_69*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_69_TypeDefinitionIndex)->GetStaticField(0xC440);
	}
