...
#define CLASS_1_0251F68C7A9C91EA_CLEAR_OFFSET UNITYSDK_OFFSET(0x15274070)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_0FBD74DBB0657BEA_OFFSET UNITYSDK_OFFSET(0x15273A20)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_1DDCA39D02072455_OFFSET UNITYSDK_OFFSET(0x15273170)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_3293B6969A1743D5_OFFSET UNITYSDK_OFFSET(0x15273AC0)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_509007321E951A59_OFFSET UNITYSDK_OFFSET(0x15272DB0)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_623E48726F69CC25_OFFSET UNITYSDK_OFFSET(0x15273DF0)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_67D79E831A43846E_OFFSET UNITYSDK_OFFSET(0x15273EB0)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_89FDB49A9937EBE7_OFFSET UNITYSDK_OFFSET(0x15273540)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_8C6FE832D6EE7451_OFFSET UNITYSDK_OFFSET(0x15273220)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_9188E56A2068A4DC_OFFSET UNITYSDK_OFFSET(0x152741D0)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_9D7CB3F8D53AEB40_OFFSET UNITYSDK_OFFSET(0x152736F0)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_E465D0F588233D19_OFFSET UNITYSDK_OFFSET(0x15272D50)
#define CLASS_1_0251F68C7A9C91EA_METHOD_1_EBBE08F2874773A2_OFFSET UNITYSDK_OFFSET(0x152742F0)
#define CLASS_1_0251F68C7A9C91EA__CTOR_OFFSET UNITYSDK_OFFSET(0x152743B0)

inline static constexpr unsigned int Class_1_0251F68C7A9C91EA_TypeDefinitionIndex = 54786;
...
public:
	...
	::System::Collections::Generic::List_1<::Class_1_0251F68C7A9C91EA_Class_1_F1947C9CC03EB062*>* Field_1_4; // 0x30
	...
	::System::Void Method_1_9D7CB3F8D53AEB40(::RPG::GameCore::BattlePerformCaptureActor* a1, ::Class_1_0251F68C7A9C91EA_Class_3_1C5AB48DABF38B2F* a2, ::System::Boolean& a3)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::BattlePerformCaptureActor*, ::Class_1_0251F68C7A9C91EA_Class_3_1C5AB48DABF38B2F*, ::System::Boolean&))((::PBYTE)hIl2Cpp + CLASS_1_0251F68C7A9C91EA_METHOD_1_9D7CB3F8D53AEB40_OFFSET))(this, a1, a2, a3);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::BattlePerformCaptureActor*, ::System::Action_2<::RPG::GameCore::BattlePerformCaptureActor*, ::RPG::GameCore::GameEntity*>*, ::System::Boolean&))((::PBYTE)hIl2Cpp + CLASS_1_0251F68C7A9C91EA_METHOD_1_3293B6969A1743D5_OFFSET))(this, a1, a2, a3);
	}
