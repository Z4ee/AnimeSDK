...
#define CLASS_2_70E2C1E5A9347D38_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x15913190)
#define CLASS_2_70E2C1E5A9347D38_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x15912D20)
#define CLASS_2_70E2C1E5A9347D38_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x15912EF0)
#define CLASS_2_70E2C1E5A9347D38_METHOD_2_73D70CF7573CE802_OFFSET UNITYSDK_OFFSET(0x15912D80)
#define CLASS_2_70E2C1E5A9347D38_METHOD_2_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0x15913070)
#define CLASS_2_70E2C1E5A9347D38_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x15912C50)
#define CLASS_2_70E2C1E5A9347D38_ONRETURN_OFFSET UNITYSDK_OFFSET(0x15912CA0)
#define CLASS_2_70E2C1E5A9347D38__CTOR_OFFSET UNITYSDK_OFFSET(0x15913200)
#define CLASS_2_70E2C1E5A9347D38__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x15912CE0)

inline static constexpr unsigned int Class_2_70E2C1E5A9347D38_TypeDefinitionIndex = 71740;

class Class_2_70E2C1E5A9347D38 : public ::Class_1_34917908B7833130
{
public:
	::UnityEngine::RectTransform* JAKMENOCECF; // 0x60
	::UnityEngine::UI::Image* GGADAPDEIAD; // 0x68
