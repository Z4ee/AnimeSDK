...
#define CLASS_1_D4A438F1B456B957_METHOD_1_010D09F1E5622D85_OFFSET UNITYSDK_OFFSET(0x1837C0B0)
#define CLASS_1_D4A438F1B456B957__CCTOR_OFFSET UNITYSDK_OFFSET(0x1837BDC0)
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::RogueMode, ::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D4A438F1B456B957_TypeDefinitionIndex)->GetStaticField(0x3E910);
	}
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::StageType, ::System::Type*>** StaticGet_AJCICNJHJCP()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::StageType, ::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D4A438F1B456B957_TypeDefinitionIndex)->GetStaticField(0x3E918);
	}
