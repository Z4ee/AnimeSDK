...
#define CLASS_2_CA1A1CB95049C55A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17A845B0)
#define CLASS_2_CA1A1CB95049C55A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17A845F0)
#define CLASS_2_CA1A1CB95049C55A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17A84B10)
#define CLASS_2_CA1A1CB95049C55A_TICK_OFFSET UNITYSDK_OFFSET(0x17A84B60)
#define CLASS_2_CA1A1CB95049C55A__CTOR_OFFSET UNITYSDK_OFFSET(0x17A845A0)

inline static constexpr unsigned int Class_2_CA1A1CB95049C55A_TypeDefinitionIndex = 56343;
