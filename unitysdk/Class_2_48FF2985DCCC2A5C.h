...
#define CLASS_2_48FF2985DCCC2A5C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAAC6F30)
#define CLASS_2_48FF2985DCCC2A5C_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xAAC6F90)
#define CLASS_2_48FF2985DCCC2A5C_METHOD_2_85F9AAEEA394BE31_OFFSET UNITYSDK_OFFSET(0xAAC71B0)
#define CLASS_2_48FF2985DCCC2A5C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAAC6B30)
#define CLASS_2_48FF2985DCCC2A5C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAAC6EE0)
#define CLASS_2_48FF2985DCCC2A5C_TICK_OFFSET UNITYSDK_OFFSET(0xAAC72F0)
#define CLASS_2_48FF2985DCCC2A5C__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC6B20)

inline static constexpr unsigned int Class_2_48FF2985DCCC2A5C_TypeDefinitionIndex = 54855;

class Class_2_48FF2985DCCC2A5C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_303D5A33D1401D59* Field_2_0; // 0x18
	::Class_3_6B399D161FCD382D* Field_2_1; // 0x20
