...
#define SCREENEFFECTPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x150A5170)
#define SCREENEFFECTPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x150A5570)
#define SCREENEFFECTPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x150A5800)
#define SCREENEFFECTPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x150A57B0)
#define SCREENEFFECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x150A5AB0)

inline static constexpr unsigned int ScreenEffectProxy_TypeDefinitionIndex = 47697;
