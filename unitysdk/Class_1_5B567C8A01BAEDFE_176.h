...
#define CLASS_1_5B567C8A01BAEDFE_176_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19668BC0)
#define CLASS_1_5B567C8A01BAEDFE_176_CLONE_OFFSET UNITYSDK_OFFSET(0x19668A30)
#define CLASS_1_5B567C8A01BAEDFE_176_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19668AD0)
#define CLASS_1_5B567C8A01BAEDFE_176_EQUALS_OFFSET UNITYSDK_OFFSET(0x19668A70)
#define CLASS_1_5B567C8A01BAEDFE_176_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19668B20)
#define CLASS_1_5B567C8A01BAEDFE_176_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19668C10)
#define CLASS_1_5B567C8A01BAEDFE_176_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19668BE0)
#define CLASS_1_5B567C8A01BAEDFE_176_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x196689B0)
#define CLASS_1_5B567C8A01BAEDFE_176_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x196689E0)
#define CLASS_1_5B567C8A01BAEDFE_176_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19668B50)
#define CLASS_1_5B567C8A01BAEDFE_176_WRITETO_OFFSET UNITYSDK_OFFSET(0x19668BB0)
#define CLASS_1_5B567C8A01BAEDFE_176__CCTOR_OFFSET UNITYSDK_OFFSET(0x19668C60)
#define CLASS_1_5B567C8A01BAEDFE_176__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19668A00)
#define CLASS_1_5B567C8A01BAEDFE_176__CTOR_OFFSET UNITYSDK_OFFSET(0x196689F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_176_TypeDefinitionIndex = 28518;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_176*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_176_TypeDefinitionIndex)->GetStaticField(0x43040);
	}
