...
#define STAGEHARMONYCURVEDEMODULATOR_METHOD_3_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0xB9511A0)
#define STAGEHARMONYCURVEDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xB951210)
#define STAGEHARMONYCURVEDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB951260)

inline static constexpr unsigned int StageHarmonyCurveDemodulator_TypeDefinitionIndex = 44273;
