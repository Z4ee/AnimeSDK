...
#define CLASS_2_C2C9554C906BB2FD_METHOD_2_77EA5BCD93BD96AE_OFFSET UNITYSDK_OFFSET(0x11966720)
#define CLASS_2_C2C9554C906BB2FD_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x11966810)
#define CLASS_2_C2C9554C906BB2FD_METHOD_2_ECD1B788BD780B17_OFFSET UNITYSDK_OFFSET(0x119665A0)
#define CLASS_2_C2C9554C906BB2FD__CTOR_OFFSET UNITYSDK_OFFSET(0x11966800)

inline static constexpr unsigned int Class_2_C2C9554C906BB2FD_TypeDefinitionIndex = 45369;

class Class_2_C2C9554C906BB2FD : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_3_30A064D7BE47C07D<::MoleMole::UIInLevelPauseMiniscapeMapWidget_MapIconDetailWidgetController*>* Field_2_1; // 0x18
	::Class_3_30A064D7BE47C07D<::MoleMole::UIInLevelPauseMiniscapeMapWidget_MiniscapeMapWidgetController*>* Field_2_0; // 0x20
