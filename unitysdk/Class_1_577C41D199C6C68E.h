...
#define CLASS_1_577C41D199C6C68E_GET_FIRSTCOMMAND_OFFSET UNITYSDK_OFFSET(0xB681AF0)
#define CLASS_1_577C41D199C6C68E_GET_FIRSTREDDOTKEY_OFFSET UNITYSDK_OFFSET(0xB681AB0)
#define CLASS_1_577C41D199C6C68E_GET_FOURTHCOMMAND_OFFSET UNITYSDK_OFFSET(0xB681B20)
#define CLASS_1_577C41D199C6C68E_GET_FOURTHREDDOTKEY_OFFSET UNITYSDK_OFFSET(0xB681AE0)
#define CLASS_1_577C41D199C6C68E_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xB681AA0)
#define CLASS_1_577C41D199C6C68E_GET_SECONDCOMMAND_OFFSET UNITYSDK_OFFSET(0xB681B00)
#define CLASS_1_577C41D199C6C68E_GET_SECONDREDDOTKEY_OFFSET UNITYSDK_OFFSET(0xB681AC0)
#define CLASS_1_577C41D199C6C68E_GET_THIRDCOMMAND_OFFSET UNITYSDK_OFFSET(0xB681B10)
#define CLASS_1_577C41D199C6C68E_GET_THIRDREDDOTKEY_OFFSET UNITYSDK_OFFSET(0xB681AD0)
#define CLASS_1_577C41D199C6C68E__CTOR_OFFSET UNITYSDK_OFFSET(0xB681B30)
...
{
public:
	::R3::ReactiveProperty_1<::System::String*>* _FirstRedDotKey_k__BackingField; // 0x10
	::Class_0_16E4307DCC419505_318* _ThirdCommand_k__BackingField; // 0x18
	::R3::ReactiveProperty_1<::System::String*>* _SecondRedDotKey_k__BackingField; // 0x20
	::R3::ReactiveProperty_1<::System::String*>* _ThirdRedDotKey_k__BackingField; // 0x28
	::Class_0_16E4307DCC419505_318* _SecondCommand_k__BackingField; // 0x30
	::Class_0_16E4307DCC419505_318* _FirstCommand_k__BackingField; // 0x38
	::R3::ReactiveProperty_1<::System::Boolean>* _IsVisible_k__BackingField; // 0x40
	::R3::ReactiveProperty_1<::System::String*>* _FourthRedDotKey_k__BackingField; // 0x48
	::Class_0_16E4307DCC419505_318* _FourthCommand_k__BackingField; // 0x50
