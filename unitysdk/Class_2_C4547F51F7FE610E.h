...
#define CLASS_2_C4547F51F7FE610E_METHOD_2_1DDD10252C795DC3_OFFSET UNITYSDK_OFFSET(0x1309BAB0)
#define CLASS_2_C4547F51F7FE610E_METHOD_2_2F809989C4EE835D_OFFSET UNITYSDK_OFFSET(0x1309BD00)
#define CLASS_2_C4547F51F7FE610E_METHOD_2_420601DEBBE296C1_OFFSET UNITYSDK_OFFSET(0x1309B030)
#define CLASS_2_C4547F51F7FE610E_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x1309B2F0)
#define CLASS_2_C4547F51F7FE610E_METHOD_2_AB1A8DFD378DB0BE_OFFSET UNITYSDK_OFFSET(0x1309B370)
#define CLASS_2_C4547F51F7FE610E_METHOD_2_D51A30EED4C31484_OFFSET UNITYSDK_OFFSET(0x1309B830)
#define CLASS_2_C4547F51F7FE610E_METHOD_2_EF8412AD8A9C06E6_OFFSET UNITYSDK_OFFSET(0x1309AFC0)
#define CLASS_2_C4547F51F7FE610E_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x1309B6A0)
#define CLASS_2_C4547F51F7FE610E_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1309B190)
#define CLASS_2_C4547F51F7FE610E__CTOR_OFFSET UNITYSDK_OFFSET(0x1309BDD0)

inline static constexpr unsigned int Class_2_C4547F51F7FE610E_TypeDefinitionIndex = 79528;

class Class_2_C4547F51F7FE610E : public ::Class_1_3713064DEE761936
{
public:
	::System::Collections::Generic::List_1<::System::Boolean>* GHKGBMKFMJG; // 0x20
	::System::Collections::Generic::List_1<::System::Boolean>* ENOOFJFOJEH; // 0x28
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_413*>* GFFAGJOELCH; // 0x30
	::UnityEngine::Coroutine* BFOPPPBPDEE; // 0x38
	::System::Single CDOLCLMGEBO; // 0x40
	::System::Int32 BBJLJNNLIOM; // 0x44
	::System::Boolean BEMMCKLJICI; // 0x48
	::System::Int32 FDBCPLFBHEO; // 0x4C
