...
#define COLLECTIONS_POOLED_HASHHELPERS_EXPANDPRIME_OFFSET UNITYSDK_OFFSET(0x1D2EDE80)
#define COLLECTIONS_POOLED_HASHHELPERS_GETPRIME_OFFSET UNITYSDK_OFFSET(0x1D2EDD50)
#define COLLECTIONS_POOLED_HASHHELPERS_GET_SERIALIZATIONINFOTABLE_OFFSET UNITYSDK_OFFSET(0x1D2EDC10)
#define COLLECTIONS_POOLED_HASHHELPERS_ISPRIME_OFFSET UNITYSDK_OFFSET(0x1D2EDCD0)
#define COLLECTIONS_POOLED_HASHHELPERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D2EDEA0)

namespace Collections::Pooled
{
	inline static constexpr unsigned int HashHelpers_TypeDefinitionIndex = 5071;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(HashHelpers_TypeDefinitionIndex)->GetStaticField(0x290);
		}
		...
		{
			return (::System::Runtime::CompilerServices::ConditionalWeakTable_2<::System::Object*, ::System::Runtime::Serialization::SerializationInfo*>**)Il2CppClass::FromTypeDefinitionIndex(HashHelpers_TypeDefinitionIndex)->GetStaticField(0x298);
		}
