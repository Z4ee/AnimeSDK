...
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x164AA7A0)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x164AAA00)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_EQUALS_3_OFFSET UNITYSDK_OFFSET(0x164AAAB0)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x164AA770)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x164AAB60)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x164AA830)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_GETNONRANDOMIZEDHASHCODE_OFFSET UNITYSDK_OFFSET(0x164AA950)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x164AA700)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x164AAC20)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x164AAC70)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x164AA750)
#define COLLECTIONS_POOLED_NONRANDOMIZEDSTRINGEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x164AA730)

namespace Collections::Pooled
{
	inline static constexpr unsigned int NonRandomizedStringEqualityComparer_TypeDefinitionIndex = 5312;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NonRandomizedStringEqualityComparer_TypeDefinitionIndex)->GetStaticField(0x2B0);
		}
