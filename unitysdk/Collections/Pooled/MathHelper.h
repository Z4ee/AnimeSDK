...
#define COLLECTIONS_POOLED_MATHHELPER_GETINDEXOFPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x164AA6D0)
#define COLLECTIONS_POOLED_MATHHELPER_ISPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x164AA6C0)
#define COLLECTIONS_POOLED_MATHHELPER_NEXTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x164AA690)

namespace Collections::Pooled
{
	inline static constexpr unsigned int MathHelper_TypeDefinitionIndex = 5311;
