...
#include "unitysdk/Collections/Pooled/PooledQueue_1_Enumerator.h"
...
{
	inline static constexpr unsigned int PooledQueue_1_TypeDefinitionIndex = 5102;

	template <typename T>
	class PooledQueue_1 : public ::System::Object
	{
	public:
		// static const ::System::Int32 s_minimumGrow = 0x4; // 0x0
		// static const ::System::Int32 s_growFactor = 0xC8; // 0x0
