...
#define CLASS_1_5B567C8A01BAEDFE_309_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198AB1C0)
#define CLASS_1_5B567C8A01BAEDFE_309_CLONE_OFFSET UNITYSDK_OFFSET(0x198AAFD0)
#define CLASS_1_5B567C8A01BAEDFE_309_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198AB0D0)
#define CLASS_1_5B567C8A01BAEDFE_309_EQUALS_OFFSET UNITYSDK_OFFSET(0x198AB040)
#define CLASS_1_5B567C8A01BAEDFE_309_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198AB120)
#define CLASS_1_5B567C8A01BAEDFE_309_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198AB210)
#define CLASS_1_5B567C8A01BAEDFE_309_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198AB1E0)
#define CLASS_1_5B567C8A01BAEDFE_309_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x198AAF20)
#define CLASS_1_5B567C8A01BAEDFE_309_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198AAF80)
#define CLASS_1_5B567C8A01BAEDFE_309_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198AB150)
#define CLASS_1_5B567C8A01BAEDFE_309_WRITETO_OFFSET UNITYSDK_OFFSET(0x198AB1B0)
#define CLASS_1_5B567C8A01BAEDFE_309__CCTOR_OFFSET UNITYSDK_OFFSET(0x198AB260)
#define CLASS_1_5B567C8A01BAEDFE_309__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198AAFA0)
#define CLASS_1_5B567C8A01BAEDFE_309__CTOR_OFFSET UNITYSDK_OFFSET(0x198AAF90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_309_TypeDefinitionIndex = 31236;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_309*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_309_TypeDefinitionIndex)->GetStaticField(0x4FC90);
	}
