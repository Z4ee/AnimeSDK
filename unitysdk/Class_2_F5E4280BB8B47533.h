...
#define CLASS_2_F5E4280BB8B47533_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1648BAB0)
#define CLASS_2_F5E4280BB8B47533_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1648C130)
#define CLASS_2_F5E4280BB8B47533_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1648C0E0)
#define CLASS_2_F5E4280BB8B47533_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1648BAF0)
#define CLASS_2_F5E4280BB8B47533_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1648C090)
#define CLASS_2_F5E4280BB8B47533_TICK_OFFSET UNITYSDK_OFFSET(0x1648C030)
#define CLASS_2_F5E4280BB8B47533__CTOR_OFFSET UNITYSDK_OFFSET(0x1648BAA0)

inline static constexpr unsigned int Class_2_F5E4280BB8B47533_TypeDefinitionIndex = 52750;

class Class_2_F5E4280BB8B47533 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::AdvPropSteer* OFKGLJOAMLD; // 0x20
