...
#define MONOUILOOPBGTEXT_AUTOREPAIR_OFFSET UNITYSDK_OFFSET(0x10437080)
#define MONOUILOOPBGTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x10436D10)
#define MONOUILOOPBGTEXT_GETRUNINGTIME_OFFSET UNITYSDK_OFFSET(0x104377C0)
#define MONOUILOOPBGTEXT_GET__INITPOS_OFFSET UNITYSDK_OFFSET(0x10436590)
#define MONOUILOOPBGTEXT_INIT_OFFSET UNITYSDK_OFFSET(0x10436640)
#define MONOUILOOPBGTEXT_INNERUPDATE_OFFSET UNITYSDK_OFFSET(0x10437860)
#define MONOUILOOPBGTEXT_RESETANIMATION_OFFSET UNITYSDK_OFFSET(0x104371F0)
#define MONOUILOOPBGTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x10437180)
#define MONOUILOOPBGTEXT_START_OFFSET UNITYSDK_OFFSET(0x10436DE0)
#define MONOUILOOPBGTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x10437810)
#define MONOUILOOPBGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x10437CA0)

inline static constexpr unsigned int MonoUILoopBGText_TypeDefinitionIndex = 52840;
