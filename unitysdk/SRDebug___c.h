...
#define SRDEBUG___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E66E560)
#define SRDEBUG___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1E66E590)
#define SRDEBUG___C__GETDEFAULTCOPYCONSOLEITEMCALLBACK_B__8_0_OFFSET UNITYSDK_OFFSET(0x1E66E5A0)
...
public:
	...
	{
		return (::System::Action_1<::SRDebugger::Services::ConsoleEntry*>**)Il2CppClass::FromTypeDefinitionIndex(SRDebug___c_TypeDefinitionIndex)->GetStaticField(0x43E90);
	}
	static ::SRDebug___c** StaticGet___9()
	{
		return (::SRDebug___c**)Il2CppClass::FromTypeDefinitionIndex(SRDebug___c_TypeDefinitionIndex)->GetStaticField(0x43E98);
	}
