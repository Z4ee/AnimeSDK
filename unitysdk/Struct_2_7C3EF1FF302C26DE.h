...
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3845720)
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_OFFSET UNITYSDK_OFFSET(0x38456E0)
#define STRUCT_2_7C3EF1FF302C26DE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38457F0)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_1_OFFSET UNITYSDK_OFFSET(0x18C14410)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x18C14350)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3845800)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3845880)

inline static constexpr unsigned int Struct_2_7C3EF1FF302C26DE_TypeDefinitionIndex = 38748;
...
struct alignas(8) Struct_2_7C3EF1FF302C26DE
{
	...
	{
		return ((::System::Boolean(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_EQUALS_OFFSET))(this, a1);
	}
