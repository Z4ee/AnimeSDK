...
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x22B7FF0)
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_OFFSET UNITYSDK_OFFSET(0x22B7FB0)
#define STRUCT_2_7C3EF1FF302C26DE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22B80D0)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_1_OFFSET UNITYSDK_OFFSET(0x180A6660)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x180A65A0)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x22B80E0)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22B8160)

inline static constexpr unsigned int Struct_2_7C3EF1FF302C26DE_TypeDefinitionIndex = 38007;
