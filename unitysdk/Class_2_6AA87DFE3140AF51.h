...
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_02B7A9B7DE670ADB_OFFSET UNITYSDK_OFFSET(0x138BC390)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x138BC330)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_0BA114B592B3A582_OFFSET UNITYSDK_OFFSET(0x138BC660)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_1B265F1038CD73C2_OFFSET UNITYSDK_OFFSET(0x138BC5F0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0x138BCAF0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_81D7D1157E92B61D_OFFSET UNITYSDK_OFFSET(0x138BC3F0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x138BC200)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x138BC920)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x138BCC80)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x138BCC00)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x138BC990)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_F4C8B018D655630D_OFFSET UNITYSDK_OFFSET(0x138BC9E0)
#define CLASS_2_6AA87DFE3140AF51__CTOR_OFFSET UNITYSDK_OFFSET(0x138BC170)
#define CLASS_2_6AA87DFE3140AF51__ONBIND_OFFSET UNITYSDK_OFFSET(0x138BBDC0)
#define CLASS_2_6AA87DFE3140AF51__ONTICK_OFFSET UNITYSDK_OFFSET(0x138BCA40)
#define CLASS_2_6AA87DFE3140AF51___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x138BCCE0)
#define CLASS_2_6AA87DFE3140AF51___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x138BCD40)

inline static constexpr unsigned int Class_2_6AA87DFE3140AF51_TypeDefinitionIndex = 67465;
...
public:
	...
	{
		return (::System::Nullable_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(Class_2_6AA87DFE3140AF51_TypeDefinitionIndex)->GetStaticField(0x13810);
	}
	::System::String* Field_2_1; // 0x60
	::System::String* Field_2_2; // 0x68
	::Class_1_23F67DD15593C8D6* Field_2_3; // 0x70
	::UnityEngine::Animation* Field_2_4; // 0x78
	::Class_2_2E24E31B9E151332* Field_2_5; // 0x80
	::System::String* Field_2_6; // 0x88
	::RPG::Client::LocalizedText* Field_2_7; // 0x90
	::RPG::Client::RPGAnimationEvent* Field_2_8; // 0x98
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_2_6AA87DFE3140AF51___IFIXBASEPROXY__ONTICK_OFFSET))(this, a1);
	}
};
