...
#define CLASS_2_5063DF4014902490_DISPOSE_OFFSET UNITYSDK_OFFSET(0x186C2A30)
#define CLASS_2_5063DF4014902490_METHOD_2_24A73FD2F3BEC0BF_OFFSET UNITYSDK_OFFSET(0x186C2C50)
#define CLASS_2_5063DF4014902490_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x186C2AF0)
#define CLASS_2_5063DF4014902490_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x186C2BA0)
#define CLASS_2_5063DF4014902490_TICK_OFFSET UNITYSDK_OFFSET(0x186C2BF0)
#define CLASS_2_5063DF4014902490__CTOR_OFFSET UNITYSDK_OFFSET(0x186C2A20)
...
{
public:
	::RPG::GameCore::WaitUIEvent* OFKGLJOAMLD; // 0x18
