...
#define CLASS_3_A56D1E75A2012BD6_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x181E11B0)
#define CLASS_3_A56D1E75A2012BD6_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x181E1310)
#define CLASS_3_A56D1E75A2012BD6_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x181E1290)
#define CLASS_3_A56D1E75A2012BD6_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x181E1160)
#define CLASS_3_A56D1E75A2012BD6__CCTOR_OFFSET UNITYSDK_OFFSET(0x181E1200)
#define CLASS_3_A56D1E75A2012BD6__CTOR_OFFSET UNITYSDK_OFFSET(0x181E1280)

inline static constexpr unsigned int Class_3_A56D1E75A2012BD6_TypeDefinitionIndex = 70706;

class Class_3_A56D1E75A2012BD6 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_0 = 0x23; // 0x0
	::UnityEngine::AI::NavMeshObstacle* Field_3_2; // 0x48
