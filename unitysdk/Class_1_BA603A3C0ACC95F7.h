...
#define CLASS_1_BA603A3C0ACC95F7_GET_LINEUP_OFFSET UNITYSDK_OFFSET(0x160B80A0)
#define CLASS_1_BA603A3C0ACC95F7_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x160B8080)
#define CLASS_1_BA603A3C0ACC95F7_SET_LINEUP_OFFSET UNITYSDK_OFFSET(0x160B80B0)
#define CLASS_1_BA603A3C0ACC95F7_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x160B8090)
#define CLASS_1_BA603A3C0ACC95F7__CTOR_OFFSET UNITYSDK_OFFSET(0x160B80C0)

inline static constexpr unsigned int Class_1_BA603A3C0ACC95F7_TypeDefinitionIndex = 80154;

class Class_1_BA603A3C0ACC95F7 : public ::System::Object
{
public:
	::RPG::Client::Challenge::Tierce::ChallengeTierceSessionStageResultBase* _Result_k__BackingField; // 0x10
	::Class_1_D40936EF3BF54118_4* _Lineup_k__BackingField; // 0x18
