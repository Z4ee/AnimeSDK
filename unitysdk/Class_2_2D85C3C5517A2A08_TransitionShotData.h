...
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_GET_FORWARDDIR_OFFSET UNITYSDK_OFFSET(0x128EAB20)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_GET_RIGHTDIR_OFFSET UNITYSDK_OFFSET(0x128EAB60)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_GET_SHOTAIMCENTERPOS_OFFSET UNITYSDK_OFFSET(0x128EAAA0)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_GET_SHOTINITCENTERPOS_OFFSET UNITYSDK_OFFSET(0x128EAAE0)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_SET_FORWARDDIR_OFFSET UNITYSDK_OFFSET(0x128EAB40)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_SET_RIGHTDIR_OFFSET UNITYSDK_OFFSET(0x128EAB80)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_SET_SHOTAIMCENTERPOS_OFFSET UNITYSDK_OFFSET(0x128EAAC0)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA_SET_SHOTINITCENTERPOS_OFFSET UNITYSDK_OFFSET(0x128EAB00)
#define CLASS_2_2D85C3C5517A2A08_TRANSITIONSHOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x128EAA90)

inline static constexpr unsigned int Class_2_2D85C3C5517A2A08_TransitionShotData_TypeDefinitionIndex = 64176;
