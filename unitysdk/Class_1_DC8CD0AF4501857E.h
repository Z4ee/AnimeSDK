...
#define CLASS_1_DC8CD0AF4501857E_METHOD_1_BA928C31B09C0D39_OFFSET UNITYSDK_OFFSET(0x1CA92650)
#define CLASS_1_DC8CD0AF4501857E__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA92A40)
...
public:
	...
	::Il2CppArray<::Class_1_584A0EBB2813A76B*>* OJBEKHJBIHL; // 0x20
	::RPG::Client::TextID AIFCBBLPHHI; // 0x28
	::RPG::GameCore::LimaoNewsPlanPhaseType ABPCHBOBLNB; // 0x38
	::RPG::Client::TextID CCHLHJCMFGM; // 0x40
	::System::UInt32 OPOPKLGBNKB; // 0x50
	::System::UInt32 NFIKDONNJMD; // 0x54
