...
#define CLASS_1_7D93990153DD34ED_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC523A40)
#define CLASS_1_7D93990153DD34ED_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC521F10)
#define CLASS_1_7D93990153DD34ED_METHOD_1_499C93D7C9F81C2E_OFFSET UNITYSDK_OFFSET(0xC522960)
#define CLASS_1_7D93990153DD34ED_METHOD_1_4BE99DDCF7F1FD88_OFFSET UNITYSDK_OFFSET(0xC522910)
#define CLASS_1_7D93990153DD34ED_METHOD_1_6AF8CC03883E6064_OFFSET UNITYSDK_OFFSET(0xC521060)
#define CLASS_1_7D93990153DD34ED_METHOD_1_7D5C8911419B1FA3_OFFSET UNITYSDK_OFFSET(0xC521E90)
#define CLASS_1_7D93990153DD34ED_METHOD_1_92EF378E5C246C05_OFFSET UNITYSDK_OFFSET(0xC521380)
#define CLASS_1_7D93990153DD34ED_METHOD_1_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xC523D90)
#define CLASS_1_7D93990153DD34ED_METHOD_1_C450A961450309C9_1_OFFSET UNITYSDK_OFFSET(0xC523C20)
#define CLASS_1_7D93990153DD34ED_METHOD_1_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xC523AB0)
#define CLASS_1_7D93990153DD34ED_TEARDOWN_OFFSET UNITYSDK_OFFSET(0xC523390)
#define CLASS_1_7D93990153DD34ED__CTOR_OFFSET UNITYSDK_OFFSET(0xC521050)

inline static constexpr unsigned int Class_1_7D93990153DD34ED_TypeDefinitionIndex = 76357;

class Class_1_7D93990153DD34ED : public ::System::Object
{
public:
	::Class_1_2CDF619C23140440* FKINCGODJEP; // 0x10
	::UnityEngine::Coroutine* BEIIDJKKJEG; // 0x18
	::Class_3_912CC478F2B21832* PDENFEFCAGN; // 0x20
	::System::Single PCOMMLHHNOA; // 0x28
	::System::Int32 EAGMNCBBOIK; // 0x2C
