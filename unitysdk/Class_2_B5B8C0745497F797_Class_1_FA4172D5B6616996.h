...
#define CLASS_2_B5B8C0745497F797_CLASS_1_FA4172D5B6616996__CTOR_OFFSET UNITYSDK_OFFSET(0x1A75E020)
...
{
public:
	::System::Collections::Generic::List_1<::UnityEngine::Vector4>* MODHBNJHAEP; // 0x10
	::Il2CppArray<::UnityEngine::ParticleSystem_Particle>* BDIAMMKNGLA; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Vector4>* MBMPMMMJGGC; // 0x20
