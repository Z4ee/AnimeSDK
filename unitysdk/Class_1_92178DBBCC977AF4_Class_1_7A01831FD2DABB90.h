...
#define CLASS_1_92178DBBCC977AF4_CLASS_1_7A01831FD2DABB90__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF8A280)
#define CLASS_1_92178DBBCC977AF4_CLASS_1_7A01831FD2DABB90__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF8A200)

inline static constexpr unsigned int Class_1_92178DBBCC977AF4_Class_1_7A01831FD2DABB90_TypeDefinitionIndex = 40362;

class Class_1_92178DBBCC977AF4_Class_1_7A01831FD2DABB90 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::System::UInt32>* GEIAMAJHJOM; // 0x10
	::System::Int32 KOLODCBCIBM; // 0x18
	::Enum_3_0A3761FE34514D6C_27 FFEPLIHOFLA; // 0x1C
	::System::Int32 AHGIENEMKFI; // 0x20
	::System::Int32 LFPBDLMKCMA; // 0x24
	::System::Int32 KKOHJJCHHCI; // 0x28
	::System::Int32 ABHHIEEBJLB; // 0x2C
	::System::UInt32 PHFMCACHFIJ; // 0x30
	::System::Int32 OICNICJICFN; // 0x34
	::System::Int32 POJIJMMGAFB; // 0x38
	::System::Boolean ELGNOMOFHAG; // 0x3C
	::System::UInt32 PJNNPOKJEFD; // 0x40
	::System::UInt32 PMIEAEGJNMJ; // 0x44
	::RPG::GameCore::ChimeraDuelTeamType JCDIEKGKCPP; // 0x48
	::System::Int32 JJNEIJNMKJG; // 0x4C
	::System::Int32 IPIFLCJBDEE; // 0x50
	::System::UInt32 AAGKEBFHLMC; // 0x54
