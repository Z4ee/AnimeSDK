...
#define CLASS_2_E30AD93D1A269424_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0D2CA0)
#define CLASS_2_E30AD93D1A269424_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A0D2C10)
#define CLASS_2_E30AD93D1A269424_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A0D2CE0)
#define CLASS_2_E30AD93D1A269424_TICK_OFFSET UNITYSDK_OFFSET(0x1A0D2D30)
#define CLASS_2_E30AD93D1A269424__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D2C00)

inline static constexpr unsigned int Class_2_E30AD93D1A269424_TypeDefinitionIndex = 53049;

class Class_2_E30AD93D1A269424 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::SetFollowLightDeviceDamp* OFKGLJOAMLD; // 0x20
