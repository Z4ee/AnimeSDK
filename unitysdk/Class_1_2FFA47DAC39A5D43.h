...
#define CLASS_1_2FFA47DAC39A5D43_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1656D4E0)
#define CLASS_1_2FFA47DAC39A5D43_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1656D3E0)
#define CLASS_1_2FFA47DAC39A5D43_METHOD_1_F75A8ECE5CAA5D87_OFFSET UNITYSDK_OFFSET(0x1656DB40)
#define CLASS_1_2FFA47DAC39A5D43_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x1656DA10)
#define CLASS_1_2FFA47DAC39A5D43__CTOR_OFFSET UNITYSDK_OFFSET(0x1656D3D0)

inline static constexpr unsigned int Class_1_2FFA47DAC39A5D43_TypeDefinitionIndex = 76334;

class Class_1_2FFA47DAC39A5D43 : public ::System::Object
{
public:
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelRuntimeInspector* AJICFFBAAKJ; // 0x10
