...
#define WAVESIMSHAPETEXBAKER_GETPANEL_OFFSET UNITYSDK_OFFSET(0xE9A2990)
#define WAVESIMSHAPETEXBAKER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE9A27B0)
#define WAVESIMSHAPETEXBAKER_SETCOLLECTDEBUG_OFFSET UNITYSDK_OFFSET(0xE9A2810)
#define WAVESIMSHAPETEXBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0xE9A2A50)
