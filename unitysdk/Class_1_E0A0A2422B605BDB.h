...
#define CLASS_1_E0A0A2422B605BDB_METHOD_1_943A3CE8BB953879_OFFSET UNITYSDK_OFFSET(0xC0D1D20)
#define CLASS_1_E0A0A2422B605BDB_METHOD_1_F22E7E7C9FC01A6F_OFFSET UNITYSDK_OFFSET(0xC0D1F00)
#define CLASS_1_E0A0A2422B605BDB__CCTOR_OFFSET UNITYSDK_OFFSET(0xC0D1FE0)

inline static constexpr unsigned int Class_1_E0A0A2422B605BDB_TypeDefinitionIndex = 48054;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::UnityEngine::PrimitiveType, ::UnityEngine::Mesh*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E0A0A2422B605BDB_TypeDefinitionIndex)->GetStaticField(0x6A930);
	}
