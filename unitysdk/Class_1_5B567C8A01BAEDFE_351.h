...
#define CLASS_1_5B567C8A01BAEDFE_351_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CEACDB0)
#define CLASS_1_5B567C8A01BAEDFE_351_CLONE_OFFSET UNITYSDK_OFFSET(0x1CEACAA0)
#define CLASS_1_5B567C8A01BAEDFE_351_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CEACBB0)
#define CLASS_1_5B567C8A01BAEDFE_351_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CEACAE0)
#define CLASS_1_5B567C8A01BAEDFE_351_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CEACD10)
#define CLASS_1_5B567C8A01BAEDFE_351_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CEACE00)
#define CLASS_1_5B567C8A01BAEDFE_351_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CEACDD0)
#define CLASS_1_5B567C8A01BAEDFE_351_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CEACA20)
#define CLASS_1_5B567C8A01BAEDFE_351_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CEACA50)
#define CLASS_1_5B567C8A01BAEDFE_351_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CEACD40)
#define CLASS_1_5B567C8A01BAEDFE_351_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CEACDA0)
#define CLASS_1_5B567C8A01BAEDFE_351__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CEACE50)
#define CLASS_1_5B567C8A01BAEDFE_351__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CEACA70)
#define CLASS_1_5B567C8A01BAEDFE_351__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEACA60)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_351_TypeDefinitionIndex = 33145;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_351*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_351_TypeDefinitionIndex)->GetStaticField(0x34B60);
	}
