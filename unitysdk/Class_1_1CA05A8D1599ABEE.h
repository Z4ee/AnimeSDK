...
#define CLASS_1_1CA05A8D1599ABEE_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x129B3F70)
#define CLASS_1_1CA05A8D1599ABEE_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x129B40B0)
#define CLASS_1_1CA05A8D1599ABEE_METHOD_1_997EBC8B2A2EC9F8_OFFSET UNITYSDK_OFFSET(0x129B3F90)
#define CLASS_1_1CA05A8D1599ABEE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x129B4060)
#define CLASS_1_1CA05A8D1599ABEE_SET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x129B3F80)
#define CLASS_1_1CA05A8D1599ABEE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x129B4800)
#define CLASS_1_1CA05A8D1599ABEE__CTOR_OFFSET UNITYSDK_OFFSET(0x129B4870)
#define CLASS_1_1CA05A8D1599ABEE___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x129B4900)

inline static constexpr unsigned int Class_1_1CA05A8D1599ABEE_TypeDefinitionIndex = 72633;
