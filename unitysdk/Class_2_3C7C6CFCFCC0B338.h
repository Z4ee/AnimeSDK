...
#define CLASS_2_3C7C6CFCFCC0B338_DISPOSE_OFFSET UNITYSDK_OFFSET(0x163DEA30)
#define CLASS_2_3C7C6CFCFCC0B338_METHOD_2_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0x163DE350)
#define CLASS_2_3C7C6CFCFCC0B338_METHOD_2_F5B4708E7805566C_OFFSET UNITYSDK_OFFSET(0x163DE430)
#define CLASS_2_3C7C6CFCFCC0B338_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x163DE210)
#define CLASS_2_3C7C6CFCFCC0B338_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x163DE9A0)
#define CLASS_2_3C7C6CFCFCC0B338_TICK_OFFSET UNITYSDK_OFFSET(0x163DE8C0)
#define CLASS_2_3C7C6CFCFCC0B338__CTOR_OFFSET UNITYSDK_OFFSET(0x163DE200)
...
public:
	...
	::RPG::GameCore::UITriggerMonopolyModifier* OFKGLJOAMLD; // 0x20
