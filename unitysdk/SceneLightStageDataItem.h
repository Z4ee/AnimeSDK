...
#define SCENELIGHTSTAGEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0765F0)

inline static constexpr unsigned int SceneLightStageDataItem_TypeDefinitionIndex = 44683;
