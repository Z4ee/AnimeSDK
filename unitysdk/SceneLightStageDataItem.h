...
#define SCENELIGHTSTAGEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19F67030)

inline static constexpr unsigned int SceneLightStageDataItem_TypeDefinitionIndex = 45598;
