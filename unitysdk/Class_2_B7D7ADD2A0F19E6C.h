...
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0x1867BD40)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1867BE20)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_1CF29F34FEF30EFD_OFFSET UNITYSDK_OFFSET(0x1867BAB0)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_57E77DB19367C4CF_OFFSET UNITYSDK_OFFSET(0x1867B730)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_A0646B40A733EA40_OFFSET UNITYSDK_OFFSET(0x1867B990)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_DE8FDF9C87F3AA65_OFFSET UNITYSDK_OFFSET(0x1867BC10)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_FB6392A8F30862C7_OFFSET UNITYSDK_OFFSET(0x1867BCB0)
#define CLASS_2_B7D7ADD2A0F19E6C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1867B520)
#define CLASS_2_B7D7ADD2A0F19E6C__CTOR_OFFSET UNITYSDK_OFFSET(0x1867BC00)

inline static constexpr unsigned int Class_2_B7D7ADD2A0F19E6C_TypeDefinitionIndex = 43709;

class Class_2_B7D7ADD2A0F19E6C : public ::MoleMole::Config::AnimatorEvent
{
public:
	::System::String* Field_2_1; // 0x50
	::MoleMole::Config::BaseProperty Field_2_0; // 0x58
	::MoleMole::Config::PropertyModifyFunction Field_2_2; // 0x5C
