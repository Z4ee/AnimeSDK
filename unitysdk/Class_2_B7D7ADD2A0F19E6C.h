...
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0x1234C7F0)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1234C960)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_1CF29F34FEF30EFD_OFFSET UNITYSDK_OFFSET(0x1234C690)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_57E77DB19367C4CF_OFFSET UNITYSDK_OFFSET(0x1234C310)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_A0646B40A733EA40_OFFSET UNITYSDK_OFFSET(0x1234C570)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_DE8FDF9C87F3AA65_OFFSET UNITYSDK_OFFSET(0x1234C9A0)
#define CLASS_2_B7D7ADD2A0F19E6C_METHOD_2_FB6392A8F30862C7_OFFSET UNITYSDK_OFFSET(0x1234C8D0)
#define CLASS_2_B7D7ADD2A0F19E6C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1234C100)
#define CLASS_2_B7D7ADD2A0F19E6C__CTOR_OFFSET UNITYSDK_OFFSET(0x1234C7E0)

inline static constexpr unsigned int Class_2_B7D7ADD2A0F19E6C_TypeDefinitionIndex = 61891;

class Class_2_B7D7ADD2A0F19E6C : public ::MoleMole::Config::AnimatorEvent
{
public:
	::System::String* Field_2_2; // 0x50
	::MoleMole::Config::PropertyModifyFunction Field_2_1; // 0x58
	::MoleMole::Config::BaseProperty Field_2_3; // 0x5C
