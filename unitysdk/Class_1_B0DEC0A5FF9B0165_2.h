...
#define CLASS_1_B0DEC0A5FF9B0165_2_METHOD_1_076FEE641C2B6499_OFFSET UNITYSDK_OFFSET(0xA790360)
#define CLASS_1_B0DEC0A5FF9B0165_2_METHOD_1_9C06C768B25E4E13_OFFSET UNITYSDK_OFFSET(0xA7902F0)
#define CLASS_1_B0DEC0A5FF9B0165_2__CCTOR_OFFSET UNITYSDK_OFFSET(0xA790420)
#define CLASS_1_B0DEC0A5FF9B0165_2__CTOR_OFFSET UNITYSDK_OFFSET(0xA790350)

inline static constexpr unsigned int Class_1_B0DEC0A5FF9B0165_2_TypeDefinitionIndex = 69331;
...
public:
	...
	{
		return (::Class_1_B0DEC0A5FF9B0165_2**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B0DEC0A5FF9B0165_2_TypeDefinitionIndex)->GetStaticField(0x5BEF0);
	}
