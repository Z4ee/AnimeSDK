...
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x139E51D0)
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x139E5210)
#define MONOLAYOUTELEMENTPROCESSOR_CANUSE_OFFSET UNITYSDK_OFFSET(0x139E42A0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x139E4D30)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x139E4F80)
#define MONOLAYOUTELEMENTPROCESSOR_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x139E4D20)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x139E4AD0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x139E4880)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x139E4630)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x139E43E0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_SOURCELAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x139E43A0)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x139E40F0)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCETYPE_OFFSET UNITYSDK_OFFSET(0x139E4070)
#define MONOLAYOUTELEMENTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x139E5250)

inline static constexpr unsigned int MonoLayoutElementProcessor_TypeDefinitionIndex = 75398;
