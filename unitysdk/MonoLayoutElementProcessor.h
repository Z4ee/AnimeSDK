...
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1345C630)
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1345C670)
#define MONOLAYOUTELEMENTPROCESSOR_CANUSE_OFFSET UNITYSDK_OFFSET(0x1345B700)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x1345C190)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x1345C3E0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1345C180)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1345BF30)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1345BCE0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1345BA90)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1345B840)
#define MONOLAYOUTELEMENTPROCESSOR_GET_SOURCELAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x1345B800)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1345B550)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCETYPE_OFFSET UNITYSDK_OFFSET(0x1345B4D0)
#define MONOLAYOUTELEMENTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1345C6B0)

inline static constexpr unsigned int MonoLayoutElementProcessor_TypeDefinitionIndex = 53624;
