...
#define CLASS_2_C219469667DBAA6A_CLASS_1_AD08101070EC9E76_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12C965C0)
#define CLASS_2_C219469667DBAA6A_CLASS_1_AD08101070EC9E76_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12C96AD0)
#define CLASS_2_C219469667DBAA6A_CLASS_1_AD08101070EC9E76_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12C96B30)
#define CLASS_2_C219469667DBAA6A_CLASS_1_AD08101070EC9E76_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12C96AE0)
#define CLASS_2_C219469667DBAA6A_CLASS_1_AD08101070EC9E76_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12C965B0)
#define CLASS_2_C219469667DBAA6A_CLASS_1_AD08101070EC9E76__CTOR_OFFSET UNITYSDK_OFFSET(0x12C965A0)

inline static constexpr unsigned int Class_2_C219469667DBAA6A_Class_1_AD08101070EC9E76_TypeDefinitionIndex = 65657;

class Class_2_C219469667DBAA6A_Class_1_AD08101070EC9E76 : public ::System::Object
{
public:
	::Foundation::AssetRequestHandle Field_1_9; // 0x10
	::System::Object* Field_1_0; // 0x30
	::Class_2_C219469667DBAA6A* Field_1_7; // 0x38
	::UnityEngine::ShaderVariantCollection* Field_1_10; // 0x40
	::System::Action_1<::System::Single>* Field_1_6; // 0x48
