...
#define AIRSHIPRANDOMFLOATING_AWAKE_OFFSET UNITYSDK_OFFSET(0x10BF7C90)
#define AIRSHIPRANDOMFLOATING_METHOD_5_A678846DF98684D3_OFFSET UNITYSDK_OFFSET(0x10BF83D0)
#define AIRSHIPRANDOMFLOATING_METHOD_5_C34AC80B04BCFF1B_OFFSET UNITYSDK_OFFSET(0x10BF89A0)
#define AIRSHIPRANDOMFLOATING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10BF7D90)
#define AIRSHIPRANDOMFLOATING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10BF7D40)
#define AIRSHIPRANDOMFLOATING_TICK_OFFSET UNITYSDK_OFFSET(0x10BF7EA0)
#define AIRSHIPRANDOMFLOATING_UPDATE_OFFSET UNITYSDK_OFFSET(0x10BF7E40)
#define AIRSHIPRANDOMFLOATING__CTOR_OFFSET UNITYSDK_OFFSET(0x10BF8AB0)

inline static constexpr unsigned int AirShipRandomFloating_TypeDefinitionIndex = 37994;
