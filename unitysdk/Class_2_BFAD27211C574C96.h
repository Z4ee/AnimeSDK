...
#define CLASS_2_BFAD27211C574C96_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x143F5340)
#define CLASS_2_BFAD27211C574C96__CTOR_OFFSET UNITYSDK_OFFSET(0x143F52F0)
#define CLASS_2_BFAD27211C574C96___IFIXBASEPROXY_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x143F53B0)

inline static constexpr unsigned int Class_2_BFAD27211C574C96_TypeDefinitionIndex = 67031;
