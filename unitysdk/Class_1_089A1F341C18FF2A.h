...
#define CLASS_1_089A1F341C18FF2A__CTOR_OFFSET UNITYSDK_OFFSET(0x16B07040)

inline static constexpr unsigned int Class_1_089A1F341C18FF2A_TypeDefinitionIndex = 79250;

class Class_1_089A1F341C18FF2A : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* ILIPCNCIPBB; // 0x10
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* OBNHCGIDDDC; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* HODNMBAEKPG; // 0x20
