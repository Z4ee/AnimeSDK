...
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1B6BC5B0)
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1B6BC300)
#define PATHCREATION_PATHCREATORDATA_BEZIERPATHEDITED_OFFSET UNITYSDK_OFFSET(0x1B6BC990)
#define PATHCREATION_PATHCREATORDATA_CREATEBEZIER_OFFSET UNITYSDK_OFFSET(0x1B6BC6B0)
#define PATHCREATION_PATHCREATORDATA_GETVERTEXPATH_OFFSET UNITYSDK_OFFSET(0x1B6BBFA0)
#define PATHCREATION_PATHCREATORDATA_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1B6BC8E0)
#define PATHCREATION_PATHCREATORDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6BC380)
#define PATHCREATION_PATHCREATORDATA_PATHMODIFIEDBYUNDO_OFFSET UNITYSDK_OFFSET(0x1B6BC970)
#define PATHCREATION_PATHCREATORDATA_PATHTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1B6BC940)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1B6BC630)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1B6BC280)
#define PATHCREATION_PATHCREATORDATA_RESETBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1B6BC8B0)
#define PATHCREATION_PATHCREATORDATA_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1B6BC0A0)
#define PATHCREATION_PATHCREATORDATA_VERTEXPATHSETTINGSCHANGED_OFFSET UNITYSDK_OFFSET(0x1B6BC950)
#define PATHCREATION_PATHCREATORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BC250)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreatorData_TypeDefinitionIndex = 35841;
