...
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1EEB46B0)
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1EEB4400)
#define PATHCREATION_PATHCREATORDATA_BEZIERPATHEDITED_OFFSET UNITYSDK_OFFSET(0x1EEB4A90)
#define PATHCREATION_PATHCREATORDATA_CREATEBEZIER_OFFSET UNITYSDK_OFFSET(0x1EEB47B0)
#define PATHCREATION_PATHCREATORDATA_GETVERTEXPATH_OFFSET UNITYSDK_OFFSET(0x1EEB40A0)
#define PATHCREATION_PATHCREATORDATA_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1EEB49E0)
#define PATHCREATION_PATHCREATORDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EEB4480)
#define PATHCREATION_PATHCREATORDATA_PATHMODIFIEDBYUNDO_OFFSET UNITYSDK_OFFSET(0x1EEB4A70)
#define PATHCREATION_PATHCREATORDATA_PATHTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1EEB4A40)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1EEB4730)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1EEB4380)
#define PATHCREATION_PATHCREATORDATA_RESETBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1EEB49B0)
#define PATHCREATION_PATHCREATORDATA_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1EEB41A0)
#define PATHCREATION_PATHCREATORDATA_VERTEXPATHSETTINGSCHANGED_OFFSET UNITYSDK_OFFSET(0x1EEB4A50)
#define PATHCREATION_PATHCREATORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEB4350)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreatorData_TypeDefinitionIndex = 38110;
