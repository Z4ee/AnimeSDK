...
#define PATHCREATION_PATHCREATOR_ADD_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1B6B8900)
#define PATHCREATION_PATHCREATOR_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1B6BC060)
#define PATHCREATION_PATHCREATOR_GET_EDITORDATA_OFFSET UNITYSDK_OFFSET(0x1B6BC540)
#define PATHCREATION_PATHCREATOR_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1B6B8BE0)
#define PATHCREATION_PATHCREATOR_INITIALIZEEDITORDATA_OFFSET UNITYSDK_OFFSET(0x1B6BBDC0)
#define PATHCREATION_PATHCREATOR_REMOVE_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1B6BBD40)
#define PATHCREATION_PATHCREATOR_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1B6B86A0)
#define PATHCREATION_PATHCREATOR_TRIGGERPATHUPDATE_OFFSET UNITYSDK_OFFSET(0x1B6BC550)
#define PATHCREATION_PATHCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BC560)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreator_TypeDefinitionIndex = 35840;
