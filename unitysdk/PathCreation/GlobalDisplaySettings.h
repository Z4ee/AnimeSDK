...
#define PATHCREATION_GLOBALDISPLAYSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DABEC40)

namespace PathCreation
{
	inline static constexpr unsigned int GlobalDisplaySettings_TypeDefinitionIndex = 37445;
