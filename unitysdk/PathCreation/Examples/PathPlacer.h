...
#define PATHCREATION_EXAMPLES_PATHPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEB0FF0)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathPlacer_TypeDefinitionIndex = 38121;
