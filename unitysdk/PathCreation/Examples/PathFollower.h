...
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_ONPATHCHANGED_OFFSET UNITYSDK_OFFSET(0x1B6B8D20)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_START_OFFSET UNITYSDK_OFFSET(0x1B6B8730)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B6B8980)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B8E70)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathFollower_TypeDefinitionIndex = 35851;
