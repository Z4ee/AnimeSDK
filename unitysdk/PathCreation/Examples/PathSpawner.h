...
#define PATHCREATION_EXAMPLES_PATHSPAWNER_START_OFFSET UNITYSDK_OFFSET(0x1EEB12D0)
#define PATHCREATION_EXAMPLES_PATHSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEB1490)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathSpawner_TypeDefinitionIndex = 38127;
