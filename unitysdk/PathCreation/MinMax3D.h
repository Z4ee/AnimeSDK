...
#define PATHCREATION_MINMAX3D_ADDVALUE_OFFSET UNITYSDK_OFFSET(0x1EEAEF00)
#define PATHCREATION_MINMAX3D_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1EEB3E20)
#define PATHCREATION_MINMAX3D_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1EEB3DF0)
#define PATHCREATION_MINMAX3D_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1EEB3E40)
#define PATHCREATION_MINMAX3D_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1EEB3E10)
#define PATHCREATION_MINMAX3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEAEDC0)

namespace PathCreation
{
	inline static constexpr unsigned int MinMax3D_TypeDefinitionIndex = 38108;
