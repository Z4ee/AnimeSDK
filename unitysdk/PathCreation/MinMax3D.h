...
#define PATHCREATION_MINMAX3D_ADDVALUE_OFFSET UNITYSDK_OFFSET(0x1B6B6C30)
#define PATHCREATION_MINMAX3D_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1B6BBD10)
#define PATHCREATION_MINMAX3D_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1B6BBCE0)
#define PATHCREATION_MINMAX3D_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1B6BBD30)
#define PATHCREATION_MINMAX3D_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1B6BBD00)
#define PATHCREATION_MINMAX3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B6AF0)

namespace PathCreation
{
	inline static constexpr unsigned int MinMax3D_TypeDefinitionIndex = 35839;
