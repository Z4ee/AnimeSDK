...
#define PATHCREATION_VERTEXPATH_CALCULATECLOSESTPOINTONPATHDATA_OFFSET UNITYSDK_OFFSET(0x1B6C30C0)
#define PATHCREATION_VERTEXPATH_CALCULATEPERCENTONPATHDATA_OFFSET UNITYSDK_OFFSET(0x1B6C2B30)
#define PATHCREATION_VERTEXPATH_GETCLOSESTDISTANCEALONGPATH_OFFSET UNITYSDK_OFFSET(0x1B6B8DC0)
#define PATHCREATION_VERTEXPATH_GETCLOSESTPOINTONPATH_OFFSET UNITYSDK_OFFSET(0x1B6C2DC0)
#define PATHCREATION_VERTEXPATH_GETCLOSESTTIMEONPATH_OFFSET UNITYSDK_OFFSET(0x1B6C3950)
#define PATHCREATION_VERTEXPATH_GETDIRECTIONATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B6C2310)
#define PATHCREATION_VERTEXPATH_GETDIRECTION_OFFSET UNITYSDK_OFFSET(0x1B6C2340)
#define PATHCREATION_VERTEXPATH_GETNORMALATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B6C2540)
#define PATHCREATION_VERTEXPATH_GETNORMAL_1_OFFSET UNITYSDK_OFFSET(0x1B6C2570)
#define PATHCREATION_VERTEXPATH_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1B6BB8D0)
#define PATHCREATION_VERTEXPATH_GETPOINTATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B6B8CC0)
#define PATHCREATION_VERTEXPATH_GETPOINTATTIME_OFFSET UNITYSDK_OFFSET(0x1B6C2030)
#define PATHCREATION_VERTEXPATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B6BBA10)
#define PATHCREATION_VERTEXPATH_GETROTATIONATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B6B8CF0)
#define PATHCREATION_VERTEXPATH_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1B6C2770)
#define PATHCREATION_VERTEXPATH_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1B6BB790)
#define PATHCREATION_VERTEXPATH_GET_NUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1B6BB770)
#define PATHCREATION_VERTEXPATH_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B6C2020)
#define PATHCREATION_VERTEXPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6C1FD0)
#define PATHCREATION_VERTEXPATH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6C0F80)
#define PATHCREATION_VERTEXPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BC8F0)

namespace PathCreation
{
	inline static constexpr unsigned int VertexPath_TypeDefinitionIndex = 35843;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Vector3>* localTangents; // 0x18
		::Il2CppArray<::UnityEngine::Vector3>* localNormals; // 0x20
		::UnityEngine::Transform* transform; // 0x28
		::Il2CppArray<::UnityEngine::Vector3>* localPoints; // 0x30
		::Il2CppArray<::System::Single>* times; // 0x38
		::UnityEngine::Vector3 up; // 0x40
		::PathCreation::PathSpace space; // 0x4C
		::System::Boolean isClosedLoop; // 0x50
		::UnityEngine::Bounds bounds; // 0x54
		::System::Single length; // 0x6C
