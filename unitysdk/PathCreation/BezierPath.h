...
#define PATHCREATION_BEZIERPATH_ADDSEGMENTTOEND_OFFSET UNITYSDK_OFFSET(0x1EEABA50)
#define PATHCREATION_BEZIERPATH_ADDSEGMENTTOSTART_OFFSET UNITYSDK_OFFSET(0x1EEACCC0)
#define PATHCREATION_BEZIERPATH_ADD_ONMODIFIED_OFFSET UNITYSDK_OFFSET(0x1EEAAF60)
#define PATHCREATION_BEZIERPATH_ADD_ONMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1EEAB060)
#define PATHCREATION_BEZIERPATH_AUTOSETALLAFFECTEDCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1EEACC40)
#define PATHCREATION_BEZIERPATH_AUTOSETALLCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1EEACB00)
#define PATHCREATION_BEZIERPATH_AUTOSETANCHORCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1EEAFB70)
#define PATHCREATION_BEZIERPATH_AUTOSETSTARTANDENDCONTROLS_OFFSET UNITYSDK_OFFSET(0x1EEB0050)
#define PATHCREATION_BEZIERPATH_CALCULATEBOUNDSWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EEAE580)
#define PATHCREATION_BEZIERPATH_DELETESEGMENT_OFFSET UNITYSDK_OFFSET(0x1EEAE2C0)
#define PATHCREATION_BEZIERPATH_GETANCHORNORMALANGLE_OFFSET UNITYSDK_OFFSET(0x1EEAF3A0)
#define PATHCREATION_BEZIERPATH_GETPOINTSINSEGMENT_OFFSET UNITYSDK_OFFSET(0x1EEAD6F0)
#define PATHCREATION_BEZIERPATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1EEAC0E0)
#define PATHCREATION_BEZIERPATH_GET_AUTOCONTROLLENGTH_OFFSET UNITYSDK_OFFSET(0x1EEACB80)
#define PATHCREATION_BEZIERPATH_GET_CONTROLPOINTMODE_OFFSET UNITYSDK_OFFSET(0x1EEACA50)
#define PATHCREATION_BEZIERPATH_GET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1EEAF330)
#define PATHCREATION_BEZIERPATH_GET_GLOBALNORMALSANGLE_OFFSET UNITYSDK_OFFSET(0x1EEAF360)
#define PATHCREATION_BEZIERPATH_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1EEAC710)
#define PATHCREATION_BEZIERPATH_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1EEAC090)
#define PATHCREATION_BEZIERPATH_GET_NUMANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x1EEAC1F0)
#define PATHCREATION_BEZIERPATH_GET_NUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1EEAC1D0)
#define PATHCREATION_BEZIERPATH_GET_NUMSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1EEAC240)
#define PATHCREATION_BEZIERPATH_GET_PATHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1EEAF500)
#define PATHCREATION_BEZIERPATH_GET_SPACE_OFFSET UNITYSDK_OFFSET(0x1EEAC270)
#define PATHCREATION_BEZIERPATH_LOOPINDEX_OFFSET UNITYSDK_OFFSET(0x1EEAE550)
#define PATHCREATION_BEZIERPATH_MOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1EEADDD0)
#define PATHCREATION_BEZIERPATH_NOTIFYPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1EEAC1B0)
#define PATHCREATION_BEZIERPATH_ONMOVEPONT_OFFSET UNITYSDK_OFFSET(0x1EEAB160)
#define PATHCREATION_BEZIERPATH_REMOVE_ONMODIFIED_OFFSET UNITYSDK_OFFSET(0x1EEAAFE0)
#define PATHCREATION_BEZIERPATH_REMOVE_ONMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1EEAB0E0)
#define PATHCREATION_BEZIERPATH_RESETNORMALANGLES_OFFSET UNITYSDK_OFFSET(0x1EEAF470)
#define PATHCREATION_BEZIERPATH_SETANCHORNORMALANGLE_OFFSET UNITYSDK_OFFSET(0x1EEAF3E0)
#define PATHCREATION_BEZIERPATH_SETPOINT_OFFSET UNITYSDK_OFFSET(0x1EEAC130)
#define PATHCREATION_BEZIERPATH_SET_AUTOCONTROLLENGTH_OFFSET UNITYSDK_OFFSET(0x1EEACB90)
#define PATHCREATION_BEZIERPATH_SET_CONTROLPOINTMODE_OFFSET UNITYSDK_OFFSET(0x1EEACA60)
#define PATHCREATION_BEZIERPATH_SET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1EEAF340)
#define PATHCREATION_BEZIERPATH_SET_GLOBALNORMALSANGLE_OFFSET UNITYSDK_OFFSET(0x1EEAF370)
#define PATHCREATION_BEZIERPATH_SET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1EEAB790)
#define PATHCREATION_BEZIERPATH_SET_SPACE_OFFSET UNITYSDK_OFFSET(0x1EEAB770)
#define PATHCREATION_BEZIERPATH_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x1EEACFD0)
#define PATHCREATION_BEZIERPATH_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1EEAF540)
#define PATHCREATION_BEZIERPATH_UPDATECLOSEDSTATE_OFFSET UNITYSDK_OFFSET(0x1EEAC720)
#define PATHCREATION_BEZIERPATH_UPDATETONEWPATHSPACE_OFFSET UNITYSDK_OFFSET(0x1EEAC280)
#define PATHCREATION_BEZIERPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EEAB7A0)
#define PATHCREATION_BEZIERPATH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EEABD20)
#define PATHCREATION_BEZIERPATH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EEABE40)
#define PATHCREATION_BEZIERPATH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1EEABF70)
#define PATHCREATION_BEZIERPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEAB1D0)

namespace PathCreation
{
	inline static constexpr unsigned int BezierPath_TypeDefinitionIndex = 38102;
