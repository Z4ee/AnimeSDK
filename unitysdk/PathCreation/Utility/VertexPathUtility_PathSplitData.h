...
#define PATHCREATION_UTILITY_VERTEXPATHUTILITY_PATHSPLITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAC30F0)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int VertexPathUtility_PathSplitData_TypeDefinitionIndex = 37457;

	class VertexPathUtility_PathSplitData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Single>* cumulativeLength; // 0x10
		...
		::PathCreation::MinMax3D* minMax; // 0x28
		::System::Collections::Generic::List_1<::System::Int32>* anchorVertexMap; // 0x30
