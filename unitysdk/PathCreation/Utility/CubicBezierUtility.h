...
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_CALCULATESEGMENTBOUNDS_OFFSET UNITYSDK_OFFSET(0x1EEB57D0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_ESTIMATECURVELENGTH_OFFSET UNITYSDK_OFFSET(0x1EEB5C00)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1EEB4D30)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1EEB4B80)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1EEB5020)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1EEB4E70)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_1_OFFSET UNITYSDK_OFFSET(0x1EEB4AB0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1EEAF1D0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EXTREMEPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1EEAEF40)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_1_OFFSET UNITYSDK_OFFSET(0x1EEB54F0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_OFFSET UNITYSDK_OFFSET(0x1EEB5190)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_SPLITCURVE_OFFSET UNITYSDK_OFFSET(0x1EEAD900)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_STATIONARYPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1EEB5D00)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int CubicBezierUtility_TypeDefinitionIndex = 38114;
