...
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_CALCULATESEGMENTBOUNDS_OFFSET UNITYSDK_OFFSET(0x1DAC0760)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_ESTIMATECURVELENGTH_OFFSET UNITYSDK_OFFSET(0x1DAC0B90)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1DABFCA0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1DABFB00)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1DABFF70)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1DABFDD0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_1_OFFSET UNITYSDK_OFFSET(0x1DABFA30)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1DAB9FB0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EXTREMEPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1DAB9D20)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_1_OFFSET UNITYSDK_OFFSET(0x1DAC0430)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_OFFSET UNITYSDK_OFFSET(0x1DAC00E0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_SPLITCURVE_OFFSET UNITYSDK_OFFSET(0x1DAB86A0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_STATIONARYPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1DAC0D30)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int CubicBezierUtility_TypeDefinitionIndex = 37453;
