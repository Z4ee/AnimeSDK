...
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1DAC1D50)
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1DAC1C90)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1DAC18B0)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1DAC1530)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1DAC16F0)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0x1DAC1990)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESINTERSECT_OFFSET UNITYSDK_OFFSET(0x1DAC1AA0)
#define PATHCREATION_UTILITY_MATHUTILITY_LOCKTRANSFORMTOSPACE_OFFSET UNITYSDK_OFFSET(0x1DAC0EA0)
#define PATHCREATION_UTILITY_MATHUTILITY_MINANGLE_OFFSET UNITYSDK_OFFSET(0x1DAC1E90)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1DAC1FB0)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTOFLINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1DAC1B00)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTSARECLOCKWISE_OFFSET UNITYSDK_OFFSET(0x1DAC2110)
#define PATHCREATION_UTILITY_MATHUTILITY_SIDEOFLINE_OFFSET UNITYSDK_OFFSET(0x1DAC1E30)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1DAC17D0)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1DAB9C00)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1DAC1610)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int MathUtility_TypeDefinitionIndex = 37454;
