...
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1EEB6D10)
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1EEB6C50)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EEB6870)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1EEB64F0)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1EEB66B0)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0x1EEB6950)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESINTERSECT_OFFSET UNITYSDK_OFFSET(0x1EEB6A60)
#define PATHCREATION_UTILITY_MATHUTILITY_LOCKTRANSFORMTOSPACE_OFFSET UNITYSDK_OFFSET(0x1EEB5E70)
#define PATHCREATION_UTILITY_MATHUTILITY_MINANGLE_OFFSET UNITYSDK_OFFSET(0x1EEB6E50)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1EEB6F70)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTOFLINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1EEB6AC0)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTSARECLOCKWISE_OFFSET UNITYSDK_OFFSET(0x1EEB70C0)
#define PATHCREATION_UTILITY_MATHUTILITY_SIDEOFLINE_OFFSET UNITYSDK_OFFSET(0x1EEB6DF0)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1EEB6790)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1EEAEE20)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1EEB65D0)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int MathUtility_TypeDefinitionIndex = 38115;
