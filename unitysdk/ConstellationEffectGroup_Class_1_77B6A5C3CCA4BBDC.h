...
#define CONSTELLATIONEFFECTGROUP_CLASS_1_77B6A5C3CCA4BBDC_METHOD_1_248C354FAAB50CEE_OFFSET UNITYSDK_OFFSET(0xAD12FF0)
#define CONSTELLATIONEFFECTGROUP_CLASS_1_77B6A5C3CCA4BBDC_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xAD12B90)
#define CONSTELLATIONEFFECTGROUP_CLASS_1_77B6A5C3CCA4BBDC__CTOR_OFFSET UNITYSDK_OFFSET(0xAD12FE0)

inline static constexpr unsigned int ConstellationEffectGroup_Class_1_77B6A5C3CCA4BBDC_TypeDefinitionIndex = 44116;

class ConstellationEffectGroup_Class_1_77B6A5C3CCA4BBDC : public ::System::Object
{
public:
	::UnityEngine::GameObject* Field_1_0; // 0x10
	::ConstellationEffectGroup_ConstellationAnchor* Field_1_6; // 0x18
