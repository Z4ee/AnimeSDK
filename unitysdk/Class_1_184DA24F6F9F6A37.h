...
#define CLASS_1_184DA24F6F9F6A37_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0x15CCD150)
#define CLASS_1_184DA24F6F9F6A37_GET_STATECONFIGWHENRANGEATK_OFFSET UNITYSDK_OFFSET(0x15CCD1C0)
#define CLASS_1_184DA24F6F9F6A37_INIT_OFFSET UNITYSDK_OFFSET(0x15CCBF90)
#define CLASS_1_184DA24F6F9F6A37_METHOD_1_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0x15CCC230)
#define CLASS_1_184DA24F6F9F6A37_METHOD_1_2EDAC8CAFF864AE8_OFFSET UNITYSDK_OFFSET(0x15CCDC90)
#define CLASS_1_184DA24F6F9F6A37_METHOD_1_43F61CBC46441777_OFFSET UNITYSDK_OFFSET(0x15CCD1E0)
#define CLASS_1_184DA24F6F9F6A37_REFRESH_OFFSET UNITYSDK_OFFSET(0x15CCC0D0)
#define CLASS_1_184DA24F6F9F6A37_RESET_OFFSET UNITYSDK_OFFSET(0x15CCC030)
#define CLASS_1_184DA24F6F9F6A37_SET_STATECONFIGWHENRANGEATK_OFFSET UNITYSDK_OFFSET(0x15CCD1D0)
#define CLASS_1_184DA24F6F9F6A37__CTOR_OFFSET UNITYSDK_OFFSET(0x15CCDD50)

inline static constexpr unsigned int Class_1_184DA24F6F9F6A37_TypeDefinitionIndex = 69558;
...
public:
	...
	::RPG::Client::CameraFightStateDarkAttackConfig* MAFIONBKPIE; // 0x20
	::Class_2_4C3F9D9CF221EFEC* LEOGIKABIGF; // 0x28
	::System::Boolean CDNFOAPHINA; // 0x30
	::UnityEngine::Vector3 OEGAAMGHNCP; // 0x34
	::UnityEngine::Vector3 EBJIPOAJLBG; // 0x40
