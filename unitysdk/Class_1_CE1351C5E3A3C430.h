...
#define CLASS_1_CE1351C5E3A3C430_DISPOSE_OFFSET UNITYSDK_OFFSET(0x198FFF40)
#define CLASS_1_CE1351C5E3A3C430_METHOD_1_0F87F20F7EC17068_OFFSET UNITYSDK_OFFSET(0x199002E0)
#define CLASS_1_CE1351C5E3A3C430_METHOD_1_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0x19900220)
#define CLASS_1_CE1351C5E3A3C430_METHOD_1_3FEDBA52BB885E46_OFFSET UNITYSDK_OFFSET(0x19900010)
#define CLASS_1_CE1351C5E3A3C430_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x198FFFB0)
#define CLASS_1_CE1351C5E3A3C430_METHOD_1_4D1AF36C364D23A7_OFFSET UNITYSDK_OFFSET(0x19900110)
#define CLASS_1_CE1351C5E3A3C430_METHOD_1_F239777256F9BA8F_OFFSET UNITYSDK_OFFSET(0x19900330)
#define CLASS_1_CE1351C5E3A3C430__CTOR_OFFSET UNITYSDK_OFFSET(0x19900340)

inline static constexpr unsigned int Class_1_CE1351C5E3A3C430_TypeDefinitionIndex = 61139;

class Class_1_CE1351C5E3A3C430 : public ::System::Object
{
public:
	::Class_3_985419CB30979FC6* HDPGNKLCNAD; // 0x10
