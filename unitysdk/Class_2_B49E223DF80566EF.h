...
#define CLASS_2_B49E223DF80566EF_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x18CCFDC0)
#define CLASS_2_B49E223DF80566EF_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x18CCFEE0)
#define CLASS_2_B49E223DF80566EF_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x18CCEEF0)
#define CLASS_2_B49E223DF80566EF_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x18CCF9C0)
#define CLASS_2_B49E223DF80566EF_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x18CCFA20)
#define CLASS_2_B49E223DF80566EF_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18CCF370)
#define CLASS_2_B49E223DF80566EF_METHOD_2_A00FA3762EA46365_OFFSET UNITYSDK_OFFSET(0x18CCF890)
#define CLASS_2_B49E223DF80566EF_METHOD_2_A3C36642AA77866E_OFFSET UNITYSDK_OFFSET(0x18CCF1D0)
#define CLASS_2_B49E223DF80566EF_METHOD_2_BA84CD6B9377DF2C_OFFSET UNITYSDK_OFFSET(0x18CCF490)
#define CLASS_2_B49E223DF80566EF_METHOD_2_BD6A3C745D127D79_OFFSET UNITYSDK_OFFSET(0x18CCF3F0)
#define CLASS_2_B49E223DF80566EF_METHOD_2_C4E2F930A41E34C0_OFFSET UNITYSDK_OFFSET(0x18CCFB30)
#define CLASS_2_B49E223DF80566EF_METHOD_2_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0x18CCEC20)
#define CLASS_2_B49E223DF80566EF_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18CCFAD0)
#define CLASS_2_B49E223DF80566EF_METHOD_2_F0CA034D8F146D0A_OFFSET UNITYSDK_OFFSET(0x18CCEE60)
#define CLASS_2_B49E223DF80566EF_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x18CCFD00)
#define CLASS_2_B49E223DF80566EF_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x18CCFC40)
#define CLASS_2_B49E223DF80566EF__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCFFD0)
#define CLASS_2_B49E223DF80566EF__ONBIND_OFFSET UNITYSDK_OFFSET(0x18CCEBA0)

inline static constexpr unsigned int Class_2_B49E223DF80566EF_TypeDefinitionIndex = 71412;
...
public:
	...
	::RPG::Client::LocalizedText* JGJCHJKLHFG; // 0x60
	::UnityEngine::Animation* GGHHILBNDJN; // 0x68
	::UnityEngine::Transform* IKOPFLFOJNJ; // 0x70
	::UnityEngine::Animation* NGHBNMLGFNC; // 0x78
	::RPG::GameCore::GameEntity* KAKEIDJDNHJ; // 0x80
	::UnityEngine::Transform* HANPJFACEEG; // 0x88
	::RPG::Client::PrefabLoadMeta* CKPJOENDCDE; // 0x90
	::RPG::Client::PrefabLoadMeta* GGBFOLPIFIL; // 0x98
	::System::Boolean EDILAOJDGBM; // 0xA0
	::System::Boolean HCEJJOLGIPH; // 0xA1
	::System::Int32 KIKIPLCFKNL; // 0xA4
