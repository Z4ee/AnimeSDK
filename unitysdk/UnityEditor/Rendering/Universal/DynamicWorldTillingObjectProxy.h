...
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x1908F3E0)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1908F980)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1908F920)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_RESETTRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x1908F7D0)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_SETTRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x1908F680)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1908F9D0)

namespace UnityEditor::Rendering::Universal
{
	inline static constexpr unsigned int DynamicWorldTillingObjectProxy_TypeDefinitionIndex = 29695;
