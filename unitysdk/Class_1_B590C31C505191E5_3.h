...
#define CLASS_1_B590C31C505191E5_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1E4360)
#define CLASS_1_B590C31C505191E5_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1E3F20)
#define CLASS_1_B590C31C505191E5_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1E4080)
#define CLASS_1_B590C31C505191E5_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1E3FA0)
#define CLASS_1_B590C31C505191E5_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1E4120)
#define CLASS_1_B590C31C505191E5_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1E4450)
#define CLASS_1_B590C31C505191E5_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1E4400)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1E3DD0)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A1E3F70)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A1E3F90)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A1E3F80)
#define CLASS_1_B590C31C505191E5_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1E3E30)
#define CLASS_1_B590C31C505191E5_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1E4220)
#define CLASS_1_B590C31C505191E5_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1E4280)
#define CLASS_1_B590C31C505191E5_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E4630)
#define CLASS_1_B590C31C505191E5_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1E3E90)
#define CLASS_1_B590C31C505191E5_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E3E40)

inline static constexpr unsigned int Class_1_B590C31C505191E5_3_TypeDefinitionIndex = 27527;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_3_TypeDefinitionIndex)->GetStaticField(0x379C0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_3_TypeDefinitionIndex)->GetStaticField(0x379C8);
	}
