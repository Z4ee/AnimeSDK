...
#define CLASS_1_6FB9CB31F8B2D4C3_CLEAR_OFFSET UNITYSDK_OFFSET(0xC3C3120)
#define CLASS_1_6FB9CB31F8B2D4C3_METHOD_1_6AEE51845DFA6D71_OFFSET UNITYSDK_OFFSET(0xC3C34A0)
#define CLASS_1_6FB9CB31F8B2D4C3_METHOD_1_6BD22FADB2E43BAE_OFFSET UNITYSDK_OFFSET(0xC3C3240)
#define CLASS_1_6FB9CB31F8B2D4C3_METHOD_1_EA672F77F1086A27_1_OFFSET UNITYSDK_OFFSET(0xC3C31E0)
#define CLASS_1_6FB9CB31F8B2D4C3_METHOD_1_EA672F77F1086A27_OFFSET UNITYSDK_OFFSET(0xC3C3180)
#define CLASS_1_6FB9CB31F8B2D4C3__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C3500)
...
public:
	...
	::RPG::GameCore::FixPoint DDAGDNNDCDI; // 0x18
	::RPG::GameCore::FixPoint EIMIIHEDKFM; // 0x20
	::System::Boolean MFIBFJPLCOG; // 0x28
	::RPG::GameCore::FixPoint PPBNKKKIIIN; // 0x30
