...
#define CLASS_2_DF5A73890D38DEF5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x158E1610)
#define CLASS_2_DF5A73890D38DEF5_METHOD_2_42C5BADE1C9EFC80_OFFSET UNITYSDK_OFFSET(0x158E1650)
#define CLASS_2_DF5A73890D38DEF5_METHOD_2_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x158E13D0)
#define CLASS_2_DF5A73890D38DEF5_METHOD_2_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x158E1720)
#define CLASS_2_DF5A73890D38DEF5_METHOD_2_DE45EA3A177BC33B_OFFSET UNITYSDK_OFFSET(0x158E1780)
#define CLASS_2_DF5A73890D38DEF5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x158E12D0)
#define CLASS_2_DF5A73890D38DEF5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x158E1540)
#define CLASS_2_DF5A73890D38DEF5_TICK_OFFSET UNITYSDK_OFFSET(0x158E1590)
#define CLASS_2_DF5A73890D38DEF5__CTOR_OFFSET UNITYSDK_OFFSET(0x158E12C0)

inline static constexpr unsigned int Class_2_DF5A73890D38DEF5_TypeDefinitionIndex = 53087;

class Class_2_DF5A73890D38DEF5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	// static const ::System::Single CAKIPDKMIJJ; // 0x0
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::Class_3_8B26808C73AFBC57* OFKGLJOAMLD; // 0x20
	::System::Single PHCPNGOKAPN; // 0x28
