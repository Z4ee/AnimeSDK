...
#define CLASS_1_5B567C8A01BAEDFE_58_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19A78E70)
#define CLASS_1_5B567C8A01BAEDFE_58_CLONE_OFFSET UNITYSDK_OFFSET(0x19A78C80)
#define CLASS_1_5B567C8A01BAEDFE_58_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19A78D80)
#define CLASS_1_5B567C8A01BAEDFE_58_EQUALS_OFFSET UNITYSDK_OFFSET(0x19A78CF0)
#define CLASS_1_5B567C8A01BAEDFE_58_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A78DD0)
#define CLASS_1_5B567C8A01BAEDFE_58_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19A78EC0)
#define CLASS_1_5B567C8A01BAEDFE_58_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19A78E90)
#define CLASS_1_5B567C8A01BAEDFE_58_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19A78BD0)
#define CLASS_1_5B567C8A01BAEDFE_58_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19A78C30)
#define CLASS_1_5B567C8A01BAEDFE_58_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19A78E00)
#define CLASS_1_5B567C8A01BAEDFE_58_WRITETO_OFFSET UNITYSDK_OFFSET(0x19A78E60)
#define CLASS_1_5B567C8A01BAEDFE_58__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A78F10)
#define CLASS_1_5B567C8A01BAEDFE_58__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A78C50)
#define CLASS_1_5B567C8A01BAEDFE_58__CTOR_OFFSET UNITYSDK_OFFSET(0x19A78C40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_58_TypeDefinitionIndex = 25565;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_58*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_58_TypeDefinitionIndex)->GetStaticField(0x51760);
	}
