...
#define CLASS_1_5B567C8A01BAEDFE_40_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A417BE0)
#define CLASS_1_5B567C8A01BAEDFE_40_CLONE_OFFSET UNITYSDK_OFFSET(0x1A417A50)
#define CLASS_1_5B567C8A01BAEDFE_40_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A417AF0)
#define CLASS_1_5B567C8A01BAEDFE_40_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A417A90)
#define CLASS_1_5B567C8A01BAEDFE_40_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A417B40)
#define CLASS_1_5B567C8A01BAEDFE_40_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A417C30)
#define CLASS_1_5B567C8A01BAEDFE_40_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A417C00)
#define CLASS_1_5B567C8A01BAEDFE_40_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A4179D0)
#define CLASS_1_5B567C8A01BAEDFE_40_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A417A00)
#define CLASS_1_5B567C8A01BAEDFE_40_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A417B70)
#define CLASS_1_5B567C8A01BAEDFE_40_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A417BD0)
#define CLASS_1_5B567C8A01BAEDFE_40__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A417C80)
#define CLASS_1_5B567C8A01BAEDFE_40__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A417A20)
#define CLASS_1_5B567C8A01BAEDFE_40__CTOR_OFFSET UNITYSDK_OFFSET(0x1A417A10)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_40_TypeDefinitionIndex = 25141;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_40*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_40_TypeDefinitionIndex)->GetStaticField(0x63FC0);
	}
