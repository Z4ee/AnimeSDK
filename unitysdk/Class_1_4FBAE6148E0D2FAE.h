...
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_0960CAEE01038065_OFFSET UNITYSDK_OFFSET(0x1848EAE0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_267A0BF471A986CA_OFFSET UNITYSDK_OFFSET(0x1848FB80)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_4B10F84263C4F017_OFFSET UNITYSDK_OFFSET(0x1848F460)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_569C8A2D03C8AA85_OFFSET UNITYSDK_OFFSET(0x1848F870)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_5B0531D5B96D6B96_OFFSET UNITYSDK_OFFSET(0x1848F7E0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_6151E230327C7564_OFFSET UNITYSDK_OFFSET(0x1848EFC0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_86D55F79EA296C22_OFFSET UNITYSDK_OFFSET(0x1848EDB0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_878EA953B73E6E80_OFFSET UNITYSDK_OFFSET(0x1848F3D0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_8894E534FED3129C_OFFSET UNITYSDK_OFFSET(0x1848EB40)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_8E7E4D966A3D3048_OFFSET UNITYSDK_OFFSET(0x1848FB90)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_97CAD17442913F0E_OFFSET UNITYSDK_OFFSET(0x1848ECA0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0x1848E980)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_9EB92E1BAB312EBE_OFFSET UNITYSDK_OFFSET(0x1848F530)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x1848F380)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_C2D0A28EDD88D4E9_OFFSET UNITYSDK_OFFSET(0x1848ED30)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_C980F30C1DA81B6D_OFFSET UNITYSDK_OFFSET(0x1848E8D0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_E18F3B9E6FAE6526_OFFSET UNITYSDK_OFFSET(0x1848EEE0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_E23B1B7FCD82A4A2_OFFSET UNITYSDK_OFFSET(0x1848F5E0)
#define CLASS_1_4FBAE6148E0D2FAE_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1848FB70)
#define CLASS_1_4FBAE6148E0D2FAE__CTOR_OFFSET UNITYSDK_OFFSET(0x1848E090)
...
{
public:
	::System::Collections::BitArray* PIJBEDOOEGF; // 0x10
	::RPG::GameCore::StatisticsComponent* BCBGNBGMBAL; // 0x18
	::System::Collections::Generic::List_1<::System::UInt32>* DONPAEODKCC; // 0x20
	::Il2CppArray<::System::Int32>* HHCJCOEAGGI; // 0x28
	::System::Collections::Generic::HashSet_1<::System::UInt32>* DLKBMJMOMEB; // 0x30
	::RPG::GameCore::StageInvasionBuffRow* HAENOCFNAMF; // 0x38
	::RPG::GameCore::TurnBasedGameMode* GICHGNGMBGD; // 0x40
	::RPG::GameCore::StageInvasionConfigRow* LDOKFGNDIAE; // 0x48
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_6EDF1562E8B73DA4*>* MINMNJGAGOM; // 0x50
