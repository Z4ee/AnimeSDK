...
#define CLASS_1_EBB880A8D2C9B0D4_GET_REQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xC4009F0)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0xC4009D0)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0xC4009C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_011CDA9D67F544B1_OFFSET UNITYSDK_OFFSET(0xC3FEA30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_029507C9854F63E7_OFFSET UNITYSDK_OFFSET(0xC3FC630)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_0F2A1B718CAA236B_OFFSET UNITYSDK_OFFSET(0xC400A00)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_1A73A901CB10B415_OFFSET UNITYSDK_OFFSET(0xC400A40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_20F8BB50E0FBEE51_OFFSET UNITYSDK_OFFSET(0xC3FFDB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xC3F9050)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_28695814746C5E4E_OFFSET UNITYSDK_OFFSET(0xC3FDDA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2930745D6F02D733_OFFSET UNITYSDK_OFFSET(0xC3FD2A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_297321ACFDDF5650_OFFSET UNITYSDK_OFFSET(0xC3FBCF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2AA2AEA4ADAE7DAC_1_OFFSET UNITYSDK_OFFSET(0xC3FC840)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2AA2AEA4ADAE7DAC_OFFSET UNITYSDK_OFFSET(0xC3FC6A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3543E185ADE7267F_OFFSET UNITYSDK_OFFSET(0xC3FDCA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_35C22FC4636C6636_OFFSET UNITYSDK_OFFSET(0xC3FE7D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_36E7EF7EB5DFC680_OFFSET UNITYSDK_OFFSET(0xC4003E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xC3F89A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3C713D5FB6FF9D5F_OFFSET UNITYSDK_OFFSET(0xC3FF960)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4147F14EBAE37DB9_OFFSET UNITYSDK_OFFSET(0xC3F6D30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xC3F75A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_48F66A306BE261D7_OFFSET UNITYSDK_OFFSET(0xC3FD510)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4F4C649413562C08_OFFSET UNITYSDK_OFFSET(0xC4005D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4FD30F236AB3F0D4_OFFSET UNITYSDK_OFFSET(0xC3F82B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_513B28E8F5D79998_OFFSET UNITYSDK_OFFSET(0xC3FC580)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_525C11E1C03A03AA_OFFSET UNITYSDK_OFFSET(0xC3FD850)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_56E0415ED61DFBD8_OFFSET UNITYSDK_OFFSET(0xC3FBB10)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5F2528715070ADC0_OFFSET UNITYSDK_OFFSET(0xC3FCC80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0xC3FE3B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7ED03410F58071B9_OFFSET UNITYSDK_OFFSET(0xC3FDBA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0xC3F8070)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_80ECD089EB377640_OFFSET UNITYSDK_OFFSET(0xC3FF4B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_816DE7054F759A6D_OFFSET UNITYSDK_OFFSET(0xC3FFBC0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_81D122F3EBFE3B2D_OFFSET UNITYSDK_OFFSET(0xC4002D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_841D90BDB3E94FF6_OFFSET UNITYSDK_OFFSET(0xC3FB250)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xC3F71F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_902E5094ED6E20A2_OFFSET UNITYSDK_OFFSET(0xC3F7770)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_95FF180A965BC00B_OFFSET UNITYSDK_OFFSET(0xC3FFF50)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_96087D675A0A6BF2_OFFSET UNITYSDK_OFFSET(0xC4007C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xC400970)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_ABA49F311F6B82E0_OFFSET UNITYSDK_OFFSET(0xC3FF3D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xC3F99D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0xC3F87C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BB71BF1E162694DE_OFFSET UNITYSDK_OFFSET(0xC3FE4A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BBD36158AE50EC8B_OFFSET UNITYSDK_OFFSET(0xC3F9970)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C2F9324ADF5C3031_OFFSET UNITYSDK_OFFSET(0xC3FED80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3A97DC040BD7DD3_OFFSET UNITYSDK_OFFSET(0xC3FF590)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3EAACDE46DF8E59_1_OFFSET UNITYSDK_OFFSET(0xC3FCB30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3EAACDE46DF8E59_OFFSET UNITYSDK_OFFSET(0xC3FC9E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_CE76B71EB4CF1D47_OFFSET UNITYSDK_OFFSET(0xC3FD0E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D29CB62E2602F1AC_OFFSET UNITYSDK_OFFSET(0xC3FD900)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xC3F8B60)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D68B32ED7E946B47_OFFSET UNITYSDK_OFFSET(0xC3FB200)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DC76497A3CA272B5_OFFSET UNITYSDK_OFFSET(0xC3FCE90)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DDC113A5E50536E5_OFFSET UNITYSDK_OFFSET(0xC3FE200)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E05D8B64DF84735B_OFFSET UNITYSDK_OFFSET(0xC3FE640)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0xC3F97C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F4AD6DE35B09EAA8_OFFSET UNITYSDK_OFFSET(0xC3FBCB0)
#define CLASS_1_EBB880A8D2C9B0D4_SET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0xC4009E0)
#define CLASS_1_EBB880A8D2C9B0D4__CCTOR_OFFSET UNITYSDK_OFFSET(0xC400A80)
#define CLASS_1_EBB880A8D2C9B0D4__CTOR_OFFSET UNITYSDK_OFFSET(0xC3F6FB0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex)->GetStaticField(0x12780);
	}
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int16>* CHKAALLGBOM; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* DHIBGONCNAP; // 0x18
	...
	::RPG::GameCore::LittleGameLevelConfig* CLKEPOJFDPD; // 0x40
	::RPG::GameCore::FiveDimLevelSettings* LHBPBEADJLE; // 0x48
	::RPG::GameCore::FiveDimNavMapConfig* DGNHEOPGJJE; // 0x50
	::RPG::GameCore::LevelLittleGameInfo* MHKIDMHMMCL; // 0x58
	::System::Collections::Generic::List_1<::System::UInt32>* AKMEAPBBNDH; // 0x60
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* DOOJHNILCED; // 0x68
	::Class_1_A139A18477C7681A* _SubNavGraphInfo_k__BackingField; // 0x70
