...
#define CLASS_1_EBB880A8D2C9B0D4_GET_REQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x12955010)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0x12954FF0)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0x12954FE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_09A1BD26EB158047_OFFSET UNITYSDK_OFFSET(0x129522F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_0A33F6FE49CC944A_OFFSET UNITYSDK_OFFSET(0x129544B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_243BEAA857EE5299_OFFSET UNITYSDK_OFFSET(0x12950E80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x1294C1E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2D84C0C580E710CA_OFFSET UNITYSDK_OFFSET(0x12954CB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_316098F2824CF764_OFFSET UNITYSDK_OFFSET(0x129540D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3254D409AD76C2E2_OFFSET UNITYSDK_OFFSET(0x12954B20)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_37641CB56E59A096_OFFSET UNITYSDK_OFFSET(0x12952960)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x1294C5A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x1294DFC0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4DE65AB3A4860CEB_OFFSET UNITYSDK_OFFSET(0x1294E7E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4FD30F236AB3F0D4_OFFSET UNITYSDK_OFFSET(0x1294D240)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_525C11E1C03A03AA_OFFSET UNITYSDK_OFFSET(0x12952590)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5427D429B5D2766F_OFFSET UNITYSDK_OFFSET(0x12955020)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_55F2BCAC640061D3_OFFSET UNITYSDK_OFFSET(0x12953BF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5CD57035BDDE5369_OFFSET UNITYSDK_OFFSET(0x129530C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5F2528715070ADC0_OFFSET UNITYSDK_OFFSET(0x12951D40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_602E1CCD3AA8E1F1_OFFSET UNITYSDK_OFFSET(0x12951820)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_626E1E7A59ADB775_OFFSET UNITYSDK_OFFSET(0x12950660)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_67D262B21B9B459D_OFFSET UNITYSDK_OFFSET(0x12952E70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0x1294D750)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7B02396350AF3AC1_OFFSET UNITYSDK_OFFSET(0x12951740)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x1294D040)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_81D122F3EBFE3B2D_OFFSET UNITYSDK_OFFSET(0x12954A00)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_85B87F15DE7D9577_OFFSET UNITYSDK_OFFSET(0x12953730)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_8EB834389429CDAD_OFFSET UNITYSDK_OFFSET(0x12952880)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_94F202012C4866F0_OFFSET UNITYSDK_OFFSET(0x1294BD10)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_956F8BBA61BA4CBA_OFFSET UNITYSDK_OFFSET(0x12953410)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_95FF180A965BC00B_OFFSET UNITYSDK_OFFSET(0x12954640)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_96087D675A0A6BF2_OFFSET UNITYSDK_OFFSET(0x12954E40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_9B4043903C569F54_OFFSET UNITYSDK_OFFSET(0x12951890)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_9DF520971B8F09EA_OFFSET UNITYSDK_OFFSET(0x129532F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_A9F21234A9F13159_OFFSET UNITYSDK_OFFSET(0x12953D30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x1294EA00)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BBD36158AE50EC8B_OFFSET UNITYSDK_OFFSET(0x1294E9A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BF07FECBF7CF9E7C_1_OFFSET UNITYSDK_OFFSET(0x12951BA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BF07FECBF7CF9E7C_OFFSET UNITYSDK_OFFSET(0x12951A00)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_CA99028638214CFF_OFFSET UNITYSDK_OFFSET(0x12950CA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D29CB62E2602F1AC_OFFSET UNITYSDK_OFFSET(0x12952640)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x1294DAD0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D826D49B6EAB49B3_OFFSET UNITYSDK_OFFSET(0x12953C90)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x12954FC0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DA5C74D0B5008ECB_OFFSET UNITYSDK_OFFSET(0x12953640)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DAECDCD3FF53DE14_OFFSET UNITYSDK_OFFSET(0x12954350)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DC76497A3CA272B5_OFFSET UNITYSDK_OFFSET(0x12951F70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E41A0A8438B1F519_OFFSET UNITYSDK_OFFSET(0x12955030)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E48192ED77C2189D_OFFSET UNITYSDK_OFFSET(0x12950610)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E643356DEDBA29E8_OFFSET UNITYSDK_OFFSET(0x12952150)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_EF79C60756C35D5F_OFFSET UNITYSDK_OFFSET(0x12953000)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F4AD6DE35B09EAA8_OFFSET UNITYSDK_OFFSET(0x12950E40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x1294D910)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F8C816D8A562BDA9_OFFSET UNITYSDK_OFFSET(0x12952A40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F9C90F9ECA68885E_OFFSET UNITYSDK_OFFSET(0x1294C780)
#define CLASS_1_EBB880A8D2C9B0D4_SET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0x12955000)
#define CLASS_1_EBB880A8D2C9B0D4__CCTOR_OFFSET UNITYSDK_OFFSET(0x12955040)
#define CLASS_1_EBB880A8D2C9B0D4__CTOR_OFFSET UNITYSDK_OFFSET(0x1294BFA0)

inline static constexpr unsigned int Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex = 57371;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex)->GetStaticField(0xBA30);
	}
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* Field_1_13; // 0x10
	::RPG::GameCore::FiveDimLevelSettings* Field_1_7; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int16>* Field_1_9; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* Field_1_4; // 0x28
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_5; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_99D526797741C2F2*>* Field_1_3; // 0x38
	::System::Collections::Generic::List_1<::Class_1_99D526797741C2F2*>* _SurfaceList_k__BackingField; // 0x40
	::RPG::GameCore::LevelLittleGameInfo* Field_1_8; // 0x48
	::System::Collections::Generic::HashSet_1<::System::UInt32>* _RequireSubMissionIDs_k__BackingField; // 0x50
	::RPG::GameCore::LittleGameLevelConfig* Field_1_6; // 0x58
	::RPG::GameCore::FiveDimNavMapConfig* Field_1_12; // 0x60
	::RPG::GameCore::RuntimeGroupInfo* Field_1_10; // 0x68
	::Class_1_2EAB25208BF9561B* _SubNavGraphInfo_k__BackingField; // 0x70
	...
	::System::Void Method_1_E48192ED77C2189D(::RPG::GameCore::LevelFloorBakedInfo* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::LevelFloorBakedInfo*))((::PBYTE)hIl2Cpp + CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E48192ED77C2189D_OFFSET))(this, a1);
	}
	...
	::System::Void Method_1_626E1E7A59ADB775(::RPG::GameCore::LevelFloorBakedInfo* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::LevelFloorBakedInfo*))((::PBYTE)hIl2Cpp + CLASS_1_EBB880A8D2C9B0D4_METHOD_1_626E1E7A59ADB775_OFFSET))(this, a1);
	}
