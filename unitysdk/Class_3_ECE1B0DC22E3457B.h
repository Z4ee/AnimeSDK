...
#define CLASS_3_ECE1B0DC22E3457B_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x17745850)
#define CLASS_3_ECE1B0DC22E3457B_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x17745930)
#define CLASS_3_ECE1B0DC22E3457B_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x177459C0)
#define CLASS_3_ECE1B0DC22E3457B_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x17745800)
#define CLASS_3_ECE1B0DC22E3457B__CCTOR_OFFSET UNITYSDK_OFFSET(0x177458A0)
#define CLASS_3_ECE1B0DC22E3457B__CTOR_OFFSET UNITYSDK_OFFSET(0x17745920)

inline static constexpr unsigned int Class_3_ECE1B0DC22E3457B_TypeDefinitionIndex = 45835;

class Class_3_ECE1B0DC22E3457B : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_2 = 0x25; // 0x0
