...
#define CLASS_2_4B04EFB7ACBD76AF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1731EB10)
#define CLASS_2_4B04EFB7ACBD76AF_METHOD_2_7B6EC255F45D034F_OFFSET UNITYSDK_OFFSET(0x1731EDD0)
#define CLASS_2_4B04EFB7ACBD76AF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1731EBB0)
#define CLASS_2_4B04EFB7ACBD76AF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1731EF20)
#define CLASS_2_4B04EFB7ACBD76AF_TICK_OFFSET UNITYSDK_OFFSET(0x1731EB50)
#define CLASS_2_4B04EFB7ACBD76AF__CTOR_OFFSET UNITYSDK_OFFSET(0x1731EB00)

inline static constexpr unsigned int Class_2_4B04EFB7ACBD76AF_TypeDefinitionIndex = 55844;

class Class_2_4B04EFB7ACBD76AF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::RogueDLCADVRoomHideDestruct* Field_2_1; // 0x20
