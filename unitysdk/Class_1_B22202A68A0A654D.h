...
#define CLASS_1_B22202A68A0A654D_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x1821F1D0)
#define CLASS_1_B22202A68A0A654D_METHOD_1_032AAF1CA9C9CE58_OFFSET UNITYSDK_OFFSET(0x1821F330)
#define CLASS_1_B22202A68A0A654D_METHOD_1_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1821EAA0)
#define CLASS_1_B22202A68A0A654D_METHOD_1_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1821EAC0)
#define CLASS_1_B22202A68A0A654D_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1821EA80)
#define CLASS_1_B22202A68A0A654D_METHOD_1_1642495E99BA2FDC_OFFSET UNITYSDK_OFFSET(0x1821EAE0)
#define CLASS_1_B22202A68A0A654D_METHOD_1_2439C7815990B9DD_OFFSET UNITYSDK_OFFSET(0x1821EAF0)
#define CLASS_1_B22202A68A0A654D_METHOD_1_409719413A147F0C_OFFSET UNITYSDK_OFFSET(0x1821F200)
#define CLASS_1_B22202A68A0A654D_METHOD_1_6D8E8D1FC2488E6B_OFFSET UNITYSDK_OFFSET(0x1821EB50)
#define CLASS_1_B22202A68A0A654D_METHOD_1_8CEAB4B365735B82_OFFSET UNITYSDK_OFFSET(0x1821EA70)
#define CLASS_1_B22202A68A0A654D_METHOD_1_99D5CA958F67E07B_OFFSET UNITYSDK_OFFSET(0x1821FA50)
#define CLASS_1_B22202A68A0A654D_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x1821EA10)
#define CLASS_1_B22202A68A0A654D_METHOD_1_BC62B9FB87FD6A48_OFFSET UNITYSDK_OFFSET(0x1821EA60)
#define CLASS_1_B22202A68A0A654D_METHOD_1_C9DFB122603938B7_OFFSET UNITYSDK_OFFSET(0x1821F2D0)
#define CLASS_1_B22202A68A0A654D_METHOD_1_D3B7AE0D15236248_OFFSET UNITYSDK_OFFSET(0x1821FEC0)
#define CLASS_1_B22202A68A0A654D__CTOR_OFFSET UNITYSDK_OFFSET(0x18220200)

inline static constexpr unsigned int Class_1_B22202A68A0A654D_TypeDefinitionIndex = 51742;

class Class_1_B22202A68A0A654D : public ::System::Object
{
public:
	::RPG::GameCore::ILBattleStageConfigRow* Field_1_0; // 0x10
	::RPG::GameCore::ILEliteGroupConfigRow* Field_1_1; // 0x18
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_487*>* Field_1_2; // 0x20
	::RPG::GameCore::ILHardLevelGroupConfigRow* Field_1_3; // 0x28
	::RPG::GameCore::RtCharacterConfig* Field_1_4; // 0x30
	::RPG::GameCore::ILBattleMonsterConfigRow* Field_1_5; // 0x38
	...
	{
		return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_487*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_B22202A68A0A654D_METHOD_1_2439C7815990B9DD_OFFSET))(this);
	}
