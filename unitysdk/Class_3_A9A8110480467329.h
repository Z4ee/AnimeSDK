...
#define CLASS_3_A9A8110480467329_METHOD_3_0764B034DBA6672A_OFFSET UNITYSDK_OFFSET(0x1506C3C0)
#define CLASS_3_A9A8110480467329_METHOD_3_9C037F8FB897F814_OFFSET UNITYSDK_OFFSET(0x1506D0B0)
#define CLASS_3_A9A8110480467329_METHOD_3_A059119D107E5B8F_OFFSET UNITYSDK_OFFSET(0x1506DEA0)
#define CLASS_3_A9A8110480467329_METHOD_3_A8517DDC83130AC3_OFFSET UNITYSDK_OFFSET(0x1506ED70)
#define CLASS_3_A9A8110480467329_METHOD_3_D9B3CF5A5A7B9B3C_OFFSET UNITYSDK_OFFSET(0x1506BA50)
#define CLASS_3_A9A8110480467329_METHOD_3_E16F95027310837B_OFFSET UNITYSDK_OFFSET(0x1506A9B0)
#define CLASS_3_A9A8110480467329_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1506F4D0)
#define CLASS_3_A9A8110480467329__CTOR_OFFSET UNITYSDK_OFFSET(0x1506A830)

inline static constexpr unsigned int Class_3_A9A8110480467329_TypeDefinitionIndex = 76278;

class Class_3_A9A8110480467329 : public ::Class_2_B0798E1629E01207<::UnityEngine::Rendering::Universal::AutoExposure*, ::MoleMole::Config::ConfigEntityAutoExposureEffect*>
{
public:
	::MoleMole::TwoValue_1<::UnityEngine::Vector2>* Field_3_3; // 0xA8
	::MoleMole::TwoValue_1<::UnityEngine::Vector2>* Field_3_1; // 0xB0
	::MoleMole::TwoValue_1<::System::Boolean>* Field_3_5; // 0xB8
	::MoleMole::TwoValue_1<::System::Single>* Field_3_9; // 0xC0
	::MoleMole::TwoValue_1<::System::Single>* Field_3_11; // 0xC8
	::MoleMole::TwoValue_1<::System::Single>* Field_3_7; // 0xD0
	::UnityEngine::Vector2 Field_3_0; // 0xD8
	::System::Single Field_3_8; // 0xE0
	::System::Boolean Field_3_4; // 0xE4
	::System::Single Field_3_10; // 0xE8
	::System::Single Field_3_6; // 0xEC
	::UnityEngine::Vector2 Field_3_2; // 0xF0
	...
	::System::Void Method_3_E16F95027310837B(::UnityEngine::NAPRenderPipeline0::VolumeProfile_NativeSRP* a1, ::UnityEngine::Rendering::Universal::AutoExposure* a2)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::NAPRenderPipeline0::VolumeProfile_NativeSRP*, ::UnityEngine::Rendering::Universal::AutoExposure*))((::PBYTE)hIl2Cpp + CLASS_3_A9A8110480467329_METHOD_3_E16F95027310837B_OFFSET))(this, a1, a2);
	}
