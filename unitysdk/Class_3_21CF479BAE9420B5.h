...
#define CLASS_3_21CF479BAE9420B5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13A2A7B0)
#define CLASS_3_21CF479BAE9420B5__CTOR_OFFSET UNITYSDK_OFFSET(0x13A2A6A0)

inline static constexpr unsigned int Class_3_21CF479BAE9420B5_TypeDefinitionIndex = 54310;
