...
#define CLASS_1_5B567C8A01BAEDFE_293_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DFDA270)
#define CLASS_1_5B567C8A01BAEDFE_293_CLONE_OFFSET UNITYSDK_OFFSET(0x1DFD9F10)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DFDA070)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DFD9F80)
#define CLASS_1_5B567C8A01BAEDFE_293_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DFDA1D0)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DFDA2C0)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DFDA290)
#define CLASS_1_5B567C8A01BAEDFE_293_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DFD9E60)
#define CLASS_1_5B567C8A01BAEDFE_293_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DFD9EC0)
#define CLASS_1_5B567C8A01BAEDFE_293_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DFDA200)
#define CLASS_1_5B567C8A01BAEDFE_293_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DFDA260)
#define CLASS_1_5B567C8A01BAEDFE_293__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DFDA310)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFD9EE0)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFD9ED0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_293_TypeDefinitionIndex = 32226;

class Class_1_5B567C8A01BAEDFE_293 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_293*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_293*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_293_TypeDefinitionIndex)->GetStaticField(0x37C30);
	}
