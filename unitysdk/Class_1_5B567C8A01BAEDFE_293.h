...
#define CLASS_1_5B567C8A01BAEDFE_293_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CC9C8A0)
#define CLASS_1_5B567C8A01BAEDFE_293_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC9C540)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CC9C6A0)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC9C5B0)
#define CLASS_1_5B567C8A01BAEDFE_293_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC9C800)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CC9C8F0)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CC9C8C0)
#define CLASS_1_5B567C8A01BAEDFE_293_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1CC9C490)
#define CLASS_1_5B567C8A01BAEDFE_293_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CC9C4F0)
#define CLASS_1_5B567C8A01BAEDFE_293_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC9C830)
#define CLASS_1_5B567C8A01BAEDFE_293_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CC9C890)
#define CLASS_1_5B567C8A01BAEDFE_293__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC9C940)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC9C510)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC9C500)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_293_TypeDefinitionIndex = 31551;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_293*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_293_TypeDefinitionIndex)->GetStaticField(0x5E7F0);
	}
