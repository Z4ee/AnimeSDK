...
#define CLASS_1_F91AD0C5A85E4AFA_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EDC03A0)
#define CLASS_1_F91AD0C5A85E4AFA_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1EDBFD20)
#define CLASS_1_F91AD0C5A85E4AFA_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EDBFF60)
#define CLASS_1_F91AD0C5A85E4AFA_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EDBFE90)
#define CLASS_1_F91AD0C5A85E4AFA_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EDC0090)
#define CLASS_1_F91AD0C5A85E4AFA_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EDC0530)
#define CLASS_1_F91AD0C5A85E4AFA_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EDC04D0)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1EDBFE10)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_050E70FEDB783306_1_OFFSET UNITYSDK_OFFSET(0x1EDBFE40)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1EDBFDC0)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_126AB3935214AA22_1_OFFSET UNITYSDK_OFFSET(0x1EDBFE30)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1EDBFDB0)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1EDBFC30)
#define CLASS_1_F91AD0C5A85E4AFA_7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1EDBFE20)
#define CLASS_1_F91AD0C5A85E4AFA_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EDBFC90)
#define CLASS_1_F91AD0C5A85E4AFA_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EDC01E0)
#define CLASS_1_F91AD0C5A85E4AFA_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EDC0240)
#define CLASS_1_F91AD0C5A85E4AFA_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EDC0730)
#define CLASS_1_F91AD0C5A85E4AFA_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EDBFCC0)
#define CLASS_1_F91AD0C5A85E4AFA_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1EDBFCA0)

inline static constexpr unsigned int Class_1_F91AD0C5A85E4AFA_7_TypeDefinitionIndex = 26147;

class Class_1_F91AD0C5A85E4AFA_7 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_7*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F91AD0C5A85E4AFA_7_TypeDefinitionIndex)->GetStaticField(0x3A440);
	}
	// static const ::System::Int32 CDMJHOMAPGP = 0x7; // 0x0
	// static const ::System::Int32 MKICIFKJMDE = 0xD; // 0x0
	// static const ::System::Int32 KIAAMEJPBHC = 0xF; // 0x0
	::System::String* KLPFJNIEDHG; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::String* OEMOLMMEBJJ; // 0x20
	::System::UInt32 JJFJJBOFAKI; // 0x28
