...
#define CLASS_2_B0A57EC5AFEEFE0B_METHOD_2_03A81715BD2AFEF3_OFFSET UNITYSDK_OFFSET(0x1793AF40)
#define CLASS_2_B0A57EC5AFEEFE0B_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x1793B3C0)
#define CLASS_2_B0A57EC5AFEEFE0B_METHOD_2_9A6C904A5C8D7167_OFFSET UNITYSDK_OFFSET(0x1793AE40)
#define CLASS_2_B0A57EC5AFEEFE0B_METHOD_2_A37F95FE754B38A0_OFFSET UNITYSDK_OFFSET(0x1793B1F0)
#define CLASS_2_B0A57EC5AFEEFE0B__CTOR_OFFSET UNITYSDK_OFFSET(0x1793B530)

inline static constexpr unsigned int Class_2_B0A57EC5AFEEFE0B_TypeDefinitionIndex = 77525;

class Class_2_B0A57EC5AFEEFE0B : public ::Class_1_1FB256EC3633CF9E
{
public:
	::RPG::GameCore::CakeRaceProperty NOIGFGJJDLB; // 0x28
	::System::Int32 AIKAPJELHNK; // 0x2C
