...
#define CLASS_1_D2BA87226C48A494_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F416A0)
#define CLASS_1_D2BA87226C48A494_FROMFLX_OFFSET UNITYSDK_OFFSET(0x16F41150)
#define CLASS_1_D2BA87226C48A494_METHOD_1_01A38C1C04BF8076_OFFSET UNITYSDK_OFFSET(0x16F41700)
#define CLASS_1_D2BA87226C48A494_METHOD_1_8741A88D50268453_OFFSET UNITYSDK_OFFSET(0x16F411D0)
#define CLASS_1_D2BA87226C48A494_METHOD_1_F62E96DF0CE4717C_OFFSET UNITYSDK_OFFSET(0x16F41A50)
#define CLASS_1_D2BA87226C48A494__CTOR_OFFSET UNITYSDK_OFFSET(0x16F41A40)

inline static constexpr unsigned int Class_1_D2BA87226C48A494_TypeDefinitionIndex = 55688;

class Class_1_D2BA87226C48A494 : public ::System::Object
{
public:
	::System::String* Field_1_1; // 0x10
	::System::Collections::Generic::List_1<::MoleMole::Config::ConfigDecorBase*>* Field_1_0; // 0x18
	...
	{
		return ((::System::Boolean(*)(::PVOID, ::FlexBuffers::FlxMap))((::PBYTE)hIl2Cpp + CLASS_1_D2BA87226C48A494_METHOD_1_8741A88D50268453_OFFSET))(this, a1);
	}
