...
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0xF18C3F0)
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0xF18C030)
#define EMISSIONOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xF18C6C0)
#define EMISSIONOPERATION_METHOD_3_A4A57157C453DC3A_OFFSET UNITYSDK_OFFSET(0xF18C2E0)
#define EMISSIONOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0xF18C730)
#define EMISSIONOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0xF18C710)

inline static constexpr unsigned int EmissionOperation_TypeDefinitionIndex = 45338;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EmissionOperation_TypeDefinitionIndex)->GetStaticField(0x8A50);
	}
