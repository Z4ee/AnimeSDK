...
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0xF2F7BE0)
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0xF2F77F0)
#define EMISSIONOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xF2F7EE0)
#define EMISSIONOPERATION_METHOD_3_A4A57157C453DC3A_OFFSET UNITYSDK_OFFSET(0xF2F7AD0)
#define EMISSIONOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0xF2F7F50)
#define EMISSIONOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0xF2F7F30)

inline static constexpr unsigned int EmissionOperation_TypeDefinitionIndex = 43920;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EmissionOperation_TypeDefinitionIndex)->GetStaticField(0x5810);
	}
