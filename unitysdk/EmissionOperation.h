...
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0x1357E6C0)
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0x1357E2E0)
#define EMISSIONOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1357E9C0)
#define EMISSIONOPERATION_METHOD_3_A4A57157C453DC3A_OFFSET UNITYSDK_OFFSET(0x1357E5B0)
#define EMISSIONOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1357EA30)
#define EMISSIONOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1357EA10)

inline static constexpr unsigned int EmissionOperation_TypeDefinitionIndex = 44466;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EmissionOperation_TypeDefinitionIndex)->GetStaticField(0xC430);
	}
