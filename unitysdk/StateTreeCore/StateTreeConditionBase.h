...
#define STATETREECORE_STATETREECONDITIONBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x410C50)
#define STATETREECORE_STATETREECONDITIONBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x695C90)
#define STATETREECORE_STATETREECONDITIONBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E80A330)
#define STATETREECORE_STATETREECONDITIONBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA7CB00)
#define STATETREECORE_STATETREECONDITIONBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREECONDITIONBASE_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define STATETREECORE_STATETREECONDITIONBASE_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define STATETREECORE_STATETREECONDITIONBASE_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define STATETREECORE_STATETREECONDITIONBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define STATETREECORE_STATETREECONDITIONBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA7CA70)
#define STATETREECORE_STATETREECONDITIONBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA7CB20)
#define STATETREECORE_STATETREECONDITIONBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREECORE_STATETREECONDITIONBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0xA7C920)
#define STATETREECORE_STATETREECONDITIONBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x410C50)
#define STATETREECORE_STATETREECONDITIONBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x695C90)
#define STATETREECORE_STATETREECONDITIONBASE_RESET_OFFSET UNITYSDK_OFFSET(0x410C90)
#define STATETREECORE_STATETREECONDITIONBASE_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0xA7CAE0)
#define STATETREECORE_STATETREECONDITIONBASE_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7F5090)
#define STATETREECORE_STATETREECONDITIONBASE_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xA7CAF0)
#define STATETREECORE_STATETREECONDITIONBASE_SET_NAME_OFFSET UNITYSDK_OFFSET(0xA7CAD0)
#define STATETREECORE_STATETREECONDITIONBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define STATETREECORE_STATETREECONDITIONBASE_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x1E80A0C0)
#define STATETREECORE_STATETREECONDITIONBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREECONDITIONBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x410C50)
#define STATETREECORE_STATETREECONDITIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E80A730)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeConditionBase_TypeDefinitionIndex = 30916;

	struct alignas(4) StateTreeConditionBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeConditionBase_TypeDefinitionIndex)->GetStaticField(0x257C0);
		}
