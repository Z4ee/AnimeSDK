...
#define STATETREECORE_STATETREEACTIVESTATES_CLEAR_OFFSET UNITYSDK_OFFSET(0xAC5120)
#define STATETREECORE_STATETREEACTIVESTATES_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0xAC50C0)
#define STATETREECORE_STATETREEACTIVESTATES_CONTAINS_OFFSET UNITYSDK_OFFSET(0xAC5070)
#define STATETREECORE_STATETREEACTIVESTATES_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAC51D0)
#define STATETREECORE_STATETREEACTIVESTATES_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAC51B0)
#define STATETREECORE_STATETREEACTIVESTATES_CREATE_OFFSET UNITYSDK_OFFSET(0x1FA55CE0)
#define STATETREECORE_STATETREEACTIVESTATES_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAC51A0)
#define STATETREECORE_STATETREEACTIVESTATES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREEACTIVESTATES_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAC5180)
#define STATETREECORE_STATETREEACTIVESTATES_GETSTATESAFE_OFFSET UNITYSDK_OFFSET(0xAC4F70)
#define STATETREECORE_STATETREEACTIVESTATES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x36D9B0)
#define STATETREECORE_STATETREEACTIVESTATES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xAC4EC0)
#define STATETREECORE_STATETREEACTIVESTATES_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define STATETREECORE_STATETREEACTIVESTATES_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAC51F0)
#define STATETREECORE_STATETREEACTIVESTATES_INDEXOFREVERSE_OFFSET UNITYSDK_OFFSET(0xAC5130)
#define STATETREECORE_STATETREEACTIVESTATES_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0xAC4ED0)
#define STATETREECORE_STATETREEACTIVESTATES_LAST_OFFSET UNITYSDK_OFFSET(0xAC4EF0)
#define STATETREECORE_STATETREEACTIVESTATES_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAC51D0)
#define STATETREECORE_STATETREEACTIVESTATES_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAC51B0)
#define STATETREECORE_STATETREEACTIVESTATES_POP_OFFSET UNITYSDK_OFFSET(0xAC5000)
#define STATETREECORE_STATETREEACTIVESTATES_PUSH_OFFSET UNITYSDK_OFFSET(0xAC4FE0)
#define STATETREECORE_STATETREEACTIVESTATES_RESET_OFFSET UNITYSDK_OFFSET(0xAC51E0)
#define STATETREECORE_STATETREEACTIVESTATES_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEACTIVESTATES__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAC51D0)
#define STATETREECORE_STATETREEACTIVESTATES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FA55E50)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeActiveStates_TypeDefinitionIndex = 31548;

	struct alignas(2) StateTreeActiveStates
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeActiveStates_TypeDefinitionIndex)->GetStaticField(0x26E30);
		}
