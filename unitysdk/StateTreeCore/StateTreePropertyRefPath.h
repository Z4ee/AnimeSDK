...
#define STATETREECORE_STATETREEPROPERTYREFPATH_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA5B1C0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA5B040)
#define STATETREECORE_STATETREEPROPERTYREFPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1E1DC0B0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA5AF90)
#define STATETREECORE_STATETREEPROPERTYREFPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x455620)
#define STATETREECORE_STATETREEPROPERTYREFPATH_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA5AF30)
#define STATETREECORE_STATETREEPROPERTYREFPATH_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA5B340)
#define STATETREECORE_STATETREEPROPERTYREFPATH_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA5B2A0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA5B0E0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_RESET_OFFSET UNITYSDK_OFFSET(0xA5B2D0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYREFPATH__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA5B1C0)
#define STATETREECORE_STATETREEPROPERTYREFPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1DC540)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyRefPath_TypeDefinitionIndex = 31017;

	struct alignas(8) StateTreePropertyRefPath
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyRefPath_TypeDefinitionIndex)->GetStaticField(0x257A0);
		}
