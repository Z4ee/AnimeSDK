...
#define STATETREECORE_STATETREEPROPERTYBINDINGS_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B9F70)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9B9F30)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_COPYPROPERTY_OFFSET UNITYSDK_OFFSET(0x9B9D00)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_CREATE_OFFSET UNITYSDK_OFFSET(0x1BEF2CB0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9B9F10)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BA590)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GETADDRESS_1_OFFSET UNITYSDK_OFFSET(0x1BEF27E0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GETADDRESS_OFFSET UNITYSDK_OFFSET(0x9B9D30)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GETBATCHCOPIES_OFFSET UNITYSDK_OFFSET(0x9B9B70)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GETPROPERTYACCESS_OFFSET UNITYSDK_OFFSET(0x9B9E20)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GETPROPERTYCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0x1BEF15A0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GETSOURCEDESCBYHANDLE_OFFSET UNITYSDK_OFFSET(0x9B9C10)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9B9B60)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9B9EB0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9BA620)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9BA370)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9B9F50)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_PERFORMCOPY_OFFSET UNITYSDK_OFFSET(0x1BEF1DC0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_RESET_OFFSET UNITYSDK_OFFSET(0x9BA520)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_RESOLVECOPYTYPE_OFFSET UNITYSDK_OFFSET(0x1BEF0300)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_RESOLVEPATHS_OFFSET UNITYSDK_OFFSET(0x9B9C40)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_RESOLVEPATH_1_OFFSET UNITYSDK_OFFSET(0x1BEF0AE0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_RESOLVEPATH_OFFSET UNITYSDK_OFFSET(0x9B9C50)
#define STATETREECORE_STATETREEPROPERTYBINDINGS_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYBINDINGS__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B9F70)
#define STATETREECORE_STATETREEPROPERTYBINDINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BEF4290)
#define STATETREECORE_STATETREEPROPERTYBINDINGS__GETPROPERTYCOMPATIBILITY_G__GETPROPERTYENUM_16_0_OFFSET UNITYSDK_OFFSET(0x1BEF19D0)
#define STATETREECORE_STATETREEPROPERTYBINDINGS__RESOLVEPATH_G__CASTARRAYINDEXTOINDEX16_14_0_OFFSET UNITYSDK_OFFSET(0x1BEF1580)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyBindings_TypeDefinitionIndex = 28365;

	struct alignas(8) StateTreePropertyBindings
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyBindings_TypeDefinitionIndex)->GetStaticField(0x219C0);
		}
