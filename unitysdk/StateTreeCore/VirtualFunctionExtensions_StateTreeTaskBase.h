...
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1E1DC9C0)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1E1DCA50)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1E1DCAE0)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1E1DCB70)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1E1DCC00)

namespace StateTreeCore
{
	inline static constexpr unsigned int VirtualFunctionExtensions_StateTreeTaskBase_TypeDefinitionIndex = 31056;
