...
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9CDD50)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9CDD20)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C2A81A0)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9CDD00)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x304470)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9CDD90)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9CDD50)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9CDD20)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_RESET_OFFSET UNITYSDK_OFFSET(0x9CDD70)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONDELAYEDSTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9CDD50)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2A8360)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionDelayedState_TypeDefinitionIndex = 28301;

	struct alignas(8) StateTreeTransitionDelayedState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionDelayedState_TypeDefinitionIndex)->GetStaticField(0x211C0);
		}
