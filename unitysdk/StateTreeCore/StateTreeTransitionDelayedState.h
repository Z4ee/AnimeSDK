...
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA6C660)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA6C630)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E597ED0)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA6C610)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA6C6A0)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA6C660)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA6C630)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_RESET_OFFSET UNITYSDK_OFFSET(0xA6C680)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONDELAYEDSTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA6C660)
#define STATETREECORE_STATETREETRANSITIONDELAYEDSTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E598090)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionDelayedState_TypeDefinitionIndex = 30951;

	struct alignas(8) StateTreeTransitionDelayedState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionDelayedState_TypeDefinitionIndex)->GetStaticField(0x24F30);
		}
