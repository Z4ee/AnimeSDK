...
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9BA780)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9BA760)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_CREATE_OFFSET UNITYSDK_OFFSET(0x1BEF4730)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9BA6E0)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9BA680)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9BA840)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9BA780)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9BA760)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_RESET_OFFSET UNITYSDK_OFFSET(0x9BA7A0)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYCOPYBATCH__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9BA780)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BEF49C0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyCopyBatch_TypeDefinitionIndex = 28355;

	struct alignas(4) StateTreePropertyCopyBatch
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyCopyBatch_TypeDefinitionIndex)->GetStaticField(0x219D0);
		}
