...
#define STATETREECORE_STATETREEPROPERTYPATH_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x8C3310)
#define STATETREECORE_STATETREEPROPERTYPATH_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x8C31C0)
#define STATETREECORE_STATETREEPROPERTYPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1BF49980)
#define STATETREECORE_STATETREEPROPERTYPATH_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9BC1D0)
#define STATETREECORE_STATETREEPROPERTYPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C3530)
#define STATETREECORE_STATETREEPROPERTYPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x9BC0A0)
#define STATETREECORE_STATETREEPROPERTYPATH_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x9BC090)
#define STATETREECORE_STATETREEPROPERTYPATH_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x9BC080)
#define STATETREECORE_STATETREEPROPERTYPATH_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9BC170)
#define STATETREECORE_STATETREEPROPERTYPATH_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9BC270)
#define STATETREECORE_STATETREEPROPERTYPATH_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9BC250)
#define STATETREECORE_STATETREEPROPERTYPATH_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x8C3240)
#define STATETREECORE_STATETREEPROPERTYPATH_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BF486F0)
#define STATETREECORE_STATETREEPROPERTYPATH_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BF48730)
#define STATETREECORE_STATETREEPROPERTYPATH_RESET_OFFSET UNITYSDK_OFFSET(0x9BC260)
#define STATETREECORE_STATETREEPROPERTYPATH_RESOLVEINDIRECTIONSWITHVALUE_OFFSET UNITYSDK_OFFSET(0x9BC120)
#define STATETREECORE_STATETREEPROPERTYPATH_RESOLVEINDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x9BC0E0)
#define STATETREECORE_STATETREEPROPERTYPATH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9BC0D0)
#define STATETREECORE_STATETREEPROPERTYPATH_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATH__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x8C3310)
#define STATETREECORE_STATETREEPROPERTYPATH_UPDATESEGMENTSFROMVALUE_OFFSET UNITYSDK_OFFSET(0x9BC150)
#define STATETREECORE_STATETREEPROPERTYPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF49D30)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPath_TypeDefinitionIndex = 28346;

	struct alignas(8) StateTreePropertyPath
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPath_TypeDefinitionIndex)->GetStaticField(0x21800);
		}
