...
#define STATETREECORE_STATETREERANDOMTIMEDURATION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5EC570)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_CREATE_OFFSET UNITYSDK_OFFSET(0x1E681190)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GETRANDOMDURATION_OFFSET UNITYSDK_OFFSET(0xA74CD0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xA74A80)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xA74AC0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_RANDOMVARIANCE_OFFSET UNITYSDK_OFFSET(0xA74AA0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA74D10)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA74D70)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x5EC570)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_QUANTIZE_OFFSET UNITYSDK_OFFSET(0x1E680E30)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_RESET_OFFSET UNITYSDK_OFFSET(0x3E1930)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_SET_OFFSET UNITYSDK_OFFSET(0xA74AE0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREERANDOMTIMEDURATION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x5EC570)
#define STATETREECORE_STATETREERANDOMTIMEDURATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E6812C0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeRandomTimeDuration_TypeDefinitionIndex = 31072;

	struct alignas(2) StateTreeRandomTimeDuration
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeRandomTimeDuration_TypeDefinitionIndex)->GetStaticField(0x25710);
		}
