...
#define STATETREECORE_STATETREERANDOMTIMEDURATION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_CREATE_OFFSET UNITYSDK_OFFSET(0x1FA568E0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GETRANDOMDURATION_OFFSET UNITYSDK_OFFSET(0xAC5720)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xAC54D0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xAC5510)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_RANDOMVARIANCE_OFFSET UNITYSDK_OFFSET(0xAC54F0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xAC5760)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAC57C0)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_QUANTIZE_OFFSET UNITYSDK_OFFSET(0x1FA56580)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_RESET_OFFSET UNITYSDK_OFFSET(0x463B50)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_SET_OFFSET UNITYSDK_OFFSET(0xAC5530)
#define STATETREECORE_STATETREERANDOMTIMEDURATION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREERANDOMTIMEDURATION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x753C30)
#define STATETREECORE_STATETREERANDOMTIMEDURATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FA56A10)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeRandomTimeDuration_TypeDefinitionIndex = 31691;

	struct alignas(2) StateTreeRandomTimeDuration
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeRandomTimeDuration_TypeDefinitionIndex)->GetStaticField(0x26E60);
		}
