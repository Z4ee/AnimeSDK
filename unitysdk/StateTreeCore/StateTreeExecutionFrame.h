...
#define STATETREECORE_STATETREEEXECUTIONFRAME_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAC8430)
#define STATETREECORE_STATETREEEXECUTIONFRAME_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAC83D0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_CREATE_OFFSET UNITYSDK_OFFSET(0x1FB168D0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAC83B0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREEEXECUTIONFRAME_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAC8570)
#define STATETREECORE_STATETREEEXECUTIONFRAME_ISSAMEFRAME_OFFSET UNITYSDK_OFFSET(0xAC8340)
#define STATETREECORE_STATETREEEXECUTIONFRAME_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAC8430)
#define STATETREECORE_STATETREEEXECUTIONFRAME_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAC83D0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_RESET_OFFSET UNITYSDK_OFFSET(0xAC8490)
#define STATETREECORE_STATETREEEXECUTIONFRAME_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXECUTIONFRAME__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAC8430)
#define STATETREECORE_STATETREEEXECUTIONFRAME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB16D50)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionFrame_TypeDefinitionIndex = 31557;

	struct alignas(8) StateTreeExecutionFrame
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExecutionFrame_TypeDefinitionIndex)->GetStaticField(0x26C90);
		}
