...
#define STATETREECORE_STATETREEEXECUTIONFRAME_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D7070)
#define STATETREECORE_STATETREEEXECUTIONFRAME_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9D7010)
#define STATETREECORE_STATETREEEXECUTIONFRAME_CREATE_OFFSET UNITYSDK_OFFSET(0x1C413210)
#define STATETREECORE_STATETREEEXECUTIONFRAME_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9D6FF0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x304470)
#define STATETREECORE_STATETREEEXECUTIONFRAME_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9D71B0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_ISSAMEFRAME_OFFSET UNITYSDK_OFFSET(0x9D6F80)
#define STATETREECORE_STATETREEEXECUTIONFRAME_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9D7070)
#define STATETREECORE_STATETREEEXECUTIONFRAME_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9D7010)
#define STATETREECORE_STATETREEEXECUTIONFRAME_RESET_OFFSET UNITYSDK_OFFSET(0x9D70D0)
#define STATETREECORE_STATETREEEXECUTIONFRAME_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXECUTIONFRAME__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D7070)
#define STATETREECORE_STATETREEEXECUTIONFRAME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C413690)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionFrame_TypeDefinitionIndex = 28303;

	struct alignas(8) StateTreeExecutionFrame
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExecutionFrame_TypeDefinitionIndex)->GetStaticField(0x21780);
		}
