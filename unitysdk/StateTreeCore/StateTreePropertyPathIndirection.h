...
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9E0C20)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9E0BE0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1C5293F0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9E0B30)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x304470)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9E0D00)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9E0C20)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9E0BE0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_RESET_OFFSET UNITYSDK_OFFSET(0x9E0C50)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9E0C20)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C529720)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9E0A90)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathIndirection_TypeDefinitionIndex = 28351;

	struct alignas(8) StateTreePropertyPathIndirection
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathIndirection_TypeDefinitionIndex)->GetStaticField(0x21A80);
		}
