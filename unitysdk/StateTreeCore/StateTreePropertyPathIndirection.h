...
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAD3F80)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAD3F40)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1FC3DEC0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAD3E90)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAD4060)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAD3F80)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAD3F40)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_RESET_OFFSET UNITYSDK_OFFSET(0xAD3FB0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAD3F80)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC3E1F0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xAD3DF0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathIndirection_TypeDefinitionIndex = 31610;

	struct alignas(8) StateTreePropertyPathIndirection
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathIndirection_TypeDefinitionIndex)->GetStaticField(0x26F90);
		}
