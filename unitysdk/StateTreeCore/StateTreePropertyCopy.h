...
#define STATETREECORE_STATETREEPROPERTYCOPY_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D3090)
#define STATETREECORE_STATETREEPROPERTYCOPY_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9D3040)
#define STATETREECORE_STATETREEPROPERTYCOPY_CREATE_OFFSET UNITYSDK_OFFSET(0x1C33A1E0)
#define STATETREECORE_STATETREEPROPERTYCOPY_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9D3020)
#define STATETREECORE_STATETREEPROPERTYCOPY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEPROPERTYCOPY_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9D2FC0)
#define STATETREECORE_STATETREEPROPERTYCOPY_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9D3120)
#define STATETREECORE_STATETREEPROPERTYCOPY_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9D3090)
#define STATETREECORE_STATETREEPROPERTYCOPY_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9D3040)
#define STATETREECORE_STATETREEPROPERTYCOPY_RESET_OFFSET UNITYSDK_OFFSET(0x9D30D0)
#define STATETREECORE_STATETREEPROPERTYCOPY_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYCOPY__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D3090)
#define STATETREECORE_STATETREEPROPERTYCOPY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C33A590)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyCopy_TypeDefinitionIndex = 28358;

	struct alignas(4) StateTreePropertyCopy
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyCopy_TypeDefinitionIndex)->GetStaticField(0x21930);
		}
