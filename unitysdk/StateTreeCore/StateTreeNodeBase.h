...
#define STATETREECORE_STATETREENODEBASE_COMPILE_OFFSET UNITYSDK_OFFSET(0x1E597870)
#define STATETREECORE_STATETREENODEBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA6C510)
#define STATETREECORE_STATETREENODEBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA6C4E0)
#define STATETREECORE_STATETREENODEBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E597AC0)
#define STATETREECORE_STATETREENODEBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA6C4C0)
#define STATETREECORE_STATETREENODEBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREENODEBASE_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1E597890)
#define STATETREECORE_STATETREENODEBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA6C460)
#define STATETREECORE_STATETREENODEBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA6C5B0)
#define STATETREECORE_STATETREENODEBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREECORE_STATETREENODEBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0xA6C310)
#define STATETREECORE_STATETREENODEBASE_LINK_OFFSET UNITYSDK_OFFSET(0x1E597880)
#define STATETREECORE_STATETREENODEBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA6C510)
#define STATETREECORE_STATETREENODEBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA6C4E0)
#define STATETREECORE_STATETREENODEBASE_RESET_OFFSET UNITYSDK_OFFSET(0xA6C540)
#define STATETREECORE_STATETREENODEBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define STATETREECORE_STATETREENODEBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREENODEBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA6C510)
#define STATETREECORE_STATETREENODEBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E597E50)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeNodeBase_TypeDefinitionIndex = 30985;

	struct alignas(4) StateTreeNodeBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeNodeBase_TypeDefinitionIndex)->GetStaticField(0x24F20);
		}
