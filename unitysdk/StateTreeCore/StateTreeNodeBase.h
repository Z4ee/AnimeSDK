...
#define STATETREECORE_STATETREENODEBASE_COMPILE_OFFSET UNITYSDK_OFFSET(0x1C2A7B40)
#define STATETREECORE_STATETREENODEBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9CDC00)
#define STATETREECORE_STATETREENODEBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9CDBD0)
#define STATETREECORE_STATETREENODEBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C2A7D90)
#define STATETREECORE_STATETREENODEBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9CDBB0)
#define STATETREECORE_STATETREENODEBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREENODEBASE_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1C2A7B60)
#define STATETREECORE_STATETREENODEBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9CDB50)
#define STATETREECORE_STATETREENODEBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9CDCA0)
#define STATETREECORE_STATETREENODEBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define STATETREECORE_STATETREENODEBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x9CDA00)
#define STATETREECORE_STATETREENODEBASE_LINK_OFFSET UNITYSDK_OFFSET(0x1C2A7B50)
#define STATETREECORE_STATETREENODEBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9CDC00)
#define STATETREECORE_STATETREENODEBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9CDBD0)
#define STATETREECORE_STATETREENODEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x9CDC30)
#define STATETREECORE_STATETREENODEBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define STATETREECORE_STATETREENODEBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREENODEBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9CDC00)
#define STATETREECORE_STATETREENODEBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2A8120)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeNodeBase_TypeDefinitionIndex = 28335;

	struct alignas(4) StateTreeNodeBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeNodeBase_TypeDefinitionIndex)->GetStaticField(0x211B0);
		}
