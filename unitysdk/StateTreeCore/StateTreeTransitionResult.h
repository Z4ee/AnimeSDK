...
#define STATETREECORE_STATETREETRANSITIONRESULT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA7FD50)
#define STATETREECORE_STATETREETRANSITIONRESULT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA7FB30)
#define STATETREECORE_STATETREETRANSITIONRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x1E825B30)
#define STATETREECORE_STATETREETRANSITIONRESULT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA7FA40)
#define STATETREECORE_STATETREETRANSITIONRESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x959A90)
#define STATETREECORE_STATETREETRANSITIONRESULT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREECORE_STATETREETRANSITIONRESULT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA7FEF0)
#define STATETREECORE_STATETREETRANSITIONRESULT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA7FDB0)
#define STATETREECORE_STATETREETRANSITIONRESULT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA7FCD0)
#define STATETREECORE_STATETREETRANSITIONRESULT_RESET_OFFSET UNITYSDK_OFFSET(0xA7FE60)
#define STATETREECORE_STATETREETRANSITIONRESULT_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONRESULT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA7FD50)
#define STATETREECORE_STATETREETRANSITIONRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8260F0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionResult_TypeDefinitionIndex = 30957;

	struct alignas(8) StateTreeTransitionResult
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionResult_TypeDefinitionIndex)->GetStaticField(0x25340);
		}
