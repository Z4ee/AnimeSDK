...
#define STATETREECORE_STATETREETRANSITIONRESULT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DE2A0)
#define STATETREECORE_STATETREETRANSITIONRESULT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9DE080)
#define STATETREECORE_STATETREETRANSITIONRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4F2B60)
#define STATETREECORE_STATETREETRANSITIONRESULT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DDF90)
#define STATETREECORE_STATETREETRANSITIONRESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7C89D0)
#define STATETREECORE_STATETREETRANSITIONRESULT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x304470)
#define STATETREECORE_STATETREETRANSITIONRESULT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DE440)
#define STATETREECORE_STATETREETRANSITIONRESULT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9DE300)
#define STATETREECORE_STATETREETRANSITIONRESULT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9DE220)
#define STATETREECORE_STATETREETRANSITIONRESULT_RESET_OFFSET UNITYSDK_OFFSET(0x9DE3B0)
#define STATETREECORE_STATETREETRANSITIONRESULT_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONRESULT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DE2A0)
#define STATETREECORE_STATETREETRANSITIONRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4F3120)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionResult_TypeDefinitionIndex = 28307;

	struct alignas(8) StateTreeTransitionResult
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionResult_TypeDefinitionIndex)->GetStaticField(0x215C0);
		}
