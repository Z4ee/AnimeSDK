...
#define STATETREECORE_STATETREETASKBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREECORE_STATETREETASKBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7E39D0)
#define STATETREECORE_STATETREETASKBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1FC1AB10)
#define STATETREECORE_STATETREETASKBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAD15F0)
#define STATETREECORE_STATETREETASKBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1FC1A860)
#define STATETREECORE_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1FC1A870)
#define STATETREECORE_STATETREETASKBASE_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define STATETREECORE_STATETREETASKBASE_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define STATETREECORE_STATETREETASKBASE_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define STATETREECORE_STATETREETASKBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define STATETREECORE_STATETREETASKBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xAD1590)
#define STATETREECORE_STATETREETASKBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAD1610)
#define STATETREECORE_STATETREETASKBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define STATETREECORE_STATETREETASKBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0xAD1440)
#define STATETREECORE_STATETREETASKBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREECORE_STATETREETASKBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7E39D0)
#define STATETREECORE_STATETREETASKBASE_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define STATETREECORE_STATETREETASKBASE_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0xACCF20)
#define STATETREECORE_STATETREETASKBASE_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x83B570)
#define STATETREECORE_STATETREETASKBASE_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xACCF30)
#define STATETREECORE_STATETREETASKBASE_SET_NAME_OFFSET UNITYSDK_OFFSET(0xACCF10)
#define STATETREECORE_STATETREETASKBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x3253A0)
#define STATETREECORE_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1FC1A880)
#define STATETREECORE_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1FC1A890)
#define STATETREECORE_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1FC1A8A0)
#define STATETREECORE_STATETREETASKBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETASKBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREECORE_STATETREETASKBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC1AF10)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTaskBase_TypeDefinitionIndex = 31673;

	struct alignas(4) StateTreeTaskBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTaskBase_TypeDefinitionIndex)->GetStaticField(0x26440);
		}
