...
#define STATETREECORE_STATETREETASKBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define STATETREECORE_STATETREETASKBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9DF0E0)
#define STATETREECORE_STATETREETASKBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C508D90)
#define STATETREECORE_STATETREETASKBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DF0C0)
#define STATETREECORE_STATETREETASKBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1C508AE0)
#define STATETREECORE_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1C508AF0)
#define STATETREECORE_STATETREETASKBASE_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4B6C10)
#define STATETREECORE_STATETREETASKBASE_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3EBE20)
#define STATETREECORE_STATETREETASKBASE_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x4B6C70)
#define STATETREECORE_STATETREETASKBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3ABA20)
#define STATETREECORE_STATETREETASKBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DF060)
#define STATETREECORE_STATETREETASKBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DF130)
#define STATETREECORE_STATETREETASKBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define STATETREECORE_STATETREETASKBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x9DEF10)
#define STATETREECORE_STATETREETASKBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define STATETREECORE_STATETREETASKBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9DF0E0)
#define STATETREECORE_STATETREETASKBASE_RESET_OFFSET UNITYSDK_OFFSET(0x4B6E10)
#define STATETREECORE_STATETREETASKBASE_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x9DB4E0)
#define STATETREECORE_STATETREETASKBASE_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x722290)
#define STATETREECORE_STATETREETASKBASE_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x9DB4F0)
#define STATETREECORE_STATETREETASKBASE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x9DB4D0)
#define STATETREECORE_STATETREETASKBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define STATETREECORE_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1C508B00)
#define STATETREECORE_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1C508B10)
#define STATETREECORE_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1C508B20)
#define STATETREECORE_STATETREETASKBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETASKBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x4B6DD0)
#define STATETREECORE_STATETREETASKBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C509190)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTaskBase_TypeDefinitionIndex = 28399;

	struct alignas(4) StateTreeTaskBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTaskBase_TypeDefinitionIndex)->GetStaticField(0x20F80);
		}
