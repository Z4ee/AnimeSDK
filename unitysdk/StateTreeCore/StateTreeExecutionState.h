...
#define STATETREECORE_STATETREEEXECUTIONSTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA82DD0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA82A60)
#define STATETREECORE_STATETREEEXECUTIONSTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E8604A0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA82A40)
#define STATETREECORE_STATETREEEXECUTIONSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA83090)
#define STATETREECORE_STATETREEEXECUTIONSTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA830C0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA82F50)
#define STATETREECORE_STATETREEEXECUTIONSTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA82C90)
#define STATETREECORE_STATETREEEXECUTIONSTATE_RESET_OFFSET UNITYSDK_OFFSET(0xA83000)
#define STATETREECORE_STATETREEEXECUTIONSTATE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXECUTIONSTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA82DD0)
#define STATETREECORE_STATETREEEXECUTIONSTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E860CD0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionState_TypeDefinitionIndex = 30955;

	struct alignas(8) StateTreeExecutionState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExecutionState_TypeDefinitionIndex)->GetStaticField(0x25740);
		}
