...
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA81950)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA81920)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1E845710)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA81880)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA81820)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA81A10)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA81950)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA81920)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_RESET_OFFSET UNITYSDK_OFFSET(0xA81980)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYINDIRECTION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA81950)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8459C0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyIndirection_TypeDefinitionIndex = 31007;

	struct alignas(4) StateTreePropertyIndirection
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyIndirection_TypeDefinitionIndex)->GetStaticField(0x255D0);
		}
