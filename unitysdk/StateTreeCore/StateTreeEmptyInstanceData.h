...
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1E5976D0)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA6C250)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA6C2B0)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x4105E0)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEMPTYINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEMPTYINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E597800)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeEmptyInstanceData_TypeDefinitionIndex = 30987;

	struct alignas(1) StateTreeEmptyInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeEmptyInstanceData_TypeDefinitionIndex)->GetStaticField(0x24EC0);
		}
