...
#define STATETREECORE_BASEFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B860BC0)
#define STATETREECORE_BASEFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x995F00)
#define STATETREECORE_BASEFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x995F60)
#define STATETREECORE_BASEFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x4B6FE0)
#define STATETREECORE_BASEFRAGMENT_UNREALTYPES_ISTRUCT_STATETREECORE_BASEFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_BASEFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B860CF0)

namespace StateTreeCore
{
	inline static constexpr unsigned int BaseFragment_TypeDefinitionIndex = 28326;

	struct alignas(1) BaseFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(BaseFragment_TypeDefinitionIndex)->GetStaticField(0x211E0);
		}
