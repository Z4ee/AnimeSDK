...
#define STATETREECORE_STATETREEINSTANCEDATA_ADDTEMPORARYINSTANCE_OFFSET UNITYSDK_OFFSET(0xA59170)
#define STATETREECORE_STATETREEINSTANCEDATA_ADDTRANSITIONREQUEST_OFFSET UNITYSDK_OFFSET(0xA58FD0)
#define STATETREECORE_STATETREEINSTANCEDATA_APPEND_OFFSET UNITYSDK_OFFSET(0xA59370)
#define STATETREECORE_STATETREEINSTANCEDATA_AREALLINSTANCESVALID_OFFSET UNITYSDK_OFFSET(0xA590F0)
#define STATETREECORE_STATETREEINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA59C50)
#define STATETREECORE_STATETREEINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA59400)
#define STATETREECORE_STATETREEINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1E1D5280)
#define STATETREECORE_STATETREEINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA593E0)
#define STATETREECORE_STATETREEINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA5A080)
#define STATETREECORE_STATETREEINSTANCEDATA_GETMUTABLESTRUCT_OFFSET UNITYSDK_OFFSET(0xA58F00)
#define STATETREECORE_STATETREEINSTANCEDATA_GETMUTABLETEMPORARYINSTANCES_OFFSET UNITYSDK_OFFSET(0xA591E0)
#define STATETREECORE_STATETREEINSTANCEDATA_GETSTRUCT_OFFSET UNITYSDK_OFFSET(0xA58F00)
#define STATETREECORE_STATETREEINSTANCEDATA_GETTRANSITIONREQUESTS_OFFSET UNITYSDK_OFFSET(0xA58F40)
#define STATETREECORE_STATETREEINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA59380)
#define STATETREECORE_STATETREEINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA5A140)
#define STATETREECORE_STATETREEINSTANCEDATA_INIT_OFFSET UNITYSDK_OFFSET(0xA59260)
#define STATETREECORE_STATETREEINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA59E90)
#define STATETREECORE_STATETREEINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA59850)
#define STATETREECORE_STATETREEINSTANCEDATA_RESETTEMPORARYINSTANCES_OFFSET UNITYSDK_OFFSET(0xA591D0)
#define STATETREECORE_STATETREEINSTANCEDATA_RESETTRANSITIONREQUESTS_OFFSET UNITYSDK_OFFSET(0xA590E0)
#define STATETREECORE_STATETREEINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0xA59F80)
#define STATETREECORE_STATETREEINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA59C50)
#define STATETREECORE_STATETREEINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1D61D0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeInstanceData_TypeDefinitionIndex = 30971;

	struct alignas(8) StateTreeInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeInstanceData_TypeDefinitionIndex)->GetStaticField(0x25770);
		}
