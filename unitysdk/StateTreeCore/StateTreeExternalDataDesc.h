...
#define STATETREECORE_STATETREEEXTERNALDATADESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA770E0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA816C0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1E845300)
#define STATETREECORE_STATETREEEXTERNALDATADESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA81600)
#define STATETREECORE_STATETREEEXTERNALDATADESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEEXTERNALDATADESC_EQUALS_OFFSET UNITYSDK_OFFSET(0xA814D0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA815A0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA817C0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_ISCOMPATIBLEWITH_OFFSET UNITYSDK_OFFSET(0xA813B0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA770E0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA816C0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E845100)
#define STATETREECORE_STATETREEEXTERNALDATADESC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E8451D0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_RESET_OFFSET UNITYSDK_OFFSET(0xA816F0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXTERNALDATADESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA770E0)
#define STATETREECORE_STATETREEEXTERNALDATADESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E845640)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExternalDataDesc_TypeDefinitionIndex = 30940;

	struct alignas(4) StateTreeExternalDataDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExternalDataDesc_TypeDefinitionIndex)->GetStaticField(0x255C0);
		}
