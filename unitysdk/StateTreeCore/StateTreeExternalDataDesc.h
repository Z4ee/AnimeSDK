...
#define STATETREECORE_STATETREEEXTERNALDATADESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D5AD0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9DF9C0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1C514480)
#define STATETREECORE_STATETREEEXTERNALDATADESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DF900)
#define STATETREECORE_STATETREEEXTERNALDATADESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_EQUALS_OFFSET UNITYSDK_OFFSET(0x9DF7D0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DF8A0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DFAC0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_ISCOMPATIBLEWITH_OFFSET UNITYSDK_OFFSET(0x9DF6B0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9D5AD0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9DF9C0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C514280)
#define STATETREECORE_STATETREEEXTERNALDATADESC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C514350)
#define STATETREECORE_STATETREEEXTERNALDATADESC_RESET_OFFSET UNITYSDK_OFFSET(0x9DF9F0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXTERNALDATADESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D5AD0)
#define STATETREECORE_STATETREEEXTERNALDATADESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5147C0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExternalDataDesc_TypeDefinitionIndex = 28290;

	struct alignas(4) StateTreeExternalDataDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExternalDataDesc_TypeDefinitionIndex)->GetStaticField(0x21830);
		}
