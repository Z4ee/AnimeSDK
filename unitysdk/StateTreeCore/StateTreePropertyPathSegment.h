...
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D73B0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x28BE10)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1C413A10)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9D7330)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9D7210)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9D72D0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9D7440)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9D73B0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x28BE10)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C413810)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C4138E0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x9D73D0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHSEGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D73B0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C413C60)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathSegment_TypeDefinitionIndex = 28344;

	struct alignas(4) StateTreePropertyPathSegment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathSegment_TypeDefinitionIndex)->GetStaticField(0x217C0);
		}
