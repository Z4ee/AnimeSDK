...
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAC6460)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAC6430)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1FAA46B0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAC6380)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x59EE80)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xAC6320)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAC6530)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAC6460)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAC6430)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_RESET_OFFSET UNITYSDK_OFFSET(0xAC6490)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAC6310)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEBINDABLESTRUCTDESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAC6460)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FAA49B0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeBindableStructDesc_TypeDefinitionIndex = 31601;

	struct alignas(4) StateTreeBindableStructDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeBindableStructDesc_TypeDefinitionIndex)->GetStaticField(0x26F70);
		}
