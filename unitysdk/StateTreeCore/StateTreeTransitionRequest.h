...
#define STATETREECORE_STATETREETRANSITIONREQUEST_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAD1740)
#define STATETREECORE_STATETREETRANSITIONREQUEST_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAD1700)
#define STATETREECORE_STATETREETRANSITIONREQUEST_CREATE_OFFSET UNITYSDK_OFFSET(0x1FC1AFA0)
#define STATETREECORE_STATETREETRANSITIONREQUEST_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAD1670)
#define STATETREECORE_STATETREETRANSITIONREQUEST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREETRANSITIONREQUEST_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define STATETREECORE_STATETREETRANSITIONREQUEST_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAD17F0)
#define STATETREECORE_STATETREETRANSITIONREQUEST_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAD1740)
#define STATETREECORE_STATETREETRANSITIONREQUEST_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAD1700)
#define STATETREECORE_STATETREETRANSITIONREQUEST_RESET_OFFSET UNITYSDK_OFFSET(0xAD1770)
#define STATETREECORE_STATETREETRANSITIONREQUEST_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONREQUEST__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAD1740)
#define STATETREECORE_STATETREETRANSITIONREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC1B280)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionRequest_TypeDefinitionIndex = 31546;

	struct alignas(8) StateTreeTransitionRequest
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionRequest_TypeDefinitionIndex)->GetStaticField(0x26460);
		}
