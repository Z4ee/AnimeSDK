...
#define STATETREECORE_STATETREETRANSITIONREQUEST_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA80F80)
#define STATETREECORE_STATETREETRANSITIONREQUEST_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA80F40)
#define STATETREECORE_STATETREETRANSITIONREQUEST_CREATE_OFFSET UNITYSDK_OFFSET(0x1E83B430)
#define STATETREECORE_STATETREETRANSITIONREQUEST_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA80EB0)
#define STATETREECORE_STATETREETRANSITIONREQUEST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREETRANSITIONREQUEST_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREECORE_STATETREETRANSITIONREQUEST_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA81030)
#define STATETREECORE_STATETREETRANSITIONREQUEST_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA80F80)
#define STATETREECORE_STATETREETRANSITIONREQUEST_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA80F40)
#define STATETREECORE_STATETREETRANSITIONREQUEST_RESET_OFFSET UNITYSDK_OFFSET(0xA80FB0)
#define STATETREECORE_STATETREETRANSITIONREQUEST_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONREQUEST__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA80F80)
#define STATETREECORE_STATETREETRANSITIONREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E83B710)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionRequest_TypeDefinitionIndex = 30942;

	struct alignas(8) StateTreeTransitionRequest
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionRequest_TypeDefinitionIndex)->GetStaticField(0x24CE0);
		}
