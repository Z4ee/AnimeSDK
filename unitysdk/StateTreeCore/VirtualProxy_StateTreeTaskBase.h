...
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1F6B5E10)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1F6B5E70)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1F6B5EC0)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1F6B5F10)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1F6B5F70)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6B5FC0)

namespace StateTreeCore
{
	inline static constexpr unsigned int VirtualProxy_StateTreeTaskBase_TypeDefinitionIndex = 31676;
