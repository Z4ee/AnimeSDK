...
#define STATETREECORE_STATETREEDATAHANDLE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x996350)
#define STATETREECORE_STATETREEDATAHANDLE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x996330)
#define STATETREECORE_STATETREEDATAHANDLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B862DE0)
#define STATETREECORE_STATETREEDATAHANDLE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9962C0)
#define STATETREECORE_STATETREEDATAHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEDATAHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x996120)
#define STATETREECORE_STATETREEDATAHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x996190)
#define STATETREECORE_STATETREEDATAHANDLE_GETTYPEHASH_OFFSET UNITYSDK_OFFSET(0x1B862BE0)
#define STATETREECORE_STATETREEDATAHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x3E5650)
#define STATETREECORE_STATETREEDATAHANDLE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x996260)
#define STATETREECORE_STATETREEDATAHANDLE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9963D0)
#define STATETREECORE_STATETREEDATAHANDLE_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0x1B862D70)
#define STATETREECORE_STATETREEDATAHANDLE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x996350)
#define STATETREECORE_STATETREEDATAHANDLE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x996330)
#define STATETREECORE_STATETREEDATAHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B862C70)
#define STATETREECORE_STATETREEDATAHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B862CF0)
#define STATETREECORE_STATETREEDATAHANDLE_RESET_OFFSET UNITYSDK_OFFSET(0x996370)
#define STATETREECORE_STATETREEDATAHANDLE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEDATAHANDLE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x996350)
#define STATETREECORE_STATETREEDATAHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B863020)
#define STATETREECORE_STATETREEDATAHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x996030)
#define STATETREECORE_STATETREEDATAHANDLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9960A0)
#define STATETREECORE_STATETREEDATAHANDLE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9960B0)
#define STATETREECORE_STATETREEDATAHANDLE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x9960A0)
#define STATETREECORE_STATETREEDATAHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x995FC0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeDataHandle_TypeDefinitionIndex = 28415;

	struct alignas(2) StateTreeDataHandle
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeDataHandle_TypeDefinitionIndex)->GetStaticField(0x211A0);
		}
		static ::StateTreeCore::StateTreeDataHandle* StaticGet_Invalid()
		{
			return (::StateTreeCore::StateTreeDataHandle*)Il2CppClass::FromTypeDefinitionIndex(StateTreeDataHandle_TypeDefinitionIndex)->GetStaticField(0x4AA0);
		}
