...
#define STATETREECORE_STATETREEPROPERTYACCESS_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA7F970)
#define STATETREECORE_STATETREEPROPERTYACCESS_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA7F940)
#define STATETREECORE_STATETREEPROPERTYACCESS_CREATE_OFFSET UNITYSDK_OFFSET(0x1E825790)
#define STATETREECORE_STATETREEPROPERTYACCESS_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA7F920)
#define STATETREECORE_STATETREEPROPERTYACCESS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_STATETREEPROPERTYACCESS_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA7F8C0)
#define STATETREECORE_STATETREEPROPERTYACCESS_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA7F9E0)
#define STATETREECORE_STATETREEPROPERTYACCESS_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA7F970)
#define STATETREECORE_STATETREEPROPERTYACCESS_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA7F940)
#define STATETREECORE_STATETREEPROPERTYACCESS_RESET_OFFSET UNITYSDK_OFFSET(0xA7F9A0)
#define STATETREECORE_STATETREEPROPERTYACCESS_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYACCESS__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA7F970)
#define STATETREECORE_STATETREEPROPERTYACCESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E825A90)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyAccess_TypeDefinitionIndex = 31014;

	struct alignas(4) StateTreePropertyAccess
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyAccess_TypeDefinitionIndex)->GetStaticField(0x25330);
		}
