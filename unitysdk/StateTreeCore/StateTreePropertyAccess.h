...
#define STATETREECORE_STATETREEPROPERTYACCESS_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DDEC0)
#define STATETREECORE_STATETREEPROPERTYACCESS_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9DDE90)
#define STATETREECORE_STATETREEPROPERTYACCESS_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4F27C0)
#define STATETREECORE_STATETREEPROPERTYACCESS_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DDE70)
#define STATETREECORE_STATETREEPROPERTYACCESS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEPROPERTYACCESS_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DDE10)
#define STATETREECORE_STATETREEPROPERTYACCESS_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DDF30)
#define STATETREECORE_STATETREEPROPERTYACCESS_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9DDEC0)
#define STATETREECORE_STATETREEPROPERTYACCESS_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9DDE90)
#define STATETREECORE_STATETREEPROPERTYACCESS_RESET_OFFSET UNITYSDK_OFFSET(0x9DDEF0)
#define STATETREECORE_STATETREEPROPERTYACCESS_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYACCESS__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DDEC0)
#define STATETREECORE_STATETREEPROPERTYACCESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4F2AC0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyAccess_TypeDefinitionIndex = 28360;

	struct alignas(4) StateTreePropertyAccess
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyAccess_TypeDefinitionIndex)->GetStaticField(0x215B0);
		}
