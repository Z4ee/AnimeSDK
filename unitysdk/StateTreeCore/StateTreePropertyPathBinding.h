...
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA83530)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA83250)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_CREATE_OFFSET UNITYSDK_OFFSET(0x1E861EF0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA83180)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA83770)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA83120)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA837A0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA836C0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA83390)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_RESET_OFFSET UNITYSDK_OFFSET(0xA83700)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHBINDING__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA83530)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E862600)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathBinding_TypeDefinitionIndex = 31002;

	struct alignas(8) StateTreePropertyPathBinding
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathBinding_TypeDefinitionIndex)->GetStaticField(0x25630);
		}
