...
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAD2640)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAD2370)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_CREATE_OFFSET UNITYSDK_OFFSET(0x1FC305A0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAD22A0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAD2880)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xAD2240)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAD28B0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAD27D0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAD24A0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_RESET_OFFSET UNITYSDK_OFFSET(0xAD2810)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHBINDING__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAD2640)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC30CA0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathBinding_TypeDefinitionIndex = 31607;

	struct alignas(8) StateTreePropertyPathBinding
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathBinding_TypeDefinitionIndex)->GetStaticField(0x26EC0);
		}
