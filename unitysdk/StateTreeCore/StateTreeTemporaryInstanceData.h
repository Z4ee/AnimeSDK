...
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA79C30)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA79A20)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1E78ADC0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA79A00)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA79D60)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA79D80)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA79C70)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA79B90)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0xA79CB0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETEMPORARYINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA79C30)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E78B340)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTemporaryInstanceData_TypeDefinitionIndex = 30969;

	struct alignas(8) StateTreeTemporaryInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTemporaryInstanceData_TypeDefinitionIndex)->GetStaticField(0x25410);
		}
