...
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D9030)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9D8E20)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C44E2E0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9D8E00)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9D9160)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x304470)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9D9180)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9D9070)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9D8F90)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x9D90B0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETEMPORARYINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D9030)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C44E860)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTemporaryInstanceData_TypeDefinitionIndex = 28319;

	struct alignas(8) StateTreeTemporaryInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTemporaryInstanceData_TypeDefinitionIndex)->GetStaticField(0x21680);
		}
