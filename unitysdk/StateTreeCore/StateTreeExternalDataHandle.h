...
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xACD160)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x5AE900)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1FBE2250)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xACD0F0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x36DBB0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xACD090)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xACD1E0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xACD160)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x5AE900)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_RESET_OFFSET UNITYSDK_OFFSET(0xACD170)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXTERNALDATAHANDLE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xACD160)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBE2460)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExternalDataHandle_TypeDefinitionIndex = 31541;

	struct alignas(2) StateTreeExternalDataHandle
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExternalDataHandle_TypeDefinitionIndex)->GetStaticField(0x26F50);
		}
