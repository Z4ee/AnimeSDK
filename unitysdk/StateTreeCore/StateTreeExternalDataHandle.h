...
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DB740)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x3B3EF0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4D7230)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DB6D0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x3E5650)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DB670)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DB7C0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9DB740)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x3B3EF0)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_RESET_OFFSET UNITYSDK_OFFSET(0x9DB750)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXTERNALDATAHANDLE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DB740)
#define STATETREECORE_STATETREEEXTERNALDATAHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4D7440)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExternalDataHandle_TypeDefinitionIndex = 28287;

	struct alignas(2) StateTreeExternalDataHandle
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExternalDataHandle_TypeDefinitionIndex)->GetStaticField(0x21A10);
		}
