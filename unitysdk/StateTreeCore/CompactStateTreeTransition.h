...
#define STATETREECORE_COMPACTSTATETREETRANSITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAABEA0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xAABE60)
#define STATETREECORE_COMPACTSTATETREETRANSITION_CREATE_OFFSET UNITYSDK_OFFSET(0x1F6B31A0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xAABE40)
#define STATETREECORE_COMPACTSTATETREETRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_HASDELAY_OFFSET UNITYSDK_OFFSET(0xAABDC0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xAABDE0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xAABF70)
#define STATETREECORE_COMPACTSTATETREETRANSITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xAABEA0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xAABE60)
#define STATETREECORE_COMPACTSTATETREETRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0xAABED0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_UNREALTYPES_ISTRUCT_STATETREECORE_COMPACTSTATETREETRANSITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xAABEA0)
#define STATETREECORE_COMPACTSTATETREETRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F6B3520)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeTransition_TypeDefinitionIndex = 31694;

	struct alignas(4) CompactStateTreeTransition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CompactStateTreeTransition_TypeDefinitionIndex)->GetStaticField(0x26CE0);
		}
