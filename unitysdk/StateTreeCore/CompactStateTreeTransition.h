...
#define STATETREECORE_COMPACTSTATETREETRANSITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9BBD90)
#define STATETREECORE_COMPACTSTATETREETRANSITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9BBD50)
#define STATETREECORE_COMPACTSTATETREETRANSITION_CREATE_OFFSET UNITYSDK_OFFSET(0x1BF47320)
#define STATETREECORE_COMPACTSTATETREETRANSITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9BBD30)
#define STATETREECORE_COMPACTSTATETREETRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_HASDELAY_OFFSET UNITYSDK_OFFSET(0x9BBCB0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9BBCD0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9BBE60)
#define STATETREECORE_COMPACTSTATETREETRANSITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9BBD90)
#define STATETREECORE_COMPACTSTATETREETRANSITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9BBD50)
#define STATETREECORE_COMPACTSTATETREETRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x9BBDC0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_UNREALTYPES_ISTRUCT_STATETREECORE_COMPACTSTATETREETRANSITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9BBD90)
#define STATETREECORE_COMPACTSTATETREETRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF476A0)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeTransition_TypeDefinitionIndex = 28420;

	struct alignas(4) CompactStateTreeTransition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CompactStateTreeTransition_TypeDefinitionIndex)->GetStaticField(0x217D0);
		}
