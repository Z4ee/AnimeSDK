...
#define STATETREECORE_COMPACTSTATETREESTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D8C80)
#define STATETREECORE_COMPACTSTATETREESTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9D8C10)
#define STATETREECORE_COMPACTSTATETREESTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C44CA60)
#define STATETREECORE_COMPACTSTATETREESTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9D8B00)
#define STATETREECORE_COMPACTSTATETREESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0x9D8A90)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_NEXTSIBLING_OFFSET UNITYSDK_OFFSET(0x7A04C0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9D8AA0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9D8DA0)
#define STATETREECORE_COMPACTSTATETREESTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9D8C80)
#define STATETREECORE_COMPACTSTATETREESTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9D8C10)
#define STATETREECORE_COMPACTSTATETREESTATE_RESET_OFFSET UNITYSDK_OFFSET(0x9D8CD0)
#define STATETREECORE_COMPACTSTATETREESTATE_UNREALTYPES_ISTRUCT_STATETREECORE_COMPACTSTATETREESTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9D8C80)
#define STATETREECORE_COMPACTSTATETREESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C44CEC0)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeState_TypeDefinitionIndex = 28422;

	struct alignas(8) CompactStateTreeState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CompactStateTreeState_TypeDefinitionIndex)->GetStaticField(0x215D0);
		}
