...
#define STATETREECORE_COMPACTSTATETREESTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA79880)
#define STATETREECORE_COMPACTSTATETREESTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0xA79810)
#define STATETREECORE_COMPACTSTATETREESTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1E7893A0)
#define STATETREECORE_COMPACTSTATETREESTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA79700)
#define STATETREECORE_COMPACTSTATETREESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0xA79690)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_NEXTSIBLING_OFFSET UNITYSDK_OFFSET(0x5F4600)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA796A0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA799A0)
#define STATETREECORE_COMPACTSTATETREESTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0xA79880)
#define STATETREECORE_COMPACTSTATETREESTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0xA79810)
#define STATETREECORE_COMPACTSTATETREESTATE_RESET_OFFSET UNITYSDK_OFFSET(0xA798D0)
#define STATETREECORE_COMPACTSTATETREESTATE_UNREALTYPES_ISTRUCT_STATETREECORE_COMPACTSTATETREESTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA79880)
#define STATETREECORE_COMPACTSTATETREESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E789800)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeState_TypeDefinitionIndex = 31077;

	struct alignas(8) CompactStateTreeState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CompactStateTreeState_TypeDefinitionIndex)->GetStaticField(0x25350);
		}
