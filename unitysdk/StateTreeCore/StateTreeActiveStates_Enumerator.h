...
#define STATETREECORE_STATETREEACTIVESTATES_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADAD90)
#define STATETREECORE_STATETREEACTIVESTATES_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADADA0)
#define STATETREECORE_STATETREEACTIVESTATES_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xADAD80)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeActiveStates_Enumerator_TypeDefinitionIndex = 31549;
