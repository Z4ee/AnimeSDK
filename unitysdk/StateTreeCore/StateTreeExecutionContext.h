...
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_ADDTEMPORARYINSTANCE_OFFSET UNITYSDK_OFFSET(0xA7C8A0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_APPENDINSTANCESTRUCT_OFFSET UNITYSDK_OFFSET(0x1ED84E70)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_COPYBATCHONACTIVEINSTANCES_OFFSET UNITYSDK_OFFSET(0xA7CA20)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_COPYBATCHWITHVALIDATION_OFFSET UNITYSDK_OFFSET(0xA7CA60)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_DEBUGGETSTATEPATH_OFFSET UNITYSDK_OFFSET(0xA7CAB0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA7C380)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xA7C5D0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xA7C5C0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_FORMATINDENTSTRING_OFFSET UNITYSDK_OFFSET(0x1ED87E90)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETDATAVIEWORTEMPORARY_OFFSET UNITYSDK_OFFSET(0xA7C860)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETDATAVIEW_1_OFFSET UNITYSDK_OFFSET(0x1ED867D0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETDATAVIEW_OFFSET UNITYSDK_OFFSET(0xA7C730)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSAFESTATENAME_OFFSET UNITYSDK_OFFSET(0x1ED87D40)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSTATEFROMHANDLE_OFFSET UNITYSDK_OFFSET(0xA7C320)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSTATESTATUSSTRING_OFFSET UNITYSDK_OFFSET(0x1ED88740)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSTATETREERUNSTATUS_OFFSET UNITYSDK_OFFSET(0xA7C540)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_CURRENTLYPROCESSEDFRAME_OFFSET UNITYSDK_OFFSET(0x9679E0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_CURRENTLYPROCESSEDPARENTFRAME_OFFSET UNITYSDK_OFFSET(0xA7C310)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_CURRENTLYPROCESSEDSTATE_OFFSET UNITYSDK_OFFSET(0xA7C300)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_INSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xA7C240)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_LOGINSTANCEID_OFFSET UNITYSDK_OFFSET(0xA7C260)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_STATEPATH_OFFSET UNITYSDK_OFFSET(0x1ED87EB0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_STATETREENAME_OFFSET UNITYSDK_OFFSET(0xA7C270)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_STATETREE_OFFSET UNITYSDK_OFFSET(0x259D70)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_HASEVENTTOPROCESS_OFFSET UNITYSDK_OFFSET(0xA7C720)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_ISHANDLESOURCEVALID_OFFSET UNITYSDK_OFFSET(0xA7C830)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_MEMSWAP_OFFSET UNITYSDK_OFFSET(0x1ED850C0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_SETCONTEXTDATABYNAME_OFFSET UNITYSDK_OFFSET(0xA7C410)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_SETGLOBALPARAMETERS_OFFSET UNITYSDK_OFFSET(0xA7CAA0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_SETUPNEXTTRANSITION_OFFSET UNITYSDK_OFFSET(0xA7C610)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STARTGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0xA7C570)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STARTTEMPORARYGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x4ED2C0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xA7C5B0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STOPGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0xA7C580)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STOPTEMPORARYGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_TESTALLCONDITIONS_OFFSET UNITYSDK_OFFSET(0xA7C710)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_TICKGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0xA7C590)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_TICKTASKS_OFFSET UNITYSDK_OFFSET(0xA7C5A0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_UPDATEINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0xA7C5E0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C370)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT__UPDATEINSTANCEDATA_G__FINDINSTANCETEMPDATA_52_0_OFFSET UNITYSDK_OFFSET(0x1ED84C30)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionContext_TypeDefinitionIndex = 31531;
	...
	struct alignas(8) StateTreeExecutionContext
	{
		...
		::StateTreeCore::StateTree& get_StateTree()
		{
			return ((::StateTreeCore::StateTree&(*)(::PVOID))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_STATETREE_OFFSET))(this);
		}
		...
		::StateTreeCore::StateTreeStateHandle get_CurrentlyProcessedState()
		{
			return ((::StateTreeCore::StateTreeStateHandle(*)(::PVOID))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_CURRENTLYPROCESSEDSTATE_OFFSET))(this);
		}
		...
		/*
		::UnrealTypes::ReadOnlyRawPtr_1<::StateTreeCore::CompactStateTreeState> GetStateFromHandle(::StateTreeCore::StateTreeStateHandle stateHandle)
		{
			return ((::UnrealTypes::ReadOnlyRawPtr_1<::StateTreeCore::CompactStateTreeState>(*)(::PVOID, ::StateTreeCore::StateTreeStateHandle))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSTATEFROMHANDLE_OFFSET))(this, stateHandle);
		}
		*/
		...
		/*
		::System::Boolean SetContextDataByName(::Foundation::Unreal::FName name, ::StateTreeCore::StateTreeDataView dataView)
		{
			return ((::System::Boolean(*)(::PVOID, ::Foundation::Unreal::FName, ::StateTreeCore::StateTreeDataView))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT_SETCONTEXTDATABYNAME_OFFSET))(this, name, dataView);
		}
		*/
		...
		*/
		...
		static ::System::Void MemSwap(::System::Void* destination, ::System::Void* source, ::System::Int32 size)
		{
			return ((::System::Void(*)(::System::Void*, ::System::Void*, ::System::Int32))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT_MEMSWAP_OFFSET))(destination, source, size);
		}
		...
		*/
		...
		/*
		::System::Boolean SetGlobalParameters(::UnrealTypes::FInstancedPropertyBag& parameters)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnrealTypes::FInstancedPropertyBag&))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT_SETGLOBALPARAMETERS_OFFSET))(this, parameters);
		}
		*/
		...
		*/
		...
		/*
		static ::UnrealTypes::RawPtr_1<::UnrealTypes::FInstancedStruct> _UpdateInstanceData_g__FindInstanceTempData_52_0(::StateTreeCore::StateTreeExecutionFrame& frame, ::StateTreeCore::StateTreeDataHandle dataHandle, ::StateTreeCore::StateTreeExecutionContext___c__DisplayClass52_0& a3)
		{
			return ((::UnrealTypes::RawPtr_1<::UnrealTypes::FInstancedStruct>(*)(::StateTreeCore::StateTreeExecutionFrame&, ::StateTreeCore::StateTreeDataHandle, ::StateTreeCore::StateTreeExecutionContext___c__DisplayClass52_0&))((::PBYTE)hIl2Cpp + STATETREECORE_STATETREEEXECUTIONCONTEXT__UPDATEINSTANCEDATA_G__FINDINSTANCETEMPDATA_52_0_OFFSET))(frame, dataHandle, a3);
		}
		*/
	};
}
