...
#define CLASS_1_714A2A6E232161AB_METHOD_1_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xE047090)
#define CLASS_1_714A2A6E232161AB__CTOR_OFFSET UNITYSDK_OFFSET(0xE047080)
...
{
public:
	::RPG::Client::GlobalDispatchData_ServerData* APPIHABBCGK; // 0x10
	::System::Action* DPANHIICMLD; // 0x18
