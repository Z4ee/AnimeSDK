...
#define CLASS_2_86E714D53F8D6B2B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195DDC70)
#define CLASS_2_86E714D53F8D6B2B_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x195DE0F0)
#define CLASS_2_86E714D53F8D6B2B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x195DDF20)
#define CLASS_2_86E714D53F8D6B2B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x195DE180)
#define CLASS_2_86E714D53F8D6B2B_TICK_OFFSET UNITYSDK_OFFSET(0x195DE1D0)
#define CLASS_2_86E714D53F8D6B2B__CTOR_OFFSET UNITYSDK_OFFSET(0x195DDAA0)

inline static constexpr unsigned int Class_2_86E714D53F8D6B2B_TypeDefinitionIndex = 55875;

class Class_2_86E714D53F8D6B2B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_07C3C4D2990C49EE* CFPDPMEKCPJ; // 0x18
	::Class_3_07C3C4D2990C49EE* ELJLJDKNFKE; // 0x20
	::Class_3_07C3C4D2990C49EE* EAJNBAKNEIG; // 0x28
	::Class_3_07C3C4D2990C49EE* JPMOKOKJEJC; // 0x30
	::RPG::GameCore::SwitchChallengeTurnLimitType* OFKGLJOAMLD; // 0x38
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x40
	::Class_3_07C3C4D2990C49EE* MMOICOEJACI; // 0x48
