...
#define CLASS_2_86E714D53F8D6B2B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB955C80)
#define CLASS_2_86E714D53F8D6B2B_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xB956100)
#define CLASS_2_86E714D53F8D6B2B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB955F30)
#define CLASS_2_86E714D53F8D6B2B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB956190)
#define CLASS_2_86E714D53F8D6B2B_TICK_OFFSET UNITYSDK_OFFSET(0xB9561E0)
#define CLASS_2_86E714D53F8D6B2B__CTOR_OFFSET UNITYSDK_OFFSET(0xB955AB0)
...
{
public:
	::Class_3_07C3C4D2990C49EE* ELJLJDKNFKE; // 0x18
	::Class_3_07C3C4D2990C49EE* CFPDPMEKCPJ; // 0x20
	::Class_3_07C3C4D2990C49EE* MMOICOEJACI; // 0x28
	::RPG::GameCore::SwitchChallengeTurnLimitType* OFKGLJOAMLD; // 0x30
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x38
	::Class_3_07C3C4D2990C49EE* JPMOKOKJEJC; // 0x40
	::Class_3_07C3C4D2990C49EE* EAJNBAKNEIG; // 0x48
