...
#define UNITYENGINEINTERNAL_GENERICSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49B860)

namespace UnityEngineInternal
{
	inline static constexpr unsigned int GenericStack_TypeDefinitionIndex = 3734;
