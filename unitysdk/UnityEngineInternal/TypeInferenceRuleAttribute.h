...
#define UNITYENGINEINTERNAL_TYPEINFERENCERULEATTRIBUTE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D22DBB0)
#define UNITYENGINEINTERNAL_TYPEINFERENCERULEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D22DBA0)
#define UNITYENGINEINTERNAL_TYPEINFERENCERULEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22DAD0)

namespace UnityEngineInternal
{
	inline static constexpr unsigned int TypeInferenceRuleAttribute_TypeDefinitionIndex = 3911;
