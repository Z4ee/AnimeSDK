...
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_ALLOCATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1FC61780)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_GET_CURRENTTIMEOFFSETTOREALTIMESINCESTARTUP_OFFSET UNITYSDK_OFFSET(0x1FC61770)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1FC61760)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_GET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1FC61110)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_IOCTL_OFFSET UNITYSDK_OFFSET(0x1FC617A0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_NOTIFYBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1FC61200)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_NOTIFYDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1FC61640)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_NOTIFYUPDATE_OFFSET UNITYSDK_OFFSET(0x1FC61290)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_QUEUEINPUTEVENT_OFFSET UNITYSDK_OFFSET(0x1FC61790)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SETPOLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1FC617B0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SET_HASDEVICEDISCOVEREDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1FC611E0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1FC61170)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1FC616D0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FC617C0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC611F0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC617D0)

namespace UnityEngineInternal::Input
{
	inline static constexpr unsigned int NativeInputSystem_TypeDefinitionIndex = 28029;
	...
	public:
		...
		{
			return (::System::Func_2<::UnityEngineInternal::Input::NativeInputUpdateType, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x23C30);
		}
		static ::System::Action_1<::UnityEngineInternal::Input::NativeInputUpdateType>** StaticGet_onBeforeUpdate()
		{
			return (::System::Action_1<::UnityEngineInternal::Input::NativeInputUpdateType>**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x23C38);
		}
		static ::System::Action_2<::System::Int32, ::System::String*>** StaticGet_s_OnDeviceDiscoveredCallback()
		{
			return (::System::Action_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x23C40);
		}
		static ::UnityEngineInternal::Input::NativeUpdateCallback** StaticGet_onUpdate()
		{
			return (::UnityEngineInternal::Input::NativeUpdateCallback**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x23C48);
		}
