...
#define CLASS_1_126415C60CEDDA17_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A41B900)
#define CLASS_1_126415C60CEDDA17_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1A41B600)
#define CLASS_1_126415C60CEDDA17_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A41B770)
#define CLASS_1_126415C60CEDDA17_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A41B6C0)
#define CLASS_1_126415C60CEDDA17_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A41B7E0)
#define CLASS_1_126415C60CEDDA17_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A41BA40)
#define CLASS_1_126415C60CEDDA17_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A41BA00)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1A41B6B0)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A41B540)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A41B690)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1A41B6A0)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A41B680)
#define CLASS_1_126415C60CEDDA17_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A41B5A0)
#define CLASS_1_126415C60CEDDA17_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A41B820)
#define CLASS_1_126415C60CEDDA17_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A41B880)
#define CLASS_1_126415C60CEDDA17_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A41BBC0)
#define CLASS_1_126415C60CEDDA17_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A41B5C0)
#define CLASS_1_126415C60CEDDA17_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41B5B0)

inline static constexpr unsigned int Class_1_126415C60CEDDA17_1_TypeDefinitionIndex = 30079;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_126415C60CEDDA17_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_126415C60CEDDA17_1_TypeDefinitionIndex)->GetStaticField(0x640D0);
	}
