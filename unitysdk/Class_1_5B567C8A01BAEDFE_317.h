...
#define CLASS_1_5B567C8A01BAEDFE_317_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19309C10)
#define CLASS_1_5B567C8A01BAEDFE_317_CLONE_OFFSET UNITYSDK_OFFSET(0x19309A80)
#define CLASS_1_5B567C8A01BAEDFE_317_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19309B20)
#define CLASS_1_5B567C8A01BAEDFE_317_EQUALS_OFFSET UNITYSDK_OFFSET(0x19309AC0)
#define CLASS_1_5B567C8A01BAEDFE_317_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19309B70)
#define CLASS_1_5B567C8A01BAEDFE_317_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19309C60)
#define CLASS_1_5B567C8A01BAEDFE_317_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19309C30)
#define CLASS_1_5B567C8A01BAEDFE_317_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19309A00)
#define CLASS_1_5B567C8A01BAEDFE_317_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19309A30)
#define CLASS_1_5B567C8A01BAEDFE_317_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19309BA0)
#define CLASS_1_5B567C8A01BAEDFE_317_WRITETO_OFFSET UNITYSDK_OFFSET(0x19309C00)
#define CLASS_1_5B567C8A01BAEDFE_317__CCTOR_OFFSET UNITYSDK_OFFSET(0x19309CB0)
#define CLASS_1_5B567C8A01BAEDFE_317__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19309A50)
#define CLASS_1_5B567C8A01BAEDFE_317__CTOR_OFFSET UNITYSDK_OFFSET(0x19309A40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_317_TypeDefinitionIndex = 31617;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_317*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_317_TypeDefinitionIndex)->GetStaticField(0x5F940);
	}
