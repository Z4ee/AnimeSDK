...
#define MONO_RUNTIMEGENERICPARAMINFOHANDLE_GETCONSTRAINTSCOUNT_OFFSET UNITYSDK_OFFSET(0x38F05B0)
#define MONO_RUNTIMEGENERICPARAMINFOHANDLE_GETCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x38F0580)
#define MONO_RUNTIMEGENERICPARAMINFOHANDLE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x38F0590)
#define MONO_RUNTIMEGENERICPARAMINFOHANDLE_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x38F0580)
#define MONO_RUNTIMEGENERICPARAMINFOHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x164FF0)

namespace Mono
{
	inline static constexpr unsigned int RuntimeGenericParamInfoHandle_TypeDefinitionIndex = 7;
	...
	struct alignas(8) RuntimeGenericParamInfoHandle
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::IntPtr))((::PBYTE)hIl2Cpp + MONO_RUNTIMEGENERICPARAMINFOHANDLE__CTOR_OFFSET))(this, a1);
		}
