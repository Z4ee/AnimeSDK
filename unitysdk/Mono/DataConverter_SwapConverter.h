...
#define MONO_DATACONVERTER_SWAPCONVERTER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1AC40130)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1AC40610)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT16_OFFSET UNITYSDK_OFFSET(0x1AC40A00)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT32_OFFSET UNITYSDK_OFFSET(0x1AC40760)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT64_OFFSET UNITYSDK_OFFSET(0x1AC40470)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x1AC40B20)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x1AC408B0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x1AC402D0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_1_OFFSET UNITYSDK_OFFSET(0x1AC40CD0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_2_OFFSET UNITYSDK_OFFSET(0x1AC40D40)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_3_OFFSET UNITYSDK_OFFSET(0x1AC40DB0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_4_OFFSET UNITYSDK_OFFSET(0x1AC40E20)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_5_OFFSET UNITYSDK_OFFSET(0x1AC40EB0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_6_OFFSET UNITYSDK_OFFSET(0x1AC40F40)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_7_OFFSET UNITYSDK_OFFSET(0x1AC40FA0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x1AC40C40)
#define MONO_DATACONVERTER_SWAPCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC41000)
