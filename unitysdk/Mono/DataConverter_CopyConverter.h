...
#define MONO_DATACONVERTER_COPYCONVERTER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B912750)
#define MONO_DATACONVERTER_COPYCONVERTER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B912C30)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT16_OFFSET UNITYSDK_OFFSET(0x1B913020)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT32_OFFSET UNITYSDK_OFFSET(0x1B912D80)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT64_OFFSET UNITYSDK_OFFSET(0x1B912A90)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x1B913140)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x1B912ED0)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x1B9128F0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_1_OFFSET UNITYSDK_OFFSET(0x1B9132C0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_2_OFFSET UNITYSDK_OFFSET(0x1B913320)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_3_OFFSET UNITYSDK_OFFSET(0x1B913370)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_4_OFFSET UNITYSDK_OFFSET(0x1B9133C0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_5_OFFSET UNITYSDK_OFFSET(0x1B913410)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_6_OFFSET UNITYSDK_OFFSET(0x1B913460)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_7_OFFSET UNITYSDK_OFFSET(0x1B9134B0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x1B913260)
#define MONO_DATACONVERTER_COPYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B913500)
