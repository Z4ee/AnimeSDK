...
#define MONO_RUNTIMEEVENTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B5FCD0)
#define MONO_RUNTIMEEVENTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5F00)
#define MONO_RUNTIMEEVENTHANDLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define MONO_RUNTIMEEVENTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC610)
