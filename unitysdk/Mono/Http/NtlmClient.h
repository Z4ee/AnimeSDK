...
#define MONO_HTTP_NTLMCLIENT_AUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1C003340)
#define MONO_HTTP_NTLMCLIENT_GET_AUTHENTICATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1C0036E0)
#define MONO_HTTP_NTLMCLIENT_GET_CANPREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1C003720)
#define MONO_HTTP_NTLMCLIENT_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1C0036D0)
#define MONO_HTTP_NTLMCLIENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C003740)
#define MONO_HTTP_NTLMCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C003730)

namespace Mono::Http
{
	inline static constexpr unsigned int NtlmClient_TypeDefinitionIndex = 2648;
	...
	public:
		...
		{
			return (::System::Runtime::CompilerServices::ConditionalWeakTable_2<::System::Net::HttpWebRequest*, ::Mono::Http::NtlmSession*>**)Il2CppClass::FromTypeDefinitionIndex(NtlmClient_TypeDefinitionIndex)->GetStaticField(0x2D10);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MONO_HTTP_NTLMCLIENT_GET_CANPREAUTHENTICATE_OFFSET))(this);
		}
	};
}
