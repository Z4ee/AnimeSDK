...
#define MONO_SECURITY_ASN1_ADD_OFFSET UNITYSDK_OFFSET(0x1E03B240)
#define MONO_SECURITY_ASN1_COMPAREARRAY_OFFSET UNITYSDK_OFFSET(0x1E03B0E0)
#define MONO_SECURITY_ASN1_COMPAREVALUE_OFFSET UNITYSDK_OFFSET(0x1E03B1D0)
#define MONO_SECURITY_ASN1_DECODETLV_OFFSET UNITYSDK_OFFSET(0x1E03BAB0)
#define MONO_SECURITY_ASN1_DECODE_OFFSET UNITYSDK_OFFSET(0x1E03AC60)
#define MONO_SECURITY_ASN1_ELEMENT_OFFSET UNITYSDK_OFFSET(0x1E03BD00)
#define MONO_SECURITY_ASN1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E03B150)
#define MONO_SECURITY_ASN1_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1E03B300)
#define MONO_SECURITY_ASN1_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E03AE50)
#define MONO_SECURITY_ASN1_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1E03BBE0)
#define MONO_SECURITY_ASN1_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E03AE80)
#define MONO_SECURITY_ASN1_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1E03AE70)
#define MONO_SECURITY_ASN1_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E03AE90)
#define MONO_SECURITY_ASN1_SAVETOFILE_OFFSET UNITYSDK_OFFSET(0x1E03C4F0)
#define MONO_SECURITY_ASN1_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E03AFB0)
#define MONO_SECURITY_ASN1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E03BE30)
#define MONO_SECURITY_ASN1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E03AAA0)
#define MONO_SECURITY_ASN1__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E03AA90)
#define MONO_SECURITY_ASN1__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E03AAB0)
#define MONO_SECURITY_ASN1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E03AA80)

namespace Mono::Security
{
	inline static constexpr unsigned int ASN1_TypeDefinitionIndex = 2271;
