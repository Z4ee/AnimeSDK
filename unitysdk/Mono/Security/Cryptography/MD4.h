...
#define MONO_SECURITY_CRYPTOGRAPHY_MD4_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1BD9B9B0)
#define MONO_SECURITY_CRYPTOGRAPHY_MD4_CREATE_OFFSET UNITYSDK_OFFSET(0x1BD9B960)
#define MONO_SECURITY_CRYPTOGRAPHY_MD4__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD9B950)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int MD4_TypeDefinitionIndex = 2459;
