...
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_ADD_KEYGENERATED_OFFSET UNITYSDK_OFFSET(0x18B7F8C0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_ADD_OFFSET UNITYSDK_OFFSET(0x18B7DFE0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x18B7EE40)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B7CC00)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_EXPORTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x18B7E480)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18B7CAB0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GENERATEKEYPAIR_OFFSET UNITYSDK_OFFSET(0x18B7DBC0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GENERATEPARAMS_OFFSET UNITYSDK_OFFSET(0x18B7D0C0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GENERATE_OFFSET UNITYSDK_OFFSET(0x18B7D080)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GET_KEYEXCHANGEALGORITHM_OFFSET UNITYSDK_OFFSET(0x18B7E340)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GET_KEYSIZE_OFFSET UNITYSDK_OFFSET(0x18B7E310)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GET_PUBLICONLY_OFFSET UNITYSDK_OFFSET(0x18B7E350)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GET_RANDOM_OFFSET UNITYSDK_OFFSET(0x18B7E100)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x18B7E3B0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_IMPORTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x18B7EAC0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_NORMALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x18B7E3F0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_REMOVE_KEYGENERATED_OFFSET UNITYSDK_OFFSET(0x18B7F940)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x18B7F2F0)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B7CA20)
#define MONO_SECURITY_CRYPTOGRAPHY_DSAMANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7CA10)
...
namespace Mono::Security::Cryptography
{
	...
	{
	public:
		::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler* KeyGenerated; // 0x20
		::Mono::Math::BigInteger* j; // 0x28
		::Mono::Math::BigInteger* seed; // 0x30
		::Mono::Math::BigInteger* q; // 0x38
		::System::Security::Cryptography::RandomNumberGenerator* rng; // 0x40
		::Mono::Math::BigInteger* p; // 0x48
		::Mono::Math::BigInteger* g; // 0x50
