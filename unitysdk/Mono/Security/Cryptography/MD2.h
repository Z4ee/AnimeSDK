...
#define MONO_SECURITY_CRYPTOGRAPHY_MD2_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1E0E3850)
#define MONO_SECURITY_CRYPTOGRAPHY_MD2_CREATE_OFFSET UNITYSDK_OFFSET(0x1E0E3800)
#define MONO_SECURITY_CRYPTOGRAPHY_MD2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E37F0)
