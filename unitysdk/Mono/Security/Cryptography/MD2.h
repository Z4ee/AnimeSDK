...
#define MONO_SECURITY_CRYPTOGRAPHY_MD2_CREATE_OFFSET UNITYSDK_OFFSET(0x1613C7B0)
#define MONO_SECURITY_CRYPTOGRAPHY_MD2__CTOR_OFFSET UNITYSDK_OFFSET(0x1613C7A0)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int MD2_TypeDefinitionIndex = 2290;
