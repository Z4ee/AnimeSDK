...
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C482800)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1C482780)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1C482650)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C482600)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C482920)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C482570)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int MD5SHA1_TypeDefinitionIndex = 2461;
