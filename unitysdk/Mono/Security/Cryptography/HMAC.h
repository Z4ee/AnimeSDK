...
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1E703C90)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1E704610)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1E704470)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_INITIALIZEPAD_OFFSET UNITYSDK_OFFSET(0x1E703F20)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E704290)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1E703D90)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7042D0)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7040D0)
...
namespace Mono::Security::Cryptography
{
	...
	{
	public:
		::Il2CppArray<::System::Byte>* innerPad; // 0x30
