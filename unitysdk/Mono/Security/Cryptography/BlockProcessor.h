...
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_CORE_1_OFFSET UNITYSDK_OFFSET(0x1FBD4E20)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_CORE_OFFSET UNITYSDK_OFFSET(0x1FBD4E00)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1FBD4D60)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_FINAL_OFFSET UNITYSDK_OFFSET(0x1FBD50C0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1FBD4DD0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBD4CA0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBD4B60)
...
namespace Mono::Security::Cryptography
{
	...
	{
	public:
		::Il2CppArray<::System::Byte>* block; // 0x10
		::System::Security::Cryptography::ICryptoTransform* transform; // 0x18
		::System::Int32 blockSize; // 0x20
		::System::Int32 blockCount; // 0x24
