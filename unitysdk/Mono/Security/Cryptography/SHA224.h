...
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B778020)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224_CREATE_OFFSET UNITYSDK_OFFSET(0x1B777EF0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224__CTOR_OFFSET UNITYSDK_OFFSET(0x1B777EE0)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int SHA224_TypeDefinitionIndex = 2471;
