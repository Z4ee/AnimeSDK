...
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_DECODE_OFFSET UNITYSDK_OFFSET(0x18525F10)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_ALGORITHM_OFFSET UNITYSDK_OFFSET(0x185263B0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_ENCRYPTEDDATA_OFFSET UNITYSDK_OFFSET(0x185263C0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x185265D0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_SALT_OFFSET UNITYSDK_OFFSET(0x185264A0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18525F00)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18525EF0)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int PKCS8_EncryptedPrivateKeyInfo_TypeDefinitionIndex = 2298;
