...
#define MONO_SECURITY_CRYPTOGRAPHY_SHACONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBC7B60)
#define MONO_SECURITY_CRYPTOGRAPHY_SHACONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC7B50)
