...
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_ADD_KEYGENERATED_OFFSET UNITYSDK_OFFSET(0x1E0E8320)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_DECRYPTVALUE_OFFSET UNITYSDK_OFFSET(0x1E0E7040)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E0E62F0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_ENCRYPTVALUE_OFFSET UNITYSDK_OFFSET(0x1E0E7810)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_EXPORTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E0E79F0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E0E6280)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GENERATEKEYPAIR_OFFSET UNITYSDK_OFFSET(0x1E0E67F0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GETPADDEDVALUE_OFFSET UNITYSDK_OFFSET(0x1E0E7770)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GET_ISCRTPOSSIBLE_OFFSET UNITYSDK_OFFSET(0x1E0E8A40)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GET_KEYEXCHANGEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1E0E6F30)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GET_KEYSIZE_OFFSET UNITYSDK_OFFSET(0x1E0E6EA0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GET_PUBLICONLY_OFFSET UNITYSDK_OFFSET(0x1E0E6F70)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x1E0E7000)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_GET_USEKEYBLINDING_OFFSET UNITYSDK_OFFSET(0x1E0E8A20)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_IMPORTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E0E7D70)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_REMOVE_KEYGENERATED_OFFSET UNITYSDK_OFFSET(0x1E0E83A0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_SET_USEKEYBLINDING_OFFSET UNITYSDK_OFFSET(0x1E0E8A30)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1E0E8420)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E0E61E0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E61D0)
...
namespace Mono::Security::Cryptography
{
	...
	public:
		...
		::System::Boolean keyBlinding; // 0x6A
		::System::Boolean isCRTpossible; // 0x6B
