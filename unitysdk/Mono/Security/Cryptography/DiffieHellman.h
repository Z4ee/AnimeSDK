...
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1D3620F0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_OFFSET UNITYSDK_OFFSET(0x1D362050)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_FROMXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1D3621B0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_GETNAMEDPARAM_OFFSET UNITYSDK_OFFSET(0x1D362170)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1D3625E0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3629C0)
