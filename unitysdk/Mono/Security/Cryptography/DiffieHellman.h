...
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AF519E0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_OFFSET UNITYSDK_OFFSET(0x1AF51940)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_FROMXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1AF51AA0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_GETNAMEDPARAM_OFFSET UNITYSDK_OFFSET(0x1AF51A60)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1AF51ED0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF522B0)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int DiffieHellman_TypeDefinitionIndex = 2454;
