...
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_ADDLENGTH_OFFSET UNITYSDK_OFFSET(0x1C480D30)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_CH_OFFSET UNITYSDK_OFFSET(0x1C480290)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1C480330)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1C4809C0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C480180)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_MAJ_OFFSET UNITYSDK_OFFSET(0x1C4802A0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_PROCESSBLOCK_OFFSET UNITYSDK_OFFSET(0x1C480410)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_PROCESSFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1C480B30)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_RO0_OFFSET UNITYSDK_OFFSET(0x1C4802B0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_RO1_OFFSET UNITYSDK_OFFSET(0x1C4802D0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_SIG0_OFFSET UNITYSDK_OFFSET(0x1C4802F0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_SIG1_OFFSET UNITYSDK_OFFSET(0x1C480310)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C480100)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int SHA224Managed_TypeDefinitionIndex = 2472;
