...
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B775190)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_CREATEFROMNAME_OFFSET UNITYSDK_OFFSET(0x1B776BE0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_CREATEFROMOID_OFFSET UNITYSDK_OFFSET(0x1B777870)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_DECRYPT_OAEP_OFFSET UNITYSDK_OFFSET(0x1B775BF0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_DECRYPT_V15_OFFSET UNITYSDK_OFFSET(0x1B7761B0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_ENCODE_V15_OFFSET UNITYSDK_OFFSET(0x1B7764E0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_ENCRYPT_OAEP_OFFSET UNITYSDK_OFFSET(0x1B775720)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_ENCRYPT_V15_OFFSET UNITYSDK_OFFSET(0x1B775F80)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_GETEMPTYHASH_OFFSET UNITYSDK_OFFSET(0x1B7752C0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_HASHNAMEFROMOID_OFFSET UNITYSDK_OFFSET(0x1B777570)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_I2OSP_1_OFFSET UNITYSDK_OFFSET(0x1B775510)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_I2OSP_OFFSET UNITYSDK_OFFSET(0x1B775440)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_MGF1_OFFSET UNITYSDK_OFFSET(0x1B775A30)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_OS2IP_OFFSET UNITYSDK_OFFSET(0x1B775590)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSADP_OFFSET UNITYSDK_OFFSET(0x1B775690)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSAEP_OFFSET UNITYSDK_OFFSET(0x1B775660)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSASP1_OFFSET UNITYSDK_OFFSET(0x1B7756C0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSAVP1_OFFSET UNITYSDK_OFFSET(0x1B7756F0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_SIGN_V15_1_OFFSET UNITYSDK_OFFSET(0x1B776AD0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_SIGN_V15_OFFSET UNITYSDK_OFFSET(0x1B7763D0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_VERIFY_V15_1_OFFSET UNITYSDK_OFFSET(0x1B777450)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_VERIFY_V15_2_OFFSET UNITYSDK_OFFSET(0x1B777160)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_VERIFY_V15_OFFSET UNITYSDK_OFFSET(0x1B7770E0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_XOR_OFFSET UNITYSDK_OFFSET(0x1B775200)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7778D0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B775180)

namespace Mono::Security::Cryptography
{
	inline static constexpr unsigned int PKCS1_TypeDefinitionIndex = 2462;
