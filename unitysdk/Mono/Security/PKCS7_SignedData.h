...
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1F3F3F80)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1F3F5B20)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1F3F3F70)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1F3F53A0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1F3F53B0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1F3F53C0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1F3F53D0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_SIGNERINFO_OFFSET UNITYSDK_OFFSET(0x1F3F53E0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_USEAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1F3F5410)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1F3F53F0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_OIDTONAME_OFFSET UNITYSDK_OFFSET(0x1F3F3DC0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1F3F3F50)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_USEAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1F3F5420)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1F3F5400)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1F3F5430)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F3F35E0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F3F3640)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3F3410)
...
namespace Mono::Security
{
	...
	public:
		...
		::Mono::Security::PKCS7_ContentInfo* contentInfo; // 0x30
