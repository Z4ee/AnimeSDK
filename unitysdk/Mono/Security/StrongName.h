...
#define MONO_SECURITY_STRONGNAME_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1D369120)
#define MONO_SECURITY_STRONGNAME_GET_CANSIGN_OFFSET UNITYSDK_OFFSET(0x1D3685B0)
#define MONO_SECURITY_STRONGNAME_GET_PUBLICKEYTOKEN_OFFSET UNITYSDK_OFFSET(0x1D368D80)
#define MONO_SECURITY_STRONGNAME_GET_PUBLICKEY_OFFSET UNITYSDK_OFFSET(0x1D3687E0)
#define MONO_SECURITY_STRONGNAME_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1D368780)
#define MONO_SECURITY_STRONGNAME_GET_TOKENALGORITHM_OFFSET UNITYSDK_OFFSET(0x1D368FD0)
#define MONO_SECURITY_STRONGNAME_HASH_OFFSET UNITYSDK_OFFSET(0x1D369C50)
#define MONO_SECURITY_STRONGNAME_INVALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1D368590)
#define MONO_SECURITY_STRONGNAME_RVATOPOSITION_OFFSET UNITYSDK_OFFSET(0x1D369190)
#define MONO_SECURITY_STRONGNAME_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1D3684F0)
#define MONO_SECURITY_STRONGNAME_SET_TOKENALGORITHM_OFFSET UNITYSDK_OFFSET(0x1D369020)
#define MONO_SECURITY_STRONGNAME_SIGN_OFFSET UNITYSDK_OFFSET(0x1D369D00)
#define MONO_SECURITY_STRONGNAME_STRONGHASH_OFFSET UNITYSDK_OFFSET(0x1D369260)
#define MONO_SECURITY_STRONGNAME_VERIFY_1_OFFSET UNITYSDK_OFFSET(0x1D36A310)
#define MONO_SECURITY_STRONGNAME_VERIFY_2_OFFSET UNITYSDK_OFFSET(0x1D36A440)
#define MONO_SECURITY_STRONGNAME_VERIFY_OFFSET UNITYSDK_OFFSET(0x1D36A1E0)
#define MONO_SECURITY_STRONGNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D3682C0)
#define MONO_SECURITY_STRONGNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D368310)
#define MONO_SECURITY_STRONGNAME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D368510)
#define MONO_SECURITY_STRONGNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3682B0)
...
namespace Mono::Security
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* publicKey; // 0x18
		::System::String* tokenAlgorithm; // 0x20
