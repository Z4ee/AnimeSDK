...
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_CLIFLAGPOSITION_OFFSET UNITYSDK_OFFSET(0x1E54C040)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_CLIFLAG_OFFSET UNITYSDK_OFFSET(0x1E54C020)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1E54BF60)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_METADATALENGTH_OFFSET UNITYSDK_OFFSET(0x1E54BFC0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_METADATAPOSITION_OFFSET UNITYSDK_OFFSET(0x1E54BFA0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_SIGNATURELENGTH_OFFSET UNITYSDK_OFFSET(0x1E54C000)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_SIGNATUREPOSITION_OFFSET UNITYSDK_OFFSET(0x1E54BFE0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1E54BF80)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_CLIFLAGPOSITION_OFFSET UNITYSDK_OFFSET(0x1E54C050)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_CLIFLAG_OFFSET UNITYSDK_OFFSET(0x1E54C030)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_HASH_OFFSET UNITYSDK_OFFSET(0x1E54BF70)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_METADATALENGTH_OFFSET UNITYSDK_OFFSET(0x1E54BFD0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_METADATAPOSITION_OFFSET UNITYSDK_OFFSET(0x1E54BFB0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_SIGNATURELENGTH_OFFSET UNITYSDK_OFFSET(0x1E54C010)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_SIGNATUREPOSITION_OFFSET UNITYSDK_OFFSET(0x1E54BFF0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1E54BF90)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E54C060)

namespace Mono::Security
{
	inline static constexpr unsigned int StrongName_StrongNameSignature_TypeDefinitionIndex = 2284;

	class StrongName_StrongNameSignature : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* signature; // 0x10
		::Il2CppArray<::System::Byte>* hash; // 0x18
		::System::UInt32 signaturePosition; // 0x20
		::System::UInt32 cliFlagPosition; // 0x24
		::System::UInt32 metadataLength; // 0x28
		::System::UInt32 signatureLength; // 0x2C
		::System::Byte cliFlag; // 0x30
		::System::UInt32 metadataPosition; // 0x34
