...
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETASN1_1_OFFSET UNITYSDK_OFFSET(0x1E71AD90)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETASN1_OFFSET UNITYSDK_OFFSET(0x1E71ADA0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1E71B400)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1E71B3E0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1E71AD80)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E71ACC0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_SELECTBESTENCODING_OFFSET UNITYSDK_OFFSET(0x1E71B2E0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E71ACD0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E71ACB0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E71ACA0)
