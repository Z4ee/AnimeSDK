...
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETASN1_1_OFFSET UNITYSDK_OFFSET(0x1D381560)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETASN1_OFFSET UNITYSDK_OFFSET(0x1D381570)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1D381BC0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1D381BA0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1D381550)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D381490)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_SELECTBESTENCODING_OFFSET UNITYSDK_OFFSET(0x1D381AA0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D3814A0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D381480)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D381470)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_AttributeTypeAndValue_TypeDefinitionIndex = 2309;

	class X520_AttributeTypeAndValue : public ::System::Object
	{
	public:
		::System::String* attrValue; // 0x10
		::System::String* oid; // 0x18
