...
#define MONO_SECURITY_X509_X520_COMMONNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E54CFB0)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_CommonName_TypeDefinitionIndex = 2311;
