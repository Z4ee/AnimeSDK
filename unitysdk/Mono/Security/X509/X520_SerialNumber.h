...
#define MONO_SECURITY_X509_X520_SERIALNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3B53B0)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_SerialNumber_TypeDefinitionIndex = 2313;
