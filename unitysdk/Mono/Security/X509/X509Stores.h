...
#define MONO_SECURITY_X509_X509STORES_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E7C2D30)
#define MONO_SECURITY_X509_X509STORES_GET_INTERMEDIATECA_OFFSET UNITYSDK_OFFSET(0x1E7C2BB0)
#define MONO_SECURITY_X509_X509STORES_GET_OTHERPEOPLE_OFFSET UNITYSDK_OFFSET(0x1E7C2B40)
#define MONO_SECURITY_X509_X509STORES_GET_PERSONAL_OFFSET UNITYSDK_OFFSET(0x1E7C2AD0)
#define MONO_SECURITY_X509_X509STORES_GET_TRUSTEDROOT_OFFSET UNITYSDK_OFFSET(0x1E7C2C30)
#define MONO_SECURITY_X509_X509STORES_GET_UNTRUSTED_OFFSET UNITYSDK_OFFSET(0x1E7C2CB0)
#define MONO_SECURITY_X509_X509STORES_OPEN_OFFSET UNITYSDK_OFFSET(0x1E7C2E90)
#define MONO_SECURITY_X509_X509STORES__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7C2AC0)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::Mono::Security::X509::X509Store* _trusted; // 0x18
		::System::String* _storePath; // 0x20
		::Mono::Security::X509::X509Store* _personal; // 0x28
		::Mono::Security::X509::X509Store* _intermediate; // 0x30
		::Mono::Security::X509::X509Store* _other; // 0x38
