...
#define MONO_SECURITY_X509_X520_ORGANIZATIONNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F603BF0)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_OrganizationName_TypeDefinitionIndex = 2315;
