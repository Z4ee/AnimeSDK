...
#define MONO_SECURITY_X509_X520_COUNTRYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7B9800)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_CountryName_TypeDefinitionIndex = 2322;
