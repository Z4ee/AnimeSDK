...
#define MONO_SECURITY_X509_X520_EMAILADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D2290)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_EmailAddress_TypeDefinitionIndex = 2317;
