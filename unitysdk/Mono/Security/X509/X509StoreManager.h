...
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_CURRENTUSERPATH_OFFSET UNITYSDK_OFFSET(0x1FAE4300)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_CURRENTUSER_OFFSET UNITYSDK_OFFSET(0x1FAE4580)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_INTERMEDIATECACERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1FAE4980)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_INTERMEDIATECACRLS_OFFSET UNITYSDK_OFFSET(0x1FAE4BE0)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_LOCALMACHINEPATH_OFFSET UNITYSDK_OFFSET(0x1FAE43A0)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_LOCALMACHINE_OFFSET UNITYSDK_OFFSET(0x1FAE4680)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_NEWCURRENTUSERPATH_OFFSET UNITYSDK_OFFSET(0x1FAE4440)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_NEWCURRENTUSER_OFFSET UNITYSDK_OFFSET(0x1FAE4780)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_NEWLOCALMACHINEPATH_OFFSET UNITYSDK_OFFSET(0x1FAE44E0)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_NEWLOCALMACHINE_OFFSET UNITYSDK_OFFSET(0x1FAE4880)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_TRUSTEDROOTCACRLS_OFFSET UNITYSDK_OFFSET(0x1FAE5030)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_TRUSTEDROOTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1FAE4DD0)
#define MONO_SECURITY_X509_X509STOREMANAGER_GET_UNTRUSTEDCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1FAE5220)
#define MONO_SECURITY_X509_X509STOREMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAE42F0)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(X509StoreManager_TypeDefinitionIndex)->GetStaticField(0x2390);
		}
