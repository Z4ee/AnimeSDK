...
#define MONO_SECURITY_X509_X509EXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1AF6E610)
#define MONO_SECURITY_X509_X509EXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1AF6E620)
#define MONO_SECURITY_X509_X509EXTENSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AF6E990)
#define MONO_SECURITY_X509_X509EXTENSION_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AF6EB00)
#define MONO_SECURITY_X509_X509EXTENSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AF6EB20)
#define MONO_SECURITY_X509_X509EXTENSION_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1AF6E630)
#define MONO_SECURITY_X509_X509EXTENSION_GET_CRITICAL_OFFSET UNITYSDK_OFFSET(0x1AF6E960)
#define MONO_SECURITY_X509_X509EXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AF6E980)
#define MONO_SECURITY_X509_X509EXTENSION_GET_OID_OFFSET UNITYSDK_OFFSET(0x1AF6E950)
#define MONO_SECURITY_X509_X509EXTENSION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF6E5E0)
#define MONO_SECURITY_X509_X509EXTENSION_SET_CRITICAL_OFFSET UNITYSDK_OFFSET(0x1AF6E970)
#define MONO_SECURITY_X509_X509EXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF6F1D0)
#define MONO_SECURITY_X509_X509EXTENSION_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1AF6EBB0)
#define MONO_SECURITY_X509_X509EXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF6E110)
#define MONO_SECURITY_X509_X509EXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AF6E4B0)
#define MONO_SECURITY_X509_X509EXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6E100)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X509Extension_TypeDefinitionIndex = 2303;
