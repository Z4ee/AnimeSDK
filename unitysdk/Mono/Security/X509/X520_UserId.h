...
#define MONO_SECURITY_X509_X520_USERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1C481E60)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_UserId_TypeDefinitionIndex = 2320;
