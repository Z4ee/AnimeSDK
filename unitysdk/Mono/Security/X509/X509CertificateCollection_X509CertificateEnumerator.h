...
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BE969C0)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BE96AE0)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BEA07F0)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BEA0550)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BEA0630)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BEA0710)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA0470)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X509CertificateCollection_X509CertificateEnumerator_TypeDefinitionIndex = 2300;
