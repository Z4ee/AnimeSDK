...
#define MONO_SECURITY_X509_X520_STATEORPROVINCENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D381C30)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_StateOrProvinceName_TypeDefinitionIndex = 2314;
