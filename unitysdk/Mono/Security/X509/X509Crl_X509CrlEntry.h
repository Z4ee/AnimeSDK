...
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C19EAE0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1C19EAD0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GET_REVOCATIONDATE_OFFSET UNITYSDK_OFFSET(0x1C19EAC0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1C19E9C0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C19E890)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19E790)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X509Crl_X509CrlEntry_TypeDefinitionIndex = 2296;

	class X509Crl_X509CrlEntry : public ::System::Object
	{
	public:
		::Mono::Security::X509::X509ExtensionCollection* extensions; // 0x10
		::Il2CppArray<::System::Byte>* sn; // 0x18
