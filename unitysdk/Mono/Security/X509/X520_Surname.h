...
#define MONO_SECURITY_X509_X520_SURNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C27A0C0)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_Surname_TypeDefinitionIndex = 2325;
