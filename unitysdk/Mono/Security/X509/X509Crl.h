...
#define MONO_SECURITY_X509_X509CRL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F7B8E60)
#define MONO_SECURITY_X509_X509CRL_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1F7B9630)
#define MONO_SECURITY_X509_X509CRL_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1F7B8D50)
#define MONO_SECURITY_X509_X509CRL_GETCRLENTRY_1_OFFSET UNITYSDK_OFFSET(0x1F7B86E0)
#define MONO_SECURITY_X509_X509CRL_GETCRLENTRY_OFFSET UNITYSDK_OFFSET(0x1F7B8EC0)
#define MONO_SECURITY_X509_X509CRL_GET_ENTRIES_OFFSET UNITYSDK_OFFSET(0x1F7B85E0)
#define MONO_SECURITY_X509_X509CRL_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1F7B8850)
#define MONO_SECURITY_X509_X509CRL_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1F7B8860)
#define MONO_SECURITY_X509_X509CRL_GET_ISCURRENT_OFFSET UNITYSDK_OFFSET(0x1F7B8CA0)
#define MONO_SECURITY_X509_X509CRL_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1F7B8A40)
#define MONO_SECURITY_X509_X509CRL_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1F7B86D0)
#define MONO_SECURITY_X509_X509CRL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F7B8640)
#define MONO_SECURITY_X509_X509CRL_GET_NEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7B8A50)
#define MONO_SECURITY_X509_X509CRL_GET_RAWDATA_OFFSET UNITYSDK_OFFSET(0x1F7B8B80)
#define MONO_SECURITY_X509_X509CRL_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x1F7B8A70)
#define MONO_SECURITY_X509_X509CRL_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1F7B8A80)
#define MONO_SECURITY_X509_X509CRL_GET_THISUPDATE_OFFSET UNITYSDK_OFFSET(0x1F7B8A60)
#define MONO_SECURITY_X509_X509CRL_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1F7B8C90)
#define MONO_SECURITY_X509_X509CRL_PARSE_OFFSET UNITYSDK_OFFSET(0x1F7B7F40)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_1_OFFSET UNITYSDK_OFFSET(0x1F7B91D0)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_2_OFFSET UNITYSDK_OFFSET(0x1F7B9430)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_3_OFFSET UNITYSDK_OFFSET(0x1F7B9520)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1F7B8F40)
#define MONO_SECURITY_X509_X509CRL_WASCURRENT_OFFSET UNITYSDK_OFFSET(0x1F7B8D00)
#define MONO_SECURITY_X509_X509CRL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7B7DE0)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::System::String* signatureOID; // 0x18
		::Il2CppArray<::System::Byte>* encoded; // 0x20
		::Il2CppArray<::System::Byte>* hash_value; // 0x28
		::System::String* issuer; // 0x30
		::System::Collections::ArrayList* entries; // 0x38
		::Mono::Security::X509::X509ExtensionCollection* extensions; // 0x40
		::System::DateTime thisUpdate; // 0x48
		::System::Byte version; // 0x50
		::System::DateTime nextUpdate; // 0x58
