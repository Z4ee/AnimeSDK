...
#define MONO_SECURITY_X509_X509CRL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1C042160)
#define MONO_SECURITY_X509_X509CRL_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1C042940)
#define MONO_SECURITY_X509_X509CRL_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C042060)
#define MONO_SECURITY_X509_X509CRL_GETCRLENTRY_1_OFFSET UNITYSDK_OFFSET(0x1C041A00)
#define MONO_SECURITY_X509_X509CRL_GETCRLENTRY_OFFSET UNITYSDK_OFFSET(0x1C0421B0)
#define MONO_SECURITY_X509_X509CRL_GET_ENTRIES_OFFSET UNITYSDK_OFFSET(0x1C041900)
#define MONO_SECURITY_X509_X509CRL_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1C041B70)
#define MONO_SECURITY_X509_X509CRL_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1C041B80)
#define MONO_SECURITY_X509_X509CRL_GET_ISCURRENT_OFFSET UNITYSDK_OFFSET(0x1C041FB0)
#define MONO_SECURITY_X509_X509CRL_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1C041D60)
#define MONO_SECURITY_X509_X509CRL_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1C0419F0)
#define MONO_SECURITY_X509_X509CRL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C041960)
#define MONO_SECURITY_X509_X509CRL_GET_NEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1C041D70)
#define MONO_SECURITY_X509_X509CRL_GET_RAWDATA_OFFSET UNITYSDK_OFFSET(0x1C041EA0)
#define MONO_SECURITY_X509_X509CRL_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C041D90)
#define MONO_SECURITY_X509_X509CRL_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C041DA0)
#define MONO_SECURITY_X509_X509CRL_GET_THISUPDATE_OFFSET UNITYSDK_OFFSET(0x1C041D80)
#define MONO_SECURITY_X509_X509CRL_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1C041FA0)
#define MONO_SECURITY_X509_X509CRL_PARSE_OFFSET UNITYSDK_OFFSET(0x1C041270)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_1_OFFSET UNITYSDK_OFFSET(0x1C0424C0)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_2_OFFSET UNITYSDK_OFFSET(0x1C042730)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_3_OFFSET UNITYSDK_OFFSET(0x1C042820)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C042230)
#define MONO_SECURITY_X509_X509CRL_WASCURRENT_OFFSET UNITYSDK_OFFSET(0x1C042010)
#define MONO_SECURITY_X509_X509CRL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C041120)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* hash_value; // 0x20
		::System::String* signatureOID; // 0x28
		::System::Collections::ArrayList* entries; // 0x30
		::Il2CppArray<::System::Byte>* signature; // 0x38
		::Il2CppArray<::System::Byte>* encoded; // 0x40
		::System::Byte version; // 0x48
		::System::DateTime thisUpdate; // 0x50
