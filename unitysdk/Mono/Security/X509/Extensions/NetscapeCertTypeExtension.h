...
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1BE9C580)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BE9C6B0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_SUPPORT_OFFSET UNITYSDK_OFFSET(0x1BE9C6F0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BE9C760)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE9C560)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BE9C570)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE9C520)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int NetscapeCertTypeExtension_TypeDefinitionIndex = 2339;
