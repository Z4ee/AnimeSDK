...
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1F9A4EB0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_KEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1F9A5150)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1F9A5250)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_NOTAFTER_OFFSET UNITYSDK_OFFSET(0x1F9A5290)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_NOTBEFORE_OFFSET UNITYSDK_OFFSET(0x1F9A52A0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_SUPPORT_OFFSET UNITYSDK_OFFSET(0x1F9A52B0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F9A5320)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F9A4E90)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F9A4EA0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9A4E50)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int KeyAttributesExtension_TypeDefinitionIndex = 2335;
	...
	public:
		...
		::System::Int32 kubits; // 0x38
		::System::DateTime notAfter; // 0x40
