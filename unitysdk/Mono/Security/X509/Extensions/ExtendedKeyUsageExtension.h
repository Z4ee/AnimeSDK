...
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1C19B250)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1C19B3F0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_GET_KEYPURPOSE_OFFSET UNITYSDK_OFFSET(0x1C19B870)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C19B880)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C19B8C0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C19B230)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C19B240)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19B180)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int ExtendedKeyUsageExtension_TypeDefinitionIndex = 2334;
