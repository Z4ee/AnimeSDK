...
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1E4D8C50)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1E4D8DF0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_GET_KEYPURPOSE_OFFSET UNITYSDK_OFFSET(0x1E4D9270)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E4D9280)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4D92C0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4D8C30)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E4D8C40)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4D8B80)
