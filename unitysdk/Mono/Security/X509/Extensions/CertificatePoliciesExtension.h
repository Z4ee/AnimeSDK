...
#define MONO_SECURITY_X509_EXTENSIONS_CERTIFICATEPOLICIESEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1C4C9080)
#define MONO_SECURITY_X509_EXTENSIONS_CERTIFICATEPOLICIESEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C4C92C0)
#define MONO_SECURITY_X509_EXTENSIONS_CERTIFICATEPOLICIESEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4C9300)
#define MONO_SECURITY_X509_EXTENSIONS_CERTIFICATEPOLICIESEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4C9060)
#define MONO_SECURITY_X509_EXTENSIONS_CERTIFICATEPOLICIESEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C4C9070)
#define MONO_SECURITY_X509_EXTENSIONS_CERTIFICATEPOLICIESEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C8FB0)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int CertificatePoliciesExtension_TypeDefinitionIndex = 2333;
