...
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_CRLISSUER_OFFSET UNITYSDK_OFFSET(0x1C3B4E40)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C3B4E00)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_REASONS_OFFSET UNITYSDK_OFFSET(0x1C3B4E20)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_CRLISSUER_OFFSET UNITYSDK_OFFSET(0x1C3B4E50)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C3B4E10)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_REASONS_OFFSET UNITYSDK_OFFSET(0x1C3B4E30)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3B4E70)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3B4E60)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int CRLDistributionPointsExtension_DistributionPoint_TypeDefinitionIndex = 2331;
