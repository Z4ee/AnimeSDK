...
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1C4C8A30)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_GET_DISTRIBUTIONPOINTS_OFFSET UNITYSDK_OFFSET(0x1C4C8CA0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C4C8C60)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4C8CB0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4C8A10)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C4C8A20)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C8990)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int CRLDistributionPointsExtension_TypeDefinitionIndex = 2330;
