...
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1E3640C0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_DIRECTORYNAMES_OFFSET UNITYSDK_OFFSET(0x1E363DC0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_DNSNAMES_OFFSET UNITYSDK_OFFSET(0x1E363E80)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_IPADDRESSES_OFFSET UNITYSDK_OFFSET(0x1E364000)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_RFC822_OFFSET UNITYSDK_OFFSET(0x1E363D00)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_UNIFORMRESOURCEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x1E363F40)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3640F0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3626A0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E363370)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1E362690)
...
namespace Mono::Security::X509::Extensions
{
	...
	{
	public:
		::System::Collections::ArrayList* uris; // 0x10
		::System::Collections::ArrayList* directoryNames; // 0x18
		::Mono::Security::ASN1* asn; // 0x20
		::System::Collections::ArrayList* rfc822Name; // 0x28
		::System::Collections::ArrayList* ipAddr; // 0x30
		::System::Collections::ArrayList* dnsName; // 0x38
