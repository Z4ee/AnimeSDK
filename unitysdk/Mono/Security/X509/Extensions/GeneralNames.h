...
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C03FFC0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_DIRECTORYNAMES_OFFSET UNITYSDK_OFFSET(0x1C03FCC0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_DNSNAMES_OFFSET UNITYSDK_OFFSET(0x1C03FD80)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_IPADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C03FF00)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_RFC822_OFFSET UNITYSDK_OFFSET(0x1C03FC00)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_UNIFORMRESOURCEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x1C03FE40)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C03FFF0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C03E5A0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C03F270)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C03E590)

namespace Mono::Security::X509::Extensions
{
	inline static constexpr unsigned int GeneralNames_TypeDefinitionIndex = 2335;

	class GeneralNames : public ::System::Object
	{
	public:
		::System::Collections::ArrayList* rfc822Name; // 0x10
		::System::Collections::ArrayList* ipAddr; // 0x18
		::System::Collections::ArrayList* dnsName; // 0x20
		::System::Collections::ArrayList* uris; // 0x28
		::System::Collections::ArrayList* directoryNames; // 0x30
		::Mono::Security::ASN1* asn; // 0x38
