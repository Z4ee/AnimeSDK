...
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1EF60B90)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1EF60AB0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_ISSUERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1EF60B50)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_NOTAFTER_OFFSET UNITYSDK_OFFSET(0x1EF60AF0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_NOTBEFORE_OFFSET UNITYSDK_OFFSET(0x1EF60AD0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1EF60A90)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_SUBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1EF60B10)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_SUBJECTPUBLICKEY_OFFSET UNITYSDK_OFFSET(0x1EF60B30)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_SUBJECTUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1EF60B70)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1EF60A70)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1EF60AC0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_ISSUERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1EF60B60)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_NOTAFTER_OFFSET UNITYSDK_OFFSET(0x1EF60B00)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_NOTBEFORE_OFFSET UNITYSDK_OFFSET(0x1EF60AE0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1EF60AA0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_SUBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1EF60B20)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_SUBJECTPUBLICKEY_OFFSET UNITYSDK_OFFSET(0x1EF60B40)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_SUBJECTUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1EF60B80)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1EF60A80)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_SUBJECTPUBLICKEYINFO_OFFSET UNITYSDK_OFFSET(0x1EF60BA0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_TOBESIGNED_OFFSET UNITYSDK_OFFSET(0x1EF61660)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER_UNIQUEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1EF615B0)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EF60910)
#define MONO_SECURITY_X509_X509CERTIFICATEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF607F0)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* subjectUniqueID; // 0x28
		::Il2CppArray<::System::Byte>* sn; // 0x30
		::Il2CppArray<::System::Byte>* issuerUniqueID; // 0x38
		::System::String* subject; // 0x40
		::System::String* issuer; // 0x48
