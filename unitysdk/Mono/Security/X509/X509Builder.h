...
#define MONO_SECURITY_X509_X509BUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1BDA4030)
#define MONO_SECURITY_X509_X509BUILDER_GETOID_OFFSET UNITYSDK_OFFSET(0x1BDA3D20)
#define MONO_SECURITY_X509_X509BUILDER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1BDA3ED0)
#define MONO_SECURITY_X509_X509BUILDER_SET_HASH_OFFSET UNITYSDK_OFFSET(0x1BDA3EE0)
#define MONO_SECURITY_X509_X509BUILDER_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1BDA4350)
#define MONO_SECURITY_X509_X509BUILDER_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1BDA44F0)
#define MONO_SECURITY_X509_X509BUILDER_SIGN_OFFSET UNITYSDK_OFFSET(0x1BDA3F30)
#define MONO_SECURITY_X509_X509BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA3CE0)
