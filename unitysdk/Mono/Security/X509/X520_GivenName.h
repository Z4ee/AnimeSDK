...
#define MONO_SECURITY_X509_X520_GIVENNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C042B50)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X520_GivenName_TypeDefinitionIndex = 2326;
