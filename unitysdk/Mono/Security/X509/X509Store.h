...
#define MONO_SECURITY_X509_X509STORE_BUILDCERTIFICATESCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1BCD3500)
#define MONO_SECURITY_X509_X509STORE_BUILDCRLSCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1BCD3930)
#define MONO_SECURITY_X509_X509STORE_CHECKSTORE_OFFSET UNITYSDK_OFFSET(0x1BCD4500)
#define MONO_SECURITY_X509_X509STORE_CLEARCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1BCD3CC0)
#define MONO_SECURITY_X509_X509STORE_CLEARCRLS_OFFSET UNITYSDK_OFFSET(0x1BCD3CF0)
#define MONO_SECURITY_X509_X509STORE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BCD3C80)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAMEWITHSERIAL_OFFSET UNITYSDK_OFFSET(0x1BCD4800)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_1_OFFSET UNITYSDK_OFFSET(0x1BCD4CF0)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_2_OFFSET UNITYSDK_OFFSET(0x1BCD5200)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_3_OFFSET UNITYSDK_OFFSET(0x1BCD5350)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1BCD4780)
#define MONO_SECURITY_X509_X509STORE_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1BCD34D0)
#define MONO_SECURITY_X509_X509STORE_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1BCD3870)
#define MONO_SECURITY_X509_X509STORE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BCD3C10)
#define MONO_SECURITY_X509_X509STORE_IMPORTNEWFORMAT_OFFSET UNITYSDK_OFFSET(0x1BCD4680)
#define MONO_SECURITY_X509_X509STORE_IMPORT_1_OFFSET UNITYSDK_OFFSET(0x1BCD48F0)
#define MONO_SECURITY_X509_X509STORE_IMPORT_OFFSET UNITYSDK_OFFSET(0x1BCD3D20)
#define MONO_SECURITY_X509_X509STORE_LOADCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1BCD4890)
#define MONO_SECURITY_X509_X509STORE_LOADCRL_OFFSET UNITYSDK_OFFSET(0x1BCD5650)
#define MONO_SECURITY_X509_X509STORE_LOAD_OFFSET UNITYSDK_OFFSET(0x1BCD54A0)
#define MONO_SECURITY_X509_X509STORE_REMOVENEWFORMAT_OFFSET UNITYSDK_OFFSET(0x1BCD4F80)
#define MONO_SECURITY_X509_X509STORE_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1BCD5080)
#define MONO_SECURITY_X509_X509STORE_REMOVE_OFFSET UNITYSDK_OFFSET(0x1BCD4D70)
#define MONO_SECURITY_X509_X509STORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD34C0)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X509Store_TypeDefinitionIndex = 2305;
