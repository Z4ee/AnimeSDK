...
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x185417D0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1853F780)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18541780)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X509ExtensionCollection_TypeDefinitionIndex = 2260;
