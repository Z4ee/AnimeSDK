...
#define MONO_SECURITY_X509_X509CERTIFICATE_CHECKSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C278780)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1C278940)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1C278A10)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETSUBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1C278950)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETUNSIGNEDBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1C277070)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_DSA_OFFSET UNITYSDK_OFFSET(0x1C277100)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1C277400)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1C277410)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_ISCURRENT_OFFSET UNITYSDK_OFFSET(0x1C2781E0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_ISSELFSIGNED_OFFSET UNITYSDK_OFFSET(0x1C278800)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1C2776A0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_ISSUERUNIQUEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1C278270)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_KEYALGORITHMPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C2776C0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_KEYALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C2776B0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_PUBLICKEY_OFFSET UNITYSDK_OFFSET(0x1C2777D0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_RAWDATA_OFFSET UNITYSDK_OFFSET(0x1C277A70)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1C2778D0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1C277B70)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SIGNATUREALGORITHMPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C2780A0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C278090)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C277C70)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SUBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1C2781A0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SUBJECTUNIQUEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1C278370)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_VALIDFROM_OFFSET UNITYSDK_OFFSET(0x1C2781B0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_VALIDUNTIL_OFFSET UNITYSDK_OFFSET(0x1C2781C0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1C2781D0)
#define MONO_SECURITY_X509_X509CERTIFICATE_PARSE_OFFSET UNITYSDK_OFFSET(0x1C276470)
#define MONO_SECURITY_X509_X509CERTIFICATE_PEM_OFFSET UNITYSDK_OFFSET(0x1C276E80)
#define MONO_SECURITY_X509_X509CERTIFICATE_SET_DSA_OFFSET UNITYSDK_OFFSET(0x1C2773E0)
#define MONO_SECURITY_X509_X509CERTIFICATE_SET_KEYALGORITHMPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C2777C0)
#define MONO_SECURITY_X509_X509CERTIFICATE_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1C277A50)
#define MONO_SECURITY_X509_X509CERTIFICATE_VERIFYSIGNATURE_1_OFFSET UNITYSDK_OFFSET(0x1C278500)
#define MONO_SECURITY_X509_X509CERTIFICATE_VERIFYSIGNATURE_2_OFFSET UNITYSDK_OFFSET(0x1C278660)
#define MONO_SECURITY_X509_X509CERTIFICATE_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C278470)
#define MONO_SECURITY_X509_X509CERTIFICATE_WASCURRENT_OFFSET UNITYSDK_OFFSET(0x1C278240)
#define MONO_SECURITY_X509_X509CERTIFICATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C278AB0)
#define MONO_SECURITY_X509_X509CERTIFICATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C278960)
#define MONO_SECURITY_X509_X509CERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C276D60)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::Mono::Security::ASN1* decoder; // 0x20
		::System::String* m_issuername; // 0x28
		::System::String* m_keyalgo; // 0x30
		::Mono::Security::ASN1* issuer; // 0x38
		::Il2CppArray<::System::Byte>* subjectUniqueID; // 0x40
		::Il2CppArray<::System::Byte>* m_encodedcert; // 0x48
		::Mono::Security::X509::X509ExtensionCollection* extensions; // 0x50
		::System::String* m_signaturealgo; // 0x58
		::Mono::Security::ASN1* subject; // 0x60
		::Il2CppArray<::System::Byte>* issuerUniqueID; // 0x68
		::Il2CppArray<::System::Byte>* m_signaturealgoparams; // 0x70
		::System::String* m_subject; // 0x78
		...
		::Il2CppArray<::System::Byte>* certhash; // 0xA0
