...
#define MONO_SECURITY_X509_X509CERTIFICATE_GETISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1B666520)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B666540)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETSUBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1B666530)
#define MONO_SECURITY_X509_X509CERTIFICATE_GETUNSIGNEDBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1B665E60)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_DSA_OFFSET UNITYSDK_OFFSET(0x1B65A500)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1B665EE0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_KEYALGORITHMPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B665F00)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_KEYALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B665EF0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_PUBLICKEY_OFFSET UNITYSDK_OFFSET(0x1B665FE0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_RAWDATA_OFFSET UNITYSDK_OFFSET(0x1B666310)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1B6660C0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1B6663F0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B6664D0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_SUBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1B6664E0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_VALIDFROM_OFFSET UNITYSDK_OFFSET(0x1B6664F0)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_VALIDUNTIL_OFFSET UNITYSDK_OFFSET(0x1B666500)
#define MONO_SECURITY_X509_X509CERTIFICATE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B666510)
#define MONO_SECURITY_X509_X509CERTIFICATE_PARSE_OFFSET UNITYSDK_OFFSET(0x1B664F20)
#define MONO_SECURITY_X509_X509CERTIFICATE_PEM_OFFSET UNITYSDK_OFFSET(0x1B665C10)
#define MONO_SECURITY_X509_X509CERTIFICATE_SET_DSA_OFFSET UNITYSDK_OFFSET(0x1B665EC0)
#define MONO_SECURITY_X509_X509CERTIFICATE_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1B6662F0)
#define MONO_SECURITY_X509_X509CERTIFICATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6665E0)
#define MONO_SECURITY_X509_X509CERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B658F40)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(X509Certificate_TypeDefinitionIndex)->GetStaticField(0x29230);
		}
		::Il2CppArray<::System::Byte>* m_publickey; // 0x10
		::System::String* m_issuername; // 0x18
		::System::Security::Cryptography::RSA* _rsa; // 0x20
		::Il2CppArray<::System::Byte>* serialnumber; // 0x28
		::Il2CppArray<::System::Byte>* subjectUniqueID; // 0x30
		::Il2CppArray<::System::Byte>* signature; // 0x38
		::Il2CppArray<::System::Byte>* m_signaturealgoparams; // 0x40
		::Il2CppArray<::System::Byte>* m_keyalgoparams; // 0x48
		::System::Security::Cryptography::DSA* _dsa; // 0x50
		::System::String* m_subject; // 0x58
		::Il2CppArray<::System::Byte>* issuerUniqueID; // 0x60
		::Mono::Security::ASN1* issuer; // 0x68
		::Mono::Security::X509::X509ExtensionCollection* extensions; // 0x70
		::System::String* m_keyalgo; // 0x78
		::System::String* m_signaturealgo; // 0x80
		::Il2CppArray<::System::Byte>* m_encodedcert; // 0x88
		::Mono::Security::ASN1* decoder; // 0x90
		::Mono::Security::ASN1* subject; // 0x98
		::System::Int32 version; // 0xA0
