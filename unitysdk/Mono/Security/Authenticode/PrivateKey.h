...
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1BE98910)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1BE98900)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DECODE_OFFSET UNITYSDK_OFFSET(0x1BE97940)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DERIVEKEY_OFFSET UNITYSDK_OFFSET(0x1BE97E90)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_ENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1BE97E10)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1BE97E20)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1BE97E40)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_WEAK_OFFSET UNITYSDK_OFFSET(0x1BE97E60)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1BE98090)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_OFFSET UNITYSDK_OFFSET(0x1BE98080)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1BE97E30)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1BE97E50)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_WEAK_OFFSET UNITYSDK_OFFSET(0x1BE97E80)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE97890)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE97880)

namespace Mono::Security::Authenticode
{
	inline static constexpr unsigned int PrivateKey_TypeDefinitionIndex = 2479;
	...
	public:
		...
		::System::Boolean encrypted; // 0x18
		::System::Boolean weak; // 0x19
