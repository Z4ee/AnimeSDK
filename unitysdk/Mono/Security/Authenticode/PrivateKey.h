...
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1E1E0540)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1E1E0530)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DECODE_OFFSET UNITYSDK_OFFSET(0x1E1DF570)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DERIVEKEY_OFFSET UNITYSDK_OFFSET(0x1E1DFAC0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_ENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1E1DFA40)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1E1DFA50)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1E1DFA70)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_WEAK_OFFSET UNITYSDK_OFFSET(0x1E1DFA90)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1E1DFCC0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_OFFSET UNITYSDK_OFFSET(0x1E1DFCB0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1E1DFA60)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1E1DFA80)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_WEAK_OFFSET UNITYSDK_OFFSET(0x1E1DFAB0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E1DF4C0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1DF4B0)
