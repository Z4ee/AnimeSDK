...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_ALGORITHMIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AF4EC00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AF4EE00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x1AF4E9E0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AF4EA00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_CRL_OFFSET UNITYSDK_OFFSET(0x1AF4EA10)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AF4EBC0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1AF4EA20)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1AF4EB80)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_TIMESTAMPURL_OFFSET UNITYSDK_OFFSET(0x1AF4EBA0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_URL_OFFSET UNITYSDK_OFFSET(0x1AF4EBE0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_HEADER_OFFSET UNITYSDK_OFFSET(0x1AF4F660)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_OPUS_OFFSET UNITYSDK_OFFSET(0x1AF4F0D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_PROCESSTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AF50030)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SAVE_OFFSET UNITYSDK_OFFSET(0x1AF50660)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x1AF4E9F0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AF4EBD0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_HASH_OFFSET UNITYSDK_OFFSET(0x1AF4EA70)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1AF4EB90)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_TIMESTAMPURL_OFFSET UNITYSDK_OFFSET(0x1AF4EBB0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_URL_OFFSET UNITYSDK_OFFSET(0x1AF4EBF0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SIGN_OFFSET UNITYSDK_OFFSET(0x1AF50AD0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMPREQUEST_OFFSET UNITYSDK_OFFSET(0x1AF4FEA0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1AF50F00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AF50390)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF51890)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4E820)

namespace Mono::Security::Authenticode
{
	inline static constexpr unsigned int AuthenticodeFormatter_TypeDefinitionIndex = 2478;
	...
	public:
		...
		::System::Security::Cryptography::RSA* rsa; // 0x48
		::Mono::Security::PKCS7_SignedData* pkcs7; // 0x50
		::Mono::Security::ASN1* authenticode; // 0x58
		::System::Collections::ArrayList* crls; // 0x60
		::System::Uri* timestamp; // 0x68
