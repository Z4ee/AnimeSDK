...
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1C197320)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C197190)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1C197150)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1C197170)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_PEM_OFFSET UNITYSDK_OFFSET(0x1C1975B0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C196F70)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C196F00)

namespace Mono::Security::Authenticode
{
	inline static constexpr unsigned int SoftwarePublisherCertificate_TypeDefinitionIndex = 2480;
