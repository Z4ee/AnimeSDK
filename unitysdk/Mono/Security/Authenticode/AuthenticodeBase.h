...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C3BEAE0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GETHASH_OFFSET UNITYSDK_OFFSET(0x1C3BEEB0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GETSECURITYENTRY_OFFSET UNITYSDK_OFFSET(0x1C3BED80)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GET_COFFSYMBOLTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1C3BEA00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GET_PEOFFSET_OFFSET UNITYSDK_OFFSET(0x1C3BE910)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GET_SECURITYOFFSET_OFFSET UNITYSDK_OFFSET(0x1C3BEA20)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_HASHFILE_OFFSET UNITYSDK_OFFSET(0x1C3BF440)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_OPEN_OFFSET UNITYSDK_OFFSET(0x1C3BEA40)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_PROCESSFIRSTBLOCK_OFFSET UNITYSDK_OFFSET(0x1C3BEB10)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_READFIRSTBLOCK_OFFSET UNITYSDK_OFFSET(0x1C3BE930)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3BE8D0)

namespace Mono::Security::Authenticode
{
	inline static constexpr unsigned int AuthenticodeBase_TypeDefinitionIndex = 2476;
	...
	public:
		...
		::System::Int32 coffSymbolTableOffset; // 0x24
		::System::Int32 blockLength; // 0x28
		::System::Int32 dirSecuritySize; // 0x2C
		::System::Int32 peOffset; // 0x30
		::System::Int32 dirSecurityOffset; // 0x34
