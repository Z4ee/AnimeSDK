...
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER_GETNATIVECERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1C481610)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER_GETNATIVECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1C4815C0)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER_GET_HASNATIVECERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1C4815B0)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4815A0)

namespace Mono::Security::Interface
{
	inline static constexpr unsigned int MonoTlsProvider_TypeDefinitionIndex = 2442;
