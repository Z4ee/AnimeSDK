...
#define MONO_SECURITY_INTERFACE_MONOREMOTECERTIFICATEVALIDATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BD82560)
#define MONO_SECURITY_INTERFACE_MONOREMOTECERTIFICATEVALIDATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BD82600)
#define MONO_SECURITY_INTERFACE_MONOREMOTECERTIFICATEVALIDATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BD81EC0)
#define MONO_SECURITY_INTERFACE_MONOREMOTECERTIFICATEVALIDATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD81EB0)

namespace Mono::Security::Interface
{
	inline static constexpr unsigned int MonoRemoteCertificateValidationCallback_TypeDefinitionIndex = 2440;
