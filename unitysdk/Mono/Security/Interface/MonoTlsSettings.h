...
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_CLONEWITHVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1F50C480)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_CLONE_OFFSET UNITYSDK_OFFSET(0x1F50C420)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_COPYDEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1F50C350)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CALLBACKNEEDSCERTIFICATECHAIN_OFFSET UNITYSDK_OFFSET(0x1F50C150)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CERTIFICATESEARCHPATHS_OFFSET UNITYSDK_OFFSET(0x1F50C1D0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CERTIFICATEVALIDATIONTIME_OFFSET UNITYSDK_OFFSET(0x1F50C170)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CERTIFICATEVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1F50C470)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CHECKCERTIFICATENAME_OFFSET UNITYSDK_OFFSET(0x1F50C0D0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CHECKCERTIFICATEREVOCATIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1F50C0F0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_CLIENTCERTIFICATESELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F50C0B0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1F50C260)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_ENABLEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1F50C230)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_ENABLEDPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1F50C210)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_REMOTECERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F50C090)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_SENDCLOSENOTIFY_OFFSET UNITYSDK_OFFSET(0x1F50C1F0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_SKIPSYSTEMVALIDATORS_OFFSET UNITYSDK_OFFSET(0x1F50C130)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_TRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x1F50C190)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_USERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1F50C1B0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_GET_USESERVICEPOINTMANAGERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F50C110)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_CALLBACKNEEDSCERTIFICATECHAIN_OFFSET UNITYSDK_OFFSET(0x1F50C160)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_CERTIFICATESEARCHPATHS_OFFSET UNITYSDK_OFFSET(0x1F50C1E0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_CERTIFICATEVALIDATIONTIME_OFFSET UNITYSDK_OFFSET(0x1F50C180)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_CHECKCERTIFICATENAME_OFFSET UNITYSDK_OFFSET(0x1F50C0E0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_CHECKCERTIFICATEREVOCATIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1F50C100)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_CLIENTCERTIFICATESELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F50C0C0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1F50C2F0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_ENABLEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1F50C240)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_ENABLEDPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1F50C220)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_REMOTECERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F50C0A0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_SENDCLOSENOTIFY_OFFSET UNITYSDK_OFFSET(0x1F50C200)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_SKIPSYSTEMVALIDATORS_OFFSET UNITYSDK_OFFSET(0x1F50C140)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_TRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x1F50C1A0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_USERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1F50C1C0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS_SET_USESERVICEPOINTMANAGERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F50C120)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F50C4F0)
#define MONO_SECURITY_INTERFACE_MONOTLSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F50C250)
...
namespace Mono::Security::Interface
{
	...
	public:
		...
		::Mono::Security::Interface::MonoRemoteCertificateValidationCallback* _RemoteCertificateValidationCallback_k__BackingField; // 0x18
		::System::Object* _UserSettings_k__BackingField; // 0x20
		::Mono::Security::Interface::ICertificateValidator* certificateValidator; // 0x28
		...
		::System::Boolean checkCertRevocationStatus; // 0x50
		::System::Boolean skipSystemValidators; // 0x51
		::System::Boolean cloned; // 0x52
		::System::Nullable_1<::System::Boolean> useServicePointManagerCallback; // 0x53
		::System::Boolean checkCertName; // 0x55
		::System::Boolean _SendCloseNotify_k__BackingField; // 0x56
		::System::Boolean callbackNeedsChain; // 0x57
