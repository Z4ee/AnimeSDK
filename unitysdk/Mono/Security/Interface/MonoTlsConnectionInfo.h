...
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1BE9A5F0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_CIPHERSUITECODE_OFFSET UNITYSDK_OFFSET(0x1BE9A5B0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1BE9A630)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1BE9A610)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_PEERDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1BE9A650)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1BE9A5D0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1BE9A600)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_CIPHERSUITECODE_OFFSET UNITYSDK_OFFSET(0x1BE9A5C0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1BE9A640)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1BE9A620)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_PEERDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1BE9A660)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1BE9A5E0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BE9A670)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE9A710)
...
namespace Mono::Security::Interface
{
	...
	public:
		...
		::Mono::Security::Interface::CipherAlgorithmType _CipherAlgorithmType_k__BackingField; // 0x24
