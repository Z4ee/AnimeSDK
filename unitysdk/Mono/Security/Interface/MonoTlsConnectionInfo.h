...
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1F5FF8A0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_CIPHERSUITECODE_OFFSET UNITYSDK_OFFSET(0x1F5FF860)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1F5FF8E0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1F5FF8C0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_PEERDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1F5FF900)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1F5FF880)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1F5FF8B0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_CIPHERSUITECODE_OFFSET UNITYSDK_OFFSET(0x1F5FF870)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1F5FF8F0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1F5FF8D0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_PEERDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1F5FF910)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1F5FF890)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F5FF920)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5FF9C0)
...
namespace Mono::Security::Interface
{
	...
	public:
		...
		::Mono::Security::Interface::CipherSuiteCode _CipherSuiteCode_k__BackingField; // 0x20
		::Mono::Security::Interface::HashAlgorithmType _HashAlgorithmType_k__BackingField; // 0x24
		::Mono::Security::Interface::ExchangeAlgorithmType _ExchangeAlgorithmType_k__BackingField; // 0x28
