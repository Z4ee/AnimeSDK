...
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AF52490)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AF52420)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AF52540)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GET_SUPPORTSTRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x1AF523C0)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GET_SUPPORTSX509CHAIN_OFFSET UNITYSDK_OFFSET(0x1AF52360)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF522C0)

namespace Mono::Security::Interface
{
	inline static constexpr unsigned int CertificateValidationHelper_TypeDefinitionIndex = 2431;
