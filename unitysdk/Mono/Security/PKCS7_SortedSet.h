...
#define MONO_SECURITY_PKCS7_SORTEDSET_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F5FF9D0)
#define MONO_SECURITY_PKCS7_SORTEDSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5FFB90)
