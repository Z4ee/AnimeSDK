...
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1E4D5750)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x1E4D5770)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x1E4D5790)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x1E4D57B0)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x1E4D57D0)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_6_OFFSET UNITYSDK_OFFSET(0x1E4D57F0)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_7_OFFSET UNITYSDK_OFFSET(0x1E4D5810)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_8_OFFSET UNITYSDK_OFFSET(0x1E4D5830)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_9_OFFSET UNITYSDK_OFFSET(0x1E4D5850)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D56F0)
#define MONO_SECURITY_BITCONVERTERLE_GETUINTBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D5310)
#define MONO_SECURITY_BITCONVERTERLE_GETULONGBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D5480)
#define MONO_SECURITY_BITCONVERTERLE_GETUSHORTBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D5240)
#define MONO_SECURITY_BITCONVERTERLE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1E4D5BD0)
#define MONO_SECURITY_BITCONVERTERLE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x1E4D5C10)
#define MONO_SECURITY_BITCONVERTERLE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1E4D5D90)
#define MONO_SECURITY_BITCONVERTERLE_TOINT16_OFFSET UNITYSDK_OFFSET(0x1E4D5C40)
#define MONO_SECURITY_BITCONVERTERLE_TOINT32_OFFSET UNITYSDK_OFFSET(0x1E4D5C70)
#define MONO_SECURITY_BITCONVERTERLE_TOINT64_OFFSET UNITYSDK_OFFSET(0x1E4D5CA0)
#define MONO_SECURITY_BITCONVERTERLE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x1E4D5D60)
#define MONO_SECURITY_BITCONVERTERLE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x1E4D5CD0)
#define MONO_SECURITY_BITCONVERTERLE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x1E4D5D00)
#define MONO_SECURITY_BITCONVERTERLE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x1E4D5D30)
#define MONO_SECURITY_BITCONVERTERLE_UINTFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D5910)
#define MONO_SECURITY_BITCONVERTERLE_ULONGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D5A50)
#define MONO_SECURITY_BITCONVERTERLE_USHORTFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D5870)
#define MONO_SECURITY_BITCONVERTERLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4D5230)
