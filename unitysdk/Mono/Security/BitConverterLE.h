...
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1C197D70)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x1C197D90)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x1C197DB0)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x1C197DD0)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x1C197DF0)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_6_OFFSET UNITYSDK_OFFSET(0x1C197E10)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_7_OFFSET UNITYSDK_OFFSET(0x1C197E30)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_8_OFFSET UNITYSDK_OFFSET(0x1C197E50)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_9_OFFSET UNITYSDK_OFFSET(0x1C197E70)
#define MONO_SECURITY_BITCONVERTERLE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C197D10)
#define MONO_SECURITY_BITCONVERTERLE_GETUINTBYTES_OFFSET UNITYSDK_OFFSET(0x1C197930)
#define MONO_SECURITY_BITCONVERTERLE_GETULONGBYTES_OFFSET UNITYSDK_OFFSET(0x1C197AA0)
#define MONO_SECURITY_BITCONVERTERLE_GETUSHORTBYTES_OFFSET UNITYSDK_OFFSET(0x1C197860)
#define MONO_SECURITY_BITCONVERTERLE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1C1981F0)
#define MONO_SECURITY_BITCONVERTERLE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x1C198230)
#define MONO_SECURITY_BITCONVERTERLE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1C1983B0)
#define MONO_SECURITY_BITCONVERTERLE_TOINT16_OFFSET UNITYSDK_OFFSET(0x1C198260)
#define MONO_SECURITY_BITCONVERTERLE_TOINT32_OFFSET UNITYSDK_OFFSET(0x1C198290)
#define MONO_SECURITY_BITCONVERTERLE_TOINT64_OFFSET UNITYSDK_OFFSET(0x1C1982C0)
#define MONO_SECURITY_BITCONVERTERLE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x1C198380)
#define MONO_SECURITY_BITCONVERTERLE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x1C1982F0)
#define MONO_SECURITY_BITCONVERTERLE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x1C198320)
#define MONO_SECURITY_BITCONVERTERLE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x1C198350)
#define MONO_SECURITY_BITCONVERTERLE_UINTFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1C197F30)
#define MONO_SECURITY_BITCONVERTERLE_ULONGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1C198070)
#define MONO_SECURITY_BITCONVERTERLE_USHORTFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1C197E90)
#define MONO_SECURITY_BITCONVERTERLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C197850)
