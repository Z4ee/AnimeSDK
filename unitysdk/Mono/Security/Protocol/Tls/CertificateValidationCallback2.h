...
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D363960)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D363990)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D363420)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D363400)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int CertificateValidationCallback2_TypeDefinitionIndex = 2374;
