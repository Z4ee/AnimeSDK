...
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATESELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF52C80)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATESELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF52CD0)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATESELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF525D0)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATESELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF525C0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int CertificateSelectionCallback_TypeDefinitionIndex = 2376;
