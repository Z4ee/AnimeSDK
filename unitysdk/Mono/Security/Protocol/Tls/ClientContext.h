...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BE9A930)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_GET_CLIENTHELLOPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1BE9A8C0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1BE9A8B0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_SET_CLIENTHELLOPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1BE9A8D0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE9A8E0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int ClientContext_TypeDefinitionIndex = 2351;
