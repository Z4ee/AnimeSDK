...
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEDECRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1E0CAF20)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEENCRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1E0CA980)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1E0CA4F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEPREMASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1E0CB8F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_DECRYPTRECORD_OFFSET UNITYSDK_OFFSET(0x1E0CB6C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_ENCRYPTRECORD_OFFSET UNITYSDK_OFFSET(0x1E0CB4C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_EXPAND_OFFSET UNITYSDK_OFFSET(0x1E0CBD70)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1E0CA480)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CIPHERMODE_OFFSET UNITYSDK_OFFSET(0x1E0CA590)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CLIENTHMAC_OFFSET UNITYSDK_OFFSET(0x1E0CA460)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CODE_OFFSET UNITYSDK_OFFSET(0x1E0CA5A0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1E0CA620)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_DECRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1E0CA450)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EFFECTIVEKEYBITS_OFFSET UNITYSDK_OFFSET(0x1E0CA600)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_ENCRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1E0CA440)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1E0CA580)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EXPANDEDKEYMATERIALSIZE_OFFSET UNITYSDK_OFFSET(0x1E0CA5F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHALGORITHMNAME_OFFSET UNITYSDK_OFFSET(0x1E0CA490)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1E0CA550)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1E0CA560)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_ISEXPORTABLE_OFFSET UNITYSDK_OFFSET(0x1E0CA5C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_IVSIZE_OFFSET UNITYSDK_OFFSET(0x1E0CA610)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_KEYBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1E0CA5E0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_KEYMATERIALSIZE_OFFSET UNITYSDK_OFFSET(0x1E0CA5D0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E0CA5B0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_SERVERHMAC_OFFSET UNITYSDK_OFFSET(0x1E0CA470)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_INITIALIZECIPHER_OFFSET UNITYSDK_OFFSET(0x1E0CA960)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_PRF_OFFSET UNITYSDK_OFFSET(0x1E0CBA10)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1E0CA630)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1E0CA7A0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_WRITE_OFFSET UNITYSDK_OFFSET(0x1E0CA6F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E0CC1F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CA640)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::SymmetricAlgorithm* encryptionAlgorithm; // 0x18
		::System::Security::Cryptography::ICryptoTransform* decryptionCipher; // 0x20
		::System::Security::Cryptography::ICryptoTransform* encryptionCipher; // 0x28
		::System::Security::Cryptography::KeyedHashAlgorithm* serverHMAC; // 0x30
		::System::Security::Cryptography::KeyedHashAlgorithm* clientHMAC; // 0x38
		::System::Security::Cryptography::SymmetricAlgorithm* decryptionAlgorithm; // 0x40
		::Mono::Security::Protocol::Tls::Context* context; // 0x48
		::Mono::Security::Protocol::Tls::CipherAlgorithmType cipherAlgorithmType; // 0x50
		::Mono::Security::Protocol::Tls::HashAlgorithmType hashAlgorithmType; // 0x54
		::System::Byte keyMaterialSize; // 0x58
		::System::Byte expandedKeyMaterialSize; // 0x59
		::System::Byte ivSize; // 0x5A
		::System::Security::Cryptography::CipherMode cipherMode; // 0x5C
		::Mono::Security::Protocol::Tls::ExchangeAlgorithmType exchangeAlgorithmType; // 0x60
		::System::Boolean isExportable; // 0x64
		::System::Byte blockSize; // 0x65
		::System::Int32 keyBlockSize; // 0x68
		::System::Int16 effectiveKeyBits; // 0x6C
		::System::Int16 code; // 0x6E
