...
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19B0F0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19B170)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19AB00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19AAF0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int SslStreamBase_AsyncHandshakeDelegate_TypeDefinitionIndex = 2384;
