...
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C275510)
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C275550)
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM___C___CTOR_B__2_0_OFFSET UNITYSDK_OFFSET(0x1C275560)
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM___C___CTOR_B__2_1_OFFSET UNITYSDK_OFFSET(0x1C2755A0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int HttpsClientStream___c_TypeDefinitionIndex = 2362;
	...
	public:
		...
		{
			return (::Mono::Security::Protocol::Tls::HttpsClientStream___c**)Il2CppClass::FromTypeDefinitionIndex(HttpsClientStream___c_TypeDefinitionIndex)->GetStaticField(0x23F0);
		}
		...
		{
			return (::Mono::Security::Protocol::Tls::PrivateKeySelectionCallback**)Il2CppClass::FromTypeDefinitionIndex(HttpsClientStream___c_TypeDefinitionIndex)->GetStaticField(0x2400);
		}
