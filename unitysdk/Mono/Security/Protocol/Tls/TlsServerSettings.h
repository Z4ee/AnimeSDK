...
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATEREQUEST_OFFSET UNITYSDK_OFFSET(0x1E362480)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1E362400)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1E3623E0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATETYPES_OFFSET UNITYSDK_OFFSET(0x1E3624A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_DISTINGUISEDNAMES_OFFSET UNITYSDK_OFFSET(0x1E3624C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_RSAPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E362410)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_SERVERKEYEXCHANGE_OFFSET UNITYSDK_OFFSET(0x1E3623C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_SIGNEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1E362460)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATEREQUEST_OFFSET UNITYSDK_OFFSET(0x1E362490)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1E3623F0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATETYPES_OFFSET UNITYSDK_OFFSET(0x1E3624B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_DISTINGUISEDNAMES_OFFSET UNITYSDK_OFFSET(0x1E3624D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_RSAPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E362440)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_SERVERKEYEXCHANGE_OFFSET UNITYSDK_OFFSET(0x1E3623D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_SIGNEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1E362470)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_UPDATECERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1E3624F0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3624E0)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::RSAParameters rsaParameters; // 0x18
		::Il2CppArray<::System::String*>* distinguisedNames; // 0x58
		::Mono::Security::X509::X509CertificateCollection* certificates; // 0x60
		::Il2CppArray<::System::Byte>* signedParams; // 0x68
