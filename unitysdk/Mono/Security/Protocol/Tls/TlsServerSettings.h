...
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATEREQUEST_OFFSET UNITYSDK_OFFSET(0x1F7B5110)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1F7B5090)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1F7B5070)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATETYPES_OFFSET UNITYSDK_OFFSET(0x1F7B5130)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_DISTINGUISEDNAMES_OFFSET UNITYSDK_OFFSET(0x1F7B5150)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_RSAPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1F7B50A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_SERVERKEYEXCHANGE_OFFSET UNITYSDK_OFFSET(0x1F7B5050)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_SIGNEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1F7B50F0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATEREQUEST_OFFSET UNITYSDK_OFFSET(0x1F7B5120)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1F7B5080)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATETYPES_OFFSET UNITYSDK_OFFSET(0x1F7B5140)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_DISTINGUISEDNAMES_OFFSET UNITYSDK_OFFSET(0x1F7B5160)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_RSAPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1F7B50D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_SERVERKEYEXCHANGE_OFFSET UNITYSDK_OFFSET(0x1F7B5060)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_SIGNEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1F7B5100)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_UPDATECERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1F7B5180)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7B5170)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int TlsServerSettings_TypeDefinitionIndex = 2388;

	class TlsServerSettings : public ::System::Object
	{
	public:
		::System::Security::Cryptography::RSAParameters rsaParameters; // 0x10
		::Mono::Security::X509::X509CertificateCollection* certificates; // 0x50
		::Il2CppArray<::Mono::Security::Protocol::Tls::Handshake::ClientCertificateType>* certificateTypes; // 0x58
		::Il2CppArray<::System::Byte>* signedParams; // 0x60
		::Il2CppArray<::System::String*>* distinguisedNames; // 0x68
		::System::Security::Cryptography::RSA* certificateRSA; // 0x70
