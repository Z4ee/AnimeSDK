...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERFINISHED_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1C199BE0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERFINISHED_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1C199E20)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERFINISHED_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C199BB0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERFINISHED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C19A040)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C199B80)

namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	inline static constexpr unsigned int TlsServerFinished_TypeDefinitionIndex = 2412;
