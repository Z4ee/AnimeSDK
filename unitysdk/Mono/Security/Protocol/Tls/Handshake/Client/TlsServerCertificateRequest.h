...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATEREQUEST_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1AF554F0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATEREQUEST_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1AF55500)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATEREQUEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AF554A0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF55470)

namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	inline static constexpr unsigned int TlsServerCertificateRequest_TypeDefinitionIndex = 2411;
