...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLODONE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1E0EB2C0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLODONE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1E0EB2D0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLODONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0EB290)

namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	inline static constexpr unsigned int TlsServerHelloDone_TypeDefinitionIndex = 2413;
