...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1AF53C80)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1AF53FD0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE_PROCESSCOMMON_OFFSET UNITYSDK_OFFSET(0x1AF53C90)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF53C50)

namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	inline static constexpr unsigned int TlsClientKeyExchange_TypeDefinitionIndex = 2409;
