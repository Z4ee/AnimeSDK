...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1D3643B0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1D364720)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE_PROCESSCOMMON_OFFSET UNITYSDK_OFFSET(0x1D3643C0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTKEYEXCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D364380)
