...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERKEYEXCHANGE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1F4C9490)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERKEYEXCHANGE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1F4C95F0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERKEYEXCHANGE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F4C9410)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERKEYEXCHANGE_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1F4C9180)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERKEYEXCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4C9150)

namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	inline static constexpr unsigned int TlsServerKeyExchange_TypeDefinitionIndex = 2414;
