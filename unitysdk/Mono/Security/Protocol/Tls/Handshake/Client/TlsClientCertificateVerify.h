...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_GETCLIENTCERTRSA_OFFSET UNITYSDK_OFFSET(0x1E6FBB90)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_GETUNSIGNEDBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1E6FC110)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1E6FB810)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1E6FBDA0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E6FB7A0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6FB770)
