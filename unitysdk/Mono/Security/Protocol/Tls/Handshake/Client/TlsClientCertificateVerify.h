...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_GETCLIENTCERTRSA_OFFSET UNITYSDK_OFFSET(0x1FAD9630)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_GETUNSIGNEDBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1FAD9BB0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1FAD92B0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1FAD9840)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FAD9240)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAD9210)

namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	inline static constexpr unsigned int TlsClientCertificateVerify_TypeDefinitionIndex = 2405;
