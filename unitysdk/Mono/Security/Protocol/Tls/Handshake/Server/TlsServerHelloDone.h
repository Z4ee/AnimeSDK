...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERHELLODONE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1C19A120)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERHELLODONE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1C19A130)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERHELLODONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19A0F0)

namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	inline static constexpr unsigned int TlsServerHelloDone_TypeDefinitionIndex = 2403;
