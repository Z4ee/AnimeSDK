...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERCERTIFICATEREQUEST_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1C3C2120)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERCERTIFICATEREQUEST_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1C3C2130)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERCERTIFICATEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3C20F0)

namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	inline static constexpr unsigned int TlsServerCertificateRequest_TypeDefinitionIndex = 2400;
