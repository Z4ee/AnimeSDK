...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1E54A380)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1E54A390)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1E54A650)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCIPHERSUITE_OFFSET UNITYSDK_OFFSET(0x1E54A120)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCOMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1E54A350)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E54A0D0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E54A0A0)

namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	inline static constexpr unsigned int TlsClientHello_TypeDefinitionIndex = 2396;

	class TlsClientHello : public ::Mono::Security::Protocol::Tls::Handshake::HandshakeMessage
	{
	public:
		::Il2CppArray<::System::Byte>* sessionId; // 0x58
		::Il2CppArray<::System::Int16>* cipherSuites; // 0x60
		::Il2CppArray<::System::Byte>* random; // 0x68
		::Il2CppArray<::System::Byte>* compressionMethods; // 0x70
