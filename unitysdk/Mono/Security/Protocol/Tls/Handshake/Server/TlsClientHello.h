...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1F93A5E0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1F93A5F0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1F93A8C0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCIPHERSUITE_OFFSET UNITYSDK_OFFSET(0x1F93A390)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCOMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1F93A5B0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F93A330)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F93A300)
...
namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* sessionId; // 0x70
