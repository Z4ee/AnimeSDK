...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERKEYEXCHANGE_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C275320)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERKEYEXCHANGE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1C274FC0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERKEYEXCHANGE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1C274FD0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERKEYEXCHANGE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C274F70)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSSERVERKEYEXCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C274F40)

namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	inline static constexpr unsigned int TlsServerKeyExchange_TypeDefinitionIndex = 2404;
