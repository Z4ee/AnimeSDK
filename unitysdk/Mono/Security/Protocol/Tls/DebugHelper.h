...
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1FBC89B0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1FBC8A10)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITEBUFFER_OFFSET UNITYSDK_OFFSET(0x1FBC8A00)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x1FBC89E0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x1FBC89F0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1FBC89D0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC8B50)
