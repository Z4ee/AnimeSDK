...
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7E7F50)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1E7E7FB0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITEBUFFER_OFFSET UNITYSDK_OFFSET(0x1E7E7FA0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x1E7E7F80)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x1E7E7F90)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1E7E7F70)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E80F0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int DebugHelper_TypeDefinitionIndex = 2356;
