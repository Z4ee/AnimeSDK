...
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ASYNCEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1F3F5BB0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ASYNCSTATE_OFFSET UNITYSDK_OFFSET(0x1F3F5BA0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ASYNCWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x1F3F5D40)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_COMPLETEDSYNCHRONOUSLY_OFFSET UNITYSDK_OFFSET(0x1F3F5E50)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_COMPLETEDWITHERROR_OFFSET UNITYSDK_OFFSET(0x1F3F5BC0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1F3F5C90)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1F3F5B90)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_SETCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1F3F5FB0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_SETCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1F3F5E60)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3F5B50)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::Mono::Security::Protocol::Tls::Handshake::HandshakeMessage* _message; // 0x20
		::System::Object* locker; // 0x28
		::System::Exception* _asyncException; // 0x30
