...
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ASYNCEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1BCD25E0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ASYNCSTATE_OFFSET UNITYSDK_OFFSET(0x1BCD25D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ASYNCWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x1BCD2770)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_COMPLETEDSYNCHRONOUSLY_OFFSET UNITYSDK_OFFSET(0x1BCD2880)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_COMPLETEDWITHERROR_OFFSET UNITYSDK_OFFSET(0x1BCD25F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1BCD26C0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1BCD25C0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_SETCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1BCD29E0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT_SETCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1BCD2890)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORDASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD2580)
...
namespace Mono::Security::Protocol::Tls
{
	...
	{
	public:
		::Mono::Security::Protocol::Tls::Handshake::HandshakeMessage* _message; // 0x10
		::System::AsyncCallback* _userCallback; // 0x18
		::System::Exception* _asyncException; // 0x20
		::System::Object* _userState; // 0x28
