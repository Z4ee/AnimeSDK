...
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ADD_CLIENTCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1E700B80)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ADD_CLIENTCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1E700900)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ADD_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1E700A00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_BEGINNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1E700F70)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E700F40)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ENDNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1E7010A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E700EC0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1E700B00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_CLIENTCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E700B40)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_HAVEREMOTEVALIDATION2CALLBACK_OFFSET UNITYSDK_OFFSET(0x1E701430)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E700B60)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONLOCALCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1E7013B0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONLOCALPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1E701470)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONREMOTECERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1E701440)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONREMOTECERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1E701400)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_RAISECLIENTCERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1E701460)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_RAISEPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1E6FFC30)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_REMOVE_CLIENTCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1E700C00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_REMOVE_CLIENTCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1E700980)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_REMOVE_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1E700A80)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_SET_CLIENTCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E700B50)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_SET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E700B70)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E700CE0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E700D10)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E700CB0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1E700D40)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E700C80)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int SslServerStream_TypeDefinitionIndex = 2381;

	class SslServerStream : public ::Mono::Security::Protocol::Tls::SslStreamBase
	{
	public:
		::Mono::Security::Protocol::Tls::CertificateValidationCallback* ClientCertValidation; // 0x80
		::Mono::Security::Protocol::Tls::PrivateKeySelectionCallback* PrivateKeySelection; // 0x88
		::Mono::Security::Protocol::Tls::CertificateValidationCallback2* ClientCertValidation2; // 0x90
