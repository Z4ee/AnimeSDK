...
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_CREATECLIENTHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AF56730)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_CREATESERVERHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AF56200)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AF561F0)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_PROCESSHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AF56420)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF56170)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int ServerRecordProtocol_TypeDefinitionIndex = 2372;
