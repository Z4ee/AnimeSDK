...
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_CLIENTCERTSELECTION_OFFSET UNITYSDK_OFFSET(0x1DB69A10)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1DB69B10)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_SERVERCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1DB69CE0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_SERVERCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1DB69910)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_BEGINNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1DB6A3D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB6A310)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ENDNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1DB6A590)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DB6A290)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1DB69C20)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_CLIENTCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1DB69CA0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_HAVEREMOTEVALIDATION2CALLBACK_OFFSET UNITYSDK_OFFSET(0x1DB6BE00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_INPUTBUFFER_OFFSET UNITYSDK_OFFSET(0x1DB69C10)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1DB69CC0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_SELECTEDCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1DB69C50)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_SERVERCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1DB69C80)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_NEGOTIATEASYNCWORKER_OFFSET UNITYSDK_OFFSET(0x1DB6A730)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONLOCALCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1DB6BDE0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONLOCALPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1DB6BEB0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONREMOTECERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1DB6BE10)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONREMOTECERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1DB6BE30)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISECLIENTCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1DB6BE80)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISEPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1DB6BED0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1DB6BE70)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1DB6BE60)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_CLIENTCERTSELECTION_OFFSET UNITYSDK_OFFSET(0x1DB69A90)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1DB69B90)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_SERVERCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1DB69D60)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_SERVERCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1DB69990)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SAFEENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1DB6A340)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_CLIENTCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1DB69CB0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1DB69CD0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_SERVERCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1DB69C90)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB69FA0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DB6A150)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DB6A170)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1DB69E00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB69DE0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int SslClientStream_TypeDefinitionIndex = 2377;

	class SslClientStream : public ::Mono::Security::Protocol::Tls::SslStreamBase
	{
	public:
		::Mono::Security::Protocol::Tls::CertificateValidationCallback* ServerCertValidation; // 0x80
		::Mono::Security::Protocol::Tls::CertificateValidationCallback2* ServerCertValidation2; // 0x88
		::Mono::Security::Protocol::Tls::CertificateSelectionCallback* ClientCertSelection; // 0x90
		::Mono::Security::Protocol::Tls::PrivateKeySelectionCallback* PrivateKeySelection; // 0x98
