...
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_CLIENTCERTSELECTION_OFFSET UNITYSDK_OFFSET(0x1EF5E390)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1EF5E490)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_SERVERCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1EF5E660)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_SERVERCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1EF5E290)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_BEGINNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1EF5ED60)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF5ECA0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ENDNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1EF5EF20)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1EF5EC20)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1EF5E5A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_CLIENTCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EF5E620)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_HAVEREMOTEVALIDATION2CALLBACK_OFFSET UNITYSDK_OFFSET(0x1EF60710)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_INPUTBUFFER_OFFSET UNITYSDK_OFFSET(0x1EF5E590)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EF5E640)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_SELECTEDCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1EF5E5D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_SERVERCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EF5E600)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_NEGOTIATEASYNCWORKER_OFFSET UNITYSDK_OFFSET(0x1EF5F0B0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONLOCALCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1EF606F0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONLOCALPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1EF607C0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONREMOTECERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1EF60720)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONREMOTECERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1EF60740)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISECLIENTCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1EF60790)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISEPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1EF607E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1EF60780)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1EF60770)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_CLIENTCERTSELECTION_OFFSET UNITYSDK_OFFSET(0x1EF5E410)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1EF5E510)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_SERVERCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1EF5E6E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_SERVERCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1EF5E310)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SAFEENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1EF5ECD0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_CLIENTCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EF5E630)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EF5E650)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_SERVERCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EF5E610)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EF5E930)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EF5EAE0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EF5EB00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1EF5E780)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF5E760)
...
namespace Mono::Security::Protocol::Tls
{
	...
	{
	public:
		::Mono::Security::Protocol::Tls::CertificateSelectionCallback* ClientCertSelection; // 0x80
		::Mono::Security::Protocol::Tls::PrivateKeySelectionCallback* PrivateKeySelection; // 0x88
		::Mono::Security::Protocol::Tls::CertificateValidationCallback* ServerCertValidation; // 0x90
