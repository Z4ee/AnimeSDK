...
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19A6F0)
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19A730)
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19A150)
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19A140)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int PrivateKeySelectionCallback_TypeDefinitionIndex = 2377;
