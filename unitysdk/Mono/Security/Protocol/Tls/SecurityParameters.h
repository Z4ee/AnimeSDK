...
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1FBD5F80)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_GET_CIPHER_OFFSET UNITYSDK_OFFSET(0x1FBD5F20)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_GET_CLIENTWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1FBD5F40)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_GET_SERVERWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1FBD5F60)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_SET_CIPHER_OFFSET UNITYSDK_OFFSET(0x1FBD5F30)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_SET_CLIENTWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1FBD5F50)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_SET_SERVERWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1FBD5F70)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBD5F10)
