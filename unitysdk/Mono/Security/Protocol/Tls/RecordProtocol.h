...
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1EF5BE80)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1EF5D930)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1EF5D9B0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1EF5BAE0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1EF5E1D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_DECRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1EF5C8C0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODEHANDSHAKERECORD_OFFSET UNITYSDK_OFFSET(0x1EF5E0F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_1_OFFSET UNITYSDK_OFFSET(0x1EF5DD90)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_OFFSET UNITYSDK_OFFSET(0x1EF5D900)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1EF5DFD0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1EF5CBC0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1EF5DAC0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1EF5BBD0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1EF5BE30)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1EF5BA70)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALRECEIVERECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1EF5C080)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALSENDRECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1EF5DB80)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSALERT_OFFSET UNITYSDK_OFFSET(0x1EF5CB30)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1EF5BD70)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_READRECORDBUFFER_OFFSET UNITYSDK_OFFSET(0x1EF5C560)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_RECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1EF5CE20)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_1_OFFSET UNITYSDK_OFFSET(0x1EF5D5B0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_2_OFFSET UNITYSDK_OFFSET(0x1EF5D630)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_3_OFFSET UNITYSDK_OFFSET(0x1EF5D450)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_OFFSET UNITYSDK_OFFSET(0x1EF5D2E0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_1_OFFSET UNITYSDK_OFFSET(0x1EF5D7C0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1EF5D6B0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1EF5D680)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_OFFSET UNITYSDK_OFFSET(0x1EF5BAB0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1EF5BA80)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EF5E230)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF5BA90)
