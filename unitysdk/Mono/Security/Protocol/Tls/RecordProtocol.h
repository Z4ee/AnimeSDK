...
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1B77C820)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1B77E2D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1B77E350)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1B77C480)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B77EB90)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_DECRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1B77D230)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODEHANDSHAKERECORD_OFFSET UNITYSDK_OFFSET(0x1B77EAB0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_1_OFFSET UNITYSDK_OFFSET(0x1B77E740)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_OFFSET UNITYSDK_OFFSET(0x1B77E2A0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1B77E980)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1B77D530)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1B77E460)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1B77C570)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B77C7D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1B77C410)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALRECEIVERECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B77CA20)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALSENDRECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B77E520)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSALERT_OFFSET UNITYSDK_OFFSET(0x1B77D4A0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1B77C710)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_READRECORDBUFFER_OFFSET UNITYSDK_OFFSET(0x1B77CEE0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_RECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1B77D790)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_1_OFFSET UNITYSDK_OFFSET(0x1B77DF30)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_2_OFFSET UNITYSDK_OFFSET(0x1B77DFB0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_3_OFFSET UNITYSDK_OFFSET(0x1B77DDD0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_OFFSET UNITYSDK_OFFSET(0x1B77DC60)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_1_OFFSET UNITYSDK_OFFSET(0x1B77E150)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1B77E030)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1B77E000)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_OFFSET UNITYSDK_OFFSET(0x1B77C450)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1B77C420)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B77EBF0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B77C430)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int RecordProtocol_TypeDefinitionIndex = 2365;
