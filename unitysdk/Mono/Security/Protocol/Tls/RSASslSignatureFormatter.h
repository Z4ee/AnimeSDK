...
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x1FBB5410)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER_SETHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1FBB5510)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER_SETKEY_OFFSET UNITYSDK_OFFSET(0x1FBB5380)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBB52F0)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBB52E0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int RSASslSignatureFormatter_TypeDefinitionIndex = 2363;

	class RSASslSignatureFormatter : public ::System::Security::Cryptography::AsymmetricSignatureFormatter
	{
	public:
		::System::Security::Cryptography::RSA* key; // 0x10
