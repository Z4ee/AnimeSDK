...
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREDEFORMATTER_SETHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C19A9F0)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREDEFORMATTER_SETKEY_OFFSET UNITYSDK_OFFSET(0x1C19A7E0)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREDEFORMATTER_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C19A870)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREDEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C19A750)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREDEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19A740)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int RSASslSignatureDeformatter_TypeDefinitionIndex = 2363;
