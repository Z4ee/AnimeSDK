...
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1BE9C4C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1BE9BB60)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1BE9BB70)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1BE9BB50)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1BE9BAC0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1BE9BB20)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BE9BAF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READBYTES_OFFSET UNITYSDK_OFFSET(0x1BE9C060)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1BE9BEB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT16_OFFSET UNITYSDK_OFFSET(0x1BE9BEF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT24_OFFSET UNITYSDK_OFFSET(0x1BE9BF40)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT32_OFFSET UNITYSDK_OFFSET(0x1BE9BFC0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READSMALLVALUE_OFFSET UNITYSDK_OFFSET(0x1BE9BCC0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1BE9BE20)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1BE9B090)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1BE9C500)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1BE9C4E0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BE9BB90)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_TOARRAY_OFFSET UNITYSDK_OFFSET(0x1BE9B060)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITEINT24_OFFSET UNITYSDK_OFFSET(0x1BE9C300)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1BE9B4A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1BE9ADF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_3_OFFSET UNITYSDK_OFFSET(0x1BE9C490)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_4_OFFSET UNITYSDK_OFFSET(0x1BE9AFB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_5_OFFSET UNITYSDK_OFFSET(0x1BE9C260)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1BE9C150)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE9BBB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE9AD00)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int TlsStream_TypeDefinitionIndex = 2390;
	...
	public:
		...
		::System::Boolean canWrite; // 0x38
		::System::Boolean canRead; // 0x39
