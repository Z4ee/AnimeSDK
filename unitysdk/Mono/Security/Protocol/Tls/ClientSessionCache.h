...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_ADD_OFFSET UNITYSDK_OFFSET(0x1FAE24B0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_FROMCONTEXT_OFFSET UNITYSDK_OFFSET(0x1FAE2E80)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_FROMHOST_OFFSET UNITYSDK_OFFSET(0x1FAE2830)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_SETCONTEXTFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1FAE3240)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_SETCONTEXTINCACHE_OFFSET UNITYSDK_OFFSET(0x1FAE30D0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FAE23F0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAE33B0)
