...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_ADD_OFFSET UNITYSDK_OFFSET(0x1E704C80)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_FROMCONTEXT_OFFSET UNITYSDK_OFFSET(0x1E705680)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_FROMHOST_OFFSET UNITYSDK_OFFSET(0x1E705000)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_SETCONTEXTFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1E705A40)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE_SETCONTEXTINCACHE_OFFSET UNITYSDK_OFFSET(0x1E7058D0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E704BC0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E705BB0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int ClientSessionCache_TypeDefinitionIndex = 2353;
