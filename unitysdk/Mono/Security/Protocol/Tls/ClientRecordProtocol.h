...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_CREATECLIENTHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C274770)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_CREATESERVERHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C274BD0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C274760)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_PROCESSHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C2748A0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2746E0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int ClientRecordProtocol_TypeDefinitionIndex = 2352;
