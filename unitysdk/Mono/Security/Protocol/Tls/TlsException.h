...
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION_GET_ALERT_OFFSET UNITYSDK_OFFSET(0x1C2029B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C202A40)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C202A90)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C202B20)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C202C40)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1C202D20)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1C200D40)
#define MONO_SECURITY_PROTOCOL_TLS_TLSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2029C0)

namespace Mono::Security::Protocol::Tls
{
	inline static constexpr unsigned int TlsException_TypeDefinitionIndex = 2388;
