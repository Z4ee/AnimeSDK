...
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_DECODESTRING_OFFSET UNITYSDK_OFFSET(0x1BD83BD0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_DECODE_OFFSET UNITYSDK_OFFSET(0x1BD82C50)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_ENCODESTRING_OFFSET UNITYSDK_OFFSET(0x1BD83DB0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BD835A0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1BD83FC0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_CHALLENGE_OFFSET UNITYSDK_OFFSET(0x1BD83720)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1BD83640)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1BD83A00)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_HOST_OFFSET UNITYSDK_OFFSET(0x1BD83AB0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1BD83700)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_LM_OFFSET UNITYSDK_OFFSET(0x1BD83BA0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_NT_OFFSET UNITYSDK_OFFSET(0x1BD83BB0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1BD83B60)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1BD83B80)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_CHALLENGE_OFFSET UNITYSDK_OFFSET(0x1BD83820)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1BD836A0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1BD83A10)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_HOST_OFFSET UNITYSDK_OFFSET(0x1BD83AC0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1BD83710)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_NT_OFFSET UNITYSDK_OFFSET(0x1BD83BC0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1BD83B70)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1BD83B90)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD82BE0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BD833B0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD82AF0)

namespace Mono::Security::Protocol::Ntlm
{
	inline static constexpr unsigned int Type3Message_TypeDefinitionIndex = 2424;
	...
	public:
		...
		::Mono::Security::Protocol::Ntlm::Type2Message* _type2; // 0x28
		::Il2CppArray<::System::Byte>* _nt; // 0x30
		::System::String* _password; // 0x38
		::System::String* _domain; // 0x40
		::Il2CppArray<::System::Byte>* _challenge; // 0x48
