...
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS_GET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x16148050)
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x161480B0)

namespace Mono::Security::Protocol::Ntlm
{
	inline static constexpr unsigned int NtlmSettings_TypeDefinitionIndex = 2265;
	...
	public:
		...
		{
			return (::Mono::Security::Protocol::Ntlm::NtlmAuthLevel*)Il2CppClass::FromTypeDefinitionIndex(NtlmSettings_TypeDefinitionIndex)->GetStaticField(0x4E40);
		}
