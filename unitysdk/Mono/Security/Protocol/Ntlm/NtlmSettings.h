...
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS_GET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1FBD51B0)
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS_SET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1FBD5210)
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBD5270)

namespace Mono::Security::Protocol::Ntlm
{
	inline static constexpr unsigned int NtlmSettings_TypeDefinitionIndex = 2420;
