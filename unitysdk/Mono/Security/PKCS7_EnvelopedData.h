...
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1E4D6EC0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1E4D7040)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1E4D6E80)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1E4D6F00)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ENCRYPTEDCONTENT_OFFSET UNITYSDK_OFFSET(0x1E4D6F20)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ENCRYPTIONALGORITHM_OFFSET UNITYSDK_OFFSET(0x1E4D6F10)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_RECIPIENTINFOS_OFFSET UNITYSDK_OFFSET(0x1E4D6E70)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1E4D7020)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1E4D7030)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4D6900)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E4D6960)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4D67B0)
...
namespace Mono::Security
{
	...
	{
	public:
		::System::Collections::ArrayList* _recipientInfos; // 0x10
		::Mono::Security::PKCS7_ContentInfo* _content; // 0x18
		::Il2CppArray<::System::Byte>* _encrypted; // 0x20
		::Mono::Security::PKCS7_ContentInfo* _encryptionAlgorithm; // 0x28
