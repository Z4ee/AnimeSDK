...
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_ADD_OFFSET UNITYSDK_OFFSET(0x1E114F90)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E114F20)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GETNAME_OFFSET UNITYSDK_OFFSET(0x1E114AB0)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E114CA0)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1E114B10)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E114A90)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1E114DC0)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1E114E70)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E115010)
