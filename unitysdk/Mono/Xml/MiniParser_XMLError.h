...
#define MONO_XML_MINIPARSER_XMLERROR_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x1E7FA510)
#define MONO_XML_MINIPARSER_XMLERROR_GET_LINE_OFFSET UNITYSDK_OFFSET(0x1E7FA500)
#define MONO_XML_MINIPARSER_XMLERROR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E7FA520)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7FA3C0)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E7FA460)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7FA2E0)
