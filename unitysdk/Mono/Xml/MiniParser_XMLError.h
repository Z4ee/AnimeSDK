...
#define MONO_XML_MINIPARSER_XMLERROR_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x1C4C9A70)
#define MONO_XML_MINIPARSER_XMLERROR_GET_LINE_OFFSET UNITYSDK_OFFSET(0x1C4C9A60)
#define MONO_XML_MINIPARSER_XMLERROR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4C9A80)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4C9920)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C4C99C0)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C9840)

namespace Mono::Xml
{
	inline static constexpr unsigned int MiniParser_XMLError_TypeDefinitionIndex = 2270;
