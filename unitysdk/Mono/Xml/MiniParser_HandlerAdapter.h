...
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONCHARS_OFFSET UNITYSDK_OFFSET(0x1FADD660)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1FADD650)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONENDPARSING_OFFSET UNITYSDK_OFFSET(0x1FADD670)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1FADD640)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONSTARTPARSING_OFFSET UNITYSDK_OFFSET(0x1FADD630)
#define MONO_XML_MINIPARSER_HANDLERADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FADD400)
