...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_X509_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A850D10)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_X509_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A850DB0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_X509_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A84E820)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_X509_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A850CA0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_x509list_get_x509_t_TypeDefinitionIndex = 2372;
