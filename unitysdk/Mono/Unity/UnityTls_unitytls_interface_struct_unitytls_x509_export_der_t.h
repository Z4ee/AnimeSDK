...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509_EXPORT_DER_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18670BD0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509_EXPORT_DER_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18670C80)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509_EXPORT_DER_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1866A630)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509_EXPORT_DER_T__CTOR_OFFSET UNITYSDK_OFFSET(0x18670BB0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_x509_export_der_t_TypeDefinitionIndex = 2365;
