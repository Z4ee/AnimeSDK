...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SERVER_REQUIRE_CLIENT_AUTHENTICATION_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4823A0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SERVER_REQUIRE_CLIENT_AUTHENTICATION_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C482430)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SERVER_REQUIRE_CLIENT_AUTHENTICATION_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C482380)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SERVER_REQUIRE_CLIENT_AUTHENTICATION_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1C482300)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_server_require_client_authentication_t_TypeDefinitionIndex = 2388;
