...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_X509VERIFY_CALLBACK_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D452B60)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_X509VERIFY_CALLBACK_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D452BB0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_X509VERIFY_CALLBACK_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4527F0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_X509VERIFY_CALLBACK_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4527D0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_set_x509verify_callback_t_TypeDefinitionIndex = 2569;
