...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_FREE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A3FDE0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_FREE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A3FE10)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_FREE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A3FAB0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_FREE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3FAA0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_x509list_free_t_TypeDefinitionIndex = 2562;
