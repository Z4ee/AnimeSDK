...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_FREE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1938EB90)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_FREE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1938EBC0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_FREE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1938E860)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_FREE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1938E850)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_free_t_TypeDefinitionIndex = 2578;
