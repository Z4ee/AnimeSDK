...
#define MONO_UNITY_UNITYTLS_UNITYTLS_X509VERIFY_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A851900)
#define MONO_UNITY_UNITYTLS_UNITYTLS_X509VERIFY_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A8519B0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_X509VERIFY_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8518D0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_X509VERIFY_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A851850)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_x509verify_callback_TypeDefinitionIndex = 2351;
