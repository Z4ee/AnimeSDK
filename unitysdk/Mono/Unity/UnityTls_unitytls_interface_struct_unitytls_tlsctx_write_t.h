...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_WRITE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C482960)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_WRITE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4829E0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_WRITE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C482930)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_WRITE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4828B0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_write_t_TypeDefinitionIndex = 2397;
