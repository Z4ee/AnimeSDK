...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18FA3B70)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18FA3BF0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x18FA3800)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA37F0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_x509list_append_der_t_TypeDefinitionIndex = 2560;
