...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A8503B0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A850400)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A850380)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A850300)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_set_trace_callback_t_TypeDefinitionIndex = 2383;
