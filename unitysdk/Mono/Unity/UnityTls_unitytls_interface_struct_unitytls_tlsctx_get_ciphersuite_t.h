...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_CIPHERSUITE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A84FAC0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_CIPHERSUITE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A84FB00)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_CIPHERSUITE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A84FAB0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_CIPHERSUITE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A84FA30)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_get_ciphersuite_t_TypeDefinitionIndex = 2386;
