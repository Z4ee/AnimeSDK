...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509VERIFY_EXPLICIT_CA_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A851040)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509VERIFY_EXPLICIT_CA_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A851130)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509VERIFY_EXPLICIT_CA_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A851000)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509VERIFY_EXPLICIT_CA_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A850F90)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_x509verify_explicit_ca_t_TypeDefinitionIndex = 2378;
