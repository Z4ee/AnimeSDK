...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A0F2B60)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0F2BA0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0F2820)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F2810)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_process_handshake_t_TypeDefinitionIndex = 2574;
