...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_RANDOM_GENERATE_BYTES_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E23D10)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_RANDOM_GENERATE_BYTES_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E23D80)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_RANDOM_GENERATE_BYTES_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E239A0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_RANDOM_GENERATE_BYTES_T__CTOR_OFFSET UNITYSDK_OFFSET(0x19E23990)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_random_generate_bytes_t_TypeDefinitionIndex = 2579;
