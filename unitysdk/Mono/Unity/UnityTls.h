...
#define MONO_UNITY_UNITYTLS_GETUNITYTLSINTERFACE_OFFSET UNITYSDK_OFFSET(0x1DD0D250)
#define MONO_UNITY_UNITYTLS_GET_ISSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1DD0D260)
#define MONO_UNITY_UNITYTLS_GET_NATIVEINTERFACE_OFFSET UNITYSDK_OFFSET(0x1DD0D2E0)
#define MONO_UNITY_UNITYTLS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD0D360)
