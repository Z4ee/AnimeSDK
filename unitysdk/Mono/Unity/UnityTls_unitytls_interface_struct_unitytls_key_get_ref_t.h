...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_GET_REF_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191FCE30)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_GET_REF_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191FCE70)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_GET_REF_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x191FCAF0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_GET_REF_T__CTOR_OFFSET UNITYSDK_OFFSET(0x191FCAE0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_key_get_ref_t_TypeDefinitionIndex = 2551;
