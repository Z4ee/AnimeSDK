...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1938EF20)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1938EF60)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1938EBE0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1938EBD0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_notify_close_t_TypeDefinitionIndex = 2577;
