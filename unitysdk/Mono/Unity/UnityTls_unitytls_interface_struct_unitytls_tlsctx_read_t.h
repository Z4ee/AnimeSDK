...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A0A9760)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0A97E0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0A93E0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A93C0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_read_t_TypeDefinitionIndex = 2385;
