...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_CREATE_CLIENT_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFDB890)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_CREATE_CLIENT_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFDB960)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_CREATE_CLIENT_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFDB280)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_CREATE_CLIENT_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDB270)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t_TypeDefinitionIndex = 2566;
