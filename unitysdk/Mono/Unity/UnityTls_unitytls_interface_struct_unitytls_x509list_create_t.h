...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_CREATE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A0F2F10)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_CREATE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0F2F40)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_CREATE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0F2BE0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_CREATE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F2BD0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_x509list_create_t_TypeDefinitionIndex = 2558;
