...
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_X509VERIFY_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E908280)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_X509VERIFY_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E908310)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_X509VERIFY_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E908260)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_X509VERIFY_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9081E0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_tlsctx_x509verify_callback_TypeDefinitionIndex = 2368;
