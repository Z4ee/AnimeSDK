...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A850270)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A8502F0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A850240)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8501C0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_tlsctx_set_supported_ciphersuites_t_TypeDefinitionIndex = 2385;
