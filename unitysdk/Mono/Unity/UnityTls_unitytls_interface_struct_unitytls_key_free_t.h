...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_FREE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1866BB90)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_FREE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1866BBC0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_FREE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1866B850)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_FREE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1866B830)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_key_free_t_TypeDefinitionIndex = 2364;
