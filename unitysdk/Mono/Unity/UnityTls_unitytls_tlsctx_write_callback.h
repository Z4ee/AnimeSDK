...
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18673C20)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18673CA0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x186738A0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18673880)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_tlsctx_write_callback_TypeDefinitionIndex = 2352;
