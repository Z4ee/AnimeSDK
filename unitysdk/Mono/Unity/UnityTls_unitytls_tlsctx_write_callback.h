...
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF18440)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF184C0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF18410)
#define MONO_UNITY_UNITYTLS_UNITYTLS_TLSCTX_WRITE_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF18390)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_tlsctx_write_callback_TypeDefinitionIndex = 2353;
