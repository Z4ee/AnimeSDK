...
#define MONO_UNITY_UNITYTLSCONTEXT_CERTIFICATECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x19200910)
#define MONO_UNITY_UNITYTLSCONTEXT_CERTIFICATECALLBACK_OFFSET UNITYSDK_OFFSET(0x191FDA20)
#define MONO_UNITY_UNITYTLSCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191FF950)
#define MONO_UNITY_UNITYTLSCONTEXT_EXTRACTNATIVEKEYANDCHAINFROMMANAGEDCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x191FECB0)
#define MONO_UNITY_UNITYTLSCONTEXT_FINISHHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x191FFFF0)
#define MONO_UNITY_UNITYTLSCONTEXT_FLUSH_OFFSET UNITYSDK_OFFSET(0x191FF0D0)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_CONNECTIONINFO_OFFSET UNITYSDK_OFFSET(0x191FF070)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_HASCONTEXT_OFFSET UNITYSDK_OFFSET(0x191FF050)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x191FF060)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_ISREMOTECERTIFICATEAVAILABLE_OFFSET UNITYSDK_OFFSET(0x191FF080)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_LOCALCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x191FF090)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_NEGOTIATEDPROTOCOL_OFFSET UNITYSDK_OFFSET(0x191FF0B0)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_REMOTECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x191FF0A0)
#define MONO_UNITY_UNITYTLSCONTEXT_PROCESSHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x191FFD50)
#define MONO_UNITY_UNITYTLSCONTEXT_READCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x19200470)
#define MONO_UNITY_UNITYTLSCONTEXT_READCALLBACK_OFFSET UNITYSDK_OFFSET(0x191FD7C0)
#define MONO_UNITY_UNITYTLSCONTEXT_READ_OFFSET UNITYSDK_OFFSET(0x191FF0E0)
#define MONO_UNITY_UNITYTLSCONTEXT_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x191FF5B0)
#define MONO_UNITY_UNITYTLSCONTEXT_STARTHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x191FFA50)
#define MONO_UNITY_UNITYTLSCONTEXT_TRACECALLBACK_OFFSET UNITYSDK_OFFSET(0x191FDB70)
#define MONO_UNITY_UNITYTLSCONTEXT_VERIFYCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x192007E0)
#define MONO_UNITY_UNITYTLSCONTEXT_VERIFYCALLBACK_OFFSET UNITYSDK_OFFSET(0x191FD900)
#define MONO_UNITY_UNITYTLSCONTEXT_WRITECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x19200280)
#define MONO_UNITY_UNITYTLSCONTEXT_WRITECALLBACK_OFFSET UNITYSDK_OFFSET(0x191FD680)
#define MONO_UNITY_UNITYTLSCONTEXT_WRITE_OFFSET UNITYSDK_OFFSET(0x191FF350)
#define MONO_UNITY_UNITYTLSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x191FDD20)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTlsContext_TypeDefinitionIndex = 2580;

	class UnityTlsContext : public ::Mono::Net::Security::MobileTlsContext
	{
	public:
		// static const ::System::Boolean ActivateTracing; // 0x0
		::Mono::Unity::UnityTls_unitytls_tlsctx_read_callback* readCallback; // 0x48
		::Mono::Security::Interface::MonoTlsConnectionInfo* connectioninfo; // 0x50
		...
		::Mono::Unity::UnityTls_unitytls_tlsctx_certificate_callback* certificateCallback; // 0x70
		::Il2CppArray<::System::Byte>* writeBuffer; // 0x78
		::Il2CppArray<::System::Byte>* readBuffer; // 0x80
		::Mono::Unity::UnityTls_unitytls_tlsctx_trace_callback* traceCallback; // 0x88
		::Mono::Unity::UnityTls_unitytls_tlsctx_write_callback* writeCallback; // 0x90
		::System::Exception* lastException; // 0x98
		::Mono::Unity::UnityTls_unitytls_x509list* requestedClientCertChain; // 0xA0
		::System::Runtime::InteropServices::GCHandle handle; // 0xA8
		::System::Boolean closedGraceful; // 0xAC
		::System::Boolean hasContext; // 0xAD
		::System::Boolean isAuthenticated; // 0xAE
