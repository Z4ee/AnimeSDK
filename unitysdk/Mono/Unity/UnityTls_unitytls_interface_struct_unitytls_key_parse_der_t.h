...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_PARSE_DER_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A0A68D0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_PARSE_DER_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0A6970)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_PARSE_DER_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0A6510)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_KEY_PARSE_DER_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A64F0)

namespace Mono::Unity
{
	inline static constexpr unsigned int UnityTls_unitytls_interface_struct_unitytls_key_parse_der_t_TypeDefinitionIndex = 2363;
