...
#define MONO_DATACONVERTER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1A6AC750)
#define MONO_DATACONVERTER_CHECK_OFFSET UNITYSDK_OFFSET(0x1A6B01C0)
#define MONO_DATACONVERTER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1A6AC360)
#define MONO_DATACONVERTER_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x1A6AC3D0)
#define MONO_DATACONVERTER_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x1A6AC440)
#define MONO_DATACONVERTER_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x1A6AC4B0)
#define MONO_DATACONVERTER_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x1A6AC520)
#define MONO_DATACONVERTER_GETBYTES_6_OFFSET UNITYSDK_OFFSET(0x1A6AC590)
#define MONO_DATACONVERTER_GETBYTES_7_OFFSET UNITYSDK_OFFSET(0x1A6AC600)
#define MONO_DATACONVERTER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1A6AC2F0)
#define MONO_DATACONVERTER_GET_BIGENDIAN_OFFSET UNITYSDK_OFFSET(0x1A6AC6E0)
#define MONO_DATACONVERTER_GET_LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A6AC670)
#define MONO_DATACONVERTER_PACKONE_OFFSET UNITYSDK_OFFSET(0x1A6AC970)
#define MONO_DATACONVERTER_PACK_OFFSET UNITYSDK_OFFSET(0x1A6AC770)
#define MONO_DATACONVERTER_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A6AE5C0)
#define MONO_DATACONVERTER_UNPACK_OFFSET UNITYSDK_OFFSET(0x1A6AE660)
#define MONO_DATACONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6B0280)
#define MONO_DATACONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B0270)
