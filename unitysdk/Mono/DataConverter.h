...
#define MONO_DATACONVERTER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1C9C0A60)
#define MONO_DATACONVERTER_CHECK_OFFSET UNITYSDK_OFFSET(0x1C9C44C0)
#define MONO_DATACONVERTER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1C9C0670)
#define MONO_DATACONVERTER_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x1C9C06E0)
#define MONO_DATACONVERTER_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x1C9C0750)
#define MONO_DATACONVERTER_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x1C9C07C0)
#define MONO_DATACONVERTER_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x1C9C0830)
#define MONO_DATACONVERTER_GETBYTES_6_OFFSET UNITYSDK_OFFSET(0x1C9C08A0)
#define MONO_DATACONVERTER_GETBYTES_7_OFFSET UNITYSDK_OFFSET(0x1C9C0910)
#define MONO_DATACONVERTER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1C9C0600)
#define MONO_DATACONVERTER_GET_BIGENDIAN_OFFSET UNITYSDK_OFFSET(0x1C9C09F0)
#define MONO_DATACONVERTER_GET_LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1C9C0980)
#define MONO_DATACONVERTER_PACKONE_OFFSET UNITYSDK_OFFSET(0x1C9C0C80)
#define MONO_DATACONVERTER_PACK_OFFSET UNITYSDK_OFFSET(0x1C9C0A80)
#define MONO_DATACONVERTER_PREPARE_OFFSET UNITYSDK_OFFSET(0x1C9C28D0)
#define MONO_DATACONVERTER_UNPACK_OFFSET UNITYSDK_OFFSET(0x1C9C2970)
#define MONO_DATACONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C9C4580)
#define MONO_DATACONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9C4570)
