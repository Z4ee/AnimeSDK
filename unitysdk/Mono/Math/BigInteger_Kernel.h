...
#define MONO_MATH_BIGINTEGER_KERNEL_ADDSAMESIGN_OFFSET UNITYSDK_OFFSET(0x1E0372F0)
#define MONO_MATH_BIGINTEGER_KERNEL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1E037D00)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIVMOD_OFFSET UNITYSDK_OFFSET(0x1E038210)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIV_OFFSET UNITYSDK_OFFSET(0x1E038060)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDMOD_OFFSET UNITYSDK_OFFSET(0x1E037FD0)
#define MONO_MATH_BIGINTEGER_KERNEL_GCD_OFFSET UNITYSDK_OFFSET(0x1E0399A0)
#define MONO_MATH_BIGINTEGER_KERNEL_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x1E038DF0)
#define MONO_MATH_BIGINTEGER_KERNEL_MINUSEQ_OFFSET UNITYSDK_OFFSET(0x1E0378E0)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_1_OFFSET UNITYSDK_OFFSET(0x1E039E20)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x1E039C50)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIBYTEDIVIDE_OFFSET UNITYSDK_OFFSET(0x1E0384F0)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYBYDWORD_OFFSET UNITYSDK_OFFSET(0x1E039370)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYMOD2P32PMOD_OFFSET UNITYSDK_OFFSET(0x1E039600)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E039510)
#define MONO_MATH_BIGINTEGER_KERNEL_PLUSEQ_OFFSET UNITYSDK_OFFSET(0x1E037A60)
#define MONO_MATH_BIGINTEGER_KERNEL_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x1E039100)
#define MONO_MATH_BIGINTEGER_KERNEL_SINGLEBYTEDIVIDEINPLACE_OFFSET UNITYSDK_OFFSET(0x1E037EE0)
#define MONO_MATH_BIGINTEGER_KERNEL_SQUAREPOSITIVE_OFFSET UNITYSDK_OFFSET(0x1E039700)
#define MONO_MATH_BIGINTEGER_KERNEL_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1E037610)
#define MONO_MATH_BIGINTEGER_KERNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E03A9B0)

namespace Mono::Math
{
	inline static constexpr unsigned int BigInteger_Kernel_TypeDefinitionIndex = 2483;
