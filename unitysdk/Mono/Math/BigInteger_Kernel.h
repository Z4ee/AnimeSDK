...
#define MONO_MATH_BIGINTEGER_KERNEL_ADDSAMESIGN_OFFSET UNITYSDK_OFFSET(0x1F3ECC90)
#define MONO_MATH_BIGINTEGER_KERNEL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F3ED870)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIVMOD_OFFSET UNITYSDK_OFFSET(0x1F3EDE30)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIV_OFFSET UNITYSDK_OFFSET(0x1F3EDC80)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDMOD_OFFSET UNITYSDK_OFFSET(0x1F3EDB70)
#define MONO_MATH_BIGINTEGER_KERNEL_GCD_OFFSET UNITYSDK_OFFSET(0x1F3EF660)
#define MONO_MATH_BIGINTEGER_KERNEL_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x1F3EE9F0)
#define MONO_MATH_BIGINTEGER_KERNEL_MINUSEQ_OFFSET UNITYSDK_OFFSET(0x1F3ED3A0)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_1_OFFSET UNITYSDK_OFFSET(0x1F3EFAF0)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x1F3EF910)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIBYTEDIVIDE_OFFSET UNITYSDK_OFFSET(0x1F3EE100)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYBYDWORD_OFFSET UNITYSDK_OFFSET(0x1F3EEF50)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYMOD2P32PMOD_OFFSET UNITYSDK_OFFSET(0x1F3EF220)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1F3EF0F0)
#define MONO_MATH_BIGINTEGER_KERNEL_PLUSEQ_OFFSET UNITYSDK_OFFSET(0x1F3ED4F0)
#define MONO_MATH_BIGINTEGER_KERNEL_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x1F3EECF0)
#define MONO_MATH_BIGINTEGER_KERNEL_SINGLEBYTEDIVIDEINPLACE_OFFSET UNITYSDK_OFFSET(0x1F3EDA70)
#define MONO_MATH_BIGINTEGER_KERNEL_SQUAREPOSITIVE_OFFSET UNITYSDK_OFFSET(0x1F3EF360)
#define MONO_MATH_BIGINTEGER_KERNEL_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1F3ED080)
#define MONO_MATH_BIGINTEGER_KERNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3F0690)
