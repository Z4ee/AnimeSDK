...
#define MONO_MATH_BIGINTEGER_ADD_OFFSET UNITYSDK_OFFSET(0x1F504600)
#define MONO_MATH_BIGINTEGER_BITCOUNT_OFFSET UNITYSDK_OFFSET(0x1F5052B0)
#define MONO_MATH_BIGINTEGER_CLEARBIT_OFFSET UNITYSDK_OFFSET(0x1F5055D0)
#define MONO_MATH_BIGINTEGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1F505EC0)
#define MONO_MATH_BIGINTEGER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F505BE0)
#define MONO_MATH_BIGINTEGER_DIVID_1_OFFSET UNITYSDK_OFFSET(0x1F504C20)
#define MONO_MATH_BIGINTEGER_DIVID_OFFSET UNITYSDK_OFFSET(0x1F504B60)
#define MONO_MATH_BIGINTEGER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1F506030)
#define MONO_MATH_BIGINTEGER_GCD_OFFSET UNITYSDK_OFFSET(0x1F5061A0)
#define MONO_MATH_BIGINTEGER_GENERATEPSEUDOPRIME_OFFSET UNITYSDK_OFFSET(0x1F5066D0)
#define MONO_MATH_BIGINTEGER_GENERATERANDOM_1_OFFSET UNITYSDK_OFFSET(0x1F505070)
#define MONO_MATH_BIGINTEGER_GENERATERANDOM_OFFSET UNITYSDK_OFFSET(0x1F504E80)
#define MONO_MATH_BIGINTEGER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1F5056C0)
#define MONO_MATH_BIGINTEGER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1F505F20)
#define MONO_MATH_BIGINTEGER_GET_RNG_OFFSET UNITYSDK_OFFSET(0x1F504D70)
#define MONO_MATH_BIGINTEGER_INCR2_OFFSET UNITYSDK_OFFSET(0x1F506740)
#define MONO_MATH_BIGINTEGER_ISPROBABLEPRIME_OFFSET UNITYSDK_OFFSET(0x1F506230)
#define MONO_MATH_BIGINTEGER_LOWESTSETBIT_OFFSET UNITYSDK_OFFSET(0x1F505630)
#define MONO_MATH_BIGINTEGER_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x1F5061B0)
#define MONO_MATH_BIGINTEGER_MODPOW_OFFSET UNITYSDK_OFFSET(0x1F5061C0)
#define MONO_MATH_BIGINTEGER_MODULUS_1_OFFSET UNITYSDK_OFFSET(0x1F504960)
#define MONO_MATH_BIGINTEGER_MODULUS_2_OFFSET UNITYSDK_OFFSET(0x1F504AD0)
#define MONO_MATH_BIGINTEGER_MODULUS_OFFSET UNITYSDK_OFFSET(0x1F5046C0)
#define MONO_MATH_BIGINTEGER_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1F504D10)
#define MONO_MATH_BIGINTEGER_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1F504CB0)
#define MONO_MATH_BIGINTEGER_NEXTHIGHESTPRIME_OFFSET UNITYSDK_OFFSET(0x1F506670)
#define MONO_MATH_BIGINTEGER_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1F503000)
#define MONO_MATH_BIGINTEGER_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1F503B30)
#define MONO_MATH_BIGINTEGER_OP_DIVISION_1_OFFSET UNITYSDK_OFFSET(0x1F504250)
#define MONO_MATH_BIGINTEGER_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1F5041E0)
#define MONO_MATH_BIGINTEGER_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1F505A20)
#define MONO_MATH_BIGINTEGER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1F503C10)
#define MONO_MATH_BIGINTEGER_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1F505BA0)
#define MONO_MATH_BIGINTEGER_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1F505B60)
#define MONO_MATH_BIGINTEGER_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1F503450)
#define MONO_MATH_BIGINTEGER_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1F503520)
#define MONO_MATH_BIGINTEGER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1F5033B0)
#define MONO_MATH_BIGINTEGER_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1F505AC0)
#define MONO_MATH_BIGINTEGER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1F505960)
#define MONO_MATH_BIGINTEGER_OP_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x1F5045E0)
#define MONO_MATH_BIGINTEGER_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1F505BC0)
#define MONO_MATH_BIGINTEGER_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1F505B80)
#define MONO_MATH_BIGINTEGER_OP_MODULUS_1_OFFSET UNITYSDK_OFFSET(0x1F504090)
#define MONO_MATH_BIGINTEGER_OP_MODULUS_2_OFFSET UNITYSDK_OFFSET(0x1F5041A0)
#define MONO_MATH_BIGINTEGER_OP_MODULUS_OFFSET UNITYSDK_OFFSET(0x1F503E60)
#define MONO_MATH_BIGINTEGER_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1F503A60)
#define MONO_MATH_BIGINTEGER_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1F504290)
#define MONO_MATH_BIGINTEGER_OP_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x1F5045F0)
#define MONO_MATH_BIGINTEGER_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1F503CD0)
#define MONO_MATH_BIGINTEGER_PARSE_OFFSET UNITYSDK_OFFSET(0x1F503570)
#define MONO_MATH_BIGINTEGER_RANDOMIZE_1_OFFSET UNITYSDK_OFFSET(0x1F5053B0)
#define MONO_MATH_BIGINTEGER_RANDOMIZE_OFFSET UNITYSDK_OFFSET(0x1F5050D0)
#define MONO_MATH_BIGINTEGER_SETBIT_1_OFFSET UNITYSDK_OFFSET(0x1F505540)
#define MONO_MATH_BIGINTEGER_SETBIT_OFFSET UNITYSDK_OFFSET(0x1F5054F0)
#define MONO_MATH_BIGINTEGER_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1F504660)
#define MONO_MATH_BIGINTEGER_TESTBIT_1_OFFSET UNITYSDK_OFFSET(0x1F505450)
#define MONO_MATH_BIGINTEGER_TESTBIT_OFFSET UNITYSDK_OFFSET(0x1F505410)
#define MONO_MATH_BIGINTEGER_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1F505C30)
#define MONO_MATH_BIGINTEGER_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x1F505FF0)
#define MONO_MATH_BIGINTEGER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F505BF0)
#define MONO_MATH_BIGINTEGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F5067E0)
#define MONO_MATH_BIGINTEGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F502A00)
#define MONO_MATH_BIGINTEGER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F502A50)
#define MONO_MATH_BIGINTEGER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F502BA0)
#define MONO_MATH_BIGINTEGER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1F502C90)
#define MONO_MATH_BIGINTEGER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1F503070)
#define MONO_MATH_BIGINTEGER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1F5032A0)
#define MONO_MATH_BIGINTEGER__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1F503310)
#define MONO_MATH_BIGINTEGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5029B0)
