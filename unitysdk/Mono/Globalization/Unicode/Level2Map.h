...
#define MONO_GLOBALIZATION_UNICODE_LEVEL2MAP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4CA20)

namespace Mono::Globalization::Unicode
{
	inline static constexpr unsigned int Level2Map_TypeDefinitionIndex = 37;
