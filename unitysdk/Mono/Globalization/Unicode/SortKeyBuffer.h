...
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_APPENDBUFFERPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x16DECBF0)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_APPENDCJKEXTENSION_OFFSET UNITYSDK_OFFSET(0x16DE5B40)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_APPENDKANA_OFFSET UNITYSDK_OFFSET(0x16DE5C80)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_APPENDLEVEL5_OFFSET UNITYSDK_OFFSET(0x16DECC70)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_APPENDNORMAL_OFFSET UNITYSDK_OFFSET(0x16DE59B0)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_GETOPTIMIZEDLENGTH_OFFSET UNITYSDK_OFFSET(0x16DED580)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_GETRESULTANDRESET_OFFSET UNITYSDK_OFFSET(0x16DE5310)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_GETRESULT_OFFSET UNITYSDK_OFFSET(0x16DECD00)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x16DE49B0)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x16DECBE0)
#define MONO_GLOBALIZATION_UNICODE_SORTKEYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE49A0)
...
namespace Mono::Globalization::Unicode
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* l5b; // 0x30
		...
		::System::Int32 l4s; // 0x60
		::System::Int32 l5; // 0x64
		::System::Int32 l4w; // 0x68
		::System::Int32 l2; // 0x6C
		::System::Int32 l3; // 0x70
		::System::Int32 l4t; // 0x74
		::System::Boolean frenchSort; // 0x78
		::System::Boolean frenchSorted; // 0x79
		::System::Boolean processLevel2; // 0x7A
		::System::Globalization::CompareOptions options; // 0x7C
		::System::Int32 lcid; // 0x80
