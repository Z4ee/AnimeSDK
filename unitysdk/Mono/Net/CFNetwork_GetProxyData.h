...
#define MONO_NET_CFNETWORK_GETPROXYDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A311750)
#define MONO_NET_CFNETWORK_GETPROXYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A311770)

namespace Mono::Net
{
	inline static constexpr unsigned int CFNetwork_GetProxyData_TypeDefinitionIndex = 2600;
