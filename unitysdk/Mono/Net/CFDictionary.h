...
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATECOPY_OFFSET UNITYSDK_OFFSET(0x1C1BA570)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATEMUTABLECOPY_OFFSET UNITYSDK_OFFSET(0x1C1BA840)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATE_OFFSET UNITYSDK_OFFSET(0x1C1B9F10)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1C1BA4E0)
#define MONO_NET_CFDICTIONARY_COPY_OFFSET UNITYSDK_OFFSET(0x1C1BA600)
#define MONO_NET_CFDICTIONARY_FROMKEYSANDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1C1B9FE0)
#define MONO_NET_CFDICTIONARY_FROMOBJECTANDKEY_OFFSET UNITYSDK_OFFSET(0x1C1B9D80)
#define MONO_NET_CFDICTIONARY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1C1BA8D0)
#define MONO_NET_CFDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C1BA9C0)
#define MONO_NET_CFDICTIONARY_MUTABLECOPY_OFFSET UNITYSDK_OFFSET(0x1C1BA700)
#define MONO_NET_CFDICTIONARY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1B9A30)
#define MONO_NET_CFDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B9CF0)
