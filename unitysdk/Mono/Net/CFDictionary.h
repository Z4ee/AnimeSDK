...
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATECOPY_OFFSET UNITYSDK_OFFSET(0x19E225C0)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATEMUTABLECOPY_OFFSET UNITYSDK_OFFSET(0x19E22890)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATE_OFFSET UNITYSDK_OFFSET(0x19E21F60)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYGETVALUE_OFFSET UNITYSDK_OFFSET(0x19E22530)
#define MONO_NET_CFDICTIONARY_COPY_OFFSET UNITYSDK_OFFSET(0x19E22650)
#define MONO_NET_CFDICTIONARY_FROMKEYSANDOBJECTS_OFFSET UNITYSDK_OFFSET(0x19E22030)
#define MONO_NET_CFDICTIONARY_FROMOBJECTANDKEY_OFFSET UNITYSDK_OFFSET(0x19E21DD0)
#define MONO_NET_CFDICTIONARY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19E22920)
#define MONO_NET_CFDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19E22A10)
#define MONO_NET_CFDICTIONARY_MUTABLECOPY_OFFSET UNITYSDK_OFFSET(0x19E22750)
#define MONO_NET_CFDICTIONARY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E21A80)
#define MONO_NET_CFDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E21D40)

namespace Mono::Net
{
	inline static constexpr unsigned int CFDictionary_TypeDefinitionIndex = 2592;
