...
#define MONO_NET_CFBOOLEAN_CFBOOLEANGETVALUE_OFFSET UNITYSDK_OFFSET(0x1DB70960)
#define MONO_NET_CFBOOLEAN_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1DB705F0)
#define MONO_NET_CFBOOLEAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB70540)
#define MONO_NET_CFBOOLEAN_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DB704C0)
#define MONO_NET_CFBOOLEAN_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1DB70900)
#define MONO_NET_CFBOOLEAN_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1DB709E0)
#define MONO_NET_CFBOOLEAN_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1DB70530)
#define MONO_NET_CFBOOLEAN_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DB70770)
#define MONO_NET_CFBOOLEAN_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1DB70850)
#define MONO_NET_CFBOOLEAN_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1DB70680)
#define MONO_NET_CFBOOLEAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DB70020)
#define MONO_NET_CFBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB70440)
