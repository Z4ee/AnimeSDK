...
#define MONO_NET_CFBOOLEAN_CFBOOLEANGETVALUE_OFFSET UNITYSDK_OFFSET(0x1C6BEEA0)
#define MONO_NET_CFBOOLEAN_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C6BEB10)
#define MONO_NET_CFBOOLEAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C6BEA60)
#define MONO_NET_CFBOOLEAN_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C6BE9E0)
#define MONO_NET_CFBOOLEAN_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1C6BEE30)
#define MONO_NET_CFBOOLEAN_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1C6BEF20)
#define MONO_NET_CFBOOLEAN_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1C6BEA50)
#define MONO_NET_CFBOOLEAN_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C6BEC90)
#define MONO_NET_CFBOOLEAN_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1C6BED80)
#define MONO_NET_CFBOOLEAN_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C6BEBA0)
#define MONO_NET_CFBOOLEAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6BE530)
#define MONO_NET_CFBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6BE950)

namespace Mono::Net
{
	inline static constexpr unsigned int CFBoolean_TypeDefinitionIndex = 2603;
