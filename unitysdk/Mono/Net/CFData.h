...
#define MONO_NET_CFDATA_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x1C2DB0F0)
#define MONO_NET_CFDATA_CFDATAGETBYTEPTR_OFFSET UNITYSDK_OFFSET(0x1C2DB430)
#define MONO_NET_CFDATA_CFDATAGETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C2DB3B0)
#define MONO_NET_CFDATA_FROMDATA_1_OFFSET UNITYSDK_OFFSET(0x1C2DB260)
#define MONO_NET_CFDATA_FROMDATA_OFFSET UNITYSDK_OFFSET(0x1C2DB180)
#define MONO_NET_CFDATA_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x1C2DB4B0)
#define MONO_NET_CFDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C2DB530)
#define MONO_NET_CFDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1C2DB330)
#define MONO_NET_CFDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C2DB690)
#define MONO_NET_CFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DB060)

namespace Mono::Net
{
	inline static constexpr unsigned int CFData_TypeDefinitionIndex = 2590;
