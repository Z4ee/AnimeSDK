...
#define MONO_NET_CFDATA_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x1D69C120)
#define MONO_NET_CFDATA_CFDATAGETBYTEPTR_OFFSET UNITYSDK_OFFSET(0x1D69C460)
#define MONO_NET_CFDATA_CFDATAGETLENGTH_OFFSET UNITYSDK_OFFSET(0x1D69C3E0)
#define MONO_NET_CFDATA_FROMDATA_1_OFFSET UNITYSDK_OFFSET(0x1D69C290)
#define MONO_NET_CFDATA_FROMDATA_OFFSET UNITYSDK_OFFSET(0x1D69C1B0)
#define MONO_NET_CFDATA_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x1D69C4E0)
#define MONO_NET_CFDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D69C560)
#define MONO_NET_CFDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D69C360)
#define MONO_NET_CFDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D69C6C0)
#define MONO_NET_CFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69C0A0)
