...
#define MONO_NET_CFDATE_CFDATECREATE_OFFSET UNITYSDK_OFFSET(0x1DB70BB0)
#define MONO_NET_CFDATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1DB70C40)
#define MONO_NET_CFDATE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1DB70E20)
#define MONO_NET_CFDATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB70D70)
#define MONO_NET_CFDATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DB70B40)
#define MONO_NET_CFDATE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1DB70D60)
#define MONO_NET_CFDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB70AC0)
