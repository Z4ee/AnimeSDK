...
#define MONO_NET_CFMUTABLEDICTIONARY_CFDICTIONARYCREATEMUTABLE_OFFSET UNITYSDK_OFFSET(0x1CEBEE80)
#define MONO_NET_CFMUTABLEDICTIONARY_CFDICTIONARYSETVALUE_OFFSET UNITYSDK_OFFSET(0x1CEBECB0)
#define MONO_NET_CFMUTABLEDICTIONARY_CREATE_OFFSET UNITYSDK_OFFSET(0x1CEBED40)
#define MONO_NET_CFMUTABLEDICTIONARY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1CEBEC20)
#define MONO_NET_CFMUTABLEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEBEB30)
