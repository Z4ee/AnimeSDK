...
#define MONO_NET_CFARRAY_CFARRAYCREATE_OFFSET UNITYSDK_OFFSET(0x1A7D1800)
#define MONO_NET_CFARRAY_CFARRAYGETCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7D2170)
#define MONO_NET_CFARRAY_CFARRAYGETVALUEATINDEX_OFFSET UNITYSDK_OFFSET(0x1A7D22D0)
#define MONO_NET_CFARRAY_CREATEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1A7D2100)
#define MONO_NET_CFARRAY_CREATEARRAY_OFFSET UNITYSDK_OFFSET(0x1A7D1F40)
#define MONO_NET_CFARRAY_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A7D1B40)
#define MONO_NET_CFARRAY_CREATE_OFFSET UNITYSDK_OFFSET(0x1A7D1E00)
#define MONO_NET_CFARRAY_FROMNATIVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A7D1AD0)
#define MONO_NET_CFARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A7D21F0)
#define MONO_NET_CFARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A7D2360)
#define MONO_NET_CFARRAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7D18A0)
#define MONO_NET_CFARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D1770)
