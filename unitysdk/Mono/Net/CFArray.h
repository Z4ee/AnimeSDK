...
#define MONO_NET_CFARRAY_CFARRAYCREATE_OFFSET UNITYSDK_OFFSET(0x1CAE52F0)
#define MONO_NET_CFARRAY_CFARRAYGETCOUNT_OFFSET UNITYSDK_OFFSET(0x1CAE5C60)
#define MONO_NET_CFARRAY_CFARRAYGETVALUEATINDEX_OFFSET UNITYSDK_OFFSET(0x1CAE5DC0)
#define MONO_NET_CFARRAY_CREATEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1CAE5BF0)
#define MONO_NET_CFARRAY_CREATEARRAY_OFFSET UNITYSDK_OFFSET(0x1CAE5A30)
#define MONO_NET_CFARRAY_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1CAE5630)
#define MONO_NET_CFARRAY_CREATE_OFFSET UNITYSDK_OFFSET(0x1CAE58F0)
#define MONO_NET_CFARRAY_FROMNATIVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1CAE55C0)
#define MONO_NET_CFARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1CAE5CE0)
#define MONO_NET_CFARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CAE5E50)
#define MONO_NET_CFARRAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CAE5390)
#define MONO_NET_CFARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE5260)
