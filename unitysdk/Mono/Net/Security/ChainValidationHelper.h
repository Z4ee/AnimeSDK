...
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_CLONEWITHCALLBACKWRAPPER_OFFSET UNITYSDK_OFFSET(0x1AFD9DE0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AFDA1E0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_DEFAULTSELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AFDA2E0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AFD9CF0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AFD98D0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_HASCERTIFICATESELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AFDA340)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1AFDA320)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1AFDA330)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_INVOKECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AFDA0B0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_INVOKESYSTEMVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AFDAE40)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_SELECTCLIENTCERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1AFDA390)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_SELECTCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AFDA350)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1AFDA8A0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AFDA700)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECHAIN_1_OFFSET UNITYSDK_OFFSET(0x1AFDAA50)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECHAIN_OFFSET UNITYSDK_OFFSET(0x1AFDA630)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AFDA3B0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFD9960)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD9F60)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int ChainValidationHelper_TypeDefinitionIndex = 2620;
	...
	public:
		...
		::System::Net::Security::LocalCertSelectionCallback* certSelectionCallback; // 0x20
		::System::Net::HttpWebRequest* request; // 0x28
		::Mono::Net::Security::ServerCertValidationCallbackWrapper* callbackWrapper; // 0x30
		::System::Net::ServerCertValidationCallback* certValidationCallback; // 0x38
		::Mono::Security::Interface::MonoTlsProvider* provider; // 0x40
		::Mono::Security::Interface::MonoTlsSettings* settings; // 0x48
