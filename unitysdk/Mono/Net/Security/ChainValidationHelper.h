...
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_CLONEWITHCALLBACKWRAPPER_OFFSET UNITYSDK_OFFSET(0x1D4507F0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1D450BE0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_DEFAULTSELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D450CE0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1D450700)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1D4502E0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_HASCERTIFICATESELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D450D40)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1D450D20)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1D450D30)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_INVOKECALLBACK_OFFSET UNITYSDK_OFFSET(0x1D450AB0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_INVOKESYSTEMVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1D451840)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_SELECTCLIENTCERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1D450D90)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_SELECTCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1D450D50)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1D4512A0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1D451100)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECHAIN_1_OFFSET UNITYSDK_OFFSET(0x1D451450)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECHAIN_OFFSET UNITYSDK_OFFSET(0x1D451030)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1D450DB0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D450370)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D450970)
...
namespace Mono::Net::Security
{
	...
	{
	public:
		::System::Net::ServerCertValidationCallback* certValidationCallback; // 0x10
		...
		::Mono::Net::Security::MonoTlsStream* tlsStream; // 0x40
