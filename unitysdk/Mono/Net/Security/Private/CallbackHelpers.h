...
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOMONO_1_OFFSET UNITYSDK_OFFSET(0x1D3EB290)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOMONO_OFFSET UNITYSDK_OFFSET(0x1D3EB170)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOPUBLIC_OFFSET UNITYSDK_OFFSET(0x1D3EB200)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1D3EB4D0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D3EB440)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOPUBLIC_1_OFFSET UNITYSDK_OFFSET(0x1D3EB3B0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOPUBLIC_OFFSET UNITYSDK_OFFSET(0x1D3EB320)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_PUBLICTOMONO_1_OFFSET UNITYSDK_OFFSET(0x1D3EB0E0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_PUBLICTOMONO_OFFSET UNITYSDK_OFFSET(0x1D3EB050)
