...
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOMONO_1_OFFSET UNITYSDK_OFFSET(0x19AD76C0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOMONO_OFFSET UNITYSDK_OFFSET(0x19AD75A0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOPUBLIC_OFFSET UNITYSDK_OFFSET(0x19AD7630)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x19AD7900)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x19AD7870)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOPUBLIC_1_OFFSET UNITYSDK_OFFSET(0x19AD77E0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOPUBLIC_OFFSET UNITYSDK_OFFSET(0x19AD7750)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_PUBLICTOMONO_1_OFFSET UNITYSDK_OFFSET(0x19AD7510)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_PUBLICTOMONO_OFFSET UNITYSDK_OFFSET(0x19AD7480)

namespace Mono::Net::Security::Private
{
	inline static constexpr unsigned int CallbackHelpers_TypeDefinitionIndex = 2634;
