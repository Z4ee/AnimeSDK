...
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18669420)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS___C__DISPLAYCLASS8_0__MONOTOINTERNAL_B__0_OFFSET UNITYSDK_OFFSET(0x18669470)

namespace Mono::Net::Security::Private
{
	inline static constexpr unsigned int CallbackHelpers___c__DisplayClass8_0_TypeDefinitionIndex = 2439;
