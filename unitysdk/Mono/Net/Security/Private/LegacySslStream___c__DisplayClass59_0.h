...
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__DISPLAYCLASS59_0__BEGINAUTHENTICATEASSERVER_B__0_OFFSET UNITYSDK_OFFSET(0x1BEB0E50)
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__DISPLAYCLASS59_0__BEGINAUTHENTICATEASSERVER_B__1_OFFSET UNITYSDK_OFFSET(0x1BEB0EF0)
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB0E40)
