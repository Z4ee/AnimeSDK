...
#define MONO_NET_SECURITY_ASYNCREADORWRITEREQUEST_GET_CURRENTSIZE_OFFSET UNITYSDK_OFFSET(0x191FC070)
#define MONO_NET_SECURITY_ASYNCREADORWRITEREQUEST_GET_USERBUFFER_OFFSET UNITYSDK_OFFSET(0x191FC060)
#define MONO_NET_SECURITY_ASYNCREADORWRITEREQUEST_SET_CURRENTSIZE_OFFSET UNITYSDK_OFFSET(0x191FC080)
#define MONO_NET_SECURITY_ASYNCREADORWRITEREQUEST_TOSTRING_OFFSET UNITYSDK_OFFSET(0x191FC120)
#define MONO_NET_SECURITY_ASYNCREADORWRITEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x191FC090)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int AsyncReadOrWriteRequest_TypeDefinitionIndex = 2615;
