...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C645CA0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x1C645A80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x1C644CD0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1C644BD0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C645EE0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVERASYNC_OFFSET UNITYSDK_OFFSET(0x1C645EC0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x1C645550)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1C645530)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x1C645270)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1C645150)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x1C6457C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1C645790)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1C646470)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1C646730)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_CHECKTHROW_OFFSET UNITYSDK_OFFSET(0x1C644630)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_DEBUG_OFFSET UNITYSDK_OFFSET(0x1C6472F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C648270)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1C6454B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1C645A00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1C6466C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1C646980)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C6485D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETCONNECTIONINFO_OFFSET UNITYSDK_OFFSET(0x1C648980)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETIOEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C644A30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETSSPIEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C6448D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_AUTHENTICATEDSTREAM_OFFSET UNITYSDK_OFFSET(0x1C646460)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1C648B20)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1C648D70)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C648C30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1C648C60)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CHECKCERTREVOCATIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1C6494B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CIPHERALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C6490B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CIPHERSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1C6493C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_DEFAULTPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1C644BC0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C644620)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C6491B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASHSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1C649410)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_INTERNALLOCALCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1C648870)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1C6447F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1C648E30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1C6480B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISSERVER_OFFSET UNITYSDK_OFFSET(0x1C648050)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x1C648F10)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_KEYEXCHANGEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1C6492C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_KEYEXCHANGESTRENGTH_OFFSET UNITYSDK_OFFSET(0x1C649460)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1C648D80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_LOCALCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1C6487B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C648DB0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1C644610)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C648FF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_REMOTECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1C6486E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1C644600)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SSLPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1C648600)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1C6445F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_TRANSPORTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C648AD0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C649050)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INNERREAD_OFFSET UNITYSDK_OFFSET(0x1C647890)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INNERWRITE_OFFSET UNITYSDK_OFFSET(0x1C647A10)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALREAD_1_OFFSET UNITYSDK_OFFSET(0x1C647410)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALREAD_OFFSET UNITYSDK_OFFSET(0x1C647300)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALWRITE_1_OFFSET UNITYSDK_OFFSET(0x1C6476C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALWRITE_OFFSET UNITYSDK_OFFSET(0x1C6475C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x1C644F00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1C647BF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSREAD_OFFSET UNITYSDK_OFFSET(0x1C647DA0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1C647F80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSWRITE_OFFSET UNITYSDK_OFFSET(0x1C647E90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x1C646EB0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C646A00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1C648A50)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C644B90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C648AA0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C648DE0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C649020)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C649080)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SHUTDOWNASYNC_OFFSET UNITYSDK_OFFSET(0x1C646110)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_STARTOPERATION_OFFSET UNITYSDK_OFFSET(0x1C6462F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x1C6470D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1C646C60)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1C646C40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C649500)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6442E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERWRITE_B__67_0_OFFSET UNITYSDK_OFFSET(0x1C649510)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int MobileAuthenticatedStream_TypeDefinitionIndex = 2621;
	...
	public:
		...
		::Mono::Security::Interface::MonoTlsProvider* _Provider_k__BackingField; // 0x40
		::Mono::Net::Security::BufferOffsetSize2* readBuffer; // 0x48
		::Mono::Net::Security::AsyncProtocolRequest* asyncHandshakeRequest; // 0x50
		::Mono::Net::Security::AsyncProtocolRequest* asyncReadRequest; // 0x58
		::Mono::Net::Security::MobileTlsContext* xobileTlsContext; // 0x60
		...
		::System::Runtime::ExceptionServices::ExceptionDispatchInfo* lastException; // 0x80
		::Mono::Security::Interface::MonoTlsSettings* _Settings_k__BackingField; // 0x88
