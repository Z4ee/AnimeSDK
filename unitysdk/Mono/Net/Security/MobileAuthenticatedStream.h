...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1DAA9D40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x1DAA9B30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x1DAA8D70)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1DAA8C70)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1DAA9F80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVERASYNC_OFFSET UNITYSDK_OFFSET(0x1DAA9F60)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x1DAA95F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1DAA95D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x1DAA9310)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1DAA91F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x1DAA9860)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1DAA9830)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1DAAA520)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1DAAA7E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_CHECKTHROW_OFFSET UNITYSDK_OFFSET(0x1DAA86C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_DEBUG_OFFSET UNITYSDK_OFFSET(0x1DAAB3A0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DAAC270)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x1DAA9550)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x1DAA9AB0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1DAAA770)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1DAAAA30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1DAAC5D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETCONNECTIONINFO_OFFSET UNITYSDK_OFFSET(0x1DAAC990)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETIOEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1DAA8AD0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETSSPIEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1DAA8960)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_AUTHENTICATEDSTREAM_OFFSET UNITYSDK_OFFSET(0x1DAAA510)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1DAACB30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1DAACD80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DAACC40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1DAACC70)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CHECKCERTREVOCATIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1DAAD4C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CIPHERALGORITHM_OFFSET UNITYSDK_OFFSET(0x1DAAD0C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CIPHERSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1DAAD3D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_DEFAULTPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1DAA8C60)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASCONTEXT_OFFSET UNITYSDK_OFFSET(0x1DAA86B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1DAAD1C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASHSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1DAAD420)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_INTERNALLOCALCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1DAAC880)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1DAA8880)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1DAACE40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1DAAC0B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISSERVER_OFFSET UNITYSDK_OFFSET(0x1DAAC050)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x1DAACF20)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_KEYEXCHANGEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1DAAD2D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_KEYEXCHANGESTRENGTH_OFFSET UNITYSDK_OFFSET(0x1DAAD470)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1DAACD90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_LOCALCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1DAAC7B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DAACDC0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1DAA86A0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DAAD000)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_REMOTECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1DAAC6E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1DAA8690)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SSLPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1DAAC600)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1DAA8680)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_TRANSPORTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1DAACAE0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DAAD060)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INNERREAD_OFFSET UNITYSDK_OFFSET(0x1DAAB900)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INNERWRITE_OFFSET UNITYSDK_OFFSET(0x1DAABA80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALREAD_1_OFFSET UNITYSDK_OFFSET(0x1DAAB4B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALREAD_OFFSET UNITYSDK_OFFSET(0x1DAAB3B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALWRITE_1_OFFSET UNITYSDK_OFFSET(0x1DAAB740)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALWRITE_OFFSET UNITYSDK_OFFSET(0x1DAAB640)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x1DAA8FA0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1DAABBF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSREAD_OFFSET UNITYSDK_OFFSET(0x1DAABDA0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1DAABF80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSWRITE_OFFSET UNITYSDK_OFFSET(0x1DAABE90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x1DAAAF60)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1DAAAAB0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1DAACA60)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1DAA8C30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1DAACAB0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DAACDF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DAAD030)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DAAD090)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SHUTDOWNASYNC_OFFSET UNITYSDK_OFFSET(0x1DAAA1C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_STARTOPERATION_OFFSET UNITYSDK_OFFSET(0x1DAAA3A0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x1DAAB180)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1DAAAD10)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1DAAACF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAAD510)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAA8370)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERWRITE_B__67_0_OFFSET UNITYSDK_OFFSET(0x1DAAD520)
...
namespace Mono::Net::Security
{
	...
	public:
		...
		::Mono::Net::Security::BufferOffsetSize2* writeBuffer; // 0x38
		...
		::Mono::Net::Security::BufferOffsetSize2* readBuffer; // 0x50
		...
		::System::Object* ioLock; // 0x80
		::System::Net::Security::SslStream* _SslStream_k__BackingField; // 0x88
		::System::Int32 ID; // 0x90
		::System::Int32 closeRequested; // 0x94
		::System::Boolean shutdown; // 0x98
