...
#define MONO_NET_SECURITY_ASYNCPROTOCOLREQUEST__INNERREAD_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A008D0)
#define MONO_NET_SECURITY_ASYNCPROTOCOLREQUEST__INNERREAD_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x38D1DC0)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int AsyncProtocolRequest__InnerRead_d__25_TypeDefinitionIndex = 2422;
