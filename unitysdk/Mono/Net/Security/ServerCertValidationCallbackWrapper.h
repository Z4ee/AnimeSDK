...
#define MONO_NET_SECURITY_SERVERCERTVALIDATIONCALLBACKWRAPPER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A84DC60)
#define MONO_NET_SECURITY_SERVERCERTVALIDATIONCALLBACKWRAPPER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A84DD00)
#define MONO_NET_SECURITY_SERVERCERTVALIDATIONCALLBACKWRAPPER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8457C0)
#define MONO_NET_SECURITY_SERVERCERTVALIDATIONCALLBACKWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A84DB70)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int ServerCertValidationCallbackWrapper_TypeDefinitionIndex = 2427;
