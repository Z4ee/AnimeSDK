...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERREAD_D__66_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A00900)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERREAD_D__66_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x38D1DC0)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int MobileAuthenticatedStream__InnerRead_d__66_TypeDefinitionIndex = 2434;
