...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERREAD_D__66_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x21006A0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERREAD_D__66_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x81E80)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int MobileAuthenticatedStream__InnerRead_d__66_TypeDefinitionIndex = 2429;
	...
	struct alignas(8) MobileAuthenticatedStream__InnerRead_d__66
	{
		...
		::System::Int32 requestedSize; // 0x4C
