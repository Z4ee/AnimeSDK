...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8A6A10)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x55E040)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int MobileAuthenticatedStream__ProcessAuthentication_d__47_TypeDefinitionIndex = 2624;
	...
	struct alignas(8) MobileAuthenticatedStream__ProcessAuthentication_d__47
	{
		...
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* clientCertificates; // 0x40
		::System::String* targetHost; // 0x48
		...
		::System::Boolean clientCertRequired; // 0x60
		::System::Boolean runSynchronously; // 0x61
		::System::Boolean serverMode; // 0x62
