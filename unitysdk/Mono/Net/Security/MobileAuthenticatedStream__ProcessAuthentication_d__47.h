...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BA4A00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2DF79F0)
...
namespace Mono::Net::Security
{
	...
	struct alignas(8) MobileAuthenticatedStream__ProcessAuthentication_d__47
	{
		...
		::System::Security::Cryptography::X509Certificates::X509Certificate* serverCertificate; // 0x48
