...
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_BUILDX509CHAIN_OFFSET UNITYSDK_OFFSET(0x1CBECD50)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKCERTIFICATEUSAGE_OFFSET UNITYSDK_OFFSET(0x1CBECEF0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1CBEDF30)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKSERVERIDENTITY_OFFSET UNITYSDK_OFFSET(0x1CBED310)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKUSAGE_OFFSET UNITYSDK_OFFSET(0x1CBECD60)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CREATEX509CHAIN_OFFSET UNITYSDK_OFFSET(0x1CBECC20)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_EVALUATESYSTEM_OFFSET UNITYSDK_OFFSET(0x1CBED6D0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1CBED810)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_MATCH_OFFSET UNITYSDK_OFFSET(0x1CBEDD40)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_NEEDSCHAIN_OFFSET UNITYSDK_OFFSET(0x1CBED900)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CBECC00)
...
namespace Mono::Net::Security
{
	...
	public:
		...
		{
			return (::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags*)Il2CppClass::FromTypeDefinitionIndex(SystemCertificateValidator_TypeDefinitionIndex)->GetStaticField(0x1250);
		}
		static ::System::Boolean* StaticGet_is_macosx()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SystemCertificateValidator_TypeDefinitionIndex)->GetStaticField(0x1254);
		}
