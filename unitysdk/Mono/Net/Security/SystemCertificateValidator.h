...
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_BUILDX509CHAIN_OFFSET UNITYSDK_OFFSET(0x1938D0D0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKCERTIFICATEUSAGE_OFFSET UNITYSDK_OFFSET(0x1938D270)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1938E290)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKSERVERIDENTITY_OFFSET UNITYSDK_OFFSET(0x1938D690)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKUSAGE_OFFSET UNITYSDK_OFFSET(0x1938D0E0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CREATEX509CHAIN_OFFSET UNITYSDK_OFFSET(0x1938CF90)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_EVALUATESYSTEM_OFFSET UNITYSDK_OFFSET(0x1938DA40)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1938DB80)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_MATCH_OFFSET UNITYSDK_OFFSET(0x1938E0A0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_NEEDSCHAIN_OFFSET UNITYSDK_OFFSET(0x1938DC70)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1938CF70)
