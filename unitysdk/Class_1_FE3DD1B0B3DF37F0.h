...
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x16F32AE0)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_1E1DB0E6F2E4BEAA_OFFSET UNITYSDK_OFFSET(0x16F322C0)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_3BB70D7328098C02_OFFSET UNITYSDK_OFFSET(0x16F32B30)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_3F2EAD367EB12147_OFFSET UNITYSDK_OFFSET(0x16F32740)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_5A0FAC6C7AC9D973_OFFSET UNITYSDK_OFFSET(0x16F325D0)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x16F32910)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x16F329A0)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x16F32570)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x16F32340)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x16F328D0)
#define CLASS_1_FE3DD1B0B3DF37F0_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x16F32A40)
#define CLASS_1_FE3DD1B0B3DF37F0__CCTOR_OFFSET UNITYSDK_OFFSET(0x16F32EA0)
...
public:
	...
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE3DD1B0B3DF37F0_TypeDefinitionIndex)->GetStaticField(0x3AD20);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_JHPLPOEEIFE()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE3DD1B0B3DF37F0_TypeDefinitionIndex)->GetStaticField(0x3AD28);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::B51RacingTrackRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE3DD1B0B3DF37F0_TypeDefinitionIndex)->GetStaticField(0x3AD30);
	}
	static ::System::Boolean* StaticGet_AHBLLGCADBB()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE3DD1B0B3DF37F0_TypeDefinitionIndex)->GetStaticField(0xF130);
	}
	static ::System::Byte* StaticGet_GDMLAIBCKIP()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE3DD1B0B3DF37F0_TypeDefinitionIndex)->GetStaticField(0xF131);
	}
