...
#define CLASS_2_44580E953508036F_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1060C070)
#define CLASS_2_44580E953508036F_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1060C110)
#define CLASS_2_44580E953508036F_METHOD_2_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x1060BAE0)
#define CLASS_2_44580E953508036F_METHOD_2_300DFD4123676691_OFFSET UNITYSDK_OFFSET(0x1060BE10)
#define CLASS_2_44580E953508036F_METHOD_2_3600F66F20C66537_OFFSET UNITYSDK_OFFSET(0x1060BC50)
#define CLASS_2_44580E953508036F_METHOD_2_376E493B62EC0CAE_OFFSET UNITYSDK_OFFSET(0x1060B4B0)
#define CLASS_2_44580E953508036F_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x1060A6A0)
#define CLASS_2_44580E953508036F_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x1060A610)
#define CLASS_2_44580E953508036F_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x1060C350)
#define CLASS_2_44580E953508036F_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1060C220)
#define CLASS_2_44580E953508036F_METHOD_2_6612072A232BE51E_OFFSET UNITYSDK_OFFSET(0x1060B670)
#define CLASS_2_44580E953508036F_METHOD_2_722E1524F560C8AF_OFFSET UNITYSDK_OFFSET(0x1060BEB0)
#define CLASS_2_44580E953508036F_METHOD_2_885DF4DA0F709E3E_OFFSET UNITYSDK_OFFSET(0x1060AF60)
#define CLASS_2_44580E953508036F_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x1060BBD0)
#define CLASS_2_44580E953508036F_METHOD_2_A693F2E8D4F4A766_OFFSET UNITYSDK_OFFSET(0x1060A8F0)
#define CLASS_2_44580E953508036F_METHOD_2_B435928465FCA059_OFFSET UNITYSDK_OFFSET(0x1060A800)
#define CLASS_2_44580E953508036F_METHOD_2_C20A8E714F76AB3E_OFFSET UNITYSDK_OFFSET(0x1060A960)
#define CLASS_2_44580E953508036F_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1060A4D0)
#define CLASS_2_44580E953508036F_METHOD_2_E0ACEB52BB92B9CC_OFFSET UNITYSDK_OFFSET(0x1060B810)
#define CLASS_2_44580E953508036F_METHOD_2_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x1060B360)
#define CLASS_2_44580E953508036F_METHOD_2_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0x1060AC10)
#define CLASS_2_44580E953508036F_METHOD_2_EB35513948B480FA_OFFSET UNITYSDK_OFFSET(0x1060B590)
#define CLASS_2_44580E953508036F_METHOD_2_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x1060BB70)
#define CLASS_2_44580E953508036F_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x1060BF70)
#define CLASS_2_44580E953508036F__CTOR_OFFSET UNITYSDK_OFFSET(0x1060C190)
#define CLASS_2_44580E953508036F__ONBIND_OFFSET UNITYSDK_OFFSET(0x10608FF0)
#define CLASS_2_44580E953508036F__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1060A510)
#define CLASS_2_44580E953508036F__ONTICK_OFFSET UNITYSDK_OFFSET(0x1060A560)
#define CLASS_2_44580E953508036F___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1060C3B0)
#define CLASS_2_44580E953508036F___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1060C410)
#define CLASS_2_44580E953508036F___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x1060C1C0)
#define CLASS_2_44580E953508036F___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1060C280)
#define CLASS_2_44580E953508036F___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x1060C2E0)

inline static constexpr unsigned int Class_2_44580E953508036F_TypeDefinitionIndex = 58389;
...
public:
	...
	::UnityEngine::Transform* Field_2_44; // 0x60
	::UnityEngine::Transform* Field_2_20; // 0x68
	::UnityEngine::UI::Image* Field_2_42; // 0x70
	...
	::UnityEngine::Transform* Field_2_24; // 0x98
	::UnityEngine::CanvasGroup* Field_2_0; // 0xA0
	::UnityEngine::CanvasGroup* Field_2_2; // 0xA8
	::UnityEngine::Transform* Field_2_37; // 0xB0
	::UnityEngine::RectTransform* Field_2_8; // 0xB8
	::UnityEngine::CanvasGroup* Field_2_1; // 0xC0
	::UnityEngine::Transform* Field_2_13; // 0xC8
	::UnityEngine::UI::Image* Field_2_41; // 0xD0
	::UnityEngine::Transform* Field_2_29; // 0xD8
	::UnityEngine::Transform* Field_2_4; // 0xE0
	::UnityEngine::Transform* Field_2_27; // 0xE8
	::UnityEngine::Transform* Field_2_7; // 0xF0
	::UnityEngine::Transform* Field_2_45; // 0xF8
	::UnityEngine::Transform* Field_2_31; // 0x100
	::RPG::GameCore::CharacterDataComponent* Field_2_48; // 0x108
	::UnityEngine::Transform* Field_2_32; // 0x110
	::UnityEngine::Transform* Field_2_26; // 0x118
	::UnityEngine::Transform* Field_2_18; // 0x120
	::UnityEngine::Transform* Field_2_34; // 0x128
	::UnityEngine::RectTransform* Field_2_9; // 0x130
	::UnityEngine::Transform* Field_2_10; // 0x138
	::UnityEngine::Transform* Field_2_21; // 0x140
	::UnityEngine::Animation* Field_2_46; // 0x148
	::UnityEngine::Transform* Field_2_36; // 0x150
	::UnityEngine::Transform* Field_2_25; // 0x158
	::UnityEngine::Transform* Field_2_16; // 0x160
	::UnityEngine::UI::Image* Field_2_39; // 0x168
	::UnityEngine::CanvasGroup* Field_2_3; // 0x170
	::RPG::GameCore::GameEntity* Field_2_47; // 0x178
	::UnityEngine::UI::Image* Field_2_40; // 0x180
	::UnityEngine::Transform* Field_2_11; // 0x188
	::UnityEngine::Transform* Field_2_23; // 0x190
	::UnityEngine::Transform* Field_2_28; // 0x198
	::UnityEngine::Transform* Field_2_19; // 0x1A0
	::UnityEngine::Transform* Field_2_22; // 0x1A8
	::UnityEngine::Transform* Field_2_5; // 0x1B0
	::UnityEngine::Transform* Field_2_30; // 0x1B8
	::UnityEngine::Transform* Field_2_12; // 0x1C0
	::UnityEngine::Transform* Field_2_38; // 0x1C8
	::UnityEngine::Transform* Field_2_43; // 0x1D0
	::UnityEngine::Transform* Field_2_35; // 0x1D8
	::UnityEngine::Transform* Field_2_33; // 0x1E0
	::RPG::GameCore::BattleLineupData* Field_2_49; // 0x1E8
