...
#define CLASS_3_B942B51FF20C85B4_METHOD_3_292FA0EEF6659E6F_OFFSET UNITYSDK_OFFSET(0x1AF8A210)
#define CLASS_3_B942B51FF20C85B4_METHOD_3_E29CAE0C7AB44E72_OFFSET UNITYSDK_OFFSET(0x1AF8A1D0)
#define CLASS_3_B942B51FF20C85B4__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF8A200)

inline static constexpr unsigned int Class_3_B942B51FF20C85B4_TypeDefinitionIndex = 20670;

class Class_3_B942B51FF20C85B4 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicFloat* Field_3_0; // 0x18
	::Il2CppArray<::RPG::GameCore::FiveDimTrainEnergyGear*>* Field_3_1; // 0x20
