...
#define CLASS_3_B942B51FF20C85B4_METHOD_3_292FA0EEF6659E6F_OFFSET UNITYSDK_OFFSET(0x19079510)
#define CLASS_3_B942B51FF20C85B4_METHOD_3_F73DE1E21818E48C_OFFSET UNITYSDK_OFFSET(0x19079490)
#define CLASS_3_B942B51FF20C85B4__CTOR_OFFSET UNITYSDK_OFFSET(0x190794E0)

inline static constexpr unsigned int Class_3_B942B51FF20C85B4_TypeDefinitionIndex = 20356;

class Class_3_B942B51FF20C85B4 : public ::RPG::GameCore::TaskConfig
{
public:
	::Il2CppArray<::RPG::GameCore::FiveDimTrainEnergyGear*>* Field_3_3; // 0x18
	::RPG::GameCore::DynamicFloat* Field_3_1; // 0x20
	::RPG::GameCore::DynamicFloat* Field_3_2; // 0x28
	::RPG::GameCore::DynamicString* Field_3_0; // 0x30
