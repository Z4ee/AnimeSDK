...
#define CLASS_2_5CCD0ECCAE145BCF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x165889E0)
#define CLASS_2_5CCD0ECCAE145BCF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16588A20)
#define CLASS_2_5CCD0ECCAE145BCF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16589140)
#define CLASS_2_5CCD0ECCAE145BCF_TICK_OFFSET UNITYSDK_OFFSET(0x16589190)
#define CLASS_2_5CCD0ECCAE145BCF__CTOR_OFFSET UNITYSDK_OFFSET(0x165889D0)

inline static constexpr unsigned int Class_2_5CCD0ECCAE145BCF_TypeDefinitionIndex = 58199;

class Class_2_5CCD0ECCAE145BCF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CreateCharacter* OFKGLJOAMLD; // 0x18
