...
#define CLASS_2_5CCD0ECCAE145BCF_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB9E9240)
#define CLASS_2_5CCD0ECCAE145BCF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB9E9280)
#define CLASS_2_5CCD0ECCAE145BCF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB9E99C0)
#define CLASS_2_5CCD0ECCAE145BCF_TICK_OFFSET UNITYSDK_OFFSET(0xB9E9A10)
#define CLASS_2_5CCD0ECCAE145BCF__CTOR_OFFSET UNITYSDK_OFFSET(0xB9E9230)

inline static constexpr unsigned int Class_2_5CCD0ECCAE145BCF_TypeDefinitionIndex = 54245;

class Class_2_5CCD0ECCAE145BCF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::CreateCharacter* Field_2_1; // 0x20
