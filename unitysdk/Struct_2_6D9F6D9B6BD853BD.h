...
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x879D00)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_340237F7579E924C_OFFSET UNITYSDK_OFFSET(0x879CF0)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x879C80)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x879CB0)
#define STRUCT_2_6D9F6D9B6BD853BD_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x879C00)
#define STRUCT_2_6D9F6D9B6BD853BD_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x879C40)
#define STRUCT_2_6D9F6D9B6BD853BD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0C8B30)
#define STRUCT_2_6D9F6D9B6BD853BD__CTOR_OFFSET UNITYSDK_OFFSET(0x879B80)

inline static constexpr unsigned int Struct_2_6D9F6D9B6BD853BD_TypeDefinitionIndex = 78807;

struct alignas(8) Struct_2_6D9F6D9B6BD853BD
{
	static ::Struct_2_6D9F6D9B6BD853BD* StaticGet_Field_2_5()
	{
		return (::Struct_2_6D9F6D9B6BD853BD*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6D9F6D9B6BD853BD_TypeDefinitionIndex)->GetStaticField(0x114B0);
	}
	::Struct_2_ABBDBB7B60DE9902 Field_2_0; // 0x10
	::System::Double Field_2_1; // 0x20
	::System::Byte Field_2_2; // 0x28
	::System::Double Field_2_3; // 0x30
	::Struct_2_ACD0EF80A5330786 Field_2_4; // 0x38
