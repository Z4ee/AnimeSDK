...
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x7039D0)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_340237F7579E924C_OFFSET UNITYSDK_OFFSET(0x7039C0)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x703950)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x703980)
#define STRUCT_2_6D9F6D9B6BD853BD_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x7038D0)
#define STRUCT_2_6D9F6D9B6BD853BD_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x703910)
#define STRUCT_2_6D9F6D9B6BD853BD__CCTOR_OFFSET UNITYSDK_OFFSET(0x10C477D0)
#define STRUCT_2_6D9F6D9B6BD853BD__CTOR_OFFSET UNITYSDK_OFFSET(0x703850)

inline static constexpr unsigned int Struct_2_6D9F6D9B6BD853BD_TypeDefinitionIndex = 68521;

struct alignas(8) Struct_2_6D9F6D9B6BD853BD
{
	static ::Struct_2_6D9F6D9B6BD853BD* StaticGet_Field_2_5()
	{
		return (::Struct_2_6D9F6D9B6BD853BD*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6D9F6D9B6BD853BD_TypeDefinitionIndex)->GetStaticField(0xEB80);
	}
