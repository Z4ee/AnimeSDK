...
#define MONOUIDAMAGETMPEFFECT_ANIMATETEXT_OFFSET UNITYSDK_OFFSET(0x11BF89B0)
#define MONOUIDAMAGETMPEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x11BF7060)
#define MONOUIDAMAGETMPEFFECT_CLEARCOROUTINE_OFFSET UNITYSDK_OFFSET(0x11BF76B0)
#define MONOUIDAMAGETMPEFFECT_DOUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x11BF8A90)
#define MONOUIDAMAGETMPEFFECT_GETCHARACTERFADEININTERVAL_OFFSET UNITYSDK_OFFSET(0x11BF8530)
#define MONOUIDAMAGETMPEFFECT_GETCHARACTERFADEOUTINTERVAL_OFFSET UNITYSDK_OFFSET(0x11BF8580)
#define MONOUIDAMAGETMPEFFECT_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x11BF8670)
#define MONOUIDAMAGETMPEFFECT_GETTEXTSCALE_OFFSET UNITYSDK_OFFSET(0x11BF85D0)
#define MONOUIDAMAGETMPEFFECT_GETTEXTSHOWTIME_OFFSET UNITYSDK_OFFSET(0x11BF8490)
#define MONOUIDAMAGETMPEFFECT_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x11BF7050)
#define MONOUIDAMAGETMPEFFECT_GET_ISPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0x11BF7040)
#define MONOUIDAMAGETMPEFFECT_INITDATA_OFFSET UNITYSDK_OFFSET(0x11BF71D0)
#define MONOUIDAMAGETMPEFFECT_MANUALUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x11BF8A30)
#define MONOUIDAMAGETMPEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11BF75C0)
#define MONOUIDAMAGETMPEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11BF7780)
#define MONOUIDAMAGETMPEFFECT_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x11BF7870)
#define MONOUIDAMAGETMPEFFECT_PLAYDAMAGEJUMPANIM_OFFSET UNITYSDK_OFFSET(0x11BF86C0)
#define MONOUIDAMAGETMPEFFECT_REFRESHCOMBINEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x11BF78C0)
#define MONOUIDAMAGETMPEFFECT_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x11BF97F0)
#define MONOUIDAMAGETMPEFFECT_SETDAMAGETEXTCOMBINE_OFFSET UNITYSDK_OFFSET(0x11BF79F0)
#define MONOUIDAMAGETMPEFFECT_SETDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x11BF7D90)
#define MONOUIDAMAGETMPEFFECT_SETFONTMATERIAL_OFFSET UNITYSDK_OFFSET(0x11BF7C00)
#define MONOUIDAMAGETMPEFFECT_UPDATETRSMATRIX_OFFSET UNITYSDK_OFFSET(0x11BF9860)
#define MONOUIDAMAGETMPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x11BF99B0)

inline static constexpr unsigned int MonoUIDamageTMPEffect_TypeDefinitionIndex = 59899;
