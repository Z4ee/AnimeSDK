...
#define CLASS_1_7034D7C52E05781E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185D4C50)
#define CLASS_1_7034D7C52E05781E_GET_BOUNDSOCCLUDERFORJOB_OFFSET UNITYSDK_OFFSET(0x185D6630)
#define CLASS_1_7034D7C52E05781E_METHOD_1_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x185D49A0)
#define CLASS_1_7034D7C52E05781E_METHOD_1_2A38E69140BEF946_OFFSET UNITYSDK_OFFSET(0x185D5670)
#define CLASS_1_7034D7C52E05781E_METHOD_1_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x185D5960)
#define CLASS_1_7034D7C52E05781E_METHOD_1_369BB5E7FA6A1768_OFFSET UNITYSDK_OFFSET(0x185D5570)
#define CLASS_1_7034D7C52E05781E_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x185D5310)
#define CLASS_1_7034D7C52E05781E_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x185D5FC0)
#define CLASS_1_7034D7C52E05781E_METHOD_1_5015A42C2D679D72_OFFSET UNITYSDK_OFFSET(0x185D41E0)
#define CLASS_1_7034D7C52E05781E_METHOD_1_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x185D4930)
#define CLASS_1_7034D7C52E05781E_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x185D4F30)
#define CLASS_1_7034D7C52E05781E_METHOD_1_8BC85DADEC2C3862_OFFSET UNITYSDK_OFFSET(0x185D44F0)
#define CLASS_1_7034D7C52E05781E_METHOD_1_8F0B0B3BBBDAAD6F_OFFSET UNITYSDK_OFFSET(0x185D6440)
#define CLASS_1_7034D7C52E05781E_METHOD_1_97D83E4CB3B11935_1_OFFSET UNITYSDK_OFFSET(0x185D5860)
#define CLASS_1_7034D7C52E05781E_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x185D5110)
#define CLASS_1_7034D7C52E05781E_METHOD_1_E041300CFBBD9160_OFFSET UNITYSDK_OFFSET(0x185D4FE0)
#define CLASS_1_7034D7C52E05781E_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x185D41B0)
#define CLASS_1_7034D7C52E05781E_METHOD_1_F296D77B5A1D1EA1_OFFSET UNITYSDK_OFFSET(0x185D6070)
#define CLASS_1_7034D7C52E05781E_METHOD_1_FF05AC0AB0D75A04_OFFSET UNITYSDK_OFFSET(0x185D59B0)
#define CLASS_1_7034D7C52E05781E_SET_BOUNDSOCCLUDERFORJOB_OFFSET UNITYSDK_OFFSET(0x185D6640)
#define CLASS_1_7034D7C52E05781E__CCTOR_OFFSET UNITYSDK_OFFSET(0x185D6650)
#define CLASS_1_7034D7C52E05781E__CTOR_OFFSET UNITYSDK_OFFSET(0x185D4260)
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x13270);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_ACGJKBIKNMN()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x13278);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_BHHLPBCJLBH()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x13280);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_BAHJOMPJPND()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x13288);
	}
	static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet_AKFFPNIDIMF()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x13290);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_OBPPGKLKLPB()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x13298);
	}
	static ::System::Boolean* StaticGet_BPFGBEHONML()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x7CC0);
	}
	static ::System::UInt32* StaticGet_EIEICCFEMBE()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7034D7C52E05781E_TypeDefinitionIndex)->GetStaticField(0x7CC4);
	}
	...
	::Class_2_961AF441B82A290C* HKPLKLDIFCM; // 0x10
	::RPG::GameCore::TickLodConfig* KNFFAILGFIF; // 0x18
	::System::Collections::Generic::List_1<::Class_1_27D9C028BDC40E5D*>* LEJLIIGIMEC; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_414BCDCDAD47B487*>* HPEHFHOBIGG; // 0x28
	::Class_1_D2B8D50DD9833CFC* _BoundsOccluderForJob_k__BackingField; // 0x30
	::System::Collections::Generic::List_1<::Class_1_27D9C028BDC40E5D*>* JJOFPLMDCMK; // 0x38
	::System::Collections::Generic::List_1<::Class_1_27D9C028BDC40E5D*>* MALPDHPDPDB; // 0x40
	::System::Nullable_1<::Unity::Jobs::JobHandle> CDBGDBNJOPF; // 0x48
	::System::Boolean DIECPKPBDEN; // 0x60
	::System::Boolean CPKCLCNMGHP; // 0x61
	::System::Boolean DKDLKJHNHNC; // 0x62
	::Struct_2_639D4030F98AB624 LHANPGLMHMD; // 0x68
