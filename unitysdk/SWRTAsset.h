...
#define SWRTASSET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1818B130)
#define SWRTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1818B450)

inline static constexpr unsigned int SWRTAsset_TypeDefinitionIndex = 34870;
