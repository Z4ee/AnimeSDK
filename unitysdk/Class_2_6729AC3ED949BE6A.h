...
#define CLASS_2_6729AC3ED949BE6A__CTOR_OFFSET UNITYSDK_OFFSET(0x1179B7B0)
...
{
public:
	::Class_0_16E4307DCC419505_469* Field_2_15; // 0x58
	::RPG::GameCore::BigFixPoint Field_2_5; // 0x60
	::RPG::GameCore::GameEntity* Field_2_12; // 0x70
	::RPG::GameCore::BigFixPoint Field_2_6; // 0x78
	::Class_1_9AD7EC315F99B05E* Field_2_1; // 0x88
	::Il2CppArray<::RPG::GameCore::AttackDamageType>* Field_2_11; // 0x90
	::RPG::GameCore::GameWorld* Field_2_0; // 0x98
	...
	::RPG::GameCore::WaveMonsterTiming Field_2_9; // 0xBC
	::System::Boolean Field_2_4; // 0xC0
	::System::Nullable_1<::RPG::GameCore::FixPoint> Field_2_8; // 0xC8
	::RPG::GameCore::FixPoint Field_2_3; // 0xD8
	::RPG::GameCore::FixPoint Field_2_2; // 0xE0
