...
#define SKIRTIK_HAIRBONEDATACLASS__CTOR_OFFSET UNITYSDK_OFFSET(0xABCFFB0)

inline static constexpr unsigned int SkirtIK_HairBoneDataClass_TypeDefinitionIndex = 38164;
