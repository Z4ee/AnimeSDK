...
#define CLASS_1_5B567C8A01BAEDFE_185_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1993A8C0)
#define CLASS_1_5B567C8A01BAEDFE_185_CLONE_OFFSET UNITYSDK_OFFSET(0x1993A6D0)
#define CLASS_1_5B567C8A01BAEDFE_185_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1993A7D0)
#define CLASS_1_5B567C8A01BAEDFE_185_EQUALS_OFFSET UNITYSDK_OFFSET(0x1993A740)
#define CLASS_1_5B567C8A01BAEDFE_185_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1993A820)
#define CLASS_1_5B567C8A01BAEDFE_185_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1993A910)
#define CLASS_1_5B567C8A01BAEDFE_185_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1993A8E0)
#define CLASS_1_5B567C8A01BAEDFE_185_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1993A620)
#define CLASS_1_5B567C8A01BAEDFE_185_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1993A680)
#define CLASS_1_5B567C8A01BAEDFE_185_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1993A850)
#define CLASS_1_5B567C8A01BAEDFE_185_WRITETO_OFFSET UNITYSDK_OFFSET(0x1993A8B0)
#define CLASS_1_5B567C8A01BAEDFE_185__CCTOR_OFFSET UNITYSDK_OFFSET(0x1993A960)
#define CLASS_1_5B567C8A01BAEDFE_185__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1993A6A0)
#define CLASS_1_5B567C8A01BAEDFE_185__CTOR_OFFSET UNITYSDK_OFFSET(0x1993A690)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_185_TypeDefinitionIndex = 28676;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_185*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_185_TypeDefinitionIndex)->GetStaticField(0x5DB30);
	}
