...
#define CLASS_2_18A6611020544E5C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x104C9840)
#define CLASS_2_18A6611020544E5C_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x104C9B60)
#define CLASS_2_18A6611020544E5C_METHOD_2_4470079B241DC9AC_OFFSET UNITYSDK_OFFSET(0x104CA8C0)
#define CLASS_2_18A6611020544E5C_METHOD_2_546A898B107DD9A0_OFFSET UNITYSDK_OFFSET(0x104CAF10)
#define CLASS_2_18A6611020544E5C_METHOD_2_54A38F8D8DAF21B2_OFFSET UNITYSDK_OFFSET(0x104CA5B0)
#define CLASS_2_18A6611020544E5C_METHOD_2_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0x104C98B0)
#define CLASS_2_18A6611020544E5C_METHOD_2_B4A92FBA9B14B708_OFFSET UNITYSDK_OFFSET(0x104CAB20)
#define CLASS_2_18A6611020544E5C_METHOD_2_B944848102CC2EEE_OFFSET UNITYSDK_OFFSET(0x104CB550)
#define CLASS_2_18A6611020544E5C_METHOD_2_C49BD18776DC458B_OFFSET UNITYSDK_OFFSET(0x104CA800)
#define CLASS_2_18A6611020544E5C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x104CA0E0)
#define CLASS_2_18A6611020544E5C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x104CAAB0)
#define CLASS_2_18A6611020544E5C_TICK_OFFSET UNITYSDK_OFFSET(0x104C9C20)
#define CLASS_2_18A6611020544E5C__CTOR_OFFSET UNITYSDK_OFFSET(0x104C9830)

inline static constexpr unsigned int Class_2_18A6611020544E5C_TypeDefinitionIndex = 43177;

class Class_2_18A6611020544E5C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::MonoCustomRotateItem* Field_2_8; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::Class_2_5B599AA9B6DFF68F* Field_2_4; // 0x28
	::RPG::GameCore::SwitchHandStateSync* Field_2_0; // 0x30
	::RPG::Client::MonoControllableHand* Field_2_5; // 0x38
	::RPG::GameCore::CharacterModelComponent* Field_2_3; // 0x40
	::UnityEngine::Transform* Field_2_7; // 0x48
	::RPG::Client::MonoHandOverlapTrigger* Field_2_6; // 0x50
