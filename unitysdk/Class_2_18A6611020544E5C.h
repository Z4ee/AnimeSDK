...
#define CLASS_2_18A6611020544E5C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1597D360)
#define CLASS_2_18A6611020544E5C_METHOD_2_14103B4D7F556AC2_OFFSET UNITYSDK_OFFSET(0x1597F590)
#define CLASS_2_18A6611020544E5C_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1597D780)
#define CLASS_2_18A6611020544E5C_METHOD_2_4470079B241DC9AC_OFFSET UNITYSDK_OFFSET(0x1597E760)
#define CLASS_2_18A6611020544E5C_METHOD_2_9B2E710EB9D49BA6_OFFSET UNITYSDK_OFFSET(0x1597D3C0)
#define CLASS_2_18A6611020544E5C_METHOD_2_B060EFAD670F0C83_OFFSET UNITYSDK_OFFSET(0x1597EEA0)
#define CLASS_2_18A6611020544E5C_METHOD_2_B4A92FBA9B14B708_OFFSET UNITYSDK_OFFSET(0x1597E9D0)
#define CLASS_2_18A6611020544E5C_METHOD_2_C065D9865AD72EAA_OFFSET UNITYSDK_OFFSET(0x1597E3A0)
#define CLASS_2_18A6611020544E5C_METHOD_2_C49BD18776DC458B_OFFSET UNITYSDK_OFFSET(0x1597E6A0)
#define CLASS_2_18A6611020544E5C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1597DE40)
#define CLASS_2_18A6611020544E5C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1597E960)
#define CLASS_2_18A6611020544E5C_TICK_OFFSET UNITYSDK_OFFSET(0x1597D840)
#define CLASS_2_18A6611020544E5C__CTOR_OFFSET UNITYSDK_OFFSET(0x1597D350)
...
{
public:
	::Class_2_5B599AA9B6DFF68F* NOLJIPMCEAK; // 0x18
	::RPG::GameCore::CharacterModelComponent* OFGPBOKLGJJ; // 0x20
	::UnityEngine::Transform* LNFLNINJBCN; // 0x28
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x30
	::RPG::GameCore::SwitchHandStateSync* IGHAHBNLIJA; // 0x38
	::RPG::Client::MonoControllableHand* KNBJLAPEIFJ; // 0x40
	::RPG::Client::MonoHandOverlapTrigger* KEJPFIAHINP; // 0x48
	::RPG::Client::MonoCustomRotateItem* KIOMFMKAPEH; // 0x50
