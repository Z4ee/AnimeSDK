...
#define CLASS_2_0D474CE0ACB61EB7_GET_ISULTRAMODE_OFFSET UNITYSDK_OFFSET(0x18509630)
#define CLASS_2_0D474CE0ACB61EB7_METHOD_2_11F90B354314AA3B_OFFSET UNITYSDK_OFFSET(0x185092A0)
#define CLASS_2_0D474CE0ACB61EB7_METHOD_2_15935C22F36A0728_OFFSET UNITYSDK_OFFSET(0x18509470)
#define CLASS_2_0D474CE0ACB61EB7_METHOD_2_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x18508EA0)
#define CLASS_2_0D474CE0ACB61EB7_METHOD_2_4C4EF158A7663D09_OFFSET UNITYSDK_OFFSET(0x18508D80)
#define CLASS_2_0D474CE0ACB61EB7_METHOD_2_7EEB862686CC49A7_OFFSET UNITYSDK_OFFSET(0x18508D20)
#define CLASS_2_0D474CE0ACB61EB7_METHOD_2_8D6AEC6345FD603D_OFFSET UNITYSDK_OFFSET(0x185094C0)
#define CLASS_2_0D474CE0ACB61EB7_SET_ISULTRAMODE_OFFSET UNITYSDK_OFFSET(0x18509640)
#define CLASS_2_0D474CE0ACB61EB7__CTOR_OFFSET UNITYSDK_OFFSET(0x18509650)
#define CLASS_2_0D474CE0ACB61EB7__ONBIND_OFFSET UNITYSDK_OFFSET(0x18508A50)
#define CLASS_2_0D474CE0ACB61EB7__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x18508B00)
#define CLASS_2_0D474CE0ACB61EB7___SETUPULTRABTNEFX_B__6_0_OFFSET UNITYSDK_OFFSET(0x185096F0)

inline static constexpr unsigned int Class_2_0D474CE0ACB61EB7_TypeDefinitionIndex = 71889;

class Class_2_0D474CE0ACB61EB7 : public ::Class_1_34917908B7833130
{
public:
	::UnityEngine::Transform* POGABPLIMMH; // 0x60
	::RPG::GameCore::SkillCharacterComponent* DLKGKDBPHOH; // 0x68
	::RPG::GameCore::DamageTypeRow* LPEJACFNIDK; // 0x70
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AttackDamageType, ::UnityEngine::Transform*>* IILGGIHNCMC; // 0x78
	::RPG::GameCore::CharacterDataComponent* HKCICBFPGGF; // 0x80
	::UnityEngine::UI::Image* NBOHBGJDNKF; // 0x88
