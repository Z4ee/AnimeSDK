...
#define CLASS_1_5B567C8A01BAEDFE_89_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4E5360)
#define CLASS_1_5B567C8A01BAEDFE_89_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4E5170)
#define CLASS_1_5B567C8A01BAEDFE_89_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4E5270)
#define CLASS_1_5B567C8A01BAEDFE_89_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4E51E0)
#define CLASS_1_5B567C8A01BAEDFE_89_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4E52C0)
#define CLASS_1_5B567C8A01BAEDFE_89_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4E53B0)
#define CLASS_1_5B567C8A01BAEDFE_89_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4E5380)
#define CLASS_1_5B567C8A01BAEDFE_89_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4E50C0)
#define CLASS_1_5B567C8A01BAEDFE_89_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4E5120)
#define CLASS_1_5B567C8A01BAEDFE_89_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4E52F0)
#define CLASS_1_5B567C8A01BAEDFE_89_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4E5350)
#define CLASS_1_5B567C8A01BAEDFE_89__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4E5400)
#define CLASS_1_5B567C8A01BAEDFE_89__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4E5140)
#define CLASS_1_5B567C8A01BAEDFE_89__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E5130)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_89_TypeDefinitionIndex = 26035;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_89*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_89_TypeDefinitionIndex)->GetStaticField(0x8650);
	}
