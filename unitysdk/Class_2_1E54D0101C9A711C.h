...
#define CLASS_2_1E54D0101C9A711C_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15EC0560)
#define CLASS_2_1E54D0101C9A711C_GET_FROMENTITY_OFFSET UNITYSDK_OFFSET(0x15EC0520)
#define CLASS_2_1E54D0101C9A711C_GET_TOENTITY_OFFSET UNITYSDK_OFFSET(0x15EC0540)
#define CLASS_2_1E54D0101C9A711C_METHOD_2_B990AAC12314EDF2_OFFSET UNITYSDK_OFFSET(0x15EC0AE0)
#define CLASS_2_1E54D0101C9A711C_SET_FROMENTITY_OFFSET UNITYSDK_OFFSET(0x15EC0530)
#define CLASS_2_1E54D0101C9A711C_SET_TOENTITY_OFFSET UNITYSDK_OFFSET(0x15EC0550)
#define CLASS_2_1E54D0101C9A711C__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC0E20)

inline static constexpr unsigned int Class_2_1E54D0101C9A711C_TypeDefinitionIndex = 51837;

class Class_2_1E54D0101C9A711C : public ::Class_1_6F2598F82A312737
{
public:
	::RPG::GameCore::GameEntity* _FromEntity_k__BackingField; // 0x20
	::RPG::GameCore::GameEntity* _ToEntity_k__BackingField; // 0x28
