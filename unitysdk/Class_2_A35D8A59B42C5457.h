...
#define CLASS_2_A35D8A59B42C5457_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89F1840)
#define CLASS_2_A35D8A59B42C5457_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x89F18E0)
#define CLASS_2_A35D8A59B42C5457_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89F1AD0)
#define CLASS_2_A35D8A59B42C5457_TICK_OFFSET UNITYSDK_OFFSET(0x89F1880)
#define CLASS_2_A35D8A59B42C5457__CTOR_OFFSET UNITYSDK_OFFSET(0x89F1830)

inline static constexpr unsigned int Class_2_A35D8A59B42C5457_TypeDefinitionIndex = 47076;

class Class_2_A35D8A59B42C5457 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropPuzzleEventSender* Field_2_1; // 0x18
