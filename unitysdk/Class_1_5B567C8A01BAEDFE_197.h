...
#define CLASS_1_5B567C8A01BAEDFE_197_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19441340)
#define CLASS_1_5B567C8A01BAEDFE_197_CLONE_OFFSET UNITYSDK_OFFSET(0x194411B0)
#define CLASS_1_5B567C8A01BAEDFE_197_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19441250)
#define CLASS_1_5B567C8A01BAEDFE_197_EQUALS_OFFSET UNITYSDK_OFFSET(0x194411F0)
#define CLASS_1_5B567C8A01BAEDFE_197_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x194412A0)
#define CLASS_1_5B567C8A01BAEDFE_197_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19441390)
#define CLASS_1_5B567C8A01BAEDFE_197_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19441360)
#define CLASS_1_5B567C8A01BAEDFE_197_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19441130)
#define CLASS_1_5B567C8A01BAEDFE_197_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19441160)
#define CLASS_1_5B567C8A01BAEDFE_197_TOSTRING_OFFSET UNITYSDK_OFFSET(0x194412D0)
#define CLASS_1_5B567C8A01BAEDFE_197_WRITETO_OFFSET UNITYSDK_OFFSET(0x19441330)
#define CLASS_1_5B567C8A01BAEDFE_197__CCTOR_OFFSET UNITYSDK_OFFSET(0x194413E0)
#define CLASS_1_5B567C8A01BAEDFE_197__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19441180)
#define CLASS_1_5B567C8A01BAEDFE_197__CTOR_OFFSET UNITYSDK_OFFSET(0x19441170)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_197_TypeDefinitionIndex = 28947;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_197*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_197_TypeDefinitionIndex)->GetStaticField(0x48130);
	}
