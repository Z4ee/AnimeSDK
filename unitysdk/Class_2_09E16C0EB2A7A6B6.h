...
#define CLASS_2_09E16C0EB2A7A6B6_METHOD_2_7835DD7D7F7FF1B7_OFFSET UNITYSDK_OFFSET(0x127B4D40)
#define CLASS_2_09E16C0EB2A7A6B6_METHOD_2_8CE71901D76EEEA9_OFFSET UNITYSDK_OFFSET(0x127B4B30)
#define CLASS_2_09E16C0EB2A7A6B6_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x127B4E10)
#define CLASS_2_09E16C0EB2A7A6B6__CTOR_OFFSET UNITYSDK_OFFSET(0x127B4E00)

inline static constexpr unsigned int Class_2_09E16C0EB2A7A6B6_TypeDefinitionIndex = 82243;
...
public:
	...
	::UnityEngine::UI::Extension::UIToggleButton* Field_2_9; // 0x38
