...
#define CLASS_2_BC1642CEE8AE3624_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18469110)
#define CLASS_2_BC1642CEE8AE3624__CTOR_OFFSET UNITYSDK_OFFSET(0x18469340)
...
public:
	...
	::System::UInt32 GBJLLAJJEOL; // 0x2C
