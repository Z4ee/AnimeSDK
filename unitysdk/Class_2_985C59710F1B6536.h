...
#define CLASS_2_985C59710F1B6536_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18742890)
#define CLASS_2_985C59710F1B6536_METHOD_2_3D8F0F1C6E55B9B6_OFFSET UNITYSDK_OFFSET(0x18743410)
#define CLASS_2_985C59710F1B6536_METHOD_2_8F5E775A33818F1D_OFFSET UNITYSDK_OFFSET(0x18742C70)
#define CLASS_2_985C59710F1B6536_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x187433C0)
#define CLASS_2_985C59710F1B6536_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x187434B0)
#define CLASS_2_985C59710F1B6536_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18742930)
#define CLASS_2_985C59710F1B6536_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18743460)
#define CLASS_2_985C59710F1B6536_TICK_OFFSET UNITYSDK_OFFSET(0x187428D0)
#define CLASS_2_985C59710F1B6536__CTOR_OFFSET UNITYSDK_OFFSET(0x18742880)
...
public:
	...
	::RPG::GameCore::AdvAINavigateTo* IGHAHBNLIJA; // 0x28
