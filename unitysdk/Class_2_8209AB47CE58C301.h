...
#define CLASS_2_8209AB47CE58C301_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE48ACA0)
#define CLASS_2_8209AB47CE58C301_METHOD_2_7FD7D34994C88765_OFFSET UNITYSDK_OFFSET(0xE48ACF0)
#define CLASS_2_8209AB47CE58C301_METHOD_2_A5C4135A88AD533A_1_OFFSET UNITYSDK_OFFSET(0xE48B500)
#define CLASS_2_8209AB47CE58C301_METHOD_2_A5C4135A88AD533A_OFFSET UNITYSDK_OFFSET(0xE48B460)
#define CLASS_2_8209AB47CE58C301_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE48AE00)
#define CLASS_2_8209AB47CE58C301_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE48B380)
#define CLASS_2_8209AB47CE58C301_TICK_OFFSET UNITYSDK_OFFSET(0xE48B400)
#define CLASS_2_8209AB47CE58C301__CTOR_OFFSET UNITYSDK_OFFSET(0xE48AC90)

inline static constexpr unsigned int Class_2_8209AB47CE58C301_TypeDefinitionIndex = 48917;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::TaskContext*, ::Class_3_2D512E916C716041_1*))((::PBYTE)hIl2Cpp + CLASS_2_8209AB47CE58C301__CTOR_OFFSET))(this, a1, a2);
	}
