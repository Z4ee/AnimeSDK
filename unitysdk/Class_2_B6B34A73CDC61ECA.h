...
#define CLASS_2_B6B34A73CDC61ECA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1872A8A0)
#define CLASS_2_B6B34A73CDC61ECA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1872A8E0)
#define CLASS_2_B6B34A73CDC61ECA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1872AB90)
#define CLASS_2_B6B34A73CDC61ECA_TICK_OFFSET UNITYSDK_OFFSET(0x1872ABE0)
#define CLASS_2_B6B34A73CDC61ECA__CTOR_OFFSET UNITYSDK_OFFSET(0x1872A890)

inline static constexpr unsigned int Class_2_B6B34A73CDC61ECA_TypeDefinitionIndex = 55599;

class Class_2_B6B34A73CDC61ECA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::LeaveLoopScene* Field_2_1; // 0x20
