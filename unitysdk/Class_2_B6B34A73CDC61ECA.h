...
#define CLASS_2_B6B34A73CDC61ECA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188C0210)
#define CLASS_2_B6B34A73CDC61ECA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188C0250)
#define CLASS_2_B6B34A73CDC61ECA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188C0500)
#define CLASS_2_B6B34A73CDC61ECA_TICK_OFFSET UNITYSDK_OFFSET(0x188C0550)
#define CLASS_2_B6B34A73CDC61ECA__CTOR_OFFSET UNITYSDK_OFFSET(0x188C0200)
...
{
public:
	::RPG::GameCore::LeaveLoopScene* OFKGLJOAMLD; // 0x18
