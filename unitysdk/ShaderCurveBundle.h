...
#define SHADERCURVEBUNDLE_GET_CURVEPREVIEW_OFFSET UNITYSDK_OFFSET(0x1BC746B0)
#define SHADERCURVEBUNDLE_GET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x1BC74550)
#define SHADERCURVEBUNDLE_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x1BC74570)
#define SHADERCURVEBUNDLE_SET_CURVEPREVIEW_OFFSET UNITYSDK_OFFSET(0x1BC746C0)
#define SHADERCURVEBUNDLE_SET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x1BC74560)
#define SHADERCURVEBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC663D0)

inline static constexpr unsigned int ShaderCurveBundle_TypeDefinitionIndex = 41334;
