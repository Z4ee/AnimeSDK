...
#define SHADERCURVEBUNDLE_GET_CURVEPREVIEW_OFFSET UNITYSDK_OFFSET(0x18310FD0)
#define SHADERCURVEBUNDLE_GET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x18310E70)
#define SHADERCURVEBUNDLE_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x18310E90)
#define SHADERCURVEBUNDLE_SET_CURVEPREVIEW_OFFSET UNITYSDK_OFFSET(0x18310FE0)
#define SHADERCURVEBUNDLE_SET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x18310E80)
#define SHADERCURVEBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18303110)

inline static constexpr unsigned int ShaderCurveBundle_TypeDefinitionIndex = 33895;
...
public:
	...
	::System::Void set_preview(::UnityEngine::Material* value)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::Material*))((::PBYTE)hIl2Cpp + SHADERCURVEBUNDLE_SET_PREVIEW_OFFSET))(this, value);
	}
