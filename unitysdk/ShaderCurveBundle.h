...
#define SHADERCURVEBUNDLE_GET_CURVEPREVIEW_OFFSET UNITYSDK_OFFSET(0x1E55C080)
#define SHADERCURVEBUNDLE_GET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x1E55BF20)
#define SHADERCURVEBUNDLE_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x1E55BF40)
#define SHADERCURVEBUNDLE_SET_CURVEPREVIEW_OFFSET UNITYSDK_OFFSET(0x1E55C090)
#define SHADERCURVEBUNDLE_SET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x1E55BF30)
#define SHADERCURVEBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E54DDA0)
