...
#define AKMIDIEVENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18BB8710)
#define AKMIDIEVENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BB8620)
#define AKMIDIEVENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18BB86A0)
#define AKMIDIEVENT_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18BB8510)
#define AKMIDIEVENT_GET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x18BBA6E0)
#define AKMIDIEVENT_GET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x18BBA290)
#define AKMIDIEVENT_GET_BYCC_OFFSET UNITYSDK_OFFSET(0x18BBA120)
#define AKMIDIEVENT_GET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x18BBA9C0)
#define AKMIDIEVENT_GET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x18BB8970)
#define AKMIDIEVENT_GET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x18BBA850)
#define AKMIDIEVENT_GET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x18BB9E40)
#define AKMIDIEVENT_GET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x18BBAB30)
#define AKMIDIEVENT_GET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x18BB9CD0)
#define AKMIDIEVENT_GET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x18BBA400)
#define AKMIDIEVENT_GET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x18BBA570)
#define AKMIDIEVENT_GET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x18BB9FB0)
#define AKMIDIEVENT_GET_CC_OFFSET UNITYSDK_OFFSET(0x18BB8E20)
#define AKMIDIEVENT_GET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x18BB9860)
#define AKMIDIEVENT_GET_GEN_OFFSET UNITYSDK_OFFSET(0x18BB8B90)
#define AKMIDIEVENT_GET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x18BB95D0)
#define AKMIDIEVENT_GET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x18BB90B0)
#define AKMIDIEVENT_GET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x18BB9340)
#define AKMIDIEVENT_GET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x18BB9AF0)
#define AKMIDIEVENT_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BB8560)
#define AKMIDIEVENT_SET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x18BBA620)
#define AKMIDIEVENT_SET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x18BBA1D0)
#define AKMIDIEVENT_SET_BYCC_OFFSET UNITYSDK_OFFSET(0x18BBA060)
#define AKMIDIEVENT_SET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x18BBA900)
#define AKMIDIEVENT_SET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x18BB88B0)
#define AKMIDIEVENT_SET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x18BBA790)
#define AKMIDIEVENT_SET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x18BB9D80)
#define AKMIDIEVENT_SET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x18BBAA70)
#define AKMIDIEVENT_SET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x18BB9C10)
#define AKMIDIEVENT_SET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x18BBA340)
#define AKMIDIEVENT_SET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x18BBA4B0)
#define AKMIDIEVENT_SET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x18BB9EF0)
#define AKMIDIEVENT_SET_CC_OFFSET UNITYSDK_OFFSET(0x18BB8CB0)
#define AKMIDIEVENT_SET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x18BB96F0)
#define AKMIDIEVENT_SET_GEN_OFFSET UNITYSDK_OFFSET(0x18BB8A20)
#define AKMIDIEVENT_SET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x18BB9460)
#define AKMIDIEVENT_SET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x18BB8F40)
#define AKMIDIEVENT_SET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x18BB91D0)
#define AKMIDIEVENT_SET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x18BB9980)
#define AKMIDIEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BBABE0)
#define AKMIDIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB8500)

inline static constexpr unsigned int AkMIDIEvent_TypeDefinitionIndex = 34486;
