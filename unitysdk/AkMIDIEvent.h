...
#define AKMIDIEVENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E3A7CD0)
#define AKMIDIEVENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E3A7BB0)
#define AKMIDIEVENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E3A7C60)
#define AKMIDIEVENT_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1E3A7AF0)
#define AKMIDIEVENT_GET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x1E3A91A0)
#define AKMIDIEVENT_GET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x1E3A8EA0)
#define AKMIDIEVENT_GET_BYCC_OFFSET UNITYSDK_OFFSET(0x1E3A8DA0)
#define AKMIDIEVENT_GET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1E3A93A0)
#define AKMIDIEVENT_GET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x1E3A7F00)
#define AKMIDIEVENT_GET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1E3A92A0)
#define AKMIDIEVENT_GET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x1E3A8BA0)
#define AKMIDIEVENT_GET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x1E3A94A0)
#define AKMIDIEVENT_GET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x1E3A8AA0)
#define AKMIDIEVENT_GET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x1E3A8FA0)
#define AKMIDIEVENT_GET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x1E3A90A0)
#define AKMIDIEVENT_GET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x1E3A8CA0)
#define AKMIDIEVENT_GET_CC_OFFSET UNITYSDK_OFFSET(0x1E3A81C0)
#define AKMIDIEVENT_GET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1E3A87C0)
#define AKMIDIEVENT_GET_GEN_OFFSET UNITYSDK_OFFSET(0x1E3A8030)
#define AKMIDIEVENT_GET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1E3A8640)
#define AKMIDIEVENT_GET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x1E3A8340)
#define AKMIDIEVENT_GET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x1E3A84C0)
#define AKMIDIEVENT_GET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x1E3A8940)
#define AKMIDIEVENT_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1E3A7B00)
#define AKMIDIEVENT_SET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x1E3A9120)
#define AKMIDIEVENT_SET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x1E3A8E20)
#define AKMIDIEVENT_SET_BYCC_OFFSET UNITYSDK_OFFSET(0x1E3A8D20)
#define AKMIDIEVENT_SET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1E3A9320)
#define AKMIDIEVENT_SET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x1E3A7E80)
#define AKMIDIEVENT_SET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1E3A9220)
#define AKMIDIEVENT_SET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x1E3A8B20)
#define AKMIDIEVENT_SET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x1E3A9420)
#define AKMIDIEVENT_SET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x1E3A8A20)
#define AKMIDIEVENT_SET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x1E3A8F20)
#define AKMIDIEVENT_SET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x1E3A9020)
#define AKMIDIEVENT_SET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x1E3A8C20)
#define AKMIDIEVENT_SET_CC_OFFSET UNITYSDK_OFFSET(0x1E3A8120)
#define AKMIDIEVENT_SET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1E3A8720)
#define AKMIDIEVENT_SET_GEN_OFFSET UNITYSDK_OFFSET(0x1E3A7F80)
#define AKMIDIEVENT_SET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1E3A85A0)
#define AKMIDIEVENT_SET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x1E3A82A0)
#define AKMIDIEVENT_SET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x1E3A8420)
#define AKMIDIEVENT_SET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x1E3A88A0)
#define AKMIDIEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3A9520)
#define AKMIDIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3A7AE0)

inline static constexpr unsigned int AkMIDIEvent_TypeDefinitionIndex = 32977;
