...
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALEXPR_OFFSET UNITYSDK_OFFSET(0x14D25900)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALRPN_OFFSET UNITYSDK_OFFSET(0x14D25A80)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_INTERPOLATEBRACES_OFFSET UNITYSDK_OFFSET(0x14D255B0)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x14D25BC0)

namespace ExpressionV2
{
	inline static constexpr unsigned int ComplexExpressionEvaluator_TypeDefinitionIndex = 55299;
