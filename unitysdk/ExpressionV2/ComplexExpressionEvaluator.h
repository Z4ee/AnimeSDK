...
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALEXPR_OFFSET UNITYSDK_OFFSET(0x18A566C0)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALRPN_OFFSET UNITYSDK_OFFSET(0x18A56840)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_INTERPOLATEBRACES_OFFSET UNITYSDK_OFFSET(0x18A56340)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18A56980)

namespace ExpressionV2
{
	inline static constexpr unsigned int ComplexExpressionEvaluator_TypeDefinitionIndex = 64584;
