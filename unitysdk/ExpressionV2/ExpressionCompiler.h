...
#define EXPRESSIONV2_EXPRESSIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x18386D60)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_DEINIT_OFFSET UNITYSDK_OFFSET(0x183869B0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18386940)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_GETRPNCOUNT_OFFSET UNITYSDK_OFFSET(0x18389DD0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_GETRPN_OFFSET UNITYSDK_OFFSET(0x18389E10)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISDIGIT_OFFSET UNITYSDK_OFFSET(0x18386CB0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISLETTERORDIGIT_OFFSET UNITYSDK_OFFSET(0x18386D00)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISLETTER_OFFSET UNITYSDK_OFFSET(0x18386C60)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x18386C10)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_RECOMPILE_OFFSET UNITYSDK_OFFSET(0x18389E50)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_RETURNTOKEN_OFFSET UNITYSDK_OFFSET(0x18386B20)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TOKENCREATOR_OFFSET UNITYSDK_OFFSET(0x18386AB0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x18386F50)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TORPN_OFFSET UNITYSDK_OFFSET(0x183890E0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18389FD0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x18389FC0)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionCompiler_TypeDefinitionIndex = 73518;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Stack_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionCompiler_TypeDefinitionIndex)->GetStaticField(0x44B20);
		}
		static ::ExpressionV2::ExpressionCompiler_ExpressionMode* StaticGet_Mode()
		{
			return (::ExpressionV2::ExpressionCompiler_ExpressionMode*)Il2CppClass::FromTypeDefinitionIndex(ExpressionCompiler_TypeDefinitionIndex)->GetStaticField(0x10A80);
		}
		::System::Buffers::ArrayPool_1<::ExpressionV2::Token*>* pool3; // 0x10
		::System::Buffers::ArrayPool_1<::ExpressionV2::Token*>* pool4; // 0x18
		::Il2CppArray<::ExpressionV2::Token*>* rpn2; // 0x20
		::Il2CppArray<::ExpressionV2::Token*>* buf2; // 0x28
		::System::Boolean hasDispose; // 0x30
		::System::Int32 count2; // 0x34
