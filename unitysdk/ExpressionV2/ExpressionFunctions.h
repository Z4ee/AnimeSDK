...
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_ACTORPROPERTY_OFFSET UNITYSDK_OFFSET(0x114066F0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_AVATARSKILLLEVEL_OFFSET UNITYSDK_OFFSET(0x114078C0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_CALL_OFFSET UNITYSDK_OFFSET(0x11404340)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_CARDTYPE_OFFSET UNITYSDK_OFFSET(0x11406270)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_CONCAT_OFFSET UNITYSDK_OFFSET(0x11404A70)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETAVATARAUDIOEVENTNAME_OFFSET UNITYSDK_OFFSET(0x11407FB0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETAVATARNAME_OFFSET UNITYSDK_OFFSET(0x11406F90)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETAVATARTAG_OFFSET UNITYSDK_OFFSET(0x11407CE0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETBUDDYCOUNT_OFFSET UNITYSDK_OFFSET(0x114074E0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETINDEX_OFFSET UNITYSDK_OFFSET(0x114068E0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETPOS_OFFSET UNITYSDK_OFFSET(0x11406A40)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETSTRING_OFFSET UNITYSDK_OFFSET(0x11406ED0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_HOLLOWLEVEL_OFFSET UNITYSDK_OFFSET(0x11406580)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_IF_OFFSET UNITYSDK_OFFSET(0x11404C40)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x11405EA0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_ITEM_OFFSET UNITYSDK_OFFSET(0x11404550)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_MAX_OFFSET UNITYSDK_OFFSET(0x11404900)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_MIN_OFFSET UNITYSDK_OFFSET(0x11404790)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_PLAYERPOS_OFFSET UNITYSDK_OFFSET(0x11406990)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_PROPERTYID_OFFSET UNITYSDK_OFFSET(0x114070E0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_PROPERTY_OFFSET UNITYSDK_OFFSET(0x11404D30)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_RAND_OFFSET UNITYSDK_OFFSET(0x11405DC0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x11405A70)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SCENEVAR_OFFSET UNITYSDK_OFFSET(0x114050F0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SEPCIALS_OFFSET UNITYSDK_OFFSET(0x11404F80)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SQRT_OFFSET UNITYSDK_OFFSET(0x11404480)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_TEAMPROPERTY_OFFSET UNITYSDK_OFFSET(0x11406AF0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_TRASHREMAINSIZE_OFFSET UNITYSDK_OFFSET(0x11407320)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x11403CC0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x11408100)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS__GETSCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x11405920)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionFunctions_TypeDefinitionIndex = 52185;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Func_4<::Il2CppArray<::ExpressionV2::ExprValue>*, ::System::Int32, ::ExpressionV2::ExpressionEvalContext*, ::ExpressionV2::ExprValue>*>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionFunctions_TypeDefinitionIndex)->GetStaticField(0x47160);
		}
