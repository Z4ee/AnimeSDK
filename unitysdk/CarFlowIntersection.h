...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0xA6D9810)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0xA6D9EA0)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xA6D9EE0)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D9F20)

inline static constexpr unsigned int CarFlowIntersection_TypeDefinitionIndex = 37996;
