...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0x184728B0)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0x18472DF0)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x18472E30)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18472E70)

inline static constexpr unsigned int CarFlowIntersection_TypeDefinitionIndex = 45290;
