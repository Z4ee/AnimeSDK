...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0xACF4990)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0xACF5020)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xACF5060)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xACF50A0)

inline static constexpr unsigned int CarFlowIntersection_TypeDefinitionIndex = 43874;
