...
#define CLASS_2_67D90C18CB092682_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17AF6230)
#define CLASS_2_67D90C18CB092682_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17AF6270)
#define CLASS_2_67D90C18CB092682_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17AF64B0)
#define CLASS_2_67D90C18CB092682_TICK_OFFSET UNITYSDK_OFFSET(0x17AF6500)
#define CLASS_2_67D90C18CB092682__CTOR_OFFSET UNITYSDK_OFFSET(0x17AF6220)

inline static constexpr unsigned int Class_2_67D90C18CB092682_TypeDefinitionIndex = 55505;

class Class_2_67D90C18CB092682 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RemoveEntityFromTeamFormation* OFKGLJOAMLD; // 0x18
