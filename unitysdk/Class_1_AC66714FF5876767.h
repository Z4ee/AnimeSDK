...
#define CLASS_1_AC66714FF5876767_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0A2EC0)
#define CLASS_1_AC66714FF5876767_GET_AIACTIONTURNCOUNT_OFFSET UNITYSDK_OFFSET(0xC0A48C0)
#define CLASS_1_AC66714FF5876767_GET_AISEQUENCESKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xC0A4930)
#define CLASS_1_AC66714FF5876767_GET_AISKILLTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0xC0A4950)
#define CLASS_1_AC66714FF5876767_GET_GLOBALVARS_OFFSET UNITYSDK_OFFSET(0xC0A4990)
#define CLASS_1_AC66714FF5876767_GET_HASAVAILABLESKILL_OFFSET UNITYSDK_OFFSET(0xC0A4970)
#define CLASS_1_AC66714FF5876767_GET_LASTSEQUENCESKILLIDX_OFFSET UNITYSDK_OFFSET(0xC0A4910)
#define CLASS_1_AC66714FF5876767_GET_ONLYULTRAFLAG_OFFSET UNITYSDK_OFFSET(0xC0A49B0)
#define CLASS_1_AC66714FF5876767_GET_VARIABLEANIMCONFIGREFKEY_OFFSET UNITYSDK_OFFSET(0xC0A4900)
#define CLASS_1_AC66714FF5876767_GET_VARIABLEFORBIDCLEARSKILLUSERECORDREFKEY_OFFSET UNITYSDK_OFFSET(0xC0A48E0)
#define CLASS_1_AC66714FF5876767_METHOD_1_1266A942BF66AA3D_OFFSET UNITYSDK_OFFSET(0xC0A3C40)
#define CLASS_1_AC66714FF5876767_METHOD_1_36FE06AA8E3E4023_OFFSET UNITYSDK_OFFSET(0xC0A3EC0)
#define CLASS_1_AC66714FF5876767_METHOD_1_39797B00B8ADB694_OFFSET UNITYSDK_OFFSET(0xC0A3390)
#define CLASS_1_AC66714FF5876767_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xC0A4000)
#define CLASS_1_AC66714FF5876767_METHOD_1_70DF8997DFA24177_OFFSET UNITYSDK_OFFSET(0xC0A3760)
#define CLASS_1_AC66714FF5876767_METHOD_1_7251E73A45DF0488_1_OFFSET UNITYSDK_OFFSET(0xC0A3D00)
#define CLASS_1_AC66714FF5876767_METHOD_1_7251E73A45DF0488_OFFSET UNITYSDK_OFFSET(0xC0A3B20)
#define CLASS_1_AC66714FF5876767_METHOD_1_81123091D2E89083_OFFSET UNITYSDK_OFFSET(0xC0A42A0)
#define CLASS_1_AC66714FF5876767_METHOD_1_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0xC0A3E20)
#define CLASS_1_AC66714FF5876767_METHOD_1_8CBB93C3A2339306_OFFSET UNITYSDK_OFFSET(0xC0A3940)
#define CLASS_1_AC66714FF5876767_METHOD_1_941C404C800CB723_OFFSET UNITYSDK_OFFSET(0xC0A40C0)
#define CLASS_1_AC66714FF5876767_METHOD_1_9592CC34AD487472_OFFSET UNITYSDK_OFFSET(0xC0A41A0)
#define CLASS_1_AC66714FF5876767_METHOD_1_95F5200B1985BEE8_OFFSET UNITYSDK_OFFSET(0xC0A3030)
#define CLASS_1_AC66714FF5876767_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0xC0A48A0)
#define CLASS_1_AC66714FF5876767_METHOD_1_B26CE4DFFCFFA38A_OFFSET UNITYSDK_OFFSET(0xC0A31B0)
#define CLASS_1_AC66714FF5876767_METHOD_1_B64C60973842FE45_OFFSET UNITYSDK_OFFSET(0xC0A49D0)
#define CLASS_1_AC66714FF5876767_METHOD_1_CC5CE2E05C46A526_OFFSET UNITYSDK_OFFSET(0xC0A4230)
#define CLASS_1_AC66714FF5876767_METHOD_1_CD6D61DEE46F1276_OFFSET UNITYSDK_OFFSET(0xC0A3570)
#define CLASS_1_AC66714FF5876767_METHOD_1_D94CB0E64E013CD7_OFFSET UNITYSDK_OFFSET(0xC0A3A00)
#define CLASS_1_AC66714FF5876767_SET_AIACTIONTURNCOUNT_OFFSET UNITYSDK_OFFSET(0xC0A48B0)
#define CLASS_1_AC66714FF5876767_SET_AISEQUENCESKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xC0A4940)
#define CLASS_1_AC66714FF5876767_SET_AISKILLTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0xC0A4960)
#define CLASS_1_AC66714FF5876767_SET_GLOBALVARS_OFFSET UNITYSDK_OFFSET(0xC0A49A0)
#define CLASS_1_AC66714FF5876767_SET_HASAVAILABLESKILL_OFFSET UNITYSDK_OFFSET(0xC0A4980)
#define CLASS_1_AC66714FF5876767_SET_LASTSEQUENCESKILLIDX_OFFSET UNITYSDK_OFFSET(0xC0A4920)
#define CLASS_1_AC66714FF5876767_SET_ONLYULTRAFLAG_OFFSET UNITYSDK_OFFSET(0xC0A49C0)
#define CLASS_1_AC66714FF5876767_SET_VARIABLEANIMCONFIGREFKEY_OFFSET UNITYSDK_OFFSET(0xC0A48F0)
#define CLASS_1_AC66714FF5876767_SET_VARIABLEFORBIDCLEARSKILLUSERECORDREFKEY_OFFSET UNITYSDK_OFFSET(0xC0A48D0)
#define CLASS_1_AC66714FF5876767__CTOR_OFFSET UNITYSDK_OFFSET(0xC0A2B50)
...
{
public:
	::System::Collections::Generic::HashSet_1<::System::String*>* PPKBODLJJKD; // 0x10
	::System::String* _VariableForbidClearSkillUseRecordRefKey_k__BackingField; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::AIVariable*>* FEONBGCCLBB; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_AC66714FF5876767_Struct_2_028675BFBEB6582A>*>* KEFAKHJCHLF; // 0x28
	::RPG::GameCore::GameEntity* ICHEDAEHEBG; // 0x30
	::System::String* _VariableAnimConfigRefKey_k__BackingField; // 0x38
	::System::Collections::Generic::List_1<::Class_1_AC66714FF5876767_Struct_2_BBD456EBC9087BC2_4>* OJANELEACLE; // 0x40
	::System::Collections::Generic::List_1<::System::UInt32>* _AISequenceSkillIDList_k__BackingField; // 0x48
	::Class_1_95BA09BAE479F559* _GlobalVars_k__BackingField; // 0x50
