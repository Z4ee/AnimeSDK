...
#include "unitysdk/Class_1_AC66714FF5876767_Struct_2_BBD456EBC9087BC2_3.h"
...
#define CLASS_1_AC66714FF5876767_DISPOSE_OFFSET UNITYSDK_OFFSET(0x173EAA60)
#define CLASS_1_AC66714FF5876767_GET_AIACTIONTURNCOUNT_OFFSET UNITYSDK_OFFSET(0x173EC430)
#define CLASS_1_AC66714FF5876767_GET_AISEQUENCESKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x173EC4A0)
#define CLASS_1_AC66714FF5876767_GET_AISKILLTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x173EC4C0)
#define CLASS_1_AC66714FF5876767_GET_GLOBALVARS_OFFSET UNITYSDK_OFFSET(0x173EC500)
#define CLASS_1_AC66714FF5876767_GET_HASAVAILABLESKILL_OFFSET UNITYSDK_OFFSET(0x173EC4E0)
#define CLASS_1_AC66714FF5876767_GET_LASTSEQUENCESKILLIDX_OFFSET UNITYSDK_OFFSET(0x173EC480)
#define CLASS_1_AC66714FF5876767_GET_ONLYULTRAFLAG_OFFSET UNITYSDK_OFFSET(0x173EC520)
#define CLASS_1_AC66714FF5876767_GET_VARIABLEANIMCONFIGREFKEY_OFFSET UNITYSDK_OFFSET(0x173EC470)
#define CLASS_1_AC66714FF5876767_GET_VARIABLEFORBIDCLEARSKILLUSERECORDREFKEY_OFFSET UNITYSDK_OFFSET(0x173EC450)
#define CLASS_1_AC66714FF5876767_METHOD_1_1266A942BF66AA3D_OFFSET UNITYSDK_OFFSET(0x173EB7E0)
#define CLASS_1_AC66714FF5876767_METHOD_1_36FE06AA8E3E4023_OFFSET UNITYSDK_OFFSET(0x173EBA60)
#define CLASS_1_AC66714FF5876767_METHOD_1_39797B00B8ADB694_OFFSET UNITYSDK_OFFSET(0x173EAF30)
#define CLASS_1_AC66714FF5876767_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x173EBBA0)
#define CLASS_1_AC66714FF5876767_METHOD_1_60DC879ACE99CF48_OFFSET UNITYSDK_OFFSET(0x173EBC60)
#define CLASS_1_AC66714FF5876767_METHOD_1_70DF8997DFA24177_OFFSET UNITYSDK_OFFSET(0x173EB300)
#define CLASS_1_AC66714FF5876767_METHOD_1_7251E73A45DF0488_1_OFFSET UNITYSDK_OFFSET(0x173EB8A0)
#define CLASS_1_AC66714FF5876767_METHOD_1_7251E73A45DF0488_OFFSET UNITYSDK_OFFSET(0x173EB6C0)
#define CLASS_1_AC66714FF5876767_METHOD_1_81123091D2E89083_OFFSET UNITYSDK_OFFSET(0x173EBE10)
#define CLASS_1_AC66714FF5876767_METHOD_1_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x173EB9C0)
#define CLASS_1_AC66714FF5876767_METHOD_1_8CBB93C3A2339306_OFFSET UNITYSDK_OFFSET(0x173EB4E0)
#define CLASS_1_AC66714FF5876767_METHOD_1_9592CC34AD487472_OFFSET UNITYSDK_OFFSET(0x173EBD10)
#define CLASS_1_AC66714FF5876767_METHOD_1_95F5200B1985BEE8_OFFSET UNITYSDK_OFFSET(0x173EABD0)
#define CLASS_1_AC66714FF5876767_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x173EC410)
#define CLASS_1_AC66714FF5876767_METHOD_1_B26CE4DFFCFFA38A_OFFSET UNITYSDK_OFFSET(0x173EAD50)
#define CLASS_1_AC66714FF5876767_METHOD_1_B64C60973842FE45_OFFSET UNITYSDK_OFFSET(0x173EC540)
#define CLASS_1_AC66714FF5876767_METHOD_1_CC5CE2E05C46A526_OFFSET UNITYSDK_OFFSET(0x173EBDA0)
#define CLASS_1_AC66714FF5876767_METHOD_1_CD6D61DEE46F1276_OFFSET UNITYSDK_OFFSET(0x173EB110)
#define CLASS_1_AC66714FF5876767_METHOD_1_D94CB0E64E013CD7_OFFSET UNITYSDK_OFFSET(0x173EB5A0)
#define CLASS_1_AC66714FF5876767_SET_AIACTIONTURNCOUNT_OFFSET UNITYSDK_OFFSET(0x173EC420)
#define CLASS_1_AC66714FF5876767_SET_AISEQUENCESKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x173EC4B0)
#define CLASS_1_AC66714FF5876767_SET_AISKILLTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x173EC4D0)
#define CLASS_1_AC66714FF5876767_SET_GLOBALVARS_OFFSET UNITYSDK_OFFSET(0x173EC510)
#define CLASS_1_AC66714FF5876767_SET_HASAVAILABLESKILL_OFFSET UNITYSDK_OFFSET(0x173EC4F0)
#define CLASS_1_AC66714FF5876767_SET_LASTSEQUENCESKILLIDX_OFFSET UNITYSDK_OFFSET(0x173EC490)
#define CLASS_1_AC66714FF5876767_SET_ONLYULTRAFLAG_OFFSET UNITYSDK_OFFSET(0x173EC530)
#define CLASS_1_AC66714FF5876767_SET_VARIABLEANIMCONFIGREFKEY_OFFSET UNITYSDK_OFFSET(0x173EC460)
#define CLASS_1_AC66714FF5876767_SET_VARIABLEFORBIDCLEARSKILLUSERECORDREFKEY_OFFSET UNITYSDK_OFFSET(0x173EC440)
#define CLASS_1_AC66714FF5876767__CTOR_OFFSET UNITYSDK_OFFSET(0x173EA710)

inline static constexpr unsigned int Class_1_AC66714FF5876767_TypeDefinitionIndex = 51865;

class Class_1_AC66714FF5876767 : public ::System::Object
{
public:
	::System::String* _VariableAnimConfigRefKey_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::System::UInt32>* _AISequenceSkillIDList_k__BackingField; // 0x18
	::Class_1_95BA09BAE479F559* _GlobalVars_k__BackingField; // 0x20
	::RPG::GameCore::GameEntity* Field_1_3; // 0x28
	::System::Collections::Generic::List_1<::Class_1_AC66714FF5876767_Struct_2_BBD456EBC9087BC2_3>* Field_1_4; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_AC66714FF5876767_Struct_2_028675BFBEB6582A>*>* Field_1_5; // 0x38
	::System::String* _VariableForbidClearSkillUseRecordRefKey_k__BackingField; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::AIVariable*>* Field_1_7; // 0x48
	::System::Collections::Generic::HashSet_1<::System::String*>* Field_1_8; // 0x50
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* _AISkillTargetEntityList_k__BackingField; // 0x58
	::System::Boolean _OnlyUltraFlag_k__BackingField; // 0x60
	::System::Boolean _HasAvailableSkill_k__BackingField; // 0x61
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + CLASS_1_AC66714FF5876767_METHOD_1_60DC879ACE99CF48_OFFSET))(this, a1);
	}
