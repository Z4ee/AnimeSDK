...
#define CLASS_2_3AC4A4E4A74256ED_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11784BE0)
#define CLASS_2_3AC4A4E4A74256ED_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11784A40)
#define CLASS_2_3AC4A4E4A74256ED_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11784B90)
#define CLASS_2_3AC4A4E4A74256ED_TICK_OFFSET UNITYSDK_OFFSET(0x11784C20)
#define CLASS_2_3AC4A4E4A74256ED__CTOR_OFFSET UNITYSDK_OFFSET(0x11784A30)

inline static constexpr unsigned int Class_2_3AC4A4E4A74256ED_TypeDefinitionIndex = 53993;

class Class_2_3AC4A4E4A74256ED : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetProbePuzzleResetNumber* Field_2_1; // 0x18
