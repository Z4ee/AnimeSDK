...
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x114A2990)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_COLLECTANIMATIONS_OFFSET UNITYSDK_OFFSET(0x114A35C0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONCANVASWILLRENDER_OFFSET UNITYSDK_OFFSET(0x114A24B0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONDISABLE_OFFSET UNITYSDK_OFFSET(0x114A2250)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONENABLE_OFFSET UNITYSDK_OFFSET(0x114A2320)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x114A36E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETCUSTOMPROPERTYMAXVALUE_OFFSET UNITYSDK_OFFSET(0x114A33D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETCUSTOMPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x114A1DC0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x114A0E50)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x114A0CC0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_HANDLEALLCUSTOMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x114A1490)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_HANDLEPROGRESS_OFFSET UNITYSDK_OFFSET(0x114A3780)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_LOGCUSTOMTYPEHOLDERERROR_OFFSET UNITYSDK_OFFSET(0x114A3380)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_MOLEMOLE_BATTLE_IPROPERTYCHANGEINCURFRAMECALLBACK_ONPROPERTYLISTCHANGEINCURFRAME_OFFSET UNITYSDK_OFFSET(0x114A3B90)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x114A21A0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONCANVASWILLRENDER_OFFSET UNITYSDK_OFFSET(0x114A2380)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x114A1B30)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x114A21E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x114A22A0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x114A1530)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONFORCEHIDECUSTOMPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x114A1F70)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x114A18F0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x114A15D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONPROPERTYLISTCHANGEINCURFRAME_OFFSET UNITYSDK_OFFSET(0x114A1790)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x114A0FE0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x114A1D70)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x114A0E70)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REDIRECTCUSTOMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x114A2CA0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REGISTERPROPCHANGECB_OFFSET UNITYSDK_OFFSET(0x114A1400)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REMOVEPROEPRTYCALLBACK_OFFSET UNITYSDK_OFFSET(0x114A1B80)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x114A24F0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SETPROPERTYCHANGEHANDLEMODE_OFFSET UNITYSDK_OFFSET(0x114A0FA0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x114A0E60)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_UNREGISTERPROPCHANGECB_OFFSET UNITYSDK_OFFSET(0x114A12A0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x114A3B80)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x114A3C00)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x114A3C10)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x114A3CA0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x114A3BE0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x114A3BF0)

inline static constexpr unsigned int MonoCustomPropertyUIControllerBase_TypeDefinitionIndex = 55007;

class MonoCustomPropertyUIControllerBase : public ::MoleMole::UIWindowController
{
public:
	::System::UInt32 _ownerEntityID; // 0x318
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _placeholder2CustomTypes; // 0x320
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _customType2Placeholders; // 0x328
	::Class_1_1487A3F820CB8361* _property; // 0x330
	::System::Collections::Generic::List_1<::UnityEngine::Animation*>* _allAnimationComponents; // 0x338
	::MoleMole::CharacterScriptConfig_ConfigCustomPropertyUI* _config_k__BackingField; // 0x340
	::System::Boolean _needHandleAllCustomPropertiesOnEnable; // 0x348
	::System::Boolean _handlePropertiesExecutedInOnEnable; // 0x349
	::System::Boolean _mergeHandleEnable; // 0x34A
	...
	::System::Void HandleAllCustomProperties()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MONOCUSTOMPROPERTYUICONTROLLERBASE_HANDLEALLCUSTOMPROPERTIES_OFFSET))(this);
	}
	...
	::System::Void OnForceHideCustomPropertyChanged(::System::Double oldValue, ::System::Double newValue)
	{
		return ((::System::Void(*)(::PVOID, ::System::Double, ::System::Double))((::PBYTE)hIl2Cpp + MONOCUSTOMPROPERTYUICONTROLLERBASE_ONFORCEHIDECUSTOMPROPERTYCHANGED_OFFSET))(this, oldValue, newValue);
	}
