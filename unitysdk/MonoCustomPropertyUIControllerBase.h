...
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1950E8E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_COLLECTANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1950F6D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONCANVASWILLRENDER_OFFSET UNITYSDK_OFFSET(0x1950E400)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONDISABLE_OFFSET UNITYSDK_OFFSET(0x1950E180)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONENABLE_OFFSET UNITYSDK_OFFSET(0x1950E250)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1950F7F0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETCUSTOMPROPERTYMAXVALUE_OFFSET UNITYSDK_OFFSET(0x1950F4E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETCUSTOMPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1950F2E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1950D240)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x1950D0B0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_HANDLEPROGRESS_OFFSET UNITYSDK_OFFSET(0x1950F890)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_LOGCUSTOMTYPEHOLDERERROR_OFFSET UNITYSDK_OFFSET(0x1950F490)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_MOLEMOLE_BATTLE_IPROPERTYCHANGEINCURFRAMECALLBACK_ONPROPERTYLISTCHANGEINCURFRAME_OFFSET UNITYSDK_OFFSET(0x1950FC90)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1950E0D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONCANVASWILLRENDER_OFFSET UNITYSDK_OFFSET(0x1950E2B0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1950DE40)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1950E110)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1950E1D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1950D8A0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1950DC00)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x1950D940)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONPROPERTYLISTCHANGEINCURFRAME_OFFSET UNITYSDK_OFFSET(0x1950DAA0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1950D3E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1950E080)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1950D260)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REDIRECTCUSTOMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1950EC00)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REGISTERPROPCHANGECB_OFFSET UNITYSDK_OFFSET(0x1950D810)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REMOVEPROEPRTYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1950DE90)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1950E440)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SETPROPERTYCHANGEHANDLEMODE_OFFSET UNITYSDK_OFFSET(0x1950D3A0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1950D250)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_UNREGISTERPROPCHANGECB_OFFSET UNITYSDK_OFFSET(0x1950D6B0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1950FC80)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1950FD00)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1950FD10)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1950FDA0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1950FCE0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1950FCF0)

inline static constexpr unsigned int MonoCustomPropertyUIControllerBase_TypeDefinitionIndex = 77526;
