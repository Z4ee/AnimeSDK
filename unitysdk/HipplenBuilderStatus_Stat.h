...
#define HIPPLENBUILDERSTATUS_STAT_GET_GRADECONFIGS_OFFSET UNITYSDK_OFFSET(0x15ADD8D0)
#define HIPPLENBUILDERSTATUS_STAT_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x15ADD880)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAMENEG_OFFSET UNITYSDK_OFFSET(0x15ADD5D0)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15ADD580)
#define HIPPLENBUILDERSTATUS_STAT_GET_NEXTGRADEMIN_OFFSET UNITYSDK_OFFSET(0x15ADD670)
#define HIPPLENBUILDERSTATUS_STAT_GET_NORMALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x15ADD920)
#define HIPPLENBUILDERSTATUS_STAT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x15ADD620)
#define HIPPLENBUILDERSTATUS_STAT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x15ADCAC0)
#define HIPPLENBUILDERSTATUS_STAT_GET_WARNINGVALUE_OFFSET UNITYSDK_OFFSET(0x15ADD830)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_AB01D2A3604A75E7_OFFSET UNITYSDK_OFFSET(0x15ADD6C0)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_B06FAFF37803F837_OFFSET UNITYSDK_OFFSET(0x15ADD240)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_E89B5E85E1E3F103_OFFSET UNITYSDK_OFFSET(0x15ADCB10)
#define HIPPLENBUILDERSTATUS_STAT__CTOR_OFFSET UNITYSDK_OFFSET(0x15ADCAA0)

inline static constexpr unsigned int HipplenBuilderStatus_Stat_TypeDefinitionIndex = 47669;
