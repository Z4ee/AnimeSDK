...
#define HIPPLENBUILDERSTATUS_STAT_GET_GRADECONFIGS_OFFSET UNITYSDK_OFFSET(0x11E0A920)
#define HIPPLENBUILDERSTATUS_STAT_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x11E0A900)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAMENEG_OFFSET UNITYSDK_OFFSET(0x11E0A720)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x11E0A700)
#define HIPPLENBUILDERSTATUS_STAT_GET_NEXTGRADEMIN_OFFSET UNITYSDK_OFFSET(0x11E0A760)
#define HIPPLENBUILDERSTATUS_STAT_GET_NORMALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x11E0A940)
#define HIPPLENBUILDERSTATUS_STAT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x11E0A740)
#define HIPPLENBUILDERSTATUS_STAT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x11E09DC0)
#define HIPPLENBUILDERSTATUS_STAT_GET_WARNINGVALUE_OFFSET UNITYSDK_OFFSET(0x11E0A8E0)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_353DAAE369AAEE14_OFFSET UNITYSDK_OFFSET(0x11E09DE0)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_4F2DF85F37DC818F_OFFSET UNITYSDK_OFFSET(0x11E0A770)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_E0BE53945D089B15_OFFSET UNITYSDK_OFFSET(0x11E0A440)
#define HIPPLENBUILDERSTATUS_STAT__CTOR_OFFSET UNITYSDK_OFFSET(0x11E09DA0)

inline static constexpr unsigned int HipplenBuilderStatus_Stat_TypeDefinitionIndex = 44001;
