...
#define CLASS_3_B9321AFB2F8A6685_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96AF070)
#define CLASS_3_B9321AFB2F8A6685_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x96AED50)
#define CLASS_3_B9321AFB2F8A6685_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x96AEF70)
#define CLASS_3_B9321AFB2F8A6685__CTOR_OFFSET UNITYSDK_OFFSET(0x96AED20)
#define CLASS_3_B9321AFB2F8A6685___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96AF1E0)
#define CLASS_3_B9321AFB2F8A6685___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x96AF1D0)

inline static constexpr unsigned int Class_3_B9321AFB2F8A6685_TypeDefinitionIndex = 48651;

class Class_3_B9321AFB2F8A6685 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::CreateFMChannelSource*>
{
public:
	::Class_0_16E4307DCC419505_385* Field_3_0; // 0x28
