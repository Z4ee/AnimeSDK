...
#define CLASS_3_6334D7D4A4FC7A34_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C5D150)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9C5D010)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9C5D0E0)
#define CLASS_3_6334D7D4A4FC7A34_TICK_OFFSET UNITYSDK_OFFSET(0x9C5D080)
#define CLASS_3_6334D7D4A4FC7A34__CTOR_OFFSET UNITYSDK_OFFSET(0x9C5CFE0)
#define CLASS_3_6334D7D4A4FC7A34___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C5D1F0)
#define CLASS_3_6334D7D4A4FC7A34___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9C5D190)

inline static constexpr unsigned int Class_3_6334D7D4A4FC7A34_TypeDefinitionIndex = 42310;
