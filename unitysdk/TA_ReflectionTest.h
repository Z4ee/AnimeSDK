...
#define TA_REFLECTIONTEST_DROPDOWN_OFFSET UNITYSDK_OFFSET(0xAC25FA0)
#define TA_REFLECTIONTEST_SETCUBE_OFFSET UNITYSDK_OFFSET(0xAC26630)
#define TA_REFLECTIONTEST_SETNONE_OFFSET UNITYSDK_OFFSET(0xAC26080)
#define TA_REFLECTIONTEST_SETPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0xAC26790)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBEBOXPROJECTION_OFFSET UNITYSDK_OFFSET(0xAC26500)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0xAC263D0)
#define TA_REFLECTIONTEST_SETSSRTRACEONCE_OFFSET UNITYSDK_OFFSET(0xAC26A00)
#define TA_REFLECTIONTEST_SETSSR_OFFSET UNITYSDK_OFFSET(0xAC268C0)
#define TA_REFLECTIONTEST_SLIDER_OFFSET UNITYSDK_OFFSET(0xAC25EE0)
#define TA_REFLECTIONTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xAC26AE0)

inline static constexpr unsigned int TA_ReflectionTest_TypeDefinitionIndex = 38303;
