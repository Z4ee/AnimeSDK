...
#define TA_REFLECTIONTEST_DROPDOWN_OFFSET UNITYSDK_OFFSET(0x104F38D0)
#define TA_REFLECTIONTEST_SETCUBE_OFFSET UNITYSDK_OFFSET(0x104F3F50)
#define TA_REFLECTIONTEST_SETNONE_OFFSET UNITYSDK_OFFSET(0x104F39B0)
#define TA_REFLECTIONTEST_SETPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0x104F40B0)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBEBOXPROJECTION_OFFSET UNITYSDK_OFFSET(0x104F3E20)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0x104F3CF0)
#define TA_REFLECTIONTEST_SETSSRTRACEONCE_OFFSET UNITYSDK_OFFSET(0x104F4320)
#define TA_REFLECTIONTEST_SETSSR_OFFSET UNITYSDK_OFFSET(0x104F41E0)
#define TA_REFLECTIONTEST_SLIDER_OFFSET UNITYSDK_OFFSET(0x104F37B0)
#define TA_REFLECTIONTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x104F4400)

inline static constexpr unsigned int TA_ReflectionTest_TypeDefinitionIndex = 47899;
...
public:
	...
	::System::Single DJDBOJNMICO; // 0x48
