...
#define TA_REFLECTIONTEST_DROPDOWN_OFFSET UNITYSDK_OFFSET(0x10526E10)
#define TA_REFLECTIONTEST_SETCUBE_OFFSET UNITYSDK_OFFSET(0x10527490)
#define TA_REFLECTIONTEST_SETNONE_OFFSET UNITYSDK_OFFSET(0x10526EF0)
#define TA_REFLECTIONTEST_SETPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0x105275F0)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBEBOXPROJECTION_OFFSET UNITYSDK_OFFSET(0x10527360)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0x10527230)
#define TA_REFLECTIONTEST_SETSSRTRACEONCE_OFFSET UNITYSDK_OFFSET(0x10527860)
#define TA_REFLECTIONTEST_SETSSR_OFFSET UNITYSDK_OFFSET(0x10527720)
#define TA_REFLECTIONTEST_SLIDER_OFFSET UNITYSDK_OFFSET(0x10526CF0)
#define TA_REFLECTIONTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x10527940)

inline static constexpr unsigned int TA_ReflectionTest_TypeDefinitionIndex = 45648;
