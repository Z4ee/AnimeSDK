...
#define TA_REFLECTIONTEST_DROPDOWN_OFFSET UNITYSDK_OFFSET(0xE98BC30)
#define TA_REFLECTIONTEST_SETCUBE_OFFSET UNITYSDK_OFFSET(0xE98C2B0)
#define TA_REFLECTIONTEST_SETNONE_OFFSET UNITYSDK_OFFSET(0xE98BD10)
#define TA_REFLECTIONTEST_SETPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0xE98C410)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBEBOXPROJECTION_OFFSET UNITYSDK_OFFSET(0xE98C180)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0xE98C050)
#define TA_REFLECTIONTEST_SETSSRTRACEONCE_OFFSET UNITYSDK_OFFSET(0xE98C680)
#define TA_REFLECTIONTEST_SETSSR_OFFSET UNITYSDK_OFFSET(0xE98C540)
#define TA_REFLECTIONTEST_SLIDER_OFFSET UNITYSDK_OFFSET(0xE98BB10)
#define TA_REFLECTIONTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xE98C760)
