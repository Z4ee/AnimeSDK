...
#define CLASS_2_D13F0A2D74DCF483_METHOD_2_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0x141A9F90)
#define CLASS_2_D13F0A2D74DCF483_METHOD_2_13D583A8E8628BFF_OFFSET UNITYSDK_OFFSET(0x141AB260)
#define CLASS_2_D13F0A2D74DCF483_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x141BEF10)
#define CLASS_2_D13F0A2D74DCF483_METHOD_2_B74D3688C9F7FE4B_OFFSET UNITYSDK_OFFSET(0x141BEF20)
#define CLASS_2_D13F0A2D74DCF483_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x141BF160)
#define CLASS_2_D13F0A2D74DCF483_METHOD_2_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x141BEFE0)
#define CLASS_2_D13F0A2D74DCF483__CTOR_OFFSET UNITYSDK_OFFSET(0x141BF150)

inline static constexpr unsigned int Class_2_D13F0A2D74DCF483_TypeDefinitionIndex = 86622;

class Class_2_D13F0A2D74DCF483 : public ::Class_1_2DD57B8CAD4CF82D
{
public:
	::MoleMole::UIEmojiTipRouletteWidgetController* Field_2_7; // 0x28
	::MoleMole::UIInLevelEmoticonsTipWidgetController* Field_2_6; // 0x30
	...
	{
		return ((::Enum_3_C64432A6918BE61F(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_D13F0A2D74DCF483_METHOD_2_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_2_B74D3688C9F7FE4B(::Class_0_16E4307DCC419505_207* a1, ::MoleMole::UIWindowController* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_207*, ::MoleMole::UIWindowController*))((::PBYTE)hIl2Cpp + CLASS_2_D13F0A2D74DCF483_METHOD_2_B74D3688C9F7FE4B_OFFSET))(this, a1, a2);
	}
