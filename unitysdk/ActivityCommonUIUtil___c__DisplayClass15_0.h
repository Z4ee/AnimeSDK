...
#define ACTIVITYCOMMONUIUTIL___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFD8B7F0)
#define ACTIVITYCOMMONUIUTIL___C__DISPLAYCLASS15_0__GETGROUPMONSTERCONFIGS_B__0_OFFSET UNITYSDK_OFFSET(0xFD8B800)

inline static constexpr unsigned int ActivityCommonUIUtil___c__DisplayClass15_0_TypeDefinitionIndex = 73004;
