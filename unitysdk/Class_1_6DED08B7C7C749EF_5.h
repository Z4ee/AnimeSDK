...
#define CLASS_1_6DED08B7C7C749EF_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CDEBC80)
#define CLASS_1_6DED08B7C7C749EF_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1CDEB6D0)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CDEB830)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CDEB790)
#define CLASS_1_6DED08B7C7C749EF_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CDEB960)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CDEBE10)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CDEBDA0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1CDEB700)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1CDEB730)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1CDEB720)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1CDEB780)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CDEB590)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1CDEB710)
#define CLASS_1_6DED08B7C7C749EF_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CDEB5C0)
#define CLASS_1_6DED08B7C7C749EF_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CDEBAE0)
#define CLASS_1_6DED08B7C7C749EF_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CDEBB40)
#define CLASS_1_6DED08B7C7C749EF_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CDEBF20)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CDEB630)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDEB5D0)

inline static constexpr unsigned int Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex = 32730;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x575D0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_5*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x575D8);
	}
