...
#define CLASS_1_6DED08B7C7C749EF_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DC368E0)
#define CLASS_1_6DED08B7C7C749EF_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1DC36330)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DC36490)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DC363F0)
#define CLASS_1_6DED08B7C7C749EF_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DC365C0)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DC36A70)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DC36A00)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DC36360)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1DC363A0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1DC36390)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1DC36380)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DC361F0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DC36370)
#define CLASS_1_6DED08B7C7C749EF_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DC36220)
#define CLASS_1_6DED08B7C7C749EF_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DC36740)
#define CLASS_1_6DED08B7C7C749EF_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DC367A0)
#define CLASS_1_6DED08B7C7C749EF_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC36B70)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DC36290)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC36230)

inline static constexpr unsigned int Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex = 33483;

class Class_1_6DED08B7C7C749EF_5 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_5*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x47410);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_NGJOKJCBILD()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x47418);
	}
	// static const ::System::Int32 CDDFKHMGIKC = 0x1; // 0x0
	// static const ::System::Int32 CIPHCNGGHJJ = 0x7; // 0x0
	// static const ::System::Int32 NPGGEJCIEND = 0x3; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* MKIMBAJGANG; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::System::String* GBEOKDKOKKG; // 0x20
