...
#define CLASS_1_6DED08B7C7C749EF_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EA738E0)
#define CLASS_1_6DED08B7C7C749EF_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1EA73330)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EA73490)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EA733F0)
#define CLASS_1_6DED08B7C7C749EF_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EA735C0)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EA73A70)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EA73A00)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1EA73360)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1EA733A0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1EA73390)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1EA73380)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EA731F0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1EA73370)
#define CLASS_1_6DED08B7C7C749EF_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EA73220)
#define CLASS_1_6DED08B7C7C749EF_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EA73740)
#define CLASS_1_6DED08B7C7C749EF_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EA737A0)
#define CLASS_1_6DED08B7C7C749EF_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA73B70)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA73290)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA73230)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x5BB30);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_NGJOKJCBILD()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x5BB38);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* MKIMBAJGANG; // 0x20
