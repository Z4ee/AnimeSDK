...
#define CLASS_1_F574BDCB88571F05_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178C05A0)
#define CLASS_1_F574BDCB88571F05_METHOD_1_22029239F59360DB_OFFSET UNITYSDK_OFFSET(0x178C0820)
#define CLASS_1_F574BDCB88571F05_METHOD_1_4C1C6BDA70EF0410_OFFSET UNITYSDK_OFFSET(0x178C05F0)
#define CLASS_1_F574BDCB88571F05_METHOD_1_937B45B908BF4585_OFFSET UNITYSDK_OFFSET(0x178C0A90)
#define CLASS_1_F574BDCB88571F05__CTOR_OFFSET UNITYSDK_OFFSET(0x178C0590)
#define CLASS_1_F574BDCB88571F05__START_B__2_0_OFFSET UNITYSDK_OFFSET(0x178C0F60)
#define CLASS_1_F574BDCB88571F05__STOP_B__3_0_OFFSET UNITYSDK_OFFSET(0x178C0F70)

inline static constexpr unsigned int Class_1_F574BDCB88571F05_TypeDefinitionIndex = 78226;

class Class_1_F574BDCB88571F05 : public ::System::Object
{
public:
	::System::String* NNIOCPHFNNG; // 0x10
	::Il2CppArray<::Class_1_DA16F6EFFF969A86*>* EJJJMLPECEJ; // 0x18
	::RPG::Client::Prop::OpticalIllusionPuzzleBoard* MIPPNCGOJNM; // 0x20
	::RPG::Client::MonoEffect* LBNBPMIFDHI; // 0x28
	::UnityEngine::Coroutine* NAEJCNNMAKA; // 0x30
	::System::Action* HIBJGHDJLJO; // 0x38
	::System::Boolean OFEPHLEKKCD; // 0x40
	::System::Single CHIPCDEFEPM; // 0x44
	::System::Single GHABAAOGBNO; // 0x48
	::System::Int32 LMOHABJNMFF; // 0x4C
