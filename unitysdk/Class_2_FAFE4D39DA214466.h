...
#define CLASS_2_FAFE4D39DA214466_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x163A2310)
#define CLASS_2_FAFE4D39DA214466_METHOD_2_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x163A23C0)
#define CLASS_2_FAFE4D39DA214466_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x163A2410)
#define CLASS_2_FAFE4D39DA214466_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x163A2660)
#define CLASS_2_FAFE4D39DA214466__CTOR_OFFSET UNITYSDK_OFFSET(0x163A2370)

inline static constexpr unsigned int Class_2_FAFE4D39DA214466_TypeDefinitionIndex = 80894;

class Class_2_FAFE4D39DA214466 : public ::Class_1_FAF146B3D74C3C3F
{
public:
	::System::String* GKHIHPGCLIK; // 0x20
	::Class_2_293C6AF513403273* BGKEEIDDGOB; // 0x28
