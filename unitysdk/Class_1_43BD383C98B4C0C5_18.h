...
#define CLASS_1_43BD383C98B4C0C5_18_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1A47D0)
#define CLASS_1_43BD383C98B4C0C5_18__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A4810)
