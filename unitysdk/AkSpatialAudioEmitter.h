...
#define AKSPATIALAUDIOEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D4010)

inline static constexpr unsigned int AkSpatialAudioEmitter_TypeDefinitionIndex = 42149;
