...
#define AKSPATIALAUDIOEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA270D0)

inline static constexpr unsigned int AkSpatialAudioEmitter_TypeDefinitionIndex = 33810;
