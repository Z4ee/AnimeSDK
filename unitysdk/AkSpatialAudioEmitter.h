...
#define AKSPATIALAUDIOEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A6D00)

inline static constexpr unsigned int AkSpatialAudioEmitter_TypeDefinitionIndex = 41334;
