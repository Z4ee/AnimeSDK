...
#define CLASS_1_5B567C8A01BAEDFE_354_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A736D60)
#define CLASS_1_5B567C8A01BAEDFE_354_CLONE_OFFSET UNITYSDK_OFFSET(0x1A736BD0)
#define CLASS_1_5B567C8A01BAEDFE_354_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A736C70)
#define CLASS_1_5B567C8A01BAEDFE_354_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A736C10)
#define CLASS_1_5B567C8A01BAEDFE_354_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A736CC0)
#define CLASS_1_5B567C8A01BAEDFE_354_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A736DB0)
#define CLASS_1_5B567C8A01BAEDFE_354_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A736D80)
#define CLASS_1_5B567C8A01BAEDFE_354_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A736B50)
#define CLASS_1_5B567C8A01BAEDFE_354_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A736B80)
#define CLASS_1_5B567C8A01BAEDFE_354_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A736CF0)
#define CLASS_1_5B567C8A01BAEDFE_354_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A736D50)
#define CLASS_1_5B567C8A01BAEDFE_354__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A736E00)
#define CLASS_1_5B567C8A01BAEDFE_354__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A736BA0)
#define CLASS_1_5B567C8A01BAEDFE_354__CTOR_OFFSET UNITYSDK_OFFSET(0x1A736B90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_354_TypeDefinitionIndex = 32411;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_354*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_354_TypeDefinitionIndex)->GetStaticField(0x3E7E0);
	}
