...
#define STAGEHARMONYVECTORDEMODULATOR_METHOD_3_B4DE4A1745AD2498_OFFSET UNITYSDK_OFFSET(0xB9559F0)
#define STAGEHARMONYVECTORDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xB955A90)
#define STAGEHARMONYVECTORDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB955AE0)

inline static constexpr unsigned int StageHarmonyVectorDemodulator_TypeDefinitionIndex = 44278;
