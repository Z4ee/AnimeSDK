...
#define STAGEHARMONYVECTORDEMODULATOR_METHOD_3_B4DE4A1745AD2498_OFFSET UNITYSDK_OFFSET(0xABDFD80)
#define STAGEHARMONYVECTORDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xABDFE20)
#define STAGEHARMONYVECTORDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xABDFE70)

inline static constexpr unsigned int StageHarmonyVectorDemodulator_TypeDefinitionIndex = 38394;
