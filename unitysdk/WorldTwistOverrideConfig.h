...
#define WORLDTWISTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9BBC50)

inline static constexpr unsigned int WorldTwistOverrideConfig_TypeDefinitionIndex = 27393;
