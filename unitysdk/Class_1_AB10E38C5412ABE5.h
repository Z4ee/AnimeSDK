...
#define CLASS_1_AB10E38C5412ABE5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DC2C040)
#define CLASS_1_AB10E38C5412ABE5_CLONE_OFFSET UNITYSDK_OFFSET(0x1DC2BA10)
#define CLASS_1_AB10E38C5412ABE5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DC2BB20)
#define CLASS_1_AB10E38C5412ABE5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DC2BAF0)
#define CLASS_1_AB10E38C5412ABE5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DC2BD40)
#define CLASS_1_AB10E38C5412ABE5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DC2C110)
#define CLASS_1_AB10E38C5412ABE5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DC2C0B0)
#define CLASS_1_AB10E38C5412ABE5_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1DC2BA80)
#define CLASS_1_AB10E38C5412ABE5_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1DC2BA70)
#define CLASS_1_AB10E38C5412ABE5_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1DC2BAD0)
#define CLASS_1_AB10E38C5412ABE5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DC2B970)
#define CLASS_1_AB10E38C5412ABE5_METHOD_1_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x1DC2BAE0)
#define CLASS_1_AB10E38C5412ABE5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DC2B9A0)
#define CLASS_1_AB10E38C5412ABE5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DC2BEE0)
#define CLASS_1_AB10E38C5412ABE5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DC2BF40)
#define CLASS_1_AB10E38C5412ABE5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC2C2C0)
#define CLASS_1_AB10E38C5412ABE5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DC2B9C0)
#define CLASS_1_AB10E38C5412ABE5__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2B9B0)

inline static constexpr unsigned int Class_1_AB10E38C5412ABE5_TypeDefinitionIndex = 33326;

class Class_1_AB10E38C5412ABE5 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_AB10E38C5412ABE5*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_AB10E38C5412ABE5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AB10E38C5412ABE5_TypeDefinitionIndex)->GetStaticField(0x456E0);
	}
	// static const ::System::Int32 AFBDHEMJEPP = 0xC; // 0x0
	// static const ::System::Int32 JLAAHBJNEML = 0x6; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::String* PDKNJCIEBHA; // 0x18
	::System::Single DFKHBNCHKBI; // 0x20
