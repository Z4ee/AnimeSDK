...
#define CLASS_2_4DAD3B9FE7AD7A9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA224910)
#define CLASS_2_4DAD3B9FE7AD7A9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA224950)
#define CLASS_2_4DAD3B9FE7AD7A9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA2249E0)
#define CLASS_2_4DAD3B9FE7AD7A9C_TICK_OFFSET UNITYSDK_OFFSET(0xA224A30)
#define CLASS_2_4DAD3B9FE7AD7A9C__CTOR_OFFSET UNITYSDK_OFFSET(0xA224900)

inline static constexpr unsigned int Class_2_4DAD3B9FE7AD7A9C_TypeDefinitionIndex = 47248;

class Class_2_4DAD3B9FE7AD7A9C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetLocalWinFlag* Field_2_0; // 0x20
