...
#define SWRT_SWRT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EE64D20)
#define SWRT_SWRT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EE64B80)
#define SWRT_SWRT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE64E20)
