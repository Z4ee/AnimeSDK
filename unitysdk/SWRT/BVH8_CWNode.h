...
#define SWRT_BVH8_CWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x22B9E70)

namespace SWRT
{
	inline static constexpr unsigned int BVH8_CWNode_TypeDefinitionIndex = 34896;
	...
	struct alignas(4) BVH8_CWNode
	{
		...
		/*
		::System::Void _ctor(::SWRT::BVH8_CWNodeUnpacked node)
		{
			return ((::System::Void(*)(::PVOID, ::SWRT::BVH8_CWNodeUnpacked))((::PBYTE)hIl2Cpp + SWRT_BVH8_CWNODE__CTOR_OFFSET))(this, node);
		}
		*/
	};
}
