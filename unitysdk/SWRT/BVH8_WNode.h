...
#define SWRT_BVH8_WNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18188460)

namespace SWRT
{
	inline static constexpr unsigned int BVH8_WNode_TypeDefinitionIndex = 34886;
	...
	public:
		...
		::System::Int32 CPrimBaseIndex; // 0x50
		::UnityEngine::Vector3 AABBMax; // 0x54
