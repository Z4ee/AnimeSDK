...
#define SWRT_BVH2_HNODE_GET_ISLEAF_OFFSET UNITYSDK_OFFSET(0x181876C0)
#define SWRT_BVH2_HNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x181876D0)

namespace SWRT
{
	inline static constexpr unsigned int BVH2_HNode_TypeDefinitionIndex = 34881;
