...
#define SWRT_AABB_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x3AD95C0)
#define SWRT_AABB_GET_EXTENDS_OFFSET UNITYSDK_OFFSET(0x3AD3FC0)
#define SWRT_AABB_GET_MAX_OFFSET UNITYSDK_OFFSET(0x38CBD20)
#define SWRT_AABB_GET_MIN_OFFSET UNITYSDK_OFFSET(0x165820)
#define SWRT_AABB_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x395C1C0)
#define SWRT_AABB_SET_MAX_OFFSET UNITYSDK_OFFSET(0x38CBD40)
#define SWRT_AABB_SET_MIN_OFFSET UNITYSDK_OFFSET(0x165690)
#define SWRT_AABB_SURFACEAREA_OFFSET UNITYSDK_OFFSET(0x3AD97D0)
#define SWRT_AABB_UNION_1_OFFSET UNITYSDK_OFFSET(0x1D13CC30)
#define SWRT_AABB_UNION_OFFSET UNITYSDK_OFFSET(0x3AD9780)
#define SWRT_AABB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3AD96A0)
#define SWRT_AABB__CTOR_OFFSET UNITYSDK_OFFSET(0x3AD9600)

namespace SWRT
{
	inline static constexpr unsigned int AABB_TypeDefinitionIndex = 35944;
