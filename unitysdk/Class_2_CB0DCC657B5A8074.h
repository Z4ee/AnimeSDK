...
#define CLASS_2_CB0DCC657B5A8074_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155238A0)
#define CLASS_2_CB0DCC657B5A8074_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x15523C10)
#define CLASS_2_CB0DCC657B5A8074_METHOD_2_F55160DB3394C58D_OFFSET UNITYSDK_OFFSET(0x15523EB0)
#define CLASS_2_CB0DCC657B5A8074_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15523CF0)
#define CLASS_2_CB0DCC657B5A8074_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15523DA0)
#define CLASS_2_CB0DCC657B5A8074_TICK_OFFSET UNITYSDK_OFFSET(0x15523A90)
#define CLASS_2_CB0DCC657B5A8074__CTOR_OFFSET UNITYSDK_OFFSET(0x155237B0)
...
public:
	...
	::RPG::GameCore::WaitPhotoGraphConditionResult* OFKGLJOAMLD; // 0x28
