...
#define CLASS_3_8B5C246122C47145_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x14FF5600)
#define CLASS_3_8B5C246122C47145_METHOD_3_00DD5E22412E831E_OFFSET UNITYSDK_OFFSET(0x14FF78C0)
#define CLASS_3_8B5C246122C47145_METHOD_3_6A95C9C629848F04_OFFSET UNITYSDK_OFFSET(0x14FF60F0)
#define CLASS_3_8B5C246122C47145_METHOD_3_6EE6A27960654DB8_OFFSET UNITYSDK_OFFSET(0x14FF5F10)
#define CLASS_3_8B5C246122C47145_METHOD_3_807F2A52783217B1_OFFSET UNITYSDK_OFFSET(0x14FF83D0)
#define CLASS_3_8B5C246122C47145_METHOD_3_90FAC76749C7F5B5_OFFSET UNITYSDK_OFFSET(0x14FF7640)
#define CLASS_3_8B5C246122C47145_METHOD_3_9E768B9E7876D4DE_OFFSET UNITYSDK_OFFSET(0x14FF7AE0)
#define CLASS_3_8B5C246122C47145_METHOD_3_A0DC3805CCC8A542_OFFSET UNITYSDK_OFFSET(0x14FF9560)
#define CLASS_3_8B5C246122C47145_METHOD_3_AF8195137AC6C12D_OFFSET UNITYSDK_OFFSET(0x14FF8220)
#define CLASS_3_8B5C246122C47145_METHOD_3_B95AB671BE22D94D_OFFSET UNITYSDK_OFFSET(0x14FF6440)
#define CLASS_3_8B5C246122C47145_METHOD_3_B9B2FC4F6DB802EB_OFFSET UNITYSDK_OFFSET(0x14FF73B0)
#define CLASS_3_8B5C246122C47145_METHOD_3_BADC81CF9C936EDA_OFFSET UNITYSDK_OFFSET(0x14FF6060)
#define CLASS_3_8B5C246122C47145_METHOD_3_BED82C557EE24F50_OFFSET UNITYSDK_OFFSET(0x14FF68A0)
#define CLASS_3_8B5C246122C47145_METHOD_3_BF6A40F21F41755D_OFFSET UNITYSDK_OFFSET(0x14FF7460)
#define CLASS_3_8B5C246122C47145_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14FF8340)
#define CLASS_3_8B5C246122C47145_METHOD_3_E52A85E9F69A491B_OFFSET UNITYSDK_OFFSET(0x14FF7840)
#define CLASS_3_8B5C246122C47145_METHOD_3_F702E6651D2A079D_OFFSET UNITYSDK_OFFSET(0x14FF5B50)
#define CLASS_3_8B5C246122C47145_UPDATE_OFFSET UNITYSDK_OFFSET(0x14FF59D0)
#define CLASS_3_8B5C246122C47145__CTOR_OFFSET UNITYSDK_OFFSET(0x14FF5B00)

inline static constexpr unsigned int Class_3_8B5C246122C47145_TypeDefinitionIndex = 44023;
...
public:
	...
	static ::System::String* Method_3_B9B2FC4F6DB802EB(::MoleMole::Battle::Entity* a1, ::Class_3_B8F2A25A5ADF5CEE* a2)
	{
		return ((::System::String*(*)(::MoleMole::Battle::Entity*, ::Class_3_B8F2A25A5ADF5CEE*))((::PBYTE)hIl2Cpp + CLASS_3_8B5C246122C47145_METHOD_3_B9B2FC4F6DB802EB_OFFSET))(a1, a2);
	}
	...
	static ::System::Boolean Method_3_E52A85E9F69A491B(::Class_2_208CC9941471731A_1117* a1)
	{
		return ((::System::Boolean(*)(::Class_2_208CC9941471731A_1117*))((::PBYTE)hIl2Cpp + CLASS_3_8B5C246122C47145_METHOD_3_E52A85E9F69A491B_OFFSET))(a1);
	}
	...
	static ::System::Void Method_3_9E768B9E7876D4DE(::Class_3_09C6D749A1B6BB3E* a1, ::Class_3_B8F2A25A5ADF5CEE* a2, ::Class_3_F33F9DC5F4112336* a3)
	{
		return ((::System::Void(*)(::Class_3_09C6D749A1B6BB3E*, ::Class_3_B8F2A25A5ADF5CEE*, ::Class_3_F33F9DC5F4112336*))((::PBYTE)hIl2Cpp + CLASS_3_8B5C246122C47145_METHOD_3_9E768B9E7876D4DE_OFFSET))(a1, a2, a3);
	}
