...
#define CLASS_1_12271C42C4A51895_1_METHOD_1_7EFD94ECD2A1208E_OFFSET UNITYSDK_OFFSET(0x19989670)
#define CLASS_1_12271C42C4A51895_1_METHOD_1_F8F6A303DF35A01D_OFFSET UNITYSDK_OFFSET(0x19989730)
#define CLASS_1_12271C42C4A51895_1__CTOR_OFFSET UNITYSDK_OFFSET(0x199898F0)

inline static constexpr unsigned int Class_1_12271C42C4A51895_1_TypeDefinitionIndex = 62921;
...
public:
	...
	{
		return ((::Class_0_16E4307DCC419505_419*(*)(::PVOID, ::Class_0_16E4307DCC419505_419*, ::RPG::AvatarSystem::IAvatar*, ::Class_1_65EF9EC87B818BF3*))((::PBYTE)hIl2Cpp + CLASS_1_12271C42C4A51895_1_METHOD_1_F8F6A303DF35A01D_OFFSET))(this, a1, a2, a3);
	}
};
