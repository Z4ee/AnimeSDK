...
#define CLASS_1_393788F99F11B777_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187D7ED0)
#define CLASS_1_393788F99F11B777_GET_MODE_OFFSET UNITYSDK_OFFSET(0x187D86E0)
#define CLASS_1_393788F99F11B777_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x187D7430)
#define CLASS_1_393788F99F11B777_METHOD_1_53E30A4F2E776E4F_OFFSET UNITYSDK_OFFSET(0x187D8290)
#define CLASS_1_393788F99F11B777_METHOD_1_64748F4446A4BF5B_OFFSET UNITYSDK_OFFSET(0x187D84B0)
#define CLASS_1_393788F99F11B777_METHOD_1_D4975DF907B2431F_OFFSET UNITYSDK_OFFSET(0x187D7480)
#define CLASS_1_393788F99F11B777_METHOD_1_DD452FFC9DB74C79_OFFSET UNITYSDK_OFFSET(0x187D8050)
#define CLASS_1_393788F99F11B777_METHOD_1_ECE69D9D242E4D7A_OFFSET UNITYSDK_OFFSET(0x187D79E0)
#define CLASS_1_393788F99F11B777_METHOD_1_F5972DD1C3F4267B_OFFSET UNITYSDK_OFFSET(0x187D7890)
#define CLASS_1_393788F99F11B777_SET_MODE_OFFSET UNITYSDK_OFFSET(0x187D86F0)
#define CLASS_1_393788F99F11B777__CTOR_OFFSET UNITYSDK_OFFSET(0x187D73D0)
...
public:
	...
	::UnityEngine::Transform* ILFCKOFPHGH; // 0x10
	::RPG::GameCore::GameEntity* JCCHOIPFHHD; // 0x18
	::System::Single JDLCCIPIHEM; // 0x20
	::System::Single EMFNDEMFDAE; // 0x24
	::RPG::Client::TravelShipCameraMode _Mode_k__BackingField; // 0x28
	::System::Single MDALBHBADBJ; // 0x2C
	::System::Single KALMIGLCEAP; // 0x30
	::System::Single DBNPPMOPFNG; // 0x34
	::System::Single BAAHCPEDNDO; // 0x38
	::System::Single CNPIJNIMJHA; // 0x3C
	::System::Single EILFNDNFIFK; // 0x40
	::System::Boolean MHEAIOMEGCA; // 0x44
	::System::Boolean GMJHMBDAAID; // 0x45
