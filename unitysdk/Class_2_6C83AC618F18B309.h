...
#define CLASS_2_6C83AC618F18B309_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1253A5C0)
#define CLASS_2_6C83AC618F18B309_METHOD_2_91F134D80943E100_OFFSET UNITYSDK_OFFSET(0x1253A820)
#define CLASS_2_6C83AC618F18B309_METHOD_2_AE0B725AB77F7E6F_OFFSET UNITYSDK_OFFSET(0x1253A7A0)
#define CLASS_2_6C83AC618F18B309_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1253A210)
#define CLASS_2_6C83AC618F18B309_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1253A360)
#define CLASS_2_6C83AC618F18B309_TICK_OFFSET UNITYSDK_OFFSET(0x1253A660)
#define CLASS_2_6C83AC618F18B309__CTOR_OFFSET UNITYSDK_OFFSET(0x1253A130)

inline static constexpr unsigned int Class_2_6C83AC618F18B309_TypeDefinitionIndex = 54368;

class Class_2_6C83AC618F18B309 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::WolfBroPuzzleGameDataListener* Field_2_1; // 0x18
	::RPG::Client::MonoWolfBroCustomData* Field_2_2; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_6C83AC618F18B309_METHOD_2_AE0B725AB77F7E6F_OFFSET))(this);
	}
};
