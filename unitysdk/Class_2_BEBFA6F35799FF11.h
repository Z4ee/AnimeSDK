...
#define CLASS_2_BEBFA6F35799FF11_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x186CF390)
#define CLASS_2_BEBFA6F35799FF11_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x186CF460)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x186CEFE0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_6240D6A70F158712_OFFSET UNITYSDK_OFFSET(0x186CF1A0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_66DB3CB36C1BD375_OFFSET UNITYSDK_OFFSET(0x186CEC80)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_7DD84EAFF333A1E4_1_OFFSET UNITYSDK_OFFSET(0x186CEF90)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x186CEF40)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x186CF0B0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_A9AE92A8BD1FF115_OFFSET UNITYSDK_OFFSET(0x186CEAD0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_AC1BFDB3D2FC0C79_OFFSET UNITYSDK_OFFSET(0x186CEC10)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_C5F2E178DAEB1793_OFFSET UNITYSDK_OFFSET(0x186CE7C0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x186CEEB0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x186CEDE0)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_EDE51B31CB05573F_OFFSET UNITYSDK_OFFSET(0x186CF130)
#define CLASS_2_BEBFA6F35799FF11_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x186CF210)
#define CLASS_2_BEBFA6F35799FF11__CTOR_OFFSET UNITYSDK_OFFSET(0x186CF500)
#define CLASS_2_BEBFA6F35799FF11__ONBIND_OFFSET UNITYSDK_OFFSET(0x186CE6B0)
#define CLASS_2_BEBFA6F35799FF11__ONTICK_OFFSET UNITYSDK_OFFSET(0x186CE940)

inline static constexpr unsigned int Class_2_BEBFA6F35799FF11_TypeDefinitionIndex = 71738;

class Class_2_BEBFA6F35799FF11 : public ::Class_1_34917908B7833130
{
public:
	::RPG::Client::LocalizedText* AGNIJEOAICD; // 0x60
	::Class_2_7CCE1EDB2270143F* JCMPJLEDFAA; // 0x68
	::RPG::GameCore::CharacterDataComponent* HFKMDPCLJJB; // 0x70
	::RPG::Client::MonoInControlTip* OOBBOFLHLDH; // 0x78
	::UnityEngine::UI::Button* KJIOINOOIHP; // 0x80
	::RPG::GameCore::GameEntity* OJAHLJGABMJ; // 0x88
