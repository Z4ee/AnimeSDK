...
#define MONODETECTCOLLIDER_LOOKAROUND_OFFSET UNITYSDK_OFFSET(0x1C469630)
#define MONODETECTCOLLIDER_LOOK_OFFSET UNITYSDK_OFFSET(0x1C469590)
#define MONODETECTCOLLIDER_START_OFFSET UNITYSDK_OFFSET(0x1C469050)
#define MONODETECTCOLLIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C469060)
#define MONODETECTCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C469C70)

inline static constexpr unsigned int MonoDetectCollider_TypeDefinitionIndex = 85483;
