...
#define CLASS_1_CCF20DC2AAC0169A_GET_AREAPOSITION_OFFSET UNITYSDK_OFFSET(0x185EAB00)
#define CLASS_1_CCF20DC2AAC0169A_GET_AREATYPE_OFFSET UNITYSDK_OFFSET(0x185EAAA0)
#define CLASS_1_CCF20DC2AAC0169A_GET_POSE_OFFSET UNITYSDK_OFFSET(0x185EAAE0)
#define CLASS_1_CCF20DC2AAC0169A_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x185EAAC0)
#define CLASS_1_CCF20DC2AAC0169A_SET_AREAPOSITION_OFFSET UNITYSDK_OFFSET(0x185EAB10)
#define CLASS_1_CCF20DC2AAC0169A_SET_AREATYPE_OFFSET UNITYSDK_OFFSET(0x185EAAB0)
#define CLASS_1_CCF20DC2AAC0169A_SET_POSE_OFFSET UNITYSDK_OFFSET(0x185EAAF0)
#define CLASS_1_CCF20DC2AAC0169A_SET_SLOT_OFFSET UNITYSDK_OFFSET(0x185EAAD0)
#define CLASS_1_CCF20DC2AAC0169A__CTOR_OFFSET UNITYSDK_OFFSET(0x185EAB20)

inline static constexpr unsigned int Class_1_CCF20DC2AAC0169A_TypeDefinitionIndex = 60210;

class Class_1_CCF20DC2AAC0169A : public ::System::Object
{
public:
	::RPG::GameCore::CakeValidAreaType _AreaType_k__BackingField; // 0x10
	::RPG::Client::TrainCakeCatchExhibitController_CatGroundType _Pose_k__BackingField; // 0x14
