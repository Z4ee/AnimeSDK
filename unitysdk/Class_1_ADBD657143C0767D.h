...
#define CLASS_1_ADBD657143C0767D_GET_CURSORPOS_OFFSET UNITYSDK_OFFSET(0x92A3C90)
#define CLASS_1_ADBD657143C0767D_GET_ISPRESSJOYSTICK_OFFSET UNITYSDK_OFFSET(0x92A3CC0)
#define CLASS_1_ADBD657143C0767D_GET_JOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0x92A3CE0)
#define CLASS_1_ADBD657143C0767D_GET_TOUCHINPUT_OFFSET UNITYSDK_OFFSET(0x92A3D10)
#define CLASS_1_ADBD657143C0767D_METHOD_1_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x92A30F0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x92A39F0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_28F815C49D235C59_OFFSET UNITYSDK_OFFSET(0x92A2BE0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_354CB9B459B0C5D5_OFFSET UNITYSDK_OFFSET(0x92A3070)
#define CLASS_1_ADBD657143C0767D_METHOD_1_4D2A473556700CDC_1_OFFSET UNITYSDK_OFFSET(0x92A36A0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x92A3140)
#define CLASS_1_ADBD657143C0767D_METHOD_1_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x92A3650)
#define CLASS_1_ADBD657143C0767D_METHOD_1_85E657E328490B3B_OFFSET UNITYSDK_OFFSET(0x92A2B10)
#define CLASS_1_ADBD657143C0767D_METHOD_1_8BD11CDEA7D5139F_OFFSET UNITYSDK_OFFSET(0x92A3B20)
#define CLASS_1_ADBD657143C0767D_METHOD_1_9D967D80C41C7781_1_OFFSET UNITYSDK_OFFSET(0x92A4090)
#define CLASS_1_ADBD657143C0767D_METHOD_1_9D967D80C41C7781_2_OFFSET UNITYSDK_OFFSET(0x92A40E0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_9D967D80C41C7781_OFFSET UNITYSDK_OFFSET(0x92A4040)
#define CLASS_1_ADBD657143C0767D_METHOD_1_AA1355730928EC40_OFFSET UNITYSDK_OFFSET(0x92A3E70)
#define CLASS_1_ADBD657143C0767D_METHOD_1_B12B4E4A39A083D2_OFFSET UNITYSDK_OFFSET(0x92A2F10)
#define CLASS_1_ADBD657143C0767D_METHOD_1_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x92A3490)
#define CLASS_1_ADBD657143C0767D_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x92A3E10)
#define CLASS_1_ADBD657143C0767D_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x92A2B90)
#define CLASS_1_ADBD657143C0767D_METHOD_1_D20BF56E36607D54_1_OFFSET UNITYSDK_OFFSET(0x92A2AC0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_D20BF56E36607D54_OFFSET UNITYSDK_OFFSET(0x92A2A70)
#define CLASS_1_ADBD657143C0767D_METHOD_1_F3044C7F0F775E6E_OFFSET UNITYSDK_OFFSET(0x92A3D40)
#define CLASS_1_ADBD657143C0767D_SET_CURSORPOS_OFFSET UNITYSDK_OFFSET(0x92A3CB0)
#define CLASS_1_ADBD657143C0767D_SET_ISPRESSJOYSTICK_OFFSET UNITYSDK_OFFSET(0x92A3CD0)
#define CLASS_1_ADBD657143C0767D_SET_JOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0x92A3D00)
#define CLASS_1_ADBD657143C0767D_SET_TOUCHINPUT_OFFSET UNITYSDK_OFFSET(0x92A3D30)
#define CLASS_1_ADBD657143C0767D__CTOR_OFFSET UNITYSDK_OFFSET(0x92A4130)

inline static constexpr unsigned int Class_1_ADBD657143C0767D_TypeDefinitionIndex = 68224;

class Class_1_ADBD657143C0767D : public ::System::Object
{
public:
	::HedgehogTeam::EasyTouch::EasyTouch_EvtType Field_1_8; // 0x10
	::UnityEngine::Vector3 _CursorPos_k__BackingField; // 0x14
	::UnityEngine::Vector3 _TouchInput_k__BackingField; // 0x20
	::System::Int32 Field_1_7; // 0x2C
	::System::Single Field_1_4; // 0x30
	::UnityEngine::Vector3 _JoyStickInput_k__BackingField; // 0x34
	::System::Boolean _IsPressJoyStick_k__BackingField; // 0x40
