...
#define CLASS_1_A8D9A742F7AB118B_METHOD_1_0BE1846AC20D43BE_OFFSET UNITYSDK_OFFSET(0xF5C4860)
#define CLASS_1_A8D9A742F7AB118B_METHOD_1_A8AE4A9A45E37F95_OFFSET UNITYSDK_OFFSET(0xF5C4770)
#define CLASS_1_A8D9A742F7AB118B_METHOD_1_FFE3B23FA133E1EE_OFFSET UNITYSDK_OFFSET(0xF5C4A70)
#define CLASS_1_A8D9A742F7AB118B__CTOR_OFFSET UNITYSDK_OFFSET(0xF5C4760)

inline static constexpr unsigned int Class_1_A8D9A742F7AB118B_TypeDefinitionIndex = 78800;
...
public:
	...
	{
		return (::MoleMole::Config::ConfigAutoBattleAccessoryEffect**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A8D9A742F7AB118B_TypeDefinitionIndex)->GetStaticField(0x2F800);
	}
