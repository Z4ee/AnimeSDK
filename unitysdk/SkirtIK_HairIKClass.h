...
#define SKIRTIK_HAIRIKCLASS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x19F7AD60)
#define SKIRTIK_HAIRIKCLASS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19F7AD20)
#define SKIRTIK_HAIRIKCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F7ADA0)

inline static constexpr unsigned int SkirtIK_HairIKClass_TypeDefinitionIndex = 45467;
