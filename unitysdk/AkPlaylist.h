...
#define AKPLAYLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C2EC330)
#define AKPLAYLIST_ENQUEUE_1_OFFSET UNITYSDK_OFFSET(0x1C2EC5D0)
#define AKPLAYLIST_ENQUEUE_2_OFFSET UNITYSDK_OFFSET(0x1C2EC680)
#define AKPLAYLIST_ENQUEUE_3_OFFSET UNITYSDK_OFFSET(0x1C2EC720)
#define AKPLAYLIST_ENQUEUE_4_OFFSET UNITYSDK_OFFSET(0x1C2EC7B0)
#define AKPLAYLIST_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x1C2EC500)
#define AKPLAYLIST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1C2EC290)
#define AKPLAYLIST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1C2EC2A0)
#define AKPLAYLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2EC840)
#define AKPLAYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2EC200)

inline static constexpr unsigned int AkPlaylist_TypeDefinitionIndex = 31450;
