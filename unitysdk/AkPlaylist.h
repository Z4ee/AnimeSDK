...
#define AKPLAYLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BD6EE60)
#define AKPLAYLIST_ENQUEUE_1_OFFSET UNITYSDK_OFFSET(0x1BD6F340)
#define AKPLAYLIST_ENQUEUE_2_OFFSET UNITYSDK_OFFSET(0x1BD6F430)
#define AKPLAYLIST_ENQUEUE_3_OFFSET UNITYSDK_OFFSET(0x1BD6F510)
#define AKPLAYLIST_ENQUEUE_4_OFFSET UNITYSDK_OFFSET(0x1BD6F5E0)
#define AKPLAYLIST_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x1BD6F230)
#define AKPLAYLIST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1BD6ECB0)
#define AKPLAYLIST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1BD6ED00)
#define AKPLAYLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD6F6A0)
#define AKPLAYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD6EC10)

inline static constexpr unsigned int AkPlaylist_TypeDefinitionIndex = 41971;
