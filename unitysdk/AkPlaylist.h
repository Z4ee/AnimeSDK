...
#define AKPLAYLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DAA1AF0)
#define AKPLAYLIST_ENQUEUE_1_OFFSET UNITYSDK_OFFSET(0x1DAA1FD0)
#define AKPLAYLIST_ENQUEUE_2_OFFSET UNITYSDK_OFFSET(0x1DAA20C0)
#define AKPLAYLIST_ENQUEUE_3_OFFSET UNITYSDK_OFFSET(0x1DAA21A0)
#define AKPLAYLIST_ENQUEUE_4_OFFSET UNITYSDK_OFFSET(0x1DAA2270)
#define AKPLAYLIST_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x1DAA1EC0)
#define AKPLAYLIST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1DAA1940)
#define AKPLAYLIST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1DAA1990)
#define AKPLAYLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAA2330)
#define AKPLAYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAA18A0)
