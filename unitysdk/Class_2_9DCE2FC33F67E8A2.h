...
#define CLASS_2_9DCE2FC33F67E8A2_METHOD_2_9F86FD0988591376_OFFSET UNITYSDK_OFFSET(0x11EA4C30)
#define CLASS_2_9DCE2FC33F67E8A2__CTOR_OFFSET UNITYSDK_OFFSET(0x11EA4C20)

inline static constexpr unsigned int Class_2_9DCE2FC33F67E8A2_TypeDefinitionIndex = 55260;

class Class_2_9DCE2FC33F67E8A2 : public ::Class_1_43BD383C98B4C0C5_25
{
public:
	::MoleMole::UIHollowMainPageController* Field_2_7; // 0x10
	::MoleMole::UIHollowChessboard3DModelController* Field_2_1; // 0x18
	::Class_1_E5B7864412CDC074* Field_2_0; // 0x20
