...
#define CLASS_1_AB3C5C546C7E20BB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18E7A4A0)
#define CLASS_1_AB3C5C546C7E20BB_METHOD_1_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0x18E7A4E0)
#define CLASS_1_AB3C5C546C7E20BB_METHOD_1_AA5BC7DF3E976197_OFFSET UNITYSDK_OFFSET(0x18E7A530)
#define CLASS_1_AB3C5C546C7E20BB__CTOR_OFFSET UNITYSDK_OFFSET(0x18E7A150)

inline static constexpr unsigned int Class_1_AB3C5C546C7E20BB_TypeDefinitionIndex = 77479;

class Class_1_AB3C5C546C7E20BB : public ::System::Object
{
public:
	::Class_3_543326C044264182* PDENFEFCAGN; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Color>* ENOJCDIEPHA; // 0x18
