...
#define RPGCAMERA_BLENDERUTILS_LERPPOS_OFFSET UNITYSDK_OFFSET(0x1B7526B0)
#define RPGCAMERA_BLENDERUTILS_LERPRADIUS_OFFSET UNITYSDK_OFFSET(0x1B751C70)
#define RPGCAMERA_BLENDERUTILS_LERPSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1B751D50)
#define RPGCAMERA_BLENDERUTILS_LERPSPH_OFFSET UNITYSDK_OFFSET(0x1B751E80)
#define RPGCAMERA_BLENDERUTILS_LERPVECTOR3_OFFSET UNITYSDK_OFFSET(0x1B751BA0)

namespace RPGCamera
{
	inline static constexpr unsigned int BlenderUtils_TypeDefinitionIndex = 42636;
