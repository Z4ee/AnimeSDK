...
#define RPGCAMERA_CAMERABLENDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x85BABD0)

namespace RPGCamera
{
	inline static constexpr unsigned int CameraBlendState_TypeDefinitionIndex = 35111;
