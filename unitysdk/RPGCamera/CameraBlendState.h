...
#define RPGCAMERA_CAMERABLENDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x8DF0C00)

namespace RPGCamera
{
	inline static constexpr unsigned int CameraBlendState_TypeDefinitionIndex = 40939;
