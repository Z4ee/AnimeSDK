...
#define CLASS_3_E3637432884C0D3F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x117ACD00)
#define CLASS_3_E3637432884C0D3F__CTOR_OFFSET UNITYSDK_OFFSET(0x117ACCD0)

inline static constexpr unsigned int Class_3_E3637432884C0D3F_TypeDefinitionIndex = 44333;
