...
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x187D89F0)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x187D8CA0)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x187D8890)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x187D8D00)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x187D8C10)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_C274475308736EB1_OFFSET UNITYSDK_OFFSET(0x187D8700)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x187D8A40)
#define CLASS_2_A92C91EC1758A1CE_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x187D8D60)
#define CLASS_2_A92C91EC1758A1CE_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x187D8BB0)
#define CLASS_2_A92C91EC1758A1CE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x187D87A0)
#define CLASS_2_A92C91EC1758A1CE__CTOR_OFFSET UNITYSDK_OFFSET(0x187D8E40)

inline static constexpr unsigned int Class_2_A92C91EC1758A1CE_TypeDefinitionIndex = 79531;

class Class_2_A92C91EC1758A1CE : public ::Class_1_3713064DEE761936
{
public:
	// static const ::System::Single GAANFPLAEEC; // 0x0
	::System::String* FGMKCOANOOK; // 0x20
	::System::Action_1<::System::String*>* MBOEDFCNCJF; // 0x28
	::UnityEngine::Coroutine* NAEJCNNMAKA; // 0x30
	::RPG::Client::MonoAnimationTrigger* GALAHGAJODG; // 0x38
	::System::Boolean BEMMCKLJICI; // 0x40
	::System::Single FILPDDOEEPD; // 0x44
