...
#define BABYHIPPLENCONTROLLER__PLAYHOWL02_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18BA54D0)
#define BABYHIPPLENCONTROLLER__PLAYHOWL02_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18BA57A0)
#define BABYHIPPLENCONTROLLER__PLAYHOWL02_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18BA5800)
#define BABYHIPPLENCONTROLLER__PLAYHOWL02_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18BA57B0)
#define BABYHIPPLENCONTROLLER__PLAYHOWL02_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BA54C0)
#define BABYHIPPLENCONTROLLER__PLAYHOWL02_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA2640)

inline static constexpr unsigned int BabyHipplenController__PlayHowl02_d__41_TypeDefinitionIndex = 45407;
