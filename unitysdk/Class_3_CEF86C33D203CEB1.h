...
#define CLASS_3_CEF86C33D203CEB1_METHOD_3_465C7AF349834498_OFFSET UNITYSDK_OFFSET(0x17A5A600)
#define CLASS_3_CEF86C33D203CEB1_METHOD_3_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0x17A5A590)
#define CLASS_3_CEF86C33D203CEB1_METHOD_3_A075CF751E1F56A2_OFFSET UNITYSDK_OFFSET(0x17A5A700)
#define CLASS_3_CEF86C33D203CEB1_METHOD_3_B25D8B00CDE640ED_OFFSET UNITYSDK_OFFSET(0x17A5AC50)
#define CLASS_3_CEF86C33D203CEB1_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17A5A550)
#define CLASS_3_CEF86C33D203CEB1__CTOR_OFFSET UNITYSDK_OFFSET(0x17A5A4C0)
#define CLASS_3_CEF86C33D203CEB1___N__0_OFFSET UNITYSDK_OFFSET(0x17A5B4D0)

inline static constexpr unsigned int Class_3_CEF86C33D203CEB1_TypeDefinitionIndex = 73776;

class Class_3_CEF86C33D203CEB1 : public ::Class_2_C89D4C6D15B742C2
{
public:
	::System::Nullable_1<::UnityEngine::Vector3> ONAFKLJMHIH; // 0x288
	::System::Int32 ENNBKAEMKHD; // 0x298
	::System::Int32 KHBFNMDLILM; // 0x29C
