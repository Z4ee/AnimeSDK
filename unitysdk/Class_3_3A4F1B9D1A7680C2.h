...
#define CLASS_3_3A4F1B9D1A7680C2_METHOD_3_B4C09A5853E73B8A_OFFSET UNITYSDK_OFFSET(0x1D0CAC70)
#define CLASS_3_3A4F1B9D1A7680C2_METHOD_3_C6C799B3DFBE236B_OFFSET UNITYSDK_OFFSET(0x1D0CAC30)
#define CLASS_3_3A4F1B9D1A7680C2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0CAC60)
...
public:
	...
	::System::Boolean DMKJAJLNEBK; // 0x24
