...
#define CLASS_1_C85C4DAB350DD5FC_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x16DCA060)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPADD_OFFSET UNITYSDK_OFFSET(0x16DC9FC0)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0x16DC9FA0)
#define CLASS_1_C85C4DAB350DD5FC_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x16DC9FE0)
#define CLASS_1_C85C4DAB350DD5FC_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x16DC9EE0)
#define CLASS_1_C85C4DAB350DD5FC_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x16DC9E90)
#define CLASS_1_C85C4DAB350DD5FC_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x16DC9EA0)
#define CLASS_1_C85C4DAB350DD5FC_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x16DCA000)
#define CLASS_1_C85C4DAB350DD5FC_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x16DC9F00)
#define CLASS_1_C85C4DAB350DD5FC_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x16DCA020)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x16DCA0A0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x16DCA080)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x16DC9EC0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPADD_OFFSET UNITYSDK_OFFSET(0x16DC9F20)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0x16DC9F40)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x16DC9F80)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x16DC9F60)
#define CLASS_1_C85C4DAB350DD5FC_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x16DCA040)
#define CLASS_1_C85C4DAB350DD5FC_SET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x16DCA070)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPADD_OFFSET UNITYSDK_OFFSET(0x16DC9FD0)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPNEED_OFFSET UNITYSDK_OFFSET(0x16DC9FB0)
#define CLASS_1_C85C4DAB350DD5FC_SET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x16DC9FF0)
#define CLASS_1_C85C4DAB350DD5FC_SET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x16DC9EF0)
#define CLASS_1_C85C4DAB350DD5FC_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x16DC9EB0)
#define CLASS_1_C85C4DAB350DD5FC_SET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x16DCA010)
#define CLASS_1_C85C4DAB350DD5FC_SET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x16DC9F10)
#define CLASS_1_C85C4DAB350DD5FC_SET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x16DCA030)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x16DCA0B0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x16DCA090)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x16DC9ED0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPADD_OFFSET UNITYSDK_OFFSET(0x16DC9F30)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPBASE_OFFSET UNITYSDK_OFFSET(0x16DC9F50)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x16DC9F90)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPNEED_OFFSET UNITYSDK_OFFSET(0x16DC9F70)
#define CLASS_1_C85C4DAB350DD5FC_SET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x16DCA050)
#define CLASS_1_C85C4DAB350DD5FC__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCA0C0)

inline static constexpr unsigned int Class_1_C85C4DAB350DD5FC_TypeDefinitionIndex = 52230;
...
public:
	...
	::RPG::GameCore::SkillEffect _SkillEffect_k__BackingField; // 0x38
	::Struct_2_276321B6B122C69C _Identifier_k__BackingField; // 0x3C
	::RPG::GameCore::AttackType _AttackType_k__BackingField; // 0x44
	::RPG::GameCore::FixPoint _SPNeed_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _SkillComboValueDelta_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint _SPBase_k__BackingField; // 0x58
	...
	::System::UInt32 _MaxLevel_k__BackingField; // 0x80
	::RPG::GameCore::AttackDamageType _StanceDamageType_k__BackingField; // 0x84
	::RPG::GameCore::FixPoint _DelayRatio_k__BackingField; // 0x88
