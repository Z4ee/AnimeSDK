...
#define CLASS_1_C85C4DAB350DD5FC_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x15FB3930)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPADD_OFFSET UNITYSDK_OFFSET(0x15FB3890)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0x15FB3870)
#define CLASS_1_C85C4DAB350DD5FC_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x15FB38B0)
#define CLASS_1_C85C4DAB350DD5FC_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x15FB37B0)
#define CLASS_1_C85C4DAB350DD5FC_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x15FB3760)
#define CLASS_1_C85C4DAB350DD5FC_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x15FB3770)
#define CLASS_1_C85C4DAB350DD5FC_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x15FB38D0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x15FB37D0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x15FB38F0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x15FB3970)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x15FB3950)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x15FB3790)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPADD_OFFSET UNITYSDK_OFFSET(0x15FB37F0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0x15FB3810)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x15FB3850)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x15FB3830)
#define CLASS_1_C85C4DAB350DD5FC_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x15FB3910)
#define CLASS_1_C85C4DAB350DD5FC_SET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x15FB3940)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPADD_OFFSET UNITYSDK_OFFSET(0x15FB38A0)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPNEED_OFFSET UNITYSDK_OFFSET(0x15FB3880)
#define CLASS_1_C85C4DAB350DD5FC_SET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x15FB38C0)
#define CLASS_1_C85C4DAB350DD5FC_SET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x15FB37C0)
#define CLASS_1_C85C4DAB350DD5FC_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x15FB3780)
#define CLASS_1_C85C4DAB350DD5FC_SET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x15FB38E0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x15FB37E0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x15FB3900)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x15FB3980)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x15FB3960)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x15FB37A0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPADD_OFFSET UNITYSDK_OFFSET(0x15FB3800)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPBASE_OFFSET UNITYSDK_OFFSET(0x15FB3820)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x15FB3860)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPNEED_OFFSET UNITYSDK_OFFSET(0x15FB3840)
#define CLASS_1_C85C4DAB350DD5FC_SET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x15FB3920)
#define CLASS_1_C85C4DAB350DD5FC__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB3990)

inline static constexpr unsigned int Class_1_C85C4DAB350DD5FC_TypeDefinitionIndex = 49572;

class Class_1_C85C4DAB350DD5FC : public ::System::Object
{
public:
	::System::String* _SkillTriggerKey_k__BackingField; // 0x10
	::Il2CppArray<::RPG::GameCore::FixPoint>* _ParamList_k__BackingField; // 0x18
	::Il2CppArray<::RPG::GameCore::FixPoint>* _ShowStanceList_k__BackingField; // 0x20
	...
	::Struct_2_276321B6B122C69C _Identifier_k__BackingField; // 0x38
	::RPG::GameCore::SkillEffect _SkillEffect_k__BackingField; // 0x40
	::RPG::GameCore::FixPoint _SPBase_k__BackingField; // 0x48
	::System::UInt32 _MaxLevel_k__BackingField; // 0x50
	::RPG::GameCore::AttackType _AttackType_k__BackingField; // 0x54
	::RPG::GameCore::FixPoint _SPAdd_k__BackingField; // 0x58
	::RPG::GameCore::FixPoint _DelayRatio_k__BackingField; // 0x60
	::RPG::GameCore::AttackDamageType _StanceDamageType_k__BackingField; // 0x68
