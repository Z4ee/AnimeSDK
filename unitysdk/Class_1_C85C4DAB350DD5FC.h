...
#define CLASS_1_C85C4DAB350DD5FC_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xB5BB880)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xB5BB7E0)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xB5BB7C0)
#define CLASS_1_C85C4DAB350DD5FC_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xB5BB800)
#define CLASS_1_C85C4DAB350DD5FC_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB5BB700)
#define CLASS_1_C85C4DAB350DD5FC_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0xB5BB6B0)
#define CLASS_1_C85C4DAB350DD5FC_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xB5BB6C0)
#define CLASS_1_C85C4DAB350DD5FC_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xB5BB820)
#define CLASS_1_C85C4DAB350DD5FC_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xB5BB720)
#define CLASS_1_C85C4DAB350DD5FC_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xB5BB840)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xB5BB8C0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xB5BB8A0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xB5BB6E0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xB5BB740)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xB5BB760)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xB5BB7A0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xB5BB780)
#define CLASS_1_C85C4DAB350DD5FC_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xB5BB860)
#define CLASS_1_C85C4DAB350DD5FC_SET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xB5BB890)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPADD_OFFSET UNITYSDK_OFFSET(0xB5BB7F0)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPNEED_OFFSET UNITYSDK_OFFSET(0xB5BB7D0)
#define CLASS_1_C85C4DAB350DD5FC_SET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xB5BB810)
#define CLASS_1_C85C4DAB350DD5FC_SET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB5BB710)
#define CLASS_1_C85C4DAB350DD5FC_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xB5BB6D0)
#define CLASS_1_C85C4DAB350DD5FC_SET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xB5BB830)
#define CLASS_1_C85C4DAB350DD5FC_SET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xB5BB730)
#define CLASS_1_C85C4DAB350DD5FC_SET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xB5BB850)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xB5BB8D0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xB5BB8B0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xB5BB6F0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPADD_OFFSET UNITYSDK_OFFSET(0xB5BB750)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPBASE_OFFSET UNITYSDK_OFFSET(0xB5BB770)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xB5BB7B0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPNEED_OFFSET UNITYSDK_OFFSET(0xB5BB790)
#define CLASS_1_C85C4DAB350DD5FC_SET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xB5BB870)
#define CLASS_1_C85C4DAB350DD5FC__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BB8E0)
...
public:
	...
	::RPG::GameCore::SkillEffect _SkillEffect_k__BackingField; // 0x40
	::Struct_2_276321B6B122C69C _Identifier_k__BackingField; // 0x44
	::System::UInt32 _MaxLevel_k__BackingField; // 0x4C
	::RPG::GameCore::FixPoint _BPNeed_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint _SPMultipleRatio_k__BackingField; // 0x58
	::RPG::GameCore::FixPoint _SPNeed_k__BackingField; // 0x60
	::RPG::GameCore::FixPoint _BPAdd_k__BackingField; // 0x68
	::RPG::GameCore::FixPoint _SPAdd_k__BackingField; // 0x70
	::RPG::GameCore::AttackDamageType _StanceDamageType_k__BackingField; // 0x78
	::RPG::GameCore::AttackType _AttackType_k__BackingField; // 0x7C
	::RPG::GameCore::FixPoint _DelayRatio_k__BackingField; // 0x80
