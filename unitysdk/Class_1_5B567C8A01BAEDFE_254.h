...
#define CLASS_1_5B567C8A01BAEDFE_254_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19673040)
#define CLASS_1_5B567C8A01BAEDFE_254_CLONE_OFFSET UNITYSDK_OFFSET(0x19672EB0)
#define CLASS_1_5B567C8A01BAEDFE_254_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19672F50)
#define CLASS_1_5B567C8A01BAEDFE_254_EQUALS_OFFSET UNITYSDK_OFFSET(0x19672EF0)
#define CLASS_1_5B567C8A01BAEDFE_254_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19672FA0)
#define CLASS_1_5B567C8A01BAEDFE_254_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19673090)
#define CLASS_1_5B567C8A01BAEDFE_254_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19673060)
#define CLASS_1_5B567C8A01BAEDFE_254_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19672E30)
#define CLASS_1_5B567C8A01BAEDFE_254_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19672E60)
#define CLASS_1_5B567C8A01BAEDFE_254_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19672FD0)
#define CLASS_1_5B567C8A01BAEDFE_254_WRITETO_OFFSET UNITYSDK_OFFSET(0x19673030)
#define CLASS_1_5B567C8A01BAEDFE_254__CCTOR_OFFSET UNITYSDK_OFFSET(0x196730E0)
#define CLASS_1_5B567C8A01BAEDFE_254__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19672E80)
#define CLASS_1_5B567C8A01BAEDFE_254__CTOR_OFFSET UNITYSDK_OFFSET(0x19672E70)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_254_TypeDefinitionIndex = 30308;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_254*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_254_TypeDefinitionIndex)->GetStaticField(0x43FB0);
	}
