...
#define CLASS_1_5B567C8A01BAEDFE_254_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A442CC0)
#define CLASS_1_5B567C8A01BAEDFE_254_CLONE_OFFSET UNITYSDK_OFFSET(0x1A442B30)
#define CLASS_1_5B567C8A01BAEDFE_254_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A442BD0)
#define CLASS_1_5B567C8A01BAEDFE_254_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A442B70)
#define CLASS_1_5B567C8A01BAEDFE_254_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A442C20)
#define CLASS_1_5B567C8A01BAEDFE_254_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A442D10)
#define CLASS_1_5B567C8A01BAEDFE_254_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A442CE0)
#define CLASS_1_5B567C8A01BAEDFE_254_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A442AB0)
#define CLASS_1_5B567C8A01BAEDFE_254_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A442AE0)
#define CLASS_1_5B567C8A01BAEDFE_254_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A442C50)
#define CLASS_1_5B567C8A01BAEDFE_254_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A442CB0)
#define CLASS_1_5B567C8A01BAEDFE_254__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A442D60)
#define CLASS_1_5B567C8A01BAEDFE_254__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A442B00)
#define CLASS_1_5B567C8A01BAEDFE_254__CTOR_OFFSET UNITYSDK_OFFSET(0x1A442AF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_254_TypeDefinitionIndex = 30143;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_254*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_254_TypeDefinitionIndex)->GetStaticField(0x659A0);
	}
