...
#define CLASS_2_AD1D66AC79AA489C_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x159EEF90)
#define CLASS_2_AD1D66AC79AA489C_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x159EF2D0)
#define CLASS_2_AD1D66AC79AA489C_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x159ECFD0)
#define CLASS_2_AD1D66AC79AA489C_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x159ECFF0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x159ED030)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x159ED3C0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x159ED230)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x159EE840)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0x159EE1C0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_24B2CA816EFA1FA5_OFFSET UNITYSDK_OFFSET(0x159EE6A0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0x159ED7A0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x159ED710)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x159ED640)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0x159EE010)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_479759059E440327_1_OFFSET UNITYSDK_OFFSET(0x159EEC30)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x159EE5C0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_5D5817B6B3027F40_OFFSET UNITYSDK_OFFSET(0x159EE3A0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_7E69B386DB903252_OFFSET UNITYSDK_OFFSET(0x159ED5D0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_926A87EF7B2C87F9_OFFSET UNITYSDK_OFFSET(0x159EEE40)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_A1F9BFB7EBB25DAC_OFFSET UNITYSDK_OFFSET(0x159EDC00)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0x159EDF50)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x159EED50)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_C836268BEBB9DBE1_OFFSET UNITYSDK_OFFSET(0x159EE9F0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x159EECC0)
#define CLASS_2_AD1D66AC79AA489C_METHOD_2_FA58824BA12F6F62_OFFSET UNITYSDK_OFFSET(0x159ED580)
#define CLASS_2_AD1D66AC79AA489C_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x159ECFE0)
#define CLASS_2_AD1D66AC79AA489C__CTOR_OFFSET UNITYSDK_OFFSET(0x159EF5D0)
#define CLASS_2_AD1D66AC79AA489C__ONBIND_OFFSET UNITYSDK_OFFSET(0x159ECCE0)
#define CLASS_2_AD1D66AC79AA489C__ONTICK_OFFSET UNITYSDK_OFFSET(0x159EE940)

inline static constexpr unsigned int Class_2_AD1D66AC79AA489C_TypeDefinitionIndex = 71337;

class Class_2_AD1D66AC79AA489C : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* DJCBDJMACFH; // 0x0
	// static const ::System::Single GODJBGOCFOC; // 0x0
	// static const ::System::Single KOJDBNHGKJI; // 0x0
	// static const ::System::String* GKCHCEFIGCH; // 0x0
	// static const ::System::String* ILPHFEKBDGA; // 0x0
	::RPG::Client::LocalizedText* BIGGNHHLLOA; // 0x60
	::UnityEngine::Transform* PNDDAOPPKHN; // 0x68
	::UnityEngine::RectTransform* MIALKGHPBAK; // 0x70
	::UnityEngine::UI::Image* FHPOFLPCFJC; // 0x78
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0x80
	::RPG::Client::LocalizedText* MCNOINHLLGO; // 0x88
	::UnityEngine::Transform* MAOGFKBEFJH; // 0x90
	::RPG::Client::EvolveBuildLevel* OCGMHDIKBKN; // 0x98
	::RPG::GameCore::LevelDataComponent* KEKOPPIHDLJ; // 0xA0
	::UnityEngine::UI::Image* BHMFMBBLADC; // 0xA8
	::UnityEngine::Transform* COBCKPCNFCN; // 0xB0
	::UnityEngine::Animation* PMOJILOJEPE; // 0xB8
	::System::Boolean HAFCOEMEHNH; // 0xC0
	::System::Boolean IANFNCDIEHH; // 0xC1
	::System::Boolean AKBPMCJFCFM; // 0xC2
	::System::Boolean BFOMHHMMCBP; // 0xC3
	::System::Single HEKAGAJGKEB; // 0xC4
	::System::UInt32 NDIFIJNBMFI; // 0xC8
	::System::Single NNLBCLCPIDK; // 0xCC
	::System::Single IODBJGNMKND; // 0xD0
	::System::Single CLEBBBABPEI; // 0xD4
	::System::Single BFKCADADNCA; // 0xD8
	::System::Int32 _Index_k__BackingField; // 0xDC
	::System::UInt32 PPIDINJNCFL; // 0xE0
	::System::Single FAFIAGJFGEF; // 0xE4
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_AD1D66AC79AA489C_METHOD_2_1ABF1CBED7A4AF0A_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::LevelInfiniteWaveProgressChange*))((::PBYTE)hIl2Cpp + CLASS_2_AD1D66AC79AA489C_METHOD_2_5D5817B6B3027F40_OFFSET))(this, a1);
	}
