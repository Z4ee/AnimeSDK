...
#define CLASS_2_877B74806F1C13B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11A5D5C0)
#define CLASS_2_877B74806F1C13B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11A5D600)
#define CLASS_2_877B74806F1C13B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11A5D680)
#define CLASS_2_877B74806F1C13B0_TICK_OFFSET UNITYSDK_OFFSET(0x11A5D6D0)
#define CLASS_2_877B74806F1C13B0__CTOR_OFFSET UNITYSDK_OFFSET(0x11A5D5B0)

inline static constexpr unsigned int Class_2_877B74806F1C13B0_TypeDefinitionIndex = 49170;

class Class_2_877B74806F1C13B0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchHandShowPuzzleFinishToast* Field_2_0; // 0x18
