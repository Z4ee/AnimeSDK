...
#define CLASS_2_36B1199187304023_METHOD_2_55B50F0EBC3528C6_OFFSET UNITYSDK_OFFSET(0x112CB430)
#define CLASS_2_36B1199187304023__CTOR_OFFSET UNITYSDK_OFFSET(0x112CB2D0)

inline static constexpr unsigned int Class_2_36B1199187304023_TypeDefinitionIndex = 52458;

class Class_2_36B1199187304023 : public ::Class_1_7E61104234A02BD7
{
public:
	::Class_1_1C30CE192ABE4C54* Field_2_0; // 0x48
	::RPG::GameCore::FloatCurve* Field_2_1; // 0x50
	::RPG::GameCore::FloatCurve* Field_2_2; // 0x58
	::RPG::GameCore::FloatCurve* Field_2_3; // 0x60
	::System::Single Field_2_4; // 0x68
	::System::Single Field_2_5; // 0x6C
	::RPG::GameCore::StringHash Field_2_6; // 0x70
