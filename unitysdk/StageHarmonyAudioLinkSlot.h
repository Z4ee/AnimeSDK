...
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0x197E6130)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_2DD8EB2A8AB21975_OFFSET UNITYSDK_OFFSET(0x197E6720)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_44AC3F3C85C7CAA3_OFFSET UNITYSDK_OFFSET(0x197E6560)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0x197E6300)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_680FC076CDE6057B_OFFSET UNITYSDK_OFFSET(0x197E6E30)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_8AC834FE1A022C85_OFFSET UNITYSDK_OFFSET(0x197E6C40)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_ABC507DBBD207493_OFFSET UNITYSDK_OFFSET(0x197E6940)
#define STAGEHARMONYAUDIOLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x197E6EE0)

inline static constexpr unsigned int StageHarmonyAudioLinkSlot_TypeDefinitionIndex = 47995;
