...
#define GYROBASEMONO_ENABLEGYRO_OFFSET UNITYSDK_OFFSET(0x1DCC3F50)
#define GYROBASEMONO_GET_CURRENTGRAVITY_OFFSET UNITYSDK_OFFSET(0x1DCC3E00)
#define GYROBASEMONO_START_OFFSET UNITYSDK_OFFSET(0x1DCC3F00)
#define GYROBASEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC40B0)

inline static constexpr unsigned int GyroBaseMono_TypeDefinitionIndex = 7845;
