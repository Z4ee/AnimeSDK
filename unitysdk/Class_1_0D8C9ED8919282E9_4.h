...
#define CLASS_1_0D8C9ED8919282E9_4_GET_ISCHALLENGE_OFFSET UNITYSDK_OFFSET(0x18CE1CA0)
#define CLASS_1_0D8C9ED8919282E9_4_GET_ISFIRSTSEASONMATCH_OFFSET UNITYSDK_OFFSET(0x18CE1C80)
#define CLASS_1_0D8C9ED8919282E9_4_GET_ISSEASONAGENDA_OFFSET UNITYSDK_OFFSET(0x18CE1C60)
#define CLASS_1_0D8C9ED8919282E9_4_GET_MATCHCONFIGID_OFFSET UNITYSDK_OFFSET(0x18CE1C00)
#define CLASS_1_0D8C9ED8919282E9_4_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x18CE1C20)
#define CLASS_1_0D8C9ED8919282E9_4_GET_TRACKCONFIGID_OFFSET UNITYSDK_OFFSET(0x18CE1C40)
#define CLASS_1_0D8C9ED8919282E9_4_METHOD_1_1798FAFF45053267_OFFSET UNITYSDK_OFFSET(0x18CE1B30)
#define CLASS_1_0D8C9ED8919282E9_4_SET_ISCHALLENGE_OFFSET UNITYSDK_OFFSET(0x18CE1CB0)
#define CLASS_1_0D8C9ED8919282E9_4_SET_ISFIRSTSEASONMATCH_OFFSET UNITYSDK_OFFSET(0x18CE1C90)
#define CLASS_1_0D8C9ED8919282E9_4_SET_ISSEASONAGENDA_OFFSET UNITYSDK_OFFSET(0x18CE1C70)
#define CLASS_1_0D8C9ED8919282E9_4_SET_MATCHCONFIGID_OFFSET UNITYSDK_OFFSET(0x18CE1C10)
#define CLASS_1_0D8C9ED8919282E9_4_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x18CE1C30)
#define CLASS_1_0D8C9ED8919282E9_4_SET_TRACKCONFIGID_OFFSET UNITYSDK_OFFSET(0x18CE1C50)
#define CLASS_1_0D8C9ED8919282E9_4__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE1CC0)

inline static constexpr unsigned int Class_1_0D8C9ED8919282E9_4_TypeDefinitionIndex = 80354;

class Class_1_0D8C9ED8919282E9_4 : public ::System::Object
{
public:
	::System::UInt32 _SessionId_k__BackingField; // 0x10
	::System::UInt32 _TrackConfigId_k__BackingField; // 0x14
	::System::UInt32 _MatchConfigId_k__BackingField; // 0x18
	::System::Boolean _IsSeasonAgenda_k__BackingField; // 0x1C
	::System::Boolean _IsFirstSeasonMatch_k__BackingField; // 0x1D
	::System::Boolean _IsChallenge_k__BackingField; // 0x1E
