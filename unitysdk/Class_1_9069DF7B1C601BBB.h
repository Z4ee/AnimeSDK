...
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x1909ABF0)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_163DC9A61F1D3AF0_OFFSET UNITYSDK_OFFSET(0x190B8590)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_1C08CB854956A856_OFFSET UNITYSDK_OFFSET(0x190B8030)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x190704D0)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_805ED9316430A0DF_OFFSET UNITYSDK_OFFSET(0x190B7EA0)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_99AC52A5C48A589D_OFFSET UNITYSDK_OFFSET(0x190B7F30)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x190B7FE0)
#define CLASS_1_9069DF7B1C601BBB_METHOD_1_C4919AE7547B2FDE_OFFSET UNITYSDK_OFFSET(0x19070570)
#define CLASS_1_9069DF7B1C601BBB__CTOR_OFFSET UNITYSDK_OFFSET(0x1909AA00)

inline static constexpr unsigned int Class_1_9069DF7B1C601BBB_TypeDefinitionIndex = 66548;
...
public:
	...
	{
		return (::Class_1_9069DF7B1C601BBB**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9069DF7B1C601BBB_TypeDefinitionIndex)->GetStaticField(0x36620);
	}
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_420B9A7615F4ACC2*>* Field_1_2; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Func_1<::Class_2_52F82E04F7FEE529*>*>* Field_1_5; // 0x18
