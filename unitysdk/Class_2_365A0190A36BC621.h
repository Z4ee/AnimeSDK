...
#define CLASS_2_365A0190A36BC621_DISPOSE_OFFSET UNITYSDK_OFFSET(0x157DF5C0)
#define CLASS_2_365A0190A36BC621_METHOD_2_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0x157DF650)
#define CLASS_2_365A0190A36BC621_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x157DF8A0)
#define CLASS_2_365A0190A36BC621_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x157DF600)
#define CLASS_2_365A0190A36BC621_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x157DF7F0)
#define CLASS_2_365A0190A36BC621_TICK_OFFSET UNITYSDK_OFFSET(0x157DF840)
#define CLASS_2_365A0190A36BC621__CTOR_OFFSET UNITYSDK_OFFSET(0x157DF5B0)

inline static constexpr unsigned int Class_2_365A0190A36BC621_TypeDefinitionIndex = 58796;

class Class_2_365A0190A36BC621 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowFightActivityLose* OFKGLJOAMLD; // 0x18
