...
#define CLASS_2_CDB36C12F6D0C61F_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x165A5140)
#define CLASS_2_CDB36C12F6D0C61F_METHOD_2_50131F4CF014469C_OFFSET UNITYSDK_OFFSET(0x165A5250)
#define CLASS_2_CDB36C12F6D0C61F_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x165A53E0)
#define CLASS_2_CDB36C12F6D0C61F_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x165A52E0)
#define CLASS_2_CDB36C12F6D0C61F_METHOD_2_D79CC8F576883D14_OFFSET UNITYSDK_OFFSET(0x165A5380)
#define CLASS_2_CDB36C12F6D0C61F__CCTOR_OFFSET UNITYSDK_OFFSET(0x165A51D0)
#define CLASS_2_CDB36C12F6D0C61F__CTOR_OFFSET UNITYSDK_OFFSET(0x165A5240)

inline static constexpr unsigned int Class_2_CDB36C12F6D0C61F_TypeDefinitionIndex = 48149;

class Class_2_CDB36C12F6D0C61F : public ::Class_1_B7E341C5F1A6F199
{
public:
	// static const ::System::UInt16 Field_2_3 = 0x12B; // 0x0
