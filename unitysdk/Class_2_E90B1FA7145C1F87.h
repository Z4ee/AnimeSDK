...
#define CLASS_2_E90B1FA7145C1F87_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F6C370)
#define CLASS_2_E90B1FA7145C1F87_METHOD_2_5FBAD89A54D9F070_1_OFFSET UNITYSDK_OFFSET(0x18F6C3C0)
#define CLASS_2_E90B1FA7145C1F87_METHOD_2_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x18F6C510)
#define CLASS_2_E90B1FA7145C1F87_METHOD_2_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0x18F6C5D0)
#define CLASS_2_E90B1FA7145C1F87_METHOD_2_BF89C115E2404429_OFFSET UNITYSDK_OFFSET(0x18F6C700)
#define CLASS_2_E90B1FA7145C1F87_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18F6C480)
#define CLASS_2_E90B1FA7145C1F87_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18F6C650)
#define CLASS_2_E90B1FA7145C1F87_TICK_OFFSET UNITYSDK_OFFSET(0x18F6C6A0)
#define CLASS_2_E90B1FA7145C1F87__CTOR_OFFSET UNITYSDK_OFFSET(0x18F6C360)

inline static constexpr unsigned int Class_2_E90B1FA7145C1F87_TypeDefinitionIndex = 53468;

class Class_2_E90B1FA7145C1F87 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::ReturnToLoginPage* OFKGLJOAMLD; // 0x20
