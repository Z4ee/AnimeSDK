...
#define CLASS_1_8A37F0A1B3D53FED___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA040B0)
#define CLASS_1_8A37F0A1B3D53FED___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA040F0)
#define CLASS_1_8A37F0A1B3D53FED___C___CCTOR_B__38_0_OFFSET UNITYSDK_OFFSET(0x1EA04100)
...
public:
	...
	{
		return (::Class_1_8A37F0A1B3D53FED___c**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8A37F0A1B3D53FED___c_TypeDefinitionIndex)->GetStaticField(0x486E0);
	}
