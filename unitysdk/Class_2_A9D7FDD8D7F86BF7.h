...
#define CLASS_2_A9D7FDD8D7F86BF7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1542B570)
#define CLASS_2_A9D7FDD8D7F86BF7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1542B4C0)
#define CLASS_2_A9D7FDD8D7F86BF7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1542B520)
#define CLASS_2_A9D7FDD8D7F86BF7_TICK_OFFSET UNITYSDK_OFFSET(0x1542B5C0)
#define CLASS_2_A9D7FDD8D7F86BF7__CTOR_OFFSET UNITYSDK_OFFSET(0x1542B4B0)

inline static constexpr unsigned int Class_2_A9D7FDD8D7F86BF7_TypeDefinitionIndex = 58375;

class Class_2_A9D7FDD8D7F86BF7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyTriggerDailySettlement* OFKGLJOAMLD; // 0x18
