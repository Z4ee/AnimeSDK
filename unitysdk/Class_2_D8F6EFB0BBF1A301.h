...
#define CLASS_2_D8F6EFB0BBF1A301_GET_CLIENTPREDICATETIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x163D5260)
#define CLASS_2_D8F6EFB0BBF1A301_GET_CLIENTREPLAYTIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x163D5280)
#define CLASS_2_D8F6EFB0BBF1A301_GET_ISPAUSEREPLAY_OFFSET UNITYSDK_OFFSET(0x163D52A0)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_02DC14AEDD53F663_OFFSET UNITYSDK_OFFSET(0x163D4260)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_0EB2899F45F512FE_OFFSET UNITYSDK_OFFSET(0x163D45B0)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_2F5AC4358F4D89A9_OFFSET UNITYSDK_OFFSET(0x163D5240)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_3FC863B885E15ED5_OFFSET UNITYSDK_OFFSET(0x163D5000)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_4484591CA1060976_OFFSET UNITYSDK_OFFSET(0x163D46E0)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0x163D4020)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_9407410AABC43F0E_OFFSET UNITYSDK_OFFSET(0x163D5250)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_A7AE8381C96B12F1_1_OFFSET UNITYSDK_OFFSET(0x163D4F30)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_A7AE8381C96B12F1_OFFSET UNITYSDK_OFFSET(0x163D4E60)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x163D3440)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0x163D4990)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_D30CC5B4F0E44E1B_OFFSET UNITYSDK_OFFSET(0x163D43B0)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_E5695720AB0F6E98_OFFSET UNITYSDK_OFFSET(0x163D4410)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_F239777256F9BA8F_1_OFFSET UNITYSDK_OFFSET(0x163D52D0)
#define CLASS_2_D8F6EFB0BBF1A301_METHOD_2_F239777256F9BA8F_OFFSET UNITYSDK_OFFSET(0x163D52C0)
#define CLASS_2_D8F6EFB0BBF1A301_SET_CLIENTPREDICATETIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x163D5270)
#define CLASS_2_D8F6EFB0BBF1A301_SET_CLIENTREPLAYTIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x163D5290)
#define CLASS_2_D8F6EFB0BBF1A301_SET_ISPAUSEREPLAY_OFFSET UNITYSDK_OFFSET(0x163D52B0)
#define CLASS_2_D8F6EFB0BBF1A301__CANLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x163D47E0)
#define CLASS_2_D8F6EFB0BBF1A301__CTOR_OFFSET UNITYSDK_OFFSET(0x163D52E0)
#define CLASS_2_D8F6EFB0BBF1A301__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x163D4BF0)
#define CLASS_2_D8F6EFB0BBF1A301__ONINIT_OFFSET UNITYSDK_OFFSET(0x163D3480)
#define CLASS_2_D8F6EFB0BBF1A301__ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x163D4820)
#define CLASS_2_D8F6EFB0BBF1A301__ONSTART_OFFSET UNITYSDK_OFFSET(0x163D3740)
#define CLASS_2_D8F6EFB0BBF1A301__ONTICK_OFFSET UNITYSDK_OFFSET(0x163D3970)

inline static constexpr unsigned int Class_2_D8F6EFB0BBF1A301_TypeDefinitionIndex = 60668;

class Class_2_D8F6EFB0BBF1A301 : public ::Class_1_E0103A0EA6CD0F4C
{
public:
	::System::Action_1<::Class_1_2375E47039821420*>* MGMLPPCOONF; // 0x78
	::System::Collections::Generic::List_1<::System::Int32>* FCNFCPMOOBD; // 0x80
	::Class_3_49128057410E0DBC* EOJJACAGMJM; // 0x88
	::Class_0_16E4307DCC419505_38* HKCEFPHJGNC; // 0x90
	::Class_3_9F40BD36E5F30CAE* HICCPCEDFLA; // 0x98
	::System::Action* MHEBKIOKMCG; // 0xA0
	::System::Action_2<::System::UInt32, ::Google::Protobuf::ByteString*>* FNPNAEJCMNB; // 0xA8
	::Class_1_3DA1D1484278689C_ReceiveMode NMLENCDBHAA; // 0xB0
	::System::UInt32 GBAOPEBHOKK; // 0xB4
	::System::UInt64 _ClientPredicateTimeStampMs_k__BackingField; // 0xB8
	::System::UInt32 AOMJLHEENIB; // 0xC0
	::System::Boolean JEFDCGHEEPL; // 0xC4
	::RPG::Client::LittleGameShare::LittleGameClientNetMode GBEPMICDFJO; // 0xC5
	::System::Boolean _IsPauseReplay_k__BackingField; // 0xC6
	::System::UInt64 _ClientReplayTimeStampMs_k__BackingField; // 0xC8
	::System::UInt64 LBADGOLINJL; // 0xD0
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_D8F6EFB0BBF1A301_METHOD_2_3FC863B885E15ED5_OFFSET))(this);
	}
