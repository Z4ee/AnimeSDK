...
#define CLASS_1_7C908BE601A534FA_CLEAR_OFFSET UNITYSDK_OFFSET(0x18BBD0B0)
#define CLASS_1_7C908BE601A534FA_EVALUATE_OFFSET UNITYSDK_OFFSET(0x18BBD630)
#define CLASS_1_7C908BE601A534FA_GETDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0x18BBDD20)
#define CLASS_1_7C908BE601A534FA_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x18BBDCD0)
#define CLASS_1_7C908BE601A534FA_METHOD_1_BD29EBFCF4C67999_OFFSET UNITYSDK_OFFSET(0x18BBD6D0)
#define CLASS_1_7C908BE601A534FA_METHOD_1_D974D458F5E95B4D_OFFSET UNITYSDK_OFFSET(0x18BBD250)
#define CLASS_1_7C908BE601A534FA_METHOD_1_F9BB28182C0BA6DA_OFFSET UNITYSDK_OFFSET(0x18BBDEE0)
#define CLASS_1_7C908BE601A534FA_ONALLOC_OFFSET UNITYSDK_OFFSET(0x18BBD160)
#define CLASS_1_7C908BE601A534FA_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x18BBD210)
#define CLASS_1_7C908BE601A534FA_RECALCULATE_OFFSET UNITYSDK_OFFSET(0x18BBDE10)
#define CLASS_1_7C908BE601A534FA__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBDF20)

inline static constexpr unsigned int Class_1_7C908BE601A534FA_TypeDefinitionIndex = 40250;

class Class_1_7C908BE601A534FA : public ::System::Object
{
public:
	::RPG::PoolList_1<::Class_1_7C908BE601A534FA_Struct_2_E658502528B7C034>* Field_1_0; // 0x10
	::RPG::GameCore::LittleGameCircleCurveInfo* Field_1_1; // 0x18
	::Struct_2_EAC1BB0F093534A5 Field_1_2; // 0x20
