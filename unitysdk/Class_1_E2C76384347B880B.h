...
#define CLASS_1_E2C76384347B880B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E33EA0)
#define CLASS_1_E2C76384347B880B_GET_AGENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x18E363E0)
#define CLASS_1_E2C76384347B880B_GET_AGENTRADIUS_OFFSET UNITYSDK_OFFSET(0x18E363D0)
#define CLASS_1_E2C76384347B880B_GET_ISPOSTSMOOTH_OFFSET UNITYSDK_OFFSET(0x18E36390)
#define CLASS_1_E2C76384347B880B_METHOD_1_051D4FD5F66B038B_OFFSET UNITYSDK_OFFSET(0x18E34BB0)
#define CLASS_1_E2C76384347B880B_METHOD_1_0A45674940E5A274_OFFSET UNITYSDK_OFFSET(0x18E34440)
#define CLASS_1_E2C76384347B880B_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x18E347A0)
#define CLASS_1_E2C76384347B880B_METHOD_1_2CD6D17D088D5DB9_OFFSET UNITYSDK_OFFSET(0x18E34CF0)
#define CLASS_1_E2C76384347B880B_METHOD_1_576F7DA4771CFFCA_OFFSET UNITYSDK_OFFSET(0x18E349A0)
#define CLASS_1_E2C76384347B880B_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x18E34B50)
#define CLASS_1_E2C76384347B880B_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18E343B0)
#define CLASS_1_E2C76384347B880B_METHOD_1_9C68D73444D54154_OFFSET UNITYSDK_OFFSET(0x18E33FA0)
#define CLASS_1_E2C76384347B880B_METHOD_1_A36150C5DCC8409E_1_OFFSET UNITYSDK_OFFSET(0x18E36440)
#define CLASS_1_E2C76384347B880B_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x18E363F0)
#define CLASS_1_E2C76384347B880B_METHOD_1_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x18E360B0)
#define CLASS_1_E2C76384347B880B_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18E34750)
#define CLASS_1_E2C76384347B880B_METHOD_1_D90B0567A2E3A269_OFFSET UNITYSDK_OFFSET(0x18E34810)
#define CLASS_1_E2C76384347B880B_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x18E363C0)
#define CLASS_1_E2C76384347B880B_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18E363B0)
#define CLASS_1_E2C76384347B880B_SET_ISPOSTSMOOTH_OFFSET UNITYSDK_OFFSET(0x18E363A0)
#define CLASS_1_E2C76384347B880B__CTOR_OFFSET UNITYSDK_OFFSET(0x18E33DC0)
...
public:
	...
	::Class_2_E08C4A9CFB467C17* DHOBMFLDLAN; // 0x18
	::Il2CppArray<::Class_1_C84A84118567060F*>* IOFHPGIJANO; // 0x20
	::System::Collections::Generic::List_1<::UnityEngine::Vector3>* IMDMBCFBKKE; // 0x28
	::System::Int32 ECMGHKJIKNL; // 0x30
	::System::Single _AgentRadius_k__BackingField; // 0x34
	::System::Boolean HHBGOBMFMML; // 0x38
	::System::Boolean AFLJILDNMHA; // 0x39
	::System::Boolean _IsPostSmooth_k__BackingField; // 0x3A
	::UnityEngine::Vector3 DEIMGIGLHLK; // 0x3C
	::UnityEngine::Vector3 GLDEBFOKEMJ; // 0x48
	::UnityEngine::LayerMask _AgentLayerMask_k__BackingField; // 0x54
	::RPGTools::Octree::Agent::AgentNavigationParams IJIHPGHKLIF; // 0x58
