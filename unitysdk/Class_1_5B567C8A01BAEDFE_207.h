...
#define CLASS_1_5B567C8A01BAEDFE_207_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5A27D0)
#define CLASS_1_5B567C8A01BAEDFE_207_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5A24C0)
#define CLASS_1_5B567C8A01BAEDFE_207_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5A25D0)
#define CLASS_1_5B567C8A01BAEDFE_207_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5A2500)
#define CLASS_1_5B567C8A01BAEDFE_207_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5A2730)
#define CLASS_1_5B567C8A01BAEDFE_207_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5A2820)
#define CLASS_1_5B567C8A01BAEDFE_207_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5A27F0)
#define CLASS_1_5B567C8A01BAEDFE_207_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C5A2440)
#define CLASS_1_5B567C8A01BAEDFE_207_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5A2470)
#define CLASS_1_5B567C8A01BAEDFE_207_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5A2760)
#define CLASS_1_5B567C8A01BAEDFE_207_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5A27C0)
#define CLASS_1_5B567C8A01BAEDFE_207__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5A2870)
#define CLASS_1_5B567C8A01BAEDFE_207__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5A2490)
#define CLASS_1_5B567C8A01BAEDFE_207__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5A2480)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_207_TypeDefinitionIndex = 29582;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_207*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_207_TypeDefinitionIndex)->GetStaticField(0x46050);
	}
