...
#define CLASS_2_8875CF8A827738B7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16D960D0)
#define CLASS_2_8875CF8A827738B7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16D96110)
#define CLASS_2_8875CF8A827738B7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16D963F0)
#define CLASS_2_8875CF8A827738B7_TICK_OFFSET UNITYSDK_OFFSET(0x16D96440)
#define CLASS_2_8875CF8A827738B7__CTOR_OFFSET UNITYSDK_OFFSET(0x16D960C0)

inline static constexpr unsigned int Class_2_8875CF8A827738B7_TypeDefinitionIndex = 52716;

class Class_2_8875CF8A827738B7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifySkillPropertyBySlot* Field_2_0; // 0x18
