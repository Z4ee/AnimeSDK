...
#define CLASS_3_5E441F1C0561B4FB_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x16B55C20)
#define CLASS_3_5E441F1C0561B4FB_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x16B55EA0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_00004B41EFDB322F_OFFSET UNITYSDK_OFFSET(0x16B551E0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_0115C0C3E970EDD2_OFFSET UNITYSDK_OFFSET(0x16B556E0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x16B54F30)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_4AC7BEFAB2317D4A_OFFSET UNITYSDK_OFFSET(0x16B55170)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x16B553A0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x16B54EE0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_9AB87E6FBE1EB9E8_OFFSET UNITYSDK_OFFSET(0x16B54E40)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_9F88E35FE931B81A_OFFSET UNITYSDK_OFFSET(0x16B559B0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x16B558A0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0x16B55930)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x16B557C0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_E6D6625F79A63882_OFFSET UNITYSDK_OFFSET(0x16B55580)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_F04C04E6DB6D6224_OFFSET UNITYSDK_OFFSET(0x16B55630)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x16B55B60)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x16B55AA0)
#define CLASS_3_5E441F1C0561B4FB_METHOD_3_FB1C56FCE4ABD259_OFFSET UNITYSDK_OFFSET(0x16B55060)
#define CLASS_3_5E441F1C0561B4FB__CTOR_OFFSET UNITYSDK_OFFSET(0x16B560E0)
#define CLASS_3_5E441F1C0561B4FB__ONBIND_OFFSET UNITYSDK_OFFSET(0x16B54CC0)
#define CLASS_3_5E441F1C0561B4FB__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x16B550E0)

inline static constexpr unsigned int Class_3_5E441F1C0561B4FB_TypeDefinitionIndex = 71189;
...
public:
	...
	::UnityEngine::Transform* BGDCEDJDHNG; // 0xE0
	::UnityEngine::UI::Text* LALMKOAFHGI; // 0xE8
	::UnityEngine::Animation* JPHOOFFIAAH; // 0xF0
	::UnityEngine::UI::Text* LKCLLMKCPOA; // 0xF8
	::UnityEngine::UI::Text* JDLFBCEMBBP; // 0x100
	::System::String* DIDHOFMKIFH; // 0x108
	::UnityEngine::UI::Text* CCIKANDNKPK; // 0x110
	::UnityEngine::UI::Text* OCEEDFPJEOK; // 0x118
