...
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_090304344AE646C8_OFFSET UNITYSDK_OFFSET(0x165BD3C0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_0D679A59A10441FD_OFFSET UNITYSDK_OFFSET(0x165BD8C0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x165BE610)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x165BE440)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_15A44F4C16628BFF_OFFSET UNITYSDK_OFFSET(0x165BDAD0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_29DAE34D979AD312_OFFSET UNITYSDK_OFFSET(0x165BDF40)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x165BE2A0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_371B021CD74A58C0_OFFSET UNITYSDK_OFFSET(0x165BDEE0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x165BE360)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_5E54832D785EF7E8_OFFSET UNITYSDK_OFFSET(0x165BDE80)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_673DF5ECC0F21210_OFFSET UNITYSDK_OFFSET(0x165BE520)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_790E3622E78EC61C_OFFSET UNITYSDK_OFFSET(0x165BDCC0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_7CB9C71E2C2A0739_OFFSET UNITYSDK_OFFSET(0x165BE640)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_8C627D641C4810C9_OFFSET UNITYSDK_OFFSET(0x165BE0D0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0x165BE5F0)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_9ED4DF385B9D99B1_OFFSET UNITYSDK_OFFSET(0x165BD360)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_A6ABD71BB75A0790_OFFSET UNITYSDK_OFFSET(0x165BE620)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x165BDC40)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x165BE600)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x165BDA20)
#define CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x165BE630)
#define CLASS_1_EFCBA1FD97ED5FE9__CTOR_OFFSET UNITYSDK_OFFSET(0x165BE690)

inline static constexpr unsigned int Class_1_EFCBA1FD97ED5FE9_TypeDefinitionIndex = 57488;

class Class_1_EFCBA1FD97ED5FE9 : public ::System::Object
{
public:
	::System::Action_1<::UnityEngine::GameObject*>* EFLFOHKHIIH; // 0x10
	::System::String* IMANEBGEPIO; // 0x18
	::RPG::GameCore::EntityLodModelConfig* MGHKBEOHKDN; // 0x20
	::System::String* GFAGJIHDOII; // 0x28
	::RPG::GameCore::EntityLodLoadingData* CMCKMDEBKHE; // 0x30
	::RPG::GameCore::GameEntity* ICHEDAEHEBG; // 0x38
	::System::Action_1<::UnityEngine::GameObject*>* NNNGFJMFLON; // 0x40
	::UnityEngine::GameObject* CGGBLDIBMEH; // 0x48
	::RPG::GameCore::EntityLodModelConfig* OPIIGLAJPDH; // 0x50
	::System::String* BODICBBGAJA; // 0x58
	::System::Action_1<::UnityEngine::GameObject*>* KOFPPNFGKPO; // 0x60
	::System::Int32 EFCFHKMHHJJ; // 0x68
	::System::Boolean GFAMGLFOMGI; // 0x6C
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::String*, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_790E3622E78EC61C_OFFSET))(this, a1, a2);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_673DF5ECC0F21210_OFFSET))(this, a1);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_EFCBA1FD97ED5FE9_METHOD_1_1290EA767C459179_OFFSET))(this);
	}
