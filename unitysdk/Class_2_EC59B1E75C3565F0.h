...
#define CLASS_2_EC59B1E75C3565F0_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x198B6580)
#define CLASS_2_EC59B1E75C3565F0_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x198B66A0)
#define CLASS_2_EC59B1E75C3565F0_METHOD_2_4102C7EC43D1EB1B_OFFSET UNITYSDK_OFFSET(0x198B5BD0)
#define CLASS_2_EC59B1E75C3565F0_METHOD_2_546D123B31C1EA8A_OFFSET UNITYSDK_OFFSET(0x198B5A50)
#define CLASS_2_EC59B1E75C3565F0_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x198B64C0)
#define CLASS_2_EC59B1E75C3565F0_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x198B6400)
#define CLASS_2_EC59B1E75C3565F0_METHOD_2_FB354432755DC8C3_OFFSET UNITYSDK_OFFSET(0x198B6180)
#define CLASS_2_EC59B1E75C3565F0__CTOR_OFFSET UNITYSDK_OFFSET(0x198B6790)

inline static constexpr unsigned int Class_2_EC59B1E75C3565F0_TypeDefinitionIndex = 72029;

class Class_2_EC59B1E75C3565F0 : public ::Class_1_34917908B7833130
{
public:
	::System::Void _ctor()
	{
