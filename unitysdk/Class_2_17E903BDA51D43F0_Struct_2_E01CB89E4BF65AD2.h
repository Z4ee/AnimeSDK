...
#define CLASS_2_17E903BDA51D43F0_STRUCT_2_E01CB89E4BF65AD2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x744270)
#define CLASS_2_17E903BDA51D43F0_STRUCT_2_E01CB89E4BF65AD2_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

inline static constexpr unsigned int Class_2_17E903BDA51D43F0_Struct_2_E01CB89E4BF65AD2_TypeDefinitionIndex = 46702;

struct alignas(8) Class_2_17E903BDA51D43F0_Struct_2_E01CB89E4BF65AD2
{
	::MonoSceneMap3DConfig* Field_2_5; // 0x10
	::Class_2_17E903BDA51D43F0* Field_2_2; // 0x18
	::System::Threading::CancellationTokenSource* Field_2_10; // 0x20
	::System::Threading::CancellationToken Field_2_4; // 0x28
	::MoleMole::MapChangeLayerConfig* Field_2_6; // 0x30
	::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_11; // 0x38
	::MoleMole::MapChangeLayerConfig* Field_2_7; // 0x48
