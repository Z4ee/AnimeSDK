...
#define CLASS_3_6B90C9F119FE08BB_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x125A5620)
#define CLASS_3_6B90C9F119FE08BB_METHOD_3_4AA7827CFB505DDD_OFFSET UNITYSDK_OFFSET(0x125A5860)
#define CLASS_3_6B90C9F119FE08BB_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x125A57D0)
#define CLASS_3_6B90C9F119FE08BB_METHOD_3_FFFD00FEC6029AE6_OFFSET UNITYSDK_OFFSET(0x125A5760)
#define CLASS_3_6B90C9F119FE08BB_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x125A54E0)
#define CLASS_3_6B90C9F119FE08BB__CCTOR_OFFSET UNITYSDK_OFFSET(0x125A5670)
#define CLASS_3_6B90C9F119FE08BB__CTOR_OFFSET UNITYSDK_OFFSET(0x125A56F0)

inline static constexpr unsigned int Class_3_6B90C9F119FE08BB_TypeDefinitionIndex = 75826;

class Class_3_6B90C9F119FE08BB : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_8 = 0x8; // 0x0
	::MoleMole::Config::AttackPatternMorphBase* Field_3_7; // 0x48
	::Class_2_93A9E55A4E05FAD9_6* Field_3_11; // 0x50
	::MoleMole::Battle::Entity* Field_3_9; // 0x58
	::Class_2_93A9E55A4E05FAD9_5* Field_3_4; // 0x60
	::Class_2_93A9E55A4E05FAD9_4* Field_3_5; // 0x68
	::Class_1_CFC8E3321E6584C8* Field_3_0; // 0x70
	::Enum_3_9666512A8D753070 Field_3_6; // 0x78
