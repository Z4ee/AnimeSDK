...
#define CUSTOMSKIN_SDKCONFIRM_INSTANCE_OFFSET UNITYSDK_OFFSET(0x131A4290)
#define CUSTOMSKIN_SDKCONFIRM_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x131A4450)
#define CUSTOMSKIN_SDKCONFIRM_ONSHOW_OFFSET UNITYSDK_OFFSET(0x131A44A0)
#define CUSTOMSKIN_SDKCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0x131A43C0)
#define CUSTOMSKIN_SDKCONFIRM__ONSHOW_B__4_0_OFFSET UNITYSDK_OFFSET(0x131A47A0)
#define CUSTOMSKIN_SDKCONFIRM__ONSHOW_B__4_1_OFFSET UNITYSDK_OFFSET(0x131A47E0)

inline static constexpr unsigned int CustomSkin_SDKConfirm_TypeDefinitionIndex = 73427;
...
public:
	...
	{
		return (::CustomSkin_SDKConfirm**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_SDKConfirm_TypeDefinitionIndex)->GetStaticField(0x481E0);
	}
