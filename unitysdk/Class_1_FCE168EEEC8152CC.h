...
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_09240C49BD2B3C4B_OFFSET UNITYSDK_OFFSET(0xC076CC0)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_270DF59DB725F7EA_OFFSET UNITYSDK_OFFSET(0xC076D90)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_3F7A5CB67EB7A185_OFFSET UNITYSDK_OFFSET(0xC076650)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_480A9644B5367A58_OFFSET UNITYSDK_OFFSET(0xC076B30)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xC0764B0)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_979F687A22CC9A41_OFFSET UNITYSDK_OFFSET(0xC0768F0)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xC076500)
#define CLASS_1_FCE168EEEC8152CC_METHOD_1_E681B6D41E5607D0_OFFSET UNITYSDK_OFFSET(0xC0765A0)
#define CLASS_1_FCE168EEEC8152CC__CTOR_OFFSET UNITYSDK_OFFSET(0xC0762D0)
...
{
public:
	::System::String* CLGGLFHIFCK; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_6A49D2459F37DC4F*>* FOBNPFOCGBO; // 0x18
	::Il2CppArray<::System::Byte>* DCHOFPFDBNJ; // 0x20
	::System::Collections::Generic::HashSet_1<::System::String*>* GFIHMIOGHDH; // 0x28
	::System::String* NHDJIMLEECM; // 0x30
	::System::Collections::Generic::List_1<::System::Net::IPEndPoint*>* EDALBPFJFLH; // 0x38
	::System::String* FNOBOEPLIHH; // 0x40
	::RPG::Client::AtomicObject_1<::System::Net::IPEndPoint*>* FPFAKJBEDAD; // 0x48
