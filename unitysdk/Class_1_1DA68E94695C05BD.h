...
#define CLASS_1_1DA68E94695C05BD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF99C90)
...
{
public:
	::Il2CppArray<::Class_1_80B0DA28ED2E4CFF*>* MBEOOBEPKDI; // 0x10
	::RPG::Client::LittleGame::RoadRash::RoadRashMapStartLine HJIOBKHMFHA; // 0x18
	::Il2CppArray<::RPG::Client::LittleGame::RoadRash::RoadRashMapStartPoint>* MKCFHAFABCO; // 0x28
	::UnityEngine::Transform* DHIPFJBEJPI; // 0x30
	::Il2CppArray<::Class_1_DCE3BC3D0902A8EB*>* PBMKEAJPDIC; // 0x38
	::Il2CppArray<::Class_1_B6045334FA181376*>* MMEGKALPGGC; // 0x40
	::Il2CppArray<::Class_1_47EE63CB5C4DC8FC_15*>* JEOBJOICGDG; // 0x48
