...
#define CLASS_2_1266B9A4B9B8481C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A78B1C0)
#define CLASS_2_1266B9A4B9B8481C_METHOD_2_79329BF7EA8A0EED_OFFSET UNITYSDK_OFFSET(0x1A78BE90)
#define CLASS_2_1266B9A4B9B8481C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A78B200)
#define CLASS_2_1266B9A4B9B8481C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A78BDE0)
#define CLASS_2_1266B9A4B9B8481C_TICK_OFFSET UNITYSDK_OFFSET(0x1A78BE30)
#define CLASS_2_1266B9A4B9B8481C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A78B1B0)
...
{
public:
	::RPG::GameCore::GlobalTimeSlow* OFKGLJOAMLD; // 0x18
