...
#define CLASS_2_1266B9A4B9B8481C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x163B08C0)
#define CLASS_2_1266B9A4B9B8481C_METHOD_2_79329BF7EA8A0EED_OFFSET UNITYSDK_OFFSET(0x163B1580)
#define CLASS_2_1266B9A4B9B8481C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x163B0900)
#define CLASS_2_1266B9A4B9B8481C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x163B14D0)
#define CLASS_2_1266B9A4B9B8481C_TICK_OFFSET UNITYSDK_OFFSET(0x163B1520)
#define CLASS_2_1266B9A4B9B8481C__CTOR_OFFSET UNITYSDK_OFFSET(0x163B08B0)

inline static constexpr unsigned int Class_2_1266B9A4B9B8481C_TypeDefinitionIndex = 55288;

class Class_2_1266B9A4B9B8481C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::GlobalTimeSlow* OFKGLJOAMLD; // 0x20
