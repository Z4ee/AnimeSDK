...
#define CLASS_2_1266B9A4B9B8481C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14420600)
#define CLASS_2_1266B9A4B9B8481C_METHOD_2_79329BF7EA8A0EED_OFFSET UNITYSDK_OFFSET(0x14421110)
#define CLASS_2_1266B9A4B9B8481C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14420640)
#define CLASS_2_1266B9A4B9B8481C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14421060)
#define CLASS_2_1266B9A4B9B8481C_TICK_OFFSET UNITYSDK_OFFSET(0x144210B0)
#define CLASS_2_1266B9A4B9B8481C__CTOR_OFFSET UNITYSDK_OFFSET(0x144205F0)

inline static constexpr unsigned int Class_2_1266B9A4B9B8481C_TypeDefinitionIndex = 51447;
