...
#define CLASS_1_5B567C8A01BAEDFE_26_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3B9280)
#define CLASS_1_5B567C8A01BAEDFE_26_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3B90F0)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3B9190)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3B9130)
#define CLASS_1_5B567C8A01BAEDFE_26_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3B91E0)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3B92D0)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3B92A0)
#define CLASS_1_5B567C8A01BAEDFE_26_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3B9070)
#define CLASS_1_5B567C8A01BAEDFE_26_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3B90A0)
#define CLASS_1_5B567C8A01BAEDFE_26_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3B9210)
#define CLASS_1_5B567C8A01BAEDFE_26_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3B9270)
#define CLASS_1_5B567C8A01BAEDFE_26__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3B9320)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3B90C0)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B90B0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_26_TypeDefinitionIndex = 24944;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_26*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_26_TypeDefinitionIndex)->GetStaticField(0x602F0);
	}
