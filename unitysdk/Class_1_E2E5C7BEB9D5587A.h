...
#define CLASS_1_E2E5C7BEB9D5587A__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FFA70)
...
public:
	...
	::RPG::GameCore::PropState MEPFOEEGBEA; // 0x18
	::Enum_3_0A3761FE34514D6C_78 GMPGDEINODK; // 0x1C
