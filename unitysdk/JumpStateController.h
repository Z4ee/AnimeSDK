...
#define JUMPSTATECONTROLLER_METHOD_4_097455A9BF07EB21_OFFSET UNITYSDK_OFFSET(0x163E4180)
#define JUMPSTATECONTROLLER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x163E4090)
#define JUMPSTATECONTROLLER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x163E43D0)
#define JUMPSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x163E4460)

inline static constexpr unsigned int JumpStateController_TypeDefinitionIndex = 47732;
