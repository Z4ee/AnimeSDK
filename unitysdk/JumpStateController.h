...
#define JUMPSTATECONTROLLER_METHOD_4_097455A9BF07EB21_OFFSET UNITYSDK_OFFSET(0x1A7BEA40)
#define JUMPSTATECONTROLLER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A7BE950)
#define JUMPSTATECONTROLLER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A7BEC90)
#define JUMPSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BED20)
