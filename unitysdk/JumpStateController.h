...
#define JUMPSTATECONTROLLER_METHOD_4_097455A9BF07EB21_OFFSET UNITYSDK_OFFSET(0x114DB270)
#define JUMPSTATECONTROLLER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x114DB180)
#define JUMPSTATECONTROLLER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x114DB4C0)
#define JUMPSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x114DB550)
#define JUMPSTATECONTROLLER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x114DB580)
#define JUMPSTATECONTROLLER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x114DB590)

inline static constexpr unsigned int JumpStateController_TypeDefinitionIndex = 38180;
