...
#define CLASS_3_D76B8E917C6A8144_DISPOSE_OFFSET UNITYSDK_OFFSET(0x129DF240)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_22979A281ED046FD_OFFSET UNITYSDK_OFFSET(0x129E00B0)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x129DF2A0)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_5B0BDDCEF30419AF_OFFSET UNITYSDK_OFFSET(0x129DFE80)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_8255505595309FA5_OFFSET UNITYSDK_OFFSET(0x129DFF80)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_A07BC9887E08649F_OFFSET UNITYSDK_OFFSET(0x129DFB70)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x129DF420)
#define CLASS_3_D76B8E917C6A8144_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x129DF580)
#define CLASS_3_D76B8E917C6A8144__CTOR_OFFSET UNITYSDK_OFFSET(0x129DF1C0)
#define CLASS_3_D76B8E917C6A8144___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x129E0180)

inline static constexpr unsigned int Class_3_D76B8E917C6A8144_TypeDefinitionIndex = 52050;

class Class_3_D76B8E917C6A8144 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::TriggerSoundInAnim*>
{
public:
	::System::Action_3<::System::UInt32, ::AkCallbackType, ::AkCallbackInfo*>* Field_3_7; // 0x28
	::System::String* Field_3_6; // 0x30
	::Class_1_D7003CCDED916330_Class_3_640C173449D72699* Field_3_9; // 0x38
	::Class_0_16E4307DCC419505_386_Class_3_363670394F299996* Field_3_8; // 0x40
	...
	::System::String* Method_3_A07BC9887E08649F()
	{
		return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_D76B8E917C6A8144_METHOD_3_A07BC9887E08649F_OFFSET))(this);
	}

	::System::Void __iFixBaseProxy_Dispose()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_D76B8E917C6A8144___IFIXBASEPROXY_DISPOSE_OFFSET))(this);
	}
};
