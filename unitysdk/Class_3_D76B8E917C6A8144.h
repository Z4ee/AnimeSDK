...
#define CLASS_3_D76B8E917C6A8144_DISPOSE_OFFSET UNITYSDK_OFFSET(0x114B8840)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_22979A281ED046FD_OFFSET UNITYSDK_OFFSET(0x114B96B0)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x114B88A0)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_5B0BDDCEF30419AF_OFFSET UNITYSDK_OFFSET(0x114B9480)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_8255505595309FA5_OFFSET UNITYSDK_OFFSET(0x114B9580)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_A07BC9887E08649F_OFFSET UNITYSDK_OFFSET(0x114B9170)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x114B8A20)
#define CLASS_3_D76B8E917C6A8144_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x114B8B80)
#define CLASS_3_D76B8E917C6A8144__CTOR_OFFSET UNITYSDK_OFFSET(0x114B87C0)
#define CLASS_3_D76B8E917C6A8144___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x114B9780)

inline static constexpr unsigned int Class_3_D76B8E917C6A8144_TypeDefinitionIndex = 45405;

class Class_3_D76B8E917C6A8144 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::TriggerSoundInAnim*>
{
public:
	::Class_1_D7003CCDED916330_Class_3_640C173449D72699* Field_3_9; // 0x28
	::RPG::GameCore::GameEntity* Field_3_0; // 0x30
	::System::String* Field_3_10; // 0x38
	::Class_0_16E4307DCC419505_379_Class_3_363670394F299996* Field_3_8; // 0x40
	::System::String* Field_3_6; // 0x48
	::System::Action_3<::System::UInt32, ::AkCallbackType, ::AkCallbackInfo*>* Field_3_7; // 0x50
