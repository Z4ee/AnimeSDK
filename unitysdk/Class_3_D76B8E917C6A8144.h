...
#define CLASS_3_D76B8E917C6A8144_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB52A030)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_22979A281ED046FD_OFFSET UNITYSDK_OFFSET(0xB52AEB0)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xB52A090)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_5B0BDDCEF30419AF_OFFSET UNITYSDK_OFFSET(0xB52AC80)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_8255505595309FA5_OFFSET UNITYSDK_OFFSET(0xB52AD80)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_A07BC9887E08649F_OFFSET UNITYSDK_OFFSET(0xB52A970)
#define CLASS_3_D76B8E917C6A8144_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xB52A220)
#define CLASS_3_D76B8E917C6A8144_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB52A380)
#define CLASS_3_D76B8E917C6A8144__CTOR_OFFSET UNITYSDK_OFFSET(0xB529F90)
#define CLASS_3_D76B8E917C6A8144___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB52AF80)

inline static constexpr unsigned int Class_3_D76B8E917C6A8144_TypeDefinitionIndex = 52724;

class Class_3_D76B8E917C6A8144 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::TriggerSoundInAnim*>
{
public:
	::Class_1_D7003CCDED916330_Class_3_640C173449D72699* Field_3_0; // 0x28
	::System::String* Field_3_1; // 0x30
	::Class_0_16E4307DCC419505_405_Class_3_363670394F299996* Field_3_2; // 0x38
	::System::String* Field_3_3; // 0x40
	::RPG::GameCore::GameEntity* Field_3_4; // 0x48
	::System::Action_3<::System::UInt32, ::AkCallbackType, ::AkCallbackInfo*>* Field_3_5; // 0x50
