...
#define CLASS_1_2E3F0B7D2C2B7128_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17ADC820)
#define CLASS_1_2E3F0B7D2C2B7128_CLONE_OFFSET UNITYSDK_OFFSET(0x17ADC3D0)
#define CLASS_1_2E3F0B7D2C2B7128_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17ADC520)
#define CLASS_1_2E3F0B7D2C2B7128_EQUALS_OFFSET UNITYSDK_OFFSET(0x17ADC430)
#define CLASS_1_2E3F0B7D2C2B7128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17ADC5D0)
#define CLASS_1_2E3F0B7D2C2B7128_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17ADCA10)
#define CLASS_1_2E3F0B7D2C2B7128_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17ADC970)
#define CLASS_1_2E3F0B7D2C2B7128_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17ADC410)
#define CLASS_1_2E3F0B7D2C2B7128_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17ADC420)
#define CLASS_1_2E3F0B7D2C2B7128_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17ADC400)
#define CLASS_1_2E3F0B7D2C2B7128_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17ADC2B0)
#define CLASS_1_2E3F0B7D2C2B7128_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17ADC6C0)
#define CLASS_1_2E3F0B7D2C2B7128_WRITETO_OFFSET UNITYSDK_OFFSET(0x17ADC720)
#define CLASS_1_2E3F0B7D2C2B7128__CCTOR_OFFSET UNITYSDK_OFFSET(0x17ADCAF0)
#define CLASS_1_2E3F0B7D2C2B7128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17ADC310)
#define CLASS_1_2E3F0B7D2C2B7128__CTOR_OFFSET UNITYSDK_OFFSET(0x17ADC2C0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_F381659723E3F143_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2E3F0B7D2C2B7128_TypeDefinitionIndex)->GetStaticField(0x31460);
	}
