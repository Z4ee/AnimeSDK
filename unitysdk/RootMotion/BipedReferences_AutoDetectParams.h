...
#define ROOTMOTION_BIPEDREFERENCES_AUTODETECTPARAMS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1EEDB7C0)
#define ROOTMOTION_BIPEDREFERENCES_AUTODETECTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x342140)

namespace RootMotion
{
	inline static constexpr unsigned int BipedReferences_AutoDetectParams_TypeDefinitionIndex = 39008;
