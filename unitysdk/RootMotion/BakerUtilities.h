...
#define ROOTMOTION_BAKERUTILITIES_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1F882660)
#define ROOTMOTION_BAKERUTILITIES_GETREDUCEDKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F882220)
#define ROOTMOTION_BAKERUTILITIES_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F8821E0)
#define ROOTMOTION_BAKERUTILITIES_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1F8825A0)
#define ROOTMOTION_BAKERUTILITIES_SETTANGENTMODE_OFFSET UNITYSDK_OFFSET(0x1F882650)

namespace RootMotion
{
	inline static constexpr unsigned int BakerUtilities_TypeDefinitionIndex = 38961;
