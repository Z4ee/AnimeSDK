...
#define ROOTMOTION_LAYERMASKEXTENSIONS_ADDTOMASK_OFFSET UNITYSDK_OFFSET(0x1E2C1EE0)
#define ROOTMOTION_LAYERMASKEXTENSIONS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1E2C1B60)
#define ROOTMOTION_LAYERMASKEXTENSIONS_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1E2C1C50)
#define ROOTMOTION_LAYERMASKEXTENSIONS_CREATE_OFFSET UNITYSDK_OFFSET(0x1E2C1B70)
#define ROOTMOTION_LAYERMASKEXTENSIONS_INVERSE_OFFSET UNITYSDK_OFFSET(0x1E2C1ED0)
#define ROOTMOTION_LAYERMASKEXTENSIONS_LAYERNUMBERSTOMASK_OFFSET UNITYSDK_OFFSET(0x1E2C1D90)
#define ROOTMOTION_LAYERMASKEXTENSIONS_MASKTONAMES_OFFSET UNITYSDK_OFFSET(0x1E2C1FC0)
#define ROOTMOTION_LAYERMASKEXTENSIONS_MASKTONUMBERS_OFFSET UNITYSDK_OFFSET(0x1E2C2110)
#define ROOTMOTION_LAYERMASKEXTENSIONS_MASKTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1E2C2290)
#define ROOTMOTION_LAYERMASKEXTENSIONS_MASKTOSTRING_OFFSET UNITYSDK_OFFSET(0x1E2C21F0)
#define ROOTMOTION_LAYERMASKEXTENSIONS_NAMESTOMASK_OFFSET UNITYSDK_OFFSET(0x1E2C1BE0)
#define ROOTMOTION_LAYERMASKEXTENSIONS_REMOVEFROMMASK_OFFSET UNITYSDK_OFFSET(0x1E2C1F50)

namespace RootMotion
{
	inline static constexpr unsigned int LayerMaskExtensions_TypeDefinitionIndex = 38343;
