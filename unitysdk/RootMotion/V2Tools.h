...
#define ROOTMOTION_V2TOOLS_DELTAANGLEXZ_OFFSET UNITYSDK_OFFSET(0x1E2C23E0)
#define ROOTMOTION_V2TOOLS_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x1E2C2320)
#define ROOTMOTION_V2TOOLS_LINECIRCLEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1E2C2480)
#define ROOTMOTION_V2TOOLS_RAYCIRCLEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1E2C2590)
#define ROOTMOTION_V2TOOLS_XZ_OFFSET UNITYSDK_OFFSET(0x1E2C2310)

namespace RootMotion
{
	inline static constexpr unsigned int V2Tools_TypeDefinitionIndex = 38222;
