...
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1F9255B0)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1F925590)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1F9255C0)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1F9255A0)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9255D0)

namespace RootMotion
{
	inline static constexpr unsigned int ShowRangeIfAttribute_TypeDefinitionIndex = 38777;
