...
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1C34A500)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1C34A550)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1C34A5E0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1C34A460)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1C34A410)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1C34A4B0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C34AB10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitAngle_TypeDefinitionIndex = 36678;
