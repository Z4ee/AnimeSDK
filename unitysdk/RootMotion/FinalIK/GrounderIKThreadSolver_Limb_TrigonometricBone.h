...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_TRIGONOMETRICBONE_GETBENDNORMALFROMCURRENTROTATION_OFFSET UNITYSDK_OFFSET(0x39D0710)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_TRIGONOMETRICBONE_GETROTATION_OFFSET UNITYSDK_OFFSET(0x39D0610)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_TRIGONOMETRICBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x39D05D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderIKThreadSolver_Limb_TrigonometricBone_TypeDefinitionIndex = 42677;
