...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTONODE_OFFSET UNITYSDK_OFFSET(0x1F8AEEE0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F8AE0D0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETPLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F8AF010)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1F8AF1F0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_ISNODEBONE_OFFSET UNITYSDK_OFFSET(0x1F8AE130)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_LASTANIMATEDTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1F8AEB90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_SWINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x1F8ADEF0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_INITIATE_OFFSET UNITYSDK_OFFSET(0x1F8ADE70)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_MAINTAINROTATION_OFFSET UNITYSDK_OFFSET(0x1F8AEE60)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_POSITIONTOPLANE_OFFSET UNITYSDK_OFFSET(0x1F8AF380)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F8AFCF0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOMAINTAIN_OFFSET UNITYSDK_OFFSET(0x1F8AFC40)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOPLANE_OFFSET UNITYSDK_OFFSET(0x1F8AF3D0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1F8AEE00)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1F8AE140)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1F8AE230)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_OFFSET UNITYSDK_OFFSET(0x1F8AE220)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALTWISTAXIS_OFFSET UNITYSDK_OFFSET(0x1F8AE4E0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETPLANE_OFFSET UNITYSDK_OFFSET(0x1F8AE660)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETTOIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1F8AEEA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1F8AE040)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_1_OFFSET UNITYSDK_OFFSET(0x1F8AF5F0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_OFFSET UNITYSDK_OFFSET(0x1F8AF560)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_TWIST_OFFSET UNITYSDK_OFFSET(0x1F8AF920)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_UPDATEPLANE_OFFSET UNITYSDK_OFFSET(0x1F8AE7F0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8AFE50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_BoneMap_TypeDefinitionIndex = 38831;
