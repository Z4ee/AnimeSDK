...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTONODE_OFFSET UNITYSDK_OFFSET(0x1C13FC70)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C13EE30)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETPLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x1C13FDA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1C13FF80)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_ISNODEBONE_OFFSET UNITYSDK_OFFSET(0x1C13EE90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_LASTANIMATEDTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1C13F910)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_SWINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x1C13EC40)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_INITIATE_OFFSET UNITYSDK_OFFSET(0x1C13EBC0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_MAINTAINROTATION_OFFSET UNITYSDK_OFFSET(0x1C13FBF0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_POSITIONTOPLANE_OFFSET UNITYSDK_OFFSET(0x1C140120)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1C140A90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOMAINTAIN_OFFSET UNITYSDK_OFFSET(0x1C1409E0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOPLANE_OFFSET UNITYSDK_OFFSET(0x1C140170)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1C13FB90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C13EEA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1C13EFB0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_OFFSET UNITYSDK_OFFSET(0x1C13EFA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALTWISTAXIS_OFFSET UNITYSDK_OFFSET(0x1C13F250)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETPLANE_OFFSET UNITYSDK_OFFSET(0x1C13F3E0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETTOIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1C13FC30)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1C13EDA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_1_OFFSET UNITYSDK_OFFSET(0x1C140390)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_OFFSET UNITYSDK_OFFSET(0x1C140300)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_TWIST_OFFSET UNITYSDK_OFFSET(0x1C1406C0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_UPDATEPLANE_OFFSET UNITYSDK_OFFSET(0x1C13F570)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C140BF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_BoneMap_TypeDefinitionIndex = 36602;
