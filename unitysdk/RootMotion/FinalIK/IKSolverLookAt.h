...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1EEE03E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0x1EEE31E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1EEE0F10)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1EEE13D0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_EYESISEMPTY_OFFSET UNITYSDK_OFFSET(0x1EEE0EF0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_EYESISVALID_OFFSET UNITYSDK_OFFSET(0x1EEE0C30)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADBASEFORWARD_OFFSET UNITYSDK_OFFSET(0x1EEE3690)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADISEMPTY_OFFSET UNITYSDK_OFFSET(0x1EEE0DD0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADISVALID_OFFSET UNITYSDK_OFFSET(0x1EEE0C20)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEBASEFORWARD_OFFSET UNITYSDK_OFFSET(0x1EEE36D0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEISEMPTY_OFFSET UNITYSDK_OFFSET(0x1EEE0DB0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEISVALID_OFFSET UNITYSDK_OFFSET(0x1EEE0AA0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1EEE0600)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1EEE1860)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EEE1FE0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETBONES_OFFSET UNITYSDK_OFFSET(0x1EEE1660)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1EEE1590)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x1EEDFCF0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_2_OFFSET UNITYSDK_OFFSET(0x1EEDFD40)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_3_OFFSET UNITYSDK_OFFSET(0x1EEDFDB0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_4_OFFSET UNITYSDK_OFFSET(0x1EEDFE50)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_5_OFFSET UNITYSDK_OFFSET(0x1EEDFF20)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x1EEDFCC0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0x1EEE2A70)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x1EEE2500)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1EEE2280)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1EEE0040)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEE3750)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_TypeDefinitionIndex = 38799;
