...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DAFA9A0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0x1DAFD850)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1DAFB4D0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1DAFB9A0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_EYESISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DAFB4B0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_EYESISVALID_OFFSET UNITYSDK_OFFSET(0x1DAFB1F0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADBASEFORWARD_OFFSET UNITYSDK_OFFSET(0x1DAFDD00)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DAFB390)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADISVALID_OFFSET UNITYSDK_OFFSET(0x1DAFB1E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEBASEFORWARD_OFFSET UNITYSDK_OFFSET(0x1DAFDD40)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DAFB370)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEISVALID_OFFSET UNITYSDK_OFFSET(0x1DAFB060)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DAFABC0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1DAFBE20)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DAFC5C0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETBONES_OFFSET UNITYSDK_OFFSET(0x1DAFBC30)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1DAFBB60)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x1DAFA2B0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_2_OFFSET UNITYSDK_OFFSET(0x1DAFA300)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_3_OFFSET UNITYSDK_OFFSET(0x1DAFA370)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_4_OFFSET UNITYSDK_OFFSET(0x1DAFA410)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_5_OFFSET UNITYSDK_OFFSET(0x1DAFA4E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DAFA280)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0x1DAFD0E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x1DAFCB30)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1DAFC860)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1DAFA600)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAFDDC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_TypeDefinitionIndex = 38161;
