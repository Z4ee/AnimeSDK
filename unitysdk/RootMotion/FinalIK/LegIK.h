...
#define ROOTMOTION_FINALIK_LEGIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1F3D5FA0)
#define ROOTMOTION_FINALIK_LEGIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1F3D5FF0)
#define ROOTMOTION_FINALIK_LEGIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F3D5F00)
#define ROOTMOTION_FINALIK_LEGIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1F3D5EB0)
#define ROOTMOTION_FINALIK_LEGIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1F3D5F50)
#define ROOTMOTION_FINALIK_LEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3D6000)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIK_TypeDefinitionIndex = 39003;
