...
#define ROOTMOTION_FINALIK_LEGIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1BCB0230)
#define ROOTMOTION_FINALIK_LEGIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1BCB0280)
#define ROOTMOTION_FINALIK_LEGIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1BCB0190)
#define ROOTMOTION_FINALIK_LEGIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1BCB0140)
#define ROOTMOTION_FINALIK_LEGIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1BCB01E0)
#define ROOTMOTION_FINALIK_LEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB0290)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIK_TypeDefinitionIndex = 36585;
