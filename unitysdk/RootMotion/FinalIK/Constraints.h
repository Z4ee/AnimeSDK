...
#define ROOTMOTION_FINALIK_CONSTRAINTS_INITIATE_OFFSET UNITYSDK_OFFSET(0x1F3AD050)
#define ROOTMOTION_FINALIK_CONSTRAINTS_ISVALID_OFFSET UNITYSDK_OFFSET(0x1F3ACF40)
#define ROOTMOTION_FINALIK_CONSTRAINTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F3AD1A0)
#define ROOTMOTION_FINALIK_CONSTRAINTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3AD970)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Constraints_TypeDefinitionIndex = 38917;
