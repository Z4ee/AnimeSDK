...
#define ROOTMOTION_FINALIK_CONSTRAINTS_INITIATE_OFFSET UNITYSDK_OFFSET(0x1DF91910)
#define ROOTMOTION_FINALIK_CONSTRAINTS_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DF91800)
#define ROOTMOTION_FINALIK_CONSTRAINTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DF91A60)
#define ROOTMOTION_FINALIK_CONSTRAINTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF92240)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Constraints_TypeDefinitionIndex = 38175;
