...
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E46FCA0)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E4710F0)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1E470B80)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4712B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKArmBending_TypeDefinitionIndex = 38278;
