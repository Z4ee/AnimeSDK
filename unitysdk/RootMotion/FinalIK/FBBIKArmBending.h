...
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1F8A81C0)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F8A9630)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1F8A90C0)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8A97F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKArmBending_TypeDefinitionIndex = 38983;
