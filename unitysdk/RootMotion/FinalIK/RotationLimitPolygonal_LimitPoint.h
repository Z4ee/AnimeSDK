...
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_LIMITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB4220)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitPolygonal_LimitPoint_TypeDefinitionIndex = 38139;
