...
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_CHILD_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E6E8940)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_CHILD_STORELOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E6E8AF0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_CHILD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E88B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RagdollUtility_Child_TypeDefinitionIndex = 38275;
