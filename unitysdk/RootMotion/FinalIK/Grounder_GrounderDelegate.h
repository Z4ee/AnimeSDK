...
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F2948B0)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F2948E0)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F294620)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F294600)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounder_GrounderDelegate_TypeDefinitionIndex = 38916;
