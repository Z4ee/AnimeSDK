...
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB31CD0)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB31D00)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB31A30)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB31A20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounder_GrounderDelegate_TypeDefinitionIndex = 36562;
