...
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET_GET_ROTATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F1316B0)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1F1314A0)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F131730)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F131720)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintRotationOffset_TypeDefinitionIndex = 38823;
