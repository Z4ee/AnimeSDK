...
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET_GET_ROTATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1DD29420)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1DD29210)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD294A0)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD29490)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintRotationOffset_TypeDefinitionIndex = 38115;
