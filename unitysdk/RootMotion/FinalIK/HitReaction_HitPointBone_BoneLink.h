...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_BONELINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1F3CC460)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_BONELINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1F3CC5F0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_BONELINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3CC600)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointBone_BoneLink_TypeDefinitionIndex = 38840;
