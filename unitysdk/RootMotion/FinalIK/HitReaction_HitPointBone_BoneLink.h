...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_BONELINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1BCA6700)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_BONELINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1BCA6890)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_BONELINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA68A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointBone_BoneLink_TypeDefinitionIndex = 36701;
