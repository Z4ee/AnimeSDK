...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x1C2E2320)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1C2E1BD0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1C2E1FB0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2E1B80)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E1B40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_LookAtBone_TypeDefinitionIndex = 36631;
