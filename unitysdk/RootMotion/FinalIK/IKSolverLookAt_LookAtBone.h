...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x1FA18060)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1FA178F0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1FA17CE0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FA178A0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA17860)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_LookAtBone_TypeDefinitionIndex = 38800;
