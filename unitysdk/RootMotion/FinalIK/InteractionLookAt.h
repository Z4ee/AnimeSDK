...
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_LOOK_OFFSET UNITYSDK_OFFSET(0x1C347FD0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1C348360)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x1C348AD0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1C3488E0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C3484D0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C348CC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionLookAt_TypeDefinitionIndex = 36650;
