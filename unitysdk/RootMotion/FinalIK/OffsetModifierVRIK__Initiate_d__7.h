...
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DEF7280)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DEF7470)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DEF74D0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DEF7480)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DEF7270)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEF7260)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifierVRIK__Initiate_d__7_TypeDefinitionIndex = 38284;
