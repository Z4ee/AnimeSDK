...
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BB8E060)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BB8E250)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BB8E2B0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BB8E260)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BB8E050)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8E040)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifierVRIK__Initiate_d__7_TypeDefinitionIndex = 36717;
