...
#define ROOTMOTION_FINALIK_AIMPOSER_GETPOSE_OFFSET UNITYSDK_OFFSET(0x1DAF5D70)
#define ROOTMOTION_FINALIK_AIMPOSER_SETPOSEACTIVE_OFFSET UNITYSDK_OFFSET(0x1DAF5E70)
#define ROOTMOTION_FINALIK_AIMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF5ED0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_TypeDefinitionIndex = 38165;
