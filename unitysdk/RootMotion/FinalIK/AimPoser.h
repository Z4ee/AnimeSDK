...
#define ROOTMOTION_FINALIK_AIMPOSER_GETPOSE_OFFSET UNITYSDK_OFFSET(0x1B6F37D0)
#define ROOTMOTION_FINALIK_AIMPOSER_SETPOSEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B6F38D0)
#define ROOTMOTION_FINALIK_AIMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F3930)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_TypeDefinitionIndex = 36687;
