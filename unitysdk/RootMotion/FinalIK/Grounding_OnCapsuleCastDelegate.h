...
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BCA6580)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BCA66D0)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BCA5BE0)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA5BD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnCapsuleCastDelegate_TypeDefinitionIndex = 36573;
