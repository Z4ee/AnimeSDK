...
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F3CC2E0)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F3CC430)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F3CBA20)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3CBA00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnCapsuleCastDelegate_TypeDefinitionIndex = 38816;
