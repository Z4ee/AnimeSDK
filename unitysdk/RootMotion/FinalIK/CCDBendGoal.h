...
#define ROOTMOTION_FINALIK_CCDBENDGOAL_BEFOREIK_OFFSET UNITYSDK_OFFSET(0x1F56DB60)
#define ROOTMOTION_FINALIK_CCDBENDGOAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F56DF50)
#define ROOTMOTION_FINALIK_CCDBENDGOAL_START_OFFSET UNITYSDK_OFFSET(0x1F56DA90)
#define ROOTMOTION_FINALIK_CCDBENDGOAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F56E110)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int CCDBendGoal_TypeDefinitionIndex = 38806;
