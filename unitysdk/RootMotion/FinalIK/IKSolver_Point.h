...
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E068D00)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E068C70)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1E068EA0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E068F90)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1E068E40)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERSTATE_OFFSET UNITYSDK_OFFSET(0x1E068F00)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E069020)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolver_Point_TypeDefinitionIndex = 38233;
