...
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19276550)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x192764C0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x192766F0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x192767E0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x19276690)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERSTATE_OFFSET UNITYSDK_OFFSET(0x19276750)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x192762C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolver_Point_TypeDefinitionIndex = 42694;
