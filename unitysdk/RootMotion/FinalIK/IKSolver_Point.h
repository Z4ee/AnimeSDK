...
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA270480)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0xA2703F0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xA270620)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALSTATE_OFFSET UNITYSDK_OFFSET(0xA270710)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0xA2705C0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERSTATE_OFFSET UNITYSDK_OFFSET(0xA270680)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA2701F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolver_Point_TypeDefinitionIndex = 41833;
