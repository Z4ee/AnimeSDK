...
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_EFFECTORTYPE_OFFSET UNITYSDK_OFFSET(0x1E2BCCC0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_ININTERACTION_OFFSET UNITYSDK_OFFSET(0x1E2BCD20)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_INTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1E2BCD00)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1E2BCCE0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1E2C06B0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1E2BCEA0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1E2C0810)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_PAUSE_OFFSET UNITYSDK_OFFSET(0x1E2BD9A0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_PICKUP_OFFSET UNITYSDK_OFFSET(0x1E2BFD50)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_RESETTODEFAULTS_OFFSET UNITYSDK_OFFSET(0x1E2BD270)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_RESUME_OFFSET UNITYSDK_OFFSET(0x1E2BDC80)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_EFFECTORTYPE_OFFSET UNITYSDK_OFFSET(0x1E2BCCD0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_INTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1E2BCD10)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1E2BCCF0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_START_1_OFFSET UNITYSDK_OFFSET(0x1E2BDFF0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_START_OFFSET UNITYSDK_OFFSET(0x1E2BDDF0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_STOP_OFFSET UNITYSDK_OFFSET(0x1E2C03C0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_STOREDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1E2BCFC0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_TRIGGERUNTRIGGEREDEVENTS_OFFSET UNITYSDK_OFFSET(0x1E2BFA60)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E2BECD0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2BCE30)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionEffector_TypeDefinitionIndex = 38234;
