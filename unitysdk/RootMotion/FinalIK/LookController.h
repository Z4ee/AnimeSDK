...
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_CUSTOMROTATETOWARDS_OFFSET UNITYSDK_OFFSET(0x1DF9E9A0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_CUSTOMSLERP_OFFSET UNITYSDK_OFFSET(0x1DF9D1D0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_DOUPDATEONCE_OFFSET UNITYSDK_OFFSET(0x1DF9A130)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_FIXDIR_OFFSET UNITYSDK_OFFSET(0x1DF9BFC0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_FIXEDLERP_OFFSET UNITYSDK_OFFSET(0x1DF9E950)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_FIXPITCH_OFFSET UNITYSDK_OFFSET(0x1DF9EC70)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GETROTATEXZDIR_OFFSET UNITYSDK_OFFSET(0x1DF9E6A0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1DF989F0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1DF98B10)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETPITCHDOWN_OFFSET UNITYSDK_OFFSET(0x1DF98E90)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETPITCHUP_OFFSET UNITYSDK_OFFSET(0x1DF98E50)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONCHANGETARGET_OFFSET UNITYSDK_OFFSET(0x1DF98F30)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONGETTARGET_OFFSET UNITYSDK_OFFSET(0x1DF98F10)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONLOCKINGTARGET_OFFSET UNITYSDK_OFFSET(0x1DF98F70)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONMISSINGTARGET_OFFSET UNITYSDK_OFFSET(0x1DF98F50)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETYAWLEFT_OFFSET UNITYSDK_OFFSET(0x1DF98EF0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETYAWRIGHT_OFFSET UNITYSDK_OFFSET(0x1DF98ED0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_ISVALIDPIVOT_OFFSET UNITYSDK_OFFSET(0x1DF98B80)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1DF98DD0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_INITSTARTDIR_OFFSET UNITYSDK_OFFSET(0x1DF994C0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ISOUTOFRANGE_OFFSET UNITYSDK_OFFSET(0x1DF9ED20)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ISWEIGHTZERO_OFFSET UNITYSDK_OFFSET(0x1DF9BC20)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1DF9A010)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DF99EF0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1DF9A140)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_RESTOREIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1DF9A910)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ROTATEBYHINGERYAWPITCH_OFFSET UNITYSDK_OFFSET(0x1DF9D930)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1DF98F90)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_UPDATEBYSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1DF9B100)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_UPDATELOCKINGDIR_OFFSET UNITYSDK_OFFSET(0x1DF9BC50)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DF9AA10)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF9F450)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LookController_TypeDefinitionIndex = 38265;
