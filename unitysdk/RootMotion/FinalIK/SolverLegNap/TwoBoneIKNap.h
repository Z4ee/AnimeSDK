...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_TWOBONEIKNAP_GETDIRECTIONTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1DB06B60)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_TWOBONEIKNAP_SOLVETWOBONEIK_OFFSET UNITYSDK_OFFSET(0x1DB06620)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int TwoBoneIKNap_TypeDefinitionIndex = 38128;
