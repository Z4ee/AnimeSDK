...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_DISTANCESQ_OFFSET UNITYSDK_OFFSET(0x1BB3B4D0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GENERATETRANSFORMLIST_OFFSET UNITYSDK_OFFSET(0x1BB3B870)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GETDISTANCETOPANEL_OFFSET UNITYSDK_OFFSET(0x1BB3BFC0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GETTRANSFORMSCACHE_OFFSET UNITYSDK_OFFSET(0x1BB3BC20)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_ISVALIDBONECHAIN_OFFSET UNITYSDK_OFFSET(0x1BB3B510)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_ROTATEAXISTOABOVEPANEL_OFFSET UNITYSDK_OFFSET(0x1BB3BCD0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB3C000)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int IKSolverLegNapUtils_TypeDefinitionIndex = 36744;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(IKSolverLegNapUtils_TypeDefinitionIndex)->GetStaticField(0x272B0);
		}
