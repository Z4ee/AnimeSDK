...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_NODE_MAKEIDENTITY_OFFSET UNITYSDK_OFFSET(0x1F42B0F0)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int BoneChain_Node_TypeDefinitionIndex = 38847;
