...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_APPENDENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1E0165C0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_ENSURESIZE_OFFSET UNITYSDK_OFFSET(0x1E0163B0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETLASTBONEPOSITION_OFFSET UNITYSDK_OFFSET(0x1E016CA0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETNODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E016810)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1E016C30)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1E016860)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E015CA0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_MULUNIONSCALE_OFFSET UNITYSDK_OFFSET(0x1E016510)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_NODEFROMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E016410)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_POSITIONAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1E0172C0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_RESOLVEBONES_OFFSET UNITYSDK_OFFSET(0x1E016940)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_RESOLVEDIRTY_OFFSET UNITYSDK_OFFSET(0x1E0172B0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SCALEAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1E017300)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETFIRSTDIRTY_OFFSET UNITYSDK_OFFSET(0x1E0168D0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1E016640)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETUPBONECHAINRETURNTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E015CB0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETUPBONECHAIN_OFFSET UNITYSDK_OFFSET(0x1E016580)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_WRITETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E016D20)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E017320)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int BoneChain_TypeDefinitionIndex = 38208;
