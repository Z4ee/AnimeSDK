...
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1BB85310)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BB85270)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_GET_ANIMATEPHYSICS_OFFSET UNITYSDK_OFFSET(0x1BB84F50)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1BB85470)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_START_OFFSET UNITYSDK_OFFSET(0x1BB850A0)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BB85110)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB85680)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKExecutionOrder_TypeDefinitionIndex = 36584;
