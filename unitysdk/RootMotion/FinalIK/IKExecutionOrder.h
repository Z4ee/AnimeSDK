...
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1DEEE530)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DEEE490)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_GET_ANIMATEPHYSICS_OFFSET UNITYSDK_OFFSET(0x1DEEE170)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1DEEE690)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_START_OFFSET UNITYSDK_OFFSET(0x1DEEE2C0)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DEEE330)
#define ROOTMOTION_FINALIK_IKEXECUTIONORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEEE8A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKExecutionOrder_TypeDefinitionIndex = 38125;
