...
#define ROOTMOTION_FINALIK_CCDIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1DAF6050)
#define ROOTMOTION_FINALIK_CCDIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1DAF60A0)
#define ROOTMOTION_FINALIK_CCDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DAF5FB0)
#define ROOTMOTION_FINALIK_CCDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1DAF5F60)
#define ROOTMOTION_FINALIK_CCDIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1DAF6000)
#define ROOTMOTION_FINALIK_CCDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF60B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int CCDIK_TypeDefinitionIndex = 38207;
