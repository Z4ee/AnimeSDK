...
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1E063D70)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E063E20)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E063E10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintRotation_TypeDefinitionIndex = 38239;
