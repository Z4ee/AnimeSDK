...
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1F424500)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F4245B0)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4245A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintRotation_TypeDefinitionIndex = 38856;
