...
#define ROOTMOTION_FINALIK_POSER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B703FB0)
#define ROOTMOTION_FINALIK_POSER_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1B703F80)
#define ROOTMOTION_FINALIK_POSER_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x1B703F30)
#define ROOTMOTION_FINALIK_POSER_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1B703F40)
#define ROOTMOTION_FINALIK_POSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B703FD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Poser_TypeDefinitionIndex = 36672;
