...
#define ROOTMOTION_FINALIK_POSER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1EEEBE90)
#define ROOTMOTION_FINALIK_POSER_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1EEEBE60)
#define ROOTMOTION_FINALIK_POSER_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x1EEEBE10)
#define ROOTMOTION_FINALIK_POSER_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1EEEBE20)
#define ROOTMOTION_FINALIK_POSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEEBEB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Poser_TypeDefinitionIndex = 38992;
