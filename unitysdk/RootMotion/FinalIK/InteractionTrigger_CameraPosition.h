...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1BE21A80)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1BE21EA0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE22310)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CameraPosition_TypeDefinitionIndex = 36666;
