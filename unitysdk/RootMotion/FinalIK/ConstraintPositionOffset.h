...
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET_GET_POSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F6E8990)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1F6E8710)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F6E8A30)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6E8A20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintPositionOffset_TypeDefinitionIndex = 39016;
