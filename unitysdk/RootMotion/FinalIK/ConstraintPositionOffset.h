...
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET_GET_POSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E2B7E50)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1E2B7BD0)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E2B7EF0)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2B7EE0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintPositionOffset_TypeDefinitionIndex = 38354;
