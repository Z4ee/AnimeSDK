...
#define ROOTMOTION_FINALIK_ARMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1F130E40)
#define ROOTMOTION_FINALIK_ARMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1F130E90)
#define ROOTMOTION_FINALIK_ARMIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1F130EF0)
#define ROOTMOTION_FINALIK_ARMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F130DA0)
#define ROOTMOTION_FINALIK_ARMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1F130D50)
#define ROOTMOTION_FINALIK_ARMIK_SETTARGETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1F130EA0)
#define ROOTMOTION_FINALIK_ARMIK_START_OFFSET UNITYSDK_OFFSET(0x1F130EB0)
#define ROOTMOTION_FINALIK_ARMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1F130DF0)
#define ROOTMOTION_FINALIK_ARMIK_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1F1311D0)
#define ROOTMOTION_FINALIK_ARMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1313A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ArmIK_TypeDefinitionIndex = 38994;
