...
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1E44BA70)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_APPLY_OFFSET UNITYSDK_OFFSET(0x1E44B0E0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1E44A560)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_CURVEUSED_OFFSET UNITYSDK_OFFSET(0x1E44AE00)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETMULTIPLIERINDEX_OFFSET UNITYSDK_OFFSET(0x1E44CA30)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGETS_OFFSET UNITYSDK_OFFSET(0x1E44AEB0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGET_1_OFFSET UNITYSDK_OFFSET(0x1E44AEC0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGET_2_OFFSET UNITYSDK_OFFSET(0x1E44B060)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGET_OFFSET UNITYSDK_OFFSET(0x1E44AC50)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1E44C490)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETWEIGHTCURVEINDEX_OFFSET UNITYSDK_OFFSET(0x1E44C440)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_LASTUSEDINTERACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0x1E44A5D0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E44A5B0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1E44AB10)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_TARGETSROOT_OFFSET UNITYSDK_OFFSET(0x1E44A9D0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_INITIATE_OFFSET UNITYSDK_OFFSET(0x1E44A5F0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ONSTARTINTERACTION_OFFSET UNITYSDK_OFFSET(0x1E44B0D0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E44A380)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL1_OFFSET UNITYSDK_OFFSET(0x1E44A3D0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL2_OFFSET UNITYSDK_OFFSET(0x1E44A420)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL3_OFFSET UNITYSDK_OFFSET(0x1E44A470)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL4_OFFSET UNITYSDK_OFFSET(0x1E44A4C0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1E44A330)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_SET_LASTUSEDINTERACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0x1E44A5E0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E44A5C0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_START_OFFSET UNITYSDK_OFFSET(0x1E44CA20)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1E44A510)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E44CA80)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionObject_TypeDefinitionIndex = 38308;
