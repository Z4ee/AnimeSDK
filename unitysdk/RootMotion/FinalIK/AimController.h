...
#define ROOTMOTION_FINALIK_AIMCONTROLLER_APPLYMINDISTANCE_OFFSET UNITYSDK_OFFSET(0x1BD14F90)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_FIXEDLERP_OFFSET UNITYSDK_OFFSET(0x1BD14F40)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1BD12670)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_INNERHANDLETARGETOFFSET_OFFSET UNITYSDK_OFFSET(0x1BD12880)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_INNERUPDATEAIMCOORDINATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1BD12920)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1BD13130)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_ROOTROTATION_OFFSET UNITYSDK_OFFSET(0x1BD15100)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1BD12450)
#define ROOTMOTION_FINALIK_AIMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD15620)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimController_TypeDefinitionIndex = 36684;
