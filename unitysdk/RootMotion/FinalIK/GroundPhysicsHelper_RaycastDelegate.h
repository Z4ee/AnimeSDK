...
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_RAYCASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x85D3F80)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_RAYCASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85D4070)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_RAYCASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x85D1270)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_RAYCASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x85D3F60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundPhysicsHelper_RaycastDelegate_TypeDefinitionIndex = 35177;
