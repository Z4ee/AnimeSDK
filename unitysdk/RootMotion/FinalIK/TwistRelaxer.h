...
#define ROOTMOTION_FINALIK_TWISTRELAXER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1FACD4F0)
#define ROOTMOTION_FINALIK_TWISTRELAXER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1FACD680)
#define ROOTMOTION_FINALIK_TWISTRELAXER_ONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x1FACD360)
#define ROOTMOTION_FINALIK_TWISTRELAXER_START_OFFSET UNITYSDK_OFFSET(0x1FACCF50)
#define ROOTMOTION_FINALIK_TWISTRELAXER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FACD1C0)
#define ROOTMOTION_FINALIK_TWISTRELAXER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FACD850)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int TwistRelaxer_TypeDefinitionIndex = 38984;
