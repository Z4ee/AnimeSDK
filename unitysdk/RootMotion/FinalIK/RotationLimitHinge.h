...
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1E478C70)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_LIMITHINGE_OFFSET UNITYSDK_OFFSET(0x1E478D00)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1E478CC0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E478BD0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1E478B80)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1E478C20)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E479100)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitHinge_TypeDefinitionIndex = 38249;
