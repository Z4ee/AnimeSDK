...
#define ROOTMOTION_FINALIK_IKSOLVERCCD_FADEOUTBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1E632020)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1E6320B0)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E632170)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_SOLVE_OFFSET UNITYSDK_OFFSET(0x1E632610)
#define ROOTMOTION_FINALIK_IKSOLVERCCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6333B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverCCD_TypeDefinitionIndex = 38294;
