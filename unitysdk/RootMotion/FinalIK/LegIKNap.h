...
#define ROOTMOTION_FINALIK_LEGIKNAP_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1F3B3E40)
#define ROOTMOTION_FINALIK_LEGIKNAP_GET__ERRORMSG_OFFSET UNITYSDK_OFFSET(0x1F3B3E70)
#define ROOTMOTION_FINALIK_LEGIKNAP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F3B3E50)
#define ROOTMOTION_FINALIK_LEGIKNAP_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F3B3E20)
#define ROOTMOTION_FINALIK_LEGIKNAP_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1F3B3E30)
#define ROOTMOTION_FINALIK_LEGIKNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3B3ED0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIKNap_TypeDefinitionIndex = 38960;
