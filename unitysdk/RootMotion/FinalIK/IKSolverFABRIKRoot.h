...
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ADDPOINTSTOARRAY_OFFSET UNITYSDK_OFFSET(0x1DAFA000)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DAF95C0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETCENTROID_OFFSET UNITYSDK_OFFSET(0x1DAF9BD0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1DAF9F60)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1DAFA190)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ISROOT_OFFSET UNITYSDK_OFFSET(0x1DAF9890)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DAF8BF0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1DAF9680)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DAF9920)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1DAF94F0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAFA230)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFABRIKRoot_TypeDefinitionIndex = 38127;
