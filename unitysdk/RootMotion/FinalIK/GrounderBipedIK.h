...
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1F3CA620)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ISREADYTOINITIATE_OFFSET UNITYSDK_OFFSET(0x1F3CA430)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F3CB690)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F3CAA60)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONPOSTSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1F3CB3A0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1F3CAAC0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F3CA3A0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1F3CA350)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1F3CA3F0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_SETLEGIK_OFFSET UNITYSDK_OFFSET(0x1F3CB270)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F3CA5C0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3CB910)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderBipedIK_TypeDefinitionIndex = 38786;
