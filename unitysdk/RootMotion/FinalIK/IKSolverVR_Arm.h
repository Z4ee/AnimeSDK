...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1DEF1FB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_DAMPERVALUE_OFFSET UNITYSDK_OFFSET(0x1DEF55C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GETBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x1DEF5680)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_FOREARM_OFFSET UNITYSDK_OFFSET(0x1DEF0680)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_HAND_OFFSET UNITYSDK_OFFSET(0x1DEF06D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DEF05A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1DEF05E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_SHOULDER_OFFSET UNITYSDK_OFFSET(0x1DEF0600)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_UPPERARM_OFFSET UNITYSDK_OFFSET(0x1DEF0640)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_ONREAD_OFFSET UNITYSDK_OFFSET(0x1DEF0720)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1DEF1A00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1DEF6540)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DEF05C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1DEF05F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1DEF2440)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1DEF1FF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1DEF6A00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_WRITE_OFFSET UNITYSDK_OFFSET(0x1DEF6560)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEF6B50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Arm_TypeDefinitionIndex = 38341;
