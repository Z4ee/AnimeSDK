...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1BB88D90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_DAMPERVALUE_OFFSET UNITYSDK_OFFSET(0x1BB8C3A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GETBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x1BB8C460)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_FOREARM_OFFSET UNITYSDK_OFFSET(0x1BB87460)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_HAND_OFFSET UNITYSDK_OFFSET(0x1BB874B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BB87380)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1BB873C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_SHOULDER_OFFSET UNITYSDK_OFFSET(0x1BB873E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_UPPERARM_OFFSET UNITYSDK_OFFSET(0x1BB87420)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_ONREAD_OFFSET UNITYSDK_OFFSET(0x1BB87500)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1BB887E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1BB8D320)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BB873A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1BB873D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1BB89220)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1BB88DD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1BB8D7E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_WRITE_OFFSET UNITYSDK_OFFSET(0x1BB8D340)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8D930)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Arm_TypeDefinitionIndex = 36635;
