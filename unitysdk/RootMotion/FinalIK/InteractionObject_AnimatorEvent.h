...
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_1_OFFSET UNITYSDK_OFFSET(0x1C3A3A60)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_2_OFFSET UNITYSDK_OFFSET(0x1C3A3B40)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1C3A3810)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3A3C40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionObject_AnimatorEvent_TypeDefinitionIndex = 36654;
