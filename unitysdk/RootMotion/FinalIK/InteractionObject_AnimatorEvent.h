...
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_1_OFFSET UNITYSDK_OFFSET(0x1E6E86C0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_2_OFFSET UNITYSDK_OFFSET(0x1E6E87A0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E6E8470)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E88A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionObject_AnimatorEvent_TypeDefinitionIndex = 38314;
