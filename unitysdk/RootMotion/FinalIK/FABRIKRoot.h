...
#define ROOTMOTION_FINALIK_FABRIKROOT_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1E669AF0)
#define ROOTMOTION_FINALIK_FABRIKROOT_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1E669B40)
#define ROOTMOTION_FINALIK_FABRIKROOT_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E669A50)
#define ROOTMOTION_FINALIK_FABRIKROOT_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1E669A00)
#define ROOTMOTION_FINALIK_FABRIKROOT_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1E669AA0)
#define ROOTMOTION_FINALIK_FABRIKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E669B50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIKRoot_TypeDefinitionIndex = 38180;
