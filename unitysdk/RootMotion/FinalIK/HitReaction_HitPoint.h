...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_APPLY_OFFSET UNITYSDK_OFFSET(0x1BF84EB0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_CROSSFADER_OFFSET UNITYSDK_OFFSET(0x1BF84D50)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_FORCE_OFFSET UNITYSDK_OFFSET(0x1BF84D90)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_INPROGRESS_OFFSET UNITYSDK_OFFSET(0x1BF84D40)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_TIMER_OFFSET UNITYSDK_OFFSET(0x1BF84D70)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_HIT_OFFSET UNITYSDK_OFFSET(0x1BF84DC0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_CROSSFADER_OFFSET UNITYSDK_OFFSET(0x1BF84D60)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_FORCE_OFFSET UNITYSDK_OFFSET(0x1BF84DB0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_TIMER_OFFSET UNITYSDK_OFFSET(0x1BF84D80)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF84F90)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPoint_TypeDefinitionIndex = 36697;
