...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_APPLY_OFFSET UNITYSDK_OFFSET(0x1E2B8070)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_CROSSFADER_OFFSET UNITYSDK_OFFSET(0x1E2B7F10)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_FORCE_OFFSET UNITYSDK_OFFSET(0x1E2B7F50)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_INPROGRESS_OFFSET UNITYSDK_OFFSET(0x1E2B7F00)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_TIMER_OFFSET UNITYSDK_OFFSET(0x1E2B7F30)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_HIT_OFFSET UNITYSDK_OFFSET(0x1E2B7F80)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_CROSSFADER_OFFSET UNITYSDK_OFFSET(0x1E2B7F20)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_FORCE_OFFSET UNITYSDK_OFFSET(0x1E2B7F70)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_TIMER_OFFSET UNITYSDK_OFFSET(0x1E2B7F40)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2B8150)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPoint_TypeDefinitionIndex = 38184;
