...
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1EE56370)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_CALIBRATE_1_OFFSET UNITYSDK_OFFSET(0x1EE56A70)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_CALIBRATE_OFFSET UNITYSDK_OFFSET(0x1EE564A0)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_GET_PELVISTARGETRIGHT_OFFSET UNITYSDK_OFFSET(0x1EE56340)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EE578F0)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_ONPREUPDATE_OFFSET UNITYSDK_OFFSET(0x1EE56D50)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_SET_PELVISTARGETRIGHT_OFFSET UNITYSDK_OFFSET(0x1EE56360)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE57AB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKRootController_TypeDefinitionIndex = 38955;
