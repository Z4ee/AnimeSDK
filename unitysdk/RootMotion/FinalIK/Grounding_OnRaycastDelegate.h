...
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F131E20)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F131F20)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F131760)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F131740)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnRaycastDelegate_TypeDefinitionIndex = 38812;
