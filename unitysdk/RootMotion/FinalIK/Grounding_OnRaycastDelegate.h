...
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD29C10)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD29D10)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD294D0)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD294B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnRaycastDelegate_TypeDefinitionIndex = 38202;
