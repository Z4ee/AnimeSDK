...
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_ADDBONE_OFFSET UNITYSDK_OFFSET(0x1E06AB60)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_APPLYTOREALTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E06BC20)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_DEBUGDRAWVIRTUALBONE_OFFSET UNITYSDK_OFFSET(0x1E06CA20)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1E06CAF0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_FINDBONE_OFFSET UNITYSDK_OFFSET(0x1E06ACC0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1E06AB50)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_INITHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1E06AD60)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_SYNCANIMATIONTOVIRTUALBONES_OFFSET UNITYSDK_OFFSET(0x1E06BE80)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_UPDATEBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E06B060)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_UPDATESOLVERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E06B360)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E06CB20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBoneHierarchy_TypeDefinitionIndex = 38210;
	...
	public:
		...
		::System::Boolean debugDrawGizmos; // 0x18
		::System::Single gizmoSize; // 0x1C
