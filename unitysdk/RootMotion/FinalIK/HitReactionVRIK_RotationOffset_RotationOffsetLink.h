...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1E2B8160)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1E2B8260)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2B8270)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_RotationOffset_RotationOffsetLink_TypeDefinitionIndex = 38153;
