...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1BF84FA0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1BF850A0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF850B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_RotationOffset_RotationOffsetLink_TypeDefinitionIndex = 36707;
