...
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_ASSIGNREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B6753F0)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_IKSOLVERS_OFFSET UNITYSDK_OFFSET(0x1B675020)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_LIMBS_OFFSET UNITYSDK_OFFSET(0x1B674DB0)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6756D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BipedIKSolvers_TypeDefinitionIndex = 36551;
