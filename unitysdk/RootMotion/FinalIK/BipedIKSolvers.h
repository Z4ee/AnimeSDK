...
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_ASSIGNREFERENCES_OFFSET UNITYSDK_OFFSET(0x1DA741C0)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_IKSOLVERS_OFFSET UNITYSDK_OFFSET(0x1DA73DF0)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_LIMBS_OFFSET UNITYSDK_OFFSET(0x1DA73B80)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA744A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BipedIKSolvers_TypeDefinitionIndex = 38191;
