...
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1178E0)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C117A00)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1171F0)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1171E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnSphereCastDelegate_TypeDefinitionIndex = 36574;
