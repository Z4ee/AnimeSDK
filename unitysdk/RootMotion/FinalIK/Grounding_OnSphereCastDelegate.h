...
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F883980)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F883AA0)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F883270)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F883250)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnSphereCastDelegate_TypeDefinitionIndex = 38817;
