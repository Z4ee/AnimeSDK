...
#define ROOTMOTION_FINALIK_RECOIL_AFTERAIMIK_OFFSET UNITYSDK_OFFSET(0x1B68A6B0)
#define ROOTMOTION_FINALIK_RECOIL_AFTERFBBIK_OFFSET UNITYSDK_OFFSET(0x1B68A380)
#define ROOTMOTION_FINALIK_RECOIL_FIRE_OFFSET UNITYSDK_OFFSET(0x1B688480)
#define ROOTMOTION_FINALIK_RECOIL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B688440)
#define ROOTMOTION_FINALIK_RECOIL_GET_PRIMARYHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1B68A240)
#define ROOTMOTION_FINALIK_RECOIL_GET_PRIMARYHAND_OFFSET UNITYSDK_OFFSET(0x1B68A0E0)
#define ROOTMOTION_FINALIK_RECOIL_GET_SECONDARYHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1B68A2E0)
#define ROOTMOTION_FINALIK_RECOIL_GET_SECONDARYHAND_OFFSET UNITYSDK_OFFSET(0x1B68A190)
#define ROOTMOTION_FINALIK_RECOIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B68A8A0)
#define ROOTMOTION_FINALIK_RECOIL_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1B6886E0)
#define ROOTMOTION_FINALIK_RECOIL_SETHANDROTATIONS_OFFSET UNITYSDK_OFFSET(0x1B688460)
#define ROOTMOTION_FINALIK_RECOIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68ABF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Recoil_TypeDefinitionIndex = 36723;
