...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_DIRECTION3D_OFFSET UNITYSDK_OFFSET(0x1E0138E0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_OFFSET3D_OFFSET UNITYSDK_OFFSET(0x1E0138C0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1E013A60)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E014900)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CharacterPosition_TypeDefinitionIndex = 38118;
