...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_DIRECTION3D_OFFSET UNITYSDK_OFFSET(0x1BCAF110)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_OFFSET3D_OFFSET UNITYSDK_OFFSET(0x1BCAF0F0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1BCAF290)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB0130)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CharacterPosition_TypeDefinitionIndex = 36665;
