...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_DOSOLVE_OFFSET UNITYSDK_OFFSET(0xAA9160)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0xAA91B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAA9150)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TrigonometricContext_TypeDefinitionIndex = 38829;
