...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_DOSOLVE_OFFSET UNITYSDK_OFFSET(0xA58590)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0xA585E0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA58580)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TrigonometricContext_TypeDefinitionIndex = 38114;
