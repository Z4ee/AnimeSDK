...
#define ROOTMOTION_FINALIK_HITREACTION_GET_INPROGRESS_OFFSET UNITYSDK_OFFSET(0x1E6E49C0)
#define ROOTMOTION_FINALIK_HITREACTION_HIT_OFFSET UNITYSDK_OFFSET(0x1E6E4D10)
#define ROOTMOTION_FINALIK_HITREACTION_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1E6E4A70)
#define ROOTMOTION_FINALIK_HITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E5110)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_TypeDefinitionIndex = 38181;
