...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1E631860)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E631620)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1E6318D0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E631D10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_PositionOffset_TypeDefinitionIndex = 38155;
