...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1C2DFFA0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C2DFD60)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1C2E0010)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E0450)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_PositionOffset_TypeDefinitionIndex = 36704;
