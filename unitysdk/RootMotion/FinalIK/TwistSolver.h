...
#define ROOTMOTION_FINALIK_TWISTSOLVER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B9A8D90)
#define ROOTMOTION_FINALIK_TWISTSOLVER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B9A8080)
#define ROOTMOTION_FINALIK_TWISTSOLVER_RELAX_OFFSET UNITYSDK_OFFSET(0x1B9A8E70)
#define ROOTMOTION_FINALIK_TWISTSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7FF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int TwistSolver_TypeDefinitionIndex = 36648;
