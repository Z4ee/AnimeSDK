...
#define ROOTMOTION_FINALIK_IKSOLVER_NODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3A0530)
#define ROOTMOTION_FINALIK_IKSOLVER_NODE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C3A0550)
#define ROOTMOTION_FINALIK_IKSOLVER_NODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3A0510)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolver_Node_TypeDefinitionIndex = 36610;
