...
#define ROOTMOTION_FINALIK_IKSOLVER_NODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x85EC970)
#define ROOTMOTION_FINALIK_IKSOLVER_NODE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x85EC990)
#define ROOTMOTION_FINALIK_IKSOLVER_NODE__CTOR_OFFSET UNITYSDK_OFFSET(0x85EC950)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolver_Node_TypeDefinitionIndex = 35206;
