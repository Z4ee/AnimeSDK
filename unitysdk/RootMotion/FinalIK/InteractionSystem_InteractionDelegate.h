...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9A73C0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9A7440)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9A7070)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7060)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionDelegate_TypeDefinitionIndex = 36659;
