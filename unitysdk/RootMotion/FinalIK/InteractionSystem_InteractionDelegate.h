...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD2F2E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD2F360)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD2EF90)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2EF70)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionDelegate_TypeDefinitionIndex = 38170;
