...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETBENDDIRECTION_OFFSET UNITYSDK_OFFSET(0x2A720)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETMODIFIEDBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x2A7A0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GET_AXISDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x2A7C0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_MAINTAINBEND_OFFSET UNITYSDK_OFFSET(0x2A7E0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONPOSTUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x2A600)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x2A5F0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_SOLVE_OFFSET UNITYSDK_OFFSET(0x2A5E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderIKThreadSolver_Limb_TypeDefinitionIndex = 41012;
	...
	struct alignas(8) GrounderIKThreadSolver_Limb
	{
		...
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::UnityEngine::Vector3, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETBENDDIRECTION_OFFSET))(this, IKPosition, bendNormal);
		}
