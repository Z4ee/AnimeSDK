...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETBENDDIRECTION_OFFSET UNITYSDK_OFFSET(0x3AFA2F0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETMODIFIEDBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x3AFA340)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GET_AXISDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x3AFA360)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_MAINTAINBEND_OFFSET UNITYSDK_OFFSET(0x3AFA380)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONPOSTUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x3AFA2E0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x3AFA2D0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_SOLVE_OFFSET UNITYSDK_OFFSET(0x3AFA2C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderIKThreadSolver_Limb_TypeDefinitionIndex = 44858;
