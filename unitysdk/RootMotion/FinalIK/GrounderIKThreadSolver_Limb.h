...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETBENDDIRECTION_OFFSET UNITYSDK_OFFSET(0x2D8F0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETMODIFIEDBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x2D940)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GET_AXISDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x2D960)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_MAINTAINBEND_OFFSET UNITYSDK_OFFSET(0x2D980)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONPOSTUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x2D8E0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x2D8D0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_SOLVE_OFFSET UNITYSDK_OFFSET(0x2D8C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderIKThreadSolver_Limb_TypeDefinitionIndex = 41815;
