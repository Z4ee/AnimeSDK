...
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1925D440)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1925D550)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1925C0F0)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1925D3D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundPhysicsHelper_SphereCastDelegate_TypeDefinitionIndex = 42668;
