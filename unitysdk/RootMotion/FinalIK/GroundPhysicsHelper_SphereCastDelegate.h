...
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA257740)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA257850)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA2563F0)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_SPHERECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA2576D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundPhysicsHelper_SphereCastDelegate_TypeDefinitionIndex = 41807;
