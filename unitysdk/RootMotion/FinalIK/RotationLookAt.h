...
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_APPLY_OFFSET UNITYSDK_OFFSET(0x1F429C10)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1F4297D0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_FIXDIR_OFFSET UNITYSDK_OFFSET(0x1F429DC0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1F42B010)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1F42B030)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHDOWN_OFFSET UNITYSDK_OFFSET(0x1F429740)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHUP_OFFSET UNITYSDK_OFFSET(0x1F429710)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWLEFT_OFFSET UNITYSDK_OFFSET(0x1F4297A0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWRIGHT_OFFSET UNITYSDK_OFFSET(0x1F429770)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_RECORD_OFFSET UNITYSDK_OFFSET(0x1F429940)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_START_OFFSET UNITYSDK_OFFSET(0x1F429930)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F42B080)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLookAt_TypeDefinitionIndex = 38925;
