...
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_APPLY_OFFSET UNITYSDK_OFFSET(0x1BD1B5A0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BD1B140)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_FIXDIR_OFFSET UNITYSDK_OFFSET(0x1BD1B750)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1BD1CA30)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1BD1CA50)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHDOWN_OFFSET UNITYSDK_OFFSET(0x1BD1B0B0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHUP_OFFSET UNITYSDK_OFFSET(0x1BD1B080)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWLEFT_OFFSET UNITYSDK_OFFSET(0x1BD1B110)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWRIGHT_OFFSET UNITYSDK_OFFSET(0x1BD1B0E0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_RECORD_OFFSET UNITYSDK_OFFSET(0x1BD1B2C0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_START_OFFSET UNITYSDK_OFFSET(0x1BD1B2B0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD1CAA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLookAt_TypeDefinitionIndex = 36646;
