...
#define ROOTMOTION_FINALIK_EDITORIKPOSE_GET_POSESTORED_OFFSET UNITYSDK_OFFSET(0x1F8827C0)
#define ROOTMOTION_FINALIK_EDITORIKPOSE_RESTORE_OFFSET UNITYSDK_OFFSET(0x1F8829C0)
#define ROOTMOTION_FINALIK_EDITORIKPOSE_STORE_OFFSET UNITYSDK_OFFSET(0x1F8827E0)
#define ROOTMOTION_FINALIK_EDITORIKPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F882BB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int EditorIKPose_TypeDefinitionIndex = 39011;
