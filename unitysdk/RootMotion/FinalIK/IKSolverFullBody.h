...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1BB87070)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BB86320)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAINANDNODEINDEXES_OFFSET UNITYSDK_OFFSET(0x1BB859D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAININDEX_OFFSET UNITYSDK_OFFSET(0x1BB85810)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1BB857C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1BB856D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETNODE_OFFSET UNITYSDK_OFFSET(0x1BB85960)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1BB85A50)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1BB85CB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BB85E90)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1BB86470)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BB866C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_READPOSE_OFFSET UNITYSDK_OFFSET(0x1BB86860)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_SOLVE_OFFSET UNITYSDK_OFFSET(0x1BB86BD0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1BB86160)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1BB870C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB872C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 36618;
