...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1F2ED330)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1F2EC5E0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAINANDNODEINDEXES_OFFSET UNITYSDK_OFFSET(0x1F2EBCB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAININDEX_OFFSET UNITYSDK_OFFSET(0x1F2EBAF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1F2EBAA0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F2EB9A0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETNODE_OFFSET UNITYSDK_OFFSET(0x1F2EBC40)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1F2EBD30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1F2EBF80)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ISVALID_OFFSET UNITYSDK_OFFSET(0x1F2EC140)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1F2EC730)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F2EC980)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_READPOSE_OFFSET UNITYSDK_OFFSET(0x1F2ECB20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_SOLVE_OFFSET UNITYSDK_OFFSET(0x1F2ECE90)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1F2EC410)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1F2ED380)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2ED580)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 38848;
