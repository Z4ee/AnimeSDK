...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_SOLVE_OFFSET UNITYSDK_OFFSET(0x39D0420)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER__POSTSOLVE_OFFSET UNITYSDK_OFFSET(0x39D04B0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER__PRESOLVE_OFFSET UNITYSDK_OFFSET(0x39D04A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderIKThreadSolver_TypeDefinitionIndex = 42682;
