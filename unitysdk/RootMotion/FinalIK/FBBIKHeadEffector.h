...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_CCDPASS_OFFSET UNITYSDK_OFFSET(0x1DEA81B0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_CHESTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1DEA7590)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ITERATE_OFFSET UNITYSDK_OFFSET(0x1DEA8790)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_LERPSOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1DEA9750)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DEAA110)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DEA6280)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x1DEA9850)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONPREREAD_OFFSET UNITYSDK_OFFSET(0x1DEA6AF0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONSTOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1DEA5870)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_POSTSTRETCHING_OFFSET UNITYSDK_OFFSET(0x1DEA9C10)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_SOLVE_OFFSET UNITYSDK_OFFSET(0x1DEA9660)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_SPINEBEND_OFFSET UNITYSDK_OFFSET(0x1DEA7B80)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_START_OFFSET UNITYSDK_OFFSET(0x1DEA53B0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAA560)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_TypeDefinitionIndex = 38226;
