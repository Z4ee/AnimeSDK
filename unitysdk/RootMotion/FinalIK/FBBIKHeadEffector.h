...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_CCDPASS_OFFSET UNITYSDK_OFFSET(0x1BB2E870)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_CHESTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1BB2DC50)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ITERATE_OFFSET UNITYSDK_OFFSET(0x1BB2EE50)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_LERPSOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1BB2FE10)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BB307D0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BB2C940)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x1BB2FF10)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONPREREAD_OFFSET UNITYSDK_OFFSET(0x1BB2D1B0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONSTOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1BB2BF30)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_POSTSTRETCHING_OFFSET UNITYSDK_OFFSET(0x1BB302D0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_SOLVE_OFFSET UNITYSDK_OFFSET(0x1BB2FD20)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_SPINEBEND_OFFSET UNITYSDK_OFFSET(0x1BB2E240)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_START_OFFSET UNITYSDK_OFFSET(0x1BB2BA80)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB30C20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_TypeDefinitionIndex = 36594;
