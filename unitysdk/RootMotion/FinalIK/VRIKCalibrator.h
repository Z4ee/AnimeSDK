...
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEBODY_OFFSET UNITYSDK_OFFSET(0x1F141E50)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHANDS_OFFSET UNITYSDK_OFFSET(0x1F1419F0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHAND_OFFSET UNITYSDK_OFFSET(0x1F142440)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHEAD_OFFSET UNITYSDK_OFFSET(0x1F140A00)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATELEG_1_OFFSET UNITYSDK_OFFSET(0x1F140320)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATELEG_OFFSET UNITYSDK_OFFSET(0x1F13D4A0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1F139D20)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATESCALE_OFFSET UNITYSDK_OFFSET(0x1F139F20)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_1_OFFSET UNITYSDK_OFFSET(0x1F13E430)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_2_OFFSET UNITYSDK_OFFSET(0x1F140790)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_OFFSET UNITYSDK_OFFSET(0x1F139F40)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_GUESSPALMTOTHUMBAXIS_OFFSET UNITYSDK_OFFSET(0x1F143140)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_GUESSWRISTTOPALMAXIS_OFFSET UNITYSDK_OFFSET(0x1F142DF0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_RECALIBRATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1F139CA0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_RECALIBRATESCALE_OFFSET UNITYSDK_OFFSET(0x1F139C20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKCalibrator_TypeDefinitionIndex = 38867;
