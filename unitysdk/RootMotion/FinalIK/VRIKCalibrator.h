...
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEBODY_OFFSET UNITYSDK_OFFSET(0x1B9B1C40)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHANDS_OFFSET UNITYSDK_OFFSET(0x1B9B17E0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHAND_OFFSET UNITYSDK_OFFSET(0x1B9B2220)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHEAD_OFFSET UNITYSDK_OFFSET(0x1B9B08A0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATELEG_1_OFFSET UNITYSDK_OFFSET(0x1B9B01C0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATELEG_OFFSET UNITYSDK_OFFSET(0x1B9AD320)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1B9A9B90)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATESCALE_OFFSET UNITYSDK_OFFSET(0x1B9A9D90)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_1_OFFSET UNITYSDK_OFFSET(0x1B9AE200)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_2_OFFSET UNITYSDK_OFFSET(0x1B9B0630)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_OFFSET UNITYSDK_OFFSET(0x1B9A9DB0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_GUESSPALMTOTHUMBAXIS_OFFSET UNITYSDK_OFFSET(0x1B9B2F00)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_GUESSWRISTTOPALMAXIS_OFFSET UNITYSDK_OFFSET(0x1B9B2B80)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_RECALIBRATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1B9A9B10)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_RECALIBRATESCALE_OFFSET UNITYSDK_OFFSET(0x1B9A9A90)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKCalibrator_TypeDefinitionIndex = 36728;
