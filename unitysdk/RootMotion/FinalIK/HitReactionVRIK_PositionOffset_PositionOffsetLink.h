...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_POSITIONOFFSETLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1DA747D0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_POSITIONOFFSETLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1DA74A90)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_POSITIONOFFSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA74AA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_PositionOffset_PositionOffsetLink_TypeDefinitionIndex = 38156;
