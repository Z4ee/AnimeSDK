...
#define ROOTMOTION_FINALIK_IKSOLVERARM_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DA76380)
#define ROOTMOTION_FINALIK_IKSOLVERARM_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1DA75C90)
#define ROOTMOTION_FINALIK_IKSOLVERARM_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1DA75F60)
#define ROOTMOTION_FINALIK_IKSOLVERARM_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DA752E0)
#define ROOTMOTION_FINALIK_IKSOLVERARM_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1DA76400)
#define ROOTMOTION_FINALIK_IKSOLVERARM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DA76C10)
#define ROOTMOTION_FINALIK_IKSOLVERARM_READ_OFFSET UNITYSDK_OFFSET(0x1DA764B0)
#define ROOTMOTION_FINALIK_IKSOLVERARM_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1DA75C00)
#define ROOTMOTION_FINALIK_IKSOLVERARM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1DA76C40)
#define ROOTMOTION_FINALIK_IKSOLVERARM_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1DA76130)
#define ROOTMOTION_FINALIK_IKSOLVERARM_WRITE_OFFSET UNITYSDK_OFFSET(0x1DA76D00)
#define ROOTMOTION_FINALIK_IKSOLVERARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA76FC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverArm_TypeDefinitionIndex = 38282;
