...
#define ROOTMOTION_FINALIK_IKSOLVERLEG_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E449470)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1E448D80)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1E449050)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E4483D0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1E4494F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E449D00)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_READ_OFFSET UNITYSDK_OFFSET(0x1E4495A0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1E448CF0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1E449D30)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E449220)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1E449E40)
#define ROOTMOTION_FINALIK_IKSOLVERLEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E44A100)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLeg_TypeDefinitionIndex = 38290;
