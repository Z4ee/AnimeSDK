...
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1C142460)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1C1423F0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1C142420)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1C142440)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1C142410)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1C142430)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1C142450)
#define ROOTMOTION_FINALIK_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C142470)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBone_TypeDefinitionIndex = 36735;
