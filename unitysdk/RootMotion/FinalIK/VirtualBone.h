...
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1E4791F0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1E479180)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1E4791B0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E4791D0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1E4791A0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1E4791C0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E4791E0)
#define ROOTMOTION_FINALIK_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E479200)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBone_TypeDefinitionIndex = 38252;
