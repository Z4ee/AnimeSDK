...
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2573E0)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA257510)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA256AF0)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA257370)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundPhysicsHelper_CapsuleCastDelegate_TypeDefinitionIndex = 41808;
