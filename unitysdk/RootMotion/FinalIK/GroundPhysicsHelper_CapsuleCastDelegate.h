...
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1925D0E0)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1925D210)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1925C7F0)
#define ROOTMOTION_FINALIK_GROUNDPHYSICSHELPER_CAPSULECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1925D070)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundPhysicsHelper_CapsuleCastDelegate_TypeDefinitionIndex = 42669;
