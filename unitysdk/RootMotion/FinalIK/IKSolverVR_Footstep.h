...
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_ISSTEPPING_OFFSET UNITYSDK_OFFSET(0x1E526740)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1E526750)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_RESET_OFFSET UNITYSDK_OFFSET(0x1E526900)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_SET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1E526760)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_STEPTO_OFFSET UNITYSDK_OFFSET(0x1E526940)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTANDING_OFFSET UNITYSDK_OFFSET(0x1E526D00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTEPPING_OFFSET UNITYSDK_OFFSET(0x1E526B00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E526F80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E526770)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Footstep_TypeDefinitionIndex = 38340;
