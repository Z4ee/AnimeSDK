...
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_ISSTEPPING_OFFSET UNITYSDK_OFFSET(0x1F921B50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1F921B60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_RESET_OFFSET UNITYSDK_OFFSET(0x1F921D10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_SET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1F921B70)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_STEPTO_OFFSET UNITYSDK_OFFSET(0x1F921D50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTANDING_OFFSET UNITYSDK_OFFSET(0x1F922100)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTEPPING_OFFSET UNITYSDK_OFFSET(0x1F921F00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F922380)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F921B80)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Footstep_TypeDefinitionIndex = 38952;
