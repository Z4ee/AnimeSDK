...
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_ADJUSTCHESTBYHANDS_OFFSET UNITYSDK_OFFSET(0x1BCABBC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1BCAABB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_BEND_1_OFFSET UNITYSDK_OFFSET(0x1BCADA30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_BEND_OFFSET UNITYSDK_OFFSET(0x1BCADFB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_CALCULATECHESTTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1BCAB6C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_FABRIKPASS_OFFSET UNITYSDK_OFFSET(0x1BCAD790)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_ANCHORRELATIVETOHEAD_OFFSET UNITYSDK_OFFSET(0x1BCA8970)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_ANCHORROTATION_OFFSET UNITYSDK_OFFSET(0x1BCA8950)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_CHEST_OFFSET UNITYSDK_OFFSET(0x1BCA8860)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_FIRSTSPINEBONE_OFFSET UNITYSDK_OFFSET(0x1BCA8820)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_HEAD_OFFSET UNITYSDK_OFFSET(0x1BCA88D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_NECK_OFFSET UNITYSDK_OFFSET(0x1BCA8910)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_PELVIS_OFFSET UNITYSDK_OFFSET(0x1BCA87E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_INVERSETRANSLATETOHEAD_OFFSET UNITYSDK_OFFSET(0x1BCADE60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_LIMITPELVISPOSITION_OFFSET UNITYSDK_OFFSET(0x1BCAEB90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_ONREAD_OFFSET UNITYSDK_OFFSET(0x1BCA8990)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1BCA9DE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1BCAEB10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SET_ANCHORRELATIVETOHEAD_OFFSET UNITYSDK_OFFSET(0x1BCA8980)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SET_ANCHORROTATION_OFFSET UNITYSDK_OFFSET(0x1BCA8960)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SOLVEPELVIS_OFFSET UNITYSDK_OFFSET(0x1BCAE300)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SOLVE_OFFSET UNITYSDK_OFFSET(0x1BCAC290)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_TRANSLATEPELVIS_OFFSET UNITYSDK_OFFSET(0x1BCACF30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_WRITE_OFFSET UNITYSDK_OFFSET(0x1BCAE7E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCAEFA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Spine_TypeDefinitionIndex = 36642;
