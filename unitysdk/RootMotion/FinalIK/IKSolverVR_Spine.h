...
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_ADJUSTCHESTBYHANDS_OFFSET UNITYSDK_OFFSET(0x1E010390)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1E00F380)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_BEND_1_OFFSET UNITYSDK_OFFSET(0x1E012200)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_BEND_OFFSET UNITYSDK_OFFSET(0x1E012780)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_CALCULATECHESTTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1E00FE90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_FABRIKPASS_OFFSET UNITYSDK_OFFSET(0x1E011F60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_ANCHORRELATIVETOHEAD_OFFSET UNITYSDK_OFFSET(0x1E00D140)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_ANCHORROTATION_OFFSET UNITYSDK_OFFSET(0x1E00D120)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_CHEST_OFFSET UNITYSDK_OFFSET(0x1E00D030)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_FIRSTSPINEBONE_OFFSET UNITYSDK_OFFSET(0x1E00CFF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_HEAD_OFFSET UNITYSDK_OFFSET(0x1E00D0A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_NECK_OFFSET UNITYSDK_OFFSET(0x1E00D0E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_PELVIS_OFFSET UNITYSDK_OFFSET(0x1E00CFB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_INVERSETRANSLATETOHEAD_OFFSET UNITYSDK_OFFSET(0x1E012630)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_LIMITPELVISPOSITION_OFFSET UNITYSDK_OFFSET(0x1E013360)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_ONREAD_OFFSET UNITYSDK_OFFSET(0x1E00D160)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1E00E5B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1E0132E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SET_ANCHORRELATIVETOHEAD_OFFSET UNITYSDK_OFFSET(0x1E00D150)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SET_ANCHORROTATION_OFFSET UNITYSDK_OFFSET(0x1E00D130)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SOLVEPELVIS_OFFSET UNITYSDK_OFFSET(0x1E012AD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SOLVE_OFFSET UNITYSDK_OFFSET(0x1E010A60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_TRANSLATEPELVIS_OFFSET UNITYSDK_OFFSET(0x1E011700)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_WRITE_OFFSET UNITYSDK_OFFSET(0x1E012FB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E013770)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Spine_TypeDefinitionIndex = 38333;
