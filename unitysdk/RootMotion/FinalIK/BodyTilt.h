...
#define ROOTMOTION_FINALIK_BODYTILT_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1F424050)
#define ROOTMOTION_FINALIK_BODYTILT_START_OFFSET UNITYSDK_OFFSET(0x1F423EF0)
#define ROOTMOTION_FINALIK_BODYTILT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4244A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BodyTilt_TypeDefinitionIndex = 38884;
