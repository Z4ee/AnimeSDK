...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1DD29D40)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1DD29DF0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD29E00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointEffector_EffectorLink_TypeDefinitionIndex = 38186;
