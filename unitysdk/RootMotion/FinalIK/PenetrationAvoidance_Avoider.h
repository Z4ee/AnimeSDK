...
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_GETOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0x1E66DC10)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1E66DDA0)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_SOLVE_OFFSET UNITYSDK_OFFSET(0x1E66DA10)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E66E380)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int PenetrationAvoidance_Avoider_TypeDefinitionIndex = 38136;
