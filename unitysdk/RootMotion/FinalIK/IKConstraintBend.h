...
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GETDIR_OFFSET UNITYSDK_OFFSET(0x1BD17570)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1BD162B0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_INITIATE_OFFSET UNITYSDK_OFFSET(0x1BD16330)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BD15E70)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_LIMITBEND_OFFSET UNITYSDK_OFFSET(0x1BD16E30)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOBONE1_OFFSET UNITYSDK_OFFSET(0x1BD16AD0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOLIMB_OFFSET UNITYSDK_OFFSET(0x1BD16A10)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETBONES_OFFSET UNITYSDK_OFFSET(0x1BD16320)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1BD16B90)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1BD162C0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD162F0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD162D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 36599;
