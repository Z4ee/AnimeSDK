...
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GETDIR_OFFSET UNITYSDK_OFFSET(0x1E065530)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1E064270)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_INITIATE_OFFSET UNITYSDK_OFFSET(0x1E0642F0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E063E30)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_LIMITBEND_OFFSET UNITYSDK_OFFSET(0x1E064DF0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOBONE1_OFFSET UNITYSDK_OFFSET(0x1E064A90)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOLIMB_OFFSET UNITYSDK_OFFSET(0x1E0649D0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETBONES_OFFSET UNITYSDK_OFFSET(0x1E0642E0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1E064B50)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1E064280)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E0642B0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1E064290)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 38126;
