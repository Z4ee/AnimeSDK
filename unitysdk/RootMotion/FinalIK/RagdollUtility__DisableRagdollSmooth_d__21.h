...
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__DISABLERAGDOLLSMOOTH_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BE22370)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__DISABLERAGDOLLSMOOTH_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BE226C0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__DISABLERAGDOLLSMOOTH_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BE22720)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__DISABLERAGDOLLSMOOTH_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BE226D0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__DISABLERAGDOLLSMOOTH_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BE22360)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__DISABLERAGDOLLSMOOTH_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE22350)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RagdollUtility__DisableRagdollSmooth_d__21_TypeDefinitionIndex = 36676;
