...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEISVALID_OFFSET UNITYSDK_OFFSET(0x1DA74AD0)
#define ROOTMOTION_FINALIK_IKMAPPING_INITIATE_OFFSET UNITYSDK_OFFSET(0x1DA74AC0)
#define ROOTMOTION_FINALIK_IKMAPPING_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DA74AB0)
#define ROOTMOTION_FINALIK_IKMAPPING_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1DA751E0)
#define ROOTMOTION_FINALIK_IKMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA752D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_TypeDefinitionIndex = 38193;
