...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEISVALID_OFFSET UNITYSDK_OFFSET(0x1B675D00)
#define ROOTMOTION_FINALIK_IKMAPPING_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B675CF0)
#define ROOTMOTION_FINALIK_IKMAPPING_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B675CE0)
#define ROOTMOTION_FINALIK_IKMAPPING_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1B676410)
#define ROOTMOTION_FINALIK_IKMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B676500)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_TypeDefinitionIndex = 36601;
