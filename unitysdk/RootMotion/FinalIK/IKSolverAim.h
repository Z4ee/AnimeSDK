...
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GETANGLE_OFFSET UNITYSDK_OFFSET(0x1F297270)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GETCLAMPEDIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1F298CE0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_ALLOWCOMMONPARENT_OFFSET UNITYSDK_OFFSET(0x1F297260)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_LOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1F2994F0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_MINBONES_OFFSET UNITYSDK_OFFSET(0x1F299A10)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_TRANSFORMAXIS_OFFSET UNITYSDK_OFFSET(0x1F2974E0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_TRANSFORMPOLEAXIS_OFFSET UNITYSDK_OFFSET(0x1F297640)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1F2977A0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1F297FE0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ROTATETOTARGETVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1F29A850)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ROTATETOTARGET_OFFSET UNITYSDK_OFFSET(0x1F299A20)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_SOLVEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1F299700)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1F299900)
#define ROOTMOTION_FINALIK_IKSOLVERAIM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F29B3B0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F29B290)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverAim_TypeDefinitionIndex = 38991;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(IKSolverAim_TypeDefinitionIndex)->GetStaticField(0x2A850);
		}
