...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BF861B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETLEGTRSLIST_OFFSET UNITYSDK_OFFSET(0x1BF858A0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1BF85600)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1BF855B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF87C30)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXROTATION_OFFSET UNITYSDK_OFFSET(0x1BF87B40)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_BANFIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BF853D0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1BF85350)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF85390)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1BF85330)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1BF85310)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET__NOTTRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1BF853E0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BF85D30)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONENABLED_OFFSET UNITYSDK_OFFSET(0x1BF853F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1BF86770)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1BF86D90)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1BF85370)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF853B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1BF85340)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1BF85320)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1BF864F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF87CA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TypeDefinitionIndex = 36625;
