...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E2B9370)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETLEGTRSLIST_OFFSET UNITYSDK_OFFSET(0x1E2B8A60)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1E2B87C0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1E2B8770)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXPOSITION_OFFSET UNITYSDK_OFFSET(0x1E2BADF0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXROTATION_OFFSET UNITYSDK_OFFSET(0x1E2BAD00)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_BANFIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E2B8590)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1E2B8510)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1E2B8550)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1E2B84F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1E2B84D0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET__NOTTRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1E2B85A0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E2B8EF0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONENABLED_OFFSET UNITYSDK_OFFSET(0x1E2B85B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1E2B9930)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E2B9F50)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1E2B8530)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1E2B8570)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1E2B8500)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1E2B84E0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E2B96B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2BAE60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TypeDefinitionIndex = 38113;
