...
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1DD2CE60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD2CDF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD2C9C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0x1DD2E1C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1DD2AA70)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1DD2AAB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_CALF_OFFSET UNITYSDK_OFFSET(0x1DD2A920)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_FOOT_OFFSET UNITYSDK_OFFSET(0x1DD2A960)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1DD2A8C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_LASTBONE_OFFSET UNITYSDK_OFFSET(0x1DD2A9E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DD2A860)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1DD2A8A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1DD2AA30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGH_OFFSET UNITYSDK_OFFSET(0x1DD2A8E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_TOES_OFFSET UNITYSDK_OFFSET(0x1DD2A9A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_ONREAD_OFFSET UNITYSDK_OFFSET(0x1DD2AAF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1DD2B890)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1DD2EE30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1DD2AA90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1DD2AAD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1DD2A8D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1DD2A880)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1DD2A8B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1DD2AA50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1DD2D9F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1DD2DD10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1DD2E9F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2EE80)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Leg_TypeDefinitionIndex = 38338;
