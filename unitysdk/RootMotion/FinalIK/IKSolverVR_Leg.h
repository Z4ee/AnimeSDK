...
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1B9A4F50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1B9A4EE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1B9A4AB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0x1B9A62B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1B9A2B60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1B9A2BA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_CALF_OFFSET UNITYSDK_OFFSET(0x1B9A2A10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_FOOT_OFFSET UNITYSDK_OFFSET(0x1B9A2A50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1B9A29B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_LASTBONE_OFFSET UNITYSDK_OFFSET(0x1B9A2AD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B9A2950)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B9A2990)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1B9A2B20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGH_OFFSET UNITYSDK_OFFSET(0x1B9A29D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_TOES_OFFSET UNITYSDK_OFFSET(0x1B9A2A90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_ONREAD_OFFSET UNITYSDK_OFFSET(0x1B9A2BE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1B9A3980)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1B9A6F20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1B9A2B80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1B9A2BC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1B9A29C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B9A2970)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B9A29A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1B9A2B40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B9A5AE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1B9A5E00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1B9A6AE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A6F70)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Leg_TypeDefinitionIndex = 36639;
