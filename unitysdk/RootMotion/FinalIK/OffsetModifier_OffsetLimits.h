...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_APPLY_OFFSET UNITYSDK_OFFSET(0x1F3BA890)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRINGAXIS_OFFSET UNITYSDK_OFFSET(0x1F3BAD70)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRING_OFFSET UNITYSDK_OFFSET(0x1F3BADE0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3BAE40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier_OffsetLimits_TypeDefinitionIndex = 38878;
