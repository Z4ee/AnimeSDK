...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_APPLY_OFFSET UNITYSDK_OFFSET(0x1DF9F4E0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRINGAXIS_OFFSET UNITYSDK_OFFSET(0x1DF9F9D0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRING_OFFSET UNITYSDK_OFFSET(0x1DF9FA40)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF9FAA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier_OffsetLimits_TypeDefinitionIndex = 38241;
