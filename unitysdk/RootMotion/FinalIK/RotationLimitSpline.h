...
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1F1375B0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1F137630)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1F1376C0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F137510)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1F1374C0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_SETSPLINE_OFFSET UNITYSDK_OFFSET(0x1F137600)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1F137560)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F137DD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitSpline_TypeDefinitionIndex = 38785;

	class RotationLimitSpline : public ::RootMotion::FinalIK::RotationLimit
	{
	public:
		::System::Single twistLimit; // 0x40
		::UnityEngine::AnimationCurve* spline; // 0x48
