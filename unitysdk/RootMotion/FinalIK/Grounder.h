...
#define ROOTMOTION_FINALIK_GROUNDER_GETLEGSPINEBENDVECTOR_OFFSET UNITYSDK_OFFSET(0x1925D8A0)
#define ROOTMOTION_FINALIK_GROUNDER_GETLEGSPINETANGENT_OFFSET UNITYSDK_OFFSET(0x1925DC80)
#define ROOTMOTION_FINALIK_GROUNDER_GETSPINEOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0x1925D7E0)
#define ROOTMOTION_FINALIK_GROUNDER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1925D7D0)
#define ROOTMOTION_FINALIK_GROUNDER_GET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0x1925D660)
#define ROOTMOTION_FINALIK_GROUNDER_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0x1925D740)
#define ROOTMOTION_FINALIK_GROUNDER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1925DC20)
#define ROOTMOTION_FINALIK_GROUNDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1925E090)
#define ROOTMOTION_FINALIK_GROUNDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1925E080)
#define ROOTMOTION_FINALIK_GROUNDER_ONSTARTIK_OFFSET UNITYSDK_OFFSET(0x1925E0A0)
#define ROOTMOTION_FINALIK_GROUNDER_ONSTOPIK_OFFSET UNITYSDK_OFFSET(0x1925E0F0)
#define ROOTMOTION_FINALIK_GROUNDER_REFRESHIKSTATE_OFFSET UNITYSDK_OFFSET(0x1925E140)
#define ROOTMOTION_FINALIK_GROUNDER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1925D750)
#define ROOTMOTION_FINALIK_GROUNDER_SET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0x1925D670)
#define ROOTMOTION_FINALIK_GROUNDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1925E490)
#define ROOTMOTION_FINALIK_GROUNDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1925E280)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounder_TypeDefinitionIndex = 42670;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Grounder_TypeDefinitionIndex)->GetStaticField(0x5FD0);
		}
