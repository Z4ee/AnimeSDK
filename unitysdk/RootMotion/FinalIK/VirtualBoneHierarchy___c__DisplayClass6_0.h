...
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B36F0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY___C__DISPLAYCLASS6_0__FINDBONE_B__0_OFFSET UNITYSDK_OFFSET(0x1B9B3700)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBoneHierarchy___c__DisplayClass6_0_TypeDefinitionIndex = 36737;
