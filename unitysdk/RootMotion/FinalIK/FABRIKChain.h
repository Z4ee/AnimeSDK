...
#define ROOTMOTION_FINALIK_FABRIKCHAIN_GETCENTROID_OFFSET UNITYSDK_OFFSET(0x1E46F7F0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_INITIATE_OFFSET UNITYSDK_OFFSET(0x1E46F6A0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E46F530)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_STAGE1_OFFSET UNITYSDK_OFFSET(0x1E46F6D0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_STAGE2_OFFSET UNITYSDK_OFFSET(0x1E46FA70)
#define ROOTMOTION_FINALIK_FABRIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E46FC50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIKChain_TypeDefinitionIndex = 38132;
