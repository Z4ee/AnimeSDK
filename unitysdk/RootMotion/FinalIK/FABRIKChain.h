...
#define ROOTMOTION_FINALIK_FABRIKCHAIN_GETCENTROID_OFFSET UNITYSDK_OFFSET(0x1C138A60)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_INITIATE_OFFSET UNITYSDK_OFFSET(0x1C138910)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C1387A0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_STAGE1_OFFSET UNITYSDK_OFFSET(0x1C138940)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_STAGE2_OFFSET UNITYSDK_OFFSET(0x1C138CE0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C138EC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIKChain_TypeDefinitionIndex = 36592;
