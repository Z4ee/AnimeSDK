...
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x2A510)
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_ISVALIDHITINTHREAD_OFFSET UNITYSDK_OFFSET(0x2A500)
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_ISVALIDHIT_OFFSET UNITYSDK_OFFSET(0x2A4A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundRaycastHit_TypeDefinitionIndex = 41001;
