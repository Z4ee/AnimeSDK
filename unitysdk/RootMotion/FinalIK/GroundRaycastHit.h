...
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x39D03A0)
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_ISVALIDHITINTHREAD_OFFSET UNITYSDK_OFFSET(0x167D30)
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_ISVALIDHIT_OFFSET UNITYSDK_OFFSET(0x39D0330)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GroundRaycastHit_TypeDefinitionIndex = 42665;
