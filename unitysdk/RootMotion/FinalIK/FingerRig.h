...
#define ROOTMOTION_FINALIK_FINGERRIG_ADDCHILDRENRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1DEAAA40)
#define ROOTMOTION_FINALIK_FINGERRIG_ADDFINGER_OFFSET UNITYSDK_OFFSET(0x1DEAABA0)
#define ROOTMOTION_FINALIK_FINGERRIG_AUTODETECT_OFFSET UNITYSDK_OFFSET(0x1DEAA7A0)
#define ROOTMOTION_FINALIK_FINGERRIG_FIXFINGERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DEAB0D0)
#define ROOTMOTION_FINALIK_FINGERRIG_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DEAB230)
#define ROOTMOTION_FINALIK_FINGERRIG_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1DEAA700)
#define ROOTMOTION_FINALIK_FINGERRIG_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1DEAAF90)
#define ROOTMOTION_FINALIK_FINGERRIG_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DEAA720)
#define ROOTMOTION_FINALIK_FINGERRIG_REMOVEFINGER_OFFSET UNITYSDK_OFFSET(0x1DEAAD80)
#define ROOTMOTION_FINALIK_FINGERRIG_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1DEAA710)
#define ROOTMOTION_FINALIK_FINGERRIG_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1DEAB150)
#define ROOTMOTION_FINALIK_FINGERRIG_UPDATEFINGERSOLVERS_OFFSET UNITYSDK_OFFSET(0x1DEAB060)
#define ROOTMOTION_FINALIK_FINGERRIG_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1DEAB1C0)
#define ROOTMOTION_FINALIK_FINGERRIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAB2B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FingerRig_TypeDefinitionIndex = 38297;
