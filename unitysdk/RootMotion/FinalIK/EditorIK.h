...
#define ROOTMOTION_FINALIK_EDITORIK_GET_IK_OFFSET UNITYSDK_OFFSET(0x1FA56BA0)
#define ROOTMOTION_FINALIK_EDITORIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1FA575D0)
#define ROOTMOTION_FINALIK_EDITORIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1FA57190)
#define ROOTMOTION_FINALIK_EDITORIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1FA56F10)
#define ROOTMOTION_FINALIK_EDITORIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1FA56BC0)
#define ROOTMOTION_FINALIK_EDITORIK_SET_IK_OFFSET UNITYSDK_OFFSET(0x1FA56BB0)
#define ROOTMOTION_FINALIK_EDITORIK_STOREDEFAULTPOSE_OFFSET UNITYSDK_OFFSET(0x1FA574F0)
#define ROOTMOTION_FINALIK_EDITORIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FA57A90)
#define ROOTMOTION_FINALIK_EDITORIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA57F10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int EditorIK_TypeDefinitionIndex = 38985;
