...
#define ROOTMOTION_FINALIK_FINGER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1F3C9140)
#define ROOTMOTION_FINALIK_FINGER_GET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1F3C7F10)
#define ROOTMOTION_FINALIK_FINGER_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1F3C7F70)
#define ROOTMOTION_FINALIK_FINGER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1F3C7EF0)
#define ROOTMOTION_FINALIK_FINGER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1F3C82D0)
#define ROOTMOTION_FINALIK_FINGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1F3C7FC0)
#define ROOTMOTION_FINALIK_FINGER_SET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1F3C7F40)
#define ROOTMOTION_FINALIK_FINGER_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1F3C7FA0)
#define ROOTMOTION_FINALIK_FINGER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1F3C7F00)
#define ROOTMOTION_FINALIK_FINGER_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1F3C9330)
#define ROOTMOTION_FINALIK_FINGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F3C94F0)
#define ROOTMOTION_FINALIK_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3CA340)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Finger_TypeDefinitionIndex = 38930;
