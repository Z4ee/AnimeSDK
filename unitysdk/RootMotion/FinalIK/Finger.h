...
#define ROOTMOTION_FINALIK_FINGER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E007B10)
#define ROOTMOTION_FINALIK_FINGER_GET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1E006900)
#define ROOTMOTION_FINALIK_FINGER_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1E006960)
#define ROOTMOTION_FINALIK_FINGER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1E0068E0)
#define ROOTMOTION_FINALIK_FINGER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1E006CC0)
#define ROOTMOTION_FINALIK_FINGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E0069B0)
#define ROOTMOTION_FINALIK_FINGER_SET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1E006930)
#define ROOTMOTION_FINALIK_FINGER_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1E006990)
#define ROOTMOTION_FINALIK_FINGER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1E0068F0)
#define ROOTMOTION_FINALIK_FINGER_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E007D00)
#define ROOTMOTION_FINALIK_FINGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E007EC0)
#define ROOTMOTION_FINALIK_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E008CC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Finger_TypeDefinitionIndex = 38237;
