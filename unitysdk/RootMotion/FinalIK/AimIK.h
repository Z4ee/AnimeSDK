...
#define ROOTMOTION_FINALIK_AIMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1DEE6830)
#define ROOTMOTION_FINALIK_AIMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1DEE6880)
#define ROOTMOTION_FINALIK_AIMIK_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1DEE6690)
#define ROOTMOTION_FINALIK_AIMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DEE6740)
#define ROOTMOTION_FINALIK_AIMIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1DEE6790)
#define ROOTMOTION_FINALIK_AIMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1DEE66F0)
#define ROOTMOTION_FINALIK_AIMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1DEE67E0)
#define ROOTMOTION_FINALIK_AIMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEE6890)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimIK_TypeDefinitionIndex = 38150;
