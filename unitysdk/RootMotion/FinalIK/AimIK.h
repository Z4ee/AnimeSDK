...
#define ROOTMOTION_FINALIK_AIMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1BB7D5F0)
#define ROOTMOTION_FINALIK_AIMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1BB7D640)
#define ROOTMOTION_FINALIK_AIMIK_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1BB7D450)
#define ROOTMOTION_FINALIK_AIMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1BB7D500)
#define ROOTMOTION_FINALIK_AIMIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1BB7D550)
#define ROOTMOTION_FINALIK_AIMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1BB7D4B0)
#define ROOTMOTION_FINALIK_AIMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1BB7D5A0)
#define ROOTMOTION_FINALIK_AIMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB7D650)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimIK_TypeDefinitionIndex = 36577;
