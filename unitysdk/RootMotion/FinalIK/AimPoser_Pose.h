...
#define ROOTMOTION_FINALIK_AIMPOSER_POSE_ISINDIRECTION_OFFSET UNITYSDK_OFFSET(0x1E46F130)
#define ROOTMOTION_FINALIK_AIMPOSER_POSE_SETANGLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1E46F500)
#define ROOTMOTION_FINALIK_AIMPOSER_POSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E46F510)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_Pose_TypeDefinitionIndex = 38166;
