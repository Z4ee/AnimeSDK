...
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETNODE_OFFSET UNITYSDK_OFFSET(0x1BD18120)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPLANEROTATION_OFFSET UNITYSDK_OFFSET(0x1BD19D30)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1BD1A3B0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1BD181A0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1BD18BE0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BD184A0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPOSTWRITE_OFFSET UNITYSDK_OFFSET(0x1BD19D10)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1BD195B0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_PINTOBONE_OFFSET UNITYSDK_OFFSET(0x1BD181C0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_RESETOFFSET_OFFSET UNITYSDK_OFFSET(0x1BD19300)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SETTOTARGET_OFFSET UNITYSDK_OFFSET(0x1BD19400)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1BD181B0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BD1A010)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD183A0)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD182B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 36600;
