...
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETNODE_OFFSET UNITYSDK_OFFSET(0x1E0660E0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPLANEROTATION_OFFSET UNITYSDK_OFFSET(0x1E067CF0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1E068370)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1E066160)
#define ROOTMOTION_FINALIK_IKEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1E066BA0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1E066460)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPOSTWRITE_OFFSET UNITYSDK_OFFSET(0x1E067CD0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1E067570)
#define ROOTMOTION_FINALIK_IKEFFECTOR_PINTOBONE_OFFSET UNITYSDK_OFFSET(0x1E066180)
#define ROOTMOTION_FINALIK_IKEFFECTOR_RESETOFFSET_OFFSET UNITYSDK_OFFSET(0x1E0672C0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SETTOTARGET_OFFSET UNITYSDK_OFFSET(0x1E0673C0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1E066170)
#define ROOTMOTION_FINALIK_IKEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E067FD0)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E066360)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E066270)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 38306;
