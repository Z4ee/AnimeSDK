...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1E475320)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E475210)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_HIT_OFFSET UNITYSDK_OFFSET(0x1E474DB0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1E475390)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E475940)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_RotationOffset_TypeDefinitionIndex = 38152;
