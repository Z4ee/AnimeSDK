...
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_FOOT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D5820)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderQuadruped_Foot_TypeDefinitionIndex = 36568;
