...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB38C20)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB38CB0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB38890)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB38880)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionEventDelegate_TypeDefinitionIndex = 36660;
