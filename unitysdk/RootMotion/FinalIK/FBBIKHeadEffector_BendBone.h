...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1E669D00)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1E669CC0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E669CA0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E669C80)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_BendBone_TypeDefinitionIndex = 38227;
