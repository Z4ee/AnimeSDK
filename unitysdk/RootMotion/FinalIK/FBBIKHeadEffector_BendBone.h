...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1FA58290)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1FA58250)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FA58230)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA58210)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_BendBone_TypeDefinitionIndex = 38855;
