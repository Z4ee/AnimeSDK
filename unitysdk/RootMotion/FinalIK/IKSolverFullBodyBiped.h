...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1F3B2530)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1F3B1A50)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_DETECTROOTNODEBONE_OFFSET UNITYSDK_OFFSET(0x1F3B0F90)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBENDCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1F3AEAE0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1F3B2120)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_1_OFFSET UNITYSDK_OFFSET(0x1F3AE4F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1F3AE360)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADCA0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3AE6E0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHANDBODYPULL_OFFSET UNITYSDK_OFFSET(0x1F3B2360)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AEAA0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLEFTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1F3B14A0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1F3AE8D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AE7D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETRIGHTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1F3B1620)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETSPINEMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AEA90)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_BODYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADC60)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_HEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AE2C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1F3AE0C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AE1C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3AE040)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADFC0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1F3AE140)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AE240)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADEC0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADF40)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1F3B1A10)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1F3AE100)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AE200)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3AE080)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3AE000)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1F3AE180)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1F3AE280)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADF00)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADF80)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_ISVALID_OFFSET UNITYSDK_OFFSET(0x1F3AEBE0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_PULLBODY_OFFSET UNITYSDK_OFFSET(0x1F3B1C40)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_READPOSE_OFFSET UNITYSDK_OFFSET(0x1F3B1B00)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETCHAINWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1F3AE300)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETEFFECTORWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1F3AE450)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1F3B17A0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1F3B1800)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1F3AEEE0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1F3B1A30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1F3B2B20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3B2BF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBodyBiped_TypeDefinitionIndex = 39002;
