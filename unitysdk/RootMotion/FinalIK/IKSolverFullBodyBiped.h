...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1DF96F20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1DF96410)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_DETECTROOTNODEBONE_OFFSET UNITYSDK_OFFSET(0x1DF958F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBENDCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1DF93440)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1DF96AF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_1_OFFSET UNITYSDK_OFFSET(0x1DF92DF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1DF92C50)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF92570)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF93000)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHANDBODYPULL_OFFSET UNITYSDK_OFFSET(0x1DF96D30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF93400)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLEFTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1DF95E70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1DF93210)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF93100)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETRIGHTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1DF95FF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETSPINEMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF933F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_BODYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF92530)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_HEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF92BB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1DF929B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF92AB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF92930)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF928B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1DF92A30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF92B30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF927B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF92830)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1DF963D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1DF929F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF92AF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF92970)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF928F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1DF92A70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1DF92B70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF927F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1DF92870)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DF93550)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_PULLBODY_OFFSET UNITYSDK_OFFSET(0x1DF96600)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_READPOSE_OFFSET UNITYSDK_OFFSET(0x1DF964C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETCHAINWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1DF92BF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETEFFECTORWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1DF92D50)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1DF96170)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1DF961D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1DF93850)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1DF963F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1DF97510)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF975E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBodyBiped_TypeDefinitionIndex = 38167;
