...
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1BB33F80)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BB32720)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1BB33D30)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1BB32800)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BB31D10)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_MAPTOSOLVERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1BB34170)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_READPOSE_OFFSET UNITYSDK_OFFSET(0x1BB33300)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_SETBONES_OFFSET UNITYSDK_OFFSET(0x1BB32600)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1BB32620)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_USEFABRIK_OFFSET UNITYSDK_OFFSET(0x1BB332D0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1BB33850)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BB324B0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB323A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 36606;
