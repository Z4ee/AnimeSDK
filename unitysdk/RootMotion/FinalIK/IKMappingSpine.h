...
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1DEAD8D0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DEAC070)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1DEAD680)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1DEAC150)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1DEAB660)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_MAPTOSOLVERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1DEADAC0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_READPOSE_OFFSET UNITYSDK_OFFSET(0x1DEACC50)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_SETBONES_OFFSET UNITYSDK_OFFSET(0x1DEABF50)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1DEABF70)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_USEFABRIK_OFFSET UNITYSDK_OFFSET(0x1DEACC20)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1DEAD1A0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEABE00)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEABCF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 38352;
