...
#define ROOTMOTION_FINALIK_FABRIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1BC8F050)
#define ROOTMOTION_FINALIK_FABRIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1BC8F0A0)
#define ROOTMOTION_FINALIK_FABRIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1BC8EFB0)
#define ROOTMOTION_FINALIK_FABRIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1BC8EF60)
#define ROOTMOTION_FINALIK_FABRIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1BC8F000)
#define ROOTMOTION_FINALIK_FABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC8F0B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIK_TypeDefinitionIndex = 36580;
