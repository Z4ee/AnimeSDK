...
#define ROOTMOTION_FINALIK_FABRIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1F3ADA70)
#define ROOTMOTION_FINALIK_FABRIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1F3ADAC0)
#define ROOTMOTION_FINALIK_FABRIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F3AD9D0)
#define ROOTMOTION_FINALIK_FABRIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1F3AD980)
#define ROOTMOTION_FINALIK_FABRIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1F3ADA20)
#define ROOTMOTION_FINALIK_FABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3ADAD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIK_TypeDefinitionIndex = 38979;
