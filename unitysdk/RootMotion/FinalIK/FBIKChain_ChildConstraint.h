...
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_GET_ISRIGID_OFFSET UNITYSDK_OFFSET(0x1C116B20)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_GET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C116B00)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_INITIATE_OFFSET UNITYSDK_OFFSET(0x1C116B60)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1C116BB0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SET_ISRIGID_OFFSET UNITYSDK_OFFSET(0x1C116B30)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C116B10)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SOLVE_OFFSET UNITYSDK_OFFSET(0x1C116E90)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C116B40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBIKChain_ChildConstraint_TypeDefinitionIndex = 36597;
