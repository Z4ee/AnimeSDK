...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDPLATFORMMOTION_OFFSET UNITYSDK_OFFSET(0x1EE44A00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1EE3F5B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDROTATIONOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1EE447B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1EE44740)
#define ROOTMOTION_FINALIK_IKSOLVERVR_DEFAULTANIMATIONCURVES_OFFSET UNITYSDK_OFFSET(0x1EE441A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1EE46250)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1EE46810)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPELVISOFFSET_OFFSET UNITYSDK_OFFSET(0x1EE4E850)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1EE46570)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1EE465D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1EE4AA50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1EE4AAA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETSINEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1EE44690)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x1EE41E20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1EE4F0C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GUESSHANDORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1EE44380)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1EE46630)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1EE46B00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EE46B80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_READ_OFFSET UNITYSDK_OFFSET(0x1EE45320)
#define ROOTMOTION_FINALIK_IKSOLVERVR_RESET_OFFSET UNITYSDK_OFFSET(0x1EE44D90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1EE41E40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x1EE41E30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1EE4F0D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SOLVE_OFFSET UNITYSDK_OFFSET(0x1EE47720)
#define ROOTMOTION_FINALIK_IKSOLVERVR_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1EE45F50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_UPDATESOLVERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1EE45020)
#define ROOTMOTION_FINALIK_IKSOLVERVR_WRITETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1EE4A0C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_WRITE_OFFSET UNITYSDK_OFFSET(0x1EE49EF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE4F0E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_TypeDefinitionIndex = 38943;
