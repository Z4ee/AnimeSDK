...
#define ROOTMOTION_FINALIK_GROUNDER__ONSTARTIK_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB2FAF20)
#define ROOTMOTION_FINALIK_GROUNDER__ONSTARTIK_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB2FAF40)
#define ROOTMOTION_FINALIK_GROUNDER__ONSTARTIK_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB2FAFA0)
#define ROOTMOTION_FINALIK_GROUNDER__ONSTARTIK_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB2FAF50)
#define ROOTMOTION_FINALIK_GROUNDER__ONSTARTIK_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2FAF10)
#define ROOTMOTION_FINALIK_GROUNDER__ONSTARTIK_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0xB2FAB10)
