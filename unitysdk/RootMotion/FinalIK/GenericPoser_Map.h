...
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1FA59080)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_STOREDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x1FA590E0)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FA58DF0)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA58A80)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GenericPoser_Map_TypeDefinitionIndex = 38821;
