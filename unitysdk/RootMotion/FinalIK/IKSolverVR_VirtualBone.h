...
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_GETDIRECTIONTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1E15DB40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1E15C5D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_READ_OFFSET UNITYSDK_OFFSET(0x1E15C270)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEAROUNDPOINT_OFFSET UNITYSDK_OFFSET(0x1E15C9F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEBY_1_OFFSET UNITYSDK_OFFSET(0x1E15CFA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEBY_OFFSET UNITYSDK_OFFSET(0x1E15CCB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1E15D330)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVECCD_OFFSET UNITYSDK_OFFSET(0x1E15E5A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1E15E4B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVEFABRIK_OFFSET UNITYSDK_OFFSET(0x1E15DE40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVETRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1E15D500)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SWINGROTATION_OFFSET UNITYSDK_OFFSET(0x1E15C2A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E15C220)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_VirtualBone_TypeDefinitionIndex = 38332;
