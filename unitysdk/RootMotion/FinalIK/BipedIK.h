...
#define ROOTMOTION_FINALIK_BIPEDIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1DEA3FD0)
#define ROOTMOTION_FINALIK_BIPEDIK_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DEA5010)
#define ROOTMOTION_FINALIK_BIPEDIK_GETGOALIK_OFFSET UNITYSDK_OFFSET(0x1DEA40C0)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKPOSITIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DEA4020)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1DEA44A0)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DEA4160)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKROTATION_OFFSET UNITYSDK_OFFSET(0x1DEA4540)
#define ROOTMOTION_FINALIK_BIPEDIK_INITIATEBIPEDIK_OFFSET UNITYSDK_OFFSET(0x1DEA47F0)
#define ROOTMOTION_FINALIK_BIPEDIK_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1DEA4800)
#define ROOTMOTION_FINALIK_BIPEDIK_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1DEA5120)
#define ROOTMOTION_FINALIK_BIPEDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DEA3F30)
#define ROOTMOTION_FINALIK_BIPEDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1DEA3EE0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKPOSITIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DEA4200)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1DEA4360)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DEA42B0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKROTATION_OFFSET UNITYSDK_OFFSET(0x1DEA4400)
#define ROOTMOTION_FINALIK_BIPEDIK_SETLOOKATPOSITION_OFFSET UNITYSDK_OFFSET(0x1DEA4720)
#define ROOTMOTION_FINALIK_BIPEDIK_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DEA45E0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETSPINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DEA4760)
#define ROOTMOTION_FINALIK_BIPEDIK_SETSPINEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1DEA47A0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETTODEFAULTS_OFFSET UNITYSDK_OFFSET(0x1DEA4EC0)
#define ROOTMOTION_FINALIK_BIPEDIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1DEA3F80)
#define ROOTMOTION_FINALIK_BIPEDIK_UPDATEBIPEDIK_OFFSET UNITYSDK_OFFSET(0x1DEA4A90)
#define ROOTMOTION_FINALIK_BIPEDIK_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1DEA4AA0)
#define ROOTMOTION_FINALIK_BIPEDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEA51A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BipedIK_TypeDefinitionIndex = 38157;
