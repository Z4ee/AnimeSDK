...
#define ROOTMOTION_FINALIK_FBIKCHAIN_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1C1EA790)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CALCULATEBONELENGTHS_OFFSET UNITYSDK_OFFSET(0x1C1E7FD0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1C1EA230)
#define ROOTMOTION_FINALIK_FBIKCHAIN_GETDIRTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1C1E9920)
#define ROOTMOTION_FINALIK_FBIKCHAIN_GETNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1C1E7AC0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_INITIATE_OFFSET UNITYSDK_OFFSET(0x1C1E7D20)
#define ROOTMOTION_FINALIK_FBIKCHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1C1E7B90)
#define ROOTMOTION_FINALIK_FBIKCHAIN_PUSH_OFFSET UNITYSDK_OFFSET(0x1C1E91D0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_REACH_OFFSET UNITYSDK_OFFSET(0x1C1E8EA0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_READPOSE_OFFSET UNITYSDK_OFFSET(0x1C1E8820)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SETNODES_OFFSET UNITYSDK_OFFSET(0x1C1E7960)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVECHILDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1C1EA480)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVECONSTRAINTSYSTEMS_OFFSET UNITYSDK_OFFSET(0x1C1EAA70)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1C1EA500)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVELINEARCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C1EAC60)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVETRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1C1E95B0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_STAGE1_OFFSET UNITYSDK_OFFSET(0x1C1E9C10)
#define ROOTMOTION_FINALIK_FBIKCHAIN_STAGE2_OFFSET UNITYSDK_OFFSET(0x1C1EA5F0)
#define ROOTMOTION_FINALIK_FBIKCHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C1E7860)
#define ROOTMOTION_FINALIK_FBIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1E77B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBIKChain_TypeDefinitionIndex = 36596;
