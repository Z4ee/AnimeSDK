...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1DAF7950)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1DAF78B0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_HIT_OFFSET UNITYSDK_OFFSET(0x1DAF7450)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1DAF79C0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF7AC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointBone_TypeDefinitionIndex = 38182;
