...
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BCA7740)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_GETBONEMAP_OFFSET UNITYSDK_OFFSET(0x1BCA6940)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_INITIATE_OFFSET UNITYSDK_OFFSET(0x1BCA7980)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_ISVALID_OFFSET UNITYSDK_OFFSET(0x1BCA68C0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_READPOSE_OFFSET UNITYSDK_OFFSET(0x1BCA7DF0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_SETBONES_OFFSET UNITYSDK_OFFSET(0x1BCA73C0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1BCA6B10)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1BCA73E0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1BCA7EA0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BCA7290)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA7190)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 36604;
