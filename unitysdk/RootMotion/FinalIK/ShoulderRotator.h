...
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_GETPARENTBONEMAP_OFFSET UNITYSDK_OFFSET(0x1DEB4BD0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DEB4C10)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDERS_OFFSET UNITYSDK_OFFSET(0x1DEB4370)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDER_OFFSET UNITYSDK_OFFSET(0x1DEB4570)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_START_OFFSET UNITYSDK_OFFSET(0x1DEB4240)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB4DD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ShoulderRotator_TypeDefinitionIndex = 38188;
