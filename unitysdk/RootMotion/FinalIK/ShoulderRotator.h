...
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_GETPARENTBONEMAP_OFFSET UNITYSDK_OFFSET(0x1BB3B270)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BB3B2B0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDERS_OFFSET UNITYSDK_OFFSET(0x1BB3AA10)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDER_OFFSET UNITYSDK_OFFSET(0x1BB3AC10)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_START_OFFSET UNITYSDK_OFFSET(0x1BB3A8E0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB3B470)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ShoulderRotator_TypeDefinitionIndex = 36727;
