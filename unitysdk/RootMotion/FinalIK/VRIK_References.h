...
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B68C6B0)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GETTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B679BC0)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B68BD80)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1B678D10)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B68BC40)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68BC30)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIK_References_TypeDefinitionIndex = 36591;
