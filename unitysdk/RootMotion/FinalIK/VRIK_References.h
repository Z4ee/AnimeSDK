...
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1DA8B490)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GETTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DA78990)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DA8AB60)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1DA77AE0)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DA8AA20)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8AA10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIK_References_TypeDefinitionIndex = 38329;
