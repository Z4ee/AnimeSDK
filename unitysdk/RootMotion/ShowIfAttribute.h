...
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x1E6E9C90)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1E6E9CB0)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1E6E9C70)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1E6E9C30)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1E6E9C50)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x1E6E9CA0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1E6E9CC0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1E6E9C80)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1E6E9C40)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1E6E9C60)
#define ROOTMOTION_SHOWIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E9CD0)

namespace RootMotion
{
	inline static constexpr unsigned int ShowIfAttribute_TypeDefinitionIndex = 38353;
