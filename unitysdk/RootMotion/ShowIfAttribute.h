...
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x1C3A5030)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1C3A5050)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A5010)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1C3A4FD0)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A4FF0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x1C3A5040)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1C3A5060)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A5020)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1C3A4FE0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A5000)
#define ROOTMOTION_SHOWIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3A5070)

namespace RootMotion
{
	inline static constexpr unsigned int ShowIfAttribute_TypeDefinitionIndex = 36537;

	class ShowIfAttribute : public ::UnityEngine::PropertyAttribute
	{
	public:
		::System::Object* _propValue_k__BackingField; // 0x10
		::System::String* _propName_k__BackingField; // 0x18
		::System::Object* _otherPropValue_k__BackingField; // 0x20
		::RootMotion::ShowIfMode _mode_k__BackingField; // 0x28
		::System::Boolean _indent_k__BackingField; // 0x2C
