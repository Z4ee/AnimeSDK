...
#define ROOTMOTION_BAKER_CLIPSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C116090)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_ClipSettings_TypeDefinitionIndex = 36508;
