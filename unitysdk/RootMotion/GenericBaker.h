...
#define ROOTMOTION_GENERICBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1F3BD8D0)
#define ROOTMOTION_GENERICBAKER_BAKEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F3BDCD0)
#define ROOTMOTION_GENERICBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1F3BDDB0)
#define ROOTMOTION_GENERICBAKER_ISIGNORED_OFFSET UNITYSDK_OFFSET(0x1F3BDBF0)
#define ROOTMOTION_GENERICBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1F3BDFB0)
#define ROOTMOTION_GENERICBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F3BE030)
#define ROOTMOTION_GENERICBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1F3BDF30)
#define ROOTMOTION_GENERICBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1F3BDDC0)
#define ROOTMOTION_GENERICBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3BE0B0)

namespace RootMotion
{
	inline static constexpr unsigned int GenericBaker_TypeDefinitionIndex = 38880;
