...
#define ROOTMOTION_GENERICBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BC9EFB0)
#define ROOTMOTION_GENERICBAKER_BAKEPOSITION_OFFSET UNITYSDK_OFFSET(0x1BC9F390)
#define ROOTMOTION_GENERICBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1BC9F460)
#define ROOTMOTION_GENERICBAKER_ISIGNORED_OFFSET UNITYSDK_OFFSET(0x1BC9F2C0)
#define ROOTMOTION_GENERICBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1BC9F660)
#define ROOTMOTION_GENERICBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1BC9F6E0)
#define ROOTMOTION_GENERICBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1BC9F5E0)
#define ROOTMOTION_GENERICBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1BC9F470)
#define ROOTMOTION_GENERICBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC9F760)

namespace RootMotion
{
	inline static constexpr unsigned int GenericBaker_TypeDefinitionIndex = 36512;
