...
#define ROOTMOTION_HUMANOIDBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BCB2B60)
#define ROOTMOTION_HUMANOIDBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1BCB3270)
#define ROOTMOTION_HUMANOIDBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1BCB3640)
#define ROOTMOTION_HUMANOIDBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1BCB38D0)
#define ROOTMOTION_HUMANOIDBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1BCB33F0)
#define ROOTMOTION_HUMANOIDBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1BCB3290)
#define ROOTMOTION_HUMANOIDBAKER_UPDATEHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1BCB3D50)
#define ROOTMOTION_HUMANOIDBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB3F30)

namespace RootMotion
{
	inline static constexpr unsigned int HumanoidBaker_TypeDefinitionIndex = 36519;
