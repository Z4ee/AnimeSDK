...
#define ROOTMOTION_HUMANOIDBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E017330)
#define ROOTMOTION_HUMANOIDBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1E017A40)
#define ROOTMOTION_HUMANOIDBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1E017E10)
#define ROOTMOTION_HUMANOIDBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1E0180A0)
#define ROOTMOTION_HUMANOIDBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1E017BC0)
#define ROOTMOTION_HUMANOIDBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1E017A60)
#define ROOTMOTION_HUMANOIDBAKER_UPDATEHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1E018520)
#define ROOTMOTION_HUMANOIDBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E018700)

namespace RootMotion
{
	inline static constexpr unsigned int HumanoidBaker_TypeDefinitionIndex = 38178;
