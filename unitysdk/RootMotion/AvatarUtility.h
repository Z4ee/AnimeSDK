...
#define ROOTMOTION_AVATARUTILITY_GETIKGOALTQ_OFFSET UNITYSDK_OFFSET(0x1C2DBC40)
#define ROOTMOTION_AVATARUTILITY_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1C2DB930)
#define ROOTMOTION_AVATARUTILITY_GETWORLDSPACEIKGOAL_OFFSET UNITYSDK_OFFSET(0x1C2DD020)
#define ROOTMOTION_AVATARUTILITY_HUMANIDFROMAVATARIKGOAL_OFFSET UNITYSDK_OFFSET(0x1C2DBC20)
#define ROOTMOTION_AVATARUTILITY_WORLDSPACEIKGOALTOBONE_OFFSET UNITYSDK_OFFSET(0x1C2DC7F0)
#define ROOTMOTION_AVATARUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DD2A0)

namespace RootMotion
{
	inline static constexpr unsigned int AvatarUtility_TypeDefinitionIndex = 36514;
