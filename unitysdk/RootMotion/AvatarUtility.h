...
#define ROOTMOTION_AVATARUTILITY_GETIKGOALTQ_OFFSET UNITYSDK_OFFSET(0x1FA118B0)
#define ROOTMOTION_AVATARUTILITY_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1FA11590)
#define ROOTMOTION_AVATARUTILITY_GETWORLDSPACEIKGOAL_OFFSET UNITYSDK_OFFSET(0x1FA12D00)
#define ROOTMOTION_AVATARUTILITY_HUMANIDFROMAVATARIKGOAL_OFFSET UNITYSDK_OFFSET(0x1FA11890)
#define ROOTMOTION_AVATARUTILITY_WORLDSPACEIKGOALTOBONE_OFFSET UNITYSDK_OFFSET(0x1FA124B0)
#define ROOTMOTION_AVATARUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA12F70)

namespace RootMotion
{
	inline static constexpr unsigned int AvatarUtility_TypeDefinitionIndex = 38883;
