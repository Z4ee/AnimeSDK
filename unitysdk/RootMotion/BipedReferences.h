...
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOEYES_OFFSET UNITYSDK_OFFSET(0x1DAF3660)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1DAF3920)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOSPINE_OFFSET UNITYSDK_OFFSET(0x1DAF3400)
#define ROOTMOTION_BIPEDREFERENCES_ASSIGNHUMANOIDREFERENCES_OFFSET UNITYSDK_OFFSET(0x1DAF1380)
#define ROOTMOTION_BIPEDREFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1DAF0F70)
#define ROOTMOTION_BIPEDREFERENCES_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1DAF0B20)
#define ROOTMOTION_BIPEDREFERENCES_DETECTLIMB_OFFSET UNITYSDK_OFFSET(0x1DAF32C0)
#define ROOTMOTION_BIPEDREFERENCES_DETECTREFERENCESBYNAMING_OFFSET UNITYSDK_OFFSET(0x1DAF1D00)
#define ROOTMOTION_BIPEDREFERENCES_EYESERROR_OFFSET UNITYSDK_OFFSET(0x1DAF4B20)
#define ROOTMOTION_BIPEDREFERENCES_EYESWARNING_OFFSET UNITYSDK_OFFSET(0x1DAF51D0)
#define ROOTMOTION_BIPEDREFERENCES_FACINGAXISWARNING_OFFSET UNITYSDK_OFFSET(0x1DAF56B0)
#define ROOTMOTION_BIPEDREFERENCES_GETVERTICALOFFSET_OFFSET UNITYSDK_OFFSET(0x1DAF5C70)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DAF01D0)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1DAEF970)
#define ROOTMOTION_BIPEDREFERENCES_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1DAF01F0)
#define ROOTMOTION_BIPEDREFERENCES_ISNECKBONE_OFFSET UNITYSDK_OFFSET(0x1DAF3B00)
#define ROOTMOTION_BIPEDREFERENCES_LIMBERROR_OFFSET UNITYSDK_OFFSET(0x1DAF3C90)
#define ROOTMOTION_BIPEDREFERENCES_LIMBWARNING_OFFSET UNITYSDK_OFFSET(0x1DAF4E60)
#define ROOTMOTION_BIPEDREFERENCES_ROOTHEIGHTWARNING_OFFSET UNITYSDK_OFFSET(0x1DAF51E0)
#define ROOTMOTION_BIPEDREFERENCES_SETUPERROR_OFFSET UNITYSDK_OFFSET(0x1DAF3120)
#define ROOTMOTION_BIPEDREFERENCES_SETUPWARNING_OFFSET UNITYSDK_OFFSET(0x1DAF3210)
#define ROOTMOTION_BIPEDREFERENCES_SPINEERROR_OFFSET UNITYSDK_OFFSET(0x1DAF44F0)
#define ROOTMOTION_BIPEDREFERENCES_SPINEWARNING_OFFSET UNITYSDK_OFFSET(0x1DAF51C0)
#define ROOTMOTION_BIPEDREFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF1320)

namespace RootMotion
{
	inline static constexpr unsigned int BipedReferences_TypeDefinitionIndex = 38256;
