...
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOEYES_OFFSET UNITYSDK_OFFSET(0x1B6F10C0)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B6F1380)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOSPINE_OFFSET UNITYSDK_OFFSET(0x1B6F0E60)
#define ROOTMOTION_BIPEDREFERENCES_ASSIGNHUMANOIDREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B6EEDE0)
#define ROOTMOTION_BIPEDREFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B6EE9D0)
#define ROOTMOTION_BIPEDREFERENCES_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B6EE580)
#define ROOTMOTION_BIPEDREFERENCES_DETECTLIMB_OFFSET UNITYSDK_OFFSET(0x1B6F0D20)
#define ROOTMOTION_BIPEDREFERENCES_DETECTREFERENCESBYNAMING_OFFSET UNITYSDK_OFFSET(0x1B6EF760)
#define ROOTMOTION_BIPEDREFERENCES_EYESERROR_OFFSET UNITYSDK_OFFSET(0x1B6F2580)
#define ROOTMOTION_BIPEDREFERENCES_EYESWARNING_OFFSET UNITYSDK_OFFSET(0x1B6F2C30)
#define ROOTMOTION_BIPEDREFERENCES_FACINGAXISWARNING_OFFSET UNITYSDK_OFFSET(0x1B6F3110)
#define ROOTMOTION_BIPEDREFERENCES_GETVERTICALOFFSET_OFFSET UNITYSDK_OFFSET(0x1B6F36D0)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B6EDC30)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1B6ED3D0)
#define ROOTMOTION_BIPEDREFERENCES_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B6EDC50)
#define ROOTMOTION_BIPEDREFERENCES_ISNECKBONE_OFFSET UNITYSDK_OFFSET(0x1B6F1560)
#define ROOTMOTION_BIPEDREFERENCES_LIMBERROR_OFFSET UNITYSDK_OFFSET(0x1B6F16F0)
#define ROOTMOTION_BIPEDREFERENCES_LIMBWARNING_OFFSET UNITYSDK_OFFSET(0x1B6F28C0)
#define ROOTMOTION_BIPEDREFERENCES_ROOTHEIGHTWARNING_OFFSET UNITYSDK_OFFSET(0x1B6F2C40)
#define ROOTMOTION_BIPEDREFERENCES_SETUPERROR_OFFSET UNITYSDK_OFFSET(0x1B6F0B80)
#define ROOTMOTION_BIPEDREFERENCES_SETUPWARNING_OFFSET UNITYSDK_OFFSET(0x1B6F0C70)
#define ROOTMOTION_BIPEDREFERENCES_SPINEERROR_OFFSET UNITYSDK_OFFSET(0x1B6F1F50)
#define ROOTMOTION_BIPEDREFERENCES_SPINEWARNING_OFFSET UNITYSDK_OFFSET(0x1B6F2C20)
#define ROOTMOTION_BIPEDREFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EED80)

namespace RootMotion
{
	inline static constexpr unsigned int BipedReferences_TypeDefinitionIndex = 36527;
