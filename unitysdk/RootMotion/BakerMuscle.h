...
#define ROOTMOTION_BAKERMUSCLE_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1E2B78B0)
#define ROOTMOTION_BAKERMUSCLE_MUSCLENAMETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E2B72A0)
#define ROOTMOTION_BAKERMUSCLE_RESET_OFFSET UNITYSDK_OFFSET(0x1E2B7860)
#define ROOTMOTION_BAKERMUSCLE_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1E2B79C0)
#define ROOTMOTION_BAKERMUSCLE_SETKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1E2B7B70)
#define ROOTMOTION_BAKERMUSCLE_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1E2B7BC0)
#define ROOTMOTION_BAKERMUSCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2B7210)

namespace RootMotion
{
	inline static constexpr unsigned int BakerMuscle_TypeDefinitionIndex = 38296;
