...
#define ROOTMOTION_BAKERMUSCLE_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1F6E83F0)
#define ROOTMOTION_BAKERMUSCLE_MUSCLENAMETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F6E7DE0)
#define ROOTMOTION_BAKERMUSCLE_RESET_OFFSET UNITYSDK_OFFSET(0x1F6E83A0)
#define ROOTMOTION_BAKERMUSCLE_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1F6E8500)
#define ROOTMOTION_BAKERMUSCLE_SETKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1F6E86B0)
#define ROOTMOTION_BAKERMUSCLE_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1F6E8700)
#define ROOTMOTION_BAKERMUSCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6E7D50)

namespace RootMotion
{
	inline static constexpr unsigned int BakerMuscle_TypeDefinitionIndex = 38850;
