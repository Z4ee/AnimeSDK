...
#define ROOTMOTION_TRIGGEREVENTBROADCASTER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1DA8D480)
#define ROOTMOTION_TRIGGEREVENTBROADCASTER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1DA8D760)
#define ROOTMOTION_TRIGGEREVENTBROADCASTER_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1DA8D5F0)
#define ROOTMOTION_TRIGGEREVENTBROADCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8D8D0)

namespace RootMotion
{
	inline static constexpr unsigned int TriggerEventBroadcaster_TypeDefinitionIndex = 38253;
