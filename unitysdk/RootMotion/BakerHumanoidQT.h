...
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x1BD0DAA0)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEROTATION_OFFSET UNITYSDK_OFFSET(0x1BD0D9D0)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1BD0DB40)
#define ROOTMOTION_BAKERHUMANOIDQT_GETCURVESFROMCLIP_OFFSET UNITYSDK_OFFSET(0x1BD0DCF0)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1BD0E310)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1BD0E630)
#define ROOTMOTION_BAKERHUMANOIDQT_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1BD0E740)
#define ROOTMOTION_BAKERHUMANOIDQT_RESET_OFFSET UNITYSDK_OFFSET(0x1BD0D7C0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1BD0E850)
#define ROOTMOTION_BAKERHUMANOIDQT_SETIKKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1BD0DD00)
#define ROOTMOTION_BAKERHUMANOIDQT_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1BD0E210)
#define ROOTMOTION_BAKERHUMANOIDQT_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1BD0E6B0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETROOTLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1BD0E730)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD0D8F0)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0D6F0)

namespace RootMotion
{
	inline static constexpr unsigned int BakerHumanoidQT_TypeDefinitionIndex = 36516;
