...
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x1F41C090)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEROTATION_OFFSET UNITYSDK_OFFSET(0x1F41BFC0)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1F41C130)
#define ROOTMOTION_BAKERHUMANOIDQT_GETCURVESFROMCLIP_OFFSET UNITYSDK_OFFSET(0x1F41C2E0)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F41C910)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1F41CC30)
#define ROOTMOTION_BAKERHUMANOIDQT_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1F41CD40)
#define ROOTMOTION_BAKERHUMANOIDQT_RESET_OFFSET UNITYSDK_OFFSET(0x1F41BDB0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1F41CE50)
#define ROOTMOTION_BAKERHUMANOIDQT_SETIKKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F41C2F0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F41C810)
#define ROOTMOTION_BAKERHUMANOIDQT_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1F41CCB0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETROOTLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1F41CD30)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F41BEE0)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F41BCE0)

namespace RootMotion
{
	inline static constexpr unsigned int BakerHumanoidQT_TypeDefinitionIndex = 38919;
