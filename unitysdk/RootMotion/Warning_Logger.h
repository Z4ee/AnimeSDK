...
#define ROOTMOTION_WARNING_LOGGER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EE57FC0)
#define ROOTMOTION_WARNING_LOGGER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EE57FF0)
#define ROOTMOTION_WARNING_LOGGER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EE3FA00)
#define ROOTMOTION_WARNING_LOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE57FA0)

namespace RootMotion
{
	inline static constexpr unsigned int Warning_Logger_TypeDefinitionIndex = 38782;
