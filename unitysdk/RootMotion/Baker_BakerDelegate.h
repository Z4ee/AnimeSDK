...
#define ROOTMOTION_BAKER_BAKERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F41BC50)
#define ROOTMOTION_BAKER_BAKERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F41BCD0)
#define ROOTMOTION_BAKER_BAKERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F41B690)
#define ROOTMOTION_BAKER_BAKERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F41B670)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_BakerDelegate_TypeDefinitionIndex = 38997;
