...
#define ROOTMOTION_BAKER_BAKERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BD0D660)
#define ROOTMOTION_BAKER_BAKERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BD0D6E0)
#define ROOTMOTION_BAKER_BAKERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BD0D0C0)
#define ROOTMOTION_BAKER_BAKERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0D0B0)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_BakerDelegate_TypeDefinitionIndex = 36507;
