...
#define ROOTMOTION_WARNING_LOG_1_OFFSET UNITYSDK_OFFSET(0x1F428610)
#define ROOTMOTION_WARNING_LOG_OFFSET UNITYSDK_OFFSET(0x1F42D1C0)

namespace RootMotion
{
	inline static constexpr unsigned int Warning_TypeDefinitionIndex = 38781;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Warning_TypeDefinitionIndex)->GetStaticField(0x8EA0);
		}
