...
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_MAXBIPED_OFFSET UNITYSDK_OFFSET(0x1DD28890)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_UMA_OFFSET UNITYSDK_OFFSET(0x1DD28620)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD28600)

namespace RootMotion
{
	inline static constexpr unsigned int BipedLimbOrientations_TypeDefinitionIndex = 38158;
