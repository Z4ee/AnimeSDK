...
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_MAXBIPED_OFFSET UNITYSDK_OFFSET(0x1B9A0990)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_UMA_OFFSET UNITYSDK_OFFSET(0x1B9A0720)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A0700)

namespace RootMotion
{
	inline static constexpr unsigned int BipedLimbOrientations_TypeDefinitionIndex = 36522;
