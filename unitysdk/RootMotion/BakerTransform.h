...
#define ROOTMOTION_BAKERTRANSFORM_ADDLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1EED5200)
#define ROOTMOTION_BAKERTRANSFORM_ADDROOTMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1EED4B00)
#define ROOTMOTION_BAKERTRANSFORM_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1EED4DC0)
#define ROOTMOTION_BAKERTRANSFORM_RESET_OFFSET UNITYSDK_OFFSET(0x1EED46F0)
#define ROOTMOTION_BAKERTRANSFORM_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1EED4820)
#define ROOTMOTION_BAKERTRANSFORM_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1EED4F10)
#define ROOTMOTION_BAKERTRANSFORM_SETRELATIVESPACE_OFFSET UNITYSDK_OFFSET(0x1EED4800)
#define ROOTMOTION_BAKERTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EED46C0)

namespace RootMotion
{
	inline static constexpr unsigned int BakerTransform_TypeDefinitionIndex = 39018;
