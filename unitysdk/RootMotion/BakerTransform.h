...
#define ROOTMOTION_BAKERTRANSFORM_ADDLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1B6ED160)
#define ROOTMOTION_BAKERTRANSFORM_ADDROOTMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1B6ECA70)
#define ROOTMOTION_BAKERTRANSFORM_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1B6ECD30)
#define ROOTMOTION_BAKERTRANSFORM_RESET_OFFSET UNITYSDK_OFFSET(0x1B6EC660)
#define ROOTMOTION_BAKERTRANSFORM_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1B6EC790)
#define ROOTMOTION_BAKERTRANSFORM_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1B6ECE80)
#define ROOTMOTION_BAKERTRANSFORM_SETRELATIVESPACE_OFFSET UNITYSDK_OFFSET(0x1B6EC770)
#define ROOTMOTION_BAKERTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EC630)

namespace RootMotion
{
	inline static constexpr unsigned int BakerTransform_TypeDefinitionIndex = 36518;
