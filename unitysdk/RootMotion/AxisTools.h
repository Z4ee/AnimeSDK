...
#define ROOTMOTION_AXISTOOLS_GETAXISTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1F881CB0)
#define ROOTMOTION_AXISTOOLS_GETAXISTOPOINT_OFFSET UNITYSDK_OFFSET(0x1F881AC0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_1_OFFSET UNITYSDK_OFFSET(0x1F881E40)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1F881DD0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTOPOINT_OFFSET UNITYSDK_OFFSET(0x1F881C00)
#define ROOTMOTION_AXISTOOLS_TOAXIS_OFFSET UNITYSDK_OFFSET(0x1F881A70)
#define ROOTMOTION_AXISTOOLS_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1F881A10)
#define ROOTMOTION_AXISTOOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8821C0)

namespace RootMotion
{
	inline static constexpr unsigned int AxisTools_TypeDefinitionIndex = 38795;
