...
#define ROOTMOTION_AXISTOOLS_GETAXISTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1C115B90)
#define ROOTMOTION_AXISTOOLS_GETAXISTOPOINT_OFFSET UNITYSDK_OFFSET(0x1C115990)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_1_OFFSET UNITYSDK_OFFSET(0x1C115D20)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1C115CB0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTOPOINT_OFFSET UNITYSDK_OFFSET(0x1C115AE0)
#define ROOTMOTION_AXISTOOLS_TOAXIS_OFFSET UNITYSDK_OFFSET(0x1C115940)
#define ROOTMOTION_AXISTOOLS_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1C1158E0)
#define ROOTMOTION_AXISTOOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C116080)

namespace RootMotion
{
	inline static constexpr unsigned int AxisTools_TypeDefinitionIndex = 36521;
