...
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9B63E0)
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9B6410)
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9B6140)
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B6130)

namespace RootMotion
{
	inline static constexpr unsigned int SolverManager_PostLateUpdateDelegate_TypeDefinitionIndex = 36544;
