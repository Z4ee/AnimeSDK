...
#define CLASS_2_F94C658DA9FD0105_DISPOSE_OFFSET UNITYSDK_OFFSET(0x113F2B80)
#define CLASS_2_F94C658DA9FD0105_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x113F2BC0)
#define CLASS_2_F94C658DA9FD0105_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x113F2DE0)
#define CLASS_2_F94C658DA9FD0105_TICK_OFFSET UNITYSDK_OFFSET(0x113F2E30)
#define CLASS_2_F94C658DA9FD0105__CTOR_OFFSET UNITYSDK_OFFSET(0x113F2B70)

inline static constexpr unsigned int Class_2_F94C658DA9FD0105_TypeDefinitionIndex = 44437;

class Class_2_F94C658DA9FD0105 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetEffectAnimSpeed* Field_2_0; // 0x20
