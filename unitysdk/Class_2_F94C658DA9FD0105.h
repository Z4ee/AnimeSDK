...
#define CLASS_2_F94C658DA9FD0105_DISPOSE_OFFSET UNITYSDK_OFFSET(0x162DE1A0)
#define CLASS_2_F94C658DA9FD0105_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x162DE1E0)
#define CLASS_2_F94C658DA9FD0105_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x162DE460)
#define CLASS_2_F94C658DA9FD0105_TICK_OFFSET UNITYSDK_OFFSET(0x162DE4B0)
#define CLASS_2_F94C658DA9FD0105__CTOR_OFFSET UNITYSDK_OFFSET(0x162DE190)

inline static constexpr unsigned int Class_2_F94C658DA9FD0105_TypeDefinitionIndex = 52973;

class Class_2_F94C658DA9FD0105 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetEffectAnimSpeed* Field_2_0; // 0x18
