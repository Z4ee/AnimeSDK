...
#define CLASS_1_64B7A5556C27C456___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC1E870)
#define CLASS_1_64B7A5556C27C456___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC1E8A0)
#define CLASS_1_64B7A5556C27C456___C___CCTOR_B__68_0_OFFSET UNITYSDK_OFFSET(0x1EC1E8B0)
...
public:
	...
	{
		return (::Class_1_64B7A5556C27C456___c**)Il2CppClass::FromTypeDefinitionIndex(Class_1_64B7A5556C27C456___c_TypeDefinitionIndex)->GetStaticField(0x1CD30);
	}
