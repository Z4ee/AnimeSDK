...
#define CLASS_1_BDE834440C34BB91_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159B1A60)
#define CLASS_1_BDE834440C34BB91_METHOD_1_140ADD2330A35AD4_OFFSET UNITYSDK_OFFSET(0x159B3BA0)
#define CLASS_1_BDE834440C34BB91_METHOD_1_148E914DF5D0B2BA_OFFSET UNITYSDK_OFFSET(0x159B1E50)
#define CLASS_1_BDE834440C34BB91_METHOD_1_DF1CE6C8082AFAAD_OFFSET UNITYSDK_OFFSET(0x159B3660)
#define CLASS_1_BDE834440C34BB91__CTOR_OFFSET UNITYSDK_OFFSET(0x159B1A50)

inline static constexpr unsigned int Class_1_BDE834440C34BB91_TypeDefinitionIndex = 75508;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_8D31566281692B25*, ::Class_3_CD59F26A5F0E803D*))((::PBYTE)hIl2Cpp + CLASS_1_BDE834440C34BB91__CTOR_OFFSET))(this, a1, a2);
	}
