...
#define CLASS_1_33CD93C022C9C39F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15FA0060)
#define CLASS_1_33CD93C022C9C39F_METHOD_1_149A2B8BEDE501A7_OFFSET UNITYSDK_OFFSET(0x15F9FE80)
#define CLASS_1_33CD93C022C9C39F_METHOD_1_5A8B223EA7063738_OFFSET UNITYSDK_OFFSET(0x15F9FF50)
#define CLASS_1_33CD93C022C9C39F_METHOD_1_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x15FA04A0)
#define CLASS_1_33CD93C022C9C39F_METHOD_1_B1B466AFE3B0CC1E_OFFSET UNITYSDK_OFFSET(0x15FA0B30)
#define CLASS_1_33CD93C022C9C39F_METHOD_1_C350A11085903292_OFFSET UNITYSDK_OFFSET(0x15FA0A90)
#define CLASS_1_33CD93C022C9C39F_METHOD_1_EE7339DA6ECF5F6D_OFFSET UNITYSDK_OFFSET(0x15FA0890)
#define CLASS_1_33CD93C022C9C39F__CTOR_OFFSET UNITYSDK_OFFSET(0x15FA0C00)

inline static constexpr unsigned int Class_1_33CD93C022C9C39F_TypeDefinitionIndex = 76748;

class Class_1_33CD93C022C9C39F : public ::System::Object
{
public:
	// static const ::System::UInt32 Field_1_0 = 0x0; // 0x0
	::System::Collections::Concurrent::ConcurrentDictionary_2<::System::UInt32, ::Class_1_0AAA29E827EB555D*>* Field_1_1; // 0x10
	::Collections::Pooled::PooledSet_1<::System::UInt32>* Field_1_2; // 0x18
	::RPG::CustomRP::Quality Field_1_3; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_33CD93C022C9C39F_METHOD_1_96189EDEF38976A6_OFFSET))(this);
	}
