...
#define CLASS_2_7D656B7D2636EAEB_77_BINARYLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x19C544B0)
#define CLASS_2_7D656B7D2636EAEB_77_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19C53AE0)
#define CLASS_2_7D656B7D2636EAEB_77_ISTYPESTRICTLYEQUAL_OFFSET UNITYSDK_OFFSET(0x19C53BA0)
#define CLASS_2_7D656B7D2636EAEB_77_JSONDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x19C53BF0)
#define CLASS_2_7D656B7D2636EAEB_77__CTOR_OFFSET UNITYSDK_OFFSET(0x19C54B50)

inline static constexpr unsigned int Class_2_7D656B7D2636EAEB_77_TypeDefinitionIndex = 84417;
