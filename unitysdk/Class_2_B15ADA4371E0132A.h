...
#define CLASS_2_B15ADA4371E0132A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12AEF390)
#define CLASS_2_B15ADA4371E0132A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12AEF3D0)
#define CLASS_2_B15ADA4371E0132A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12AEF500)
#define CLASS_2_B15ADA4371E0132A_TICK_OFFSET UNITYSDK_OFFSET(0x12AEF550)
#define CLASS_2_B15ADA4371E0132A__CTOR_OFFSET UNITYSDK_OFFSET(0x12AEF380)

inline static constexpr unsigned int Class_2_B15ADA4371E0132A_TypeDefinitionIndex = 53861;

class Class_2_B15ADA4371E0132A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ResetBattleBGMToStage* Field_2_0; // 0x18
