...
#define CLASS_1_5B567C8A01BAEDFE_127_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19635EE0)
#define CLASS_1_5B567C8A01BAEDFE_127_CLONE_OFFSET UNITYSDK_OFFSET(0x19635CF0)
#define CLASS_1_5B567C8A01BAEDFE_127_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19635DF0)
#define CLASS_1_5B567C8A01BAEDFE_127_EQUALS_OFFSET UNITYSDK_OFFSET(0x19635D60)
#define CLASS_1_5B567C8A01BAEDFE_127_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19635E40)
#define CLASS_1_5B567C8A01BAEDFE_127_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19635F30)
#define CLASS_1_5B567C8A01BAEDFE_127_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19635F00)
#define CLASS_1_5B567C8A01BAEDFE_127_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19635C40)
#define CLASS_1_5B567C8A01BAEDFE_127_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19635CA0)
#define CLASS_1_5B567C8A01BAEDFE_127_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19635E70)
#define CLASS_1_5B567C8A01BAEDFE_127_WRITETO_OFFSET UNITYSDK_OFFSET(0x19635ED0)
#define CLASS_1_5B567C8A01BAEDFE_127__CCTOR_OFFSET UNITYSDK_OFFSET(0x19635F80)
#define CLASS_1_5B567C8A01BAEDFE_127__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19635CC0)
#define CLASS_1_5B567C8A01BAEDFE_127__CTOR_OFFSET UNITYSDK_OFFSET(0x19635CB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_127_TypeDefinitionIndex = 27234;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_127*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_127_TypeDefinitionIndex)->GetStaticField(0x60320);
	}
