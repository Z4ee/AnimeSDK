...
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_ACTIVESKILLEXP_OFFSET UNITYSDK_OFFSET(0x1A7EC4A0)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_CARNUMBER_OFFSET UNITYSDK_OFFSET(0x1A7EC480)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A7EC460)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_DEVELOPEDPARTS_OFFSET UNITYSDK_OFFSET(0x1A7EC520)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_EQUIPPEDPAINT_OFFSET UNITYSDK_OFFSET(0x1A7EC540)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_EQUIPPEDPARTS_OFFSET UNITYSDK_OFFSET(0x1A7EC500)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_STATVALUES_OFFSET UNITYSDK_OFFSET(0x1A7EC4C0)
#define CLASS_1_5AD3EC2EA1B1D5CD_GET_TARGETSTATTIERS_OFFSET UNITYSDK_OFFSET(0x1A7EC4E0)
#define CLASS_1_5AD3EC2EA1B1D5CD_METHOD_1_ADA85C40A3382050_1_OFFSET UNITYSDK_OFFSET(0x1A7EC740)
#define CLASS_1_5AD3EC2EA1B1D5CD_METHOD_1_ADA85C40A3382050_OFFSET UNITYSDK_OFFSET(0x1A7EC560)
#define CLASS_1_5AD3EC2EA1B1D5CD_METHOD_1_B2CC3047F75151AA_OFFSET UNITYSDK_OFFSET(0x1A7EC670)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_ACTIVESKILLEXP_OFFSET UNITYSDK_OFFSET(0x1A7EC4B0)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_CARNUMBER_OFFSET UNITYSDK_OFFSET(0x1A7EC490)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A7EC470)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_DEVELOPEDPARTS_OFFSET UNITYSDK_OFFSET(0x1A7EC530)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_EQUIPPEDPAINT_OFFSET UNITYSDK_OFFSET(0x1A7EC550)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_EQUIPPEDPARTS_OFFSET UNITYSDK_OFFSET(0x1A7EC510)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_STATVALUES_OFFSET UNITYSDK_OFFSET(0x1A7EC4D0)
#define CLASS_1_5AD3EC2EA1B1D5CD_SET_TARGETSTATTIERS_OFFSET UNITYSDK_OFFSET(0x1A7EC4F0)
#define CLASS_1_5AD3EC2EA1B1D5CD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7EC850)

inline static constexpr unsigned int Class_1_5AD3EC2EA1B1D5CD_TypeDefinitionIndex = 80359;

class Class_1_5AD3EC2EA1B1D5CD : public ::System::Object
{
public:
	// static const ::System::UInt32 GHJIDLDCHKL = 0x66; // 0x0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::B51RacingStatType, ::System::UInt32>* _TargetStatTiers_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::B51RacingPartType, ::System::Collections::Generic::List_1<::Class_1_961B0CA014B1FC95*>*>* _DevelopedParts_k__BackingField; // 0x18
	::Class_1_4F430D8CD5312CD8* _Config_k__BackingField; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::B51RacingPartType, ::Class_1_961B0CA014B1FC95*>* _EquippedParts_k__BackingField; // 0x28
	::Class_1_E2FB7E5A9E3705C7_3* _EquippedPaint_k__BackingField; // 0x30
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::B51RacingStatType, ::System::UInt32>* _StatValues_k__BackingField; // 0x38
	::System::UInt32 _CarNumber_k__BackingField; // 0x40
	::System::UInt32 _ActiveSkillExp_k__BackingField; // 0x44
