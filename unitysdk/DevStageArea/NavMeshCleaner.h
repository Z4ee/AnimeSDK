...
#define DEVSTAGEAREA_NAVMESHCLEANER__CTOR_OFFSET UNITYSDK_OFFSET(0x139349E0)

namespace DevStageArea
{
	inline static constexpr unsigned int NavMeshCleaner_TypeDefinitionIndex = 65130;
