...
#define CLASS_2_361A54BBF4779C04_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8858400)
#define CLASS_2_361A54BBF4779C04_METHOD_2_D012DDA5D8AEAA70_OFFSET UNITYSDK_OFFSET(0x88587F0)
#define CLASS_2_361A54BBF4779C04_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8858440)
#define CLASS_2_361A54BBF4779C04_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8858B20)
#define CLASS_2_361A54BBF4779C04_TICK_OFFSET UNITYSDK_OFFSET(0x8858B70)
#define CLASS_2_361A54BBF4779C04__CTOR_OFFSET UNITYSDK_OFFSET(0x8858330)

inline static constexpr unsigned int Class_2_361A54BBF4779C04_TypeDefinitionIndex = 44408;
