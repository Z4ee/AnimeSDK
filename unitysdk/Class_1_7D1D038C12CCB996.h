...
#define CLASS_1_7D1D038C12CCB996_METHOD_1_1E2EE7072F864BB5_OFFSET UNITYSDK_OFFSET(0xABFCD90)
#define CLASS_1_7D1D038C12CCB996_METHOD_1_3267D7B163015EF6_OFFSET UNITYSDK_OFFSET(0xABFBDF0)
#define CLASS_1_7D1D038C12CCB996_METHOD_1_4356052CF68E27BC_OFFSET UNITYSDK_OFFSET(0xABFCF00)
#define CLASS_1_7D1D038C12CCB996_METHOD_1_6ACD0D44FE3233A4_OFFSET UNITYSDK_OFFSET(0xABFBD40)
#define CLASS_1_7D1D038C12CCB996_METHOD_1_BCC20F6116C68B6A_OFFSET UNITYSDK_OFFSET(0xABFC930)
#define CLASS_1_7D1D038C12CCB996__CTOR_OFFSET UNITYSDK_OFFSET(0xABFD0F0)

inline static constexpr unsigned int Class_1_7D1D038C12CCB996_TypeDefinitionIndex = 48669;
...
public:
	...
	{
		return ((::System::Boolean(*)(::SimpleJSON::JSONClass*, ::SimpleJSON::JSONClass*))((::PBYTE)hIl2Cpp + CLASS_1_7D1D038C12CCB996_METHOD_1_BCC20F6116C68B6A_OFFSET))(a1, a2);
	}
	...
	static ::System::Boolean Method_1_4356052CF68E27BC(::SimpleJSON::JSONNode* a1, ::SimpleJSON::JSONNode* a2)
	{
		return ((::System::Boolean(*)(::SimpleJSON::JSONNode*, ::SimpleJSON::JSONNode*))((::PBYTE)hIl2Cpp + CLASS_1_7D1D038C12CCB996_METHOD_1_4356052CF68E27BC_OFFSET))(a1, a2);
	}
};
