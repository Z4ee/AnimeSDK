...
#define CLASS_2_B8756EBEFE499C71_DISPOSE_OFFSET UNITYSDK_OFFSET(0x108CE010)
#define CLASS_2_B8756EBEFE499C71_METHOD_2_0D7638DBC93E5002_1_OFFSET UNITYSDK_OFFSET(0x108CE910)
#define CLASS_2_B8756EBEFE499C71_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x108CE640)
#define CLASS_2_B8756EBEFE499C71_METHOD_2_295B0FA1282F1A6E_OFFSET UNITYSDK_OFFSET(0x108CE780)
#define CLASS_2_B8756EBEFE499C71_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x108CE0E0)
#define CLASS_2_B8756EBEFE499C71_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x108CE3C0)
#define CLASS_2_B8756EBEFE499C71_TICK_OFFSET UNITYSDK_OFFSET(0x108CE500)
#define CLASS_2_B8756EBEFE499C71__CTOR_OFFSET UNITYSDK_OFFSET(0x108CDEB0)

inline static constexpr unsigned int Class_2_B8756EBEFE499C71_TypeDefinitionIndex = 47323;
...
public:
	...
	::RPG::GameCore::ShowEnterPasswordPage* Field_2_0; // 0x38
