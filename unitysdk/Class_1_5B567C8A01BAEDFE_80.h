...
#define CLASS_1_5B567C8A01BAEDFE_80_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A03ECB0)
#define CLASS_1_5B567C8A01BAEDFE_80_CLONE_OFFSET UNITYSDK_OFFSET(0x1A03EB20)
#define CLASS_1_5B567C8A01BAEDFE_80_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A03EBC0)
#define CLASS_1_5B567C8A01BAEDFE_80_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A03EB60)
#define CLASS_1_5B567C8A01BAEDFE_80_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A03EC10)
#define CLASS_1_5B567C8A01BAEDFE_80_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A03ED00)
#define CLASS_1_5B567C8A01BAEDFE_80_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A03ECD0)
#define CLASS_1_5B567C8A01BAEDFE_80_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A03EAA0)
#define CLASS_1_5B567C8A01BAEDFE_80_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A03EAD0)
#define CLASS_1_5B567C8A01BAEDFE_80_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A03EC40)
#define CLASS_1_5B567C8A01BAEDFE_80_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A03ECA0)
#define CLASS_1_5B567C8A01BAEDFE_80__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A03ED50)
#define CLASS_1_5B567C8A01BAEDFE_80__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A03EAF0)
#define CLASS_1_5B567C8A01BAEDFE_80__CTOR_OFFSET UNITYSDK_OFFSET(0x1A03EAE0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_80_TypeDefinitionIndex = 25829;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_80_TypeDefinitionIndex)->GetStaticField(0x2D430);
	}
