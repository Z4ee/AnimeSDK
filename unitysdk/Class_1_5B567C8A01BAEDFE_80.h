...
#define CLASS_1_5B567C8A01BAEDFE_80_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D7E3440)
#define CLASS_1_5B567C8A01BAEDFE_80_CLONE_OFFSET UNITYSDK_OFFSET(0x1D7E3130)
#define CLASS_1_5B567C8A01BAEDFE_80_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D7E3240)
#define CLASS_1_5B567C8A01BAEDFE_80_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D7E3170)
#define CLASS_1_5B567C8A01BAEDFE_80_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D7E33A0)
#define CLASS_1_5B567C8A01BAEDFE_80_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D7E3490)
#define CLASS_1_5B567C8A01BAEDFE_80_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D7E3460)
#define CLASS_1_5B567C8A01BAEDFE_80_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D7E30B0)
#define CLASS_1_5B567C8A01BAEDFE_80_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D7E30E0)
#define CLASS_1_5B567C8A01BAEDFE_80_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D7E33D0)
#define CLASS_1_5B567C8A01BAEDFE_80_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D7E3430)
#define CLASS_1_5B567C8A01BAEDFE_80__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D7E34E0)
#define CLASS_1_5B567C8A01BAEDFE_80__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D7E3100)
#define CLASS_1_5B567C8A01BAEDFE_80__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E30F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_80_TypeDefinitionIndex = 27030;

class Class_1_5B567C8A01BAEDFE_80 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_80*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_80_TypeDefinitionIndex)->GetStaticField(0x3C530);
	}
