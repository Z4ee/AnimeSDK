...
#include "unitysdk/Class_1_49776B0E09344AA8_Struct_2_04D90A334135A87C_1.h"
...
#define CLASS_1_49776B0E09344AA8_METHOD_1_15B5FD54C4CEEA1E_OFFSET UNITYSDK_OFFSET(0x122571E0)
#define CLASS_1_49776B0E09344AA8_METHOD_1_289B514D3F9E6FBA_OFFSET UNITYSDK_OFFSET(0x122567F0)
#define CLASS_1_49776B0E09344AA8_METHOD_1_2967916D2F0F3EA5_OFFSET UNITYSDK_OFFSET(0x12256E10)
#define CLASS_1_49776B0E09344AA8_METHOD_1_300B5A4DCE3E1169_OFFSET UNITYSDK_OFFSET(0x12256170)
#define CLASS_1_49776B0E09344AA8_METHOD_1_334E2974515ABEF4_OFFSET UNITYSDK_OFFSET(0x122597E0)
#define CLASS_1_49776B0E09344AA8_METHOD_1_3CD2D83C87F46A2B_OFFSET UNITYSDK_OFFSET(0x12258470)
#define CLASS_1_49776B0E09344AA8_METHOD_1_462F66C3ADA9DDFE_OFFSET UNITYSDK_OFFSET(0x12257040)
#define CLASS_1_49776B0E09344AA8_METHOD_1_514125448B988326_OFFSET UNITYSDK_OFFSET(0x12259180)
#define CLASS_1_49776B0E09344AA8_METHOD_1_5733969903013487_OFFSET UNITYSDK_OFFSET(0x122586D0)
#define CLASS_1_49776B0E09344AA8_METHOD_1_5E7FABA4D5E7C76E_OFFSET UNITYSDK_OFFSET(0x12256280)
#define CLASS_1_49776B0E09344AA8_METHOD_1_77263D24A58AB58A_OFFSET UNITYSDK_OFFSET(0x12259520)
#define CLASS_1_49776B0E09344AA8_METHOD_1_8121B3C6E077454C_OFFSET UNITYSDK_OFFSET(0x12258290)
#define CLASS_1_49776B0E09344AA8_METHOD_1_859E039F50491B02_OFFSET UNITYSDK_OFFSET(0x12258750)
#define CLASS_1_49776B0E09344AA8_METHOD_1_8FE74818B6CAB22C_OFFSET UNITYSDK_OFFSET(0x12259240)
#define CLASS_1_49776B0E09344AA8_METHOD_1_97A2B621D1D21DFF_OFFSET UNITYSDK_OFFSET(0x12259760)
#define CLASS_1_49776B0E09344AA8_METHOD_1_BA477C1C7B39F8E1_OFFSET UNITYSDK_OFFSET(0x12258B80)
#define CLASS_1_49776B0E09344AA8_METHOD_1_BAF11821FC5492D1_OFFSET UNITYSDK_OFFSET(0x12257450)
#define CLASS_1_49776B0E09344AA8_METHOD_1_BF78D022CCEFBA4C_OFFSET UNITYSDK_OFFSET(0x12258910)
#define CLASS_1_49776B0E09344AA8_METHOD_1_C39B5F57AE810B5D_OFFSET UNITYSDK_OFFSET(0x12256B00)
#define CLASS_1_49776B0E09344AA8_METHOD_1_CA45A4ED6A6D7421_OFFSET UNITYSDK_OFFSET(0x12258AA0)
#define CLASS_1_49776B0E09344AA8_METHOD_1_DA3A39A1FFB19DA1_OFFSET UNITYSDK_OFFSET(0x12258670)
#define CLASS_1_49776B0E09344AA8_METHOD_1_DB62B0088E6661DB_OFFSET UNITYSDK_OFFSET(0x12259720)
#define CLASS_1_49776B0E09344AA8_METHOD_1_DEBAA4A63BA242E1_OFFSET UNITYSDK_OFFSET(0x12256500)
#define CLASS_1_49776B0E09344AA8_METHOD_1_FFCB21C8433F8F7D_OFFSET UNITYSDK_OFFSET(0x12257E40)

inline static constexpr unsigned int Class_1_49776B0E09344AA8_TypeDefinitionIndex = 85450;
...
public:
	...
	static ::System::Void Method_1_462F66C3ADA9DDFE(::MoleMole::HollowChessboard::HollowEntity* a1, ::Class_5_FCAF801AC482D3B5* a2, ::Class_5_FCAF801AC482D3B5* a3, ::MoleMole::HollowChessboard::HollowCell a4, ::MoleMole::HollowChessboard::HollowCell a5)
	{
		return ((::System::Void(*)(::MoleMole::HollowChessboard::HollowEntity*, ::Class_5_FCAF801AC482D3B5*, ::Class_5_FCAF801AC482D3B5*, ::MoleMole::HollowChessboard::HollowCell, ::MoleMole::HollowChessboard::HollowCell))((::PBYTE)hIl2Cpp + CLASS_1_49776B0E09344AA8_METHOD_1_462F66C3ADA9DDFE_OFFSET))(a1, a2, a3, a4, a5);
	}
	...
	static ::Cysharp::Threading::Tasks::UniTask Method_1_BF78D022CCEFBA4C(::MoleMole::HollowChessboard::HollowEntity* a1, ::Class_5_FCAF801AC482D3B5* a2, ::Class_5_FCAF801AC482D3B5* a3, ::MoleMole::HollowChessboard::HollowCell a4, ::MoleMole::HollowChessboard::HollowCell a5, ::System::Action* a6)
	{
		return ((::Cysharp::Threading::Tasks::UniTask(*)(::MoleMole::HollowChessboard::HollowEntity*, ::Class_5_FCAF801AC482D3B5*, ::Class_5_FCAF801AC482D3B5*, ::MoleMole::HollowChessboard::HollowCell, ::MoleMole::HollowChessboard::HollowCell, ::System::Action*))((::PBYTE)hIl2Cpp + CLASS_1_49776B0E09344AA8_METHOD_1_BF78D022CCEFBA4C_OFFSET))(a1, a2, a3, a4, a5, a6);
	}
	...
	static ::Cysharp::Threading::Tasks::UniTask Method_1_CA45A4ED6A6D7421(::MoleMole::HollowChessboard::HollowEntity* a1, ::Class_5_FCAF801AC482D3B5* a2, ::MoleMole::HollowChessboard::HollowCell a3)
	{
		return ((::Cysharp::Threading::Tasks::UniTask(*)(::MoleMole::HollowChessboard::HollowEntity*, ::Class_5_FCAF801AC482D3B5*, ::MoleMole::HollowChessboard::HollowCell))((::PBYTE)hIl2Cpp + CLASS_1_49776B0E09344AA8_METHOD_1_CA45A4ED6A6D7421_OFFSET))(a1, a2, a3);
	}
	...
	static ::System::Void Method_1_BAF11821FC5492D1(::MoleMole::HollowChessboard::HollowEntity* a1, ::Class_5_FCAF801AC482D3B5* a2, ::Class_5_FCAF801AC482D3B5* a3, ::MoleMole::HollowChessboard::HollowCell a4, ::MoleMole::HollowChessboard::HollowCell a5)
	{
		return ((::System::Void(*)(::MoleMole::HollowChessboard::HollowEntity*, ::Class_5_FCAF801AC482D3B5*, ::Class_5_FCAF801AC482D3B5*, ::MoleMole::HollowChessboard::HollowCell, ::MoleMole::HollowChessboard::HollowCell))((::PBYTE)hIl2Cpp + CLASS_1_49776B0E09344AA8_METHOD_1_BAF11821FC5492D1_OFFSET))(a1, a2, a3, a4, a5);
	}
	...
	static ::System::Void Method_1_FFCB21C8433F8F7D(::Class_5_FCAF801AC482D3B5* a1, ::Class_5_FCAF801AC482D3B5* a2, ::MoleMole::HollowChessboard::HollowCell a3, ::MoleMole::HollowChessboard::HollowCell a4)
	{
		return ((::System::Void(*)(::Class_5_FCAF801AC482D3B5*, ::Class_5_FCAF801AC482D3B5*, ::MoleMole::HollowChessboard::HollowCell, ::MoleMole::HollowChessboard::HollowCell))((::PBYTE)hIl2Cpp + CLASS_1_49776B0E09344AA8_METHOD_1_FFCB21C8433F8F7D_OFFSET))(a1, a2, a3, a4);
	}
	...
	static ::Class_5_A6F8D19602712D95* Method_1_DB62B0088E6661DB(::MoleMole::HollowChessboard::HollowCell a1, ::Class_1_49776B0E09344AA8_Struct_2_04D90A334135A87C_1& a2)
	{
		return ((::Class_5_A6F8D19602712D95*(*)(::MoleMole::HollowChessboard::HollowCell, ::Class_1_49776B0E09344AA8_Struct_2_04D90A334135A87C_1&))((::PBYTE)hIl2Cpp + CLASS_1_49776B0E09344AA8_METHOD_1_DB62B0088E6661DB_OFFSET))(a1, a2);
	}
