...
#define ATTACHPOINTSET_LATETICK_OFFSET UNITYSDK_OFFSET(0x158D55D0)
#define ATTACHPOINTSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x158D59D0)
#define ATTACHPOINTSET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x158D5540)
#define ATTACHPOINTSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x158D5400)
#define ATTACHPOINTSET_REFRESHLASTTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x158D5490)
#define ATTACHPOINTSET_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0x158D5810)
#define ATTACHPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0x158D5A20)

inline static constexpr unsigned int AttachPointSet_TypeDefinitionIndex = 45456;
