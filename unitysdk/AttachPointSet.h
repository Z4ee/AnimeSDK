...
#define ATTACHPOINTSET_LATETICK_OFFSET UNITYSDK_OFFSET(0x13BFFF70)
#define ATTACHPOINTSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13C00370)
#define ATTACHPOINTSET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13BFFEE0)
#define ATTACHPOINTSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13BFFDA0)
#define ATTACHPOINTSET_REFRESHLASTTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x13BFFE30)
#define ATTACHPOINTSET_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0x13C001B0)
#define ATTACHPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0x13C003C0)

inline static constexpr unsigned int AttachPointSet_TypeDefinitionIndex = 44584;
