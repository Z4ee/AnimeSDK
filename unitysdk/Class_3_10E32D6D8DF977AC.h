...
#define CLASS_3_10E32D6D8DF977AC_METHOD_3_28DFC52A1206DD2C_OFFSET UNITYSDK_OFFSET(0x1D5CF7B0)
#define CLASS_3_10E32D6D8DF977AC_METHOD_3_B291FB5C41D58000_OFFSET UNITYSDK_OFFSET(0x1D5CF7F0)
#define CLASS_3_10E32D6D8DF977AC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CF7E0)
...
{
public:
	::System::String* HHMLELABBFN; // 0x18
	::RPG::GameCore::ChenLingFesTargetConfig* GMJKHCGCNKA; // 0x20
	::System::String* KFEHPOFIOOA; // 0x28
	::RPG::GameCore::LittleGameEntityType EAMICGDAKCN; // 0x30
	::System::UInt32 CMNOEFFFNPE; // 0x34
	::System::UInt32 NJNFNFCJHFJ; // 0x38
	::RPG::GameCore::ChenLingFesTargetType HILNFHCPEAD; // 0x3C
