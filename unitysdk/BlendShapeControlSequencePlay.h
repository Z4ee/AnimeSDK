...
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETCURRENTUVSHIFT_OFFSET UNITYSDK_OFFSET(0x16A739F0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETNAPRENDERER_OFFSET UNITYSDK_OFFSET(0x16A73150)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x16A72C90)
#define BLENDSHAPECONTROLSEQUENCEPLAY_INITSEQUENCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x16A71CE0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16A722F0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16A71AE0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x16A71C30)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x16A71BA0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x16A720D0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_RESETDATA_OFFSET UNITYSDK_OFFSET(0x16A72C10)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SEARCHMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x16A736F0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x16A72340)
#define BLENDSHAPECONTROLSEQUENCEPLAY_START_OFFSET UNITYSDK_OFFSET(0x16A71C90)
#define BLENDSHAPECONTROLSEQUENCEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16A73B00)

inline static constexpr unsigned int BlendShapeControlSequencePlay_TypeDefinitionIndex = 45008;
