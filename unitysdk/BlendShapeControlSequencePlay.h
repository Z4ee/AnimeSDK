...
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETCURRENTUVSHIFT_OFFSET UNITYSDK_OFFSET(0x11432880)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETNAPRENDERER_OFFSET UNITYSDK_OFFSET(0x11431FE0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x11431B20)
#define BLENDSHAPECONTROLSEQUENCEPLAY_INITSEQUENCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x11430B70)
#define BLENDSHAPECONTROLSEQUENCEPLAY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11431180)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11430970)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x11430AC0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x11430A30)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x11430F60)
#define BLENDSHAPECONTROLSEQUENCEPLAY_RESETDATA_OFFSET UNITYSDK_OFFSET(0x11431AA0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SEARCHMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x11432580)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x114311D0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_START_OFFSET UNITYSDK_OFFSET(0x11430B20)
#define BLENDSHAPECONTROLSEQUENCEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x11432990)

inline static constexpr unsigned int BlendShapeControlSequencePlay_TypeDefinitionIndex = 55921;
