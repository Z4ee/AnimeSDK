...
#define CLASS_2_05AA2E5B0591C250_DISPOSE_OFFSET UNITYSDK_OFFSET(0x179B5430)
#define CLASS_2_05AA2E5B0591C250_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x179B5470)
#define CLASS_2_05AA2E5B0591C250_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x179B5BA0)
#define CLASS_2_05AA2E5B0591C250_TICK_OFFSET UNITYSDK_OFFSET(0x179B5BF0)
#define CLASS_2_05AA2E5B0591C250__CTOR_OFFSET UNITYSDK_OFFSET(0x179B5420)

inline static constexpr unsigned int Class_2_05AA2E5B0591C250_TypeDefinitionIndex = 50344;

class Class_2_05AA2E5B0591C250 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::DestroyNPCMonster* Field_2_1; // 0x20
