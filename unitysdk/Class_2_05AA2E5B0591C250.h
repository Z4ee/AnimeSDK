...
#define CLASS_2_05AA2E5B0591C250_DISPOSE_OFFSET UNITYSDK_OFFSET(0x160FA510)
#define CLASS_2_05AA2E5B0591C250_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x160FA550)
#define CLASS_2_05AA2E5B0591C250_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x160FAC90)
#define CLASS_2_05AA2E5B0591C250_TICK_OFFSET UNITYSDK_OFFSET(0x160FACE0)
#define CLASS_2_05AA2E5B0591C250__CTOR_OFFSET UNITYSDK_OFFSET(0x160FA500)

inline static constexpr unsigned int Class_2_05AA2E5B0591C250_TypeDefinitionIndex = 53007;

class Class_2_05AA2E5B0591C250 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::DestroyNPCMonster* OFKGLJOAMLD; // 0x18
