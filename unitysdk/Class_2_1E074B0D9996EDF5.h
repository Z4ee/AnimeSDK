...
#define CLASS_2_1E074B0D9996EDF5_METHOD_2_E4EE4D98EE55C81B_OFFSET UNITYSDK_OFFSET(0x1CA6B1C0)
#define CLASS_2_1E074B0D9996EDF5__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA6B2F0)
...
{
public:
	::RPG::MVector3 AIBGEDIGEOO; // 0x10
	::RPG::MVector3 LOLLEGPLMOO; // 0x1C
