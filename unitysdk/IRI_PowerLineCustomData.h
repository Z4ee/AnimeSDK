...
#define IRI_POWERLINECUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x142404F0)

inline static constexpr unsigned int IRI_PowerLineCustomData_TypeDefinitionIndex = 44854;
