...
#define IRI_POWERLINECUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x111DEAC0)

inline static constexpr unsigned int IRI_PowerLineCustomData_TypeDefinitionIndex = 38424;
