...
#define IRI_POWERLINECUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1241C170)

inline static constexpr unsigned int IRI_PowerLineCustomData_TypeDefinitionIndex = 44308;
