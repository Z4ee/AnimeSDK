...
#define CLASS_1_414BCDCDAD47B487_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xD164BC0)
#define CLASS_1_414BCDCDAD47B487_GET_DITHERSWITCH_OFFSET UNITYSDK_OFFSET(0xD164C20)
#define CLASS_1_414BCDCDAD47B487_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xD164BA0)
#define CLASS_1_414BCDCDAD47B487_GET_ISAUTOGEN_OFFSET UNITYSDK_OFFSET(0xD164C40)
#define CLASS_1_414BCDCDAD47B487_GET_ISPERSISTENT_OFFSET UNITYSDK_OFFSET(0xD164BB0)
#define CLASS_1_414BCDCDAD47B487_GET_LAYERTYPE_OFFSET UNITYSDK_OFFSET(0xD164C10)
#define CLASS_1_414BCDCDAD47B487_GET_LAYER_OFFSET UNITYSDK_OFFSET(0xD164C00)
#define CLASS_1_414BCDCDAD47B487_GET_LODDETAILLIST_OFFSET UNITYSDK_OFFSET(0xD164BF0)
#define CLASS_1_414BCDCDAD47B487_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD164B90)
#define CLASS_1_414BCDCDAD47B487_GET_NORMDISTANCE_OFFSET UNITYSDK_OFFSET(0xD164BD0)
#define CLASS_1_414BCDCDAD47B487_GET_OBJECTSIZE_OFFSET UNITYSDK_OFFSET(0xD164BE0)
#define CLASS_1_414BCDCDAD47B487_GET_SOURCELODTEMPLATE_OFFSET UNITYSDK_OFFSET(0xD164C60)
#define CLASS_1_414BCDCDAD47B487_GET_SOURCENORMDISTANCETEMPLATE_OFFSET UNITYSDK_OFFSET(0xD164C70)
#define CLASS_1_414BCDCDAD47B487_GET_SOURCETYPE_OFFSET UNITYSDK_OFFSET(0xD164C50)
#define CLASS_1_414BCDCDAD47B487_GET_USEAABBDIST_OFFSET UNITYSDK_OFFSET(0xD164C30)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_2A2D5F8C97A46780_OFFSET UNITYSDK_OFFSET(0xD164A70)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_ADE7EC82E13C7741_OFFSET UNITYSDK_OFFSET(0xD164940)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0xD1649D0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0xD164D40)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xD164DA0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0xD164C80)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FD97D7184557CB1A_1_OFFSET UNITYSDK_OFFSET(0xD164CA0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FD97D7184557CB1A_2_OFFSET UNITYSDK_OFFSET(0xD164CF0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FD97D7184557CB1A_OFFSET UNITYSDK_OFFSET(0xD164B30)
#define CLASS_1_414BCDCDAD47B487__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD1646F0)
#define CLASS_1_414BCDCDAD47B487__CTOR_OFFSET UNITYSDK_OFFSET(0xD1645F0)

inline static constexpr unsigned int Class_1_414BCDCDAD47B487_TypeDefinitionIndex = 68977;
...
public:
	...
	::Class_1_F756B10AB29D1235* Field_1_3; // 0x28
	::RPG::GameCore::NormDistanceLodTemplate* _SourceNormDistanceTemplate_k__BackingField; // 0x30
	::Il2CppArray<::RPG::GameCore::LodDetail*>* _LodDetailList_k__BackingField; // 0x38
	::RPG::GameCore::StreamingLayerType _LayerType_k__BackingField; // 0x40
	::System::Single _Distance_k__BackingField; // 0x44
	::System::Int32 _Index_k__BackingField; // 0x48
	::System::Boolean _UseAABBDist_k__BackingField; // 0x4C
	::System::Boolean _DitherSwitch_k__BackingField; // 0x4D
	::System::Boolean _IsPersistent_k__BackingField; // 0x4E
	::System::Boolean _IsAutoGen_k__BackingField; // 0x4F
	::System::Single _ObjectSize_k__BackingField; // 0x50
	::System::Single _NormDistance_k__BackingField; // 0x54
