...
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_ALIGNPARAMTYPE_OFFSET UNITYSDK_OFFSET(0x32EC50)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_ENABLEOVERINDEX_OFFSET UNITYSDK_OFFSET(0x6B3160)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_FROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x6B3140)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_HASANIM_OFFSET UNITYSDK_OFFSET(0x3645D0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_NOTINTERRUPTPRESCROLLIFCURNONEEDSCROLL_TEMPFOR1_0_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_OVERRIDEALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x40C750)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_SCROLLDIRECTION_OFFSET UNITYSDK_OFFSET(0x3B1DA0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_TARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_TARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_ALIGNPARAMTYPE_OFFSET UNITYSDK_OFFSET(0x32EC60)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_ENABLEOVERINDEX_OFFSET UNITYSDK_OFFSET(0x6B3170)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_FROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x6B3150)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_HASANIM_OFFSET UNITYSDK_OFFSET(0x55F930)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_NOTINTERRUPTPRESCROLLIFCURNONEEDSCROLL_TEMPFOR1_0_OFFSET UNITYSDK_OFFSET(0x48E360)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_OVERRIDEALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x6B3130)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_SCROLLDIRECTION_OFFSET UNITYSDK_OFFSET(0x6427B0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_TARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_TARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x446DA0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHALIGNPARAMTYPE_OFFSET UNITYSDK_OFFSET(0x6B3270)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHENABLEOVERINDEX_OFFSET UNITYSDK_OFFSET(0x6B3480)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHFROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x6B3400)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHNOTINTERRUPTPRESCROLLIFCURNONEEDSCROLL_TEMPFOR1_0_OFFSET UNITYSDK_OFFSET(0x6B3380)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHOVERRIDEALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x6B31E0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHSCROLLDIRECTION_OFFSET UNITYSDK_OFFSET(0x6B3300)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x6B31B0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6B3180)

inline static constexpr unsigned int MonoUITableScrollV2_ScrollToTargetContext_TypeDefinitionIndex = 69996;
