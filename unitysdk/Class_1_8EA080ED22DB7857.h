...
#define CLASS_1_8EA080ED22DB7857_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x11625910)
#define CLASS_1_8EA080ED22DB7857_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x11624840)
#define CLASS_1_8EA080ED22DB7857_GET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0x116248A0)
#define CLASS_1_8EA080ED22DB7857_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x116247E0)
#define CLASS_1_8EA080ED22DB7857_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x11624800)
#define CLASS_1_8EA080ED22DB7857_GET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0x11624880)
#define CLASS_1_8EA080ED22DB7857_GET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0x116248C0)
#define CLASS_1_8EA080ED22DB7857_GET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0x11624860)
#define CLASS_1_8EA080ED22DB7857_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x11624820)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_1699EE197DCC012D_OFFSET UNITYSDK_OFFSET(0x11625040)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_621F8E54F3755EEC_OFFSET UNITYSDK_OFFSET(0x11625420)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_633B64919EFDE65C_OFFSET UNITYSDK_OFFSET(0x116254C0)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_B3584D5964FDFB7E_OFFSET UNITYSDK_OFFSET(0x116248E0)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_C9BA836BA1E88EC0_OFFSET UNITYSDK_OFFSET(0x11624B40)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_EC5A942F906ED2A6_OFFSET UNITYSDK_OFFSET(0x11624AC0)
#define CLASS_1_8EA080ED22DB7857_SET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x11624850)
#define CLASS_1_8EA080ED22DB7857_SET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0x116248B0)
#define CLASS_1_8EA080ED22DB7857_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x116247F0)
#define CLASS_1_8EA080ED22DB7857_SET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x11624810)
#define CLASS_1_8EA080ED22DB7857_SET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0x11624890)
#define CLASS_1_8EA080ED22DB7857_SET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0x116248D0)
#define CLASS_1_8EA080ED22DB7857_SET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0x11624870)
#define CLASS_1_8EA080ED22DB7857_SET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x11624830)
#define CLASS_1_8EA080ED22DB7857__CTOR_OFFSET UNITYSDK_OFFSET(0x11624AB0)

inline static constexpr unsigned int Class_1_8EA080ED22DB7857_TypeDefinitionIndex = 78899;
...
public:
	...
	::RPG::GameCore::FixPoint _ShieldPower_k__BackingField; // 0x20
	::RPG::GameCore::FixPoint _HastePower_k__BackingField; // 0x28
	::RPG::GameCore::FixPoint _DamagePower_k__BackingField; // 0x30
	::RPG::GameCore::FixPoint _BurnPower_k__BackingField; // 0x38
	::RPG::GameCore::FixPoint _CoolDown_k__BackingField; // 0x40
	::RPG::GameCore::FixPoint _ChargePower_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _MultiPower_k__BackingField; // 0x50
