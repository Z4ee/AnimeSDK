...
#define CLASS_1_8EA080ED22DB7857_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xDD8C920)
#define CLASS_1_8EA080ED22DB7857_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B850)
#define CLASS_1_8EA080ED22DB7857_GET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B8B0)
#define CLASS_1_8EA080ED22DB7857_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xDD8B7F0)
#define CLASS_1_8EA080ED22DB7857_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B810)
#define CLASS_1_8EA080ED22DB7857_GET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B890)
#define CLASS_1_8EA080ED22DB7857_GET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B8D0)
#define CLASS_1_8EA080ED22DB7857_GET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B870)
#define CLASS_1_8EA080ED22DB7857_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B830)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_1699EE197DCC012D_OFFSET UNITYSDK_OFFSET(0xDD8C050)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_621F8E54F3755EEC_OFFSET UNITYSDK_OFFSET(0xDD8C430)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_633B64919EFDE65C_OFFSET UNITYSDK_OFFSET(0xDD8C4D0)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_B3584D5964FDFB7E_OFFSET UNITYSDK_OFFSET(0xDD8B8F0)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_C9BA836BA1E88EC0_OFFSET UNITYSDK_OFFSET(0xDD8BB50)
#define CLASS_1_8EA080ED22DB7857_METHOD_1_EC5A942F906ED2A6_OFFSET UNITYSDK_OFFSET(0xDD8BAD0)
#define CLASS_1_8EA080ED22DB7857_SET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B860)
#define CLASS_1_8EA080ED22DB7857_SET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B8C0)
#define CLASS_1_8EA080ED22DB7857_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xDD8B800)
#define CLASS_1_8EA080ED22DB7857_SET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B820)
#define CLASS_1_8EA080ED22DB7857_SET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B8A0)
#define CLASS_1_8EA080ED22DB7857_SET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B8E0)
#define CLASS_1_8EA080ED22DB7857_SET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B880)
#define CLASS_1_8EA080ED22DB7857_SET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xDD8B840)
#define CLASS_1_8EA080ED22DB7857__CTOR_OFFSET UNITYSDK_OFFSET(0xDD8BAC0)

inline static constexpr unsigned int Class_1_8EA080ED22DB7857_TypeDefinitionIndex = 75352;

class Class_1_8EA080ED22DB7857 : public ::System::Object
{
public:
	::Class_2_FFF9083835D38A52* Field_1_0; // 0x10
	::Class_1_0B6B39B929043B8F* Field_1_1; // 0x18
	::RPG::GameCore::FixPoint _HastePower_k__BackingField; // 0x20
	::RPG::GameCore::FixPoint _BurnPower_k__BackingField; // 0x28
	::RPG::GameCore::FixPoint _ChargePower_k__BackingField; // 0x30
	::RPG::GameCore::FixPoint _CoolDown_k__BackingField; // 0x38
	::RPG::GameCore::FixPoint _MultiPower_k__BackingField; // 0x40
	::RPG::GameCore::FixPoint _DamagePower_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _ShieldPower_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint _JamPower_k__BackingField; // 0x58
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_923*))((::PBYTE)hIl2Cpp + CLASS_1_8EA080ED22DB7857_METHOD_1_EC5A942F906ED2A6_OFFSET))(this, a1);
	}
