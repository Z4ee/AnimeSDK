...
#define CLASS_2_1DBC99898268989D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19915110)
#define CLASS_2_1DBC99898268989D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19915150)
#define CLASS_2_1DBC99898268989D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19915550)
#define CLASS_2_1DBC99898268989D_TICK_OFFSET UNITYSDK_OFFSET(0x199155A0)
#define CLASS_2_1DBC99898268989D__CTOR_OFFSET UNITYSDK_OFFSET(0x19915100)
...
public:
	...
	::RPG::GameCore::SetMonsterStanceBarStyle* OFKGLJOAMLD; // 0x20
