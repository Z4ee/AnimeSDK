...
#define SOFTBODYIK_ADDFORCE_1_OFFSET UNITYSDK_OFFSET(0x197E2410)
#define SOFTBODYIK_ADDFORCE_OFFSET UNITYSDK_OFFSET(0x197E20B0)
#define SOFTBODYIK_CHECKCURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0x197E2F90)
#define SOFTBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x197DEF30)
#define SOFTBODYIK_METHOD_5_15EF20217BD059DF_OFFSET UNITYSDK_OFFSET(0x197DF690)
#define SOFTBODYIK_METHOD_5_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x197DE0C0)
#define SOFTBODYIK_METHOD_5_3FD6E53B47B68444_OFFSET UNITYSDK_OFFSET(0x197E24A0)
#define SOFTBODYIK_METHOD_5_5362541F0053C52B_OFFSET UNITYSDK_OFFSET(0x197DF3E0)
#define SOFTBODYIK_METHOD_5_97E6634148C1D535_OFFSET UNITYSDK_OFFSET(0x197E0F90)
#define SOFTBODYIK_METHOD_5_A9B660A656DA65E2_OFFSET UNITYSDK_OFFSET(0x197DFB20)
#define SOFTBODYIK_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x197DF110)
#define SOFTBODYIK_METHOD_5_B80705A944339AA3_1_OFFSET UNITYSDK_OFFSET(0x197E06F0)
#define SOFTBODYIK_METHOD_5_B80705A944339AA3_OFFSET UNITYSDK_OFFSET(0x197E1870)
#define SOFTBODYIK_METHOD_5_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x197E1EB0)
#define SOFTBODYIK_METHOD_5_D3A7E03DEF3D4859_OFFSET UNITYSDK_OFFSET(0x197DFD30)
#define SOFTBODYIK_METHOD_5_EB49B73DCCB74433_OFFSET UNITYSDK_OFFSET(0x197E04A0)
#define SOFTBODYIK_REINITIALIZE_OFFSET UNITYSDK_OFFSET(0x197E2DA0)
#define SOFTBODYIK_RESETTOORIGINALSTATE_OFFSET UNITYSDK_OFFSET(0x197E28F0)
#define SOFTBODYIK_START_OFFSET UNITYSDK_OFFSET(0x197DE070)
#define SOFTBODYIK_TESTFORCE_OFFSET UNITYSDK_OFFSET(0x197E2DF0)
#define SOFTBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0x197E3E00)

inline static constexpr unsigned int SoftBodyIK_TypeDefinitionIndex = 47720;
...
public:
	...
	::UnityEngine::Vector3 OPPKAHNEILK; // 0x60
	::UnityEngine::Quaternion IKAHJHCHNMJ; // 0x6C
	::UnityEngine::Vector3 ODGGMCKDEBO; // 0x7C
	::UnityEngine::Vector3 JIOKOFADBKI; // 0x88
	::System::Boolean HGLEGIJBIMA; // 0x94
