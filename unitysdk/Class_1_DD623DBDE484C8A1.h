...
#define CLASS_1_DD623DBDE484C8A1_METHOD_1_169C9AE8F88E4F64_OFFSET UNITYSDK_OFFSET(0x14413870)
#define CLASS_1_DD623DBDE484C8A1__CTOR_OFFSET UNITYSDK_OFFSET(0x14413860)

inline static constexpr unsigned int Class_1_DD623DBDE484C8A1_TypeDefinitionIndex = 62739;

class Class_1_DD623DBDE484C8A1 : public ::System::Object
{
public:
	::System::Int32 Field_1_5; // 0x10
	::Enum_3_EBEEF823C6ADDCAA Field_1_0; // 0x14
