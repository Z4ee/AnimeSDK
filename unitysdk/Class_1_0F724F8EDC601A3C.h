...
#define CLASS_1_0F724F8EDC601A3C_METHOD_1_239127A8B01A1A3F_OFFSET UNITYSDK_OFFSET(0x1A3FB400)
#define CLASS_1_0F724F8EDC601A3C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FB500)
...
{
public:
	::RPG::GameCore::LoadingDescConditionType GMPGDEINODK; // 0x10
