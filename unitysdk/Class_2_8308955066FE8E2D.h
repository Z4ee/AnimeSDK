...
#define CLASS_2_8308955066FE8E2D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185C17D0)
#define CLASS_2_8308955066FE8E2D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x185C1810)
#define CLASS_2_8308955066FE8E2D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x185C1890)
#define CLASS_2_8308955066FE8E2D_TICK_OFFSET UNITYSDK_OFFSET(0x185C18E0)
#define CLASS_2_8308955066FE8E2D__CTOR_OFFSET UNITYSDK_OFFSET(0x185C17C0)

inline static constexpr unsigned int Class_2_8308955066FE8E2D_TypeDefinitionIndex = 56188;

class Class_2_8308955066FE8E2D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TutorialFinish* Field_2_0; // 0x18
