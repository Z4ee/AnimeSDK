...
#define CRPLIGHTQUALITYGROUPPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xACEF8C0)
#define CRPLIGHTQUALITYGROUPPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xACEF630)
#define CRPLIGHTQUALITYGROUPPLUGIN_TRYTURNONLIGHT_OFFSET UNITYSDK_OFFSET(0xACEFCA0)
#define CRPLIGHTQUALITYGROUPPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xACEFDF0)

inline static constexpr unsigned int CRPLightQualityGroupPlugin_TypeDefinitionIndex = 44108;
