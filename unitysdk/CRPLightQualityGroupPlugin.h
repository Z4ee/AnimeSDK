...
#define CRPLIGHTQUALITYGROUPPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA6D4740)
#define CRPLIGHTQUALITYGROUPPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA6D44B0)
#define CRPLIGHTQUALITYGROUPPLUGIN_TRYTURNONLIGHT_OFFSET UNITYSDK_OFFSET(0xA6D4B20)
#define CRPLIGHTQUALITYGROUPPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D4C70)

inline static constexpr unsigned int CRPLightQualityGroupPlugin_TypeDefinitionIndex = 38224;
