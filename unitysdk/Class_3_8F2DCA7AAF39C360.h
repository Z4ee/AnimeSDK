...
#define CLASS_3_8F2DCA7AAF39C360_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x12752CD0)
#define CLASS_3_8F2DCA7AAF39C360_METHOD_3_8015C1C6E62C7AE5_OFFSET UNITYSDK_OFFSET(0x12752DB0)
#define CLASS_3_8F2DCA7AAF39C360_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x12752E00)
#define CLASS_3_8F2DCA7AAF39C360_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x12752E90)
#define CLASS_3_8F2DCA7AAF39C360_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x12752C80)
#define CLASS_3_8F2DCA7AAF39C360__CCTOR_OFFSET UNITYSDK_OFFSET(0x12752D20)
#define CLASS_3_8F2DCA7AAF39C360__CTOR_OFFSET UNITYSDK_OFFSET(0x12752DA0)

inline static constexpr unsigned int Class_3_8F2DCA7AAF39C360_TypeDefinitionIndex = 80044;

class Class_3_8F2DCA7AAF39C360 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_0 = 0xB9; // 0x0
	::MoleMole::MonoEffectPluginSyncEntityPos* Field_3_1; // 0x48
