...
#define BLOODFLOWDRAWINSTANCE_GET_MAXNUMINSTANCES_OFFSET UNITYSDK_OFFSET(0x9B94430)
#define BLOODFLOWDRAWINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x9B94AC0)
#define BLOODFLOWDRAWINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B94480)

inline static constexpr unsigned int BloodFlowDrawInstance_TypeDefinitionIndex = 44198;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Keyframe>**)Il2CppClass::FromTypeDefinitionIndex(BloodFlowDrawInstance_TypeDefinitionIndex)->GetStaticField(0x6A2F0);
	}
