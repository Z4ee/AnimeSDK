...
#define BLOODFLOWDRAWINSTANCE_GET_MAXNUMINSTANCES_OFFSET UNITYSDK_OFFSET(0xC4F1C80)
#define BLOODFLOWDRAWINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0xC4F21C0)
#define BLOODFLOWDRAWINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4F1CD0)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Keyframe>**)Il2CppClass::FromTypeDefinitionIndex(BloodFlowDrawInstance_TypeDefinitionIndex)->GetStaticField(0x60040);
	}
