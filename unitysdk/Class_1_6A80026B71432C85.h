...
#define CLASS_1_6A80026B71432C85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16BFD8F0)
#define CLASS_1_6A80026B71432C85_INIT_OFFSET UNITYSDK_OFFSET(0x16BFD7A0)
#define CLASS_1_6A80026B71432C85_ONENTER_OFFSET UNITYSDK_OFFSET(0x16BFD870)
#define CLASS_1_6A80026B71432C85_ONEXIT_OFFSET UNITYSDK_OFFSET(0x16BFD8B0)
#define CLASS_1_6A80026B71432C85_PREPAREONSTARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x16BFD7F0)
#define CLASS_1_6A80026B71432C85__CTOR_OFFSET UNITYSDK_OFFSET(0x16BFD930)

inline static constexpr unsigned int Class_1_6A80026B71432C85_TypeDefinitionIndex = 77913;
