...
#define CLASS_1_6A80026B71432C85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14CE1E00)
#define CLASS_1_6A80026B71432C85_INIT_OFFSET UNITYSDK_OFFSET(0x14CE1CB0)
#define CLASS_1_6A80026B71432C85_ONENTER_OFFSET UNITYSDK_OFFSET(0x14CE1D80)
#define CLASS_1_6A80026B71432C85_ONEXIT_OFFSET UNITYSDK_OFFSET(0x14CE1DC0)
#define CLASS_1_6A80026B71432C85_PREPAREONSTARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x14CE1D00)
#define CLASS_1_6A80026B71432C85__CTOR_OFFSET UNITYSDK_OFFSET(0x14CE1E40)

inline static constexpr unsigned int Class_1_6A80026B71432C85_TypeDefinitionIndex = 74428;
