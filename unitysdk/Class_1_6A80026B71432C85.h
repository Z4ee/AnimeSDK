...
#define CLASS_1_6A80026B71432C85_DISPOSE_OFFSET UNITYSDK_OFFSET(0xABE4E60)
#define CLASS_1_6A80026B71432C85_INIT_OFFSET UNITYSDK_OFFSET(0xABE4D10)
#define CLASS_1_6A80026B71432C85_ONENTER_OFFSET UNITYSDK_OFFSET(0xABE4DE0)
#define CLASS_1_6A80026B71432C85_ONEXIT_OFFSET UNITYSDK_OFFSET(0xABE4E20)
#define CLASS_1_6A80026B71432C85_PREPAREONSTARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xABE4D60)
#define CLASS_1_6A80026B71432C85__CTOR_OFFSET UNITYSDK_OFFSET(0xABE4EA0)

inline static constexpr unsigned int Class_1_6A80026B71432C85_TypeDefinitionIndex = 72903;
