...
#define CLASS_1_DB8D2359E085AA87_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155298C0)
#define CLASS_1_DB8D2359E085AA87_GET_PLAYMODE_OFFSET UNITYSDK_OFFSET(0x1552C4D0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_102AF9E4BB61DA4D_OFFSET UNITYSDK_OFFSET(0x1552BA20)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1552B7E0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1552A020)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_187B835A9D811184_OFFSET UNITYSDK_OFFSET(0x15529990)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_25C1D63D5CD4CAF9_OFFSET UNITYSDK_OFFSET(0x1552B150)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_2BFC239DC1CC6011_OFFSET UNITYSDK_OFFSET(0x1552BD60)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_2D1E645E1D19FB69_OFFSET UNITYSDK_OFFSET(0x1552A790)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x15529F50)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_3103666BB5017625_OFFSET UNITYSDK_OFFSET(0x1552C450)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0x1552A210)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_3CADA8B8868A94B7_OFFSET UNITYSDK_OFFSET(0x1552AD90)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_40ED258E7B928165_OFFSET UNITYSDK_OFFSET(0x1552A510)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_41257D8583D30E48_OFFSET UNITYSDK_OFFSET(0x1552C130)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1552A160)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x1552A600)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_4C288C0C3DC7B4CA_OFFSET UNITYSDK_OFFSET(0x1552B900)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_57F17F1D6A27CB64_OFFSET UNITYSDK_OFFSET(0x1552C360)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_6250E00298E4B8BC_OFFSET UNITYSDK_OFFSET(0x1552AA20)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_73C75C834F119161_OFFSET UNITYSDK_OFFSET(0x1552B640)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_7C35D2BC7FBDA31C_OFFSET UNITYSDK_OFFSET(0x1552B1E0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_9407BADC2B8047B6_OFFSET UNITYSDK_OFFSET(0x1552AB10)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1552B890)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_99CAAAB23A959235_OFFSET UNITYSDK_OFFSET(0x1552B6A0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_9F2F0B0E740BB579_OFFSET UNITYSDK_OFFSET(0x1552B250)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x1552B5B0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_B2040612BB29E8BB_OFFSET UNITYSDK_OFFSET(0x1552BD10)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x1552A260)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1552A1D0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_DFC263D3AB138D01_OFFSET UNITYSDK_OFFSET(0x1552ABD0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_EA7C9571288E1295_OFFSET UNITYSDK_OFFSET(0x1552B370)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x15529FD0)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_F87916206B4C2FC7_OFFSET UNITYSDK_OFFSET(0x1552BB70)
#define CLASS_1_DB8D2359E085AA87_METHOD_1_F9555880FBE027D5_OFFSET UNITYSDK_OFFSET(0x1552AF30)
#define CLASS_1_DB8D2359E085AA87_SET_PLAYMODE_OFFSET UNITYSDK_OFFSET(0x1552C4E0)
#define CLASS_1_DB8D2359E085AA87__CCTOR_OFFSET UNITYSDK_OFFSET(0x1552C6F0)
#define CLASS_1_DB8D2359E085AA87__CTOR_OFFSET UNITYSDK_OFFSET(0x1552C4F0)
#define CLASS_1_DB8D2359E085AA87__SPAWNUICONTROLLER_B__24_0_OFFSET UNITYSDK_OFFSET(0x1552C720)
#define CLASS_1_DB8D2359E085AA87___CREATEVIDEOTEXTURE_B__22_0_OFFSET UNITYSDK_OFFSET(0x1552C710)

inline static constexpr unsigned int Class_1_DB8D2359E085AA87_TypeDefinitionIndex = 73120;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DB8D2359E085AA87_TypeDefinitionIndex)->GetStaticField(0x14E0);
	}
	static ::System::Int32* StaticGet_MIONLNENENI()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DB8D2359E085AA87_TypeDefinitionIndex)->GetStaticField(0x14E4);
	}
	static ::System::Int32* StaticGet_GPFPNHHAACC()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DB8D2359E085AA87_TypeDefinitionIndex)->GetStaticField(0x14E8);
	}
	...
	::UnityEngine::Shader* JBNKALCBMEL; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::CriWare::CriManaMovieMaterial*>* JFPPBDJLBLG; // 0x18
	::System::Collections::Generic::List_1<::CriWare::CriManaMovieController*>* FLNEKJAFGGH; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_0A58DDD24CA46B3B*>* NOPMBHGJHMP; // 0x28
	::UnityEngine::GameObject* CGAMDBOLHLA; // 0x30
	::System::Collections::Generic::HashSet_1<::Class_2_1611AD1A09A7A324*>* IHHFDIEDEHF; // 0x38
	::CriWare::CriManaVP9Initializer* FNIDGGBFPPG; // 0x40
	::CriWare::CriWareErrorHandler* GEPONNBNGHF; // 0x48
	::System::Collections::Generic::List_1<::Class_1_0A58DDD24CA46B3B*>* ANGNFJIGNOC; // 0x50
	::UnityEngine::Shader* POMDJBNGCLL; // 0x58
	::System::Collections::Generic::List_1<::CriWare::CriManaMovieController*>* FBDGNNLPCGB; // 0x60
	::CriWare::CriWareInitializer* MMINIDBGNDM; // 0x68
	::System::Int32 JAAADFGGDJI; // 0x70
	::System::Boolean MMMENIJLAJE; // 0x74
	::System::Boolean NFNNIPBFDCA; // 0x75
	::System::Int32 DIFFFBMGAHC; // 0x78
	::RPG::Client::EVideoPlayMode _PlayMode_k__BackingField; // 0x7C
	::System::Single FIFJJJDDJFH; // 0x80
	::System::Int32 BLMMNEOJCGP; // 0x84
	::System::Int32 NGGKEMLIEAK; // 0x88
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_DB8D2359E085AA87_METHOD_1_1290EA767C459179_OFFSET))(this);
	}
