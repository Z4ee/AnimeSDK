...
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824_METHOD_1_0EAC696610085644_OFFSET UNITYSDK_OFFSET(0xB644D90)
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824_METHOD_1_5A5C2C2245BED1D2_OFFSET UNITYSDK_OFFSET(0xB641F40)
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824_METHOD_1_6A4C4FE2123534CE_OFFSET UNITYSDK_OFFSET(0xB648B80)
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824_METHOD_1_9557973674FE3DBD_OFFSET UNITYSDK_OFFSET(0xB6421A0)
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824_METHOD_1_978871DC1BE4B568_1_OFFSET UNITYSDK_OFFSET(0xB648B00)
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824_METHOD_1_978871DC1BE4B568_OFFSET UNITYSDK_OFFSET(0xB648A80)
#define CLASS_1_195081730F1669B6_CLASS_1_A07D6A22A9F47824__CTOR_OFFSET UNITYSDK_OFFSET(0xB63EA50)
...
{
public:
	::Class_1_43BD383C98B4C0C5_130* JDMIDPLGJHB; // 0x10
	::Class_1_843DD6330B22E422* DKLIOLLHPCD; // 0x18
	::System::String* CIFMMNHCFPP; // 0x20
	::System::String* BIHJOMFOPEF; // 0x28
	::System::String* MGNNLEMDOEP; // 0x30
	::System::String* CIDCEJCGOGB; // 0x38
	::System::String* CMBEAABNPNF; // 0x40
	::System::String* HCJJMPFAMPG; // 0x48
	::Il2CppArray<::RPG::GameCore::FixPoint>* NCJEDLGIKID; // 0x50
	::RPG::GameCore::AttackData* GGEEAPOJKGA; // 0x58
	::System::String* FCCIKPPNBIB; // 0x60
	::System::String* JJIGHCMEIOG; // 0x68
	::System::String* KBKOGLCAEKG; // 0x70
	::System::String* EIPCCBAIILO; // 0x78
	::Il2CppArray<::RPG::GameCore::FixPoint>* LFJADFGHCAG; // 0x80
	::System::String* OOKIKHKPMDB; // 0x88
	::RPG::GameCore::FixPoint GICPKLPMOHL; // 0x90
	::System::UInt32 BOKJJKFCFME; // 0x98
	::RPG::GameCore::AttackType BCGMMBMLAAC; // 0x9C
	::System::Boolean DFBLNFEGBFP; // 0xA0
	::System::Boolean KNDCAHDDHCO; // 0xA1
	::System::UInt32 EPPHNPFFPOE; // 0xA4
	::RPG::GameCore::FixPoint EOMBCKAJDAK; // 0xA8
	::RPG::GameCore::FixPoint AADEILGEDJN; // 0xB0
	::RPG::GameCore::FixPoint NDABIMGKOMC; // 0xB8
	::RPG::GameCore::FixPoint MMBEINNANKF; // 0xC0
	::RPG::GameCore::FixPoint ACBENJHBMFE; // 0xC8
	::RPG::GameCore::FixPoint PMEGJKPHDMH; // 0xD0
	::RPG::GameCore::FixPoint MDCBJNEONIJ; // 0xD8
	::RPG::GameCore::FixPoint FGJJDAGBAIK; // 0xE0
	::RPG::GameCore::TeamType IBGEPEHFBOF; // 0xE8
	::RPG::GameCore::SkillType JBCBONFABOM; // 0xEC
	::RPG::GameCore::FixPoint HAIMFCEPABC; // 0xF0
	::RPG::GameCore::FixPoint LLEEFHICECO; // 0xF8
	::RPG::GameCore::FixPoint KNGKLAIMGMP; // 0x100
	::RPG::GameCore::TeamType LHKHAOBIADO; // 0x108
	::System::Int32 FAICKBGJPNF; // 0x10C
	::Class_1_195081730F1669B6_BattleActionType GMPGDEINODK; // 0x110
	::System::UInt32 CPDPJFEEHHG; // 0x114
	::RPG::GameCore::FixPoint KFDBCMOPLKC; // 0x118
	::RPG::GameCore::FixPoint MDFKCMGPPDM; // 0x120
	::RPG::GameCore::FixPoint GKLLOMFGMBI; // 0x128
	::RPG::GameCore::FixPoint DPCJEJNLPAL; // 0x130
	::System::Single GAFENHHEBPG; // 0x138
	::System::Int32 FGIGJGGFIOP; // 0x13C
	::RPG::GameCore::FixPoint CBBGLNDJEEE; // 0x140
