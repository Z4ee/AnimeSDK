...
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x17DFD120)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x17DFD0B0)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_363BD7C9D66CD9F8_OFFSET UNITYSDK_OFFSET(0x17DFD1E0)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_49B12BACA95FCC04_OFFSET UNITYSDK_OFFSET(0x17DFE0B0)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_4B8BB754EBD146AC_OFFSET UNITYSDK_OFFSET(0x17DFD160)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x17DFD0A0)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_6287030D53179AEE_OFFSET UNITYSDK_OFFSET(0x17DFDF00)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_899900EC2E5E417B_OFFSET UNITYSDK_OFFSET(0x17DFD3F0)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_DB6CA4A20DE1FB9D_OFFSET UNITYSDK_OFFSET(0x17DFED50)
#define CLASS_1_ED17B6CCBE9C897A_METHOD_1_F22773CFEB4B61E4_OFFSET UNITYSDK_OFFSET(0x17DFD370)
#define CLASS_1_ED17B6CCBE9C897A__CTOR_OFFSET UNITYSDK_OFFSET(0x17DFF100)
...
{
public:
	::UnityEngine::Transform* DHCAEEGOLIM; // 0x10
	::UnityEngine::Transform* CJLFBMEPOPA; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Quaternion>* PIOADIJCHJC; // 0x20
	::UnityEngine::Transform* CHHEMDFJCEH; // 0x28
	::System::Collections::Generic::List_1<::Class_1_ED17B6CCBE9C897A_Class_1_9EABF2B790586FE2*>* EMHKPLPNOJH; // 0x30
	::System::Single GGNNHDAIEMG; // 0x38
	::Class_1_ED17B6CCBE9C897A_EEffectorSpace GIKHKIEFLOL; // 0x3C
	::System::Single KJLHNBJMPDC; // 0x40
	::UnityEngine::Vector3 FMOODJPLAHC; // 0x44
