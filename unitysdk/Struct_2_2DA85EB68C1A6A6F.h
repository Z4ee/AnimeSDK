...
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_006E258B22EA43C8_OFFSET UNITYSDK_OFFSET(0x117952B0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x71FDB0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_222592086BA83928_OFFSET UNITYSDK_OFFSET(0x71FDA0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_224D6B6433F0D411_OFFSET UNITYSDK_OFFSET(0x71FE10)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x71FD30)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_89C1A5C779599670_OFFSET UNITYSDK_OFFSET(0x6E27D0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_AC2B82F3D026F3EA_1_OFFSET UNITYSDK_OFFSET(0x71FE50)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_AC2B82F3D026F3EA_OFFSET UNITYSDK_OFFSET(0x71FDD0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_BCDF1C0553E211C6_OFFSET UNITYSDK_OFFSET(0x71FDF0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x71FD60)
#define STRUCT_2_2DA85EB68C1A6A6F_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x71FCB0)
#define STRUCT_2_2DA85EB68C1A6A6F_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x71FCF0)
#define STRUCT_2_2DA85EB68C1A6A6F__CCTOR_OFFSET UNITYSDK_OFFSET(0x11795A50)
#define STRUCT_2_2DA85EB68C1A6A6F__CTOR_OFFSET UNITYSDK_OFFSET(0x71FA40)

inline static constexpr unsigned int Struct_2_2DA85EB68C1A6A6F_TypeDefinitionIndex = 55406;

struct alignas(8) Struct_2_2DA85EB68C1A6A6F
{
	static ::Struct_2_2DA85EB68C1A6A6F* StaticGet_Field_2_4()
	{
		return (::Struct_2_2DA85EB68C1A6A6F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_2DA85EB68C1A6A6F_TypeDefinitionIndex)->GetStaticField(0xED00);
	}
