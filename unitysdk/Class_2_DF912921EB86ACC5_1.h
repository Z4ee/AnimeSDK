...
#define CLASS_2_DF912921EB86ACC5_1_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x15B92550)
#define CLASS_2_DF912921EB86ACC5_1_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x15B92A50)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x15B90890)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_27EBB2381EBD0C34_OFFSET UNITYSDK_OFFSET(0x15B91990)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_33ABFC364E341C89_OFFSET UNITYSDK_OFFSET(0x15B912C0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_3B7F6352EF818AEA_OFFSET UNITYSDK_OFFSET(0x15B90F50)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_457717A0CF438A7C_OFFSET UNITYSDK_OFFSET(0x15B907B0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x15B90C60)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_4BE99DDCF7F1FD88_OFFSET UNITYSDK_OFFSET(0x15B915E0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_77EA5BCD93BD96AE_OFFSET UNITYSDK_OFFSET(0x15B909D0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_8A3D91A38AD395C0_OFFSET UNITYSDK_OFFSET(0x15B90E30)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_9839DFE3C10E4654_OFFSET UNITYSDK_OFFSET(0x15B91350)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_9D455FE4693966A8_OFFSET UNITYSDK_OFFSET(0x15B91750)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_A6B0F2C779192279_OFFSET UNITYSDK_OFFSET(0x15B90CF0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0x15B91230)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_AB379526BCF8122B_OFFSET UNITYSDK_OFFSET(0x15B906B0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x15B910F0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_C0848FE1BD81D8B4_OFFSET UNITYSDK_OFFSET(0x15B91A30)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15B90990)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_CC95FA0CD2CB9EB2_OFFSET UNITYSDK_OFFSET(0x15B914F0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x15B918C0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x15B91180)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0x15B91C60)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_DA1BF2C227DC3D86_2_OFFSET UNITYSDK_OFFSET(0x15B91CB0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x15B91C10)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_DCE709D1A4B35861_OFFSET UNITYSDK_OFFSET(0x15B90610)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x15B920E0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x15B921A0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_3_OFFSET UNITYSDK_OFFSET(0x15B92230)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_4_OFFSET UNITYSDK_OFFSET(0x15B922F0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_5_OFFSET UNITYSDK_OFFSET(0x15B923D0)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_6_OFFSET UNITYSDK_OFFSET(0x15B92490)
#define CLASS_2_DF912921EB86ACC5_1_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x15B91ED0)
#define CLASS_2_DF912921EB86ACC5_1_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x15B90800)
#define CLASS_2_DF912921EB86ACC5_1_ONRETURN_OFFSET UNITYSDK_OFFSET(0x15B90930)
#define CLASS_2_DF912921EB86ACC5_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15B92DE0)
#define CLASS_2_DF912921EB86ACC5_1__ONBIND_OFFSET UNITYSDK_OFFSET(0x15B900E0)
#define CLASS_2_DF912921EB86ACC5_1__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x15B90AD0)
#define CLASS_2_DF912921EB86ACC5_1__ONTICK_OFFSET UNITYSDK_OFFSET(0x15B90B20)

inline static constexpr unsigned int Class_2_DF912921EB86ACC5_1_TypeDefinitionIndex = 71665;
...
public:
	...
	::UnityEngine::Transform* AFBPLKJNAFK; // 0x70
	::Class_2_F253BDBB0669BC76* BEHLFAEJFEH; // 0x78
	::RPG::Client::MonoInControlTip* OOBBOFLHLDH; // 0x80
	::UnityEngine::Transform* ENIOLPBCHLK; // 0x88
	::Class_2_5A17D97436D48D36* IOOAKAGEMAO; // 0x90
	::UnityEngine::Transform* GDGDNANJFKI; // 0x98
	::UnityEngine::UI::Image* ANIHJHGMMDP; // 0xA0
	::Class_3_C922191B32E5C6F1* HKCICBFPGGF; // 0xA8
	::Class_2_BEBFA6F35799FF11* LEFDOCOCCBH; // 0xB0
	::UnityEngine::Transform* HIGKIILCPEP; // 0xB8
	::UnityEngine::Transform* FGHFLHBEGHJ; // 0xC0
	::Class_2_7FD0A88267681658* COLBKPIKJOO; // 0xC8
	::RPG::Client::PrefabLoadMeta* CKGIPACADAL; // 0xD0
	::UnityEngine::Animation* NJDJFFENGOJ; // 0xD8
	::Class_2_A7947638CBFEF9CF* KFILGHMECDL; // 0xE0
	::UnityEngine::Transform* KMPHCBLIPAN; // 0xE8
	::Class_1_915BD94BEC3C8A71* EKJFNFKADAA; // 0xF0
	::UnityEngine::Animation* IGCIKMHNLLC; // 0xF8
	::System::Single CMKOAALCKAO; // 0x100
	::System::Boolean FMBKOCPMBDF; // 0x104
	::System::Boolean ACAPCHBDIBF; // 0x105
	::System::Boolean FFIAGGGEAEG; // 0x106
	::System::Boolean FHBNNGCEPFD; // 0x107
	::RPG::GameCore::BossHeadEffType IDPCLIFIAEB; // 0x108
