...
#define NPCEMOTIONEFFECTCONFIG_GETEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x10A0F3B0)
#define NPCEMOTIONEFFECTCONFIG_UNLOADASSETS_OFFSET UNITYSDK_OFFSET(0x10A0F530)
#define NPCEMOTIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10A0F570)

inline static constexpr unsigned int NPCEmotionEffectConfig_TypeDefinitionIndex = 83499;
