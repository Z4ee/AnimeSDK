...
#define TRACKCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB99DA80)
#define TRACKCAMERACONTROLLER_INITVC_OFFSET UNITYSDK_OFFSET(0xB99DD10)
#define TRACKCAMERACONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xB99DEC0)
#define TRACKCAMERACONTROLLER_MAPRATIOSTATIC_OFFSET UNITYSDK_OFFSET(0xB99E750)
#define TRACKCAMERACONTROLLER_MAPRATIO_OFFSET UNITYSDK_OFFSET(0xB99E460)
#define TRACKCAMERACONTROLLER_METHOD_5_A36544CA17714445_OFFSET UNITYSDK_OFFSET(0xB99E1B0)
#define TRACKCAMERACONTROLLER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB99E800)
#define TRACKCAMERACONTROLLER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB99E7C0)
#define TRACKCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB99DE60)
#define TRACKCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB99E840)

inline static constexpr unsigned int TrackCameraController_TypeDefinitionIndex = 44072;
...
public:
	...
	::UnityEngine::Vector3 Method_5_A36544CA17714445(::System::Collections::Generic::List_1<::UnityEngine::Vector3>* a1, ::System::Single a2)
	{
		return ((::UnityEngine::Vector3(*)(::PVOID, ::System::Collections::Generic::List_1<::UnityEngine::Vector3>*, ::System::Single))((::PBYTE)hIl2Cpp + TRACKCAMERACONTROLLER_METHOD_5_A36544CA17714445_OFFSET))(this, a1, a2);
	}
