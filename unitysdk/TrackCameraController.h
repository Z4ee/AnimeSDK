...
#define TRACKCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAC26EB0)
#define TRACKCAMERACONTROLLER_INITVC_OFFSET UNITYSDK_OFFSET(0xAC27110)
#define TRACKCAMERACONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xAC27290)
#define TRACKCAMERACONTROLLER_MAPRATIOSTATIC_OFFSET UNITYSDK_OFFSET(0xAC27AE0)
#define TRACKCAMERACONTROLLER_MAPRATIO_OFFSET UNITYSDK_OFFSET(0xAC277F0)
#define TRACKCAMERACONTROLLER_METHOD_5_A36544CA17714445_OFFSET UNITYSDK_OFFSET(0xAC27540)
#define TRACKCAMERACONTROLLER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xAC27B90)
#define TRACKCAMERACONTROLLER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xAC27B50)
#define TRACKCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAC27230)
#define TRACKCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC27BD0)

inline static constexpr unsigned int TrackCameraController_TypeDefinitionIndex = 38188;
