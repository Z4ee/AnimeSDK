...
#define TRACKCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x10527D20)
#define TRACKCAMERACONTROLLER_INITVC_OFFSET UNITYSDK_OFFSET(0x10527FA0)
#define TRACKCAMERACONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x10528140)
#define TRACKCAMERACONTROLLER_MAPRATIOSTATIC_OFFSET UNITYSDK_OFFSET(0x10528B10)
#define TRACKCAMERACONTROLLER_MAPRATIO_OFFSET UNITYSDK_OFFSET(0x10528740)
#define TRACKCAMERACONTROLLER_METHOD_5_BC09128703DEDF98_OFFSET UNITYSDK_OFFSET(0x10528400)
#define TRACKCAMERACONTROLLER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10528BC0)
#define TRACKCAMERACONTROLLER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10528B80)
#define TRACKCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x105280E0)
#define TRACKCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10528C00)

inline static constexpr unsigned int TrackCameraController_TypeDefinitionIndex = 45490;
