...
#define STRUCT_2_D6C349C31864351E_METHOD_2_20F4806358A3520A_OFFSET UNITYSDK_OFFSET(0x880120)
#define STRUCT_2_D6C349C31864351E_METHOD_2_A39080B57B55848D_OFFSET UNITYSDK_OFFSET(0x1A876020)
#define STRUCT_2_D6C349C31864351E_METHOD_2_D126582672457EA7_OFFSET UNITYSDK_OFFSET(0x8801A0)
#define STRUCT_2_D6C349C31864351E__CTOR_OFFSET UNITYSDK_OFFSET(0x880110)

inline static constexpr unsigned int Struct_2_D6C349C31864351E_TypeDefinitionIndex = 59824;

struct alignas(4) Struct_2_D6C349C31864351E
{
	::Enum_3_309C66F1326114D7 Field_2_0; // 0x10
	::Enum_3_AB9CCA0B2E05A401 Field_2_1; // 0x14
