...
#define CLASS_1_C77E8D851AB7BCBD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15EEC530)
#define CLASS_1_C77E8D851AB7BCBD_METHOD_1_9178B711385FE155_OFFSET UNITYSDK_OFFSET(0x15EEC6C0)
#define CLASS_1_C77E8D851AB7BCBD_METHOD_1_AA6AC38756233BD0_OFFSET UNITYSDK_OFFSET(0x15EEC570)
#define CLASS_1_C77E8D851AB7BCBD_METHOD_1_F36E75210ED5F96C_OFFSET UNITYSDK_OFFSET(0x15EEC5C0)
#define CLASS_1_C77E8D851AB7BCBD__CTOR_OFFSET UNITYSDK_OFFSET(0x15EEC520)

inline static constexpr unsigned int Class_1_C77E8D851AB7BCBD_TypeDefinitionIndex = 63776;

class Class_1_C77E8D851AB7BCBD : public ::System::Object
{
public:
	::Class_1_EAB9B76B098BE3AC* Field_1_0; // 0x10

	::System::Void _ctor(::Class_1_EAB9B76B098BE3AC* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_EAB9B76B098BE3AC*))((::PBYTE)hIl2Cpp + CLASS_1_C77E8D851AB7BCBD__CTOR_OFFSET))(this, a1);
	}
