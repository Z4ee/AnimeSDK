...
#define CLASS_2_22C4B636012AE7A6_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1593FA70)
#define CLASS_2_22C4B636012AE7A6_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x1593FA90)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x1593FF60)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_0517EE1B2F8956FE_OFFSET UNITYSDK_OFFSET(0x15940120)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1593FAF0)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x1593FEE0)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_837B832C4CA7C908_OFFSET UNITYSDK_OFFSET(0x15940200)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_86FDF9B846367A7E_OFFSET UNITYSDK_OFFSET(0x159402A0)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_B75C7B573F2E1A01_OFFSET UNITYSDK_OFFSET(0x159405A0)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x15940170)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_C363D49B19844D3D_OFFSET UNITYSDK_OFFSET(0x159403C0)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_DD784213055292FB_1_OFFSET UNITYSDK_OFFSET(0x1593FCB0)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_DD784213055292FB_OFFSET UNITYSDK_OFFSET(0x1593FC60)
#define CLASS_2_22C4B636012AE7A6_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x159407D0)
#define CLASS_2_22C4B636012AE7A6_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1593FA80)
#define CLASS_2_22C4B636012AE7A6__CTOR_OFFSET UNITYSDK_OFFSET(0x15940980)
#define CLASS_2_22C4B636012AE7A6__ONBIND_OFFSET UNITYSDK_OFFSET(0x1593F8F0)

inline static constexpr unsigned int Class_2_22C4B636012AE7A6_TypeDefinitionIndex = 71653;

class Class_2_22C4B636012AE7A6 : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* LGNIMOIHBEK; // 0x0
	// static const ::System::String* CKKEBDJGLGJ; // 0x0
	// static const ::System::String* AMADNKBJFIL; // 0x0
	::UnityEngine::Animation* JPHOOFFIAAH; // 0x60
	::UnityEngine::UI::Image* LKAOENJHMHA; // 0x68
	::UnityEngine::UI::Image* HPCAJDKDMEI; // 0x70
	::UnityEngine::UI::Text* HCPKJEKHAPF; // 0x78
	::UnityEngine::UI::Button* JOODINOFCLL; // 0x80
	::UnityEngine::Transform* JNLPLFIOEAN; // 0x88
	::UnityEngine::UI::Text* GBFKFBCCLKK; // 0x90
	::Class_1_1D7B69991D584C07* DMFEKIIDMFL; // 0x98
	::UnityEngine::UI::Button* KJIOINOOIHP; // 0xA0
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0xA8
	::UnityEngine::Transform* ILHPAIHKJNN; // 0xB0
	::System::UInt32 LBADPLDHDPE; // 0xB8
