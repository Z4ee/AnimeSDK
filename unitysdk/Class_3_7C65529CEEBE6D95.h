...
#define CLASS_3_7C65529CEEBE6D95_METHOD_3_5DA7E6E6484000DA_OFFSET UNITYSDK_OFFSET(0x1922DD90)
#define CLASS_3_7C65529CEEBE6D95_METHOD_3_6386D036D69129C5_OFFSET UNITYSDK_OFFSET(0x1922E120)
#define CLASS_3_7C65529CEEBE6D95_METHOD_3_F25E77D6D86538C0_OFFSET UNITYSDK_OFFSET(0x1922DAD0)
#define CLASS_3_7C65529CEEBE6D95_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1922CBB0)
#define CLASS_3_7C65529CEEBE6D95__CTOR_OFFSET UNITYSDK_OFFSET(0x1922CB60)

inline static constexpr unsigned int Class_3_7C65529CEEBE6D95_TypeDefinitionIndex = 52351;

class Class_3_7C65529CEEBE6D95 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::AdventureCameraLookAt*>
{
public:
	::RPG::GameCore::VCameraVector3ChangeParam* Field_3_0; // 0x28
