...
#define STRUCT_2_941CB6CDBCA0A3A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7693F0)
#define STRUCT_2_941CB6CDBCA0A3A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x7693D0)
#define STRUCT_2_941CB6CDBCA0A3A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7694E0)
#define STRUCT_2_941CB6CDBCA0A3A7_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x769530)
#define STRUCT_2_941CB6CDBCA0A3A7_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x769590)
#define STRUCT_2_941CB6CDBCA0A3A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1358A470)
#define STRUCT_2_941CB6CDBCA0A3A7__CTOR_OFFSET UNITYSDK_OFFSET(0x3A5E00)

inline static constexpr unsigned int Struct_2_941CB6CDBCA0A3A7_TypeDefinitionIndex = 71418;

struct alignas(2) Struct_2_941CB6CDBCA0A3A7
{
	static ::Struct_2_941CB6CDBCA0A3A7* StaticGet_Field_2_2()
	{
		return (::Struct_2_941CB6CDBCA0A3A7*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_941CB6CDBCA0A3A7_TypeDefinitionIndex)->GetStaticField(0xF7B0);
	}
