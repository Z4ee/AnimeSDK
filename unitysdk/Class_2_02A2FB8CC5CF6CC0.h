...
#define CLASS_2_02A2FB8CC5CF6CC0_METHOD_2_DEB57A9A5A4C2CEA_OFFSET UNITYSDK_OFFSET(0x1D2761C0)
#define CLASS_2_02A2FB8CC5CF6CC0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D276380)
...
{
public:
	::Il2CppArray<::System::UInt32>* PAEPOONBKAD; // 0x10
	::Il2CppArray<::Struct_2_331ACDD60B60D2E3>* OCHDMBJBIIC; // 0x18
	::RPG::GameCore::MeshBound* PAMFCEDOEMO; // 0x20
