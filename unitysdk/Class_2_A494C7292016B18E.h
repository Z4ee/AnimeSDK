...
#define CLASS_2_A494C7292016B18E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x129A4FB0)
#define CLASS_2_A494C7292016B18E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x129A4FF0)
#define CLASS_2_A494C7292016B18E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x129A50C0)
#define CLASS_2_A494C7292016B18E_TICK_OFFSET UNITYSDK_OFFSET(0x129A5110)
#define CLASS_2_A494C7292016B18E__CTOR_OFFSET UNITYSDK_OFFSET(0x129A4FA0)

inline static constexpr unsigned int Class_2_A494C7292016B18E_TypeDefinitionIndex = 51061;

class Class_2_A494C7292016B18E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetCurrentTurnActionEntity* Field_2_0; // 0x20
