...
#define CLASS_2_A494C7292016B18E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18707AB0)
#define CLASS_2_A494C7292016B18E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18707AF0)
#define CLASS_2_A494C7292016B18E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18707BC0)
#define CLASS_2_A494C7292016B18E_TICK_OFFSET UNITYSDK_OFFSET(0x18707C10)
#define CLASS_2_A494C7292016B18E__CTOR_OFFSET UNITYSDK_OFFSET(0x18707AA0)
...
{
public:
	::RPG::GameCore::SetCurrentTurnActionEntity* OFKGLJOAMLD; // 0x18
