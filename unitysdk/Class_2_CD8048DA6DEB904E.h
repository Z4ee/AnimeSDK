...
#define CLASS_2_CD8048DA6DEB904E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17A410B0)
#define CLASS_2_CD8048DA6DEB904E_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x17A41350)
#define CLASS_2_CD8048DA6DEB904E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17A41160)
#define CLASS_2_CD8048DA6DEB904E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17A41230)
#define CLASS_2_CD8048DA6DEB904E_TICK_OFFSET UNITYSDK_OFFSET(0x17A41280)
#define CLASS_2_CD8048DA6DEB904E__CTOR_OFFSET UNITYSDK_OFFSET(0x17A40DC0)

inline static constexpr unsigned int Class_2_CD8048DA6DEB904E_TypeDefinitionIndex = 56257;

class Class_2_CD8048DA6DEB904E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Struct_2_D3027B1CDFF61281 Field_2_0; // 0x18
	::RPG::GameCore::WaitForNotifyNoParam* Field_2_1; // 0x48
