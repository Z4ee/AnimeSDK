...
#define CLASS_2_6E9D411FA6163500_GET_ICONID_OFFSET UNITYSDK_OFFSET(0x99BDED0)
#define CLASS_2_6E9D411FA6163500__CTOR_OFFSET UNITYSDK_OFFSET(0x99BDFB0)
#define CLASS_2_6E9D411FA6163500___IFIXBASEPROXY_GET_ICONID_OFFSET UNITYSDK_OFFSET(0x99BE010)

inline static constexpr unsigned int Class_2_6E9D411FA6163500_TypeDefinitionIndex = 55923;
...
public:
	...
	{
		return ((::System::UInt32(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_6E9D411FA6163500___IFIXBASEPROXY_GET_ICONID_OFFSET))(this);
	}
};
