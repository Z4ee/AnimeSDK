...
#define CLASS_2_7CBFDE32C0B9C8E6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBD54B60)
#define CLASS_2_7CBFDE32C0B9C8E6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBD54A50)
#define CLASS_2_7CBFDE32C0B9C8E6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBD54B10)
#define CLASS_2_7CBFDE32C0B9C8E6_TICK_OFFSET UNITYSDK_OFFSET(0xBD54AB0)
#define CLASS_2_7CBFDE32C0B9C8E6__CTOR_OFFSET UNITYSDK_OFFSET(0xBD54A40)
...
{
public:
	::RPG::GameCore::UINotifyMonopolyCellEventFinish* OFKGLJOAMLD; // 0x18
