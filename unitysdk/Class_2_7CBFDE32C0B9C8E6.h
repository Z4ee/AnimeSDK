...
#define CLASS_2_7CBFDE32C0B9C8E6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAA012B0)
#define CLASS_2_7CBFDE32C0B9C8E6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAA011A0)
#define CLASS_2_7CBFDE32C0B9C8E6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAA01260)
#define CLASS_2_7CBFDE32C0B9C8E6_TICK_OFFSET UNITYSDK_OFFSET(0xAA01200)
#define CLASS_2_7CBFDE32C0B9C8E6__CTOR_OFFSET UNITYSDK_OFFSET(0xAA01190)

inline static constexpr unsigned int Class_2_7CBFDE32C0B9C8E6_TypeDefinitionIndex = 54970;

class Class_2_7CBFDE32C0B9C8E6 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::UINotifyMonopolyCellEventFinish* Field_2_1; // 0x20
