...
#define CLASS_2_7CBFDE32C0B9C8E6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B41EF0)
#define CLASS_2_7CBFDE32C0B9C8E6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19B41DE0)
#define CLASS_2_7CBFDE32C0B9C8E6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19B41EA0)
#define CLASS_2_7CBFDE32C0B9C8E6_TICK_OFFSET UNITYSDK_OFFSET(0x19B41E40)
#define CLASS_2_7CBFDE32C0B9C8E6__CTOR_OFFSET UNITYSDK_OFFSET(0x19B41DD0)

inline static constexpr unsigned int Class_2_7CBFDE32C0B9C8E6_TypeDefinitionIndex = 58985;

class Class_2_7CBFDE32C0B9C8E6 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::UINotifyMonopolyCellEventFinish* OFKGLJOAMLD; // 0x20
