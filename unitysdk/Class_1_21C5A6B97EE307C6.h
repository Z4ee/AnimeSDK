...
#define CLASS_1_21C5A6B97EE307C6_GET_ATTRIBUTELIST_OFFSET UNITYSDK_OFFSET(0x18E5E1F0)
#define CLASS_1_21C5A6B97EE307C6_GET_COMPOSITIONTYPE_OFFSET UNITYSDK_OFFSET(0x18E5E1B0)
#define CLASS_1_21C5A6B97EE307C6_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18E5E1D0)
#define CLASS_1_21C5A6B97EE307C6_METHOD_1_0D4D447F31661D06_OFFSET UNITYSDK_OFFSET(0x18E5E3A0)
#define CLASS_1_21C5A6B97EE307C6_METHOD_1_1B0559824B2C4929_OFFSET UNITYSDK_OFFSET(0x18E5E210)
#define CLASS_1_21C5A6B97EE307C6_METHOD_1_2F132DF8FDFFADAF_OFFSET UNITYSDK_OFFSET(0x18E5E290)
#define CLASS_1_21C5A6B97EE307C6_METHOD_1_CB8F7DA1917A4695_OFFSET UNITYSDK_OFFSET(0x18E5E320)
#define CLASS_1_21C5A6B97EE307C6_SET_ATTRIBUTELIST_OFFSET UNITYSDK_OFFSET(0x18E5E200)
#define CLASS_1_21C5A6B97EE307C6_SET_COMPOSITIONTYPE_OFFSET UNITYSDK_OFFSET(0x18E5E1C0)
#define CLASS_1_21C5A6B97EE307C6_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18E5E1E0)
#define CLASS_1_21C5A6B97EE307C6__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E5E5D0)
#define CLASS_1_21C5A6B97EE307C6__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5E250)
...
public:
	...
	{
		return (::RPG::Client::RogueInstanceCacheManager_2<::System::UInt32, ::Class_1_21C5A6B97EE307C6*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_21C5A6B97EE307C6_TypeDefinitionIndex)->GetStaticField(0x45620);
	}
	::System::Collections::Generic::List_1<::RPG::Client::IRogueTournPersonaRoomAttribute*>* FGJCCBCKPNL; // 0x10
