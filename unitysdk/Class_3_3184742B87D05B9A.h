...
#define CLASS_3_3184742B87D05B9A_METHOD_3_28DFC52A1206DD2C_OFFSET UNITYSDK_OFFSET(0x1D0611C0)
#define CLASS_3_3184742B87D05B9A_METHOD_3_8041BB6608BA1545_OFFSET UNITYSDK_OFFSET(0x1D061480)
#define CLASS_3_3184742B87D05B9A__CTOR_OFFSET UNITYSDK_OFFSET(0x1D061200)
...
{
public:
	::RPG::GameCore::DynamicFloat* PINNPLKBABH; // 0x18
	::RPG::GameCore::DynamicFloat* OCGINFHNEPF; // 0x20
	::RPG::GameCore::DynamicFloat* NMMOOCJILEC; // 0x28
	::RPG::GameCore::DynamicFloat* FBIJGGIOLNO; // 0x30
	::RPG::GameCore::DynamicFloat* IHLBHMNLJMN; // 0x38
	::RPG::GameCore::DynamicFloat* NBEEPDPFAHG; // 0x40
	::RPG::GameCore::DynamicFloat* DIPCHCFIPDB; // 0x48
	::RPG::GameCore::DynamicFloat* AANFIMJNOKA; // 0x50
