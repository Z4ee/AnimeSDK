...
#define CLASS_1_2A76A884C97A2E2B_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x14BD8AE0)
#define CLASS_1_2A76A884C97A2E2B_FROMFLX_OFFSET UNITYSDK_OFFSET(0x14BD7EB0)
#define CLASS_1_2A76A884C97A2E2B_METHOD_1_0578713EDB32B89E_OFFSET UNITYSDK_OFFSET(0x14BD7F30)
#define CLASS_1_2A76A884C97A2E2B_METHOD_1_46BAE982627C8007_OFFSET UNITYSDK_OFFSET(0x14BD8B40)
#define CLASS_1_2A76A884C97A2E2B__CTOR_OFFSET UNITYSDK_OFFSET(0x14BD90A0)

inline static constexpr unsigned int Class_1_2A76A884C97A2E2B_TypeDefinitionIndex = 66275;

class Class_1_2A76A884C97A2E2B : public ::System::Object
{
public:
	::Class_1_8C28E085C991E9A7* Field_1_3; // 0x10
	::System::Collections::Generic::List_1<::MoleMole::Config::ConfigCommonLevelData*>* Field_1_4; // 0x18
	::Class_1_6657081C8A94CA44* Field_1_0; // 0x20
	::Class_1_5FA9CCDDD9957726* Field_1_1; // 0x28
	::Class_1_B8726C3723B428F0* Field_1_5; // 0x30
	::Class_1_F8A4F21F742B6836* Field_1_2; // 0x38
