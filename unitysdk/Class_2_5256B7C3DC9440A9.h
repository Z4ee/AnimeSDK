...
#define CLASS_2_5256B7C3DC9440A9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17DCB9E0)
#define CLASS_2_5256B7C3DC9440A9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17DCBA20)
#define CLASS_2_5256B7C3DC9440A9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17DCBAB0)
#define CLASS_2_5256B7C3DC9440A9_TICK_OFFSET UNITYSDK_OFFSET(0x17DCBB00)
#define CLASS_2_5256B7C3DC9440A9__CTOR_OFFSET UNITYSDK_OFFSET(0x17DCB9D0)

inline static constexpr unsigned int Class_2_5256B7C3DC9440A9_TypeDefinitionIndex = 55508;

class Class_2_5256B7C3DC9440A9 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RemoveGlobalTimeSlow* OFKGLJOAMLD; // 0x18
