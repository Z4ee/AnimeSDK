...
#define CLASS_2_5256B7C3DC9440A9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x176C5160)
#define CLASS_2_5256B7C3DC9440A9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x176C51A0)
#define CLASS_2_5256B7C3DC9440A9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x176C5230)
#define CLASS_2_5256B7C3DC9440A9_TICK_OFFSET UNITYSDK_OFFSET(0x176C5280)
#define CLASS_2_5256B7C3DC9440A9__CTOR_OFFSET UNITYSDK_OFFSET(0x176C5150)

inline static constexpr unsigned int Class_2_5256B7C3DC9440A9_TypeDefinitionIndex = 52805;
