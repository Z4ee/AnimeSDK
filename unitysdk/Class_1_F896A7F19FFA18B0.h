...
#define CLASS_1_F896A7F19FFA18B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9300500)
#define CLASS_1_F896A7F19FFA18B0_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x93010B0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x92FF020)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_07BB45288DFF8852_OFFSET UNITYSDK_OFFSET(0x92FF740)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_1CC11A49B82F4151_OFFSET UNITYSDK_OFFSET(0x9300A60)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_40051A2743448924_OFFSET UNITYSDK_OFFSET(0x9300C90)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_422AB1A19F04E217_OFFSET UNITYSDK_OFFSET(0x92FFB80)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_5AEAA72641C1FC1E_OFFSET UNITYSDK_OFFSET(0x9300890)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0x93001B0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0x92FFFF0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0x92FFAD0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x92FFEF0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x92FFDF0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_C2992E3B105F7E09_OFFSET UNITYSDK_OFFSET(0x93009C0)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_E111A6E980D49A23_OFFSET UNITYSDK_OFFSET(0x9300E90)
#define CLASS_1_F896A7F19FFA18B0_METHOD_1_E68AEBF88F1494A8_OFFSET UNITYSDK_OFFSET(0x9301010)
#define CLASS_1_F896A7F19FFA18B0_SET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x93010C0)
#define CLASS_1_F896A7F19FFA18B0__CCTOR_OFFSET UNITYSDK_OFFSET(0x93010D0)
#define CLASS_1_F896A7F19FFA18B0__CTOR_OFFSET UNITYSDK_OFFSET(0x92FEE00)

inline static constexpr unsigned int Class_1_F896A7F19FFA18B0_TypeDefinitionIndex = 70955;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F896A7F19FFA18B0_TypeDefinitionIndex)->GetStaticField(0x6A6D0);
	}
	static ::System::String** StaticGet_Field_1_21()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F896A7F19FFA18B0_TypeDefinitionIndex)->GetStaticField(0x6A6D8);
	}
	static ::System::String** StaticGet_Field_1_20()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F896A7F19FFA18B0_TypeDefinitionIndex)->GetStaticField(0x6A6E0);
	}
	static ::System::String** StaticGet_Field_1_23()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F896A7F19FFA18B0_TypeDefinitionIndex)->GetStaticField(0x6A6E8);
	}
	::RPG::GameCore::LittleGameStateTreeConfig* Field_1_7; // 0x10
	::RPG::GameCore::ElfRestaurantGameConfig* _GameConfig_k__BackingField; // 0x18
	::RPG::GameCore::ElfBehaviorStateConfig* Field_1_12; // 0x20
	...
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::RestaurantNormalEventType, ::RPG::GameCore::RestaurantEventRewardRow*>* Field_1_14; // 0x38
	::RPG::GameCore::ElfBuffConfig* Field_1_15; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* Field_1_1; // 0x48
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* Field_1_3; // 0x50
	::Class_1_ADC27DBA8547EDD7* Field_1_10; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::ElfBehaviorStateConfig*>* Field_1_11; // 0x60
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::RPG::GameCore::RestaurantSpecialBubbleRow*>*>* Field_1_13; // 0x68
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_B587CAF66AB56ABD*>* Field_1_6; // 0x70
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* Field_1_4; // 0x78
	::RPG::GameCore::LittleGameStateTreeConfig* Field_1_9; // 0x80
	::RPG::GameCore::ElfDailyWaveConfig* Field_1_16; // 0x88
	::RPG::GameCore::LittleGameLevelConfig* Field_1_19; // 0x90
	::Class_2_43D1AA62A6D00FFF* Field_1_17; // 0x98
	::RPG::GameCore::LittleGameStateTreeConfig* Field_1_8; // 0xA0
