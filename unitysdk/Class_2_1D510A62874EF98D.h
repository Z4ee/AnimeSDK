...
#define CLASS_2_1D510A62874EF98D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105C1FA0)
#define CLASS_2_1D510A62874EF98D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105C2040)
#define CLASS_2_1D510A62874EF98D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x105C2170)
#define CLASS_2_1D510A62874EF98D_TICK_OFFSET UNITYSDK_OFFSET(0x105C1FE0)
#define CLASS_2_1D510A62874EF98D__CTOR_OFFSET UNITYSDK_OFFSET(0x105C1F90)
...
public:
	...
	::RPG::GameCore::TaskContext* OEGOIILHDOD; // 0x20
	::RPG::GameCore::ShowBonusUIEffect* HAOKDAIPDIM; // 0x28
