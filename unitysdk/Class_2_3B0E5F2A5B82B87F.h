...
#define CLASS_2_3B0E5F2A5B82B87F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13CBA530)
#define CLASS_2_3B0E5F2A5B82B87F_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13CBA800)
#define CLASS_2_3B0E5F2A5B82B87F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13CBA680)
#define CLASS_2_3B0E5F2A5B82B87F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13CBA750)
#define CLASS_2_3B0E5F2A5B82B87F_TICK_OFFSET UNITYSDK_OFFSET(0x13CBA7A0)
#define CLASS_2_3B0E5F2A5B82B87F__CTOR_OFFSET UNITYSDK_OFFSET(0x13CBA520)

inline static constexpr unsigned int Class_2_3B0E5F2A5B82B87F_TypeDefinitionIndex = 49922;

class Class_2_3B0E5F2A5B82B87F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TrainPartyGridMove* Field_2_0; // 0x18
