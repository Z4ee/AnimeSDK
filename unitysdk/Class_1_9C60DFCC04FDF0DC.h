...
#define CLASS_1_9C60DFCC04FDF0DC_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0C2DF0)
#define CLASS_1_9C60DFCC04FDF0DC_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0C2820)
#define CLASS_1_9C60DFCC04FDF0DC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0C28D0)
#define CLASS_1_9C60DFCC04FDF0DC_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0C28A0)
#define CLASS_1_9C60DFCC04FDF0DC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0C2A80)
#define CLASS_1_9C60DFCC04FDF0DC_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0C3190)
#define CLASS_1_9C60DFCC04FDF0DC_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0C2FA0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A0C2850)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1A0C2880)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_358A144584A5DBFC_OFFSET UNITYSDK_OFFSET(0x1A0C27A0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0C25D0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A0C2870)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A0C2860)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A0C2890)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A0C2800)
#define CLASS_1_9C60DFCC04FDF0DC_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0C2600)
#define CLASS_1_9C60DFCC04FDF0DC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0C2C20)
#define CLASS_1_9C60DFCC04FDF0DC_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0C2C80)
#define CLASS_1_9C60DFCC04FDF0DC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0C3430)
#define CLASS_1_9C60DFCC04FDF0DC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0C2660)
#define CLASS_1_9C60DFCC04FDF0DC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C2610)

inline static constexpr unsigned int Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex = 32821;

class Class_1_9C60DFCC04FDF0DC : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_6CEA13619F869F51*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_6CEA13619F869F51*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex)->GetStaticField(0x3D8A0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_9C60DFCC04FDF0DC*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9C60DFCC04FDF0DC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex)->GetStaticField(0x3D8A8);
	}
	// static const ::System::Int32 Field_1_2 = 0xF; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x481; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_6CEA13619F869F51*>* Field_1_5; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_6; // 0x18
	::System::Object* Field_1_7; // 0x20
	::System::UInt32 Field_1_8; // 0x28
	::Class_1_9C60DFCC04FDF0DC_Enum_3_2E741879C8CDBAFC_25 Field_1_9; // 0x2C
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_6CEA13619F869F51*>* Method_1_6E1EC2DF63D7020F()
	{
		return ((::Google::Protobuf::Collections::RepeatedField_1<::Class_1_6CEA13619F869F51*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_9C60DFCC04FDF0DC_METHOD_1_6E1EC2DF63D7020F_OFFSET))(this);
	}
