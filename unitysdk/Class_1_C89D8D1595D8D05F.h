...
#define CLASS_1_C89D8D1595D8D05F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6D3E20)
#define CLASS_1_C89D8D1595D8D05F_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6D36D0)
#define CLASS_1_C89D8D1595D8D05F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6D37A0)
#define CLASS_1_C89D8D1595D8D05F_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6D3740)
#define CLASS_1_C89D8D1595D8D05F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6D3B00)
#define CLASS_1_C89D8D1595D8D05F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6D4210)
#define CLASS_1_C89D8D1595D8D05F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6D3FE0)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1C6D3720)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C6D33B0)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_358A144584A5DBFC_OFFSET UNITYSDK_OFFSET(0x1C6D35B0)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_6BCB722BBE18B904_OFFSET UNITYSDK_OFFSET(0x1C6D3620)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1C6D3730)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1C6D3610)
#define CLASS_1_C89D8D1595D8D05F_METHOD_1_F45A6C563F3DF7EB_OFFSET UNITYSDK_OFFSET(0x1C6D36A0)
#define CLASS_1_C89D8D1595D8D05F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6D3410)
#define CLASS_1_C89D8D1595D8D05F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6D3C20)
#define CLASS_1_C89D8D1595D8D05F_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6D3C80)
#define CLASS_1_C89D8D1595D8D05F__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6D4470)
#define CLASS_1_C89D8D1595D8D05F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6D3430)
#define CLASS_1_C89D8D1595D8D05F__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6D3420)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C89D8D1595D8D05F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C89D8D1595D8D05F_TypeDefinitionIndex)->GetStaticField(0x62960);
	}
