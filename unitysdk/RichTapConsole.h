...
#define RICHTAPCONSOLE_ADDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1DE14710)
#define RICHTAPCONSOLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DE1CFB0)
#define RICHTAPCONSOLE_CLAMPWINDOWPOSITION_OFFSET UNITYSDK_OFFSET(0x1DE1D620)
#define RICHTAPCONSOLE_CLEARALLMESSAGES_OFFSET UNITYSDK_OFFSET(0x1DE1DB00)
#define RICHTAPCONSOLE_DRAWCONSOLEWINDOW_OFFSET UNITYSDK_OFFSET(0x1DE1D510)
#define RICHTAPCONSOLE_DRAWTOOLBAR_OFFSET UNITYSDK_OFFSET(0x1DE1D930)
#define RICHTAPCONSOLE_DRAWWINDOWCONTENT_OFFSET UNITYSDK_OFFSET(0x1DE1D6A0)
#define RICHTAPCONSOLE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1DE1CFA0)
#define RICHTAPCONSOLE_INITGUISTYLE_OFFSET UNITYSDK_OFFSET(0x1DE1D280)
#define RICHTAPCONSOLE_INITWINDOWRECT_OFFSET UNITYSDK_OFFSET(0x1DE1D210)
#define RICHTAPCONSOLE_ONGUI_OFFSET UNITYSDK_OFFSET(0x1DE1D500)
#define RICHTAPCONSOLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DE1D4F0)
#define RICHTAPCONSOLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE1DBD0)

inline static constexpr unsigned int RichTapConsole_TypeDefinitionIndex = 38076;
...
public:
	...
	{
		return (::RichTapConsole**)Il2CppClass::FromTypeDefinitionIndex(RichTapConsole_TypeDefinitionIndex)->GetStaticField(0x28E50);
	}
