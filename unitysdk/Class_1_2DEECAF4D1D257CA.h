...
#define CLASS_1_2DEECAF4D1D257CA_GET_ISASSISTAVAILABLE_OFFSET UNITYSDK_OFFSET(0xA764450)
#define CLASS_1_2DEECAF4D1D257CA_GET_USINGASSISTGROUPID_OFFSET UNITYSDK_OFFSET(0xA764430)
#define CLASS_1_2DEECAF4D1D257CA_GET_USINGRETURNID_OFFSET UNITYSDK_OFFSET(0xA764410)
#define CLASS_1_2DEECAF4D1D257CA_GET_USINGTRIALAVATARGROUP_OFFSET UNITYSDK_OFFSET(0xA764470)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_0EA837295AE4519F_OFFSET UNITYSDK_OFFSET(0xA763BD0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_123DFB09BD2C9B9E_OFFSET UNITYSDK_OFFSET(0xA7640A0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_18D6CFE1BE963B0A_OFFSET UNITYSDK_OFFSET(0xA7643B0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_45482282A7223016_OFFSET UNITYSDK_OFFSET(0xA7642A0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_53C3C61BF4D261AA_OFFSET UNITYSDK_OFFSET(0xA7638C0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0xA763C90)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_7B4A205C38FE24BC_OFFSET UNITYSDK_OFFSET(0xA763EB0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_9477221A6F70535F_OFFSET UNITYSDK_OFFSET(0xA7641B0)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_A43932CA1D838777_OFFSET UNITYSDK_OFFSET(0xA763970)
#define CLASS_1_2DEECAF4D1D257CA_METHOD_1_EADDF1782C977BCA_OFFSET UNITYSDK_OFFSET(0xA764100)
#define CLASS_1_2DEECAF4D1D257CA_SET_ISASSISTAVAILABLE_OFFSET UNITYSDK_OFFSET(0xA764460)
#define CLASS_1_2DEECAF4D1D257CA_SET_USINGASSISTGROUPID_OFFSET UNITYSDK_OFFSET(0xA764440)
#define CLASS_1_2DEECAF4D1D257CA_SET_USINGRETURNID_OFFSET UNITYSDK_OFFSET(0xA764420)
#define CLASS_1_2DEECAF4D1D257CA_SET_USINGTRIALAVATARGROUP_OFFSET UNITYSDK_OFFSET(0xA764480)
#define CLASS_1_2DEECAF4D1D257CA__CTOR_OFFSET UNITYSDK_OFFSET(0xA763800)

inline static constexpr unsigned int Class_1_2DEECAF4D1D257CA_TypeDefinitionIndex = 57878;

class Class_1_2DEECAF4D1D257CA : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::PlayerReturnTrialAvatarGroup*>* Field_1_0; // 0x10
	...
	::System::Boolean _IsAssistAvailable_k__BackingField; // 0x28
	::System::UInt32 _UsingReturnID_k__BackingField; // 0x2C
	::System::UInt32 _UsingAssistGroupID_k__BackingField; // 0x30
	...
	::System::Boolean Method_1_45482282A7223016(::System::UInt32 a1)
	{
		return ((::System::Boolean(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_1_2DEECAF4D1D257CA_METHOD_1_45482282A7223016_OFFSET))(this, a1);
	}
