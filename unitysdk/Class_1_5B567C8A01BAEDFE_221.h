...
#define CLASS_1_5B567C8A01BAEDFE_221_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6B49C0)
#define CLASS_1_5B567C8A01BAEDFE_221_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6B47D0)
#define CLASS_1_5B567C8A01BAEDFE_221_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6B48D0)
#define CLASS_1_5B567C8A01BAEDFE_221_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6B4840)
#define CLASS_1_5B567C8A01BAEDFE_221_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6B4920)
#define CLASS_1_5B567C8A01BAEDFE_221_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6B4A10)
#define CLASS_1_5B567C8A01BAEDFE_221_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6B49E0)
#define CLASS_1_5B567C8A01BAEDFE_221_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A6B4720)
#define CLASS_1_5B567C8A01BAEDFE_221_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A6B4780)
#define CLASS_1_5B567C8A01BAEDFE_221_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6B4950)
#define CLASS_1_5B567C8A01BAEDFE_221_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A6B49B0)
#define CLASS_1_5B567C8A01BAEDFE_221__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6B4A60)
#define CLASS_1_5B567C8A01BAEDFE_221__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6B47A0)
#define CLASS_1_5B567C8A01BAEDFE_221__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B4790)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_221_TypeDefinitionIndex = 29358;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_221*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_221_TypeDefinitionIndex)->GetStaticField(0x2FF10);
	}
