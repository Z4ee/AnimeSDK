...
#define CLASS_2_EFCC66A165448AE8_METHOD_2_F7D48A5F0FE8B616_OFFSET UNITYSDK_OFFSET(0x18350000)
#define CLASS_2_EFCC66A165448AE8__CTOR_OFFSET UNITYSDK_OFFSET(0x183501B0)

inline static constexpr unsigned int Class_2_EFCC66A165448AE8_TypeDefinitionIndex = 22307;

class Class_2_EFCC66A165448AE8 : public ::RPG::GameCore::JsonConfig
{
public:
	::Il2CppArray<::RPG::GameCore::DynamicFloat*>* Field_2_1; // 0x10
	::RPG::Client::TextID Field_2_0; // 0x18
