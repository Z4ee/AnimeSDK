...
#define MONOUITABLESCROLLV2_DATACOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x18E8C1E0)
#define MONOUITABLESCROLLV2_DATACOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18E8C270)
#define MONOUITABLESCROLLV2_DATACOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E8C300)
#define MONOUITABLESCROLLV2_DATACOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8C2F0)

inline static constexpr unsigned int MonoUITableScrollV2_DataComparer_TypeDefinitionIndex = 69976;
...
public:
	...
	{
		return (::MonoUITableScrollV2_DataComparer**)Il2CppClass::FromTypeDefinitionIndex(MonoUITableScrollV2_DataComparer_TypeDefinitionIndex)->GetStaticField(0x418A0);
	}
