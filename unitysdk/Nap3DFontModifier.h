...
#define NAP3DFONTMODIFIER_INIT_OFFSET UNITYSDK_OFFSET(0x1C4269C0)
#define NAP3DFONTMODIFIER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C4266A0)
#define NAP3DFONTMODIFIER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1C4268B0)
#define NAP3DFONTMODIFIER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1C426820)
#define NAP3DFONTMODIFIER_START_OFFSET UNITYSDK_OFFSET(0x1C426970)
#define NAP3DFONTMODIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C427520)
#define NAP3DFONTMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C427C80)

inline static constexpr unsigned int Nap3DFontModifier_TypeDefinitionIndex = 26548;
