...
#define CLASS_2_78C8C3A77A6DBE61_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x19FE64B0)
#define CLASS_2_78C8C3A77A6DBE61_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x19FE65D0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0x19FE5AA0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_0C44FB644D25C1C2_OFFSET UNITYSDK_OFFSET(0x19FE5C40)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x19FE5DC0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19FE6020)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_5DA541F24A0E0D28_OFFSET UNITYSDK_OFFSET(0x19FE6080)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_75AAF4C9AB049F98_OFFSET UNITYSDK_OFFSET(0x19FE5830)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x19FE5D10)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_881057BF38FE4763_OFFSET UNITYSDK_OFFSET(0x19FE60F0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_E8A165BEBD75409B_OFFSET UNITYSDK_OFFSET(0x19FE6160)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_EAF52FA690F5978F_OFFSET UNITYSDK_OFFSET(0x19FE5740)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_EEABD52C0F4D0C8A_OFFSET UNITYSDK_OFFSET(0x19FE58E0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x19FE63B0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x19FE62B0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_FD939CBDC4C3B869_OFFSET UNITYSDK_OFFSET(0x19FE5BF0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_FDE09C8D62639E3E_1_OFFSET UNITYSDK_OFFSET(0x19FE5EC0)
#define CLASS_2_78C8C3A77A6DBE61_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x19FE5F70)
#define CLASS_2_78C8C3A77A6DBE61_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x19FE59C0)
#define CLASS_2_78C8C3A77A6DBE61_ONRETURN_OFFSET UNITYSDK_OFFSET(0x19FE5B20)
#define CLASS_2_78C8C3A77A6DBE61__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE66C0)
#define CLASS_2_78C8C3A77A6DBE61__ONBIND_OFFSET UNITYSDK_OFFSET(0x19FE56A0)
#define CLASS_2_78C8C3A77A6DBE61__ONTICK_OFFSET UNITYSDK_OFFSET(0x19FE5C90)

inline static constexpr unsigned int Class_2_78C8C3A77A6DBE61_TypeDefinitionIndex = 71429;

class Class_2_78C8C3A77A6DBE61 : public ::Class_1_34917908B7833130
{
public:
	::Class_1_93570651E1E7F6D8* APPIHABBCGK; // 0x60
	::RPG::Client::LocalizedText* HCPKJEKHAPF; // 0x68
	::RPG::Client::AnimatorButton* PFBLCICMBBK; // 0x70
	::UnityEngine::Animator* APPGGMLEPLN; // 0x78
	::System::Int32 OOFHFDPECOC; // 0x80
	::System::Nullable_1<::System::Int32> KLLBBLOKMEH; // 0x84
	::System::Int32 JFAFBMKCBMJ; // 0x8C
	::System::Int32 NGCFNPJDCEM; // 0x90
	::System::Int32 NHIPFHBLNEF; // 0x94
	::System::Int32 DALCCNHNKHC; // 0x98
	::System::Nullable_1<::System::Boolean> HOGMAFEHCGD; // 0x9C
