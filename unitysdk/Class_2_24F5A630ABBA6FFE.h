...
#define CLASS_2_24F5A630ABBA6FFE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1568D480)
#define CLASS_2_24F5A630ABBA6FFE_METHOD_2_8282D1563F42937E_OFFSET UNITYSDK_OFFSET(0x1568D8B0)
#define CLASS_2_24F5A630ABBA6FFE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1568D370)
#define CLASS_2_24F5A630ABBA6FFE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1568D430)
#define CLASS_2_24F5A630ABBA6FFE_TICK_OFFSET UNITYSDK_OFFSET(0x1568DD20)
#define CLASS_2_24F5A630ABBA6FFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1568D0C0)
...
{
public:
	::Class_3_07C3C4D2990C49EE* KHFKIGICMCL; // 0x18
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x20
	::Class_3_07C3C4D2990C49EE* JIJACLILLBI; // 0x28
	::Class_3_07C3C4D2990C49EE* FHEGMOCMNLO; // 0x30
	::Class_3_07C3C4D2990C49EE* NBGFNJOADKB; // 0x38
	::Class_3_07C3C4D2990C49EE* DBNHKOCFADK; // 0x40
	::Class_3_07C3C4D2990C49EE* LJOKDPABLLL; // 0x48
	::RPG::GameCore::MarbleNpcListener* IGHAHBNLIJA; // 0x50
