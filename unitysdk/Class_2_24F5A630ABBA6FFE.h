...
#define CLASS_2_24F5A630ABBA6FFE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1589EAB0)
#define CLASS_2_24F5A630ABBA6FFE_METHOD_2_8282D1563F42937E_OFFSET UNITYSDK_OFFSET(0x1589EEE0)
#define CLASS_2_24F5A630ABBA6FFE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1589E9A0)
#define CLASS_2_24F5A630ABBA6FFE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1589EA60)
#define CLASS_2_24F5A630ABBA6FFE_TICK_OFFSET UNITYSDK_OFFSET(0x1589F350)
#define CLASS_2_24F5A630ABBA6FFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1589E6F0)

inline static constexpr unsigned int Class_2_24F5A630ABBA6FFE_TypeDefinitionIndex = 50602;

class Class_2_24F5A630ABBA6FFE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MarbleNpcListener* Field_2_0; // 0x18
