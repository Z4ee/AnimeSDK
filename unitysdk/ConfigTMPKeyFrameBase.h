...
#define CONFIGTMPKEYFRAMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F84BA0)

inline static constexpr unsigned int ConfigTMPKeyFrameBase_TypeDefinitionIndex = 80423;
