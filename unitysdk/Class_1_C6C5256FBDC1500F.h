...
#define CLASS_1_C6C5256FBDC1500F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C116CB0)
#define CLASS_1_C6C5256FBDC1500F_GET_ALLCONTEXTS_OFFSET UNITYSDK_OFFSET(0x1C116DA0)
#define CLASS_1_C6C5256FBDC1500F_GET_CAKERACECORE_OFFSET UNITYSDK_OFFSET(0x1C116D90)
#define CLASS_1_C6C5256FBDC1500F__CTOR_OFFSET UNITYSDK_OFFSET(0x1C116BE0)

inline static constexpr unsigned int Class_1_C6C5256FBDC1500F_TypeDefinitionIndex = 36141;

class Class_1_C6C5256FBDC1500F : public ::System::Object
{
public:
	::Class_2_3616FDE8A71D0590_1* _cakeRaceCore_k__BackingField; // 0x10
