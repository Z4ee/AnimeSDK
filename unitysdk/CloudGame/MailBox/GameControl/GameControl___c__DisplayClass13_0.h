...
#define CLOUDGAME_MAILBOX_GAMECONTROL_GAMECONTROL___C__DISPLAYCLASS13_0__CONNECT_B__1_OFFSET UNITYSDK_OFFSET(0x1991E3E0)
#define CLOUDGAME_MAILBOX_GAMECONTROL_GAMECONTROL___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1991E3D0)

namespace CloudGame::MailBox::GameControl
{
	inline static constexpr unsigned int GameControl___c__DisplayClass13_0_TypeDefinitionIndex = 18421;
