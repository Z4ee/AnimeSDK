...
#define CLASS_2_FC61924680D40F48_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x160645D0)
#define CLASS_2_FC61924680D40F48_METHOD_2_193C90E4C6892FC2_OFFSET UNITYSDK_OFFSET(0x16064570)
#define CLASS_2_FC61924680D40F48_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x160643F0)
#define CLASS_2_FC61924680D40F48_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x16063D90)
#define CLASS_2_FC61924680D40F48_METHOD_2_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x16063DF0)
#define CLASS_2_FC61924680D40F48_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x160640C0)
#define CLASS_2_FC61924680D40F48_METHOD_2_494458CA7765DC42_OFFSET UNITYSDK_OFFSET(0x16064650)
#define CLASS_2_FC61924680D40F48_METHOD_2_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x16063EE0)
#define CLASS_2_FC61924680D40F48_METHOD_2_7AFC74ADCC2A9C7A_1_OFFSET UNITYSDK_OFFSET(0x16064510)
#define CLASS_2_FC61924680D40F48_METHOD_2_7AFC74ADCC2A9C7A_OFFSET UNITYSDK_OFFSET(0x16064050)
#define CLASS_2_FC61924680D40F48_METHOD_2_7B6EC255F45D034F_OFFSET UNITYSDK_OFFSET(0x16063C80)
#define CLASS_2_FC61924680D40F48_METHOD_2_86738FBA5954F142_OFFSET UNITYSDK_OFFSET(0x16063FA0)
#define CLASS_2_FC61924680D40F48_METHOD_2_ACC01D4A7A73EC9E_OFFSET UNITYSDK_OFFSET(0x16064110)
#define CLASS_2_FC61924680D40F48_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x16063BA0)
#define CLASS_2_FC61924680D40F48_METHOD_2_D5999BF4C232F1C9_OFFSET UNITYSDK_OFFSET(0x16064470)
#define CLASS_2_FC61924680D40F48_METHOD_2_EDE104A2956E181A_OFFSET UNITYSDK_OFFSET(0x16063D00)
#define CLASS_2_FC61924680D40F48_METHOD_2_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0x16063C20)
#define CLASS_2_FC61924680D40F48__CTOR_OFFSET UNITYSDK_OFFSET(0x160646D0)
#define CLASS_2_FC61924680D40F48__ONBIND_OFFSET UNITYSDK_OFFSET(0x16063980)

inline static constexpr unsigned int Class_2_FC61924680D40F48_TypeDefinitionIndex = 71926;

class Class_2_FC61924680D40F48 : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* GGOHHHPLNEK; // 0x0
	// static const ::System::String* CALMIPOMOKI; // 0x0
	::RPG::GameCore::SkillData* OCOIDGHBAEH; // 0x60
	::RPG::Client::AnimatorButton* DKECLDPHDAB; // 0x68
	::RPG::GameCore::BattleInstance* IFKCCHIFMOC; // 0x70
	::Struct_2_96F8F0A04B900A9E PMECLILMEDH; // 0x78
	::UnityEngine::Transform* NEFFAGOFKKD; // 0x80
	::UnityEngine::Animator* APPGGMLEPLN; // 0x88
	::Class_2_B71FA21BC121C2FA* HPADAGJIHAO; // 0x90
	::Class_2_6E0B9E69D0FC929E* MNONMJBHKKG; // 0x98
	::Class_1_A474572029D08468* ABOBEBEOHPA; // 0xA0
	::UnityEngine::Transform* AIDIMEHEEMI; // 0xA8
	::System::Boolean FHBNNGCEPFD; // 0xB0
