...
#define BATCHANIMATIONINSTPROPMANAGER_CLEARINSTANCEDPROP_1_OFFSET UNITYSDK_OFFSET(0x9B933A0)
#define BATCHANIMATIONINSTPROPMANAGER_CLEARINSTANCEDPROP_OFFSET UNITYSDK_OFFSET(0x9B93330)
#define BATCHANIMATIONINSTPROPMANAGER_INITPART_OFFSET UNITYSDK_OFFSET(0x9B92EA0)
#define BATCHANIMATIONINSTPROPMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9B93EB0)
#define BATCHANIMATIONINSTPROPMANAGER_METHOD_5_9D7B81571ADA6EDE_OFFSET UNITYSDK_OFFSET(0x9B93950)
#define BATCHANIMATIONINSTPROPMANAGER_METHOD_5_CCFD131833AE484B_OFFSET UNITYSDK_OFFSET(0x9B93B90)
#define BATCHANIMATIONINSTPROPMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9B93F00)
#define BATCHANIMATIONINSTPROPMANAGER_SETINSTANCEDPROP_1_OFFSET UNITYSDK_OFFSET(0x9B931B0)
#define BATCHANIMATIONINSTPROPMANAGER_SETINSTANCEDPROP_OFFSET UNITYSDK_OFFSET(0x9B93130)
#define BATCHANIMATIONINSTPROPMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9B93F50)

inline static constexpr unsigned int BatchAnimationInstPropManager_TypeDefinitionIndex = 44080;
