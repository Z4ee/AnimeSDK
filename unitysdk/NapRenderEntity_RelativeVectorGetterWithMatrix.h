...
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D5E05C0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D5E0630)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D5E02A0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5E0280)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetterWithMatrix_TypeDefinitionIndex = 27223;
