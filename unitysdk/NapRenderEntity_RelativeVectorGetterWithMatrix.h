...
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2E4E20)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2E4E90)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2E4AE0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E4AD0)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetterWithMatrix_TypeDefinitionIndex = 29580;
