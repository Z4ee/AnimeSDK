...
#define CLASS_3_6DBA585243CD6B22_METHOD_3_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x1400ABE0)
#define CLASS_3_6DBA585243CD6B22_METHOD_3_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x1400AB10)
#define CLASS_3_6DBA585243CD6B22_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1400A980)
#define CLASS_3_6DBA585243CD6B22_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1400AA40)
#define CLASS_3_6DBA585243CD6B22__CTOR_OFFSET UNITYSDK_OFFSET(0x1400AC30)
#define CLASS_3_6DBA585243CD6B22___IFIXBASEPROXY_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1400AC40)
#define CLASS_3_6DBA585243CD6B22___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1400AC50)

inline static constexpr unsigned int Class_3_6DBA585243CD6B22_TypeDefinitionIndex = 45266;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + CLASS_3_6DBA585243CD6B22___IFIXBASEPROXY_ONGRAPHSTART_OFFSET))(this, a1);
	}

	::System::Void __iFixBaseProxy_OnGraphStop(::UnityEngine::Playables::Playable a1)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::Playable))((::PBYTE)hIl2Cpp + CLASS_3_6DBA585243CD6B22___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET))(this, a1);
	}
};
