...
#define MB_MULTIMATERIALTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C466EB0)

inline static constexpr unsigned int MB_MultiMaterialTexArray_TypeDefinitionIndex = 84951;
