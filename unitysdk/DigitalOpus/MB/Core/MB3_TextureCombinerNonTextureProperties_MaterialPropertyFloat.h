...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_GETAVERAGECALCULATOR_OFFSET UNITYSDK_OFFSET(0x1BDF6930)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1BDF6940)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1BDF68B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1BDF68C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF68D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_MaterialPropertyFloat_TypeDefinitionIndex = 85136;
