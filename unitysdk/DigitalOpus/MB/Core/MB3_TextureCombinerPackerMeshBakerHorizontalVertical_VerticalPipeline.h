...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE_GETEDGE2EDGETREATMENT_OFFSET UNITYSDK_OFFSET(0x1BFC76D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE_GETEXTRAROOMFORREGULARATLAS_OFFSET UNITYSDK_OFFSET(0x1BFC7860)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE_GETPACKINGALG_OFFSET UNITYSDK_OFFSET(0x1BFC7600)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE_INITIALIZEATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1BFC76E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE_MERGEATLASPACKINGRESULTSTACKBONAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BFC76F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE_SORTTEXSETINTOBINS_OFFSET UNITYSDK_OFFSET(0x1BFC7610)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_VERTICALPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFC7880)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerHorizontalVertical_VerticalPipeline_TypeDefinitionIndex = 85159;
