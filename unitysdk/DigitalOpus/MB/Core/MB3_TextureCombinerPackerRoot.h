...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLESSTATIC_OFFSET UNITYSDK_OFFSET(0x1C4659E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1C465C60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1C465C00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CREATETEMPORARYTEXTURESFORATLAS_OFFSET UNITYSDK_OFFSET(0x1C465590)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_MAKEPROCEDURALTEXTURESREADABLE_OFFSET UNITYSDK_OFFSET(0x1C465BF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_SAVEATLASANDCONFIGURERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C4657A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C465C70)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerRoot_TypeDefinitionIndex = 85115;
