...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLESSTATIC_OFFSET UNITYSDK_OFFSET(0x1E7A3810)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1E7A3A80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1E7A3A20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CREATETEMPORARYTEXTURESFORATLAS_OFFSET UNITYSDK_OFFSET(0x1E7A33C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_MAKEPROCEDURALTEXTURESREADABLE_OFFSET UNITYSDK_OFFSET(0x1E7A3A10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_SAVEATLASANDCONFIGURERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E7A35D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A3A90)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerRoot_TypeDefinitionIndex = 90689;
