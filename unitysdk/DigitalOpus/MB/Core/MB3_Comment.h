...
#define DIGITALOPUS_MB_CORE_MB3_COMMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E04FCB0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_Comment_TypeDefinitionIndex = 90562;
