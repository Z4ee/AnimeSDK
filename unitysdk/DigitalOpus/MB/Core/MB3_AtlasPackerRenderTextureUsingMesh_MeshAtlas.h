...
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_ADDNINESLICEDRECT_OFFSET UNITYSDK_OFFSET(0x1E2CDD90)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_ADDQUAD_OFFSET UNITYSDK_OFFSET(0x1E2CE4B0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_BUILDATLAS_OFFSET UNITYSDK_OFFSET(0x1E2CCEA0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_CONFIGUREMATERIAL_DEFAULTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1E2CE380)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2CE700)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AtlasPackerRenderTextureUsingMesh_MeshAtlas_TypeDefinitionIndex = 90730;
