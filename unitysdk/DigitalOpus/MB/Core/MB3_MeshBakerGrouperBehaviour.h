...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_ADDMESHBAKER_OFFSET UNITYSDK_OFFSET(0x1C120050)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_DOCLUSTERING_OFFSET UNITYSDK_OFFSET(0x1C11E0E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1C120400)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_GROUPBYLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1C11FD80)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C120410)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperBehaviour_TypeDefinitionIndex = 84993;
