...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_COLLECTCHANNELDATAFORALLMESHESINLIST_OFFSET UNITYSDK_OFFSET(0x1BAFBCE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1BAFB340)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BAFB320)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBINDPOSES_OFFSET UNITYSDK_OFFSET(0x1BAFD2A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1BAFD4F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1BAFD400)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETCOLORS_OFFSET UNITYSDK_OFFSET(0x1BAFBC10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETNORMALS_OFFSET UNITYSDK_OFFSET(0x1BAFB6B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETTANGENTS_OFFSET UNITYSDK_OFFSET(0x1BAFB780)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV0MODIFIED_OFFSET UNITYSDK_OFFSET(0x1BAFB850)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV0RAW_OFFSET UNITYSDK_OFFSET(0x1BAFB4E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV2MODIFIED_OFFSET UNITYSDK_OFFSET(0x1BAFB920)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1BAFB9F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x1BAFB5B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_HASCOLLECTEDMESHDATA_OFFSET UNITYSDK_OFFSET(0x1BAFB4A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1BAFB4B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFB270)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GENERATETANGENTS_OFFSET UNITYSDK_OFFSET(0x1BAFD740)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETBINDPOSES_OFFSET UNITYSDK_OFFSET(0x1BAFCE60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1BAFD0A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1BAFCD10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHNORMALS_OFFSET UNITYSDK_OFFSET(0x1BAFC9D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHTANGENTS_OFFSET UNITYSDK_OFFSET(0x1BAFCB30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHUV2S_OFFSET UNITYSDK_OFFSET(0x1BAFC8F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHUVS_OFFSET UNITYSDK_OFFSET(0x1BAFC770)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MeshChannelsCache_TypeDefinitionIndex = 85068;
	...
	public:
		...
		::System::Boolean _collectedMeshData; // 0x20
