...
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_1_OFFSET UNITYSDK_OFFSET(0x1DE893B0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1DE89330)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECTSHIFTED_OFFSET UNITYSDK_OFFSET(0x1DE89550)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1DE896F0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETSHIFTTRANSFORMTOFITBINA_OFFSET UNITYSDK_OFFSET(0x1DE893E0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_INVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DE89300)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_LINESEGMENTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1DE89B10)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_1_OFFSET UNITYSDK_OFFSET(0x1DE89910)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1DE89730)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1DE89A60)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_OFFSET UNITYSDK_OFFSET(0x1DE89BD0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TEST_OFFSET UNITYSDK_OFFSET(0x1DE89170)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1DE89C80)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1DE89360)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMX_OFFSET UNITYSDK_OFFSET(0x1DE893A0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE89CA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_UVTransformUtility_TypeDefinitionIndex = 90656;
