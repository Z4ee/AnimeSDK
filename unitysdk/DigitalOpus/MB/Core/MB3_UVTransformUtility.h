...
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_1_OFFSET UNITYSDK_OFFSET(0x1BAFFCD0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1BAFFC50)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECTSHIFTED_OFFSET UNITYSDK_OFFSET(0x1BAFFE70)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1BB00010)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETSHIFTTRANSFORMTOFITBINA_OFFSET UNITYSDK_OFFSET(0x1BAFFD00)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_INVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BAFFC20)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_LINESEGMENTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1BB00430)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_1_OFFSET UNITYSDK_OFFSET(0x1BB00230)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1BB00050)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1BB00380)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_OFFSET UNITYSDK_OFFSET(0x1BB004F0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TEST_OFFSET UNITYSDK_OFFSET(0x1BAFFA90)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1BB005A0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1BAFFC80)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMX_OFFSET UNITYSDK_OFFSET(0x1BAFFCC0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB005C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_UVTransformUtility_TypeDefinitionIndex = 85082;
