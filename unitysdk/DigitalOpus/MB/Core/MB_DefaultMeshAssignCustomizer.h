...
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_DEFAULTDELEGATEASSIGNMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1F797890)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_COLORS_OFFSET UNITYSDK_OFFSET(0x1F797860)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV0_OFFSET UNITYSDK_OFFSET(0x1F7976E0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV2_OFFSET UNITYSDK_OFFSET(0x1F797710)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV3_OFFSET UNITYSDK_OFFSET(0x1F797740)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV4_OFFSET UNITYSDK_OFFSET(0x1F797770)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV5_OFFSET UNITYSDK_OFFSET(0x1F7977A0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV6_OFFSET UNITYSDK_OFFSET(0x1F7977D0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV7_OFFSET UNITYSDK_OFFSET(0x1F797800)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV8_OFFSET UNITYSDK_OFFSET(0x1F797830)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7978C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_DefaultMeshAssignCustomizer_TypeDefinitionIndex = 94591;
