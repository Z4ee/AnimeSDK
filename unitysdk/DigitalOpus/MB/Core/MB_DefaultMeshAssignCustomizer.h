...
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_DEFAULTDELEGATEASSIGNMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1C037CF0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_COLORS_OFFSET UNITYSDK_OFFSET(0x1C037CC0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV0_OFFSET UNITYSDK_OFFSET(0x1C037B40)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV2_OFFSET UNITYSDK_OFFSET(0x1C037B70)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV3_OFFSET UNITYSDK_OFFSET(0x1C037BA0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV4_OFFSET UNITYSDK_OFFSET(0x1C037BD0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV5_OFFSET UNITYSDK_OFFSET(0x1C037C00)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV6_OFFSET UNITYSDK_OFFSET(0x1C037C30)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV7_OFFSET UNITYSDK_OFFSET(0x1C037C60)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV8_OFFSET UNITYSDK_OFFSET(0x1C037C90)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C037D20)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_DefaultMeshAssignCustomizer_TypeDefinitionIndex = 85084;
