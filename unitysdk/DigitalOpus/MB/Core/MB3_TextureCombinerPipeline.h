...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEALLTEXTURESARENULLANDSAMECOLOR_OFFSET UNITYSDK_OFFSET(0x1ECDD1D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEIDEALSIZESFORTEXTURESINATLASANDPADDING_OFFSET UNITYSDK_OFFSET(0x1ECDD970)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CONVERTNORMALFORMATFROMUNITY_TOSTANDARD_OFFSET UNITYSDK_OFFSET(0x1ECE01A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATEPACKER_OFFSET UNITYSDK_OFFSET(0x1ECDE770)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATETEXTUREPACKER_OFFSET UNITYSDK_OFFSET(0x1ECDFB80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLATLASPACKINGRESULTAUXILLARYDATA_OFFSET UNITYSDK_OFFSET(0x1ECDDB30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLRESULTATLASESANDRECTS_OFFSET UNITYSDK_OFFSET(0x1ECDE1F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GENERATEREPORT_OFFSET UNITYSDK_OFFSET(0x1ECDE990)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETADJUSTEDFORSCALEANDOFFSET2DIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1ECDFC50)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETMATERIALSCALEANDOFFSET_OFFSET UNITYSDK_OFFSET(0x1ECE0280)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETSUBMESHAREA_OFFSET UNITYSDK_OFFSET(0x1ECE0410)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETTEXTURECONSIDERINGSTANDARDSHADERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1ECDCF70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_ISPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1ECE0770)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1ECDD9C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ECE0790)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_1_OFFSET UNITYSDK_OFFSET(0x1ECDCA00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1ECDC970)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECE0780)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__DOANYSRCMATSHAVEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1ECDC930)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__SHOULDWECREATEATLASFORTHISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1ECDAA10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ECDD150)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP3_BUILDANDSAVEATLASESANDSTORERESULTS_OFFSET UNITYSDK_OFFSET(0x1ECDE8D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline_TypeDefinitionIndex = 94674;
	...
	public:
		...
		{
			return (::Il2CppArray<::DigitalOpus::MB::Core::ShaderTextureProperty*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x525E0);
		}
		static ::System::Boolean* StaticGet_USE_EXPERIMENTAL_HOIZONTALVERTICAL()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x13290);
		}
