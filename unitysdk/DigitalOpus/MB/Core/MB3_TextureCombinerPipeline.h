...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEALLTEXTURESARENULLANDSAMECOLOR_OFFSET UNITYSDK_OFFSET(0x1B5A3670)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEIDEALSIZESFORTEXTURESINATLASANDPADDING_OFFSET UNITYSDK_OFFSET(0x1B5A3E00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CONVERTNORMALFORMATFROMUNITY_TOSTANDARD_OFFSET UNITYSDK_OFFSET(0x1B5A66A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATEPACKER_OFFSET UNITYSDK_OFFSET(0x1B5A4C30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATETEXTUREPACKER_OFFSET UNITYSDK_OFFSET(0x1B5A6040)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLATLASPACKINGRESULTAUXILLARYDATA_OFFSET UNITYSDK_OFFSET(0x1B5A3FC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLRESULTATLASESANDRECTS_OFFSET UNITYSDK_OFFSET(0x1B5A46A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GENERATEREPORT_OFFSET UNITYSDK_OFFSET(0x1B5A4E70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETADJUSTEDFORSCALEANDOFFSET2DIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1B5A6140)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETMATERIALSCALEANDOFFSET_OFFSET UNITYSDK_OFFSET(0x1B5A6780)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETSUBMESHAREA_OFFSET UNITYSDK_OFFSET(0x1B5A6910)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETTEXTURECONSIDERINGSTANDARDSHADERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1B5A3410)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_ISPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1B5A6BA0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1B5A3E50)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5A6BC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_1_OFFSET UNITYSDK_OFFSET(0x1B5A2EB0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1B5A2E20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A6BB0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__DOANYSRCMATSHAVEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B5A2DE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__SHOULDWECREATEATLASFORTHISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B5A0E40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B5A35E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP3_BUILDANDSAVEATLASESANDSTORERESULTS_OFFSET UNITYSDK_OFFSET(0x1B5A4DB0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline_TypeDefinitionIndex = 85167;
	...
	public:
		...
		{
			return (::Il2CppArray<::DigitalOpus::MB::Core::ShaderTextureProperty*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x49CE0);
		}
		static ::System::Boolean* StaticGet_USE_EXPERIMENTAL_HOIZONTALVERTICAL()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x11E10);
		}
