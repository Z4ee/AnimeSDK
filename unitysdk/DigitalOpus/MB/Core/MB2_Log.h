...
#define DIGITALOPUS_MB_CORE_MB2_LOG_ERROR_OFFSET UNITYSDK_OFFSET(0x1F889B20)
#define DIGITALOPUS_MB_CORE_MB2_LOG_INFO_OFFSET UNITYSDK_OFFSET(0x1F889CA0)
#define DIGITALOPUS_MB_CORE_MB2_LOG_LOGDEBUG_OFFSET UNITYSDK_OFFSET(0x1F889D60)
#define DIGITALOPUS_MB_CORE_MB2_LOG_LOG_OFFSET UNITYSDK_OFFSET(0x1F889950)
#define DIGITALOPUS_MB_CORE_MB2_LOG_TRACE_OFFSET UNITYSDK_OFFSET(0x1F889E20)
#define DIGITALOPUS_MB_CORE_MB2_LOG_WARN_OFFSET UNITYSDK_OFFSET(0x1F889BE0)
#define DIGITALOPUS_MB_CORE_MB2_LOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1F889EE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_Log_TypeDefinitionIndex = 94541;
