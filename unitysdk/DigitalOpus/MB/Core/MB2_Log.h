...
#define DIGITALOPUS_MB_CORE_MB2_LOG_ERROR_OFFSET UNITYSDK_OFFSET(0x1C11DAA0)
#define DIGITALOPUS_MB_CORE_MB2_LOG_INFO_OFFSET UNITYSDK_OFFSET(0x1C11DC20)
#define DIGITALOPUS_MB_CORE_MB2_LOG_LOGDEBUG_OFFSET UNITYSDK_OFFSET(0x1C11DCE0)
#define DIGITALOPUS_MB_CORE_MB2_LOG_LOG_OFFSET UNITYSDK_OFFSET(0x1C11D8B0)
#define DIGITALOPUS_MB_CORE_MB2_LOG_TRACE_OFFSET UNITYSDK_OFFSET(0x1C11DDA0)
#define DIGITALOPUS_MB_CORE_MB2_LOG_WARN_OFFSET UNITYSDK_OFFSET(0x1C11DB60)
#define DIGITALOPUS_MB_CORE_MB2_LOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11DE60)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_Log_TypeDefinitionIndex = 85034;
