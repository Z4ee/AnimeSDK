...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1E20DEE0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1E20DE30)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1E20DB80)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1E20DC90)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E20DB70)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_PipelineVariationAllTexturesUseSameMatTiling_TypeDefinitionIndex = 90705;
