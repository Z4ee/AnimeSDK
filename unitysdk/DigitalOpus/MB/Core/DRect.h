...
#define DIGITALOPUS_MB_CORE_DRECT_ENCLOSES_OFFSET UNITYSDK_OFFSET(0x9B4E50)
#define DIGITALOPUS_MB_CORE_DRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B4DF0)
#define DIGITALOPUS_MB_CORE_DRECT_EXPAND_OFFSET UNITYSDK_OFFSET(0x9B4E10)
#define DIGITALOPUS_MB_CORE_DRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B4EF0)
#define DIGITALOPUS_MB_CORE_DRECT_GETRECT_OFFSET UNITYSDK_OFFSET(0x9B4D30)
#define DIGITALOPUS_MB_CORE_DRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x9B4DD0)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MAXD_OFFSET UNITYSDK_OFFSET(0x9B4D50)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x9B4D70)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MIND_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x9A7670)
#define DIGITALOPUS_MB_CORE_DRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x9B4DA0)
#define DIGITALOPUS_MB_CORE_DRECT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BE00620)
#define DIGITALOPUS_MB_CORE_DRECT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BE00680)
#define DIGITALOPUS_MB_CORE_DRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B4E00)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9B4CC0)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x924660)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9B4D10)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x919AE0)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4CB0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int DRect_TypeDefinitionIndex = 85081;
