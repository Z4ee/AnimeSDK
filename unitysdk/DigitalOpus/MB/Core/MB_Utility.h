...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_AREALLSHAREDMATERIALSDISTINCT_OFFSET UNITYSDK_OFFSET(0x1D952700)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ARRAYBISSUBSETOFA_OFFSET UNITYSDK_OFFSET(0x1D94FEA0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_BONEWEIGHTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1D952F10)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CONVERTASSETSRELATIVEPATHTOFULLSYSTEMPATH_OFFSET UNITYSDK_OFFSET(0x1D952E60)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1D94FD10)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D946350)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DISABLERENDERERINSOURCE_OFFSET UNITYSDK_OFFSET(0x1D9515E0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DOSUBMESHESSHAREVERTSORTRIS_OFFSET UNITYSDK_OFFSET(0x1D952830)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1D952B00)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETGOMATERIALS_OFFSET UNITYSDK_OFFSET(0x1D94FF30)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETMESH_OFFSET UNITYSDK_OFFSET(0x1D950A50)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETRENDERER_OFFSET UNITYSDK_OFFSET(0x1D951220)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_1_OFFSET UNITYSDK_OFFSET(0x1D951B30)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_2_OFFSET UNITYSDK_OFFSET(0x1D951CA0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_3_OFFSET UNITYSDK_OFFSET(0x1D951F40)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1D9519C0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ISSCENEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D952ED0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_RESAMPLETEXTURE_OFFSET UNITYSDK_OFFSET(0x1D9521E0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETMESH_OFFSET UNITYSDK_OFFSET(0x1D950E30)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETSOLIDCOLOR_OFFSET UNITYSDK_OFFSET(0x1D94FA80)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D953480)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D953470)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_TypeDefinitionIndex = 90669;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB_Utility_TypeDefinitionIndex)->GetStaticField(0x12CA0);
		}
