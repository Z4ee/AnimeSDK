...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_AREALLSHAREDMATERIALSDISTINCT_OFFSET UNITYSDK_OFFSET(0x1B5AF080)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ARRAYBISSUBSETOFA_OFFSET UNITYSDK_OFFSET(0x1B5AC820)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_BONEWEIGHTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1B5AF890)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CONVERTASSETSRELATIVEPATHTOFULLSYSTEMPATH_OFFSET UNITYSDK_OFFSET(0x1B5AF7E0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1B5AC690)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B5A2CA0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DISABLERENDERERINSOURCE_OFFSET UNITYSDK_OFFSET(0x1B5ADF60)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DOSUBMESHESSHAREVERTSORTRIS_OFFSET UNITYSDK_OFFSET(0x1B5AF1B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B5AF480)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETGOMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B5AC8B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETMESH_OFFSET UNITYSDK_OFFSET(0x1B5AD3D0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETRENDERER_OFFSET UNITYSDK_OFFSET(0x1B5ADBA0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_1_OFFSET UNITYSDK_OFFSET(0x1B5AE4B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_2_OFFSET UNITYSDK_OFFSET(0x1B5AE620)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_3_OFFSET UNITYSDK_OFFSET(0x1B5AE8C0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1B5AE340)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ISSCENEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B5AF850)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_RESAMPLETEXTURE_OFFSET UNITYSDK_OFFSET(0x1B5AEB60)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETMESH_OFFSET UNITYSDK_OFFSET(0x1B5AD7B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETSOLIDCOLOR_OFFSET UNITYSDK_OFFSET(0x1B5AC400)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5AFE00)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AFDF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_TypeDefinitionIndex = 85095;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB_Utility_TypeDefinitionIndex)->GetStaticField(0x11E30);
		}
