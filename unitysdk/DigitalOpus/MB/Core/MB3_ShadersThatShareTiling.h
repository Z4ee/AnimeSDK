...
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING_GETSCALEANDOFFSETFORTEXTUREPROP_OFFSET UNITYSDK_OFFSET(0x1E745910)
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING_GETSHADERSTHATSHARETILING_OFFSET UNITYSDK_OFFSET(0x1E745530)
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING_INIT_OFFSET UNITYSDK_OFFSET(0x1E745570)
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E745B60)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_ShadersThatShareTiling_TypeDefinitionIndex = 94585;
	...
	public:
		...
		{
			return (::DigitalOpus::MB::Core::MB3_ShadersThatShareTiling**)Il2CppClass::FromTypeDefinitionIndex(MB3_ShadersThatShareTiling_TypeDefinitionIndex)->GetStaticField(0x52610);
		}
