...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BONEANDBINDPOSE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B49A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BONEANDBINDPOSE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B49B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BONEANDBINDPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x3B4630)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_BoneAndBindpose_TypeDefinitionIndex = 85066;
