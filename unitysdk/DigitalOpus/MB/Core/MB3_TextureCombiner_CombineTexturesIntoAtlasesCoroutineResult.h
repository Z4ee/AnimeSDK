...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASESCOROUTINERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE34880)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner_CombineTexturesIntoAtlasesCoroutineResult_TypeDefinitionIndex = 94628;
