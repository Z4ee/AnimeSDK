...
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY_MESHASSIGN_COLORS_OFFSET UNITYSDK_OFFSET(0x1E1408A0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY_MESHASSIGN_UV_OFFSET UNITYSDK_OFFSET(0x1E140890)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY_UVCHANNELWITHEXTRAPARAMETER_OFFSET UNITYSDK_OFFSET(0x1E140880)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1408B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_DefaultMeshAssignCustomizer_NativeArray_TypeDefinitionIndex = 90672;
