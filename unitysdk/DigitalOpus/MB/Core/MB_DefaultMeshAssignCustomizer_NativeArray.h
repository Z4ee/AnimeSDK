...
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY_MESHASSIGN_COLORS_OFFSET UNITYSDK_OFFSET(0x1F55A910)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY_MESHASSIGN_UV_OFFSET UNITYSDK_OFFSET(0x1F55A900)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY_UVCHANNELWITHEXTRAPARAMETER_OFFSET UNITYSDK_OFFSET(0x1F55A8F0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_NATIVEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F55A920)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_DefaultMeshAssignCustomizer_NativeArray_TypeDefinitionIndex = 94605;
