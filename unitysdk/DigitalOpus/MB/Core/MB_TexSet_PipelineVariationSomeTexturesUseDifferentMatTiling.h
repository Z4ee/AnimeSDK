...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AF8AB30)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1AF8AB20)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AF8A8F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1AF8A980)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF88CA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_PipelineVariationSomeTexturesUseDifferentMatTiling_TypeDefinitionIndex = 85132;
