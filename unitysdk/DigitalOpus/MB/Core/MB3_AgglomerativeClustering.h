...
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_AGGLOMERATE_OFFSET UNITYSDK_OFFSET(0x1B59D1C0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_EUCLIDEAN_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1B59D170)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_MAIN_OFFSET UNITYSDK_OFFSET(0x1B59F460)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_TESTRUN_OFFSET UNITYSDK_OFFSET(0x1B59F2A0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59F5C0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING__REFILLPRIORITYQWITHSOME_OFFSET UNITYSDK_OFFSET(0x1B59EAE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AgglomerativeClustering_TypeDefinitionIndex = 85040;
