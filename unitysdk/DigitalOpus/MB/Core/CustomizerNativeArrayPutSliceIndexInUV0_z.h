...
#define DIGITALOPUS_MB_CORE_CUSTOMIZERNATIVEARRAYPUTSLICEINDEXINUV0_Z_MESHASSIGN_UV_OFFSET UNITYSDK_OFFSET(0x1C4E2820)
#define DIGITALOPUS_MB_CORE_CUSTOMIZERNATIVEARRAYPUTSLICEINDEXINUV0_Z_UVCHANNELWITHEXTRAPARAMETER_OFFSET UNITYSDK_OFFSET(0x1C4E2810)
#define DIGITALOPUS_MB_CORE_CUSTOMIZERNATIVEARRAYPUTSLICEINDEXINUV0_Z__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4E28F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int CustomizerNativeArrayPutSliceIndexInUV0_z_TypeDefinitionIndex = 84986;
