...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___C__DISPLAYCLASS9_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBF71C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___C__DISPLAYCLASS9_1____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_B__0_OFFSET UNITYSDK_OFFSET(0x1FBF71D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline___c__DisplayClass9_1_TypeDefinitionIndex = 94680;

	class MB3_TextureCombinerPipeline___c__DisplayClass9_1 : public ::System::Object
	{
	public:
		::DigitalOpus::MB::Core::MB_TexSet* setOfTexs; // 0x10
		::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline___c__DisplayClass9_0* CS___8__locals1; // 0x18
