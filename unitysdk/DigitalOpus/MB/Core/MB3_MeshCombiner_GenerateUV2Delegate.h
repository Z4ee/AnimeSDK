...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GENERATEUV2DELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E123280)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GENERATEUV2DELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E123320)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GENERATEUV2DELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E122CA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GENERATEUV2DELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E122C80)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombiner_GenerateUV2Delegate_TypeDefinitionIndex = 90623;
