...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_BUILDCLUSTERS_OFFSET UNITYSDK_OFFSET(0x1EE33700)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1EE346C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1EE33350)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1EE34850)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__BUILDLISTOFCLUSTERSTODRAW_OFFSET UNITYSDK_OFFSET(0x1EE33DB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE34860)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperCluster_TypeDefinitionIndex = 94505;
