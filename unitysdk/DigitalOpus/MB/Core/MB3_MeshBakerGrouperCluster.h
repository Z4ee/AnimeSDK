...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_BUILDCLUSTERS_OFFSET UNITYSDK_OFFSET(0x1B669B00)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B66AB00)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1B669740)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1B66AC80)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__BUILDLISTOFCLUSTERSTODRAW_OFFSET UNITYSDK_OFFSET(0x1B66A1A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66AC90)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperCluster_TypeDefinitionIndex = 84998;
