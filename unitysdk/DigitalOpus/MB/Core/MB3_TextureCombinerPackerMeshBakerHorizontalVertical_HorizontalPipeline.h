...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_GETEDGE2EDGETREATMENT_OFFSET UNITYSDK_OFFSET(0x1E457A90)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_GETEXTRAROOMFORREGULARATLAS_OFFSET UNITYSDK_OFFSET(0x1E457C20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_GETPACKINGALG_OFFSET UNITYSDK_OFFSET(0x1E4579C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_INITIALIZEATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1E457AA0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_MERGEATLASPACKINGRESULTSTACKBONAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E457AB0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_SORTTEXSETINTOBINS_OFFSET UNITYSDK_OFFSET(0x1E4579D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E457C40)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerHorizontalVertical_HorizontalPipeline_TypeDefinitionIndex = 90734;
