...
#define DIGITALOPUS_MB_CORE_OBJECTLOG_DUMP_OFFSET UNITYSDK_OFFSET(0x1E20E250)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_ERROR_OFFSET UNITYSDK_OFFSET(0x1E20E020)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_INFO_OFFSET UNITYSDK_OFFSET(0x1E20E100)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_LOGDEBUG_OFFSET UNITYSDK_OFFSET(0x1E20E170)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_LOG_OFFSET UNITYSDK_OFFSET(0x1E20DFA0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_TRACE_OFFSET UNITYSDK_OFFSET(0x1E20E1E0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_WARN_OFFSET UNITYSDK_OFFSET(0x1E20E090)
#define DIGITALOPUS_MB_CORE_OBJECTLOG__CACHELOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x1E20DEF0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E20DF50)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ObjectLog_TypeDefinitionIndex = 90609;
