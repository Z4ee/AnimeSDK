...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ALLOCATEBLENDSHAPEARRAYIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1E124D00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_MERGEBLENDSHAPESWITHTHESAMENAME_OFFSET UNITYSDK_OFFSET(0x1E1251C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_OFFSET UNITYSDK_OFFSET(0x1E123D30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ASSIGNNEWBLENDSHAPESTOCOMBINERIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1E124E00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESFORNEWMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1E125040)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESINCURRENTMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1E124F10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E123560)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E123540)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1E123590)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__BUILDSRCSHAPE2COMBINEDMAP_OFFSET UNITYSDK_OFFSET(0x1E124860)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CONVERTBLENDSHAPENAMETOOUTPUTNAME_OFFSET UNITYSDK_OFFSET(0x1E124730)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E123580)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__ZEROARRAY_OFFSET UNITYSDK_OFFSET(0x1E1247F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BlendShapeProcessor_TypeDefinitionIndex = 90630;

	class MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BlendShapeProcessor : public ::System::Object
	{
	public:
		::DigitalOpus::MB::Core::MB3_MeshCombinerSingle* combiner; // 0x10
		::Il2CppArray<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle_MBBlendShape*>* nblendShapes; // 0x18
