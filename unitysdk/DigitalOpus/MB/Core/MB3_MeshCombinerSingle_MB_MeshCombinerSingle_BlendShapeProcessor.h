...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ALLOCATEBLENDSHAPEARRAYIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1BDF0420)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_MERGEBLENDSHAPESWITHTHESAMENAME_OFFSET UNITYSDK_OFFSET(0x1BDF08E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_OFFSET UNITYSDK_OFFSET(0x1BDEF450)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ASSIGNNEWBLENDSHAPESTOCOMBINERIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1BDF0520)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESFORNEWMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1BDF0760)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESINCURRENTMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1BDF0630)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1BDEEC80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BDEEC60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1BDEECB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__BUILDSRCSHAPE2COMBINEDMAP_OFFSET UNITYSDK_OFFSET(0x1BDEFF80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CONVERTBLENDSHAPENAMETOOUTPUTNAME_OFFSET UNITYSDK_OFFSET(0x1BDEFE50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDEECA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__ZEROARRAY_OFFSET UNITYSDK_OFFSET(0x1BDEFF10)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BlendShapeProcessor_TypeDefinitionIndex = 85056;
