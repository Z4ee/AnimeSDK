...
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS___CREATEATLASESCOROUTINESINGLERESULTMATERIAL_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D94D2D0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS___CREATEATLASESCOROUTINESINGLERESULTMATERIAL_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D94FCA0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS___CREATEATLASESCOROUTINESINGLERESULTMATERIAL_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D94FD00)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS___CREATEATLASESCOROUTINESINGLERESULTMATERIAL_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D94FCB0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS___CREATEATLASESCOROUTINESINGLERESULTMATERIAL_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D94D2C0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS___CREATEATLASESCOROUTINESINGLERESULTMATERIAL_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x1D94D2B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TextureArrays___CreateAtlasesCoroutineSingleResultMaterial_d__6_TypeDefinitionIndex = 90753;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MB_TexArraySliceRendererMatPair*>* _srcMatAndObjPairs_5__6; // 0x20
		::System::Object* __2__current; // 0x28
		::MB_MultiMaterialTexArray* resMatConfig; // 0x30
		::Il2CppArray<::MB_TextureArrayFormatSet*>* textureArrayOutputFormats; // 0x38
		::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::ShaderTextureProperty*>* customShaderProperties; // 0x40
		::MB_TextureArrayResultMaterial* bakedMatsAndSlicesResMat; // 0x48
		::MB_AtlasesAndRects* _sliceAtlasesAndRectOutput_5__8; // 0x50
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* objsToMesh; // 0x58
		::DigitalOpus::MB::Core::MB3_TextureCombiner_CreateAtlasesCoroutineResult* coroutineResult; // 0x60
		::DigitalOpus::MB::Core::MB3_TextureCombiner_CombineTexturesIntoAtlasesCoroutineResult* _coroutineResult2_5__7; // 0x68
		::System::Collections::Generic::List_1<::System::String*>* texPropNamesToIgnore; // 0x70
		::System::Collections::Generic::List_1<::MB_TexArraySlice*>* _slicesConfig_5__4; // 0x78
		::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB3_TextureCombiner_TemporaryTexture*>* _generatedTemporaryAtlases_5__3; // 0x80
		::DigitalOpus::MB::Core::MB3_TextureCombiner* combiner; // 0x88
		::System::Int32 __1__state; // 0x90
		::System::Int32 resMatIdx; // 0x94
		::System::Int32 _sliceIdx_5__5; // 0x98
		::DigitalOpus::MB::Core::MB2_LogLevel _LOG_LEVEL_5__2; // 0x9C
		::System::Boolean saveAtlasesAsAssets; // 0xA0
		::System::Single maxTimePerFrame; // 0xA4
