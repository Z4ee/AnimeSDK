...
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_ANYAREEMPTY_OFFSET UNITYSDK_OFFSET(0x1C043270)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_CLUSTER_OFFSET UNITYSDK_OFFSET(0x1C043E00)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_ELUCIDANDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C0438D0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_GETCLUSTER_OFFSET UNITYSDK_OFFSET(0x1C043A50)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_INITIALIZECENTROIDS_OFFSET UNITYSDK_OFFSET(0x1C042F10)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_MININDEX_OFFSET UNITYSDK_OFFSET(0x1C043940)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_UPDATECLUSTERMEMBERSHIP_OFFSET UNITYSDK_OFFSET(0x1C0433A0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_UPDATEDATAPOINTMEANS_OFFSET UNITYSDK_OFFSET(0x1C042FF0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C042B90)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_KMeansClustering_TypeDefinitionIndex = 85045;

	class MB3_KMeansClustering : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::Vector3>* _clusters; // 0x10
		::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB3_KMeansClustering_DataPoint*>* _normalizedDataToCluster; // 0x18
