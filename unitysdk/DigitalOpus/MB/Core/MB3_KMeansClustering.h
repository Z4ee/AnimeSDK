...
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_ANYAREEMPTY_OFFSET UNITYSDK_OFFSET(0x1E367370)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_CLUSTER_OFFSET UNITYSDK_OFFSET(0x1E367F00)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_ELUCIDANDISTANCE_OFFSET UNITYSDK_OFFSET(0x1E3679D0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_GETCLUSTER_OFFSET UNITYSDK_OFFSET(0x1E367B50)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_INITIALIZECENTROIDS_OFFSET UNITYSDK_OFFSET(0x1E367010)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_MININDEX_OFFSET UNITYSDK_OFFSET(0x1E367A40)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_UPDATECLUSTERMEMBERSHIP_OFFSET UNITYSDK_OFFSET(0x1E3674A0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_UPDATEDATAPOINTMEANS_OFFSET UNITYSDK_OFFSET(0x1E3670F0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1E366C90)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_KMeansClustering_TypeDefinitionIndex = 90619;
