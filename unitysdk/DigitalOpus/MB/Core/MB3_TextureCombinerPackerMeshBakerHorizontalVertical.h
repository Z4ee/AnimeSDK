...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1F5587F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_MERGEATLASPACKINGRESULTSTACKBONA_OFFSET UNITYSDK_OFFSET(0x1F55A170)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_TESTSTACKRECTANGLESHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1F55A760)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_TESTSTACKRECTANGLESVERTICAL_OFFSET UNITYSDK_OFFSET(0x1F55A7D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5587E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerHorizontalVertical_TypeDefinitionIndex = 94664;
