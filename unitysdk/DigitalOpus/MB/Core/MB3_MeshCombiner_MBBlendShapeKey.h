...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C1204F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C120590)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1204E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombiner_MBBlendShapeKey_TypeDefinitionIndex = 85050;
