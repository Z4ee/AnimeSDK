...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4577B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E457850)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4577A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombiner_MBBlendShapeKey_TypeDefinitionIndex = 90624;
