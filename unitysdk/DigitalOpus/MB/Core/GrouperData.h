...
#define DIGITALOPUS_MB_CORE_GROUPERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE2CE10)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int GrouperData_TypeDefinitionIndex = 94499;
