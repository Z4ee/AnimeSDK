...
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1F7247F0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1F7244B0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1F723990)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1F723A50)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_OFFSET UNITYSDK_OFFSET(0x1F723740)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1F7288D0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARBUFFERS_OFFSET UNITYSDK_OFFSET(0x1F7281D0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1F728620)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1F728300)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1F7234E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1F728640)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1F728320)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1F723460)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1F725080)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1F7232D0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1F723300)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1F722E90)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_MAXVERTSINMESH_OFFSET UNITYSDK_OFFSET(0x1F722FF0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1F722FE0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1F722EA0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_MAXVERTSINMESH_OFFSET UNITYSDK_OFFSET(0x1F723000)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1F722F40)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1F723FC0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1F723F20)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1F723DE0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1F723E80)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1F723D40)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__BAKESTEP1_OFFSET UNITYSDK_OFFSET(0x1F7269E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F728AC0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F728980)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1F728830)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__DISTRIBUTEAMONGBAKERS_OFFSET UNITYSDK_OFFSET(0x1F725D50)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__SETMBVALUES_OFFSET UNITYSDK_OFFSET(0x1F727F70)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__VALIDATETEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1F723570)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__VALIDATE_OFFSET UNITYSDK_OFFSET(0x1F725240)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MultiMeshCombiner_TypeDefinitionIndex = 94582;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MB3_MultiMeshCombiner_TypeDefinitionIndex)->GetStaticField(0x52600);
		}
		static ::Il2CppArray<::UnityEngine::GameObject*>** StaticGet_empty()
		{
			return (::Il2CppArray<::UnityEngine::GameObject*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_MultiMeshCombiner_TypeDefinitionIndex)->GetStaticField(0x52608);
		}
