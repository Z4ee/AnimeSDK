...
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1BFC3270)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1BFC2F40)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1BFC2430)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1BFC24F0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_OFFSET UNITYSDK_OFFSET(0x1BFC21E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1BFC73B0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARBUFFERS_OFFSET UNITYSDK_OFFSET(0x1BFC6CB0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1BFC7110)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1BFC6DE0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1BFC1F80)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1BFC7130)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1BFC6E00)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1BFC1F00)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1BFC3B00)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1BFC1D70)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1BFC1DA0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1BFC1930)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_MAXVERTSINMESH_OFFSET UNITYSDK_OFFSET(0x1BFC1A90)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1BFC1A80)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1BFC1940)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_MAXVERTSINMESH_OFFSET UNITYSDK_OFFSET(0x1BFC1AA0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1BFC19E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1BFC2A60)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1BFC29C0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1BFC2880)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BFC2920)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1BFC27E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__BAKESTEP1_OFFSET UNITYSDK_OFFSET(0x1BFC54A0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFC75A0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFC7460)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1BFC7310)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__DISTRIBUTEAMONGBAKERS_OFFSET UNITYSDK_OFFSET(0x1BFC47D0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__SETMBVALUES_OFFSET UNITYSDK_OFFSET(0x1BFC6A50)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__VALIDATETEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1BFC2010)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__VALIDATE_OFFSET UNITYSDK_OFFSET(0x1BFC3CC0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MultiMeshCombiner_TypeDefinitionIndex = 85075;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::GameObject*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_MultiMeshCombiner_TypeDefinitionIndex)->GetStaticField(0x49D00);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_emptyIDs()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MB3_MultiMeshCombiner_TypeDefinitionIndex)->GetStaticField(0x49D08);
		}
