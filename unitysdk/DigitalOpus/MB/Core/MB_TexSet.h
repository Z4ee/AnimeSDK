...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AF895D0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ALLTEXTURESARESAMEFORMERGE_OFFSET UNITYSDK_OFFSET(0x1AF89C80)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CALCINITIALFULLSAMPLINGRECTS_OFFSET UNITYSDK_OFFSET(0x1AF89890)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CALCMATANDUVSAMPLINGRECTS_OFFSET UNITYSDK_OFFSET(0x1AF89AB0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CREATECOLOREDTEXTOREPLACENULL_OFFSET UNITYSDK_OFFSET(0x1AF894D0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_DRAWRECTSTOMERGEGIZMOS_OFFSET UNITYSDK_OFFSET(0x1AF8A150)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AF8A440)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETENCAPSULATINGSAMPLINGRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x1AF89290)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1AF897A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMATSUBRECTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x1AF8A6F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMAXRAWTEXTUREHEIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x1AF891C0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AF896C0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_ALLTEXTURESUSESAMEMATTILING_OFFSET UNITYSDK_OFFSET(0x1AF88BB0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVOFFSET_OFFSET UNITYSDK_OFFSET(0x1AF88C10)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVRECT_OFFSET UNITYSDK_OFFSET(0x1AF88C50)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVSCALE_OFFSET UNITYSDK_OFFSET(0x1AF88C30)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_THISISONLYTEXSETINATLAS_OFFSET UNITYSDK_OFFSET(0x1AF88BD0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_TILINGTREATMENT_OFFSET UNITYSDK_OFFSET(0x1AF88BF0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x1AF88CB0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETALLTEXTURESUSESAMEMATTILINGTRUE_OFFSET UNITYSDK_OFFSET(0x1AF89580)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1AF893F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGSAMPLINGRECTFORTESTING_OFFSET UNITYSDK_OFFSET(0x1AF893A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGSAMPLINGRECTWHENMERGINGTEXSETS_OFFSET UNITYSDK_OFFSET(0x1AF89330)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETTHISISONLYTEXSETINATLASTRUE_OFFSET UNITYSDK_OFFSET(0x1AF85CD0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1AF85CE0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_ALLTEXTURESUSESAMEMATTILING_OFFSET UNITYSDK_OFFSET(0x1AF88BC0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_OBUVOFFSET_OFFSET UNITYSDK_OFFSET(0x1AF88C20)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_OBUVSCALE_OFFSET UNITYSDK_OFFSET(0x1AF88C40)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_THISISONLYTEXSETINATLAS_OFFSET UNITYSDK_OFFSET(0x1AF88BE0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_TILINGTREATMENT_OFFSET UNITYSDK_OFFSET(0x1AF88C00)
#define DIGITALOPUS_MB_CORE_MB_TEXSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF884D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_TypeDefinitionIndex = 85129;

	class MB_TexSet : public ::System::Object
	{
	public:
		::Il2CppArray<::DigitalOpus::MB::Core::MeshBakerMaterialTexture*>* ts; // 0x10
		::DigitalOpus::MB::Core::MB_TexSet_PipelineVariation* pipelineVariation; // 0x18
		...
		::System::Int32 idealWidth_pix; // 0x30
		::UnityEngine::Vector2 _obUVscale_k__BackingField; // 0x34
		::UnityEngine::Vector2 _obUVoffset_k__BackingField; // 0x3C
		::System::Boolean _thisIsOnlyTexSetInAtlas_k__BackingField; // 0x44
		::System::Boolean _allTexturesUseSameMatTiling_k__BackingField; // 0x45
