...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_TEMPORARYTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD02BA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner_TemporaryTexture_TypeDefinitionIndex = 85120;
