...
#define DIGITALOPUS_MB_CORE_MBVERSION_ADDBLENDSHAPEFRAME_OFFSET UNITYSDK_OFFSET(0x1ECE2C50)
#define DIGITALOPUS_MB_CORE_MBVERSION_CLEARBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1ECE2B70)
#define DIGITALOPUS_MB_CORE_MBVERSION_COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1ECDCE70)
#define DIGITALOPUS_MB_CORE_MBVERSION_DETECTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1ECE32E0)
#define DIGITALOPUS_MB_CORE_MBVERSION_DOSPECIALRENDERPIPELINE_TEXTUREPACKERFASTSETUP_OFFSET UNITYSDK_OFFSET(0x1ECE3160)
#define DIGITALOPUS_MB_CORE_MBVERSION_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1ECE37A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_FINDSCENEOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1ECE2080)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETACTIVE_OFFSET UNITYSDK_OFFSET(0x1ECE1DE0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1ECE28A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMEVERTICES_OFFSET UNITYSDK_OFFSET(0x1ECE2A70)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1ECE2980)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBONES_OFFSET UNITYSDK_OFFSET(0x1ECE2700)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETLIGHTMAPTILINGOFFSET_OFFSET UNITYSDK_OFFSET(0x1ECE2600)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETMESHCHANNEL_OFFSET UNITYSDK_OFFSET(0x1ECE22A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETPROJECTCOLORSPACE_OFFSET UNITYSDK_OFFSET(0x1ECE3220)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETSCALEINLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x1ECE2380)
#define DIGITALOPUS_MB_CORE_MBVERSION_GRAPHICSUVSTARTSATTOP_OFFSET UNITYSDK_OFFSET(0x1ECE2F00)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISASSETINPROJECT_OFFSET UNITYSDK_OFFSET(0x1ECE3500)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISRUNNINGANDMESHNOTREADWRITEABLE_OFFSET UNITYSDK_OFFSET(0x1ECE21A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISTEXTUREREADABLE_OFFSET UNITYSDK_OFFSET(0x1ECE3080)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISTEXTURE_SRGBGAMMACORRECTED_OFFSET UNITYSDK_OFFSET(0x1ECE2FC0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISUSINGADDRESSABLES_OFFSET UNITYSDK_OFFSET(0x1ECE35C0)
#define DIGITALOPUS_MB_CORE_MBVERSION_IS_2017_1_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1ECE1D20)
#define DIGITALOPUS_MB_CORE_MBVERSION_IS_2018_3_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1ECE1C60)
#define DIGITALOPUS_MB_CORE_MBVERSION_MAXMESHVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1ECE2D50)
#define DIGITALOPUS_MB_CORE_MBVERSION_MESHASSIGNUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1ECE2520)
#define DIGITALOPUS_MB_CORE_MBVERSION_MESHCLEAR_OFFSET UNITYSDK_OFFSET(0x1ECE2440)
#define DIGITALOPUS_MB_CORE_MBVERSION_OPTIMIZEMESH_OFFSET UNITYSDK_OFFSET(0x1ECE27E0)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETACTIVERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1ECE1FA0)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1ECE1EC0)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETMESHINDEXFORMATANDCLEARMESH_OFFSET UNITYSDK_OFFSET(0x1ECE2E10)
#define DIGITALOPUS_MB_CORE_MBVERSION_UNESCAPEURL_OFFSET UNITYSDK_OFFSET(0x1ECE33A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_VERSION_OFFSET UNITYSDK_OFFSET(0x1ECE1B70)
#define DIGITALOPUS_MB_CORE_MBVERSION__CREATEMBVERSIONCONCRETE_OFFSET UNITYSDK_OFFSET(0x1ECE1AE0)
#define DIGITALOPUS_MB_CORE_MBVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECE37F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersion_TypeDefinitionIndex = 94544;
	...
	public:
		...
		{
			return (::DigitalOpus::MB::Core::MBVersionInterface**)Il2CppClass::FromTypeDefinitionIndex(MBVersion_TypeDefinitionIndex)->GetStaticField(0x525A0);
		}
