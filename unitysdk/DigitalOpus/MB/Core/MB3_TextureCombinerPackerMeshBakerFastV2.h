...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1B6E9550)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1B6E9510)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1B6E9560)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_ONETIMESETUP_OFFSET UNITYSDK_OFFSET(0x1B6E9600)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1B6E9490)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E9760)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFastV2_TypeDefinitionIndex = 85151;

	class MB3_TextureCombinerPackerMeshBakerFastV2 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* renderAtlasesGO; // 0x10
		::UnityEngine::GameObject* cameraGameObject; // 0x18
