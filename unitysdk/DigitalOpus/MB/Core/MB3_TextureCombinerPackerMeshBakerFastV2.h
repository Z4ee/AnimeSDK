...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1DAD97B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1DAD9770)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1DAD97C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_ONETIMESETUP_OFFSET UNITYSDK_OFFSET(0x1DAD9860)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1DAD96F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAD99C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFastV2_TypeDefinitionIndex = 90725;

	class MB3_TextureCombinerPackerMeshBakerFastV2 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* cameraGameObject; // 0x10
		::UnityEngine::Mesh* mesh; // 0x18
		::UnityEngine::GameObject* renderAtlasesGO; // 0x20
