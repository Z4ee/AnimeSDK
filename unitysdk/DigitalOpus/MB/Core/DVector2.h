...
#define DIGITALOPUS_MB_CORE_DVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1BAF8C70)
#define DIGITALOPUS_MB_CORE_DVECTOR2_GETVECTOR2_OFFSET UNITYSDK_OFFSET(0x9A7670)
#define DIGITALOPUS_MB_CORE_DVECTOR2_ISCONTAINEDINWITHMARGIN_OFFSET UNITYSDK_OFFSET(0x9A76E0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_ISCONTAINEDIN_OFFSET UNITYSDK_OFFSET(0x9A76A0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1BAF88C0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9A77C0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9A7710)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BAF8CA0)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x918440)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int DVector2_TypeDefinitionIndex = 85080;

	struct alignas(8) DVector2
	{
		static ::System::Double* StaticGet_epsilon()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(DVector2_TypeDefinitionIndex)->GetStaticField(0x11DC0);
		}
