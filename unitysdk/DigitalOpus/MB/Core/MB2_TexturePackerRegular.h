...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_DRAWGIZMOSNODE_OFFSET UNITYSDK_OFFSET(0x1B6638B0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B663B70)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_FLATTENTREE_OFFSET UNITYSDK_OFFSET(0x1B6636F0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETEXTENT_OFFSET UNITYSDK_OFFSET(0x1B6644A0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETRECTS_1_OFFSET UNITYSDK_OFFSET(0x1B664D10)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETRECTS_OFFSET UNITYSDK_OFFSET(0x1B664C20)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PRINTTREE_OFFSET UNITYSDK_OFFSET(0x1B6632E0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBEMULTIATLAS_OFFSET UNITYSDK_OFFSET(0x1B664580)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBESINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1B663C10)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_STEPWIDTHHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B664BF0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B669730)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__GETRECTSMULTIATLAS_OFFSET UNITYSDK_OFFSET(0x1B665050)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__GETRECTSSINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1B666BE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerRegular_TypeDefinitionIndex = 85109;
