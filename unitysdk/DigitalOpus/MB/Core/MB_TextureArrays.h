...
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CONVERTTEXTURESTOREADABLEFORMAT_OFFSET UNITYSDK_OFFSET(0x1EE37820)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CREATETEXTUREARRAYSFORRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1EE36C70)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_DETERMINEWHICHPROPERTIESHAVETEXTURES_OFFSET UNITYSDK_OFFSET(0x1EE368E0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_FINDBESTSIZEANDMIPCOUNTANDFORMATFORTEXTUREARRAYS_OFFSET UNITYSDK_OFFSET(0x1EE38940)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_ISLINEARPROPERTY_OFFSET UNITYSDK_OFFSET(0x1EE36B40)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CREATEATLASESCOROUTINESINGLERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1EE38F20)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE39020)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TextureArrays_TypeDefinitionIndex = 94684;
