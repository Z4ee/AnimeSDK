...
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CONVERTTEXTURESTOREADABLEFORMAT_OFFSET UNITYSDK_OFFSET(0x1DA6CA10)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CREATETEXTUREARRAYSFORRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DA6BE80)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_DETERMINEWHICHPROPERTIESHAVETEXTURES_OFFSET UNITYSDK_OFFSET(0x1DA6BAF0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_FINDBESTSIZEANDMIPCOUNTANDFORMATFORTEXTUREARRAYS_OFFSET UNITYSDK_OFFSET(0x1DA6DB40)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_ISLINEARPROPERTY_OFFSET UNITYSDK_OFFSET(0x1DA6BD50)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CREATEATLASESCOROUTINESINGLERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1DA6E110)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA6E210)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TextureArrays_TypeDefinitionIndex = 90751;
