...
#define DIGITALOPUS_MB_CORE_MESHBAKERSETTINGSUTILITY_DOUV2GETDATAFROMSOURCEMESHES_OFFSET UNITYSDK_OFFSET(0x1F7AD600)
#define DIGITALOPUS_MB_CORE_MESHBAKERSETTINGSUTILITY_GETMESHCHANNELSASFLAGS_OFFSET UNITYSDK_OFFSET(0x1F7ACE00)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MeshBakerSettingsUtility_TypeDefinitionIndex = 94598;
