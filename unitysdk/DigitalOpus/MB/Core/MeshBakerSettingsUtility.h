...
#define DIGITALOPUS_MB_CORE_MESHBAKERSETTINGSUTILITY_DOUV2GETDATAFROMSOURCEMESHES_OFFSET UNITYSDK_OFFSET(0x1C0469B0)
#define DIGITALOPUS_MB_CORE_MESHBAKERSETTINGSUTILITY_GETMESHCHANNELSASFLAGS_OFFSET UNITYSDK_OFFSET(0x1C0461D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MeshBakerSettingsUtility_TypeDefinitionIndex = 85091;
