...
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_ARETEXTURESEQUAL_OFFSET UNITYSDK_OFFSET(0x1E35C6F0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GETENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1E35C0C0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GETTEXNAME_OFFSET UNITYSDK_OFFSET(0x1E35C540)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GETTEXTURE2D_OFFSET UNITYSDK_OFFSET(0x1E35C100)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1E35C3F0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_ISIMPORTEDASNORMALMAP_OFFSET UNITYSDK_OFFSET(0x1E35BEB0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1E35C190)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_MATTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1E35BE80)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1E35C2A0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SETENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1E35C0E0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SET_ISIMPORTEDASNORMALMAP_OFFSET UNITYSDK_OFFSET(0x1E35BEC0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SET_MATTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1E35BEA0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SET_T_OFFSET UNITYSDK_OFFSET(0x1E35BE70)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E35C760)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E35BED0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MeshBakerMaterialTexture_TypeDefinitionIndex = 90700;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MeshBakerMaterialTexture_TypeDefinitionIndex)->GetStaticField(0x12C40);
		}
		::UnityEngine::Texture2D* _t; // 0x10
		::DigitalOpus::MB::Core::DRect _matTilingRect_k__BackingField; // 0x18
		::DigitalOpus::MB::Core::DRect encapsulatingSamplingRect; // 0x38
		::System::Single texelDensity; // 0x58
		::System::Int32 _isImportedAsNormalMap_k__BackingField; // 0x5C
