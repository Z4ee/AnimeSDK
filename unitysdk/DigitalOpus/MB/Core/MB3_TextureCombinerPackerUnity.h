...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1AF82A80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1AF82B60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_GETADJUSTEDFORSCALEANDOFFSET2_OFFSET UNITYSDK_OFFSET(0x1AF83380)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1AF82A70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__COPYTEXTURESINTOATLAS_OFFSET UNITYSDK_OFFSET(0x1AF82C00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF83C00)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerUnity_TypeDefinitionIndex = 85165;
