...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1E745D30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1E745E10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_GETADJUSTEDFORSCALEANDOFFSET2_OFFSET UNITYSDK_OFFSET(0x1E746610)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1E745D20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__COPYTEXTURESINTOATLAS_OFFSET UNITYSDK_OFFSET(0x1E745EA0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E746EA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerUnity_TypeDefinitionIndex = 94672;
