...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GETAVERAGECALCULATOR_OFFSET UNITYSDK_OFFSET(0x1E2D1A30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1E2D1A40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E2D19C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E2D19D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2D19E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_MaterialPropertyColor_TypeDefinitionIndex = 90711;
