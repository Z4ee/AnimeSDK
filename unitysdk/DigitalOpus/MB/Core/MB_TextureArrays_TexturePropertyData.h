...
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_TEXTUREPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2A6B00)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TextureArrays_TexturePropertyData_TypeDefinitionIndex = 94685;

	class MB_TextureArrays_TexturePropertyData : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::Vector2>* sizes; // 0x10
		::Il2CppArray<::DigitalOpus::MB::Core::MB_TextureCompressionQuality>* compressionQualities; // 0x18
