...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1BCFA210)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1BCF9E90)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1BCFA220)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCFA230)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperNone_TypeDefinitionIndex = 84995;
