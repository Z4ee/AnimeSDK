...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1F42DD50)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1F42D9D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1F42DD60)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F42DD70)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperNone_TypeDefinitionIndex = 94502;
