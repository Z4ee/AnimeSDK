...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1F7080C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1F707970)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1F706D90)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1F708680)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_MAXINDEXINVECTOR3_OFFSET UNITYSDK_OFFSET(0x1F708650)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F708690)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperPie_TypeDefinitionIndex = 94504;
