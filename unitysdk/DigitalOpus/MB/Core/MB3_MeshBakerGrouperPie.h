...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1BFA32D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1BFA2AD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1BFA1E20)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1BFA38C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_MAXINDEXINVECTOR3_OFFSET UNITYSDK_OFFSET(0x1BFA3890)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFA38D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperPie_TypeDefinitionIndex = 84997;
