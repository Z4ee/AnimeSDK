...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_MATERIALPROPERTYPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B3340)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_MATERIALPROPERTYPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B33E0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_MATERIALPROPERTYPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderMaterialPropertyCacheHelper_MaterialPropertyPair_TypeDefinitionIndex = 85009;
