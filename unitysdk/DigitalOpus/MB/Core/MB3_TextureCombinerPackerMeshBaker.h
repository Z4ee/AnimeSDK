...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_COPYSCALEDANDTILEDTOATLAS_OFFSET UNITYSDK_OFFSET(0x1D3AC4D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1D3AC430)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1D3AC420)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3AC5D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBaker_TypeDefinitionIndex = 90719;
