...
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F639D20)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F639DA0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F639760)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F639740)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ProgressUpdateCancelableDelegate_TypeDefinitionIndex = 94528;
