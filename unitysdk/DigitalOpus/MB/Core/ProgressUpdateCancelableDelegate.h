...
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E20E9C0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E20EA40)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E20E420)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E20E400)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ProgressUpdateCancelableDelegate_TypeDefinitionIndex = 90595;
