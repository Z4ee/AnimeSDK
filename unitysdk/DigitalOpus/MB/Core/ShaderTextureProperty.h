...
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E20EAB0)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E20EB80)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_GETNAMES_OFFSET UNITYSDK_OFFSET(0x1E20EB90)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E20EA90)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E20EA70)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ShaderTextureProperty_TypeDefinitionIndex = 90691;
