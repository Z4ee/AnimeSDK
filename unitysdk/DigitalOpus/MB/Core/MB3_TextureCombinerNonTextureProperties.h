...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_ADJUSTNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EE363A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_COLLECTAVERAGEVALUESOFNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EE35230)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_FINDBESTTEXTUREBLENDER_OFFSET UNITYSDK_OFFSET(0x1EE35D80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_FINDMATCHINGTEXTUREBLENDER_OFFSET UNITYSDK_OFFSET(0x1EE36050)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_GETCOLORASITWOULDAPPEARINATLASIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EE365A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_GETCOLORFORTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EE366A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_INTERFACEFILTER_OFFSET UNITYSDK_OFFSET(0x1EE35FC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_LOADTEXTUREBLENDERSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1EE35560)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_LOADTEXTUREBLENDERS_OFFSET UNITYSDK_OFFSET(0x1EE35590)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1EE361D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_TINTTEXTUREWITHTEXTURECOMBINER_OFFSET UNITYSDK_OFFSET(0x1EE362B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EE367A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE34890)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_TypeDefinitionIndex = 94641;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerNonTextureProperties_TypeDefinitionIndex)->GetStaticField(0x13280);
		}
		::DigitalOpus::MB::Core::TextureBlender* resultMaterialTextureBlender; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Color>* textureProperty2DefaultColorMap; // 0x18
		::Il2CppArray<::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties_TexPropertyNameColorPair>* defaultTextureProperty2DefaultColorMap; // 0x20
		::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties_NonTextureProperties* _nonTexturePropertiesBlender; // 0x28
