...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_ADJUSTNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B66C7D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_COLLECTAVERAGEVALUESOFNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B66B660)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_FINDBESTTEXTUREBLENDER_OFFSET UNITYSDK_OFFSET(0x1B66C1A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_FINDMATCHINGTEXTUREBLENDER_OFFSET UNITYSDK_OFFSET(0x1B66C470)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_GETCOLORASITWOULDAPPEARINATLASIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B66C9D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_GETCOLORFORTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B66CAE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_INTERFACEFILTER_OFFSET UNITYSDK_OFFSET(0x1B66C3E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_LOADTEXTUREBLENDERSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1B66B980)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_LOADTEXTUREBLENDERS_OFFSET UNITYSDK_OFFSET(0x1B66B9B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1B66C5F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_TINTTEXTUREWITHTEXTURECOMBINER_OFFSET UNITYSDK_OFFSET(0x1B66C6D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B66CBF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66ACC0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_TypeDefinitionIndex = 85134;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerNonTextureProperties_TypeDefinitionIndex)->GetStaticField(0x11E00);
		}
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Color>* textureProperty2DefaultColorMap; // 0x10
		::Il2CppArray<::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties_MaterialProperty*>* _nonTextureProperties; // 0x18
		::Il2CppArray<::DigitalOpus::MB::Core::TextureBlender*>* textureBlenders; // 0x20
		::DigitalOpus::MB::Core::TextureBlender* resultMaterialTextureBlender; // 0x28
		::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties_NonTextureProperties* _nonTexturePropertiesBlender; // 0x30
