...
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E81B1B0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E81B230)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E81AC10)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81ABF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ProgressUpdateDelegate_TypeDefinitionIndex = 90594;
