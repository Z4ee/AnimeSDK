...
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_ASSIGNINITIALVALUESFORMATERIALTILINGANDSAMPLINGRECTMATANDUVTILING_OFFSET UNITYSDK_OFFSET(0x1B6EB660)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B6EB1A0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B6EB3D0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GETMATERIALNAME_OFFSET UNITYSDK_OFFSET(0x1B6EB480)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GET_MATERIALTILING_OFFSET UNITYSDK_OFFSET(0x1B6EB0B0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GET_OBUVRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x1B6EB050)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GET_SAMPLINGRECTMATANDUVTILING_OFFSET UNITYSDK_OFFSET(0x1B6EB080)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_SET_MATERIALTILING_OFFSET UNITYSDK_OFFSET(0x1B6EB0D0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_SET_OBUVRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x1B6EB070)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_SET_SAMPLINGRECTMATANDUVTILING_OFFSET UNITYSDK_OFFSET(0x1B6EB0A0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6EB160)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EB0E0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED__INIT_OFFSET UNITYSDK_OFFSET(0x1B6EB120)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MatAndTransformToMerged_TypeDefinitionIndex = 85127;
	...
	public:
		...
		::DigitalOpus::MB::Core::DRect _samplingRectMatAndUVTiling_k__BackingField; // 0x20
		::DigitalOpus::MB::Core::DRect _materialTiling_k__BackingField; // 0x40
