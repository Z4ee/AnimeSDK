...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E12B910)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_ISSAME_OFFSET UNITYSDK_OFFSET(0x1E12B600)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_SHARESVERTS_OFFSET UNITYSDK_OFFSET(0x1E12B770)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E12BA30)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_MB_Triangle_TypeDefinitionIndex = 90671;
