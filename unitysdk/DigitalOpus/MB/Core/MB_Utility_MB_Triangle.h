...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1F5445C0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_ISSAME_OFFSET UNITYSDK_OFFSET(0x1F5442B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_SHARESVERTS_OFFSET UNITYSDK_OFFSET(0x1F544420)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5446E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_MB_Triangle_TypeDefinitionIndex = 94604;
