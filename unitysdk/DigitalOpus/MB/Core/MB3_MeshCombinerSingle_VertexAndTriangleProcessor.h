...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ADJUSTVERTSTOWRITEACCORDINGTOPIVOTPOSITIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0xA53030)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNBUFFERSTOMESH_OFFSET UNITYSDK_OFFSET(0xA53010)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNTRIANGLEDATAFORSUBMESHES_OFFSET UNITYSDK_OFFSET(0xA53020)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNTRIANGLEDATAFORSUBMESHES_SHOWHIDE_OFFSET UNITYSDK_OFFSET(0xA53020)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYARRAYSFROMPREVIOUSBAKEBUFFERSTONEWBUFFERS_OFFSET UNITYSDK_OFFSET(0xA52F90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYFROMDGOMESHTOBUFFERS_OFFSET UNITYSDK_OFFSET(0xA52FA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYUV2UNCHANGEDTOSEPARATERECTS_OFFSET UNITYSDK_OFFSET(0xA53090)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA52E70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETSUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0xA52F40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETSUBMESHTRISWITHSHOWHIDEAPPLIED_OFFSET UNITYSDK_OFFSET(0xA530A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETTRIANGLESIZES_OFFSET UNITYSDK_OFFSET(0xA530B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0xA52F20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INITFROMMESHCOMBINER_OFFSET UNITYSDK_OFFSET(0xA52F10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INITSHOWHIDE_OFFSET UNITYSDK_OFFSET(0xA52EE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INIT_OFFSET UNITYSDK_OFFSET(0xA52EB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x2ACBE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x417DB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_SET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_TRANSFEROWNERSHIPOFSERIALIZABLEBUFFERSTOCOMBINER_OFFSET UNITYSDK_OFFSET(0xA52F60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__COPYANDADJUSTUV2FROMMESH_OFFSET UNITYSDK_OFFSET(0xA53080)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__COPYANDADJUSTUVSFROMMESH_OFFSET UNITYSDK_OFFSET(0xA53070)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLDMATRIX_TRS_OFFSET UNITYSDK_OFFSET(0x1E057BD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0xA530C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_TRS_OFFSET UNITYSDK_OFFSET(0x1E058310)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_TR_OFFSET UNITYSDK_OFFSET(0x1E057680)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__NUMNONZEROLENGTHSUBMESHTRIS_OFFSET UNITYSDK_OFFSET(0x1E056DB0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_VertexAndTriangleProcessor_TypeDefinitionIndex = 90646;
