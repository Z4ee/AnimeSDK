...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CEILTONEARESTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1E734770)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CONVERTTORECTSWITHOUTPADDINGANDNORMALIZE01_OFFSET UNITYSDK_OFFSET(0x1E734C00)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_ROUNDTONEARESTPOSITIVEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1E734690)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_SCALEATLASTOFITMAXDIM_OFFSET UNITYSDK_OFFSET(0x1E7347B0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E734EE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePacker_TypeDefinitionIndex = 94608;
