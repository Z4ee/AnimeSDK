...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CEILTONEARESTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1AF71590)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CONVERTTORECTSWITHOUTPADDINGANDNORMALIZE01_OFFSET UNITYSDK_OFFSET(0x1AF71A10)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_ROUNDTONEARESTPOSITIVEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1AF714B0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_SCALEATLASTOFITMAXDIM_OFFSET UNITYSDK_OFFSET(0x1AF715D0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF71CD0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePacker_TypeDefinitionIndex = 85101;
