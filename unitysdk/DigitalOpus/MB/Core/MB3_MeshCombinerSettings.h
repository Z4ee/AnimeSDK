...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSETTINGS_GETMESHBAKERSETTINGSASSERIALIZEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E819CF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSETTINGS_GETMESHBAKERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1E819CE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E819D40)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSettings_TypeDefinitionIndex = 90628;
