...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1E457900)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1E4578C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1E457910)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1E4578B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4579B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFast_TypeDefinitionIndex = 90722;
