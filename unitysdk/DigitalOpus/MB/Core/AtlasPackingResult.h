...
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_CALCUSEDWIDTHANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E4545F0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4547B0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4545E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int AtlasPackingResult_TypeDefinitionIndex = 90674;
