...
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_CALCUSEDWIDTHANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1C11D330)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C11D4F0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11D320)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int AtlasPackingResult_TypeDefinitionIndex = 85100;
