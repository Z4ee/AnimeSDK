...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1E740D50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E7408C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1E73E5C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1E73E720)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1E73E990)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_OFFSET UNITYSDK_OFFSET(0x1E73E440)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSCENEHIERARCHPREBAKE_OFFSET UNITYSDK_OFFSET(0x1E7425E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSCENEMESHOBJECT_OFFSET UNITYSDK_OFFSET(0x1E7419B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSOURCEMATSTOSUBMESHIDXMAP_OFFSET UNITYSDK_OFFSET(0x1E73ADA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1E744480)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARBUFFERS_OFFSET UNITYSDK_OFFSET(0x1E741BF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1E7422C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1E7420E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1E741B90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_BONEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1E73B120)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_MESHCHANNELSCACHE_OFFSET UNITYSDK_OFFSET(0x1E73B0D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_VERTEXANDTRIANGLEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1E7387E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1E7423D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1E73AC30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E735590)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETBONES_OFFSET UNITYSDK_OFFSET(0x1E736720)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1E736730)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1E7417E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETMESH_OFFSET UNITYSDK_OFFSET(0x1E736370)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1E736290)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1E7362B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1E735930)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPADD_OFFSET UNITYSDK_OFFSET(0x1E735CD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCLEAR_OFFSET UNITYSDK_OFFSET(0x1E735EC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1E735F30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1E735E90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPGET_OFFSET UNITYSDK_OFFSET(0x1E735C70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPREMOVE_OFFSET UNITYSDK_OFFSET(0x1E735D60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1E735DC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCEID2DGO_OFFSET UNITYSDK_OFFSET(0x1E735FC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ISMIRRORED_OFFSET UNITYSDK_OFFSET(0x1E73E240)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_PRINTPROFILEINFO_OFFSET UNITYSDK_OFFSET(0x1E734F90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SETMESH_OFFSET UNITYSDK_OFFSET(0x1E7365E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_RENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1E735950)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_RESULTSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E7359E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1E735780)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SHOWHIDEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E7405E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_STARTPROFILE_OFFSET UNITYSDK_OFFSET(0x1E734EF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1E73F960)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E73EC80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1E744950)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1E744660)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1E744650)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VALIDATETARGRENDERERANDMESHANDRESULTSCENEOBJ_OFFSET UNITYSDK_OFFSET(0x1E73A580)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1E738860)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__COLLECTMATERIALTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1E736DD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__COLLECTOUTOFBOUNDSUVRECTS2_OFFSET UNITYSDK_OFFSET(0x1E737B20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__CONFIGURESCENEHIERARCH_OFFSET UNITYSDK_OFFSET(0x1E743A60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7450E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1E7422D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__GETBONES_OFFSET UNITYSDK_OFFSET(0x1E73E430)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7368D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__NEWMESH_OFFSET UNITYSDK_OFFSET(0x1E736540)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__SETLIGHTMAPINDEXIFPRESERVELIGHTMAPPING_OFFSET UNITYSDK_OFFSET(0x1E744190)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1E7381A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E73EED0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__UPDATEMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1E744C40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__USENATIVEARRAYAPIORNOT_OFFSET UNITYSDK_OFFSET(0x1E7387D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__VALIDATETEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1E737FD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE___ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1E73B170)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE___UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1E73FC30)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_TypeDefinitionIndex = 94562;
