...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1AF7DA90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AF7D610)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1AF7B340)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1AF7B4A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1AF7B720)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_OFFSET UNITYSDK_OFFSET(0x1AF7B1C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSCENEHIERARCHPREBAKE_OFFSET UNITYSDK_OFFSET(0x1AF7F330)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSCENEMESHOBJECT_OFFSET UNITYSDK_OFFSET(0x1AF7E700)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSOURCEMATSTOSUBMESHIDXMAP_OFFSET UNITYSDK_OFFSET(0x1AF77BC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1AF811A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARBUFFERS_OFFSET UNITYSDK_OFFSET(0x1AF7E940)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1AF7F010)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1AF7EE30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1AF7E8E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_BONEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1AF77F30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_MESHCHANNELSCACHE_OFFSET UNITYSDK_OFFSET(0x1AF77EE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_VERTEXANDTRIANGLEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1AF75640)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1AF7F120)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1AF77A50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF72380)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETBONES_OFFSET UNITYSDK_OFFSET(0x1AF73520)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1AF73530)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1AF7E530)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETMESH_OFFSET UNITYSDK_OFFSET(0x1AF73170)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1AF73090)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1AF730B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF72720)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPADD_OFFSET UNITYSDK_OFFSET(0x1AF72AC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCLEAR_OFFSET UNITYSDK_OFFSET(0x1AF72CB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1AF72D20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF72C80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPGET_OFFSET UNITYSDK_OFFSET(0x1AF72A60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPREMOVE_OFFSET UNITYSDK_OFFSET(0x1AF72B50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1AF72BB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCEID2DGO_OFFSET UNITYSDK_OFFSET(0x1AF72DB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ISMIRRORED_OFFSET UNITYSDK_OFFSET(0x1AF7AF30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_PRINTPROFILEINFO_OFFSET UNITYSDK_OFFSET(0x1AF71D80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SETMESH_OFFSET UNITYSDK_OFFSET(0x1AF733E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_RENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1AF72740)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_RESULTSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AF727D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AF72570)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SHOWHIDEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AF7D330)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_STARTPROFILE_OFFSET UNITYSDK_OFFSET(0x1AF71CE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1AF7C6D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AF7BA10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1AF81670)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AF81380)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AF81370)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VALIDATETARGRENDERERANDMESHANDRESULTSCENEOBJ_OFFSET UNITYSDK_OFFSET(0x1AF773B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1AF756C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__COLLECTMATERIALTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1AF73BE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__COLLECTOUTOFBOUNDSUVRECTS2_OFFSET UNITYSDK_OFFSET(0x1AF74970)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__CONFIGURESCENEHIERARCH_OFFSET UNITYSDK_OFFSET(0x1AF80790)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF81E00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1AF7F020)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__GETBONES_OFFSET UNITYSDK_OFFSET(0x1AF7B1B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AF736D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__NEWMESH_OFFSET UNITYSDK_OFFSET(0x1AF73340)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__SETLIGHTMAPINDEXIFPRESERVELIGHTMAPPING_OFFSET UNITYSDK_OFFSET(0x1AF80EC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1AF74FF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AF7BC60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__UPDATEMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1AF81960)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__USENATIVEARRAYAPIORNOT_OFFSET UNITYSDK_OFFSET(0x1AF75630)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__VALIDATETEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AF74E20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE___ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1AF77F80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE___UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AF7C990)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_TypeDefinitionIndex = 85055;
