...
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS_COPYBONEWEIGHTSFROMSEAMMESHTOOTHERMESHES_OFFSET UNITYSDK_OFFSET(0x1DE82650)
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS_REMAPBONEWEIGHTINDEXES_OFFSET UNITYSDK_OFFSET(0x1DE84620)
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE848A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_CopyBoneWeights_TypeDefinitionIndex = 90618;
