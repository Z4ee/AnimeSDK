...
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS_COPYBONEWEIGHTSFROMSEAMMESHTOOTHERMESHES_OFFSET UNITYSDK_OFFSET(0x1F29F4F0)
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS_REMAPBONEWEIGHTINDEXES_OFFSET UNITYSDK_OFFSET(0x1F2A1460)
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2A16E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_CopyBoneWeights_TypeDefinitionIndex = 94551;
