...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__COPYSCALEDANDTILEDTOATLAS_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B6E8300)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__COPYSCALEDANDTILEDTOATLAS_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6E9420)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__COPYSCALEDANDTILEDTOATLAS_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6E9480)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__COPYSCALEDANDTILEDTOATLAS_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B6E9430)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__COPYSCALEDANDTILEDTOATLAS_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6E82F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__COPYSCALEDANDTILEDTOATLAS_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E82E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBaker__CopyScaledAndTiledToAtlas_d__2_TypeDefinitionIndex = 85147;
	...
	public:
		...
		::DigitalOpus::MB::Core::MB_TexSet* sourceMaterial; // 0x18
		::DigitalOpus::MB::Core::ShaderTextureProperty* shaderPropertyName; // 0x20
		::DigitalOpus::MB::Core::ProgressUpdateDelegate* progressInfo; // 0x28
		::Il2CppArray<::Il2CppArray<::UnityEngine::Color>*>* atlasPixels; // 0x30
		...
		::System::Int32 _w_5__2; // 0x54
		::DigitalOpus::MB::Core::DRect srcSamplingRect; // 0x58
		::System::Int32 targH; // 0x78
		::System::Int32 targX; // 0x7C
		::System::Int32 _h_5__3; // 0x80
		::DigitalOpus::MB::Core::MB2_LogLevel LOG_LEVEL; // 0x84
		::System::Int32 _j_5__5; // 0x88
		::DigitalOpus::MB::Core::AtlasPadding padding; // 0x8C
		::System::Int32 __1__state; // 0x94
		::System::Int32 targY; // 0x98
		::System::Int32 targW; // 0x9C
