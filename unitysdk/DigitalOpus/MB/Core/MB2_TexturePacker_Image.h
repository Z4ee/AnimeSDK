...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_IMAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E04F560)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_IMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E04F520)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePacker_Image_TypeDefinitionIndex = 90678;
