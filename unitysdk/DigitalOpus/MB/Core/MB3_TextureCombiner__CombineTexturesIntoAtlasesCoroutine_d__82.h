...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASESCOROUTINE_D__82_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BAFE360)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASESCOROUTINE_D__82_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAFE520)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASESCOROUTINE_D__82_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAFE580)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASESCOROUTINE_D__82_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BAFE530)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASESCOROUTINE_D__82_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BAFE350)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASESCOROUTINE_D__82__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFE340)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner__CombineTexturesIntoAtlasesCoroutine_d__82_TypeDefinitionIndex = 85122;

	class MB3_TextureCombiner__CombineTexturesIntoAtlasesCoroutine_d__82 : public ::System::Object
	{
	public:
		::DigitalOpus::MB::Core::MB3_TextureCombiner_CombineTexturesIntoAtlasesCoroutineResult* coroutineResult; // 0x10
		::UnityEngine::Material* resultMaterial; // 0x18
		::System::Object* __2__current; // 0x20
		::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::AtlasPackingResult*>* packingResults; // 0x28
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* allowedMaterialsFilter; // 0x30
		::MB_AtlasesAndRects* resultAtlasesAndRects; // 0x38
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* objsToMesh; // 0x40
		::DigitalOpus::MB::Core::MB2_EditorMethodsInterface* textureEditorMethods; // 0x48
		::System::Collections::Generic::List_1<::System::String*>* texPropsToIgnore; // 0x50
		::DigitalOpus::MB::Core::MB3_TextureCombiner* __4__this; // 0x58
		::DigitalOpus::MB::Core::ProgressUpdateDelegate* progressInfo; // 0x60
		::System::Int32 __1__state; // 0x68
		::System::Boolean splitAtlasWhenPackingIfTooBig; // 0x6C
		::System::Boolean onlyPackRects; // 0x6D
		::System::Single maxTimePerFrame; // 0x70
