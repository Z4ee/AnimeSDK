...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_DOESSHADERNAMEMATCH_OFFSET UNITYSDK_OFFSET(0x1F728DC0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_GETCOLORIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1F729050)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1F728F80)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_ONBEFORETINTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1F728EB0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_ONBLENDTEXTUREPIXEL_OFFSET UNITYSDK_OFFSET(0x1F728F50)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_SETNONTEXTUREPROPERTYVALUESONRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F728FE0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F729170)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderLegacyBumpDiffuse_TypeDefinitionIndex = 94513;

	class TextureBlenderLegacyBumpDiffuse : public ::System::Object
	{
	public:
		::System::Boolean doColor; // 0x10
		::UnityEngine::Color m_defaultTintColor; // 0x14
