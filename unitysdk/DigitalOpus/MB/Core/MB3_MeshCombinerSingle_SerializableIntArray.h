...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SERIALIZABLEINTARRAY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7454F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SERIALIZABLEINTARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E737AE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_SerializableIntArray_TypeDefinitionIndex = 94567;
