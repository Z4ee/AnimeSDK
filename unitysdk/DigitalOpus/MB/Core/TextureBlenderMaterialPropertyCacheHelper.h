...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_ALLNONTEXTUREPROPERTYVALUESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1E35C770)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_CACHEMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E35C9D0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_GETVALUEIFALLSOURCEARETHESAMEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1E35CA70)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E35CC60)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderMaterialPropertyCacheHelper_TypeDefinitionIndex = 90582;
