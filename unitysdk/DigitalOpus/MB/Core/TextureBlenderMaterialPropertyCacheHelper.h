...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_ALLNONTEXTUREPROPERTYVALUESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1C038680)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_CACHEMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C0388E0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_GETVALUEIFALLSOURCEARETHESAMEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1C038980)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C038B70)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderMaterialPropertyCacheHelper_TypeDefinitionIndex = 85008;
