...
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B6EAF30)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6EAFE0)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6EB040)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B6EAFF0)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6EAF20)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EAF10)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersion__FindRuntimeMaterialsFromAddresses_d__36_TypeDefinitionIndex = 85039;

	class MBVersion__FindRuntimeMaterialsFromAddresses_d__36 : public ::System::Object
	{
	public:
		::MB2_TextureBakeResults* textureBakeResult; // 0x10
		::System::Object* __2__current; // 0x18
		::MB2_TextureBakeResults_CoroutineResult* isComplete; // 0x20
