...
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DADB190)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DADB240)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DADB2A0)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DADB250)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DADB180)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36__CTOR_OFFSET UNITYSDK_OFFSET(0x1DADB170)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersion__FindRuntimeMaterialsFromAddresses_d__36_TypeDefinitionIndex = 90613;
