...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_ADDTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EEA3690)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1EEA3010)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1EEA2E00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1EEA28E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EEA2AC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1EEA2AA0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_DOMERGEDISTINCTMATERIALTEXTURESTHATWOULDEXCEEDATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1EEA2AE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1EEA29C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_LAYERTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1EEA29E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2940)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1EEA2900)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2920)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1EEA2A00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1EEA2A80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1EEA2A60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1EEA29A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1EEA2A40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_SAVEATLASESASASSETS_OFFSET UNITYSDK_OFFSET(0x1EEA2A20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1EEA28C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2980)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2960)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_LOADPIPELINEDATA_OFFSET UNITYSDK_OFFSET(0x1EEA3100)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_PRINTLIST_OFFSET UNITYSDK_OFFSET(0x1EEA69F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_RUNCORUTINEWITHOUTPAUSE_OFFSET UNITYSDK_OFFSET(0x1EEA2B00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1EEA28F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1EEA2AD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1EEA2AB0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_DOMERGEDISTINCTMATERIALTEXTURESTHATWOULDEXCEEDATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1EEA2AF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1EEA29D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_LAYERTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1EEA29F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2950)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1EEA2910)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2930)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1EEA2A10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1EEA2A90)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1EEA2A70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1EEA29B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1EEA2A50)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_SAVEATLASESASASSETS_OFFSET UNITYSDK_OFFSET(0x1EEA2A30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1EEA28D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2990)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1EEA2970)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SHOULDTEXTUREBELINEAR_OFFSET UNITYSDK_OFFSET(0x1EEA6B00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1EEA4180)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EEA6C10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1EEA2F40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CREATETEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1EEA3490)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1EEA36F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEA6B30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__DESTROYALLTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1EEA3A60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__DESTROYTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1EEA3B90)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__GETNUMTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1EEA3470)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__RESIZETEXTURE_OFFSET UNITYSDK_OFFSET(0x1EEA38A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__RESTOREPROCEDURALMATERIALS_OFFSET UNITYSDK_OFFSET(0x1EEA4170)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER___COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1EEA3360)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER___RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1EEA33E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner_TypeDefinitionIndex = 94625;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombiner_TypeDefinitionIndex)->GetStaticField(0x13260);
		}
