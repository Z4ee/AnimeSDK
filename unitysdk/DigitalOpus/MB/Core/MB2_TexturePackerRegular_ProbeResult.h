...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_GETSCORE_OFFSET UNITYSDK_OFFSET(0x1E13D4D0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_PRINTTREE_OFFSET UNITYSDK_OFFSET(0x1E13D510)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_SET_OFFSET UNITYSDK_OFFSET(0x1E13D490)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E13D550)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerRegular_ProbeResult_TypeDefinitionIndex = 90684;
	...
	public:
		...
		::System::Int32 numAtlases; // 0x18
		::System::Single efficiency; // 0x1C
		::System::Boolean largerOrEqualToMaxDim; // 0x20
		::System::Single squareness; // 0x24
		::System::Single totalAtlasArea; // 0x28
		::System::Int32 h; // 0x2C
		::System::Int32 outW; // 0x30
		::System::Int32 w; // 0x34
		::System::Int32 outH; // 0x38
