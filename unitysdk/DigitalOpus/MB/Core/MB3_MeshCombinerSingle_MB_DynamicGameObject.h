...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1BE01D50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_INITIALIZENEW_OFFSET UNITYSDK_OFFSET(0x1BE01B00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BE018C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_UNINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BE01D30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE01D70)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_DynamicGameObject_TypeDefinitionIndex = 85062;
