...
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED_DEBUGPRINT_OFFSET UNITYSDK_OFFSET(0x1B6EB6E0)
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED_GENERATEMAPFROMSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x1B6EBAD0)
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED_SETBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B6EB6C0)
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EBF10)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int SerializableSourceBlendShape2Combined_TypeDefinitionIndex = 85093;
