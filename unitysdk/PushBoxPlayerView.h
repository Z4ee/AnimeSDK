...
#define PUSHBOXPLAYERVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DA4B580)
#define PUSHBOXPLAYERVIEW_GETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1DA4BBE0)
#define PUSHBOXPLAYERVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1DA4BEC0)
#define PUSHBOXPLAYERVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DA4BD50)
#define PUSHBOXPLAYERVIEW_INIT_OFFSET UNITYSDK_OFFSET(0x1DA4B5E0)
#define PUSHBOXPLAYERVIEW_PLAYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1DA4B6A0)
#define PUSHBOXPLAYERVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x1DA4C030)
#define PUSHBOXPLAYERVIEW_SETAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x1DA4B850)
#define PUSHBOXPLAYERVIEW_SETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1DA4BB50)
#define PUSHBOXPLAYERVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DA4BC80)
#define PUSHBOXPLAYERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA4C070)

inline static constexpr unsigned int PushBoxPlayerView_TypeDefinitionIndex = 41327;
