...
#define CLASS_2_DB56BB40EF1C39CE_METHOD_2_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0x17ECB390)
#define CLASS_2_DB56BB40EF1C39CE__CTOR_OFFSET UNITYSDK_OFFSET(0x17ECB370)
...
public:
	...
	::System::UInt32 CMGPDNDPJOC; // 0x20
	::System::Int32 FFNBLDFFMCN; // 0x24
	::RPG::LittleGameShare::DiceCombatCore::TacticsBuyResult GNOEGILFEMD; // 0x28
