...
#define CLASS_2_DB56BB40EF1C39CE_METHOD_2_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0xA3D5440)
#define CLASS_2_DB56BB40EF1C39CE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3D5420)

inline static constexpr unsigned int Class_2_DB56BB40EF1C39CE_TypeDefinitionIndex = 56400;

class Class_2_DB56BB40EF1C39CE : public ::Class_1_2231FD56C070349F
{
public:
	::Class_1_E3E37125DAA7A899* Field_2_0; // 0x18
	::RPG::LittleGameShare::DiceCombatCore::TacticsBuyResult Field_2_1; // 0x20
