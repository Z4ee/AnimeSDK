...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1FC41BD0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_RESET_OFFSET UNITYSDK_OFFSET(0x1FC41BF0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1FC41C40)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1FC41CC0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FC41C00)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC41BE0)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int Adler32_TypeDefinitionIndex = 6776;
