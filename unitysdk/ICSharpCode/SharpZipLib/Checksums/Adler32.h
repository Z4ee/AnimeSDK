...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C5302B0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_RESET_OFFSET UNITYSDK_OFFSET(0x1C5302D0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1C530330)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1C5303B0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C5302E0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5302C0)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int Adler32_TypeDefinitionIndex = 6641;
