...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_COMPUTECRC32_OFFSET UNITYSDK_OFFSET(0x1FC63A70)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1FC63B10)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_RESET_OFFSET UNITYSDK_OFFSET(0x1FC63B30)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1FC63B20)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1FC63BF0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1FC63C70)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FC63B40)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC63E90)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC63E80)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int Crc32_TypeDefinitionIndex = 6777;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Crc32_TypeDefinitionIndex)->GetStaticField(0x5BE0);
		}
