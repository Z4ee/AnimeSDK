...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_COMPUTECRC32_OFFSET UNITYSDK_OFFSET(0x1E883800)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E8838A0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_RESET_OFFSET UNITYSDK_OFFSET(0x1E8838C0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E8838B0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1E883980)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1E883A00)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E8838D0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E883C30)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1E883C20)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int Crc32_TypeDefinitionIndex = 6773;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Crc32_TypeDefinitionIndex)->GetStaticField(0x5BD0);
		}
