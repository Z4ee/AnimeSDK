...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B2BDF50)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_RESET_OFFSET UNITYSDK_OFFSET(0x1B2BDF40)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B2BE010)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1B2BE090)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B2BDF60)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2BE1F0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B54D0)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int StrangeCRC_TypeDefinitionIndex = 6643;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(StrangeCRC_TypeDefinitionIndex)->GetStaticField(0x5B70);
		}
