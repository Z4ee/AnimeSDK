...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2EXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F93D870)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2EXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F93D930)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2EXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F93D9C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2EXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F93D820)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2Exception_TypeDefinitionIndex = 6771;
