...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2_COMPRESS_OFFSET UNITYSDK_OFFSET(0x1B2B50E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2_DECOMPRESS_OFFSET UNITYSDK_OFFSET(0x1B2B4EF0)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2_TypeDefinitionIndex = 6633;
