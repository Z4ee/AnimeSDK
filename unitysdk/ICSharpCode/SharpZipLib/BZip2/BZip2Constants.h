...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2CONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB72490)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2CONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB72480)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2Constants_TypeDefinitionIndex = 6769;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BZip2Constants_TypeDefinitionIndex)->GetStaticField(0x5C60);
		}
