...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ALLOCATECOMPRESSSTRUCTURES_OFFSET UNITYSDK_OFFSET(0x1D67D8C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSFINISHEDWITHSTREAM_OFFSET UNITYSDK_OFFSET(0x1D67F770)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTINTVS_OFFSET UNITYSDK_OFFSET(0x1D67F7E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTINT_OFFSET UNITYSDK_OFFSET(0x1D67F430)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTUCHAR_OFFSET UNITYSDK_OFFSET(0x1D67F270)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSSETSTREAM_OFFSET UNITYSDK_OFFSET(0x1D67D8A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSW_OFFSET UNITYSDK_OFFSET(0x1D67F630)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D67E830)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D67DD80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_DOREVERSIBLETRANSFORMATION_OFFSET UNITYSDK_OFFSET(0x1D67F310)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ENDBLOCK_OFFSET UNITYSDK_OFFSET(0x1D67E960)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ENDCOMPRESSION_OFFSET UNITYSDK_OFFSET(0x1D67EEF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D67DD10)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1D67F240)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FULLGTU_OFFSET UNITYSDK_OFFSET(0x1D6842A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GENERATEMTFVALUES_OFFSET UNITYSDK_OFFSET(0x1D683710)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_BYTESWRITTEN_OFFSET UNITYSDK_OFFSET(0x1D67EEE0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1D67DEA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1D67DEB0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1D67DEC0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1D67DE80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1D67DEF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1D67DF20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_HBASSIGNCODES_OFFSET UNITYSDK_OFFSET(0x1D683630)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_HBMAKECODELENGTHS_OFFSET UNITYSDK_OFFSET(0x1D6829C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1D67DB90)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D67D970)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MAINSORT_OFFSET UNITYSDK_OFFSET(0x1D6851E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MAKEMAPS_OFFSET UNITYSDK_OFFSET(0x1D67E890)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MED3_OFFSET UNITYSDK_OFFSET(0x1D6851C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MOVETOFRONTCODEANDSEND_OFFSET UNITYSDK_OFFSET(0x1D67F6D0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_PANIC_OFFSET UNITYSDK_OFFSET(0x1D682970)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_QSORT3_OFFSET UNITYSDK_OFFSET(0x1D684860)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_RANDOMISEBLOCK_OFFSET UNITYSDK_OFFSET(0x1D686090)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1D67E040)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1D67E090)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1D67DFA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SENDMTFVALUES_OFFSET UNITYSDK_OFFSET(0x1D67F880)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1D67DFF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1D67DE90)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1D67DF50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SIMPLESORT_OFFSET UNITYSDK_OFFSET(0x1D683DB0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_VSWAP_OFFSET UNITYSDK_OFFSET(0x1D684710)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1D67E2C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITERUN_OFFSET UNITYSDK_OFFSET(0x1D67E340)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1D67E0E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D67D690)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D67D880)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2OutputStream_TypeDefinitionIndex = 6769;
	...
	public:
		...
		::Il2CppArray<::System::Boolean>* inUse; // 0x28
		::Il2CppArray<::System::Int32>* increments; // 0x30
		::Il2CppArray<::System::Int32>* ftab; // 0x38
		::Il2CppArray<::System::Int32>* mtfFreq; // 0x40
		::Il2CppArray<::System::Char>* unseqToSeq; // 0x48
		::ICSharpCode::SharpZipLib::Checksums::IChecksum* mCrc; // 0x50
		::Il2CppArray<::System::Int32>* quadrant; // 0x58
		::Il2CppArray<::System::Char>* selectorMtf; // 0x60
		::System::IO::Stream* baseStream; // 0x68
		::Il2CppArray<::System::Byte>* block; // 0x70
		::Il2CppArray<::System::Char>* seqToUnseq; // 0x78
		::Il2CppArray<::System::Char>* selector; // 0x80
		::Il2CppArray<::System::Int32>* zptr; // 0x88
		::Il2CppArray<::System::Int16>* szptr; // 0x90
		::System::Int32 workDone; // 0x98
		::System::UInt32 blockCRC; // 0x9C
		::System::Int32 allowableBlockSize; // 0xA0
		::System::Int32 nBlocksRandomised; // 0xA4
		::System::Int32 bytesOut; // 0xA8
		::System::Int32 currentChar; // 0xAC
		::System::Int32 workFactor; // 0xB0
		::System::Int32 blockSize100k; // 0xB4
		::System::Int32 last; // 0xB8
		::System::Int32 origPtr; // 0xBC
		::System::Int32 workLimit; // 0xC0
		::System::Int32 nInUse; // 0xC4
		::System::Int32 nMTF; // 0xC8
		::System::UInt32 combinedCRC; // 0xCC
		::System::Int32 runLength; // 0xD0
		::System::Boolean disposed_; // 0xD4
		::System::Boolean blockRandomised; // 0xD5
		::System::Boolean firstAttempt; // 0xD6
		::System::Boolean isStreamOwner; // 0xD7
		::System::Int32 bsLive; // 0xD8
		::System::Int32 bsBuff; // 0xDC
