...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ALLOCATECOMPRESSSTRUCTURES_OFFSET UNITYSDK_OFFSET(0x1B2B5510)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSFINISHEDWITHSTREAM_OFFSET UNITYSDK_OFFSET(0x1B2B7400)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTINTVS_OFFSET UNITYSDK_OFFSET(0x1B2B7470)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTINT_OFFSET UNITYSDK_OFFSET(0x1B2B70B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTUCHAR_OFFSET UNITYSDK_OFFSET(0x1B2B6EE0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSSETSTREAM_OFFSET UNITYSDK_OFFSET(0x1B2B54E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSW_OFFSET UNITYSDK_OFFSET(0x1B2B72B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B2B6490)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2B59E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_DOREVERSIBLETRANSFORMATION_OFFSET UNITYSDK_OFFSET(0x1B2B6F80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ENDBLOCK_OFFSET UNITYSDK_OFFSET(0x1B2B65C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ENDCOMPRESSION_OFFSET UNITYSDK_OFFSET(0x1B2B6B60)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B2B5970)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B2B6EB0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FULLGTU_OFFSET UNITYSDK_OFFSET(0x1B2BBF30)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GENERATEMTFVALUES_OFFSET UNITYSDK_OFFSET(0x1B2BB3A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_BYTESWRITTEN_OFFSET UNITYSDK_OFFSET(0x1B2B6B50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1B2B5B00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1B2B5B10)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1B2B5B20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1B2B5AE0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B2B5B50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B2B5B80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_HBASSIGNCODES_OFFSET UNITYSDK_OFFSET(0x1B2BB2C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_HBMAKECODELENGTHS_OFFSET UNITYSDK_OFFSET(0x1B2BA650)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1B2B57F0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B2B55C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MAINSORT_OFFSET UNITYSDK_OFFSET(0x1B2BCE70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MAKEMAPS_OFFSET UNITYSDK_OFFSET(0x1B2B64F0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MED3_OFFSET UNITYSDK_OFFSET(0x1B2BCE50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MOVETOFRONTCODEANDSEND_OFFSET UNITYSDK_OFFSET(0x1B2B7350)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_PANIC_OFFSET UNITYSDK_OFFSET(0x1B2BA600)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_QSORT3_OFFSET UNITYSDK_OFFSET(0x1B2BC4F0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_RANDOMISEBLOCK_OFFSET UNITYSDK_OFFSET(0x1B2BDD20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B2B5CA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B2B5CF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1B2B5C00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SENDMTFVALUES_OFFSET UNITYSDK_OFFSET(0x1B2B7510)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B2B5C50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1B2B5AF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B2B5BB0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SIMPLESORT_OFFSET UNITYSDK_OFFSET(0x1B2BBA40)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_VSWAP_OFFSET UNITYSDK_OFFSET(0x1B2BC3A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B2B5F20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITERUN_OFFSET UNITYSDK_OFFSET(0x1B2B5FA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B2B5D40)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2B52D0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B54C0)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2OutputStream_TypeDefinitionIndex = 6638;
	...
	public:
		...
		::Il2CppArray<::System::Int32>* increments; // 0x28
		::Il2CppArray<::System::Boolean>* inUse; // 0x30
		::Il2CppArray<::System::Char>* selectorMtf; // 0x38
		::Il2CppArray<::System::Int32>* quadrant; // 0x40
		::Il2CppArray<::System::Int32>* mtfFreq; // 0x48
		::Il2CppArray<::System::Char>* selector; // 0x50
		::Il2CppArray<::System::Int16>* szptr; // 0x58
		::ICSharpCode::SharpZipLib::Checksums::IChecksum* mCrc; // 0x60
		::Il2CppArray<::System::Char>* seqToUnseq; // 0x68
		::Il2CppArray<::System::Byte>* block; // 0x70
		::Il2CppArray<::System::Int32>* ftab; // 0x78
		::Il2CppArray<::System::Char>* unseqToSeq; // 0x80
		::Il2CppArray<::System::Int32>* zptr; // 0x88
		::System::IO::Stream* baseStream; // 0x90
		::System::Int32 last; // 0x98
		::System::Int32 workLimit; // 0x9C
		::System::Int32 origPtr; // 0xA0
		::System::Int32 nBlocksRandomised; // 0xA4
		::System::Int32 bsBuff; // 0xA8
		::System::Int32 nInUse; // 0xAC
		::System::Int32 bsLive; // 0xB0
		::System::Int32 workFactor; // 0xB4
		::System::UInt32 blockCRC; // 0xB8
		::System::Int32 blockSize100k; // 0xBC
		::System::Int32 allowableBlockSize; // 0xC0
		::System::Int32 bytesOut; // 0xC4
		::System::Int32 runLength; // 0xC8
		::System::Int32 workDone; // 0xCC
		::System::Int32 nMTF; // 0xD0
		::System::UInt32 combinedCRC; // 0xD4
		::System::Boolean isStreamOwner; // 0xD8
		::System::Boolean blockRandomised; // 0xD9
		::System::Boolean disposed_; // 0xDA
		::System::Boolean firstAttempt; // 0xDB
		::System::Int32 currentChar; // 0xDC
