...
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E823EF0)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E823FB0)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E824040)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E823EA0)

namespace ICSharpCode::SharpZipLib
{
	inline static constexpr unsigned int SharpZipBaseException_TypeDefinitionIndex = 6766;
