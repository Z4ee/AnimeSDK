...
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4ED460)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C4ED520)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C4ED5B0)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4ED410)

namespace ICSharpCode::SharpZipLib
{
	inline static constexpr unsigned int SharpZipBaseException_TypeDefinitionIndex = 6635;
