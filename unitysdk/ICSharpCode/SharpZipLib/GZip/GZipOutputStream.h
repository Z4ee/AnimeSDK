...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E79B1A0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1E79B240)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1E79AED0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1E79AE50)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1E79AFC0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1E79AEF0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E79ADD0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79AD50)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipOutputStream_TypeDefinitionIndex = 6806;
