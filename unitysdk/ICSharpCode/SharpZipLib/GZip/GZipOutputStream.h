...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1FB73520)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1FB735C0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1FB73250)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1FB731D0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1FB73340)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1FB73270)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FB73150)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB730D0)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipOutputStream_TypeDefinitionIndex = 6810;
