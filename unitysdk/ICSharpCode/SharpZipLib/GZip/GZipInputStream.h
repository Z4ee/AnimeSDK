...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READFOOTER_OFFSET UNITYSDK_OFFSET(0x1C102690)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READHEADER_OFFSET UNITYSDK_OFFSET(0x1C101F10)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C101E60)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C101E00)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C101DA0)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipInputStream_TypeDefinitionIndex = 6673;
