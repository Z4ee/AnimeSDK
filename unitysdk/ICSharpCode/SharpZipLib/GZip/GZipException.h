...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E55D030)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E55D0F0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E55D180)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E55CFE0)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipException_TypeDefinitionIndex = 6802;
