...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_CONVERTTEMPORARYTOFINAL_OFFSET UNITYSDK_OFFSET(0x1FBA1430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FBA1790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_GETTEMPFILENAME_OFFSET UNITYSDK_OFFSET(0x1FBA1080)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_GETTEMPORARYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1FBA0FD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_MAKETEMPORARYCOPY_OFFSET UNITYSDK_OFFSET(0x1FBA1600)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_OPENFORDIRECTUPDATE_OFFSET UNITYSDK_OFFSET(0x1FBA16D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBA0F40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBA0E20)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int DiskArchiveStorage_TypeDefinitionIndex = 6886;
