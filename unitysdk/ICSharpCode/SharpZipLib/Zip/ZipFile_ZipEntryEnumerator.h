...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E79CD60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E79CDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E79CDA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79CD50)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipEntryEnumerator_TypeDefinitionIndex = 6873;
