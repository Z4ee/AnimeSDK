...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_ISSOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1FC0F5A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWCOMMENT_OFFSET UNITYSDK_OFFSET(0x1FC0F6A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWLENGTH_OFFSET UNITYSDK_OFFSET(0x1FC0F5B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKEBYTESAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1FC0F630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKETEXTAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1FC0F830)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1FC0F8F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_RESET_OFFSET UNITYSDK_OFFSET(0x1FC0F810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FC0F590)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC0F580)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipString_TypeDefinitionIndex = 6876;
