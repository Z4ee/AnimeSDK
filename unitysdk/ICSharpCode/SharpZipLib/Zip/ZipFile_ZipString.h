...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_ISSOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1C4FBEF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWCOMMENT_OFFSET UNITYSDK_OFFSET(0x1C4FBFF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWLENGTH_OFFSET UNITYSDK_OFFSET(0x1C4FBF00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKEBYTESAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1C4FBF80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKETEXTAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1C4FC170)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C4FC230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_RESET_OFFSET UNITYSDK_OFFSET(0x1C4FC160)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4FBEE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FBED0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipString_TypeDefinitionIndex = 6741;

	class ZipFile_ZipString : public ::System::Object
	{
	public:
		::System::String* comment_; // 0x10
		::Il2CppArray<::System::Byte>* rawComment_; // 0x18
