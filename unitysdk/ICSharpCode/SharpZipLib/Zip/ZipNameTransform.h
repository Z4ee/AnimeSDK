...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_GET_TRIMPREFIX_OFFSET UNITYSDK_OFFSET(0x1B2C7B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_ISVALIDNAME_1_OFFSET UNITYSDK_OFFSET(0x1B2C7C70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_ISVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1B2C7B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_MAKEVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1B2C7A00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_SET_TRIMPREFIX_OFFSET UNITYSDK_OFFSET(0x1B2C74A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_TRANSFORMDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B2C76A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_TRANSFORMFILE_OFFSET UNITYSDK_OFFSET(0x1B2C7750)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2C74D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2C7470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C7460)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipNameTransform_TypeDefinitionIndex = 6758;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(ZipNameTransform_TypeDefinitionIndex)->GetStaticField(0x5BF0);
		}
		static ::Il2CppArray<::System::Char>** StaticGet_InvalidEntryCharsRelaxed()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(ZipNameTransform_TypeDefinitionIndex)->GetStaticField(0x5BF8);
		}
