...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_STATICDISKDATASOURCE_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x1C4FB120)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_STATICDISKDATASOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FB110)
