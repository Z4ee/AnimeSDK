...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E55B300)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E55B3A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E55AD20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E55AD00)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipInputStream_ReadDataHandler_TypeDefinitionIndex = 6888;
