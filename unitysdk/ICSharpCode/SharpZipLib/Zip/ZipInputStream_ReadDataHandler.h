...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2121E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C212280)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C211C00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C211BF0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipInputStream_ReadDataHandler_TypeDefinitionIndex = 6757;
