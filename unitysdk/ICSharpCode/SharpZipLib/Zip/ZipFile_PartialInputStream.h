...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E87E2C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E87E590)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1E87E680)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1E87E670)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1E87E690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1E87E660)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E87E650)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E87E5A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1E87E1C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1E87E2D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1E87E4C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E87E470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E87E5B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1E87E420)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E87E130)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_PartialInputStream_TypeDefinitionIndex = 6875;
	...
	public:
		...
		::System::Int64 start_; // 0x48
		::System::Int64 end_; // 0x50
