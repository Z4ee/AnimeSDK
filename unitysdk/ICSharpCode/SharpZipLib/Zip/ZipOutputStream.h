...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_ADDEXTRADATAAES_OFFSET UNITYSDK_OFFSET(0x1C4504D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1C44FA90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_COPYANDENCRYPT_OFFSET UNITYSDK_OFFSET(0x1C450A20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1C450AF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1C44ED70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1C44EC80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1C44ED90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_PUTNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1C44EEC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1C44EC90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1C44ED40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1C44EDA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEAESHEADER_OFFSET UNITYSDK_OFFSET(0x1C450620)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEENCRYPTIONHEADER_OFFSET UNITYSDK_OFFSET(0x1C4506D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1C44EE00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1C44EE90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1C44EDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1C450800)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C44EB40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C44EA00)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipOutputStream_TypeDefinitionIndex = 6759;

	class ZipOutputStream : public ::ICSharpCode::SharpZipLib::Zip::Compression::Streams::DeflaterOutputStream
	{
	public:
		::Il2CppArray<::System::Byte>* zipComment; // 0x60
		::ICSharpCode::SharpZipLib::Checksums::Crc32* crc; // 0x68
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* curEntry; // 0x70
		::System::Collections::ArrayList* entries; // 0x78
		::ICSharpCode::SharpZipLib::Zip::CompressionMethod curMethod; // 0x80
		::ICSharpCode::SharpZipLib::Zip::UseZip64 useZip64_; // 0x84
		::System::Int64 offset; // 0x88
		::System::Int64 size; // 0x90
		::System::Int64 crcPatchPos; // 0x98
		::System::Boolean patchEntryHeader; // 0xA0
		::System::Int32 defaultCompressionLevel; // 0xA4
