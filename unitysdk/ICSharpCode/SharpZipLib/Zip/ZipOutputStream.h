...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_ADDEXTRADATAAES_OFFSET UNITYSDK_OFFSET(0x1FB68EE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1FB684B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_COPYANDENCRYPT_OFFSET UNITYSDK_OFFSET(0x1FB69430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1FB69500)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1FB67850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1FB67760)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1FB67870)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_PUTNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1FB679A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1FB67770)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1FB67820)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1FB67880)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEAESHEADER_OFFSET UNITYSDK_OFFSET(0x1FB69030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEENCRYPTIONHEADER_OFFSET UNITYSDK_OFFSET(0x1FB690E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1FB678E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1FB67970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1FB67890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1FB69210)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FB67620)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB674E0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipOutputStream_TypeDefinitionIndex = 6894;
	...
	public:
		...
		::System::Collections::ArrayList* entries; // 0x68
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* curEntry; // 0x70
		::Il2CppArray<::System::Byte>* zipComment; // 0x78
		::ICSharpCode::SharpZipLib::Zip::UseZip64 useZip64_; // 0x80
		::System::Int32 defaultCompressionLevel; // 0x84
		::System::Int64 sizePatchPos; // 0x88
		::System::Int64 size; // 0x90
		::System::Boolean patchEntryHeader; // 0x98
		::ICSharpCode::SharpZipLib::Zip::CompressionMethod curMethod; // 0x9C
		::System::Int64 offset; // 0xA0
		::System::Int64 crcPatchPos; // 0xA8
