...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C4BDC20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C4BDB30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1C4BD9E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1C4BDA10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1C4BDA40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1C4BDB00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1C4BD9C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1C4BDA70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C4BDAA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_LOCATEBLOCKWITHSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1C4BE2B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4BECA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLEINT_OFFSET UNITYSDK_OFFSET(0x1C4BE370)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLELONG_OFFSET UNITYSDK_OFFSET(0x1C4BEA90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLESHORT_OFFSET UNITYSDK_OFFSET(0x1C4BE9C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C4BDBC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1C4BDB60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C4BDB90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1C4BD9D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C4BDAD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4BEB10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEENDOFCENTRALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1C4BE570)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1C4BE1D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1C4BE540)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1C4BE260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEUINT_OFFSET UNITYSDK_OFFSET(0x1C4BE930)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEULONG_OFFSET UNITYSDK_OFFSET(0x1C4BEAE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEUSHORT_OFFSET UNITYSDK_OFFSET(0x1C4BE8E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELOCALHEADER_OFFSET UNITYSDK_OFFSET(0x1C4BDC50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEZIP64ENDOFCENTRALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1C4BE3A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1C4BDBF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4BD960)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BD8A0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipHelperStream_TypeDefinitionIndex = 6755;
