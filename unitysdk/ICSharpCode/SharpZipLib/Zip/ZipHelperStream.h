...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1FBD1410)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1FBD1320)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1FBD11D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1FBD1200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1FBD1230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1FBD12F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1FBD11B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1FBD1260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1FBD1290)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_LOCATEBLOCKWITHSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1FBD1A90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1FBD2480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLEINT_OFFSET UNITYSDK_OFFSET(0x1FBD1B50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLELONG_OFFSET UNITYSDK_OFFSET(0x1FBD2270)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLESHORT_OFFSET UNITYSDK_OFFSET(0x1FBD21A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1FBD13B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1FBD1350)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1FBD1380)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1FBD11C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1FBD12C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1FBD22F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEENDOFCENTRALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1FBD1D50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1FBD19B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1FBD1D20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1FBD1A40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEUINT_OFFSET UNITYSDK_OFFSET(0x1FBD2110)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEULONG_OFFSET UNITYSDK_OFFSET(0x1FBD22C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEUSHORT_OFFSET UNITYSDK_OFFSET(0x1FBD20C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELOCALHEADER_OFFSET UNITYSDK_OFFSET(0x1FBD1440)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEZIP64ENDOFCENTRALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1FBD1B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1FBD13E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBD1150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBD1090)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipHelperStream_TypeDefinitionIndex = 6890;
