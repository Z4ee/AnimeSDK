...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_ALIGNTOBYTE_OFFSET UNITYSDK_OFFSET(0x1C530860)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C530A10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_GET_BITCOUNT_OFFSET UNITYSDK_OFFSET(0x1C530850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_GET_ISFLUSHED_OFFSET UNITYSDK_OFFSET(0x1C530A00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1C530680)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1C530AB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBITS_OFFSET UNITYSDK_OFFSET(0x1C5308F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C530820)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1C530690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1C530740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITESHORTMSB_OFFSET UNITYSDK_OFFSET(0x1C530990)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITESHORT_OFFSET UNITYSDK_OFFSET(0x1C5306D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C530640)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C530600)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int PendingBuffer_TypeDefinitionIndex = 6700;
