...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_1_OFFSET UNITYSDK_OFFSET(0x1F9882C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_OFFSET UNITYSDK_OFFSET(0x1F9882A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FINISH_OFFSET UNITYSDK_OFFSET(0x1F988170)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1F988160)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1F988290)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1F988100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1F988180)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1F9881B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1F988130)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1F988150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1F9880B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1F988690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1F9885F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1F988200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1F9881E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1F988010)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1F987FF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F987FE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F987E90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F987E80)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int Deflater_TypeDefinitionIndex = 6829;
	...
	public:
		...
		::System::Boolean noZlibHeaderOrFooter; // 0x30
