...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_1_OFFSET UNITYSDK_OFFSET(0x1E5A0EE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_OFFSET UNITYSDK_OFFSET(0x1E5A0EC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FINISH_OFFSET UNITYSDK_OFFSET(0x1E5A0D90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E5A0D80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1E5A0EB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1E5A0D20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1E5A0DA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1E5A0DD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1E5A0D50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1E5A0D70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1E5A0CD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1E5A12A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1E5A1200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1E5A0E20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1E5A0E00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1E5A0C30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1E5A0C10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5A0C00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E5A0AB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A0AA0)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int Deflater_TypeDefinitionIndex = 6825;
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterEngine* engine; // 0x18
		::System::Int32 state; // 0x20
		::System::Boolean noZlibHeaderOrFooter; // 0x24
		::System::Int64 totalOut; // 0x28
