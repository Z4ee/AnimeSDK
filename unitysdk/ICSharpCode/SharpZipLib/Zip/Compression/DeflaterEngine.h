...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_DEFLATEFAST_OFFSET UNITYSDK_OFFSET(0x1F863BD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_DEFLATESLOW_OFFSET UNITYSDK_OFFSET(0x1F863E70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_DEFLATESTORED_OFFSET UNITYSDK_OFFSET(0x1F863A90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_DEFLATE_OFFSET UNITYSDK_OFFSET(0x1F863810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_FILLWINDOW_OFFSET UNITYSDK_OFFSET(0x1F863990)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_FINDLONGESTMATCH_OFFSET UNITYSDK_OFFSET(0x1F864C90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1F8646E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_GET_STRATEGY_OFFSET UNITYSDK_OFFSET(0x1F864710)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1F864700)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_INSERTSTRING_OFFSET UNITYSDK_OFFSET(0x1F864470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_NEEDSINPUT_OFFSET UNITYSDK_OFFSET(0x1F8642F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_RESETADLER_OFFSET UNITYSDK_OFFSET(0x1F8646C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_RESET_OFFSET UNITYSDK_OFFSET(0x1F864530)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1F864300)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1F864190)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1F864730)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_SET_STRATEGY_OFFSET UNITYSDK_OFFSET(0x1F864720)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_SLIDEWINDOW_OFFSET UNITYSDK_OFFSET(0x1F864AE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE_UPDATEHASH_OFFSET UNITYSDK_OFFSET(0x1F864400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F863720)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int DeflaterEngine_TypeDefinitionIndex = 6832;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* inputBuf; // 0x18
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterPending* pending; // 0x20
		::Il2CppArray<::System::Int16>* head; // 0x28
		::ICSharpCode::SharpZipLib::Checksums::Adler32* adler; // 0x30
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterHuffman* huffman; // 0x38
		::Il2CppArray<::System::Int16>* prev; // 0x40
		::System::Boolean prevAvailable; // 0x48
		::System::Int32 compressionFunction; // 0x4C
		::System::Int32 strstart; // 0x50
		::System::Int32 goodLength; // 0x54
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflateStrategy strategy; // 0x58
		::System::Int32 lookahead; // 0x5C
		::System::Int32 matchLen; // 0x60
		::System::Int32 ins_h; // 0x64
		::System::Int32 inputEnd; // 0x68
		::System::Int64 totalIn; // 0x70
		::System::Int32 max_lazy; // 0x78
		::System::Int32 inputOff; // 0x7C
		::System::Int32 matchStart; // 0x80
		::System::Int32 niceLength; // 0x84
		::System::Int32 max_chain; // 0x88
		::System::Int32 blockStart; // 0x8C
