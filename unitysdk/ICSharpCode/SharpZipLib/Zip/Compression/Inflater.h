...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODECHKSUM_OFFSET UNITYSDK_OFFSET(0x1E55E8B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEDICT_OFFSET UNITYSDK_OFFSET(0x1E55E320)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEHEADER_OFFSET UNITYSDK_OFFSET(0x1E55E200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEHUFFMAN_OFFSET UNITYSDK_OFFSET(0x1E55E3A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODE_OFFSET UNITYSDK_OFFSET(0x1E55EA70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1E55F580)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1E55F520)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISNEEDINGDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1E55F220)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1E55F550)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_REMAININGINPUT_OFFSET UNITYSDK_OFFSET(0x1E55F610)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1E55F5D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1E55F5C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_INFLATE_1_OFFSET UNITYSDK_OFFSET(0x1E55F330)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_INFLATE_OFFSET UNITYSDK_OFFSET(0x1E55F2B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1E55E180)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1E55EFD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1E55EFB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1E55F280)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1E55F240)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E55F640)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E55E0D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E55E0C0)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int Inflater_TypeDefinitionIndex = 6833;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Inflater_TypeDefinitionIndex)->GetStaticField(0x5C20);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_CPLENS()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Inflater_TypeDefinitionIndex)->GetStaticField(0x5C28);
		}
		...
		::ICSharpCode::SharpZipLib::Zip::Compression::Streams::OutputWindow* outputWindow; // 0x10
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterDynHeader* dynHeader; // 0x18
		::ICSharpCode::SharpZipLib::Checksums::Adler32* adler; // 0x20
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterHuffmanTree* litlenTree; // 0x28
		::ICSharpCode::SharpZipLib::Zip::Compression::Streams::StreamManipulator* input; // 0x30
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterHuffmanTree* distTree; // 0x38
		::System::Int32 repLength; // 0x40
		::System::Int32 repDist; // 0x44
		::System::Int32 uncomprLen; // 0x48
		::System::Int32 mode; // 0x4C
		::System::Int32 readAdler; // 0x50
		::System::Int64 totalOut; // 0x58
		::System::Int64 totalIn; // 0x60
		::System::Boolean noHeader; // 0x68
		::System::Boolean isLastBlock; // 0x69
		::System::Int32 neededBits; // 0x6C
