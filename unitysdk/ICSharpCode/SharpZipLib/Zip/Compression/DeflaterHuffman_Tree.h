...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDCODES_OFFSET UNITYSDK_OFFSET(0x1EA447F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDLENGTH_OFFSET UNITYSDK_OFFSET(0x1EA468D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDTREE_OFFSET UNITYSDK_OFFSET(0x1EA45760)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_CALCBLFREQ_OFFSET UNITYSDK_OFFSET(0x1EA46030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_CHECKEMPTY_OFFSET UNITYSDK_OFFSET(0x1EA46780)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_GETENCODEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1EA46300)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_RESET_OFFSET UNITYSDK_OFFSET(0x1EA44560)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_SETSTATICCODES_OFFSET UNITYSDK_OFFSET(0x1EA46470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_WRITESYMBOL_OFFSET UNITYSDK_OFFSET(0x1EA45100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_WRITETREE_OFFSET UNITYSDK_OFFSET(0x1EA44A50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA443E0)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int DeflaterHuffman_Tree_TypeDefinitionIndex = 6834;

	class DeflaterHuffman_Tree : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Int32>* bl_counts; // 0x10
		::Il2CppArray<::System::Int16>* freqs; // 0x18
		::Il2CppArray<::System::Int16>* codes; // 0x20
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterHuffman* dh; // 0x28
		::Il2CppArray<::System::Byte>* length; // 0x30
