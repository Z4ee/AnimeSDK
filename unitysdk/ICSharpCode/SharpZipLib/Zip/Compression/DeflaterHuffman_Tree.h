...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDCODES_OFFSET UNITYSDK_OFFSET(0x1D68B550)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDLENGTH_OFFSET UNITYSDK_OFFSET(0x1D68D7F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDTREE_OFFSET UNITYSDK_OFFSET(0x1D68C7B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_CALCBLFREQ_OFFSET UNITYSDK_OFFSET(0x1D68D040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_CHECKEMPTY_OFFSET UNITYSDK_OFFSET(0x1D68D6A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_GETENCODEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1D68D310)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_RESET_OFFSET UNITYSDK_OFFSET(0x1D68B2D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_SETSTATICCODES_OFFSET UNITYSDK_OFFSET(0x1D68D390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_WRITESYMBOL_OFFSET UNITYSDK_OFFSET(0x1D68BE40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_WRITETREE_OFFSET UNITYSDK_OFFSET(0x1D68B7A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D68B160)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int DeflaterHuffman_Tree_TypeDefinitionIndex = 6830;
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterHuffman* dh; // 0x20
		::Il2CppArray<::System::Byte>* length; // 0x28
		::Il2CppArray<::System::Int16>* codes; // 0x30
		::System::Int32 minNumCodes; // 0x38
		::System::Int32 numCodes; // 0x3C
