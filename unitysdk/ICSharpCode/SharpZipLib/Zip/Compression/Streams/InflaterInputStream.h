...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1F94FFA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1F94FFF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_FILL_OFFSET UNITYSDK_OFFSET(0x1F94FC60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1F94FE30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1F94FC20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1F94FD40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1F94FD70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1F94FD80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1F94FAA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1F94FD90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F94FDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1F950030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1F94FE60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1F94FEB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1F94FAB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F94FDE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1F94FAC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_STOPDECRYPTING_OFFSET UNITYSDK_OFFSET(0x1F94FC00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1F94FF50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1F94FF00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F94FA90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F94F900)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F94F8A0)

namespace ICSharpCode::SharpZipLib::Zip::Compression::Streams
{
	inline static constexpr unsigned int InflaterInputStream_TypeDefinitionIndex = 6807;
	...
	public:
		...
		::System::Boolean isStreamOwner; // 0x48
		::System::Boolean isClosed; // 0x49
