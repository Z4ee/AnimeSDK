...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1E55FFB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E560000)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_FILL_OFFSET UNITYSDK_OFFSET(0x1E55FC70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E55FE40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1E55FC30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1E55FD50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1E55FD80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1E55FD90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1E55FAB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E55FDA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E55FDC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1E560040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1E55FE70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E55FEC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1E55FAC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E55FDF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1E55FAD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_STOPDECRYPTING_OFFSET UNITYSDK_OFFSET(0x1E55FC10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1E55FF60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1E55FF10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E55FAA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E55F920)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E55F8C0)

namespace ICSharpCode::SharpZipLib::Zip::Compression::Streams
{
	inline static constexpr unsigned int InflaterInputStream_TypeDefinitionIndex = 6803;

	class InflaterInputStream : public ::System::IO::Stream
	{
	public:
		::ICSharpCode::SharpZipLib::Zip::Compression::Inflater* inf; // 0x28
		...
		::System::Int64 csize; // 0x40
		::System::Boolean isClosed; // 0x48
		::System::Boolean isStreamOwner; // 0x49
