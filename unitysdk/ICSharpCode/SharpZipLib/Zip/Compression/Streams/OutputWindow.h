...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYDICT_OFFSET UNITYSDK_OFFSET(0x1E77A120)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1E77A220)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYSTORED_OFFSET UNITYSDK_OFFSET(0x1E77A070)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_GETAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1E77A210)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_GETFREESPACE_OFFSET UNITYSDK_OFFSET(0x1E77A200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_REPEAT_OFFSET UNITYSDK_OFFSET(0x1E779EC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_RESET_OFFSET UNITYSDK_OFFSET(0x1E77A2F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_SLOWREPEAT_OFFSET UNITYSDK_OFFSET(0x1E779E20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_WRITE_OFFSET UNITYSDK_OFFSET(0x1E779D70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E77A300)

namespace ICSharpCode::SharpZipLib::Zip::Compression::Streams
{
	inline static constexpr unsigned int OutputWindow_TypeDefinitionIndex = 6823;
	...
	public:
		...
		::System::Int32 windowFilled; // 0x18
		::System::Int32 windowEnd; // 0x1C
