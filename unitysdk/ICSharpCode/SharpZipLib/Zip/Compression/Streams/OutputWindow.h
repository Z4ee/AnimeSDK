...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYDICT_OFFSET UNITYSDK_OFFSET(0x1C4386E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1C4387E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYSTORED_OFFSET UNITYSDK_OFFSET(0x1C438630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_GETAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1C4387D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_GETFREESPACE_OFFSET UNITYSDK_OFFSET(0x1C4387C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_REPEAT_OFFSET UNITYSDK_OFFSET(0x1C438480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_RESET_OFFSET UNITYSDK_OFFSET(0x1C4388B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_SLOWREPEAT_OFFSET UNITYSDK_OFFSET(0x1C4383E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_WRITE_OFFSET UNITYSDK_OFFSET(0x1C438330)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4388C0)

namespace ICSharpCode::SharpZipLib::Zip::Compression::Streams
{
	inline static constexpr unsigned int OutputWindow_TypeDefinitionIndex = 6692;
