...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ED0EC90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ED0ECC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ED0E770)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED0E750)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZip_ConfirmOverwriteDelegate_TypeDefinitionIndex = 6843;
