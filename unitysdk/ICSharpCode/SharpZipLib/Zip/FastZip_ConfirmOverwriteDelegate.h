...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D5360)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D5390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D4E20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CONFIRMOVERWRITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D4E10)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZip_ConfirmOverwriteDelegate_TypeDefinitionIndex = 6708;
