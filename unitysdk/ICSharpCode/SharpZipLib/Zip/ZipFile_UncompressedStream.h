...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E824EB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E824ED0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1E824EC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1E824F30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1E824F00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E824F40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E824F50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1E824F90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1E824FA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E824FB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E824F80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1E824FC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E824E50)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_UncompressedStream_TypeDefinitionIndex = 6874;
