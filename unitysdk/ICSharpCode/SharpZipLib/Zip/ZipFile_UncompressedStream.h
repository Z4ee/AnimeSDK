...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1FBFF9A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1FBFF9C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1FBFF9B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1FBFFA20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1FBFF9F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1FBFFA30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1FBFFA40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1FBFFA80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1FBFFA90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1FBFFAA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1FBFFA70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1FBFFAB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UNCOMPRESSEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBFF940)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_UncompressedStream_TypeDefinitionIndex = 6878;
