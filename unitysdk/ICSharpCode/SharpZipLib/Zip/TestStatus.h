...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_ADDERROR_OFFSET UNITYSDK_OFFSET(0x1C4FB210)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_BYTESTESTED_OFFSET UNITYSDK_OFFSET(0x1C4FB1F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_ENTRYVALID_OFFSET UNITYSDK_OFFSET(0x1C4FB200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1C4FB1D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_ERRORCOUNT_OFFSET UNITYSDK_OFFSET(0x1C4FB1E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_FILE_OFFSET UNITYSDK_OFFSET(0x1C4FB1C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_OPERATION_OFFSET UNITYSDK_OFFSET(0x1C4FB1B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_SETBYTESTESTED_OFFSET UNITYSDK_OFFSET(0x1C4FB250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_SETENTRY_OFFSET UNITYSDK_OFFSET(0x1C4FB230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_SETOPERATION_OFFSET UNITYSDK_OFFSET(0x1C4FB220)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FB1A0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int TestStatus_TypeDefinitionIndex = 6732;
	...
	public:
		...
		::System::Int64 bytesTested_; // 0x20
		::System::Int32 errorCount_; // 0x28
		::System::Boolean entryValid_; // 0x2C
