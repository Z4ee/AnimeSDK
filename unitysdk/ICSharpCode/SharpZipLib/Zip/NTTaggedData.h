...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1E42BEB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1E42C4B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1E42C5E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_LASTMODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1E42C380)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1E42BB00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_ISVALIDVALUE_OFFSET UNITYSDK_OFFSET(0x1E42C2A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1E42BB10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1E42C4C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1E42C5F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_LASTMODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1E42C390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E42C710)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int NTTaggedData_TypeDefinitionIndex = 6857;

	class NTTaggedData : public ::System::Object
	{
	public:
		::System::DateTime _createTime; // 0x10
		::System::DateTime _lastModificationTime; // 0x18
