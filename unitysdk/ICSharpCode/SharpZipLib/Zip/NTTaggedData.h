...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1C105E70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1C106470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1C1065A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_LASTMODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1C106340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1C105AC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_ISVALIDVALUE_OFFSET UNITYSDK_OFFSET(0x1C106260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1C105AD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1C106480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1C1065B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_LASTMODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1C106350)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1066D0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int NTTaggedData_TypeDefinitionIndex = 6726;
