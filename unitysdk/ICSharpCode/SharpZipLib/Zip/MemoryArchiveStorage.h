...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_CONVERTTEMPORARYTOFINAL_OFFSET UNITYSDK_OFFSET(0x1E8241B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E824480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_GETTEMPORARYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1E824100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_GET_FINALSTREAM_OFFSET UNITYSDK_OFFSET(0x1E8240F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_MAKETEMPORARYCOPY_OFFSET UNITYSDK_OFFSET(0x1E824250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_OPENFORDIRECTUPDATE_OFFSET UNITYSDK_OFFSET(0x1E824360)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E8240E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8240D0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int MemoryArchiveStorage_TypeDefinitionIndex = 6883;

	class MemoryArchiveStorage : public ::ICSharpCode::SharpZipLib::Zip::BaseArchiveStorage
	{
	public:
		::System::IO::MemoryStream* temporaryStream_; // 0x18
		::System::IO::MemoryStream* finalStream_; // 0x20
