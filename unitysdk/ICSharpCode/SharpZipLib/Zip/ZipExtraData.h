...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDDATA_1_OFFSET UNITYSDK_OFFSET(0x1E560F60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDDATA_OFFSET UNITYSDK_OFFSET(0x1E560F30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDENTRY_1_OFFSET UNITYSDK_OFFSET(0x1E560A70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDENTRY_OFFSET UNITYSDK_OFFSET(0x1E5608E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDLEINT_OFFSET UNITYSDK_OFFSET(0x1E561040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDLELONG_OFFSET UNITYSDK_OFFSET(0x1E5610D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDLESHORT_OFFSET UNITYSDK_OFFSET(0x1E560FF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDNEWENTRY_OFFSET UNITYSDK_OFFSET(0x1E560EF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E560270)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1E5605E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_DELETE_OFFSET UNITYSDK_OFFSET(0x1E560D10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E5613E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_FIND_OFFSET UNITYSDK_OFFSET(0x1E560500)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1E5605A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GETENTRYDATA_OFFSET UNITYSDK_OFFSET(0x1E560320)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GETSTREAMFORTAG_OFFSET UNITYSDK_OFFSET(0x1E560480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_CURRENTREADINDEX_OFFSET UNITYSDK_OFFSET(0x1E560790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E560460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_UNREADCOUNT_OFFSET UNITYSDK_OFFSET(0x1E5607A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_VALUELENGTH_OFFSET UNITYSDK_OFFSET(0x1E560780)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READBYTE_OFFSET UNITYSDK_OFFSET(0x1E561360)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READCHECK_OFFSET UNITYSDK_OFFSET(0x1E561140)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READINT_OFFSET UNITYSDK_OFFSET(0x1E561230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READLONG_OFFSET UNITYSDK_OFFSET(0x1E561100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READSHORTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E560820)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READSHORT_OFFSET UNITYSDK_OFFSET(0x1E5612F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_SETSHORT_OFFSET UNITYSDK_OFFSET(0x1E560DD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_SKIP_OFFSET UNITYSDK_OFFSET(0x1E5613C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_STARTNEWENTRY_OFFSET UNITYSDK_OFFSET(0x1E560E40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5602D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E560210)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipExtraData_TypeDefinitionIndex = 6859;
	...
	public:
		...
		::System::Int32 _readValueLength; // 0x20
