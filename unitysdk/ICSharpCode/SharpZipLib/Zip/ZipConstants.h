...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_1_OFFSET UNITYSDK_OFFSET(0x1F98AD50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_OFFSET UNITYSDK_OFFSET(0x1F989EA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_1_OFFSET UNITYSDK_OFFSET(0x1F98ABF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_OFFSET UNITYSDK_OFFSET(0x1F98AA90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1F98AA20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1F98A920)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_GET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1F98A860)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_SET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1F98A8C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F98AEB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F98AEA0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipConstants_TypeDefinitionIndex = 6850;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZipConstants_TypeDefinitionIndex)->GetStaticField(0x3200);
		}
		...
		// static const ::System::Int32 Field_1_23 = 0x8074B50; // 0x0
		// static const ::System::Int32 SpanningTempSignature = 0x30304B50; // 0x0
		// static const ::System::Int32 Field_1_21 = 0x30304B50; // 0x0
