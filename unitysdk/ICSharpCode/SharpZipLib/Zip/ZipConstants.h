...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_1_OFFSET UNITYSDK_OFFSET(0x1E5A3930)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_OFFSET UNITYSDK_OFFSET(0x1E5A2A80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_1_OFFSET UNITYSDK_OFFSET(0x1E5A37D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_OFFSET UNITYSDK_OFFSET(0x1E5A3670)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1E5A3600)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1E5A3500)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_GET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1E5A3440)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_SET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1E5A34A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E5A3A90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A3A80)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipConstants_TypeDefinitionIndex = 6846;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZipConstants_TypeDefinitionIndex)->GetStaticField(0x31F0);
		}
