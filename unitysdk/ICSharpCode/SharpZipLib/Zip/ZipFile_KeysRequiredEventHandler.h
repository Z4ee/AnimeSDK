...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FC42B10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FC42B50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FC42580)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC42560)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_KeysRequiredEventHandler_TypeDefinitionIndex = 6871;
