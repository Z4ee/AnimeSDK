...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5311C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C531200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C530C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C530C30)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_KeysRequiredEventHandler_TypeDefinitionIndex = 6736;
