...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_ADDFILECONTENTS_OFFSET UNITYSDK_OFFSET(0x1E77B9B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_1_OFFSET UNITYSDK_OFFSET(0x1E77AA60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_2_OFFSET UNITYSDK_OFFSET(0x1E77A6B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_OFFSET UNITYSDK_OFFSET(0x1E77A620)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTENTRY_OFFSET UNITYSDK_OFFSET(0x1E77B2A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1E77BB80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_1_OFFSET UNITYSDK_OFFSET(0x1E77ABE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_2_OFFSET UNITYSDK_OFFSET(0x1E77ACC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_OFFSET UNITYSDK_OFFSET(0x1E77AB10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1E77A460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1E77A520)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E77A4A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1E77A480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1E77A600)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1E77A5E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1E77A5C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_MAKEEXTERNALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E77C1D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_NAMEISVALID_OFFSET UNITYSDK_OFFSET(0x1E77C280)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1E77B610)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1E77B790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1E77A470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1E77A530)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E77A4C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1E77A490)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1E77A610)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1E77A5F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1E77A5D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E77A3D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E77A340)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZip_TypeDefinitionIndex = 6837;

	class FastZip : public ::System::Object
	{
	public:
		::System::String* sourceDirectory_; // 0x10
		::ICSharpCode::SharpZipLib::Zip::ZipOutputStream* outputStream_; // 0x18
		::System::String* password_; // 0x20
		::ICSharpCode::SharpZipLib::Zip::FastZip_ConfirmOverwriteDelegate* confirmDelegate_; // 0x28
		::ICSharpCode::SharpZipLib::Core::INameTransform* extractNameTransform_; // 0x30
		::Il2CppArray<::System::Byte>* buffer_; // 0x38
		::ICSharpCode::SharpZipLib::Zip::IEntryFactory* entryFactory_; // 0x40
		::ICSharpCode::SharpZipLib::Core::NameFilter* fileFilter_; // 0x48
		::ICSharpCode::SharpZipLib::Core::NameFilter* directoryFilter_; // 0x50
		::ICSharpCode::SharpZipLib::Zip::ZipFile* zipFile_; // 0x58
		::ICSharpCode::SharpZipLib::Zip::FastZipEvents* events_; // 0x60
		::ICSharpCode::SharpZipLib::Zip::FastZip_Overwrite overwrite_; // 0x68
		::System::Boolean restoreDateTimeOnExtract_; // 0x6C
		::System::Boolean restoreAttributesOnExtract_; // 0x6D
		::System::Boolean createEmptyDirectories_; // 0x6E
		::System::Boolean continueRunning_; // 0x6F
