...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_ADDFILECONTENTS_OFFSET UNITYSDK_OFFSET(0x1FB5BD00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_1_OFFSET UNITYSDK_OFFSET(0x1FB5ADE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_2_OFFSET UNITYSDK_OFFSET(0x1FB5AA30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_OFFSET UNITYSDK_OFFSET(0x1FB5A990)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTENTRY_OFFSET UNITYSDK_OFFSET(0x1FB5B630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1FB5BED0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_1_OFFSET UNITYSDK_OFFSET(0x1FB5AF70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_2_OFFSET UNITYSDK_OFFSET(0x1FB5B050)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_OFFSET UNITYSDK_OFFSET(0x1FB5AEA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1FB5A7D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1FB5A890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1FB5A810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1FB5A7F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1FB5A970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1FB5A950)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1FB5A930)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_MAKEEXTERNALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1FB5C520)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_NAMEISVALID_OFFSET UNITYSDK_OFFSET(0x1FB5C5D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1FB5B960)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1FB5BAE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1FB5A7E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1FB5A8A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1FB5A830)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1FB5A800)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1FB5A980)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1FB5A960)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1FB5A940)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FB5A740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB5A6B0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZip_TypeDefinitionIndex = 6841;

	class FastZip : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Zip::FastZip_ConfirmOverwriteDelegate* confirmDelegate_; // 0x10
		::System::String* sourceDirectory_; // 0x18
		::ICSharpCode::SharpZipLib::Core::NameFilter* directoryFilter_; // 0x20
		::ICSharpCode::SharpZipLib::Zip::ZipOutputStream* outputStream_; // 0x28
		::System::String* password_; // 0x30
		::Il2CppArray<::System::Byte>* buffer_; // 0x38
		::ICSharpCode::SharpZipLib::Core::NameFilter* fileFilter_; // 0x40
		::ICSharpCode::SharpZipLib::Zip::FastZipEvents* events_; // 0x48
		::ICSharpCode::SharpZipLib::Zip::ZipFile* zipFile_; // 0x50
		::ICSharpCode::SharpZipLib::Zip::IEntryFactory* entryFactory_; // 0x58
		::ICSharpCode::SharpZipLib::Core::INameTransform* extractNameTransform_; // 0x60
		::ICSharpCode::SharpZipLib::Zip::FastZip_Overwrite overwrite_; // 0x68
		::System::Boolean restoreAttributesOnExtract_; // 0x6C
		::System::Boolean restoreDateTimeOnExtract_; // 0x6D
		::System::Boolean continueRunning_; // 0x6E
		::System::Boolean createEmptyDirectories_; // 0x6F
