...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_FIXEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1E82F7D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E82F7E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1E82F820)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E82F750)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E82F800)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_SETTING_OFFSET UNITYSDK_OFFSET(0x1E82F7B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEDIRECTORYENTRY_1_OFFSET UNITYSDK_OFFSET(0x1E82FC50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEDIRECTORYENTRY_OFFSET UNITYSDK_OFFSET(0x1E82FC40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEFILEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1E82F850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1E82F840)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_FIXEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1E82F600)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E82F7F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1E82F830)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E82F760)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E82F810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_SETTING_OFFSET UNITYSDK_OFFSET(0x1E82F7C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E82F400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E82F460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82F3B0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipEntryFactory_TypeDefinitionIndex = 6850;

	class ZipEntryFactory : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Core::INameTransform* nameTransform_; // 0x10
		::ICSharpCode::SharpZipLib::Zip::ZipEntryFactory_TimeSetting timeSetting_; // 0x18
		::System::Int32 getAttributes_; // 0x1C
