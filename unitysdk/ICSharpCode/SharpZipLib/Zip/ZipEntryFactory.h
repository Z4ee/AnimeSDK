...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_FIXEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1C4FB680)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C4FB690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1C4FB6D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C4FB600)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C4FB6B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_SETTING_OFFSET UNITYSDK_OFFSET(0x1C4FB660)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEDIRECTORYENTRY_1_OFFSET UNITYSDK_OFFSET(0x1C4FBB00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEDIRECTORYENTRY_OFFSET UNITYSDK_OFFSET(0x1C4FBAF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEFILEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1C4FB700)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1C4FB6F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_FIXEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1C4FB4B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C4FB6A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1C4FB6E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C4FB610)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C4FB6C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_SETTING_OFFSET UNITYSDK_OFFSET(0x1C4FB670)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4FB2B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C4FB310)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FB260)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipEntryFactory_TypeDefinitionIndex = 6719;
	...
	public:
		...
		::System::Boolean isUnicodeText_; // 0x20
		::System::Int32 setAttributes_; // 0x24
