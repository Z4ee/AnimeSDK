...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1E82F230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1E82F240)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1E82F170)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1E82F190)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1E82F250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_SET_TAGID_OFFSET UNITYSDK_OFFSET(0x1E82F180)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82F160)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int RawTaggedData_TypeDefinitionIndex = 6854;
