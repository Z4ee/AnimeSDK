...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1C4FB0E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C4FB0F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1C4FB020)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1C4FB040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1C4FB100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA_SET_TAGID_OFFSET UNITYSDK_OFFSET(0x1C4FB030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_RAWTAGGEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FB010)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int RawTaggedData_TypeDefinitionIndex = 6723;
