...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1C219B20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_CRC_OFFSET UNITYSDK_OFFSET(0x1C219B60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C219B40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1C219B30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_CRC_OFFSET UNITYSDK_OFFSET(0x1C219B70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C219B50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C219B80)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int DescriptorData_TypeDefinitionIndex = 6753;

	class DescriptorData : public ::System::Object
	{
	public:
		::System::Int64 size; // 0x10
		::System::Int64 crc; // 0x18
		::System::Int64 compressedSize; // 0x20
