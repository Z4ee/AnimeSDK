...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1E5601A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_CRC_OFFSET UNITYSDK_OFFSET(0x1E5601E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1E5601C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1E5601B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_CRC_OFFSET UNITYSDK_OFFSET(0x1E5601F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1E5601D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E560200)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int DescriptorData_TypeDefinitionIndex = 6884;

	class DescriptorData : public ::System::Object
	{
	public:
		::System::Int64 crc; // 0x10
