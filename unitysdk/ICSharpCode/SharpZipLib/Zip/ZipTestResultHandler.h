...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2583C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C258400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C257E40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C257E30)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipTestResultHandler_TypeDefinitionIndex = 6733;
