...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B2C68F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_GET_ACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1B2C70C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_GET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1B2C7250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_GET_INCLUDE_OFFSET UNITYSDK_OFFSET(0x1B2C73E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_GET_MODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1B2C6F30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1B2C62D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_ISVALIDVALUE_OFFSET UNITYSDK_OFFSET(0x1B2C6E20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1B2C62E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_SET_ACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1B2C70D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_SET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1B2C7260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_SET_INCLUDE_OFFSET UNITYSDK_OFFSET(0x1B2C73F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA_SET_MODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1B2C6F40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_EXTENDEDUNIXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C7400)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ExtendedUnixData_TypeDefinitionIndex = 6724;

	class ExtendedUnixData : public ::System::Object
	{
	public:
		::System::DateTime _createTime; // 0x10
		::System::DateTime _lastAccessTime; // 0x18
		::ICSharpCode::SharpZipLib::Zip::ExtendedUnixData_Flags _flags; // 0x20
