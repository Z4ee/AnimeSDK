...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_GET_PROGRESSINTERVAL_OFFSET UNITYSDK_OFFSET(0x1F943500)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONCOMPLETEDFILE_OFFSET UNITYSDK_OFFSET(0x1F943370)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONDIRECTORYFAILURE_OFFSET UNITYSDK_OFFSET(0x1F943110)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONFILEFAILURE_OFFSET UNITYSDK_OFFSET(0x1F9431E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONPROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1F943430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONPROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1F9432B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_SET_PROGRESSINTERVAL_OFFSET UNITYSDK_OFFSET(0x1F943510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F943520)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZipEvents_TypeDefinitionIndex = 6840;
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Core::DirectoryFailureHandler* DirectoryFailure; // 0x28
		::ICSharpCode::SharpZipLib::Core::ProcessDirectoryHandler* ProcessDirectory; // 0x30
