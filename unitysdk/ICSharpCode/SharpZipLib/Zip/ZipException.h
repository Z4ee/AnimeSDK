...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E7C5FC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E7C3C10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E7C6080)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7C5F70)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipException_TypeDefinitionIndex = 6852;
