...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x1E42CE10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_COMMAND_OFFSET UNITYSDK_OFFSET(0x1E42CD90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1E42CDD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1E42CCC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1E42CDA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_OFFSETBASEDSIZE_OFFSET UNITYSDK_OFFSET(0x1E42CDF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_OUTENTRY_OFFSET UNITYSDK_OFFSET(0x1E42CCD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1E42CDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1E42CDE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_OFFSETBASEDSIZE_OFFSET UNITYSDK_OFFSET(0x1E42CE00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1E42CDC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E42C890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E42C990)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E42CA40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1E42CB40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1E42CB70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1E42CBE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1E42CCB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E42C860)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipUpdate_TypeDefinitionIndex = 6871;

	class ZipFile_ZipUpdate : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Zip::IStaticDataSource* dataSource_; // 0x10
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* outEntry_; // 0x18
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* entry_; // 0x20
		::System::String* filename_; // 0x28
		::System::Int64 sizePatchOffset_; // 0x30
		::System::Int64 _offsetBasedSize; // 0x38
		::System::Int64 crcPatchOffset_; // 0x40
