...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_BODYREAD_OFFSET UNITYSDK_OFFSET(0x1F8680D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1F867170)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1F867340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_COMPLETECLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1F867790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GETNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1F8668F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1F867A40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_CANDECOMPRESSENTRY_OFFSET UNITYSDK_OFFSET(0x1F8668E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1F867A50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1F8668C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_INITIALREAD_OFFSET UNITYSDK_OFFSET(0x1F867C30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1F867B00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1F8673D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READINGNOTAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1F867B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READINGNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1F867BE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1F867900)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1F8668D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F866820)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F866780)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipInputStream_TypeDefinitionIndex = 6891;

	class ZipInputStream : public ::ICSharpCode::SharpZipLib::Zip::Compression::Streams::InflaterInputStream
	{
	public:
		::ICSharpCode::SharpZipLib::Zip::ZipInputStream_ReadDataHandler* internalReader; // 0x50
		::System::String* password; // 0x58
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* entry; // 0x60
