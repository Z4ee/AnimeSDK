...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1FC42530)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1FC42540)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1FC42550)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FC424C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC42460)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int KeysRequiredEventArgs_TypeDefinitionIndex = 6864;
