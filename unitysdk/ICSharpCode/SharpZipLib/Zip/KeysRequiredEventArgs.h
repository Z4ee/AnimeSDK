...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1C530C00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1C530C10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1C530C20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C530B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_KEYSREQUIREDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C530B30)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int KeysRequiredEventArgs_TypeDefinitionIndex = 6729;
