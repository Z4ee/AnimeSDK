...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_CLEANNAME_OFFSET UNITYSDK_OFFSET(0x1C487E70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_CLONE_OFFSET UNITYSDK_OFFSET(0x1C487D10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_FORCEZIP64_OFFSET UNITYSDK_OFFSET(0x1C486F30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESENCRYPTIONSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1C487390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESKEYSIZE_OFFSET UNITYSDK_OFFSET(0x1C486CD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESOVERHEADSIZE_OFFSET UNITYSDK_OFFSET(0x1C4873C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESSALTLEN_OFFSET UNITYSDK_OFFSET(0x1C4873A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CANDECOMPRESS_OFFSET UNITYSDK_OFFSET(0x1C486EB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CENTRALHEADERREQUIRESZIP64_OFFSET UNITYSDK_OFFSET(0x1C486D70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1C487B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1C4870D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMPRESSIONMETHODFORHEADER_OFFSET UNITYSDK_OFFSET(0x1C4871F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1C487160)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CRC_OFFSET UNITYSDK_OFFSET(0x1C487100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CRYPTOCHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1C486A70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1C486FD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_DOSTIME_OFFSET UNITYSDK_OFFSET(0x1C486FB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_EXTERNALFILEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C486AF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_EXTRADATA_OFFSET UNITYSDK_OFFSET(0x1C487220)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C486A90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_HASCRC_OFFSET UNITYSDK_OFFSET(0x1C486A10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_HOSTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C486B40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISCRYPTED_OFFSET UNITYSDK_OFFSET(0x1C486A20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1C486DD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISDOSENTRY_OFFSET UNITYSDK_OFFSET(0x1C486B20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISFILE_OFFSET UNITYSDK_OFFSET(0x1C487C10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1C486A40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_LOCALHEADERREQUIRESZIP64_OFFSET UNITYSDK_OFFSET(0x1C486F50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C487090)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C486AD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C4870A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_VERSIONMADEBY_OFFSET UNITYSDK_OFFSET(0x1C486B10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1C486B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ZIPFILEINDEX_OFFSET UNITYSDK_OFFSET(0x1C486AB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_HASDOSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C486B50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_ISCOMPRESSIONMETHODSUPPORTED_1_OFFSET UNITYSDK_OFFSET(0x1C4871E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_ISCOMPRESSIONMETHODSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1C486F20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_ISZIP64FORCED_OFFSET UNITYSDK_OFFSET(0x1C486F40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_PROCESSAESEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1C487A10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_PROCESSEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1C4873E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_AESKEYSIZE_OFFSET UNITYSDK_OFFSET(0x1C4872E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1C487B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1C4870F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1C487170)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_CRC_OFFSET UNITYSDK_OFFSET(0x1C487120)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_CRYPTOCHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1C486A80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1C4866B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_DOSTIME_OFFSET UNITYSDK_OFFSET(0x1C486FC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_EXTERNALFILEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C486B00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_EXTRADATA_OFFSET UNITYSDK_OFFSET(0x1C487230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1C486AA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_HOSTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C486B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_ISCRYPTED_OFFSET UNITYSDK_OFFSET(0x1C486A30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1C486A50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C486AE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C4870C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_ZIPFILEINDEX_OFFSET UNITYSDK_OFFSET(0x1C486AC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C487E60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C486690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C486560)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C4868F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C486540)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipEntry_TypeDefinitionIndex = 6717;
	...
	public:
		...
		::System::UInt64 compressedSize; // 0x28
		::System::UInt32 dosTime; // 0x30
		::ICSharpCode::SharpZipLib::Zip::CompressionMethod method; // 0x34
		::System::Int32 _aesVer; // 0x38
		::System::UInt32 crc; // 0x3C
		::System::UInt64 size; // 0x40
		::System::Int64 offset; // 0x48
		::System::Int32 externalFileAttributes; // 0x50
		::System::Int32 _aesEncryptionStrength; // 0x54
		::System::Int32 flags; // 0x58
		::System::Int64 zipFileIndex; // 0x60
		::System::UInt16 versionMadeBy; // 0x68
		::System::Boolean forceZip64_; // 0x6A
		::System::Byte cryptoCheckValue_; // 0x6B
		::System::UInt16 versionToExtract; // 0x6C
		::ICSharpCode::SharpZipLib::Zip::ZipEntry_Known known; // 0x6E
