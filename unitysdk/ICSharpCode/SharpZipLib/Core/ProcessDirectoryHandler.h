...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSDIRECTORYHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F94D010)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSDIRECTORYHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F94D050)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSDIRECTORYHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F94CA80)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSDIRECTORYHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F94CA60)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProcessDirectoryHandler_TypeDefinitionIndex = 6783;
