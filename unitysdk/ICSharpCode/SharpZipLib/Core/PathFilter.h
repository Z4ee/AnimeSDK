...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PATHFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1C4BD760)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PATHFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BD710)
