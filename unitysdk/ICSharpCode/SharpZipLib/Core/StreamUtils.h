...
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_1_OFFSET UNITYSDK_OFFSET(0x1E556180)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_2_OFFSET UNITYSDK_OFFSET(0x1E5561B0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_OFFSET UNITYSDK_OFFSET(0x1E555FF0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_1_OFFSET UNITYSDK_OFFSET(0x1E555E60)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_OFFSET UNITYSDK_OFFSET(0x1E555E40)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5565F0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int StreamUtils_TypeDefinitionIndex = 6792;
