...
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_1_OFFSET UNITYSDK_OFFSET(0x1F93EBA0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_2_OFFSET UNITYSDK_OFFSET(0x1F93EBD0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_OFFSET UNITYSDK_OFFSET(0x1F93EA10)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_1_OFFSET UNITYSDK_OFFSET(0x1F93E880)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_OFFSET UNITYSDK_OFFSET(0x1F93E860)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F93F010)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int StreamUtils_TypeDefinitionIndex = 6796;
