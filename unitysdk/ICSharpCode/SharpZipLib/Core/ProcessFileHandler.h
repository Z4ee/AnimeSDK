...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E823740)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E823780)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8231C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8231A0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProcessFileHandler_TypeDefinitionIndex = 6780;
