...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FBFE220)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FBFE260)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FBFDC90)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBFDC70)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProcessFileHandler_TypeDefinitionIndex = 6784;
