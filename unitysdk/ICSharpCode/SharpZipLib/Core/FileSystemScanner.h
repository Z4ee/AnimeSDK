...
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONCOMPLETEFILE_OFFSET UNITYSDK_OFFSET(0x1C20C350)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONDIRECTORYFAILURE_OFFSET UNITYSDK_OFFSET(0x1C20C0E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONFILEFAILURE_OFFSET UNITYSDK_OFFSET(0x1C20C1B0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONPROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1C20C410)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONPROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1C20C290)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_SCANDIR_OFFSET UNITYSDK_OFFSET(0x1C20C4F0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_SCAN_OFFSET UNITYSDK_OFFSET(0x1C20C4E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C20BFE0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C20C0C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C20C0D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C20BF50)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int FileSystemScanner_TypeDefinitionIndex = 6654;

	class FileSystemScanner : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Core::ProcessFileHandler* ProcessFile; // 0x10
		::ICSharpCode::SharpZipLib::Core::IScanFilter* fileFilter_; // 0x18
		::ICSharpCode::SharpZipLib::Core::ProcessDirectoryHandler* ProcessDirectory; // 0x20
		::ICSharpCode::SharpZipLib::Core::CompletedFileHandler* CompletedFile; // 0x28
		::ICSharpCode::SharpZipLib::Core::IScanFilter* directoryFilter_; // 0x30
		::ICSharpCode::SharpZipLib::Core::FileFailureHandler* FileFailure; // 0x38
		::ICSharpCode::SharpZipLib::Core::DirectoryFailureHandler* DirectoryFailure; // 0x40
