...
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1FC5B9A0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1FC5B990)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1FC5B890)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_SET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1FC5B820)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_SET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1FC5B7B0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC5B680)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int NameAndSizeFilter_TypeDefinitionIndex = 6795;
