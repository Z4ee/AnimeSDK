...
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1C54CEC0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1C54CEB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1C54CDB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_SET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1C54CD40)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_SET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1C54CCD0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54CBA0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int NameAndSizeFilter_TypeDefinitionIndex = 6660;

	class NameAndSizeFilter : public ::ICSharpCode::SharpZipLib::Core::PathFilter
	{
	public:
		::System::Int64 maxSize_; // 0x18
		::System::Int64 minSize_; // 0x20
