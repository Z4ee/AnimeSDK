...
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E82EC40)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E82EC80)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E82E6C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82E6A0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int FileFailureHandler_TypeDefinitionIndex = 6784;
