...
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4FAAF0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4FAB30)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4FA570)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FA560)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int FileFailureHandler_TypeDefinitionIndex = 6653;
