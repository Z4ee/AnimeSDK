...
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS_GET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1FBFE2E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1FBFE2D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS_SET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1FBFE2F0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBFE270)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ScanEventArgs_TypeDefinitionIndex = 6779;
