...
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D4480)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D44C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D3F00)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D3EF0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int CompletedFileHandler_TypeDefinitionIndex = 6651;
