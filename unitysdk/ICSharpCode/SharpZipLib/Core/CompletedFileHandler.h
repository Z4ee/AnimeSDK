...
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D987530)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D987570)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D986FB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D986F90)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int CompletedFileHandler_TypeDefinitionIndex = 6782;
