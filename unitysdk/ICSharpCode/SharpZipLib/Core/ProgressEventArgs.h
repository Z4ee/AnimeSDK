...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS_GET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1C485920)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C485910)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS_GET_PERCENTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C485940)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS_GET_PROCESSED_OFFSET UNITYSDK_OFFSET(0x1C485970)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1C485980)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS_SET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1C485930)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C485890)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProgressEventArgs_TypeDefinitionIndex = 6645;

	class ProgressEventArgs : public ::System::EventArgs
	{
	public:
		::System::String* name_; // 0x10
		::System::Int64 processed_; // 0x18
