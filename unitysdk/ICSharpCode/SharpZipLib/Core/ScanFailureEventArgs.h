...
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_GET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1FBD1070)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1FBD1060)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1FBD1050)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_SET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1FBD1080)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBD0FE0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ScanFailureEventArgs_TypeDefinitionIndex = 6782;
