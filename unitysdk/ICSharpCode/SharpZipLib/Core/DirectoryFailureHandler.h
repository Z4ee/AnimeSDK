...
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4BD6C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4BD700)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4BD140)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BD130)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int DirectoryFailureHandler_TypeDefinitionIndex = 6652;
