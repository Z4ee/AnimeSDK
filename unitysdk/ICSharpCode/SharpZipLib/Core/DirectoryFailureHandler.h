...
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7F4330)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7F4370)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7F3DB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7F3D90)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int DirectoryFailureHandler_TypeDefinitionIndex = 6783;
