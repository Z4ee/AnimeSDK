...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C45CA60)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C45CAA0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C45C4E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C45C4D0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProgressHandler_TypeDefinitionIndex = 6650;
