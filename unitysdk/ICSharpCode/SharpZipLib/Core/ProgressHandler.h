...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FB72B70)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FB72BB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FB725E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB725C0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProgressHandler_TypeDefinitionIndex = 6785;
