...
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1FBA0AE0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1FBA0AC0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1FBA0AD0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1FBA0AB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1FBA0950)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1FBA0660)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1FBA0400)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1FBA05D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1FBA0390)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBA0470)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1FBA06F0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBA0240)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ExtendedPathFilter_TypeDefinitionIndex = 6794;

	class ExtendedPathFilter : public ::ICSharpCode::SharpZipLib::Core::PathFilter
	{
	public:
		::System::DateTime minDate_; // 0x18
		::System::Int64 maxSize_; // 0x20
		::System::Int64 minSize_; // 0x28
		::System::DateTime maxDate_; // 0x30
