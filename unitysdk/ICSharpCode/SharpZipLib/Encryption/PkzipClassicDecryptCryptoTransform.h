...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E87DEB0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_CANREUSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E87DE70)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_CANTRANSFORMMULTIPLEBLOCKS_OFFSET UNITYSDK_OFFSET(0x1E87DEA0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_INPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1E87DE80)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_OUTPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1E87DE90)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_TRANSFORMBLOCK_OFFSET UNITYSDK_OFFSET(0x1E87DD60)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_TRANSFORMFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1E87DCF0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E87DCE0)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int PkzipClassicDecryptCryptoTransform_TypeDefinitionIndex = 6797;
