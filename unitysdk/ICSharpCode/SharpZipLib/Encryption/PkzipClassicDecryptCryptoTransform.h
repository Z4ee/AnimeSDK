...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FC5BBA0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_CANREUSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1FC5BB60)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_CANTRANSFORMMULTIPLEBLOCKS_OFFSET UNITYSDK_OFFSET(0x1FC5BB90)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_INPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1FC5BB70)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_OUTPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1FC5BB80)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_TRANSFORMBLOCK_OFFSET UNITYSDK_OFFSET(0x1FC5BA40)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_TRANSFORMFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1FC5B9C0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC5B9B0)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int PkzipClassicDecryptCryptoTransform_TypeDefinitionIndex = 6801;
