...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_CREATEDECRYPTOR_OFFSET UNITYSDK_OFFSET(0x1FB59610)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_CREATEENCRYPTOR_OFFSET UNITYSDK_OFFSET(0x1FB595B0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GENERATEIV_OFFSET UNITYSDK_OFFSET(0x1FB59100)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GENERATEKEY_OFFSET UNITYSDK_OFFSET(0x1FB59360)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1FB59000)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1FB591A0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_LEGALBLOCKSIZES_OFFSET UNITYSDK_OFFSET(0x1FB59110)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_LEGALKEYSIZES_OFFSET UNITYSDK_OFFSET(0x1FB59070)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_SET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1FB59010)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1FB59420)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB59670)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int PkzipClassicManaged_TypeDefinitionIndex = 6802;
