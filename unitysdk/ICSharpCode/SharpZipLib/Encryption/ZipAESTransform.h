...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5D4D10)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GETAUTHCODE_OFFSET UNITYSDK_OFFSET(0x1B5D4C00)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_CANREUSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B5D4D00)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_CANTRANSFORMMULTIPLEBLOCKS_OFFSET UNITYSDK_OFFSET(0x1B5D4CF0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_INPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1B5D4CD0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_OUTPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1B5D4CE0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_PWDVERIFIER_OFFSET UNITYSDK_OFFSET(0x1B5D4BF0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_TRANSFORMBLOCK_OFFSET UNITYSDK_OFFSET(0x1B5D4900)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_TRANSFORMFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1B5D4C80)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D44D0)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int ZipAESTransform_TypeDefinitionIndex = 6669;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _encryptBuffer; // 0x10
		::Il2CppArray<::System::Byte>* _pwdVerifier; // 0x18
		::System::Security::Cryptography::ICryptoTransform* _encryptor; // 0x20
		::System::Security::Cryptography::HMACSHA1* _hmacsha1; // 0x28
		::Il2CppArray<::System::Byte>* _counterNonce; // 0x30
		::System::Boolean _writeMode; // 0x38
		::System::Boolean _finalised; // 0x39
		::System::Int32 _encrPos; // 0x3C
