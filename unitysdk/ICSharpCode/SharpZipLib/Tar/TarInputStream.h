...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1E55A1C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_COPYENTRYCONTENTS_OFFSET UNITYSDK_OFFSET(0x1E55A7F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E55A450)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1E557CC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1E55A660)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1E55A680)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1E55A350)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1E55A380)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1E55A390)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISMARKSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1E55A720)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1E55A330)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E55A3A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E55A3D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1E557B80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_MARK_OFFSET UNITYSDK_OFFSET(0x1E55A730)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1E55A5C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1E558FD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1E55A740)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1E55A480)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1E55A650)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E55A4D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1E557BE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E55A400)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIPTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1E55A750)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1E55A690)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1E55A570)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1E55A520)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E557120)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E55A2C0)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarInputStream_TypeDefinitionIndex = 6818;

	class TarInputStream : public ::System::IO::Stream
	{
	public:
		::ICSharpCode::SharpZipLib::Tar::TarEntry* currentEntry; // 0x28
		::ICSharpCode::SharpZipLib::Tar::TarBuffer* tarBuffer; // 0x30
