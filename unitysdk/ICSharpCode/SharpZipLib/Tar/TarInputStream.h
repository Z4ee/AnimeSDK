...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1F942A20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_COPYENTRYCONTENTS_OFFSET UNITYSDK_OFFSET(0x1F943050)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1F942CB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1F940680)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1F942EC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1F942EE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1F942BB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1F942BE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1F942BF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISMARKSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1F942F80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1F942B90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1F942C00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F942C30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1F940540)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_MARK_OFFSET UNITYSDK_OFFSET(0x1F942F90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1F942E20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1F941810)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1F942FA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1F942CE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1F942EB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1F942D30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1F9405A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F942C60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIPTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1F942FB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1F942EF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1F942DD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1F942D80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F93FAE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F942B20)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarInputStream_TypeDefinitionIndex = 6822;

	class TarInputStream : public ::System::IO::Stream
	{
	public:
		::ICSharpCode::SharpZipLib::Tar::TarEntry* currentEntry; // 0x28
		...
		::ICSharpCode::SharpZipLib::Tar::TarBuffer* tarBuffer; // 0x48
		::System::Int64 entrySize; // 0x50
		::System::Int64 entryOffset; // 0x58
		::System::Boolean hasHitEOF; // 0x60
