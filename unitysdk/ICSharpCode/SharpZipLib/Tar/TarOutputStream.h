...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1C254350)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C2544A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1C2542F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1C2542C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1C254580)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1C2540E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1C254110)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1C254140)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_ISENTRYOPEN_OFFSET UNITYSDK_OFFSET(0x1C254340)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1C2540A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1C254170)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C2541A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1C254560)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_PUTNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1C2545A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1C254260)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1C254290)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1C254200)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C254230)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1C2540C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C2541D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1C254A10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_WRITEEOFBLOCK_OFFSET UNITYSDK_OFFSET(0x1C254460)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1C254A90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C253FD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C253FC0)
...
namespace ICSharpCode::SharpZipLib::Tar
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Tar::TarBuffer* buffer; // 0x40
