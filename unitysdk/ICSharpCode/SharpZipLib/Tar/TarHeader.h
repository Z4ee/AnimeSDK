...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_CLONE_OFFSET UNITYSDK_OFFSET(0x1B2BEC70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_COMPUTECHECKSUM_OFFSET UNITYSDK_OFFSET(0x1B2C1AB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B2C1C80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETASCIIBYTES_OFFSET UNITYSDK_OFFSET(0x1B2C18D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETCHECKSUMOCTALBYTES_OFFSET UNITYSDK_OFFSET(0x1B2C1B70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETCTIME_OFFSET UNITYSDK_OFFSET(0x1B2C1840)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETDATETIMEFROMCTIME_OFFSET UNITYSDK_OFFSET(0x1B2C0A90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B2C1BF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETLONGOCTALBYTES_OFFSET UNITYSDK_OFFSET(0x1B2C17D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1B2C1FF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1B2C2220)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_3_OFFSET UNITYSDK_OFFSET(0x1B2C15B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_OFFSET UNITYSDK_OFFSET(0x1B2C1F10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAME_OFFSET UNITYSDK_OFFSET(0x1B2BE880)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETOCTALBYTES_OFFSET UNITYSDK_OFFSET(0x1B2C1680)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_CHECKSUM_OFFSET UNITYSDK_OFFSET(0x1B2BEBA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_DEVMAJOR_OFFSET UNITYSDK_OFFSET(0x1B2BEC30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_DEVMINOR_OFFSET UNITYSDK_OFFSET(0x1B2BEC50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B2BE8D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1B2BEC20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_ISCHECKSUMVALID_OFFSET UNITYSDK_OFFSET(0x1B2BEBB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_LINKNAME_OFFSET UNITYSDK_OFFSET(0x1B2BEBE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_MAGIC_OFFSET UNITYSDK_OFFSET(0x1B2BEBF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1B2BE890)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1B2BE900)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B2BE870)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B2BE8F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_TYPEFLAG_OFFSET UNITYSDK_OFFSET(0x1B2BEBC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1B2BE8B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1B2BEC10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B2BEC00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_MAKECHECKSUM_OFFSET UNITYSDK_OFFSET(0x1B2C0C00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_PARSEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B2BED10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1B2C0760)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_PARSEOCTAL_OFFSET UNITYSDK_OFFSET(0x1B2C09A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_RESTORESETVALUES_OFFSET UNITYSDK_OFFSET(0x1B2C1E80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SETVALUEDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1B2C1DE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_DEVMAJOR_OFFSET UNITYSDK_OFFSET(0x1B2BEC40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_DEVMINOR_OFFSET UNITYSDK_OFFSET(0x1B2BEC60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B2BE8E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1B2BE7B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_LINKNAME_OFFSET UNITYSDK_OFFSET(0x1B2BE6E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_MAGIC_OFFSET UNITYSDK_OFFSET(0x1B2BE590)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1B2BE8A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1B2BE910)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B2BE670)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B2BE800)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_TYPEFLAG_OFFSET UNITYSDK_OFFSET(0x1B2BEBD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1B2BE8C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1B2BE750)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B2BE600)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1B2C1040)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2C2300)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2BE2A0)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarHeader_TypeDefinitionIndex = 6686;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x5B80);
		}
		static ::System::String** StaticGet_groupNameAsSet()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x5B88);
		}
		static ::System::String** StaticGet_defaultGroupName()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x5B90);
		}
		static ::System::String** StaticGet_userNameAsSet()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x5B98);
		}
		static ::System::Int32* StaticGet_defaultGroupId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x3140);
		}
		static ::System::Int32* StaticGet_defaultUserId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x3144);
		}
		static ::System::Int32* StaticGet_userIdAsSet()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x3148);
		}
		static ::System::Int32* StaticGet_groupIdAsSet()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x314C);
		}
		static ::System::DateTime* StaticGet_dateTime1970()
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x3150);
		}
		...
		::System::String* linkName; // 0x18
		::System::String* magic; // 0x20
		::System::String* name; // 0x28
		::System::String* version; // 0x30
		::System::String* userName; // 0x38
		::System::Int32 devMinor; // 0x40
		::System::Int32 groupId; // 0x44
		::System::Int32 checksum; // 0x48
		::System::DateTime modTime; // 0x50
		::System::Int32 mode; // 0x58
		::System::Byte typeFlag; // 0x5C
		::System::Boolean isChecksumValid; // 0x5D
		::System::Int64 size; // 0x60
		::System::Int32 devMajor; // 0x68
		::System::Int32 userId; // 0x6C
