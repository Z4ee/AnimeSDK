...
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C20DB30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C20DB70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C20D510)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C20D500)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int ProgressMessageHandler_TypeDefinitionIndex = 6682;
