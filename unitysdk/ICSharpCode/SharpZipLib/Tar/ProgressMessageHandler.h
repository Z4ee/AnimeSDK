...
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E556C40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E556C80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E556620)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E556600)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int ProgressMessageHandler_TypeDefinitionIndex = 6813;
