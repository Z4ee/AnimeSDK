...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1C2179E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEINPUTTARBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1C216D20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEINPUTTARBUFFER_OFFSET UNITYSDK_OFFSET(0x1C216C00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEOUTPUTTARBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1C216FF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEOUTPUTTARBUFFER_OFFSET UNITYSDK_OFFSET(0x1C216ED0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETBLOCKFACTOR_OFFSET UNITYSDK_OFFSET(0x1C216BD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETCURRENTBLOCKNUM_OFFSET UNITYSDK_OFFSET(0x1C217550)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETCURRENTRECORDNUM_OFFSET UNITYSDK_OFFSET(0x1C217570)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1C216BB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_BLOCKFACTOR_OFFSET UNITYSDK_OFFSET(0x1C216BC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_CURRENTBLOCK_OFFSET UNITYSDK_OFFSET(0x1C217520)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_CURRENTRECORD_OFFSET UNITYSDK_OFFSET(0x1C217560)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1C217530)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1C216BA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C216E60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_ISENDOFARCHIVEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C217230)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_ISEOFBLOCK_OFFSET UNITYSDK_OFFSET(0x1C217130)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_READBLOCK_OFFSET UNITYSDK_OFFSET(0x1C217470)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_READRECORD_OFFSET UNITYSDK_OFFSET(0x1C2173B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1C217540)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_SKIPBLOCK_OFFSET UNITYSDK_OFFSET(0x1C217330)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITEBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1C217780)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C217580)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITEFINALRECORD_OFFSET UNITYSDK_OFFSET(0x1C217930)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITERECORD_OFFSET UNITYSDK_OFFSET(0x1C2176D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C216BE0)
...
namespace ICSharpCode::SharpZipLib::Tar
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* recordBuffer; // 0x18
		::System::IO::Stream* outputStream; // 0x20
		::System::Int32 currentBlockIndex; // 0x28
		::System::Int32 currentRecordIndex; // 0x2C
		::System::Boolean isStreamOwner_; // 0x30
		::System::Int32 blockFactor; // 0x34
		::System::Int32 recordSize; // 0x38
