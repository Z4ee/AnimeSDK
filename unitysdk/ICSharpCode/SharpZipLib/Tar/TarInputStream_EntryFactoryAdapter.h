...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER_CREATEENTRYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1E79CC20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER_CREATEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1E79CCB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER_CREATEENTRY_OFFSET UNITYSDK_OFFSET(0x1E79CB90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79CD40)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarInputStream_EntryFactoryAdapter_TypeDefinitionIndex = 6820;
