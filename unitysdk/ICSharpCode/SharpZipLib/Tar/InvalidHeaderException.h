...
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C437950)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C437A10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C437AA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C437900)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int InvalidHeaderException_TypeDefinitionIndex = 6681;
