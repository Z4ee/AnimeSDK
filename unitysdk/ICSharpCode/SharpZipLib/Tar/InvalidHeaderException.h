...
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E779390)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E779450)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E7794E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E779340)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int InvalidHeaderException_TypeDefinitionIndex = 6812;
