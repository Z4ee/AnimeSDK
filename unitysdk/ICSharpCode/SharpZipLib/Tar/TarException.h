...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4859E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C485AA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C485B30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C485990)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarException_TypeDefinitionIndex = 6680;
