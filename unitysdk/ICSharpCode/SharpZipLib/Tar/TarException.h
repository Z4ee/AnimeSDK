...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FBA0C40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1FBA0D00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1FBA0D90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBA0BF0)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarException_TypeDefinitionIndex = 6815;
