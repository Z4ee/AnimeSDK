...
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1F863690)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1F8636E0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_FILL_OFFSET UNITYSDK_OFFSET(0x1F8633A0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1F863520)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1F863440)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1F863470)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1F863480)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1F8623E0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1F863490)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F8634A0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_PARSEHEADER_OFFSET UNITYSDK_OFFSET(0x1F862F70)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1F862490)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1F8624F0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_RESETBUF_OFFSET UNITYSDK_OFFSET(0x1F863400)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1F863550)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1F8635A0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1F8623F0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1F8634D0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1F863640)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1F8635F0)
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F862400)

namespace ICSharpCode::SharpZipLib::LZW
{
	inline static constexpr unsigned int LzwInputStream_TypeDefinitionIndex = 6814;
	...
	public:
		...
		::System::Boolean eof; // 0x60
		::System::Byte finChar; // 0x61
		::System::Boolean headerParsed; // 0x62
		::System::Boolean isClosed; // 0x63
		::System::Int32 nBits; // 0x64
		::System::Int32 bitPos; // 0x68
		::System::Int32 got; // 0x6C
		::System::Int32 bitMask; // 0x70
		::System::Int32 oldCode; // 0x74
		::System::Int32 end; // 0x78
		::System::Int32 maxMaxCode; // 0x7C
		::System::Int32 stackP; // 0x80
		::System::Int32 maxBits; // 0x84
		::System::Int32 freeEnt; // 0x88
		::System::Int32 maxCode; // 0x8C
		::System::Boolean blockMode; // 0x90
		::System::Boolean isStreamOwner; // 0x91
