...
#define ICSHARPCODE_SHARPZIPLIB_LZW_LZWCONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F94D290)

namespace ICSharpCode::SharpZipLib::LZW
{
	inline static constexpr unsigned int LzwConstants_TypeDefinitionIndex = 6812;
