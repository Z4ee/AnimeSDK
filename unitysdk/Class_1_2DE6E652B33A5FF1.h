...
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x15B0AF10)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_55D86343A23F57E8_OFFSET UNITYSDK_OFFSET(0x15B09EB0)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_5F08B426ADF31FF5_OFFSET UNITYSDK_OFFSET(0x15B0AB20)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_719C91AA066BB16B_OFFSET UNITYSDK_OFFSET(0x15B0AAD0)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x15B0A570)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15B0AA40)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_A44A18C9451109E4_OFFSET UNITYSDK_OFFSET(0x15B0A850)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_B06F516E4459C742_OFFSET UNITYSDK_OFFSET(0x15B09FD0)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_B965CEE892F95FE3_OFFSET UNITYSDK_OFFSET(0x15B0A680)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_D05F37F7E5D1C36C_OFFSET UNITYSDK_OFFSET(0x15B0AD40)
#define CLASS_1_2DE6E652B33A5FF1_METHOD_1_FA013307F30F3628_OFFSET UNITYSDK_OFFSET(0x15B0A3B0)
#define CLASS_1_2DE6E652B33A5FF1__CTOR_OFFSET UNITYSDK_OFFSET(0x15B0AF70)
...
{
public:
	::System::Collections::Generic::List_1<::Class_1_3C1D1D7E172034A6*>* BONENBLJGCN; // 0x10
	::System::Action_3<::System::String*, ::UnityEngine::SkinnedMeshRenderer*, ::UnityEngine::Mesh*>* KINHNJOJAGB; // 0x18
	::System::Action_1<::Class_1_3C1D1D7E172034A6*>* MAEBAFINNNO; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* JIDFGJPFONL; // 0x28
	::UnityEngine::GameObject* OAGDNIBLMAC; // 0x30
	::RPG::GameCore::EntityLodLoadingData* CMCKMDEBKHE; // 0x38
	::System::String* AJDOEJPFFBF; // 0x40
