...
#define CLASS_2_79EA3C0F1B5547EE_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x195B4880)
#define CLASS_2_79EA3C0F1B5547EE_METHOD_2_6DE85A525F3B541B_OFFSET UNITYSDK_OFFSET(0x195B48F0)
#define CLASS_2_79EA3C0F1B5547EE_METHOD_2_9C2A65574448D201_OFFSET UNITYSDK_OFFSET(0x195B48A0)
#define CLASS_2_79EA3C0F1B5547EE_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x195B4890)
#define CLASS_2_79EA3C0F1B5547EE__CTOR_OFFSET UNITYSDK_OFFSET(0x195B4B90)

inline static constexpr unsigned int Class_2_79EA3C0F1B5547EE_TypeDefinitionIndex = 56408;

class Class_2_79EA3C0F1B5547EE : public ::RPG::PriorityLinkableNodeList_1<::Class_0_16E4307DCC419505_560*>
{
public:
