...
#define CLASS_2_5393E88C5FE145C5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13CFA6C0)
#define CLASS_2_5393E88C5FE145C5_METHOD_2_4E8F0BA4B6232E21_OFFSET UNITYSDK_OFFSET(0x13CFA7A0)
#define CLASS_2_5393E88C5FE145C5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13CFA700)
#define CLASS_2_5393E88C5FE145C5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13CFA850)
#define CLASS_2_5393E88C5FE145C5_TICK_OFFSET UNITYSDK_OFFSET(0x13CFA8A0)
#define CLASS_2_5393E88C5FE145C5__CTOR_OFFSET UNITYSDK_OFFSET(0x13CFA6B0)

inline static constexpr unsigned int Class_2_5393E88C5FE145C5_TypeDefinitionIndex = 54840;

class Class_2_5393E88C5FE145C5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowTutorialBlockMask* Field_2_0; // 0x18
