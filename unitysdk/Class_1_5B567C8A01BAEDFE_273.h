...
#define CLASS_1_5B567C8A01BAEDFE_273_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E074FE0)
#define CLASS_1_5B567C8A01BAEDFE_273_CLONE_OFFSET UNITYSDK_OFFSET(0x1E074CD0)
#define CLASS_1_5B567C8A01BAEDFE_273_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E074DE0)
#define CLASS_1_5B567C8A01BAEDFE_273_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E074D10)
#define CLASS_1_5B567C8A01BAEDFE_273_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E074F40)
#define CLASS_1_5B567C8A01BAEDFE_273_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E075030)
#define CLASS_1_5B567C8A01BAEDFE_273_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E075000)
#define CLASS_1_5B567C8A01BAEDFE_273_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E074C50)
#define CLASS_1_5B567C8A01BAEDFE_273_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E074C80)
#define CLASS_1_5B567C8A01BAEDFE_273_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E074F70)
#define CLASS_1_5B567C8A01BAEDFE_273_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E074FD0)
#define CLASS_1_5B567C8A01BAEDFE_273__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E075080)
#define CLASS_1_5B567C8A01BAEDFE_273__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E074CA0)
#define CLASS_1_5B567C8A01BAEDFE_273__CTOR_OFFSET UNITYSDK_OFFSET(0x1E074C90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_273_TypeDefinitionIndex = 31698;

class Class_1_5B567C8A01BAEDFE_273 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_273*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_273*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_273_TypeDefinitionIndex)->GetStaticField(0xE320);
	}
