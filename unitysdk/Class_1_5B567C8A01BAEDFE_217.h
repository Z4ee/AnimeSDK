...
#define CLASS_1_5B567C8A01BAEDFE_217_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1928C0B0)
#define CLASS_1_5B567C8A01BAEDFE_217_CLONE_OFFSET UNITYSDK_OFFSET(0x1928BEC0)
#define CLASS_1_5B567C8A01BAEDFE_217_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1928BFC0)
#define CLASS_1_5B567C8A01BAEDFE_217_EQUALS_OFFSET UNITYSDK_OFFSET(0x1928BF30)
#define CLASS_1_5B567C8A01BAEDFE_217_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1928C010)
#define CLASS_1_5B567C8A01BAEDFE_217_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1928C100)
#define CLASS_1_5B567C8A01BAEDFE_217_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1928C0D0)
#define CLASS_1_5B567C8A01BAEDFE_217_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1928BE10)
#define CLASS_1_5B567C8A01BAEDFE_217_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1928BE70)
#define CLASS_1_5B567C8A01BAEDFE_217_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1928C040)
#define CLASS_1_5B567C8A01BAEDFE_217_WRITETO_OFFSET UNITYSDK_OFFSET(0x1928C0A0)
#define CLASS_1_5B567C8A01BAEDFE_217__CCTOR_OFFSET UNITYSDK_OFFSET(0x1928C150)
#define CLASS_1_5B567C8A01BAEDFE_217__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1928BE90)
#define CLASS_1_5B567C8A01BAEDFE_217__CTOR_OFFSET UNITYSDK_OFFSET(0x1928BE80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_217_TypeDefinitionIndex = 29403;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_217*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_217_TypeDefinitionIndex)->GetStaticField(0x2FFA0);
	}
