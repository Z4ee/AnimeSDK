...
#define CLASS_2_C6247ED3A12D531A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188BBB90)
#define CLASS_2_C6247ED3A12D531A_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x188BC070)
#define CLASS_2_C6247ED3A12D531A_METHOD_2_E239382DD8D3653B_OFFSET UNITYSDK_OFFSET(0x188BBD20)
#define CLASS_2_C6247ED3A12D531A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188BBC40)
#define CLASS_2_C6247ED3A12D531A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188BBFC0)
#define CLASS_2_C6247ED3A12D531A_TICK_OFFSET UNITYSDK_OFFSET(0x188BC010)
#define CLASS_2_C6247ED3A12D531A__CTOR_OFFSET UNITYSDK_OFFSET(0x188BBB80)
...
public:
	...
	::RPG::GameCore::PlayMusicRhythmTalk* IGHAHBNLIJA; // 0x20
