...
#define CLASS_1_C0A429D585B22054_METHOD_1_0131B28D046A5D7C_OFFSET UNITYSDK_OFFSET(0x1CFEE600)
#define CLASS_1_C0A429D585B22054__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFEE7E0)
...
{
public:
	::RPG::GameCore::LimaoNewsEmployeeStateType BKEMOJMOLBB; // 0x10
	::RPG::Client::TextID EJJIJCCPJHP; // 0x18
	::System::UInt32 LPNBEANGIGE; // 0x28
	::System::UInt32 CNHDBLLCFFB; // 0x2C
