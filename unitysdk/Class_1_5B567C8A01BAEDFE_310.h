...
#define CLASS_1_5B567C8A01BAEDFE_310_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x192C8940)
#define CLASS_1_5B567C8A01BAEDFE_310_CLONE_OFFSET UNITYSDK_OFFSET(0x192C87B0)
#define CLASS_1_5B567C8A01BAEDFE_310_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x192C8850)
#define CLASS_1_5B567C8A01BAEDFE_310_EQUALS_OFFSET UNITYSDK_OFFSET(0x192C87F0)
#define CLASS_1_5B567C8A01BAEDFE_310_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192C88A0)
#define CLASS_1_5B567C8A01BAEDFE_310_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x192C8990)
#define CLASS_1_5B567C8A01BAEDFE_310_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x192C8960)
#define CLASS_1_5B567C8A01BAEDFE_310_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x192C8730)
#define CLASS_1_5B567C8A01BAEDFE_310_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x192C8760)
#define CLASS_1_5B567C8A01BAEDFE_310_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192C88D0)
#define CLASS_1_5B567C8A01BAEDFE_310_WRITETO_OFFSET UNITYSDK_OFFSET(0x192C8930)
#define CLASS_1_5B567C8A01BAEDFE_310__CCTOR_OFFSET UNITYSDK_OFFSET(0x192C89E0)
#define CLASS_1_5B567C8A01BAEDFE_310__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192C8780)
#define CLASS_1_5B567C8A01BAEDFE_310__CTOR_OFFSET UNITYSDK_OFFSET(0x192C8770)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_310_TypeDefinitionIndex = 31281;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_310*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_310_TypeDefinitionIndex)->GetStaticField(0x56F40);
	}
