...
#define TASKTREETEST__START_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x881F90)
#define TASKTREETEST__START_D__1_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x52B5E0)

inline static constexpr unsigned int TaskTreeTest__Start_d__1_TypeDefinitionIndex = 48929;
