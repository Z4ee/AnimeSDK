...
#define CLASS_1_7D206861DF006C83_EXECUTE_OFFSET UNITYSDK_OFFSET(0xB50B170)
#define CLASS_1_7D206861DF006C83_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB50B070)
#define CLASS_1_7D206861DF006C83_METHOD_1_6E17CBFDDFD73EDB_OFFSET UNITYSDK_OFFSET(0xB50BBB0)
#define CLASS_1_7D206861DF006C83_TEARDOWN_OFFSET UNITYSDK_OFFSET(0xB50BFB0)
#define CLASS_1_7D206861DF006C83__CTOR_OFFSET UNITYSDK_OFFSET(0xB50B060)

inline static constexpr unsigned int Class_1_7D206861DF006C83_TypeDefinitionIndex = 76801;
...
public:
	...
	::Entitas::IGroup_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* NFBCHEEFOCK; // 0x20
