...
#define CLASS_1_7D206861DF006C83_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19C28390)
#define CLASS_1_7D206861DF006C83_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19C28290)
#define CLASS_1_7D206861DF006C83_METHOD_1_6E17CBFDDFD73EDB_OFFSET UNITYSDK_OFFSET(0x19C28DD0)
#define CLASS_1_7D206861DF006C83_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x19C291D0)
#define CLASS_1_7D206861DF006C83__CTOR_OFFSET UNITYSDK_OFFSET(0x19C28280)

inline static constexpr unsigned int Class_1_7D206861DF006C83_TypeDefinitionIndex = 76800;

class Class_1_7D206861DF006C83 : public ::System::Object
{
public:
	::Entitas::IGroup_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* NFBCHEEFOCK; // 0x10
