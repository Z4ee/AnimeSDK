...
#define CARFLOWINTERSECTIONRULE_ADDCAR_OFFSET UNITYSDK_OFFSET(0x1A8685B0)
#define CARFLOWINTERSECTIONRULE_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0x1A868720)
#define CARFLOWINTERSECTIONRULE_GET_CARS_OFFSET UNITYSDK_OFFSET(0x1A868570)
#define CARFLOWINTERSECTIONRULE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x1A868590)
#define CARFLOWINTERSECTIONRULE_GET_MATH_OFFSET UNITYSDK_OFFSET(0x1A868550)
#define CARFLOWINTERSECTIONRULE_REMOVECAR_OFFSET UNITYSDK_OFFSET(0x1A868690)
#define CARFLOWINTERSECTIONRULE_SET_CARS_OFFSET UNITYSDK_OFFSET(0x1A868580)
#define CARFLOWINTERSECTIONRULE_SET_CURVE_OFFSET UNITYSDK_OFFSET(0x1A8685A0)
#define CARFLOWINTERSECTIONRULE_SET_MATH_OFFSET UNITYSDK_OFFSET(0x1A868560)
#define CARFLOWINTERSECTIONRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A868800)

inline static constexpr unsigned int CarFlowIntersectionRule_TypeDefinitionIndex = 47530;
