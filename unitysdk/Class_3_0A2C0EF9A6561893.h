...
#define CLASS_3_0A2C0EF9A6561893_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x140E9800)
#define CLASS_3_0A2C0EF9A6561893__CTOR_OFFSET UNITYSDK_OFFSET(0x140E97D0)

inline static constexpr unsigned int Class_3_0A2C0EF9A6561893_TypeDefinitionIndex = 53021;

class Class_3_0A2C0EF9A6561893 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::SetModifierDynamicValue*>
{
public:
	::RPG::GameCore::StringHash Field_3_0; // 0x28
	::RPG::GameCore::ArrayPoolWrapper_1<::Class_0_16E4307DCC419505_380*> Field_3_1; // 0x2C
