...
#define CLASS_2_5231D2D38C9A3D74_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11A9A000)
#define CLASS_2_5231D2D38C9A3D74_METHOD_2_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0x11A9A090)
#define CLASS_2_5231D2D38C9A3D74_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11A9A4B0)
#define CLASS_2_5231D2D38C9A3D74_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11A9A040)
#define CLASS_2_5231D2D38C9A3D74_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11A9A400)
#define CLASS_2_5231D2D38C9A3D74_TICK_OFFSET UNITYSDK_OFFSET(0x11A9A450)
#define CLASS_2_5231D2D38C9A3D74__CTOR_OFFSET UNITYSDK_OFFSET(0x11A99FF0)

inline static constexpr unsigned int Class_2_5231D2D38C9A3D74_TypeDefinitionIndex = 54023;
