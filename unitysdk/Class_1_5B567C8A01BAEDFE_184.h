...
#define CLASS_1_5B567C8A01BAEDFE_184_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A739580)
#define CLASS_1_5B567C8A01BAEDFE_184_CLONE_OFFSET UNITYSDK_OFFSET(0x1A739390)
#define CLASS_1_5B567C8A01BAEDFE_184_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A739490)
#define CLASS_1_5B567C8A01BAEDFE_184_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A739400)
#define CLASS_1_5B567C8A01BAEDFE_184_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7394E0)
#define CLASS_1_5B567C8A01BAEDFE_184_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7395D0)
#define CLASS_1_5B567C8A01BAEDFE_184_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7395A0)
#define CLASS_1_5B567C8A01BAEDFE_184_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A7392E0)
#define CLASS_1_5B567C8A01BAEDFE_184_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A739340)
#define CLASS_1_5B567C8A01BAEDFE_184_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A739510)
#define CLASS_1_5B567C8A01BAEDFE_184_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A739570)
#define CLASS_1_5B567C8A01BAEDFE_184__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A739620)
#define CLASS_1_5B567C8A01BAEDFE_184__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A739360)
#define CLASS_1_5B567C8A01BAEDFE_184__CTOR_OFFSET UNITYSDK_OFFSET(0x1A739350)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_184_TypeDefinitionIndex = 28540;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_184*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_184_TypeDefinitionIndex)->GetStaticField(0x3EF30);
	}
