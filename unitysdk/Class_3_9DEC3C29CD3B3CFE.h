...
#define CLASS_3_9DEC3C29CD3B3CFE_METHOD_3_ADB2171AF9BBB5C3_OFFSET UNITYSDK_OFFSET(0x1A097AE0)
#define CLASS_3_9DEC3C29CD3B3CFE_METHOD_3_F0479BC8A45C30F8_OFFSET UNITYSDK_OFFSET(0x1A097C10)
#define CLASS_3_9DEC3C29CD3B3CFE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A0974E0)
#define CLASS_3_9DEC3C29CD3B3CFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0974B0)

inline static constexpr unsigned int Class_3_9DEC3C29CD3B3CFE_TypeDefinitionIndex = 55842;
