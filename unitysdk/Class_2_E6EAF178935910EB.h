...
#define CLASS_2_E6EAF178935910EB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1650F590)
#define CLASS_2_E6EAF178935910EB_METHOD_2_3AC94EEB348AAF2D_OFFSET UNITYSDK_OFFSET(0x1650F790)
#define CLASS_2_E6EAF178935910EB_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1650F910)
#define CLASS_2_E6EAF178935910EB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1650F5D0)
#define CLASS_2_E6EAF178935910EB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1650F860)
#define CLASS_2_E6EAF178935910EB_TICK_OFFSET UNITYSDK_OFFSET(0x1650F8B0)
#define CLASS_2_E6EAF178935910EB__CTOR_OFFSET UNITYSDK_OFFSET(0x1650F580)

inline static constexpr unsigned int Class_2_E6EAF178935910EB_TypeDefinitionIndex = 51001;

class Class_2_E6EAF178935910EB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TrainPartyShowEffectResult* Field_2_0; // 0x18
