...
#define CLASS_2_2DF1E390945FEC75_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6C1D70)
#define CLASS_2_2DF1E390945FEC75_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB6C1BA0)
#define CLASS_2_2DF1E390945FEC75_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB6C1D20)
#define CLASS_2_2DF1E390945FEC75_TICK_OFFSET UNITYSDK_OFFSET(0xB6C1DB0)
#define CLASS_2_2DF1E390945FEC75__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C1B90)
...
{
public:
	::RPG::GameCore::PropResetPuzzle* IGHAHBNLIJA; // 0x18
