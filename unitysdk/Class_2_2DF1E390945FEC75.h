...
#define CLASS_2_2DF1E390945FEC75_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12840E00)
#define CLASS_2_2DF1E390945FEC75_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12840D10)
#define CLASS_2_2DF1E390945FEC75_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12840DB0)
#define CLASS_2_2DF1E390945FEC75_TICK_OFFSET UNITYSDK_OFFSET(0x12840E40)
#define CLASS_2_2DF1E390945FEC75__CTOR_OFFSET UNITYSDK_OFFSET(0x12840D00)

inline static constexpr unsigned int Class_2_2DF1E390945FEC75_TypeDefinitionIndex = 53812;

class Class_2_2DF1E390945FEC75 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropResetPuzzle* Field_2_1; // 0x18
