...
#define CLASS_2_C3D280D728AC79D5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA741150)
#define CLASS_2_C3D280D728AC79D5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA741190)
#define CLASS_2_C3D280D728AC79D5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA741400)
#define CLASS_2_C3D280D728AC79D5_TICK_OFFSET UNITYSDK_OFFSET(0xA741450)
#define CLASS_2_C3D280D728AC79D5__CTOR_OFFSET UNITYSDK_OFFSET(0xA741140)

inline static constexpr unsigned int Class_2_C3D280D728AC79D5_TypeDefinitionIndex = 51684;

class Class_2_C3D280D728AC79D5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SaveCharacterState* Field_2_0; // 0x18
