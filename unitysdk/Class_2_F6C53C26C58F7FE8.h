...
#define CLASS_2_F6C53C26C58F7FE8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAF4E1A0)
#define CLASS_2_F6C53C26C58F7FE8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAF4E1E0)
#define CLASS_2_F6C53C26C58F7FE8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAF4E2E0)
#define CLASS_2_F6C53C26C58F7FE8_TICK_OFFSET UNITYSDK_OFFSET(0xAF4E330)
#define CLASS_2_F6C53C26C58F7FE8__CTOR_OFFSET UNITYSDK_OFFSET(0xAF4E190)

inline static constexpr unsigned int Class_2_F6C53C26C58F7FE8_TypeDefinitionIndex = 51535;

class Class_2_F6C53C26C58F7FE8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::MatchThreeCreateLevel* Field_2_1; // 0x20
