...
#define CLASS_2_F6C53C26C58F7FE8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD9E8D90)
#define CLASS_2_F6C53C26C58F7FE8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD9E8DD0)
#define CLASS_2_F6C53C26C58F7FE8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD9E8ED0)
#define CLASS_2_F6C53C26C58F7FE8_TICK_OFFSET UNITYSDK_OFFSET(0xD9E8F20)
#define CLASS_2_F6C53C26C58F7FE8__CTOR_OFFSET UNITYSDK_OFFSET(0xD9E8D80)

inline static constexpr unsigned int Class_2_F6C53C26C58F7FE8_TypeDefinitionIndex = 50866;

class Class_2_F6C53C26C58F7FE8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::MatchThreeCreateLevel* Field_2_0; // 0x20
