...
#define CLASS_1_0A57601A2887BDDF_CLEAR_OFFSET UNITYSDK_OFFSET(0x18C13EC0)
#define CLASS_1_0A57601A2887BDDF__CTOR_OFFSET UNITYSDK_OFFSET(0x18C13F20)

inline static constexpr unsigned int Class_1_0A57601A2887BDDF_TypeDefinitionIndex = 39963;
