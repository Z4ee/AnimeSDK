...
#define STRUCT_2_FA6F1CFCFAC0D4A9_METHOD_2_A0ECBFEA2D1D05B9_OFFSET UNITYSDK_OFFSET(0x997E10)
#define STRUCT_2_FA6F1CFCFAC0D4A9__CTOR_OFFSET UNITYSDK_OFFSET(0x997DB0)

inline static constexpr unsigned int Struct_2_FA6F1CFCFAC0D4A9_TypeDefinitionIndex = 83010;
