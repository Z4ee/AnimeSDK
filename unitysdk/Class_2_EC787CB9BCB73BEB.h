...
#define CLASS_2_EC787CB9BCB73BEB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15EB7A80)
#define CLASS_2_EC787CB9BCB73BEB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15EB7AC0)
#define CLASS_2_EC787CB9BCB73BEB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15EB7EC0)
#define CLASS_2_EC787CB9BCB73BEB_TICK_OFFSET UNITYSDK_OFFSET(0x15EB7F10)
#define CLASS_2_EC787CB9BCB73BEB__CTOR_OFFSET UNITYSDK_OFFSET(0x15EB7A70)

inline static constexpr unsigned int Class_2_EC787CB9BCB73BEB_TypeDefinitionIndex = 53141;

class Class_2_EC787CB9BCB73BEB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::Class_1_D27BF54F25500E5F* Field_2_1; // 0x20
	::RPG::GameCore::StartEffectAim* Field_2_2; // 0x28
