...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD2ASYNC_OFFSET UNITYSDK_OFFSET(0xF75CAA0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD2SYNC_OFFSET UNITYSDK_OFFSET(0xF75CA20)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD3ASYNC_OFFSET UNITYSDK_OFFSET(0xF75CC10)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD3SYNC_OFFSET UNITYSDK_OFFSET(0xF75CB90)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD0MESHASYNC_OFFSET UNITYSDK_OFFSET(0xF75C310)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD0MESHSYNC_OFFSET UNITYSDK_OFFSET(0xF75C290)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD1MESHASYNC_OFFSET UNITYSDK_OFFSET(0xF75C480)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD1MESHSYNC_OFFSET UNITYSDK_OFFSET(0xF75C400)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD2MESHASYNC_OFFSET UNITYSDK_OFFSET(0xF75C5F0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD2MESHSYNC_OFFSET UNITYSDK_OFFSET(0xF75C570)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD3MESHASYNC_OFFSET UNITYSDK_OFFSET(0xF75C760)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD3MESHSYNC_OFFSET UNITYSDK_OFFSET(0xF75C6E0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETMATERIALSASYNC_OFFSET UNITYSDK_OFFSET(0xF75C8C0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETMATERIALSSYNC_OFFSET UNITYSDK_OFFSET(0xF75C840)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETUIMATERIALSSYNC_OFFSET UNITYSDK_OFFSET(0xF75C9A0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0xF75CCF0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__CTOR_OFFSET UNITYSDK_OFFSET(0xF75CDF0)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets_TypeDefinitionIndex = 55889;
