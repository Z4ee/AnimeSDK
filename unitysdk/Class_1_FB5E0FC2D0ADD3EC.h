...
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_0140BBF9DD0138E3_OFFSET UNITYSDK_OFFSET(0x18547170)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_1337274651A1E4E8_OFFSET UNITYSDK_OFFSET(0x18546750)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_19A2A4AB4251AD48_OFFSET UNITYSDK_OFFSET(0x18547280)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_1BB9E3011EADDA6B_OFFSET UNITYSDK_OFFSET(0x18546FA0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_23841F75B879070A_OFFSET UNITYSDK_OFFSET(0x18546C40)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_23C2C928CCAD791F_OFFSET UNITYSDK_OFFSET(0x18546360)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_2D54721BE7779E27_OFFSET UNITYSDK_OFFSET(0x18546D00)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_328A051C6835C28D_OFFSET UNITYSDK_OFFSET(0x18546570)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_529FAC71ABD39274_OFFSET UNITYSDK_OFFSET(0x18547510)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_664222BCF379D634_OFFSET UNITYSDK_OFFSET(0x18545FE0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_69B9BDF88ECD47B5_OFFSET UNITYSDK_OFFSET(0x185473B0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_91C638630F1EEE79_OFFSET UNITYSDK_OFFSET(0x18547480)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_A48996EAFBC0AF59_OFFSET UNITYSDK_OFFSET(0x18546050)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_BF93C93F570E4D30_OFFSET UNITYSDK_OFFSET(0x18547590)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_C363F4FD862A9AC6_OFFSET UNITYSDK_OFFSET(0x18547100)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_D11636C6BF6D79A2_OFFSET UNITYSDK_OFFSET(0x18546E50)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_D423291144A4CA49_OFFSET UNITYSDK_OFFSET(0x185460D0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_DEE90D3447555A55_OFFSET UNITYSDK_OFFSET(0x18546B90)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_DF4E6019F076658F_OFFSET UNITYSDK_OFFSET(0x18546990)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_FD1EFD5A6E481F5B_OFFSET UNITYSDK_OFFSET(0x18547410)
#define CLASS_1_FB5E0FC2D0ADD3EC__CCTOR_OFFSET UNITYSDK_OFFSET(0x185476B0)
#define CLASS_1_FB5E0FC2D0ADD3EC__CTOR_OFFSET UNITYSDK_OFFSET(0x185476A0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0xF350);
	}
	static ::RPG::GameCore::FixPoint* StaticGet_FCBKCMLGIPE()
	{
		return (::RPG::GameCore::FixPoint*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0xF358);
	}
	static ::RPG::MVector3* StaticGet_EMHOCDLFGBN()
	{
		return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0xF360);
	}
	static ::System::Guid* StaticGet_ALCCFEHEOBN()
	{
		return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0xF36C);
	}
