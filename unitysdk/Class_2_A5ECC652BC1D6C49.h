...
#define CLASS_2_A5ECC652BC1D6C49_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1DE4D0)
#define CLASS_2_A5ECC652BC1D6C49_METHOD_2_DBE533A3E57F4B9C_OFFSET UNITYSDK_OFFSET(0xC1DE1E0)
#define CLASS_2_A5ECC652BC1D6C49_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC1DE060)
#define CLASS_2_A5ECC652BC1D6C49_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC1DE440)
#define CLASS_2_A5ECC652BC1D6C49_TICK_OFFSET UNITYSDK_OFFSET(0xC1DE550)
#define CLASS_2_A5ECC652BC1D6C49__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DE050)

inline static constexpr unsigned int Class_2_A5ECC652BC1D6C49_TypeDefinitionIndex = 54417;

class Class_2_A5ECC652BC1D6C49 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyShowSwitchFromSpeTransition* Field_2_0; // 0x18
