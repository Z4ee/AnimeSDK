...
#define CLASS_2_3698CD7A7AFEFDC4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1953A6A0)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_53993E7C2839A69A_OFFSET UNITYSDK_OFFSET(0x1953A6E0)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_7E3A7035A8240838_OFFSET UNITYSDK_OFFSET(0x1953A820)
#define CLASS_2_3698CD7A7AFEFDC4_TICK_OFFSET UNITYSDK_OFFSET(0x1953A950)
#define CLASS_2_3698CD7A7AFEFDC4__CTOR_OFFSET UNITYSDK_OFFSET(0x1953ABC0)

inline static constexpr unsigned int Class_2_3698CD7A7AFEFDC4_TypeDefinitionIndex = 57597;

class Class_2_3698CD7A7AFEFDC4 : public ::RPG::GameCore::GameComponentBase
{
public:
	::Class_0_16E4307DCC419505_614* NMDGJILDMLO; // 0x18
