...
#define CLASS_2_3698CD7A7AFEFDC4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18439C20)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_53993E7C2839A69A_OFFSET UNITYSDK_OFFSET(0x18439C60)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_7E3A7035A8240838_OFFSET UNITYSDK_OFFSET(0x18439DA0)
#define CLASS_2_3698CD7A7AFEFDC4_TICK_OFFSET UNITYSDK_OFFSET(0x18439ED0)
#define CLASS_2_3698CD7A7AFEFDC4__CTOR_OFFSET UNITYSDK_OFFSET(0x1843A140)

inline static constexpr unsigned int Class_2_3698CD7A7AFEFDC4_TypeDefinitionIndex = 54873;

class Class_2_3698CD7A7AFEFDC4 : public ::RPG::GameCore::GameComponentBase
{
public:
	::Class_0_16E4307DCC419505_579* Field_2_0; // 0x18
