...
#define CLASS_2_3698CD7A7AFEFDC4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC454840)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_53993E7C2839A69A_OFFSET UNITYSDK_OFFSET(0xC454880)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_7E3A7035A8240838_OFFSET UNITYSDK_OFFSET(0xC4549C0)
#define CLASS_2_3698CD7A7AFEFDC4_TICK_OFFSET UNITYSDK_OFFSET(0xC454AF0)
#define CLASS_2_3698CD7A7AFEFDC4__CTOR_OFFSET UNITYSDK_OFFSET(0xC454CA0)
#define CLASS_2_3698CD7A7AFEFDC4___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xC454CB0)

inline static constexpr unsigned int Class_2_3698CD7A7AFEFDC4_TypeDefinitionIndex = 53654;

class Class_2_3698CD7A7AFEFDC4 : public ::RPG::GameCore::GameComponentBase
{
public:
	::Class_0_16E4307DCC419505_544* Field_2_0; // 0x18
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_2_3698CD7A7AFEFDC4___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
	}
};
