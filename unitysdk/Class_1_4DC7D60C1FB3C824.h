...
#define CLASS_1_4DC7D60C1FB3C824_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11586F50)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_0A888ADA55827819_OFFSET UNITYSDK_OFFSET(0x11588C20)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_178EA063585DE2C4_OFFSET UNITYSDK_OFFSET(0x11588B00)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_1E6CA4B463058047_OFFSET UNITYSDK_OFFSET(0x11587870)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_208CCBFF1B8F62A7_1_OFFSET UNITYSDK_OFFSET(0x115889C0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_208CCBFF1B8F62A7_OFFSET UNITYSDK_OFFSET(0x11587F70)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_27F287B1045999E8_OFFSET UNITYSDK_OFFSET(0x11588380)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_3E8C7E78003D17FB_OFFSET UNITYSDK_OFFSET(0x11588C80)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x115874B0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_4ACC2F8684BE1D57_OFFSET UNITYSDK_OFFSET(0x115885D0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x11588050)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_4DB14E9CF0E552EE_OFFSET UNITYSDK_OFFSET(0x115877C0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_5ADC654B7B75957A_OFFSET UNITYSDK_OFFSET(0x11587F90)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_5E256ABCBB78EAD2_OFFSET UNITYSDK_OFFSET(0x11586FF0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x11588480)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_8E64D6357918B560_OFFSET UNITYSDK_OFFSET(0x11587E20)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_9035FEE44752EB8E_OFFSET UNITYSDK_OFFSET(0x11588EE0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_90A476C0D1BA2FC9_1_OFFSET UNITYSDK_OFFSET(0x11588100)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_90A476C0D1BA2FC9_OFFSET UNITYSDK_OFFSET(0x11587980)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_9D88E5402AD63A48_OFFSET UNITYSDK_OFFSET(0x115886E0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_9E14C8E365DFCB60_OFFSET UNITYSDK_OFFSET(0x115887C0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x11588530)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_AAE44609DDD73F41_OFFSET UNITYSDK_OFFSET(0x115870A0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_ACC7C04D05A7D67E_OFFSET UNITYSDK_OFFSET(0x11587A60)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_DBBF8A9CF80D2D00_OFFSET UNITYSDK_OFFSET(0x11588290)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_DF64B90BA25AAE64_OFFSET UNITYSDK_OFFSET(0x11588F00)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_F26109FDE858206E_OFFSET UNITYSDK_OFFSET(0x11587CA0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_F75C0E617E8805AE_OFFSET UNITYSDK_OFFSET(0x115889E0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_F78C032061CEA1F7_1_OFFSET UNITYSDK_OFFSET(0x115882E0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_F78C032061CEA1F7_OFFSET UNITYSDK_OFFSET(0x115881F0)
#define CLASS_1_4DC7D60C1FB3C824_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x11587440)
#define CLASS_1_4DC7D60C1FB3C824__CTOR_1_OFFSET UNITYSDK_OFFSET(0x11586DF0)
#define CLASS_1_4DC7D60C1FB3C824__CTOR_OFFSET UNITYSDK_OFFSET(0x11586C50)

inline static constexpr unsigned int Class_1_4DC7D60C1FB3C824_TypeDefinitionIndex = 80578;
