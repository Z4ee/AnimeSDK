...
#define CLASS_1_CE2AC6C9C34CBBD2_GET_ASSETFLAGS_OFFSET UNITYSDK_OFFSET(0x17B1F140)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x17B1F1C0)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_BUNDLESHORTNAMEHASH_OFFSET UNITYSDK_OFFSET(0x17B1F1A0)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_BUNDLESHORTNAME_OFFSET UNITYSDK_OFFSET(0x17B1F180)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_FILESIZE_OFFSET UNITYSDK_OFFSET(0x17B1F120)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x17B1F160)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x17B1F100)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x17B1F300)
#define CLASS_1_CE2AC6C9C34CBBD2_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x17B1F0E0)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_2C4CACFCB85F415D_OFFSET UNITYSDK_OFFSET(0x17B1F1E0)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_7CC2462FD595A34A_OFFSET UNITYSDK_OFFSET(0x17B1F4A0)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_7ED10847788F63EA_OFFSET UNITYSDK_OFFSET(0x17B21210)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_8395AB7342C6B852_OFFSET UNITYSDK_OFFSET(0x17B20270)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_A90C6EB1D97C6DA9_OFFSET UNITYSDK_OFFSET(0x17B1F320)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x17B1F2C0)
#define CLASS_1_CE2AC6C9C34CBBD2_METHOD_1_F123041D2BCE0542_OFFSET UNITYSDK_OFFSET(0x17B209B0)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_ASSETFLAGS_OFFSET UNITYSDK_OFFSET(0x17B1F150)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x17B1F1D0)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_BUNDLESHORTNAMEHASH_OFFSET UNITYSDK_OFFSET(0x17B1F1B0)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_BUNDLESHORTNAME_OFFSET UNITYSDK_OFFSET(0x17B1F190)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_FILESIZE_OFFSET UNITYSDK_OFFSET(0x17B1F130)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x17B1F170)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x17B1F110)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x17B1F310)
#define CLASS_1_CE2AC6C9C34CBBD2_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x17B1F0F0)
#define CLASS_1_CE2AC6C9C34CBBD2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B213A0)
#define CLASS_1_CE2AC6C9C34CBBD2__CTOR_OFFSET UNITYSDK_OFFSET(0x17B201E0)
#define CLASS_1_CE2AC6C9C34CBBD2___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B21A10)
...
public:
	...
	::System::Boolean _IsValid_k__BackingField; // 0x58
	::RPG::Client::AssetsStaticFlag _AssetFlags_k__BackingField; // 0x5A
