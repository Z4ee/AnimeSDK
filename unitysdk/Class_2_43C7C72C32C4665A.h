...
#define CLASS_2_43C7C72C32C4665A_SETUPDATA_OFFSET UNITYSDK_OFFSET(0x1A4437E0)
#define CLASS_2_43C7C72C32C4665A__CTOR_OFFSET UNITYSDK_OFFSET(0x1A443F90)

inline static constexpr unsigned int Class_2_43C7C72C32C4665A_TypeDefinitionIndex = 64294;
