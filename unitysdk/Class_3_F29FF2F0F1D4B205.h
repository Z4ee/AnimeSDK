...
#define CLASS_3_F29FF2F0F1D4B205_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x14EDF5A0)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x14EE04C0)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_3D42A0AC2602D380_OFFSET UNITYSDK_OFFSET(0x14EE0590)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_49964A8388055B4B_OFFSET UNITYSDK_OFFSET(0x14EDF780)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_4F6948586D063855_OFFSET UNITYSDK_OFFSET(0x14EE0D50)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x14EDF6F0)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_DAD497A719A5A6B7_OFFSET UNITYSDK_OFFSET(0x14EE01F0)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_DC8A7A631720DCED_OFFSET UNITYSDK_OFFSET(0x14EDF9F0)
#define CLASS_3_F29FF2F0F1D4B205_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x14EDF310)
#define CLASS_3_F29FF2F0F1D4B205__CCTOR_OFFSET UNITYSDK_OFFSET(0x14EDF5F0)
#define CLASS_3_F29FF2F0F1D4B205__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDF680)

inline static constexpr unsigned int Class_3_F29FF2F0F1D4B205_TypeDefinitionIndex = 70995;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_3_F29FF2F0F1D4B205_TypeDefinitionIndex)->GetStaticField(0x11840);
	}
	// static const ::System::Int32 Field_3_12 = 0x1B; // 0x0
	::Il2CppArray<::RootMotion::FinalIK::LegIK*>* Field_3_11; // 0x48
	::System::Action* Field_3_9; // 0x50
	::Il2CppArray<::System::Boolean>* Field_3_0; // 0x58
	::System::Action* Field_3_10; // 0x60
	::System::Collections::Generic::List_1<::System::Boolean>* Field_3_8; // 0x68
	::RootMotion::FinalIK::Grounder_GrounderDelegate* Field_3_14; // 0x70
	::MoleMole::TgsPvLegIkController* Field_3_5; // 0x78
	::RootMotion::SolverManager_PostLateUpdateDelegate* Field_3_13; // 0x80
	::RootMotion::FinalIK::GrounderIK* Field_3_4; // 0x88
