...
#define CLASS_3_F29FF2F0F1D4B205_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x16800990)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x16802000)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_3D42A0AC2602D380_OFFSET UNITYSDK_OFFSET(0x16801580)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_49964A8388055B4B_OFFSET UNITYSDK_OFFSET(0x168020D0)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_4F6948586D063855_OFFSET UNITYSDK_OFFSET(0x168013B0)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x16801320)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_DAD497A719A5A6B7_OFFSET UNITYSDK_OFFSET(0x16801D30)
#define CLASS_3_F29FF2F0F1D4B205_METHOD_3_DC8A7A631720DCED_OFFSET UNITYSDK_OFFSET(0x16800AE0)
#define CLASS_3_F29FF2F0F1D4B205_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x168006F0)
#define CLASS_3_F29FF2F0F1D4B205__CCTOR_OFFSET UNITYSDK_OFFSET(0x168009E0)
#define CLASS_3_F29FF2F0F1D4B205__CTOR_OFFSET UNITYSDK_OFFSET(0x16800A70)

inline static constexpr unsigned int Class_3_F29FF2F0F1D4B205_TypeDefinitionIndex = 40444;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_3_F29FF2F0F1D4B205_TypeDefinitionIndex)->GetStaticField(0x118D0);
	}
	// static const ::System::Int32 Field_3_12 = 0x1B; // 0x0
	::System::Collections::Generic::List_1<::System::Boolean>* Field_3_8; // 0x48
	::RootMotion::SolverManager_PostLateUpdateDelegate* Field_3_11; // 0x50
	::Il2CppArray<::RootMotion::FinalIK::LegIK*>* Field_3_5; // 0x58
	::System::Action* Field_3_6; // 0x60
	::RootMotion::FinalIK::Grounder_GrounderDelegate* Field_3_10; // 0x68
	::Il2CppArray<::System::Boolean>* Field_3_0; // 0x70
	::RootMotion::FinalIK::GrounderIK* Field_3_4; // 0x78
	::System::Action* Field_3_7; // 0x80
	::MoleMole::TgsPvLegIkController* Field_3_3; // 0x88
