...
#define CLASS_2_2E094C8C40E7D957_AFTERCREATERESOURCES_OFFSET UNITYSDK_OFFSET(0x17914A10)
#define CLASS_2_2E094C8C40E7D957_AFTEREXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x17914CB0)
#define CLASS_2_2E094C8C40E7D957_BEFOREEXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x17914B60)
#define CLASS_2_2E094C8C40E7D957_RESETSIMULATIONSTATE_OFFSET UNITYSDK_OFFSET(0x17914830)
#define CLASS_2_2E094C8C40E7D957__CTOR_OFFSET UNITYSDK_OFFSET(0x17914E00)

inline static constexpr unsigned int Class_2_2E094C8C40E7D957_TypeDefinitionIndex = 73582;
