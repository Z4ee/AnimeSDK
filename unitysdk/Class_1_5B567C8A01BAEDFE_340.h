...
#define CLASS_1_5B567C8A01BAEDFE_340_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x193C0680)
#define CLASS_1_5B567C8A01BAEDFE_340_CLONE_OFFSET UNITYSDK_OFFSET(0x193C04F0)
#define CLASS_1_5B567C8A01BAEDFE_340_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x193C0590)
#define CLASS_1_5B567C8A01BAEDFE_340_EQUALS_OFFSET UNITYSDK_OFFSET(0x193C0530)
#define CLASS_1_5B567C8A01BAEDFE_340_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x193C05E0)
#define CLASS_1_5B567C8A01BAEDFE_340_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x193C06D0)
#define CLASS_1_5B567C8A01BAEDFE_340_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x193C06A0)
#define CLASS_1_5B567C8A01BAEDFE_340_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x193C0470)
#define CLASS_1_5B567C8A01BAEDFE_340_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x193C04A0)
#define CLASS_1_5B567C8A01BAEDFE_340_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193C0610)
#define CLASS_1_5B567C8A01BAEDFE_340_WRITETO_OFFSET UNITYSDK_OFFSET(0x193C0670)
#define CLASS_1_5B567C8A01BAEDFE_340__CCTOR_OFFSET UNITYSDK_OFFSET(0x193C0720)
#define CLASS_1_5B567C8A01BAEDFE_340__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193C04C0)
#define CLASS_1_5B567C8A01BAEDFE_340__CTOR_OFFSET UNITYSDK_OFFSET(0x193C04B0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_340_TypeDefinitionIndex = 32266;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_340*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_340_TypeDefinitionIndex)->GetStaticField(0x3D2D0);
	}
