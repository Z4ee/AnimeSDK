...
#define CLASS_1_5B567C8A01BAEDFE_340_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AAA9A40)
#define CLASS_1_5B567C8A01BAEDFE_340_CLONE_OFFSET UNITYSDK_OFFSET(0x1AAA98B0)
#define CLASS_1_5B567C8A01BAEDFE_340_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AAA9950)
#define CLASS_1_5B567C8A01BAEDFE_340_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AAA98F0)
#define CLASS_1_5B567C8A01BAEDFE_340_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AAA99A0)
#define CLASS_1_5B567C8A01BAEDFE_340_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AAA9A90)
#define CLASS_1_5B567C8A01BAEDFE_340_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AAA9A60)
#define CLASS_1_5B567C8A01BAEDFE_340_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AAA9830)
#define CLASS_1_5B567C8A01BAEDFE_340_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AAA9860)
#define CLASS_1_5B567C8A01BAEDFE_340_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AAA99D0)
#define CLASS_1_5B567C8A01BAEDFE_340_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AAA9A30)
#define CLASS_1_5B567C8A01BAEDFE_340__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AAA9AE0)
#define CLASS_1_5B567C8A01BAEDFE_340__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAA9880)
#define CLASS_1_5B567C8A01BAEDFE_340__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA9870)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_340_TypeDefinitionIndex = 31965;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_340*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_340_TypeDefinitionIndex)->GetStaticField(0xD460);
	}
