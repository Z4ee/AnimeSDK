...
#define CLASS_2_CA1F4A5B1A684DEF_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x153D6710)
#define CLASS_2_CA1F4A5B1A684DEF_METHOD_2_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0x153D65D0)
#define CLASS_2_CA1F4A5B1A684DEF_METHOD_2_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x153D6830)
#define CLASS_2_CA1F4A5B1A684DEF__CTOR_OFFSET UNITYSDK_OFFSET(0x153D6470)

inline static constexpr unsigned int Class_2_CA1F4A5B1A684DEF_TypeDefinitionIndex = 64476;

class Class_2_CA1F4A5B1A684DEF : public ::Class_1_43BD383C98B4C0C5_33
{
public:
	// static const ::System::String* Field_2_4; // 0x0
	::Class_2_A2C95BEE51D13F24* Field_2_2; // 0x10
	::Class_2_D09F9E57BC6350B3_1* Field_2_1; // 0x18
	::MoleMole::UISummerMissionTipsWidgetController* Field_2_0; // 0x20
