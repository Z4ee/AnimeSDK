...
#define CLASS_1_FBCD4FF549575A07_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1929CC40)
#define CLASS_1_FBCD4FF549575A07_CLONE_OFFSET UNITYSDK_OFFSET(0x1929C550)
#define CLASS_1_FBCD4FF549575A07_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1929C650)
#define CLASS_1_FBCD4FF549575A07_EQUALS_OFFSET UNITYSDK_OFFSET(0x1929C620)
#define CLASS_1_FBCD4FF549575A07_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1929C800)
#define CLASS_1_FBCD4FF549575A07_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1929CFB0)
#define CLASS_1_FBCD4FF549575A07_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1929CDD0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_24748FC20F375725_1_OFFSET UNITYSDK_OFFSET(0x1929C5A0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_24748FC20F375725_2_OFFSET UNITYSDK_OFFSET(0x1929C5D0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_24748FC20F375725_3_OFFSET UNITYSDK_OFFSET(0x1929C600)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1929C580)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1929C5F0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1929C5C0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1929C1E0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x1929C5B0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_8C8625211DA811AE_2_OFFSET UNITYSDK_OFFSET(0x1929C5E0)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_8C8625211DA811AE_3_OFFSET UNITYSDK_OFFSET(0x1929C610)
#define CLASS_1_FBCD4FF549575A07_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1929C590)
#define CLASS_1_FBCD4FF549575A07_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1929C210)
#define CLASS_1_FBCD4FF549575A07_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1929CA70)
#define CLASS_1_FBCD4FF549575A07_WRITETO_OFFSET UNITYSDK_OFFSET(0x1929CAD0)
#define CLASS_1_FBCD4FF549575A07__CCTOR_OFFSET UNITYSDK_OFFSET(0x1929D200)
#define CLASS_1_FBCD4FF549575A07__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1929C2B0)
#define CLASS_1_FBCD4FF549575A07__CTOR_OFFSET UNITYSDK_OFFSET(0x1929C220)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FBCD4FF549575A07_TypeDefinitionIndex)->GetStaticField(0x53AC0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_FBCD4FF549575A07*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_FBCD4FF549575A07*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FBCD4FF549575A07_TypeDefinitionIndex)->GetStaticField(0x53AC8);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_12()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FBCD4FF549575A07_TypeDefinitionIndex)->GetStaticField(0x53AD0);
	}
	...
	::Class_1_075C34D03AFA1215_23* Field_1_10; // 0x20
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* Field_1_13; // 0x28
	::Class_1_49E6D1DAFF77A936* Field_1_15; // 0x30
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* Field_1_8; // 0x38
	::Class_1_00BAB2C33D444F88_6* Field_1_3; // 0x40
