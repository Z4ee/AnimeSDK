...
#define CLASS_1_5B567C8A01BAEDFE_28_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x192C5D50)
#define CLASS_1_5B567C8A01BAEDFE_28_CLONE_OFFSET UNITYSDK_OFFSET(0x192C5B60)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x192C5C60)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_OFFSET UNITYSDK_OFFSET(0x192C5BD0)
#define CLASS_1_5B567C8A01BAEDFE_28_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192C5CB0)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x192C5DA0)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x192C5D70)
#define CLASS_1_5B567C8A01BAEDFE_28_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x192C5AB0)
#define CLASS_1_5B567C8A01BAEDFE_28_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x192C5B10)
#define CLASS_1_5B567C8A01BAEDFE_28_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192C5CE0)
#define CLASS_1_5B567C8A01BAEDFE_28_WRITETO_OFFSET UNITYSDK_OFFSET(0x192C5D40)
#define CLASS_1_5B567C8A01BAEDFE_28__CCTOR_OFFSET UNITYSDK_OFFSET(0x192C5DF0)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192C5B30)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_OFFSET UNITYSDK_OFFSET(0x192C5B20)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_28_TypeDefinitionIndex = 25091;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_28*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_28_TypeDefinitionIndex)->GetStaticField(0x56B10);
	}
