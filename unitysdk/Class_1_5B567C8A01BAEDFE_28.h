...
#define CLASS_1_5B567C8A01BAEDFE_28_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0767A0)
#define CLASS_1_5B567C8A01BAEDFE_28_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0765B0)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0766B0)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A076620)
#define CLASS_1_5B567C8A01BAEDFE_28_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A076700)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0767F0)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0767C0)
#define CLASS_1_5B567C8A01BAEDFE_28_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A076500)
#define CLASS_1_5B567C8A01BAEDFE_28_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A076560)
#define CLASS_1_5B567C8A01BAEDFE_28_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A076730)
#define CLASS_1_5B567C8A01BAEDFE_28_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A076790)
#define CLASS_1_5B567C8A01BAEDFE_28__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A076840)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A076580)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_OFFSET UNITYSDK_OFFSET(0x1A076570)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_28_TypeDefinitionIndex = 24954;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_28*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_28_TypeDefinitionIndex)->GetStaticField(0x339A0);
	}
