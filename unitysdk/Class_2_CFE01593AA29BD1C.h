...
#define CLASS_2_CFE01593AA29BD1C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159659B0)
#define CLASS_2_CFE01593AA29BD1C_METHOD_2_D3314DFA55F6676E_OFFSET UNITYSDK_OFFSET(0x15965B00)
#define CLASS_2_CFE01593AA29BD1C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x159656C0)
#define CLASS_2_CFE01593AA29BD1C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15965960)
#define CLASS_2_CFE01593AA29BD1C_TICK_OFFSET UNITYSDK_OFFSET(0x159658B0)
#define CLASS_2_CFE01593AA29BD1C__CTOR_OFFSET UNITYSDK_OFFSET(0x159656B0)
...
{
public:
	::RPG::GameCore::HipplenGameWaitEvent* OFKGLJOAMLD; // 0x18
	::RPG::Client::ActivityHipplen::ActivityHipplenMiniGameManager* CDPFMOHMFPO; // 0x20
	::Class_2_CFE01593AA29BD1C_Class_1_22046C69D06B0F53* OOEABHBKAKC; // 0x28
	::Class_1_F3391C70DC37088D* HEAGLNNMMNJ; // 0x30
