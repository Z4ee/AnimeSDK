...
#define IRI_TRACKCUSTOMDATA_METHOD_6_A2846FC5EA0763C6_OFFSET UNITYSDK_OFFSET(0x14240610)
#define IRI_TRACKCUSTOMDATA_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x14240590)
#define IRI_TRACKCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14240550)
#define IRI_TRACKCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14240630)

inline static constexpr unsigned int IRI_TrackCustomData_TypeDefinitionIndex = 44523;
