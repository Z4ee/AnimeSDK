...
#define PACKAGENAMERECORD_METHOD_5_B8FAD8726C647FA2_OFFSET UNITYSDK_OFFSET(0xB06A570)
#define PACKAGENAMERECORD_METHOD_5_BBE2D28D8A6AFB06_OFFSET UNITYSDK_OFFSET(0xB06A4E0)
#define PACKAGENAMERECORD_WRITEANDUPLOADBRANCHDATA_OFFSET UNITYSDK_OFFSET(0xB069F00)
#define PACKAGENAMERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xB06A610)
