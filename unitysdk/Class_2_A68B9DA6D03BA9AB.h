...
#define CLASS_2_A68B9DA6D03BA9AB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1435B350)
#define CLASS_2_A68B9DA6D03BA9AB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1435B390)
#define CLASS_2_A68B9DA6D03BA9AB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1435B6B0)
#define CLASS_2_A68B9DA6D03BA9AB_TICK_OFFSET UNITYSDK_OFFSET(0x1435B740)
#define CLASS_2_A68B9DA6D03BA9AB__CTOR_OFFSET UNITYSDK_OFFSET(0x1435B340)

inline static constexpr unsigned int Class_2_A68B9DA6D03BA9AB_TypeDefinitionIndex = 54112;

class Class_2_A68B9DA6D03BA9AB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::AdventureMonsterTriggerMove* Field_2_1; // 0x20
