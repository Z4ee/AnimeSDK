...
#define CLASS_2_A68B9DA6D03BA9AB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9ED7A50)
#define CLASS_2_A68B9DA6D03BA9AB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9ED7A90)
#define CLASS_2_A68B9DA6D03BA9AB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9ED7D90)
#define CLASS_2_A68B9DA6D03BA9AB_TICK_OFFSET UNITYSDK_OFFSET(0x9ED7E20)
#define CLASS_2_A68B9DA6D03BA9AB__CTOR_OFFSET UNITYSDK_OFFSET(0x9ED7A40)

inline static constexpr unsigned int Class_2_A68B9DA6D03BA9AB_TypeDefinitionIndex = 46690;

class Class_2_A68B9DA6D03BA9AB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdventureMonsterTriggerMove* Field_2_0; // 0x18
