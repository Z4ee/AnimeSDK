...
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1BAB4070)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETPREBAKEDURATION_OFFSET UNITYSDK_OFFSET(0x1BAB4080)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1BAB3FB0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1BAB40A0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_HASVIBRATOR_OFFSET UNITYSDK_OFFSET(0x1BAB4060)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BAB3FA0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_ISRICHTAPEFFECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1BAB4040)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1BAB3FF0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_PLAY_OFFSET UNITYSDK_OFFSET(0x1BAB4000)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_QUIT_OFFSET UNITYSDK_OFFSET(0x1BAB4030)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1BAB4090)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_STOP_OFFSET UNITYSDK_OFFSET(0x1BAB4020)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x1BAB4010)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAB4190)

namespace RichTap::Platforms::Mobile
{
	inline static constexpr unsigned int AndroidSDKBridge_TypeDefinitionIndex = 36488;
	...
	public:
		...
		{
			return (::RichTap::Platforms::Mobile::AndroidSDKBridge**)Il2CppClass::FromTypeDefinitionIndex(AndroidSDKBridge_TypeDefinitionIndex)->GetStaticField(0x271B0);
		}
