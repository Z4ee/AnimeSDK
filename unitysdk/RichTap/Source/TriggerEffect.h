...
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDFEEDBACKMODE_OFFSET UNITYSDK_OFFSET(0x1F22F250)
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDVIBRATIONMODE_OFFSET UNITYSDK_OFFSET(0x1F22F1E0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDWEAPONMODE_OFFSET UNITYSDK_OFFSET(0x1F22F2A0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1F22F1B0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1F22F1A0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1F22F1C0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1F22F180)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1F22F170)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1F22F190)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1F22F1D0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1F22F300)
#define RICHTAP_SOURCE_TRIGGEREFFECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F22F3C0)
#define RICHTAP_SOURCE_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F22F240)

namespace RichTap::Source
{
	inline static constexpr unsigned int TriggerEffect_TypeDefinitionIndex = 38752;
