...
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1F22CE40)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1F22CE30)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1F22CE50)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1F22CE10)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1F22CE00)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1F22CE20)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1F22CE60)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1F22CE70)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F22CF30)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F22D760)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int TriggerEffectComponent_TypeDefinitionIndex = 38754;
