...
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1BAB57C0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1BAB57B0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1BAB57D0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1BAB5790)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1BAB5780)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1BAB57A0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1BAB57E0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1BAB57F0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BAB58B0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAB60E0)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int TriggerEffectComponent_TypeDefinitionIndex = 36485;
