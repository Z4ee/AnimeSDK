...
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1DE18FC0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1DE18FA0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1DE19000)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1DE18FD0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1DE18FE0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x1DE18FF0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1DE18FB0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETUID_OFFSET UNITYSDK_OFFSET(0x1DE18F60)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1DE19160)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1DE19450)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_STOP_OFFSET UNITYSDK_OFFSET(0x1DE193A0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE19620)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int RichtapClipEffectComponent_TypeDefinitionIndex = 38092;
