...
#define RICHTAP_SOURCE_EFFECTCONST_AMPLITUDECHECK_OFFSET UNITYSDK_OFFSET(0x1BAB4C50)
#define RICHTAP_SOURCE_EFFECTCONST_FREQUENCYCHECK_OFFSET UNITYSDK_OFFSET(0x1BAB4C60)
#define RICHTAP_SOURCE_EFFECTCONST_LOOPCOUNTCHECK_OFFSET UNITYSDK_OFFSET(0x1BAB6140)
#define RICHTAP_SOURCE_EFFECTCONST_LOOPINTERVALCHECK_OFFSET UNITYSDK_OFFSET(0x1BAB4C80)
#define RICHTAP_SOURCE_EFFECTCONST_TRIGGERSETTINGCHECK_OFFSET UNITYSDK_OFFSET(0x1BAB6150)

namespace RichTap::Source
{
	inline static constexpr unsigned int EffectConst_TypeDefinitionIndex = 36478;
