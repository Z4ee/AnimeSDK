...
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BAB1110)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAB11B0)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAB1210)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BAB11C0)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BAB1100)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAB0F10)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataModel__PlayCoroutine_d__24_TypeDefinitionIndex = 36496;

	class HapticDataModel__PlayCoroutine_d__24 : public ::System::Object
	{
	public:
		::RichTap::Common::HapticDataModel* __4__this; // 0x10
