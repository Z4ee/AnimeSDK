...
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DE15030)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DE150D0)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DE15130)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DE150E0)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DE15020)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE14E30)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataModel__PlayCoroutine_d__24_TypeDefinitionIndex = 38104;
