...
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAAECC0)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAAED50)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAAE980)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAAE970)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerConnectionListener_TypeDefinitionIndex = 36499;
