...
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F2263B0)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F226440)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F226090)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F226070)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerConnectionListener_TypeDefinitionIndex = 38768;
