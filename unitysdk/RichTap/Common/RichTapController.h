...
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1F22A740)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLEALTERNATIVEASSETS_OFFSET UNITYSDK_OFFSET(0x1F229E40)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLESHOWPLAYINGHEDIALOG_OFFSET UNITYSDK_OFFSET(0x1F22A010)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1F22A520)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1F22A3C0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1F228AE0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1F229DB0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETPLUGINVERSION_OFFSET UNITYSDK_OFFSET(0x1F228A40)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1F22A840)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETRICHTAPENABLE_OFFSET UNITYSDK_OFFSET(0x1F228A90)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1F228A00)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ISRICHTAPSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1F228AA0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1F2291E0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x1F228B00)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_REGISTERCONTROLLERCONNECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1F2288E0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F228970)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1F2295C0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1F229410)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1F228AC0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETINTLEVEL_OFFSET UNITYSDK_OFFSET(0x1F2295A0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETRICHTAPENABLE_OFFSET UNITYSDK_OFFSET(0x1F228A80)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETTARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1F22A620)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0x1F229910)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_UNINIT_OFFSET UNITYSDK_OFFSET(0x1F228A20)
#define RICHTAP_COMMON_RICHTAPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F22AA60)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapController_TypeDefinitionIndex = 38770;
