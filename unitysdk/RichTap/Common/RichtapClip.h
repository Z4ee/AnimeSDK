...
#define RICHTAP_COMMON_RICHTAPCLIP_GETCLIPNAME_OFFSET UNITYSDK_OFFSET(0x1F22B650)
#define RICHTAP_COMMON_RICHTAPCLIP_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1F22B640)
#define RICHTAP_COMMON_RICHTAPCLIP_LOAD_OFFSET UNITYSDK_OFFSET(0x1F22B610)
#define RICHTAP_COMMON_RICHTAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F22B590)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichtapClip_TypeDefinitionIndex = 38767;
