...
#define RICHTAP_COMMON_RICHTAPCLIP_GETCLIPNAME_OFFSET UNITYSDK_OFFSET(0x1DE17EB0)
#define RICHTAP_COMMON_RICHTAPCLIP_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1DE17EA0)
#define RICHTAP_COMMON_RICHTAPCLIP_LOAD_OFFSET UNITYSDK_OFFSET(0x1DE17E70)
#define RICHTAP_COMMON_RICHTAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE17DF0)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichtapClip_TypeDefinitionIndex = 38106;
