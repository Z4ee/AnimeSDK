...
#define RICHTAP_COMMON_HAPTICDATAMANAGER_ADDTOREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F227250)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_ADDTOVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F227730)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_CLEARPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F227920)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_DECIDEREALPLAYBACK_OFFSET UNITYSDK_OFFSET(0x1F226820)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_GETREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F226E80)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_GETVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F226F80)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_REMOVEFROMREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F227150)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_REMOVEFROMVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1F227830)
#define RICHTAP_COMMON_HAPTICDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F227C50)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataManager_TypeDefinitionIndex = 38761;
	...
	public:
		...
		::System::Object* realPlayLock; // 0x18
		::System::Object* virtualLock; // 0x20
		::System::Collections::Generic::List_1<::RichTap::Common::HapticDataModel*>* virtualPlayList; // 0x28
