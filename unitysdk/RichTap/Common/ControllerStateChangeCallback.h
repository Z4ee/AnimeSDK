...
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F226780)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F226810)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F226470)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F226450)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerStateChangeCallback_TypeDefinitionIndex = 38769;
