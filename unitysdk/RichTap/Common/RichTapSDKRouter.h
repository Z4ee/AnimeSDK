...
#define RICHTAP_COMMON_RICHTAPSDKROUTER_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1BAB30F0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BAB2ED0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1BAB2DA0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1BAB1430)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1BAB1AA0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETPREBAKEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1BAB1D30)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1BAB31F0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETRICHTAPSDKVERSION_OFFSET UNITYSDK_OFFSET(0x1BAB3750)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_INIT_OFFSET UNITYSDK_OFFSET(0x1BAB1350)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_ISRICHTAPSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1BAB13F0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1BAB0A50)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_PLAY_OFFSET UNITYSDK_OFFSET(0x1BAB0980)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_REGISTERCONTROLLERCONNECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1BAB3270)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BAB3300)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1BAB2230)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1BAB1EC0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1BAB1410)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETTARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1BAB2FE0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_STOP_OFFSET UNITYSDK_OFFSET(0x1BAB1020)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_UNINIT_OFFSET UNITYSDK_OFFSET(0x1BAB1370)
#define RICHTAP_COMMON_RICHTAPSDKROUTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAB3EC0)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapSDKRouter_TypeDefinitionIndex = 36497;
