...
#define RICHTAP_COMMON_RICHTAPSDKROUTER_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1DE17010)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1DE16DF0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1DE16CC0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1DE15350)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1DE159C0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETPREBAKEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1DE15C50)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1DE17110)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETRICHTAPSDKVERSION_OFFSET UNITYSDK_OFFSET(0x1DE17670)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_INIT_OFFSET UNITYSDK_OFFSET(0x1DE15270)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_ISRICHTAPSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1DE15310)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1DE14970)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_PLAY_OFFSET UNITYSDK_OFFSET(0x1DE148A0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_REGISTERCONTROLLERCONNECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1DE17190)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1DE17220)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1DE16150)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1DE15DE0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1DE15330)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETTARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1DE16F00)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_STOP_OFFSET UNITYSDK_OFFSET(0x1DE14F40)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_UNINIT_OFFSET UNITYSDK_OFFSET(0x1DE15290)
#define RICHTAP_COMMON_RICHTAPSDKROUTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE17DE0)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapSDKRouter_TypeDefinitionIndex = 38105;
