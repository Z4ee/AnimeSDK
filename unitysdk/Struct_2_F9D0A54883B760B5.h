...
#define STRUCT_2_F9D0A54883B760B5_GET_AGGRO_OFFSET UNITYSDK_OFFSET(0x25E90)
#define STRUCT_2_F9D0A54883B760B5_GET_HPBASE_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define STRUCT_2_F9D0A54883B760B5_GET_HPINHERIT_OFFSET UNITYSDK_OFFSET(0x6020)
#define STRUCT_2_F9D0A54883B760B5_GET_HPSKILL_OFFSET UNITYSDK_OFFSET(0x6E30)
#define STRUCT_2_F9D0A54883B760B5_GET_SPEEDBASE_OFFSET UNITYSDK_OFFSET(0x2CFE0)
#define STRUCT_2_F9D0A54883B760B5_GET_SPEEDINHERIT_OFFSET UNITYSDK_OFFSET(0x112A0)
#define STRUCT_2_F9D0A54883B760B5_GET_SPEEDSKILL_OFFSET UNITYSDK_OFFSET(0x112B0)
#define STRUCT_2_F9D0A54883B760B5_SET_AGGRO_OFFSET UNITYSDK_OFFSET(0x2E750)
#define STRUCT_2_F9D0A54883B760B5_SET_HPBASE_OFFSET UNITYSDK_OFFSET(0xC610)
#define STRUCT_2_F9D0A54883B760B5_SET_HPINHERIT_OFFSET UNITYSDK_OFFSET(0x9500)
#define STRUCT_2_F9D0A54883B760B5_SET_HPSKILL_OFFSET UNITYSDK_OFFSET(0x2AA0)
#define STRUCT_2_F9D0A54883B760B5_SET_SPEEDBASE_OFFSET UNITYSDK_OFFSET(0x2CFF0)
#define STRUCT_2_F9D0A54883B760B5_SET_SPEEDINHERIT_OFFSET UNITYSDK_OFFSET(0xBBC0)
#define STRUCT_2_F9D0A54883B760B5_SET_SPEEDSKILL_OFFSET UNITYSDK_OFFSET(0xC250)
