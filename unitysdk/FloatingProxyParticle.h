...
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_1_OFFSET UNITYSDK_OFFSET(0x17C80D90)
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_OFFSET UNITYSDK_OFFSET(0x17C819A0)
#define FLOATINGPROXYPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3975460)

inline static constexpr unsigned int FloatingProxyParticle_TypeDefinitionIndex = 45700;
