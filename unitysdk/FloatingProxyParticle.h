...
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_1_OFFSET UNITYSDK_OFFSET(0x15616330)
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_OFFSET UNITYSDK_OFFSET(0x15616F70)
#define FLOATINGPROXYPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2DEAAC0)

inline static constexpr unsigned int FloatingProxyParticle_TypeDefinitionIndex = 47951;
