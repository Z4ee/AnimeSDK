...
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_1_OFFSET UNITYSDK_OFFSET(0x13830660)
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_OFFSET UNITYSDK_OFFSET(0x138312A0)
#define FLOATINGPROXYPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2BBFB00)

inline static constexpr unsigned int FloatingProxyParticle_TypeDefinitionIndex = 44783;
