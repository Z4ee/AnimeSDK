...
#define CLASS_1_643E8C5145F2D973_CLEAR_OFFSET UNITYSDK_OFFSET(0xBC456A0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_021D359A6B27D7E9_OFFSET UNITYSDK_OFFSET(0xBC45740)
#define CLASS_1_643E8C5145F2D973_METHOD_1_14458B78C43EB27B_OFFSET UNITYSDK_OFFSET(0xBC455F0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_224CE5D244AB2F7C_OFFSET UNITYSDK_OFFSET(0xBC458A0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_2266060C1EDA6636_OFFSET UNITYSDK_OFFSET(0xBC45AE0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_36E47868EF373D40_OFFSET UNITYSDK_OFFSET(0xBC457C0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_9FF25618E0E9BEC3_OFFSET UNITYSDK_OFFSET(0xBC45B90)
#define CLASS_1_643E8C5145F2D973_METHOD_1_AD51F82E38D39A74_OFFSET UNITYSDK_OFFSET(0xBC45970)
#define CLASS_1_643E8C5145F2D973_METHOD_1_B2B45A0FDF809296_OFFSET UNITYSDK_OFFSET(0xBC45830)
#define CLASS_1_643E8C5145F2D973_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBC45580)
#define CLASS_1_643E8C5145F2D973__CCTOR_OFFSET UNITYSDK_OFFSET(0xBC45FD0)
#define CLASS_1_643E8C5145F2D973__CTOR_OFFSET UNITYSDK_OFFSET(0xBC45FC0)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_643E8C5145F2D973_TypeDefinitionIndex)->GetStaticField(0x5BD30);
	}
	::RPG::Client::MonoEmoPlayableGraph* CEODOONOFBM; // 0x10
	::UnityEngine::Vector2 EMJMDGFPPBG; // 0x18
	::UnityEngine::Vector2 MDOCBCLPNIH; // 0x20
	::UnityEngine::Vector2 OHLIBFDCIKO; // 0x28
	::System::Boolean BLPDPHFBBIJ; // 0x30
	::System::Boolean OELBLBCINNB; // 0x31
	::System::Boolean FOBGFIPLPDN; // 0x32
	::System::Boolean DGPHEEPHEFD; // 0x33
	::UnityEngine::Vector2 GNEDDHJDNMK; // 0x34
