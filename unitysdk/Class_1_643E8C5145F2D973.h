...
#define CLASS_1_643E8C5145F2D973_CLEAR_OFFSET UNITYSDK_OFFSET(0x15CBE3B0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_021D359A6B27D7E9_OFFSET UNITYSDK_OFFSET(0x15CBE450)
#define CLASS_1_643E8C5145F2D973_METHOD_1_14458B78C43EB27B_OFFSET UNITYSDK_OFFSET(0x15CBE300)
#define CLASS_1_643E8C5145F2D973_METHOD_1_224CE5D244AB2F7C_OFFSET UNITYSDK_OFFSET(0x15CBE5B0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_2266060C1EDA6636_OFFSET UNITYSDK_OFFSET(0x15CBE7F0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_36E47868EF373D40_OFFSET UNITYSDK_OFFSET(0x15CBE4D0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_9FF25618E0E9BEC3_OFFSET UNITYSDK_OFFSET(0x15CBE8A0)
#define CLASS_1_643E8C5145F2D973_METHOD_1_AD51F82E38D39A74_OFFSET UNITYSDK_OFFSET(0x15CBE680)
#define CLASS_1_643E8C5145F2D973_METHOD_1_B2B45A0FDF809296_OFFSET UNITYSDK_OFFSET(0x15CBE540)
#define CLASS_1_643E8C5145F2D973_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15CBE290)
#define CLASS_1_643E8C5145F2D973__CCTOR_OFFSET UNITYSDK_OFFSET(0x15CBED30)
#define CLASS_1_643E8C5145F2D973__CTOR_OFFSET UNITYSDK_OFFSET(0x15CBED20)

inline static constexpr unsigned int Class_1_643E8C5145F2D973_TypeDefinitionIndex = 68261;

class Class_1_643E8C5145F2D973 : public ::System::Object
{
public:
	static ::System::Collections::Generic::List_1<::UnityEngine::Vector3>** StaticGet_LAFHHEBDELI()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_643E8C5145F2D973_TypeDefinitionIndex)->GetStaticField(0x57BC0);
	}
	::RPG::Client::MonoEmoPlayableGraph* CEODOONOFBM; // 0x10
	::UnityEngine::Vector2 GNEDDHJDNMK; // 0x18
	::UnityEngine::Vector2 MDOCBCLPNIH; // 0x20
	::UnityEngine::Vector2 EMJMDGFPPBG; // 0x28
	::UnityEngine::Vector2 OHLIBFDCIKO; // 0x30
	::System::Boolean BLPDPHFBBIJ; // 0x38
	::System::Boolean OELBLBCINNB; // 0x39
	::System::Boolean DGPHEEPHEFD; // 0x3A
	::System::Boolean FOBGFIPLPDN; // 0x3B
