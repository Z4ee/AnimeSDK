...
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_2434B5A8F8358CF4_OFFSET UNITYSDK_OFFSET(0x1CB5E490)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_45E1DD4C3004BE8D_OFFSET UNITYSDK_OFFSET(0x1CB5C8C0)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_46DC1B7A23E8F63B_OFFSET UNITYSDK_OFFSET(0x1CB5D520)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_5B6891ACE8F7E909_OFFSET UNITYSDK_OFFSET(0x1CB5E3F0)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_7D02D663A9812A42_OFFSET UNITYSDK_OFFSET(0x1CB5C7D0)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_7D201B4343E63821_OFFSET UNITYSDK_OFFSET(0x1CB5CB50)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_8D94830F96A2A934_OFFSET UNITYSDK_OFFSET(0x1CB5C5B0)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_BB097BD2A2DFBFFA_OFFSET UNITYSDK_OFFSET(0x1CB5C310)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_C2F366E4DDF9B195_OFFSET UNITYSDK_OFFSET(0x1CB5CB60)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_C3AFFA7F66B1CB2D_OFFSET UNITYSDK_OFFSET(0x1CB5DB10)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x1CB5C520)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_D7D0CD092E7E5457_OFFSET UNITYSDK_OFFSET(0x1CB5E340)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_DAC74854F8E730C9_OFFSET UNITYSDK_OFFSET(0x1CB5CC80)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_E11C87AB2E6DB49B_OFFSET UNITYSDK_OFFSET(0x1CB5D080)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_E6F43BC16622B0E6_OFFSET UNITYSDK_OFFSET(0x1CB5CBA0)
#define CLASS_1_AEB41C92C66E4F8C_METHOD_1_F57C23A8ACA862D2_OFFSET UNITYSDK_OFFSET(0x1CB5E560)
#define CLASS_1_AEB41C92C66E4F8C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB5E660)
#define CLASS_1_AEB41C92C66E4F8C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CB5C290)
#define CLASS_1_AEB41C92C66E4F8C__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB5C1A0)

inline static constexpr unsigned int Class_1_AEB41C92C66E4F8C_TypeDefinitionIndex = 10839;

class Class_1_AEB41C92C66E4F8C : public ::System::Object
{
public:
	static ::System::Collections::Concurrent::ConcurrentBag_1<::Class_1_AEB41C92C66E4F8C*>** StaticGet_BEHHICMOFIE()
	{
		return (::System::Collections::Concurrent::ConcurrentBag_1<::Class_1_AEB41C92C66E4F8C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AEB41C92C66E4F8C_TypeDefinitionIndex)->GetStaticField(0x33170);
	}
	::System::String* GEPFFDDHPAI; // 0x10
	::System::Text::StringBuilder* NBGGLAANOJH; // 0x18
	::System::Int32 CPKEFMBLLNC; // 0x20
