...
#define CLASS_1_075C34D03AFA1215_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DCF7460)
#define CLASS_1_075C34D03AFA1215_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1DCF6FE0)
#define CLASS_1_075C34D03AFA1215_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DCF7160)
#define CLASS_1_075C34D03AFA1215_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DCF7040)
#define CLASS_1_075C34D03AFA1215_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DCF7250)
#define CLASS_1_075C34D03AFA1215_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DCF7550)
#define CLASS_1_075C34D03AFA1215_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DCF7500)
#define CLASS_1_075C34D03AFA1215_5_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DCF6E90)
#define CLASS_1_075C34D03AFA1215_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1DCF7030)
#define CLASS_1_075C34D03AFA1215_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DCF6EF0)
#define CLASS_1_075C34D03AFA1215_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DCF7350)
#define CLASS_1_075C34D03AFA1215_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DCF73B0)
#define CLASS_1_075C34D03AFA1215_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DCF7720)
#define CLASS_1_075C34D03AFA1215_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DCF6F50)
#define CLASS_1_075C34D03AFA1215_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCF6F00)

inline static constexpr unsigned int Class_1_075C34D03AFA1215_5_TypeDefinitionIndex = 24898;

class Class_1_075C34D03AFA1215_5 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_075C34D03AFA1215_5*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_075C34D03AFA1215_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_075C34D03AFA1215_5_TypeDefinitionIndex)->GetStaticField(0x5CA40);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_JPAEBNKOHFA()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_075C34D03AFA1215_5_TypeDefinitionIndex)->GetStaticField(0x5CA48);
	}
