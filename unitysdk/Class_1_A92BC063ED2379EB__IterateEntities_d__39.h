...
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x13A5F920)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_LITTLEGAME_CHIMERADUELGAMEENTITY__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x13A5FB70)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_LITTLEGAME_CHIMERADUELGAMEENTITY__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x13A5FB00)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x13A5FBF0)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x13A5FB60)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x13A5FB10)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13A5F900)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x13A5F170)
#define CLASS_1_A92BC063ED2379EB__ITERATEENTITIES_D__39___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x13A5F910)

inline static constexpr unsigned int Class_1_A92BC063ED2379EB__IterateEntities_d__39_TypeDefinitionIndex = 71950;

class Class_1_A92BC063ED2379EB__IterateEntities_d__39 : public ::System::Object
{
public:
	::Entitas::IMatcher_1<::Class_2_B66C1067C0468FBB*>* __3__matcher; // 0x10
	::Class_2_B66C1067C0468FBB* __2__current; // 0x18
	::System::Collections::Generic::HashSet_1_Enumerator<::Class_2_B66C1067C0468FBB*> __7__wrap1; // 0x20
	::Entitas::IMatcher_1<::Class_2_B66C1067C0468FBB*>* matcher; // 0x38
	::Class_1_A92BC063ED2379EB* __4__this; // 0x40
