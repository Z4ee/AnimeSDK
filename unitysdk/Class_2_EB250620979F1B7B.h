...
#define CLASS_2_EB250620979F1B7B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1412EAA0)
#define CLASS_2_EB250620979F1B7B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1412F1D0)
#define CLASS_2_EB250620979F1B7B_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1412EDD0)
#define CLASS_2_EB250620979F1B7B_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1412F1E0)
#define CLASS_2_EB250620979F1B7B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1412EAE0)
#define CLASS_2_EB250620979F1B7B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1412EE20)
#define CLASS_2_EB250620979F1B7B_TICK_OFFSET UNITYSDK_OFFSET(0x1412EE80)
#define CLASS_2_EB250620979F1B7B__CTOR_OFFSET UNITYSDK_OFFSET(0x1412EA80)

inline static constexpr unsigned int Class_2_EB250620979F1B7B_TypeDefinitionIndex = 52735;
