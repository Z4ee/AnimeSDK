...
#define CLASS_2_EB250620979F1B7B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16046F50)
#define CLASS_2_EB250620979F1B7B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x16047690)
#define CLASS_2_EB250620979F1B7B_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16047280)
#define CLASS_2_EB250620979F1B7B_ONSKIP_OFFSET UNITYSDK_OFFSET(0x160476A0)
#define CLASS_2_EB250620979F1B7B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16046F90)
#define CLASS_2_EB250620979F1B7B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x160472D0)
#define CLASS_2_EB250620979F1B7B_TICK_OFFSET UNITYSDK_OFFSET(0x16047330)
#define CLASS_2_EB250620979F1B7B__CTOR_OFFSET UNITYSDK_OFFSET(0x16046F30)
...
public:
	...
	::RPG::GameCore::WaitTimelineFinish* OFKGLJOAMLD; // 0x20
