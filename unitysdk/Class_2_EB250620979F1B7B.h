...
#define CLASS_2_EB250620979F1B7B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12526CD0)
#define CLASS_2_EB250620979F1B7B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x12527410)
#define CLASS_2_EB250620979F1B7B_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12527000)
#define CLASS_2_EB250620979F1B7B_ONSKIP_OFFSET UNITYSDK_OFFSET(0x12527420)
#define CLASS_2_EB250620979F1B7B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12526D10)
#define CLASS_2_EB250620979F1B7B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12527050)
#define CLASS_2_EB250620979F1B7B_TICK_OFFSET UNITYSDK_OFFSET(0x125270B0)
#define CLASS_2_EB250620979F1B7B__CTOR_OFFSET UNITYSDK_OFFSET(0x12526CB0)

inline static constexpr unsigned int Class_2_EB250620979F1B7B_TypeDefinitionIndex = 52061;

class Class_2_EB250620979F1B7B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::WaitTimelineFinish* Field_2_0; // 0x18
	::Class_1_36264895A759B0FF* Field_2_2; // 0x20
