...
#define CLASS_1_5B567C8A01BAEDFE_364_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EAF6140)
#define CLASS_1_5B567C8A01BAEDFE_364_CLONE_OFFSET UNITYSDK_OFFSET(0x1EAF5E30)
#define CLASS_1_5B567C8A01BAEDFE_364_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EAF5F40)
#define CLASS_1_5B567C8A01BAEDFE_364_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EAF5E70)
#define CLASS_1_5B567C8A01BAEDFE_364_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EAF60A0)
#define CLASS_1_5B567C8A01BAEDFE_364_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EAF6190)
#define CLASS_1_5B567C8A01BAEDFE_364_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EAF6160)
#define CLASS_1_5B567C8A01BAEDFE_364_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EAF5DB0)
#define CLASS_1_5B567C8A01BAEDFE_364_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EAF5DE0)
#define CLASS_1_5B567C8A01BAEDFE_364_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EAF60D0)
#define CLASS_1_5B567C8A01BAEDFE_364_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EAF6130)
#define CLASS_1_5B567C8A01BAEDFE_364__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EAF61E0)
#define CLASS_1_5B567C8A01BAEDFE_364__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EAF5E00)
#define CLASS_1_5B567C8A01BAEDFE_364__CTOR_OFFSET UNITYSDK_OFFSET(0x1EAF5DF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_364_TypeDefinitionIndex = 34076;

class Class_1_5B567C8A01BAEDFE_364 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_364*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_364*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_364_TypeDefinitionIndex)->GetStaticField(0x12890);
	}
