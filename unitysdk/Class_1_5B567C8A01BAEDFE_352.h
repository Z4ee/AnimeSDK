...
#define CLASS_1_5B567C8A01BAEDFE_352_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A412DE0)
#define CLASS_1_5B567C8A01BAEDFE_352_CLONE_OFFSET UNITYSDK_OFFSET(0x1A412C50)
#define CLASS_1_5B567C8A01BAEDFE_352_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A412CF0)
#define CLASS_1_5B567C8A01BAEDFE_352_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A412C90)
#define CLASS_1_5B567C8A01BAEDFE_352_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A412D40)
#define CLASS_1_5B567C8A01BAEDFE_352_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A412E30)
#define CLASS_1_5B567C8A01BAEDFE_352_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A412E00)
#define CLASS_1_5B567C8A01BAEDFE_352_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A412BD0)
#define CLASS_1_5B567C8A01BAEDFE_352_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A412C00)
#define CLASS_1_5B567C8A01BAEDFE_352_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A412D70)
#define CLASS_1_5B567C8A01BAEDFE_352_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A412DD0)
#define CLASS_1_5B567C8A01BAEDFE_352__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A412E80)
#define CLASS_1_5B567C8A01BAEDFE_352__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A412C20)
#define CLASS_1_5B567C8A01BAEDFE_352__CTOR_OFFSET UNITYSDK_OFFSET(0x1A412C10)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_352_TypeDefinitionIndex = 32342;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_352*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_352_TypeDefinitionIndex)->GetStaticField(0x63D10);
	}
