...
#define CLASS_1_1005B9479049BC5A_METHOD_1_17781C67C46C8E05_OFFSET UNITYSDK_OFFSET(0x18154290)
#define CLASS_1_1005B9479049BC5A_METHOD_1_3249389B928082B9_OFFSET UNITYSDK_OFFSET(0x181544C0)
#define CLASS_1_1005B9479049BC5A_METHOD_1_80C66335F1B7C73D_OFFSET UNITYSDK_OFFSET(0x18154270)
#define CLASS_1_1005B9479049BC5A__CTOR_OFFSET UNITYSDK_OFFSET(0x18153ED0)

inline static constexpr unsigned int Class_1_1005B9479049BC5A_TypeDefinitionIndex = 55927;

class Class_1_1005B9479049BC5A : public ::System::Object
{
public:
	::Class_2_208CC9941471731A_624* Field_1_6; // 0x10
	::Class_2_208CC9941471731A_640* Field_1_7; // 0x18
	::Enum_3_63CAB6C405C6C7B1_1 Field_1_0; // 0x20

	::System::Void _ctor(::Class_2_208CC9941471731A_640* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_640*))((::PBYTE)hIl2Cpp + CLASS_1_1005B9479049BC5A__CTOR_OFFSET))(this, a1);
	}
