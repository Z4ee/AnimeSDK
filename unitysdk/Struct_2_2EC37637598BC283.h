...
#define STRUCT_2_2EC37637598BC283_DISPOSE_OFFSET UNITYSDK_OFFSET(0x161C9C0)
#define STRUCT_2_2EC37637598BC283_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x161C920)
#define STRUCT_2_2EC37637598BC283_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x161CA00)
#define STRUCT_2_2EC37637598BC283_RESET_OFFSET UNITYSDK_OFFSET(0x161CA80)
#define STRUCT_2_2EC37637598BC283_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x161C970)
#define STRUCT_2_2EC37637598BC283__CTOR_OFFSET UNITYSDK_OFFSET(0x161C8A0)

inline static constexpr unsigned int Struct_2_2EC37637598BC283_TypeDefinitionIndex = 69121;
