...
#define CLASS_2_CDD3C39CC21668D3_METHOD_2_E443625AAFA6531A_OFFSET UNITYSDK_OFFSET(0x1A7B4EA0)
#define CLASS_2_CDD3C39CC21668D3_METHOD_2_F17676F976AEF1D8_OFFSET UNITYSDK_OFFSET(0x1A7B5000)
#define CLASS_2_CDD3C39CC21668D3_METHOD_2_F1E1DC61D1C45DDA_OFFSET UNITYSDK_OFFSET(0x1A7B4E30)
#define CLASS_2_CDD3C39CC21668D3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7B5250)
#define CLASS_2_CDD3C39CC21668D3__ONBIND_OFFSET UNITYSDK_OFFSET(0x1A7B4AC0)

inline static constexpr unsigned int Class_2_CDD3C39CC21668D3_TypeDefinitionIndex = 72062;

class Class_2_CDD3C39CC21668D3 : public ::Class_1_34917908B7833130
{
public:
	::Class_2_CDD3C39CC21668D3_Class_2_562902FDFF3F5056* NCODOADGHHG; // 0x60
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ElationPointChangePopUIStyle, ::Class_2_CDD3C39CC21668D3_Class_2_562902FDFF3F5056*>* JNLOPNECCDP; // 0x68
