...
#define CLASS_1_2899B0E942F4D2BC_METHOD_1_11EE4A1CDB86715F_OFFSET UNITYSDK_OFFSET(0x178706D0)
#define CLASS_1_2899B0E942F4D2BC_METHOD_1_7813B04986E9626D_OFFSET UNITYSDK_OFFSET(0x178709B0)
#define CLASS_1_2899B0E942F4D2BC_METHOD_1_7889E856344009E9_OFFSET UNITYSDK_OFFSET(0x17870940)
#define CLASS_1_2899B0E942F4D2BC_METHOD_1_8695FFE2881491AB_OFFSET UNITYSDK_OFFSET(0x17870A40)
#define CLASS_1_2899B0E942F4D2BC_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x17870A00)
#define CLASS_1_2899B0E942F4D2BC_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17870690)
#define CLASS_1_2899B0E942F4D2BC__CTOR_OFFSET UNITYSDK_OFFSET(0x17870600)

inline static constexpr unsigned int Class_1_2899B0E942F4D2BC_TypeDefinitionIndex = 45218;

class Class_1_2899B0E942F4D2BC : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_055C5EAE0A9ABD4D*>* Field_1_1; // 0x10
	::Class_5_AF65C3A968E836D2* Field_1_0; // 0x18

	::System::Void _ctor(::Class_5_AF65C3A968E836D2* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_5_AF65C3A968E836D2*))((::PBYTE)hIl2Cpp + CLASS_1_2899B0E942F4D2BC__CTOR_OFFSET))(this, a1);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_1_2899B0E942F4D2BC_METHOD_1_11EE4A1CDB86715F_OFFSET))(this, a1, a2);
	}
