...
#define CLASS_2_2956BAF0F97343C0_GET_AGILITYLEVEL_OFFSET UNITYSDK_OFFSET(0x18512C40)
#define CLASS_2_2956BAF0F97343C0_GET_ENDURANCELEVEL_OFFSET UNITYSDK_OFFSET(0x18512C20)
#define CLASS_2_2956BAF0F97343C0_GET_INVISIBLE_OFFSET UNITYSDK_OFFSET(0x18512970)
#define CLASS_2_2956BAF0F97343C0_GET_LUCKLEVEL_OFFSET UNITYSDK_OFFSET(0x18512C80)
#define CLASS_2_2956BAF0F97343C0_GET_MANALEVEL_OFFSET UNITYSDK_OFFSET(0x18512C60)
#define CLASS_2_2956BAF0F97343C0_GET_STRENGTHLEVEL_OFFSET UNITYSDK_OFFSET(0x18512C00)
#define CLASS_2_2956BAF0F97343C0_GET_UNKNOWN_OFFSET UNITYSDK_OFFSET(0x18512910)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x18512CA0)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_7D201B4343E63821_OFFSET UNITYSDK_OFFSET(0x18512E90)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_8F059A365E90744C_OFFSET UNITYSDK_OFFSET(0x18512EA0)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_A0FB0B00BE3FDFFC_OFFSET UNITYSDK_OFFSET(0x18512AE0)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_A7957CDB95DAF72B_OFFSET UNITYSDK_OFFSET(0x18512D20)
#define CLASS_2_2956BAF0F97343C0_SET_AGILITYLEVEL_OFFSET UNITYSDK_OFFSET(0x18512C50)
#define CLASS_2_2956BAF0F97343C0_SET_ENDURANCELEVEL_OFFSET UNITYSDK_OFFSET(0x18512C30)
#define CLASS_2_2956BAF0F97343C0_SET_LUCKLEVEL_OFFSET UNITYSDK_OFFSET(0x18512C90)
#define CLASS_2_2956BAF0F97343C0_SET_MANALEVEL_OFFSET UNITYSDK_OFFSET(0x18512C70)
#define CLASS_2_2956BAF0F97343C0_SET_STRENGTHLEVEL_OFFSET UNITYSDK_OFFSET(0x18512C10)
#define CLASS_2_2956BAF0F97343C0__CCTOR_OFFSET UNITYSDK_OFFSET(0x18512FE0)
#define CLASS_2_2956BAF0F97343C0__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18512A40)
#define CLASS_2_2956BAF0F97343C0__CTOR_OFFSET UNITYSDK_OFFSET(0x185129D0)

inline static constexpr unsigned int Class_2_2956BAF0F97343C0_TypeDefinitionIndex = 79451;
...
public:
	...
	{
		return (::Class_2_2956BAF0F97343C0**)Il2CppClass::FromTypeDefinitionIndex(Class_2_2956BAF0F97343C0_TypeDefinitionIndex)->GetStaticField(0x1EB90);
	}
	static ::Class_2_2956BAF0F97343C0** StaticGet__Invisible_k__BackingField()
	{
		return (::Class_2_2956BAF0F97343C0**)Il2CppClass::FromTypeDefinitionIndex(Class_2_2956BAF0F97343C0_TypeDefinitionIndex)->GetStaticField(0x1EB98);
	}
	// static const ::System::String* CFDJLOAJIBI; // 0x0
	::System::String* ECNBBDHAEFO; // 0x20
	::System::String* _LuckLevel_k__BackingField; // 0x28
	::System::String* _AgilityLevel_k__BackingField; // 0x30
	::System::String* _EnduranceLevel_k__BackingField; // 0x38
	::System::String* _StrengthLevel_k__BackingField; // 0x40
