...
#define CLASS_2_2956BAF0F97343C0_GET_AGILITYLEVEL_OFFSET UNITYSDK_OFFSET(0xC41B2B0)
#define CLASS_2_2956BAF0F97343C0_GET_ENDURANCELEVEL_OFFSET UNITYSDK_OFFSET(0xC41B290)
#define CLASS_2_2956BAF0F97343C0_GET_INVISIBLE_OFFSET UNITYSDK_OFFSET(0xC41B000)
#define CLASS_2_2956BAF0F97343C0_GET_LUCKLEVEL_OFFSET UNITYSDK_OFFSET(0xC41B2F0)
#define CLASS_2_2956BAF0F97343C0_GET_MANALEVEL_OFFSET UNITYSDK_OFFSET(0xC41B2D0)
#define CLASS_2_2956BAF0F97343C0_GET_STRENGTHLEVEL_OFFSET UNITYSDK_OFFSET(0xC41B270)
#define CLASS_2_2956BAF0F97343C0_GET_UNKNOWN_OFFSET UNITYSDK_OFFSET(0xC41AFA0)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xC41B310)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_7D201B4343E63821_OFFSET UNITYSDK_OFFSET(0xC41B500)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_8F059A365E90744C_OFFSET UNITYSDK_OFFSET(0xC41B510)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_A0FB0B00BE3FDFFC_OFFSET UNITYSDK_OFFSET(0xC41B160)
#define CLASS_2_2956BAF0F97343C0_METHOD_2_A7957CDB95DAF72B_OFFSET UNITYSDK_OFFSET(0xC41B390)
#define CLASS_2_2956BAF0F97343C0_SET_AGILITYLEVEL_OFFSET UNITYSDK_OFFSET(0xC41B2C0)
#define CLASS_2_2956BAF0F97343C0_SET_ENDURANCELEVEL_OFFSET UNITYSDK_OFFSET(0xC41B2A0)
#define CLASS_2_2956BAF0F97343C0_SET_LUCKLEVEL_OFFSET UNITYSDK_OFFSET(0xC41B300)
#define CLASS_2_2956BAF0F97343C0_SET_MANALEVEL_OFFSET UNITYSDK_OFFSET(0xC41B2E0)
#define CLASS_2_2956BAF0F97343C0_SET_STRENGTHLEVEL_OFFSET UNITYSDK_OFFSET(0xC41B280)
#define CLASS_2_2956BAF0F97343C0__CCTOR_OFFSET UNITYSDK_OFFSET(0xC41B650)
#define CLASS_2_2956BAF0F97343C0__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC41B0D0)
#define CLASS_2_2956BAF0F97343C0__CTOR_OFFSET UNITYSDK_OFFSET(0xC41B060)

inline static constexpr unsigned int Class_2_2956BAF0F97343C0_TypeDefinitionIndex = 79452;
...
public:
	...
	{
		return (::Class_2_2956BAF0F97343C0**)Il2CppClass::FromTypeDefinitionIndex(Class_2_2956BAF0F97343C0_TypeDefinitionIndex)->GetStaticField(0x1B6F0);
	}
	static ::Class_2_2956BAF0F97343C0** StaticGet__Invisible_k__BackingField()
	{
		return (::Class_2_2956BAF0F97343C0**)Il2CppClass::FromTypeDefinitionIndex(Class_2_2956BAF0F97343C0_TypeDefinitionIndex)->GetStaticField(0x1B6F8);
	}
	// static const ::System::String* CFDJLOAJIBI; // 0x0
	::System::String* _LuckLevel_k__BackingField; // 0x20
	::System::String* ECNBBDHAEFO; // 0x28
	::System::String* _AgilityLevel_k__BackingField; // 0x30
	::System::String* _ManaLevel_k__BackingField; // 0x38
	::System::String* _EnduranceLevel_k__BackingField; // 0x40
