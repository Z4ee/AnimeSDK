...
#define CLASS_2_F4A08C9C0F5EB4C6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CC6920)
#define CLASS_2_F4A08C9C0F5EB4C6_METHOD_2_2C5008384F244597_OFFSET UNITYSDK_OFFSET(0x19CC6BE0)
#define CLASS_2_F4A08C9C0F5EB4C6_METHOD_2_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0x19CC6B90)
#define CLASS_2_F4A08C9C0F5EB4C6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19CC6A50)
#define CLASS_2_F4A08C9C0F5EB4C6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19CC6970)
#define CLASS_2_F4A08C9C0F5EB4C6_TICK_OFFSET UNITYSDK_OFFSET(0x19CC6B30)
#define CLASS_2_F4A08C9C0F5EB4C6__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC68C0)
...
public:
	...
	::System::Action_1<::RPG::GameCore::GameEntity*>* MNGIAJPCOCG; // 0x20
	::RPG::GameCore::GameEntity* POPNDPJELNO; // 0x28
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x30
	::RPG::GameCore::WaitEntityArtLoad* OFKGLJOAMLD; // 0x38
