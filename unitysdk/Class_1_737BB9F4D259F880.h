...
#define CLASS_1_737BB9F4D259F880__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAB7E90)
...
public:
	...
	::System::UInt32 IAKDNNCLGAN; // 0x18
	::System::Boolean MAEJNJNNOCI; // 0x1C
	::System::Boolean PAKNNEFOEON; // 0x1D
	::RPG::Client::LittleGame::ChimeraDuelGameState MEPFOEEGBEA; // 0x20
