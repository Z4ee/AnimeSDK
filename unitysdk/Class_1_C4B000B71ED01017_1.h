...
#define CLASS_1_C4B000B71ED01017_1_CLEAR_OFFSET UNITYSDK_OFFSET(0x17E6FE90)
#define CLASS_1_C4B000B71ED01017_1_GET_ISPROPAGATEATTACK_OFFSET UNITYSDK_OFFSET(0x17E6FE70)
#define CLASS_1_C4B000B71ED01017_1_GET_LOCKDAMAGEZERO_OFFSET UNITYSDK_OFFSET(0x17E6FE50)
#define CLASS_1_C4B000B71ED01017_1_SET_ISPROPAGATEATTACK_OFFSET UNITYSDK_OFFSET(0x17E6FE80)
#define CLASS_1_C4B000B71ED01017_1_SET_LOCKDAMAGEZERO_OFFSET UNITYSDK_OFFSET(0x17E6FE60)
#define CLASS_1_C4B000B71ED01017_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17E6FF10)
...
public:
	...
	::System::Boolean GNIKNANDLNH; // 0x30
	::System::Boolean _IsPropagateAttack_k__BackingField; // 0x31
	::System::Boolean KFHFGGIGAKK; // 0x32
	::System::Boolean LBAFIMAMNPL; // 0x33
	::System::Boolean _LockDamageZero_k__BackingField; // 0x34
	::System::Boolean BPKFCCGIEPH; // 0x35
	::RPG::GameCore::FixPoint GBCIHEMICFM; // 0x38
