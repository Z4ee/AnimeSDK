...
#define CLASS_2_1A26C5D5D346F951_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xDD97020)
#define CLASS_2_1A26C5D5D346F951_METHOD_2_31910FB02E3010D4_OFFSET UNITYSDK_OFFSET(0xDD96CF0)
#define CLASS_2_1A26C5D5D346F951_METHOD_2_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0xDD96C90)
#define CLASS_2_1A26C5D5D346F951_METHOD_2_BF961C009AF7A1E2_OFFSET UNITYSDK_OFFSET(0xDD96BD0)
#define CLASS_2_1A26C5D5D346F951_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xDD96FA0)
#define CLASS_2_1A26C5D5D346F951_METHOD_2_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0xDD970C0)
#define CLASS_2_1A26C5D5D346F951_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xDD97080)
#define CLASS_2_1A26C5D5D346F951__CTOR_OFFSET UNITYSDK_OFFSET(0xDD96C70)

inline static constexpr unsigned int Class_2_1A26C5D5D346F951_TypeDefinitionIndex = 75247;

class Class_2_1A26C5D5D346F951 : public ::Class_1_8303B8E58A593199
{
public:
	::RPG::GameCore::HipplenIncidentLevelGraphStepConfig* IGHAHBNLIJA; // 0x30
	::RPG::GameCore::EntityManager* LPILDKDAGDP; // 0x38
	::RPG::GameCore::LevelGraphComponent* LJCPCPJJEIB; // 0x40
