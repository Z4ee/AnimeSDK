...
#define CLASS_1_DA26F2BB73BDCDDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DA3B0)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::ChenLingBattleAnimEventConfig*>* PIELBNECIIN; // 0x10
	::UnityEngine::Animator* CKDKOONONCG; // 0x18
	::System::String* OIBKPJEGPOK; // 0x20
	::Class_1_43BD383C98B4C0C5_41* CAHCLIMGPFF; // 0x28
