...
#define MONOVOPATHPARTICLE_APPLYMATERIALOVERRIDE_OFFSET UNITYSDK_OFFSET(0x109C2B10)
#define MONOVOPATHPARTICLE_APPLYMOBILEPLATFORMOVERRIDEMATERIALS_OFFSET UNITYSDK_OFFSET(0x109C57D0)
#define MONOVOPATHPARTICLE_APPLYOVERRIDEMATERIALS_OFFSET UNITYSDK_OFFSET(0x109C5360)
#define MONOVOPATHPARTICLE_CALCULATECATMULLROMCURVE_OFFSET UNITYSDK_OFFSET(0x109C2CD0)
#define MONOVOPATHPARTICLE_CALCULATECATMULLROMPOINT_OFFSET UNITYSDK_OFFSET(0x109C4430)
#define MONOVOPATHPARTICLE_CALCULATECURVELENGTH_OFFSET UNITYSDK_OFFSET(0x109C46D0)
#define MONOVOPATHPARTICLE_CLEANSEGMENTPOINTS_OFFSET UNITYSDK_OFFSET(0x109C59F0)
#define MONOVOPATHPARTICLE_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x109C4B20)
#define MONOVOPATHPARTICLE_DELTAPOSITION_OFFSET UNITYSDK_OFFSET(0x109C49E0)
#define MONOVOPATHPARTICLE_DRAWMULTIPLEPASS_OFFSET UNITYSDK_OFFSET(0x109C2BA0)
#define MONOVOPATHPARTICLE_FADEOUT_OFFSET UNITYSDK_OFFSET(0x109C5840)
#define MONOVOPATHPARTICLE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x109C3700)
#define MONOVOPATHPARTICLE_GET_CURVEPOINTS_OFFSET UNITYSDK_OFFSET(0x11C004A0)
#define MONOVOPATHPARTICLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x109C40B0)
#define MONOVOPATHPARTICLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11C004B0)
#define MONOVOPATHPARTICLE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11C00250)
#define MONOVOPATHPARTICLE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11C00100)
#define MONOVOPATHPARTICLE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x11C003C0)
#define MONOVOPATHPARTICLE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x11C00440)
#define MONOVOPATHPARTICLE_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x11C00310)
#define MONOVOPATHPARTICLE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x11C00200)
#define MONOVOPATHPARTICLE_SETCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x109C2C10)
#define MONOVOPATHPARTICLE_SETUPPARTICLEMESHSOURCE_OFFSET UNITYSDK_OFFSET(0x109C4E50)
#define MONOVOPATHPARTICLE_STARTSPAWNPARTICLE_OFFSET UNITYSDK_OFFSET(0x109C4280)
#define MONOVOPATHPARTICLE_STOPPARTICLE_OFFSET UNITYSDK_OFFSET(0x109C43D0)
#define MONOVOPATHPARTICLE_STOPSPAWNPARTICLE_OFFSET UNITYSDK_OFFSET(0x109C4330)
#define MONOVOPATHPARTICLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x11C00560)
#define MONOVOPATHPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x109C5B90)

inline static constexpr unsigned int MonoVOPathParticle_TypeDefinitionIndex = 74339;
