...
#define MONOVOPATHPARTICLE_APPLYMATERIALOVERRIDE_OFFSET UNITYSDK_OFFSET(0x12B3A6E0)
#define MONOVOPATHPARTICLE_APPLYMOBILEPLATFORMOVERRIDEMATERIALS_OFFSET UNITYSDK_OFFSET(0x12B3C980)
#define MONOVOPATHPARTICLE_APPLYOVERRIDEMATERIALS_OFFSET UNITYSDK_OFFSET(0x12B3C510)
#define MONOVOPATHPARTICLE_CALCULATECATMULLROMCURVE_OFFSET UNITYSDK_OFFSET(0x12B3AA50)
#define MONOVOPATHPARTICLE_CALCULATECATMULLROMPOINT_OFFSET UNITYSDK_OFFSET(0x12B3BF80)
#define MONOVOPATHPARTICLE_CALCULATECURVELENGTH_OFFSET UNITYSDK_OFFSET(0x12B3C220)
#define MONOVOPATHPARTICLE_CLEANSEGMENTPOINTS_OFFSET UNITYSDK_OFFSET(0x12B3C9F0)
#define MONOVOPATHPARTICLE_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x12B39AA0)
#define MONOVOPATHPARTICLE_DELTAPOSITION_OFFSET UNITYSDK_OFFSET(0x12B3A070)
#define MONOVOPATHPARTICLE_DRAWMULTIPLEPASS_OFFSET UNITYSDK_OFFSET(0x12B3A920)
#define MONOVOPATHPARTICLE_FADEOUT_OFFSET UNITYSDK_OFFSET(0x12B3A770)
#define MONOVOPATHPARTICLE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x12B3B440)
#define MONOVOPATHPARTICLE_GET_CURVEPOINTS_OFFSET UNITYSDK_OFFSET(0x12B39810)
#define MONOVOPATHPARTICLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x12B39820)
#define MONOVOPATHPARTICLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12B399F0)
#define MONOVOPATHPARTICLE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12B395C0)
#define MONOVOPATHPARTICLE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12B39470)
#define MONOVOPATHPARTICLE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x12B39730)
#define MONOVOPATHPARTICLE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x12B397B0)
#define MONOVOPATHPARTICLE_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x12B39680)
#define MONOVOPATHPARTICLE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x12B39570)
#define MONOVOPATHPARTICLE_SETCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x12B3A990)
#define MONOVOPATHPARTICLE_SETUPPARTICLEMESHSOURCE_OFFSET UNITYSDK_OFFSET(0x12B3A1C0)
#define MONOVOPATHPARTICLE_STARTSPAWNPARTICLE_OFFSET UNITYSDK_OFFSET(0x12B3BDD0)
#define MONOVOPATHPARTICLE_STOPPARTICLE_OFFSET UNITYSDK_OFFSET(0x12B3BF20)
#define MONOVOPATHPARTICLE_STOPSPAWNPARTICLE_OFFSET UNITYSDK_OFFSET(0x12B3BE80)
#define MONOVOPATHPARTICLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x12B39DD0)
#define MONOVOPATHPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B3CB90)

inline static constexpr unsigned int MonoVOPathParticle_TypeDefinitionIndex = 47577;
