...
#define CLASS_1_27444C19DAB228CE_METHOD_1_00188D2AAFE2BA67_1_OFFSET UNITYSDK_OFFSET(0x1413D030)
#define CLASS_1_27444C19DAB228CE_METHOD_1_00188D2AAFE2BA67_OFFSET UNITYSDK_OFFSET(0x1413C920)
#define CLASS_1_27444C19DAB228CE_METHOD_1_08FE6E442A19B10E_OFFSET UNITYSDK_OFFSET(0x1413D5C0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_093EA43DB4ED711A_OFFSET UNITYSDK_OFFSET(0x1413D4E0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_0BABA9B9DB990C03_OFFSET UNITYSDK_OFFSET(0x1413CBC0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_2942C5D71FB9D518_OFFSET UNITYSDK_OFFSET(0x1413C9A0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_49DFA39A30A44449_OFFSET UNITYSDK_OFFSET(0x1413C700)
#define CLASS_1_27444C19DAB228CE_METHOD_1_4E30EAD831ABAB2E_OFFSET UNITYSDK_OFFSET(0x1413C360)
#define CLASS_1_27444C19DAB228CE_METHOD_1_58EBACEA953BF8BD_OFFSET UNITYSDK_OFFSET(0x1413D250)
#define CLASS_1_27444C19DAB228CE_METHOD_1_6308C232BF6C33AE_1_OFFSET UNITYSDK_OFFSET(0x1413BC90)
#define CLASS_1_27444C19DAB228CE_METHOD_1_6308C232BF6C33AE_OFFSET UNITYSDK_OFFSET(0x1413BFC0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_6A5C7F4041315572_OFFSET UNITYSDK_OFFSET(0x1413D140)
#define CLASS_1_27444C19DAB228CE_METHOD_1_6BB0D0298525DBFB_OFFSET UNITYSDK_OFFSET(0x1413C5E0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_756E91E89470983A_OFFSET UNITYSDK_OFFSET(0x1413C430)
#define CLASS_1_27444C19DAB228CE_METHOD_1_97F950E714FD8F2B_OFFSET UNITYSDK_OFFSET(0x1413CE50)
#define CLASS_1_27444C19DAB228CE_METHOD_1_9B69C5437360C3AB_OFFSET UNITYSDK_OFFSET(0x1413C080)
#define CLASS_1_27444C19DAB228CE_METHOD_1_C45A7C148E83C429_OFFSET UNITYSDK_OFFSET(0x1413BA80)
#define CLASS_1_27444C19DAB228CE_METHOD_1_DFF98536D8B4074F_OFFSET UNITYSDK_OFFSET(0x1413BD60)
#define CLASS_1_27444C19DAB228CE_METHOD_1_EC51DBC6B6B2501B_OFFSET UNITYSDK_OFFSET(0x1413C670)
#define CLASS_1_27444C19DAB228CE_METHOD_1_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0x1413D0B0)
#define CLASS_1_27444C19DAB228CE_METHOD_1_FDA309F11AC8B46B_OFFSET UNITYSDK_OFFSET(0x1413BEE0)
#define CLASS_1_27444C19DAB228CE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1413BA50)

inline static constexpr unsigned int Class_1_27444C19DAB228CE_TypeDefinitionIndex = 46472;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_27444C19DAB228CE_TypeDefinitionIndex)->GetStaticField(0x44580);
	}
	static ::MoleMole::ConfigUIAdapt** StaticGet_Field_1_0()
	{
		return (::MoleMole::ConfigUIAdapt**)Il2CppClass::FromTypeDefinitionIndex(Class_1_27444C19DAB228CE_TypeDefinitionIndex)->GetStaticField(0x44588);
	}
	static ::UnityEngine::DeviceType* StaticGet_Field_1_4()
	{
		return (::UnityEngine::DeviceType*)Il2CppClass::FromTypeDefinitionIndex(Class_1_27444C19DAB228CE_TypeDefinitionIndex)->GetStaticField(0x106F0);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_27444C19DAB228CE_TypeDefinitionIndex)->GetStaticField(0x106F4);
	}
	static ::System::Boolean* StaticGet_Field_1_2()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_27444C19DAB228CE_TypeDefinitionIndex)->GetStaticField(0x106F5);
	}
	static ::System::Single* StaticGet_Field_1_5()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_27444C19DAB228CE_TypeDefinitionIndex)->GetStaticField(0x106F8);
	}
