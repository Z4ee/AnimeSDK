...
#define CLASS_1_98AD82C8BD0A9A10_ADD_AGENDACOMPLETED_OFFSET UNITYSDK_OFFSET(0x163E1AA0)
#define CLASS_1_98AD82C8BD0A9A10_DISPOSE_OFFSET UNITYSDK_OFFSET(0x163E1DE0)
#define CLASS_1_98AD82C8BD0A9A10_METHOD_1_8DA3FEE3379AFF0E_OFFSET UNITYSDK_OFFSET(0x163E1B70)
#define CLASS_1_98AD82C8BD0A9A10_METHOD_1_CA95011BD8CFD258_OFFSET UNITYSDK_OFFSET(0x163E1F00)
#define CLASS_1_98AD82C8BD0A9A10_REMOVE_AGENDACOMPLETED_OFFSET UNITYSDK_OFFSET(0x163E1B00)
#define CLASS_1_98AD82C8BD0A9A10__CTOR_OFFSET UNITYSDK_OFFSET(0x163E1B60)

inline static constexpr unsigned int Class_1_98AD82C8BD0A9A10_TypeDefinitionIndex = 80622;

class Class_1_98AD82C8BD0A9A10 : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_1408* MJHHLOPFDNK; // 0x10
	::Class_1_5452947417BCF16A* CEAAMGFCOLP; // 0x18
	::System::Action_1<::Class_1_6C6363C2772DEF01*>* AgendaCompleted; // 0x20

	::System::Void _ctor(::Class_0_16E4307DCC419505_1408* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_1408*))((::PBYTE)hIl2Cpp + CLASS_1_98AD82C8BD0A9A10__CTOR_OFFSET))(this, a1);
	}
