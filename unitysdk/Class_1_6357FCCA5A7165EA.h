...
#define CLASS_1_6357FCCA5A7165EA_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA44B750)
#define CLASS_1_6357FCCA5A7165EA_METHOD_1_BC68E9F9EA354BAB_OFFSET UNITYSDK_OFFSET(0xA44B7A0)
#define CLASS_1_6357FCCA5A7165EA_METHOD_1_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0xA44B540)
#define CLASS_1_6357FCCA5A7165EA_METHOD_1_E9977E6C7A715233_OFFSET UNITYSDK_OFFSET(0xA44B890)

inline static constexpr unsigned int Class_1_6357FCCA5A7165EA_TypeDefinitionIndex = 60069;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::PropDynamicResConfigItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6357FCCA5A7165EA_TypeDefinitionIndex)->GetStaticField(0x483B0);
	}
	static ::RPG::GameCore::PropDynamicResConfig** StaticGet_Field_1_0()
	{
		return (::RPG::GameCore::PropDynamicResConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6357FCCA5A7165EA_TypeDefinitionIndex)->GetStaticField(0x483B8);
	}
