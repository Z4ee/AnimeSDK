...
#define STRUCT_2_E1D658B1C952DF7C_METHOD_2_01A86BFC2138AD3D_OFFSET UNITYSDK_OFFSET(0x6232E0)
#define STRUCT_2_E1D658B1C952DF7C_METHOD_2_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0x6232D0)

inline static constexpr unsigned int Struct_2_E1D658B1C952DF7C_TypeDefinitionIndex = 71423;

struct alignas(8) Struct_2_E1D658B1C952DF7C
{
	::FluffyUnderware::Curvy::CurvySplineSegment* Field_2_0; // 0x10
	::MoleMole::MonoAirBusSegment* Field_2_1; // 0x18
