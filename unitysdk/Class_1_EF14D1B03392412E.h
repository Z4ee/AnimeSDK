...
#define CLASS_1_EF14D1B03392412E_EXECUTE_OFFSET UNITYSDK_OFFSET(0xB4C3490)
#define CLASS_1_EF14D1B03392412E_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB4C2AC0)
#define CLASS_1_EF14D1B03392412E_METHOD_1_A0C1D60A13C360A1_OFFSET UNITYSDK_OFFSET(0xB4C2DB0)
#define CLASS_1_EF14D1B03392412E_TEARDOWN_OFFSET UNITYSDK_OFFSET(0xB4C3340)
#define CLASS_1_EF14D1B03392412E__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C28B0)

inline static constexpr unsigned int Class_1_EF14D1B03392412E_TypeDefinitionIndex = 76651;

class Class_1_EF14D1B03392412E : public ::System::Object
{
public:
	::Entitas::IGroup_1<::Class_2_B9E8C2EEAA5C96EC*>* KFBHHFIFHCJ; // 0x10
	::Entitas::IGroup_1<::Class_2_B9E8C2EEAA5C96EC*>* GGLEFKBINMC; // 0x18
