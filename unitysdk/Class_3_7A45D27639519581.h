...
#define CLASS_3_7A45D27639519581_METHOD_3_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x87516B0)
#define CLASS_3_7A45D27639519581_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x87515C0)
#define CLASS_3_7A45D27639519581_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8751660)
#define CLASS_3_7A45D27639519581_TICK_OFFSET UNITYSDK_OFFSET(0x8751770)
#define CLASS_3_7A45D27639519581__CTOR_OFFSET UNITYSDK_OFFSET(0x8751560)
#define CLASS_3_7A45D27639519581___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x8751810)

inline static constexpr unsigned int Class_3_7A45D27639519581_TypeDefinitionIndex = 42262;
