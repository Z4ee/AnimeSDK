...
#define MONOUITABLESCROLLV2_MOVECONTEXT_GETCOPYWITHMODIFIEDDELTA_OFFSET UNITYSDK_OFFSET(0x781D50)
#define MONOUITABLESCROLLV2_MOVECONTEXT_GET_NEEDUPDATESCROLL_OFFSET UNITYSDK_OFFSET(0x781CE0)
#define MONOUITABLESCROLLV2_MOVECONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x781DE0)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x781D40)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x781D30)
#define MONOUITABLESCROLLV2_MOVECONTEXT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x781DF0)

inline static constexpr unsigned int MonoUITableScrollV2_MoveContext_TypeDefinitionIndex = 74986;
