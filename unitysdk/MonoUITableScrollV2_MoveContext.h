...
#define MONOUITABLESCROLLV2_MOVECONTEXT_GETCOPYWITHMODIFIEDDELTA_OFFSET UNITYSDK_OFFSET(0x72FF40)
#define MONOUITABLESCROLLV2_MOVECONTEXT_GET_NEEDUPDATESCROLL_OFFSET UNITYSDK_OFFSET(0x72FED0)
#define MONOUITABLESCROLLV2_MOVECONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x72FFD0)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x72FF30)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x72FF20)
#define MONOUITABLESCROLLV2_MOVECONTEXT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x72FFE0)

inline static constexpr unsigned int MonoUITableScrollV2_MoveContext_TypeDefinitionIndex = 54088;
