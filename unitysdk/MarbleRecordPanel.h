...
#define MARBLERECORDPANEL_REFRESHSEALPOS_OFFSET UNITYSDK_OFFSET(0xBBBC1C0)
#define MARBLERECORDPANEL_SETSEALHP_OFFSET UNITYSDK_OFFSET(0xBBBBA10)
#define MARBLERECORDPANEL_SETSEALVISIBLE_OFFSET UNITYSDK_OFFSET(0xBBBBE30)
#define MARBLERECORDPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBBBC280)
