...
#define MARBLERECORDPANEL_REFRESHSEALPOS_OFFSET UNITYSDK_OFFSET(0xA846CC0)
#define MARBLERECORDPANEL_SETSEALHP_OFFSET UNITYSDK_OFFSET(0xA846500)
#define MARBLERECORDPANEL_SETSEALVISIBLE_OFFSET UNITYSDK_OFFSET(0xA846930)
#define MARBLERECORDPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA846D80)

inline static constexpr unsigned int MarbleRecordPanel_TypeDefinitionIndex = 44477;
