...
#define CLASS_2_CB07A8EBC4DB4858_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9713B70)
#define CLASS_2_CB07A8EBC4DB4858_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x9713BB0)
#define CLASS_2_CB07A8EBC4DB4858_ONSKIP_OFFSET UNITYSDK_OFFSET(0x9713D00)
#define CLASS_2_CB07A8EBC4DB4858_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9713BC0)
#define CLASS_2_CB07A8EBC4DB4858_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9713C30)
#define CLASS_2_CB07A8EBC4DB4858_TICK_OFFSET UNITYSDK_OFFSET(0x9713C80)
#define CLASS_2_CB07A8EBC4DB4858__CTOR_OFFSET UNITYSDK_OFFSET(0x9713B60)

inline static constexpr unsigned int Class_2_CB07A8EBC4DB4858_TypeDefinitionIndex = 54325;
