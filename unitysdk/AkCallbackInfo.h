...
#define AKCALLBACKINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1E5ED980)
#define AKCALLBACKINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E5ED860)
#define AKCALLBACKINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E5ED910)
#define AKCALLBACKINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1E5ED7A0)
#define AKCALLBACKINFO_GET_GAMEOBJID_OFFSET UNITYSDK_OFFSET(0x1E5EDBB0)
#define AKCALLBACKINFO_GET_PCOOKIE_OFFSET UNITYSDK_OFFSET(0x1E5EDB30)
#define AKCALLBACKINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1E5ED7B0)
#define AKCALLBACKINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5EDC30)
#define AKCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5ED790)

inline static constexpr unsigned int AkCallbackInfo_TypeDefinitionIndex = 32950;
