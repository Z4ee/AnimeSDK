...
#define CLASS_2_140C207FA14C26B7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A83E490)
#define CLASS_2_140C207FA14C26B7_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A83E4F0)
#define CLASS_2_140C207FA14C26B7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A83DF90)
#define CLASS_2_140C207FA14C26B7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A83E440)
#define CLASS_2_140C207FA14C26B7_TICK_OFFSET UNITYSDK_OFFSET(0x1A83E540)
#define CLASS_2_140C207FA14C26B7__CTOR_OFFSET UNITYSDK_OFFSET(0x1A83DF80)

inline static constexpr unsigned int Class_2_140C207FA14C26B7_TypeDefinitionIndex = 58514;

class Class_2_140C207FA14C26B7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::PropWaterWheelStartRotate* OFKGLJOAMLD; // 0x20
