...
#define CLASS_2_9B8DF5B996968D25_DISPOSE_OFFSET UNITYSDK_OFFSET(0x151FA770)
#define CLASS_2_9B8DF5B996968D25_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x151FA7C0)
#define CLASS_2_9B8DF5B996968D25_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x151FA9A0)
#define CLASS_2_9B8DF5B996968D25_TICK_OFFSET UNITYSDK_OFFSET(0x151FA9F0)
#define CLASS_2_9B8DF5B996968D25__CTOR_OFFSET UNITYSDK_OFFSET(0x151FA760)

inline static constexpr unsigned int Class_2_9B8DF5B996968D25_TypeDefinitionIndex = 58147;

class Class_2_9B8DF5B996968D25 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CacheUI* OFKGLJOAMLD; // 0x18
