...
#define CLASS_1_CC9CE4D523046362_GET_BATTLEENDDATA_OFFSET UNITYSDK_OFFSET(0x159890E0)
#define CLASS_1_CC9CE4D523046362_GET_CONSUMEDLEVELCOUNT_OFFSET UNITYSDK_OFFSET(0x15989140)
#define CLASS_1_CC9CE4D523046362_GET_FSM_OFFSET UNITYSDK_OFFSET(0x15989120)
#define CLASS_1_CC9CE4D523046362_GET_ISSETTLERECEIVED_OFFSET UNITYSDK_OFFSET(0x15989160)
#define CLASS_1_CC9CE4D523046362_GET_MAP_OFFSET UNITYSDK_OFFSET(0x159890C0)
#define CLASS_1_CC9CE4D523046362_GET_ROUTESTATEMAP_OFFSET UNITYSDK_OFFSET(0x15989130)
#define CLASS_1_CC9CE4D523046362_GET_TEAMS_OFFSET UNITYSDK_OFFSET(0x15989100)
#define CLASS_1_CC9CE4D523046362_METHOD_1_2D444D75288B6C4F_OFFSET UNITYSDK_OFFSET(0x159899E0)
#define CLASS_1_CC9CE4D523046362_METHOD_1_4A7B99FF06C6A910_OFFSET UNITYSDK_OFFSET(0x159894A0)
#define CLASS_1_CC9CE4D523046362_METHOD_1_7952C32242C5A7A5_OFFSET UNITYSDK_OFFSET(0x15989330)
#define CLASS_1_CC9CE4D523046362_METHOD_1_9F2422E56849ED61_OFFSET UNITYSDK_OFFSET(0x159891D0)
#define CLASS_1_CC9CE4D523046362_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x15989180)
#define CLASS_1_CC9CE4D523046362_METHOD_1_C02839B8F78A55E8_OFFSET UNITYSDK_OFFSET(0x159896F0)
#define CLASS_1_CC9CE4D523046362_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x159896B0)
#define CLASS_1_CC9CE4D523046362_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15989670)
#define CLASS_1_CC9CE4D523046362_SET_BATTLEENDDATA_OFFSET UNITYSDK_OFFSET(0x159890F0)
#define CLASS_1_CC9CE4D523046362_SET_CONSUMEDLEVELCOUNT_OFFSET UNITYSDK_OFFSET(0x15989150)
#define CLASS_1_CC9CE4D523046362_SET_ISSETTLERECEIVED_OFFSET UNITYSDK_OFFSET(0x15989170)
#define CLASS_1_CC9CE4D523046362_SET_MAP_OFFSET UNITYSDK_OFFSET(0x159890D0)
#define CLASS_1_CC9CE4D523046362_SET_TEAMS_OFFSET UNITYSDK_OFFSET(0x15989110)
#define CLASS_1_CC9CE4D523046362__CTOR_OFFSET UNITYSDK_OFFSET(0x15989A40)
...
{
public:
	::Class_1_B8494E43D47731C4* _BattleEndData_k__BackingField; // 0x10
	::Il2CppArray<::RPG::Client::ExpeditionBattleTeam*>* _Teams_k__BackingField; // 0x18
	::RPG::Client::ExpeditionBattleMap* _Map_k__BackingField; // 0x20
	...
	::Class_1_6E4915D0928F88AA* _Fsm_k__BackingField; // 0x30
	::System::UInt32 _ConsumedLevelCount_k__BackingField; // 0x38
	::System::Boolean _IsSettleReceived_k__BackingField; // 0x3C
