...
#define CLASS_1_EBC347C362DFF976_METHOD_1_57DCB1CE056E3F2A_OFFSET UNITYSDK_OFFSET(0x1A418EB0)
#define CLASS_1_EBC347C362DFF976_METHOD_1_70437D85C11C5222_1_OFFSET UNITYSDK_OFFSET(0x1A419020)
#define CLASS_1_EBC347C362DFF976_METHOD_1_70437D85C11C5222_OFFSET UNITYSDK_OFFSET(0x1A418F80)
#define CLASS_1_EBC347C362DFF976_METHOD_1_79CF584A1A32664A_OFFSET UNITYSDK_OFFSET(0x1A418640)
#define CLASS_1_EBC347C362DFF976_METHOD_1_9E36D95DE7534F6F_OFFSET UNITYSDK_OFFSET(0x1A418A80)
#define CLASS_1_EBC347C362DFF976_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1A4190C0)
#define CLASS_1_EBC347C362DFF976_METHOD_1_BC19473A0B3069DE_OFFSET UNITYSDK_OFFSET(0x1A4182D0)
#define CLASS_1_EBC347C362DFF976_METHOD_1_C3B50927F0CCA612_OFFSET UNITYSDK_OFFSET(0x1A418390)
#define CLASS_1_EBC347C362DFF976__CTOR_OFFSET UNITYSDK_OFFSET(0x1A418220)

inline static constexpr unsigned int Class_1_EBC347C362DFF976_TypeDefinitionIndex = 78505;

class Class_1_EBC347C362DFF976 : public ::System::Object
{
public:
	::RPG::Client::Prop::CoilPuzzle::RigCoilPuzzleBoard* MIPPNCGOJNM; // 0x10
	::UnityEngine::MeshRenderer* IFJJNBGGEKF; // 0x18
	::UnityEngine::Collider* GBDKBLPAHEL; // 0x20
	::System::Int32 NMIEDIECAGH; // 0x28
	::System::Boolean HAAPDBMKDLH; // 0x2C
