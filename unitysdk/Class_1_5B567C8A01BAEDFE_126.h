...
#define CLASS_1_5B567C8A01BAEDFE_126_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D8ECA20)
#define CLASS_1_5B567C8A01BAEDFE_126_CLONE_OFFSET UNITYSDK_OFFSET(0x1D8EC710)
#define CLASS_1_5B567C8A01BAEDFE_126_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D8EC820)
#define CLASS_1_5B567C8A01BAEDFE_126_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D8EC750)
#define CLASS_1_5B567C8A01BAEDFE_126_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D8EC980)
#define CLASS_1_5B567C8A01BAEDFE_126_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D8ECA70)
#define CLASS_1_5B567C8A01BAEDFE_126_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D8ECA40)
#define CLASS_1_5B567C8A01BAEDFE_126_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D8EC690)
#define CLASS_1_5B567C8A01BAEDFE_126_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D8EC6C0)
#define CLASS_1_5B567C8A01BAEDFE_126_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D8EC9B0)
#define CLASS_1_5B567C8A01BAEDFE_126_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D8ECA10)
#define CLASS_1_5B567C8A01BAEDFE_126__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D8ECAC0)
#define CLASS_1_5B567C8A01BAEDFE_126__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D8EC6E0)
#define CLASS_1_5B567C8A01BAEDFE_126__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8EC6D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_126_TypeDefinitionIndex = 28227;

class Class_1_5B567C8A01BAEDFE_126 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_126*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_126*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_126_TypeDefinitionIndex)->GetStaticField(0x45F60);
	}
