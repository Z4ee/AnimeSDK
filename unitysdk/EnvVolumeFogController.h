...
#define ENVVOLUMEFOGCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x151EC530)
#define ENVVOLUMEFOGCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x151EC6D0)
#define ENVVOLUMEFOGCONTROLLER_RECOVERGLOBALFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x151EC4D0)
#define ENVVOLUMEFOGCONTROLLER_SETHEIGHTFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x151EC3C0)
#define ENVVOLUMEFOGCONTROLLER_SWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x151EC230)
#define ENVVOLUMEFOGCONTROLLER_TESTDARK_OFFSET UNITYSDK_OFFSET(0x151EC320)
#define ENVVOLUMEFOGCONTROLLER_TESTLIGHT_OFFSET UNITYSDK_OFFSET(0x151EC430)
#define ENVVOLUMEFOGCONTROLLER_TESTSWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x151EC1E0)
#define ENVVOLUMEFOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151EC750)

inline static constexpr unsigned int EnvVolumeFogController_TypeDefinitionIndex = 49582;
