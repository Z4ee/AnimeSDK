...
#define ENVVOLUMEFOGCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1591BDE0)
#define ENVVOLUMEFOGCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1591BF80)
#define ENVVOLUMEFOGCONTROLLER_RECOVERGLOBALFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x1591BD80)
#define ENVVOLUMEFOGCONTROLLER_SETHEIGHTFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x1591BC70)
#define ENVVOLUMEFOGCONTROLLER_SWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x1591BAE0)
#define ENVVOLUMEFOGCONTROLLER_TESTDARK_OFFSET UNITYSDK_OFFSET(0x1591BBD0)
#define ENVVOLUMEFOGCONTROLLER_TESTLIGHT_OFFSET UNITYSDK_OFFSET(0x1591BCE0)
#define ENVVOLUMEFOGCONTROLLER_TESTSWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x1591BA90)
#define ENVVOLUMEFOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1591C000)

inline static constexpr unsigned int EnvVolumeFogController_TypeDefinitionIndex = 41064;
