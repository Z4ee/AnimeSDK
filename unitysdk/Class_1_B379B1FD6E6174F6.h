...
inline static constexpr unsigned int Class_1_B379B1FD6E6174F6_TypeDefinitionIndex = 49678;

template <typename T>
class Class_1_B379B1FD6E6174F6 : public ::System::Object
{
public:
	::System::Collections::Generic::Stack_1<T>* BBEBHJOLHDE; // 0x0
	static ::Class_1_B379B1FD6E6174F6<T>** StaticGet_FMJPMFEDIJL()
	{
