...
#define CLASS_1_20FCC2F82753283C_1_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB9A8EA0)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_2288BF7B54BF86A9_OFFSET UNITYSDK_OFFSET(0xB9AA4E0)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB9AA480)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_4967D395F2BF3624_OFFSET UNITYSDK_OFFSET(0xB9A8F50)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xB9A8EE0)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_938C5AA708433B7C_OFFSET UNITYSDK_OFFSET(0xB9A8C60)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_A7188DFAB5831CB7_OFFSET UNITYSDK_OFFSET(0xB9A9980)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_AF5DADE427749D02_OFFSET UNITYSDK_OFFSET(0xB9A8CB0)
#define CLASS_1_20FCC2F82753283C_1_METHOD_1_D1149065CC4CFA55_OFFSET UNITYSDK_OFFSET(0xB9A8BB0)
#define CLASS_1_20FCC2F82753283C_1__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A8B70)
...
public:
	...
	::System::Single GNFOMGEBMAA; // 0x18
	::RPG::Client::SwipeCameraStateEnum DLNIGFGLPLJ; // 0x1C
	::System::Single MEHLMFMJANN; // 0x20
	::UnityEngine::Quaternion IKLDDLDIJIC; // 0x24
	::System::Boolean MOKNCFJICIC; // 0x34
	::System::Single PBLBNOOMKCC; // 0x38
	::UnityEngine::Vector2 MJGIHIGGBIK; // 0x3C
	::UnityEngine::Quaternion ECDODICPJJH; // 0x44
	::System::Single MIPBBGJCKCB; // 0x54
	::UnityEngine::Quaternion CPOGADDNCLM; // 0x58
	::UnityEngine::Quaternion HCFLKAIIMMN; // 0x68
	::System::Single BAGGGIOKJAK; // 0x78
	::UnityEngine::Vector2 OGDEKPDMCLF; // 0x7C
	::System::Single DCLAIMLDBFO; // 0x84
	::System::Single NMFDLKEPKLJ; // 0x88
