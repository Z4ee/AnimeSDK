...
#define CLASS_3_4E839C0B2E8A1A3F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC46CE60)
#define CLASS_3_4E839C0B2E8A1A3F__CTOR_OFFSET UNITYSDK_OFFSET(0xC46CE30)

inline static constexpr unsigned int Class_3_4E839C0B2E8A1A3F_TypeDefinitionIndex = 51894;
