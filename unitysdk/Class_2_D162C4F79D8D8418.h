...
#define CLASS_2_D162C4F79D8D8418_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BB2BD0)
#define CLASS_2_D162C4F79D8D8418_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15BB25E0)
#define CLASS_2_D162C4F79D8D8418_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15BB2B90)
#define CLASS_2_D162C4F79D8D8418_TICK_OFFSET UNITYSDK_OFFSET(0x15BB2B30)
#define CLASS_2_D162C4F79D8D8418__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB25D0)

inline static constexpr unsigned int Class_2_D162C4F79D8D8418_TypeDefinitionIndex = 58174;

class Class_2_D162C4F79D8D8418 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ChimeraDuelEnterTutorialBattle* OFKGLJOAMLD; // 0x18
