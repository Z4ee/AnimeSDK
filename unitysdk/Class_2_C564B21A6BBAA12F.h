...
#define CLASS_2_C564B21A6BBAA12F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17241580)
#define CLASS_2_C564B21A6BBAA12F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x172415C0)
#define CLASS_2_C564B21A6BBAA12F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17241740)
#define CLASS_2_C564B21A6BBAA12F_TICK_OFFSET UNITYSDK_OFFSET(0x17241790)
#define CLASS_2_C564B21A6BBAA12F__CTOR_OFFSET UNITYSDK_OFFSET(0x17241570)

inline static constexpr unsigned int Class_2_C564B21A6BBAA12F_TypeDefinitionIndex = 55561;

class Class_2_C564B21A6BBAA12F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetCameraConfigPriority* OFKGLJOAMLD; // 0x18
