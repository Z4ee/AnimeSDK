...
#define CLASS_1_B9C702BA1E12DFA3__CTOR_OFFSET UNITYSDK_OFFSET(0xBA5A4F0)
...
{
public:
	::RPG::GameCore::VCameraState NGDOLOLEAPI; // 0x10
	::RPG::GameCore::VCameraState JBCFGGDEKMH; // 0x14
