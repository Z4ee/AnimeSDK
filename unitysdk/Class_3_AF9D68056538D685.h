...
#define CLASS_3_AF9D68056538D685_METHOD_3_2DFC332AF3EA3B47_OFFSET UNITYSDK_OFFSET(0x1D849E30)
#define CLASS_3_AF9D68056538D685_METHOD_3_469ECD10EF199C13_OFFSET UNITYSDK_OFFSET(0x1D849ED0)
#define CLASS_3_AF9D68056538D685__CTOR_OFFSET UNITYSDK_OFFSET(0x1D849E90)

inline static constexpr unsigned int Class_3_AF9D68056538D685_TypeDefinitionIndex = 23883;

class Class_3_AF9D68056538D685 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x18
	::RPG::GameCore::TargetEvaluator* GAKEPLNFPGP; // 0x20
