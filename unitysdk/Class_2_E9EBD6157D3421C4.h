...
#define CLASS_2_E9EBD6157D3421C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16353FE0)
#define CLASS_2_E9EBD6157D3421C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16354040)
#define CLASS_2_E9EBD6157D3421C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x163540C0)
#define CLASS_2_E9EBD6157D3421C4_TICK_OFFSET UNITYSDK_OFFSET(0x16354110)
#define CLASS_2_E9EBD6157D3421C4__CTOR_OFFSET UNITYSDK_OFFSET(0x16353FD0)

inline static constexpr unsigned int Class_2_E9EBD6157D3421C4_TypeDefinitionIndex = 55501;

class Class_2_E9EBD6157D3421C4 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::DialogueEventSwitch* Field_2_0; // 0x18
