...
#define CLASS_1_274386B6ECA5E606_METHOD_1_20649D79497C5001_OFFSET UNITYSDK_OFFSET(0x179AC6A0)
#define CLASS_1_274386B6ECA5E606_METHOD_1_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0x179AC5A0)
#define CLASS_1_274386B6ECA5E606_METHOD_1_7EE99EE6AA394745_OFFSET UNITYSDK_OFFSET(0x179AC940)
#define CLASS_1_274386B6ECA5E606_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x179AC550)
#define CLASS_1_274386B6ECA5E606_METHOD_1_E6F4FD7AF7C4C2DC_OFFSET UNITYSDK_OFFSET(0x179AC430)
#define CLASS_1_274386B6ECA5E606__CTOR_OFFSET UNITYSDK_OFFSET(0x179ACA00)

inline static constexpr unsigned int Class_1_274386B6ECA5E606_TypeDefinitionIndex = 72304;

class Class_1_274386B6ECA5E606 : public ::System::Object
{
public:
	::RPG::Client::PrefabLoadMeta* BFACGOBBOBH; // 0x10
	::System::Collections::Generic::List_1<::RPG::Client::SkillCounterItem*>* LKICMLJHCAK; // 0x18
	::UnityEngine::GameObject* BPEEKJFKHNI; // 0x20
	::UnityEngine::Transform* LKECMFKKOHA; // 0x28
