...
{
	inline static constexpr unsigned int HexagonalGrid___c__DisplayClass78_0_1_TypeDefinitionIndex = 26305;

	template <typename T>
	class HexagonalGrid___c__DisplayClass78_0_1 : public ::System::Object
	{
	public:
