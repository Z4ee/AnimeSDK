...
#define HEXAGONALLIB_HEXAGONALEXCEPTION_CREATEBUILDER_OFFSET UNITYSDK_OFFSET(0x1DEFB160)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEFB050)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DEFB400)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DEFB630)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEFAFD0)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalException_TypeDefinitionIndex = 28970;
