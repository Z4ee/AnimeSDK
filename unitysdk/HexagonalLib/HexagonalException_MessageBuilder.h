...
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x1BC3F3E0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x1BC3F1C0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_3_OFFSET UNITYSDK_OFFSET(0x1BC3F780)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_OFFSET UNITYSDK_OFFSET(0x1BC3F6C0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC3F270)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3F640)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC3F850)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalException_MessageBuilder_TypeDefinitionIndex = 26355;
