...
#define HEXAGONALLIB_HEXAGONALMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1E6283B0)
#define HEXAGONALLIB_HEXAGONALMATH_ROTATE_OFFSET UNITYSDK_OFFSET(0x1E628230)
#define HEXAGONALLIB_HEXAGONALMATH_SIMILARTO_1_OFFSET UNITYSDK_OFFSET(0x1E628520)
#define HEXAGONALLIB_HEXAGONALMATH_SIMILARTO_OFFSET UNITYSDK_OFFSET(0x1E628450)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalMath_TypeDefinitionIndex = 28955;
