...
#define HEXAGONALLIB_HEXAGONALMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1F6B9D40)
#define HEXAGONALLIB_HEXAGONALMATH_ROTATE_OFFSET UNITYSDK_OFFSET(0x1F6B9BD0)
#define HEXAGONALLIB_HEXAGONALMATH_SIMILARTO_1_OFFSET UNITYSDK_OFFSET(0x1F6B9E80)
#define HEXAGONALLIB_HEXAGONALMATH_SIMILARTO_OFFSET UNITYSDK_OFFSET(0x1F6B9DD0)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalMath_TypeDefinitionIndex = 29540;
