...
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F8EE0A0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HEXAGONALLIB_COORDINATES_AXIAL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F8EE3A0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HEXAGONALLIB_COORDINATES_AXIAL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F8EE2F0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F8EE430)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F8EE350)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F8EE300)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F8EE070)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8EE050)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1F8EE090)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalGrid__GetNeighbors_d__41_TypeDefinitionIndex = 29409;
	...
	public:
		...
		::HexagonalLib::HexagonalGrid __4__this; // 0x28
		...
		::HexagonalLib::Coordinates::Axial hex; // 0x50
