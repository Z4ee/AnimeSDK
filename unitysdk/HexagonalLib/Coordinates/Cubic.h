...
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9ABE10)
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x9ABE80)
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_OFFSET UNITYSDK_OFFSET(0x9ABE00)
#define HEXAGONALLIB_COORDINATES_CUBIC_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x9ABFD0)
#define HEXAGONALLIB_COORDINATES_CUBIC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9ABEC0)
#define HEXAGONALLIB_COORDINATES_CUBIC_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1BC3DDB0)
#define HEXAGONALLIB_COORDINATES_CUBIC_ISVALID_OFFSET UNITYSDK_OFFSET(0x9ABD10)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1BC3E200)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1BC3E160)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BC3E050)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BC3E0E0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1BC3E450)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1BC3E3C0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1BC3E330)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1BC3E290)
#define HEXAGONALLIB_COORDINATES_CUBIC_ROTATETORIGHT_1_OFFSET UNITYSDK_OFFSET(0x9ABDE0)
#define HEXAGONALLIB_COORDINATES_CUBIC_ROTATETORIGHT_OFFSET UNITYSDK_OFFSET(0x9ABD60)
#define HEXAGONALLIB_COORDINATES_CUBIC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9AC000)
#define HEXAGONALLIB_COORDINATES_CUBIC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9ABD00)
#define HEXAGONALLIB_COORDINATES_CUBIC__CTOR_OFFSET UNITYSDK_OFFSET(0x3EABD0)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9AC010)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9AC080)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9AC0F0)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Cubic_TypeDefinitionIndex = 26231;
