...
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA4C5A0)
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_2_OFFSET UNITYSDK_OFFSET(0xA4C610)
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_OFFSET UNITYSDK_OFFSET(0xA4C590)
#define HEXAGONALLIB_COORDINATES_CUBIC_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0xA4C760)
#define HEXAGONALLIB_COORDINATES_CUBIC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA4C650)
#define HEXAGONALLIB_COORDINATES_CUBIC_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1DEF9EF0)
#define HEXAGONALLIB_COORDINATES_CUBIC_ISVALID_OFFSET UNITYSDK_OFFSET(0xA4C4A0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1DEFA340)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1DEFA2A0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1DEFA190)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1DEFA220)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1DEFA590)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1DEFA500)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1DEFA470)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1DEFA3D0)
#define HEXAGONALLIB_COORDINATES_CUBIC_ROTATETORIGHT_1_OFFSET UNITYSDK_OFFSET(0xA4C570)
#define HEXAGONALLIB_COORDINATES_CUBIC_ROTATETORIGHT_OFFSET UNITYSDK_OFFSET(0xA4C4F0)
#define HEXAGONALLIB_COORDINATES_CUBIC_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA4C790)
#define HEXAGONALLIB_COORDINATES_CUBIC__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA4C490)
#define HEXAGONALLIB_COORDINATES_CUBIC__CTOR_OFFSET UNITYSDK_OFFSET(0x4E6C30)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA4C7A0)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA4C810)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA4C880)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Cubic_TypeDefinitionIndex = 28953;
