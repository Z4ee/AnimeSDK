...
#define HEXAGONALLIB_COORDINATES_OFFSET_ADD_OFFSET UNITYSDK_OFFSET(0x9D2690)
#define HEXAGONALLIB_COORDINATES_OFFSET_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1D16A2D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_CLAMP_OFFSET UNITYSDK_OFFSET(0x1D16A1D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9D2710)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x9D2770)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_OFFSET UNITYSDK_OFFSET(0x9D2700)
#define HEXAGONALLIB_COORDINATES_OFFSET_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x9D28B0)
#define HEXAGONALLIB_COORDINATES_OFFSET_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9D2800)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_INVALID_OFFSET UNITYSDK_OFFSET(0x1D16A100)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9D2630)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1D16A0E0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1D16A440)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1D16A3D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1D16A510)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D16A330)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D16A380)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1D16A570)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1D16A4A0)
#define HEXAGONALLIB_COORDINATES_OFFSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9D28C0)
#define HEXAGONALLIB_COORDINATES_OFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x2AB920)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9D28D0)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9D2930)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9D2990)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Offset_TypeDefinitionIndex = 28732;
