...
#define CLASS_2_B0AE2CFF72FC6F8B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15889B50)
#define CLASS_2_B0AE2CFF72FC6F8B_METHOD_2_10633FB61A0D692F_OFFSET UNITYSDK_OFFSET(0x1588A750)
#define CLASS_2_B0AE2CFF72FC6F8B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15889E90)
#define CLASS_2_B0AE2CFF72FC6F8B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15889D40)
#define CLASS_2_B0AE2CFF72FC6F8B_TICK_OFFSET UNITYSDK_OFFSET(0x1588A5A0)
#define CLASS_2_B0AE2CFF72FC6F8B__CTOR_OFFSET UNITYSDK_OFFSET(0x158899B0)
...
public:
	...
	::RPG::Client::Prop::MonoPushDownObject* FJNPGFOCEIK; // 0x20
	::Class_3_07C3C4D2990C49EE* HGJBJGOLLCM; // 0x28
	::RPG::GameCore::TaskContext* DMNHJGOOGLI; // 0x30
	::Class_3_07C3C4D2990C49EE* CFOKAIEGBNK; // 0x38
	::RPG::GameCore::AdvPlayerPushDownProp* OFKGLJOAMLD; // 0x40
