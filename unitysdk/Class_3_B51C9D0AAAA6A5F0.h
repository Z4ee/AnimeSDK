...
#define CLASS_3_B51C9D0AAAA6A5F0_METHOD_3_1991D2DBDE96809E_OFFSET UNITYSDK_OFFSET(0x11FBFD60)
#define CLASS_3_B51C9D0AAAA6A5F0_METHOD_3_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x11FBFBA0)
#define CLASS_3_B51C9D0AAAA6A5F0_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x11FBFC00)
#define CLASS_3_B51C9D0AAAA6A5F0__CTOR_OFFSET UNITYSDK_OFFSET(0x11FBFD50)

inline static constexpr unsigned int Class_3_B51C9D0AAAA6A5F0_TypeDefinitionIndex = 79578;

class Class_3_B51C9D0AAAA6A5F0 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::String* Field_3_3; // 0x0
	::System::Action_2<::MoleMole::Config::EnterBattleState, ::MoleMole::Config::EnterBattleState>* Field_3_6; // 0x48
	::System::Collections::Generic::List_1<::System::String*>* Field_3_1; // 0x50
	::System::Collections::Generic::List_1<::MoleMole::Config::EnterBattleState>* Field_3_2; // 0x58
