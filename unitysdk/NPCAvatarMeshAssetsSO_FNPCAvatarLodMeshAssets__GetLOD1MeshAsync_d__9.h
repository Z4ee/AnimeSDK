...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD1MESHASYNC_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7B1E10)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD1MESHASYNC_D__9_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets__GetLOD1MeshAsync_d__9_TypeDefinitionIndex = 55892;
