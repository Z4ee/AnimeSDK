...
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9EAEA0)
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9EAF50)
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9EAB20)
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EAB00)

namespace WeLing::SDK
{
	inline static constexpr unsigned int PipeWrapper_OnSensorCallbackFun_TypeDefinitionIndex = 19295;
