...
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D112760)
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1127D0)
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D112750)
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1126E0)

namespace WeLing::SDK
{
	inline static constexpr unsigned int PipeWrapper_OnReceiveData_TypeDefinitionIndex = 7498;
