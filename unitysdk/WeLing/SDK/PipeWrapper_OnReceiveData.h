...
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19808010)
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198080A0)
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x19807CD0)
#define WELING_SDK_PIPEWRAPPER_ONRECEIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19807CC0)

namespace WeLing::SDK
{
	inline static constexpr unsigned int PipeWrapper_OnReceiveData_TypeDefinitionIndex = 18411;
