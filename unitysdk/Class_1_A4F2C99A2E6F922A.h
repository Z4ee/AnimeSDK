...
#define CLASS_1_A4F2C99A2E6F922A_GET_ISENTERED_OFFSET UNITYSDK_OFFSET(0xBEC4760)
#define CLASS_1_A4F2C99A2E6F922A_METHOD_1_0619D137A62C3F76_OFFSET UNITYSDK_OFFSET(0xBEC49E0)
#define CLASS_1_A4F2C99A2E6F922A_METHOD_1_193E00E83BC3E6E8_OFFSET UNITYSDK_OFFSET(0xBEC48A0)
#define CLASS_1_A4F2C99A2E6F922A_METHOD_1_3EA2E124EC6BB35D_OFFSET UNITYSDK_OFFSET(0xBEC4780)
#define CLASS_1_A4F2C99A2E6F922A_METHOD_1_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xBEC45D0)
#define CLASS_1_A4F2C99A2E6F922A_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0xBEC4690)
#define CLASS_1_A4F2C99A2E6F922A_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xBEC4500)
#define CLASS_1_A4F2C99A2E6F922A_SET_ISENTERED_OFFSET UNITYSDK_OFFSET(0xBEC4770)
#define CLASS_1_A4F2C99A2E6F922A__CTOR_OFFSET UNITYSDK_OFFSET(0xBEC4C40)

inline static constexpr unsigned int Class_1_A4F2C99A2E6F922A_TypeDefinitionIndex = 78099;

class Class_1_A4F2C99A2E6F922A : public ::System::Object
{
public:
	::RPG::Client::Prop::DronesPuzzleAreaConfig EABKOHGCHFP; // 0x10
	::System::Action* AHEEAFKFALM; // 0x30
	::System::Action* CLJEBKODGHK; // 0x38
