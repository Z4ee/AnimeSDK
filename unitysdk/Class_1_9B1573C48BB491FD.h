...
#define CLASS_1_9B1573C48BB491FD_ADDDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xDEDA230)
#define CLASS_1_9B1573C48BB491FD_CLOSE_OFFSET UNITYSDK_OFFSET(0xDEDB020)
#define CLASS_1_9B1573C48BB491FD_GETTOTALDOWNLOADEDSIZE_OFFSET UNITYSDK_OFFSET(0xDEDAE80)
#define CLASS_1_9B1573C48BB491FD_GETTOTALDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0xDEDAF40)
#define CLASS_1_9B1573C48BB491FD_GETTOTALNEEDDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0xDEDB460)
#define CLASS_1_9B1573C48BB491FD_GET_ISENABLEVERIFIER_OFFSET UNITYSDK_OFFSET(0xDEDA210)
#define CLASS_1_9B1573C48BB491FD_GET_ISSHOWALIVEKEEPER_OFFSET UNITYSDK_OFFSET(0xDEDA1F0)
#define CLASS_1_9B1573C48BB491FD_GET_ONFAILED_OFFSET UNITYSDK_OFFSET(0xDED9FE0)
#define CLASS_1_9B1573C48BB491FD_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0xDED9FC0)
#define CLASS_1_9B1573C48BB491FD_GET_ONUPDATEDELTA_OFFSET UNITYSDK_OFFSET(0xDED9FA0)
#define CLASS_1_9B1573C48BB491FD_GET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xDED9F80)
#define CLASS_1_9B1573C48BB491FD_GET_ONWEBRESPONSE_OFFSET UNITYSDK_OFFSET(0xDED9F60)
#define CLASS_1_9B1573C48BB491FD_ISDONE_OFFSET UNITYSDK_OFFSET(0xDEDB3B0)
#define CLASS_1_9B1573C48BB491FD_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xDEDB410)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_128A993FA35EFDA0_OFFSET UNITYSDK_OFFSET(0xDEDBDD0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_16FB233A057EAA95_OFFSET UNITYSDK_OFFSET(0xDEDDCA0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_21EAE8EE56AEE451_OFFSET UNITYSDK_OFFSET(0xDEDBF00)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_26EDB267E37FAB3C_OFFSET UNITYSDK_OFFSET(0xDEDBCF0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0xDEDE200)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_36F0C0302DBA2CE4_OFFSET UNITYSDK_OFFSET(0xDEDE240)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_39FFE99F2DCEB398_OFFSET UNITYSDK_OFFSET(0xDEDED30)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_3AC8F91835D61B3F_OFFSET UNITYSDK_OFFSET(0xDEDA3C0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0xDEDE510)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0xDEDA750)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_58D830BED947ACCC_OFFSET UNITYSDK_OFFSET(0xDEDD790)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_6A521C35B3EF553F_OFFSET UNITYSDK_OFFSET(0xDEDD3E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_6B5EA38BAE5646C2_OFFSET UNITYSDK_OFFSET(0xDEDEC40)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_70BBBEA481107523_OFFSET UNITYSDK_OFFSET(0xDEDD9D0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_8A87B4D6FB7FDD03_OFFSET UNITYSDK_OFFSET(0xDEDDDA0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_906C7A2F4FE684C4_OFFSET UNITYSDK_OFFSET(0xDEDB500)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9500614C417C9194_OFFSET UNITYSDK_OFFSET(0xDEDD590)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xDEDBC70)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9B81597B4B113C3D_1_OFFSET UNITYSDK_OFFSET(0xDEDE0E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9B81597B4B113C3D_OFFSET UNITYSDK_OFFSET(0xDEDD670)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xDEDE4B0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A5B6063FFC26FC8F_1_OFFSET UNITYSDK_OFFSET(0xDEDED40)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xDEDD9E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A93B7CD3768E295E_OFFSET UNITYSDK_OFFSET(0xDEDE230)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0xDEDE540)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_AD0F9D7AB7E793D8_OFFSET UNITYSDK_OFFSET(0xDEDD8F0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_AF16C96C0D113C49_OFFSET UNITYSDK_OFFSET(0xDEDD470)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xDEDB300)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_B283605EECB8DCF3_OFFSET UNITYSDK_OFFSET(0xDEDD260)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0xDEDE530)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0xDEDB4C0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C2B24D724C7D351B_OFFSET UNITYSDK_OFFSET(0xDEDF020)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0xDEDE500)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0xDEDD9C0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0xDEDD780)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_2_OFFSET UNITYSDK_OFFSET(0xDEDE1F0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_3_OFFSET UNITYSDK_OFFSET(0xDEDE220)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_4_OFFSET UNITYSDK_OFFSET(0xDEDE520)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xDEDB4F0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D03F13E5EC3F80DD_OFFSET UNITYSDK_OFFSET(0xDEDD660)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xDEDA610)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D3B9FBAF07067BAD_OFFSET UNITYSDK_OFFSET(0xDEDD110)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D66F211912D83957_OFFSET UNITYSDK_OFFSET(0xDEDAE30)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0xDEDE550)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_EE5D71FBB4261BF2_OFFSET UNITYSDK_OFFSET(0xDEDF010)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xDEDB4E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xDEDD9B0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_3_OFFSET UNITYSDK_OFFSET(0xDEDE210)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_4_OFFSET UNITYSDK_OFFSET(0xDEDF000)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xDEDB4D0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0B1C7F469B30FE7_OFFSET UNITYSDK_OFFSET(0xDEDEA20)
#define CLASS_1_9B1573C48BB491FD_PAUSE_OFFSET UNITYSDK_OFFSET(0xDEDB180)
#define CLASS_1_9B1573C48BB491FD_SET_ISENABLEVERIFIER_OFFSET UNITYSDK_OFFSET(0xDEDA220)
#define CLASS_1_9B1573C48BB491FD_SET_ISSHOWALIVEKEEPER_OFFSET UNITYSDK_OFFSET(0xDEDA200)
#define CLASS_1_9B1573C48BB491FD_SET_ONFAILED_OFFSET UNITYSDK_OFFSET(0xDED9FF0)
#define CLASS_1_9B1573C48BB491FD_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0xDED9FD0)
#define CLASS_1_9B1573C48BB491FD_SET_ONUPDATEDELTA_OFFSET UNITYSDK_OFFSET(0xDED9FB0)
#define CLASS_1_9B1573C48BB491FD_SET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xDED9F90)
#define CLASS_1_9B1573C48BB491FD_SET_ONWEBRESPONSE_OFFSET UNITYSDK_OFFSET(0xDED9F70)
#define CLASS_1_9B1573C48BB491FD_START_OFFSET UNITYSDK_OFFSET(0xDEDA450)
#define CLASS_1_9B1573C48BB491FD_UNPAUSE_OFFSET UNITYSDK_OFFSET(0xDEDB230)
#define CLASS_1_9B1573C48BB491FD_UPDATE_OFFSET UNITYSDK_OFFSET(0xDEDAB20)
#define CLASS_1_9B1573C48BB491FD__CTOR_OFFSET UNITYSDK_OFFSET(0xDEDA000)

inline static constexpr unsigned int Class_1_9B1573C48BB491FD_TypeDefinitionIndex = 55828;
...
public:
	...
	::System::Exception* Field_1_8; // 0x20
	::System::Action_3<::System::Int32, ::System::String*, ::System::Action_1<::System::Boolean>*>* Field_1_15; // 0x28
	::System::Action_1<::System::Int64>* Field_1_14; // 0x30
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_17; // 0x38
	::System::Action_1<::System::Boolean>* Field_1_20; // 0x40
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_19; // 0x48
	::System::Collections::Generic::Queue_1<::System::Single>* Field_1_27; // 0x50
	::System::Action_2<::System::String*, ::System::Boolean>* Field_1_11; // 0x58
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_18; // 0x60
	::System::Action_2<::System::Single, ::System::Int64>* Field_1_13; // 0x68
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_16; // 0x70
	::System::Collections::Generic::List_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_4; // 0x78
	::System::Threading::ManualResetEvent* Field_1_30; // 0x80
	::System::Collections::Generic::Queue_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_28; // 0x88
	::System::Int64 Field_1_23; // 0x90
	::System::Single Field_1_38; // 0x98
	::System::Int32 Field_1_7; // 0x9C
	::Class_1_9B1573C48BB491FD_Enum_3_161872DC1725FD46 Field_1_6; // 0xA0
	::System::Int32 Field_1_31; // 0xA4
	::System::Int32 Field_1_35; // 0xA8
	::System::Int32 Field_1_37; // 0xAC
	::System::Boolean Field_1_10; // 0xB0
	::System::Boolean Field_1_39; // 0xB1
	::System::Boolean Field_1_9; // 0xB2
	::System::Int32 Field_1_33; // 0xB4
	::System::Int64 Field_1_24; // 0xB8
	::System::Int32 Field_1_32; // 0xC0
	::Enum_3_0A3761FE34514D6C Field_1_0; // 0xC4
	::System::Single Field_1_26; // 0xC8
	::System::Boolean Field_1_2; // 0xCC
	::System::Boolean Field_1_40; // 0xCD
	::System::Boolean Field_1_1; // 0xCE
	::System::Boolean Field_1_3; // 0xCF
	::System::Int32 Field_1_34; // 0xD0
	::System::Int32 Field_1_5; // 0xD4
	::System::Int64 Field_1_22; // 0xD8
	::System::Int32 Field_1_36; // 0xE0
	::System::Single Field_1_25; // 0xE4
