...
#define CLASS_1_2A4D5E2A9509A7E3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17F4DD60)
#define CLASS_1_2A4D5E2A9509A7E3_CLONE_OFFSET UNITYSDK_OFFSET(0x17F4D8C0)
#define CLASS_1_2A4D5E2A9509A7E3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17F4D960)
#define CLASS_1_2A4D5E2A9509A7E3_EQUALS_OFFSET UNITYSDK_OFFSET(0x17F4D930)
#define CLASS_1_2A4D5E2A9509A7E3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17F4DA50)
#define CLASS_1_2A4D5E2A9509A7E3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17F4DFE0)
#define CLASS_1_2A4D5E2A9509A7E3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17F4DEE0)
#define CLASS_1_2A4D5E2A9509A7E3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17F4D900)
#define CLASS_1_2A4D5E2A9509A7E3_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17F4D920)
#define CLASS_1_2A4D5E2A9509A7E3_METHOD_1_6E8EADC4D1FD06E5_OFFSET UNITYSDK_OFFSET(0x17F4D8F0)
#define CLASS_1_2A4D5E2A9509A7E3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17F4D910)
#define CLASS_1_2A4D5E2A9509A7E3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17F4D730)
#define CLASS_1_2A4D5E2A9509A7E3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F4DBF0)
#define CLASS_1_2A4D5E2A9509A7E3_WRITETO_OFFSET UNITYSDK_OFFSET(0x17F4DC50)
#define CLASS_1_2A4D5E2A9509A7E3__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F4E110)
#define CLASS_1_2A4D5E2A9509A7E3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17F4D7B0)
#define CLASS_1_2A4D5E2A9509A7E3__CTOR_OFFSET UNITYSDK_OFFSET(0x17F4D740)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_35B19D34B208E77E_19*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2A4D5E2A9509A7E3_TypeDefinitionIndex)->GetStaticField(0x31D80);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::ItemList*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::ItemList*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2A4D5E2A9509A7E3_TypeDefinitionIndex)->GetStaticField(0x31D88);
	}
	// static const ::System::Int32 Field_1_1 = 0xC; // 0x0
	// static const ::System::Int32 Field_1_4 = 0xF; // 0x0
	// static const ::System::Int32 Field_1_6 = 0xB; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::ItemList*>* Field_1_3; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_35B19D34B208E77E_19*>* Field_1_8; // 0x20
