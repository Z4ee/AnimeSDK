...
#define AKRAMP_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1F9D8980)
#define AKRAMP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F9D8860)
#define AKRAMP_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1F9D8910)
#define AKRAMP_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1F9D87A0)
#define AKRAMP_GET_FNEXT_OFFSET UNITYSDK_OFFSET(0x1F9D8DF0)
#define AKRAMP_GET_FPREV_OFFSET UNITYSDK_OFFSET(0x1F9D8CE0)
#define AKRAMP_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1F9D87B0)
#define AKRAMP_SET_FNEXT_OFFSET UNITYSDK_OFFSET(0x1F9D8D60)
#define AKRAMP_SET_FPREV_OFFSET UNITYSDK_OFFSET(0x1F9D8C50)
#define AKRAMP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F9D8B30)
#define AKRAMP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F9D8BB0)
#define AKRAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9D8790)

inline static constexpr unsigned int AkRamp_TypeDefinitionIndex = 33643;
