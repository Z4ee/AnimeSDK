...
#define AKRAMP_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1C2A1E80)
#define AKRAMP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C2A1D60)
#define AKRAMP_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C2A1E10)
#define AKRAMP_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1C2A1CA0)
#define AKRAMP_GET_FNEXT_OFFSET UNITYSDK_OFFSET(0x1C2A22F0)
#define AKRAMP_GET_FPREV_OFFSET UNITYSDK_OFFSET(0x1C2A21E0)
#define AKRAMP_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1C2A1CB0)
#define AKRAMP_SET_FNEXT_OFFSET UNITYSDK_OFFSET(0x1C2A2260)
#define AKRAMP_SET_FPREV_OFFSET UNITYSDK_OFFSET(0x1C2A2150)
#define AKRAMP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2A2030)
#define AKRAMP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C2A20B0)
#define AKRAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2A1C90)

inline static constexpr unsigned int AkRamp_TypeDefinitionIndex = 31457;
