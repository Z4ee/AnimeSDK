...
#define AKRAMP_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18BCEEB0)
#define AKRAMP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BCEDC0)
#define AKRAMP_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18BCEE40)
#define AKRAMP_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18BCECB0)
#define AKRAMP_GET_FNEXT_OFFSET UNITYSDK_OFFSET(0x18BCF3A0)
#define AKRAMP_GET_FPREV_OFFSET UNITYSDK_OFFSET(0x18BCF230)
#define AKRAMP_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BCED00)
#define AKRAMP_SET_FNEXT_OFFSET UNITYSDK_OFFSET(0x18BCF2E0)
#define AKRAMP_SET_FPREV_OFFSET UNITYSDK_OFFSET(0x18BCF170)
#define AKRAMP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BCF050)
#define AKRAMP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18BCF0D0)
#define AKRAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCECA0)

inline static constexpr unsigned int AkRamp_TypeDefinitionIndex = 34517;
