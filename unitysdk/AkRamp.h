...
#define AKRAMP_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1BD75B60)
#define AKRAMP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BD75970)
#define AKRAMP_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BD75A90)
#define AKRAMP_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1BD758C0)
#define AKRAMP_GET_FNEXT_OFFSET UNITYSDK_OFFSET(0x1BD76090)
#define AKRAMP_GET_FPREV_OFFSET UNITYSDK_OFFSET(0x1BD75F20)
#define AKRAMP_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1BD75910)
#define AKRAMP_SET_FNEXT_OFFSET UNITYSDK_OFFSET(0x1BD75FD0)
#define AKRAMP_SET_FPREV_OFFSET UNITYSDK_OFFSET(0x1BD75E60)
#define AKRAMP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD75D40)
#define AKRAMP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BD75DC0)
#define AKRAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD758B0)

inline static constexpr unsigned int AkRamp_TypeDefinitionIndex = 41978;
