...
#define CLASS_1_8789FE9A7EA728A4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CDA3120)
#define CLASS_1_8789FE9A7EA728A4_CLONE_OFFSET UNITYSDK_OFFSET(0x1CDA2AD0)
#define CLASS_1_8789FE9A7EA728A4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CDA2C70)
#define CLASS_1_8789FE9A7EA728A4_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CDA2B50)
#define CLASS_1_8789FE9A7EA728A4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CDA2E20)
#define CLASS_1_8789FE9A7EA728A4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CDA3310)
#define CLASS_1_8789FE9A7EA728A4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CDA3260)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1CDA2B30)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1CDA2B20)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CDA2970)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1CDA2B10)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1CDA2B00)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1CDA2B40)
#define CLASS_1_8789FE9A7EA728A4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CDA29A0)
#define CLASS_1_8789FE9A7EA728A4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CDA2F90)
#define CLASS_1_8789FE9A7EA728A4_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CDA2FF0)
#define CLASS_1_8789FE9A7EA728A4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CDA3430)
#define CLASS_1_8789FE9A7EA728A4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CDA2A00)
#define CLASS_1_8789FE9A7EA728A4__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA29B0)

inline static constexpr unsigned int Class_1_8789FE9A7EA728A4_TypeDefinitionIndex = 26699;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8789FE9A7EA728A4_TypeDefinitionIndex)->GetStaticField(0x274F0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_8789FE9A7EA728A4*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_8789FE9A7EA728A4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8789FE9A7EA728A4_TypeDefinitionIndex)->GetStaticField(0x274F8);
	}
