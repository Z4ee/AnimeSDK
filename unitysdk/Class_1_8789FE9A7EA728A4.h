...
#define CLASS_1_8789FE9A7EA728A4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B7CD10)
#define CLASS_1_8789FE9A7EA728A4_CLONE_OFFSET UNITYSDK_OFFSET(0x19B7C8A0)
#define CLASS_1_8789FE9A7EA728A4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B7CA00)
#define CLASS_1_8789FE9A7EA728A4_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B7C920)
#define CLASS_1_8789FE9A7EA728A4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B7CAD0)
#define CLASS_1_8789FE9A7EA728A4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B7CEE0)
#define CLASS_1_8789FE9A7EA728A4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B7CE30)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19B7C8D0)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19B7C910)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19B7C740)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x19B7C900)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x19B7C8F0)
#define CLASS_1_8789FE9A7EA728A4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19B7C8E0)
#define CLASS_1_8789FE9A7EA728A4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B7C770)
#define CLASS_1_8789FE9A7EA728A4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B7CBE0)
#define CLASS_1_8789FE9A7EA728A4_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B7CC40)
#define CLASS_1_8789FE9A7EA728A4__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B7CFF0)
#define CLASS_1_8789FE9A7EA728A4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B7C7D0)
#define CLASS_1_8789FE9A7EA728A4__CTOR_OFFSET UNITYSDK_OFFSET(0x19B7C780)

inline static constexpr unsigned int Class_1_8789FE9A7EA728A4_TypeDefinitionIndex = 25106;

class Class_1_8789FE9A7EA728A4 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_8789FE9A7EA728A4*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_8789FE9A7EA728A4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8789FE9A7EA728A4_TypeDefinitionIndex)->GetStaticField(0x490A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_7()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8789FE9A7EA728A4_TypeDefinitionIndex)->GetStaticField(0x490A8);
	}
