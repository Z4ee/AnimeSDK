...
#define CLASS_1_5B567C8A01BAEDFE_307_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8A0330)
#define CLASS_1_5B567C8A01BAEDFE_307_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8A01A0)
#define CLASS_1_5B567C8A01BAEDFE_307_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8A0240)
#define CLASS_1_5B567C8A01BAEDFE_307_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8A01E0)
#define CLASS_1_5B567C8A01BAEDFE_307_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8A0290)
#define CLASS_1_5B567C8A01BAEDFE_307_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8A0380)
#define CLASS_1_5B567C8A01BAEDFE_307_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8A0350)
#define CLASS_1_5B567C8A01BAEDFE_307_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A8A0120)
#define CLASS_1_5B567C8A01BAEDFE_307_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8A0150)
#define CLASS_1_5B567C8A01BAEDFE_307_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8A02C0)
#define CLASS_1_5B567C8A01BAEDFE_307_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8A0320)
#define CLASS_1_5B567C8A01BAEDFE_307__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8A03D0)
#define CLASS_1_5B567C8A01BAEDFE_307__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8A0170)
#define CLASS_1_5B567C8A01BAEDFE_307__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A0160)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_307_TypeDefinitionIndex = 31210;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_307*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_307_TypeDefinitionIndex)->GetStaticField(0x57990);
	}
