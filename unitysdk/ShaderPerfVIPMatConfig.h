...
#define SHADERPERFVIPMATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB93BFF0)

inline static constexpr unsigned int ShaderPerfVIPMatConfig_TypeDefinitionIndex = 44226;
