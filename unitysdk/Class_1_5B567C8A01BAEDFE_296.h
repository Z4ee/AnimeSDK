...
#define CLASS_1_5B567C8A01BAEDFE_296_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E2BE2C0)
#define CLASS_1_5B567C8A01BAEDFE_296_CLONE_OFFSET UNITYSDK_OFFSET(0x1E2BDFB0)
#define CLASS_1_5B567C8A01BAEDFE_296_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E2BE0C0)
#define CLASS_1_5B567C8A01BAEDFE_296_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E2BDFF0)
#define CLASS_1_5B567C8A01BAEDFE_296_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E2BE220)
#define CLASS_1_5B567C8A01BAEDFE_296_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E2BE310)
#define CLASS_1_5B567C8A01BAEDFE_296_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E2BE2E0)
#define CLASS_1_5B567C8A01BAEDFE_296_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E2BDF30)
#define CLASS_1_5B567C8A01BAEDFE_296_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E2BDF60)
#define CLASS_1_5B567C8A01BAEDFE_296_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E2BE250)
#define CLASS_1_5B567C8A01BAEDFE_296_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E2BE2B0)
#define CLASS_1_5B567C8A01BAEDFE_296__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E2BE360)
#define CLASS_1_5B567C8A01BAEDFE_296__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E2BDF80)
#define CLASS_1_5B567C8A01BAEDFE_296__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2BDF70)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_296_TypeDefinitionIndex = 32292;

class Class_1_5B567C8A01BAEDFE_296 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_296*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_296*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_296_TypeDefinitionIndex)->GetStaticField(0x3FE10);
	}
