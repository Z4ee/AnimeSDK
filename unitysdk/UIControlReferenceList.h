...
#define UICONTROLREFERENCELIST_GETGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x143B8440)
#define UICONTROLREFERENCELIST_GETIMAGES_OFFSET UNITYSDK_OFFSET(0x143B8540)
#define UICONTROLREFERENCELIST_GETTEXTS_OFFSET UNITYSDK_OFFSET(0x143B84D0)
#define UICONTROLREFERENCELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x143B85B0)

inline static constexpr unsigned int UIControlReferenceList_TypeDefinitionIndex = 68735;
