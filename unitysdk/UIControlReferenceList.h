...
#define UICONTROLREFERENCELIST_GETGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x18B49ED0)
#define UICONTROLREFERENCELIST_GETIMAGES_OFFSET UNITYSDK_OFFSET(0x18B49FD0)
#define UICONTROLREFERENCELIST_GETTEXTS_OFFSET UNITYSDK_OFFSET(0x18B49F60)
#define UICONTROLREFERENCELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4A040)

inline static constexpr unsigned int UIControlReferenceList_TypeDefinitionIndex = 68345;
