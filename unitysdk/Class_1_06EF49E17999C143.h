...
#define CLASS_1_06EF49E17999C143_GET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x15CBE4F0)
#define CLASS_1_06EF49E17999C143_GET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x15CBE510)
#define CLASS_1_06EF49E17999C143_METHOD_1_09D518CD19A52420_OFFSET UNITYSDK_OFFSET(0x15CBF130)
#define CLASS_1_06EF49E17999C143_METHOD_1_0BBAD75CD82FF4C6_OFFSET UNITYSDK_OFFSET(0x15CBF7C0)
#define CLASS_1_06EF49E17999C143_METHOD_1_18C3B129F2E38CCF_OFFSET UNITYSDK_OFFSET(0x15CBEA60)
#define CLASS_1_06EF49E17999C143_METHOD_1_18DD7E1EED9D36D1_OFFSET UNITYSDK_OFFSET(0x15CBF360)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x15CBE400)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x15CBE3B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_2F57AE360A4E2412_OFFSET UNITYSDK_OFFSET(0x15CBF590)
#define CLASS_1_06EF49E17999C143_METHOD_1_51D2CCEAD62FAF96_OFFSET UNITYSDK_OFFSET(0x15CBECE0)
#define CLASS_1_06EF49E17999C143_METHOD_1_73B8E5A7C1BFCA1F_OFFSET UNITYSDK_OFFSET(0x15CBE360)
#define CLASS_1_06EF49E17999C143_METHOD_1_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x15CBE9F0)
#define CLASS_1_06EF49E17999C143_METHOD_1_970D5059FCBAD470_OFFSET UNITYSDK_OFFSET(0x15CBE980)
#define CLASS_1_06EF49E17999C143_METHOD_1_9B0C43B0B6D3BA9B_1_OFFSET UNITYSDK_OFFSET(0x15CBE830)
#define CLASS_1_06EF49E17999C143_METHOD_1_9B0C43B0B6D3BA9B_OFFSET UNITYSDK_OFFSET(0x15CBE600)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_1_OFFSET UNITYSDK_OFFSET(0x15CBE4A0)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_OFFSET UNITYSDK_OFFSET(0x15CBE450)
#define CLASS_1_06EF49E17999C143_METHOD_1_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0x15CBE530)
#define CLASS_1_06EF49E17999C143_METHOD_1_D08BCB51F5D3AC26_OFFSET UNITYSDK_OFFSET(0x15CBEF00)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_1_OFFSET UNITYSDK_OFFSET(0x15CBE310)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_OFFSET UNITYSDK_OFFSET(0x15CBE2C0)
#define CLASS_1_06EF49E17999C143_METHOD_1_FABFA21254FBB3C1_OFFSET UNITYSDK_OFFSET(0x15CBE910)
#define CLASS_1_06EF49E17999C143_SET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x15CBE500)
#define CLASS_1_06EF49E17999C143_SET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x15CBE520)
#define CLASS_1_06EF49E17999C143__CCTOR_OFFSET UNITYSDK_OFFSET(0x15CBFAC0)
#define CLASS_1_06EF49E17999C143__CTOR_OFFSET UNITYSDK_OFFSET(0x15CBF9F0)
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0xB0D0);
	}
	static ::System::Single* StaticGet_KLDAKHELOLK()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0xB0D4);
	}
	// static const ::System::UInt32 IIGGAHBNNCD = 0x0; // 0x0
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* NBPMENAIAPC; // 0x10
	::System::String* HMBOFKOIBFG; // 0x18
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* OKABMMEBPHE; // 0x20
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::ScreenTransferType>* FIJKLDEPEEJ; // 0x28
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* MMNCMNKAHIN; // 0x30
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* HAKFLEJNHCG; // 0x38
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* HDLGKCHPMPP; // 0x40
	::System::String* OGIICLPEECP; // 0x48
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* HILHFKIDEMJ; // 0x50
	::System::UInt32 HNPDLANHONH; // 0x58
	::System::UInt32 _EndMaskTalkSentenceID_k__BackingField; // 0x5C
	::RPG::GameCore::PerformanceChangePlayerType JGEMAMGFABJ; // 0x60
	::System::Single _EndBlackCloseDelayTime_k__BackingField; // 0x64
	::RPG::GameCore::PerformanceSkipType HLEKAACPFHP; // 0x68
	::RPG::GameCore::ELevelPerformanceType DNGFHOEACBI; // 0x6C
	::System::Boolean BALBCKJGOKC; // 0x70
