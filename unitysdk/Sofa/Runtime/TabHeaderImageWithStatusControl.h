...
#define SOFA_RUNTIME_TABHEADERIMAGEWITHSTATUSCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0xE92AB70)
#define SOFA_RUNTIME_TABHEADERIMAGEWITHSTATUSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE92B6D0)
