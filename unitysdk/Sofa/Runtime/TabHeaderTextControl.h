...
#define SOFA_RUNTIME_TABHEADERTEXTCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0xE92B830)
#define SOFA_RUNTIME_TABHEADERTEXTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE92BBA0)
