...
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHARACTERSTATUSCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x197D6130)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHARACTERSTATUSCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x197D6260)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHARACTERSTATUSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x197D6E80)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHARACTERSTATUSCONTROL__ONHPFLASHMESSAGE_OFFSET UNITYSDK_OFFSET(0x197D6C80)
