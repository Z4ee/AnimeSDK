...
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHILDDETAILCONTROL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x197D72C0)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHILDDETAILCONTROL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x197D7300)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_CHILDDETAILCONTROL___C___BINDING_B__2_0_OFFSET UNITYSDK_OFFSET(0x197D7310)
...
namespace Sofa::Runtime::ReactiveBinding::Example
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_BEC5D8EEC9856D94*, ::R3::Observable_1<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ChildDetailControl___c_TypeDefinitionIndex)->GetStaticField(0x54CC0);
		}
		static ::Sofa::Runtime::ReactiveBinding::Example::ChildDetailControl___c** StaticGet___9()
		{
			return (::Sofa::Runtime::ReactiveBinding::Example::ChildDetailControl___c**)Il2CppClass::FromTypeDefinitionIndex(ChildDetailControl___c_TypeDefinitionIndex)->GetStaticField(0x54CC8);
		}
