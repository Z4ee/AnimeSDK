...
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_PICKLISTTITLEPANELCONTROL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x197D9260)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_PICKLISTTITLEPANELCONTROL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x197D92A0)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_PICKLISTTITLEPANELCONTROL___C___BINDING_B__2_0_OFFSET UNITYSDK_OFFSET(0x197D92B0)
...
namespace Sofa::Runtime::ReactiveBinding::Example
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_CBA7B3188733D983*, ::R3::Observable_1<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(PickListTitlePanelControl___c_TypeDefinitionIndex)->GetStaticField(0x55630);
		}
		static ::Sofa::Runtime::ReactiveBinding::Example::PickListTitlePanelControl___c** StaticGet___9()
		{
			return (::Sofa::Runtime::ReactiveBinding::Example::PickListTitlePanelControl___c**)Il2CppClass::FromTypeDefinitionIndex(PickListTitlePanelControl___c_TypeDefinitionIndex)->GetStaticField(0x55638);
		}
