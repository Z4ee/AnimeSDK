...
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_PARENTPANELCONTROL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x197D8EC0)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_PARENTPANELCONTROL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x197D8F00)
#define SOFA_RUNTIME_REACTIVEBINDING_EXAMPLE_PARENTPANELCONTROL___C___BINDING_B__3_0_OFFSET UNITYSDK_OFFSET(0x197D8F10)
...
namespace Sofa::Runtime::ReactiveBinding::Example
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_F9FBCC956DFCF137_3*, ::Class_1_BEC5D8EEC9856D94*>**)Il2CppClass::FromTypeDefinitionIndex(ParentPanelControl___c_TypeDefinitionIndex)->GetStaticField(0x555F0);
		}
		static ::Sofa::Runtime::ReactiveBinding::Example::ParentPanelControl___c** StaticGet___9()
		{
			return (::Sofa::Runtime::ReactiveBinding::Example::ParentPanelControl___c**)Il2CppClass::FromTypeDefinitionIndex(ParentPanelControl___c_TypeDefinitionIndex)->GetStaticField(0x555F8);
		}
