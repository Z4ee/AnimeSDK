...
#define SOFA_RUNTIME_REACTIVEBINDING_EDITOR_SOFAUIDEVMAIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x197D0B10)
#define SOFA_RUNTIME_REACTIVEBINDING_EDITOR_SOFAUIDEVMAIN_START_OFFSET UNITYSDK_OFFSET(0x197D02B0)
#define SOFA_RUNTIME_REACTIVEBINDING_EDITOR_SOFAUIDEVMAIN_UPDATE_OFFSET UNITYSDK_OFFSET(0x197D0950)
#define SOFA_RUNTIME_REACTIVEBINDING_EDITOR_SOFAUIDEVMAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x197D0BF0)
