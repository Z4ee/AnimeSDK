...
#define SOFA_RUNTIME_TABHEADERTEXTWITHSTATUSCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0xE92BD70)
#define SOFA_RUNTIME_TABHEADERTEXTWITHSTATUSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE92C7C0)
