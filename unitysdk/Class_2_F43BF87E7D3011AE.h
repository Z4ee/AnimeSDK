...
#define CLASS_2_F43BF87E7D3011AE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1889D630)
#define CLASS_2_F43BF87E7D3011AE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1889D370)
#define CLASS_2_F43BF87E7D3011AE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1889D5E0)
#define CLASS_2_F43BF87E7D3011AE_TICK_OFFSET UNITYSDK_OFFSET(0x1889D670)
#define CLASS_2_F43BF87E7D3011AE__CTOR_OFFSET UNITYSDK_OFFSET(0x1889D360)

inline static constexpr unsigned int Class_2_F43BF87E7D3011AE_TypeDefinitionIndex = 55637;

class Class_2_F43BF87E7D3011AE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyCreateWorld* Field_2_0; // 0x18
