...
#define SCENECAMERAPOSITIONSSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xABBC500)

inline static constexpr unsigned int SceneCameraPositionsScriptableObject_TypeDefinitionIndex = 38025;
