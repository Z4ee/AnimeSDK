...
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_0475BF03848254F8_OFFSET UNITYSDK_OFFSET(0xB6EC0F0)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_1AD7BD80EF0FCE8B_OFFSET UNITYSDK_OFFSET(0xB6EBB10)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0xB6EBC60)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_48BE40EDE06FB381_OFFSET UNITYSDK_OFFSET(0xB6EC1A0)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_5574E6B244C57D1D_OFFSET UNITYSDK_OFFSET(0xB6EACC0)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_5A30DCA22339BFF6_OFFSET UNITYSDK_OFFSET(0xB6EB070)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_5BD7248EB848DE2B_OFFSET UNITYSDK_OFFSET(0xB6EAC70)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_7E4FEE322D0EA011_OFFSET UNITYSDK_OFFSET(0xB6EB480)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0xB6EAC20)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_AF31536844A77D0C_OFFSET UNITYSDK_OFFSET(0xB6EB310)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_B9A97467188E4B69_OFFSET UNITYSDK_OFFSET(0xB6EAE70)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_D240830C442C70A4_OFFSET UNITYSDK_OFFSET(0xB6EBA00)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_E3699D3CFBFD02B9_OFFSET UNITYSDK_OFFSET(0xB6EB5F0)
#define CLASS_1_CE91B9CF6CB59927_METHOD_1_FFAD8F7B4A021715_OFFSET UNITYSDK_OFFSET(0xB6EBBA0)
#define CLASS_1_CE91B9CF6CB59927__CCTOR_OFFSET UNITYSDK_OFFSET(0xB6EC320)
#define CLASS_1_CE91B9CF6CB59927__CTOR_OFFSET UNITYSDK_OFFSET(0xB6EADD0)

inline static constexpr unsigned int Class_1_CE91B9CF6CB59927_TypeDefinitionIndex = 74297;
...
public:
	...
	{
		return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CE91B9CF6CB59927_TypeDefinitionIndex)->GetStaticField(0x151E0);
	}
	static ::RPG::Client::TextID* StaticGet_HKAHOGLBKKA()
	{
		return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CE91B9CF6CB59927_TypeDefinitionIndex)->GetStaticField(0x151F0);
	}
	static ::RPG::Client::TextID* StaticGet_AEKPBJAFKKC()
	{
		return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CE91B9CF6CB59927_TypeDefinitionIndex)->GetStaticField(0x15200);
	}
