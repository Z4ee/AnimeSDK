...
#define CLASS_4_5F1E6D33718F4B0D_METHOD_4_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1561DE10)
#define CLASS_4_5F1E6D33718F4B0D_METHOD_4_40584B80B8904706_OFFSET UNITYSDK_OFFSET(0x1561D8D0)
#define CLASS_4_5F1E6D33718F4B0D_METHOD_4_7829C51DA0CC822B_OFFSET UNITYSDK_OFFSET(0x1561D500)
#define CLASS_4_5F1E6D33718F4B0D_METHOD_4_7B35E153EF3BACD3_OFFSET UNITYSDK_OFFSET(0x1561D860)
#define CLASS_4_5F1E6D33718F4B0D_METHOD_4_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1561DED0)
#define CLASS_4_5F1E6D33718F4B0D__CTOR_OFFSET UNITYSDK_OFFSET(0x1561DF50)
#define CLASS_4_5F1E6D33718F4B0D__ONBIND_OFFSET UNITYSDK_OFFSET(0x1561D430)

inline static constexpr unsigned int Class_4_5F1E6D33718F4B0D_TypeDefinitionIndex = 71647;
...
public:
	...
	::UnityEngine::UI::Image* KNJNMFKACAN; // 0x150
	::UnityEngine::UI::Image* LIDNLCGBDNG; // 0x158
	::UnityEngine::UI::Image* LFAMDJJAPJK; // 0x160
	::UnityEngine::UI::Image* KMBOKCMHBBC; // 0x168
