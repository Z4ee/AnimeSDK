...
#define CLASS_2_05FCCD31C8DF71C6_CHECKSTREAMINGLOD_OFFSET UNITYSDK_OFFSET(0x15210F00)
#define CLASS_2_05FCCD31C8DF71C6_CHECKSTREAMING_OFFSET UNITYSDK_OFFSET(0x15210C00)
#define CLASS_2_05FCCD31C8DF71C6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1520C8C0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_176FFA50C1F3821C_OFFSET UNITYSDK_OFFSET(0x1520EA20)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_28D8EC4589B1C4B8_OFFSET UNITYSDK_OFFSET(0x1520FDE0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_3407EE44BF43A6A4_OFFSET UNITYSDK_OFFSET(0x1520CBE0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_356A8AB268440A1F_OFFSET UNITYSDK_OFFSET(0x15211010)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_3F3693110F25FD62_OFFSET UNITYSDK_OFFSET(0x1520CAC0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_5DE00ED3D9EFB4BA_OFFSET UNITYSDK_OFFSET(0x15210000)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_75DEE7A74EA0F7C2_OFFSET UNITYSDK_OFFSET(0x1520FEC0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_8D68E1C80950460F_OFFSET UNITYSDK_OFFSET(0x1520DB70)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_93E37F35EE782FFC_OFFSET UNITYSDK_OFFSET(0x1520F6C0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_A877DE024E06B561_OFFSET UNITYSDK_OFFSET(0x15210CC0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_BA9FCEE8D9831F4F_OFFSET UNITYSDK_OFFSET(0x1520D300)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_BEAE9B9FA494D648_OFFSET UNITYSDK_OFFSET(0x1520E150)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_BFA195F09950C507_OFFSET UNITYSDK_OFFSET(0x1520F5B0)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_C7D0E24443F285BF_OFFSET UNITYSDK_OFFSET(0x15210960)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_E44FD2AE32DFF0AA_OFFSET UNITYSDK_OFFSET(0x1520DA40)
#define CLASS_2_05FCCD31C8DF71C6_METHOD_2_FEF999131EAD8C08_OFFSET UNITYSDK_OFFSET(0x1520E420)
#define CLASS_2_05FCCD31C8DF71C6_QUADTREEOP_OFFSET UNITYSDK_OFFSET(0x15210B60)
#define CLASS_2_05FCCD31C8DF71C6__CCTOR_OFFSET UNITYSDK_OFFSET(0x152110B0)
#define CLASS_2_05FCCD31C8DF71C6__CTOR_OFFSET UNITYSDK_OFFSET(0x1520C500)
#define CLASS_2_05FCCD31C8DF71C6__SOLVEINSTANCELODCALC_OFFSET UNITYSDK_OFFSET(0x152104C0)

inline static constexpr unsigned int Class_2_05FCCD31C8DF71C6_TypeDefinitionIndex = 73744;
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_2_05FCCD31C8DF71C6_TypeDefinitionIndex)->GetStaticField(0x56B20);
	}
	::RPG::Client::OpenWorld::CellStruct_1<::RPG::Client::OpenWorld::StreamingItemData*>* HGDDMHIPHIB; // 0x170
	::System::Collections::Generic::List_1<::RPG::Client::OpenWorld::StreamingItemData*>* KIHCPNIAIPO; // 0x178
	::Class_2_05FCCD31C8DF71C6_Class_1_DF49782B75FABBCB* JBFHLLICIFK; // 0x180
	::System::Collections::Generic::List_1<::System::Tuple_2<::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::GameObject*>*>* ECICLILIDJJ; // 0x188
	::System::Collections::Generic::Dictionary_2<::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::GameObject*>* KBLOKGOGPPK; // 0x190
	::Class_2_05FCCD31C8DF71C6_Class_1_DF49782B75FABBCB* GKPGMBLHBCF; // 0x198
	::Class_2_05FCCD31C8DF71C6_Class_1_DF49782B75FABBCB* ADBOANJGCCK; // 0x1A0
	::Class_1_166E0F5C448FE77D* CMPEGHAGBDC; // 0x1A8
