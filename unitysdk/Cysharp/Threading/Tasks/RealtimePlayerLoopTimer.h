...
#define CYSHARP_THREADING_TASKS_REALTIMEPLAYERLOOPTIMER_MOVENEXTCORE_OFFSET UNITYSDK_OFFSET(0x1EA5C160)
#define CYSHARP_THREADING_TASKS_REALTIMEPLAYERLOOPTIMER_RESETCORE_OFFSET UNITYSDK_OFFSET(0x1EA5C040)
#define CYSHARP_THREADING_TASKS_REALTIMEPLAYERLOOPTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA5BB90)
...
namespace Cysharp::Threading::Tasks
{
	...
	{
	public:
		::Cysharp::Threading::Tasks::Internal::ValueStopwatch stopwatch; // 0x30
		::System::Int64 intervalTicks; // 0x38
