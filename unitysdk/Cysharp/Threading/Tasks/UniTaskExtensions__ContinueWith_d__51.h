...
#define CYSHARP_THREADING_TASKS_UNITASKEXTENSIONS__CONTINUEWITH_D__51_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9D7F80)
#define CYSHARP_THREADING_TASKS_UNITASKEXTENSIONS__CONTINUEWITH_D__51_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTaskExtensions__ContinueWith_d__51_TypeDefinitionIndex = 28645;

	struct alignas(8) UniTaskExtensions__ContinueWith_d__51
	{
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x10
		::System::Action* continuationFunction; // 0x20
