...
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EA4D880)
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EA4D930)
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENEQUALITYCOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA4D9A0)
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA4D990)
...
namespace Cysharp::Threading::Tasks
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::IEqualityComparer_1<::System::Threading::CancellationToken>**)Il2CppClass::FromTypeDefinitionIndex(CancellationTokenEqualityComparer_TypeDefinitionIndex)->GetStaticField(0x55930);
		}
