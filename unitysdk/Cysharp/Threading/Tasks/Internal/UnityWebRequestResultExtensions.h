...
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYWEBREQUESTRESULTEXTENSIONS_ISERROR_OFFSET UNITYSDK_OFFSET(0x1FA4B6A0)

namespace Cysharp::Threading::Tasks::Internal
{
	inline static constexpr unsigned int UnityWebRequestResultExtensions_TypeDefinitionIndex = 32107;
