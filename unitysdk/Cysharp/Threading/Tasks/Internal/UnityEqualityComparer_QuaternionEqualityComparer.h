...
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_QUATERNIONEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D750E50)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_QUATERNIONEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D750F30)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_QUATERNIONEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D750910)
