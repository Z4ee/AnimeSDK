...
#define CYSHARP_THREADING_TASKS_INTERNAL_CONTINUATIONQUEUE_ENQUEUEWITHUSERDATA_OFFSET UNITYSDK_OFFSET(0x1E80D2A0)
#define CYSHARP_THREADING_TASKS_INTERNAL_CONTINUATIONQUEUE_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x1E80CFD0)
#define CYSHARP_THREADING_TASKS_INTERNAL_CONTINUATIONQUEUE_RUNCORE_OFFSET UNITYSDK_OFFSET(0x1E80D7D0)
#define CYSHARP_THREADING_TASKS_INTERNAL_CONTINUATIONQUEUE_RUN_OFFSET UNITYSDK_OFFSET(0x1E80D7C0)
#define CYSHARP_THREADING_TASKS_INTERNAL_CONTINUATIONQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E80CF10)

namespace Cysharp::Threading::Tasks::Internal
{
	inline static constexpr unsigned int ContinuationQueue_TypeDefinitionIndex = 31473;

	class ContinuationQueue : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Object*>* userdata; // 0x10
		::Il2CppArray<::System::Action_1<::System::Object*>*>* userdataWaitingList; // 0x18
		::Il2CppArray<::System::Object*>* userdataWaiting; // 0x20
		::Il2CppArray<::System::Action_1<::System::Object*>*>* userdataActionList; // 0x28
		::Il2CppArray<::System::Action*>* waitingList; // 0x30
		::Il2CppArray<::System::Action*>* actionList; // 0x38
		::System::Boolean dequing; // 0x40
		::System::Int32 userdataWaitingListCount; // 0x44
		::System::Threading::SpinLock gate; // 0x48
		::System::Int32 userdataActionListCount; // 0x4C
		::System::Int32 actionListCount; // 0x50
		::Cysharp::Threading::Tasks::PlayerLoopTiming timing; // 0x54
		::System::Int32 waitingListCount; // 0x58
