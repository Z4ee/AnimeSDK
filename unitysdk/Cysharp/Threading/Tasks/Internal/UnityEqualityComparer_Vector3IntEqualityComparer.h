...
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_VECTOR3INTEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D750BA0)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_VECTOR3INTEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D750C60)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_VECTOR3INTEQUALITYCOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D751360)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_VECTOR3INTEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D750930)
...
namespace Cysharp::Threading::Tasks::Internal
{
	...
	public:
		...
		{
			return (::Cysharp::Threading::Tasks::Internal::UnityEqualityComparer_Vector3IntEqualityComparer**)Il2CppClass::FromTypeDefinitionIndex(UnityEqualityComparer_Vector3IntEqualityComparer_TypeDefinitionIndex)->GetStaticField(0x61B50);
		}
