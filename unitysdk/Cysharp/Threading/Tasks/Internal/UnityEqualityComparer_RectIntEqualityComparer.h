...
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_RECTINTEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D751130)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_RECTINTEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D751160)
#define CYSHARP_THREADING_TASKS_INTERNAL_UNITYEQUALITYCOMPARER_RECTINTEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D750950)
