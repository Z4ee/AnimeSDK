...
{
	inline static constexpr unsigned int TakeWhileIntAwaitWithCancellation_1_TypeDefinitionIndex = 44530;

	template <typename TSource>
	class TakeWhileIntAwaitWithCancellation_1 : public ::System::Object
	{
	public:
