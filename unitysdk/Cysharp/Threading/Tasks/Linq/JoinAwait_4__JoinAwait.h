...
{
	inline static constexpr unsigned int JoinAwait_4__JoinAwait_TypeDefinitionIndex = 44266;

	template <typename TOuter, typename TInner, typename TKey, typename TResult>
	class JoinAwait_4__JoinAwait : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		static ::System::Action_1<::System::Object*>** StaticGet_MoveNextCoreDelegate()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(JoinAwait_4__JoinAwait_TypeDefinitionIndex)->GetStaticField(0x0);
		}
		...
		::System::Func_3<TOuter, TInner, ::Cysharp::Threading::Tasks::UniTask_1<TResult>>* resultSelector; // 0x0
