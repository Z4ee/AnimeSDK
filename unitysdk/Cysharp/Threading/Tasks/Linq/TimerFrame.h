...
#define CYSHARP_THREADING_TASKS_LINQ_TIMERFRAME_GETASYNCENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CE63D10)
#define CYSHARP_THREADING_TASKS_LINQ_TIMERFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE63CF0)
