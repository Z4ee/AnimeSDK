...
{
	inline static constexpr unsigned int DistinctAwaitWithCancellation_2_TypeDefinitionIndex = 44203;

	template <typename TSource, typename TKey>
	class DistinctAwaitWithCancellation_2 : public ::System::Object
	{
	public:
