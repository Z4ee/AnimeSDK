...
{
	inline static constexpr unsigned int Max__MaxAsync_d__0_1_TypeDefinitionIndex = 44282;

	template <typename TSource>
	struct Max__MaxAsync_d__0_1
	{
		...
		TSource _value_5__2; // 0x0
		::System::Collections::Generic::Comparer_1<TSource>* _comparer_5__3; // 0x0
