...
#define CYSHARP_THREADING_TASKS_LINQ_MIN__MINASYNC_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BBB930)
#define CYSHARP_THREADING_TASKS_LINQ_MIN__MINASYNC_D__36_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x10F00)
