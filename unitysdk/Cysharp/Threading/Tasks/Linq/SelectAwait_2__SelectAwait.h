...
{
	inline static constexpr unsigned int SelectAwait_2__SelectAwait_TypeDefinitionIndex = 44417;

	template <typename TSource, typename TResult>
	class SelectAwait_2__SelectAwait : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<TSource>* source; // 0x0
		::System::Func_2<TSource, ::Cysharp::Threading::Tasks::UniTask_1<TResult>>* selector; // 0x0
