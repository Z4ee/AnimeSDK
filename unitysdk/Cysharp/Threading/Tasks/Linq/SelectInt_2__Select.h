...
{
	inline static constexpr unsigned int SelectInt_2__Select_TypeDefinitionIndex = 44415;

	template <typename TSource, typename TResult>
	class SelectInt_2__Select : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
