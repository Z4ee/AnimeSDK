...
{
	inline static constexpr unsigned int Max__MaxAwaitWithCancellationAsync_d__31_1_TypeDefinitionIndex = 44321;

	template <typename TSource>
	struct Max__MaxAwaitWithCancellationAsync_d__31_1
	{
