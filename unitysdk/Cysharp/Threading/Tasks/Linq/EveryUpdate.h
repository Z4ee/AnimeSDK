...
#define CYSHARP_THREADING_TASKS_LINQ_EVERYUPDATE_GETASYNCENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EA36600)
#define CYSHARP_THREADING_TASKS_LINQ_EVERYUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA365F0)
