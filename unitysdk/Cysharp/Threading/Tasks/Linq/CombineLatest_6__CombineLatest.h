...
{
	inline static constexpr unsigned int CombineLatest_6__CombineLatest_TypeDefinitionIndex = 44146;

	template <typename T1, typename T2, typename T3, typename T4, typename T5, typename TResult>
	class CombineLatest_6__CombineLatest : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		static ::System::Action_1<::System::Object*>** StaticGet_Completed1Delegate()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(CombineLatest_6__CombineLatest_TypeDefinitionIndex)->GetStaticField(0x0);
		}
		...
		// static const ::System::Int32 CompleteCount = 0x5; // 0x0
		...
		::System::Func_6<T1, T2, T3, T4, T5, TResult>* resultSelector; // 0x0
