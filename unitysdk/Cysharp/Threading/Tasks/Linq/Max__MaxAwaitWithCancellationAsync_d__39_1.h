...
{
	inline static constexpr unsigned int Max__MaxAwaitWithCancellationAsync_d__39_1_TypeDefinitionIndex = 44323;

	template <typename TSource>
	struct Max__MaxAwaitWithCancellationAsync_d__39_1
	{
