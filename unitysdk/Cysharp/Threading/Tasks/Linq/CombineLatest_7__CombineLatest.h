...
{
	inline static constexpr unsigned int CombineLatest_7__CombineLatest_TypeDefinitionIndex = 44149;

	template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename TResult>
	class CombineLatest_7__CombineLatest : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		static ::System::Action_1<::System::Object*>** StaticGet_Completed1Delegate()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(CombineLatest_7__CombineLatest_TypeDefinitionIndex)->GetStaticField(0x0);
		}
		...
		// static const ::System::Int32 CompleteCount = 0x6; // 0x0
