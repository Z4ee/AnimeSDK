...
{
	inline static constexpr unsigned int SkipWhileAwaitWithCancellation_1_TypeDefinitionIndex = 44457;

	template <typename TSource>
	class SkipWhileAwaitWithCancellation_1 : public ::System::Object
	{
	public:
