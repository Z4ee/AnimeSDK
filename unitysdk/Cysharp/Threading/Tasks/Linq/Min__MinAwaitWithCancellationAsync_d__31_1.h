...
{
	inline static constexpr unsigned int Min__MinAwaitWithCancellationAsync_d__31_1_TypeDefinitionIndex = 44370;

	template <typename TSource>
	struct Min__MinAwaitWithCancellationAsync_d__31_1
	{
