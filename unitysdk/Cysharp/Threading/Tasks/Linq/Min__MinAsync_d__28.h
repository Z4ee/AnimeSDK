...
#define CYSHARP_THREADING_TASKS_LINQ_MIN__MINASYNC_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BBB910)
#define CYSHARP_THREADING_TASKS_LINQ_MIN__MINASYNC_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x10F00)
