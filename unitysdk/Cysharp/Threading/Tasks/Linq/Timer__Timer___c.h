...
#define CYSHARP_THREADING_TASKS_LINQ_TIMER__TIMER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE63C20)
#define CYSHARP_THREADING_TASKS_LINQ_TIMER__TIMER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE63C60)
#define CYSHARP_THREADING_TASKS_LINQ_TIMER__TIMER___C___CTOR_B__11_0_OFFSET UNITYSDK_OFFSET(0x1CE63C70)
