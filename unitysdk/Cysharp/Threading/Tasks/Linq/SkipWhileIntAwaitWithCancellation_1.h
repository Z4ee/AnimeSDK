...
{
	inline static constexpr unsigned int SkipWhileIntAwaitWithCancellation_1_TypeDefinitionIndex = 44459;

	template <typename TSource>
	class SkipWhileIntAwaitWithCancellation_1 : public ::System::Object
	{
	public:
