...
{
	inline static constexpr unsigned int ToLookup_Lookup_2__CreateAsync_d__6_TypeDefinitionIndex = 44549;

	template <typename TKey, typename TElement>
	struct ToLookup_Lookup_2__CreateAsync_d__6
	{
		...
		::System::ArraySegment_1<TElement> source; // 0x0
		...
		::Il2CppArray<TElement>* _arr_5__3; // 0x0
