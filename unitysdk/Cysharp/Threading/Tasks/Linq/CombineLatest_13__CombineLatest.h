...
{
	inline static constexpr unsigned int CombineLatest_13__CombineLatest_TypeDefinitionIndex = 44167;
	...
	class CombineLatest_13__CombineLatest : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		static ::System::Action_1<::System::Object*>** StaticGet_Completed1Delegate()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(CombineLatest_13__CombineLatest_TypeDefinitionIndex)->GetStaticField(0x0);
		}
		...
		// static const ::System::Int32 CompleteCount = 0xC; // 0x0
		...
		::System::Func_13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>* resultSelector; // 0x0
