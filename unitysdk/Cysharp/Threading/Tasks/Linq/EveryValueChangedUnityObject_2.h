...
{
	inline static constexpr unsigned int EveryValueChangedUnityObject_2_TypeDefinitionIndex = 44576;

	template <typename TTarget, typename TProperty>
	class EveryValueChangedUnityObject_2 : public ::System::Object
	{
	public:
		TTarget target; // 0x0
