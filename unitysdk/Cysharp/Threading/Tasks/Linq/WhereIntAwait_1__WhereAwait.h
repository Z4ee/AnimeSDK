...
{
	inline static constexpr unsigned int WhereIntAwait_1__WhereAwait_TypeDefinitionIndex = 44595;

	template <typename TSource>
	class WhereIntAwait_1__WhereAwait : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
