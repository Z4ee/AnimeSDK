...
{
	inline static constexpr unsigned int TakeWhileAwaitWithCancellation_1_TypeDefinitionIndex = 44528;

	template <typename TSource>
	class TakeWhileAwaitWithCancellation_1 : public ::System::Object
	{
	public:
