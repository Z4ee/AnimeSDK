...
{
	inline static constexpr unsigned int Min__MinAwaitWithCancellationAsync_d__39_1_TypeDefinitionIndex = 44372;

	template <typename TSource>
	struct Min__MinAwaitWithCancellationAsync_d__39_1
	{
