...
{
	inline static constexpr unsigned int Average__AverageAwaitWithCancellationAsync_d__35_1_TypeDefinitionIndex = 44127;

	template <typename TSource>
	struct Average__AverageAwaitWithCancellationAsync_d__35_1
	{
