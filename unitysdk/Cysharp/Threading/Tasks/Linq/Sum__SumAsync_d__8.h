...
#define CYSHARP_THREADING_TASKS_LINQ_SUM__SUMASYNC_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BBBA00)
#define CYSHARP_THREADING_TASKS_LINQ_SUM__SUMASYNC_D__8_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x10F00)
