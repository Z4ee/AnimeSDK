...
#define CYSHARP_THREADING_TASKS_LINQ_MAX__MAXASYNC_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BA9130)
#define CYSHARP_THREADING_TASKS_LINQ_MAX__MAXASYNC_D__16_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1020)
