...
{
	inline static constexpr unsigned int WhereAwaitWithCancellation_1__WhereAwaitWithCancellation_TypeDefinitionIndex = 44597;

	template <typename TSource>
	class WhereAwaitWithCancellation_1__WhereAwaitWithCancellation : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
