...
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CE4C6F0)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_2_OFFSET UNITYSDK_OFFSET(0x1CE4C790)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_3_OFFSET UNITYSDK_OFFSET(0x1CE4C820)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_4_OFFSET UNITYSDK_OFFSET(0x1CE4C8B0)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_5_OFFSET UNITYSDK_OFFSET(0x1CE4C950)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_6_OFFSET UNITYSDK_OFFSET(0x1CE4C9F0)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_7_OFFSET UNITYSDK_OFFSET(0x1CE4CA90)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_8_OFFSET UNITYSDK_OFFSET(0x1CE4CB20)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_9_OFFSET UNITYSDK_OFFSET(0x1CE4CBC0)
#define CYSHARP_THREADING_TASKS_LINQ_AVERAGE_AVERAGEASYNC_OFFSET UNITYSDK_OFFSET(0x1CE4C660)
