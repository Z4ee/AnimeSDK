...
#define CYSHARP_THREADING_TASKS_LINQ_TIMERFRAME__TIMERFRAME___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE644F0)
#define CYSHARP_THREADING_TASKS_LINQ_TIMERFRAME__TIMERFRAME___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE64530)
#define CYSHARP_THREADING_TASKS_LINQ_TIMERFRAME__TIMERFRAME___C___CTOR_B__9_0_OFFSET UNITYSDK_OFFSET(0x1CE64540)
