...
#define CYSHARP_THREADING_TASKS_LINQ_RANGE_GETASYNCENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EA43460)
#define CYSHARP_THREADING_TASKS_LINQ_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA43450)
