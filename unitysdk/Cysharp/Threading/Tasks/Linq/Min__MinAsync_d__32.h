...
#define CYSHARP_THREADING_TASKS_LINQ_MIN__MINASYNC_D__32_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BA9210)
#define CYSHARP_THREADING_TASKS_LINQ_MIN__MINASYNC_D__32_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1020)
