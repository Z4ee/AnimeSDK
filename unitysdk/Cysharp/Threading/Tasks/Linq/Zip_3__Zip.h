...
{
	inline static constexpr unsigned int Zip_3__Zip_TypeDefinitionIndex = 44601;

	template <typename TFirst, typename TSecond, typename TResult>
	class Zip_3__Zip : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		static ::System::Action_1<::System::Object*>** StaticGet_firstMoveNextCoreDelegate()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(Zip_3__Zip_TypeDefinitionIndex)->GetStaticField(0x0);
		}
