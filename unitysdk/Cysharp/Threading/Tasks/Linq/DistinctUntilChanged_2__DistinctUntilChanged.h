...
{
	inline static constexpr unsigned int DistinctUntilChanged_2__DistinctUntilChanged_TypeDefinitionIndex = 44208;

	template <typename TSource, typename TKey>
	class DistinctUntilChanged_2__DistinctUntilChanged : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
