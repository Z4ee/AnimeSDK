...
#define CYSHARP_THREADING_TASKS_LINQ_MAX__MAXASYNC_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BA91A0)
#define CYSHARP_THREADING_TASKS_LINQ_MAX__MAXASYNC_D__40_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1020)
