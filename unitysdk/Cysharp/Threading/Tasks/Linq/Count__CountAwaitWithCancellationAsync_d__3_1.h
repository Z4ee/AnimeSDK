...
{
	inline static constexpr unsigned int Count__CountAwaitWithCancellationAsync_d__3_1_TypeDefinitionIndex = 44188;

	template <typename TSource>
	struct Count__CountAwaitWithCancellationAsync_d__3_1
	{
