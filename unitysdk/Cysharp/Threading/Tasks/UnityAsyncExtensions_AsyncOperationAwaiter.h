...
#define CYSHARP_THREADING_TASKS_UNITYASYNCEXTENSIONS_ASYNCOPERATIONAWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0x3BB8570)
#define CYSHARP_THREADING_TASKS_UNITYASYNCEXTENSIONS_ASYNCOPERATIONAWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BB82B0)
#define CYSHARP_THREADING_TASKS_UNITYASYNCEXTENSIONS_ASYNCOPERATIONAWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BB85F0)
#define CYSHARP_THREADING_TASKS_UNITYASYNCEXTENSIONS_ASYNCOPERATIONAWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BB85F0)
#define CYSHARP_THREADING_TASKS_UNITYASYNCEXTENSIONS_ASYNCOPERATIONAWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79420)
