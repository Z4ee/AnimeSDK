...
{
	inline static constexpr unsigned int UniTask__RunOnThreadPool_d__90_1_TypeDefinitionIndex = 42773;

	template <typename T>
	struct UniTask__RunOnThreadPool_d__90_1
	{
		...
		::System::Func_2<::System::Object*, ::Cysharp::Threading::Tasks::UniTask_1<T>>* func; // 0x0
