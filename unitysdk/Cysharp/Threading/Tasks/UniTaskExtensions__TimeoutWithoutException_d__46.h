...
#define CYSHARP_THREADING_TASKS_UNITASKEXTENSIONS__TIMEOUTWITHOUTEXCEPTION_D__46_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BA9E10)
#define CYSHARP_THREADING_TASKS_UNITASKEXTENSIONS__TIMEOUTWITHOUTEXCEPTION_D__46_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1020)
...
namespace Cysharp::Threading::Tasks
{
	...
	struct alignas(8) UniTaskExtensions__TimeoutWithoutException_d__46
	{
		...
		::Cysharp::Threading::Tasks::UniTask task; // 0x40
		::System::Threading::CancellationTokenSource* taskCancellationTokenSource; // 0x50
		::System::Threading::CancellationTokenSource* _delayCancellationTokenSource_5__2; // 0x58
