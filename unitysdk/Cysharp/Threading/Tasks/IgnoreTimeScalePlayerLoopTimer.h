...
#define CYSHARP_THREADING_TASKS_IGNORETIMESCALEPLAYERLOOPTIMER_MOVENEXTCORE_OFFSET UNITYSDK_OFFSET(0x1EA51D80)
#define CYSHARP_THREADING_TASKS_IGNORETIMESCALEPLAYERLOOPTIMER_RESETCORE_OFFSET UNITYSDK_OFFSET(0x1EA51C00)
#define CYSHARP_THREADING_TASKS_IGNORETIMESCALEPLAYERLOOPTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA51BB0)
