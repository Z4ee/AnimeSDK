...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCSERVERINITIALIZEDTRIGGER_GETONSERVERINITIALIZEDASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1FA4C4E0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCSERVERINITIALIZEDTRIGGER_GETONSERVERINITIALIZEDASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1FA4C430)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCSERVERINITIALIZEDTRIGGER_ONSERVERINITIALIZEDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1FA4C690)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCSERVERINITIALIZEDTRIGGER_ONSERVERINITIALIZEDASYNC_OFFSET UNITYSDK_OFFSET(0x1FA4C540)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCSERVERINITIALIZEDTRIGGER_ONSERVERINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1FA4C410)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCSERVERINITIALIZEDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA4C7A0)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncServerInitializedTrigger_TypeDefinitionIndex = 32031;
