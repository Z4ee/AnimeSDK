...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEGINDRAGTRIGGER_GETONBEGINDRAGASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1C4D88A0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEGINDRAGTRIGGER_GETONBEGINDRAGASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1C4D87D0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEGINDRAGTRIGGER_ONBEGINDRAGASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C4D8A70)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEGINDRAGTRIGGER_ONBEGINDRAGASYNC_OFFSET UNITYSDK_OFFSET(0x1C4D8900)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEGINDRAGTRIGGER_UNITYENGINE_EVENTSYSTEMS_IBEGINDRAGHANDLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1C4D8760)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEGINDRAGTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4D8B90)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncBeginDragTrigger_TypeDefinitionIndex = 28781;
