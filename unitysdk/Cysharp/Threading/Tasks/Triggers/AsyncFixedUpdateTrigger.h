...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCFIXEDUPDATETRIGGER_FIXEDUPDATEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D75F520)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCFIXEDUPDATETRIGGER_FIXEDUPDATEASYNC_OFFSET UNITYSDK_OFFSET(0x1D75F380)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCFIXEDUPDATETRIGGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1D75F270)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCFIXEDUPDATETRIGGER_GETFIXEDUPDATEASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1D75F320)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCFIXEDUPDATETRIGGER_GETFIXEDUPDATEASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1D75F280)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCFIXEDUPDATETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D75F690)
