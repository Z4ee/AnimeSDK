...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBECAMEVISIBLETRIGGER_GETONBECAMEVISIBLEASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1E78BD30)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBECAMEVISIBLETRIGGER_GETONBECAMEVISIBLEASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1E78BC80)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBECAMEVISIBLETRIGGER_ONBECAMEVISIBLEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1E78BEF0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBECAMEVISIBLETRIGGER_ONBECAMEVISIBLEASYNC_OFFSET UNITYSDK_OFFSET(0x1E78BD90)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBECAMEVISIBLETRIGGER_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1E78BC60)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBECAMEVISIBLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E78C000)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncBecameVisibleTrigger_TypeDefinitionIndex = 31341;
