...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAPPLICATIONPAUSETRIGGER_GETONAPPLICATIONPAUSEASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1D757FD0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAPPLICATIONPAUSETRIGGER_GETONAPPLICATIONPAUSEASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1D757F20)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAPPLICATIONPAUSETRIGGER_ONAPPLICATIONPAUSEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D7581D0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAPPLICATIONPAUSETRIGGER_ONAPPLICATIONPAUSEASYNC_OFFSET UNITYSDK_OFFSET(0x1D758030)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAPPLICATIONPAUSETRIGGER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1D757F10)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAPPLICATIONPAUSETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D758340)
