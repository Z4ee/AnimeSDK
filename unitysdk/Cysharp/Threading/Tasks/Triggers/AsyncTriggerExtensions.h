...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCTRIGGEREXTENSIONS_GETASYNCDESTROYTRIGGER_1_OFFSET UNITYSDK_OFFSET(0x1E76D7D0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCTRIGGEREXTENSIONS_GETASYNCDESTROYTRIGGER_OFFSET UNITYSDK_OFFSET(0x1E76D790)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncTriggerExtensions_TypeDefinitionIndex = 31311;
