...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDISABLETRIGGER_GETONDISABLEASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1C4F67C0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDISABLETRIGGER_GETONDISABLEASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1C4F6720)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDISABLETRIGGER_ONDISABLEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C4F6970)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDISABLETRIGGER_ONDISABLEASYNC_OFFSET UNITYSDK_OFFSET(0x1C4F6820)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDISABLETRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C4F6700)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDISABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F6A80)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncDisableTrigger_TypeDefinitionIndex = 28705;
