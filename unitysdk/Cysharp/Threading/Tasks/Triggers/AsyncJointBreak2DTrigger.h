...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_GETONJOINTBREAK2DASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1EA67FF0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_GETONJOINTBREAK2DASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1EA67F10)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_ONJOINTBREAK2DASYNC_1_OFFSET UNITYSDK_OFFSET(0x1EA68230)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_ONJOINTBREAK2DASYNC_OFFSET UNITYSDK_OFFSET(0x1EA68050)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_ONJOINTBREAK2D_OFFSET UNITYSDK_OFFSET(0x1EA67EA0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA683B0)
