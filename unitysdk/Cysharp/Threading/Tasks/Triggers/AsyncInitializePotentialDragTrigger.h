...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCINITIALIZEPOTENTIALDRAGTRIGGER_GETONINITIALIZEPOTENTIALDRAGASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1EA67AC0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCINITIALIZEPOTENTIALDRAGTRIGGER_GETONINITIALIZEPOTENTIALDRAGASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1EA679E0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCINITIALIZEPOTENTIALDRAGTRIGGER_ONINITIALIZEPOTENTIALDRAGASYNC_1_OFFSET UNITYSDK_OFFSET(0x1EA67D00)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCINITIALIZEPOTENTIALDRAGTRIGGER_ONINITIALIZEPOTENTIALDRAGASYNC_OFFSET UNITYSDK_OFFSET(0x1EA67B20)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCINITIALIZEPOTENTIALDRAGTRIGGER_UNITYENGINE_EVENTSYSTEMS_IINITIALIZEPOTENTIALDRAGHANDLER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1EA67970)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCINITIALIZEPOTENTIALDRAGTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA67E80)
