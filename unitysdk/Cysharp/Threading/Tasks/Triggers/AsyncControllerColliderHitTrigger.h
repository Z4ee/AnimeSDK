...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCONTROLLERCOLLIDERHITTRIGGER_GETONCONTROLLERCOLLIDERHITASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1E7719F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCONTROLLERCOLLIDERHITTRIGGER_GETONCONTROLLERCOLLIDERHITASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1E771910)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCONTROLLERCOLLIDERHITTRIGGER_ONCONTROLLERCOLLIDERHITASYNC_1_OFFSET UNITYSDK_OFFSET(0x1E771BD0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCONTROLLERCOLLIDERHITTRIGGER_ONCONTROLLERCOLLIDERHITASYNC_OFFSET UNITYSDK_OFFSET(0x1E771A50)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCONTROLLERCOLLIDERHITTRIGGER_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1E7718A0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCONTROLLERCOLLIDERHITTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E771CF0)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncControllerColliderHitTrigger_TypeDefinitionIndex = 31359;
