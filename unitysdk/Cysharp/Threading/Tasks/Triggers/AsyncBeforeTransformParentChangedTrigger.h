...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEFORETRANSFORMPARENTCHANGEDTRIGGER_GETONBEFORETRANSFORMPARENTCHANGEDASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1D7597F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEFORETRANSFORMPARENTCHANGEDTRIGGER_GETONBEFORETRANSFORMPARENTCHANGEDASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1D759750)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEFORETRANSFORMPARENTCHANGEDTRIGGER_ONBEFORETRANSFORMPARENTCHANGEDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1D7599F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEFORETRANSFORMPARENTCHANGEDTRIGGER_ONBEFORETRANSFORMPARENTCHANGEDASYNC_OFFSET UNITYSDK_OFFSET(0x1D759850)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEFORETRANSFORMPARENTCHANGEDTRIGGER_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1D759740)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCBEFORETRANSFORMPARENTCHANGEDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D759B60)
