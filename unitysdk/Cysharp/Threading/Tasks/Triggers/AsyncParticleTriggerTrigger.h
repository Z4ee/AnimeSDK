...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_GETONPARTICLETRIGGERASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1C520690)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_GETONPARTICLETRIGGERASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1C5205F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_ONPARTICLETRIGGERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C520840)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_ONPARTICLETRIGGERASYNC_OFFSET UNITYSDK_OFFSET(0x1C5206F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_ONPARTICLETRIGGER_OFFSET UNITYSDK_OFFSET(0x1C5205D0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C520950)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncParticleTriggerTrigger_TypeDefinitionIndex = 28737;
