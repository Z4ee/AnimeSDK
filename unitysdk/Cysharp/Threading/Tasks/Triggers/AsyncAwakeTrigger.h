...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAWAKETRIGGER_AWAKEASYNC_OFFSET UNITYSDK_OFFSET(0x1EA60A00)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCAWAKETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA60BC0)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncAwakeTrigger_TypeDefinitionIndex = 42909;
