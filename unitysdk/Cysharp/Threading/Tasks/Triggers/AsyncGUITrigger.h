...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_GETONGUIASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1E842E50)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_GETONGUIASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1E842DA0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_ONGUIASYNC_1_OFFSET UNITYSDK_OFFSET(0x1E843010)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_ONGUIASYNC_OFFSET UNITYSDK_OFFSET(0x1E842EB0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_ONGUI_OFFSET UNITYSDK_OFFSET(0x1E842D80)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E843120)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncGUITrigger_TypeDefinitionIndex = 31369;
