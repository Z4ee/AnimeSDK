...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_GETONGUIASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1EA675E0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_GETONGUIASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1EA67530)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_ONGUIASYNC_1_OFFSET UNITYSDK_OFFSET(0x1EA677E0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_ONGUIASYNC_OFFSET UNITYSDK_OFFSET(0x1EA67640)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER_ONGUI_OFFSET UNITYSDK_OFFSET(0x1EA67520)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCGUITRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA67950)
