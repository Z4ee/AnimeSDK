...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_GETONCOLLISIONSTAY2DASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1FA4BCC0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_GETONCOLLISIONSTAY2DASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1FA4BBF0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_ONCOLLISIONSTAY2DASYNC_1_OFFSET UNITYSDK_OFFSET(0x1FA4BEA0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_ONCOLLISIONSTAY2DASYNC_OFFSET UNITYSDK_OFFSET(0x1FA4BD20)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_ONCOLLISIONSTAY2D_OFFSET UNITYSDK_OFFSET(0x1FA4BB80)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA4BFC0)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncCollisionStay2DTrigger_TypeDefinitionIndex = 31977;
