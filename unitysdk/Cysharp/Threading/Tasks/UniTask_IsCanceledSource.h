...
#define CYSHARP_THREADING_TASKS_UNITASK_ISCANCELEDSOURCE_CYSHARP_THREADING_TASKS_IUNITASKSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1FAAC270)
#define CYSHARP_THREADING_TASKS_UNITASK_ISCANCELEDSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1FAAC0E0)
#define CYSHARP_THREADING_TASKS_UNITASK_ISCANCELEDSOURCE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1FAAC280)
#define CYSHARP_THREADING_TASKS_UNITASK_ISCANCELEDSOURCE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1FAAC440)
#define CYSHARP_THREADING_TASKS_UNITASK_ISCANCELEDSOURCE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1FAAC360)
#define CYSHARP_THREADING_TASKS_UNITASK_ISCANCELEDSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAAC0D0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_IsCanceledSource_TypeDefinitionIndex = 31883;
