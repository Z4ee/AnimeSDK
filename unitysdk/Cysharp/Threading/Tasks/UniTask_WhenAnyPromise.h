...
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE_CYSHARP_THREADING_TASKS_IUNITASKSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1E805ED0)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1E805D00)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1E805D70)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1E805E40)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE_TRYINVOKECONTINUATION_OFFSET UNITYSDK_OFFSET(0x1E805AD0)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1E805E60)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANYPROMISE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E805740)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_WhenAnyPromise_TypeDefinitionIndex = 31262;
