...
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR_DISPOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1CE29B40)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CE29650)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE29930)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR_MOVENEXTASYNC_OFFSET UNITYSDK_OFFSET(0x1CE29660)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR_ONCANCELED1_OFFSET UNITYSDK_OFFSET(0x1CE299E0)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR_ONCANCELED2_OFFSET UNITYSDK_OFFSET(0x1CE29BB0)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE29D10)
#define CYSHARP_THREADING_TASKS_UNITYEVENTHANDLERASYNCENUMERABLE_UNITYEVENTHANDLERASYNCENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE29640)
...
namespace Cysharp::Threading::Tasks
{
	...
	public:
		...
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(UnityEventHandlerAsyncEnumerable_UnityEventHandlerAsyncEnumerator_TypeDefinitionIndex)->GetStaticField(0x63070);
		}
		static ::System::Action_1<::System::Object*>** StaticGet_cancel1()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(UnityEventHandlerAsyncEnumerable_UnityEventHandlerAsyncEnumerator_TypeDefinitionIndex)->GetStaticField(0x63078);
		}
		::System::Threading::CancellationToken cancellationToken1; // 0x30
		::UnityEngine::Events::UnityAction* unityAction; // 0x38
		::UnityEngine::Events::UnityEvent* unityEvent; // 0x40
		::System::Threading::CancellationToken cancellationToken2; // 0x48
		::System::Threading::CancellationTokenRegistration registration2; // 0x50
		::System::Threading::CancellationTokenRegistration registration1; // 0x68
