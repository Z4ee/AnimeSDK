...
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1FC2A100)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1FC29FD0)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1FC2A090)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1FC2A0B0)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1FC2A0A0)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC29FB0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_ExceptionResultSource_TypeDefinitionIndex = 31869;
