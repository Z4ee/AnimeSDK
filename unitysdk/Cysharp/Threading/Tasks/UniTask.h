...
#define CYSHARP_THREADING_TASKS_UNITASK_ACTION_1_OFFSET UNITYSDK_OFFSET(0x1CE08DF0)
#define CYSHARP_THREADING_TASKS_UNITASK_ACTION_OFFSET UNITYSDK_OFFSET(0x1CE08D50)
#define CYSHARP_THREADING_TASKS_UNITASK_ASASYNCUNITUNITASK_OFFSET UNITYSDK_OFFSET(0x3BB7E10)
#define CYSHARP_THREADING_TASKS_UNITASK_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1CE08C10)
#define CYSHARP_THREADING_TASKS_UNITASK_CREATE_OFFSET UNITYSDK_OFFSET(0x1CE08BD0)
#define CYSHARP_THREADING_TASKS_UNITASK_DEFER_OFFSET UNITYSDK_OFFSET(0x1CE08FF0)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAYFRAME_OFFSET UNITYSDK_OFFSET(0x1CE07630)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_1_OFFSET UNITYSDK_OFFSET(0x1CE07AD0)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_2_OFFSET UNITYSDK_OFFSET(0x1CE07D00)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_3_OFFSET UNITYSDK_OFFSET(0x1CE07B70)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_OFFSET UNITYSDK_OFFSET(0x1CE074A0)
#define CYSHARP_THREADING_TASKS_UNITASK_FROMCANCELED_OFFSET UNITYSDK_OFFSET(0x1CE08A50)
#define CYSHARP_THREADING_TASKS_UNITASK_FROMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1CE08910)
#define CYSHARP_THREADING_TASKS_UNITASK_GETAWAITER_OFFSET UNITYSDK_OFFSET(0x14A80)
#define CYSHARP_THREADING_TASKS_UNITASK_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x3BB7D50)
#define CYSHARP_THREADING_TASKS_UNITASK_LAZY_OFFSET UNITYSDK_OFFSET(0x1CE08C50)
#define CYSHARP_THREADING_TASKS_UNITASK_NEVER_OFFSET UNITYSDK_OFFSET(0x1CE09050)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_1_OFFSET UNITYSDK_OFFSET(0x1CE06A60)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_2_OFFSET UNITYSDK_OFFSET(0x1CE06B10)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_3_OFFSET UNITYSDK_OFFSET(0x1CE06BB0)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_OFFSET UNITYSDK_OFFSET(0x1CE06620)
#define CYSHARP_THREADING_TASKS_UNITASK_POST_OFFSET UNITYSDK_OFFSET(0x1CE096A0)
#define CYSHARP_THREADING_TASKS_UNITASK_PRESERVE_OFFSET UNITYSDK_OFFSET(0x3BB7D90)
#define CYSHARP_THREADING_TASKS_UNITASK_RETURNTOCURRENTSYNCHRONIZATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CE09780)
#define CYSHARP_THREADING_TASKS_UNITASK_RETURNTOMAINTHREAD_1_OFFSET UNITYSDK_OFFSET(0x1CE09680)
#define CYSHARP_THREADING_TASKS_UNITASK_RETURNTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x1CE09660)
#define CYSHARP_THREADING_TASKS_UNITASK_RETURNTOSYNCHRONIZATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CE09760)
#define CYSHARP_THREADING_TASKS_UNITASK_RUNONTHREADPOOL_1_OFFSET UNITYSDK_OFFSET(0x1CE092F0)
#define CYSHARP_THREADING_TASKS_UNITASK_RUNONTHREADPOOL_2_OFFSET UNITYSDK_OFFSET(0x1CE09440)
#define CYSHARP_THREADING_TASKS_UNITASK_RUNONTHREADPOOL_3_OFFSET UNITYSDK_OFFSET(0x1CE095A0)
#define CYSHARP_THREADING_TASKS_UNITASK_RUNONTHREADPOOL_OFFSET UNITYSDK_OFFSET(0x1CE09190)
#define CYSHARP_THREADING_TASKS_UNITASK_RUN_1_OFFSET UNITYSDK_OFFSET(0x1CE09200)
#define CYSHARP_THREADING_TASKS_UNITASK_RUN_2_OFFSET UNITYSDK_OFFSET(0x1CE09370)
#define CYSHARP_THREADING_TASKS_UNITASK_RUN_3_OFFSET UNITYSDK_OFFSET(0x1CE094B0)
#define CYSHARP_THREADING_TASKS_UNITASK_RUN_OFFSET UNITYSDK_OFFSET(0x1CE090D0)
#define CYSHARP_THREADING_TASKS_UNITASK_SUPPRESSCANCELLATIONTHROW_OFFSET UNITYSDK_OFFSET(0x3BB7D60)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOMAINTHREAD_1_OFFSET UNITYSDK_OFFSET(0x1CE09640)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x1CE09620)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOSYNCHRONIZATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CE09700)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOTASKPOOL_OFFSET UNITYSDK_OFFSET(0x1CE096F0)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOTHREADPOOL_OFFSET UNITYSDK_OFFSET(0x1CE096E0)
#define CYSHARP_THREADING_TASKS_UNITASK_TOCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1CE060C0)
#define CYSHARP_THREADING_TASKS_UNITASK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3BB7D80)
#define CYSHARP_THREADING_TASKS_UNITASK_UNITYACTION_1_OFFSET UNITYSDK_OFFSET(0x1CE08F40)
#define CYSHARP_THREADING_TASKS_UNITASK_UNITYACTION_OFFSET UNITYSDK_OFFSET(0x1CE08EA0)
#define CYSHARP_THREADING_TASKS_UNITASK_VOID_1_OFFSET UNITYSDK_OFFSET(0x1CE08D20)
#define CYSHARP_THREADING_TASKS_UNITASK_VOID_OFFSET UNITYSDK_OFFSET(0x1CE08CE0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORENDOFFRAME_1_OFFSET UNITYSDK_OFFSET(0x1CE06CB0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORENDOFFRAME_2_OFFSET UNITYSDK_OFFSET(0x1CE06D90)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORENDOFFRAME_3_OFFSET UNITYSDK_OFFSET(0x1CE07180)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORENDOFFRAME_OFFSET UNITYSDK_OFFSET(0x1CE06C50)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORFIXEDUPDATE_1_OFFSET UNITYSDK_OFFSET(0x1CE07280)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1CE07220)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORSECONDS_1_OFFSET UNITYSDK_OFFSET(0x1CE07590)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORSECONDS_OFFSET UNITYSDK_OFFSET(0x1CE07360)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILCANCELED_OFFSET UNITYSDK_OFFSET(0x1CE09F80)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTIL_OFFSET UNITYSDK_OFFSET(0x1CE097C0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITWHILE_OFFSET UNITYSDK_OFFSET(0x1CE09BA0)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENALL_1_OFFSET UNITYSDK_OFFSET(0x1CE0A760)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENALL_OFFSET UNITYSDK_OFFSET(0x1CE0A350)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANY_1_OFFSET UNITYSDK_OFFSET(0x1CE0ADA0)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANY_OFFSET UNITYSDK_OFFSET(0x1CE0A930)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__1_OFFSET UNITYSDK_OFFSET(0x1CE061A0)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__2_OFFSET UNITYSDK_OFFSET(0x1CE061B0)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__3_OFFSET UNITYSDK_OFFSET(0x1CE06580)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__OFFSET UNITYSDK_OFFSET(0x1CE06190)
#define CYSHARP_THREADING_TASKS_UNITASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE0B730)
#define CYSHARP_THREADING_TASKS_UNITASK__CTOR_OFFSET UNITYSDK_OFFSET(0x3A30FC0)
...
namespace Cysharp::Threading::Tasks
{
	...
	struct alignas(8) UniTask
	{
		...
		{
			return (::Cysharp::Threading::Tasks::UniTask*)Il2CppClass::FromTypeDefinitionIndex(UniTask_TypeDefinitionIndex)->GetStaticField(0x61980);
		}
		static ::Cysharp::Threading::Tasks::UniTask* StaticGet_CompletedTask()
		{
			return (::Cysharp::Threading::Tasks::UniTask*)Il2CppClass::FromTypeDefinitionIndex(UniTask_TypeDefinitionIndex)->GetStaticField(0x61990);
		}
