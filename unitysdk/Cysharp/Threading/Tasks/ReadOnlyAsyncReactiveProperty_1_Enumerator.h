...
{
	inline static constexpr unsigned int ReadOnlyAsyncReactiveProperty_1_Enumerator_TypeDefinitionIndex = 42544;

	template <typename T>
	class ReadOnlyAsyncReactiveProperty_1_Enumerator : public ::Cysharp::Threading::Tasks::MoveNextSource
	{
	public:
		static ::System::Action_1<::System::Object*>** StaticGet_cancellationCallback()
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(ReadOnlyAsyncReactiveProperty_1_Enumerator_TypeDefinitionIndex)->GetStaticField(0x0);
		}
