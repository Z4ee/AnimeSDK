...
#define CYSHARP_THREADING_TASKS_COMPILERSERVICES_ASYNCUNITASKMETHODBUILDER_CREATE_OFFSET UNITYSDK_OFFSET(0x1EA4EB00)
#define CYSHARP_THREADING_TASKS_COMPILERSERVICES_ASYNCUNITASKMETHODBUILDER_GET_TASK_OFFSET UNITYSDK_OFFSET(0x3BA9430)
#define CYSHARP_THREADING_TASKS_COMPILERSERVICES_ASYNCUNITASKMETHODBUILDER_SETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x3BA9450)
#define CYSHARP_THREADING_TASKS_COMPILERSERVICES_ASYNCUNITASKMETHODBUILDER_SETRESULT_OFFSET UNITYSDK_OFFSET(0x3BA9460)
#define CYSHARP_THREADING_TASKS_COMPILERSERVICES_ASYNCUNITASKMETHODBUILDER_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1020)
