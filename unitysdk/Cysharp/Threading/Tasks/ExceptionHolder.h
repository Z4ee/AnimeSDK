...
#define CYSHARP_THREADING_TASKS_EXCEPTIONHOLDER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E82A6F0)
#define CYSHARP_THREADING_TASKS_EXCEPTIONHOLDER_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1E82A640)
#define CYSHARP_THREADING_TASKS_EXCEPTIONHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82A630)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int ExceptionHolder_TypeDefinitionIndex = 31281;
