...
#define CYSHARP_THREADING_TASKS_EXCEPTIONHOLDER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C4F6640)
#define CYSHARP_THREADING_TASKS_EXCEPTIONHOLDER_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1C4F6590)
#define CYSHARP_THREADING_TASKS_EXCEPTIONHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F6580)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int ExceptionHolder_TypeDefinitionIndex = 28625;
