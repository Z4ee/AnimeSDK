...
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENAWAITABLE_GETAWAITER_OFFSET UNITYSDK_OFFSET(0x161E0)
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENAWAITABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16050)
