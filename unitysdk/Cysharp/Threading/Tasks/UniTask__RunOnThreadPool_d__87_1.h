...
{
	inline static constexpr unsigned int UniTask__RunOnThreadPool_d__87_1_TypeDefinitionIndex = 42770;

	template <typename T>
	struct UniTask__RunOnThreadPool_d__87_1
	{
