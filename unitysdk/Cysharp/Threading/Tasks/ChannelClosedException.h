...
#define CYSHARP_THREADING_TASKS_CHANNELCLOSEDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D746C50)
#define CYSHARP_THREADING_TASKS_CHANNELCLOSEDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D746CC0)
#define CYSHARP_THREADING_TASKS_CHANNELCLOSEDEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D746D70)
#define CYSHARP_THREADING_TASKS_CHANNELCLOSEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D746BB0)
