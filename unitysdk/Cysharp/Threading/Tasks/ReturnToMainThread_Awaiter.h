...
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_AWAITER_GETAWAITER_OFFSET UNITYSDK_OFFSET(0x14A80)
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_AWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0x3BDEC30)
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_AWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BDEB50)
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_AWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BB8760)
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_AWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BB8760)
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_AWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x39A9C20)
