...
#define CYSHARP_THREADING_TASKS_ENUMERATORASYNCEXTENSIONS__CORE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D7482E0)
#define CYSHARP_THREADING_TASKS_ENUMERATORASYNCEXTENSIONS__CORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D748410)
#define CYSHARP_THREADING_TASKS_ENUMERATORASYNCEXTENSIONS__CORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D748470)
#define CYSHARP_THREADING_TASKS_ENUMERATORASYNCEXTENSIONS__CORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D748420)
#define CYSHARP_THREADING_TASKS_ENUMERATORASYNCEXTENSIONS__CORE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D7482D0)
#define CYSHARP_THREADING_TASKS_ENUMERATORASYNCEXTENSIONS__CORE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7482C0)
...
namespace Cysharp::Threading::Tasks
{
	...
	{
	public:
		::Cysharp::Threading::Tasks::AutoResetUniTaskCompletionSource* source; // 0x10
		::System::Collections::IEnumerator* inner; // 0x18
