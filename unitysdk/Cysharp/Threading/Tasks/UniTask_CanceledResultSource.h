...
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1E6C3B50)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1E6C3BB0)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1E6C3BD0)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1E6C3BC0)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6C3B40)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_CanceledResultSource_TypeDefinitionIndex = 31252;
