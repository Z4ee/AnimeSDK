...
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0xA776B0)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA776A0)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA77730)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA777A0)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x3E5700)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int SwitchToMainThreadAwaitable_Awaiter_TypeDefinitionIndex = 31274;
