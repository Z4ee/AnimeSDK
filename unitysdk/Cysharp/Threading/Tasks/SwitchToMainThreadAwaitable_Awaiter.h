...
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0xAC8110)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0xAC8100)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xAC8190)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xAC8200)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x41FE00)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int SwitchToMainThreadAwaitable_Awaiter_TypeDefinitionIndex = 31894;
