...
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0x3BA95C0)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BA97F0)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BA9640)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x3BA9640)
#define CYSHARP_THREADING_TASKS_SWITCHTOMAINTHREADAWAITABLE_AWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x31FA0)
