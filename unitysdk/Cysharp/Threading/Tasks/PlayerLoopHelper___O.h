...
namespace Cysharp::Threading::Tasks
{
	...
	public:
		...
		{
			return (::UnityEngine::LowLevel::PlayerLoopSystem_UpdateFunction**)Il2CppClass::FromTypeDefinitionIndex(PlayerLoopHelper___O_TypeDefinitionIndex)->GetStaticField(0x61BF0);
		}
	};
}
