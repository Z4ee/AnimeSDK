...
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1EA9BFB0)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_ISHTTPERROR_OFFSET UNITYSDK_OFFSET(0x1EA9BFA0)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_ISNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x1EA9BF90)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1EA9BFF0)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_RESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1EA9BFD0)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_RESPONSEHEADERS_OFFSET UNITYSDK_OFFSET(0x1EA9BFE0)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1EA9BFC0)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION_GET_UNITYWEBREQUEST_OFFSET UNITYSDK_OFFSET(0x1EA9BF80)
#define CYSHARP_THREADING_TASKS_UNITYWEBREQUESTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA92060)
...
namespace Cysharp::Threading::Tasks
{
	...
	public:
		...
		::UnityEngine::Networking::UnityWebRequest* _UnityWebRequest_k__BackingField; // 0xA0
