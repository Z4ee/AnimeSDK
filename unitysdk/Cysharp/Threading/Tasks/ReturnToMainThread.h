...
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD_DISPOSEASYNC_OFFSET UNITYSDK_OFFSET(0x3BA94C0)
#define CYSHARP_THREADING_TASKS_RETURNTOMAINTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x31FA0)
