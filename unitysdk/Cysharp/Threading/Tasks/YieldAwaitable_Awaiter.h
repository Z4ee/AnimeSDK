...
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0x283610)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA79060)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA790D0)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x2B66C0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int YieldAwaitable_Awaiter_TypeDefinitionIndex = 31271;
