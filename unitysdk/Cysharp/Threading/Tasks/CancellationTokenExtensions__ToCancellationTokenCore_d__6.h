...
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENEXTENSIONS__TOCANCELLATIONTOKENCORE_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3BDEA90)
#define CYSHARP_THREADING_TASKS_CANCELLATIONTOKENEXTENSIONS__TOCANCELLATIONTOKENCORE_D__6_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x10F00)
