...
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_GETAWAITER_OFFSET UNITYSDK_OFFSET(0x325570)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_TOUNITASK_OFFSET UNITYSDK_OFFSET(0xACC0C0)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3253A0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int YieldAwaitable_TypeDefinitionIndex = 31890;
