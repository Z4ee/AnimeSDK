...
#define CYSHARP_THREADING_TASKS_UNITASK_ASYNCUNITSOURCE_CYSHARP_THREADING_TASKS_IUNITASKSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1CE0D110)
#define CYSHARP_THREADING_TASKS_UNITASK_ASYNCUNITSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1CE0CC30)
#define CYSHARP_THREADING_TASKS_UNITASK_ASYNCUNITSOURCE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1CE0CD70)
#define CYSHARP_THREADING_TASKS_UNITASK_ASYNCUNITSOURCE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1CE0CEA0)
#define CYSHARP_THREADING_TASKS_UNITASK_ASYNCUNITSOURCE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1CE0CFE0)
#define CYSHARP_THREADING_TASKS_UNITASK_ASYNCUNITSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE0B720)
