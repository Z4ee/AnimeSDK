...
#define CYSHARP_THREADING_TASKS_UNITYBINDINGEXTENSIONS_BINDTOCORE_1_OFFSET UNITYSDK_OFFSET(0x1CE28370)
#define CYSHARP_THREADING_TASKS_UNITYBINDINGEXTENSIONS_BINDTOCORE_OFFSET UNITYSDK_OFFSET(0x1CE281E0)
#define CYSHARP_THREADING_TASKS_UNITYBINDINGEXTENSIONS_BINDTO_1_OFFSET UNITYSDK_OFFSET(0x1CE28240)
#define CYSHARP_THREADING_TASKS_UNITYBINDINGEXTENSIONS_BINDTO_2_OFFSET UNITYSDK_OFFSET(0x1CE282A0)
#define CYSHARP_THREADING_TASKS_UNITYBINDINGEXTENSIONS_BINDTO_3_OFFSET UNITYSDK_OFFSET(0x1CE283D0)
#define CYSHARP_THREADING_TASKS_UNITYBINDINGEXTENSIONS_BINDTO_OFFSET UNITYSDK_OFFSET(0x1CE28110)
