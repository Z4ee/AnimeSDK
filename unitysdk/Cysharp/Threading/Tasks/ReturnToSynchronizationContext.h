...
#define CYSHARP_THREADING_TASKS_RETURNTOSYNCHRONIZATIONCONTEXT_DISPOSEASYNC_OFFSET UNITYSDK_OFFSET(0x3BDECE0)
#define CYSHARP_THREADING_TASKS_RETURNTOSYNCHRONIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x3BDECD0)
