...
#define CLASS_1_5B567C8A01BAEDFE_345_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C44B510)
#define CLASS_1_5B567C8A01BAEDFE_345_CLONE_OFFSET UNITYSDK_OFFSET(0x1C44B1B0)
#define CLASS_1_5B567C8A01BAEDFE_345_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C44B310)
#define CLASS_1_5B567C8A01BAEDFE_345_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C44B220)
#define CLASS_1_5B567C8A01BAEDFE_345_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C44B470)
#define CLASS_1_5B567C8A01BAEDFE_345_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C44B560)
#define CLASS_1_5B567C8A01BAEDFE_345_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C44B530)
#define CLASS_1_5B567C8A01BAEDFE_345_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C44B100)
#define CLASS_1_5B567C8A01BAEDFE_345_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C44B160)
#define CLASS_1_5B567C8A01BAEDFE_345_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C44B4A0)
#define CLASS_1_5B567C8A01BAEDFE_345_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C44B500)
#define CLASS_1_5B567C8A01BAEDFE_345__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C44B5B0)
#define CLASS_1_5B567C8A01BAEDFE_345__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C44B180)
#define CLASS_1_5B567C8A01BAEDFE_345__CTOR_OFFSET UNITYSDK_OFFSET(0x1C44B170)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_345_TypeDefinitionIndex = 33028;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_345*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_345_TypeDefinitionIndex)->GetStaticField(0x1D9F0);
	}
