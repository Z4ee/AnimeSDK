...
#define CLASS_1_5B567C8A01BAEDFE_345_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A715C30)
#define CLASS_1_5B567C8A01BAEDFE_345_CLONE_OFFSET UNITYSDK_OFFSET(0x1A715A40)
#define CLASS_1_5B567C8A01BAEDFE_345_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A715B40)
#define CLASS_1_5B567C8A01BAEDFE_345_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A715AB0)
#define CLASS_1_5B567C8A01BAEDFE_345_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A715B90)
#define CLASS_1_5B567C8A01BAEDFE_345_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A715C80)
#define CLASS_1_5B567C8A01BAEDFE_345_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A715C50)
#define CLASS_1_5B567C8A01BAEDFE_345_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A715990)
#define CLASS_1_5B567C8A01BAEDFE_345_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7159F0)
#define CLASS_1_5B567C8A01BAEDFE_345_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A715BC0)
#define CLASS_1_5B567C8A01BAEDFE_345_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A715C20)
#define CLASS_1_5B567C8A01BAEDFE_345__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A715CD0)
#define CLASS_1_5B567C8A01BAEDFE_345__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A715A10)
#define CLASS_1_5B567C8A01BAEDFE_345__CTOR_OFFSET UNITYSDK_OFFSET(0x1A715A00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_345_TypeDefinitionIndex = 32027;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_345*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_345_TypeDefinitionIndex)->GetStaticField(0x38830);
	}
