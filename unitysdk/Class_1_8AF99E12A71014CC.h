...
#define CLASS_1_8AF99E12A71014CC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A101EF0)
...
public:
	...
	::Class_3_07C3C4D2990C49EE* AHEEAFKFALM; // 0x18
	::Class_3_07C3C4D2990C49EE* LEAHACBFJBP; // 0x20
	::RPG::GameCore::DynamicValueRangeCallback* EABKOHGCHFP; // 0x28
	::System::SByte EBPHCMMFAPJ; // 0x30
	::System::SByte IEFMFPIDINK; // 0x31
	::System::Boolean PDAAIEKJOJK; // 0x32
	::System::SByte PLPOFKKEENK; // 0x33
