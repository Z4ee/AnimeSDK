...
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x3A9A910)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_1D9EE327BF7D6281_OFFSET UNITYSDK_OFFSET(0x3A9A960)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_26874F67BD92CEC1_OFFSET UNITYSDK_OFFSET(0x169CD580)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0x169C69F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_3848E4903F0CA4C5_OFFSET UNITYSDK_OFFSET(0x169C76B0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x3A9AA10)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_428BD246F5FAAA99_OFFSET UNITYSDK_OFFSET(0x3A9A9F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_4F3148D4BAAF81F3_OFFSET UNITYSDK_OFFSET(0x169C78C0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x3A9A920)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_77C7045E7324E8B8_OFFSET UNITYSDK_OFFSET(0x169C72C0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_78D5E0A1A0AC9949_OFFSET UNITYSDK_OFFSET(0x169CDA70)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_85C81563BC6E2A2E_OFFSET UNITYSDK_OFFSET(0x169C7C30)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x3A9A940)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_89A99D29D0BEDD89_OFFSET UNITYSDK_OFFSET(0x3A9A930)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_9CFA7241D1009D47_OFFSET UNITYSDK_OFFSET(0x3A9A8F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_AC6B8E73BD3BD222_OFFSET UNITYSDK_OFFSET(0x3A9A970)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_AFD95DA10D1573F3_OFFSET UNITYSDK_OFFSET(0x3A9AA00)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_B799DB9989A18F1D_OFFSET UNITYSDK_OFFSET(0x169CD810)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_C0FF32B4D2022F8C_OFFSET UNITYSDK_OFFSET(0x169CD900)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x3A9AA20)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F5919FB9FE5456D1_OFFSET UNITYSDK_OFFSET(0x169C6CB0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F620DD2FD48DDF53_OFFSET UNITYSDK_OFFSET(0x3A9A950)
#define STRUCT_2_FB7FD3F7A6A85D5E__CCTOR_OFFSET UNITYSDK_OFFSET(0x169CE390)
#define STRUCT_2_FB7FD3F7A6A85D5E__CTOR_OFFSET UNITYSDK_OFFSET(0x3A9A900)
...
struct alignas(8) Struct_2_FB7FD3F7A6A85D5E
{
	...
	{
		return (::RPG::Client::EnvironmentSystem**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x5BA60);
	}
	static ::UnityEngine::Camera** StaticGet_GOFNJPLABPI()
	{
		return (::UnityEngine::Camera**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x5BA68);
	}
	static ::RPG::Client::RefList_1<::Struct_2_FB7FD3F7A6A85D5E>** StaticGet_KEBMBFCNBHN()
	{
		return (::RPG::Client::RefList_1<::Struct_2_FB7FD3F7A6A85D5E>**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x5BA70);
	}
	static ::System::Single* StaticGet_KOMEOMHBCEC()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x129B0);
	}
