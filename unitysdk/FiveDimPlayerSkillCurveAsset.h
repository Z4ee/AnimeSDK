...
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_0FDE67E8BCF7203D_1_OFFSET UNITYSDK_OFFSET(0x187ACDB0)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_0FDE67E8BCF7203D_2_OFFSET UNITYSDK_OFFSET(0x187ACEA0)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0x187ACCC0)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_20F2E478F76F0620_OFFSET UNITYSDK_OFFSET(0x187ACBD0)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_C650DC783089C46A_OFFSET UNITYSDK_OFFSET(0x187ACB30)
#define FIVEDIMPLAYERSKILLCURVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x187ACF90)

inline static constexpr unsigned int FiveDimPlayerSkillCurveAsset_TypeDefinitionIndex = 39466;
