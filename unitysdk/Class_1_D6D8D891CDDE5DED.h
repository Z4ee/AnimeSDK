...
#define CLASS_1_D6D8D891CDDE5DED_GET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x99D6DD0)
#define CLASS_1_D6D8D891CDDE5DED_GET_REPORTMESSAGE_OFFSET UNITYSDK_OFFSET(0x99D6DF0)
#define CLASS_1_D6D8D891CDDE5DED_GET_SUCCEED_OFFSET UNITYSDK_OFFSET(0x99D6DB0)
#define CLASS_1_D6D8D891CDDE5DED_SET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x99D6DE0)
#define CLASS_1_D6D8D891CDDE5DED_SET_REPORTMESSAGE_OFFSET UNITYSDK_OFFSET(0x99D6E00)
#define CLASS_1_D6D8D891CDDE5DED_SET_SUCCEED_OFFSET UNITYSDK_OFFSET(0x99D6DC0)
#define CLASS_1_D6D8D891CDDE5DED__CTOR_OFFSET UNITYSDK_OFFSET(0x99D6E10)

inline static constexpr unsigned int Class_1_D6D8D891CDDE5DED_TypeDefinitionIndex = 63962;
