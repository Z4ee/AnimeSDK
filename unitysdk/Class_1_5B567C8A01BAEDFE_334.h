...
#define CLASS_1_5B567C8A01BAEDFE_334_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4119F0)
#define CLASS_1_5B567C8A01BAEDFE_334_CLONE_OFFSET UNITYSDK_OFFSET(0x1A411800)
#define CLASS_1_5B567C8A01BAEDFE_334_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A411900)
#define CLASS_1_5B567C8A01BAEDFE_334_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A411870)
#define CLASS_1_5B567C8A01BAEDFE_334_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A411950)
#define CLASS_1_5B567C8A01BAEDFE_334_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A411A40)
#define CLASS_1_5B567C8A01BAEDFE_334_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A411A10)
#define CLASS_1_5B567C8A01BAEDFE_334_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A411750)
#define CLASS_1_5B567C8A01BAEDFE_334_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4117B0)
#define CLASS_1_5B567C8A01BAEDFE_334_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A411980)
#define CLASS_1_5B567C8A01BAEDFE_334_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4119E0)
#define CLASS_1_5B567C8A01BAEDFE_334__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A411A90)
#define CLASS_1_5B567C8A01BAEDFE_334__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4117D0)
#define CLASS_1_5B567C8A01BAEDFE_334__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4117C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_334*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_334_TypeDefinitionIndex)->GetStaticField(0x63C40);
	}
