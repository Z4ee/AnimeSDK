...
#define CLASS_1_5B567C8A01BAEDFE_334_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19998B60)
#define CLASS_1_5B567C8A01BAEDFE_334_CLONE_OFFSET UNITYSDK_OFFSET(0x199989D0)
#define CLASS_1_5B567C8A01BAEDFE_334_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19998A70)
#define CLASS_1_5B567C8A01BAEDFE_334_EQUALS_OFFSET UNITYSDK_OFFSET(0x19998A10)
#define CLASS_1_5B567C8A01BAEDFE_334_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19998AC0)
#define CLASS_1_5B567C8A01BAEDFE_334_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19998BB0)
#define CLASS_1_5B567C8A01BAEDFE_334_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19998B80)
#define CLASS_1_5B567C8A01BAEDFE_334_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19998950)
#define CLASS_1_5B567C8A01BAEDFE_334_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19998980)
#define CLASS_1_5B567C8A01BAEDFE_334_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19998AF0)
#define CLASS_1_5B567C8A01BAEDFE_334_WRITETO_OFFSET UNITYSDK_OFFSET(0x19998B50)
#define CLASS_1_5B567C8A01BAEDFE_334__CCTOR_OFFSET UNITYSDK_OFFSET(0x19998C00)
#define CLASS_1_5B567C8A01BAEDFE_334__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199989A0)
#define CLASS_1_5B567C8A01BAEDFE_334__CTOR_OFFSET UNITYSDK_OFFSET(0x19998990)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_334_TypeDefinitionIndex = 31946;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_334*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_334_TypeDefinitionIndex)->GetStaticField(0x64200);
	}
