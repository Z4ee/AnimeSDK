...
#define HDIFFPATCH_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1E88C240)
#define HDIFFPATCH_HDIFF_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1E88BD50)
#define HDIFFPATCH_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1E88C1D0)
#define HDIFFPATCH_HPATCH_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1E88BC10)
#define HDIFFPATCH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E88BB80)
#define HDIFFPATCH_INVOKEDLL_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1E88C030)
#define HDIFFPATCH_INVOKEDLL_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1E88BE90)
#define HDIFFPATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E88BAF0)

inline static constexpr unsigned int HDiffPatch_TypeDefinitionIndex = 34639;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(HDiffPatch_TypeDefinitionIndex)->GetStaticField(0x8480);
	}
