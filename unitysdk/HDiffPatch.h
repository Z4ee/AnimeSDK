...
#define HDIFFPATCH_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1C55C920)
#define HDIFFPATCH_HDIFF_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1C55C430)
#define HDIFFPATCH_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1C55C8B0)
#define HDIFFPATCH_HPATCH_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1C55C2F0)
#define HDIFFPATCH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1C55C260)
#define HDIFFPATCH_INVOKEDLL_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1C55C710)
#define HDIFFPATCH_INVOKEDLL_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1C55C570)
#define HDIFFPATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C55C1D0)

inline static constexpr unsigned int HDiffPatch_TypeDefinitionIndex = 33081;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(HDiffPatch_TypeDefinitionIndex)->GetStaticField(0x7FE0);
	}
