...
#define COFFEE_UIPARTICLEINTERNAL_SPRITEEXTENSIONS_GETACTUALTEXTURE_OFFSET UNITYSDK_OFFSET(0x12BBFBA0)

namespace Coffee::UIParticleInternal
{
	inline static constexpr unsigned int SpriteExtensions_TypeDefinitionIndex = 40679;
