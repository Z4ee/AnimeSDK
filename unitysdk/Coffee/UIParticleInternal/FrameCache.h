...
#define COFFEE_UIPARTICLEINTERNAL_FRAMECACHE_CLEARALLCACHE_OFFSET UNITYSDK_OFFSET(0x1467C8E0)
#define COFFEE_UIPARTICLEINTERNAL_FRAMECACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1467C6E0)

namespace Coffee::UIParticleInternal
{
	inline static constexpr unsigned int FrameCache_TypeDefinitionIndex = 41512;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::Coffee::UIParticleInternal::FrameCache_IFrameCache*>**)Il2CppClass::FromTypeDefinitionIndex(FrameCache_TypeDefinitionIndex)->GetStaticField(0x1420);
		}
