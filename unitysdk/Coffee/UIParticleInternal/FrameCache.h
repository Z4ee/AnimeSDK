...
#define COFFEE_UIPARTICLEINTERNAL_FRAMECACHE_CLEARALLCACHE_OFFSET UNITYSDK_OFFSET(0x1649E430)
#define COFFEE_UIPARTICLEINTERNAL_FRAMECACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1649E230)
