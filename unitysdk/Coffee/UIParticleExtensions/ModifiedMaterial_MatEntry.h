...
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL_MATENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E0440)

namespace Coffee::UIParticleExtensions
{
	inline static constexpr unsigned int ModifiedMaterial_MatEntry_TypeDefinitionIndex = 34209;
	...
	public:
		...
		::UnityEngine::Texture* texture; // 0x20
