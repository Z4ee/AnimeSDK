...
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER_OVERRIDEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2F6870)

namespace Coffee::UIExtensions
{
	inline static constexpr unsigned int UIParticleRenderer_OverrideEntry_TypeDefinitionIndex = 34864;
	...
	public:
		...
		::System::Boolean psrOverridden; // 0x18
