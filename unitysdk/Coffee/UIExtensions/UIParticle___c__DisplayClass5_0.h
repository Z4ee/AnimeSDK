...
#define COFFEE_UIEXTENSIONS_UIPARTICLE___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x119E4100)
#define COFFEE_UIEXTENSIONS_UIPARTICLE___C__DISPLAYCLASS5_0__PAUSEONTIME_B__0_OFFSET UNITYSDK_OFFSET(0x119E9440)

namespace Coffee::UIExtensions
{
	inline static constexpr unsigned int UIParticle___c__DisplayClass5_0_TypeDefinitionIndex = 34891;
