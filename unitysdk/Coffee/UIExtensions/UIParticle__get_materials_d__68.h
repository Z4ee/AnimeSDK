...
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B580900)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_MATERIAL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B580BE0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_MATERIAL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B580B70)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B580C60)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B580BD0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B580B80)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5808F0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68__CTOR_OFFSET UNITYSDK_OFFSET(0x1B576F10)

namespace Coffee::UIExtensions
{
	inline static constexpr unsigned int UIParticle__get_materials_d__68_TypeDefinitionIndex = 32671;
