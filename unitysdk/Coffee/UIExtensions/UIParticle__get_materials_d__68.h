...
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D7D51D0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_MATERIAL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D7D54B0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_MATERIAL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D7D5440)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D7D5530)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D7D54A0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D7D5450)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D7D51C0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7CB560)

namespace Coffee::UIExtensions
{
	inline static constexpr unsigned int UIParticle__get_materials_d__68_TypeDefinitionIndex = 34222;
