...
#define CLASS_3_E84B33DF6B082F6B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x123C4A10)
#define CLASS_3_E84B33DF6B082F6B_METHOD_3_25971FCF36C209CF_OFFSET UNITYSDK_OFFSET(0x123C4A80)
#define CLASS_3_E84B33DF6B082F6B_METHOD_3_5E62F6780446C42F_OFFSET UNITYSDK_OFFSET(0x123C5C00)
#define CLASS_3_E84B33DF6B082F6B_METHOD_3_E0F3A7E0D78CF15F_OFFSET UNITYSDK_OFFSET(0x123C5320)
#define CLASS_3_E84B33DF6B082F6B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x123C4C00)
#define CLASS_3_E84B33DF6B082F6B__CTOR_OFFSET UNITYSDK_OFFSET(0x123C4970)
#define CLASS_3_E84B33DF6B082F6B___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x123C62B0)

inline static constexpr unsigned int Class_3_E84B33DF6B082F6B_TypeDefinitionIndex = 53546;
...
public:
	...
	::RPG::GameCore::GameEntity* Method_3_5E62F6780446C42F(::Class_1_EAB32D6999AE04E3* a1, ::RPG::GameCore::GameEntity* a2, ::RPG::GameCore::GameEntity* a3, ::UnityEngine::Vector3 a4, ::UnityEngine::Quaternion a5, ::System::Boolean a6)
	{
		return ((::RPG::GameCore::GameEntity*(*)(::PVOID, ::Class_1_EAB32D6999AE04E3*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::GameEntity*, ::UnityEngine::Vector3, ::UnityEngine::Quaternion, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_3_E84B33DF6B082F6B_METHOD_3_5E62F6780446C42F_OFFSET))(this, a1, a2, a3, a4, a5, a6);
	}
