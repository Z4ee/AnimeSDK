...
#define UISCROLLLINEFADER_CALCLIPRECT_OFFSET UNITYSDK_OFFSET(0x18B4AB10)
#define UISCROLLLINEFADER_ENABLEUIVERTEXCOLORCALC_OFFSET UNITYSDK_OFFSET(0x18B4A890)
#define UISCROLLLINEFADER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x18B4ADD0)
#define UISCROLLLINEFADER_SETLINECOLOR_OFFSET UNITYSDK_OFFSET(0x18B4B560)
#define UISCROLLLINEFADER_SET_OFFSET UNITYSDK_OFFSET(0x18B4A570)
#define UISCROLLLINEFADER_START_OFFSET UNITYSDK_OFFSET(0x18B4A120)
#define UISCROLLLINEFADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18B4ACC0)
#define UISCROLLLINEFADER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4B810)

inline static constexpr unsigned int UIScrollLineFader_TypeDefinitionIndex = 88705;
