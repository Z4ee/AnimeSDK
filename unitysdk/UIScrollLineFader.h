...
#define UISCROLLLINEFADER_CALCLIPRECT_OFFSET UNITYSDK_OFFSET(0x179270D0)
#define UISCROLLLINEFADER_ENABLEUIVERTEXCOLORCALC_OFFSET UNITYSDK_OFFSET(0x17926E50)
#define UISCROLLLINEFADER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x17927390)
#define UISCROLLLINEFADER_SETLINECOLOR_OFFSET UNITYSDK_OFFSET(0x17927B00)
#define UISCROLLLINEFADER_SET_OFFSET UNITYSDK_OFFSET(0x17926B30)
#define UISCROLLLINEFADER_START_OFFSET UNITYSDK_OFFSET(0x179266E0)
#define UISCROLLLINEFADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17927280)
#define UISCROLLLINEFADER__CTOR_OFFSET UNITYSDK_OFFSET(0x17927DB0)

inline static constexpr unsigned int UIScrollLineFader_TypeDefinitionIndex = 48766;
