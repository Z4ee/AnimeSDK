...
#define CLASS_1_5B567C8A01BAEDFE_249_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A58CF80)
#define CLASS_1_5B567C8A01BAEDFE_249_CLONE_OFFSET UNITYSDK_OFFSET(0x1A58CD90)
#define CLASS_1_5B567C8A01BAEDFE_249_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A58CE90)
#define CLASS_1_5B567C8A01BAEDFE_249_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A58CE00)
#define CLASS_1_5B567C8A01BAEDFE_249_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A58CEE0)
#define CLASS_1_5B567C8A01BAEDFE_249_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A58CFD0)
#define CLASS_1_5B567C8A01BAEDFE_249_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A58CFA0)
#define CLASS_1_5B567C8A01BAEDFE_249_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A58CCE0)
#define CLASS_1_5B567C8A01BAEDFE_249_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A58CD40)
#define CLASS_1_5B567C8A01BAEDFE_249_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A58CF10)
#define CLASS_1_5B567C8A01BAEDFE_249_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A58CF70)
#define CLASS_1_5B567C8A01BAEDFE_249__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A58D020)
#define CLASS_1_5B567C8A01BAEDFE_249__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A58CD60)
#define CLASS_1_5B567C8A01BAEDFE_249__CTOR_OFFSET UNITYSDK_OFFSET(0x1A58CD50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_249_TypeDefinitionIndex = 30063;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_249*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_249_TypeDefinitionIndex)->GetStaticField(0x16600);
	}
