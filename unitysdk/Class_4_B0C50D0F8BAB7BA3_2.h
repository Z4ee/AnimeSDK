...
#define CLASS_4_B0C50D0F8BAB7BA3_2_CLONE_OFFSET UNITYSDK_OFFSET(0x11B8BA10)
#define CLASS_4_B0C50D0F8BAB7BA3_2_METHOD_4_479759059E440327_OFFSET UNITYSDK_OFFSET(0x11B8BAE0)
#define CLASS_4_B0C50D0F8BAB7BA3_2_METHOD_4_6332539B3C7FC700_OFFSET UNITYSDK_OFFSET(0x11B8B650)
#define CLASS_4_B0C50D0F8BAB7BA3_2_METHOD_4_76C20C1C1323A406_OFFSET UNITYSDK_OFFSET(0x11B8B8A0)
#define CLASS_4_B0C50D0F8BAB7BA3_2_METHOD_4_C256FFEE9A4AD041_OFFSET UNITYSDK_OFFSET(0x11B8B700)
#define CLASS_4_B0C50D0F8BAB7BA3_2_REVERSE_OFFSET UNITYSDK_OFFSET(0x11B8BA70)
#define CLASS_4_B0C50D0F8BAB7BA3_2_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x11B8B960)
#define CLASS_4_B0C50D0F8BAB7BA3_2__CTOR_OFFSET UNITYSDK_OFFSET(0x11B8B880)

inline static constexpr unsigned int Class_4_B0C50D0F8BAB7BA3_2_TypeDefinitionIndex = 73420;

class Class_4_B0C50D0F8BAB7BA3_2 : public ::Class_3_3F1B1DE9D9F51912
{
public:
	::UnityEngine::Vector3 OAIBEFPCJNF; // 0x38
	::UnityEngine::Vector3 KLLBBEKNJPI; // 0x44
	::UnityEngine::Vector3 PIEKBFODNOE; // 0x50
