...
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT_INIT_OFFSET UNITYSDK_OFFSET(0x196867C0)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT_SETMPB_OFFSET UNITYSDK_OFFSET(0x19686880)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19686990)

inline static constexpr unsigned int SceneMaterialParameterRewriterAnimated_MaterialAnimationOverrideElement_TypeDefinitionIndex = 29490;
