...
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT_INIT_OFFSET UNITYSDK_OFFSET(0x1B7F1D60)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT_SETMPB_OFFSET UNITYSDK_OFFSET(0x1B7F1E20)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F1F30)

inline static constexpr unsigned int SceneMaterialParameterRewriterAnimated_MaterialAnimationOverrideElement_TypeDefinitionIndex = 26420;
