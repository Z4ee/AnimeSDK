...
#define CLASS_1_0D42FFEDA6354A6B__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0ED80)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0D42FFEDA6354A6B_TypeDefinitionIndex)->GetStaticField(0x14020);
	}
