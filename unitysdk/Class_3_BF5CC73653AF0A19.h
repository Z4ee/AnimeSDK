...
#define CLASS_3_BF5CC73653AF0A19_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87AC1B0)
#define CLASS_3_BF5CC73653AF0A19_METHOD_3_8CA56FF24F45C9F3_OFFSET UNITYSDK_OFFSET(0x87AC420)
#define CLASS_3_BF5CC73653AF0A19__CTOR_OFFSET UNITYSDK_OFFSET(0x87ABFA0)
#define CLASS_3_BF5CC73653AF0A19__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x87AC240)
#define CLASS_3_BF5CC73653AF0A19__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x87AC300)
#define CLASS_3_BF5CC73653AF0A19__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x87AC390)
#define CLASS_3_BF5CC73653AF0A19___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87AC5F0)
#define CLASS_3_BF5CC73653AF0A19___IFIXBASEPROXY__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x87AC600)
#define CLASS_3_BF5CC73653AF0A19___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x87AC610)
#define CLASS_3_BF5CC73653AF0A19___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x87AC620)

inline static constexpr unsigned int Class_3_BF5CC73653AF0A19_TypeDefinitionIndex = 42885;

class Class_3_BF5CC73653AF0A19 : public ::RPG::GameCore::AdvWaitingTaskBase_1<::RPG::GameCore::WaitMapRotationEnergyStateChange*>
{
public:
	::RPG::PoolHashSet_1<::RPG::GameCore::MapRotationEnergyState>* Field_3_1; // 0x68
	::RPG::PoolHashSet_1<::RPG::GameCore::MapRotationEnergyState>* Field_3_0; // 0x70
