...
#define CLASS_2_E4D20CE6B6485AD3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18501430)
#define CLASS_2_E4D20CE6B6485AD3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18501470)
#define CLASS_2_E4D20CE6B6485AD3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18501630)
#define CLASS_2_E4D20CE6B6485AD3_TICK_OFFSET UNITYSDK_OFFSET(0x18501680)
#define CLASS_2_E4D20CE6B6485AD3__CTOR_OFFSET UNITYSDK_OFFSET(0x18501420)

inline static constexpr unsigned int Class_2_E4D20CE6B6485AD3_TypeDefinitionIndex = 55519;

class Class_2_E4D20CE6B6485AD3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::ResetRedStance* OFKGLJOAMLD; // 0x20
