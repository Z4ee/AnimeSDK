...
#define CLASS_3_3C99599DF42BA2AC_METHOD_3_494C2941F93B6A63_OFFSET UNITYSDK_OFFSET(0x1C8B51A0)
#define CLASS_3_3C99599DF42BA2AC_METHOD_3_A811EDB6C0C4A1C7_OFFSET UNITYSDK_OFFSET(0x1C8B51E0)
#define CLASS_3_3C99599DF42BA2AC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8B51D0)
...
{
public:
	::RPG::GameCore::DynamicFloat* HDJIPJCNGFG; // 0x18
	::RPG::GameCore::DynamicFloat* GBBDAJLLLOA; // 0x20
	::RPG::GameCore::DynamicFloat* GJCPNEECKPA; // 0x28
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x30
	::RPG::GameCore::DynamicFloat* JEDCEAGNOAI; // 0x38
	::RPG::GameCore::DynamicFloat* IBAMEPMGLPO; // 0x40
