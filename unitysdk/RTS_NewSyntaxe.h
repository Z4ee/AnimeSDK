...
#define RTS_NEWSYNTAXE_RESTECOLOR_OFFSET UNITYSDK_OFFSET(0x146FE1F0)
#define RTS_NEWSYNTAXE_START_OFFSET UNITYSDK_OFFSET(0x146FDBE0)
#define RTS_NEWSYNTAXE_UPDATE_OFFSET UNITYSDK_OFFSET(0x146FDBF0)
#define RTS_NEWSYNTAXE__CTOR_OFFSET UNITYSDK_OFFSET(0x146FE2E0)
