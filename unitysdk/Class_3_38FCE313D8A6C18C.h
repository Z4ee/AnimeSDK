...
#define CLASS_3_38FCE313D8A6C18C_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x12988B20)
#define CLASS_3_38FCE313D8A6C18C_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x12989030)
#define CLASS_3_38FCE313D8A6C18C_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x12988FB0)
#define CLASS_3_38FCE313D8A6C18C_METHOD_3_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0x12988C00)
#define CLASS_3_38FCE313D8A6C18C_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x12988980)
#define CLASS_3_38FCE313D8A6C18C__CCTOR_OFFSET UNITYSDK_OFFSET(0x12988B70)
#define CLASS_3_38FCE313D8A6C18C__CTOR_OFFSET UNITYSDK_OFFSET(0x12988BF0)

inline static constexpr unsigned int Class_3_38FCE313D8A6C18C_TypeDefinitionIndex = 44609;

class Class_3_38FCE313D8A6C18C : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_5 = 0x92; // 0x0
	::System::Collections::Generic::List_1<::UnityEngine::Collider*>* Field_3_2; // 0x48
