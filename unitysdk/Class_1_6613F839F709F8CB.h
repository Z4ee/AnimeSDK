...
#define CLASS_1_6613F839F709F8CB_METHOD_1_0E3C9CE42200F670_OFFSET UNITYSDK_OFFSET(0x1C84A0A0)
#define CLASS_1_6613F839F709F8CB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C84A3E0)
...
{
public:
	::System::String* ICIDICKIDCB; // 0x10
	::System::String* JLFLCFGCHHC; // 0x18
	::System::String* LJFOMBOOEIC; // 0x20
	::RPG::GameCore::RogueTournRoomType LHLKJIDFLIN; // 0x28
	::RPG::GameCore::RogueTournMarkType HLALFNEDFED; // 0x2C
	::RPG::Client::TextID OPLOPGILKKH; // 0x30
	::RPG::Client::TextID AEEEKGOKJIH; // 0x40
