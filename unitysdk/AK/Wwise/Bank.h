...
#define AK_WWISE_BANK_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1FBDDBF0)
#define AK_WWISE_BANK_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1FBDDC70)
#define AK_WWISE_BANK_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x1FBDDD50)
#define AK_WWISE_BANK_LOAD_OFFSET UNITYSDK_OFFSET(0x1FBDDC80)
#define AK_WWISE_BANK_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1FBDDC00)
#define AK_WWISE_BANK_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1FBDDE10)
#define AK_WWISE_BANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBDDEC0)

namespace AK::Wwise
{
	inline static constexpr unsigned int Bank_TypeDefinitionIndex = 33833;
