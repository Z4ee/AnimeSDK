...
#define AK_WWISE_STATE_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E6AE490)
#define AK_WWISE_STATE_GET_WWISEOBJECTGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1E6AE520)
#define AK_WWISE_STATE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1E6AE510)
#define AK_WWISE_STATE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1E6AE530)
#define AK_WWISE_STATE_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E6AE4A0)
#define AK_WWISE_STATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6AE660)

namespace AK::Wwise
{
	inline static constexpr unsigned int State_TypeDefinitionIndex = 33203;
