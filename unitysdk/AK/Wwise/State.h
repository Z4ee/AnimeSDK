...
#define AK_WWISE_STATE_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1C36FB30)
#define AK_WWISE_STATE_GET_WWISEOBJECTGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1C36FBC0)
#define AK_WWISE_STATE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1C36FBB0)
#define AK_WWISE_STATE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1C36FBD0)
#define AK_WWISE_STATE_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1C36FB40)
#define AK_WWISE_STATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C36FD00)

namespace AK::Wwise
{
	inline static constexpr unsigned int State_TypeDefinitionIndex = 31652;
