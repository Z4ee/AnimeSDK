...
#define AK_WWISE_EVENT_EXECUTEACTION_OFFSET UNITYSDK_OFFSET(0x1A5C3BA0)
#define AK_WWISE_EVENT_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A5C3880)
#define AK_WWISE_EVENT_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1A5C3900)
#define AK_WWISE_EVENT_POSTMIDI_1_OFFSET UNITYSDK_OFFSET(0x1A5C3CD0)
#define AK_WWISE_EVENT_POSTMIDI_OFFSET UNITYSDK_OFFSET(0x1A5C3C40)
#define AK_WWISE_EVENT_POST_1_OFFSET UNITYSDK_OFFSET(0x1A5C39B0)
#define AK_WWISE_EVENT_POST_2_OFFSET UNITYSDK_OFFSET(0x1A5C3A60)
#define AK_WWISE_EVENT_POST_OFFSET UNITYSDK_OFFSET(0x1A5C3920)
#define AK_WWISE_EVENT_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A5C3890)
#define AK_WWISE_EVENT_STOPMIDI_1_OFFSET UNITYSDK_OFFSET(0x1A5C3DF0)
#define AK_WWISE_EVENT_STOPMIDI_OFFSET UNITYSDK_OFFSET(0x1A5C3D60)
#define AK_WWISE_EVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1A5C3B00)
#define AK_WWISE_EVENT_VERIFYPLAYINGID_OFFSET UNITYSDK_OFFSET(0x1A5C3910)
#define AK_WWISE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5C3F10)

namespace AK::Wwise
{
	inline static constexpr unsigned int Event_TypeDefinitionIndex = 40536;
