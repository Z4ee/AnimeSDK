...
#define CLASS_1_7DBB00BF997707BD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A593A00)
...
{
public:
	::Class_1_E71C1FEE230A1337* BIHPEGKJNHA; // 0x10
	::Class_1_4BFEF016932446F8* KOFBDAHFDDN; // 0x18
