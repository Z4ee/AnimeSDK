...
#define CLASS_1_6DAFAB4384D6638B_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xAB700C0)
#define CLASS_1_6DAFAB4384D6638B_GET_ISEQUIPMENTFULLYTRAINED_OFFSET UNITYSDK_OFFSET(0xAB700E0)
#define CLASS_1_6DAFAB4384D6638B_GET_ISLEVELFULLYTRAINED_OFFSET UNITYSDK_OFFSET(0xAB700D0)
#define CLASS_1_6DAFAB4384D6638B_GET_ISRELICFULLYTRAINED_OFFSET UNITYSDK_OFFSET(0xAB70100)
#define CLASS_1_6DAFAB4384D6638B_GET_ISSKILLTREEFULLYTRAINED_OFFSET UNITYSDK_OFFSET(0xAB700F0)
#define CLASS_1_6DAFAB4384D6638B_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0xAB6FF80)
#define CLASS_1_6DAFAB4384D6638B_METHOD_1_1808E1CF7A125519_2_OFFSET UNITYSDK_OFFSET(0xAB6FFF0)
#define CLASS_1_6DAFAB4384D6638B_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xAB6FF10)
#define CLASS_1_6DAFAB4384D6638B_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xAB70060)
#define CLASS_1_6DAFAB4384D6638B__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6FE90)

inline static constexpr unsigned int Class_1_6DAFAB4384D6638B_TypeDefinitionIndex = 59210;

class Class_1_6DAFAB4384D6638B : public ::System::Object
{
public:
	::RPG::AvatarSystem::IAvatar* _Avatar_k__BackingField; // 0x10
	::System::Boolean _IsRelicFullyTrained_k__BackingField; // 0x18
