...
#define CLASS_1_5B567C8A01BAEDFE_78_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3E9910)
#define CLASS_1_5B567C8A01BAEDFE_78_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3E9720)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3E9820)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3E9790)
#define CLASS_1_5B567C8A01BAEDFE_78_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3E9870)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3E9960)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3E9930)
#define CLASS_1_5B567C8A01BAEDFE_78_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3E9670)
#define CLASS_1_5B567C8A01BAEDFE_78_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3E96D0)
#define CLASS_1_5B567C8A01BAEDFE_78_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3E98A0)
#define CLASS_1_5B567C8A01BAEDFE_78_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3E9900)
#define CLASS_1_5B567C8A01BAEDFE_78__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3E99B0)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3E96F0)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E96E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_78_TypeDefinitionIndex = 25799;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_78*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_78_TypeDefinitionIndex)->GetStaticField(0x62180);
	}
