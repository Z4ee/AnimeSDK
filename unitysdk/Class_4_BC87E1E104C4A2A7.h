...
#define CLASS_4_BC87E1E104C4A2A7_METHOD_4_02FDD26BEE186CA3_OFFSET UNITYSDK_OFFSET(0x1D025AE0)
#define CLASS_4_BC87E1E104C4A2A7_METHOD_4_657D584BE35E89A2_OFFSET UNITYSDK_OFFSET(0x1D025CD0)
#define CLASS_4_BC87E1E104C4A2A7_METHOD_4_6739D2F380E7A5A2_OFFSET UNITYSDK_OFFSET(0x1D025AA0)
#define CLASS_4_BC87E1E104C4A2A7_METHOD_4_998FE0E79A92DBE5_OFFSET UNITYSDK_OFFSET(0x1D025CA0)
#define CLASS_4_BC87E1E104C4A2A7__CTOR_OFFSET UNITYSDK_OFFSET(0x1D025AD0)

inline static constexpr unsigned int Class_4_BC87E1E104C4A2A7_TypeDefinitionIndex = 21038;

class Class_4_BC87E1E104C4A2A7 : public ::RPG::GameCore::PredicateConfig
{
public:
	::RPG::GameCore::DynamicString* NCMKOFAAAOI; // 0x20
	::System::Boolean IIACEHCDKNN; // 0x28
