...
#define MONOUIIMAGEARRAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xF968F90)
#define MONOUIIMAGEARRAY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF968F40)
#define MONOUIIMAGEARRAY_UPDATEANIMATIONS_OFFSET UNITYSDK_OFFSET(0xF969030)
#define MONOUIIMAGEARRAY_UPDATE_OFFSET UNITYSDK_OFFSET(0xF968FD0)
#define MONOUIIMAGEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0xF9693F0)

inline static constexpr unsigned int MonoUIImageArray_TypeDefinitionIndex = 48463;
