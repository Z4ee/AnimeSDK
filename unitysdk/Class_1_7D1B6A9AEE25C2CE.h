...
#define CLASS_1_7D1B6A9AEE25C2CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183A2D60)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_09CCD73C6DC37035_1_OFFSET UNITYSDK_OFFSET(0x183A2C20)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_09CCD73C6DC37035_OFFSET UNITYSDK_OFFSET(0x183A2AE0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_27EBAAFAF5369197_OFFSET UNITYSDK_OFFSET(0x183A2DB0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x183A24A0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x183A2190)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_5E657A2D9C0A02DF_1_OFFSET UNITYSDK_OFFSET(0x183A29F0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_5E657A2D9C0A02DF_OFFSET UNITYSDK_OFFSET(0x183A27C0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_67B5A5B3BC37AA52_OFFSET UNITYSDK_OFFSET(0x183A2860)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x183A2610)
#define CLASS_1_7D1B6A9AEE25C2CE__CTOR_OFFSET UNITYSDK_OFFSET(0x183A20D0)

inline static constexpr unsigned int Class_1_7D1B6A9AEE25C2CE_TypeDefinitionIndex = 54898;

class Class_1_7D1B6A9AEE25C2CE : public ::System::Object
{
public:
	::RPG::GameCore::GameEntity* Field_1_0; // 0x10
	::System::Collections::Generic::List_1<::Class_1_7D1B6A9AEE25C2CE_Class_1_9CBD4493D0516F42*>* Field_1_1; // 0x18
	...
	::Class_1_7D1B6A9AEE25C2CE_Class_1_9CBD4493D0516F42* Method_1_67B5A5B3BC37AA52(::System::String* a1)
	{
		return ((::Class_1_7D1B6A9AEE25C2CE_Class_1_9CBD4493D0516F42*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_67B5A5B3BC37AA52_OFFSET))(this, a1);
	}
