...
#define CLASS_2_0B067CF04045EAA5_METHOD_2_3845AD389B8E1E47_OFFSET UNITYSDK_OFFSET(0x12BA9970)
#define CLASS_2_0B067CF04045EAA5__CTOR_OFFSET UNITYSDK_OFFSET(0x12BA9960)

inline static constexpr unsigned int Class_2_0B067CF04045EAA5_TypeDefinitionIndex = 42408;

class Class_2_0B067CF04045EAA5 : public ::Class_1_7C2D4BBA2A4A8499
{
public:
	::MoleMole::UIWindowController* Field_2_0; // 0x10
	::Class_1_7C2D4BBA2A4A8499* Field_2_2; // 0x18
	::MoleMole::UIMainCityInteractButtonChildWindowController* Field_2_1; // 0x20
