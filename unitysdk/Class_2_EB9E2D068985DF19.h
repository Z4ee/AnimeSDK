...
#define CLASS_2_EB9E2D068985DF19_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A3C170)
#define CLASS_2_EB9E2D068985DF19_METHOD_2_57D21531A2DC98EE_OFFSET UNITYSDK_OFFSET(0x18A3C340)
#define CLASS_2_EB9E2D068985DF19_METHOD_2_77E4508564C6D7D6_OFFSET UNITYSDK_OFFSET(0x18A3C520)
#define CLASS_2_EB9E2D068985DF19_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18A3BDC0)
#define CLASS_2_EB9E2D068985DF19_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18A3BFC0)
#define CLASS_2_EB9E2D068985DF19_TICK_OFFSET UNITYSDK_OFFSET(0x18A3C110)
#define CLASS_2_EB9E2D068985DF19__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3BD30)
...
{
public:
	::RPG::GameCore::EntityTimeRewindComponent* GLBECKBELNK; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::RPG::GameCore::TimeRewindLoopControlStateChangeListener* OFKGLJOAMLD; // 0x28
	::Class_3_07C3C4D2990C49EE* PKIGFJMEKNJ; // 0x30
	::RPG::GameCore::GameEntity* LOBKOPJPFIB; // 0x38
	::System::UInt32 PIBNIOEBKJI; // 0x40
	::System::Int32 CFMADNLMFGL; // 0x44
