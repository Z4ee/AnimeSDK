...
#define MONOPARTICLESYSTEMUPDATEMODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x12E87470)
#define MONOPARTICLESYSTEMUPDATEMODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12E87540)
#define MONOPARTICLESYSTEMUPDATEMODE_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x12E87850)
#define MONOPARTICLESYSTEMUPDATEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12E879E0)

inline static constexpr unsigned int MonoParticleSystemUpdateMode_TypeDefinitionIndex = 89910;
