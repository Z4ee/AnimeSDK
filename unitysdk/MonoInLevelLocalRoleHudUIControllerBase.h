...
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x108A8BD0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_GET_FOLLOWPOS_OFFSET UNITYSDK_OFFSET(0x108A89D0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ISINCAMERAVISIBLERANGE_OFFSET UNITYSDK_OFFSET(0x108AB640)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_LERPCLOSETO_OFFSET UNITYSDK_OFFSET(0x108ABB90)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_LINEFRAMEANIMATION2_OFFSET UNITYSDK_OFFSET(0x108AB820)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x108A8F70)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x108AA680)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONLOCALAVATARCHANGED_OFFSET UNITYSDK_OFFSET(0x108ABC70)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x108AA500)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x108A8DB0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0x108ABAD0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEAFTERCAMERALATEUPDATE_OFFSET UNITYSDK_OFFSET(0x108AA800)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEFOLLOWINFO_OFFSET UNITYSDK_OFFSET(0x108A90F0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEHUDOFFSETX_OFFSET UNITYSDK_OFFSET(0x108AAE60)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEHUDOFFSETY_OFFSET UNITYSDK_OFFSET(0x108AA860)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEPOS_OFFSET UNITYSDK_OFFSET(0x108A94D0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x108ABCD0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x108ABCF0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x108ABE20)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x108ABE30)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x108ABD80)

inline static constexpr unsigned int MonoInLevelLocalRoleHudUIControllerBase_TypeDefinitionIndex = 74890;
...
public:
	...
	::Class_3_DFD5D1FDB9D2A4AC* _followModelComponent; // 0x358
