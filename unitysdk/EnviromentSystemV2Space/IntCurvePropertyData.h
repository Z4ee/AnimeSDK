...
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_526FB29047B22B50_OFFSET UNITYSDK_OFFSET(0xF935740)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0xF9356D0)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_BD4FC714E5BBCF11_OFFSET UNITYSDK_OFFSET(0xF935880)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xF9358D0)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF935870)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int IntCurvePropertyData_TypeDefinitionIndex = 45997;
