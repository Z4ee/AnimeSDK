...
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_0581C760CB3540F9_OFFSET UNITYSDK_OFFSET(0xF1FA160)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0xF1FA0F0)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF1FA340)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int IntCurvePropertyData_TypeDefinitionIndex = 47545;
