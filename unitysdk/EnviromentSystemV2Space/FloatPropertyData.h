...
#define ENVIROMENTSYSTEMV2SPACE_FLOATPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0xF1F9CD0)
#define ENVIROMENTSYSTEMV2SPACE_FLOATPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF1F9D60)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int FloatPropertyData_TypeDefinitionIndex = 47529;
