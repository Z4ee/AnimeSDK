...
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_APPLY_OFFSET UNITYSDK_OFFSET(0xF1DAD80)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_AWAKE_OFFSET UNITYSDK_OFFSET(0xF1DB250)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xF1DACE0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_3D4699CA181772DC_OFFSET UNITYSDK_OFFSET(0xF1DA810)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xF1DB060)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_REFRESHCELESTIAL_OFFSET UNITYSDK_OFFSET(0xF1DA540)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_SETOBSERVER_OFFSET UNITYSDK_OFFSET(0xF1DAA00)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_TICK_OFFSET UNITYSDK_OFFSET(0xF1DACF0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_UPDATEFROMDATA_OFFSET UNITYSDK_OFFSET(0xF1DA630)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0xF1DB2C0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xF1DB2A0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int AtmosphereCelestial_TypeDefinitionIndex = 47504;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AtmosphereCelestial_TypeDefinitionIndex)->GetStaticField(0x8DA0);
		}
