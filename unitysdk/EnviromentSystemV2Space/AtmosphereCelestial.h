...
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_APPLY_OFFSET UNITYSDK_OFFSET(0x15345090)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x15345560)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x15344FF0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_3D4699CA181772DC_OFFSET UNITYSDK_OFFSET(0x15344B20)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x15345370)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_REFRESHCELESTIAL_OFFSET UNITYSDK_OFFSET(0x15344850)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_SETOBSERVER_OFFSET UNITYSDK_OFFSET(0x15344D10)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_TICK_OFFSET UNITYSDK_OFFSET(0x15345000)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_UPDATEFROMDATA_OFFSET UNITYSDK_OFFSET(0x15344940)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x153455E0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x153455B0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int AtmosphereCelestial_TypeDefinitionIndex = 49784;

	class AtmosphereCelestial : public ::RPG::Client::CelestialRenderer
	{
	public:
		static ::System::Int32* StaticGet_CNONBNIELNF()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AtmosphereCelestial_TypeDefinitionIndex)->GetStaticField(0x14CA0);
		}
		::System::String* BGLOMMEGJBP; // 0x50
		::CelestialBodyType KCJFNJALHIE; // 0x58
		...
		::UnityEngine::MaterialPropertyBlock* CAIHEFKEOLA; // 0x68
		::UnityEngine::Renderer* IGEDAHDPAMG; // 0x70
