...
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_APPLY_OFFSET UNITYSDK_OFFSET(0x106C8B10)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x106C8FE0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x106C8A70)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_3D4699CA181772DC_OFFSET UNITYSDK_OFFSET(0x106C85A0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x106C8DF0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_REFRESHCELESTIAL_OFFSET UNITYSDK_OFFSET(0x106C82D0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_SETOBSERVER_OFFSET UNITYSDK_OFFSET(0x106C8790)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_TICK_OFFSET UNITYSDK_OFFSET(0x106C8A80)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_UPDATEFROMDATA_OFFSET UNITYSDK_OFFSET(0x106C83C0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x106C9060)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x106C9030)
...
namespace EnviromentSystemV2Space
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AtmosphereCelestial_TypeDefinitionIndex)->GetStaticField(0x14CB0);
		}
