...
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTTEXTPROPERTYDATA_METHOD_4_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0x135EFCE0)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTTEXTPROPERTYDATA_METHOD_4_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x135EFE10)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTTEXTPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x135EFDF0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int LayoutTextPropertyData_TypeDefinitionIndex = 46551;
