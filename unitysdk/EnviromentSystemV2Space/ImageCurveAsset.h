...
#define ENVIROMENTSYSTEMV2SPACE_IMAGECURVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x135EDB90)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int ImageCurveAsset_TypeDefinitionIndex = 46664;
