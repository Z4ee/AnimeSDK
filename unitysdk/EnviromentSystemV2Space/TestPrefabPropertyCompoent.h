...
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_INIT_OFFSET UNITYSDK_OFFSET(0xF939460)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xF9393C0)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_ONFADING_OFFSET UNITYSDK_OFFSET(0xF939310)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF9394F0)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xF9395C0)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT___IFIXBASEPROXY_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xF939570)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT___IFIXBASEPROXY_ONFADING_OFFSET UNITYSDK_OFFSET(0xF939510)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TestPrefabPropertyCompoent_TypeDefinitionIndex = 45909;
