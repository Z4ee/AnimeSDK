...
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_INIT_OFFSET UNITYSDK_OFFSET(0x17C3DAC0)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0x17C3DA20)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_ONFADING_OFFSET UNITYSDK_OFFSET(0x17C3D970)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3DB50)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TestPrefabPropertyCompoent_TypeDefinitionIndex = 47457;
