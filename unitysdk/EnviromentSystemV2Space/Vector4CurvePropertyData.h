...
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_351DA50719BEBFC5_OFFSET UNITYSDK_OFFSET(0x135F2E50)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_4125303C788B7304_OFFSET UNITYSDK_OFFSET(0x135F3010)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_1_OFFSET UNITYSDK_OFFSET(0x135F2FA0)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0x135F2DE0)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x135F2F80)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int Vector4CurvePropertyData_TypeDefinitionIndex = 46573;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::EnviromentSystemV2Space::PropertyDataBase*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_1_OFFSET))(this, a1);
		}

		::Class_1_EAF7984A8FAD6BE4* Method_3_4125303C788B7304()
		{
			return ((::Class_1_EAF7984A8FAD6BE4*(*)(::PVOID))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_4125303C788B7304_OFFSET))(this);
		}
	};
}
