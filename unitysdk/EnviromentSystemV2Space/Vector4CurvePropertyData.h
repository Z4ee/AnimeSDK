...
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_351DA50719BEBFC5_OFFSET UNITYSDK_OFFSET(0x153A8B10)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0x153A8AA0)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4CURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x153A8C40)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int Vector4CurvePropertyData_TypeDefinitionIndex = 49819;
