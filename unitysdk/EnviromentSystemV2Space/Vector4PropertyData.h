...
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_4F816AD42E79C1BC_OFFSET UNITYSDK_OFFSET(0x10373E40)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_82ABFE24D5168B0C_1_OFFSET UNITYSDK_OFFSET(0x10373E50)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x10373D50)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_F6AE0F54C683F5CD_OFFSET UNITYSDK_OFFSET(0x10373C60)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10373E20)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int Vector4PropertyData_TypeDefinitionIndex = 40074;
