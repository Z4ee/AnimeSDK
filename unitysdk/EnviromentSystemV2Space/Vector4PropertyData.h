...
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_2F9585153299F34B_OFFSET UNITYSDK_OFFSET(0x17C3EAD0)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x17C3EBC0)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3EC60)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int Vector4PropertyData_TypeDefinitionIndex = 47531;
