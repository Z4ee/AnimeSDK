...
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_2F9585153299F34B_OFFSET UNITYSDK_OFFSET(0x199E7620)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x199E7710)
#define ENVIROMENTSYSTEMV2SPACE_VECTOR4PROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x199E77B0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int Vector4PropertyData_TypeDefinitionIndex = 49812;
