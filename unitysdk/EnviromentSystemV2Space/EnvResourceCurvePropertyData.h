...
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_1A1283E6D869BB8A_OFFSET UNITYSDK_OFFSET(0x135DAE30)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_2FE5140487F63CFB_OFFSET UNITYSDK_OFFSET(0x135DB080)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_7BFF527DB4C449CA_OFFSET UNITYSDK_OFFSET(0x135DB090)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_A034FB093FB7C7DD_OFFSET UNITYSDK_OFFSET(0x135DAF40)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x135DB060)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int EnvResourceCurvePropertyData_TypeDefinitionIndex = 46569;
	...
	public:
		...
		::System::Boolean Method_3_2FE5140487F63CFB(::EnviromentSystemV2Space::PropertyDataBase* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::EnviromentSystemV2Space::PropertyDataBase*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_2FE5140487F63CFB_OFFSET))(this, a1);
		}
