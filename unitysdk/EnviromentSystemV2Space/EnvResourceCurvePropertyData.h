...
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_4F816AD42E79C1BC_OFFSET UNITYSDK_OFFSET(0x1035BF90)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_7BFF527DB4C449CA_OFFSET UNITYSDK_OFFSET(0x1035BFA0)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_A034FB093FB7C7DD_OFFSET UNITYSDK_OFFSET(0x1035BD00)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_F6AE0F54C683F5CD_OFFSET UNITYSDK_OFFSET(0x1035BC00)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1035BF70)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int EnvResourceCurvePropertyData_TypeDefinitionIndex = 40077;
