...
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA_METHOD_4_F2B94768004EB1C1_OFFSET UNITYSDK_OFFSET(0x10370DB0)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA_METHOD_4_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x10370E90)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10370E80)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int LayoutVector4PropertyData_TypeDefinitionIndex = 40058;
