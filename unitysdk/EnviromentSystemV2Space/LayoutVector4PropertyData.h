...
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA_METHOD_4_F2B94768004EB1C1_OFFSET UNITYSDK_OFFSET(0x17C3BD10)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3BDC0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int LayoutVector4PropertyData_TypeDefinitionIndex = 47515;
