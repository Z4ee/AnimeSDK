...
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_APPLY_OFFSET UNITYSDK_OFFSET(0xF1E0FB0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0xF1DBD10)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_3867C36D1420E61A_OFFSET UNITYSDK_OFFSET(0xF1DC760)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_3E06E2491B129B22_OFFSET UNITYSDK_OFFSET(0xF1E0DB0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xF1E0C60)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_AFECFD7779937DC6_OFFSET UNITYSDK_OFFSET(0xF1DCB80)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_C75AEDD60282682F_OFFSET UNITYSDK_OFFSET(0xF1DE6C0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xF1E0B40)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xF1E0BD0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_ONFADING_OFFSET UNITYSDK_OFFSET(0xF1E0A90)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0xF1E1000)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0xF1DDB60)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF1DCC90)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int ES_ParticleComponent_TypeDefinitionIndex = 47449;
