...
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_APPLY_OFFSET UNITYSDK_OFFSET(0xF91E230)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0xF918FC0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_3867C36D1420E61A_OFFSET UNITYSDK_OFFSET(0xF9198A0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_3E06E2491B129B22_OFFSET UNITYSDK_OFFSET(0xF91E030)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xF91DEE0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_AFECFD7779937DC6_OFFSET UNITYSDK_OFFSET(0xF919CC0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_METHOD_6_C75AEDD60282682F_OFFSET UNITYSDK_OFFSET(0xF91B6B0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xF91DDC0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xF91DE50)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_ONFADING_OFFSET UNITYSDK_OFFSET(0xF91DD10)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0xF91E280)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0xF91AB00)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF919DD0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_APPLY_OFFSET UNITYSDK_OFFSET(0xF91E4A0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xF91E2F0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xF91E400)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xF91E450)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_ONFADING_OFFSET UNITYSDK_OFFSET(0xF91E3A0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0xF91E4F0)
#define ENVIROMENTSYSTEMV2SPACE_ES_PARTICLECOMPONENT___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xF91E340)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int ES_ParticleComponent_TypeDefinitionIndex = 45901;
