...
#define ENVIROMENTSYSTEMV2SPACE_ES_CLOUDPARTICLECOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0x106C9A80)
#define ENVIROMENTSYSTEMV2SPACE_ES_CLOUDPARTICLECOMPONENT_METHOD_7_E8F71BC8471C5469_OFFSET UNITYSDK_OFFSET(0x106CA5E0)
#define ENVIROMENTSYSTEMV2SPACE_ES_CLOUDPARTICLECOMPONENT_METHOD_7_FE268EA0D7E91617_OFFSET UNITYSDK_OFFSET(0x106C9D60)
#define ENVIROMENTSYSTEMV2SPACE_ES_CLOUDPARTICLECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x106CA9E0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int ES_CloudParticleComponent_TypeDefinitionIndex = 49725;
