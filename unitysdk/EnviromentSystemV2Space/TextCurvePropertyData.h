...
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_080F02908C048D30_OFFSET UNITYSDK_OFFSET(0x135F1F20)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0x135F1EB0)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0x135F2160)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x135F21B0)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x135F2150)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TextCurvePropertyData_TypeDefinitionIndex = 46579;
	...
	public:
		...
		::System::Boolean Method_3_E3DABABAFC459BA9(::EnviromentSystemV2Space::PropertyDataBase* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::EnviromentSystemV2Space::PropertyDataBase*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_E3DABABAFC459BA9_OFFSET))(this, a1);
		}
