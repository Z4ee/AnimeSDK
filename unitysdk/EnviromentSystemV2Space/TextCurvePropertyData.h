...
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_35F88F8F0390DB9A_OFFSET UNITYSDK_OFFSET(0x199E6740)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0x199E66D0)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x199E68F0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TextCurvePropertyData_TypeDefinitionIndex = 49825;
