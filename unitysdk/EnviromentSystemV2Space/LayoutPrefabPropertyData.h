...
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTPREFABPROPERTYDATA_METHOD_4_A8D19485AA054B2A_OFFSET UNITYSDK_OFFSET(0x135EFBB0)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTPREFABPROPERTYDATA_METHOD_4_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x135EFC90)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTPREFABPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x135EFC70)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int LayoutPrefabPropertyData_TypeDefinitionIndex = 46553;
