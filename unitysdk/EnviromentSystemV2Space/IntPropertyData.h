...
#define ENVIROMENTSYSTEMV2SPACE_INTPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x106E8540)
#define ENVIROMENTSYSTEMV2SPACE_INTPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x106E85D0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int IntPropertyData_TypeDefinitionIndex = 49809;
