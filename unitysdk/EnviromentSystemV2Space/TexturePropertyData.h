...
#define ENVIROMENTSYSTEMV2SPACE_TEXTUREPROPERTYDATA_METHOD_3_4F816AD42E79C1BC_OFFSET UNITYSDK_OFFSET(0xF939E10)
#define ENVIROMENTSYSTEMV2SPACE_TEXTUREPROPERTYDATA_METHOD_3_59779CE445A59A8E_OFFSET UNITYSDK_OFFSET(0xF939E20)
#define ENVIROMENTSYSTEMV2SPACE_TEXTUREPROPERTYDATA_METHOD_3_E4886687508BA48F_OFFSET UNITYSDK_OFFSET(0xF939D30)
#define ENVIROMENTSYSTEMV2SPACE_TEXTUREPROPERTYDATA_METHOD_3_F6AE0F54C683F5CD_OFFSET UNITYSDK_OFFSET(0xF939C60)
#define ENVIROMENTSYSTEMV2SPACE_TEXTUREPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF939DF0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TexturePropertyData_TypeDefinitionIndex = 45987;
