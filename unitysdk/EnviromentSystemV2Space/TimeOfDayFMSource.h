...
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x153A86A0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_AUTOACTIVE_OFFSET UNITYSDK_OFFSET(0x153A8780)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0x153A87C0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x153A8700)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x153A8760)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x153A85B0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELACTIVE_OFFSET UNITYSDK_OFFSET(0x153A8800)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELDEACTIVE_OFFSET UNITYSDK_OFFSET(0x153A8850)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELUPDATE_OFFSET UNITYSDK_OFFSET(0x153A8890)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x153A8410)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x153A8280)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_REGISTERSOURCE_OFFSET UNITYSDK_OFFSET(0x153A82D0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SAMPLE_OFFSET UNITYSDK_OFFSET(0x153A88F0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x153A8770)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_UNREGISTERSOURCE_OFFSET UNITYSDK_OFFSET(0x153A8460)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_UPDATE_OFFSET UNITYSDK_OFFSET(0x153A8550)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x153A89E0)
