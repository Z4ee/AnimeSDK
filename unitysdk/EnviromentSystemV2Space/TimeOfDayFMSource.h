...
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x135F29E0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_AUTOACTIVE_OFFSET UNITYSDK_OFFSET(0x135F2AC0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0x135F2B00)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x135F2A40)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x135F2AA0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x135F28F0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELACTIVE_OFFSET UNITYSDK_OFFSET(0x135F2B40)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELDEACTIVE_OFFSET UNITYSDK_OFFSET(0x135F2B90)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELUPDATE_OFFSET UNITYSDK_OFFSET(0x135F2BD0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x135F2750)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x135F25C0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_REGISTERSOURCE_OFFSET UNITYSDK_OFFSET(0x135F2610)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SAMPLE_OFFSET UNITYSDK_OFFSET(0x135F2C30)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x135F2AB0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_UNREGISTERSOURCE_OFFSET UNITYSDK_OFFSET(0x135F27A0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_UPDATE_OFFSET UNITYSDK_OFFSET(0x135F2890)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x135F2D20)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TimeOfDayFMSource_TypeDefinitionIndex = 46737;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_348*(*)(::PVOID))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_GET_OWNERFMSYSTEM_OFFSET))(this);
		}

		::System::Void set_OwnerFMSystem(::Class_0_16E4307DCC419505_348* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_348*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SET_OWNERFMSYSTEM_OFFSET))(this, a1);
		}
