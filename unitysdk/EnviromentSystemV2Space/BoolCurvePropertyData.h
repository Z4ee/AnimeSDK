...
#define ENVIROMENTSYSTEMV2SPACE_BOOLCURVEPROPERTYDATA_METHOD_2_0581C760CB3540F9_OFFSET UNITYSDK_OFFSET(0xF1DB380)
#define ENVIROMENTSYSTEMV2SPACE_BOOLCURVEPROPERTYDATA_METHOD_2_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0xF1DB310)
#define ENVIROMENTSYSTEMV2SPACE_BOOLCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF1DB560)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int BoolCurvePropertyData_TypeDefinitionIndex = 47546;
