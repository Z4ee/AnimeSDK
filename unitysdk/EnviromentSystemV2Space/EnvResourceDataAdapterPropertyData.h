...
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCEDATAADAPTERPROPERTYDATA_METHOD_3_1180333F99735694_OFFSET UNITYSDK_OFFSET(0x106D3CF0)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCEDATAADAPTERPROPERTYDATA_METHOD_3_A8D19485AA054B2A_OFFSET UNITYSDK_OFFSET(0x106D3DF0)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCEDATAADAPTERPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x106D3EB0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int EnvResourceDataAdapterPropertyData_TypeDefinitionIndex = 49814;
