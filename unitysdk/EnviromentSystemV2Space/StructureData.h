...
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_41C51713E73DC838_OFFSET UNITYSDK_OFFSET(0x135F1880)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_9AB715FC68AE0629_OFFSET UNITYSDK_OFFSET(0x135F1A50)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_E3DABABAFC459BA9_1_OFFSET UNITYSDK_OFFSET(0x135F1B00)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0x135F1830)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x135F1B50)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x135F1AB0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int StructureData_TypeDefinitionIndex = 46582;
	...
	public:
		...
		::System::Boolean Method_2_E3DABABAFC459BA9_1(::EnviromentSystemV2Space::PropertyDataBase* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::EnviromentSystemV2Space::PropertyDataBase*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_E3DABABAFC459BA9_1_OFFSET))(this, a1);
		}
