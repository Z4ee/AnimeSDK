...
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_41C51713E73DC838_OFFSET UNITYSDK_OFFSET(0x17C3D6E0)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_9AB715FC68AE0629_OFFSET UNITYSDK_OFFSET(0x17C3D8B0)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0x17C3D690)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3D910)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int StructureData_TypeDefinitionIndex = 47547;
