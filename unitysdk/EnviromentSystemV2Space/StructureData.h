...
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_647B967D27CD1AE1_OFFSET UNITYSDK_OFFSET(0xF939000)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_9AB715FC68AE0629_OFFSET UNITYSDK_OFFSET(0xF9391C0)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_BD4FC714E5BBCF11_OFFSET UNITYSDK_OFFSET(0xF939270)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0xF938FB0)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xF9392C0)
#define ENVIROMENTSYSTEMV2SPACE_STRUCTUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF939220)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int StructureData_TypeDefinitionIndex = 45999;
