...
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA_METHOD_4_35F88F8F0390DB9A_OFFSET UNITYSDK_OFFSET(0x17C3CFF0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA_METHOD_4_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0x17C3CFA0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3D160)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PrefabCurvePropertyData_TypeDefinitionIndex = 47543;
