...
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA_METHOD_3_6A79026F335B11B2_OFFSET UNITYSDK_OFFSET(0xF1F9AE0)
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA_METHOD_3_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0xF1F9BD0)
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF1F9CB0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int FloatCurvePropertyData_TypeDefinitionIndex = 47537;
