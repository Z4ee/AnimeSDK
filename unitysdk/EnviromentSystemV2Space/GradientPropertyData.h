...
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTPROPERTYDATA_METHOD_3_59779CE445A59A8E_OFFSET UNITYSDK_OFFSET(0x1036E8B0)
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTPROPERTYDATA_METHOD_3_5D28844943114DA6_OFFSET UNITYSDK_OFFSET(0x1036E840)
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTPROPERTYDATA_METHOD_3_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0x1036E6F0)
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTPROPERTYDATA_METHOD_3_E4886687508BA48F_OFFSET UNITYSDK_OFFSET(0x1036E760)
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1036E820)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int GradientPropertyData_TypeDefinitionIndex = 40082;
