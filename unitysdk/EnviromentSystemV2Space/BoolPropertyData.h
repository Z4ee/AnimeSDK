...
#define ENVIROMENTSYSTEMV2SPACE_BOOLPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x153458A0)
#define ENVIROMENTSYSTEMV2SPACE_BOOLPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15345930)
