...
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYDATA_METHOD_3_1180333F99735694_OFFSET UNITYSDK_OFFSET(0x15367FC0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYDATA_METHOD_3_A8D19485AA054B2A_OFFSET UNITYSDK_OFFSET(0x153680C0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15367D10)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PrefabPropertyData_TypeDefinitionIndex = 49817;
