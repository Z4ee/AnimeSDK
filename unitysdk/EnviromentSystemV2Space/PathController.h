...
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x15367900)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x15367870)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x15367820)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x153678C0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_2747B6E1C570CBE2_OFFSET UNITYSDK_OFFSET(0x153670A0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_4415A966EAD05399_OFFSET UNITYSDK_OFFSET(0x15367610)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_64193BDBED1866DF_OFFSET UNITYSDK_OFFSET(0x15367360)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_705FFC79B57F4953_OFFSET UNITYSDK_OFFSET(0x15366D20)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_7E832D0C2C340C33_OFFSET UNITYSDK_OFFSET(0x15366FC0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_FD6692A5F6B0AC0C_OFFSET UNITYSDK_OFFSET(0x15366B70)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15366EE0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15366CD0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15366960)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x153679E0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x15366B20)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15366F30)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15367A80)
