...
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x106EB380)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x106EB2F0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x106EB2A0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x106EB340)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_2747B6E1C570CBE2_OFFSET UNITYSDK_OFFSET(0x106EAB20)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_4415A966EAD05399_OFFSET UNITYSDK_OFFSET(0x106EB090)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_64193BDBED1866DF_OFFSET UNITYSDK_OFFSET(0x106EADE0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_705FFC79B57F4953_OFFSET UNITYSDK_OFFSET(0x106EA7A0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_7E832D0C2C340C33_OFFSET UNITYSDK_OFFSET(0x106EAA40)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_FD6692A5F6B0AC0C_OFFSET UNITYSDK_OFFSET(0x106EA5F0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x106EA960)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x106EA750)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x106EA3E0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x106EB460)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x106EA5A0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x106EA9B0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x106EB500)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PathController_TypeDefinitionIndex = 49979;
	...
	public:
		...
		::System::Boolean JMPLBPFAKME; // 0x25
		::System::Boolean ShowDebugGizmos; // 0x26
		::UnityEngine::Color PathColor; // 0x28
		::System::Single GizmoSize; // 0x38
		::System::Single OELDIGFLKJH; // 0x3C
		::System::Int32 JJFBDJKBNPM; // 0x40
		::System::Single BBELABMDJIP; // 0x44
		::System::Single EFEDPMOPJBN; // 0x48
		::System::Single FLOLNDOIEIF; // 0x4C
