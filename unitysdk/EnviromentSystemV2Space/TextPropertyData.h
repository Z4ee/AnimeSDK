...
#define ENVIROMENTSYSTEMV2SPACE_TEXTPROPERTYDATA_METHOD_3_50F156471F8D4EB9_OFFSET UNITYSDK_OFFSET(0x17C3DDB0)
#define ENVIROMENTSYSTEMV2SPACE_TEXTPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x17C3DE80)
#define ENVIROMENTSYSTEMV2SPACE_TEXTPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17C3DF20)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TextPropertyData_TypeDefinitionIndex = 47532;
