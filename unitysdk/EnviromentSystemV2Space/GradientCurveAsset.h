...
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTCURVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xF1F9D80)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int GradientCurveAsset_TypeDefinitionIndex = 47626;
