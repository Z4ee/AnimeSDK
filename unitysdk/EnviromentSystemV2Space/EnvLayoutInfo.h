...
#define ENVIROMENTSYSTEMV2SPACE_ENVLAYOUTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xF920000)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int EnvLayoutInfo_TypeDefinitionIndex = 46001;
