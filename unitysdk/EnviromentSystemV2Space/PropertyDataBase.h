...
#define ENVIROMENTSYSTEMV2SPACE_PROPERTYDATABASE_METHOD_1_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0xF9181E0)
#define ENVIROMENTSYSTEMV2SPACE_PROPERTYDATABASE_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xF918270)
#define ENVIROMENTSYSTEMV2SPACE_PROPERTYDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0xF918180)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PropertyDataBase_TypeDefinitionIndex = 45978;
