...
#define ENVIROMENTSYSTEMV2SPACE_PROPERTYDATABASE_METHOD_1_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0x1036EC80)
#define ENVIROMENTSYSTEMV2SPACE_PROPERTYDATABASE_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1036ED10)
#define ENVIROMENTSYSTEMV2SPACE_PROPERTYDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1036EC20)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PropertyDataBase_TypeDefinitionIndex = 40069;
