...
#define ENVIROMENTSYSTEMV2SPACE_IMAGECURVETESTBEHAVIOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x135EDC00)
#define ENVIROMENTSYSTEMV2SPACE_IMAGECURVETESTBEHAVIOR_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x135EDCD0)
#define ENVIROMENTSYSTEMV2SPACE_IMAGECURVETESTBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x135EDD20)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int ImageCurveTestBehavior_TypeDefinitionIndex = 46665;
