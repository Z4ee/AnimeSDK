...
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRSSCASSET_METHOD_3_AA919A9E63C8C412_OFFSET UNITYSDK_OFFSET(0x106E9850)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRSSCASSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x106E96D0)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRSSCASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x106E9A90)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int LLGKeyValuePairsScAsset_TypeDefinitionIndex = 49616;
