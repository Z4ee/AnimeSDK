...
#define CLASS_2_4BEBDA9BF8D8694A_GET_ENABLERUNTIMETICK_OFFSET UNITYSDK_OFFSET(0x198FEA50)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_59D66E8B78D34F93_OFFSET UNITYSDK_OFFSET(0x198FE220)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x198FCF90)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x198FD7E0)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_C4533278489E08D3_OFFSET UNITYSDK_OFFSET(0x198FE070)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_CD48C834B961DFED_OFFSET UNITYSDK_OFFSET(0x198FDA50)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0x198FCD00)
#define CLASS_2_4BEBDA9BF8D8694A_METHOD_2_FBA4254EF4E174E5_OFFSET UNITYSDK_OFFSET(0x198FE650)
#define CLASS_2_4BEBDA9BF8D8694A__CTOR_OFFSET UNITYSDK_OFFSET(0x198FEA60)
...
{
public:
	::Class_2_4BEBDA9BF8D8694A_Class_1_5D9E8B61A63FE4D2* GJBOKLDCKEG; // 0x30
	::System::Collections::Generic::List_1<::RPG::Client::TAUtils::SimpleTransform>* IKJPLHINJMH; // 0x38
	::System::Collections::Generic::List_1<::UnityEngine::Vector3>* EJJJMLPECEJ; // 0x40
	::Il2CppArray<::System::Nullable_1<::UnityEngine::Vector3>>* AMFAHMJGOEE; // 0x48
	::System::Collections::Generic::List_1<::UnityEngine::Matrix4x4>* GINMNCLNFCF; // 0x50
	::System::Collections::Generic::Queue_1<::UnityEngine::Vector3>* JAHPONLMCEN; // 0x58
	::UnityEngine::Vector3 NIMMIBKOCCC; // 0x60
	::UnityEngine::Vector3 OGPDIJFMIHM; // 0x6C
	::System::Boolean IKKGNCDIAAC; // 0x78
	::UnityEngine::Vector3 MLPLPKGKGEG; // 0x7C
	::System::Int32 HOGEMAHFFEF; // 0x88
	::UnityEngine::Vector3 EHAIKBDMGFJ; // 0x8C
	::UnityEngine::Vector3 PCEBHJHHLLF; // 0x98
	::System::Int32 HOCMHABKLGJ; // 0xA4
	::System::Single MJNJKFNENFD; // 0xA8
	::System::Int32 KBJBJFNMKJD; // 0xAC
