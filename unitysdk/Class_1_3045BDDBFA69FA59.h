...
#define CLASS_1_3045BDDBFA69FA59_DISPOSE_OFFSET UNITYSDK_OFFSET(0x157FEA20)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0x157FEB60)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_44560CD97EB472CA_OFFSET UNITYSDK_OFFSET(0x157FEF10)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_60C1459D67942397_OFFSET UNITYSDK_OFFSET(0x157FEEA0)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x157FEBE0)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_BE37496E03846CA0_OFFSET UNITYSDK_OFFSET(0x157FEE20)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_CF62297C914431A3_OFFSET UNITYSDK_OFFSET(0x157FEA70)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x157FE840)
#define CLASS_1_3045BDDBFA69FA59_METHOD_1_FA1D6D2A00DD7F70_OFFSET UNITYSDK_OFFSET(0x157FEC90)
#define CLASS_1_3045BDDBFA69FA59__CTOR_OFFSET UNITYSDK_OFFSET(0x157FE7D0)

inline static constexpr unsigned int Class_1_3045BDDBFA69FA59_TypeDefinitionIndex = 76783;

class Class_1_3045BDDBFA69FA59 : public ::System::Object
{
public:
	::Class_2_80F8710F847F1248* EEFMDEHLLFI; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::ElfPhaseItem*>* FDCIANLOAKA; // 0x18
	::Il2CppArray<::RPG::GameCore::ElfFeverSkillLevelConfig*>* FNJGLPKPMLD; // 0x20
	::Class_3_F4528A5C0F861AF2* PDENFEFCAGN; // 0x28
	::System::Boolean APKKODLBBCJ; // 0x30
	::System::Boolean NCBKBIDGMEC; // 0x31
	::System::Boolean HNFOMLKKNKI; // 0x32
	::System::Boolean JNFGEINAAPA; // 0x33
