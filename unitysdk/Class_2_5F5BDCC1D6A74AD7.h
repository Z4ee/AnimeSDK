...
#define CLASS_2_5F5BDCC1D6A74AD7_METHOD_2_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x139889B0)
#define CLASS_2_5F5BDCC1D6A74AD7_METHOD_2_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x13988800)
#define CLASS_2_5F5BDCC1D6A74AD7_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x13988900)
#define CLASS_2_5F5BDCC1D6A74AD7__CTOR_OFFSET UNITYSDK_OFFSET(0x13988750)

inline static constexpr unsigned int Class_2_5F5BDCC1D6A74AD7_TypeDefinitionIndex = 46452;

class Class_2_5F5BDCC1D6A74AD7 : public ::Class_1_43BD383C98B4C0C5_69
{
public:
	// static const ::System::String* Field_2_5; // 0x0
	::MoleMole::UISummerMissionTipsWidgetController* Field_2_0; // 0x10
	::Class_2_A2C95BEE51D13F24* Field_2_7; // 0x18
