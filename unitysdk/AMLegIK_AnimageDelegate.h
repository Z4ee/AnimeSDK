...
#define AMLEGIK_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14621660)
#define AMLEGIK_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14621690)
#define AMLEGIK_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x146213C0)
#define AMLEGIK_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x146213B0)

inline static constexpr unsigned int AMLegIK_AnimageDelegate_TypeDefinitionIndex = 60613;
