...
#define AMLEGIK_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14914B90)
#define AMLEGIK_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14914BC0)
#define AMLEGIK_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x14914900)
#define AMLEGIK_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x149148E0)

inline static constexpr unsigned int AMLegIK_AnimageDelegate_TypeDefinitionIndex = 72589;
