...
#define CLASS_2_3042EFC0D10D9243_DISPOSE_OFFSET UNITYSDK_OFFSET(0x181A2F00)
#define CLASS_2_3042EFC0D10D9243_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x181A2DA0)
#define CLASS_2_3042EFC0D10D9243_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x181A2F40)
#define CLASS_2_3042EFC0D10D9243_TICK_OFFSET UNITYSDK_OFFSET(0x181A2F90)
#define CLASS_2_3042EFC0D10D9243__CTOR_OFFSET UNITYSDK_OFFSET(0x181A2D90)

inline static constexpr unsigned int Class_2_3042EFC0D10D9243_TypeDefinitionIndex = 50388;

class Class_2_3042EFC0D10D9243 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TwinkleFlipperLightDevice* Field_2_0; // 0x18
