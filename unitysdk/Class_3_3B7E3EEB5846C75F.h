...
#define CLASS_3_3B7E3EEB5846C75F_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x13C53C40)
#define CLASS_3_3B7E3EEB5846C75F_METHOD_3_627734491883CD35_OFFSET UNITYSDK_OFFSET(0x13C54040)
#define CLASS_3_3B7E3EEB5846C75F_METHOD_3_699E0D9B164B60CD_OFFSET UNITYSDK_OFFSET(0x13C53DE0)
#define CLASS_3_3B7E3EEB5846C75F_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x13C53FB0)
#define CLASS_3_3B7E3EEB5846C75F_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x13C53D40)
#define CLASS_3_3B7E3EEB5846C75F_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x13C53B10)
#define CLASS_3_3B7E3EEB5846C75F__CCTOR_OFFSET UNITYSDK_OFFSET(0x13C53C90)
#define CLASS_3_3B7E3EEB5846C75F__CTOR_OFFSET UNITYSDK_OFFSET(0x13C53D10)

inline static constexpr unsigned int Class_3_3B7E3EEB5846C75F_TypeDefinitionIndex = 52050;

class Class_3_3B7E3EEB5846C75F : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_13 = 0xF; // 0x0
	::UnityEngine::Rigidbody* Field_3_3; // 0x48
	::UnityEngine::Vector3 Field_3_0; // 0x50
	::System::Single Field_3_11; // 0x5C
	::MoleMole::Vector2Int Field_3_14; // 0x60
	::UnityEngine::Vector3 Field_3_1; // 0x68
	::UnityEngine::Vector3 Field_3_4; // 0x74
	::System::Single Field_3_15; // 0x80
	::System::Single Field_3_2; // 0x84
	::UnityEngine::Vector3 Field_3_6; // 0x88
	::System::Single Field_3_10; // 0x94
	::System::Boolean Field_3_5; // 0x98
	::System::Boolean Field_3_9; // 0x99
	::System::Boolean Field_3_8; // 0x9A
	::Enum_3_7C06B45C208A25D4 Field_3_7; // 0x9C
