...
#define CLASS_2_B854FD6C970DC710_DISPOSE_OFFSET UNITYSDK_OFFSET(0x144600A0)
#define CLASS_2_B854FD6C970DC710_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x144603C0)
#define CLASS_2_B854FD6C970DC710_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x144600F0)
#define CLASS_2_B854FD6C970DC710_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14460310)
#define CLASS_2_B854FD6C970DC710_TICK_OFFSET UNITYSDK_OFFSET(0x14460360)
#define CLASS_2_B854FD6C970DC710__CTOR_OFFSET UNITYSDK_OFFSET(0x14460090)

inline static constexpr unsigned int Class_2_B854FD6C970DC710_TypeDefinitionIndex = 49301;

class Class_2_B854FD6C970DC710 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ConvinceInitialize* Field_2_0; // 0x18
