...
#define CLASS_1_5B567C8A01BAEDFE_29_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C0B980)
#define CLASS_1_5B567C8A01BAEDFE_29_CLONE_OFFSET UNITYSDK_OFFSET(0x19C0B7F0)
#define CLASS_1_5B567C8A01BAEDFE_29_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C0B890)
#define CLASS_1_5B567C8A01BAEDFE_29_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C0B830)
#define CLASS_1_5B567C8A01BAEDFE_29_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C0B8E0)
#define CLASS_1_5B567C8A01BAEDFE_29_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C0B9D0)
#define CLASS_1_5B567C8A01BAEDFE_29_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C0B9A0)
#define CLASS_1_5B567C8A01BAEDFE_29_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C0B770)
#define CLASS_1_5B567C8A01BAEDFE_29_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C0B7A0)
#define CLASS_1_5B567C8A01BAEDFE_29_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C0B910)
#define CLASS_1_5B567C8A01BAEDFE_29_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C0B970)
#define CLASS_1_5B567C8A01BAEDFE_29__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C0BA20)
#define CLASS_1_5B567C8A01BAEDFE_29__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C0B7C0)
#define CLASS_1_5B567C8A01BAEDFE_29__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0B7B0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_29_TypeDefinitionIndex = 25095;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_29*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_29_TypeDefinitionIndex)->GetStaticField(0x564D0);
	}
