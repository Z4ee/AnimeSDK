...
#define CLASS_1_5B567C8A01BAEDFE_29_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6CFCE0)
#define CLASS_1_5B567C8A01BAEDFE_29_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6CFB50)
#define CLASS_1_5B567C8A01BAEDFE_29_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6CFBF0)
#define CLASS_1_5B567C8A01BAEDFE_29_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6CFB90)
#define CLASS_1_5B567C8A01BAEDFE_29_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6CFC40)
#define CLASS_1_5B567C8A01BAEDFE_29_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6CFD30)
#define CLASS_1_5B567C8A01BAEDFE_29_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6CFD00)
#define CLASS_1_5B567C8A01BAEDFE_29_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A6CFAD0)
#define CLASS_1_5B567C8A01BAEDFE_29_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A6CFB00)
#define CLASS_1_5B567C8A01BAEDFE_29_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6CFC70)
#define CLASS_1_5B567C8A01BAEDFE_29_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A6CFCD0)
#define CLASS_1_5B567C8A01BAEDFE_29__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6CFD80)
#define CLASS_1_5B567C8A01BAEDFE_29__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6CFB20)
#define CLASS_1_5B567C8A01BAEDFE_29__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6CFB10)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_29_TypeDefinitionIndex = 24958;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_29*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_29_TypeDefinitionIndex)->GetStaticField(0x33B40);
	}
