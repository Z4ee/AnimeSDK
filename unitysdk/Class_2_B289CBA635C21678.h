...
#define CLASS_2_B289CBA635C21678_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1003E0C0)
#define CLASS_2_B289CBA635C21678_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1003E100)
#define CLASS_2_B289CBA635C21678_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1003E240)
#define CLASS_2_B289CBA635C21678_TICK_OFFSET UNITYSDK_OFFSET(0x1003E290)
#define CLASS_2_B289CBA635C21678__CTOR_OFFSET UNITYSDK_OFFSET(0x1003E0A0)

inline static constexpr unsigned int Class_2_B289CBA635C21678_TypeDefinitionIndex = 52062;

class Class_2_B289CBA635C21678 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_36264895A759B0FF* Field_2_2; // 0x18
	::RPG::GameCore::WaitTimeline* Field_2_0; // 0x20
