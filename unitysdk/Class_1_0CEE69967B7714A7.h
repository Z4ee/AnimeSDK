...
#define CLASS_1_0CEE69967B7714A7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4C77A0)
#define CLASS_1_0CEE69967B7714A7_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4C6FB0)
#define CLASS_1_0CEE69967B7714A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4C70D0)
#define CLASS_1_0CEE69967B7714A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4C7070)
#define CLASS_1_0CEE69967B7714A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4C72F0)
#define CLASS_1_0CEE69967B7714A7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4C7930)
#define CLASS_1_0CEE69967B7714A7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4C78C0)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E4C7000)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E4C6DA0)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E4C7010)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1E4C7030)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_90576C13897574AE_OFFSET UNITYSDK_OFFSET(0x1E4C7060)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1E4C7020)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E4C7050)
#define CLASS_1_0CEE69967B7714A7_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E4C7040)
#define CLASS_1_0CEE69967B7714A7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4C6E00)
#define CLASS_1_0CEE69967B7714A7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4C7540)
#define CLASS_1_0CEE69967B7714A7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4C75A0)
#define CLASS_1_0CEE69967B7714A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4C7A40)
#define CLASS_1_0CEE69967B7714A7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4C6EB0)
#define CLASS_1_0CEE69967B7714A7__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4C6E10)

inline static constexpr unsigned int Class_1_0CEE69967B7714A7_TypeDefinitionIndex = 25156;

class Class_1_0CEE69967B7714A7 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::System::Double>** StaticGet_FCNMONMFJEF()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0CEE69967B7714A7_TypeDefinitionIndex)->GetStaticField(0x1AF60);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_0CEE69967B7714A7*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0CEE69967B7714A7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0CEE69967B7714A7_TypeDefinitionIndex)->GetStaticField(0x1AF68);
	}
	// static const ::System::Int32 BCMOOHPKBDG = 0x1; // 0x0
	// static const ::System::Int32 IADILMFABOH = 0x2; // 0x0
	// static const ::System::Int32 JBEIEHCLLNH = 0x3; // 0x0
	// static const ::System::Int32 GEJEJNNMGGP = 0x4; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::System::Double>* AFNHANNCAMC; // 0x18
	::System::Double NMABHKCOLCM; // 0x20
	::System::UInt32 KBIKDALMALD; // 0x28
	::System::Boolean EIPIJPDLIHO; // 0x2C
