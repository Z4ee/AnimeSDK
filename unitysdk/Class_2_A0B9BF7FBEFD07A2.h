...
#define CLASS_2_A0B9BF7FBEFD07A2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18AA4500)
#define CLASS_2_A0B9BF7FBEFD07A2_METHOD_2_E49FC3D0AC1CB0F6_OFFSET UNITYSDK_OFFSET(0x18AA41F0)
#define CLASS_2_A0B9BF7FBEFD07A2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18AA3F50)
#define CLASS_2_A0B9BF7FBEFD07A2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18AA4440)
#define CLASS_2_A0B9BF7FBEFD07A2_TICK_OFFSET UNITYSDK_OFFSET(0x18AA4670)
#define CLASS_2_A0B9BF7FBEFD07A2__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA3E60)

inline static constexpr unsigned int Class_2_A0B9BF7FBEFD07A2_TypeDefinitionIndex = 53044;

class Class_2_A0B9BF7FBEFD07A2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_07C3C4D2990C49EE* CNDAFHGGFOE; // 0x18
	::Class_3_07C3C4D2990C49EE* AGDJANGLELC; // 0x20
	::RPG::GameCore::RegionEraStateChangeListener* IGHAHBNLIJA; // 0x28
