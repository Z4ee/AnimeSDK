...
#define CLASS_2_A0B9BF7FBEFD07A2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13737110)
#define CLASS_2_A0B9BF7FBEFD07A2_METHOD_2_E49FC3D0AC1CB0F6_OFFSET UNITYSDK_OFFSET(0x13736E00)
#define CLASS_2_A0B9BF7FBEFD07A2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13736B60)
#define CLASS_2_A0B9BF7FBEFD07A2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13737050)
#define CLASS_2_A0B9BF7FBEFD07A2_TICK_OFFSET UNITYSDK_OFFSET(0x137371A0)
#define CLASS_2_A0B9BF7FBEFD07A2__CTOR_OFFSET UNITYSDK_OFFSET(0x13736A70)

inline static constexpr unsigned int Class_2_A0B9BF7FBEFD07A2_TypeDefinitionIndex = 49366;

class Class_2_A0B9BF7FBEFD07A2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RegionEraStateChangeListener* Field_2_0; // 0x18
