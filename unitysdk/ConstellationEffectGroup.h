...
#define CONSTELLATIONEFFECTGROUP_ADDALLCHILD_OFFSET UNITYSDK_OFFSET(0xC754810)
#define CONSTELLATIONEFFECTGROUP_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xC753FC0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_2BC1A70133D64A3E_OFFSET UNITYSDK_OFFSET(0xC755060)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_AB0E32D900C7A89E_OFFSET UNITYSDK_OFFSET(0xC754A70)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_CD054ADA8D27B4D4_OFFSET UNITYSDK_OFFSET(0xC754010)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_E38DBF86ED41255C_OFFSET UNITYSDK_OFFSET(0xC755380)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EA3063A5CDD6F164_OFFSET UNITYSDK_OFFSET(0xC754230)
#define CONSTELLATIONEFFECTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xC755A80)
#define CONSTELLATIONEFFECTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC755AD0)

inline static constexpr unsigned int ConstellationEffectGroup_TypeDefinitionIndex = 44659;
