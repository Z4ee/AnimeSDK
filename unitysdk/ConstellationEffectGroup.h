...
#define CONSTELLATIONEFFECTGROUP_ADDALLCHILD_OFFSET UNITYSDK_OFFSET(0xE01AB20)
#define CONSTELLATIONEFFECTGROUP_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xE01A2D0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_2BC1A70133D64A3E_OFFSET UNITYSDK_OFFSET(0xE01B370)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_AB0E32D900C7A89E_OFFSET UNITYSDK_OFFSET(0xE01AD80)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_CD054ADA8D27B4D4_OFFSET UNITYSDK_OFFSET(0xE01A320)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_E38DBF86ED41255C_OFFSET UNITYSDK_OFFSET(0xE01B690)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EA3063A5CDD6F164_OFFSET UNITYSDK_OFFSET(0xE01A540)
#define CONSTELLATIONEFFECTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xE01BD90)
#define CONSTELLATIONEFFECTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xE01BDE0)
