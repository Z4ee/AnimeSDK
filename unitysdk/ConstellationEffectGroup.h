...
#define CONSTELLATIONEFFECTGROUP_ADDALLCHILD_OFFSET UNITYSDK_OFFSET(0xAD123C0)
#define CONSTELLATIONEFFECTGROUP_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xAD11CF0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0xAD125C0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_AEBE2A217F463B51_OFFSET UNITYSDK_OFFSET(0xAD12AD0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_C365440D57901CE0_OFFSET UNITYSDK_OFFSET(0xAD12E00)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EA3063A5CDD6F164_OFFSET UNITYSDK_OFFSET(0xAD11F10)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EC90937CEA9AFCA9_OFFSET UNITYSDK_OFFSET(0xAD11D40)
#define CONSTELLATIONEFFECTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xAD134B0)
#define CONSTELLATIONEFFECTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xAD13500)

inline static constexpr unsigned int ConstellationEffectGroup_TypeDefinitionIndex = 44113;
