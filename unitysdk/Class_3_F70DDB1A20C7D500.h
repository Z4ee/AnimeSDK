...
#define CLASS_3_F70DDB1A20C7D500_EVALUATE_OFFSET UNITYSDK_OFFSET(0x10621C90)
#define CLASS_3_F70DDB1A20C7D500__CTOR_OFFSET UNITYSDK_OFFSET(0x10621C60)

inline static constexpr unsigned int Class_3_F70DDB1A20C7D500_TypeDefinitionIndex = 43690;
