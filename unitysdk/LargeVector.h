...
#define LARGEVECTOR_CREATEZEROVECTOR_OFFSET UNITYSDK_OFFSET(0x12F0BB60)
#define LARGEVECTOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x7A1350)
#define LARGEVECTOR_GET_VECTORS_OFFSET UNITYSDK_OFFSET(0x7A1300)
#define LARGEVECTOR_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x12F0B170)
#define LARGEVECTOR_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x12F0BB00)
#define LARGEVECTOR_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x12F0B8D0)
#define LARGEVECTOR_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x12F0B520)
#define LARGEVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2B6D10)

inline static constexpr unsigned int LargeVector_TypeDefinitionIndex = 79835;
