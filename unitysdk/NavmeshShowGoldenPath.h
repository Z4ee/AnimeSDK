...
#define NAVMESHSHOWGOLDENPATH_RAYCASTSPHERE_OFFSET UNITYSDK_OFFSET(0x1E7A9140)
#define NAVMESHSHOWGOLDENPATH_START_OFFSET UNITYSDK_OFFSET(0x1E7A85B0)
#define NAVMESHSHOWGOLDENPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E7A8640)
#define NAVMESHSHOWGOLDENPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A9780)

inline static constexpr unsigned int NavmeshShowGoldenPath_TypeDefinitionIndex = 91061;
