...
#define CLASS_2_1B9D0BD8899FBBD7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAF3AC50)
#define CLASS_2_1B9D0BD8899FBBD7_METHOD_2_0ED1963A672FB61E_OFFSET UNITYSDK_OFFSET(0xAF3AED0)
#define CLASS_2_1B9D0BD8899FBBD7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAF3ACA0)
#define CLASS_2_1B9D0BD8899FBBD7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAF3AE20)
#define CLASS_2_1B9D0BD8899FBBD7_TICK_OFFSET UNITYSDK_OFFSET(0xAF3AE70)
#define CLASS_2_1B9D0BD8899FBBD7__CTOR_OFFSET UNITYSDK_OFFSET(0xAF3AC40)

inline static constexpr unsigned int Class_2_1B9D0BD8899FBBD7_TypeDefinitionIndex = 49918;

class Class_2_1B9D0BD8899FBBD7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TrainPartyCreatePrefab* Field_2_1; // 0x20
