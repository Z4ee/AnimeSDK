...
#define CLASS_2_1B9D0BD8899FBBD7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19907D40)
#define CLASS_2_1B9D0BD8899FBBD7_METHOD_2_0ED1963A672FB61E_OFFSET UNITYSDK_OFFSET(0x19907FC0)
#define CLASS_2_1B9D0BD8899FBBD7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19907D90)
#define CLASS_2_1B9D0BD8899FBBD7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19907F10)
#define CLASS_2_1B9D0BD8899FBBD7_TICK_OFFSET UNITYSDK_OFFSET(0x19907F60)
#define CLASS_2_1B9D0BD8899FBBD7__CTOR_OFFSET UNITYSDK_OFFSET(0x19907D30)

inline static constexpr unsigned int Class_2_1B9D0BD8899FBBD7_TypeDefinitionIndex = 53679;

class Class_2_1B9D0BD8899FBBD7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TrainPartyCreatePrefab* OFKGLJOAMLD; // 0x18
