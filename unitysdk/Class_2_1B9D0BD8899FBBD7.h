...
#define CLASS_2_1B9D0BD8899FBBD7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD36AC60)
#define CLASS_2_1B9D0BD8899FBBD7_METHOD_2_0ED1963A672FB61E_OFFSET UNITYSDK_OFFSET(0xD36AE50)
#define CLASS_2_1B9D0BD8899FBBD7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD36ACB0)
#define CLASS_2_1B9D0BD8899FBBD7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD36ADA0)
#define CLASS_2_1B9D0BD8899FBBD7_TICK_OFFSET UNITYSDK_OFFSET(0xD36ADF0)
#define CLASS_2_1B9D0BD8899FBBD7__CTOR_OFFSET UNITYSDK_OFFSET(0xD36AC50)

inline static constexpr unsigned int Class_2_1B9D0BD8899FBBD7_TypeDefinitionIndex = 49251;

class Class_2_1B9D0BD8899FBBD7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TrainPartyCreatePrefab* Field_2_1; // 0x18
