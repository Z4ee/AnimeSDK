...
#define AKAUDIOINPUTMANAGER_AUDIOFORMATINTEROPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B94F390)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATINTEROPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B94F400)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATINTEROPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B94F380)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATINTEROPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B94F310)

inline static constexpr unsigned int AkAudioInputManager_AudioFormatInteropDelegate_TypeDefinitionIndex = 42009;
