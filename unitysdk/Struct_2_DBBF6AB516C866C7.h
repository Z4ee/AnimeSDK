...
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x86E140)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_4F49AC32E99BB202_OFFSET UNITYSDK_OFFSET(0x86E040)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_5E256ABCBB78EAD2_1_OFFSET UNITYSDK_OFFSET(0x86E0C0)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_5E256ABCBB78EAD2_OFFSET UNITYSDK_OFFSET(0x86DFC0)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_FC545203151D288E_OFFSET UNITYSDK_OFFSET(0x1772EE20)
#define STRUCT_2_DBBF6AB516C866C7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1772EDE0)

inline static constexpr unsigned int Struct_2_DBBF6AB516C866C7_TypeDefinitionIndex = 62514;

struct alignas(8) Struct_2_DBBF6AB516C866C7
{
	static ::Struct_2_DBBF6AB516C866C7* StaticGet_Field_2_15()
	{
		return (::Struct_2_DBBF6AB516C866C7*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_DBBF6AB516C866C7_TypeDefinitionIndex)->GetStaticField(0x3E090);
	}
	...
	::MoleMole::ConfigNewbie_NewbieInputLogicType Field_2_4; // 0x28
	::System::Boolean Field_2_11; // 0x2C
	::System::Boolean Field_2_10; // 0x2D
