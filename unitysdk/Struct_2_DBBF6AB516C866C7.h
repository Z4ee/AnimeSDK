...
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x751F60)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_4F49AC32E99BB202_OFFSET UNITYSDK_OFFSET(0x752000)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_5E256ABCBB78EAD2_1_OFFSET UNITYSDK_OFFSET(0x752080)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_5E256ABCBB78EAD2_OFFSET UNITYSDK_OFFSET(0x751EE0)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_FC545203151D288E_OFFSET UNITYSDK_OFFSET(0x1292E440)
#define STRUCT_2_DBBF6AB516C866C7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1292E400)

inline static constexpr unsigned int Struct_2_DBBF6AB516C866C7_TypeDefinitionIndex = 57233;

struct alignas(8) Struct_2_DBBF6AB516C866C7
{
	static ::Struct_2_DBBF6AB516C866C7* StaticGet_Field_2_11()
	{
		return (::Struct_2_DBBF6AB516C866C7*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_DBBF6AB516C866C7_TypeDefinitionIndex)->GetStaticField(0x368F0);
	}
