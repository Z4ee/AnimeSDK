...
#define CLASS_1_6DED08B7C7C749EF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED406F0)
#define CLASS_1_6DED08B7C7C749EF_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED400C0)
#define CLASS_1_6DED08B7C7C749EF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED402D0)
#define CLASS_1_6DED08B7C7C749EF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED40180)
#define CLASS_1_6DED08B7C7C749EF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED403F0)
#define CLASS_1_6DED08B7C7C749EF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED40840)
#define CLASS_1_6DED08B7C7C749EF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED407E0)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1ED40130)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1ED40120)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1ED3FF50)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1ED40110)
#define CLASS_1_6DED08B7C7C749EF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED3FFB0)
#define CLASS_1_6DED08B7C7C749EF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED40570)
#define CLASS_1_6DED08B7C7C749EF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED405D0)
#define CLASS_1_6DED08B7C7C749EF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED40A40)
#define CLASS_1_6DED08B7C7C749EF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED40020)
#define CLASS_1_6DED08B7C7C749EF__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED3FFC0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_TypeDefinitionIndex)->GetStaticField(0x416A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_JPAEBNKOHFA()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_TypeDefinitionIndex)->GetStaticField(0x416A8);
	}
