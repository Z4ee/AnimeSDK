...
#define CLASS_1_6DED08B7C7C749EF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0501D0)
#define CLASS_1_6DED08B7C7C749EF_CLONE_OFFSET UNITYSDK_OFFSET(0x1A04FC90)
#define CLASS_1_6DED08B7C7C749EF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A04FE40)
#define CLASS_1_6DED08B7C7C749EF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A04FD50)
#define CLASS_1_6DED08B7C7C749EF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A04FF00)
#define CLASS_1_6DED08B7C7C749EF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0503D0)
#define CLASS_1_6DED08B7C7C749EF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A050370)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1A04FD00)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1A04FCF0)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A04FB20)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A04FCE0)
#define CLASS_1_6DED08B7C7C749EF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A04FB80)
#define CLASS_1_6DED08B7C7C749EF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A050080)
#define CLASS_1_6DED08B7C7C749EF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0500E0)
#define CLASS_1_6DED08B7C7C749EF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0505D0)
#define CLASS_1_6DED08B7C7C749EF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A04FBF0)
#define CLASS_1_6DED08B7C7C749EF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04FB90)

inline static constexpr unsigned int Class_1_6DED08B7C7C749EF_TypeDefinitionIndex = 23827;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_TypeDefinitionIndex)->GetStaticField(0x2E4B0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_TypeDefinitionIndex)->GetStaticField(0x2E4B8);
	}
