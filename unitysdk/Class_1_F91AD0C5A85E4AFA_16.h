...
#define CLASS_1_F91AD0C5A85E4AFA_16_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DCD3970)
#define CLASS_1_F91AD0C5A85E4AFA_16_CLONE_OFFSET UNITYSDK_OFFSET(0x1DCD33F0)
#define CLASS_1_F91AD0C5A85E4AFA_16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DCD3600)
#define CLASS_1_F91AD0C5A85E4AFA_16_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DCD34F0)
#define CLASS_1_F91AD0C5A85E4AFA_16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DCD3710)
#define CLASS_1_F91AD0C5A85E4AFA_16_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DCD3B30)
#define CLASS_1_F91AD0C5A85E4AFA_16_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DCD3AD0)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1DCD34D0)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DCD3450)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1DCD3480)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1DCD3470)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DCD3350)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1DCD34E0)
#define CLASS_1_F91AD0C5A85E4AFA_16_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DCD3460)
#define CLASS_1_F91AD0C5A85E4AFA_16_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DCD3380)
#define CLASS_1_F91AD0C5A85E4AFA_16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DCD37C0)
#define CLASS_1_F91AD0C5A85E4AFA_16_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DCD3820)
#define CLASS_1_F91AD0C5A85E4AFA_16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DCD3D00)
#define CLASS_1_F91AD0C5A85E4AFA_16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DCD33A0)
#define CLASS_1_F91AD0C5A85E4AFA_16__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCD3390)

inline static constexpr unsigned int Class_1_F91AD0C5A85E4AFA_16_TypeDefinitionIndex = 29869;

class Class_1_F91AD0C5A85E4AFA_16 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_16*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F91AD0C5A85E4AFA_16_TypeDefinitionIndex)->GetStaticField(0x3C50);
	}
	// static const ::System::Int32 LKCCGCBCJJM = 0xC; // 0x0
	// static const ::System::Int32 OLMIFJKILJG = 0x4; // 0x0
