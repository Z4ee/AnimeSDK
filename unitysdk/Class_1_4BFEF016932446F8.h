...
#define CLASS_1_4BFEF016932446F8_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1A597790)
#define CLASS_1_4BFEF016932446F8_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1A573ED0)
#define CLASS_1_4BFEF016932446F8_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A573390)
#define CLASS_1_4BFEF016932446F8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5977F0)
...
public:
	...
	::RPG::GameCore::CakeRaceMoveState ALHAFOGCGJK; // 0x20
	::System::UInt32 NMALDHAIMCF; // 0x24
	::System::Boolean HGMGLFNFGGN; // 0x28
	::System::Boolean OHAHHCFNLFF; // 0x29
	::System::Boolean MLLBLJEALGA; // 0x2A
	::System::Int32 GCHLCKLCGNB; // 0x2C
	::System::Int32 FLDIHFHMLAM; // 0x30
