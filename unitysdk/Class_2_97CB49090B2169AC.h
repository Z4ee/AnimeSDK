...
#define CLASS_2_97CB49090B2169AC_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD243F10)
#define CLASS_2_97CB49090B2169AC_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xD244050)
#define CLASS_2_97CB49090B2169AC_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xD241980)
#define CLASS_2_97CB49090B2169AC_GET_TRANS_OFFSET UNITYSDK_OFFSET(0xD2419A0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0xD242CE0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_0552B0A8C7BD8BB0_OFFSET UNITYSDK_OFFSET(0xD243730)
#define CLASS_2_97CB49090B2169AC_METHOD_2_1C87EE7694B173E6_OFFSET UNITYSDK_OFFSET(0xD2439C0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_229CEF33F0AF9039_1_OFFSET UNITYSDK_OFFSET(0xD243CC0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xD2428B0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xD242B70)
#define CLASS_2_97CB49090B2169AC_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0xD243380)
#define CLASS_2_97CB49090B2169AC_METHOD_2_6DC60149A270E0D4_OFFSET UNITYSDK_OFFSET(0xD2419E0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_73D70CF7573CE802_OFFSET UNITYSDK_OFFSET(0xD2429E0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_AD1EEF8F6B87D2FC_OFFSET UNITYSDK_OFFSET(0xD2436C0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0xD242800)
#define CLASS_2_97CB49090B2169AC_METHOD_2_B53F7BD98DCC799A_OFFSET UNITYSDK_OFFSET(0xD243590)
#define CLASS_2_97CB49090B2169AC_METHOD_2_B8FA72FA9AED0C88_OFFSET UNITYSDK_OFFSET(0xD243020)
#define CLASS_2_97CB49090B2169AC_METHOD_2_C197C60741593FF0_OFFSET UNITYSDK_OFFSET(0xD243780)
#define CLASS_2_97CB49090B2169AC_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xD243D40)
#define CLASS_2_97CB49090B2169AC_METHOD_2_C5F2E178DAEB1793_OFFSET UNITYSDK_OFFSET(0xD242630)
#define CLASS_2_97CB49090B2169AC_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xD241D20)
#define CLASS_2_97CB49090B2169AC_METHOD_2_C79E003CEB6B5E92_OFFSET UNITYSDK_OFFSET(0xD243B20)
#define CLASS_2_97CB49090B2169AC_METHOD_2_C959E72807C9E088_OFFSET UNITYSDK_OFFSET(0xD243400)
#define CLASS_2_97CB49090B2169AC_METHOD_2_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0xD241BD0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0xD242710)
#define CLASS_2_97CB49090B2169AC_METHOD_2_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0xD2425C0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_D7D9D2F1638FE8DD_OFFSET UNITYSDK_OFFSET(0xD2437D0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_DE25B04543C947C4_OFFSET UNITYSDK_OFFSET(0xD242EA0)
#define CLASS_2_97CB49090B2169AC_METHOD_2_E52C357E96F7A058_OFFSET UNITYSDK_OFFSET(0xD243A60)
#define CLASS_2_97CB49090B2169AC_METHOD_2_EBAB6A35C21A2A5B_OFFSET UNITYSDK_OFFSET(0xD241E90)
#define CLASS_2_97CB49090B2169AC_METHOD_2_F2EEC5E8503D3622_OFFSET UNITYSDK_OFFSET(0xD243150)
#define CLASS_2_97CB49090B2169AC_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xD243E30)
#define CLASS_2_97CB49090B2169AC_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xD241990)
#define CLASS_2_97CB49090B2169AC__CTOR_OFFSET UNITYSDK_OFFSET(0xD244170)
#define CLASS_2_97CB49090B2169AC__ONBIND_OFFSET UNITYSDK_OFFSET(0xD240D50)
#define CLASS_2_97CB49090B2169AC__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xD243440)
#define CLASS_2_97CB49090B2169AC__ONTICK_OFFSET UNITYSDK_OFFSET(0xD242930)

inline static constexpr unsigned int Class_2_97CB49090B2169AC_TypeDefinitionIndex = 72035;
...
public:
	...
	::UnityEngine::Animation* NDAHMEMIOKI; // 0x60
	::System::Collections::Generic::List_1<::UnityEngine::Animation*>* JEHKEEKGOGP; // 0x68
	::UnityEngine::UI::Text* DHNHODGAKLH; // 0x70
	::System::Collections::Generic::List_1<::System::Boolean>* IHMLPGEGBOL; // 0x78
	::UnityEngine::UI::Text* KPICPMEANJJ; // 0x80
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* IINNNCIKFIE; // 0x88
	::RPG::GameCore::LevelDataComponent* KEKOPPIHDLJ; // 0x90
	::System::Collections::Generic::List_1<::UnityEngine::Animation*>* BBLGCBLIMEJ; // 0x98
	::UnityEngine::UI::Text* BFOKJKJBBIL; // 0xA0
	::UnityEngine::UI::Text* DKNOKMKBHLC; // 0xA8
	::RPG::Client::AnimatorButton* DGFADNOKFIO; // 0xB0
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* KKJLNGAANFB; // 0xB8
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* APDHJFGJPOM; // 0xC0
	::UnityEngine::Animation* LLJKNBGLGCN; // 0xC8
	::UnityEngine::Transform* AEFNANKNHPO; // 0xD0
	::UnityEngine::Transform* OEJACCIHPLJ; // 0xD8
	::RPG::Client::AnimatorButton* PJONABOCAHI; // 0xE0
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* CJIMFBOJLLP; // 0xE8
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* MCAMHGMGNGG; // 0xF0
	::UnityEngine::Animation* IJLIJFHBCFN; // 0xF8
	::UnityEngine::UI::Image* BHMFMBBLADC; // 0x100
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* BKNIEJKDBCB; // 0x108
	::UnityEngine::Transform* GLCFJPMFNCB; // 0x110
	::UnityEngine::Transform* KOKJLIBCGFO; // 0x118
	::UnityEngine::Transform* AOCIACEHMNM; // 0x120
	::System::Int32 LKBKDNAMNEG; // 0x128
	::System::Single BFKCADADNCA; // 0x12C
	::System::UInt32 CCCNCNCCHLL; // 0x130
	::System::Boolean AKBPMCJFCFM; // 0x134
	::System::Boolean HAFCOEMEHNH; // 0x135
	::System::Single IODBJGNMKND; // 0x138
	::System::Int32 _Index_k__BackingField; // 0x13C
	::System::UInt64 DKIFLEMOKJD; // 0x140
	::System::Single CLEBBBABPEI; // 0x148
	::System::Single FAFIAGJFGEF; // 0x14C
