...
#define CLASS_1_5B567C8A01BAEDFE_341_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A25BBB0)
#define CLASS_1_5B567C8A01BAEDFE_341_CLONE_OFFSET UNITYSDK_OFFSET(0x1A25B9C0)
#define CLASS_1_5B567C8A01BAEDFE_341_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A25BAC0)
#define CLASS_1_5B567C8A01BAEDFE_341_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A25BA30)
#define CLASS_1_5B567C8A01BAEDFE_341_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A25BB10)
#define CLASS_1_5B567C8A01BAEDFE_341_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A25BC00)
#define CLASS_1_5B567C8A01BAEDFE_341_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A25BBD0)
#define CLASS_1_5B567C8A01BAEDFE_341_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A25B910)
#define CLASS_1_5B567C8A01BAEDFE_341_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A25B970)
#define CLASS_1_5B567C8A01BAEDFE_341_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A25BB40)
#define CLASS_1_5B567C8A01BAEDFE_341_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A25BBA0)
#define CLASS_1_5B567C8A01BAEDFE_341__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A25BC50)
#define CLASS_1_5B567C8A01BAEDFE_341__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A25B990)
#define CLASS_1_5B567C8A01BAEDFE_341__CTOR_OFFSET UNITYSDK_OFFSET(0x1A25B980)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_341_TypeDefinitionIndex = 31973;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_341*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_341_TypeDefinitionIndex)->GetStaticField(0x44A80);
	}
