...
#define CLASS_2_D983B8EE78FC39CC_METHOD_2_2D8360ADEC831C05_OFFSET UNITYSDK_OFFSET(0x13546FA0)
#define CLASS_2_D983B8EE78FC39CC_METHOD_2_9FA85F81BF5EE3CA_OFFSET UNITYSDK_OFFSET(0x135471B0)
#define CLASS_2_D983B8EE78FC39CC_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x13547260)
#define CLASS_2_D983B8EE78FC39CC__CTOR_OFFSET UNITYSDK_OFFSET(0x13547250)

inline static constexpr unsigned int Class_2_D983B8EE78FC39CC_TypeDefinitionIndex = 67084;

class Class_2_D983B8EE78FC39CC : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_3_6F805C3FA3D1D41D<::MoleMole::UIGeneralActivityTagInfoWidgetController*>* Field_2_7; // 0x18
	...
	::MoleMole::MonoGamepadRegion* Field_2_2; // 0x48
