...
#define CLASS_5_B325BF975C84A0DD_CLONE_OFFSET UNITYSDK_OFFSET(0xB7C6110)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_0F40AA2B6B209CD5_OFFSET UNITYSDK_OFFSET(0xB7C5DE0)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_4D3B75704BF58A94_OFFSET UNITYSDK_OFFSET(0xB7C6250)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_6AA0A5D7371B5A80_OFFSET UNITYSDK_OFFSET(0xB7C6010)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_AE41BEE50A44D918_OFFSET UNITYSDK_OFFSET(0xB7C6310)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_E970B418D363857B_OFFSET UNITYSDK_OFFSET(0xB7C6520)
#define CLASS_5_B325BF975C84A0DD_REVERSE_OFFSET UNITYSDK_OFFSET(0xB7C61B0)
#define CLASS_5_B325BF975C84A0DD_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0xB7C60C0)
#define CLASS_5_B325BF975C84A0DD__CTOR_OFFSET UNITYSDK_OFFSET(0xB7C5DB0)
#define CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_CLONE_OFFSET UNITYSDK_OFFSET(0xB7C63E0)
#define CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_REVERSE_OFFSET UNITYSDK_OFFSET(0xB7C6480)
#define CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0xB7C63D0)

inline static constexpr unsigned int Class_5_B325BF975C84A0DD_TypeDefinitionIndex = 67696;

class Class_5_B325BF975C84A0DD : public ::Class_4_0781C886C58F298A
{
public:
	::UnityEngine::Color Field_5_5; // 0x48
	::System::Single Field_5_3; // 0x58
	::UnityEngine::Color Field_5_4; // 0x5C
	::System::Int32 Field_5_0; // 0x6C
	::System::Single Field_5_2; // 0x70
	::System::Single Field_5_1; // 0x74
	...
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_STARTWITHTARGET_OFFSET))(this, P0);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single, ::Il2CppArray<::UnityEngine::UIVertex>*&))((::PBYTE)hIl2Cpp + CLASS_5_B325BF975C84A0DD_METHOD_5_E970B418D363857B_OFFSET))(this, P0, P1);
	}
};
