...
#define CLASS_5_B325BF975C84A0DD_CLONE_OFFSET UNITYSDK_OFFSET(0x89C5E80)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_0F40AA2B6B209CD5_OFFSET UNITYSDK_OFFSET(0x89C5B50)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_4D3B75704BF58A94_OFFSET UNITYSDK_OFFSET(0x89C5FC0)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_6AA0A5D7371B5A80_OFFSET UNITYSDK_OFFSET(0x89C5D80)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_AE41BEE50A44D918_OFFSET UNITYSDK_OFFSET(0x89C6080)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_E970B418D363857B_OFFSET UNITYSDK_OFFSET(0x89C6290)
#define CLASS_5_B325BF975C84A0DD_REVERSE_OFFSET UNITYSDK_OFFSET(0x89C5F20)
#define CLASS_5_B325BF975C84A0DD_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x89C5E30)
#define CLASS_5_B325BF975C84A0DD__CTOR_OFFSET UNITYSDK_OFFSET(0x89C5B20)
#define CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_CLONE_OFFSET UNITYSDK_OFFSET(0x89C6150)
#define CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_REVERSE_OFFSET UNITYSDK_OFFSET(0x89C61F0)
#define CLASS_5_B325BF975C84A0DD___IFIXBASEPROXY_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x89C6140)

inline static constexpr unsigned int Class_5_B325BF975C84A0DD_TypeDefinitionIndex = 60278;

class Class_5_B325BF975C84A0DD : public ::Class_4_0781C886C58F298A
{
public:
	::System::Int32 Field_5_0; // 0x48
	::UnityEngine::Color Field_5_4; // 0x4C
	::System::Single Field_5_3; // 0x5C
	::System::Single Field_5_2; // 0x60
	::UnityEngine::Color Field_5_5; // 0x64
