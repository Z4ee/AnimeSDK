...
#define CLASS_5_B325BF975C84A0DD_CLONE_OFFSET UNITYSDK_OFFSET(0x1710A030)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_0F40AA2B6B209CD5_OFFSET UNITYSDK_OFFSET(0x17109D00)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_4D3B75704BF58A94_OFFSET UNITYSDK_OFFSET(0x1710A170)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_6AA0A5D7371B5A80_OFFSET UNITYSDK_OFFSET(0x17109F30)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_AE41BEE50A44D918_OFFSET UNITYSDK_OFFSET(0x1710A220)
#define CLASS_5_B325BF975C84A0DD_REVERSE_OFFSET UNITYSDK_OFFSET(0x1710A0D0)
#define CLASS_5_B325BF975C84A0DD_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x17109FE0)
#define CLASS_5_B325BF975C84A0DD__CTOR_OFFSET UNITYSDK_OFFSET(0x17109CD0)

inline static constexpr unsigned int Class_5_B325BF975C84A0DD_TypeDefinitionIndex = 73451;

class Class_5_B325BF975C84A0DD : public ::Class_4_0781C886C58F298A
{
public:
	::System::Single CGAMANONFLD; // 0x48
	::System::Single FCOFOCHPILE; // 0x4C
	::System::Int32 GLBHKBAPJFP; // 0x50
	::UnityEngine::Color LDECBLDNGIL; // 0x54
	::System::Single LEECBGEAFAI; // 0x64
	::UnityEngine::Color POMBEDOEPML; // 0x68
