...
#define CLASS_3_7723D43C6BC7FD6B_METHOD_3_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x1892AC70)
#define CLASS_3_7723D43C6BC7FD6B_METHOD_3_BD6A3C745D127D79_OFFSET UNITYSDK_OFFSET(0x1892B300)
#define CLASS_3_7723D43C6BC7FD6B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1892AD90)
#define CLASS_3_7723D43C6BC7FD6B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1892B260)
#define CLASS_3_7723D43C6BC7FD6B__CTOR_OFFSET UNITYSDK_OFFSET(0x1892AC60)

inline static constexpr unsigned int Class_3_7723D43C6BC7FD6B_TypeDefinitionIndex = 53808;

class Class_3_7723D43C6BC7FD6B : public ::Class_2_BB5C2228DBF7AE1F
{
public:
	::RPG::GameCore::GridFightWaitDragRole* IGHAHBNLIJA; // 0x28
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_7723D43C6BC7FD6B_METHOD_3_1947BC35B7A7FCB8_OFFSET))(this);
	}
