...
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1B0B8260)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1B0B8240)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1B0B8250)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0B8210)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B0B8330)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1B0B8270)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0B8520)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B0B8340)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1B0B82D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B8530)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFSM__ONGRAPHSTARTED_B__14_0_OFFSET UNITYSDK_OFFSET(0x1B0B8550)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ConcurrentSubFSM_TypeDefinitionIndex = 26967;
