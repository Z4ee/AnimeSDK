...
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A2A5670)
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A2A5870)
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1A2A5970)
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A5770)
#define NODECANVAS_STATEMACHINES_FSM_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1A2A5E60)
#define NODECANVAS_STATEMACHINES_FSM_GATHERCALLBACKRECEIVERS_OFFSET UNITYSDK_OFFSET(0x1A2A66F0)
#define NODECANVAS_STATEMACHINES_FSM_GETSTATENAMES_OFFSET UNITYSDK_OFFSET(0x1A2A6520)
#define NODECANVAS_STATEMACHINES_FSM_GETSTATEWITHNAME_OFFSET UNITYSDK_OFFSET(0x1A2A6430)
#define NODECANVAS_STATEMACHINES_FSM_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1A2A5B70)
#define NODECANVAS_STATEMACHINES_FSM_GET_BASENODETYPE_OFFSET UNITYSDK_OFFSET(0x1A2A5B10)
#define NODECANVAS_STATEMACHINES_FSM_GET_CANACCEPTVARIABLEDROPS_OFFSET UNITYSDK_OFFSET(0x1A2A5B80)
#define NODECANVAS_STATEMACHINES_FSM_GET_CURRENTSTATENAME_OFFSET UNITYSDK_OFFSET(0x1A2A5AB0)
#define NODECANVAS_STATEMACHINES_FSM_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x1A2A5A70)
#define NODECANVAS_STATEMACHINES_FSM_GET_ISTREE_OFFSET UNITYSDK_OFFSET(0x1A2A5B60)
#define NODECANVAS_STATEMACHINES_FSM_GET_PREVIOUSSTATENAME_OFFSET UNITYSDK_OFFSET(0x1A2A5AE0)
#define NODECANVAS_STATEMACHINES_FSM_GET_PREVIOUSSTATE_OFFSET UNITYSDK_OFFSET(0x1A2A5A90)
#define NODECANVAS_STATEMACHINES_FSM_GET_REQUIRESAGENT_OFFSET UNITYSDK_OFFSET(0x1A2A5B40)
#define NODECANVAS_STATEMACHINES_FSM_GET_REQUIRESPRIMENODE_OFFSET UNITYSDK_OFFSET(0x1A2A5B50)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2A5B90)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A2A5D50)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A2A6370)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A6040)
#define NODECANVAS_STATEMACHINES_FSM_PEEKSTACK_OFFSET UNITYSDK_OFFSET(0x1A2A6A40)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A2A56F0)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A2A58F0)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1A2A59F0)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A57F0)
#define NODECANVAS_STATEMACHINES_FSM_SET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x1A2A5A80)
#define NODECANVAS_STATEMACHINES_FSM_SET_PREVIOUSSTATE_OFFSET UNITYSDK_OFFSET(0x1A2A5AA0)
#define NODECANVAS_STATEMACHINES_FSM_TRIGGERSTATE_OFFSET UNITYSDK_OFFSET(0x1A2A63F0)
#define NODECANVAS_STATEMACHINES_FSM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A6AA0)
#define NODECANVAS_STATEMACHINES_FSM__GATHERCALLBACKRECEIVERS_B__48_0_OFFSET UNITYSDK_OFFSET(0x1A2A6AB0)
#define NODECANVAS_STATEMACHINES_FSM__GATHERCALLBACKRECEIVERS_B__48_1_OFFSET UNITYSDK_OFFSET(0x1A2A6C10)
#define NODECANVAS_STATEMACHINES_FSM__GATHERCALLBACKRECEIVERS_B__48_2_OFFSET UNITYSDK_OFFSET(0x1A2A6D70)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int FSM_TypeDefinitionIndex = 27563;
