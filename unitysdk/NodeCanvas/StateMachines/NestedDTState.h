...
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D809B50)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D809A90)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_ONDIALOGUEFINISHED_OFFSET UNITYSDK_OFFSET(0x1D80A020)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1D809B60)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1D809EC0)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D809E50)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D809AF0)
#define NODECANVAS_STATEMACHINES_NESTEDDTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80A0A0)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int NestedDTState_TypeDefinitionIndex = 30700;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::NodeCanvas::DialogueTrees::DialogueTree*>* _nestedDLG; // 0xA0
		::System::String* failureEvent; // 0xA8
