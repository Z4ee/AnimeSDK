...
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1E6DC950)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E6DC930)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E6DC940)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E6DC900)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1E6DCA20)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1E6DC960)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E6DCC10)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E6DCA30)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1E6DC9C0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6DCC20)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE__ONGRAPHSTARTED_B__14_0_OFFSET UNITYSDK_OFFSET(0x1E6DCC40)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ConcurrentSubTree_TypeDefinitionIndex = 30813;
