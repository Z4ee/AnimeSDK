...
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1B0B7730)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1B0B7710)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1B0B7720)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0B76D0)
#define NODECANVAS_STATEMACHINES_ANYSTATE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0B7980)
#define NODECANVAS_STATEMACHINES_ANYSTATE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B0B7740)
#define NODECANVAS_STATEMACHINES_ANYSTATE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B0B7880)
#define NODECANVAS_STATEMACHINES_ANYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B7D30)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int AnyState_TypeDefinitionIndex = 26850;
