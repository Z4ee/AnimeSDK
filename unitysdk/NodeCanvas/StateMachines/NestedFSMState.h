...
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D40F790)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D40F6D0)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1D40F7A0)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1D40FA70)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D40FA00)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D40F730)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40FC00)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int NestedFSMState_TypeDefinitionIndex = 30743;
