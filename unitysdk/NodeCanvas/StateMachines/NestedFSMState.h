...
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1E7B4DB0)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1E7B4CF0)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1E7B4DC0)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1E7B5090)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E7B5020)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1E7B4D50)
#define NODECANVAS_STATEMACHINES_NESTEDFSMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B5220)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int NestedFSMState_TypeDefinitionIndex = 30814;
