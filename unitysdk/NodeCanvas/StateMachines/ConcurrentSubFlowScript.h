...
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1AF32860)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1AF32840)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1AF32850)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AF32810)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1AF32930)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1AF32870)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AF32B20)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1AF32940)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1AF328D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF32B30)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT__ONGRAPHSTARTED_B__14_0_OFFSET UNITYSDK_OFFSET(0x1AF32B50)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ConcurrentSubFlowScript_TypeDefinitionIndex = 27624;
