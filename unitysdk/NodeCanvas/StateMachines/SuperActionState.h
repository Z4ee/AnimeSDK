...
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1D843810)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1D8438E0)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1D8439D0)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D843820)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D843580)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D843A40)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int SuperActionState_TypeDefinitionIndex = 30423;

	class SuperActionState : public ::NodeCanvas::StateMachines::FSMState
	{
	public:
		::NodeCanvas::Framework::ActionList* _onExitList; // 0x80
		::NodeCanvas::Framework::ActionList* _onUpdateList; // 0x88
		::NodeCanvas::Framework::ActionList* _onEnterList; // 0x90
