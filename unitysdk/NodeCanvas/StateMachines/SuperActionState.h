...
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1B4A3530)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1B4A3600)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B4A36F0)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A3540)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B4A32A0)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A3760)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int SuperActionState_TypeDefinitionIndex = 27114;

	class SuperActionState : public ::NodeCanvas::StateMachines::FSMState
	{
	public:
		::NodeCanvas::Framework::ActionList* _onEnterList; // 0x80
