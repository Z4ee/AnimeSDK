...
#define NODECANVAS_ACTIONLISTPLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0F0EE0)
#define NODECANVAS_ACTIONLISTPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1B0F0E30)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1B0F10A0)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0F1070)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1B0F0BF0)
#define NODECANVAS_ACTIONLISTPLAYER_GET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1B0F0C40)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1B0F0C00)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_AGENT_OFFSET UNITYSDK_OFFSET(0x1B0F0C30)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_CONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1B0F0C20)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1B0F0FA0)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_1_OFFSET UNITYSDK_OFFSET(0x1B0F1010)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_2_OFFSET UNITYSDK_OFFSET(0x1B0F0FB0)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x1B0F0F40)
#define NODECANVAS_ACTIONLISTPLAYER_SET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1B0F0C50)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0F08C0)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0F0730)
#define NODECANVAS_ACTIONLISTPLAYER_UPDATETASKSOWNER_OFFSET UNITYSDK_OFFSET(0x1B0F0D00)
#define NODECANVAS_ACTIONLISTPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F10D0)

namespace NodeCanvas
{
	inline static constexpr unsigned int ActionListPlayer_TypeDefinitionIndex = 27868;
