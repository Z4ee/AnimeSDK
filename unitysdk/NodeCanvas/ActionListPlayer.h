...
#define NODECANVAS_ACTIONLISTPLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E22F260)
#define NODECANVAS_ACTIONLISTPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1E22F1B0)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1E22F420)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1E22F3F0)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1E22EF70)
#define NODECANVAS_ACTIONLISTPLAYER_GET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1E22EFC0)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1E22EF80)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_AGENT_OFFSET UNITYSDK_OFFSET(0x1E22EFB0)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_CONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1E22EFA0)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1E22F320)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_1_OFFSET UNITYSDK_OFFSET(0x1E22F390)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_2_OFFSET UNITYSDK_OFFSET(0x1E22F330)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x1E22F2C0)
#define NODECANVAS_ACTIONLISTPLAYER_SET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1E22EFD0)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E22EC40)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E22EAB0)
#define NODECANVAS_ACTIONLISTPLAYER_UPDATETASKSOWNER_OFFSET UNITYSDK_OFFSET(0x1E22F080)
#define NODECANVAS_ACTIONLISTPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22F450)

namespace NodeCanvas
{
	inline static constexpr unsigned int ActionListPlayer_TypeDefinitionIndex = 30519;
