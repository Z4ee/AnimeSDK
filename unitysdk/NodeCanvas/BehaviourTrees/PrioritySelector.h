...
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1EB91F40)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1EB92190)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB92210)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1EB923F0)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB92400)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR__ONEXECUTE_B__5_0_OFFSET UNITYSDK_OFFSET(0x1EB92410)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int PrioritySelector_TypeDefinitionIndex = 30065;
