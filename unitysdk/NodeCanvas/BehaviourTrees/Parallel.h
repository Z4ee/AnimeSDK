...
#define NODECANVAS_BEHAVIOURTREES_PARALLEL_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1BCC8800)
#define NODECANVAS_BEHAVIOURTREES_PARALLEL_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BCC8B50)
#define NODECANVAS_BEHAVIOURTREES_PARALLEL_RESETRUNNING_OFFSET UNITYSDK_OFFSET(0x1BCC8AB0)
#define NODECANVAS_BEHAVIOURTREES_PARALLEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC8B90)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Parallel_TypeDefinitionIndex = 29384;
