...
#define NODECANVAS_BEHAVIOURTREES_PARALLEL_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D06A350)
#define NODECANVAS_BEHAVIOURTREES_PARALLEL_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D06A690)
#define NODECANVAS_BEHAVIOURTREES_PARALLEL_RESETRUNNING_OFFSET UNITYSDK_OFFSET(0x1D06A5F0)
#define NODECANVAS_BEHAVIOURTREES_PARALLEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A6D0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Parallel_TypeDefinitionIndex = 30644;
