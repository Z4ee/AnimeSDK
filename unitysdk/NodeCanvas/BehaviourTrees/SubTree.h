...
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D6E5160)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D6E50A0)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6E5170)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D6E5420)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D6E5100)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E5570)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int SubTree_TypeDefinitionIndex = 30626;
