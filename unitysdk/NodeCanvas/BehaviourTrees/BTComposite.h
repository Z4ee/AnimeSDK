...
#define NODECANVAS_BEHAVIOURTREES_BTCOMPOSITE_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1EBBA600)
#define NODECANVAS_BEHAVIOURTREES_BTCOMPOSITE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1EBBA5F0)
#define NODECANVAS_BEHAVIOURTREES_BTCOMPOSITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EBBA4B0)
#define NODECANVAS_BEHAVIOURTREES_BTCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBBA610)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BTComposite_TypeDefinitionIndex = 29818;
