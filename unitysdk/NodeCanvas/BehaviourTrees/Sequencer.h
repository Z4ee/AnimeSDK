...
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1BC5AFD0)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1BC5ACA0)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1BC5AFE0)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BC5AF70)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC5B040)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Sequencer_TypeDefinitionIndex = 30321;
