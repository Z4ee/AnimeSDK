...
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A2A2BA0)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2A2870)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A2A2BB0)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A2B40)
#define NODECANVAS_BEHAVIOURTREES_SEQUENCER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A2C10)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Sequencer_TypeDefinitionIndex = 27016;
