...
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A9005D0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A900510)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONDLGFINISHED_OFFSET UNITYSDK_OFFSET(0x1A9008A0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A9005E0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A9008B0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A900570)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A900A10)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int NestedDT_TypeDefinitionIndex = 27500;
