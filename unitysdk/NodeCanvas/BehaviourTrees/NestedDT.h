...
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D3933E0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D393320)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONDLGFINISHED_OFFSET UNITYSDK_OFFSET(0x1D3936B0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D3933F0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D3936C0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D393380)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D393810)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int NestedDT_TypeDefinitionIndex = 29917;
