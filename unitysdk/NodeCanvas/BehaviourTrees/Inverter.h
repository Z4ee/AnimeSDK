...
#define NODECANVAS_BEHAVIOURTREES_INVERTER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D356620)
#define NODECANVAS_BEHAVIOURTREES_INVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D356770)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Inverter_TypeDefinitionIndex = 30232;
