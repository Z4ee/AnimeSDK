...
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B49F860)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1B49F7E0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B49F880)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B49FD10)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B49F870)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1B49F7F0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49FD60)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int ConditionalEvaluator_TypeDefinitionIndex = 28065;
