...
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B0B5BB0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1B0B5BD0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0B5C50)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0B5F20)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B0B5BC0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1B0B5BE0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5F60)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Interruptor_TypeDefinitionIndex = 26886;
