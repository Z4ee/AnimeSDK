...
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E53F610)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E53F880)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_SENDTOBACK_OFFSET UNITYSDK_OFFSET(0x1E53F7A0)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E53F890)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int FlipSelector_TypeDefinitionIndex = 31196;
