...
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1ADB6E90)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ADB7100)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_SENDTOBACK_OFFSET UNITYSDK_OFFSET(0x1ADB7020)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADB7110)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int FlipSelector_TypeDefinitionIndex = 27676;
