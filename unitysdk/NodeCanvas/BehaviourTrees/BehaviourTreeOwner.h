...
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_GET_REPEAT_OFFSET UNITYSDK_OFFSET(0x1E72AB10)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_GET_ROOTSTATUS_OFFSET UNITYSDK_OFFSET(0x1E72B080)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E72ADC0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_SET_REPEAT_OFFSET UNITYSDK_OFFSET(0x1E72AC70)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_SET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E72AF20)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_TICK_OFFSET UNITYSDK_OFFSET(0x1E72B1E0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E72B340)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BehaviourTreeOwner_TypeDefinitionIndex = 29792;
