...
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B4B2870)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B4B2930)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1B4B2860)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B4B2880)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1B4B28B0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4B2950)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B4B2BD0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B4B2940)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1B4B28C0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B2C10)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BinarySelector_TypeDefinitionIndex = 26797;
	...
	public:
		...
		::System::Int32 succeedIndex; // 0x84
