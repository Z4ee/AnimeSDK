...
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1D803FD0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1D804090)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D803FC0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D803FE0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1D804010)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D8040B0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D804330)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1D8040A0)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1D804020)
#define NODECANVAS_BEHAVIOURTREES_BINARYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D804370)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BinarySelector_TypeDefinitionIndex = 30762;
