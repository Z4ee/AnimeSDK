...
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1B7E8EE0)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B7E8BC0)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B7E8EF0)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B7E8E80)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E8F50)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Selector_TypeDefinitionIndex = 27308;
