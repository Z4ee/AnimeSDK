...
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1BCC8CA0)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1BCC8C20)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1BCC8CC0)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_ONRESET_OFFSET UNITYSDK_OFFSET(0x1BCC9110)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1BCC8CB0)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1BCC8C30)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC9160)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 30312;
