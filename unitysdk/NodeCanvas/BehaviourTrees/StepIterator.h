...
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E6DA290)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E6DA280)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E6DA380)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6DA390)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int StepIterator_TypeDefinitionIndex = 31411;
