...
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D3568F0)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D3568E0)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D3569E0)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3569F0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int StepIterator_TypeDefinitionIndex = 29867;
