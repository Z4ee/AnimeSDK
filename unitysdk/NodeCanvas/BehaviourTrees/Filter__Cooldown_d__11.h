...
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B4216A0)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B421750)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4217B0)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B421760)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B421690)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x1B421680)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Filter__Cooldown_d__11_TypeDefinitionIndex = 27121;
