...
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ADD_ONROOTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1DFDC600)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1DFDC800)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_BASENODETYPE_OFFSET UNITYSDK_OFFSET(0x1DFDC7A0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_CANACCEPTVARIABLEDROPS_OFFSET UNITYSDK_OFFSET(0x1DFDC810)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_ISTREE_OFFSET UNITYSDK_OFFSET(0x1DFDC7F0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_REQUIRESAGENT_OFFSET UNITYSDK_OFFSET(0x1DFDC7D0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_REQUIRESPRIMENODE_OFFSET UNITYSDK_OFFSET(0x1DFDC7E0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_ROOTSTATUS_OFFSET UNITYSDK_OFFSET(0x1DFDC720)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONDERIVEDDATADESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1DFDC560)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONDERIVEDDATASERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1DFDC4F0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1DFDC820)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONGRAPHUPDATE_OFFSET UNITYSDK_OFFSET(0x1DFDC8B0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_REMOVE_ONROOTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1DFDC690)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_SET_ROOTSTATUS_OFFSET UNITYSDK_OFFSET(0x1DFDC730)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_TICK_OFFSET UNITYSDK_OFFSET(0x1DFDC960)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFDCA60)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BehaviourTree_TypeDefinitionIndex = 30608;
	...
	public:
		...
		{
			return (::System::Action_2<::NodeCanvas::BehaviourTrees::BehaviourTree*, ::NodeCanvas::Framework::Status>**)Il2CppClass::FromTypeDefinitionIndex(BehaviourTree_TypeDefinitionIndex)->GetStaticField(0x25780);
		}
