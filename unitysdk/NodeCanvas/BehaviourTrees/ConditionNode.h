...
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B0F11A0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0F11C0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1B0F1120)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0F11F0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0F12D0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B0F11B0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1B0F1130)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F1310)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int ConditionNode_TypeDefinitionIndex = 27684;
