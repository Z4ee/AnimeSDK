...
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1985A7C0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_DECORATEDCONNECTION_OFFSET UNITYSDK_OFFSET(0x1985A7D0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_DECORATEDNODE_OFFSET UNITYSDK_OFFSET(0x1985A830)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1985A7B0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1985A890)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BTDecorator_TypeDefinitionIndex = 28092;
