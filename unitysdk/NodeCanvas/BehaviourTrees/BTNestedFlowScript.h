...
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D40E5F0)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D40E530)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D40E600)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_ONFLOWSCRIPTFINISHED_OFFSET UNITYSDK_OFFSET(0x1D40E850)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D40E860)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D40E590)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40E9B0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BTNestedFlowScript_TypeDefinitionIndex = 29655;
