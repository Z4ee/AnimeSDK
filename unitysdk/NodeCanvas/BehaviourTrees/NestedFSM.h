...
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B7E8610)
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1B7E8550)
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B7E8620)
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM_ONFSMFINISH_OFFSET UNITYSDK_OFFSET(0x1B7E8A30)
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B7E8A40)
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1B7E85B0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDFSM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E8BA0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int NestedFSM_TypeDefinitionIndex = 28142;
