...
#define NODECANVAS_FRAMEWORK_CANVASGROUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DB9AF30)
#define NODECANVAS_FRAMEWORK_CANVASGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9AF20)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int CanvasGroup_TypeDefinitionIndex = 29660;
