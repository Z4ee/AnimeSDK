...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EBBC2B0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NODECANVAS_FRAMEWORK_VARIABLE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EBBC9F0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NODECANVAS_FRAMEWORK_VARIABLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EBBC980)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EBBCA70)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EBBC9E0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EBBC990)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EBBC0C0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBBC0A0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1EBBC1C0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1EBBC2A0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions__GetVariables_d__14_TypeDefinitionIndex = 30888;
	...
	public:
		...
		::System::Type* __3__ofType; // 0x28
		::System::Collections::Generic::Dictionary_2_Enumerator<::System::String*, ::NodeCanvas::Framework::Variable*> __7__wrap2; // 0x30
		::System::Type* ofType; // 0x58
		::NodeCanvas::Framework::Variable* __2__current; // 0x60
