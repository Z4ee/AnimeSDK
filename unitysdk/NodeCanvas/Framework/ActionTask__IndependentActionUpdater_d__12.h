...
#define NODECANVAS_FRAMEWORK_ACTIONTASK__INDEPENDENTACTIONUPDATER_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BCCA980)
#define NODECANVAS_FRAMEWORK_ACTIONTASK__INDEPENDENTACTIONUPDATER_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BCCAA10)
#define NODECANVAS_FRAMEWORK_ACTIONTASK__INDEPENDENTACTIONUPDATER_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BCCAA70)
#define NODECANVAS_FRAMEWORK_ACTIONTASK__INDEPENDENTACTIONUPDATER_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BCCAA20)
#define NODECANVAS_FRAMEWORK_ACTIONTASK__INDEPENDENTACTIONUPDATER_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BCCA970)
#define NODECANVAS_FRAMEWORK_ACTIONTASK__INDEPENDENTACTIONUPDATER_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCA960)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ActionTask__IndependentActionUpdater_d__12_TypeDefinitionIndex = 30722;
	...
	public:
		...
		::NodeCanvas::Framework::ActionTask* __4__this; // 0x20
		::System::Object* __2__current; // 0x28
		::System::Action_1<::NodeCanvas::Framework::Status>* callback; // 0x30
