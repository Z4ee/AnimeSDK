...
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ADDACTION_OFFSET UNITYSDK_OFFSET(0x1D804DA0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1D804BB0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1D8057F0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D804A10)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1D805760)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D804F80)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONINIT_OFFSET UNITYSDK_OFFSET(0x1D804F20)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1D8056C0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1D805610)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D805030)
#define NODECANVAS_FRAMEWORK_ACTIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D805890)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ActionList_TypeDefinitionIndex = 30248;

	class ActionList : public ::NodeCanvas::Framework::ActionTask
	{
	public:
		::Il2CppArray<::System::Boolean>* finishedIndeces; // 0x60
		::System::Collections::Generic::List_1<::NodeCanvas::Framework::ActionTask*>* actions; // 0x68
