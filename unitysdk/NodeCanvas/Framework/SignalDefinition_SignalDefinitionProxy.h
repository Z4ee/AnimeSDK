...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_ADD_ONINVOKE_OFFSET UNITYSDK_OFFSET(0x1A901E60)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_GET_PROXYID_OFFSET UNITYSDK_OFFSET(0x1A901E50)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A901F60)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_REMOVE_ONINVOKE_OFFSET UNITYSDK_OFFSET(0x1A901EE0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A901FB0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A901F90)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_SignalDefinitionProxy_TypeDefinitionIndex = 28050;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SignalDefinition_SignalDefinitionProxy_TypeDefinitionIndex)->GetStaticField(0x4A10);
		}
