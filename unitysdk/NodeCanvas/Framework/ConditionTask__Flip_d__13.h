...
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CC48250)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC482C0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC48320)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CC482D0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CC48240)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC48230)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionTask__Flip_d__13_TypeDefinitionIndex = 30368;
