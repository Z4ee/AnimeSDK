...
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DFDD530)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DFDD5A0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DFDD600)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DFDD5B0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DFDD520)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__FLIP_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFDD510)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionTask__Flip_d__13_TypeDefinitionIndex = 30708;

	class ConditionTask__Flip_d__13 : public ::System::Object
	{
	public:
		::NodeCanvas::Framework::ConditionTask* __4__this; // 0x10
