...
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E6DBCF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x1E6DBAF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E6DBBF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1E6DC430)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1E6DC2D0)
#define NODECANVAS_FRAMEWORK_VARIABLE_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1E6DC020)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETGETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1E6DC2F0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETSETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1E6DC450)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1E6DBE80)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x1E6DBF20)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISPROPERTYBOUND_OFFSET UNITYSDK_OFFSET(0x1E6DBF70)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E6DBDF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E6DBEE0)
#define NODECANVAS_FRAMEWORK_VARIABLE_HASVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1E6DC260)
#define NODECANVAS_FRAMEWORK_VARIABLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E6DC010)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E6DBD70)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x1E6DBB70)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E6DBC70)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x1E6DBFB0)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1E6DBE00)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_TSETID_OFFSET UNITYSDK_OFFSET(0x1E6DBAE0)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E6DBF00)
#define NODECANVAS_FRAMEWORK_VARIABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E6DC590)
#define NODECANVAS_FRAMEWORK_VARIABLE_TRYINVOKEVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1E6DC270)
#define NODECANVAS_FRAMEWORK_VARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6DBFC0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Variable_TypeDefinitionIndex = 30033;

	class Variable : public ::System::Object
	{
	public:
		::System::Action_1<::System::Object*>* onValueChanged; // 0x10
		::System::String* _id; // 0x18
		::System::Action* onDestroy; // 0x20
		::System::Action_1<::System::String*>* onNameChanged; // 0x28
