...
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AF31F70)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x1AF31D70)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1AF31E70)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1AF326A0)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1AF32540)
#define NODECANVAS_FRAMEWORK_VARIABLE_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1AF322A0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETGETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1AF32560)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETSETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1AF326C0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1AF32100)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x1AF321A0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISPROPERTYBOUND_OFFSET UNITYSDK_OFFSET(0x1AF321F0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AF32070)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF32160)
#define NODECANVAS_FRAMEWORK_VARIABLE_HASVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1AF324D0)
#define NODECANVAS_FRAMEWORK_VARIABLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AF32290)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AF31FF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x1AF31DF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1AF31EF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x1AF32230)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AF32080)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_TSETID_OFFSET UNITYSDK_OFFSET(0x1AF31D60)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AF32180)
#define NODECANVAS_FRAMEWORK_VARIABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF32800)
#define NODECANVAS_FRAMEWORK_VARIABLE_TRYINVOKEVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1AF324E0)
#define NODECANVAS_FRAMEWORK_VARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF32240)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Variable_TypeDefinitionIndex = 28114;
