...
#define NODECANVAS_FRAMEWORK_VARIABLE___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF91870)
#define NODECANVAS_FRAMEWORK_VARIABLE___C__DISPLAYCLASS47_0__GETSETCONVERTER_B__0_OFFSET UNITYSDK_OFFSET(0x1EF91880)
#define NODECANVAS_FRAMEWORK_VARIABLE___C__DISPLAYCLASS47_0__GETSETCONVERTER_B__1_OFFSET UNITYSDK_OFFSET(0x1EF918C0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Variable___c__DisplayClass47_0_TypeDefinitionIndex = 30034;
