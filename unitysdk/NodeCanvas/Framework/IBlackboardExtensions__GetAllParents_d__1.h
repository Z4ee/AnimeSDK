...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E72D920)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NODECANVAS_FRAMEWORK_IBLACKBOARD__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E72DB20)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NODECANVAS_FRAMEWORK_IBLACKBOARD__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E72DAB0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E72DBA0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E72DB10)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E72DAC0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E72D910)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E72D8F0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions__GetAllParents_d__1_TypeDefinitionIndex = 30889;
	...
	public:
		...
		::NodeCanvas::Framework::IBlackboard* _current_5__2; // 0x20
		::NodeCanvas::Framework::IBlackboard* __2__current; // 0x28
		::System::Int32 __l__initialThreadId; // 0x30
		::System::Int32 __1__state; // 0x34
		::System::Boolean __3__includeSelf; // 0x38
		::System::Boolean includeSelf; // 0x39
