...
#define NODECANVAS_FRAMEWORK_GRAPH__LOADOVERWRITEASYNC_D__178_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9EB700)
#define NODECANVAS_FRAMEWORK_GRAPH__LOADOVERWRITEASYNC_D__178_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x5B0AE0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Graph__LoadOverwriteAsync_d__178_TypeDefinitionIndex = 29262;
	...
	struct alignas(8) Graph__LoadOverwriteAsync_d__178
	{
		...
		::NodeCanvas::Framework::Internal::GraphLoadData data; // 0x30
		::System::Runtime::CompilerServices::TaskAwaiter __u__1; // 0x60
