...
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_EDITORLOGERROR_OFFSET UNITYSDK_OFFSET(0x1C639380)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1C639230)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x1C6390E0)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C639470)

namespace NodeCanvas::Framework::Utils
{
	inline static constexpr unsigned int NodeCanvasDebug_TypeDefinitionIndex = 29715;
