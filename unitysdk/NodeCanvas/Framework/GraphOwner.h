...
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ADD_ONMONOBEHAVIOURSTART_OFFSET UNITYSDK_OFFSET(0x1E540100)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ADD_ONOWNERBEHAVIOURSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1E53FFE0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E541520)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_BINDEXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E541C30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GETFCSTATISTC_OFFSET UNITYSDK_OFFSET(0x1E540200)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E540820)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHOBJECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1E5402B0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1E540290)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHSOURCE_OFFSET UNITYSDK_OFFSET(0x1E540270)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_DISABLEACTION_OFFSET UNITYSDK_OFFSET(0x1E540380)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1E5406A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ENABLEACTION_OFFSET UNITYSDK_OFFSET(0x1E540360)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ENABLECALLED_OFFSET UNITYSDK_OFFSET(0x1E540230)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_EXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E53FC50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_FIRSTACTIVATION_OFFSET UNITYSDK_OFFSET(0x1E540340)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_GRAPHISBOUND_OFFSET UNITYSDK_OFFSET(0x1E5402F0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1E540210)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1E540530)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x1E5403C0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_LOCKBOUNDGRAPHPREFABOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1E5402D0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_PREINITIALIZESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0x1E540320)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_STARTCALLED_OFFSET UNITYSDK_OFFSET(0x1E540250)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E5403A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E541530)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_INVOKESTARTEVENT_OFFSET UNITYSDK_OFFSET(0x1E541EC0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E541F30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E541EF0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E541E20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_PAUSEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1E540D00)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_REMOVE_ONMONOBEHAVIOURSTART_OFFSET UNITYSDK_OFFSET(0x1E540180)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_REMOVE_ONOWNERBEHAVIOURSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1E540070)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_RESTARTBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1E5411E0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SENDEVENT_1_OFFSET UNITYSDK_OFFSET(0x1E541390)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1E541210)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHOBJECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1E5402C0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1E5402A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHSOURCE_OFFSET UNITYSDK_OFFSET(0x1E540280)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_DISABLEACTION_OFFSET UNITYSDK_OFFSET(0x1E540390)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_ENABLEACTION_OFFSET UNITYSDK_OFFSET(0x1E540370)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_ENABLECALLED_OFFSET UNITYSDK_OFFSET(0x1E540240)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_EXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1E53FC60)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_FIRSTACTIVATION_OFFSET UNITYSDK_OFFSET(0x1E540350)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1E540220)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_LOCKBOUNDGRAPHPREFABOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1E540310)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_PREINITIALIZESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0x1E540330)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_STARTCALLED_OFFSET UNITYSDK_OFFSET(0x1E540260)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1E5403B0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_1_OFFSET UNITYSDK_OFFSET(0x1E540CF0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_2_OFFSET UNITYSDK_OFFSET(0x1E540A90)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1E540A80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_START_OFFSET UNITYSDK_OFFSET(0x1E541E70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STOPBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1E540E90)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E53FE70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E53FC70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UPDATEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1E541030)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5424D0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER__INITIALIZE_B__97_0_OFFSET UNITYSDK_OFFSET(0x1E542690)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int GraphOwner_TypeDefinitionIndex = 31203;
	...
	public:
		...
		{
			return (::System::Action_1<::NodeCanvas::Framework::GraphOwner*>**)Il2CppClass::FromTypeDefinitionIndex(GraphOwner_TypeDefinitionIndex)->GetStaticField(0x26240);
		}
