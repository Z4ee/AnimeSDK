...
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EF91760)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF91800)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EF91860)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EF91810)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF91750)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF91740)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Node__YieldBreak_d__98_TypeDefinitionIndex = 30205;
