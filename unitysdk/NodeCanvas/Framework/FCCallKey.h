...
#define NODECANVAS_FRAMEWORK_FCCALLKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D3574E0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D357450)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D3575C0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1D3573F0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1D357410)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1D357430)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1D357400)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1D357420)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1D357440)
#define NODECANVAS_FRAMEWORK_FCCALLKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3576E0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallKey_TypeDefinitionIndex = 30766;
