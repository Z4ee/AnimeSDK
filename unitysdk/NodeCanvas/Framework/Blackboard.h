...
#define NODECANVAS_FRAMEWORK_BLACKBOARD_ADDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1E8C20D0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_ADDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1E8C20C0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_ADD_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1E8C1BF0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_ADD_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1E8C1CF0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E8C1F70)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8C1AB0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_GETVARIABLEBYID_OFFSET UNITYSDK_OFFSET(0x1E8C2100)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1E8C20F0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_LOAD_1_OFFSET UNITYSDK_OFFSET(0x1E8C2490)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_LOAD_OFFSET UNITYSDK_OFFSET(0x1E8C2420)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1E8C1DF0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_INDEPENDANTVARIABLESFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1E8C1E70)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E8C1E60)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_PROPERTIESBINDTARGET_OFFSET UNITYSDK_OFFSET(0x1E8C1E40)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_UNITYCONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1E8C1E50)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1E8C1E00)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1E8C1E20)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1E8C1EB0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1E8C1F10)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E8C25E0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E8C2550)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_REMOVEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1E8C20E0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_REMOVE_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1E8C1C70)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_REMOVE_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1E8C1D70)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1E8C2330)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SAVE_OFFSET UNITYSDK_OFFSET(0x1E8C21E0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SELFDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8C17D0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SELFSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8C1410)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8C1A20)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1E8C2120)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1E8C2110)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_SHOWJSON_OFFSET UNITYSDK_OFFSET(0x1E8C2130)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E8C25D0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8C17C0)
#define NODECANVAS_FRAMEWORK_BLACKBOARD_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8C1400)
#define NODECANVAS_FRAMEWORK_BLACKBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8C26C0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Blackboard_TypeDefinitionIndex = 30032;
