...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1E72DC20)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1E72DC40)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1E72DC30)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1E72DC50)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E72DC60)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingBBParameterType_TypeDefinitionIndex = 30248;
