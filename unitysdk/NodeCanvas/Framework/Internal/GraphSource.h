...
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_ALLPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D825090)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_ALLTASKS_OFFSET UNITYSDK_OFFSET(0x1D825070)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_CANVASGROUPS_OFFSET UNITYSDK_OFFSET(0x1D825390)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1D8252B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1D8252D0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D825370)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_DERIVEDDATA_OFFSET UNITYSDK_OFFSET(0x1D8253D0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_LOCALBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1D8253B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1D825350)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1D8252F0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D825330)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1D825290)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_ZOOMFACTOR_OFFSET UNITYSDK_OFFSET(0x1D825310)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PACK_OFFSET UNITYSDK_OFFSET(0x1D8255A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_ISERIALIZATIONCOLLECTOR_ONCOLLECT_OFFSET UNITYSDK_OFFSET(0x1D825180)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_ISERIALIZATIONCOLLECTOR_ONPOP_OFFSET UNITYSDK_OFFSET(0x1D825280)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_ISERIALIZATIONCOLLECTOR_ONPUSH_OFFSET UNITYSDK_OFFSET(0x1D8250B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PURGEREDUNDANTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1D825B90)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SETMETADATA_OFFSET UNITYSDK_OFFSET(0x1D825B50)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_ALLPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D8250A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_ALLTASKS_OFFSET UNITYSDK_OFFSET(0x1D825080)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_CANVASGROUPS_OFFSET UNITYSDK_OFFSET(0x1D8253A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1D8252C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1D8252E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D825380)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_DERIVEDDATA_OFFSET UNITYSDK_OFFSET(0x1D8253E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_LOCALBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1D8253C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1D825360)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1D825300)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D825340)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1D8252A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_ZOOMFACTOR_OFFSET UNITYSDK_OFFSET(0x1D825320)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_UNPACK_OFFSET UNITYSDK_OFFSET(0x1D825860)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8253F0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int GraphSource_TypeDefinitionIndex = 29664;
