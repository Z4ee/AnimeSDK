...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D7C4990)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1D7C4950)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1D7C4970)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1D7C4960)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1D7C4980)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C4A70)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingCondition_TypeDefinitionIndex = 29362;
