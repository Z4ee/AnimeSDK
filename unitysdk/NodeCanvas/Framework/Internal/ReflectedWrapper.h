...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1ADBA2C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1ADB9FE0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x1ADBA280)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_GETSERIALIZEDMETHOD_OFFSET UNITYSDK_OFFSET(0x1ADBA270)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_HASCHANGED_OFFSET UNITYSDK_OFFSET(0x1ADBA2A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1ADBA080)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_SETVARIABLESBB_OFFSET UNITYSDK_OFFSET(0x1ADBA090)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ADBA2E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADB9FD0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedWrapper_TypeDefinitionIndex = 27929;
