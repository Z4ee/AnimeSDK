...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1D1E6BC0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1D1E68E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x1D1E6B80)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_GETSERIALIZEDMETHOD_OFFSET UNITYSDK_OFFSET(0x1D1E6B70)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_HASCHANGED_OFFSET UNITYSDK_OFFSET(0x1D1E6BA0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1D1E6980)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_SETVARIABLESBB_OFFSET UNITYSDK_OFFSET(0x1D1E6990)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D1E6BE0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E68D0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedWrapper_TypeDefinitionIndex = 29477;
