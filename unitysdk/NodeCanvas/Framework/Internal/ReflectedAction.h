...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_CALL_OFFSET UNITYSDK_OFFSET(0x1A859BD0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_GETVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A859B00)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_INIT_OFFSET UNITYSDK_OFFSET(0x1A859B40)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A859E90)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedAction_TypeDefinitionIndex = 26759;
