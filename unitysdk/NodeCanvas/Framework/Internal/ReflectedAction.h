...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_CALL_OFFSET UNITYSDK_OFFSET(0x1CC486F0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_GETVARIABLES_OFFSET UNITYSDK_OFFSET(0x1CC48620)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_INIT_OFFSET UNITYSDK_OFFSET(0x1CC48660)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC489B0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedAction_TypeDefinitionIndex = 29935;
