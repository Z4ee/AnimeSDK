...
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DFDD6B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_GET_VARTYPE_OFFSET UNITYSDK_OFFSET(0x1DFDD6D0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1DFDD760)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DFDD6C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DFDD640)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DFDD610)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFDD860)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DFDD880)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFDD710)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int BBObjectParameter_TypeDefinitionIndex = 31254;
