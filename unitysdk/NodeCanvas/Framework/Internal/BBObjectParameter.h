...
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A8598B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_GET_VARTYPE_OFFSET UNITYSDK_OFFSET(0x1A8598D0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1A859960)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A8598C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A859840)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A859810)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A859A60)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A859A80)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A859910)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int BBObjectParameter_TypeDefinitionIndex = 27590;
