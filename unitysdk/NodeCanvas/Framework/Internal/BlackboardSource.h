...
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_ADD_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1EF91190)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_ADD_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1EF91290)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1EF91390)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1EF913F0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_GET_PROPERTIESBINDTARGET_OFFSET UNITYSDK_OFFSET(0x1EF91430)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_GET_UNITYCONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1EF91410)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1EF913D0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_INDEPENDANTVARIABLESFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1EF91450)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1EF91460)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1EF914C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_REMOVE_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1EF91210)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_REMOVE_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1EF91310)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1EF91400)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_SET_PROPERTIESBINDTARGET_OFFSET UNITYSDK_OFFSET(0x1EF91440)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_SET_UNITYCONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1EF91420)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1EF913E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EF91660)
#define NODECANVAS_FRAMEWORK_INTERNAL_BLACKBOARDSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF91520)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int BlackboardSource_TypeDefinitionIndex = 31267;
