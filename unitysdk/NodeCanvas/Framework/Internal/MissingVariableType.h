...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGVARIABLETYPE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B0F2DF0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGVARIABLETYPE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1B0F2E10)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGVARIABLETYPE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B0F2E00)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGVARIABLETYPE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1B0F2E20)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGVARIABLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F2E30)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingVariableType_TypeDefinitionIndex = 27767;
