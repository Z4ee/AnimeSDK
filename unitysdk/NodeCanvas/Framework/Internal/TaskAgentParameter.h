...
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_GETVALUEBOXED_OFFSET UNITYSDK_OFFSET(0x1EB97F80)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EB97EE0)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_GET_VARTYPE_OFFSET UNITYSDK_OFFSET(0x1EB97EA0)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1EB98080)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_SETVALUEBOXED_OFFSET UNITYSDK_OFFSET(0x1EB98010)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EB97F70)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB980E0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int TaskAgentParameter_TypeDefinitionIndex = 30702;
