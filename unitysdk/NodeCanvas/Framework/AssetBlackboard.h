...
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_ADD_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1D3938D0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_ADD_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1D3939D0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1D393E40)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D393E60)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_GET_UID_OFFSET UNITYSDK_OFFSET(0x1D393E50)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_INDEPENDANTVARIABLESFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1D393D70)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1D393D50)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_PROPERTIESBINDTARGET_OFFSET UNITYSDK_OFFSET(0x1D393D60)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_UNITYCONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1D393D40)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1D393D00)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1D393D20)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1D393D80)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1D393DE0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_REMOVE_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1D393950)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_REMOVE_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1D393A50)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_SELFDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D393C70)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_SELFSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D393AE0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_SHOWJSON_OFFSET UNITYSDK_OFFSET(0x1D393E70)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D393ED0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D393BE0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D393AD0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D393EE0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int AssetBlackboard_TypeDefinitionIndex = 29557;
