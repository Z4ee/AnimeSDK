...
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x1EA9BB20)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_CHECKONCE_OFFSET UNITYSDK_OFFSET(0x1EA9BC00)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_CHECK_OFFSET UNITYSDK_OFFSET(0x1EA9BB90)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_DISABLE_OFFSET UNITYSDK_OFFSET(0x1EA9BAF0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ENABLE_OFFSET UNITYSDK_OFFSET(0x1EA9BAA0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_FLIP_OFFSET UNITYSDK_OFFSET(0x1EA9BD70)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_GET_INVERT_OFFSET UNITYSDK_OFFSET(0x1EA9BA80)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1EA9BDE0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EA9BDD0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EA9BDC0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_SET_INVERT_OFFSET UNITYSDK_OFFSET(0x1EA9BA90)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_YIELDRETURN_OFFSET UNITYSDK_OFFSET(0x1EA9BD00)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA9BDF0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionTask_TypeDefinitionIndex = 30707;

	class ConditionTask : public ::NodeCanvas::Framework::Task
	{
	public:
		::System::Int32 yields; // 0x50
		::System::Boolean isRuntimeEnabled; // 0x54
		::System::Boolean _invert; // 0x55
		::System::Int32 yieldReturn; // 0x58
