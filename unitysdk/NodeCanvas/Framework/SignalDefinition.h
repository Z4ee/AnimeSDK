...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_ADDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1BCCADD0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BCCAD60)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x1BCCAB20)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BCCAD80)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1BCCAE80)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1BCCAD70)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCAF60)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_TypeDefinitionIndex = 30543;
