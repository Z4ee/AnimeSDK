...
#define NODECANVAS_FRAMEWORK_CONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1E2300D0)
#define NODECANVAS_FRAMEWORK_CONNECTION_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1E230710)
#define NODECANVAS_FRAMEWORK_CONNECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1E22FDC0)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x1E2300A0)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E22FB80)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_SOURCENODE_OFFSET UNITYSDK_OFFSET(0x1E230000)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1E230080)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_TARGETNODE_OFFSET UNITYSDK_OFFSET(0x1E230020)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_UID_OFFSET UNITYSDK_OFFSET(0x1E22FFA0)
#define NODECANVAS_FRAMEWORK_CONNECTION_NODECANVAS_FRAMEWORK_IGRAPHELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E230040)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1E230E30)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E230E50)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E230E40)
#define NODECANVAS_FRAMEWORK_CONNECTION_RESET_OFFSET UNITYSDK_OFFSET(0x1E22FD80)
#define NODECANVAS_FRAMEWORK_CONNECTION_SETSOURCENODE_OFFSET UNITYSDK_OFFSET(0x1E230280)
#define NODECANVAS_FRAMEWORK_CONNECTION_SETTARGETNODE_OFFSET UNITYSDK_OFFSET(0x1E2304D0)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1E22FB30)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_SOURCENODE_OFFSET UNITYSDK_OFFSET(0x1E230010)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1E230090)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_TARGETNODE_OFFSET UNITYSDK_OFFSET(0x1E230030)
#define NODECANVAS_FRAMEWORK_CONNECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E230E60)
#define NODECANVAS_FRAMEWORK_CONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2300C0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Connection_TypeDefinitionIndex = 30117;

	class Connection : public ::System::Object
	{
	public:
		::NodeCanvas::Framework::Node* _targetNode; // 0x10
		::System::String* _UID; // 0x18
