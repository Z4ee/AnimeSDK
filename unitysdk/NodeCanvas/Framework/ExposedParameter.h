...
#define NODECANVAS_FRAMEWORK_EXPOSEDPARAMETER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1EBBBED0)
#define NODECANVAS_FRAMEWORK_EXPOSEDPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBBC090)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ExposedParameter_TypeDefinitionIndex = 31402;
