...
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GETFCCALLDICT_OFFSET UNITYSDK_OFFSET(0x1D842760)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1D842740)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_ISRECORD_OFFSET UNITYSDK_OFFSET(0x1D842770)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_RECORDFCCALLINFO_OFFSET UNITYSDK_OFFSET(0x1D842820)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_SET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1D842750)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D842A50)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCStatistic_TypeDefinitionIndex = 30166;
