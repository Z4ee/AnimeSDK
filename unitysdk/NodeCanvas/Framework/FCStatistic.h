...
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GETFCCALLDICT_OFFSET UNITYSDK_OFFSET(0x1EB84EA0)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1EB84E80)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_ISRECORD_OFFSET UNITYSDK_OFFSET(0x1EB84EB0)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_RECORDFCCALLINFO_OFFSET UNITYSDK_OFFSET(0x1EB84F60)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_SET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1EB84E90)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB85190)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCStatistic_TypeDefinitionIndex = 30674;
