...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D394BB0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D394C50)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D394500)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3944E0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_InvokeArguments_TypeDefinitionIndex = 30546;
