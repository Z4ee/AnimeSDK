...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A901DA0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A901E40)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9016F0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9016E0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_InvokeArguments_TypeDefinitionIndex = 28049;
