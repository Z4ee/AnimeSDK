...
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ADDCONDITION_OFFSET UNITYSDK_OFFSET(0x1B45D8C0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1B45D6D0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1B45DFD0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GET_ALLTRUEREQUIRED_OFFSET UNITYSDK_OFFSET(0x1B45D570)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B45D580)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1B45DCE0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B45DC30)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1B45DF40)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B45DA40)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B45E070)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionList_TypeDefinitionIndex = 27556;
