...
#define NODECANVAS_FRAMEWORK_FCCALLINFO_ADDCALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1B7E9330)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_GET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1B7E9310)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_SET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1B7E9320)
#define NODECANVAS_FRAMEWORK_FCCALLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E9340)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallInfo_TypeDefinitionIndex = 28124;
