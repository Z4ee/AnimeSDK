...
#define NODECANVAS_FRAMEWORK_FCCALLINFO_ADDCALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1EF91130)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_GET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1EF91110)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_SET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1EF91120)
#define NODECANVAS_FRAMEWORK_FCCALLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF91140)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallInfo_TypeDefinitionIndex = 31078;
