...
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1AF308F0)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1AF30910)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AF30920)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_ONOPTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x1AF30DA0)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF30F50)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int MultipleChoiceNode_TypeDefinitionIndex = 28128;
