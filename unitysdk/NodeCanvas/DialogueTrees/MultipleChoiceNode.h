...
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D356CC0)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1D356CE0)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D356CF0)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE_ONOPTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x1D357170)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D357320)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int MultipleChoiceNode_TypeDefinitionIndex = 29186;
	...
	public:
		...
		::System::Boolean saySelection; // 0x90
		::System::Single availableTime; // 0x94
