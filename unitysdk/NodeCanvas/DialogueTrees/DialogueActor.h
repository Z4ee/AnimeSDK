...
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x1DFDD0E0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x1DFDD0F0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DFDCDF0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x1DFDCE10)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x1DFDCE00)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DFDD1C0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFDD160)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueActor_TypeDefinitionIndex = 31029;
