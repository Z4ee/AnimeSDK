...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_CHECKINPUT_OFFSET UNITYSDK_OFFSET(0x1A2A4150)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1A2A4A10)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_DELAYPRINT_OFFSET UNITYSDK_OFFSET(0x1A2A41A0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A2A4A60)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_GET_LOCALSOURCE_OFFSET UNITYSDK_OFFSET(0x1A2A3100)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_INTERNAL_ONSUBTITLESREQUESTINFO_OFFSET UNITYSDK_OFFSET(0x1A2A3F60)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEFINISHED_OFFSET UNITYSDK_OFFSET(0x1A2A3BB0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEPAUSED_OFFSET UNITYSDK_OFFSET(0x1A2A3B40)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUESTARTED_OFFSET UNITYSDK_OFFSET(0x1A2A3B30)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A2A3640)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A2A3270)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONMULTIPLECHOICEREQUEST_OFFSET UNITYSDK_OFFSET(0x1A2A41F0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONSUBTITLESREQUEST_OFFSET UNITYSDK_OFFSET(0x1A2A3EA0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_PLAYTYPESOUND_OFFSET UNITYSDK_OFFSET(0x1A2A3FB0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_SETMASSALPHA_OFFSET UNITYSDK_OFFSET(0x1A2A4D10)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_START_OFFSET UNITYSDK_OFFSET(0x1A2A3A10)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A4E90)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI_TypeDefinitionIndex = 27371;
