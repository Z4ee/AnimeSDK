...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_CHECKINPUT_OFFSET UNITYSDK_OFFSET(0x1DB33A40)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1DB34300)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_DELAYPRINT_OFFSET UNITYSDK_OFFSET(0x1DB33A90)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1DB34350)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_GET_LOCALSOURCE_OFFSET UNITYSDK_OFFSET(0x1DB32AD0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_INTERNAL_ONSUBTITLESREQUESTINFO_OFFSET UNITYSDK_OFFSET(0x1DB33850)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEFINISHED_OFFSET UNITYSDK_OFFSET(0x1DB334A0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEPAUSED_OFFSET UNITYSDK_OFFSET(0x1DB33430)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUESTARTED_OFFSET UNITYSDK_OFFSET(0x1DB33420)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1DB32FA0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DB32C40)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONMULTIPLECHOICEREQUEST_OFFSET UNITYSDK_OFFSET(0x1DB33AE0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONSUBTITLESREQUEST_OFFSET UNITYSDK_OFFSET(0x1DB33790)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_PLAYTYPESOUND_OFFSET UNITYSDK_OFFSET(0x1DB338A0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_SETMASSALPHA_OFFSET UNITYSDK_OFFSET(0x1DB34600)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_START_OFFSET UNITYSDK_OFFSET(0x1DB33300)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB34780)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI_TypeDefinitionIndex = 31476;
