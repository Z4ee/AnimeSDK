...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI___C__DISPLAYCLASS29_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C3AC0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI___C__DISPLAYCLASS29_1__ONMULTIPLECHOICEREQUEST_B__0_OFFSET UNITYSDK_OFFSET(0x1D7C3AD0)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI___c__DisplayClass29_1_TypeDefinitionIndex = 30813;
