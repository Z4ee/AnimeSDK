...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_SUBTITLEDELAYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B45ABC0)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI_SubtitleDelays_TypeDefinitionIndex = 27378;
