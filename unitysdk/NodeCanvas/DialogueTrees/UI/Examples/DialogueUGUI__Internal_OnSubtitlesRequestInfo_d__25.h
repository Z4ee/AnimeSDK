...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D06B2E0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D06C410)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D06C470)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D06C420)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D06B2D0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B2C0)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI__Internal_OnSubtitlesRequestInfo_d__25_TypeDefinitionIndex = 31479;
	...
	public:
		...
		::NodeCanvas::DialogueTrees::UI::Examples::DialogueUGUI___c__DisplayClass25_0* __8__1; // 0x20
		::NodeCanvas::DialogueTrees::UI::Examples::DialogueUGUI* __4__this; // 0x28
		::NodeCanvas::DialogueTrees::SubtitlesRequestInfo* info; // 0x30
		::UnityEngine::AudioClip* _audio_5__3; // 0x38
		::UnityEngine::AudioSource* _playSource_5__4; // 0x40
		::System::String* _text_5__2; // 0x48
