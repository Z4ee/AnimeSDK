...
#define NODECANVAS_DIALOGUETREES_DTCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E5590)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DTConnection_TypeDefinitionIndex = 30370;
