...
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1D840400)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1D8404A0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1D840420)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONACTIONEND_OFFSET UNITYSDK_OFFSET(0x1D840670)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D8404B0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x1D840940)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D840900)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x1D840410)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1D840430)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_UPDATEACTION_OFFSET UNITYSDK_OFFSET(0x1D840620)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D840970)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ActionNode_TypeDefinitionIndex = 30886;
