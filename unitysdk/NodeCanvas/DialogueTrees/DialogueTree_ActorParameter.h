...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_GET_ACTOR_OFFSET UNITYSDK_OFFSET(0x1EB84030)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_GET_ID_OFFSET UNITYSDK_OFFSET(0x1EB84CE0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EB84CC0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_SET_ACTOR_OFFSET UNITYSDK_OFFSET(0x1EB842B0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1EB84CD0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EB84DE0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EB84D50)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EB84D60)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB84D40)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTree_ActorParameter_TypeDefinitionIndex = 31168;
