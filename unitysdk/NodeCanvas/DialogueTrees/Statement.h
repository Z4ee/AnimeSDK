...
#define NODECANVAS_DIALOGUETREES_STATEMENT_BLACKBOARDREPLACE_OFFSET UNITYSDK_OFFSET(0x1C62C190)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_AUDIO_OFFSET UNITYSDK_OFFSET(0x1C62C0E0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_META_OFFSET UNITYSDK_OFFSET(0x1C62C100)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1C62C0C0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_AUDIO_OFFSET UNITYSDK_OFFSET(0x1C62C0F0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_META_OFFSET UNITYSDK_OFFSET(0x1C62C110)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1C62C0D0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C62C2A0)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C62C140)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C62C160)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C62C180)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C62C120)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Statement_TypeDefinitionIndex = 30522;
