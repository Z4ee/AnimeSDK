...
#define NODECANVAS_DIALOGUETREES_STATEMENT_BLACKBOARDREPLACE_OFFSET UNITYSDK_OFFSET(0x1DAE3770)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_AUDIO_OFFSET UNITYSDK_OFFSET(0x1DAE36C0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_META_OFFSET UNITYSDK_OFFSET(0x1DAE36E0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1DAE36A0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_AUDIO_OFFSET UNITYSDK_OFFSET(0x1DAE36D0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_META_OFFSET UNITYSDK_OFFSET(0x1DAE36F0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1DAE36B0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DAE3880)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAE3720)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DAE3740)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DAE3760)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAE3700)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Statement_TypeDefinitionIndex = 31176;
