...
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x1D8426E0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D8426F0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D8426B0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x1D8426D0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x1D8426C0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1D842710)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8418F0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProxyDialogueActor_TypeDefinitionIndex = 30302;
