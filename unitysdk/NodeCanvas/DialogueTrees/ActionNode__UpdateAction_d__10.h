...
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D804650)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8049A0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D804A00)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D8049B0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D804640)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1D804630)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ActionNode__UpdateAction_d__10_TypeDefinitionIndex = 30887;

	class ActionNode__UpdateAction_d__10 : public ::System::Object
	{
	public:
		::NodeCanvas::DialogueTrees::ActionNode* __4__this; // 0x10
		::UnityEngine::Component* actionAgent; // 0x18
