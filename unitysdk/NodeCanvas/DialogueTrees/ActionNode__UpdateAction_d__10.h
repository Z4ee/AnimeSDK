...
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B4B2EF0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4B3240)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4B32A0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B4B3250)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B4B2EE0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B2ED0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ActionNode__UpdateAction_d__10_TypeDefinitionIndex = 27858;
	...
	public:
		...
		::NodeCanvas::DialogueTrees::ActionNode* __4__this; // 0x20
