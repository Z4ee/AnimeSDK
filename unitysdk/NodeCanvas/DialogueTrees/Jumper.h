...
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D356AD0)
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1D356AE0)
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1D356A70)
#define NODECANVAS_DIALOGUETREES_JUMPER_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D356A60)
#define NODECANVAS_DIALOGUETREES_JUMPER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D356AF0)
#define NODECANVAS_DIALOGUETREES_JUMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D356C80)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Jumper_TypeDefinitionIndex = 29514;
