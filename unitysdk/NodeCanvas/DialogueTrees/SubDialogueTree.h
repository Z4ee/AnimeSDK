...
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A2002C0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A200390)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A2002D0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2022C0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2003A0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONSUBDIALOGUEFINISH_OFFSET UNITYSDK_OFFSET(0x1A201D30)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A200330)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_TRYWRITEMAPPEDACTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A2015C0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2024C0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int SubDialogueTree_TypeDefinitionIndex = 27926;
