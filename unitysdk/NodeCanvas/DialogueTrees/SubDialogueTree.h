...
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1DAE3890)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1DAE3960)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1DAE38A0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DAE58D0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1DAE3970)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONSUBDIALOGUEFINISH_OFFSET UNITYSDK_OFFSET(0x1DAE5330)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1DAE3900)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_TRYWRITEMAPPEDACTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1DAE4BC0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAE5AD0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int SubDialogueTree_TypeDefinitionIndex = 30418;
