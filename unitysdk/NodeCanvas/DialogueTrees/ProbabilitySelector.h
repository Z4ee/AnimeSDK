...
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GETTOTAL_OFFSET UNITYSDK_OFFSET(0x1D40EED0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D40E9D0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1D40E9E0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1D40EAA0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D40EB20)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1D40EFC0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40EFD0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProbabilitySelector_TypeDefinitionIndex = 29826;
