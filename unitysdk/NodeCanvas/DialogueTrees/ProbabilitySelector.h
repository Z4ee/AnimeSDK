...
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GETTOTAL_OFFSET UNITYSDK_OFFSET(0x1E7B4520)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E7B4030)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1E7B4040)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1E7B4100)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E7B4180)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1E7B4610)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B4620)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProbabilitySelector_TypeDefinitionIndex = 30097;
