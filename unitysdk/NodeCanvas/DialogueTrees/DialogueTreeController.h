...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_GETACTORREFERENCEBYNAME_OFFSET UNITYSDK_OFFSET(0x1D6E5BC0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x1D6E5620)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D6E5630)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D6E55A0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x1D6E5610)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x1D6E5600)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1D6E5650)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_PAUSEDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1D6E5850)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCES_OFFSET UNITYSDK_OFFSET(0x1D6E5A60)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D6E58F0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_1_OFFSET UNITYSDK_OFFSET(0x1D6E57D0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_2_OFFSET UNITYSDK_OFFSET(0x1D6E57E0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_3_OFFSET UNITYSDK_OFFSET(0x1D6E57F0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_4_OFFSET UNITYSDK_OFFSET(0x1D6E5670)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1D6E5660)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STOPDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1D6E58A0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E5D20)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTreeController_TypeDefinitionIndex = 29545;
