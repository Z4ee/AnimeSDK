...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_GETACTORREFERENCEBYNAME_OFFSET UNITYSDK_OFFSET(0x1EA9B8F0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x1EA9B360)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x1EA9B370)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA9B2E0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x1EA9B350)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x1EA9B340)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EA9B390)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_PAUSEDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1EA9B580)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCES_OFFSET UNITYSDK_OFFSET(0x1EA9B790)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCE_OFFSET UNITYSDK_OFFSET(0x1EA9B620)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_1_OFFSET UNITYSDK_OFFSET(0x1EA9B500)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_2_OFFSET UNITYSDK_OFFSET(0x1EA9B510)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_3_OFFSET UNITYSDK_OFFSET(0x1EA9B520)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_4_OFFSET UNITYSDK_OFFSET(0x1EA9B3B0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1EA9B3A0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STOPDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1EA9B5D0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA9BA50)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTreeController_TypeDefinitionIndex = 30596;
