...
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1D06ACD0)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D06ADA0)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D06ACE0)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D06B040)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D06ADB0)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_ONFLOWSCRIPTFINISH_OFFSET UNITYSDK_OFFSET(0x1D06B1E0)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D06AD40)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B270)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DTNestedFlowScript_TypeDefinitionIndex = 29801;
