...
#define NODECANVAS_DIALOGUETREES_FINISHNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1B422090)
#define NODECANVAS_DIALOGUETREES_FINISHNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1B4220A0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4220B0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B422160)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int FinishNode_TypeDefinitionIndex = 27141;
