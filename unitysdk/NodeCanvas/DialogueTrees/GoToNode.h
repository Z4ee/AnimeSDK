...
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E53F900)
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1E53F910)
#define NODECANVAS_DIALOGUETREES_GOTONODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E53F920)
#define NODECANVAS_DIALOGUETREES_GOTONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E53F9F0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int GoToNode_TypeDefinitionIndex = 30145;
