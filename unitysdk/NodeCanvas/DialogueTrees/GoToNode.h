...
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1ADB7180)
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1ADB7190)
#define NODECANVAS_DIALOGUETREES_GOTONODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1ADB71A0)
#define NODECANVAS_DIALOGUETREES_GOTONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADB7270)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int GoToNode_TypeDefinitionIndex = 27370;
