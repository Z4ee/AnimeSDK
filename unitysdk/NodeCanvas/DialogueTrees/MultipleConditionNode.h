...
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A2A2C80)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A2A2C90)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A2A2D10)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2A2D90)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A3030)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int MultipleConditionNode_TypeDefinitionIndex = 27770;
