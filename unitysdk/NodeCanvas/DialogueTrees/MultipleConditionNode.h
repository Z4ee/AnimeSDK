...
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1DB32650)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1DB32660)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1DB326E0)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1DB32760)
#define NODECANVAS_DIALOGUETREES_MULTIPLECONDITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB32A00)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int MultipleConditionNode_TypeDefinitionIndex = 29912;
