...
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1D820290)
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D8202A0)
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE_ONSTATEMENTFINISH_OFFSET UNITYSDK_OFFSET(0x1D8203B0)
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D820430)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int StatementNode_TypeDefinitionIndex = 30662;
