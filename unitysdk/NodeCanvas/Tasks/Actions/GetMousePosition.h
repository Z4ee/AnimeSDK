...
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_DO_OFFSET UNITYSDK_OFFSET(0x1A2A7220)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2A7180)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A72C0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A7360)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetMousePosition_TypeDefinitionIndex = 28144;
