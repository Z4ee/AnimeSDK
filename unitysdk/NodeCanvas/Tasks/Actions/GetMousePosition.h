...
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_DO_OFFSET UNITYSDK_OFFSET(0x1DB36AE0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1DB36A40)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DB36B80)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB36C20)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetMousePosition_TypeDefinitionIndex = 31020;
