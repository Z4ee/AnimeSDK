...
#define NODECANVAS_TASKS_ACTIONS_LOADSCENE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D80AE80)
#define NODECANVAS_TASKS_ACTIONS_LOADSCENE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D80AEF0)
#define NODECANVAS_TASKS_ACTIONS_LOADSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80B020)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int LoadScene_TypeDefinitionIndex = 30152;
