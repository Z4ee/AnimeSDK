...
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B4242A0)
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B424660)
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B424700)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetIntRandom_TypeDefinitionIndex = 28090;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Int32>* maxValue; // 0x70
