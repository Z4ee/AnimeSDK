...
#define NODECANVAS_TASKS_ACTIONS_GETDISTANCE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1C63AC20)
#define NODECANVAS_TASKS_ACTIONS_GETDISTANCE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1C63ACA0)
#define NODECANVAS_TASKS_ACTIONS_GETDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C63AE30)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetDistance_TypeDefinitionIndex = 29793;
