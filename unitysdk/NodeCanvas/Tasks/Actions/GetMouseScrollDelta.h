...
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_DO_OFFSET UNITYSDK_OFFSET(0x1D845AF0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D845A20)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D845A60)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D845B80)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D845C10)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetMouseScrollDelta_TypeDefinitionIndex = 29972;
