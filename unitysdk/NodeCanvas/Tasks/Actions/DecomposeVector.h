...
#define NODECANVAS_TASKS_ACTIONS_DECOMPOSEVECTOR_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EB77AC0)
#define NODECANVAS_TASKS_ACTIONS_DECOMPOSEVECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB77B00)
#define NODECANVAS_TASKS_ACTIONS_DECOMPOSEVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB77C00)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int DecomposeVector_TypeDefinitionIndex = 31428;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Single>* x; // 0x70
