...
#define NODECANVAS_TASKS_ACTIONS_SETOBJECTVISIBILITY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B0F88F0)
#define NODECANVAS_TASKS_ACTIONS_SETOBJECTVISIBILITY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0F89B0)
#define NODECANVAS_TASKS_ACTIONS_SETOBJECTVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F8A80)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetObjectVisibility_TypeDefinitionIndex = 27899;
