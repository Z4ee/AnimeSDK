...
#define NODECANVAS_TASKS_ACTIONS_FINDCLOSESTWITHTAG_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AF32ED0)
#define NODECANVAS_TASKS_ACTIONS_FINDCLOSESTWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF33350)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindClosestWithTag_TypeDefinitionIndex = 26781;
