...
#define NODECANVAS_TASKS_ACTIONS_SETENUM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B464540)
#define NODECANVAS_TASKS_ACTIONS_SETENUM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B464580)
#define NODECANVAS_TASKS_ACTIONS_SETENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B464620)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetEnum_TypeDefinitionIndex = 27772;
