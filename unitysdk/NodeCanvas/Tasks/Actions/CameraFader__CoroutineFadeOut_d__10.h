...
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DAF0B80)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DAF0C40)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DAF0CA0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DAF0C50)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DAF0B70)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF0B60)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int CameraFader__CoroutineFadeOut_d__10_TypeDefinitionIndex = 30152;
