...
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C639560)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C639620)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C639680)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C639630)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C639550)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1C639540)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int CameraFader__CoroutineFadeOut_d__10_TypeDefinitionIndex = 30619;
