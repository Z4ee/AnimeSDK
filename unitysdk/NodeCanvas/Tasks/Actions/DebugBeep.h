...
#define NODECANVAS_TASKS_ACTIONS_DEBUGBEEP_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1DFDDD80)
#define NODECANVAS_TASKS_ACTIONS_DEBUGBEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFDDDB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int DebugBeep_TypeDefinitionIndex = 31265;
