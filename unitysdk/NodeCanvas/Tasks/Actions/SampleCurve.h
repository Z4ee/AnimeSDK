...
#define NODECANVAS_TASKS_ACTIONS_SAMPLECURVE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B7EAB60)
#define NODECANVAS_TASKS_ACTIONS_SAMPLECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EAC40)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SampleCurve_TypeDefinitionIndex = 27760;

	class SampleCurve : public ::NodeCanvas::Framework::ActionTask
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::System::Single>* saveAs; // 0x60
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::AnimationCurve*>* curve; // 0x68
