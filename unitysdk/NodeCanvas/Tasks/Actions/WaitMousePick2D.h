...
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D3598B0)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D359930)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D359D60)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int WaitMousePick2D_TypeDefinitionIndex = 30348;
	...
	public:
		...
		::System::Int32 buttonID; // 0x7C
		::UnityEngine::LayerMask mask; // 0x80
