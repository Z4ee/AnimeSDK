...
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1AF334E0)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AF33570)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF339A0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int WaitMousePick2D_TypeDefinitionIndex = 26534;
	...
	public:
		...
		::UnityEngine::RaycastHit2D hit; // 0x7C
		::System::Int32 buttonID; // 0xA0
		::NodeCanvas::Tasks::Actions::WaitMousePick2D_ButtonKeys buttonKey; // 0xA4
