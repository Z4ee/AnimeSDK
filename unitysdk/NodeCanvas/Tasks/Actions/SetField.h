...
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A2A7430)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A2A7530)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_GET_TARGETFIELD_OFFSET UNITYSDK_OFFSET(0x1A2A7410)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A2A77D0)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2A7930)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A2A77E0)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_ACTIONS_SETFIELD_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1A2A7370)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_SETTARGETFIELD_OFFSET UNITYSDK_OFFSET(0x1A2A7A30)
#define NODECANVAS_TASKS_ACTIONS_SETFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A7AB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetField_TypeDefinitionIndex = 27828;
