...
#define NODECANVAS_TASKS_ACTIONS_GRAPHOWNERCONTROL__YIELDDO_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DB9C4C0)
#define NODECANVAS_TASKS_ACTIONS_GRAPHOWNERCONTROL__YIELDDO_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DB9C510)
#define NODECANVAS_TASKS_ACTIONS_GRAPHOWNERCONTROL__YIELDDO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DB9C570)
#define NODECANVAS_TASKS_ACTIONS_GRAPHOWNERCONTROL__YIELDDO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DB9C520)
#define NODECANVAS_TASKS_ACTIONS_GRAPHOWNERCONTROL__YIELDDO_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB9C4B0)
#define NODECANVAS_TASKS_ACTIONS_GRAPHOWNERCONTROL__YIELDDO_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9C4A0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GraphOwnerControl__YieldDo_d__6_TypeDefinitionIndex = 29736;
