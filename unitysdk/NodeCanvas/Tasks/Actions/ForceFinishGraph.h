...
#define NODECANVAS_TASKS_ACTIONS_FORCEFINISHGRAPH_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E8C4150)
#define NODECANVAS_TASKS_ACTIONS_FORCEFINISHGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8C43E0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ForceFinishGraph_TypeDefinitionIndex = 30249;
