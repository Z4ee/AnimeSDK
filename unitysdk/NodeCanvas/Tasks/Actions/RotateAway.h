...
#define NODECANVAS_TASKS_ACTIONS_ROTATEAWAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFD0E10)
#define NODECANVAS_TASKS_ACTIONS_ROTATEAWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD1510)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int RotateAway_TypeDefinitionIndex = 26877;

	class RotateAway : public ::NodeCanvas::Framework::ActionTask_1<::UnityEngine::Transform*>
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::Vector3>* upVector; // 0x60
