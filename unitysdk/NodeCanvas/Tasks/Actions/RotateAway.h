...
#define NODECANVAS_TASKS_ACTIONS_ROTATEAWAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1E7B63B0)
#define NODECANVAS_TASKS_ACTIONS_ROTATEAWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B6AD0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int RotateAway_TypeDefinitionIndex = 30924;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Single>* angleDifference; // 0x78
