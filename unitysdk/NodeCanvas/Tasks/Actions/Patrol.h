...
#define NODECANVAS_TASKS_ACTIONS_PATROL_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EB9ABA0)
#define NODECANVAS_TASKS_ACTIONS_PATROL_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1EB9B470)
#define NODECANVAS_TASKS_ACTIONS_PATROL_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB9AC10)
#define NODECANVAS_TASKS_ACTIONS_PATROL_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1EB9B3B0)
#define NODECANVAS_TASKS_ACTIONS_PATROL_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1EB9B3C0)
#define NODECANVAS_TASKS_ACTIONS_PATROL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EB9B150)
#define NODECANVAS_TASKS_ACTIONS_PATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB9B7F0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int Patrol_TypeDefinitionIndex = 30442;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::NodeCanvas::Tasks::Actions::Patrol_PatrolMode>* patrolMode; // 0x78
