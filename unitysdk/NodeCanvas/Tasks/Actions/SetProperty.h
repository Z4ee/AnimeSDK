...
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B7EAFB0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B7EB110)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B7EAF90)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1B7EB430)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B7EB7E0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_ONINIT_OFFSET UNITYSDK_OFFSET(0x1B7EB6C0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B7EB450)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B7EB5A0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EB860)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetProperty_TypeDefinitionIndex = 27596;
