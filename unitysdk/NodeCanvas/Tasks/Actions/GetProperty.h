...
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B0B9A70)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B0B9BD0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0B9A50)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1B0B9EF0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B0BA2A0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_ONINIT_OFFSET UNITYSDK_OFFSET(0x1B0BA180)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B0B9F10)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0BA060)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BA320)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetProperty_TypeDefinitionIndex = 27322;
