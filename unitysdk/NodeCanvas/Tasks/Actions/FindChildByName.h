...
#define NODECANVAS_TASKS_ACTIONS_FINDCHILDBYNAME_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1BCCB040)
#define NODECANVAS_TASKS_ACTIONS_FINDCHILDBYNAME_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1BCCB0F0)
#define NODECANVAS_TASKS_ACTIONS_FINDCHILDBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCB310)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindChildByName_TypeDefinitionIndex = 29161;
