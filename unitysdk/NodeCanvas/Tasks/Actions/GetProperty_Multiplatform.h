...
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1D6E6890)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D6E69F0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1D6E6870)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1D6E6C80)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D6E6EB0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1D6E6DF0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D6E6C90)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1D6E6D50)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E6FB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetProperty_Multiplatform_TypeDefinitionIndex = 30681;
