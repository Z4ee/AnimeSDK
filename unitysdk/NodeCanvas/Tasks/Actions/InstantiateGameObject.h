...
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D80A6D0)
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D80AC60)
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80AE60)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int InstantiateGameObject_TypeDefinitionIndex = 30860;

	class InstantiateGameObject : public ::NodeCanvas::Framework::ActionTask_1<::UnityEngine::Transform*>
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::Transform*>* parent; // 0x60
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::GameObject*>* saveCloneAs; // 0x68
