...
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A20D6E0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A20D840)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A20D6C0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_INTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A20EAB0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A20DEA0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A20E690)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A20E490)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A20EB00)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A20DEB0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A20DED0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20EB10)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ExecuteFunction_Multiplatform_TypeDefinitionIndex = 27920;
	...
	public:
		...
		::NodeCanvas::Framework::Internal::BBObjectParameter* returnValue; // 0x68
		::System::Collections::Generic::List_1<::NodeCanvas::Framework::Internal::BBObjectParameter*>* parameters; // 0x70
		::Il2CppArray<::System::Object*>* args; // 0x78
