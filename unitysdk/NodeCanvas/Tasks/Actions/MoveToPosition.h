...
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B4B9B10)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B4B9B50)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B4BA030)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1B4B9F90)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4B9D20)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BA040)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveToPosition_TypeDefinitionIndex = 27591;
