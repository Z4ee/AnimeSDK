...
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A20F9F0)
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A20FA50)
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A20FB40)
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20FBF0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int PlayAudioAtPosition_TypeDefinitionIndex = 26991;
