...
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B4BA130)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4BA190)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4BA1F0)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B4BA1A0)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B4BA120)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BA110)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int TriggerBoolean__Flip_d__4_TypeDefinitionIndex = 27463;
