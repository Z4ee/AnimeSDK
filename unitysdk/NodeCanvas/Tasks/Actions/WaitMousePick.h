...
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1DB9DBF0)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1DB9DC80)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9DFA0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int WaitMousePick_TypeDefinitionIndex = 29635;
	...
	public:
		...
		::System::Int32 buttonID; // 0x78
		::UnityEngine::LayerMask mask; // 0x7C
		::UnityEngine::RaycastHit hit; // 0x80
		::NodeCanvas::Tasks::Actions::WaitMousePick_ButtonKeys buttonKey; // 0xB4
