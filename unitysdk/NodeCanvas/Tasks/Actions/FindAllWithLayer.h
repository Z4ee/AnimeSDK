...
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHLAYER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EB87CE0)
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHLAYER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB87F30)
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB88020)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindAllWithLayer_TypeDefinitionIndex = 30670;
