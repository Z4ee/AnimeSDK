...
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EB861C0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1EB861A0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_NODECANVAS_FRAMEWORK_ISUBPARAMETERSCONTAINER_GETSUBPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1EB86170)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1EB86D80)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x1EB86C80)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EB86930)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1EB86AF0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB86EE0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ExecuteStaticFunction_TypeDefinitionIndex = 31355;
