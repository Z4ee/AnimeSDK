...
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A5600)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetField_0_TypeDefinitionIndex = 27422;
