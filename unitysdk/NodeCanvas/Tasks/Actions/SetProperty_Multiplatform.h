...
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E5433E0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1E543540)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1E5433C0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1E5437D0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1E5439B0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1E5438F0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E5437E0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1E543800)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E543AD0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetProperty_Multiplatform_TypeDefinitionIndex = 30412;

	class SetProperty_Multiplatform : public ::NodeCanvas::Framework::ActionTask
	{
	public:
		::NodeCanvas::Framework::Internal::BBObjectParameter* parameter; // 0x60
