...
#define NODECANVAS_TASKS_ACTIONS_SETFLOATRANDOM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A903020)
#define NODECANVAS_TASKS_ACTIONS_SETFLOATRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A9033E0)
#define NODECANVAS_TASKS_ACTIONS_SETFLOATRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A903490)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetFloatRandom_TypeDefinitionIndex = 27509;
