...
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1985D3D0)
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS_GET_OFFSET UNITYSDK_OFFSET(0x1985D9C0)
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1985D4A0)
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1985DD80)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetAllChildGameObjects_TypeDefinitionIndex = 27722;
