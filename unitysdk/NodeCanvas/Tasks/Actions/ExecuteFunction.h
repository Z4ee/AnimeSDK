...
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B460F10)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B461070)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B460EF0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_INTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1B4621B0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1B460ED0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B461E70)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x1B461CE0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1B462200)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B461990)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B461B50)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B462210)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ExecuteFunction_TypeDefinitionIndex = 27967;
