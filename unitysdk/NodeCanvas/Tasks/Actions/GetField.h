...
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A20EF30)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A20F030)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_GET_TARGETFIELD_OFFSET UNITYSDK_OFFSET(0x1A20EF10)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A20F2E0)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A20F440)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A20F2F0)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_ACTIONS_GETFIELD_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1A20EE70)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD_SETTARGETFIELD_OFFSET UNITYSDK_OFFSET(0x1A20F530)
#define NODECANVAS_TASKS_ACTIONS_GETFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20F5B0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetField_TypeDefinitionIndex = 28023;
