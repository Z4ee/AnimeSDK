...
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A85B6C0)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A85B240)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A85B9E0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetLinecastInfo2D_TypeDefinitionIndex = 28010;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::Vector3>* savePointAs; // 0x78
