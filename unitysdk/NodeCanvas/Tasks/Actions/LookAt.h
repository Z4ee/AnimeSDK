...
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_DOLOOK_OFFSET UNITYSDK_OFFSET(0x1B7EA9A0)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B7EA950)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B7EA990)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B7EAB30)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EAB40)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int LookAt_TypeDefinitionIndex = 28030;
