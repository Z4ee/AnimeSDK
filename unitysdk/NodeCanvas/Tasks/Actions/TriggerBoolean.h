...
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_FLIP_OFFSET UNITYSDK_OFFSET(0x1DAF3B00)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1DAF39C0)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1DAF3A30)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAF3B50)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int TriggerBoolean_TypeDefinitionIndex = 30368;
