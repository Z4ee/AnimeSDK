...
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_FLIP_OFFSET UNITYSDK_OFFSET(0x1A2104F0)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A2103B0)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A210420)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A210540)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int TriggerBoolean_TypeDefinitionIndex = 27462;
