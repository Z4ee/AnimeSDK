...
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1EA9CCC0)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EA9CE20)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1EA9CCA0)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1EA9D1B0)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x1EA9D440)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1EA9D660)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1EA9D560)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EA9D1D0)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1EA9D320)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA9D670)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ImplementedAction_TypeDefinitionIndex = 30435;
