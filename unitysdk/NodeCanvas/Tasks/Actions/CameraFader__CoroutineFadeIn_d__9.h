...
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B423190)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B423240)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4232A0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B423250)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B423180)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1B423170)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int CameraFader__CoroutineFadeIn_d__9_TypeDefinitionIndex = 26570;
