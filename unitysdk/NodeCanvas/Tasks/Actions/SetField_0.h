...
#define NODECANVAS_TASKS_ACTIONS_SETFIELD_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A85D790)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetField_0_TypeDefinitionIndex = 27583;
