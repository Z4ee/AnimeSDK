...
#define NODECANVAS_TASKS_ACTIONS_COMPOSEVECTOR_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B460DA0)
#define NODECANVAS_TASKS_ACTIONS_COMPOSEVECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B460DE0)
#define NODECANVAS_TASKS_ACTIONS_COMPOSEVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B460EC0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ComposeVector_TypeDefinitionIndex = 27444;
