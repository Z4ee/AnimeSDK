...
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1CC4CEF0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1CC4D050)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1CC4CED0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1CC4D340)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1CC4D4B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1CC4D420)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1CC4D350)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1CC4D370)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4D9A0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckProperty_Multiplatform_TypeDefinitionIndex = 30447;
