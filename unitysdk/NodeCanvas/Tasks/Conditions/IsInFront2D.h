...
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D52DD40)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1D52DD80)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1D52E020)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52E300)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int IsInFront2D_TypeDefinitionIndex = 30373;
