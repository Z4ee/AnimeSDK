...
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1985E650)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1985E770)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1985E780)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONINIT_OFFSET UNITYSDK_OFFSET(0x1985E6D0)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1985E860)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int ButtonClicked_TypeDefinitionIndex = 28229;
