...
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1E5443E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1E5446F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1E544860)
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1E544A10)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckDistanceToGameObject2D_TypeDefinitionIndex = 31504;
