...
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EA9EF60)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1EA9F010)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1EA9F350)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1EA9F640)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EA9F1C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EA9F030)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCOLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA9F780)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckCollision2D_TypeDefinitionIndex = 30012;
