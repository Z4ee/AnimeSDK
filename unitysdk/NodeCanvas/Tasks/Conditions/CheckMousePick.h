...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D6E9B30)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1D6E9C80)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6E9F90)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMousePick_TypeDefinitionIndex = 29754;
