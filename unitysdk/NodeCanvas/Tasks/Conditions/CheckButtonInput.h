...
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B7EC460)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1B7EC500)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EC5D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckButtonInput_TypeDefinitionIndex = 26621;
