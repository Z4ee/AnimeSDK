...
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1DB9EC30)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1DB9EC70)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1DB9EFD0)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9F2C0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int IsInFront_TypeDefinitionIndex = 30123;
