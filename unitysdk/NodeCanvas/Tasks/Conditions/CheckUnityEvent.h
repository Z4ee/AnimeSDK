...
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BCCE5C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BCCE4C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1BCCE6D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1BCCE4A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_TARGETEVENTFIELD_OFFSET UNITYSDK_OFFSET(0x1BCCE540)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_TARGETEVENTPROP_OFFSET UNITYSDK_OFFSET(0x1BCCE580)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_TARGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1BCCE480)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1BCCE880)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1BCCECE0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BCCEB70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BCCEB00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONINIT_OFFSET UNITYSDK_OFFSET(0x1BCCE890)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1BCCE3E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_RAISED_OFFSET UNITYSDK_OFFSET(0x1BCCEC00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_SETTARGETEVENT_OFFSET UNITYSDK_OFFSET(0x1BCCECF0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCED50)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckUnityEvent_TypeDefinitionIndex = 29626;
