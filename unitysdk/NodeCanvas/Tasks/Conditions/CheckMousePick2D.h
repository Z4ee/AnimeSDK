...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1E730650)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1E730790)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1E730B90)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMousePick2D_TypeDefinitionIndex = 29944;
	...
	public:
		...
		::UnityEngine::LayerMask mask; // 0xA4
