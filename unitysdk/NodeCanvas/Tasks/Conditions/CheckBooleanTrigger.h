...
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1C63C520)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1C63C590)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C63C5E0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckBooleanTrigger_TypeDefinitionIndex = 29684;
