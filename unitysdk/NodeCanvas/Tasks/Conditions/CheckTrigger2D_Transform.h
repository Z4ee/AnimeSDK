...
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D3974B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1D397560)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D397720)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D397580)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1D3978C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1D397A70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER2D_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D397C20)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckTrigger2D_Transform_TypeDefinitionIndex = 30329;
