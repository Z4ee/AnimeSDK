...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1DB39970)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1DB399E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1DB39C80)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DB399F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK_ONMOUSEDOWN_OFFSET UNITYSDK_OFFSET(0x1DB39F10)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK_ONMOUSEUP_OFFSET UNITYSDK_OFFSET(0x1DB39FF0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSECLICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3A0D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMouseClick_TypeDefinitionIndex = 30550;
