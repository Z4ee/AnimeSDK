...
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1E731340)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1E732650)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1E732F20)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E731D40)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1E732AC0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDROP_OFFSET UNITYSDK_OFFSET(0x1E732BA0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E731430)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONMOVE_OFFSET UNITYSDK_OFFSET(0x1E733000)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1E7329E0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1E732820)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1E732660)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1E732740)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1E732900)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1E732C80)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1E732E40)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSUBMIT_OFFSET UNITYSDK_OFFSET(0x1E7330E0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONUPDATESELECTED_OFFSET UNITYSDK_OFFSET(0x1E732D60)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7331C0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int InterceptEvent_TypeDefinitionIndex = 30254;
