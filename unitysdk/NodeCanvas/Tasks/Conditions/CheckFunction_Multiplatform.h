...
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1EB89F30)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1EB8A0A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1EB89F10)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1EB8A6A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1EB8ADD0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1EB8AC00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1EB8A6B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1EB8A6D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB8B470)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckFunction_Multiplatform_TypeDefinitionIndex = 30100;
	...
	public:
		...
		::Il2CppArray<::System::Boolean>* parameterIsByRef; // 0x70
		::System::Collections::Generic::List_1<::NodeCanvas::Framework::Internal::BBObjectParameter*>* parameters; // 0x78
		::ParadoxNotion::Serialization::SerializedMethodInfo* method; // 0x80
