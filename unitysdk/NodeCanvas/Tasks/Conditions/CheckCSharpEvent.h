...
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E543CD0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1E543DE0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_TARGETEVENT_OFFSET UNITYSDK_OFFSET(0x1E543CB0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1E543F60)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1E5443C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E544210)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E544140)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONINIT_OFFSET UNITYSDK_OFFSET(0x1E543F70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1E543AE0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKSTATICCSHARPEVENT__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1E543BF0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_RAISED_OFFSET UNITYSDK_OFFSET(0x1E5442E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_SETTARGETEVENT_OFFSET UNITYSDK_OFFSET(0x1E543BA0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5443D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckCSharpEvent_TypeDefinitionIndex = 30795;
