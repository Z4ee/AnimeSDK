...
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1D1E7F30)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D1E8040)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_TARGETEVENT_OFFSET UNITYSDK_OFFSET(0x1D1E7F10)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1D1E81C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1D1E8620)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D1E8470)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D1E83A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONINIT_OFFSET UNITYSDK_OFFSET(0x1D1E81D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1D1E7D40)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKSTATICCSHARPEVENT__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1D1E7E50)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_RAISED_OFFSET UNITYSDK_OFFSET(0x1D1E8540)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_SETTARGETEVENT_OFFSET UNITYSDK_OFFSET(0x1D1E7E00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E8630)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckCSharpEvent_TypeDefinitionIndex = 30756;
