...
#define NODECANVAS_TASKS_CONDITIONS_CHECKFIELD_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06FE30)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckField_0_TypeDefinitionIndex = 31153;
