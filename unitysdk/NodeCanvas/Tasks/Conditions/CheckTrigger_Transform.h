...
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1BC62C00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1BC62CB0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BC62F70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BC62CD0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1BC63210)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1BC633C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKTRIGGER_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC63570)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckTrigger_Transform_TypeDefinitionIndex = 30088;
