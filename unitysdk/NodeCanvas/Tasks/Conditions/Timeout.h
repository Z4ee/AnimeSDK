...
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D6EA080)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D6EA2D0)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1D6EA330)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D6EA200)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D6EA130)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6EA370)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int Timeout_TypeDefinitionIndex = 29700;
