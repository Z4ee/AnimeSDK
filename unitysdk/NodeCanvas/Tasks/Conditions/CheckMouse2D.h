...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1AFD23F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1AFD28E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AFD26A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AFD2460)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONMOUSEENTER_OFFSET UNITYSDK_OFFSET(0x1AFD28F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONMOUSEEXIT_OFFSET UNITYSDK_OFFSET(0x1AFD29D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONMOUSEOVER_OFFSET UNITYSDK_OFFSET(0x1AFD2AB0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD2B90)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMouse2D_TypeDefinitionIndex = 27671;
