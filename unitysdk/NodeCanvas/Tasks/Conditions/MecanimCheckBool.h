...
#define NODECANVAS_TASKS_CONDITIONS_MECANIMCHECKBOOL_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1AFD3150)
#define NODECANVAS_TASKS_CONDITIONS_MECANIMCHECKBOOL_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1AFD33B0)
#define NODECANVAS_TASKS_CONDITIONS_MECANIMCHECKBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD3440)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int MecanimCheckBool_TypeDefinitionIndex = 27782;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Boolean>* value; // 0x68
