...
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1B0BA930)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1B0BA970)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1B0BAFC0)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BB8D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CanSeeTarget2D_TypeDefinitionIndex = 28232;
