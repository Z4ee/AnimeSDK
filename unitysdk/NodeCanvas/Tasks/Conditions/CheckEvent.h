...
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1D3962B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1D3964D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x1D3964E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D3963F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D396310)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D396630)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckEvent_TypeDefinitionIndex = 30125;
