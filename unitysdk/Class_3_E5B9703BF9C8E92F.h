...
#define CLASS_3_E5B9703BF9C8E92F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18193C40)
#define CLASS_3_E5B9703BF9C8E92F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18193C90)
#define CLASS_3_E5B9703BF9C8E92F_TICK_OFFSET UNITYSDK_OFFSET(0x18193CE0)
#define CLASS_3_E5B9703BF9C8E92F__CTOR_OFFSET UNITYSDK_OFFSET(0x18193BF0)

inline static constexpr unsigned int Class_3_E5B9703BF9C8E92F_TypeDefinitionIndex = 49754;
