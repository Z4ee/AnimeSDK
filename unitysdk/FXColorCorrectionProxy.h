...
#define FXCOLORCORRECTIONPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x154B4D60)
#define FXCOLORCORRECTIONPROXY_COPYVALUEFROMFXCOLORCORRECTION_OFFSET UNITYSDK_OFFSET(0x154B5170)
#define FXCOLORCORRECTIONPROXY_SETVALUETOFXCOLORCORRECTION_OFFSET UNITYSDK_OFFSET(0x154B5540)
#define FXCOLORCORRECTIONPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x154B54F0)
#define FXCOLORCORRECTIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x154B5D30)

inline static constexpr unsigned int FXColorCorrectionProxy_TypeDefinitionIndex = 65026;
