...
#define CLASS_2_BECDD56EBD7261C8_METHOD_2_50131F4CF014469C_OFFSET UNITYSDK_OFFSET(0x116AAAB0)
#define CLASS_2_BECDD56EBD7261C8_METHOD_2_6B3FF83ECBC6B398_OFFSET UNITYSDK_OFFSET(0x116AABD0)
#define CLASS_2_BECDD56EBD7261C8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x116AAB40)
#define CLASS_2_BECDD56EBD7261C8__CCTOR_OFFSET UNITYSDK_OFFSET(0x116AAA30)
#define CLASS_2_BECDD56EBD7261C8__CTOR_OFFSET UNITYSDK_OFFSET(0x116AAAA0)

inline static constexpr unsigned int Class_2_BECDD56EBD7261C8_TypeDefinitionIndex = 65610;

class Class_2_BECDD56EBD7261C8 : public ::Class_1_B7E341C5F1A6F199
{
public:
	// static const ::System::UInt16 Field_2_7 = 0x1A; // 0x0
